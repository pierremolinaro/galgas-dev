...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_26164 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_26253 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_26164 != NULL)
      && (operand_26253 != NULL)) {
    macroValidPointer (operand_26164) ;
    macroValidPointer (operand_26253) ;
    if (((operand_26164->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_26253->mAttributType.isBuilt ()) {
        operand_26253->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_26164->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_26253->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        if (var_cas_ioVariablesMap.isBuilt ()) {
          var_cas_ioVariablesMap ()->methode_insertUsedConstInArgument (lexique_var_, operand_26164->mName, operand_26253->mAttributType, var_cas_cppName) ;
        }
      }else{
          operand_26164->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_26164->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_26164 = operand_26164->nextObject () ;
    operand_26253 = operand_26253->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_28276 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_28290 = var_cas_sourceType () ;
    cPtr_typeGalgas_stringset * operand_28276 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_28276) ;
    cPtr_typeGalgas_stringset * operand_28290 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_28290) ;
    if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_28276 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_28276) ;
      cPtr_typeGalgas_uint * operand_28290 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_28290) ;
      if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_28276 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_28276) ;
        cPtr_typeGalgas_sint * operand_28290 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_28290) ;
        if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_28276 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_28276) ;
          cPtr_typeGalgas_char * operand_28290 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_28290) ;
          if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_28276 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_28276) ;
            cPtr_typeGalgas_string * operand_28290 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_28290) ;
            if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_28276 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_28276) ;
              cPtr_typeGalgas_bool * operand_28290 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_28290) ;
              if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_28276 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_28276) ;
                cPtr_typeGalgas_double * operand_28290 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_28290) ;
                if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_28276 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_28276) ;
                  cPtr_typeGalgas_ldouble * operand_28290 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_28290) ;
                  if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_28276 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_28276) ;
                    cPtr_typeGalgas_location * operand_28290 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_28290) ;
                    if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_28276 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_28276) ;
                      cPtr_typeGalgas_lchar * operand_28290 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_28290) ;
                      if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_28276 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_28276) ;
                        cPtr_typeGalgas_luint * operand_28290 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_28290) ;
                        if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_28276 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_28276) ;
                          cPtr_typeGalgas_lsint * operand_28290 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_28290) ;
                          if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_28276 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_28276) ;
                            cPtr_typeGalgas_lstring * operand_28290 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_28290) ;
                            if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_28276 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_28276) ;
                              cPtr_typeGalgas_lbool * operand_28290 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_28290) ;
                              if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_28276 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_28276) ;
                                cPtr_typeGalgasUndefinedExternType * operand_28290 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_28290) ;
                                if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                                  if (((operand_28276->mGalgasClassName.reader_value ()) != (operand_28290->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_28276->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_28290->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_28276 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_28276) ;
                                  cPtr_typeGalgasUndefinedListType * operand_28290 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_28290) ;
                                  if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                                    if (((operand_28276->mListTypeName.reader_value ()) != (operand_28290->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28276->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_28290->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_28276 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_28276) ;
                                    cPtr_typeGalgasClassType * operand_28290 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_28290) ;
                                    if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                                      if (((operand_28276->mClassTypeName.reader_value ()) == (operand_28290->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_28290->mAncestorClassesMap.reader_hasKey (operand_28276->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_28290->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_28290->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_28276 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_28276) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_28290 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_28290) ;
                                      if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                                        if (((operand_28276->mClassTypeName.reader_value ()) != (operand_28290->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28276->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_28290->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_28276 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_28276) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_28290 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_28290) ;
                                        if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                                          if (((operand_28276->mMapTypeName.reader_value ()) != (operand_28290->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28276->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_28290->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_28276 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_28276) ;
                                          cPtr_typeGalgas_enum * operand_28290 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_28290) ;
                                          if ((operand_28276 != NULL) && (operand_28290 != NULL)) {
                                            if (((operand_28276->mEnumTypeName.reader_value ()) != (operand_28290->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_28276->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_28290->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32723 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32808 = var_cas_t2.firstObject () ;
    while ((operand_32723 != NULL)
        && (operand_32808 != NULL)) {
      macroValidPointer (operand_32723) ;
      macroValidPointer (operand_32808) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32723->mType,  operand_32808->mAttributType,  operand_32723->mGalgasVariableName.reader_location ()) ;
      operand_32723 = operand_32723->nextObject () ;
      operand_32808 = operand_32808->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_34041 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_34170 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_34041 != NULL)
        && (operand_34170 != NULL)) {
      macroValidPointer (operand_34041) ;
      macroValidPointer (operand_34170) ;
      if (operand_34041->mFormalArgumentPassingMode.isBuilt () && operand_34170->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_34041->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_34170->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34041->mType,  operand_34170->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_34041->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_34170->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34041->mType,  operand_34170->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_34041->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_34170->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34041->mType,  operand_34170->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_34041->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_34170->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_34170->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_34170->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34041->mType,  operand_34170->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_34170->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_34041->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_34041 = operand_34041->nextObject () ;
      operand_34170 = operand_34170->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_35427 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35495 = var_cas_expressionList.firstObject () ;
    while ((operand_35427 != NULL)
        && (operand_35495 != NULL)) {
      macroValidPointer (operand_35427) ;
      macroValidPointer (operand_35495) ;
      if (operand_35495->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35495->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35580 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35495->mExpression.getPtr ()) ;
          macroValidPointer (operand_35580) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35580->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35427->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35495->mExpression) ;
        }
      }
      operand_35427 = operand_35427->nextObject () ;
      operand_35495 = operand_35495->nextObject () ;
    }
  }
}
