...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_27838 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_27897 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_27838 != NULL) && (operand_27897 != NULL)) {
    macroValidPointer (operand_27838) ;
    macroValidPointer (operand_27897) ;
    if (((operand_27838->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_27897->mAttributType.isBuilt ()) {
        operand_27897->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_27838->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_27897->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        insertUsedConstInArgument_typeVariablesMap (lexique_var_,
                                        var_cas_ioVariablesMap,
                                        operand_27838->mName,
                                        operand_27897->mAttributType,
                                        var_cas_cppName,
                                        NULL) ;
      }else{
          operand_27838->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_27838->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_27838 = operand_27838->nextObject () ;
    operand_27897 = operand_27897->nextObject () ;
  }
  if (((var_cas_inLocalDeclarationsList.reader_length ()) < (var_cas_inSemanticAttributsList.reader_length ())).isBuiltAndTrue ()) {
    ...
    if (((var_cas_inLocalDeclarationsList.reader_length ()) < (var_cas_inSemanticAttributsList.reader_length ())).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much identifiers")) ;
    }
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_29573 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_29587 = var_cas_sourceType () ;
    cPtr_typeGalgas_uint * operand_29573 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29573) ;
    cPtr_typeGalgas_uint * operand_29587 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29587) ;
    if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_29573 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29573) ;
      cPtr_typeGalgas_sint * operand_29587 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29587) ;
      if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_29573 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29573) ;
        cPtr_typeGalgas_char * operand_29587 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29587) ;
        if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_29573 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29573) ;
          cPtr_typeGalgas_string * operand_29587 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29587) ;
          if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_29573 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29573) ;
            cPtr_typeGalgas_bool * operand_29587 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29587) ;
            if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_29573 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_29573) ;
              cPtr_typeGalgas_double * operand_29587 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_29587) ;
              if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
              }else{
                cPtr_typeGalgas_ldouble * operand_29573 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_29573) ;
                cPtr_typeGalgas_ldouble * operand_29587 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_29587) ;
                if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                }else{
                  cPtr_typeGalgas_location * operand_29573 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29573) ;
                  cPtr_typeGalgas_location * operand_29587 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29587) ;
                  if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_29573 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29573) ;
                    cPtr_typeGalgas_lchar * operand_29587 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29587) ;
                    if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_29573 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29573) ;
                      cPtr_typeGalgas_luint * operand_29587 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29587) ;
                      if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_29573 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29573) ;
                        cPtr_typeGalgas_lsint * operand_29587 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29587) ;
                        if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_29573 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29573) ;
                          cPtr_typeGalgas_lstring * operand_29587 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29587) ;
                          if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lbool * operand_29573 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29573) ;
                            cPtr_typeGalgas_lbool * operand_29587 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29587) ;
                            if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedExternType * operand_29573 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29573) ;
                              cPtr_typeGalgasUndefinedExternType * operand_29587 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29587) ;
                              if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                                if (((operand_29573->mGalgasClassName.reader_value ()) != (operand_29587->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_29573->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_29587->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_29573 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29573) ;
                                cPtr_typeGalgasUndefinedListType * operand_29587 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29587) ;
                                if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                                  if (((operand_29573->mListTypeName.reader_value ()) != (operand_29587->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29573->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_29587->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasClassType * operand_29573 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29573) ;
                                  cPtr_typeGalgasClassType * operand_29587 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29587) ;
                                  if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                                    if (((operand_29573->mClassTypeName.reader_value ()) == (operand_29587->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    }else if (((! operand_29587->mAncestorClassesMap.reader_hasKey (operand_29573->mClassTypeName))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_29587->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_29587->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_29573 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29573) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_29587 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29587) ;
                                    if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                                      if (((operand_29573->mClassTypeName.reader_value ()) != (operand_29587->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29573->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_29587->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedMapType * operand_29573 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29573) ;
                                      cPtr_typeGalgasUndefinedMapType * operand_29587 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29587) ;
                                      if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                                        if (((operand_29573->mMapTypeName.reader_value ()) != (operand_29587->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29573->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_29587->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_29573 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29573) ;
                                        cPtr_typeGalgas_enum * operand_29587 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29587) ;
                                        if ((operand_29573 != NULL) && (operand_29587 != NULL)) {
                                          if (((operand_29573->mEnumTypeName.reader_value ()) != (operand_29587->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_29573->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_29587->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_33964 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34051 = var_cas_t2.firstObject () ;
    while ((operand_33964 != NULL) && (operand_34051 != NULL)) {
      macroValidPointer (operand_33964) ;
      macroValidPointer (operand_34051) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33964->mType,  operand_34051->mAttributType,  operand_33964->mGalgasVariableName.reader_location ()) ;
      operand_33964 = operand_33964->nextObject () ;
      operand_34051 = operand_34051->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_35324 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_35428 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35324 != NULL) && (operand_35428 != NULL)) {
      macroValidPointer (operand_35324) ;
      macroValidPointer (operand_35428) ;
      if (operand_35324->mFormalArgumentPassingMode.isBuilt () && operand_35428->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_35324->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_35428->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35324->mType,  operand_35428->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_35324->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_35428->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35324->mType,  operand_35428->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_35324->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_35428->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35324->mType,  operand_35428->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_35324->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_35428->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_35428->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_35428->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35324->mType,  operand_35428->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_35428->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_35324->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_35324 = operand_35324->nextObject () ;
      operand_35428 = operand_35428->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_36709 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_36767 = var_cas_expressionList.firstObject () ;
    while ((operand_36709 != NULL) && (operand_36767 != NULL)) {
      macroValidPointer (operand_36709) ;
      macroValidPointer (operand_36767) ;
      if (operand_36767->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_36767->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_36852 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_36767->mExpression.getPtr ()) ;
          macroValidPointer (operand_36852) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_36852->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_36709->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_36767->mExpression) ;
        }
      }
      operand_36709 = operand_36709->nextObject () ;
      operand_36767 = operand_36767->nextObject () ;
    }
  }
}
...
cPtr_typeInstructionItererTable::cPtr_typeInstructionItererTable (const GGS_location & argument_0,
                                const GGS_typeCplusPlusName & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_typeCplusPlusName & argument_3,
                                const GGS_typeInstructionsList & argument_4)
:mLocationOffset (argument_0),
aNomCppTable (argument_1),
aNomTypeTable (argument_2),
aNomCppClef (argument_3),
mInstructionsList (argument_4) {
}

//---------------------------------------------------------------------------*

bool cPtr_typeInstructionItererTable::isBuilt (void) const {
  return mLocationOffset.isBuilt () &&
       aNomCppTable.isBuilt () &&
       aNomTypeTable.isBuilt () &&
       aNomCppClef.isBuilt () &&
       mInstructionsList.isBuilt () ;
}
...
#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  cPtr_typeInstructionItererTable * GGS_typeInstructionItererTable::
    constructor_new (const GGS_location & argument_0,
                                const GGS_typeCplusPlusName & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_typeCplusPlusName & argument_3,
                                const GGS_typeInstructionsList & argument_4) {
    cPtr_typeInstructionItererTable * ptr_ = (cPtr_typeInstructionItererTable *) NULL ;
    macroMyNew (ptr_, cPtr_typeInstructionItererTable (argument_0,
                                argument_1,
                                argument_2,
                                argument_3,
                                argument_4)) ;
...
cPtr_typeInstructionItererListeSimple::cPtr_typeInstructionItererListeSimple (const GGS_location & argument_0,
                                const GGS_typeCplusPlusName & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_typeInstructionsList & argument_3)
:mLocationOffset (argument_0),
aNomCppListe (argument_1),
aNomTypeListe (argument_2),
mInstructionsList (argument_3) {
}

//---------------------------------------------------------------------------*

bool cPtr_typeInstructionItererListeSimple::isBuilt (void) const {
  return mLocationOffset.isBuilt () &&
       aNomCppListe.isBuilt () &&
       aNomTypeListe.isBuilt () &&
       mInstructionsList.isBuilt () ;
}
...
#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  cPtr_typeInstructionItererListeSimple * GGS_typeInstructionItererListeSimple::
    constructor_new (const GGS_location & argument_0,
                                const GGS_typeCplusPlusName & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_typeInstructionsList & argument_3) {
    cPtr_typeInstructionItererListeSimple * ptr_ = (cPtr_typeInstructionItererListeSimple *) NULL ;
    macroMyNew (ptr_, cPtr_typeInstructionItererListeSimple (argument_0,
                                argument_1,
                                argument_2,
                                argument_3)) ;
    return ptr_ ;
...
cPtr_typeInstructionItererListeDouble::cPtr_typeInstructionItererListeDouble (const GGS_location & argument_0,
                                const GGS_typeCplusPlusName & argument_1,
                                const GGS_lstring & argument_2,
...
:aIndicatif1 (argument_0),
aNomCppListe1 (argument_1),
aNomTypeListe1 (argument_2),
aIndicatif2 (argument_3),
aNomCppListe2 (argument_4),
aNomTypeListe2 (argument_5),
mInstructionsList (argument_6) {
}

//---------------------------------------------------------------------------*

bool cPtr_typeInstructionItererListeDouble::isBuilt (void) const {
  return aIndicatif1.isBuilt () &&
       aNomCppListe1.isBuilt () &&
       aNomTypeListe1.isBuilt () &&
       aIndicatif2.isBuilt () &&
       aNomCppListe2.isBuilt () &&
       aNomTypeListe2.isBuilt () &&
       mInstructionsList.isBuilt () ;
}
...
#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  cPtr_typeInstructionItererListeDouble * GGS_typeInstructionItererListeDouble::
    constructor_new (const GGS_location & argument_0,
                                const GGS_typeCplusPlusName & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_location & argument_3,
                                ...
                                const GGS_lstring & argument_5,
                                const GGS_typeInstructionsList & argument_6) {
    cPtr_typeInstructionItererListeDouble * ptr_ = (cPtr_typeInstructionItererListeDouble *) NULL ;
    macroMyNew (ptr_, cPtr_typeInstructionItererListeDouble (argument_0,
                                argument_1,
                                argument_2,
                                argument_3,
                                argument_4,
