...
void GGS_typeCplusPlusNameList::
_internalPrependItem (const GGS_typeCplusPlusName & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mCppName ;
  }else{
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mCppName ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_typeSemanticsTypesList::
_internalPrependItem (const GGS_AC_galgasType & argument_0,
                    const GGS_lstring & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    ...
    _out_1 = _mRoot->mFirstItem->mGalgasVariableName ;
  }else{
    _out_0._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    ...
    _out_1 = _mRoot->mLastItem->mGalgasVariableName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->aNomVariableCible ;
    _out_1 = _mRoot->mFirstItem->aNomAttributSource ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->aNomVariableCible ;
    _out_1 = _mRoot->mLastItem->aNomAttributSource ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_typeListeCibles::
_internalPrependItem (const GGS_typeCible & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->aCible ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->aCible ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    ...
    _out_2 = _mRoot->mFirstItem->mCppName ;
    _out_3 = _mRoot->mFirstItem->mModeIn ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    ...
    _out_2 = _mRoot->mLastItem->mCppName ;
    _out_3 = _mRoot->mLastItem->mModeIn ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
void GGS_typeInstructionList::
_internalPrependItem (const GGS_typeInstruction & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mType ;
    _out_1 = _mRoot->mFirstItem->mName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_typeExpressionList::
_internalPrependItem (const GGS_typeExpression & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mExpression ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mExpression ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mVarToDrop ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mVarToDrop ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mIFexpression ;
    _out_1 = _mRoot->mFirstItem->mInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mIFexpression ;
    _out_1 = _mRoot->mLastItem->mInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_L_switchBranchlist::
_internalPrependItem (const GGS_stringset & argument_0,
                    const GGS_typeInstructionList & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mConstantSet ;
    _out_1 = _mRoot->mFirstItem->mInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mConstantSet ;
    _out_1 = _mRoot->mLastItem->mInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mCase1_name ;
    _out_1 = _mRoot->mFirstItem->mCase2_name ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mCase1_name ;
    _out_1 = _mRoot->mLastItem->mCase2_name ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mCppEnumeratedVariableName ;
    _out_1 = _mRoot->mFirstItem->mLocationOffset ;
    _out_2 = _mRoot->mFirstItem->mCppTypeName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mCppEnumeratedVariableName ;
    _out_1 = _mRoot->mLastItem->mLocationOffset ;
    _out_2 = _mRoot->mLastItem->mCppTypeName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mClassName ;
    _out_1 = _mRoot->mFirstItem->mResultVarID ;
    _out_2 = _mRoot->mFirstItem->mInstructionList ;
    _out_3 = _mRoot->mFirstItem->mNoUsedParameter ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mClassName ;
    _out_1 = _mRoot->mLastItem->mResultVarID ;
    _out_2 = _mRoot->mLastItem->mInstructionList ;
    _out_3 = _mRoot->mLastItem->mNoUsedParameter ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
void GGS_typeEntitiesToGenerateList::
_internalPrependItem (const GGS_typeEntityToGenerate & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mEntityToGenerate ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mEntityToGenerate ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1456)) ;
  GGS_stringset::element_type * operand_61217 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61217 != NULL)) {
    macroValidPointer (operand_61217) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61217->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1459)) ;
    operand_61217 = operand_61217->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1460)) ;
  GGS_stringset::element_type * operand_61514 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61514 != NULL)) {
    macroValidPointer (operand_61514) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61514->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1463)) ;
    operand_61514 = operand_61514->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1472)) ;
  GGS_stringset::element_type * operand_62050 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62050 != NULL)) {
    macroValidPointer (operand_62050) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62050->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1475)) ;
    operand_62050 = operand_62050->nextObject () ;
  }
}
