...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25693 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25782 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25693 != NULL)
      && (operand_25782 != NULL)) {
    macroValidPointer (operand_25693) ;
    macroValidPointer (operand_25782) ;
    if (((operand_25693->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25782->mAttributType.isBuilt ()) {
        operand_25782->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25693->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25782->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25693->mName, operand_25782->mAttributType, var_cas_cppName) ;
      }else{
          operand_25693->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25693->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25693 = operand_25693->nextObject () ;
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27805 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27819 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27805 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27805) ;
    cPtr_typeGalgas_stringset * operand_27819 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27819) ;
    if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27805 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27805) ;
      cPtr_typeGalgas_uint * operand_27819 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27819) ;
      if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27805 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27805) ;
        cPtr_typeGalgas_sint * operand_27819 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27819) ;
        if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27805 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27805) ;
          cPtr_typeGalgas_char * operand_27819 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27819) ;
          if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27805 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27805) ;
            cPtr_typeGalgas_string * operand_27819 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27819) ;
            if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27805 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27805) ;
              cPtr_typeGalgas_bool * operand_27819 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27819) ;
              if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27805 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27805) ;
                cPtr_typeGalgas_double * operand_27819 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27819) ;
                if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27805 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27805) ;
                  cPtr_typeGalgas_ldouble * operand_27819 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27819) ;
                  if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27805 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27805) ;
                    cPtr_typeGalgas_location * operand_27819 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27819) ;
                    if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27805 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27805) ;
                      cPtr_typeGalgas_lchar * operand_27819 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27819) ;
                      if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27805 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27805) ;
                        cPtr_typeGalgas_luint * operand_27819 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27819) ;
                        if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27805 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27805) ;
                          cPtr_typeGalgas_lsint * operand_27819 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27819) ;
                          if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27805 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27805) ;
                            cPtr_typeGalgas_lstring * operand_27819 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27819) ;
                            if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27805 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27805) ;
                              cPtr_typeGalgas_lbool * operand_27819 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27819) ;
                              if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27805 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27805) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27819 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27819) ;
                                if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                                  if (((operand_27805->mGalgasClassName.reader_value ()) != (operand_27819->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27805->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27819->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27805 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27805) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27819 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27819) ;
                                  if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                                    if (((operand_27805->mListTypeName.reader_value ()) != (operand_27819->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27805->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27819->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27805 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27805) ;
                                    cPtr_typeGalgasClassType * operand_27819 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27819) ;
                                    if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                                      if (((operand_27805->mClassTypeName.reader_value ()) == (operand_27819->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27819->mAncestorClassesMap.reader_hasKey (operand_27805->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27819->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27819->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27805 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27805) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27819 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27819) ;
                                      if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                                        if (((operand_27805->mClassTypeName.reader_value ()) != (operand_27819->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27805->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27819->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27805 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27805) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27819 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27819) ;
                                        if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                                          if (((operand_27805->mMapTypeName.reader_value ()) != (operand_27819->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27805->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27819->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27805 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27805) ;
                                          cPtr_typeGalgas_enum * operand_27819 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27819) ;
                                          if ((operand_27805 != NULL) && (operand_27819 != NULL)) {
                                            if (((operand_27805->mEnumTypeName.reader_value ()) != (operand_27819->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27805->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27819->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32252 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32337 = var_cas_t2.firstObject () ;
    while ((operand_32252 != NULL)
        && (operand_32337 != NULL)) {
      macroValidPointer (operand_32252) ;
      macroValidPointer (operand_32337) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32252->mType,  operand_32337->mAttributType,  operand_32252->mGalgasVariableName.reader_location ()) ;
      operand_32252 = operand_32252->nextObject () ;
      operand_32337 = operand_32337->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_33570 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33699 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33570 != NULL)
        && (operand_33699 != NULL)) {
      macroValidPointer (operand_33570) ;
      macroValidPointer (operand_33699) ;
      if (operand_33570->mFormalArgumentPassingMode.isBuilt () && operand_33699->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33570->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33699->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33570->mType,  operand_33699->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33570->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33699->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33570->mType,  operand_33699->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33570->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33699->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33570->mType,  operand_33699->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33570->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33699->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33699->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33699->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33570->mType,  operand_33699->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33699->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33570->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33570 = operand_33570->nextObject () ;
      operand_33699 = operand_33699->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_34956 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35024 = var_cas_expressionList.firstObject () ;
    while ((operand_34956 != NULL)
        && (operand_35024 != NULL)) {
      macroValidPointer (operand_34956) ;
      macroValidPointer (operand_35024) ;
      if (operand_35024->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35024->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35109 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35024->mExpression.getPtr ()) ;
          macroValidPointer (operand_35109) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35109->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34956->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35024->mExpression) ;
        }
      }
      operand_34956 = operand_34956->nextObject () ;
      operand_35024 = operand_35024->nextObject () ;
    }
  }
}
