...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_29145 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_29234 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_29145 != NULL)
      && (operand_29234 != NULL)) {
    macroValidPointer (operand_29145) ;
    macroValidPointer (operand_29234) ;
    if (((operand_29145->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (694))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_29234->mAttributType.isBuilt ()) {
        operand_29234->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (696)) ;
      }
      if (((operand_29145->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (697))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_29234->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_29145->mName, operand_29234->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (704)) ;
      }else{
          operand_29145->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_29145->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (706))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (707)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_29145 = operand_29145->nextObject () ;
    operand_29234 = operand_29234->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (713))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (713)))) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (715)).reader_string (_inLexique SOURCE_FILE_AT_LINE (715))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (716)).reader_string (_inLexique SOURCE_FILE_AT_LINE (716))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (716)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (717))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (717)))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (719)).reader_string (_inLexique SOURCE_FILE_AT_LINE (719))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (720)).reader_string (_inLexique SOURCE_FILE_AT_LINE (720))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (720)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_31263 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_31277 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_31263 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_31263) ;
    cPtr_typeGalgas_stringset * operand_31277 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_31277) ;
    if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_31263 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_31263) ;
      cPtr_typeGalgas_uint * operand_31277 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_31277) ;
      if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_31263 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_31263) ;
        cPtr_typeGalgas_sint * operand_31277 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_31277) ;
        if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_31263 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_31263) ;
          cPtr_typeGalgas_char * operand_31277 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_31277) ;
          if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_31263 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_31263) ;
            cPtr_typeGalgas_string * operand_31277 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_31277) ;
            if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_31263 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_31263) ;
              cPtr_typeGalgas_bool * operand_31277 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_31277) ;
              if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_31263 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_31263) ;
                cPtr_typeGalgas_double * operand_31277 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_31277) ;
                if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_31263 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_31263) ;
                  cPtr_typeGalgas_ldouble * operand_31277 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_31277) ;
                  if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_31263 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_31263) ;
                    cPtr_typeGalgas_location * operand_31277 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_31277) ;
                    if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_31263 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_31263) ;
                      cPtr_typeGalgas_lchar * operand_31277 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_31277) ;
                      if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_31263 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_31263) ;
                        cPtr_typeGalgas_luint * operand_31277 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_31277) ;
                        if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_31263 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_31263) ;
                          cPtr_typeGalgas_lsint * operand_31277 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_31277) ;
                          if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_31263 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_31263) ;
                            cPtr_typeGalgas_lstring * operand_31277 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_31277) ;
                            if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_31263 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_31263) ;
                              cPtr_typeGalgas_lbool * operand_31277 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_31277) ;
                              if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_31263 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_31263) ;
                                cPtr_typeGalgasUndefinedExternType * operand_31277 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_31277) ;
                                if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                                  if (((operand_31263->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (759))) != (operand_31277->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (759)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_31263->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (760))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_31277->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (761))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (761)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_31263 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_31263) ;
                                  cPtr_typeGalgasUndefinedListType * operand_31277 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_31277) ;
                                  if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                                    if (((operand_31263->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (765))) != (operand_31277->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (765)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31263->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_31277->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (767)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_31263 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_31263) ;
                                    cPtr_typeGalgasClassType * operand_31277 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_31277) ;
                                    if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                                      if (((operand_31263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (772))) == (operand_31277->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (772)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_31277->mAncestorClassesMap.reader_hasKey (_inLexique, operand_31263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773)) SOURCE_FILE_AT_LINE (773))))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_31277->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (774))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_31277->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (775))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (775)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_31263 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_31263) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_31277 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_31277) ;
                                      if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                                        if (((operand_31263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779))) != (operand_31277->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (780))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_31277->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (781))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (781)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_31263 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_31263) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_31277 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_31277) ;
                                        if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                                          if (((operand_31263->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (785))) != (operand_31277->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (785)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31263->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (786))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_31277->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (787))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (788)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_31263 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_31263) ;
                                          cPtr_typeGalgas_enum * operand_31277 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_31277) ;
                                          if ((operand_31263 != NULL) && (operand_31277 != NULL)) {
                                            if (((operand_31263->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (793))) != (operand_31277->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (793)))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_31263->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (794))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_31277->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (795))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (796)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (799))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (800)))) SOURCE_FILE_AT_LINE (800)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (816))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (816)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (817)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (818))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (818)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (819)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_35710 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35795 = var_cas_t2.firstObject () ;
    while ((operand_35710 != NULL)
        && (operand_35795 != NULL)) {
      macroValidPointer (operand_35710) ;
      macroValidPointer (operand_35795) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35710->mType,  operand_35795->mAttributType,  operand_35710->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (823)) SOURCE_FILE_AT_LINE (823)) ;
      operand_35710 = operand_35710->nextObject () ;
      operand_35795 = operand_35795->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (841))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (841)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (842)) ;
      ...
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (844)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_37029 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37158 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_37029 != NULL)
        && (operand_37158 != NULL)) {
      macroValidPointer (operand_37029) ;
      macroValidPointer (operand_37158) ;
      if (operand_37029->mFormalArgumentPassingMode.isBuilt () && operand_37158->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_37029->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37158->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37029->mType,  operand_37158->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (851)) ;
        }else{
          if ((operand_37029->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37158->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37029->mType,  operand_37158->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (853)) ;
          }else{
            if ((operand_37029->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37158->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37029->mType,  operand_37158->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (855)) ;
            }else{
              if ((operand_37029->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37158->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37158->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37158->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37029->mType,  operand_37158->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (860)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_37158->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (863))) + (GGS_string (true, " is not compatible with ")))) + (operand_37029->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (864)))) SOURCE_FILE_AT_LINE (864)) ;
              }
            }
          }
        }
      }
      operand_37029 = operand_37029->nextObject () ;
      operand_37158 = operand_37158->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38419 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38487 = var_cas_expressionList.firstObject () ;
    while ((operand_38419 != NULL)
        && (operand_38487 != NULL)) {
      macroValidPointer (operand_38419) ;
      macroValidPointer (operand_38487) ;
      if (operand_38487->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_38487->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_38572 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38487->mExpression.getPtr ()) ;
          macroValidPointer (operand_38572) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_38572->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38419->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_38487->mExpression) ;
        }
      }
      operand_38419 = operand_38419->nextObject () ;
      operand_38487 = operand_38487->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (915)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1267)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1272)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1277)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1282)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1287)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1292)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1297)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1302)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1307)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1312)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1317)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1322)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1327)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1332)) ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1486)) ;
  GGS_stringset::element_type * operand_63769 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63769 != NULL)) {
    macroValidPointer (operand_63769) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63769->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1488)) ;
    operand_63769 = operand_63769->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1490)) ;
  GGS_stringset::element_type * operand_64066 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_64066 != NULL)) {
    macroValidPointer (operand_64066) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64066->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1492)) ;
    operand_64066 = operand_64066->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1502)) ;
  GGS_stringset::element_type * operand_64602 = var_cas_missingDefinition.firstObject () ;
  while ((operand_64602 != NULL)) {
    macroValidPointer (operand_64602) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64602->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1504)) ;
    operand_64602 = operand_64602->nextObject () ;
  }
}
