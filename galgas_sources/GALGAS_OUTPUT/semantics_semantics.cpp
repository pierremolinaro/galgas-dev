...
cPtr_typeLocationAutomaticName::cPtr_typeLocationAutomaticName (const GGS_uint & argument_0 COMMA_LOCATION_ARGS)
:cPtr_typeCplusPlusName (THERE),
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSequenceNumber.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
void GGS_typeVariablesMap::method_insertUsedConstInArgumentNoShadow (C_Lexique & _inLexique,
                                const GGS_lstring & inKey,
                                const GGS_AC_galgasType &  inParameter0,
                                const GGS_typeCplusPlusName &  inParameter1 COMMA_LOCATION_ARGS) {
  e_typeVariablesMap info ;
...
void GGS_typeVariablesMap::method_insertUsedConstInArgumentNoShadowGetIndex (C_Lexique & _inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_galgasType &  inParameter0,
                                const GGS_typeCplusPlusName &  inParameter1 COMMA_LOCATION_ARGS) {
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertUsedConstInArgumentNoShadow (_inLexique, info, inKey, inKey, "the variable '%' is already declared" COMMA_THERE) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_typeReaderCallInstruction * _p = dynamic_cast <const cPtr_typeReaderCallInstruction *> (inOperand) ;
    macroValidPointer (_p) ;
...
GGS_typeCplusPlusName  GGS_typeReaderCallInstruction::
reader_aNomCppVariable (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeReaderCallInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeReaderCallInstruction *) mPointer)->aNomCppVariable ;
  }
  return result ;
}
...
GGS_lstring  GGS_typeReaderCallInstruction::
reader_aNomMethodeSimple (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeReaderCallInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeReaderCallInstruction *) mPointer)->aNomMethodeSimple ;
  }
  return result ;
}
...
GGS_typeExpressionList  GGS_typeReaderCallInstruction::
reader_mExpressionsList (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeReaderCallInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeReaderCallInstruction *) mPointer)->mExpressionsList ;
  }
  return result ;
}
...
GGS_bool GGS_typeReaderCallInstruction::
operator == (const GGS_typeReaderCallInstruction & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), mPointer == inOperand.mPointer) ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mConversionMethod.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
cPtr_typeJokerInExpression::cPtr_typeJokerInExpression (LOCATION_ARGS)
:cPtr_typeExpression (THERE) {
}
...
constructor_new (C_Lexique & /* inLexique */ COMMA_LOCATION_ARGS) {
  ...
  macroMyNew (_ptr, cPtr_typeJokerInExpression (THERE)) ;
...
cPtr_C_dotEqualInstruction::cPtr_C_dotEqualInstruction (const GGS_typeCplusPlusName & argument_0,
                                const GGS_typeExpression & argument_1,
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSourceExpressionConverter.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
constructor_new (C_Lexique & /* inLexique */,
                 ...
                 const GGS_typeExpression & argument_1,
                 const GGS_string& argument_2 COMMA_LOCATION_ARGS) {
  cPtr_C_dotEqualInstruction * _ptr = (cPtr_C_dotEqualInstruction *) NULL ;
  macroMyNew (_ptr, cPtr_C_dotEqualInstruction (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_32043 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_32128 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_32043 != NULL)
      && (operand_32128 != NULL)) {
    macroValidPointer (operand_32043) ;
    macroValidPointer (operand_32128) ;
    if (((operand_32043->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (782))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_32128->mAttributType._isBuilt ()) {
        operand_32128->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (784)) ;
      }
      if (((operand_32043->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (785))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_32128->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_32043->mName, operand_32128->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (792)) ;
      }else{
        operand_32043->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_32043->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (794))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (796)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_32043 = operand_32043->nextObject () ;
    operand_32128 = operand_32128->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (801))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (801)))) & ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (803)).reader_string (_inLexique SOURCE_FILE_AT_LINE (803))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (804)).reader_string (_inLexique SOURCE_FILE_AT_LINE (804))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (805)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (805))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (805)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (807)).reader_string (_inLexique SOURCE_FILE_AT_LINE (807))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (808)).reader_string (_inLexique SOURCE_FILE_AT_LINE (808))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (809)) ;
  }
}
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (824))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (824)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (826)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (826))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (826)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (828)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_34434 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34515 = var_cas_t2.firstObject () ;
    while ((operand_34434 != NULL)
        && (operand_34515 != NULL)) {
      macroValidPointer (operand_34434) ;
      macroValidPointer (operand_34515) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_34434->mType,  operand_34515->mAttributType,  operand_34434->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (834)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (832)) ;
      operand_34434 = operand_34434->nextObject () ;
      operand_34515 = operand_34515->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (854))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (854)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (856)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (856))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (856)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (858)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_35788 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_35913 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35788 != NULL)
        && (operand_35913 != NULL)) {
      macroValidPointer (operand_35788) ;
      macroValidPointer (operand_35913) ;
      if (operand_35788->mFormalArgumentPassingMode._isBuilt () && operand_35913->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_35788->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_35913->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35788->mType,  operand_35913->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (864)) ;
        }else{
          if ((operand_35788->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_35913->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35788->mType,  operand_35913->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (866)) ;
          }else{
            if ((operand_35788->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_35913->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35788->mType,  operand_35913->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (868)) ;
            }else{
              if ((operand_35788->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_35913->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_35913->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_36587 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_35913->mType.getPtr ()) ;
                  if (operand_36587 != NULL) {
                    macroValidPointer (operand_36587) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35788->mType,  operand_35913->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (873)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_35913->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (876))) + (GGS_string (true, " is not compatible with ")))) + (operand_35788->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (877)))) SOURCE_FILE_AT_LINE (878)) ;
              }
            }
          }
        }
      }
      operand_35788 = operand_35788->nextObject () ;
      operand_35913 = operand_35913->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37180 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37244 = var_cas_expressionList.firstObject () ;
    while ((operand_37180 != NULL)
        && (operand_37244 != NULL)) {
      macroValidPointer (operand_37180) ;
      macroValidPointer (operand_37244) ;
      if (operand_37244->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_37327 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37244->mExpression.getPtr ()) ;
        if (operand_37327 != NULL) {
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37180->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_37244->mExpression) ;
        }
      }
      operand_37180 = operand_37180->nextObject () ;
      operand_37244 = operand_37244->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  aPositionVariableCible,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (931)) ;
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  ...
  if (equal) {
    ...
    equal = (aNomListe == _p->aNomListe).boolValue ()
         ...
         && (mExternAttributesList == _p->mExternAttributesList).boolValue () ;
  }
  return equal ;
}
...
GGS_L_nameWithType  GGS_C_listTypeToImplement::
reader_mExternAttributesList (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_L_nameWithType   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_C_listTypeToImplement *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_C_listTypeToImplement *) mPointer)->mExternAttributesList ;
  }
  return result ;
}
...
GGS_L_nameWithType  GGS_typeDefinitionTableAimplementer::
reader_mExternAttributesList (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_L_nameWithType   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefinitionTableAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefinitionTableAimplementer *) mPointer)->mExternAttributesList ;
  }
  return result ;
}
...
GGS_L_nameWithType  GGS_C_mapToImplement::
reader_mExternAttributesList (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_L_nameWithType   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_C_mapToImplement *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_C_mapToImplement *) mPointer)->mExternAttributesList ;
  }
  return result ;
}
...
reader_mClassName (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_C_classToImplement *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_C_classToImplement *) mPointer)->mClassName ;
  }
  return result ;
}
...
bool cPtr_typeDefClasseAbstraiteAimplementer::
isEqualToObject (const C_GGS_Object * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_typeDefClasseAbstraiteAimplementer * _p = dynamic_cast <const cPtr_typeDefClasseAbstraiteAimplementer *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = (aNomClasse == _p->aNomClasse).boolValue ()
         ...
         && (aListeExternesCourants == _p->aListeExternesCourants).boolValue ()
         && (mAncestorClassesMap == _p->mAncestorClassesMap).boolValue ()
...
GGS_lstring  GGS_typeDefClasseAbstraiteAimplementer::
reader_aNomClasse (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->aNomClasse ;
  }
  return result ;
}
...
GGS_typeListeAttributsSemantiques  GGS_typeDefClasseAbstraiteAimplementer::
reader_aListeTousAttributsNonExternes (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->aListeTousAttributsNonExternes ;
  }
  return result ;
}
...
GGS_typeTableMethodes  GGS_typeDefClasseAbstraiteAimplementer::
reader_aTableToutesMethodes (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->aTableToutesMethodes ;
  }
  return result ;
}
...
GGS_typeTableMethodesAimplementer  GGS_typeDefClasseAbstraiteAimplementer::
reader_mMethodsMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->mMethodsMap ;
  }
  return result ;
}
...
reader_aListeAttributsCourants (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->aListeAttributsCourants ;
  }
  return result ;
}
...
GGS_L_nameWithType  GGS_typeDefClasseAbstraiteAimplementer::
reader_aListeExternesCourants (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_L_nameWithType   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->aListeExternesCourants ;
  }
  return result ;
}
...
GGS_typeSuperClassesMap  GGS_typeDefClasseAbstraiteAimplementer::
reader_mAncestorClassesMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeSuperClassesMap   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->mAncestorClassesMap ;
  }
  return result ;
}
...
GGS_typeClassMessagesMap  GGS_typeDefClasseAbstraiteAimplementer::
reader_mMessagesMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDefClasseAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseAbstraiteAimplementer *) mPointer)->mMessagesMap ;
  }
  return result ;
}
...
GGS_bool GGS_typeDefClasseAbstraiteAimplementer::
operator == (const GGS_typeDefClasseAbstraiteAimplementer & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), mPointer == inOperand.mPointer) ;
}
...
bool cPtr_typeDefClasseNonAbstraiteAimplementer::
isEqualToObject (const C_GGS_Object * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_typeDefClasseNonAbstraiteAimplementer * _p = dynamic_cast <const cPtr_typeDefClasseNonAbstraiteAimplementer *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = (aNomClasse == _p->aNomClasse).boolValue ()
         && (aListeTousAttributsNonExternes == _p->aListeTousAttributsNonExternes).boolValue ()
         && (aTableToutesMethodes == _p->aTableToutesMethodes).boolValue ()
...
GGS_lstring  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_aNomClasse (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->aNomClasse ;
  }
  return result ;
}
...
GGS_typeListeAttributsSemantiques  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_aListeTousAttributsNonExternes (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeListeAttributsSemantiques   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->aListeTousAttributsNonExternes ;
  }
  return result ;
}
...
GGS_typeTableMethodes  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_aTableToutesMethodes (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeTableMethodes   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->aTableToutesMethodes ;
  }
  return result ;
}
...
GGS_typeTableMethodesAimplementer  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_mMethodsMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeTableMethodesAimplementer   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->mMethodsMap ;
  }
  return result ;
}
...
reader_aListeAttributsCourants (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->aListeAttributsCourants ;
  }
  return result ;
}
...
GGS_L_nameWithType  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_aListeExternesCourants (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_L_nameWithType   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->aListeExternesCourants ;
  }
  return result ;
}
...
GGS_typeSuperClassesMap  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_mAncestorClassesMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeSuperClassesMap   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->mAncestorClassesMap ;
  }
  return result ;
}
...
GGS_typeClassMessagesMap  GGS_typeDefClasseNonAbstraiteAimplementer::
reader_mMessagesMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeClassMessagesMap   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeDefClasseNonAbstraiteAimplementer *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDefClasseNonAbstraiteAimplementer *) mPointer)->mMessagesMap ;
  }
  return result ;
}
...
GGS_bool GGS_typeDefClasseNonAbstraiteAimplementer::
operator == (const GGS_typeDefClasseNonAbstraiteAimplementer & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), mPointer == inOperand.mPointer) ;
}
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1307)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1310)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1313)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1316)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1319)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1322)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1325)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1328)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1331)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1334)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1337)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1340)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1343)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1346)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1349)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1352)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1355)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1358)) ;
}
...
bool elementOf_GGS_representativeEntityMap::
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_representativeEntityMap * _p = dynamic_cast <const elementOf_GGS_representativeEntityMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.mRepresentativeEntityName == _p->mInfo.mRepresentativeEntityName).boolValue ()
...
GGS_bool GGS_representativeEntityMap::
operator == (const GGS_representativeEntityMap & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToMap (inOperand)) ;
}
...
bool elementOf_GGS_callInstructionSharedPropertySignatureMap::
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_callInstructionSharedPropertySignatureMap * _p = dynamic_cast <const elementOf_GGS_callInstructionSharedPropertySignatureMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.mEffectiveArgumentList == _p->mInfo.mEffectiveArgumentList).boolValue ()
           && (mInfo.mSignatureLocation == _p->mInfo.mSignatureLocation).boolValue () ;
}
...
GGS_bool GGS_callInstructionSharedPropertySignatureMap::
operator == (const GGS_callInstructionSharedPropertySignatureMap & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToMap (inOperand)) ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mEndOfInstructionList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}

//---------------------------------------------------------------------------*

bool elementOf_GGS_constraintInstructionListMap::
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_constraintInstructionListMap * _p = dynamic_cast <const elementOf_GGS_constraintInstructionListMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.instructionsList == _p->mInfo.instructionsList).boolValue ()
           && (mInfo.mCallInstructionSharedPropertySignatureMap == _p->mInfo.mCallInstructionSharedPropertySignatureMap).boolValue ()
           && (mInfo.mEndOfInstructionList == _p->mInfo.mEndOfInstructionList).boolValue () ;
}
...
GGS_bool GGS_constraintInstructionListMap::
operator == (const GGS_constraintInstructionListMap & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToMap (inOperand)) ;
}
...
insertElement (C_Lexique & inLexique,
  ...
  if (_isBuilt ()
   ...
   && inKey._isBuilt ()) {
    ...
    info.mEndOfInstructionList = inParameter2 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mSharedMapRoot->_mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter2 = node->mInfo.mEndOfInstructionList ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  ...
  if (equal) {
    ...
    equal = (mCalledPropertyName == _p->mCalledPropertyName).boolValue ()
         && (mProperty == _p->mProperty).boolValue ()
...
GGS_metamodelProperty  GGS_callInstruction::
reader_mProperty (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_metamodelProperty   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_callInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_callInstruction *) mPointer)->mProperty ;
  }
  return result ;
}
...
GGS_L_lstringList  GGS_callInstruction::
reader_mParameterList (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_callInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_callInstruction *) mPointer)->mParameterList ;
  }
  return result ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1460)) ;
  GGS_stringset::element_type * operand_61472 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61472 != NULL)) {
    macroValidPointer (operand_61472) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61472->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1463)) ;
    operand_61472 = operand_61472->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1464)) ;
  GGS_stringset::element_type * operand_61767 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61767 != NULL)) {
    macroValidPointer (operand_61767) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61767->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1467)) ;
    operand_61767 = operand_61767->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1476)) ;
  GGS_stringset::element_type * operand_62301 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62301 != NULL)) {
    macroValidPointer (operand_62301) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62301->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1479)) ;
    operand_62301 = operand_62301->nextObject () ;
  }
}
