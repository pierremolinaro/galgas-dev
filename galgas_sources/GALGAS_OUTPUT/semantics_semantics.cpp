...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_27803 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_27892 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_27803 != NULL)
      && (operand_27892 != NULL)) {
    macroValidPointer (operand_27803) ;
    macroValidPointer (operand_27892) ;
    if (((operand_27803->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_27892->mAttributType.isBuilt ()) {
        operand_27892->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_27803->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_27892->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        insertUsedConstInArgument_typeVariablesMap (lexique_var_,
                                        var_cas_ioVariablesMap,
                                        operand_27803->mName,
                                        operand_27892->mAttributType,
                                        var_cas_cppName,
                                        NULL) ;
      }else{
          operand_27803->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_27803->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_27803 = operand_27803->nextObject () ;
    operand_27892 = operand_27892->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_29568 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_29582 = var_cas_sourceType () ;
    cPtr_typeGalgas_uint * operand_29568 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29568) ;
    cPtr_typeGalgas_uint * operand_29582 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29582) ;
    if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_29568 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29568) ;
      cPtr_typeGalgas_sint * operand_29582 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29582) ;
      if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_29568 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29568) ;
        cPtr_typeGalgas_char * operand_29582 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29582) ;
        if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_29568 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29568) ;
          cPtr_typeGalgas_string * operand_29582 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29582) ;
          if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_29568 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29568) ;
            cPtr_typeGalgas_bool * operand_29582 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29582) ;
            if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_29568 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_29568) ;
              cPtr_typeGalgas_double * operand_29582 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_29582) ;
              if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
              }else{
                cPtr_typeGalgas_ldouble * operand_29568 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_29568) ;
                cPtr_typeGalgas_ldouble * operand_29582 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_29582) ;
                if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                }else{
                  cPtr_typeGalgas_location * operand_29568 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29568) ;
                  cPtr_typeGalgas_location * operand_29582 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29582) ;
                  if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_29568 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29568) ;
                    cPtr_typeGalgas_lchar * operand_29582 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29582) ;
                    if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_29568 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29568) ;
                      cPtr_typeGalgas_luint * operand_29582 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29582) ;
                      if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_29568 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29568) ;
                        cPtr_typeGalgas_lsint * operand_29582 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29582) ;
                        if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_29568 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29568) ;
                          cPtr_typeGalgas_lstring * operand_29582 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29582) ;
                          if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lbool * operand_29568 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29568) ;
                            cPtr_typeGalgas_lbool * operand_29582 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29582) ;
                            if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedExternType * operand_29568 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29568) ;
                              cPtr_typeGalgasUndefinedExternType * operand_29582 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29582) ;
                              if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                                if (((operand_29568->mGalgasClassName.reader_value ()) != (operand_29582->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_29568->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_29582->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_29568 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29568) ;
                                cPtr_typeGalgasUndefinedListType * operand_29582 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29582) ;
                                if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                                  if (((operand_29568->mListTypeName.reader_value ()) != (operand_29582->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29568->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_29582->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasClassType * operand_29568 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29568) ;
                                  cPtr_typeGalgasClassType * operand_29582 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29582) ;
                                  if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                                    if (((operand_29568->mClassTypeName.reader_value ()) == (operand_29582->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    }else if (((! operand_29582->mAncestorClassesMap.reader_hasKey (operand_29568->mClassTypeName))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_29582->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_29582->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_29568 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29568) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_29582 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29582) ;
                                    if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                                      if (((operand_29568->mClassTypeName.reader_value ()) != (operand_29582->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29568->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_29582->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedMapType * operand_29568 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29568) ;
                                      cPtr_typeGalgasUndefinedMapType * operand_29582 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29582) ;
                                      if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                                        if (((operand_29568->mMapTypeName.reader_value ()) != (operand_29582->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29568->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_29582->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_29568 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29568) ;
                                        cPtr_typeGalgas_enum * operand_29582 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29582) ;
                                        if ((operand_29568 != NULL) && (operand_29582 != NULL)) {
                                          if (((operand_29568->mEnumTypeName.reader_value ()) != (operand_29582->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_29568->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_29582->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_33945 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34030 = var_cas_t2.firstObject () ;
    while ((operand_33945 != NULL)
        && (operand_34030 != NULL)) {
      macroValidPointer (operand_33945) ;
      macroValidPointer (operand_34030) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33945->mType,  operand_34030->mAttributType,  operand_33945->mGalgasVariableName.reader_location ()) ;
      operand_33945 = operand_33945->nextObject () ;
      operand_34030 = operand_34030->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_35263 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_35392 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35263 != NULL)
        && (operand_35392 != NULL)) {
      macroValidPointer (operand_35263) ;
      macroValidPointer (operand_35392) ;
      if (operand_35263->mFormalArgumentPassingMode.isBuilt () && operand_35392->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_35263->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_35392->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35263->mType,  operand_35392->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_35263->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_35392->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35263->mType,  operand_35392->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_35263->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_35392->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35263->mType,  operand_35392->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_35263->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_35392->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_35392->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_35392->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35263->mType,  operand_35392->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_35392->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_35263->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      ...
      operand_35392 = operand_35392->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_36649 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_36717 = var_cas_expressionList.firstObject () ;
    while ((operand_36649 != NULL)
        && (operand_36717 != NULL)) {
      macroValidPointer (operand_36649) ;
      macroValidPointer (operand_36717) ;
      if (operand_36717->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_36717->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_36802 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_36717->mExpression.getPtr ()) ;
          macroValidPointer (operand_36802) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_36802->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_36649->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_36717->mExpression) ;
        }
      }
      operand_36649 = operand_36649->nextObject () ;
      operand_36717 = operand_36717->nextObject () ;
    }
  }
}
