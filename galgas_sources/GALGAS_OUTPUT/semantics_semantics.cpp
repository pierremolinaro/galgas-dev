...
insertElement (C_Lexique & inLexique,
  ...
  if (_isBuilt ()
   ...
   && inParameter8._isBuilt ()
   && inParameter9._isBuilt ()
   && inParameter10._isBuilt ()
   && inKey._isBuilt ()) {
    insulateMap () ;
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter8._drop_operation () ;
    outParameter9._drop_operation () ;
    outParameter10._drop_operation () ;
    if (outIndex != NULL) {
      outIndex->_drop_operation () ;
     }
  }else{
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1468)) ;
  GGS_stringset::element_type * operand_61408 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61408 != NULL)) {
    macroValidPointer (operand_61408) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61408->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1471)) ;
    operand_61408 = operand_61408->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1472)) ;
  GGS_stringset::element_type * operand_61705 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61705 != NULL)) {
    macroValidPointer (operand_61705) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61705->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1475)) ;
    operand_61705 = operand_61705->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1484)) ;
  GGS_stringset::element_type * operand_62241 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62241 != NULL)) {
    macroValidPointer (operand_62241) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62241->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1487)) ;
    operand_62241 = operand_62241->nextObject () ;
  }
}
