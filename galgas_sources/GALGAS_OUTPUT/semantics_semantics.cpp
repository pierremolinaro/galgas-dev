...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_25775 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25864 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25775 != NULL)
      && (operand_25864 != NULL)) {
    macroValidPointer (operand_25775) ;
    macroValidPointer (operand_25864) ;
    if (((operand_25775->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25864->mAttributType.isBuilt ()) {
        operand_25864->mAttributType (HERE)->methode_getTypeName (_inLexique, var_cas_typeName) ;
      }
      if (((operand_25775->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25864->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (_inLexique, operand_25775->mName, operand_25864->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (631)) ;
      }else{
          operand_25775->mType.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_25775->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (634)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_25775 = operand_25775->nextObject () ;
    operand_25864 = operand_25864->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length ()) < (var_cas_inSemanticAttributsList.reader_length ())) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length ().reader_string ()))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length ().reader_string ()))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (643)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length ()) > (var_cas_inSemanticAttributsList.reader_length ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length ().reader_string ()))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length ().reader_string ()))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (647)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27893 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27907 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27893 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27893) ;
    cPtr_typeGalgas_stringset * operand_27907 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27907) ;
    if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27893 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27893) ;
      cPtr_typeGalgas_uint * operand_27907 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27907) ;
      if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27893 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27893) ;
        cPtr_typeGalgas_sint * operand_27907 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27907) ;
        if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27893 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27893) ;
          cPtr_typeGalgas_char * operand_27907 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27907) ;
          if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27893 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27893) ;
            cPtr_typeGalgas_string * operand_27907 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27907) ;
            if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27893 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27893) ;
              cPtr_typeGalgas_bool * operand_27907 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27907) ;
              if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27893 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27893) ;
                cPtr_typeGalgas_double * operand_27907 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27907) ;
                if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27893 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27893) ;
                  cPtr_typeGalgas_ldouble * operand_27907 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27907) ;
                  if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27893 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27893) ;
                    cPtr_typeGalgas_location * operand_27907 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27907) ;
                    if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27893 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27893) ;
                      cPtr_typeGalgas_lchar * operand_27907 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27907) ;
                      if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27893 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27893) ;
                        cPtr_typeGalgas_luint * operand_27907 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27907) ;
                        if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27893 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27893) ;
                          cPtr_typeGalgas_lsint * operand_27907 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27907) ;
                          if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27893 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27893) ;
                            cPtr_typeGalgas_lstring * operand_27907 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27907) ;
                            if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27893 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27893) ;
                              cPtr_typeGalgas_lbool * operand_27907 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27907) ;
                              if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27893 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27893) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27907 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27907) ;
                                if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                                  if (((operand_27893->mGalgasClassName.reader_value ()) != (operand_27907->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27893->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27907->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (688)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27893 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27893) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27907 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27907) ;
                                  if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                                    if (((operand_27893->mListTypeName.reader_value ()) != (operand_27907->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27893->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27907->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (694)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27893 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27893) ;
                                    cPtr_typeGalgasClassType * operand_27907 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27907) ;
                                    if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                                      if (((operand_27893->mClassTypeName.reader_value ()) == (operand_27907->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! (operand_27907->mAncestorClassesMap.reader_hasKey (operand_27893->mClassTypeName.reader_value ())))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_27907->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27907->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (702)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27893 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27893) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27907 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27907) ;
                                      if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                                        if (((operand_27893->mClassTypeName.reader_value ()) != (operand_27907->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27893->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27907->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (708)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27893 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27893) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27907 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27907) ;
                                        if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                                          if (((operand_27893->mMapTypeName.reader_value ()) != (operand_27907->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27893->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27907->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (715)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27893 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27893) ;
                                          cPtr_typeGalgas_enum * operand_27907 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27907) ;
                                          if ((operand_27893 != NULL) && (operand_27907 != NULL)) {
                                            if (((operand_27893->mEnumTypeName.reader_value ()) != (operand_27907->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27893->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27907->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (723)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType ()) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (727)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (744)) ;
  }else if (((var_cas_t1.reader_length ()) > (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (746)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_32340 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32425 = var_cas_t2.firstObject () ;
    while ((operand_32340 != NULL)
        && (operand_32425 != NULL)) {
      macroValidPointer (operand_32340) ;
      macroValidPointer (operand_32425) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_32340->mType,  operand_32425->mAttributType,  operand_32340->mGalgasVariableName.reader_location () SOURCE_FILE_AT_LINE (750)) ;
      operand_32340 = operand_32340->nextObject () ;
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (769)) ;
  }else if (((var_cas_signatureReference.reader_length ()) < (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (771)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_33659 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33788 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33659 != NULL)
        && (operand_33788 != NULL)) {
      macroValidPointer (operand_33659) ;
      macroValidPointer (operand_33788) ;
      if (operand_33659->mFormalArgumentPassingMode.isBuilt () && operand_33788->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33659->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33788->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_33659->mType,  operand_33788->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (778)) ;
        }else{
          if ((operand_33659->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33788->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_33659->mType,  operand_33788->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (780)) ;
          }else{
            if ((operand_33659->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33788->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_33659->mType,  operand_33788->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (782)) ;
            }else{
              if ((operand_33659->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33788->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33788->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33788->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_33659->mType,  operand_33788->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (787)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((operand_33788->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33659->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (791)) ;
              }
            }
          }
        }
      }
      operand_33659 = operand_33659->nextObject () ;
      operand_33788 = operand_33788->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_35045 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35113 = var_cas_expressionList.firstObject () ;
    while ((operand_35045 != NULL)
        && (operand_35113 != NULL)) {
      macroValidPointer (operand_35045) ;
      macroValidPointer (operand_35113) ;
      if (operand_35113->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35113->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35198 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35113->mExpression.getPtr ()) ;
          macroValidPointer (operand_35198) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35198->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35045->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35113->mExpression) ;
        }
      }
      operand_35045 = operand_35045->nextObject () ;
      operand_35113 = operand_35113->nextObject () ;
    }
  }
}
...
methode_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (842)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1191)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1196)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1201)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1206)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1211)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1216)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1221)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1226)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1231)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1236)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1241)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1246)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1251)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1256)) ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_59491 = var_cas_missingDefinition.firstObject () ;
  while ((operand_59491 != NULL)) {
    macroValidPointer (operand_59491) ;
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59491->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1394)) ;
    operand_59491 = operand_59491->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_59788 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_59788 != NULL)) {
    macroValidPointer (operand_59788) ;
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59788->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1398)) ;
    operand_59788 = operand_59788->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_60324 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60324 != NULL)) {
    macroValidPointer (operand_60324) ;
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60324->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1410)) ;
    operand_60324 = operand_60324->nextObject () ;
  }
}
