...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_29351 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_29440 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_29351 != NULL)
      && (operand_29440 != NULL)) {
    macroValidPointer (operand_29351) ;
    macroValidPointer (operand_29440) ;
    if (((operand_29351->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (701))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_29440->mAttributType.isBuilt ()) {
        operand_29440->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (703)) ;
      }
      if (((operand_29351->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (704))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_29440->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_29351->mName, operand_29440->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (711)) ;
      }else{
          operand_29351->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_29351->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (713))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (714)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_29351 = operand_29351->nextObject () ;
    operand_29440 = operand_29440->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (720))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (720)))) & ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (722)).reader_string (_inLexique SOURCE_FILE_AT_LINE (722))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (723)).reader_string (_inLexique SOURCE_FILE_AT_LINE (723))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (723)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (724))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (724)))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (726)).reader_string (_inLexique SOURCE_FILE_AT_LINE (726))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (727)).reader_string (_inLexique SOURCE_FILE_AT_LINE (727))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (727)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_31469 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_31483 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_31469 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_31469) ;
    cPtr_typeGalgas_stringset * operand_31483 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_31483) ;
    if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_31469 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_31469) ;
      cPtr_typeGalgas_uint * operand_31483 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_31483) ;
      if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_31469 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_31469) ;
        cPtr_typeGalgas_sint * operand_31483 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_31483) ;
        if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_31469 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_31469) ;
          cPtr_typeGalgas_char * operand_31483 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_31483) ;
          if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_31469 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_31469) ;
            cPtr_typeGalgas_string * operand_31483 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_31483) ;
            if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_31469 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_31469) ;
              cPtr_typeGalgas_bool * operand_31483 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_31483) ;
              if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_31469 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_31469) ;
                cPtr_typeGalgas_double * operand_31483 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_31483) ;
                if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_31469 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_31469) ;
                  cPtr_typeGalgas_ldouble * operand_31483 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_31483) ;
                  if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_31469 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_31469) ;
                    cPtr_typeGalgas_location * operand_31483 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_31483) ;
                    if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_31469 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_31469) ;
                      cPtr_typeGalgas_lchar * operand_31483 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_31483) ;
                      if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_31469 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_31469) ;
                        cPtr_typeGalgas_luint * operand_31483 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_31483) ;
                        if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_31469 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_31469) ;
                          cPtr_typeGalgas_lsint * operand_31483 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_31483) ;
                          if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_31469 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_31469) ;
                            cPtr_typeGalgas_lstring * operand_31483 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_31483) ;
                            if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_31469 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_31469) ;
                              cPtr_typeGalgas_lbool * operand_31483 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_31483) ;
                              if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_31469 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_31469) ;
                                cPtr_typeGalgasUndefinedExternType * operand_31483 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_31483) ;
                                if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                                  if (((operand_31469->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766))) != (operand_31483->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_31469->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_31483->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (768))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (768)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_31469 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_31469) ;
                                  cPtr_typeGalgasUndefinedListType * operand_31483 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_31483) ;
                                  if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                                    if (((operand_31469->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (772))) != (operand_31483->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (772)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31469->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_31483->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (774))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (774)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_31469 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_31469) ;
                                    cPtr_typeGalgasClassType * operand_31483 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_31483) ;
                                    if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                                      if (((operand_31469->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779))) == (operand_31483->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_31483->mAncestorClassesMap.reader_hasKey (_inLexique, operand_31469->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (780)) SOURCE_FILE_AT_LINE (780))))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_31483->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (781))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_31483->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (782))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (782)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_31469 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_31469) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_31483 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_31483) ;
                                      if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                                        if (((operand_31469->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (786))) != (operand_31483->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (786)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31469->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (787))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_31483->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (788))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (788)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_31469 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_31469) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_31483 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_31483) ;
                                        if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                                          if (((operand_31469->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (792))) != (operand_31483->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (792)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31469->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (793))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_31483->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (794))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (795)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_31469 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_31469) ;
                                          cPtr_typeGalgas_enum * operand_31483 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_31483) ;
                                          if ((operand_31469 != NULL) && (operand_31483 != NULL)) {
                                            if (((operand_31469->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (800))) != (operand_31483->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (800)))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_31469->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (801))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_31483->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (802))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (803)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (806))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (807)))) SOURCE_FILE_AT_LINE (807)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (823))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (823)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (824)) ;
      ...
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (826)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_35916 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_36001 = var_cas_t2.firstObject () ;
    while ((operand_35916 != NULL)
        && (operand_36001 != NULL)) {
      macroValidPointer (operand_35916) ;
      macroValidPointer (operand_36001) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35916->mType,  operand_36001->mAttributType,  operand_35916->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (830)) SOURCE_FILE_AT_LINE (830)) ;
      operand_35916 = operand_35916->nextObject () ;
      operand_36001 = operand_36001->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (848))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (848)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (849)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (850))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (850)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (851)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_37235 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37364 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_37235 != NULL)
        && (operand_37364 != NULL)) {
      macroValidPointer (operand_37235) ;
      macroValidPointer (operand_37364) ;
      if (operand_37235->mFormalArgumentPassingMode.isBuilt () && operand_37364->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_37235->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37364->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37235->mType,  operand_37364->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (858)) ;
        }else{
          if ((operand_37235->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37364->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37235->mType,  operand_37364->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (860)) ;
          }else{
            if ((operand_37235->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37364->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37235->mType,  operand_37364->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (862)) ;
            }else{
              if ((operand_37235->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37364->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37364->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37364->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37235->mType,  operand_37364->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (867)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_37364->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (870))) + (GGS_string (true, " is not compatible with ")))) + (operand_37235->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (871)))) SOURCE_FILE_AT_LINE (871)) ;
              }
            }
          }
        }
      }
      operand_37235 = operand_37235->nextObject () ;
      operand_37364 = operand_37364->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38625 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38693 = var_cas_expressionList.firstObject () ;
    while ((operand_38625 != NULL)
        && (operand_38693 != NULL)) {
      macroValidPointer (operand_38625) ;
      macroValidPointer (operand_38693) ;
      if (operand_38693->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_38693->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_38778 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38693->mExpression.getPtr ()) ;
          macroValidPointer (operand_38778) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_38778->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38625->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_38693->mExpression) ;
        }
      }
      operand_38625 = operand_38625->nextObject () ;
      operand_38693 = operand_38693->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (922)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1274)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1279)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1284)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1289)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1294)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1299)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1304)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1309)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1314)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1319)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1324)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1329)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1334)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1339)) ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1493)) ;
  GGS_stringset::element_type * operand_63975 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63975 != NULL)) {
    macroValidPointer (operand_63975) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63975->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1495)) ;
    operand_63975 = operand_63975->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1497)) ;
  GGS_stringset::element_type * operand_64272 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_64272 != NULL)) {
    macroValidPointer (operand_64272) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64272->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1499)) ;
    operand_64272 = operand_64272->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1509)) ;
  GGS_stringset::element_type * operand_64808 = var_cas_missingDefinition.firstObject () ;
  while ((operand_64808 != NULL)) {
    macroValidPointer (operand_64808) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64808->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1511)) ;
    operand_64808 = operand_64808->nextObject () ;
  }
}
