...
mAncestorClassesMap (argument_4),
...
GGS_typeSuperClassesMap  GGS_C_metamodelEntityToImplement::
reader_mAncestorClassesMap (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeSuperClassesMap   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_C_metamodelEntityToImplement *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_C_metamodelEntityToImplement *) mPointer)->mAncestorClassesMap ;
  }
  return result ;
}
