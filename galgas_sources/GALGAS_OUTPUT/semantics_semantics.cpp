...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1248)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1253)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1258)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1263)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1268)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1273)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1278)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1283)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1288)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1293)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1298)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1303)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1308)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1313)) ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1449)) ;
   ;
  GGS_stringset::element_type * operand_61972 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61972 != NULL)) {
    macroValidPointer (operand_61972) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61972->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1451)) ;
    operand_61972 = operand_61972->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1453)) ;
   ;
  GGS_stringset::element_type * operand_62269 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_62269 != NULL)) {
    macroValidPointer (operand_62269) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62269->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1455)) ;
    operand_62269 = operand_62269->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1465)) ;
   ;
  GGS_stringset::element_type * operand_62805 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62805 != NULL)) {
    macroValidPointer (operand_62805) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62805->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1467)) ;
