...
constructor_new (C_Lexique & /* inLexique */,
                 ...
                 const GGS_lstring & argument_1,
                 const GGS_typeExpressionList & argument_2 COMMA_LOCATION_ARGS) {
  cPtr_typeMethodCallInstruction * _ptr = (cPtr_typeMethodCallInstruction *) NULL ;
  macroMyNew (_ptr, cPtr_typeMethodCallInstruction (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
...
constructor_new (C_Lexique & /* inLexique */,
                 ...
                 const GGS_L_nameWithType & argument_2,
                 const GGS_sortDescriptorList & argument_3 COMMA_LOCATION_ARGS) {
  cPtr_C_sortedListTypeToImplement * _ptr = (cPtr_C_sortedListTypeToImplement *) NULL ;
  macroMyNew (_ptr, cPtr_C_sortedListTypeToImplement (argument_0,
                                argument_1,
                                argument_2,
                                argument_3 COMMA_THERE)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1338)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1341)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1443)) ;
  GGS_stringset::element_type * operand_60763 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60763 != NULL)) {
    macroValidPointer (operand_60763) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60763->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1446)) ;
    operand_60763 = operand_60763->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1447)) ;
  GGS_stringset::element_type * operand_61058 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61058 != NULL)) {
    macroValidPointer (operand_61058) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61058->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1450)) ;
    operand_61058 = operand_61058->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  #endif
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1459)) ;
  GGS_stringset::element_type * operand_61592 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61592 != NULL)) {
    macroValidPointer (operand_61592) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61592->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1462)) ;
    operand_61592 = operand_61592->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
