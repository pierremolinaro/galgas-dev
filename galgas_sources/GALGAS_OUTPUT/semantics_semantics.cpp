...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1450)) ;
  GGS_stringset::element_type * operand_61072 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61072 != NULL)) {
    macroValidPointer (operand_61072) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61072->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1453)) ;
    operand_61072 = operand_61072->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1454)) ;
  GGS_stringset::element_type * operand_61367 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61367 != NULL)) {
    macroValidPointer (operand_61367) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61367->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1457)) ;
    operand_61367 = operand_61367->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  #endif
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1466)) ;
  GGS_stringset::element_type * operand_61901 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61901 != NULL)) {
    macroValidPointer (operand_61901) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61901->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1469)) ;
    operand_61901 = operand_61901->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
