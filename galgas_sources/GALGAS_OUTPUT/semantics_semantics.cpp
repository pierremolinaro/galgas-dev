...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25813 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25902 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25813 != NULL)
      && (operand_25902 != NULL)) {
    macroValidPointer (operand_25813) ;
    macroValidPointer (operand_25902) ;
    if (((operand_25813->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25902->mAttributType.isBuilt ()) {
        operand_25902->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25813->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25902->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25813->mName, operand_25902->mAttributType, var_cas_cppName) ;
      }else{
          operand_25813->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25813->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25813 = operand_25813->nextObject () ;
    operand_25902 = operand_25902->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27925 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27939 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27925 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27925) ;
    cPtr_typeGalgas_stringset * operand_27939 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27939) ;
    if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27925 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27925) ;
      cPtr_typeGalgas_uint * operand_27939 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27939) ;
      if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27925 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27925) ;
        cPtr_typeGalgas_sint * operand_27939 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27939) ;
        if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27925 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27925) ;
          cPtr_typeGalgas_char * operand_27939 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27939) ;
          if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27925 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27925) ;
            cPtr_typeGalgas_string * operand_27939 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27939) ;
            if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27925 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27925) ;
              cPtr_typeGalgas_bool * operand_27939 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27939) ;
              if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27925 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27925) ;
                cPtr_typeGalgas_double * operand_27939 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27939) ;
                if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27925 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27925) ;
                  cPtr_typeGalgas_ldouble * operand_27939 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27939) ;
                  if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27925 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27925) ;
                    cPtr_typeGalgas_location * operand_27939 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27939) ;
                    if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27925 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27925) ;
                      cPtr_typeGalgas_lchar * operand_27939 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27939) ;
                      if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27925 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27925) ;
                        cPtr_typeGalgas_luint * operand_27939 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27939) ;
                        if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27925 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27925) ;
                          cPtr_typeGalgas_lsint * operand_27939 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27939) ;
                          if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27925 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27925) ;
                            cPtr_typeGalgas_lstring * operand_27939 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27939) ;
                            if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27925 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27925) ;
                              cPtr_typeGalgas_lbool * operand_27939 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27939) ;
                              if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27925 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27925) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27939 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27939) ;
                                if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                                  if (((operand_27925->mGalgasClassName.reader_value ()) != (operand_27939->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27925->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27939->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27925 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27925) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27939 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27939) ;
                                  if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                                    if (((operand_27925->mListTypeName.reader_value ()) != (operand_27939->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27925->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27939->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27925 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27925) ;
                                    cPtr_typeGalgasClassType * operand_27939 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27939) ;
                                    if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                                      if (((operand_27925->mClassTypeName.reader_value ()) == (operand_27939->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27939->mAncestorClassesMap.reader_hasKey (operand_27925->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27939->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27939->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27925 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27925) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27939 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27939) ;
                                      if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                                        if (((operand_27925->mClassTypeName.reader_value ()) != (operand_27939->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27925->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27939->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27925 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27925) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27939 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27939) ;
                                        if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                                          if (((operand_27925->mMapTypeName.reader_value ()) != (operand_27939->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27925->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27939->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27925 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27925) ;
                                          cPtr_typeGalgas_enum * operand_27939 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27939) ;
                                          if ((operand_27925 != NULL) && (operand_27939 != NULL)) {
                                            if (((operand_27925->mEnumTypeName.reader_value ()) != (operand_27939->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27925->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27939->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32372 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32457 = var_cas_t2.firstObject () ;
    while ((operand_32372 != NULL)
        && (operand_32457 != NULL)) {
      macroValidPointer (operand_32372) ;
      macroValidPointer (operand_32457) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32372->mType,  operand_32457->mAttributType,  operand_32372->mGalgasVariableName.reader_location ()) ;
      operand_32372 = operand_32372->nextObject () ;
      operand_32457 = operand_32457->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_33690 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33819 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33690 != NULL)
        && (operand_33819 != NULL)) {
      macroValidPointer (operand_33690) ;
      macroValidPointer (operand_33819) ;
      if (operand_33690->mFormalArgumentPassingMode.isBuilt () && operand_33819->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33690->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33819->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33690->mType,  operand_33819->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33690->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33819->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33690->mType,  operand_33819->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33690->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33819->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33690->mType,  operand_33819->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33690->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33819->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33819->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33819->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33690->mType,  operand_33819->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33819->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33690->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33690 = operand_33690->nextObject () ;
      operand_33819 = operand_33819->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_35076 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35144 = var_cas_expressionList.firstObject () ;
    while ((operand_35076 != NULL)
        && (operand_35144 != NULL)) {
      macroValidPointer (operand_35076) ;
      macroValidPointer (operand_35144) ;
      if (operand_35144->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35144->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35229 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35144->mExpression.getPtr ()) ;
          macroValidPointer (operand_35229) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35229->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35076->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35144->mExpression) ;
        }
      }
      operand_35076 = operand_35076->nextObject () ;
      operand_35144 = operand_35144->nextObject () ;
    }
  }
}
