...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25698 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25787 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25698 != NULL)
      && (operand_25787 != NULL)) {
    macroValidPointer (operand_25698) ;
    macroValidPointer (operand_25787) ;
    if (((operand_25698->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25787->mAttributType.isBuilt ()) {
        operand_25787->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25698->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25787->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25698->mName, operand_25787->mAttributType, var_cas_cppName) ;
      }else{
          operand_25698->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25698->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_25698 = operand_25698->nextObject () ;
    operand_25787 = operand_25787->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27816 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27830 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27816 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27816) ;
    cPtr_typeGalgas_stringset * operand_27830 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27830) ;
    if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27816 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27816) ;
      cPtr_typeGalgas_uint * operand_27830 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27830) ;
      if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27816 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27816) ;
        cPtr_typeGalgas_sint * operand_27830 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27830) ;
        if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27816 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27816) ;
          cPtr_typeGalgas_char * operand_27830 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27830) ;
          if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27816 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27816) ;
            cPtr_typeGalgas_string * operand_27830 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27830) ;
            if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27816 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27816) ;
              cPtr_typeGalgas_bool * operand_27830 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27830) ;
              if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27816 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27816) ;
                cPtr_typeGalgas_double * operand_27830 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27830) ;
                if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27816 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27816) ;
                  cPtr_typeGalgas_ldouble * operand_27830 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27830) ;
                  if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27816 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27816) ;
                    cPtr_typeGalgas_location * operand_27830 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27830) ;
                    if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27816 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27816) ;
                      cPtr_typeGalgas_lchar * operand_27830 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27830) ;
                      if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27816 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27816) ;
                        cPtr_typeGalgas_luint * operand_27830 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27830) ;
                        if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27816 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27816) ;
                          cPtr_typeGalgas_lsint * operand_27830 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27830) ;
                          if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27816 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27816) ;
                            cPtr_typeGalgas_lstring * operand_27830 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27830) ;
                            if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27816 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27816) ;
                              cPtr_typeGalgas_lbool * operand_27830 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27830) ;
                              if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27816 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27816) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27830 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27830) ;
                                if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                                  if (((operand_27816->mGalgasClassName.reader_value ()) != (operand_27830->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27816->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27830->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27816 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27816) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27830 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27830) ;
                                  if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                                    if (((operand_27816->mListTypeName.reader_value ()) != (operand_27830->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27816->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27830->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27816 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27816) ;
                                    cPtr_typeGalgasClassType * operand_27830 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27830) ;
                                    if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                                      if (((operand_27816->mClassTypeName.reader_value ()) == (operand_27830->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27830->mAncestorClassesMap.reader_hasKey (operand_27816->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27830->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27830->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27816 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27816) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27830 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27830) ;
                                      if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                                        if (((operand_27816->mClassTypeName.reader_value ()) != (operand_27830->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27816->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27830->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27816 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27816) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27830 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27830) ;
                                        if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                                          if (((operand_27816->mMapTypeName.reader_value ()) != (operand_27830->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27816->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27830->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27816 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27816) ;
                                          cPtr_typeGalgas_enum * operand_27830 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27830) ;
                                          if ((operand_27816 != NULL) && (operand_27830 != NULL)) {
                                            if (((operand_27816->mEnumTypeName.reader_value ()) != (operand_27830->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27816->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27830->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32263 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32348 = var_cas_t2.firstObject () ;
    while ((operand_32263 != NULL)
        && (operand_32348 != NULL)) {
      macroValidPointer (operand_32263) ;
      macroValidPointer (operand_32348) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32263->mType,  operand_32348->mAttributType,  operand_32263->mGalgasVariableName.reader_location ()) ;
      operand_32263 = operand_32263->nextObject () ;
      operand_32348 = operand_32348->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_33583 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33712 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33583 != NULL)
        && (operand_33712 != NULL)) {
      macroValidPointer (operand_33583) ;
      macroValidPointer (operand_33712) ;
      if (operand_33583->mFormalArgumentPassingMode.isBuilt () && operand_33712->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33583->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33712->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33583->mType,  operand_33712->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33583->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33712->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33583->mType,  operand_33712->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33583->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33712->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33583->mType,  operand_33712->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33583->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33712->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33712->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33712->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33583->mType,  operand_33712->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33712->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33583->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33583 = operand_33583->nextObject () ;
      operand_33712 = operand_33712->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_34969 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35037 = var_cas_expressionList.firstObject () ;
    while ((operand_34969 != NULL)
        && (operand_35037 != NULL)) {
      macroValidPointer (operand_34969) ;
      macroValidPointer (operand_35037) ;
      if (operand_35037->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35037->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35122 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35037->mExpression.getPtr ()) ;
          macroValidPointer (operand_35122) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35122->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34969->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35037->mExpression) ;
        }
      }
      operand_34969 = operand_34969->nextObject () ;
      operand_35037 = operand_35037->nextObject () ;
    }
  }
}
