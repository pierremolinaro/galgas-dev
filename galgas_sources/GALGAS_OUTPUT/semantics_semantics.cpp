...
//                    february 16th, 2007, at 18h12'19"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_32596 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_32681 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_32596 != NULL)
      && (operand_32681 != NULL)) {
    macroValidPointer (operand_32596) ;
    macroValidPointer (operand_32681) ;
    if (((operand_32596->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (794))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_32681->mAttributType._isBuilt ()) {
        operand_32681->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (796)) ;
      }
      if (((operand_32596->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (797))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_32681->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_32596->mName, operand_32681->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (804)) ;
      }else{
        operand_32596->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_32596->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (806))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (808)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_32596 = operand_32596->nextObject () ;
    operand_32681 = operand_32681->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (813))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (813)))) & ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (815)).reader_string (_inLexique SOURCE_FILE_AT_LINE (815))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (816)).reader_string (_inLexique SOURCE_FILE_AT_LINE (816))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (817)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (817))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (817)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (819)).reader_string (_inLexique SOURCE_FILE_AT_LINE (819))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (820)).reader_string (_inLexique SOURCE_FILE_AT_LINE (820))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (821)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  #endif
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (836))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (836)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (838)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (838))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (838)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (840)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_34987 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35068 = var_cas_t2.firstObject () ;
    while ((operand_34987 != NULL)
        && (operand_35068 != NULL)) {
      macroValidPointer (operand_34987) ;
      macroValidPointer (operand_35068) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_34987->mType,  operand_35068->mAttributType,  operand_34987->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (846)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (843)) ;
      operand_34987 = operand_34987->nextObject () ;
      operand_35068 = operand_35068->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  #endif
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (866))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (866)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (868)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (868))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (868)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (870)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_36341 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_36466 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_36341 != NULL)
        && (operand_36466 != NULL)) {
      macroValidPointer (operand_36341) ;
      macroValidPointer (operand_36466) ;
      if (operand_36341->mFormalArgumentPassingMode._isBuilt () && operand_36466->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_36341->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_36466->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36341->mType,  operand_36466->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (876)) ;
        }else{
          if ((operand_36341->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_36466->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36341->mType,  operand_36466->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (878)) ;
          }else{
            if ((operand_36341->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_36466->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36341->mType,  operand_36466->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (880)) ;
            }else{
              if ((operand_36341->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_36466->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_36466->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_37140 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_36466->mType.getPtr ()) ;
                  if (operand_37140 != NULL) {
                    macroValidPointer (operand_37140) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36341->mType,  operand_36466->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (885)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_36466->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (888))) + (GGS_string (true, " is not compatible with ")))) + (operand_36341->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (889)))) SOURCE_FILE_AT_LINE (890)) ;
              }
            }
          }
        }
      }
      operand_36341 = operand_36341->nextObject () ;
      operand_36466 = operand_36466->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37733 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37797 = var_cas_expressionList.firstObject () ;
    while ((operand_37733 != NULL)
        && (operand_37797 != NULL)) {
      macroValidPointer (operand_37733) ;
      macroValidPointer (operand_37797) ;
      if (operand_37797->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_37880 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37797->mExpression.getPtr ()) ;
        if (operand_37880 != NULL) {
          macroValidPointer (operand_37880) ; 
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37733->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_37797->mExpression) ;
        }
      }
      operand_37733 = operand_37733->nextObject () ;
      operand_37797 = operand_37797->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  aPositionVariableCible,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (942)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1334)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1337)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1340)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1343)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1346)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1349)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1352)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1355)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1358)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1361)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1364)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1367)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1370)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1373)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1376)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1379)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "binaryset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1382)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1385)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1388)) ;
  GGS_AC_galgasType  var_cas_t ;
  ::routine_build_uint64list_type (_inLexique,  var_cas_t SOURCE_FILE_AT_LINE (1390)) ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64list"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1392)) ;
  ::routine_build_stringlist_type (_inLexique,  var_cas_t SOURCE_FILE_AT_LINE (1393)) ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringlist"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1396)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1498)) ;
  GGS_stringset::element_type * operand_62772 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62772 != NULL)) {
    macroValidPointer (operand_62772) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62772->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1501)) ;
    operand_62772 = operand_62772->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1502)) ;
  GGS_stringset::element_type * operand_63067 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_63067 != NULL)) {
    macroValidPointer (operand_63067) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63067->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1505)) ;
    operand_63067 = operand_63067->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  #endif
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1514)) ;
  GGS_stringset::element_type * operand_63601 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63601 != NULL)) {
    macroValidPointer (operand_63601) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63601->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1517)) ;
    operand_63601 = operand_63601->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
