...
new_element (void * inKey, void * inInfo) {
  ...
  M_assert (reinterpret_cast <e_typeClassMessagesMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
...
new_element (void * inKey, void * inInfo) {
  M_assert (reinterpret_cast <GGS_lstring *> (inKey) != NULL, "Dynamic cast error", 0, 0) ;
  M_assert (reinterpret_cast <e_typeTableRoutinesAimplementer *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  GGS_lstring * key = (GGS_lstring *) inKey ;
...
new_element (void * inKey, void * inInfo) {
  M_assert (reinterpret_cast <GGS_lstring *> (inKey) != NULL, "Dynamic cast error", 0, 0) ;
  M_assert (reinterpret_cast <e_typeTableAttributsSemantiques *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  GGS_lstring * key = (GGS_lstring *) inKey ;
...
void routine_buildMapWithLocalConstants (C_lexique & lexique_var_,
  ...
  while ((operand_27518 != NULL) && (operand_27577 != NULL)) {
    ...
    if (((operand_27518->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_27577->mAttributType.isBuilt ()) {
        operand_27577->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_27518->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        GGS_typeCplusPlusName  var_cas_cppName ;
        var_cas_cppName = GGS_typeOperandName::constructor_new (operand_27577->aNomAttribut, var_cas_inLocation, var_cas_inMapField) ;
        insertUsedConstInArgument_typeVariablesMap (lexique_var_,
                                        var_cas_ioVariablesMap,
                                        operand_27518->mName,
                                        operand_27577->mAttributType,
                                        var_cas_cppName,
                                        NULL) ;
      }else{
...
void routine_checkAssignmentTypesCompatibility (C_lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_29025 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_29039 = var_cas_sourceType () ;
    cPtr_typeGalgas_uint * operand_29025 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29025) ;
    cPtr_typeGalgas_uint * operand_29039 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29039) ;
    if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_29025 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29025) ;
      cPtr_typeGalgas_sint * operand_29039 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29039) ;
      if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_29025 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29025) ;
        cPtr_typeGalgas_char * operand_29039 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29039) ;
        if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_29025 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29025) ;
          cPtr_typeGalgas_string * operand_29039 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29039) ;
          if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_29025 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29025) ;
            cPtr_typeGalgas_bool * operand_29039 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29039) ;
            if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
            }else{
              cPtr_typeGalgas_dfloat * operand_29025 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_29025) ;
              cPtr_typeGalgas_dfloat * operand_29039 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_29039) ;
              if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
              }else{
                cPtr_typeGalgas_ldfloat * operand_29025 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_29025) ;
                cPtr_typeGalgas_ldfloat * operand_29039 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_29039) ;
                if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                }else{
                  cPtr_typeGalgas_location * operand_29025 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29025) ;
                  cPtr_typeGalgas_location * operand_29039 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29039) ;
                  if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_29025 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29025) ;
                    cPtr_typeGalgas_lchar * operand_29039 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29039) ;
                    if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_29025 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29025) ;
                      cPtr_typeGalgas_luint * operand_29039 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29039) ;
                      if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_29025 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29025) ;
                        cPtr_typeGalgas_lsint * operand_29039 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29039) ;
                        if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_29025 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29025) ;
                          cPtr_typeGalgas_lstring * operand_29039 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29039) ;
                          if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lbool * operand_29025 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29025) ;
                            cPtr_typeGalgas_lbool * operand_29039 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29039) ;
                            if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedExternType * operand_29025 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29025) ;
                              cPtr_typeGalgasUndefinedExternType * operand_29039 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29039) ;
                              if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                                if (((operand_29025->mGalgasClassName.reader_value ()) != (operand_29039->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_29025->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_29039->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_29025 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29025) ;
                                cPtr_typeGalgasUndefinedListType * operand_29039 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29039) ;
                                if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                                  if (((operand_29025->mListTypeName.reader_value ()) != (operand_29039->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29025->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_29039->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasClassType * operand_29025 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29025) ;
                                  cPtr_typeGalgasClassType * operand_29039 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29039) ;
                                  if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                                    if (((operand_29025->mClassTypeName.reader_value ()) == (operand_29039->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    }else if (((! operand_29039->mAncestorClassesMap.reader_hasKey (operand_29025->mClassTypeName))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_29039->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_29039->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_29025 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29025) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_29039 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29039) ;
                                    if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                                      if (((operand_29025->mClassTypeName.reader_value ()) != (operand_29039->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29025->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_29039->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedMapType * operand_29025 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29025) ;
                                      cPtr_typeGalgasUndefinedMapType * operand_29039 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29039) ;
                                      if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                                        if (((operand_29025->mMapTypeName.reader_value ()) != (operand_29039->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29025->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_29039->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_29025 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29025) ;
                                        cPtr_typeGalgas_enum * operand_29039 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29039) ;
                                        if ((operand_29025 != NULL) && (operand_29039 != NULL)) {
                                          if (((operand_29025->mEnumTypeName.reader_value ()) != (operand_29039->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_29025->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_29039->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    while ((operand_34776 != NULL) && (operand_34880 != NULL)) {
      ...
      if (operand_34776->mFormalArgumentPassingMode.isBuilt () && operand_34880->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_34776->mFormalArgumentPassingMode.getValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_34880->mFormalArgumentPassingMode.getValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34776->mType,  operand_34880->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_34776->mFormalArgumentPassingMode.getValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_34880->mFormalArgumentPassingMode.getValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34776->mType,  operand_34880->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_34776->mFormalArgumentPassingMode.getValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_34880->mFormalArgumentPassingMode.getValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34776->mType,  operand_34880->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_34776->mFormalArgumentPassingMode.getValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_34880->mFormalArgumentPassingMode.getValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_34880->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_34880->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34776->mType,  operand_34880->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_34880->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_34776->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
    ...
    while ((operand_36161 != NULL) && (operand_36219 != NULL)) {
      ...
      if (operand_36219->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_36219->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_36304 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_36219->mExpression.getPtr ()) ;
          macroValidPointer (operand_36304) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_36304->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_36161->mType) ;
...
new_element (void * inKey, void * inInfo) {
  M_assert (reinterpret_cast <GGS_lstring *> (inKey) != NULL, "Dynamic cast error", 0, 0) ;
  M_assert (reinterpret_cast <e_typeTableNomRoutinesDeclarees *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  GGS_lstring * key = (GGS_lstring *) inKey ;
...
mNonExternAttributesList (argument_1),
mExternAttributesList (argument_2),
aTableMethodesInserer (argument_3),
aTableMethodesChercher (argument_4),
...
void routine_enterBuiltinTypes (C_lexique & lexique_var_,
  ...
  insertKey_M_semanticsEntitiesForUse (lexique_var_,
                                  ...
                                  var_cas_e,
                                  NULL) ;
  var_cas_name = GGS_lstring::constructor_new (GGS_string (true, "ldfloat"), GGS_location (lexique_var_)) ;
  var_cas_t = GGS_typeGalgas_ldfloat::constructor_new () ;
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t) ;
  insertKey_M_semanticsEntitiesForUse (lexique_var_,
                                  var_cas_ioComponentSemanticsEntitiesMap,
                                  var_cas_name,
  ...
  insertKey_M_semanticsEntitiesForUse (lexique_var_,
                                  ...
                                  var_cas_e,
                                  NULL) ;
  var_cas_name = GGS_lstring::constructor_new (GGS_string (true, "dfloat"), GGS_location (lexique_var_)) ;
...
new_element (void * inKey, void * inInfo) {
  M_assert (reinterpret_cast <GGS_lstring *> (inKey) != NULL, "Dynamic cast error", 0, 0) ;
  M_assert (reinterpret_cast <e_typeEnumCstMessageStringMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  GGS_lstring * key = (GGS_lstring *) inKey ;
