...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32837 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32922 = var_cas_t2.firstObject () ;
    while ((operand_32837 != NULL)
        && (operand_32922 != NULL)) {
      macroValidPointer (operand_32837) ;
      macroValidPointer (operand_32922) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32837->mType,  operand_32922->mAttributType,  operand_32837->mGalgasVariableName.reader_location ()) ;
      operand_32837 = operand_32837->nextObject () ;
      operand_32922 = operand_32922->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_34155 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_34284 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_34155 != NULL)
        && (operand_34284 != NULL)) {
      macroValidPointer (operand_34155) ;
      macroValidPointer (operand_34284) ;
      if (operand_34155->mFormalArgumentPassingMode.isBuilt () && operand_34284->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_34155->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_34284->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34155->mType,  operand_34284->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_34155->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_34284->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34155->mType,  operand_34284->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_34155->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_34284->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34155->mType,  operand_34284->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_34155->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_34284->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_34284->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_34284->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34155->mType,  operand_34284->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_34284->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_34155->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_34155 = operand_34155->nextObject () ;
      operand_34284 = operand_34284->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_35541 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35609 = var_cas_expressionList.firstObject () ;
    while ((operand_35541 != NULL)
        && (operand_35609 != NULL)) {
      macroValidPointer (operand_35541) ;
      macroValidPointer (operand_35609) ;
      if (operand_35609->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35609->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35694 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35609->mExpression.getPtr ()) ;
          macroValidPointer (operand_35694) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35694->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35541->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35609->mExpression) ;
        }
      }
      operand_35541 = operand_35541->nextObject () ;
      operand_35609 = operand_35609->nextObject () ;
    }
  }
}
