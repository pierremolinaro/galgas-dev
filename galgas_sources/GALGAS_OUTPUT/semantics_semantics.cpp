...
//                    february 19th, 2007, at 19h33'14"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
cPtr_typeCurrentObjectName (const GGS_lstring & argument_0 COMMA_LOCATION_ARGS)
:cPtr_typeCplusPlusName (THERE),
mName (argument_0) {
}
...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_32791 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_32876 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_32791 != NULL)
      && (operand_32876 != NULL)) {
    macroValidPointer (operand_32791) ;
    macroValidPointer (operand_32876) ;
    if (((operand_32791->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (801))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_32876->mAttributType._isBuilt ()) {
        operand_32876->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (803)) ;
      }
      if (((operand_32791->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (804))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_32876->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_32791->mName, operand_32876->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (811)) ;
      }else{
        operand_32791->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_32791->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (813))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (815)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_32791 = operand_32791->nextObject () ;
    operand_32876 = operand_32876->nextObject () ;
  }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (843))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (843)))).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_35182 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35263 = var_cas_t2.firstObject () ;
    while ((operand_35182 != NULL)
        && (operand_35263 != NULL)) {
      macroValidPointer (operand_35182) ;
      macroValidPointer (operand_35263) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35182->mType,  operand_35263->mAttributType,  operand_35182->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (853)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (850)) ;
      operand_35182 = operand_35182->nextObject () ;
      operand_35263 = operand_35263->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (873))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (873)))).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_36536 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_36661 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_36536 != NULL)
        && (operand_36661 != NULL)) {
      macroValidPointer (operand_36536) ;
      macroValidPointer (operand_36661) ;
      if (operand_36536->mFormalArgumentPassingMode._isBuilt () && operand_36661->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_36536->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_36661->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36536->mType,  operand_36661->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (883)) ;
        }else{
          if ((operand_36536->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_36661->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36536->mType,  operand_36661->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (885)) ;
          }else{
            if ((operand_36536->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_36661->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36536->mType,  operand_36661->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (887)) ;
            }else{
              if ((operand_36536->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_36661->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_36661->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_37335 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_36661->mType.getPtr ()) ;
                  if (operand_37335 != NULL) {
                    macroValidPointer (operand_37335) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36536->mType,  operand_36661->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (892)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_36661->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (895))) + (GGS_string (true, " is not compatible with ")))) + (operand_36536->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (896)))) SOURCE_FILE_AT_LINE (897)) ;
              }
            }
          }
        }
      }
      operand_36536 = operand_36536->nextObject () ;
      operand_36661 = operand_36661->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37928 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37992 = var_cas_expressionList.firstObject () ;
    while ((operand_37928 != NULL)
        && (operand_37992 != NULL)) {
      macroValidPointer (operand_37928) ;
      macroValidPointer (operand_37992) ;
      if (operand_37992->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_38075 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37992->mExpression.getPtr ()) ;
        if (operand_38075 != NULL) {
          macroValidPointer (operand_38075) ; 
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37928->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_37992->mExpression) ;
        }
      }
      operand_37928 = operand_37928->nextObject () ;
      operand_37992 = operand_37992->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1430)) ;
  GGS_stringset::element_type * operand_59334 = var_cas_missingDefinition.firstObject () ;
  while ((operand_59334 != NULL)) {
    macroValidPointer (operand_59334) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59334->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1433)) ;
    operand_59334 = operand_59334->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1434)) ;
  GGS_stringset::element_type * operand_59629 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_59629 != NULL)) {
    macroValidPointer (operand_59629) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59629->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1437)) ;
    operand_59629 = operand_59629->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  #endif
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1446)) ;
  GGS_stringset::element_type * operand_60163 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60163 != NULL)) {
    macroValidPointer (operand_60163) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60163->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1449)) ;
    operand_60163 = operand_60163->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
