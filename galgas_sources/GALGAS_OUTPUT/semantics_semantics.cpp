...
//                    november 16th, 2005, at 15h16'10"                      *
//                                                                           *
...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25626 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25715 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25626 != NULL)
      && (operand_25715 != NULL)) {
    macroValidPointer (operand_25626) ;
    macroValidPointer (operand_25715) ;
    if (((operand_25626->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25715->mAttributType.isBuilt ()) {
        operand_25715->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25626->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25715->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25626->mName, operand_25715->mAttributType, var_cas_cppName) ;
      }else{
          operand_25626->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25626->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25626 = operand_25626->nextObject () ;
    operand_25715 = operand_25715->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27738 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27752 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27738 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27738) ;
    cPtr_typeGalgas_stringset * operand_27752 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27752) ;
    if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27738 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27738) ;
      cPtr_typeGalgas_uint * operand_27752 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27752) ;
      if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27738 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27738) ;
        cPtr_typeGalgas_sint * operand_27752 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27752) ;
        if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27738 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27738) ;
          cPtr_typeGalgas_char * operand_27752 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27752) ;
          if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27738 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27738) ;
            cPtr_typeGalgas_string * operand_27752 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27752) ;
            if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27738 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27738) ;
              cPtr_typeGalgas_bool * operand_27752 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27752) ;
              if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27738 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27738) ;
                cPtr_typeGalgas_double * operand_27752 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27752) ;
                if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27738 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27738) ;
                  cPtr_typeGalgas_ldouble * operand_27752 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27752) ;
                  if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27738 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27738) ;
                    cPtr_typeGalgas_location * operand_27752 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27752) ;
                    if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27738 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27738) ;
                      cPtr_typeGalgas_lchar * operand_27752 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27752) ;
                      if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27738 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27738) ;
                        cPtr_typeGalgas_luint * operand_27752 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27752) ;
                        if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27738 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27738) ;
                          cPtr_typeGalgas_lsint * operand_27752 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27752) ;
                          if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27738 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27738) ;
                            cPtr_typeGalgas_lstring * operand_27752 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27752) ;
                            if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27738 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27738) ;
                              cPtr_typeGalgas_lbool * operand_27752 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27752) ;
                              if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27738 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27738) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27752 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27752) ;
                                if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                                  if (((operand_27738->mGalgasClassName.reader_value ()) != (operand_27752->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27738->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27752->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27738 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27738) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27752 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27752) ;
                                  if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                                    if (((operand_27738->mListTypeName.reader_value ()) != (operand_27752->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27738->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27752->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27738 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27738) ;
                                    cPtr_typeGalgasClassType * operand_27752 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27752) ;
                                    if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                                      if (((operand_27738->mClassTypeName.reader_value ()) == (operand_27752->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27752->mAncestorClassesMap.reader_hasKey (operand_27738->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27752->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27752->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27738 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27738) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27752 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27752) ;
                                      if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                                        if (((operand_27738->mClassTypeName.reader_value ()) != (operand_27752->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27738->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27752->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27738 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27738) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27752 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27752) ;
                                        if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                                          if (((operand_27738->mMapTypeName.reader_value ()) != (operand_27752->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27738->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27752->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27738 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27738) ;
                                          cPtr_typeGalgas_enum * operand_27752 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27752) ;
                                          if ((operand_27738 != NULL) && (operand_27752 != NULL)) {
                                            if (((operand_27738->mEnumTypeName.reader_value ()) != (operand_27752->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27738->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27752->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32185 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32270 = var_cas_t2.firstObject () ;
    while ((operand_32185 != NULL)
        && (operand_32270 != NULL)) {
      macroValidPointer (operand_32185) ;
      macroValidPointer (operand_32270) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32185->mType,  operand_32270->mAttributType,  operand_32185->mGalgasVariableName.reader_location ()) ;
      operand_32185 = operand_32185->nextObject () ;
      operand_32270 = operand_32270->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_33503 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33632 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33503 != NULL)
        && (operand_33632 != NULL)) {
      macroValidPointer (operand_33503) ;
      macroValidPointer (operand_33632) ;
      if (operand_33503->mFormalArgumentPassingMode.isBuilt () && operand_33632->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33503->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33632->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33503->mType,  operand_33632->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33503->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33632->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33503->mType,  operand_33632->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33503->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33632->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33503->mType,  operand_33632->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33503->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33632->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33632->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33632->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33503->mType,  operand_33632->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33632->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33503->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      ...
      operand_33632 = operand_33632->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_34889 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_34957 = var_cas_expressionList.firstObject () ;
    while ((operand_34889 != NULL)
        && (operand_34957 != NULL)) {
      macroValidPointer (operand_34889) ;
      macroValidPointer (operand_34957) ;
      if (operand_34957->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_34957->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35042 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_34957->mExpression.getPtr ()) ;
          macroValidPointer (operand_35042) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35042->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34889->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_34957->mExpression) ;
        }
      }
      operand_34889 = operand_34889->nextObject () ;
      operand_34957 = operand_34957->nextObject () ;
    }
  }
}
