...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25621 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25710 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25621 != NULL)
      && (operand_25710 != NULL)) {
    macroValidPointer (operand_25621) ;
    macroValidPointer (operand_25710) ;
    if (((operand_25621->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25710->mAttributType.isBuilt ()) {
        operand_25710->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25621->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25710->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25621->mName, operand_25710->mAttributType, var_cas_cppName) ;
      }else{
          operand_25621->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25621->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25621 = operand_25621->nextObject () ;
    operand_25710 = operand_25710->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27733 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27747 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27733 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27733) ;
    cPtr_typeGalgas_stringset * operand_27747 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27747) ;
    if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27733 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27733) ;
      cPtr_typeGalgas_uint * operand_27747 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27747) ;
      if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27733 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27733) ;
        cPtr_typeGalgas_sint * operand_27747 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27747) ;
        if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27733 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27733) ;
          cPtr_typeGalgas_char * operand_27747 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27747) ;
          if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27733 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27733) ;
            cPtr_typeGalgas_string * operand_27747 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27747) ;
            if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27733 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27733) ;
              cPtr_typeGalgas_bool * operand_27747 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27747) ;
              if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27733 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27733) ;
                cPtr_typeGalgas_double * operand_27747 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27747) ;
                if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27733 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27733) ;
                  cPtr_typeGalgas_ldouble * operand_27747 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27747) ;
                  if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27733 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27733) ;
                    cPtr_typeGalgas_location * operand_27747 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27747) ;
                    if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27733 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27733) ;
                      cPtr_typeGalgas_lchar * operand_27747 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27747) ;
                      if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27733 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27733) ;
                        cPtr_typeGalgas_luint * operand_27747 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27747) ;
                        if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27733 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27733) ;
                          cPtr_typeGalgas_lsint * operand_27747 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27747) ;
                          if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27733 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27733) ;
                            cPtr_typeGalgas_lstring * operand_27747 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27747) ;
                            if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27733 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27733) ;
                              cPtr_typeGalgas_lbool * operand_27747 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27747) ;
                              if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27733 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27733) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27747 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27747) ;
                                if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                                  if (((operand_27733->mGalgasClassName.reader_value ()) != (operand_27747->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27733->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27747->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27733 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27733) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27747 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27747) ;
                                  if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                                    if (((operand_27733->mListTypeName.reader_value ()) != (operand_27747->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27733->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27747->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27733 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27733) ;
                                    cPtr_typeGalgasClassType * operand_27747 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27747) ;
                                    if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                                      if (((operand_27733->mClassTypeName.reader_value ()) == (operand_27747->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27747->mAncestorClassesMap.reader_hasKey (operand_27733->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27747->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27747->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27733 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27733) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27747 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27747) ;
                                      if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                                        if (((operand_27733->mClassTypeName.reader_value ()) != (operand_27747->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27733->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27747->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27733 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27733) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27747 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27747) ;
                                        if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                                          if (((operand_27733->mMapTypeName.reader_value ()) != (operand_27747->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27733->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27747->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27733 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27733) ;
                                          cPtr_typeGalgas_enum * operand_27747 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27747) ;
                                          if ((operand_27733 != NULL) && (operand_27747 != NULL)) {
                                            if (((operand_27733->mEnumTypeName.reader_value ()) != (operand_27747->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27733->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27747->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32180 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32265 = var_cas_t2.firstObject () ;
    while ((operand_32180 != NULL)
        && (operand_32265 != NULL)) {
      macroValidPointer (operand_32180) ;
      macroValidPointer (operand_32265) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32180->mType,  operand_32265->mAttributType,  operand_32180->mGalgasVariableName.reader_location ()) ;
      operand_32180 = operand_32180->nextObject () ;
      operand_32265 = operand_32265->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_33498 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33627 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33498 != NULL)
        && (operand_33627 != NULL)) {
      macroValidPointer (operand_33498) ;
      macroValidPointer (operand_33627) ;
      if (operand_33498->mFormalArgumentPassingMode.isBuilt () && operand_33627->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33498->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33627->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33498->mType,  operand_33627->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33498->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33627->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33498->mType,  operand_33627->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33498->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33627->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33498->mType,  operand_33627->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33498->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33627->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33627->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33627->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33498->mType,  operand_33627->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33627->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33498->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33498 = operand_33498->nextObject () ;
      operand_33627 = operand_33627->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_34884 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_34952 = var_cas_expressionList.firstObject () ;
    while ((operand_34884 != NULL)
        && (operand_34952 != NULL)) {
      macroValidPointer (operand_34884) ;
      macroValidPointer (operand_34952) ;
      if (operand_34952->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_34952->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35037 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_34952->mExpression.getPtr ()) ;
          macroValidPointer (operand_35037) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35037->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34884->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_34952->mExpression) ;
        }
      }
      operand_34884 = operand_34884->nextObject () ;
      operand_34952 = operand_34952->nextObject () ;
    }
  }
}
