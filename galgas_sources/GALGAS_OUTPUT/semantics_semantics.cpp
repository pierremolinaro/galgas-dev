...
void routine_buildMapWithLocalConstants (C_Compiler & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_33465 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_33550 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_33465 != NULL)
      && (operand_33550 != NULL)) {
    macroValidPointer (operand_33465) ;
    macroValidPointer (operand_33550) ;
    if (((operand_33465->mName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (820)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_33550->mAttributType._isBuilt ()) {
        operand_33550->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (822)) ;
      }
      if (((operand_33465->mType.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (823)))._operator_isEqual (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if ((((var_cas_inLocalConstantStyle)._operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE)))._operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, var_cas_inLocation, operand_33550->aNomAttribut.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (828)), var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_33465->mName, operand_33550->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (830)) ;
      }else{
        operand_33465->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I have found the '@"))._operator_concat (operand_33465->mType.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (832))))._operator_concat (GGS_string (true, "' type, I was expected the '@")))._operator_concat (var_cas_typeName))._operator_concat (GGS_string (true, "' type")) COMMA_SOURCE_FILE_AT_LINE (834)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_33465 = operand_33465->nextObject () ;
    operand_33550 = operand_33550->nextObject () ;
  }
...
void routine_verifierCompatibiliteTypes (C_Compiler & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (862)))._operator_strictInf (var_cas_t2.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (862)))).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_35865 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35946 = var_cas_t2.firstObject () ;
    while ((operand_35865 != NULL)
        && (operand_35946 != NULL)) {
      macroValidPointer (operand_35865) ;
      macroValidPointer (operand_35946) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35865->mType,  operand_35946->mAttributType,  operand_35865->mGalgasVariableName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (872)),  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (869)) ;
      operand_35865 = operand_35865->nextObject () ;
      operand_35946 = operand_35946->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Compiler & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)))._operator_strictSup (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)))).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_37219 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37344 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_37219 != NULL)
        && (operand_37344 != NULL)) {
      macroValidPointer (operand_37219) ;
      macroValidPointer (operand_37344) ;
      if (operand_37219->mFormalArgumentPassingMode._isBuilt () && operand_37344->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_37219->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37344->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37219->mType,  operand_37344->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (902)) ;
        }else{
          if ((operand_37219->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37344->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37219->mType,  operand_37344->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (904)) ;
          }else{
            if ((operand_37219->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37344->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37219->mType,  operand_37344->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (906)) ;
            }else{
              if ((operand_37219->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37344->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37344->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_38018 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37344->mType.getPtr ()) ;
                  if (operand_38018 != NULL) {
                    macroValidPointer (operand_38018) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37219->mType,  operand_37344->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (911)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((operand_37344->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (914)))._operator_concat (GGS_string (true, " is not compatible with ")))._operator_concat (operand_37219->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (915))) COMMA_SOURCE_FILE_AT_LINE (916)) ;
              }
            }
          }
        }
      }
      operand_37219 = operand_37219->nextObject () ;
      operand_37344 = operand_37344->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38611 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38675 = var_cas_expressionList.firstObject () ;
    while ((operand_38611 != NULL)
        && (operand_38675 != NULL)) {
      macroValidPointer (operand_38611) ;
      macroValidPointer (operand_38675) ;
      if (operand_38675->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_38758 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38675->mExpression.getPtr ()) ;
        if (operand_38758 != NULL) {
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38611->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_38675->mExpression) ;
        }
      }
      operand_38611 = operand_38611->nextObject () ;
      operand_38675 = operand_38675->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performMetamodelInclusion (C_Compiler & _inLexique,
  ...
  if (((var_cas_ioSuperMetamodels.reader_hasKey (_inLexique, var_cas_inSuperMetamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1492)) COMMA_SOURCE_FILE_AT_LINE (1492)))._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_entityToImplementMap::element_type * operand_61396 = var_cas_superMetamodelEntityMap.firstObject () ;
    while ((operand_61396 != NULL)) {
      macroValidPointer (operand_61396) ;
      if ((var_cas_ioAllEntityMap.reader_hasKey (_inLexique, operand_61396->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) COMMA_SOURCE_FILE_AT_LINE (1506))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (operand_61396->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1507))))._operator_concat (GGS_string (true, "' is already defined in a previously imported metamodel")) COMMA_SOURCE_FILE_AT_LINE (1508)) ;
      }else{
        var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_61396->mKey, operand_61396->mInfo.mAllMetamodelPropertyMap, operand_61396->mInfo.mIsAbstract, operand_61396->mInfo.mCurrentMetamodelPropertyMap, operand_61396->mInfo.mSuperEntityName, operand_61396->mInfo.mAncestorClassesMap, operand_61396->mInfo.mPropertyList, operand_61396->mInfo.mMetamodelName, operand_61396->mInfo.mID COMMA_SOURCE_FILE_AT_LINE (1509)) ;
      }
      operand_61396 = operand_61396->nextObject () ;
    }
    GGS_stringset::element_type * operand_62543 = var_cas_superMetamodelsOfSuperMetamodels.firstObject () ;
    while ((operand_62543 != NULL)) {
      macroValidPointer (operand_62543) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_inMetamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_62543->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_ioSuperMetamodels,  var_cas_ioAllEntityMap COMMA_SOURCE_FILE_AT_LINE (1523)) ;
      operand_62543 = operand_62543->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
