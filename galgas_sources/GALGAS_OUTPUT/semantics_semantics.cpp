...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1468)) ;
   ;
  GGS_stringset::element_type * operand_62748 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62748 != NULL)) {
    macroValidPointer (operand_62748) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62748->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1470)) ;
    operand_62748 = operand_62748->nextObject () ;
  }
  ...
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1472)) ;
   ;
  GGS_stringset::element_type * operand_63045 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_63045 != NULL)) {
    macroValidPointer (operand_63045) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63045->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1474)) ;
    operand_63045 = operand_63045->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1484)) ;
   ;
  GGS_stringset::element_type * operand_63581 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63581 != NULL)) {
    macroValidPointer (operand_63581) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63581->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1486)) ;
    operand_63581 = operand_63581->nextObject () ;
  }
}
