...
void GGS_typeClassMessagesMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_lstring   & outParameter0) {
  const char * kErrorMessage [] = {"the message '",
...
void GGS_typeClassMessagesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_lstring & inParameter0) {
  const char * kErrorMessage [] = {"the message '",
...
//---------------------------------------------------------------------------*
  ...
  GGS_typeVariablesMap::element_type * info = searchForReadOnlyAccess (inLexique, inKey, inKey, errorMessage_0, errorMessage_1) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
...
//---------------------------------------------------------------------------*
  ...
  GGS_typeVariablesMap::element_type * info = searchForDestructiveReadAccess (inLexique, inKey, inKey, errorMessage_0, errorMessage_1) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
    outParameter1.drop_operation () ;
  }else{
...
//---------------------------------------------------------------------------*
  ...
  GGS_typeVariablesMap::element_type * info = searchForReadWriteAccess (inLexique, inKey, inKey, errorMessage_0, errorMessage_1) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
    outParameter1.drop_operation () ;
  }else{
...
//---------------------------------------------------------------------------*
  ...
  GGS_typeVariablesMap::element_type * info = searchForWriteAccess (inLexique, inKey, inKey, errorMessage_0, errorMessage_1) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
    outParameter1.drop_operation () ;
  }else{
...
void GGS_typeVariablesMap::methode_insertInArgument (C_Lexique & lexique_var_,
  ...
  insertInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertInArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
...
void GGS_typeVariablesMap::methode_insertConstInArgument (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertConstInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertConstInArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertConstInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeVariablesMap::methode_insertUsedConstInArgument (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertUsedConstInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertUsedConstInArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertUsedConstInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeVariablesMap::methode_insertUnusedConstInArgument (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertUnusedConstInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertUnusedConstInArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertUnusedConstInArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeVariablesMap::methode_insertLocalVariable (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertLocalVariable (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertLocalVariableGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertLocalVariable (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeVariablesMap::methode_insertOutArgument (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertOutArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertOutArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertOutArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeVariablesMap::methode_insertInOutArgument (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertInOutArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertInOutArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertInOutArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeVariablesMap::methode_insertUnusedInOutArgument (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  insertUnusedInOutArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeVariablesMap::methode_insertUnusedInOutArgumentGetIndex (C_Lexique & lexique_var_,
  ...
  info.mArgumentType = inParameter0 ;
  info.mCplusPlusName = inParameter1 ;
  const sint32 index = insertUnusedInOutArgument (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeTableRoutinesAimplementer::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the routine '",
                                   "",
...
void GGS_typeTableAttributsSemantiques::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_typeCplusPlusName   & outParameter0,
                                GGS_AC_galgasType   & outParameter1) {
...
void GGS_typeTableAttributsSemantiques::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_typeCplusPlusName & inParameter0,
                                const GGS_AC_galgasType & inParameter1) {
...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_26340 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_26429 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_26340 != NULL)
      && (operand_26429 != NULL)) {
    macroValidPointer (operand_26340) ;
    macroValidPointer (operand_26429) ;
    if (((operand_26340->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_26429->mAttributType.isBuilt ()) {
        operand_26429->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_26340->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_26429->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        if (var_cas_ioVariablesMap.isBuilt ()) {
          var_cas_ioVariablesMap ()->methode_insertUsedConstInArgument (lexique_var_, operand_26340->mName, operand_26429->mAttributType, var_cas_cppName) ;
        }
      }else{
          operand_26340->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_26340->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_26340 = operand_26340->nextObject () ;
    operand_26429 = operand_26429->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_28452 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_28466 = var_cas_sourceType () ;
    cPtr_typeGalgas_stringset * operand_28452 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_28452) ;
    cPtr_typeGalgas_stringset * operand_28466 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_28466) ;
    if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_28452 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_28452) ;
      cPtr_typeGalgas_uint * operand_28466 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_28466) ;
      if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_28452 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_28452) ;
        cPtr_typeGalgas_sint * operand_28466 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_28466) ;
        if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_28452 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_28452) ;
          cPtr_typeGalgas_char * operand_28466 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_28466) ;
          if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_28452 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_28452) ;
            cPtr_typeGalgas_string * operand_28466 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_28466) ;
            if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_28452 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_28452) ;
              cPtr_typeGalgas_bool * operand_28466 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_28466) ;
              if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_28452 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_28452) ;
                cPtr_typeGalgas_double * operand_28466 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_28466) ;
                if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_28452 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_28452) ;
                  cPtr_typeGalgas_ldouble * operand_28466 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_28466) ;
                  if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_28452 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_28452) ;
                    cPtr_typeGalgas_location * operand_28466 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_28466) ;
                    if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_28452 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_28452) ;
                      cPtr_typeGalgas_lchar * operand_28466 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_28466) ;
                      if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_28452 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_28452) ;
                        cPtr_typeGalgas_luint * operand_28466 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_28466) ;
                        if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_28452 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_28452) ;
                          cPtr_typeGalgas_lsint * operand_28466 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_28466) ;
                          if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_28452 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_28452) ;
                            cPtr_typeGalgas_lstring * operand_28466 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_28466) ;
                            if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_28452 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_28452) ;
                              cPtr_typeGalgas_lbool * operand_28466 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_28466) ;
                              if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_28452 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_28452) ;
                                cPtr_typeGalgasUndefinedExternType * operand_28466 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_28466) ;
                                if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                                  if (((operand_28452->mGalgasClassName.reader_value ()) != (operand_28466->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_28452->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_28466->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_28452 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_28452) ;
                                  cPtr_typeGalgasUndefinedListType * operand_28466 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_28466) ;
                                  if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                                    if (((operand_28452->mListTypeName.reader_value ()) != (operand_28466->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28452->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_28466->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_28452 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_28452) ;
                                    cPtr_typeGalgasClassType * operand_28466 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_28466) ;
                                    if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                                      if (((operand_28452->mClassTypeName.reader_value ()) == (operand_28466->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_28466->mAncestorClassesMap.reader_hasKey (operand_28452->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_28466->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_28466->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_28452 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_28452) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_28466 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_28466) ;
                                      if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                                        if (((operand_28452->mClassTypeName.reader_value ()) != (operand_28466->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28452->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_28466->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_28452 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_28452) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_28466 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_28466) ;
                                        if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                                          if (((operand_28452->mMapTypeName.reader_value ()) != (operand_28466->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28452->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_28466->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_28452 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_28452) ;
                                          cPtr_typeGalgas_enum * operand_28466 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_28466) ;
                                          if ((operand_28452 != NULL) && (operand_28466 != NULL)) {
                                            if (((operand_28452->mEnumTypeName.reader_value ()) != (operand_28466->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_28452->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_28466->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32899 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32984 = var_cas_t2.firstObject () ;
    while ((operand_32899 != NULL)
        && (operand_32984 != NULL)) {
      macroValidPointer (operand_32899) ;
      macroValidPointer (operand_32984) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32899->mType,  operand_32984->mAttributType,  operand_32899->mGalgasVariableName.reader_location ()) ;
      operand_32899 = operand_32899->nextObject () ;
      operand_32984 = operand_32984->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_34217 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_34346 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_34217 != NULL)
        && (operand_34346 != NULL)) {
      macroValidPointer (operand_34217) ;
      macroValidPointer (operand_34346) ;
      if (operand_34217->mFormalArgumentPassingMode.isBuilt () && operand_34346->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_34217->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_34346->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34217->mType,  operand_34346->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_34217->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_34346->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34217->mType,  operand_34346->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_34217->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_34346->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34217->mType,  operand_34346->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_34217->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_34346->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_34346->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_34346->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34217->mType,  operand_34346->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_34346->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_34217->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_34217 = operand_34217->nextObject () ;
      operand_34346 = operand_34346->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_35603 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35671 = var_cas_expressionList.firstObject () ;
    while ((operand_35603 != NULL)
        && (operand_35671 != NULL)) {
      macroValidPointer (operand_35603) ;
      macroValidPointer (operand_35671) ;
      if (operand_35671->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35671->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35756 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35671->mExpression.getPtr ()) ;
          macroValidPointer (operand_35756) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35756->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35603->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35671->mExpression) ;
        }
      }
      operand_35603 = operand_35603->nextObject () ;
      operand_35671 = operand_35671->nextObject () ;
    }
  }
}
...
void GGS_typeTableNomRoutinesDeclarees::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the routine '",
                                   "",
...
void GGS_stateMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_stateMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_typeEnumCstMessageStringMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_lstring   & outParameter0) {
  const char * kErrorMessage [] = {"the message for '",
...
void GGS_typeEnumCstMessageStringMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_lstring & inParameter0) {
  const char * kErrorMessage [] = {"the message for '",
