...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_26137 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_26226 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_26137 != NULL)
      && (operand_26226 != NULL)) {
    macroValidPointer (operand_26137) ;
    macroValidPointer (operand_26226) ;
    if (((operand_26137->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_26226->mAttributType.isBuilt ()) {
        operand_26226->mAttributType (HERE)->methode_getTypeName (_inLexique, var_cas_typeName) ;
      }
      if (((operand_26137->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_26226->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (_inLexique, operand_26137->mName, operand_26226->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (640)) ;
      }else{
          operand_26137->mType.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_26137->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (643)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_26137 = operand_26137->nextObject () ;
    operand_26226 = operand_26226->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length ()) < (var_cas_inSemanticAttributsList.reader_length ())) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length ().reader_string ()))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length ().reader_string ()))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (652)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length ()) > (var_cas_inSemanticAttributsList.reader_length ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length ().reader_string ()))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length ().reader_string ()))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (656)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_28255 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_28269 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_28255 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_28255) ;
    cPtr_typeGalgas_stringset * operand_28269 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_28269) ;
    if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_28255 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_28255) ;
      cPtr_typeGalgas_uint * operand_28269 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_28269) ;
      if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_28255 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_28255) ;
        cPtr_typeGalgas_sint * operand_28269 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_28269) ;
        if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_28255 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_28255) ;
          cPtr_typeGalgas_char * operand_28269 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_28269) ;
          if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_28255 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_28255) ;
            cPtr_typeGalgas_string * operand_28269 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_28269) ;
            if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_28255 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_28255) ;
              cPtr_typeGalgas_bool * operand_28269 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_28269) ;
              if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_28255 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_28255) ;
                cPtr_typeGalgas_double * operand_28269 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_28269) ;
                if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_28255 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_28255) ;
                  cPtr_typeGalgas_ldouble * operand_28269 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_28269) ;
                  if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_28255 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_28255) ;
                    cPtr_typeGalgas_location * operand_28269 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_28269) ;
                    if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_28255 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_28255) ;
                      cPtr_typeGalgas_lchar * operand_28269 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_28269) ;
                      if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_28255 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_28255) ;
                        cPtr_typeGalgas_luint * operand_28269 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_28269) ;
                        if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_28255 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_28255) ;
                          cPtr_typeGalgas_lsint * operand_28269 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_28269) ;
                          if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_28255 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_28255) ;
                            cPtr_typeGalgas_lstring * operand_28269 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_28269) ;
                            if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_28255 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_28255) ;
                              cPtr_typeGalgas_lbool * operand_28269 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_28269) ;
                              if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_28255 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_28255) ;
                                cPtr_typeGalgasUndefinedExternType * operand_28269 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_28269) ;
                                if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                                  if (((operand_28255->mGalgasClassName.reader_value ()) != (operand_28269->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_28255->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_28269->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (697)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_28255 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_28255) ;
                                  cPtr_typeGalgasUndefinedListType * operand_28269 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_28269) ;
                                  if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                                    if (((operand_28255->mListTypeName.reader_value ()) != (operand_28269->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28255->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_28269->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (703)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_28255 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_28255) ;
                                    cPtr_typeGalgasClassType * operand_28269 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_28269) ;
                                    if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                                      if (((operand_28255->mClassTypeName.reader_value ()) == (operand_28269->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! (operand_28269->mAncestorClassesMap.reader_hasKey (operand_28255->mClassTypeName.reader_value ())))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_28269->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_28269->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (711)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_28255 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_28255) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_28269 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_28269) ;
                                      if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                                        if (((operand_28255->mClassTypeName.reader_value ()) != (operand_28269->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28255->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_28269->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (717)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_28255 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_28255) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_28269 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_28269) ;
                                        if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                                          if (((operand_28255->mMapTypeName.reader_value ()) != (operand_28269->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_28255->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_28269->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (724)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_28255 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_28255) ;
                                          cPtr_typeGalgas_enum * operand_28269 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_28269) ;
                                          if ((operand_28255 != NULL) && (operand_28269 != NULL)) {
                                            if (((operand_28255->mEnumTypeName.reader_value ()) != (operand_28269->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_28255->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_28269->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (732)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType ()) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (736)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (753)) ;
  }else if (((var_cas_t1.reader_length ()) > (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (755)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_32702 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32787 = var_cas_t2.firstObject () ;
    while ((operand_32702 != NULL)
        && (operand_32787 != NULL)) {
      macroValidPointer (operand_32702) ;
      macroValidPointer (operand_32787) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_32702->mType,  operand_32787->mAttributType,  operand_32702->mGalgasVariableName.reader_location () SOURCE_FILE_AT_LINE (759)) ;
      operand_32702 = operand_32702->nextObject () ;
      operand_32787 = operand_32787->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (778)) ;
  }else if (((var_cas_signatureReference.reader_length ()) < (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (780)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_34021 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_34150 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_34021 != NULL)
        && (operand_34150 != NULL)) {
      macroValidPointer (operand_34021) ;
      macroValidPointer (operand_34150) ;
      if (operand_34021->mFormalArgumentPassingMode.isBuilt () && operand_34150->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_34021->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_34150->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34021->mType,  operand_34150->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (787)) ;
        }else{
          if ((operand_34021->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_34150->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34021->mType,  operand_34150->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (789)) ;
          }else{
            if ((operand_34021->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_34150->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34021->mType,  operand_34150->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (791)) ;
            }else{
              if ((operand_34021->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_34150->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_34150->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_34150->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34021->mType,  operand_34150->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (796)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((operand_34150->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_34021->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (800)) ;
              }
            }
          }
        }
      }
      operand_34021 = operand_34021->nextObject () ;
      operand_34150 = operand_34150->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_35407 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35475 = var_cas_expressionList.firstObject () ;
    while ((operand_35407 != NULL)
        && (operand_35475 != NULL)) {
      macroValidPointer (operand_35407) ;
      macroValidPointer (operand_35475) ;
      if (operand_35475->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35475->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35560 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35475->mExpression.getPtr ()) ;
          macroValidPointer (operand_35560) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35560->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35407->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35475->mExpression) ;
        }
      }
      operand_35407 = operand_35407->nextObject () ;
      operand_35475 = operand_35475->nextObject () ;
    }
  }
}
...
methode_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (851)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1200)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1205)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1210)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1215)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1220)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1225)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1230)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1235)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1240)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1245)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1250)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1255)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1260)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1265)) ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = ((var_cas_inFirstBranchconstraintDefinitionSet) - (var_cas_inCurrentBranchconstraintDefinitionSet)) ;
  GGS_stringset::element_type * operand_59853 = var_cas_missingDefinition.firstObject () ;
  while ((operand_59853 != NULL)) {
    macroValidPointer (operand_59853) ;
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59853->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1403)) ;
    operand_59853 = operand_59853->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = ((var_cas_inCurrentBranchconstraintDefinitionSet) - (var_cas_inFirstBranchconstraintDefinitionSet)) ;
  GGS_stringset::element_type * operand_60150 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_60150 != NULL)) {
    macroValidPointer (operand_60150) ;
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60150->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1407)) ;
    operand_60150 = operand_60150->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = ((var_cas_inFirstBranchConstraintDefinitionSet) - (var_cas_inInheritedConstraintDefinitionSet)) ;
  GGS_stringset::element_type * operand_60686 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60686 != NULL)) {
    macroValidPointer (operand_60686) ;
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60686->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1419)) ;
    operand_60686 = operand_60686->nextObject () ;
  }
}
