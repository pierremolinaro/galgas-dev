  ...
  while ((operand_27961 != NULL)
    ...
    if (((operand_27961->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (674))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      if (operand_28050->mAttributType.isBuilt ()) {
        operand_28050->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (676)) ;
      }
      if (((operand_27961->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (677))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_28050->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_27961->mName, operand_28050->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (684)) ;
      }else{
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (821))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (821)))).isBuiltAndTrue ()) {
    ...
    GGS_typeExpressionList::element_type * operand_37303 = var_cas_expressionList.firstObject () ;
    while ((operand_37235 != NULL)
        && (operand_37303 != NULL)) {
      macroValidPointer (operand_37235) ;
      macroValidPointer (operand_37303) ;
      if (operand_37303->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_37303->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_37388 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37303->mExpression.getPtr ()) ;
          macroValidPointer (operand_37388) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_37388->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37235->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_37303->mExpression) ;
        }
      }
      operand_37235 = operand_37235->nextObject () ;
      operand_37303 = operand_37303->nextObject () ;
    }
  }
}
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1247)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1252)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1257)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1262)) ;
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1448)) ;
   ;
  GGS_stringset::element_type * operand_61917 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61917 != NULL)) {
    macroValidPointer (operand_61917) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61917->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1450)) ;
    operand_61917 = operand_61917->nextObject () ;
  }
  ...
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1452)) ;
   ;
  GGS_stringset::element_type * operand_62214 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_62214 != NULL)) {
    macroValidPointer (operand_62214) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62214->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1454)) ;
    operand_62214 = operand_62214->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1464)) ;
   ;
  GGS_stringset::element_type * operand_62750 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62750 != NULL)) {
    macroValidPointer (operand_62750) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62750->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1466)) ;
    operand_62750 = operand_62750->nextObject () ;
  }
}
