...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.instructionsList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mCallInstructionSharedPropertySignatureMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_60696 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60696 != NULL)) {
    macroValidPointer (operand_60696) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60696->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1448)) ;
    operand_60696 = operand_60696->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_60993 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_60993 != NULL)) {
    macroValidPointer (operand_60993) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60993->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1452)) ;
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61529 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61529 != NULL)) {
    macroValidPointer (operand_61529) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61529->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1464)) ;
    operand_61529 = operand_61529->nextObject () ;
  }
}
