...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_28049 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_28138 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_28049 != NULL)
      && (operand_28138 != NULL)) {
    macroValidPointer (operand_28049) ;
    macroValidPointer (operand_28138) ;
    if (((operand_28049->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (675))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_28138->mAttributType.isBuilt ()) {
        operand_28138->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (677)) ;
      }
      if (((operand_28049->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (678))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_28138->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_28049->mName, operand_28138->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (685)) ;
      }else{
          operand_28049->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_28049->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (687))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (688)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_28049 = operand_28049->nextObject () ;
    operand_28138 = operand_28138->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (694))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (694)))) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (696)).reader_string (_inLexique SOURCE_FILE_AT_LINE (696))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (697)).reader_string (_inLexique SOURCE_FILE_AT_LINE (697))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (697)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (698))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (698)))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (700)).reader_string (_inLexique SOURCE_FILE_AT_LINE (700))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (701)).reader_string (_inLexique SOURCE_FILE_AT_LINE (701))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (701)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_30167 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_30181 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_30167 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30167) ;
    cPtr_typeGalgas_stringset * operand_30181 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30181) ;
    if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_30167 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30167) ;
      cPtr_typeGalgas_uint * operand_30181 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30181) ;
      if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_30167 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30167) ;
        cPtr_typeGalgas_sint * operand_30181 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30181) ;
        if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_30167 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30167) ;
          cPtr_typeGalgas_char * operand_30181 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30181) ;
          if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_30167 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30167) ;
            cPtr_typeGalgas_string * operand_30181 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30181) ;
            if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_30167 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30167) ;
              cPtr_typeGalgas_bool * operand_30181 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30181) ;
              if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_30167 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30167) ;
                cPtr_typeGalgas_double * operand_30181 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30181) ;
                if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_30167 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30167) ;
                  cPtr_typeGalgas_ldouble * operand_30181 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30181) ;
                  if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_30167 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30167) ;
                    cPtr_typeGalgas_location * operand_30181 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30181) ;
                    if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_30167 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30167) ;
                      cPtr_typeGalgas_lchar * operand_30181 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30181) ;
                      if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_30167 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30167) ;
                        cPtr_typeGalgas_luint * operand_30181 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30181) ;
                        if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_30167 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30167) ;
                          cPtr_typeGalgas_lsint * operand_30181 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30181) ;
                          if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_30167 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30167) ;
                            cPtr_typeGalgas_lstring * operand_30181 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30181) ;
                            if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_30167 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30167) ;
                              cPtr_typeGalgas_lbool * operand_30181 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30181) ;
                              if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_30167 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30167) ;
                                cPtr_typeGalgasUndefinedExternType * operand_30181 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30181) ;
                                if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                                  if (((operand_30167->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (740))) != (operand_30181->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (740)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_30167->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (741))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_30181->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (742))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (742)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_30167 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30167) ;
                                  cPtr_typeGalgasUndefinedListType * operand_30181 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30181) ;
                                  if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                                    if (((operand_30167->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (746))) != (operand_30181->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (746)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30167->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (747))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_30181->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (748))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (748)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_30167 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30167) ;
                                    cPtr_typeGalgasClassType * operand_30181 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30181) ;
                                    if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                                      if (((operand_30167->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (753))) == (operand_30181->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (753)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_30181->mAncestorClassesMap.reader_hasKey (_inLexique, operand_30167->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (754)) SOURCE_FILE_AT_LINE (754))))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_30181->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (755))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_30181->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (756))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (756)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_30167 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30167) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_30181 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30181) ;
                                      if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                                        if (((operand_30167->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (760))) != (operand_30181->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (760)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30167->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (761))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_30181->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (762))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (762)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_30167 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30167) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_30181 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30181) ;
                                        if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                                          if (((operand_30167->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766))) != (operand_30181->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30167->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_30181->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (768))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (769)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_30167 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30167) ;
                                          cPtr_typeGalgas_enum * operand_30181 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30181) ;
                                          if ((operand_30167 != NULL) && (operand_30181 != NULL)) {
                                            if (((operand_30167->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (774))) != (operand_30181->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (774)))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_30167->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (775))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_30181->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (776))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (777)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (780))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (781)))) SOURCE_FILE_AT_LINE (781)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (797))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (797)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (798)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (799))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (799)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (800)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_34614 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34699 = var_cas_t2.firstObject () ;
    while ((operand_34614 != NULL)
        && (operand_34699 != NULL)) {
      macroValidPointer (operand_34614) ;
      macroValidPointer (operand_34699) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34614->mType,  operand_34699->mAttributType,  operand_34614->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (804)) SOURCE_FILE_AT_LINE (804)) ;
      operand_34614 = operand_34614->nextObject () ;
      operand_34699 = operand_34699->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (822))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (822)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (823)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (824))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (824)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (825)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_35933 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_36062 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35933 != NULL)
        && (operand_36062 != NULL)) {
      macroValidPointer (operand_35933) ;
      macroValidPointer (operand_36062) ;
      if (operand_35933->mFormalArgumentPassingMode.isBuilt () && operand_36062->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_35933->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_36062->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35933->mType,  operand_36062->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (832)) ;
        }else{
          if ((operand_35933->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_36062->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35933->mType,  operand_36062->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (834)) ;
          }else{
            if ((operand_35933->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_36062->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35933->mType,  operand_36062->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (836)) ;
            }else{
              if ((operand_35933->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_36062->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_36062->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_36062->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35933->mType,  operand_36062->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (841)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_36062->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (844))) + (GGS_string (true, " is not compatible with ")))) + (operand_35933->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (845)))) SOURCE_FILE_AT_LINE (845)) ;
              }
            }
          }
        }
      }
      operand_35933 = operand_35933->nextObject () ;
      operand_36062 = operand_36062->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37323 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37391 = var_cas_expressionList.firstObject () ;
    while ((operand_37323 != NULL)
        && (operand_37391 != NULL)) {
      macroValidPointer (operand_37323) ;
      macroValidPointer (operand_37391) ;
      if (operand_37391->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_37391->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_37476 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37391->mExpression.getPtr ()) ;
          macroValidPointer (operand_37476) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_37476->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37323->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_37391->mExpression) ;
        }
      }
      operand_37323 = operand_37323->nextObject () ;
      operand_37391 = operand_37391->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (896)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1248)) ;
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1449)) ;
   ;
  GGS_stringset::element_type * operand_62005 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62005 != NULL)) {
    macroValidPointer (operand_62005) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62005->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1451)) ;
    operand_62005 = operand_62005->nextObject () ;
  }
  ...
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1453)) ;
   ;
  GGS_stringset::element_type * operand_62302 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_62302 != NULL)) {
    macroValidPointer (operand_62302) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62302->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1455)) ;
    operand_62302 = operand_62302->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1465)) ;
   ;
  GGS_stringset::element_type * operand_62838 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62838 != NULL)) {
    macroValidPointer (operand_62838) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62838->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1467)) ;
    operand_62838 = operand_62838->nextObject () ;
  }
}
