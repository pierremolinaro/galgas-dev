...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_60821 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60821 != NULL)) {
    macroValidPointer (operand_60821) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60821->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1449)) ;
    operand_60821 = operand_60821->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_61116 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61116 != NULL)) {
    macroValidPointer (operand_61116) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61116->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1453)) ;
    operand_61116 = operand_61116->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61650 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61650 != NULL)) {
    macroValidPointer (operand_61650) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61650->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1465)) ;
    operand_61650 = operand_61650->nextObject () ;
  }
}
