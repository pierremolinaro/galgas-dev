...
//                    february 22th, 2007, at 13h46'46"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
cPtr_mdaVariableDeclaration::
cPtr_mdaVariableDeclaration (const GGS_typeCplusPlusName & argument_0,
                                const GGS_lstring & argument_1 COMMA_LOCATION_ARGS)
:cPtr_typeInstruction (THERE),
mVariableName (argument_0),
mEntityName (argument_1) {
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_mdaVariableDeclaration * GGS_mdaVariableDeclaration::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_mdaVariableDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_mdaVariableDeclaration * _p = dynamic_cast <const cPtr_mdaVariableDeclaration *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = (mVariableName == _p->mVariableName).boolValue ()
         && (mEntityName == _p->mEntityName).boolValue () ;
  }
...
appendForDescription (C_Lexique & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@mdaVariableDeclaration:"
           << mVariableName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_mdaVariableDeclaration::
GGS_mdaVariableDeclaration (void) {
  mPointer = NULL ;
}
...
GGS_mdaVariableDeclaration::
GGS_mdaVariableDeclaration (const GGS_mdaVariableDeclaration & inOperand)
:GGS_typeInstruction () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_mdaVariableDeclaration::
~GGS_mdaVariableDeclaration (void) {
  macroDetachPointer (mPointer, cPtr_mdaVariableDeclaration) ;
}

//---------------------------------------------------------------------------*

void GGS_mdaVariableDeclaration::
operator = (const GGS_mdaVariableDeclaration & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}

//---------------------------------------------------------------------------*

GGS_mdaVariableDeclaration GGS_mdaVariableDeclaration::
constructor_new (C_Lexique & /* inLexique */,
                 const GGS_typeCplusPlusName & argument_0,
                 const GGS_lstring & argument_1 COMMA_LOCATION_ARGS) {
  GGS_mdaVariableDeclaration result ;
  macroMyNew (result.mPointer, cPtr_mdaVariableDeclaration (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_typeCplusPlusName  GGS_mdaVariableDeclaration::
reader_mVariableName (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeCplusPlusName   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_mdaVariableDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_mdaVariableDeclaration *) mPointer)->mVariableName ;
  }
  return result ;
}
...
GGS_lstring  GGS_mdaVariableDeclaration::
reader_mEntityName (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_mdaVariableDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_mdaVariableDeclaration *) mPointer)->mEntityName ;
  }
  return result ;
}
...
GGS_bool GGS_mdaVariableDeclaration::
operator == (const GGS_mdaVariableDeclaration & inOperand) const {
  bool equal = mPointer == inOperand.mPointer ;
  if (_isBuilt () && inOperand._isBuilt () && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
  }
...
GGS_string GGS_mdaVariableDeclaration::
reader_description (C_Lexique & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  C_String s ;
  s << "<class @mdaVariableDeclaration" ;
  if (_isBuilt ()) {
    mPointer->appendForDescription (_inLexique, s, inIndentation + 1 COMMA_THERE) ;
  }else{
    s << "not built" ;
