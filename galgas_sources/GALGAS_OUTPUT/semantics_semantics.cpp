    ...
    if (((operand_25695->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      if (((operand_25695->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25784->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
    ...
    while ((operand_34960 != NULL)
      ...
      if (operand_35028->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35028->mExpression.getPtr ()) != NULL) {
          ...
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35113->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34960->mType) ;
...
cPtr_typeEntiteActionExterne::cPtr_typeEntiteActionExterne (const GGS_L_EXsignature & argument_0)
