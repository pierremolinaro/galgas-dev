...
isEqualToObject (const C_GGS_Object * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = (mLiteralStringList == _p->mLiteralStringList).boolValue () ;
  }
  return equal ;
}
...
void routine_buildMapWithLocalConstants (C_Compiler & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_33168 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_33253 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_33168 != NULL)
      && (operand_33253 != NULL)) {
    macroValidPointer (operand_33168) ;
    macroValidPointer (operand_33253) ;
    if (((operand_33168->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (810))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_33253->mAttributType._isBuilt ()) {
        operand_33253->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (812)) ;
      }
      if (((operand_33168->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (813))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_33253->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_33168->mName, operand_33253->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (820)) ;
      }else{
        operand_33168->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_33168->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (822))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (824)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_33168 = operand_33168->nextObject () ;
    operand_33253 = operand_33253->nextObject () ;
  }
...
void routine_verifierCompatibiliteTypes (C_Compiler & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (852))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (852)))).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_35559 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35640 = var_cas_t2.firstObject () ;
    while ((operand_35559 != NULL)
        && (operand_35640 != NULL)) {
      macroValidPointer (operand_35559) ;
      macroValidPointer (operand_35640) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35559->mType,  operand_35640->mAttributType,  operand_35559->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (862)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (859)) ;
      operand_35559 = operand_35559->nextObject () ;
      operand_35640 = operand_35640->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Compiler & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (882))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (882)))).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_36913 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37038 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_36913 != NULL)
        && (operand_37038 != NULL)) {
      macroValidPointer (operand_36913) ;
      macroValidPointer (operand_37038) ;
      if (operand_36913->mFormalArgumentPassingMode._isBuilt () && operand_37038->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_36913->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37038->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36913->mType,  operand_37038->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (892)) ;
        }else{
          if ((operand_36913->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37038->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36913->mType,  operand_37038->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (894)) ;
          }else{
            if ((operand_36913->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37038->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36913->mType,  operand_37038->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (896)) ;
            }else{
              if ((operand_36913->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37038->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37038->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_37712 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37038->mType.getPtr ()) ;
                  if (operand_37712 != NULL) {
                    macroValidPointer (operand_37712) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36913->mType,  operand_37038->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (901)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_37038->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (904))) + (GGS_string (true, " is not compatible with ")))) + (operand_36913->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (905)))) SOURCE_FILE_AT_LINE (906)) ;
              }
            }
          }
        }
      }
      operand_36913 = operand_36913->nextObject () ;
      operand_37038 = operand_37038->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38305 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38369 = var_cas_expressionList.firstObject () ;
    while ((operand_38305 != NULL)
        && (operand_38369 != NULL)) {
      macroValidPointer (operand_38305) ;
      macroValidPointer (operand_38369) ;
      if (operand_38369->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_38452 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38369->mExpression.getPtr ()) ;
        if (operand_38452 != NULL) {
          macroValidPointer (operand_38452) ; 
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38305->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_38369->mExpression) ;
        }
      }
      operand_38305 = operand_38305->nextObject () ;
      operand_38369 = operand_38369->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performMetamodelInclusion (C_Compiler & _inLexique,
  ...
  if (((! (var_cas_ioSuperMetamodels.reader_hasKey (_inLexique, var_cas_inSuperMetamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1482)) SOURCE_FILE_AT_LINE (1482))))).isBuiltAndTrue ()) {
    ...
    GGS_entityToImplementMap::element_type * operand_61078 = var_cas_superMetamodelEntityMap.firstObject () ;
    while ((operand_61078 != NULL)) {
      macroValidPointer (operand_61078) ;
      if ((var_cas_ioAllEntityMap.reader_hasKey (_inLexique, operand_61078->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1496)) SOURCE_FILE_AT_LINE (1496))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (operand_61078->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1497))))) + (GGS_string (true, "' is already defined in a previously imported metamodel"))) SOURCE_FILE_AT_LINE (1498)) ;
      }else{
        var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_61078->mKey, operand_61078->mInfo.mAllMetamodelPropertyMap, operand_61078->mInfo.mIsAbstract, operand_61078->mInfo.mCurrentMetamodelPropertyMap, operand_61078->mInfo.mSuperEntityName, operand_61078->mInfo.mAncestorClassesMap, operand_61078->mInfo.mPropertyList, operand_61078->mInfo.mMetamodelName, operand_61078->mInfo.mID SOURCE_FILE_AT_LINE (1499)) ;
      }
      operand_61078 = operand_61078->nextObject () ;
    }
    GGS_stringset::element_type * operand_62225 = var_cas_superMetamodelsOfSuperMetamodels.firstObject () ;
    while ((operand_62225 != NULL)) {
      macroValidPointer (operand_62225) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_inMetamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_62225->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_ioSuperMetamodels,  var_cas_ioAllEntityMap SOURCE_FILE_AT_LINE (1513)) ;
      operand_62225 = operand_62225->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
