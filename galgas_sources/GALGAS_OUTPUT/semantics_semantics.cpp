...
reader_mLocationOffset (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_location   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeOperandName *> (mPointer) != NULL,
...
GGS_typeDescriptionInExpression (void) {
  mPointer = NULL ;
}
...
GGS_typeDescriptionInExpression::
GGS_typeDescriptionInExpression (const GGS_typeDescriptionInExpression & inOperand)
:GGS_typeExpression () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_typeDescriptionInExpression::
~GGS_typeDescriptionInExpression (void) {
  macroDetachPointer (mPointer, cPtr_typeDescriptionInExpression) ;
}

//---------------------------------------------------------------------------*

void GGS_typeDescriptionInExpression::
operator = (const GGS_typeDescriptionInExpression & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
reader_mInstructionLocation (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_typeDescriptionInExpression *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeDescriptionInExpression *) mPointer)->mInstructionLocation ;
  }
  return result ;
}
...
GGS_bool GGS_typeDescriptionInExpression::
operator == (const GGS_typeDescriptionInExpression & inOperand) const {
  bool equal = mPointer == inOperand.mPointer ;
  if (_isBuilt () && inOperand._isBuilt () && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
  }
...
GGS_string GGS_typeDescriptionInExpression::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  C_String s ;
  s << "<class @typeDescriptionInExpression" ;
  if (_isBuilt ()) {
    mPointer->appendForDescription (_inLexique, s, inIndentation + 1 COMMA_THERE) ;
  }else{
    s << "not built" ;
...
reader_mLiteralString (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeLiteralStringExpression *> (mPointer) != NULL,
...
void routine_buildMapWithLocalConstants (C_Compiler & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_33161 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_33246 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_33161 != NULL)
      && (operand_33246 != NULL)) {
    macroValidPointer (operand_33161) ;
    macroValidPointer (operand_33246) ;
    if (((operand_33161->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (810))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_33246->mAttributType._isBuilt ()) {
        operand_33246->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (812)) ;
      }
      if (((operand_33161->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (813))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_33246->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_33161->mName, operand_33246->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (820)) ;
      }else{
        operand_33161->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_33161->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (822))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (824)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_33161 = operand_33161->nextObject () ;
    operand_33246 = operand_33246->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (829))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (829)))) & ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (831)).reader_string (_inLexique SOURCE_FILE_AT_LINE (831))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (832)).reader_string (_inLexique SOURCE_FILE_AT_LINE (832))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (833)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (833))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (833)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (835)).reader_string (_inLexique SOURCE_FILE_AT_LINE (835))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (836)).reader_string (_inLexique SOURCE_FILE_AT_LINE (836))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (837)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteTypes (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (852))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (852)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (854)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (854))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (854)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (856)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_35552 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35633 = var_cas_t2.firstObject () ;
    while ((operand_35552 != NULL)
        && (operand_35633 != NULL)) {
      macroValidPointer (operand_35552) ;
      macroValidPointer (operand_35633) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35552->mType,  operand_35633->mAttributType,  operand_35552->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (862)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (859)) ;
      operand_35552 = operand_35552->nextObject () ;
      operand_35633 = operand_35633->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (882))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (882)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (884)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (884))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (884)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (886)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_36906 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37031 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_36906 != NULL)
        && (operand_37031 != NULL)) {
      macroValidPointer (operand_36906) ;
      macroValidPointer (operand_37031) ;
      if (operand_36906->mFormalArgumentPassingMode._isBuilt () && operand_37031->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_36906->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37031->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36906->mType,  operand_37031->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (892)) ;
        }else{
          if ((operand_36906->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37031->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36906->mType,  operand_37031->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (894)) ;
          }else{
            if ((operand_36906->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37031->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36906->mType,  operand_37031->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (896)) ;
            }else{
              if ((operand_36906->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37031->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37031->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_37705 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37031->mType.getPtr ()) ;
                  if (operand_37705 != NULL) {
                    macroValidPointer (operand_37705) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_36906->mType,  operand_37031->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (901)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_37031->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (904))) + (GGS_string (true, " is not compatible with ")))) + (operand_36906->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (905)))) SOURCE_FILE_AT_LINE (906)) ;
              }
            }
          }
        }
      }
      operand_36906 = operand_36906->nextObject () ;
      operand_37031 = operand_37031->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38298 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38362 = var_cas_expressionList.firstObject () ;
    while ((operand_38298 != NULL)
        && (operand_38362 != NULL)) {
      macroValidPointer (operand_38298) ;
      macroValidPointer (operand_38362) ;
      if (operand_38362->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_38445 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38362->mExpression.getPtr ()) ;
        if (operand_38445 != NULL) {
          macroValidPointer (operand_38445) ; 
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38298->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_38362->mExpression) ;
        }
      }
      operand_38298 = operand_38298->nextObject () ;
      operand_38362 = operand_38362->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
method_verifierType (C_Compiler & _inLexique,
  ...
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  aPositionVariableCible,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (958)) ;
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = (mTreeWalkingComponentName == _p->mTreeWalkingComponentName).boolValue ()
         && (mModelVariableCppName == _p->mModelVariableCppName).boolValue ()
         && (mExpressionsList == _p->mExpressionsList).boolValue () ;
  }
  return equal ;
}
...
GGS_C_treewalkingInstruction (void) {
  mPointer = NULL ;
}
...
GGS_C_treewalkingInstruction::
GGS_C_treewalkingInstruction (const GGS_C_treewalkingInstruction & inOperand)
:GGS_typeInstruction () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_C_treewalkingInstruction::
~GGS_C_treewalkingInstruction (void) {
  macroDetachPointer (mPointer, cPtr_C_treewalkingInstruction) ;
}

//---------------------------------------------------------------------------*

void GGS_C_treewalkingInstruction::
operator = (const GGS_C_treewalkingInstruction & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
GGS_bool GGS_C_treewalkingInstruction::
operator == (const GGS_C_treewalkingInstruction & inOperand) const {
  bool equal = mPointer == inOperand.mPointer ;
  if (_isBuilt () && inOperand._isBuilt () && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
  }
...
GGS_string GGS_C_treewalkingInstruction::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  C_String s ;
  s << "<class @C_treewalkingInstruction" ;
  if (_isBuilt ()) {
    mPointer->appendForDescription (_inLexique, s, inIndentation + 1 COMMA_THERE) ;
  }else{
    s << "not built" ;
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = (mRoutineName == _p->mRoutineName).boolValue ()
         && (mExpressionsList == _p->mExpressionsList).boolValue ()
         && (mFormalParameterList == _p->mFormalParameterList).boolValue ()
         && (mIsExternActionCall == _p->mIsExternActionCall).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cSortedListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = (mMetamodelClassIDString == _p->mMetamodelClassIDString).boolValue ()
         ...
         && (mMetamodelName == _p->mMetamodelName).boolValue () ;
  }
  return equal ;
}
...
void routine_performMetamodelInclusion (C_Compiler & _inLexique,
  ...
  #endif
  if (((! (var_cas_ioSuperMetamodels.reader_hasKey (_inLexique, var_cas_inSuperMetamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1483)) SOURCE_FILE_AT_LINE (1483))))).isBuiltAndTrue ()) {
    var_cas_ioSuperMetamodels._addAssign_operation (var_cas_inSuperMetamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1484))) ;
    ...
    if (var_cas_inMetamodelComponentMap._isBuilt ()) {
      var_cas_inMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperMetamodelName, automatic_var_0, var_cas_superMetamodelEntityMap, var_cas_superMetamodelsOfSuperMetamodels SOURCE_FILE_AT_LINE (1487)) ;
    }
    GGS_entityToImplementMap::element_type * operand_61118 = var_cas_superMetamodelEntityMap.firstObject () ;
    while ((operand_61118 != NULL)) {
      macroValidPointer (operand_61118) ;
      if ((var_cas_ioAllEntityMap.reader_hasKey (_inLexique, operand_61118->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1497)) SOURCE_FILE_AT_LINE (1497))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (operand_61118->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1498))))) + (GGS_string (true, "' is already defined in a previously imported metamodel"))) SOURCE_FILE_AT_LINE (1499)) ;
      }else{
        var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_61118->mKey, operand_61118->mInfo.mAllMetamodelPropertyMap, operand_61118->mInfo.mIsAbstract, operand_61118->mInfo.mCurrentMetamodelPropertyMap, operand_61118->mInfo.mSuperEntityName, operand_61118->mInfo.mAncestorClassesMap, operand_61118->mInfo.mPropertyList, operand_61118->mInfo.mMetamodelName, operand_61118->mInfo.mID SOURCE_FILE_AT_LINE (1500)) ;
      }
      operand_61118 = operand_61118->nextObject () ;
    }
    GGS_stringset::element_type * operand_62265 = var_cas_superMetamodelsOfSuperMetamodels.firstObject () ;
    while ((operand_62265 != NULL)) {
      macroValidPointer (operand_62265) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_inMetamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_62265->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_ioSuperMetamodels,  var_cas_ioAllEntityMap SOURCE_FILE_AT_LINE (1514)) ;
      operand_62265 = operand_62265->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
