...
elementOf_GGG_typeCplusPlusNameList::
elementOf_GGG_typeCplusPlusNameList (const GGG_typeCplusPlusName  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeCplusPlusNameList *) NULL ;
  mCppName = argument_0 ;
  retain (mCppName COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeCplusPlusNameList::
~elementOf_GGG_typeCplusPlusNameList (void) {
  macroRelease (mCppName, this) ;
}
...
AC_galgas_map_elementEx * GGS_typeClassMessagesMap::
...
void GGS_typeClassMessagesMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
...
elementOf_GGG_typeSemanticsTypesList::
elementOf_GGG_typeSemanticsTypesList (const GGG_AC_galgasType  *argument_0,
                                const GGG_lstring  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeSemanticsTypesList *) NULL ;
  mType = argument_0 ;
  retain (mType COMMA_HERE) ;
  mGalgasVariableName = argument_1 ;
  retain (mGalgasVariableName COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeSemanticsTypesList::
~elementOf_GGG_typeSemanticsTypesList (void) {
  macroRelease (mType, this) ;
  macroRelease (mGalgasVariableName, this) ;
}
...
elementOf_GGG_L_assignedVariables::
elementOf_GGG_L_assignedVariables (const GGG_typeCplusPlusName  *argument_0,
                                const GGG_lstring  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_L_assignedVariables *) NULL ;
  aNomVariableCible = argument_0 ;
  retain (aNomVariableCible COMMA_HERE) ;
  aNomAttributSource = argument_1 ;
  retain (aNomAttributSource COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_L_assignedVariables::
~elementOf_GGG_L_assignedVariables (void) {
  macroRelease (aNomVariableCible, this) ;
  macroRelease (aNomAttributSource, this) ;
}
...
elementOf_GGG_typeListeCibles::
elementOf_GGG_typeListeCibles (const GGG_typeCible  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeListeCibles *) NULL ;
  aCible = argument_0 ;
  retain (aCible COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeListeCibles::
~elementOf_GGG_typeListeCibles (void) {
  macroRelease (aCible, this) ;
}
...
elementOf_GGG_typeListeTypesEtNomsArgMethode::
elementOf_GGG_typeListeTypesEtNomsArgMethode (const GGG_AC_galgasType  *argument_0,
                                const GGG_formalArgumentPassingMode &argument_1,
                                const GGG_typeCplusPlusName  *argument_2,
                                const GGG_bool &argument_3 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeListeTypesEtNomsArgMethode *) NULL ;
  mType = argument_0 ;
  retain (mType COMMA_HERE) ;
...
elementOf_GGG_typeListeTypesEtNomsArgMethode::
~elementOf_GGG_typeListeTypesEtNomsArgMethode (void) {
  macroRelease (mType, this) ;
  macroRelease (mCppName, this) ;
}
...
elementOf_GGG_typeInstructionsList::
elementOf_GGG_typeInstructionsList (const GGG_typeInstruction  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeInstructionsList *) NULL ;
  aInstruction = argument_0 ;
  retain (aInstruction COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeInstructionsList::
~elementOf_GGG_typeInstructionsList (void) {
  macroRelease (aInstruction, this) ;
}
...
elementOf_GGG_L_nameWithType::
elementOf_GGG_L_nameWithType (const GGG_lstring  *argument_0,
                                const GGG_lstring  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_L_nameWithType *) NULL ;
  mType = argument_0 ;
  retain (mType COMMA_HERE) ;
  mName = argument_1 ;
  retain (mName COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_L_nameWithType::
~elementOf_GGG_L_nameWithType (void) {
  macroRelease (mType, this) ;
  macroRelease (mName, this) ;
}
...
elementOf_GGG_typeExpressionList::
elementOf_GGG_typeExpressionList (const GGG_typeExpression  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeExpressionList *) NULL ;
  mExpression = argument_0 ;
  retain (mExpression COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeExpressionList::
~elementOf_GGG_typeExpressionList (void) {
  macroRelease (mExpression, this) ;
}
...
elementOf_GGG_L_expression_instructionsList_list::
elementOf_GGG_L_expression_instructionsList_list (const GGG_typeExpression  *argument_0,
                                const GGG_typeInstructionsList  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_L_expression_instructionsList_list *) NULL ;
  mIFexpression = argument_0 ;
  retain (mIFexpression COMMA_HERE) ;
...
elementOf_GGG_L_expression_instructionsList_list::
~elementOf_GGG_L_expression_instructionsList_list (void) {
  macroRelease (mIFexpression, this) ;
...
AC_galgas_map_elementEx * GGS_typeTableRoutinesAimplementer::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableRoutinesAimplementer::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeTableAttributsSemantiques::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableAttributsSemantiques::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25695 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25784 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25695 != NULL)
      && (operand_25784 != NULL)) {
    macroValidPointer (operand_25695) ;
    macroValidPointer (operand_25784) ;
    if (((operand_25695->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25784->mAttributType.isBuilt ()) {
        operand_25784->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25695->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        GGS_typeCplusPlusName  var_cas_cppName ;
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE))) && (var_cas_first))).isBuiltAndTrue ()) {
          var_cas_cppName = GGS_typeKeyName::constructor_new (var_cas_inLocation COMMA_HERE) ;
        }else{
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25784->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25695->mName, operand_25784->mAttributType, var_cas_cppName) ;
      }else{
          operand_25695->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25695->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25695 = operand_25695->nextObject () ;
    operand_25784 = operand_25784->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27807 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27821 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27807 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27807) ;
    cPtr_typeGalgas_stringset * operand_27821 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27821) ;
    if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27807 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27807) ;
      cPtr_typeGalgas_uint * operand_27821 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27821) ;
      if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27807 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27807) ;
        cPtr_typeGalgas_sint * operand_27821 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27821) ;
        if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27807 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27807) ;
          cPtr_typeGalgas_char * operand_27821 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27821) ;
          if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27807 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27807) ;
            cPtr_typeGalgas_string * operand_27821 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27821) ;
            if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27807 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27807) ;
              cPtr_typeGalgas_bool * operand_27821 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27821) ;
              if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27807 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27807) ;
                cPtr_typeGalgas_double * operand_27821 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27821) ;
                if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27807 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27807) ;
                  cPtr_typeGalgas_ldouble * operand_27821 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27821) ;
                  if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27807 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27807) ;
                    cPtr_typeGalgas_location * operand_27821 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27821) ;
                    if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27807 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27807) ;
                      cPtr_typeGalgas_lchar * operand_27821 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27821) ;
                      if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27807 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27807) ;
                        cPtr_typeGalgas_luint * operand_27821 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27821) ;
                        if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27807 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27807) ;
                          cPtr_typeGalgas_lsint * operand_27821 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27821) ;
                          if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27807 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27807) ;
                            cPtr_typeGalgas_lstring * operand_27821 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27821) ;
                            if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27807 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27807) ;
                              cPtr_typeGalgas_lbool * operand_27821 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27821) ;
                              if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27807 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27807) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27821 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27821) ;
                                if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                                  if (((operand_27807->mGalgasClassName.reader_value ()) != (operand_27821->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27807->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27821->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27807 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27807) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27821 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27821) ;
                                  if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                                    if (((operand_27807->mListTypeName.reader_value ()) != (operand_27821->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27807->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27821->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27807 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27807) ;
                                    cPtr_typeGalgasClassType * operand_27821 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27821) ;
                                    if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                                      if (((operand_27807->mClassTypeName.reader_value ()) == (operand_27821->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27821->mAncestorClassesMap.reader_hasKey (operand_27807->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27821->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27821->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27807 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27807) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27821 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27821) ;
                                      if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                                        if (((operand_27807->mClassTypeName.reader_value ()) != (operand_27821->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27807->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27821->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27807 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27807) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27821 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27821) ;
                                        if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                                          if (((operand_27807->mMapTypeName.reader_value ()) != (operand_27821->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27807->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27821->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27807 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27807) ;
                                          cPtr_typeGalgas_enum * operand_27821 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27821) ;
                                          if ((operand_27807 != NULL) && (operand_27821 != NULL)) {
                                            if (((operand_27807->mEnumTypeName.reader_value ()) != (operand_27821->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27807->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27821->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32254 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32339 = var_cas_t2.firstObject () ;
    while ((operand_32254 != NULL)
        && (operand_32339 != NULL)) {
      macroValidPointer (operand_32254) ;
      macroValidPointer (operand_32339) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32254->mType,  operand_32339->mAttributType,  operand_32254->mGalgasVariableName.reader_location ()) ;
      operand_32254 = operand_32254->nextObject () ;
      operand_32339 = operand_32339->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_33574 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33703 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33574 != NULL)
        && (operand_33703 != NULL)) {
      macroValidPointer (operand_33574) ;
      macroValidPointer (operand_33703) ;
      if (operand_33574->mFormalArgumentPassingMode.isBuilt () && operand_33703->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33574->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33703->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33574->mType,  operand_33703->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33574->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33703->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33574->mType,  operand_33703->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33574->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33703->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33574->mType,  operand_33703->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33574->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33703->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33703->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33703->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33574->mType,  operand_33703->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33703->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33574->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33574 = operand_33574->nextObject () ;
      operand_33703 = operand_33703->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_34960 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35028 = var_cas_expressionList.firstObject () ;
    while ((operand_34960 != NULL)
        && (operand_35028 != NULL)) {
      macroValidPointer (operand_34960) ;
      macroValidPointer (operand_35028) ;
      if (operand_35028->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35028->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35113 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35028->mExpression.getPtr ()) ;
          macroValidPointer (operand_35113) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35113->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34960->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35028->mExpression) ;
        }
      }
      operand_34960 = operand_34960->nextObject () ;
      operand_35028 = operand_35028->nextObject () ;
    }
  }
}
...
cPtr_typeEntiteNonTerminal::cPtr_typeEntiteNonTerminal (const GGS_M_nonterminalSymbolAlts & argument_0 COMMA_LOCATION_ARGS)
...
//---------------------------------------------------------------------------*
  ...
  cPtr_typeEntiteNonTerminal * GGS_typeEntiteNonTerminal::
    ...
    macroMyNew (ptr_, cPtr_typeEntiteNonTerminal (argument_0 COMMA_THERE)) ;
    return ptr_ ;
  }
#endif
...
elementOf_GGG_L_matchInstructionCasesList::
elementOf_GGG_L_matchInstructionCasesList (const GGG_lstring  *argument_0,
                                const GGG_lstring  *argument_1,
                                const GGG_typeInstructionsList  *argument_2 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_L_matchInstructionCasesList *) NULL ;
  mCase1_name = argument_0 ;
  retain (mCase1_name COMMA_HERE) ;
  mCase2_name = argument_1 ;
  retain (mCase2_name COMMA_HERE) ;
...
elementOf_GGG_L_matchInstructionCasesList::
~elementOf_GGG_L_matchInstructionCasesList (void) {
  macroRelease (mCase1_name, this) ;
  macroRelease (mCase2_name, this) ;
  macroRelease (mInstructionsList, this) ;
}
...
elementOf_GGG_foreachEnumerationList::
elementOf_GGG_foreachEnumerationList (const GGG_typeCplusPlusName  *argument_0,
                                const GGG_location  *argument_1,
                                const GGG_string *argument_2 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_foreachEnumerationList *) NULL ;
  mCppEnumeratedVariableName = argument_0 ;
  retain (mCppEnumeratedVariableName COMMA_HERE) ;
  mLocationOffset = argument_1 ;
  retain (mLocationOffset COMMA_HERE) ;
  mCppTypeName = argument_2 ;
  retain (mCppTypeName COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_foreachEnumerationList::
~elementOf_GGG_foreachEnumerationList (void) {
  macroRelease (mCppEnumeratedVariableName, this) ;
  macroRelease (mLocationOffset, this) ;
  macroRelease (mCppTypeName, this) ;
}
...
elementOf_GGG_typeStructuredExtractCasesList::
elementOf_GGG_typeStructuredExtractCasesList (const GGG_lstring  *argument_0,
                                const GGG_location  *argument_1,
                                const GGG_typeInstructionsList  *argument_2,
                                const GGG_bool &argument_3 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeStructuredExtractCasesList *) NULL ;
  mClassName = argument_0 ;
  retain (mClassName COMMA_HERE) ;
  mResultVarID = argument_1 ;
  retain (mResultVarID COMMA_HERE) ;
  mInstructionsList = argument_2 ;
  retain (mInstructionsList COMMA_HERE) ;
...
elementOf_GGG_typeStructuredExtractCasesList::
~elementOf_GGG_typeStructuredExtractCasesList (void) {
  macroRelease (mClassName, this) ;
  macroRelease (mResultVarID, this) ;
  macroRelease (mInstructionsList, this) ;
}
...
AC_galgas_map_elementEx * GGS_typeTableNomRoutinesDeclarees::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableNomRoutinesDeclarees::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_stateMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_stateMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
elementOf_GGG_typeEntitiesToGenerateList::
elementOf_GGG_typeEntitiesToGenerateList (const GGG_typeEntityToGenerate  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeEntitiesToGenerateList *) NULL ;
  mEntityToGenerate = argument_0 ;
  retain (mEntityToGenerate COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeEntitiesToGenerateList::
~elementOf_GGG_typeEntitiesToGenerateList (void) {
  macroRelease (mEntityToGenerate, this) ;
}
...
AC_galgas_map_elementEx * GGS_typeEnumCstMessageStringMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeEnumCstMessageStringMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
