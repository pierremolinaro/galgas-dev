...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "binaryset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1338)) ;
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61237 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61237 != NULL)) {
    macroValidPointer (operand_61237) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61237->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1457)) ;
    operand_61237 = operand_61237->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_61532 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61532 != NULL)) {
    macroValidPointer (operand_61532) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61532->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1461)) ;
    operand_61532 = operand_61532->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_62066 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62066 != NULL)) {
    macroValidPointer (operand_62066) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62066->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1473)) ;
    operand_62066 = operand_62066->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
