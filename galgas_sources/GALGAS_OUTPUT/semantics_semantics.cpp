...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/Developpements/mes_prgms/galgas/galgas_sources/semantics_semantics.ggs" ;
...
cPtr_typeMessageInstruction::cPtr_typeMessageInstruction (const GGS_typeExpression & argument_0 COMMA_LOCATION_ARGS)
:cPtr_typeInstruction (THERE),
...
//---------------------------------------------------------------------------*
  ...
  cPtr_typeMessageInstruction * GGS_typeMessageInstruction::
    ...
    macroMyNew (ptr_, cPtr_typeMessageInstruction (argument_0 COMMA_THERE)) ;
    return ptr_ ;
  }
#endif
...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25746 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25835 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25746 != NULL)
      && (operand_25835 != NULL)) {
    macroValidPointer (operand_25746) ;
    macroValidPointer (operand_25835) ;
    if (((operand_25746->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25835->mAttributType.isBuilt ()) {
        operand_25835->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25746->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25835->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25746->mName, operand_25835->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (630)) ;
      }else{
          operand_25746->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25746->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (633)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_25746 = operand_25746->nextObject () ;
    operand_25835 = operand_25835->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length ()) < (var_cas_inSemanticAttributsList.reader_length ())) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length ().reader_string ()))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length ().reader_string ()))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (642)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length ()) > (var_cas_inSemanticAttributsList.reader_length ())).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length ().reader_string ()))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length ().reader_string ()))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (646)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27864 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27878 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27864 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27864) ;
    cPtr_typeGalgas_stringset * operand_27878 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27878) ;
    if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27864 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27864) ;
      cPtr_typeGalgas_uint * operand_27878 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27878) ;
      if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27864 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27864) ;
        cPtr_typeGalgas_sint * operand_27878 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27878) ;
        if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27864 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27864) ;
          cPtr_typeGalgas_char * operand_27878 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27878) ;
          if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27864 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27864) ;
            cPtr_typeGalgas_string * operand_27878 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27878) ;
            if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27864 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27864) ;
              cPtr_typeGalgas_bool * operand_27878 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27878) ;
              if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27864 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27864) ;
                cPtr_typeGalgas_double * operand_27878 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27878) ;
                if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27864 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27864) ;
                  cPtr_typeGalgas_ldouble * operand_27878 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27878) ;
                  if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27864 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27864) ;
                    cPtr_typeGalgas_location * operand_27878 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27878) ;
                    if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27864 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27864) ;
                      cPtr_typeGalgas_lchar * operand_27878 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27878) ;
                      if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27864 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27864) ;
                        cPtr_typeGalgas_luint * operand_27878 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27878) ;
                        if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27864 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27864) ;
                          cPtr_typeGalgas_lsint * operand_27878 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27878) ;
                          if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27864 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27864) ;
                            cPtr_typeGalgas_lstring * operand_27878 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27878) ;
                            if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27864 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27864) ;
                              cPtr_typeGalgas_lbool * operand_27878 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27878) ;
                              if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27864 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27864) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27878 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27878) ;
                                if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                                  if (((operand_27864->mGalgasClassName.reader_value ()) != (operand_27878->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27864->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27878->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (687)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27864 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27864) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27878 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27878) ;
                                  if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                                    if (((operand_27864->mListTypeName.reader_value ()) != (operand_27878->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27864->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27878->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (693)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27864 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27864) ;
                                    cPtr_typeGalgasClassType * operand_27878 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27878) ;
                                    if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                                      if (((operand_27864->mClassTypeName.reader_value ()) == (operand_27878->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! (operand_27878->mAncestorClassesMap.reader_hasKey (operand_27864->mClassTypeName.reader_value ())))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27878->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27878->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (701)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27864 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27864) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27878 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27878) ;
                                      if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                                        if (((operand_27864->mClassTypeName.reader_value ()) != (operand_27878->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27864->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27878->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (707)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27864 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27864) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27878 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27878) ;
                                        if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                                          if (((operand_27864->mMapTypeName.reader_value ()) != (operand_27878->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27864->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27878->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (714)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27864 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27864) ;
                                          cPtr_typeGalgas_enum * operand_27878 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27878) ;
                                          if ((operand_27864 != NULL) && (operand_27878 != NULL)) {
                                            if (((operand_27864->mEnumTypeName.reader_value ()) != (operand_27878->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27864->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27878->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (722)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_targetType.reader_messageGalgasType ()) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (726)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (743)) ;
  }else if (((var_cas_t1.reader_length ()) > (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (745)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_32311 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32396 = var_cas_t2.firstObject () ;
    while ((operand_32311 != NULL)
        && (operand_32396 != NULL)) {
      macroValidPointer (operand_32311) ;
      macroValidPointer (operand_32396) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32311->mType,  operand_32396->mAttributType,  operand_32311->mGalgasVariableName.reader_location () SOURCE_FILE_AT_LINE (749)) ;
      operand_32311 = operand_32311->nextObject () ;
      operand_32396 = operand_32396->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (768)) ;
  }else if (((var_cas_signatureReference.reader_length ()) < (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (770)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_33631 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33760 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33631 != NULL)
        && (operand_33760 != NULL)) {
      macroValidPointer (operand_33631) ;
      macroValidPointer (operand_33760) ;
      if (operand_33631->mFormalArgumentPassingMode.isBuilt () && operand_33760->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33631->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33760->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33631->mType,  operand_33760->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (777)) ;
        }else{
          if ((operand_33631->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33760->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33631->mType,  operand_33760->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (779)) ;
          }else{
            if ((operand_33631->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33760->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33631->mType,  operand_33760->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (781)) ;
            }else{
              if ((operand_33631->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33760->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33760->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33760->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33631->mType,  operand_33760->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (786)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33760->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33631->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (790)) ;
              }
            }
          }
        }
      }
      operand_33631 = operand_33631->nextObject () ;
      operand_33760 = operand_33760->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_35017 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35085 = var_cas_expressionList.firstObject () ;
    while ((operand_35017 != NULL)
        && (operand_35085 != NULL)) {
      macroValidPointer (operand_35017) ;
      macroValidPointer (operand_35085) ;
      if (operand_35085->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35085->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35170 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35085->mExpression.getPtr ()) ;
          macroValidPointer (operand_35170) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35170->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35017->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35085->mExpression) ;
        }
      }
      operand_35017 = operand_35017->nextObject () ;
      operand_35085 = operand_35085->nextObject () ;
    }
  }
}
...
methode_verifierType (C_Lexique & lexique_var_,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (841)) ;
...
void routine_enterBuiltinTypes (C_Lexique & lexique_var_,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1190)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1195)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1200)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1205)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1210)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1215)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1220)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1225)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1230)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1235)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1240)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1245)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1250)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1255)) ;
}
