...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_27736 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_27825 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_27736 != NULL)
      && (operand_27825 != NULL)) {
    macroValidPointer (operand_27736) ;
    macroValidPointer (operand_27825) ;
    if (((operand_27736->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_27825->mAttributType.isBuilt ()) {
        operand_27825->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_27736->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_27825->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        insertUsedConstInArgument_typeVariablesMap (lexique_var_,
                                        var_cas_ioVariablesMap,
                                        operand_27736->mName,
                                        operand_27825->mAttributType,
                                        var_cas_cppName,
                                        NULL) ;
      }else{
          operand_27736->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_27736->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_27736 = operand_27736->nextObject () ;
    operand_27825 = operand_27825->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_29852 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_29866 = var_cas_sourceType () ;
    cPtr_typeGalgas_uint * operand_29852 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29852) ;
    cPtr_typeGalgas_uint * operand_29866 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_29866) ;
    if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_29852 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29852) ;
      cPtr_typeGalgas_sint * operand_29866 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_29866) ;
      if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_29852 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29852) ;
        cPtr_typeGalgas_char * operand_29866 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_29866) ;
        if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_29852 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29852) ;
          cPtr_typeGalgas_string * operand_29866 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_29866) ;
          if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_29852 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29852) ;
            cPtr_typeGalgas_bool * operand_29866 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_29866) ;
            if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_29852 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_29852) ;
              cPtr_typeGalgas_double * operand_29866 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_29866) ;
              if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
              }else{
                cPtr_typeGalgas_ldouble * operand_29852 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_29852) ;
                cPtr_typeGalgas_ldouble * operand_29866 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_29866) ;
                if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                }else{
                  cPtr_typeGalgas_location * operand_29852 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29852) ;
                  cPtr_typeGalgas_location * operand_29866 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_29866) ;
                  if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_29852 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29852) ;
                    cPtr_typeGalgas_lchar * operand_29866 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_29866) ;
                    if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_29852 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29852) ;
                      cPtr_typeGalgas_luint * operand_29866 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_29866) ;
                      if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_29852 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29852) ;
                        cPtr_typeGalgas_lsint * operand_29866 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_29866) ;
                        if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_29852 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29852) ;
                          cPtr_typeGalgas_lstring * operand_29866 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_29866) ;
                          if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lbool * operand_29852 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29852) ;
                            cPtr_typeGalgas_lbool * operand_29866 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_29866) ;
                            if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedExternType * operand_29852 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29852) ;
                              cPtr_typeGalgasUndefinedExternType * operand_29866 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_29866) ;
                              if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                                if (((operand_29852->mGalgasClassName.reader_value ()) != (operand_29866->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_29852->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_29866->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_29852 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29852) ;
                                cPtr_typeGalgasUndefinedListType * operand_29866 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_29866) ;
                                if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                                  if (((operand_29852->mListTypeName.reader_value ()) != (operand_29866->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29852->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_29866->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasClassType * operand_29852 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29852) ;
                                  cPtr_typeGalgasClassType * operand_29866 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_29866) ;
                                  if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                                    if (((operand_29852->mClassTypeName.reader_value ()) == (operand_29866->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    }else if (((! operand_29866->mAncestorClassesMap.reader_hasKey (operand_29852->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_29866->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_29866->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_29852 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29852) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_29866 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_29866) ;
                                    if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                                      if (((operand_29852->mClassTypeName.reader_value ()) != (operand_29866->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29852->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_29866->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedMapType * operand_29852 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29852) ;
                                      cPtr_typeGalgasUndefinedMapType * operand_29866 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_29866) ;
                                      if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                                        if (((operand_29852->mMapTypeName.reader_value ()) != (operand_29866->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_29852->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_29866->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_29852 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29852) ;
                                        cPtr_typeGalgas_enum * operand_29866 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_29866) ;
                                        if ((operand_29852 != NULL) && (operand_29866 != NULL)) {
                                          if (((operand_29852->mEnumTypeName.reader_value ()) != (operand_29866->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_29852->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_29866->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_34237 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34322 = var_cas_t2.firstObject () ;
    while ((operand_34237 != NULL)
        && (operand_34322 != NULL)) {
      macroValidPointer (operand_34237) ;
      macroValidPointer (operand_34322) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34237->mType,  operand_34322->mAttributType,  operand_34237->mGalgasVariableName.reader_location ()) ;
      operand_34237 = operand_34237->nextObject () ;
      operand_34322 = operand_34322->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_35555 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_35684 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35555 != NULL)
        && (operand_35684 != NULL)) {
      macroValidPointer (operand_35555) ;
      macroValidPointer (operand_35684) ;
      if (operand_35555->mFormalArgumentPassingMode.isBuilt () && operand_35684->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_35555->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_35684->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35555->mType,  operand_35684->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_35555->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_35684->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35555->mType,  operand_35684->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_35555->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_35684->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35555->mType,  operand_35684->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_35555->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_35684->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_35684->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_35684->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_35555->mType,  operand_35684->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_35684->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_35555->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_35555 = operand_35555->nextObject () ;
      operand_35684 = operand_35684->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_36941 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37009 = var_cas_expressionList.firstObject () ;
    while ((operand_36941 != NULL)
        && (operand_37009 != NULL)) {
      macroValidPointer (operand_36941) ;
      macroValidPointer (operand_37009) ;
      if (operand_37009->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_37009->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_37094 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37009->mExpression.getPtr ()) ;
          macroValidPointer (operand_37094) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_37094->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_36941->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_37009->mExpression) ;
        }
      }
      operand_36941 = operand_36941->nextObject () ;
      operand_37009 = operand_37009->nextObject () ;
    }
  }
}
