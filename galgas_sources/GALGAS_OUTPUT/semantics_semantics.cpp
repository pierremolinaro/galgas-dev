...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25834 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25923 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25834 != NULL)
      && (operand_25923 != NULL)) {
    macroValidPointer (operand_25834) ;
    macroValidPointer (operand_25923) ;
    if (((operand_25834->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25923->mAttributType.isBuilt ()) {
        operand_25923->mAttributType (HERE)->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25834->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25923->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_25834->mName, operand_25923->mAttributType, var_cas_cppName) ;
      }else{
          operand_25834->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25834->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25834 = operand_25834->nextObject () ;
    operand_25923 = operand_25923->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27946 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_27960 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_27946 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27946) ;
    cPtr_typeGalgas_stringset * operand_27960 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27960) ;
    if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27946 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27946) ;
      cPtr_typeGalgas_uint * operand_27960 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27960) ;
      if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27946 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27946) ;
        cPtr_typeGalgas_sint * operand_27960 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27960) ;
        if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27946 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27946) ;
          cPtr_typeGalgas_char * operand_27960 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27960) ;
          if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27946 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27946) ;
            cPtr_typeGalgas_string * operand_27960 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27960) ;
            if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27946 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27946) ;
              cPtr_typeGalgas_bool * operand_27960 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27960) ;
              if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27946 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27946) ;
                cPtr_typeGalgas_double * operand_27960 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27960) ;
                if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27946 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27946) ;
                  cPtr_typeGalgas_ldouble * operand_27960 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27960) ;
                  if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27946 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27946) ;
                    cPtr_typeGalgas_location * operand_27960 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27960) ;
                    if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27946 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27946) ;
                      cPtr_typeGalgas_lchar * operand_27960 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27960) ;
                      if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27946 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27946) ;
                        cPtr_typeGalgas_luint * operand_27960 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27960) ;
                        if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27946 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27946) ;
                          cPtr_typeGalgas_lsint * operand_27960 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27960) ;
                          if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27946 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27946) ;
                            cPtr_typeGalgas_lstring * operand_27960 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27960) ;
                            if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27946 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27946) ;
                              cPtr_typeGalgas_lbool * operand_27960 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27960) ;
                              if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27946 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27946) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27960 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27960) ;
                                if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                                  if (((operand_27946->mGalgasClassName.reader_value ()) != (operand_27960->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27946->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27960->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27946 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27946) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27960 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27960) ;
                                  if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                                    if (((operand_27946->mListTypeName.reader_value ()) != (operand_27960->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27946->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27960->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27946 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27946) ;
                                    cPtr_typeGalgasClassType * operand_27960 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27960) ;
                                    if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                                      if (((operand_27946->mClassTypeName.reader_value ()) == (operand_27960->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27960->mAncestorClassesMap.reader_hasKey (operand_27946->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27960->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27960->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27946 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27946) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27960 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27960) ;
                                      if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                                        if (((operand_27946->mClassTypeName.reader_value ()) != (operand_27960->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27946->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27960->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27946 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27946) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27960 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27960) ;
                                        if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                                          if (((operand_27946->mMapTypeName.reader_value ()) != (operand_27960->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27946->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27960->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27946 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27946) ;
                                          cPtr_typeGalgas_enum * operand_27960 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27960) ;
                                          if ((operand_27946 != NULL) && (operand_27960 != NULL)) {
                                            if (((operand_27946->mEnumTypeName.reader_value ()) != (operand_27960->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27946->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27960->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32393 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32478 = var_cas_t2.firstObject () ;
    while ((operand_32393 != NULL)
        && (operand_32478 != NULL)) {
      macroValidPointer (operand_32393) ;
      macroValidPointer (operand_32478) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32393->mType,  operand_32478->mAttributType,  operand_32393->mGalgasVariableName.reader_location ()) ;
      operand_32393 = operand_32393->nextObject () ;
      operand_32478 = operand_32478->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_33711 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33840 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33711 != NULL)
        && (operand_33840 != NULL)) {
      macroValidPointer (operand_33711) ;
      macroValidPointer (operand_33840) ;
      if (operand_33711->mFormalArgumentPassingMode.isBuilt () && operand_33840->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33711->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33840->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33711->mType,  operand_33840->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33711->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33840->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33711->mType,  operand_33840->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33711->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33840->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33711->mType,  operand_33840->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33711->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33840->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33840->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33840->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33711->mType,  operand_33840->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33840->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33711->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33711 = operand_33711->nextObject () ;
      operand_33840 = operand_33840->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_35097 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35165 = var_cas_expressionList.firstObject () ;
    while ((operand_35097 != NULL)
        && (operand_35165 != NULL)) {
      macroValidPointer (operand_35097) ;
      macroValidPointer (operand_35165) ;
      if (operand_35165->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35165->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35250 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35165->mExpression.getPtr ()) ;
          macroValidPointer (operand_35250) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35250->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_35097->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35165->mExpression) ;
        }
      }
      operand_35097 = operand_35097->nextObject () ;
      operand_35165 = operand_35165->nextObject () ;
    }
  }
}
