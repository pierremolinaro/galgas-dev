...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "->" ;
  ioString << mInfo.mMessage.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
GGS_L_switchBranchlist::cRootList::cRootList (void):
mFirstItem (NULL),
mLastItem (NULL),
mListLength (0),
mCountReference (1) {
...
GGS_L_switchBranchlist::GGS_L_switchBranchlist (void) { // Default Constructor
  _mRoot = NULL ;
}

//---------------------------------------------------------------------------*

GGS_L_switchBranchlist::~GGS_L_switchBranchlist (void) {
  _drop_operation () ;
}
...
GGS_L_switchBranchlist (const GGS_L_switchBranchlist & inSource) {
  _mRoot = inSource._mRoot ;
  if (_mRoot != NULL) {
    macroValidPointer (_mRoot) ;
    _mRoot->mCountReference ++ ;
...
GGS_L_switchBranchlist::element_type * GGS_L_switchBranchlist::
firstObject (void) const {
  return (_mRoot == NULL) ? NULL : _mRoot->mFirstItem ;
}
...
void GGS_L_switchBranchlist::
_internalAppendItem (const GGS_stringset & argument_0,
                    const GGS_typeInstructionList & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mConstantSet,
                                p->mInstructionList) ;
        p = p->mNextItem ;
      }
    }
...
GGS_uint GGS_L_switchBranchlist::
reader_length (C_Lexique & /* inLexique */
               COMMA_UNUSED_LOCATION_ARGS) const {
  return GGS_uint (_mRoot != NULL,
                   (_mRoot == NULL) ? 0 : (uint32) _mRoot->mListLength) ;
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.aNomCppAttribut.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_31441 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_31352 != NULL)
      && (operand_31441 != NULL)) {
    macroValidPointer (operand_31352) ;
    macroValidPointer (operand_31441) ;
    if (((operand_31352->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (769))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      if (operand_31441->mAttributType._isBuilt ()) {
        operand_31441->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (771)) ;
      }
      if (((operand_31352->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (772))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_31441->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_31352->mName, operand_31441->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (779)) ;
      }else{
    ...
    operand_31441 = operand_31441->nextObject () ;
  }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (811))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (811)))).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_33751 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_33836 = var_cas_t2.firstObject () ;
    while ((operand_33751 != NULL)
        && (operand_33836 != NULL)) {
      macroValidPointer (operand_33751) ;
      macroValidPointer (operand_33836) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_33751->mType,  operand_33836->mAttributType,  operand_33751->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (821)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (819)) ;
      operand_33751 = operand_33751->nextObject () ;
      operand_33836 = operand_33836->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (841))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (841)))).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_35113 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_35242 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35113 != NULL)
        && (operand_35242 != NULL)) {
      macroValidPointer (operand_35113) ;
      macroValidPointer (operand_35242) ;
      if (operand_35113->mFormalArgumentPassingMode._isBuilt () && operand_35242->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_35113->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_35242->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35113->mType,  operand_35242->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (851)) ;
        }else{
          if ((operand_35113->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_35242->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35113->mType,  operand_35242->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (853)) ;
          }else{
            if ((operand_35113->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_35242->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35113->mType,  operand_35242->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (855)) ;
            }else{
              if ((operand_35113->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_35242->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_35242->mType._isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_35242->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35113->mType,  operand_35242->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (860)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_35242->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (863))) + (GGS_string (true, " is not compatible with ")))) + (operand_35113->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (864)))) SOURCE_FILE_AT_LINE (865)) ;
              }
            }
          }
        }
      ...
      operand_35242 = operand_35242->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_36513 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_36581 = var_cas_expressionList.firstObject () ;
    while ((operand_36513 != NULL)
        && (operand_36581 != NULL)) {
      macroValidPointer (operand_36513) ;
      macroValidPointer (operand_36581) ;
      if (operand_36581->mExpression._isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_36581->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_36666 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_36581->mExpression.getPtr ()) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_36513->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_36581->mExpression) ;
        }
      }
      operand_36513 = operand_36513->nextObject () ;
      operand_36581 = operand_36581->nextObject () ;
    }
  }
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mAltParametersMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1282)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1285)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1288)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1291)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1294)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1297)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1300)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1303)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1306)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1309)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1312)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1315)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1318)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1321)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1324)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1327)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1330)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1333)) ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mMessageString.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mRepresentativeEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mSuperEntitySet.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << mInfo.mSignatureLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mMapTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mPassIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "->@callInstruction:"
           ...
           << mPropertyKind.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mPropertyTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1434)) ;
  GGS_stringset::element_type * operand_60128 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60128 != NULL)) {
    macroValidPointer (operand_60128) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60128->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1437)) ;
    operand_60128 = operand_60128->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1438)) ;
  GGS_stringset::element_type * operand_60425 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_60425 != NULL)) {
    macroValidPointer (operand_60425) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60425->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1441)) ;
    operand_60425 = operand_60425->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1450)) ;
  GGS_stringset::element_type * operand_60961 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60961 != NULL)) {
    macroValidPointer (operand_60961) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60961->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1453)) ;
    operand_60961 = operand_60961->nextObject () ;
  }
}
