...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1448)) ;
   ;
  GGS_stringset::element_type * operand_61910 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61910 != NULL)) {
    macroValidPointer (operand_61910) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61910->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1450)) ;
    operand_61910 = operand_61910->nextObject () ;
  }
  ...
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1452)) ;
   ;
  GGS_stringset::element_type * operand_62207 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_62207 != NULL)) {
    macroValidPointer (operand_62207) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62207->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1454)) ;
    operand_62207 = operand_62207->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1464)) ;
   ;
  GGS_stringset::element_type * operand_62743 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62743 != NULL)) {
    macroValidPointer (operand_62743) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62743->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1466)) ;
    operand_62743 = operand_62743->nextObject () ;
  }
}
