...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_60818 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60818 != NULL)) {
    macroValidPointer (operand_60818) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60818->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1449)) ;
    operand_60818 = operand_60818->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_61113 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61113 != NULL)) {
    macroValidPointer (operand_61113) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61113->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1453)) ;
    operand_61113 = operand_61113->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61647 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61647 != NULL)) {
    macroValidPointer (operand_61647) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61647->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1465)) ;
    operand_61647 = operand_61647->nextObject () ;
  }
}
