...
void GGS_typeCplusPlusNameList::
_internalAppendItem (const GGS_typeCplusPlusName & argument_0) {
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mCppName) ;
        p = p->mNextItem ;
      }
    }
  }
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->aNomVariableCible,
...
void GGS_typeListeCibles::
_internalAppendItem (const GGS_typeCible & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
void GGS_typeInstructionList::
_internalAppendItem (const GGS_typeInstruction & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
void GGS_typeExpressionList::
_internalAppendItem (const GGS_typeExpression & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mExpression) ;
        p = p->mNextItem ;
      }
    }
  }
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mVarToDrop) ;
        p = p->mNextItem ;
      }
    }
  }
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "->@typeLiteralDoubleExpression:"
           << mLiteralDouble.reader_description  (_inLexique COMMA_THERE) ;
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mIFexpression,
                                p->mInstructionList) ;
        p = p->mNextItem ;
      }
    }
...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_30623 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_30712 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_30623 != NULL)
      && (operand_30712 != NULL)) {
    macroValidPointer (operand_30623) ;
    macroValidPointer (operand_30712) ;
    if (((operand_30623->mName.reader_string (_inLexique SOURCE_FILE_AT_LINE (750))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_30712->mAttributType._isBuilt ()) {
        operand_30712->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (752)) ;
      }
      if (((operand_30623->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (753))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_30712->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_30623->mName, operand_30712->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (760)) ;
      }else{
        operand_30623->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_30623->mType.reader_string (_inLexique SOURCE_FILE_AT_LINE (762))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (764)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_30623 = operand_30623->nextObject () ;
    operand_30712 = operand_30712->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (769))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (769)))) & ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (771)).reader_string (_inLexique SOURCE_FILE_AT_LINE (771))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (772)).reader_string (_inLexique SOURCE_FILE_AT_LINE (772))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (773)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (773))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (773)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (775)).reader_string (_inLexique SOURCE_FILE_AT_LINE (775))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (776)).reader_string (_inLexique SOURCE_FILE_AT_LINE (776))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (777)) ;
  }
}
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (792))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (792)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (794)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (794))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (794)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (796)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_33022 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_33107 = var_cas_t2.firstObject () ;
    while ((operand_33022 != NULL)
        && (operand_33107 != NULL)) {
      macroValidPointer (operand_33022) ;
      macroValidPointer (operand_33107) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_33022->mType,  operand_33107->mAttributType,  operand_33022->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (802)),  GGS_bool (true, false) SOURCE_FILE_AT_LINE (800)) ;
      operand_33022 = operand_33022->nextObject () ;
      operand_33107 = operand_33107->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (822))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (822)))).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_34384 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_34513 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_34384 != NULL)
        && (operand_34513 != NULL)) {
      macroValidPointer (operand_34384) ;
      macroValidPointer (operand_34513) ;
      if (operand_34384->mFormalArgumentPassingMode._isBuilt () && operand_34513->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_34384->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_34513->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_34384->mType,  operand_34513->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (832)) ;
        }else{
          if ((operand_34384->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_34513->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_34384->mType,  operand_34513->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (834)) ;
          }else{
            if ((operand_34384->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_34513->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_34384->mType,  operand_34513->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (836)) ;
            }else{
              if ((operand_34384->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_34513->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_34513->mType._isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_34513->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_34384->mType,  operand_34513->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (841)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_34513->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (844))) + (GGS_string (true, " is not compatible with ")))) + (operand_34384->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (845)))) SOURCE_FILE_AT_LINE (846)) ;
              }
            }
          }
        }
      }
      operand_34384 = operand_34384->nextObject () ;
      operand_34513 = operand_34513->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_35784 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35852 = var_cas_expressionList.firstObject () ;
    while ((operand_35784 != NULL)
        && (operand_35852 != NULL)) {
      macroValidPointer (operand_35784) ;
      macroValidPointer (operand_35852) ;
      if (operand_35852->mExpression._isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35852->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35937 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35852->mExpression.getPtr ()) ;
          macroValidPointer (operand_35937) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_35937->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_35784->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_35852->mExpression) ;
        }
      }
      operand_35784 = operand_35784->nextObject () ;
      operand_35852 = operand_35852->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  aPositionVariableCible,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (900)) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mCase1_name,
                                p->mCase2_name,
                                p->mInstructionList) ;
        p = p->mNextItem ;
      }
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mCppEnumeratedVariableName,
                                p->mLocationOffset,
                                p->mCppTypeName) ;
        p = p->mNextItem ;
      }
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mClassName,
                                p->mResultVarID,
                                p->mInstructionList,
                                p->mNoUsedParameter) ;
        p = p->mNextItem ;
...
void GGS_typeEntitiesToGenerateList::
_internalAppendItem (const GGS_typeEntityToGenerate & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mEntityToGenerate) ;
        p = p->mNextItem ;
      }
    }
  }
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1263)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1266)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1269)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1272)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1275)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1278)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1281)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1284)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1287)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1290)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1293)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1296)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1299)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1302)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1305)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1308)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1311)) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1314)) ;
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mSharedPropertyTypeName,
...
appendForMapDescription (C_Lexique & _inLexique, C_String & ioString COMMA_LOCATION_ARGS) const {
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE) ;
  ioString << "->" ;
  ioString << mInfo.mRepresentativeEntityName.reader_description  (_inLexique COMMA_THERE) ;
  ioString << mInfo.mSuperEntitySet.reader_description  (_inLexique COMMA_THERE) ;
  ioString << "]" ;
}
...
GGS_string GGS_representativeEntityMap::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
mPropertyKind (argument_1),
mPropertyTypeName (argument_2),
mParameterList (argument_3) {
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1422)) ;
  GGS_stringset::element_type * operand_59573 = var_cas_missingDefinition.firstObject () ;
  while ((operand_59573 != NULL)) {
    macroValidPointer (operand_59573) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59573->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1425)) ;
    operand_59573 = operand_59573->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1426)) ;
  GGS_stringset::element_type * operand_59870 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_59870 != NULL)) {
    macroValidPointer (operand_59870) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59870->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1429)) ;
    operand_59870 = operand_59870->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1438)) ;
  GGS_stringset::element_type * operand_60406 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60406 != NULL)) {
    macroValidPointer (operand_60406) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60406->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1441)) ;
    operand_60406 = operand_60406->nextObject () ;
  }
}
