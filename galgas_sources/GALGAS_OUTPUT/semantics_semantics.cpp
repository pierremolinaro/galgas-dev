...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_28511 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_28600 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_28511 != NULL)
      && (operand_28600 != NULL)) {
    macroValidPointer (operand_28511) ;
    macroValidPointer (operand_28600) ;
    if (((operand_28511->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (680))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_28600->mAttributType.isBuilt ()) {
        operand_28600->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (682)) ;
      }
      if (((operand_28511->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (683))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_28600->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_28511->mName, operand_28600->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (690)) ;
      }else{
          operand_28511->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_28511->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (692))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (693)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_28511 = operand_28511->nextObject () ;
    operand_28600 = operand_28600->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (699))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (699)))) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (701)).reader_string (_inLexique SOURCE_FILE_AT_LINE (701))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (702)).reader_string (_inLexique SOURCE_FILE_AT_LINE (702))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (702)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (703))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (703)))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (705)).reader_string (_inLexique SOURCE_FILE_AT_LINE (705))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (706)).reader_string (_inLexique SOURCE_FILE_AT_LINE (706))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (706)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_30629 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_30643 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_30629 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30629) ;
    cPtr_typeGalgas_stringset * operand_30643 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30643) ;
    if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_30629 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30629) ;
      cPtr_typeGalgas_uint * operand_30643 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30643) ;
      if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_30629 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30629) ;
        cPtr_typeGalgas_sint * operand_30643 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30643) ;
        if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_30629 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30629) ;
          cPtr_typeGalgas_char * operand_30643 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30643) ;
          if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_30629 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30629) ;
            cPtr_typeGalgas_string * operand_30643 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30643) ;
            if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_30629 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30629) ;
              cPtr_typeGalgas_bool * operand_30643 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30643) ;
              if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_30629 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30629) ;
                cPtr_typeGalgas_double * operand_30643 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30643) ;
                if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_30629 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30629) ;
                  cPtr_typeGalgas_ldouble * operand_30643 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30643) ;
                  if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_30629 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30629) ;
                    cPtr_typeGalgas_location * operand_30643 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30643) ;
                    if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_30629 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30629) ;
                      cPtr_typeGalgas_lchar * operand_30643 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30643) ;
                      if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_30629 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30629) ;
                        cPtr_typeGalgas_luint * operand_30643 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30643) ;
                        if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_30629 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30629) ;
                          cPtr_typeGalgas_lsint * operand_30643 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30643) ;
                          if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_30629 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30629) ;
                            cPtr_typeGalgas_lstring * operand_30643 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30643) ;
                            if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_30629 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30629) ;
                              cPtr_typeGalgas_lbool * operand_30643 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30643) ;
                              if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_30629 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30629) ;
                                cPtr_typeGalgasUndefinedExternType * operand_30643 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30643) ;
                                if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                                  if (((operand_30629->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (745))) != (operand_30643->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (745)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_30629->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (746))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_30643->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (747))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (747)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_30629 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30629) ;
                                  cPtr_typeGalgasUndefinedListType * operand_30643 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30643) ;
                                  if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                                    if (((operand_30629->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (751))) != (operand_30643->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (751)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30629->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (752))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_30643->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (753))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (753)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_30629 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30629) ;
                                    cPtr_typeGalgasClassType * operand_30643 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30643) ;
                                    if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                                      if (((operand_30629->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (758))) == (operand_30643->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (758)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_30643->mAncestorClassesMap.reader_hasKey (_inLexique, operand_30629->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (759)) SOURCE_FILE_AT_LINE (759))))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_30643->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (760))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_30643->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (761))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (761)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_30629 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30629) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_30643 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30643) ;
                                      if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                                        if (((operand_30629->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (765))) != (operand_30643->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (765)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30629->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_30643->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (767)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_30629 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30629) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_30643 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30643) ;
                                        if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                                          if (((operand_30629->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (771))) != (operand_30643->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (771)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30629->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (772))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_30643->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (774)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_30629 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30629) ;
                                          cPtr_typeGalgas_enum * operand_30643 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30643) ;
                                          if ((operand_30629 != NULL) && (operand_30643 != NULL)) {
                                            if (((operand_30629->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779))) != (operand_30643->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779)))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_30629->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (780))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_30643->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (781))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (782)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (785))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (786)))) SOURCE_FILE_AT_LINE (786)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (802))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (802)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (803)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (804))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (804)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (805)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_35076 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35161 = var_cas_t2.firstObject () ;
    while ((operand_35076 != NULL)
        && (operand_35161 != NULL)) {
      macroValidPointer (operand_35076) ;
      macroValidPointer (operand_35161) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35076->mType,  operand_35161->mAttributType,  operand_35076->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (809)) SOURCE_FILE_AT_LINE (809)) ;
      operand_35076 = operand_35076->nextObject () ;
      operand_35161 = operand_35161->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (827))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (827)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (828)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (829))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (829)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (830)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_36395 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_36524 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_36395 != NULL)
        && (operand_36524 != NULL)) {
      macroValidPointer (operand_36395) ;
      macroValidPointer (operand_36524) ;
      if (operand_36395->mFormalArgumentPassingMode.isBuilt () && operand_36524->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_36395->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_36524->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36395->mType,  operand_36524->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (837)) ;
        }else{
          if ((operand_36395->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_36524->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36395->mType,  operand_36524->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (839)) ;
          }else{
            if ((operand_36395->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_36524->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36395->mType,  operand_36524->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (841)) ;
            }else{
              if ((operand_36395->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_36524->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_36524->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_36524->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36395->mType,  operand_36524->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (846)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_36524->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (849))) + (GGS_string (true, " is not compatible with ")))) + (operand_36395->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (850)))) SOURCE_FILE_AT_LINE (850)) ;
              }
            }
          }
        }
      }
      operand_36395 = operand_36395->nextObject () ;
      operand_36524 = operand_36524->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37785 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37853 = var_cas_expressionList.firstObject () ;
    while ((operand_37785 != NULL)
        && (operand_37853 != NULL)) {
      macroValidPointer (operand_37785) ;
      macroValidPointer (operand_37853) ;
      if (operand_37853->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_37853->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_37938 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37853->mExpression.getPtr ()) ;
          macroValidPointer (operand_37938) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_37938->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37785->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_37853->mExpression) ;
        }
      }
      operand_37785 = operand_37785->nextObject () ;
      operand_37853 = operand_37853->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (901)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1253)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1258)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1263)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1268)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1273)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1278)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1283)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1288)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1293)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1298)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1303)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1308)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1313)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1318)) ;
}
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1472)) ;
   ;
  GGS_stringset::element_type * operand_63135 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63135 != NULL)) {
    macroValidPointer (operand_63135) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63135->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1474)) ;
    operand_63135 = operand_63135->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1476)) ;
   ;
  GGS_stringset::element_type * operand_63432 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_63432 != NULL)) {
    macroValidPointer (operand_63432) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63432->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1478)) ;
    operand_63432 = operand_63432->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1488)) ;
   ;
  GGS_stringset::element_type * operand_63968 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63968 != NULL)) {
    macroValidPointer (operand_63968) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63968->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1490)) ;
    operand_63968 = operand_63968->nextObject () ;
  }
}
