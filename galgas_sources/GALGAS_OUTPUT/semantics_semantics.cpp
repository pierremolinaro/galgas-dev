...
//                    february 20th, 2007, at 11h51'17"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1406)) ;
  GGS_stringset::element_type * operand_58357 = var_cas_missingDefinition.firstObject () ;
  while ((operand_58357 != NULL)) {
    macroValidPointer (operand_58357) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_58357->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1409)) ;
    operand_58357 = operand_58357->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet._substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1410)) ;
  GGS_stringset::element_type * operand_58652 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_58652 != NULL)) {
    macroValidPointer (operand_58652) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_58652->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1413)) ;
    operand_58652 = operand_58652->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  #endif
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet._substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1422)) ;
  GGS_stringset::element_type * operand_59186 = var_cas_missingDefinition.firstObject () ;
  while ((operand_59186 != NULL)) {
    macroValidPointer (operand_59186) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_59186->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1425)) ;
