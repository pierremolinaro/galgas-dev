...
void routine_buildMapWithLocalConstants (C_Lexique & lexique_var_,
  ...
  GGS_L_nameWithType::element_type * operand_25683 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_25772 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_25683 != NULL)
      && (operand_25772 != NULL)) {
    macroValidPointer (operand_25683) ;
    macroValidPointer (operand_25772) ;
    if (((operand_25683->mName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_25772->mAttributType.isBuilt ()) {
        operand_25772->mAttributType ()->methode_getTypeName (lexique_var_, var_cas_typeName) ;
      }
      if (((operand_25683->mType.reader_value ()) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle ())) && (var_cas_first))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_25772->aNomAttribut, var_cas_inLocation, var_cas_mapStyle) ;
        }
        if (var_cas_ioVariablesMap.isBuilt ()) {
          var_cas_ioVariablesMap ()->methode_insertUsedConstInArgument (lexique_var_, operand_25683->mName, operand_25772->mAttributType, var_cas_cppName) ;
        }
      }else{
          operand_25683->mType.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I have found the '@")) + (operand_25683->mType.reader_value ()))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type")))) ;
      }
    }
    var_cas_first = GGS_bool (true, false) ;
    operand_25683 = operand_25683->nextObject () ;
    operand_25772 = operand_25772->nextObject () ;
  }
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & lexique_var_,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_27795 = var_cas_targetType () ;
    cPtr_AC_galgasType * ptr_27809 = var_cas_sourceType () ;
    cPtr_typeGalgas_stringset * operand_27795 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27795) ;
    cPtr_typeGalgas_stringset * operand_27809 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_27809) ;
    if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_27795 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27795) ;
      cPtr_typeGalgas_uint * operand_27809 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27809) ;
      if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_27795 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27795) ;
        cPtr_typeGalgas_sint * operand_27809 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27809) ;
        if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_27795 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27795) ;
          cPtr_typeGalgas_char * operand_27809 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_27809) ;
          if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_27795 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27795) ;
            cPtr_typeGalgas_string * operand_27809 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_27809) ;
            if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_27795 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27795) ;
              cPtr_typeGalgas_bool * operand_27809 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_27809) ;
              if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_27795 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27795) ;
                cPtr_typeGalgas_double * operand_27809 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_27809) ;
                if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_27795 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27795) ;
                  cPtr_typeGalgas_ldouble * operand_27809 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_27809) ;
                  if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_27795 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27795) ;
                    cPtr_typeGalgas_location * operand_27809 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_27809) ;
                    if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_27795 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27795) ;
                      cPtr_typeGalgas_lchar * operand_27809 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_27809) ;
                      if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_27795 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27795) ;
                        cPtr_typeGalgas_luint * operand_27809 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_27809) ;
                        if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_27795 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27795) ;
                          cPtr_typeGalgas_lsint * operand_27809 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_27809) ;
                          if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_27795 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27795) ;
                            cPtr_typeGalgas_lstring * operand_27809 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_27809) ;
                            if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_27795 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27795) ;
                              cPtr_typeGalgas_lbool * operand_27809 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_27809) ;
                              if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_27795 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27795) ;
                                cPtr_typeGalgasUndefinedExternType * operand_27809 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_27809) ;
                                if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                                  if (((operand_27795->mGalgasClassName.reader_value ()) != (operand_27809->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_27795->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_27809->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_27795 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27795) ;
                                  cPtr_typeGalgasUndefinedListType * operand_27809 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_27809) ;
                                  if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                                    if (((operand_27795->mListTypeName.reader_value ()) != (operand_27809->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27795->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_27809->mListTypeName.reader_value ()))) + (GGS_string (true, "' list type variable")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_27795 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27795) ;
                                    cPtr_typeGalgasClassType * operand_27809 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_27809) ;
                                    if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                                      if (((operand_27795->mClassTypeName.reader_value ()) == (operand_27809->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      }else if (((! operand_27809->mAncestorClassesMap.reader_hasKey (operand_27795->mClassTypeName.reader_value ()))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "The '")) + (operand_27809->mClassTypeName.reader_value ()))) + (GGS_string (true, "' does not inherit from '")))) + (operand_27809->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_27795 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27795) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_27809 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_27809) ;
                                      if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                                        if (((operand_27795->mClassTypeName.reader_value ()) != (operand_27809->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27795->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_27809->mClassTypeName.reader_value ()))) + (GGS_string (true, "' class type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_27795 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27795) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_27809 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_27809) ;
                                        if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                                          if (((operand_27795->mMapTypeName.reader_value ()) != (operand_27809->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting a '")) + (operand_27795->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_27809->mMapTypeName.reader_value ()))) + (GGS_string (true, "' map type variable")))) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_27795 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27795) ;
                                          cPtr_typeGalgas_enum * operand_27809 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_27809) ;
                                          if ((operand_27795 != NULL) && (operand_27809 != NULL)) {
                                            if (((operand_27795->mEnumTypeName.reader_value ()) != (operand_27809->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_27795->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_27809->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                            }
                                          }else{
...
void routine_verifierCompatibiliteTypes (C_Lexique & lexique_var_,
  ...
  if (((var_cas_t1.reader_length ()) < (var_cas_t2.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeSemanticsTypesList::element_type * operand_32242 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_32327 = var_cas_t2.firstObject () ;
    while ((operand_32242 != NULL)
        && (operand_32327 != NULL)) {
      macroValidPointer (operand_32242) ;
      macroValidPointer (operand_32327) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32242->mType,  operand_32327->mAttributType,  operand_32242->mGalgasVariableName.reader_location ()) ;
      operand_32242 = operand_32242->nextObject () ;
      operand_32327 = operand_32327->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) > (var_cas_inEffectiveArgumentsSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_33560 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_33689 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_33560 != NULL)
        && (operand_33689 != NULL)) {
      macroValidPointer (operand_33560) ;
      macroValidPointer (operand_33689) ;
      if (operand_33560->mFormalArgumentPassingMode.isBuilt () && operand_33689->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_33560->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_33689->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33560->mType,  operand_33689->mType,  var_cas_inErrorLocation) ;
        }else{
          if ((operand_33560->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_33689->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33560->mType,  operand_33689->mType,  var_cas_inErrorLocation) ;
          }else{
            if ((operand_33560->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_33689->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33560->mType,  operand_33689->mType,  var_cas_inErrorLocation) ;
            }else{
              if ((operand_33560->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_33689->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_33689->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_33689->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33560->mType,  operand_33689->mType,  var_cas_inErrorLocation) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_33689->mFormalArgumentPassingMode.reader_actualArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_33560->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
              }
            }
          }
        }
      }
      operand_33560 = operand_33560->nextObject () ;
      operand_33689 = operand_33689->nextObject () ;
    }
    ...
    GGS_L_signature::element_type * operand_34946 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_35014 = var_cas_expressionList.firstObject () ;
    while ((operand_34946 != NULL)
        && (operand_35014 != NULL)) {
      macroValidPointer (operand_34946) ;
      macroValidPointer (operand_35014) ;
      if (operand_35014->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_35014->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_35099 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_35014->mExpression.getPtr ()) ;
          macroValidPointer (operand_35099) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_35099->mLocation) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_34946->mType) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_35014->mExpression) ;
        }
      }
      operand_34946 = operand_34946->nextObject () ;
      operand_35014 = operand_35014->nextObject () ;
    }
  }
}
