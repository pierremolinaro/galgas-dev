...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61411 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61411 != NULL)) {
    macroValidPointer (operand_61411) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61411->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1471)) ;
    operand_61411 = operand_61411->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_61708 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61708 != NULL)) {
    macroValidPointer (operand_61708) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61708->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1475)) ;
    operand_61708 = operand_61708->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_62244 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62244 != NULL)) {
    macroValidPointer (operand_62244) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62244->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1487)) ;
    operand_62244 = operand_62244->nextObject () ;
  }
}
