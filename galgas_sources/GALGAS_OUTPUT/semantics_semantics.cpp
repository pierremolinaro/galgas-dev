...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, GGS_typeGalgas_uint64list::constructor_new (_inLexique COMMA_HERE) COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64list"), GGS_location (_inLexique) COMMA_HERE), var_cas_e SOURCE_FILE_AT_LINE (1347)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61051 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61051 != NULL)) {
    macroValidPointer (operand_61051) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61051->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1452)) ;
    operand_61051 = operand_61051->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_61346 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61346 != NULL)) {
    macroValidPointer (operand_61346) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61346->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1456)) ;
    operand_61346 = operand_61346->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61880 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61880 != NULL)) {
    macroValidPointer (operand_61880) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61880->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1468)) ;
    operand_61880 = operand_61880->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
