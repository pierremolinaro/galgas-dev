...
void routine_performMetamodelInclusion (C_Compiler & _inLexique,
  ...
  #endif
  if (((! (var_cas_ioSuperMetamodels.reader_hasKey (_inLexique, var_cas_inSuperMetamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1482)) SOURCE_FILE_AT_LINE (1482))))).isBuiltAndTrue ()) {
    var_cas_ioSuperMetamodels._addAssign_operation (var_cas_inSuperMetamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1483))) ;
    ...
    if (var_cas_inMetamodelComponentMap._isBuilt ()) {
      var_cas_inMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperMetamodelName, automatic_var_0, var_cas_superMetamodelEntityMap, var_cas_superMetamodelsOfSuperMetamodels SOURCE_FILE_AT_LINE (1486)) ;
    }
    GGS_entityToImplementMap::element_type * operand_61071 = var_cas_superMetamodelEntityMap.firstObject () ;
    while ((operand_61071 != NULL)) {
      macroValidPointer (operand_61071) ;
      if ((var_cas_ioAllEntityMap.reader_hasKey (_inLexique, operand_61071->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1496)) SOURCE_FILE_AT_LINE (1496))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (operand_61071->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1497))))) + (GGS_string (true, "' is already defined in a previously imported metamodel"))) SOURCE_FILE_AT_LINE (1498)) ;
      }else{
        var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_61071->mKey, operand_61071->mInfo.mAllMetamodelPropertyMap, operand_61071->mInfo.mIsAbstract, operand_61071->mInfo.mCurrentMetamodelPropertyMap, operand_61071->mInfo.mSuperEntityName, operand_61071->mInfo.mAncestorClassesMap, operand_61071->mInfo.mPropertyList, operand_61071->mInfo.mMetamodelName, operand_61071->mInfo.mID SOURCE_FILE_AT_LINE (1499)) ;
      }
      operand_61071 = operand_61071->nextObject () ;
    }
    GGS_stringset::element_type * operand_62218 = var_cas_superMetamodelsOfSuperMetamodels.firstObject () ;
    while ((operand_62218 != NULL)) {
      macroValidPointer (operand_62218) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_inMetamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_62218->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_ioSuperMetamodels,  var_cas_ioAllEntityMap SOURCE_FILE_AT_LINE (1513)) ;
      operand_62218 = operand_62218->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
