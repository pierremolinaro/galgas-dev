...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_29523 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_29612 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_29523 != NULL)
      && (operand_29612 != NULL)) {
    macroValidPointer (operand_29523) ;
    macroValidPointer (operand_29612) ;
    if (((operand_29523->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (708))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_29612->mAttributType.isBuilt ()) {
        operand_29612->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (710)) ;
      }
      if (((operand_29523->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (711))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) & (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_29612->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_29523->mName, operand_29612->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (718)) ;
      }else{
        operand_29523->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_29523->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (720))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (722)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_29523 = operand_29523->nextObject () ;
    operand_29612 = operand_29612->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (727))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (727)))) & ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (729)).reader_string (_inLexique SOURCE_FILE_AT_LINE (729))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (730)).reader_string (_inLexique SOURCE_FILE_AT_LINE (730))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (731)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (731))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (731)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (733)).reader_string (_inLexique SOURCE_FILE_AT_LINE (733))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (734)).reader_string (_inLexique SOURCE_FILE_AT_LINE (734))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (735)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_31641 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_31655 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_31641 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_31641) ;
    cPtr_typeGalgas_stringset * operand_31655 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_31655) ;
    if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_31641 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_31641) ;
      cPtr_typeGalgas_uint * operand_31655 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_31655) ;
      if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_31641 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_31641) ;
        cPtr_typeGalgas_sint * operand_31655 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_31655) ;
        if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_31641 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_31641) ;
          cPtr_typeGalgas_char * operand_31655 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_31655) ;
          if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_31641 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_31641) ;
            cPtr_typeGalgas_string * operand_31655 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_31655) ;
            if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_31641 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_31641) ;
              cPtr_typeGalgas_bool * operand_31655 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_31655) ;
              if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_31641 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_31641) ;
                cPtr_typeGalgas_double * operand_31655 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_31655) ;
                if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_31641 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_31641) ;
                  cPtr_typeGalgas_ldouble * operand_31655 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_31655) ;
                  if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_31641 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_31641) ;
                    cPtr_typeGalgas_location * operand_31655 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_31655) ;
                    if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_31641 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_31641) ;
                      cPtr_typeGalgas_lchar * operand_31655 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_31655) ;
                      if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_31641 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_31641) ;
                        cPtr_typeGalgas_luint * operand_31655 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_31655) ;
                        if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_31641 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_31641) ;
                          cPtr_typeGalgas_lsint * operand_31655 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_31655) ;
                          if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_31641 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_31641) ;
                            cPtr_typeGalgas_lstring * operand_31655 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_31655) ;
                            if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_31641 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_31641) ;
                              cPtr_typeGalgas_lbool * operand_31655 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_31655) ;
                              if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_31641 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_31641) ;
                                cPtr_typeGalgasUndefinedExternType * operand_31655 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_31655) ;
                                if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                                  if (((operand_31641->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773))) != (operand_31655->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773)))).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_31641->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (774))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_31655->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (775))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (776)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_31641 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_31641) ;
                                  cPtr_typeGalgasUndefinedListType * operand_31655 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_31655) ;
                                  if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                                    if (((operand_31641->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779))) != (operand_31655->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (779)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31641->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (780))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_31655->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (781))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (782)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_31641 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_31641) ;
                                    cPtr_typeGalgasClassType * operand_31655 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_31655) ;
                                    if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                                      if (((operand_31641->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (786))) == (operand_31655->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (786)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_31655->mAncestorClassesMap.reader_hasKey (_inLexique, operand_31641->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (787)) SOURCE_FILE_AT_LINE (787))))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_31655->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (788))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_31655->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (789))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (790)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_31641 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_31641) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_31655 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_31655) ;
                                      if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                                        if (((operand_31641->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (793))) != (operand_31655->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (793)))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31641->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (794))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_31655->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (795))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (796)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_31641 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_31641) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_31655 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_31655) ;
                                        if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                                          if (((operand_31641->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (799))) != (operand_31655->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (799)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_31641->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (800))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_31655->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (801))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (803)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_31641 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_31641) ;
                                          cPtr_typeGalgas_enum * operand_31655 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_31655) ;
                                          if ((operand_31641 != NULL) && (operand_31655 != NULL)) {
                                            if (((operand_31641->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (807))) != (operand_31655->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (807)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_31641->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (808))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_31655->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (809))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (811)) ;
                                            }
                                          }else{
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (813))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (814)))) SOURCE_FILE_AT_LINE (815)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (830))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (830)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (832)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (832))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (832)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (834)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_36088 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_36173 = var_cas_t2.firstObject () ;
    while ((operand_36088 != NULL)
        && (operand_36173 != NULL)) {
      macroValidPointer (operand_36088) ;
      macroValidPointer (operand_36173) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36088->mType,  operand_36173->mAttributType,  operand_36088->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (837)) SOURCE_FILE_AT_LINE (837)) ;
      operand_36088 = operand_36088->nextObject () ;
      operand_36173 = operand_36173->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (855))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (855)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (857)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (857))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (857)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (859)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_37407 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37536 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_37407 != NULL)
        && (operand_37536 != NULL)) {
      macroValidPointer (operand_37407) ;
      macroValidPointer (operand_37536) ;
      if (operand_37407->mFormalArgumentPassingMode.isBuilt () && operand_37536->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_37407->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37536->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37407->mType,  operand_37536->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (865)) ;
        }else{
          if ((operand_37407->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37536->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37407->mType,  operand_37536->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (867)) ;
          }else{
            if ((operand_37407->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37536->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37407->mType,  operand_37536->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (869)) ;
            }else{
              if ((operand_37407->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37536->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37536->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37536->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_37407->mType,  operand_37536->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (874)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_37536->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (877))) + (GGS_string (true, " is not compatible with ")))) + (operand_37407->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (878)))) SOURCE_FILE_AT_LINE (879)) ;
              }
            }
          }
        }
      }
      operand_37407 = operand_37407->nextObject () ;
      operand_37536 = operand_37536->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38797 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38865 = var_cas_expressionList.firstObject () ;
    while ((operand_38797 != NULL)
        && (operand_38865 != NULL)) {
      macroValidPointer (operand_38797) ;
      macroValidPointer (operand_38865) ;
      if (operand_38865->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_38865->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_38950 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38865->mExpression.getPtr ()) ;
          macroValidPointer (operand_38950) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_38950->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38797->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_38865->mExpression) ;
        }
      }
      operand_38797 = operand_38797->nextObject () ;
      operand_38865 = operand_38865->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (929)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1281)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1286)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1291)) ;
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1500)) ;
  GGS_stringset::element_type * operand_64147 = var_cas_missingDefinition.firstObject () ;
  while ((operand_64147 != NULL)) {
    macroValidPointer (operand_64147) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64147->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1503)) ;
    operand_64147 = operand_64147->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1504)) ;
  GGS_stringset::element_type * operand_64444 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_64444 != NULL)) {
    macroValidPointer (operand_64444) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64444->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1507)) ;
    operand_64444 = operand_64444->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1516)) ;
  GGS_stringset::element_type * operand_64980 = var_cas_missingDefinition.firstObject () ;
  while ((operand_64980 != NULL)) {
    macroValidPointer (operand_64980) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_64980->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1519)) ;
    operand_64980 = operand_64980->nextObject () ;
  }
}
