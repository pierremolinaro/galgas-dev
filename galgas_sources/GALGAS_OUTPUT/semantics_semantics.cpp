...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "semantics_semantics.ggs", line
...
_operator_isEqual (const GGS_typeCplusPlusNameList & inOperand) const {
...
GGS_bool GGS_typeCplusPlusNameList::
_operator_isNotEqual (const GGS_typeCplusPlusNameList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeSemanticsTypesList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeSemanticsTypesList::
_operator_isNotEqual (const GGS_typeSemanticsTypesList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_assignedVariables & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_assignedVariables::
_operator_isNotEqual (const GGS_L_assignedVariables & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeListeCibles & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeListeCibles::
_operator_isNotEqual (const GGS_typeListeCibles & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeListeTypesEtNomsArgMethode & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeListeTypesEtNomsArgMethode::
_operator_isNotEqual (const GGS_typeListeTypesEtNomsArgMethode & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeInstructionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeInstructionList::
_operator_isNotEqual (const GGS_typeInstructionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_nameWithType & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_nameWithType::
_operator_isNotEqual (const GGS_L_nameWithType & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeExpressionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeExpressionList::
_operator_isNotEqual (const GGS_typeExpressionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_varToDropList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_varToDropList::
_operator_isNotEqual (const GGS_varToDropList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_expression_instructionsList_list & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_expression_instructionsList_list::
_operator_isNotEqual (const GGS_L_expression_instructionsList_list & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_switchBranchlist & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_switchBranchlist::
_operator_isNotEqual (const GGS_L_switchBranchlist & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
void routine_buildMapWithLocalConstants (C_Compiler & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_33458 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_33543 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_33458 != NULL)
      && (operand_33543 != NULL)) {
    macroValidPointer (operand_33458) ;
    macroValidPointer (operand_33543) ;
    if (((operand_33458->mName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (820)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_33543->mAttributType._isBuilt ()) {
        operand_33543->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (822)) ;
      }
      if (((operand_33458->mType.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (823)))._operator_isEqual (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if ((((var_cas_inLocalConstantStyle)._operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE)))._operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, var_cas_inLocation, operand_33543->aNomAttribut.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (828)), var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_33458->mName, operand_33543->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (830)) ;
      }else{
        operand_33458->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I have found the '@"))._operator_concat (operand_33458->mType.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (832))))._operator_concat (GGS_string (true, "' type, I was expected the '@")))._operator_concat (var_cas_typeName))._operator_concat (GGS_string (true, "' type")) COMMA_SOURCE_FILE_AT_LINE (834)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_33458 = operand_33458->nextObject () ;
    operand_33543 = operand_33543->nextObject () ;
  }
  if ((((var_cas_inLocalDeclarationsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (839)))._operator_strictInf (var_cas_inSemanticAttributsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (839))))._operator_and ((var_cas_inEllipsisFound)._operator_not ())).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "one or more parameters missing: found "))._operator_concat (var_cas_inLocalDeclarationsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (841)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (841))))._operator_concat (GGS_string (true, " effective parameters, while ")))._operator_concat (var_cas_inSemanticAttributsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (842)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (842))))._operator_concat (GGS_string (true, " are needed")) COMMA_SOURCE_FILE_AT_LINE (843)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (843)))._operator_strictSup (var_cas_inSemanticAttributsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (843)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much parameters: found "))._operator_concat (var_cas_inLocalDeclarationsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (845)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (845))))._operator_concat (GGS_string (true, " effective parameters, while ")))._operator_concat (var_cas_inSemanticAttributsList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (846)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (846))))._operator_concat (GGS_string (true, " are needed")) COMMA_SOURCE_FILE_AT_LINE (847)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteTypes (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_t1.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (862)))._operator_strictInf (var_cas_t2.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (862)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") COMMA_SOURCE_FILE_AT_LINE (864)) ;
  }else if (((var_cas_t1.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (864)))._operator_strictSup (var_cas_t2.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (864)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") COMMA_SOURCE_FILE_AT_LINE (866)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_35858 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35939 = var_cas_t2.firstObject () ;
    while ((operand_35858 != NULL)
        && (operand_35939 != NULL)) {
      macroValidPointer (operand_35858) ;
      macroValidPointer (operand_35939) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35858->mType,  operand_35939->mAttributType,  operand_35858->mGalgasVariableName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (872)),  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (869)) ;
      operand_35858 = operand_35858->nextObject () ;
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_signatureReference.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)))._operator_strictSup (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") COMMA_SOURCE_FILE_AT_LINE (894)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (894)))._operator_strictInf (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (894)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") COMMA_SOURCE_FILE_AT_LINE (896)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_37212 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_37337 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_37212 != NULL)
        && (operand_37337 != NULL)) {
      macroValidPointer (operand_37212) ;
      macroValidPointer (operand_37337) ;
      if (operand_37212->mFormalArgumentPassingMode._isBuilt () && operand_37337->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_37212->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37337->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37212->mType,  operand_37337->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (902)) ;
        }else{
          if ((operand_37212->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37337->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37212->mType,  operand_37337->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (904)) ;
          }else{
            if ((operand_37212->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37337->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37212->mType,  operand_37337->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (906)) ;
            }else{
              if ((operand_37212->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37337->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37337->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_38011 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37337->mType.getPtr ()) ;
                  if (operand_38011 != NULL) {
                    macroValidPointer (operand_38011) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37212->mType,  operand_37337->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (911)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((operand_37337->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (914)))._operator_concat (GGS_string (true, " is not compatible with ")))._operator_concat (operand_37212->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (915))) COMMA_SOURCE_FILE_AT_LINE (916)) ;
              }
            }
          }
        }
      }
      operand_37212 = operand_37212->nextObject () ;
      operand_37337 = operand_37337->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_38604 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_38668 = var_cas_expressionList.firstObject () ;
    while ((operand_38604 != NULL)
        && (operand_38668 != NULL)) {
      macroValidPointer (operand_38604) ;
      macroValidPointer (operand_38668) ;
      if (operand_38668->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_38751 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38668->mExpression.getPtr ()) ;
        if (operand_38751 != NULL) {
          macroValidPointer (operand_38751) ; 
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38604->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_38668->mExpression) ;
        }
      }
      operand_38604 = operand_38604->nextObject () ;
      operand_38668 = operand_38668->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
method_verifierType (C_Compiler & _inLexique,
  ...
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  aPositionVariableCible,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (968)) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = mSourceFileCppName._operator_isEqual (_p->mSourceFileCppName).boolValue ()
...
reader_mSourceFileCppName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeCplusPlusName   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_C_grammarInstruction *> (mPointer) != NULL,
...
_operator_isEqual (const GGS_L_matchInstructionCasesList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_matchInstructionCasesList::
_operator_isNotEqual (const GGS_L_matchInstructionCasesList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mCppEnumeratedVariableName._operator_isEqual (_p->mCppEnumeratedVariableName).boolValue ()
...
_operator_isEqual (const GGS_foreachEnumerationList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_foreachEnumerationList::
_operator_isNotEqual (const GGS_foreachEnumerationList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
internalSubListWithRange (GGS_foreachEnumerationList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mCppEnumeratedVariableName, _p->mLocationOffset, _p->mCppTypeName) ;
      _p = _p->nextObject () ;
    }
  }
}
...
_operator_isEqual (const GGS_typeStructuredExtractCasesList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeStructuredExtractCasesList::
_operator_isNotEqual (const GGS_typeStructuredExtractCasesList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mGalgasName._operator_isEqual (_p->mGalgasName).boolValue ()
         ...
         && mIncludePath._operator_isEqual (_p->mIncludePath).boolValue () ;
  }
  return equal ;
}
...
GGS_lstring  GGS_typeExternTypeToGenerate::
reader_mIncludePath (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeExternTypeToGenerate *> (mPointer) != NULL,
...
_operator_isEqual (const GGS_sortDescriptorList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_sortDescriptorList::
_operator_isNotEqual (const GGS_sortDescriptorList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeEntitiesToGenerateList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeEntitiesToGenerateList::
_operator_isNotEqual (const GGS_typeEntitiesToGenerateList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_treewalkingRoutineToGenerateList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_treewalkingRoutineToGenerateList::
_operator_isNotEqual (const GGS_treewalkingRoutineToGenerateList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_ruleDescriptorForProgramList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_ruleDescriptorForProgramList::
_operator_isNotEqual (const GGS_ruleDescriptorForProgramList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
void routine_performMetamodelInclusion (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_ioSuperMetamodels.reader_hasKey (_inLexique, var_cas_inSuperMetamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1492)) COMMA_SOURCE_FILE_AT_LINE (1492)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_ioSuperMetamodels._addAssign_operation (var_cas_inSuperMetamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1493))) ;
    ...
    if (var_cas_inMetamodelComponentMap._isBuilt ()) {
      var_cas_inMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperMetamodelName, automatic_var_0, var_cas_superMetamodelEntityMap, var_cas_superMetamodelsOfSuperMetamodels COMMA_SOURCE_FILE_AT_LINE (1496)) ;
    }
    GGS_entityToImplementMap::element_type * operand_61389 = var_cas_superMetamodelEntityMap.firstObject () ;
    while ((operand_61389 != NULL)) {
      macroValidPointer (operand_61389) ;
      if ((var_cas_ioAllEntityMap.reader_hasKey (_inLexique, operand_61389->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) COMMA_SOURCE_FILE_AT_LINE (1506))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (operand_61389->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1507))))._operator_concat (GGS_string (true, "' is already defined in a previously imported metamodel")) COMMA_SOURCE_FILE_AT_LINE (1508)) ;
      }else{
        var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_61389->mKey, operand_61389->mInfo.mAllMetamodelPropertyMap, operand_61389->mInfo.mIsAbstract, operand_61389->mInfo.mCurrentMetamodelPropertyMap, operand_61389->mInfo.mSuperEntityName, operand_61389->mInfo.mAncestorClassesMap, operand_61389->mInfo.mPropertyList, operand_61389->mInfo.mMetamodelName, operand_61389->mInfo.mID COMMA_SOURCE_FILE_AT_LINE (1509)) ;
      }
      operand_61389 = operand_61389->nextObject () ;
    }
    GGS_stringset::element_type * operand_62536 = var_cas_superMetamodelsOfSuperMetamodels.firstObject () ;
    while ((operand_62536 != NULL)) {
      macroValidPointer (operand_62536) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_inMetamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_62536->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_ioSuperMetamodels,  var_cas_ioAllEntityMap COMMA_SOURCE_FILE_AT_LINE (1523)) ;
      operand_62536 = operand_62536->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
