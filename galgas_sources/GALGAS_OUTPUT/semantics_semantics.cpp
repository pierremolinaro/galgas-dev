...
GGS_string GGS_typeCplusPlusNameList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeSemanticsTypesList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_assignedVariables::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeCibles::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeTypesEtNomsArgMethode::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeInstructionList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_nameWithType::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeExpressionList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_expression_instructionsList_list::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_27961 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_28050 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_27961 != NULL)
      && (operand_28050 != NULL)) {
    macroValidPointer (operand_27961) ;
    macroValidPointer (operand_28050) ;
    if (((operand_27961->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (674))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_28050->mAttributType.isBuilt ()) {
        operand_28050->mAttributType (HERE)->methode_getTypeName (_inLexique, var_cas_typeName) ;
      }
      if (((operand_27961->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (677))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (operand_28050->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.methode_insertUsedConstInArgument (_inLexique, operand_27961->mName, operand_28050->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (684)) ;
      }else{
          operand_27961->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_27961->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (686))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (687)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_27961 = operand_27961->nextObject () ;
    operand_28050 = operand_28050->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (693))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (693)))) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (695)).reader_string (_inLexique SOURCE_FILE_AT_LINE (695))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (696)).reader_string (_inLexique SOURCE_FILE_AT_LINE (696))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (696)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (697))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (697)))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (699)).reader_string (_inLexique SOURCE_FILE_AT_LINE (699))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (700)).reader_string (_inLexique SOURCE_FILE_AT_LINE (700))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (700)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_30079 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_30093 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_30079 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30079) ;
    cPtr_typeGalgas_stringset * operand_30093 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30093) ;
    if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_30079 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30079) ;
      cPtr_typeGalgas_uint * operand_30093 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30093) ;
      if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_30079 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30079) ;
        cPtr_typeGalgas_sint * operand_30093 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30093) ;
        if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_30079 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30079) ;
          cPtr_typeGalgas_char * operand_30093 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30093) ;
          if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_30079 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30079) ;
            cPtr_typeGalgas_string * operand_30093 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30093) ;
            if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_30079 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30079) ;
              cPtr_typeGalgas_bool * operand_30093 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30093) ;
              if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_30079 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30079) ;
                cPtr_typeGalgas_double * operand_30093 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30093) ;
                if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_30079 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30079) ;
                  cPtr_typeGalgas_ldouble * operand_30093 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30093) ;
                  if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_30079 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30079) ;
                    cPtr_typeGalgas_location * operand_30093 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30093) ;
                    if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_30079 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30079) ;
                      cPtr_typeGalgas_lchar * operand_30093 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30093) ;
                      if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_30079 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30079) ;
                        cPtr_typeGalgas_luint * operand_30093 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30093) ;
                        if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_30079 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30079) ;
                          cPtr_typeGalgas_lsint * operand_30093 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30093) ;
                          if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_30079 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30079) ;
                            cPtr_typeGalgas_lstring * operand_30093 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30093) ;
                            if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_30079 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30079) ;
                              cPtr_typeGalgas_lbool * operand_30093 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30093) ;
                              if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_30079 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30079) ;
                                cPtr_typeGalgasUndefinedExternType * operand_30093 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30093) ;
                                if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                                  if (((operand_30079->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (739))) != (operand_30093->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (739)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_30079->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (740))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_30093->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (741))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (741)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_30079 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30079) ;
                                  cPtr_typeGalgasUndefinedListType * operand_30093 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30093) ;
                                  if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                                    if (((operand_30079->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (745))) != (operand_30093->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (745)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30079->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (746))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_30093->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (747))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (747)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_30079 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30079) ;
                                    cPtr_typeGalgasClassType * operand_30093 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30093) ;
                                    if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                                      if (((operand_30079->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (752))) == (operand_30093->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (752)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_30093->mAncestorClassesMap.reader_hasKey (_inLexique, operand_30079->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (753)) SOURCE_FILE_AT_LINE (753))))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_30093->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (754))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_30093->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (755))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (755)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_30079 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30079) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_30093 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30093) ;
                                      if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                                        if (((operand_30079->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (759))) != (operand_30093->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (759)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30079->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (760))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_30093->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (761))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (761)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_30079 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30079) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_30093 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30093) ;
                                        if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                                          if (((operand_30079->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (765))) != (operand_30093->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (765)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30079->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (766))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_30093->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (768)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_30079 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30079) ;
                                          cPtr_typeGalgas_enum * operand_30093 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30093) ;
                                          if ((operand_30079 != NULL) && (operand_30093 != NULL)) {
                                            if (((operand_30079->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773))) != (operand_30093->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (773)))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_30079->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (774))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_30093->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (775))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (776)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (779))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (780)))) SOURCE_FILE_AT_LINE (780)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (796))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (796)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (797)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (798))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (798)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (799)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_34526 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34611 = var_cas_t2.firstObject () ;
    while ((operand_34526 != NULL)
        && (operand_34611 != NULL)) {
      macroValidPointer (operand_34526) ;
      macroValidPointer (operand_34611) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34526->mType,  operand_34611->mAttributType,  operand_34526->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (803)) SOURCE_FILE_AT_LINE (803)) ;
      operand_34526 = operand_34526->nextObject () ;
      operand_34611 = operand_34611->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (821))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (821)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (822)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (823))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (823)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (824)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_35845 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_35974 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_35845 != NULL)
        && (operand_35974 != NULL)) {
      macroValidPointer (operand_35845) ;
      macroValidPointer (operand_35974) ;
      if (operand_35845->mFormalArgumentPassingMode.isBuilt () && operand_35974->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_35845->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_35974->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35845->mType,  operand_35974->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (831)) ;
        }else{
          if ((operand_35845->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_35974->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35845->mType,  operand_35974->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (833)) ;
          }else{
            if ((operand_35845->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_35974->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35845->mType,  operand_35974->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (835)) ;
            }else{
              if ((operand_35845->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_35974->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_35974->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_35974->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_35845->mType,  operand_35974->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (840)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_35974->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (843))) + (GGS_string (true, " is not compatible with ")))) + (operand_35845->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (844)))) SOURCE_FILE_AT_LINE (844)) ;
              }
            }
          }
        }
      }
      operand_35845 = operand_35845->nextObject () ;
      operand_35974 = operand_35974->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37231 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37299 = var_cas_expressionList.firstObject () ;
    while ((operand_37231 != NULL)
        && (operand_37299 != NULL)) {
      macroValidPointer (operand_37231) ;
      macroValidPointer (operand_37299) ;
      if (operand_37299->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_37299->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_37384 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37299->mExpression.getPtr ()) ;
          macroValidPointer (operand_37384) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (operand_37384->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_cppVarName, operand_37231->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_37299->mExpression) ;
        }
      }
      operand_37231 = operand_37231->nextObject () ;
      operand_37299 = operand_37299->nextObject () ;
    }
  }
}
...
methode_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (895)) ;
...
void cPtr_typeAppendInstructionWithAssignment::appendForDescription (C_Lexique & _inLexique, C_String & ioString COMMA_LOCATION_ARGS) const {
  ioString << "->@typeAppendInstructionWithAssignment:" ;
mTargetVarCppName.reader_description  (_inLexique COMMA_THERE) ;
mSourceExpressions.reader_description  (_inLexique COMMA_THERE) ;
m_luint_TargetVarCppName.reader_description  (_inLexique COMMA_THERE) ;
}
...
GGS_string GGS_L_matchInstructionCasesList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_foreachEnumerationList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeStructuredExtractCasesList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeEntitiesToGenerateList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1259)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1264)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1269)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1274)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1279)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1284)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1289)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1294)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1299)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1304)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1309)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1314)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1319)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1324)) ;
}
...
GGS_string GGS_sharedPropertyList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1460)) ;
   ;
  GGS_stringset::element_type * operand_62506 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62506 != NULL)) {
    macroValidPointer (operand_62506) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62506->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1462)) ;
    operand_62506 = operand_62506->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1464)) ;
   ;
  GGS_stringset::element_type * operand_62803 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_62803 != NULL)) {
    macroValidPointer (operand_62803) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62803->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1466)) ;
    operand_62803 = operand_62803->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1476)) ;
   ;
  GGS_stringset::element_type * operand_63339 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63339 != NULL)) {
    macroValidPointer (operand_63339) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63339->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1478)) ;
    operand_63339 = operand_63339->nextObject () ;
  }
}
