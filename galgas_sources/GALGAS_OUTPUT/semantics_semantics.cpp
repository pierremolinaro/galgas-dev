...
void routine_buildMapWithLocalConstants (C_Compiler & _inLexique,
  ...
  const GGS_L_nameWithType _var_33441 = var_cas_inLocalDeclarationsList ;
  GGS_L_nameWithType::element_type * operand_33441 = _var_33441.firstObject () ;
  const GGS_typeListeAttributsSemantiques _var_33516 = var_cas_inSemanticAttributsList ;
  GGS_typeListeAttributsSemantiques::element_type * operand_33516 = _var_33516.firstObject () ;
  while ((operand_33441 != NULL)
      && (operand_33516 != NULL)) {
    macroValidPointer (operand_33441) ;
    macroValidPointer (operand_33516) ;
    if (((operand_33441->mName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (820)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_33516->mAttributType._isBuilt ()) {
        operand_33516->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (822)) ;
      }
      if (((operand_33441->mType.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (823)))._operator_isEqual (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if ((((var_cas_inLocalConstantStyle)._operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE)))._operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, var_cas_inLocation, operand_33516->aNomAttribut.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (828)), var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_33441->mName, operand_33516->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (830)) ;
      }else{
        operand_33441->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I have found the '@"))._operator_concat (operand_33441->mType.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (832))))._operator_concat (GGS_string (true, "' type, I was expected the '@")))._operator_concat (var_cas_typeName))._operator_concat (GGS_string (true, "' type")) COMMA_SOURCE_FILE_AT_LINE (834)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_33441 = operand_33441->nextObject () ;
    operand_33516 = operand_33516->nextObject () ;
  }
...
void routine_verifierCompatibiliteTypes (C_Compiler & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (862)))._operator_strictInf (var_cas_t2.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (862)))).isBuiltAndTrue ()) {
    ...
    const GGS_typeSemanticsTypesList _var_35862 = var_cas_t1 ;
    GGS_typeSemanticsTypesList::element_type * operand_35862 = _var_35862.firstObject () ;
    const GGS_typeListeAttributsSemantiques _var_35931 = var_cas_t2 ;
    GGS_typeListeAttributsSemantiques::element_type * operand_35931 = _var_35931.firstObject () ;
    while ((operand_35862 != NULL)
        && (operand_35931 != NULL)) {
      macroValidPointer (operand_35862) ;
      macroValidPointer (operand_35931) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_35862->mType,  operand_35931->mAttributType,  operand_35862->mGalgasVariableName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (872)),  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (869)) ;
      operand_35862 = operand_35862->nextObject () ;
      operand_35931 = operand_35931->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Compiler & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)))._operator_strictSup (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)))).isBuiltAndTrue ()) {
    ...
    const GGS_L_EXsignature _var_37200 = var_cas_signatureReference ;
    GGS_L_EXsignature::element_type * operand_37200 = _var_37200.firstObject () ;
    const GGS_L_actualParametersSignature _var_37302 = var_cas_inEffectiveArgumentsSignature ;
    GGS_L_actualParametersSignature::element_type * operand_37302 = _var_37302.firstObject () ;
    while ((operand_37200 != NULL)
        && (operand_37302 != NULL)) {
      macroValidPointer (operand_37200) ;
      macroValidPointer (operand_37302) ;
      if (operand_37200->mFormalArgumentPassingMode._isBuilt () && operand_37302->mFormalArgumentPassingMode._isBuilt ()) {
        if ((operand_37200->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_37302->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37200->mType,  operand_37302->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (902)) ;
        }else{
          if ((operand_37200->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_37302->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37200->mType,  operand_37302->mType,  var_cas_inErrorLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (904)) ;
          }else{
            if ((operand_37200->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_37302->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37200->mType,  operand_37302->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (906)) ;
            }else{
              if ((operand_37200->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_37302->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_37302->mType._isBuilt ()) {
                  cPtr_typeGalgas_jokerInParameterList * operand_38018 = dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_37302->mType.getPtr ()) ;
                  if (operand_38018 != NULL) {
                    macroValidPointer (operand_38018) ; 
                  }else{ // Else part
                    ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_37200->mType,  operand_37302->mType,  var_cas_inErrorLocation,  GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (911)) ;
                  }
                }
              }else{
                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((operand_37302->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (914)))._operator_concat (GGS_string (true, " is not compatible with ")))._operator_concat (operand_37200->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (915))) COMMA_SOURCE_FILE_AT_LINE (916)) ;
              }
            }
          }
        }
      }
      operand_37200 = operand_37200->nextObject () ;
      operand_37302 = operand_37302->nextObject () ;
    }
    ...
    const GGS_L_EXsignature _var_38592 = var_cas_signatureReference ;
    GGS_L_EXsignature::element_type * operand_38592 = _var_38592.firstObject () ;
    const GGS_typeExpressionList _var_38648 = var_cas_expressionList ;
    GGS_typeExpressionList::element_type * operand_38648 = _var_38648.firstObject () ;
    while ((operand_38592 != NULL)
        && (operand_38648 != NULL)) {
      macroValidPointer (operand_38592) ;
      macroValidPointer (operand_38648) ;
      if (operand_38648->mExpression._isBuilt ()) {
        cPtr_typeJokerInExpression * operand_38758 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_38648->mExpression.getPtr ()) ;
        if (operand_38758 != NULL) {
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_38592->mType COMMA_HERE) ;
          var_cas_ioInstructionsList._addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList._addAssign_operation (operand_38648->mExpression) ;
        }
      }
      operand_38592 = operand_38592->nextObject () ;
      operand_38648 = operand_38648->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
internalSubListWithRange (GGS_foreachEnumerationList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mSourceExpression, _p->mLocationOffset, _p->mCppTypeName) ;
      _p = _p->nextObject () ;
    }
  }
}
...
GGS_typeInstructionList  GGS_typeStructuredCastInstruction::
reader_mElseInstructionList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeInstructionList   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeStructuredCastInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeStructuredCastInstruction *) mPointer)->mElseInstructionList ;
  }
  return result ;
}
...
void routine_performMetamodelInclusion (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_ioSuperMetamodels.reader_hasKey (_inLexique, var_cas_inSuperMetamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1516)) COMMA_SOURCE_FILE_AT_LINE (1516)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_ioSuperMetamodels._addAssign_operation (var_cas_inSuperMetamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1517))) ;
    ...
    if (var_cas_inMetamodelComponentMap._isBuilt ()) {
      var_cas_inMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperMetamodelName, automatic_var_0, var_cas_superMetamodelEntityMap, var_cas_superMetamodelsOfSuperMetamodels COMMA_SOURCE_FILE_AT_LINE (1520)) ;
    }
    const GGS_entityToImplementMap _var_62280 = var_cas_superMetamodelEntityMap ;
    GGS_entityToImplementMap::element_type * operand_62280 = _var_62280.firstObject () ;
    while ((operand_62280 != NULL)) {
      macroValidPointer (operand_62280) ;
      if ((var_cas_ioAllEntityMap.reader_hasKey (_inLexique, operand_62280->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1530)) COMMA_SOURCE_FILE_AT_LINE (1530))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (operand_62280->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1531))))._operator_concat (GGS_string (true, "' is already defined in a previously imported metamodel")) COMMA_SOURCE_FILE_AT_LINE (1532)) ;
      }else{
        var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_62280->mKey, operand_62280->mInfo.mAllMetamodelPropertyMap, operand_62280->mInfo.mIsAbstract, operand_62280->mInfo.mCurrentMetamodelPropertyMap, operand_62280->mInfo.mSuperEntityName, operand_62280->mInfo.mAncestorClassesMap, operand_62280->mInfo.mPropertyList, operand_62280->mInfo.mMetamodelName, operand_62280->mInfo.mID COMMA_SOURCE_FILE_AT_LINE (1533)) ;
      }
      operand_62280 = operand_62280->nextObject () ;
    }
    const GGS_stringset _var_63418 = var_cas_superMetamodelsOfSuperMetamodels ;
    GGS_stringset::element_type * operand_63418 = _var_63418.firstObject () ;
    while ((operand_63418 != NULL)) {
      macroValidPointer (operand_63418) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_inMetamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_63418->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_ioSuperMetamodels,  var_cas_ioAllEntityMap COMMA_SOURCE_FILE_AT_LINE (1547)) ;
      operand_63418 = operand_63418->nextObject () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
