...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_60853 = var_cas_missingDefinition.firstObject () ;
  while ((operand_60853 != NULL)) {
    macroValidPointer (operand_60853) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_60853->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1449)) ;
    operand_60853 = operand_60853->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_61150 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_61150 != NULL)) {
    macroValidPointer (operand_61150) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61150->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1453)) ;
    operand_61150 = operand_61150->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset::element_type * operand_61686 = var_cas_missingDefinition.firstObject () ;
  while ((operand_61686 != NULL)) {
    macroValidPointer (operand_61686) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_61686->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1465)) ;
    operand_61686 = operand_61686->nextObject () ;
  }
}
