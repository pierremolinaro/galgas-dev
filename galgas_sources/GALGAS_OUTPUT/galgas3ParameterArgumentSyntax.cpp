  ...
  while (repeatFlag_0) {
    ...
    case 5: {
      ...
      case 1: {
        ...
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_identifier) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 135)) ;
        var_isConstant = GALGAS_bool (false) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_var) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 138)) ;
        GALGAS_lstring var_declarationTypeName = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_type_5F_name) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 139)) ;
        var_inputActualParameterName = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_identifier) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 140)) ;
        ioArgument_ioLocalVariableDeclarationList.addAssign_operation (var_declarationTypeName, var_inputActualParameterName, GALGAS_bool (false)  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 141)) ;
        var_isConstant = GALGAS_bool (false) ;
      } break ;
      case 3: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_let) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 144)) ;
        GALGAS_lstring var_declarationTypeName = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        ioArgument_ioLocalVariableDeclarationList.addAssign_operation (var_declarationTypeName, var_inputActualParameterName, GALGAS_bool (true)  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 147)) ;
        var_isConstant = GALGAS_bool (true) ;
      } break ;
      default:
        break ;
      }
      outArgument_outActualParameterList.addAssign_operation (GALGAS_inputActualParameterAST::constructor_new (var_qualifierLocation, var_inputActualParameterName, var_isConstant  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 150))  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 150)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_galgas_33_ParameterArgumentSyntax::rule_galgas_33_ParameterArgumentSyntax_formal_5F_input_5F_parameter_5F_list_i2_ (GALGAS_formalInputParameterListAST & outArgument_outFormalInputParameterList,
  ...
  outArgument_outFormalInputParameterList = GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 176)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case 1: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken__3F_) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 181)) ;
        var_isConstant = GALGAS_bool (false) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken__3F__3F_) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 184)) ;
        var_isConstant = GALGAS_bool (true) ;
      } break ;
      default:
        break ;
      ...
      GALGAS_lstring var_mFormalParameterTypeName = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_type_5F_name) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 187)) ;
      GALGAS_bool var_mIsUnused ;
      ...
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_unused) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 192)) ;
        var_mIsUnused = GALGAS_bool (true) ;
      } break ;
      default:
        break ;
      ...
      GALGAS_lstring var_mFormalParameterName = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_identifier) COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 195)) ;
      outArgument_outFormalInputParameterList.addAssign_operation (var_mFormalParameterTypeName, var_mFormalParameterName, var_mIsUnused, var_isConstant  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 196)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
