    ...
    case 2: {
      ...
      case 2: {
        ...
        if (kBoolTrue == test_1) {
          ...
          if (var_n.isValid ()) {
            uint32_t variant_4024 = var_n.uintValue () ;
            bool loop_4024 = true ;
            while (loop_4024) {
              loop_4024 = GALGAS_bool (kIsStrictSup, var_n.objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
              if (loop_4024) {
                loop_4024 = GALGAS_bool (kIsStrictSup, var_n.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
              }
              if (loop_4024 && (0 == variant_4024)) {
                loop_4024 = false ;
...
void cParser_galgas_33_ParameterArgumentSyntax::rule_galgas_33_ParameterArgumentSyntax_formal_5F_input_5F_parameter_5F_list_i2_ (GALGAS_formalInputParameterListAST & outArgument_outFormalInputParameterList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      outArgument_outFormalInputParameterList.addAssign_operation (var_selector, var_mFormalParameterTypeName, var_mFormalParameterName, var_mIsUnused, var_isConstant  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.gSyntax", 209)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
