...
_treewalking_routine_metamodelComponentRoot (C_Compiler & _inLexique,
    ...
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_3347->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)))._operator_not ()).isBuiltAndTrue ()) {
      if (((operand_3347->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)))._operator_isNotEqual (_currentObject->mMetamodelComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)))).isBuiltAndTrue ()) {
        ...
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          ...
          operand_3347->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only a semantics component can be imported in a metamodel") COMMA_SOURCE_FILE_AT_LINE (88)) ;
        }
      }
  ...
  if ((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, _currentObject->mMetamodelComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94))).isBuiltAndTrue ()) {
    _currentObject->mMetamodelComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this component is involved in a circularity in 'extends' definitions") COMMA_SOURCE_FILE_AT_LINE (96)) ;
    ...
    { GGS__list_metamodelEntity::element_type * _ptr = _currentObject->mMetamodelEntities.firstObject () ;
      while (_ptr != NULL) {
        ...
        (* _f) (_inLexique, _ptr, var_cas_ioTypeMap, var_cas_outTypeList) ;
...
_treewalking_routine_metamodelEntity (C_Compiler & _inLexique,
  ...
  if (((_currentObject->mSuperEntityName.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_superEntityIndex = GGS_typeMapIndex::constructor_null (_inLexique COMMA_HERE) ;
  }else{
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mSuperEntityName, var_cas_ioTypeMap, var_cas_superEntityIndex COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  GGS_attributeList  var_cas_propertyList ;
  var_cas_propertyList = GGS_attributeList::constructor_emptyList (_inLexique COMMA_HERE) ;
  macroValidPointer (_currentObject) ;
  { GGS__list_metamodelProperty::element_type * _ptr = _currentObject->mProperties.firstObject () ;
    while (_ptr != NULL) {
  ...
  const GGS_lstringlist _var_5554 = _currentObject->mEntityNameList ;
  const GGS_lstringlist::element_type * operand_5554 = _var_5554.firstObject () ;
  while ((operand_5554 != NULL)) {
    macroValidPointer (operand_5554) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_entityGalgasType::constructor_new (_inLexique, _currentObject->mIsAbstract, operand_5554->mValue, var_cas_superEntityIndex, var_cas_propertyList COMMA_HERE) ;
    var_cas_ioTypeMap.modifier_insertKey (_inLexique, operand_5554->mValue, var_cas_t COMMA_SOURCE_FILE_AT_LINE (126)) ;
    var_cas_ioTypeList._addAssign_operation (var_cas_t) ;
    var_cas_t = GGS_multipleReferenceGalgasType::constructor_new (_inLexique, operand_5554->mValue COMMA_HERE) ;
    var_cas_ioTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, (GGS_string (true, "_list_"))._operator_concat (operand_5554->mValue), operand_5554->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_HERE), var_cas_t COMMA_SOURCE_FILE_AT_LINE (131)) ;
    operand_5554 = operand_5554->nextObject () ;
  }
}
...
_treewalking_routine_metamodelProperty (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mAttributeTypeName, var_cas_ioTypeMap, var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (145)) ;
...
_treewalking_routine_metamodelMultipleReference (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeMapIndex  var_cas_typeIndex ;
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, (GGS_string (true, "_list_"))._operator_concat (_currentObject->mAttributeTypeName), _currentObject->mAttributeTypeName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_HERE), var_cas_ioTypeMap, var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (156)) ;
  var_cas_ioPropertyList._addAssign_operation (var_cas_typeIndex, _currentObject->mAttributeName) ;
}
