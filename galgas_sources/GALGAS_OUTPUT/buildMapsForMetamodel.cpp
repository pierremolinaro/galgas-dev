...
_treewalking_routine_metamodelComponentRoot (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::cEnumerator enumerator_3347 (_currentObject->mMetamodelImportedComponents, true) ;
  const GGS_lstringlist::cElement * operand_3347 = NULL ;
  while (((operand_3347 = (GGS_lstringlist::cElement *) enumerator_3347.nextObject ()))) {
...
_treewalking_routine_metamodelEntity (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::cEnumerator enumerator_5622 (_currentObject->mEntityNameList, true) ;
  const GGS_lstringlist::cElement * operand_5622 = NULL ;
  while (((operand_5622 = (GGS_lstringlist::cElement *) enumerator_5622.nextObject ()))) {
    macroValidPointer (operand_5622) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_entityGalgasType::constructor_new (_inLexique, _currentObject->mIsAbstract, operand_5622->mValue, var_cas_superEntityIndex, var_cas_propertyList, var_cas_ioEntityIndex COMMA_HERE) ;
    var_cas_ioEntityIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
    var_cas_ioTypeMap.modifier_insertKey (_inLexique, operand_5622->mValue, var_cas_t COMMA_SOURCE_FILE_AT_LINE (130)) ;
    var_cas_ioTypeList._addAssign_operation (var_cas_t) ;
    var_cas_t = GGS_multipleReferenceGalgasType::constructor_new (_inLexique, operand_5622->mValue COMMA_HERE) ;
    var_cas_ioTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, (GGS_string (true, "_list_"))._operator_concat (operand_5622->mValue), operand_5622->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_HERE), var_cas_t COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  enumerator_5622.reset () ;
}
