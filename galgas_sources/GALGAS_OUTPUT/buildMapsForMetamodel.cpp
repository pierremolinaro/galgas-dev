...
_treewalking_routine_metamodelComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_lstringlist _var_2357 = _currentObject->mSuperMetamodels ;
  const GGS_lstringlist::element_type * operand_2357 = _var_2357.firstObject () ;
  while ((operand_2357 != NULL)) {
    ...
    operand_2357 = operand_2357->nextObject () ;
  }
  const GGS_lstringlist _var_3346 = _currentObject->mMetamodelImportedComponents ;
  const GGS_lstringlist::element_type * operand_3346 = _var_3346.firstObject () ;
  while ((operand_3346 != NULL)) {
    ...
    operand_3346 = operand_3346->nextObject () ;
  }
...
_treewalking_routine_metamodelEntity (C_Compiler & _inLexique,
  ...
  const GGS_lstringlist _var_5620 = _currentObject->mEntityNameList ;
  const GGS_lstringlist::element_type * operand_5620 = _var_5620.firstObject () ;
  while ((operand_5620 != NULL)) {
    ...
    operand_5620 = operand_5620->nextObject () ;
  }
}
