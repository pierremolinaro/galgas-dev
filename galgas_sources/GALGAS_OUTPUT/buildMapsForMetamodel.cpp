...
_treewalking_routine_metamodelComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  GGS_lstringlist::cEnumerator enumerator_2357 (_currentObject->mSuperMetamodels, true) ;
  const GGS_lstringlist::cElement * operand_2357 = NULL ;
  while (((operand_2357 = (GGS_lstringlist::cElement *) enumerator_2357.nextObject ()))) {
    macroValidPointer (operand_2357) ;
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_2357->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42)))._operator_not ()).isBuiltAndTrue ()) {
      if (((operand_2357->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43)))._operator_isNotEqual (_currentObject->mMetamodelComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43)))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_sourceFilePath ;
        var_cas_sourceFilePath = GGS_lstring::constructor_new (_inLexique, (((var_cas_inSourceFileDirectory)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_2357->mValue))._operator_concat (GGS_string (true, ".gMetamodel")), var_cas_inErrorLocation COMMA_HERE) ;
        GGS_metamodelComponentRoot  var_cas_metamodemComponentRoot ;
        GGS_location  var_cas_endOfSourceFile ;
          var_cas_metamodemComponentRoot = metamodelLL1grammar::_performSourceFileParsing_ (_inLexique,
      ...
      var_cas_ioImportedComponentSet._addAssign_operation (operand_2357->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (61))) ;
    }
  }
  enumerator_2357.reset () ;
  GGS_lstringlist::cEnumerator enumerator_3346 (_currentObject->mMetamodelImportedComponents, true) ;
  const GGS_lstringlist::cElement * operand_3346 = NULL ;
  while (((operand_3346 = (GGS_lstringlist::cElement *) enumerator_3346.nextObject ()))) {
    macroValidPointer (operand_3346) ;
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_3346->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)))._operator_not ()).isBuiltAndTrue ()) {
      if (((operand_3346->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)))._operator_isNotEqual (_currentObject->mMetamodelComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_sourceFilePath ;
        var_cas_sourceFilePath = GGS_lstring::constructor_new (_inLexique, ((var_cas_inSourceFileDirectory)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_3346->mValue), var_cas_inErrorLocation COMMA_HERE) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_3346->mValue.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          ...
          operand_3346->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only a semantics component can be imported in a metamodel") COMMA_SOURCE_FILE_AT_LINE (87)) ;
        }
      }
      var_cas_ioImportedComponentSet._addAssign_operation (operand_3346->mValue.ggs_string ().reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (90))) ;
    }
  }
  enumerator_3346.reset () ;
...
_treewalking_routine_metamodelEntity (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::cEnumerator enumerator_5620 (_currentObject->mEntityNameList, true) ;
  const GGS_lstringlist::cElement * operand_5620 = NULL ;
  while (((operand_5620 = (GGS_lstringlist::cElement *) enumerator_5620.nextObject ()))) {
    macroValidPointer (operand_5620) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_entityGalgasType::constructor_new (_inLexique, _currentObject->mIsAbstract, operand_5620->mValue, var_cas_superEntityIndex, var_cas_propertyList, var_cas_ioEntityIndex COMMA_HERE) ;
    var_cas_ioEntityIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
    var_cas_ioTypeMap.modifier_insertKey (_inLexique, operand_5620->mValue, var_cas_t COMMA_SOURCE_FILE_AT_LINE (130)) ;
    var_cas_ioTypeList._addAssign_operation (var_cas_t) ;
    var_cas_t = GGS_multipleReferenceGalgasType::constructor_new (_inLexique, operand_5620->mValue COMMA_HERE) ;
    var_cas_ioTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, (GGS_string (true, "_list_"))._operator_concat (operand_5620->mValue), operand_5620->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_HERE), var_cas_t COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  enumerator_5620.reset () ;
}
