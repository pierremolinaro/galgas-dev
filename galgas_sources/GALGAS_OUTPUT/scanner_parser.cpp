...
pr_galgas_component_scanner_parser_233_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_10782 != NULL)) {
    ...
    if (((! (var_cas_usedErrorMessageSet.reader_hasKey (_inLexique, operand_10782->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307))))).isBuiltAndTrue ()) {
