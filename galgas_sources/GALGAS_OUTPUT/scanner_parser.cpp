    ...
    while (syntaxRepeat_14) {
        switch (select_scanner_5F_parser_15 (inLexique)) {
          case 1 : {
            ...
            nt_lexical_5F_instructions_5F_list_ (inLexique, var_cas_li, var_cas_table_des_terminaux, var_cas_table_des_messages_erreur, var_cas_table_attributs, var_cas_table_tables_mots_reserves, var_cas_ioUsedErrorMessageSet, GGS_tagMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_bool (false)) ;
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_rule_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_HERE) ;
  GGS_tListeInstructionsLexicales  var_cas_li ;
  nt_lexical_5F_instructions_5F_list_ (inLexique, var_cas_li, var_cas_table_des_terminaux, var_cas_table_des_messages_erreur, var_cas_table_attributs, var_cas_table_tables_mots_reserves, var_cas_ioUsedErrorMessageSet, GGS_tagMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_bool (true)) ;
    ...
    while (syntaxRepeat_19) {
      switch (select_scanner_5F_parser_19 (inLexique)) {
        ...
        case 4 : {
          ...
          nt_lexical_5F_instructions_5F_list_ (inLexique, var_cas_lii, var_cas_table_des_terminaux, var_cas_table_des_messages_erreur, var_cas_table_attributs, var_cas_table_tables_mots_reserves, var_cas_ioUsedErrorMessageSet, GGS_tagMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_bool (false)) ;
