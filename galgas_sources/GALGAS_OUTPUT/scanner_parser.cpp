...
pr_attribute_or_terminal_symbol_declaration_scanner_parser_636_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_3 (_inLexique)) {
    case 1 : {
      ...
      const GGS_lexicalTypeMap  _temp_19768 = var_cas_inLexicalTypeMap ;
      if (_temp_19768._isBuilt ()) {
        _temp_19768 (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (648)) ;
      }
    ...
    case 2 : {
        ...
        while (syntaxRepeat_4) {
          switch (select_repeat_scanner_parser_4 (_inLexique)) {
            case 2 : {
              ...
              const GGS_typeLexicalAttributesMap  _temp_20220 = var_cas_table_des_attributs ;
              if (_temp_20220._isBuilt ()) {
                _temp_20220 (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (663)) ;
              }
      ...
      const GGS_M_styles  _temp_20673 = var_cas_ioStylesMap ;
      if (_temp_20673._isBuilt ()) {
        _temp_20673 (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (680)) ;
      }
...
pr_key_words_list_declaration_scanner_parser_691_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_scanner_parser_6 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_t ;
          const GGS_typeLexicalAttributesMap  _temp_21771 = var_cas_table_des_attributs ;
          if (_temp_21771._isBuilt ()) {
            _temp_21771 (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (712)) ;
          }
          var_cas_attributeList._addAssign_operation (var_cas_t, var_cas_idf) ;
          } break ;
        default :
  ...
  const GGS_M_styles  _temp_22177 = var_cas_ioStylesMap ;
  if (_temp_22177._isBuilt ()) {
    _temp_22177 (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (730)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
    ...
    while (syntaxRepeat_10) {
        ...
        switch (select_scanner_parser_11 (_inLexique)) {
          case 1 : {
            ...
            const GGS_typeTableMessagesErreurs  _temp_24638 = var_cas_table_des_messages_erreur ;
            if (_temp_24638._isBuilt ()) {
              _temp_24638 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (806)) ;
            }
...
pr_lexical_rule_scanner_parser_922_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableTablesDeMotsReserves  _temp_28044 = var_cas_table_tables_mots_reserves ;
  if (_temp_28044._isBuilt ()) {
    _temp_28044 (HERE)->method_searchKey (_inLexique, var_cas_listName, var_cas_keyWordsMap COMMA_SOURCE_FILE_AT_LINE (936)) ;
  }
    ...
    while (syntaxRepeat_14) {
      switch (select_repeat_scanner_parser_14 (_inLexique)) {
        ...
        case 7 : {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_tagIdentifier) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_tagMap  _temp_31202 = var_cas_tagMap ;
          if (_temp_31202._isBuilt ()) {
            _temp_31202 (HERE)->method_searchKey (_inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (1044)) ;
          }
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_31325 = var_cas_table_des_terminaux ;
          if (_temp_31325._isBuilt ()) {
            _temp_31325 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (1048)) ;
          }
        ...
        case 8 : {
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_31701 = var_cas_table_des_terminaux ;
          if (_temp_31701._isBuilt ()) {
            _temp_31701 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1059)) ;
          }
        ...
        case 10 : {
          ...
          const GGS_typeTableMessagesErreurs  _temp_32359 = var_cas_table_des_messages_erreur ;
          if (_temp_32359._isBuilt ()) {
            _temp_32359 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1082)) ;
          }
...
pr_lexical_error_messages_list_scanner_parser_1101_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_15 = true ;
    while (syntaxRepeat_15) {
        ...
        const GGS_typeTableMessagesErreurs  _temp_33272 = var_cas_table_des_messages_erreur ;
        if (_temp_33272._isBuilt ()) {
          _temp_33272 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1111)) ;
        }
...
pr_lexical_parameter_scanner_parser_1171_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_17 (_inLexique)) {
    case 1 : {
      GGS_AC_galgasType  var_cas_t ;
      const GGS_typeLexicalAttributesMap  _temp_35066 = var_cas_table_attributs ;
      if (_temp_35066._isBuilt ()) {
        _temp_35066 (HERE)->method_searchKey (_inLexique, var_cas_nom, var_cas_t COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      }
...
pr_lexical_send_instruction_scanner_parser_1265_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_38115 = var_cas_table_des_terminaux ;
  if (_temp_38115._isBuilt ()) {
    _temp_38115 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_11, automatic_var_12, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (1275)) ;
  }
...
pr_lexical_send_instruction_scanner_parser_1281_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_19 = true ;
    while (syntaxRepeat_19) {
        ...
        const GGS_typeLexicalAttributesMap  _temp_38824 = var_cas_table_attributs ;
        if (_temp_38824._isBuilt ()) {
          _temp_38824 (HERE)->method_searchKey (_inLexique, var_cas_nomAttribut, var_cas_natureAttribut COMMA_SOURCE_FILE_AT_LINE (1295)) ;
        }
        ...
        const GGS_typeTableTablesDeMotsReserves  _temp_39066 = var_cas_table_tables_mots_reserves ;
        if (_temp_39066._isBuilt ()) {
          _temp_39066 (HERE)->method_searchKey (_inLexique, var_cas_listName, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1300)) ;
        }
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
pr_lexical_send_or_error_scanner_parser_1318_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_39782 = var_cas_table_des_terminaux ;
  if (_temp_39782._isBuilt ()) {
    _temp_39782 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_15, automatic_var_16, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  }
...
pr_lexical_send_or_error_scanner_parser_1332_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableMessagesErreurs  _temp_40329 = var_cas_tableMessagesErreurs ;
  if (_temp_40329._isBuilt ()) {
    _temp_40329 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1342)) ;
  }
