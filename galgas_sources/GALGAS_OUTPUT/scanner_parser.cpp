  ...
  switch (select_scanner_parser_2 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_inLexicalTypeMap._isBuilt ()) {
        var_cas_inLexicalTypeMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (524)) ;
      }
    ...
    case 2 : {
          ...
          switch (select_repeat_scanner_parser_3 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_table_des_attributs._isBuilt ()) {
                var_cas_table_des_attributs (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (539)) ;
              }
      ...
      if (var_cas_ioStylesMap._isBuilt ()) {
        var_cas_ioStylesMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (556)) ;
      }
...
pr_key_words_list_declaration_scanner_parser_567_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_scanner_parser_5 (_inLexique)) {
        case 2 : {
          ...
          GGS_AC_galgasType  var_cas_t ;
          if (var_cas_table_des_attributs._isBuilt ()) {
            var_cas_table_des_attributs (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (588)) ;
          }
          var_cas_attributeList._addAssign_operation (var_cas_t, var_cas_idf) ;
          } break ;
        default :
  ...
  if (var_cas_ioStylesMap._isBuilt ()) {
    var_cas_ioStylesMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (606)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
        ...
        switch (select_scanner_parser_10 (_inLexique)) {
          case 1 : {
            ...
            if (var_cas_table_des_messages_erreur._isBuilt ()) {
              var_cas_table_des_messages_erreur (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (682)) ;
            }
...
pr_lexical_rule_scanner_parser_798_4_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_table_tables_mots_reserves._isBuilt ()) {
    var_cas_table_tables_mots_reserves (HERE)->method_searchKey (_inLexique, var_cas_listName, var_cas_keyWordsMap COMMA_SOURCE_FILE_AT_LINE (812)) ;
  }
      ...
      switch (select_repeat_scanner_parser_13 (_inLexique)) {
        ...
        case 7 : {
          ...
          if (var_cas_tagMap._isBuilt ()) {
            var_cas_tagMap (HERE)->method_searchKey (_inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (920)) ;
          }
          ...
          if (var_cas_table_des_terminaux._isBuilt ()) {
            var_cas_table_des_terminaux (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (924)) ;
          }
        ...
        case 8 : {
          ...
          if (var_cas_table_des_terminaux._isBuilt ()) {
            var_cas_table_des_terminaux (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (935)) ;
          }
        ...
        case 10 : {
          ...
          if (var_cas_table_des_messages_erreur._isBuilt ()) {
            var_cas_table_des_messages_erreur (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (958)) ;
          }
...
pr_lexical_error_messages_list_scanner_parser_977_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
        ...
        if (var_cas_table_des_messages_erreur._isBuilt ()) {
          var_cas_table_des_messages_erreur (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (987)) ;
        }
  ...
  switch (select_scanner_parser_16 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_table_attributs._isBuilt ()) {
        var_cas_table_attributs (HERE)->method_searchKey (_inLexique, var_cas_nom, var_cas_t COMMA_SOURCE_FILE_AT_LINE (1055)) ;
      }
...
pr_lexical_send_instruction_scanner_parser_1141_4_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_table_des_terminaux._isBuilt ()) {
    var_cas_table_des_terminaux (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_11, automatic_var_12, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (1151)) ;
  }
...
pr_lexical_send_instruction_scanner_parser_1157_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_18 = true ;
    while (syntaxRepeat_18) {
        ...
        if (var_cas_table_attributs._isBuilt ()) {
          var_cas_table_attributs (HERE)->method_searchKey (_inLexique, var_cas_nomAttribut, var_cas_natureAttribut COMMA_SOURCE_FILE_AT_LINE (1171)) ;
        }
        ...
        if (var_cas_table_tables_mots_reserves._isBuilt ()) {
          var_cas_table_tables_mots_reserves (HERE)->method_searchKey (_inLexique, var_cas_listName, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1176)) ;
        }
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
pr_lexical_send_or_error_scanner_parser_1194_4_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_table_des_terminaux._isBuilt ()) {
    var_cas_table_des_terminaux (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_15, automatic_var_16, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1202)) ;
  }
...
pr_lexical_send_or_error_scanner_parser_1208_4_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_tableMessagesErreurs._isBuilt ()) {
    var_cas_tableMessagesErreurs (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1218)) ;
  }
