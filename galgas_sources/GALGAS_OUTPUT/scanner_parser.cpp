...
pr_attribute_or_terminal_symbol_declaration_scanner_parser_562_47_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_errorMessageString = var_cas_errorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (608)) ;
...
pr_key_words_list_declaration_scanner_parser_632_33_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        var_cas_specificErrorMessageString = var_cas_errorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (704)).reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), var_cas_terminalSymbolName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (704)) COMMA_SOURCE_FILE_AT_LINE (704)) ;
...
pr_lexical_send_instruction_scanner_parser_1275_31_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        var_cas_lgs = GGS_typeGalgas_lstring::castFrom (inLexique, var_cas_natureAttribut.getPtr (), true, var_cas_nomAttribut COMMA_SOURCE_FILE_AT_LINE (1290)) ;
