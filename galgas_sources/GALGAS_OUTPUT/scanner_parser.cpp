...
//                    november 11th, 2010, at 15h50'14"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void scanner_parser::rule_scanner_5F_parser_key_5F_words_5F_list_5F_declaration_i5_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  if (var_cas_errorMessage.isBuilt ()) {
    ::routine_check_K_escapeCharactersEX (inLexique,  var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (662)) ;
  }
  GGS_lstring  var_cas_styleName ;
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        switch (select_scanner_5F_parser_13 (inLexique)) {
          ...
          case 2 : {
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_feature) COMMA_HERE) ;
            const GGS_bool cond_20737 = (var_cas_inIsTemplate).operator_not () ;
            if (cond_20737.isBuiltAndTrue ()) {
            ...
            inLexique.assignFromAttribute_tokenString (var_cas_mark) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_20897 = (var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (696))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
    ...
    while (syntaxRepeat_14) {
        switch (select_scanner_5F_parser_15 (inLexique)) {
          case 1 : {
            ...
            GGS_lstring  automatic_var_23232_0 ;
            if (var_cas_table_des_messages_erreur.isBuilt ()) {
              var_cas_table_des_messages_erreur (HERE)->method_searchKey (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_23232_0 COMMA_SOURCE_FILE_AT_LINE (768)) ;
            }
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_test_5F_term_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_25437 = (var_cas_availableCharSet.reader_hasKey (var_cas_unicodeCharSetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (839)))).operator_not () ;
  if (cond_25437.isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat_19) {
      switch (select_scanner_5F_parser_19 (inLexique)) {
        ...
        case 7 : {
          ...
          const GGS_bool cond_30545 = (var_cas_inCanSendTerminal).operator_not () ;
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_nomTerminal) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
          GGS_string automatic_var_30784_0 ;
          GGS_typeListeAttributsSemantiques  automatic_var_30784_1 ;
          GGS_uint  automatic_var_30784_2 ;
          GGS_bool automatic_var_30784_3 ;
          if (var_cas_table_des_terminaux.isBuilt ()) {
            var_cas_table_des_terminaux (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_30784_0, automatic_var_30784_1, automatic_var_30784_2, automatic_var_30784_3 COMMA_SOURCE_FILE_AT_LINE (1028)) ;
          }
        ...
        case 8 : {
          ...
          const GGS_bool cond_31030 = (var_cas_inCanSendTerminal).operator_not () ;
          if (cond_31030.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
          GGS_string automatic_var_31163_0 ;
          GGS_typeListeAttributsSemantiques  automatic_var_31163_1 ;
          GGS_uint  automatic_var_31163_2 ;
          GGS_bool automatic_var_31163_3 ;
          if (var_cas_table_des_terminaux.isBuilt ()) {
            var_cas_table_des_terminaux (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_31163_0, automatic_var_31163_1, automatic_var_31163_2, automatic_var_31163_3 COMMA_SOURCE_FILE_AT_LINE (1039)) ;
          }
        ...
        case 9 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_send) COMMA_HERE) ;
          const GGS_bool cond_31375 = (var_cas_inCanSendTerminal).operator_not () ;
          if (cond_31375.isBuiltAndTrue ()) {
        ...
        case 10 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          GGS_uint  var_cas_errorMessageIndex ;
          GGS_lstring  automatic_var_31838_0 ;
          if (var_cas_table_des_messages_erreur.isBuilt ()) {
            var_cas_table_des_messages_erreur (HERE)->method_searchKey (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_31838_0 COMMA_SOURCE_FILE_AT_LINE (1062)) ;
          }
        ...
        case 11 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          GGS_uint  var_cas_errorMessageIndex ;
          GGS_lstring  automatic_var_32220_0 ;
          if (var_cas_table_des_messages_erreur.isBuilt ()) {
            var_cas_table_des_messages_erreur (HERE)->method_searchKey (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_32220_0 COMMA_SOURCE_FILE_AT_LINE (1072)) ;
          }
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_error_5F_messages_5F_list_i16_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
        GGS_uint  var_cas_errorMessageIndex ;
        GGS_lstring  automatic_var_33127_0 ;
        if (var_cas_table_des_messages_erreur.isBuilt ()) {
          var_cas_table_des_messages_erreur (HERE)->method_searchKey (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_33127_0 COMMA_SOURCE_FILE_AT_LINE (1101)) ;
        }
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_send_5F_instruction_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_nomTerminal) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
  GGS_string automatic_var_38004_0 ;
  GGS_typeListeAttributsSemantiques  automatic_var_38004_1 ;
  GGS_uint  automatic_var_38004_2 ;
  GGS_bool automatic_var_38004_3 ;
  if (var_cas_table_des_terminaux.isBuilt ()) {
    var_cas_table_des_terminaux (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_38004_0, automatic_var_38004_1, automatic_var_38004_2, automatic_var_38004_3 COMMA_SOURCE_FILE_AT_LINE (1269)) ;
  }
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_send_5F_instruction_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        inLexique.assignFromAttribute_tokenString (var_cas_listName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
        GGS_typeTableMotsReserves  automatic_var_38946_0 ;
        if (var_cas_table_tables_mots_reserves.isBuilt ()) {
          var_cas_table_tables_mots_reserves (HERE)->method_searchKey (inLexique, var_cas_listName, automatic_var_38946_0 COMMA_SOURCE_FILE_AT_LINE (1294)) ;
        }
        inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_default) COMMA_HERE) ;
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_send_5F_or_5F_error_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_nomTerminal) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
  GGS_string automatic_var_39674_0 ;
  GGS_typeListeAttributsSemantiques  automatic_var_39674_1 ;
  GGS_uint  automatic_var_39674_2 ;
  GGS_bool automatic_var_39674_3 ;
  if (var_cas_table_des_terminaux.isBuilt ()) {
    var_cas_table_des_terminaux (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_39674_0, automatic_var_39674_1, automatic_var_39674_2, automatic_var_39674_3 COMMA_SOURCE_FILE_AT_LINE (1320)) ;
  }
...
void scanner_parser::rule_scanner_5F_parser_lexical_5F_send_5F_or_5F_error_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  GGS_uint  var_cas_errorMessageIndex ;
  GGS_lstring  automatic_var_40238_0 ;
  if (var_cas_tableMessagesErreurs.isBuilt ()) {
    var_cas_tableMessagesErreurs (HERE)->method_searchKey (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_40238_0 COMMA_SOURCE_FILE_AT_LINE (1336)) ;
  }
