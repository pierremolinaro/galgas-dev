...
pr_galgas_component_scanner_parser_233_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_lexiqueName._isBuilt () &&
    ...
    ::routine_generate_scanner (_inLexique,  var_cas_lexiqueName,  var_cas_table_attributs,  var_cas_table_des_terminaux,  var_cas_table_tables_mots_reserves,  var_cas_lexicalRulesList,  var_cas_table_messages,  var_cas_stylesMap,  var_cas_usedErrorMessageSet,  var_cas_tokensInListMap SOURCE_FILE_AT_LINE (313)) ;
  }
}
...
pr_lexical_rule_scanner_parser_765_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_keyWordsMap._isBuilt () &&
    ...
    ::routine_buildLexicalRulesFromList (_inLexique,  var_cas_keyWordsMap,  var_cas_ioLexicalRulesList SOURCE_FILE_AT_LINE (780)) ;
  }
}
