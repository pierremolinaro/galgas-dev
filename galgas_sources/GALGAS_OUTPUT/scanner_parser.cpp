...
pr_galgas_component_scanner_parser_247_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  {
    GGS_typeTableMessagesErreurs::cEnumerator enumerator_11737 (var_cas_table_messages, true) ;
    const GGS_typeTableMessagesErreurs::cElement * operand_11737 = NULL ;
    while (((operand_11737 = (GGS_typeTableMessagesErreurs::cElement *) enumerator_11737.nextObject ()))) {
      macroValidPointer (operand_11737) ;
      if (((var_cas_usedErrorMessageSet.reader_hasKey (_inLexique, operand_11737->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)) COMMA_SOURCE_FILE_AT_LINE (340)))._operator_not ()).isBuiltAndTrue ()) {
        operand_11737->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "this error message is not used") COMMA_SOURCE_FILE_AT_LINE (341)) ;
      }
    }
  }
...
pr_attribute_or_terminal_symbol_declaration_scanner_parser_632_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_3 (_inLexique)) {
    case 1 : {
      ...
      const GGS_lexicalTypeMap  _temp_19789 = var_cas_inLexicalTypeMap ;
      if (_temp_19789._isBuilt ()) {
        _temp_19789 (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (644)) ;
      }
    ...
    case 2 : {
        ...
        while (syntaxRepeat_4) {
          switch (select_repeat_scanner_parser_4 (_inLexique)) {
            case 2 : {
              ...
              const GGS_typeLexicalAttributesMap  _temp_20241 = var_cas_table_des_attributs ;
              if (_temp_20241._isBuilt ()) {
                _temp_20241 (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (659)) ;
              }
      ...
      const GGS_M_styles  _temp_20694 = var_cas_ioStylesMap ;
      if (_temp_20694._isBuilt ()) {
        _temp_20694 (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (676)) ;
      }
...
pr_key_words_list_declaration_scanner_parser_687_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_scanner_parser_6 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_t ;
          const GGS_typeLexicalAttributesMap  _temp_21792 = var_cas_table_des_attributs ;
          if (_temp_21792._isBuilt ()) {
            _temp_21792 (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (708)) ;
          }
          var_cas_attributeList._addAssign_operation (var_cas_t, var_cas_idf) ;
          } break ;
        default :
  ...
  const GGS_M_styles  _temp_22198 = var_cas_ioStylesMap ;
  if (_temp_22198._isBuilt ()) {
    _temp_22198 (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (726)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
    ...
    while (syntaxRepeat_10) {
        ...
        switch (select_scanner_parser_11 (_inLexique)) {
          case 1 : {
            ...
            const GGS_typeTableMessagesErreurs  _temp_24793 = var_cas_table_des_messages_erreur ;
            if (_temp_24793._isBuilt ()) {
              _temp_24793 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (808)) ;
            }
...
pr_lexical_rule_scanner_parser_915_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableTablesDeMotsReserves  _temp_28034 = var_cas_table_tables_mots_reserves ;
  if (_temp_28034._isBuilt ()) {
    _temp_28034 (HERE)->method_searchKey (_inLexique, var_cas_listName, var_cas_keyWordsMap COMMA_SOURCE_FILE_AT_LINE (929)) ;
  }
    ...
    while (syntaxRepeat_15) {
      switch (select_repeat_scanner_parser_15 (_inLexique)) {
        ...
        case 7 : {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_tagIdentifier) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_tagMap  _temp_31192 = var_cas_tagMap ;
          if (_temp_31192._isBuilt ()) {
            _temp_31192 (HERE)->method_searchKey (_inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (1037)) ;
          }
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_31315 = var_cas_table_des_terminaux ;
          if (_temp_31315._isBuilt ()) {
            _temp_31315 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (1041)) ;
          }
        ...
        case 8 : {
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_31691 = var_cas_table_des_terminaux ;
          if (_temp_31691._isBuilt ()) {
            _temp_31691 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1052)) ;
          }
        ...
        case 10 : {
          ...
          const GGS_typeTableMessagesErreurs  _temp_32349 = var_cas_table_des_messages_erreur ;
          if (_temp_32349._isBuilt ()) {
            _temp_32349 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1075)) ;
          }
...
pr_lexical_error_messages_list_scanner_parser_1094_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_16 = true ;
    while (syntaxRepeat_16) {
        ...
        const GGS_typeTableMessagesErreurs  _temp_33262 = var_cas_table_des_messages_erreur ;
        if (_temp_33262._isBuilt ()) {
          _temp_33262 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1104)) ;
        }
...
pr_lexical_parameter_scanner_parser_1164_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_18 (_inLexique)) {
    case 1 : {
      GGS_AC_galgasType  var_cas_t ;
      const GGS_typeLexicalAttributesMap  _temp_35056 = var_cas_table_attributs ;
      if (_temp_35056._isBuilt ()) {
        _temp_35056 (HERE)->method_searchKey (_inLexique, var_cas_nom, var_cas_t COMMA_SOURCE_FILE_AT_LINE (1172)) ;
      }
...
pr_lexical_send_instruction_scanner_parser_1258_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_38105 = var_cas_table_des_terminaux ;
  if (_temp_38105._isBuilt ()) {
    _temp_38105 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_11, automatic_var_12, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (1268)) ;
  }
...
pr_lexical_send_instruction_scanner_parser_1274_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
        ...
        const GGS_typeLexicalAttributesMap  _temp_38814 = var_cas_table_attributs ;
        if (_temp_38814._isBuilt ()) {
          _temp_38814 (HERE)->method_searchKey (_inLexique, var_cas_nomAttribut, var_cas_natureAttribut COMMA_SOURCE_FILE_AT_LINE (1288)) ;
        }
        ...
        const GGS_typeTableTablesDeMotsReserves  _temp_39056 = var_cas_table_tables_mots_reserves ;
        if (_temp_39056._isBuilt ()) {
          _temp_39056 (HERE)->method_searchKey (_inLexique, var_cas_listName, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1293)) ;
        }
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
pr_lexical_send_or_error_scanner_parser_1311_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_39772 = var_cas_table_des_terminaux ;
  if (_temp_39772._isBuilt ()) {
    _temp_39772 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_15, automatic_var_16, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1319)) ;
  }
...
pr_lexical_send_or_error_scanner_parser_1325_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableMessagesErreurs  _temp_40319 = var_cas_tableMessagesErreurs ;
  if (_temp_40319._isBuilt ()) {
    _temp_40319 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1335)) ;
  }
