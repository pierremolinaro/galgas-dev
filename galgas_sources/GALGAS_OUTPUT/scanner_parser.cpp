...
pr_galgas_component_scanner_parser_245_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_lexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_typeTableMessagesErreurs::cEnumerator enumerator_11432 (var_cas_table_messages, true) ;
  const GGS_typeTableMessagesErreurs::cElement * operand_11432 = NULL ;
  while (((operand_11432 = (GGS_typeTableMessagesErreurs::cElement *) enumerator_11432.nextObject ()))) {
    macroValidPointer (operand_11432) ;
    if (((var_cas_usedErrorMessageSet.reader_hasKey (_inLexique, operand_11432->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (333)))._operator_not ()).isBuiltAndTrue ()) {
      operand_11432->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "this error message is not used") COMMA_SOURCE_FILE_AT_LINE (334)) ;
    }
  }
  enumerator_11432.reset () ;
...
pr_attribute_or_terminal_symbol_declaration_scanner_parser_591_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_3 (_inLexique)) {
    case 1 : {
      ...
      const GGS_lexicalTypeMap  _temp_18467 = var_cas_inLexicalTypeMap ;
      if (_temp_18467._isBuilt ()) {
        _temp_18467 (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (603)) ;
      }
    ...
    case 2 : {
        ...
        while (syntaxRepeat_4) {
          switch (select_repeat_scanner_parser_4 (_inLexique)) {
            case 2 : {
              ...
              const GGS_typeLexicalAttributesMap  _temp_18919 = var_cas_table_des_attributs ;
              if (_temp_18919._isBuilt ()) {
                _temp_18919 (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (618)) ;
              }
      ...
      const GGS_M_styles  _temp_19372 = var_cas_ioStylesMap ;
      if (_temp_19372._isBuilt ()) {
        _temp_19372 (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (635)) ;
      }
...
pr_key_words_list_declaration_scanner_parser_646_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_scanner_parser_6 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_t ;
          const GGS_typeLexicalAttributesMap  _temp_20470 = var_cas_table_des_attributs ;
          if (_temp_20470._isBuilt ()) {
            _temp_20470 (HERE)->method_searchKey (_inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (667)) ;
          }
          var_cas_attributeList._addAssign_operation (var_cas_t, var_cas_idf) ;
          } break ;
        default :
  ...
  const GGS_M_styles  _temp_20876 = var_cas_ioStylesMap ;
  if (_temp_20876._isBuilt ()) {
    _temp_20876 (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
    ...
    while (syntaxRepeat_10) {
        ...
        switch (select_scanner_parser_11 (_inLexique)) {
          case 1 : {
            ...
            const GGS_typeTableMessagesErreurs  _temp_23337 = var_cas_table_des_messages_erreur ;
            if (_temp_23337._isBuilt ()) {
              _temp_23337 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (761)) ;
            }
...
pr_lexical_rule_scanner_parser_877_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableTablesDeMotsReserves  _temp_26743 = var_cas_table_tables_mots_reserves ;
  if (_temp_26743._isBuilt ()) {
    _temp_26743 (HERE)->method_searchKey (_inLexique, var_cas_listName, var_cas_keyWordsMap COMMA_SOURCE_FILE_AT_LINE (891)) ;
  }
    ...
    while (syntaxRepeat_14) {
      switch (select_repeat_scanner_parser_14 (_inLexique)) {
        ...
        case 7 : {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_tagIdentifier) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_tagMap  _temp_29901 = var_cas_tagMap ;
          if (_temp_29901._isBuilt ()) {
            _temp_29901 (HERE)->method_searchKey (_inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (999)) ;
          }
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_30024 = var_cas_table_des_terminaux ;
          if (_temp_30024._isBuilt ()) {
            _temp_30024 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (1003)) ;
          }
        ...
        case 8 : {
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_30400 = var_cas_table_des_terminaux ;
          if (_temp_30400._isBuilt ()) {
            _temp_30400 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1014)) ;
          }
        ...
        case 10 : {
          ...
          const GGS_typeTableMessagesErreurs  _temp_31058 = var_cas_table_des_messages_erreur ;
          if (_temp_31058._isBuilt ()) {
            _temp_31058 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1037)) ;
          }
...
pr_lexical_error_messages_list_scanner_parser_1056_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_15 = true ;
    while (syntaxRepeat_15) {
        ...
        const GGS_typeTableMessagesErreurs  _temp_31971 = var_cas_table_des_messages_erreur ;
        if (_temp_31971._isBuilt ()) {
          _temp_31971 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1066)) ;
        }
...
pr_lexical_parameter_scanner_parser_1126_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_17 (_inLexique)) {
    case 1 : {
      GGS_AC_galgasType  var_cas_t ;
      const GGS_typeLexicalAttributesMap  _temp_33765 = var_cas_table_attributs ;
      if (_temp_33765._isBuilt ()) {
        _temp_33765 (HERE)->method_searchKey (_inLexique, var_cas_nom, var_cas_t COMMA_SOURCE_FILE_AT_LINE (1134)) ;
      }
...
pr_lexical_send_instruction_scanner_parser_1220_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_36814 = var_cas_table_des_terminaux ;
  if (_temp_36814._isBuilt ()) {
    _temp_36814 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_11, automatic_var_12, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (1230)) ;
  }
...
pr_lexical_send_instruction_scanner_parser_1236_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_19 = true ;
    while (syntaxRepeat_19) {
        ...
        const GGS_typeLexicalAttributesMap  _temp_37523 = var_cas_table_attributs ;
        if (_temp_37523._isBuilt ()) {
          _temp_37523 (HERE)->method_searchKey (_inLexique, var_cas_nomAttribut, var_cas_natureAttribut COMMA_SOURCE_FILE_AT_LINE (1250)) ;
        }
        ...
        const GGS_typeTableTablesDeMotsReserves  _temp_37765 = var_cas_table_tables_mots_reserves ;
        if (_temp_37765._isBuilt ()) {
          _temp_37765 (HERE)->method_searchKey (_inLexique, var_cas_listName, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1255)) ;
        }
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
pr_lexical_send_or_error_scanner_parser_1273_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_38481 = var_cas_table_des_terminaux ;
  if (_temp_38481._isBuilt ()) {
    _temp_38481 (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_15, automatic_var_16, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1281)) ;
  }
...
pr_lexical_send_or_error_scanner_parser_1287_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableMessagesErreurs  _temp_39028 = var_cas_tableMessagesErreurs ;
  if (_temp_39028._isBuilt ()) {
    _temp_39028 (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1297)) ;
  }
