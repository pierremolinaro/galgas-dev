  ...
  switch (select_scanner_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioStylesMap._isBuilt ()) {
        var_cas_ioStylesMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_0 SOURCE_FILE_AT_LINE (548)) ;
      }
...
pr_key_words_list_declaration_scanner_parser_559_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_ioStylesMap._isBuilt ()) {
    var_cas_ioStylesMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_styleName, var_cas_styleIndex, automatic_var_1 SOURCE_FILE_AT_LINE (598)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      ...
      switch (select_repeat_scanner_parser_12 (_inLexique)) {
        ...
        case 9 : {
          ...
          if (var_cas_table_des_messages_erreur._isBuilt ()) {
            var_cas_table_des_messages_erreur (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_8 SOURCE_FILE_AT_LINE (921)) ;
          }
...
pr_lexical_error_messages_list_scanner_parser_940_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_table_des_messages_erreur._isBuilt ()) {
          var_cas_table_des_messages_erreur (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 SOURCE_FILE_AT_LINE (950)) ;
        }
...
pr_lexical_send_or_error_scanner_parser_1171_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_tableMessagesErreurs._isBuilt ()) {
    var_cas_tableMessagesErreurs (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_17 SOURCE_FILE_AT_LINE (1181)) ;
  }
