...
pr_galgas_component_scanner_parser_231_23_ (galgas_scanner & inLexique,
  ...
  var_cas_lexiqueName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("in GALGAS 1.9.0 and later, extension of lexique component file should be '.gLexique'") COMMA_SOURCE_FILE_AT_LINE (251)) ;
  ...
  ::routine_buildLexicalTypeMap (inLexique,  var_cas_lexicalTypeMap COMMA_SOURCE_FILE_AT_LINE (265)) ;
  ...
  var_cas_stylesMap.modifier_insertKey (inLexique, var_cas_defaultStringIdentifier COMMA_SOURCE_FILE_AT_LINE (270)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  {
    GGS_typeTableMessagesErreurs::cEnumerator enumerator_11069 (var_cas_table_messages, true) ;
    const GGS_typeTableMessagesErreurs::cElement * operand_11069 = NULL ;
    while (((operand_11069 = enumerator_11069.nextObject ()))) {
      macroValidPointer (operand_11069) ;
      if (((var_cas_usedErrorMessageSet.reader_hasKey (inLexique, operand_11069->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (328)) COMMA_SOURCE_FILE_AT_LINE (328))).operator_not ()).isBuiltAndTrue ()) {
        operand_11069->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("this error message is not used") COMMA_SOURCE_FILE_AT_LINE (329)) ;
      }
    }
  }
  var_cas_ioLexiqueMapForUse.modifier_insertKey (inLexique, var_cas_lexiqueName, var_cas_terminalSymbolsMapForUse COMMA_SOURCE_FILE_AT_LINE (333)) ;
  if (((var_cas_isTemplate).operator_and ((var_cas_templateDelimiterMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (335))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a template lexique should define at least one template") COMMA_SOURCE_FILE_AT_LINE (337)) ;
  }
}
...
pr_galgas_component_scanner_parser_231_23_importLexique (galgas_scanner & inLexique,
  ...
  var_cas_tokensInListMap = GGS_tokensInListMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_EXLexicalTypeMap  var_cas_lexicalTypeMap ;
  ::routine_buildLexicalTypeMap (inLexique,  var_cas_lexicalTypeMap COMMA_SOURCE_FILE_AT_LINE (358)) ;
  GGS_M_styles  var_cas_stylesMap ;
  var_cas_stylesMap = GGS_M_styles ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_lstring  var_cas_defaultStringIdentifier ;
  var_cas_defaultStringIdentifier = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
  var_cas_stylesMap.modifier_insertKey (inLexique, var_cas_defaultStringIdentifier COMMA_SOURCE_FILE_AT_LINE (362)) ;
  GGS_styleList  var_cas_styleList ;
  var_cas_styleList = GGS_styleList ::constructor_emptyList () ;
  var_cas_styleList._addAssign_operation (GGS_string (""), GGS_string ("Default style")) ;
  { bool syntaxRepeat_1 = true ;
  ...
  var_cas_ioLexiqueMapForUse.modifier_insertKey (inLexique, var_cas_lexiqueName, var_cas_terminalSymbolsMapForUse COMMA_SOURCE_FILE_AT_LINE (401)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_lexique) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
void scanner_parser::
pr_style_declaration_scanner_parser_548_24_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
        ...
        var_cas_ioStylesMap.modifier_insertKey (inLexique, var_cas_styleName COMMA_SOURCE_FILE_AT_LINE (559)) ;
        var_cas_ioStyleList._addAssign_operation (var_cas_styleName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560)), var_cas_title.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
...
void scanner_parser::
pr_style_declaration_scanner_parser_548_24_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_style) COMMA_HERE) ;
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void scanner_parser::
pr_template_declaration_scanner_parser_570_27_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_3 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      if (((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (585))).operator_isNotEqual (GGS_string ("preserved"))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'preserved' tag is allowed here") COMMA_SOURCE_FILE_AT_LINE (587)) ;
      }
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_ioTemplateDelimiterMap.modifier_insertKey (inLexique, var_cas_startString, var_cas_preservesStartDelimiter, var_cas_endString COMMA_SOURCE_FILE_AT_LINE (596)) ;
}

//---------------------------------------------------------------------------*

void scanner_parser::
pr_template_declaration_scanner_parser_570_27_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_template) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  switch (select_scanner_parser_3 (inLexique)) {
    case 1 : {
...
void scanner_parser::
pr_replace_declaration_scanner_parser_603_26_ (galgas_scanner & inLexique,
                                const GGS_bool var_cas_inIsTemplate,
  ...
  if (((var_cas_inIsTemplate).operator_not ()).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the lexique should be declared as template lexique") COMMA_SOURCE_FILE_AT_LINE (611)) ;
  }
  GGS_lstring  var_cas_startString ;
  inLexique.assignFromAttribute_tokenString (var_cas_startString) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  switch (select_scanner_parser_4 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      var_cas_ioTemplateReplacementMap.modifier_insertKey (inLexique, var_cas_startString, var_cas_endString, var_cas_replacementFunction COMMA_SOURCE_FILE_AT_LINE (618)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
      GGS_lstring  var_cas_endString ;
      inLexique.assignFromAttribute_tokenString (var_cas_endString) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
      var_cas_ioTemplateReplacementMap.modifier_insertKey (inLexique, var_cas_startString, var_cas_endString, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (622)) ;
      } break ;
    default :
      break ;
  }
...
void scanner_parser::
pr_replace_declaration_scanner_parser_603_26_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_replace) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  switch (select_scanner_parser_4 (inLexique)) {
    case 1 : {
...
void scanner_parser::
pr_attribute_or_terminal_symbol_declaration_scanner_parser_631_47_ (galgas_scanner & inLexique,
                                GGS_typeTableDefinitionTerminaux  &var_cas_table_des_terminaux,
  ...
  switch (select_scanner_parser_5 (inLexique)) {
    case 1 : {
      ...
      const GGS_EXLexicalTypeMap  temp_19495 = var_cas_inLexicalTypeMap ;
      if (temp_19495.isBuilt ()) {
        temp_19495 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (644)) ;
      }
      GGS_lstring  var_cas_attributeName ;
      inLexique.assignFromAttribute_tokenString (var_cas_attributeName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      var_cas_table_des_attributs.modifier_insertKey (inLexique, var_cas_attributeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (647)) ;
      } break ;
    case 2 : {
        ...
        while (syntaxRepeat_6) {
          switch (select_repeat_scanner_parser_6 (inLexique)) {
            case 2 : {
              ...
              const GGS_typeLexicalAttributesMap  temp_19947 = var_cas_table_des_attributs ;
              if (temp_19947.isBuilt ()) {
                temp_19947 (HERE)->method_searchKey (inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (659)) ;
              }
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
      var_cas_ioTerminalSymbolsMapForUse.modifier_insertKey (inLexique, var_cas_nomTerminal, var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (666)) ;
      GGS_lstring  var_cas_styleName ;
      ...
      const GGS_M_styles  temp_20405 = var_cas_ioStylesMap ;
      if (temp_20405.isBuilt ()) {
        temp_20405 (HERE)->method_searchKeyGetID (inLexique, var_cas_styleName, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (676)) ;
      }
      GGS_string var_cas_errorMessageString ;
      var_cas_errorMessageString = var_cas_errorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (677)) ;
      ...
      switch (select_scanner_parser_8 (inLexique)) {
        ...
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_feature) COMMA_HERE) ;
          if (((var_cas_inIsTemplate).operator_not ()).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for using this construct, the lexique should have been declared as a template lexique") COMMA_SOURCE_FILE_AT_LINE (685)) ;
          }
          GGS_lstring  var_cas_mark ;
          inLexique.assignFromAttribute_tokenString (var_cas_mark) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (((var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (687))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
            var_cas_mark.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only 'templateEndMark' is allowed here") COMMA_SOURCE_FILE_AT_LINE (689)) ;
          }
      ...
      var_cas_table_des_terminaux.modifier_insertKey (inLexique, var_cas_nomTerminal, var_cas_errorMessageString, var_cas_attributeList, var_cas_styleIndex, var_cas_isTemplateEndMark COMMA_SOURCE_FILE_AT_LINE (692)) ;
      } break ;
    default :
      break ;
  }
...
void scanner_parser::
pr_attribute_or_terminal_symbol_declaration_scanner_parser_631_47_parse (galgas_scanner & inLexique) {
  switch (select_scanner_parser_5 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void scanner_parser::
pr_key_words_list_declaration_scanner_parser_701_33_ (galgas_scanner & inLexique,
                                GGS_typeTableTablesDeMotsReserves  &var_cas_table_tables_mots_reserves,
                                GGS_typeLexicalAttributesMap  &var_cas_table_des_attributs,
                                GGS_typeTableDefinitionTerminaux  &var_cas_table_des_terminaux,
                                GGS_M_terminalSymbolsMapForUse  &var_cas_ioTerminalSymbolsMapForUse,
    ...
    while (syntaxRepeat_9) {
      switch (select_repeat_scanner_parser_9 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_t ;
          const GGS_typeLexicalAttributesMap  temp_22034 = var_cas_table_des_attributs ;
          if (temp_22034.isBuilt ()) {
            temp_22034 (HERE)->method_searchKey (inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (723)) ;
          }
          var_cas_attributeList._addAssign_operation (var_cas_t, var_cas_idf) ;
          } break ;
        default :
  ...
  if (var_cas_errorMessage.isBuilt ()) {
    ::routine_check_K_escapeCharacters (inLexique,  var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (731)) ;
  }
  GGS_lstring  var_cas_styleName ;
  ...
  GGS_luint  var_cas_styleIndex ;
  const GGS_M_styles  temp_22445 = var_cas_ioStylesMap ;
  if (temp_22445.isBuilt ()) {
    temp_22445 (HERE)->method_searchKeyGetID (inLexique, var_cas_styleName, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (741)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
    ...
    while (syntaxRepeat_11) {
        ...
        switch (select_scanner_parser_13 (inLexique)) {
          ...
          case 2 : {
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_feature) COMMA_HERE) ;
            if (((var_cas_inIsTemplate).operator_not ()).isBuiltAndTrue ()) {
              GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for using this construct, the lexique should have been declared as a template lexique") COMMA_SOURCE_FILE_AT_LINE (763)) ;
            }
            GGS_lstring  var_cas_mark ;
            inLexique.assignFromAttribute_tokenString (var_cas_mark) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            if (((var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (765))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
              var_cas_mark.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only 'templateEndMark' is allowed here") COMMA_SOURCE_FILE_AT_LINE (767)) ;
            }
            var_cas_isTemplateEndMark = GGS_bool (true) ;
            } break ;
          default :
        ...
        var_cas_ioTokensInListMap.modifier_insertKey (inLexique, var_cas_listEntry, var_cas_terminalSymbolName COMMA_SOURCE_FILE_AT_LINE (771)) ;
        GGS_string var_cas_specificErrorMessageString ;
        var_cas_specificErrorMessageString = var_cas_errorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (773)).reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), var_cas_terminalSymbolName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (773)) COMMA_SOURCE_FILE_AT_LINE (773)) ;
        var_cas_table_des_terminaux.modifier_insertKey (inLexique, var_cas_terminalSymbolName, var_cas_specificErrorMessageString, var_cas_attributeList, var_cas_styleIndex, var_cas_isTemplateEndMark COMMA_SOURCE_FILE_AT_LINE (775)) ;
        var_cas_ioTerminalSymbolsMapForUse.modifier_insertKey (inLexique, var_cas_terminalSymbolName, var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (782)) ;
        var_cas_entriesMap.modifier_insertKey (inLexique, var_cas_listEntry, var_cas_terminalSymbolName COMMA_SOURCE_FILE_AT_LINE (784)) ;
  ...
  var_cas_table_tables_mots_reserves.modifier_insertKey (inLexique, var_cas_listName, var_cas_entriesMap COMMA_SOURCE_FILE_AT_LINE (788)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
void scanner_parser::
pr_key_words_list_declaration_scanner_parser_701_33_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_list) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  { bool syntaxRepeat_9 = true ;
    while (syntaxRepeat_9) {
...
void scanner_parser::
pr_lexical_error_message_declaration_scanner_parser_796_40_ (galgas_scanner & inLexique,
                                GGS_typeTableMessagesErreurs  &var_cas_table_messages) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_errorMessage) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  var_cas_table_messages.modifier_insertKey (inLexique, var_cas_nom, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (805)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
void scanner_parser::
pr_lexical_error_message_declaration_scanner_parser_796_40_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void scanner_parser::
pr_while_branches_list_scanner_parser_811_26_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_14) {
        switch (select_scanner_parser_15 (inLexique)) {
          case 1 : {
            ...
            const GGS_typeTableMessagesErreurs  temp_25467 = var_cas_table_des_messages_erreur ;
            if (temp_25467.isBuilt ()) {
              temp_25467 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (837)) ;
            }
            var_cas_ioUsedErrorMessageSet._addAssign_operation (var_cas_errorMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (838))) ;
...
void scanner_parser::
pr_while_branches_list_scanner_parser_811_26_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
        switch (select_scanner_parser_15 (inLexique)) {
          case 1 : {
...
void scanner_parser::
pr_lexical_test_expression_scanner_parser_877_30_ (galgas_scanner & inLexique,
...
void scanner_parser::
pr_lexical_test_expression_scanner_parser_877_30_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_17 = true ;
    while (syntaxRepeat_17) {
...
pr_lexical_test_term_scanner_parser_892_24_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_availableCharSet.reader_hasKey (inLexique, var_cas_unicodeCharSetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (908)) COMMA_SOURCE_FILE_AT_LINE (908))).operator_not ()).isBuiltAndTrue ()) {
    var_cas_unicodeCharSetName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unknown Unicode character set") COMMA_SOURCE_FILE_AT_LINE (910)) ;
  }
}
...
void scanner_parser::
pr_lexical_test_term_scanner_parser_915_24_ (galgas_scanner & inLexique,
                                GGS_typeConditionLexicale  &var_cas_tt) {
  GGS_lstring  var_cas_ch ;
  inLexique.assignFromAttribute_tokenString (var_cas_ch) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void scanner_parser::
pr_lexical_test_term_scanner_parser_915_24_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
}
...
void scanner_parser::
pr_lexical_test_term_scanner_parser_925_24_ (galgas_scanner & inLexique,
                                GGS_typeConditionLexicale  &var_cas_tt) {
  GGS_lchar  var_cas_c ;
...
void scanner_parser::
pr_lexical_test_term_scanner_parser_925_24_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_char) COMMA_HERE) ;
  switch (select_scanner_parser_18 (inLexique)) {
    case 1 : {
      } break ;
...
void scanner_parser::
pr_lexical_rule_scanner_parser_942_19_ (galgas_scanner & inLexique,
...
void scanner_parser::
pr_lexical_rule_scanner_parser_942_19_parse (galgas_scanner & inLexique) {
  nt_lexical_test_expression_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
  nt_lexical_instructions_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
...
void scanner_parser::
pr_lexical_rule_scanner_parser_971_19_ (galgas_scanner & inLexique,
                                GGS_typeListeTestsEtInstructions  &var_cas_ioLexicalRulesList,
                                GGS_typeTableDefinitionTerminaux  &/* var_cas_table_des_terminaux */,
                                GGS_typeTableMessagesErreurs  &/* var_cas_table_des_messages_erreur */,
                                GGS_typeLexicalAttributesMap  &/* var_cas_table_attributs */,
  ...
  const GGS_typeTableTablesDeMotsReserves  temp_29745 = var_cas_table_tables_mots_reserves ;
  if (temp_29745.isBuilt ()) {
    temp_29745 (HERE)->method_searchKey (inLexique, var_cas_listName, var_cas_keyWordsMap COMMA_SOURCE_FILE_AT_LINE (985)) ;
  }
  if (var_cas_keyWordsMap.isBuilt () &&
      var_cas_ioLexicalRulesList.isBuilt ()) {
    ::routine_buildLexicalRulesFromList (inLexique,  var_cas_keyWordsMap,  var_cas_ioLexicalRulesList COMMA_SOURCE_FILE_AT_LINE (987)) ;
  }
}
...
void scanner_parser::
pr_lexical_rule_scanner_parser_971_19_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_list) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void scanner_parser::
pr_lexical_instructions_list_scanner_parser_992_32_ (galgas_scanner & inLexique,
                                GGS_tListeInstructionsLexicales  &var_cas_li,
                                GGS_typeTableDefinitionTerminaux  &var_cas_table_des_terminaux,
                                GGS_typeTableMessagesErreurs  &var_cas_table_des_messages_erreur,
                                GGS_typeLexicalAttributesMap  &var_cas_table_attributs,
    ...
    while (syntaxRepeat_19) {
      switch (select_repeat_scanner_parser_19 (inLexique)) {
        ...
        case 5 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          var_cas_tagMap.modifier_insertKey (inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (1079)) ;
        ...
        case 7 : {
          ...
          if (((var_cas_inCanSendTerminal).operator_not ()).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the rewind instruction cannot be used within a repeat instruction") COMMA_SOURCE_FILE_AT_LINE (1090)) ;
          }
          GGS_lstring  var_cas_tagIdentifier ;
          inLexique.assignFromAttribute_tokenString (var_cas_tagIdentifier) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_tagMap  temp_32903 = var_cas_tagMap ;
          if (temp_32903.isBuilt ()) {
            temp_32903 (HERE)->method_searchKey (inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (1093)) ;
          }
          ...
          const GGS_typeTableDefinitionTerminaux  temp_33026 = var_cas_table_des_terminaux ;
          if (temp_33026.isBuilt ()) {
            temp_33026 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (1097)) ;
          }
        ...
        case 8 : {
          ...
          if (((var_cas_inCanSendTerminal).operator_not ()).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the drop instruction cannot be used within a repeat instruction") COMMA_SOURCE_FILE_AT_LINE (1104)) ;
          }
          GGS_lstring  var_cas_nomTerminal ;
          inLexique.assignFromAttribute_tokenString (var_cas_nomTerminal) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
          ...
          const GGS_typeTableDefinitionTerminaux  temp_33405 = var_cas_table_des_terminaux ;
          if (temp_33405.isBuilt ()) {
            temp_33405 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1108)) ;
          }
        ...
        case 9 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_send) COMMA_HERE) ;
          if (((var_cas_inCanSendTerminal).operator_not ()).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the send instruction cannot be used within a repeat instruction") COMMA_SOURCE_FILE_AT_LINE (1114)) ;
          }
          GGS_typeInstructionLexicale  var_cas_e ;
        ...
        case 10 : {
          ...
          const GGS_typeTableMessagesErreurs  temp_34071 = var_cas_table_des_messages_erreur ;
          if (temp_34071.isBuilt ()) {
            temp_34071 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1131)) ;
          }
          var_cas_ioUsedErrorMessageSet._addAssign_operation (var_cas_errorMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1132))) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
          GGS_typeInstructionLexicale  var_cas_e ;
        ...
        case 11 : {
          ...
          const GGS_typeTableMessagesErreurs  temp_34459 = var_cas_table_des_messages_erreur ;
          if (temp_34459.isBuilt ()) {
            temp_34459 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1141)) ;
          }
          var_cas_ioUsedErrorMessageSet._addAssign_operation (var_cas_errorMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1142))) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
          GGS_typeInstructionLexicale  var_cas_e ;
...
void scanner_parser::
pr_lexical_instructions_list_scanner_parser_992_32_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_19 = true ;
    while (syntaxRepeat_19) {
      switch (select_repeat_scanner_parser_19 (inLexique)) {
        case 2 : {
...
void scanner_parser::
pr_lexical_error_messages_list_scanner_parser_1151_34_ (galgas_scanner & /* inLexique */,
                                GGS_typeListeMessagesErreur  &/* var_cas_lme */,
                                GGS_typeTableMessagesErreurs  &/* var_cas_table_des_messages_erreur */,
                                GGS_stringset  &/* var_cas_ioUsedErrorMessageSet */) {
}
...
void scanner_parser::
pr_lexical_error_messages_list_scanner_parser_1151_34_parse (galgas_scanner & /* inLexique */) {
}
...
void scanner_parser::
pr_lexical_error_messages_list_scanner_parser_1160_34_ (galgas_scanner & inLexique,
                                GGS_typeListeMessagesErreur  &var_cas_lme,
                                GGS_typeTableMessagesErreurs  &var_cas_table_des_messages_erreur,
                                GGS_stringset  &var_cas_ioUsedErrorMessageSet) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_error) COMMA_HERE) ;
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
        ...
        const GGS_typeTableMessagesErreurs  temp_35372 = var_cas_table_des_messages_erreur ;
        if (temp_35372.isBuilt ()) {
          temp_35372 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (1170)) ;
        }
        var_cas_lme._addAssign_operation (var_cas_errorMessageIndex) ;
        var_cas_ioUsedErrorMessageSet._addAssign_operation (var_cas_errorMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1172))) ;
...
void scanner_parser::
pr_lexical_error_messages_list_scanner_parser_1160_34_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_error) COMMA_HERE) ;
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void scanner_parser::
pr_lexical_parameters_non_empty_list_scanner_parser_1180_40_ (galgas_scanner & inLexique,
...
void scanner_parser::
pr_lexical_parameters_non_empty_list_scanner_parser_1180_40_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_21 = true ;
    while (syntaxRepeat_21) {
      switch (select_repeat_scanner_parser_21 (inLexique)) {
        case 2 : {
...
void scanner_parser::
pr_lexical_parameter_scanner_parser_1200_24_ (galgas_scanner & inLexique,
                                GGS_typeArgumentRoutineExterne  &var_cas_a,
                                GGS_typeLexicalAttributesMap  &/* var_cas_table_attributs */) {
...
void scanner_parser::
pr_lexical_parameter_scanner_parser_1200_24_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
}
...
void scanner_parser::
pr_lexical_parameter_scanner_parser_1210_24_ (galgas_scanner & inLexique,
                                GGS_typeArgumentRoutineExterne  &var_cas_a,
                                GGS_typeLexicalAttributesMap  &/* var_cas_table_attributs */) {
  GGS_lchar  var_cas_c ;
  inLexique.assignFromAttribute_charValue (var_cas_c) ;
...
void scanner_parser::
pr_lexical_parameter_scanner_parser_1210_24_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_char) COMMA_HERE) ;
}
...
void scanner_parser::
pr_lexical_parameter_scanner_parser_1221_24_ (galgas_scanner & inLexique,
                                GGS_typeArgumentRoutineExterne  &var_cas_a,
                                GGS_typeLexicalAttributesMap  &/* var_cas_table_attributs */) {
  GGS_luint  var_cas_n ;
...
void scanner_parser::
pr_lexical_parameter_scanner_parser_1221_24_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
}
...
pr_lexical_parameter_scanner_parser_1232_24_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_23 (inLexique)) {
    case 1 : {
      GGS_AC_galgasType  var_cas_t ;
      const GGS_typeLexicalAttributesMap  temp_37195 = var_cas_table_attributs ;
      if (temp_37195.isBuilt ()) {
        temp_37195 (HERE)->method_searchKey (inLexique, var_cas_nom, var_cas_t COMMA_SOURCE_FILE_AT_LINE (1240)) ;
      }
...
void scanner_parser::
pr_lexical_when_branches_list_scanner_parser_1253_33_ (galgas_scanner & inLexique,
...
void scanner_parser::
pr_lexical_when_branches_list_scanner_parser_1253_33_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_when) COMMA_HERE) ;
  { bool syntaxRepeat_24 = true ;
    while (syntaxRepeat_24) {
        nt_lexical_test_expression_parse (inLexique) ;
...
void scanner_parser::
pr_lexical_default_branch_scanner_parser_1288_29_ (galgas_scanner & /* inLexique */,
                                GGS_tListeInstructionsLexicales  &var_cas_liste_instructions_sinon,
                                GGS_typeTableDefinitionTerminaux  &/* var_cas_table_des_terminaux */,
                                GGS_typeTableMessagesErreurs  &/* var_cas_table_des_messages_erreur */,
                                GGS_typeLexicalAttributesMap  &/* var_cas_table_attributs */,
...
void scanner_parser::
pr_lexical_default_branch_scanner_parser_1288_29_parse (galgas_scanner & /* inLexique */) {
}
...
void scanner_parser::
pr_lexical_default_branch_scanner_parser_1303_29_ (galgas_scanner & inLexique,
                                GGS_tListeInstructionsLexicales  &var_cas_liste_instructions_sinon,
                                GGS_typeTableDefinitionTerminaux  &var_cas_table_des_terminaux,
                                GGS_typeTableMessagesErreurs  &var_cas_table_des_messages_erreur,
                                GGS_typeLexicalAttributesMap  &var_cas_table_attributs,
...
void scanner_parser::
pr_lexical_default_branch_scanner_parser_1303_29_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
  nt_lexical_instructions_list_parse (inLexique) ;
}
...
void scanner_parser::
pr_lexical_send_instruction_scanner_parser_1328_31_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  temp_40264 = var_cas_table_des_terminaux ;
  if (temp_40264.isBuilt ()) {
    temp_40264 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }
...
void scanner_parser::
pr_lexical_send_instruction_scanner_parser_1328_31_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
}
...
pr_lexical_send_instruction_scanner_parser_1344_31_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        const GGS_typeLexicalAttributesMap  temp_40976 = var_cas_table_attributs ;
        if (temp_40976.isBuilt ()) {
          temp_40976 (HERE)->method_searchKey (inLexique, var_cas_nomAttribut, var_cas_natureAttribut COMMA_SOURCE_FILE_AT_LINE (1358)) ;
        }
        GGS_typeGalgas_lstring  var_cas_lgs ;
        var_cas_lgs = GGS_typeGalgas_lstring::castFrom (inLexique, var_cas_natureAttribut.getPtr (), true, var_cas_nomAttribut COMMA_SOURCE_FILE_AT_LINE (1359)) ;
        ...
        const GGS_typeTableTablesDeMotsReserves  temp_41218 = var_cas_table_tables_mots_reserves ;
        if (temp_41218.isBuilt ()) {
          temp_41218 (HERE)->method_searchKey (inLexique, var_cas_listName, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1363)) ;
        }
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
void scanner_parser::
pr_lexical_send_or_error_scanner_parser_1381_28_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  temp_41934 = var_cas_table_des_terminaux ;
  if (temp_41934.isBuilt ()) {
    temp_41934 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (1389)) ;
  }
...
void scanner_parser::
pr_lexical_send_or_error_scanner_parser_1381_28_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
}
...
void scanner_parser::
pr_lexical_send_or_error_scanner_parser_1395_28_ (galgas_scanner & inLexique,
                                GGS_typeEmissionParDefaut  &var_cas_emissionParDefaut,
                                GGS_typeTableMessagesErreurs  &var_cas_tableMessagesErreurs,
                                GGS_typeTableDefinitionTerminaux  &/* var_cas_table_des_terminaux */,
                                GGS_stringset  &var_cas_ioUsedErrorMessageSet) {
  ...
  const GGS_typeTableMessagesErreurs  temp_42489 = var_cas_tableMessagesErreurs ;
  if (temp_42489.isBuilt ()) {
    temp_42489 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_21 COMMA_SOURCE_FILE_AT_LINE (1405)) ;
  }
  var_cas_ioUsedErrorMessageSet._addAssign_operation (var_cas_errorMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1406))) ;
...
void scanner_parser::
pr_lexical_send_or_error_scanner_parser_1395_28_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_error) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void scanner_parser::
pr_extern_routine_or_function_declaration_scanner_parser_1412_45_ (galgas_scanner & inLexique) {
