...
pr_galgas_component_scanner_parser_233_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_lexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  const GGS_typeTableMessagesErreurs _var_10779 = var_cas_table_messages ;
  GGS_typeTableMessagesErreurs::element_type * operand_10779 = _var_10779.firstObject () ;
  while ((operand_10779 != NULL)) {
    macroValidPointer (operand_10779) ;
    if (((var_cas_usedErrorMessageSet.reader_hasKey (_inLexique, operand_10779->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307)))._operator_not ()).isBuiltAndTrue ()) {
      operand_10779->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "this error message is not used") COMMA_SOURCE_FILE_AT_LINE (308)) ;
    }
    operand_10779 = operand_10779->nextObject () ;
  }
...
pr_lexical_send_instruction_scanner_parser_1149_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_lgs = GGS_typeGalgas_lstring::_castFrom (_inLexique, var_cas_natureAttribut.getPtr (), true, var_cas_nomAttribut COMMA_SOURCE_FILE_AT_LINE (1164)) ;
        ...
        if (var_cas_table_tables_mots_reserves._isBuilt ()) {
          var_cas_table_tables_mots_reserves (HERE)->method_searchKey (_inLexique, var_cas_listName, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1169)) ;
        }
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
void scanner_parser::
scanner_parser::
pr_lexical_send_or_error_scanner_parser_1187_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_table_des_terminaux._isBuilt ()) {
    var_cas_table_des_terminaux (HERE)->method_searchKey (_inLexique, var_cas_nomTerminal, automatic_var_15, automatic_var_16, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1195)) ;
  }
...
void scanner_parser::
pr_lexical_send_or_error_scanner_parser_1187_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
}
...
void scanner_parser::
scanner_parser::
pr_lexical_send_or_error_scanner_parser_1201_6_ (galgas_scanner & _inLexique,
                                GGS_typeEmissionParDefaut  &var_cas_emissionParDefaut,
                                GGS_typeTableMessagesErreurs  &var_cas_tableMessagesErreurs,
                                GGS_typeTableDefinitionTerminaux  &/* var_cas_table_des_terminaux */,
                                GGS_stringset  &var_cas_ioUsedErrorMessageSet) {
  ...
  if (var_cas_tableMessagesErreurs._isBuilt ()) {
    var_cas_tableMessagesErreurs (HERE)->method_searchKeyGetID (_inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1211)) ;
  }
  var_cas_ioUsedErrorMessageSet._addAssign_operation (var_cas_errorMessageName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1212))) ;
...
void scanner_parser::
pr_lexical_send_or_error_scanner_parser_1201_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_error) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
