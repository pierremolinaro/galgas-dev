...
pr_template_declaration_scanner_parser_501_27_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_3 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      if (((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (516))).operator_isNotEqual (GGS_string ("preserved"))).isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      switch (select_scanner_parser_8 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (((var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (618))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat_11) {
        ...
        switch (select_scanner_parser_13 (inLexique)) {
          ...
          case 2 : {
            ...
            inLexique.assignFromAttribute_tokenString (var_cas_mark) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            if (((var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (696))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
...
pr_lexical_test_term_scanner_parser_823_24_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_availableCharSet.reader_hasKey (inLexique, var_cas_unicodeCharSetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839))).operator_not ()).isBuiltAndTrue ()) {
