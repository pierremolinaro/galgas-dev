...
pr_galgas_component_scanner_parser_233_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_10782 != NULL)) {
    ...
    if (((var_cas_usedErrorMessageSet.reader_hasKey (_inLexique, operand_10782->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (307))).isBuiltAndTrue ()) {
  ...
  if (var_cas_lexiqueName._isBuilt (HERE) &&
      var_cas_table_attributs._isBuilt (HERE) &&
      var_cas_table_des_terminaux._isBuilt (HERE) &&
      var_cas_table_tables_mots_reserves._isBuilt (HERE) &&
      var_cas_lexicalRulesList._isBuilt (HERE) &&
      var_cas_table_messages._isBuilt (HERE) &&
      var_cas_stylesMap._isBuilt (HERE) &&
      var_cas_usedErrorMessageSet._isBuilt (HERE) &&
      var_cas_tokensInListMap._isBuilt (HERE)) {
...
pr_attribute_or_terminal_symbol_declaration_scanner_parser_504_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_2 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_inLexicalTypeMap._isBuilt (HERE)) {
    ...
    case 2 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_scanner_parser_3 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_table_des_attributs._isBuilt (HERE)) {
      ...
      if (var_cas_ioStylesMap._isBuilt (HERE)) {
...
pr_lexical_rule_scanner_parser_765_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_table_tables_mots_reserves._isBuilt (HERE)) {
  ...
  if (var_cas_keyWordsMap._isBuilt (HERE) &&
      var_cas_ioLexicalRulesList._isBuilt (HERE)) {
    ...
    while (syntaxRepeat) {
      switch (select_repeat_scanner_parser_12 (_inLexique)) {
        ...
        case 6 : {
          ...
          if (((var_cas_inCanSendTerminal)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (878))).isBuiltAndTrue ()) {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_tagIdentifier) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (var_cas_tagMap._isBuilt (HERE)) {
          ...
          if (var_cas_table_des_terminaux._isBuilt (HERE)) {
        ...
        case 7 : {
          ...
          if (((var_cas_inCanSendTerminal)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (892))).isBuiltAndTrue ()) {
        ...
        case 8 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_send) COMMA_HERE) ;
          if (((var_cas_inCanSendTerminal)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (902))).isBuiltAndTrue ()) {
        ...
        case 9 : {
          ...
          if (var_cas_table_des_messages_erreur._isBuilt (HERE)) {
...
pr_lexical_parameter_scanner_parser_1010_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_scanner_parser_15 (_inLexique)) {
    case 1 : {
      GGS_AC_galgasType  var_cas_t ;
      if (var_cas_table_attributs._isBuilt (HERE)) {
...
pr_lexical_send_or_error_scanner_parser_1171_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_tableMessagesErreurs._isBuilt (HERE)) {
