        ...
        switch (select_scanner_parser_15 (inLexique)) {
          case 1 : {
            ...
            if (temp_23143.isBuilt ()) {
              temp_23143 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (768)) ;
            }
...
pr_lexical_test_term_scanner_parser_823_24_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_25389 = (var_cas_availableCharSet.reader_hasKey (inLexique, var_cas_unicodeCharSetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839))).operator_not () ;
      ...
      switch (select_scanner_parser_19 (inLexique)) {
        ...
        case 7 : {
          ...
          if (temp_30710.isBuilt ()) {
            temp_30710 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (1028)) ;
          }
        ...
        case 8 : {
          ...
          if (temp_31089.isBuilt ()) {
            temp_31089 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1039)) ;
          }
        ...
        case 10 : {
          ...
          if (temp_31755.isBuilt ()) {
            temp_31755 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1062)) ;
          }
        ...
        case 11 : {
          ...
          if (temp_32143.isBuilt ()) {
            temp_32143 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1072)) ;
          }
  ...
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
        ...
        if (temp_33056.isBuilt ()) {
          temp_33056 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (1101)) ;
        }
...
pr_lexical_send_instruction_scanner_parser_1259_31_ (galgas_scanner & inLexique,
  ...
  if (temp_37948.isBuilt ()) {
    temp_37948 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1269)) ;
  }
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        if (temp_38902.isBuilt ()) {
          temp_38902 (HERE)->method_searchKey (inLexique, var_cas_listName, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1294)) ;
        }
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
pr_lexical_send_or_error_scanner_parser_1312_28_ (galgas_scanner & inLexique,
  ...
  if (temp_39618.isBuilt ()) {
    temp_39618 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (1320)) ;
  }
...
pr_lexical_send_or_error_scanner_parser_1326_28_ (galgas_scanner & inLexique,
  ...
  if (temp_40173.isBuilt ()) {
    temp_40173 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_21 COMMA_SOURCE_FILE_AT_LINE (1336)) ;
  }
