...
pr_galgas_component_scanner_parser_233_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_lexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  const GGS_typeTableMessagesErreurs _var_10794 = var_cas_table_messages ;
  const GGS_typeTableMessagesErreurs::element_type * operand_10794 = _var_10794.firstObject () ;
