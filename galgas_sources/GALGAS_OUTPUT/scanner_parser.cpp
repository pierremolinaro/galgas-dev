...
pr_galgas_component_scanner_parser_233_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_lexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_typeTableMessagesErreurs::element_type * operand_10794 = var_cas_table_messages.firstObject () ;
  while ((operand_10794 != NULL)) {
    macroValidPointer (operand_10794) ;
    if (((var_cas_usedErrorMessageSet.reader_hasKey (_inLexique, operand_10794->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307)))._operator_not ()).isBuiltAndTrue ()) {
      operand_10794->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "this error message is not used") COMMA_SOURCE_FILE_AT_LINE (308)) ;
    }
    operand_10794 = operand_10794->nextObject () ;
  }
