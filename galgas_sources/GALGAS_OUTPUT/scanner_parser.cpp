...
void routine_buildLexicalTypeMap (C_Compiler & inLexique,
  ...
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_lstring ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (223)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_lchar ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_luint ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (227)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_lsint ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (229)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint64"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_luint64 ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (231)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint64"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_lsint64 ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (233)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lbool"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_lbool ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (235)) ;
  var_cas_outLexicalTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("ldouble"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgas_ldouble ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (237)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
pr_galgas_component_scanner_parser_244_23_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_lexiqueName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS 1.7.5 and later checks "
      "the component name ('"))._operator_concat (var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266))))._operator_concat (GGS_string ("') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (268)) ;
  }
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  {
    ...
    while (((operand_11767 = enumerator_11767.nextObject ()))) {
      ...
      if (((var_cas_usedErrorMessageSet.reader_hasKey (inLexique, operand_11767->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (345)) COMMA_SOURCE_FILE_AT_LINE (345)))._operator_not ()).isBuiltAndTrue ()) {
  ...
  if (((var_cas_isTemplate)._operator_and ((var_cas_templateDelimiterMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (352)))._operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
...
pr_template_declaration_scanner_parser_592_27_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_3 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      if (((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (607)))._operator_isNotEqual (GGS_string ("preserved"))).isBuiltAndTrue ()) {
...
pr_attribute_or_terminal_symbol_declaration_scanner_parser_653_47_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_5 (inLexique)) {
    case 1 : {
      ...
      const GGS_lexicalTypeMap  _temp_20223 = var_cas_inLexicalTypeMap ;
      if (_temp_20223.isBuilt ()) {
        _temp_20223 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_attributeType COMMA_SOURCE_FILE_AT_LINE (666)) ;
      }
    ...
    case 2 : {
        ...
        while (syntaxRepeat_6) {
          switch (select_repeat_scanner_parser_6 (inLexique)) {
            case 2 : {
              ...
              const GGS_typeLexicalAttributesMap  _temp_20675 = var_cas_table_des_attributs ;
              if (_temp_20675.isBuilt ()) {
                _temp_20675 (HERE)->method_searchKey (inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (681)) ;
              }
      ...
      const GGS_M_styles  _temp_21133 = var_cas_ioStylesMap ;
      if (_temp_21133.isBuilt ()) {
        _temp_21133 (HERE)->method_searchKeyGetID (inLexique, var_cas_styleName, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (698)) ;
      }
      ...
      switch (select_scanner_parser_8 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (((var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (709)))._operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
...
pr_key_words_list_declaration_scanner_parser_723_33_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_9) {
      switch (select_repeat_scanner_parser_9 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_t ;
          const GGS_typeLexicalAttributesMap  _temp_22762 = var_cas_table_des_attributs ;
          if (_temp_22762.isBuilt ()) {
            _temp_22762 (HERE)->method_searchKey (inLexique, var_cas_idf, var_cas_t COMMA_SOURCE_FILE_AT_LINE (745)) ;
          }
          var_cas_attributeList._addAssign_operation (var_cas_t, var_cas_idf) ;
          } break ;
        default :
  ...
  GGS_luint  var_cas_styleIndex ;
  const GGS_M_styles  _temp_23173 = var_cas_ioStylesMap ;
  if (_temp_23173.isBuilt ()) {
    _temp_23173 (HERE)->method_searchKeyGetID (inLexique, var_cas_styleName, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (763)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
    ...
    while (syntaxRepeat_11) {
        ...
        switch (select_scanner_parser_13 (inLexique)) {
          ...
          case 2 : {
            ...
            inLexique._assignFromAttribute_tokenString (var_cas_mark) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            if (((var_cas_mark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (787)))._operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat_14) {
        switch (select_scanner_parser_15 (inLexique)) {
          case 1 : {
            ...
            const GGS_typeTableMessagesErreurs  _temp_26195 = var_cas_table_des_messages_erreur ;
            if (_temp_26195.isBuilt ()) {
              _temp_26195 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (859)) ;
            }
...
pr_lexical_test_term_scanner_parser_914_24_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_availableCharSet.reader_hasKey (inLexique, var_cas_unicodeCharSetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (930)) COMMA_SOURCE_FILE_AT_LINE (930)))._operator_not ()).isBuiltAndTrue ()) {
...
pr_lexical_rule_scanner_parser_993_19_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableTablesDeMotsReserves  _temp_30473 = var_cas_table_tables_mots_reserves ;
  if (_temp_30473.isBuilt ()) {
    _temp_30473 (HERE)->method_searchKey (inLexique, var_cas_listName, var_cas_keyWordsMap COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  }
    ...
    while (syntaxRepeat_19) {
      switch (select_repeat_scanner_parser_19 (inLexique)) {
        ...
        case 7 : {
          ...
          inLexique._assignFromAttribute_tokenString (var_cas_tagIdentifier) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_tagMap  _temp_33631 = var_cas_tagMap ;
          if (_temp_33631.isBuilt ()) {
            _temp_33631 (HERE)->method_searchKey (inLexique, var_cas_tagIdentifier COMMA_SOURCE_FILE_AT_LINE (1115)) ;
          }
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_33754 = var_cas_table_des_terminaux ;
          if (_temp_33754.isBuilt ()) {
            _temp_33754 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (1119)) ;
          }
        ...
        case 8 : {
          ...
          const GGS_typeTableDefinitionTerminaux  _temp_34133 = var_cas_table_des_terminaux ;
          if (_temp_34133.isBuilt ()) {
            _temp_34133 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1130)) ;
          }
        ...
        case 10 : {
          ...
          const GGS_typeTableMessagesErreurs  _temp_34799 = var_cas_table_des_messages_erreur ;
          if (_temp_34799.isBuilt ()) {
            _temp_34799 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1153)) ;
          }
        ...
        case 11 : {
          ...
          const GGS_typeTableMessagesErreurs  _temp_35187 = var_cas_table_des_messages_erreur ;
          if (_temp_35187.isBuilt ()) {
            _temp_35187 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1163)) ;
          }
...
pr_lexical_error_messages_list_scanner_parser_1182_34_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
        ...
        const GGS_typeTableMessagesErreurs  _temp_36100 = var_cas_table_des_messages_erreur ;
        if (_temp_36100.isBuilt ()) {
          _temp_36100 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (1192)) ;
        }
...
pr_lexical_parameter_scanner_parser_1254_24_ (galgas_scanner & inLexique,
  ...
  switch (select_scanner_parser_23 (inLexique)) {
    case 1 : {
      GGS_AC_galgasType  var_cas_t ;
      const GGS_typeLexicalAttributesMap  _temp_37923 = var_cas_table_attributs ;
      if (_temp_37923.isBuilt ()) {
        _temp_37923 (HERE)->method_searchKey (inLexique, var_cas_nom, var_cas_t COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      }
...
pr_lexical_send_instruction_scanner_parser_1350_31_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_40992 = var_cas_table_des_terminaux ;
  if (_temp_40992.isBuilt ()) {
    _temp_40992 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1360)) ;
  }
...
pr_lexical_send_instruction_scanner_parser_1366_31_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        const GGS_typeLexicalAttributesMap  _temp_41704 = var_cas_table_attributs ;
        if (_temp_41704.isBuilt ()) {
          _temp_41704 (HERE)->method_searchKey (inLexique, var_cas_nomAttribut, var_cas_natureAttribut COMMA_SOURCE_FILE_AT_LINE (1380)) ;
        }
        GGS_typeGalgas_lstring  var_cas_lgs ;
        var_cas_lgs = GGS_typeGalgas_lstring::_castFrom (inLexique, var_cas_natureAttribut.getPtr (), true, var_cas_nomAttribut COMMA_SOURCE_FILE_AT_LINE (1381)) ;
        ...
        const GGS_typeTableTablesDeMotsReserves  _temp_41946 = var_cas_table_tables_mots_reserves ;
        if (_temp_41946.isBuilt ()) {
          _temp_41946 (HERE)->method_searchKey (inLexique, var_cas_listName, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1385)) ;
        }
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_default) COMMA_HERE) ;
...
pr_lexical_send_or_error_scanner_parser_1403_28_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableDefinitionTerminaux  _temp_42662 = var_cas_table_des_terminaux ;
  if (_temp_42662.isBuilt ()) {
    _temp_42662 (HERE)->method_searchKey (inLexique, var_cas_nomTerminal, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (1411)) ;
  }
...
pr_lexical_send_or_error_scanner_parser_1417_28_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableMessagesErreurs  _temp_43217 = var_cas_tableMessagesErreurs ;
  if (_temp_43217.isBuilt ()) {
    _temp_43217 (HERE)->method_searchKeyGetID (inLexique, var_cas_errorMessageName, var_cas_errorMessageIndex, automatic_var_21 COMMA_SOURCE_FILE_AT_LINE (1427)) ;
  }
