...
pr_constraints_on_entity_declaration_constraint_parser_473_41_ (galgas_scanner & _inLexique,
  ...
  GGS_bool var_cas_17715 ;
  GGS_bool var_cas_17866 ;
  if (var_cas_inEntityMap._isBuilt ()) {
    var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_17715, var_cas_currentMetamodelPropertyMap, var_cas_superEntity, var_cas_currentConstraintPropertyMap, var_cas_superClassSet, var_cas_allConstraintPropertyMap, var_cas_17866, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (492)) ;
  }
  if (((var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (506))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_18309 ;
    GGS_lstring  var_cas_18364 ;
    GGS_stringset  var_cas_18424 ;
    GGS_bool var_cas_18483 ;
    if (var_cas_ioConstrainedEntityMap._isBuilt ()) {
      var_cas_ioConstrainedEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, var_cas_18309, var_cas_currentMetamodelPropertyMap, var_cas_18364, var_cas_currentConstraintPropertyMap, var_cas_18424, var_cas_allConstraintPropertyMap, var_cas_18483, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (510)) ;
    }
  }else{
