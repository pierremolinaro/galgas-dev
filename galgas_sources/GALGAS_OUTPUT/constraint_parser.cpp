...
pr_constraints_on_entity_declaration_constraint_parser_471_41_ (galgas_scanner & _inLexique,
  ...
  GGS_bool var_cas_17634 ;
  GGS_bool var_cas_17785 ;
  if (var_cas_inEntityMap._isBuilt ()) {
    var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_17634, var_cas_currentMetamodelPropertyMap, var_cas_superEntity, var_cas_currentConstraintPropertyMap, var_cas_superClassSet, var_cas_allConstraintPropertyMap, var_cas_17785, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (490)) ;
  }
  if (((var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (504))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
  }else if ((var_cas_ioConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (506)) SOURCE_FILE_AT_LINE (506))).isBuiltAndTrue ()) {
    GGS_bool var_cas_18228 ;
    GGS_lstring  var_cas_18283 ;
    GGS_stringset  var_cas_18343 ;
    GGS_bool var_cas_18402 ;
    if (var_cas_ioConstrainedEntityMap._isBuilt ()) {
      var_cas_ioConstrainedEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, var_cas_18228, var_cas_currentMetamodelPropertyMap, var_cas_18283, var_cas_currentConstraintPropertyMap, var_cas_18343, var_cas_allConstraintPropertyMap, var_cas_18402, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (508)) ;
    }
  }else{
    var_cas_entityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "constraints for super entity ('@")) + (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (521))))) + (GGS_string (true, "') should be previously defined"))) SOURCE_FILE_AT_LINE (522)) ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_constraint_parser_1 (_inLexique)) {
        case 2 : {
          ...
          GGS_lstring  var_cas_19554 ;
          GGS_lstring  var_cas_19557 ;
          GGS_lstring  var_cas_19560 ;
          if (var_cas_ioMapEntityMap._isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_19554, var_cas_19557, var_cas_19560 SOURCE_FILE_AT_LINE (551)) ;
          }
          ...
          var_cas_currentConstraintPropertyMap.method_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (555)) ;
          var_cas_allConstraintPropertyMap.method_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (556)) ;
          var_cas_allAvailablePropertyMap.method_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (557)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
          syntaxRepeat = false ;
...
pr_property_path_for_constraint_constraint_parser_711_36_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_3 (_inLexique)) {
          case 1 : {
...
pr_constraint_relation_primary_constraint_parser_785_35_ (galgas_scanner & _inLexique,
                                ...
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_7 (_inLexique)) {
    case 1 : {
