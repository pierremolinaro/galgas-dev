...
pr_parse_constraint_document_constraint_parser_181_33_ (galgas_scanner & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_19269 = var_cas_actualConstrainedEntityMap.firstObject () ;
  while ((operand_19269 != NULL)) {
    macroValidPointer (operand_19269) ;
    GGS_entityPropertyMap::element_type * operand_19539 = operand_19269->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_19539 != NULL)) {
      macroValidPointer (operand_19539) ;
      switch (operand_19539->mInfo.mKind.enumValue ()) {
      case GGS_metamodelPropertyKind::enum_attributeProperty:
        {
        }
        break ;
      ...
      case GGS_metamodelPropertyKind::enum_singleReferenceProperty:
        ...
        if ((var_cas_constraintInstructionListMap.reader_hasKey (_inLexique, operand_19269->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (501)) SOURCE_FILE_AT_LINE (501))).isBuiltAndTrue ()) {
          GGS_typeInstructionList  var_cas_19980 ;
          if (var_cas_constraintInstructionListMap._isBuilt ()) {
            var_cas_constraintInstructionListMap (HERE)->method_searchKey (_inLexique, operand_19269->mKey, var_cas_19980, var_cas_callInstructionSharedPropertySignatureMap SOURCE_FILE_AT_LINE (502)) ;
          }
        }
        if ((var_cas_actualConstrainedEntityMap.reader_hasKey (_inLexique, operand_19539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (504)) SOURCE_FILE_AT_LINE (504))).isBuiltAndTrue ()) {
          if ((var_cas_callInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, operand_19539->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (505)) SOURCE_FILE_AT_LINE (505))).isBuiltAndTrue ()) {
            operand_19269->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "checking 'call ")) + (operand_19539->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (506))))) + (GGS_string (true, "' instruction..."))) SOURCE_FILE_AT_LINE (506)) ;
          }else{
            operand_19269->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the instruction list should have a 'call ")) + (operand_19539->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (508))))) + (GGS_string (true, "' instruction"))) SOURCE_FILE_AT_LINE (509)) ;
          }
        }else{
          if ((var_cas_callInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, operand_19539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (511)) SOURCE_FILE_AT_LINE (511))).isBuiltAndTrue ()) {
            operand_19269->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the instruction list should not have a 'call ")) + (operand_19539->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (512))))) + (GGS_string (true, "' instruction"))) SOURCE_FILE_AT_LINE (513)) ;
          }
        }
        }
        break ;
      ...
      operand_19539 = operand_19539->nextObject () ;
    }
    operand_19269 = operand_19269->nextObject () ;
  }
  GGS_constraintInstructionListMap::element_type * operand_20848 = var_cas_constraintInstructionListMap.firstObject () ;
  while ((operand_20848 != NULL)) {
    macroValidPointer (operand_20848) ;
    _inLexique.printMessage (((GGS_string (true, "kEntityName: ")) + (operand_20848->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (525)))) SOURCE_FILE_AT_LINE (525)) ;
    _inLexique.printMessage (((GGS_string (true, "kCallInstructionSharedPropertySignatureMap: ")) + (operand_20848->mInfo.mCallInstructionSharedPropertySignatureMap.reader_description (_inLexique SOURCE_FILE_AT_LINE (526)))) SOURCE_FILE_AT_LINE (526)) ;
    operand_20848 = operand_20848->nextObject () ;
  }
  if (var_cas_metamodelEntityMap._isBuilt () &&
...
void constraint_parser::
constraint_parser::
pr_constraint_map_declaration_constraint_parser_546_34_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inMetamodelEntityMap.reader_hasKey (_inLexique, var_cas_mapIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (553)) SOURCE_FILE_AT_LINE (553))).isBuiltAndTrue ()) {
    var_cas_mapIdentifier.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "An entity has been declared with this name") SOURCE_FILE_AT_LINE (555)) ;
  }
  ...
  if (var_cas_insertErrorMessage._isBuilt ()) {
    ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_insertErrorMessage SOURCE_FILE_AT_LINE (565)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  ...
  if (var_cas_searchErrorMessage._isBuilt ()) {
    ::routine_check_K_escapeCharacters (_inLexique,  var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (572)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioMapEntityMap.method_insertKey (_inLexique, var_cas_mapIdentifier, var_cas_mapElementIdentifier, var_cas_insertErrorMessage, var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (576)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraint_map_declaration_constraint_parser_546_34_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_of) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
...
void constraint_parser::
constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_585_41_ (galgas_scanner & _inLexique,
  ...
  GGS_bool var_cas_23183 ;
  GGS_constrainedPropertyList  var_cas_23190 ;
  GGS_constrainedPropertyList  var_cas_23197 ;
  if (var_cas_inEntityMap._isBuilt ()) {
    var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_propertyMap, var_cas_superEntity, var_cas_superClassSet, var_cas_23183, var_cas_23190, var_cas_23197 SOURCE_FILE_AT_LINE (602)) ;
  }
  GGS_constrainedPropertyList  var_cas_constrainedParameterPropertyToImplementList ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_typeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (664)) SOURCE_FILE_AT_LINE (664))).isBuiltAndTrue ()) {
              var_cas_constrainedParameterPropertyToImplementList._addAssign_operation (var_cas_typeName, var_cas_propertyName) ;
            }else{
              var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled type name") SOURCE_FILE_AT_LINE (672)) ;
            }
  ...
  GGS_entityPropertyMap::element_type * operand_27539 = var_cas_allPropertyMap.firstObject () ;
  while ((operand_27539 != NULL)) {
    macroValidPointer (operand_27539) ;
    switch (operand_27539->mInfo.mKind.enumValue ()) {
    case GGS_metamodelPropertyKind::enum_attributeProperty:
      {
      GGS_typeCplusPlusName  var_cas_cppName ;
      var_cas_cppName = GGS_typeDirectName::constructor_new (_inLexique, GGS_lstring::constructor_new (_inLexique, ((GGS_string (true, "_mMetamodelObject->")) + (operand_27539->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (719)))), operand_27539->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (719)) COMMA_HERE) COMMA_HERE) ;
      if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (720))) == (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (722)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (723))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (725)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (726))) == (GGS_string (true, "lchar"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_lchar::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (728)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (729))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (731)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (732))) == (GGS_string (true, "luint"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (734)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (735))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (737)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (738))) == (GGS_string (true, "lsint"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_lsint::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (740)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (741))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (743)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (744))) == (GGS_string (true, "lbool"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_lbool::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (746)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (747))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (749)) ;
      }else if (((operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (750))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_27539->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (752)) ;
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "internal error (@")) + (operand_27539->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (754))))) + (GGS_string (true, " type not handled"))) SOURCE_FILE_AT_LINE (755)) ;
      }
      }
      break ;
    case GGS_metamodelPropertyKind::enum_multipleReferenceProperty:
    ...
    operand_27539 = operand_27539->nextObject () ;
  }
  GGS_typeCplusPlusName  var_cas_cppName ;
  ...
  GGS_AC_galgasType  var_cas_t ;
  var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, var_cas_entityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (783)) COMMA_HERE) ;
  var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "self"), GGS_location (_inLexique) COMMA_HERE), var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (784)) ;
  ...
  var_cas_ioConstraintInstructionListMap.method_insertKey (_inLexique, var_cas_entityName, var_cas_instructionsList, var_cas_callInstructionSharedPropertySignatureMap SOURCE_FILE_AT_LINE (803)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioConstrainedEntityMap.method_insertKey (_inLexique, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_propertyMap, var_cas_superEntity, var_cas_superClassSet, GGS_bool (true, false), var_cas_constrainedAttributePropertyToImplementList, var_cas_constrainedParameterPropertyToImplementList SOURCE_FILE_AT_LINE (834)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_585_41_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_on) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_constraint_parser_1 (_inLexique)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_property_path_for_constraint_constraint_parser_848_36_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        switch (select_constraint_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
            var_cas_pathElement.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
            var_cas_outPath._addAssign_operation (GGS_lstring::constructor_new (_inLexique, ((GGS_string (true, ".")) + (var_cas_pathElement.reader_string (_inLexique SOURCE_FILE_AT_LINE (860)))), var_cas_pathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (860)) COMMA_HERE)) ;
            } break ;
          default :
            break ;
        }
...
void constraint_parser::
pr_property_path_for_constraint_constraint_parser_848_36_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_5 (_inLexique)) {
          case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_expression_constraint_parser_869_38_ (galgas_scanner & _inLexique,
...
void constraint_parser::
pr_constraint_relation_expression_constraint_parser_869_38_parse (galgas_scanner & _inLexique) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_term_constraint_parser_889_32_ (galgas_scanner & _inLexique,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_term_constraint_parser_889_32_parse (galgas_scanner & _inLexique) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_factor_constraint_parser_906_34_ (galgas_scanner & _inLexique,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_factor_constraint_parser_906_34_parse (galgas_scanner & _inLexique) {
  switch (select_constraint_parser_8 (_inLexique)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_primary_constraint_parser_922_35_ (galgas_scanner & _inLexique,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_9 (_inLexique)) {
    ...
    case 4 : {
      ...
      if (var_cas_ioRelationVariableMap._isBuilt ()) {
        var_cas_ioRelationVariableMap (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_localVar, var_cas_variableIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (943)) ;
      }
      ...
      GGS_uint  var_cas_37226 ;
      if (var_cas_ioIndexMap._isBuilt ()) {
        var_cas_ioIndexMap (HERE)->method_searchKey (_inLexique, var_cas_indexVariableName, var_cas_domainVariableFromIndex, var_cas_37226 SOURCE_FILE_AT_LINE (948)) ;
      }
      if (((var_cas_domainVariable.reader_string (_inLexique SOURCE_FILE_AT_LINE (949))) != (var_cas_domainVariableFromIndex.reader_string (_inLexique SOURCE_FILE_AT_LINE (949)))).isBuiltAndTrue ()) {
        var_cas_indexVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_string (_inLexique SOURCE_FILE_AT_LINE (950))))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_string (_inLexique SOURCE_FILE_AT_LINE (951))))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_string (_inLexique SOURCE_FILE_AT_LINE (952))))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (953)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
    ...
    case 5 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_domainVariable ;
            if (var_cas_ioRelationVariableMap._isBuilt ()) {
              var_cas_ioRelationVariableMap (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_parameter, var_cas_parameterIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (968)) ;
            }
...
void constraint_parser::
pr_constraint_relation_primary_constraint_parser_922_35_parse (galgas_scanner & _inLexique) {
  switch (select_constraint_parser_9 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
      } break ;
