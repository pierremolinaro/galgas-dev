...
//                    november 18th, 2006, at 17h42'49"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_parse_constraint_document_constraint_parser_264_33_ (galgas_scanner & _inLexique,
  ...
  while ((operand_13025 != NULL)) {
    ...
    var_cas_representativeEntityMap.modifier_insertKey (_inLexique, operand_13025->mKey, var_cas_representativeTypeName, var_cas_superEntitySet SOURCE_FILE_AT_LINE (344)) ;
...
pr_constraint_map_declaration_constraint_parser_516_34_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioMapEntityMap.modifier_insertKey (_inLexique, var_cas_mapIdentifier, var_cas_mapElementIdentifier, var_cas_insertErrorMessage, var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (546)) ;
}
...
pr_constraints_on_entity_declaration_constraint_parser_555_41_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (586))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_22306 != NULL)) {
      ...
      var_cas_allAvailablePropertyMap.modifier_insertKey (_inLexique, operand_22306->mKey, operand_22306->mInfo.mProperty SOURCE_FILE_AT_LINE (602)) ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_currentConstraintPropertyMap.modifier_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (624)) ;
            var_cas_allConstraintPropertyMap.modifier_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (625)) ;
            var_cas_allAvailablePropertyMap.modifier_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (626)) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_constraint_parser_4 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_propertyName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          var_cas_currentConstraintPropertyMap.modifier_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (643)) ;
          var_cas_allConstraintPropertyMap.modifier_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (644)) ;
          var_cas_allAvailablePropertyMap.modifier_insertKey (_inLexique, var_cas_propertyName, var_cas_property SOURCE_FILE_AT_LINE (645)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
          syntaxRepeat = false ;
    ...
    if (operand_24728->mInfo.mProperty._isBuilt ()) {
      ...
      if (operand_24812 != NULL) {
        ...
        if (((operand_24812->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (669))) == (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (671)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (674)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (677)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (680)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (683)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (686)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (689)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (692)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (695)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (698)) ;
          ...
          var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_24728->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (701)) ;
        }else{
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioConstraintInstructionListMap.modifier_insertKey (_inLexique, var_cas_entityName, var_cas_instructionsList, var_cas_callInstructionSharedPropertySignatureMap, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (753)) ;
    ...
    if (operand_36098->mInfo.mProperty._isBuilt ()) {
      ...
      if (operand_36186 != NULL) {
        ...
        if ((var_cas_inUsefullClassSet.reader_hasKey (_inLexique, operand_36186->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (949)) SOURCE_FILE_AT_LINE (949))).isBuiltAndTrue ()) {
          var_cas_outOutputPropertyMap.modifier_insertKey (_inLexique, operand_36098->mKey, operand_36098->mInfo.mProperty SOURCE_FILE_AT_LINE (950)) ;
        }
      }else{
        ...
        if (operand_36419 != NULL) {
          ...
          if ((var_cas_inUsefullClassSet.reader_hasKey (_inLexique, operand_36419->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (953)) SOURCE_FILE_AT_LINE (953))).isBuiltAndTrue ()) {
            var_cas_outOutputPropertyMap.modifier_insertKey (_inLexique, operand_36098->mKey, operand_36098->mInfo.mProperty SOURCE_FILE_AT_LINE (954)) ;
          }
        }else{ // Else part
          var_cas_outOutputPropertyMap.modifier_insertKey (_inLexique, operand_36098->mKey, operand_36098->mInfo.mProperty SOURCE_FILE_AT_LINE (957)) ;
        }
      }
    }
...
pr_constraint_class_override_declarations_constraint_parser_964_46_ (galgas_scanner & _inLexique,
  ...
  while ((operand_40510 != NULL)) {
    ...
    if ((var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_40510->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1061)) SOURCE_FILE_AT_LINE (1061))).isBuiltAndTrue ()) {
      ...
      var_cas_outMetamodelEntityMap.modifier_insertKey (_inLexique, operand_40510->mKey, var_cas_allMetamodelPropertyMap, operand_40510->mInfo.mIsAbstract, var_cas_currentMetamodelPropertyMap, operand_40510->mInfo.mSuperEntityName, var_cas_currentConstraintPropertyMap, operand_40510->mInfo.mSuperEntitySet, var_cas_allConstraintPropertyMap, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (1073)) ;
    }
