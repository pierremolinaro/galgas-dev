...
void routine_checkCallInstruction (C_Lexique & _inLexique,
  ...
  if ((var_cas_inConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_inTestedReferenceName.reader_string (_inLexique SOURCE_FILE_AT_LINE (196)) SOURCE_FILE_AT_LINE (196))).isBuiltAndTrue ()) {
    if ((var_cas_inCallInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, var_cas_inTestedPropertyName.reader_string (_inLexique SOURCE_FILE_AT_LINE (197)) SOURCE_FILE_AT_LINE (197))).isBuiltAndTrue ()) {
      ...
      GGS_entityPropertyMap  var_cas_7329 ;
      GGS_bool var_cas_7332 ;
      GGS_entityPropertyMap  var_cas_7335 ;
      GGS_lstring  var_cas_7338 ;
      GGS_entityPropertyMap  var_cas_7341 ;
      GGS_stringset  var_cas_7344 ;
      GGS_entityPropertyMap  var_cas_7373 ;
      if (var_cas_inConstrainedEntityMap._isBuilt ()) {
        var_cas_inConstrainedEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inTestedReferenceName, var_cas_7329, var_cas_7332, var_cas_7335, var_cas_7338, var_cas_7341, var_cas_7344, var_cas_allContraintsPropertyMap, var_cas_7373 SOURCE_FILE_AT_LINE (201)) ;
      }
...
pr_parse_constraint_document_constraint_parser_264_33_ (galgas_scanner & _inLexique,
  ...
  GGS_stringset  var_cas_11933 ;
  if (var_cas_metamodelComponentMap._isBuilt ()) {
    var_cas_metamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntity, var_cas_originalMetamodelEntityMap, var_cas_11933 SOURCE_FILE_AT_LINE (294)) ;
  }
  ...
  while ((operand_18040 != NULL)) {
    ...
    GGS_typeInstructionList  var_cas_18438 ;
    if (var_cas_constraintInstructionListMap._isBuilt ()) {
      var_cas_constraintInstructionListMap (HERE)->method_searchKey (_inLexique, operand_18040->mKey, var_cas_18438, var_cas_callInstructionSharedPropertySignatureMap, var_cas_endOfInstructionList SOURCE_FILE_AT_LINE (473)) ;
    }
...
pr_constraints_on_entity_declaration_constraint_parser_555_41_ (galgas_scanner & _inLexique,
  ...
  GGS_bool var_cas_21424 ;
  GGS_entityPropertyMap  var_cas_21492 ;
  if (var_cas_inEntityMap._isBuilt ()) {
    var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_21424, var_cas_currentMetamodelPropertyMap, var_cas_superEntity, var_cas_21492, var_cas_superClassSet, var_cas_allConstraintPropertyMap, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (573)) ;
  }
  if (((var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (586))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_22017 ;
    GGS_bool var_cas_22051 ;
    GGS_entityPropertyMap  var_cas_22071 ;
    GGS_lstring  var_cas_22109 ;
    GGS_stringset  var_cas_22171 ;
    GGS_entityPropertyMap  var_cas_22230 ;
    if (var_cas_ioConstrainedEntityMap._isBuilt ()) {
      var_cas_ioConstrainedEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_22017, var_cas_22051, var_cas_22071, var_cas_22109, var_cas_inheritedConstraintPropertyMap, var_cas_22171, var_cas_allConstraintPropertyMap, var_cas_22230 SOURCE_FILE_AT_LINE (591)) ;
    }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_23017 ;
            GGS_lstring  var_cas_23020 ;
            GGS_lstring  var_cas_23023 ;
            if (var_cas_ioMapEntityMap._isBuilt ()) {
              var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_23017, var_cas_23020, var_cas_23023 SOURCE_FILE_AT_LINE (620)) ;
            }
            GGS_metamodelProperty  var_cas_property ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_constraint_parser_4 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_mda_5Ftype_5Fname) ;
          var_cas_typeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          GGS_lstring  var_cas_23689 ;
          GGS_lstring  var_cas_23692 ;
          GGS_lstring  var_cas_23695 ;
          if (var_cas_ioMapEntityMap._isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_23689, var_cas_23692, var_cas_23695 SOURCE_FILE_AT_LINE (639)) ;
          }
          GGS_metamodelProperty  var_cas_property ;
...
void routine_buildUsefullPropertyMap (C_Lexique & _inLexique,
  ...
  GGS_entityPropertyMap::element_type * operand_36099 = var_cas_inInputPropertyMap.firstObject () ;
  while ((operand_36099 != NULL)) {
    macroValidPointer (operand_36099) ;
    if (operand_36099->mInfo.mProperty._isBuilt ()) {
      cPtr_metamodelSingleReferenceProperty * operand_36187 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_36099->mInfo.mProperty.getPtr ()) ;
      if (operand_36187 != NULL) {
        macroValidPointer (operand_36187) ; 
        if ((var_cas_inUsefullClassSet.reader_hasKey (_inLexique, operand_36187->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (949)) SOURCE_FILE_AT_LINE (949))).isBuiltAndTrue ()) {
          var_cas_outOutputPropertyMap.method_insertKey (_inLexique, operand_36099->mKey, operand_36099->mInfo.mProperty SOURCE_FILE_AT_LINE (950)) ;
        }
      }else{
        cPtr_metamodelMultipleReferenceProperty * operand_36420 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_36099->mInfo.mProperty.getPtr ()) ;
        if (operand_36420 != NULL) {
          macroValidPointer (operand_36420) ; 
          if ((var_cas_inUsefullClassSet.reader_hasKey (_inLexique, operand_36420->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (953)) SOURCE_FILE_AT_LINE (953))).isBuiltAndTrue ()) {
            var_cas_outOutputPropertyMap.method_insertKey (_inLexique, operand_36099->mKey, operand_36099->mInfo.mProperty SOURCE_FILE_AT_LINE (954)) ;
          }
        }else{ // Else part
          var_cas_outOutputPropertyMap.method_insertKey (_inLexique, operand_36099->mKey, operand_36099->mInfo.mProperty SOURCE_FILE_AT_LINE (957)) ;
        }
      }
    }
    operand_36099 = operand_36099->nextObject () ;
  }
}
...
pr_constraint_class_override_declarations_constraint_parser_964_46_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_entityPropertyMap  var_cas_37264 ;
        GGS_bool var_cas_37267 ;
        GGS_entityPropertyMap  var_cas_37270 ;
        GGS_lstring  var_cas_37273 ;
        GGS_entityPropertyMap  var_cas_37276 ;
        GGS_stringset  var_cas_37279 ;
        GGS_entityPropertyMap  var_cas_37282 ;
        GGS_entityPropertyMap  var_cas_37285 ;
        if (var_cas_inOriginalMetamodelEntityMap._isBuilt ()) {
          var_cas_inOriginalMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelClass, var_cas_37264, var_cas_37267, var_cas_37270, var_cas_37273, var_cas_37276, var_cas_37279, var_cas_37282, var_cas_37285 SOURCE_FILE_AT_LINE (975)) ;
        }
  ...
  GGS_uint _variant_39805 = var_cas_inOriginalMetamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (991))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (991)) ;
  GGS_bool _condition_39805 (_variant_39805._isBuilt (), true) ;
  while (_condition_39805.isBuiltAndTrue ()) {
    if (_variant_39805.uintValue () == 0) {
      _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1036)) ;
      _condition_39805 = GGS_bool (true, false) ;
    }else{
      _variant_39805._decrement_operation (_inLexique COMMA_HERE) ;
      _condition_39805 = var_cas_continue  ;
      if (_condition_39805.isBuiltAndTrue ()) {
        var_cas_continue = GGS_bool (true, false) ;
        GGS_stringset::element_type * operand_38009 = var_cas_overriddenClassSet.firstObject () ;
        while ((operand_38009 != NULL)) {
          macroValidPointer (operand_38009) ;
          GGS_entityPropertyMap  var_cas_allAvailablePropertyMap ;
          GGS_lstring  var_cas_superEntityName ;
          GGS_entityPropertyMap  var_cas_38215 ;
          GGS_bool var_cas_38226 ;
          GGS_entityPropertyMap  var_cas_38237 ;
          GGS_entityPropertyMap  var_cas_38273 ;
          GGS_stringset  var_cas_38284 ;
          GGS_entityPropertyMap  var_cas_38295 ;
          if (var_cas_inOriginalMetamodelEntityMap._isBuilt ()) {
            var_cas_inOriginalMetamodelEntityMap (HERE)->method_searchKey (_inLexique, GGS_lstring::constructor_new (_inLexique, operand_38009->mKey, GGS_location (_inLexique) COMMA_HERE), var_cas_38215, var_cas_38226, var_cas_38237, var_cas_superEntityName, var_cas_38273, var_cas_38284, var_cas_38295, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (998)) ;
          }
          if ((((var_cas_usefulClassSet.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1009)) SOURCE_FILE_AT_LINE (1009))) & ((! (var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_38009->mKey SOURCE_FILE_AT_LINE (1009))))))).isBuiltAndTrue ()) {
            var_cas_continue = GGS_bool (true, true) ;
            var_cas_usefulClassSet._addAssign_operation (operand_38009->mKey) ;
          }
          if ((var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_38009->mKey SOURCE_FILE_AT_LINE (1013))).isBuiltAndTrue ()) {
            ...
            GGS_entityPropertyMap::element_type * operand_38965 = var_cas_allAvailablePropertyMap.firstObject () ;
            while ((operand_38965 != NULL)) {
              macroValidPointer (operand_38965) ;
              if (operand_38965->mInfo.mProperty._isBuilt ()) {
                cPtr_metamodelSingleReferenceProperty * operand_39044 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_38965->mInfo.mProperty.getPtr ()) ;
                if (operand_39044 != NULL) {
                  macroValidPointer (operand_39044) ; 
                  if ((((var_cas_overriddenClassSet.reader_hasKey (_inLexique, operand_39044->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1022)) SOURCE_FILE_AT_LINE (1022))) & ((! (var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_39044->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1022)) SOURCE_FILE_AT_LINE (1022))))))).isBuiltAndTrue ()) {
                    var_cas_continue = GGS_bool (true, true) ;
                    var_cas_usefulClassSet._addAssign_operation (operand_39044->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1024))) ;
                  }
                }else{
                  cPtr_metamodelMultipleReferenceProperty * operand_39382 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_38965->mInfo.mProperty.getPtr ()) ;
                  if (operand_39382 != NULL) {
                    macroValidPointer (operand_39382) ; 
                    if ((((var_cas_overriddenClassSet.reader_hasKey (_inLexique, operand_39382->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1027)) SOURCE_FILE_AT_LINE (1027))) & ((! (var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_39382->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1027)) SOURCE_FILE_AT_LINE (1027))))))).isBuiltAndTrue ()) {
                      var_cas_continue = GGS_bool (true, true) ;
                      var_cas_usefulClassSet._addAssign_operation (operand_39382->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1029))) ;
                    }
                  }else{ // Else part
                  }
                }
              }
              operand_38965 = operand_38965->nextObject () ;
            }
          }
          operand_38009 = operand_38009->nextObject () ;
        }
      }
    }
  }
  ...
  GGS_stringset::element_type * operand_39967 = var_cas_missingClasses.firstObject () ;
  while ((operand_39967 != NULL)) {
    macroValidPointer (operand_39967) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '%")) + (operand_39967->mKey))) + (GGS_string (true, "' class should be overriden"))) SOURCE_FILE_AT_LINE (1042)) ;
    operand_39967 = operand_39967->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_40216 = var_cas_uselessClasses.firstObject () ;
  while ((operand_40216 != NULL)) {
    macroValidPointer (operand_40216) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "it is useless to override '%")) + (operand_40216->mKey))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (1047)) ;
    operand_40216 = operand_40216->nextObject () ;
  }
  var_cas_outMetamodelEntityMap = GGS_entityToImplementMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_entityToImplementMap::element_type * operand_40511 = var_cas_inOriginalMetamodelEntityMap.firstObject () ;
  while ((operand_40511 != NULL)) {
    macroValidPointer (operand_40511) ;
    if ((var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_40511->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1061)) SOURCE_FILE_AT_LINE (1061))).isBuiltAndTrue ()) {
      GGS_entityPropertyMap  var_cas_allMetamodelPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_40511->mInfo.mAllMetamodelPropertyMap,  var_cas_usefulClassSet,  var_cas_allMetamodelPropertyMap SOURCE_FILE_AT_LINE (1063)) ;
      GGS_entityPropertyMap  var_cas_currentMetamodelPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_40511->mInfo.mCurrentMetamodelPropertyMap,  var_cas_usefulClassSet,  var_cas_currentMetamodelPropertyMap SOURCE_FILE_AT_LINE (1065)) ;
      GGS_entityPropertyMap  var_cas_currentConstraintPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_40511->mInfo.mCurrentConstraintPropertyMap,  var_cas_usefulClassSet,  var_cas_currentConstraintPropertyMap SOURCE_FILE_AT_LINE (1067)) ;
      GGS_entityPropertyMap  var_cas_allConstraintPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_40511->mInfo.mAllConstraintPropertyMap,  var_cas_usefulClassSet,  var_cas_allConstraintPropertyMap SOURCE_FILE_AT_LINE (1069)) ;
      GGS_entityPropertyMap  var_cas_allAvailablePropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_40511->mInfo.mAllAvailablePropertyMap,  var_cas_usefulClassSet,  var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (1071)) ;
      var_cas_outMetamodelEntityMap.method_insertKey (_inLexique, operand_40511->mKey, var_cas_allMetamodelPropertyMap, operand_40511->mInfo.mIsAbstract, var_cas_currentMetamodelPropertyMap, operand_40511->mInfo.mSuperEntityName, var_cas_currentConstraintPropertyMap, operand_40511->mInfo.mSuperEntitySet, var_cas_allConstraintPropertyMap, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (1073)) ;
    }
    operand_40511 = operand_40511->nextObject () ;
  }
}
