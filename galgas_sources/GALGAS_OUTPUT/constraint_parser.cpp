...
pr_constraints_on_entity_declaration_constraint_parser_282_41_ (galgas_scanner & lexique_var_,
        ...
        while (syntaxRepeat) {
            ...
            if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_entityName.reader_value ())).isBuiltAndTrue ()) {
              ...
              var_cas_isMap = GGS_bool (true, false) ;
                ...
                var_cas_entityName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this type is not defined") SOURCE_FILE_AT_LINE (316)) ;
            }
            GGS_lstring  var_cas_contextPropertyName ;
            lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            var_cas_contextPropertyName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
            var_cas_contextPropertyMap.methode_insertKey (lexique_var_, var_cas_contextPropertyName, var_cas_entityName, var_cas_isMap SOURCE_FILE_AT_LINE (320)) ;
  ...
  if (((var_cas_superEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    if ((var_cas_ioConstrainedEntityMap.reader_hasKey (var_cas_superEntity.reader_value ())).isBuiltAndTrue ()) {
      GGS_lstring  var_cas_10103 ;
      GGS_entityPropertyMap  var_cas_10114 ;
      GGS_mapPropertyMap  var_cas_10153 ;
      GGS_contextParameterMap  var_cas_10164 ;
      GGS_insertionList  var_cas_10175 ;
      GGS_indexMap  var_cas_10186 ;
      GGS_fetchedPropertyMap  var_cas_10197 ;
      var_cas_ioConstrainedEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_allRelationMap, var_cas_10103, var_cas_10114, var_cas_contextPropertyMap, var_cas_10153, var_cas_10164, var_cas_10175, var_cas_10186, var_cas_10197 SOURCE_FILE_AT_LINE (331)) ;
    }else{
        var_cas_entityName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "constraints for super entity ('@")) + (var_cas_superEntity.reader_value ()))) + (GGS_string (true, "') should be previously defined"))) SOURCE_FILE_AT_LINE (343)) ;
    }
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_constraint_parser_4 (lexique_var_)) {
        case 2 : {
          ...
          switch (select_constraint_parser_5 (lexique_var_)) {
            ...
            case 2 : {
              ...
              var_cas_indexMap.methode_insertKey (lexique_var_, var_cas_indexName, var_cas_mapPropertyName SOURCE_FILE_AT_LINE (368)) ;
        ...
        case 3 : {
          ...
          var_cas_contextParameterMap.methode_insertKey (lexique_var_, var_cas_referencePropertyName, var_cas_contextParameterList SOURCE_FILE_AT_LINE (386)) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        case 4 : {
          ...
          switch (select_constraint_parser_7 (lexique_var_)) {
            case 1 : {
              GGS_lstring  var_cas_11795 ;
              GGS_lstring  var_cas_11798 ;
              GGS_lstring  var_cas_11801 ;
              var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_propertyTypeName, var_cas_11795, var_cas_11798, var_cas_11801 SOURCE_FILE_AT_LINE (395)) ;
              var_cas_mapPropertyMap.methode_insertKey (lexique_var_, var_cas_attributeName, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (396)) ;
              } break ;
            case 2 : {
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              ...
              switch (select_constraint_parser_8 (lexique_var_)) {
                ...
                case 2 : {
                  ...
                  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
                  var_cas_indexName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
                  var_cas_indexMap.methode_insertKey (lexique_var_, var_cas_indexName, var_cas_mapPropertyName SOURCE_FILE_AT_LINE (411)) ;
                  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
                  } break ;
                default :
                  break ;
              }
              var_cas_fetchedPropertyMap.methode_insertKey (lexique_var_, var_cas_attributeName, var_cas_propertyTypeName, var_cas_fetchedAttributeName, var_cas_mapPropertyName, var_cas_indexName SOURCE_FILE_AT_LINE (415)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_relationVarMap.methode_insertKey (lexique_var_, var_cas_localVar, var_cas_domainVariable SOURCE_FILE_AT_LINE (435)) ;
          ...
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_allRelationMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (444)) ;
          var_cas_relationToImplementMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (445)) ;
          } break ;
        case 6 : {
          ...
          var_cas_relationIdentifier.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
          GGS_relationVarMap  var_cas_relationVarMap ;
          GGS_metamodelRelationExpression  var_cas_13454 ;
          var_cas_allRelationMap.methode_searchKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_13454 SOURCE_FILE_AT_LINE (452)) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
          GGS_metamodelRelationExpression  var_cas_e ;
          nt_constraint_relation_expression_ (lexique_var_, var_cas_relationVarMap, var_cas_indexMap, var_cas_e) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_relationToImplementMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (457)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioConstrainedEntityMap.methode_insertKey (lexique_var_, var_cas_entityName, var_cas_allRelationMap, var_cas_superEntity, var_cas_propertyMap, var_cas_contextPropertyMap, var_cas_mapPropertyMap, var_cas_contextParameterMap, var_cas_insertionList, var_cas_indexMap, var_cas_fetchedPropertyMap SOURCE_FILE_AT_LINE (461)) ;
}
...
void constraint_parser::
constraint_parser::
pr_property_path_for_constraint_constraint_parser_476_36_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_property_path_for_constraint_constraint_parser_476_36_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_11 (lexique_var_)) {
          case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_expression_constraint_parser_497_38_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_constraint_relation_expression_constraint_parser_497_38_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_term_constraint_parser_514_32_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_term_constraint_parser_514_32_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_factor_constraint_parser_531_34_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_factor_constraint_parser_531_34_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_14 (lexique_var_)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_primary_constraint_parser_547_35_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_15 (lexique_var_)) {
    ...
    case 4 : {
      ...
      GGS_lstring  var_cas_domainVariable ;
      var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_localVar, var_cas_variableIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (568)) ;
      ...
      var_cas_ioIndexMap.methode_searchKey (lexique_var_, var_cas_indexVariableName, var_cas_domainVariableFromIndex SOURCE_FILE_AT_LINE (573)) ;
      if (((var_cas_domainVariable.reader_value ()) != (var_cas_domainVariableFromIndex.reader_value ())).isBuiltAndTrue ()) {
          var_cas_indexVariableName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_value ()))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_value ()))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_value ()))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (577)) ;
      }
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
    ...
    case 5 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_domainVariable ;
            var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_parameter, var_cas_parameterIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (593)) ;
...
void constraint_parser::
pr_constraint_relation_primary_constraint_parser_547_35_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_15 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
      } break ;
