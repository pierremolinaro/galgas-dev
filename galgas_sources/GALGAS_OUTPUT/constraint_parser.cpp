...
//                    november 15th, 2006, at 15h48'25"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_constraint_class_override_declarations_constraint_parser_964_46_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_entityPropertyMap  var_cas_37263 ;
        GGS_bool var_cas_37266 ;
        GGS_entityPropertyMap  var_cas_37269 ;
        GGS_lstring  var_cas_37272 ;
        GGS_entityPropertyMap  var_cas_37275 ;
        GGS_stringset  var_cas_37278 ;
        GGS_entityPropertyMap  var_cas_37281 ;
        GGS_entityPropertyMap  var_cas_37284 ;
        if (var_cas_inOriginalMetamodelEntityMap._isBuilt ()) {
          var_cas_inOriginalMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelClass, var_cas_37263, var_cas_37266, var_cas_37269, var_cas_37272, var_cas_37275, var_cas_37278, var_cas_37281, var_cas_37284 SOURCE_FILE_AT_LINE (975)) ;
        }
    ...
    if (_variant_39804.uintValue () == 0) {
      ...
      if (_condition_39804.isBuiltAndTrue ()) {
        ...
        while ((operand_38008 != NULL)) {
          ...
          GGS_entityPropertyMap  var_cas_38214 ;
          GGS_bool var_cas_38225 ;
          GGS_entityPropertyMap  var_cas_38236 ;
          GGS_entityPropertyMap  var_cas_38272 ;
          GGS_stringset  var_cas_38283 ;
          GGS_entityPropertyMap  var_cas_38294 ;
          if (var_cas_inOriginalMetamodelEntityMap._isBuilt ()) {
            var_cas_inOriginalMetamodelEntityMap (HERE)->method_searchKey (_inLexique, GGS_lstring::constructor_new (_inLexique, operand_38008->mKey, GGS_location (_inLexique) COMMA_HERE), var_cas_38214, var_cas_38225, var_cas_38236, var_cas_superEntityName, var_cas_38272, var_cas_38283, var_cas_38294, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (998)) ;
          }
