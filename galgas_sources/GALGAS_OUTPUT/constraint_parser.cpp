...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/developpements/mes_prgms/galgas/galgas_sources/constraint_parser.ggs" ;
...
constraint_parser::
pr_galgas_component_constraint_parser_110_24_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
constraint_parser::
pr_galgas_component_constraint_parser_110_24_importLexique (galgas_scanner & lexique_var_,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void constraint_parser::
constraint_parser::
pr_galgas_component_constraint_parser_110_24_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_constraint_document_ (lexique_var_, var_cas_ioMetamodelComponentMap) ;
}
...
void constraint_parser::
constraint_parser::
pr_galgas_component_constraint_parser_110_24_importSemantics (galgas_scanner & lexique_var_,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_constraint_document_ (lexique_var_, var_cas_ioMetamodelComponentMap) ;
}
...
void constraint_parser::
constraint_parser::
pr_galgas_component_constraint_parser_110_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_constraint_document_ (lexique_var_, var_cas_ioMetamodelComponentMap) ;
}
...
void constraint_parser::
constraint_parser::
pr_galgas_component_constraint_parser_110_24_importOptions (galgas_scanner & lexique_var_,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_constraint_document_parse (lexique_var_) ;
}
...
void constraint_parser::
constraint_parser::
pr_parse_constraint_document_constraint_parser_146_33_ (galgas_scanner & lexique_var_,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  ...
  var_cas_metamodelComponentMap.methode_searchKey (lexique_var_, var_cas_metamodelName, var_cas_rootEntity, var_cas_semanticsEntitiesMap, var_cas_entityMap SOURCE_FILE_AT_LINE (175)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_constraint_parser_1 (lexique_var_)) {
        case 2 : {
          nt_constraints_on_entity_declaration_ (lexique_var_, var_cas_entityMap, var_cas_mapEntityMap) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void constraint_parser::
pr_parse_constraint_document_constraint_parser_146_33_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_constraint) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_import) ;
...
void constraint_parser::
constraint_parser::
pr_constraint_map_declaration_constraint_parser_213_34_ (galgas_scanner & lexique_var_,
  ...
  if ((var_cas_ioEntityMap.reader_hasKey (var_cas_mapIdentifier.reader_value ())).isBuiltAndTrue ()) {
      var_cas_mapIdentifier.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "An entity has been declared with this name") SOURCE_FILE_AT_LINE (221)) ;
  }
  ...
  if (var_cas_insertErrorMessage.isBuilt ()) {
    ::routine_check_KL_escapeCharacters (lexique_var_,  var_cas_insertErrorMessage SOURCE_FILE_AT_LINE (232)) ;
  }
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  ...
  if (var_cas_searchErrorMessage.isBuilt ()) {
    ::routine_check_K_escapeCharacters (lexique_var_,  var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (239)) ;
  }
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioMapEntityMap.methode_insertKey (lexique_var_, var_cas_mapIdentifier, var_cas_mapElementIdentifier, var_cas_insertErrorMessage, var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (243)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraint_map_declaration_constraint_parser_213_34_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_of) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
...
void constraint_parser::
constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_252_41_ (galgas_scanner & lexique_var_,
                                GGS_entityToImplementMap  &var_cas_ioEntityMap,
                                GGS_mapEntityMap  &var_cas_ioMapEntityMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_constraint) ;
  ...
  GGS_bool var_cas_8046 ;
  GGS_entityPropertyMap  var_cas_8053 ;
  var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_entityName, var_cas_allPropertyMap, var_cas_8046, var_cas_8053, var_cas_superEntity SOURCE_FILE_AT_LINE (264)) ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_contextPropertyName.reader_value ())).isBuiltAndTrue ()) {
              var_cas_isMap = GGS_bool (true, true) ;
            }else if ((var_cas_ioEntityMap.reader_hasKey (var_cas_contextPropertyName.reader_value ())).isBuiltAndTrue ()) {
              var_cas_isMap = GGS_bool (true, false) ;
            }else{
                var_cas_contextPropertyName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this type is not defined") SOURCE_FILE_AT_LINE (286)) ;
            }
            var_cas_contextPropertyMap.methode_insertKey (lexique_var_, var_cas_contextPropertyName, var_cas_entityName, var_cas_isMap SOURCE_FILE_AT_LINE (288)) ;
            ...
            case 2 : {
              ...
              switch (select_constraint_parser_8 (lexique_var_)) {
                ...
                case 2 : {
                  ...
                  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
                  var_cas_indexName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
                  var_cas_indexMap.methode_insertKey (lexique_var_, var_cas_indexName, var_cas_mapPropertyName SOURCE_FILE_AT_LINE (349)) ;
                  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
                  } break ;
                default :
                  break ;
              }
              var_cas_fetchedPropertyMap.methode_insertKey (lexique_var_, var_cas_attributeName, var_cas_propertyTypeName, var_cas_fetchedAttributeName, var_cas_mapPropertyName, var_cas_indexName SOURCE_FILE_AT_LINE (353)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_relationVarMap.methode_insertKey (lexique_var_, var_cas_localVar, var_cas_domainVariable SOURCE_FILE_AT_LINE (373)) ;
          ...
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_relationMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (382)) ;
          } break ;
        case 6 : {
          ...
          var_cas_relationIdentifier.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
          GGS_relationVarMap  var_cas_relationVarMap ;
          GGS_metamodelRelationExpression  var_cas_11195 ;
          var_cas_relationMap.methode_searchKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_11195 SOURCE_FILE_AT_LINE (389)) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
          GGS_metamodelRelationExpression  var_cas_e ;
          nt_constraint_relation_expression_ (lexique_var_, var_cas_relationVarMap, var_cas_indexMap, var_cas_e) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_relationMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (394)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_252_41_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_constraint) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_constraint_parser_2 (lexique_var_)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_property_path_for_constraint_constraint_parser_401_36_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_property_path_for_constraint_constraint_parser_401_36_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_11 (lexique_var_)) {
          case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_expression_constraint_parser_422_38_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_constraint_relation_expression_constraint_parser_422_38_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_term_constraint_parser_439_32_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_term_constraint_parser_439_32_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_factor_constraint_parser_456_34_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_factor_constraint_parser_456_34_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_14 (lexique_var_)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_primary_constraint_parser_472_35_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_15 (lexique_var_)) {
    ...
    case 4 : {
      ...
      GGS_lstring  var_cas_domainVariable ;
      var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_localVar, var_cas_variableIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (493)) ;
      ...
      var_cas_ioIndexMap.methode_searchKey (lexique_var_, var_cas_indexVariableName, var_cas_domainVariableFromIndex SOURCE_FILE_AT_LINE (498)) ;
      if (((var_cas_domainVariable.reader_value ()) != (var_cas_domainVariableFromIndex.reader_value ())).isBuiltAndTrue ()) {
          var_cas_indexVariableName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_value ()))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_value ()))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_value ()))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (502)) ;
      }
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
    ...
    case 5 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_domainVariable ;
            var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_parameter, var_cas_parameterIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (518)) ;
...
void constraint_parser::
pr_constraint_relation_primary_constraint_parser_472_35_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_15 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
      } break ;
