...
pr_constraints_on_entity_declaration_constraint_parser_328_41_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  if (((var_cas_superEntity.reader_value ()) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_constrainedEntityPassMap::element_type * operand_15859 = var_cas_constrainedEntityPassMap.firstObject () ;
    while ((operand_15859 != NULL)) {
      macroValidPointer (operand_15859) ;
      var_cas_passesDefinedByInheritanceTreeRootEntity.addAssign_operation (operand_15859->mKey.reader_value ()) ;
      operand_15859 = operand_15859->nextObject () ;
    }
  }
  if (((var_cas_superEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_constrainedEntityPassMap::element_type * operand_16174 = var_cas_constrainedEntityPassMap.firstObject () ;
    while ((operand_16174 != NULL)) {
      macroValidPointer (operand_16174) ;
      if (((! (var_cas_passesDefinedByInheritanceTreeRootEntity.reader_hasKey (operand_16174->mKey.reader_value ())))).isBuiltAndTrue ()) {
          GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "pass '")) + (operand_16174->mKey.reader_value ()))) + (GGS_string (true, "' cannot be defined because it is not defined by the constraint on '@")))) + (var_cas_superEntity.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (549)) ;
      }
      operand_16174 = operand_16174->nextObject () ;
    }
  }
  var_cas_ioConstrainedEntityMap.methode_insertKey (lexique_var_, var_cas_entityName, var_cas_passesDefinedByInheritanceTreeRootEntity, var_cas_constrainedEntityPassMap, var_cas_allRelationMap, var_cas_superEntity, var_cas_propertyMap, var_cas_contextPropertyMap, var_cas_mapPropertyMap, var_cas_contextParameterMap, var_cas_insertionList, var_cas_indexMap, var_cas_fetchedPropertyMap, var_cas_descendantEntitySet, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (555)) ;
}
...
void constraint_parser::
constraint_parser::
pr_property_path_for_constraint_constraint_parser_574_36_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_property_path_for_constraint_constraint_parser_574_36_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_14 (lexique_var_)) {
          case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_expression_constraint_parser_595_38_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_constraint_relation_expression_constraint_parser_595_38_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_term_constraint_parser_612_32_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_term_constraint_parser_612_32_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_factor_constraint_parser_629_34_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_factor_constraint_parser_629_34_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_17 (lexique_var_)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_primary_constraint_parser_645_35_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_18 (lexique_var_)) {
    ...
    case 4 : {
      ...
      GGS_lstring  var_cas_domainVariable ;
      var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_localVar, var_cas_variableIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (666)) ;
      ...
      var_cas_ioIndexMap.methode_searchKey (lexique_var_, var_cas_indexVariableName, var_cas_domainVariableFromIndex SOURCE_FILE_AT_LINE (671)) ;
      if (((var_cas_domainVariable.reader_value ()) != (var_cas_domainVariableFromIndex.reader_value ())).isBuiltAndTrue ()) {
          var_cas_indexVariableName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_value ()))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_value ()))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_value ()))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (675)) ;
      }
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
    ...
    case 5 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_domainVariable ;
            var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_parameter, var_cas_parameterIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (691)) ;
...
void constraint_parser::
pr_constraint_relation_primary_constraint_parser_645_35_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_18 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
      } break ;
