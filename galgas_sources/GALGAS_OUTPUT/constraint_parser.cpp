            ...
            if (((operand_19352->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              ...
              if (((operand_19352->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (532))) == (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
                ...
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19352->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (564)) ;
                  ...
                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "internal error (@")) + (operand_19352->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (566))))) + (GGS_string (true, " type not handled"))) SOURCE_FILE_AT_LINE (566)) ;
              }
            }
  ...
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (632))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_25071 != NULL)) {
      ...
      if (((! (var_cas_passesDefinedByInheritanceTreeRootEntity.reader_hasKey (_inLexique, operand_25071->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (634)) SOURCE_FILE_AT_LINE (634))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "pass '")) + (operand_25071->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (635))))) + (GGS_string (true, "' cannot be defined because it is not defined by the constraint on '@")))) + (var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (637))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (637)) ;
      }
