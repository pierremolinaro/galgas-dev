...
pr_constraints_on_entity_declaration_constraint_parser_473_41_ (galgas_scanner & _inLexique,
  ...
  GGS_bool var_cas_17703 ;
  GGS_bool var_cas_17854 ;
  if (var_cas_inEntityMap._isBuilt ()) {
    var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_17703, var_cas_currentMetamodelPropertyMap, var_cas_superEntity, var_cas_currentConstraintPropertyMap, var_cas_superClassSet, var_cas_allConstraintPropertyMap, var_cas_17854, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (492)) ;
  }
  if (((var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (506))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_18297 ;
    GGS_lstring  var_cas_18352 ;
    GGS_stringset  var_cas_18412 ;
    GGS_bool var_cas_18471 ;
    if (var_cas_ioConstrainedEntityMap._isBuilt ()) {
      var_cas_ioConstrainedEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, var_cas_18297, var_cas_currentMetamodelPropertyMap, var_cas_18352, var_cas_currentConstraintPropertyMap, var_cas_18412, var_cas_allConstraintPropertyMap, var_cas_18471, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (510)) ;
    }
  }else{
