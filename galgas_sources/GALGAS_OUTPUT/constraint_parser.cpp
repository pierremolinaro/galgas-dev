...
pr_constraints_on_entity_declaration_constraint_parser_541_6_ (galgas_scanner & _inLexique,
    ...
    if (operand_25577->mInfo.mProperty._isBuilt ()) {
      ...
      if (operand_25661 != NULL) {
        ...
        if (operand_25973 != NULL) {
          ...
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeDirectName::constructor_new (_inLexique, operand_25577->mKey COMMA_HERE) ;
          if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (672))) == (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (674)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (675))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (677)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (678))) == (GGS_string (true, "lchar"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_lchar::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (680)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (681))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (683)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (684))) == (GGS_string (true, "luint"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (686)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (687))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (689)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (690))) == (GGS_string (true, "lsint"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_lsint::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (692)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (693))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (695)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (696))) == (GGS_string (true, "lbool"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_lbool::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (698)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (699))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (701)) ;
          }else if (((operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (702))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_25577->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (704)) ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "internal error (@")) + (operand_25973->mAttributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (706))))) + (GGS_string (true, " type not handled"))) SOURCE_FILE_AT_LINE (707)) ;
          }
        }else{ // Else part
        }
      }
  ...
  GGS_entityPropertyMap::element_type * operand_28492 = var_cas_allConstraintPropertyMap.firstObject () ;
  while ((operand_28492 != NULL)) {
    macroValidPointer (operand_28492) ;
    if (operand_28492->mInfo.mProperty._isBuilt ()) {
      cPtr_metamodelSharedMapProperty * operand_28588 = dynamic_cast <cPtr_metamodelSharedMapProperty *> (operand_28492->mInfo.mProperty.getPtr ()) ;
      if (operand_28588 != NULL) {
        macroValidPointer (operand_28588) ; 
        GGS_string var_cas_overrideConstraint ;
        if ((var_cas_inOverriddenClassSet.reader_hasKey (_inLexique, operand_28588->mMapElementName.reader_string (_inLexique SOURCE_FILE_AT_LINE (718)) SOURCE_FILE_AT_LINE (718))).isBuiltAndTrue ()) {
        ...
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_mapEntityInInstruction::constructor_new (_inLexique, operand_28588->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (723)), operand_28588->mMapElementName.reader_string (_inLexique SOURCE_FILE_AT_LINE (723)), var_cas_overrideConstraint COMMA_HERE) ;
        GGS_typeCplusPlusName  var_cas_cppName ;
        var_cas_cppName = GGS_typeDirectName::constructor_new (_inLexique, GGS_lstring::constructor_new (_inLexique, ((((GGS_string (true, "(* ")) + (operand_28492->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (724))))) + (GGS_string (true, ")"))), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertUsedInOutArgument (_inLexique, operand_28492->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (725)) ;
      }else{ // Else part
      }
    }
    operand_28492 = operand_28492->nextObject () ;
  }
  GGS_typeCplusPlusName  var_cas_cppName ;
...
void routine_buildUsefullPropertyMap (C_Lexique & _inLexique,
  ...
  GGS_entityPropertyMap::element_type * operand_31051 = var_cas_inInputPropertyMap.firstObject () ;
  while ((operand_31051 != NULL)) {
    macroValidPointer (operand_31051) ;
    if (operand_31051->mInfo.mProperty._isBuilt ()) {
      cPtr_metamodelSingleReferenceProperty * operand_31139 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_31051->mInfo.mProperty.getPtr ()) ;
      if (operand_31139 != NULL) {
        macroValidPointer (operand_31139) ; 
        if ((var_cas_inUsefullClassSet.reader_hasKey (_inLexique, operand_31139->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (782)) SOURCE_FILE_AT_LINE (782))).isBuiltAndTrue ()) {
          var_cas_outOutputPropertyMap.modifier_insertKey (_inLexique, operand_31051->mKey, operand_31051->mInfo.mProperty SOURCE_FILE_AT_LINE (783)) ;
        }
      }else{
        cPtr_metamodelMultipleReferenceProperty * operand_31372 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_31051->mInfo.mProperty.getPtr ()) ;
        if (operand_31372 != NULL) {
          macroValidPointer (operand_31372) ; 
          if ((var_cas_inUsefullClassSet.reader_hasKey (_inLexique, operand_31372->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (786)) SOURCE_FILE_AT_LINE (786))).isBuiltAndTrue ()) {
            var_cas_outOutputPropertyMap.modifier_insertKey (_inLexique, operand_31051->mKey, operand_31051->mInfo.mProperty SOURCE_FILE_AT_LINE (787)) ;
          }
        }else{ // Else part
          var_cas_outOutputPropertyMap.modifier_insertKey (_inLexique, operand_31051->mKey, operand_31051->mInfo.mProperty SOURCE_FILE_AT_LINE (790)) ;
        }
      }
    }
...
pr_constraint_class_override_declarations_constraint_parser_797_6_ (galgas_scanner & _inLexique,
  ...
  GGS_uint _variant_34818 = var_cas_inOriginalMetamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (825))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (825)) ;
  GGS_bool _condition_34818 (_variant_34818._isBuilt (), true) ;
  while (_condition_34818.isBuiltAndTrue ()) {
    _condition_34818 = var_cas_continue ;
    if (_condition_34818.isBuiltAndTrue ()) {
      if (_variant_34818.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (870)) ;
        _condition_34818 = GGS_bool (true, false) ;
      }else{
        _variant_34818._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_continue = GGS_bool (true, false) ;
        GGS_stringset::element_type * operand_33016 = var_cas_outOverriddenClassSet.firstObject () ;
        while ((operand_33016 != NULL)) {
          macroValidPointer (operand_33016) ;
          GGS_entityPropertyMap  var_cas_allAvailablePropertyMap ;
          ...
          if (var_cas_inOriginalMetamodelEntityMap._isBuilt ()) {
            var_cas_inOriginalMetamodelEntityMap (HERE)->method_searchKey (_inLexique, GGS_lstring::constructor_new (_inLexique, operand_33016->mKey, GGS_location (_inLexique) COMMA_HERE), automatic_var_31, automatic_var_32, automatic_var_33, var_cas_superEntityName, automatic_var_34, automatic_var_35, automatic_var_36, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (831)) ;
          }
          if ((((var_cas_usefulClassSet.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (843)) SOURCE_FILE_AT_LINE (843))) & ((! (var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_33016->mKey SOURCE_FILE_AT_LINE (843))))))).isBuiltAndTrue ()) {
            var_cas_continue = GGS_bool (true, true) ;
            var_cas_usefulClassSet._addAssign_operation (operand_33016->mKey) ;
          }
          if ((var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_33016->mKey SOURCE_FILE_AT_LINE (847))).isBuiltAndTrue ()) {
            ...
            GGS_entityPropertyMap::element_type * operand_33972 = var_cas_allAvailablePropertyMap.firstObject () ;
            while ((operand_33972 != NULL)) {
              macroValidPointer (operand_33972) ;
              if (operand_33972->mInfo.mProperty._isBuilt ()) {
                cPtr_metamodelSingleReferenceProperty * operand_34051 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_33972->mInfo.mProperty.getPtr ()) ;
                if (operand_34051 != NULL) {
                  macroValidPointer (operand_34051) ; 
                  if ((((var_cas_outOverriddenClassSet.reader_hasKey (_inLexique, operand_34051->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (856)) SOURCE_FILE_AT_LINE (856))) & ((! (var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_34051->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (856)) SOURCE_FILE_AT_LINE (856))))))).isBuiltAndTrue ()) {
                    var_cas_continue = GGS_bool (true, true) ;
                    var_cas_usefulClassSet._addAssign_operation (operand_34051->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (858))) ;
                  }
                }else{
                  cPtr_metamodelMultipleReferenceProperty * operand_34392 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_33972->mInfo.mProperty.getPtr ()) ;
                  if (operand_34392 != NULL) {
                    macroValidPointer (operand_34392) ; 
                    if ((((var_cas_outOverriddenClassSet.reader_hasKey (_inLexique, operand_34392->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (861)) SOURCE_FILE_AT_LINE (861))) & ((! (var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_34392->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (861)) SOURCE_FILE_AT_LINE (861))))))).isBuiltAndTrue ()) {
                      var_cas_continue = GGS_bool (true, true) ;
                      var_cas_usefulClassSet._addAssign_operation (operand_34392->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (863))) ;
                    }
                  }else{ // Else part
                  }
                }
              }
              operand_33972 = operand_33972->nextObject () ;
            }
          }
          operand_33016 = operand_33016->nextObject () ;
        }
      }
    }
  }
  ...
  GGS_stringset::element_type * operand_34983 = var_cas_missingClasses.firstObject () ;
  while ((operand_34983 != NULL)) {
    macroValidPointer (operand_34983) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '%")) + (operand_34983->mKey))) + (GGS_string (true, "' class should be overriden"))) SOURCE_FILE_AT_LINE (876)) ;
    operand_34983 = operand_34983->nextObject () ;
  }
  ...
  GGS_stringset::element_type * operand_35235 = var_cas_uselessClasses.firstObject () ;
  while ((operand_35235 != NULL)) {
    macroValidPointer (operand_35235) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "it is useless to override '%")) + (operand_35235->mKey))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (881)) ;
    operand_35235 = operand_35235->nextObject () ;
  }
  var_cas_outMetamodelEntityMap = GGS_entityToImplementMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_entityToImplementMap::element_type * operand_35530 = var_cas_inOriginalMetamodelEntityMap.firstObject () ;
  while ((operand_35530 != NULL)) {
    macroValidPointer (operand_35530) ;
    if ((var_cas_usefulClassSet.reader_hasKey (_inLexique, operand_35530->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (895)) SOURCE_FILE_AT_LINE (895))).isBuiltAndTrue ()) {
      GGS_entityPropertyMap  var_cas_allMetamodelPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_35530->mInfo.mAllMetamodelPropertyMap,  var_cas_usefulClassSet,  var_cas_allMetamodelPropertyMap SOURCE_FILE_AT_LINE (897)) ;
      GGS_entityPropertyMap  var_cas_currentMetamodelPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_35530->mInfo.mCurrentMetamodelPropertyMap,  var_cas_usefulClassSet,  var_cas_currentMetamodelPropertyMap SOURCE_FILE_AT_LINE (899)) ;
      GGS_entityPropertyMap  var_cas_currentConstraintPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_35530->mInfo.mCurrentConstraintPropertyMap,  var_cas_usefulClassSet,  var_cas_currentConstraintPropertyMap SOURCE_FILE_AT_LINE (901)) ;
      GGS_entityPropertyMap  var_cas_allConstraintPropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_35530->mInfo.mAllConstraintPropertyMap,  var_cas_usefulClassSet,  var_cas_allConstraintPropertyMap SOURCE_FILE_AT_LINE (903)) ;
      GGS_entityPropertyMap  var_cas_allAvailablePropertyMap ;
      ::routine_buildUsefullPropertyMap (_inLexique,  operand_35530->mInfo.mAllAvailablePropertyMap,  var_cas_usefulClassSet,  var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (905)) ;
      var_cas_outMetamodelEntityMap.modifier_insertKey (_inLexique, operand_35530->mKey, var_cas_allMetamodelPropertyMap, operand_35530->mInfo.mIsAbstract, var_cas_currentMetamodelPropertyMap, operand_35530->mInfo.mSuperEntityName, var_cas_currentConstraintPropertyMap, operand_35530->mInfo.mSuperEntitySet, var_cas_allConstraintPropertyMap, var_cas_allAvailablePropertyMap SOURCE_FILE_AT_LINE (906)) ;
    }
    operand_35530 = operand_35530->nextObject () ;
  }
}
