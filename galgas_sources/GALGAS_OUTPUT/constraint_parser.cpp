...
pr_parse_constraint_document_constraint_parser_183_33_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_constraintOnRootEntity).isBuiltAndTrue ()) {
    ...
    while ((operand_9196 != NULL)) {
      ...
      if (((operand_9196->mInfo.mSharedPropertyList.reader_length (_inLexique SOURCE_FILE_AT_LINE (283))) != (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
          operand_9196->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a pass of the root entity constraint should not define any shared prperty") SOURCE_FILE_AT_LINE (284)) ;
      }
  ...
  while ((operand_9523 != NULL)) {
    ...
    var_cas_definedPassSet = operand_9523->mInfo.mConstrainedEntityPassMap.reader_allKeys (_inLexique SOURCE_FILE_AT_LINE (290)) ;
    ...
    while ((operand_9762 != NULL)) {
      ...
      if (((operand_9762->mInfo.mKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        ...
        while ((operand_10186 != NULL)) {
          ...
          if (((! (operand_9523->mInfo.mConstrainedEntityPassMap.reader_hasKey (_inLexique, operand_10186->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (296)) SOURCE_FILE_AT_LINE (296))))).isBuiltAndTrue ()) {
              operand_9523->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this constraint should define the '")) + (operand_10186->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (297))))) + (GGS_string (true, "' pass (due to '")))) + (operand_9762->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (298))))) + (GGS_string (true, "' reference)"))) SOURCE_FILE_AT_LINE (298)) ;
          }
        ...
        while ((operand_10806 != NULL)) {
          ...
          if ((((operand_10806->mInfo.mConstraintPropertyDefinitionSet.reader_hasKey (_inLexique, operand_9762->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (311)) SOURCE_FILE_AT_LINE (311))) && ((! (var_cas_referencePassSet.reader_hasKey (_inLexique, operand_10806->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (311)) SOURCE_FILE_AT_LINE (311))))))).isBuiltAndTrue ()) {
              operand_10806->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this pass should not define the '")) + (operand_9762->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (312))))) + (GGS_string (true, "' property"))) SOURCE_FILE_AT_LINE (312)) ;
          }else if (((((! (operand_10806->mInfo.mConstraintPropertyDefinitionSet.reader_hasKey (_inLexique, operand_9762->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (313)) SOURCE_FILE_AT_LINE (313))))) && (var_cas_referencePassSet.reader_hasKey (_inLexique, operand_10806->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (313)) SOURCE_FILE_AT_LINE (313))))).isBuiltAndTrue ()) {
              operand_10806->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this pass should define the '")) + (operand_9762->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (314))))) + (GGS_string (true, "' property"))) SOURCE_FILE_AT_LINE (314)) ;
          }
          if ((operand_10806->mInfo.mCallInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, operand_9762->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (317)) SOURCE_FILE_AT_LINE (317))).isBuiltAndTrue ()) {
            ...
            if (((var_cas_sharedPropertyList.reader_length (_inLexique SOURCE_FILE_AT_LINE (324))) == (var_cas_signature.reader_length (_inLexique SOURCE_FILE_AT_LINE (324)))).isBuiltAndTrue ()) {
              ...
              while ((operand_12479 != NULL)
                ...
                if (((operand_12479->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (327))) != (operand_12561->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (327)))).isBuiltAndTrue ()) {
                    operand_12561->mSharedPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "the type of the parameter is '@")) + (operand_12561->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (328))))) + (GGS_string (true, "', while a '@")))) + (operand_12479->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (329))))) + (GGS_string (true, "' type is expected"))) SOURCE_FILE_AT_LINE (329)) ;
                }
                operand_12479 = operand_12479->nextObject () ;
                operand_12561 = operand_12561->nextObject () ;
              }
            }else{
                var_cas_signatureLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, " this instruction names ")) + (var_cas_signature.reader_length (_inLexique SOURCE_FILE_AT_LINE (333)).reader_string (_inLexique SOURCE_FILE_AT_LINE (333))))) + (GGS_string (true, " shared property(ies) as parameters, while the constraint definition requires ")))) + (var_cas_sharedPropertyList.reader_length (_inLexique SOURCE_FILE_AT_LINE (335)).reader_string (_inLexique SOURCE_FILE_AT_LINE (335)))) SOURCE_FILE_AT_LINE (335)) ;
            }
          }
...
pr_constraint_map_declaration_constraint_parser_365_34_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioEntityMap.reader_hasKey (_inLexique, var_cas_mapIdentifier.reader_value (_inLexique SOURCE_FILE_AT_LINE (372)) SOURCE_FILE_AT_LINE (372))).isBuiltAndTrue ()) {
      var_cas_mapIdentifier.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "An entity has been declared with this name") SOURCE_FILE_AT_LINE (373)) ;
  }
...
pr_constraints_on_entity_declaration_constraint_parser_404_41_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (431))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    if ((var_cas_ioConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (432)) SOURCE_FILE_AT_LINE (432))).isBuiltAndTrue ()) {
      ...
      var_cas_ioConstrainedEntityMap.methode_searchKey (_inLexique, var_cas_superEntity, var_cas_passesDefinedByInheritanceTreeRootEntity, var_cas_inheritedConstrainedEntityPassMap, var_cas_16003, var_cas_16014, var_cas_16025, var_cas_16036, var_cas_16047, var_cas_allMapsAsConstraintPropertyMap SOURCE_FILE_AT_LINE (434)) ;
        ...
        var_cas_entityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "constraints for super entity ('@")) + (var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (446))))) + (GGS_string (true, "') should be previously defined"))) SOURCE_FILE_AT_LINE (446)) ;
    }
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_constraint_parser_4 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_index.reader_value (_inLexique SOURCE_FILE_AT_LINE (460))) < (var_cas_currentIndex)).isBuiltAndTrue ()) {
              var_cas_passName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the pass order is incorrect") SOURCE_FILE_AT_LINE (461)) ;
          }
          var_cas_currentIndex = var_cas_index.reader_value (_inLexique SOURCE_FILE_AT_LINE (463)) ;
          GGS_sharedPropertyList  var_cas_sharedPropertyList ;
          var_cas_sharedPropertyList = GGS_sharedPropertyList::constructor_empty (HERE) ;
          switch (select_constraint_parser_5 (_inLexique)) {
            case 1 : {
              if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (467))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
            ...
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
              if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (472))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "as the '@")) + (var_cas_entityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (473))))) + (GGS_string (true, "' entity has a super entity, you cannot define any shared property"))) SOURCE_FILE_AT_LINE (474)) ;
              }
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (481)) SOURCE_FILE_AT_LINE (481))).isBuiltAndTrue ()) {
                      ...
                      var_cas_mapAsConstraintPropertyMap.methode_insertKey (_inLexique, var_cas_propertyName, var_cas_typeName, var_cas_elementTypeName, var_cas_currentIndex, var_cas_passName.reader_value (_inLexique SOURCE_FILE_AT_LINE (484)), GGS_bool (true, true) SOURCE_FILE_AT_LINE (484)) ;
                      var_cas_allMapsAsConstraintPropertyMap.methode_insertKey (_inLexique, var_cas_propertyName, var_cas_typeName, var_cas_elementTypeName, var_cas_currentIndex, var_cas_passName.reader_value (_inLexique SOURCE_FILE_AT_LINE (485)), GGS_bool (true, true) SOURCE_FILE_AT_LINE (485)) ;
                      var_cas_sharedPropertyList.addAssign_operation (var_cas_typeName, var_cas_propertyName) ;
                    }else{
                        var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled type name") SOURCE_FILE_AT_LINE (488)) ;
                    }
            ...
            while (syntaxRepeat) {
              switch (select_repeat_constraint_parser_7 (_inLexique)) {
                case 2 : {
                  ...
                  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
                  var_cas_propertyName.defineAttribute (_inLexique.tokenString, _inLexique) ;
                  if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (503)) SOURCE_FILE_AT_LINE (503))).isBuiltAndTrue ()) {
                    GGS_lstring  var_cas_elementTypeName ;
                    ...
                    var_cas_mapAsConstraintPropertyMap.methode_insertKey (_inLexique, var_cas_propertyName, var_cas_typeName, var_cas_elementTypeName, var_cas_currentIndex, var_cas_passName.reader_value (_inLexique SOURCE_FILE_AT_LINE (506)), GGS_bool (true, false) SOURCE_FILE_AT_LINE (506)) ;
                    var_cas_allMapsAsConstraintPropertyMap.methode_insertKey (_inLexique, var_cas_propertyName, var_cas_typeName, var_cas_elementTypeName, var_cas_currentIndex, var_cas_passName.reader_value (_inLexique SOURCE_FILE_AT_LINE (507)), GGS_bool (true, false) SOURCE_FILE_AT_LINE (507)) ;
                  }else{
          ...
          nt_semantic_instructions_list_ (_inLexique, var_cas_componentSemanticsEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_optionsComponentsMapForUse, var_cas_variablesMap, var_cas_instructionsList, var_cas_passName.reader_value (_inLexique SOURCE_FILE_AT_LINE (529)), var_cas_propertyMap, var_cas_mapAsConstraintPropertyMap, var_cas_constraintPropertyDefinitionSet, var_cas_callInstructionSharedPropertySignatureMap) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (546))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_19908 != NULL)) {
      ...
      var_cas_passesDefinedByInheritanceTreeRootEntity.addAssign_operation (operand_19908->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (548))) ;
      operand_19908 = operand_19908->nextObject () ;
    }
  }
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (553))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_20239 != NULL)) {
      ...
      if (((! (var_cas_passesDefinedByInheritanceTreeRootEntity.reader_hasKey (_inLexique, operand_20239->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (555)) SOURCE_FILE_AT_LINE (555))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "pass '")) + (operand_20239->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (556))))) + (GGS_string (true, "' cannot be defined because it is not defined by the constraint on '@")))) + (var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (558))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (558)) ;
      }
    ...
    while (syntaxRepeat) {
        switch (select_constraint_parser_9 (_inLexique)) {
          ...
          case 2 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
            var_cas_pathElement.defineAttribute (_inLexique.tokenString, _inLexique) ;
            var_cas_outPath.addAssign_operation (GGS_lstring::constructor_new (((GGS_string (true, ".")) + (var_cas_pathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (590)))), var_cas_pathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (590)) COMMA_HERE)) ;
            } break ;
          default :
            break ;
        }
...
pr_constraint_relation_primary_constraint_parser_649_35_ (galgas_scanner & _inLexique,
  ...
  switch (select_constraint_parser_13 (_inLexique)) {
    ...
    case 4 : {
      ...
      if (((var_cas_domainVariable.reader_value (_inLexique SOURCE_FILE_AT_LINE (676))) != (var_cas_domainVariableFromIndex.reader_value (_inLexique SOURCE_FILE_AT_LINE (676)))).isBuiltAndTrue ()) {
          var_cas_indexVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_value (_inLexique SOURCE_FILE_AT_LINE (677))))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_value (_inLexique SOURCE_FILE_AT_LINE (678))))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_value (_inLexique SOURCE_FILE_AT_LINE (679))))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (679)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
