...
pr_parse_constraint_document_constraint_parser_183_33_ (galgas_scanner & _inLexique,
  ...
  if (((! (var_cas_constraintOnRootEntity))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "no constraint is defined on metamodel root entity") SOURCE_FILE_AT_LINE (257)) ;
  }
  if ((var_cas_constraintOnRootEntity).isBuiltAndTrue ()) {
    ...
    while ((operand_9177 != NULL)) {
      ...
      if (((operand_9177->mInfo.mSharedPropertyList.reader_length (_inLexique SOURCE_FILE_AT_LINE (283))) != (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
          operand_9177->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a pass of the root entity constraint should not define any shared prperty") SOURCE_FILE_AT_LINE (284)) ;
      }
      ...
      if (((operand_9743->mInfo.mKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        ...
        while ((operand_10174 != NULL)) {
          ...
          if (((! (operand_9504->mInfo.mConstrainedEntityPassMap.reader_hasKey (_inLexique, operand_10174->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (296)) SOURCE_FILE_AT_LINE (296))))).isBuiltAndTrue ()) {
              operand_9504->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this constraint should define the '")) + (operand_10174->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (297))))) + (GGS_string (true, "' pass (due to '")))) + (operand_9743->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (298))))) + (GGS_string (true, "' reference)"))) SOURCE_FILE_AT_LINE (298)) ;
          }
...
pr_constraints_on_entity_declaration_constraint_parser_395_41_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (424))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    if ((var_cas_ioConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (425)) SOURCE_FILE_AT_LINE (425))).isBuiltAndTrue ()) {
      GGS_lstring  var_cas_15776 ;
      GGS_entityPropertyMap  var_cas_15787 ;
      GGS_stringset  var_cas_15798 ;
      GGS_location  var_cas_15809 ;
      GGS_mapAsConstraintPropertyMap  var_cas_15820 ;
      GGS_indexMap  var_cas_15907 ;
      if (var_cas_ioConstrainedEntityMap.isBuilt ()) {
        var_cas_ioConstrainedEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_passesDefinedByInheritanceTreeRootEntity, var_cas_inheritedConstrainedEntityPassMap, var_cas_15776, var_cas_15787, var_cas_15798, var_cas_15809, var_cas_15820, var_cas_allMapsAsConstraintPropertyMap, var_cas_constraintAllPropertiesMap, var_cas_15907, var_cas_allIndexMap SOURCE_FILE_AT_LINE (427)) ;
      }
    }else{
        var_cas_entityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "constraints for super entity ('@")) + (var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (442))))) + (GGS_string (true, "') should be previously defined"))) SOURCE_FILE_AT_LINE (442)) ;
    }
  }
      ...
      switch (select_repeat_constraint_parser_3 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_index.reader_value (_inLexique SOURCE_FILE_AT_LINE (457))) < (var_cas_currentPassIndex)).isBuiltAndTrue ()) {
              var_cas_passName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the pass order is incorrect") SOURCE_FILE_AT_LINE (458)) ;
          }
          ...
          switch (select_constraint_parser_4 (_inLexique)) {
            case 1 : {
              if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (464))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_typeInstructionList  var_cas_16820 ;
                GGS_stringset  var_cas_16843 ;
                GGS_callInstructionSharedPropertySignatureMap  var_cas_16846 ;
                if (var_cas_inheritedConstrainedEntityPassMap.isBuilt ()) {
                  var_cas_inheritedConstrainedEntityPassMap (HERE)->method_searchKey (_inLexique, var_cas_passName, var_cas_16820, var_cas_sharedPropertyList, var_cas_16843, var_cas_16846 SOURCE_FILE_AT_LINE (465)) ;
                }
              }
              } break ;
            case 2 : {
              ...
              if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (469))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "as the '@")) + (var_cas_entityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (470))))) + (GGS_string (true, "' entity has a super entity, you cannot define any shared property"))) SOURCE_FILE_AT_LINE (471)) ;
              }
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (479)) SOURCE_FILE_AT_LINE (479))).isBuiltAndTrue ()) {
                      ...
                      GGS_lstring  var_cas_17443 ;
                      GGS_lstring  var_cas_17446 ;
                      if (var_cas_ioMapEntityMap.isBuilt ()) {
                        var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_elementTypeName, var_cas_17443, var_cas_17446 SOURCE_FILE_AT_LINE (481)) ;
                      }
                      ...
                      var_cas_sharedPropertyList.addAssign_operation (var_cas_typeName, var_cas_propertyName) ;
                        ...
                        var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled type name") SOURCE_FILE_AT_LINE (486)) ;
                    }
              ...
              switch (select_repeat_constraint_parser_6 (_inLexique)) {
                case 2 : {
                  ...
                  if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (502)) SOURCE_FILE_AT_LINE (502))).isBuiltAndTrue ()) {
                    GGS_lstring  var_cas_elementTypeName ;
                    GGS_lstring  var_cas_18327 ;
                    GGS_lstring  var_cas_18330 ;
                    if (var_cas_ioMapEntityMap.isBuilt ()) {
                      var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_elementTypeName, var_cas_18327, var_cas_18330 SOURCE_FILE_AT_LINE (504)) ;
                    }
                    ...
                    var_cas_allMapsAsConstraintPropertyMap.method_insertKey (_inLexique, var_cas_propertyName, var_cas_typeName, var_cas_elementTypeName, var_cas_currentPassIndex, var_cas_passName.reader_value (_inLexique SOURCE_FILE_AT_LINE (506)), GGS_bool (true, false) SOURCE_FILE_AT_LINE (506)) ;
                      ...
                      var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled type name") SOURCE_FILE_AT_LINE (508)) ;
                  }
                  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
                  } break ;
                case 3 : {
                  ...
                  GGS_lstring  var_cas_19003 ;
                  GGS_lstring  var_cas_19006 ;
                  GGS_uint  var_cas_19009 ;
                  GGS_string var_cas_19012 ;
                  GGS_bool var_cas_19015 ;
                  if (var_cas_allMapsAsConstraintPropertyMap.isBuilt ()) {
                    var_cas_allMapsAsConstraintPropertyMap (HERE)->method_searchKey (_inLexique, var_cas_mapPropertyName, var_cas_19003, var_cas_19006, var_cas_19009, var_cas_19012, var_cas_19015 SOURCE_FILE_AT_LINE (519)) ;
                  }
          ...
          GGS_entityPropertyMap::element_type * operand_19353 = var_cas_allPropertyMap.firstObject () ;
          while ((operand_19353 != NULL)) {
            macroValidPointer (operand_19353) ;
            if (((operand_19353->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              GGS_typeCplusPlusName  var_cas_cppName ;
              var_cas_cppName = GGS_typeDirectName::constructor_new (_inLexique, GGS_lstring::constructor_new (_inLexique, ((GGS_string (true, "_mMetamodelObject->")) + (operand_19353->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (531)))), operand_19353->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (531)) COMMA_HERE) COMMA_HERE) ;
              if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (532))) == (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (534)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (535))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (537)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (538))) == (GGS_string (true, "lchar"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_lchar::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (540)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (541))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (543)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (544))) == (GGS_string (true, "luint"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (546)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (547))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (549)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (550))) == (GGS_string (true, "lsint"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_lsint::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (552)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (553))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (555)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (556))) == (GGS_string (true, "lbool"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_lbool::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (558)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (559))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (561)) ;
              }else if (((operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (562))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
                GGS_AC_galgasType  var_cas_t ;
                var_cas_t = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
                var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_19353->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (564)) ;
              }else{
                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "internal error (@")) + (operand_19353->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (566))))) + (GGS_string (true, " type not handled"))) SOURCE_FILE_AT_LINE (566)) ;
              }
            }
            operand_19353 = operand_19353->nextObject () ;
          }
          GGS_mapAsConstraintPropertyMap::element_type * operand_21919 = var_cas_allMapsAsConstraintPropertyMap.firstObject () ;
          while ((operand_21919 != NULL)) {
            macroValidPointer (operand_21919) ;
            GGS_typeCplusPlusName  var_cas_cppName ;
            var_cas_cppName = GGS_typeDirectName::constructor_new (_inLexique, GGS_lstring::constructor_new (_inLexique, ((((GGS_string (true, "(* ")) + (operand_21919->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (573))))) + (GGS_string (true, ")"))), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_mapEntityInInstruction::constructor_new (_inLexique, operand_21919->mInfo.mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (574)), operand_21919->mInfo.mElementTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (574)) COMMA_HERE) ;
            if (((((operand_21919->mInfo.mPassIndex) == (var_cas_currentPassIndex)) && (var_cas_mapAsConstraintPropertyMap.reader_hasKey (_inLexique, operand_21919->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (575)) SOURCE_FILE_AT_LINE (575))))).isBuiltAndTrue ()) {
              var_cas_variablesMap.method_insertUsedInOutArgument (_inLexique, operand_21919->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (576)) ;
            }else{
              var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_21919->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (578)) ;
            }
            operand_21919 = operand_21919->nextObject () ;
          }
          GGS_indexMap::element_type * operand_22743 = var_cas_allIndexMap.firstObject () ;
          while ((operand_22743 != NULL)) {
            macroValidPointer (operand_22743) ;
            GGS_typeCplusPlusName  var_cas_cppName ;
            var_cas_cppName = GGS_typeDirectName::constructor_new (_inLexique, operand_22743->mKey COMMA_HERE) ;
            GGS_AC_galgasType  var_cas_t ;
            var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, operand_22743->mInfo.mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (584)) COMMA_HERE) ;
            if (((((operand_22743->mInfo.mPassIndex) == (var_cas_currentPassIndex)) && (var_cas_indexMap.reader_hasKey (_inLexique, operand_22743->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (585)) SOURCE_FILE_AT_LINE (585))))).isBuiltAndTrue ()) {
              var_cas_variablesMap.method_insertOutProperty (_inLexique, operand_22743->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (586)) ;
            }else{
              var_cas_variablesMap.method_insertUsedConstInArgument (_inLexique, operand_22743->mKey, var_cas_t, var_cas_cppName SOURCE_FILE_AT_LINE (588)) ;
            }
            operand_22743 = operand_22743->nextObject () ;
          }
          GGS_typeCplusPlusName  var_cas_cppName ;
  ...
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (625))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_constrainedEntityPassMap::element_type * operand_24741 = var_cas_constrainedEntityPassMap.firstObject () ;
    while ((operand_24741 != NULL)) {
      macroValidPointer (operand_24741) ;
      var_cas_passesDefinedByInheritanceTreeRootEntity.addAssign_operation (operand_24741->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (627))) ;
      operand_24741 = operand_24741->nextObject () ;
    }
  }
  if (((var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (632))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_constrainedEntityPassMap::element_type * operand_25072 = var_cas_constrainedEntityPassMap.firstObject () ;
    while ((operand_25072 != NULL)) {
      macroValidPointer (operand_25072) ;
      if (((! (var_cas_passesDefinedByInheritanceTreeRootEntity.reader_hasKey (_inLexique, operand_25072->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (634)) SOURCE_FILE_AT_LINE (634))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "pass '")) + (operand_25072->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (635))))) + (GGS_string (true, "' cannot be defined because it is not defined by the constraint on '@")))) + (var_cas_superEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (637))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (637)) ;
      }
      operand_25072 = operand_25072->nextObject () ;
    }
  }
...
pr_constraint_relation_primary_constraint_parser_731_35_ (galgas_scanner & _inLexique,
  ...
  switch (select_constraint_parser_12 (_inLexique)) {
    ...
    case 4 : {
      ...
      GGS_uint  var_cas_28805 ;
      if (var_cas_ioIndexMap.isBuilt ()) {
        var_cas_ioIndexMap (HERE)->method_searchKey (_inLexique, var_cas_indexVariableName, var_cas_domainVariableFromIndex, var_cas_28805 SOURCE_FILE_AT_LINE (757)) ;
      }
      if (((var_cas_domainVariable.reader_value (_inLexique SOURCE_FILE_AT_LINE (758))) != (var_cas_domainVariableFromIndex.reader_value (_inLexique SOURCE_FILE_AT_LINE (758)))).isBuiltAndTrue ()) {
          var_cas_indexVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_value (_inLexique SOURCE_FILE_AT_LINE (759))))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_value (_inLexique SOURCE_FILE_AT_LINE (760))))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_value (_inLexique SOURCE_FILE_AT_LINE (761))))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (761)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
