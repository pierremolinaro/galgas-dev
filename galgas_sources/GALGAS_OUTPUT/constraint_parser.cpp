...
pr_parse_constraint_document_constraint_parser_180_33_ (galgas_scanner & _inLexique,
  ...
  GGS_stringset  var_cas_7315 ;
  if (var_cas_metamodelComponentMap._isBuilt ()) {
    var_cas_metamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntity, var_cas_semanticsEntitiesMap, var_cas_metamodelEntityMap, var_cas_7315 SOURCE_FILE_AT_LINE (211)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_12963 = var_cas_metamodelEntityMap.firstObject () ;
  while ((operand_12963 != NULL)) {
    macroValidPointer (operand_12963) ;
    GGS_lstring  var_cas_representativeTypeName ;
    ::routine_computeRepresentativeEntityName (_inLexique,  var_cas_metamodelEntityMap,  var_cas_constrainedEntityMap,  operand_12963->mKey,  var_cas_representativeTypeName SOURCE_FILE_AT_LINE (325)) ;
    var_cas_representativeEntityMap.method_insertKey (_inLexique, operand_12963->mKey, var_cas_representativeTypeName, operand_12963->mInfo.mSuperClassSet SOURCE_FILE_AT_LINE (330)) ;
    operand_12963 = operand_12963->nextObject () ;
  }
  GGS_bool var_cas_performLoop ;
  var_cas_performLoop = GGS_bool (true, true) ;
  GGS_uint _variant_14470 = var_cas_metamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (334))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (334)) ;
  GGS_bool _condition_14470 (_variant_14470._isBuilt (), true) ;
  while (_condition_14470.isBuiltAndTrue ()) {
    if (_variant_14470.uintValue () == 0) {
      _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (364)) ;
      _condition_14470 = GGS_bool (true, false) ;
    }else{
      _variant_14470._decrement_operation (_inLexique COMMA_HERE) ;
      _condition_14470 = var_cas_performLoop  ;
      if (_condition_14470.isBuiltAndTrue ()) {
        ...
        GGS_entityToImplementMap::element_type * operand_13607 = var_cas_temporaryEntityMap.firstObject () ;
        while ((operand_13607 != NULL)) {
          macroValidPointer (operand_13607) ;
          if (((((operand_13607->mInfo.mSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (339))) != (GGS_string (true, ""))) & ((! (var_cas_constrainedEntityMap.reader_hasKey (_inLexique, operand_13607->mInfo.mSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (339)) SOURCE_FILE_AT_LINE (339))))))).isBuiltAndTrue ()) {
            var_cas_performLoop = GGS_bool (true, true) ;
            ...
            if (var_cas_metamodelEntityMap._isBuilt ()) {
              var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_13607->mInfo.mSuperEntityName, var_cas_allPropertiesMap, var_cas_isAbstract, var_cas_entityPropertiesMap, var_cas_superEntityName, var_cas_superClassSet SOURCE_FILE_AT_LINE (347)) ;
            }
            var_cas_constrainedEntityMap.method_insertKey (_inLexique, operand_13607->mInfo.mSuperEntityName, var_cas_allPropertiesMap, var_cas_isAbstract, var_cas_entityPropertiesMap, var_cas_superEntityName, var_cas_superClassSet SOURCE_FILE_AT_LINE (355)) ;
          }
          operand_13607 = operand_13607->nextObject () ;
        }
      }
    }
  }
  ...
  GGS_entityToImplementMap::element_type * operand_14668 = var_cas_constrainedEntityMap.firstObject () ;
  while ((operand_14668 != NULL)) {
    ...
    GGS_entityPropertyMap::element_type * operand_14972 = operand_14668->mInfo.mAllPropertiesMap.firstObject () ;
    while ((operand_14972 != NULL)) {
      macroValidPointer (operand_14972) ;
      if (((operand_14972->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_newAllPropertiesMap.method_insertKey (_inLexique, operand_14972->mKey, operand_14972->mInfo.mKind, operand_14972->mInfo.mTypeName SOURCE_FILE_AT_LINE (380)) ;
      }else if (((((operand_14972->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))) | ((operand_14972->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_representativeTypeName ;
        ::routine_computeRepresentativeEntityName (_inLexique,  var_cas_metamodelEntityMap,  var_cas_constrainedEntityMap,  operand_14972->mInfo.mTypeName,  var_cas_representativeTypeName SOURCE_FILE_AT_LINE (384)) ;
        if (((var_cas_representativeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (389))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
          var_cas_newAllPropertiesMap.method_insertKey (_inLexique, operand_14972->mKey, operand_14972->mInfo.mKind, var_cas_representativeTypeName SOURCE_FILE_AT_LINE (390)) ;
          var_cas_multiReferencedEntities._addAssign_operation (var_cas_representativeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (391))) ;
        }
      }
      operand_14972 = operand_14972->nextObject () ;
    }
    ...
    GGS_entityPropertyMap::element_type * operand_15873 = operand_14668->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_15873 != NULL)) {
      macroValidPointer (operand_15873) ;
      if (((operand_15873->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_newPropertiesMap.method_insertKey (_inLexique, operand_15873->mKey, operand_15873->mInfo.mKind, operand_15873->mInfo.mTypeName SOURCE_FILE_AT_LINE (398)) ;
      }else if (((((operand_15873->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))) | ((operand_15873->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_representativeTypeName ;
        ::routine_computeRepresentativeEntityName (_inLexique,  var_cas_metamodelEntityMap,  var_cas_constrainedEntityMap,  operand_15873->mInfo.mTypeName,  var_cas_representativeTypeName SOURCE_FILE_AT_LINE (402)) ;
        if (((var_cas_representativeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (407))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
          var_cas_newPropertiesMap.method_insertKey (_inLexique, operand_15873->mKey, operand_15873->mInfo.mKind, var_cas_representativeTypeName SOURCE_FILE_AT_LINE (408)) ;
          var_cas_multiReferencedEntities._addAssign_operation (var_cas_representativeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (409))) ;
        }
      }
      operand_15873 = operand_15873->nextObject () ;
    }
    var_cas_actualConstrainedEntityMap.method_insertKey (_inLexique, operand_14668->mKey, var_cas_newAllPropertiesMap, operand_14668->mInfo.mIsAbstract, var_cas_newPropertiesMap, operand_14668->mInfo.mSuperEntityName, operand_14668->mInfo.mSuperClassSet SOURCE_FILE_AT_LINE (414)) ;
    operand_14668 = operand_14668->nextObject () ;
  }
  if (var_cas_metamodelEntityMap._isBuilt () &&
    ...
    ::routine_generate_constraints (_inLexique,  var_cas_metamodelEntityMap,  var_cas_mapEntityMap,  var_cas_metamodelName,  var_cas_constraintName,  var_cas_actualConstrainedEntityMap,  var_cas_multiReferencedEntities,  var_cas_rootEntity,  var_cas_representativeEntityMap SOURCE_FILE_AT_LINE (424)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_constraint) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void constraint_parser::
constraint_parser::
pr_constraint_map_declaration_constraint_parser_439_34_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inMetamodelEntityMap.reader_hasKey (_inLexique, var_cas_mapIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (446)) SOURCE_FILE_AT_LINE (446))).isBuiltAndTrue ()) {
    var_cas_mapIdentifier.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "An entity has been declared with this name") SOURCE_FILE_AT_LINE (448)) ;
  }
  ...
  if (var_cas_insertErrorMessage._isBuilt ()) {
    ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_insertErrorMessage SOURCE_FILE_AT_LINE (458)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  ...
  if (var_cas_searchErrorMessage._isBuilt ()) {
    ::routine_check_K_escapeCharacters (_inLexique,  var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (465)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioMapEntityMap.method_insertKey (_inLexique, var_cas_mapIdentifier, var_cas_mapElementIdentifier, var_cas_insertErrorMessage, var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (469)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraint_map_declaration_constraint_parser_439_34_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_of) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
...
void constraint_parser::
constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_478_41_ (galgas_scanner & _inLexique,
                                GGS_entityToImplementMap  var_cas_inEntityMap,
                                GGS_mapEntityMap  &/* var_cas_ioMapEntityMap */,
                                GGS_entityToImplementMap  &var_cas_ioConstainedEntityMap) {
  ...
  if (var_cas_inEntityMap._isBuilt ()) {
    var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_propertyMap, var_cas_superEntity, var_cas_superClassSet SOURCE_FILE_AT_LINE (494)) ;
  }
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioConstainedEntityMap.method_insertKey (_inLexique, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_propertyMap, var_cas_superEntity, var_cas_superClassSet SOURCE_FILE_AT_LINE (728)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_478_41_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_on) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_constraint_parser_1 (_inLexique)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_property_path_for_constraint_constraint_parser_739_36_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        switch (select_constraint_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
            var_cas_pathElement.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
            var_cas_outPath._addAssign_operation (GGS_lstring::constructor_new (_inLexique, ((GGS_string (true, ".")) + (var_cas_pathElement.reader_string (_inLexique SOURCE_FILE_AT_LINE (751)))), var_cas_pathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (751)) COMMA_HERE)) ;
            } break ;
          default :
            break ;
        }
...
void constraint_parser::
pr_property_path_for_constraint_constraint_parser_739_36_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_5 (_inLexique)) {
          case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_expression_constraint_parser_760_38_ (galgas_scanner & _inLexique,
...
void constraint_parser::
pr_constraint_relation_expression_constraint_parser_760_38_parse (galgas_scanner & _inLexique) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_term_constraint_parser_780_32_ (galgas_scanner & _inLexique,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_term_constraint_parser_780_32_parse (galgas_scanner & _inLexique) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_factor_constraint_parser_797_34_ (galgas_scanner & _inLexique,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_factor_constraint_parser_797_34_parse (galgas_scanner & _inLexique) {
  switch (select_constraint_parser_8 (_inLexique)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_primary_constraint_parser_813_35_ (galgas_scanner & _inLexique,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_9 (_inLexique)) {
    ...
    case 4 : {
      ...
      if (var_cas_ioRelationVariableMap._isBuilt ()) {
        var_cas_ioRelationVariableMap (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_localVar, var_cas_variableIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (834)) ;
      }
      ...
      GGS_uint  var_cas_32621 ;
      if (var_cas_ioIndexMap._isBuilt ()) {
        var_cas_ioIndexMap (HERE)->method_searchKey (_inLexique, var_cas_indexVariableName, var_cas_domainVariableFromIndex, var_cas_32621 SOURCE_FILE_AT_LINE (839)) ;
      }
      if (((var_cas_domainVariable.reader_string (_inLexique SOURCE_FILE_AT_LINE (840))) != (var_cas_domainVariableFromIndex.reader_string (_inLexique SOURCE_FILE_AT_LINE (840)))).isBuiltAndTrue ()) {
        var_cas_indexVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_string (_inLexique SOURCE_FILE_AT_LINE (841))))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_string (_inLexique SOURCE_FILE_AT_LINE (842))))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_string (_inLexique SOURCE_FILE_AT_LINE (843))))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (844)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
    ...
    case 5 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_domainVariable ;
            if (var_cas_ioRelationVariableMap._isBuilt ()) {
              var_cas_ioRelationVariableMap (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_parameter, var_cas_parameterIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (859)) ;
            }
...
void constraint_parser::
pr_constraint_relation_primary_constraint_parser_813_35_parse (galgas_scanner & _inLexique) {
  switch (select_constraint_parser_9 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
      } break ;
