...
pr_parse_constraint_document_constraint_parser_169_33_ (galgas_scanner & lexique_var_,
  ...
  var_cas_metamodelComponentMap.methode_searchKey (lexique_var_, var_cas_metamodelName, var_cas_rootEntity, var_cas_semanticsEntitiesMap, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (201)) ;
  ...
  if (var_cas_entityMap.isBuilt () &&
      ...
      var_cas_constraintToImplementMap.isBuilt () &&
      var_cas_multiReferencedEntities.isBuilt () &&
      var_cas_rootEntity.isBuilt ()) {
    ::routine_generate_constraints (lexique_var_,  var_cas_entityMap,  var_cas_mapEntityMap,  var_cas_metamodelName,  var_cas_constraintName,  var_cas_constrainedEntityMap,  var_cas_constraintToImplementMap,  var_cas_multiReferencedEntities,  var_cas_rootEntity SOURCE_FILE_AT_LINE (231)) ;
  }
...
void constraint_parser::
constraint_parser::
pr_constraint_map_declaration_constraint_parser_247_34_ (galgas_scanner & lexique_var_,
  ...
  if ((var_cas_ioEntityMap.reader_hasKey (var_cas_mapIdentifier.reader_value ())).isBuiltAndTrue ()) {
      var_cas_mapIdentifier.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "An entity has been declared with this name") SOURCE_FILE_AT_LINE (255)) ;
  }
  ...
  if (var_cas_insertErrorMessage.isBuilt ()) {
    ::routine_check_KL_escapeCharacters (lexique_var_,  var_cas_insertErrorMessage SOURCE_FILE_AT_LINE (266)) ;
  }
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  ...
  if (var_cas_searchErrorMessage.isBuilt ()) {
    ::routine_check_K_escapeCharacters (lexique_var_,  var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (273)) ;
  }
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioMapEntityMap.methode_insertKey (lexique_var_, var_cas_mapIdentifier, var_cas_mapElementIdentifier, var_cas_insertErrorMessage, var_cas_searchErrorMessage SOURCE_FILE_AT_LINE (277)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraint_map_declaration_constraint_parser_247_34_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_of) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
...
void constraint_parser::
constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_286_41_ (galgas_scanner & lexique_var_,
                                GGS_entityToImplementMap  &var_cas_ioEntityMap,
                                GGS_mapEntityMap  &var_cas_ioMapEntityMap,
  ...
  var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_entityName, var_cas_allPropertyMap, var_cas_9338, var_cas_propertyMap, var_cas_superEntity SOURCE_FILE_AT_LINE (301)) ;
        ...
        while (syntaxRepeat) {
            ...
            if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_entityName.reader_value ())).isBuiltAndTrue ()) {
              ...
              var_cas_isMap = GGS_bool (true, false) ;
                ...
                var_cas_entityName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this type is not defined") SOURCE_FILE_AT_LINE (321)) ;
            }
            GGS_lstring  var_cas_contextPropertyName ;
            lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            var_cas_contextPropertyName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
            var_cas_contextPropertyMap.methode_insertKey (lexique_var_, var_cas_contextPropertyName, var_cas_entityName, var_cas_isMap SOURCE_FILE_AT_LINE (325)) ;
  ...
  if (((var_cas_superEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    if ((var_cas_ioConstrainedEntityMap.reader_hasKey (var_cas_superEntity.reader_value ())).isBuiltAndTrue ()) {
      GGS_lstring  var_cas_10346 ;
      GGS_entityPropertyMap  var_cas_10357 ;
      var_cas_ioConstrainedEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_allRelationMap, var_cas_10346, var_cas_10357 SOURCE_FILE_AT_LINE (336)) ;
    }else{
        var_cas_entityName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "constraints for super entity ('@")) + (var_cas_superEntity.reader_value ()))) + (GGS_string (true, "') should be previously defined"))) SOURCE_FILE_AT_LINE (342)) ;
    }
  }
            ...
            case 2 : {
              ...
              switch (select_constraint_parser_8 (lexique_var_)) {
                ...
                case 2 : {
                  ...
                  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
                  var_cas_indexName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
                  var_cas_indexMap.methode_insertKey (lexique_var_, var_cas_indexName, var_cas_mapPropertyName SOURCE_FILE_AT_LINE (401)) ;
                  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
                  } break ;
                default :
                  break ;
              }
              var_cas_fetchedPropertyMap.methode_insertKey (lexique_var_, var_cas_attributeName, var_cas_propertyTypeName, var_cas_fetchedAttributeName, var_cas_mapPropertyName, var_cas_indexName SOURCE_FILE_AT_LINE (405)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_relationVarMap.methode_insertKey (lexique_var_, var_cas_localVar, var_cas_domainVariable SOURCE_FILE_AT_LINE (425)) ;
          ...
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_allRelationMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (434)) ;
          var_cas_relationToImplementMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (435)) ;
          } break ;
        case 6 : {
          ...
          var_cas_relationIdentifier.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
          GGS_relationVarMap  var_cas_relationVarMap ;
          GGS_metamodelRelationExpression  var_cas_13098 ;
          var_cas_allRelationMap.methode_searchKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_13098 SOURCE_FILE_AT_LINE (442)) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
          GGS_metamodelRelationExpression  var_cas_e ;
          nt_constraint_relation_expression_ (lexique_var_, var_cas_relationVarMap, var_cas_indexMap, var_cas_e) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_relationToImplementMap.methode_insertKey (lexique_var_, var_cas_relationIdentifier, var_cas_relationVarMap, var_cas_e SOURCE_FILE_AT_LINE (447)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioConstrainedEntityMap.methode_insertKey (lexique_var_, var_cas_entityName, var_cas_allRelationMap, var_cas_superEntity, var_cas_propertyMap SOURCE_FILE_AT_LINE (451)) ;
  var_cas_ioConstraintToImplementMap.methode_insertKey (lexique_var_, var_cas_entityName, var_cas_relationToImplementMap, var_cas_superEntity, var_cas_propertyMap SOURCE_FILE_AT_LINE (457)) ;
}

//---------------------------------------------------------------------------*

void constraint_parser::
pr_constraints_on_entity_declaration_constraint_parser_286_41_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_constraint) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_constraint_parser_2 (lexique_var_)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_property_path_for_constraint_constraint_parser_466_36_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_property_path_for_constraint_constraint_parser_466_36_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_constraint_parser_11 (lexique_var_)) {
          case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_expression_constraint_parser_487_38_ (galgas_scanner & lexique_var_,
...
void constraint_parser::
pr_constraint_relation_expression_constraint_parser_487_38_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_term_constraint_parser_504_32_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_term_constraint_parser_504_32_parse (galgas_scanner & lexique_var_) {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_factor_constraint_parser_521_34_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
...
void constraint_parser::
pr_constraint_relation_factor_constraint_parser_521_34_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_14 (lexique_var_)) {
    case 1 : {
...
void constraint_parser::
constraint_parser::
pr_constraint_relation_primary_constraint_parser_537_35_ (galgas_scanner & lexique_var_,
                                GGS_relationVarMap  &var_cas_ioRelationVariableMap,
                                GGS_indexMap  &var_cas_ioIndexMap,
                                GGS_metamodelRelationExpression  &var_cas_outExpression) {
  switch (select_constraint_parser_15 (lexique_var_)) {
    ...
    case 4 : {
      ...
      GGS_lstring  var_cas_domainVariable ;
      var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_localVar, var_cas_variableIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (558)) ;
      ...
      var_cas_ioIndexMap.methode_searchKey (lexique_var_, var_cas_indexVariableName, var_cas_domainVariableFromIndex SOURCE_FILE_AT_LINE (563)) ;
      if (((var_cas_domainVariable.reader_value ()) != (var_cas_domainVariableFromIndex.reader_value ())).isBuiltAndTrue ()) {
          var_cas_indexVariableName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((((((GGS_string (true, "this index refers to the '")) + (var_cas_domainVariableFromIndex.reader_value ()))) + (GGS_string (true, "' domain, while '")))) + (var_cas_localVar.reader_value ()))) + (GGS_string (true, "' relation variable refers to the '")))) + (var_cas_domainVariable.reader_value ()))) + (GGS_string (true, "' domain"))) SOURCE_FILE_AT_LINE (567)) ;
      }
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
    ...
    case 5 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_domainVariable ;
            var_cas_ioRelationVariableMap.methode_searchKeyAndGetIndex (lexique_var_, var_cas_parameter, var_cas_parameterIndex, var_cas_domainVariable SOURCE_FILE_AT_LINE (583)) ;
...
void constraint_parser::
pr_constraint_relation_primary_constraint_parser_537_35_parse (galgas_scanner & lexique_var_) {
  switch (select_constraint_parser_15 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
      } break ;
