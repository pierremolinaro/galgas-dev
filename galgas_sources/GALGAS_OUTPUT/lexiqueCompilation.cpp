...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "_1_:\n"
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7501 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7501 = NULL ;
    while (((operand_7501 = enumerator_7501.nextObject ()))) {
      macroValidPointer (operand_7501) ;
      result << "    case " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7501->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7501->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7816 (operand_7501->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7816 = NULL ;
      while (((operand_7816 = enumerator_7816.nextObject ()))) {
        macroValidPointer (operand_7816) ;
        result << "      s." ;
        result << operand_7816->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7816->mAttributeName ;
        result << operand_7816->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8522 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8522 = NULL ;
    if (enumerator_8522.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_8522 = enumerator_8522.nextObject ()))) {
        macroValidPointer (operand_8522) ;
        result << "  {kUnicodeString_" ;
        result << operand_8522->mStartString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        result << operand_8522->mStartString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        if ((operand_8522->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8522->mEndString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << ", " ;
          result << operand_8522->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8522->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
        result << "}" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10602 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_terminalList::cElement * operand_10602 = NULL ;
    if (enumerator_10602.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_10602 = enumerator_10602.nextObject ()))) {
        macroValidPointer (operand_10602) ;
        result << "  " ;
        result << operand_10602->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " /* " ;
        result << operand_10602->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " */" ;
        if (enumerator_10602.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13819 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13819 = NULL ;
      while (((operand_13819 = enumerator_13819.nextObject ()))) {
        macroValidPointer (operand_13819) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13819->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13819->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14257 = GGS_uint (8U) ;
      if (indentation_14257.isBuilt ()) {
        result.incIndentation ((sint32) indentation_14257.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14023 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14023 = NULL ;
      while (((operand_14023 = enumerator_14023.nextObject ()))) {
        macroValidPointer (operand_14023) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14023->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14023->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14257.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_14257.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14746 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14746 = NULL ;
      while (((operand_14746 = enumerator_14746.nextObject ()))) {
        macroValidPointer (operand_14746) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14746->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14746->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15182 = GGS_uint (6U) ;
      if (indentation_15182.isBuilt ()) {
        result.incIndentation ((sint32) indentation_15182.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14950 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14950 = NULL ;
      while (((operand_14950 = enumerator_14950.nextObject ()))) {
        macroValidPointer (operand_14950) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14950->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14950->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15182.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_15182.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16503 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16503 = NULL ;
    while (((operand_16503 = enumerator_16503.nextObject ()))) {
      macroValidPointer (operand_16503) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16503->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17082 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17082 = NULL ;
    while (((operand_17082 = enumerator_17082.nextObject ()))) {
      ...
      result << operand_17082->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " (" ;
      result << operand_17082->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_17082->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_17082->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17898 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17898 = NULL ;
    while (((operand_17898 = enumerator_17898.nextObject ()))) {
      macroValidPointer (operand_17898) ;
      result << operand_17898->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_17898->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_17898->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
