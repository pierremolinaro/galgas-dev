...
//                    february 10th, 2010, at 11h14'47"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_7636 = enumerator_7636.nextObject ()))) {
      ...
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7933 (operand_7636->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7933 = NULL ;
      while (((operand_7933 = enumerator_7933.nextObject ()))) {
        macroValidPointer (operand_7933) ;
        result << "      s." ;
        result << operand_7933->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7933->mAttributeName.reader_identifierRepresentation () ;
        result << operand_7933->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8665 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (177)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8665 = NULL ;
    if (enumerator_8665.hasCurrentObject ()) {
      ...
      while (((operand_8665 = enumerator_8665.nextObject ()))) {
        ...
        result << operand_8665->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_8665->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
        result << ", " ;
        if ((operand_8665->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8665->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_8665->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8665->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
        result << ")" ;
        if (enumerator_8665.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9702 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), true) ;
    const GGS_templateReplacementList::cElement * operand_9702 = NULL ;
    if (enumerator_9702.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_9702 = enumerator_9702.nextObject ()))) {
        macroValidPointer (operand_9702) ;
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_9702->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9702->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
        result << ", kUnicodeString_" ;
        result << operand_9702->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9702->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)) ;
        result << ", " ;
        if ((operand_9702->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9702->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        }
        result << ", true)" ;
        if (enumerator_9702.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10761 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (219)), true) ;
    const GGS_terminalList::cElement * operand_10761 = NULL ;
    if (enumerator_10761.hasCurrentObject ()) {
      ...
      while (((operand_10761 = enumerator_10761.nextObject ()))) {
        ...
        result << "  " ;
        result << operand_10761->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
        result << " /* " ;
        result << operand_10761->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
        result << " */" ;
        if (enumerator_10761.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (239)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13986 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13986 = NULL ;
      while (((operand_13986 = enumerator_13986.nextObject ()))) {
        macroValidPointer (operand_13986) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13986->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_13986->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (277)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14877 = GGS_uint (8U) ;
      if (indentation_14877.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_14877.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14206 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14206 = NULL ;
      while (((operand_14206 = enumerator_14206.nextObject ()))) {
        macroValidPointer (operand_14206) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14206->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14206->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (284))) ;
      }
       ;
      if (indentation_14877.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_14877.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14912 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14912 = NULL ;
      while (((operand_14912 = enumerator_14912.nextObject ()))) {
        macroValidPointer (operand_14912) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14912->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_14912->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (302)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15639 = GGS_uint (6U) ;
      if (indentation_15639.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15639.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_15132 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_15132 = NULL ;
      while (((operand_15132 = enumerator_15132.nextObject ()))) {
        macroValidPointer (operand_15132) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_15132->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_15132->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (309))) ;
      }
       ;
      if (indentation_15639.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15639.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16681 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16681 = NULL ;
    while (((operand_16681 = enumerator_16681.nextObject ()))) {
      macroValidPointer (operand_16681) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16681->mKey.ggs_string ().reader_identifierRepresentation () ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17215 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17215 = NULL ;
    while (((operand_17215 = enumerator_17215.nextObject ()))) {
      macroValidPointer (operand_17215) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << operand_17215->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (356)) ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::attributeValue_" ;
      result << operand_17215->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17998 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17998 = NULL ;
    while (((operand_17998 = enumerator_17998.nextObject ()))) {
      ...
      result << operand_17998->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (GGS_l" ;
      result << operand_17998->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (368)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = GGS_l" ;
      result << operand_17998->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (370)) ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_18869 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_18869 = NULL ;
    while (((operand_18869 = enumerator_18869.nextObject ()))) {
      macroValidPointer (operand_18869) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << operand_18869->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (380)).reader_identifierRepresentation () ;
      result << " * C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::synthetizedAttribute_" ;
      result << operand_18869->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << operand_18869->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (384)).reader_identifierRepresentation () ;
      ...
      result << " COMMA_HERE) ;\n"
        "  return GALGAS_l" ;
      result << operand_18869->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (385)).reader_identifierRepresentation () ;
