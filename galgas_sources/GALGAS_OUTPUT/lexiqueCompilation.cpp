...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13716 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13716 = NULL ;
      while (((operand_13716 = enumerator_13716.nextObject ()))) {
        macroValidPointer (operand_13716) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13716->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13716->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14154 = GGS_uint (8U) ;
      if (indentation_14154.isBuilt ()) {
        result.incIndentation ((sint32) indentation_14154.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_13920 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_13920 = NULL ;
      while (((operand_13920 = enumerator_13920.nextObject ()))) {
        macroValidPointer (operand_13920) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_13920->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_13920->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14154.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_14154.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14643 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14643 = NULL ;
      while (((operand_14643 = enumerator_14643.nextObject ()))) {
        macroValidPointer (operand_14643) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14643->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14643->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15079 = GGS_uint (6U) ;
      if (indentation_15079.isBuilt ()) {
        result.incIndentation ((sint32) indentation_15079.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14847 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14847 = NULL ;
      while (((operand_14847 = enumerator_14847.nextObject ()))) {
        macroValidPointer (operand_14847) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14847->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14847->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15079.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_15079.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16402 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16402 = NULL ;
    while (((operand_16402 = enumerator_16402.nextObject ()))) {
      macroValidPointer (operand_16402) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16402->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_16981 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16981 = NULL ;
    while (((operand_16981 = enumerator_16981.nextObject ()))) {
      macroValidPointer (operand_16981) ;
      result << "void " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "assignFromAttribute_" ;
      result << operand_16981->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " (" ;
      result << operand_16981->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_16981->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_16981->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17797 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17797 = NULL ;
    while (((operand_17797 = enumerator_17797.nextObject ()))) {
      macroValidPointer (operand_17797) ;
      result << operand_17797->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_17797->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_17797->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
