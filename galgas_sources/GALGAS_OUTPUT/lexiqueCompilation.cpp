...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  result << "\n"
    ...
    "void C_Lexique_" ;
  result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
  result << "::appendTerminalMessageToSyntaxErrorMessage (const int16_t inTerminalIndex,\n"
    "                                           C_String & outSyntaxErrorMessage) {\n"
    "  static const utf32 * syntaxErrorMessageArray [" ;
  result << in_TERMINAL_5F_LIST.reader_length (SOURCE_FILE_AT_LINE (105)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).reader_string (SOURCE_FILE_AT_LINE (105)).stringValue () ;
  result << "] = {kEndOfSourceLexicalErrorMessage" ;
  GALGAS_uint index_5083_ (0) ;
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_5083 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_5083.hasCurrentObject ()) {
      result << ",\n"
        "    gSyntaxErrorMessage_" ;
      result << enumerator_5083.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (107)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (107)).stringValue () ;
  ...
  if (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES.isValid ()) {
    cEnumerator_stringset enumerator_5705 (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES, kEnumeration_up) ;
    while (enumerator_5705.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5705.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (120)).stringValue () ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5705.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (121)).stringValue () ;
      result << " [] = " ;
      result << enumerator_5705.current_key (HERE).reader_utf_33__32_Representation (SOURCE_FILE_AT_LINE (121)).stringValue () ;
      result << " ;\n" ;
  ...
  if (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP.isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5956 (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP, kEnumeration_up) ;
    while (enumerator_5956.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "//                                                                             *\n"
        "//             Key words table '" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (128)).stringValue () ;
      result << "'                            *\n"
        "//                                                                             *\n"
        "//-----------------------------------------------------------------------------*\n"
        "\n"
        "static const int32_t ktable_size_" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " = " ;
      result << enumerator_5956.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (131)).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
      result << " [ktable_size_" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_6721_ (0) ;
      if (enumerator_5956.current_mTokenSortedList (HERE).isValid ()) {
        cEnumerator_tokenSortedlist enumerator_6721 (enumerator_5956.current_mTokenSortedList (HERE), kEnumeration_up) ;
        while (enumerator_6721.hasCurrentObject ()) {
          result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
          result << enumerator_6721.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ", " ;
          result << enumerator_6721.current_mLength (HERE).reader_string (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ", C_Lexique_" ;
          result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
          result << "::kToken_" ;
          result << enumerator_6721.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ")" ;
      ...
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::search_into_" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).stringValue () ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).stringValue () ;
      result << ", ktable_size_" ;
      result << enumerator_5956.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).stringValue () ;
      result << ") ;\n"
        "}\n"
  ...
  result << " *) inTokenPtr ;\n"
    ...
    "      s.appendCString(\"$$\") ;\n"
    "      break ;\n" ;
  GALGAS_uint index_8053_ (0) ;
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_8053 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_8053.hasCurrentObject ()) {
      result << "    case kToken_" ;
      result << enumerator_8053.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (160)).stringValue () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << enumerator_8053.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (162)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (162)).stringValue () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GALGAS_uint index_8383_ (0) ;
      if (enumerator_8053.current_mSentAttributeList (HERE).isValid ()) {
        cEnumerator_lexicalSentValueList enumerator_8383 (enumerator_8053.current_mSentAttributeList (HERE), kEnumeration_up) ;
        while (enumerator_8383.hasCurrentObject ()) {
          result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
            "      s." ;
          result << categoryReader_appendMethodName (enumerator_8383.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << " (ptr->mLexicalAttribute_" ;
          result << enumerator_8383.current_mLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << categoryReader_appendArgumentOfMethod (enumerator_8383.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << ") ;\n" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_9347 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_9347 = enumerator_9347.hasCurrentObject () ;
    if (nonEmpty_enumerator_9347) {
    ...
    while (enumerator_9347.hasCurrentObject ()) {
      ...
      result << enumerator_9347.current_mStartString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (185)).stringValue () ;
      result << ", " ;
      result << enumerator_9347.current_mStartString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (185)).reader_string (SOURCE_FILE_AT_LINE (185)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_9347.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (186)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "NULL, 0," ;
      }else if (kBoolFalse == test_2) {
        result << "kUnicodeString_" ;
        result << enumerator_9347.current_mEndString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (189)).stringValue () ;
        result << ", " ;
        result << enumerator_9347.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (189)).reader_string (SOURCE_FILE_AT_LINE (189)).stringValue () ;
        result << "," ;
      }
      result << " NULL, " ;
      result << enumerator_9347.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (192)).reader_cString (SOURCE_FILE_AT_LINE (192)).stringValue () ;
      result << ")" ;
      if (enumerator_9347.hasNextObject ()) {
        result << ",\n" ;
      }
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_10397 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)), kEnumeration_up) ;
    ...
    while (enumerator_10397.hasCurrentObject ()) {
      result << "  cTemplateDelimiter (kUnicodeString_" ;
      result << enumerator_10397.current_mMatchString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", " ;
      result << enumerator_10397.current_mMatchString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (207)).reader_string (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", kUnicodeString_" ;
      result << enumerator_10397.current_mReplacementString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (208)).stringValue () ;
      result << ", " ;
      result << enumerator_10397.current_mReplacementString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (208)).reader_string (SOURCE_FILE_AT_LINE (208)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_10397.current_mReplacementFunction (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (209)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "NULL" ;
      }else if (kBoolFalse == test_3) {
        result << "scanner_routine_" ;
        result << enumerator_10397.current_mReplacementFunction (HERE).reader_string (SOURCE_FILE_AT_LINE (212)).stringValue () ;
      }
      result << ", true)" ;
  ...
  result << "\n"
    ...
    "//-----------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (225)).reader_length (SOURCE_FILE_AT_LINE (225)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_uint index_11522_ (0) ;
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (226)).isValid ()) {
      cEnumerator_terminalList enumerator_11522 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (226)), kEnumeration_up) ;
      const bool nonEmpty_enumerator_11522 = enumerator_11522.hasCurrentObject () ;
      if (nonEmpty_enumerator_11522) {
      ...
      while (enumerator_11522.hasCurrentObject ()) {
        result << "  " ;
        result << enumerator_11522.current_mIsEndOfTemplateMark (HERE).reader_cString (SOURCE_FILE_AT_LINE (228)).stringValue () ;
        result << " /* " ;
        result << enumerator_11522.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (228)).stringValue () ;
        result << " */" ;
        if (enumerator_11522.hasNextObject ()) {
          result << ",\n" ;
        }
        index_11522_.increment () ;
  ...
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (247)).reader_length (SOURCE_FILE_AT_LINE (247)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    ...
    GALGAS_uint index_14646_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_14646 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_14646.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_14646.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (285)).stringValue () ;
        result << categoryReader_initialization (enumerator_14646.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (285)).stringValue () ;
        result << " ;\n" ;
        index_14646_.increment () ;
    ...
    GALGAS_uint index_14867_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_14867 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_14867.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_14867.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)).stringValue () ;
        index_14867_.increment () ;
    ...
    GALGAS_uint index_15573_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_15573 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_15573.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_15573.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (310)).stringValue () ;
        result << categoryReader_initialization (enumerator_15573.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (310)).stringValue () ;
        result << " ;\n" ;
        index_15573_.increment () ;
    ...
    GALGAS_uint index_15794_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_15794 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_15794.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_15794.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (317)).stringValue () ;
        index_15794_.increment () ;
  ...
  GALGAS_uint index_17352_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17352 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17352.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_17352.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (352)).stringValue () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << enumerator_17352.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (352)).stringValue () ;
      result << " ;\n" ;
      index_17352_.increment () ;
  ...
  result << "  enterTokenFromPointer (ptr) ;\n"
    ...
    "//                                                                             *\n" ;
  GALGAS_uint index_17896_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17896 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17896.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_17896.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (364)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_17896.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (364)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      ...
      result << enumerator_17896.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (366)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
      index_17896_.increment () ;
  ...
  result << "//-----------------------------------------------------------------------------*\n"
    ...
    "//                                                                             *\n" ;
  GALGAS_uint index_18691_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_18691 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_18691.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18691.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (376)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (376)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_18691.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (376)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18691.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (380)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (380)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_18691.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (380)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18691.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (381)).stringValue () ;
      result << " result (value, currentLocation) ;\n"
        "  return result ;\n"
        "}\n"
        "\n" ;
      index_18691_.increment () ;
  ...
  GALGAS_uint index_20184_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (393)).isValid ()) {
    cEnumerator_terminalList enumerator_20184 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (393)), kEnumeration_up) ;
    while (enumerator_20184.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_20184.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (394)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
      index_20184_.increment () ;
