...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP.isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_6101 (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP, kEnumeration_up) ;
    while (enumerator_6101.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (128)).stringValue () ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const PMSInt32 ktable_size_" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " = " ;
      result << enumerator_6101.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (131)).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
      result << " [ktable_size_" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_6697_ (0) ;
      if (enumerator_6101.current_mTokenSortedList (HERE).isValid ()) {
        cEnumerator_tokenSortedlist enumerator_6697 (enumerator_6101.current_mTokenSortedList (HERE), kEnumeration_up) ;
        while (enumerator_6697.hasCurrentObject ()) {
          result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
          result << enumerator_6697.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ", " ;
          result << enumerator_6697.current_mLength (HERE).reader_string (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ", C_Lexique_" ;
          result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
          result << "::kToken_" ;
          result << enumerator_6697.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ")" ;
          if (enumerator_6697.hasNextObject ()) {
            result << ",\n" ;
          }
          index_6697_.increment () ;
      ...
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::search_into_" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).stringValue () ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).stringValue () ;
      result << ", ktable_size_" ;
      result << enumerator_6101.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).stringValue () ;
      result << ") ;\n"
        "}\n"
  ...
  result << " *) inTokenPtr ;\n"
    ...
    "      s.appendCString(\"$$\") ;\n"
    "      break ;\n" ;
  GALGAS_uint index_7991_ (0) ;
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_7991 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_7991.hasCurrentObject ()) {
      result << "    case kToken_" ;
      result << enumerator_7991.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (160)).stringValue () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << enumerator_7991.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (162)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (162)).stringValue () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GALGAS_uint index_8387_ (0) ;
      if (enumerator_7991.current_mSentAttributeList (HERE).isValid ()) {
        cEnumerator_lexicalSentValueList enumerator_8387 (enumerator_7991.current_mSentAttributeList (HERE), kEnumeration_up) ;
        while (enumerator_8387.hasCurrentObject ()) {
          result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
            "      s." ;
          result << categoryReader_appendMethodName (enumerator_8387.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << " (ptr->mLexicalAttribute_" ;
          result << enumerator_8387.current_mLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << categoryReader_appendArgumentOfMethod (enumerator_8387.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << ") ;\n" ;
          index_8387_.increment () ;
          enumerator_8387.gotoNextObject () ;
        }
      }
      result << "      break ;\n" ;
      index_7991_.increment () ;
      enumerator_7991.gotoNextObject () ;
    }
  }
  result << "    default:\n"
    "      break ;\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_9293_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_9293 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_9293 = enumerator_9293.hasCurrentObject () ;
    if (nonEmpty_enumerator_9293) {
    ...
    while (enumerator_9293.hasCurrentObject ()) {
      ...
      result << enumerator_9293.current_mStartString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (185)).stringValue () ;
      result << ", " ;
      result << enumerator_9293.current_mStartString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (185)).reader_string (SOURCE_FILE_AT_LINE (185)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_9293.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (186)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "NULL, 0," ;
      }else if (kBoolFalse == test_2) {
        result << "kUnicodeString_" ;
        result << enumerator_9293.current_mEndString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (189)).stringValue () ;
        result << ", " ;
        result << enumerator_9293.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (189)).reader_string (SOURCE_FILE_AT_LINE (189)).stringValue () ;
        result << "," ;
      }
      result << " NULL, " ;
      result << enumerator_9293.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (192)).reader_cString (SOURCE_FILE_AT_LINE (192)).stringValue () ;
      result << ")" ;
      if (enumerator_9293.hasNextObject ()) {
        result << ",\n" ;
      }
      index_9293_.increment () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_10339 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_10339 = enumerator_10339.hasCurrentObject () ;
    if (nonEmpty_enumerator_10339) {
    ...
    while (enumerator_10339.hasCurrentObject ()) {
      result << "  cTemplateDelimiter (kUnicodeString_" ;
      result << enumerator_10339.current_mMatchString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", " ;
      result << enumerator_10339.current_mMatchString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (207)).reader_string (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", kUnicodeString_" ;
      result << enumerator_10339.current_mReplacementString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (208)).stringValue () ;
      result << ", " ;
      result << enumerator_10339.current_mReplacementString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (208)).reader_string (SOURCE_FILE_AT_LINE (208)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_10339.current_mReplacementFunction (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (209)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "NULL" ;
      }else if (kBoolFalse == test_3) {
        result << "scanner_routine_" ;
        result << enumerator_10339.current_mReplacementFunction (HERE).reader_string (SOURCE_FILE_AT_LINE (212)).stringValue () ;
      }
      result << ", true)" ;
      if (enumerator_10339.hasNextObject ()) {
        result << ",\n" ;
      }
  ...
  result << "\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_11336_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (225)).isValid ()) {
    cEnumerator_terminalList enumerator_11336 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (225)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_11336 = enumerator_11336.hasCurrentObject () ;
    if (nonEmpty_enumerator_11336) {
    ...
    while (enumerator_11336.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_11336.current_mIsEndOfTemplateMark (HERE).reader_cString (SOURCE_FILE_AT_LINE (227)).stringValue () ;
      result << " /* " ;
      result << enumerator_11336.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (227)).stringValue () ;
      result << " */" ;
  ...
  if (kBoolTrue == test_4) {
    ...
    GALGAS_uint index_14466_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_14466 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_14466.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_14466.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (283)).stringValue () ;
        result << categoryReader_initialization (enumerator_14466.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)).stringValue () ;
        result << " ;\n" ;
        index_14466_.increment () ;
    ...
    GALGAS_uint index_14659_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_14659 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_14659.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_14659.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (290)).stringValue () ;
        index_14659_.increment () ;
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_15393 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_15393.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_15393.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (308)).stringValue () ;
        result << categoryReader_initialization (enumerator_15393.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (308)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_15586_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_15586 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_15586.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_15586.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)).stringValue () ;
        index_15586_.increment () ;
  ...
  GALGAS_uint index_17159_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17159 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17159.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_17159.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (350)).stringValue () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << enumerator_17159.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (350)).stringValue () ;
      result << " ;\n" ;
      index_17159_.increment () ;
  ...
  result << "  enterTokenFromPointer (ptr) ;\n"
    ...
    "//                                                                           *\n" ;
  GALGAS_uint index_17757_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17757 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17757.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_17757.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (362)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_17757.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (362)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      ...
      result << enumerator_17757.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (364)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
  ...
  result << "//---------------------------------------------------------------------------*\n"
    ...
    "//                                                                           *\n" ;
  GALGAS_uint index_18552_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_18552 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_18552.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18552.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (374)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (374)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_18552.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (374)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18552.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (378)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (378)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_18552.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (378)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18552.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (379)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (379)).stringValue () ;
      result << " result (value, currentLocation) ;\n"
        "  return result ;\n"
        "}\n"
        "\n" ;
      index_18552_.increment () ;
  ...
  GALGAS_uint index_19977_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (391)).isValid ()) {
    cEnumerator_terminalList enumerator_19977 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (391)), kEnumeration_up) ;
    while (enumerator_19977.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_19977.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (392)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
      index_19977_.increment () ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_1597 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_1597.hasCurrentObject ()) {
      result << "    mLexicalAttribute_" ;
      result << enumerator_1597.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (36)).stringValue () ;
      result << " = " ;
      result << categoryReader_cocoaInitializationCode (enumerator_1597.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (36)).stringValue () ;
      result << " ;\n" ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (42)).isValid ()) {
      cEnumerator_templateDelimitorList enumerator_2089 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (42)), kEnumeration_up) ;
      while (enumerator_2089.hasCurrentObject ()) {
        result << "      [[OC_GGS_TemplateDelimiter alloc] initWithStartString:@" ;
        result << enumerator_2089.current_mStartString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (43)).stringValue () ;
        result << " endString:" ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_2089.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (44)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_3) {
          result << "nil" ;
        }else if (kBoolFalse == test_3) {
          result << "@" ;
          result << enumerator_2089.current_mEndString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (47)).stringValue () ;
        }
        result << " discardStartString:" ;
        result << enumerator_2089.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (50)).reader_ocString (SOURCE_FILE_AT_LINE (50)).stringValue () ;
        result << "],\n" ;
  ...
  if (kBoolTrue == test_4) {
    ...
    if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (60)).isValid ()) {
      cEnumerator_templateReplacementListAST enumerator_2772 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (60)), kEnumeration_up) ;
      while (enumerator_2772.hasCurrentObject ()) {
        result << "      @" ;
        result << enumerator_2772.current_mMatchString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (61)).stringValue () ;
        result << ", " ;
  ...
  GALGAS_uint index_4131_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (96)).isValid ()) {
    cEnumerator_indexingListAST enumerator_4131 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (96)), kEnumeration_up) ;
    while (enumerator_4131.hasCurrentObject ()) {
      result << "    @" ;
      result << enumerator_4131.current_mIndexComment (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (97)).stringValue () ;
      result << ",\n" ;
      index_4131_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (109)).isValid ()) {
    cEnumerator_terminalList enumerator_4841 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (109)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_4841 = enumerator_4841.hasCurrentObject () ;
    if (nonEmpty_enumerator_4841) {
    ...
    while (enumerator_4841.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4841.current_mIsEndOfTemplateMark (HERE).reader_ocString (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " /* " ;
      result << enumerator_4841.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (118)).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5044 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (118)), kEnumeration_up) ;
    while (enumerator_5044.hasCurrentObject ()) {
      const enumGalgasBool test_5 = enumerator_5044.current_mShouldBeGenerated (HERE).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << enumerator_5044.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (122)).stringValue () ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << enumerator_5044.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
        result << " [" ;
        result << enumerator_5044.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
        result << "] = {\n" ;
        GALGAS_uint index_5792_ (0) ;
        if (enumerator_5044.current_mTokenSortedList (HERE).isValid ()) {
          cEnumerator_tokenSortedlist enumerator_5792 (enumerator_5044.current_mTokenSortedList (HERE), kEnumeration_up) ;
          while (enumerator_5792.hasCurrentObject ()) {
            result << "  {" ;
            result << enumerator_5792.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
            result << ", " ;
            result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
            result << "_1_" ;
            result << enumerator_5792.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
            result << "}" ;
            if (enumerator_5792.hasNextObject ()) {
              result << ",\n" ;
            }
            index_5792_.increment () ;
        ...
        result << "_" ;
        result << enumerator_5044.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
        ...
        result << "_" ;
        result << enumerator_5044.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << ", " ;
        result << enumerator_5044.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (132)).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << ") ;\n"
          "}\n"
          "\n" ;
  ...
  if (kBoolTrue == test_6) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8243 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8243.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8243.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8243.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8243.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_8459_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8459 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8459.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8459.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)).stringValue () ;
        index_8459_.increment () ;
    ...
    GALGAS_uint index_9096_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_9096 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_9096.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_9096.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_9096.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_9096.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << " ;\n" ;
        index_9096_.increment () ;
    ...
    GALGAS_uint index_9310_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_9310 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_9310.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_9310.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (199)).stringValue () ;
        index_9310_.increment () ;
  ...
  result << "] = {0" ;
  GALGAS_uint index_11900_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (253)).isValid ()) {
    cEnumerator_terminalList enumerator_11900 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (253)), kEnumeration_up) ;
    while (enumerator_11900.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11900.current_mStyleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11900.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (254)).stringValue () ;
      result << " */" ;
      index_11900_.increment () ;
  ...
  result << "] = {NO" ;
  GALGAS_uint index_12717_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (267)).isValid ()) {
    cEnumerator_terminalList enumerator_12717 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (267)), kEnumeration_up) ;
    while (enumerator_12717.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_12717.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_12717.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (268)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      result << " */" ;
      index_12717_.increment () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13690 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)), kEnumeration_up) ;
    while (enumerator_13690.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13690.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (285)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (285)).stringValue () ;
  ...
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_14614_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_14614 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)), kEnumeration_up) ;
    while (enumerator_14614.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14614.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (304)).stringValue () ;
      result << "\"" ;
      index_14614_.increment () ;
      enumerator_14614.gotoNextObject () ;
    }
  }
  result << "\n"
    "    } ;\n"
...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lexicalAttributeListAST enumerator_34263 (constinArgument_inLexicalAttributeList, kEnumeration_up) ;
  while (enumerator_34263.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inLexicalTypeMap.reader_hasKey (enumerator_34263.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (826)) COMMA_SOURCE_FILE_AT_LINE (826)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lexicalTypeEnum var_lexicalType ;
      constinArgument_inLexicalTypeMap.method_searchKey (enumerator_34263.current_mTypeName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
      {
      ioArgument_ioLexicalAttributeMap.modifier_insertKey (enumerator_34263.current_mName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (829)) ;
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_m = GALGAS_string::makeEmptyString () ;
      var_m.dotAssign_operation (GALGAS_string ("the @").operator_concat (enumerator_34263.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)).operator_concat (GALGAS_string (" type is not a valid lexical attribute type; are allowed:") COMMA_SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)) ;
      GALGAS_bool var_firstLoop = GALGAS_bool (true) ;
      cEnumerator_lexicalTypeMap enumerator_34677 (constinArgument_inLexicalTypeMap, kEnumeration_up) ;
      while (enumerator_34677.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" @").operator_concat (enumerator_34677.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) ;
        if (enumerator_34677.hasNextObject ()) {
          var_m.dotAssign_operation (GALGAS_string (",") COMMA_SOURCE_FILE_AT_LINE (837)) ;
        }
        enumerator_34677.gotoNextObject () ;
      }
      GALGAS_location location_1 (enumerator_34263.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  cEnumerator_externRoutineListAST enumerator_36083 (constinArgument_inLexiqueComponentRoot.reader_mExternRoutineList (SOURCE_FILE_AT_LINE (867)), kEnumeration_up) ;
  while (enumerator_36083.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_36217 (enumerator_36083.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_36217.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_36217.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_36217.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_36217.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
      enumerator_36217.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_36083.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_36083.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (874)) ;
    }
    enumerator_36083.gotoNextObject () ;
  }
  ...
  cEnumerator_externFunctionListAST enumerator_36887 (constinArgument_inLexiqueComponentRoot.reader_mExternFunctionList (SOURCE_FILE_AT_LINE (880)), kEnumeration_up) ;
  while (enumerator_36887.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_37024 (enumerator_36887.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_37024.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_37024.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (884)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_37024.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (885)) COMMA_SOURCE_FILE_AT_LINE (885)) ;
      enumerator_37024.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_36887.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_36887.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
    }
  ...
  cEnumerator_lexicalStyleListAST enumerator_38841 (constinArgument_inLexiqueComponentRoot.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (920)), kEnumeration_up) ;
  while (enumerator_38841.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_38841.current_mName (HERE), enumerator_38841.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
    var_styleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (922)) ;
    enumerator_38841.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_terminalDeclarationListAST enumerator_39303 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (931)), kEnumeration_up) ;
  while (enumerator_39303.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((PMUInt32) 0U) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_39303.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (933)).reader_length (SOURCE_FILE_AT_LINE (933)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_lstring joker_39443_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (934)).method_searchKey (enumerator_39303.current_mStyle (HERE), joker_39443_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_39570 (enumerator_39303.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_39570.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_39570.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
      var_argumentTypeList.addAssign_operation (enumerator_39570.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (940)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (940)) ;
      enumerator_39570.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_39303.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_39982 (enumerator_39303.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_39982.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_39982.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (946)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_3) {
        const enumGalgasBool test_4 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_4) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (enumerator_39982.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_39982.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (952)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_39982.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          if (kBoolTrue == test_8) {
            GALGAS_location location_9 (enumerator_39982.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_39303.current_mName (HERE), var_argumentTypeList, enumerator_39303.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (963)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (960)) ;
    enumerator_39303.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_40839 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (969)), kEnumeration_up) ;
  while (enumerator_40839.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((PMUInt32) 0U) ;
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, enumerator_40839.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (971)).reader_length (SOURCE_FILE_AT_LINE (971)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_lstring joker_40979_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (972)).method_searchKey (enumerator_40839.current_mStyle (HERE), joker_40979_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_41106 (enumerator_40839.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_41106.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_41106.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (977)) ;
      var_argumentTypeList.addAssign_operation (enumerator_41106.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (978)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (978)) ;
    ...
    cEnumerator_lexicalListEntryListAST enumerator_41481 (enumerator_40839.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_41481.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_40839.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (983)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_41481.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (983)), inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_41727 (enumerator_41481.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_41727.hasCurrentObject ()) {
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_41727.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (987)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_12) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_12) {
            GALGAS_location location_13 (enumerator_41727.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_41727.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (993)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_14) {
            GALGAS_location location_15 (enumerator_41727.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            if (kBoolTrue == test_16) {
              GALGAS_location location_17 (enumerator_41727.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_41727.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_41481.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (1001)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_41481.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1009)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_41481.current_mEntrySpelling (HERE), enumerator_41481.current_mTerminalSpelling (HERE), enumerator_41481.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_41481.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)).reader_length (SOURCE_FILE_AT_LINE (1011)), enumerator_41481.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)), enumerator_41481.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_41481.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
      enumerator_41481.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_40839.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    }
    enumerator_40839.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_43213 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE_AT_LINE (1017)), kEnumeration_up) ;
  while (enumerator_43213.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_43213.current_mMessageName (HERE), enumerator_43213.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1018)) ;
    }
    enumerator_43213.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_43436 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE_AT_LINE (1021)), kEnumeration_up) ;
  while (enumerator_43436.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_43436.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    enumerator_43436.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_43638 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE_AT_LINE (1025)), kEnumeration_up) ;
  while (enumerator_43638.hasCurrentObject ()) {
    const enumGalgasBool test_18 = enumerator_43638.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE_AT_LINE (1026)).boolEnum () ;
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_43638.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_19, GALGAS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (1027)) ;
    }
    enumerator_43638.gotoNextObject () ;
  }
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_43858 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (1031)), kEnumeration_up) ;
  while (enumerator_43858.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43858.current_mStartString (HERE).reader_string (SOURCE_FILE_AT_LINE (1032)) COMMA_SOURCE_FILE_AT_LINE (1032)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43858.current_mEndString (HERE).reader_string (SOURCE_FILE_AT_LINE (1033)) COMMA_SOURCE_FILE_AT_LINE (1033)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_44086 (enumerator_43858.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_44086.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_44086.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1036)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        GALGAS_location location_21 (enumerator_44086.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        if (kBoolTrue == test_22) {
          GALGAS_location location_23 (enumerator_44086.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_44086.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_43858.current_mStartString (HERE), enumerator_43858.current_mEndString (HERE), var_preservesStartDelimiter COMMA_SOURCE_FILE_AT_LINE (1044)) ;
    enumerator_43858.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_24) {
    cEnumerator_indexingListAST enumerator_44700 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1048)), kEnumeration_up) ;
    while (enumerator_44700.hasCurrentObject ()) {
      GALGAS_location location_25 (enumerator_44700.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_44700.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1052)) ;
  cEnumerator_indexingListAST enumerator_44922 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1053)), kEnumeration_up) ;
  while (enumerator_44922.hasCurrentObject ()) {
    const enumGalgasBool test_26 = var_indexNameSet.reader_hasKey (enumerator_44922.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_44922.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_44922.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)).operator_concat (GALGAS_string ("' index is already declared") COMMA_SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_44922.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1057)) COMMA_SOURCE_FILE_AT_LINE (1057)) ;
    enumerator_44922.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_45255 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (1060)), kEnumeration_up) ;
  while (enumerator_45255.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45255.current_mMatchString (HERE).reader_string (SOURCE_FILE_AT_LINE (1061)) COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45255.current_mReplacementString (HERE).reader_string (SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
    enumerator_45255.gotoNextObject () ;
  }
...
static void categoryMethod_lexicalCharacterSetMatchAST_checkLexicalExpression (const cPtr_lexicalExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_stringset enumerator_8657 (ioArgument_ioLexiqueAnalysisContext.mAttribute_mExternUnicodeTestFunctions, kEnumeration_up) ;
    while (enumerator_8657.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  ").operator_concat (enumerator_8657.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_SOURCE_FILE_AT_LINE (199)) ;
...
static void categoryMethod_lexicalStringNotMatchAST_checkLexicalExpression (const cPtr_lexicalExpressionAST * inObject,
  ...
  // index 1: attribute 'mLexicalMessage', type @lstring
  // index 2: attribute 'mMessageIsUsed', type @bool
  cMapElement_lexicalMessageMap * objectArray_9560 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (226)) ;
  if (NULL != objectArray_9560) {
      macroValidSharedObject (objectArray_9560, cMapElement_lexicalMessageMap) ;
    objectArray_9560->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalFunctionInputArgumentAST_checkLexicalFunctionCallArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  GALGAS_bool joker_13424_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (317)).method_searchKey (object->mAttribute_mFunctionName, var_lexicalFormalTypeList, var_returnedLexicalFormalType, var_replacementFunctionName, joker_13424_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (317)) ;
  ...
  cEnumerator_lexicalFunctionFormalArgumentList enumerator_14425 (var_lexicalFormalTypeList, kEnumeration_up) ;
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_14456 (object->mAttribute_mFunctionActualArgumentList, kEnumeration_up) ;
  while (enumerator_14425.hasCurrentObject () && enumerator_14456.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalFunctionCallArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) enumerator_14456.current_mLexicalActualInputArgument (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, enumerator_14425.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (345)) ;
...
static void categoryMethod_lexicalFunctionInputArgumentAST_checkLexicalRoutineCallArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (438)).method_searchKey (object->mAttribute_mFunctionName, var_lexicalFormalTypeList, var_returnedLexicalFormalType, var_replacementFunctionName, joker_18348_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (438)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_replacementFunctionName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_lexicalFunctionFormalArgumentList enumerator_19349 (var_lexicalFormalTypeList, kEnumeration_up) ;
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_19380 (object->mAttribute_mFunctionActualArgumentList, kEnumeration_up) ;
  while (enumerator_19349.hasCurrentObject () && enumerator_19380.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalFunctionCallArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) enumerator_19380.current_mLexicalActualInputArgument (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, enumerator_19349.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
    enumerator_19349.gotoNextObject () ;
    enumerator_19380.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalStructuredSendInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  cEnumerator_lexicalSendSearchListAST enumerator_22604 (object->mAttribute_mLexicalSendSearchList, kEnumeration_up) ;
  while (enumerator_22604.hasCurrentObject ()) {
    ...
    cMapElement_lexicalExplicitTokenListMapMap * objectArray_22616 = (cMapElement_lexicalExplicitTokenListMapMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.readWriteAccessForWithInstruction_searchKey (inCompiler, enumerator_22604.current_mSearchListName (HERE) COMMA_SOURCE_FILE_AT_LINE (544)) ;
    if (NULL != objectArray_22616) {
        macroValidSharedObject (objectArray_22616, cMapElement_lexicalExplicitTokenListMapMap) ;
      objectArray_22616->mAttribute_mShouldBeGenerated = GALGAS_bool (true) ;
    }
    GALGAS_lexicalTypeEnum joker_22824_0 ; // Joker input parameter
    ioArgument_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE_AT_LINE (547)).method_searchKey (enumerator_22604.current_mAttributeName (HERE), joker_22824_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (547)) ;
    enumerator_22604.gotoNextObject () ;
  }
...
static void categoryMethod_lexicalSimpleSendInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_23255_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (558)).method_searchKey (object->mAttribute_mSentTerminal, joker_23255_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalRepeatInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  cEnumerator_lexicalWhileBranchListAST enumerator_23540 (object->mAttribute_mLexicalWhileBranchList, kEnumeration_up) ;
  while (enumerator_23540.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalExpression ((const cPtr_lexicalExpressionAST *) enumerator_23540.current_mWhileExpression (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (568)) ;
    ...
    cEnumerator_lexicalInstructionListAST enumerator_23713 (enumerator_23540.current_mWhileInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_23713.hasCurrentObject ()) {
      callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_23713.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
  ...
  cEnumerator_lexicalInstructionListAST enumerator_23927 (object->mAttribute_mRepeatedInstructionList, kEnumeration_up) ;
  while (enumerator_23927.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_23927.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (576)) ;
...
static void categoryMethod_lexicalSelectInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  cEnumerator_lexicalSelectBranchListAST enumerator_24308 (object->mAttribute_mLexicalSelectBranchList, kEnumeration_up) ;
  while (enumerator_24308.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalExpression ((const cPtr_lexicalExpressionAST *) enumerator_24308.current_mSelectExpression (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (587)) ;
    ...
    cEnumerator_lexicalInstructionListAST enumerator_24483 (enumerator_24308.current_mSelectInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_24483.hasCurrentObject ()) {
      callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_24483.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
  ...
  cEnumerator_lexicalInstructionListAST enumerator_24696 (object->mAttribute_mDefaultInstructionList, kEnumeration_up) ;
  while (enumerator_24696.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_24696.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (595)) ;
    enumerator_24696.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalRoutineInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_bool joker_25315_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalRoutineMessageMap (SOURCE_FILE_AT_LINE (607)).method_searchKey (object->mAttribute_mRoutineName, var_lexicalRoutineFormalArgumentList, var_routineErrorMessageList, joker_25315_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
  ...
  cEnumerator_lexicalRoutineFormalArgumentList enumerator_25805 (var_lexicalRoutineFormalArgumentList, kEnumeration_up) ;
  cEnumerator_lexicalRoutineCallActualArgumentListAST enumerator_25828 (object->mAttribute_mActualArgumentList, kEnumeration_up) ;
  while (enumerator_25805.hasCurrentObject () && enumerator_25828.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRoutineCallArgument ((const cPtr_abstractLexicalRoutineActualArgumentAST *) enumerator_25828.current_mLexicalRoutineActualArgument (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, enumerator_25805.current_mLexicalFormalArgumentMode (HERE), enumerator_25805.current_mLexicalFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (622)) ;
  ...
  cEnumerator_lstringlist enumerator_26457 (object->mAttribute_mErrorMessageList, kEnumeration_up) ;
  while (enumerator_26457.hasCurrentObject ()) {
    // index 1: attribute 'mLexicalMessage', type @lstring
    // index 2: attribute 'mMessageIsUsed', type @bool
    cMapElement_lexicalMessageMap * objectArray_26469 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, enumerator_26457.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (637)) ;
    if (NULL != objectArray_26469) {
        macroValidSharedObject (objectArray_26469, cMapElement_lexicalMessageMap) ;
      objectArray_26469->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
    }
...
static void categoryMethod_lexicalRewindInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_27221_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (658)).method_searchKey (object->mAttribute_mTerminalName, joker_27221_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (658)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalDropInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_27546_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (667)).method_searchKey (object->mAttribute_mTerminalName, joker_27546_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalErrorInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  // index 1: attribute 'mLexicalMessage', type @lstring
  // index 2: attribute 'mMessageIsUsed', type @bool
  cMapElement_lexicalMessageMap * objectArray_28103 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mErrorMessageName COMMA_SOURCE_FILE_AT_LINE (685)) ;
  if (NULL != objectArray_28103) {
      macroValidSharedObject (objectArray_28103, cMapElement_lexicalMessageMap) ;
    objectArray_28103->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalWarningInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  // index 1: attribute 'mLexicalMessage', type @lstring
  // index 2: attribute 'mMessageIsUsed', type @bool
  cMapElement_lexicalMessageMap * objectArray_28484 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mWarningMessageName COMMA_SOURCE_FILE_AT_LINE (696)) ;
  if (NULL != objectArray_28484) {
      macroValidSharedObject (objectArray_28484, cMapElement_lexicalMessageMap) ;
    objectArray_28484->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalImplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  GALGAS_lexicalExplicitTokenListMap joker_29232_0 ; // Joker input parameter
  GALGAS_tokenSortedlist joker_29235_0 ; // Joker input parameter
  GALGAS_bool joker_29238_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (714)).method_searchKey (object->mAttribute_mListName, joker_29232_0, joker_29235_0, joker_29238_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalExplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  cEnumerator_lexicalInstructionListAST enumerator_29592 (object->mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_29592.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_29592.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (725)) ;
    enumerator_29592.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
