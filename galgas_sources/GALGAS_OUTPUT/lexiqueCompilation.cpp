...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
    ...
    while (((operand_33196 = enumerator_33196.nextObject ()))) {
      ...
      GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
      {
        ...
        while (((operand_33886 = enumerator_33886.nextObject ()))) {
          ...
          if (((operand_33886->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (799))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    while (((operand_34409 = enumerator_34409.nextObject ()))) {
      ...
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      if (((operand_34409->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (817)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (817))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        while (((operand_35101 = enumerator_35101.nextObject ()))) {
          ...
          GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
            ...
            while (((operand_35300 = enumerator_35300.nextObject ()))) {
              ...
              if (((operand_35300->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (832))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    while (((operand_36855 = enumerator_36855.nextObject ()))) {
      ...
      if (((operand_36855->mInfo.mMessageIsUsed).operator_not ()).isBuiltAndTrue ()) {
    ...
    while (((operand_37070 = enumerator_37070.nextObject ()))) {
      ...
      GGS_bool var_cas_preservesStartDelimiter = GGS_bool (false) ;
      {
        ...
        while (((operand_37340 = enumerator_37340.nextObject ()))) {
          ...
          if (((operand_37340->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (874))).operator_isNotEqual (GGS_string ("preserved"))).isBuiltAndTrue ()) {
