...
void routine_parseLexiqueComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    C_String syntaxDirectedTranslationResult_32541 ;
    cGrammar_lexiqueLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_32541, constinArgument_inSourceFile, outArgument_outLexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (794)) ;
    {
