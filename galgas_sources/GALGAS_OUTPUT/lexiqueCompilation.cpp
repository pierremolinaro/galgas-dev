...
void routine_compileLexiqueComponent (C_Compiler & _inLexique,
  ...
  var_cas_allowedLexicalTypeNameSet._addAssign_operation (GGS_string ("lstring")) ;
  var_cas_allowedLexicalTypeNameSet._addAssign_operation (GGS_string ("lchar")) ;
  var_cas_allowedLexicalTypeNameSet._addAssign_operation (GGS_string ("luint")) ;
  var_cas_allowedLexicalTypeNameSet._addAssign_operation (GGS_string ("luint64")) ;
  var_cas_allowedLexicalTypeNameSet._addAssign_operation (GGS_string ("lsint")) ;
