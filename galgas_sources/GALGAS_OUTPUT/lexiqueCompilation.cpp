  ...
  if (operand_16633 != NULL) {
    ...
    var_cas_outGeneratedCode = GGS_string ("") ;
    {
      ...
      while (((operand_16918 = enumerator_16918.nextObject ()))) {
        ...
        var_cas_outGeneratedCode.dotAssign_operation (var_cas_inScannerClassName) ;
        var_cas_outGeneratedCode.appendCString ("_1_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_16918->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (428))) ;
        var_cas_outGeneratedCode.appendCString (" ;\n") ;
        var_cas_outGeneratedCode.appendCString ("  enterToken (token) ;\n") ;
        var_cas_outGeneratedCode.appendCString ("}else ") ;
      }
...
category_reader__lexicalExplicitRule__generateCode (C_Compiler & inLexique,
  ...
  if (operand_17569 != NULL) {
    ...
    var_cas_outGeneratedCode.dotAssign_operation ((findCategoryReader__lexicalExpression__generateConditionCode (operand_17569->mLexicalRuleExpression (HERE)->galgasRTTI ()) (inLexique, operand_17569->mLexicalRuleExpression.getPtr (), var_cas_inLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (442)))) ;
    var_cas_outGeneratedCode.appendCString (") {\n") ;
    var_cas_outGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (444)) ;
    {
      GGS_lexicalInstructionList::cEnumerator enumerator_17913 (operand_17569->mInstructionList, true) ;
      const GGS_lexicalInstructionList::cElement * operand_17913 = NULL ;
      while (((operand_17913 = enumerator_17913.nextObject ()))) {
        macroValidPointer (operand_17913) ;
        var_cas_outGeneratedCode.dotAssign_operation ((findCategoryReader__lexicalInstruction__generateInstructionCode (operand_17913->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_17913->mInstruction.getPtr (), var_cas_inScannerClassName, var_cas_inLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (446)))) ;
      }
    }
  ...
  if (isBuilt) {
    ...
    while (((operand_5192 = enumerator_5192.nextObject ()))) {
      ...
      while (((operand_5949 = enumerator_5949.nextObject ()))) {
        ...
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "_1_" ;
        result << operand_5949->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << "}" ;
    ...
    result << "_1_:\n"
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7229 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7229 = NULL ;
    while (((operand_7229 = enumerator_7229.nextObject ()))) {
      macroValidPointer (operand_7229) ;
      result << "    case " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7229->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (151)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7229->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (153)).reader_CStringConstantRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7555 (operand_7229->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7555 = NULL ;
      while (((operand_7555 = enumerator_7555.nextObject ()))) {
        macroValidPointer (operand_7555) ;
        result << "      s." ;
        result << operand_7555->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7555->mAttributeName ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_8407 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_8407 = NULL ;
    while (((operand_8407 = enumerator_8407.nextObject ()))) {
      macroValidPointer (operand_8407) ;
      result << "    token.mLexicalAttribute_" ;
      result << operand_8407->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
      result << operand_8407->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
      result << " ;\n" ;
    }
    result << "    mTokenFirstLocation = mCurrentLocation ;\n"
      "    try{\n" ;
    const GGS_uint indentation_8843 = GGS_uint (6U) ;
    if (indentation_8843.isBuilt ()) {
      result.incIndentation ((sint32) indentation_8843.uintValue ()) ;
    }
    GGS_lexicalRuleList::cEnumerator enumerator_8611 (var_cas_LEXICAL_RULE_LIST, true) ;
    const GGS_lexicalRuleList::cElement * operand_8611 = NULL ;
    while (((operand_8611 = enumerator_8611.nextObject ()))) {
      macroValidPointer (operand_8611) ;
      result << (findCategoryReader__abstractLexicalRule__generateCode (operand_8611->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_8611->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (188))) ;
    }
     ;
    if (indentation_8843.isBuilt ()) {
      result.incIndentation (- ((sint32) indentation_8843.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_10158 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_10158 = NULL ;
    while (((operand_10158 = enumerator_10158.nextObject ()))) {
      macroValidPointer (operand_10158) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_10158->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_10737 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_10737 = NULL ;
    while (((operand_10737 = enumerator_10737.nextObject ()))) {
      ...
      result << operand_10737->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
      result << " (" ;
      result << operand_10737->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_10737->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (238)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_10737->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (238)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_11553 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_11553 = NULL ;
    while (((operand_11553 = enumerator_11553.nextObject ()))) {
      macroValidPointer (operand_11553) ;
      result << operand_11553->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_11553->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (250)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_11553->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (252)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
...
category_method__lexicalSendTerminalByDefault__checkLexicalDefaultAction (C_Compiler & inLexique,
                                const cPtr_lexicalSendTerminalByDefault * operand_19795,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19795 != NULL) {
    GGS_lexicalSentValueList  automatic_var_1 ;
    const GGS_terminalMap  temp_19903 = var_cas_ioLexiqueAnalysisContext.reader_mTerminalMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
    if (temp_19903.isBuilt ()) {
      temp_19903 (HERE)->method_searchKey (inLexique, operand_19795->mDefaultSentTerminal, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (493)) ;
    }
  }
}
...
category_method__lexicalErrorByDefault__checkLexicalDefaultAction (C_Compiler & inLexique,
                                const cPtr_lexicalErrorByDefault * operand_20089,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20089 != NULL) {
    elementOf_GGS_lexicalMessageMap * operand_20204 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_20089->mDefaultErrorMessageName, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (501)) ;
    if (NULL != operand_20204) {
      operand_20204->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalOrExpression__checkLexicalExpression (C_Compiler & inLexique,
                                const cPtr_lexicalOrExpression * operand_20798,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20798 != NULL) {
    const GGS_lexicalExpression  temp_20892 = operand_20798->mLeftOperand ;
    if (temp_20892.isBuilt ()) {
      typeCategoryMethod__lexicalExpression__checkLexicalExpression method = findCategoryMethod__lexicalExpression__checkLexicalExpression (temp_20892.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_20892 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (519)) ;
      }
    }
    const GGS_lexicalExpression  temp_20963 = operand_20798->mRightOperand ;
    if (temp_20963.isBuilt ()) {
      typeCategoryMethod__lexicalExpression__checkLexicalExpression method = findCategoryMethod__lexicalExpression__checkLexicalExpression (temp_20963.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_20963 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (520)) ;
      }
    }
  }
}
...
category_method__lexicalCharacterMatch__checkLexicalExpression (C_Compiler &,
                                const cPtr_lexicalCharacterMatch * operand_21149,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__lexicalCharacterSetMatch__checkLexicalExpression (C_Compiler &,
                                const cPtr_lexicalCharacterSetMatch * operand_21369,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__lexicalCharacterIntervalMatch__checkLexicalExpression (C_Compiler &,
                                const cPtr_lexicalCharacterIntervalMatch * operand_21594,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21594 != NULL) {
  }
}
...
category_method__lexicalStringMatch__checkLexicalExpression (C_Compiler & inLexique,
                                const cPtr_lexicalStringMatch * operand_21808,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21808 != NULL) {
    var_cas_ioLexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_21808->mString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (549))) ;
  }
}
...
category_method__lexicalStringNotMatch__checkLexicalExpression (C_Compiler & inLexique,
                                const cPtr_lexicalStringNotMatch * operand_22093,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22093 != NULL) {
    var_cas_ioLexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_22093->mString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (557))) ;
    elementOf_GGS_lexicalMessageMap * operand_22276 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_22093->mErrorMessage, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (558)) ;
    if (NULL != operand_22276) {
      operand_22276->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalAttributeInputArgument__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalAttributeInputArgument * operand_22973,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
  ...
  if (operand_22973 != NULL) {
    ...
    const GGS_lexicalAttributeMap  temp_23218 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (580)) ;
    if (temp_23218.isBuilt ()) {
      temp_23218 (HERE)->method_searchKey (inLexique, operand_22973->mAttributeName, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (580)) ;
    }
    if (((var_cas_attributeLexicalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_22973->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, attribute type is ")).operator_concat (var_cas_attributeLexicalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (587)))).operator_concat (GGS_string (" type, but lexical routine prototype requires "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (589)))).operator_concat (GGS_string (" type")) COMMA_SOURCE_FILE_AT_LINE (591)) ;
    }
  }
}
...
category_method__lexicalCharacterInputArgument__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCharacterInputArgument * operand_23772,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23772 != NULL) {
...
category_method__lexicalUnsignedInputArgument__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalUnsignedInputArgument * operand_24376,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24376 != NULL) {
...
category_method__lexicalCurrentCharacterInputArgument__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCurrentCharacterInputArgument * operand_24987,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24987 != NULL) {
    if (((GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
...
category_method__lexicalFunctionInputArgument__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalFunctionInputArgument * operand_25594,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25594 != NULL) {
    ...
    const GGS_lexicalFunctionMap  temp_25940 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (649)) ;
    if (temp_25940.isBuilt ()) {
      temp_25940 (HERE)->method_searchKey (inLexique, operand_25594->mFunctionName, var_cas_lexicalFormalTypeList, var_cas_returnedLexicalFormalType, var_cas_replacementFunctionName COMMA_SOURCE_FILE_AT_LINE (649)) ;
    }
    if (((var_cas_replacementFunctionName).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
      operand_25594->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("obsolete lexical function, replaced by '")).operator_concat (var_cas_replacementFunctionName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (657)) ;
    }
    if (((var_cas_returnedLexicalFormalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_25594->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, the function returns an ")).operator_concat (var_cas_returnedLexicalFormalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (662)))).operator_concat (GGS_string (" value, but lexical routine prototype requires an "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (664)))).operator_concat (GGS_string (" value")) COMMA_SOURCE_FILE_AT_LINE (666)) ;
    }
    if (((var_cas_lexicalFormalTypeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (668))).operator_isNotEqual (operand_25594->mFunctionActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (668)))).isBuiltAndTrue ()) {
      operand_25594->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical function names ")).operator_concat (operand_25594->mFunctionActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (670)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (670)))).operator_concat (GGS_string (" actual argument(s), but the prototype requires "))).operator_concat (var_cas_lexicalFormalTypeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (672)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (672)))).operator_concat (GGS_string (" actual argument(s)")) COMMA_SOURCE_FILE_AT_LINE (673)) ;
    }
    {
      GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_27036 (var_cas_lexicalFormalTypeList, true) ;
      const GGS_lexicalFunctionFormalArgumentList::cElement * operand_27036 = NULL ;
      GGS_lexicalFunctionCallActualArgumentList::cEnumerator enumerator_27065 (operand_25594->mFunctionActualArgumentList, true) ;
      const GGS_lexicalFunctionCallActualArgumentList::cElement * operand_27065 = NULL ;
      while (((operand_27036 = enumerator_27036.nextObject ()))
          && ((operand_27065 = enumerator_27065.nextObject ()))) {
        macroValidPointer (operand_27036) ;
        macroValidPointer (operand_27065) ;
        const GGS_lexicalRoutineOrFunctionFormalInputArgument  temp_27134 = operand_27065->mLexicalActualInputArgument ;
        if (temp_27134.isBuilt ()) {
          typeCategoryMethod__lexicalRoutineOrFunctionFormalInputArgument__checkLexicalFunctionCallArgument method = findCategoryMethod__lexicalRoutineOrFunctionFormalInputArgument__checkLexicalFunctionCallArgument (temp_27134.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_27134 (HERE), var_cas_ioLexiqueAnalysisContext, operand_27036->mLexicalType COMMA_SOURCE_FILE_AT_LINE (676)) ;
          }
        }
      }
    }
...
category_method__lexicalAttributeInputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalAttributeInputArgument * operand_27836,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27836 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalAttributeMap  temp_28081 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (700)) ;
    if (temp_28081.isBuilt ()) {
      temp_28081 (HERE)->method_searchKey (inLexique, operand_27836->mAttributeName, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (700)) ;
    }
    if (((var_cas_attributeLexicalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_27836->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, attribute type is ")).operator_concat (var_cas_attributeLexicalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (707)))).operator_concat (GGS_string (" type, but lexical routine prototype requires "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (709)))).operator_concat (GGS_string (" type")) COMMA_SOURCE_FILE_AT_LINE (711)) ;
    }
  }
}
...
category_method__lexicalCharacterInputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCharacterInputArgument * operand_28634,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28634 != NULL) {
    if (((GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_28634->mCharacter.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("type error, a literal character has @char")).operator_concat (GGS_string (" type, but lexical routine prototype requires an "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (724)))).operator_concat (GGS_string (" type value")) COMMA_SOURCE_FILE_AT_LINE (726)) ;
    }
  }
}
...
category_method__lexicalCurrentCharacterInputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCurrentCharacterInputArgument * operand_29852,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29852 != NULL) {
    if (((GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_29852->mLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("type error, current character value has @char")).operator_concat (GGS_string (" type, but lexical routine prototype requires an "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (754)))).operator_concat (GGS_string (" type value")) COMMA_SOURCE_FILE_AT_LINE (756)) ;
    }
  }
}
...
category_method__lexicalFunctionInputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalFunctionInputArgument * operand_30458,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30458 != NULL) {
    GGS_lexicalFunctionFormalArgumentList  var_cas_lexicalFormalTypeList ;
    GGS_lexicalTypeEnum var_cas_returnedLexicalFormalType ;
    GGS_string var_cas_replacementFunctionName ;
    const GGS_lexicalFunctionMap  temp_30804 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (769)) ;
    if (temp_30804.isBuilt ()) {
      temp_30804 (HERE)->method_searchKey (inLexique, operand_30458->mFunctionName, var_cas_lexicalFormalTypeList, var_cas_returnedLexicalFormalType, var_cas_replacementFunctionName COMMA_SOURCE_FILE_AT_LINE (769)) ;
    }
    if (((var_cas_replacementFunctionName).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
      operand_30458->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("obsolete lexical function, replaced by '")).operator_concat (var_cas_replacementFunctionName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (777)) ;
    }
    if (((var_cas_returnedLexicalFormalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_30458->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, the function returns an ")).operator_concat (var_cas_returnedLexicalFormalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (782)))).operator_concat (GGS_string (" value, but lexical routine prototype requires an "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (784)))).operator_concat (GGS_string (" value")) COMMA_SOURCE_FILE_AT_LINE (786)) ;
    }
    if (((var_cas_lexicalFormalTypeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (788))).operator_isNotEqual (operand_30458->mFunctionActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (788)))).isBuiltAndTrue ()) {
      operand_30458->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical function names ")).operator_concat (operand_30458->mFunctionActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (790)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (790)))).operator_concat (GGS_string (" actual argument(s), but the prototype requires "))).operator_concat (var_cas_lexicalFormalTypeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (792)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (792)))).operator_concat (GGS_string (" actual argument(s)")) COMMA_SOURCE_FILE_AT_LINE (793)) ;
    }
    {
      GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_31900 (var_cas_lexicalFormalTypeList, true) ;
      const GGS_lexicalFunctionFormalArgumentList::cElement * operand_31900 = NULL ;
      GGS_lexicalFunctionCallActualArgumentList::cEnumerator enumerator_31929 (operand_30458->mFunctionActualArgumentList, true) ;
      const GGS_lexicalFunctionCallActualArgumentList::cElement * operand_31929 = NULL ;
      while (((operand_31900 = enumerator_31900.nextObject ()))
          && ((operand_31929 = enumerator_31929.nextObject ()))) {
        macroValidPointer (operand_31900) ;
        macroValidPointer (operand_31929) ;
        const GGS_lexicalRoutineOrFunctionFormalInputArgument  temp_31998 = operand_31929->mLexicalActualInputArgument ;
        if (temp_31998.isBuilt ()) {
          typeCategoryMethod__lexicalRoutineOrFunctionFormalInputArgument__checkLexicalFunctionCallArgument method = findCategoryMethod__lexicalRoutineOrFunctionFormalInputArgument__checkLexicalFunctionCallArgument (temp_31998.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_31998 (HERE), var_cas_ioLexiqueAnalysisContext, operand_31900->mLexicalType COMMA_SOURCE_FILE_AT_LINE (796)) ;
          }
        }
      }
    }
...
category_method__lexicalAttributeInputOutputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalAttributeInputOutputArgument * operand_32765,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalArgumentMode  var_cas_inLexicalRoutineFormalArgumentMode,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32765 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalAttributeMap  temp_33069 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (822)) ;
    if (temp_33069.isBuilt ()) {
      temp_33069 (HERE)->method_searchKey (inLexique, operand_32765->mAttributeName, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (822)) ;
    }
    if (((var_cas_attributeLexicalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType)).isBuiltAndTrue ()) {
      operand_32765->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, attribute type is ")).operator_concat (var_cas_attributeLexicalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (829)))).operator_concat (GGS_string (" type, but lexical routine prototype requires "))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (831)))).operator_concat (GGS_string (" type")) COMMA_SOURCE_FILE_AT_LINE (833)) ;
    }
    if (((var_cas_inLexicalRoutineFormalArgumentMode).operator_isNotEqual (GGS_lexicalArgumentMode::constructor_lexicalInputOutputMode (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      operand_32765->mActualPassingModeLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the output mode (!) is required here, not an output/input mode") COMMA_SOURCE_FILE_AT_LINE (837)) ;
    }
  }
}
...
category_method__lexicalFormalInputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalFormalInputArgument * operand_33852,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalArgumentMode  var_cas_inLexicalRoutineFormalArgumentMode,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_33852 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalRoutineOrFunctionFormalInputArgument  temp_34168 = operand_33852->mRoutineOrFunctionFormalInputArgument ;
    if (temp_34168.isBuilt ()) {
      typeCategoryMethod__lexicalRoutineOrFunctionFormalInputArgument__checkLexicalRoutineCallArgument method = findCategoryMethod__lexicalRoutineOrFunctionFormalInputArgument__checkLexicalRoutineCallArgument (temp_34168.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34168 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_inLexicalRoutineFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (849)) ;
      }
    }
    if (((var_cas_inLexicalRoutineFormalArgumentMode).operator_isNotEqual (GGS_lexicalArgumentMode::constructor_lexicalInputMode (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      operand_33852->mActualPassingModeLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the output/input mode (!\?) is required here, not an input mode") COMMA_SOURCE_FILE_AT_LINE (856)) ;
    }
  }
}
...
category_method__lexicalStructuredSendInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalStructuredSendInstruction * operand_34997,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34997 != NULL) {
    {
      GGS_lexicalSendSearchList::cEnumerator enumerator_35085 (operand_34997->mLexicalSendSearchList, true) ;
      const GGS_lexicalSendSearchList::cElement * operand_35085 = NULL ;
      while (((operand_35085 = enumerator_35085.nextObject ()))) {
        macroValidPointer (operand_35085) ;
        GGS_lexicalTypeEnum automatic_var_2 ;
        const GGS_lexicalAttributeMap  temp_35151 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (873)) ;
        if (temp_35151.isBuilt ()) {
          temp_35151 (HERE)->method_searchKey (inLexique, operand_35085->mAttributeName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (873)) ;
        }
      }
    }
    const GGS_lexicalSendDefaultAction  temp_35244 = operand_34997->mLexicalSendDefaultAction ;
    if (temp_35244.isBuilt ()) {
      typeCategoryMethod__lexicalSendDefaultAction__checkLexicalDefaultAction method = findCategoryMethod__lexicalSendDefaultAction__checkLexicalDefaultAction (temp_35244.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_35244 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (875)) ;
      }
    }
  }
}
...
category_method__lexicalSimpleSendInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalSimpleSendInstruction * operand_35437,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_35437 != NULL) {
    GGS_lexicalSentValueList  automatic_var_3 ;
    const GGS_terminalMap  temp_35545 = var_cas_ioLexiqueAnalysisContext.reader_mTerminalMap (inLexique COMMA_SOURCE_FILE_AT_LINE (883)) ;
    if (temp_35545.isBuilt ()) {
      temp_35545 (HERE)->method_searchKey (inLexique, operand_35437->mSentTerminal, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (883)) ;
    }
  }
}
...
category_method__lexicalRepeatInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalRepeatInstruction * operand_35725,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_35725 != NULL) {
    {
      GGS_lexicalWhileBranchList::cEnumerator enumerator_35814 (operand_35725->mLexicalWhileBranchList, true) ;
      const GGS_lexicalWhileBranchList::cElement * operand_35814 = NULL ;
      while (((operand_35814 = enumerator_35814.nextObject ()))) {
        macroValidPointer (operand_35814) ;
        const GGS_lexicalExpression  temp_35862 = operand_35814->mWhileExpression ;
        if (temp_35862.isBuilt ()) {
          typeCategoryMethod__lexicalExpression__checkLexicalExpression method = findCategoryMethod__lexicalExpression__checkLexicalExpression (temp_35862.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_35862 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (892)) ;
          }
        }
        {
          GGS_lexicalInstructionList::cEnumerator enumerator_35926 (operand_35814->mWhileInstructionList, true) ;
          const GGS_lexicalInstructionList::cElement * operand_35926 = NULL ;
          while (((operand_35926 = enumerator_35926.nextObject ()))) {
            macroValidPointer (operand_35926) ;
            const GGS_lexicalInstruction  temp_35973 = operand_35926->mInstruction ;
            if (temp_35973.isBuilt ()) {
              typeCategoryMethod__lexicalInstruction__checkLexicalInstruction method = findCategoryMethod__lexicalInstruction__checkLexicalInstruction (temp_35973.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_35973 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (894)) ;
              }
            }
          }
        }
    ...
    {
      GGS_lexicalInstructionList::cEnumerator enumerator_36072 (operand_35725->mRepeatedInstructionList, true) ;
      const GGS_lexicalInstructionList::cElement * operand_36072 = NULL ;
      while (((operand_36072 = enumerator_36072.nextObject ()))) {
        macroValidPointer (operand_36072) ;
        const GGS_lexicalInstruction  temp_36117 = operand_36072->mInstruction ;
        if (temp_36117.isBuilt ()) {
          typeCategoryMethod__lexicalInstruction__checkLexicalInstruction method = findCategoryMethod__lexicalInstruction__checkLexicalInstruction (temp_36117.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_36117 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (898)) ;
          }
        }
      }
    }
...
category_method__lexicalSelectInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalSelectInstruction * operand_36322,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36322 != NULL) {
    {
      GGS_lexicalSelectBranchList::cEnumerator enumerator_36412 (operand_36322->mLexicalSelectBranchList, true) ;
      const GGS_lexicalSelectBranchList::cElement * operand_36412 = NULL ;
      while (((operand_36412 = enumerator_36412.nextObject ()))) {
        macroValidPointer (operand_36412) ;
        const GGS_lexicalExpression  temp_36461 = operand_36412->mSelectExpression ;
        if (temp_36461.isBuilt ()) {
          typeCategoryMethod__lexicalExpression__checkLexicalExpression method = findCategoryMethod__lexicalExpression__checkLexicalExpression (temp_36461.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_36461 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (908)) ;
          }
        }
        {
          GGS_lexicalInstructionList::cEnumerator enumerator_36526 (operand_36412->mSelectInstructionList, true) ;
          const GGS_lexicalInstructionList::cElement * operand_36526 = NULL ;
          while (((operand_36526 = enumerator_36526.nextObject ()))) {
            macroValidPointer (operand_36526) ;
            const GGS_lexicalInstruction  temp_36573 = operand_36526->mInstruction ;
            if (temp_36573.isBuilt ()) {
              typeCategoryMethod__lexicalInstruction__checkLexicalInstruction method = findCategoryMethod__lexicalInstruction__checkLexicalInstruction (temp_36573.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_36573 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (910)) ;
              }
            }
          }
        }
    ...
    {
      GGS_lexicalInstructionList::cEnumerator enumerator_36671 (operand_36322->mDefaultInstructionList, true) ;
      const GGS_lexicalInstructionList::cElement * operand_36671 = NULL ;
      while (((operand_36671 = enumerator_36671.nextObject ()))) {
        macroValidPointer (operand_36671) ;
        const GGS_lexicalInstruction  temp_36716 = operand_36671->mInstruction ;
        if (temp_36716.isBuilt ()) {
          typeCategoryMethod__lexicalInstruction__checkLexicalInstruction method = findCategoryMethod__lexicalInstruction__checkLexicalInstruction (temp_36716.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_36716 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (914)) ;
          }
        }
      }
    }
...
category_method__lexicalRoutineInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalRoutineInstruction * operand_36922,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36922 != NULL) {
    ...
    const GGS_lexicalRoutineMap  temp_37189 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalRoutineMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (926)) ;
    if (temp_37189.isBuilt ()) {
      temp_37189 (HERE)->method_searchKey (inLexique, operand_36922->mRoutineName, var_cas_lexicalRoutineFormalArgumentList, var_cas_routineErrorMessageList, var_cas_replacementRoutineName COMMA_SOURCE_FILE_AT_LINE (926)) ;
    }
    if (((var_cas_replacementRoutineName).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
      operand_36922->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("obsolete lexical routine, replaced by '")).operator_concat (var_cas_replacementRoutineName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (934)) ;
    }
    if (((var_cas_lexicalRoutineFormalArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (937))).operator_isNotEqual (operand_36922->mActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (937)))).isBuiltAndTrue ()) {
      operand_36922->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical routine call names ")).operator_concat (operand_36922->mActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (939)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (939)))).operator_concat (GGS_string (" actual argument(s), but the lexical routine prototype requires "))).operator_concat (var_cas_lexicalRoutineFormalArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (941)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (941)))).operator_concat (GGS_string (" actual argument(s)")) COMMA_SOURCE_FILE_AT_LINE (942)) ;
    }
    {
      GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_37965 (var_cas_lexicalRoutineFormalArgumentList, true) ;
      const GGS_lexicalRoutineFormalArgumentList::cElement * operand_37965 = NULL ;
      GGS_lexicalRoutineCallActualArgumentList::cEnumerator enumerator_37986 (operand_36922->mActualArgumentList, true) ;
      const GGS_lexicalRoutineCallActualArgumentList::cElement * operand_37986 = NULL ;
      while (((operand_37965 = enumerator_37965.nextObject ()))
          && ((operand_37986 = enumerator_37986.nextObject ()))) {
        macroValidPointer (operand_37965) ;
        macroValidPointer (operand_37986) ;
        const GGS_abstractLexicalRoutineActualArgument  temp_38056 = operand_37986->mLexicalRoutineActualArgument ;
        if (temp_38056.isBuilt ()) {
          typeCategoryMethod__abstractLexicalRoutineActualArgument__checkLexicalRoutineCallArgument method = findCategoryMethod__abstractLexicalRoutineActualArgument__checkLexicalRoutineCallArgument (temp_38056.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_38056 (HERE), var_cas_ioLexiqueAnalysisContext, operand_37965->mLexicalFormalArgumentMode, operand_37965->mLexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (945)) ;
          }
        }
      }
    }
    if (((var_cas_routineErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (952))).operator_isNotEqual (operand_36922->mErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (952)))).isBuiltAndTrue ()) {
      operand_36922->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical routine call names ")).operator_concat (operand_36922->mErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (954)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (954)))).operator_concat (GGS_string (" error message(s), but the lexical routine prototype requires "))).operator_concat (var_cas_routineErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (956)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (956)))).operator_concat (GGS_string (" error message(s)")) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_38615 (operand_36922->mErrorMessageList, true) ;
      const GGS_lstringlist::cElement * operand_38615 = NULL ;
      while (((operand_38615 = enumerator_38615.nextObject ()))) {
        macroValidPointer (operand_38615) ;
        elementOf_GGS_lexicalMessageMap * operand_38680 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_38615->mValue, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (960)) ;
        if (NULL != operand_38680) {
          operand_38680->mInfo.mMessageIsUsed = GGS_bool (true) ;
        }
      }
    }
  }
...
category_method__lexicalLogInstruction__checkLexicalInstruction (C_Compiler &,
                                const cPtr_lexicalLogInstruction * operand_38923,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38923 != NULL) {
  }
}
...
category_method__lexicalRewindInstruction__checkLexicalInstruction (C_Compiler &,
                                const cPtr_lexicalRewindInstruction * operand_39144,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39144 != NULL) {
  }
}
...
category_method__lexicalDropInstruction__checkLexicalInstruction (C_Compiler &,
                                const cPtr_lexicalDropInstruction * operand_39363,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39363 != NULL) {
  }
}
...
category_method__lexicalTagInstruction__checkLexicalInstruction (C_Compiler &,
                                const cPtr_lexicalTagInstruction * operand_39581,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39581 != NULL) {
  }
}
...
category_method__lexicalErrorInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalErrorInstruction * operand_39801,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39801 != NULL) {
    elementOf_GGS_lexicalMessageMap * operand_39909 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_39801->mErrorMessageName, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (999)) ;
    if (NULL != operand_39909) {
      operand_39909->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalWarningInstruction__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalWarningInstruction * operand_40143,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40143 != NULL) {
    elementOf_GGS_lexicalMessageMap * operand_40251 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_40143->mWarningMessageName, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (1009)) ;
    if (NULL != operand_40251) {
      operand_40251->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalImplicitRule__checkLexicalRule (C_Compiler & inLexique,
                                const cPtr_lexicalImplicitRule * operand_40826,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40826 != NULL) {
    GGS_lexicalExplicitTokenListMap  automatic_var_4 ;
    GGS_tokenSortedlist  automatic_var_5 ;
    const GGS_lexicalExplicitTokenListMapMap  temp_40942 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1027)) ;
    if (temp_40942.isBuilt ()) {
      temp_40942 (HERE)->method_searchKey (inLexique, operand_40826->mListName, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (1027)) ;
    }
  }
}
...
category_method__lexicalExplicitRule__checkLexicalRule (C_Compiler & inLexique,
                                const cPtr_lexicalExplicitRule * operand_41110,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41110 != NULL) {
    const GGS_lexicalExpression  temp_41214 = operand_41110->mLexicalRuleExpression ;
    if (temp_41214.isBuilt ()) {
      typeCategoryMethod__lexicalExpression__checkLexicalExpression method = findCategoryMethod__lexicalExpression__checkLexicalExpression (temp_41214.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_41214 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (1035)) ;
      }
    }
    {
      GGS_lexicalInstructionList::cEnumerator enumerator_41271 (operand_41110->mInstructionList, true) ;
      const GGS_lexicalInstructionList::cElement * operand_41271 = NULL ;
      while (((operand_41271 = enumerator_41271.nextObject ()))) {
        macroValidPointer (operand_41271) ;
        const GGS_lexicalInstruction  temp_41316 = operand_41271->mInstruction ;
        if (temp_41316.isBuilt ()) {
          typeCategoryMethod__lexicalInstruction__checkLexicalInstruction method = findCategoryMethod__lexicalInstruction__checkLexicalInstruction (temp_41316.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_41316 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (1037)) ;
          }
        }
      }
    }
...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
  ...
  {
    GGS_lexicalAttributeList::cEnumerator enumerator_43845 (var_cas_lexiqueComponentRoot.reader_mLexicalAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1086)), true) ;
    const GGS_lexicalAttributeList::cElement * operand_43845 = NULL ;
    while (((operand_43845 = enumerator_43845.nextObject ()))) {
      macroValidPointer (operand_43845) ;
      if ((var_cas_lexicalTypeMap.reader_hasKey (inLexique, operand_43845->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1087)) COMMA_SOURCE_FILE_AT_LINE (1087))).isBuiltAndTrue ()) {
        GGS_lexicalTypeEnum var_cas_lexicalType ;
        const GGS_lexicalTypeMap  temp_44016 = var_cas_lexicalTypeMap ;
        if (temp_44016.isBuilt ()) {
          temp_44016 (HERE)->method_searchKey (inLexique, operand_43845->mTypeName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (1089)) ;
        }
        var_cas_lexiqueAnalysisContext.mLexicalAttributeMap.modifier_insertKey (inLexique, operand_43845->mName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (1090)) ;
      }else{
        GGS_string var_cas_m ;
        var_cas_m = GGS_string ("") ;
        var_cas_m.appendCString ("the @") ;
        var_cas_m.dotAssign_operation (operand_43845->mTypeName) ;
        ...
        {
          GGS_lexicalTypeMap::cEnumerator enumerator_44318 (var_cas_lexicalTypeMap, true) ;
          const GGS_lexicalTypeMap::cElement * operand_44318 = enumerator_44318.nextObject () ;
          if ((operand_44318 != NULL)) {
            bool _foreach_loop_44318 ;
            do{
              macroValidPointer (operand_44318) ;
              var_cas_m.appendCString (" @") ;
              var_cas_m.dotAssign_operation (operand_44318->mKey) ;
              operand_44318 = enumerator_44318.nextObject () ;
              _foreach_loop_44318 = ((operand_44318 != NULL)) ;
              if (_foreach_loop_44318) {
                var_cas_m.appendCString (",") ;
              }
            }while (_foreach_loop_44318) ;
          }
        }
        operand_43845->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (1101)) ;
      }
    }
  }
  {
    GGS_terminalDeclarationList::cEnumerator enumerator_44528 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1104)), true) ;
    const GGS_terminalDeclarationList::cElement * operand_44528 = NULL ;
    while (((operand_44528 = enumerator_44528.nextObject ()))) {
      macroValidPointer (operand_44528) ;
      GGS_lexicalSentValueList  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_44665 (operand_44528->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_44665 = NULL ;
        while (((operand_44665 = enumerator_44665.nextObject ()))) {
          macroValidPointer (operand_44665) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_44804 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1108)) ;
          if (temp_44804.isBuilt ()) {
            temp_44804 (HERE)->method_searchKey (inLexique, operand_44665->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (1108)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (operand_44665->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1109)), var_cas_attributeLexicalType) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_44528->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (1111)) ;
      var_cas_lexiqueAnalysisContext.mTerminalList._addAssign_operation (operand_44528->mName, var_cas_argumentTypeList, operand_44528->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1112))) ;
    }
  }
  {
    GGS_lexicalListDeclarationList::cEnumerator enumerator_45148 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1114)), true) ;
    const GGS_lexicalListDeclarationList::cElement * operand_45148 = NULL ;
    while (((operand_45148 = enumerator_45148.nextObject ()))) {
      macroValidPointer (operand_45148) ;
      GGS_lexicalSentValueList  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_45288 (operand_45148->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_45288 = NULL ;
        while (((operand_45288 = enumerator_45288.nextObject ()))) {
          macroValidPointer (operand_45288) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_45426 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1118)) ;
          if (temp_45426.isBuilt ()) {
            temp_45426 (HERE)->method_searchKey (inLexique, operand_45288->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (1118)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (operand_45288->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1119)), var_cas_attributeLexicalType) ;
        }
      }
      ...
      {
        GGS_lexicalListEntryList::cEnumerator enumerator_45706 (operand_45148->mEntryList, true) ;
        const GGS_lexicalListEntryList::cElement * operand_45706 = NULL ;
        while (((operand_45706 = enumerator_45706.nextObject ()))) {
          macroValidPointer (operand_45706) ;
          GGS_string var_cas_syntaxErrorMessage ;
          var_cas_syntaxErrorMessage = operand_45148->mSyntaxErrorMessage.ggs_string ().reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_45706->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1124)) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
          var_cas_lexiqueAnalysisContext.mTerminalList._addAssign_operation (operand_45706->mTerminalSpelling, var_cas_argumentTypeList, var_cas_syntaxErrorMessage) ;
          var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_45706->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (1126)) ;
          var_cas_lexicalTokenListMap.modifier_insertKey (inLexique, operand_45706->mEntrySpelling, operand_45706->mTerminalSpelling, operand_45706->mFeatureList COMMA_SOURCE_FILE_AT_LINE (1127)) ;
          var_cas_tokenSortedlist._addAssign_operation (operand_45706->mEntrySpelling.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1128)), operand_45706->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1128)), operand_45706->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1128))) ;
          var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_45706->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1129))) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mLexicalTokenListMap.modifier_insertKey (inLexique, operand_45148->mName, var_cas_lexicalTokenListMap, var_cas_tokenSortedlist COMMA_SOURCE_FILE_AT_LINE (1131)) ;
    }
  }
  {
    GGS_lexicalMessageDeclarationList::cEnumerator enumerator_46529 (var_cas_lexiqueComponentRoot.reader_mLexicalMessageDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1134)), true) ;
    const GGS_lexicalMessageDeclarationList::cElement * operand_46529 = NULL ;
    while (((operand_46529 = enumerator_46529.nextObject ()))) {
      macroValidPointer (operand_46529) ;
      var_cas_lexiqueAnalysisContext.mLexicalMessageMap.modifier_insertKey (inLexique, operand_46529->mMessageName, operand_46529->mMessageValue, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1135)) ;
    }
  }
  {
    GGS_lexicalRuleList::cEnumerator enumerator_46763 (var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)), true) ;
    const GGS_lexicalRuleList::cElement * operand_46763 = NULL ;
    while (((operand_46763 = enumerator_46763.nextObject ()))) {
      macroValidPointer (operand_46763) ;
      const GGS_abstractLexicalRule  temp_46839 = operand_46763->mLexicalRule ;
      if (temp_46839.isBuilt ()) {
        typeCategoryMethod__abstractLexicalRule__checkLexicalRule method = findCategoryMethod__abstractLexicalRule__checkLexicalRule (temp_46839.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_46839 (HERE), var_cas_lexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (1139)) ;
        }
      }
    }
  }
  {
    GGS_lexicalMessageMap::cEnumerator enumerator_46961 (var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1142)), true) ;
    const GGS_lexicalMessageMap::cElement * operand_46961 = NULL ;
    while (((operand_46961 = enumerator_46961.nextObject ()))) {
      macroValidPointer (operand_46961) ;
      if (((operand_46961->mInfo.mMessageIsUsed).operator_not ()).isBuiltAndTrue ()) {
        operand_46961->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (1144)) ;
      }
    }
  }
