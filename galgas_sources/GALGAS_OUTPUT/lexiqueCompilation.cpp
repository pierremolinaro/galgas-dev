...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (C_Compiler * inCompiler,
  ...
  if (kBoolTrue == test_6) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_14688.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_14688.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 271)).stringValue () ;
        result << categoryReader_initialization (enumerator_14688.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 271)).stringValue () ;
        result << " ;\n" ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      ...
      while (enumerator_14903.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_14903.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 278)).stringValue () ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_16410.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_16410.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 311)).stringValue () ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_16866.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_16866.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 321)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_16866.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 321)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      ...
      result << enumerator_16866.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 323)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_17573.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_17573.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 331)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 331)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_17573.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 331)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_17573.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 335)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 335)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_17573.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 335)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_17573.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 336)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 336)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 346)).isValid ()) {
    cEnumerator_terminalList enumerator_19018 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 346)), kEnumeration_up) ;
    while (enumerator_19018.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_19018.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 347)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (kBoolTrue == test_6) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_17603.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_17603.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 296)).stringValue () ;
        result << categoryReader_initialization (enumerator_17603.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 296)).stringValue () ;
        result << " ;\n" ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      ...
      while (enumerator_17818.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_17818.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 303)).stringValue () ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_19567.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_19567.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 338)).stringValue () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << enumerator_19567.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 338)).stringValue () ;
      result << " ;\n" ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_20265.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_20265.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 350)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_20265.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 350)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  return ptr->mLexicalAttribute_" ;
      result << enumerator_20265.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 352)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_21254.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_21254.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 362)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 362)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_21254.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 362)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        "  GALGAS_location currentLocation (ptr->mStartLocation, ptr->mEndLocation, sourceText ()) ;\n"
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_21254.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 366)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 366)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_21254.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 366)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_21254.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 367)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 367)).stringValue () ;
      result << " result (value, currentLocation) ;\n"
        "  return result ;\n"
        "}\n"
        "\n" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 379)).isValid ()) {
    cEnumerator_terminalList enumerator_22981 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 379)), kEnumeration_up) ;
    while (enumerator_22981.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_22981.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_implementation.new.cpp.galgasTemplate", 380)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (kBoolTrue == test_7) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_10469.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_10469.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 195)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_10469.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 195)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_10469.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 195)).stringValue () ;
        result << " ;\n" ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      ...
      while (enumerator_10681.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_10681.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 201)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 255)).isValid ()) {
    cEnumerator_terminalList enumerator_14049 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 255)), kEnumeration_up) ;
    while (enumerator_14049.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_14049.current_mStyleIndex (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 256)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_14049.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 256)).reader_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 256)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 269)).isValid ()) {
    cEnumerator_terminalList enumerator_15070 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 269)), kEnumeration_up) ;
    while (enumerator_15070.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_15070.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 270)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_15070.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 270)).reader_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 270)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXICAL_5F_STYLE_5F_LIST.isValid ()) {
    ...
    while (enumerator_16172.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_16172.current_mComment (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 287)).reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 287)).stringValue () ;
  ...
  if (in_LEXICAL_5F_STYLE_5F_LIST.isValid ()) {
    ...
    while (enumerator_17227.hasCurrentObject ()) {
      ...
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_17227.current_mName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 306)).stringValue () ;
      result << "\"" ;
...
void routine_parseLexiqueComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    C_String syntaxDirectedTranslationResult_33466 ;
    cGrammar_lexiqueLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_33466, constinArgument_inSourceFile, outArgument_outLexiqueComponentRoot  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 805)) ;
    {
...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  cEnumerator_externRoutineListAST enumerator_34908 (constinArgument_inLexiqueComponentRoot.reader_mExternRoutineList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 833)), kEnumeration_up) ;
  while (enumerator_34908.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_35042 (enumerator_34908.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_35042.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_35042.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 837)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_35042.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_35042.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 838))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 838)) ;
      enumerator_35042.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_34908.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_34908.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 840)) ;
    }
  ...
  cEnumerator_externFunctionListAST enumerator_35712 (constinArgument_inLexiqueComponentRoot.reader_mExternFunctionList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 846)), kEnumeration_up) ;
  while (enumerator_35712.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_35849 (enumerator_35712.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_35849.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_35849.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 850)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_35849.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 851))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 851)) ;
      enumerator_35849.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_35712.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 854)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_35712.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 855)) ;
    }
  ...
  cEnumerator_lexicalStyleListAST enumerator_37388 (constinArgument_inLexiqueComponentRoot.reader_mLexicalStyleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 889)), kEnumeration_up) ;
  while (enumerator_37388.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_37388.current_mName (HERE), enumerator_37388.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 890)) ;
    }
    var_styleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 891)) ;
    enumerator_37388.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_terminalDeclarationListAST enumerator_37850 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 900)), kEnumeration_up) ;
  while (enumerator_37850.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, enumerator_37850.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 902)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 902)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_lstring joker_37992 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 903)).method_searchKey (enumerator_37850.current_mStyle (HERE), joker_37992, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 903)) ;
    }
    ...
    cEnumerator_sentLexicalAttributeListAST enumerator_38117 (enumerator_37850.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_38117.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_38117.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 908)) ;
      var_argumentTypeList.addAssign_operation (enumerator_38117.current_mFormalSelector (HERE), enumerator_38117.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 909)) ;
      enumerator_38117.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_37850.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 911)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_38561 (enumerator_37850.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_38561.hasCurrentObject ()) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_38561.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 915)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        const enumGalgasBool test_5 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_5) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_5) {
          GALGAS_location location_6 (enumerator_38561.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_38561.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 921)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_location location_8 (enumerator_38561.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_38561.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_37850.current_mName (HERE), var_argumentTypeList, enumerator_37850.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 932)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 929)) ;
    enumerator_37850.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_39418 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 938)), kEnumeration_up) ;
  while (enumerator_39418.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, enumerator_39418.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 940)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 940)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_lstring joker_39560 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 941)).method_searchKey (enumerator_39418.current_mStyle (HERE), joker_39560, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 941)) ;
    }
    ...
    cEnumerator_sentLexicalAttributeListAST enumerator_39685 (enumerator_39418.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_39685.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_39685.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 946)) ;
      var_argumentTypeList.addAssign_operation (enumerator_39685.current_mFormalSelector (HERE), enumerator_39685.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 947)) ;
      enumerator_39685.gotoNextObject () ;
    }
    ...
    cEnumerator_lexicalListEntryListAST enumerator_40092 (enumerator_39418.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_40092.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_39418.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 952)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_40092.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 952)), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 952)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_40338 (enumerator_40092.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_40338.hasCurrentObject ()) {
        const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_40338.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 956)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_12) {
          const enumGalgasBool test_13 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_13) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_13) {
            GALGAS_location location_14 (enumerator_40338.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_40338.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 962)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_15) {
            GALGAS_location location_16 (enumerator_40338.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            if (kBoolTrue == test_17) {
              GALGAS_location location_18 (enumerator_40338.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_40092.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 970)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_40092.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 978)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_40092.current_mEntrySpelling (HERE), enumerator_40092.current_mTerminalSpelling (HERE), enumerator_40092.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 979)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_40092.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 980)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 980)), enumerator_40092.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 980)), enumerator_40092.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 980))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 980)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_40092.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 981))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 981)) ;
      enumerator_40092.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_39418.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 983)) ;
    }
    enumerator_39418.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_41824 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 986)), kEnumeration_up) ;
  while (enumerator_41824.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_41824.current_mMessageName (HERE), enumerator_41824.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 987)) ;
    }
    enumerator_41824.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_42047 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 990)), kEnumeration_up) ;
  while (enumerator_42047.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_42047.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 991)) ;
    enumerator_42047.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_42249 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 994)), kEnumeration_up) ;
  while (enumerator_42249.hasCurrentObject ()) {
    const enumGalgasBool test_19 = enumerator_42249.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("lexiqueCompilation.gSemantics", 995)).boolEnum () ;
    if (kBoolTrue == test_19) {
      GALGAS_location location_20 (enumerator_42249.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_42249.gotoNextObject () ;
  }
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_42469 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1000)), kEnumeration_up) ;
  while (enumerator_42469.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_42469.current_mStartString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1001))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1001)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_42469.current_mEndString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1002))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1002)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_42697 (enumerator_42469.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_42697.hasCurrentObject ()) {
      const enumGalgasBool test_21 = GALGAS_bool (kIsNotEqual, enumerator_42697.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1005)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_42697.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        if (kBoolTrue == test_23) {
          GALGAS_location location_24 (enumerator_42697.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_42697.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_42469.current_mStartString (HERE), enumerator_42469.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1013)) ;
  ...
  if (kBoolTrue == test_25) {
    cEnumerator_indexingListAST enumerator_43311 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1017)), kEnumeration_up) ;
    while (enumerator_43311.hasCurrentObject ()) {
      GALGAS_location location_26 (enumerator_43311.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_43311.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1021)) ;
  cEnumerator_indexingListAST enumerator_43533 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1022)), kEnumeration_up) ;
  while (enumerator_43533.hasCurrentObject ()) {
    const enumGalgasBool test_27 = var_indexNameSet.reader_hasKey (enumerator_43533.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1023)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1023)).boolEnum () ;
    if (kBoolTrue == test_27) {
      GALGAS_location location_28 (enumerator_43533.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_28, GALGAS_string ("the '").operator_concat (enumerator_43533.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1024))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1024)).operator_concat (GALGAS_string ("' index is already declared")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1024))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1024)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_43533.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1026))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1026)) ;
    enumerator_43533.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_43866 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1029)), kEnumeration_up) ;
  while (enumerator_43866.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43866.current_mMatchString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1030))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1030)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43866.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1031))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1031)) ;
    enumerator_43866.gotoNextObject () ;
  }
