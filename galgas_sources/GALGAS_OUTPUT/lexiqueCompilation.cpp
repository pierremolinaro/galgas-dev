...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (131)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_9284 = GGS_uint (4U) ;
      if (indentation_9284.isBuilt ()) {
        result.incIndentation ((sint32) indentation_9284.uintValue ()) ;
      }
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_11235 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (242)), true) ;
    const GGS_terminalList::cElement * operand_11235 = NULL ;
    while (((operand_11235 = enumerator_11235.nextObject ()))) {
      macroValidPointer (operand_11235) ;
      result << ",\n"
        "    " ;
      result << operand_11235->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_11235->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (243)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_12053 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (257)), true) ;
    const GGS_lexicalStyleList::cElement * operand_12053 = NULL ;
    while (((operand_12053 = enumerator_12053.nextObject ()))) {
      macroValidPointer (operand_12053) ;
      result << ",\n"
        "    @" ;
      result << operand_12053->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258)).reader_CStringConstantRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_12816 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (272)), true) ;
    const GGS_lexicalStyleList::cElement * operand_12816 = NULL ;
    while (((operand_12816 = enumerator_12816.nextObject ()))) {
      macroValidPointer (operand_12816) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_12816->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (273)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
...
void routine_parseLexiqueComponent (C_Compiler & inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (679)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679))).isBuiltAndTrue ()) {
    const GGS_parsedLexiqueComponentMap  temp_27974 = var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (680)) ;
    if (temp_27974.isBuilt ()) {
      temp_27974 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_outLexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (680)) ;
    }
  }else{
...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
  ...
  {
    GGS_externRoutineList::cEnumerator enumerator_30287 (var_cas_lexiqueComponentRoot.reader_mExternRoutineList (inLexique COMMA_SOURCE_FILE_AT_LINE (724)), true) ;
    const GGS_externRoutineList::cElement * operand_30287 = NULL ;
    while (((operand_30287 = enumerator_30287.nextObject ()))) {
      ...
      {
        GGS_lexicalExternRoutineFormalArgumentList::cEnumerator enumerator_30461 (operand_30287->mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalExternRoutineFormalArgumentList::cElement * operand_30461 = NULL ;
        while (((operand_30461 = enumerator_30461.nextObject ()))) {
          macroValidPointer (operand_30461) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          const GGS_lexicalTypeMap  temp_30547 = var_cas_lexicalTypeMap ;
          if (temp_30547.isBuilt ()) {
            temp_30547 (HERE)->method_searchKey (inLexique, operand_30461->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (728)) ;
          }
          var_cas_lexicalRoutineFormalArgumentList._addAssign_operation (operand_30461->mPassingMode, var_cas_lexicalFormalArgumentType, operand_30461->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (729))) ;
        }
      }
      var_cas_lexicalRoutineMap.modifier_insertKey (inLexique, operand_30287->mRoutineName, var_cas_lexicalRoutineFormalArgumentList, operand_30287->mErrorMessageList, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (731)) ;
    }
  }
  ...
  {
    GGS_externFunctionList::cEnumerator enumerator_31092 (var_cas_lexiqueComponentRoot.reader_mExternFunctionList (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), true) ;
    const GGS_externFunctionList::cElement * operand_31092 = NULL ;
    while (((operand_31092 = enumerator_31092.nextObject ()))) {
      macroValidPointer (operand_31092) ;
      ...
      {
        GGS_lexicalExternFunctionFormalArgumentList::cEnumerator enumerator_31270 (operand_31092->mLexicalFunctionFormalArgumentList, true) ;
        const GGS_lexicalExternFunctionFormalArgumentList::cElement * operand_31270 = NULL ;
        while (((operand_31270 = enumerator_31270.nextObject ()))) {
          macroValidPointer (operand_31270) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          const GGS_lexicalTypeMap  temp_31356 = var_cas_lexicalTypeMap ;
          if (temp_31356.isBuilt ()) {
            temp_31356 (HERE)->method_searchKey (inLexique, operand_31270->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (741)) ;
          }
          var_cas_lexicalFunctionFormalArgumentList._addAssign_operation (var_cas_lexicalFormalArgumentType, operand_31270->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (742))) ;
        }
      }
      GGS_lexicalTypeEnum var_cas_returnedArgumentType ;
      const GGS_lexicalTypeMap  temp_31598 = var_cas_lexicalTypeMap ;
      if (temp_31598.isBuilt ()) {
        temp_31598 (HERE)->method_searchKey (inLexique, operand_31092->mReturnedTypeName, var_cas_returnedArgumentType COMMA_SOURCE_FILE_AT_LINE (745)) ;
      }
      var_cas_lexicalFunctionMap.modifier_insertKey (inLexique, operand_31092->mFunctionName, var_cas_lexicalFunctionFormalArgumentList, var_cas_returnedArgumentType, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (746)) ;
    }
  }
  ...
  {
    GGS_lexicalStyleList::cEnumerator enumerator_32296 (var_cas_lexiqueComponentRoot.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (763)), true) ;
    const GGS_lexicalStyleList::cElement * operand_32296 = NULL ;
    while (((operand_32296 = enumerator_32296.nextObject ()))) {
      macroValidPointer (operand_32296) ;
      var_cas_lexiqueAnalysisContext.mStyleMap.modifier_insertKey (inLexique, operand_32296->mName, operand_32296->mComment, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (764)) ;
      var_cas_styleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (765)) ;
    }
  }
  {
    GGS_lexicalAttributeList::cEnumerator enumerator_32547 (var_cas_lexiqueComponentRoot.reader_mLexicalAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (768)), true) ;
    const GGS_lexicalAttributeList::cElement * operand_32547 = NULL ;
    while (((operand_32547 = enumerator_32547.nextObject ()))) {
      macroValidPointer (operand_32547) ;
      if ((var_cas_lexicalTypeMap.reader_hasKey (inLexique, operand_32547->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (769)) COMMA_SOURCE_FILE_AT_LINE (769))).isBuiltAndTrue ()) {
        GGS_lexicalTypeEnum var_cas_lexicalType ;
        const GGS_lexicalTypeMap  temp_32718 = var_cas_lexicalTypeMap ;
        if (temp_32718.isBuilt ()) {
          temp_32718 (HERE)->method_searchKey (inLexique, operand_32547->mTypeName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (771)) ;
        }
        var_cas_lexiqueAnalysisContext.mLexicalAttributeMap.modifier_insertKey (inLexique, operand_32547->mName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (772)) ;
      }else{
        GGS_string var_cas_m ;
        var_cas_m = GGS_string ("") ;
        var_cas_m.appendCString ("the @") ;
        var_cas_m.dotAssign_operation (operand_32547->mTypeName) ;
        ...
        {
          GGS_lexicalTypeMap::cEnumerator enumerator_33020 (var_cas_lexicalTypeMap, true) ;
          const GGS_lexicalTypeMap::cElement * operand_33020 = enumerator_33020.nextObject () ;
          if ((operand_33020 != NULL)) {
            bool _foreach_loop_33020 ;
            do{
              macroValidPointer (operand_33020) ;
              var_cas_m.appendCString (" @") ;
              var_cas_m.dotAssign_operation (operand_33020->mKey) ;
              operand_33020 = enumerator_33020.nextObject () ;
              _foreach_loop_33020 = ((operand_33020 != NULL)) ;
              if (_foreach_loop_33020) {
                var_cas_m.appendCString (",") ;
              }
            }while (_foreach_loop_33020) ;
          }
        }
        operand_32547->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (783)) ;
      }
    }
  }
  {
    GGS_terminalDeclarationList::cEnumerator enumerator_33230 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), true) ;
    const GGS_terminalDeclarationList::cElement * operand_33230 = NULL ;
    while (((operand_33230 = enumerator_33230.nextObject ()))) {
      macroValidPointer (operand_33230) ;
      GGS_uint  var_cas_terminalStyleIndex ;
      var_cas_terminalStyleIndex = GGS_uint (0U) ;
      if (((operand_33230->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (788)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (788))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_11 ;
        const GGS_styleMap  temp_33408 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (789)) ;
        if (temp_33408.isBuilt ()) {
          temp_33408 (HERE)->method_searchKey (inLexique, operand_33230->mStyle, automatic_var_11, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (789)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_33543 (operand_33230->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_33543 = NULL ;
        while (((operand_33543 = enumerator_33543.nextObject ()))) {
          macroValidPointer (operand_33543) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_33682 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (794)) ;
          if (temp_33682.isBuilt ()) {
            temp_33682 (HERE)->method_searchKey (inLexique, operand_33543->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (794)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (operand_33543->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), var_cas_attributeLexicalType) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_33230->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (797)) ;
      GGS_bool var_cas_isEndOfTemplateMark ;
      var_cas_isEndOfTemplateMark = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_33962 (operand_33230->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_33962 = NULL ;
        while (((operand_33962 = enumerator_33962.nextObject ()))) {
          macroValidPointer (operand_33962) ;
          if (((operand_33962->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (800))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
            operand_33962->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (802)) ;
          }else if ((var_cas_isEndOfTemplateMark).isBuiltAndTrue ()) {
            operand_33962->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (804)) ;
          }else{
            var_cas_isEndOfTemplateMark = GGS_bool (true) ;
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalList._addAssign_operation (operand_33230->mName, var_cas_argumentTypeList, operand_33230->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (811)), var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
    }
  }
  {
    GGS_lexicalListDeclarationList::cEnumerator enumerator_34485 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (816)), true) ;
    const GGS_lexicalListDeclarationList::cElement * operand_34485 = NULL ;
    while (((operand_34485 = enumerator_34485.nextObject ()))) {
      macroValidPointer (operand_34485) ;
      GGS_uint  var_cas_terminalStyleIndex ;
      var_cas_terminalStyleIndex = GGS_uint (0U) ;
      if (((operand_34485->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (818)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (818))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_12 ;
        const GGS_styleMap  temp_34666 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (819)) ;
        if (temp_34666.isBuilt ()) {
          temp_34666 (HERE)->method_searchKey (inLexique, operand_34485->mStyle, automatic_var_12, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (819)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_34801 (operand_34485->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_34801 = NULL ;
        while (((operand_34801 = enumerator_34801.nextObject ()))) {
          macroValidPointer (operand_34801) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_34939 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (824)) ;
          if (temp_34939.isBuilt ()) {
            temp_34939 (HERE)->method_searchKey (inLexique, operand_34801->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (824)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (operand_34801->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (825)), var_cas_attributeLexicalType) ;
        }
      }
      ...
      {
        GGS_lexicalListEntryList::cEnumerator enumerator_35219 (operand_34485->mEntryList, true) ;
        const GGS_lexicalListEntryList::cElement * operand_35219 = NULL ;
        while (((operand_35219 = enumerator_35219.nextObject ()))) {
          macroValidPointer (operand_35219) ;
          GGS_string var_cas_syntaxErrorMessage ;
          var_cas_syntaxErrorMessage = operand_34485->mSyntaxErrorMessage.ggs_string ().reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_35219->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830)) COMMA_SOURCE_FILE_AT_LINE (830)) ;
          GGS_bool var_cas_isEndOfTemplateMark ;
          var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
            GGS_lstringlist::cEnumerator enumerator_35418 (operand_35219->mFeatureList, true) ;
            const GGS_lstringlist::cElement * operand_35418 = NULL ;
            while (((operand_35418 = enumerator_35418.nextObject ()))) {
              macroValidPointer (operand_35418) ;
              if (((operand_35418->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (833))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
                operand_35418->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (835)) ;
              }else if ((var_cas_isEndOfTemplateMark).isBuiltAndTrue ()) {
                operand_35418->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (837)) ;
              }else{
                var_cas_isEndOfTemplateMark = GGS_bool (true) ;
              }
            }
          }
          var_cas_lexiqueAnalysisContext.mTerminalList._addAssign_operation (operand_35219->mTerminalSpelling, var_cas_argumentTypeList, var_cas_syntaxErrorMessage, var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
          var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_35219->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (848)) ;
          var_cas_lexicalTokenListMap.modifier_insertKey (inLexique, operand_35219->mEntrySpelling, operand_35219->mTerminalSpelling, operand_35219->mFeatureList COMMA_SOURCE_FILE_AT_LINE (849)) ;
          var_cas_tokenSortedlist._addAssign_operation (operand_35219->mEntrySpelling.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_35219->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_35219->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (850))) ;
          var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_35219->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (851))) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mLexicalTokenListMap.modifier_insertKey (inLexique, operand_34485->mName, var_cas_lexicalTokenListMap, var_cas_tokenSortedlist, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (853)) ;
    }
  }
  {
    GGS_lexicalMessageDeclarationList::cEnumerator enumerator_36541 (var_cas_lexiqueComponentRoot.reader_mLexicalMessageDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (856)), true) ;
    const GGS_lexicalMessageDeclarationList::cElement * operand_36541 = NULL ;
    while (((operand_36541 = enumerator_36541.nextObject ()))) {
      macroValidPointer (operand_36541) ;
      var_cas_lexiqueAnalysisContext.mLexicalMessageMap.modifier_insertKey (inLexique, operand_36541->mMessageName, operand_36541->mMessageValue, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    }
  }
  {
    GGS_lexicalRuleList::cEnumerator enumerator_36775 (var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (860)), true) ;
    const GGS_lexicalRuleList::cElement * operand_36775 = NULL ;
    while (((operand_36775 = enumerator_36775.nextObject ()))) {
      macroValidPointer (operand_36775) ;
      const GGS_abstractLexicalRule  temp_36851 = operand_36775->mLexicalRule ;
      if (temp_36851.isBuilt ()) {
        typeCategoryMethod__abstractLexicalRule__checkLexicalRule method = findCategoryMethod__abstractLexicalRule__checkLexicalRule (temp_36851.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_36851 (HERE), var_cas_lexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (861)) ;
        }
      }
    }
  }
  {
    GGS_lexicalMessageMap::cEnumerator enumerator_36973 (var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (864)), true) ;
    const GGS_lexicalMessageMap::cElement * operand_36973 = NULL ;
    while (((operand_36973 = enumerator_36973.nextObject ()))) {
      macroValidPointer (operand_36973) ;
      if (((operand_36973->mInfo.mMessageIsUsed).operator_not ()).isBuiltAndTrue ()) {
        operand_36973->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (866)) ;
      }
    }
  }
  {
    GGS_metamodelTemplateDelimitorList::cEnumerator enumerator_37188 (var_cas_lexiqueComponentRoot.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (870)), true) ;
    const GGS_metamodelTemplateDelimitorList::cElement * operand_37188 = NULL ;
    while (((operand_37188 = enumerator_37188.nextObject ()))) {
      macroValidPointer (operand_37188) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37188->mStartString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (871))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37188->mEndString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (872))) ;
      GGS_bool var_cas_preservesStartDelimiter ;
      var_cas_preservesStartDelimiter = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_37458 (operand_37188->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_37458 = NULL ;
        while (((operand_37458 = enumerator_37458.nextObject ()))) {
          macroValidPointer (operand_37458) ;
          if (((operand_37458->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (875))).operator_isNotEqual (GGS_string ("preserved"))).isBuiltAndTrue ()) {
            operand_37458->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'preserved' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (877)) ;
          }else if ((var_cas_preservesStartDelimiter).isBuiltAndTrue ()) {
            operand_37458->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'preserved' feature is already set") COMMA_SOURCE_FILE_AT_LINE (879)) ;
          }else{
            var_cas_preservesStartDelimiter = GGS_bool (true) ;
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTemplateDelimitorList._addAssign_operation (operand_37188->mStartString, operand_37188->mEndString, var_cas_preservesStartDelimiter) ;
    }
  }
  {
    GGS_templateReplacementList::cEnumerator enumerator_37956 (var_cas_lexiqueComponentRoot.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (886)), true) ;
    const GGS_templateReplacementList::cElement * operand_37956 = NULL ;
    while (((operand_37956 = enumerator_37956.nextObject ()))) {
      macroValidPointer (operand_37956) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37956->mMatchString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (887))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37956->mReplacementString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (888))) ;
    }
  }
