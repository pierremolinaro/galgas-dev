...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
  ...
  {
    GGS_terminalDeclarationListAST::cEnumerator enumerator_33282 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), true) ;
    const GGS_terminalDeclarationListAST::cElement * operand_33282 = NULL ;
    while (((operand_33282 = enumerator_33282.nextObject ()))) {
      macroValidPointer (operand_33282) ;
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_33502 = (operand_33282->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (785)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_33502.isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_33492_0 ;
        const GGS_styleMap  temp_33460 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (786)) ;
        if (temp_33460.isBuilt ()) {
          temp_33460 (HERE)->method_searchKey (inLexique, operand_33282->mStyle, automatic_var_33492_0, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (786)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_33595 (operand_33282->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_33595 = NULL ;
        while (((operand_33595 = enumerator_33595.nextObject ()))) {
          macroValidPointer (operand_33595) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_33708 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (791)) ;
          if (temp_33708.isBuilt ()) {
            temp_33708 (HERE)->method_searchKey (inLexique, operand_33595->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (791)) ;
          }
          var_cas_argumentTypeList.addAssign_operation (operand_33595->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (792)), var_cas_attributeLexicalType) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_33282->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (794)) ;
      GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_33973 (operand_33282->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_33973 = NULL ;
        while (((operand_33973 = enumerator_33973.nextObject ()))) {
          macroValidPointer (operand_33973) ;
          const GGS_bool cond_34115 = (operand_33973->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (797))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
          if (cond_34115.isBuiltAndTrue ()) {
            operand_33973->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (799)) ;
          }else if (cond_34115.isBuiltAndFalse ()) {
            const GGS_bool cond_34221 = var_cas_isEndOfTemplateMark ;
            if (cond_34221.isBuiltAndTrue ()) {
              operand_33973->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (801)) ;
            }else if (cond_34221.isBuiltAndFalse ()) {
              var_cas_isEndOfTemplateMark = GGS_bool (true) ;
            }
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalList.addAssign_operation (operand_33282->mName, var_cas_argumentTypeList, operand_33282->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
    }
  }
  {
    GGS_lexicalListDeclarationListAST::cEnumerator enumerator_34497 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (813)), true) ;
    const GGS_lexicalListDeclarationListAST::cElement * operand_34497 = NULL ;
    while (((operand_34497 = enumerator_34497.nextObject ()))) {
      macroValidPointer (operand_34497) ;
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_34720 = (operand_34497->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (815)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_34720.isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_34710_0 ;
        const GGS_styleMap  temp_34678 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (816)) ;
        if (temp_34678.isBuilt ()) {
          temp_34678 (HERE)->method_searchKey (inLexique, operand_34497->mStyle, automatic_var_34710_0, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (816)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_34813 (operand_34497->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_34813 = NULL ;
        while (((operand_34813 = enumerator_34813.nextObject ()))) {
          macroValidPointer (operand_34813) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_34925 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (821)) ;
          if (temp_34925.isBuilt ()) {
            temp_34925 (HERE)->method_searchKey (inLexique, operand_34813->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (821)) ;
          }
          var_cas_argumentTypeList.addAssign_operation (operand_34813->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (822)), var_cas_attributeLexicalType) ;
        }
      }
      ...
      {
        GGS_lexicalListEntryListAST::cEnumerator enumerator_35189 (operand_34497->mEntryList, true) ;
        const GGS_lexicalListEntryListAST::cElement * operand_35189 = NULL ;
        while (((operand_35189 = enumerator_35189.nextObject ()))) {
          macroValidPointer (operand_35189) ;
          GGS_string var_cas_syntaxErrorMessage = operand_34497->mSyntaxErrorMessage.ggs_string ().reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_35189->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
          GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
            GGS_lstringlist::cEnumerator enumerator_35388 (operand_35189->mFeatureList, true) ;
            const GGS_lstringlist::cElement * operand_35388 = NULL ;
            while (((operand_35388 = enumerator_35388.nextObject ()))) {
              macroValidPointer (operand_35388) ;
              const GGS_bool cond_35536 = (operand_35388->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
              if (cond_35536.isBuiltAndTrue ()) {
                operand_35388->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (832)) ;
              }else if (cond_35536.isBuiltAndFalse ()) {
                const GGS_bool cond_35646 = var_cas_isEndOfTemplateMark ;
                if (cond_35646.isBuiltAndTrue ()) {
                  operand_35388->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (834)) ;
                }else if (cond_35646.isBuiltAndFalse ()) {
                  var_cas_isEndOfTemplateMark = GGS_bool (true) ;
                }
              }
            }
          }
          var_cas_lexiqueAnalysisContext.mTerminalList.addAssign_operation (operand_35189->mTerminalSpelling, var_cas_argumentTypeList, var_cas_syntaxErrorMessage, var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
          var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_35189->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (845)) ;
          var_cas_lexicalTokenListMap.modifier_insertKey (inLexique, operand_35189->mEntrySpelling, operand_35189->mTerminalSpelling, operand_35189->mFeatureList COMMA_SOURCE_FILE_AT_LINE (846)) ;
          var_cas_tokenSortedlist.addAssign_operation (operand_35189->mEntrySpelling.ggs_string ().reader_length (), operand_35189->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (847)), operand_35189->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (847))) ;
          var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_35189->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (848))) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mLexicalTokenListMap.modifier_insertKey (inLexique, operand_34497->mName, var_cas_lexicalTokenListMap, var_cas_tokenSortedlist, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (850)) ;
    }
  }
  {
    GGS_lexicalMessageDeclarationListAST::cEnumerator enumerator_36515 (var_cas_lexiqueComponentRoot.reader_mLexicalMessageDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (853)), true) ;
    const GGS_lexicalMessageDeclarationListAST::cElement * operand_36515 = NULL ;
    while (((operand_36515 = enumerator_36515.nextObject ()))) {
      macroValidPointer (operand_36515) ;
      var_cas_lexiqueAnalysisContext.mLexicalMessageMap.modifier_insertKey (inLexique, operand_36515->mMessageName, operand_36515->mMessageValue, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (854)) ;
    }
  }
  {
    GGS_lexicalRuleListAST::cEnumerator enumerator_36750 (var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (857)), true) ;
    const GGS_lexicalRuleListAST::cElement * operand_36750 = NULL ;
    while (((operand_36750 = enumerator_36750.nextObject ()))) {
      macroValidPointer (operand_36750) ;
      { typeCategoryMethod__abstractLexicalRuleAST__checkLexicalRule method = findCategoryMethod__abstractLexicalRuleAST__checkLexicalRule (operand_36750->mLexicalRule.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_36750->mLexicalRule (HERE), var_cas_lexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (858)) ;
        }
      }
    }
  }
  {
    GGS_lexicalMessageMap::cEnumerator enumerator_36948 (var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (861)), true) ;
    const GGS_lexicalMessageMap::cElement * operand_36948 = NULL ;
    while (((operand_36948 = enumerator_36948.nextObject ()))) {
      macroValidPointer (operand_36948) ;
      const GGS_bool cond_37070 = (operand_36948->mInfo.mMessageIsUsed).operator_not () ;
      if (cond_37070.isBuiltAndTrue ()) {
        operand_36948->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (863)) ;
      }
    }
  }
  {
    GGS_metamodelTemplateDelimitorListAST::cEnumerator enumerator_37164 (var_cas_lexiqueComponentRoot.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (867)), true) ;
    const GGS_metamodelTemplateDelimitorListAST::cElement * operand_37164 = NULL ;
    while (((operand_37164 = enumerator_37164.nextObject ()))) {
      macroValidPointer (operand_37164) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37164->mStartString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (868))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37164->mEndString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (869))) ;
      GGS_bool var_cas_preservesStartDelimiter = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_37436 (operand_37164->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_37436 = NULL ;
        while (((operand_37436 = enumerator_37436.nextObject ()))) {
          macroValidPointer (operand_37436) ;
          const GGS_bool cond_37563 = (operand_37436->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (872))).operator_isNotEqual (GGS_string ("preserved")) ;
          if (cond_37563.isBuiltAndTrue ()) {
            operand_37436->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'preserved' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (874)) ;
          }else if (cond_37563.isBuiltAndFalse ()) {
            const GGS_bool cond_37665 = var_cas_preservesStartDelimiter ;
            if (cond_37665.isBuiltAndTrue ()) {
              operand_37436->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'preserved' feature is already set") COMMA_SOURCE_FILE_AT_LINE (876)) ;
            }else if (cond_37665.isBuiltAndFalse ()) {
              var_cas_preservesStartDelimiter = GGS_bool (true) ;
            }
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTemplateDelimitorList.addAssign_operation (operand_37164->mStartString, operand_37164->mEndString, var_cas_preservesStartDelimiter) ;
    }
  }
  {
    GGS_templateReplacementListAST::cEnumerator enumerator_37934 (var_cas_lexiqueComponentRoot.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (883)), true) ;
    const GGS_templateReplacementListAST::cElement * operand_37934 = NULL ;
    while (((operand_37934 = enumerator_37934.nextObject ()))) {
      macroValidPointer (operand_37934) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37934->mMatchString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (884))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37934->mReplacementString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (885))) ;
    }
  }
  GGS_string var_cas_lexiqueClassName = var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (889)) ;
  const GGS_bool cond_38956 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (891))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_38956.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_39749 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (911))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_39749.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_40268 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (933))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_40268.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_40993 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (951))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_40993.isBuiltAndTrue ()) {
