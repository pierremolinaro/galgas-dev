...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_7509 = enumerator_7509.nextObject ()))) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7509->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7509->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_utf8Representation () ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
    ...
    if (enumerator_8528.hasCurrentObject ()) {
      ...
      while (((operand_8528 = enumerator_8528.nextObject ()))) {
        ...
        result << "  {kUnicodeString_" ;
        result << operand_8528->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_8528->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        if ((operand_8528->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8528->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_8528->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << "," ;
        }
        result << " NULL, " ;
    ...
    if (enumerator_9551.hasCurrentObject ()) {
      ...
      while (((operand_9551 = enumerator_9551.nextObject ()))) {
        ...
        result << "  {kUnicodeString_" ;
        result << operand_9551->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9551->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", kUnicodeString_" ;
        result << operand_9551->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9551->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        if ((operand_9551->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
