...
//                    february 24th, 2010, at 18h36'46"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9807 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (199)), true) ;
    const GGS_templateReplacementList::cElement * operand_9807 = NULL ;
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (240)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalRuleList::cEnumerator enumerator_14311 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14311 = NULL ;
      while (((operand_14311 = enumerator_14311.nextObject ()))) {
        macroValidPointer (operand_14311) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14311->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14311->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (285))) ;
      }
       ;
      if (indentation_14982.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_14982.uintValue ())) ;
      ...
      GGS_lexicalRuleList::cEnumerator enumerator_15237 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_15237 = NULL ;
      while (((operand_15237 = enumerator_15237.nextObject ()))) {
        macroValidPointer (operand_15237) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_15237->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_15237->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (310))) ;
      }
       ;
      if (indentation_15744.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15744.uintValue ())) ;
