...
template_filewrapper_lexiqueGenerationTemplates_newHeaderZone2 (C_CompilerEx & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "_CLASS_DEFINED\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalRoutineMap::cEnumerator enumerator_701 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalRoutineMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (16)), true) ;
    const GGS_lexicalRoutineMap::cElement * operand_701 = NULL ;
    while (((operand_701 = enumerator_701.nextObject ()))) {
      macroValidPointer (operand_701) ;
      if (operand_701->mInfo.mIsExtern.boolValue ()) {
        result << "\n"
          "void scanner_routine_" ;
        result << operand_701->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
        result << " (C_Lexique & inLexique" ;
        GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_845 (operand_701->mInfo.mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalRoutineFormalArgumentList::cElement * operand_845 = NULL ;
        while (((operand_845 = enumerator_845.nextObject ()))) {
          macroValidPointer (operand_845) ;
          result << ",\n"
            "                " ;
          result << operand_845->mLexicalFormalArgumentMode.reader_cppConstInFormalArgument (inLexique COMMA_SOURCE_FILE_AT_LINE (20)) ;
          result << operand_845->mLexicalFormalArgumentType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (21)) ;
          result << operand_845->mLexicalFormalArgumentMode.reader_cppReferenceInFormalArgument (inLexique COMMA_SOURCE_FILE_AT_LINE (22)) ;
          result << " " ;
          result << operand_845->mArgumentNameForComment ;
        }
        GGS_stringlist::cEnumerator enumerator_1198 (operand_701->mInfo.mErrorMessageList, true) ;
        const GGS_stringlist::cElement * operand_1198 = NULL ;
        while (((operand_1198 = enumerator_1198.nextObject ()))) {
          macroValidPointer (operand_1198) ;
          result << ",\n"
            "                const char * " ;
          result << operand_1198->mValue ;
        }
        result << ") ;\n" ;
      }else {
      }
    ...
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalFunctionMap::cEnumerator enumerator_1764 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (38)), true) ;
    const GGS_lexicalFunctionMap::cElement * operand_1764 = NULL ;
    while (((operand_1764 = enumerator_1764.nextObject ()))) {
      macroValidPointer (operand_1764) ;
      if (operand_1764->mInfo.mIsExtern.boolValue ()) {
        result << "\n" ;
        result << operand_1764->mInfo.mReturnedLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (40)) ;
        result << " scanner_function_" ;
        result << operand_1764->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (40)) ;
        result << " (C_Lexique & inLexique" ;
        GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_1925 (operand_1764->mInfo.mLexicalTypeList, true) ;
        const GGS_lexicalFunctionFormalArgumentList::cElement * operand_1925 = NULL ;
        while (((operand_1925 = enumerator_1925.nextObject ()))) {
          macroValidPointer (operand_1925) ;
          result << ",\n"
            "                const " ;
          result << operand_1925->mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
          result << " " ;
          result << operand_1925->mArgumentNameForComment ;
        }
        result << ") ;\n" ;
      }else {
      }
    ...
    result << var_cas_LEXIQUE_IDENTIFIER ;
    result << " : public cToken {\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_2589 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (56)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_2589 = NULL ;
    while (((operand_2589 = enumerator_2589.nextObject ()))) {
      macroValidPointer (operand_2589) ;
      result << "  public : " ;
      result << operand_2589->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
      result << " mLexicalAttribute_" ;
      result << operand_2589->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "  public : cTokenFor_" ;
    ...
    result << " (void) {}\n"
      "  #endif\n" ;
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (90)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      result << "\n"
        "//--- Scanner mode for template scanner\n"
        "  private : PMSInt32 mMatchedTemplateDelimiterIndex ;\n" ;
    }else {
...
template_filewrapper_lexiqueGenerationTemplates_newHeaderZone3 (C_CompilerEx & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_517 = enumerator_517.nextObject ()))) {
      ...
      result << operand_517->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (18)).reader_identifierRepresentation () ;
    ...
    result << "\n"
      "\n"
      "//--- Attribute access\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_783 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (24)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_783 = NULL ;
    while (((operand_783 = enumerator_783.nextObject ()))) {
      macroValidPointer (operand_783) ;
      result << "  public : " ;
      result << operand_783->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (25)) ;
      result << " attributeValue_" ;
      result << operand_783->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const ;\n" ;
    }
    result << "\n"
      "\n"
...
template_filewrapper_lexiqueGenerationTemplates_newImplementationZone2 (C_CompilerEx & inLexique,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "\n"
      "#include \"" ;
    result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexiqueComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (22)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (22)) ;
    result << ".h\"\n"
      "\n"
      "//---------------------------------------------------------------------------*\n"
      "\n"
    ...
    result << var_cas_LEXIQUE_IDENTIFIER ;
    result << " (void)" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_1716 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_1716 = NULL ;
    if (enumerator_1716.hasCurrentObject ()) {
      result << " :\n" ;
      while (((operand_1716 = enumerator_1716.nextObject ()))) {
        macroValidPointer (operand_1716) ;
        result << "mLexicalAttribute_" ;
        result << operand_1716->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << " ()" ;
        if (enumerator_1716.hasNextObject ()) {
          result << ",\n" ;
        }
      }
    }
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (58)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      result << ",\n"
        "mMatchedTemplateDelimiterIndex (-1)" ;
    }else {
    }
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (72)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      result << ",\n"
        "mMatchedTemplateDelimiterIndex (-1)" ;
    }else {
    }
    result << " {\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalMessageMap::cEnumerator enumerator_3526 (var_cas_LEXICAL_MESSAGE_MAP, true) ;
    const GGS_lexicalMessageMap::cElement * operand_3526 = NULL ;
    while (((operand_3526 = enumerator_3526.nextObject ()))) {
      macroValidPointer (operand_3526) ;
      result << "\n"
        "static const utf32 gLexicalMessage_" ;
      result << operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) ;
      result << " [] = " ;
      result << operand_3526->mInfo.mLexicalMessage.ggs_string ().reader_utf32Representation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_terminalList::cEnumerator enumerator_4076 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_4076 = NULL ;
    while (((operand_4076 = enumerator_4076.nextObject ()))) {
      macroValidPointer (operand_4076) ;
      result << "\n"
        "//--- Syntax error message for terminal '$" ;
      result << operand_4076->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (95)) ;
      result << "$' :\n"
        "static const utf32 gSyntaxErrorMessage_" ;
      result << operand_4076->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96)).reader_identifierRepresentation () ;
      result << " [] = " ;
      result << operand_4076->mSyntaxErrorMessage.reader_utf32Representation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    result << "::appendTerminalMessageToSyntaxErrorMessage (const PMSInt16 inTerminalIndex,\n"
      "                                           C_String & outSyntaxErrorMessage) {\n"
      "  static const utf32 * syntaxErrorMessageArray [" ;
    result << var_cas_TERMINAL_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (107)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) ;
    result << "] = {kEndOfSourceLexicalErrorMessage" ;
    GGS_terminalList::cEnumerator enumerator_5063 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_5063 = NULL ;
    while (((operand_5063 = enumerator_5063.nextObject ()))) {
      macroValidPointer (operand_5063) ;
      result << ",\n"
        "    gSyntaxErrorMessage_" ;
      result << operand_5063->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (109)).reader_identifierRepresentation () ;
    }
    result << "} ;\n"
      "  outSyntaxErrorMessage << syntaxErrorMessageArray [inTerminalIndex] ;\n"
      "}\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_stringset::cEnumerator enumerator_5675 (var_cas_STRINGS_IN_EXPLICIT_RULES, true) ;
    while (enumerator_5675.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5675._key (HERE).reader_identifierRepresentation () ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5675._key (HERE).reader_identifierRepresentation () ;
      result << " [] = " ;
      result << enumerator_5675._key (HERE).reader_utf32Representation () ;
      result << " ;\n" ;
      enumerator_5675.next () ;
    }
    result << "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_5935 (var_cas_LEXICAL_TOKEN_LIST_MAP, true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_5935 = NULL ;
    while (((operand_5935 = enumerator_5935.nextObject ()))) {
      macroValidPointer (operand_5935) ;
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const PMSInt32 ktable_size_" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
      result << " = " ;
      result << operand_5935->mInfo.mExplicitTokenListMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
      result << " [ktable_size_" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
      result << "] = {\n" ;
      GGS_tokenSortedlist::cEnumerator enumerator_6693 (operand_5935->mInfo.mTokenSortedList, true) ;
      const GGS_tokenSortedlist::cElement * operand_6693 = NULL ;
      while (((operand_6693 = enumerator_6693.nextObject ()))) {
        macroValidPointer (operand_6693) ;
        result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
        result << operand_6693->mName.reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_6693->mLength.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
        result << ", C_Lexique_" ;
        result << var_cas_LEXIQUE_IDENTIFIER ;
        result << "::kToken_" ;
        result << operand_6693->mTerminalName.reader_identifierRepresentation () ;
        result << ")" ;
      ...
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::search_into_" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
      result << ", ktable_size_" ;
      result << operand_5935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
      result << ") ;\n"
        "}\n"
    ...
    result << " *) inTokenPtr ;\n"
      ...
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_8016 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_8016 = NULL ;
    while (((operand_8016 = enumerator_8016.nextObject ()))) {
      macroValidPointer (operand_8016) ;
      result << "    case kToken_" ;
      result << operand_8016->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162)).reader_identifierRepresentation () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_8016->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_utf8Representation () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_8346 (operand_8016->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_8346 = NULL ;
      while (((operand_8346 = enumerator_8346.nextObject ()))) {
        macroValidPointer (operand_8346) ;
        result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
          "      s." ;
        result << operand_8346->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_8346->mLexicalAttributeName.reader_identifierRepresentation () ;
        result << operand_8346->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_9157 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (185)), true) ;
    const GGS_templateDelimitorList::cElement * operand_9157 = NULL ;
    if (enumerator_9157.hasCurrentObject ()) {
      result << "static const cTemplateDelimiter kTemplateDefinitionArray [" ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
      result << "] = {\n" ;
      while (((operand_9157 = enumerator_9157.nextObject ()))) {
        macroValidPointer (operand_9157) ;
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_9157->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9157->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
        result << ", " ;
        if ((operand_9157->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_9157->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_9157->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_9157->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
        result << ")" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementListAST::cEnumerator enumerator_10194 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), true) ;
    const GGS_templateReplacementListAST::cElement * operand_10194 = NULL ;
    if (enumerator_10194.hasCurrentObject ()) {
      result << "static const cTemplateDelimiter kTemplateReplacementArray [" ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
      result << "] = {\n" ;
      while (((operand_10194 = enumerator_10194.nextObject ()))) {
        macroValidPointer (operand_10194) ;
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_10194->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_10194->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
        result << ", kUnicodeString_" ;
        result << operand_10194->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_10194->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        result << ", " ;
        if ((operand_10194->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_10194->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
        }
        result << ", true)" ;
        if (enumerator_10194.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_11253 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (227)), true) ;
    const GGS_terminalList::cElement * operand_11253 = NULL ;
    if (enumerator_11253.hasCurrentObject ()) {
      result << "static const bool kEndOfScriptInTemplateArray [" ;
      result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (228)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (228)) ;
      result << "] = {\n" ;
      while (((operand_11253 = enumerator_11253.nextObject ()))) {
        macroValidPointer (operand_11253) ;
        result << "  " ;
        result << operand_11253->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
        result << " /* " ;
        result << operand_11253->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
        result << " */" ;
        if (enumerator_11253.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << " token ;\n"
      ...
      "  token.mTokenCode = -1 ;\n"
      "  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\\0')) {\n" ;
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (247)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      result << "    if ((mMatchedTemplateDelimiterIndex >= 0)\n"
        "     && (kTemplateDefinitionArray [mMatchedTemplateDelimiterIndex].mEndStringLength > 0)\n"
        "     && (UNICODE_VALUE (mCurrentChar) != '\\0')) {\n"
        "      const bool foundEndDelimitor = testForInputUTF32String (kTemplateDefinitionArray [mMatchedTemplateDelimiterIndex].mEndString,\n"
        ...
        "      while (replacementIndex >= 0) {\n"
        "        replacementIndex = findTemplateDelimiterIndex (kTemplateReplacementArray, " ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (261)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
      result << ") ;\n"
        "        if (replacementIndex >= 0) {\n"
        "          if (kTemplateReplacementArray [replacementIndex].mReplacementFunction == NULL) {\n"
        "            token.mTemplateStringBeforeToken << kTemplateReplacementArray [replacementIndex].mEndString ;\n"
        ...
        "      }\n"
        "      mMatchedTemplateDelimiterIndex = findTemplateDelimiterIndex (kTemplateDefinitionArray, " ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (277)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (277)) ;
      result << ") ;\n"
        "      if (mMatchedTemplateDelimiterIndex < 0) {\n"
        "        token.mTemplateStringBeforeToken.appendUnicodeCharacter (mCurrentChar COMMA_HERE) ;\n"
        "        advance () ;\n"
        ...
        "    }\n"
        "    if ((mMatchedTemplateDelimiterIndex >= 0) && (UNICODE_VALUE (mCurrentChar) != '\\0')) {\n" ;
      GGS_lexicalAttributeMap::cEnumerator enumerator_14478 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14478 = NULL ;
      while (((operand_14478 = enumerator_14478.nextObject ()))) {
        macroValidPointer (operand_14478) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14478->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_14478->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (285)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15370 = GGS_uint (8U) ;
      if (indentation_15370.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15370.uintValue ()) ;
      }
      GGS_lexicalRuleListAST::cEnumerator enumerator_14699 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleListAST::cElement * operand_14699 = NULL ;
      while (((operand_14699 = enumerator_14699.nextObject ()))) {
        macroValidPointer (operand_14699) ;
        result << (findCategoryReader__abstractLexicalRuleAST__generateCode (operand_14699->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14699->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (292))) ;
      }
       ;
      if (indentation_15370.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15370.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_15405 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_15405 = NULL ;
      while (((operand_15405 = enumerator_15405.nextObject ()))) {
        macroValidPointer (operand_15405) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_15405->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_15405->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (310)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_16133 = GGS_uint (6U) ;
      if (indentation_16133.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_16133.uintValue ()) ;
      }
      GGS_lexicalRuleListAST::cEnumerator enumerator_15626 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleListAST::cElement * operand_15626 = NULL ;
      while (((operand_15626 = enumerator_15626.nextObject ()))) {
        macroValidPointer (operand_15626) ;
        result << (findCategoryReader__abstractLexicalRuleAST__generateCode (operand_15626->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_15626->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (317))) ;
      }
       ;
      if (indentation_16133.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_16133.uintValue ())) ;
    ...
    result << " ()) ;\n"
      ...
      "  ptr->mEndLocation = mTokenLastLocation ;\n"
      "  ptr->mTemplateStringBeforeToken = inToken.mTemplateStringBeforeToken ;\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17175 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17175 = NULL ;
    while (((operand_17175 = enumerator_17175.nextObject ()))) {
      macroValidPointer (operand_17175) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_17175->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << operand_17175->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " ;\n" ;
    }
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//               A T T R I B U T E   A C C E S S                             *\n"
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17711 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17711 = NULL ;
    while (((operand_17711 = enumerator_17711.nextObject ()))) {
      macroValidPointer (operand_17711) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << operand_17711->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::attributeValue_" ;
      result << operand_17711->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_18496 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_18496 = NULL ;
    while (((operand_18496 = enumerator_18496.nextObject ()))) {
      macroValidPointer (operand_18496) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << operand_18496->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (376)).reader_identifierRepresentation () ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::synthetizedAttribute_" ;
      result << operand_18496->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << operand_18496->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (380)).reader_identifierRepresentation () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << operand_18496->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << operand_18496->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (381)).reader_identifierRepresentation () ;
  ...
  if (isBuilt) {
    ...
    while (((operand_486 = enumerator_486.nextObject ()))) {
      ...
      if (operand_486->mInfo.mIsExtern.boolValue ()) {
        ...
        GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_638 (operand_486->mInfo.mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalRoutineFormalArgumentList::cElement * operand_638 = NULL ;
        while (((operand_638 = enumerator_638.nextObject ()))) {
          macroValidPointer (operand_638) ;
          result << ",\n"
            "                " ;
          result.appendSpacesUntilColumn (columnMarker) ;
          result << operand_638->mLexicalFormalArgumentMode.reader_cppConstInFormalArgument (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
          result << operand_638->mLexicalFormalArgumentType.reader_cocoaTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (15)) ;
          result << operand_638->mLexicalFormalArgumentMode.reader_cocoaPointerInFormalArgument (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) ;
          result << " " ;
          result << operand_638->mArgumentNameForComment ;
        }
        result << ") ;\n" ;
      }else {
      }
    ...
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalFunctionMap::cEnumerator enumerator_1458 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (29)), true) ;
    const GGS_lexicalFunctionMap::cElement * operand_1458 = NULL ;
    while (((operand_1458 = enumerator_1458.nextObject ()))) {
      macroValidPointer (operand_1458) ;
      if (operand_1458->mInfo.mIsExtern.boolValue ()) {
        result << "\n" ;
        result << operand_1458->mInfo.mReturnedLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
        result << " scanner_cocoa_function_" ;
        result << operand_1458->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
        result << " (" ;
        columnMarker = result.currentColumn () ;
        result << "BOOL * ioScanningOk" ;
        GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_1627 (operand_1458->mInfo.mLexicalTypeList, true) ;
        const GGS_lexicalFunctionFormalArgumentList::cElement * operand_1627 = NULL ;
        while (((operand_1627 = enumerator_1627.nextObject ()))) {
          macroValidPointer (operand_1627) ;
          result << ",\n"
            "                " ;
          result.appendSpacesUntilColumn (columnMarker) ;
          result << "const " ;
          result << operand_1627->mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (33)) ;
          result << " " ;
          result << operand_1627->mArgumentNameForComment ;
        }
        result << ") ;\n" ;
      }else {
      }
    ...
    result << "_1_" ;
    GGS_terminalList::cEnumerator enumerator_2265 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (47)), true) ;
    const GGS_terminalList::cElement * operand_2265 = NULL ;
    while (((operand_2265 = enumerator_2265.nextObject ()))) {
      macroValidPointer (operand_2265) ;
      result << ",\n"
        "  " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_2265->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (48)).reader_identifierRepresentation () ;
    }
    result << "\n"
      "} ;\n"
      "\n"
    ...
    result << " : OC_Lexique {\n"
      "//--- Attributes\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_2916 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (61)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_2916 = NULL ;
    while (((operand_2916 = enumerator_2916.nextObject ()))) {
      macroValidPointer (operand_2916) ;
      result << "  @private " ;
      result << operand_2916->mInfo.mLexicalType.reader_cocoaTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
      result << " mLexicalAttribute_" ;
      result << operand_2916->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
      result << " ;\n" ;
    }
    result << "\n"
      "}\n" ;
...
void routine_compileLexiqueComponent (C_CompilerEx & inLexique,
  ...
  ::routine_parseLexiqueComponent (inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_lexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (770)) ;
  GGS_lstring  var_cas_componentName = var_cas_lexiqueComponentRoot.reader_mLexiqueComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (776)) ;
  GGS_string var_cas_basename = var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (777)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  const GGS_bool cond_32514 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (778))).operator_isNotEqual (var_cas_basename) ;
  if (cond_32514.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (780)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (782)) ;
  }
  const GGS_lexicalTypeMap  var_cas_lexicalTypeMap = function_buildLexicalTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (785)) ;
  GGS_lexicalRoutineMap  var_cas_lexicalRoutineMap ;
  ::routine_buildLexicalRoutineMap (inLexique,  var_cas_lexicalRoutineMap COMMA_SOURCE_FILE_AT_LINE (788)) ;
  {
    GGS_externRoutineListAST::cEnumerator enumerator_32887 (var_cas_lexiqueComponentRoot.reader_mExternRoutineList (inLexique COMMA_SOURCE_FILE_AT_LINE (790)), true) ;
    const GGS_externRoutineListAST::cElement * operand_32887 = NULL ;
    while (((operand_32887 = enumerator_32887.nextObject ()))) {
      ...
      {
        GGS_lexicalExternRoutineFormalArgumentListAST::cEnumerator enumerator_33061 (operand_32887->mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalExternRoutineFormalArgumentListAST::cElement * operand_33061 = NULL ;
        while (((operand_33061 = enumerator_33061.nextObject ()))) {
          macroValidPointer (operand_33061) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          if (var_cas_lexicalTypeMap.isBuilt ()) {
            var_cas_lexicalTypeMap (HERE)->method_searchKey (inLexique, operand_33061->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (794)) ;
          }
          var_cas_lexicalRoutineFormalArgumentList.addAssign_operation (operand_33061->mPassingMode, var_cas_lexicalFormalArgumentType, operand_33061->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (795))) ;
        }
      }
      var_cas_lexicalRoutineMap.modifier_insertKey (inLexique, operand_32887->mRoutineName, var_cas_lexicalRoutineFormalArgumentList, operand_32887->mErrorMessageList, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (797)) ;
    }
  }
  GGS_lexicalFunctionMap  var_cas_lexicalFunctionMap ;
  ::routine_buildLexicalFunctionMap (inLexique,  var_cas_lexicalFunctionMap COMMA_SOURCE_FILE_AT_LINE (801)) ;
  {
    GGS_externFunctionListAST::cEnumerator enumerator_33692 (var_cas_lexiqueComponentRoot.reader_mExternFunctionList (inLexique COMMA_SOURCE_FILE_AT_LINE (803)), true) ;
    const GGS_externFunctionListAST::cElement * operand_33692 = NULL ;
    while (((operand_33692 = enumerator_33692.nextObject ()))) {
      ...
      {
        GGS_lexicalExternFunctionFormalArgumentListAST::cEnumerator enumerator_33870 (operand_33692->mLexicalFunctionFormalArgumentList, true) ;
        const GGS_lexicalExternFunctionFormalArgumentListAST::cElement * operand_33870 = NULL ;
        while (((operand_33870 = enumerator_33870.nextObject ()))) {
          macroValidPointer (operand_33870) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          if (var_cas_lexicalTypeMap.isBuilt ()) {
            var_cas_lexicalTypeMap (HERE)->method_searchKey (inLexique, operand_33870->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (807)) ;
          }
          var_cas_lexicalFunctionFormalArgumentList.addAssign_operation (var_cas_lexicalFormalArgumentType, operand_33870->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (808))) ;
        }
      }
      GGS_lexicalTypeEnum var_cas_returnedArgumentType ;
      if (var_cas_lexicalTypeMap.isBuilt ()) {
        var_cas_lexicalTypeMap (HERE)->method_searchKey (inLexique, operand_33692->mReturnedTypeName, var_cas_returnedArgumentType COMMA_SOURCE_FILE_AT_LINE (811)) ;
      }
      var_cas_lexicalFunctionMap.modifier_insertKey (inLexique, operand_33692->mFunctionName, var_cas_lexicalFunctionFormalArgumentList, var_cas_returnedArgumentType, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (812)) ;
    }
  }
  GGS_lexiqueAnalysisContext var_cas_lexiqueAnalysisContext = GGS_lexiqueAnalysisContext::constructor_new (var_cas_lexicalRoutineMap, var_cas_lexicalFunctionMap, GGS_lexicalMessageMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (818)), GGS_terminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (819)), GGS_terminalList ::constructor_emptyList (), GGS_lexicalAttributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (821)), GGS_lexicalExplicitTokenListMapMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (822)), GGS_stringset ::constructor_emptySet (), GGS_templateDelimitorList ::constructor_emptyList (), GGS_styleMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (825))) ;
  GGS_uint  var_cas_styleIndex = GGS_uint (1U) ;
  {
    GGS_lexicalStyleListAST::cEnumerator enumerator_34896 (var_cas_lexiqueComponentRoot.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (829)), true) ;
    const GGS_lexicalStyleListAST::cElement * operand_34896 = NULL ;
    while (((operand_34896 = enumerator_34896.nextObject ()))) {
      macroValidPointer (operand_34896) ;
      var_cas_lexiqueAnalysisContext.mStyleMap.modifier_insertKey (inLexique, operand_34896->mName, operand_34896->mComment, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (830)) ;
      var_cas_styleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (831)) ;
    }
  }
  ::routine_buildLexicalAttributeMap (inLexique,  var_cas_lexicalTypeMap,  var_cas_lexiqueComponentRoot.reader_mLexicalAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (836)),  var_cas_lexiqueAnalysisContext.mLexicalAttributeMap COMMA_SOURCE_FILE_AT_LINE (834)) ;
  {
    GGS_terminalDeclarationListAST::cEnumerator enumerator_35347 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (840)), true) ;
    const GGS_terminalDeclarationListAST::cElement * operand_35347 = NULL ;
    while (((operand_35347 = enumerator_35347.nextObject ()))) {
      macroValidPointer (operand_35347) ;
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_35567 = (operand_35347->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (842)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_35567.isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_35557_0 ;
        const GGS_styleMap  temp_35525 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (843)) ;
        if (temp_35525.isBuilt ()) {
          temp_35525 (HERE)->method_searchKey (inLexique, operand_35347->mStyle, automatic_var_35557_0, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (843)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_35660 (operand_35347->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_35660 = NULL ;
        while (((operand_35660 = enumerator_35660.nextObject ()))) {
          macroValidPointer (operand_35660) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          if (var_cas_lexiqueAnalysisContext.mLexicalAttributeMap.isBuilt ()) {
            var_cas_lexiqueAnalysisContext.mLexicalAttributeMap (HERE)->method_searchKey (inLexique, operand_35660->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (848)) ;
          }
          var_cas_argumentTypeList.addAssign_operation (operand_35660->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849)), var_cas_attributeLexicalType) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_35347->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (851)) ;
      GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_36036 (operand_35347->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_36036 = NULL ;
        while (((operand_36036 = enumerator_36036.nextObject ()))) {
          macroValidPointer (operand_36036) ;
          const GGS_bool cond_36178 = (operand_36036->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (854))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
          if (cond_36178.isBuiltAndTrue ()) {
            operand_36036->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (856)) ;
          }else if (cond_36178.isBuiltAndFalse ()) {
            const GGS_bool cond_36284 = var_cas_isEndOfTemplateMark ;
            if (cond_36284.isBuiltAndTrue ()) {
              operand_36036->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (858)) ;
            }else if (cond_36284.isBuiltAndFalse ()) {
              var_cas_isEndOfTemplateMark = GGS_bool (true) ;
            }
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalList.addAssign_operation (operand_35347->mName, var_cas_argumentTypeList, operand_35347->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (865)), var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
    }
  }
  {
    GGS_lexicalListDeclarationListAST::cEnumerator enumerator_36560 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (870)), true) ;
    const GGS_lexicalListDeclarationListAST::cElement * operand_36560 = NULL ;
    while (((operand_36560 = enumerator_36560.nextObject ()))) {
      macroValidPointer (operand_36560) ;
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_36783 = (operand_36560->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (872)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_36783.isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_36773_0 ;
        const GGS_styleMap  temp_36741 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (873)) ;
        if (temp_36741.isBuilt ()) {
          temp_36741 (HERE)->method_searchKey (inLexique, operand_36560->mStyle, automatic_var_36773_0, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (873)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_36876 (operand_36560->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_36876 = NULL ;
        while (((operand_36876 = enumerator_36876.nextObject ()))) {
          macroValidPointer (operand_36876) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          if (var_cas_lexiqueAnalysisContext.mLexicalAttributeMap.isBuilt ()) {
            var_cas_lexiqueAnalysisContext.mLexicalAttributeMap (HERE)->method_searchKey (inLexique, operand_36876->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (878)) ;
          }
          var_cas_argumentTypeList.addAssign_operation (operand_36876->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (879)), var_cas_attributeLexicalType) ;
        }
      }
      GGS_lexicalExplicitTokenListMap  var_cas_lexicalTokenListMap = GGS_lexicalExplicitTokenListMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (881)) ;
      GGS_tokenSortedlist  var_cas_tokenSortedlist = GGS_tokenSortedlist ::constructor_emptySortedList () ;
      {
        GGS_lexicalListEntryListAST::cEnumerator enumerator_37251 (operand_36560->mEntryList, true) ;
        const GGS_lexicalListEntryListAST::cElement * operand_37251 = NULL ;
        while (((operand_37251 = enumerator_37251.nextObject ()))) {
          macroValidPointer (operand_37251) ;
          GGS_string var_cas_syntaxErrorMessage = operand_36560->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (884)).reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_37251->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (884)) COMMA_SOURCE_FILE_AT_LINE (884)) ;
          GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
            GGS_lstringlist::cEnumerator enumerator_37459 (operand_37251->mFeatureList, true) ;
            const GGS_lstringlist::cElement * operand_37459 = NULL ;
            while (((operand_37459 = enumerator_37459.nextObject ()))) {
              macroValidPointer (operand_37459) ;
              const GGS_bool cond_37607 = (operand_37459->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (887))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
              if (cond_37607.isBuiltAndTrue ()) {
                operand_37459->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (889)) ;
              }else if (cond_37607.isBuiltAndFalse ()) {
                const GGS_bool cond_37717 = var_cas_isEndOfTemplateMark ;
                if (cond_37717.isBuiltAndTrue ()) {
                  operand_37459->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (891)) ;
                }else if (cond_37717.isBuiltAndFalse ()) {
                  var_cas_isEndOfTemplateMark = GGS_bool (true) ;
                }
              }
            }
          }
          var_cas_lexiqueAnalysisContext.mTerminalList.addAssign_operation (operand_37251->mTerminalSpelling, var_cas_argumentTypeList, var_cas_syntaxErrorMessage, var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
          var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_37251->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (902)) ;
          var_cas_lexicalTokenListMap.modifier_insertKey (inLexique, operand_37251->mEntrySpelling, operand_37251->mTerminalSpelling, operand_37251->mFeatureList COMMA_SOURCE_FILE_AT_LINE (903)) ;
          var_cas_tokenSortedlist.addAssign_operation (operand_37251->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (904)).reader_length (), operand_37251->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (904)), operand_37251->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (904))) ;
          var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37251->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (905))) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mLexicalTokenListMap.modifier_insertKey (inLexique, operand_36560->mName, var_cas_lexicalTokenListMap, var_cas_tokenSortedlist, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (907)) ;
    }
  }
  {
    GGS_lexicalMessageDeclarationListAST::cEnumerator enumerator_38595 (var_cas_lexiqueComponentRoot.reader_mLexicalMessageDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (910)), true) ;
    const GGS_lexicalMessageDeclarationListAST::cElement * operand_38595 = NULL ;
    while (((operand_38595 = enumerator_38595.nextObject ()))) {
      macroValidPointer (operand_38595) ;
      var_cas_lexiqueAnalysisContext.mLexicalMessageMap.modifier_insertKey (inLexique, operand_38595->mMessageName, operand_38595->mMessageValue, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (911)) ;
    }
  }
  {
    GGS_lexicalRuleListAST::cEnumerator enumerator_38830 (var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (914)), true) ;
    const GGS_lexicalRuleListAST::cElement * operand_38830 = NULL ;
    while (((operand_38830 = enumerator_38830.nextObject ()))) {
      macroValidPointer (operand_38830) ;
      { typeCategoryMethod__abstractLexicalRuleAST__checkLexicalRule method = findCategoryMethod__abstractLexicalRuleAST__checkLexicalRule (operand_38830->mLexicalRule.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_38830->mLexicalRule (HERE), var_cas_lexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (915)) ;
        }
      }
    }
  }
  {
    GGS_lexicalMessageMap::cEnumerator enumerator_39028 (var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (918)), true) ;
    const GGS_lexicalMessageMap::cElement * operand_39028 = NULL ;
    while (((operand_39028 = enumerator_39028.nextObject ()))) {
      macroValidPointer (operand_39028) ;
      const GGS_bool cond_39150 = (operand_39028->mInfo.mMessageIsUsed).operator_not () ;
      if (cond_39150.isBuiltAndTrue ()) {
        operand_39028->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (920)) ;
      }
    }
  }
  {
    GGS_metamodelTemplateDelimitorListAST::cEnumerator enumerator_39244 (var_cas_lexiqueComponentRoot.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (924)), true) ;
    const GGS_metamodelTemplateDelimitorListAST::cElement * operand_39244 = NULL ;
    while (((operand_39244 = enumerator_39244.nextObject ()))) {
      macroValidPointer (operand_39244) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_39244->mStartString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (925))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_39244->mEndString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (926))) ;
      GGS_bool var_cas_preservesStartDelimiter = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_39516 (operand_39244->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_39516 = NULL ;
        while (((operand_39516 = enumerator_39516.nextObject ()))) {
          macroValidPointer (operand_39516) ;
          const GGS_bool cond_39643 = (operand_39516->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (929))).operator_isNotEqual (GGS_string ("preserved")) ;
          if (cond_39643.isBuiltAndTrue ()) {
            operand_39516->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'preserved' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (931)) ;
          }else if (cond_39643.isBuiltAndFalse ()) {
            const GGS_bool cond_39745 = var_cas_preservesStartDelimiter ;
            if (cond_39745.isBuiltAndTrue ()) {
              operand_39516->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'preserved' feature is already set") COMMA_SOURCE_FILE_AT_LINE (933)) ;
            }else if (cond_39745.isBuiltAndFalse ()) {
              var_cas_preservesStartDelimiter = GGS_bool (true) ;
            }
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTemplateDelimitorList.addAssign_operation (operand_39244->mStartString, operand_39244->mEndString, var_cas_preservesStartDelimiter) ;
    }
  }
  {
    GGS_templateReplacementListAST::cEnumerator enumerator_40014 (var_cas_lexiqueComponentRoot.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (940)), true) ;
    const GGS_templateReplacementListAST::cElement * operand_40014 = NULL ;
    while (((operand_40014 = enumerator_40014.nextObject ()))) {
      macroValidPointer (operand_40014) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_40014->mMatchString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (941))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_40014->mReplacementString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (942))) ;
    }
  }
  GGS_string var_cas_lexiqueClassName = var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (946)) ;
  const GGS_bool cond_41748 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (948))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_41748.isBuiltAndTrue ()) {
    const GGS_bool cond_41117 = (var_cas_inGenerateGALGAS1Code).operator_not () ;
    if (cond_41117.isBuiltAndTrue ()) {
      GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_lexiqueClassName).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
        ...
        "\n"), template_filewrapper_lexiqueGenerationTemplates_newHeaderZone3 (inLexique, var_cas_lexiqueClassName.reader_identifierRepresentation (), var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (963)), var_cas_lexiqueAnalysisContext) COMMA_SOURCE_FILE_AT_LINE (950)) ;
    }else if (cond_41117.isBuiltAndFalse ()) {
      GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_lexiqueClassName).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
        ...
        "\n"), template_filewrapper_lexiqueGenerationTemplates_oldHeaderZone3 (inLexique, var_cas_lexiqueClassName.reader_identifierRepresentation (), var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (981)), var_cas_lexiqueAnalysisContext) COMMA_SOURCE_FILE_AT_LINE (968)) ;
    }
  }
  const GGS_bool cond_43397 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (988))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_43397.isBuiltAndTrue ()) {
    const GGS_bool cond_42623 = (var_cas_inGenerateGALGAS1Code).operator_not () ;
    if (cond_42623.isBuiltAndTrue ()) {
      GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_lexiqueClassName).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
        "\n"), template_filewrapper_lexiqueGenerationTemplates_newImplementationZone2 (inLexique, var_cas_lexiqueClassName.reader_identifierRepresentation (), var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (997)), var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (998)), var_cas_lexiqueAnalysisContext.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (999)), var_cas_lexiqueAnalysisContext.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1000)), var_cas_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)), var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (1002)), var_cas_lexiqueAnalysisContext, var_cas_lexiqueComponentRoot), GGS_string ("\n"
        "\n"), GGS_string ("\n"
        "\n") COMMA_SOURCE_FILE_AT_LINE (990)) ;
    }else if (cond_42623.isBuiltAndFalse ()) {
      GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_lexiqueClassName).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
        "\n"), template_filewrapper_lexiqueGenerationTemplates_oldImplementationZone2 (inLexique, var_cas_lexiqueClassName.reader_identifierRepresentation (), var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1017)), var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1018)), var_cas_lexiqueAnalysisContext.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (1019)), var_cas_lexiqueAnalysisContext.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1020)), var_cas_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (inLexique COMMA_SOURCE_FILE_AT_LINE (1021)), var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (1022)), var_cas_lexiqueAnalysisContext, var_cas_lexiqueComponentRoot), GGS_string ("\n"
        "\n"), GGS_string ("\n"
        "\n") COMMA_SOURCE_FILE_AT_LINE (1010)) ;
    }
  }
  const GGS_bool cond_43916 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1032))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_43916.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_lexiqueClassName).operator_concat (GGS_string ("-cocoa.h")), GGS_string ("//"), GGS_string ("\n"
      ...
      "\n"), template_filewrapper_lexiqueGenerationTemplates_cocoaHeaderZone3 (inLexique, var_cas_lexiqueClassName, var_cas_lexiqueAnalysisContext) COMMA_SOURCE_FILE_AT_LINE (1033)) ;
  }
  const GGS_bool cond_44641 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1050))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_44641.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_lexiqueClassName).operator_concat (GGS_string ("-cocoa.m")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (inLexique, var_cas_lexiqueClassName, var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1058)), var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)), var_cas_lexiqueAnalysisContext.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (1060)), var_cas_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)), var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (1062)), var_cas_lexiqueAnalysisContext, var_cas_lexiqueComponentRoot), GGS_string ("\n"
      "\n"), GGS_string ("\n"
