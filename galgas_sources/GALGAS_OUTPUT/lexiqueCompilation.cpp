...
//                    november 11th, 2009, at 14h57'19"                      *
//                                                                           *
//---------------------------------------------------------------------------*
  ...
  if (isBuilt) {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (129)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (129))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
        ...
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
        result << "] ;\n"
          "      " ;
      }else {
      }
    ...
    while (((operand_10514 = enumerator_10514.nextObject ()))) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_10514->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    while (((operand_11330 = enumerator_11330.nextObject ()))) {
      ...
      result << ",\n"
        "    @" ;
      result << operand_11330->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (240)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ;
    }
    result << "\n"
      "  } ;\n"
