...
class cCollectionElement_lexiqueComponentGenerationList : public cCollectionElement {
  public : GALGAS_lexiqueComponentGenerationList_2E_element mObject ;
...
GALGAS_lexiqueComponentGenerationList_2E_element cEnumerator_lexiqueComponentGenerationList::current (LOCATION_ARGS) const {
...
void routine_compileLexiqueComponentGalgas_33_ (const GALGAS_galgas_33_LexiqueComponentListAST_2E_element constinArgument_inLexiqueComponentAST,
  ...
  cEnumerator_externRoutineListAST enumerator_49394 (constinArgument_inLexiqueComponentAST.mAttribute_mExternRoutineList, kEnumeration_up) ;
  while (enumerator_49394.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_49528 (enumerator_49394.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_49528.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_49528.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1174)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_49528.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_49528.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1175))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1175)) ;
      enumerator_49528.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_49394.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_49394.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1177)) ;
    }
  ...
  cEnumerator_externFunctionListAST enumerator_50196 (constinArgument_inLexiqueComponentAST.mAttribute_mExternFunctionList, kEnumeration_up) ;
  while (enumerator_50196.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_50333 (enumerator_50196.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_50333.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_50333.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1187)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_50333.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1188))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1188)) ;
      enumerator_50333.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_50196.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1191)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_50196.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1192)) ;
    }
    enumerator_50196.gotoNextObject () ;
  }
  ...
  GALGAS_uint var_styleIndex = GALGAS_uint ((uint32_t) 1U) ;
  cEnumerator_lexicalStyleListAST enumerator_52148 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalStyleList, kEnumeration_up) ;
  while (enumerator_52148.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_52148.current_mName (HERE), enumerator_52148.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1224)) ;
    }
  ...
  cEnumerator_terminalDeclarationListAST enumerator_52606 (constinArgument_inLexiqueComponentAST.mAttribute_mTerminalDeclarationList, kEnumeration_up) ;
  while (enumerator_52606.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_52606.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1236)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1236)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lstring joker_52748_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1237)).method_searchKey (enumerator_52606.current_mStyle (HERE), joker_52748_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1237)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_52873 (enumerator_52606.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_52873.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_52873.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1242)) ;
      var_argumentTypeList.addAssign_operation (enumerator_52873.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1243)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1243)) ;
      enumerator_52873.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_52606.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1245)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_53285 (enumerator_52606.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_53285.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_53285.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1249)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_2) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_2) {
          GALGAS_location location_3 (enumerator_53285.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_53285.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1255)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_location location_5 (enumerator_53285.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          if (kBoolTrue == test_6) {
            GALGAS_location location_7 (enumerator_53285.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_52606.current_mName (HERE), var_argumentTypeList, enumerator_52606.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1266)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1263)) ;
    enumerator_52606.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_54140 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalListDeclarationList, kEnumeration_up) ;
  while (enumerator_54140.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, enumerator_54140.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1274)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1274)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_lstring joker_54282_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1275)).method_searchKey (enumerator_54140.current_mStyle (HERE), joker_54282_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1275)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_54407 (enumerator_54140.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_54407.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_54407.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1280)) ;
      var_argumentTypeList.addAssign_operation (enumerator_54407.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1281)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1281)) ;
    ...
    cEnumerator_lexicalListEntryListAST enumerator_54782 (enumerator_54140.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_54782.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_54140.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1286)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_54782.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1286)), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1286)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_55028 (enumerator_54782.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_55028.hasCurrentObject ()) {
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_55028.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1290)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          const enumGalgasBool test_10 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_10) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_10) {
            GALGAS_location location_11 (enumerator_55028.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_55028.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1296)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_55028.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            if (kBoolTrue == test_14) {
              GALGAS_location location_15 (enumerator_55028.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_55028.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_54782.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1304)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_54782.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1312)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_54782.current_mEntrySpelling (HERE), enumerator_54782.current_mTerminalSpelling (HERE), enumerator_54782.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1313)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_54782.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314)), enumerator_54782.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314)), enumerator_54782.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_54782.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1315))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1315)) ;
      enumerator_54782.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_54140.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1317)) ;
    }
    enumerator_54140.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_56512 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalMessageDeclarationList, kEnumeration_up) ;
  while (enumerator_56512.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_56512.current_mMessageName (HERE), enumerator_56512.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1321)) ;
    }
    enumerator_56512.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_56733 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, kEnumeration_up) ;
  while (enumerator_56733.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_56733.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1325)) ;
    enumerator_56733.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_56935 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1328)), kEnumeration_up) ;
  while (enumerator_56935.hasCurrentObject ()) {
    const enumGalgasBool test_16 = enumerator_56935.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1329)).boolEnum () ;
    if (kBoolTrue == test_16) {
      GALGAS_location location_17 (enumerator_56935.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_57153 (constinArgument_inLexiqueComponentAST.mAttribute_mTemplateDelimitorList, kEnumeration_up) ;
  while (enumerator_57153.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_57153.current_mStartString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1335))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1335)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_57153.current_mEndString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1336))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1336)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_57381 (enumerator_57153.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_57381.hasCurrentObject ()) {
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_57381.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1339)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_57381.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        if (kBoolTrue == test_20) {
          GALGAS_location location_21 (enumerator_57381.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_57381.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_57153.current_mStartString (HERE), enumerator_57153.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1347)) ;
  ...
  if (kBoolTrue == test_22) {
    cEnumerator_indexingListAST enumerator_57991 (constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST, kEnumeration_up) ;
    while (enumerator_57991.hasCurrentObject ()) {
      GALGAS_location location_23 (enumerator_57991.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_57991.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1355)) ;
  cEnumerator_indexingListAST enumerator_58211 (constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST, kEnumeration_up) ;
  while (enumerator_58211.hasCurrentObject ()) {
    const enumGalgasBool test_24 = var_indexNameSet.reader_hasKey (enumerator_58211.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1357)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1357)).boolEnum () ;
    if (kBoolTrue == test_24) {
      GALGAS_location location_25 (enumerator_58211.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("the '").operator_concat (enumerator_58211.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1358))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1358)).operator_concat (GALGAS_string ("' index is already declared")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1358))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1358)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_58211.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1360))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1360)) ;
    enumerator_58211.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_58542 (constinArgument_inLexiqueComponentAST.mAttribute_mTemplateReplacementList, kEnumeration_up) ;
  while (enumerator_58542.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_58542.current_mMatchString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1364))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1364)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_58542.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1365))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1365)) ;
    enumerator_58542.gotoNextObject () ;
  }
...
void routine_generateLexiqueComponentsGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lexiqueComponentGenerationList enumerator_61512 (constinArgument_inLexiqueComponentGenerationList, kEnumeration_up) ;
    while (enumerator_61512.hasCurrentObject ()) {
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1440)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1440))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1440)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1443)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1443)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_61512.current_mCppHeaderContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1441)) ;
      }
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1451)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1451))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1451)) ;
      ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1452)).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1452))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1452)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1455)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1455)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_61512.current_mCppContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1453)) ;
      }
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1463)).operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1463))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1463)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1466)).operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1466)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_61512.current_mCocoaHeaderContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1464)) ;
      }
      ioArgument_ioAppProductFileList.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1474)).add_operation (GALGAS_string ("-cocoa.m"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1474))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1474)) ;
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1475)).operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1475))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1475)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_61512.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1478)).operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1478)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_61512.current_mCocoaContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1476)) ;
      }
      enumerator_61512.gotoNextObject () ;
    }
  }
}
...
GALGAS_lexiqueComponentGenerationList_2E_element::GALGAS_lexiqueComponentGenerationList_2E_element (void) :
...
GALGAS_lexiqueComponentGenerationList_2E_element::GALGAS_lexiqueComponentGenerationList_2E_element (const GALGAS_string & inOperand0,
                                                                                                    const GALGAS_string & inOperand1,
                                                                                                    const GALGAS_string & inOperand2,
                                                                                                    const GALGAS_string & inOperand3,
                                                                                                    const GALGAS_string & inOperand4) :
...
GALGAS_lexiqueComponentGenerationList_2E_element GALGAS_lexiqueComponentGenerationList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_lexiqueComponentGenerationList_2E_element (GALGAS_string::constructor_default (HERE),
...
GALGAS_lexiqueComponentGenerationList_2E_element GALGAS_lexiqueComponentGenerationList_2E_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                                                    const GALGAS_string & inOperand1,
                                                                                                                    const GALGAS_string & inOperand2,
                                                                                                                    const GALGAS_string & inOperand3,
                                                                                                                    const GALGAS_string & inOperand4 
                                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexiqueComponentGenerationList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_lexiqueComponentGenerationList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexiqueComponentGenerationList_2E_element::objectCompare (const GALGAS_lexiqueComponentGenerationList_2E_element & inOperand) const {
...
bool GALGAS_lexiqueComponentGenerationList_2E_element::isValid (void) const {
...
void GALGAS_lexiqueComponentGenerationList_2E_element::drop (void) {
...
void GALGAS_lexiqueComponentGenerationList_2E_element::description (C_String & ioString,
...
GALGAS_string GALGAS_lexiqueComponentGenerationList_2E_element::reader_mLexiqueComponentName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexiqueComponentName ;
}

//-----------------------------------------------------------------------------*

GALGAS_string GALGAS_lexiqueComponentGenerationList_2E_element::reader_mCppHeaderContents (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCppHeaderContents ;
}

//-----------------------------------------------------------------------------*

GALGAS_string GALGAS_lexiqueComponentGenerationList_2E_element::reader_mCppContents (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCppContents ;
}

//-----------------------------------------------------------------------------*

GALGAS_string GALGAS_lexiqueComponentGenerationList_2E_element::reader_mCocoaHeaderContents (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCocoaHeaderContents ;
}

//-----------------------------------------------------------------------------*

GALGAS_string GALGAS_lexiqueComponentGenerationList_2E_element::reader_mCocoaContents (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexiqueComponentGenerationList_2E_element ("lexiqueComponentGenerationList.element",
                                                                  NULL) ;

//-----------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexiqueComponentGenerationList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexiqueComponentGenerationList_2E_element ;
}

//-----------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexiqueComponentGenerationList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexiqueComponentGenerationList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexiqueComponentGenerationList_2E_element GALGAS_lexiqueComponentGenerationList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                                                  C_Compiler * inCompiler
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_lexiqueComponentGenerationList_2E_element result ;
  const GALGAS_lexiqueComponentGenerationList_2E_element * p = (const GALGAS_lexiqueComponentGenerationList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexiqueComponentGenerationList_2E_element *> (p)) {
      result = *p ;
    }else{
