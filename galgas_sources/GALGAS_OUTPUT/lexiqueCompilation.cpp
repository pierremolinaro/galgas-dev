...
//                    december 10th, 2011, at 18h22'40"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (C_Compiler * inCompiler,
  ...
  result << " (void) {}\n"
    "  #endif\n" ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (88)).reader_length (SOURCE_FILE_AT_LINE (88)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    result << "\n"
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  result << "  }\n"
    ...
    "- (NSString *) indexingDirectory {\n"
    "  return @" ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingDirectory (SOURCE_FILE_AT_LINE (27)).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (27)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (39)).isValid ()) {
    cEnumerator_indexingListAST enumerator_1541 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (39)), kEnumeration_up) ;
    while (enumerator_1541.hasCurrentObject ()) {
      result << "    @" ;
      result << enumerator_1541.current_mIndexComment (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (40)).stringValue () ;
      result << ",\n" ;
  ...
  result << "    NULL\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_2293_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (52)).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_2293 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (52)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_2293 = enumerator_2293.hasCurrentObject () ;
    if (nonEmpty_enumerator_2293) {
      result << "static const templateDelimiterStructForCocoa kTemplateDefinitionArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (53)).stringValue () ;
      result << " [" ;
      result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (53)).reader_length (SOURCE_FILE_AT_LINE (53)).reader_string (SOURCE_FILE_AT_LINE (53)).stringValue () ;
      result << "] = {\n" ;
    }
    while (enumerator_2293.hasCurrentObject ()) {
      result << "  {@" ;
      result << enumerator_2293.current_mStartString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_2293.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (55)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "nil," ;
      }else if (kBoolFalse == test_0) {
        result << "@" ;
        result << enumerator_2293.current_mEndString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (58)).stringValue () ;
        result << "," ;
      }
      result << " " ;
      result << enumerator_2293.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (61)).reader_ocString (SOURCE_FILE_AT_LINE (61)).stringValue () ;
      result << "}" ;
      if (enumerator_2293.hasNextObject ()) {
        result << ",\n" ;
      }
      index_2293_.increment () ;
  ...
  result << "\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_3235_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (73)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_3235 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (73)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_3235 = enumerator_3235.hasCurrentObject () ;
    if (nonEmpty_enumerator_3235) {
      result << "static NSString * kTemplateReplacementArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (74)).stringValue () ;
      result << " [" ;
      result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (74)).reader_length (SOURCE_FILE_AT_LINE (74)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (SOURCE_FILE_AT_LINE (74)).stringValue () ;
      result << "] = {\n"
        "  " ;
    }
    while (enumerator_3235.hasCurrentObject ()) {
      result << "@" ;
      result << enumerator_3235.current_mMatchString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << ", " ;
      index_3235_.increment () ;
  ...
  result << "\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_3948_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (86)).isValid ()) {
    cEnumerator_terminalList enumerator_3948 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (86)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_3948 = enumerator_3948.hasCurrentObject () ;
    if (nonEmpty_enumerator_3948) {
      result << "static const BOOL kEndOfScriptInTemplateArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (87)).stringValue () ;
      result << " [" ;
      result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (87)).reader_length (SOURCE_FILE_AT_LINE (87)).reader_string (SOURCE_FILE_AT_LINE (87)).stringValue () ;
      result << "] = {\n" ;
    }
    while (enumerator_3948.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_3948.current_mIsEndOfTemplateMark (HERE).reader_ocString (SOURCE_FILE_AT_LINE (88)).stringValue () ;
      result << " /* " ;
      result << enumerator_3948.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (88)).stringValue () ;
      result << " */" ;
      if (enumerator_3948.hasNextObject ()) {
        result << ",\n" ;
      }
      index_3948_.increment () ;
  ...
  result << "\n"
    "\n" ;
  GALGAS_uint index_4160_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (95)).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_4160 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (95)), kEnumeration_up) ;
    while (enumerator_4160.hasCurrentObject ()) {
      const enumGalgasBool test_1 = enumerator_4160.current_mShouldBeGenerated (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << enumerator_4160.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (99)).stringValue () ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << enumerator_4160.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (102)).stringValue () ;
        result << " [" ;
        result << enumerator_4160.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (102)).reader_string (SOURCE_FILE_AT_LINE (102)).stringValue () ;
        result << "] = {\n" ;
        GALGAS_uint index_4909_ (0) ;
        if (enumerator_4160.current_mTokenSortedList (HERE).isValid ()) {
          cEnumerator_tokenSortedlist enumerator_4909 (enumerator_4160.current_mTokenSortedList (HERE), kEnumeration_up) ;
          while (enumerator_4909.hasCurrentObject ()) {
            result << "  {@" ;
            result << enumerator_4909.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (104)).stringValue () ;
            result << ", " ;
            result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
            result << "_1_" ;
            result << enumerator_4909.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (104)).stringValue () ;
            result << "}" ;
            if (enumerator_4909.hasNextObject ()) {
              result << ",\n" ;
            }
        ...
        result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (108)).stringValue () ;
        result << "_" ;
        result << enumerator_4160.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (108)).stringValue () ;
        result << " (NSString * inSearchedString) {\n"
          "  return searchStringInTable (inSearchedString, ktable_for_" ;
        result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << "_" ;
        result << enumerator_4160.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << ", " ;
        result << enumerator_4160.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (109)).reader_string (SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else if (kBoolFalse == test_1) {
      }
      index_4160_.increment () ;
      enumerator_4160.gotoNextObject () ;
    }
  }
  result << "\n"
    "//---------------------------------------------------------------------------*\n"
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (127)).reader_length (SOURCE_FILE_AT_LINE (127)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    ...
    result << " [mMatchedTemplateDelimiterIndex].mEndString advance:YES] ;\n"
      ...
      "      " ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (135)).reader_length (SOURCE_FILE_AT_LINE (135)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      result << "\n"
        "      [self searchForReplacementPattern:kTemplateReplacementArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (136)).stringValue () ;
      result << "] ;\n"
        "      " ;
    }else if (kBoolFalse == test_3) {
    }
    ...
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (138)).stringValue () ;
    result << " listLength:" ;
    result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (138)).reader_length (SOURCE_FILE_AT_LINE (138)).reader_string (SOURCE_FILE_AT_LINE (138)).stringValue () ;
    result << "] ;\n"
      "      if (mMatchedTemplateDelimiterIndex < 0) {\n"
      "        [self advance] ;\n"
      "        mTokenCode = -2 ;\n"
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_7396 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_7396.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_7396.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_7396.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (146)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_7396.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_7612_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_7612 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_7612.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_7612.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)).stringValue () ;
        index_7612_.increment () ;
    ...
    GALGAS_uint index_8249_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8249 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8249.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8249.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (170)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8249.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (170)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8249.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (170)).stringValue () ;
        result << " ;\n" ;
        index_8249_.increment () ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8463 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8463.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8463.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
  ...
  result << "\n"
    ...
    "- (UInt32) terminalVocabularyCount {\n"
    "  return " ;
  result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (199)).reader_length (SOURCE_FILE_AT_LINE (199)).reader_string (SOURCE_FILE_AT_LINE (199)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
    ...
    "- (UInt32) styleCount {\n"
    "  return " ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (209)).reader_length (SOURCE_FILE_AT_LINE (209)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (209)).reader_string (SOURCE_FILE_AT_LINE (209)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
    ...
    "- (BOOL) isTemplateLexique {\n"
    "  return " ;
  result << GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (219)).reader_length (SOURCE_FILE_AT_LINE (219)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).reader_ocString (SOURCE_FILE_AT_LINE (219)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
  ...
  result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (229)).reader_length (SOURCE_FILE_AT_LINE (229)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (229)).reader_string (SOURCE_FILE_AT_LINE (229)).stringValue () ;
  result << "] = {0" ;
  GALGAS_uint index_11034_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (230)).isValid ()) {
    cEnumerator_terminalList enumerator_11034 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (230)), kEnumeration_up) ;
    while (enumerator_11034.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11034.current_mStyleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (231)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11034.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (231)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (231)).stringValue () ;
      result << " */" ;
      index_11034_.increment () ;
  ...
  result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (243)).reader_length (SOURCE_FILE_AT_LINE (243)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (243)).reader_string (SOURCE_FILE_AT_LINE (243)).stringValue () ;
  result << "] = {NO" ;
  GALGAS_uint index_11851_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (244)).isValid ()) {
    cEnumerator_terminalList enumerator_11851 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (244)), kEnumeration_up) ;
    while (enumerator_11851.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11851.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE_AT_LINE (245)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11851.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (245)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (245)).stringValue () ;
      result << " */" ;
      index_11851_.increment () ;
  ...
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (258)).reader_length (SOURCE_FILE_AT_LINE (258)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (258)).reader_string (SOURCE_FILE_AT_LINE (258)).stringValue () ;
  result << ")) {\n"
    "    NSString * kStyleArray [" ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (259)).reader_length (SOURCE_FILE_AT_LINE (259)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (259)).reader_string (SOURCE_FILE_AT_LINE (259)).stringValue () ;
  result << "] = {\n"
    "      @\"Default Style\"" ;
  GALGAS_uint index_12821_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (261)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_12821 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (261)), kEnumeration_up) ;
    while (enumerator_12821.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_12821.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (262)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (262)).stringValue () ;
      index_12821_.increment () ;
  ...
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_13742_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (280)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13742 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (280)), kEnumeration_up) ;
    while (enumerator_13742.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_13742.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (281)).stringValue () ;
      result << "\"" ;
      index_13742_.increment () ;
