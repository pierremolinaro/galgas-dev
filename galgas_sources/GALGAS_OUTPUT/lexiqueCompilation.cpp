...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (C_Compiler * inCompiler,
  ...
  result << "_CLASS_DEFINED\n"
    ...
    "//                                                                           *\n"
    "//---------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_701_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalRoutineMessageMap (SOURCE_FILE_AT_LINE (16)).isValid ()) {
    cEnumerator_lexicalRoutineMap enumerator_701 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalRoutineMessageMap (SOURCE_FILE_AT_LINE (16)), kEnumeration_up) ;
    while (enumerator_701.hasCurrentObject ()) {
      const enumGalgasBool test_0 = enumerator_701.current_mIsExtern (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "\n"
          "void scanner_routine_" ;
        result << enumerator_701.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (18)).stringValue () ;
        result << " (C_Lexique & inLexique" ;
        GALGAS_uint index_845_ (0) ;
        if (enumerator_701.current_mLexicalRoutineFormalArgumentList (HERE).isValid ()) {
          cEnumerator_lexicalRoutineFormalArgumentList enumerator_845 (enumerator_701.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
          while (enumerator_845.hasCurrentObject ()) {
            result << ",\n"
              "                " ;
            result << categoryReader_cppConstInFormalArgument (enumerator_845.current_mLexicalFormalArgumentMode (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (20)).stringValue () ;
            result << categoryReader_cppTypeName (enumerator_845.current_mLexicalFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (21)).stringValue () ;
            result << categoryReader_cppReferenceInFormalArgument (enumerator_845.current_mLexicalFormalArgumentMode (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (22)).stringValue () ;
            result << " " ;
            result << enumerator_845.current_mArgumentNameForComment (HERE).stringValue () ;
            index_845_.increment () ;
            enumerator_845.gotoNextObject () ;
          }
        }
        GALGAS_uint index_1198_ (0) ;
        if (enumerator_701.current_mErrorMessageList (HERE).isValid ()) {
          cEnumerator_stringlist enumerator_1198 (enumerator_701.current_mErrorMessageList (HERE), kEnumeration_up) ;
          while (enumerator_1198.hasCurrentObject ()) {
            result << ",\n"
              "                const char * " ;
            result << enumerator_1198.current_mValue (HERE).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (38)).isValid ()) {
    cEnumerator_lexicalFunctionMap enumerator_1764 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (38)), kEnumeration_up) ;
    while (enumerator_1764.hasCurrentObject ()) {
      const enumGalgasBool test_1 = enumerator_1764.current_mIsExtern (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "\n" ;
        result << categoryReader_cppTypeName (enumerator_1764.current_mReturnedLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (40)).stringValue () ;
        result << " scanner_function_" ;
        result << enumerator_1764.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (40)).stringValue () ;
        result << " (C_Lexique & inLexique" ;
        GALGAS_uint index_1925_ (0) ;
        if (enumerator_1764.current_mLexicalTypeList (HERE).isValid ()) {
          cEnumerator_lexicalFunctionFormalArgumentList enumerator_1925 (enumerator_1764.current_mLexicalTypeList (HERE), kEnumeration_up) ;
          while (enumerator_1925.hasCurrentObject ()) {
            result << ",\n"
              "                const " ;
            result << categoryReader_cppTypeName (enumerator_1925.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (42)).stringValue () ;
            result << " " ;
            result << enumerator_1925.current_mArgumentNameForComment (HERE).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalAttributeMap (SOURCE_FILE_AT_LINE (56)).isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_2589 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalAttributeMap (SOURCE_FILE_AT_LINE (56)), kEnumeration_up) ;
    while (enumerator_2589.hasCurrentObject ()) {
      result << "  public : " ;
      result << categoryReader_cppTypeName (enumerator_2589.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (57)).stringValue () ;
      result << " mLexicalAttribute_" ;
      result << enumerator_2589.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (57)).stringValue () ;
      result << " ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_1264 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    const bool nonEmpty_enumerator_1264 = enumerator_1264.hasCurrentObject () ;
    if (nonEmpty_enumerator_1264) {
      result << " :\n" ;
    }
    while (enumerator_1264.hasCurrentObject ()) {
      result << "mLexicalAttribute_" ;
      result << enumerator_1264.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (33)).stringValue () ;
      result << " ()" ;
      if (enumerator_1264.hasNextObject ()) {
        result << ",\n" ;
      }
  ...
  result << " ;\n"
    ...
    "//                                                                           *\n"
    "//---------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_3487_ (0) ;
  if (in_LEXICAL_5F_MESSAGE_5F_MAP.isValid ()) {
    cEnumerator_lexicalMessageMap enumerator_3487 (in_LEXICAL_5F_MESSAGE_5F_MAP, kEnumeration_up) ;
    while (enumerator_3487.hasCurrentObject ()) {
      result << "\n"
        "static const utf32 gLexicalMessage_" ;
      result << enumerator_3487.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (83)).stringValue () ;
      result << " [] = " ;
      result << enumerator_3487.current_mLexicalMessage (HERE).mAttribute_string.reader_utf_33__32_Representation (SOURCE_FILE_AT_LINE (83)).stringValue () ;
      result << " ;\n" ;
      index_3487_.increment () ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_4037 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_4037.hasCurrentObject ()) {
      result << "\n"
        "//--- Syntax error message for terminal '$" ;
      result << enumerator_4037.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (93)).stringValue () ;
      result << "$' :\n"
        "static const utf32 gSyntaxErrorMessage_" ;
      result << enumerator_4037.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (94)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (94)).stringValue () ;
      result << " [] = " ;
      result << enumerator_4037.current_mSyntaxErrorMessage (HERE).reader_utf_33__32_Representation (SOURCE_FILE_AT_LINE (94)).stringValue () ;
      result << " ;\n" ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_5024 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_5024.hasCurrentObject ()) {
      result << ",\n"
        "    gSyntaxErrorMessage_" ;
      result << enumerator_5024.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (107)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (107)).stringValue () ;
  ...
  result << "} ;\n"
    ...
    "//                                                                           *\n"
    "//---------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_5636_ (0) ;
  if (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES.isValid ()) {
    cEnumerator_stringset enumerator_5636 (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES, kEnumeration_up) ;
    while (enumerator_5636.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5636.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (120)).stringValue () ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5636.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (121)).stringValue () ;
      result << " [] = " ;
      result << enumerator_5636.current_key (HERE).reader_utf_33__32_Representation (SOURCE_FILE_AT_LINE (121)).stringValue () ;
      result << " ;\n" ;
      index_5636_.increment () ;
  ...
  if (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP.isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5887 (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP, kEnumeration_up) ;
    while (enumerator_5887.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (128)).stringValue () ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const PMSInt32 ktable_size_" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " = " ;
      result << enumerator_5887.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (131)).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
      result << " [ktable_size_" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_6645_ (0) ;
      if (enumerator_5887.current_mTokenSortedList (HERE).isValid ()) {
        cEnumerator_tokenSortedlist enumerator_6645 (enumerator_5887.current_mTokenSortedList (HERE), kEnumeration_up) ;
        while (enumerator_6645.hasCurrentObject ()) {
          result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
          result << enumerator_6645.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ", " ;
          result << enumerator_6645.current_mLength (HERE).reader_string (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ", C_Lexique_" ;
          result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
          result << "::kToken_" ;
          result << enumerator_6645.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (134)).stringValue () ;
          result << ")" ;
      ...
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::search_into_" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).stringValue () ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).stringValue () ;
      result << ", ktable_size_" ;
      result << enumerator_5887.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).stringValue () ;
      result << ") ;\n"
        "}\n"
  ...
  result << " *) inTokenPtr ;\n"
    ...
    "      s.appendCString(\"$$\") ;\n"
    "      break ;\n" ;
  GALGAS_uint index_7968_ (0) ;
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_7968 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_7968.hasCurrentObject ()) {
      result << "    case kToken_" ;
      result << enumerator_7968.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (160)).stringValue () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << enumerator_7968.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (162)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (162)).stringValue () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GALGAS_uint index_8298_ (0) ;
      if (enumerator_7968.current_mSentAttributeList (HERE).isValid ()) {
        cEnumerator_lexicalSentValueList enumerator_8298 (enumerator_7968.current_mSentAttributeList (HERE), kEnumeration_up) ;
        while (enumerator_8298.hasCurrentObject ()) {
          result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
            "      s." ;
          result << categoryReader_appendMethodName (enumerator_8298.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << " (ptr->mLexicalAttribute_" ;
          result << enumerator_8298.current_mLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << categoryReader_appendArgumentOfMethod (enumerator_8298.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).stringValue () ;
          result << ") ;\n" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_9252 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_9252 = enumerator_9252.hasCurrentObject () ;
    if (nonEmpty_enumerator_9252) {
    ...
    while (enumerator_9252.hasCurrentObject ()) {
      ...
      result << enumerator_9252.current_mStartString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (185)).stringValue () ;
      result << ", " ;
      result << enumerator_9252.current_mStartString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (185)).reader_string (SOURCE_FILE_AT_LINE (185)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_9252.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (186)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "NULL, 0," ;
      }else if (kBoolFalse == test_2) {
        result << "kUnicodeString_" ;
        result << enumerator_9252.current_mEndString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (189)).stringValue () ;
        result << ", " ;
        result << enumerator_9252.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (189)).reader_string (SOURCE_FILE_AT_LINE (189)).stringValue () ;
        result << "," ;
      }
      result << " NULL, " ;
      result << enumerator_9252.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (192)).reader_cString (SOURCE_FILE_AT_LINE (192)).stringValue () ;
      result << ")" ;
      if (enumerator_9252.hasNextObject ()) {
        result << ",\n" ;
      }
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_10292 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)), kEnumeration_up) ;
    ...
    while (enumerator_10292.hasCurrentObject ()) {
      result << "  cTemplateDelimiter (kUnicodeString_" ;
      result << enumerator_10292.current_mMatchString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", " ;
      result << enumerator_10292.current_mMatchString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (207)).reader_string (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", kUnicodeString_" ;
      result << enumerator_10292.current_mReplacementString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (208)).stringValue () ;
      result << ", " ;
      result << enumerator_10292.current_mReplacementString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (208)).reader_string (SOURCE_FILE_AT_LINE (208)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_10292.current_mReplacementFunction (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (209)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "NULL" ;
      }else if (kBoolFalse == test_3) {
        result << "scanner_routine_" ;
        result << enumerator_10292.current_mReplacementFunction (HERE).reader_string (SOURCE_FILE_AT_LINE (212)).stringValue () ;
      }
      result << ", true)" ;
  ...
  result << "\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_11330_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (225)).isValid ()) {
    cEnumerator_terminalList enumerator_11330 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (225)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_11330 = enumerator_11330.hasCurrentObject () ;
    if (nonEmpty_enumerator_11330) {
    ...
    while (enumerator_11330.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_11330.current_mIsEndOfTemplateMark (HERE).reader_cString (SOURCE_FILE_AT_LINE (227)).stringValue () ;
      result << " /* " ;
      result << enumerator_11330.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (227)).stringValue () ;
      result << " */" ;
      if (enumerator_11330.hasNextObject ()) {
        result << ",\n" ;
      }
      index_11330_.increment () ;
  ...
  if (kBoolTrue == test_4) {
    ...
    GALGAS_uint index_14430_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_14430 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_14430.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_14430.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (283)).stringValue () ;
        result << categoryReader_initialization (enumerator_14430.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)).stringValue () ;
        result << " ;\n" ;
        index_14430_.increment () ;
    ...
    GALGAS_uint index_14651_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_14651 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_14651.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_14651.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (290)).stringValue () ;
        index_14651_.increment () ;
    ...
    GALGAS_uint index_15357_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_15357 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_15357.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_15357.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (308)).stringValue () ;
        result << categoryReader_initialization (enumerator_15357.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (308)).stringValue () ;
        result << " ;\n" ;
        index_15357_.increment () ;
    ...
    GALGAS_uint index_15578_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_15578 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_15578.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_15578.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)).stringValue () ;
        index_15578_.increment () ;
  ...
  GALGAS_uint index_17126_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17126 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17126.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_17126.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (350)).stringValue () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << enumerator_17126.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (350)).stringValue () ;
      result << " ;\n" ;
      index_17126_.increment () ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17662 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17662.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_17662.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (362)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_17662.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (362)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      ...
      result << enumerator_17662.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (364)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
  ...
  result << "//---------------------------------------------------------------------------*\n"
    ...
    "//                                                                           *\n" ;
  GALGAS_uint index_18447_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_18447 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_18447.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18447.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (374)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (374)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_18447.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (374)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18447.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (378)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (378)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_18447.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (378)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18447.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (379)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (379)).stringValue () ;
      result << " result (value, currentLocation) ;\n"
        "  return result ;\n"
        "}\n"
        "\n" ;
      index_18447_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (391)).isValid ()) {
    cEnumerator_terminalList enumerator_19928 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (391)), kEnumeration_up) ;
    while (enumerator_19928.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_19928.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (392)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalRoutineMessageMap (SOURCE_FILE_AT_LINE (10)).isValid ()) {
    cEnumerator_lexicalRoutineMap enumerator_486 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalRoutineMessageMap (SOURCE_FILE_AT_LINE (10)), kEnumeration_up) ;
    while (enumerator_486.hasCurrentObject ()) {
      const enumGalgasBool test_0 = enumerator_486.current_mIsExtern (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "\n"
          "void scanner_cocoa_routine_" ;
        result << enumerator_486.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (12)).stringValue () ;
        result << " (" ;
        columnMarker = result.currentColumn () ;
        result << "BOOL * ioScanningOk" ;
        GALGAS_uint index_638_ (0) ;
        if (enumerator_486.current_mLexicalRoutineFormalArgumentList (HERE).isValid ()) {
          cEnumerator_lexicalRoutineFormalArgumentList enumerator_638 (enumerator_486.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
          while (enumerator_638.hasCurrentObject ()) {
            result << ",\n"
              "                " ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << categoryReader_cppConstInFormalArgument (enumerator_638.current_mLexicalFormalArgumentMode (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (14)).stringValue () ;
            result << categoryReader_cocoaTypeName (enumerator_638.current_mLexicalFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (15)).stringValue () ;
            result << categoryReader_cocoaPointerInFormalArgument (enumerator_638.current_mLexicalFormalArgumentMode (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (16)).stringValue () ;
            result << " " ;
            result << enumerator_638.current_mArgumentNameForComment (HERE).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (29)).isValid ()) {
    cEnumerator_lexicalFunctionMap enumerator_1458 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (29)), kEnumeration_up) ;
    while (enumerator_1458.hasCurrentObject ()) {
      const enumGalgasBool test_1 = enumerator_1458.current_mIsExtern (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "\n" ;
        result << categoryReader_cppTypeName (enumerator_1458.current_mReturnedLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (31)).stringValue () ;
        result << " scanner_cocoa_function_" ;
        result << enumerator_1458.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (31)).stringValue () ;
        result << " (" ;
        columnMarker = result.currentColumn () ;
        result << "BOOL * ioScanningOk" ;
        GALGAS_uint index_1627_ (0) ;
        if (enumerator_1458.current_mLexicalTypeList (HERE).isValid ()) {
          cEnumerator_lexicalFunctionFormalArgumentList enumerator_1627 (enumerator_1458.current_mLexicalTypeList (HERE), kEnumeration_up) ;
          while (enumerator_1627.hasCurrentObject ()) {
            result << ",\n"
              "                " ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "const " ;
            result << categoryReader_cppTypeName (enumerator_1627.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (33)).stringValue () ;
            result << " " ;
            result << enumerator_1627.current_mArgumentNameForComment (HERE).stringValue () ;
            index_1627_.increment () ;
            enumerator_1627.gotoNextObject () ;
          }
        }
        result << ") ;\n" ;
      }else if (kBoolFalse == test_1) {
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (47)).isValid ()) {
    cEnumerator_terminalList enumerator_2265 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (47)), kEnumeration_up) ;
    while (enumerator_2265.hasCurrentObject ()) {
      result << ",\n"
        "  " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_2265.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (48)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (48)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalAttributeMap (SOURCE_FILE_AT_LINE (61)).isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_2916 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalAttributeMap (SOURCE_FILE_AT_LINE (61)), kEnumeration_up) ;
    while (enumerator_2916.hasCurrentObject ()) {
      result << "  @private " ;
      result << categoryReader_cocoaTypeName (enumerator_2916.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (62)).stringValue () ;
      result << " mLexicalAttribute_" ;
      result << enumerator_2916.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
      result << " ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_1567 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_1567.hasCurrentObject ()) {
      result << "    mLexicalAttribute_" ;
      result << enumerator_1567.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (36)).stringValue () ;
      result << " = " ;
      result << categoryReader_cocoaInitializationCode (enumerator_1567.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (36)).stringValue () ;
      result << " ;\n" ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (42)).isValid ()) {
      cEnumerator_templateDelimitorList enumerator_2022 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (42)), kEnumeration_up) ;
      while (enumerator_2022.hasCurrentObject ()) {
        result << "      [[OC_GGS_TemplateDelimiter alloc] initWithStartString:@" ;
        result << enumerator_2022.current_mStartString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (43)).stringValue () ;
        result << " endString:" ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_2022.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (44)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_3) {
          result << "nil" ;
        }else if (kBoolFalse == test_3) {
          result << "@" ;
          result << enumerator_2022.current_mEndString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (47)).stringValue () ;
        }
        result << " discardStartString:" ;
        result << enumerator_2022.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (50)).reader_ocString (SOURCE_FILE_AT_LINE (50)).stringValue () ;
        result << "],\n" ;
  ...
  if (kBoolTrue == test_4) {
    ...
    result << " = [NSArray arrayWithObjects:\n" ;
    GALGAS_uint index_2757_ (0) ;
    if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (60)).isValid ()) {
      cEnumerator_templateReplacementListAST enumerator_2757 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (60)), kEnumeration_up) ;
      while (enumerator_2757.hasCurrentObject ()) {
        result << "      @" ;
        result << enumerator_2757.current_mMatchString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (61)).stringValue () ;
        result << ", " ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (96)).isValid ()) {
    cEnumerator_indexingListAST enumerator_4118 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (96)), kEnumeration_up) ;
    while (enumerator_4118.hasCurrentObject ()) {
      result << "    @" ;
      result << enumerator_4118.current_mIndexComment (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (97)).stringValue () ;
      result << ",\n" ;
  ...
  result << "    NULL\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_4835_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (109)).isValid ()) {
    cEnumerator_terminalList enumerator_4835 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (109)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_4835 = enumerator_4835.hasCurrentObject () ;
    if (nonEmpty_enumerator_4835) {
    ...
    while (enumerator_4835.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4835.current_mIsEndOfTemplateMark (HERE).reader_ocString (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " /* " ;
      result << enumerator_4835.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " */" ;
      if (enumerator_4835.hasNextObject ()) {
        result << ",\n" ;
      }
      index_4835_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (118)).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5037 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (118)), kEnumeration_up) ;
    while (enumerator_5037.hasCurrentObject ()) {
      const enumGalgasBool test_5 = enumerator_5037.current_mShouldBeGenerated (HERE).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << enumerator_5037.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (122)).stringValue () ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << enumerator_5037.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
        result << " [" ;
        result << enumerator_5037.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
        result << "] = {\n" ;
        GALGAS_uint index_5785_ (0) ;
        if (enumerator_5037.current_mTokenSortedList (HERE).isValid ()) {
          cEnumerator_tokenSortedlist enumerator_5785 (enumerator_5037.current_mTokenSortedList (HERE), kEnumeration_up) ;
          while (enumerator_5785.hasCurrentObject ()) {
            result << "  {" ;
            result << enumerator_5785.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
            result << ", " ;
            result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
            result << "_1_" ;
            result << enumerator_5785.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
            result << "}" ;
            if (enumerator_5785.hasNextObject ()) {
              result << ",\n" ;
            }
        ...
        result << "_" ;
        result << enumerator_5037.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
        ...
        result << "_" ;
        result << enumerator_5037.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << ", " ;
        result << enumerator_5037.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (132)).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << ") ;\n"
          "}\n"
          "\n" ;
  ...
  if (kBoolTrue == test_6) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8229 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8229.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8229.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8229.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8229.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_8451_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8451 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8451.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8451.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)).stringValue () ;
        index_8451_.increment () ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_9302 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_9302.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_9302.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (199)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13674 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)), kEnumeration_up) ;
    while (enumerator_13674.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13674.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (285)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (285)).stringValue () ;
  ...
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_14597_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_14597 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)), kEnumeration_up) ;
    while (enumerator_14597.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14597.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (304)).stringValue () ;
      result << "\"" ;
      index_14597_.increment () ;
