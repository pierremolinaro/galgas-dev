...
//                    november 10th, 2010, at 10h13'15"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileLexiqueComponent (C_CompilerEx & inLexique,
  ...
  if (cond_41749.isBuiltAndTrue ()) {
    const GGS_bool cond_41118 = (GGS_bool (gOption_galgas_5F_cli_5F_options_legacyCodeGeneration.reader_value ())).operator_not () ;
  ...
  if (cond_43431.isBuiltAndTrue ()) {
    const GGS_bool cond_42657 = (GGS_bool (gOption_galgas_5F_cli_5F_options_legacyCodeGeneration.reader_value ())).operator_not () ;
