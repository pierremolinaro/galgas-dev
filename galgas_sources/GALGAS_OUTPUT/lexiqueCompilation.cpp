...
template_filewrapper_lexiqueGenerationTemplates_newHeaderZone2 (C_CompilerEx & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "_0_DEFINED\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalRoutineMap::cEnumerator enumerator_693 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalRoutineMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (16)), true) ;
    const GGS_lexicalRoutineMap::cElement * operand_693 = NULL ;
    while (((operand_693 = enumerator_693.nextObject ()))) {
      macroValidPointer (operand_693) ;
      if (operand_693->mInfo.mIsExtern.boolValue ()) {
        result << "\n"
          "void scanner_routine_" ;
        result << operand_693->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
        result << " (C_Lexique & inLexique" ;
        GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_837 (operand_693->mInfo.mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalRoutineFormalArgumentList::cElement * operand_837 = NULL ;
        while (((operand_837 = enumerator_837.nextObject ()))) {
          macroValidPointer (operand_837) ;
          result << ",\n"
            "                " ;
          result << operand_837->mLexicalFormalArgumentMode.reader_cppConstInFormalArgument (inLexique COMMA_SOURCE_FILE_AT_LINE (20)) ;
          result << operand_837->mLexicalFormalArgumentType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (21)) ;
          result << operand_837->mLexicalFormalArgumentMode.reader_cppReferenceInFormalArgument (inLexique COMMA_SOURCE_FILE_AT_LINE (22)) ;
          result << " " ;
          result << operand_837->mArgumentNameForComment ;
        }
        GGS_stringlist::cEnumerator enumerator_1190 (operand_693->mInfo.mErrorMessageList, true) ;
        const GGS_stringlist::cElement * operand_1190 = NULL ;
        while (((operand_1190 = enumerator_1190.nextObject ()))) {
          macroValidPointer (operand_1190) ;
          result << ",\n"
            "                const char * " ;
          result << operand_1190->mValue ;
        }
        result << ") ;\n" ;
      }else {
      }
    ...
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalFunctionMap::cEnumerator enumerator_1756 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (38)), true) ;
    const GGS_lexicalFunctionMap::cElement * operand_1756 = NULL ;
    while (((operand_1756 = enumerator_1756.nextObject ()))) {
      macroValidPointer (operand_1756) ;
      if (operand_1756->mInfo.mIsExtern.boolValue ()) {
        result << "\n" ;
        result << operand_1756->mInfo.mReturnedLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (40)) ;
        result << " scanner_function_" ;
        result << operand_1756->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (40)) ;
        result << " (C_Lexique & inLexique" ;
        GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_1917 (operand_1756->mInfo.mLexicalTypeList, true) ;
        const GGS_lexicalFunctionFormalArgumentList::cElement * operand_1917 = NULL ;
        while (((operand_1917 = enumerator_1917.nextObject ()))) {
          macroValidPointer (operand_1917) ;
          result << ",\n"
            "                const " ;
          result << operand_1917->mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
          result << " " ;
          result << operand_1917->mArgumentNameForComment ;
        }
        result << ") ;\n" ;
      }else {
      }
    ...
    result << var_cas_LEXIQUE_IDENTIFIER ;
    result << " : public cToken {\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_2581 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (56)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_2581 = NULL ;
    while (((operand_2581 = enumerator_2581.nextObject ()))) {
      macroValidPointer (operand_2581) ;
      result << "  public : " ;
      result << operand_2581->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
      result << " mLexicalAttribute_" ;
      result << operand_2581->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "  public : cTokenFor_" ;
...
template_filewrapper_lexiqueGenerationTemplates_newImplementationZone2 (C_CompilerEx & inLexique,
  ...
  if (isBuilt) {
    ...
    result << var_cas_LEXIQUE_IDENTIFIER ;
    result << " (void)" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_1475 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_1475 = NULL ;
    if (enumerator_1475.hasCurrentObject ()) {
      result << " :\n" ;
      while (((operand_1475 = enumerator_1475.nextObject ()))) {
        macroValidPointer (operand_1475) ;
        result << "mLexicalAttribute_" ;
        result << operand_1475->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << " ()" ;
        if (enumerator_1475.hasNextObject ()) {
          result << ",\n" ;
        }
      }
    }
    ...
    result << " {\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalMessageMap::cEnumerator enumerator_3285 (var_cas_LEXICAL_MESSAGE_MAP, true) ;
    const GGS_lexicalMessageMap::cElement * operand_3285 = NULL ;
    while (((operand_3285 = enumerator_3285.nextObject ()))) {
      macroValidPointer (operand_3285) ;
      result << "\n"
        "static const utf32 gLexicalMessage_" ;
      result << operand_3285->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ;
      result << " [] = " ;
      result << operand_3285->mInfo.mLexicalMessage.ggs_string ().reader_utf32Representation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_terminalList::cEnumerator enumerator_3835 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_3835 = NULL ;
    while (((operand_3835 = enumerator_3835.nextObject ()))) {
      macroValidPointer (operand_3835) ;
      result << "\n"
        "//--- Syntax error message for terminal '$" ;
      result << operand_3835->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
      result << "$' :\n"
        "static const utf32 gSyntaxErrorMessage_" ;
      result << operand_3835->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)).reader_identifierRepresentation () ;
      result << " [] = " ;
      result << operand_3835->mSyntaxErrorMessage.reader_utf32Representation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    result << var_cas_TERMINAL_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (100)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
    result << "] = {kEndOfSourceLexicalErrorMessage" ;
    GGS_terminalList::cEnumerator enumerator_4822 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_4822 = NULL ;
    while (((operand_4822 = enumerator_4822.nextObject ()))) {
      macroValidPointer (operand_4822) ;
      result << ",\n"
        "    gSyntaxErrorMessage_" ;
      result << operand_4822->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102)).reader_identifierRepresentation () ;
    }
    result << "} ;\n"
      "  outSyntaxErrorMessage << syntaxErrorMessageArray [inTerminalIndex] ;\n"
      "}\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_stringset::cEnumerator enumerator_5434 (var_cas_STRINGS_IN_EXPLICIT_RULES, true) ;
    while (enumerator_5434.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5434._key (HERE).reader_identifierRepresentation () ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5434._key (HERE).reader_identifierRepresentation () ;
      result << " [] = " ;
      result << enumerator_5434._key (HERE).reader_utf32Representation () ;
      result << " ;\n" ;
      enumerator_5434.next () ;
    }
    result << "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_5694 (var_cas_LEXICAL_TOKEN_LIST_MAP, true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_5694 = NULL ;
    while (((operand_5694 = enumerator_5694.nextObject ()))) {
      macroValidPointer (operand_5694) ;
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (123)) ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const PMSInt32 ktable_size_" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      result << " = " ;
      result << operand_5694->mInfo.mExplicitTokenListMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
      result << " [ktable_size_" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
      result << "] = {\n" ;
      GGS_tokenSortedlist::cEnumerator enumerator_6452 (operand_5694->mInfo.mTokenSortedList, true) ;
      const GGS_tokenSortedlist::cElement * operand_6452 = NULL ;
      while (((operand_6452 = enumerator_6452.nextObject ()))) {
        macroValidPointer (operand_6452) ;
        result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
        result << operand_6452->mName.reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_6452->mLength.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
        result << ", C_Lexique_" ;
        result << var_cas_LEXIQUE_IDENTIFIER ;
        result << "::kToken_" ;
        result << operand_6452->mTerminalName.reader_identifierRepresentation () ;
        result << ")" ;
        if (enumerator_6452.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
      ...
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::search_into_" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
      result << ", ktable_size_" ;
      result << operand_5694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
      result << ") ;\n"
        "}\n"
    ...
    result << " *) inTokenPtr ;\n"
      ...
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7775 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7775 = NULL ;
    while (((operand_7775 = enumerator_7775.nextObject ()))) {
      macroValidPointer (operand_7775) ;
      result << "    case kToken_" ;
      result << operand_7775->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (155)).reader_identifierRepresentation () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7775->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (157)).reader_utf8Representation () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_8105 (operand_7775->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_8105 = NULL ;
      while (((operand_8105 = enumerator_8105.nextObject ()))) {
        macroValidPointer (operand_8105) ;
        result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
          "      s." ;
        result << operand_8105->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_8105->mLexicalAttributeName.reader_identifierRepresentation () ;
        result << operand_8105->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8916 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (178)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8916 = NULL ;
    if (enumerator_8916.hasCurrentObject ()) {
      result << "static const cTemplateDelimiter kTemplateDefinitionArray [" ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (179)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
      result << "] = {\n" ;
      while (((operand_8916 = enumerator_8916.nextObject ()))) {
        macroValidPointer (operand_8916) ;
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_8916->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_8916->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
        result << ", " ;
        if ((operand_8916->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8916->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_8916->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8916->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
        result << ")" ;
        if (enumerator_8916.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementListAST::cEnumerator enumerator_9953 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (199)), true) ;
    const GGS_templateReplacementListAST::cElement * operand_9953 = NULL ;
    if (enumerator_9953.hasCurrentObject ()) {
      ...
      while (((operand_9953 = enumerator_9953.nextObject ()))) {
        ...
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_9953->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9953->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)) ;
        result << ", kUnicodeString_" ;
        result << operand_9953->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9953->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
        result << ", " ;
        if ((operand_9953->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9953->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
        }
        result << ", true)" ;
        if (enumerator_9953.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_11012 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (220)), true) ;
    const GGS_terminalList::cElement * operand_11012 = NULL ;
    if (enumerator_11012.hasCurrentObject ()) {
      result << "static const bool kEndOfScriptInTemplateArray [" ;
      result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (221)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
      result << "] = {\n" ;
      while (((operand_11012 = enumerator_11012.nextObject ()))) {
        macroValidPointer (operand_11012) ;
        result << "  " ;
        result << operand_11012->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
        result << " /* " ;
        result << operand_11012->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
        result << " */" ;
        if (enumerator_11012.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (240)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      result << ") ;\n"
        ...
        "    }\n"
        "    if ((mMatchedTemplateDelimiterIndex >= 0) && (UNICODE_VALUE (mCurrentChar) != '\\0')) {\n" ;
      GGS_lexicalAttributeMap::cEnumerator enumerator_14237 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14237 = NULL ;
      while (((operand_14237 = enumerator_14237.nextObject ()))) {
        macroValidPointer (operand_14237) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14237->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_14237->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (278)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15129 = GGS_uint (8U) ;
      if (indentation_15129.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15129.uintValue ()) ;
      }
      GGS_lexicalRuleListAST::cEnumerator enumerator_14458 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleListAST::cElement * operand_14458 = NULL ;
      while (((operand_14458 = enumerator_14458.nextObject ()))) {
        macroValidPointer (operand_14458) ;
        result << (findCategoryReader__abstractLexicalRuleAST__generateCode (operand_14458->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14458->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (285))) ;
      }
       ;
      if (indentation_15129.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15129.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_15164 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_15164 = NULL ;
      while (((operand_15164 = enumerator_15164.nextObject ()))) {
        macroValidPointer (operand_15164) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_15164->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_15164->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (303)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15892 = GGS_uint (6U) ;
      if (indentation_15892.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15892.uintValue ()) ;
      }
      GGS_lexicalRuleListAST::cEnumerator enumerator_15385 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleListAST::cElement * operand_15385 = NULL ;
      while (((operand_15385 = enumerator_15385.nextObject ()))) {
        macroValidPointer (operand_15385) ;
        result << (findCategoryReader__abstractLexicalRuleAST__generateCode (operand_15385->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_15385->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (310))) ;
      }
       ;
      if (indentation_15892.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15892.uintValue ())) ;
    ...
    result << " ()) ;\n"
      ...
      "  ptr->mEndLocation = mTokenLastLocation ;\n"
      "  ptr->mTemplateStringBeforeToken = inToken.mTemplateStringBeforeToken ;\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_16934 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16934 = NULL ;
    while (((operand_16934 = enumerator_16934.nextObject ()))) {
      macroValidPointer (operand_16934) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16934->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << operand_16934->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " ;\n" ;
    }
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//               A T T R I B U T E   A C C E S S                             *\n"
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17470 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17470 = NULL ;
    while (((operand_17470 = enumerator_17470.nextObject ()))) {
      macroValidPointer (operand_17470) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << operand_17470->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::attributeValue_" ;
      result << operand_17470->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_18255 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_18255 = NULL ;
    while (((operand_18255 = enumerator_18255.nextObject ()))) {
      macroValidPointer (operand_18255) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << operand_18255->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (369)).reader_identifierRepresentation () ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::synthetizedAttribute_" ;
      result << operand_18255->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << operand_18255->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (373)).reader_identifierRepresentation () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << operand_18255->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << operand_18255->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (374)).reader_identifierRepresentation () ;
