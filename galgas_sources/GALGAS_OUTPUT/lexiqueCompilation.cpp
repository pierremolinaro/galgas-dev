...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (kBoolTrue == test_2) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_7400 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_7400.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_7400.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_7400.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (146)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_7400.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_7616_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_7616 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_7616.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_7616.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)).stringValue () ;
        index_7616_.increment () ;
    ...
    GALGAS_uint index_8253_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8253 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8253.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8253.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (170)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8253.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (170)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8253.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (170)).stringValue () ;
        result << " ;\n" ;
        index_8253_.increment () ;
    ...
    GALGAS_uint index_8467_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8467 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8467.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8467.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
        index_8467_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (230)).isValid ()) {
    cEnumerator_terminalList enumerator_11057 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (230)), kEnumeration_up) ;
    while (enumerator_11057.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11057.current_mStyleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (231)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11057.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (231)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (231)).stringValue () ;
      result << " */" ;
  ...
  result << "] = {NO" ;
  GALGAS_uint index_11874_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (244)).isValid ()) {
    cEnumerator_terminalList enumerator_11874 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (244)), kEnumeration_up) ;
    while (enumerator_11874.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11874.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE_AT_LINE (245)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11874.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (245)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (245)).stringValue () ;
      result << " */" ;
      index_11874_.increment () ;
  ...
  result << "] = {\n"
    "      @\"Default Style\"" ;
  GALGAS_uint index_12847_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (261)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_12847 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (261)), kEnumeration_up) ;
    while (enumerator_12847.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_12847.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (262)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (262)).stringValue () ;
      index_12847_.increment () ;
  ...
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_13771_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (280)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13771 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (280)), kEnumeration_up) ;
    while (enumerator_13771.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_13771.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (281)).stringValue () ;
      result << "\"" ;
      index_13771_.increment () ;
