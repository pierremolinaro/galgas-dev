...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (118)).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5053 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (118)), kEnumeration_up) ;
    while (enumerator_5053.hasCurrentObject ()) {
      const enumGalgasBool test_5 = enumerator_5053.current_mShouldBeGenerated (HERE).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << enumerator_5053.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (122)).stringValue () ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << enumerator_5053.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
        result << " [" ;
        result << enumerator_5053.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
        result << "] = {\n" ;
        GALGAS_uint index_5801_ (0) ;
        if (enumerator_5053.current_mTokenSortedList (HERE).isValid ()) {
          cEnumerator_tokenSortedlist enumerator_5801 (enumerator_5053.current_mTokenSortedList (HERE), kEnumeration_up) ;
          while (enumerator_5801.hasCurrentObject ()) {
            result << "  {" ;
            result << enumerator_5801.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
            result << ", " ;
            result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
            result << "_1_" ;
            result << enumerator_5801.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
            result << "}" ;
            if (enumerator_5801.hasNextObject ()) {
              result << ",\n" ;
            }
        ...
        result << "_" ;
        result << enumerator_5053.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
        ...
        result << "_" ;
        result << enumerator_5053.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << ", " ;
        result << enumerator_5053.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (132)).reader_string (SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << ") ;\n"
          "}\n"
          "\n" ;
  ...
  if (kBoolTrue == test_6) {
    ...
    GALGAS_uint index_8240_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8240 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8240.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8240.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8240.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8240.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << " ;\n" ;
        index_8240_.increment () ;
    ...
    GALGAS_uint index_8456_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8456 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8456.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8456.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)).stringValue () ;
        index_8456_.increment () ;
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_9093 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_9093.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_9093.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_9093.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_9093.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_9307_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_9307 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_9307.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_9307.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (199)).stringValue () ;
        index_9307_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (253)).isValid ()) {
    cEnumerator_terminalList enumerator_11897 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (253)), kEnumeration_up) ;
    while (enumerator_11897.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11897.current_mStyleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11897.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (254)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (267)).isValid ()) {
    cEnumerator_terminalList enumerator_12714 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (267)), kEnumeration_up) ;
    while (enumerator_12714.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_12714.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_12714.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (268)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      result << " */" ;
  ...
  result << "] = {\n"
    "      @\"Default Style\"" ;
  GALGAS_uint index_13687_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13687 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)), kEnumeration_up) ;
    while (enumerator_13687.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13687.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (285)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (285)).stringValue () ;
      index_13687_.increment () ;
  ...
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_14611_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_14611 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)), kEnumeration_up) ;
    while (enumerator_14611.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14611.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (304)).stringValue () ;
      result << "\"" ;
      index_14611_.increment () ;
