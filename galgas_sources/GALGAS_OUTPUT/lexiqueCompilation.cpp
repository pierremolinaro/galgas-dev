...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_terminalList::cEnumerator enumerator_4586 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_4586 = NULL ;
    while (((operand_4586 = enumerator_4586.nextObject ()))) {
      macroValidPointer (operand_4586) ;
      result << ",\n"
        "    gSyntaxErrorMessage_" ;
      result << operand_4586->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (105)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
    result << "} ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_stringset::cEnumerator enumerator_5199 (var_cas_STRINGS_IN_EXPLICIT_RULES, true) ;
    while (enumerator_5199.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5199._key (HERE).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (118)) ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5199._key (HERE).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
      result << " [] = " ;
      result << enumerator_5199._key (HERE).reader_utf32Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
      result << " ;\n" ;
      enumerator_5199.next () ;
    }
    result << "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_5452 (var_cas_LEXICAL_TOKEN_LIST_MAP, true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_5452 = NULL ;
    while (((operand_5452 = enumerator_5452.nextObject ()))) {
      macroValidPointer (operand_5452) ;
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const sint32 ktable_size_" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " = " ;
      result << operand_5452->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (129)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << " [ktable_size_" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << "] = {\n" ;
      GGS_tokenSortedlist::cEnumerator enumerator_6209 (operand_5452->mInfo.mTokenSortedList, true) ;
      const GGS_tokenSortedlist::cElement * operand_6209 = NULL ;
      while (((operand_6209 = enumerator_6209.nextObject ()))) {
        macroValidPointer (operand_6209) ;
        result << "  {kUnicodeString_" ;
        result << operand_6209->mName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << ", " ;
        result << operand_6209->mLength.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << ", " ;
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "::" ;
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "_1_" ;
        result << operand_6209->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << "}" ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::search_into_" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      result << ", ktable_size_" ;
      result << operand_5452->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      result << ") ;\n"
        "}\n"
    ...
    result << "_1_:\n"
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7489 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7489 = NULL ;
    while (((operand_7489 = enumerator_7489.nextObject ()))) {
      macroValidPointer (operand_7489) ;
      result << "    case " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7489->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7489->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7804 (operand_7489->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7804 = NULL ;
      while (((operand_7804 = enumerator_7804.nextObject ()))) {
        macroValidPointer (operand_7804) ;
        result << "      s." ;
        result << operand_7804->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7804->mAttributeName ;
        result << operand_7804->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8510 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8510 = NULL ;
    if (enumerator_8510.hasCurrentObject ()) {
      ...
      while (((operand_8510 = enumerator_8510.nextObject ()))) {
        ...
        result << "  {kUnicodeString_" ;
        result << operand_8510->mStartString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        result << operand_8510->mStartString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        if ((operand_8510->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8510->mEndString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << ", " ;
          result << operand_8510->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8510->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
        result << "}" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9539 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
    const GGS_templateReplacementList::cElement * operand_9539 = NULL ;
    if (enumerator_9539.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_9539 = enumerator_9539.nextObject ()))) {
        macroValidPointer (operand_9539) ;
        result << "  {kUnicodeString_" ;
        result << operand_9539->mMatchString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", " ;
        result << operand_9539->mMatchString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", kUnicodeString_" ;
        result << operand_9539->mReplacementString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        result << operand_9539->mReplacementString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        if ((operand_9539->mReplacementFunction.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (207))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9539->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
        result << ", true}" ;
        if (enumerator_9539.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10590 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_terminalList::cElement * operand_10590 = NULL ;
    if (enumerator_10590.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_10590 = enumerator_10590.nextObject ()))) {
        macroValidPointer (operand_10590) ;
        result << "  " ;
        result << operand_10590->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " /* " ;
        result << operand_10590->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " */" ;
        if (enumerator_10590.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13807 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13807 = NULL ;
      while (((operand_13807 = enumerator_13807.nextObject ()))) {
        macroValidPointer (operand_13807) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13807->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13807->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14245 = GGS_uint (8U) ;
      if (indentation_14245.isBuilt ()) {
        result.incIndentation ((sint32) indentation_14245.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14011 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14011 = NULL ;
      while (((operand_14011 = enumerator_14011.nextObject ()))) {
        macroValidPointer (operand_14011) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14011->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14011->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14245.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_14245.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14734 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14734 = NULL ;
      while (((operand_14734 = enumerator_14734.nextObject ()))) {
        macroValidPointer (operand_14734) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14734->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14734->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15170 = GGS_uint (6U) ;
      if (indentation_15170.isBuilt ()) {
        result.incIndentation ((sint32) indentation_15170.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14938 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14938 = NULL ;
      while (((operand_14938 = enumerator_14938.nextObject ()))) {
        macroValidPointer (operand_14938) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14938->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14938->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15170.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_15170.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16491 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16491 = NULL ;
    while (((operand_16491 = enumerator_16491.nextObject ()))) {
      macroValidPointer (operand_16491) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16491->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17070 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17070 = NULL ;
    while (((operand_17070 = enumerator_17070.nextObject ()))) {
      macroValidPointer (operand_17070) ;
      result << "void " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "assignFromAttribute_" ;
      result << operand_17070->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " (" ;
      result << operand_17070->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_17070->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_17070->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17886 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17886 = NULL ;
    while (((operand_17886 = enumerator_17886.nextObject ()))) {
      macroValidPointer (operand_17886) ;
      result << operand_17886->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_17886->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_17886->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << " ;\n"
      ...
      "- (BOOL) isTemplateLexique {\n"
      "  return " ;
    result << (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_strictSup (GGS_uint (0U)).reader_ocString (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
    result << " ;\n"
      "}\n"
      "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (207)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_9598 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (208)), true) ;
    const GGS_terminalList::cElement * operand_9598 = NULL ;
    while (((operand_9598 = enumerator_9598.nextObject ()))) {
      macroValidPointer (operand_9598) ;
      result << ",\n"
        "    " ;
      result << operand_9598->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_9598->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (221)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (221)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (221)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_10416 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_lexicalStyleList::cElement * operand_10416 = NULL ;
    while (((operand_10416 = enumerator_10416.nextObject ()))) {
      macroValidPointer (operand_10416) ;
      result << ",\n"
        "    @" ;
      result << operand_10416->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
    }
    result << "\n"
      "  } ;\n"
      ...
      "- (NSString *) styleIdentifierForStyleIndex: (SInt32) inIndex {\n"
      "  NSString * kStyleArray [" ;
    result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (236)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (236)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (236)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
    result << "] = {\n"
      "    @\"" ;
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_11168 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), true) ;
    const GGS_lexicalStyleList::cElement * operand_11168 = NULL ;
    while (((operand_11168 = enumerator_11168.nextObject ()))) {
      macroValidPointer (operand_11168) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_11168->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
