  ...
  if (isBuilt) {
    ...
    if (enumerator_8506.hasCurrentObject ()) {
      ...
      while (((operand_8506 = enumerator_8506.nextObject ()))) {
        ...
        result << " NULL, " ;
        result << (operand_8506->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
        result << "}" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9535 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
    const GGS_templateReplacementList::cElement * operand_9535 = NULL ;
    if (enumerator_9535.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_9535 = enumerator_9535.nextObject ()))) {
        macroValidPointer (operand_9535) ;
        result << "  {kUnicodeString_" ;
        result << operand_9535->mMatchString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", " ;
        result << operand_9535->mMatchString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", kUnicodeString_" ;
        result << operand_9535->mReplacementString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        result << operand_9535->mReplacementString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        if ((operand_9535->mReplacementFunction.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (207))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9535->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
        result << ", true}" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10586 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_terminalList::cElement * operand_10586 = NULL ;
    if (enumerator_10586.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_10586 = enumerator_10586.nextObject ()))) {
        macroValidPointer (operand_10586) ;
        result << "  " ;
        result << operand_10586->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " /* " ;
        result << operand_10586->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " */" ;
        if (enumerator_10586.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13803 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13803 = NULL ;
      while (((operand_13803 = enumerator_13803.nextObject ()))) {
        macroValidPointer (operand_13803) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13803->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13803->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14241 = GGS_uint (8U) ;
      if (indentation_14241.isBuilt ()) {
        result.incIndentation ((sint32) indentation_14241.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14007 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14007 = NULL ;
      while (((operand_14007 = enumerator_14007.nextObject ()))) {
        macroValidPointer (operand_14007) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14007->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14007->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14241.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_14241.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14730 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14730 = NULL ;
      while (((operand_14730 = enumerator_14730.nextObject ()))) {
        macroValidPointer (operand_14730) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14730->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14730->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15166 = GGS_uint (6U) ;
      if (indentation_15166.isBuilt ()) {
        result.incIndentation ((sint32) indentation_15166.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14934 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14934 = NULL ;
      while (((operand_14934 = enumerator_14934.nextObject ()))) {
        macroValidPointer (operand_14934) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14934->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14934->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15166.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_15166.uintValue ())) ;
...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_2544 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (67)), true) ;
    const GGS_terminalList::cElement * operand_2544 = NULL ;
    if (enumerator_2544.hasCurrentObject ()) {
      ...
      result << " [" ;
      result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
      result << "] = {\n" ;
      while (((operand_2544 = enumerator_2544.nextObject ()))) {
        macroValidPointer (operand_2544) ;
        result << "  " ;
        result << operand_2544->mIsEndOfTemplateMark.reader_ocString (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
        result << " /* " ;
        result << operand_2544->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
        result << " */" ;
    ...
    result << "\n"
      "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_2923 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (76)), true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_2923 = NULL ;
    while (((operand_2923 = enumerator_2923.nextObject ()))) {
      macroValidPointer (operand_2923) ;
      if (operand_2923->mInfo.mShouldBeGenerated.boolValue ()) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << operand_2923->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
          "static const C_cocoa_lexique_table_entry ktable_for_" ;
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << "_" ;
        result << operand_2923->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << " [" ;
        result << operand_2923->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (83)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << "] = {\n" ;
        GGS_tokenSortedlist::cEnumerator enumerator_3673 (operand_2923->mInfo.mTokenSortedList, true) ;
        const GGS_tokenSortedlist::cElement * operand_3673 = NULL ;
        while (((operand_3673 = enumerator_3673.nextObject ()))) {
          macroValidPointer (operand_3673) ;
          result << "  {@" ;
          result << operand_3673->mName.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) ;
          result << ", " ;
          result << var_cas_LEXIQUE_CLASS_NAME ;
          result << "_1_" ;
          result << operand_3673->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) ;
          result << "}" ;
        ...
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
        result << "_" ;
        result << operand_2923->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
        result << " (NSString * inSearchedString) {\n"
          "  return searchStringInTable (inSearchedString, ktable_for_" ;
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
        result << "_" ;
        result << operand_2923->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
        result << ", " ;
        result << operand_2923->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (90)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (108))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      result << "    if ((mMatchedTemplateDelimiterIndex >= 0) && ([kTemplateDefinitionArray_" ;
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
      result << " listLength:" ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (116)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (116)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
      result << "] ;\n"
        "      if (mMatchedTemplateDelimiterIndex < 0) {\n"
        "        [self advance] ;\n"
        "        mTokenCode = -2 ;\n"
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_5950 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_5950 = NULL ;
      while (((operand_5950 = enumerator_5950.nextObject ()))) {
        macroValidPointer (operand_5950) ;
        result << "      " ;
        result << operand_5950->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << "mLexicalAttribute_" ;
        result << operand_5950->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << operand_5950->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << " ;\n" ;
      }
      result << "      mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_6392 = GGS_uint (6U) ;
      if (indentation_6392.isBuilt ()) {
        result.incIndentation ((sint32) indentation_6392.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_6174 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_6174 = NULL ;
      while (((operand_6174 = enumerator_6174.nextObject ()))) {
        macroValidPointer (operand_6174) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_6174->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_6174->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (130))) ;
      }
       ;
      if (indentation_6392.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_6392.uintValue ())) ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
      result << " [mTokenCode - 1]) {\n"
        "      mMatchedTemplateDelimiterIndex = -1 ;\n"
        "    }\n"
        "  //--- Error \?\n"
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_6808 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_6808 = NULL ;
      while (((operand_6808 = enumerator_6808.nextObject ()))) {
        macroValidPointer (operand_6808) ;
        result << "    " ;
        result << operand_6808->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << "mLexicalAttribute_" ;
        result << operand_6808->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << operand_6808->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_7244 = GGS_uint (4U) ;
      if (indentation_7244.isBuilt ()) {
        result.incIndentation ((sint32) indentation_7244.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7028 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7028 = NULL ;
      while (((operand_7028 = enumerator_7028.nextObject ()))) {
        macroValidPointer (operand_7028) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7028->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7028->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (154))) ;
      }
       ;
      if (indentation_7244.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_7244.uintValue ())) ;
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_9083 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), true) ;
    const GGS_terminalList::cElement * operand_9083 = NULL ;
    while (((operand_9083 = enumerator_9083.nextObject ()))) {
      macroValidPointer (operand_9083) ;
      result << ",\n"
        "    " ;
      result << operand_9083->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_9083->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_9901 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (213)), true) ;
    const GGS_lexicalStyleList::cElement * operand_9901 = NULL ;
    while (((operand_9901 = enumerator_9901.nextObject ()))) {
      macroValidPointer (operand_9901) ;
      result << ",\n"
        "    @" ;
      result << operand_9901->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_10653 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (228)), true) ;
    const GGS_lexicalStyleList::cElement * operand_10653 = NULL ;
    while (((operand_10653 = enumerator_10653.nextObject ()))) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_10653->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
