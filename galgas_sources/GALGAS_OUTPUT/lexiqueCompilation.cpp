...
//                                         september 3rd, 2014, at 11h47'59"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_1568 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    const bool nonEmpty_enumerator_1568 = enumerator_1568.hasCurrentObject () ;
    if (nonEmpty_enumerator_1568) {
      result << " :\n" ;
    }
    while (enumerator_1568.hasCurrentObject ()) {
      result << "mLexicalAttribute_" ;
      result << enumerator_1568.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 33)).stringValue () ;
      result << " ()" ;
      if (enumerator_1568.hasNextObject ()) {
        result << ",\n" ;
      }
  ...
  if (in_LEXICAL_5F_MESSAGE_5F_MAP.isValid ()) {
    cEnumerator_lexicalMessageMap enumerator_4283 (in_LEXICAL_5F_MESSAGE_5F_MAP, kEnumeration_up) ;
    while (enumerator_4283.hasCurrentObject ()) {
      result << "\n"
        "static const utf32 gLexicalMessage_" ;
      result << enumerator_4283.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 83)).stringValue () ;
      result << " [] = " ;
      result << enumerator_4283.current_mLexicalMessage (HERE).mAttribute_string.reader_utf_33__32_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 83)).stringValue () ;
      result << " ;\n" ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_5037 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_5037.hasCurrentObject ()) {
      result << "\n"
        "//--- Syntax error message for terminal '$" ;
      result << enumerator_5037.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 93)).stringValue () ;
      result << "$' :\n"
        "static const utf32 gSyntaxErrorMessage_" ;
      result << enumerator_5037.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 94)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 94)).stringValue () ;
      result << " [] = " ;
      result << enumerator_5037.current_mSyntaxErrorMessage (HERE).reader_utf_33__32_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 94)).stringValue () ;
      result << " ;\n" ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_6140 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_6140.hasCurrentObject ()) {
      result << ",\n"
        "    gSyntaxErrorMessage_" ;
      result << enumerator_6140.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 106)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 106)).stringValue () ;
  ...
  if (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES.isValid ()) {
    cEnumerator_stringset enumerator_6938 (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES, kEnumeration_up) ;
    while (enumerator_6938.hasCurrentObject ()) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_6938.current_key (HERE).reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 119)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "\n"
          "//--- Unicode string for '$" ;
        result << enumerator_6938.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 120)).stringValue () ;
        result << "$'\n"
          "static const utf32 kUnicodeString_" ;
        result << enumerator_6938.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 121)).stringValue () ;
        result << " [] = " ;
        result << enumerator_6938.current_key (HERE).reader_utf_33__32_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 121)).stringValue () ;
        result << " ;\n" ;
      }else if (kBoolFalse == test_2) {
      }
  ...
  result << "\n" ;
  GALGAS_uint index_7218_ (0) ;
  if (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP.isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_7218 (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP, kEnumeration_up) ;
    while (enumerator_7218.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------------------------------------------------*\n"
        "//                                                                                                                     *\n"
        "//             Key words table '" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 129)).stringValue () ;
      result << "'                            *\n"
        "//                                                                                                                     *\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "static const int32_t ktable_size_" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 132)).stringValue () ;
      result << " = " ;
      result << enumerator_7218.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 132)).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 132)).stringValue () ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 133)).stringValue () ;
      result << " [ktable_size_" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 133)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_8145_ (0) ;
      if (enumerator_7218.current_mTokenSortedList (HERE).isValid ()) {
        cEnumerator_tokenSortedlist enumerator_8145 (enumerator_7218.current_mTokenSortedList (HERE), kEnumeration_up) ;
        while (enumerator_8145.hasCurrentObject ()) {
          result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
          result << enumerator_8145.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 135)).stringValue () ;
          result << ", " ;
          result << enumerator_8145.current_mLength (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 135)).stringValue () ;
          result << ", C_Lexique_" ;
          result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
          result << "::kToken_" ;
          result << enumerator_8145.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 135)).stringValue () ;
          result << ")" ;
      ...
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::search_into_" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 139)).stringValue () ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 140)).stringValue () ;
      result << ", ktable_size_" ;
      result << enumerator_7218.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 140)).stringValue () ;
      result << ") ;\n"
        "}\n"
        "\n" ;
      index_7218_.increment () ;
  ...
  result << " *) inTokenPtr ;\n"
    ...
    "      s.appendCString(\"$$\") ;\n"
    "      break ;\n" ;
  GALGAS_uint index_9663_ (0) ;
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_9663 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_9663.hasCurrentObject ()) {
      result << "    case kToken_" ;
      result << enumerator_9663.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 161)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 161)).stringValue () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << enumerator_9663.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 163)).reader_utf_38_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 163)).stringValue () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GALGAS_uint index_9995_ (0) ;
      if (enumerator_9663.current_mSentAttributeList (HERE).isValid ()) {
        cEnumerator_lexicalSentValueList enumerator_9995 (enumerator_9663.current_mSentAttributeList (HERE), kEnumeration_up) ;
        while (enumerator_9995.hasCurrentObject ()) {
          result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
            "      s." ;
          result << categoryReader_appendMethodName (enumerator_9995.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 167)).stringValue () ;
          result << " (ptr->mLexicalAttribute_" ;
          result << enumerator_9995.current_mLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 167)).stringValue () ;
          result << categoryReader_appendArgumentOfMethod (enumerator_9995.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 167)).stringValue () ;
          result << ") ;\n" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 184)).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_11145 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 184)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_11145 = enumerator_11145.hasCurrentObject () ;
    if (nonEmpty_enumerator_11145) {
    ...
    while (enumerator_11145.hasCurrentObject ()) {
      ...
      result << enumerator_11145.current_mStartString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 186)).stringValue () ;
      result << ", " ;
      result << enumerator_11145.current_mStartString (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 186)).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 186)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_11145.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 187)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "NULL, 0," ;
      }else if (kBoolFalse == test_3) {
        result << "kUnicodeString_" ;
        result << enumerator_11145.current_mEndString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 190)).stringValue () ;
        result << ", " ;
        result << enumerator_11145.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 190)).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 190)).stringValue () ;
        result << "," ;
      }
      result << " NULL, " ;
      result << enumerator_11145.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 193)).reader_cString (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 193)).stringValue () ;
      result << ")" ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 205)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_12386 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 205)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_12386 = enumerator_12386.hasCurrentObject () ;
    if (nonEmpty_enumerator_12386) {
    ...
    while (enumerator_12386.hasCurrentObject ()) {
      result << "  cTemplateDelimiter (kUnicodeString_" ;
      result << enumerator_12386.current_mMatchString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 208)).stringValue () ;
      result << ", " ;
      result << enumerator_12386.current_mMatchString (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 208)).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 208)).stringValue () ;
      result << ", kUnicodeString_" ;
      result << enumerator_12386.current_mReplacementString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 209)).stringValue () ;
      result << ", " ;
      result << enumerator_12386.current_mReplacementString (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 209)).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 209)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_12386.current_mReplacementFunction (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 210)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "NULL" ;
      }else if (kBoolFalse == test_4) {
        result << "scanner_routine_" ;
        result << enumerator_12386.current_mReplacementFunction (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 213)).stringValue () ;
      }
      result << ", true)" ;
      if (enumerator_12386.hasNextObject ()) {
        result << ",\n" ;
      }
      index_12386_.increment () ;
  ...
  if (kBoolTrue == test_5) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 227)).isValid ()) {
      cEnumerator_terminalList enumerator_13702 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 227)), kEnumeration_up) ;
      const bool nonEmpty_enumerator_13702 = enumerator_13702.hasCurrentObject () ;
      if (nonEmpty_enumerator_13702) {
      ...
      while (enumerator_13702.hasCurrentObject ()) {
        result << "  " ;
        result << enumerator_13702.current_mIsEndOfTemplateMark (HERE).reader_cString (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 229)).stringValue () ;
        result << " /* " ;
        result << enumerator_13702.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 229)).stringValue () ;
        result << " */" ;
        if (enumerator_13702.hasNextObject ()) {
          result << ",\n" ;
        }
        index_13702_.increment () ;
  ...
  if (kBoolTrue == test_6) {
    ...
    GALGAS_uint index_17017_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_17017 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_17017.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_17017.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 286)).stringValue () ;
        result << categoryReader_initialization (enumerator_17017.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 286)).stringValue () ;
        result << " ;\n" ;
        index_17017_.increment () ;
    ...
    GALGAS_uint index_17232_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_17232 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_17232.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_17232.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 293)).stringValue () ;
        index_17232_.increment () ;
    ...
    GALGAS_uint index_17932_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_17932 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_17932.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_17932.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 311)).stringValue () ;
        result << categoryReader_initialization (enumerator_17932.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 311)).stringValue () ;
        result << " ;\n" ;
        index_17932_.increment () ;
    ...
    GALGAS_uint index_18147_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_18147 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_18147.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_18147.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 318)).stringValue () ;
  ...
  GALGAS_uint index_19896_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_19896 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_19896.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_19896.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 353)).stringValue () ;
      result << " = inToken.mLexicalAttribute_" ;
      result << enumerator_19896.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 353)).stringValue () ;
      result << " ;\n" ;
      index_19896_.increment () ;
      enumerator_19896.gotoNextObject () ;
    }
  }
  result << "  enterTokenFromPointer (ptr) ;\n"
    ...
    "//                                                                                                                     *\n" ;
  GALGAS_uint index_20594_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_20594 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_20594.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_20594.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 365)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_20594.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 365)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      ...
      result << enumerator_20594.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 367)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
      index_20594_.increment () ;
  ...
  result << "//---------------------------------------------------------------------------------------------------------------------*\n"
    ...
    "//                                                                                                                     *\n" ;
  GALGAS_uint index_21543_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_21543 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_21543.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_21543.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 377)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 377)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_21543.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 377)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_21543.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 381)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 381)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_21543.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 381)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_21543.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 382)).reader_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 382)).stringValue () ;
      result << " result (value, currentLocation) ;\n"
        "  return result ;\n"
        "}\n"
        "\n" ;
      index_21543_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 394)).isValid ()) {
    cEnumerator_terminalList enumerator_23230 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 394)), kEnumeration_up) ;
    while (enumerator_23230.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_23230.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.gTemplate", 395)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
      index_23230_.increment () ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_2067 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_2067.hasCurrentObject ()) {
      result << "    mLexicalAttribute_" ;
      result << enumerator_2067.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 36)).stringValue () ;
      result << " = " ;
      result << categoryReader_cocoaInitializationCode (enumerator_2067.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 36)).stringValue () ;
      result << " ;\n" ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 42)).isValid ()) {
      cEnumerator_templateDelimitorList enumerator_2516 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 42)), kEnumeration_up) ;
      while (enumerator_2516.hasCurrentObject ()) {
        result << "      [[OC_GGS_TemplateDelimiter alloc] initWithStartString:@" ;
        result << enumerator_2516.current_mStartString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 43)).stringValue () ;
        result << " endString:" ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_2516.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 44)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_3) {
          result << "nil" ;
        }else if (kBoolFalse == test_3) {
          result << "@" ;
          result << enumerator_2516.current_mEndString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 47)).stringValue () ;
        }
        result << " discardStartString:" ;
        result << enumerator_2516.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 50)).reader_ocString (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 50)).stringValue () ;
        result << "],\n" ;
  ...
  if (kBoolTrue == test_4) {
    ...
    if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 60)).isValid ()) {
      cEnumerator_templateReplacementListAST enumerator_3239 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 60)), kEnumeration_up) ;
      while (enumerator_3239.hasCurrentObject ()) {
        result << "      @" ;
        result << enumerator_3239.current_mMatchString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 61)).stringValue () ;
        result << ", " ;
        index_3239_.increment () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 96)).isValid ()) {
    cEnumerator_indexingListAST enumerator_5053 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 96)), kEnumeration_up) ;
    while (enumerator_5053.hasCurrentObject ()) {
      result << "    @" ;
      result << enumerator_5053.current_mIndexComment (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 97)).stringValue () ;
      result << ",\n" ;
      index_5053_.increment () ;
  ...
  if (kBoolTrue == test_5) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 110)).isValid ()) {
      cEnumerator_terminalList enumerator_6050 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 110)), kEnumeration_up) ;
      const bool nonEmpty_enumerator_6050 = enumerator_6050.hasCurrentObject () ;
      if (nonEmpty_enumerator_6050) {
      ...
      while (enumerator_6050.hasCurrentObject ()) {
        result << "  " ;
        result << enumerator_6050.current_mIsEndOfTemplateMark (HERE).reader_ocString (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 112)).stringValue () ;
        result << " /* " ;
        result << enumerator_6050.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 112)).stringValue () ;
        result << " */" ;
        if (enumerator_6050.hasNextObject ()) {
          result << ",\n" ;
        }
        index_6050_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 120)).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_6258 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 120)), kEnumeration_up) ;
    while (enumerator_6258.hasCurrentObject ()) {
      const enumGalgasBool test_6 = enumerator_6258.current_mShouldBeGenerated (HERE).boolEnum () ;
      if (kBoolTrue == test_6) {
        result << "//---------------------------------------------------------------------------------------------------------------------*\n"
          "//                                                                                                                     *\n"
          "//             Key words table '" ;
        result << enumerator_6258.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 124)).stringValue () ;
        result << "'                            *\n"
          "//                                                                                                                     *\n"
          "//---------------------------------------------------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << enumerator_6258.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 127)).stringValue () ;
        result << " [" ;
        result << enumerator_6258.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 127)).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 127)).stringValue () ;
        result << "] = {\n" ;
        GALGAS_uint index_7176_ (0) ;
        if (enumerator_6258.current_mTokenSortedList (HERE).isValid ()) {
          cEnumerator_tokenSortedlist enumerator_7176 (enumerator_6258.current_mTokenSortedList (HERE), kEnumeration_up) ;
          while (enumerator_7176.hasCurrentObject ()) {
            result << "  {" ;
            result << enumerator_7176.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 129)).stringValue () ;
            result << ", " ;
            result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
            result << "_1_" ;
            result << enumerator_7176.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 129)).stringValue () ;
            result << "}" ;
            if (enumerator_7176.hasNextObject ()) {
              result << ",\n" ;
            }
        ...
        result << "_" ;
        result << enumerator_6258.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 133)).stringValue () ;
        ...
        result << "_" ;
        result << enumerator_6258.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 134)).stringValue () ;
        result << ", " ;
        result << enumerator_6258.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 134)).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 134)).stringValue () ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else if (kBoolFalse == test_6) {
      }
      index_6258_.increment () ;
  ...
  if (kBoolTrue == test_7) {
    ...
    GALGAS_uint index_9823_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_9823 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_9823.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_9823.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 171)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_9823.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 171)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_9823.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 171)).stringValue () ;
        result << " ;\n" ;
        index_9823_.increment () ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_10039 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_10039.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_10039.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 177)).stringValue () ;
    ...
    GALGAS_uint index_10666_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_10666 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_10666.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_10666.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 195)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_10666.current_lkey (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 195)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_10666.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 195)).stringValue () ;
        result << " ;\n" ;
        index_10666_.increment () ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_10878 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_10878.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_10878.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 201)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 255)).isValid ()) {
    cEnumerator_terminalList enumerator_14294 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 255)), kEnumeration_up) ;
    while (enumerator_14294.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_14294.current_mStyleIndex (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 256)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_14294.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 256)).reader_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 256)).stringValue () ;
      result << " */" ;
      index_14294_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 269)).isValid ()) {
    cEnumerator_terminalList enumerator_15315 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 269)), kEnumeration_up) ;
    while (enumerator_15315.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_15315.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 270)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_15315.current_mTerminalName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 270)).reader_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 270)).stringValue () ;
      result << " */" ;
      index_15315_.increment () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 286)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_16489 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 286)), kEnumeration_up) ;
    while (enumerator_16489.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_16489.current_mComment (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 287)).reader_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 287)).stringValue () ;
      index_16489_.increment () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 305)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_17616 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 305)), kEnumeration_up) ;
    while (enumerator_17616.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_17616.current_mName (HERE).reader_string (SOURCE_FILE ("lexique_cocoa_implementation.m.gTemplate", 306)).stringValue () ;
      result << "\"" ;
      index_17616_.increment () ;
      enumerator_17616.gotoNextObject () ;
    }
  }
  result << "\n"
    "    } ;\n"
...
void routine_parseLexiqueComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inSourceFile.reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 800)).reader_lastPathComponent (SOURCE_FILE ("lexiqueCompilation.gSemantics", 800)).reader_stringByDeletingPathExtension (SOURCE_FILE ("lexiqueCompilation.gSemantics", 800)), constinArgument_inSourceFile.reader_location (SOURCE_FILE ("lexiqueCompilation.gSemantics", 800)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 800)) ;
  const enumGalgasBool test_0 = ioArgument_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 801)).reader_hasKey (var_key.reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 801)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 801)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 802)).method_searchKey (var_key, outArgument_outLexiqueComponentRoot, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 802)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outLexiqueComponentRoot.drop () ;
    C_String syntaxDirectedTranslationResult_33429 ;
    cGrammar_lexiqueLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_33429, constinArgument_inSourceFile, outArgument_outLexiqueComponentRoot  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 804)) ;
    {
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedLexiqueComponentMap.modifier_insertKey (var_key, outArgument_outLexiqueComponentRoot, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 805)) ;
    }
  }
}
...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_componentName = constinArgument_inLexiqueComponentRoot.reader_mLexiqueComponentName (SOURCE_FILE ("lexiqueCompilation.gSemantics", 819)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_componentName.reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 820)).objectCompare (constinArgument_inComponentNameFromSourceFilePath)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (var_componentName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_componentName.reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 822))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 822)).operator_concat (GALGAS_string ("') against the source file base name ('")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 822)).operator_concat (constinArgument_inComponentNameFromSourceFilePath  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 823)).operator_concat (GALGAS_string ("'): they should be identical")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 823))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 821)) ;
  }
  GALGAS_lexicalTypeMap var_lexicalTypeMap = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 827)) ;
  GALGAS_lexicalRoutineMap var_lexicalRoutineMap ;
  {
  routine_buildLexicalRoutineMap (var_lexicalRoutineMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 830)) ;
  }
  cEnumerator_externRoutineListAST enumerator_34871 (constinArgument_inLexiqueComponentRoot.reader_mExternRoutineList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 832)), kEnumeration_up) ;
  while (enumerator_34871.hasCurrentObject ()) {
    GALGAS_lexicalRoutineFormalArgumentList var_lexicalRoutineFormalArgumentList = GALGAS_lexicalRoutineFormalArgumentList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 833)) ;
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_35005 (enumerator_34871.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_35005.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_35005.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 836)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_35005.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_35005.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 837))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 837)) ;
      enumerator_35005.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_34871.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_34871.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 839)) ;
    }
    enumerator_34871.gotoNextObject () ;
  }
  GALGAS_lexicalFunctionMap var_lexicalFunctionMap ;
  {
  routine_buildLexicalFunctionMap (var_lexicalFunctionMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 843)) ;
  }
  cEnumerator_externFunctionListAST enumerator_35675 (constinArgument_inLexiqueComponentRoot.reader_mExternFunctionList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 845)), kEnumeration_up) ;
  while (enumerator_35675.hasCurrentObject ()) {
    GALGAS_lexicalFunctionFormalArgumentList var_lexicalFunctionFormalArgumentList = GALGAS_lexicalFunctionFormalArgumentList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 846)) ;
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_35812 (enumerator_35675.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_35812.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_35812.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 849)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_35812.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 850))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 850)) ;
      enumerator_35812.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_35675.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 853)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_35675.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 854)) ;
    }
    enumerator_35675.gotoNextObject () ;
  }
  GALGAS_stringset temp_2 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 869)) ;
  temp_2.addAssign_operation (GALGAS_string ("unicodeToLower")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 858)) ;
  ...
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeLetter")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 861)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeMark")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 862)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeNumber")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 863)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeDecimalDigit")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 864)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeASCIIHexDigit")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 865)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeSeparator")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 866)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeCommand")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 867)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodePunctuation")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 868)) ;
  temp_2.addAssign_operation (GALGAS_string ("isUnicodeSymbol")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 869)) ;
  GALGAS_stringset var_externUnicodeTestFunctions = temp_2 ;
  GALGAS_lexiqueAnalysisContext var_lexiqueAnalysisContext = GALGAS_lexiqueAnalysisContext::constructor_new (var_lexicalRoutineMap, var_lexicalFunctionMap, GALGAS_lexicalMessageMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 875)), GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 876)), GALGAS_terminalList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 877)), GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 878)), GALGAS_lexicalExplicitTokenListMapMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 879)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 880)), GALGAS_templateDelimitorList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 881)), GALGAS_styleMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 882)), var_externUnicodeTestFunctions COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 872)) ;
  GALGAS_uint var_styleIndex = GALGAS_uint ((uint32_t) 1U) ;
  cEnumerator_lexicalStyleListAST enumerator_37324 (constinArgument_inLexiqueComponentRoot.reader_mLexicalStyleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 887)), kEnumeration_up) ;
  while (enumerator_37324.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_37324.current_mName (HERE), enumerator_37324.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 888)) ;
    }
    var_styleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 889)) ;
    enumerator_37324.gotoNextObject () ;
  }
  {
  routine_buildLexicalAttributeMap (var_lexicalTypeMap, constinArgument_inLexiqueComponentRoot.reader_mLexicalAttributeList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 894)), var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 892)) ;
  }
  cEnumerator_terminalDeclarationListAST enumerator_37786 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 898)), kEnumeration_up) ;
  while (enumerator_37786.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, enumerator_37786.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 900)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 900)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_lstring joker_37928_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 901)).method_searchKey (enumerator_37786.current_mStyle (HERE), joker_37928_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 901)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 903)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_38053 (enumerator_37786.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_38053.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_38053.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 906)) ;
      var_argumentTypeList.addAssign_operation (enumerator_38053.current_mFormalSelector (HERE), enumerator_38053.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 907)) ;
      enumerator_38053.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_37786.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 909)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_38497 (enumerator_37786.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_38497.hasCurrentObject ()) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_38497.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 913)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        const enumGalgasBool test_5 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_5) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_5) {
          GALGAS_location location_6 (enumerator_38497.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 917)) ;
        }
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_38497.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 919)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_location location_8 (enumerator_38497.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 920)) ;
        }else if (kBoolFalse == test_7) {
          const enumGalgasBool test_9 = var_isEndOfTemplateMark.boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_38497.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 922)) ;
    ...
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_37786.current_mName (HERE), var_argumentTypeList, enumerator_37786.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 930)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 927)) ;
    enumerator_37786.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_39354 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 936)), kEnumeration_up) ;
  while (enumerator_39354.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, enumerator_39354.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 938)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 938)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_lstring joker_39496_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 939)).method_searchKey (enumerator_39354.current_mStyle (HERE), joker_39496_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 939)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 941)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_39621 (enumerator_39354.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_39621.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_39621.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 944)) ;
      var_argumentTypeList.addAssign_operation (enumerator_39621.current_mFormalSelector (HERE), enumerator_39621.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 945)) ;
      enumerator_39621.gotoNextObject () ;
    }
    GALGAS_lexicalExplicitTokenListMap var_lexicalTokenListMap = GALGAS_lexicalExplicitTokenListMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 947)) ;
    GALGAS_tokenSortedlist var_tokenSortedlist = GALGAS_tokenSortedlist::constructor_emptySortedList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 948)) ;
    cEnumerator_lexicalListEntryListAST enumerator_40028 (enumerator_39354.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_40028.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_39354.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 950)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_40028.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 950)), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 950)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_40274 (enumerator_40028.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_40274.hasCurrentObject ()) {
        const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_40274.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 954)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_12) {
          const enumGalgasBool test_13 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_13) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_13) {
            GALGAS_location location_14 (enumerator_40274.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_14, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 958)) ;
          }
        }else if (kBoolFalse == test_12) {
          const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_40274.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 960)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_15) {
            GALGAS_location location_16 (enumerator_40274.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_16, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 961)) ;
          }else if (kBoolFalse == test_15) {
            const enumGalgasBool test_17 = var_isEndOfTemplateMark.boolEnum () ;
            if (kBoolTrue == test_17) {
              GALGAS_location location_18 (enumerator_40274.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_18, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 963)) ;
      ...
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_40028.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 968)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_40028.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 976)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_40028.current_mEntrySpelling (HERE), enumerator_40028.current_mTerminalSpelling (HERE), enumerator_40028.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 977)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_40028.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 978)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 978)), enumerator_40028.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 978)), enumerator_40028.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 978))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 978)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_40028.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 979))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 979)) ;
      enumerator_40028.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_39354.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 981)) ;
    }
    enumerator_39354.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_41760 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 984)), kEnumeration_up) ;
  while (enumerator_41760.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_41760.current_mMessageName (HERE), enumerator_41760.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 985)) ;
    }
    enumerator_41760.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_41983 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 988)), kEnumeration_up) ;
  while (enumerator_41983.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_41983.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 989)) ;
    enumerator_41983.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_42185 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 992)), kEnumeration_up) ;
  while (enumerator_42185.hasCurrentObject ()) {
    const enumGalgasBool test_19 = enumerator_42185.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("lexiqueCompilation.gSemantics", 993)).boolEnum () ;
    if (kBoolTrue == test_19) {
      GALGAS_location location_20 (enumerator_42185.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_20, GALGAS_string ("unused message")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 994)) ;
    }
    enumerator_42185.gotoNextObject () ;
  }
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_42405 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 998)), kEnumeration_up) ;
  while (enumerator_42405.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_42405.current_mStartString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 999))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 999)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_42405.current_mEndString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1000))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1000)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_42633 (enumerator_42405.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_42633.hasCurrentObject ()) {
      const enumGalgasBool test_21 = GALGAS_bool (kIsNotEqual, enumerator_42633.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1003)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_42633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_22, GALGAS_string ("only the 'preserved' feature is allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1004)) ;
      }else if (kBoolFalse == test_21) {
        const enumGalgasBool test_23 = var_preservesStartDelimiter.boolEnum () ;
        if (kBoolTrue == test_23) {
          GALGAS_location location_24 (enumerator_42633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_24, GALGAS_string ("the 'preserved' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1006)) ;
    ...
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_42405.current_mStartString (HERE), enumerator_42405.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1011)) ;
    enumerator_42405.gotoNextObject () ;
  }
  const enumGalgasBool test_25 = constinArgument_inLexiqueComponentRoot.reader_mIndexingDirectory (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1014)).mAttribute_location.reader_isNowhere (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1014)).boolEnum () ;
  if (kBoolTrue == test_25) {
    cEnumerator_indexingListAST enumerator_43247 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1015)), kEnumeration_up) ;
    while (enumerator_43247.hasCurrentObject ()) {
      GALGAS_location location_26 (enumerator_43247.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("indexing declaration requires one 'indexing in \"path\";' declaration")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1016)) ;
      enumerator_43247.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1019)) ;
  cEnumerator_indexingListAST enumerator_43469 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1020)), kEnumeration_up) ;
  while (enumerator_43469.hasCurrentObject ()) {
    const enumGalgasBool test_27 = var_indexNameSet.reader_hasKey (enumerator_43469.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1021)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1021)).boolEnum () ;
    if (kBoolTrue == test_27) {
      GALGAS_location location_28 (enumerator_43469.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_28, GALGAS_string ("the '").operator_concat (enumerator_43469.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1022))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1022)).operator_concat (GALGAS_string ("' index is already declared")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1022))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1022)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_43469.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1024))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1024)) ;
    enumerator_43469.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_43802 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1027)), kEnumeration_up) ;
  while (enumerator_43802.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43802.current_mMatchString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1028))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1028)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43802.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1029))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1029)) ;
    enumerator_43802.gotoNextObject () ;
  }
  GALGAS_string var_lexiqueClassName = var_componentName.reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1033)) ;
  const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1035)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_lexiqueClassName.operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1038)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1042)), var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentRoot COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1041))), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1048)), constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1049)), var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1051)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1047))), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1036)) ;
    }
  }
  const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1056)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_lexiqueClassName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1059)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1063)), var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1064)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1065)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1066)), var_lexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1067)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1068)), constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1069)), var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentRoot COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1062))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1057)) ;
    }
  }
  const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1078)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_lexiqueClassName.operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1081)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1084))), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_33_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1089))), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1079)) ;
    }
  }
  const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1096)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_lexiqueClassName.operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1099)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, var_lexiqueClassName.operator_concat (GALGAS_string ("-cocoa")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1103)), var_lexiqueClassName, var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1105)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1106)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1107)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1108)), constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1109)), var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentRoot COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1102))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1097)) ;
    }
  }
}
...
void routine_compileLexiqueComponentFromSource (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  {
  routine_parseLexiqueComponent (constinArgument_inSourceFile, ioArgument_ioParsedComponentStruct, var_lexiqueComponentRoot, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1129)) ;
  }
  {
  routine_compileLexiqueComponentFromAST (constinArgument_inSourceFile.reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1135)).reader_lastPathComponent (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1135)).reader_stringByDeletingPathExtension (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1135)), constinArgument_inOutputDirectory, var_lexiqueComponentRoot, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1134)) ;
  }
}
...
void routine_compileLexiqueComponentGalgas_33_ (const GALGAS_galgas_33_LexiqueComponentListAST_2D_element constinArgument_inLexiqueComponentAST,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalTypeMap var_lexicalTypeMap = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1160)) ;
  GALGAS_lexicalRoutineMap var_lexicalRoutineMap ;
  {
  routine_buildLexicalRoutineMap (var_lexicalRoutineMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1163)) ;
  }
  cEnumerator_externRoutineListAST enumerator_48812 (constinArgument_inLexiqueComponentAST.mAttribute_mExternRoutineList, kEnumeration_up) ;
  while (enumerator_48812.hasCurrentObject ()) {
    GALGAS_lexicalRoutineFormalArgumentList var_lexicalRoutineFormalArgumentList = GALGAS_lexicalRoutineFormalArgumentList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1166)) ;
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_48946 (enumerator_48812.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_48946.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_48946.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1169)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_48946.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_48946.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1170))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1170)) ;
      enumerator_48946.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_48812.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_48812.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1172)) ;
    }
    enumerator_48812.gotoNextObject () ;
  }
  GALGAS_lexicalFunctionMap var_lexicalFunctionMap ;
  {
  routine_buildLexicalFunctionMap (var_lexicalFunctionMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1176)) ;
  }
  cEnumerator_externFunctionListAST enumerator_49614 (constinArgument_inLexiqueComponentAST.mAttribute_mExternFunctionList, kEnumeration_up) ;
  while (enumerator_49614.hasCurrentObject ()) {
    GALGAS_lexicalFunctionFormalArgumentList var_lexicalFunctionFormalArgumentList = GALGAS_lexicalFunctionFormalArgumentList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1179)) ;
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_49751 (enumerator_49614.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_49751.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_49751.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1182)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_49751.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1183))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1183)) ;
      enumerator_49751.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_49614.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1186)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_49614.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1187)) ;
    }
    enumerator_49614.gotoNextObject () ;
  }
  GALGAS_stringset temp_0 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1202)) ;
  temp_0.addAssign_operation (GALGAS_string ("unicodeToLower")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1191)) ;
  temp_0.addAssign_operation (GALGAS_string ("unicodeToUpper")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1192)) ;
  temp_0.addAssign_operation (GALGAS_string ("unicodeToUpper")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1193)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeLetter")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1194)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeMark")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1195)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeNumber")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1196)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeDecimalDigit")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1197)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeASCIIHexDigit")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1198)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeSeparator")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1199)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeCommand")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1200)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodePunctuation")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1201)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeSymbol")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1202)) ;
  GALGAS_stringset var_externUnicodeTestFunctions = temp_0 ;
  GALGAS_lexiqueAnalysisContext var_lexiqueAnalysisContext = GALGAS_lexiqueAnalysisContext::constructor_new (var_lexicalRoutineMap, var_lexicalFunctionMap, GALGAS_lexicalMessageMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1208)), GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1209)), GALGAS_terminalList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1210)), GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1211)), GALGAS_lexicalExplicitTokenListMapMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1212)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1213)), GALGAS_templateDelimitorList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1214)), GALGAS_styleMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1215)), var_externUnicodeTestFunctions COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1205)) ;
  GALGAS_uint var_styleIndex = GALGAS_uint ((uint32_t) 1U) ;
  cEnumerator_lexicalStyleListAST enumerator_51261 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalStyleList, kEnumeration_up) ;
  while (enumerator_51261.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_51261.current_mName (HERE), enumerator_51261.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1221)) ;
    }
    var_styleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1222)) ;
    enumerator_51261.gotoNextObject () ;
  }
  {
  routine_buildLexicalAttributeMap (var_lexicalTypeMap, constinArgument_inLexiqueComponentAST.mAttribute_mLexicalAttributeList, var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1225)) ;
  }
  cEnumerator_terminalDeclarationListAST enumerator_51719 (constinArgument_inLexiqueComponentAST.mAttribute_mTerminalDeclarationList, kEnumeration_up) ;
  while (enumerator_51719.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, enumerator_51719.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1233)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1233)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_lstring joker_51861_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1234)).method_searchKey (enumerator_51719.current_mStyle (HERE), joker_51861_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1234)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1236)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_51986 (enumerator_51719.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_51986.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_51986.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1239)) ;
      var_argumentTypeList.addAssign_operation (enumerator_51986.current_mFormalSelector (HERE), enumerator_51986.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1240)) ;
      enumerator_51986.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_51719.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1242)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_52430 (enumerator_51719.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_52430.hasCurrentObject ()) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_52430.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1246)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_3) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_3) {
          GALGAS_location location_4 (enumerator_52430.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_4, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1250)) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_52430.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1252)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_location location_6 (enumerator_52430.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1253)) ;
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = var_isEndOfTemplateMark.boolEnum () ;
          if (kBoolTrue == test_7) {
            GALGAS_location location_8 (enumerator_52430.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_8, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1255)) ;
          }else if (kBoolFalse == test_7) {
            var_isEndOfTemplateMark = GALGAS_bool (true) ;
          }
        }
    ...
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_51719.current_mName (HERE), var_argumentTypeList, enumerator_51719.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1263)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1260)) ;
    enumerator_51719.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_53285 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalListDeclarationList, kEnumeration_up) ;
  while (enumerator_53285.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, enumerator_53285.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1271)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1271)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_lstring joker_53427_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1272)).method_searchKey (enumerator_53285.current_mStyle (HERE), joker_53427_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1272)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1274)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_53552 (enumerator_53285.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_53552.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_53552.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1277)) ;
      var_argumentTypeList.addAssign_operation (enumerator_53552.current_mFormalSelector (HERE), enumerator_53552.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1278)) ;
      enumerator_53552.gotoNextObject () ;
    }
    GALGAS_lexicalExplicitTokenListMap var_lexicalTokenListMap = GALGAS_lexicalExplicitTokenListMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1280)) ;
    GALGAS_tokenSortedlist var_tokenSortedlist = GALGAS_tokenSortedlist::constructor_emptySortedList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1281)) ;
    cEnumerator_lexicalListEntryListAST enumerator_53959 (enumerator_53285.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_53959.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_53285.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1283)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_53959.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1283)), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1283)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_54205 (enumerator_53959.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_54205.hasCurrentObject ()) {
        const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_54205.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1287)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_10) {
          const enumGalgasBool test_11 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_11) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_11) {
            GALGAS_location location_12 (enumerator_54205.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_12, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1291)) ;
          }
        }else if (kBoolFalse == test_10) {
          const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_54205.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1293)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_13) {
            GALGAS_location location_14 (enumerator_54205.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_14, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1294)) ;
          }else if (kBoolFalse == test_13) {
            const enumGalgasBool test_15 = var_isEndOfTemplateMark.boolEnum () ;
            if (kBoolTrue == test_15) {
              GALGAS_location location_16 (enumerator_54205.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_16, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1296)) ;
            }else if (kBoolFalse == test_15) {
              var_isEndOfTemplateMark = GALGAS_bool (true) ;
            }
          }
      ...
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_53959.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1301)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_53959.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1309)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_53959.current_mEntrySpelling (HERE), enumerator_53959.current_mTerminalSpelling (HERE), enumerator_53959.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1310)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_53959.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1311)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1311)), enumerator_53959.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1311)), enumerator_53959.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1311))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1311)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_53959.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1312))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1312)) ;
      enumerator_53959.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_53285.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314)) ;
    }
    enumerator_53285.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_55689 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalMessageDeclarationList, kEnumeration_up) ;
  while (enumerator_55689.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_55689.current_mMessageName (HERE), enumerator_55689.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1318)) ;
    }
    enumerator_55689.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_55910 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, kEnumeration_up) ;
  while (enumerator_55910.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_55910.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1322)) ;
    enumerator_55910.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_56112 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1325)), kEnumeration_up) ;
  while (enumerator_56112.hasCurrentObject ()) {
    const enumGalgasBool test_17 = enumerator_56112.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1326)).boolEnum () ;
    if (kBoolTrue == test_17) {
      GALGAS_location location_18 (enumerator_56112.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_18, GALGAS_string ("unused message")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1327)) ;
    }
    enumerator_56112.gotoNextObject () ;
  }
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_56330 (constinArgument_inLexiqueComponentAST.mAttribute_mTemplateDelimitorList, kEnumeration_up) ;
  while (enumerator_56330.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_56330.current_mStartString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1332))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1332)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_56330.current_mEndString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1333))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1333)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_56558 (enumerator_56330.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_56558.hasCurrentObject ()) {
      const enumGalgasBool test_19 = GALGAS_bool (kIsNotEqual, enumerator_56558.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1336)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_19) {
        GALGAS_location location_20 (enumerator_56558.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_20, GALGAS_string ("only the 'preserved' feature is allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1337)) ;
      }else if (kBoolFalse == test_19) {
        const enumGalgasBool test_21 = var_preservesStartDelimiter.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_56558.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("the 'preserved' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1339)) ;
        }else if (kBoolFalse == test_21) {
          var_preservesStartDelimiter = GALGAS_bool (true) ;
        }
      }
    ...
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_56330.current_mStartString (HERE), enumerator_56330.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1344)) ;
    enumerator_56330.gotoNextObject () ;
  }
  const enumGalgasBool test_23 = constinArgument_inLexiqueComponentAST.mAttribute_mIndexingDirectory.mAttribute_location.reader_isNowhere (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1347)).boolEnum () ;
  if (kBoolTrue == test_23) {
    cEnumerator_indexingListAST enumerator_57168 (constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST, kEnumeration_up) ;
    while (enumerator_57168.hasCurrentObject ()) {
      GALGAS_location location_24 (enumerator_57168.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_24, GALGAS_string ("indexing declaration requires one 'indexing in \"path\";' declaration")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1349)) ;
      enumerator_57168.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1352)) ;
  cEnumerator_indexingListAST enumerator_57388 (constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST, kEnumeration_up) ;
  while (enumerator_57388.hasCurrentObject ()) {
    const enumGalgasBool test_25 = var_indexNameSet.reader_hasKey (enumerator_57388.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1354)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1354)).boolEnum () ;
    if (kBoolTrue == test_25) {
      GALGAS_location location_26 (enumerator_57388.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("the '").operator_concat (enumerator_57388.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1355))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1355)).operator_concat (GALGAS_string ("' index is already declared")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1355))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1355)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_57388.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1357))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1357)) ;
    enumerator_57388.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_57719 (constinArgument_inLexiqueComponentAST.mAttribute_mTemplateReplacementList, kEnumeration_up) ;
  while (enumerator_57719.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_57719.current_mMatchString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1361))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1361)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_57719.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1362))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1362)) ;
    enumerator_57719.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1366)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_27) {
    ...
    GALGAS_string var_headerContents = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1370)), var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1369))) ;
    var_headerContents.dotAssign_operation (GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1375)), constinArgument_inLexiqueComponentAST.mAttribute_mLexicalListDeclarationList, var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1374)))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1374)) ;
    GALGAS_string var_cppContents = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1382)), var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1383)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1384)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1385)), var_lexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1386)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1387)), constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1381))) ;
    GALGAS_string var_cocoaHeader = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1393))) ;
    var_cocoaHeader.dotAssign_operation (GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_33_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1397)))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1397)) ;
    GALGAS_string var_cocoaImplementation = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1403)).add_operation (GALGAS_string ("-cocoa"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1403)), var_lexiqueClassName, var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1405)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1406)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1407)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1408)), constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1402))) ;
    ioArgument_ioLexiqueComponentGenerationList.addAssign_operation (var_lexiqueClassName, var_headerContents, var_cppContents, var_cocoaHeader, var_cocoaImplementation  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1414)) ;
  }
}
...
void routine_generateLexiqueComponentsGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1434)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lexiqueComponentGenerationList enumerator_60700 (constinArgument_inLexiqueComponentGenerationList, kEnumeration_up) ;
    while (enumerator_60700.hasCurrentObject ()) {
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1437)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1437))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1437)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1440)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1440)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_60700.current_mCppHeaderContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1438)) ;
      }
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1448)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1448))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1448)) ;
      ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1449)).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1449))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1449)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1452)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1452)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_60700.current_mCppContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1450)) ;
      }
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1460)).operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1460))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1460)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1463)).operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1463)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_60700.current_mCocoaHeaderContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1461)) ;
      }
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1472)).operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1472))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1472)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (enumerator_60700.current_mLexiqueComponentName (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1475)).operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1475)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_60700.current_mCocoaContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1473)) ;
      }
