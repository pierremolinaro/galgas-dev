...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_STRINGS_5F_IN_5F_EXPLICIT_5F_RULES.isValid ()) {
    ...
    while (enumerator_5600.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5600.current_key (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (119)).stringValue () ;
      result << "$'\n"
      ...
      result << " [] = " ;
      result << enumerator_5600.current_key (HERE).reader_utf_33__32_Representation (SOURCE_FILE_AT_LINE (120)).stringValue () ;
      result << " ;\n" ;
  ...
  result << "\n" ;
  GALGAS_uint index_5851_ (0) ;
  if (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP.isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5851 (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP, kEnumeration_up) ;
    while (enumerator_5851.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "//                                                                             *\n"
        "//             Key words table '" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (127)).stringValue () ;
      result << "'                            *\n"
        "//                                                                             *\n"
        "//-----------------------------------------------------------------------------*\n"
        "\n"
        "static const int32_t ktable_size_" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << " = " ;
      result << enumerator_5851.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (130)).reader_string (SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << " [ktable_size_" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (131)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_6616_ (0) ;
      if (enumerator_5851.current_mTokenSortedList (HERE).isValid ()) {
        cEnumerator_tokenSortedlist enumerator_6616 (enumerator_5851.current_mTokenSortedList (HERE), kEnumeration_up) ;
        while (enumerator_6616.hasCurrentObject ()) {
          result << "  C_unicode_lexique_table_entry (kUnicodeString_" ;
          result << enumerator_6616.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (133)).stringValue () ;
          result << ", " ;
          result << enumerator_6616.current_mLength (HERE).reader_string (SOURCE_FILE_AT_LINE (133)).stringValue () ;
          result << ", C_Lexique_" ;
          result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
          result << "::kToken_" ;
          result << enumerator_6616.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (133)).stringValue () ;
          result << ")" ;
          if (enumerator_6616.hasNextObject ()) {
            result << ",\n" ;
          }
      ...
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::search_into_" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (137)).stringValue () ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).stringValue () ;
      result << ", ktable_size_" ;
      result << enumerator_5851.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).stringValue () ;
      result << ") ;\n"
        "}\n"
        "\n" ;
      index_5851_.increment () ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_terminalList enumerator_7948 (in_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_7948.hasCurrentObject ()) {
      result << "    case kToken_" ;
      result << enumerator_7948.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (159)).stringValue () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << enumerator_7948.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (161)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (161)).stringValue () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
      GALGAS_uint index_8278_ (0) ;
      if (enumerator_7948.current_mSentAttributeList (HERE).isValid ()) {
        cEnumerator_lexicalSentValueList enumerator_8278 (enumerator_7948.current_mSentAttributeList (HERE), kEnumeration_up) ;
        while (enumerator_8278.hasCurrentObject ()) {
          result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
            "      s." ;
          result << categoryReader_appendMethodName (enumerator_8278.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (165)).stringValue () ;
          result << " (ptr->mLexicalAttribute_" ;
          result << enumerator_8278.current_mLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (165)).stringValue () ;
          result << categoryReader_appendArgumentOfMethod (enumerator_8278.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (165)).stringValue () ;
          result << ") ;\n" ;
          index_8278_.increment () ;
  ...
  result << "    default:\n"
    ...
    "//-----------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_9242_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (182)).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_9242 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (182)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_9242 = enumerator_9242.hasCurrentObject () ;
    if (nonEmpty_enumerator_9242) {
      result << "static const cTemplateDelimiter kTemplateDefinitionArray [" ;
      result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (183)).reader_length (SOURCE_FILE_AT_LINE (183)).reader_string (SOURCE_FILE_AT_LINE (183)).stringValue () ;
      result << "] = {\n" ;
    }
    while (enumerator_9242.hasCurrentObject ()) {
      result << "  cTemplateDelimiter (kUnicodeString_" ;
      result << enumerator_9242.current_mStartString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (184)).stringValue () ;
      result << ", " ;
      result << enumerator_9242.current_mStartString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (184)).reader_string (SOURCE_FILE_AT_LINE (184)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_9242.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (185)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "NULL, 0," ;
      }else if (kBoolFalse == test_2) {
        result << "kUnicodeString_" ;
        result << enumerator_9242.current_mEndString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (188)).stringValue () ;
        result << ", " ;
        result << enumerator_9242.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (188)).reader_string (SOURCE_FILE_AT_LINE (188)).stringValue () ;
        result << "," ;
      }
      result << " NULL, " ;
      result << enumerator_9242.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (191)).reader_cString (SOURCE_FILE_AT_LINE (191)).stringValue () ;
      result << ")" ;
      if (enumerator_9242.hasNextObject ()) {
        result << ",\n" ;
      }
      index_9242_.increment () ;
  ...
  result << "\n"
    ...
    "//-----------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_10292_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (203)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_10292 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (203)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_10292 = enumerator_10292.hasCurrentObject () ;
    if (nonEmpty_enumerator_10292) {
      result << "static const cTemplateDelimiter kTemplateReplacementArray [" ;
      result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (204)).reader_length (SOURCE_FILE_AT_LINE (204)).reader_string (SOURCE_FILE_AT_LINE (204)).stringValue () ;
      result << "] = {\n" ;
    }
    while (enumerator_10292.hasCurrentObject ()) {
      result << "  cTemplateDelimiter (kUnicodeString_" ;
      result << enumerator_10292.current_mMatchString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (206)).stringValue () ;
      result << ", " ;
      result << enumerator_10292.current_mMatchString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (206)).reader_string (SOURCE_FILE_AT_LINE (206)).stringValue () ;
      result << ", kUnicodeString_" ;
      result << enumerator_10292.current_mReplacementString (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", " ;
      result << enumerator_10292.current_mReplacementString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (207)).reader_string (SOURCE_FILE_AT_LINE (207)).stringValue () ;
      result << ", " ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_10292.current_mReplacementFunction (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (208)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "NULL" ;
      }else if (kBoolFalse == test_3) {
        result << "scanner_routine_" ;
        result << enumerator_10292.current_mReplacementFunction (HERE).reader_string (SOURCE_FILE_AT_LINE (211)).stringValue () ;
      }
      result << ", true)" ;
      if (enumerator_10292.hasNextObject ()) {
        result << ",\n" ;
      }
      index_10292_.increment () ;
  ...
  result << "\n"
    ...
    "//-----------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (224)).reader_length (SOURCE_FILE_AT_LINE (224)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_uint index_11417_ (0) ;
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (225)).isValid ()) {
      cEnumerator_terminalList enumerator_11417 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (225)), kEnumeration_up) ;
      const bool nonEmpty_enumerator_11417 = enumerator_11417.hasCurrentObject () ;
      if (nonEmpty_enumerator_11417) {
      ...
      while (enumerator_11417.hasCurrentObject ()) {
        result << "  " ;
        result << enumerator_11417.current_mIsEndOfTemplateMark (HERE).reader_cString (SOURCE_FILE_AT_LINE (227)).stringValue () ;
        result << " /* " ;
        result << enumerator_11417.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (227)).stringValue () ;
        result << " */" ;
        if (enumerator_11417.hasNextObject ()) {
          result << ",\n" ;
        }
        index_11417_.increment () ;
  ...
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (246)).reader_length (SOURCE_FILE_AT_LINE (246)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    ...
    result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (260)).reader_length (SOURCE_FILE_AT_LINE (260)).reader_string (SOURCE_FILE_AT_LINE (260)).stringValue () ;
    result << ") ;\n"
    ...
    result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (276)).reader_length (SOURCE_FILE_AT_LINE (276)).reader_string (SOURCE_FILE_AT_LINE (276)).stringValue () ;
    result << ") ;\n"
    ...
    GALGAS_uint index_14541_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_14541 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_14541.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_14541.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (284)).stringValue () ;
        result << categoryReader_initialization (enumerator_14541.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (284)).stringValue () ;
        result << " ;\n" ;
        index_14541_.increment () ;
    ...
    GALGAS_uint index_14762_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_14762 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_14762.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_14762.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (291)).stringValue () ;
        index_14762_.increment () ;
        enumerator_14762.gotoNextObject () ;
      }
    }
    if (GALGAS_uint ((uint32_t) 8U).isValid ()) {
      result.incIndentation (- ((int32_t) GALGAS_uint ((uint32_t) 8U).uintValue ())) ;
    ...
    GALGAS_uint index_15468_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_15468 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_15468.hasCurrentObject ()) {
        result << "    token.mLexicalAttribute_" ;
        result << enumerator_15468.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (309)).stringValue () ;
        result << categoryReader_initialization (enumerator_15468.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (309)).stringValue () ;
        result << " ;\n" ;
        index_15468_.increment () ;
    ...
    GALGAS_uint index_15689_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_15689 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_15689.hasCurrentObject ()) {
        result << callCategoryReader_generateCode ((const cPtr_abstractLexicalRuleAST *) enumerator_15689.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_IDENTIFIER, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (316)).stringValue () ;
        index_15689_.increment () ;
  ...
  GALGAS_uint index_17247_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17247 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17247.hasCurrentObject ()) {
      result << "  ptr->mLexicalAttribute_" ;
      result << enumerator_17247.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (351)).stringValue () ;
  ...
  result << "  enterTokenFromPointer (ptr) ;\n"
    ...
    "//                                                                             *\n" ;
  GALGAS_uint index_17791_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_17791 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_17791.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_17791.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (363)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
      result << enumerator_17791.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (363)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      ...
      result << enumerator_17791.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (365)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n" ;
      index_17791_.increment () ;
  ...
  result << "//-----------------------------------------------------------------------------*\n"
    ...
    "//                                                                             *\n" ;
  GALGAS_uint index_18586_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_18586 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_18586.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18586.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (375)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (375)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      result << enumerator_18586.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (375)).stringValue () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18586.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (379)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (379)).stringValue () ;
      result << " value (ptr->mLexicalAttribute_" ;
      result << enumerator_18586.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (379)).stringValue () ;
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18586.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (380)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (380)).stringValue () ;
      result << " result (value, currentLocation) ;\n"
        "  return result ;\n"
        "}\n"
        "\n" ;
      index_18586_.increment () ;
  ...
  GALGAS_uint index_20079_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (392)).isValid ()) {
    cEnumerator_terminalList enumerator_20079 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (392)), kEnumeration_up) ;
    while (enumerator_20079.hasCurrentObject ()) {
      result << "  result.addAssign_operation (GALGAS_string (" ;
      result << enumerator_20079.current_mTerminalName (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (393)).stringValue () ;
      result << ") COMMA_THERE) ;\n" ;
      index_20079_.increment () ;
