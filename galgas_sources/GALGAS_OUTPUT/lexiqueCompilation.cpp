...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (kBoolTrue == test_6) {
    ...
    GALGAS_uint index_8231_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8231 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8231.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8231.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8231.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8231.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)).stringValue () ;
        result << " ;\n" ;
        index_8231_.increment () ;
    ...
    GALGAS_uint index_8447_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8447 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8447.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8447.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)).stringValue () ;
        index_8447_.increment () ;
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_9084 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_9084.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_9084.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_9084.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_9084.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).stringValue () ;
        result << " ;\n" ;
    ...
    GALGAS_uint index_9298_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_9298 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_9298.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_9298.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (199)).stringValue () ;
        index_9298_.increment () ;
  ...
  result << "] = {0" ;
  GALGAS_uint index_11888_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (253)).isValid ()) {
    cEnumerator_terminalList enumerator_11888 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (253)), kEnumeration_up) ;
    while (enumerator_11888.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11888.current_mStyleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11888.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (254)).stringValue () ;
      result << " */" ;
      index_11888_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (267)).isValid ()) {
    cEnumerator_terminalList enumerator_12705 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (267)), kEnumeration_up) ;
    while (enumerator_12705.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_12705.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_12705.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (268)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13678 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (284)), kEnumeration_up) ;
    while (enumerator_13678.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13678.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (285)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (285)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_14602 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (303)), kEnumeration_up) ;
    while (enumerator_14602.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14602.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (304)).stringValue () ;
      result << "\"" ;
