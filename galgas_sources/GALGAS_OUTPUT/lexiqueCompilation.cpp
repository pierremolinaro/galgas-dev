...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  while (enumerator_37815.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_3) {
      GALGAS_lstring joker_37957 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 903)).method_searchKey (enumerator_37815.current_mStyle (HERE), joker_37957, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 903)) ;
    }
  ...
  while (enumerator_39383.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_11) {
      GALGAS_lstring joker_39525 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 941)).method_searchKey (enumerator_39383.current_mStyle (HERE), joker_39525, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 941)) ;
    }
...
static void categoryMethod_lexicalSendTerminalByDefaultAST_checkLexicalDefaultAction (const cPtr_lexicalSendDefaultActionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_6897 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 154)).method_searchKey (object->mAttribute_mDefaultSentTerminal, joker_6897, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 154)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lexicalStructuredSendInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_22552.hasCurrentObject ()) {
    ...
    GALGAS_lexicalTypeEnum joker_22752 ; // Joker input parameter
    ioArgument_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 541)).method_searchKey (enumerator_22552.current_mAttributeName (HERE), joker_22752, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 541)) ;
...
static void categoryMethod_lexicalSimpleSendInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_23183 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 552)).method_searchKey (object->mAttribute_mSentTerminal, joker_23183, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 552)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lexicalRoutineInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_bool joker_25243 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalRoutineMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 601)).method_searchKey (object->mAttribute_mRoutineName, var_lexicalRoutineFormalArgumentList, var_routineErrorMessageList, joker_25243, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 601)) ;
...
static void categoryMethod_lexicalRewindInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_27253 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 653)).method_searchKey (object->mAttribute_mTerminalName, joker_27253, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 653)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lexicalDropInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  GALGAS_lexicalSentValueList joker_27578 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 662)).method_searchKey (object->mAttribute_mTerminalName, joker_27578, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 662)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lexicalImplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  GALGAS_lexicalExplicitTokenListMap joker_29228 ; // Joker input parameter
  GALGAS_tokenSortedlist joker_29231 ; // Joker input parameter
  GALGAS_bool joker_29234 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 705)).method_searchKey (object->mAttribute_mListName, joker_29228, joker_29231, joker_29234, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 705)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
