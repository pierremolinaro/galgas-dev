...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_5450 (var_cas_LEXICAL_TOKEN_LIST_MAP, true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_5450 = NULL ;
    while (((operand_5450 = enumerator_5450.nextObject ()))) {
      macroValidPointer (operand_5450) ;
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const PMSInt32 ktable_size_" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " = " ;
      result << operand_5450->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (129)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << " [ktable_size_" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << "] = {\n" ;
      GGS_tokenSortedlist::cEnumerator enumerator_6204 (operand_5450->mInfo.mTokenSortedList, true) ;
      const GGS_tokenSortedlist::cElement * operand_6204 = NULL ;
      while (((operand_6204 = enumerator_6204.nextObject ()))) {
        macroValidPointer (operand_6204) ;
        result << "  {kUnicodeString_" ;
        result << operand_6204->mName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << ", " ;
        result << operand_6204->mLength.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << ", " ;
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "::" ;
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "_1_" ;
        result << operand_6204->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << "}" ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::search_into_" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      result << ", ktable_size_" ;
      result << operand_5450->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      result << ") ;\n"
        "}\n"
    ...
    result << "_1_:\n"
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7499 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7499 = NULL ;
    while (((operand_7499 = enumerator_7499.nextObject ()))) {
      macroValidPointer (operand_7499) ;
      result << "    case " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7499->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7499->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7813 (operand_7499->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7813 = NULL ;
      while (((operand_7813 = enumerator_7813.nextObject ()))) {
        macroValidPointer (operand_7813) ;
        result << "      s." ;
        result << operand_7813->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7813->mAttributeName ;
        result << operand_7813->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8518 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8518 = NULL ;
    if (enumerator_8518.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_8518 = enumerator_8518.nextObject ()))) {
        macroValidPointer (operand_8518) ;
        result << "  {kUnicodeString_" ;
        result << operand_8518->mStartString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        result << operand_8518->mStartString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        if ((operand_8518->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8518->mEndString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << ", " ;
          result << operand_8518->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8518->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
        result << "}" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9541 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
    const GGS_templateReplacementList::cElement * operand_9541 = NULL ;
    if (enumerator_9541.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_9541 = enumerator_9541.nextObject ()))) {
        macroValidPointer (operand_9541) ;
        result << "  {kUnicodeString_" ;
        result << operand_9541->mMatchString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", " ;
        result << operand_9541->mMatchString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", kUnicodeString_" ;
        result << operand_9541->mReplacementString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        result << operand_9541->mReplacementString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        if ((operand_9541->mReplacementFunction.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (207))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9541->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
        result << ", true}" ;
        if (enumerator_9541.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13802 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13802 = NULL ;
      while (((operand_13802 = enumerator_13802.nextObject ()))) {
        macroValidPointer (operand_13802) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13802->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13802->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14220 = GGS_uint (8U) ;
      if (indentation_14220.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_14220.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14004 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14004 = NULL ;
      while (((operand_14004 = enumerator_14004.nextObject ()))) {
        macroValidPointer (operand_14004) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14004->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14004->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14220.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_14220.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14727 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14727 = NULL ;
      while (((operand_14727 = enumerator_14727.nextObject ()))) {
        macroValidPointer (operand_14727) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14727->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14727->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15143 = GGS_uint (6U) ;
      if (indentation_15143.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15143.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14929 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14929 = NULL ;
      while (((operand_14929 = enumerator_14929.nextObject ()))) {
        macroValidPointer (operand_14929) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14929->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14929->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15143.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15143.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16486 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16486 = NULL ;
    while (((operand_16486 = enumerator_16486.nextObject ()))) {
      macroValidPointer (operand_16486) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16486->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17063 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17063 = NULL ;
    while (((operand_17063 = enumerator_17063.nextObject ()))) {
      ...
      result << operand_17063->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " (" ;
      result << operand_17063->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_17063->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_17063->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17878 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17878 = NULL ;
    while (((operand_17878 = enumerator_17878.nextObject ()))) {
      macroValidPointer (operand_17878) ;
      result << operand_17878->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_17878->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_17878->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_3642 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (89)), true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_3642 = NULL ;
    while (((operand_3642 = enumerator_3642.nextObject ()))) {
      macroValidPointer (operand_3642) ;
      if (operand_3642->mInfo.mShouldBeGenerated.boolValue ()) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << operand_3642->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << operand_3642->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ;
        result << " [" ;
        result << operand_3642->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (96)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ;
        result << "] = {\n" ;
        GGS_tokenSortedlist::cEnumerator enumerator_4388 (operand_3642->mInfo.mTokenSortedList, true) ;
        const GGS_tokenSortedlist::cElement * operand_4388 = NULL ;
        while (((operand_4388 = enumerator_4388.nextObject ()))) {
          macroValidPointer (operand_4388) ;
          result << "  {@" ;
          result << operand_4388->mName.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
          result << ", " ;
          result << var_cas_LEXIQUE_CLASS_NAME ;
          result << "_1_" ;
          result << operand_4388->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
          result << "}" ;
          if (enumerator_4388.hasNextObject ()) {
            result << ",\n" ;
          }
        }
        result << "\n"
        ...
        result << "_" ;
        result << operand_3642->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
        ...
        result << "_" ;
        result << operand_3642->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) ;
        result << ", " ;
        result << operand_3642->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (103)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_6840 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_6840 = NULL ;
      while (((operand_6840 = enumerator_6840.nextObject ()))) {
        macroValidPointer (operand_6840) ;
        result << "      " ;
        result << operand_6840->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        result << "mLexicalAttribute_" ;
        result << operand_6840->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        result << operand_6840->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        result << " ;\n" ;
      }
      result << "      mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_7261 = GGS_uint (6U) ;
      if (indentation_7261.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_7261.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7061 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7061 = NULL ;
      while (((operand_7061 = enumerator_7061.nextObject ()))) {
        macroValidPointer (operand_7061) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7061->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7061->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (146))) ;
      }
       ;
      if (indentation_7261.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_7261.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_7694 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_7694 = NULL ;
      while (((operand_7694 = enumerator_7694.nextObject ()))) {
        macroValidPointer (operand_7694) ;
        result << "    " ;
        result << operand_7694->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << "mLexicalAttribute_" ;
        result << operand_7694->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << operand_7694->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_8109 = GGS_uint (4U) ;
      if (indentation_8109.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_8109.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7911 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7911 = NULL ;
      while (((operand_7911 = enumerator_7911.nextObject ()))) {
        macroValidPointer (operand_7911) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7911->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7911->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (170))) ;
      }
       ;
      if (indentation_8109.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_8109.uintValue ())) ;
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_10477 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (224)), true) ;
    const GGS_terminalList::cElement * operand_10477 = NULL ;
    while (((operand_10477 = enumerator_10477.nextObject ()))) {
      macroValidPointer (operand_10477) ;
      result << ",\n"
        "    " ;
      result << operand_10477->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_10477->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_11293 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (239)), true) ;
    const GGS_lexicalStyleList::cElement * operand_11293 = NULL ;
    while (((operand_11293 = enumerator_11293.nextObject ()))) {
      macroValidPointer (operand_11293) ;
      result << ",\n"
        "    @" ;
      result << operand_11293->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (240)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_12044 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), true) ;
    const GGS_lexicalStyleList::cElement * operand_12044 = NULL ;
    while (((operand_12044 = enumerator_12044.nextObject ()))) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_12044->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    while (((operand_34451 = enumerator_34451.nextObject ()))) {
      ...
      GGS_tokenSortedlist  var_cas_tokenSortedlist = GGS_tokenSortedlist ::constructor_emptySortedList () ;
      {
        ...
        while (((operand_35185 = enumerator_35185.nextObject ()))) {
          ...
          GGS_string var_cas_syntaxErrorMessage = operand_34451->mSyntaxErrorMessage.ggs_string ().reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_35185->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (829)) COMMA_SOURCE_FILE_AT_LINE (829)) ;
          GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
