...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_2539 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (67)), true) ;
    const GGS_terminalList::cElement * operand_2539 = NULL ;
    if (enumerator_2539.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_2539 = enumerator_2539.nextObject ()))) {
        macroValidPointer (operand_2539) ;
        result << "  " ;
        result << operand_2539->mIsEndOfTemplateMark.reader_ocString (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
        result << " /* " ;
        result << operand_2539->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
        result << " */" ;
    ...
    result << "\n"
      "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_2918 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (76)), true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_2918 = NULL ;
    while (((operand_2918 = enumerator_2918.nextObject ()))) {
      macroValidPointer (operand_2918) ;
      if (operand_2918->mInfo.mShouldBeGenerated.boolValue ()) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << operand_2918->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << operand_2918->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << " [" ;
        result << operand_2918->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (83)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << "] = {\n" ;
        GGS_tokenSortedlist::cEnumerator enumerator_3668 (operand_2918->mInfo.mTokenSortedList, true) ;
        const GGS_tokenSortedlist::cElement * operand_3668 = NULL ;
        while (((operand_3668 = enumerator_3668.nextObject ()))) {
          macroValidPointer (operand_3668) ;
          result << "  {@" ;
          result << operand_3668->mName.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) ;
          result << ", " ;
          result << var_cas_LEXIQUE_CLASS_NAME ;
          result << "_1_" ;
          result << operand_3668->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) ;
          result << "}" ;
          if (enumerator_3668.hasNextObject ()) {
            result << ",\n" ;
          }
        }
        result << "\n"
        ...
        result << "_" ;
        result << operand_2918->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
        ...
        result << "_" ;
        result << operand_2918->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
        result << ", " ;
        result << operand_2918->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (90)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (108))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_5945 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_5945 = NULL ;
      while (((operand_5945 = enumerator_5945.nextObject ()))) {
        macroValidPointer (operand_5945) ;
        result << "      " ;
        result << operand_5945->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << "mLexicalAttribute_" ;
        result << operand_5945->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << operand_5945->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
        result << " ;\n" ;
      }
      result << "      mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_6387 = GGS_uint (6U) ;
      if (indentation_6387.isBuilt ()) {
        result.incIndentation ((sint32) indentation_6387.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_6169 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_6169 = NULL ;
      while (((operand_6169 = enumerator_6169.nextObject ()))) {
        macroValidPointer (operand_6169) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_6169->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_6169->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (130))) ;
      }
       ;
      if (indentation_6387.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_6387.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_6803 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_6803 = NULL ;
      while (((operand_6803 = enumerator_6803.nextObject ()))) {
        macroValidPointer (operand_6803) ;
        result << "    " ;
        result << operand_6803->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << "mLexicalAttribute_" ;
        result << operand_6803->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << operand_6803->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_7239 = GGS_uint (4U) ;
      if (indentation_7239.isBuilt ()) {
        result.incIndentation ((sint32) indentation_7239.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7023 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7023 = NULL ;
      while (((operand_7023 = enumerator_7023.nextObject ()))) {
        macroValidPointer (operand_7023) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7023->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7023->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (154))) ;
      }
       ;
      if (indentation_7239.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_7239.uintValue ())) ;
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_9593 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (208)), true) ;
    const GGS_terminalList::cElement * operand_9593 = NULL ;
    while (((operand_9593 = enumerator_9593.nextObject ()))) {
      macroValidPointer (operand_9593) ;
      result << ",\n"
        "    " ;
      result << operand_9593->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_9593->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_10411 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_lexicalStyleList::cElement * operand_10411 = NULL ;
    while (((operand_10411 = enumerator_10411.nextObject ()))) {
      macroValidPointer (operand_10411) ;
      result << ",\n"
        "    @" ;
      result << operand_10411->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_11163 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), true) ;
    const GGS_lexicalStyleList::cElement * operand_11163 = NULL ;
    while (((operand_11163 = enumerator_11163.nextObject ()))) {
      macroValidPointer (operand_11163) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_11163->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
