...
category_method__lexicalErrorByDefaultAST__checkLexicalDefaultAction (C_Compiler & inLexique,
  ...
  if (operand_2722 != NULL) {
    elementOf_GGS_lexicalMessageMap * operand_2837 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_2722->mDefaultErrorMessageName, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (52)) ;
    if (NULL != operand_2837) {
      operand_2837->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalOrExpressionAST__checkLexicalExpression (C_Compiler & inLexique,
                                const cPtr_lexicalOrExpressionAST * operand_3437,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3437 != NULL) {
    const GGS_lexicalExpressionAST  temp_3531 = operand_3437->mLeftOperand ;
    if (temp_3531.isBuilt ()) {
      typeCategoryMethod__lexicalExpressionAST__checkLexicalExpression method = findCategoryMethod__lexicalExpressionAST__checkLexicalExpression (temp_3531.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_3531 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (70)) ;
      }
    }
    const GGS_lexicalExpressionAST  temp_3602 = operand_3437->mRightOperand ;
    if (temp_3602.isBuilt ()) {
      typeCategoryMethod__lexicalExpressionAST__checkLexicalExpression method = findCategoryMethod__lexicalExpressionAST__checkLexicalExpression (temp_3602.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_3602 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (71)) ;
      }
    }
  }
}
...
category_method__lexicalCharacterMatchAST__checkLexicalExpression (C_Compiler &,
                                const cPtr_lexicalCharacterMatchAST * operand_3791,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3791 != NULL) {
  }
}
...
category_method__lexicalCharacterSetMatchAST__checkLexicalExpression (C_Compiler &,
                                const cPtr_lexicalCharacterSetMatchAST * operand_4014,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4014 != NULL) {
  }
}
...
category_method__lexicalCharacterIntervalMatchAST__checkLexicalExpression (C_Compiler &,
                                const cPtr_lexicalCharacterIntervalMatchAST * operand_4242,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4242 != NULL) {
  }
}
...
category_method__lexicalStringMatchAST__checkLexicalExpression (C_Compiler & inLexique,
                                const cPtr_lexicalStringMatchAST * operand_4459,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4459 != NULL) {
    var_cas_ioLexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_4459->mString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100))) ;
  }
}
...
category_method__lexicalStringNotMatchAST__checkLexicalExpression (C_Compiler & inLexique,
                                const cPtr_lexicalStringNotMatchAST * operand_4747,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4747 != NULL) {
    var_cas_ioLexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_4747->mString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (108))) ;
    elementOf_GGS_lexicalMessageMap * operand_4930 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_4747->mErrorMessage, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (109)) ;
    if (NULL != operand_4930) {
      operand_4930->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalAttributeInputArgumentAST__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalAttributeInputArgumentAST * operand_5633,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5633 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalAttributeMap  temp_5878 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
    if (temp_5878.isBuilt ()) {
      temp_5878 (HERE)->method_searchKey (inLexique, operand_5633->mAttributeName, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (131)) ;
    }
    const GGS_bool cond_6264 = (var_cas_attributeLexicalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_6264.isBuiltAndTrue ()) {
      operand_5633->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, attribute type is @")).operator_concat (var_cas_attributeLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (138)))).operator_concat (GGS_string (" type, but lexical routine prototype requires @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (140)))).operator_concat (GGS_string (" type")) COMMA_SOURCE_FILE_AT_LINE (142)) ;
    }
  }
}
...
category_method__lexicalCharacterInputArgumentAST__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCharacterInputArgumentAST * operand_6445,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6445 != NULL) {
    const GGS_bool cond_6877 = (GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_6877.isBuiltAndTrue ()) {
      operand_6445->mCharacter.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("type error, a literal character has @char")).operator_concat (GGS_string (" type, but lexical routine prototype requires an @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (155)))).operator_concat (GGS_string (" type value")) COMMA_SOURCE_FILE_AT_LINE (157)) ;
    }
  }
}
...
category_method__lexicalCurrentCharacterInputArgumentAST__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCurrentCharacterInputArgumentAST * operand_7676,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7676 != NULL) {
    const GGS_bool cond_8111 = (GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_8111.isBuiltAndTrue ()) {
      operand_7676->mLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("type error, current character value has @char")).operator_concat (GGS_string (" type, but lexical routine prototype requires an @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (185)))).operator_concat (GGS_string (" type value")) COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
  }
}
...
category_method__lexicalFunctionInputArgumentAST__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalFunctionInputArgumentAST * operand_8291,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8291 != NULL) {
    ...
    GGS_bool automatic_var_8754_0 ;
    const GGS_lexicalFunctionMap  temp_8637 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (200)) ;
    if (temp_8637.isBuilt ()) {
      temp_8637 (HERE)->method_searchKey (inLexique, operand_8291->mFunctionName, var_cas_lexicalFormalTypeList, var_cas_returnedLexicalFormalType, var_cas_replacementFunctionName, automatic_var_8754_0 COMMA_SOURCE_FILE_AT_LINE (200)) ;
    }
    const GGS_bool cond_8930 = (var_cas_replacementFunctionName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_8930.isBuiltAndTrue ()) {
      operand_8291->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("obsolete lexical function, replaced by '")).operator_concat (var_cas_replacementFunctionName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (209)) ;
    }
    const GGS_bool cond_9298 = (var_cas_returnedLexicalFormalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_9298.isBuiltAndTrue ()) {
      operand_8291->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, the function returns an @")).operator_concat (var_cas_returnedLexicalFormalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (214)))).operator_concat (GGS_string (" value, but lexical routine prototype requires an @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (216)))).operator_concat (GGS_string (" value")) COMMA_SOURCE_FILE_AT_LINE (218)) ;
    }
    const GGS_bool cond_9660 = (var_cas_lexicalFormalTypeList.reader_length ()).operator_isNotEqual (operand_8291->mFunctionActualArgumentList.reader_length ()) ;
    if (cond_9660.isBuiltAndTrue ()) {
      operand_8291->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical function names ")).operator_concat (operand_8291->mFunctionActualArgumentList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)))).operator_concat (GGS_string (" actual argument(s), but the prototype requires "))).operator_concat (var_cas_lexicalFormalTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)))).operator_concat (GGS_string (" actual argument(s)")) COMMA_SOURCE_FILE_AT_LINE (225)) ;
    }
    {
      GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_9750 (var_cas_lexicalFormalTypeList, true) ;
      const GGS_lexicalFunctionFormalArgumentList::cElement * operand_9750 = NULL ;
      GGS_lexicalFunctionCallActualArgumentListAST::cEnumerator enumerator_9779 (operand_8291->mFunctionActualArgumentList, true) ;
      const GGS_lexicalFunctionCallActualArgumentListAST::cElement * operand_9779 = NULL ;
      while (((operand_9750 = enumerator_9750.nextObject ()))
          && ((operand_9779 = enumerator_9779.nextObject ()))) {
        macroValidPointer (operand_9750) ;
        macroValidPointer (operand_9779) ;
        const GGS_lexicalRoutineOrFunctionFormalInputArgumentAST  temp_9848 = operand_9779->mLexicalActualInputArgument ;
        if (temp_9848.isBuilt ()) {
          typeCategoryMethod__lexicalRoutineOrFunctionFormalInputArgumentAST__checkLexicalFunctionCallArgument method = findCategoryMethod__lexicalRoutineOrFunctionFormalInputArgumentAST__checkLexicalFunctionCallArgument (temp_9848.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_9848 (HERE), var_cas_ioLexiqueAnalysisContext, operand_9750->mLexicalType COMMA_SOURCE_FILE_AT_LINE (228)) ;
          }
        }
      }
    }
...
category_method__lexicalAttributeInputArgumentAST__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalAttributeInputArgumentAST * operand_10556,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10556 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalAttributeMap  temp_10801 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (252)) ;
    if (temp_10801.isBuilt ()) {
      temp_10801 (HERE)->method_searchKey (inLexique, operand_10556->mAttributeName, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (252)) ;
    }
    const GGS_bool cond_11187 = (var_cas_attributeLexicalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_11187.isBuiltAndTrue ()) {
      operand_10556->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, attribute type is @")).operator_concat (var_cas_attributeLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (259)))).operator_concat (GGS_string (" type, but lexical routine prototype requires @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (261)))).operator_concat (GGS_string (" type")) COMMA_SOURCE_FILE_AT_LINE (263)) ;
    }
  }
}
...
category_method__lexicalCharacterInputArgumentAST__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCharacterInputArgumentAST * operand_11367,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11367 != NULL) {
    const GGS_bool cond_11799 = (GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_11799.isBuiltAndTrue ()) {
      operand_11367->mCharacter.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("type error, a literal character has @char")).operator_concat (GGS_string (" type, but lexical routine prototype requires an @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (276)))).operator_concat (GGS_string (" type value")) COMMA_SOURCE_FILE_AT_LINE (278)) ;
    }
  }
}
...
category_method__lexicalCurrentCharacterInputArgumentAST__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalCurrentCharacterInputArgumentAST * operand_12601,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12601 != NULL) {
    const GGS_bool cond_13036 = (GGS_lexicalTypeEnum::constructor_lexicalType_char (inLexique COMMA_HERE)).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_13036.isBuiltAndTrue ()) {
      operand_12601->mLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("type error, current character value has @char")).operator_concat (GGS_string (" type, but lexical routine prototype requires an @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (306)))).operator_concat (GGS_string (" type value")) COMMA_SOURCE_FILE_AT_LINE (308)) ;
    }
  }
}
...
category_method__lexicalFunctionInputArgumentAST__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalFunctionInputArgumentAST * operand_13215,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13215 != NULL) {
    GGS_lexicalFunctionFormalArgumentList  var_cas_lexicalFormalTypeList ;
    GGS_lexicalTypeEnum var_cas_returnedLexicalFormalType ;
    GGS_string var_cas_replacementFunctionName ;
    GGS_bool automatic_var_13678_0 ;
    const GGS_lexicalFunctionMap  temp_13561 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (321)) ;
    if (temp_13561.isBuilt ()) {
      temp_13561 (HERE)->method_searchKey (inLexique, operand_13215->mFunctionName, var_cas_lexicalFormalTypeList, var_cas_returnedLexicalFormalType, var_cas_replacementFunctionName, automatic_var_13678_0 COMMA_SOURCE_FILE_AT_LINE (321)) ;
    }
    const GGS_bool cond_13854 = (var_cas_replacementFunctionName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_13854.isBuiltAndTrue ()) {
      operand_13215->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("obsolete lexical function, replaced by '")).operator_concat (var_cas_replacementFunctionName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (330)) ;
    }
    const GGS_bool cond_14222 = (var_cas_returnedLexicalFormalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_14222.isBuiltAndTrue ()) {
      operand_13215->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, the function returns an @")).operator_concat (var_cas_returnedLexicalFormalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (335)))).operator_concat (GGS_string (" value, but lexical routine prototype requires an @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (337)))).operator_concat (GGS_string (" value")) COMMA_SOURCE_FILE_AT_LINE (339)) ;
    }
    const GGS_bool cond_14584 = (var_cas_lexicalFormalTypeList.reader_length ()).operator_isNotEqual (operand_13215->mFunctionActualArgumentList.reader_length ()) ;
    if (cond_14584.isBuiltAndTrue ()) {
      operand_13215->mFunctionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical function names ")).operator_concat (operand_13215->mFunctionActualArgumentList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (343)))).operator_concat (GGS_string (" actual argument(s), but the prototype requires "))).operator_concat (var_cas_lexicalFormalTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (345)))).operator_concat (GGS_string (" actual argument(s)")) COMMA_SOURCE_FILE_AT_LINE (346)) ;
    }
    {
      GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_14674 (var_cas_lexicalFormalTypeList, true) ;
      const GGS_lexicalFunctionFormalArgumentList::cElement * operand_14674 = NULL ;
      GGS_lexicalFunctionCallActualArgumentListAST::cEnumerator enumerator_14703 (operand_13215->mFunctionActualArgumentList, true) ;
      const GGS_lexicalFunctionCallActualArgumentListAST::cElement * operand_14703 = NULL ;
      while (((operand_14674 = enumerator_14674.nextObject ()))
          && ((operand_14703 = enumerator_14703.nextObject ()))) {
        macroValidPointer (operand_14674) ;
        macroValidPointer (operand_14703) ;
        const GGS_lexicalRoutineOrFunctionFormalInputArgumentAST  temp_14772 = operand_14703->mLexicalActualInputArgument ;
        if (temp_14772.isBuilt ()) {
          typeCategoryMethod__lexicalRoutineOrFunctionFormalInputArgumentAST__checkLexicalFunctionCallArgument method = findCategoryMethod__lexicalRoutineOrFunctionFormalInputArgumentAST__checkLexicalFunctionCallArgument (temp_14772.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_14772 (HERE), var_cas_ioLexiqueAnalysisContext, operand_14674->mLexicalType COMMA_SOURCE_FILE_AT_LINE (349)) ;
          }
        }
      }
    }
...
category_method__lexicalAttributeInputOutputArgumentAST__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalAttributeInputOutputArgumentAST * operand_15548,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
  ...
  if (operand_15548 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalAttributeMap  temp_15855 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
    if (temp_15855.isBuilt ()) {
      temp_15855 (HERE)->method_searchKey (inLexique, operand_15548->mAttributeName, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (375)) ;
    }
    const GGS_bool cond_16241 = (var_cas_attributeLexicalType).operator_isNotEqual (var_cas_inLexicalRoutineFormalArgumentType) ;
    if (cond_16241.isBuiltAndTrue ()) {
      operand_15548->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("type error, attribute type is @")).operator_concat (var_cas_attributeLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (382)))).operator_concat (GGS_string (" type, but lexical routine prototype requires @"))).operator_concat (var_cas_inLexicalRoutineFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (384)))).operator_concat (GGS_string (" type")) COMMA_SOURCE_FILE_AT_LINE (386)) ;
    }
    const GGS_bool cond_16477 = (var_cas_inLexicalRoutineFormalArgumentMode).operator_isNotEqual (GGS_lexicalArgumentModeAST::constructor_lexicalInputOutputMode (inLexique COMMA_HERE)) ;
    if (cond_16477.isBuiltAndTrue ()) {
      operand_15548->mActualPassingModeLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the output mode (!) is required here, not an output/input mode") COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
  }
}
...
category_method__lexicalFormalInputArgumentAST__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
                                const cPtr_lexicalFormalInputArgumentAST * operand_16654,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalArgumentModeAST  var_cas_inLexicalRoutineFormalArgumentMode,
                                GGS_lexicalTypeEnum  var_cas_inLexicalRoutineFormalArgumentType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16654 != NULL) {
    GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
    const GGS_lexicalRoutineOrFunctionFormalInputArgumentAST  temp_16973 = operand_16654->mRoutineOrFunctionFormalInputArgument ;
    if (temp_16973.isBuilt ()) {
      typeCategoryMethod__lexicalRoutineOrFunctionFormalInputArgumentAST__checkLexicalRoutineCallArgument method = findCategoryMethod__lexicalRoutineOrFunctionFormalInputArgumentAST__checkLexicalRoutineCallArgument (temp_16973.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_16973 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_inLexicalRoutineFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (402)) ;
      }
    }
    const GGS_bool cond_17275 = (var_cas_inLexicalRoutineFormalArgumentMode).operator_isNotEqual (GGS_lexicalArgumentModeAST::constructor_lexicalInputMode (inLexique COMMA_HERE)) ;
    if (cond_17275.isBuiltAndTrue ()) {
      operand_16654->mActualPassingModeLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the output/input mode (!\?) is required here, not an input mode") COMMA_SOURCE_FILE_AT_LINE (409)) ;
    }
  }
}
...
category_method__lexicalStructuredSendInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalStructuredSendInstructionAST * operand_17846,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17846 != NULL) {
    {
      GGS_lexicalSendSearchListAST::cEnumerator enumerator_17969 (operand_17846->mLexicalSendSearchList, true) ;
      const GGS_lexicalSendSearchListAST::cElement * operand_17969 = NULL ;
      while (((operand_17969 = enumerator_17969.nextObject ()))) {
        macroValidPointer (operand_17969) ;
        elementOf_GGS_lexicalExplicitTokenListMapMap * operand_18029 = (elementOf_GGS_lexicalExplicitTokenListMapMap *) var_cas_ioLexiqueAnalysisContext.mLexicalTokenListMap.searchForWithInstruction (inLexique, operand_17969->mSearchListName, GGS_lexicalExplicitTokenListMapMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (428)) ;
        if (NULL != operand_18029) {
          operand_18029->mInfo.mShouldBeGenerated = GGS_bool (true) ;
        }
        GGS_lexicalTypeEnum automatic_var_18192_0 ;
        const GGS_lexicalAttributeMap  temp_18172 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (431)) ;
        if (temp_18172.isBuilt ()) {
          temp_18172 (HERE)->method_searchKey (inLexique, operand_17969->mAttributeName, automatic_var_18192_0 COMMA_SOURCE_FILE_AT_LINE (431)) ;
        }
      }
    }
    const GGS_lexicalSendDefaultActionAST  temp_18265 = operand_17846->mLexicalSendDefaultAction ;
    if (temp_18265.isBuilt ()) {
      typeCategoryMethod__lexicalSendDefaultActionAST__checkLexicalDefaultAction method = findCategoryMethod__lexicalSendDefaultActionAST__checkLexicalDefaultAction (temp_18265.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_18265 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (433)) ;
      }
    }
  }
}
...
category_method__lexicalSimpleSendInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalSimpleSendInstructionAST * operand_18461,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18461 != NULL) {
    GGS_lexicalSentValueList  automatic_var_18623_0 ;
    const GGS_terminalMap  temp_18604 = var_cas_ioLexiqueAnalysisContext.reader_mTerminalMap (inLexique COMMA_SOURCE_FILE_AT_LINE (442)) ;
    if (temp_18604.isBuilt ()) {
      temp_18604 (HERE)->method_searchKey (inLexique, operand_18461->mSentTerminal, automatic_var_18623_0 COMMA_SOURCE_FILE_AT_LINE (442)) ;
    }
  }
}
...
category_method__lexicalRepeatInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalRepeatInstructionAST * operand_18787,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & var_cas_ioTagMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18787 != NULL) {
    {
      GGS_lexicalWhileBranchListAST::cEnumerator enumerator_18904 (operand_18787->mLexicalWhileBranchList, true) ;
      const GGS_lexicalWhileBranchListAST::cElement * operand_18904 = NULL ;
      while (((operand_18904 = enumerator_18904.nextObject ()))) {
        macroValidPointer (operand_18904) ;
        const GGS_lexicalExpressionAST  temp_18952 = operand_18904->mWhileExpression ;
        if (temp_18952.isBuilt ()) {
          typeCategoryMethod__lexicalExpressionAST__checkLexicalExpression method = findCategoryMethod__lexicalExpressionAST__checkLexicalExpression (temp_18952.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_18952 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (452)) ;
          }
        }
        ...
        {
          GGS_lexicalInstructionListAST::cEnumerator enumerator_19077 (operand_18904->mWhileInstructionList, true) ;
          const GGS_lexicalInstructionListAST::cElement * operand_19077 = NULL ;
          while (((operand_19077 = enumerator_19077.nextObject ()))) {
            macroValidPointer (operand_19077) ;
            const GGS_lexicalInstructionAST  temp_19124 = operand_19077->mInstruction ;
            if (temp_19124.isBuilt ()) {
              typeCategoryMethod__lexicalInstructionAST__checkLexicalInstruction method = findCategoryMethod__lexicalInstructionAST__checkLexicalInstruction (temp_19124.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_19124 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_tagMap COMMA_SOURCE_FILE_AT_LINE (455)) ;
              }
            }
          }
        }
    ...
    GGS_lexicalTagMap  var_cas_tagMap = GGS_lexicalTagMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTagMap COMMA_HERE) ;
    {
      GGS_lexicalInstructionListAST::cEnumerator enumerator_19291 (operand_18787->mRepeatedInstructionList, true) ;
      const GGS_lexicalInstructionListAST::cElement * operand_19291 = NULL ;
      while (((operand_19291 = enumerator_19291.nextObject ()))) {
        macroValidPointer (operand_19291) ;
        const GGS_lexicalInstructionAST  temp_19336 = operand_19291->mInstruction ;
        if (temp_19336.isBuilt ()) {
          typeCategoryMethod__lexicalInstructionAST__checkLexicalInstruction method = findCategoryMethod__lexicalInstructionAST__checkLexicalInstruction (temp_19336.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_19336 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_tagMap COMMA_SOURCE_FILE_AT_LINE (460)) ;
          }
        }
      }
    }
...
category_method__lexicalSelectInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalSelectInstructionAST * operand_19553,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & var_cas_ioTagMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19553 != NULL) {
    {
      GGS_lexicalSelectBranchListAST::cEnumerator enumerator_19672 (operand_19553->mLexicalSelectBranchList, true) ;
      const GGS_lexicalSelectBranchListAST::cElement * operand_19672 = NULL ;
      while (((operand_19672 = enumerator_19672.nextObject ()))) {
        macroValidPointer (operand_19672) ;
        const GGS_lexicalExpressionAST  temp_19721 = operand_19672->mSelectExpression ;
        if (temp_19721.isBuilt ()) {
          typeCategoryMethod__lexicalExpressionAST__checkLexicalExpression method = findCategoryMethod__lexicalExpressionAST__checkLexicalExpression (temp_19721.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_19721 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (471)) ;
          }
        }
        GGS_lexicalTagMap  var_cas_tagMap = GGS_lexicalTagMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTagMap COMMA_HERE) ;
        {
          GGS_lexicalInstructionListAST::cEnumerator enumerator_19847 (operand_19672->mSelectInstructionList, true) ;
          const GGS_lexicalInstructionListAST::cElement * operand_19847 = NULL ;
          while (((operand_19847 = enumerator_19847.nextObject ()))) {
            macroValidPointer (operand_19847) ;
            const GGS_lexicalInstructionAST  temp_19894 = operand_19847->mInstruction ;
            if (temp_19894.isBuilt ()) {
              typeCategoryMethod__lexicalInstructionAST__checkLexicalInstruction method = findCategoryMethod__lexicalInstructionAST__checkLexicalInstruction (temp_19894.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_19894 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_tagMap COMMA_SOURCE_FILE_AT_LINE (474)) ;
              }
            }
          }
        }
    ...
    GGS_lexicalTagMap  var_cas_tagMap = GGS_lexicalTagMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTagMap COMMA_HERE) ;
    {
      GGS_lexicalInstructionListAST::cEnumerator enumerator_20060 (operand_19553->mDefaultInstructionList, true) ;
      const GGS_lexicalInstructionListAST::cElement * operand_20060 = NULL ;
      while (((operand_20060 = enumerator_20060.nextObject ()))) {
        macroValidPointer (operand_20060) ;
        const GGS_lexicalInstructionAST  temp_20105 = operand_20060->mInstruction ;
        if (temp_20105.isBuilt ()) {
          typeCategoryMethod__lexicalInstructionAST__checkLexicalInstruction method = findCategoryMethod__lexicalInstructionAST__checkLexicalInstruction (temp_20105.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_20105 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_tagMap COMMA_SOURCE_FILE_AT_LINE (479)) ;
          }
        }
      }
    }
...
category_method__lexicalRoutineInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalRoutineInstructionAST * operand_20323,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20323 != NULL) {
    ...
    GGS_bool automatic_var_20749_0 ;
    const GGS_lexicalRoutineMap  temp_20625 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalRoutineMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)) ;
    if (temp_20625.isBuilt ()) {
      temp_20625 (HERE)->method_searchKey (inLexique, operand_20323->mRoutineName, var_cas_lexicalRoutineFormalArgumentList, var_cas_routineErrorMessageList, var_cas_replacementRoutineName, automatic_var_20749_0 COMMA_SOURCE_FILE_AT_LINE (492)) ;
    }
    const GGS_bool cond_20920 = (var_cas_replacementRoutineName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_20920.isBuiltAndTrue ()) {
      operand_20323->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("obsolete lexical routine, replaced by '")).operator_concat (var_cas_replacementRoutineName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (501)) ;
    }
    const GGS_bool cond_21307 = (var_cas_lexicalRoutineFormalArgumentList.reader_length ()).operator_isNotEqual (operand_20323->mActualArgumentList.reader_length ()) ;
    if (cond_21307.isBuiltAndTrue ()) {
      operand_20323->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical routine call names ")).operator_concat (operand_20323->mActualArgumentList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (506)))).operator_concat (GGS_string (" actual argument(s), but the lexical routine prototype requires "))).operator_concat (var_cas_lexicalRoutineFormalArgumentList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (508)))).operator_concat (GGS_string (" actual argument(s)")) COMMA_SOURCE_FILE_AT_LINE (509)) ;
    }
    {
      GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_21408 (var_cas_lexicalRoutineFormalArgumentList, true) ;
      const GGS_lexicalRoutineFormalArgumentList::cElement * operand_21408 = NULL ;
      GGS_lexicalRoutineCallActualArgumentListAST::cEnumerator enumerator_21429 (operand_20323->mActualArgumentList, true) ;
      const GGS_lexicalRoutineCallActualArgumentListAST::cElement * operand_21429 = NULL ;
      while (((operand_21408 = enumerator_21408.nextObject ()))
          && ((operand_21429 = enumerator_21429.nextObject ()))) {
        macroValidPointer (operand_21408) ;
        macroValidPointer (operand_21429) ;
        const GGS_abstractLexicalRoutineActualArgumentAST  temp_21499 = operand_21429->mLexicalRoutineActualArgument ;
        if (temp_21499.isBuilt ()) {
          typeCategoryMethod__abstractLexicalRoutineActualArgumentAST__checkLexicalRoutineCallArgument method = findCategoryMethod__abstractLexicalRoutineActualArgumentAST__checkLexicalRoutineCallArgument (temp_21499.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_21499 (HERE), var_cas_ioLexiqueAnalysisContext, operand_21408->mLexicalFormalArgumentMode, operand_21408->mLexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (512)) ;
          }
        }
      }
    }
    const GGS_bool cond_21978 = (var_cas_routineErrorMessageList.reader_length ()).operator_isNotEqual (operand_20323->mErrorMessageList.reader_length ()) ;
    if (cond_21978.isBuiltAndTrue ()) {
      operand_20323->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this lexical routine call names ")).operator_concat (operand_20323->mErrorMessageList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (521)))).operator_concat (GGS_string (" error message(s), but the lexical routine prototype requires "))).operator_concat (var_cas_routineErrorMessageList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (523)))).operator_concat (GGS_string (" error message(s)")) COMMA_SOURCE_FILE_AT_LINE (524)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_22058 (operand_20323->mErrorMessageList, true) ;
      const GGS_lstringlist::cElement * operand_22058 = NULL ;
      while (((operand_22058 = enumerator_22058.nextObject ()))) {
        macroValidPointer (operand_22058) ;
        elementOf_GGS_lexicalMessageMap * operand_22123 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_22058->mValue, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (527)) ;
        if (NULL != operand_22123) {
          operand_22123->mInfo.mMessageIsUsed = GGS_bool (true) ;
        }
      }
    }
  }
...
category_method__lexicalLogInstructionAST__checkLexicalInstruction (C_Compiler &,
                                const cPtr_lexicalLogInstructionAST * operand_22369,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22369 != NULL) {
  }
}
...
category_method__lexicalRewindInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalRewindInstructionAST * operand_22628,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & var_cas_ioTagMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22628 != NULL) {
    const GGS_lexicalTagMap  temp_22733 = var_cas_ioTagMap ;
    if (temp_22733.isBuilt ()) {
      temp_22733 (HERE)->method_searchKey (inLexique, operand_22628->mLexicalTagName COMMA_SOURCE_FILE_AT_LINE (547)) ;
    }
    GGS_lexicalSentValueList  automatic_var_22825_0 ;
    const GGS_terminalMap  temp_22806 = var_cas_ioLexiqueAnalysisContext.reader_mTerminalMap (inLexique COMMA_SOURCE_FILE_AT_LINE (548)) ;
    if (temp_22806.isBuilt ()) {
      temp_22806 (HERE)->method_searchKey (inLexique, operand_22628->mTerminalName, automatic_var_22825_0 COMMA_SOURCE_FILE_AT_LINE (548)) ;
    }
  }
}
...
category_method__lexicalDropInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalDropInstructionAST * operand_22987,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22987 != NULL) {
    GGS_lexicalSentValueList  automatic_var_23150_0 ;
    const GGS_terminalMap  temp_23131 = var_cas_ioLexiqueAnalysisContext.reader_mTerminalMap (inLexique COMMA_SOURCE_FILE_AT_LINE (557)) ;
    if (temp_23131.isBuilt ()) {
      temp_23131 (HERE)->method_searchKey (inLexique, operand_22987->mTerminalName, automatic_var_23150_0 COMMA_SOURCE_FILE_AT_LINE (557)) ;
    }
  }
}
...
category_method__lexicalTagInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalTagInstructionAST * operand_23311,
                                GGS_lexiqueAnalysisContext & /* var_cas_ioLexiqueAnalysisContext */,
                                GGS_lexicalTagMap  & var_cas_ioTagMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23311 != NULL) {
    var_cas_ioTagMap.modifier_insertKey (inLexique, operand_23311->mLexicalTagName COMMA_SOURCE_FILE_AT_LINE (566)) ;
  }
}
...
category_method__lexicalErrorInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalErrorInstructionAST * operand_23606,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23606 != NULL) {
    elementOf_GGS_lexicalMessageMap * operand_23749 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_23606->mErrorMessageName, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (575)) ;
    if (NULL != operand_23749) {
      operand_23749->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalWarningInstructionAST__checkLexicalInstruction (C_Compiler & inLexique,
                                const cPtr_lexicalWarningInstructionAST * operand_23986,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext,
                                GGS_lexicalTagMap  & /* var_cas_ioTagMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23986 != NULL) {
    elementOf_GGS_lexicalMessageMap * operand_24129 = (elementOf_GGS_lexicalMessageMap *) var_cas_ioLexiqueAnalysisContext.mLexicalMessageMap.searchForWithInstruction (inLexique, operand_23986->mWarningMessageName, GGS_lexicalMessageMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (586)) ;
    if (NULL != operand_24129) {
      operand_24129->mInfo.mMessageIsUsed = GGS_bool (true) ;
    }
  }
}
...
category_method__lexicalImplicitRuleAST__checkLexicalRule (C_Compiler & inLexique,
                                const cPtr_lexicalImplicitRuleAST * operand_24703,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24703 != NULL) {
    GGS_lexicalExplicitTokenListMap  automatic_var_24840_0 ;
    GGS_tokenSortedlist  automatic_var_24840_1 ;
    GGS_bool automatic_var_24840_2 ;
    const GGS_lexicalExplicitTokenListMapMap  temp_24819 = var_cas_ioLexiqueAnalysisContext.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) ;
    if (temp_24819.isBuilt ()) {
      temp_24819 (HERE)->method_searchKey (inLexique, operand_24703->mListName, automatic_var_24840_0, automatic_var_24840_1, automatic_var_24840_2 COMMA_SOURCE_FILE_AT_LINE (604)) ;
    }
  }
}
...
category_method__lexicalExplicitRuleAST__checkLexicalRule (C_Compiler & inLexique,
                                const cPtr_lexicalExplicitRuleAST * operand_24992,
                                GGS_lexiqueAnalysisContext & var_cas_ioLexiqueAnalysisContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24992 != NULL) {
    const GGS_lexicalExpressionAST  temp_25096 = operand_24992->mLexicalRuleExpression ;
    if (temp_25096.isBuilt ()) {
      typeCategoryMethod__lexicalExpressionAST__checkLexicalExpression method = findCategoryMethod__lexicalExpressionAST__checkLexicalExpression (temp_25096.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_25096 (HERE), var_cas_ioLexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (612)) ;
      }
    }
    GGS_lexicalTagMap  var_cas_tagMap = GGS_lexicalTagMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    {
      GGS_lexicalInstructionListAST::cEnumerator enumerator_25190 (operand_24992->mInstructionList, true) ;
      const GGS_lexicalInstructionListAST::cElement * operand_25190 = NULL ;
      while (((operand_25190 = enumerator_25190.nextObject ()))) {
        macroValidPointer (operand_25190) ;
        const GGS_lexicalInstructionAST  temp_25235 = operand_25190->mInstruction ;
        if (temp_25235.isBuilt ()) {
          typeCategoryMethod__lexicalInstructionAST__checkLexicalInstruction method = findCategoryMethod__lexicalInstructionAST__checkLexicalInstruction (temp_25235.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_25235 (HERE), var_cas_ioLexiqueAnalysisContext, var_cas_tagMap COMMA_SOURCE_FILE_AT_LINE (615)) ;
          }
        }
      }
    }
...
void routine_parseLexiqueComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_28037 = var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (676)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (676))) ;
  if (cond_28037.isBuiltAndTrue ()) {
    const GGS_parsedLexiqueComponentMap  temp_27997 = var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (677)) ;
    if (temp_27997.isBuilt ()) {
      temp_27997 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_outLexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (677)) ;
    }
  }else if (cond_28037.isBuiltAndFalse ()) {
...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_29235 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (702))).operator_isNotEqual (var_cas_basename) ;
  if (cond_29235.isBuiltAndTrue ()) {
  ...
  {
    GGS_externRoutineListAST::cEnumerator enumerator_30309 (var_cas_lexiqueComponentRoot.reader_mExternRoutineList (inLexique COMMA_SOURCE_FILE_AT_LINE (721)), true) ;
    const GGS_externRoutineListAST::cElement * operand_30309 = NULL ;
    while (((operand_30309 = enumerator_30309.nextObject ()))) {
      macroValidPointer (operand_30309) ;
      ...
      {
        GGS_lexicalExternRoutineFormalArgumentListAST::cEnumerator enumerator_30483 (operand_30309->mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalExternRoutineFormalArgumentListAST::cElement * operand_30483 = NULL ;
        while (((operand_30483 = enumerator_30483.nextObject ()))) {
          macroValidPointer (operand_30483) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          const GGS_lexicalTypeMap  temp_30569 = var_cas_lexicalTypeMap ;
          if (temp_30569.isBuilt ()) {
            temp_30569 (HERE)->method_searchKey (inLexique, operand_30483->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (725)) ;
          }
          var_cas_lexicalRoutineFormalArgumentList.addAssign_operation (operand_30483->mPassingMode, var_cas_lexicalFormalArgumentType, operand_30483->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (726))) ;
        }
      }
      var_cas_lexicalRoutineMap.modifier_insertKey (inLexique, operand_30309->mRoutineName, var_cas_lexicalRoutineFormalArgumentList, operand_30309->mErrorMessageList, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (728)) ;
    }
  }
  ...
  {
    GGS_externFunctionListAST::cEnumerator enumerator_31114 (var_cas_lexiqueComponentRoot.reader_mExternFunctionList (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), true) ;
    const GGS_externFunctionListAST::cElement * operand_31114 = NULL ;
    while (((operand_31114 = enumerator_31114.nextObject ()))) {
      macroValidPointer (operand_31114) ;
      ...
      {
        GGS_lexicalExternFunctionFormalArgumentListAST::cEnumerator enumerator_31292 (operand_31114->mLexicalFunctionFormalArgumentList, true) ;
        const GGS_lexicalExternFunctionFormalArgumentListAST::cElement * operand_31292 = NULL ;
        while (((operand_31292 = enumerator_31292.nextObject ()))) {
          macroValidPointer (operand_31292) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          const GGS_lexicalTypeMap  temp_31378 = var_cas_lexicalTypeMap ;
          if (temp_31378.isBuilt ()) {
            temp_31378 (HERE)->method_searchKey (inLexique, operand_31292->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (738)) ;
          }
          var_cas_lexicalFunctionFormalArgumentList.addAssign_operation (var_cas_lexicalFormalArgumentType, operand_31292->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (739))) ;
        }
      }
      GGS_lexicalTypeEnum var_cas_returnedArgumentType ;
      const GGS_lexicalTypeMap  temp_31620 = var_cas_lexicalTypeMap ;
      if (temp_31620.isBuilt ()) {
        temp_31620 (HERE)->method_searchKey (inLexique, operand_31114->mReturnedTypeName, var_cas_returnedArgumentType COMMA_SOURCE_FILE_AT_LINE (742)) ;
      }
      var_cas_lexicalFunctionMap.modifier_insertKey (inLexique, operand_31114->mFunctionName, var_cas_lexicalFunctionFormalArgumentList, var_cas_returnedArgumentType, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (743)) ;
    }
  }
  ...
  {
    GGS_lexicalStyleListAST::cEnumerator enumerator_32318 (var_cas_lexiqueComponentRoot.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), true) ;
    const GGS_lexicalStyleListAST::cElement * operand_32318 = NULL ;
    while (((operand_32318 = enumerator_32318.nextObject ()))) {
      macroValidPointer (operand_32318) ;
      var_cas_lexiqueAnalysisContext.mStyleMap.modifier_insertKey (inLexique, operand_32318->mName, operand_32318->mComment, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (761)) ;
      var_cas_styleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (762)) ;
    }
  }
  {
    GGS_lexicalAttributeListAST::cEnumerator enumerator_32569 (var_cas_lexiqueComponentRoot.reader_mLexicalAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (765)), true) ;
    const GGS_lexicalAttributeListAST::cElement * operand_32569 = NULL ;
    while (((operand_32569 = enumerator_32569.nextObject ()))) {
      macroValidPointer (operand_32569) ;
      const GGS_bool cond_32862 = var_cas_lexicalTypeMap.reader_hasKey (operand_32569->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (766))) ;
      if (cond_32862.isBuiltAndTrue ()) {
        GGS_lexicalTypeEnum var_cas_lexicalType ;
        const GGS_lexicalTypeMap  temp_32740 = var_cas_lexicalTypeMap ;
        if (temp_32740.isBuilt ()) {
          temp_32740 (HERE)->method_searchKey (inLexique, operand_32569->mTypeName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (768)) ;
        }
        var_cas_lexiqueAnalysisContext.mLexicalAttributeMap.modifier_insertKey (inLexique, operand_32569->mName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (769)) ;
      }else if (cond_32862.isBuiltAndFalse ()) {
        GGS_string var_cas_m = GGS_string ("") ;
        var_cas_m.appendCString ("the @") ;
        var_cas_m.dotAssign_operation (operand_32569->mTypeName) ;
        var_cas_m.appendCString (" type is not a valid lexical attribute type; are allowed:") ;
        GGS_bool var_cas_firstLoop = GGS_bool (true) ;
        {
          GGS_lexicalTypeMap::cEnumerator enumerator_33042 (var_cas_lexicalTypeMap, true) ;
          const GGS_lexicalTypeMap::cElement * operand_33042 = enumerator_33042.nextObject () ;
          if ((operand_33042 != NULL)) {
            bool _foreach_loop_33042 ;
            do{
              macroValidPointer (operand_33042) ;
              var_cas_m.appendCString (" @") ;
              var_cas_m.dotAssign_operation (operand_33042->mKey) ;
              operand_33042 = enumerator_33042.nextObject () ;
              _foreach_loop_33042 = ((operand_33042 != NULL)) ;
              if (_foreach_loop_33042) {
                var_cas_m.appendCString (",") ;
              }
            }while (_foreach_loop_33042) ;
          }
        }
        operand_32569->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (780)) ;
      }
    }
  }
  {
    GGS_terminalDeclarationListAST::cEnumerator enumerator_33252 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), true) ;
    const GGS_terminalDeclarationListAST::cElement * operand_33252 = NULL ;
    while (((operand_33252 = enumerator_33252.nextObject ()))) {
      macroValidPointer (operand_33252) ;
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_33472 = (operand_33252->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (785)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_33472.isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_33462_0 ;
        const GGS_styleMap  temp_33430 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (786)) ;
        if (temp_33430.isBuilt ()) {
          temp_33430 (HERE)->method_searchKey (inLexique, operand_33252->mStyle, automatic_var_33462_0, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (786)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_33565 (operand_33252->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_33565 = NULL ;
        while (((operand_33565 = enumerator_33565.nextObject ()))) {
          macroValidPointer (operand_33565) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_33678 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (791)) ;
          if (temp_33678.isBuilt ()) {
            temp_33678 (HERE)->method_searchKey (inLexique, operand_33565->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (791)) ;
          }
          var_cas_argumentTypeList.addAssign_operation (operand_33565->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (792)), var_cas_attributeLexicalType) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_33252->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (794)) ;
      GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_33942 (operand_33252->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_33942 = NULL ;
        while (((operand_33942 = enumerator_33942.nextObject ()))) {
          macroValidPointer (operand_33942) ;
          const GGS_bool cond_34084 = (operand_33942->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (797))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
          if (cond_34084.isBuiltAndTrue ()) {
            operand_33942->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (799)) ;
          }else if (cond_34084.isBuiltAndFalse ()) {
            const GGS_bool cond_34190 = var_cas_isEndOfTemplateMark ;
            if (cond_34190.isBuiltAndTrue ()) {
              operand_33942->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (801)) ;
            }else if (cond_34190.isBuiltAndFalse ()) {
              var_cas_isEndOfTemplateMark = GGS_bool (true) ;
            }
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalList.addAssign_operation (operand_33252->mName, var_cas_argumentTypeList, operand_33252->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
    }
  }
  {
    GGS_lexicalListDeclarationListAST::cEnumerator enumerator_34465 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (813)), true) ;
    const GGS_lexicalListDeclarationListAST::cElement * operand_34465 = NULL ;
    while (((operand_34465 = enumerator_34465.nextObject ()))) {
      macroValidPointer (operand_34465) ;
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_34688 = (operand_34465->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (815)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_34688.isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_34678_0 ;
        const GGS_styleMap  temp_34646 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (816)) ;
        if (temp_34646.isBuilt ()) {
          temp_34646 (HERE)->method_searchKey (inLexique, operand_34465->mStyle, automatic_var_34678_0, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (816)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_34781 (operand_34465->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_34781 = NULL ;
        while (((operand_34781 = enumerator_34781.nextObject ()))) {
          macroValidPointer (operand_34781) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_34893 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (821)) ;
          if (temp_34893.isBuilt ()) {
            temp_34893 (HERE)->method_searchKey (inLexique, operand_34781->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (821)) ;
          }
          var_cas_argumentTypeList.addAssign_operation (operand_34781->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (822)), var_cas_attributeLexicalType) ;
        }
      }
      ...
      {
        GGS_lexicalListEntryListAST::cEnumerator enumerator_35157 (operand_34465->mEntryList, true) ;
        const GGS_lexicalListEntryListAST::cElement * operand_35157 = NULL ;
        while (((operand_35157 = enumerator_35157.nextObject ()))) {
          macroValidPointer (operand_35157) ;
          GGS_string var_cas_syntaxErrorMessage = operand_34465->mSyntaxErrorMessage.ggs_string ().reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_35157->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
          GGS_bool var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
            GGS_lstringlist::cEnumerator enumerator_35356 (operand_35157->mFeatureList, true) ;
            const GGS_lstringlist::cElement * operand_35356 = NULL ;
            while (((operand_35356 = enumerator_35356.nextObject ()))) {
              macroValidPointer (operand_35356) ;
              const GGS_bool cond_35504 = (operand_35356->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830))).operator_isNotEqual (GGS_string ("templateEndMark")) ;
              if (cond_35504.isBuiltAndTrue ()) {
                operand_35356->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (832)) ;
              }else if (cond_35504.isBuiltAndFalse ()) {
                const GGS_bool cond_35614 = var_cas_isEndOfTemplateMark ;
                if (cond_35614.isBuiltAndTrue ()) {
                  operand_35356->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (834)) ;
                }else if (cond_35614.isBuiltAndFalse ()) {
                  var_cas_isEndOfTemplateMark = GGS_bool (true) ;
                }
              }
            }
          }
          var_cas_lexiqueAnalysisContext.mTerminalList.addAssign_operation (operand_35157->mTerminalSpelling, var_cas_argumentTypeList, var_cas_syntaxErrorMessage, var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
          var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_35157->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (845)) ;
          var_cas_lexicalTokenListMap.modifier_insertKey (inLexique, operand_35157->mEntrySpelling, operand_35157->mTerminalSpelling, operand_35157->mFeatureList COMMA_SOURCE_FILE_AT_LINE (846)) ;
          var_cas_tokenSortedlist.addAssign_operation (operand_35157->mEntrySpelling.ggs_string ().reader_length (), operand_35157->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (847)), operand_35157->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (847))) ;
          var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_35157->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (848))) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mLexicalTokenListMap.modifier_insertKey (inLexique, operand_34465->mName, var_cas_lexicalTokenListMap, var_cas_tokenSortedlist, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (850)) ;
    }
  }
  {
    GGS_lexicalMessageDeclarationListAST::cEnumerator enumerator_36479 (var_cas_lexiqueComponentRoot.reader_mLexicalMessageDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (853)), true) ;
    const GGS_lexicalMessageDeclarationListAST::cElement * operand_36479 = NULL ;
    while (((operand_36479 = enumerator_36479.nextObject ()))) {
      macroValidPointer (operand_36479) ;
      var_cas_lexiqueAnalysisContext.mLexicalMessageMap.modifier_insertKey (inLexique, operand_36479->mMessageName, operand_36479->mMessageValue, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (854)) ;
    }
  }
  {
    GGS_lexicalRuleListAST::cEnumerator enumerator_36713 (var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (857)), true) ;
    const GGS_lexicalRuleListAST::cElement * operand_36713 = NULL ;
    while (((operand_36713 = enumerator_36713.nextObject ()))) {
      macroValidPointer (operand_36713) ;
      const GGS_abstractLexicalRuleAST  temp_36789 = operand_36713->mLexicalRule ;
      if (temp_36789.isBuilt ()) {
        typeCategoryMethod__abstractLexicalRuleAST__checkLexicalRule method = findCategoryMethod__abstractLexicalRuleAST__checkLexicalRule (temp_36789.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_36789 (HERE), var_cas_lexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (858)) ;
        }
      }
    }
  }
  {
    GGS_lexicalMessageMap::cEnumerator enumerator_36911 (var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (861)), true) ;
    const GGS_lexicalMessageMap::cElement * operand_36911 = NULL ;
    while (((operand_36911 = enumerator_36911.nextObject ()))) {
      macroValidPointer (operand_36911) ;
      const GGS_bool cond_37032 = (operand_36911->mInfo.mMessageIsUsed).operator_not () ;
      if (cond_37032.isBuiltAndTrue ()) {
        operand_36911->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (863)) ;
      }
    }
  }
  {
    GGS_metamodelTemplateDelimitorListAST::cEnumerator enumerator_37126 (var_cas_lexiqueComponentRoot.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (867)), true) ;
    const GGS_metamodelTemplateDelimitorListAST::cElement * operand_37126 = NULL ;
    while (((operand_37126 = enumerator_37126.nextObject ()))) {
      macroValidPointer (operand_37126) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37126->mStartString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (868))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37126->mEndString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (869))) ;
      GGS_bool var_cas_preservesStartDelimiter = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_37396 (operand_37126->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_37396 = NULL ;
        while (((operand_37396 = enumerator_37396.nextObject ()))) {
          macroValidPointer (operand_37396) ;
          const GGS_bool cond_37523 = (operand_37396->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (872))).operator_isNotEqual (GGS_string ("preserved")) ;
          if (cond_37523.isBuiltAndTrue ()) {
            operand_37396->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'preserved' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (874)) ;
          }else if (cond_37523.isBuiltAndFalse ()) {
            const GGS_bool cond_37625 = var_cas_preservesStartDelimiter ;
            if (cond_37625.isBuiltAndTrue ()) {
              operand_37396->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'preserved' feature is already set") COMMA_SOURCE_FILE_AT_LINE (876)) ;
            }else if (cond_37625.isBuiltAndFalse ()) {
              var_cas_preservesStartDelimiter = GGS_bool (true) ;
            }
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTemplateDelimitorList.addAssign_operation (operand_37126->mStartString, operand_37126->mEndString, var_cas_preservesStartDelimiter) ;
    }
  }
  {
    GGS_templateReplacementListAST::cEnumerator enumerator_37894 (var_cas_lexiqueComponentRoot.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (883)), true) ;
    const GGS_templateReplacementListAST::cElement * operand_37894 = NULL ;
    while (((operand_37894 = enumerator_37894.nextObject ()))) {
      macroValidPointer (operand_37894) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37894->mMatchString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (884))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate.addAssign_operation (operand_37894->mReplacementString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (885))) ;
    }
  }
  GGS_string var_cas_lexiqueClassName = var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (889)) ;
  const GGS_bool cond_38914 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_38914.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_39707 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_39707.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_40226 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_40226.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_40951 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_40951.isBuiltAndTrue ()) {
