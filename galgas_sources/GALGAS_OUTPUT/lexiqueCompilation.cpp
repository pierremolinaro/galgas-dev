...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_ (C_Compiler * inCompiler,
      ...
      if (enumerator_8128.current_mSentAttributeList (HERE).isValid ()) {
        ...
        while (enumerator_8524.hasCurrentObject ()) {
          result << "      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;\n"
            "      s." ;
          result << categoryReader_appendMethodName (enumerator_8524.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (168)).stringValue () ;
          ...
          result << categoryReader_appendArgumentOfMethod (enumerator_8524.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (168)).stringValue () ;
          result << ") ;\n" ;
  ...
  if (kBoolTrue == test_4) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_14603.hasCurrentObject ()) {
        ...
        result << categoryReader_initialization (enumerator_14603.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (285)).stringValue () ;
        result << " ;\n" ;
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_15530.hasCurrentObject ()) {
        ...
        result << categoryReader_initialization (enumerator_15530.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (310)).stringValue () ;
        result << " ;\n" ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_17894.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << categoryReader_cppTypeName (enumerator_17894.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (364)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::attributeValue_" ;
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_18689.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18689.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (376)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (376)).stringValue () ;
      result << " C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "::synthetizedAttribute_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18689.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (380)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (380)).stringValue () ;
      ...
      result << ") ;\n"
        "  GALGAS_l" ;
      result << categoryReader_lexicalTypeBaseName (enumerator_18689.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (381)).stringValue () ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_370.hasCurrentObject ()) {
      ...
      result << " = " ;
      result << categoryReader_cocoaInitializationCode (enumerator_370.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (14)).stringValue () ;
      result << " ;\n" ;
  ...
  if (kBoolTrue == test_3) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_7704.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_7704.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_7704.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (157)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_7704.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)).stringValue () ;
        result << " ;\n" ;
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_8557.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8557.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (181)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8557.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (181)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8557.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (181)).stringValue () ;
        result << " ;\n" ;
  ...
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (269)).reader_length (SOURCE_FILE_AT_LINE (269)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (269)).reader_string (SOURCE_FILE_AT_LINE (269)).stringValue () ;
  result << ")) {\n"
    "    NSString * kStyleArray [" ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (270)).reader_length (SOURCE_FILE_AT_LINE (270)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (270)).reader_string (SOURCE_FILE_AT_LINE (270)).stringValue () ;
  result << "] = {\n"
    "      @\"Default Style\"" ;
  GALGAS_uint index_13129_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (272)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13129 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (272)), kEnumeration_up) ;
    while (enumerator_13129.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13129.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (273)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (273)).stringValue () ;
      index_13129_.increment () ;
  ...
  result << "\n"
    ...
    "  NSString * result = nil ;\n"
    "  if ((inIndex >= 0) && (inIndex < " ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (288)).reader_length (SOURCE_FILE_AT_LINE (288)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (288)).reader_string (SOURCE_FILE_AT_LINE (288)).stringValue () ;
  result << ")) {\n"
    "    NSString * kStyleArray [" ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (289)).reader_length (SOURCE_FILE_AT_LINE (289)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (289)).reader_string (SOURCE_FILE_AT_LINE (289)).stringValue () ;
  result << "] = {\n"
    "      @\"" ;
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_14050_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (291)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_14050 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (291)), kEnumeration_up) ;
    while (enumerator_14050.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14050.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (292)).stringValue () ;
      result << "\"" ;
      index_14050_.increment () ;
...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
  ...
  cEnumerator_lexicalAttributeListAST enumerator_34285 (constinArgument_inLexicalAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34285.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inLexicalTypeMap.reader_hasKey (enumerator_34285.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (826)) COMMA_SOURCE_FILE_AT_LINE (826)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lexicalTypeEnum var_lexicalType ;
      //-------- @methodCallInstructionForGeneration
      constinArgument_inLexicalTypeMap.method_searchKey (enumerator_34285.current_mTypeName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioLexicalAttributeMap.modifier_insertKey (enumerator_34285.current_mName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (829)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_m = GALGAS_string::makeEmptyString () ;
      //-------- @concatInstructionForGeneration
      var_m.dotAssign_operation (GALGAS_string ("the @").operator_concat (enumerator_34285.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)).operator_concat (GALGAS_string (" type is not a valid lexical attribute type; are allowed:") COMMA_SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_firstLoop = GALGAS_bool (true) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lexicalTypeMap enumerator_34699 (constinArgument_inLexicalTypeMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_34699.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_m.dotAssign_operation (GALGAS_string (" @").operator_concat (enumerator_34699.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) ;
        if (enumerator_34699.hasNextObject ()) {
          //-------- @concatInstructionForGeneration
      ...
      GALGAS_location location_1 (enumerator_34285.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_externRoutineListAST enumerator_36105 (constinArgument_inLexiqueComponentRoot.reader_mExternRoutineList (SOURCE_FILE_AT_LINE (867)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36105.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_36239 (enumerator_36105.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_36239.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      //-------- @methodCallInstructionForGeneration
      var_lexicalTypeMap.method_searchKey (enumerator_36239.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_36239.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_36239.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
      enumerator_36239.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_lexicalRoutineMap.modifier_insertKey (enumerator_36105.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_36105.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (874)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_36105.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_externFunctionListAST enumerator_36909 (constinArgument_inLexiqueComponentRoot.reader_mExternFunctionList (SOURCE_FILE_AT_LINE (880)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36909.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_37046 (enumerator_36909.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37046.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      //-------- @methodCallInstructionForGeneration
      var_lexicalTypeMap.method_searchKey (enumerator_37046.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (884)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_37046.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (885)) COMMA_SOURCE_FILE_AT_LINE (885)) ;
      enumerator_37046.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    //-------- @methodCallInstructionForGeneration
    var_lexicalTypeMap.method_searchKey (enumerator_36909.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_lexicalFunctionMap.modifier_insertKey (enumerator_36909.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalStyleListAST enumerator_38863 (constinArgument_inLexiqueComponentRoot.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (920)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_38863.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_38863.current_mName (HERE), enumerator_38863.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @incrementInstructionForGeneration
    var_styleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (922)) ;
    enumerator_38863.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_terminalDeclarationListAST enumerator_39325 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (931)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39325.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((PMUInt32) 0U) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_39325.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (933)).reader_length (SOURCE_FILE_AT_LINE (933)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_39465_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (934)).method_searchKey (enumerator_39325.current_mStyle (HERE), joker_39465_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_39592 (enumerator_39325.current_mSentAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39592.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      //-------- @methodCallInstructionForGeneration
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_39592.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_argumentTypeList.addAssign_operation (enumerator_39592.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (940)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (940)) ;
      enumerator_39592.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_39325.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_40004 (enumerator_39325.current_mOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40004.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_40004.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (946)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @ifInstructionForGeneration
        ...
        if (kBoolTrue == test_4) {
          ...
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_40004.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_40004.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (952)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_7 (enumerator_40004.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          if (kBoolTrue == test_8) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_9 (enumerator_40004.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    //-------- @plusEqualnstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_39325.current_mName (HERE), var_argumentTypeList, enumerator_39325.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (963)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (960)) ;
    enumerator_39325.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalListDeclarationListAST enumerator_40861 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (969)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40861.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((PMUInt32) 0U) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, enumerator_40861.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (971)).reader_length (SOURCE_FILE_AT_LINE (971)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_41001_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (972)).method_searchKey (enumerator_40861.current_mStyle (HERE), joker_41001_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_41128 (enumerator_40861.current_mSentAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41128.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      //-------- @methodCallInstructionForGeneration
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_41128.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (977)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_argumentTypeList.addAssign_operation (enumerator_41128.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (978)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (978)) ;
      enumerator_41128.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalListEntryListAST enumerator_41503 (enumerator_40861.current_mEntryList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41503.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_syntaxErrorMessage = enumerator_40861.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (983)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_41503.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (983)), inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_41749 (enumerator_41503.current_mFeatureList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_41749.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_41749.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (987)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          ...
          if (kBoolTrue == test_12) {
            ...
            //-------- @errorInstructionForGeneration
            GALGAS_location location_13 (enumerator_41749.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_41749.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (993)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_14) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_15 (enumerator_41749.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            if (kBoolTrue == test_16) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_17 (enumerator_41749.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_41749.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_41503.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (1001)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_41503.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1009)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_lexicalTokenListMap.modifier_insertKey (enumerator_41503.current_mEntrySpelling (HERE), enumerator_41503.current_mTerminalSpelling (HERE), enumerator_41503.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_tokenSortedlist.addAssign_operation (enumerator_41503.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)).reader_length (SOURCE_FILE_AT_LINE (1011)), enumerator_41503.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)), enumerator_41503.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
      //-------- @plusEqualnstructionForGeneration
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_41503.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
      enumerator_41503.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_40861.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_40861.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalMessageDeclarationListAST enumerator_43235 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE_AT_LINE (1017)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43235.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_43235.current_mMessageName (HERE), enumerator_43235.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1018)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_43235.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalRuleListAST enumerator_43458 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE_AT_LINE (1021)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43458.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_43458.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_43458.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalMessageMap enumerator_43660 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE_AT_LINE (1025)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43660.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_18 = enumerator_43660.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE_AT_LINE (1026)).boolEnum () ;
    if (kBoolTrue == test_18) {
      //-------- @warningInstructionForGeneration
      GALGAS_location location_19 (enumerator_43660.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_19, GALGAS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (1027)) ;
    }
    enumerator_43660.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_43880 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (1031)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43880.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43880.current_mStartString (HERE).reader_string (SOURCE_FILE_AT_LINE (1032)) COMMA_SOURCE_FILE_AT_LINE (1032)) ;
    //-------- @plusEqualnstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43880.current_mEndString (HERE).reader_string (SOURCE_FILE_AT_LINE (1033)) COMMA_SOURCE_FILE_AT_LINE (1033)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_44108 (enumerator_43880.current_mOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44108.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_44108.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1036)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_21 (enumerator_44108.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        if (kBoolTrue == test_22) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_23 (enumerator_44108.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    //-------- @plusEqualnstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_43880.current_mStartString (HERE), enumerator_43880.current_mEndString (HERE), var_preservesStartDelimiter COMMA_SOURCE_FILE_AT_LINE (1044)) ;
    enumerator_43880.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_24) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_indexingListAST enumerator_44722 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1048)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44722.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_25 (enumerator_44722.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_indexingListAST enumerator_44944 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1053)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44944.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_26 = var_indexNameSet.reader_hasKey (enumerator_44944.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)).boolEnum () ;
    if (kBoolTrue == test_26) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_27 (enumerator_44944.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_44944.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)).operator_concat (GALGAS_string ("' index is already declared") COMMA_SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_indexNameSet.addAssign_operation (enumerator_44944.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1057)) COMMA_SOURCE_FILE_AT_LINE (1057)) ;
    enumerator_44944.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_templateReplacementListAST enumerator_45277 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (1060)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45277.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45277.current_mMatchString (HERE).reader_string (SOURCE_FILE_AT_LINE (1061)) COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    //-------- @plusEqualnstructionForGeneration
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45277.current_mReplacementString (HERE).reader_string (SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
    enumerator_45277.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_lexiqueClassName = var_componentName.reader_string (SOURCE_FILE_AT_LINE (1066)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_28 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (1068)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (1089)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (1111)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (1129)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
...
GALGAS_string categoryReader_appendMethodName (const GALGAS_lexicalTypeEnum & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint_36__34_: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("appendUnsigned64") ;
      } break ;
    case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint: {
      //-------- @assignmentInstructionForGeneration
    ...
    case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint_36__34_: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("appendSigned64") ;
      } break ;
    case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_double: {
      //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_lexicalSendTerminalByDefaultAST_checkLexicalDefaultAction (const cPtr_lexicalSendDefaultActionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lexicalSentValueList joker_6904_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (154)).method_searchKey (object->mAttribute_mDefaultSentTerminal, joker_6904_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalErrorByDefaultAST_checkLexicalDefaultAction (const cPtr_lexicalSendDefaultActionAST * inObject,
  ...
  cMapElement_lexicalMessageMap * objectArray_7133 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mDefaultErrorMessageName COMMA_SOURCE_FILE_AT_LINE (162)) ;
  if (NULL != objectArray_7133) {
      macroValidSharedObject (objectArray_7133, cMapElement_lexicalMessageMap) ;
    //-------- @assignmentInstructionForGeneration
    objectArray_7133->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalCharacterSetMatchAST_checkLexicalExpression (const cPtr_lexicalExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringset enumerator_8670 (ioArgument_ioLexiqueAnalysisContext.mAttribute_mExternUnicodeTestFunctions, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8670.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  ").operator_concat (enumerator_8670.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_SOURCE_FILE_AT_LINE (199)) ;
...
static void categoryMethod_lexicalStringNotMatchAST_checkLexicalExpression (const cPtr_lexicalExpressionAST * inObject,
  ...
  // index 1: attribute 'mLexicalMessage', type @lstring
  // index 2: attribute 'mMessageIsUsed', type @bool
  cMapElement_lexicalMessageMap * objectArray_9573 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (226)) ;
  if (NULL != objectArray_9573) {
      macroValidSharedObject (objectArray_9573, cMapElement_lexicalMessageMap) ;
    //-------- @assignmentInstructionForGeneration
    objectArray_9573->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalFunctionInputArgumentAST_checkLexicalFunctionCallArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_13437_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (317)).method_searchKey (object->mAttribute_mFunctionName, var_lexicalFormalTypeList, var_returnedLexicalFormalType, var_replacementFunctionName, joker_13437_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (317)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalFunctionFormalArgumentList enumerator_14438 (var_lexicalFormalTypeList, kEnumeration_up) ;
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_14469 (object->mAttribute_mFunctionActualArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14438.hasCurrentObject () && enumerator_14469.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalFunctionCallArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) enumerator_14469.current_mLexicalActualInputArgument (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, enumerator_14438.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (345)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_lexicalFunctionInputArgumentAST_checkLexicalRoutineCallArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  GALGAS_string var_replacementFunctionName ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_18361_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalFunctionMap (SOURCE_FILE_AT_LINE (438)).method_searchKey (object->mAttribute_mFunctionName, var_lexicalFormalTypeList, var_returnedLexicalFormalType, var_replacementFunctionName, joker_18361_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (438)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_replacementFunctionName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalFunctionFormalArgumentList enumerator_19362 (var_lexicalFormalTypeList, kEnumeration_up) ;
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_19393 (object->mAttribute_mFunctionActualArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19362.hasCurrentObject () && enumerator_19393.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalFunctionCallArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) enumerator_19393.current_mLexicalActualInputArgument (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, enumerator_19362.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_lexicalStructuredSendInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalSendSearchListAST enumerator_22617 (object->mAttribute_mLexicalSendSearchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_22617.hasCurrentObject ()) {
    ...
    cMapElement_lexicalExplicitTokenListMapMap * objectArray_22629 = (cMapElement_lexicalExplicitTokenListMapMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.readWriteAccessForWithInstruction_searchKey (inCompiler, enumerator_22617.current_mSearchListName (HERE) COMMA_SOURCE_FILE_AT_LINE (544)) ;
    if (NULL != objectArray_22629) {
        macroValidSharedObject (objectArray_22629, cMapElement_lexicalExplicitTokenListMapMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_22629->mAttribute_mShouldBeGenerated = GALGAS_bool (true) ;
    }
    //-------- @methodCallInstructionForGeneration
    GALGAS_lexicalTypeEnum joker_22837_0 ; // Joker input parameter
    ioArgument_ioLexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE_AT_LINE (547)).method_searchKey (enumerator_22617.current_mAttributeName (HERE), joker_22837_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (547)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_lexicalSimpleSendInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lexicalSentValueList joker_23268_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (558)).method_searchKey (object->mAttribute_mSentTerminal, joker_23268_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalRepeatInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalWhileBranchListAST enumerator_23553 (object->mAttribute_mLexicalWhileBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23553.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalExpression ((const cPtr_lexicalExpressionAST *) enumerator_23553.current_mWhileExpression (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (568)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_23726 (enumerator_23553.current_mWhileInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_23726.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_23726.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_23940 (object->mAttribute_mRepeatedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23940.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_23940.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (576)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_lexicalSelectInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalSelectBranchListAST enumerator_24321 (object->mAttribute_mLexicalSelectBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24321.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalExpression ((const cPtr_lexicalExpressionAST *) enumerator_24321.current_mSelectExpression (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (587)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_24496 (enumerator_24321.current_mSelectInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24496.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_24496.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_24709 (object->mAttribute_mDefaultInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24709.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_24709.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (595)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_lexicalRoutineInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_25328_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalRoutineMessageMap (SOURCE_FILE_AT_LINE (607)).method_searchKey (object->mAttribute_mRoutineName, var_lexicalRoutineFormalArgumentList, var_routineErrorMessageList, joker_25328_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalRoutineFormalArgumentList enumerator_25818 (var_lexicalRoutineFormalArgumentList, kEnumeration_up) ;
  cEnumerator_lexicalRoutineCallActualArgumentListAST enumerator_25841 (object->mAttribute_mActualArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25818.hasCurrentObject () && enumerator_25841.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalRoutineCallArgument ((const cPtr_abstractLexicalRoutineActualArgumentAST *) enumerator_25841.current_mLexicalRoutineActualArgument (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, enumerator_25818.current_mLexicalFormalArgumentMode (HERE), enumerator_25818.current_mLexicalFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (622)) ;
    //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_26470 (object->mAttribute_mErrorMessageList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26470.hasCurrentObject ()) {
    //-------- @readWriteWithInstructionForGeneration
    // index 1: attribute 'mLexicalMessage', type @lstring
    // index 2: attribute 'mMessageIsUsed', type @bool
    cMapElement_lexicalMessageMap * objectArray_26482 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, enumerator_26470.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (637)) ;
    if (NULL != objectArray_26482) {
        macroValidSharedObject (objectArray_26482, cMapElement_lexicalMessageMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_26482->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
    }
    enumerator_26470.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalRewindInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_lexicalSentValueList joker_27243_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (658)).method_searchKey (object->mAttribute_mTerminalName, joker_27243_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (658)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalDropInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lexicalSentValueList joker_27568_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mTerminalMap (SOURCE_FILE_AT_LINE (667)).method_searchKey (object->mAttribute_mTerminalName, joker_27568_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalErrorInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  // index 1: attribute 'mLexicalMessage', type @lstring
  // index 2: attribute 'mMessageIsUsed', type @bool
  cMapElement_lexicalMessageMap * objectArray_28125 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mErrorMessageName COMMA_SOURCE_FILE_AT_LINE (685)) ;
  if (NULL != objectArray_28125) {
      macroValidSharedObject (objectArray_28125, cMapElement_lexicalMessageMap) ;
    //-------- @assignmentInstructionForGeneration
    objectArray_28125->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalWarningInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  // index 1: attribute 'mLexicalMessage', type @lstring
  // index 2: attribute 'mMessageIsUsed', type @bool
  cMapElement_lexicalMessageMap * objectArray_28506 = (cMapElement_lexicalMessageMap *) ioArgument_ioLexiqueAnalysisContext.mAttribute_mLexicalMessageMap.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mWarningMessageName COMMA_SOURCE_FILE_AT_LINE (696)) ;
  if (NULL != objectArray_28506) {
      macroValidSharedObject (objectArray_28506, cMapElement_lexicalMessageMap) ;
    //-------- @assignmentInstructionForGeneration
    objectArray_28506->mAttribute_mMessageIsUsed = GALGAS_bool (true) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalImplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lexicalExplicitTokenListMap joker_29254_0 ; // Joker input parameter
  GALGAS_tokenSortedlist joker_29257_0 ; // Joker input parameter
  GALGAS_bool joker_29260_0 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (714)).method_searchKey (object->mAttribute_mListName, joker_29254_0, joker_29257_0, joker_29260_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexicalExplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_29614 (object->mAttribute_mInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29614.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_29614.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (725)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_29614.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
