...
template_filewrapper_lexiqueGenerationTemplates_headerZone3 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      "\n"
      "//--- Attribute access\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_1041 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (31)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_1041 = NULL ;
    while (((operand_1041 = enumerator_1041.nextObject ()))) {
      macroValidPointer (operand_1041) ;
      result << "  public : " ;
      result << operand_1041->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) ;
      result << " attributeValue_" ;
      result << operand_1041->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const ;\n" ;
    }
    result << "\n"
      "\n"
  ...
  if (isBuilt) {
    ...
    while (((operand_7774 = enumerator_7774.nextObject ()))) {
      ...
      while (((operand_8104 = enumerator_8104.nextObject ()))) {
        ...
        result << operand_8104->mAttributeName.reader_identifierRepresentation () ;
    ...
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8908 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (178)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8908 = NULL ;
    if (enumerator_8908.hasCurrentObject ()) {
      ...
      while (((operand_8908 = enumerator_8908.nextObject ()))) {
        ...
        result << operand_8908->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_8908->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
        result << ", " ;
        if ((operand_8908->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8908->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_8908->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8908->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
        result << ")" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementListAST::cEnumerator enumerator_9945 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (199)), true) ;
    const GGS_templateReplacementListAST::cElement * operand_9945 = NULL ;
    if (enumerator_9945.hasCurrentObject ()) {
      ...
      while (((operand_9945 = enumerator_9945.nextObject ()))) {
        ...
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_9945->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9945->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)) ;
        result << ", kUnicodeString_" ;
        result << operand_9945->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9945->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
        result << ", " ;
        if ((operand_9945->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9945->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
        }
        result << ", true)" ;
        if (enumerator_9945.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_11004 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (220)), true) ;
    const GGS_terminalList::cElement * operand_11004 = NULL ;
    if (enumerator_11004.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_11004 = enumerator_11004.nextObject ()))) {
        macroValidPointer (operand_11004) ;
        result << "  " ;
        result << operand_11004->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
        result << " /* " ;
        result << operand_11004->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
        result << " */" ;
        if (enumerator_11004.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (240)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14229 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14229 = NULL ;
      while (((operand_14229 = enumerator_14229.nextObject ()))) {
        macroValidPointer (operand_14229) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14229->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_14229->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (278)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15121 = GGS_uint (8U) ;
      if (indentation_15121.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15121.uintValue ()) ;
      }
      GGS_lexicalRuleListAST::cEnumerator enumerator_14450 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleListAST::cElement * operand_14450 = NULL ;
      while (((operand_14450 = enumerator_14450.nextObject ()))) {
        macroValidPointer (operand_14450) ;
        result << (findCategoryReader__abstractLexicalRuleAST__generateCode (operand_14450->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14450->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (285))) ;
      }
       ;
      if (indentation_15121.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15121.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_15156 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_15156 = NULL ;
      while (((operand_15156 = enumerator_15156.nextObject ()))) {
        macroValidPointer (operand_15156) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_15156->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_15156->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (303)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15884 = GGS_uint (6U) ;
      if (indentation_15884.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15884.uintValue ()) ;
      }
      GGS_lexicalRuleListAST::cEnumerator enumerator_15377 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleListAST::cElement * operand_15377 = NULL ;
      while (((operand_15377 = enumerator_15377.nextObject ()))) {
        macroValidPointer (operand_15377) ;
        result << (findCategoryReader__abstractLexicalRuleAST__generateCode (operand_15377->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_15377->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (310))) ;
      }
       ;
      if (indentation_15884.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15884.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16926 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16926 = NULL ;
    while (((operand_16926 = enumerator_16926.nextObject ()))) {
      macroValidPointer (operand_16926) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16926->mKey.ggs_string ().reader_identifierRepresentation () ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17462 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17462 = NULL ;
    while (((operand_17462 = enumerator_17462.nextObject ()))) {
      macroValidPointer (operand_17462) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << operand_17462->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::attributeValue_" ;
      result << operand_17462->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_18247 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_18247 = NULL ;
    while (((operand_18247 = enumerator_18247.nextObject ()))) {
      macroValidPointer (operand_18247) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "void C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::assignFromAttribute_" ;
      result << operand_18247->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (GGS_l" ;
      result << operand_18247->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (369)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = GGS_l" ;
      result << operand_18247->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (371)) ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_19120 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_19120 = NULL ;
    while (((operand_19120 = enumerator_19120.nextObject ()))) {
      macroValidPointer (operand_19120) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << operand_19120->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (381)).reader_identifierRepresentation () ;
      result << " * C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::synthetizedAttribute_" ;
      result << operand_19120->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << operand_19120->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (385)).reader_identifierRepresentation () ;
      ...
      result << " COMMA_HERE) ;\n"
        "  return GALGAS_l" ;
      result << operand_19120->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (386)).reader_identifierRepresentation () ;
