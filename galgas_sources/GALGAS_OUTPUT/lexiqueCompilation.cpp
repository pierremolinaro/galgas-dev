...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_7636 = enumerator_7636.nextObject ()))) {
      ...
      result << ") ;\n"
        "      s.appendCString(\"$\") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7932 (operand_7636->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7932 = NULL ;
      while (((operand_7932 = enumerator_7932.nextObject ()))) {
        macroValidPointer (operand_7932) ;
        result << "      s." ;
        result << operand_7932->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7932->mAttributeName.reader_identifierRepresentation () ;
        result << operand_7932->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8664 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (177)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8664 = NULL ;
    if (enumerator_8664.hasCurrentObject ()) {
      ...
      while (((operand_8664 = enumerator_8664.nextObject ()))) {
        ...
        result << operand_8664->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_8664->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
        result << ", " ;
        if ((operand_8664->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8664->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_8664->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8664->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
        result << ")" ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9701 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), true) ;
    const GGS_templateReplacementList::cElement * operand_9701 = NULL ;
    if (enumerator_9701.hasCurrentObject ()) {
      ...
      while (((operand_9701 = enumerator_9701.nextObject ()))) {
        ...
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_9701->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9701->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
        result << ", kUnicodeString_" ;
        result << operand_9701->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9701->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)) ;
        result << ", " ;
        if ((operand_9701->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9701->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        }
        result << ", true)" ;
        if (enumerator_9701.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10760 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (219)), true) ;
    const GGS_terminalList::cElement * operand_10760 = NULL ;
    if (enumerator_10760.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_10760 = enumerator_10760.nextObject ()))) {
        macroValidPointer (operand_10760) ;
        result << "  " ;
        result << operand_10760->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
        result << " /* " ;
        result << operand_10760->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
        result << " */" ;
        if (enumerator_10760.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (239)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13985 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13985 = NULL ;
      while (((operand_13985 = enumerator_13985.nextObject ()))) {
        macroValidPointer (operand_13985) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13985->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_13985->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (277)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14876 = GGS_uint (8U) ;
      if (indentation_14876.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_14876.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14205 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14205 = NULL ;
      while (((operand_14205 = enumerator_14205.nextObject ()))) {
        macroValidPointer (operand_14205) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14205->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14205->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (284))) ;
      }
       ;
      if (indentation_14876.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_14876.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14911 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14911 = NULL ;
      while (((operand_14911 = enumerator_14911.nextObject ()))) {
        macroValidPointer (operand_14911) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14911->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << operand_14911->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (302)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15638 = GGS_uint (6U) ;
      if (indentation_15638.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15638.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_15131 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_15131 = NULL ;
      while (((operand_15131 = enumerator_15131.nextObject ()))) {
        macroValidPointer (operand_15131) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_15131->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_15131->mLexicalRule.getPtr (), var_cas_LEXIQUE_IDENTIFIER, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (309))) ;
      }
       ;
      if (indentation_15638.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15638.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16680 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16680 = NULL ;
    while (((operand_16680 = enumerator_16680.nextObject ()))) {
      macroValidPointer (operand_16680) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16680->mKey.ggs_string ().reader_identifierRepresentation () ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17214 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17214 = NULL ;
    while (((operand_17214 = enumerator_17214.nextObject ()))) {
      macroValidPointer (operand_17214) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n" ;
      result << operand_17214->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (356)) ;
      result << " C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::attributeValue_" ;
      result << operand_17214->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17997 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17997 = NULL ;
    while (((operand_17997 = enumerator_17997.nextObject ()))) {
      macroValidPointer (operand_17997) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "void C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::assignFromAttribute_" ;
      result << operand_17997->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (GGS_l" ;
      result << operand_17997->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (368)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = GGS_l" ;
      result << operand_17997->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (370)) ;
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_18868 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_18868 = NULL ;
    while (((operand_18868 = enumerator_18868.nextObject ()))) {
      macroValidPointer (operand_18868) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "GALGAS_l" ;
      result << operand_18868->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (380)).reader_identifierRepresentation () ;
      result << " * C_Lexique_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << "::synthetizedAttribute_" ;
      result << operand_18868->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_IDENTIFIER ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << ") ;\n"
        ...
        "  GALGAS_" ;
      result << operand_18868->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (384)).reader_identifierRepresentation () ;
      ...
      result << " COMMA_HERE) ;\n"
        "  return GALGAS_l" ;
      result << operand_18868->mInfo.mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (385)).reader_identifierRepresentation () ;
