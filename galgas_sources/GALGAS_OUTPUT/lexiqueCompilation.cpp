...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << " {\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalMessageMap::cEnumerator enumerator_3061 (var_cas_LEXICAL_MESSAGE_MAP, true) ;
    const GGS_lexicalMessageMap::cElement * operand_3061 = NULL ;
    while (((operand_3061 = enumerator_3061.nextObject ()))) {
      macroValidPointer (operand_3061) ;
      result << "\n"
        "static const utf32 gLexicalMessage_" ;
      result << operand_3061->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
      result << " [] = " ;
      result << operand_3061->mInfo.mLexicalMessage.ggs_string ().reader_utf32Representation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_terminalList::cEnumerator enumerator_3610 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_3610 = NULL ;
    while (((operand_3610 = enumerator_3610.nextObject ()))) {
      macroValidPointer (operand_3610) ;
      result << "\n"
        "//--- Syntax error message for terminal '$" ;
      result << operand_3610->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
      result << "$' :\n"
        "static const utf32 gSyntaxErrorMessage_" ;
      result << operand_3610->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91)).reader_identifierRepresentation () ;
      result << " [] = " ;
      result << operand_3610->mSyntaxErrorMessage.reader_utf32Representation () ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    while (((operand_4588 = enumerator_4588.nextObject ()))) {
      ...
      result << operand_4588->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (105)).reader_identifierRepresentation () ;
    }
    result << "} ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_stringset::cEnumerator enumerator_5200 (var_cas_STRINGS_IN_EXPLICIT_RULES, true) ;
    while (enumerator_5200.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5200._key (HERE).reader_identifierRepresentation () ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5200._key (HERE).reader_identifierRepresentation () ;
      result << " [] = " ;
      result << enumerator_5200._key (HERE).reader_utf32Representation () ;
      result << " ;\n" ;
      enumerator_5200.next () ;
    }
    result << "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_5460 (var_cas_LEXICAL_TOKEN_LIST_MAP, true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_5460 = NULL ;
    while (((operand_5460 = enumerator_5460.nextObject ()))) {
      macroValidPointer (operand_5460) ;
      result << "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        "//             Key words table '" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      result << "'                            *\n"
        "//                                                                           *\n"
        "//---------------------------------------------------------------------------*\n"
        "\n"
        "static const PMSInt32 ktable_size_" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " = " ;
      result << operand_5460->mInfo.mExplicitTokenListMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " ;\n"
        "\n"
        "static const C_unicode_lexique_table_entry ktable_for_" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << " [ktable_size_" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
      result << "] = {\n" ;
      GGS_tokenSortedlist::cEnumerator enumerator_6214 (operand_5460->mInfo.mTokenSortedList, true) ;
      const GGS_tokenSortedlist::cElement * operand_6214 = NULL ;
      while (((operand_6214 = enumerator_6214.nextObject ()))) {
        ...
        result << operand_6214->mName.reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_6214->mLength.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << ", " ;
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "::" ;
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "_1_" ;
        result << operand_6214->mTerminalName.reader_identifierRepresentation () ;
        result << ")" ;
        if (enumerator_6214.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::search_into_" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
      result << " (const C_String & inSearchedString) {\n"
        "  return searchInList (inSearchedString, ktable_for_" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      result << ", ktable_size_" ;
      result << operand_5460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      result << ") ;\n"
        "}\n"
    ...
    result << "_1_:\n"
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7539 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7539 = NULL ;
    while (((operand_7539 = enumerator_7539.nextObject ()))) {
      macroValidPointer (operand_7539) ;
      result << "    case " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7539->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7539->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_utf8Representation () ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7853 (operand_7539->mSentAttributeList, true) ;
    ...
    result << "    default:\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateDelimitorList::cEnumerator enumerator_8558 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
    const GGS_templateDelimitorList::cElement * operand_8558 = NULL ;
    if (enumerator_8558.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_8558 = enumerator_8558.nextObject ()))) {
        macroValidPointer (operand_8558) ;
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_8558->mStartString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_8558->mStartString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << ", " ;
        if ((operand_8558->mEndString.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL, 0," ;
        }else {
          result << "kUnicodeString_" ;
          result << operand_8558->mEndString.ggs_string ().reader_identifierRepresentation () ;
          result << ", " ;
          result << operand_8558->mEndString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
          result << "," ;
        }
        result << " NULL, " ;
        result << (operand_8558->mPreservesStartDelimiter).operator_not ().reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
        result << ")" ;
        if (enumerator_8558.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9595 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
    const GGS_templateReplacementList::cElement * operand_9595 = NULL ;
    if (enumerator_9595.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_9595 = enumerator_9595.nextObject ()))) {
        macroValidPointer (operand_9595) ;
        result << "  cTemplateDelimiter (kUnicodeString_" ;
        result << operand_9595->mMatchString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9595->mMatchString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", kUnicodeString_" ;
        result << operand_9595->mReplacementString.ggs_string ().reader_identifierRepresentation () ;
        result << ", " ;
        result << operand_9595->mReplacementString.ggs_string ().reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        if ((operand_9595->mReplacementFunction.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9595->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
        result << ", true)" ;
        if (enumerator_9595.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10654 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_terminalList::cElement * operand_10654 = NULL ;
    if (enumerator_10654.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_10654 = enumerator_10654.nextObject ()))) {
        macroValidPointer (operand_10654) ;
        result << "  " ;
        result << operand_10654->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " /* " ;
        result << operand_10654->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " */" ;
        if (enumerator_10654.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13870 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13870 = NULL ;
      while (((operand_13870 = enumerator_13870.nextObject ()))) {
        macroValidPointer (operand_13870) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13870->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13870->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14288 = GGS_uint (8U) ;
      if (indentation_14288.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_14288.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14072 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14072 = NULL ;
      while (((operand_14072 = enumerator_14072.nextObject ()))) {
        macroValidPointer (operand_14072) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14072->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14072->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14288.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_14288.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14795 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14795 = NULL ;
      while (((operand_14795 = enumerator_14795.nextObject ()))) {
        macroValidPointer (operand_14795) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14795->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14795->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15211 = GGS_uint (6U) ;
      if (indentation_15211.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15211.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14997 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14997 = NULL ;
      while (((operand_14997 = enumerator_14997.nextObject ()))) {
        macroValidPointer (operand_14997) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14997->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14997->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15211.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15211.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16554 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16554 = NULL ;
    while (((operand_16554 = enumerator_16554.nextObject ()))) {
      macroValidPointer (operand_16554) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16554->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17131 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17131 = NULL ;
    while (((operand_17131 = enumerator_17131.nextObject ()))) {
      macroValidPointer (operand_17131) ;
      result << "void " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "assignFromAttribute_" ;
      result << operand_17131->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " (" ;
      result << operand_17131->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_17131->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_17131->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17946 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17946 = NULL ;
    while (((operand_17946 = enumerator_17946.nextObject ()))) {
      macroValidPointer (operand_17946) ;
      result << operand_17946->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_17946->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_17946->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
