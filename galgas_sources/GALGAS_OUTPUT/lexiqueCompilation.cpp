...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  while (enumerator_40006.hasCurrentObject ()) {
    ...
    while (enumerator_40273.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_40273.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 950)) ;
      var_argumentTypeList.addAssign_operation (enumerator_40273.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 951)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 951)) ;
    ...
    while (enumerator_40648.hasCurrentObject ()) {
      ...
      while (enumerator_40894.hasCurrentObject ()) {
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_40894.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 960)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          ...
          const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_40894.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 966)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
      ...
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_40648.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 974)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_40648.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 982)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_40648.current_mEntrySpelling (HERE), enumerator_40648.current_mTerminalSpelling (HERE), enumerator_40648.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 983)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_40648.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 984)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 984)), enumerator_40648.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 984)), enumerator_40648.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 984))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 984)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_40648.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 985))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 985)) ;
  ...
  cEnumerator_lexicalMessageDeclarationListAST enumerator_42380 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 990)), kEnumeration_up) ;
  while (enumerator_42380.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_42380.current_mMessageName (HERE), enumerator_42380.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 991)) ;
    }
    enumerator_42380.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_42603 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 994)), kEnumeration_up) ;
  while (enumerator_42603.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_42603.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 995)) ;
    enumerator_42603.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_42805 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 998)), kEnumeration_up) ;
  while (enumerator_42805.hasCurrentObject ()) {
    const enumGalgasBool test_18 = enumerator_42805.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("lexiqueCompilation.gSemantics", 999)).boolEnum () ;
  ...
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_43025 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1004)), kEnumeration_up) ;
  while (enumerator_43025.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43025.current_mStartString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1005))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1005)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43025.current_mEndString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1006))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1006)) ;
    ...
    while (enumerator_43253.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_43253.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1009)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
    ...
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_43025.current_mStartString (HERE), enumerator_43025.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1017)) ;
  ...
  if (kBoolTrue == test_24) {
    cEnumerator_indexingListAST enumerator_43867 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1021)), kEnumeration_up) ;
  ...
  cEnumerator_indexingListAST enumerator_44089 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1026)), kEnumeration_up) ;
  while (enumerator_44089.hasCurrentObject ()) {
    const enumGalgasBool test_26 = var_indexNameSet.reader_hasKey (enumerator_44089.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1027)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1027)).boolEnum () ;
    ...
    var_indexNameSet.addAssign_operation (enumerator_44089.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1030))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1030)) ;
    enumerator_44089.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_44422 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1033)), kEnumeration_up) ;
  while (enumerator_44422.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_44422.current_mMatchString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1034))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1034)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_44422.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1035))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1035)) ;
...
void routine_compileLexiqueComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  cEnumerator_externRoutineListAST enumerator_49194 (constinArgument_inLexiqueComponentAST.mAttribute_mExternRoutineList, kEnumeration_up) ;
  while (enumerator_49194.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_49328 (enumerator_49194.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_49328.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_49328.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1167)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_49328.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_49328.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1168))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1168)) ;
      enumerator_49328.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_49194.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_49194.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1170)) ;
    }
  ...
  cEnumerator_externFunctionListAST enumerator_49996 (constinArgument_inLexiqueComponentAST.mAttribute_mExternFunctionList, kEnumeration_up) ;
  while (enumerator_49996.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_50133 (enumerator_49996.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_50133.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_50133.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1180)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_50133.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1181))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1181)) ;
      enumerator_50133.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_49996.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1184)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_49996.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1185)) ;
    }
    enumerator_49996.gotoNextObject () ;
  }
  GALGAS_stringset var_externUnicodeTestFunctions = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1188)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("unicodeToLower")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1189)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("unicodeToUpper")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1190)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeLetter")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1191)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeMark")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1192)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeNumber")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1193)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeDecimalDigit")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1194)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeASCIIHexDigit")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1195)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeSeparator")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1196)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeCommand")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1197)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodePunctuation")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1198)) ;
  var_externUnicodeTestFunctions.addAssign_operation (GALGAS_string ("isUnicodeSymbol")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1199)) ;
  GALGAS_lexiqueAnalysisContext var_lexiqueAnalysisContext = GALGAS_lexiqueAnalysisContext::constructor_new (var_lexicalRoutineMap, var_lexicalFunctionMap, GALGAS_lexicalMessageMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1204)), GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1205)), GALGAS_terminalList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1206)), GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1207)), GALGAS_lexicalExplicitTokenListMapMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1208)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1209)), GALGAS_templateDelimitorList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1210)), GALGAS_styleMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1211)), var_externUnicodeTestFunctions COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1201)) ;
  GALGAS_uint var_styleIndex = GALGAS_uint ((uint32_t) 1U) ;
  cEnumerator_lexicalStyleListAST enumerator_51948 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalStyleList, kEnumeration_up) ;
  while (enumerator_51948.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_51948.current_mName (HERE), enumerator_51948.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1217)) ;
    }
    var_styleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1218)) ;
    enumerator_51948.gotoNextObject () ;
  }
  {
  routine_buildLexicalAttributeMap (var_lexicalTypeMap, constinArgument_inLexiqueComponentAST.mAttribute_mLexicalAttributeList, var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1221)) ;
  }
  cEnumerator_terminalDeclarationListAST enumerator_52406 (constinArgument_inLexiqueComponentAST.mAttribute_mTerminalDeclarationList, kEnumeration_up) ;
  while (enumerator_52406.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_52406.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1229)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1229)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lstring joker_52548_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1230)).method_searchKey (enumerator_52406.current_mStyle (HERE), joker_52548_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1230)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1232)) ;
    cEnumerator_lstringlist enumerator_52673 (enumerator_52406.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_52673.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_52673.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1235)) ;
      var_argumentTypeList.addAssign_operation (enumerator_52673.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1236)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1236)) ;
      enumerator_52673.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_52406.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1238)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_53085 (enumerator_52406.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_53085.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_53085.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1242)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_2) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_2) {
          GALGAS_location location_3 (enumerator_53085.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1246)) ;
        }
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_53085.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1248)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_location location_5 (enumerator_53085.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1249)) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_6 = var_isEndOfTemplateMark.boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_location location_7 (enumerator_53085.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1251)) ;
          }else if (kBoolFalse == test_6) {
            var_isEndOfTemplateMark = GALGAS_bool (true) ;
          }
        }
    ...
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_52406.current_mName (HERE), var_argumentTypeList, enumerator_52406.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1259)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1256)) ;
    enumerator_52406.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_53940 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalListDeclarationList, kEnumeration_up) ;
  while (enumerator_53940.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, enumerator_53940.current_mStyle (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1267)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1267)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_lstring joker_54082_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1268)).method_searchKey (enumerator_53940.current_mStyle (HERE), joker_54082_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1268)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1270)) ;
    cEnumerator_lstringlist enumerator_54207 (enumerator_53940.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_54207.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_54207.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1273)) ;
      var_argumentTypeList.addAssign_operation (enumerator_54207.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1274)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1274)) ;
      enumerator_54207.gotoNextObject () ;
    }
    GALGAS_lexicalExplicitTokenListMap var_lexicalTokenListMap = GALGAS_lexicalExplicitTokenListMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1276)) ;
    GALGAS_tokenSortedlist var_tokenSortedlist = GALGAS_tokenSortedlist::constructor_emptySortedList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1277)) ;
    cEnumerator_lexicalListEntryListAST enumerator_54582 (enumerator_53940.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_54582.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_53940.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1279)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_54582.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1279)), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1279)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_54828 (enumerator_54582.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_54828.hasCurrentObject ()) {
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_54828.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1283)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          const enumGalgasBool test_10 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_10) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_10) {
            GALGAS_location location_11 (enumerator_54828.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_11, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1287)) ;
          }
        }else if (kBoolFalse == test_9) {
          const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_54828.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1289)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_54828.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_13, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1290)) ;
          }else if (kBoolFalse == test_12) {
            const enumGalgasBool test_14 = var_isEndOfTemplateMark.boolEnum () ;
            if (kBoolTrue == test_14) {
              GALGAS_location location_15 (enumerator_54828.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_15, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1292)) ;
            }else if (kBoolFalse == test_14) {
              var_isEndOfTemplateMark = GALGAS_bool (true) ;
            }
          }
        }
        enumerator_54828.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_54582.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1297)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_54582.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1305)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_54582.current_mEntrySpelling (HERE), enumerator_54582.current_mTerminalSpelling (HERE), enumerator_54582.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1306)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_54582.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1307)).reader_length (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1307)), enumerator_54582.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1307)), enumerator_54582.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1307))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1307)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_54582.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1308))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1308)) ;
      enumerator_54582.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_53940.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1310)) ;
    }
    enumerator_53940.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_56312 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalMessageDeclarationList, kEnumeration_up) ;
  while (enumerator_56312.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_56312.current_mMessageName (HERE), enumerator_56312.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1314)) ;
    }
    enumerator_56312.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_56533 (constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, kEnumeration_up) ;
  while (enumerator_56533.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_56533.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1318)) ;
    enumerator_56533.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_56735 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1321)), kEnumeration_up) ;
  while (enumerator_56735.hasCurrentObject ()) {
    const enumGalgasBool test_16 = enumerator_56735.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1322)).boolEnum () ;
    if (kBoolTrue == test_16) {
      GALGAS_location location_17 (enumerator_56735.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_17, GALGAS_string ("unused message")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1323)) ;
    }
    enumerator_56735.gotoNextObject () ;
  }
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_56953 (constinArgument_inLexiqueComponentAST.mAttribute_mTemplateDelimitorList, kEnumeration_up) ;
  while (enumerator_56953.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_56953.current_mStartString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1328))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1328)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_56953.current_mEndString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1329))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1329)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_57181 (enumerator_56953.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_57181.hasCurrentObject ()) {
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_57181.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1332)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_57181.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("only the 'preserved' feature is allowed here")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1333)) ;
      }else if (kBoolFalse == test_18) {
        const enumGalgasBool test_20 = var_preservesStartDelimiter.boolEnum () ;
        if (kBoolTrue == test_20) {
          GALGAS_location location_21 (enumerator_57181.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_21, GALGAS_string ("the 'preserved' feature is already set")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1335)) ;
        }else if (kBoolFalse == test_20) {
          var_preservesStartDelimiter = GALGAS_bool (true) ;
        }
      }
      enumerator_57181.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_56953.current_mStartString (HERE), enumerator_56953.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1340)) ;
    enumerator_56953.gotoNextObject () ;
  }
  const enumGalgasBool test_22 = constinArgument_inLexiqueComponentAST.mAttribute_mIndexingDirectory.mAttribute_location.reader_isNowhere (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1343)).boolEnum () ;
  if (kBoolTrue == test_22) {
    cEnumerator_indexingListAST enumerator_57791 (constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST, kEnumeration_up) ;
    while (enumerator_57791.hasCurrentObject ()) {
      GALGAS_location location_23 (enumerator_57791.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_23, GALGAS_string ("indexing declaration requires one 'indexing in \"path\";' declaration")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1345)) ;
      enumerator_57791.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1348)) ;
  cEnumerator_indexingListAST enumerator_58011 (constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST, kEnumeration_up) ;
  while (enumerator_58011.hasCurrentObject ()) {
    const enumGalgasBool test_24 = var_indexNameSet.reader_hasKey (enumerator_58011.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1350)) COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1350)).boolEnum () ;
    if (kBoolTrue == test_24) {
      GALGAS_location location_25 (enumerator_58011.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("the '").operator_concat (enumerator_58011.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1351))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1351)).operator_concat (GALGAS_string ("' index is already declared")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1351))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1351)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_58011.current_mIndexName (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1353))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1353)) ;
    enumerator_58011.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_58342 (constinArgument_inLexiqueComponentAST.mAttribute_mTemplateReplacementList, kEnumeration_up) ;
  while (enumerator_58342.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_58342.current_mMatchString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1357))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1357)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_58342.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1358))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1358)) ;
  ...
  ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1363)).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1363))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1363)) ;
  ioArgument_ioAppProductFileList.addAssign_operation (GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1364)).add_operation (GALGAS_string ("-cocoa.m"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1364))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1364)) ;
  const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1366)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_26) {
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1367)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1367))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1367)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1370)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1370)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1374)), var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1373))), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1380)), constinArgument_inLexiqueComponentAST.mAttribute_mLexicalListDeclarationList, var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST.mAttribute_mIndexingListAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1379))), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1368)) ;
    }
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1388)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_27) {
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1389)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1389))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1389)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1392)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1392)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1396)), var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1397)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1398)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1399)), var_lexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1400)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1401)), constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1395))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1390)) ;
    }
  }
  const enumGalgasBool test_28 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1411)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_28) {
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1412)).operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1412))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1412)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1415)).operator_concat (GALGAS_string ("-cocoa.h")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1415)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1418))), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_33_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1423))), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1413)) ;
    }
  }
  const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1430)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_29) {
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1431)).operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1431))  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1431)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1434)).operator_concat (GALGAS_string ("-cocoa.m")  COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1434)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1439)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1440)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1441)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("lexiqueCompilation.gSemantics", 1442)), constinArgument_inLexiqueComponentAST.mAttribute_mLexicalRuleList, var_lexiqueAnalysisContext, constinArgument_inLexiqueComponentAST COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1437))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.gSemantics", 1432)) ;
    }
  }
}
