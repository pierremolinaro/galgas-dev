...
category_method__lexicalFunctionInputArgument__checkLexicalFunctionCallArgument (C_Compiler & inLexique,
  ...
  if (operand_8381 != NULL) {
    ...
    const GGS_bool cond_9740 = (var_cas_lexicalFormalTypeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isNotEqual (operand_8381->mFunctionActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (222))) ;
...
category_method__lexicalFunctionInputArgument__checkLexicalRoutineCallArgument (C_Compiler & inLexique,
  ...
  if (operand_13252 != NULL) {
    ...
    const GGS_bool cond_14611 = (var_cas_lexicalFormalTypeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (343))).operator_isNotEqual (operand_13252->mFunctionActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (343))) ;
...
category_method__lexicalRoutineInstruction__checkLexicalInstruction (C_Compiler & inLexique,
  ...
  if (operand_20298 != NULL) {
    ...
    const GGS_bool cond_21282 = (var_cas_lexicalRoutineFormalArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (506))).operator_isNotEqual (operand_20298->mActualArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (506))) ;
    ...
    const GGS_bool cond_21953 = (var_cas_routineErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (521))).operator_isNotEqual (operand_20298->mErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (521))) ;
...
template_filewrapper_lexiqueGenerationTemplates_headerZone3 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_133 = enumerator_133.nextObject ()))) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_133->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (5)) ;
    }
    result << "} ;\n" ;
...
template_filewrapper_lexiqueGenerationTemplates_implementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_3061 = enumerator_3061.nextObject ()))) {
      ...
      result << " [] = " ;
      result << operand_3061->mInfo.mLexicalMessage.ggs_string ().reader_utf32Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    while (((operand_3610 = enumerator_3610.nextObject ()))) {
      ...
      result << operand_3610->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
      result << " [] = " ;
      result << operand_3610->mSyntaxErrorMessage.reader_utf32Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
      result << " ;\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    while (enumerator_5200.hasCurrentObject ()) {
      result << "\n"
        "//--- Unicode string for '$" ;
      result << enumerator_5200._key (HERE).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (118)) ;
      result << "$'\n"
        "static const utf32 kUnicodeString_" ;
      result << enumerator_5200._key (HERE).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
      result << " [] = " ;
      result << enumerator_5200._key (HERE).reader_utf32Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
      result << " ;\n" ;
    ...
    while (((operand_5460 = enumerator_5460.nextObject ()))) {
      ...
      result << " = " ;
      result << operand_5460->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (129)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << " ;\n"
        "\n"
      ...
      while (((operand_6214 = enumerator_6214.nextObject ()))) {
        ...
        result << operand_6214->mName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << ", " ;
        ...
        result << var_cas_LEXIQUE_CLASS_NAME ;
        result << "_1_" ;
        result << operand_6214->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
        result << "}" ;
    ...
    result << "_1_:\n"
      "      s.appendCString(\"$$\") ;\n"
      "      break ;\n" ;
    GGS_terminalList::cEnumerator enumerator_7509 (var_cas_TERMINAL_LIST, true) ;
    const GGS_terminalList::cElement * operand_7509 = NULL ;
    while (((operand_7509 = enumerator_7509.nextObject ()))) {
      macroValidPointer (operand_7509) ;
      result << "    case " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_7509->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << operand_7509->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
      result << ") ;\n"
        "      s.appendCString(\"$ \") ;\n" ;
      GGS_lexicalSentValueList::cEnumerator enumerator_7823 (operand_7509->mSentAttributeList, true) ;
      const GGS_lexicalSentValueList::cElement * operand_7823 = NULL ;
      while (((operand_7823 = enumerator_7823.nextObject ()))) {
        macroValidPointer (operand_7823) ;
        result << "      s." ;
        result << operand_7823->mLexicalType.reader_appendMethodName (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << " (ptr->mLexicalAttribute_" ;
        result << operand_7823->mAttributeName ;
        result << operand_7823->mLexicalType.reader_appendArgumentOfMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << ") ;\n" ;
      }
      result << "      break ;\n" ;
    }
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_templateReplacementList::cEnumerator enumerator_9551 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
    const GGS_templateReplacementList::cElement * operand_9551 = NULL ;
    if (enumerator_9551.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_9551 = enumerator_9551.nextObject ()))) {
        macroValidPointer (operand_9551) ;
        result << "  {kUnicodeString_" ;
        result << operand_9551->mMatchString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", " ;
        result << operand_9551->mMatchString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
        result << ", kUnicodeString_" ;
        result << operand_9551->mReplacementString.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        result << operand_9551->mReplacementString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
        result << ", " ;
        if ((operand_9551->mReplacementFunction.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (207))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "NULL" ;
        }else {
          result << "scanner_routine_" ;
          result << operand_9551->mReplacementFunction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
        result << ", true}" ;
        if (enumerator_9551.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_10596 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), true) ;
    const GGS_terminalList::cElement * operand_10596 = NULL ;
    if (enumerator_10596.hasCurrentObject ()) {
      ...
      result << "] = {\n" ;
      while (((operand_10596 = enumerator_10596.nextObject ()))) {
        macroValidPointer (operand_10596) ;
        result << "  " ;
        result << operand_10596->mIsEndOfTemplateMark.reader_cString (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " /* " ;
        result << operand_10596->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
        result << " */" ;
        if (enumerator_10596.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_13812 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_13812 = NULL ;
      while (((operand_13812 = enumerator_13812.nextObject ()))) {
        macroValidPointer (operand_13812) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_13812->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << operand_13812->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_14230 = GGS_uint (8U) ;
      if (indentation_14230.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_14230.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14014 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14014 = NULL ;
      while (((operand_14014 = enumerator_14014.nextObject ()))) {
        macroValidPointer (operand_14014) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14014->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14014->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (289))) ;
      }
       ;
      if (indentation_14230.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_14230.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_14737 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_14737 = NULL ;
      while (((operand_14737 = enumerator_14737.nextObject ()))) {
        macroValidPointer (operand_14737) ;
        result << "    token.mLexicalAttribute_" ;
        result << operand_14737->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << operand_14737->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n"
        "    try{\n" ;
      const GGS_uint indentation_15153 = GGS_uint (6U) ;
      if (indentation_15153.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_15153.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_14939 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_14939 = NULL ;
      while (((operand_14939 = enumerator_14939.nextObject ()))) {
        macroValidPointer (operand_14939) ;
        result << (findCategoryReader__abstractLexicalRule__generateCode (operand_14939->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_14939->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (314))) ;
      }
       ;
      if (indentation_15153.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_15153.uintValue ())) ;
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_16496 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_16496 = NULL ;
    while (((operand_16496 = enumerator_16496.nextObject ()))) {
      macroValidPointer (operand_16496) ;
      result << "  ptr->mLexicalAttribute_" ;
      result << operand_16496->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    result << "  enterTokenFromPointer (ptr) ;\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17073 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17073 = NULL ;
    while (((operand_17073 = enumerator_17073.nextObject ()))) {
      macroValidPointer (operand_17073) ;
      result << "void " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "assignFromAttribute_" ;
      result << operand_17073->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " (" ;
      result << operand_17073->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
      result << " & outValue) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      ...
      result << " *) mCurrentTokenPtr ;\n"
        "  outValue = " ;
      result << operand_17073->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << " (* this, ptr->mLexicalAttribute_" ;
      result << operand_17073->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
      result << ") ;\n"
        "}\n"
        "\n" ;
    }
    result << "\n"
      ...
      "//                                                                           *\n"
      "//---------------------------------------------------------------------------*\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_17888 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
    const GGS_lexicalAttributeMap::cElement * operand_17888 = NULL ;
    while (((operand_17888 = enumerator_17888.nextObject ()))) {
      macroValidPointer (operand_17888) ;
      result << operand_17888->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
      result << " " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "::\n"
        "attributeValue_" ;
      result << operand_17888->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
      result << " (void) const {\n"
        "  cTokenFor_" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << " * ptr = (cTokenFor_" ;
      ...
      result << operand_17888->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
      result << " ;\n"
        "}\n"
        "\n" ;
    }
...
template_filewrapper_lexiqueGenerationTemplates_cocoaHeaderZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_2249 = enumerator_2249.nextObject ()))) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_2249->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (48)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (48)) ;
    }
    result << "\n"
      "} ;\n"
      "\n"
  ...
  if (isBuilt) {
    ...
    if (enumerator_1579.hasCurrentObject ()) {
      ...
      while (((operand_1579 = enumerator_1579.nextObject ()))) {
        ...
        result << "  {@" ;
        result << operand_1579->mStartString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (48)) ;
        result << ", " ;
        if ((operand_1579->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (49))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          result << "nil," ;
        }else {
          result << "@" ;
          result << operand_1579->mEndString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) ;
          result << "," ;
        }
        result << " " ;
    ...
    if (enumerator_2542.hasCurrentObject ()) {
      ...
      while (((operand_2542 = enumerator_2542.nextObject ()))) {
        ...
        result << "@" ;
        result << operand_2542->mMatchString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
        result << ", " ;
      }
      result << "nil\n"
        "} ;" ;
    ...
    while (((operand_3652 = enumerator_3652.nextObject ()))) {
      ...
      if (operand_3652->mInfo.mShouldBeGenerated.boolValue ()) {
        ...
        result << " [" ;
        result << operand_3652->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (96)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ;
        result << "] = {\n" ;
        ...
        while (((operand_4398 = enumerator_4398.nextObject ()))) {
          ...
          result << "  {@" ;
          result << operand_4398->mName.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
          result << ", " ;
          result << var_cas_LEXIQUE_CLASS_NAME ;
          result << "_1_" ;
          result << operand_4398->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
          result << "}" ;
        ...
        result << ", " ;
        result << operand_3652->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (103)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_6850 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_6850 = NULL ;
      while (((operand_6850 = enumerator_6850.nextObject ()))) {
        macroValidPointer (operand_6850) ;
        result << "      " ;
        result << operand_6850->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        result << "mLexicalAttribute_" ;
        result << operand_6850->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        result << operand_6850->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        result << " ;\n" ;
      }
      result << "      mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_7271 = GGS_uint (6U) ;
      if (indentation_7271.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_7271.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7071 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7071 = NULL ;
      while (((operand_7071 = enumerator_7071.nextObject ()))) {
        macroValidPointer (operand_7071) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7071->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7071->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (146))) ;
      }
       ;
      if (indentation_7271.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_7271.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_7704 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_7704 = NULL ;
      while (((operand_7704 = enumerator_7704.nextObject ()))) {
        macroValidPointer (operand_7704) ;
        result << "    " ;
        result << operand_7704->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << "mLexicalAttribute_" ;
        result << operand_7704->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << operand_7704->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_8119 = GGS_uint (4U) ;
      if (indentation_8119.isBuilt ()) {
        result.incIndentation ((PMSInt32) indentation_8119.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7921 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7921 = NULL ;
      while (((operand_7921 = enumerator_7921.nextObject ()))) {
        macroValidPointer (operand_7921) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7921->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7921->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (170))) ;
      }
       ;
      if (indentation_8119.isBuilt ()) {
        result.incIndentation (- ((PMSInt32) indentation_8119.uintValue ())) ;
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_10487 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (224)), true) ;
    const GGS_terminalList::cElement * operand_10487 = NULL ;
    while (((operand_10487 = enumerator_10487.nextObject ()))) {
      macroValidPointer (operand_10487) ;
      result << ",\n"
        "    " ;
      result << operand_10487->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_10487->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_11303 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (239)), true) ;
    const GGS_lexicalStyleList::cElement * operand_11303 = NULL ;
    while (((operand_11303 = enumerator_11303.nextObject ()))) {
      macroValidPointer (operand_11303) ;
      result << ",\n"
        "    @" ;
      result << operand_11303->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (240)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_12054 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), true) ;
    const GGS_lexicalStyleList::cElement * operand_12054 = NULL ;
    while (((operand_12054 = enumerator_12054.nextObject ()))) {
      macroValidPointer (operand_12054) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_12054->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
...
void routine_parseLexiqueComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_27980 = var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (678)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (678)) COMMA_SOURCE_FILE_AT_LINE (678)) ;
...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
  ...
  GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (703)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (703)) ;
  ...
  }
  {
    ...
    while (((operand_32513 = enumerator_32513.nextObject ()))) {
      ...
      const GGS_bool cond_32806 = var_cas_lexicalTypeMap.reader_hasKey (inLexique, operand_32513->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (768)) COMMA_SOURCE_FILE_AT_LINE (768)) ;
  ...
  }
  {
    ...
    while (((operand_33196 = enumerator_33196.nextObject ()))) {
      ...
      const GGS_bool cond_33416 = (operand_33196->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (787)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (787))).operator_strictSup (GGS_uint (0U)) ;
  ...
  }
  {
    ...
    while (((operand_34409 = enumerator_34409.nextObject ()))) {
      ...
      GGS_uint  var_cas_terminalStyleIndex = GGS_uint (0U) ;
      const GGS_bool cond_34632 = (operand_34409->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (817)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (817))).operator_strictSup (GGS_uint (0U)) ;
      if (cond_34632.isBuiltAndTrue ()) {
        ...
        if (temp_34590.isBuilt ()) {
          temp_34590 (HERE)->method_searchKey (inLexique, operand_34409->mStyle, automatic_var_12, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (818)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
      ...
      GGS_tokenSortedlist  var_cas_tokenSortedlist = GGS_tokenSortedlist ::constructor_emptySortedList () ;
      {
        ...
        while (((operand_35101 = enumerator_35101.nextObject ()))) {
          ...
          var_cas_tokenSortedlist.addAssign_operation (operand_35101->mEntrySpelling.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (849)), operand_35101->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849)), operand_35101->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849))) ;
