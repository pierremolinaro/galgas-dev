...
template_filewrapper_lexiqueGenerationTemplates_headerZone3 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_lexicalAttributeMap::cEnumerator enumerator_544 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (17)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_544 = NULL ;
    while (((operand_544 = enumerator_544.nextObject ()))) {
      macroValidPointer (operand_544) ;
      result << "  public : void assignFromAttribute_" ;
      result << operand_544->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
      result << " (" ;
      result << operand_544->mInfo.mLexicalType.reader_exportedCPPTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
      result << " & outValue) const ;\n" ;
    }
    result << "\n"
      "\n"
      "//--- Attribute access\n" ;
    GGS_lexicalAttributeMap::cEnumerator enumerator_768 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (24)), true) ;
    const GGS_lexicalAttributeMap::cElement * operand_768 = NULL ;
    while (((operand_768 = enumerator_768.nextObject ()))) {
      macroValidPointer (operand_768) ;
      result << "  public : " ;
      result << operand_768->mInfo.mLexicalType.reader_cppTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (25)) ;
      result << " attributeValue_" ;
      result << operand_768->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (25)) ;
      result << " (void) const ;\n" ;
    }
    result << "\n"
      "\n"
...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if (enumerator_1709.hasCurrentObject ()) {
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
      result << " [" ;
      ...
      while (((operand_1709 = enumerator_1709.nextObject ()))) {
        ...
        result << "  {@" ;
        result << operand_1709->mStartString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
        result << ", " ;
        if ((operand_1709->mEndString.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (52))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
          ...
          result << "@" ;
          result << operand_1709->mEndString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
          result << "," ;
        }
        result << " nil, " ;
    ...
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_terminalList::cEnumerator enumerator_2671 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (70)), true) ;
    const GGS_terminalList::cElement * operand_2671 = NULL ;
    if (enumerator_2671.hasCurrentObject ()) {
      result << "static const BOOL kEndOfScriptInTemplateArray_" ;
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
      result << " [" ;
      result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (71)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (71)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
      result << "] = {\n" ;
      while (((operand_2671 = enumerator_2671.nextObject ()))) {
        macroValidPointer (operand_2671) ;
        result << "  " ;
        result << operand_2671->mIsEndOfTemplateMark.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ;
        result << " /* " ;
        result << operand_2671->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ;
        result << " */" ;
        if (enumerator_2671.hasNextObject ()) {
          result << ",\n" ;
        }
      }
      result << "\n"
    ...
    result << "\n"
      "\n" ;
    GGS_lexicalExplicitTokenListMapMap::cEnumerator enumerator_3048 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mLexicalTokenListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (79)), true) ;
    const GGS_lexicalExplicitTokenListMapMap::cElement * operand_3048 = NULL ;
    while (((operand_3048 = enumerator_3048.nextObject ()))) {
      macroValidPointer (operand_3048) ;
      if (operand_3048->mInfo.mShouldBeGenerated.boolValue ()) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << operand_3048->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
          "static const C_cocoa_lexique_table_entry ktable_for_" ;
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
        result << "_" ;
        result << operand_3048->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
        result << " [" ;
        result << operand_3048->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (86)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
        result << "] = {\n" ;
        GGS_tokenSortedlist::cEnumerator enumerator_3798 (operand_3048->mInfo.mTokenSortedList, true) ;
        const GGS_tokenSortedlist::cElement * operand_3798 = NULL ;
        while (((operand_3798 = enumerator_3798.nextObject ()))) {
          macroValidPointer (operand_3798) ;
          result << "  {@" ;
          result << operand_3798->mName.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
          result << ", " ;
          result << var_cas_LEXIQUE_CLASS_NAME ;
          result << "_1_" ;
          result << operand_3798->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
          result << "}" ;
        ...
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
        result << "_" ;
        result << operand_3048->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
        result << " (NSString * inSearchedString) {\n"
          "  return searchStringInTable (inSearchedString, ktable_for_" ;
        result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) ;
        result << "_" ;
        result << operand_3048->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) ;
        result << ", " ;
        result << operand_3048->mInfo.mExplicitTokenListMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (93)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (110)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (110))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      result << "    if ((mMatchedTemplateDelimiterIndex >= 0)\n"
        "     && ([kTemplateDefinitionArray_" ;
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (114)) ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (121)) ;
      result << " listLength:" ;
      result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121)) ;
      result << "] ;\n"
        "      if (mMatchedTemplateDelimiterIndex < 0) {\n"
        "        [self advance] ;\n"
        "      }\n"
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_6064 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_6064 = NULL ;
      while (((operand_6064 = enumerator_6064.nextObject ()))) {
        macroValidPointer (operand_6064) ;
        result << "      " ;
        result << operand_6064->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
        result << "mLexicalAttribute_" ;
        result << operand_6064->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
        result << operand_6064->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_6504 = GGS_uint (6U) ;
      if (indentation_6504.isBuilt ()) {
        result.incIndentation ((sint32) indentation_6504.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_6286 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_6286 = NULL ;
      while (((operand_6286 = enumerator_6286.nextObject ()))) {
        macroValidPointer (operand_6286) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_6286->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_6286->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (134))) ;
      }
       ;
      if (indentation_6504.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_6504.uintValue ())) ;
      ...
      result << var_cas_LEXIQUE_CLASS_NAME.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
      result << " [mTokenCode - 1]) {\n"
        "      mMatchedTemplateDelimiterIndex = -1 ;\n"
        "    }\n"
        "  " ;
    }else {
      GGS_lexicalAttributeMap::cEnumerator enumerator_6830 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_6830 = NULL ;
      while (((operand_6830 = enumerator_6830.nextObject ()))) {
        macroValidPointer (operand_6830) ;
        result << "    " ;
        result << operand_6830->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << "mLexicalAttribute_" ;
        result << operand_6830->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << operand_6830->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_7266 = GGS_uint (4U) ;
      if (indentation_7266.isBuilt ()) {
        result.incIndentation ((sint32) indentation_7266.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_7050 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_7050 = NULL ;
      while (((operand_7050 = enumerator_7050.nextObject ()))) {
        macroValidPointer (operand_7050) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_7050->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_7050->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (154))) ;
      }
       ;
      if (indentation_7266.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_7266.uintValue ())) ;
    ...
    result << "\n"
      ...
      "- (UInt32) terminalVocabularyCount {\n"
      "  return " ;
    result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (177)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (177)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (177)) ;
    result << " ;\n"
      "}\n"
      "\n"
      "//---------------------------------------------------------------------------*\n"
      ...
      "- (UInt32) styleCount {\n"
      "  return " ;
    result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
    result << " ;\n"
      "}\n"
      "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    result << var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (197)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (197)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_9105 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), true) ;
    const GGS_terminalList::cElement * operand_9105 = NULL ;
    while (((operand_9105 = enumerator_9105.nextObject ()))) {
      macroValidPointer (operand_9105) ;
      result << ",\n"
        "    " ;
      result << operand_9105->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_9105->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (211)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (211)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (211)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_9923 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (213)), true) ;
    const GGS_lexicalStyleList::cElement * operand_9923 = NULL ;
    while (((operand_9923 = enumerator_9923.nextObject ()))) {
      macroValidPointer (operand_9923) ;
      result << ",\n"
        "    @" ;
      result << operand_9923->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)).reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
    }
    result << "\n"
      "  } ;\n"
      ...
      "- (NSString *) styleIdentifierForStyleIndex: (SInt32) inIndex {\n"
      "  NSString * kStyleArray [" ;
    result << var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (226)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (226)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (226)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (226)) ;
    result << "] = {\n"
      "    @\"" ;
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_10675 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (228)), true) ;
    const GGS_lexicalStyleList::cElement * operand_10675 = NULL ;
    while (((operand_10675 = enumerator_10675.nextObject ()))) {
      macroValidPointer (operand_10675) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_10675->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
...
void routine_parseLexiqueComponent (C_Compiler & inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (679)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679))).isBuiltAndTrue ()) {
    const GGS_parsedLexiqueComponentMap  temp_27990 = var_cas_ioParsedComponentStruct.reader_mParsedLexiqueComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (680)) ;
    if (temp_27990.isBuilt ()) {
      temp_27990 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_outLexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (680)) ;
    }
  }else{
...
void routine_compileLexiqueComponent (C_Compiler & inLexique,
  ...
  {
    GGS_externRoutineList::cEnumerator enumerator_30303 (var_cas_lexiqueComponentRoot.reader_mExternRoutineList (inLexique COMMA_SOURCE_FILE_AT_LINE (724)), true) ;
    const GGS_externRoutineList::cElement * operand_30303 = NULL ;
    while (((operand_30303 = enumerator_30303.nextObject ()))) {
      macroValidPointer (operand_30303) ;
      GGS_lexicalRoutineFormalArgumentList  var_cas_lexicalRoutineFormalArgumentList ;
      var_cas_lexicalRoutineFormalArgumentList = GGS_lexicalRoutineFormalArgumentList ::constructor_emptyList () ;
      {
        GGS_lexicalExternRoutineFormalArgumentList::cEnumerator enumerator_30477 (operand_30303->mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalExternRoutineFormalArgumentList::cElement * operand_30477 = NULL ;
        while (((operand_30477 = enumerator_30477.nextObject ()))) {
          macroValidPointer (operand_30477) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          const GGS_lexicalTypeMap  temp_30563 = var_cas_lexicalTypeMap ;
          if (temp_30563.isBuilt ()) {
            temp_30563 (HERE)->method_searchKey (inLexique, operand_30477->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (728)) ;
          }
          var_cas_lexicalRoutineFormalArgumentList._addAssign_operation (operand_30477->mPassingMode, var_cas_lexicalFormalArgumentType, operand_30477->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (729))) ;
        }
      }
      var_cas_lexicalRoutineMap.modifier_insertKey (inLexique, operand_30303->mRoutineName, var_cas_lexicalRoutineFormalArgumentList, operand_30303->mErrorMessageList, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (731)) ;
    }
  }
  ...
  {
    GGS_externFunctionList::cEnumerator enumerator_31108 (var_cas_lexiqueComponentRoot.reader_mExternFunctionList (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), true) ;
    const GGS_externFunctionList::cElement * operand_31108 = NULL ;
    while (((operand_31108 = enumerator_31108.nextObject ()))) {
      macroValidPointer (operand_31108) ;
      ...
      {
        GGS_lexicalExternFunctionFormalArgumentList::cEnumerator enumerator_31286 (operand_31108->mLexicalFunctionFormalArgumentList, true) ;
        const GGS_lexicalExternFunctionFormalArgumentList::cElement * operand_31286 = NULL ;
        while (((operand_31286 = enumerator_31286.nextObject ()))) {
          macroValidPointer (operand_31286) ;
          GGS_lexicalTypeEnum var_cas_lexicalFormalArgumentType ;
          const GGS_lexicalTypeMap  temp_31372 = var_cas_lexicalTypeMap ;
          if (temp_31372.isBuilt ()) {
            temp_31372 (HERE)->method_searchKey (inLexique, operand_31286->mLexicalTypeName, var_cas_lexicalFormalArgumentType COMMA_SOURCE_FILE_AT_LINE (741)) ;
          }
          var_cas_lexicalFunctionFormalArgumentList._addAssign_operation (var_cas_lexicalFormalArgumentType, operand_31286->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (742))) ;
        }
      }
      GGS_lexicalTypeEnum var_cas_returnedArgumentType ;
      const GGS_lexicalTypeMap  temp_31614 = var_cas_lexicalTypeMap ;
      if (temp_31614.isBuilt ()) {
        temp_31614 (HERE)->method_searchKey (inLexique, operand_31108->mReturnedTypeName, var_cas_returnedArgumentType COMMA_SOURCE_FILE_AT_LINE (745)) ;
      }
      var_cas_lexicalFunctionMap.modifier_insertKey (inLexique, operand_31108->mFunctionName, var_cas_lexicalFunctionFormalArgumentList, var_cas_returnedArgumentType, GGS_string (""), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (746)) ;
    }
  }
  ...
  {
    GGS_lexicalStyleList::cEnumerator enumerator_32312 (var_cas_lexiqueComponentRoot.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (763)), true) ;
    const GGS_lexicalStyleList::cElement * operand_32312 = NULL ;
    while (((operand_32312 = enumerator_32312.nextObject ()))) {
      macroValidPointer (operand_32312) ;
      var_cas_lexiqueAnalysisContext.mStyleMap.modifier_insertKey (inLexique, operand_32312->mName, operand_32312->mComment, var_cas_styleIndex COMMA_SOURCE_FILE_AT_LINE (764)) ;
      var_cas_styleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (765)) ;
    }
  }
  {
    GGS_lexicalAttributeList::cEnumerator enumerator_32563 (var_cas_lexiqueComponentRoot.reader_mLexicalAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (768)), true) ;
    const GGS_lexicalAttributeList::cElement * operand_32563 = NULL ;
    while (((operand_32563 = enumerator_32563.nextObject ()))) {
      macroValidPointer (operand_32563) ;
      if ((var_cas_lexicalTypeMap.reader_hasKey (inLexique, operand_32563->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (769)) COMMA_SOURCE_FILE_AT_LINE (769))).isBuiltAndTrue ()) {
        GGS_lexicalTypeEnum var_cas_lexicalType ;
        const GGS_lexicalTypeMap  temp_32734 = var_cas_lexicalTypeMap ;
        if (temp_32734.isBuilt ()) {
          temp_32734 (HERE)->method_searchKey (inLexique, operand_32563->mTypeName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (771)) ;
        }
        var_cas_lexiqueAnalysisContext.mLexicalAttributeMap.modifier_insertKey (inLexique, operand_32563->mName, var_cas_lexicalType COMMA_SOURCE_FILE_AT_LINE (772)) ;
      }else{
        GGS_string var_cas_m ;
        var_cas_m = GGS_string ("") ;
        var_cas_m.appendCString ("the @") ;
        var_cas_m.dotAssign_operation (operand_32563->mTypeName) ;
        ...
        {
          GGS_lexicalTypeMap::cEnumerator enumerator_33036 (var_cas_lexicalTypeMap, true) ;
          const GGS_lexicalTypeMap::cElement * operand_33036 = enumerator_33036.nextObject () ;
          if ((operand_33036 != NULL)) {
            bool _foreach_loop_33036 ;
            do{
              macroValidPointer (operand_33036) ;
              var_cas_m.appendCString (" @") ;
              var_cas_m.dotAssign_operation (operand_33036->mKey) ;
              operand_33036 = enumerator_33036.nextObject () ;
              _foreach_loop_33036 = ((operand_33036 != NULL)) ;
              if (_foreach_loop_33036) {
                var_cas_m.appendCString (",") ;
              }
            }while (_foreach_loop_33036) ;
          }
        }
        operand_32563->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (783)) ;
      }
    }
  }
  {
    GGS_terminalDeclarationList::cEnumerator enumerator_33246 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), true) ;
    const GGS_terminalDeclarationList::cElement * operand_33246 = NULL ;
    while (((operand_33246 = enumerator_33246.nextObject ()))) {
      ...
      if (((operand_33246->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (788)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (788))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_11 ;
        const GGS_styleMap  temp_33424 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (789)) ;
        if (temp_33424.isBuilt ()) {
          temp_33424 (HERE)->method_searchKey (inLexique, operand_33246->mStyle, automatic_var_11, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (789)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_33559 (operand_33246->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_33559 = NULL ;
        while (((operand_33559 = enumerator_33559.nextObject ()))) {
          macroValidPointer (operand_33559) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_33698 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (794)) ;
          if (temp_33698.isBuilt ()) {
            temp_33698 (HERE)->method_searchKey (inLexique, operand_33559->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (794)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (operand_33559->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), var_cas_attributeLexicalType) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_33246->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (797)) ;
      GGS_bool var_cas_isEndOfTemplateMark ;
      var_cas_isEndOfTemplateMark = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_33978 (operand_33246->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_33978 = NULL ;
        while (((operand_33978 = enumerator_33978.nextObject ()))) {
          macroValidPointer (operand_33978) ;
          if (((operand_33978->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (800))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
            operand_33978->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (802)) ;
          }else if ((var_cas_isEndOfTemplateMark).isBuiltAndTrue ()) {
            operand_33978->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (804)) ;
          }else{
            var_cas_isEndOfTemplateMark = GGS_bool (true) ;
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTerminalList._addAssign_operation (operand_33246->mName, var_cas_argumentTypeList, operand_33246->mSyntaxErrorMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (811)), var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
    }
  }
  {
    GGS_lexicalListDeclarationList::cEnumerator enumerator_34501 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (816)), true) ;
    const GGS_lexicalListDeclarationList::cElement * operand_34501 = NULL ;
    while (((operand_34501 = enumerator_34501.nextObject ()))) {
      macroValidPointer (operand_34501) ;
      GGS_uint  var_cas_terminalStyleIndex ;
      var_cas_terminalStyleIndex = GGS_uint (0U) ;
      if (((operand_34501->mStyle.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (818)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (818))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        GGS_lstring  automatic_var_12 ;
        const GGS_styleMap  temp_34682 = var_cas_lexiqueAnalysisContext.reader_mStyleMap (inLexique COMMA_SOURCE_FILE_AT_LINE (819)) ;
        if (temp_34682.isBuilt ()) {
          temp_34682 (HERE)->method_searchKey (inLexique, operand_34501->mStyle, automatic_var_12, var_cas_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (819)) ;
        }
      }
      GGS_lexicalSentValueList  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_lexicalSentValueList ::constructor_emptyList () ;
      {
        GGS_lstringlist::cEnumerator enumerator_34817 (operand_34501->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_34817 = NULL ;
        while (((operand_34817 = enumerator_34817.nextObject ()))) {
          macroValidPointer (operand_34817) ;
          GGS_lexicalTypeEnum var_cas_attributeLexicalType ;
          const GGS_lexicalAttributeMap  temp_34955 = var_cas_lexiqueAnalysisContext.reader_mLexicalAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (824)) ;
          if (temp_34955.isBuilt ()) {
            temp_34955 (HERE)->method_searchKey (inLexique, operand_34817->mValue, var_cas_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (824)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (operand_34817->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (825)), var_cas_attributeLexicalType) ;
        }
      }
      ...
      {
        GGS_lexicalListEntryList::cEnumerator enumerator_35235 (operand_34501->mEntryList, true) ;
        const GGS_lexicalListEntryList::cElement * operand_35235 = NULL ;
        while (((operand_35235 = enumerator_35235.nextObject ()))) {
          macroValidPointer (operand_35235) ;
          GGS_string var_cas_syntaxErrorMessage ;
          var_cas_syntaxErrorMessage = operand_34501->mSyntaxErrorMessage.ggs_string ().reader_stringByReplacingStringByString (inLexique, GGS_string ("%K"), operand_35235->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830)) COMMA_SOURCE_FILE_AT_LINE (830)) ;
          GGS_bool var_cas_isEndOfTemplateMark ;
          var_cas_isEndOfTemplateMark = GGS_bool (false) ;
          {
            GGS_lstringlist::cEnumerator enumerator_35434 (operand_35235->mFeatureList, true) ;
            const GGS_lstringlist::cElement * operand_35434 = NULL ;
            while (((operand_35434 = enumerator_35434.nextObject ()))) {
              macroValidPointer (operand_35434) ;
              if (((operand_35434->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (833))).operator_isNotEqual (GGS_string ("templateEndMark"))).isBuiltAndTrue ()) {
                operand_35434->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'templateEndMark' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (835)) ;
              }else if ((var_cas_isEndOfTemplateMark).isBuiltAndTrue ()) {
                operand_35434->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'templateEndMark' feature is already set") COMMA_SOURCE_FILE_AT_LINE (837)) ;
              }else{
                var_cas_isEndOfTemplateMark = GGS_bool (true) ;
              }
            }
          }
          var_cas_lexiqueAnalysisContext.mTerminalList._addAssign_operation (operand_35235->mTerminalSpelling, var_cas_argumentTypeList, var_cas_syntaxErrorMessage, var_cas_isEndOfTemplateMark, var_cas_terminalStyleIndex) ;
          var_cas_lexiqueAnalysisContext.mTerminalMap.modifier_insertKey (inLexique, operand_35235->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (848)) ;
          var_cas_lexicalTokenListMap.modifier_insertKey (inLexique, operand_35235->mEntrySpelling, operand_35235->mTerminalSpelling, operand_35235->mFeatureList COMMA_SOURCE_FILE_AT_LINE (849)) ;
          var_cas_tokenSortedlist._addAssign_operation (operand_35235->mEntrySpelling.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_35235->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_35235->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (850))) ;
          var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_35235->mEntrySpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (851))) ;
        }
      }
      var_cas_lexiqueAnalysisContext.mLexicalTokenListMap.modifier_insertKey (inLexique, operand_34501->mName, var_cas_lexicalTokenListMap, var_cas_tokenSortedlist, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (853)) ;
    }
  }
  {
    GGS_lexicalMessageDeclarationList::cEnumerator enumerator_36557 (var_cas_lexiqueComponentRoot.reader_mLexicalMessageDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (856)), true) ;
    const GGS_lexicalMessageDeclarationList::cElement * operand_36557 = NULL ;
    while (((operand_36557 = enumerator_36557.nextObject ()))) {
      macroValidPointer (operand_36557) ;
      var_cas_lexiqueAnalysisContext.mLexicalMessageMap.modifier_insertKey (inLexique, operand_36557->mMessageName, operand_36557->mMessageValue, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    }
  }
  {
    GGS_lexicalRuleList::cEnumerator enumerator_36791 (var_cas_lexiqueComponentRoot.reader_mLexicalRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (860)), true) ;
    const GGS_lexicalRuleList::cElement * operand_36791 = NULL ;
    while (((operand_36791 = enumerator_36791.nextObject ()))) {
      macroValidPointer (operand_36791) ;
      const GGS_abstractLexicalRule  temp_36867 = operand_36791->mLexicalRule ;
      if (temp_36867.isBuilt ()) {
        typeCategoryMethod__abstractLexicalRule__checkLexicalRule method = findCategoryMethod__abstractLexicalRule__checkLexicalRule (temp_36867.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_36867 (HERE), var_cas_lexiqueAnalysisContext COMMA_SOURCE_FILE_AT_LINE (861)) ;
        }
      }
    }
  }
  {
    GGS_lexicalMessageMap::cEnumerator enumerator_36989 (var_cas_lexiqueAnalysisContext.reader_mLexicalMessageMap (inLexique COMMA_SOURCE_FILE_AT_LINE (864)), true) ;
    const GGS_lexicalMessageMap::cElement * operand_36989 = NULL ;
    while (((operand_36989 = enumerator_36989.nextObject ()))) {
      macroValidPointer (operand_36989) ;
      if (((operand_36989->mInfo.mMessageIsUsed).operator_not ()).isBuiltAndTrue ()) {
        operand_36989->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unused message") COMMA_SOURCE_FILE_AT_LINE (866)) ;
      }
    }
  }
  {
    GGS_metamodelTemplateDelimitorList::cEnumerator enumerator_37204 (var_cas_lexiqueComponentRoot.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (870)), true) ;
    const GGS_metamodelTemplateDelimitorList::cElement * operand_37204 = NULL ;
    while (((operand_37204 = enumerator_37204.nextObject ()))) {
      macroValidPointer (operand_37204) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37204->mStartString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (871))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37204->mEndString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (872))) ;
      GGS_bool var_cas_preservesStartDelimiter ;
      var_cas_preservesStartDelimiter = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_37474 (operand_37204->mOptionList, true) ;
        const GGS_lstringlist::cElement * operand_37474 = NULL ;
        while (((operand_37474 = enumerator_37474.nextObject ()))) {
          macroValidPointer (operand_37474) ;
          if (((operand_37474->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (875))).operator_isNotEqual (GGS_string ("preserved"))).isBuiltAndTrue ()) {
            operand_37474->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'preserved' feature is allowed here") COMMA_SOURCE_FILE_AT_LINE (877)) ;
          }else if ((var_cas_preservesStartDelimiter).isBuiltAndTrue ()) {
            operand_37474->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'preserved' feature is already set") COMMA_SOURCE_FILE_AT_LINE (879)) ;
          }else{
            var_cas_preservesStartDelimiter = GGS_bool (true) ;
          }
        }
      }
      var_cas_lexiqueAnalysisContext.mTemplateDelimitorList._addAssign_operation (operand_37204->mStartString, operand_37204->mEndString, var_cas_preservesStartDelimiter) ;
    }
  }
  {
    GGS_templateReplacementList::cEnumerator enumerator_37972 (var_cas_lexiqueComponentRoot.reader_mTemplateReplacementList (inLexique COMMA_SOURCE_FILE_AT_LINE (886)), true) ;
    const GGS_templateReplacementList::cElement * operand_37972 = NULL ;
    while (((operand_37972 = enumerator_37972.nextObject ()))) {
      macroValidPointer (operand_37972) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37972->mMatchString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (887))) ;
      var_cas_lexiqueAnalysisContext.mUnicodeStringToGenerate._addAssign_operation (operand_37972->mReplacementString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (888))) ;
    }
  }
