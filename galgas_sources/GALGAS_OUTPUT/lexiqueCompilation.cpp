...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_4115 = enumerator_4115.nextObject ()))) {
      ...
      if (operand_4115->mInfo.mShouldBeGenerated.boolValue ()) {
        ...
        while (((operand_4815 = enumerator_4815.nextObject ()))) {
          ...
          result << "  {@" ;
          result << operand_4815->mName.reader_CStringConstantRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
          result << ", " ;
          result << var_cas_LEXIQUE_CLASS_NAME ;
          result << "_1_" ;
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (131)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_8165 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_8165 = NULL ;
      while (((operand_8165 = enumerator_8165.nextObject ()))) {
        macroValidPointer (operand_8165) ;
        result << "    mLexicalAttribute_" ;
        result << operand_8165->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
        result << operand_8165->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_8567 = GGS_uint (6U) ;
      if (indentation_8567.isBuilt ()) {
        result.incIndentation ((sint32) indentation_8567.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_8354 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_8354 = NULL ;
      while (((operand_8354 = enumerator_8354.nextObject ()))) {
        macroValidPointer (operand_8354) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_8354->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_8354->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (175))) ;
      }
       ;
      if (indentation_8567.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_8567.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_8848 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_8848 = NULL ;
      while (((operand_8848 = enumerator_8848.nextObject ()))) {
        macroValidPointer (operand_8848) ;
        result << "    " ;
        result << operand_8848->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
        result << "mLexicalAttribute_" ;
        result << operand_8848->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
        result << operand_8848->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_9286 = GGS_uint (4U) ;
      if (indentation_9286.isBuilt ()) {
        result.incIndentation ((sint32) indentation_9286.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_9068 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_9068 = NULL ;
      while (((operand_9068 = enumerator_9068.nextObject ()))) {
        macroValidPointer (operand_9068) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_9068->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_9068->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (195))) ;
      }
       ;
      if (indentation_9286.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_9286.uintValue ())) ;
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_11176 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), true) ;
    const GGS_terminalList::cElement * operand_11176 = NULL ;
    while (((operand_11176 = enumerator_11176.nextObject ()))) {
      macroValidPointer (operand_11176) ;
      result << ",\n"
        "    " ;
      result << operand_11176->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_11176->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_11994 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), true) ;
    const GGS_lexicalStyleList::cElement * operand_11994 = NULL ;
    while (((operand_11994 = enumerator_11994.nextObject ()))) {
      macroValidPointer (operand_11994) ;
      result << ",\n"
        "    @" ;
      result << operand_11994->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_CStringConstantRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_12757 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (268)), true) ;
    const GGS_lexicalStyleList::cElement * operand_12757 = NULL ;
    while (((operand_12757 = enumerator_12757.nextObject ()))) {
      macroValidPointer (operand_12757) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_12757->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
