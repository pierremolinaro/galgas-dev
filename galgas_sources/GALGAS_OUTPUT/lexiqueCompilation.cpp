...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  result << "\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (14)).reader_length (SOURCE_FILE_AT_LINE (14)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result << "static NSArray * kTemplateDefinitionArray_" ;
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (15)).stringValue () ;
    result << " ;\n" ;
  }else if (kBoolFalse == test_0) {
  }
  result << "\n"
    ...
    "  self = [super init] ;\n"
    "  if (self) {\n" ;
  GALGAS_uint index_943_ (0) ;
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_943 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
    while (enumerator_943.hasCurrentObject ()) {
      result << "    mLexicalAttribute_" ;
      result << enumerator_943.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (23)).stringValue () ;
      result << " = " ;
      result << categoryReader_cocoaInitializationCode (enumerator_943.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (23)).stringValue () ;
      result << " ;\n" ;
      index_943_.increment () ;
      enumerator_943.gotoNextObject () ;
    }
  }
  result << "  }\n" ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (26)).reader_length (SOURCE_FILE_AT_LINE (26)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    result << "  if (nil == kTemplateDefinitionArray_" ;
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (27)).stringValue () ;
    result << ") {\n"
      "    kTemplateDefinitionArray_" ;
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (28)).stringValue () ;
    result << " = [NSArray arrayWithObjects:\n" ;
    GALGAS_uint index_1435_ (0) ;
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (29)).isValid ()) {
      cEnumerator_templateDelimitorList enumerator_1435 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (29)), kEnumeration_up) ;
      while (enumerator_1435.hasCurrentObject ()) {
        result << "      [[OC_GGS_TemplateDelimiter alloc] initWithStartString:@" ;
        result << enumerator_1435.current_mStartString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (30)).stringValue () ;
        result << " endString:" ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_1435.current_mEndString (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (31)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_2) {
          result << "nil" ;
        }else if (kBoolFalse == test_2) {
          result << "@" ;
          result << enumerator_1435.current_mEndString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (34)).stringValue () ;
        }
        result << " discardStartString:" ;
        result << enumerator_1435.current_mPreservesStartDelimiter (HERE).operator_not (SOURCE_FILE_AT_LINE (37)).reader_ocString (SOURCE_FILE_AT_LINE (37)).stringValue () ;
        result << "],\n" ;
  ...
  result << "  return self ;\n"
    ...
    "- (NSString *) indexingDirectory {\n"
    "  return @" ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingDirectory (SOURCE_FILE_AT_LINE (54)).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
  ...
  GALGAS_uint index_2842_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (66)).isValid ()) {
    cEnumerator_indexingListAST enumerator_2842 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (66)), kEnumeration_up) ;
    while (enumerator_2842.hasCurrentObject ()) {
      result << "    @" ;
      result << enumerator_2842.current_mIndexComment (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (67)).stringValue () ;
      result << ",\n" ;
      index_2842_.increment () ;
  ...
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (79)).isValid ()) {
    cEnumerator_templateReplacementListAST enumerator_3573 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (79)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_3573 = enumerator_3573.hasCurrentObject () ;
    if (nonEmpty_enumerator_3573) {
      result << "static NSString * kTemplateReplacementArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (80)).stringValue () ;
      result << " [" ;
      result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (80)).reader_length (SOURCE_FILE_AT_LINE (80)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (80)).reader_string (SOURCE_FILE_AT_LINE (80)).stringValue () ;
      result << "] = {\n"
        "  " ;
    }
    while (enumerator_3573.hasCurrentObject ()) {
      result << "@" ;
      result << enumerator_3573.current_mMatchString (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << ", " ;
  ...
  result << "\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_4286_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (92)).isValid ()) {
    cEnumerator_terminalList enumerator_4286 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (92)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_4286 = enumerator_4286.hasCurrentObject () ;
    if (nonEmpty_enumerator_4286) {
      result << "static const BOOL kEndOfScriptInTemplateArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (93)).stringValue () ;
      result << " [" ;
      result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (93)).reader_length (SOURCE_FILE_AT_LINE (93)).reader_string (SOURCE_FILE_AT_LINE (93)).stringValue () ;
      result << "] = {\n" ;
    }
    while (enumerator_4286.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4286.current_mIsEndOfTemplateMark (HERE).reader_ocString (SOURCE_FILE_AT_LINE (94)).stringValue () ;
      result << " /* " ;
      result << enumerator_4286.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (94)).stringValue () ;
      result << " */" ;
      if (enumerator_4286.hasNextObject ()) {
        result << ",\n" ;
      }
      index_4286_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (101)).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_4498 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (101)), kEnumeration_up) ;
    while (enumerator_4498.hasCurrentObject ()) {
      const enumGalgasBool test_3 = enumerator_4498.current_mShouldBeGenerated (HERE).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "//---------------------------------------------------------------------------*\n"
          "//                                                                           *\n"
          "//             Key words table '" ;
        result << enumerator_4498.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (105)).stringValue () ;
        result << "'                            *\n"
          "//                                                                           *\n"
          "//---------------------------------------------------------------------------*\n"
          "\n"
        ...
        result << "_" ;
        result << enumerator_4498.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (108)).stringValue () ;
        result << " [" ;
        result << enumerator_4498.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (108)).reader_string (SOURCE_FILE_AT_LINE (108)).stringValue () ;
        result << "] = {\n" ;
        GALGAS_uint index_5247_ (0) ;
        if (enumerator_4498.current_mTokenSortedList (HERE).isValid ()) {
          cEnumerator_tokenSortedlist enumerator_5247 (enumerator_4498.current_mTokenSortedList (HERE), kEnumeration_up) ;
          while (enumerator_5247.hasCurrentObject ()) {
            result << "  {@" ;
            result << enumerator_5247.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (110)).stringValue () ;
            result << ", " ;
            result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
            result << "_1_" ;
            result << enumerator_5247.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (110)).stringValue () ;
            result << "}" ;
            if (enumerator_5247.hasNextObject ()) {
              result << ",\n" ;
            }
            index_5247_.increment () ;
        ...
        result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (114)).stringValue () ;
        result << "_" ;
        result << enumerator_4498.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (114)).stringValue () ;
        result << " (NSString * inSearchedString) {\n"
          "  return searchStringInTable (inSearchedString, ktable_for_" ;
        result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << "_" ;
        result << enumerator_4498.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << ", " ;
        result << enumerator_4498.current_mExplicitTokenListMap (HERE).reader_count (SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << ") ;\n"
          "}\n"
          "\n" ;
      }else if (kBoolFalse == test_3) {
  ...
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (133)).reader_length (SOURCE_FILE_AT_LINE (133)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    ...
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (135)).stringValue () ;
    result << " objectAtIndex:mMatchedTemplateDelimiterIndex] endString] advance:YES] ;\n"
      ...
      "      " ;
    const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (141)).reader_length (SOURCE_FILE_AT_LINE (141)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_5) {
      result << "\n"
        "      [self searchForReplacementPattern:kTemplateReplacementArray_" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (142)).stringValue () ;
      result << "] ;\n"
        "      " ;
    ...
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (144)).stringValue () ;
    result << "] ;\n"
      "      if (mMatchedTemplateDelimiterIndex < 0) {\n"
      "        [self advance] ;\n"
      "        mTokenCode = -2 ;\n"
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_7686 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_7686.hasCurrentObject ()) {
        result << "      " ;
        result << categoryReader_cocoaResetPrefix (enumerator_7686.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (152)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_7686.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (152)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_7686.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (152)).stringValue () ;
        result << " ;\n" ;
    ...
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_7902 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_7902.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_7902.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)).stringValue () ;
    ...
    result << in_LEXIQUE_5F_CLASS_5F_NAME.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (167)).stringValue () ;
    result << " [mTokenCode - 1]) {\n"
      "      mMatchedTemplateDelimiterIndex = -1 ;\n"
      "    }\n"
      "  //--- Error \?\n"
    ...
    GALGAS_uint index_8539_ (0) ;
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      cEnumerator_lexicalAttributeMap enumerator_8539 (in_LEXICAL_5F_ATTRIBUTE_5F_MAP, kEnumeration_up) ;
      while (enumerator_8539.hasCurrentObject ()) {
        result << "    " ;
        result << categoryReader_cocoaResetPrefix (enumerator_8539.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
        result << "mLexicalAttribute_" ;
        result << enumerator_8539.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (176)).stringValue () ;
        result << categoryReader_cocoaReset (enumerator_8539.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
        result << " ;\n" ;
        index_8539_.increment () ;
    ...
    GALGAS_uint index_8753_ (0) ;
    if (in_LEXICAL_5F_RULE_5F_LIST.isValid ()) {
      cEnumerator_lexicalRuleListAST enumerator_8753 (in_LEXICAL_5F_RULE_5F_LIST, kEnumeration_up) ;
      while (enumerator_8753.hasCurrentObject ()) {
        result << callCategoryReader_generateCocoaCode ((const cPtr_abstractLexicalRuleAST *) enumerator_8753.current_mLexicalRule (HERE).ptr (), in_LEXIQUE_5F_CLASS_5F_NAME, in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT, inCompiler COMMA_SOURCE_FILE_AT_LINE (182)).stringValue () ;
        index_8753_.increment () ;
  ...
  result << "\n"
    ...
    "- (NSUInteger) terminalVocabularyCount {\n"
    "  return " ;
  result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (205)).reader_length (SOURCE_FILE_AT_LINE (205)).reader_string (SOURCE_FILE_AT_LINE (205)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
    ...
    "- (NSUInteger) styleCount {\n"
    "  return " ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (215)).reader_length (SOURCE_FILE_AT_LINE (215)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (215)).reader_string (SOURCE_FILE_AT_LINE (215)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
    ...
    "- (BOOL) isTemplateLexique {\n"
    "  return " ;
  result << GALGAS_bool (kIsStrictSup, in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (225)).reader_length (SOURCE_FILE_AT_LINE (225)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).reader_ocString (SOURCE_FILE_AT_LINE (225)).stringValue () ;
  result << " ;\n"
    "}\n"
    "\n"
    "//---------------------------------------------------------------------------*\n"
  ...
  result << in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (235)).reader_length (SOURCE_FILE_AT_LINE (235)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (235)).reader_string (SOURCE_FILE_AT_LINE (235)).stringValue () ;
  result << "] = {0" ;
  GALGAS_uint index_11343_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (236)).isValid ()) {
    cEnumerator_terminalList enumerator_11343 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (236)), kEnumeration_up) ;
    while (enumerator_11343.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_11343.current_mStyleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (237)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11343.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (237)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (237)).stringValue () ;
      result << " */" ;
      index_11343_.increment () ;
  ...
  result << "] = {NO" ;
  GALGAS_uint index_12160_ (0) ;
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (250)).isValid ()) {
    cEnumerator_terminalList enumerator_12160 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.reader_mTerminalList (SOURCE_FILE_AT_LINE (250)), kEnumeration_up) ;
    while (enumerator_12160.hasCurrentObject ()) {
      result << ",\n"
        "    " ;
      result << enumerator_12160.current_mAtomicSelection (HERE).reader_ocString (SOURCE_FILE_AT_LINE (251)).stringValue () ;
      result << " /* " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_12160.current_mTerminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (251)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (251)).stringValue () ;
      result << " */" ;
      index_12160_.increment () ;
  ...
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (264)).reader_length (SOURCE_FILE_AT_LINE (264)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (264)).reader_string (SOURCE_FILE_AT_LINE (264)).stringValue () ;
  result << ")) {\n"
    "    NSString * kStyleArray [" ;
  result << in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (265)).reader_length (SOURCE_FILE_AT_LINE (265)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (265)).reader_string (SOURCE_FILE_AT_LINE (265)).stringValue () ;
  result << "] = {\n"
    "      @\"Default Style\"" ;
  GALGAS_uint index_13133_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (267)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_13133 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (267)), kEnumeration_up) ;
    while (enumerator_13133.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13133.current_mComment (HERE).reader_string (SOURCE_FILE_AT_LINE (268)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (268)).stringValue () ;
      index_13133_.increment () ;
  ...
  result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
  result << "\"" ;
  GALGAS_uint index_14057_ (0) ;
  if (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (286)).isValid ()) {
    cEnumerator_lexicalStyleListAST enumerator_14057 (in_LEXIQUE_5F_COMPONENT_5F_ROOT.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (286)), kEnumeration_up) ;
    while (enumerator_14057.hasCurrentObject ()) {
      result << ",\n"
        "      @\"" ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14057.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (287)).stringValue () ;
      result << "\"" ;
      index_14057_.increment () ;
