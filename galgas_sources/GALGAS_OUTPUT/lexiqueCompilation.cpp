...
template_filewrapper_lexiqueGenerationTemplates_cocoaImplementationZone2 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if ((var_cas_LEXIQUE_COMPONENT_ROOT.reader_mTemplateDelimitorList (inLexique COMMA_SOURCE_FILE_AT_LINE (131)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_8146 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_8146 = NULL ;
      while (((operand_8146 = enumerator_8146.nextObject ()))) {
        macroValidPointer (operand_8146) ;
        result << "    mLexicalAttribute_" ;
        result << operand_8146->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
        result << operand_8146->mInfo.mLexicalType.reader_initialization (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_8548 = GGS_uint (6U) ;
      if (indentation_8548.isBuilt ()) {
        result.incIndentation ((sint32) indentation_8548.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_8335 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_8335 = NULL ;
      while (((operand_8335 = enumerator_8335.nextObject ()))) {
        macroValidPointer (operand_8335) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_8335->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_8335->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (175))) ;
      }
       ;
      if (indentation_8548.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_8548.uintValue ())) ;
      ...
      GGS_lexicalAttributeMap::cEnumerator enumerator_8829 (var_cas_LEXICAL_ATTRIBUTE_MAP, true) ;
      const GGS_lexicalAttributeMap::cElement * operand_8829 = NULL ;
      while (((operand_8829 = enumerator_8829.nextObject ()))) {
        macroValidPointer (operand_8829) ;
        result << "    " ;
        result << operand_8829->mInfo.mLexicalType.reader_cocoaResetPrefix (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
        result << "mLexicalAttribute_" ;
        result << operand_8829->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
        result << operand_8829->mInfo.mLexicalType.reader_cocoaReset (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
        result << " ;\n" ;
      }
      result << "    mTokenFirstLocation = mCurrentLocation ;\n" ;
      const GGS_uint indentation_9267 = GGS_uint (4U) ;
      if (indentation_9267.isBuilt ()) {
        result.incIndentation ((sint32) indentation_9267.uintValue ()) ;
      }
      GGS_lexicalRuleList::cEnumerator enumerator_9049 (var_cas_LEXICAL_RULE_LIST, true) ;
      const GGS_lexicalRuleList::cElement * operand_9049 = NULL ;
      while (((operand_9049 = enumerator_9049.nextObject ()))) {
        macroValidPointer (operand_9049) ;
        result << (findCategoryReader__abstractLexicalRule__generateCocoaCode (operand_9049->mLexicalRule (HERE)->galgasRTTI ()) (inLexique, operand_9049->mLexicalRule.getPtr (), var_cas_LEXIQUE_CLASS_NAME, var_cas_LEXIQUE_ANALYSIS_CONTEXT COMMA_SOURCE_FILE_AT_LINE (195))) ;
      }
       ;
      if (indentation_9267.isBuilt ()) {
        result.incIndentation (- ((sint32) indentation_9267.uintValue ())) ;
    ...
    result << "] = {0" ;
    GGS_terminalList::cEnumerator enumerator_11157 (var_cas_LEXIQUE_ANALYSIS_CONTEXT.reader_mTerminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), true) ;
    const GGS_terminalList::cElement * operand_11157 = NULL ;
    while (((operand_11157 = enumerator_11157.nextObject ()))) {
      macroValidPointer (operand_11157) ;
      result << ",\n"
        "    " ;
      result << operand_11157->mStyleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
      result << " /* " ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "_1_" ;
      result << operand_11157->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
      result << " */" ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << "] = {\n"
      "    @\"Default Style\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_11975 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), true) ;
    const GGS_lexicalStyleList::cElement * operand_11975 = NULL ;
    while (((operand_11975 = enumerator_11975.nextObject ()))) {
      macroValidPointer (operand_11975) ;
      result << ",\n"
        "    @" ;
      result << operand_11975->mComment.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_CStringConstantRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
    }
    result << "\n"
      "  } ;\n"
    ...
    result << var_cas_LEXIQUE_CLASS_NAME ;
    result << "\"" ;
    GGS_lexicalStyleList::cEnumerator enumerator_12738 (var_cas_LEXIQUE_COMPONENT_ROOT.reader_mLexicalStyleList (inLexique COMMA_SOURCE_FILE_AT_LINE (268)), true) ;
    const GGS_lexicalStyleList::cElement * operand_12738 = NULL ;
    while (((operand_12738 = enumerator_12738.nextObject ()))) {
      macroValidPointer (operand_12738) ;
      result << ",\n"
        "    @\"" ;
      result << var_cas_LEXIQUE_CLASS_NAME ;
      result << "-" ;
      result << operand_12738->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269)) ;
      result << "\"" ;
    }
    result << "\n"
      "  } ;\n"
