...
void routine_parseLexiqueComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    C_String syntaxDirectedTranslationResult_32535 ;
    cGrammar_lexiqueLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_32535, constinArgument_inSourceFile, outArgument_outLexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (794)) ;
    {
...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lexicalAttributeListAST enumerator_34252 (constinArgument_inLexicalAttributeList, kEnumeration_up) ;
  while (enumerator_34252.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inLexicalTypeMap.reader_hasKey (enumerator_34252.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (826)) COMMA_SOURCE_FILE_AT_LINE (826)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lexicalTypeEnum var_lexicalType ;
      constinArgument_inLexicalTypeMap.method_searchKey (enumerator_34252.current_mTypeName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
      {
      ioArgument_ioLexicalAttributeMap.modifier_insertKey (enumerator_34252.current_mName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (829)) ;
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_m = GALGAS_string::makeEmptyString () ;
      var_m.dotAssign_operation (GALGAS_string ("the @").operator_concat (enumerator_34252.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)).operator_concat (GALGAS_string (" type is not a valid lexical attribute type; are allowed:") COMMA_SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)) ;
      GALGAS_bool var_firstLoop = GALGAS_bool (true) ;
      cEnumerator_lexicalTypeMap enumerator_34666 (constinArgument_inLexicalTypeMap, kEnumeration_up) ;
      while (enumerator_34666.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" @").operator_concat (enumerator_34666.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) ;
        if (enumerator_34666.hasNextObject ()) {
          var_m.dotAssign_operation (GALGAS_string (",") COMMA_SOURCE_FILE_AT_LINE (837)) ;
        }
        enumerator_34666.gotoNextObject () ;
      }
      GALGAS_location location_1 (enumerator_34252.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  cEnumerator_externRoutineListAST enumerator_36072 (constinArgument_inLexiqueComponentRoot.reader_mExternRoutineList (SOURCE_FILE_AT_LINE (867)), kEnumeration_up) ;
  while (enumerator_36072.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_36206 (enumerator_36072.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_36206.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_36206.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_36206.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_36206.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
      enumerator_36206.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_36072.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_36072.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (874)) ;
    }
    enumerator_36072.gotoNextObject () ;
  }
  ...
  cEnumerator_externFunctionListAST enumerator_36876 (constinArgument_inLexiqueComponentRoot.reader_mExternFunctionList (SOURCE_FILE_AT_LINE (880)), kEnumeration_up) ;
  while (enumerator_36876.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_37013 (enumerator_36876.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_37013.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_37013.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (884)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_37013.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (885)) COMMA_SOURCE_FILE_AT_LINE (885)) ;
      enumerator_37013.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_36876.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_36876.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
    }
    enumerator_36876.gotoNextObject () ;
  }
  ...
  cEnumerator_lexicalStyleListAST enumerator_38830 (constinArgument_inLexiqueComponentRoot.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (920)), kEnumeration_up) ;
  while (enumerator_38830.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_38830.current_mName (HERE), enumerator_38830.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
  ...
  cEnumerator_terminalDeclarationListAST enumerator_39292 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (931)), kEnumeration_up) ;
  while (enumerator_39292.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_39292.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (933)).reader_length (SOURCE_FILE_AT_LINE (933)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_lstring joker_39434_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (934)).method_searchKey (enumerator_39292.current_mStyle (HERE), joker_39434_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_39559 (enumerator_39292.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_39559.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_39559.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
      var_argumentTypeList.addAssign_operation (enumerator_39559.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (940)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (940)) ;
      enumerator_39559.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_39292.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_39971 (enumerator_39292.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_39971.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_39971.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (946)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_3) {
        const enumGalgasBool test_4 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_4) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (enumerator_39971.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_39971.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (952)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_39971.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          if (kBoolTrue == test_8) {
            GALGAS_location location_9 (enumerator_39971.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_39971.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_39292.current_mName (HERE), var_argumentTypeList, enumerator_39292.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (963)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (960)) ;
    enumerator_39292.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_40828 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (969)), kEnumeration_up) ;
  while (enumerator_40828.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, enumerator_40828.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (971)).reader_length (SOURCE_FILE_AT_LINE (971)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_lstring joker_40970_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (972)).method_searchKey (enumerator_40828.current_mStyle (HERE), joker_40970_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_41095 (enumerator_40828.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_41095.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_41095.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (977)) ;
      var_argumentTypeList.addAssign_operation (enumerator_41095.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (978)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (978)) ;
      enumerator_41095.gotoNextObject () ;
    }
    ...
    cEnumerator_lexicalListEntryListAST enumerator_41470 (enumerator_40828.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_41470.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_40828.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (983)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_41470.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (983)), inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_41716 (enumerator_41470.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_41716.hasCurrentObject ()) {
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_41716.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (987)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_12) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_12) {
            GALGAS_location location_13 (enumerator_41716.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_41716.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (993)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_14) {
            GALGAS_location location_15 (enumerator_41716.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            if (kBoolTrue == test_16) {
              GALGAS_location location_17 (enumerator_41716.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_41716.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_41470.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (1001)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_41470.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1009)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_41470.current_mEntrySpelling (HERE), enumerator_41470.current_mTerminalSpelling (HERE), enumerator_41470.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_41470.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)).reader_length (SOURCE_FILE_AT_LINE (1011)), enumerator_41470.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)), enumerator_41470.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_41470.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
      enumerator_41470.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_40828.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    }
    enumerator_40828.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_43202 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE_AT_LINE (1017)), kEnumeration_up) ;
  while (enumerator_43202.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_43202.current_mMessageName (HERE), enumerator_43202.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1018)) ;
    }
    enumerator_43202.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_43425 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE_AT_LINE (1021)), kEnumeration_up) ;
  while (enumerator_43425.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_43425.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    enumerator_43425.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_43627 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE_AT_LINE (1025)), kEnumeration_up) ;
  while (enumerator_43627.hasCurrentObject ()) {
    const enumGalgasBool test_18 = enumerator_43627.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE_AT_LINE (1026)).boolEnum () ;
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_43627.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_43847 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (1031)), kEnumeration_up) ;
  while (enumerator_43847.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43847.current_mStartString (HERE).reader_string (SOURCE_FILE_AT_LINE (1032)) COMMA_SOURCE_FILE_AT_LINE (1032)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_43847.current_mEndString (HERE).reader_string (SOURCE_FILE_AT_LINE (1033)) COMMA_SOURCE_FILE_AT_LINE (1033)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_44075 (enumerator_43847.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_44075.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_44075.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1036)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        GALGAS_location location_21 (enumerator_44075.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        if (kBoolTrue == test_22) {
          GALGAS_location location_23 (enumerator_44075.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_43847.current_mStartString (HERE), enumerator_43847.current_mEndString (HERE), var_preservesStartDelimiter COMMA_SOURCE_FILE_AT_LINE (1044)) ;
    enumerator_43847.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_24) {
    cEnumerator_indexingListAST enumerator_44689 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1048)), kEnumeration_up) ;
    while (enumerator_44689.hasCurrentObject ()) {
      GALGAS_location location_25 (enumerator_44689.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_indexingListAST enumerator_44911 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1053)), kEnumeration_up) ;
  while (enumerator_44911.hasCurrentObject ()) {
    const enumGalgasBool test_26 = var_indexNameSet.reader_hasKey (enumerator_44911.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_44911.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_44911.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)).operator_concat (GALGAS_string ("' index is already declared") COMMA_SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_44911.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1057)) COMMA_SOURCE_FILE_AT_LINE (1057)) ;
    enumerator_44911.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_45244 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (1060)), kEnumeration_up) ;
  while (enumerator_45244.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45244.current_mMatchString (HERE).reader_string (SOURCE_FILE_AT_LINE (1061)) COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45244.current_mReplacementString (HERE).reader_string (SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
    enumerator_45244.gotoNextObject () ;
  }
