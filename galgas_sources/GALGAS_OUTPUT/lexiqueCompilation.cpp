...
void routine_parseLexiqueComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    C_String syntaxDirectedTranslationResult_33215 ;
    cGrammar_lexiqueLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_33215, constinArgument_inSourceFile, outArgument_outLexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (800)) ;
    {
...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lexicalAttributeListAST enumerator_34932 (constinArgument_inLexicalAttributeList, kEnumeration_up) ;
  while (enumerator_34932.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inLexicalTypeMap.reader_hasKey (enumerator_34932.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lexicalTypeEnum var_lexicalType ;
      constinArgument_inLexicalTypeMap.method_searchKey (enumerator_34932.current_mTypeName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) ;
      {
      ioArgument_ioLexicalAttributeMap.modifier_insertKey (enumerator_34932.current_mName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_m = GALGAS_string::makeEmptyString () ;
      var_m.dotAssign_operation (GALGAS_string ("the @").operator_concat (enumerator_34932.current_mTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (838)).operator_concat (GALGAS_string (" type is not a valid lexical attribute type; are allowed:") COMMA_SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (838)) ;
      GALGAS_bool var_firstLoop = GALGAS_bool (true) ;
      cEnumerator_lexicalTypeMap enumerator_35346 (constinArgument_inLexicalTypeMap, kEnumeration_up) ;
      while (enumerator_35346.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" @").operator_concat (enumerator_35346.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (841)) COMMA_SOURCE_FILE_AT_LINE (841)) COMMA_SOURCE_FILE_AT_LINE (841)) ;
        if (enumerator_35346.hasNextObject ()) {
          var_m.dotAssign_operation (GALGAS_string (",") COMMA_SOURCE_FILE_AT_LINE (843)) ;
        }
        enumerator_35346.gotoNextObject () ;
      }
      GALGAS_location location_1 (enumerator_34932.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
void routine_compileLexiqueComponentFromAST (const GALGAS_string constinArgument_inComponentNameFromSourceFilePath,
  ...
  cEnumerator_externRoutineListAST enumerator_36752 (constinArgument_inLexiqueComponentRoot.reader_mExternRoutineList (SOURCE_FILE_AT_LINE (873)), kEnumeration_up) ;
  while (enumerator_36752.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_36886 (enumerator_36752.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_36886.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_36886.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (877)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_36886.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_36886.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)) ;
      enumerator_36886.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_36752.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_36752.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (880)) ;
    }
  ...
  cEnumerator_externFunctionListAST enumerator_37556 (constinArgument_inLexiqueComponentRoot.reader_mExternFunctionList (SOURCE_FILE_AT_LINE (886)), kEnumeration_up) ;
  while (enumerator_37556.hasCurrentObject ()) {
    ...
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_37693 (enumerator_37556.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_37693.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_37693.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (890)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_37693.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (891)) COMMA_SOURCE_FILE_AT_LINE (891)) ;
      enumerator_37693.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_37556.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE_AT_LINE (894)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_37556.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (895)) ;
    }
    enumerator_37556.gotoNextObject () ;
  }
  ...
  cEnumerator_lexicalStyleListAST enumerator_39510 (constinArgument_inLexiqueComponentRoot.reader_mLexicalStyleList (SOURCE_FILE_AT_LINE (926)), kEnumeration_up) ;
  while (enumerator_39510.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_39510.current_mName (HERE), enumerator_39510.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (927)) ;
    }
    var_styleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (928)) ;
    enumerator_39510.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_terminalDeclarationListAST enumerator_39972 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (937)), kEnumeration_up) ;
  while (enumerator_39972.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_39972.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (939)).reader_length (SOURCE_FILE_AT_LINE (939)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_lstring joker_40114_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (940)).method_searchKey (enumerator_39972.current_mStyle (HERE), joker_40114_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_40239 (enumerator_39972.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_40239.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_40239.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
      var_argumentTypeList.addAssign_operation (enumerator_40239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (946)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (946)) ;
      enumerator_40239.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_39972.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (948)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_40651 (enumerator_39972.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_40651.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_40651.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (952)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_3) {
        const enumGalgasBool test_4 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_4) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (enumerator_40651.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_40651.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (958)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_40651.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          if (kBoolTrue == test_8) {
            GALGAS_location location_9 (enumerator_40651.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_40651.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_39972.current_mName (HERE), var_argumentTypeList, enumerator_39972.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (969)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (966)) ;
    enumerator_39972.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_41508 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (975)), kEnumeration_up) ;
  while (enumerator_41508.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, enumerator_41508.current_mStyle (HERE).reader_string (SOURCE_FILE_AT_LINE (977)).reader_length (SOURCE_FILE_AT_LINE (977)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_lstring joker_41650_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE_AT_LINE (978)).method_searchKey (enumerator_41508.current_mStyle (HERE), joker_41650_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_41775 (enumerator_41508.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_41775.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_41775.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
      var_argumentTypeList.addAssign_operation (enumerator_41775.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (984)), var_attributeLexicalType COMMA_SOURCE_FILE_AT_LINE (984)) ;
    ...
    cEnumerator_lexicalListEntryListAST enumerator_42150 (enumerator_41508.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_42150.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_41508.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (989)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_42150.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (989)), inCompiler COMMA_SOURCE_FILE_AT_LINE (989)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_42396 (enumerator_42150.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_42396.hasCurrentObject ()) {
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_42396.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (993)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_12) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_12) {
            GALGAS_location location_13 (enumerator_42396.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_42396.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (999)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_14) {
            GALGAS_location location_15 (enumerator_42396.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            if (kBoolTrue == test_16) {
              GALGAS_location location_17 (enumerator_42396.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_42396.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_42150.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex COMMA_SOURCE_FILE_AT_LINE (1007)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_42150.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1015)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_42150.current_mEntrySpelling (HERE), enumerator_42150.current_mTerminalSpelling (HERE), enumerator_42150.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1016)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_42150.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1017)).reader_length (SOURCE_FILE_AT_LINE (1017)), enumerator_42150.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1017)), enumerator_42150.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1017)) COMMA_SOURCE_FILE_AT_LINE (1017)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_42150.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (1018)) COMMA_SOURCE_FILE_AT_LINE (1018)) ;
      enumerator_42150.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_41508.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1020)) ;
    }
    enumerator_41508.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_43882 (constinArgument_inLexiqueComponentRoot.reader_mLexicalMessageDeclarationList (SOURCE_FILE_AT_LINE (1023)), kEnumeration_up) ;
  while (enumerator_43882.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_43882.current_mMessageName (HERE), enumerator_43882.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1024)) ;
    }
    enumerator_43882.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_44105 (constinArgument_inLexiqueComponentRoot.reader_mLexicalRuleList (SOURCE_FILE_AT_LINE (1027)), kEnumeration_up) ;
  while (enumerator_44105.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_44105.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (1028)) ;
    enumerator_44105.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_44307 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE_AT_LINE (1031)), kEnumeration_up) ;
  while (enumerator_44307.hasCurrentObject ()) {
    const enumGalgasBool test_18 = enumerator_44307.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE_AT_LINE (1032)).boolEnum () ;
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_44307.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_44527 (constinArgument_inLexiqueComponentRoot.reader_mTemplateDelimitorList (SOURCE_FILE_AT_LINE (1037)), kEnumeration_up) ;
  while (enumerator_44527.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_44527.current_mStartString (HERE).reader_string (SOURCE_FILE_AT_LINE (1038)) COMMA_SOURCE_FILE_AT_LINE (1038)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_44527.current_mEndString (HERE).reader_string (SOURCE_FILE_AT_LINE (1039)) COMMA_SOURCE_FILE_AT_LINE (1039)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_44755 (enumerator_44527.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_44755.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_44755.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1042)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        GALGAS_location location_21 (enumerator_44755.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        if (kBoolTrue == test_22) {
          GALGAS_location location_23 (enumerator_44755.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_44527.current_mStartString (HERE), enumerator_44527.current_mEndString (HERE), var_preservesStartDelimiter COMMA_SOURCE_FILE_AT_LINE (1050)) ;
    enumerator_44527.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_24) {
    cEnumerator_indexingListAST enumerator_45369 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1054)), kEnumeration_up) ;
    while (enumerator_45369.hasCurrentObject ()) {
      GALGAS_location location_25 (enumerator_45369.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_indexingListAST enumerator_45591 (constinArgument_inLexiqueComponentRoot.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (1059)), kEnumeration_up) ;
  while (enumerator_45591.hasCurrentObject ()) {
    const enumGalgasBool test_26 = var_indexNameSet.reader_hasKey (enumerator_45591.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_45591.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_45591.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1061)) COMMA_SOURCE_FILE_AT_LINE (1061)).operator_concat (GALGAS_string ("' index is already declared") COMMA_SOURCE_FILE_AT_LINE (1061)) COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_45591.current_mIndexName (HERE).reader_string (SOURCE_FILE_AT_LINE (1063)) COMMA_SOURCE_FILE_AT_LINE (1063)) ;
    enumerator_45591.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_45924 (constinArgument_inLexiqueComponentRoot.reader_mTemplateReplacementList (SOURCE_FILE_AT_LINE (1066)), kEnumeration_up) ;
  while (enumerator_45924.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45924.current_mMatchString (HERE).reader_string (SOURCE_FILE_AT_LINE (1067)) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_45924.current_mReplacementString (HERE).reader_string (SOURCE_FILE_AT_LINE (1068)) COMMA_SOURCE_FILE_AT_LINE (1068)) ;
