//---------------------------------------------------------------------------*
//                                                                           *
//                  File 'include_typeAppendInstruction.h'                   *
...
#ifndef typeAppendInstruction_DEFINED
#define typeAppendInstruction_DEFINED
...
/* class GGG_typeAppendInstruction : public GGG_typeInstruction {
  private : typedef GGG_typeInstruction inherited ;
  public : GGG_typeAppendInstruction (const GGS_typeCplusPlusName & ,
                                const GGS_typeExpressionList &  COMMA_LOCATION_ARGS) ;
} ; */
