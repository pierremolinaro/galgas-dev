...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_templateInstructionIfBranchListForGeneration reader_subListWithRange (const GALGAS_range & constinOperand0,
                                                                                                         C_Compiler * inCompiler
                                                                                                         COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  public : GALGAS_templateInstructionIfBranchListForGeneration_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_templateInstructionSwitchBranchListForGeneration reader_subListWithRange (const GALGAS_range & constinOperand0,
                                                                                                             C_Compiler * inCompiler
                                                                                                             COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : GALGAS_templateInstructionListForGeneration current_mInstructionList (LOCATION_ARGS) const ;
//--- Current element access
  public : GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_templateInstructionExpressionForGeneration constructor_default (LOCATION_ARGS) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_templateInstructionIfBranchListForGeneration_2E_element constructor_new (const GALGAS_semanticExpressionForGeneration & inOperand0,
                                                                                                  const GALGAS_templateInstructionListForGeneration & inOperand1
                                                                                                  COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_templateInstructionListForGeneration reader_mInstructionList (LOCATION_ARGS) const ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element constructor_new (const GALGAS_lstringlist & inOperand0,
                                                                                                      const GALGAS_templateInstructionListForGeneration & inOperand1
                                                                                                      COMMA_LOCATION_ARGS) ;
