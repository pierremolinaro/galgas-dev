...
class GALGAS_string function_generateProcedure (const class GALGAS_string & constinArgument0,
                                                class GALGAS_formalParameterListForGeneration inArgument1,
                                                const class GALGAS_semanticInstructionListForGeneration & constinArgument2,
...
class GALGAS_string function_generateFunction (const class GALGAS_string & constinArgument0,
                                               const class GALGAS_formalInputParameterListForGeneration & constinArgument1,
                                               const class GALGAS_semanticInstructionListForGeneration & constinArgument2,
...
class GALGAS_string function_generateCategoryMethod (const class GALGAS_string & constinArgument0,
                                                     const class GALGAS_string & constinArgument1,
                                                     const class GALGAS_string & constinArgument2,
                                                     const class GALGAS_formalParameterListForGeneration & constinArgument3,
                                                     const class GALGAS_semanticInstructionListForGeneration & constinArgument4,
...
class GALGAS_string function_generateCategoryReader (const class GALGAS_string & constinArgument0,
                                                     const class GALGAS_string & constinArgument1,
                                                     const class GALGAS_string & constinArgument2,
