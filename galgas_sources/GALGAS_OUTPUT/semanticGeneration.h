...
extern const C_galgas_function_descriptorEX kFunction_descriptor_generateRoutine ;

//---------------------------------------------------------------------------*

GGS_string function_generateRoutine (C_Compiler &,
                                const GGS_string ,
