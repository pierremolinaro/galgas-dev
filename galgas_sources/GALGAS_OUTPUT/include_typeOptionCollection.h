//---------------------------------------------------------------------------*
//                                                                           *
//                  File 'include_typeOptionCollection.h'                    *
...
//---------------------------------------------------------------------------*
//                                                                           *
//                abstract class 'cPtr_typeOptionCollection'                 *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_typeOptionCollection : public cPtr_typeExpression {
...
//--- Constructor
  public : cPtr_typeOptionCollection (const GGS_string& ,
                                const GGS_lstring & 
                                COMMA_LOCATION_ARGS) ;
...
//    C_GGS_Object::detachPointer may invoke delete.
    ...
    protected : virtual ~cPtr_typeOptionCollection (void) {}
  #endif

//--- Attributes
  public : GGS_string mOptionComponentName ;
  public : GGS_lstring  mCollectionName ;
//--- Class message
