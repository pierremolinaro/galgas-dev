...
class galgas_start {
  ...
  protected : void pr_galgas_start_symbol_galgas_start_89_6_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_start_symbol_galgas_start_89_6_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_89_6_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_treewalkingComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_89_6_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_treewalkingComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_89_6_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_optionComponents  &,
                                GGS_M_treewalkingComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_89_6_compileFile (galgas_scanner &) ;

  protected : void pr_galgas_start_symbol_galgas_start_89_6_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;
