...
class galgas_start {
  ...
  protected : void pr_galgas_start_symbol_galgas_start_83_26_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_start_symbol_galgas_start_83_26_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_optionComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_galgas_start_symbol_galgas_start_83_26_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_83_26_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_83_26_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_EXsemanticContext &,
                                GGS_stringset  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_83_26_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_EXsemanticContext &) ;
