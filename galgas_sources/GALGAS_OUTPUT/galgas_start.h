...
class galgas_start {
  ...
  protected : virtual void nt_galgas_start_symbol_importMetamodels (galgas_scanner &,
                                GGS_M_metamodelsComponents  &) = 0 ;
  ...
  protected : void pr_galgas_start_symbol_galgas_start_77_27_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_start_symbol_galgas_start_77_27_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_77_27_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_77_27_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_77_27_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_77_27_compileFile (galgas_scanner &) ;

  protected : void pr_galgas_start_symbol_galgas_start_77_27_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_77_27_importMetamodels (galgas_scanner &,
                                GGS_M_metamodelsComponents  &) ;
