...
class galgas_start {
  ...
  protected : void pr_galgas_start_symbol_galgas_start_85_8_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_start_symbol_galgas_start_85_8_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_85_8_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_metamodelsComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_85_8_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_constraintComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_85_8_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_constraintComponents  &) ;

  protected : void pr_galgas_start_symbol_galgas_start_85_8_compileFile (galgas_scanner &) ;

  protected : void pr_galgas_start_symbol_galgas_start_85_8_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;
