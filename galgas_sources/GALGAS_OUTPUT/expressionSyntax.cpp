...
void expressionSyntax::rule_expressionSyntax_factor_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_trueExpressionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (360)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_falseExpressionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (371)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalStringExpressionAST ::constructor_new (inLexique, var_cas_literalStringList COMMA_SOURCE_FILE_AT_LINE (388)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_hereExpressionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (471)) ;
}
