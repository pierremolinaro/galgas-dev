    ...
    case 3 : {
      ...
      switch (select_expressionSyntax_11 (inLexique)) {
        case 1 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (545)), var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (545)) ;
          } break ;
        case 2 : {
