...
void expressionSyntax::rule_expressionSyntax_factor_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expressionSyntax_7 (inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_outExpression = GGS_castInExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_useKindOfClass, var_cas_typeName, var_cas_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (314)) ;
      } break ;
    default :
      break ;
  }
...
void expressionSyntax::rule_expressionSyntax_factor_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_factor_ (inLexique, var_cas_outExpression) ;
  var_cas_outExpression = GGS_notExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_outExpression COMMA_SOURCE_FILE_AT_LINE (334)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_factor_ (inLexique, var_cas_outExpression) ;
  var_cas_outExpression = GGS_complementExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_outExpression COMMA_SOURCE_FILE_AT_LINE (347)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_trueExpressionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (358)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_falseExpressionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (369)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_9 = true ;
    while (syntaxRepeat_9) {
        ...
        var_cas_literalStringList.addAssign_operation (var_cas_literalString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (383))) ;
  ...
  var_cas_outExpression = GGS_literalStringExpressionAST ::constructor_new (inLexique, var_cas_literalStringList COMMA_SOURCE_FILE_AT_LINE (386)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i15_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalUIntExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (398)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i16_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalSIntExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (410)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i17_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalUInt64ExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (422)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i18_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalSInt64ExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (434)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i19_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalCharExpressionAST ::constructor_new (inLexique, var_cas_literalChar COMMA_SOURCE_FILE_AT_LINE (446)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalDoubleExpressionAST ::constructor_new (inLexique, var_cas_literalDouble COMMA_SOURCE_FILE_AT_LINE (458)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_hereExpressionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (469)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_ifExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_ifExpression, var_cas_thenExpression, var_cas_elseExpression COMMA_SOURCE_FILE_AT_LINE (490)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expressionSyntax_10 (inLexique)) {
    case 1 : {
      ...
      var_cas_outExpression = GGS_readerCallExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_readerName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (520)) ;
      } break ;
    case 2 : {
      ...
      GGS_semanticExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outExpression = GGS_constructorExpressionAST ::constructor_new (inLexique, var_cas_className, var_cas_constructorName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (531)) ;
      } break ;
    case 3 : {
      ...
      switch (select_expressionSyntax_11 (inLexique)) {
        case 1 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("generic_galgas_cli_options"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (543)), var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (543)) ;
          } break ;
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, var_cas_optionComponentName, var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (549)) ;
          } break ;
        default :
          break ;
      }
    ...
    case 4 : {
      ...
      switch (select_expressionSyntax_12 (inLexique)) {
        case 1 : {
          var_cas_outExpression = GGS_filewrapperObjectInstanciationInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName COMMA_SOURCE_FILE_AT_LINE (556)) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2E_) COMMA_HERE) ;
          switch (select_expressionSyntax_13 (inLexique)) {
            case 1 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
              var_cas_outExpression = GGS_filewrapperInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_filePath COMMA_SOURCE_FILE_AT_LINE (564)) ;
              } break ;
            case 2 : {
              ...
              GGS_semanticExpressionListAST  var_cas_expressionList ;
              nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
              var_cas_outExpression = GGS_filewrapperTemplateInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_filewrapperTemplateName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (573)) ;
              } break ;
            default :
              break ;
          }
...
void expressionSyntax::rule_expressionSyntax_factor_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_semanticExpressionListAST  var_cas_expressionList ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
  var_cas_outExpression = GGS_functionCallExpressionAST ::constructor_new (inLexique, var_cas_functionName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (597)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  var_cas_outExpression = GGS_literalTypeInExpressionAST ::constructor_new (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (615)) ;
}
