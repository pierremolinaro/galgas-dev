    ...
    while (syntaxRepeat_0) {
      switch (select_expressionSyntax_0 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_concatExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_1) {
      switch (select_expressionSyntax_1 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_orExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_relation_5F_term_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_xorExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_2) {
      switch (select_expressionSyntax_2 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_andExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_3) {
      switch (select_expressionSyntax_3 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_equalExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_simple_5F_expression_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_notEqualExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_simple_5F_expression_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_lowerOrEqualExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 5 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_simple_5F_expression_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_greaterOrEqualExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 6 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_simple_5F_expression_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_strictGreaterExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 7 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_simple_5F_expression_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_strictLowerExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_4) {
      switch (select_expressionSyntax_4 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_leftShiftExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_term_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_rightShiftExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_term_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_addExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 5 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_term_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_subExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_5) {
      switch (select_expressionSyntax_5 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_multiplicationExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_factor_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_divisionExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_semanticExpressionAST  var_cas_rightOperand ;
          nt_factor_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_moduloExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_HERE) ;
          } break ;
        default :
...
void expressionSyntax::rule_expressionSyntax_factor_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D_) COMMA_HERE) ;
  nt_factor_ (inLexique, var_cas_outExpression) ;
  var_cas_outExpression = GGS_unaryMinusExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_outExpression COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_varInExpressionAST ::constructor_new (inLexique, var_cas_identifier, var_cas_structFieldList COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_selfInExpressionAST ::constructor_new (inLexique COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expressionSyntax_7 (inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_outExpression = GGS_castInExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_useKindOfClass, var_cas_typeName, var_cas_errorLocationExpression COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
void expressionSyntax::rule_expressionSyntax_factor_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_factor_ (inLexique, var_cas_outExpression) ;
  var_cas_outExpression = GGS_notExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_outExpression COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_factor_ (inLexique, var_cas_outExpression) ;
  var_cas_outExpression = GGS_negateExpressionAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_outExpression COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_trueExpressionAST ::constructor_new (inLexique COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_falseExpressionAST ::constructor_new (inLexique COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalStringExpressionAST ::constructor_new (inLexique, var_cas_literalStringList COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i15_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalUIntExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i16_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalSIntExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i17_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalUInt64ExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i18_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalSInt64ExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i19_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalCharExpressionAST ::constructor_new (inLexique, var_cas_literalChar COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_literalDoubleExpressionAST ::constructor_new (inLexique, var_cas_literalDouble COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_hereExpressionAST ::constructor_new (inLexique COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_ifExpressionAST ::constructor_new (inLexique, var_cas_ifExpression, var_cas_thenExpression, var_cas_elseExpression COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expressionSyntax_10 (inLexique)) {
    case 1 : {
      ...
      var_cas_outExpression = GGS_readerCallExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_readerName, var_cas_expressionList COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      GGS_outSemanticExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outExpression = GGS_constructorExpressionAST ::constructor_new (inLexique, var_cas_className, var_cas_constructorName, var_cas_expressionList COMMA_HERE) ;
      } break ;
    case 3 : {
      ...
      switch (select_expressionSyntax_11 (inLexique)) {
        case 1 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("generic_galgas_cli_options"), GGS_location (inLexique) COMMA_HERE), var_cas_optionName, var_cas_readerName COMMA_HERE) ;
          } break ;
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, var_cas_optionComponentName, var_cas_optionName, var_cas_readerName COMMA_HERE) ;
          } break ;
        default :
          break ;
      }
    ...
    case 4 : {
      ...
      switch (select_expressionSyntax_12 (inLexique)) {
        case 1 : {
          var_cas_outExpression = GGS_filewrapperObjectInstanciationInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2E_) COMMA_HERE) ;
          switch (select_expressionSyntax_13 (inLexique)) {
            case 1 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
              var_cas_outExpression = GGS_filewrapperInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_filePath COMMA_HERE) ;
              } break ;
            case 2 : {
              ...
              GGS_outSemanticExpressionListAST  var_cas_expressionList ;
              nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
              var_cas_outExpression = GGS_filewrapperTemplateInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_filewrapperTemplateName, var_cas_expressionList COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
...
void expressionSyntax::rule_expressionSyntax_factor_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_outSemanticExpressionListAST  var_cas_expressionList ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
  var_cas_outExpression = GGS_functionCallExpressionAST ::constructor_new (inLexique, var_cas_functionName, var_cas_expressionList COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  var_cas_outExpression = GGS_literalTypeInExpressionAST ::constructor_new (inLexique, var_cas_typeName COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_output_5F_expression_5F_list_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpressionList = GGS_outSemanticExpressionListAST ::constructor_new (inLexique, var_cas_expressionList, GGS_location (inLexique) COMMA_HERE) ;
}
