...
void expressionSyntax::rule_expressionSyntax_factor_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expressionSyntax_10 (inLexique)) {
    case 1 : {
      ...
      var_cas_outExpression = GGS_readerCallExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_readerName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (523)) ;
      } break ;
    case 2 : {
      ...
      GGS_semanticExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outExpression = GGS_constructorExpressionAST ::constructor_new (inLexique, var_cas_className, var_cas_constructorName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (534)) ;
      } break ;
    case 3 : {
      ...
      switch (select_expressionSyntax_11 (inLexique)) {
        case 1 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (546)), var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (546)) ;
          } break ;
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_optionExpressionAST ::constructor_new (inLexique, var_cas_optionComponentName, var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (552)) ;
          } break ;
        default :
          break ;
      }
    ...
    case 4 : {
      ...
      switch (select_expressionSyntax_12 (inLexique)) {
        case 1 : {
          var_cas_outExpression = GGS_filewrapperObjectInstanciationInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName COMMA_SOURCE_FILE_AT_LINE (559)) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2E_) COMMA_HERE) ;
          switch (select_expressionSyntax_13 (inLexique)) {
            case 1 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
              var_cas_outExpression = GGS_filewrapperInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_filePath COMMA_SOURCE_FILE_AT_LINE (567)) ;
              } break ;
            case 2 : {
              ...
              GGS_semanticExpressionListAST  var_cas_expressionList ;
              nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
              var_cas_outExpression = GGS_filewrapperTemplateInExpressionAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_filewrapperTemplateName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (576)) ;
              } break ;
            default :
              break ;
          }
...
void expressionSyntax::rule_expressionSyntax_factor_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_semanticExpressionListAST  var_cas_expressionList ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
  var_cas_outExpression = GGS_functionCallExpressionAST ::constructor_new (inLexique, var_cas_functionName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (600)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  var_cas_outExpression = GGS_literalTypeInExpressionAST ::constructor_new (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (618)) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_semanticExpressionAST  &var_cas_outExpression) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_extract) COMMA_HERE) ;
  GGS_semanticExpressionAST  var_cas_receiverExpression ;
  nt_expression_ (inLexique, var_cas_receiverExpression) ;
  const GGS_location  var_cas_endOfExpression = GGS_location (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_HERE) ;
  GGS_lstring  var_cas_typeName ;
  inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  var_cas_outExpression = GGS_extractObjectInExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_endOfExpression, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (638)) ;
}
...
void expressionSyntax::rule_expressionSyntax_output_5F_expression_5F_list_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
