...
void expressionSyntax::rule_expressionSyntax_factor_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_varInExpressionAST ::constructor_new (inLexique, var_cas_identifier COMMA_HERE) ;
}
...
void expressionSyntax::rule_expressionSyntax_factor_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        ...
        var_cas_literalStringList.addAssign_operation (var_cas_literalString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (375))) ;
