            ...
            case 5 : {
              ...
              if (((! (var_cas_outIncludedMetamodelComponents.reader_hasKey (_inLexique, var_cas_metamodelComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (929)) SOURCE_FILE_AT_LINE (929))))).isBuiltAndTrue ()) {
                ...
                while ((operand_34306 != NULL)) {
                  ...
                  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_34306->mKey, var_cas_e SOURCE_FILE_AT_LINE (956)) ;
              ...
              var_cas_outInclusionsForHeaderFile._addAssign_operation (var_cas_metamodelComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (964))) ;
              var_cas_outIncludedMetamodelComponents._addAssign_operation (var_cas_metamodelComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (965))) ;
              } break ;
            default :
              break ;
          }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique._assignFromAttribute_tokenString (var_cas_optionComponentName) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              var_cas_outIncludedOptionComponents._addAssign_operation (var_cas_optionComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1003))) ;
              switch (select_semantics_parser_4 (_inLexique)) {
                case 1 : {
                  } break ;
                case 2 : {
            ...
            case 4 : {
              ...
              _inLexique._assignFromAttribute_tokenString (var_cas_componentName) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              var_cas_outIncludedSemanticsComponents._addAssign_operation (var_cas_componentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1023))) ;
              switch (select_semantics_parser_6 (_inLexique)) {
                case 1 : {
                  } break ;
                case 2 : {
              ...
              if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
                var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_componentName, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, var_cas_importedEntities SOURCE_FILE_AT_LINE (1037)) ;
              }
              ...
              while ((operand_38026 != NULL)) {
                ...
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_38026->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1039)) SOURCE_FILE_AT_LINE (1039))))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_38026->mKey, operand_38026->mInfo.aDefEntite SOURCE_FILE_AT_LINE (1040)) ;
                }
                operand_38026 = operand_38026->nextObject () ;
              }
              ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_outModelMap,  var_cas_outActionMap,  var_cas_alreadyImportedSemanticsComponents,  var_cas_alreadyImportedMetamodelComponents,  var_cas_componentName SOURCE_FILE_AT_LINE (1043)) ;
              } break ;
            case 5 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_metamodel) COMMA_HERE) ;
              GGS_lstring  var_cas_metamodelComponentName ;
              ...
              if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
                var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelComponentName, automatic_var_14, automatic_var_15, automatic_var_16 SOURCE_FILE_AT_LINE (1069)) ;
              }
              } break ;
            default :
              break ;
...
pr_semantics_declaration_semantics_parser_1081_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_tableRoutinesAimplementer.modifier_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1154)) ;
      } break ;
    default :
      break ;
  }
...
pr_semantics_declaration_semantics_parser_1081_6_importSemantics (galgas_scanner & _inLexique,
  ...
  var_cas_ioExternActionMap.modifier_insertKey (_inLexique, var_cas_routineName, var_cas_signature, GGS_bool (true, false) SOURCE_FILE_AT_LINE (1182)) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1185)) SOURCE_FILE_AT_LINE (1185))).isBuiltAndTrue ()) {
    GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_routineName, var_cas_entite SOURCE_FILE_AT_LINE (1188)) ;
    }
    { cPtr_typeEntiteRoutine * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteRoutine *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_listeDeTypesPrecedenteDeclaration._drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteRoutine::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_routineName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1189)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_listeDeTypesPrecedenteDeclaration = ptrExtraire_->aListeArgumentsFormels ;
    ...
    ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_listeDeTypesPrecedenteDeclaration,  var_cas_listeDeTypes,  GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1190)) ;
  }else{
    var_cas_tableNomRoutinesDeclarees.modifier_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1196)) ;
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_entite = GGS_typeEntiteRoutine::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
    var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_routineName, var_cas_entite SOURCE_FILE_AT_LINE (1198)) ;
  }
  switch (select_semantics_parser_8 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
      var_cas_tableRoutinesAimplementer.modifier_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1209)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_routine) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      } break ;
    default :
...
pr_parent_class_semantics_parser_1259_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outSuperClassName, var_cas_entite SOURCE_FILE_AT_LINE (1274)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outSuperClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1275)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeUtilisateur.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeUtilisateur.getPtr () != NULL) {
        ...
        var_cas_outSuperClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1283)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  var_cas_tableDesClassesAncetres.modifier_insertKey (_inLexique, var_cas_outSuperClassName SOURCE_FILE_AT_LINE (1285)) ;
}
...
pr_parent_class_semantics_parser_1259_6_importSemantics (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_entite SOURCE_FILE_AT_LINE (1305)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      var_cas_typeUtilisateur._drop_operation () ;
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_superClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1306)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_typeUtilisateur = ptrExtraire_->aDefType ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeUtilisateur.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeUtilisateur.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgasClassType::static_string_message_messageGalgasType () ;
        message2_ << var_cas_typeUtilisateur (HERE)->message_messageGalgasType () ;
        var_cas_superClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1314)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_tableDesMethodes = ptrExtraire_->mReaderMap ;
  ...
  var_cas_tableDesClassesAncetres.modifier_insertKey (_inLexique, var_cas_superClassName SOURCE_FILE_AT_LINE (1316)) ;
  GGS_TypeModel  var_cas_type ;
  if (var_cas_ioModelMap._isBuilt ()) {
    var_cas_ioModelMap (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_type SOURCE_FILE_AT_LINE (1319)) ;
  }
  if (var_cas_type._isBuilt ()) {
    ...
    if (operand_49683 != NULL) {
      ...
      var_cas_superClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_superClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1326))))) + (GGS_string (true, "' type is not a class"))) SOURCE_FILE_AT_LINE (1328)) ;
      var_cas_outSuperClasses._drop_operation () ;
      var_cas_outAttributeList._drop_operation () ;
      var_cas_outMessageMap._drop_operation () ;
    }
  }
  var_cas_outSuperClasses._addAssign_operation (var_cas_superClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1329))) ;
  var_cas_outMessageMap = GGS_classMessageMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  var_cas_outSuperClasses = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
  var_cas_outAttributeList = GGS_typeListModel::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
pr_semantics_declaration_semantics_parser_1343_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_10 (_inLexique)) {
    case 1 : {
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1364)) SOURCE_FILE_AT_LINE (1364))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1365)) SOURCE_FILE_AT_LINE (1365))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedClassType::constructor_new (_inLexique, var_cas_abstractClassName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1367)) ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      } break ;
    case 2 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_11 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
              if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1412)) SOURCE_FILE_AT_LINE (1412))))).isBuiltAndTrue ()) {
                var_cas_messageMapForHeirs.modifier_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1413)) ;
              }
              var_cas_tableMessagesClasseConcrete.modifier_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1415)) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              } break ;
            case 3 : {
      ...
      while ((operand_54646 != NULL)) {
        ...
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_54646->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1462)) SOURCE_FILE_AT_LINE (1462))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_54646->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1463))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1464)) ;
        }
      ...
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_abstractClassName, var_cas_entite SOURCE_FILE_AT_LINE (1476)) ;
...
pr_semantics_declaration_semantics_parser_1343_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_10 (_inLexique)) {
    case 1 : {
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1512)) SOURCE_FILE_AT_LINE (1512))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1513)) SOURCE_FILE_AT_LINE (1513))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedClassType::constructor_new (_inLexique, var_cas_abstractClassName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1515)) ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      } break ;
    case 2 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_11 (_inLexique)) {
            case 2 : {
              ...
              _inLexique._assignFromAttribute_tokenString (var_cas_messageText) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
              if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1567)) SOURCE_FILE_AT_LINE (1567))))).isBuiltAndTrue ()) {
                var_cas_messageMapForHeirs.modifier_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1568)) ;
              }
              var_cas_tableMessagesClasseConcrete.modifier_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1570)) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              } break ;
            case 3 : {
              nt_abstract_method_ (_inLexique, var_cas_estAbstraite, var_cas_listeAttributsSemantiquesCourants, var_cas_listeEntitesAengendrer, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableDesMethodes, var_cas_tableMethodesAimplementer, var_cas_tableEnAvant) ;
      ...
      while ((operand_59962 != NULL)) {
        ...
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_59962->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1616)) SOURCE_FILE_AT_LINE (1616))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_59962->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1617))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1618)) ;
        }
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_abstractClassName, var_cas_entite SOURCE_FILE_AT_LINE (1630)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      ...
      var_cas_ioModelMap.modifier_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1633)) ;
      } break ;
    default :
      break ;
  }
...
pr_abstract_method_semantics_parser_1641_6_ (galgas_scanner & _inLexique,
  ...
  if (((! (var_cas_inIsAbstract))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a concrete class should not declare an abstract method") SOURCE_FILE_AT_LINE (1654)) ;
  }
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_tableDesMethodes.modifier_insertKey (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (1669)) ;
  ...
  var_cas_tableMethodesAimplementer.modifier_insertAbstract (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions SOURCE_FILE_AT_LINE (1671)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
pr_parse_method_semantics_parser_1677_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_63560 != NULL)) {
    ...
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (_inLexique, operand_63560->mKey COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_63560->mKey, operand_63560->mInfo.mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (1701)) ;
  ...
  var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (_inLexique, var_cas_me_Constant, var_cas_typeDefinition, var_cas_me_constantCppName SOURCE_FILE_AT_LINE (1714)) ;
  ...
  var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (_inLexique, var_cas_super_Constant, var_cas_typeDefinition, var_cas_super_constantCppName SOURCE_FILE_AT_LINE (1726)) ;
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  ...
  var_cas_componentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_inCurrentClassName, var_cas_entite SOURCE_FILE_AT_LINE (1741)) ;
...
pr_non_abstract_method_semantics_parser_1762_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_12 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "old syntax: from GALGAS 1.5.1, use 'method' instead of 'reader'") SOURCE_FILE_AT_LINE (1781)) ;
      } break ;
    default :
      break ;
  }
  ...
  var_cas_tableDesMethodes.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (1805)) ;
...
pr_overrided_method_semantics_parser_1819_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_14 (_inLexique)) {
    ...
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_reader) COMMA_HERE) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "old syntax: from GALGAS 1.5.1, use 'method' instead of 'reader'") SOURCE_FILE_AT_LINE (1839)) ;
      } break ;
    default :
      break ;
  }
  ...
  if (var_cas_tableDesMethodes._isBuilt ()) {
    var_cas_tableDesMethodes (HERE)->method_searchKey (_inLexique, var_cas_methodName, var_cas_listeDeTypesMethodeOriginale SOURCE_FILE_AT_LINE (1865)) ;
  }
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_listeDeTypesMethodeOriginale,  var_cas_methodSignature,  GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1866)) ;
  var_cas_tableMethodesAimplementer.modifier_insertNotAbstract (_inLexique, var_cas_methodName, var_cas_methodSignature, var_cas_listeTypeEtNomsArguments, var_cas_instructionsList SOURCE_FILE_AT_LINE (1872)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  switch (select_semantics_parser_15 (_inLexique)) {
    ...
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_reader) COMMA_HERE) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "old syntax: from GALGAS 1.5.1, use 'method' instead of 'reader'") SOURCE_FILE_AT_LINE (1878)) ;
      } break ;
    default :
      break ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_16 (_inLexique)) {
        case 2 : {
          ...
          switch (select_semantics_parser_17 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.modifier_insertUnusedConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1920)) ;
              } break ;
            case 2 : {
              _inLexique._assignFromAttribute_tokenString (var_cas_nomArgument) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
              var_cas_tableArgumentsMethode.modifier_insertConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1925)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_18 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.modifier_insertUnusedInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1946)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_nomArgument ;
              _inLexique._assignFromAttribute_tokenString (var_cas_nomArgument) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, true)) ;
              var_cas_tableArgumentsMethode.modifier_insertInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1952)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_19 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.modifier_insertUnusedInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1973)) ;
              } break ;
            case 2 : {
              _inLexique._assignFromAttribute_tokenString (var_cas_nomArgument) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, false)) ;
              var_cas_tableArgumentsMethode.modifier_insertInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1978)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
          var_cas_tableArgumentsMethode.modifier_insertOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1998)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
pr_type_parsing_semantics_parser_2055_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2062)) SOURCE_FILE_AT_LINE (2062))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (2064)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        ...
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2065)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
  ...
  }else if ((var_cas_inTableEnAvant.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2066)) SOURCE_FILE_AT_LINE (2066))).isBuiltAndTrue ()) {
    if (var_cas_inTableEnAvant._isBuilt ()) {
      var_cas_inTableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_outTypeDefinition SOURCE_FILE_AT_LINE (2067)) ;
    }
  }else{
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2069))))) + (GGS_string (true, "' type is not defined"))) SOURCE_FILE_AT_LINE (2070)) ;
    var_cas_outTypeDefinition._drop_operation () ;
  }
}
...
pr_instruction_beginning_with_identifier_semantics_parser_2080_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_targetVarType, var_cas_targetVarCppName SOURCE_FILE_AT_LINE (2103)) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_targetVarType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2104)) ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2117_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVarType ;
  GGS_typeCplusPlusName  var_cas_targetVarCppName ;
  var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_targetVarType, var_cas_targetVarCppName SOURCE_FILE_AT_LINE (2140)) ;
  GGS_string var_cas_sourceExpressionConverter ;
  if (var_cas_targetVarType._isBuilt () && var_cas_sourceType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_80468 = var_cas_targetVarType (HERE) ;
    cPtr_AC_galgasType * ptr_80482 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_string * operand_80468 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_80468) ;
    cPtr_typeGalgas_string * operand_80482 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_80482) ;
    if ((operand_80468 != NULL) && (operand_80482 != NULL)) {
      var_cas_sourceExpressionConverter = GGS_string (true, "") ;
    }else{
      cPtr_typeGalgas_string * operand_80468 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_80468) ;
      cPtr_typeGalgas_lstring * operand_80482 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_80482) ;
      if ((operand_80468 != NULL) && (operand_80482 != NULL)) {
        var_cas_sourceExpressionConverter = GGS_string (true, "ggs_string") ;
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "for '.=' operator, ")) + (var_cas_targetVarType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2149))))) + (GGS_string (true, " target object type is not compatible with ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2150))))) + (GGS_string (true, " source expression type"))) SOURCE_FILE_AT_LINE (2152)) ;
...
pr_input_parameters_list_semantics_parser_2166_6_ (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_21 (_inLexique)) {
            case 1 : {
              ...
              var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_nomVariableDest, var_cas_typeVarDest, var_cas_nomCppDest SOURCE_FILE_AT_LINE (2181)) ;
            ...
            case 3 : {
              ...
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (_inLexique SOURCE_FILE_AT_LINE (2190)) ;
              GGS_uint _variant_82369 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (2191)) ;
              GGS_bool _condition_82369 (_variant_82369._isBuilt (), true) ;
              while (_condition_82369.isBuiltAndTrue ()) {
                _condition_82369 = (var_cas_jokerCount) > (GGS_uint (true, 0U)) ;
                if (_condition_82369.isBuiltAndTrue ()) {
                  if (_variant_82369.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (2195)) ;
                    _condition_82369 = GGS_bool (true, false) ;
                  }else{
                    _variant_82369._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeCibles._addAssign_operation (GGS_typeJoker::constructor_new (_inLexique COMMA_HERE)) ;
                    var_cas_jokerCount._decrement_operation (_inLexique SOURCE_FILE_AT_LINE (2194)) ;
                  }
                }
              }
              } break ;
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2206))) < (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2206)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much arguments: ")) + (var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2207)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2207))))) + (GGS_string (true, " expected, ")))) + (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2208)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2208))))) + (GGS_string (true, " found"))) SOURCE_FILE_AT_LINE (2210)) ;
    var_cas_outAllVariablesList._drop_operation () ;
    var_cas_listeAffectationParametresEffectifs._drop_operation () ;
  }else if (((((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2210))) > (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2210)))) & ((! (var_cas_ellipsis))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "argument(s) missing: ")) + (var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2211)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2211))))) + (GGS_string (true, " expected, ")))) + (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2212)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2212))))) + (GGS_string (true, " found"))) SOURCE_FILE_AT_LINE (2214)) ;
    var_cas_outAllVariablesList._drop_operation () ;
    var_cas_listeAffectationParametresEffectifs._drop_operation () ;
  }else{
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_83387 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_83469 = var_cas_listeCibles.firstObject () ;
    while ((operand_83387 != NULL)
        && (operand_83469 != NULL)) {
      macroValidPointer (operand_83387) ;
      macroValidPointer (operand_83469) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_83387->aNomAttribut ;
      if (operand_83469->aCible._isBuilt ()) {
        operand_83469->aCible (HERE)->method_verifierType (_inLexique, operand_83387->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList SOURCE_FILE_AT_LINE (2220)) ;
      }
      operand_83387 = operand_83387->nextObject () ;
      operand_83469 = operand_83469->nextObject () ;
    }
  }
  ...
  if (var_cas_outAllVariablesList._isBuilt () &&
      var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2227))._isBuilt () &&
      var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2228))._isBuilt () &&
      var_cas_nullName._isBuilt ()) {
    ::routine_appendJokersIfNeeded (_inLexique,  var_cas_outAllVariablesList,  var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2227)),  var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2228)),  var_cas_nullName SOURCE_FILE_AT_LINE (2225)) ;
  }
}
...
pr_instruction_beginning_with_identifier_semantics_parser_2241_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2254)) ;
  GGS_typeListeAttributsSemantiques  var_cas_formalParametersList ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleAddAssignOperatorCall (_inLexique, GGS_location (_inLexique), var_cas_formalParametersList SOURCE_FILE_AT_LINE (2257)) ;
  }
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2277))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2277)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2278)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2278))) + (GGS_string (true, " argument(s), while ")))) + (var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2278)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2278))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (2279)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_86058 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_86128 = var_cas_typeList.firstObject () ;
    while ((operand_86058 != NULL)
        && (operand_86128 != NULL)) {
      macroValidPointer (operand_86058) ;
      macroValidPointer (operand_86128) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_86058->mAttributType,  operand_86128->mType,  operand_86128->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2282)) ;
      operand_86058 = operand_86058->nextObject () ;
      operand_86128 = operand_86128->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2302_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2315)) ;
  GGS_typeListeAttributsSemantiques  var_cas_formalParametersList ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleMinusAssignOperatorCall (_inLexique, GGS_location (_inLexique), var_cas_formalParametersList SOURCE_FILE_AT_LINE (2318)) ;
  }
  GGS_typeTypesList  var_cas_typeList ;
  var_cas_typeList = GGS_typeTypesList::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2338))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2338)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2339)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2339))) + (GGS_string (true, " argument(s), while ")))) + (var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2339)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2339))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (2340)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_88629 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_88699 = var_cas_typeList.firstObject () ;
    while ((operand_88629 != NULL)
        && (operand_88699 != NULL)) {
      macroValidPointer (operand_88629) ;
      macroValidPointer (operand_88699) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_88629->mAttributType,  operand_88699->mType,  operand_88699->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2343)) ;
      operand_88629 = operand_88629->nextObject () ;
      operand_88699 = operand_88699->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2363_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2376)) ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleIncrementOperatorCall (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2378)) ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2392_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2405)) ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleDecrementOperatorCall (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2407)) ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_actual_parameters_list_semantics_parser_2417_6_ (galgas_scanner & _inLexique,
  ...
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_listeTypesParametresFormels,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_outExpressionList SOURCE_FILE_AT_LINE (2433)) ;
}
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_25 (_inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_26 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount ;
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (_inLexique SOURCE_FILE_AT_LINE (2483)) ;
              GGS_uint _variant_95046 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (2484)) ;
              GGS_bool _condition_95046 (_variant_95046._isBuilt (), true) ;
              while (_condition_95046.isBuiltAndTrue ()) {
                _condition_95046 = (var_cas_jokerCount) > (GGS_uint (true, 0U)) ;
                if (_condition_95046.isBuiltAndTrue ()) {
                  if (_variant_95046.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (2489)) ;
                    _condition_95046 = GGS_bool (true, false) ;
                  }else{
                    _variant_95046._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeTypesParametresEffectifs._addAssign_operation (GGS_typeGalgas_jokerInParameterList::constructor_new (_inLexique COMMA_HERE), var_cas_parameterPassingMode) ;
                    var_cas_outExpressionList._addAssign_operation (GGS_typeJokerInExpression::constructor_new (_inLexique COMMA_HERE)) ;
                    var_cas_jokerCount._decrement_operation (_inLexique SOURCE_FILE_AT_LINE (2488)) ;
                  }
                }
              }
              } break ;
            case 3 : {
              ...
              _inLexique._assignFromAttribute_tokenString (var_cas_nomArgument) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2495)) ;
              ...
              if ((var_cas_exclusiveVariables.reader_hasKey (_inLexique, var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2499)) SOURCE_FILE_AT_LINE (2499))).isBuiltAndTrue ()) {
                var_cas_nomArgument.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object is already named as input or output/input effectif argument of current instruction") SOURCE_FILE_AT_LINE (2501)) ;
              }else{
                var_cas_exclusiveVariables._addAssign_operation (var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2502))) ;
              }
              } break ;
            default :
              break ;
        ...
        case 4 : {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_nomArgument) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2511)) ;
          GGS_actualParametersPassingMode var_cas_parameterPassingMode ;
          ...
          var_cas_e = GGS_typeVarInExpression::constructor_new (_inLexique, var_cas_nomCppArgument COMMA_HERE) ;
          var_cas_outExpressionList._addAssign_operation (var_cas_e) ;
          if ((var_cas_exclusiveVariables.reader_hasKey (_inLexique, var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2516)) SOURCE_FILE_AT_LINE (2516))).isBuiltAndTrue ()) {
            var_cas_nomArgument.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object is already named as input or output/input effectif argument of current instruction") SOURCE_FILE_AT_LINE (2518)) ;
          }else{
            var_cas_exclusiveVariables._addAssign_operation (var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2519))) ;
          }
          } break ;
        default :
          syntaxRepeat = false ;
...
pr_semantic_instructions_list_semantics_parser_2528_6_ (galgas_scanner & _inLexique,
                                ...
                                const GGS_entityToImplementMap  &var_cas_inMetamodelEntityMap,
                                const GGS_M_treewalkingComponents  &var_cas_inTreewalkingComponentMap) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique SOURCE_FILE_AT_LINE (2539)) ;
  ...
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2539)) ;
}
...
pr_semantic_instruction_semantics_parser_2560_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inCurrentTreewalkingRoutinePropertyMap._isBuilt ()) {
    var_cas_inCurrentTreewalkingRoutinePropertyMap (HERE)->method_searchKey (_inLexique, var_cas_calledPropertyName, var_cas_propertyType SOURCE_FILE_AT_LINE (2576)) ;
  }
  GGS_lstring  var_cas_entityName ;
  if (var_cas_propertyType._isBuilt ()) {
    cPtr_typeGalgas_singleReferenceEntity * operand_98927 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_propertyType.getPtr ()) ;
    if (operand_98927 != NULL) {
      macroValidPointer (operand_98927) ; 
      var_cas_entityName = operand_98927->mEntityTypeName ;
    }else{
      cPtr_typeGalgas_multipleReferenceEntity * operand_99026 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (var_cas_propertyType.getPtr ()) ;
      if (operand_99026 != NULL) {
        macroValidPointer (operand_99026) ; 
        var_cas_entityName = operand_99026->mEntityTypeName ;
      }else{ // Else part
        var_cas_calledPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this property should be a single or a multiple reference") SOURCE_FILE_AT_LINE (2585)) ;
        var_cas_entityName._drop_operation () ;
      }
    }
  }
  GGS_L_EXsignature  var_cas_routineSignature ;
  if ((var_cas_inTreewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_entityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2588)) SOURCE_FILE_AT_LINE (2588))).isBuiltAndTrue ()) {
    GGS_typeListeTypesEtNomsArgMethode  automatic_var_18 ;
    if (var_cas_inTreewalkingRoutineHeaderMap._isBuilt ()) {
      var_cas_inTreewalkingRoutineHeaderMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_routineSignature, automatic_var_18 SOURCE_FILE_AT_LINE (2589)) ;
    }
  }else{
    var_cas_calledPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "there is no treewalking routine for the '%")) + (var_cas_entityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2592))))) + (GGS_string (true, "' metamodel class"))) SOURCE_FILE_AT_LINE (2595)) ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeVarSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeVarSource.getPtr () != NULL) {
        ...
        var_cas_nomVarSource.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2645)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
pr_extract_instruction_semantics_parser_2670_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomClasse, var_cas_entite SOURCE_FILE_AT_LINE (2691)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_nomClasse.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2692)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_leType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_leType.getPtr () != NULL) {
        ...
        var_cas_nomClasse.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2703)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  if (((! (var_cas_tableDesClassesAncetres.reader_hasKey (_inLexique, var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (2705)) SOURCE_FILE_AT_LINE (2705))))).isBuiltAndTrue ()) {
    var_cas_nomClasse.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (2706))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2707)) ;
  }
  GGS_L_assignedVariables  var_cas_listeAffectationParametresEffectifs ;
  ...
  if (var_cas_errorExpressionType._isBuilt ()) {
    var_cas_errorExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (2731)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  GGS_lstring  var_cas_messageName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_messageName) ;
  ...
  if (var_cas_tableMessagesAbstraits._isBuilt ()) {
    var_cas_tableMessagesAbstraits (HERE)->method_searchKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (2735)) ;
  }
...
pr_extract_instruction_semantics_parser_2748_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (2765)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (2767)) ;
        ...
        GGS_AC_semanticsEntity  var_cas_entite ;
        if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
          var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomType1, var_cas_entite SOURCE_FILE_AT_LINE (2775)) ;
        }
        { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_entite.getPtr () != NULL) {
              ...
              message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
              message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
              var_cas_nomType1.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2776)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_definitionClasse1.getPtr () != NULL) {
              ...
              var_cas_nomType1.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2788)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (_inLexique, var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (2790)) SOURCE_FILE_AT_LINE (2790))))).isBuiltAndTrue ()) {
          var_cas_nomType1.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (2791))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2792)) ;
        }
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2767)) ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (2822)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2822)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (2765)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_extract) COMMA_HERE) ;
}
...
pr_semantic_instruction_semantics_parser_2851_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.modifier_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (2875)) ;
...
pr_semantic_instruction_semantics_parser_2896_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (_inLexique, var_cas_galgasVariableName, automatic_var_19, var_cas_nomCppVar SOURCE_FILE_AT_LINE (2912)) ;
        GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_2927_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.modifier_searchForDestructiveReadAccess (_inLexique, var_cas_nom, automatic_var_20, var_cas_nomCppVar SOURCE_FILE_AT_LINE (2943)) ;
        GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2960_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomVarDest, var_cas_entite SOURCE_FILE_AT_LINE (2972)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  if (var_cas_entite._isBuilt ()) {
    cPtr_typeEntiteRoutine * operand_114415 = dynamic_cast <cPtr_typeEntiteRoutine *> (var_cas_entite.getPtr ()) ;
    if (operand_114415 != NULL) {
      macroValidPointer (operand_114415) ; 
      var_cas_signatureRoutine = operand_114415->aListeArgumentsFormels ;
      var_cas_isExternActionCall = GGS_bool (true, false) ;
    }else{
      cPtr_typeEntiteActionExterne * operand_114557 = dynamic_cast <cPtr_typeEntiteActionExterne *> (var_cas_entite.getPtr ()) ;
      if (operand_114557 != NULL) {
        macroValidPointer (operand_114557) ; 
        var_cas_signatureRoutine = operand_114557->aSignature ;
        var_cas_isExternActionCall = GGS_bool (true, true) ;
      }else{ // Else part
        var_cas_nomVarDest.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "'")) + (var_cas_nomVarDest.reader_string (_inLexique SOURCE_FILE_AT_LINE (2983))))) + (GGS_string (true, "' should name a routine or an extern action"))) SOURCE_FILE_AT_LINE (2986)) ;
  ...
  switch (select_semantics_parser_30 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_variableType._isBuilt ()) {
        var_cas_variableType (HERE)->method_handleMethodInstructionCall (_inLexique, var_cas_readObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3042)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_variableType ;
      GGS_typeCplusPlusName  var_cas_cppVariableName ;
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_modifiedObjectName, var_cas_variableType, var_cas_cppVariableName SOURCE_FILE_AT_LINE (3061)) ;
      GGS_lstring  var_cas_methodName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_methodName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
      if (var_cas_variableType._isBuilt ()) {
        var_cas_variableType (HERE)->method_handleModifierCall (_inLexique, var_cas_modifiedObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3066)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
      nt_actual_parameters_list_ (_inLexique, var_cas_methodSignature, var_cas_expressionsList, var_cas_ioVariablesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioInstructionList) ;
    ...
    case 3 : {
      ...
      if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
        var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_theEntity SOURCE_FILE_AT_LINE (3087)) ;
      }
      GGS_AC_galgasType  var_cas_type ;
      { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_theEntity.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_theEntity.getPtr () != NULL) {
            ...
            var_cas_typeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3089)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
          var_cas_type = ptrExtraire_->aDefType ;
      ...
      if (var_cas_type._isBuilt ()) {
        var_cas_type (HERE)->method_handleClassMethodCall (_inLexique, var_cas_typeMethodName, var_cas_typeMethodSignature SOURCE_FILE_AT_LINE (3090)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
...
pr_semantic_instruction_semantics_parser_3151_6_ (galgas_scanner & _inLexique,
  ...
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_errorExpression, var_cas_errorExpressionType) ;
  if (var_cas_errorExpressionType._isBuilt ()) {
    var_cas_errorExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3173)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  ...
  { cPtr_typeGalgas_string * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_string *> (var_cas_warningMessageExpressionType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_warningMessageExpressionType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3186)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
...
pr_semantic_instruction_semantics_parser_3200_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_errorLocationExpressionType._isBuilt ()) {
    var_cas_errorLocationExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3222)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  ...
  { cPtr_typeGalgas_string * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_string *> (var_cas_errorMessageExpressionType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_errorMessageExpressionType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3235)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_nomVariable, automatic_var_21, var_cas_varCppName SOURCE_FILE_AT_LINE (3245)) ;
  ...
  { cPtr_typeGalgas_string * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_string *> (var_cas_messageExpressionType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_messageExpressionType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3292)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
...
pr_semantic_instruction_semantics_parser_3305_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3319)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3321)) ;
        ...
        { cPtr_typeGalgas_bool * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_bool *> (var_cas_resultType.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            if (var_cas_resultType.getPtr () != NULL) {
              ...
              GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3331)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
          }
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3321)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_if) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3319)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_3385_6_ (galgas_scanner & _inLexique,
  ...
  { cPtr_typeGalgas_enum * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_resultType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_resultType.getPtr () != NULL) {
        ...
        message2_ << var_cas_resultType (HERE)->message_messageGalgasType () ;
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3410)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3414)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_when) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        { bool syntaxRepeat = true ;
          while (syntaxRepeat) {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              var_cas_branchConstantSet._addAssign_operation (var_cas_enumConstantName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3422))) ;
              if (var_cas_enumConstantesMap._isBuilt ()) {
                var_cas_enumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_enumConstantName SOURCE_FILE_AT_LINE (3423)) ;
              }
              if ((var_cas_allBranchConstantSet.reader_hasKey (_inLexique, var_cas_enumConstantName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3424)) SOURCE_FILE_AT_LINE (3424))).isBuiltAndTrue ()) {
                var_cas_enumConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this constant is already used in current switch instruction") SOURCE_FILE_AT_LINE (3426)) ;
              }
        ...
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3432)) ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3432)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3414)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  GGS_stringset  var_cas_missingConstants ;
  var_cas_missingConstants = var_cas_enumConstantesMap.reader_allKeys (_inLexique SOURCE_FILE_AT_LINE (3453))._substract_operation (_inLexique, var_cas_allBranchConstantSet SOURCE_FILE_AT_LINE (3453)) ;
  GGS_stringset::element_type * operand_132744 = var_cas_missingConstants.firstObject () ;
  while ((operand_132744 != NULL)) {
    macroValidPointer (operand_132744) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_132744->mKey))) + (GGS_string (true, "' is not used in switch instruction"))) SOURCE_FILE_AT_LINE (3456)) ;
    operand_132744 = operand_132744->nextObject () ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_3471_6_ (galgas_scanner & _inLexique,
  ...
  { cPtr_typeGalgas_uint * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_variantResultType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_variantResultType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3493)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3497)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3498)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3498)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3497)) ;
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3528)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3529)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3529)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3528)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_3563_6_ (galgas_scanner & _inLexique,
  ...
  { cPtr_typeGalgas_lstring * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_typeNomFichierSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_typeNomFichierSource.getPtr () != NULL) {
        ...
        var_cas_nomFichierSource.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3592)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (3605)) ;
  }
  ...
  { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_e.getPtr () != NULL) {
        ...
        message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
        var_cas_grammarName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3608)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  if (var_cas_startSymbolAltMap._isBuilt ()) {
    var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (3611)) ;
  }
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_startSymbolSignature,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_expressionsList SOURCE_FILE_AT_LINE (3612)) ;
  ...
  switch (select_semantics_parser_38 (_inLexique)) {
    case 1 : {
      if (((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3623))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this grammar returns an instance of '@")) + (var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3624))))) + (GGS_string (true, "' metamodel entity"))) SOURCE_FILE_AT_LINE (3624)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D_3E) COMMA_HERE) ;
      ...
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_metamodelClassVariableName, var_cas_type, automatic_var_22 SOURCE_FILE_AT_LINE (3630)) ;
      ...
      { cPtr_typeGalgas_singleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_type.getPtr () != NULL) {
            ...
            var_cas_metamodelClassVariableName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3632)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      if (((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3633))) != (var_cas_variableEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3633)))).isBuiltAndTrue ()) {
        var_cas_metamodelClassVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this variable has the '@")) + (var_cas_variableEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3634))))) + (GGS_string (true, "', but a variable of '@")))) + (var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3635))))) + (GGS_string (true, "' type is expected"))) SOURCE_FILE_AT_LINE (3636)) ;
      }
      } break ;
    default :
      break ;
...
pr_semantic_instruction_semantics_parser_3658_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inTreewalkingComponentMap._isBuilt ()) {
    var_cas_inTreewalkingComponentMap (HERE)->method_searchKey (_inLexique, var_cas_treewalkingComponentName, var_cas_rootEntityName, var_cas_treewalkingRoutineSignature SOURCE_FILE_AT_LINE (3676)) ;
  }
  ...
  { cPtr_typeGalgas_singleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_modelVariableType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_modelVariableType.getPtr () != NULL) {
        ...
        var_cas_modelVariableName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3694)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  if (((var_cas_variableEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3695))) != (var_cas_rootEntityName)).isBuiltAndTrue ()) {
    var_cas_modelVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((((((GGS_string (true, "the '")) + (var_cas_modelVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3696))))) + (GGS_string (true, "' variable is an instance of '@")))) + (var_cas_variableEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3697))))) + (GGS_string (true, "', but the '")))) + (var_cas_treewalkingComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3698))))) + (GGS_string (true, "' component requires an instance of '@")))) + (var_cas_rootEntityName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (3700)) ;
  }
  GGS_typeExpressionList  var_cas_expressionsList ;
  GGS_L_actualParametersSignature  var_cas_listeTypesParametresEffectifs ;
  nt_parse_parameters_list_ (_inLexique, var_cas_listeTypesParametresEffectifs, var_cas_expressionsList, var_cas_ioVariablesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioComponentSemanticsEntitiesMap) ;
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_treewalkingRoutineSignature,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_expressionsList SOURCE_FILE_AT_LINE (3711)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_3735_6_ (galgas_scanner & _inLexique,
  ...
  GGS_typeInstruction  var_cas_instruction ;
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3748)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3749)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.modifier_insertUsedConstInArgumentNoShadow (_inLexique, var_cas_enumeratedVariableName, var_cas_enumeratedVariableType, var_cas_enumeratedVariableCPPName SOURCE_FILE_AT_LINE (3764)) ;
        ...
        if (var_cas_enumeratedVariableType._isBuilt ()) {
          var_cas_enumeratedVariableType (HERE)->method_acceptForeachInstruction (_inLexique, var_cas_enumeratedVariableName, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum SOURCE_FILE_AT_LINE (3768)) ;
        }
        GGS_string var_cas_typeName ;
        if (var_cas_enumeratedVariableType._isBuilt ()) {
          var_cas_enumeratedVariableType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (3771)) ;
        }
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3749)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3748)) ;
...
pr_parse_match_operand_semantics_parser_3834_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_type._isBuilt ()) {
    cPtr_typeGalgasClassType * operand_147024 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
    if (operand_147024 != NULL) {
      macroValidPointer (operand_147024) ; 
      var_cas_outBaseTypeName = operand_147024->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_147216 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      if (operand_147216 != NULL) {
        macroValidPointer (operand_147216) ; 
        var_cas_outBaseTypeName = operand_147216->mEnumTypeName ;
        var_cas_outIsEnumeration = GGS_bool (true, true) ;
        var_cas_outEnumMessageMap = operand_147216->mEnumConstantesMap ;
      }else{ // Else part
        GGS_string var_cas_actualTypeName ;
        if (var_cas_type._isBuilt ()) {
          var_cas_type (HERE)->method_getTypeName (_inLexique, var_cas_actualTypeName SOURCE_FILE_AT_LINE (3862)) ;
        }
        var_cas_variableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '@")) + (var_cas_actualTypeName))) + (GGS_string (true, "' ; I was expected an enumeration type or an abstract type"))) SOURCE_FILE_AT_LINE (3866)) ;
...
pr_parse_match_case_semantics_parser_3872_6_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (3886)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      var_cas_definitionClasse1._drop_operation () ;
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3887)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_definitionClasse1 = ptrExtraire_->aDefType ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_definitionClasse1.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgasClassType::static_string_message_messageGalgasType () ;
        message2_ << var_cas_definitionClasse1 (HERE)->message_messageGalgasType () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3900)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_listeAttributs1 = ptrExtraire_->mNonExternAttributesList ;
  ...
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class is not allowed here") SOURCE_FILE_AT_LINE (3904)) ;
  }
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a constant of '@")) + (var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3907))))) + (GGS_string (true, "' enumeration type is expected here"))) SOURCE_FILE_AT_LINE (3908)) ;
  }else if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (_inLexique, var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3908)) SOURCE_FILE_AT_LINE (3908))))).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This type does not inherit from '")) + (var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3909))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3910)) ;
  }
...
pr_parse_match_case_semantics_parser_3923_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    if (var_cas_inEnumMessageMap._isBuilt ()) {
      var_cas_inEnumMessageMap (HERE)->method_searchKey (_inLexique, var_cas_outEnumConstantName SOURCE_FILE_AT_LINE (3936)) ;
    }
  }else{
    var_cas_outEnumConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a class that inherit from '@")) + (var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3938))))) + (GGS_string (true, "' abstract class is expected here"))) SOURCE_FILE_AT_LINE (3939)) ;
  }
}
...
pr_semantic_instruction_semantics_parser_3944_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3988)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_41 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_when) COMMA_HERE) ;
          var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3992)) ;
          ...
          var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3992)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (4035)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_else) COMMA_HERE) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (4035)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3988)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_match) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_optional_assignment_semantics_parser_4117_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, automatic_var_25, automatic_var_26 SOURCE_FILE_AT_LINE (4129)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_inVariableType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (4140)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_optional_assignment_semantics_parser_4149_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, automatic_var_27, automatic_var_28 SOURCE_FILE_AT_LINE (4160)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B) COMMA_HERE) ;
  ...
  if (var_cas_inVariableType._isBuilt ()) {
    var_cas_inVariableType (HERE)->method_handleConstructorCall (_inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques SOURCE_FILE_AT_LINE (4166)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D) COMMA_HERE) ;
  GGS_typeExpression  var_cas_e ;
  var_cas_e = GGS_typeConstructorExpression::constructor_new (_inLexique, var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4179)), var_cas_constructorName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4180)), var_cas_expressionList COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_4192_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_43 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapindexTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4206)) SOURCE_FILE_AT_LINE (4206))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapindexTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4207)) SOURCE_FILE_AT_LINE (4207))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapindexType::constructor_new (_inLexique, var_cas_mapindexTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_mapindexTypeName, var_cas_t SOURCE_FILE_AT_LINE (4209)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
      ...
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
        var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_theEntity SOURCE_FILE_AT_LINE (4216)) ;
      }
      ...
      { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_theEntity.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_theEntity.getPtr () != NULL) {
            ...
            message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
            message2_ << var_cas_theEntity (HERE)->message_messageTypeEntite () ;
            var_cas_mapTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (4218)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      { cPtr_typeGalgasMapType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_aType.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_aType.getPtr () != NULL) {
            ...
            var_cas_mapTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (4229)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
          ...
          switch (select_repeat_semantics_parser_44 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_mapindexErrorMessage._isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_mapindexErrorMessage SOURCE_FILE_AT_LINE (4242)) ;
              }
              var_cas_mapIndexSearchReaderMap.modifier_insertKey (_inLexique, var_cas_searchReaderName, var_cas_mapindexErrorMessage SOURCE_FILE_AT_LINE (4243)) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_mapindexTypeName, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) SOURCE_FILE_AT_LINE (4256)) ;
...
pr_semantics_declaration_semantics_parser_4192_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_43 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapindexTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4279)) SOURCE_FILE_AT_LINE (4279))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapindexTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4280)) SOURCE_FILE_AT_LINE (4280))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapindexType::constructor_new (_inLexique, var_cas_mapindexTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_mapindexTypeName, var_cas_t SOURCE_FILE_AT_LINE (4282)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
      ...
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
        var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_theEntity SOURCE_FILE_AT_LINE (4289)) ;
      }
      GGS_AC_galgasType  var_cas_aType ;
      { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_theEntity.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_theEntity.getPtr () != NULL) {
            ...
            message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
            message2_ << var_cas_theEntity (HERE)->message_messageTypeEntite () ;
            var_cas_mapTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (4291)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
          var_cas_aType = ptrExtraire_->aDefType ;
      ...
      { cPtr_typeGalgasMapType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_aType.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_aType.getPtr () != NULL) {
            ...
            message1_ (0 COMMA_HERE) << cPtr_typeGalgasMapType::static_string_message_messageGalgasType () ;
            message2_ << var_cas_aType (HERE)->message_messageGalgasType () ;
            var_cas_mapTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (4302)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
          var_cas_mapAttributesList = ptrExtraire_->mNonExternAttributesList ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_44 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
              if (var_cas_mapindexErrorMessage._isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_mapindexErrorMessage SOURCE_FILE_AT_LINE (4315)) ;
              }
              var_cas_mapIndexSearchReaderMap.modifier_insertKey (_inLexique, var_cas_searchReaderName, var_cas_mapindexErrorMessage SOURCE_FILE_AT_LINE (4316)) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_galgasType  var_cas_t ;
      var_cas_t = GGS_typeGalgasMapindexType::constructor_new (_inLexique, var_cas_mapindexTypeName, var_cas_mapTypeName, var_cas_mapAttributesList, var_cas_mapIndexSearchReaderMap, var_cas_tableMethodesSurcharger, var_cas_modifierMethodMap, var_cas_readerMethodMap COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_mapindexTypeName, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) SOURCE_FILE_AT_LINE (4329)) ;
      } break ;
    default :
      break ;
  }
...
pr_semantics_declaration_semantics_parser_4339_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_45 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4353)) SOURCE_FILE_AT_LINE (4353))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4354)) SOURCE_FILE_AT_LINE (4354))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4356)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_class) COMMA_HERE) ;
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      var_cas_cppClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "old style map definition") SOURCE_FILE_AT_LINE (4363)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_46 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4376)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_search) COMMA_HERE) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4383)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 4 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29) COMMA_HERE) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              var_cas_tableMethodesBloc.modifier_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4418)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_insertOrSearchMethodList::element_type * operand_168180 = var_cas_insertMethodList.firstObject () ;
      while ((operand_168180 != NULL)) {
        macroValidPointer (operand_168180) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_168376 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_168376 != NULL)) {
          macroValidPointer (operand_168376) ;
          var_cas_methodSignature._addAssign_operation (operand_168376->mAttributType, var_cas_inPassingMode) ;
          operand_168376 = operand_168376->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_168180->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4446)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        ...
        while ((operand_168805 != NULL)) {
          ...
          var_cas_methodSignature._addAssign_operation (operand_168805->mAttributType, var_cas_inPassingMode) ;
          operand_168805 = operand_168805->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_168180->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4454))) + (GGS_string (true, "GetIndex"))), operand_168180->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4454)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4455)) ;
        operand_168180 = operand_168180->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_169153 = var_cas_searchMethodList.firstObject () ;
      while ((operand_169153 != NULL)) {
        macroValidPointer (operand_169153) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_169347 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_169347 != NULL)) {
          macroValidPointer (operand_169347) ;
          var_cas_methodSignature._addAssign_operation (operand_169347->mAttributType, var_cas_outPassingMode) ;
          operand_169347 = operand_169347->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_169153->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4464)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_169774 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_169774 != NULL)) {
          macroValidPointer (operand_169774) ;
          var_cas_methodSignature._addAssign_operation (operand_169774->mAttributType, var_cas_outPassingMode) ;
          operand_169774 = operand_169774->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_169153->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4472))) + (GGS_string (true, "GetIndex"))), operand_169153->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4472)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4473)) ;
        operand_169153 = operand_169153->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4484)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
          ...
          switch (select_repeat_semantics_parser_47 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4528)) ;
              }
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_172812 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_172812 != NULL)) {
                macroValidPointer (operand_172812) ;
                var_cas_methodSignature._addAssign_operation (operand_172812->mAttributType, var_cas_outPassingMode) ;
                operand_172812 = operand_172812->nextObject () ;
              }
              var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4536)) ;
              var_cas_removeMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4537)), GGS_bool (true, false), GGS_string (true, "")) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4539))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_173400 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_173400 != NULL)) {
                  macroValidPointer (operand_173400) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_173400->mAttributType, var_cas_outPassingMode) ;
                  operand_173400 = operand_173400->nextObject () ;
                }
                var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4546)) ;
                var_cas_removeMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4547)), GGS_bool (true, true), GGS_string (true, "")) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_insert) COMMA_HERE) ;
              ...
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4555)) ;
              }
              ...
              switch (select_semantics_parser_48 (_inLexique)) {
                ...
                case 2 : {
                  ...
                  if (var_cas_shadowErrorMessageString._isBuilt ()) {
                    ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_shadowErrorMessageString SOURCE_FILE_AT_LINE (4563)) ;
                  }
                  var_cas_shadowErrorMessage = var_cas_shadowErrorMessageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (4564)) ;
                  } break ;
                default :
                  break ;
              }
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_174495 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_174495 != NULL)) {
                macroValidPointer (operand_174495) ;
                var_cas_methodSignature._addAssign_operation (operand_174495->mAttributType, var_cas_inPassingMode) ;
                operand_174495 = operand_174495->nextObject () ;
              }
              var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4573)) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4574)), GGS_bool (true, false), var_cas_shadowErrorMessage) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4576))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_175098 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_175098 != NULL)) {
                  macroValidPointer (operand_175098) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_175098->mAttributType, var_cas_inPassingMode) ;
                  operand_175098 = operand_175098->nextObject () ;
                }
                var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4583)) ;
                var_cas_insertMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4584)), GGS_bool (true, true), var_cas_shadowErrorMessage) ;
              }
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_search) COMMA_HERE) ;
              ...
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_K_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4592)) ;
              }
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_175879 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_175879 != NULL)) {
                macroValidPointer (operand_175879) ;
                var_cas_methodSignature._addAssign_operation (operand_175879->mAttributType, var_cas_outPassingMode) ;
                operand_175879 = operand_175879->nextObject () ;
              }
              var_cas_mapReaderMethodMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4600)) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4601)), GGS_bool (true, false), GGS_string (true, "")) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4603))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_176497 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_176497 != NULL)) {
                  macroValidPointer (operand_176497) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_176497->mAttributType, var_cas_outPassingMode) ;
                  operand_176497 = operand_176497->nextObject () ;
                }
                var_cas_mapReaderMethodMap.modifier_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4610)) ;
                var_cas_searchMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4611)), GGS_bool (true, true), GGS_string (true, "")) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
...
pr_semantics_declaration_semantics_parser_4339_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_45 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4649)) SOURCE_FILE_AT_LINE (4649))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4649)) SOURCE_FILE_AT_LINE (4649))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4651)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_class) COMMA_HERE) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_46 (_inLexique)) {
            case 2 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4670)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_search) COMMA_HERE) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4677)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_block) COMMA_HERE) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29) COMMA_HERE) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
              var_cas_tableMethodesBloc.modifier_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4712)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_181156 = var_cas_insertMethodList.firstObject () ;
      while ((operand_181156 != NULL)) {
        macroValidPointer (operand_181156) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_181352 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_181352 != NULL)) {
          macroValidPointer (operand_181352) ;
          var_cas_methodSignature._addAssign_operation (operand_181352->mAttributType, var_cas_inPassingMode) ;
          operand_181352 = operand_181352->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_181156->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4740)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_181781 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_181781 != NULL)) {
          macroValidPointer (operand_181781) ;
          var_cas_methodSignature._addAssign_operation (operand_181781->mAttributType, var_cas_inPassingMode) ;
          operand_181781 = operand_181781->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_181156->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4748))) + (GGS_string (true, "GetIndex"))), operand_181156->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4748)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4749)) ;
        operand_181156 = operand_181156->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_182129 = var_cas_searchMethodList.firstObject () ;
      while ((operand_182129 != NULL)) {
        macroValidPointer (operand_182129) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_182325 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_182325 != NULL)) {
          macroValidPointer (operand_182325) ;
          var_cas_methodSignature._addAssign_operation (operand_182325->mAttributType, var_cas_outPassingMode) ;
          operand_182325 = operand_182325->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_182129->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4758)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_182755 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_182755 != NULL)) {
          macroValidPointer (operand_182755) ;
          var_cas_methodSignature._addAssign_operation (operand_182755->mAttributType, var_cas_outPassingMode) ;
          operand_182755 = operand_182755->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_182129->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4766))) + (GGS_string (true, "GetIndex"))), operand_182129->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4766)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4767)) ;
        operand_182129 = operand_182129->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4778)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4780)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_47 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_184989 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_184989 != NULL)) {
                macroValidPointer (operand_184989) ;
                var_cas_methodSignature._addAssign_operation (operand_184989->mAttributType, var_cas_outPassingMode) ;
                operand_184989 = operand_184989->nextObject () ;
              }
              var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4819)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4821))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_185533 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_185533 != NULL)) {
                  macroValidPointer (operand_185533) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_185533->mAttributType, var_cas_outPassingMode) ;
                  operand_185533 = operand_185533->nextObject () ;
                }
                var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4828)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_insert) COMMA_HERE) ;
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_186213 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_186213 != NULL)) {
                macroValidPointer (operand_186213) ;
                var_cas_methodSignature._addAssign_operation (operand_186213->mAttributType, var_cas_inPassingMode) ;
                operand_186213 = operand_186213->nextObject () ;
              }
              var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4847)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4849))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_186756 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_186756 != NULL)) {
                  macroValidPointer (operand_186756) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_186756->mAttributType, var_cas_inPassingMode) ;
                  operand_186756 = operand_186756->nextObject () ;
                }
                var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4856)) ;
              }
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_search) COMMA_HERE) ;
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_187356 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_187356 != NULL)) {
                macroValidPointer (operand_187356) ;
                var_cas_methodSignature._addAssign_operation (operand_187356->mAttributType, var_cas_outPassingMode) ;
                operand_187356 = operand_187356->nextObject () ;
              }
              var_cas_mapReaderMethodMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4870)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4872))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_187940 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_187940 != NULL)) {
                  macroValidPointer (operand_187940) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_187940->mAttributType, var_cas_outPassingMode) ;
                  operand_187940 = operand_187940->nextObject () ;
                }
                var_cas_mapReaderMethodMap.modifier_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4879)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4891)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.modifier_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4893)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      } break ;
    default :
      break ;
...
pr_semantics_declaration_semantics_parser_4935_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4949)) SOURCE_FILE_AT_LINE (4949))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4949)) SOURCE_FILE_AT_LINE (4949))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4951)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
      ...
      GGS_typeListeAttributsSemantiques::element_type * operand_191255 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_191255 != NULL)) {
        macroValidPointer (operand_191255) ;
        var_cas_extractSignature._addAssign_operation (operand_191255->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_191255->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_191255 = operand_191255->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4983)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
pr_semantics_declaration_semantics_parser_4935_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5004)) SOURCE_FILE_AT_LINE (5004))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5004)) SOURCE_FILE_AT_LINE (5004))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (5006)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
      ...
      GGS_L_EXsignature  var_cas_inputSignature ;
      var_cas_inputSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_193455 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_193455 != NULL)) {
        macroValidPointer (operand_193455) ;
        var_cas_extractSignature._addAssign_operation (operand_193455->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_193455->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_193455 = operand_193455->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_5050_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_51 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5064)) SOURCE_FILE_AT_LINE (5064))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5064)) SOURCE_FILE_AT_LINE (5064))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (5066)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
      ...
      GGS_L_EXsignature  var_cas_extractSignature ;
      var_cas_extractSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_196017 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_196017 != NULL)) {
        macroValidPointer (operand_196017) ;
        var_cas_extractSignature._addAssign_operation (operand_196017->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        operand_196017 = operand_196017->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            if ((var_cas_usedSortedAttributes.reader_hasKey (_inLexique, var_cas_sortAttribute.reader_string (_inLexique SOURCE_FILE_AT_LINE (5101)) SOURCE_FILE_AT_LINE (5101))).isBuiltAndTrue ()) {
              var_cas_sortAttribute.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this attribute is already used in sort list") SOURCE_FILE_AT_LINE (5103)) ;
            }else{
              GGS_AC_galgasType  var_cas_definitionType ;
              if (var_cas_tableAttributs._isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (_inLexique, var_cas_sortAttribute, var_cas_definitionType SOURCE_FILE_AT_LINE (5105)) ;
              }
              if (var_cas_definitionType._isBuilt ()) {
                var_cas_definitionType (HERE)->method_acceptToBeSortKeyInSortedListDefinition (_inLexique, var_cas_sortAttribute SOURCE_FILE_AT_LINE (5106)) ;
              }
              var_cas_usedSortedAttributes._addAssign_operation (var_cas_sortAttribute.reader_string (_inLexique SOURCE_FILE_AT_LINE (5107))) ;
            }
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5123)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
pr_semantics_declaration_semantics_parser_5050_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_51 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5145)) SOURCE_FILE_AT_LINE (5145))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5145)) SOURCE_FILE_AT_LINE (5145))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (5147)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
      ...
      GGS_L_EXsignature  var_cas_extractSignature ;
      var_cas_extractSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_199028 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_199028 != NULL)) {
        macroValidPointer (operand_199028) ;
        var_cas_extractSignature._addAssign_operation (operand_199028->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        operand_199028 = operand_199028->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasSortedListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5189)) ;
      GGS_TypeModel  var_cas_t ;
      var_cas_t = GGS_ListModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.modifier_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (5191)) ;
      } break ;
    default :
      break ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_54 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          var_cas_tableAttributs.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_definitionType SOURCE_FILE_AT_LINE (5225)) ;
...
pr_semantics_declaration_semantics_parser_5239_6_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_55 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          var_cas_constructorsMap.modifier_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (5289)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
          GGS_lstring  var_cas_methodName ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          var_cas_readersInInstructionMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5309)) ;
          } break ;
        case 4 : {
          ...
          switch (select_semantics_parser_57 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signatureForGrammarComponent ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
              var_cas_modifiersMap.modifier_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5329)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2B_3D) COMMA_HERE) ;
              ...
              if ((var_cas_acceptAddAssignOperatorCall).isBuiltAndTrue ()) {
                var_cas_errorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (5350)) ;
              }else{
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (5368)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
}
...
pr_semantics_declaration_semantics_parser_5239_6_importSemantics (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_55 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          var_cas_EXconstructorsMap.modifier_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (5425)) ;
          var_cas_constructorMap.modifier_insertKey (_inLexique, var_cas_constructorName, var_cas_formalInputArgumentList SOURCE_FILE_AT_LINE (5426)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          var_cas_readersInInstructionMap.modifier_insertKey (_inLexique, var_cas_readerName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5446)) ;
          var_cas_readerMap.modifier_insertKey (_inLexique, var_cas_readerName, var_cas_signature SOURCE_FILE_AT_LINE (5447)) ;
          } break ;
        case 4 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_modifier) COMMA_HERE) ;
          switch (select_semantics_parser_57 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signature ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
              var_cas_EXmodifiersMap.modifier_insertKey (_inLexique, var_cas_modifierName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5467)) ;
              var_cas_modifierMap.modifier_insertKey (_inLexique, var_cas_modifierName, var_cas_signature SOURCE_FILE_AT_LINE (5468)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2B_3D) COMMA_HERE) ;
              if (((var_cas_addAssignFormalInputArgumentList.reader_length (_inLexique SOURCE_FILE_AT_LINE (5471))) > (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (5473)) ;
              }else{
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true, true) ;
              }
              { bool syntaxRepeat = true ;
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (5504)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.modifier_insertKey (_inLexique, var_cas_externTypeName, var_cas_t SOURCE_FILE_AT_LINE (5506)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
}
...
pr_formal_argument_type_semantics_parser_5514_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5521)) SOURCE_FILE_AT_LINE (5521))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_inComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5523)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        ...
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5524)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5526)) ;
    }
  }
}
    ...
    { cPtr_typeGalgasUndefinedListType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5550)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
pr_formal_argument_type_semantics_parser_5586_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5595)) SOURCE_FILE_AT_LINE (5595))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_inComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5597)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5600)) ;
    }
    { cPtr_typeGalgasUndefinedClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          message2_ << var_cas_type_semantique (HERE)->message_messageGalgasType () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5601)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
pr_semantics_declaration_semantics_parser_5617_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (5642)) ;
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_semantics_declaration_semantics_parser_5617_6_importSemantics (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  var_cas_entite = GGS_typeEntiteActionExterne::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_actionName, var_cas_entite SOURCE_FILE_AT_LINE (5671)) ;
  var_cas_ioExternActionMap.modifier_insertKey (_inLexique, var_cas_actionName, var_cas_signature, GGS_bool (true, true) SOURCE_FILE_AT_LINE (5672)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
pr_semantics_declaration_semantics_parser_5682_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
        var_cas_constantMap.modifier_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5703)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
                var_cas_cstMessageStringMap.modifier_insertKey (_inLexique, var_cas_cstName, var_cas_cstString SOURCE_FILE_AT_LINE (5723)) ;
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          ...
          GGS_enumConstantMap::element_type * operand_219827 = var_cas_constantMap.firstObject () ;
          while ((operand_219827 != NULL)) {
            macroValidPointer (operand_219827) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_219827->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (5731)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            if (var_cas_cstMessageStringMap._isBuilt ()) {
              var_cas_cstMessageStringMap (HERE)->method_searchKey (_inLexique, var_cas_name, var_cas_cstString SOURCE_FILE_AT_LINE (5733)) ;
            }
            var_cas_messageStringList._addAssign_operation (var_cas_cstString) ;
            operand_219827 = operand_219827->nextObject () ;
          }
          var_cas_enumMessageMap.modifier_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5737)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_enumTypeName, var_cas_ee SOURCE_FILE_AT_LINE (5749)) ;
}
...
pr_semantics_declaration_semantics_parser_5682_6_importSemantics (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique._assignFromAttribute_tokenString (var_cas_constantName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
        var_cas_constantMap.modifier_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5769)) ;
      switch (select_repeat_semantics_parser_59 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_60 (_inLexique)) {
        case 2 : {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_messageName) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          var_cas_enumMessageMap.modifier_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (5784)) ;
          GGS_L_lstringList  var_cas_messageStringList ;
          var_cas_messageStringList = GGS_L_lstringList::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_exEnumMessageMap.modifier_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5786)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_enumTypeName, var_cas_e SOURCE_FILE_AT_LINE (5803)) ;
  GGS_TypeModel  var_cas_type ;
  var_cas_type = GGS_EnumModel::constructor_new (_inLexique, var_cas_constantMap, var_cas_enumMessageMap COMMA_HERE) ;
  var_cas_ioModelMap.modifier_insertKey (_inLexique, var_cas_enumTypeName, var_cas_type SOURCE_FILE_AT_LINE (5805)) ;
}
