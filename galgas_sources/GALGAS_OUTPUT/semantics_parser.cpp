...
pr_semantics_declaration_semantics_parser_1714_29_ (galgas_scanner & _inLexique,
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_69607 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_69607 != NULL)) {
    macroValidPointer (operand_69607) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_69607->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1840)) SOURCE_FILE_AT_LINE (1840))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_69607->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1841))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1842)) ;
    }
    operand_69607 = operand_69607->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_1714_29_importSemantics (galgas_scanner & _inLexique,
  ...
  if (((var_cas_superClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1912))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    if (var_cas_type._isBuilt ()) {
      if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
        cPtr_ClassModel * operand_72785 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
        macroValidPointer (operand_72785) ; 
        var_cas_superClasses = operand_72785->mSuperClasses ;
        var_cas_attributeList = operand_72785->mAttributeList ;
        var_cas_messageMap = operand_72785->mMessageMap ;
      }else{ // Else part
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_76808 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_76808 != NULL)) {
    macroValidPointer (operand_76808) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_76808->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2018)) SOURCE_FILE_AT_LINE (2018))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_76808->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2019))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (2020)) ;
    }
    operand_76808 = operand_76808->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  var_cas_c = GGS_typeGalgasClassType::constructor_new (_inLexique, var_cas_concreteClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
...
pr_parse_method_semantics_parser_2073_20_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_81595 = var_cas_listeAttributsSemantiquesCourants.firstObject () ;
  while ((operand_81595 != NULL)) {
    macroValidPointer (operand_81595) ;
    GGS_typeCplusPlusName  var_cas_nomCpp ;
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (_inLexique, operand_81595->aNomAttribut COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_81595->aNomAttribut, operand_81595->mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (2134)) ;
    operand_81595 = operand_81595->nextObject () ;
  }
...
pr_input_parameters_list_semantics_parser_2485_29_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2507))) < (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2507)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_96509 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_96595 = var_cas_listeCibles.firstObject () ;
    while ((operand_96509 != NULL)
        && (operand_96595 != NULL)) {
      macroValidPointer (operand_96509) ;
      macroValidPointer (operand_96595) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_96509->aNomAttribut ;
      if (operand_96595->aCible._isBuilt ()) {
        operand_96595->aCible (HERE)->method_verifierType (_inLexique, operand_96509->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList SOURCE_FILE_AT_LINE (2521)) ;
      }
      operand_96509 = operand_96509->nextObject () ;
      operand_96595 = operand_96595->nextObject () ;
    }
  }
...
pr_instruction_beginning_with_identifier_semantics_parser_2566_45_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2600))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2600)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_99804 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_99878 = var_cas_typeList.firstObject () ;
    while ((operand_99804 != NULL)
        && (operand_99878 != NULL)) {
      macroValidPointer (operand_99804) ;
      macroValidPointer (operand_99878) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_99804->mAttributType,  operand_99878->mType,  operand_99878->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2606)) ;
      operand_99804 = operand_99804->nextObject () ;
      operand_99878 = operand_99878->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2625_45_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2659))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2659)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_102261 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_102335 = var_cas_typeList.firstObject () ;
    while ((operand_102261 != NULL)
        && (operand_102335 != NULL)) {
      macroValidPointer (operand_102261) ;
      macroValidPointer (operand_102335) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_102261->mAttributType,  operand_102335->mType,  operand_102335->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2665)) ;
      operand_102261 = operand_102261->nextObject () ;
      operand_102335 = operand_102335->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_2870_28_ (galgas_scanner & _inLexique,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_112726 ;
            GGS_uint  var_cas_112729 ;
            GGS_string var_cas_112732 ;
            GGS_bool var_cas_112735 ;
            if (var_cas_ioMapAsConstraintPropertyMap._isBuilt ()) {
              var_cas_ioMapAsConstraintPropertyMap (HERE)->method_searchKey (_inLexique, var_cas_propertyArgumentName, var_cas_propertyTypeName, var_cas_112726, var_cas_112729, var_cas_112732, var_cas_112735 SOURCE_FILE_AT_LINE (2904)) ;
            }
  ...
  if ((var_cas_ioCallInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, var_cas_calledPropertyName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2913)) SOURCE_FILE_AT_LINE (2913))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_previousParameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2917))) == (var_cas_parameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2917)))).isBuiltAndTrue ()) {
      GGS_sharedPropertyList::element_type * operand_113404 = var_cas_previousParameterTypeList.firstObject () ;
      GGS_sharedPropertyList::element_type * operand_113472 = var_cas_parameterTypeList.firstObject () ;
      while ((operand_113404 != NULL)
          && (operand_113472 != NULL)) {
        macroValidPointer (operand_113404) ;
        macroValidPointer (operand_113472) ;
        if (((operand_113404->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2920))) != (operand_113472->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2920)))).isBuiltAndTrue ()) {
          operand_113472->mSharedPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this shared property has '@")) + (operand_113472->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2921))))) + (GGS_string (true, "' type, while a previous call has named an attribute of type '@")))) + (operand_113404->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2922))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2923)) ;
        }
        operand_113404 = operand_113404->nextObject () ;
        operand_113472 = operand_113472->nextObject () ;
      }
    }else{
...
pr_drop_instruction_semantics_parser_3277_24_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_galgasType  var_cas_127792 ;
        var_cas_ioVariablesMap.method_searchForDestructiveReadAccess (_inLexique, var_cas_nom, var_cas_127792, var_cas_nomCppVar SOURCE_FILE_AT_LINE (3287)) ;
        GGS_typeInstruction  var_cas_instruction ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_AC_galgasType  var_cas_140270 ;
            var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariable, var_cas_140270, var_cas_varCppName SOURCE_FILE_AT_LINE (3589)) ;
...
pr_parse_match_operand_semantics_parser_4015_27_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_type._isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_typeGalgasClassType * operand_157065 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_157065) ; 
      var_cas_outBaseTypeName = operand_157065->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_157271 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_157271) ; 
      var_cas_outBaseTypeName = operand_157271->mEnumTypeName ;
      var_cas_outIsEnumeration = GGS_bool (true, true) ;
      var_cas_outEnumMessageMap = operand_157271->mEnumConstantesMap ;
    }else{ // Else part
...
pr_optional_assignment_semantics_parser_4302_27_ (galgas_scanner & _inLexique,
                                ...
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  GGS_AC_galgasType  var_cas_167226 ;
  GGS_typeCplusPlusName  var_cas_167229 ;
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_167226, var_cas_167229 SOURCE_FILE_AT_LINE (4314)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
...
pr_optional_assignment_semantics_parser_4334_27_ (galgas_scanner & _inLexique,
                                ...
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  GGS_AC_galgasType  var_cas_168342 ;
  GGS_typeCplusPlusName  var_cas_168345 ;
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_168342, var_cas_168345 SOURCE_FILE_AT_LINE (4345)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
...
pr_semantics_declaration_semantics_parser_4374_29_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_41 (_inLexique)) {
    ...
    case 2 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_42 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4410)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 3 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4417)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 4 : {
      ...
      GGS_insertOrSearchMethodList::element_type * operand_173255 = var_cas_insertMethodList.firstObject () ;
      while ((operand_173255 != NULL)) {
        macroValidPointer (operand_173255) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_173453 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_173453 != NULL)) {
          macroValidPointer (operand_173453) ;
          var_cas_methodSignature._addAssign_operation (operand_173453->mAttributType, var_cas_inPassingMode) ;
          operand_173453 = operand_173453->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_173255->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4481)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_173884 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_173884 != NULL)) {
          macroValidPointer (operand_173884) ;
          var_cas_methodSignature._addAssign_operation (operand_173884->mAttributType, var_cas_inPassingMode) ;
          operand_173884 = operand_173884->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_173255->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4489))) + (GGS_string (true, "GetIndex"))), operand_173255->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4489)) COMMA_HERE) ;
        ...
        operand_173255 = operand_173255->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_174234 = var_cas_searchMethodList.firstObject () ;
      while ((operand_174234 != NULL)) {
        macroValidPointer (operand_174234) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_174430 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_174430 != NULL)) {
          macroValidPointer (operand_174430) ;
          var_cas_methodSignature._addAssign_operation (operand_174430->mAttributType, var_cas_outPassingMode) ;
          operand_174430 = operand_174430->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_174234->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4499)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_174859 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_174859 != NULL)) {
          macroValidPointer (operand_174859) ;
          var_cas_methodSignature._addAssign_operation (operand_174859->mAttributType, var_cas_outPassingMode) ;
          operand_174859 = operand_174859->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_174234->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4507))) + (GGS_string (true, "GetIndex"))), operand_174234->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4507)) COMMA_HERE) ;
        ...
        operand_174234 = operand_174234->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_43 (_inLexique)) {
            case 2 : {
              ...
              switch (select_semantics_parser_44 (_inLexique)) {
                ...
                case 2 : {
                  ...
                  if (var_cas_shadowErrorMessageString._isBuilt ()) {
                    ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_shadowErrorMessageString SOURCE_FILE_AT_LINE (4572)) ;
                  }
                  var_cas_shadowErrorMessage = var_cas_shadowErrorMessageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (4573)) ;
                  } break ;
                default :
                  break ;
              }
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_178390 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_178390 != NULL)) {
                macroValidPointer (operand_178390) ;
                var_cas_methodSignature._addAssign_operation (operand_178390->mAttributType, var_cas_inPassingMode) ;
                operand_178390 = operand_178390->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4582)) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4583)), GGS_bool (true, false), var_cas_shadowErrorMessage) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4585))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_178995 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_178995 != NULL)) {
                  macroValidPointer (operand_178995) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_178995->mAttributType, var_cas_inPassingMode) ;
                  operand_178995 = operand_178995->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4592)) ;
                var_cas_insertMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4593)), GGS_bool (true, true), var_cas_shadowErrorMessage) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              ...
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_K_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4601)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_179785 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_179785 != NULL)) {
                macroValidPointer (operand_179785) ;
                var_cas_methodSignature._addAssign_operation (operand_179785->mAttributType, var_cas_outPassingMode) ;
                operand_179785 = operand_179785->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4609)) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4610)), GGS_bool (true, false), GGS_string (true, "")) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4612))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_180405 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_180405 != NULL)) {
                  macroValidPointer (operand_180405) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_180405->mAttributType, var_cas_outPassingMode) ;
                  operand_180405 = operand_180405->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4619)) ;
                var_cas_searchMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4620)), GGS_bool (true, true), GGS_string (true, "")) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
...
pr_semantics_declaration_semantics_parser_4374_29_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_41 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4655)) SOURCE_FILE_AT_LINE (4655))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4655)) SOURCE_FILE_AT_LINE (4655))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4657)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_42 (_inLexique)) {
            case 2 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4676)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4683)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4718)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_185293 = var_cas_insertMethodList.firstObject () ;
      while ((operand_185293 != NULL)) {
        macroValidPointer (operand_185293) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_185491 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_185491 != NULL)) {
          macroValidPointer (operand_185491) ;
          var_cas_methodSignature._addAssign_operation (operand_185491->mAttributType, var_cas_inPassingMode) ;
          operand_185491 = operand_185491->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_185293->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4747)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_185922 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_185922 != NULL)) {
          macroValidPointer (operand_185922) ;
          var_cas_methodSignature._addAssign_operation (operand_185922->mAttributType, var_cas_inPassingMode) ;
          operand_185922 = operand_185922->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_185293->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4755))) + (GGS_string (true, "GetIndex"))), operand_185293->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4755)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4756)) ;
        operand_185293 = operand_185293->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_186272 = var_cas_searchMethodList.firstObject () ;
      while ((operand_186272 != NULL)) {
        macroValidPointer (operand_186272) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_186470 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_186470 != NULL)) {
          macroValidPointer (operand_186470) ;
          var_cas_methodSignature._addAssign_operation (operand_186470->mAttributType, var_cas_outPassingMode) ;
          operand_186470 = operand_186470->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_186272->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4765)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_186902 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_186902 != NULL)) {
          macroValidPointer (operand_186902) ;
          var_cas_methodSignature._addAssign_operation (operand_186902->mAttributType, var_cas_outPassingMode) ;
          operand_186902 = operand_186902->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_186272->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4773))) + (GGS_string (true, "GetIndex"))), operand_186272->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4773)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4774)) ;
        operand_186272 = operand_186272->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4785)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4787)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_43 (_inLexique)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_189008 ;
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_189008) ;
              switch (select_semantics_parser_44 (_inLexique)) {
                case 1 : {
                  } break ;
                case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_189303 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_189303 != NULL)) {
                macroValidPointer (operand_189303) ;
                var_cas_methodSignature._addAssign_operation (operand_189303->mAttributType, var_cas_inPassingMode) ;
                operand_189303 = operand_189303->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4832)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4834))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_189848 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_189848 != NULL)) {
                  macroValidPointer (operand_189848) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_189848->mAttributType, var_cas_inPassingMode) ;
                  operand_189848 = operand_189848->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4841)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_190235 ;
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_190235) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_190450 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_190450 != NULL)) {
                macroValidPointer (operand_190450) ;
                var_cas_methodSignature._addAssign_operation (operand_190450->mAttributType, var_cas_outPassingMode) ;
                operand_190450 = operand_190450->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4855)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4857))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_191036 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_191036 != NULL)) {
                  macroValidPointer (operand_191036) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_191036->mAttributType, var_cas_outPassingMode) ;
                  operand_191036 = operand_191036->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4864)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4876)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4878)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    default :
      break ;
...
void semantics_parser::
semantics_parser::
pr_ex_map_method_semantics_parser_4885_21_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomMethode,
...
void semantics_parser::
pr_ex_map_method_semantics_parser_4885_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_error) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void semantics_parser::
semantics_parser::
pr_map_method_semantics_parser_4897_18_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_methodName,
                                GGS_lstring  &var_cas_getIndexMethodName,
                                GGS_lstring  &var_cas_outMessage) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_map_method_semantics_parser_4897_18_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_45 (_inLexique)) {
    case 1 : {
      } break ;
...
void semantics_parser::
semantics_parser::
pr_message_pattern_semantics_parser_4916_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        switch (select_semantics_parser_47 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
            var_cas_messageText.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
            if (((var_cas_messageText.reader_string (_inLexique SOURCE_FILE_AT_LINE (4924))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_outMessageList._addAssign_operation (var_cas_messageText.reader_string (_inLexique SOURCE_FILE_AT_LINE (4925))) ;
            }
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2A) ;
...
void semantics_parser::
pr_message_pattern_semantics_parser_4916_23_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_semantics_parser_47 (_inLexique)) {
          case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4942_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_48 (_inLexique)) {
    case 1 : {
      ...
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4955)) SOURCE_FILE_AT_LINE (4955))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4955)) SOURCE_FILE_AT_LINE (4955))))))).isBuiltAndTrue ()) {
        ...
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4957)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4979)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4942_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_48 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4996)) SOURCE_FILE_AT_LINE (4996))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4996)) SOURCE_FILE_AT_LINE (4996))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4998)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5020)) ;
      GGS_TypeModel  var_cas_t ;
      var_cas_t = GGS_ListModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (5022)) ;
      } break ;
    default :
      break ;
  }
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4942_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_48 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_attributes_definition_list_semantics_parser_5032_34_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_49 (_inLexique)) {
        case 2 : {
          ...
          var_cas_tableAttributs.method_insertKey (_inLexique, var_cas_attributeName, var_cas_definitionType SOURCE_FILE_AT_LINE (5056)) ;
...
void semantics_parser::
pr_attributes_definition_list_semantics_parser_5032_34_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_49 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5070_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_50 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_constructorsMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (5119)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
          GGS_lstring  var_cas_methodName ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5139)) ;
          } break ;
        case 4 : {
          ...
          switch (select_semantics_parser_52 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signatureForGrammarComponent ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
              var_cas_modifiersMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5159)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              ...
              if ((var_cas_acceptAddAssignOperatorCall).isBuiltAndTrue ()) {
                var_cas_errorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (5180)) ;
              }else{
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (5198)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5070_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_50 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_EXconstructorsMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (5254)) ;
          var_cas_constructorMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_formalInputArgumentList SOURCE_FILE_AT_LINE (5255)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.method_insertKey (_inLexique, var_cas_readerName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5275)) ;
          var_cas_readerMap.method_insertKey (_inLexique, var_cas_readerName, var_cas_signature SOURCE_FILE_AT_LINE (5276)) ;
          } break ;
        case 4 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_modifier) ;
          switch (select_semantics_parser_52 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signature ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
              var_cas_EXmodifiersMap.method_insertKey (_inLexique, var_cas_modifierName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5296)) ;
              var_cas_modifierMap.method_insertKey (_inLexique, var_cas_modifierName, var_cas_signature SOURCE_FILE_AT_LINE (5297)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              if (((var_cas_addAssignFormalInputArgumentList.reader_length (_inLexique SOURCE_FILE_AT_LINE (5300))) > (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (5302)) ;
              }else{
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true, true) ;
              }
              { bool syntaxRepeat = true ;
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (5333)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_t SOURCE_FILE_AT_LINE (5335)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5070_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extern) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5343_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5350)) SOURCE_FILE_AT_LINE (5350))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5352)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5343_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
}
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5343_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5365_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5365_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5365_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5390_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5398)) SOURCE_FILE_AT_LINE (5398))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5400)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5403)) ;
    }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5390_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5390_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5415_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5424)) SOURCE_FILE_AT_LINE (5424))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5426)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5429)) ;
    }
    { cPtr_typeGalgasUndefinedClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          message2_ << var_cas_type_semantique (HERE)->message_messageGalgasType () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5430)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5415_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5415_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5446_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (5470)) ;
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5446_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
                                GGS_ActionMap  &var_cas_ioExternActionMap,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  var_cas_entite = GGS_typeEntiteActionExterne::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_actionName, var_cas_entite SOURCE_FILE_AT_LINE (5498)) ;
  var_cas_ioExternActionMap.method_insertKey (_inLexique, var_cas_actionName, var_cas_signature, GGS_bool (true, true) SOURCE_FILE_AT_LINE (5499)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5446_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_action) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5509_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5529)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_cstMessageStringMap.method_insertKey (_inLexique, var_cas_cstName, var_cas_cstString SOURCE_FILE_AT_LINE (5548)) ;
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          ...
          GGS_enumConstantMap::element_type * operand_216714 = var_cas_constantMap.firstObject () ;
          while ((operand_216714 != NULL)) {
            macroValidPointer (operand_216714) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_216714->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (5556)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            if (var_cas_cstMessageStringMap._isBuilt ()) {
              var_cas_cstMessageStringMap (HERE)->method_searchKey (_inLexique, var_cas_name, var_cas_cstString SOURCE_FILE_AT_LINE (5558)) ;
            }
            var_cas_messageStringList._addAssign_operation (var_cas_cstString) ;
            operand_216714 = operand_216714->nextObject () ;
          }
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5562)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_ee SOURCE_FILE_AT_LINE (5574)) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5509_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5593)) ;
      switch (select_repeat_semantics_parser_54 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2C) ;
          } break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_55 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_messageName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (5607)) ;
          GGS_L_lstringList  var_cas_messageStringList ;
          var_cas_messageStringList = GGS_L_lstringList::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_exEnumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5609)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_e SOURCE_FILE_AT_LINE (5626)) ;
  GGS_TypeModel  var_cas_type ;
  var_cas_type = GGS_EnumModel::constructor_new (_inLexique, var_cas_constantMap, var_cas_enumMessageMap COMMA_HERE) ;
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_type SOURCE_FILE_AT_LINE (5628)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_semantics_declaration_semantics_parser_5509_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_enum) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  { bool syntaxRepeat = true ;
