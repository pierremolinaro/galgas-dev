    ...
    case 3 : {
      ...
      GGS_stringset  var_cas_accessibilityGraph = GGS_stringset ::constructor_emptySet () ;
      {
        ...
        while (((operand_232067 = enumerator_232067.nextObject ()))) {
          ...
          GGS_bool var_cas_progress = GGS_bool (true) ;
          GGS_uint _variant_232782 = var_cas_mapAutomatonStateMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (6207)) ;
          GGS_bool _condition_232782 (_variant_232782.isBuilt (), true) ;
          while (_condition_232782.isBuiltAndTrue ()) {
            _condition_232782 = var_cas_progress ;
            if (_condition_232782.isBuiltAndTrue ()) {
              if (_variant_232782.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (6220)) ;
                _condition_232782 = GGS_bool (false) ;
              }else{
                _variant_232782.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_progress = GGS_bool (false) ;
                {
                  ...
                  while (((operand_232310 = enumerator_232310.nextObject ()))) {
                    ...
                    const GGS_bool cond_232745 = var_cas_reachableStates.reader_hasKey (operand_232310->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6210))) ;
                    if (cond_232745.isBuiltAndTrue ()) {
                      {
                        GGS_mapStateTransitionList::cEnumerator enumerator_232413 (operand_232310->mTransitionList, true) ;
                        const GGS_mapStateTransitionList::cElement * operand_232413 = NULL ;
                        while (((operand_232413 = enumerator_232413.nextObject ()))) {
                          macroValidPointer (operand_232413) ;
                          const GGS_bool cond_232700 = (var_cas_reachableStates.reader_hasKey (operand_232413->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6212)))).operator_not () ;
                          if (cond_232700.isBuiltAndTrue ()) {
                            var_cas_reachableStates.addAssign_operation (operand_232413->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6213))) ;
                            var_cas_accessibilityGraph.addAssign_operation (((operand_232067->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6214))).operator_concat (GGS_string (":"))).operator_concat (operand_232413->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6214)))) ;
                            var_cas_progress = GGS_bool (true) ;
                          }
                        }
                      }
          ...
          {
            GGS_stringset::cEnumerator enumerator_232819 (var_cas_reachableStates, true) ;
            while (enumerator_232819.hasCurrentObject ()) {
              const GGS_bool cond_232932 = (operand_232067->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6222))).operator_isNotEqual (enumerator_232819._key (HERE)) ;
              if (cond_232932.isBuiltAndTrue ()) {
                var_cas_neededAssociations.addAssign_operation (((operand_232067->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6223))).operator_concat (GGS_string (":"))).operator_concat (enumerator_232819._key (HERE))) ;
              }
              enumerator_232819.next () ;
            }
          }
        }
      }
        ...
        while (syntaxRepeat_74) {
          switch (select_semantics_5F_parser_74 (inLexique)) {
            case 2 : {
                ...
                while (syntaxRepeat_75) {
                  switch (select_semantics_5F_parser_75 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_234072 = (var_cas_neededAssociations.reader_hasKey (var_cas_association)).operator_not () ;
                      if (cond_234072.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_234252 = var_cas_handledAssociations.reader_hasKey (var_cas_association) ;
                      if (cond_234252.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_235021 = (var_cas_startStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))).operator_isNotEqual (var_cas_finalStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))) ;
                      if (cond_235021.isBuiltAndTrue ()) {
                        ...
                        const GGS_bool cond_235004 = (var_cas_accessibilityGraph.reader_hasKey (((var_cas_startStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))).operator_concat (GGS_string (":"))).operator_concat (var_cas_finalStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))))).operator_not () ;
                        if (cond_235004.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_236437 = (var_cas_forgottenAssociations.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_236437.isBuiltAndTrue ()) {
                GGS_string var_cas_s = GGS_string ("") ;
                {
                  GGS_stringset::cEnumerator enumerator_236268 (var_cas_forgottenAssociations, true) ;
                  while (enumerator_236268.hasCurrentObject ()) {
                    var_cas_s.appendCString ("\n"
                      "  - ") ;
                    var_cas_s.dotAssign_operation (enumerator_236268._key (HERE)) ;
                    enumerator_236268.next () ;
                  }
                }
                ...
                while (syntaxRepeat_77) {
                  switch (select_semantics_5F_parser_77 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_237331 = (var_cas_neededCombinaisons.reader_hasKey (var_cas_combinaison)).operator_not () ;
                      if (cond_237331.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_237548 = var_cas_definedCombinaisons.reader_hasKey (var_cas_combinaison) ;
                      if (cond_237548.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_240241 = (var_cas_forgottenAssociations.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_240241.isBuiltAndTrue ()) {
                ...
                const GGS_bool cond_240226 = (var_cas_forgottenCombinaisons.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_240226.isBuiltAndTrue ()) {
                  GGS_string var_cas_s = GGS_string ("") ;
                  {
                    GGS_stringset::cEnumerator enumerator_240053 (var_cas_forgottenCombinaisons, true) ;
                    while (enumerator_240053.hasCurrentObject ()) {
                      var_cas_s.appendCString ("\n"
                        "  - ") ;
                      var_cas_s.dotAssign_operation (enumerator_240053._key (HERE)) ;
                      enumerator_240053.next () ;
                    }
                  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_242012 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432))))).operator_not () ;
      if (cond_242012.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_244944 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_244944 = NULL ;
        while (((operand_244944 = enumerator_244944.nextObject ()))) {
          macroValidPointer (operand_244944) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245121 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245121 = NULL ;
            while (((operand_245121 = enumerator_245121.nextObject ()))) {
              macroValidPointer (operand_245121) ;
              var_cas_methodSignature.addAssign_operation (operand_245121->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_244944->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6523)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245523 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245523 = NULL ;
            while (((operand_245523 = enumerator_245523.nextObject ()))) {
              macroValidPointer (operand_245523) ;
              var_cas_methodSignature.addAssign_operation (operand_245523->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_244944->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6531))).operator_concat (GGS_string ("GetIndex")), operand_244944->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6531)) COMMA_SOURCE_FILE_AT_LINE (6531)) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_245851 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_245851 = NULL ;
        while (((operand_245851 = enumerator_245851.nextObject ()))) {
          macroValidPointer (operand_245851) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246028 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246028 = NULL ;
            while (((operand_246028 = enumerator_246028.nextObject ()))) {
              macroValidPointer (operand_246028) ;
              var_cas_methodSignature.addAssign_operation (operand_246028->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_245851->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6541)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246431 (var_cas_listeTousAttributsSemantiques, true) ;
            ...
            while (((operand_246431 = enumerator_246431.nextObject ()))) {
              ...
              var_cas_methodSignature.addAssign_operation (operand_246431->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_245851->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6549))).operator_concat (GGS_string ("GetIndex")), operand_245851->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6549)) COMMA_SOURCE_FILE_AT_LINE (6549)) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_70) {
          switch (select_semantics_5F_parser_70 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_250545 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_250545 = NULL ;
                while (((operand_250545 = enumerator_250545.nextObject ()))) {
                  macroValidPointer (operand_250545) ;
                  var_cas_methodSignature.addAssign_operation (operand_250545->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_remove) COMMA_HERE) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  automatic_var_250825_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, automatic_var_250825_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251032 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251032 = NULL ;
                while (((operand_251032 = enumerator_251032.nextObject ()))) {
                  macroValidPointer (operand_251032) ;
                  var_cas_methodSignature.addAssign_operation (operand_251032->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251723 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251723 = NULL ;
                while (((operand_251723 = enumerator_251723.nextObject ()))) {
                  macroValidPointer (operand_251723) ;
                  var_cas_methodSignature.addAssign_operation (operand_251723->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_252329 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_252329 = NULL ;
                while (((operand_252329 = enumerator_252329.nextObject ()))) {
                  macroValidPointer (operand_252329) ;
                  var_cas_methodSignature.addAssign_operation (operand_252329->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_252543 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_252543.isBuiltAndTrue ()) {
              ...
              }else if (cond_252543.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_252710 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_252710 = NULL ;
        while (((operand_252710 = enumerator_252710.nextObject ()))) {
          macroValidPointer (operand_252710) ;
          const GGS_bool cond_253142 = operand_252710->mInfo.mHasSetter ;
          if (cond_253142.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_252710->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6728)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_252710->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_253403 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_253403.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_257667 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_257667 = NULL ;
    while (((operand_257667 = enumerator_257667.nextObject ()))) {
      macroValidPointer (operand_257667) ;
      GGS_string var_cas_keyClassMethod = ((operand_257667->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))) ;
      const GGS_bool cond_257964 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6873)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_257964.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_257667->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6876)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_259599 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)))).operator_not () ;
  if (cond_259599.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_263103 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (6972))) ;
  if (cond_263103.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_262145 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_262145 = NULL ;
      while (((operand_262145 = enumerator_262145.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_262145) ;
        GGS_string var_cas_keyClassMethod = ((operand_262145->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))) ;
        var_cas_baseClassName = operand_262145->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6977)) ;
        ...
        const GGS_bool cond_262883 = var_cas_found ;
        if (cond_262883.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_262552 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          if (temp_262552.isBuilt ()) {
            temp_262552 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (6982)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          }
    ...
    const GGS_bool cond_263091 = (var_cas_found).operator_not () ;
    if (cond_263091.isBuiltAndTrue ()) {
  ...
  }else if (cond_263103.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_263180 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_263180 = NULL ;
      while (((operand_263180 = enumerator_263180.nextObject ()))) {
        macroValidPointer (operand_263180) ;
        GGS_string var_cas_keyClassMethod = ((operand_263180->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))) ;
        const GGS_bool cond_263486 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6998)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_263486.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_263180->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7001)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_263639 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7006)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_263639 = NULL ;
    while (((operand_263639 = enumerator_263639.nextObject ()))) {
      macroValidPointer (operand_263639) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7008)), operand_263639->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7009)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7007)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_263639->mAttributeName, operand_263639->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7013)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_266157 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)))).operator_not () ;
  if (cond_266157.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_269104 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_269104 = NULL ;
    while (((operand_269104 = enumerator_269104.nextObject ()))) {
      macroValidPointer (operand_269104) ;
      GGS_string var_cas_keyClassMethod = ((operand_269104->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))) ;
      const GGS_bool cond_269401 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7137)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_269401.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_269104->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7140)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_271520 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)))).operator_not () ;
  if (cond_271520.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_276108 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7256))) ;
  if (cond_276108.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_274807 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_274807 = NULL ;
      while (((operand_274807 = enumerator_274807.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_274807) ;
        GGS_string var_cas_keyClassMethod = ((operand_274807->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))) ;
        var_cas_baseClassName = operand_274807->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7261)) ;
        ...
        const GGS_bool cond_275888 = var_cas_found ;
        if (cond_275888.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_275271 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          if (temp_275271.isBuilt ()) {
    ...
    const GGS_bool cond_276096 = (var_cas_found).operator_not () ;
    if (cond_276096.isBuiltAndTrue ()) {
  ...
  }else if (cond_276108.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_276185 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_276185 = NULL ;
      while (((operand_276185 = enumerator_276185.nextObject ()))) {
        macroValidPointer (operand_276185) ;
        GGS_string var_cas_keyClassMethod = ((operand_276185->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))) ;
        const GGS_bool cond_276491 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7294)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_276491.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_276185->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7297)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276644 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7302)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_276644 = NULL ;
    while (((operand_276644 = enumerator_276644.nextObject ()))) {
      macroValidPointer (operand_276644) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7304)), operand_276644->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7305)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7303)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_276644->mAttributeName, operand_276644->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7309)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_279645 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)))).operator_not () ;
  if (cond_279645.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_282101 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_282101 = NULL ;
    while (((operand_282101 = enumerator_282101.nextObject ()))) {
      macroValidPointer (operand_282101) ;
      GGS_string var_cas_keyClassMethod = ((operand_282101->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))) ;
      const GGS_bool cond_282406 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7436)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_282406.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_282101->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7439)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_284111 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)))).operator_not () ;
  if (cond_284111.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_287853 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7539))) ;
  if (cond_287853.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_286824 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_286824 = NULL ;
      while (((operand_286824 = enumerator_286824.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_286824) ;
        GGS_string var_cas_keyClassMethod = ((operand_286824->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))) ;
        var_cas_baseClassName = operand_286824->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7544)) ;
        ...
        const GGS_bool cond_287629 = var_cas_found ;
        if (cond_287629.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_287237 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          if (temp_287237.isBuilt ()) {
            temp_287237 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7550)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          }
    ...
    const GGS_bool cond_287841 = (var_cas_found).operator_not () ;
    if (cond_287841.isBuiltAndTrue ()) {
  ...
  }else if (cond_287853.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_287930 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_287930 = NULL ;
      while (((operand_287930 = enumerator_287930.nextObject ()))) {
        macroValidPointer (operand_287930) ;
        GGS_string var_cas_keyClassMethod = ((operand_287930->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))) ;
        const GGS_bool cond_288244 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7569)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_288244.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_287930->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7572)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_288397 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7577)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_288397 = NULL ;
    while (((operand_288397 = enumerator_288397.nextObject ()))) {
      macroValidPointer (operand_288397) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7579)), operand_288397->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7580)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7578)) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_288397->mAttributeName, operand_288397->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7584)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_291211 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)))).operator_not () ;
  if (cond_291211.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_292519 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687))))).operator_not () ;
      if (cond_292519.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_293211 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_293211 = NULL ;
        while (((operand_293211 = enumerator_293211.nextObject ()))) {
          macroValidPointer (operand_293211) ;
          var_cas_extractSignature.addAssign_operation (operand_293211->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7709))) ;
          var_cas_inputSignature.addAssign_operation (operand_293211->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7710))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_294658 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742))))).operator_not () ;
      if (cond_294658.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_295350 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_295350 = NULL ;
        while (((operand_295350 = enumerator_295350.nextObject ()))) {
          macroValidPointer (operand_295350) ;
          var_cas_extractSignature.addAssign_operation (operand_295350->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7764))) ;
          var_cas_inputSignature.addAssign_operation (operand_295350->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7765))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_297214 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802))))).operator_not () ;
      if (cond_297214.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_297858 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_297858 = NULL ;
        while (((operand_297858 = enumerator_297858.nextObject ()))) {
          macroValidPointer (operand_297858) ;
          var_cas_extractSignature.addAssign_operation (operand_297858->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7823))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_85 = true ;
        while (syntaxRepeat_85) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_298549 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7839))) ;
            if (cond_298549.isBuiltAndTrue ()) {
            ...
            }else if (cond_298549.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_298661_0 ;
              GGS_bool automatic_var_298661_1 ;
              if (var_cas_tableAttributs.isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_298661_0, automatic_var_298661_1 COMMA_SOURCE_FILE_AT_LINE (7843)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_300176 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883))))).operator_not () ;
      if (cond_300176.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_300820 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_300820 = NULL ;
        while (((operand_300820 = enumerator_300820.nextObject ()))) {
          macroValidPointer (operand_300820) ;
          var_cas_extractSignature.addAssign_operation (operand_300820->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7904))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_89 = true ;
                while (syntaxRepeat_89) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_303258 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7971))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_303258.isBuiltAndTrue ()) {
                      const GGS_bool cond_303208 = (var_cas_hasGetter).operator_not () ;
                      if (cond_303208.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_303258.isBuiltAndFalse ()) {
                      const GGS_bool cond_303460 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7976))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_303460.isBuiltAndTrue ()) {
                        const GGS_bool cond_303412 = var_cas_hasSetter ;
                        if (cond_303412.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_303460.isBuiltAndFalse ()) {
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311007 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_311007 = NULL ;
    while (((operand_311007 = enumerator_311007.nextObject ()))) {
      macroValidPointer (operand_311007) ;
      const GGS_bool cond_311514 = var_cas_inExtensionMap.reader_hasKey (operand_311007->mValue.reader_pathExtension ()) ;
      if (cond_311514.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311007->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_311007->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_311007->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8181)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (8180)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311749 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_311749 = NULL ;
    while (((operand_311749 = enumerator_311749.nextObject ()))) {
      macroValidPointer (operand_311749) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311749->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_311749->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (8195)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_311749->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_313812 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_313812.isBuiltAndTrue ()) {
  ...
  }else if (cond_313812.isBuiltAndFalse ()) {
            ...
            while (syntaxRepeat_93) {
              switch (select_semantics_5F_parser_93 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_316134 = var_cas_parameterIsUsed ;
                  if (cond_316134.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_316134.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_318855 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)))).operator_not () ;
  if (cond_318855.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_318067 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_318067.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8385)) ;
    }else if (cond_318067.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_318357 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_318357.isBuiltAndTrue ()) {
    ...
    }else if (cond_318357.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedList  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedList  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_319914 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)))).operator_not () ;
  if (cond_319914.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_325524 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_325524.isBuiltAndTrue ()) {
              ...
              }else if (cond_325524.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_95 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_329781 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_329781.isBuiltAndTrue ()) {
              ...
              }else if (cond_329781.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_98 = true ;
                while (syntaxRepeat_98) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i79_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_331713 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8772))) ;
  if (cond_331713.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_331713.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i80_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_332546 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8795))) ;
  if (cond_332546.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_332546.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_333516 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8820))) ;
  if (cond_333516.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_333516.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_334501 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8846))) ;
  if (cond_334501.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_334501.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_336047_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_336047_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_338509_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_338509_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_338718 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_338718 = NULL ;
    while (((operand_338718 = enumerator_338718.nextObject ()))) {
      macroValidPointer (operand_338718) ;
      const GGS_bool cond_338937 = (operand_338718->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8959))) ;
      if (cond_338937.isBuiltAndTrue ()) {
        operand_338718->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8961)) ;
      }else if (cond_338937.isBuiltAndFalse ()) {
        const GGS_bool cond_339146 = (operand_338718->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8961))) ;
        if (cond_339146.isBuiltAndTrue ()) {
          operand_338718->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8963)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_340997 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_340997 = NULL ;
    while (((operand_340997 = enumerator_340997.nextObject ()))) {
      macroValidPointer (operand_340997) ;
      const GGS_bool cond_341216 = (operand_340997->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9013))) ;
      if (cond_341216.isBuiltAndTrue ()) {
        operand_340997->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9015)) ;
      }else if (cond_341216.isBuiltAndFalse ()) {
        const GGS_bool cond_341425 = (operand_340997->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9015))) ;
        if (cond_341425.isBuiltAndTrue ()) {
          operand_340997->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9017)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_99 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_enumConstantMap::cEnumerator enumerator_343721 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_343721 = enumerator_343721.nextObject () ;
        if ((operand_343721 != NULL)) {
          bool _foreach_loop_343721 ;
          do{
            macroValidPointer (operand_343721) ;
            var_cas_s.dotAssign_operation (operand_343721->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9084))) ;
            operand_343721 = enumerator_343721.nextObject () ;
            _foreach_loop_343721 = ((operand_343721 != NULL)) ;
            if (_foreach_loop_343721) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_343721) ;
        }
      }
    ...
    while (syntaxRepeat_103) {
      switch (select_semantics_5F_parser_103 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_344541 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_344541 = NULL ;
            while (((operand_344541 = enumerator_344541.nextObject ()))) {
              macroValidPointer (operand_344541) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_344541->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9116)), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (9116)) ;
              GGS_lstring  var_cas_cstString ;
