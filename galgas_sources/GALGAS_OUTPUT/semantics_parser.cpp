...
//                    november 18th, 2006, at 14h54'42"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_import_headers_semantics_and_grammars_semantics_parser_682_45_ (galgas_scanner & _inLexique,
  ...
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), GGS_CharModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (715)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), GGS_StringModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (717)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), GGS_UIntModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (719)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), GGS_SIntModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (721)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), GGS_UInt64Model::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (723)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), GGS_SInt64Model::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (725)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), GGS_BoolModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (727)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), GGS_DoubleModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (729)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), GGS_LCharModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (731)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), GGS_LStringModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (733)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), GGS_LUIntModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (735)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), GGS_LSIntModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (737)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), GGS_LUInt64Model::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (739)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), GGS_LSInt64Model::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (741)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), GGS_LBoolModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (743)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), GGS_LDoubleModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (745)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), GGS_LocationModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (747)) ;
  var_cas_outModelMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), GGS_StringsetModel::constructor_new (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (749)) ;
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            case 1 : {
              ...
              var_cas_ioOptionsComponentsMapForUse.method_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (779)) ;
              } break ;
            case 2 : {
              ...
              while ((operand_28354 != NULL)) {
                ...
                var_cas_grammarAltMap.method_insertKey (_inLexique, operand_28354->mKey, var_cas_formalParametersList, operand_28354->mInfo.mReturnedEntityTypeName SOURCE_FILE_AT_LINE (812)) ;
              ...
              var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_grammarComponentName, var_cas_e SOURCE_FILE_AT_LINE (815)) ;
              ...
              if (((! (var_cas_outImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_componentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (837)) SOURCE_FILE_AT_LINE (837))))).isBuiltAndTrue ()) {
                ...
                while ((operand_30185 != NULL)) {
                  ...
                  if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_30185->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (842)) SOURCE_FILE_AT_LINE (842))))).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, operand_30185->mKey, operand_30185->mInfo.aDefEntite SOURCE_FILE_AT_LINE (843)) ;
                  }
            ...
            case 3 : {
              ...
              while ((operand_35319 != NULL)) {
                ...
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_35319->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (977)) SOURCE_FILE_AT_LINE (977))))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, operand_35319->mKey, operand_35319->mInfo.aDefEntite SOURCE_FILE_AT_LINE (978)) ;
                }
...
pr_semantics_declaration_semantics_parser_1019_29_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1046)) SOURCE_FILE_AT_LINE (1046))).isBuiltAndTrue ()) {
    ...
    var_cas_tableNomRoutinesDeclarees.method_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1057)) ;
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_entite = GGS_typeEntiteRoutine::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
    var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_routineName, var_cas_entite SOURCE_FILE_AT_LINE (1059)) ;
  }
  switch (select_semantics_parser_7 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_tableRoutinesAimplementer.method_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1090)) ;
      } break ;
    default :
      break ;
  }
...
pr_semantics_declaration_semantics_parser_1019_29_importSemantics (galgas_scanner & _inLexique,
  ...
  var_cas_ioExternActionMap.method_insertKey (_inLexique, var_cas_routineName, var_cas_signature, GGS_bool (true, false) SOURCE_FILE_AT_LINE (1117)) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1120)) SOURCE_FILE_AT_LINE (1120))).isBuiltAndTrue ()) {
    ...
    var_cas_tableNomRoutinesDeclarees.method_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1131)) ;
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_entite = GGS_typeEntiteRoutine::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
    var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_routineName, var_cas_entite SOURCE_FILE_AT_LINE (1133)) ;
  }
  switch (select_semantics_parser_7 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
      var_cas_tableRoutinesAimplementer.method_insertKey (_inLexique, var_cas_routineName SOURCE_FILE_AT_LINE (1144)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_routine) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      } break ;
    default :
...
pr_parent_class_semantics_parser_1194_20_ (galgas_scanner & _inLexique,
  ...
  var_cas_tableDesClassesAncetres.method_insertKey (_inLexique, var_cas_outSuperClassName SOURCE_FILE_AT_LINE (1220)) ;
}
...
pr_parent_class_semantics_parser_1194_20_importSemantics (galgas_scanner & _inLexique,
  ...
  var_cas_tableDesClassesAncetres.method_insertKey (_inLexique, var_cas_superClassName SOURCE_FILE_AT_LINE (1251)) ;
...
pr_semantics_declaration_semantics_parser_1278_29_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_9 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_entite SOURCE_FILE_AT_LINE (1411)) ;
  ...
  switch (select_semantics_parser_9 (_inLexique)) {
    case 1 : {
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1446)) SOURCE_FILE_AT_LINE (1446))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1447)) SOURCE_FILE_AT_LINE (1447))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedClassType::constructor_new (_inLexique, var_cas_abstractClassName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1449)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      } break ;
    case 2 : {
          ...
          switch (select_repeat_semantics_parser_10 (_inLexique)) {
            case 2 : {
              ...
              if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1502)) SOURCE_FILE_AT_LINE (1502))))).isBuiltAndTrue ()) {
                var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1503)) ;
              }
              var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1505)) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              } break ;
            case 3 : {
              nt_abstract_method_ (_inLexique, var_cas_estAbstraite, var_cas_listeAttributsSemantiquesCourants, var_cas_listeEntitesAengendrer, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableDesMethodes, var_cas_tableMethodesAimplementer, var_cas_tableEnAvant) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_entite SOURCE_FILE_AT_LINE (1565)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      ...
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1568)) ;
      } break ;
    default :
      break ;
  }
...
pr_abstract_method_semantics_parser_1576_23_ (galgas_scanner & _inLexique,
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_tableDesMethodes.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (1604)) ;
  ...
  var_cas_tableMethodesAimplementer.method_insertAbstract (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions SOURCE_FILE_AT_LINE (1606)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
pr_parse_method_semantics_parser_1612_20_ (galgas_scanner & _inLexique,
  ...
  while ((operand_60855 != NULL)) {
    ...
    var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_60855->mKey, operand_60855->mInfo.mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (1636)) ;
  ...
  var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_me_Constant, var_cas_typeDefinition, var_cas_me_constantCppName SOURCE_FILE_AT_LINE (1649)) ;
  ...
  var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_super_Constant, var_cas_typeDefinition, var_cas_super_constantCppName SOURCE_FILE_AT_LINE (1661)) ;
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  ...
  var_cas_componentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_inCurrentClassName, var_cas_entite SOURCE_FILE_AT_LINE (1676)) ;
...
pr_non_abstract_method_semantics_parser_1696_27_ (galgas_scanner & _inLexique,
  ...
  var_cas_tableDesMethodes.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (1739)) ;
  var_cas_tableMethodesAimplementer.method_insertNotAbstract (_inLexique, var_cas_methodName, var_cas_methodSignature, var_cas_listeTypeEtNomsArguments, var_cas_instructionsList SOURCE_FILE_AT_LINE (1740)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
...
pr_overrided_method_semantics_parser_1753_24_ (galgas_scanner & _inLexique,
  ...
  var_cas_tableMethodesAimplementer.method_insertNotAbstract (_inLexique, var_cas_methodName, var_cas_methodSignature, var_cas_listeTypeEtNomsArguments, var_cas_instructionsList SOURCE_FILE_AT_LINE (1806)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_15 (_inLexique)) {
        case 2 : {
          ...
          switch (select_semantics_parser_16 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1854)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
              var_cas_tableArgumentsMethode.method_insertConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1859)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_17 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1880)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_nomArgument ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, true)) ;
              var_cas_tableArgumentsMethode.method_insertInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1886)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_18 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1907)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, false)) ;
              var_cas_tableArgumentsMethode.method_insertInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1912)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
          var_cas_tableArgumentsMethode.method_insertOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (1932)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2006_45_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_targetVarType, var_cas_targetVarCppName SOURCE_FILE_AT_LINE (2027)) ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2041_45_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVarType ;
  GGS_typeCplusPlusName  var_cas_targetVarCppName ;
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_targetVarType, var_cas_targetVarCppName SOURCE_FILE_AT_LINE (2062)) ;
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_20 (_inLexique)) {
            case 1 : {
              ...
              var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariableDest, var_cas_typeVarDest, var_cas_nomCppDest SOURCE_FILE_AT_LINE (2103)) ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2163_45_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2174)) ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2222_45_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2233)) ;
  GGS_typeListeAttributsSemantiques  var_cas_formalParametersList ;
  if (var_cas_targetVariableType._isBuilt ()) {
...
pr_instruction_beginning_with_identifier_semantics_parser_2281_45_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2292)) ;
  if (var_cas_targetVariableType._isBuilt ()) {
...
pr_instruction_beginning_with_identifier_semantics_parser_2308_45_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2319)) ;
  if (var_cas_targetVariableType._isBuilt ()) {
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_24 (_inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_25 (_inLexique)) {
            ...
            case 3 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2409)) ;
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2425)) ;
          GGS_actualParametersPassingMode var_cas_parameterPassingMode ;
...
pr_semantic_instruction_semantics_parser_2472_28_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioCallInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, var_cas_calledPropertyName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2519)) SOURCE_FILE_AT_LINE (2519))).isBuiltAndTrue ()) {
    ...
    var_cas_ioCallInstructionSharedPropertySignatureMap.method_insertKey (_inLexique, var_cas_calledPropertyName, var_cas_parameterList, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2536)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_2776_28_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (2794)) ;
...
pr_semantic_instruction_semantics_parser_2815_28_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.method_searchForReadOnlyAccess (_inLexique, var_cas_galgasVariableName, automatic_var_19, var_cas_nomCppVar SOURCE_FILE_AT_LINE (2830)) ;
        GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_2845_28_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.method_searchForDestructiveReadAccess (_inLexique, var_cas_nom, automatic_var_20, var_cas_nomCppVar SOURCE_FILE_AT_LINE (2860)) ;
        GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_2961_28_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_31 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_variableType ;
      GGS_typeCplusPlusName  var_cas_cppVariableName ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_modifiedObjectName, var_cas_variableType, var_cas_cppVariableName SOURCE_FILE_AT_LINE (3001)) ;
      GGS_lstring  var_cas_methodName ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      var_cas_methodName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariable, automatic_var_21, var_cas_varCppName SOURCE_FILE_AT_LINE (3152)) ;
...
pr_semantic_instruction_semantics_parser_3556_28_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.method_insertUsedConstInArgumentNoShadow (_inLexique, var_cas_enumeratedVariableName, var_cas_enumeratedVariableType, var_cas_enumeratedVariableCPPName SOURCE_FILE_AT_LINE (3584)) ;
...
pr_optional_assignment_semantics_parser_3931_27_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, automatic_var_24, automatic_var_25 SOURCE_FILE_AT_LINE (3943)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
...
pr_optional_assignment_semantics_parser_3963_27_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, automatic_var_26, automatic_var_27 SOURCE_FILE_AT_LINE (3974)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  ...
  switch (select_semantics_parser_43 (_inLexique)) {
    case 1 : {
      ...
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4016)) SOURCE_FILE_AT_LINE (4016))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4017)) SOURCE_FILE_AT_LINE (4017))))))).isBuiltAndTrue ()) {
        ...
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4019)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_44 (_inLexique)) {
            ...
            case 4 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4081)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_insertOrSearchMethodList::element_type * operand_157569 = var_cas_insertMethodList.firstObject () ;
      while ((operand_157569 != NULL)) {
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_157765 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_157765 != NULL)) {
          macroValidPointer (operand_157765) ;
          var_cas_methodSignature._addAssign_operation (operand_157765->mAttributType, var_cas_inPassingMode) ;
          operand_157765 = operand_157765->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_157569->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4110)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_158194 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_158194 != NULL)) {
          macroValidPointer (operand_158194) ;
          var_cas_methodSignature._addAssign_operation (operand_158194->mAttributType, var_cas_inPassingMode) ;
          operand_158194 = operand_158194->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_157569->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4118))) + (GGS_string (true, "GetIndex"))), operand_157569->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4118)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4119)) ;
        operand_157569 = operand_157569->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_158542 = var_cas_searchMethodList.firstObject () ;
      while ((operand_158542 != NULL)) {
        macroValidPointer (operand_158542) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_158736 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_158736 != NULL)) {
          macroValidPointer (operand_158736) ;
          var_cas_methodSignature._addAssign_operation (operand_158736->mAttributType, var_cas_outPassingMode) ;
          operand_158736 = operand_158736->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_158542->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4128)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_159163 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_159163 != NULL)) {
          macroValidPointer (operand_159163) ;
          var_cas_methodSignature._addAssign_operation (operand_159163->mAttributType, var_cas_outPassingMode) ;
          operand_159163 = operand_159163->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_158542->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4136))) + (GGS_string (true, "GetIndex"))), operand_158542->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4136)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4137)) ;
        operand_158542 = operand_158542->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4148)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
    ...
    case 3 : {
          ...
          switch (select_repeat_semantics_parser_45 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4193)) ;
              }
              ...
              switch (select_semantics_parser_46 (_inLexique)) {
                ...
                case 2 : {
                  ...
                  if (var_cas_shadowErrorMessageString._isBuilt ()) {
                    ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_shadowErrorMessageString SOURCE_FILE_AT_LINE (4201)) ;
                  }
                  var_cas_shadowErrorMessage = var_cas_shadowErrorMessageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (4202)) ;
                  } break ;
                default :
                  break ;
              }
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_162692 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_162692 != NULL)) {
                macroValidPointer (operand_162692) ;
                var_cas_methodSignature._addAssign_operation (operand_162692->mAttributType, var_cas_inPassingMode) ;
                operand_162692 = operand_162692->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4211)) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4212)), GGS_bool (true, false), var_cas_shadowErrorMessage) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4214))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_163295 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_163295 != NULL)) {
                  macroValidPointer (operand_163295) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_163295->mAttributType, var_cas_inPassingMode) ;
                  operand_163295 = operand_163295->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4221)) ;
                var_cas_insertMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4222)), GGS_bool (true, true), var_cas_shadowErrorMessage) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              ...
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_K_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4230)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_164083 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_164083 != NULL)) {
                macroValidPointer (operand_164083) ;
                var_cas_methodSignature._addAssign_operation (operand_164083->mAttributType, var_cas_outPassingMode) ;
                operand_164083 = operand_164083->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4238)) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4239)), GGS_bool (true, false), GGS_string (true, "")) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4241))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_164701 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_164701 != NULL)) {
                  macroValidPointer (operand_164701) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_164701->mAttributType, var_cas_outPassingMode) ;
                  operand_164701 = operand_164701->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4248)) ;
                var_cas_searchMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4249)), GGS_bool (true, true), GGS_string (true, "")) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4261)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
pr_semantics_declaration_semantics_parser_4003_29_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_43 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4284)) SOURCE_FILE_AT_LINE (4284))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4284)) SOURCE_FILE_AT_LINE (4284))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4286)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_44 (_inLexique)) {
            case 2 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4305)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4312)), GGS_bool (true, true), GGS_string (true, "")) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4347)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_169587 = var_cas_insertMethodList.firstObject () ;
      while ((operand_169587 != NULL)) {
        macroValidPointer (operand_169587) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_169783 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_169783 != NULL)) {
          macroValidPointer (operand_169783) ;
          var_cas_methodSignature._addAssign_operation (operand_169783->mAttributType, var_cas_inPassingMode) ;
          operand_169783 = operand_169783->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_169587->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4376)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_170212 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_170212 != NULL)) {
          macroValidPointer (operand_170212) ;
          var_cas_methodSignature._addAssign_operation (operand_170212->mAttributType, var_cas_inPassingMode) ;
          operand_170212 = operand_170212->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_169587->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4384))) + (GGS_string (true, "GetIndex"))), operand_169587->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4384)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4385)) ;
        operand_169587 = operand_169587->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_170560 = var_cas_searchMethodList.firstObject () ;
      while ((operand_170560 != NULL)) {
        macroValidPointer (operand_170560) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_170756 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_170756 != NULL)) {
          macroValidPointer (operand_170756) ;
          var_cas_methodSignature._addAssign_operation (operand_170756->mAttributType, var_cas_outPassingMode) ;
          operand_170756 = operand_170756->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_170560->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4394)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_171186 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_171186 != NULL)) {
          macroValidPointer (operand_171186) ;
          var_cas_methodSignature._addAssign_operation (operand_171186->mAttributType, var_cas_outPassingMode) ;
          operand_171186 = operand_171186->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_170560->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4402))) + (GGS_string (true, "GetIndex"))), operand_170560->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4402)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4403)) ;
        operand_170560 = operand_170560->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4414)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4416)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_45 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_173585 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_173585 != NULL)) {
                macroValidPointer (operand_173585) ;
                var_cas_methodSignature._addAssign_operation (operand_173585->mAttributType, var_cas_inPassingMode) ;
                operand_173585 = operand_173585->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4463))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_174128 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_174128 != NULL)) {
                  macroValidPointer (operand_174128) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_174128->mAttributType, var_cas_inPassingMode) ;
                  operand_174128 = operand_174128->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4470)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_174728 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_174728 != NULL)) {
                macroValidPointer (operand_174728) ;
                var_cas_methodSignature._addAssign_operation (operand_174728->mAttributType, var_cas_outPassingMode) ;
                operand_174728 = operand_174728->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4484)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4486))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_175312 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_175312 != NULL)) {
                  macroValidPointer (operand_175312) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_175312->mAttributType, var_cas_outPassingMode) ;
                  operand_175312 = operand_175312->nextObject () ;
                }
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4505)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4507)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    default :
      break ;
...
void semantics_parser::
semantics_parser::
pr_ex_map_method_semantics_parser_4514_21_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomMethode,
...
void semantics_parser::
pr_ex_map_method_semantics_parser_4514_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_error) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void semantics_parser::
semantics_parser::
pr_map_method_semantics_parser_4526_18_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_methodName,
                                GGS_lstring  &var_cas_getIndexMethodName,
                                GGS_lstring  &var_cas_outMessage) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_map_method_semantics_parser_4526_18_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_47 (_inLexique)) {
    case 1 : {
      } break ;
...
void semantics_parser::
semantics_parser::
pr_message_pattern_semantics_parser_4545_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        switch (select_semantics_parser_49 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
            var_cas_messageText.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
            if (((var_cas_messageText.reader_string (_inLexique SOURCE_FILE_AT_LINE (4553))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_outMessageList._addAssign_operation (var_cas_messageText.reader_string (_inLexique SOURCE_FILE_AT_LINE (4554))) ;
            }
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2A) ;
...
void semantics_parser::
pr_message_pattern_semantics_parser_4545_23_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_semantics_parser_49 (_inLexique)) {
          case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4571_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4584)) SOURCE_FILE_AT_LINE (4584))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4584)) SOURCE_FILE_AT_LINE (4584))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4586)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_typeListeAttributsSemantiques::element_type * operand_179135 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_179135 != NULL)) {
        macroValidPointer (operand_179135) ;
        var_cas_extractSignature._addAssign_operation (operand_179135->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_179135->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_179135 = operand_179135->nextObject () ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4619)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4571_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4636)) SOURCE_FILE_AT_LINE (4636))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4636)) SOURCE_FILE_AT_LINE (4636))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4638)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_L_EXsignature  var_cas_inputSignature ;
      var_cas_inputSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_181374 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_181374 != NULL)) {
        macroValidPointer (operand_181374) ;
        var_cas_extractSignature._addAssign_operation (operand_181374->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_181374->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_181374 = operand_181374->nextObject () ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4671)) ;
      GGS_TypeModel  var_cas_t ;
      var_cas_t = GGS_ListModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4673)) ;
      } break ;
    default :
      break ;
  }
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4571_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_50 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_attributes_definition_list_semantics_parser_4683_34_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_51 (_inLexique)) {
        case 2 : {
          ...
          var_cas_tableAttributs.method_insertKey (_inLexique, var_cas_attributeName, var_cas_definitionType SOURCE_FILE_AT_LINE (4707)) ;
...
void semantics_parser::
pr_attributes_definition_list_semantics_parser_4683_34_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_51 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4721_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_52 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_constructorsMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (4770)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_method) ;
          GGS_lstring  var_cas_methodName ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4790)) ;
          } break ;
        case 4 : {
          ...
          switch (select_semantics_parser_54 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signatureForGrammarComponent ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
              var_cas_modifiersMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4810)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              ...
              if ((var_cas_acceptAddAssignOperatorCall).isBuiltAndTrue ()) {
                var_cas_errorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (4831)) ;
              }else{
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (4849)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4721_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_52 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_EXconstructorsMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (4905)) ;
          var_cas_constructorMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_formalInputArgumentList SOURCE_FILE_AT_LINE (4906)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_method) ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.method_insertKey (_inLexique, var_cas_readerName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4926)) ;
          var_cas_readerMap.method_insertKey (_inLexique, var_cas_readerName, var_cas_signature SOURCE_FILE_AT_LINE (4927)) ;
          } break ;
        case 4 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_modifier) ;
          switch (select_semantics_parser_54 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signature ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
              var_cas_EXmodifiersMap.method_insertKey (_inLexique, var_cas_modifierName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4947)) ;
              var_cas_modifierMap.method_insertKey (_inLexique, var_cas_modifierName, var_cas_signature SOURCE_FILE_AT_LINE (4948)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              if (((var_cas_addAssignFormalInputArgumentList.reader_length (_inLexique SOURCE_FILE_AT_LINE (4951))) > (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (4953)) ;
              }else{
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true, true) ;
              }
              { bool syntaxRepeat = true ;
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (4984)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_t SOURCE_FILE_AT_LINE (4986)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4721_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extern) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
pr_formal_argument_type_semantics_parser_4994_28_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5001)) SOURCE_FILE_AT_LINE (5001))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5003)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        ...
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5004)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5006)) ;
    }
  }
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5016_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5024)) SOURCE_FILE_AT_LINE (5024))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5026)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5027)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5029)) ;
    }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5016_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5016_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5041_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5049)) SOURCE_FILE_AT_LINE (5049))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5051)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5052)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5054)) ;
    }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5041_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5041_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5066_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5075)) SOURCE_FILE_AT_LINE (5075))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5066_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5066_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5097_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (5121)) ;
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5097_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
                                GGS_ActionMap  &var_cas_ioExternActionMap,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  var_cas_entite = GGS_typeEntiteActionExterne::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_actionName, var_cas_entite SOURCE_FILE_AT_LINE (5149)) ;
  var_cas_ioExternActionMap.method_insertKey (_inLexique, var_cas_actionName, var_cas_signature, GGS_bool (true, true) SOURCE_FILE_AT_LINE (5150)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5097_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_action) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
...
pr_semantics_declaration_semantics_parser_5160_29_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5180)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_cstMessageStringMap.method_insertKey (_inLexique, var_cas_cstName, var_cas_cstString SOURCE_FILE_AT_LINE (5200)) ;
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          ...
          GGS_enumConstantMap::element_type * operand_201880 = var_cas_constantMap.firstObject () ;
          while ((operand_201880 != NULL)) {
            macroValidPointer (operand_201880) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_201880->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (5208)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            if (var_cas_cstMessageStringMap._isBuilt ()) {
              var_cas_cstMessageStringMap (HERE)->method_searchKey (_inLexique, var_cas_name, var_cas_cstString SOURCE_FILE_AT_LINE (5210)) ;
            }
            var_cas_messageStringList._addAssign_operation (var_cas_cstString) ;
            operand_201880 = operand_201880->nextObject () ;
          }
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5214)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_ee SOURCE_FILE_AT_LINE (5226)) ;
}
...
pr_semantics_declaration_semantics_parser_5160_29_importSemantics (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5245)) ;
      switch (select_repeat_semantics_parser_56 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2C) ;
          } break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_57 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_messageName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (5260)) ;
          GGS_L_lstringList  var_cas_messageStringList ;
          var_cas_messageStringList = GGS_L_lstringList::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_exEnumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5262)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_e SOURCE_FILE_AT_LINE (5279)) ;
  GGS_TypeModel  var_cas_type ;
  var_cas_type = GGS_EnumModel::constructor_new (_inLexique, var_cas_constantMap, var_cas_enumMessageMap COMMA_HERE) ;
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_type SOURCE_FILE_AT_LINE (5281)) ;
}
