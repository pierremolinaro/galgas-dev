...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/Developpements/mes_prgms/galgas/galgas_sources/semantics_parser.ggs" ;
          ...
          switch (select_semantics_parser_2 (lexique_var_)) {
            ...
            case 4 : {
              ...
              if (((! (var_cas_outIncludedMetamodelComponents.reader_hasKey (var_cas_metamodelComponentName.reader_value ())))).isBuiltAndTrue ()) {
                ...
                var_cas_ioMetamodelComponentMap.methode_searchKey (lexique_var_, var_cas_metamodelComponentName, var_cas_30904, var_cas_importedEntities SOURCE_FILE_AT_LINE (882)) ;
                GGS_M_semanticsEntitiesForUse::element_type * operand_30958 = var_cas_importedEntities.firstObject () ;
                while ((operand_30958 != NULL)) {
                  macroValidPointer (operand_30958) ;
                  if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (operand_30958->mKey.reader_value ())))).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, operand_30958->mKey, operand_30958->mInfo.aDefEntite SOURCE_FILE_AT_LINE (885)) ;
                  }
                  operand_30958 = operand_30958->nextObject () ;
                }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (lexique_var_)) {
            ...
            case 3 : {
              ...
              GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
              GGS_ModelMap  var_cas_33325 ;
              GGS_ActionMap  var_cas_33328 ;
              GGS_stringset  var_cas_33331 ;
              GGS_stringset  var_cas_33334 ;
              GGS_stringset  var_cas_33337 ;
              GGS_M_optionComponents  var_cas_33340 ;
              var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_componentName, var_cas_33325, var_cas_33328, var_cas_33331, var_cas_33334, var_cas_33337, var_cas_33340, var_cas_importedEntities SOURCE_FILE_AT_LINE (954)) ;
              GGS_M_semanticsEntitiesForUse::element_type * operand_33392 = var_cas_importedEntities.firstObject () ;
              while ((operand_33392 != NULL)) {
                macroValidPointer (operand_33392) ;
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (operand_33392->mKey.reader_value ())))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, operand_33392->mKey, operand_33392->mInfo.aDefEntite SOURCE_FILE_AT_LINE (957)) ;
                }
                operand_33392 = operand_33392->nextObject () ;
              }
            ...
            case 4 : {
              ...
              GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
              GGS_lstring  var_cas_34469 ;
              var_cas_ioMetamodelComponentMap.methode_searchKey (lexique_var_, var_cas_metamodelComponentName, var_cas_34469, var_cas_importedEntities SOURCE_FILE_AT_LINE (986)) ;
              GGS_M_semanticsEntitiesForUse::element_type * operand_34521 = var_cas_importedEntities.firstObject () ;
              while ((operand_34521 != NULL)) {
                macroValidPointer (operand_34521) ;
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (operand_34521->mKey.reader_value ())))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, operand_34521->mKey, operand_34521->mInfo.aDefEntite SOURCE_FILE_AT_LINE (989)) ;
                }
                operand_34521 = operand_34521->nextObject () ;
              }
              } break ;
            default :
              break ;
...
pr_parent_class_semantics_parser_1179_20_importSemantics (galgas_scanner & lexique_var_,
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_ClassModel * operand_45194 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_45194) ; 
      var_cas_outSuperClasses = operand_45194->mSuperClasses ;
      var_cas_outAttributeList = operand_45194->mAttributeList ;
      var_cas_outMessageMap = operand_45194->mMessageMap ;
    }else{ // Else part
...
pr_semantics_declaration_semantics_parser_1263_29_ (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_8 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_50191 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_50191 != NULL)) {
        macroValidPointer (operand_50191) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_50191->mKey.reader_value ())))).isBuiltAndTrue ()) {
            GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_50191->mKey.reader_value ()))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1376)) ;
        }
        operand_50191 = operand_50191->nextObject () ;
      }
...
pr_semantics_declaration_semantics_parser_1263_29_importSemantics (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_8 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_56144 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_56144 != NULL)) {
        macroValidPointer (operand_56144) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_56144->mKey.reader_value ())))).isBuiltAndTrue ()) {
            GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_56144->mKey.reader_value ()))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1526)) ;
        }
        operand_56144 = operand_56144->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasClassType::constructor_new (var_cas_abstractClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
...
pr_semantics_declaration_semantics_parser_1552_29_ (galgas_scanner & lexique_var_,
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_62037 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_62037 != NULL)) {
    macroValidPointer (operand_62037) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_62037->mKey.reader_value ())))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_62037->mKey.reader_value ()))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1665)) ;
    }
    operand_62037 = operand_62037->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_1552_29_importSemantics (galgas_scanner & lexique_var_,
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_68796 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_68796 != NULL)) {
    macroValidPointer (operand_68796) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_68796->mKey.reader_value ())))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_68796->mKey.reader_value ()))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1825)) ;
    }
    operand_68796 = operand_68796->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  var_cas_c = GGS_typeGalgasClassType::constructor_new (var_cas_concreteClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
  var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
...
pr_parse_method_semantics_parser_1880_20_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_73599 = var_cas_listeAttributsSemantiquesCourants.firstObject () ;
  while ((operand_73599 != NULL)) {
    macroValidPointer (operand_73599) ;
    GGS_typeCplusPlusName  var_cas_nomCpp ;
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (operand_73599->aNomAttribut COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_73599->aNomAttribut, operand_73599->mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (1941)) ;
    operand_73599 = operand_73599->nextObject () ;
  }
...
pr_input_parameters_list_semantics_parser_2271_29_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length ()) < (var_cas_listeCibles.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_87695 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_87781 = var_cas_listeCibles.firstObject () ;
    while ((operand_87695 != NULL)
        && (operand_87781 != NULL)) {
      macroValidPointer (operand_87695) ;
      macroValidPointer (operand_87781) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_87695->aNomAttribut ;
      if (operand_87781->aCible.isBuilt ()) {
        operand_87781->aCible (HERE)->methode_verifierType (lexique_var_, operand_87695->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList) ;
      }
      operand_87695 = operand_87695->nextObject () ;
      operand_87781 = operand_87781->nextObject () ;
    }
  }
...
pr_instruction_beginning_with_identifier_semantics_parser_2352_45_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_formalParametersList.reader_length ()) != (var_cas_typeList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_91041 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_91115 = var_cas_typeList.firstObject () ;
    while ((operand_91041 != NULL)
        && (operand_91115 != NULL)) {
      macroValidPointer (operand_91041) ;
      macroValidPointer (operand_91115) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_91041->mAttributType,  operand_91115->mType,  operand_91115->mEndOfExpressionLocation SOURCE_FILE_AT_LINE (2392)) ;
      operand_91041 = operand_91041->nextObject () ;
      operand_91115 = operand_91115->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_drop_instruction_semantics_parser_2848_24_ (galgas_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_galgasType  var_cas_109250 ;
        var_cas_ioVariablesMap.methode_searchForDestructiveReadAccess (lexique_var_, var_cas_nom, var_cas_109250, var_cas_nomCppVar SOURCE_FILE_AT_LINE (2858)) ;
        GGS_typeInstruction  var_cas_instruction ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            var_cas_nomVariable.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
            GGS_AC_galgasType  var_cas_120267 ;
            GGS_typeCplusPlusName  var_cas_120270 ;
            var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_nomVariable, var_cas_120267, var_cas_120270 SOURCE_FILE_AT_LINE (3136)) ;
...
pr_semantic_instruction_semantics_parser_3150_28_ (galgas_scanner & lexique_var_,
  ...
  { cPtr_typeGalgas_string * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_string *> (var_cas_messageExpressionType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_messageExpressionType.getPtr () != NULL) {
        ...
        GGS_location (lexique_var_).signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (3169)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  GGS_typeInstruction  var_cas_instruction ;
  var_cas_instruction = GGS_typeMessageInstruction::constructor_new (var_cas_messageExpression COMMA_HERE) ;
  var_cas_ioInstructionsList.addAssign_operation (var_cas_instruction) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3182_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (3191)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (3193)) ;
        ...
        { cPtr_typeGalgas_bool * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_bool *> (var_cas_resultType.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            if (var_cas_resultType.getPtr () != NULL) {
              ...
              GGS_location (lexique_var_).signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (3203)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
          }
        ...
        var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (3193)) ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (3219)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (3219)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_if) ;
  var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (3191)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3182_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_if) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_expression_parse (lexique_var_) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3248_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  { cPtr_typeGalgas_lstring * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_typeNomFichierSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_typeNomFichierSource.getPtr () != NULL) {
        ...
        var_cas_nomFichierSource.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (3273)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (3286)) ;
  ...
  { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_e.getPtr () != NULL) {
        ...
        message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
        var_cas_grammarName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (3288)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  var_cas_startSymbolAltMap.methode_searchKey (lexique_var_, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (3291)) ;
  ::routine_verifierCompatibiliteArgEffectifsSignature (lexique_var_,  var_cas_startSymbolSignature,  var_cas_listeTypesParametresEffectifs,  GGS_location (lexique_var_),  var_cas_ioInstructionsList,  var_cas_expressionsList SOURCE_FILE_AT_LINE (3293)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3248_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_30 (lexique_var_)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3316_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_typeInstruction  var_cas_instruction ;
  var_cas_ioVariablesMap.prologue_repeatBlock (lexique_var_ SOURCE_FILE_AT_LINE (3325)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (lexique_var_ SOURCE_FILE_AT_LINE (3326)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (3326)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (lexique_var_ SOURCE_FILE_AT_LINE (3325)) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3316_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_foreach) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_read_access_parse (lexique_var_) ;
...
void semantics_parser::
semantics_parser::
pr_parse_match_operand_semantics_parser_3404_27_ (galgas_scanner & lexique_var_,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_typeGalgasClassType * operand_130271 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_130271) ; 
      var_cas_outBaseTypeName = operand_130271->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_130474 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_130474) ; 
      var_cas_outBaseTypeName = operand_130474->mEnumTypeName ;
      var_cas_outIsEnumeration = GGS_bool (true, true) ;
      var_cas_outEnumMessageMap = operand_130474->mEnumConstantesMap ;
    }else{ // Else part
      GGS_string var_cas_actualTypeName ;
      if (var_cas_type.isBuilt ()) {
        var_cas_type (HERE)->methode_getTypeName (lexique_var_, var_cas_actualTypeName) ;
      }
        var_cas_variableName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the type of this variable is '@")) + (var_cas_actualTypeName))) + (GGS_string (true, "' ; I was expected an enumeration type or an abstract type"))) SOURCE_FILE_AT_LINE (3434)) ;
    }
  }
}
...
void semantics_parser::
pr_parse_match_operand_semantics_parser_3404_27_parse (galgas_scanner & lexique_var_) {
  nt_read_access_parse (lexique_var_) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_3442_24_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_galgasType  var_cas_definitionClasse1 ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (3456)) ;
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      var_cas_definitionClasse1.drop_operation () ;
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (3457)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_definitionClasse1 = ptrExtraire_->aDefType ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_definitionClasse1.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgasClassType::static_string_message_messageGalgasType () ;
        message2_ << var_cas_definitionClasse1 (HERE)->message_messageGalgasType () ;
        var_cas_outTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (3470)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_listeAttributs1 = ptrExtraire_->mNonExternAttributesList ;
  ...
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
      var_cas_outTypeName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class is not allowed here") SOURCE_FILE_AT_LINE (3473)) ;
  }
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
      var_cas_outTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "a constant of '@")) + (var_cas_inTypeName.reader_value ()))) + (GGS_string (true, "' enumeration type is expected here"))) SOURCE_FILE_AT_LINE (3477)) ;
  }else if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (var_cas_inTypeName.reader_value ())))).isBuiltAndTrue ()) {
      var_cas_outTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "This type does not inherit from '")) + (var_cas_inTypeName.reader_value ()))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3479)) ;
  }
...
void semantics_parser::
pr_parse_match_case_semantics_parser_3442_24_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  nt_parse_effective_input_parameters_list_parse (lexique_var_) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_3492_24_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_lstring  var_cas_inTypeName,
                                GGS_location  /* var_cas_inVarLocation */,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    var_cas_inEnumMessageMap.methode_searchKey (lexique_var_, var_cas_outEnumConstantName SOURCE_FILE_AT_LINE (3505)) ;
  }else{
      var_cas_outEnumConstantName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "a class that inherit from '@")) + (var_cas_inTypeName.reader_value ()))) + (GGS_string (true, "' abstract class is expected here"))) SOURCE_FILE_AT_LINE (3507)) ;
  }
}
...
void semantics_parser::
pr_parse_match_case_semantics_parser_3492_24_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3513_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (3553)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_33 (lexique_var_)) {
        case 2 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_when) ;
          var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (3557)) ;
          ...
          var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (3557)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (3596)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_else) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (3596)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (3553)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_match) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3513_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_match) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instructions_list_no_verif_semantics_parser_3627_43_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instructions_list_no_verif_semantics_parser_3627_43_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_34 (lexique_var_)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_3650_27_ (galgas_scanner & /* lexique_var_ */,
...
void semantics_parser::
pr_optional_assignment_semantics_parser_3650_27_parse (galgas_scanner & /* lexique_var_ */) {
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_3666_27_ (galgas_scanner & lexique_var_,
                                const GGS_lstring  &/* var_cas_inTypeName */,
                                ...
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  GGS_AC_galgasType  var_cas_139268 ;
  GGS_typeCplusPlusName  var_cas_139271 ;
  var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_inTargetVarName, var_cas_139268, var_cas_139271 SOURCE_FILE_AT_LINE (3678)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
  ::routine_checkAssignmentTypesCompatibility (lexique_var_,  var_cas_inVariableType,  var_cas_sourceType,  GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (3690)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_optional_assignment_semantics_parser_3666_27_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  nt_expression_parse (lexique_var_) ;
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_3698_27_ (galgas_scanner & lexique_var_,
                                const GGS_lstring  &var_cas_inTypeName,
                                const GGS_lstring  &var_cas_inTargetVarName,
                                const GGS_typeCplusPlusName  &var_cas_inTargetVariableCppName,
                                const GGS_AC_galgasType  &var_cas_inVariableType,
                                ...
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  GGS_AC_galgasType  var_cas_140381 ;
  GGS_typeCplusPlusName  var_cas_140384 ;
  var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_inTargetVarName, var_cas_140381, var_cas_140384 SOURCE_FILE_AT_LINE (3709)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
...
void semantics_parser::
pr_optional_assignment_semantics_parser_3698_27_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
semantics_parser::
pr_parse_states_semantics_parser_3738_20_ (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_35 (lexique_var_)) {
    case 1 : {
      ...
      var_cas_ioStateValues.methode_searchKey (lexique_var_, var_cas_firstStateName SOURCE_FILE_AT_LINE (3749)) ;
    ...
    case 2 : {
      ...
      if (((var_cas_ioStateValues.reader_count ()) != (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
          GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "since you have declared states, you must define a first state") SOURCE_FILE_AT_LINE (3754)) ;
      }
      } break ;
    default :
      break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_36 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_outTransitionStatusMap.methode_insertKey (lexique_var_, var_cas_transitionName, var_cas_status, var_cas_messageList SOURCE_FILE_AT_LINE (3778)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_38 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_ioStateValues.methode_searchKey (lexique_var_, var_cas_lastStateName SOURCE_FILE_AT_LINE (3787)) ;
          GGS_lastStateEnum var_cas_status ;
          GGS_L_stringList  var_cas_messageList ;
...
void semantics_parser::
pr_parse_states_semantics_parser_3738_20_parse (galgas_scanner & lexique_var_) {
  switch (select_semantics_parser_35 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_firststate) ;
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_3812_29_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_40 (lexique_var_)) {
    case 1 : {
      ...
      if (((! (((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_value ())) || (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_value ())))))).isBuiltAndTrue ()) {
        ...
        var_cas_tableEnAvant.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (3828)) ;
      }
      } break ;
    case 2 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_41 (lexique_var_)) {
            ...
            case 4 : {
              ...
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.methode_insertKey (lexique_var_, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (3895)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_insertOrSearchMethodList::element_type * operand_147918 = var_cas_insertMethodList.firstObject () ;
      while ((operand_147918 != NULL)) {
        macroValidPointer (operand_147918) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_148112 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_148112 != NULL)) {
          macroValidPointer (operand_148112) ;
          var_cas_methodSignature.addAssign_operation (operand_148112->mAttributType, var_cas_inPassingMode) ;
          operand_148112 = operand_148112->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_147918->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3924)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_148531 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_148531 != NULL)) {
          macroValidPointer (operand_148531) ;
          var_cas_methodSignature.addAssign_operation (operand_148531->mAttributType, var_cas_inPassingMode) ;
          operand_148531 = operand_148531->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_147918->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_147918->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3933)) ;
        operand_147918 = operand_147918->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_148872 = var_cas_searchMethodList.firstObject () ;
      while ((operand_148872 != NULL)) {
        macroValidPointer (operand_148872) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        ...
        while ((operand_149064 != NULL)) {
          ...
          var_cas_methodSignature.addAssign_operation (operand_149064->mAttributType, var_cas_outPassingMode) ;
          operand_149064 = operand_149064->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_148872->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3942)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_149481 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_149481 != NULL)) {
          macroValidPointer (operand_149481) ;
          var_cas_methodSignature.addAssign_operation (operand_149481->mAttributType, var_cas_outPassingMode) ;
          operand_149481 = operand_149481->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_148872->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_148872->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3951)) ;
        operand_148872 = operand_148872->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (3959)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
    ...
    case 3 : {
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_stateValues.methode_insertKey (lexique_var_, var_cas_idf SOURCE_FILE_AT_LINE (3994)) ;
          ...
          switch (select_repeat_semantics_parser_44 (lexique_var_)) {
            case 2 : {
              ...
              if (var_cas_errorMessage.isBuilt ()) {
                ::routine_check_KL_escapeCharacters (lexique_var_,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4017)) ;
              }
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_153150 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_153150 != NULL)) {
                macroValidPointer (operand_153150) ;
                var_cas_methodSignature.addAssign_operation (operand_153150->mAttributType, var_cas_inPassingMode) ;
                operand_153150 = operand_153150->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4029)) ;
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_153778 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_153778 != NULL)) {
                  macroValidPointer (operand_153778) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_153778->mAttributType, var_cas_inPassingMode) ;
                  operand_153778 = operand_153778->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4039)) ;
            ...
            case 3 : {
              ...
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage.isBuilt ()) {
                ::routine_check_K_escapeCharacters (lexique_var_,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4048)) ;
              }
              GGS_string var_cas_firstStateName ;
              GGS_lastStateList  var_cas_emptyLastStateList ;
              GGS_transitionStatusMap  var_cas_transitionStatusMap ;
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_154816 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_154816 != NULL)) {
                macroValidPointer (operand_154816) ;
                var_cas_methodSignature.addAssign_operation (operand_154816->mAttributType, var_cas_outPassingMode) ;
                operand_154816 = operand_154816->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4060)) ;
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_155477 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_155477 != NULL)) {
                  macroValidPointer (operand_155477) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_155477->mAttributType, var_cas_outPassingMode) ;
                  operand_155477 = operand_155477->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4070)) ;
      ...
      if (((var_cas_stateValues.reader_count ()) > (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
        GGS_insertOrSearchMethodList::element_type * operand_156007 = var_cas_insertMethodList.firstObject () ;
        while ((operand_156007 != NULL)) {
          macroValidPointer (operand_156007) ;
          GGS_insertOrSearchMethodList::element_type * operand_156129 = var_cas_insertMethodList.firstObject () ;
          while ((operand_156129 != NULL)) {
            macroValidPointer (operand_156129) ;
            if (((! (operand_156007->mTransitionStatusMap.reader_hasKey (operand_156129->mMethodName.reader_value ())))).isBuiltAndTrue ()) {
                operand_156007->mMethodName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "This insert method does not define the '")) + (operand_156129->mMethodName.reader_value ()))) + (GGS_string (true, "' transition"))) SOURCE_FILE_AT_LINE (4079)) ;
            }
            operand_156129 = operand_156129->nextObject () ;
          }
          operand_156007 = operand_156007->nextObject () ;
        }
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapMethodMap COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4090)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_3812_29_importSemantics (galgas_scanner & lexique_var_,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_40 (lexique_var_)) {
    case 1 : {
      ...
      if (((! (((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_value ())) || (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_value ())))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4116)) ;
      }
      } break ;
    case 2 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_41 (lexique_var_)) {
            ...
            case 4 : {
              ...
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.methode_insertKey (lexique_var_, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4183)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_161471 = var_cas_insertMethodList.firstObject () ;
      while ((operand_161471 != NULL)) {
        macroValidPointer (operand_161471) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        ...
        while ((operand_161665 != NULL)) {
          ...
          var_cas_methodSignature.addAssign_operation (operand_161665->mAttributType, var_cas_inPassingMode) ;
          operand_161665 = operand_161665->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_161471->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4212)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_162084 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_162084 != NULL)) {
          macroValidPointer (operand_162084) ;
          var_cas_methodSignature.addAssign_operation (operand_162084->mAttributType, var_cas_inPassingMode) ;
          operand_162084 = operand_162084->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_161471->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_161471->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4221)) ;
        operand_161471 = operand_161471->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_162425 = var_cas_searchMethodList.firstObject () ;
      while ((operand_162425 != NULL)) {
        macroValidPointer (operand_162425) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_162619 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_162619 != NULL)) {
          macroValidPointer (operand_162619) ;
          var_cas_methodSignature.addAssign_operation (operand_162619->mAttributType, var_cas_outPassingMode) ;
          operand_162619 = operand_162619->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_162425->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4230)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_163039 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_163039 != NULL)) {
          macroValidPointer (operand_163039) ;
          var_cas_methodSignature.addAssign_operation (operand_163039->mAttributType, var_cas_outPassingMode) ;
          operand_163039 = operand_163039->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_162425->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_162425->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4239)) ;
        operand_162425 = operand_162425->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapMethodMap COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4247)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4249)) ;
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    case 3 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_44 (lexique_var_)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_165299 ;
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_165299) ;
              nt_parse_states_parse (lexique_var_) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_165533 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_165533 != NULL)) {
                macroValidPointer (operand_165533) ;
                var_cas_methodSignature.addAssign_operation (operand_165533->mAttributType, var_cas_inPassingMode) ;
                operand_165533 = operand_165533->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4300)) ;
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_166065 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_166065 != NULL)) {
                  macroValidPointer (operand_166065) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_166065->mAttributType, var_cas_inPassingMode) ;
                  operand_166065 = operand_166065->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4309)) ;
              }
              } break ;
            case 3 : {
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_166444 ;
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_166444) ;
              nt_parse_states_parse (lexique_var_) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_166684 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_166684 != NULL)) {
                macroValidPointer (operand_166684) ;
                var_cas_methodSignature.addAssign_operation (operand_166684->mAttributType, var_cas_outPassingMode) ;
                operand_166684 = operand_166684->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4324)) ;
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_167259 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_167259 != NULL)) {
                  macroValidPointer (operand_167259) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_167259->mAttributType, var_cas_outPassingMode) ;
                  operand_167259 = operand_167259->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4333)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4342)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.methode_insertKey (lexique_var_, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4344)) ;
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    default :
      break ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_3812_29_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_40 (lexique_var_)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_ex_map_method_semantics_parser_4351_21_ (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_nomMethode,
...
void semantics_parser::
pr_ex_map_method_semantics_parser_4351_21_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_error) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void semantics_parser::
semantics_parser::
pr_map_method_semantics_parser_4363_18_ (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_methodName,
                                GGS_lstring  &var_cas_getIndexMethodName,
                                GGS_lstring  &var_cas_outMessage) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_map_method_semantics_parser_4363_18_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_45 (lexique_var_)) {
    case 1 : {
      } break ;
...
void semantics_parser::
semantics_parser::
pr_message_pattern_semantics_parser_4382_23_ (galgas_scanner & lexique_var_,
...
void semantics_parser::
pr_message_pattern_semantics_parser_4382_23_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_semantics_parser_47 (lexique_var_)) {
          case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4408_29_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_48 (lexique_var_)) {
    case 1 : {
      ...
      if (((! (((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_value ())) || (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_value ())))))).isBuiltAndTrue ()) {
        ...
        var_cas_tableEnAvant.methode_insertKey (lexique_var_, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4423)) ;
      }
      } break ;
    case 2 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4445)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4408_29_importSemantics (galgas_scanner & lexique_var_,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_48 (lexique_var_)) {
    case 1 : {
      ...
      if (((! (((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_value ())) || (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_value ())))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.methode_insertKey (lexique_var_, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4464)) ;
      }
      } break ;
    case 2 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4486)) ;
      GGS_TypeModel  var_cas_t ;
      var_cas_t = GGS_ListModel::constructor_new (var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.methode_insertKey (lexique_var_, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4488)) ;
      } break ;
    default :
      break ;
  }
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4408_29_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_48 (lexique_var_)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_attributes_definition_list_semantics_parser_4498_34_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_49 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_tableAttributs.methode_insertKey (lexique_var_, var_cas_attributeName, var_cas_definitionType SOURCE_FILE_AT_LINE (4524)) ;
...
void semantics_parser::
pr_attributes_definition_list_semantics_parser_4498_34_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_49 (lexique_var_)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4538_29_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_50 (lexique_var_)) {
        case 2 : {
          ...
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_constructorsMap.methode_insertKey (lexique_var_, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (4588)) ;
          } break ;
        case 3 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
          GGS_lstring  var_cas_methodName ;
          ...
          nt_formal_arguments_list_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.methode_insertNotAbstract (lexique_var_, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4608)) ;
          } break ;
        case 4 : {
          ...
          switch (select_semantics_parser_52 (lexique_var_)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signatureForGrammarComponent ;
              nt_formal_arguments_list_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
              var_cas_modifiersMap.methode_insertNotAbstract (lexique_var_, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4628)) ;
              } break ;
            case 2 : {
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              ...
              if ((var_cas_acceptAddAssignOperatorCall).isBuiltAndTrue ()) {
                  var_cas_errorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (4648)) ;
              }else{
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (4667)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_extern) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4538_29_importSemantics (galgas_scanner & lexique_var_,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_50 (lexique_var_)) {
        case 2 : {
          ...
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_EXconstructorsMap.methode_insertKey (lexique_var_, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (4726)) ;
          var_cas_constructorMap.methode_insertKey (lexique_var_, var_cas_constructorName, var_cas_formalInputArgumentList SOURCE_FILE_AT_LINE (4727)) ;
          } break ;
        case 3 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
          ...
          nt_formal_arguments_list_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.methode_insertNotAbstract (lexique_var_, var_cas_readerName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4747)) ;
          var_cas_readerMap.methode_insertKey (lexique_var_, var_cas_readerName, var_cas_signature SOURCE_FILE_AT_LINE (4748)) ;
          } break ;
        case 4 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_modifier) ;
          switch (select_semantics_parser_52 (lexique_var_)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signature ;
              nt_formal_arguments_list_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
              var_cas_EXmodifiersMap.methode_insertNotAbstract (lexique_var_, var_cas_modifierName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (4768)) ;
              var_cas_modifierMap.methode_insertKey (lexique_var_, var_cas_modifierName, var_cas_signature SOURCE_FILE_AT_LINE (4769)) ;
              } break ;
            case 2 : {
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              if (((var_cas_addAssignFormalInputArgumentList.reader_length ()) > (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
                  GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (4773)) ;
              }else{
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true, true) ;
              }
              { bool syntaxRepeat = true ;
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (4805)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.methode_insertKey (lexique_var_, var_cas_externTypeName, var_cas_t SOURCE_FILE_AT_LINE (4807)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_extern) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4538_29_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_extern) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4817_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4826)) ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        ...
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4827)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
    ...
    var_cas_tableEnAvant.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (4829)) ;
  }
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4817_28_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
}
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_4817_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4839_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4849)) ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique.drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4850)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    var_cas_tableEnAvant.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (4852)) ;
    { cPtr_typeGalgasUndefinedListType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4853)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4839_28_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_4839_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4864_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4874)) ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique.drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4875)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    var_cas_tableEnAvant.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (4877)) ;
    { cPtr_typeGalgasUndefinedMapType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          message2_ << var_cas_type_semantique (HERE)->message_messageGalgasType () ;
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4878)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4864_28_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_4864_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4889_28_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4900)) ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique.drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4901)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    var_cas_tableEnAvant.methode_searchKey (lexique_var_, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (4903)) ;
    { cPtr_typeGalgasUndefinedClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          message2_ << var_cas_type_semantique (HERE)->message_messageGalgasType () ;
          var_cas_outGalgasTypeName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (4904)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_4889_28_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_4889_28_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4920_29_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (4944)) ;
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4920_29_importSemantics (galgas_scanner & lexique_var_,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
                                GGS_ActionMap  &var_cas_ioExternActionMap,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  var_cas_entite = GGS_typeEntiteActionExterne::constructor_new (var_cas_listeDeTypes COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_actionName, var_cas_entite SOURCE_FILE_AT_LINE (4972)) ;
  var_cas_ioExternActionMap.methode_insertKey (lexique_var_, var_cas_actionName, var_cas_signature, GGS_bool (true, true) SOURCE_FILE_AT_LINE (4973)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4920_29_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_action) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4983_29_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
        var_cas_constantMap.methode_insertKey (lexique_var_, var_cas_constantName SOURCE_FILE_AT_LINE (5003)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_cstMessageStringMap.methode_insertKey (lexique_var_, var_cas_cstName, var_cas_cstString SOURCE_FILE_AT_LINE (5022)) ;
                lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          ...
          GGS_enumConstantMap::element_type * operand_193098 = var_cas_constantMap.firstObject () ;
          while ((operand_193098 != NULL)) {
            macroValidPointer (operand_193098) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (operand_193098->mKey.reader_value (), GGS_location (lexique_var_) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            var_cas_cstMessageStringMap.methode_searchKey (lexique_var_, var_cas_name, var_cas_cstString SOURCE_FILE_AT_LINE (5032)) ;
            var_cas_messageStringList.addAssign_operation (var_cas_cstString) ;
            operand_193098 = operand_193098->nextObject () ;
          }
          var_cas_enumMessageMap.methode_insertKey (lexique_var_, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5036)) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_enumTypeName, var_cas_ee SOURCE_FILE_AT_LINE (5048)) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4983_29_importSemantics (galgas_scanner & lexique_var_,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
        var_cas_constantMap.methode_insertKey (lexique_var_, var_cas_constantName SOURCE_FILE_AT_LINE (5067)) ;
      switch (select_repeat_semantics_parser_54 (lexique_var_)) {
        case 2 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2C) ;
          } break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_55 (lexique_var_)) {
        case 2 : {
          ...
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_messageName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
          var_cas_enumMessageMap.methode_insertKey (lexique_var_, var_cas_messageName SOURCE_FILE_AT_LINE (5081)) ;
          GGS_L_lstringList  var_cas_messageStringList ;
          var_cas_messageStringList = GGS_L_lstringList::constructor_empty (HERE) ;
          var_cas_exEnumMessageMap.methode_insertKey (lexique_var_, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5083)) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, var_cas_enumTypeName, var_cas_e SOURCE_FILE_AT_LINE (5100)) ;
  GGS_TypeModel  var_cas_type ;
  var_cas_type = GGS_EnumModel::constructor_new (var_cas_constantMap, var_cas_enumMessageMap COMMA_HERE) ;
  var_cas_ioModelMap.methode_insertKey (lexique_var_, var_cas_enumTypeName, var_cas_type SOURCE_FILE_AT_LINE (5102)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_semantics_declaration_semantics_parser_4983_29_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_enum) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  { bool syntaxRepeat = true ;
