...
pr_galgas_component_semantics_parser_558_23_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_21003 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (572))).operator_isNotEqual (var_cas_basename) ;
  if (cond_21003.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_24061 = (var_cas_ioSemanticsComponentsMap.reader_hasKey (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657))).operator_not () ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  {
    ...
    while (((operand_24204 = enumerator_24204.nextObject ()))) {
      ...
      const GGS_bool cond_24398 = (var_cas_tableRoutinesAimplementer.reader_hasKey (inLexique, operand_24204->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (676)) COMMA_SOURCE_FILE_AT_LINE (676))).operator_not () ;
      if (cond_24398.isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    while (((operand_24498 = enumerator_24498.nextObject ()))) {
      ...
      const GGS_bool cond_24693 = (var_cas_componentEntitiesMap.reader_hasKey (inLexique, operand_24498->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (683)) COMMA_SOURCE_FILE_AT_LINE (683))).operator_not () ;
...
pr_galgas_component_semantics_parser_558_23_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_26968 = (var_cas_ioSemanticsComponentsMap.reader_hasKey (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (754)) COMMA_SOURCE_FILE_AT_LINE (754))).operator_not () ;
  if (cond_26968.isBuiltAndTrue ()) {
    GGS_M_optionComponents  var_cas_optionsComponentsMap = GGS_M_optionComponents ::constructor_emptyMap (inLexique COMMA_HERE) ;
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (inLexique)) {
            ...
            case 3 : {
              ...
              var_cas_outInclusionsForImplementationFile.addAssign_operation (var_cas_fileNameWithPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (973))) ;
              {
                ...
                while (((operand_35189 = enumerator_35189.nextObject ()))) {
                  ...
                  const GGS_bool cond_35443 = (var_cas_ioGrammarComponentsMap.reader_hasKey (inLexique, operand_35189->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (975)) COMMA_SOURCE_FILE_AT_LINE (975))).operator_not () ;
                  if (cond_35443.isBuiltAndTrue ()) {
            ...
            case 4 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_sourceFile) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
              const GGS_bool cond_36972 = (var_cas_outImportedSemanticsComponentNameSet.reader_hasKey (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (992)) COMMA_SOURCE_FILE_AT_LINE (992))).operator_not () ;
              if (cond_36972.isBuiltAndTrue ()) {
                ...
                }
                {
                  ...
                  while (((operand_36375 = enumerator_36375.nextObject ()))) {
                    ...
                    const GGS_bool cond_36546 = (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, operand_36375->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1005)) COMMA_SOURCE_FILE_AT_LINE (1005))).operator_not () ;
                ...
                }
                {
                  ...
                  while (((operand_36748 = enumerator_36748.nextObject ()))) {
                    ...
                    const GGS_bool cond_36935 = (var_cas_ioOptionsComponentsMapForUse.reader_hasKey (inLexique, operand_36748->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012))).operator_not () ;
            ...
            case 4 : {
              ...
              }
              {
                ...
                while (((operand_39141 = enumerator_39141.nextObject ()))) {
                  ...
                  const GGS_bool cond_39306 = (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, operand_39141->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1083)) COMMA_SOURCE_FILE_AT_LINE (1083))).operator_not () ;
                  if (cond_39306.isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_1107_28_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_41513 = var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_routineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1134)) COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  ...
  }else if (cond_41513.isBuiltAndFalse ()) {
...
pr_semantics_declaration_semantics_parser_1107_28_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_43712 = (var_cas_ioExternActionMap.reader_hasKey (inLexique, var_cas_routineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1203)) COMMA_SOURCE_FILE_AT_LINE (1203))).operator_not () ;
  if (cond_43712.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_44143 = var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_routineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1206)) COMMA_SOURCE_FILE_AT_LINE (1206)) ;
  if (cond_44143.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_44143.isBuiltAndFalse ()) {
...
pr_semantics_declaration_semantics_parser_1241_28_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_47433 = var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_routineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
  if (cond_47433.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_47433.isBuiltAndFalse ()) {
...
pr_semantics_declaration_semantics_parser_1241_28_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_50877 = var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_routineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1381)) COMMA_SOURCE_FILE_AT_LINE (1381)) ;
  ...
  }else if (cond_50877.isBuiltAndFalse ()) {
    ...
    case 2 : {
      ...
      switch (select_semantics_parser_7 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_bool cond_68600 = (var_cas_optionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1844))).operator_isNotEqual (GGS_string ("generatedInSeparateFile")) ;
          if (cond_68600.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_68818 = (var_cas_tableDesClassesAncetres.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1848))).operator_strictSup (GGS_uint (0U)) ;
          if (cond_68818.isBuiltAndTrue ()) {
            ...
            case 2 : {
              ...
              switch (select_semantics_parser_9 (inLexique)) {
                case 1 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                  const GGS_bool cond_69889 = (var_cas_classMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1877))).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_69889.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_69889.isBuiltAndFalse ()) {
                    const GGS_bool cond_70012 = (var_cas_messageText.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1879))).operator_isEqual (GGS_uint (0U)) ;
                    if (cond_70012.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_70012.isBuiltAndFalse ()) {
                ...
                case 2 : {
                  ...
                  inLexique.assignFromAttribute_tokenString (var_cas_messageText) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                  const GGS_bool cond_70459 = (var_cas_inheritedMessageMap.reader_hasKey (inLexique, var_cas_messageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1891)) COMMA_SOURCE_FILE_AT_LINE (1891))).operator_not () ;
                  if (cond_70459.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_72476 = ((var_cas_superClassMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1960))).operator_strictSup (GGS_uint (0U))).operator_and ((var_cas_classMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1960))).operator_isEqual (GGS_uint (0U))) ;
      if (cond_72476.isBuiltAndTrue ()) {
      ...
      }
      {
        ...
        while (((operand_72567 = enumerator_72567.nextObject ()))) {
          ...
          const GGS_bool cond_72724 = (var_cas_tableMessagesClasseConcrete.reader_hasKey (inLexique, operand_72567->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1965)) COMMA_SOURCE_FILE_AT_LINE (1965))).operator_not () ;
          if (cond_72724.isBuiltAndTrue ()) {
      ...
      GGS_typeListeAttributsSemantiques  var_cas_setterAttributeModifierToImplementList = GGS_typeListeAttributsSemantiques ::constructor_emptyList () ;
      {
        ...
        while (((operand_73425 = enumerator_73425.nextObject ()))) {
          ...
          const GGS_bool cond_73665 = var_cas_hasSetter ;
          if (cond_73665.isBuiltAndTrue ()) {
      ...
      GGS_typeListeAttributsSemantiques  var_cas_getterAttributeReaderToImplementList = GGS_typeListeAttributsSemantiques ::constructor_emptyList () ;
      {
        ...
        while (((operand_73835 = enumerator_73835.nextObject ()))) {
          ...
          const GGS_bool cond_74073 = var_cas_hasGetter ;
...
pr_class_declaration_semantics_parser_1800_24_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_6 (inLexique)) {
    case 1 : {
      const GGS_bool cond_75535 = ((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_abstractClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2042)) COMMA_SOURCE_FILE_AT_LINE (2042))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_abstractClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2043)) COMMA_SOURCE_FILE_AT_LINE (2043)))).operator_not () ;
      if (cond_75535.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedClassType ::constructor_new (inLexique, var_cas_abstractClassName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      switch (select_semantics_parser_7 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_optionString) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          const GGS_bool cond_76621 = (var_cas_optionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2076))).operator_isNotEqual (GGS_string ("generatedInSeparateFile")) ;
          if (cond_76621.isBuiltAndTrue ()) {
          ...
          var_cas_hasGeneratedInSeparateFileSetting = GGS_bool (true) ;
          const GGS_bool cond_76839 = (var_cas_tableDesClassesAncetres.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (2080))).operator_strictSup (GGS_uint (0U)) ;
          if (cond_76839.isBuiltAndTrue ()) {
            ...
            case 2 : {
              ...
              switch (select_semantics_parser_9 (inLexique)) {
                case 1 : {
                  ...
                  inLexique.assignFromAttribute_tokenString (var_cas_messageText) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                  const GGS_bool cond_77986 = (var_cas_classMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2110))).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_77986.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_77986.isBuiltAndFalse ()) {
                    const GGS_bool cond_78109 = (var_cas_messageText.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2112))).operator_isEqual (GGS_uint (0U)) ;
                    if (cond_78109.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_78109.isBuiltAndFalse ()) {
                ...
                case 2 : {
                  ...
                  inLexique.assignFromAttribute_tokenString (var_cas_messageText) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                  const GGS_bool cond_78556 = (var_cas_inheritedMessageMap.reader_hasKey (inLexique, var_cas_messageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2124)) COMMA_SOURCE_FILE_AT_LINE (2124))).operator_not () ;
                  if (cond_78556.isBuiltAndTrue ()) {
      ...
      }
      {
        ...
        while (((operand_80414 = enumerator_80414.nextObject ()))) {
          ...
          const GGS_bool cond_80572 = (var_cas_tableMessagesClasseConcrete.reader_hasKey (inLexique, operand_80414->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2193)) COMMA_SOURCE_FILE_AT_LINE (2193))).operator_not () ;
          if (cond_80572.isBuiltAndTrue ()) {
...
pr_abstract_method_semantics_parser_2222_22_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_81917 = (var_cas_inIsAbstract).operator_not () ;
  if (cond_81917.isBuiltAndTrue ()) {
...
pr_type_parsing_semantics_parser_2725_19_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_101415 = var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2732)) COMMA_SOURCE_FILE_AT_LINE (2732)) ;
  if (cond_101415.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_101415.isBuiltAndFalse ()) {
    const GGS_bool cond_101539 = var_cas_inTableEnAvant.reader_hasKey (inLexique, var_cas_outTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2736)) COMMA_SOURCE_FILE_AT_LINE (2736)) ;
    if (cond_101539.isBuiltAndTrue ()) {
    ...
    }else if (cond_101539.isBuiltAndFalse ()) {
...
pr_instruction_beginning_with_identifier_semantics_parser_2789_44_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_17 = true ;
    while (syntaxRepeat_17) {
        ...
        const GGS_bool cond_104946 = (var_cas_found).operator_not () ;
        if (cond_104946.isBuiltAndTrue ()) {
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_2845_65_ (galgas_scanner & inLexique,
  ...
  if (var_cas_inTargetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    ...
    if ((operand_106763 != NULL) && (operand_106776 != NULL)) {
      const GGS_bool cond_107159 = (operand_106763->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2871))).operator_isNotEqual (operand_106776->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2871))) ;
      if (cond_107159.isBuiltAndTrue ()) {
      ...
      }else if (cond_107159.isBuiltAndFalse ()) {
      ...
      if ((operand_106763 != NULL) && (operand_106776 != NULL)) {
        const GGS_bool cond_107583 = (operand_106763->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2879))).operator_isNotEqual (operand_106776->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2879))) ;
        if (cond_107583.isBuiltAndTrue ()) {
          ...
          var_cas_sourceExpressionConverter.drop () ;
        }else if (cond_107583.isBuiltAndFalse ()) {
          var_cas_sourceExpressionConverter = GGS_string ("") ;
        }
      }else{
        ...
        if ((operand_106763 != NULL) && (operand_106776 != NULL)) {
          const GGS_bool cond_108031 = (operand_106763->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2887))).operator_isNotEqual (operand_106776->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2887))) ;
          if (cond_108031.isBuiltAndTrue ()) {
            ...
            var_cas_sourceExpressionConverter.drop () ;
          }else if (cond_108031.isBuiltAndFalse ()) {
            var_cas_sourceExpressionConverter = GGS_string ("") ;
          }
        }else{
...
pr_input_parameters_list_semantics_parser_2917_28_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_111281 = (var_cas_listeAttributsSemantiques.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2974))).operator_strictInf (var_cas_listeCibles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2974))) ;
  if (cond_111281.isBuiltAndTrue ()) {
  ...
  }else if (cond_111281.isBuiltAndFalse ()) {
    const GGS_bool cond_111588 = ((var_cas_listeAttributsSemantiques.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2978))).operator_strictSup (var_cas_listeCibles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2978)))).operator_and ((var_cas_ellipsis).operator_not ()) ;
    if (cond_111588.isBuiltAndTrue ()) {
      ...
      var_cas_outAllVariablesList.drop () ;
      var_cas_listeAffectationParametresEffectifs.drop () ;
    }else if (cond_111588.isBuiltAndFalse ()) {
    ...
    while (syntaxRepeat_22) {
      switch (select_repeat_semantics_parser_22 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_114327 = (var_cas_found).operator_not () ;
          if (cond_114327.isBuiltAndTrue ()) {
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_3064_65_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_116660 = (var_cas_formalParametersList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (3099))).operator_isNotEqual (var_cas_typeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (3099))) ;
  if (cond_116660.isBuiltAndTrue ()) {
  ...
  }else if (cond_116660.isBuiltAndFalse ()) {
    {
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_3123_65_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_118967 = (var_cas_formalParametersList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (3157))).operator_isNotEqual (var_cas_typeList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (3157))) ;
  if (cond_118967.isBuiltAndTrue ()) {
  ...
  }else if (cond_118967.isBuiltAndFalse ()) {
    {
    ...
    while (syntaxRepeat_25) {
      switch (select_repeat_semantics_parser_25 (inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_26 (inLexique)) {
            ...
            case 3 : {
              ...
              const GGS_bool cond_125876 = var_cas_exclusiveVariables.reader_hasKey (inLexique, var_cas_nomArgument.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3318)) COMMA_SOURCE_FILE_AT_LINE (3318)) ;
              if (cond_125876.isBuiltAndTrue ()) {
              ...
              }else if (cond_125876.isBuiltAndFalse ()) {
        ...
        case 4 : {
            ...
            while (syntaxRepeat_27) {
              switch (select_repeat_semantics_parser_27 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_126905 = (var_cas_found).operator_not () ;
                  if (cond_126905.isBuiltAndTrue ()) {
          ...
          var_cas_outExpressionList.addAssign_operation (var_cas_e) ;
          const GGS_bool cond_127479 = var_cas_exclusiveVariables.reader_hasKey (inLexique, var_cas_nomArgument.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3352)) COMMA_SOURCE_FILE_AT_LINE (3352)) ;
          if (cond_127479.isBuiltAndTrue ()) {
          ...
          }else if (cond_127479.isBuiltAndFalse ()) {
...
pr_extract_instruction_semantics_parser_3427_26_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_131541 = (var_cas_tableDesClassesAncetres.reader_hasKey (inLexique, var_cas_nomTypeSource.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3451)) COMMA_SOURCE_FILE_AT_LINE (3451))).operator_not () ;
  if (cond_131541.isBuiltAndTrue ()) {
...
pr_extract_instruction_semantics_parser_3497_26_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_28 = true ;
    while (syntaxRepeat_28) {
        ...
        const GGS_bool cond_134914 = (var_cas_tableDesClassesAncetresType1.reader_hasKey (inLexique, var_cas_nomTypeSource.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3528)) COMMA_SOURCE_FILE_AT_LINE (3528))).operator_not () ;
        if (cond_134914.isBuiltAndTrue ()) {
...
pr_semantic_instruction_semantics_parser_3584_27_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_29 = true ;
    while (syntaxRepeat_29) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
        GGS_AC_semanticsEntity  var_cas_entite ;
        const GGS_M_semanticsEntitiesForUse  temp_138253 = var_cas_ioComponentSemanticsEntitiesMap ;
        if (temp_138253.isBuilt ()) {
          temp_138253 (HERE)->method_searchKey (inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (3627)) ;
        }
        ...
        const GGS_bool cond_139064 = (var_cas_checkForKindOfClass).operator_not () ;
        if (cond_139064.isBuiltAndTrue ()) {
          const GGS_bool cond_139045 = ((var_cas_castedTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3635))).operator_isNotEqual (var_cas_sourceExpressionTypeNameString)).operator_and ((var_cas_superClassMap.reader_hasKey (inLexique, var_cas_sourceExpressionTypeNameString COMMA_SOURCE_FILE_AT_LINE (3635))).operator_not ()) ;
          if (cond_139045.isBuiltAndTrue ()) {
        ...
        }else if (cond_139064.isBuiltAndFalse ()) {
          const GGS_bool cond_139252 = (var_cas_superClassMap.reader_hasKey (inLexique, var_cas_sourceExpressionTypeNameString COMMA_SOURCE_FILE_AT_LINE (3638))).operator_not () ;
          if (cond_139252.isBuiltAndTrue ()) {
  ...
  switch (select_semantics_parser_32 (inLexique)) {
    case 1 : {
      ...
      const GGS_bool cond_141105 = (var_cas_sourceClassMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (3677))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_141105.isBuiltAndTrue ()) {
      ...
      const GGS_AC_galgasType  temp_141602 = var_cas_errorLocationExpressionType ;
      if (temp_141602.isBuilt ()) {
        temp_141602 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (3693)) ;
      }
...
pr_instruction_beginning_with_identifier_semantics_parser_3832_44_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_147172 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_147172.isBuilt ()) {
    temp_147172 (HERE)->method_searchKey (inLexique, var_cas_nomVarDest, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (3843)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_147644 = var_cas_entite ; // CAST instruction
    if (_var_147644.getPtr () != NULL) {
      macroValidPointer (_var_147644.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteRoutine *> (_var_147644.getPtr ()) != NULL) {
        const GGS_typeEntiteRoutine var_cas_r (_var_147644.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteRoutineExterne *> (_var_147644.getPtr ()) != NULL) {
        const GGS_typeEntiteRoutineExterne var_cas_ae (_var_147644.getPtr ()) ;
...
pr_semantic_instruction_semantics_parser_3892_27_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_35 (inLexique)) {
    case 1 : {
      ...
      const GGS_AC_galgasType  temp_149976 = var_cas_expressionType ;
      if (temp_149976.isBuilt ()) {
        temp_149976 (HERE)->method_handleMethodInstructionCall (inLexique, var_cas_methodName, var_cas_inSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (3921)), var_cas_methodSignature, var_cas_categoryMethodClassBaseName COMMA_SOURCE_FILE_AT_LINE (3919)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
    ...
    case 2 : {
        ...
        while (syntaxRepeat_36) {
          switch (select_repeat_semantics_parser_36 (inLexique)) {
            case 2 : {
              ...
              GGS_bool var_cas_found = GGS_bool (false) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_151296 (var_cas_structType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (3961)), true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_151296 = NULL ;
                while (((operand_151296 = enumerator_151296.nextObject ()))
                    && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
                  macroValidPointer (operand_151296) ;
                  var_cas_found = (operand_151296->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3962))).operator_isEqual (var_cas_structAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3962))) ;
                  var_cas_variableType = operand_151296->mAttributType ;
                }
              }
              const GGS_bool cond_151651 = (var_cas_found).operator_not () ;
              if (cond_151651.isBuiltAndTrue ()) {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
      const GGS_AC_galgasType  temp_151834 = var_cas_variableType ;
      if (temp_151834.isBuilt ()) {
        temp_151834 (HERE)->method_handleModifierCall (inLexique, var_cas_modifierName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (3973)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
      nt_actual_parameters_list_ (inLexique, var_cas_methodSignature, var_cas_expressionsList, var_cas_ioVariablesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioInstructionList) ;
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  temp_152630 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_152630.isBuilt ()) {
        temp_152630 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (3995)) ;
      }
      ...
      const GGS_AC_galgasType  temp_152785 = var_cas_type ;
      if (temp_152785.isBuilt ()) {
        temp_152785 (HERE)->method_handleClassMethodCall (inLexique, var_cas_typeMethodName, var_cas_typeMethodSignature COMMA_SOURCE_FILE_AT_LINE (3997)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
...
pr_semantic_instruction_semantics_parser_4029_27_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_37 (inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_AC_galgasType  temp_155264 = var_cas_targetVarType ;
      if (temp_155264.isBuilt ()) {
        temp_155264 (HERE)->method_handleConstructorCall (inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (4074)) ;
      }
...
pr_warning_instruction_semantics_parser_4159_26_ (galgas_scanner & inLexique,
  ...
  GGS_AC_galgasType  var_cas_errorExpressionType ;
  nt_expression_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_errorExpression, var_cas_errorExpressionType) ;
  const GGS_AC_galgasType  temp_158972 = var_cas_errorExpressionType ;
  if (temp_158972.isBuilt ()) {
    temp_158972 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (4178)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
...
pr_error_instruction_semantics_parser_4225_24_ (galgas_scanner & inLexique,
  ...
  GGS_AC_galgasType  var_cas_errorLocationExpressionType ;
  nt_expression_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_errorLocationExpression, var_cas_errorLocationExpressionType) ;
  const GGS_AC_galgasType  temp_161346 = var_cas_errorLocationExpressionType ;
  if (temp_161346.isBuilt ()) {
    temp_161346 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (4244)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
...
pr_semantic_instruction_semantics_parser_4397_27_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_42) {
        ...
        { bool syntaxRepeat_43 = true ;
          while (syntaxRepeat_43) {
              ...
              const GGS_enumConstantMap  temp_168014 = var_cas_enumConstantesMap ;
              if (temp_168014.isBuilt ()) {
                temp_168014 (HERE)->method_searchKey (inLexique, var_cas_enumConstantName, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (4433)) ;
              }
              const GGS_bool cond_168221 = var_cas_allBranchConstantSet.reader_hasKey (inLexique, var_cas_enumConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4434)) COMMA_SOURCE_FILE_AT_LINE (4434)) ;
              if (cond_168221.isBuiltAndTrue ()) {
  ...
  {
    GGS_stringset::cEnumerator enumerator_169031 (var_cas_missingConstants, true) ;
    while (enumerator_169031.hasCurrentObject ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (enumerator_169031._key (HERE))).operator_concat (GGS_string ("' is not used in switch instruction")) COMMA_SOURCE_FILE_AT_LINE (4463)) ;
      enumerator_169031.next () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_4563_27_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_175842 = (var_cas_hasDependancyFile).operator_and (var_cas_hasInputParameter) ;
  if (cond_175842.isBuiltAndTrue ()) {
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  const GGS_M_semanticsEntitiesForUse  temp_175941 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_175941.isBuilt ()) {
    temp_175941 (HERE)->method_searchKey (inLexique, var_cas_grammarName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (4666)) ;
  }
  ...
  const GGS_M_nonterminalSymbolAlts  temp_176254 = var_cas_startSymbolAltMap ;
  if (temp_176254.isBuilt ()) {
    temp_176254 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_startSymbolSignature COMMA_SOURCE_FILE_AT_LINE (4671)) ;
  }
...
pr_semantic_instruction_semantics_parser_4754_27_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_49) {
      switch (select_repeat_semantics_parser_49 (inLexique)) {
        case 2 : {
          ...
          GGS_bool var_cas_found = GGS_bool (false) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_180377 (var_cas_structType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (4792)), true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_180377 = NULL ;
            while (((operand_180377 = enumerator_180377.nextObject ()))
                && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
              macroValidPointer (operand_180377) ;
              var_cas_found = (operand_180377->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4793))).operator_isEqual (var_cas_structAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4793))) ;
              var_cas_targetType = operand_180377->mAttributType ;
            }
          }
          const GGS_bool cond_180718 = (var_cas_found).operator_not () ;
          if (cond_180718.isBuiltAndTrue ()) {
  ...
  const GGS_AC_galgasType  temp_181220 = var_cas_targetType ;
  if (temp_181220.isBuilt ()) {
    temp_181220 (HERE)->method_check_with_InstructionAccess (inLexique, var_cas_instructionLocation, var_cas_searchMethodName, var_cas_keyExpressionType, var_cas_mapTypeName, var_cas_errorMessageName, var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (4817)) ;
  }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_181911 (var_cas_attributeList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_181911 = NULL ;
    while (((operand_181911 = enumerator_181911.nextObject ()))) {
      macroValidPointer (operand_181911) ;
      var_cas_ioVariablesMap.modifier_insertWithInstructionLocalVariable (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefixString).operator_concat (operand_181911->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4840))), var_cas_instructionLocation COMMA_HERE), operand_181911->mAttributType, GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_181911->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4842)), GGS_bool (true), GGS_bool (false) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (4839)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
...
pr_constant_while_before_in_foreach_instruction_semantics_parser_4894_51_secondPhase (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_51 = true ;
    while (syntaxRepeat_51) {
        ...
        const GGS_AC_galgasType  temp_186934 = var_cas_sourceExpressionType ;
        if (temp_186934.isBuilt ()) {
          temp_186934 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_magicNumber, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (5005)) ;
        }
        GGS_string var_cas_typeName ;
        const GGS_AC_galgasType  temp_187192 = var_cas_sourceExpressionType ;
        if (temp_187192.isBuilt ()) {
          temp_187192 (HERE)->method_getTypeName (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (5014)) ;
        }
        switch (select_semantics_parser_53 (inLexique)) {
          case 1 : {
          ...
          case 2 : {
            ...
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_187729 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_187729 = NULL ;
              while (((operand_187729 = enumerator_187729.nextObject ()))) {
                macroValidPointer (operand_187729) ;
                GGS_typeCplusPlusName  var_cas_cppName ;
                const GGS_bool cond_187978 = ((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne) ;
                if (cond_187978.isBuiltAndTrue ()) {
                  var_cas_cppName = GGS_typeKeyName ::constructor_new (inLexique, var_cas_magicNumber, var_cas_iteratorNewStyle COMMA_HERE) ;
                }else if (cond_187978.isBuiltAndFalse ()) {
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_187729->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5035)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5037))).operator_concat (operand_187729->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5037))), GGS_location (inLexique) COMMA_HERE), operand_187729->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5037)) ;
          ...
          case 3 : {
            ...
            GGS_bool var_cas_firstOne = GGS_bool (true) ;
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_188489 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_188489 = NULL ;
              while (((operand_188489 = enumerator_188489.nextObject ()))) {
                macroValidPointer (operand_188489) ;
                GGS_typeCplusPlusName  var_cas_cppName ;
                const GGS_bool cond_188738 = ((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne) ;
                if (cond_188738.isBuiltAndTrue ()) {
                  var_cas_cppName = GGS_typeKeyName ::constructor_new (inLexique, var_cas_magicNumber, var_cas_iteratorNewStyle COMMA_HERE) ;
                }else if (cond_188738.isBuiltAndFalse ()) {
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_188489->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5048)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, operand_188489->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5050)), GGS_location (inLexique) COMMA_HERE), operand_188489->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5050)) ;
                var_cas_firstOne = GGS_bool (false) ;
              }
            }
            } break ;
...
pr_semantic_instruction_semantics_parser_5109_27_ (galgas_scanner & inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_191930 = inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    inLexique.setParsingContext (context_191930) ;
  ...
  switch (select_semantics_parser_57 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_192383 = var_cas_indexVariable ; // CAST instruction
        if (_var_192383.getPtr () != NULL) {
          macroValidPointer (_var_192383.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_192383.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_192383.getPtr ()) ;
  ...
  switch (select_semantics_parser_58 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_193150 = var_cas_indexVariable ; // CAST instruction
        if (_var_193150.getPtr () != NULL) {
          macroValidPointer (_var_193150.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_193150.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_193150.getPtr ()) ;
...
pr_parse_match_operand_semantics_parser_5219_26_ (galgas_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_195203 = var_cas_type ; // CAST instruction
    if (_var_195203.getPtr () != NULL) {
      macroValidPointer (_var_195203.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_195203.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_t (_var_195203.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (_var_195203.getPtr ()) != NULL) {
        const GGS_typeGalgas_enum var_cas_e (_var_195203.getPtr ()) ;
        ...
        const GGS_AC_galgasType  temp_194967 = var_cas_type ;
        if (temp_194967.isBuilt ()) {
          temp_194967 (HERE)->method_getTypeName (inLexique, var_cas_actualTypeName COMMA_SOURCE_FILE_AT_LINE (5247)) ;
        }
...
pr_parse_match_case_semantics_parser_5257_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_195751 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_195751.isBuilt ()) {
    temp_195751 (HERE)->method_searchKey (inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (5270)) ;
  }
  ...
  const GGS_bool cond_196425 = var_cas_isAbstract ;
  if (cond_196425.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_196617 = var_cas_inIsEnumeration ;
  if (cond_196617.isBuiltAndTrue ()) {
  ...
  }else if (cond_196617.isBuiltAndFalse ()) {
    const GGS_bool cond_196781 = (var_cas_tableDesClassesAncetresType1.reader_hasKey (inLexique, var_cas_inTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5284)) COMMA_SOURCE_FILE_AT_LINE (5284))).operator_not () ;
    if (cond_196781.isBuiltAndTrue ()) {
...
pr_parse_match_case_semantics_parser_5300_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  const GGS_bool cond_197586 = var_cas_inIsEnumeration ;
  if (cond_197586.isBuiltAndTrue ()) {
    GGS_bool automatic_var_26 ;
    const GGS_enumConstantMap  temp_197552 = var_cas_inEnumMessageMap ;
    if (temp_197552.isBuilt ()) {
      temp_197552 (HERE)->method_searchKey (inLexique, var_cas_outEnumConstantName, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (5313)) ;
    }
  }else if (cond_197586.isBuiltAndFalse ()) {
...
pr_optional_assignment_semantics_parser_5513_26_ (galgas_scanner & inLexique,
  ...
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_204955 = var_cas_inVariableType ;
  if (temp_204955.isBuilt ()) {
    temp_204955 (HERE)->method_handleConstructorCall (inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (5531)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_5561_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_61 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      const GGS_bool cond_206937 = ((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5575)) COMMA_SOURCE_FILE_AT_LINE (5575))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5576)) COMMA_SOURCE_FILE_AT_LINE (5576)))).operator_not () ;
      if (cond_206937.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_207099 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_207099.isBuilt ()) {
        temp_207099 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5585)) ;
      }
...
pr_semantics_declaration_semantics_parser_5561_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_61 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      const GGS_bool cond_209462 = ((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5641)) COMMA_SOURCE_FILE_AT_LINE (5641))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5642)) COMMA_SOURCE_FILE_AT_LINE (5642)))).operator_not () ;
      if (cond_209462.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedMapindexType ::constructor_new (inLexique, var_cas_mapindexTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_209624 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_209624.isBuilt ()) {
        temp_209624 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5651)) ;
      }
...
pr_semantics_declaration_semantics_parser_5694_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_63 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      const GGS_bool cond_212199 = ((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5708)) COMMA_SOURCE_FILE_AT_LINE (5708))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5709)) COMMA_SOURCE_FILE_AT_LINE (5709)))).operator_not () ;
      if (cond_212199.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_215130 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_215130 = NULL ;
        while (((operand_215130 = enumerator_215130.nextObject ()))) {
          macroValidPointer (operand_215130) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_215307 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_215307 = NULL ;
            while (((operand_215307 = enumerator_215307.nextObject ()))) {
              macroValidPointer (operand_215307) ;
              var_cas_methodSignature.addAssign_operation (operand_215307->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_215130->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5801)) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_215709 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_215709 = NULL ;
            while (((operand_215709 = enumerator_215709.nextObject ()))) {
              macroValidPointer (operand_215709) ;
              var_cas_methodSignature.addAssign_operation (operand_215709->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_215130->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5809))).operator_concat (GGS_string ("GetIndex")), operand_215130->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5809)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_216037 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_216037 = NULL ;
        while (((operand_216037 = enumerator_216037.nextObject ()))) {
          macroValidPointer (operand_216037) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216212 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216212 = NULL ;
            while (((operand_216212 = enumerator_216212.nextObject ()))) {
              macroValidPointer (operand_216212) ;
              var_cas_methodSignature.addAssign_operation (operand_216212->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_216037->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5819)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216612 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216612 = NULL ;
            while (((operand_216612 = enumerator_216612.nextObject ()))) {
              macroValidPointer (operand_216612) ;
              var_cas_methodSignature.addAssign_operation (operand_216612->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_216037->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5827))).operator_concat (GGS_string ("GetIndex")), operand_216037->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5827)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_66) {
          switch (select_repeat_semantics_parser_66 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_219985 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_219985 = NULL ;
                while (((operand_219985 = enumerator_219985.nextObject ()))) {
                  macroValidPointer (operand_219985) ;
                  var_cas_methodSignature.addAssign_operation (operand_219985->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_220823 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5906))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_220823.isBuiltAndTrue ()) {
                ...
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_220539 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_220539 = NULL ;
                  while (((operand_220539 = enumerator_220539.nextObject ()))) {
                    macroValidPointer (operand_220539) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_220539->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221600 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_221600 = NULL ;
                while (((operand_221600 = enumerator_221600.nextObject ()))) {
                  macroValidPointer (operand_221600) ;
                  var_cas_methodSignature.addAssign_operation (operand_221600->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_222468 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5943))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_222468.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222169 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_222169 = NULL ;
                  while (((operand_222169 = enumerator_222169.nextObject ()))) {
                    macroValidPointer (operand_222169) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_222169->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222916 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_222916 = NULL ;
                while (((operand_222916 = enumerator_222916.nextObject ()))) {
                  macroValidPointer (operand_222916) ;
                  var_cas_methodSignature.addAssign_operation (operand_222916->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_223781 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5970))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_223781.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_223500 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_223500 = NULL ;
                  while (((operand_223500 = enumerator_223500.nextObject ()))) {
                    macroValidPointer (operand_223500) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_223500->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_223866 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_223866 = NULL ;
        while (((operand_223866 = enumerator_223866.nextObject ()))) {
          macroValidPointer (operand_223866) ;
          const GGS_bool cond_224297 = operand_223866->mInfo.mHasSetter ;
          if (cond_224297.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_223866->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5984)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (5984)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_223866->mInfo.mAttributType, var_cas_inPassingMode) ;
...
pr_semantics_declaration_semantics_parser_5694_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_63 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      const GGS_bool cond_225819 = ((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6029)) COMMA_SOURCE_FILE_AT_LINE (6029))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6029)) COMMA_SOURCE_FILE_AT_LINE (6029)))).operator_not () ;
      if (cond_225819.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedMapType ::constructor_new (inLexique, var_cas_mapTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType = GGS_typeGalgas_luint ::constructor_new (inLexique COMMA_HERE) ;
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_228703 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_228703 = NULL ;
        while (((operand_228703 = enumerator_228703.nextObject ()))) {
          macroValidPointer (operand_228703) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228880 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_228880 = NULL ;
            while (((operand_228880 = enumerator_228880.nextObject ()))) {
              macroValidPointer (operand_228880) ;
              var_cas_methodSignature.addAssign_operation (operand_228880->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_228703->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6120)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229282 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_229282 = NULL ;
            while (((operand_229282 = enumerator_229282.nextObject ()))) {
              macroValidPointer (operand_229282) ;
              var_cas_methodSignature.addAssign_operation (operand_229282->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_228703->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6128))).operator_concat (GGS_string ("GetIndex")), operand_228703->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6128)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_229610 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_229610 = NULL ;
        while (((operand_229610 = enumerator_229610.nextObject ()))) {
          macroValidPointer (operand_229610) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229787 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_229787 = NULL ;
            while (((operand_229787 = enumerator_229787.nextObject ()))) {
              macroValidPointer (operand_229787) ;
              var_cas_methodSignature.addAssign_operation (operand_229787->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_229610->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6138)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            ...
            while (((operand_230190 = enumerator_230190.nextObject ()))) {
              ...
              var_cas_methodSignature.addAssign_operation (operand_230190->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_229610->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6146))).operator_concat (GGS_string ("GetIndex")), operand_229610->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6146)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_66) {
          switch (select_repeat_semantics_parser_66 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_232528 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_232528 = NULL ;
                while (((operand_232528 = enumerator_232528.nextObject ()))) {
                  macroValidPointer (operand_232528) ;
                  var_cas_methodSignature.addAssign_operation (operand_232528->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_233239 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6209))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_233239.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_233038 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_233038 = NULL ;
                  while (((operand_233038 = enumerator_233038.nextObject ()))) {
                    macroValidPointer (operand_233038) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_233038->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_233684 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_233684 = NULL ;
                while (((operand_233684 = enumerator_233684.nextObject ()))) {
                  macroValidPointer (operand_233684) ;
                  var_cas_methodSignature.addAssign_operation (operand_233684->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_234394 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6237))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_234394.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234193 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_234193 = NULL ;
                  while (((operand_234193 = enumerator_234193.nextObject ()))) {
                    macroValidPointer (operand_234193) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_234193->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234759 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_234759 = NULL ;
                while (((operand_234759 = enumerator_234759.nextObject ()))) {
                  macroValidPointer (operand_234759) ;
                  var_cas_methodSignature.addAssign_operation (operand_234759->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_235508 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6260))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_235508.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_235309 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_235309 = NULL ;
                  while (((operand_235309 = enumerator_235309.nextObject ()))) {
                    macroValidPointer (operand_235309) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_235309->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_235593 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_235593 = NULL ;
        while (((operand_235593 = enumerator_235593.nextObject ()))) {
          macroValidPointer (operand_235593) ;
          const GGS_bool cond_236024 = operand_235593->mInfo.mHasSetter ;
          if (cond_236024.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_235593->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6273)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (6273)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_235593->mInfo.mAttributType, var_cas_inPassingMode) ;
            var_cas_modifierSignature.addAssign_operation (GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_inPassingMode) ;
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6333_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_239005 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_239005.isBuilt ()) {
    temp_239005 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6363)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_239474 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_239474 = NULL ;
    while (((operand_239474 = enumerator_239474.nextObject ()))) {
      macroValidPointer (operand_239474) ;
      GGS_string var_cas_keyClassMethod = ((operand_239474->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6371))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6371))) ;
      const GGS_bool cond_239769 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6372)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6372)) ;
      if (cond_239769.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_239474->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6375)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6333_50_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_241387 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6417)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6417)) COMMA_SOURCE_FILE_AT_LINE (6417))).operator_not () ;
  if (cond_241387.isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_6429_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_243322 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_243322.isBuilt ()) {
    temp_243322 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6465)) ;
  }
  ...
  const GGS_bool cond_244872 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE)) ;
  if (cond_244872.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_243916 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_243916 = NULL ;
      while (((operand_243916 = enumerator_243916.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_243916) ;
        GGS_string var_cas_keyClassMethod = ((operand_243916->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6475))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6475))) ;
        var_cas_baseClassName = operand_243916->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6476)) ;
        ...
        const GGS_bool cond_244652 = var_cas_found ;
        if (cond_244652.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_244321 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6481)) ;
          if (temp_244321.isBuilt ()) {
            temp_244321 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6481)) ;
          }
    ...
    const GGS_bool cond_244860 = (var_cas_found).operator_not () ;
    if (cond_244860.isBuiltAndTrue ()) {
  ...
  }else if (cond_244872.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_244949 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_244949 = NULL ;
      while (((operand_244949 = enumerator_244949.nextObject ()))) {
        macroValidPointer (operand_244949) ;
        GGS_string var_cas_keyClassMethod = ((operand_244949->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6496))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6496))) ;
        const GGS_bool cond_245253 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6497)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6497)) ;
        if (cond_245253.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_244949->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6500)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245406 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6505)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_245406 = NULL ;
    while (((operand_245406 = enumerator_245406.nextObject ()))) {
      macroValidPointer (operand_245406) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6507)), operand_245406->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6508)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_245406->mAttributeName, operand_245406->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6512)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6429_28_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_247907 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6572)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6572)) COMMA_SOURCE_FILE_AT_LINE (6572))).operator_not () ;
  if (cond_247907.isBuiltAndTrue ()) {
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6589_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_249843 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_249843.isBuilt ()) {
    temp_249843 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6621)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_250368 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_250368.isBuilt ()) {
    temp_250368 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6627)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_250837 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_250837 = NULL ;
    while (((operand_250837 = enumerator_250837.nextObject ()))) {
      macroValidPointer (operand_250837) ;
      GGS_string var_cas_keyClassMethod = ((operand_250837->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6635))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6635))) ;
      const GGS_bool cond_251132 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6636)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6636)) ;
      if (cond_251132.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_250837->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6639)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6589_50_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_252743 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_252743.isBuilt ()) {
    temp_252743 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6687)) ;
  }
  ...
  const GGS_bool cond_253234 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6691)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6691)) COMMA_SOURCE_FILE_AT_LINE (6691))).operator_not () ;
  if (cond_253234.isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_6703_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_255032 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_255032.isBuilt ()) {
    temp_255032 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6739)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_255910 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_255910.isBuilt ()) {
    temp_255910 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6749)) ;
  }
  ...
  const GGS_bool cond_257803 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE)) ;
  if (cond_257803.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_256504 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_256504 = NULL ;
      while (((operand_256504 = enumerator_256504.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_256504) ;
        GGS_string var_cas_keyClassMethod = ((operand_256504->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6759))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6759))) ;
        var_cas_baseClassName = operand_256504->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6760)) ;
        ...
        const GGS_bool cond_257583 = var_cas_found ;
        if (cond_257583.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_256966 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6766)) ;
          if (temp_256966.isBuilt ()) {
            temp_256966 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (6766)) ;
          }
    ...
    const GGS_bool cond_257791 = (var_cas_found).operator_not () ;
    if (cond_257791.isBuiltAndTrue ()) {
  ...
  }else if (cond_257803.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_257880 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_257880 = NULL ;
      while (((operand_257880 = enumerator_257880.nextObject ()))) {
        macroValidPointer (operand_257880) ;
        GGS_string var_cas_keyClassMethod = ((operand_257880->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6792))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6792))) ;
        const GGS_bool cond_258184 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6793)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6793)) ;
        if (cond_258184.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_257880->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6796)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_258337 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6801)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_258337 = NULL ;
    while (((operand_258337 = enumerator_258337.nextObject ()))) {
      macroValidPointer (operand_258337) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6803)), operand_258337->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6804)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_258337->mAttributeName, operand_258337->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6808)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6703_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_260830 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_260830.isBuilt ()) {
    temp_260830 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6874)) ;
  }
  ...
  const GGS_bool cond_261321 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6878)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6878)) COMMA_SOURCE_FILE_AT_LINE (6878))).operator_not () ;
  if (cond_261321.isBuiltAndTrue ()) {
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6895_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_263291 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_263291.isBuilt ()) {
    temp_263291 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6926)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_263760 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_263760 = NULL ;
    while (((operand_263760 = enumerator_263760.nextObject ()))) {
      macroValidPointer (operand_263760) ;
      GGS_string var_cas_keyClassMethod = ((operand_263760->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6934))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6934))) ;
      const GGS_bool cond_264063 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6935)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6935)) ;
      if (cond_264063.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_263760->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6938)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6895_50_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_265740 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6980)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6980)) COMMA_SOURCE_FILE_AT_LINE (6980))).operator_not () ;
  if (cond_265740.isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_6992_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_267756 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_267756.isBuilt ()) {
    temp_267756 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7029)) ;
  }
  ...
  const GGS_bool cond_269377 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE)) ;
  if (cond_269377.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_268350 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_268350 = NULL ;
      while (((operand_268350 = enumerator_268350.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_268350) ;
        GGS_string var_cas_keyClassMethod = ((operand_268350->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7039))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7039))) ;
        var_cas_baseClassName = operand_268350->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7040)) ;
        ...
        const GGS_bool cond_269153 = var_cas_found ;
        if (cond_269153.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_268761 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7045)) ;
          if (temp_268761.isBuilt ()) {
            temp_268761 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7045)) ;
          }
    ...
    const GGS_bool cond_269365 = (var_cas_found).operator_not () ;
    if (cond_269365.isBuiltAndTrue ()) {
  ...
  }else if (cond_269377.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_269454 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_269454 = NULL ;
      while (((operand_269454 = enumerator_269454.nextObject ()))) {
        macroValidPointer (operand_269454) ;
        GGS_string var_cas_keyClassMethod = ((operand_269454->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7064))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7064))) ;
        const GGS_bool cond_269766 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7065)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (7065)) ;
        if (cond_269766.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_269454->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7068)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_269919 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_269919 = NULL ;
    while (((operand_269919 = enumerator_269919.nextObject ()))) {
      macroValidPointer (operand_269919) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7075)), operand_269919->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7076)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_269919->mAttributeName, operand_269919->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7080)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6992_28_importSemantics (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_272666 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7146)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7146)) COMMA_SOURCE_FILE_AT_LINE (7146))).operator_not () ;
  if (cond_272666.isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_7166_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_73 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_274666 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_274666 = NULL ;
        while (((operand_274666 = enumerator_274666.nextObject ()))) {
          macroValidPointer (operand_274666) ;
          var_cas_extractSignature.addAssign_operation (operand_274666->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_274666->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7166_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_73 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276803 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_276803 = NULL ;
        while (((operand_276803 = enumerator_276803.nextObject ()))) {
          macroValidPointer (operand_276803) ;
          var_cas_extractSignature.addAssign_operation (operand_276803->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_276803->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7281_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_279309 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_279309 = NULL ;
        while (((operand_279309 = enumerator_279309.nextObject ()))) {
          macroValidPointer (operand_279309) ;
          var_cas_extractSignature.addAssign_operation (operand_279309->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_75 = true ;
        while (syntaxRepeat_75) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            const GGS_bool cond_279999 = var_cas_usedSortedAttributes.reader_hasKey (inLexique, var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7332)) COMMA_SOURCE_FILE_AT_LINE (7332)) ;
            if (cond_279999.isBuiltAndTrue ()) {
            ...
            }else if (cond_279999.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_34 ;
              GGS_bool automatic_var_35 ;
              const GGS_typeSemanticAttributesMap  temp_280073 = var_cas_tableAttributs ;
              if (temp_280073.isBuilt ()) {
                temp_280073 (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_34, automatic_var_35 COMMA_SOURCE_FILE_AT_LINE (7336)) ;
              }
              const GGS_AC_galgasType  temp_280177 = var_cas_definitionType ;
              if (temp_280177.isBuilt ()) {
                temp_280177 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (7337)) ;
              }
...
pr_semantics_declaration_semantics_parser_7281_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_282270 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_282270 = NULL ;
        while (((operand_282270 = enumerator_282270.nextObject ()))) {
          macroValidPointer (operand_282270) ;
          var_cas_extractSignature.addAssign_operation (operand_282270->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasSortedListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_79 = true ;
                while (syntaxRepeat_79) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                    const GGS_bool cond_284707 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7464))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_284707.isBuiltAndTrue ()) {
                      const GGS_bool cond_284657 = (var_cas_hasGetter).operator_not () ;
                      if (cond_284657.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_284707.isBuiltAndFalse ()) {
                      const GGS_bool cond_284909 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7469))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_284909.isBuiltAndTrue ()) {
                        const GGS_bool cond_284861 = var_cas_hasSetter ;
                        if (cond_284861.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_284909.isBuiltAndFalse ()) {
...
pr_semantics_declaration_semantics_parser_7495_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_286439 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_286439.isBuilt ()) {
    temp_286439 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7512)) ;
  }
...
pr_semantics_declaration_semantics_parser_7495_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_287720 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_287720.isBuilt ()) {
    temp_287720 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7546)) ;
  }
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_292456 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_292456 = NULL ;
    while (((operand_292456 = enumerator_292456.nextObject ()))) {
      macroValidPointer (operand_292456) ;
      const GGS_bool cond_292963 = var_cas_inExtensionMap.reader_hasKey (inLexique, operand_292456->mValue.reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (7664)) COMMA_SOURCE_FILE_AT_LINE (7664)) ;
      if (cond_292963.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_292456->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_292456->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_292456->mValue), GGS_location (inLexique) COMMA_HERE), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (7673)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_293198 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_293198 = NULL ;
    while (((operand_293198 = enumerator_293198.nextObject ()))) {
      macroValidPointer (operand_293198) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_293198->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_293198->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (7688)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_293198->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
pr_semantics_declaration_semantics_parser_7709_28_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_294981 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (7740))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_294981.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7741)) ;
  }else if (cond_294981.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_295261 = (var_cas_absoluteSourcePath.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (7745))).operator_not () ;
  if (cond_295261.isBuiltAndTrue ()) {
  ...
  }else if (cond_295261.isBuiltAndFalse ()) {
            ...
            while (syntaxRepeat_83) {
              switch (select_repeat_semantics_parser_83 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_297589 = var_cas_parameterIsUsed ;
                  if (cond_297589.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_297589.isBuiltAndFalse ()) {
...
pr_semantics_declaration_semantics_parser_7709_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
  GGS_M_regularFiles  var_cas_regularFileMap = GGS_M_regularFiles ::constructor_emptyMap (inLexique COMMA_HERE) ;
  const GGS_bool cond_300251 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (7871)).reader_hasKey (inLexique, var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7871)) COMMA_SOURCE_FILE_AT_LINE (7871))).operator_not () ;
  if (cond_300251.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_299463 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (7874))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_299463.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7875)) ;
    }else if (cond_299463.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_299753 = (var_cas_absoluteSourcePath.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (7879))).operator_not () ;
    if (cond_299753.isBuiltAndTrue ()) {
    ...
    }else if (cond_299753.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedList  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedList  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_301307 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (7932)).reader_hasKey (inLexique, var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7932)) COMMA_SOURCE_FILE_AT_LINE (7932))).operator_not () ;
  if (cond_301307.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_87 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_306885 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_306885.isBuiltAndTrue ()) {
              ...
              }else if (cond_306885.isBuiltAndFalse ()) {
      ...
      switch (select_repeat_semantics_parser_85 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_87 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_311080 = (var_cas_addAssignFormalInputArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (8211))).operator_strictSup (GGS_uint (0U)) ;
              if (cond_311080.isBuiltAndTrue ()) {
              ...
              }else if (cond_311080.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_88 = true ;
                while (syntaxRepeat_88) {
...
pr_formal_argument_type_semantics_parser_8255_27_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_313012 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8262)) COMMA_SOURCE_FILE_AT_LINE (8262)) ;
  if (cond_313012.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_312874 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_312874.isBuilt ()) {
      temp_312874 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8264)) ;
    }
  ...
  }else if (cond_313012.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_313066 = var_cas_tableEnAvant ;
    if (temp_313066.isBuilt ()) {
      temp_313066 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8267)) ;
    }
  }
}
...
pr_formal_argument_type_semantics_parser_8277_27_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_313845 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8285)) COMMA_SOURCE_FILE_AT_LINE (8285)) ;
  if (cond_313845.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_313707 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_313707.isBuilt ()) {
      temp_313707 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8287)) ;
    }
  ...
  }else if (cond_313845.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_313899 = var_cas_tableEnAvant ;
    if (temp_313899.isBuilt ()) {
      temp_313899 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8290)) ;
    }
...
pr_formal_argument_type_semantics_parser_8302_27_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_314815 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8310)) COMMA_SOURCE_FILE_AT_LINE (8310)) ;
  if (cond_314815.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_314677 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_314677.isBuilt ()) {
      temp_314677 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8312)) ;
    }
  ...
  }else if (cond_314815.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_314869 = var_cas_tableEnAvant ;
    if (temp_314869.isBuilt ()) {
      temp_314869 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8315)) ;
    }
...
pr_formal_argument_type_semantics_parser_8327_27_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  const GGS_bool cond_315800 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8336)) COMMA_SOURCE_FILE_AT_LINE (8336)) ;
  if (cond_315800.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_315662 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_315662.isBuilt ()) {
      temp_315662 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8338)) ;
    }
  ...
  }else if (cond_315800.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_315854 = var_cas_tableEnAvant ;
    if (temp_315854.isBuilt ()) {
      temp_315854 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8341)) ;
    }
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8422_47_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_320001 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_320001 = NULL ;
    while (((operand_320001 = enumerator_320001.nextObject ()))) {
      macroValidPointer (operand_320001) ;
      const GGS_bool cond_320219 = (operand_320001->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
      if (cond_320219.isBuiltAndTrue ()) {
        operand_320001->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8451)) ;
      }else if (cond_320219.isBuiltAndFalse ()) {
        const GGS_bool cond_320427 = (operand_320001->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)) ;
        if (cond_320427.isBuiltAndTrue ()) {
          operand_320001->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8453)) ;
        }
      }
    }
  }
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8422_47_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_322260 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_322260 = NULL ;
    while (((operand_322260 = enumerator_322260.nextObject ()))) {
      macroValidPointer (operand_322260) ;
      const GGS_bool cond_322478 = (operand_322260->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
      if (cond_322478.isBuiltAndTrue ()) {
        operand_322260->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8505)) ;
      }else if (cond_322478.isBuiltAndFalse ()) {
        const GGS_bool cond_322686 = (operand_322260->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)) ;
        if (cond_322686.isBuiltAndTrue ()) {
          operand_322260->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8507)) ;
        }
      }
    }
  }
    ...
    while (syntaxRepeat_92) {
      switch (select_repeat_semantics_parser_92 (inLexique)) {
        case 2 : {
          ...
          switch (select_semantics_parser_93 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              const GGS_bool cond_325529 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8590))).operator_isNotEqual (GGS_string ("location")) ;
              if (cond_325529.isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_95 = true ;
            while (syntaxRepeat_95) {
                ...
                const GGS_enumConstantMap  temp_326790 = var_cas_constantMap ;
                if (temp_326790.isBuilt ()) {
                  temp_326790 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_38 COMMA_SOURCE_FILE_AT_LINE (8617)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_326983 = var_cas_constantMap ;
                if (temp_326983.isBuilt ()) {
                  temp_326983 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_39 COMMA_SOURCE_FILE_AT_LINE (8622)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_327182 = var_cas_constantMap ;
                if (temp_327182.isBuilt ()) {
                  temp_327182 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (8627)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_97 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              const GGS_bool cond_328563 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8673))).operator_isNotEqual (GGS_string ("location")) ;
              if (cond_328563.isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_99 = true ;
            while (syntaxRepeat_99) {
                ...
                const GGS_enumConstantMap  temp_329829 = var_cas_constantMap ;
                if (temp_329829.isBuilt ()) {
                  temp_329829 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_41 COMMA_SOURCE_FILE_AT_LINE (8700)) ;
                }
                ...
                const GGS_enumConstantMap  temp_330002 = var_cas_constantMap ;
                if (temp_330002.isBuilt ()) {
                  temp_330002 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_42 COMMA_SOURCE_FILE_AT_LINE (8705)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_330735 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_330735 = NULL ;
            while (((operand_330735 = enumerator_330735.nextObject ()))) {
              macroValidPointer (operand_330735) ;
              const GGS_bool cond_330872 = (var_cas_definedSourceMap.reader_hasKey (inLexique, operand_330735->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8731)) COMMA_SOURCE_FILE_AT_LINE (8731))).operator_not () ;
              if (cond_330872.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_330735->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8732)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8733)) ;
              }
            }
          }
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_101 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              const GGS_bool cond_331468 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8750))).operator_isNotEqual (GGS_string ("location")) ;
              if (cond_331468.isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_103 = true ;
            while (syntaxRepeat_103) {
                ...
                const GGS_enumConstantMap  temp_332732 = var_cas_constantMap ;
                if (temp_332732.isBuilt ()) {
                  temp_332732 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_43 COMMA_SOURCE_FILE_AT_LINE (8777)) ;
                }
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_333504 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_333504 = NULL ;
            while (((operand_333504 = enumerator_333504.nextObject ()))) {
              macroValidPointer (operand_333504) ;
              const GGS_bool cond_333641 = (var_cas_definedSourceMap.reader_hasKey (inLexique, operand_333504->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8804)) COMMA_SOURCE_FILE_AT_LINE (8804))).operator_not () ;
              if (cond_333641.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_333504->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8805)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8806)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_334341 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_334341 = NULL ;
            while (((operand_334341 = enumerator_334341.nextObject ()))) {
              macroValidPointer (operand_334341) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_334341->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8833)), GGS_location (inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  temp_334468 = var_cas_cstMessageStringMap ;
              if (temp_334468.isBuilt ()) {
                temp_334468 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (8835)) ;
              }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_93 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              const GGS_bool cond_336926 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8919))).operator_isNotEqual (GGS_string ("location")) ;
              if (cond_336926.isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_95 = true ;
            while (syntaxRepeat_95) {
                ...
                const GGS_enumConstantMap  temp_338187 = var_cas_constantMap ;
                if (temp_338187.isBuilt ()) {
                  temp_338187 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_44 COMMA_SOURCE_FILE_AT_LINE (8946)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                GGS_lstring  var_cas_rightConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_rightConstant) ;
                ...
                if (temp_338380.isBuilt ()) {
                  temp_338380 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_45 COMMA_SOURCE_FILE_AT_LINE (8951)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                GGS_lstring  var_cas_targetConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_targetConstant) ;
                ...
                const GGS_enumConstantMap  temp_338579 = var_cas_constantMap ;
                if (temp_338579.isBuilt ()) {
                  temp_338579 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_46 COMMA_SOURCE_FILE_AT_LINE (8956)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
                switch (select_semantics_parser_96 (inLexique)) {
                  case 1 : {
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_99 = true ;
            while (syntaxRepeat_99) {
                ...
                const GGS_enumConstantMap  temp_339921 = var_cas_constantMap ;
                if (temp_339921.isBuilt ()) {
                  temp_339921 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_47 COMMA_SOURCE_FILE_AT_LINE (9003)) ;
                }
                ...
                const GGS_enumConstantMap  temp_340094 = var_cas_constantMap ;
                if (temp_340094.isBuilt ()) {
                  temp_340094 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_48 COMMA_SOURCE_FILE_AT_LINE (9008)) ;
                }
                switch (select_semantics_parser_100 (inLexique)) {
                  case 1 : {
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_103 = true ;
            while (syntaxRepeat_103) {
                ...
                const GGS_enumConstantMap  temp_341245 = var_cas_constantMap ;
                if (temp_341245.isBuilt ()) {
                  temp_341245 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_49 COMMA_SOURCE_FILE_AT_LINE (9047)) ;
                }
