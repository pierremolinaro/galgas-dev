...
pr_instruction_beginning_with_identifier_semantics_parser_2317_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2353)))._operator_isNotEqual (var_cas_typeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2353)))).isBuiltAndTrue ()) {
    ...
    const GGS_typeListeAttributsSemantiques _var_89871 = var_cas_formalParametersList ;
    GGS_typeListeAttributsSemantiques::element_type * operand_89871 = _var_89871.firstObject () ;
    const GGS_typeTypesList _var_89941 = var_cas_typeList ;
    GGS_typeTypesList::element_type * operand_89941 = _var_89941.firstObject () ;
    while ((operand_89871 != NULL)
        && (operand_89941 != NULL)) {
      macroValidPointer (operand_89871) ;
      macroValidPointer (operand_89941) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_89871->mAttributType,  operand_89941->mType,  operand_89941->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (2358)) ;
      operand_89871 = operand_89871->nextObject () ;
      operand_89941 = operand_89941->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2378_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2414)))._operator_isNotEqual (var_cas_typeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2414)))).isBuiltAndTrue ()) {
    ...
    const GGS_typeListeAttributsSemantiques _var_92442 = var_cas_formalParametersList ;
    GGS_typeListeAttributsSemantiques::element_type * operand_92442 = _var_92442.firstObject () ;
    const GGS_typeTypesList _var_92512 = var_cas_typeList ;
    GGS_typeTypesList::element_type * operand_92512 = _var_92512.firstObject () ;
    while ((operand_92442 != NULL)
        && (operand_92512 != NULL)) {
      macroValidPointer (operand_92442) ;
      macroValidPointer (operand_92512) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_92442->mAttributType,  operand_92512->mType,  operand_92512->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (2419)) ;
      operand_92442 = operand_92442->nextObject () ;
      operand_92512 = operand_92512->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_27 (_inLexique)) {
            ...
            case 2 : {
              ...
              GGS_uint _variant_98880 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (2560)) ;
              GGS_bool _condition_98880 (_variant_98880._isBuilt (), true) ;
              while (_condition_98880.isBuiltAndTrue ()) {
                _condition_98880 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_98880.isBuiltAndTrue ()) {
                  if (_variant_98880.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2565)) ;
                    _condition_98880 = GGS_bool (true, false) ;
                  }else{
                    _variant_98880._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeTypesParametresEffectifs._addAssign_operation (GGS_typeGalgas_jokerInParameterList::constructor_new (_inLexique COMMA_HERE), var_cas_parameterPassingMode) ;
                    var_cas_outExpressionList._addAssign_operation (GGS_typeJokerInExpression::constructor_new (_inLexique COMMA_HERE)) ;
...
pr_semantic_instruction_semantics_parser_2636_6_ (galgas_scanner & _inLexique,
  ...
  { const GGS_AC_galgasType _var_103051 = var_cas_propertyType ; // CAST instruction
    if (_var_103051.getPtr () != NULL) {
      macroValidPointer (_var_103051.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_103051.getPtr ()) != NULL) {
        const GGS_typeGalgas_singleReferenceEntity var_cas_ref (_var_103051.getPtr ()) ;
        var_cas_entityName = var_cas_ref.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (2656)) ;
      }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_103051.getPtr ()) != NULL) {
        const GGS_typeGalgas_multipleReferenceEntity var_cas_ref (_var_103051.getPtr ()) ;
...
pr_instruction_beginning_with_identifier_semantics_parser_3200_6_ (galgas_scanner & _inLexique,
  ...
  { const GGS_AC_semanticsEntity _var_126622 = var_cas_entite ; // CAST instruction
    if (_var_126622.getPtr () != NULL) {
      macroValidPointer (_var_126622.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteRoutine *> (_var_126622.getPtr ()) != NULL) {
        const GGS_typeEntiteRoutine var_cas_r (_var_126622.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteActionExterne *> (_var_126622.getPtr ()) != NULL) {
        const GGS_typeEntiteActionExterne var_cas_ae (_var_126622.getPtr ()) ;
...
pr_semantic_instruction_semantics_parser_3628_6_ (galgas_scanner & _inLexique,
  ...
  const GGS_stringset _var_145081 = var_cas_missingConstants ;
  GGS_stringset::element_type * operand_145081 = _var_145081.firstObject () ;
  while ((operand_145081 != NULL)) {
    macroValidPointer (operand_145081) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_145081->mKey))._operator_concat (GGS_string (true, "' is not used in switch instruction")) COMMA_SOURCE_FILE_AT_LINE (3700)) ;
    operand_145081 = operand_145081->nextObject () ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_parse_match_operand_semantics_parser_4082_6_ (galgas_scanner & _inLexique,
  ...
  { const GGS_AC_galgasType _var_160442 = var_cas_type ; // CAST instruction
    if (_var_160442.getPtr () != NULL) {
      macroValidPointer (_var_160442.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_160442.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_t (_var_160442.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (_var_160442.getPtr ()) != NULL) {
        const GGS_typeGalgas_enum var_cas_e (_var_160442.getPtr ()) ;
...
pr_semantics_declaration_semantics_parser_4590_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_insertOrSearchMethodList _var_181872 = var_cas_insertMethodList ;
      GGS_insertOrSearchMethodList::element_type * operand_181872 = _var_181872.firstObject () ;
      while ((operand_181872 != NULL)) {
        macroValidPointer (operand_181872) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        const GGS_typeListeAttributsSemantiques _var_182055 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_182055 = _var_182055.firstObject () ;
        while ((operand_182055 != NULL)) {
          macroValidPointer (operand_182055) ;
          var_cas_methodSignature._addAssign_operation (operand_182055->mAttributType, var_cas_inPassingMode) ;
          operand_182055 = operand_182055->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_181872->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (4697)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_182484 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_182484 = _var_182484.firstObject () ;
        while ((operand_182484 != NULL)) {
          macroValidPointer (operand_182484) ;
          var_cas_methodSignature._addAssign_operation (operand_182484->mAttributType, var_cas_inPassingMode) ;
          operand_182484 = operand_182484->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, (operand_181872->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4705)))._operator_concat (GGS_string (true, "GetIndex")), operand_181872->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (4705)) COMMA_HERE) ;
        ...
        operand_181872 = operand_181872->nextObject () ;
      }
      const GGS_insertOrSearchMethodList _var_182845 = var_cas_searchMethodList ;
      GGS_insertOrSearchMethodList::element_type * operand_182845 = _var_182845.firstObject () ;
      while ((operand_182845 != NULL)) {
        macroValidPointer (operand_182845) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_183026 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_183026 = _var_183026.firstObject () ;
        while ((operand_183026 != NULL)) {
          macroValidPointer (operand_183026) ;
          var_cas_methodSignature._addAssign_operation (operand_183026->mAttributType, var_cas_outPassingMode) ;
          operand_183026 = operand_183026->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_182845->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (4715)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_183453 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_183453 = _var_183453.firstObject () ;
        while ((operand_183453 != NULL)) {
          macroValidPointer (operand_183453) ;
          var_cas_methodSignature._addAssign_operation (operand_183453->mAttributType, var_cas_outPassingMode) ;
          operand_183453 = operand_183453->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, (operand_182845->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4723)))._operator_concat (GGS_string (true, "GetIndex")), operand_182845->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (4723)) COMMA_HERE) ;
        ...
        operand_182845 = operand_182845->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_52 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              const GGS_typeListeAttributsSemantiques _var_186491 = var_cas_listeTousAttributsSemantiques ;
              GGS_typeListeAttributsSemantiques::element_type * operand_186491 = _var_186491.firstObject () ;
              while ((operand_186491 != NULL)) {
                macroValidPointer (operand_186491) ;
                var_cas_methodSignature._addAssign_operation (operand_186491->mAttributType, var_cas_outPassingMode) ;
                operand_186491 = operand_186491->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4790)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                const GGS_typeListeAttributsSemantiques _var_187079 = var_cas_listeTousAttributsSemantiques ;
                GGS_typeListeAttributsSemantiques::element_type * operand_187079 = _var_187079.firstObject () ;
                while ((operand_187079 != NULL)) {
                  macroValidPointer (operand_187079) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_187079->mAttributType, var_cas_outPassingMode) ;
                  operand_187079 = operand_187079->nextObject () ;
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              const GGS_typeListeAttributsSemantiques _var_188174 = var_cas_listeTousAttributsSemantiques ;
              GGS_typeListeAttributsSemantiques::element_type * operand_188174 = _var_188174.firstObject () ;
              while ((operand_188174 != NULL)) {
                macroValidPointer (operand_188174) ;
                var_cas_methodSignature._addAssign_operation (operand_188174->mAttributType, var_cas_inPassingMode) ;
                operand_188174 = operand_188174->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4827)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                const GGS_typeListeAttributsSemantiques _var_188777 = var_cas_listeTousAttributsSemantiques ;
                GGS_typeListeAttributsSemantiques::element_type * operand_188777 = _var_188777.firstObject () ;
                while ((operand_188777 != NULL)) {
                  macroValidPointer (operand_188777) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_188777->mAttributType, var_cas_inPassingMode) ;
                  operand_188777 = operand_188777->nextObject () ;
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              const GGS_typeListeAttributsSemantiques _var_189558 = var_cas_listeTousAttributsSemantiques ;
              GGS_typeListeAttributsSemantiques::element_type * operand_189558 = _var_189558.firstObject () ;
              while ((operand_189558 != NULL)) {
                macroValidPointer (operand_189558) ;
                var_cas_methodSignature._addAssign_operation (operand_189558->mAttributType, var_cas_outPassingMode) ;
                operand_189558 = operand_189558->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4854)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_190176 = _var_190176.firstObject () ;
                while ((operand_190176 != NULL)) {
                  macroValidPointer (operand_190176) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_190176->mAttributType, var_cas_outPassingMode) ;
...
pr_semantics_declaration_semantics_parser_4590_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      const GGS_insertOrSearchMethodList _var_194848 = var_cas_insertMethodList ;
      GGS_insertOrSearchMethodList::element_type * operand_194848 = _var_194848.firstObject () ;
      while ((operand_194848 != NULL)) {
        macroValidPointer (operand_194848) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_195031 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_195031 = _var_195031.firstObject () ;
        while ((operand_195031 != NULL)) {
          macroValidPointer (operand_195031) ;
          var_cas_methodSignature._addAssign_operation (operand_195031->mAttributType, var_cas_inPassingMode) ;
          operand_195031 = operand_195031->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_194848->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (4991)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_195460 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_195460 = _var_195460.firstObject () ;
        while ((operand_195460 != NULL)) {
          macroValidPointer (operand_195460) ;
          var_cas_methodSignature._addAssign_operation (operand_195460->mAttributType, var_cas_inPassingMode) ;
          operand_195460 = operand_195460->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, (operand_194848->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4999)))._operator_concat (GGS_string (true, "GetIndex")), operand_194848->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (4999)) COMMA_HERE) ;
        ...
        operand_194848 = operand_194848->nextObject () ;
      }
      const GGS_insertOrSearchMethodList _var_195821 = var_cas_searchMethodList ;
      GGS_insertOrSearchMethodList::element_type * operand_195821 = _var_195821.firstObject () ;
      while ((operand_195821 != NULL)) {
        macroValidPointer (operand_195821) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_196004 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_196004 = _var_196004.firstObject () ;
        while ((operand_196004 != NULL)) {
          macroValidPointer (operand_196004) ;
          var_cas_methodSignature._addAssign_operation (operand_196004->mAttributType, var_cas_outPassingMode) ;
          operand_196004 = operand_196004->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_195821->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5009)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        const GGS_typeListeAttributsSemantiques _var_196434 = var_cas_listeTousAttributsSemantiques ;
        GGS_typeListeAttributsSemantiques::element_type * operand_196434 = _var_196434.firstObject () ;
        while ((operand_196434 != NULL)) {
          macroValidPointer (operand_196434) ;
          var_cas_methodSignature._addAssign_operation (operand_196434->mAttributType, var_cas_outPassingMode) ;
          operand_196434 = operand_196434->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, (operand_195821->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5017)))._operator_concat (GGS_string (true, "GetIndex")), operand_195821->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (5017)) COMMA_HERE) ;
        ...
        operand_195821 = operand_195821->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_52 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              const GGS_typeListeAttributsSemantiques _var_198668 = var_cas_listeTousAttributsSemantiques ;
              GGS_typeListeAttributsSemantiques::element_type * operand_198668 = _var_198668.firstObject () ;
              while ((operand_198668 != NULL)) {
                macroValidPointer (operand_198668) ;
                var_cas_methodSignature._addAssign_operation (operand_198668->mAttributType, var_cas_outPassingMode) ;
                operand_198668 = operand_198668->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5072)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                const GGS_typeListeAttributsSemantiques _var_199212 = var_cas_listeTousAttributsSemantiques ;
                GGS_typeListeAttributsSemantiques::element_type * operand_199212 = _var_199212.firstObject () ;
                while ((operand_199212 != NULL)) {
                  macroValidPointer (operand_199212) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_199212->mAttributType, var_cas_outPassingMode) ;
                  operand_199212 = operand_199212->nextObject () ;
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              const GGS_typeListeAttributsSemantiques _var_199892 = var_cas_listeTousAttributsSemantiques ;
              GGS_typeListeAttributsSemantiques::element_type * operand_199892 = _var_199892.firstObject () ;
              while ((operand_199892 != NULL)) {
                macroValidPointer (operand_199892) ;
                var_cas_methodSignature._addAssign_operation (operand_199892->mAttributType, var_cas_inPassingMode) ;
                operand_199892 = operand_199892->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5100)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                const GGS_typeListeAttributsSemantiques _var_200435 = var_cas_listeTousAttributsSemantiques ;
                GGS_typeListeAttributsSemantiques::element_type * operand_200435 = _var_200435.firstObject () ;
                while ((operand_200435 != NULL)) {
                  macroValidPointer (operand_200435) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_200435->mAttributType, var_cas_inPassingMode) ;
                  operand_200435 = operand_200435->nextObject () ;
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              const GGS_typeListeAttributsSemantiques _var_201035 = var_cas_listeTousAttributsSemantiques ;
              GGS_typeListeAttributsSemantiques::element_type * operand_201035 = _var_201035.firstObject () ;
              while ((operand_201035 != NULL)) {
                macroValidPointer (operand_201035) ;
                var_cas_methodSignature._addAssign_operation (operand_201035->mAttributType, var_cas_outPassingMode) ;
                operand_201035 = operand_201035->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5123)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                const GGS_typeListeAttributsSemantiques _var_201619 = var_cas_listeTousAttributsSemantiques ;
                GGS_typeListeAttributsSemantiques::element_type * operand_201619 = _var_201619.firstObject () ;
                while ((operand_201619 != NULL)) {
                  macroValidPointer (operand_201619) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_201619->mAttributType, var_cas_outPassingMode) ;
                  operand_201619 = operand_201619->nextObject () ;
                }
...
pr_semantics_declaration_semantics_parser_5186_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_55 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_typeListeAttributsSemantiques _var_204934 = var_cas_listeTousAttributsSemantiques ;
      GGS_typeListeAttributsSemantiques::element_type * operand_204934 = _var_204934.firstObject () ;
      while ((operand_204934 != NULL)) {
        macroValidPointer (operand_204934) ;
        var_cas_extractSignature._addAssign_operation (operand_204934->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_204934->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_204934 = operand_204934->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_5186_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_55 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature ;
      var_cas_inputSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      const GGS_typeListeAttributsSemantiques _var_207134 = var_cas_listeTousAttributsSemantiques ;
      GGS_typeListeAttributsSemantiques::element_type * operand_207134 = _var_207134.firstObject () ;
      while ((operand_207134 != NULL)) {
        macroValidPointer (operand_207134) ;
        var_cas_extractSignature._addAssign_operation (operand_207134->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_207134->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_207134 = operand_207134->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_5301_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_56 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature ;
      var_cas_extractSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      const GGS_typeListeAttributsSemantiques _var_209696 = var_cas_listeTousAttributsSemantiques ;
      GGS_typeListeAttributsSemantiques::element_type * operand_209696 = _var_209696.firstObject () ;
      while ((operand_209696 != NULL)) {
        macroValidPointer (operand_209696) ;
        var_cas_extractSignature._addAssign_operation (operand_209696->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        operand_209696 = operand_209696->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_5301_6_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_56 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature ;
      var_cas_extractSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      const GGS_typeListeAttributsSemantiques _var_212707 = var_cas_listeTousAttributsSemantiques ;
      GGS_typeListeAttributsSemantiques::element_type * operand_212707 = _var_212707.firstObject () ;
      while ((operand_212707 != NULL)) {
        macroValidPointer (operand_212707) ;
        var_cas_extractSignature._addAssign_operation (operand_212707->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        operand_212707 = operand_212707->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasSortedListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_65 (_inLexique)) {
        case 2 : {
          ...
          const GGS_enumConstantMap _var_234336 = var_cas_constantMap ;
          GGS_enumConstantMap::element_type * operand_234336 = _var_234336.firstObject () ;
          while ((operand_234336 != NULL)) {
            macroValidPointer (operand_234336) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_234336->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5989)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            ...
            operand_234336 = operand_234336->nextObject () ;
          }
