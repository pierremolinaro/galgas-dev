...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    ...
    case 3 : {
      ...
      {
        GGS_mapStateList::cEnumerator enumerator_222961 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_222961 = NULL ;
        while (((operand_222961 = enumerator_222961.nextObject ()))) {
          macroValidPointer (operand_222961) ;
          var_cas_mapAutomatonStateMap.modifier_insertKey (inLexique, operand_222961->mStateName, var_cas_mapAutomatonStateMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (5983)) ;
        }
      }
      {
        GGS_mapStateList::cEnumerator enumerator_223092 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_223092 = NULL ;
        while (((operand_223092 = enumerator_223092.nextObject ()))) {
          macroValidPointer (operand_223092) ;
          {
            GGS_mapStateTransitionList::cEnumerator enumerator_223125 (operand_223092->mTransitionList, true) ;
            const GGS_mapStateTransitionList::cElement * operand_223125 = NULL ;
            while (((operand_223125 = enumerator_223125.nextObject ()))) {
              macroValidPointer (operand_223125) ;
              GGS_uint  automatic_var_223190_0 ;
              if (var_cas_mapAutomatonStateMap.isBuilt ()) {
                var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_223125->mTargetStateName, automatic_var_223190_0 COMMA_SOURCE_FILE_AT_LINE (5987)) ;
              }
            }
          }
        }
        ...
        while (syntaxRepeat_70) {
          switch (select_semantics_5F_parser_70 (inLexique)) {
            case 2 : {
              ...
              const GGS_bool cond_224316 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_224316.isBuiltAndTrue ()) {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_224571 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_224571 = NULL ;
                while (((operand_224571 = enumerator_224571.nextObject ()))) {
                  macroValidPointer (operand_224571) ;
                  var_cas_methodSignature.addAssign_operation (operand_224571->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_225125 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_225125 = NULL ;
                while (((operand_225125 = enumerator_225125.nextObject ()))) {
                  macroValidPointer (operand_225125) ;
                  var_cas_methodSignature.addAssign_operation (operand_225125->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              switch (select_semantics_5F_parser_71 (inLexique)) {
                case 1 : {
                  const GGS_bool cond_225660 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_225660.isBuiltAndTrue ()) {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_226602 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_226602 = NULL ;
                while (((operand_226602 = enumerator_226602.nextObject ()))) {
                  macroValidPointer (operand_226602) ;
                  var_cas_methodSignature.addAssign_operation (operand_226602->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              switch (select_semantics_5F_parser_73 (inLexique)) {
                case 1 : {
                  const GGS_bool cond_227201 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_227201.isBuiltAndTrue ()) {
                ...
                case 2 : {
                  ...
                  inLexique.assignFromAttribute_tokenString (var_cas_actionName) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                  const GGS_bool cond_227534 = (var_cas_mapAutomatonActionMap.reader_hasKey (var_cas_actionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6089)))).operator_not () ;
                  if (cond_227534.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_227534.isBuiltAndFalse ()) {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_227970 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_227970 = NULL ;
                while (((operand_227970 = enumerator_227970.nextObject ()))) {
                  macroValidPointer (operand_227970) ;
                  var_cas_methodSignature.addAssign_operation (operand_227970->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_228184 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_228184.isBuiltAndTrue ()) {
              ...
              }else if (cond_228184.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_228438 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_228438 = NULL ;
        while (((operand_228438 = enumerator_228438.nextObject ()))) {
          macroValidPointer (operand_228438) ;
          const GGS_bool cond_228870 = operand_228438->mInfo.mHasSetter ;
          if (cond_228870.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_228438->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6117)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_228438->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_229131 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_229131.isBuiltAndTrue ()) {
      ...
      {
        GGS_mapStateList::cEnumerator enumerator_229342 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_229342 = NULL ;
        while (((operand_229342 = enumerator_229342.nextObject ()))) {
          macroValidPointer (operand_229342) ;
          ...
          {
            GGS_mapStateTransitionList::cEnumerator enumerator_229515 (operand_229342->mTransitionList, true) ;
            const GGS_mapStateTransitionList::cElement * operand_229515 = NULL ;
            while (((operand_229515 = enumerator_229515.nextObject ()))) {
              macroValidPointer (operand_229515) ;
              GGS_uint  var_cas_actionIndex ;
              if (var_cas_mapAutomatonActionMap.isBuilt ()) {
                var_cas_mapAutomatonActionMap (HERE)->method_searchKey (inLexique, operand_229515->mActionName, var_cas_actionIndex COMMA_SOURCE_FILE_AT_LINE (6139)) ;
              }
              const GGS_bool cond_229796 = var_cas_actionsForCurrentState.reader_hasKey (operand_229515->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6140))) ;
              if (cond_229796.isBuiltAndTrue ()) {
                operand_229515->mActionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_229515->mActionName)).operator_concat (GGS_string ("' action is already used for this state")) COMMA_SOURCE_FILE_AT_LINE (6142)) ;
              }
              var_cas_actionsForCurrentState.addAssign_operation (operand_229515->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6143))) ;
              GGS_uint  var_cas_targetStateIndex ;
              if (var_cas_mapAutomatonStateMap.isBuilt ()) {
                var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_229515->mTargetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (6145)) ;
              }
              var_cas_mapStateTransitionSortedList.addAssign_operation (var_cas_actionIndex, operand_229515->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6148)), var_cas_targetStateIndex, operand_229515->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6150)), operand_229515->mTransitionMessageKind, operand_229515->mTransitionMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6152))) ;
            }
          }
          GGS_uint  var_cas_stateIndex ;
          if (var_cas_mapAutomatonStateMap.isBuilt ()) {
            var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_229342->mStateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (6156)) ;
          }
          var_cas_mapStateSortedList.addAssign_operation (var_cas_stateIndex, operand_229342->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6159)), operand_229342->mStateMessageKind, operand_229342->mStateMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6161)), var_cas_mapStateTransitionSortedList) ;
          ...
          const GGS_bool cond_230880 = (var_cas_missingActions.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
          if (cond_230880.isBuiltAndTrue ()) {
            GGS_string var_cas_s = GGS_string ("") ;
            {
              GGS_stringset::cEnumerator enumerator_230677 (var_cas_missingActions, true) ;
              if (enumerator_230677 .hasCurrentObject ()) {
                bool _foreach_loop_230677 ;
                do{
                  var_cas_s.appendCString ("'") ;
                  var_cas_s.dotAssign_operation (enumerator_230677._key (HERE)) ;
                  var_cas_s.appendCString ("'") ;
                  enumerator_230677.next () ;
                  _foreach_loop_230677 = (enumerator_230677 .hasCurrentObject ()) ;
                  if (_foreach_loop_230677) {
                    var_cas_s.appendCString (", ") ;
                  }
                }while (_foreach_loop_230677) ;
              }
            }
            operand_229342->mStateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the following actions are not named in a transition from this state: ")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (6172)) ;
          }
        }
      }
      GGS_stringset  var_cas_accessibleStates = var_cas_initialStateSet ;
      GGS_bool var_cas_progress = GGS_bool (true) ;
      GGS_uint _variant_231500 = var_cas_mapStateList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (6177)) ;
      GGS_bool _condition_231500 (_variant_231500.isBuilt (), true) ;
      while (_condition_231500.isBuiltAndTrue ()) {
        _condition_231500 = var_cas_progress ;
        if (_condition_231500.isBuiltAndTrue ()) {
          if (_variant_231500.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (6189)) ;
            _condition_231500 = GGS_bool (false) ;
          }else{
            _variant_231500.decrement_operation (inLexique COMMA_HERE) ;
            var_cas_progress = GGS_bool (false) ;
            {
              GGS_mapStateList::cEnumerator enumerator_231134 (var_cas_mapStateList, true) ;
              const GGS_mapStateList::cElement * operand_231134 = NULL ;
              while (((operand_231134 = enumerator_231134.nextObject ()))) {
                macroValidPointer (operand_231134) ;
                const GGS_bool cond_231467 = var_cas_accessibleStates.reader_hasKey (operand_231134->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6180))) ;
                if (cond_231467.isBuiltAndTrue ()) {
                  {
                    GGS_mapStateTransitionList::cEnumerator enumerator_231234 (operand_231134->mTransitionList, true) ;
                    const GGS_mapStateTransitionList::cElement * operand_231234 = NULL ;
                    while (((operand_231234 = enumerator_231234.nextObject ()))) {
                      macroValidPointer (operand_231234) ;
                      const GGS_bool cond_231426 = (var_cas_accessibleStates.reader_hasKey (operand_231234->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6182)))).operator_not () ;
                      if (cond_231426.isBuiltAndTrue ()) {
                        var_cas_accessibleStates.addAssign_operation (operand_231234->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6183))) ;
      ...
      const GGS_bool cond_231855 = (var_cas_uselessStates.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_231855.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_stringset::cEnumerator enumerator_231687 (var_cas_uselessStates, true) ;
          if (enumerator_231687 .hasCurrentObject ()) {
            bool _foreach_loop_231687 ;
            do{
              var_cas_s.appendCString ("'") ;
              var_cas_s.dotAssign_operation (enumerator_231687._key (HERE)) ;
              var_cas_s.appendCString ("'") ;
              enumerator_231687.next () ;
              _foreach_loop_231687 = (enumerator_231687 .hasCurrentObject ()) ;
              if (_foreach_loop_231687) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_231687) ;
          }
        }
      ...
      {
        GGS_EXmapAutomatonStateMap::cEnumerator enumerator_232077 (var_cas_mapAutomatonStateMap, true) ;
        const GGS_EXmapAutomatonStateMap::cElement * operand_232077 = NULL ;
        while (((operand_232077 = enumerator_232077.nextObject ()))) {
          macroValidPointer (operand_232077) ;
          GGS_stringset  var_cas_reachableStates = GGS_stringset ::constructor_emptySet () ;
          var_cas_reachableStates.addAssign_operation (operand_232077->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6205))) ;
          GGS_bool var_cas_progress = GGS_bool (true) ;
          GGS_uint _variant_232792 = var_cas_mapAutomatonStateMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (6207)) ;
          GGS_bool _condition_232792 (_variant_232792.isBuilt (), true) ;
          while (_condition_232792.isBuiltAndTrue ()) {
            _condition_232792 = var_cas_progress ;
            if (_condition_232792.isBuiltAndTrue ()) {
              if (_variant_232792.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (6220)) ;
                _condition_232792 = GGS_bool (false) ;
              }else{
                _variant_232792.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_progress = GGS_bool (false) ;
                {
                  GGS_mapStateList::cEnumerator enumerator_232320 (var_cas_mapStateList, true) ;
                  const GGS_mapStateList::cElement * operand_232320 = NULL ;
                  while (((operand_232320 = enumerator_232320.nextObject ()))) {
                    macroValidPointer (operand_232320) ;
                    const GGS_bool cond_232755 = var_cas_reachableStates.reader_hasKey (operand_232320->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6210))) ;
                    if (cond_232755.isBuiltAndTrue ()) {
                      {
                        GGS_mapStateTransitionList::cEnumerator enumerator_232423 (operand_232320->mTransitionList, true) ;
                        const GGS_mapStateTransitionList::cElement * operand_232423 = NULL ;
                        while (((operand_232423 = enumerator_232423.nextObject ()))) {
                          macroValidPointer (operand_232423) ;
                          const GGS_bool cond_232710 = (var_cas_reachableStates.reader_hasKey (operand_232423->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6212)))).operator_not () ;
                          if (cond_232710.isBuiltAndTrue ()) {
                            var_cas_reachableStates.addAssign_operation (operand_232423->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6213))) ;
                            var_cas_accessibilityGraph.addAssign_operation (((operand_232077->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6214))).operator_concat (GGS_string (":"))).operator_concat (operand_232423->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6214)))) ;
                            var_cas_progress = GGS_bool (true) ;
                          }
                        }
                      }
          ...
          {
            GGS_stringset::cEnumerator enumerator_232829 (var_cas_reachableStates, true) ;
            while (enumerator_232829.hasCurrentObject ()) {
              const GGS_bool cond_232942 = (operand_232077->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6222))).operator_isNotEqual (enumerator_232829._key (HERE)) ;
              if (cond_232942.isBuiltAndTrue ()) {
                var_cas_neededAssociations.addAssign_operation (((operand_232077->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6223))).operator_concat (GGS_string (":"))).operator_concat (enumerator_232829._key (HERE))) ;
              }
              enumerator_232829.next () ;
            }
          }
        }
      }
        ...
        while (syntaxRepeat_74) {
          switch (select_semantics_5F_parser_74 (inLexique)) {
            case 2 : {
                ...
                while (syntaxRepeat_75) {
                  switch (select_semantics_5F_parser_75 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_234086 = (var_cas_neededAssociations.reader_hasKey (var_cas_association)).operator_not () ;
                      if (cond_234086.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_234266 = var_cas_handledAssociations.reader_hasKey (var_cas_association) ;
                      if (cond_234266.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_235035 = (var_cas_startStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))).operator_isNotEqual (var_cas_finalStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))) ;
                      if (cond_235035.isBuiltAndTrue ()) {
                        ...
                        const GGS_bool cond_235018 = (var_cas_accessibilityGraph.reader_hasKey (((var_cas_startStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))).operator_concat (GGS_string (":"))).operator_concat (var_cas_finalStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))))).operator_not () ;
                        if (cond_235018.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_236451 = (var_cas_forgottenAssociations.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_236451.isBuiltAndTrue ()) {
                GGS_string var_cas_s = GGS_string ("") ;
                {
                  GGS_stringset::cEnumerator enumerator_236282 (var_cas_forgottenAssociations, true) ;
                  while (enumerator_236282.hasCurrentObject ()) {
                    var_cas_s.appendCString ("\n"
                      "  - ") ;
                    var_cas_s.dotAssign_operation (enumerator_236282._key (HERE)) ;
                    enumerator_236282.next () ;
                  }
                }
                ...
                while (syntaxRepeat_77) {
                  switch (select_semantics_5F_parser_77 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_237347 = (var_cas_neededCombinaisons.reader_hasKey (var_cas_combinaison)).operator_not () ;
                      if (cond_237347.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_237564 = var_cas_definedCombinaisons.reader_hasKey (var_cas_combinaison) ;
                      if (cond_237564.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_240257 = (var_cas_forgottenAssociations.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_240257.isBuiltAndTrue ()) {
                ...
                const GGS_bool cond_240242 = (var_cas_forgottenCombinaisons.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_240242.isBuiltAndTrue ()) {
                  GGS_string var_cas_s = GGS_string ("") ;
                  {
                    GGS_stringset::cEnumerator enumerator_240069 (var_cas_forgottenCombinaisons, true) ;
                    while (enumerator_240069.hasCurrentObject ()) {
                      var_cas_s.appendCString ("\n"
                        "  - ") ;
                      var_cas_s.dotAssign_operation (enumerator_240069._key (HERE)) ;
                      enumerator_240069.next () ;
                    }
                  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_242028 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432))))).operator_not () ;
      if (cond_242028.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_244960 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_244960 = NULL ;
        while (((operand_244960 = enumerator_244960.nextObject ()))) {
          macroValidPointer (operand_244960) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245137 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245137 = NULL ;
            while (((operand_245137 = enumerator_245137.nextObject ()))) {
              macroValidPointer (operand_245137) ;
              var_cas_methodSignature.addAssign_operation (operand_245137->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_244960->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6523)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245539 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245539 = NULL ;
            while (((operand_245539 = enumerator_245539.nextObject ()))) {
              macroValidPointer (operand_245539) ;
              var_cas_methodSignature.addAssign_operation (operand_245539->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_244960->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6531))).operator_concat (GGS_string ("GetIndex")), operand_244960->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6531)) COMMA_SOURCE_FILE_AT_LINE (6531)) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_245867 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_245867 = NULL ;
        while (((operand_245867 = enumerator_245867.nextObject ()))) {
          macroValidPointer (operand_245867) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246044 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246044 = NULL ;
            while (((operand_246044 = enumerator_246044.nextObject ()))) {
              macroValidPointer (operand_246044) ;
              var_cas_methodSignature.addAssign_operation (operand_246044->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_245867->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6541)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246447 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246447 = NULL ;
            while (((operand_246447 = enumerator_246447.nextObject ()))) {
              macroValidPointer (operand_246447) ;
              var_cas_methodSignature.addAssign_operation (operand_246447->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_245867->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6549))).operator_concat (GGS_string ("GetIndex")), operand_245867->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6549)) COMMA_SOURCE_FILE_AT_LINE (6549)) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_70) {
          switch (select_semantics_5F_parser_70 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_250561 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_250561 = NULL ;
                while (((operand_250561 = enumerator_250561.nextObject ()))) {
                  macroValidPointer (operand_250561) ;
                  var_cas_methodSignature.addAssign_operation (operand_250561->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_remove) COMMA_HERE) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  automatic_var_250841_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, automatic_var_250841_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251048 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251048 = NULL ;
                while (((operand_251048 = enumerator_251048.nextObject ()))) {
                  macroValidPointer (operand_251048) ;
                  var_cas_methodSignature.addAssign_operation (operand_251048->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251739 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251739 = NULL ;
                while (((operand_251739 = enumerator_251739.nextObject ()))) {
                  macroValidPointer (operand_251739) ;
                  var_cas_methodSignature.addAssign_operation (operand_251739->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_252345 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_252345 = NULL ;
                while (((operand_252345 = enumerator_252345.nextObject ()))) {
                  macroValidPointer (operand_252345) ;
                  var_cas_methodSignature.addAssign_operation (operand_252345->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_252559 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              ...
              }else if (cond_252559.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_252726 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_252726 = NULL ;
        while (((operand_252726 = enumerator_252726.nextObject ()))) {
          macroValidPointer (operand_252726) ;
          const GGS_bool cond_253158 = operand_252726->mInfo.mHasSetter ;
          if (cond_253158.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_252726->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6728)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_252726->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_253419 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_253419.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_257683 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_257683 = NULL ;
    while (((operand_257683 = enumerator_257683.nextObject ()))) {
      macroValidPointer (operand_257683) ;
      GGS_string var_cas_keyClassMethod = ((operand_257683->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))) ;
      const GGS_bool cond_257980 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6873)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_257980.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_257683->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6876)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_259615 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)))).operator_not () ;
  if (cond_259615.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_263119 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (6972))) ;
  if (cond_263119.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_262161 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_262161 = NULL ;
      while (((operand_262161 = enumerator_262161.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_262161) ;
        GGS_string var_cas_keyClassMethod = ((operand_262161->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))) ;
        var_cas_baseClassName = operand_262161->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6977)) ;
        ...
        const GGS_bool cond_262899 = var_cas_found ;
        if (cond_262899.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_262568 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          if (temp_262568.isBuilt ()) {
            temp_262568 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (6982)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          }
    ...
    const GGS_bool cond_263107 = (var_cas_found).operator_not () ;
    if (cond_263107.isBuiltAndTrue ()) {
  ...
  }else if (cond_263119.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_263196 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_263196 = NULL ;
      while (((operand_263196 = enumerator_263196.nextObject ()))) {
        macroValidPointer (operand_263196) ;
        GGS_string var_cas_keyClassMethod = ((operand_263196->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))) ;
        const GGS_bool cond_263502 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6998)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_263502.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_263196->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7001)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_263655 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7006)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_263655 = NULL ;
    while (((operand_263655 = enumerator_263655.nextObject ()))) {
      macroValidPointer (operand_263655) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7008)), operand_263655->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7009)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7007)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_263655->mAttributeName, operand_263655->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7013)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_266173 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)))).operator_not () ;
  if (cond_266173.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_269120 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_269120 = NULL ;
    while (((operand_269120 = enumerator_269120.nextObject ()))) {
      macroValidPointer (operand_269120) ;
      GGS_string var_cas_keyClassMethod = ((operand_269120->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))) ;
      const GGS_bool cond_269417 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7137)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_269417.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_269120->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7140)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_271536 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)))).operator_not () ;
  if (cond_271536.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_276124 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7256))) ;
  if (cond_276124.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_274823 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_274823 = NULL ;
      while (((operand_274823 = enumerator_274823.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_274823) ;
        GGS_string var_cas_keyClassMethod = ((operand_274823->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))) ;
        var_cas_baseClassName = operand_274823->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7261)) ;
        ...
        const GGS_bool cond_275904 = var_cas_found ;
        if (cond_275904.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_275287 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          if (temp_275287.isBuilt ()) {
            temp_275287 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7268)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          }
    ...
    const GGS_bool cond_276112 = (var_cas_found).operator_not () ;
    if (cond_276112.isBuiltAndTrue ()) {
  ...
  }else if (cond_276124.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_276201 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_276201 = NULL ;
      while (((operand_276201 = enumerator_276201.nextObject ()))) {
        macroValidPointer (operand_276201) ;
        GGS_string var_cas_keyClassMethod = ((operand_276201->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))) ;
        const GGS_bool cond_276507 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7294)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_276507.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_276201->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7297)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276660 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7302)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_276660 = NULL ;
    while (((operand_276660 = enumerator_276660.nextObject ()))) {
      macroValidPointer (operand_276660) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7304)), operand_276660->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7305)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7303)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_276660->mAttributeName, operand_276660->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7309)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_279661 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)))).operator_not () ;
  if (cond_279661.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_282117 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_282117 = NULL ;
    while (((operand_282117 = enumerator_282117.nextObject ()))) {
      macroValidPointer (operand_282117) ;
      GGS_string var_cas_keyClassMethod = ((operand_282117->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))) ;
      const GGS_bool cond_282422 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7436)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_282422.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_282117->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7439)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_284127 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)))).operator_not () ;
  if (cond_284127.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_287871 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7539))) ;
  if (cond_287871.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_286842 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_286842 = NULL ;
      while (((operand_286842 = enumerator_286842.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_286842) ;
        GGS_string var_cas_keyClassMethod = ((operand_286842->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))) ;
        var_cas_baseClassName = operand_286842->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7544)) ;
        ...
        const GGS_bool cond_287647 = var_cas_found ;
        if (cond_287647.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_287255 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          if (temp_287255.isBuilt ()) {
            temp_287255 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7550)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          }
    ...
    const GGS_bool cond_287859 = (var_cas_found).operator_not () ;
    if (cond_287859.isBuiltAndTrue ()) {
  ...
  }else if (cond_287871.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_287948 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_287948 = NULL ;
      while (((operand_287948 = enumerator_287948.nextObject ()))) {
        macroValidPointer (operand_287948) ;
        GGS_string var_cas_keyClassMethod = ((operand_287948->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))) ;
        const GGS_bool cond_288262 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7569)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_288262.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_287948->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7572)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_288415 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7577)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_288415 = NULL ;
    while (((operand_288415 = enumerator_288415.nextObject ()))) {
      macroValidPointer (operand_288415) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7579)), operand_288415->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7580)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7578)) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_288415->mAttributeName, operand_288415->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7584)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_291229 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)))).operator_not () ;
  if (cond_291229.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_292537 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687))))).operator_not () ;
      if (cond_292537.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_293229 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_293229 = NULL ;
        while (((operand_293229 = enumerator_293229.nextObject ()))) {
          macroValidPointer (operand_293229) ;
          var_cas_extractSignature.addAssign_operation (operand_293229->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7709))) ;
          var_cas_inputSignature.addAssign_operation (operand_293229->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7710))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_294676 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742))))).operator_not () ;
      if (cond_294676.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_295368 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_295368 = NULL ;
        while (((operand_295368 = enumerator_295368.nextObject ()))) {
          macroValidPointer (operand_295368) ;
          var_cas_extractSignature.addAssign_operation (operand_295368->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7764))) ;
          var_cas_inputSignature.addAssign_operation (operand_295368->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7765))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_297232 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802))))).operator_not () ;
      if (cond_297232.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_297876 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_297876 = NULL ;
        while (((operand_297876 = enumerator_297876.nextObject ()))) {
          macroValidPointer (operand_297876) ;
          var_cas_extractSignature.addAssign_operation (operand_297876->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7823))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_85 = true ;
        while (syntaxRepeat_85) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_298567 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7839))) ;
            if (cond_298567.isBuiltAndTrue ()) {
            ...
            }else if (cond_298567.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_298679_0 ;
              GGS_bool automatic_var_298679_1 ;
              if (var_cas_tableAttributs.isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_298679_0, automatic_var_298679_1 COMMA_SOURCE_FILE_AT_LINE (7843)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_300194 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883))))).operator_not () ;
      if (cond_300194.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_300838 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_300838 = NULL ;
        while (((operand_300838 = enumerator_300838.nextObject ()))) {
          macroValidPointer (operand_300838) ;
          var_cas_extractSignature.addAssign_operation (operand_300838->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7904))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_89 = true ;
                while (syntaxRepeat_89) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_303276 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7971))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_303276.isBuiltAndTrue ()) {
                      const GGS_bool cond_303226 = (var_cas_hasGetter).operator_not () ;
                      if (cond_303226.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_303276.isBuiltAndFalse ()) {
                      const GGS_bool cond_303478 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7976))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_303478.isBuiltAndTrue ()) {
                        const GGS_bool cond_303430 = var_cas_hasSetter ;
                        if (cond_303430.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_303478.isBuiltAndFalse ()) {
...
void routine_recursivelyEnumerateDirectoriesEX (C_CompilerEx & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311037 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_311037 = NULL ;
    while (((operand_311037 = enumerator_311037.nextObject ()))) {
      macroValidPointer (operand_311037) ;
      const GGS_bool cond_311544 = var_cas_inExtensionMap.reader_hasKey (operand_311037->mValue.reader_pathExtension ()) ;
      if (cond_311544.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311037->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_311037->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_311037->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8181)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (8180)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311781 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_311781 = NULL ;
    while (((operand_311781 = enumerator_311781.nextObject ()))) {
      macroValidPointer (operand_311781) ;
      ...
      ::routine_recursivelyEnumerateDirectoriesEX (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311781->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_311781->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (8195)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_311781->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_313574 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_313574.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8248)) ;
  }else if (cond_313574.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_313854 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_313854.isBuiltAndTrue ()) {
  ...
  }else if (cond_313854.isBuiltAndFalse ()) {
            ...
            while (syntaxRepeat_93) {
              switch (select_semantics_5F_parser_93 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_316184 = var_cas_parameterIsUsed ;
                  if (cond_316184.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_316184.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_318915 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)))).operator_not () ;
  if (cond_318915.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_318121 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_318121.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8385)) ;
    }else if (cond_318121.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_318411 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_318411.isBuiltAndTrue ()) {
    ...
    }else if (cond_318411.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedListEX  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedListEX  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_319974 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)))).operator_not () ;
  if (cond_319974.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_325584 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_325584.isBuiltAndTrue ()) {
              ...
              }else if (cond_325584.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_95 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_329841 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_329841.isBuiltAndTrue ()) {
              ...
              }else if (cond_329841.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_98 = true ;
                while (syntaxRepeat_98) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i79_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_331773 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8772))) ;
  if (cond_331773.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_331773.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i80_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_332606 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8795))) ;
  if (cond_332606.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_332606.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_333576 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8820))) ;
  if (cond_333576.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_333576.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_334561 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8846))) ;
  if (cond_334561.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_334561.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_336107_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_336107_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_338569_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_338569_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_338778 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_338778 = NULL ;
    while (((operand_338778 = enumerator_338778.nextObject ()))) {
      macroValidPointer (operand_338778) ;
      const GGS_bool cond_338997 = (operand_338778->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8959))) ;
      if (cond_338997.isBuiltAndTrue ()) {
        operand_338778->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8961)) ;
      }else if (cond_338997.isBuiltAndFalse ()) {
        const GGS_bool cond_339206 = (operand_338778->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8961))) ;
        if (cond_339206.isBuiltAndTrue ()) {
          operand_338778->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8963)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_341057 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_341057 = NULL ;
    while (((operand_341057 = enumerator_341057.nextObject ()))) {
      macroValidPointer (operand_341057) ;
      const GGS_bool cond_341276 = (operand_341057->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9013))) ;
      if (cond_341276.isBuiltAndTrue ()) {
        operand_341057->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9015)) ;
      }else if (cond_341276.isBuiltAndFalse ()) {
        const GGS_bool cond_341485 = (operand_341057->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9015))) ;
        if (cond_341485.isBuiltAndTrue ()) {
          operand_341057->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9017)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_99 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_enumConstantMap::cEnumerator enumerator_343781 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_343781 = enumerator_343781.nextObject () ;
        if ((operand_343781 != NULL)) {
          bool _foreach_loop_343781 ;
          do{
            macroValidPointer (operand_343781) ;
            var_cas_s.dotAssign_operation (operand_343781->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9084))) ;
            operand_343781 = enumerator_343781.nextObject () ;
            _foreach_loop_343781 = ((operand_343781 != NULL)) ;
            if (_foreach_loop_343781) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_343781) ;
        }
      }
    ...
    while (syntaxRepeat_103) {
      switch (select_semantics_5F_parser_103 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_344601 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_344601 = NULL ;
            while (((operand_344601 = enumerator_344601.nextObject ()))) {
              macroValidPointer (operand_344601) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_344601->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9116)), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (9116)) ;
              GGS_lstring  var_cas_cstString ;
