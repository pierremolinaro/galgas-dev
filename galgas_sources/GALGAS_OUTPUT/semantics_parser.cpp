...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i63_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_63 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_217470 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5837)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5838))))).operator_not () ;
      if (cond_217470.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedMapindexType ::constructor_new (inLexique, var_cas_mapindexTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_217632 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_217632.isBuilt ()) {
        temp_217632 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5847)) ;
      }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i64_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_65 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_220209 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5904)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5905))))).operator_not () ;
      if (cond_220209.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_223158 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_223158 = NULL ;
        while (((operand_223158 = enumerator_223158.nextObject ()))) {
          macroValidPointer (operand_223158) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_223335 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_223335 = NULL ;
            while (((operand_223335 = enumerator_223335.nextObject ()))) {
              macroValidPointer (operand_223335) ;
              var_cas_methodSignature.addAssign_operation (operand_223335->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_223158->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5997)) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_223737 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_223737 = NULL ;
            while (((operand_223737 = enumerator_223737.nextObject ()))) {
              macroValidPointer (operand_223737) ;
              var_cas_methodSignature.addAssign_operation (operand_223737->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_223158->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6005))).operator_concat (GGS_string ("GetIndex")), operand_223158->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6005)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_224065 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_224065 = NULL ;
        while (((operand_224065 = enumerator_224065.nextObject ()))) {
          macroValidPointer (operand_224065) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_224240 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_224240 = NULL ;
            while (((operand_224240 = enumerator_224240.nextObject ()))) {
              macroValidPointer (operand_224240) ;
              var_cas_methodSignature.addAssign_operation (operand_224240->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_224065->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6015)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_224640 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_224640 = NULL ;
            while (((operand_224640 = enumerator_224640.nextObject ()))) {
              macroValidPointer (operand_224640) ;
              var_cas_methodSignature.addAssign_operation (operand_224640->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_224065->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6023))).operator_concat (GGS_string ("GetIndex")), operand_224065->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6023)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_68) {
          switch (select_semantics_5F_parser_68 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228019 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_228019 = NULL ;
                while (((operand_228019 = enumerator_228019.nextObject ()))) {
                  macroValidPointer (operand_228019) ;
                  var_cas_methodSignature.addAssign_operation (operand_228019->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_228857 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6102))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_228857.isBuiltAndTrue ()) {
                ...
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228573 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_228573 = NULL ;
                  while (((operand_228573 = enumerator_228573.nextObject ()))) {
                    macroValidPointer (operand_228573) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_228573->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229634 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_229634 = NULL ;
                while (((operand_229634 = enumerator_229634.nextObject ()))) {
                  macroValidPointer (operand_229634) ;
                  var_cas_methodSignature.addAssign_operation (operand_229634->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_230502 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6139))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_230502.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230203 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_230203 = NULL ;
                  while (((operand_230203 = enumerator_230203.nextObject ()))) {
                    macroValidPointer (operand_230203) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_230203->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230950 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_230950 = NULL ;
                while (((operand_230950 = enumerator_230950.nextObject ()))) {
                  macroValidPointer (operand_230950) ;
                  var_cas_methodSignature.addAssign_operation (operand_230950->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_231815 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6166))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_231815.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_231534 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_231534 = NULL ;
                  while (((operand_231534 = enumerator_231534.nextObject ()))) {
                    macroValidPointer (operand_231534) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_231534->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_231900 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_231900 = NULL ;
        while (((operand_231900 = enumerator_231900.nextObject ()))) {
          macroValidPointer (operand_231900) ;
          const GGS_bool cond_232331 = operand_231900->mInfo.mHasSetter ;
          if (cond_232331.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_231900->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6180)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_231900->mInfo.mAttributType, var_cas_inPassingMode) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i64_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_65 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_233853 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6225)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6225))))).operator_not () ;
      if (cond_233853.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedMapType ::constructor_new (inLexique, var_cas_mapTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType = GGS_typeGalgas_luint ::constructor_new (inLexique COMMA_HERE) ;
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_236755 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_236755 = NULL ;
        while (((operand_236755 = enumerator_236755.nextObject ()))) {
          macroValidPointer (operand_236755) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_236932 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_236932 = NULL ;
            while (((operand_236932 = enumerator_236932.nextObject ()))) {
              macroValidPointer (operand_236932) ;
              var_cas_methodSignature.addAssign_operation (operand_236932->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_236755->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6316)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_237334 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_237334 = NULL ;
            while (((operand_237334 = enumerator_237334.nextObject ()))) {
              macroValidPointer (operand_237334) ;
              var_cas_methodSignature.addAssign_operation (operand_237334->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_236755->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6324))).operator_concat (GGS_string ("GetIndex")), operand_236755->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6324)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_237662 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_237662 = NULL ;
        while (((operand_237662 = enumerator_237662.nextObject ()))) {
          macroValidPointer (operand_237662) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_237839 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_237839 = NULL ;
            while (((operand_237839 = enumerator_237839.nextObject ()))) {
              macroValidPointer (operand_237839) ;
              var_cas_methodSignature.addAssign_operation (operand_237839->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_237662->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6334)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_238242 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_238242 = NULL ;
            while (((operand_238242 = enumerator_238242.nextObject ()))) {
              macroValidPointer (operand_238242) ;
              var_cas_methodSignature.addAssign_operation (operand_238242->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_237662->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6342))).operator_concat (GGS_string ("GetIndex")), operand_237662->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6342)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_68) {
          switch (select_semantics_5F_parser_68 (inLexique)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  automatic_var_240379_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, var_cas_getIndexMethodName, automatic_var_240379_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_240586 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_240586 = NULL ;
                while (((operand_240586 = enumerator_240586.nextObject ()))) {
                  macroValidPointer (operand_240586) ;
                  var_cas_methodSignature.addAssign_operation (operand_240586->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_241297 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6405))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_241297.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_241096 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_241096 = NULL ;
                  while (((operand_241096 = enumerator_241096.nextObject ()))) {
                    macroValidPointer (operand_241096) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_241096->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  automatic_var_241449_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, var_cas_getIndexMethodName, automatic_var_241449_0) ;
              switch (select_semantics_5F_parser_69 (inLexique)) {
                case 1 : {
                  } break ;
                case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_241742 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_241742 = NULL ;
                while (((operand_241742 = enumerator_241742.nextObject ()))) {
                  macroValidPointer (operand_241742) ;
                  var_cas_methodSignature.addAssign_operation (operand_241742->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_242452 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6433))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_242452.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_242251 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_242251 = NULL ;
                  while (((operand_242251 = enumerator_242251.nextObject ()))) {
                    macroValidPointer (operand_242251) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_242251->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  automatic_var_242604_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, var_cas_getIndexMethodName, automatic_var_242604_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_242817 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_242817 = NULL ;
                while (((operand_242817 = enumerator_242817.nextObject ()))) {
                  macroValidPointer (operand_242817) ;
                  var_cas_methodSignature.addAssign_operation (operand_242817->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              const GGS_bool cond_243566 = (var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6456))).operator_isNotEqual (GGS_string ("")) ;
              if (cond_243566.isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_243367 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_243367 = NULL ;
                  while (((operand_243367 = enumerator_243367.nextObject ()))) {
                    macroValidPointer (operand_243367) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_243367->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_243651 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_243651 = NULL ;
        while (((operand_243651 = enumerator_243651.nextObject ()))) {
          macroValidPointer (operand_243651) ;
          const GGS_bool cond_244082 = operand_243651->mInfo.mHasSetter ;
          if (cond_244082.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_243651->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6469)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_243651->mInfo.mAttributType, var_cas_inPassingMode) ;
            var_cas_modifierSignature.addAssign_operation (GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_inPassingMode) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_247153 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_247153.isBuilt ()) {
    temp_247153 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6560)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_247622 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_247622 = NULL ;
    while (((operand_247622 = enumerator_247622.nextObject ()))) {
      macroValidPointer (operand_247622) ;
      GGS_string var_cas_keyClassMethod = ((operand_247622->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6568))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6568))) ;
      const GGS_bool cond_247917 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6569)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_247917.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_247622->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6572)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_249551 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6614)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6614)))).operator_not () ;
  if (cond_249551.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_251502 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_251502.isBuilt ()) {
    temp_251502 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6662)) ;
  }
  ...
  const GGS_bool cond_253052 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE)) ;
  if (cond_253052.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_252096 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_252096 = NULL ;
      while (((operand_252096 = enumerator_252096.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_252096) ;
        GGS_string var_cas_keyClassMethod = ((operand_252096->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6672))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6672))) ;
        var_cas_baseClassName = operand_252096->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6673)) ;
        ...
        const GGS_bool cond_252832 = var_cas_found ;
        if (cond_252832.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_252501 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6678)) ;
          if (temp_252501.isBuilt ()) {
            temp_252501 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6678)) ;
          }
    ...
    const GGS_bool cond_253040 = (var_cas_found).operator_not () ;
    if (cond_253040.isBuiltAndTrue ()) {
  ...
  }else if (cond_253052.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_253129 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_253129 = NULL ;
      while (((operand_253129 = enumerator_253129.nextObject ()))) {
        macroValidPointer (operand_253129) ;
        GGS_string var_cas_keyClassMethod = ((operand_253129->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6693))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6693))) ;
        const GGS_bool cond_253433 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6694)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_253433.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_253129->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6697)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_253586 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6702)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_253586 = NULL ;
    while (((operand_253586 = enumerator_253586.nextObject ()))) {
      macroValidPointer (operand_253586) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6704)), operand_253586->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6705)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_253586->mAttributeName, operand_253586->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6709)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_256103 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6769)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6769)))).operator_not () ;
  if (cond_256103.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_258055 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_258055.isBuilt ()) {
    temp_258055 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6818)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_258580 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_258580.isBuilt ()) {
    temp_258580 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6824)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_259049 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_259049 = NULL ;
    while (((operand_259049 = enumerator_259049.nextObject ()))) {
      macroValidPointer (operand_259049) ;
      GGS_string var_cas_keyClassMethod = ((operand_259049->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6832))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6832))) ;
      const GGS_bool cond_259344 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6833)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_259344.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_259049->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6836)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_260971 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_260971.isBuilt ()) {
    temp_260971 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6884)) ;
  }
  ...
  const GGS_bool cond_261462 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6888)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6888)))).operator_not () ;
  if (cond_261462.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_263276 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_263276.isBuilt ()) {
    temp_263276 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6936)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_264154 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_264154.isBuilt ()) {
    temp_264154 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6946)) ;
  }
  ...
  const GGS_bool cond_266047 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE)) ;
  if (cond_266047.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_264748 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_264748 = NULL ;
      while (((operand_264748 = enumerator_264748.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_264748) ;
        GGS_string var_cas_keyClassMethod = ((operand_264748->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6956))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6956))) ;
        var_cas_baseClassName = operand_264748->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6957)) ;
        ...
        const GGS_bool cond_265827 = var_cas_found ;
        if (cond_265827.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_265210 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6963)) ;
          if (temp_265210.isBuilt ()) {
            temp_265210 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (6963)) ;
          }
    ...
    const GGS_bool cond_266035 = (var_cas_found).operator_not () ;
    if (cond_266035.isBuiltAndTrue ()) {
  ...
  }else if (cond_266047.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_266124 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_266124 = NULL ;
      while (((operand_266124 = enumerator_266124.nextObject ()))) {
        macroValidPointer (operand_266124) ;
        GGS_string var_cas_keyClassMethod = ((operand_266124->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6989))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6989))) ;
        const GGS_bool cond_266428 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6990)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_266428.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_266124->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6993)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_266581 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6998)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_266581 = NULL ;
    while (((operand_266581 = enumerator_266581.nextObject ()))) {
      macroValidPointer (operand_266581) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7000)), operand_266581->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7001)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_266581->mAttributeName, operand_266581->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7005)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_269090 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_269090.isBuilt ()) {
    temp_269090 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7071)) ;
  }
  ...
  const GGS_bool cond_269581 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7075)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7075)))).operator_not () ;
  if (cond_269581.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_271567 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_271567.isBuilt ()) {
    temp_271567 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7123)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_272036 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_272036 = NULL ;
    while (((operand_272036 = enumerator_272036.nextObject ()))) {
      macroValidPointer (operand_272036) ;
      GGS_string var_cas_keyClassMethod = ((operand_272036->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7131))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7131))) ;
      const GGS_bool cond_272339 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7132)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_272339.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_272036->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7135)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_274043 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7178)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7178)))).operator_not () ;
  if (cond_274043.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_276161 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_276161.isBuilt ()) {
    temp_276161 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7229)) ;
  }
  ...
  const GGS_bool cond_277782 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE)) ;
  if (cond_277782.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_276755 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_276755 = NULL ;
      while (((operand_276755 = enumerator_276755.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_276755) ;
        GGS_string var_cas_keyClassMethod = ((operand_276755->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7239))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7239))) ;
        var_cas_baseClassName = operand_276755->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7240)) ;
        ...
        const GGS_bool cond_277558 = var_cas_found ;
        if (cond_277558.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_277166 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7245)) ;
          if (temp_277166.isBuilt ()) {
            temp_277166 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7245)) ;
          }
    ...
    const GGS_bool cond_277770 = (var_cas_found).operator_not () ;
    if (cond_277770.isBuiltAndTrue ()) {
  ...
  }else if (cond_277782.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_277859 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_277859 = NULL ;
      while (((operand_277859 = enumerator_277859.nextObject ()))) {
        macroValidPointer (operand_277859) ;
        GGS_string var_cas_keyClassMethod = ((operand_277859->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7264))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7264))) ;
        const GGS_bool cond_278171 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7265)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_278171.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_277859->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7268)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_278324 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7273)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_278324 = NULL ;
    while (((operand_278324 = enumerator_278324.nextObject ()))) {
      macroValidPointer (operand_278324) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7275)), operand_278324->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7276)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_278324->mAttributeName, operand_278324->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7280)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_281137 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7349)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7349)))).operator_not () ;
  if (cond_281137.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i73_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_75 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_282445 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7383)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7383))))).operator_not () ;
      if (cond_282445.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_283137 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_283137 = NULL ;
        while (((operand_283137 = enumerator_283137.nextObject ()))) {
          macroValidPointer (operand_283137) ;
          var_cas_extractSignature.addAssign_operation (operand_283137->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_283137->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i73_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_75 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_284584 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7438)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7438))))).operator_not () ;
      if (cond_284584.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedListType ::constructor_new (inLexique, var_cas_listTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_285276 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_285276 = NULL ;
        while (((operand_285276 = enumerator_285276.nextObject ()))) {
          macroValidPointer (operand_285276) ;
          var_cas_extractSignature.addAssign_operation (operand_285276->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_285276->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i74_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_76 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_287140 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7498)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7498))))).operator_not () ;
      if (cond_287140.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_287784 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_287784 = NULL ;
        while (((operand_287784 = enumerator_287784.nextObject ()))) {
          macroValidPointer (operand_287784) ;
          var_cas_extractSignature.addAssign_operation (operand_287784->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_77 = true ;
        while (syntaxRepeat_77) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_288475 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7535))) ;
            if (cond_288475.isBuiltAndTrue ()) {
            ...
            }else if (cond_288475.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_288587_0 ;
              GGS_bool automatic_var_288587_1 ;
              const GGS_typeSemanticAttributesMap  temp_288549 = var_cas_tableAttributs ;
              if (temp_288549.isBuilt ()) {
                temp_288549 (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_288587_0, automatic_var_288587_1 COMMA_SOURCE_FILE_AT_LINE (7539)) ;
              }
              const GGS_AC_galgasType  temp_288653 = var_cas_definitionType ;
              if (temp_288653.isBuilt ()) {
                temp_288653 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (7540)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i74_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_76 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_290102 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7579)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7579))))).operator_not () ;
      if (cond_290102.isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedSortedListType ::constructor_new (inLexique, var_cas_listTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_290746 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_290746 = NULL ;
        while (((operand_290746 = enumerator_290746.nextObject ()))) {
          macroValidPointer (operand_290746) ;
          var_cas_extractSignature.addAssign_operation (operand_290746->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasSortedListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_81 = true ;
                while (syntaxRepeat_81) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_293184 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7667))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_293184.isBuiltAndTrue ()) {
                      const GGS_bool cond_293134 = (var_cas_hasGetter).operator_not () ;
                      if (cond_293134.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_293184.isBuiltAndFalse ()) {
                      const GGS_bool cond_293386 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7672))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_293386.isBuiltAndTrue ()) {
                        const GGS_bool cond_293338 = var_cas_hasSetter ;
                        if (cond_293338.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_293386.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_294916 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_294916.isBuilt ()) {
    temp_294916 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7715)) ;
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_296197 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_296197.isBuilt ()) {
    temp_296197 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7749)) ;
  }
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_300933 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_300933 = NULL ;
    while (((operand_300933 = enumerator_300933.nextObject ()))) {
      macroValidPointer (operand_300933) ;
      const GGS_bool cond_301440 = var_cas_inExtensionMap.reader_hasKey (operand_300933->mValue.reader_pathExtension ()) ;
      if (cond_301440.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_300933->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_300933->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_300933->mValue), GGS_location (inLexique) COMMA_HERE), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (7876)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_301675 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_301675 = NULL ;
    while (((operand_301675 = enumerator_301675.nextObject ()))) {
      macroValidPointer (operand_301675) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_301675->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_301675->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (7891)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_301675->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i78_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_303458 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_303458.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7944)) ;
  }else if (cond_303458.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_303738 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_303738.isBuiltAndTrue ()) {
  ...
  }else if (cond_303738.isBuiltAndFalse ()) {
            ...
            while (syntaxRepeat_85) {
              switch (select_semantics_5F_parser_85 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_306060 = var_cas_parameterIsUsed ;
                  if (cond_306060.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_306060.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i78_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  GGS_M_regularFiles  var_cas_regularFileMap = GGS_M_regularFiles ::constructor_emptyMap (inLexique COMMA_HERE) ;
  const GGS_bool cond_308780 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8077)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8077)))).operator_not () ;
  if (cond_308780.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_307992 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_307992.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8081)) ;
    }else if (cond_307992.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_308282 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_308282.isBuiltAndTrue ()) {
    ...
    }else if (cond_308282.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedList  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedList  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_309838 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8138)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8138)))).operator_not () ;
  if (cond_309838.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_89 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_315448 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_315448.isBuiltAndTrue ()) {
              ...
              }else if (cond_315448.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_87 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_89 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_319705 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_319705.isBuiltAndTrue ()) {
              ...
              }else if (cond_319705.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_90 = true ;
                while (syntaxRepeat_90) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_321637 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8468))) ;
  if (cond_321637.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_321499 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_321499.isBuilt ()) {
      temp_321499 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8470)) ;
    }
  ...
  }else if (cond_321637.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_321691 = var_cas_tableEnAvant ;
    if (temp_321691.isBuilt ()) {
      temp_321691 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8473)) ;
    }
  }
}
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_322470 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8491))) ;
  if (cond_322470.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_322332 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_322332.isBuilt ()) {
      temp_322332 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8493)) ;
    }
  ...
  }else if (cond_322470.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_322524 = var_cas_tableEnAvant ;
    if (temp_322524.isBuilt ()) {
      temp_322524 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8496)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_323440 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8516))) ;
  if (cond_323440.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_323302 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_323302.isBuilt ()) {
      temp_323302 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8518)) ;
    }
  ...
  }else if (cond_323440.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_323494 = var_cas_tableEnAvant ;
    if (temp_323494.isBuilt ()) {
      temp_323494 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8521)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_324425 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8542))) ;
  if (cond_324425.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_324287 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_324287.isBuilt ()) {
      temp_324287 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8544)) ;
    }
  ...
  }else if (cond_324425.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_324479 = var_cas_tableEnAvant ;
    if (temp_324479.isBuilt ()) {
      temp_324479 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8547)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeVariablesMap  var_cas_tableArgumentsMethode = GGS_typeVariablesMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_325971_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_325971_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i86_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeVariablesMap  var_cas_tableArgumentsMethode = GGS_typeVariablesMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_328433_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_328433_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_328642 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_328642 = NULL ;
    while (((operand_328642 = enumerator_328642.nextObject ()))) {
      macroValidPointer (operand_328642) ;
      const GGS_bool cond_328861 = (operand_328642->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
      if (cond_328861.isBuiltAndTrue ()) {
        operand_328642->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8657)) ;
      }else if (cond_328861.isBuiltAndFalse ()) {
        const GGS_bool cond_329070 = (operand_328642->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)) ;
        if (cond_329070.isBuiltAndTrue ()) {
          operand_328642->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8659)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i86_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_330921 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_330921 = NULL ;
    while (((operand_330921 = enumerator_330921.nextObject ()))) {
      macroValidPointer (operand_330921) ;
      const GGS_bool cond_331140 = (operand_330921->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
      if (cond_331140.isBuiltAndTrue ()) {
        operand_330921->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8711)) ;
      }else if (cond_331140.isBuiltAndFalse ()) {
        const GGS_bool cond_331349 = (operand_330921->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)) ;
        if (cond_331349.isBuiltAndTrue ()) {
          operand_330921->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8713)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i87_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_91 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_enumConstantMap::cEnumerator enumerator_333645 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_333645 = enumerator_333645.nextObject () ;
        if ((operand_333645 != NULL)) {
          bool _foreach_loop_333645 ;
          do{
            macroValidPointer (operand_333645) ;
            var_cas_s.dotAssign_operation (operand_333645->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8780))) ;
            operand_333645 = enumerator_333645.nextObject () ;
            _foreach_loop_333645 = ((operand_333645 != NULL)) ;
            if (_foreach_loop_333645) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_333645) ;
        }
      }
    ...
    while (syntaxRepeat_95) {
      switch (select_semantics_5F_parser_95 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_334464 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_334464 = NULL ;
            while (((operand_334464 = enumerator_334464.nextObject ()))) {
              macroValidPointer (operand_334464) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_334464->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8812)), GGS_location (inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  temp_334591 = var_cas_cstMessageStringMap ;
              if (temp_334591.isBuilt ()) {
                temp_334591 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (8814)) ;
              }
