...
pr_parse_match_operand_semantics_parser_3405_27_ (galgas_scanner & lexique_var_,
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_typeGalgasClassType * operand_130334 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_130334) ; 
      var_cas_outBaseTypeName = operand_130334->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_130537 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_130537) ; 
      var_cas_outBaseTypeName = operand_130537->mEnumTypeName ;
      var_cas_outIsEnumeration = GGS_bool (true, true) ;
      var_cas_outEnumMessageMap = operand_130537->mEnumConstantesMap ;
    }else{ // Else part
...
pr_optional_assignment_semantics_parser_3667_27_ (galgas_scanner & lexique_var_,
                                ...
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  GGS_AC_galgasType  var_cas_139331 ;
  GGS_typeCplusPlusName  var_cas_139334 ;
  var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_inTargetVarName, var_cas_139331, var_cas_139334 SOURCE_FILE_AT_LINE (3679)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
...
pr_optional_assignment_semantics_parser_3699_27_ (galgas_scanner & lexique_var_,
                                ...
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  GGS_AC_galgasType  var_cas_140444 ;
  GGS_typeCplusPlusName  var_cas_140447 ;
  var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_inTargetVarName, var_cas_140444, var_cas_140447 SOURCE_FILE_AT_LINE (3710)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
...
pr_semantics_declaration_semantics_parser_3813_29_ (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_40 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_insertOrSearchMethodList::element_type * operand_147981 = var_cas_insertMethodList.firstObject () ;
      while ((operand_147981 != NULL)) {
        macroValidPointer (operand_147981) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_148175 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_148175 != NULL)) {
          macroValidPointer (operand_148175) ;
          var_cas_methodSignature.addAssign_operation (operand_148175->mAttributType, var_cas_inPassingMode) ;
          operand_148175 = operand_148175->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_147981->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3925)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_148594 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_148594 != NULL)) {
          macroValidPointer (operand_148594) ;
          var_cas_methodSignature.addAssign_operation (operand_148594->mAttributType, var_cas_inPassingMode) ;
          operand_148594 = operand_148594->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_147981->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_147981->mMethodName.reader_location () COMMA_HERE) ;
        ...
        operand_147981 = operand_147981->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_148935 = var_cas_searchMethodList.firstObject () ;
      while ((operand_148935 != NULL)) {
        macroValidPointer (operand_148935) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_149127 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_149127 != NULL)) {
          macroValidPointer (operand_149127) ;
          var_cas_methodSignature.addAssign_operation (operand_149127->mAttributType, var_cas_outPassingMode) ;
          operand_149127 = operand_149127->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_148935->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3943)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_149544 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_149544 != NULL)) {
          macroValidPointer (operand_149544) ;
          var_cas_methodSignature.addAssign_operation (operand_149544->mAttributType, var_cas_outPassingMode) ;
          operand_149544 = operand_149544->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_148935->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_148935->mMethodName.reader_location () COMMA_HERE) ;
        ...
        operand_148935 = operand_148935->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_44 (lexique_var_)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_153213 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_153213 != NULL)) {
                macroValidPointer (operand_153213) ;
                var_cas_methodSignature.addAssign_operation (operand_153213->mAttributType, var_cas_inPassingMode) ;
                operand_153213 = operand_153213->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_153841 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_153841 != NULL)) {
                  macroValidPointer (operand_153841) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_153841->mAttributType, var_cas_inPassingMode) ;
                  operand_153841 = operand_153841->nextObject () ;
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_154879 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_154879 != NULL)) {
                macroValidPointer (operand_154879) ;
                var_cas_methodSignature.addAssign_operation (operand_154879->mAttributType, var_cas_outPassingMode) ;
                operand_154879 = operand_154879->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_155540 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_155540 != NULL)) {
                  macroValidPointer (operand_155540) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_155540->mAttributType, var_cas_outPassingMode) ;
                  operand_155540 = operand_155540->nextObject () ;
                }
      ...
      if (((var_cas_stateValues.reader_count ()) > (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
        GGS_insertOrSearchMethodList::element_type * operand_156070 = var_cas_insertMethodList.firstObject () ;
        while ((operand_156070 != NULL)) {
          macroValidPointer (operand_156070) ;
          GGS_insertOrSearchMethodList::element_type * operand_156192 = var_cas_insertMethodList.firstObject () ;
          while ((operand_156192 != NULL)) {
            macroValidPointer (operand_156192) ;
            if (((! (operand_156070->mTransitionStatusMap.reader_hasKey (operand_156192->mMethodName.reader_value ())))).isBuiltAndTrue ()) {
                operand_156070->mMethodName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "This insert method does not define the '")) + (operand_156192->mMethodName.reader_value ()))) + (GGS_string (true, "' transition"))) SOURCE_FILE_AT_LINE (4080)) ;
            }
            operand_156192 = operand_156192->nextObject () ;
          }
          operand_156070 = operand_156070->nextObject () ;
        }
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapMethodMap COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_3813_29_importSemantics (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_40 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_161534 = var_cas_insertMethodList.firstObject () ;
      while ((operand_161534 != NULL)) {
        macroValidPointer (operand_161534) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_161728 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_161728 != NULL)) {
          macroValidPointer (operand_161728) ;
          var_cas_methodSignature.addAssign_operation (operand_161728->mAttributType, var_cas_inPassingMode) ;
          operand_161728 = operand_161728->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_161534->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4213)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_162147 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_162147 != NULL)) {
          macroValidPointer (operand_162147) ;
          var_cas_methodSignature.addAssign_operation (operand_162147->mAttributType, var_cas_inPassingMode) ;
          operand_162147 = operand_162147->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_161534->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_161534->mMethodName.reader_location () COMMA_HERE) ;
      ...
      GGS_insertOrSearchMethodList::element_type * operand_162488 = var_cas_searchMethodList.firstObject () ;
      while ((operand_162488 != NULL)) {
        macroValidPointer (operand_162488) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_162682 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_162682 != NULL)) {
          macroValidPointer (operand_162682) ;
          var_cas_methodSignature.addAssign_operation (operand_162682->mAttributType, var_cas_outPassingMode) ;
          operand_162682 = operand_162682->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_162488->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4231)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_163102 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_163102 != NULL)) {
          macroValidPointer (operand_163102) ;
          var_cas_methodSignature.addAssign_operation (operand_163102->mAttributType, var_cas_outPassingMode) ;
          operand_163102 = operand_163102->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_162488->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_162488->mMethodName.reader_location () COMMA_HERE) ;
        ...
        operand_162488 = operand_162488->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapMethodMap COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_44 (lexique_var_)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_165362 ;
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_165362) ;
              nt_parse_states_parse (lexique_var_) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_165596 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_165596 != NULL)) {
                macroValidPointer (operand_165596) ;
                var_cas_methodSignature.addAssign_operation (operand_165596->mAttributType, var_cas_inPassingMode) ;
                operand_165596 = operand_165596->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_166128 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_166128 != NULL)) {
                  macroValidPointer (operand_166128) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_166128->mAttributType, var_cas_inPassingMode) ;
                  operand_166128 = operand_166128->nextObject () ;
                }
            ...
            case 3 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_166507 ;
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_166507) ;
              nt_parse_states_parse (lexique_var_) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_166747 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_166747 != NULL)) {
                macroValidPointer (operand_166747) ;
                var_cas_methodSignature.addAssign_operation (operand_166747->mAttributType, var_cas_outPassingMode) ;
                operand_166747 = operand_166747->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_167322 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_167322 != NULL)) {
                  macroValidPointer (operand_167322) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_167322->mAttributType, var_cas_outPassingMode) ;
                  operand_167322 = operand_167322->nextObject () ;
                }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_55 (lexique_var_)) {
        case 2 : {
          ...
          GGS_enumConstantMap::element_type * operand_193161 = var_cas_constantMap.firstObject () ;
          while ((operand_193161 != NULL)) {
            macroValidPointer (operand_193161) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (operand_193161->mKey.reader_value (), GGS_location (lexique_var_) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            ...
            operand_193161 = operand_193161->nextObject () ;
          }
