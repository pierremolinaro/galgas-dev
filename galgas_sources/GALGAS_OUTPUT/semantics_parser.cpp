  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  {
    ...
    while (((operand_24572 = (GGS_typeTableNomRoutinesDeclarees::cElement *) enumerator_24572.nextObject ()))) {
      ...
      if (((var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_24572->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (666)) COMMA_SOURCE_FILE_AT_LINE (666)))._operator_not ()).isBuiltAndTrue ()) {
        operand_24572->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the routine '"))._operator_concat (operand_24572->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (667))))._operator_concat (GGS_string (true, "' is not implemented in the component")) COMMA_SOURCE_FILE_AT_LINE (668)) ;
      }
    }
  }
  {
    GGS_typeTableEnAvant::cEnumerator enumerator_24922 (var_cas_tableEnAvant, true) ;
    const GGS_typeTableEnAvant::cElement * operand_24922 = NULL ;
    while (((operand_24922 = (GGS_typeTableEnAvant::cElement *) enumerator_24922.nextObject ()))) {
      macroValidPointer (operand_24922) ;
      if (((var_cas_componentEntitiesMap.reader_hasKey (_inLexique, operand_24922->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (673)) COMMA_SOURCE_FILE_AT_LINE (673)))._operator_not ()).isBuiltAndTrue ()) {
        operand_24922->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (operand_24922->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (674))))._operator_concat (GGS_string (true, "' forward type is not implemented in the component")) COMMA_SOURCE_FILE_AT_LINE (675)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            ...
            case 3 : {
              ...
              const GGS_M_optionComponents  _temp_34893 = var_cas_importedOptionComponentsMap ;
              if (_temp_34893._isBuilt ()) {
                _temp_34893 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (958)) ;
              }
            ...
            case 4 : {
              ...
              const GGS_M_grammarComponents  _temp_35933 = var_cas_grammarComponentsMap ;
              if (_temp_35933._isBuilt ()) {
                _temp_35933 (HERE)->method_searchKey (_inLexique, var_cas_grammarComponentName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (981)) ;
              }
              ...
              {
                GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_36093 (var_cas_nonterminalSymbolParametersMap, true) ;
                const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_36093 = NULL ;
                while (((operand_36093 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_36093.nextObject ()))) {
                  ...
                  {
                    GGS_L_signature::cEnumerator enumerator_36268 (operand_36093->mInfo.mFormalParametersList, true) ;
                    const GGS_L_signature::cElement * operand_36268 = NULL ;
                    while (((operand_36268 = (GGS_L_signature::cElement *) enumerator_36268.nextObject ()))) {
                      macroValidPointer (operand_36268) ;
                      GGS_AC_semanticsEntity  var_cas_e ;
                      const GGS_M_semanticsEntitiesForUse  _temp_36419 = var_cas_ioComponentSemanticsEntitiesMap ;
                      if (_temp_36419._isBuilt ()) {
                        _temp_36419 (HERE)->method_searchKey (_inLexique, operand_36268->mGalgasTypeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (987)) ;
                      }
                      GGS_AC_galgasType  var_cas_type ;
                      var_cas_type = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_e.getPtr (), true, operand_36268->mGalgasTypeName COMMA_SOURCE_FILE_AT_LINE (988)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (988)) ;
                      var_cas_formalParametersList._addAssign_operation (var_cas_type, operand_36268->mFormalArgumentPassingMode) ;
                    }
                  }
                  var_cas_grammarAltMap.modifier_insertKey (_inLexique, operand_36093->mKey, var_cas_formalParametersList, operand_36093->mInfo.mReturnedEntityTypeName COMMA_SOURCE_FILE_AT_LINE (991)) ;
                }
              }
              GGS_AC_semanticsEntity  var_cas_e ;
              ...
              {
                GGS_M_grammarComponents::cEnumerator enumerator_37213 (var_cas_grammarComponentsMap, true) ;
                const GGS_M_grammarComponents::cElement * operand_37213 = NULL ;
                while (((operand_37213 = (GGS_M_grammarComponents::cElement *) enumerator_37213.nextObject ()))) {
                  macroValidPointer (operand_37213) ;
                  if (((var_cas_ioGrammarComponentsMap.reader_hasKey (_inLexique, operand_37213->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)) COMMA_SOURCE_FILE_AT_LINE (1004)))._operator_not ()).isBuiltAndTrue ()) {
                    var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, operand_37213->mKey, operand_37213->mInfo.mNonterminalSymbolParametersMap, operand_37213->mInfo.mLexiqueName, operand_37213->mInfo.mOptionsMap COMMA_SOURCE_FILE_AT_LINE (1005)) ;
                  }
                }
              }
              } break ;
            case 5 : {
              ...
              if (((var_cas_outImportedSemanticsComponentNameSet.reader_hasKey (_inLexique, var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1021)) COMMA_SOURCE_FILE_AT_LINE (1021)))._operator_not ()).isBuiltAndTrue ()) {
                ...
                const GGS_M_semanticsComponents  _temp_38628 = var_cas_ioSemanticsComponentsMap ;
                if (_temp_38628._isBuilt ()) {
                  _temp_38628 (HERE)->method_searchKey (_inLexique, var_cas_componentName, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_importedOptionsComponentsMap, var_cas_importedEntities COMMA_SOURCE_FILE_AT_LINE (1034)) ;
                }
                {
                  GGS_M_semanticsEntitiesForUse::cEnumerator enumerator_38724 (var_cas_importedEntities, true) ;
                  const GGS_M_semanticsEntitiesForUse::cElement * operand_38724 = NULL ;
                  while (((operand_38724 = (GGS_M_semanticsEntitiesForUse::cElement *) enumerator_38724.nextObject ()))) {
                    macroValidPointer (operand_38724) ;
                    if (((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_38724->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1036)) COMMA_SOURCE_FILE_AT_LINE (1036)))._operator_not ()).isBuiltAndTrue ()) {
                      var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_38724->mKey, operand_38724->mInfo.aDefEntite COMMA_SOURCE_FILE_AT_LINE (1037)) ;
                    }
                  }
                }
                {
                  GGS_M_optionComponents::cEnumerator enumerator_39152 (var_cas_importedOptionsComponentsMap, true) ;
                  const GGS_M_optionComponents::cElement * operand_39152 = NULL ;
                  while (((operand_39152 = (GGS_M_optionComponents::cElement *) enumerator_39152.nextObject ()))) {
                    macroValidPointer (operand_39152) ;
                    if (((var_cas_ioOptionsComponentsMapForUse.reader_hasKey (_inLexique, operand_39152->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1043)) COMMA_SOURCE_FILE_AT_LINE (1043)))._operator_not ()).isBuiltAndTrue ()) {
                      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_39152->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1044))))._operator_concat (GGS_string (true, "' option component must have been imported")) COMMA_SOURCE_FILE_AT_LINE (1044)) ;
                    }
                  }
                }
              }
            ...
            case 6 : {
              ...
              if (((var_cas_outIncludedMetamodelComponents.reader_hasKey (_inLexique, var_cas_metamodelComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1075)) COMMA_SOURCE_FILE_AT_LINE (1075)))._operator_not ()).isBuiltAndTrue ()) {
                ...
                const GGS_M_metamodelsComponents  _temp_40475 = var_cas_ioMetamodelComponentMap ;
                if (_temp_40475._isBuilt ()) {
                  _temp_40475 (HERE)->method_searchKey (_inLexique, var_cas_metamodelComponentName, automatic_var_6, var_cas_metamodelClassMap, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (1077)) ;
                }
                {
                  GGS_entityToImplementMap::cEnumerator enumerator_40553 (var_cas_metamodelClassMap, true) ;
                  const GGS_entityToImplementMap::cElement * operand_40553 = NULL ;
                  while (((operand_40553 = (GGS_entityToImplementMap::cElement *) enumerator_40553.nextObject ()))) {
                    macroValidPointer (operand_40553) ;
                    var_cas_outAllMetamodelClassMap.modifier_insertKey (_inLexique, operand_40553->mKey, operand_40553->mInfo.mAllMetamodelPropertyMap, operand_40553->mInfo.mIsAbstract, operand_40553->mInfo.mCurrentMetamodelPropertyMap, operand_40553->mInfo.mSuperEntityName, operand_40553->mInfo.mAncestorClassesMap, operand_40553->mInfo.mPropertyList, operand_40553->mInfo.mMetamodelName, operand_40553->mInfo.mID COMMA_SOURCE_FILE_AT_LINE (1087)) ;
                    GGS_AC_galgasType  var_cas_t ;
                    var_cas_t = GGS_typeGalgas_singleReferenceEntity ::constructor_new (_inLexique, operand_40553->mKey, operand_40553->mInfo.mPropertyList, operand_40553->mInfo.mAncestorClassesMap.reader_allKeys (_inLexique COMMA_SOURCE_FILE_AT_LINE (1101)) COMMA_HERE) ;
                    var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_40553->mKey, GGS_typeEntiteType ::constructor_new (_inLexique, var_cas_t COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1103)) ;
                    var_cas_t = GGS_typeGalgas_multipleReferenceEntity ::constructor_new (_inLexique, operand_40553->mKey, GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
                    GGS_lstring  var_cas_ListOf_entityName ;
                    var_cas_ListOf_entityName = GGS_lstring ::constructor_new (_inLexique, (GGS_string (true, "ListOf"))._operator_concat (operand_40553->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1112)).reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1112))), operand_40553->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1112)) COMMA_HERE) ;
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            ...
            case 5 : {
              ...
              const GGS_M_semanticsComponents  _temp_45743 = var_cas_ioSemanticsComponentsMap ;
              if (_temp_45743._isBuilt ()) {
                _temp_45743 (HERE)->method_searchKey (_inLexique, var_cas_componentName, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, var_cas_importedEntities COMMA_SOURCE_FILE_AT_LINE (1207)) ;
              }
              {
                GGS_M_semanticsEntitiesForUse::cEnumerator enumerator_45810 (var_cas_importedEntities, true) ;
                const GGS_M_semanticsEntitiesForUse::cElement * operand_45810 = NULL ;
                while (((operand_45810 = (GGS_M_semanticsEntitiesForUse::cElement *) enumerator_45810.nextObject ()))) {
                  macroValidPointer (operand_45810) ;
                  if (((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_45810->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1209)) COMMA_SOURCE_FILE_AT_LINE (1209)))._operator_not ()).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_45810->mKey, operand_45810->mInfo.aDefEntite COMMA_SOURCE_FILE_AT_LINE (1210)) ;
                  }
                }
              }
            ...
            case 6 : {
              ...
              const GGS_M_metamodelsComponents  _temp_46860 = var_cas_ioMetamodelComponentMap ;
              if (_temp_46860._isBuilt ()) {
                _temp_46860 (HERE)->method_searchKey (_inLexique, var_cas_metamodelComponentName, automatic_var_14, automatic_var_15, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1238)) ;
              }
              } break ;
            default :
              break ;
...
pr_semantics_declaration_semantics_parser_1250_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279))).isBuiltAndTrue ()) {
    ...
    const GGS_M_semanticsEntitiesForUse  _temp_48669 = var_cas_ioComponentSemanticsEntitiesMap ;
    if (_temp_48669._isBuilt ()) {
      _temp_48669 (HERE)->method_searchKey (_inLexique, var_cas_routineName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1281)) ;
    }
...
pr_semantics_declaration_semantics_parser_1250_4_importSemantics (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1357)) COMMA_SOURCE_FILE_AT_LINE (1357))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  _temp_51768 = var_cas_ioComponentSemanticsEntitiesMap ;
    if (_temp_51768._isBuilt ()) {
      _temp_51768 (HERE)->method_searchKey (_inLexique, var_cas_routineName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1359)) ;
    }
    GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
...
pr_parent_class_semantics_parser_1433_4_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  _temp_55379 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (_temp_55379._isBuilt ()) {
    _temp_55379 (HERE)->method_searchKey (_inLexique, var_cas_outSuperClassName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1448)) ;
  }
...
pr_parent_class_semantics_parser_1433_4_importSemantics (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  _temp_56852 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (_temp_56852._isBuilt ()) {
    _temp_56852 (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1478)) ;
  }
  GGS_AC_galgasType  var_cas_typeUtilisateur ;
  ...
  const GGS_ModelMap  _temp_57654 = var_cas_ioModelMap ;
  if (_temp_57654._isBuilt ()) {
    _temp_57654 (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_type COMMA_SOURCE_FILE_AT_LINE (1492)) ;
  }
  { const GGS_TypeModel _var_58115 = var_cas_type ; // CAST instruction
    if (_var_58115.getPtr () != NULL) {
      macroValidPointer (_var_58115.getPtr ()) ;
      if (dynamic_cast <cPtr_ClassModel *> (_var_58115.getPtr ()) != NULL) {
        const GGS_ClassModel var_cas_model (_var_58115.getPtr ()) ;
...
pr_semantics_declaration_semantics_parser_1516_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_5 (_inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeClassInheritedMessagesMap::cEnumerator enumerator_63606 (var_cas_inheritedMessageMap, true) ;
        const GGS_typeClassInheritedMessagesMap::cElement * operand_63606 = NULL ;
        while (((operand_63606 = (GGS_typeClassInheritedMessagesMap::cElement *) enumerator_63606.nextObject ()))) {
          macroValidPointer (operand_63606) ;
          if (((var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_63606->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1659)) COMMA_SOURCE_FILE_AT_LINE (1659)))._operator_not ()).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the message '"))._operator_concat (operand_63606->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1660))))._operator_concat (GGS_string (true, "' is not defined")) COMMA_SOURCE_FILE_AT_LINE (1660)) ;
          }
        }
      }
...
pr_semantics_declaration_semantics_parser_1516_4_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_5 (_inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeClassInheritedMessagesMap::cEnumerator enumerator_69583 (var_cas_inheritedMessageMap, true) ;
        const GGS_typeClassInheritedMessagesMap::cElement * operand_69583 = NULL ;
        while (((operand_69583 = (GGS_typeClassInheritedMessagesMap::cElement *) enumerator_69583.nextObject ()))) {
          macroValidPointer (operand_69583) ;
          if (((var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_69583->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1833)) COMMA_SOURCE_FILE_AT_LINE (1833)))._operator_not ()).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the message '"))._operator_concat (operand_69583->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1834))))._operator_concat (GGS_string (true, "' is not defined")) COMMA_SOURCE_FILE_AT_LINE (1834)) ;
          }
        }
      }
      GGS_AC_galgasType  var_cas_c ;
...
pr_parse_method_semantics_parser_1895_4_ (galgas_scanner & _inLexique,
  ...
  {
    GGS_typeSemanticAttributesMap::cEnumerator enumerator_73305 (var_cas_tableAttributsHerites, true) ;
    const GGS_typeSemanticAttributesMap::cElement * operand_73305 = NULL ;
    while (((operand_73305 = (GGS_typeSemanticAttributesMap::cElement *) enumerator_73305.nextObject ()))) {
      macroValidPointer (operand_73305) ;
      GGS_typeCplusPlusName  var_cas_nomCpp ;
      var_cas_nomCpp = GGS_typeDirectName ::constructor_new (_inLexique, operand_73305->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1920)), operand_73305->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1920)) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_73305->mKey, operand_73305->mInfo.mAttributType, var_cas_nomCpp COMMA_SOURCE_FILE_AT_LINE (1921)) ;
    }
  }
...
pr_overrided_method_semantics_parser_2037_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableMethodes  _temp_79241 = var_cas_tableDesMethodes ;
  if (_temp_79241._isBuilt ()) {
    _temp_79241 (HERE)->method_searchKey (_inLexique, var_cas_methodName, var_cas_listeDeTypesMethodeOriginale COMMA_SOURCE_FILE_AT_LINE (2082)) ;
  }
...
pr_type_parsing_semantics_parser_2267_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2274)) COMMA_SOURCE_FILE_AT_LINE (2274))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  _temp_87051 = var_cas_ioComponentSemanticsEntitiesMap ;
    if (_temp_87051._isBuilt ()) {
      _temp_87051 (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (2276)) ;
    }
    ...
    const GGS_typeTableEnAvant  _temp_87261 = var_cas_inTableEnAvant ;
    if (_temp_87261._isBuilt ()) {
      _temp_87261 (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_outTypeDefinition COMMA_SOURCE_FILE_AT_LINE (2279)) ;
    }
  }else{
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_2331_4_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inTargetType._isBuilt () && var_cas_sourceType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_90333 = var_cas_inTargetType (HERE) ;
    cPtr_AC_galgasType * ptr_90347 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_string * operand_90333 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_90333) ;
    cPtr_typeGalgas_string * operand_90347 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_90347) ;
    if ((operand_90333 != NULL) && (operand_90347 != NULL)) {
      var_cas_sourceExpressionConverter = GGS_string (true, "") ;
    }else{
      cPtr_typeGalgas_string * operand_90333 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_90333) ;
      cPtr_typeGalgas_lstring * operand_90347 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_90347) ;
      if ((operand_90333 != NULL) && (operand_90347 != NULL)) {
...
pr_input_parameters_list_semantics_parser_2381_4_ (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_13 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_93015 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (2423)) ;
              GGS_bool _condition_93015 (_variant_93015._isBuilt (), true) ;
              while (_condition_93015.isBuiltAndTrue ()) {
                _condition_93015 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_93015.isBuiltAndTrue ()) {
                  if (_variant_93015.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2426)) ;
                    _condition_93015 = GGS_bool (true, false) ;
                  }else{
                    _variant_93015._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeCibles._addAssign_operation (GGS_typeJoker ::constructor_new (_inLexique COMMA_HERE)) ;
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2438)))._operator_strictInf (var_cas_listeCibles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2438)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_94007 (var_cas_listeAttributsSemantiques, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_94007 = NULL ;
      GGS_typeListeCibles::cEnumerator enumerator_94091 (var_cas_listeCibles, true) ;
      const GGS_typeListeCibles::cElement * operand_94091 = NULL ;
      while (((operand_94007 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_94007.nextObject ()))
          && ((operand_94091 = enumerator_94091.nextObject ()))) {
        macroValidPointer (operand_94007) ;
        macroValidPointer (operand_94091) ;
        GGS_lstring  var_cas_nomAttributSource ;
        var_cas_nomAttributSource = operand_94007->aNomAttribut ;
        const GGS_typeCible  _temp_94209 = operand_94091->aCible ;
        if (_temp_94209._isBuilt ()) {
          _temp_94209 (HERE)->method_verifierType (_inLexique, operand_94007->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList COMMA_SOURCE_FILE_AT_LINE (2452)) ;
        }
      }
    }
  }
    ...
    while (syntaxRepeat_16) {
      switch (select_repeat_semantics_parser_16 (_inLexique)) {
        case 2 : {
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_96452 (var_cas_structType.reader_mAttributesList (_inLexique COMMA_SOURCE_FILE_AT_LINE (2501)), true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_96452 = NULL ;
            while (((operand_96452 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_96452.nextObject ()))
                && ((var_cas_found)._operator_not ().isBuiltAndTrue ())) {
              macroValidPointer (operand_96452) ;
              var_cas_found = (operand_96452->aNomAttribut.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2502)))._operator_isEqual (var_cas_structAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2502))) ;
              var_cas_targetType = operand_96452->mAttributType ;
            }
          }
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_2533_4_ (galgas_scanner & _inLexique,
  ...
  { const GGS_AC_galgasType _var_99052 = var_cas_inTargetType ; // CAST instruction
    if (_var_99052.getPtr () != NULL) {
      macroValidPointer (_var_99052.getPtr ()) ;
      if (typeid (cPtr_typeGalgas_multipleReferenceEntity) == typeid (* (_var_99052.getPtr ()))) {
        const GGS_typeGalgas_multipleReferenceEntity var_cas_mre (_var_99052.getPtr ()) ;
        var_cas_formalParametersList = GGS_typeListeAttributsSemantiques ::constructor_emptyList (_inLexique COMMA_HERE) ;
        GGS_AC_semanticsEntity  var_cas_entite ;
        const GGS_M_semanticsEntitiesForUse  _temp_98755 = var_cas_ioComponentSemanticsEntitiesMap ;
        if (_temp_98755._isBuilt ()) {
          _temp_98755 (HERE)->method_searchKey (_inLexique, var_cas_mre.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (2553)), var_cas_entite COMMA_SOURCE_FILE_AT_LINE (2553)) ;
        }
        ...
        const GGS_AC_galgasType  _temp_98993 = var_cas_inTargetType ;
        if (_temp_98993._isBuilt ()) {
          _temp_98993 (HERE)->method_handleAddAssignOperatorCall (_inLexique, GGS_location (_inLexique), var_cas_formalParametersList COMMA_SOURCE_FILE_AT_LINE (2557)) ;
        }
      }
    }
  }
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2579)))._operator_isNotEqual (var_cas_typeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2579)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_99832 (var_cas_formalParametersList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_99832 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_99902 (var_cas_typeList, true) ;
      const GGS_typeTypesList::cElement * operand_99902 = NULL ;
      while (((operand_99832 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_99832.nextObject ()))
          && ((operand_99902 = enumerator_99902.nextObject ()))) {
        macroValidPointer (operand_99832) ;
        macroValidPointer (operand_99902) ;
        ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_99832->mAttributType,  operand_99902->mType,  operand_99902->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (2583)) ;
      }
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_2604_4_ (galgas_scanner & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques  var_cas_formalParametersList ;
  const GGS_AC_galgasType  _temp_101544 = var_cas_inTargetType ;
  if (_temp_101544._isBuilt ()) {
    _temp_101544 (HERE)->method_handleMinusAssignOperatorCall (_inLexique, GGS_location (_inLexique), var_cas_formalParametersList COMMA_SOURCE_FILE_AT_LINE (2619)) ;
  }
  GGS_typeTypesList  var_cas_typeList ;
  var_cas_typeList = GGS_typeTypesList ::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2640)))._operator_isNotEqual (var_cas_typeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2640)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_102372 (var_cas_formalParametersList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_102372 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_102442 (var_cas_typeList, true) ;
      const GGS_typeTypesList::cElement * operand_102442 = NULL ;
      while (((operand_102372 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_102372.nextObject ()))
          && ((operand_102442 = enumerator_102442.nextObject ()))) {
        macroValidPointer (operand_102372) ;
        macroValidPointer (operand_102442) ;
        ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_102372->mAttributType,  operand_102442->mType,  operand_102442->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (2644)) ;
      }
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_2665_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_AC_galgasType  _temp_104056 = var_cas_inTargetType ;
  if (_temp_104056._isBuilt ()) {
    _temp_104056 (HERE)->method_handleIncrementOperatorCall (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2679)) ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_and_structure_access_semantics_parser_2693_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_AC_galgasType  _temp_105488 = var_cas_inTargetType ;
  if (_temp_105488._isBuilt ()) {
    _temp_105488 (HERE)->method_handleDecrementOperatorCall (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2707)) ;
  }
  GGS_typeInstruction  var_cas_instruction ;
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_20 (_inLexique)) {
            ...
            case 2 : {
              ...
              GGS_uint _variant_108884 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (2788)) ;
              GGS_bool _condition_108884 (_variant_108884._isBuilt (), true) ;
              while (_condition_108884.isBuiltAndTrue ()) {
                _condition_108884 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_108884.isBuiltAndTrue ()) {
                  if (_variant_108884.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2792)) ;
                    _condition_108884 = GGS_bool (true, false) ;
                  }else{
                    _variant_108884._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeTypesParametresEffectifs._addAssign_operation (GGS_typeGalgas_jokerInParameterList ::constructor_new (_inLexique COMMA_HERE), var_cas_parameterPassingMode) ;
                    var_cas_outExpressionList._addAssign_operation (GGS_typeJokerInExpression ::constructor_new (_inLexique COMMA_HERE)) ;
...
pr_semantic_instruction_semantics_parser_2866_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityPropertyMap  _temp_112769 = var_cas_inCurrentTreewalkingRoutinePropertyMap ;
  if (_temp_112769._isBuilt ()) {
    _temp_112769 (HERE)->method_searchKey (_inLexique, var_cas_calledPropertyName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (2883)) ;
  }
  GGS_lstring  var_cas_entityName ;
  { const GGS_AC_galgasType _var_113162 = var_cas_propertyType ; // CAST instruction
    if (_var_113162.getPtr () != NULL) {
      macroValidPointer (_var_113162.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_113162.getPtr ()) != NULL) {
        const GGS_typeGalgas_singleReferenceEntity var_cas_ref (_var_113162.getPtr ()) ;
        var_cas_entityName = var_cas_ref.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (2887)) ;
      }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_113162.getPtr ()) != NULL) {
        const GGS_typeGalgas_multipleReferenceEntity var_cas_ref (_var_113162.getPtr ()) ;
  ...
  if ((var_cas_inTreewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2895)) COMMA_SOURCE_FILE_AT_LINE (2895))).isBuiltAndTrue ()) {
    ...
    const GGS_treewalkingRoutineHeaderMap  _temp_113369 = var_cas_inTreewalkingRoutineHeaderMap ;
    if (_temp_113369._isBuilt ()) {
      _temp_113369 (HERE)->method_searchKey (_inLexique, var_cas_entityName, var_cas_routineSignature, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (2896)) ;
    }
  }else{
...
pr_extract_instruction_semantics_parser_2976_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  _temp_117217 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (_temp_117217._isBuilt ()) {
    _temp_117217 (HERE)->method_searchKey (_inLexique, var_cas_nomClasse, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (2998)) ;
  }
  ...
  const GGS_AC_galgasType  _temp_118636 = var_cas_errorExpressionType ;
  if (_temp_118636._isBuilt ()) {
    _temp_118636 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (3033)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  GGS_lstring  var_cas_messageName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_messageName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  const GGS_typeClassInheritedMessagesMap  _temp_118773 = var_cas_tableMessagesAbstraits ;
  if (_temp_118773._isBuilt ()) {
    _temp_118773 (HERE)->method_searchKey (_inLexique, var_cas_messageName COMMA_SOURCE_FILE_AT_LINE (3037)) ;
  }
...
pr_extract_instruction_semantics_parser_3050_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_21 = true ;
    while (syntaxRepeat_21) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        GGS_AC_semanticsEntity  var_cas_entite ;
        const GGS_M_semanticsEntitiesForUse  _temp_120676 = var_cas_ioComponentSemanticsEntitiesMap ;
        if (_temp_120676._isBuilt ()) {
          _temp_120676 (HERE)->method_searchKey (_inLexique, var_cas_nomType1, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (3078)) ;
        }
...
pr_semantic_instruction_semantics_parser_3148_4_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        GGS_AC_semanticsEntity  var_cas_entite ;
        const GGS_M_semanticsEntitiesForUse  _temp_125339 = var_cas_ioComponentSemanticsEntitiesMap ;
        if (_temp_125339._isBuilt ()) {
          _temp_125339 (HERE)->method_searchKey (_inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (3196)) ;
        }
        GGS_AC_galgasType  var_cas_typeDefinition ;
  ...
  switch (select_semantics_parser_25 (_inLexique)) {
    case 1 : {
      ...
      const GGS_AC_galgasType  _temp_128814 = var_cas_errorLocationExpressionType ;
      if (_temp_128814._isBuilt ()) {
        _temp_128814 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (3266)) ;
      }
...
pr_instruction_beginning_with_identifier_semantics_parser_3421_4_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  _temp_135459 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (_temp_135459._isBuilt ()) {
    _temp_135459 (HERE)->method_searchKey (_inLexique, var_cas_nomVarDest, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (3434)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_135941 = var_cas_entite ; // CAST instruction
    if (_var_135941.getPtr () != NULL) {
      macroValidPointer (_var_135941.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteRoutine *> (_var_135941.getPtr ()) != NULL) {
        const GGS_typeEntiteRoutine var_cas_r (_var_135941.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteActionExterne *> (_var_135941.getPtr ()) != NULL) {
        const GGS_typeEntiteActionExterne var_cas_ae (_var_135941.getPtr ()) ;
...
pr_semantic_instruction_semantics_parser_3483_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_28 (_inLexique)) {
    case 1 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
      const GGS_AC_galgasType  _temp_138462 = var_cas_expressionType ;
      if (_temp_138462._isBuilt ()) {
        _temp_138462 (HERE)->method_handleMethodInstructionCall (_inLexique, var_cas_methodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (3513)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
    ...
    case 2 : {
        ...
        while (syntaxRepeat_29) {
          switch (select_repeat_semantics_parser_29 (_inLexique)) {
            case 2 : {
              ...
              var_cas_found = GGS_bool (true, false) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_139652 (var_cas_structType.reader_mAttributesList (_inLexique COMMA_SOURCE_FILE_AT_LINE (3544)), true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_139652 = NULL ;
                while (((operand_139652 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_139652.nextObject ()))
                    && ((var_cas_found)._operator_not ().isBuiltAndTrue ())) {
                  macroValidPointer (operand_139652) ;
                  var_cas_found = (operand_139652->aNomAttribut.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (3545)))._operator_isEqual (var_cas_structAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (3545))) ;
                  var_cas_variableType = operand_139652->mAttributType ;
                }
              }
              if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
      const GGS_AC_galgasType  _temp_140229 = var_cas_variableType ;
      if (_temp_140229._isBuilt ()) {
        _temp_140229 (HERE)->method_handleModifierCall (_inLexique, var_cas_modifierName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (3556)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
      nt_actual_parameters_list_ (_inLexique, var_cas_methodSignature, var_cas_expressionsList, var_cas_ioVariablesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioInstructionList) ;
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_141034 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (_temp_141034._isBuilt ()) {
        _temp_141034 (HERE)->method_searchKey (_inLexique, var_cas_typeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (3578)) ;
      }
      GGS_AC_galgasType  var_cas_type ;
      ...
      const GGS_AC_galgasType  _temp_141177 = var_cas_type ;
      if (_temp_141177._isBuilt ()) {
        _temp_141177 (HERE)->method_handleClassMethodCall (_inLexique, var_cas_typeMethodName, var_cas_typeMethodSignature COMMA_SOURCE_FILE_AT_LINE (3580)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
...
pr_warning_instruction_semantics_parser_3667_4_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_errorExpressionType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_errorExpression, var_cas_errorExpressionType) ;
  const GGS_AC_galgasType  _temp_144971 = var_cas_errorExpressionType ;
  if (_temp_144971._isBuilt ()) {
    _temp_144971 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (3686)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
pr_error_instruction_semantics_parser_3737_4_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_errorLocationExpressionType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_errorLocationExpression, var_cas_errorLocationExpressionType) ;
  const GGS_AC_galgasType  _temp_147596 = var_cas_errorLocationExpressionType ;
  if (_temp_147596._isBuilt ()) {
    _temp_147596 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (3756)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
pr_semantic_instruction_semantics_parser_3925_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_34) {
        ...
        { bool syntaxRepeat_35 = true ;
          while (syntaxRepeat_35) {
              ...
              const GGS_enumConstantMap  _temp_155315 = var_cas_enumConstantesMap ;
              if (_temp_155315._isBuilt ()) {
                _temp_155315 (HERE)->method_searchKey (_inLexique, var_cas_enumConstantName, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (3965)) ;
              }
  ...
  {
    GGS_stringset::cEnumerator enumerator_156485 (var_cas_missingConstants, true) ;
    const GGS_stringset::cElement * operand_156485 = NULL ;
    while (((operand_156485 = (GGS_stringset::cElement *) enumerator_156485.nextObject ()))) {
      macroValidPointer (operand_156485) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_156485->mKey))._operator_concat (GGS_string (true, "' is not used in switch instruction")) COMMA_SOURCE_FILE_AT_LINE (3998)) ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_4110_4_ (galgas_scanner & _inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  const GGS_M_semanticsEntitiesForUse  _temp_162494 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (_temp_162494._isBuilt ()) {
    _temp_162494 (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (4177)) ;
  }
  ...
  const GGS_M_nonterminalSymbolAlts  _temp_162835 = var_cas_startSymbolAltMap ;
  if (_temp_162835._isBuilt ()) {
    _temp_162835 (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (4183)) ;
  }
...
pr_semantic_instruction_semantics_parser_4245_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_M_treewalkingComponents  _temp_165988 = var_cas_inTreewalkingComponentMap ;
  if (_temp_165988._isBuilt ()) {
    _temp_165988 (HERE)->method_searchKey (_inLexique, var_cas_treewalkingComponentName, var_cas_rootEntityName, var_cas_treewalkingRoutineSignature COMMA_SOURCE_FILE_AT_LINE (4264)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_on) COMMA_HERE) ;
...
pr_constant_while_before_in_foreach_instruction_semantics_parser_4364_4_secondPhase (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_40 = true ;
    while (syntaxRepeat_40) {
        ...
        const GGS_AC_galgasType  _temp_173315 = var_cas_sourceExpressionType ;
        if (_temp_173315._isBuilt ()) {
          _temp_173315 (HERE)->method_acceptForeachInstruction (_inLexique, var_cas_magicNumber, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum COMMA_SOURCE_FILE_AT_LINE (4483)) ;
        }
        GGS_string var_cas_typeName ;
        const GGS_AC_galgasType  _temp_173519 = var_cas_sourceExpressionType ;
        if (_temp_173519._isBuilt ()) {
          _temp_173519 (HERE)->method_getTypeName (_inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (4490)) ;
        }
        switch (select_semantics_parser_42 (_inLexique)) {
          case 1 : {
          ...
          case 2 : {
            ...
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_173954 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_173954 = NULL ;
              while (((operand_173954 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_173954.nextObject ()))) {
                macroValidPointer (operand_173954) ;
                ...
                if ((((var_cas_localConstantBuildStyleEnum)._operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE)))._operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
                  ...
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (_inLexique, var_cas_magicNumber, operand_173954->aNomAttribut.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (4508)), var_cas_mapStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_173954->aNomAttribut, operand_173954->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (4510)) ;
...
pr_semantic_instruction_semantics_parser_4576_4_ (galgas_scanner & _inLexique,
  ...
  GGS_typeCplusPlusName  var_cas_indexVariable ;
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_178038 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_178038) ;
  ...
  switch (select_semantics_parser_46 (_inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_178487 = var_cas_indexVariable ; // CAST instruction
        if (_var_178487.getPtr () != NULL) {
          macroValidPointer (_var_178487.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_178487.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_178487.getPtr ()) ;
  ...
  switch (select_semantics_parser_47 (_inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_179414 = var_cas_indexVariable ; // CAST instruction
        if (_var_179414.getPtr () != NULL) {
          macroValidPointer (_var_179414.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_179414.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_179414.getPtr ()) ;
...
pr_parse_match_operand_semantics_parser_4706_4_ (galgas_scanner & _inLexique,
  ...
  { const GGS_AC_galgasType _var_181633 = var_cas_type ; // CAST instruction
    if (_var_181633.getPtr () != NULL) {
      macroValidPointer (_var_181633.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_181633.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_t (_var_181633.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (_var_181633.getPtr ()) != NULL) {
        const GGS_typeGalgas_enum var_cas_e (_var_181633.getPtr ()) ;
        ...
        const GGS_AC_galgasType  _temp_181391 = var_cas_type ;
        if (_temp_181391._isBuilt ()) {
          _temp_181391 (HERE)->method_getTypeName (_inLexique, var_cas_actualTypeName COMMA_SOURCE_FILE_AT_LINE (4734)) ;
        }
...
pr_parse_match_case_semantics_parser_4744_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  _temp_182177 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (_temp_182177._isBuilt ()) {
    _temp_182177 (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (4757)) ;
  }
  GGS_AC_galgasType  var_cas_definitionClasse1 ;
...
pr_parse_match_case_semantics_parser_4786_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    ...
    const GGS_enumConstantMap  _temp_183948 = var_cas_inEnumMessageMap ;
    if (_temp_183948._isBuilt ()) {
      _temp_183948 (HERE)->method_searchKey (_inLexique, var_cas_outEnumConstantName, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (4799)) ;
    }
  }else{
...
pr_optional_assignment_semantics_parser_5019_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
  const GGS_AC_galgasType  _temp_192198 = var_cas_inVariableType ;
  if (_temp_192198._isBuilt ()) {
    _temp_192198 (HERE)->method_handleConstructorCall (_inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (5036)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
...
pr_semantics_declaration_semantics_parser_5065_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  _temp_194346 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (_temp_194346._isBuilt ()) {
        _temp_194346 (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5090)) ;
      }
...
pr_semantics_declaration_semantics_parser_5065_4_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  _temp_196941 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (_temp_196941._isBuilt ()) {
        _temp_196941 (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5157)) ;
      }
      GGS_AC_galgasType  var_cas_aType ;
...
pr_semantics_declaration_semantics_parser_5200_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_52 (_inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_202510 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_202510 = NULL ;
        while (((operand_202510 = (GGS_insertOrSearchMethodList::cElement *) enumerator_202510.nextObject ()))) {
          macroValidPointer (operand_202510) ;
          GGS_L_EXsignature  var_cas_methodSignature ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_202694 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_202694 = NULL ;
            while (((operand_202694 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_202694.nextObject ()))) {
              macroValidPointer (operand_202694) ;
              var_cas_methodSignature._addAssign_operation (operand_202694->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_202510->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5308)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_203124 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_203124 = NULL ;
            while (((operand_203124 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_203124.nextObject ()))) {
              macroValidPointer (operand_203124) ;
              var_cas_methodSignature._addAssign_operation (operand_203124->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName ;
          var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (_inLexique, (operand_202510->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5316)))._operator_concat (GGS_string (true, "GetIndex")), operand_202510->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (5316)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_203486 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_203486 = NULL ;
        while (((operand_203486 = (GGS_insertOrSearchMethodList::cElement *) enumerator_203486.nextObject ()))) {
          macroValidPointer (operand_203486) ;
          GGS_L_EXsignature  var_cas_methodSignature ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_203668 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_203668 = NULL ;
            while (((operand_203668 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_203668.nextObject ()))) {
              macroValidPointer (operand_203668) ;
              var_cas_methodSignature._addAssign_operation (operand_203668->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_203486->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5326)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_204096 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_204096 = NULL ;
            while (((operand_204096 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_204096.nextObject ()))) {
              macroValidPointer (operand_204096) ;
              var_cas_methodSignature._addAssign_operation (operand_204096->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName ;
          var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (_inLexique, (operand_203486->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5334)))._operator_concat (GGS_string (true, "GetIndex")), operand_203486->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (5334)) COMMA_HERE) ;
        ...
        while (syntaxRepeat_55) {
          switch (select_repeat_semantics_parser_55 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_207462 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_207462 = NULL ;
                while (((operand_207462 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_207462.nextObject ()))) {
                  macroValidPointer (operand_207462) ;
                  var_cas_methodSignature._addAssign_operation (operand_207462->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5413)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  ...
                  while (((operand_208051 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_208051.nextObject ()))) {
                    ...
                    var_cas_getIndexMethodSignature._addAssign_operation (operand_208051->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_209147 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_209147 = NULL ;
                while (((operand_209147 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_209147.nextObject ()))) {
                  macroValidPointer (operand_209147) ;
                  var_cas_methodSignature._addAssign_operation (operand_209147->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5450)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_209751 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_209751 = NULL ;
                  while (((operand_209751 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_209751.nextObject ()))) {
                    macroValidPointer (operand_209751) ;
                    var_cas_getIndexMethodSignature._addAssign_operation (operand_209751->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_210533 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_210533 = NULL ;
                while (((operand_210533 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_210533.nextObject ()))) {
                  macroValidPointer (operand_210533) ;
                  var_cas_methodSignature._addAssign_operation (operand_210533->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5477)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_211152 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_211152 = NULL ;
                  while (((operand_211152 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_211152.nextObject ()))) {
                    macroValidPointer (operand_211152) ;
                    var_cas_getIndexMethodSignature._addAssign_operation (operand_211152->mAttributType, var_cas_outPassingMode) ;
                  }
                }
...
pr_semantics_declaration_semantics_parser_5200_4_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_52 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_luintType = GGS_typeGalgas_luint ::constructor_new (_inLexique COMMA_HERE) ;
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_215924 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_215924 = NULL ;
        while (((operand_215924 = (GGS_insertOrSearchMethodList::cElement *) enumerator_215924.nextObject ()))) {
          macroValidPointer (operand_215924) ;
          GGS_L_EXsignature  var_cas_methodSignature ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216108 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216108 = NULL ;
            while (((operand_216108 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_216108.nextObject ()))) {
              macroValidPointer (operand_216108) ;
              var_cas_methodSignature._addAssign_operation (operand_216108->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_215924->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5617)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216538 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216538 = NULL ;
            while (((operand_216538 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_216538.nextObject ()))) {
              macroValidPointer (operand_216538) ;
              var_cas_methodSignature._addAssign_operation (operand_216538->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName ;
          var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (_inLexique, (operand_215924->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5625)))._operator_concat (GGS_string (true, "GetIndex")), operand_215924->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (5625)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_216900 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_216900 = NULL ;
        while (((operand_216900 = (GGS_insertOrSearchMethodList::cElement *) enumerator_216900.nextObject ()))) {
          macroValidPointer (operand_216900) ;
          GGS_L_EXsignature  var_cas_methodSignature ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_217084 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_217084 = NULL ;
            while (((operand_217084 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_217084.nextObject ()))) {
              macroValidPointer (operand_217084) ;
              var_cas_methodSignature._addAssign_operation (operand_217084->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_216900->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5635)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_217515 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_217515 = NULL ;
            while (((operand_217515 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_217515.nextObject ()))) {
              macroValidPointer (operand_217515) ;
              var_cas_methodSignature._addAssign_operation (operand_217515->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName ;
          var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (_inLexique, (operand_216900->mMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5643)))._operator_concat (GGS_string (true, "GetIndex")), operand_216900->mMethodName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (5643)) COMMA_HERE) ;
        ...
        while (syntaxRepeat_55) {
          switch (select_repeat_semantics_parser_55 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_219874 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_219874 = NULL ;
                while (((operand_219874 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_219874.nextObject ()))) {
                  macroValidPointer (operand_219874) ;
                  var_cas_methodSignature._addAssign_operation (operand_219874->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5706)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_220419 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_220419 = NULL ;
                  while (((operand_220419 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_220419.nextObject ()))) {
                    macroValidPointer (operand_220419) ;
                    var_cas_getIndexMethodSignature._addAssign_operation (operand_220419->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221100 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_221100 = NULL ;
                while (((operand_221100 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_221100.nextObject ()))) {
                  macroValidPointer (operand_221100) ;
                  var_cas_methodSignature._addAssign_operation (operand_221100->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5734)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221644 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_221644 = NULL ;
                  while (((operand_221644 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_221644.nextObject ()))) {
                    macroValidPointer (operand_221644) ;
                    var_cas_getIndexMethodSignature._addAssign_operation (operand_221644->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222245 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_222245 = NULL ;
                while (((operand_222245 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_222245.nextObject ()))) {
                  macroValidPointer (operand_222245) ;
                  var_cas_methodSignature._addAssign_operation (operand_222245->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5757)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222830 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_222830 = NULL ;
                  while (((operand_222830 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_222830.nextObject ()))) {
                    macroValidPointer (operand_222830) ;
                    var_cas_getIndexMethodSignature._addAssign_operation (operand_222830->mAttributType, var_cas_outPassingMode) ;
                  }
                }
...
pr_semantics_declaration_semantics_parser_5820_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_58 (_inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_226192 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_226192 = NULL ;
        while (((operand_226192 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_226192.nextObject ()))) {
          macroValidPointer (operand_226192) ;
          var_cas_extractSignature._addAssign_operation (operand_226192->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
          var_cas_inputSignature._addAssign_operation (operand_226192->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        }
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_5820_4_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_58 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228443 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_228443 = NULL ;
        while (((operand_228443 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_228443.nextObject ()))) {
          macroValidPointer (operand_228443) ;
          var_cas_extractSignature._addAssign_operation (operand_228443->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
          var_cas_inputSignature._addAssign_operation (operand_228443->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        }
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_5937_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_59 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_231062 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_231062 = NULL ;
        while (((operand_231062 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_231062.nextObject ()))) {
          macroValidPointer (operand_231062) ;
          var_cas_extractSignature._addAssign_operation (operand_231062->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        }
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      ...
      { bool syntaxRepeat_60 = true ;
        while (syntaxRepeat_60) {
            ...
            if ((var_cas_usedSortedAttributes.reader_hasKey (_inLexique, var_cas_sortAttribute.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (5989)) COMMA_SOURCE_FILE_AT_LINE (5989))).isBuiltAndTrue ()) {
              ...
              GGS_AC_galgasType  var_cas_definitionType ;
              const GGS_typeSemanticAttributesMap  _temp_231899 = var_cas_tableAttributs ;
              if (_temp_231899._isBuilt ()) {
                _temp_231899 (HERE)->method_searchKey (_inLexique, var_cas_sortAttribute, var_cas_definitionType COMMA_SOURCE_FILE_AT_LINE (5993)) ;
              }
              const GGS_AC_galgasType  _temp_231967 = var_cas_definitionType ;
              if (_temp_231967._isBuilt ()) {
                _temp_231967 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (_inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (5994)) ;
              }
...
pr_semantics_declaration_semantics_parser_5937_4_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_59 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList (_inLexique COMMA_HERE) ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234130 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_234130 = NULL ;
        while (((operand_234130 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_234130.nextObject ()))) {
          macroValidPointer (operand_234130) ;
          var_cas_extractSignature._addAssign_operation (operand_234130->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        }
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
void routine_recursivelyEnumerateDirectories (C_Compiler & _inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_240886 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_240886 = NULL ;
    while (((operand_240886 = (GGS_stringlist::cElement *) enumerator_240886.nextObject ()))) {
      macroValidPointer (operand_240886) ;
      if ((var_cas_inExtensionMap.reader_hasKey (_inLexique, operand_240886->mValue.reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (6229)) COMMA_SOURCE_FILE_AT_LINE (6229))).isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath ;
        var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_240886->mValue) ;
        var_cas_outWrapperFileSortedList._addAssign_operation (operand_240886->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, (var_cas_inPathInWrapper)._operator_concat (operand_240886->mValue), GGS_location (_inLexique) COMMA_HERE), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (6238)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_241634 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_241634 = NULL ;
    while (((operand_241634 = (GGS_stringlist::cElement *) enumerator_241634.nextObject ()))) {
      macroValidPointer (operand_241634) ;
      ...
      ::routine_recursivelyEnumerateDirectories (_inLexique,  ((var_cas_inAbsoluteSourcePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_241634->mValue),  ((var_cas_inPathInWrapper)._operator_concat (operand_241634->mValue))._operator_concat (GGS_string (true, "/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (6252)) ;
      var_cas_outWrapperDirectorySortedList._addAssign_operation (operand_241634->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
pr_formal_argument_type_semantics_parser_6823_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (6830)) COMMA_SOURCE_FILE_AT_LINE (6830))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  _temp_261791 = var_cas_inComponentSemanticsEntitiesMap ;
    if (_temp_261791._isBuilt ()) {
      _temp_261791 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (6832)) ;
    }
    ...
    const GGS_typeTableEnAvant  _temp_261983 = var_cas_tableEnAvant ;
    if (_temp_261983._isBuilt ()) {
      _temp_261983 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (6835)) ;
    }
  }
}
...
pr_formal_argument_type_semantics_parser_6845_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (6853)) COMMA_SOURCE_FILE_AT_LINE (6853))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  _temp_262624 = var_cas_inComponentSemanticsEntitiesMap ;
    if (_temp_262624._isBuilt ()) {
      _temp_262624 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (6855)) ;
    }
    ...
    const GGS_typeTableEnAvant  _temp_262816 = var_cas_tableEnAvant ;
    if (_temp_262816._isBuilt ()) {
      _temp_262816 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (6858)) ;
    }
...
pr_formal_argument_type_semantics_parser_6870_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (6878)) COMMA_SOURCE_FILE_AT_LINE (6878))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  _temp_263594 = var_cas_inComponentSemanticsEntitiesMap ;
    if (_temp_263594._isBuilt ()) {
      _temp_263594 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (6880)) ;
    }
    ...
    const GGS_typeTableEnAvant  _temp_263786 = var_cas_tableEnAvant ;
    if (_temp_263786._isBuilt ()) {
      _temp_263786 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (6883)) ;
    }
...
pr_formal_argument_type_semantics_parser_6895_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (6904)) COMMA_SOURCE_FILE_AT_LINE (6904))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  _temp_264579 = var_cas_inComponentSemanticsEntitiesMap ;
    if (_temp_264579._isBuilt ()) {
      _temp_264579 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (6906)) ;
    }
    ...
    const GGS_typeTableEnAvant  _temp_264771 = var_cas_tableEnAvant ;
    if (_temp_264771._isBuilt ()) {
      _temp_264771 (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (6909)) ;
    }
    ...
    while (syntaxRepeat_74) {
      switch (select_repeat_semantics_parser_74 (_inLexique)) {
        case 2 : {
          ...
          { bool syntaxRepeat_77 = true ;
            while (syntaxRepeat_77) {
                ...
                const GGS_enumConstantMap  _temp_271055 = var_cas_constantMap ;
                if (_temp_271055._isBuilt ()) {
                  _temp_271055 (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_34 COMMA_SOURCE_FILE_AT_LINE (7073)) ;
                }
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  _temp_271248 = var_cas_constantMap ;
                if (_temp_271248._isBuilt ()) {
                  _temp_271248 (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_35 COMMA_SOURCE_FILE_AT_LINE (7078)) ;
                }
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D_3E) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  _temp_271447 = var_cas_constantMap ;
                if (_temp_271447._isBuilt ()) {
                  _temp_271447 (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_36 COMMA_SOURCE_FILE_AT_LINE (7083)) ;
                }
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_81 = true ;
            while (syntaxRepeat_81) {
                ...
                const GGS_enumConstantMap  _temp_274079 = var_cas_constantMap ;
                if (_temp_274079._isBuilt ()) {
                  _temp_274079 (HERE)->method_searchKey (_inLexique, var_cas_sourceName, automatic_var_37 COMMA_SOURCE_FILE_AT_LINE (7156)) ;
                }
                ...
                const GGS_enumConstantMap  _temp_274252 = var_cas_constantMap ;
                if (_temp_274252._isBuilt ()) {
                  _temp_274252 (HERE)->method_searchKey (_inLexique, var_cas_targetName, automatic_var_38 COMMA_SOURCE_FILE_AT_LINE (7161)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList ;
                var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList (_inLexique COMMA_HERE) ;
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_274983 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_274983 = NULL ;
            while (((operand_274983 = (GGS_enumConstantMap::cElement *) enumerator_274983.nextObject ()))) {
              macroValidPointer (operand_274983) ;
              if (((var_cas_definedSourceMap.reader_hasKey (_inLexique, operand_274983->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (7187)) COMMA_SOURCE_FILE_AT_LINE (7187)))._operator_not ()).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The '"))._operator_concat (operand_274983->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (7188))))._operator_concat (GGS_string (true, "' is not handled")) COMMA_SOURCE_FILE_AT_LINE (7188)) ;
              }
            }
          }
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_85 = true ;
            while (syntaxRepeat_85) {
                ...
                const GGS_enumConstantMap  _temp_276994 = var_cas_constantMap ;
                if (_temp_276994._isBuilt ()) {
                  _temp_276994 (HERE)->method_searchKey (_inLexique, var_cas_sourceName, automatic_var_39 COMMA_SOURCE_FILE_AT_LINE (7233)) ;
                }
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_277764 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_277764 = NULL ;
            while (((operand_277764 = (GGS_enumConstantMap::cElement *) enumerator_277764.nextObject ()))) {
              macroValidPointer (operand_277764) ;
              if (((var_cas_definedSourceMap.reader_hasKey (_inLexique, operand_277764->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (7260)) COMMA_SOURCE_FILE_AT_LINE (7260)))._operator_not ()).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The '"))._operator_concat (operand_277764->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (7261))))._operator_concat (GGS_string (true, "' is not handled")) COMMA_SOURCE_FILE_AT_LINE (7261)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_278612 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_278612 = NULL ;
            while (((operand_278612 = (GGS_enumConstantMap::cElement *) enumerator_278612.nextObject ()))) {
              macroValidPointer (operand_278612) ;
              GGS_lstring  var_cas_name ;
              var_cas_name = GGS_lstring ::constructor_new (_inLexique, operand_278612->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (7287)), GGS_location (_inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  _temp_278776 = var_cas_cstMessageStringMap ;
              if (_temp_278776._isBuilt ()) {
                _temp_278776 (HERE)->method_searchKey (_inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (7289)) ;
              }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_77 = true ;
            while (syntaxRepeat_77) {
                ...
                const GGS_enumConstantMap  _temp_282518 = var_cas_constantMap ;
                if (_temp_282518._isBuilt ()) {
                  _temp_282518 (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (7401)) ;
                }
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
                GGS_lstring  var_cas_rightConstant ;
                _inLexique._assignFromAttribute_tokenString (var_cas_rightConstant) ;
                ...
                const GGS_enumConstantMap  _temp_282711 = var_cas_constantMap ;
                if (_temp_282711._isBuilt ()) {
                  _temp_282711 (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_41 COMMA_SOURCE_FILE_AT_LINE (7406)) ;
                }
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D_3E) COMMA_HERE) ;
                GGS_lstring  var_cas_targetConstant ;
                _inLexique._assignFromAttribute_tokenString (var_cas_targetConstant) ;
                ...
                const GGS_enumConstantMap  _temp_282910 = var_cas_constantMap ;
                if (_temp_282910._isBuilt ()) {
                  _temp_282910 (HERE)->method_searchKeyAndGetIndex (_inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_42 COMMA_SOURCE_FILE_AT_LINE (7411)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList ;
                var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList (_inLexique COMMA_HERE) ;
                switch (select_semantics_parser_78 (_inLexique)) {
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_81 = true ;
            while (syntaxRepeat_81) {
                ...
                const GGS_enumConstantMap  _temp_284263 = var_cas_constantMap ;
                if (_temp_284263._isBuilt ()) {
                  _temp_284263 (HERE)->method_searchKey (_inLexique, var_cas_sourceName, automatic_var_43 COMMA_SOURCE_FILE_AT_LINE (7458)) ;
                }
                ...
                const GGS_enumConstantMap  _temp_284436 = var_cas_constantMap ;
                if (_temp_284436._isBuilt ()) {
                  _temp_284436 (HERE)->method_searchKey (_inLexique, var_cas_targetName, automatic_var_44 COMMA_SOURCE_FILE_AT_LINE (7463)) ;
                }
                switch (select_semantics_parser_82 (_inLexique)) {
                  case 1 : {
                    _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_85 = true ;
            while (syntaxRepeat_85) {
                ...
                const GGS_enumConstantMap  _temp_285587 = var_cas_constantMap ;
                if (_temp_285587._isBuilt ()) {
                  _temp_285587 (HERE)->method_searchKey (_inLexique, var_cas_sourceName, automatic_var_45 COMMA_SOURCE_FILE_AT_LINE (7502)) ;
                }
