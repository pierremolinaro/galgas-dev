...
pr_semantic_instruction_semantics_parser_4762_27_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_49) {
      switch (select_repeat_semantics_parser_49 (inLexique)) {
        case 2 : {
          ...
          GGS_bool var_cas_found = GGS_bool (false) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_181715 (var_cas_structType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (4800)), true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_181715 = NULL ;
            while (((operand_181715 = enumerator_181715.nextObject ()))
                && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
              macroValidPointer (operand_181715) ;
              var_cas_found = (operand_181715->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4801))).operator_isEqual (var_cas_structAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4801))) ;
              var_cas_targetType = operand_181715->mAttributType ;
            }
          }
          if (((var_cas_found).operator_not ()).isBuiltAndTrue ()) {
  ...
  const GGS_AC_galgasType  temp_182613 = var_cas_targetType ;
  if (temp_182613.isBuilt ()) {
    temp_182613 (HERE)->method_check_with_InstructionAccess (inLexique, var_cas_instructionLocation, var_cas_searchMethodName, var_cas_keyExpressionType, var_cas_mapTypeName, var_cas_errorMessageName, var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (4825)) ;
  }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_183304 (var_cas_attributeList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_183304 = NULL ;
    while (((operand_183304 = enumerator_183304.nextObject ()))) {
      macroValidPointer (operand_183304) ;
      var_cas_ioVariablesMap.modifier_insertWithInstructionLocalVariable (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefixString).operator_concat (operand_183304->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4848))), var_cas_instructionLocation COMMA_HERE), operand_183304->mAttributType, GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_183304->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4850)), GGS_bool (true), GGS_bool (false) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (4847)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
...
pr_constant_while_before_in_foreach_instruction_semantics_parser_4902_51_secondPhase (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_51 = true ;
    while (syntaxRepeat_51) {
        ...
        const GGS_AC_galgasType  temp_188365 = var_cas_sourceExpressionType ;
        if (temp_188365.isBuilt ()) {
          temp_188365 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_magicNumber, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (5016)) ;
        }
        GGS_string var_cas_typeName ;
        const GGS_AC_galgasType  temp_188623 = var_cas_sourceExpressionType ;
        if (temp_188623.isBuilt ()) {
          temp_188623 (HERE)->method_getTypeName (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (5025)) ;
        }
        ...
        switch (select_semantics_parser_54 (inLexique)) {
          case 1 : {
            ...
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_189210 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_189210 = NULL ;
              while (((operand_189210 = enumerator_189210.nextObject ()))) {
                macroValidPointer (operand_189210) ;
                var_cas_listOfAttributes.appendCString (" ") ;
                var_cas_listOfAttributes.dotAssign_operation (var_cas_prefix) ;
                var_cas_listOfAttributes.dotAssign_operation (operand_189210->mAttributeName) ;
              }
            }
          ...
          case 2 : {
            ...
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_189581 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_189581 = NULL ;
              while (((operand_189581 = enumerator_189581.nextObject ()))) {
                macroValidPointer (operand_189581) ;
                ...
                if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
                  ...
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_189581->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5058)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefix).operator_concat (operand_189581->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5060))), GGS_location (inLexique) COMMA_HERE), operand_189581->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5060)) ;
...
pr_semantic_instruction_semantics_parser_5119_27_ (galgas_scanner & inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_193061 = inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    inLexique.setParsingContext (context_193061) ;
  ...
  switch (select_semantics_parser_58 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_193514 = var_cas_indexVariable ; // CAST instruction
        if (_var_193514.getPtr () != NULL) {
          macroValidPointer (_var_193514.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_193514.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_193514.getPtr ()) ;
  ...
  switch (select_semantics_parser_59 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_194281 = var_cas_indexVariable ; // CAST instruction
        if (_var_194281.getPtr () != NULL) {
          macroValidPointer (_var_194281.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_194281.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_194281.getPtr ()) ;
...
pr_parse_match_operand_semantics_parser_5229_26_ (galgas_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_196334 = var_cas_type ; // CAST instruction
    if (_var_196334.getPtr () != NULL) {
      macroValidPointer (_var_196334.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_196334.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_t (_var_196334.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (_var_196334.getPtr ()) != NULL) {
        const GGS_typeGalgas_enum var_cas_e (_var_196334.getPtr ()) ;
        ...
        const GGS_AC_galgasType  temp_196098 = var_cas_type ;
        if (temp_196098.isBuilt ()) {
          temp_196098 (HERE)->method_getTypeName (inLexique, var_cas_actualTypeName COMMA_SOURCE_FILE_AT_LINE (5257)) ;
        }
...
pr_parse_match_case_semantics_parser_5267_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_196882 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_196882.isBuilt ()) {
    temp_196882 (HERE)->method_searchKey (inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (5280)) ;
  }
...
pr_parse_match_case_semantics_parser_5310_23_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    ...
    const GGS_enumConstantMap  temp_198683 = var_cas_inEnumMessageMap ;
    if (temp_198683.isBuilt ()) {
      temp_198683 (HERE)->method_searchKey (inLexique, var_cas_outEnumConstantName, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (5323)) ;
    }
  }else{
...
pr_optional_assignment_semantics_parser_5523_26_ (galgas_scanner & inLexique,
  ...
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_206086 = var_cas_inVariableType ;
  if (temp_206086.isBuilt ()) {
    temp_206086 (HERE)->method_handleConstructorCall (inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (5541)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_5571_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_62 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_208230 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_208230.isBuilt ()) {
        temp_208230 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5595)) ;
      }
...
pr_semantics_declaration_semantics_parser_5571_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_62 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_210755 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_210755.isBuilt ()) {
        temp_210755 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5661)) ;
      }
...
pr_semantics_declaration_semantics_parser_5704_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_64 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_216261 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_216261 = NULL ;
        while (((operand_216261 = enumerator_216261.nextObject ()))) {
          macroValidPointer (operand_216261) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216458 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216458 = NULL ;
            while (((operand_216458 = enumerator_216458.nextObject ()))) {
              macroValidPointer (operand_216458) ;
              var_cas_methodSignature.addAssign_operation (operand_216458->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_216261->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5811)) ;
          ...
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            ...
            while (((operand_216888 = enumerator_216888.nextObject ()))) {
              ...
              var_cas_methodSignature.addAssign_operation (operand_216888->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_216261->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5819))).operator_concat (GGS_string ("GetIndex")), operand_216261->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5819)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_217237 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_217237 = NULL ;
        while (((operand_217237 = enumerator_217237.nextObject ()))) {
          macroValidPointer (operand_217237) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_217432 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_217432 = NULL ;
            while (((operand_217432 = enumerator_217432.nextObject ()))) {
              macroValidPointer (operand_217432) ;
              var_cas_methodSignature.addAssign_operation (operand_217432->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_217237->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5829)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_217860 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_217860 = NULL ;
            while (((operand_217860 = enumerator_217860.nextObject ()))) {
              macroValidPointer (operand_217860) ;
              var_cas_methodSignature.addAssign_operation (operand_217860->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_217237->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5837))).operator_concat (GGS_string ("GetIndex")), operand_217237->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5837)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_67) {
          switch (select_repeat_semantics_parser_67 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221254 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_221254 = NULL ;
                while (((operand_221254 = enumerator_221254.nextObject ()))) {
                  macroValidPointer (operand_221254) ;
                  var_cas_methodSignature.addAssign_operation (operand_221254->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5916))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221843 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_221843 = NULL ;
                  while (((operand_221843 = enumerator_221843.nextObject ()))) {
                    macroValidPointer (operand_221843) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_221843->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222939 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_222939 = NULL ;
                while (((operand_222939 = enumerator_222939.nextObject ()))) {
                  macroValidPointer (operand_222939) ;
                  var_cas_methodSignature.addAssign_operation (operand_222939->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5953))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_223543 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_223543 = NULL ;
                  while (((operand_223543 = enumerator_223543.nextObject ()))) {
                    macroValidPointer (operand_223543) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_223543->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5980))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_224944 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_224944 = NULL ;
                  while (((operand_224944 = enumerator_224944.nextObject ()))) {
                    macroValidPointer (operand_224944) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_224944->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_225345 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_225345 = NULL ;
        while (((operand_225345 = enumerator_225345.nextObject ()))) {
          macroValidPointer (operand_225345) ;
          if ((operand_225345->mInfo.mHasSetter).isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_225345->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5994)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (5994)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_225345->mInfo.mAttributType, var_cas_inPassingMode) ;
...
pr_semantics_declaration_semantics_parser_5704_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_64 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType = GGS_typeGalgas_luint ::constructor_new (inLexique COMMA_HERE) ;
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_230182 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_230182 = NULL ;
        while (((operand_230182 = enumerator_230182.nextObject ()))) {
          macroValidPointer (operand_230182) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230379 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_230379 = NULL ;
            while (((operand_230379 = enumerator_230379.nextObject ()))) {
              macroValidPointer (operand_230379) ;
              var_cas_methodSignature.addAssign_operation (operand_230379->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_230182->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6130)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230809 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_230809 = NULL ;
            while (((operand_230809 = enumerator_230809.nextObject ()))) {
              macroValidPointer (operand_230809) ;
              var_cas_methodSignature.addAssign_operation (operand_230809->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_230182->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6138))).operator_concat (GGS_string ("GetIndex")), operand_230182->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6138)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_231158 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_231158 = NULL ;
        while (((operand_231158 = enumerator_231158.nextObject ()))) {
          macroValidPointer (operand_231158) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_231355 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_231355 = NULL ;
            while (((operand_231355 = enumerator_231355.nextObject ()))) {
              macroValidPointer (operand_231355) ;
              var_cas_methodSignature.addAssign_operation (operand_231355->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_231158->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6148)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_231786 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_231786 = NULL ;
            while (((operand_231786 = enumerator_231786.nextObject ()))) {
              macroValidPointer (operand_231786) ;
              var_cas_methodSignature.addAssign_operation (operand_231786->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_231158->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6156))).operator_concat (GGS_string ("GetIndex")), operand_231158->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6156)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_67) {
          switch (select_repeat_semantics_parser_67 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234145 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_234145 = NULL ;
                while (((operand_234145 = enumerator_234145.nextObject ()))) {
                  macroValidPointer (operand_234145) ;
                  var_cas_methodSignature.addAssign_operation (operand_234145->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6219))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234690 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_234690 = NULL ;
                  while (((operand_234690 = enumerator_234690.nextObject ()))) {
                    macroValidPointer (operand_234690) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_234690->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_235371 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_235371 = NULL ;
                while (((operand_235371 = enumerator_235371.nextObject ()))) {
                  macroValidPointer (operand_235371) ;
                  var_cas_methodSignature.addAssign_operation (operand_235371->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6247))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_235915 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_235915 = NULL ;
                  while (((operand_235915 = enumerator_235915.nextObject ()))) {
                    macroValidPointer (operand_235915) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_235915->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_236516 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_236516 = NULL ;
                while (((operand_236516 = enumerator_236516.nextObject ()))) {
                  macroValidPointer (operand_236516) ;
                  var_cas_methodSignature.addAssign_operation (operand_236516->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6270))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_237101 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_237101 = NULL ;
                  while (((operand_237101 = enumerator_237101.nextObject ()))) {
                    macroValidPointer (operand_237101) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_237101->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_237420 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_237420 = NULL ;
        while (((operand_237420 = enumerator_237420.nextObject ()))) {
          macroValidPointer (operand_237420) ;
          if ((operand_237420->mInfo.mHasSetter).isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_237420->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6283)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (6283)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_237420->mInfo.mAttributType, var_cas_inPassingMode) ;
            var_cas_modifierSignature.addAssign_operation (GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_inPassingMode) ;
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6343_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_240824 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_240824.isBuilt ()) {
    temp_240824 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6373)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_241293 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_241293 = NULL ;
    while (((operand_241293 = enumerator_241293.nextObject ()))) {
      macroValidPointer (operand_241293) ;
      GGS_string var_cas_keyClassMethod = ((operand_241293->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6381))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6381))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6382)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6382))).isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_241293->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6385)) ;
      }
    }
  }
...
pr_semantics_declaration_semantics_parser_6439_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_245133 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_245133.isBuilt ()) {
    temp_245133 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6475)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_245727 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_245727 = NULL ;
      while (((operand_245727 = enumerator_245727.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_245727) ;
        GGS_string var_cas_keyClassMethod = ((operand_245727->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6485))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6485))) ;
        var_cas_baseClassName = operand_245727->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6486)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          ...
          const GGS_EXcategoryMethodMap  temp_246127 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6491)) ;
          if (temp_246127.isBuilt ()) {
            temp_246127 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_categoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6491)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_246745 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_246745 = NULL ;
      while (((operand_246745 = enumerator_246745.nextObject ()))) {
        macroValidPointer (operand_246745) ;
        GGS_string var_cas_keyClassMethod = ((operand_246745->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6506))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6506))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6507)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6507))).isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_246745->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6510)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_247202 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6515)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_247202 = NULL ;
    while (((operand_247202 = enumerator_247202.nextObject ()))) {
      macroValidPointer (operand_247202) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6517)), operand_247202->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6518)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_247202->mAttributeName, operand_247202->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6522)) ;
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6599_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_251639 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_251639.isBuilt ()) {
    temp_251639 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6631)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_252156 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_252156.isBuilt ()) {
    temp_252156 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6637)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_252625 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_252625 = NULL ;
    while (((operand_252625 = enumerator_252625.nextObject ()))) {
      macroValidPointer (operand_252625) ;
      GGS_string var_cas_keyClassMethod = ((operand_252625->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6645))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6645))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6646)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6646))).isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_252625->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6649)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6599_50_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_254531 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_254531.isBuilt ()) {
    temp_254531 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6697)) ;
  }
...
pr_semantics_declaration_semantics_parser_6713_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_256820 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_256820.isBuilt ()) {
    temp_256820 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6749)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_257690 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_257690.isBuilt ()) {
    temp_257690 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6759)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_258284 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_258284 = NULL ;
      while (((operand_258284 = enumerator_258284.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_258284) ;
        GGS_string var_cas_keyClassMethod = ((operand_258284->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6769))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6769))) ;
        var_cas_baseClassName = operand_258284->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6770)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          ...
          const GGS_EXcategoryReaderMap  temp_258741 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6776)) ;
          if (temp_258741.isBuilt ()) {
            temp_258741 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_categoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (6776)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_259645 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_259645 = NULL ;
      while (((operand_259645 = enumerator_259645.nextObject ()))) {
        macroValidPointer (operand_259645) ;
        GGS_string var_cas_keyClassMethod = ((operand_259645->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6802))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6802))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6803)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6803))).isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_259645->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6806)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_260102 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6811)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_260102 = NULL ;
    while (((operand_260102 = enumerator_260102.nextObject ()))) {
      macroValidPointer (operand_260102) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6813)), operand_260102->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6814)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_260102->mAttributeName, operand_260102->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6818)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6713_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_262595 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_262595.isBuilt ()) {
    temp_262595 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6884)) ;
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6905_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_265054 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_265054.isBuilt ()) {
    temp_265054 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6936)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_265523 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_265523 = NULL ;
    while (((operand_265523 = enumerator_265523.nextObject ()))) {
      macroValidPointer (operand_265523) ;
      GGS_string var_cas_keyClassMethod = ((operand_265523->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6944))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6944))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6945)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6945))).isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_265523->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6948)) ;
      }
    }
  }
...
pr_semantics_declaration_semantics_parser_7002_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_269511 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_269511.isBuilt ()) {
    temp_269511 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7039)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_270105 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_270105 = NULL ;
      while (((operand_270105 = enumerator_270105.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_270105) ;
        GGS_string var_cas_keyClassMethod = ((operand_270105->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7049))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7049))) ;
        var_cas_baseClassName = operand_270105->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7050)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_categoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_270511 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7055)) ;
          if (temp_270511.isBuilt ()) {
            temp_270511 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_categoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7055)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_271194 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_271194 = NULL ;
      while (((operand_271194 = enumerator_271194.nextObject ()))) {
        macroValidPointer (operand_271194) ;
        GGS_string var_cas_keyClassMethod = ((operand_271194->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7074))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7074))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7075)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (7075))).isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_271194->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7078)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_271659 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7083)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_271659 = NULL ;
    while (((operand_271659 = enumerator_271659.nextObject ()))) {
      macroValidPointer (operand_271659) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7085)), operand_271659->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7086)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_271659->mAttributeName, operand_271659->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7090)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_7176_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276406 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_276406 = NULL ;
        while (((operand_276406 = enumerator_276406.nextObject ()))) {
          macroValidPointer (operand_276406) ;
          var_cas_extractSignature.addAssign_operation (operand_276406->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_276406->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7176_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_278596 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_278596 = NULL ;
        while (((operand_278596 = enumerator_278596.nextObject ()))) {
          macroValidPointer (operand_278596) ;
          var_cas_extractSignature.addAssign_operation (operand_278596->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_278596->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7291_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_75 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_281155 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_281155 = NULL ;
        while (((operand_281155 = enumerator_281155.nextObject ()))) {
          macroValidPointer (operand_281155) ;
          var_cas_extractSignature.addAssign_operation (operand_281155->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_76 = true ;
        while (syntaxRepeat_76) {
            ...
            if ((var_cas_usedSortedAttributes.reader_hasKey (inLexique, var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7342)) COMMA_SOURCE_FILE_AT_LINE (7342))).isBuiltAndTrue ()) {
              ...
              const GGS_typeSemanticAttributesMap  temp_281972 = var_cas_tableAttributs ;
              if (temp_281972.isBuilt ()) {
                temp_281972 (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_34, automatic_var_35 COMMA_SOURCE_FILE_AT_LINE (7346)) ;
              }
              const GGS_AC_galgasType  temp_282076 = var_cas_definitionType ;
              if (temp_282076.isBuilt ()) {
                temp_282076 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (7347)) ;
              }
...
pr_semantics_declaration_semantics_parser_7291_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_75 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_284169 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_284169 = NULL ;
        while (((operand_284169 = enumerator_284169.nextObject ()))) {
          macroValidPointer (operand_284169) ;
          var_cas_extractSignature.addAssign_operation (operand_284169->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasSortedListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7505_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_288391 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_288391.isBuilt ()) {
    temp_288391 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7522)) ;
  }
...
pr_semantics_declaration_semantics_parser_7505_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_289672 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_289672.isBuilt ()) {
    temp_289672 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7556)) ;
  }
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_294408 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_294408 = NULL ;
    while (((operand_294408 = enumerator_294408.nextObject ()))) {
      macroValidPointer (operand_294408) ;
      if ((var_cas_inExtensionMap.reader_hasKey (inLexique, operand_294408->mValue.reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (7674)) COMMA_SOURCE_FILE_AT_LINE (7674))).isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_294408->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_294408->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_294408->mValue), GGS_location (inLexique) COMMA_HERE), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (7683)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_295162 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_295162 = NULL ;
    while (((operand_295162 = enumerator_295162.nextObject ()))) {
      macroValidPointer (operand_295162) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_295162->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_295162->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (7698)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_295162->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
pr_formal_argument_type_semantics_parser_8265_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8272)) COMMA_SOURCE_FILE_AT_LINE (8272))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_314871 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_314871.isBuilt ()) {
      temp_314871 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8274)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_315063 = var_cas_tableEnAvant ;
    if (temp_315063.isBuilt ()) {
      temp_315063 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8277)) ;
    }
  }
}
...
pr_formal_argument_type_semantics_parser_8287_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8295)) COMMA_SOURCE_FILE_AT_LINE (8295))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_315704 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_315704.isBuilt ()) {
      temp_315704 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8297)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_315896 = var_cas_tableEnAvant ;
    if (temp_315896.isBuilt ()) {
      temp_315896 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8300)) ;
    }
...
pr_formal_argument_type_semantics_parser_8312_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8320)) COMMA_SOURCE_FILE_AT_LINE (8320))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_316674 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_316674.isBuilt ()) {
      temp_316674 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8322)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_316866 = var_cas_tableEnAvant ;
    if (temp_316866.isBuilt ()) {
      temp_316866 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8325)) ;
    }
...
pr_formal_argument_type_semantics_parser_8337_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8346)) COMMA_SOURCE_FILE_AT_LINE (8346))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_317659 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_317659.isBuilt ()) {
      temp_317659 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8348)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_317851 = var_cas_tableEnAvant ;
    if (temp_317851.isBuilt ()) {
      temp_317851 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8351)) ;
    }
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8432_47_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_321998 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_321998 = NULL ;
    while (((operand_321998 = enumerator_321998.nextObject ()))) {
      macroValidPointer (operand_321998) ;
      if (((operand_321998->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_321998->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8461)) ;
      }else if (((operand_321998->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_321998->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8463)) ;
      }
    }
  }
  GGS_EXformalArgumentPassingMode var_cas_passingMode = GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE) ;
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8432_47_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_324257 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_324257 = NULL ;
    while (((operand_324257 = enumerator_324257.nextObject ()))) {
      macroValidPointer (operand_324257) ;
      if (((operand_324257->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_324257->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8515)) ;
      }else if (((operand_324257->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_324257->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8517)) ;
      }
    }
  }
  GGS_EXformalArgumentPassingMode var_cas_passingMode = GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE) ;
    ...
    while (syntaxRepeat_93) {
      switch (select_repeat_semantics_parser_93 (inLexique)) {
        case 2 : {
          ...
          { bool syntaxRepeat_96 = true ;
            while (syntaxRepeat_96) {
                ...
                const GGS_enumConstantMap  temp_328787 = var_cas_constantMap ;
                if (temp_328787.isBuilt ()) {
                  temp_328787 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_38 COMMA_SOURCE_FILE_AT_LINE (8627)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_328980 = var_cas_constantMap ;
                if (temp_328980.isBuilt ()) {
                  temp_328980 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_39 COMMA_SOURCE_FILE_AT_LINE (8632)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_329179 = var_cas_constantMap ;
                if (temp_329179.isBuilt ()) {
                  temp_329179 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (8637)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_100 = true ;
            while (syntaxRepeat_100) {
                ...
                const GGS_enumConstantMap  temp_331826 = var_cas_constantMap ;
                if (temp_331826.isBuilt ()) {
                  temp_331826 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_41 COMMA_SOURCE_FILE_AT_LINE (8710)) ;
                }
                ...
                const GGS_enumConstantMap  temp_331999 = var_cas_constantMap ;
                if (temp_331999.isBuilt ()) {
                  temp_331999 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_42 COMMA_SOURCE_FILE_AT_LINE (8715)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_332732 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_332732 = NULL ;
            while (((operand_332732 = enumerator_332732.nextObject ()))) {
              macroValidPointer (operand_332732) ;
              if (((var_cas_definedSourceMap.reader_hasKey (inLexique, operand_332732->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8741)) COMMA_SOURCE_FILE_AT_LINE (8741))).operator_not ()).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_332732->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8742)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8743)) ;
              }
            }
          }
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_104 = true ;
            while (syntaxRepeat_104) {
                ...
                const GGS_enumConstantMap  temp_334767 = var_cas_constantMap ;
                if (temp_334767.isBuilt ()) {
                  temp_334767 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_43 COMMA_SOURCE_FILE_AT_LINE (8787)) ;
                }
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_335539 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_335539 = NULL ;
            while (((operand_335539 = enumerator_335539.nextObject ()))) {
              macroValidPointer (operand_335539) ;
              if (((var_cas_definedSourceMap.reader_hasKey (inLexique, operand_335539->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8814)) COMMA_SOURCE_FILE_AT_LINE (8814))).operator_not ()).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_335539->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8815)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8816)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_336414 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_336414 = NULL ;
            while (((operand_336414 = enumerator_336414.nextObject ()))) {
              macroValidPointer (operand_336414) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_336414->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8843)), GGS_location (inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  temp_336576 = var_cas_cstMessageStringMap ;
              if (temp_336576.isBuilt ()) {
                temp_336576 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (8845)) ;
              }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_96 = true ;
            while (syntaxRepeat_96) {
                ...
                const GGS_enumConstantMap  temp_340295 = var_cas_constantMap ;
                if (temp_340295.isBuilt ()) {
                  temp_340295 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_44 COMMA_SOURCE_FILE_AT_LINE (8956)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                GGS_lstring  var_cas_rightConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_rightConstant) ;
                ...
                const GGS_enumConstantMap  temp_340488 = var_cas_constantMap ;
                if (temp_340488.isBuilt ()) {
                  temp_340488 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_45 COMMA_SOURCE_FILE_AT_LINE (8961)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                GGS_lstring  var_cas_targetConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_targetConstant) ;
                ...
                const GGS_enumConstantMap  temp_340687 = var_cas_constantMap ;
                if (temp_340687.isBuilt ()) {
                  temp_340687 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_46 COMMA_SOURCE_FILE_AT_LINE (8966)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
                switch (select_semantics_parser_97 (inLexique)) {
                  case 1 : {
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_100 = true ;
            while (syntaxRepeat_100) {
                ...
                const GGS_enumConstantMap  temp_342029 = var_cas_constantMap ;
                if (temp_342029.isBuilt ()) {
                  temp_342029 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_47 COMMA_SOURCE_FILE_AT_LINE (9013)) ;
                }
                ...
                const GGS_enumConstantMap  temp_342202 = var_cas_constantMap ;
                if (temp_342202.isBuilt ()) {
                  temp_342202 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_48 COMMA_SOURCE_FILE_AT_LINE (9018)) ;
                }
                switch (select_semantics_parser_101 (inLexique)) {
                  case 1 : {
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_104 = true ;
            while (syntaxRepeat_104) {
                ...
                const GGS_enumConstantMap  temp_343353 = var_cas_constantMap ;
                if (temp_343353.isBuilt ()) {
                  temp_343353 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_49 COMMA_SOURCE_FILE_AT_LINE (9057)) ;
                }
