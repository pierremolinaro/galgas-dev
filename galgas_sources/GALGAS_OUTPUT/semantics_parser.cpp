        ...
        while (syntaxRepeat_74) {
          switch (select_semantics_5F_parser_74 (inLexique)) {
            case 2 : {
                ...
                while (syntaxRepeat_75) {
                  switch (select_semantics_5F_parser_75 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_234063 = (var_cas_neededAssociations.reader_hasKey (var_cas_association)).operator_not () ;
                      if (cond_234063.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_234243 = var_cas_handledAssociations.reader_hasKey (var_cas_association) ;
                      if (cond_234243.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_235012 = (var_cas_startStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))).operator_isNotEqual (var_cas_finalStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))) ;
                      if (cond_235012.isBuiltAndTrue ()) {
                        ...
                        const GGS_bool cond_234995 = (var_cas_accessibilityGraph.reader_hasKey (((var_cas_startStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))).operator_concat (GGS_string (":"))).operator_concat (var_cas_finalStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))))).operator_not () ;
                        if (cond_234995.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_236428 = (var_cas_forgottenAssociations.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_236428.isBuiltAndTrue ()) {
                GGS_string var_cas_s = GGS_string ("") ;
                {
                  GGS_stringset::cEnumerator enumerator_236259 (var_cas_forgottenAssociations, true) ;
                  while (enumerator_236259.hasCurrentObject ()) {
                    var_cas_s.appendCString ("\n"
                      "  - ") ;
                    var_cas_s.dotAssign_operation (enumerator_236259._key (HERE)) ;
                    enumerator_236259.next () ;
                  }
                }
                ...
                while (syntaxRepeat_77) {
                  switch (select_semantics_5F_parser_77 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_237322 = (var_cas_neededCombinaisons.reader_hasKey (var_cas_combinaison)).operator_not () ;
                      if (cond_237322.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_237539 = var_cas_definedCombinaisons.reader_hasKey (var_cas_combinaison) ;
                      if (cond_237539.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_240232 = (var_cas_forgottenAssociations.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_240232.isBuiltAndTrue ()) {
                ...
                const GGS_bool cond_240217 = (var_cas_forgottenCombinaisons.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_240217.isBuiltAndTrue ()) {
                  GGS_string var_cas_s = GGS_string ("") ;
                  {
                    GGS_stringset::cEnumerator enumerator_240044 (var_cas_forgottenCombinaisons, true) ;
                    while (enumerator_240044.hasCurrentObject ()) {
                      var_cas_s.appendCString ("\n"
                        "  - ") ;
                      var_cas_s.dotAssign_operation (enumerator_240044._key (HERE)) ;
                      enumerator_240044.next () ;
                    }
                  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_242003 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432))))).operator_not () ;
      if (cond_242003.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_244935 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_244935 = NULL ;
        while (((operand_244935 = enumerator_244935.nextObject ()))) {
          macroValidPointer (operand_244935) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245112 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245112 = NULL ;
            while (((operand_245112 = enumerator_245112.nextObject ()))) {
              macroValidPointer (operand_245112) ;
              var_cas_methodSignature.addAssign_operation (operand_245112->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_244935->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6523)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245514 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245514 = NULL ;
            while (((operand_245514 = enumerator_245514.nextObject ()))) {
              macroValidPointer (operand_245514) ;
              var_cas_methodSignature.addAssign_operation (operand_245514->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_244935->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6531))).operator_concat (GGS_string ("GetIndex")), operand_244935->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6531)) COMMA_SOURCE_FILE_AT_LINE (6531)) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_245842 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_245842 = NULL ;
        while (((operand_245842 = enumerator_245842.nextObject ()))) {
          macroValidPointer (operand_245842) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246019 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246019 = NULL ;
            while (((operand_246019 = enumerator_246019.nextObject ()))) {
              macroValidPointer (operand_246019) ;
              var_cas_methodSignature.addAssign_operation (operand_246019->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_245842->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6541)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246422 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246422 = NULL ;
            while (((operand_246422 = enumerator_246422.nextObject ()))) {
              macroValidPointer (operand_246422) ;
              var_cas_methodSignature.addAssign_operation (operand_246422->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_245842->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6549))).operator_concat (GGS_string ("GetIndex")), operand_245842->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6549)) COMMA_SOURCE_FILE_AT_LINE (6549)) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_70) {
          switch (select_semantics_5F_parser_70 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_250536 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_250536 = NULL ;
                while (((operand_250536 = enumerator_250536.nextObject ()))) {
                  macroValidPointer (operand_250536) ;
                  var_cas_methodSignature.addAssign_operation (operand_250536->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_remove) COMMA_HERE) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  automatic_var_250816_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, automatic_var_250816_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251023 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251023 = NULL ;
                while (((operand_251023 = enumerator_251023.nextObject ()))) {
                  macroValidPointer (operand_251023) ;
                  var_cas_methodSignature.addAssign_operation (operand_251023->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251714 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251714 = NULL ;
                while (((operand_251714 = enumerator_251714.nextObject ()))) {
                  macroValidPointer (operand_251714) ;
                  var_cas_methodSignature.addAssign_operation (operand_251714->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_252320 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_252320 = NULL ;
                while (((operand_252320 = enumerator_252320.nextObject ()))) {
                  macroValidPointer (operand_252320) ;
                  var_cas_methodSignature.addAssign_operation (operand_252320->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_252534 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_252534.isBuiltAndTrue ()) {
              ...
              }else if (cond_252534.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_252701 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_252701 = NULL ;
        while (((operand_252701 = enumerator_252701.nextObject ()))) {
          macroValidPointer (operand_252701) ;
          const GGS_bool cond_253133 = operand_252701->mInfo.mHasSetter ;
          if (cond_253133.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_252701->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6728)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_252701->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_253394 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_253394.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_257658 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_257658 = NULL ;
    while (((operand_257658 = enumerator_257658.nextObject ()))) {
      macroValidPointer (operand_257658) ;
      GGS_string var_cas_keyClassMethod = ((operand_257658->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))) ;
      const GGS_bool cond_257955 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6873)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_257955.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_257658->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6876)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_259590 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)))).operator_not () ;
  if (cond_259590.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_263094 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (6972))) ;
  if (cond_263094.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_262136 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_262136 = NULL ;
      while (((operand_262136 = enumerator_262136.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_262136) ;
        GGS_string var_cas_keyClassMethod = ((operand_262136->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))) ;
        var_cas_baseClassName = operand_262136->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6977)) ;
        ...
        const GGS_bool cond_262874 = var_cas_found ;
        if (cond_262874.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_262543 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          if (temp_262543.isBuilt ()) {
            temp_262543 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (6982)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          }
    ...
    const GGS_bool cond_263082 = (var_cas_found).operator_not () ;
    if (cond_263082.isBuiltAndTrue ()) {
  ...
  }else if (cond_263094.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_263171 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_263171 = NULL ;
      while (((operand_263171 = enumerator_263171.nextObject ()))) {
        macroValidPointer (operand_263171) ;
        GGS_string var_cas_keyClassMethod = ((operand_263171->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))) ;
        const GGS_bool cond_263477 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6998)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_263477.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_263171->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7001)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_263630 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7006)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_263630 = NULL ;
    while (((operand_263630 = enumerator_263630.nextObject ()))) {
      macroValidPointer (operand_263630) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7008)), operand_263630->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7009)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7007)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_263630->mAttributeName, operand_263630->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7013)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_266148 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)))).operator_not () ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_269095 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_269095 = NULL ;
    while (((operand_269095 = enumerator_269095.nextObject ()))) {
      macroValidPointer (operand_269095) ;
      GGS_string var_cas_keyClassMethod = ((operand_269095->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))) ;
      const GGS_bool cond_269392 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7137)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_269392.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_269095->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7140)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_271511 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)))).operator_not () ;
  if (cond_271511.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_276099 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7256))) ;
  if (cond_276099.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_274798 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_274798 = NULL ;
      while (((operand_274798 = enumerator_274798.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_274798) ;
        GGS_string var_cas_keyClassMethod = ((operand_274798->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))) ;
        var_cas_baseClassName = operand_274798->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7261)) ;
        ...
        const GGS_bool cond_275879 = var_cas_found ;
        if (cond_275879.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_275262 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          if (temp_275262.isBuilt ()) {
            temp_275262 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7268)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          }
    ...
    const GGS_bool cond_276087 = (var_cas_found).operator_not () ;
    if (cond_276087.isBuiltAndTrue ()) {
  ...
  }else if (cond_276099.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_276176 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_276176 = NULL ;
      while (((operand_276176 = enumerator_276176.nextObject ()))) {
        macroValidPointer (operand_276176) ;
        GGS_string var_cas_keyClassMethod = ((operand_276176->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))) ;
        const GGS_bool cond_276482 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7294)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_276482.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_276176->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7297)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276635 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7302)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_276635 = NULL ;
    while (((operand_276635 = enumerator_276635.nextObject ()))) {
      macroValidPointer (operand_276635) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7304)), operand_276635->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7305)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7303)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_276635->mAttributeName, operand_276635->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7309)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_279636 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)))).operator_not () ;
  if (cond_279636.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_282092 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_282092 = NULL ;
    while (((operand_282092 = enumerator_282092.nextObject ()))) {
      macroValidPointer (operand_282092) ;
      GGS_string var_cas_keyClassMethod = ((operand_282092->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))) ;
      const GGS_bool cond_282397 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7436)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_282397.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_282092->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7439)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_284102 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)))).operator_not () ;
  if (cond_284102.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_287844 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7539))) ;
  if (cond_287844.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_286815 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_286815 = NULL ;
      while (((operand_286815 = enumerator_286815.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_286815) ;
        GGS_string var_cas_keyClassMethod = ((operand_286815->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))) ;
        var_cas_baseClassName = operand_286815->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7544)) ;
        ...
        const GGS_bool cond_287620 = var_cas_found ;
        if (cond_287620.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_287228 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          if (temp_287228.isBuilt ()) {
            temp_287228 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7550)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          }
    ...
    const GGS_bool cond_287832 = (var_cas_found).operator_not () ;
    if (cond_287832.isBuiltAndTrue ()) {
  ...
  }else if (cond_287844.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_287921 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_287921 = NULL ;
      while (((operand_287921 = enumerator_287921.nextObject ()))) {
        macroValidPointer (operand_287921) ;
        GGS_string var_cas_keyClassMethod = ((operand_287921->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))) ;
        const GGS_bool cond_288235 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7569)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_288235.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_287921->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7572)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_288388 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7577)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_288388 = NULL ;
    while (((operand_288388 = enumerator_288388.nextObject ()))) {
      macroValidPointer (operand_288388) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7579)), operand_288388->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7580)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7578)) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_288388->mAttributeName, operand_288388->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7584)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_291202 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)))).operator_not () ;
  if (cond_291202.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_292510 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687))))).operator_not () ;
      if (cond_292510.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_293202 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_293202 = NULL ;
        while (((operand_293202 = enumerator_293202.nextObject ()))) {
          macroValidPointer (operand_293202) ;
          var_cas_extractSignature.addAssign_operation (operand_293202->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7709))) ;
          var_cas_inputSignature.addAssign_operation (operand_293202->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7710))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_294649 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742))))).operator_not () ;
      if (cond_294649.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_295341 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_295341 = NULL ;
        while (((operand_295341 = enumerator_295341.nextObject ()))) {
          macroValidPointer (operand_295341) ;
          var_cas_extractSignature.addAssign_operation (operand_295341->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7764))) ;
          var_cas_inputSignature.addAssign_operation (operand_295341->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7765))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_297205 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802))))).operator_not () ;
      if (cond_297205.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_297849 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_297849 = NULL ;
        while (((operand_297849 = enumerator_297849.nextObject ()))) {
          macroValidPointer (operand_297849) ;
          var_cas_extractSignature.addAssign_operation (operand_297849->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7823))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_85 = true ;
        while (syntaxRepeat_85) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_298540 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7839))) ;
            if (cond_298540.isBuiltAndTrue ()) {
            ...
            }else if (cond_298540.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_298652_0 ;
              GGS_bool automatic_var_298652_1 ;
              if (var_cas_tableAttributs.isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_298652_0, automatic_var_298652_1 COMMA_SOURCE_FILE_AT_LINE (7843)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_300167 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883))))).operator_not () ;
      if (cond_300167.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_300811 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_300811 = NULL ;
        while (((operand_300811 = enumerator_300811.nextObject ()))) {
          macroValidPointer (operand_300811) ;
          var_cas_extractSignature.addAssign_operation (operand_300811->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7904))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_89 = true ;
                while (syntaxRepeat_89) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_303249 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7971))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_303249.isBuiltAndTrue ()) {
                      const GGS_bool cond_303199 = (var_cas_hasGetter).operator_not () ;
                      if (cond_303199.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_303249.isBuiltAndFalse ()) {
                      const GGS_bool cond_303451 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7976))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_303451.isBuiltAndTrue ()) {
                        const GGS_bool cond_303403 = var_cas_hasSetter ;
                        if (cond_303403.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_303451.isBuiltAndFalse ()) {
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_310998 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_310998 = NULL ;
    while (((operand_310998 = enumerator_310998.nextObject ()))) {
      macroValidPointer (operand_310998) ;
      const GGS_bool cond_311505 = var_cas_inExtensionMap.reader_hasKey (operand_310998->mValue.reader_pathExtension ()) ;
      if (cond_311505.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_310998->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_310998->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_310998->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8181)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (8180)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311740 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_311740 = NULL ;
    while (((operand_311740 = enumerator_311740.nextObject ()))) {
      macroValidPointer (operand_311740) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311740->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_311740->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (8195)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_311740->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7B_) COMMA_HERE) ;
  GGS_wrapperExtensionMap  var_cas_extensionMap = GGS_wrapperExtensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (8232)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  GGS_M_regularFiles  var_cas_regularFileMap = GGS_M_regularFiles ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (8245)) ;
  GGS_string var_cas_absoluteSourcePath ;
  const GGS_bool cond_313523 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_313523.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8248)) ;
  }else if (cond_313523.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_313803 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_313803.isBuiltAndTrue ()) {
  ...
  }else if (cond_313803.isBuiltAndFalse ()) {
    ...
    ::routine_recursivelyEnumerateDirectories (inLexique,  var_cas_absoluteSourcePath,  GGS_string ("/"),  var_cas_extensionMap,  var_cas_wrapperFileSortedList,  var_cas_wrapperDirectorySortedList,  var_cas_wrapperFileIndex,  var_cas_wrapperDirectoryIndex,  var_cas_regularFileMap COMMA_SOURCE_FILE_AT_LINE (8260)) ;
            ...
            while (syntaxRepeat_93) {
              switch (select_semantics_5F_parser_93 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_316125 = var_cas_parameterIsUsed ;
                  if (cond_316125.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_316125.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7B_) COMMA_HERE) ;
  GGS_wrapperExtensionMap  var_cas_extensionMap = GGS_wrapperExtensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (8368)) ;
  switch (select_semantics_5F_parser_90 (inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  GGS_M_regularFiles  var_cas_regularFileMap = GGS_M_regularFiles ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (8380)) ;
  const GGS_bool cond_318846 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)))).operator_not () ;
  if (cond_318846.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_318058 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_318058.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8385)) ;
    }else if (cond_318058.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_318348 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_318348.isBuiltAndTrue ()) {
    ...
    }else if (cond_318348.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedList  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedList  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
      ::routine_recursivelyEnumerateDirectories (inLexique,  var_cas_absoluteSourcePath,  GGS_string ("/"),  var_cas_extensionMap,  var_cas_wrapperFileSortedList,  var_cas_wrapperDirectorySortedList,  var_cas_wrapperFileIndex,  var_cas_wrapperDirectoryIndex,  var_cas_regularFileMap COMMA_SOURCE_FILE_AT_LINE (8397)) ;
    }
  }
  ...
  const GGS_bool cond_319905 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)))).operator_not () ;
  if (cond_319905.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_325515 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_325515.isBuiltAndTrue ()) {
              ...
              }else if (cond_325515.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_95 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_329772 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_329772.isBuiltAndTrue ()) {
              ...
              }else if (cond_329772.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_98 = true ;
                while (syntaxRepeat_98) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i79_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_331704 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8772))) ;
  if (cond_331704.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_331704.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i80_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_332537 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8795))) ;
  if (cond_332537.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_332537.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_333507 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8820))) ;
  if (cond_333507.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_333507.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_334492 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8846))) ;
  if (cond_334492.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_334492.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_336038_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_336038_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_338500_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_338500_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_338709 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_338709 = NULL ;
    while (((operand_338709 = enumerator_338709.nextObject ()))) {
      macroValidPointer (operand_338709) ;
      const GGS_bool cond_338928 = (operand_338709->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8959))) ;
      if (cond_338928.isBuiltAndTrue ()) {
        operand_338709->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8961)) ;
      }else if (cond_338928.isBuiltAndFalse ()) {
        const GGS_bool cond_339137 = (operand_338709->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8961))) ;
        if (cond_339137.isBuiltAndTrue ()) {
          operand_338709->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8963)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_340988 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_340988 = NULL ;
    while (((operand_340988 = enumerator_340988.nextObject ()))) {
      macroValidPointer (operand_340988) ;
      const GGS_bool cond_341207 = (operand_340988->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9013))) ;
      if (cond_341207.isBuiltAndTrue ()) {
        operand_340988->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9015)) ;
      }else if (cond_341207.isBuiltAndFalse ()) {
        const GGS_bool cond_341416 = (operand_340988->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9015))) ;
        if (cond_341416.isBuiltAndTrue ()) {
          operand_340988->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9017)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_99 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_enumConstantMap::cEnumerator enumerator_343712 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_343712 = enumerator_343712.nextObject () ;
        if ((operand_343712 != NULL)) {
          bool _foreach_loop_343712 ;
          do{
            macroValidPointer (operand_343712) ;
            var_cas_s.dotAssign_operation (operand_343712->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9084))) ;
            operand_343712 = enumerator_343712.nextObject () ;
            _foreach_loop_343712 = ((operand_343712 != NULL)) ;
            if (_foreach_loop_343712) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_343712) ;
        }
      }
    ...
    while (syntaxRepeat_103) {
      switch (select_semantics_5F_parser_103 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_344532 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_344532 = NULL ;
            while (((operand_344532 = enumerator_344532.nextObject ()))) {
              macroValidPointer (operand_344532) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_344532->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9116)), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (9116)) ;
              GGS_lstring  var_cas_cstString ;
