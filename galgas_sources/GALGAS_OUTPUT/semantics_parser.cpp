...
pr_semantic_instruction_semantics_parser_3584_27_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_29 = true ;
    while (syntaxRepeat_29) {
        ...
        if (((var_cas_checkForKindOfClass).operator_not ()).isBuiltAndTrue ()) {
          if ((((var_cas_castedTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (3635))).operator_isNotEqual (var_cas_sourceExpressionTypeNameString)).operator_and ((var_cas_superClassMap.reader_hasKey (inLexique, var_cas_sourceExpressionTypeNameString COMMA_SOURCE_FILE_AT_LINE (3635))).operator_not ())).isBuiltAndTrue ()) {
        ...
        }else if (((var_cas_superClassMap.reader_hasKey (inLexique, var_cas_sourceExpressionTypeNameString COMMA_SOURCE_FILE_AT_LINE (3638))).operator_not ()).isBuiltAndTrue ()) {
  ...
  switch (select_semantics_parser_32 (inLexique)) {
    case 1 : {
      ...
      if (((var_cas_sourceClassMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (3677))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
...
pr_semantic_instruction_semantics_parser_4397_27_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_42) {
        ...
        { bool syntaxRepeat_43 = true ;
          while (syntaxRepeat_43) {
              ...
              const GGS_enumConstantMap  temp_168008 = var_cas_enumConstantesMap ;
              if (temp_168008.isBuilt ()) {
                temp_168008 (HERE)->method_searchKey (inLexique, var_cas_enumConstantName, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (4433)) ;
              }
              if ((var_cas_allBranchConstantSet.reader_hasKey (inLexique, var_cas_enumConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4434)) COMMA_SOURCE_FILE_AT_LINE (4434))).isBuiltAndTrue ()) {
  ...
  {
    GGS_stringset::cEnumerator enumerator_169025 (var_cas_missingConstants, true) ;
    while (enumerator_169025.hasCurrentObject ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (enumerator_169025._key (HERE))).operator_concat (GGS_string ("' is not used in switch instruction")) COMMA_SOURCE_FILE_AT_LINE (4463)) ;
      enumerator_169025.next () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_semantic_instruction_semantics_parser_4563_27_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  const GGS_M_semanticsEntitiesForUse  temp_175935 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_175935.isBuilt ()) {
    temp_175935 (HERE)->method_searchKey (inLexique, var_cas_grammarName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (4666)) ;
  }
  ...
  const GGS_M_nonterminalSymbolAlts  temp_176248 = var_cas_startSymbolAltMap ;
  if (temp_176248.isBuilt ()) {
    temp_176248 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_startSymbolSignature COMMA_SOURCE_FILE_AT_LINE (4671)) ;
  }
...
pr_semantic_instruction_semantics_parser_4754_27_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_49) {
      switch (select_repeat_semantics_parser_49 (inLexique)) {
        case 2 : {
          ...
          GGS_bool var_cas_found = GGS_bool (false) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_180371 (var_cas_structType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (4792)), true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_180371 = NULL ;
            while (((operand_180371 = enumerator_180371.nextObject ()))
                && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
              macroValidPointer (operand_180371) ;
              var_cas_found = (operand_180371->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4793))).operator_isEqual (var_cas_structAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4793))) ;
              var_cas_targetType = operand_180371->mAttributType ;
            }
          }
          if (((var_cas_found).operator_not ()).isBuiltAndTrue ()) {
  ...
  const GGS_AC_galgasType  temp_181214 = var_cas_targetType ;
  if (temp_181214.isBuilt ()) {
    temp_181214 (HERE)->method_check_with_InstructionAccess (inLexique, var_cas_instructionLocation, var_cas_searchMethodName, var_cas_keyExpressionType, var_cas_mapTypeName, var_cas_errorMessageName, var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (4817)) ;
  }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_181905 (var_cas_attributeList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_181905 = NULL ;
    while (((operand_181905 = enumerator_181905.nextObject ()))) {
      macroValidPointer (operand_181905) ;
      var_cas_ioVariablesMap.modifier_insertWithInstructionLocalVariable (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefixString).operator_concat (operand_181905->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4840))), var_cas_instructionLocation COMMA_HERE), operand_181905->mAttributType, GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_181905->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (4842)), GGS_bool (true), GGS_bool (false) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (4839)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
...
pr_constant_while_before_in_foreach_instruction_semantics_parser_4894_51_secondPhase (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_51 = true ;
    while (syntaxRepeat_51) {
        ...
        const GGS_AC_galgasType  temp_186924 = var_cas_sourceExpressionType ;
        if (temp_186924.isBuilt ()) {
          temp_186924 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_magicNumber, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (5005)) ;
        }
        GGS_string var_cas_typeName ;
        const GGS_AC_galgasType  temp_187182 = var_cas_sourceExpressionType ;
        if (temp_187182.isBuilt ()) {
          temp_187182 (HERE)->method_getTypeName (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (5014)) ;
        }
        switch (select_semantics_parser_53 (inLexique)) {
          case 1 : {
          ...
          case 2 : {
            ...
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_187719 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_187719 = NULL ;
              while (((operand_187719 = enumerator_187719.nextObject ()))) {
                macroValidPointer (operand_187719) ;
                ...
                if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
                  ...
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_187719->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5035)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5037))).operator_concat (operand_187719->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5037))), GGS_location (inLexique) COMMA_HERE), operand_187719->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5037)) ;
          ...
          case 3 : {
            ...
            GGS_bool var_cas_firstOne = GGS_bool (true) ;
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_188479 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_188479 = NULL ;
              while (((operand_188479 = enumerator_188479.nextObject ()))) {
                macroValidPointer (operand_188479) ;
                GGS_typeCplusPlusName  var_cas_cppName ;
                if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
                  var_cas_cppName = GGS_typeKeyName ::constructor_new (inLexique, var_cas_magicNumber, var_cas_iteratorNewStyle COMMA_HERE) ;
                }else{
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_188479->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5048)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, operand_188479->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5050)), GGS_location (inLexique) COMMA_HERE), operand_188479->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5050)) ;
                var_cas_firstOne = GGS_bool (false) ;
              }
            }
            } break ;
...
pr_semantic_instruction_semantics_parser_5109_27_ (galgas_scanner & inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_191916 = inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    inLexique.setParsingContext (context_191916) ;
  ...
  switch (select_semantics_parser_57 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_192369 = var_cas_indexVariable ; // CAST instruction
        if (_var_192369.getPtr () != NULL) {
          macroValidPointer (_var_192369.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_192369.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_192369.getPtr ()) ;
  ...
  switch (select_semantics_parser_58 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_193136 = var_cas_indexVariable ; // CAST instruction
        if (_var_193136.getPtr () != NULL) {
          macroValidPointer (_var_193136.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_193136.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_193136.getPtr ()) ;
...
pr_parse_match_operand_semantics_parser_5219_26_ (galgas_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_195189 = var_cas_type ; // CAST instruction
    if (_var_195189.getPtr () != NULL) {
      macroValidPointer (_var_195189.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_195189.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_t (_var_195189.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (_var_195189.getPtr ()) != NULL) {
        const GGS_typeGalgas_enum var_cas_e (_var_195189.getPtr ()) ;
        ...
        const GGS_AC_galgasType  temp_194953 = var_cas_type ;
        if (temp_194953.isBuilt ()) {
          temp_194953 (HERE)->method_getTypeName (inLexique, var_cas_actualTypeName COMMA_SOURCE_FILE_AT_LINE (5247)) ;
        }
...
pr_parse_match_case_semantics_parser_5257_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_195737 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_195737.isBuilt ()) {
    temp_195737 (HERE)->method_searchKey (inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (5270)) ;
  }
  ...
  }else if (((var_cas_tableDesClassesAncetresType1.reader_hasKey (inLexique, var_cas_inTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5284)) COMMA_SOURCE_FILE_AT_LINE (5284))).operator_not ()).isBuiltAndTrue ()) {
...
pr_parse_match_case_semantics_parser_5300_23_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    ...
    const GGS_enumConstantMap  temp_197538 = var_cas_inEnumMessageMap ;
    if (temp_197538.isBuilt ()) {
      temp_197538 (HERE)->method_searchKey (inLexique, var_cas_outEnumConstantName, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (5313)) ;
    }
  }else{
...
pr_optional_assignment_semantics_parser_5513_26_ (galgas_scanner & inLexique,
  ...
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_204941 = var_cas_inVariableType ;
  if (temp_204941.isBuilt ()) {
    temp_204941 (HERE)->method_handleConstructorCall (inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (5531)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_5561_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_61 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_207085 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_207085.isBuilt ()) {
        temp_207085 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5585)) ;
      }
...
pr_semantics_declaration_semantics_parser_5561_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_61 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      if ((((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5641)) COMMA_SOURCE_FILE_AT_LINE (5641))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapindexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5642)) COMMA_SOURCE_FILE_AT_LINE (5642)))).operator_not ()).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedMapindexType ::constructor_new (inLexique, var_cas_mapindexTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_209610 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_209610.isBuilt ()) {
        temp_209610 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5651)) ;
      }
...
pr_semantics_declaration_semantics_parser_5694_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_63 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      if ((((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5708)) COMMA_SOURCE_FILE_AT_LINE (5708))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5709)) COMMA_SOURCE_FILE_AT_LINE (5709)))).operator_not ()).isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_215116 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_215116 = NULL ;
        while (((operand_215116 = enumerator_215116.nextObject ()))) {
          macroValidPointer (operand_215116) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_215293 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_215293 = NULL ;
            while (((operand_215293 = enumerator_215293.nextObject ()))) {
              macroValidPointer (operand_215293) ;
              var_cas_methodSignature.addAssign_operation (operand_215293->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_215116->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5801)) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_215695 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_215695 = NULL ;
            while (((operand_215695 = enumerator_215695.nextObject ()))) {
              macroValidPointer (operand_215695) ;
              var_cas_methodSignature.addAssign_operation (operand_215695->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_215116->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5809))).operator_concat (GGS_string ("GetIndex")), operand_215116->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5809)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_216023 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_216023 = NULL ;
        while (((operand_216023 = enumerator_216023.nextObject ()))) {
          macroValidPointer (operand_216023) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216198 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216198 = NULL ;
            while (((operand_216198 = enumerator_216198.nextObject ()))) {
              macroValidPointer (operand_216198) ;
              var_cas_methodSignature.addAssign_operation (operand_216198->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_216023->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5819)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216598 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216598 = NULL ;
            while (((operand_216598 = enumerator_216598.nextObject ()))) {
              macroValidPointer (operand_216598) ;
              var_cas_methodSignature.addAssign_operation (operand_216598->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_216023->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5827))).operator_concat (GGS_string ("GetIndex")), operand_216023->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5827)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_66) {
          switch (select_repeat_semantics_parser_66 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_219971 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_219971 = NULL ;
                while (((operand_219971 = enumerator_219971.nextObject ()))) {
                  macroValidPointer (operand_219971) ;
                  var_cas_methodSignature.addAssign_operation (operand_219971->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5906))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_220525 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_220525 = NULL ;
                  while (((operand_220525 = enumerator_220525.nextObject ()))) {
                    macroValidPointer (operand_220525) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_220525->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221586 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_221586 = NULL ;
                while (((operand_221586 = enumerator_221586.nextObject ()))) {
                  macroValidPointer (operand_221586) ;
                  var_cas_methodSignature.addAssign_operation (operand_221586->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5943))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222155 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_222155 = NULL ;
                  while (((operand_222155 = enumerator_222155.nextObject ()))) {
                    macroValidPointer (operand_222155) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_222155->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222902 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_222902 = NULL ;
                while (((operand_222902 = enumerator_222902.nextObject ()))) {
                  macroValidPointer (operand_222902) ;
                  var_cas_methodSignature.addAssign_operation (operand_222902->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5970))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_223486 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_223486 = NULL ;
                  while (((operand_223486 = enumerator_223486.nextObject ()))) {
                    macroValidPointer (operand_223486) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_223486->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_223852 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_223852 = NULL ;
        while (((operand_223852 = enumerator_223852.nextObject ()))) {
          macroValidPointer (operand_223852) ;
          if ((operand_223852->mInfo.mHasSetter).isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_223852->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5984)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (5984)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_223852->mInfo.mAttributType, var_cas_inPassingMode) ;
...
pr_semantics_declaration_semantics_parser_5694_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_63 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      if ((((var_cas_tableEnAvant.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6029)) COMMA_SOURCE_FILE_AT_LINE (6029))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6029)) COMMA_SOURCE_FILE_AT_LINE (6029)))).operator_not ()).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t = GGS_typeGalgasUndefinedMapType ::constructor_new (inLexique, var_cas_mapTypeName COMMA_HERE) ;
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType = GGS_typeGalgas_luint ::constructor_new (inLexique COMMA_HERE) ;
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_228689 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_228689 = NULL ;
        while (((operand_228689 = enumerator_228689.nextObject ()))) {
          macroValidPointer (operand_228689) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228866 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_228866 = NULL ;
            while (((operand_228866 = enumerator_228866.nextObject ()))) {
              macroValidPointer (operand_228866) ;
              var_cas_methodSignature.addAssign_operation (operand_228866->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_228689->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6120)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229268 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_229268 = NULL ;
            while (((operand_229268 = enumerator_229268.nextObject ()))) {
              macroValidPointer (operand_229268) ;
              var_cas_methodSignature.addAssign_operation (operand_229268->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_228689->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6128))).operator_concat (GGS_string ("GetIndex")), operand_228689->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6128)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_229596 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_229596 = NULL ;
        while (((operand_229596 = enumerator_229596.nextObject ()))) {
          macroValidPointer (operand_229596) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229773 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_229773 = NULL ;
            while (((operand_229773 = enumerator_229773.nextObject ()))) {
              macroValidPointer (operand_229773) ;
              var_cas_methodSignature.addAssign_operation (operand_229773->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_229596->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6138)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230176 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_230176 = NULL ;
            while (((operand_230176 = enumerator_230176.nextObject ()))) {
              macroValidPointer (operand_230176) ;
              var_cas_methodSignature.addAssign_operation (operand_230176->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_229596->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6146))).operator_concat (GGS_string ("GetIndex")), operand_229596->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6146)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_66) {
          switch (select_repeat_semantics_parser_66 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_232514 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_232514 = NULL ;
                while (((operand_232514 = enumerator_232514.nextObject ()))) {
                  macroValidPointer (operand_232514) ;
                  var_cas_methodSignature.addAssign_operation (operand_232514->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6209))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_233024 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_233024 = NULL ;
                  while (((operand_233024 = enumerator_233024.nextObject ()))) {
                    macroValidPointer (operand_233024) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_233024->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_233670 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_233670 = NULL ;
                while (((operand_233670 = enumerator_233670.nextObject ()))) {
                  macroValidPointer (operand_233670) ;
                  var_cas_methodSignature.addAssign_operation (operand_233670->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6237))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234179 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_234179 = NULL ;
                  while (((operand_234179 = enumerator_234179.nextObject ()))) {
                    macroValidPointer (operand_234179) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_234179->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234745 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_234745 = NULL ;
                while (((operand_234745 = enumerator_234745.nextObject ()))) {
                  macroValidPointer (operand_234745) ;
                  var_cas_methodSignature.addAssign_operation (operand_234745->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6260))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_235295 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_235295 = NULL ;
                  while (((operand_235295 = enumerator_235295.nextObject ()))) {
                    macroValidPointer (operand_235295) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_235295->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_235579 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_235579 = NULL ;
        while (((operand_235579 = enumerator_235579.nextObject ()))) {
          macroValidPointer (operand_235579) ;
          if ((operand_235579->mInfo.mHasSetter).isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_235579->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6273)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (6273)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_235579->mInfo.mAttributType, var_cas_inPassingMode) ;
            var_cas_modifierSignature.addAssign_operation (GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_inPassingMode) ;
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6333_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_238991 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_238991.isBuilt ()) {
    temp_238991 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6363)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_239460 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_239460 = NULL ;
    while (((operand_239460 = enumerator_239460.nextObject ()))) {
      macroValidPointer (operand_239460) ;
      GGS_string var_cas_keyClassMethod = ((operand_239460->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6371))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6371))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6372)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6372))).isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_239460->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6375)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6333_50_importSemantics (galgas_scanner & inLexique,
  ...
  if (((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6417)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6417)) COMMA_SOURCE_FILE_AT_LINE (6417))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_6429_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_243308 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_243308.isBuilt ()) {
    temp_243308 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6465)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_243902 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_243902 = NULL ;
      while (((operand_243902 = enumerator_243902.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_243902) ;
        GGS_string var_cas_keyClassMethod = ((operand_243902->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6475))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6475))) ;
        var_cas_baseClassName = operand_243902->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6476)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          ...
          const GGS_EXcategoryMethodMap  temp_244307 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6481)) ;
          if (temp_244307.isBuilt ()) {
            temp_244307 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6481)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_244935 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_244935 = NULL ;
      while (((operand_244935 = enumerator_244935.nextObject ()))) {
        macroValidPointer (operand_244935) ;
        GGS_string var_cas_keyClassMethod = ((operand_244935->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6496))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6496))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6497)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6497))).isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_244935->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6500)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245392 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6505)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_245392 = NULL ;
    while (((operand_245392 = enumerator_245392.nextObject ()))) {
      macroValidPointer (operand_245392) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6507)), operand_245392->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6508)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_245392->mAttributeName, operand_245392->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6512)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6429_28_importSemantics (galgas_scanner & inLexique,
  ...
  if (((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6572)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6572)) COMMA_SOURCE_FILE_AT_LINE (6572))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6589_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_249829 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_249829.isBuilt ()) {
    temp_249829 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6621)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_250354 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_250354.isBuilt ()) {
    temp_250354 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6627)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_250823 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_250823 = NULL ;
    while (((operand_250823 = enumerator_250823.nextObject ()))) {
      macroValidPointer (operand_250823) ;
      GGS_string var_cas_keyClassMethod = ((operand_250823->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6635))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6635))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6636)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6636))).isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_250823->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6639)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6589_50_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_252729 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_252729.isBuilt ()) {
    temp_252729 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6687)) ;
  }
  ...
  if (((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6691)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6691)) COMMA_SOURCE_FILE_AT_LINE (6691))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_6703_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_255018 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_255018.isBuilt ()) {
    temp_255018 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6739)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_255896 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_255896.isBuilt ()) {
    temp_255896 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6749)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_256490 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_256490 = NULL ;
      while (((operand_256490 = enumerator_256490.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_256490) ;
        GGS_string var_cas_keyClassMethod = ((operand_256490->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6759))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6759))) ;
        var_cas_baseClassName = operand_256490->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6760)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          ...
          const GGS_EXcategoryReaderMap  temp_256952 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6766)) ;
          if (temp_256952.isBuilt ()) {
            temp_256952 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (6766)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_257866 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_257866 = NULL ;
      while (((operand_257866 = enumerator_257866.nextObject ()))) {
        macroValidPointer (operand_257866) ;
        GGS_string var_cas_keyClassMethod = ((operand_257866->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6792))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6792))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6793)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6793))).isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_257866->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6796)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_258323 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6801)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_258323 = NULL ;
    while (((operand_258323 = enumerator_258323.nextObject ()))) {
      macroValidPointer (operand_258323) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6803)), operand_258323->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6804)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_258323->mAttributeName, operand_258323->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6808)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6703_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_260816 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_260816.isBuilt ()) {
    temp_260816 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6874)) ;
  }
  ...
  if (((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6878)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6878)) COMMA_SOURCE_FILE_AT_LINE (6878))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6895_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_263277 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_263277.isBuilt ()) {
    temp_263277 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6926)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_263746 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_263746 = NULL ;
    while (((operand_263746 = enumerator_263746.nextObject ()))) {
      macroValidPointer (operand_263746) ;
      GGS_string var_cas_keyClassMethod = ((operand_263746->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6934))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6934))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6935)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6935))).isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_263746->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6938)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6895_50_importSemantics (galgas_scanner & inLexique,
  ...
  if (((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6980)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6980)) COMMA_SOURCE_FILE_AT_LINE (6980))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_6992_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_267742 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_267742.isBuilt ()) {
    temp_267742 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7029)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_268336 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_268336 = NULL ;
      while (((operand_268336 = enumerator_268336.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_268336) ;
        GGS_string var_cas_keyClassMethod = ((operand_268336->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7039))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7039))) ;
        var_cas_baseClassName = operand_268336->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7040)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_268747 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7045)) ;
          if (temp_268747.isBuilt ()) {
            temp_268747 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7045)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_269440 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_269440 = NULL ;
      while (((operand_269440 = enumerator_269440.nextObject ()))) {
        macroValidPointer (operand_269440) ;
        GGS_string var_cas_keyClassMethod = ((operand_269440->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7064))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7064))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7065)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (7065))).isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_269440->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7068)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_269905 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_269905 = NULL ;
    while (((operand_269905 = enumerator_269905.nextObject ()))) {
      macroValidPointer (operand_269905) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7075)), operand_269905->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7076)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_269905->mAttributeName, operand_269905->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7080)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6992_28_importSemantics (galgas_scanner & inLexique,
  ...
  if (((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7146)).reader_hasKey (inLexique, var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7146)) COMMA_SOURCE_FILE_AT_LINE (7146))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_7166_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_73 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_274652 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_274652 = NULL ;
        while (((operand_274652 = enumerator_274652.nextObject ()))) {
          macroValidPointer (operand_274652) ;
          var_cas_extractSignature.addAssign_operation (operand_274652->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_274652->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7166_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_73 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276789 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_276789 = NULL ;
        while (((operand_276789 = enumerator_276789.nextObject ()))) {
          macroValidPointer (operand_276789) ;
          var_cas_extractSignature.addAssign_operation (operand_276789->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_276789->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7281_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_279295 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_279295 = NULL ;
        while (((operand_279295 = enumerator_279295.nextObject ()))) {
          macroValidPointer (operand_279295) ;
          var_cas_extractSignature.addAssign_operation (operand_279295->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_75 = true ;
        while (syntaxRepeat_75) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            if ((var_cas_usedSortedAttributes.reader_hasKey (inLexique, var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7332)) COMMA_SOURCE_FILE_AT_LINE (7332))).isBuiltAndTrue ()) {
              ...
              const GGS_typeSemanticAttributesMap  temp_280059 = var_cas_tableAttributs ;
              if (temp_280059.isBuilt ()) {
                temp_280059 (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_34, automatic_var_35 COMMA_SOURCE_FILE_AT_LINE (7336)) ;
              }
              const GGS_AC_galgasType  temp_280163 = var_cas_definitionType ;
              if (temp_280163.isBuilt ()) {
                temp_280163 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (7337)) ;
              }
...
pr_semantics_declaration_semantics_parser_7281_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_282256 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_282256 = NULL ;
        while (((operand_282256 = enumerator_282256.nextObject ()))) {
          macroValidPointer (operand_282256) ;
          var_cas_extractSignature.addAssign_operation (operand_282256->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasSortedListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_79 = true ;
                while (syntaxRepeat_79) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                    if (((var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7464))).operator_isEqual (GGS_string ("nogetter"))).isBuiltAndTrue ()) {
                    ...
                    }else if (((var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7469))).operator_isEqual (GGS_string ("setter"))).isBuiltAndTrue ()) {
                      if ((var_cas_hasSetter).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_7495_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_286425 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_286425.isBuilt ()) {
    temp_286425 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7512)) ;
  }
...
pr_semantics_declaration_semantics_parser_7495_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_287706 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_287706.isBuilt ()) {
    temp_287706 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7546)) ;
  }
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_292442 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_292442 = NULL ;
    while (((operand_292442 = enumerator_292442.nextObject ()))) {
      macroValidPointer (operand_292442) ;
      if ((var_cas_inExtensionMap.reader_hasKey (inLexique, operand_292442->mValue.reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (7664)) COMMA_SOURCE_FILE_AT_LINE (7664))).isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_292442->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_292442->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_292442->mValue), GGS_location (inLexique) COMMA_HERE), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (7673)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_293184 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_293184 = NULL ;
    while (((operand_293184 = enumerator_293184.nextObject ()))) {
      macroValidPointer (operand_293184) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_293184->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_293184->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (7688)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_293184->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
pr_semantics_declaration_semantics_parser_7709_28_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (7740))).operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_absoluteSourcePath.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (7745))).operator_not ()).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_7709_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
  GGS_M_regularFiles  var_cas_regularFileMap = GGS_M_regularFiles ::constructor_emptyMap (inLexique COMMA_HERE) ;
  if (((var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (7871)).reader_hasKey (inLexique, var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7871)) COMMA_SOURCE_FILE_AT_LINE (7871))).operator_not ()).isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    if (((var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (7874))).operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_absoluteSourcePath.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (7879))).operator_not ()).isBuiltAndTrue ()) {
  ...
  if (((var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (7932)).reader_hasKey (inLexique, var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7932)) COMMA_SOURCE_FILE_AT_LINE (7932))).operator_not ()).isBuiltAndTrue ()) {
      ...
      switch (select_repeat_semantics_parser_85 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_87 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2B__3D_) COMMA_HERE) ;
              if (((var_cas_addAssignFormalInputArgumentList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (8211))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
...
pr_formal_argument_type_semantics_parser_8255_27_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8262)) COMMA_SOURCE_FILE_AT_LINE (8262))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_312860 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_312860.isBuilt ()) {
      temp_312860 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8264)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_313052 = var_cas_tableEnAvant ;
    if (temp_313052.isBuilt ()) {
      temp_313052 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8267)) ;
    }
  }
}
...
pr_formal_argument_type_semantics_parser_8277_27_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8285)) COMMA_SOURCE_FILE_AT_LINE (8285))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_313693 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_313693.isBuilt ()) {
      temp_313693 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8287)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_313885 = var_cas_tableEnAvant ;
    if (temp_313885.isBuilt ()) {
      temp_313885 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8290)) ;
    }
...
pr_formal_argument_type_semantics_parser_8302_27_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8310)) COMMA_SOURCE_FILE_AT_LINE (8310))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_314663 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_314663.isBuilt ()) {
      temp_314663 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8312)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_314855 = var_cas_tableEnAvant ;
    if (temp_314855.isBuilt ()) {
      temp_314855 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8315)) ;
    }
...
pr_formal_argument_type_semantics_parser_8327_27_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8336)) COMMA_SOURCE_FILE_AT_LINE (8336))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_315648 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_315648.isBuilt ()) {
      temp_315648 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8338)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_315840 = var_cas_tableEnAvant ;
    if (temp_315840.isBuilt ()) {
      temp_315840 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8341)) ;
    }
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8422_47_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_319987 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_319987 = NULL ;
    while (((operand_319987 = enumerator_319987.nextObject ()))) {
      macroValidPointer (operand_319987) ;
      if (((operand_319987->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_319987->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8451)) ;
      }else if (((operand_319987->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_319987->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8453)) ;
      }
    }
  }
  GGS_EXformalArgumentPassingMode var_cas_passingMode = GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE) ;
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8422_47_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_322246 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_322246 = NULL ;
    while (((operand_322246 = enumerator_322246.nextObject ()))) {
      macroValidPointer (operand_322246) ;
      if (((operand_322246->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_322246->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8505)) ;
      }else if (((operand_322246->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_322246->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8507)) ;
      }
    }
  }
  GGS_EXformalArgumentPassingMode var_cas_passingMode = GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE) ;
    ...
    while (syntaxRepeat_92) {
      switch (select_repeat_semantics_parser_92 (inLexique)) {
        case 2 : {
          ...
          switch (select_semantics_parser_93 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              if (((var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8590))).operator_isNotEqual (GGS_string ("location"))).isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_95 = true ;
            while (syntaxRepeat_95) {
                ...
                const GGS_enumConstantMap  temp_326776 = var_cas_constantMap ;
                if (temp_326776.isBuilt ()) {
                  temp_326776 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_38 COMMA_SOURCE_FILE_AT_LINE (8617)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_326969 = var_cas_constantMap ;
                if (temp_326969.isBuilt ()) {
                  temp_326969 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_39 COMMA_SOURCE_FILE_AT_LINE (8622)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_327168 = var_cas_constantMap ;
                if (temp_327168.isBuilt ()) {
                  temp_327168 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (8627)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_97 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              if (((var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8673))).operator_isNotEqual (GGS_string ("location"))).isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_99 = true ;
            while (syntaxRepeat_99) {
                ...
                const GGS_enumConstantMap  temp_329815 = var_cas_constantMap ;
                if (temp_329815.isBuilt ()) {
                  temp_329815 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_41 COMMA_SOURCE_FILE_AT_LINE (8700)) ;
                }
                ...
                const GGS_enumConstantMap  temp_329988 = var_cas_constantMap ;
                if (temp_329988.isBuilt ()) {
                  temp_329988 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_42 COMMA_SOURCE_FILE_AT_LINE (8705)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_330721 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_330721 = NULL ;
            while (((operand_330721 = enumerator_330721.nextObject ()))) {
              macroValidPointer (operand_330721) ;
              if (((var_cas_definedSourceMap.reader_hasKey (inLexique, operand_330721->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8731)) COMMA_SOURCE_FILE_AT_LINE (8731))).operator_not ()).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_330721->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8732)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8733)) ;
              }
            }
          }
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_101 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              if (((var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8750))).operator_isNotEqual (GGS_string ("location"))).isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_103 = true ;
            while (syntaxRepeat_103) {
                ...
                const GGS_enumConstantMap  temp_332718 = var_cas_constantMap ;
                if (temp_332718.isBuilt ()) {
                  temp_332718 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_43 COMMA_SOURCE_FILE_AT_LINE (8777)) ;
                }
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_333490 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_333490 = NULL ;
            while (((operand_333490 = enumerator_333490.nextObject ()))) {
              macroValidPointer (operand_333490) ;
              if (((var_cas_definedSourceMap.reader_hasKey (inLexique, operand_333490->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8804)) COMMA_SOURCE_FILE_AT_LINE (8804))).operator_not ()).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_333490->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8805)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8806)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_334327 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_334327 = NULL ;
            while (((operand_334327 = enumerator_334327.nextObject ()))) {
              macroValidPointer (operand_334327) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_334327->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8833)), GGS_location (inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  temp_334454 = var_cas_cstMessageStringMap ;
              if (temp_334454.isBuilt ()) {
                temp_334454 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (8835)) ;
              }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_93 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
              if (((var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8919))).operator_isNotEqual (GGS_string ("location"))).isBuiltAndTrue ()) {
          ...
          { bool syntaxRepeat_95 = true ;
            while (syntaxRepeat_95) {
                ...
                if (temp_338173.isBuilt ()) {
                  temp_338173 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_44 COMMA_SOURCE_FILE_AT_LINE (8946)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                GGS_lstring  var_cas_rightConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_rightConstant) ;
                ...
                const GGS_enumConstantMap  temp_338366 = var_cas_constantMap ;
                if (temp_338366.isBuilt ()) {
                  temp_338366 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_45 COMMA_SOURCE_FILE_AT_LINE (8951)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                GGS_lstring  var_cas_targetConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_targetConstant) ;
                ...
                const GGS_enumConstantMap  temp_338565 = var_cas_constantMap ;
                if (temp_338565.isBuilt ()) {
                  temp_338565 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_46 COMMA_SOURCE_FILE_AT_LINE (8956)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
                switch (select_semantics_parser_96 (inLexique)) {
                  case 1 : {
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_99 = true ;
            while (syntaxRepeat_99) {
                ...
                const GGS_enumConstantMap  temp_339907 = var_cas_constantMap ;
                if (temp_339907.isBuilt ()) {
                  temp_339907 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_47 COMMA_SOURCE_FILE_AT_LINE (9003)) ;
                }
                ...
                const GGS_enumConstantMap  temp_340080 = var_cas_constantMap ;
                if (temp_340080.isBuilt ()) {
                  temp_340080 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_48 COMMA_SOURCE_FILE_AT_LINE (9008)) ;
                }
                switch (select_semantics_parser_100 (inLexique)) {
                  case 1 : {
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_103 = true ;
            while (syntaxRepeat_103) {
                ...
                const GGS_enumConstantMap  temp_341231 = var_cas_constantMap ;
                if (temp_341231.isBuilt ()) {
                  temp_341231 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_49 COMMA_SOURCE_FILE_AT_LINE (9047)) ;
                }
