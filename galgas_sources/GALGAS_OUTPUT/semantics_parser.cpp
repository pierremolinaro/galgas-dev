...
pr_semantics_declaration_semantics_parser_1186_29_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_8 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstrac) ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_clas) ;
...
pr_parent_class_semantics_parser_1340_20_importSemantics (galgas_scanner & _inLexique,
  ...
  if (var_cas_type._isBuilt ()) {
    if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_ClassModel * operand_52307 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_52307) ; 
      var_cas_outSuperClasses = operand_52307->mSuperClasses ;
      var_cas_outAttributeList = operand_52307->mAttributeList ;
      var_cas_outMessageMap = operand_52307->mMessageMap ;
    }else{ // Else part
...
pr_semantics_declaration_semantics_parser_1424_29_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_11 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_typeSemanticAttributesMap  var_cas_tableAttributs ;
      GGS_lstring  var_cas_54646 ;
      nt_parent_class_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableAttributs, var_cas_listeTousAttributsSemantiques, var_cas_ancestorClassMethodsMap, var_cas_tableDesClassesAncetres, var_cas_inheritedMessageMap, var_cas_54646) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_57341 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_57341 != NULL)) {
        macroValidPointer (operand_57341) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_57341->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1537)) SOURCE_FILE_AT_LINE (1537))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_57341->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1538))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1539)) ;
        }
        operand_57341 = operand_57341->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
  ...
  switch (select_semantics_parser_11 (_inLexique)) {
    ...
    case 2 : {
      ...
      while ((operand_63316 != NULL)) {
        ...
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_63316->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1687)) SOURCE_FILE_AT_LINE (1687))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_63316->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1688))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1689)) ;
        }
...
pr_semantics_declaration_semantics_parser_1714_29_ (galgas_scanner & _inLexique,
  ...
  GGS_typeClassInheritedMessagesMap  var_cas_inheritedMessageMap ;
  GGS_typeSemanticAttributesMap  var_cas_tableAttributs ;
  GGS_lstring  var_cas_65984 ;
  nt_parent_class_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableAttributs, var_cas_listeTousAttributsSemantiques, var_cas_ancestorClassMethodsMap, var_cas_tableDesClassesAncetres, var_cas_inheritedMessageMap, var_cas_65984) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiquesCourants ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_13 (_inLexique)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
          var_cas_messageText.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1815)) SOURCE_FILE_AT_LINE (1815))))).isBuiltAndTrue ()) {
            var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1816)) ;
          }
          var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1818)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        case 4 : {
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_69553 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_69553 != NULL)) {
    macroValidPointer (operand_69553) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_69553->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1840)) SOURCE_FILE_AT_LINE (1840))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_69553->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1841))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1842)) ;
    }
    operand_69553 = operand_69553->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_concreteClassName, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) SOURCE_FILE_AT_LINE (1853)) ;
  GGS_typeEntityToGenerate  var_cas_def ;
...
pr_semantics_declaration_semantics_parser_1714_29_importSemantics (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_concreteClassName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_concreteClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1879)) SOURCE_FILE_AT_LINE (1879))).isBuiltAndTrue ()) {
    var_cas_concreteClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a non abstract class cannot be predeclared") SOURCE_FILE_AT_LINE (1880)) ;
  }
  GGS_typeTableMethodes  var_cas_ancestorClassMethodsMap ;
  GGS_typeListeAttributsSemantiques  var_cas_listeTousAttributsSemantiques ;
  GGS_typeSuperClassesMap  var_cas_tableDesClassesAncetres ;
  ...
  if (((var_cas_superClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1912))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_TypeModel  var_cas_type ;
    if (var_cas_ioModelMap._isBuilt ()) {
      var_cas_ioModelMap (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_type SOURCE_FILE_AT_LINE (1914)) ;
    }
    if (var_cas_type._isBuilt ()) {
      if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
        cPtr_ClassModel * operand_72731 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
        macroValidPointer (operand_72731) ; 
        var_cas_superClasses = operand_72731->mSuperClasses ;
        var_cas_attributeList = operand_72731->mAttributeList ;
        var_cas_messageMap = operand_72731->mMessageMap ;
      }else{ // Else part
        var_cas_superClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_superClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1921))))) + (GGS_string (true, "' type is not a class"))) SOURCE_FILE_AT_LINE (1923)) ;
        var_cas_superClasses._drop_operation () ;
        var_cas_attributeList._drop_operation () ;
        var_cas_messageMap._drop_operation () ;
      }
    }
    var_cas_superClasses._addAssign_operation (var_cas_superClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1924))) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiquesCourants ;
  GGS_L_nameWithType  var_cas_listeTypeeAttributsExternesCourants ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_13 (_inLexique)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
          var_cas_messageText.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1992)) SOURCE_FILE_AT_LINE (1992))))).isBuiltAndTrue ()) {
            var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1993)) ;
          }
          var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1995)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        case 4 : {
          GGS_typeEntitiesToGenerateList  var_cas_listeEntitesAengendrer ;
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_76754 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_76754 != NULL)) {
    macroValidPointer (operand_76754) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_76754->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2018)) SOURCE_FILE_AT_LINE (2018))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_76754->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2019))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (2020)) ;
    }
    operand_76754 = operand_76754->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  var_cas_c = GGS_typeGalgasClassType::constructor_new (_inLexique, var_cas_concreteClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_concreteClassName, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) SOURCE_FILE_AT_LINE (2031)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_concreteClassName, var_cas_t SOURCE_FILE_AT_LINE (2033)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
semantics_parser::
pr_abstract_method_semantics_parser_2041_23_ (galgas_scanner & _inLexique,
                                GGS_typeListeAttributsSemantiques  &/* var_cas_listeAttributsSemantiquesCourants */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableMethodes  &var_cas_tableDesMethodes,
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_tableDesMethodes.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (2065)) ;
  ...
  var_cas_tableMethodesAimplementer.method_insertAbstract (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions SOURCE_FILE_AT_LINE (2067)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_abstract_method_semantics_parser_2041_23_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_parse_method_semantics_parser_2073_20_ (galgas_scanner & _inLexique,
  ...
  var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_me_Constant, var_cas_typeDefinition, var_cas_me_constantCppName SOURCE_FILE_AT_LINE (2107)) ;
  ...
  var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_super_Constant, var_cas_typeDefinition, var_cas_super_constantCppName SOURCE_FILE_AT_LINE (2119)) ;
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_81541 = var_cas_listeAttributsSemantiquesCourants.firstObject () ;
  while ((operand_81541 != NULL)) {
    macroValidPointer (operand_81541) ;
    GGS_typeCplusPlusName  var_cas_nomCpp ;
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (_inLexique, operand_81541->aNomAttribut COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_81541->aNomAttribut, operand_81541->mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (2134)) ;
    operand_81541 = operand_81541->nextObject () ;
  }
...
void semantics_parser::
pr_parse_method_semantics_parser_2073_20_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  nt_semantic_instructions_list_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_non_abstract_method_semantics_parser_2158_27_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inCurrentClassName,
                                const GGS_typeTableMethodes  &var_cas_inAncestorClassMethodsMap,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeAttributsSemantiquesCourants,
  ...
  var_cas_tableDesMethodes.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (2198)) ;
...
void semantics_parser::
pr_non_abstract_method_semantics_parser_2158_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
...
void semantics_parser::
semantics_parser::
pr_overrided_method_semantics_parser_2207_24_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inCurrentClassName,
                                const GGS_typeTableMethodes  &var_cas_inAncestorClassMethodsMap,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeAttributsSemantiquesCourants,
  ...
  if (var_cas_tableDesMethodes._isBuilt ()) {
    var_cas_tableDesMethodes (HERE)->method_searchKey (_inLexique, var_cas_methodName, var_cas_listeDeTypesMethodeOriginale SOURCE_FILE_AT_LINE (2250)) ;
  }
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_listeDeTypesMethodeOriginale,  var_cas_methodSignature,  GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2252)) ;
  var_cas_tableMethodesAimplementer.method_insertNotAbstract (_inLexique, var_cas_methodName, var_cas_methodSignature, var_cas_listeTypeEtNomsArguments, var_cas_instructionsList SOURCE_FILE_AT_LINE (2257)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_overrided_method_semantics_parser_2207_24_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_override) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  nt_parse_method_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
...
void semantics_parser::
semantics_parser::
pr_formal_arguments_list_semantics_parser_2268_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_L_EXsignature  &var_cas_listeDeTypes,
                                GGS_typeVariablesMap  &var_cas_tableArgumentsMethode,
                                GGS_typeListeTypesEtNomsArgMethode  &var_cas_listeTypeEtNomsArguments,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_14 (_inLexique)) {
        case 2 : {
          ...
          switch (select_semantics_parser_15 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2300)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
              var_cas_tableArgumentsMethode.method_insertConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2305)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_16 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2326)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_nomArgument ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, true)) ;
              var_cas_tableArgumentsMethode.method_insertInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2332)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_17 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2353)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, false)) ;
              var_cas_tableArgumentsMethode.method_insertInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2358)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          var_cas_listeTypeEtNomsArguments._addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
          var_cas_tableArgumentsMethode.method_insertOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2378)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void semantics_parser::
semantics_parser::
pr_formal_arguments_list_semantics_parser_2268_29_importGrammarForSemantics (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_formal_arguments_list_semantics_parser_2268_29_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_14 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_type_parsing_semantics_parser_2435_20_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (2442)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2443)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_type_parsing_semantics_parser_2435_20_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2452_45_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_targetVarType, var_cas_targetVarCppName SOURCE_FILE_AT_LINE (2473)) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_targetVarType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2475)) ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2452_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
...
void semantics_parser::
semantics_parser::
pr_input_parameters_list_semantics_parser_2485_29_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2507))) < (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2507)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much arguments: ")) + (var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2508)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2508))))) + (GGS_string (true, " expected, ")))) + (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2509)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2509))))) + (GGS_string (true, " found"))) SOURCE_FILE_AT_LINE (2511)) ;
    var_cas_outAllVariablesList._drop_operation () ;
    var_cas_listeAffectationParametresEffectifs._drop_operation () ;
  }else if (((((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2511))) > (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2511)))) & ((! (var_cas_ellipsis))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "argument(s) missing: ")) + (var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2512)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2512))))) + (GGS_string (true, " expected, ")))) + (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2513)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2513))))) + (GGS_string (true, " found"))) SOURCE_FILE_AT_LINE (2515)) ;
    var_cas_outAllVariablesList._drop_operation () ;
    var_cas_listeAffectationParametresEffectifs._drop_operation () ;
  }else{
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_96455 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_96541 = var_cas_listeCibles.firstObject () ;
    while ((operand_96455 != NULL)
        && (operand_96541 != NULL)) {
      macroValidPointer (operand_96455) ;
      macroValidPointer (operand_96541) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_96455->aNomAttribut ;
      if (operand_96541->aCible._isBuilt ()) {
        operand_96541->aCible (HERE)->method_verifierType (_inLexique, operand_96455->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList SOURCE_FILE_AT_LINE (2521)) ;
      }
      operand_96455 = operand_96455->nextObject () ;
      operand_96541 = operand_96541->nextObject () ;
    }
  }
  ...
  if (var_cas_outAllVariablesList._isBuilt () &&
      var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2528))._isBuilt () &&
      var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2529))._isBuilt () &&
      var_cas_nullName._isBuilt ()) {
    ::routine_appendJokersIfNeeded (_inLexique,  var_cas_outAllVariablesList,  var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2528)),  var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2529)),  var_cas_nullName SOURCE_FILE_AT_LINE (2527)) ;
  }
}
...
void semantics_parser::
pr_input_parameters_list_semantics_parser_2485_29_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_18 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_target_entity_semantics_parser_2536_21_ (galgas_scanner & _inLexique,
                                GGS_typeCible  &var_cas_typeEntiteDestination,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariableDest, var_cas_typeVarDest, var_cas_nomCppDest SOURCE_FILE_AT_LINE (2544)) ;
...
void semantics_parser::
pr_target_entity_semantics_parser_2536_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_target_entity_semantics_parser_2550_21_ (galgas_scanner & _inLexique,
                                GGS_typeCible  &var_cas_typeEntiteDestination,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */) {
...
void semantics_parser::
pr_target_entity_semantics_parser_2550_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2A) ;
}
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2566_45_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2577)) ;
  GGS_typeListeAttributsSemantiques  var_cas_formalParametersList ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleAddAssignOperatorCall (_inLexique, GGS_location (_inLexique), var_cas_formalParametersList SOURCE_FILE_AT_LINE (2580)) ;
  }
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2600))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2600)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2601)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2601))) + (GGS_string (true, " argument(s), while ")))) + (var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2601)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2601))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (2602)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_99750 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_99824 = var_cas_typeList.firstObject () ;
    while ((operand_99750 != NULL)
        && (operand_99824 != NULL)) {
      macroValidPointer (operand_99750) ;
      macroValidPointer (operand_99824) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_99750->mAttributType,  operand_99824->mType,  operand_99824->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2606)) ;
      operand_99750 = operand_99750->nextObject () ;
      operand_99824 = operand_99824->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2566_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__21) ;
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2625_45_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2636)) ;
  GGS_typeListeAttributsSemantiques  var_cas_formalParametersList ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleMinusAssignOperatorCall (_inLexique, GGS_location (_inLexique), var_cas_formalParametersList SOURCE_FILE_AT_LINE (2639)) ;
  }
  GGS_typeTypesList  var_cas_typeList ;
  var_cas_typeList = GGS_typeTypesList::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2659))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2659)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2660)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2660))) + (GGS_string (true, " argument(s), while ")))) + (var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2660)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2660))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (2661)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_102207 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_102281 = var_cas_typeList.firstObject () ;
    while ((operand_102207 != NULL)
        && (operand_102281 != NULL)) {
      macroValidPointer (operand_102207) ;
      macroValidPointer (operand_102281) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_102207->mAttributType,  operand_102281->mType,  operand_102281->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2665)) ;
      operand_102207 = operand_102207->nextObject () ;
      operand_102281 = operand_102281->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2625_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_3D) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__21) ;
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2684_45_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2695)) ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleIncrementOperatorCall (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2697)) ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2684_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_2B) ;
}
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2711_45_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
  ...
  GGS_AC_galgasType  var_cas_targetVariableType ;
  GGS_typeCplusPlusName  var_cas_nomCppVariableSource ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomVarDest, var_cas_targetVariableType, var_cas_nomCppVariableSource SOURCE_FILE_AT_LINE (2722)) ;
  if (var_cas_targetVariableType._isBuilt ()) {
    var_cas_targetVariableType (HERE)->method_handleDecrementOperatorCall (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2724)) ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2711_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_2D) ;
}
...
void semantics_parser::
semantics_parser::
pr_actual_parameters_list_semantics_parser_2734_30_ (galgas_scanner & _inLexique,
  ...
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_listeTypesParametresFormels,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_outExpressionList SOURCE_FILE_AT_LINE (2752)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_actual_parameters_list_semantics_parser_2734_30_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_parse_parameters_list_semantics_parser_2765_29_ (galgas_scanner & _inLexique,
                                GGS_L_actualParametersSignature  &var_cas_listeTypesParametresEffectifs,
                                GGS_typeExpressionList  &var_cas_outExpressionList,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_22 (_inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_23 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2803)) ;
              var_cas_listeTypesParametresEffectifs._addAssign_operation (var_cas_typeArgument, var_cas_parameterPassingMode) ;
              GGS_typeExpression  var_cas_e ;
              var_cas_e = GGS_typeVarInExpression::constructor_new (_inLexique, var_cas_nomCppArgument COMMA_HERE) ;
              var_cas_outExpressionList._addAssign_operation (var_cas_e) ;
              if ((var_cas_exclusiveVariables.reader_hasKey (_inLexique, var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2807)) SOURCE_FILE_AT_LINE (2807))).isBuiltAndTrue ()) {
                var_cas_nomArgument.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object is already named as input or output/input effectif argument of current instruction") SOURCE_FILE_AT_LINE (2809)) ;
              }else{
                var_cas_exclusiveVariables._addAssign_operation (var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2810))) ;
              }
              } break ;
            default :
              break ;
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_nomArgument.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2819)) ;
          GGS_actualParametersPassingMode var_cas_parameterPassingMode ;
          ...
          var_cas_e = GGS_typeVarInExpression::constructor_new (_inLexique, var_cas_nomCppArgument COMMA_HERE) ;
          var_cas_outExpressionList._addAssign_operation (var_cas_e) ;
          if ((var_cas_exclusiveVariables.reader_hasKey (_inLexique, var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2824)) SOURCE_FILE_AT_LINE (2824))).isBuiltAndTrue ()) {
            var_cas_nomArgument.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object is already named as input or output/input effectif argument of current instruction") SOURCE_FILE_AT_LINE (2826)) ;
          }else{
            var_cas_exclusiveVariables._addAssign_operation (var_cas_nomArgument.reader_string (_inLexique SOURCE_FILE_AT_LINE (2827))) ;
          }
          } break ;
        default :
          syntaxRepeat = false ;
...
void semantics_parser::
pr_parse_parameters_list_semantics_parser_2765_29_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_22 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instructions_list_semantics_parser_2836_34_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique SOURCE_FILE_AT_LINE (2848)) ;
  ...
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2848)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_semantic_instructions_list_semantics_parser_2836_34_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2870_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  if (var_cas_ioPropertyMap._isBuilt ()) {
    var_cas_ioPropertyMap (HERE)->method_searchKey (_inLexique, var_cas_calledPropertyName, var_cas_kind, var_cas_typeName SOURCE_FILE_AT_LINE (2888)) ;
  }
  if ((var_cas_ioConstraintPropertyDefinitionSet.reader_hasKey (_inLexique, var_cas_calledPropertyName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2889)) SOURCE_FILE_AT_LINE (2889))).isBuiltAndTrue ()) {
    var_cas_calledPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this property has been already initialized") SOURCE_FILE_AT_LINE (2891)) ;
  }else{
    var_cas_ioConstraintPropertyDefinitionSet._addAssign_operation (var_cas_calledPropertyName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2892))) ;
  }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_112672 ;
            GGS_uint  var_cas_112675 ;
            GGS_string var_cas_112678 ;
            GGS_bool var_cas_112681 ;
            if (var_cas_ioMapAsConstraintPropertyMap._isBuilt ()) {
              var_cas_ioMapAsConstraintPropertyMap (HERE)->method_searchKey (_inLexique, var_cas_propertyArgumentName, var_cas_propertyTypeName, var_cas_112672, var_cas_112675, var_cas_112678, var_cas_112681 SOURCE_FILE_AT_LINE (2904)) ;
            }
  ...
  if ((var_cas_ioCallInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, var_cas_calledPropertyName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2913)) SOURCE_FILE_AT_LINE (2913))).isBuiltAndTrue ()) {
    ...
    if (var_cas_ioCallInstructionSharedPropertySignatureMap._isBuilt ()) {
      var_cas_ioCallInstructionSharedPropertySignatureMap (HERE)->method_searchKey (_inLexique, var_cas_calledPropertyName, var_cas_previousParameterTypeList, var_cas_previousParameterTypeListLocation SOURCE_FILE_AT_LINE (2916)) ;
    }
    if (((var_cas_previousParameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2917))) == (var_cas_parameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2917)))).isBuiltAndTrue ()) {
      GGS_sharedPropertyList::element_type * operand_113350 = var_cas_previousParameterTypeList.firstObject () ;
      GGS_sharedPropertyList::element_type * operand_113418 = var_cas_parameterTypeList.firstObject () ;
      while ((operand_113350 != NULL)
          && (operand_113418 != NULL)) {
        macroValidPointer (operand_113350) ;
        macroValidPointer (operand_113418) ;
        if (((operand_113350->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2920))) != (operand_113418->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2920)))).isBuiltAndTrue ()) {
          operand_113418->mSharedPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this shared property has '@")) + (operand_113418->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2921))))) + (GGS_string (true, "' type, while a previous call has named an attribute of type '@")))) + (operand_113350->mSharedPropertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2922))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2923)) ;
        }
        operand_113350 = operand_113350->nextObject () ;
        operand_113418 = operand_113418->nextObject () ;
      }
    }else{
      var_cas_previousParameterTypeListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this instruction names ")) + (var_cas_parameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2926)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2926))))) + (GGS_string (true, " shared parameter(s), while a previous call has named ")))) + (var_cas_previousParameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2927)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2927))))) + (GGS_string (true, " parameter(s)"))) SOURCE_FILE_AT_LINE (2929)) ;
    }
  }else{
    var_cas_ioCallInstructionSharedPropertySignatureMap.method_insertKey (_inLexique, var_cas_calledPropertyName, var_cas_parameterTypeList, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2931)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2870_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_call) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_24 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2951_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeVarSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeVarSource.getPtr () != NULL) {
        ...
        var_cas_nomVarSource.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2974)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2951_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extract) ;
...
void semantics_parser::
semantics_parser::
pr_extract_instruction_semantics_parser_3000_27_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomClasse, var_cas_entite SOURCE_FILE_AT_LINE (3022)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_nomClasse.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3023)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_leType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_leType.getPtr () != NULL) {
        ...
        var_cas_nomClasse.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3034)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  if (((! (var_cas_tableDesClassesAncetres.reader_hasKey (_inLexique, var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (3036)) SOURCE_FILE_AT_LINE (3036))))).isBuiltAndTrue ()) {
    var_cas_nomClasse.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (3037))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3038)) ;
  }
  GGS_L_assignedVariables  var_cas_listeAffectationParametresEffectifs ;
  ...
  if (var_cas_errorExpressionType._isBuilt ()) {
    var_cas_errorExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3062)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  GGS_lstring  var_cas_messageName ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  if (var_cas_tableMessagesAbstraits._isBuilt ()) {
    var_cas_tableMessagesAbstraits (HERE)->method_searchKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (3066)) ;
  }
...
void semantics_parser::
pr_extract_instruction_semantics_parser_3000_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_3E) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
...
void semantics_parser::
semantics_parser::
pr_extract_instruction_semantics_parser_3079_27_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3097)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3099)) ;
        ...
        GGS_AC_semanticsEntity  var_cas_entite ;
        if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
          var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomType1, var_cas_entite SOURCE_FILE_AT_LINE (3107)) ;
        }
        { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_entite.getPtr () != NULL) {
              ...
              message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
              message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
              var_cas_nomType1.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3108)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_definitionClasse1.getPtr () != NULL) {
              ...
              var_cas_nomType1.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3120)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (_inLexique, var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (3122)) SOURCE_FILE_AT_LINE (3122))))).isBuiltAndTrue ()) {
          var_cas_nomType1.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_string (_inLexique SOURCE_FILE_AT_LINE (3123))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3124)) ;
        }
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
        ::routine_buildMapWithLocalConstants (_inLexique,  var_cas_elementsList,  var_cas_listeAttributs1,  var_cas_ioVariablesMap,  var_cas_indicatif1,  GGS_localConstantBuildStyleEnum::constructor_listStyle (_inLexique COMMA_HERE),  var_cas_ellipsisFound SOURCE_FILE_AT_LINE (3155)) ;
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_3E) ;
        GGS_typeInstructionList  var_cas_instructionsList ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3099)) ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3183)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3183)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3097)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extract) ;
}
...
void semantics_parser::
pr_extract_instruction_semantics_parser_3079_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_when) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
pr_semantic_instruction_semantics_parser_3213_28_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (3233)) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3254_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3254_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_drop) ;
...
void semantics_parser::
semantics_parser::
pr_drop_instruction_semantics_parser_3277_24_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_galgasType  var_cas_127738 ;
        var_cas_ioVariablesMap.method_searchForDestructiveReadAccess (_inLexique, var_cas_nom, var_cas_127738, var_cas_nomCppVar SOURCE_FILE_AT_LINE (3287)) ;
        GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_drop_instruction_semantics_parser_3277_24_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      switch (select_repeat_semantics_parser_30 (_inLexique)) {
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_3304_45_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomVarDest, var_cas_entite SOURCE_FILE_AT_LINE (3314)) ;
  }
  { cPtr_typeEntiteRoutine * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteRoutine *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteRoutine::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_nomVarDest.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3315)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_3304_45_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3339_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (3357)) ;
  }
  ...
  { cPtr_typeEntiteActionExterne * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteActionExterne *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_nomAction.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3359)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3339_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_action) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_actual_parameters_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  ...
  switch (select_semantics_parser_31 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_variableType._isBuilt ()) {
        var_cas_variableType (HERE)->method_handleReaderInstructionCall (_inLexique, var_cas_readObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3413)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_variableType ;
      GGS_typeCplusPlusName  var_cas_cppVariableName ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_modifiedObjectName, var_cas_variableType, var_cas_cppVariableName SOURCE_FILE_AT_LINE (3432)) ;
      GGS_lstring  var_cas_methodName ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      var_cas_methodName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
      if (var_cas_variableType._isBuilt ()) {
        var_cas_variableType (HERE)->method_handleModifierCall (_inLexique, var_cas_modifiedObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3437)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
      nt_actual_parameters_list_ (_inLexique, var_cas_methodSignature, var_cas_expressionsList, var_cas_ioVariablesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioInstructionList) ;
...
pr_semantic_instruction_semantics_parser_3493_28_ (galgas_scanner & _inLexique,
  ...
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_errorExpression, var_cas_errorExpressionType) ;
  if (var_cas_errorExpressionType._isBuilt ()) {
    var_cas_errorExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3516)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  ...
  { cPtr_typeGalgas_string * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_string *> (var_cas_warningMessageExpressionType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_warningMessageExpressionType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3529)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3543_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  if (var_cas_errorLocationExpressionType._isBuilt ()) {
    var_cas_errorLocationExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3566)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_AC_galgasType  var_cas_140216 ;
            var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariable, var_cas_140216, var_cas_varCppName SOURCE_FILE_AT_LINE (3589)) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3543_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_error) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  nt_expression_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3650_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3666)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3668)) ;
        ...
        { cPtr_typeGalgas_bool * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_bool *> (var_cas_resultType.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            if (var_cas_resultType.getPtr () != NULL) {
              ...
              GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3678)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
          }
        ...
        if ((var_cas_firstBranch).isBuiltAndTrue ()) {
          ...
          ::routine_displayConstraintDefinitionErrors (_inLexique,  var_cas_ioConstraintPropertyDefinitionSet,  var_cas_constraintPropertyDefinitionSet SOURCE_FILE_AT_LINE (3698)) ;
        }
        var_cas_listeBranchesTest._addAssign_operation (var_cas_testBranche, var_cas_listeInstructionsBrancheTest) ;
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3668)) ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3706)) ;
  switch (select_semantics_parser_35 (_inLexique)) {
    case 1 : {
      if (((var_cas_ioConstraintPropertyDefinitionSet) != (var_cas_startConstraintPropertyDefinitionSet)).isBuiltAndTrue ()) {
        ::routine_displayConstraintDefinitionErrorsNoElse (_inLexique,  var_cas_ioConstraintPropertyDefinitionSet,  var_cas_startConstraintPropertyDefinitionSet SOURCE_FILE_AT_LINE (3709)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_else) ;
      ...
      if (((var_cas_ioConstraintPropertyDefinitionSet) != (var_cas_constraintPropertyDefinitionSet)).isBuiltAndTrue ()) {
        ::routine_displayConstraintDefinitionErrors (_inLexique,  var_cas_ioConstraintPropertyDefinitionSet,  var_cas_constraintPropertyDefinitionSet SOURCE_FILE_AT_LINE (3727)) ;
      }
      } break ;
    default :
      break ;
  }
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3706)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_if) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3666)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3650_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_if) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_expression_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3747_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  { cPtr_typeGalgas_uint * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_variantResultType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_variantResultType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3770)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3774)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3775)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3775)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3774)) ;
  ...
  { cPtr_typeGalgas_bool * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_bool *> (var_cas_resultType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_resultType.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgas_bool::static_string_message_messageGalgasType () ;
        message2_ << var_cas_resultType (HERE)->message_messageGalgasType () ;
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3802)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3806)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3807)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3807)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3806)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3747_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_loop) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  nt_semantic_instructions_list_no_verif_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3842_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  { cPtr_typeGalgas_lstring * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_typeNomFichierSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_typeNomFichierSource.getPtr () != NULL) {
        ...
        var_cas_nomFichierSource.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3872)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (3885)) ;
  }
  ...
  { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_e.getPtr () != NULL) {
        ...
        message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
        var_cas_grammarName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3887)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  if (var_cas_startSymbolAltMap._isBuilt ()) {
    var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (3890)) ;
  }
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_startSymbolSignature,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_expressionsList SOURCE_FILE_AT_LINE (3892)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3842_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_36 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3915_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_typeInstruction  var_cas_instruction ;
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3929)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3930)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_enumeratedVariableName, var_cas_enumeratedVariableType, var_cas_enumeratedVariableCPPName SOURCE_FILE_AT_LINE (3945)) ;
        ...
        if (var_cas_enumeratedVariableType._isBuilt ()) {
          var_cas_enumeratedVariableType (HERE)->method_acceptForeachInstruction (_inLexique, var_cas_enumeratedVariableName, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum SOURCE_FILE_AT_LINE (3949)) ;
        }
        GGS_string var_cas_typeName ;
        if (var_cas_enumeratedVariableType._isBuilt ()) {
          var_cas_enumeratedVariableType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (3952)) ;
        }
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3930)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3929)) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3915_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_foreach) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_read_access_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_parse_match_operand_semantics_parser_4015_27_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  if (var_cas_type._isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_typeGalgasClassType * operand_157011 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_157011) ; 
      var_cas_outBaseTypeName = operand_157011->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_157217 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_157217) ; 
      var_cas_outBaseTypeName = operand_157217->mEnumTypeName ;
      var_cas_outIsEnumeration = GGS_bool (true, true) ;
      var_cas_outEnumMessageMap = operand_157217->mEnumConstantesMap ;
    }else{ // Else part
      GGS_string var_cas_actualTypeName ;
      if (var_cas_type._isBuilt ()) {
        var_cas_type (HERE)->method_getTypeName (_inLexique, var_cas_actualTypeName SOURCE_FILE_AT_LINE (4043)) ;
      }
      var_cas_variableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '@")) + (var_cas_actualTypeName))) + (GGS_string (true, "' ; I was expected an enumeration type or an abstract type"))) SOURCE_FILE_AT_LINE (4047)) ;
...
void semantics_parser::
pr_parse_match_operand_semantics_parser_4015_27_parse (galgas_scanner & _inLexique) {
  nt_read_access_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_4053_24_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4067)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      var_cas_definitionClasse1._drop_operation () ;
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (4068)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_definitionClasse1 = ptrExtraire_->aDefType ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_definitionClasse1.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgasClassType::static_string_message_messageGalgasType () ;
        message2_ << var_cas_definitionClasse1 (HERE)->message_messageGalgasType () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (4081)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_listeAttributs1 = ptrExtraire_->mNonExternAttributesList ;
  ...
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class is not allowed here") SOURCE_FILE_AT_LINE (4085)) ;
  }
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a constant of '@")) + (var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4088))))) + (GGS_string (true, "' enumeration type is expected here"))) SOURCE_FILE_AT_LINE (4089)) ;
  }else if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (_inLexique, var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4089)) SOURCE_FILE_AT_LINE (4089))))).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This type does not inherit from '")) + (var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4090))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (4091)) ;
  }
...
void semantics_parser::
pr_parse_match_case_semantics_parser_4053_24_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  nt_parse_effective_input_parameters_list_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_4103_24_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_lstring  var_cas_inTypeName,
                                GGS_location  /* var_cas_inVarLocation */,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    if (var_cas_inEnumMessageMap._isBuilt ()) {
      var_cas_inEnumMessageMap (HERE)->method_searchKey (_inLexique, var_cas_outEnumConstantName SOURCE_FILE_AT_LINE (4116)) ;
    }
  }else{
    var_cas_outEnumConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a class that inherit from '@")) + (var_cas_inTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4118))))) + (GGS_string (true, "' abstract class is expected here"))) SOURCE_FILE_AT_LINE (4119)) ;
  }
}
...
void semantics_parser::
pr_parse_match_case_semantics_parser_4103_24_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_4124_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (4169)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_39 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_when) ;
          var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (4173)) ;
          ...
          var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (4173)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (4217)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_else) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (4217)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (4169)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_match) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_4124_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_match) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instructions_list_no_verif_semantics_parser_4253_43_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instructions_list_no_verif_semantics_parser_4253_43_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_40 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_4286_27_ (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_optional_assignment_semantics_parser_4286_27_parse (galgas_scanner & /* _inLexique */) {
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_4302_27_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &/* var_cas_inTypeName */,
                                ...
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  GGS_AC_galgasType  var_cas_167172 ;
  GGS_typeCplusPlusName  var_cas_167175 ;
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_167172, var_cas_167175 SOURCE_FILE_AT_LINE (4314)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_inVariableType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (4326)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_optional_assignment_semantics_parser_4302_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  nt_expression_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_4334_27_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inTypeName,
                                const GGS_lstring  &var_cas_inTargetVarName,
                                const GGS_typeCplusPlusName  &var_cas_inTargetVariableCppName,
                                const GGS_AC_galgasType  &var_cas_inVariableType,
                                ...
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  GGS_AC_galgasType  var_cas_168288 ;
  GGS_typeCplusPlusName  var_cas_168291 ;
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_168288, var_cas_168291 SOURCE_FILE_AT_LINE (4345)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  ...
  if (var_cas_inVariableType._isBuilt ()) {
    var_cas_inVariableType (HERE)->method_handleConstructorCall (_inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques SOURCE_FILE_AT_LINE (4351)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
...
void semantics_parser::
pr_optional_assignment_semantics_parser_4334_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4374_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_41 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4387)) SOURCE_FILE_AT_LINE (4387))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4388)) SOURCE_FILE_AT_LINE (4388))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4390)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
      ...
      var_cas_cppClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "old style map definition") SOURCE_FILE_AT_LINE (4397)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_42 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4410)), GGS_bool (true, true)) ;
              } break ;
            case 3 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4417)), GGS_bool (true, true)) ;
              } break ;
            case 4 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4452)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_insertOrSearchMethodList::element_type * operand_173193 = var_cas_insertMethodList.firstObject () ;
      while ((operand_173193 != NULL)) {
        macroValidPointer (operand_173193) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_173391 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_173391 != NULL)) {
          macroValidPointer (operand_173391) ;
          var_cas_methodSignature._addAssign_operation (operand_173391->mAttributType, var_cas_inPassingMode) ;
          operand_173391 = operand_173391->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_173193->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4481)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_173822 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_173822 != NULL)) {
          macroValidPointer (operand_173822) ;
          var_cas_methodSignature._addAssign_operation (operand_173822->mAttributType, var_cas_inPassingMode) ;
          operand_173822 = operand_173822->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_173193->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4489))) + (GGS_string (true, "GetIndex"))), operand_173193->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4489)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4490)) ;
        operand_173193 = operand_173193->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_174172 = var_cas_searchMethodList.firstObject () ;
      while ((operand_174172 != NULL)) {
        macroValidPointer (operand_174172) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_174368 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_174368 != NULL)) {
          macroValidPointer (operand_174368) ;
          var_cas_methodSignature._addAssign_operation (operand_174368->mAttributType, var_cas_outPassingMode) ;
          operand_174368 = operand_174368->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_174172->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4499)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_174797 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_174797 != NULL)) {
          macroValidPointer (operand_174797) ;
          var_cas_methodSignature._addAssign_operation (operand_174797->mAttributType, var_cas_outPassingMode) ;
          operand_174797 = operand_174797->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_174172->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4507))) + (GGS_string (true, "GetIndex"))), operand_174172->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4507)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4508)) ;
        operand_174172 = operand_174172->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4519)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
          ...
          switch (select_repeat_semantics_parser_43 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4564)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_177970 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_177970 != NULL)) {
                macroValidPointer (operand_177970) ;
                var_cas_methodSignature._addAssign_operation (operand_177970->mAttributType, var_cas_inPassingMode) ;
                operand_177970 = operand_177970->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4572)) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4573)), GGS_bool (true, false)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4575))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_178555 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_178555 != NULL)) {
                  macroValidPointer (operand_178555) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_178555->mAttributType, var_cas_inPassingMode) ;
                  operand_178555 = operand_178555->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4582)) ;
                var_cas_insertMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4583)), GGS_bool (true, true)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              ...
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage._isBuilt ()) {
                ::routine_check_K_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4591)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_179325 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_179325 != NULL)) {
                macroValidPointer (operand_179325) ;
                var_cas_methodSignature._addAssign_operation (operand_179325->mAttributType, var_cas_outPassingMode) ;
                operand_179325 = operand_179325->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4599)) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4600)), GGS_bool (true, false)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4602))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_179941 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_179941 != NULL)) {
                  macroValidPointer (operand_179941) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_179941->mAttributType, var_cas_outPassingMode) ;
                  operand_179941 = operand_179941->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4609)) ;
                var_cas_searchMethodList._addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4610)), GGS_bool (true, true)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4374_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_41 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4645)) SOURCE_FILE_AT_LINE (4645))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4645)) SOURCE_FILE_AT_LINE (4645))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4647)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_42 (_inLexique)) {
            case 2 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4666)), GGS_bool (true, true)) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList._addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_string (_inLexique SOURCE_FILE_AT_LINE (4673)), GGS_bool (true, true)) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4708)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_184817 = var_cas_insertMethodList.firstObject () ;
      while ((operand_184817 != NULL)) {
        macroValidPointer (operand_184817) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_185015 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_185015 != NULL)) {
          macroValidPointer (operand_185015) ;
          var_cas_methodSignature._addAssign_operation (operand_185015->mAttributType, var_cas_inPassingMode) ;
          operand_185015 = operand_185015->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_184817->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4737)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_185446 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_185446 != NULL)) {
          macroValidPointer (operand_185446) ;
          var_cas_methodSignature._addAssign_operation (operand_185446->mAttributType, var_cas_inPassingMode) ;
          operand_185446 = operand_185446->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_184817->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4745))) + (GGS_string (true, "GetIndex"))), operand_184817->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4745)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4746)) ;
        operand_184817 = operand_184817->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_185796 = var_cas_searchMethodList.firstObject () ;
      while ((operand_185796 != NULL)) {
        macroValidPointer (operand_185796) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_185994 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_185994 != NULL)) {
          macroValidPointer (operand_185994) ;
          var_cas_methodSignature._addAssign_operation (operand_185994->mAttributType, var_cas_outPassingMode) ;
          operand_185994 = operand_185994->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_185796->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4755)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_186426 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_186426 != NULL)) {
          macroValidPointer (operand_186426) ;
          var_cas_methodSignature._addAssign_operation (operand_186426->mAttributType, var_cas_outPassingMode) ;
          operand_186426 = operand_186426->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_185796->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4763))) + (GGS_string (true, "GetIndex"))), operand_185796->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4763)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4764)) ;
        operand_185796 = operand_185796->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4775)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4777)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_43 (_inLexique)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_188532 ;
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_188532) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_188741 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_188741 != NULL)) {
                macroValidPointer (operand_188741) ;
                var_cas_methodSignature._addAssign_operation (operand_188741->mAttributType, var_cas_inPassingMode) ;
                operand_188741 = operand_188741->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4817)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4819))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_189286 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_189286 != NULL)) {
                  macroValidPointer (operand_189286) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_189286->mAttributType, var_cas_inPassingMode) ;
                  operand_189286 = operand_189286->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4826)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_189673 ;
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_189673) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              ...
              while ((operand_189888 != NULL)) {
                ...
                var_cas_methodSignature._addAssign_operation (operand_189888->mAttributType, var_cas_outPassingMode) ;
                operand_189888 = operand_189888->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4840)) ;
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4842))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_190474 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_190474 != NULL)) {
                  macroValidPointer (operand_190474) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_190474->mAttributType, var_cas_outPassingMode) ;
                  operand_190474 = operand_190474->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4849)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4861)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4863)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    default :
      break ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4374_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_41 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_ex_map_method_semantics_parser_4870_21_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomMethode,
...
void semantics_parser::
pr_ex_map_method_semantics_parser_4870_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_error) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void semantics_parser::
semantics_parser::
pr_map_method_semantics_parser_4882_18_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_methodName,
                                GGS_lstring  &var_cas_getIndexMethodName,
                                GGS_lstring  &var_cas_outMessage) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_map_method_semantics_parser_4882_18_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_44 (_inLexique)) {
    case 1 : {
      } break ;
...
void semantics_parser::
semantics_parser::
pr_message_pattern_semantics_parser_4901_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        switch (select_semantics_parser_46 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
            var_cas_messageText.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
            if (((var_cas_messageText.reader_string (_inLexique SOURCE_FILE_AT_LINE (4909))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_outMessageList._addAssign_operation (var_cas_messageText.reader_string (_inLexique SOURCE_FILE_AT_LINE (4910))) ;
            }
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2A) ;
...
void semantics_parser::
pr_message_pattern_semantics_parser_4901_23_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_semantics_parser_46 (_inLexique)) {
          case 1 : {
...
pr_semantics_declaration_semantics_parser_4927_29_ (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_47 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4940)) SOURCE_FILE_AT_LINE (4940))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4940)) SOURCE_FILE_AT_LINE (4940))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4942)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4964)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
pr_semantics_declaration_semantics_parser_4927_29_importSemantics (galgas_scanner & _inLexique,
  ...
  switch (select_semantics_parser_47 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4981)) SOURCE_FILE_AT_LINE (4981))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4981)) SOURCE_FILE_AT_LINE (4981))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4983)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5005)) ;
      GGS_TypeModel  var_cas_t ;
      var_cas_t = GGS_ListModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (5007)) ;
      } break ;
    default :
      break ;
  }
...
void semantics_parser::
semantics_parser::
pr_attributes_definition_list_semantics_parser_5017_34_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_48 (_inLexique)) {
        case 2 : {
          ...
          var_cas_tableAttributs.method_insertKey (_inLexique, var_cas_attributeName, var_cas_definitionType SOURCE_FILE_AT_LINE (5041)) ;
...
void semantics_parser::
pr_attributes_definition_list_semantics_parser_5017_34_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_48 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5055_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_49 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_constructorsMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (5104)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
          GGS_lstring  var_cas_methodName ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5124)) ;
          } break ;
        case 4 : {
          ...
          switch (select_semantics_parser_51 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signatureForGrammarComponent ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
              var_cas_modifiersMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5144)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              ...
              if ((var_cas_acceptAddAssignOperatorCall).isBuiltAndTrue ()) {
                var_cas_errorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (5165)) ;
              }else{
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (5183)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5055_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_49 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_EXconstructorsMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_constructorArgumentTypesList SOURCE_FILE_AT_LINE (5239)) ;
          var_cas_constructorMap.method_insertKey (_inLexique, var_cas_constructorName, var_cas_formalInputArgumentList SOURCE_FILE_AT_LINE (5240)) ;
          } break ;
        case 3 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
          ...
          nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          var_cas_readersInInstructionMap.method_insertKey (_inLexique, var_cas_readerName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5260)) ;
          var_cas_readerMap.method_insertKey (_inLexique, var_cas_readerName, var_cas_signature SOURCE_FILE_AT_LINE (5261)) ;
          } break ;
        case 4 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_modifier) ;
          switch (select_semantics_parser_51 (_inLexique)) {
            case 1 : {
              ...
              GGS_L_signature  var_cas_signature ;
              nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signature) ;
              var_cas_EXmodifiersMap.method_insertKey (_inLexique, var_cas_modifierName, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (5281)) ;
              var_cas_modifierMap.method_insertKey (_inLexique, var_cas_modifierName, var_cas_signature SOURCE_FILE_AT_LINE (5282)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2B_3D) ;
              if (((var_cas_addAssignFormalInputArgumentList.reader_length (_inLexique SOURCE_FILE_AT_LINE (5285))) > (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (5287)) ;
              }else{
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true, true) ;
              }
              { bool syntaxRepeat = true ;
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_e SOURCE_FILE_AT_LINE (5318)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_externTypeName, var_cas_t SOURCE_FILE_AT_LINE (5320)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5055_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extern) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
pr_formal_argument_type_semantics_parser_5328_28_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5335)) SOURCE_FILE_AT_LINE (5335))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5337)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5340)) ;
    }
  }
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5350_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5358)) SOURCE_FILE_AT_LINE (5358))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5360)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5361)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5363)) ;
    }
    { cPtr_typeGalgasUndefinedListType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5364)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5350_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5350_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5375_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5383)) SOURCE_FILE_AT_LINE (5383))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5385)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5386)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5388)) ;
    }
    { cPtr_typeGalgasUndefinedMapType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (var_cas_type_semantique.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        if (var_cas_type_semantique.getPtr () != NULL) {
          ...
          message2_ << var_cas_type_semantique (HERE)->message_messageGalgasType () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5389)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
      }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5375_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5375_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5400_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  var_cas_outGalgasTypeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (5409)) SOURCE_FILE_AT_LINE (5409))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
      var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_entite SOURCE_FILE_AT_LINE (5411)) ;
    }
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type_semantique._drop_operation () ;
        if (var_cas_entite.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
          var_cas_outGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (5412)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type_semantique = ptrExtraire_->aDefType ;
    ...
    if (var_cas_tableEnAvant._isBuilt ()) {
      var_cas_tableEnAvant (HERE)->method_searchKey (_inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique SOURCE_FILE_AT_LINE (5414)) ;
    }
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5400_28_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5400_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5431_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (5455)) ;
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5431_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
                                GGS_ActionMap  &var_cas_ioExternActionMap,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  var_cas_entite = GGS_typeEntiteActionExterne::constructor_new (_inLexique, var_cas_listeDeTypes COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_actionName, var_cas_entite SOURCE_FILE_AT_LINE (5483)) ;
  var_cas_ioExternActionMap.method_insertKey (_inLexique, var_cas_actionName, var_cas_signature, GGS_bool (true, true) SOURCE_FILE_AT_LINE (5484)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5431_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_action) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5494_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5514)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_cstMessageStringMap.method_insertKey (_inLexique, var_cas_cstName, var_cas_cstString SOURCE_FILE_AT_LINE (5533)) ;
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          ...
          GGS_enumConstantMap::element_type * operand_216152 = var_cas_constantMap.firstObject () ;
          while ((operand_216152 != NULL)) {
            macroValidPointer (operand_216152) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_216152->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (5541)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            if (var_cas_cstMessageStringMap._isBuilt ()) {
              var_cas_cstMessageStringMap (HERE)->method_searchKey (_inLexique, var_cas_name, var_cas_cstString SOURCE_FILE_AT_LINE (5543)) ;
            }
            var_cas_messageStringList._addAssign_operation (var_cas_cstString) ;
            operand_216152 = operand_216152->nextObject () ;
          }
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5547)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_ee SOURCE_FILE_AT_LINE (5559)) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5494_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5578)) ;
      switch (select_repeat_semantics_parser_53 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2C) ;
          } break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_54 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_messageName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (5592)) ;
          GGS_L_lstringList  var_cas_messageStringList ;
          var_cas_messageStringList = GGS_L_lstringList::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_exEnumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5594)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_e SOURCE_FILE_AT_LINE (5611)) ;
  GGS_TypeModel  var_cas_type ;
  var_cas_type = GGS_EnumModel::constructor_new (_inLexique, var_cas_constantMap, var_cas_enumMessageMap COMMA_HERE) ;
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_type SOURCE_FILE_AT_LINE (5613)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_semantics_declaration_semantics_parser_5494_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_enum) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  { bool syntaxRepeat = true ;
