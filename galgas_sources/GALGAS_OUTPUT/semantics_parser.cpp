...
pr_galgas_component_semantics_parser_460_24_ (galgas_scanner & _inLexique,
  ...
  if (((! (var_cas_ioSemanticsComponentsMap.reader_hasKey (_inLexique, var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (545)) SOURCE_FILE_AT_LINE (545))))).isBuiltAndTrue ()) {
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_20015 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_20015 != NULL)) {
    macroValidPointer (operand_20015) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_20015->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (564)) SOURCE_FILE_AT_LINE (564))))).isBuiltAndTrue ()) {
      operand_20015->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_20015->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (565))))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (567)) ;
    }
    operand_20015 = operand_20015->nextObject () ;
  }
...
pr_galgas_component_semantics_parser_460_24_importSemantics (galgas_scanner & _inLexique,
  ...
  if (((! (var_cas_ioSemanticsComponentsMap.reader_hasKey (_inLexique, var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (635)) SOURCE_FILE_AT_LINE (635))))).isBuiltAndTrue ()) {
    GGS_M_optionComponents  var_cas_optionsComponentsMap ;
    var_cas_optionsComponentsMap = GGS_M_optionComponents::constructor_emptyMap (_inLexique COMMA_HERE) ;
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            case 1 : {
              ...
              var_cas_outImportedOptionComponents.addAssign_operation (var_cas_optionComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (781))) ;
            ...
            case 2 : {
              ...
              var_cas_outImportedGrammarComponents.addAssign_operation (var_cas_grammarComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (803))) ;
              ...
              GGS_lstring  var_cas_28910 ;
              GGS_M_optionComponents  var_cas_28913 ;
              if (var_cas_grammarComponentsMap.isBuilt ()) {
                var_cas_grammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarComponentName, var_cas_nonterminalSymbolParametersMap, var_cas_28910, var_cas_28913 SOURCE_FILE_AT_LINE (820)) ;
              }
              ...
              GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_29019 = var_cas_nonterminalSymbolParametersMap.firstObject () ;
              while ((operand_29019 != NULL)) {
                ...
                GGS_L_signature::element_type * operand_29178 = operand_29019->mInfo.mFormalParametersList.firstObject () ;
                while ((operand_29178 != NULL)) {
                  macroValidPointer (operand_29178) ;
                  GGS_AC_semanticsEntity  var_cas_e ;
                  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
                    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, operand_29178->mGalgasTypeName, var_cas_e SOURCE_FILE_AT_LINE (826)) ;
                  }
                  ...
                  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
                    if (ptrExtraire_ == NULL) {
                      ...
                      if (var_cas_e.getPtr () != NULL) {
                        ...
                        operand_29178->mGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (828)) ;
                      }
                    }else{
                  ...
                  var_cas_formalParametersList.addAssign_operation (var_cas_type, operand_29178->mFormalArgumentPassingMode) ;
                  operand_29178 = operand_29178->nextObject () ;
                }
                var_cas_grammarAltMap.method_insertKey (_inLexique, operand_29019->mKey, var_cas_formalParametersList, operand_29019->mInfo.mReturnedEntityTypeName SOURCE_FILE_AT_LINE (831)) ;
                operand_29019 = operand_29019->nextObject () ;
              }
              GGS_AC_semanticsEntity  var_cas_e ;
              ...
              var_cas_outInclusionsForImplementationFile.addAssign_operation (var_cas_fileNameWithPath.reader_value (_inLexique SOURCE_FILE_AT_LINE (839))) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_semantics) ;
              GGS_lstring  var_cas_componentName ;
              ...
              if (((! (var_cas_outImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (856)) SOURCE_FILE_AT_LINE (856))))).isBuiltAndTrue ()) {
                GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
                GGS_M_optionComponents  var_cas_importedOptionsComponentsMap ;
                GGS_ModelMap  var_cas_30773 ;
                GGS_ActionMap  var_cas_30776 ;
                GGS_stringset  var_cas_30779 ;
                GGS_stringset  var_cas_30782 ;
                GGS_stringset  var_cas_30785 ;
                if (var_cas_ioSemanticsComponentsMap.isBuilt ()) {
                  var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_componentName, var_cas_30773, var_cas_30776, var_cas_30779, var_cas_30782, var_cas_30785, var_cas_importedOptionsComponentsMap, var_cas_importedEntities SOURCE_FILE_AT_LINE (859)) ;
                }
                GGS_M_semanticsEntitiesForUse::element_type * operand_30869 = var_cas_importedEntities.firstObject () ;
                while ((operand_30869 != NULL)) {
                  macroValidPointer (operand_30869) ;
                  if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_30869->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (861)) SOURCE_FILE_AT_LINE (861))))).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, operand_30869->mKey, operand_30869->mInfo.aDefEntite SOURCE_FILE_AT_LINE (862)) ;
                  }
                  operand_30869 = operand_30869->nextObject () ;
                }
                var_cas_outInclusionsForHeaderFile.addAssign_operation (var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (865))) ;
                GGS_M_optionComponents::element_type * operand_31314 = var_cas_importedOptionsComponentsMap.firstObject () ;
                while ((operand_31314 != NULL)) {
                  macroValidPointer (operand_31314) ;
                  if (((! (var_cas_ioOptionsComponentsMapForUse.reader_hasKey (_inLexique, operand_31314->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (868)) SOURCE_FILE_AT_LINE (868))))).isBuiltAndTrue ()) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_31314->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (869))))) + (GGS_string (true, "' option component must have been imported"))) SOURCE_FILE_AT_LINE (870)) ;
                  }
                  operand_31314 = operand_31314->nextObject () ;
                }
              }
              ...
              var_cas_outInclusionsForHeaderFile.addAssign_operation (var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (884))) ;
              var_cas_outImportedSemanticsComponents.addAssign_operation (var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (885))) ;
              } break ;
            case 4 : {
              ...
              if (((! (var_cas_outIncludedMetamodelComponents.reader_hasKey (_inLexique, var_cas_metamodelComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (902)) SOURCE_FILE_AT_LINE (902))))).isBuiltAndTrue ()) {
                GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
                GGS_lstring  var_cas_32688 ;
                GGS_entityToImplementMap  var_cas_32709 ;
                GGS_stringset  var_cas_32712 ;
                if (var_cas_ioMetamodelComponentMap.isBuilt ()) {
                  var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelComponentName, var_cas_32688, var_cas_importedEntities, var_cas_32709, var_cas_32712 SOURCE_FILE_AT_LINE (904)) ;
                }
                GGS_M_semanticsEntitiesForUse::element_type * operand_32748 = var_cas_importedEntities.firstObject () ;
                while ((operand_32748 != NULL)) {
                  macroValidPointer (operand_32748) ;
                  if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_32748->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (906)) SOURCE_FILE_AT_LINE (906))))).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, operand_32748->mKey, operand_32748->mInfo.aDefEntite SOURCE_FILE_AT_LINE (907)) ;
                  }
                  operand_32748 = operand_32748->nextObject () ;
                }
                var_cas_outInclusionsForHeaderFile.addAssign_operation (var_cas_metamodelComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (910))) ;
              }
              var_cas_outInclusionsForHeaderFile.addAssign_operation (var_cas_metamodelComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (913))) ;
              var_cas_outIncludedMetamodelComponents.addAssign_operation (var_cas_metamodelComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (914))) ;
              } break ;
            default :
              break ;
          }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            case 1 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_optionComponentName.defineAttribute (_inLexique.tokenString, _inLexique) ;
              var_cas_outIncludedOptionComponents.addAssign_operation (var_cas_optionComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (944))) ;
              switch (select_semantics_parser_3 (_inLexique)) {
                case 1 : {
                  } break ;
                case 2 : {
            ...
            case 3 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_componentName.defineAttribute (_inLexique.tokenString, _inLexique) ;
              var_cas_outIncludedSemanticsComponents.addAssign_operation (var_cas_componentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (964))) ;
              switch (select_semantics_parser_5 (_inLexique)) {
                case 1 : {
                  } break ;
                case 2 : {
              ...
              GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
              GGS_ModelMap  var_cas_35221 ;
              GGS_ActionMap  var_cas_35224 ;
              GGS_stringset  var_cas_35227 ;
              GGS_stringset  var_cas_35230 ;
              GGS_stringset  var_cas_35233 ;
              GGS_M_optionComponents  var_cas_35236 ;
              if (var_cas_ioSemanticsComponentsMap.isBuilt ()) {
                var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_componentName, var_cas_35221, var_cas_35224, var_cas_35227, var_cas_35230, var_cas_35233, var_cas_35236, var_cas_importedEntities SOURCE_FILE_AT_LINE (978)) ;
              }
              GGS_M_semanticsEntitiesForUse::element_type * operand_35288 = var_cas_importedEntities.firstObject () ;
              while ((operand_35288 != NULL)) {
                macroValidPointer (operand_35288) ;
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_35288->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (980)) SOURCE_FILE_AT_LINE (980))))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, operand_35288->mKey, operand_35288->mInfo.aDefEntite SOURCE_FILE_AT_LINE (981)) ;
                }
                operand_35288 = operand_35288->nextObject () ;
              }
            ...
            case 4 : {
              ...
              GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
              GGS_lstring  var_cas_36399 ;
              GGS_entityToImplementMap  var_cas_36420 ;
              GGS_stringset  var_cas_36423 ;
              if (var_cas_ioMetamodelComponentMap.isBuilt ()) {
                var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelComponentName, var_cas_36399, var_cas_importedEntities, var_cas_36420, var_cas_36423 SOURCE_FILE_AT_LINE (1011)) ;
              }
              GGS_M_semanticsEntitiesForUse::element_type * operand_36457 = var_cas_importedEntities.firstObject () ;
              while ((operand_36457 != NULL)) {
                macroValidPointer (operand_36457) ;
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_36457->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1013)) SOURCE_FILE_AT_LINE (1013))))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, operand_36457->mKey, operand_36457->mInfo.aDefEntite SOURCE_FILE_AT_LINE (1014)) ;
                }
                operand_36457 = operand_36457->nextObject () ;
              }
              } break ;
            default :
              break ;
...
pr_semantics_declaration_semantics_parser_1028_29_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1055)) SOURCE_FILE_AT_LINE (1055))).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_1028_29_importSemantics (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_routineName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1133)) SOURCE_FILE_AT_LINE (1133))).isBuiltAndTrue ()) {
    GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1184_20_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1184_20_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
...
void semantics_parser::
pr_parent_class_semantics_parser_1184_20_parse (galgas_scanner & /* _inLexique */) {
}
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1224_20_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeSemanticAttributesMap  &var_cas_tableAttributs,
                                GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                GGS_typeTableMethodes  &var_cas_tableDesMethodes,
  ...
  var_cas_outSuperClassName.defineAttribute (_inLexique.tokenString, _inLexique) ;
  GGS_AC_galgasType  var_cas_typeUtilisateur ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outSuperClassName, var_cas_entite SOURCE_FILE_AT_LINE (1239)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outSuperClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1240)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeUtilisateur.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeUtilisateur.getPtr () != NULL) {
        ...
        var_cas_outSuperClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1248)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  var_cas_tableDesClassesAncetres.method_insertKey (_inLexique, var_cas_outSuperClassName SOURCE_FILE_AT_LINE (1250)) ;
}
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1224_20_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_stringset  &var_cas_outSuperClasses,
                                GGS_typeListModel  &var_cas_outAttributeList,
                                GGS_classMessageMap  &var_cas_outMessageMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_entite SOURCE_FILE_AT_LINE (1270)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      var_cas_typeUtilisateur.drop_operation () ;
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_superClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1271)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_typeUtilisateur = ptrExtraire_->aDefType ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeUtilisateur.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeUtilisateur.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgasClassType::static_string_message_messageGalgasType () ;
        message2_ << var_cas_typeUtilisateur (HERE)->message_messageGalgasType () ;
        var_cas_superClassName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1279)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_tableDesMethodes = ptrExtraire_->mReaderMap ;
  ...
  var_cas_tableDesClassesAncetres.method_insertKey (_inLexique, var_cas_superClassName SOURCE_FILE_AT_LINE (1281)) ;
  GGS_TypeModel  var_cas_type ;
  if (var_cas_ioModelMap.isBuilt ()) {
    var_cas_ioModelMap (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_type SOURCE_FILE_AT_LINE (1284)) ;
  }
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_ClassModel * operand_48152 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_48152) ; 
      var_cas_outSuperClasses = operand_48152->mSuperClasses ;
      var_cas_outAttributeList = operand_48152->mAttributeList ;
      var_cas_outMessageMap = operand_48152->mMessageMap ;
    }else{ // Else part
      var_cas_superClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_superClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1291))))) + (GGS_string (true, "' type is not a class"))) SOURCE_FILE_AT_LINE (1293)) ;
      var_cas_outSuperClasses.drop_operation () ;
      var_cas_outAttributeList.drop_operation () ;
      var_cas_outMessageMap.drop_operation () ;
    }
  }
  var_cas_outSuperClasses.addAssign_operation (var_cas_superClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1294))) ;
  var_cas_outMessageMap = GGS_classMessageMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  var_cas_outSuperClasses = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
  var_cas_outAttributeList = GGS_typeListModel::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void semantics_parser::
pr_parent_class_semantics_parser_1224_20_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extends) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1308_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_8 (_inLexique)) {
    case 1 : {
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1322)) SOURCE_FILE_AT_LINE (1322))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1323)) SOURCE_FILE_AT_LINE (1323))))))).isBuiltAndTrue ()) {
        ...
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1325)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      } break ;
    case 2 : {
      ...
      GGS_typeSemanticAttributesMap  var_cas_tableAttributs ;
      GGS_lstring  var_cas_50487 ;
      nt_parent_class_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableAttributs, var_cas_listeTousAttributsSemantiques, var_cas_ancestorClassMethodsMap, var_cas_tableDesClassesAncetres, var_cas_inheritedMessageMap, var_cas_50487) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_9 (_inLexique)) {
            case 2 : {
              ...
              if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1372)) SOURCE_FILE_AT_LINE (1372))))).isBuiltAndTrue ()) {
                var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1373)) ;
              }
              var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1375)) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              } break ;
            case 3 : {
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_53181 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_53181 != NULL)) {
        macroValidPointer (operand_53181) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_53181->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1421)) SOURCE_FILE_AT_LINE (1421))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_53181->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1422))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1423)) ;
        }
        operand_53181 = operand_53181->nextObject () ;
      }
      ...
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_entite SOURCE_FILE_AT_LINE (1435)) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1308_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_8 (_inLexique)) {
    case 1 : {
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1463)) SOURCE_FILE_AT_LINE (1463))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_abstractClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1464)) SOURCE_FILE_AT_LINE (1464))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedClassType::constructor_new (_inLexique, var_cas_abstractClassName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1466)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      } break ;
    case 2 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_9 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
              var_cas_messageText.defineAttribute (_inLexique.tokenString, _inLexique) ;
              if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1521)) SOURCE_FILE_AT_LINE (1521))))).isBuiltAndTrue ()) {
                var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1522)) ;
              }
              var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1524)) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              } break ;
            case 3 : {
              nt_abstract_method_ (_inLexique, var_cas_listeAttributsSemantiquesCourants, var_cas_listeEntitesAengendrer, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableDesMethodes, var_cas_tableMethodesAimplementer, var_cas_tableEnAvant) ;
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_59151 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_59151 != NULL)) {
        macroValidPointer (operand_59151) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_59151->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1571)) SOURCE_FILE_AT_LINE (1571))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_59151->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1572))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1573)) ;
        }
        operand_59151 = operand_59151->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasClassType::constructor_new (_inLexique, var_cas_abstractClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_entite SOURCE_FILE_AT_LINE (1585)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      ...
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_abstractClassName, var_cas_t SOURCE_FILE_AT_LINE (1588)) ;
      } break ;
    default :
      break ;
  }
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_1308_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_8 (_inLexique)) {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1598_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  if ((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_concreteClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1611)) SOURCE_FILE_AT_LINE (1611))).isBuiltAndTrue ()) {
    var_cas_concreteClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a non abstract class cannot be predeclared") SOURCE_FILE_AT_LINE (1612)) ;
  }
  GGS_typeTableMethodes  var_cas_ancestorClassMethodsMap ;
  GGS_typeListeAttributsSemantiques  var_cas_listeTousAttributsSemantiques ;
  GGS_typeSuperClassesMap  var_cas_tableDesClassesAncetres ;
  GGS_typeClassInheritedMessagesMap  var_cas_inheritedMessageMap ;
  GGS_typeSemanticAttributesMap  var_cas_tableAttributs ;
  GGS_lstring  var_cas_61816 ;
  nt_parent_class_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_tableAttributs, var_cas_listeTousAttributsSemantiques, var_cas_ancestorClassMethodsMap, var_cas_tableDesClassesAncetres, var_cas_inheritedMessageMap, var_cas_61816) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiquesCourants ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_10 (_inLexique)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
          var_cas_messageText.defineAttribute (_inLexique.tokenString, _inLexique) ;
          if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1699)) SOURCE_FILE_AT_LINE (1699))))).isBuiltAndTrue ()) {
            var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1700)) ;
          }
          var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1702)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        case 4 : {
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_65384 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_65384 != NULL)) {
    macroValidPointer (operand_65384) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_65384->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1724)) SOURCE_FILE_AT_LINE (1724))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_65384->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1725))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1726)) ;
    }
    operand_65384 = operand_65384->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_concreteClassName, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) SOURCE_FILE_AT_LINE (1737)) ;
  GGS_typeEntityToGenerate  var_cas_def ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1598_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_concreteClassName.defineAttribute (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_concreteClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1763)) SOURCE_FILE_AT_LINE (1763))).isBuiltAndTrue ()) {
    var_cas_concreteClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a non abstract class cannot be predeclared") SOURCE_FILE_AT_LINE (1764)) ;
  }
  GGS_typeTableMethodes  var_cas_ancestorClassMethodsMap ;
  GGS_typeListeAttributsSemantiques  var_cas_listeTousAttributsSemantiques ;
  GGS_typeSuperClassesMap  var_cas_tableDesClassesAncetres ;
  ...
  if (((var_cas_superClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1796))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_TypeModel  var_cas_type ;
    if (var_cas_ioModelMap.isBuilt ()) {
      var_cas_ioModelMap (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_type SOURCE_FILE_AT_LINE (1798)) ;
    }
    if (var_cas_type.isBuilt ()) {
      if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
        cPtr_ClassModel * operand_68558 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
        macroValidPointer (operand_68558) ; 
        var_cas_superClasses = operand_68558->mSuperClasses ;
        var_cas_attributeList = operand_68558->mAttributeList ;
        var_cas_messageMap = operand_68558->mMessageMap ;
      }else{ // Else part
        var_cas_superClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_superClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1805))))) + (GGS_string (true, "' type is not a class"))) SOURCE_FILE_AT_LINE (1807)) ;
        var_cas_superClasses.drop_operation () ;
        var_cas_attributeList.drop_operation () ;
        var_cas_messageMap.drop_operation () ;
      }
    }
    var_cas_superClasses.addAssign_operation (var_cas_superClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1808))) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiquesCourants ;
  GGS_L_nameWithType  var_cas_listeTypeeAttributsExternesCourants ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_10 (_inLexique)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
          var_cas_messageText.defineAttribute (_inLexique.tokenString, _inLexique) ;
          if (((! (var_cas_inheritedMessageMap.reader_hasKey (_inLexique, var_cas_messageName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1876)) SOURCE_FILE_AT_LINE (1876))))).isBuiltAndTrue ()) {
            var_cas_messageMapForHeirs.method_insertKey (_inLexique, var_cas_messageName SOURCE_FILE_AT_LINE (1877)) ;
          }
          var_cas_tableMessagesClasseConcrete.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageText SOURCE_FILE_AT_LINE (1879)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        case 4 : {
          GGS_typeEntitiesToGenerateList  var_cas_listeEntitesAengendrer ;
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_72578 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_72578 != NULL)) {
    macroValidPointer (operand_72578) ;
    if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_72578->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1902)) SOURCE_FILE_AT_LINE (1902))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_72578->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1903))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1904)) ;
    }
    operand_72578 = operand_72578->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  var_cas_c = GGS_typeGalgasClassType::constructor_new (_inLexique, var_cas_concreteClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_concreteClassName, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) SOURCE_FILE_AT_LINE (1915)) ;
  GGS_TypeModel  var_cas_t ;
  ...
  var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_concreteClassName, var_cas_t SOURCE_FILE_AT_LINE (1917)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
}
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_1598_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  nt_parent_class_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
...
void semantics_parser::
semantics_parser::
pr_abstract_method_semantics_parser_1925_23_ (galgas_scanner & _inLexique,
                                GGS_typeListeAttributsSemantiques  &/* var_cas_listeAttributsSemantiquesCourants */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableMethodes  &var_cas_tableDesMethodes,
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_tableDesMethodes.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes SOURCE_FILE_AT_LINE (1949)) ;
  ...
  var_cas_tableMethodesAimplementer.method_insertAbstract (_inLexique, var_cas_nomMethode, var_cas_listeDeTypes, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions SOURCE_FILE_AT_LINE (1951)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_abstract_method_semantics_parser_1925_23_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_abstract) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_parse_method_semantics_parser_1957_20_ (galgas_scanner & _inLexique,
  ...
  var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_me_Constant, var_cas_typeDefinition, var_cas_me_constantCppName SOURCE_FILE_AT_LINE (1991)) ;
  ...
  var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_super_Constant, var_cas_typeDefinition, var_cas_super_constantCppName SOURCE_FILE_AT_LINE (2003)) ;
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_77363 = var_cas_listeAttributsSemantiquesCourants.firstObject () ;
  while ((operand_77363 != NULL)) {
    macroValidPointer (operand_77363) ;
    GGS_typeCplusPlusName  var_cas_nomCpp ;
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (_inLexique, operand_77363->aNomAttribut COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_77363->aNomAttribut, operand_77363->mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (2018)) ;
    operand_77363 = operand_77363->nextObject () ;
  }
...
void semantics_parser::
pr_parse_method_semantics_parser_1957_20_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  nt_semantic_instructions_list_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_non_abstract_method_semantics_parser_2042_27_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inCurrentClassName,
                                const GGS_typeTableMethodes  &var_cas_inAncestorClassMethodsMap,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeAttributsSemantiquesCourants,
  ...
  var_cas_tableDesMethodes.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (2082)) ;
  var_cas_tableMethodesAimplementer.method_insertNotAbstract (_inLexique, var_cas_methodName, var_cas_methodSignature, var_cas_listeTypeEtNomsArguments, var_cas_instructionsList SOURCE_FILE_AT_LINE (2083)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_non_abstract_method_semantics_parser_2042_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
...
void semantics_parser::
semantics_parser::
pr_overrided_method_semantics_parser_2091_24_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inCurrentClassName,
                                const GGS_typeTableMethodes  &var_cas_inAncestorClassMethodsMap,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeAttributsSemantiquesCourants,
  ...
  if (var_cas_tableDesMethodes.isBuilt ()) {
    var_cas_tableDesMethodes (HERE)->method_searchKey (_inLexique, var_cas_methodName, var_cas_listeDeTypesMethodeOriginale SOURCE_FILE_AT_LINE (2134)) ;
  }
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_listeDeTypesMethodeOriginale,  var_cas_methodSignature,  GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2136)) ;
  var_cas_tableMethodesAimplementer.method_insertNotAbstract (_inLexique, var_cas_methodName, var_cas_methodSignature, var_cas_listeTypeEtNomsArguments, var_cas_instructionsList SOURCE_FILE_AT_LINE (2141)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
pr_overrided_method_semantics_parser_2091_24_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_override) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_reader) ;
  nt_parse_method_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
...
void semantics_parser::
semantics_parser::
pr_formal_arguments_list_semantics_parser_2152_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_L_EXsignature  &var_cas_listeDeTypes,
                                GGS_typeVariablesMap  &var_cas_tableArgumentsMethode,
                                GGS_typeListeTypesEtNomsArgMethode  &var_cas_listeTypeEtNomsArguments,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_11 (_inLexique)) {
        case 2 : {
          ...
          switch (select_semantics_parser_12 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2184)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttribute (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments.addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
              var_cas_tableArgumentsMethode.method_insertConstInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2189)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_13 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2210)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_nomArgument ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments.addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, true)) ;
              var_cas_tableArgumentsMethode.method_insertInArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2216)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 4 : {
          ...
          switch (select_semantics_parser_14 (_inLexique)) {
            case 1 : {
              ...
              var_cas_tableArgumentsMethode.method_insertUnusedInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2237)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttribute (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_natureNom = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomArgument COMMA_HERE) ;
              var_cas_listeTypeEtNomsArguments.addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, GGS_bool (true, false)) ;
              var_cas_tableArgumentsMethode.method_insertInOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2242)) ;
              } break ;
            default :
              break ;
          }
        ...
        case 5 : {
          ...
          var_cas_listeTypeEtNomsArguments.addAssign_operation (var_cas_type_semantique, var_cas_passingMode, var_cas_natureNom, var_cas_modeIn) ;
          var_cas_tableArgumentsMethode.method_insertOutArgument (_inLexique, var_cas_nomArgument, var_cas_type_semantique, var_cas_natureNom SOURCE_FILE_AT_LINE (2262)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void semantics_parser::
semantics_parser::
pr_formal_arguments_list_semantics_parser_2152_29_importGrammarForSemantics (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_formal_arguments_list_semantics_parser_2152_29_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_11 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_type_parsing_semantics_parser_2319_20_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (2326)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2327)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_type_parsing_semantics_parser_2319_20_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
}
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2336_45_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_targetVarType, var_cas_targetVarCppName SOURCE_FILE_AT_LINE (2357)) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_targetVarType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2359)) ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2336_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
...
void semantics_parser::
semantics_parser::
pr_input_parameters_list_semantics_parser_2369_29_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2391))) < (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2391)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much arguments: ")) + (var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2392)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2392))))) + (GGS_string (true, " expected, ")))) + (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2393)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2393))))) + (GGS_string (true, " found"))) SOURCE_FILE_AT_LINE (2395)) ;
    var_cas_outAllVariablesList.drop_operation () ;
    var_cas_listeAffectationParametresEffectifs.drop_operation () ;
  }else if (((((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2395))) > (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2395)))) & ((! (var_cas_ellipsis))))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "argument(s) missing: ")) + (var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2396)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2396))))) + (GGS_string (true, " expected, ")))) + (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2397)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2397))))) + (GGS_string (true, " found"))) SOURCE_FILE_AT_LINE (2399)) ;
    var_cas_outAllVariablesList.drop_operation () ;
    var_cas_listeAffectationParametresEffectifs.drop_operation () ;
  }else{
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_92277 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_92363 = var_cas_listeCibles.firstObject () ;
    while ((operand_92277 != NULL)
        && (operand_92363 != NULL)) {
      macroValidPointer (operand_92277) ;
      macroValidPointer (operand_92363) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_92277->aNomAttribut ;
      if (operand_92363->aCible.isBuilt ()) {
        operand_92363->aCible (HERE)->method_verifierType (_inLexique, operand_92277->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList SOURCE_FILE_AT_LINE (2405)) ;
      }
      operand_92277 = operand_92277->nextObject () ;
      operand_92363 = operand_92363->nextObject () ;
    }
  }
  ...
  if (var_cas_outAllVariablesList.isBuilt () &&
      var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2412)).isBuilt () &&
      var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2413)).isBuilt () &&
      var_cas_nullName.isBuilt ()) {
    ::routine_appendJokersIfNeeded (_inLexique,  var_cas_outAllVariablesList,  var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2412)),  var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2413)),  var_cas_nullName SOURCE_FILE_AT_LINE (2411)) ;
  }
}
...
void semantics_parser::
pr_input_parameters_list_semantics_parser_2369_29_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_15 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_target_entity_semantics_parser_2420_21_ (galgas_scanner & _inLexique,
                                GGS_typeCible  &var_cas_typeEntiteDestination,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariableDest, var_cas_typeVarDest, var_cas_nomCppDest SOURCE_FILE_AT_LINE (2428)) ;
...
void semantics_parser::
pr_target_entity_semantics_parser_2420_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_target_entity_semantics_parser_2434_21_ (galgas_scanner & _inLexique,
                                GGS_typeCible  &var_cas_typeEntiteDestination,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */) {
...
void semantics_parser::
pr_target_entity_semantics_parser_2434_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2A) ;
}
...
pr_instruction_beginning_with_identifier_semantics_parser_2450_45_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2484))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2484)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_95572 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_95646 = var_cas_typeList.firstObject () ;
    while ((operand_95572 != NULL)
        && (operand_95646 != NULL)) {
      macroValidPointer (operand_95572) ;
      macroValidPointer (operand_95646) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_95572->mAttributType,  operand_95646->mType,  operand_95646->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2490)) ;
      operand_95572 = operand_95572->nextObject () ;
      operand_95646 = operand_95646->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_instruction_beginning_with_identifier_semantics_parser_2509_45_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2543))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2543)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_98029 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_98103 = var_cas_typeList.firstObject () ;
    while ((operand_98029 != NULL)
        && (operand_98103 != NULL)) {
      macroValidPointer (operand_98029) ;
      macroValidPointer (operand_98103) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_98029->mAttributType,  operand_98103->mType,  operand_98103->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2549)) ;
      operand_98029 = operand_98029->nextObject () ;
      operand_98103 = operand_98103->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_19 (_inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_20 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_nomArgument.defineAttribute (_inLexique.tokenString, _inLexique) ;
              var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2687)) ;
              var_cas_listeTypesParametresEffectifs.addAssign_operation (var_cas_typeArgument, var_cas_parameterPassingMode) ;
              GGS_typeExpression  var_cas_e ;
              var_cas_e = GGS_typeVarInExpression::constructor_new (_inLexique, var_cas_nomCppArgument COMMA_HERE) ;
              var_cas_outExpressionList.addAssign_operation (var_cas_e) ;
              if ((var_cas_exclusiveVariables.reader_hasKey (_inLexique, var_cas_nomArgument.reader_value (_inLexique SOURCE_FILE_AT_LINE (2691)) SOURCE_FILE_AT_LINE (2691))).isBuiltAndTrue ()) {
                var_cas_nomArgument.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object is already named as input or output/input effectif argument of current instruction") SOURCE_FILE_AT_LINE (2693)) ;
              }else{
                var_cas_exclusiveVariables.addAssign_operation (var_cas_nomArgument.reader_value (_inLexique SOURCE_FILE_AT_LINE (2694))) ;
              }
              } break ;
            default :
              break ;
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_nomArgument.defineAttribute (_inLexique.tokenString, _inLexique) ;
          var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomArgument, var_cas_typeArgument, var_cas_nomCppArgument SOURCE_FILE_AT_LINE (2703)) ;
          GGS_actualParametersPassingMode var_cas_parameterPassingMode ;
          ...
          var_cas_e = GGS_typeVarInExpression::constructor_new (_inLexique, var_cas_nomCppArgument COMMA_HERE) ;
          var_cas_outExpressionList.addAssign_operation (var_cas_e) ;
          if ((var_cas_exclusiveVariables.reader_hasKey (_inLexique, var_cas_nomArgument.reader_value (_inLexique SOURCE_FILE_AT_LINE (2708)) SOURCE_FILE_AT_LINE (2708))).isBuiltAndTrue ()) {
            var_cas_nomArgument.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object is already named as input or output/input effectif argument of current instruction") SOURCE_FILE_AT_LINE (2710)) ;
          }else{
            var_cas_exclusiveVariables.addAssign_operation (var_cas_nomArgument.reader_value (_inLexique SOURCE_FILE_AT_LINE (2711))) ;
          }
          } break ;
        default :
          syntaxRepeat = false ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instructions_list_semantics_parser_2720_34_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique SOURCE_FILE_AT_LINE (2732)) ;
  ...
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2732)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_semantic_instructions_list_semantics_parser_2720_34_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2754_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  if (var_cas_ioPropertyMap.isBuilt ()) {
    var_cas_ioPropertyMap (HERE)->method_searchKey (_inLexique, var_cas_calledPropertyName, var_cas_kind, var_cas_typeName SOURCE_FILE_AT_LINE (2772)) ;
  }
  if ((var_cas_ioConstraintPropertyDefinitionSet.reader_hasKey (_inLexique, var_cas_calledPropertyName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2773)) SOURCE_FILE_AT_LINE (2773))).isBuiltAndTrue ()) {
    var_cas_calledPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this property has been already initialized") SOURCE_FILE_AT_LINE (2775)) ;
  }else{
    var_cas_ioConstraintPropertyDefinitionSet.addAssign_operation (var_cas_calledPropertyName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2776))) ;
  }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_lstring  var_cas_108488 ;
            GGS_uint  var_cas_108491 ;
            GGS_string var_cas_108494 ;
            GGS_bool var_cas_108497 ;
            if (var_cas_ioMapAsConstraintPropertyMap.isBuilt ()) {
              var_cas_ioMapAsConstraintPropertyMap (HERE)->method_searchKey (_inLexique, var_cas_propertyArgumentName, var_cas_propertyTypeName, var_cas_108488, var_cas_108491, var_cas_108494, var_cas_108497 SOURCE_FILE_AT_LINE (2788)) ;
            }
  ...
  if ((var_cas_ioCallInstructionSharedPropertySignatureMap.reader_hasKey (_inLexique, var_cas_calledPropertyName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2797)) SOURCE_FILE_AT_LINE (2797))).isBuiltAndTrue ()) {
    ...
    if (var_cas_ioCallInstructionSharedPropertySignatureMap.isBuilt ()) {
      var_cas_ioCallInstructionSharedPropertySignatureMap (HERE)->method_searchKey (_inLexique, var_cas_calledPropertyName, var_cas_previousParameterTypeList, var_cas_previousParameterTypeListLocation SOURCE_FILE_AT_LINE (2800)) ;
    }
    if (((var_cas_previousParameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2801))) == (var_cas_parameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2801)))).isBuiltAndTrue ()) {
      GGS_sharedPropertyList::element_type * operand_109165 = var_cas_previousParameterTypeList.firstObject () ;
      GGS_sharedPropertyList::element_type * operand_109233 = var_cas_parameterTypeList.firstObject () ;
      while ((operand_109165 != NULL)
          && (operand_109233 != NULL)) {
        macroValidPointer (operand_109165) ;
        macroValidPointer (operand_109233) ;
        if (((operand_109165->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2804))) != (operand_109233->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2804)))).isBuiltAndTrue ()) {
          operand_109233->mSharedPropertyName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this shared property has '@")) + (operand_109233->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2805))))) + (GGS_string (true, "' type, while a previous call has named an attribute of type '@")))) + (operand_109165->mSharedPropertyTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2806))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2807)) ;
        }
        operand_109165 = operand_109165->nextObject () ;
        operand_109233 = operand_109233->nextObject () ;
      }
    }else{
      var_cas_previousParameterTypeListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this instruction names ")) + (var_cas_parameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2810)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2810))))) + (GGS_string (true, " shared parameter(s), while a previous call has named ")))) + (var_cas_previousParameterTypeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2811)).reader_string (_inLexique SOURCE_FILE_AT_LINE (2811))))) + (GGS_string (true, " parameter(s)"))) SOURCE_FILE_AT_LINE (2813)) ;
    }
  }else{
    var_cas_ioCallInstructionSharedPropertySignatureMap.method_insertKey (_inLexique, var_cas_calledPropertyName, var_cas_parameterTypeList, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (2815)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2754_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_call) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_21 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2835_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_typeVarSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeVarSource.getPtr () != NULL) {
        ...
        var_cas_nomVarSource.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2858)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2835_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extract) ;
...
void semantics_parser::
semantics_parser::
pr_extract_instruction_semantics_parser_2884_27_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  if (((! (var_cas_tableDesClassesAncetres.reader_hasKey (_inLexique, var_cas_nomTypeSource.reader_value (_inLexique SOURCE_FILE_AT_LINE (2920)) SOURCE_FILE_AT_LINE (2920))))).isBuiltAndTrue ()) {
    var_cas_nomClasse.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_value (_inLexique SOURCE_FILE_AT_LINE (2921))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2922)) ;
  }
  GGS_L_assignedVariables  var_cas_listeAffectationParametresEffectifs ;
...
void semantics_parser::
pr_extract_instruction_semantics_parser_2884_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_3E) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
...
pr_extract_instruction_semantics_parser_2963_27_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (2981)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_semanticsEntity  var_cas_entite ;
        if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
          var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomType1, var_cas_entite SOURCE_FILE_AT_LINE (2991)) ;
        }
        { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_entite.getPtr () != NULL) {
              ...
              message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
              message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
              var_cas_nomType1.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (2992)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_definitionClasse1.getPtr () != NULL) {
              ...
              var_cas_nomType1.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3004)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (_inLexique, var_cas_nomTypeSource.reader_value (_inLexique SOURCE_FILE_AT_LINE (3006)) SOURCE_FILE_AT_LINE (3006))))).isBuiltAndTrue ()) {
          var_cas_nomType1.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_value (_inLexique SOURCE_FILE_AT_LINE (3007))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3008)) ;
        }
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
        ::routine_buildMapWithLocalConstants (_inLexique,  var_cas_elementsList,  var_cas_listeAttributs1,  var_cas_ioVariablesMap,  var_cas_indicatif1,  GGS_localConstantBuildStyleEnum::constructor_listStyle (_inLexique COMMA_HERE),  var_cas_ellipsisFound SOURCE_FILE_AT_LINE (3039)) ;
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_3E) ;
        GGS_typeInstructionList  var_cas_instructionsList ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3067)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3067)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (2981)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_extract) ;
}
...
pr_semantic_instruction_semantics_parser_3097_28_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (3117)) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3138_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3138_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_drop) ;
...
void semantics_parser::
semantics_parser::
pr_drop_instruction_semantics_parser_3161_24_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_galgasType  var_cas_123545 ;
        var_cas_ioVariablesMap.method_searchForDestructiveReadAccess (_inLexique, var_cas_nom, var_cas_123545, var_cas_nomCppVar SOURCE_FILE_AT_LINE (3171)) ;
        GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_drop_instruction_semantics_parser_3161_24_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      switch (select_repeat_semantics_parser_27 (_inLexique)) {
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_3188_45_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomVarDest, var_cas_entite SOURCE_FILE_AT_LINE (3198)) ;
  }
  { cPtr_typeEntiteRoutine * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteRoutine *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeEntiteRoutine::static_string_message_messageTypeEntite () ;
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_nomVarDest.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3199)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_3188_45_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3223_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_nomAction, var_cas_entite SOURCE_FILE_AT_LINE (3241)) ;
  }
  ...
  { cPtr_typeEntiteActionExterne * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteActionExterne *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_entite.getPtr () != NULL) {
        ...
        message2_ << var_cas_entite (HERE)->message_messageTypeEntite () ;
        var_cas_nomAction.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3243)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3223_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_action) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  nt_actual_parameters_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3274_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_semantics_parser_28 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_variableType.isBuilt ()) {
        var_cas_variableType (HERE)->method_handleReaderInstructionCall (_inLexique, var_cas_readObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3297)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_variableType ;
      GGS_typeCplusPlusName  var_cas_cppVariableName ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_modifiedObjectName, var_cas_variableType, var_cas_cppVariableName SOURCE_FILE_AT_LINE (3316)) ;
      GGS_lstring  var_cas_methodName ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      var_cas_methodName.defineAttribute (_inLexique.tokenString, _inLexique) ;
      GGS_L_EXsignature  var_cas_methodSignature ;
      if (var_cas_variableType.isBuilt ()) {
        var_cas_variableType (HERE)->method_handleModifierCall (_inLexique, var_cas_modifiedObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (3321)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
      nt_actual_parameters_list_ (_inLexique, var_cas_methodSignature, var_cas_expressionsList, var_cas_ioVariablesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioInstructionList) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3274_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  switch (select_semantics_parser_28 (_inLexique)) {
    case 1 : {
      nt_read_access_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3377_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_errorExpression, var_cas_errorExpressionType) ;
  if (var_cas_errorExpressionType.isBuilt ()) {
    var_cas_errorExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3400)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3377_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_warning) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  nt_expression_parse (_inLexique) ;
...
pr_semantic_instruction_semantics_parser_3427_28_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_errorLocationExpressionType.isBuilt ()) {
    var_cas_errorLocationExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique SOURCE_FILE_AT_LINE (3450)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  ...
  { cPtr_typeGalgas_string * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_string *> (var_cas_errorMessageExpressionType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_errorMessageExpressionType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3463)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_AC_galgasType  var_cas_136023 ;
            var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_nomVariable, var_cas_136023, var_cas_varCppName SOURCE_FILE_AT_LINE (3473)) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3496_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3496_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3534_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3550)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3552)) ;
        ...
        if ((var_cas_firstBranch).isBuiltAndTrue ()) {
          ...
          ::routine_displayConstraintDefinitionErrors (_inLexique,  var_cas_ioConstraintPropertyDefinitionSet,  var_cas_constraintPropertyDefinitionSet SOURCE_FILE_AT_LINE (3582)) ;
        }
        var_cas_listeBranchesTest.addAssign_operation (var_cas_testBranche, var_cas_listeInstructionsBrancheTest) ;
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3552)) ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (3590)) ;
  switch (select_semantics_parser_32 (_inLexique)) {
    case 1 : {
      if (((var_cas_ioConstraintPropertyDefinitionSet) != (var_cas_startConstraintPropertyDefinitionSet)).isBuiltAndTrue ()) {
        ::routine_displayConstraintDefinitionErrorsNoElse (_inLexique,  var_cas_ioConstraintPropertyDefinitionSet,  var_cas_startConstraintPropertyDefinitionSet SOURCE_FILE_AT_LINE (3593)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_else) ;
      ...
      if (((var_cas_ioConstraintPropertyDefinitionSet) != (var_cas_constraintPropertyDefinitionSet)).isBuiltAndTrue ()) {
        ::routine_displayConstraintDefinitionErrors (_inLexique,  var_cas_ioConstraintPropertyDefinitionSet,  var_cas_constraintPropertyDefinitionSet SOURCE_FILE_AT_LINE (3611)) ;
      }
      } break ;
    default :
      break ;
  }
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3590)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_if) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (3550)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3534_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_if) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_expression_parse (_inLexique) ;
...
pr_semantic_instruction_semantics_parser_3631_28_ (galgas_scanner & _inLexique,
  ...
  { cPtr_typeGalgas_uint * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_variantResultType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_variantResultType.getPtr () != NULL) {
        ...
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3654)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  { cPtr_typeGalgas_bool * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_bool *> (var_cas_resultType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_resultType.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgas_bool::static_string_message_messageGalgasType () ;
        message2_ << var_cas_resultType (HERE)->message_messageGalgasType () ;
        GGS_location (_inLexique).signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3686)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3690)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3691)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3691)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3690)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3726_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  { cPtr_typeGalgas_lstring * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_typeNomFichierSource.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_typeNomFichierSource.getPtr () != NULL) {
        ...
        var_cas_nomFichierSource.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3756)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
    }
  ...
  GGS_AC_semanticsEntity  var_cas_e ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (3769)) ;
  }
  ...
  { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_e.getPtr () != NULL) {
        ...
        message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
        var_cas_grammarName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3771)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
  ...
  if (var_cas_startSymbolAltMap.isBuilt ()) {
    var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (3774)) ;
  }
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_startSymbolSignature,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_expressionsList SOURCE_FILE_AT_LINE (3776)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3726_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_33 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3799_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_typeInstruction  var_cas_instruction ;
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3813)) ;
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (3814)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, var_cas_enumeratedVariableName, var_cas_enumeratedVariableType, var_cas_enumeratedVariableCPPName SOURCE_FILE_AT_LINE (3829)) ;
        ...
        if (var_cas_enumeratedVariableType.isBuilt ()) {
          var_cas_enumeratedVariableType (HERE)->method_acceptForeachInstruction (_inLexique, var_cas_enumeratedVariableName, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum SOURCE_FILE_AT_LINE (3833)) ;
        }
        GGS_string var_cas_typeName ;
        if (var_cas_enumeratedVariableType.isBuilt ()) {
          var_cas_enumeratedVariableType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (3836)) ;
        }
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (3814)) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (3813)) ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3799_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_foreach) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_read_access_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_parse_match_operand_semantics_parser_3899_27_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_typeGalgasClassType * operand_152818 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_152818) ; 
      var_cas_outBaseTypeName = operand_152818->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_153024 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_153024) ; 
      var_cas_outBaseTypeName = operand_153024->mEnumTypeName ;
      var_cas_outIsEnumeration = GGS_bool (true, true) ;
      var_cas_outEnumMessageMap = operand_153024->mEnumConstantesMap ;
    }else{ // Else part
      GGS_string var_cas_actualTypeName ;
      if (var_cas_type.isBuilt ()) {
        var_cas_type (HERE)->method_getTypeName (_inLexique, var_cas_actualTypeName SOURCE_FILE_AT_LINE (3927)) ;
      }
      var_cas_variableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '@")) + (var_cas_actualTypeName))) + (GGS_string (true, "' ; I was expected an enumeration type or an abstract type"))) SOURCE_FILE_AT_LINE (3931)) ;
...
void semantics_parser::
pr_parse_match_operand_semantics_parser_3899_27_parse (galgas_scanner & _inLexique) {
  nt_read_access_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_3937_24_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_entite SOURCE_FILE_AT_LINE (3951)) ;
  }
  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      var_cas_definitionClasse1.drop_operation () ;
  ...
  { cPtr_typeGalgasClassType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_definitionClasse1.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_definitionClasse1.getPtr () != NULL) {
        ...
        message1_ (0 COMMA_HERE) << cPtr_typeGalgasClassType::static_string_message_messageGalgasType () ;
        message2_ << var_cas_definitionClasse1 (HERE)->message_messageGalgasType () ;
        var_cas_outTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (3965)) ;
      }
    }else{
      macroValidPointer (ptrExtraire_) ;
      var_cas_listeAttributs1 = ptrExtraire_->mNonExternAttributesList ;
  ...
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class is not allowed here") SOURCE_FILE_AT_LINE (3969)) ;
  }
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a constant of '@")) + (var_cas_inTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (3972))))) + (GGS_string (true, "' enumeration type is expected here"))) SOURCE_FILE_AT_LINE (3973)) ;
  }else if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (_inLexique, var_cas_inTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (3973)) SOURCE_FILE_AT_LINE (3973))))).isBuiltAndTrue ()) {
    var_cas_outTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This type does not inherit from '")) + (var_cas_inTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (3974))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3975)) ;
  }
...
void semantics_parser::
pr_parse_match_case_semantics_parser_3937_24_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  nt_parse_effective_input_parameters_list_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_3987_24_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_lstring  var_cas_inTypeName,
                                GGS_location  /* var_cas_inVarLocation */,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    if (var_cas_inEnumMessageMap.isBuilt ()) {
      var_cas_inEnumMessageMap (HERE)->method_searchKey (_inLexique, var_cas_outEnumConstantName SOURCE_FILE_AT_LINE (4000)) ;
    }
  }else{
    var_cas_outEnumConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a class that inherit from '@")) + (var_cas_inTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4002))))) + (GGS_string (true, "' abstract class is expected here"))) SOURCE_FILE_AT_LINE (4003)) ;
  }
}
...
void semantics_parser::
pr_parse_match_case_semantics_parser_3987_24_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_4008_28_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (4053)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_36 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_when) ;
          var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (4057)) ;
          ...
          var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (4057)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (4101)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_else) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (4101)) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (4053)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_match) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_4008_28_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_match) ;
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_4170_27_ (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_optional_assignment_semantics_parser_4170_27_parse (galgas_scanner & /* _inLexique */) {
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_4186_27_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &/* var_cas_inTypeName */,
  ...
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_162975, var_cas_162978 SOURCE_FILE_AT_LINE (4198)) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_inVariableType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (4210)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_optional_assignment_semantics_parser_4186_27_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  nt_expression_parse (_inLexique) ;
}
...
pr_optional_assignment_semantics_parser_4218_27_ (galgas_scanner & _inLexique,
                                ...
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  GGS_AC_galgasType  var_cas_164091 ;
  GGS_typeCplusPlusName  var_cas_164094 ;
  var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_inTargetVarName, var_cas_164091, var_cas_164094 SOURCE_FILE_AT_LINE (4229)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  ...
  if (var_cas_inVariableType.isBuilt ()) {
    var_cas_inVariableType (HERE)->method_handleConstructorCall (_inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques SOURCE_FILE_AT_LINE (4235)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4258_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_38 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4271)) SOURCE_FILE_AT_LINE (4271))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4272)) SOURCE_FILE_AT_LINE (4272))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4274)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
      ...
      var_cas_cppClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "old style map definition") SOURCE_FILE_AT_LINE (4281)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_39 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList.addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4294)), GGS_bool (true, true)) ;
              } break ;
            case 3 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList.addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4301)), GGS_bool (true, true)) ;
              } break ;
            case 4 : {
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4336)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_insertOrSearchMethodList::element_type * operand_168992 = var_cas_insertMethodList.firstObject () ;
      while ((operand_168992 != NULL)) {
        macroValidPointer (operand_168992) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_169190 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_169190 != NULL)) {
          macroValidPointer (operand_169190) ;
          var_cas_methodSignature.addAssign_operation (operand_169190->mAttributType, var_cas_inPassingMode) ;
          operand_169190 = operand_169190->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_168992->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4365)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_169621 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_169621 != NULL)) {
          macroValidPointer (operand_169621) ;
          var_cas_methodSignature.addAssign_operation (operand_169621->mAttributType, var_cas_inPassingMode) ;
          operand_169621 = operand_169621->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_168992->mMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4373))) + (GGS_string (true, "GetIndex"))), operand_168992->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4373)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4374)) ;
        operand_168992 = operand_168992->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_169970 = var_cas_searchMethodList.firstObject () ;
      while ((operand_169970 != NULL)) {
        macroValidPointer (operand_169970) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_170166 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_170166 != NULL)) {
          macroValidPointer (operand_170166) ;
          var_cas_methodSignature.addAssign_operation (operand_170166->mAttributType, var_cas_outPassingMode) ;
          operand_170166 = operand_170166->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_169970->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4383)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_170595 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_170595 != NULL)) {
          macroValidPointer (operand_170595) ;
          var_cas_methodSignature.addAssign_operation (operand_170595->mAttributType, var_cas_outPassingMode) ;
          operand_170595 = operand_170595->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_169970->mMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4391))) + (GGS_string (true, "GetIndex"))), operand_169970->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4391)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4392)) ;
        operand_169970 = operand_169970->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4403)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
    ...
    case 3 : {
          ...
          switch (select_repeat_semantics_parser_40 (_inLexique)) {
            case 2 : {
              ...
              if (var_cas_errorMessage.isBuilt ()) {
                ::routine_check_KL_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4448)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_173767 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_173767 != NULL)) {
                macroValidPointer (operand_173767) ;
                var_cas_methodSignature.addAssign_operation (operand_173767->mAttributType, var_cas_inPassingMode) ;
                operand_173767 = operand_173767->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4456)) ;
              var_cas_insertMethodList.addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4457)), GGS_bool (true, false)) ;
              if (((var_cas_getIndexMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4459))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_174350 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_174350 != NULL)) {
                  macroValidPointer (operand_174350) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_174350->mAttributType, var_cas_inPassingMode) ;
                  operand_174350 = operand_174350->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4466)) ;
                var_cas_insertMethodList.addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4467)), GGS_bool (true, true)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              ...
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_errorMessage) ;
              if (var_cas_errorMessage.isBuilt ()) {
                ::routine_check_K_escapeCharacters (_inLexique,  var_cas_errorMessage SOURCE_FILE_AT_LINE (4475)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_175119 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_175119 != NULL)) {
                macroValidPointer (operand_175119) ;
                var_cas_methodSignature.addAssign_operation (operand_175119->mAttributType, var_cas_outPassingMode) ;
                operand_175119 = operand_175119->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4483)) ;
              var_cas_searchMethodList.addAssign_operation (var_cas_methodName, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4484)), GGS_bool (true, false)) ;
              if (((var_cas_getIndexMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4486))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_175733 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_175733 != NULL)) {
                  macroValidPointer (operand_175733) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_175733->mAttributType, var_cas_outPassingMode) ;
                  operand_175733 = operand_175733->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4493)) ;
                var_cas_searchMethodList.addAssign_operation (var_cas_getIndexMethodName, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4494)), GGS_bool (true, true)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4506)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4258_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_38 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4529)) SOURCE_FILE_AT_LINE (4529))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_mapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4529)) SOURCE_FILE_AT_LINE (4529))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedMapType::constructor_new (_inLexique, var_cas_mapTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_t SOURCE_FILE_AT_LINE (4531)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_class) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_39 (_inLexique)) {
            case 2 : {
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_insertMethodList.addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4550)), GGS_bool (true, true)) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              nt_ex_map_method_ (_inLexique, var_cas_nomMethode, var_cas_errorMessage) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_searchMethodList.addAssign_operation (var_cas_nomMethode, var_cas_errorMessage.reader_value (_inLexique SOURCE_FILE_AT_LINE (4557)), GGS_bool (true, true)) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
              GGS_lstring  var_cas_nomMethode ;
              ...
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              var_cas_tableMethodesBloc.method_insertKey (_inLexique, var_cas_nomMethode, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (4592)) ;
              } break ;
            default :
              syntaxRepeat = false ;
              break ;
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_180604 = var_cas_insertMethodList.firstObject () ;
      while ((operand_180604 != NULL)) {
        macroValidPointer (operand_180604) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_180802 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_180802 != NULL)) {
          macroValidPointer (operand_180802) ;
          var_cas_methodSignature.addAssign_operation (operand_180802->mAttributType, var_cas_inPassingMode) ;
          operand_180802 = operand_180802->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_180604->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4621)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_181233 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_181233 != NULL)) {
          macroValidPointer (operand_181233) ;
          var_cas_methodSignature.addAssign_operation (operand_181233->mAttributType, var_cas_inPassingMode) ;
          operand_181233 = operand_181233->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_180604->mMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4629))) + (GGS_string (true, "GetIndex"))), operand_180604->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4629)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4630)) ;
        operand_180604 = operand_180604->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_181582 = var_cas_searchMethodList.firstObject () ;
      while ((operand_181582 != NULL)) {
        macroValidPointer (operand_181582) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_181780 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_181780 != NULL)) {
          macroValidPointer (operand_181780) ;
          var_cas_methodSignature.addAssign_operation (operand_181780->mAttributType, var_cas_outPassingMode) ;
          operand_181780 = operand_181780->nextObject () ;
        }
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, operand_181582->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4639)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_182212 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_182212 != NULL)) {
          macroValidPointer (operand_182212) ;
          var_cas_methodSignature.addAssign_operation (operand_182212->mAttributType, var_cas_outPassingMode) ;
          operand_182212 = operand_182212->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_181582->mMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4647))) + (GGS_string (true, "GetIndex"))), operand_181582->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4647)) COMMA_HERE) ;
        var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4648)) ;
        operand_181582 = operand_181582->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4659)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4661)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_40 (_inLexique)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_184317 ;
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_184317) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_184526 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_184526 != NULL)) {
                macroValidPointer (operand_184526) ;
                var_cas_methodSignature.addAssign_operation (operand_184526->mAttributType, var_cas_inPassingMode) ;
                operand_184526 = operand_184526->nextObject () ;
              }
              var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4701)) ;
              if (((var_cas_getIndexMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4703))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_185070 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_185070 != NULL)) {
                  macroValidPointer (operand_185070) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_185070->mAttributType, var_cas_inPassingMode) ;
                  operand_185070 = operand_185070->nextObject () ;
                }
                var_cas_mapModifierMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4710)) ;
              }
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_search) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_185457 ;
              nt_map_method_ (_inLexique, var_cas_methodName, var_cas_getIndexMethodName, var_cas_185457) ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              ...
              while ((operand_185672 != NULL)) {
                ...
                var_cas_methodSignature.addAssign_operation (operand_185672->mAttributType, var_cas_outPassingMode) ;
                operand_185672 = operand_185672->nextObject () ;
              }
              var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4724)) ;
              if (((var_cas_getIndexMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4726))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                var_cas_getIndexMethodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_186257 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_186257 != NULL)) {
                  macroValidPointer (operand_186257) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_186257->mAttributType, var_cas_outPassingMode) ;
                  operand_186257 = operand_186257->nextObject () ;
                }
                var_cas_mapReaderMethodMap.method_insertKey (_inLexique, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature SOURCE_FILE_AT_LINE (4733)) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
      ...
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_entite = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_c COMMA_HERE) ;
      var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_entite SOURCE_FILE_AT_LINE (4745)) ;
      GGS_TypeModel  var_cas_type ;
      var_cas_type = GGS_MapModel::constructor_new (_inLexique, var_cas_attributeListModel COMMA_HERE) ;
      var_cas_ioModelMap.method_insertKey (_inLexique, var_cas_mapTypeName, var_cas_type SOURCE_FILE_AT_LINE (4747)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
      } break ;
    default :
      break ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4258_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_map) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_38 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_ex_map_method_semantics_parser_4754_21_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomMethode,
...
void semantics_parser::
pr_ex_map_method_semantics_parser_4754_21_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_error) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void semantics_parser::
semantics_parser::
pr_map_method_semantics_parser_4766_18_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_methodName,
                                GGS_lstring  &var_cas_getIndexMethodName,
                                GGS_lstring  &var_cas_outMessage) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void semantics_parser::
pr_map_method_semantics_parser_4766_18_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_semantics_parser_41 (_inLexique)) {
    case 1 : {
      } break ;
...
void semantics_parser::
semantics_parser::
pr_message_pattern_semantics_parser_4785_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        switch (select_semantics_parser_43 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
            var_cas_messageText.defineAttribute (_inLexique.tokenString, _inLexique) ;
            if (((var_cas_messageText.reader_value (_inLexique SOURCE_FILE_AT_LINE (4793))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_outMessageList.addAssign_operation (var_cas_messageText.reader_value (_inLexique SOURCE_FILE_AT_LINE (4794))) ;
            }
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2A) ;
...
void semantics_parser::
pr_message_pattern_semantics_parser_4785_23_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_semantics_parser_43 (_inLexique)) {
          case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4811_29_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4811_29_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_44 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((! (((var_cas_tableEnAvant.reader_hasKey (_inLexique, var_cas_listTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4865)) SOURCE_FILE_AT_LINE (4865))) | (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_listTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (4865)) SOURCE_FILE_AT_LINE (4865))))))).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgasUndefinedListType::constructor_new (_inLexique, var_cas_listTypeName COMMA_HERE) ;
        var_cas_tableEnAvant.method_insertKey (_inLexique, var_cas_listTypeName, var_cas_t SOURCE_FILE_AT_LINE (4867)) ;
      }
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4811_29_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_list) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  switch (select_semantics_parser_44 (_inLexique)) {
    case 1 : {
...
pr_formal_argument_type_semantics_parser_5212_28_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (5219)) SOURCE_FILE_AT_LINE (5219))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
...
pr_formal_argument_type_semantics_parser_5234_28_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttribute (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (5242)) SOURCE_FILE_AT_LINE (5242))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
...
pr_formal_argument_type_semantics_parser_5259_28_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_type_5Fname) ;
  var_cas_outGalgasTypeName.defineAttribute (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (5267)) SOURCE_FILE_AT_LINE (5267))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
...
pr_formal_argument_type_semantics_parser_5284_28_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  var_cas_outGalgasTypeName.defineAttribute (_inLexique.tokenString, _inLexique) ;
  if ((var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, var_cas_outGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (5293)) SOURCE_FILE_AT_LINE (5293))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_ioComponentSemanticsEntitiesMap.isBuilt ()) {
...
pr_semantics_declaration_semantics_parser_5378_29_ (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_cstMessageStringMap.method_insertKey (_inLexique, var_cas_cstName, var_cas_cstString SOURCE_FILE_AT_LINE (5417)) ;
                _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          ...
          GGS_enumConstantMap::element_type * operand_211925 = var_cas_constantMap.firstObject () ;
          while ((operand_211925 != NULL)) {
            macroValidPointer (operand_211925) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_211925->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (5425)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            if (var_cas_cstMessageStringMap.isBuilt ()) {
              var_cas_cstMessageStringMap (HERE)->method_searchKey (_inLexique, var_cas_name, var_cas_cstString SOURCE_FILE_AT_LINE (5427)) ;
            }
            var_cas_messageStringList.addAssign_operation (var_cas_cstString) ;
            operand_211925 = operand_211925->nextObject () ;
          }
          var_cas_enumMessageMap.method_insertKey (_inLexique, var_cas_messageName, var_cas_messageStringList SOURCE_FILE_AT_LINE (5431)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_message) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_enumTypeName, var_cas_ee SOURCE_FILE_AT_LINE (5443)) ;
}
...
pr_semantics_declaration_semantics_parser_5378_29_importSemantics (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
        var_cas_constantName.defineAttribute (_inLexique.tokenString, _inLexique) ;
        var_cas_constantMap.method_insertKey (_inLexique, var_cas_constantName SOURCE_FILE_AT_LINE (5462)) ;
      switch (select_repeat_semantics_parser_50 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2C) ;
          } break ;
