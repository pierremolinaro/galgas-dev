...
void semantics_parser::rule_semantics_5F_parser_semantic_5F_instruction_i51_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_AC_galgasType  temp_185906 = var_cas_targetType ;
  if (temp_185906.isBuilt ()) {
    temp_185906 (HERE)->method_check_with_InstructionAccess (inLexique, var_cas_instructionLocation, var_cas_searchMethodName, var_cas_keyExpressionType, var_cas_mapTypeName, var_cas_errorMessageName, var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (4936)) ;
  }
...
void semantics_parser::rule_semantics_5F_parser_constant_5F_while_5F_before_5F_in_5F_foreach_5F_instruction_i52_secondPhase (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_54 = true ;
    while (syntaxRepeat_54) {
        ...
        const GGS_AC_galgasType  temp_192203 = var_cas_sourceExpressionType ;
        if (temp_192203.isBuilt ()) {
          temp_192203 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_magicNumber, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (5142)) ;
        }
        GGS_string var_cas_typeName ;
        const GGS_AC_galgasType  temp_192461 = var_cas_sourceExpressionType ;
        if (temp_192461.isBuilt ()) {
          temp_192461 (HERE)->method_getTypeName (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (5151)) ;
        }
        switch (select_semantics_5F_parser_56 (inLexique)) {
          case 1 : {
  ...
  { const GGS_AC_galgasType _var_200471 = var_cas_type ; // CAST instruction
    if (_var_200471.getPtr () != NULL) {
      ...
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_200471.getPtr ()) != NULL) {
        ...
        const GGS_AC_galgasType  temp_200236 = var_cas_type ;
        if (temp_200236.isBuilt ()) {
          temp_200236 (HERE)->method_getTypeName (inLexique, var_cas_actualTypeName COMMA_SOURCE_FILE_AT_LINE (5384)) ;
        }
...
void semantics_parser::rule_semantics_5F_parser_parse_5F_match_5F_case_i55_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_201019 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_201019.isBuilt ()) {
    temp_201019 (HERE)->method_searchKey (inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (5407)) ;
  }
...
void semantics_parser::rule_semantics_5F_parser_parse_5F_match_5F_case_i56_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  if (cond_202854.isBuiltAndTrue ()) {
    ...
    const GGS_enumConstantMap  temp_202820 = var_cas_inEnumMessageMap ;
    if (temp_202820.isBuilt ()) {
      temp_202820 (HERE)->method_searchKey (inLexique, var_cas_outEnumConstantName, automatic_var_202845_0 COMMA_SOURCE_FILE_AT_LINE (5450)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_optional_5F_assignment_i61_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  GGS_AC_galgasType  var_cas_returnedType ;
  const GGS_AC_galgasType  temp_210261 = var_cas_inVariableType ;
  if (temp_210261.isBuilt ()) {
    temp_210261 (HERE)->method_handleConstructorInvocation (inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments, var_cas_returnedType COMMA_SOURCE_FILE_AT_LINE (5669)) ;
  }
  const GGS_bool cond_210607 = (var_cas_inVariableType).operator_isNotEqual (var_cas_returnedType) ;
  if (cond_210607.isBuiltAndTrue ()) {
    GGS_string var_cas_typeName ;
    const GGS_AC_galgasType  temp_210498 = var_cas_returnedType ;
    if (temp_210498.isBuilt ()) {
      temp_210498 (HERE)->method_getTypeName (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (5672)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_212668 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_212668.isBuilt ()) {
        temp_212668 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5728)) ;
      }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_214692 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_214692.isBuilt ()) {
        temp_214692 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5779)) ;
      }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i63_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_65 (inLexique)) {
    ...
    case 3 : {
        ...
        while (((operand_225382 = enumerator_225382.nextObject ()))) {
          macroValidPointer (operand_225382) ;
          {
            ...
            while (((operand_225415 = enumerator_225415.nextObject ()))) {
              ...
              const GGS_mapAutomatonStateMap  temp_225458 = var_cas_mapAutomatonStateMap ;
              if (temp_225458.isBuilt ()) {
                temp_225458 (HERE)->method_searchKey (inLexique, operand_225415->mTargetStateName, automatic_var_225480_0 COMMA_SOURCE_FILE_AT_LINE (6045)) ;
              }
            }
          }
        }
            ...
            case 4 : {
              ...
              switch (select_semantics_5F_parser_72 (inLexique)) {
                ...
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                  const GGS_mapAutomatonStateMap  temp_228107 = var_cas_mapAutomatonStateMap ;
                  if (temp_228107.isBuilt ()) {
                    temp_228107 (HERE)->method_searchKey (inLexique, var_cas_insertStateName, var_cas_initialAutomatonState COMMA_SOURCE_FILE_AT_LINE (6107)) ;
                  }
            ...
            case 5 : {
              ...
              switch (select_semantics_5F_parser_74 (inLexique)) {
                ...
                case 2 : {
                  ...
                  inLexique.assignFromAttribute_tokenString (var_cas_actionName) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                  const GGS_bool cond_229826 = (var_cas_mapAutomatonActionMap.reader_hasKey (var_cas_actionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6147)))).operator_not () ;
                  if (cond_229826.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_229826.isBuiltAndFalse ()) {
                    const GGS_mapAutomatonActionMap  temp_229869 = var_cas_mapAutomatonActionMap ;
                    if (temp_229869.isBuilt ()) {
                      temp_229869 (HERE)->method_searchKey (inLexique, var_cas_actionName, var_cas_actionIndex COMMA_SOURCE_FILE_AT_LINE (6151)) ;
                    }
                  }
                  } break ;
                default :
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230262 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_230262 = NULL ;
                while (((operand_230262 = enumerator_230262.nextObject ()))) {
                  macroValidPointer (operand_230262) ;
                  var_cas_methodSignature.addAssign_operation (operand_230262->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_230476 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_230476.isBuiltAndTrue ()) {
              ...
              }else if (cond_230476.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_230730 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_230730 = NULL ;
        while (((operand_230730 = enumerator_230730.nextObject ()))) {
          macroValidPointer (operand_230730) ;
          const GGS_bool cond_231161 = operand_230730->mInfo.mHasSetter ;
          if (cond_231161.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_230730->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6175)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_230730->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_231422 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_231422.isBuiltAndTrue ()) {
      ...
      {
        GGS_mapStateList::cEnumerator enumerator_232029 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_232029 = NULL ;
        while (((operand_232029 = enumerator_232029.nextObject ()))) {
          macroValidPointer (operand_232029) ;
          ...
          {
            GGS_mapStateTransitionList::cEnumerator enumerator_232200 (operand_232029->mTransitionList, true) ;
            const GGS_mapStateTransitionList::cElement * operand_232200 = NULL ;
            while (((operand_232200 = enumerator_232200.nextObject ()))) {
              macroValidPointer (operand_232200) ;
              GGS_uint  var_cas_actionIndex ;
              const GGS_mapAutomatonActionMap  temp_232272 = var_cas_mapAutomatonActionMap ;
              if (temp_232272.isBuilt ()) {
                temp_232272 (HERE)->method_searchKey (inLexique, operand_232200->mActionName, var_cas_actionIndex COMMA_SOURCE_FILE_AT_LINE (6208)) ;
              }
              const GGS_bool cond_232481 = var_cas_actionsForCurrentState.reader_hasKey (operand_232200->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6209))) ;
              if (cond_232481.isBuiltAndTrue ()) {
                operand_232200->mActionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_232200->mActionName)).operator_concat (GGS_string ("' action is already used for this state")) COMMA_SOURCE_FILE_AT_LINE (6211)) ;
              }
              var_cas_actionsForCurrentState.addAssign_operation (operand_232200->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6212))) ;
              GGS_uint  var_cas_targetStateIndex ;
              const GGS_mapAutomatonStateMap  temp_232617 = var_cas_mapAutomatonStateMap ;
              if (temp_232617.isBuilt ()) {
                temp_232617 (HERE)->method_searchKey (inLexique, operand_232200->mTargetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (6214)) ;
              }
              var_cas_mapStateTransitionSortedList.addAssign_operation (var_cas_actionIndex, operand_232200->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6217)), var_cas_targetStateIndex, operand_232200->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6219)), operand_232200->mTransitionMessageKind, operand_232200->mTransitionMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6221))) ;
            }
          }
          GGS_uint  var_cas_stateIndex ;
          const GGS_mapAutomatonStateMap  temp_232982 = var_cas_mapAutomatonStateMap ;
          if (temp_232982.isBuilt ()) {
            temp_232982 (HERE)->method_searchKey (inLexique, operand_232029->mStateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (6225)) ;
          }
          var_cas_mapStateSortedList.addAssign_operation (var_cas_stateIndex, operand_232029->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6228)), operand_232029->mStateMessageKind, operand_232029->mStateMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6230)), var_cas_mapStateTransitionSortedList) ;
          ...
          const GGS_bool cond_233565 = (var_cas_missingActions.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
          if (cond_233565.isBuiltAndTrue ()) {
            GGS_string var_cas_s = GGS_string ("") ;
            {
              GGS_stringset::cEnumerator enumerator_233362 (var_cas_missingActions, true) ;
              if (enumerator_233362 .hasCurrentObject ()) {
                bool _foreach_loop_233362 ;
                do{
                  var_cas_s.appendCString ("'") ;
                  var_cas_s.dotAssign_operation (enumerator_233362._key (HERE)) ;
                  var_cas_s.appendCString ("'") ;
                  enumerator_233362.next () ;
                  _foreach_loop_233362 = (enumerator_233362 .hasCurrentObject ()) ;
                  if (_foreach_loop_233362) {
                    var_cas_s.appendCString (", ") ;
                  }
                }while (_foreach_loop_233362) ;
              }
            }
            operand_232029->mStateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the following actions are not named in a transition from this state: ")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (6241)) ;
          }
        }
      }
      GGS_stringset  var_cas_accessibleStates = var_cas_initialStateSet ;
      GGS_bool var_cas_progress = GGS_bool (true) ;
      GGS_uint _variant_234185 = var_cas_mapStateList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (6246)) ;
      GGS_bool _condition_234185 (_variant_234185.isBuilt (), true) ;
      while (_condition_234185.isBuiltAndTrue ()) {
        _condition_234185 = var_cas_progress ;
        if (_condition_234185.isBuiltAndTrue ()) {
          if (_variant_234185.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (6258)) ;
            _condition_234185 = GGS_bool (false) ;
          }else{
            _variant_234185.decrement_operation (inLexique COMMA_HERE) ;
            var_cas_progress = GGS_bool (false) ;
            {
              GGS_mapStateList::cEnumerator enumerator_233819 (var_cas_mapStateList, true) ;
              const GGS_mapStateList::cElement * operand_233819 = NULL ;
              while (((operand_233819 = enumerator_233819.nextObject ()))) {
                macroValidPointer (operand_233819) ;
                const GGS_bool cond_234152 = var_cas_accessibleStates.reader_hasKey (operand_233819->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6249))) ;
                if (cond_234152.isBuiltAndTrue ()) {
                  {
                    GGS_mapStateTransitionList::cEnumerator enumerator_233919 (operand_233819->mTransitionList, true) ;
                    const GGS_mapStateTransitionList::cElement * operand_233919 = NULL ;
                    while (((operand_233919 = enumerator_233919.nextObject ()))) {
                      macroValidPointer (operand_233919) ;
                      const GGS_bool cond_234111 = (var_cas_accessibleStates.reader_hasKey (operand_233919->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6251)))).operator_not () ;
                      if (cond_234111.isBuiltAndTrue ()) {
                        var_cas_accessibleStates.addAssign_operation (operand_233919->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6252))) ;
      ...
      const GGS_bool cond_234540 = (var_cas_uselessStates.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_234540.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_stringset::cEnumerator enumerator_234372 (var_cas_uselessStates, true) ;
          if (enumerator_234372 .hasCurrentObject ()) {
            bool _foreach_loop_234372 ;
            do{
              var_cas_s.appendCString ("'") ;
              var_cas_s.dotAssign_operation (enumerator_234372._key (HERE)) ;
              var_cas_s.appendCString ("'") ;
              enumerator_234372.next () ;
              _foreach_loop_234372 = (enumerator_234372 .hasCurrentObject ()) ;
              if (_foreach_loop_234372) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_234372) ;
          }
        }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i63_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_65 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_235712 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6297)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6297))))).operator_not () ;
      if (cond_235712.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_238644 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_238644 = NULL ;
        while (((operand_238644 = enumerator_238644.nextObject ()))) {
          macroValidPointer (operand_238644) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_238821 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_238821 = NULL ;
            while (((operand_238821 = enumerator_238821.nextObject ()))) {
              macroValidPointer (operand_238821) ;
              var_cas_methodSignature.addAssign_operation (operand_238821->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_238644->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6388)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_239223 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_239223 = NULL ;
            while (((operand_239223 = enumerator_239223.nextObject ()))) {
              macroValidPointer (operand_239223) ;
              var_cas_methodSignature.addAssign_operation (operand_239223->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_238644->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6396))).operator_concat (GGS_string ("GetIndex")), operand_238644->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6396)) COMMA_SOURCE_FILE_AT_LINE (6396)) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_239551 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_239551 = NULL ;
        while (((operand_239551 = enumerator_239551.nextObject ()))) {
          macroValidPointer (operand_239551) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_239728 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_239728 = NULL ;
            while (((operand_239728 = enumerator_239728.nextObject ()))) {
              macroValidPointer (operand_239728) ;
              var_cas_methodSignature.addAssign_operation (operand_239728->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_239551->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6406)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_240131 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_240131 = NULL ;
            while (((operand_240131 = enumerator_240131.nextObject ()))) {
              macroValidPointer (operand_240131) ;
              var_cas_methodSignature.addAssign_operation (operand_240131->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_239551->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6414))).operator_concat (GGS_string ("GetIndex")), operand_239551->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6414)) COMMA_SOURCE_FILE_AT_LINE (6414)) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_71) {
          switch (select_semantics_5F_parser_71 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_244213 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_244213 = NULL ;
                while (((operand_244213 = enumerator_244213.nextObject ()))) {
                  macroValidPointer (operand_244213) ;
                  var_cas_methodSignature.addAssign_operation (operand_244213->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_remove) COMMA_HERE) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  automatic_var_244493_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, automatic_var_244493_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_244700 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_244700 = NULL ;
                while (((operand_244700 = enumerator_244700.nextObject ()))) {
                  macroValidPointer (operand_244700) ;
                  var_cas_methodSignature.addAssign_operation (operand_244700->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245391 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_245391 = NULL ;
                while (((operand_245391 = enumerator_245391.nextObject ()))) {
                  macroValidPointer (operand_245391) ;
                  var_cas_methodSignature.addAssign_operation (operand_245391->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246001 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_246001 = NULL ;
                while (((operand_246001 = enumerator_246001.nextObject ()))) {
                  macroValidPointer (operand_246001) ;
                  var_cas_methodSignature.addAssign_operation (operand_246001->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_246215 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_246215.isBuiltAndTrue ()) {
              ...
              }else if (cond_246215.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_246382 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_246382 = NULL ;
        while (((operand_246382 = enumerator_246382.nextObject ()))) {
          macroValidPointer (operand_246382) ;
          const GGS_bool cond_246813 = operand_246382->mInfo.mHasSetter ;
          if (cond_246813.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_246382->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6592)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_246382->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_247074 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_247074.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i66_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_249911 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_249911.isBuilt ()) {
    temp_249911 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6683)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_250380 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_250380 = NULL ;
    while (((operand_250380 = enumerator_250380.nextObject ()))) {
      macroValidPointer (operand_250380) ;
      GGS_string var_cas_keyClassMethod = ((operand_250380->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6691))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6691))) ;
      const GGS_bool cond_250675 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6692)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_250675.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_250380->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6695)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i66_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_252310 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6737)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6737)))).operator_not () ;
  if (cond_252310.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i67_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_254262 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_254262.isBuilt ()) {
    temp_254262 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6785)) ;
  }
  ...
  const GGS_bool cond_255812 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (6791))) ;
  if (cond_255812.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_254856 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_254856 = NULL ;
      while (((operand_254856 = enumerator_254856.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_254856) ;
        GGS_string var_cas_keyClassMethod = ((operand_254856->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6795))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6795))) ;
        var_cas_baseClassName = operand_254856->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6796)) ;
        ...
        const GGS_bool cond_255592 = var_cas_found ;
        if (cond_255592.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_255261 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6801)) ;
          if (temp_255261.isBuilt ()) {
            temp_255261 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (6801)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6801)) ;
          }
    ...
    const GGS_bool cond_255800 = (var_cas_found).operator_not () ;
    if (cond_255800.isBuiltAndTrue ()) {
  ...
  }else if (cond_255812.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_255889 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_255889 = NULL ;
      while (((operand_255889 = enumerator_255889.nextObject ()))) {
        macroValidPointer (operand_255889) ;
        GGS_string var_cas_keyClassMethod = ((operand_255889->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6816))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6816))) ;
        const GGS_bool cond_256193 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6817)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_256193.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_255889->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6820)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_256346 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6825)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_256346 = NULL ;
    while (((operand_256346 = enumerator_256346.nextObject ()))) {
      macroValidPointer (operand_256346) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6827)), operand_256346->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6828)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (6826)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_256346->mAttributeName, operand_256346->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6832)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i67_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_258864 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6892)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6892)))).operator_not () ;
  if (cond_258864.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i68_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  if (temp_260816.isBuilt ()) {
    temp_260816 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6941)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_261342 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_261342.isBuilt ()) {
    temp_261342 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6947)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_261811 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_261811 = NULL ;
    while (((operand_261811 = enumerator_261811.nextObject ()))) {
      macroValidPointer (operand_261811) ;
      GGS_string var_cas_keyClassMethod = ((operand_261811->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6955))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6955))) ;
      const GGS_bool cond_262106 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6956)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_262106.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_261811->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6959)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i68_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_263733 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_263733.isBuilt ()) {
    temp_263733 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7007)) ;
  }
  ...
  const GGS_bool cond_264225 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7011)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7011)))).operator_not () ;
  if (cond_264225.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i69_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_266039 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_266039.isBuilt ()) {
    temp_266039 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7059)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_266918 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_266918.isBuilt ()) {
    temp_266918 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7069)) ;
  }
  ...
  const GGS_bool cond_268811 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7075))) ;
  if (cond_268811.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_267512 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_267512 = NULL ;
      while (((operand_267512 = enumerator_267512.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_267512) ;
        GGS_string var_cas_keyClassMethod = ((operand_267512->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7079))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7079))) ;
        var_cas_baseClassName = operand_267512->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7080)) ;
        ...
        const GGS_bool cond_268591 = var_cas_found ;
        if (cond_268591.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_267974 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7086)) ;
          if (temp_267974.isBuilt ()) {
            temp_267974 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7087)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (7086)) ;
          }
    ...
    const GGS_bool cond_268799 = (var_cas_found).operator_not () ;
    if (cond_268799.isBuiltAndTrue ()) {
  ...
  }else if (cond_268811.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_268888 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_268888 = NULL ;
      while (((operand_268888 = enumerator_268888.nextObject ()))) {
        macroValidPointer (operand_268888) ;
        GGS_string var_cas_keyClassMethod = ((operand_268888->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7112))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7112))) ;
        const GGS_bool cond_269192 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7113)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_269192.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_268888->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7116)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_269345 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7121)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_269345 = NULL ;
    while (((operand_269345 = enumerator_269345.nextObject ()))) {
      macroValidPointer (operand_269345) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7123)), operand_269345->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7124)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7122)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_269345->mAttributeName, operand_269345->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7128)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i69_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_271854 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_271854.isBuilt ()) {
    temp_271854 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7194)) ;
  }
  ...
  const GGS_bool cond_272346 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7198)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7198)))).operator_not () ;
  if (cond_272346.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_274333 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_274333.isBuilt ()) {
    temp_274333 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7246)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_274802 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_274802 = NULL ;
    while (((operand_274802 = enumerator_274802.nextObject ()))) {
      macroValidPointer (operand_274802) ;
      GGS_string var_cas_keyClassMethod = ((operand_274802->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7254))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7254))) ;
      const GGS_bool cond_275105 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7255)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_275105.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_274802->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7258)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_276810 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7301)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7301)))).operator_not () ;
  if (cond_276810.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_278929 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_278929.isBuilt ()) {
    temp_278929 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7352)) ;
  }
  ...
  const GGS_bool cond_280550 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7358))) ;
  if (cond_280550.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_279523 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_279523 = NULL ;
      while (((operand_279523 = enumerator_279523.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_279523) ;
        GGS_string var_cas_keyClassMethod = ((operand_279523->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7362))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7362))) ;
        var_cas_baseClassName = operand_279523->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7363)) ;
        ...
        const GGS_bool cond_280326 = var_cas_found ;
        if (cond_280326.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_279934 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7368)) ;
          if (temp_279934.isBuilt ()) {
            temp_279934 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7369)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7368)) ;
          }
    ...
    const GGS_bool cond_280538 = (var_cas_found).operator_not () ;
    if (cond_280538.isBuiltAndTrue ()) {
  ...
  }else if (cond_280550.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_280627 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_280627 = NULL ;
      while (((operand_280627 = enumerator_280627.nextObject ()))) {
        macroValidPointer (operand_280627) ;
        GGS_string var_cas_keyClassMethod = ((operand_280627->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7387))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7387))) ;
        const GGS_bool cond_280939 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7388)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_280939.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_280627->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7391)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_281092 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7396)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_281092 = NULL ;
    while (((operand_281092 = enumerator_281092.nextObject ()))) {
      macroValidPointer (operand_281092) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7398)), operand_281092->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7399)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7397)) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_281092->mAttributeName, operand_281092->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7403)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_283906 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7472)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7472)))).operator_not () ;
  if (cond_283906.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_79 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_285214 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7506)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7506))))).operator_not () ;
      if (cond_285214.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_285906 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_285906 = NULL ;
        while (((operand_285906 = enumerator_285906.nextObject ()))) {
          macroValidPointer (operand_285906) ;
          var_cas_extractSignature.addAssign_operation (operand_285906->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7528))) ;
          var_cas_inputSignature.addAssign_operation (operand_285906->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7529))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_79 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_287353 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7561)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7561))))).operator_not () ;
      if (cond_287353.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_288045 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_288045 = NULL ;
        while (((operand_288045 = enumerator_288045.nextObject ()))) {
          macroValidPointer (operand_288045) ;
          var_cas_extractSignature.addAssign_operation (operand_288045->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7583))) ;
          var_cas_inputSignature.addAssign_operation (operand_288045->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7584))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i73_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_80 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_289909 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7621)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7621))))).operator_not () ;
      if (cond_289909.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_290553 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_290553 = NULL ;
        while (((operand_290553 = enumerator_290553.nextObject ()))) {
          macroValidPointer (operand_290553) ;
          var_cas_extractSignature.addAssign_operation (operand_290553->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7642))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_81 = true ;
        while (syntaxRepeat_81) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_291244 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7658))) ;
            if (cond_291244.isBuiltAndTrue ()) {
            ...
            }else if (cond_291244.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_291356_0 ;
              GGS_bool automatic_var_291356_1 ;
              const GGS_typeSemanticAttributesMap  temp_291318 = var_cas_tableAttributs ;
              if (temp_291318.isBuilt ()) {
                temp_291318 (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_291356_0, automatic_var_291356_1 COMMA_SOURCE_FILE_AT_LINE (7662)) ;
              }
              const GGS_AC_galgasType  temp_291422 = var_cas_definitionType ;
              if (temp_291422.isBuilt ()) {
                temp_291422 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (7663)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i73_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_80 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_292871 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7702)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7702))))).operator_not () ;
      if (cond_292871.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_293515 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_293515 = NULL ;
        while (((operand_293515 = enumerator_293515.nextObject ()))) {
          macroValidPointer (operand_293515) ;
          var_cas_extractSignature.addAssign_operation (operand_293515->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7723))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_85 = true ;
                while (syntaxRepeat_85) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_295953 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7790))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_295953.isBuiltAndTrue ()) {
                      const GGS_bool cond_295903 = (var_cas_hasGetter).operator_not () ;
                      if (cond_295903.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_295953.isBuiltAndFalse ()) {
                      const GGS_bool cond_296155 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7795))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_296155.isBuiltAndTrue ()) {
                        const GGS_bool cond_296107 = var_cas_hasSetter ;
                        if (cond_296107.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_296155.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i75_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_297685 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_297685.isBuilt ()) {
    temp_297685 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7838)) ;
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i75_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_298966 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_298966.isBuilt ()) {
    temp_298966 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7872)) ;
  }
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_303702 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_303702 = NULL ;
    while (((operand_303702 = enumerator_303702.nextObject ()))) {
      macroValidPointer (operand_303702) ;
      const GGS_bool cond_304209 = var_cas_inExtensionMap.reader_hasKey (operand_303702->mValue.reader_pathExtension ()) ;
      if (cond_304209.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_303702->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_303702->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_303702->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8000)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (7999)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_304444 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_304444 = NULL ;
    while (((operand_304444 = enumerator_304444.nextObject ()))) {
      macroValidPointer (operand_304444) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_304444->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_304444->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (8014)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_304444->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i77_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_306227 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_306227.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8067)) ;
  }else if (cond_306227.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_306507 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_306507.isBuiltAndTrue ()) {
  ...
  }else if (cond_306507.isBuiltAndFalse ()) {
            ...
            while (syntaxRepeat_89) {
              switch (select_semantics_5F_parser_89 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_308829 = var_cas_parameterIsUsed ;
                  if (cond_308829.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_308829.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i77_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_311550 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8200)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8200)))).operator_not () ;
  if (cond_311550.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_310762 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_310762.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8204)) ;
    }else if (cond_310762.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_311052 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_311052.isBuiltAndTrue ()) {
    ...
    }else if (cond_311052.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedList  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedList  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_312609 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8261)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8261)))).operator_not () ;
  if (cond_312609.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_93 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_318219 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_318219.isBuiltAndTrue ()) {
              ...
              }else if (cond_318219.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_91 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_93 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_322476 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_322476.isBuiltAndTrue ()) {
              ...
              }else if (cond_322476.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_94 = true ;
                while (syntaxRepeat_94) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i80_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_324408 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8591))) ;
  if (cond_324408.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_324270 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_324270.isBuilt ()) {
      temp_324270 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8593)) ;
    }
  ...
  }else if (cond_324408.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_324462 = var_cas_tableEnAvant ;
    if (temp_324462.isBuilt ()) {
      temp_324462 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8596)) ;
    }
  }
}
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_325241 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8614))) ;
  if (cond_325241.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_325103 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_325103.isBuilt ()) {
      temp_325103 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8616)) ;
    }
  ...
  }else if (cond_325241.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_325295 = var_cas_tableEnAvant ;
    if (temp_325295.isBuilt ()) {
      temp_325295 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8619)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_326211 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8639))) ;
  if (cond_326211.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_326073 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_326073.isBuilt ()) {
      temp_326073 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8641)) ;
    }
  ...
  }else if (cond_326211.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_326265 = var_cas_tableEnAvant ;
    if (temp_326265.isBuilt ()) {
      temp_326265 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8644)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_327196 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8665))) ;
  if (cond_327196.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_327058 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_327058.isBuilt ()) {
      temp_327058 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8667)) ;
    }
  ...
  }else if (cond_327196.isBuiltAndFalse ()) {
    const GGS_typeTableEnAvant  temp_327250 = var_cas_tableEnAvant ;
    if (temp_327250.isBuilt ()) {
      temp_327250 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8670)) ;
    }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_328742_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_328742_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_331204_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_331204_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_331413 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_331413 = NULL ;
    while (((operand_331413 = enumerator_331413.nextObject ()))) {
      macroValidPointer (operand_331413) ;
      const GGS_bool cond_331632 = (operand_331413->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8778))) ;
      if (cond_331632.isBuiltAndTrue ()) {
        operand_331413->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8780)) ;
      }else if (cond_331632.isBuiltAndFalse ()) {
        const GGS_bool cond_331841 = (operand_331413->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8780))) ;
        if (cond_331841.isBuiltAndTrue ()) {
          operand_331413->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8782)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i85_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_333692 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_333692 = NULL ;
    while (((operand_333692 = enumerator_333692.nextObject ()))) {
      macroValidPointer (operand_333692) ;
      const GGS_bool cond_333911 = (operand_333692->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8832))) ;
      if (cond_333911.isBuiltAndTrue ()) {
        operand_333692->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8834)) ;
      }else if (cond_333911.isBuiltAndFalse ()) {
        const GGS_bool cond_334120 = (operand_333692->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8834))) ;
        if (cond_334120.isBuiltAndTrue ()) {
          operand_333692->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8836)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i86_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_95 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_enumConstantMap::cEnumerator enumerator_336416 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_336416 = enumerator_336416.nextObject () ;
        if ((operand_336416 != NULL)) {
          bool _foreach_loop_336416 ;
          do{
            macroValidPointer (operand_336416) ;
            var_cas_s.dotAssign_operation (operand_336416->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8903))) ;
            operand_336416 = enumerator_336416.nextObject () ;
            _foreach_loop_336416 = ((operand_336416 != NULL)) ;
            if (_foreach_loop_336416) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_336416) ;
        }
      }
    ...
    while (syntaxRepeat_99) {
      switch (select_semantics_5F_parser_99 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_337235 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_337235 = NULL ;
            while (((operand_337235 = enumerator_337235.nextObject ()))) {
              macroValidPointer (operand_337235) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_337235->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8935)), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8935)) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  temp_337362 = var_cas_cstMessageStringMap ;
              if (temp_337362.isBuilt ()) {
                temp_337362 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (8937)) ;
              }
