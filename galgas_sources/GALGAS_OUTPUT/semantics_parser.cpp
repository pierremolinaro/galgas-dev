        ...
        while (((operand_232029 = enumerator_232029.nextObject ()))) {
          ...
          GGS_mapStateTransitionSortedList  var_cas_mapStateTransitionSortedList = GGS_mapStateTransitionSortedList ::constructor_emptySortedList () ;
          {
            ...
            while (((operand_232200 = enumerator_232200.nextObject ()))) {
              ...
              GGS_uint  var_cas_actionIndex ;
              if (var_cas_mapAutomatonActionMap.isBuilt ()) {
                var_cas_mapAutomatonActionMap (HERE)->method_searchKey (inLexique, operand_232200->mActionName, var_cas_actionIndex COMMA_SOURCE_FILE_AT_LINE (6208)) ;
              }
              ...
              if (var_cas_mapAutomatonStateMap.isBuilt ()) {
                var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_232200->mTargetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (6214)) ;
              }
          ...
          if (var_cas_mapAutomatonStateMap.isBuilt ()) {
            var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_232029->mStateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (6225)) ;
          }
      ...
      { bool syntaxRepeat_81 = true ;
        while (syntaxRepeat_81) {
            ...
            if (cond_291244.isBuiltAndTrue ()) {
              ...
              if (var_cas_tableAttributs.isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_291356_0, automatic_var_291356_1 COMMA_SOURCE_FILE_AT_LINE (7662)) ;
              }
