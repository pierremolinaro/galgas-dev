...
pr_galgas_component_semantics_parser_438_6_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_18874 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_18874) ;
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_19466 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_19466 != NULL)) {
    macroValidPointer (operand_19466) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_19466->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (544)) SOURCE_FILE_AT_LINE (544))))).isBuiltAndTrue ()) {
      operand_19466->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_19466->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (545))))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (547)) ;
    }
    operand_19466 = operand_19466->nextObject () ;
  }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            ...
            case 2 : {
              ...
              GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_28585 = var_cas_nonterminalSymbolParametersMap.firstObject () ;
              while ((operand_28585 != NULL)) {
                ...
                GGS_L_signature::element_type * operand_28738 = operand_28585->mInfo.mFormalParametersList.firstObject () ;
                while ((operand_28738 != NULL)) {
                  macroValidPointer (operand_28738) ;
                  GGS_AC_semanticsEntity  var_cas_e ;
                  if (var_cas_ioComponentSemanticsEntitiesMap._isBuilt ()) {
                    var_cas_ioComponentSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, operand_28738->mGalgasTypeName, var_cas_e SOURCE_FILE_AT_LINE (807)) ;
                  }
                  ...
                  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
                    if (ptrExtraire_ == NULL) {
                      ...
                      if (var_cas_e.getPtr () != NULL) {
                        ...
                        operand_28738->mGalgasTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (809)) ;
                      }
                    }else{
                  ...
                  var_cas_formalParametersList._addAssign_operation (var_cas_type, operand_28738->mFormalArgumentPassingMode) ;
                  operand_28738 = operand_28738->nextObject () ;
                }
                var_cas_grammarAltMap.modifier_insertKey (_inLexique, operand_28585->mKey, var_cas_formalParametersList, operand_28585->mInfo.mReturnedEntityTypeName SOURCE_FILE_AT_LINE (812)) ;
            ...
            case 3 : {
              ...
              if (((! (var_cas_outImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_componentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (837)) SOURCE_FILE_AT_LINE (837))))).isBuiltAndTrue ()) {
                ...
                GGS_M_semanticsEntitiesForUse::element_type * operand_30416 = var_cas_importedEntities.firstObject () ;
                while ((operand_30416 != NULL)) {
                  macroValidPointer (operand_30416) ;
                  if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_30416->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (842)) SOURCE_FILE_AT_LINE (842))))).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_30416->mKey, operand_30416->mInfo.aDefEntite SOURCE_FILE_AT_LINE (843)) ;
                  }
                  operand_30416 = operand_30416->nextObject () ;
                }
                ...
                GGS_M_optionComponents::element_type * operand_30859 = var_cas_importedOptionsComponentsMap.firstObject () ;
                while ((operand_30859 != NULL)) {
                  macroValidPointer (operand_30859) ;
                  if (((! (var_cas_ioOptionsComponentsMapForUse.reader_hasKey (_inLexique, operand_30859->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (849)) SOURCE_FILE_AT_LINE (849))))).isBuiltAndTrue ()) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_30859->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (850))))) + (GGS_string (true, "' option component must have been imported"))) SOURCE_FILE_AT_LINE (851)) ;
                  }
                  operand_30859 = operand_30859->nextObject () ;
                }
              }
            ...
            case 4 : {
              ...
              if (((! (var_cas_outIncludedMetamodelComponents.reader_hasKey (_inLexique, var_cas_metamodelComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (883)) SOURCE_FILE_AT_LINE (883))))).isBuiltAndTrue ()) {
                ...
                GGS_entityToImplementMap::element_type * operand_32291 = var_cas_metamodelClassMap.firstObject () ;
                while ((operand_32291 != NULL)) {
                  macroValidPointer (operand_32291) ;
                  var_cas_outAllMetamodelClassMap.modifier_insertKey (_inLexique, operand_32291->mKey, operand_32291->mInfo.mAllMetamodelPropertyMap, operand_32291->mInfo.mIsAbstract, operand_32291->mInfo.mCurrentMetamodelPropertyMap, operand_32291->mInfo.mSuperEntityName, operand_32291->mInfo.mCurrentConstraintPropertyMap, operand_32291->mInfo.mSuperEntitySet, operand_32291->mInfo.mAllConstraintPropertyMap, operand_32291->mInfo.mAllAvailablePropertyMap SOURCE_FILE_AT_LINE (895)) ;
                  operand_32291 = operand_32291->nextObject () ;
                }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_M_semanticsEntitiesForUse::element_type * operand_35550 = var_cas_importedEntities.firstObject () ;
              while ((operand_35550 != NULL)) {
                macroValidPointer (operand_35550) ;
                if (((! (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (_inLexique, operand_35550->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (977)) SOURCE_FILE_AT_LINE (977))))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, operand_35550->mKey, operand_35550->mInfo.aDefEntite SOURCE_FILE_AT_LINE (978)) ;
                }
                operand_35550 = operand_35550->nextObject () ;
              }
              ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_outModelMap,  var_cas_outActionMap,  var_cas_alreadyImportedSemanticsComponents,  var_cas_alreadyImportedMetamodelComponents,  var_cas_componentName SOURCE_FILE_AT_LINE (981)) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_metamodel) COMMA_HERE) ;
              GGS_lstring  var_cas_metamodelComponentName ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1019_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1019_6_importSemantics (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_1019_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_routine) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1154_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1154_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
...
void semantics_parser::
pr_parent_class_semantics_parser_1154_6_parse (galgas_scanner & /* _inLexique */) {
}
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1194_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeSemanticAttributesMap  &var_cas_tableAttributs,
                                GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                GGS_typeTableMethodes  &var_cas_tableDesMethodes,
...
void semantics_parser::
semantics_parser::
pr_parent_class_semantics_parser_1194_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_stringset  &var_cas_outSuperClasses,
                                GGS_typeListModel  &var_cas_outAttributeList,
                                GGS_classMessageMap  &var_cas_outMessageMap,
  ...
  if (var_cas_type._isBuilt ()) {
    cPtr_ClassModel * operand_47150 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
    if (operand_47150 != NULL) {
      macroValidPointer (operand_47150) ; 
      var_cas_outSuperClasses = operand_47150->mSuperClasses ;
      var_cas_outAttributeList = operand_47150->mAttributeList ;
      var_cas_outMessageMap = operand_47150->mMessageMap ;
    }else{ // Else part
...
void semantics_parser::
pr_parent_class_semantics_parser_1194_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_extends) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1278_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_9 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_52125 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_52125 != NULL)) {
        macroValidPointer (operand_52125) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_52125->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1397)) SOURCE_FILE_AT_LINE (1397))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_52125->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1398))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1399)) ;
        }
        operand_52125 = operand_52125->nextObject () ;
      }
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_1278_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_9 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_57487 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_57487 != NULL)) {
        macroValidPointer (operand_57487) ;
        if (((! (var_cas_tableMessagesClasseConcrete.reader_hasKey (_inLexique, operand_57487->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1551)) SOURCE_FILE_AT_LINE (1551))))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the message '")) + (operand_57487->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1552))))) + (GGS_string (true, "' is not defined"))) SOURCE_FILE_AT_LINE (1553)) ;
        }
        operand_57487 = operand_57487->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasClassType::constructor_new (_inLexique, var_cas_abstractClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_1278_6_parse (galgas_scanner & _inLexique) {
  switch (select_semantics_parser_8 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
      } break ;
...
void semantics_parser::
semantics_parser::
pr_abstract_method_semantics_parser_1576_6_ (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_abstract_method_semantics_parser_1576_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_formal_arguments_list_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_parse_method_semantics_parser_1612_6_ (galgas_scanner & _inLexique,
  ...
  GGS_typeSemanticAttributesMap::element_type * operand_61086 = var_cas_tableAttributsHerites.firstObject () ;
  while ((operand_61086 != NULL)) {
    macroValidPointer (operand_61086) ;
    GGS_typeCplusPlusName  var_cas_nomCpp ;
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (_inLexique, operand_61086->mKey COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (_inLexique, operand_61086->mKey, operand_61086->mInfo.mAttributType, var_cas_nomCpp SOURCE_FILE_AT_LINE (1636)) ;
    operand_61086 = operand_61086->nextObject () ;
  }
...
void semantics_parser::
pr_parse_method_semantics_parser_1612_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  nt_semantic_instructions_list_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_non_abstract_method_semantics_parser_1696_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inCurrentClassName,
                                const GGS_typeTableMethodes  &var_cas_inAncestorClassMethodsMap,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                GGS_typeTableMethodes  &var_cas_tableDesMethodes,
...
void semantics_parser::
pr_non_abstract_method_semantics_parser_1696_6_parse (galgas_scanner & _inLexique) {
  switch (select_semantics_parser_11 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
      } break ;
...
void semantics_parser::
semantics_parser::
pr_overrided_method_semantics_parser_1753_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inCurrentClassName,
                                const GGS_typeTableMethodes  &var_cas_inAncestorClassMethodsMap,
                                const GGS_typeListeAttributsSemantiques  &var_cas_listeTousAttributsSemantiques,
                                GGS_typeTableMethodes  &var_cas_tableDesMethodes,
  ...
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_listeDeTypesMethodeOriginale,  var_cas_methodSignature,  GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1800)) ;
...
void semantics_parser::
pr_overrided_method_semantics_parser_1753_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_override) COMMA_HERE) ;
  switch (select_semantics_parser_13 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_formal_arguments_list_semantics_parser_1822_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_L_EXsignature  &var_cas_listeDeTypes,
                                GGS_typeVariablesMap  &var_cas_tableArgumentsMethode,
                                GGS_typeListeTypesEtNomsArgMethode  &var_cas_listeTypeEtNomsArguments,
...
void semantics_parser::
semantics_parser::
pr_formal_arguments_list_semantics_parser_1822_6_importGrammarForSemantics (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_formal_arguments_list_semantics_parser_1822_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_15 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_type_parsing_semantics_parser_1989_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
...
void semantics_parser::
pr_type_parsing_semantics_parser_1989_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
}
...
pr_instruction_beginning_with_identifier_semantics_parser_2006_6_ (galgas_scanner & _inLexique,
  ...
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_targetVarType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2028)) ;
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2041_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_inTargetVarName,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
  ...
  if (var_cas_targetVarType._isBuilt () && var_cas_sourceType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_77419 = var_cas_targetVarType (HERE) ;
    cPtr_AC_galgasType * ptr_77433 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_string * operand_77419 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77419) ;
    cPtr_typeGalgas_string * operand_77433 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77433) ;
    if ((operand_77419 != NULL) && (operand_77433 != NULL)) {
      var_cas_sourceExpressionConverter = GGS_string (true, "") ;
    }else{
      cPtr_typeGalgas_string * operand_77419 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77419) ;
      cPtr_typeGalgas_lstring * operand_77433 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77433) ;
      if ((operand_77419 != NULL) && (operand_77433 != NULL)) {
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2041_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_3D) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_input_parameters_list_semantics_parser_2088_6_ (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_20 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_79320 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (2113)) ;
              GGS_bool _condition_79320 (_variant_79320._isBuilt (), true) ;
              while (_condition_79320.isBuiltAndTrue ()) {
                _condition_79320 = (var_cas_jokerCount) > (GGS_uint (true, 0U)) ;
                if (_condition_79320.isBuiltAndTrue ()) {
                  if (_variant_79320.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (2117)) ;
                    _condition_79320 = GGS_bool (true, false) ;
                  }else{
                    _variant_79320._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeCibles._addAssign_operation (GGS_typeJoker::constructor_new (_inLexique COMMA_HERE)) ;
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2128))) < (var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2128)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_80338 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_80420 = var_cas_listeCibles.firstObject () ;
    while ((operand_80338 != NULL)
        && (operand_80420 != NULL)) {
      macroValidPointer (operand_80338) ;
      macroValidPointer (operand_80420) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_80338->aNomAttribut ;
      if (operand_80420->aCible._isBuilt ()) {
        operand_80420->aCible (HERE)->method_verifierType (_inLexique, operand_80338->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList SOURCE_FILE_AT_LINE (2142)) ;
      }
      operand_80338 = operand_80338->nextObject () ;
      operand_80420 = operand_80420->nextObject () ;
    }
  }
  ...
  if (var_cas_outAllVariablesList._isBuilt () &&
    ...
    ::routine_appendJokersIfNeeded (_inLexique,  var_cas_outAllVariablesList,  var_cas_listeCibles.reader_length (_inLexique SOURCE_FILE_AT_LINE (2149)),  var_cas_listeAttributsSemantiques.reader_length (_inLexique SOURCE_FILE_AT_LINE (2150)),  var_cas_nullName SOURCE_FILE_AT_LINE (2147)) ;
  }
}
...
void semantics_parser::
pr_input_parameters_list_semantics_parser_2088_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_19 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2163_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2197))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2197)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_82893 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_82963 = var_cas_typeList.firstObject () ;
    while ((operand_82893 != NULL)
        && (operand_82963 != NULL)) {
      macroValidPointer (operand_82893) ;
      macroValidPointer (operand_82963) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_82893->mAttributType,  operand_82963->mType,  operand_82963->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2202)) ;
      operand_82893 = operand_82893->nextObject () ;
      operand_82963 = operand_82963->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2163_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2B_3D) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__21) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2222_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
  ...
  if (((var_cas_formalParametersList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2256))) != (var_cas_typeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (2256)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_85341 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_85411 = var_cas_typeList.firstObject () ;
    while ((operand_85341 != NULL)
        && (operand_85411 != NULL)) {
      macroValidPointer (operand_85341) ;
      macroValidPointer (operand_85411) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_85341->mAttributType,  operand_85411->mType,  operand_85411->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (2261)) ;
      operand_85341 = operand_85341->nextObject () ;
      operand_85411 = operand_85411->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2222_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D_3D) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__21) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2308_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2308_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D_2D) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_actual_parameters_list_semantics_parser_2331_6_ (galgas_scanner & _inLexique,
  ...
  ::routine_verifierCompatibiliteArgEffectifsSignature (_inLexique,  var_cas_listeTypesParametresFormels,  var_cas_listeTypesParametresEffectifs,  GGS_location (_inLexique),  var_cas_ioInstructionList,  var_cas_outExpressionList SOURCE_FILE_AT_LINE (2347)) ;
}

//---------------------------------------------------------------------------*

void semantics_parser::
pr_actual_parameters_list_semantics_parser_2331_6_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_parse_parameters_list_semantics_parser_2362_6_ (galgas_scanner & _inLexique,
                                GGS_L_actualParametersSignature  &var_cas_listeTypesParametresEffectifs,
                                GGS_typeExpressionList  &var_cas_outExpressionList,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
        ...
        case 3 : {
          ...
          switch (select_semantics_parser_25 (_inLexique)) {
            ...
            case 2 : {
              ...
              GGS_uint _variant_91512 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (2398)) ;
              GGS_bool _condition_91512 (_variant_91512._isBuilt (), true) ;
              while (_condition_91512.isBuiltAndTrue ()) {
                _condition_91512 = (var_cas_jokerCount) > (GGS_uint (true, 0U)) ;
                if (_condition_91512.isBuiltAndTrue ()) {
                  if (_variant_91512.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (2403)) ;
                    _condition_91512 = GGS_bool (true, false) ;
                  }else{
                    _variant_91512._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_listeTypesParametresEffectifs._addAssign_operation (GGS_typeGalgas_jokerInParameterList::constructor_new (_inLexique COMMA_HERE), var_cas_parameterPassingMode) ;
                    var_cas_outExpressionList._addAssign_operation (GGS_typeJokerInExpression::constructor_new (_inLexique COMMA_HERE)) ;
...
void semantics_parser::
pr_parse_parameters_list_semantics_parser_2362_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_24 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instructions_list_semantics_parser_2442_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instructions_list_semantics_parser_2442_6_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2472_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  if (var_cas_property._isBuilt ()) {
    cPtr_metamodelSingleReferenceProperty * operand_95261 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (var_cas_property.getPtr ()) ;
    if (operand_95261 != NULL) {
      macroValidPointer (operand_95261) ; 
      ...
      cPtr_metamodelMultipleReferenceProperty * operand_95594 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (var_cas_property.getPtr ()) ;
      if (operand_95594 != NULL) {
        macroValidPointer (operand_95594) ; 
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2472_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_call) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_semantics_parser_26 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2554_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2554_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_extract) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_extract_instruction_semantics_parser_2599_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_extract_instruction_semantics_parser_2599_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D_3E) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_extract_instruction_semantics_parser_2676_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_extract_instruction_semantics_parser_2676_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_when) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2776_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2776_6_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2845_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2845_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_drop) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2877_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  var_cas_nomVarDest,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeInstructionList  &var_cas_ioInstructionList,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
...
void semantics_parser::
pr_instruction_beginning_with_identifier_semantics_parser_2877_6_parse (galgas_scanner & _inLexique) {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_2912_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_2912_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_action) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_actual_parameters_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  ...
  switch (select_semantics_parser_31 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_variableType._isBuilt ()) {
        var_cas_variableType (HERE)->method_handleMethodInstructionCall (_inLexique, var_cas_readObjectName, var_cas_methodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (2982)) ;
      }
      GGS_typeExpressionList  var_cas_expressionsList ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3060_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3060_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_warning) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3108_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3108_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_error) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3175_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3175_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3211_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3211_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_if) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_expression_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3303_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_stringset::element_type * operand_131610 = var_cas_missingConstants.firstObject () ;
  while ((operand_131610 != NULL)) {
    macroValidPointer (operand_131610) ;
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_131610->mKey))) + (GGS_string (true, "' is not used in switch instruction"))) SOURCE_FILE_AT_LINE (3381)) ;
    operand_131610 = operand_131610->nextObject () ;
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3303_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_switch) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_when) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3396_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3396_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_loop) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
  nt_semantic_instructions_list_no_verif_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3485_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3485_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_semantics_parser_38 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3556_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3556_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_foreach) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_read_access_parse (_inLexique) ;
...
void semantics_parser::
semantics_parser::
pr_parse_match_operand_semantics_parser_3653_6_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  if (var_cas_type._isBuilt ()) {
    cPtr_typeGalgasClassType * operand_142054 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
    if (operand_142054 != NULL) {
      macroValidPointer (operand_142054) ; 
      var_cas_outBaseTypeName = operand_142054->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_142246 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      if (operand_142246 != NULL) {
        macroValidPointer (operand_142246) ; 
        var_cas_outBaseTypeName = operand_142246->mEnumTypeName ;
        var_cas_outIsEnumeration = GGS_bool (true, true) ;
        var_cas_outEnumMessageMap = operand_142246->mEnumConstantesMap ;
      }else{ // Else part
...
void semantics_parser::
pr_parse_match_operand_semantics_parser_3653_6_parse (galgas_scanner & _inLexique) {
  nt_read_access_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_3691_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_parse_match_case_semantics_parser_3691_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  nt_parse_effective_input_parameters_list_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_parse_match_case_semantics_parser_3742_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioComponentSemanticsEntitiesMap */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_lstring  var_cas_inTypeName,
                                GGS_location  /* var_cas_inVarLocation */,
...
void semantics_parser::
pr_parse_match_case_semantics_parser_3742_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantic_instruction_semantics_parser_3763_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instruction_semantics_parser_3763_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_match) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_semantic_instructions_list_no_verif_semantics_parser_3886_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void semantics_parser::
pr_semantic_instructions_list_no_verif_semantics_parser_3886_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_42 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_3915_6_ (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_optional_assignment_semantics_parser_3915_6_parse (galgas_scanner & /* _inLexique */) {
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_3931_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &/* var_cas_inTypeName */,
  ...
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (_inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
  ::routine_checkAssignmentTypesCompatibility (_inLexique,  var_cas_inVariableType,  var_cas_sourceType,  GGS_location (_inLexique),  GGS_bool (true, true) SOURCE_FILE_AT_LINE (3954)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void semantics_parser::
pr_optional_assignment_semantics_parser_3931_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_3D) COMMA_HERE) ;
  nt_expression_parse (_inLexique) ;
}
...
void semantics_parser::
semantics_parser::
pr_optional_assignment_semantics_parser_3963_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inTypeName,
                                const GGS_lstring  &var_cas_inTargetVarName,
                                const GGS_typeCplusPlusName  &var_cas_inTargetVariableCppName,
                                const GGS_AC_galgasType  &var_cas_inVariableType,
...
void semantics_parser::
pr_optional_assignment_semantics_parser_3963_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4003_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_43 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_insertOrSearchMethodList::element_type * operand_157802 = var_cas_insertMethodList.firstObject () ;
      while ((operand_157802 != NULL)) {
        macroValidPointer (operand_157802) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_157998 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_157998 != NULL)) {
          macroValidPointer (operand_157998) ;
          var_cas_methodSignature._addAssign_operation (operand_157998->mAttributType, var_cas_inPassingMode) ;
          operand_157998 = operand_157998->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_157802->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4110)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_158427 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_158427 != NULL)) {
          macroValidPointer (operand_158427) ;
          var_cas_methodSignature._addAssign_operation (operand_158427->mAttributType, var_cas_inPassingMode) ;
          operand_158427 = operand_158427->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_157802->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4118))) + (GGS_string (true, "GetIndex"))), operand_157802->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4118)) COMMA_HERE) ;
        ...
        operand_157802 = operand_157802->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_158775 = var_cas_searchMethodList.firstObject () ;
      while ((operand_158775 != NULL)) {
        macroValidPointer (operand_158775) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_158969 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_158969 != NULL)) {
          macroValidPointer (operand_158969) ;
          var_cas_methodSignature._addAssign_operation (operand_158969->mAttributType, var_cas_outPassingMode) ;
          operand_158969 = operand_158969->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_158775->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4128)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_159396 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_159396 != NULL)) {
          macroValidPointer (operand_159396) ;
          var_cas_methodSignature._addAssign_operation (operand_159396->mAttributType, var_cas_outPassingMode) ;
          operand_159396 = operand_159396->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_158775->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4136))) + (GGS_string (true, "GetIndex"))), operand_158775->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4136)) COMMA_HERE) ;
        ...
        operand_158775 = operand_158775->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_45 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_162630 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_162630 != NULL)) {
                macroValidPointer (operand_162630) ;
                var_cas_methodSignature._addAssign_operation (operand_162630->mAttributType, var_cas_outPassingMode) ;
                operand_162630 = operand_162630->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4205))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_163218 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_163218 != NULL)) {
                  macroValidPointer (operand_163218) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_163218->mAttributType, var_cas_outPassingMode) ;
                  operand_163218 = operand_163218->nextObject () ;
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_164327 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_164327 != NULL)) {
                macroValidPointer (operand_164327) ;
                var_cas_methodSignature._addAssign_operation (operand_164327->mAttributType, var_cas_inPassingMode) ;
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4242))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_164930 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_164930 != NULL)) {
                  macroValidPointer (operand_164930) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_164930->mAttributType, var_cas_inPassingMode) ;
                  operand_164930 = operand_164930->nextObject () ;
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_165718 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_165718 != NULL)) {
                macroValidPointer (operand_165718) ;
                var_cas_methodSignature._addAssign_operation (operand_165718->mAttributType, var_cas_outPassingMode) ;
                operand_165718 = operand_165718->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4269))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_166336 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_166336 != NULL)) {
                  macroValidPointer (operand_166336) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_166336->mAttributType, var_cas_outPassingMode) ;
                  operand_166336 = operand_166336->nextObject () ;
                }
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4003_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_43 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (_inLexique COMMA_HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_171059 = var_cas_insertMethodList.firstObject () ;
      while ((operand_171059 != NULL)) {
        macroValidPointer (operand_171059) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        ...
        while ((operand_171255 != NULL)) {
          ...
          var_cas_methodSignature._addAssign_operation (operand_171255->mAttributType, var_cas_inPassingMode) ;
          operand_171255 = operand_171255->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_171059->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4407)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_171684 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_171684 != NULL)) {
          macroValidPointer (operand_171684) ;
          var_cas_methodSignature._addAssign_operation (operand_171684->mAttributType, var_cas_inPassingMode) ;
          operand_171684 = operand_171684->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_171059->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4415))) + (GGS_string (true, "GetIndex"))), operand_171059->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4415)) COMMA_HERE) ;
        ...
        operand_171059 = operand_171059->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_172032 = var_cas_searchMethodList.firstObject () ;
      while ((operand_172032 != NULL)) {
        macroValidPointer (operand_172032) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_172228 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_172228 != NULL)) {
          macroValidPointer (operand_172228) ;
          var_cas_methodSignature._addAssign_operation (operand_172228->mAttributType, var_cas_outPassingMode) ;
          operand_172228 = operand_172228->nextObject () ;
        }
        var_cas_mapModifierMethodMap.modifier_insertKey (_inLexique, operand_172032->mMethodName, var_cas_methodSignature SOURCE_FILE_AT_LINE (4425)) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_172658 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_172658 != NULL)) {
          macroValidPointer (operand_172658) ;
          var_cas_methodSignature._addAssign_operation (operand_172658->mAttributType, var_cas_outPassingMode) ;
          operand_172658 = operand_172658->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (_inLexique, ((operand_172032->mMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4433))) + (GGS_string (true, "GetIndex"))), operand_172032->mMethodName.reader_location (_inLexique SOURCE_FILE_AT_LINE (4433)) COMMA_HERE) ;
        ...
        operand_172032 = operand_172032->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (_inLexique, var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapModifierMethodMap, GGS_mapMethodMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_45 (_inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_174973 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_174973 != NULL)) {
                macroValidPointer (operand_174973) ;
                var_cas_methodSignature._addAssign_operation (operand_174973->mAttributType, var_cas_outPassingMode) ;
                operand_174973 = operand_174973->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4489))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_175517 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_175517 != NULL)) {
                  macroValidPointer (operand_175517) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_175517->mAttributType, var_cas_outPassingMode) ;
                  operand_175517 = operand_175517->nextObject () ;
                }
            ...
            case 3 : {
              ...
              while ((operand_176197 != NULL)) {
                ...
                var_cas_methodSignature._addAssign_operation (operand_176197->mAttributType, var_cas_inPassingMode) ;
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4517))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_176740 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_176740 != NULL)) {
                  macroValidPointer (operand_176740) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_176740->mAttributType, var_cas_inPassingMode) ;
                  operand_176740 = operand_176740->nextObject () ;
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
              var_cas_methodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_177340 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_177340 != NULL)) {
                macroValidPointer (operand_177340) ;
                var_cas_methodSignature._addAssign_operation (operand_177340->mAttributType, var_cas_outPassingMode) ;
                operand_177340 = operand_177340->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (4540))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature._addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_177924 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_177924 != NULL)) {
                  macroValidPointer (operand_177924) ;
                  var_cas_getIndexMethodSignature._addAssign_operation (operand_177924->mAttributType, var_cas_outPassingMode) ;
                  operand_177924 = operand_177924->nextObject () ;
                }
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4003_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_map) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  switch (select_semantics_parser_43 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_ex_map_method_semantics_parser_4568_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomMethode,
...
void semantics_parser::
pr_ex_map_method_semantics_parser_4568_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_error) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_map_method_semantics_parser_4580_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_methodName,
                                GGS_lstring  &var_cas_getIndexMethodName,
                                GGS_lstring  &var_cas_outMessage) {
  _inLexique._assignFromAttribute_tokenString (var_cas_methodName) ;
...
void semantics_parser::
pr_map_method_semantics_parser_4580_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_semantics_parser_47 (_inLexique)) {
    case 1 : {
      } break ;
...
void semantics_parser::
semantics_parser::
pr_message_pattern_semantics_parser_4599_6_ (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_message_pattern_semantics_parser_4599_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        switch (select_semantics_parser_49 (_inLexique)) {
          case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4625_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_typeListeAttributsSemantiques::element_type * operand_181747 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_181747 != NULL)) {
        macroValidPointer (operand_181747) ;
        var_cas_extractSignature._addAssign_operation (operand_181747->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_181747->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_181747 = operand_181747->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4625_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_50 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature ;
      var_cas_inputSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_183986 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_183986 != NULL)) {
        macroValidPointer (operand_183986) ;
        var_cas_extractSignature._addAssign_operation (operand_183986->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        var_cas_inputSignature._addAssign_operation (operand_183986->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
        operand_183986 = operand_183986->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4625_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_list) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  switch (select_semantics_parser_50 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4737_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_51 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature ;
      var_cas_extractSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_186567 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_186567 != NULL)) {
        macroValidPointer (operand_186567) ;
        var_cas_extractSignature._addAssign_operation (operand_186567->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        operand_186567 = operand_186567->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4737_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
  ...
  switch (select_semantics_parser_51 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature ;
      var_cas_extractSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques::element_type * operand_189640 = var_cas_listeTousAttributsSemantiques.firstObject () ;
      while ((operand_189640 != NULL)) {
        macroValidPointer (operand_189640) ;
        var_cas_extractSignature._addAssign_operation (operand_189640->mAttributType, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
        operand_189640 = operand_189640->nextObject () ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasSortedListType::constructor_new (_inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4737_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_sortedlist) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  switch (select_semantics_parser_51 (_inLexique)) {
    case 1 : {
...
void semantics_parser::
semantics_parser::
pr_attributes_definition_list_semantics_parser_4889_6_ (galgas_scanner & _inLexique,
...
void semantics_parser::
pr_attributes_definition_list_semantics_parser_4889_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_54 (_inLexique)) {
        case 2 : {
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4927_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_4927_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_4927_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_extern) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_class) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5200_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5200_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique._assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
}
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5200_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5222_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5222_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_list) COMMA_HERE) ;
  _inLexique._assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5222_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_list) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5247_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5247_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_map) COMMA_HERE) ;
  _inLexique._assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5247_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_map) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5272_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_AC_galgasType  &var_cas_type_semantique,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
...
void semantics_parser::
semantics_parser::
pr_formal_argument_type_semantics_parser_5272_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outGalgasTypeName) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_class) COMMA_HERE) ;
  _inLexique._assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
...
void semantics_parser::
pr_formal_argument_type_semantics_parser_5272_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_class) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5303_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5303_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &/* var_cas_ioModelMap */,
                                GGS_ActionMap  &var_cas_ioExternActionMap,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5303_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_action) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5366_6_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                const GGS_M_optionComponents  &/* var_cas_inOptionsComponentsMapForUse */,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_60 (_inLexique)) {
        case 2 : {
          ...
          GGS_enumConstantMap::element_type * operand_210241 = var_cas_constantMap.firstObject () ;
          while ((operand_210241 != NULL)) {
            macroValidPointer (operand_210241) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_210241->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (5414)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            ...
            operand_210241 = operand_210241->nextObject () ;
          }
...
void semantics_parser::
semantics_parser::
pr_semantics_declaration_semantics_parser_5366_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_ModelMap  &var_cas_ioModelMap,
                                GGS_ActionMap  &/* var_cas_ioExternActionMap */,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeTableNomRoutinesDeclarees  &/* var_cas_tableNomRoutinesDeclarees */,
...
void semantics_parser::
pr_semantics_declaration_semantics_parser_5366_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_enum) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
