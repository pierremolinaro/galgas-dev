    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_57 (_inLexique)) {
        case 2 : {
          ...
          GGS_enumConstantMap::element_type * operand_204261 = var_cas_constantMap.firstObject () ;
          while ((operand_204261 != NULL)) {
            macroValidPointer (operand_204261) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (_inLexique, operand_204261->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (5262)), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            ...
            operand_204261 = operand_204261->nextObject () ;
          }
