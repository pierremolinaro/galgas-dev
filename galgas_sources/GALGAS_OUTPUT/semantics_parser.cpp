...
pr_constant_while_before_in_foreach_instruction_semantics_parser_4894_51_secondPhase (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_51 = true ;
    while (syntaxRepeat_51) {
        ...
        const GGS_AC_galgasType  temp_186928 = var_cas_sourceExpressionType ;
        if (temp_186928.isBuilt ()) {
          temp_186928 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_magicNumber, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (5005)) ;
        }
        GGS_string var_cas_typeName ;
        const GGS_AC_galgasType  temp_187186 = var_cas_sourceExpressionType ;
        if (temp_187186.isBuilt ()) {
          temp_187186 (HERE)->method_getTypeName (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (5014)) ;
        }
        switch (select_semantics_parser_53 (inLexique)) {
          case 1 : {
          ...
          case 2 : {
            ...
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_187723 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_187723 = NULL ;
              while (((operand_187723 = enumerator_187723.nextObject ()))) {
                macroValidPointer (operand_187723) ;
                ...
                if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
                  ...
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_187723->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5035)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_prefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5037))).operator_concat (operand_187723->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5037))), GGS_location (inLexique) COMMA_HERE), operand_187723->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5037)) ;
          ...
          case 3 : {
            ...
            GGS_bool var_cas_firstOne = GGS_bool (true) ;
            {
              GGS_typeListeAttributsSemantiques::cEnumerator enumerator_188483 (var_cas_formalEnumerationList, true) ;
              const GGS_typeListeAttributsSemantiques::cElement * operand_188483 = NULL ;
              while (((operand_188483 = enumerator_188483.nextObject ()))) {
                macroValidPointer (operand_188483) ;
                GGS_typeCplusPlusName  var_cas_cppName ;
                if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
                  var_cas_cppName = GGS_typeKeyName ::constructor_new (inLexique, var_cas_magicNumber, var_cas_iteratorNewStyle COMMA_HERE) ;
                }else{
                  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_magicNumber, operand_188483->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5048)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
                }
                var_cas_ioVariablesMap.modifier_insertUsedConstInArgument (inLexique, GGS_lstring ::constructor_new (inLexique, operand_188483->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5050)), GGS_location (inLexique) COMMA_HERE), operand_188483->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (5050)) ;
                var_cas_firstOne = GGS_bool (false) ;
              }
            }
            } break ;
...
pr_semantic_instruction_semantics_parser_5109_27_ (galgas_scanner & inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_191924 = inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    inLexique.setParsingContext (context_191924) ;
  ...
  switch (select_semantics_parser_57 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_192377 = var_cas_indexVariable ; // CAST instruction
        if (_var_192377.getPtr () != NULL) {
          macroValidPointer (_var_192377.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_192377.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_192377.getPtr ()) ;
  ...
  switch (select_semantics_parser_58 (inLexique)) {
    ...
    case 2 : {
      { const GGS_typeCplusPlusName _var_193144 = var_cas_indexVariable ; // CAST instruction
        if (_var_193144.getPtr () != NULL) {
          macroValidPointer (_var_193144.getPtr ()) ;
          if (typeid (cPtr_typeAutomaticName) == typeid (* (_var_193144.getPtr ()))) {
            const GGS_typeAutomaticName var_cas_a (_var_193144.getPtr ()) ;
...
pr_parse_match_operand_semantics_parser_5219_26_ (galgas_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_195197 = var_cas_type ; // CAST instruction
    if (_var_195197.getPtr () != NULL) {
      macroValidPointer (_var_195197.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_195197.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_t (_var_195197.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (_var_195197.getPtr ()) != NULL) {
        const GGS_typeGalgas_enum var_cas_e (_var_195197.getPtr ()) ;
        ...
        const GGS_AC_galgasType  temp_194961 = var_cas_type ;
        if (temp_194961.isBuilt ()) {
          temp_194961 (HERE)->method_getTypeName (inLexique, var_cas_actualTypeName COMMA_SOURCE_FILE_AT_LINE (5247)) ;
        }
...
pr_parse_match_case_semantics_parser_5257_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_195745 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_195745.isBuilt ()) {
    temp_195745 (HERE)->method_searchKey (inLexique, var_cas_outTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (5270)) ;
  }
...
pr_parse_match_case_semantics_parser_5300_23_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    ...
    const GGS_enumConstantMap  temp_197546 = var_cas_inEnumMessageMap ;
    if (temp_197546.isBuilt ()) {
      temp_197546 (HERE)->method_searchKey (inLexique, var_cas_outEnumConstantName, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (5313)) ;
    }
  }else{
...
pr_optional_assignment_semantics_parser_5513_26_ (galgas_scanner & inLexique,
  ...
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_204949 = var_cas_inVariableType ;
  if (temp_204949.isBuilt ()) {
    temp_204949 (HERE)->method_handleConstructorCall (inLexique, var_cas_constructorName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (5531)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_ioComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_5561_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_61 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_207093 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_207093.isBuilt ()) {
        temp_207093 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5585)) ;
      }
...
pr_semantics_declaration_semantics_parser_5561_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_61 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_theEntity ;
      const GGS_M_semanticsEntitiesForUse  temp_209618 = var_cas_ioComponentSemanticsEntitiesMap ;
      if (temp_209618.isBuilt ()) {
        temp_209618 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (5651)) ;
      }
...
pr_semantics_declaration_semantics_parser_5694_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_63 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_215124 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_215124 = NULL ;
        while (((operand_215124 = enumerator_215124.nextObject ()))) {
          macroValidPointer (operand_215124) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_215301 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_215301 = NULL ;
            while (((operand_215301 = enumerator_215301.nextObject ()))) {
              macroValidPointer (operand_215301) ;
              var_cas_methodSignature.addAssign_operation (operand_215301->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_215124->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5801)) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_215703 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_215703 = NULL ;
            while (((operand_215703 = enumerator_215703.nextObject ()))) {
              macroValidPointer (operand_215703) ;
              var_cas_methodSignature.addAssign_operation (operand_215703->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_215124->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5809))).operator_concat (GGS_string ("GetIndex")), operand_215124->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5809)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_216031 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_216031 = NULL ;
        while (((operand_216031 = enumerator_216031.nextObject ()))) {
          macroValidPointer (operand_216031) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216206 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216206 = NULL ;
            while (((operand_216206 = enumerator_216206.nextObject ()))) {
              macroValidPointer (operand_216206) ;
              var_cas_methodSignature.addAssign_operation (operand_216206->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_216031->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5819)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_216606 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_216606 = NULL ;
            while (((operand_216606 = enumerator_216606.nextObject ()))) {
              macroValidPointer (operand_216606) ;
              var_cas_methodSignature.addAssign_operation (operand_216606->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_216031->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5827))).operator_concat (GGS_string ("GetIndex")), operand_216031->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5827)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_66) {
          switch (select_repeat_semantics_parser_66 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_219979 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_219979 = NULL ;
                while (((operand_219979 = enumerator_219979.nextObject ()))) {
                  macroValidPointer (operand_219979) ;
                  var_cas_methodSignature.addAssign_operation (operand_219979->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5906))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_220533 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_220533 = NULL ;
                  while (((operand_220533 = enumerator_220533.nextObject ()))) {
                    macroValidPointer (operand_220533) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_220533->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_221594 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_221594 = NULL ;
                while (((operand_221594 = enumerator_221594.nextObject ()))) {
                  macroValidPointer (operand_221594) ;
                  var_cas_methodSignature.addAssign_operation (operand_221594->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5943))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222163 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_222163 = NULL ;
                  while (((operand_222163 = enumerator_222163.nextObject ()))) {
                    macroValidPointer (operand_222163) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_222163->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_222910 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_222910 = NULL ;
                while (((operand_222910 = enumerator_222910.nextObject ()))) {
                  macroValidPointer (operand_222910) ;
                  var_cas_methodSignature.addAssign_operation (operand_222910->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5970))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_223494 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_223494 = NULL ;
                  while (((operand_223494 = enumerator_223494.nextObject ()))) {
                    macroValidPointer (operand_223494) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_223494->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_223860 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_223860 = NULL ;
        while (((operand_223860 = enumerator_223860.nextObject ()))) {
          macroValidPointer (operand_223860) ;
          if ((operand_223860->mInfo.mHasSetter).isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_223860->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5984)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (5984)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_223860->mInfo.mAttributType, var_cas_inPassingMode) ;
...
pr_semantics_declaration_semantics_parser_5694_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_63 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType = GGS_typeGalgas_luint ::constructor_new (inLexique COMMA_HERE) ;
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_228697 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_228697 = NULL ;
        while (((operand_228697 = enumerator_228697.nextObject ()))) {
          macroValidPointer (operand_228697) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228874 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_228874 = NULL ;
            while (((operand_228874 = enumerator_228874.nextObject ()))) {
              macroValidPointer (operand_228874) ;
              var_cas_methodSignature.addAssign_operation (operand_228874->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_228697->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6120)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229276 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_229276 = NULL ;
            while (((operand_229276 = enumerator_229276.nextObject ()))) {
              macroValidPointer (operand_229276) ;
              var_cas_methodSignature.addAssign_operation (operand_229276->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_228697->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6128))).operator_concat (GGS_string ("GetIndex")), operand_228697->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6128)) COMMA_HERE) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_229604 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_229604 = NULL ;
        while (((operand_229604 = enumerator_229604.nextObject ()))) {
          macroValidPointer (operand_229604) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_229781 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_229781 = NULL ;
            while (((operand_229781 = enumerator_229781.nextObject ()))) {
              macroValidPointer (operand_229781) ;
              var_cas_methodSignature.addAssign_operation (operand_229781->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_229604->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6138)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_230184 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_230184 = NULL ;
            while (((operand_230184 = enumerator_230184.nextObject ()))) {
              macroValidPointer (operand_230184) ;
              var_cas_methodSignature.addAssign_operation (operand_230184->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_229604->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6146))).operator_concat (GGS_string ("GetIndex")), operand_229604->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6146)) COMMA_HERE) ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat_66) {
          switch (select_repeat_semantics_parser_66 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_232522 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_232522 = NULL ;
                while (((operand_232522 = enumerator_232522.nextObject ()))) {
                  macroValidPointer (operand_232522) ;
                  var_cas_methodSignature.addAssign_operation (operand_232522->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6209))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_233032 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_233032 = NULL ;
                  while (((operand_233032 = enumerator_233032.nextObject ()))) {
                    macroValidPointer (operand_233032) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_233032->mAttributType, var_cas_outPassingMode) ;
                  }
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_233678 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_233678 = NULL ;
                while (((operand_233678 = enumerator_233678.nextObject ()))) {
                  macroValidPointer (operand_233678) ;
                  var_cas_methodSignature.addAssign_operation (operand_233678->mAttributType, var_cas_inPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6237))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234187 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_234187 = NULL ;
                  while (((operand_234187 = enumerator_234187.nextObject ()))) {
                    macroValidPointer (operand_234187) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_234187->mAttributType, var_cas_inPassingMode) ;
                  }
                }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_234753 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_234753 = NULL ;
                while (((operand_234753 = enumerator_234753.nextObject ()))) {
                  macroValidPointer (operand_234753) ;
                  var_cas_methodSignature.addAssign_operation (operand_234753->mAttributType, var_cas_outPassingMode) ;
                }
              }
              ...
              if (((var_cas_getIndexMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6260))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_235303 (var_cas_listeTousAttributsSemantiques, true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_235303 = NULL ;
                  while (((operand_235303 = enumerator_235303.nextObject ()))) {
                    macroValidPointer (operand_235303) ;
                    var_cas_getIndexMethodSignature.addAssign_operation (operand_235303->mAttributType, var_cas_outPassingMode) ;
                  }
                }
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_235587 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_235587 = NULL ;
        while (((operand_235587 = enumerator_235587.nextObject ()))) {
          macroValidPointer (operand_235587) ;
          if ((operand_235587->mInfo.mHasSetter).isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_235587->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6273)).reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (6273)))).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_235587->mInfo.mAttributType, var_cas_inPassingMode) ;
            var_cas_modifierSignature.addAssign_operation (GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_inPassingMode) ;
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6333_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_238999 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_238999.isBuilt ()) {
    temp_238999 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6363)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_239468 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_239468 = NULL ;
    while (((operand_239468 = enumerator_239468.nextObject ()))) {
      macroValidPointer (operand_239468) ;
      GGS_string var_cas_keyClassMethod = ((operand_239468->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6371))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6371))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6372)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6372))).isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_239468->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6375)) ;
      }
    }
  }
...
pr_semantics_declaration_semantics_parser_6429_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_243316 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_243316.isBuilt ()) {
    temp_243316 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6465)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_243910 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_243910 = NULL ;
      while (((operand_243910 = enumerator_243910.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_243910) ;
        GGS_string var_cas_keyClassMethod = ((operand_243910->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6475))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6475))) ;
        var_cas_baseClassName = operand_243910->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6476)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          ...
          const GGS_EXcategoryMethodMap  temp_244315 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6481)) ;
          if (temp_244315.isBuilt ()) {
            temp_244315 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6481)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_244943 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_244943 = NULL ;
      while (((operand_244943 = enumerator_244943.nextObject ()))) {
        macroValidPointer (operand_244943) ;
        GGS_string var_cas_keyClassMethod = ((operand_244943->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6496))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6496))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6497)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6497))).isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_244943->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6500)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245400 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6505)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_245400 = NULL ;
    while (((operand_245400 = enumerator_245400.nextObject ()))) {
      macroValidPointer (operand_245400) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6507)), operand_245400->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6508)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_245400->mAttributeName, operand_245400->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6512)) ;
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6589_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_249837 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_249837.isBuilt ()) {
    temp_249837 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6621)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_250362 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_250362.isBuilt ()) {
    temp_250362 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6627)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_250831 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_250831 = NULL ;
    while (((operand_250831 = enumerator_250831.nextObject ()))) {
      macroValidPointer (operand_250831) ;
      GGS_string var_cas_keyClassMethod = ((operand_250831->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6635))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6635))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6636)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6636))).isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_250831->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6639)) ;
      }
    }
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6589_50_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_252737 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_252737.isBuilt ()) {
    temp_252737 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6687)) ;
  }
...
pr_semantics_declaration_semantics_parser_6703_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_255026 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_255026.isBuilt ()) {
    temp_255026 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6739)) ;
  }
  ...
  const GGS_M_semanticsEntitiesForUse  temp_255904 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_255904.isBuilt ()) {
    temp_255904 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6749)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_256498 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_256498 = NULL ;
      while (((operand_256498 = enumerator_256498.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_256498) ;
        GGS_string var_cas_keyClassMethod = ((operand_256498->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6759))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6759))) ;
        var_cas_baseClassName = operand_256498->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6760)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          ...
          const GGS_EXcategoryReaderMap  temp_256960 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6766)) ;
          if (temp_256960.isBuilt ()) {
            temp_256960 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (6766)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_257874 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_257874 = NULL ;
      while (((operand_257874 = enumerator_257874.nextObject ()))) {
        macroValidPointer (operand_257874) ;
        GGS_string var_cas_keyClassMethod = ((operand_257874->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6792))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6792))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6793)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6793))).isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_257874->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6796)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_258331 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (6801)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_258331 = NULL ;
    while (((operand_258331 = enumerator_258331.nextObject ()))) {
      macroValidPointer (operand_258331) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6803)), operand_258331->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6804)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_258331->mAttributeName, operand_258331->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (6808)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_6703_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_260824 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_260824.isBuilt ()) {
    temp_260824 (HERE)->method_searchKey (inLexique, var_cas_returnedTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6874)) ;
  }
...
pr_semantics_declaration_beginning_by_abstract_semantics_parser_6895_50_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_263285 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_263285.isBuilt ()) {
    temp_263285 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (6926)) ;
  }
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_263754 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_263754 = NULL ;
    while (((operand_263754 = enumerator_263754.nextObject ()))) {
      macroValidPointer (operand_263754) ;
      GGS_string var_cas_keyClassMethod = ((operand_263754->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6934))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6934))) ;
      if ((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6935)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (6935))).isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_263754->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6938)) ;
      }
    }
  }
...
pr_semantics_declaration_semantics_parser_6992_28_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_theEntity ;
  const GGS_M_semanticsEntitiesForUse  temp_267750 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_267750.isBuilt ()) {
    temp_267750 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (7029)) ;
  }
  ...
  if (((var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_268344 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_268344 = NULL ;
      while (((operand_268344 = enumerator_268344.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_268344) ;
        GGS_string var_cas_keyClassMethod = ((operand_268344->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7039))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7039))) ;
        var_cas_baseClassName = operand_268344->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7040)) ;
        ...
        if ((var_cas_found).isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_268755 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7045)) ;
          if (temp_268755.isBuilt ()) {
            temp_268755 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_HERE), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7045)) ;
          }
    ...
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_269448 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_269448 = NULL ;
      while (((operand_269448 = enumerator_269448.nextObject ()))) {
        macroValidPointer (operand_269448) ;
        GGS_string var_cas_keyClassMethod = ((operand_269448->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7064))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7064))) ;
        if ((var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7065)).reader_hasKey (inLexique, var_cas_keyClassMethod COMMA_SOURCE_FILE_AT_LINE (7065))).isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_269448->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7068)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_269913 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_269913 = NULL ;
    while (((operand_269913 = enumerator_269913.nextObject ()))) {
      macroValidPointer (operand_269913) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7075)), operand_269913->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7076)), GGS_bool (false), GGS_bool (false) COMMA_HERE) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_269913->mAttributeName, operand_269913->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7080)) ;
    }
  }
...
pr_semantics_declaration_semantics_parser_7166_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_73 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_274660 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_274660 = NULL ;
        while (((operand_274660 = enumerator_274660.nextObject ()))) {
          macroValidPointer (operand_274660) ;
          var_cas_extractSignature.addAssign_operation (operand_274660->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_274660->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7166_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_73 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276797 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_276797 = NULL ;
        while (((operand_276797 = enumerator_276797.nextObject ()))) {
          macroValidPointer (operand_276797) ;
          var_cas_extractSignature.addAssign_operation (operand_276797->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
          var_cas_inputSignature.addAssign_operation (operand_276797->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentIn (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature, var_cas_inputSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7281_28_ (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_279303 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_279303 = NULL ;
        while (((operand_279303 = enumerator_279303.nextObject ()))) {
          macroValidPointer (operand_279303) ;
          var_cas_extractSignature.addAssign_operation (operand_279303->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_75 = true ;
        while (syntaxRepeat_75) {
            ...
            if ((var_cas_usedSortedAttributes.reader_hasKey (inLexique, var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7332)) COMMA_SOURCE_FILE_AT_LINE (7332))).isBuiltAndTrue ()) {
              ...
              const GGS_typeSemanticAttributesMap  temp_280067 = var_cas_tableAttributs ;
              if (temp_280067.isBuilt ()) {
                temp_280067 (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_34, automatic_var_35 COMMA_SOURCE_FILE_AT_LINE (7336)) ;
              }
              const GGS_AC_galgasType  temp_280171 = var_cas_definitionType ;
              if (temp_280171.isBuilt ()) {
                temp_280171 (HERE)->method_acceptToBeSortKeyInSortedListDefinition (inLexique, var_cas_sortAttribute COMMA_SOURCE_FILE_AT_LINE (7337)) ;
              }
...
pr_semantics_declaration_semantics_parser_7281_28_importSemantics (galgas_scanner & inLexique,
  ...
  switch (select_semantics_parser_74 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_282264 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_282264 = NULL ;
        while (((operand_282264 = enumerator_282264.nextObject ()))) {
          macroValidPointer (operand_282264) ;
          var_cas_extractSignature.addAssign_operation (operand_282264->mAttributType, GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D_) COMMA_HERE) ;
      GGS_AC_galgasType  var_cas_c = GGS_typeGalgasSortedListType ::constructor_new (inLexique, var_cas_listTypeName, var_cas_listeTousAttributsSemantiques, var_cas_extractSignature COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_7495_28_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_286433 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_286433.isBuilt ()) {
    temp_286433 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7512)) ;
  }
...
pr_semantics_declaration_semantics_parser_7495_28_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_287714 = var_cas_ioComponentSemanticsEntitiesMap ;
  if (temp_287714.isBuilt ()) {
    temp_287714 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (7546)) ;
  }
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_292450 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_292450 = NULL ;
    while (((operand_292450 = enumerator_292450.nextObject ()))) {
      macroValidPointer (operand_292450) ;
      if ((var_cas_inExtensionMap.reader_hasKey (inLexique, operand_292450->mValue.reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (7664)) COMMA_SOURCE_FILE_AT_LINE (7664))).isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_292450->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_292450->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_292450->mValue), GGS_location (inLexique) COMMA_HERE), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (7673)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_293192 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_293192 = NULL ;
    while (((operand_293192 = enumerator_293192.nextObject ()))) {
      macroValidPointer (operand_293192) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_293192->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_293192->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (7688)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_293192->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
pr_formal_argument_type_semantics_parser_8255_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8262)) COMMA_SOURCE_FILE_AT_LINE (8262))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_312868 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_312868.isBuilt ()) {
      temp_312868 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8264)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_313060 = var_cas_tableEnAvant ;
    if (temp_313060.isBuilt ()) {
      temp_313060 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8267)) ;
    }
  }
}
...
pr_formal_argument_type_semantics_parser_8277_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8285)) COMMA_SOURCE_FILE_AT_LINE (8285))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_313701 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_313701.isBuilt ()) {
      temp_313701 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8287)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_313893 = var_cas_tableEnAvant ;
    if (temp_313893.isBuilt ()) {
      temp_313893 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8290)) ;
    }
...
pr_formal_argument_type_semantics_parser_8302_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8310)) COMMA_SOURCE_FILE_AT_LINE (8310))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_314671 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_314671.isBuilt ()) {
      temp_314671 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8312)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_314863 = var_cas_tableEnAvant ;
    if (temp_314863.isBuilt ()) {
      temp_314863 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8315)) ;
    }
...
pr_formal_argument_type_semantics_parser_8327_27_ (galgas_scanner & inLexique,
  ...
  if ((var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (inLexique, var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8336)) COMMA_SOURCE_FILE_AT_LINE (8336))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    const GGS_M_semanticsEntitiesForUse  temp_315656 = var_cas_inComponentSemanticsEntitiesMap ;
    if (temp_315656.isBuilt ()) {
      temp_315656 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (8338)) ;
    }
    ...
    const GGS_typeTableEnAvant  temp_315848 = var_cas_tableEnAvant ;
    if (temp_315848.isBuilt ()) {
      temp_315848 (HERE)->method_searchKey (inLexique, var_cas_outGalgasTypeName, var_cas_type_semantique COMMA_SOURCE_FILE_AT_LINE (8341)) ;
    }
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8422_47_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_319995 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_319995 = NULL ;
    while (((operand_319995 = enumerator_319995.nextObject ()))) {
      macroValidPointer (operand_319995) ;
      if (((operand_319995->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_319995->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8451)) ;
      }else if (((operand_319995->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_319995->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8453)) ;
      }
    }
  }
  GGS_EXformalArgumentPassingMode var_cas_passingMode = GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE) ;
...
pr_semantics_declaration_begining_by_extern_semantics_parser_8422_47_importSemantics (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_322254 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_322254 = NULL ;
    while (((operand_322254 = enumerator_322254.nextObject ()))) {
      macroValidPointer (operand_322254) ;
      if (((operand_322254->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_322254->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8505)) ;
      }else if (((operand_322254->mFormalArgumentPassingMode).operator_isEqual (GGS_EXformalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        operand_322254->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8507)) ;
      }
    }
  }
  GGS_EXformalArgumentPassingMode var_cas_passingMode = GGS_EXformalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE) ;
    ...
    while (syntaxRepeat_92) {
      switch (select_repeat_semantics_parser_92 (inLexique)) {
        case 2 : {
          ...
          { bool syntaxRepeat_95 = true ;
            while (syntaxRepeat_95) {
                ...
                const GGS_enumConstantMap  temp_326784 = var_cas_constantMap ;
                if (temp_326784.isBuilt ()) {
                  temp_326784 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_38 COMMA_SOURCE_FILE_AT_LINE (8617)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_326977 = var_cas_constantMap ;
                if (temp_326977.isBuilt ()) {
                  temp_326977 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_39 COMMA_SOURCE_FILE_AT_LINE (8622)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                ...
                const GGS_enumConstantMap  temp_327176 = var_cas_constantMap ;
                if (temp_327176.isBuilt ()) {
                  temp_327176 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (8627)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_99 = true ;
            while (syntaxRepeat_99) {
                ...
                const GGS_enumConstantMap  temp_329823 = var_cas_constantMap ;
                if (temp_329823.isBuilt ()) {
                  temp_329823 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_41 COMMA_SOURCE_FILE_AT_LINE (8700)) ;
                }
                ...
                const GGS_enumConstantMap  temp_329996 = var_cas_constantMap ;
                if (temp_329996.isBuilt ()) {
                  temp_329996 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_42 COMMA_SOURCE_FILE_AT_LINE (8705)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_330729 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_330729 = NULL ;
            while (((operand_330729 = enumerator_330729.nextObject ()))) {
              macroValidPointer (operand_330729) ;
              if (((var_cas_definedSourceMap.reader_hasKey (inLexique, operand_330729->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8731)) COMMA_SOURCE_FILE_AT_LINE (8731))).operator_not ()).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_330729->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8732)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8733)) ;
              }
            }
          }
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_103 = true ;
            while (syntaxRepeat_103) {
                ...
                const GGS_enumConstantMap  temp_332726 = var_cas_constantMap ;
                if (temp_332726.isBuilt ()) {
                  temp_332726 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_43 COMMA_SOURCE_FILE_AT_LINE (8777)) ;
                }
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_333498 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_333498 = NULL ;
            while (((operand_333498 = enumerator_333498.nextObject ()))) {
              macroValidPointer (operand_333498) ;
              if (((var_cas_definedSourceMap.reader_hasKey (inLexique, operand_333498->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8804)) COMMA_SOURCE_FILE_AT_LINE (8804))).operator_not ()).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (operand_333498->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8805)))).operator_concat (GGS_string ("' is not handled")) COMMA_SOURCE_FILE_AT_LINE (8806)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_334335 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_334335 = NULL ;
            while (((operand_334335 = enumerator_334335.nextObject ()))) {
              macroValidPointer (operand_334335) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_334335->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8833)), GGS_location (inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cstString ;
              const GGS_typeEnumCstMessageStringMap  temp_334462 = var_cas_cstMessageStringMap ;
              if (temp_334462.isBuilt ()) {
                temp_334462 (HERE)->method_searchKey (inLexique, var_cas_name, var_cas_cstString COMMA_SOURCE_FILE_AT_LINE (8835)) ;
              }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_95 = true ;
            while (syntaxRepeat_95) {
                ...
                const GGS_enumConstantMap  temp_338181 = var_cas_constantMap ;
                if (temp_338181.isBuilt ()) {
                  temp_338181 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_leftConstant, var_cas_leftConstantIndex, automatic_var_44 COMMA_SOURCE_FILE_AT_LINE (8946)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                GGS_lstring  var_cas_rightConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_rightConstant) ;
                ...
                const GGS_enumConstantMap  temp_338374 = var_cas_constantMap ;
                if (temp_338374.isBuilt ()) {
                  temp_338374 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_rightConstant, var_cas_rightConstantIndex, automatic_var_45 COMMA_SOURCE_FILE_AT_LINE (8951)) ;
                }
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D__3E_) COMMA_HERE) ;
                GGS_lstring  var_cas_targetConstant ;
                inLexique.assignFromAttribute_tokenString (var_cas_targetConstant) ;
                ...
                const GGS_enumConstantMap  temp_338573 = var_cas_constantMap ;
                if (temp_338573.isBuilt ()) {
                  temp_338573 (HERE)->method_searchKeyAndGetIndex (inLexique, var_cas_targetConstant, var_cas_targetConstantIndex, automatic_var_46 COMMA_SOURCE_FILE_AT_LINE (8956)) ;
                }
                GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
                switch (select_semantics_parser_96 (inLexique)) {
                  case 1 : {
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_99 = true ;
            while (syntaxRepeat_99) {
                ...
                const GGS_enumConstantMap  temp_339915 = var_cas_constantMap ;
                if (temp_339915.isBuilt ()) {
                  temp_339915 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_47 COMMA_SOURCE_FILE_AT_LINE (9003)) ;
                }
                ...
                const GGS_enumConstantMap  temp_340088 = var_cas_constantMap ;
                if (temp_340088.isBuilt ()) {
                  temp_340088 (HERE)->method_searchKey (inLexique, var_cas_targetName, automatic_var_48 COMMA_SOURCE_FILE_AT_LINE (9008)) ;
                }
                switch (select_semantics_parser_100 (inLexique)) {
                  case 1 : {
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          { bool syntaxRepeat_103 = true ;
            while (syntaxRepeat_103) {
                ...
                const GGS_enumConstantMap  temp_341239 = var_cas_constantMap ;
                if (temp_341239.isBuilt ()) {
                  temp_341239 (HERE)->method_searchKey (inLexique, var_cas_sourceName, automatic_var_49 COMMA_SOURCE_FILE_AT_LINE (9047)) ;
                }
