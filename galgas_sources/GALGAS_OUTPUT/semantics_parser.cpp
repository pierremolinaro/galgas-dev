...
pr_semantic_instruction_semantics_parser_2650_28_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioConstraintPropertyDefinitionSet.reader_hasKey (var_cas_calledPropertyName.reader_value ())).isBuiltAndTrue ()) {
      var_cas_calledPropertyName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this property has been already initialized") SOURCE_FILE_AT_LINE (2670)) ;
  }else{
  ...
  if ((var_cas_ioCallInstructionSharedPropertySignatureMap.reader_hasKey (var_cas_calledPropertyName.reader_value ())).isBuiltAndTrue ()) {
    ...
    if (((var_cas_previousParameterTypeList.reader_length ()) == (var_cas_parameterTypeList.reader_length ())).isBuiltAndTrue ()) {
      ...
      while ((operand_104921 != NULL)
        ...
        if (((operand_104921->mSharedPropertyTypeName.reader_value ()) != (operand_104989->mSharedPropertyTypeName.reader_value ())).isBuiltAndTrue ()) {
            operand_104989->mSharedPropertyName.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this shared property has '@")) + (operand_104989->mSharedPropertyTypeName.reader_value ()))) + (GGS_string (true, "' type, while a previous call has named an attribute of type '@")))) + (operand_104921->mSharedPropertyTypeName.reader_value ()))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2702)) ;
        }
        operand_104921 = operand_104921->nextObject () ;
        operand_104989 = operand_104989->nextObject () ;
      }
    }else{
        var_cas_previousParameterTypeListLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "this instruction names ")) + (var_cas_parameterTypeList.reader_length ().reader_string ()))) + (GGS_string (true, " shared parameter(s), while a previous call has named ")))) + (var_cas_previousParameterTypeList.reader_length ().reader_string ()))) + (GGS_string (true, " parameter(s)"))) SOURCE_FILE_AT_LINE (2708)) ;
    }
  }else{
...
pr_extract_instruction_semantics_parser_2780_27_ (galgas_scanner & _inLexique,
  ...
  if (((! (var_cas_tableDesClassesAncetres.reader_hasKey (var_cas_nomTypeSource.reader_value ())))).isBuiltAndTrue ()) {
      var_cas_nomClasse.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_value ()))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2817)) ;
  }
  GGS_L_assignedVariables  var_cas_listeAffectationParametresEffectifs ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (var_cas_nomTypeSource.reader_value ())))).isBuiltAndTrue ()) {
            var_cas_nomType1.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This class does not inherit from '@")) + (var_cas_nomTypeSource.reader_value ()))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2903)) ;
        }
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      ...
      if (var_cas_type.isBuilt ()) {
        ...
        var_cas_variableName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '@")) + (var_cas_actualTypeName))) + (GGS_string (true, "' ; I was expected an enumeration type or an abstract type"))) SOURCE_FILE_AT_LINE (3722)) ;
    }
  }
}
...
pr_parse_match_case_semantics_parser_3730_24_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
      var_cas_outTypeName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class is not allowed here") SOURCE_FILE_AT_LINE (3761)) ;
  }
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
      var_cas_outTypeName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a constant of '@")) + (var_cas_inTypeName.reader_value ()))) + (GGS_string (true, "' enumeration type is expected here"))) SOURCE_FILE_AT_LINE (3765)) ;
  }else if (((! (var_cas_tableDesClassesAncetresType1.reader_hasKey (var_cas_inTypeName.reader_value ())))).isBuiltAndTrue ()) {
      var_cas_outTypeName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This type does not inherit from '")) + (var_cas_inTypeName.reader_value ()))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (3767)) ;
  }
...
pr_parse_match_case_semantics_parser_3780_24_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inIsEnumeration).isBuiltAndTrue ()) {
    var_cas_inEnumMessageMap.methode_searchKey (_inLexique, var_cas_outEnumConstantName SOURCE_FILE_AT_LINE (3793)) ;
      ...
      var_cas_outEnumConstantName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a class that inherit from '@")) + (var_cas_inTypeName.reader_value ()))) + (GGS_string (true, "' abstract class is expected here"))) SOURCE_FILE_AT_LINE (3795)) ;
  }
}
  ...
  switch (select_semantics_parser_37 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_cppClassName.defineAttribute (_inLexique.tokenString, _inLexique) ;
        var_cas_cppClassName.reader_location ().signalGGSSemanticWarning (_inLexique, GGS_string (true, "old style map definition") SOURCE_FILE_AT_LINE (4074)) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      ...
      while ((operand_160921 != NULL)) {
        ...
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_160921->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_160921->mMethodName.reader_location () COMMA_HERE) ;
      ...
      while ((operand_161875 != NULL)) {
        ...
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_161875->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_161875->mMethodName.reader_location () COMMA_HERE) ;
  ...
  switch (select_semantics_parser_37 (_inLexique)) {
    ...
    case 2 : {
      ...
      while ((operand_172475 != NULL)) {
        ...
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_172475->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_172475->mMethodName.reader_location () COMMA_HERE) ;
      ...
      while ((operand_173429 != NULL)) {
        ...
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_173429->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_173429->mMethodName.reader_location () COMMA_HERE) ;
          ...
          switch (select_semantics_parser_47 (_inLexique)) {
            ...
            case 2 : {
              ...
              if ((var_cas_acceptAddAssignOperatorCall).isBuiltAndTrue ()) {
                  var_cas_errorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (4830)) ;
              }else{
          ...
          switch (select_semantics_parser_47 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_addAssignFormalInputArgumentList.reader_length ()) > (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "'+=' operator is already defined") SOURCE_FILE_AT_LINE (4955)) ;
              }else{
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true, true) ;
              }
              { bool syntaxRepeat = true ;
      ...
      switch (select_repeat_semantics_parser_50 (_inLexique)) {
        case 2 : {
          ...
          while ((operand_203849 != NULL)) {
            ...
            var_cas_name = GGS_lstring::constructor_new (operand_203849->mKey.reader_value (), GGS_location (_inLexique) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
