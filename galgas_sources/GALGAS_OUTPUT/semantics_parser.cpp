...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_templateVariableMap  var_cas_categoryTemplateVariableMap = GGS_templateVariableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7527)) ;
  ...
  const GGS_bool cond_287855 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7539))) ;
  if (cond_287855.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_286826 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_286826 = NULL ;
      while (((operand_286826 = enumerator_286826.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_286826) ;
        GGS_string var_cas_keyClassMethod = ((operand_286826->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))) ;
        var_cas_baseClassName = operand_286826->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7544)) ;
        ...
        const GGS_bool cond_287631 = var_cas_found ;
        if (cond_287631.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_287239 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          if (temp_287239.isBuilt ()) {
            temp_287239 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7550)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          }
    ...
    const GGS_bool cond_287843 = (var_cas_found).operator_not () ;
    if (cond_287843.isBuiltAndTrue ()) {
  ...
  }else if (cond_287855.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_287932 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_287932 = NULL ;
      while (((operand_287932 = enumerator_287932.nextObject ()))) {
        macroValidPointer (operand_287932) ;
        GGS_string var_cas_keyClassMethod = ((operand_287932->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))) ;
        const GGS_bool cond_288246 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7569)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_288246.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_287932->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7572)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_288399 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7577)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_288399 = NULL ;
    while (((operand_288399 = enumerator_288399.nextObject ()))) {
      macroValidPointer (operand_288399) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7579)), operand_288399->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7580)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7578)) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_288399->mAttributeName, operand_288399->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7584)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_291213 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)))).operator_not () ;
  if (cond_291213.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_292521 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687))))).operator_not () ;
      if (cond_292521.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_293213 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_293213 = NULL ;
        while (((operand_293213 = enumerator_293213.nextObject ()))) {
          macroValidPointer (operand_293213) ;
          var_cas_extractSignature.addAssign_operation (operand_293213->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7709))) ;
          var_cas_inputSignature.addAssign_operation (operand_293213->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7710))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_83 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_294660 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742))))).operator_not () ;
      if (cond_294660.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_295352 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_295352 = NULL ;
        while (((operand_295352 = enumerator_295352.nextObject ()))) {
          macroValidPointer (operand_295352) ;
          var_cas_extractSignature.addAssign_operation (operand_295352->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7764))) ;
          var_cas_inputSignature.addAssign_operation (operand_295352->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7765))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_297216 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802))))).operator_not () ;
      if (cond_297216.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_297860 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_297860 = NULL ;
        while (((operand_297860 = enumerator_297860.nextObject ()))) {
          macroValidPointer (operand_297860) ;
          var_cas_extractSignature.addAssign_operation (operand_297860->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7823))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_85 = true ;
        while (syntaxRepeat_85) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_298551 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7839))) ;
            if (cond_298551.isBuiltAndTrue ()) {
            ...
            }else if (cond_298551.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_298663_0 ;
              GGS_bool automatic_var_298663_1 ;
              if (var_cas_tableAttributs.isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_298663_0, automatic_var_298663_1 COMMA_SOURCE_FILE_AT_LINE (7843)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_300178 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883))))).operator_not () ;
      if (cond_300178.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_300822 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_300822 = NULL ;
        while (((operand_300822 = enumerator_300822.nextObject ()))) {
          macroValidPointer (operand_300822) ;
          var_cas_extractSignature.addAssign_operation (operand_300822->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7904))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_89 = true ;
                while (syntaxRepeat_89) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_303260 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7971))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_303260.isBuiltAndTrue ()) {
                      const GGS_bool cond_303210 = (var_cas_hasGetter).operator_not () ;
                      if (cond_303210.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_303260.isBuiltAndFalse ()) {
                      const GGS_bool cond_303462 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7976))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_303462.isBuiltAndTrue ()) {
                        const GGS_bool cond_303414 = var_cas_hasSetter ;
                        if (cond_303414.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_303462.isBuiltAndFalse ()) {
...
void routine_recursivelyEnumerateDirectoriesEX (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311021 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_311021 = NULL ;
    while (((operand_311021 = enumerator_311021.nextObject ()))) {
      macroValidPointer (operand_311021) ;
      const GGS_bool cond_311528 = var_cas_inExtensionMap.reader_hasKey (operand_311021->mValue.reader_pathExtension ()) ;
      if (cond_311528.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311021->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_311021->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_311021->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8181)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (8180)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311765 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_311765 = NULL ;
    while (((operand_311765 = enumerator_311765.nextObject ()))) {
      macroValidPointer (operand_311765) ;
      ...
      ::routine_recursivelyEnumerateDirectoriesEX (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311765->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_311765->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (8195)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_311765->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_313558 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_313558.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8248)) ;
  }else if (cond_313558.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_313838 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_313838.isBuiltAndTrue ()) {
  ...
  }else if (cond_313838.isBuiltAndFalse ()) {
    ...
    while (syntaxRepeat_92) {
      switch (select_semantics_5F_parser_92 (inLexique)) {
        case 2 : {
          ...
          GGS_templateVariableMap  var_cas_templateVariableMap = GGS_templateVariableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (8299)) ;
            ...
            while (syntaxRepeat_93) {
              switch (select_semantics_5F_parser_93 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_316166 = var_cas_parameterIsUsed ;
                  if (cond_316166.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_316166.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_318897 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)))).operator_not () ;
  if (cond_318897.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_318103 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_318103.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8385)) ;
    }else if (cond_318103.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_318393 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_318393.isBuiltAndTrue ()) {
    ...
    }else if (cond_318393.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedListEX  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedListEX  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_319956 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)))).operator_not () ;
  if (cond_319956.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_325566 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_325566.isBuiltAndTrue ()) {
              ...
              }else if (cond_325566.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_95 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_97 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_329823 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_329823.isBuiltAndTrue ()) {
              ...
              }else if (cond_329823.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_98 = true ;
                while (syntaxRepeat_98) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i79_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_331755 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8772))) ;
  if (cond_331755.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_331755.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i80_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_332588 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8795))) ;
  if (cond_332588.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_332588.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_333558 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8820))) ;
  if (cond_333558.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_333558.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_334543 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8846))) ;
  if (cond_334543.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_334543.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_336089_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_336089_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_338551_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_338551_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_338760 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_338760 = NULL ;
    while (((operand_338760 = enumerator_338760.nextObject ()))) {
      macroValidPointer (operand_338760) ;
      const GGS_bool cond_338979 = (operand_338760->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8959))) ;
      if (cond_338979.isBuiltAndTrue ()) {
        operand_338760->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8961)) ;
      }else if (cond_338979.isBuiltAndFalse ()) {
        const GGS_bool cond_339188 = (operand_338760->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8961))) ;
        if (cond_339188.isBuiltAndTrue ()) {
          operand_338760->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8963)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_341039 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_341039 = NULL ;
    while (((operand_341039 = enumerator_341039.nextObject ()))) {
      macroValidPointer (operand_341039) ;
      const GGS_bool cond_341258 = (operand_341039->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9013))) ;
      if (cond_341258.isBuiltAndTrue ()) {
        operand_341039->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9015)) ;
      }else if (cond_341258.isBuiltAndFalse ()) {
        const GGS_bool cond_341467 = (operand_341039->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9015))) ;
        if (cond_341467.isBuiltAndTrue ()) {
          operand_341039->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9017)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_99 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_enumConstantMap::cEnumerator enumerator_343763 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_343763 = enumerator_343763.nextObject () ;
        if ((operand_343763 != NULL)) {
          bool _foreach_loop_343763 ;
          do{
            macroValidPointer (operand_343763) ;
            var_cas_s.dotAssign_operation (operand_343763->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9084))) ;
            operand_343763 = enumerator_343763.nextObject () ;
            _foreach_loop_343763 = ((operand_343763 != NULL)) ;
            if (_foreach_loop_343763) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_343763) ;
        }
      }
    ...
    while (syntaxRepeat_103) {
      switch (select_semantics_5F_parser_103 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_344583 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_344583 = NULL ;
            while (((operand_344583 = enumerator_344583.nextObject ()))) {
              macroValidPointer (operand_344583) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_344583->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9116)), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (9116)) ;
              GGS_lstring  var_cas_cstString ;
