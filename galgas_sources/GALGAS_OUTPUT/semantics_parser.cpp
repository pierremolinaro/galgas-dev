          ...
          switch (select_semantics_parser_2 (lexique_var_)) {
            ...
            case 2 : {
              ...
              while ((operand_26129 != NULL)) {
                ...
                while ((operand_26257 != NULL)) {
                  ...
                  var_cas_ioComponentSemanticsEntitiesMap.methode_searchKey (lexique_var_, operand_26257->mGalgasTypeName, var_cas_e) ;
            ...
            case 3 : {
              ...
              if (((! var_cas_outImportedSemanticsComponents.reader_hasKey (var_cas_componentName.reader_value ()))).isBuiltAndTrue ()) {
                ...
                GGS_ModelMap  var_cas_27766 ;
                GGS_ActionMap  var_cas_27769 ;
                GGS_stringset  var_cas_27772 ;
                GGS_stringset  var_cas_27775 ;
                var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_componentName, var_cas_27766, var_cas_27769, var_cas_27772, var_cas_27775, var_cas_importedOptionsComponentsMap, var_cas_importedEntities) ;
                GGS_M_semanticsEntitiesForUse::element_type * operand_27859 = var_cas_importedEntities.firstObject () ;
                while ((operand_27859 != NULL)) {
                  macroValidPointer (operand_27859) ;
                  if (((! var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (operand_27859->mKey.reader_value ()))).isBuiltAndTrue ()) {
                    var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, operand_27859->mKey, operand_27859->mInfo.aDefEntite) ;
                  }
                  operand_27859 = operand_27859->nextObject () ;
                }
                var_cas_outInclusionsForHeaderFile.addAssign_operation (var_cas_componentName.reader_value ()) ;
                GGS_M_optionComponents::element_type * operand_28304 = var_cas_importedOptionsComponentsMap.firstObject () ;
                while ((operand_28304 != NULL)) {
                  macroValidPointer (operand_28304) ;
                  if (((! var_cas_ioOptionsComponentsMapForUse.reader_hasKey (operand_28304->mKey.reader_value ()))).isBuiltAndTrue ()) {
                      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_28304->mKey.reader_value ()))) + (GGS_string (true, "' option component must have been imported")))) ;
                  }
                  operand_28304 = operand_28304->nextObject () ;
                }
              }
        ...
        case 2 : {
          ...
          switch (select_semantics_parser_2 (lexique_var_)) {
            ...
            case 3 : {
              ...
              GGS_M_semanticsEntitiesForUse  var_cas_importedEntities ;
              GGS_ModelMap  var_cas_30622 ;
              GGS_ActionMap  var_cas_30625 ;
              GGS_stringset  var_cas_30628 ;
              GGS_stringset  var_cas_30631 ;
              GGS_M_optionComponents  var_cas_30634 ;
              var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_componentName, var_cas_30622, var_cas_30625, var_cas_30628, var_cas_30631, var_cas_30634, var_cas_importedEntities) ;
              GGS_M_semanticsEntitiesForUse::element_type * operand_30686 = var_cas_importedEntities.firstObject () ;
              while ((operand_30686 != NULL)) {
                macroValidPointer (operand_30686) ;
                if (((! var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (operand_30686->mKey.reader_value ()))).isBuiltAndTrue ()) {
                  var_cas_ioComponentSemanticsEntitiesMap.methode_insertKey (lexique_var_, operand_30686->mKey, operand_30686->mInfo.aDefEntite) ;
                }
                operand_30686 = operand_30686->nextObject () ;
              }
              ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_outModelMap,  var_cas_outActionMap,  var_cas_alreadyImportedSemanticsComponents,  var_cas_componentName) ;
              } break ;
            default :
...
pr_parent_class_semantics_parser_1084_20_importSemantics (galgas_scanner & lexique_var_,
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_ClassModel * operand_41536 = dynamic_cast <cPtr_ClassModel *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_41536) ; 
      var_cas_outSuperClasses = operand_41536->mSuperClasses ;
      var_cas_outAttributeList = operand_41536->mAttributeList ;
      var_cas_outMessageMap = operand_41536->mMessageMap ;
    }else{ // Else part
...
pr_semantics_declaration_semantics_parser_1168_29_ (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_7 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_typeClassInheritedMessagesMap::element_type * operand_46533 = var_cas_inheritedMessageMap.firstObject () ;
      while ((operand_46533 != NULL)) {
        macroValidPointer (operand_46533) ;
        if (((! var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_46533->mKey.reader_value ()))).isBuiltAndTrue ()) {
            GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_46533->mKey.reader_value ()))) + (GGS_string (true, "' is not defined")))) ;
        }
        operand_46533 = operand_46533->nextObject () ;
      }
  ...
  switch (select_semantics_parser_7 (lexique_var_)) {
    ...
    case 2 : {
      ...
      while ((operand_52486 != NULL)) {
        ...
        if (((! var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_52486->mKey.reader_value ()))).isBuiltAndTrue ()) {
...
pr_semantics_declaration_semantics_parser_1457_29_ (galgas_scanner & lexique_var_,
  ...
  GGS_typeClassInheritedMessagesMap::element_type * operand_58379 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_58379 != NULL)) {
    macroValidPointer (operand_58379) ;
    if (((! var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_58379->mKey.reader_value ()))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_58379->mKey.reader_value ()))) + (GGS_string (true, "' is not defined")))) ;
    }
    operand_58379 = operand_58379->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
...
pr_semantics_declaration_semantics_parser_1457_29_importSemantics (galgas_scanner & lexique_var_,
  ...
  var_cas_tableDesMethodes.epilogue_definitionClasseNonAbstraite (lexique_var_) ;
  GGS_typeClassInheritedMessagesMap::element_type * operand_65138 = var_cas_inheritedMessageMap.firstObject () ;
  while ((operand_65138 != NULL)) {
    macroValidPointer (operand_65138) ;
    if (((! var_cas_tableMessagesClasseConcrete.reader_hasKey (operand_65138->mKey.reader_value ()))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the message '")) + (operand_65138->mKey.reader_value ()))) + (GGS_string (true, "' is not defined")))) ;
    }
    operand_65138 = operand_65138->nextObject () ;
  }
  GGS_AC_galgasType  var_cas_c ;
  var_cas_c = GGS_typeGalgasClassType::constructor_new (var_cas_concreteClassName, var_cas_tableDesMethodes, var_cas_listeTousAttributsSemantiques, var_cas_tableDesClassesAncetres, var_cas_messageMapForHeirs, var_cas_tableAttributs, var_cas_estAbstraite COMMA_HERE) ;
  var_cas_entite = GGS_typeEntiteType::constructor_new (var_cas_c COMMA_HERE) ;
...
pr_parse_method_semantics_parser_1785_20_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_69941 = var_cas_listeAttributsSemantiquesCourants.firstObject () ;
  while ((operand_69941 != NULL)) {
    macroValidPointer (operand_69941) ;
    GGS_typeCplusPlusName  var_cas_nomCpp ;
    var_cas_nomCpp = GGS_typeDirectName::constructor_new (operand_69941->aNomAttribut COMMA_HERE) ;
    var_cas_methodLocalVariablesMap.methode_insertUsedConstInArgument (lexique_var_, operand_69941->aNomAttribut, operand_69941->mAttributType, var_cas_nomCpp) ;
    operand_69941 = operand_69941->nextObject () ;
  }
...
pr_input_parameters_list_semantics_parser_2176_29_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_listeAttributsSemantiques.reader_length ()) < (var_cas_listeCibles.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_84037 = var_cas_listeAttributsSemantiques.firstObject () ;
    GGS_typeListeCibles::element_type * operand_84123 = var_cas_listeCibles.firstObject () ;
    while ((operand_84037 != NULL)
        && (operand_84123 != NULL)) {
      macroValidPointer (operand_84037) ;
      macroValidPointer (operand_84123) ;
      GGS_lstring  var_cas_nomAttributSource ;
      var_cas_nomAttributSource = operand_84037->aNomAttribut ;
      if (operand_84123->aCible.isBuilt ()) {
        operand_84123->aCible (HERE)->methode_verifierType (lexique_var_, operand_84037->mAttributType, var_cas_nomAttributSource, var_cas_listeAffectationParametresEffectifs, var_cas_outAllVariablesList) ;
      }
      operand_84037 = operand_84037->nextObject () ;
      operand_84123 = operand_84123->nextObject () ;
    }
  }
...
pr_instruction_beginning_with_identifier_semantics_parser_2257_45_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_formalParametersList.reader_length ()) != (var_cas_typeList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_87383 = var_cas_formalParametersList.firstObject () ;
    GGS_typeTypesList::element_type * operand_87457 = var_cas_typeList.firstObject () ;
    while ((operand_87383 != NULL)
        && (operand_87457 != NULL)) {
      macroValidPointer (operand_87383) ;
      macroValidPointer (operand_87457) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_87383->mAttributType,  operand_87457->mType,  operand_87457->mEndOfExpressionLocation) ;
      operand_87383 = operand_87383->nextObject () ;
      operand_87457 = operand_87457->nextObject () ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
pr_drop_instruction_semantics_parser_2753_24_ (galgas_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_galgasType  var_cas_105592 ;
        var_cas_ioVariablesMap.methode_searchForDestructiveReadAccess (lexique_var_, var_cas_nom, var_cas_105592, var_cas_nomCppVar) ;
        GGS_typeInstruction  var_cas_instruction ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            var_cas_nomVariable.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
            GGS_AC_galgasType  var_cas_116597 ;
            GGS_typeCplusPlusName  var_cas_116600 ;
            var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_nomVariable, var_cas_116597, var_cas_116600) ;
...
pr_parse_match_operand_semantics_parser_3308_27_ (galgas_scanner & lexique_var_,
  ...
  if (var_cas_type.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) != NULL) {
      cPtr_typeGalgasClassType * operand_126557 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_126557) ; 
      var_cas_outBaseTypeName = operand_126557->mClassTypeName ;
      ...
      cPtr_typeGalgas_enum * operand_126760 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_type.getPtr ()) ;
      macroValidPointer (operand_126760) ; 
      var_cas_outBaseTypeName = operand_126760->mEnumTypeName ;
      var_cas_outIsEnumeration = GGS_bool (true, true) ;
      var_cas_outEnumMessageMap = operand_126760->mEnumConstantesMap ;
    }else{ // Else part
...
pr_optional_assignment_semantics_parser_3570_27_ (galgas_scanner & lexique_var_,
                                ...
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A_3D) ;
  GGS_AC_galgasType  var_cas_135554 ;
  GGS_typeCplusPlusName  var_cas_135557 ;
  var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_inTargetVarName, var_cas_135554, var_cas_135557) ;
  GGS_typeExpression  var_cas_sourceExpression ;
  GGS_AC_galgasType  var_cas_sourceType ;
  nt_expression_ (lexique_var_, var_cas_ioComponentSemanticsEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_sourceExpression, var_cas_sourceType) ;
...
pr_optional_assignment_semantics_parser_3602_27_ (galgas_scanner & lexique_var_,
                                ...
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap) {
  GGS_AC_galgasType  var_cas_136667 ;
  GGS_typeCplusPlusName  var_cas_136670 ;
  var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_inTargetVarName, var_cas_136667, var_cas_136670) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
...
pr_parse_states_semantics_parser_3642_20_ (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_34 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_first) ;
...
pr_semantics_declaration_semantics_parser_3716_29_ (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_39 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_insertOrSearchMethodList::element_type * operand_144199 = var_cas_insertMethodList.firstObject () ;
      while ((operand_144199 != NULL)) {
        macroValidPointer (operand_144199) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        ...
        GGS_typeListeAttributsSemantiques::element_type * operand_144393 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_144393 != NULL)) {
          macroValidPointer (operand_144393) ;
          var_cas_methodSignature.addAssign_operation (operand_144393->mAttributType, var_cas_inPassingMode) ;
          operand_144393 = operand_144393->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_144199->mMethodName, var_cas_methodSignature) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_144812 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_144812 != NULL)) {
          macroValidPointer (operand_144812) ;
          var_cas_methodSignature.addAssign_operation (operand_144812->mAttributType, var_cas_inPassingMode) ;
          operand_144812 = operand_144812->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_144199->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_144199->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature) ;
        operand_144199 = operand_144199->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_145153 = var_cas_searchMethodList.firstObject () ;
      while ((operand_145153 != NULL)) {
        macroValidPointer (operand_145153) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_145345 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_145345 != NULL)) {
          macroValidPointer (operand_145345) ;
          var_cas_methodSignature.addAssign_operation (operand_145345->mAttributType, var_cas_outPassingMode) ;
          operand_145345 = operand_145345->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_145153->mMethodName, var_cas_methodSignature) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_145762 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_145762 != NULL)) {
          macroValidPointer (operand_145762) ;
          var_cas_methodSignature.addAssign_operation (operand_145762->mAttributType, var_cas_outPassingMode) ;
          operand_145762 = operand_145762->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_145153->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_145153->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature) ;
        operand_145153 = operand_145153->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
    ...
    case 3 : {
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_43 (lexique_var_)) {
            case 2 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_149431 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_149431 != NULL)) {
                macroValidPointer (operand_149431) ;
                var_cas_methodSignature.addAssign_operation (operand_149431->mAttributType, var_cas_inPassingMode) ;
                operand_149431 = operand_149431->nextObject () ;
              }
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                GGS_typeListeAttributsSemantiques::element_type * operand_150059 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_150059 != NULL)) {
                  macroValidPointer (operand_150059) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_150059->mAttributType, var_cas_inPassingMode) ;
                  operand_150059 = operand_150059->nextObject () ;
                }
            ...
            case 3 : {
              ...
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_151097 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_151097 != NULL)) {
                macroValidPointer (operand_151097) ;
                var_cas_methodSignature.addAssign_operation (operand_151097->mAttributType, var_cas_outPassingMode) ;
                operand_151097 = operand_151097->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature) ;
              ...
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_151758 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_151758 != NULL)) {
                  macroValidPointer (operand_151758) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_151758->mAttributType, var_cas_outPassingMode) ;
                  operand_151758 = operand_151758->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature) ;
      ...
      if (((var_cas_stateValues.reader_count ()) > (GGS_uint (true, 0UL))).isBuiltAndTrue ()) {
        GGS_insertOrSearchMethodList::element_type * operand_152288 = var_cas_insertMethodList.firstObject () ;
        while ((operand_152288 != NULL)) {
          macroValidPointer (operand_152288) ;
          GGS_insertOrSearchMethodList::element_type * operand_152410 = var_cas_insertMethodList.firstObject () ;
          while ((operand_152410 != NULL)) {
            macroValidPointer (operand_152410) ;
            if (((! operand_152288->mTransitionStatusMap.reader_hasKey (operand_152410->mMethodName.reader_value ()))).isBuiltAndTrue ()) {
                operand_152288->mMethodName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "This insert method does not define the '")) + (operand_152410->mMethodName.reader_value ()))) + (GGS_string (true, "' transition")))) ;
            }
            operand_152410 = operand_152410->nextObject () ;
          }
          operand_152288 = operand_152288->nextObject () ;
        }
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapMethodMap COMMA_HERE) ;
...
pr_semantics_declaration_semantics_parser_3716_29_importSemantics (galgas_scanner & lexique_var_,
  ...
  switch (select_semantics_parser_39 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_AC_galgasType  var_cas_luintType ;
      var_cas_luintType = GGS_typeGalgas_luint::constructor_new (HERE) ;
      GGS_insertOrSearchMethodList::element_type * operand_157752 = var_cas_insertMethodList.firstObject () ;
      while ((operand_157752 != NULL)) {
        macroValidPointer (operand_157752) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_157946 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_157946 != NULL)) {
          macroValidPointer (operand_157946) ;
          var_cas_methodSignature.addAssign_operation (operand_157946->mAttributType, var_cas_inPassingMode) ;
          operand_157946 = operand_157946->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_157752->mMethodName, var_cas_methodSignature) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_158365 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_158365 != NULL)) {
          macroValidPointer (operand_158365) ;
          var_cas_methodSignature.addAssign_operation (operand_158365->mAttributType, var_cas_inPassingMode) ;
          operand_158365 = operand_158365->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_157752->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_157752->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature) ;
        operand_157752 = operand_157752->nextObject () ;
      }
      GGS_insertOrSearchMethodList::element_type * operand_158706 = var_cas_searchMethodList.firstObject () ;
      while ((operand_158706 != NULL)) {
        macroValidPointer (operand_158706) ;
        GGS_L_EXsignature  var_cas_methodSignature ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_158900 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_158900 != NULL)) {
          macroValidPointer (operand_158900) ;
          var_cas_methodSignature.addAssign_operation (operand_158900->mAttributType, var_cas_outPassingMode) ;
          operand_158900 = operand_158900->nextObject () ;
        }
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, operand_158706->mMethodName, var_cas_methodSignature) ;
        var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
        var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
        var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
        GGS_typeListeAttributsSemantiques::element_type * operand_159320 = var_cas_listeTousAttributsSemantiques.firstObject () ;
        while ((operand_159320 != NULL)) {
          macroValidPointer (operand_159320) ;
          var_cas_methodSignature.addAssign_operation (operand_159320->mAttributType, var_cas_outPassingMode) ;
          operand_159320 = operand_159320->nextObject () ;
        }
        GGS_lstring  var_cas_insertKeyAndGetIndexName ;
        var_cas_insertKeyAndGetIndexName = GGS_lstring::constructor_new (((operand_158706->mMethodName.reader_value ()) + (GGS_string (true, "GetIndex"))), operand_158706->mMethodName.reader_location () COMMA_HERE) ;
        var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_insertKeyAndGetIndexName, var_cas_methodSignature) ;
        operand_158706 = operand_158706->nextObject () ;
      }
      GGS_AC_galgasType  var_cas_c ;
      var_cas_c = GGS_typeGalgasMapType::constructor_new (var_cas_mapTypeName, var_cas_listeTousAttributsSemantiques, var_cas_tableMethodesBloc, var_cas_mapMethodMap COMMA_HERE) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_semantics_parser_43 (lexique_var_)) {
            case 2 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_161580 ;
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_161580) ;
              nt_parse_states_parse (lexique_var_) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_161814 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_161814 != NULL)) {
                macroValidPointer (operand_161814) ;
                var_cas_methodSignature.addAssign_operation (operand_161814->mAttributType, var_cas_inPassingMode) ;
                operand_161814 = operand_161814->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature) ;
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_162346 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_162346 != NULL)) {
                  macroValidPointer (operand_162346) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_162346->mAttributType, var_cas_inPassingMode) ;
                  operand_162346 = operand_162346->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature) ;
              }
              } break ;
            case 3 : {
              ...
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  var_cas_getIndexMethodName ;
              GGS_lstring  var_cas_162725 ;
              nt_map_method_ (lexique_var_, var_cas_methodName, var_cas_getIndexMethodName, var_cas_162725) ;
              nt_parse_states_parse (lexique_var_) ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
              GGS_L_EXsignature  var_cas_methodSignature ;
              var_cas_methodSignature = GGS_L_EXsignature::constructor_empty (HERE) ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              GGS_typeListeAttributsSemantiques::element_type * operand_162965 = var_cas_listeTousAttributsSemantiques.firstObject () ;
              while ((operand_162965 != NULL)) {
                macroValidPointer (operand_162965) ;
                var_cas_methodSignature.addAssign_operation (operand_162965->mAttributType, var_cas_outPassingMode) ;
                operand_162965 = operand_162965->nextObject () ;
              }
              var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_methodName, var_cas_methodSignature) ;
              if (((var_cas_getIndexMethodName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_getIndexMethodSignature ;
                ...
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
                var_cas_getIndexMethodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
                GGS_typeListeAttributsSemantiques::element_type * operand_163540 = var_cas_listeTousAttributsSemantiques.firstObject () ;
                while ((operand_163540 != NULL)) {
                  macroValidPointer (operand_163540) ;
                  var_cas_getIndexMethodSignature.addAssign_operation (operand_163540->mAttributType, var_cas_outPassingMode) ;
                  operand_163540 = operand_163540->nextObject () ;
                }
                var_cas_mapMethodMap.methode_insertKey (lexique_var_, var_cas_getIndexMethodName, var_cas_getIndexMethodSignature) ;
              }
              } break ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_semantics_parser_54 (lexique_var_)) {
        case 2 : {
          ...
          GGS_enumConstantMap::element_type * operand_189379 = var_cas_constantMap.firstObject () ;
          while ((operand_189379 != NULL)) {
            macroValidPointer (operand_189379) ;
            GGS_lstring  var_cas_name ;
            var_cas_name = GGS_lstring::constructor_new (operand_189379->mKey.reader_value (), GGS_location (lexique_var_) COMMA_HERE) ;
            GGS_lstring  var_cas_cstString ;
            ...
            operand_189379 = operand_189379->nextObject () ;
          }
