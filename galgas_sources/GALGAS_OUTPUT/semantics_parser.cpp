...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_64 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_uniquemap) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
  ...
  switch (select_semantics_5F_parser_65 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_214487 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5762)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5763))))).operator_not () ;
      if (cond_214487.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_217442 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_217442 = NULL ;
        while (((operand_217442 = enumerator_217442.nextObject ()))) {
          macroValidPointer (operand_217442) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_217619 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_217619 = NULL ;
            while (((operand_217619 = enumerator_217619.nextObject ()))) {
              macroValidPointer (operand_217619) ;
              var_cas_methodSignature.addAssign_operation (operand_217619->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_217442->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5855)) ;
          ...
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_218021 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_218021 = NULL ;
            while (((operand_218021 = enumerator_218021.nextObject ()))) {
              macroValidPointer (operand_218021) ;
              var_cas_methodSignature.addAssign_operation (operand_218021->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_217442->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5863))).operator_concat (GGS_string ("GetIndex")), operand_217442->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5863)) COMMA_SOURCE_FILE_AT_LINE (5863)) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_218349 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_218349 = NULL ;
        while (((operand_218349 = enumerator_218349.nextObject ()))) {
          macroValidPointer (operand_218349) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_218524 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_218524 = NULL ;
            while (((operand_218524 = enumerator_218524.nextObject ()))) {
              macroValidPointer (operand_218524) ;
              var_cas_methodSignature.addAssign_operation (operand_218524->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_218349->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (5873)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_218924 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_218924 = NULL ;
            while (((operand_218924 = enumerator_218924.nextObject ()))) {
              macroValidPointer (operand_218924) ;
              var_cas_methodSignature.addAssign_operation (operand_218924->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_218349->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5881))).operator_concat (GGS_string ("GetIndex")), operand_218349->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (5881)) COMMA_SOURCE_FILE_AT_LINE (5881)) ;
    ...
    case 3 : {
      ...
      {
        GGS_mapStateList::cEnumerator enumerator_223006 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_223006 = NULL ;
        while (((operand_223006 = enumerator_223006.nextObject ()))) {
          macroValidPointer (operand_223006) ;
          var_cas_mapAutomatonStateMap.modifier_insertKey (inLexique, operand_223006->mStateName, var_cas_mapAutomatonStateMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (5983)) ;
        }
      }
      {
        GGS_mapStateList::cEnumerator enumerator_223137 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_223137 = NULL ;
        while (((operand_223137 = enumerator_223137.nextObject ()))) {
          macroValidPointer (operand_223137) ;
          {
            GGS_mapStateTransitionList::cEnumerator enumerator_223170 (operand_223137->mTransitionList, true) ;
            const GGS_mapStateTransitionList::cElement * operand_223170 = NULL ;
            while (((operand_223170 = enumerator_223170.nextObject ()))) {
              macroValidPointer (operand_223170) ;
              GGS_uint  automatic_var_223235_0 ;
              if (var_cas_mapAutomatonStateMap.isBuilt ()) {
                var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_223170->mTargetStateName, automatic_var_223235_0 COMMA_SOURCE_FILE_AT_LINE (5987)) ;
              }
            }
          }
        }
        ...
        while (syntaxRepeat_71) {
          switch (select_semantics_5F_parser_71 (inLexique)) {
            case 2 : {
              ...
              const GGS_bool cond_224361 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_224361.isBuiltAndTrue ()) {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_224616 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_224616 = NULL ;
                while (((operand_224616 = enumerator_224616.nextObject ()))) {
                  macroValidPointer (operand_224616) ;
                  var_cas_methodSignature.addAssign_operation (operand_224616->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_225172 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_225172 = NULL ;
                while (((operand_225172 = enumerator_225172.nextObject ()))) {
                  macroValidPointer (operand_225172) ;
                  var_cas_methodSignature.addAssign_operation (operand_225172->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              switch (select_semantics_5F_parser_72 (inLexique)) {
                case 1 : {
                  const GGS_bool cond_225707 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_225707.isBuiltAndTrue ()) {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_226653 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_226653 = NULL ;
                while (((operand_226653 = enumerator_226653.nextObject ()))) {
                  macroValidPointer (operand_226653) ;
                  var_cas_methodSignature.addAssign_operation (operand_226653->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              switch (select_semantics_5F_parser_74 (inLexique)) {
                case 1 : {
                  const GGS_bool cond_227252 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_227252.isBuiltAndTrue ()) {
                ...
                case 2 : {
                  ...
                  inLexique.assignFromAttribute_tokenString (var_cas_actionName) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                  const GGS_bool cond_227585 = (var_cas_mapAutomatonActionMap.reader_hasKey (var_cas_actionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6089)))).operator_not () ;
                  if (cond_227585.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_227585.isBuiltAndFalse ()) {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_228023 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_228023 = NULL ;
                while (((operand_228023 = enumerator_228023.nextObject ()))) {
                  macroValidPointer (operand_228023) ;
                  var_cas_methodSignature.addAssign_operation (operand_228023->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_228237 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_228237.isBuiltAndTrue ()) {
              ...
              }else if (cond_228237.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_228491 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_228491 = NULL ;
        while (((operand_228491 = enumerator_228491.nextObject ()))) {
          macroValidPointer (operand_228491) ;
          const GGS_bool cond_228923 = operand_228491->mInfo.mHasSetter ;
          if (cond_228923.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_228491->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6117)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_228491->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_229184 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_229184.isBuiltAndTrue ()) {
      ...
      {
        GGS_mapStateList::cEnumerator enumerator_229395 (var_cas_mapStateList, true) ;
        const GGS_mapStateList::cElement * operand_229395 = NULL ;
        while (((operand_229395 = enumerator_229395.nextObject ()))) {
          macroValidPointer (operand_229395) ;
          ...
          {
            GGS_mapStateTransitionList::cEnumerator enumerator_229568 (operand_229395->mTransitionList, true) ;
            const GGS_mapStateTransitionList::cElement * operand_229568 = NULL ;
            while (((operand_229568 = enumerator_229568.nextObject ()))) {
              macroValidPointer (operand_229568) ;
              GGS_uint  var_cas_actionIndex ;
              if (var_cas_mapAutomatonActionMap.isBuilt ()) {
                var_cas_mapAutomatonActionMap (HERE)->method_searchKey (inLexique, operand_229568->mActionName, var_cas_actionIndex COMMA_SOURCE_FILE_AT_LINE (6139)) ;
              }
              const GGS_bool cond_229849 = var_cas_actionsForCurrentState.reader_hasKey (operand_229568->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6140))) ;
              if (cond_229849.isBuiltAndTrue ()) {
                operand_229568->mActionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_229568->mActionName)).operator_concat (GGS_string ("' action is already used for this state")) COMMA_SOURCE_FILE_AT_LINE (6142)) ;
              }
              var_cas_actionsForCurrentState.addAssign_operation (operand_229568->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6143))) ;
              GGS_uint  var_cas_targetStateIndex ;
              if (var_cas_mapAutomatonStateMap.isBuilt ()) {
                var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_229568->mTargetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (6145)) ;
              }
              var_cas_mapStateTransitionSortedList.addAssign_operation (var_cas_actionIndex, operand_229568->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6148)), var_cas_targetStateIndex, operand_229568->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6150)), operand_229568->mTransitionMessageKind, operand_229568->mTransitionMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6152))) ;
            }
          }
          GGS_uint  var_cas_stateIndex ;
          if (var_cas_mapAutomatonStateMap.isBuilt ()) {
            var_cas_mapAutomatonStateMap (HERE)->method_searchKey (inLexique, operand_229395->mStateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (6156)) ;
          }
          var_cas_mapStateSortedList.addAssign_operation (var_cas_stateIndex, operand_229395->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6159)), operand_229395->mStateMessageKind, operand_229395->mStateMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6161)), var_cas_mapStateTransitionSortedList) ;
          ...
          const GGS_bool cond_230933 = (var_cas_missingActions.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
          if (cond_230933.isBuiltAndTrue ()) {
            GGS_string var_cas_s = GGS_string ("") ;
            {
              GGS_stringset::cEnumerator enumerator_230730 (var_cas_missingActions, true) ;
              if (enumerator_230730 .hasCurrentObject ()) {
                bool _foreach_loop_230730 ;
                do{
                  var_cas_s.appendCString ("'") ;
                  var_cas_s.dotAssign_operation (enumerator_230730._key (HERE)) ;
                  var_cas_s.appendCString ("'") ;
                  enumerator_230730.next () ;
                  _foreach_loop_230730 = (enumerator_230730 .hasCurrentObject ()) ;
                  if (_foreach_loop_230730) {
                    var_cas_s.appendCString (", ") ;
                  }
                }while (_foreach_loop_230730) ;
              }
            }
            operand_229395->mStateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the following actions are not named in a transition from this state: ")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (6172)) ;
          }
        }
      }
      GGS_stringset  var_cas_accessibleStates = var_cas_initialStateSet ;
      GGS_bool var_cas_progress = GGS_bool (true) ;
      GGS_uint _variant_231553 = var_cas_mapStateList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (6177)) ;
      GGS_bool _condition_231553 (_variant_231553.isBuilt (), true) ;
      while (_condition_231553.isBuiltAndTrue ()) {
        _condition_231553 = var_cas_progress ;
        if (_condition_231553.isBuiltAndTrue ()) {
          if (_variant_231553.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (6189)) ;
            _condition_231553 = GGS_bool (false) ;
          }else{
            _variant_231553.decrement_operation (inLexique COMMA_HERE) ;
            var_cas_progress = GGS_bool (false) ;
            {
              GGS_mapStateList::cEnumerator enumerator_231187 (var_cas_mapStateList, true) ;
              const GGS_mapStateList::cElement * operand_231187 = NULL ;
              while (((operand_231187 = enumerator_231187.nextObject ()))) {
                macroValidPointer (operand_231187) ;
                const GGS_bool cond_231520 = var_cas_accessibleStates.reader_hasKey (operand_231187->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6180))) ;
                if (cond_231520.isBuiltAndTrue ()) {
                  {
                    GGS_mapStateTransitionList::cEnumerator enumerator_231287 (operand_231187->mTransitionList, true) ;
                    const GGS_mapStateTransitionList::cElement * operand_231287 = NULL ;
                    while (((operand_231287 = enumerator_231287.nextObject ()))) {
                      macroValidPointer (operand_231287) ;
                      const GGS_bool cond_231479 = (var_cas_accessibleStates.reader_hasKey (operand_231287->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6182)))).operator_not () ;
                      if (cond_231479.isBuiltAndTrue ()) {
                        var_cas_accessibleStates.addAssign_operation (operand_231287->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6183))) ;
      ...
      const GGS_bool cond_231908 = (var_cas_uselessStates.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_231908.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_stringset::cEnumerator enumerator_231740 (var_cas_uselessStates, true) ;
          if (enumerator_231740 .hasCurrentObject ()) {
            bool _foreach_loop_231740 ;
            do{
              var_cas_s.appendCString ("'") ;
              var_cas_s.dotAssign_operation (enumerator_231740._key (HERE)) ;
              var_cas_s.appendCString ("'") ;
              enumerator_231740.next () ;
              _foreach_loop_231740 = (enumerator_231740 .hasCurrentObject ()) ;
              if (_foreach_loop_231740) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_231740) ;
          }
        }
      ...
      {
        GGS_EXmapAutomatonStateMap::cEnumerator enumerator_232130 (var_cas_mapAutomatonStateMap, true) ;
        const GGS_EXmapAutomatonStateMap::cElement * operand_232130 = NULL ;
        while (((operand_232130 = enumerator_232130.nextObject ()))) {
          macroValidPointer (operand_232130) ;
          GGS_stringset  var_cas_reachableStates = GGS_stringset ::constructor_emptySet () ;
          var_cas_reachableStates.addAssign_operation (operand_232130->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6205))) ;
          GGS_bool var_cas_progress = GGS_bool (true) ;
          GGS_uint _variant_232845 = var_cas_mapAutomatonStateMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (6207)) ;
          GGS_bool _condition_232845 (_variant_232845.isBuilt (), true) ;
          while (_condition_232845.isBuiltAndTrue ()) {
            _condition_232845 = var_cas_progress ;
            if (_condition_232845.isBuiltAndTrue ()) {
              if (_variant_232845.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (6220)) ;
                _condition_232845 = GGS_bool (false) ;
              }else{
                _variant_232845.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_progress = GGS_bool (false) ;
                {
                  GGS_mapStateList::cEnumerator enumerator_232373 (var_cas_mapStateList, true) ;
                  const GGS_mapStateList::cElement * operand_232373 = NULL ;
                  while (((operand_232373 = enumerator_232373.nextObject ()))) {
                    macroValidPointer (operand_232373) ;
                    const GGS_bool cond_232808 = var_cas_reachableStates.reader_hasKey (operand_232373->mStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6210))) ;
                    if (cond_232808.isBuiltAndTrue ()) {
                      {
                        GGS_mapStateTransitionList::cEnumerator enumerator_232476 (operand_232373->mTransitionList, true) ;
                        const GGS_mapStateTransitionList::cElement * operand_232476 = NULL ;
                        while (((operand_232476 = enumerator_232476.nextObject ()))) {
                          macroValidPointer (operand_232476) ;
                          const GGS_bool cond_232763 = (var_cas_reachableStates.reader_hasKey (operand_232476->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6212)))).operator_not () ;
                          if (cond_232763.isBuiltAndTrue ()) {
                            var_cas_reachableStates.addAssign_operation (operand_232476->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6213))) ;
                            var_cas_accessibilityGraph.addAssign_operation (((operand_232130->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6214))).operator_concat (GGS_string (":"))).operator_concat (operand_232476->mTargetStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6214)))) ;
                            var_cas_progress = GGS_bool (true) ;
                          }
                        }
                      }
          ...
          {
            GGS_stringset::cEnumerator enumerator_232882 (var_cas_reachableStates, true) ;
            while (enumerator_232882.hasCurrentObject ()) {
              const GGS_bool cond_232995 = (operand_232130->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6222))).operator_isNotEqual (enumerator_232882._key (HERE)) ;
              if (cond_232995.isBuiltAndTrue ()) {
                var_cas_neededAssociations.addAssign_operation (((operand_232130->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6223))).operator_concat (GGS_string (":"))).operator_concat (enumerator_232882._key (HERE))) ;
              }
              enumerator_232882.next () ;
            }
          }
        }
      }
        ...
        while (syntaxRepeat_75) {
          switch (select_semantics_5F_parser_75 (inLexique)) {
            case 2 : {
                ...
                while (syntaxRepeat_76) {
                  switch (select_semantics_5F_parser_76 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_234124 = (var_cas_neededAssociations.reader_hasKey (var_cas_association)).operator_not () ;
                      if (cond_234124.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_234302 = var_cas_handledAssociations.reader_hasKey (var_cas_association) ;
                      if (cond_234302.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_235106 = (var_cas_leftStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))).operator_isNotEqual (var_cas_resultingStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6262))) ;
                      if (cond_235106.isBuiltAndTrue ()) {
                        ...
                        const GGS_bool cond_235089 = (var_cas_accessibilityGraph.reader_hasKey (((var_cas_leftStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))).operator_concat (GGS_string (":"))).operator_concat (var_cas_resultingStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6265))))).operator_not () ;
                        if (cond_235089.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_236529 = (var_cas_forgottenAssociations.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_236529.isBuiltAndTrue ()) {
                GGS_string var_cas_s = GGS_string ("") ;
                {
                  GGS_stringset::cEnumerator enumerator_236360 (var_cas_forgottenAssociations, true) ;
                  while (enumerator_236360.hasCurrentObject ()) {
                    var_cas_s.appendCString ("\n"
                      "  - ") ;
                    var_cas_s.dotAssign_operation (enumerator_236360._key (HERE)) ;
                    enumerator_236360.next () ;
                  }
                }
                ...
                while (syntaxRepeat_78) {
                  switch (select_semantics_5F_parser_78 (inLexique)) {
                    case 2 : {
                      ...
                      const GGS_bool cond_237425 = (var_cas_neededCombinaisons.reader_hasKey (var_cas_combinaison)).operator_not () ;
                      if (cond_237425.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_237642 = var_cas_definedCombinaisons.reader_hasKey (var_cas_combinaison) ;
                      if (cond_237642.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_240339 = (var_cas_forgottenAssociations.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_240339.isBuiltAndTrue ()) {
                ...
                const GGS_bool cond_240324 = (var_cas_forgottenCombinaisons.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_240324.isBuiltAndTrue ()) {
                  GGS_string var_cas_s = GGS_string ("") ;
                  {
                    GGS_stringset::cEnumerator enumerator_240151 (var_cas_forgottenCombinaisons, true) ;
                    while (enumerator_240151.hasCurrentObject ()) {
                      var_cas_s.appendCString ("\n"
                        "  - ") ;
                      var_cas_s.dotAssign_operation (enumerator_240151._key (HERE)) ;
                      enumerator_240151.next () ;
                    }
                  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i62_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_65 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_242147 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_mapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6432))))).operator_not () ;
      if (cond_242147.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_245079 (var_cas_insertMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_245079 = NULL ;
        while (((operand_245079 = enumerator_245079.nextObject ()))) {
          macroValidPointer (operand_245079) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245256 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245256 = NULL ;
            while (((operand_245256 = enumerator_245256.nextObject ()))) {
              macroValidPointer (operand_245256) ;
              var_cas_methodSignature.addAssign_operation (operand_245256->mAttributType, var_cas_inPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_245079->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6523)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_245658 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_245658 = NULL ;
            while (((operand_245658 = enumerator_245658.nextObject ()))) {
              macroValidPointer (operand_245658) ;
              var_cas_methodSignature.addAssign_operation (operand_245658->mAttributType, var_cas_inPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_245079->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6531))).operator_concat (GGS_string ("GetIndex")), operand_245079->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6531)) COMMA_SOURCE_FILE_AT_LINE (6531)) ;
      ...
      {
        GGS_insertOrSearchMethodList::cEnumerator enumerator_245986 (var_cas_searchMethodList, true) ;
        const GGS_insertOrSearchMethodList::cElement * operand_245986 = NULL ;
        while (((operand_245986 = enumerator_245986.nextObject ()))) {
          macroValidPointer (operand_245986) ;
          GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246163 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246163 = NULL ;
            while (((operand_246163 = enumerator_246163.nextObject ()))) {
              macroValidPointer (operand_246163) ;
              var_cas_methodSignature.addAssign_operation (operand_246163->mAttributType, var_cas_outPassingMode) ;
            }
          }
          var_cas_mapModifierMethodMap.modifier_insertKey (inLexique, operand_245986->mMethodName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (6541)) ;
          var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
          var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
          var_cas_methodSignature.addAssign_operation (var_cas_luintType, var_cas_outPassingMode) ;
          {
            GGS_typeListeAttributsSemantiques::cEnumerator enumerator_246566 (var_cas_listeTousAttributsSemantiques, true) ;
            const GGS_typeListeAttributsSemantiques::cElement * operand_246566 = NULL ;
            while (((operand_246566 = enumerator_246566.nextObject ()))) {
              macroValidPointer (operand_246566) ;
              var_cas_methodSignature.addAssign_operation (operand_246566->mAttributType, var_cas_outPassingMode) ;
            }
          }
          GGS_lstring  var_cas_insertKeyAndGetIndexName = GGS_lstring ::constructor_new (inLexique, (operand_245986->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6549))).operator_concat (GGS_string ("GetIndex")), operand_245986->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (6549)) COMMA_SOURCE_FILE_AT_LINE (6549)) ;
    ...
    case 3 : {
            ...
            case 2 : {
              ...
              switch (select_semantics_5F_parser_68 (inLexique)) {
                ...
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                  if (var_cas_stateMessage.isBuilt ()) {
                    ::routine_check_K_escapeCharactersEX (inLexique,  var_cas_stateMessage COMMA_SOURCE_FILE_AT_LINE (6596)) ;
                  }
                ...
                case 3 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                  if (var_cas_stateMessage.isBuilt ()) {
                    ::routine_check_K_escapeCharactersEX (inLexique,  var_cas_stateMessage COMMA_SOURCE_FILE_AT_LINE (6601)) ;
                  }
        ...
        while (syntaxRepeat_71) {
          switch (select_semantics_5F_parser_71 (inLexique)) {
            case 2 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_250684 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_250684 = NULL ;
                while (((operand_250684 = enumerator_250684.nextObject ()))) {
                  macroValidPointer (operand_250684) ;
                  var_cas_methodSignature.addAssign_operation (operand_250684->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_remove) COMMA_HERE) ;
              GGS_lstring  var_cas_methodName ;
              GGS_lstring  automatic_var_250964_0 ;
              nt_map_5F_method_ (inLexique, var_cas_methodName, automatic_var_250964_0) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              GGS_L_EXsignature  var_cas_methodSignature = GGS_L_EXsignature ::constructor_emptyList () ;
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251171 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251171 = NULL ;
                while (((operand_251171 = enumerator_251171.nextObject ()))) {
                  macroValidPointer (operand_251171) ;
                  var_cas_methodSignature.addAssign_operation (operand_251171->mAttributType, var_cas_outPassingMode) ;
                }
              }
            ...
            case 4 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_251862 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_251862 = NULL ;
                while (((operand_251862 = enumerator_251862.nextObject ()))) {
                  macroValidPointer (operand_251862) ;
                  var_cas_methodSignature.addAssign_operation (operand_251862->mAttributType, var_cas_inPassingMode) ;
                }
              }
            ...
            case 5 : {
              ...
              var_cas_methodSignature.addAssign_operation (var_cas_lstringType, var_cas_inPassingMode) ;
              {
                GGS_typeListeAttributsSemantiques::cEnumerator enumerator_252468 (var_cas_listeTousAttributsSemantiques, true) ;
                const GGS_typeListeAttributsSemantiques::cElement * operand_252468 = NULL ;
                while (((operand_252468 = enumerator_252468.nextObject ()))) {
                  macroValidPointer (operand_252468) ;
                  var_cas_methodSignature.addAssign_operation (operand_252468->mAttributType, var_cas_outPassingMode) ;
                }
              }
              const GGS_bool cond_252682 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_252682.isBuiltAndTrue ()) {
              ...
              }else if (cond_252682.isBuiltAndFalse ()) {
      ...
      {
        GGS_typeSemanticAttributesMap::cEnumerator enumerator_252849 (var_cas_tableAttributs, true) ;
        const GGS_typeSemanticAttributesMap::cElement * operand_252849 = NULL ;
        while (((operand_252849 = enumerator_252849.nextObject ()))) {
          macroValidPointer (operand_252849) ;
          const GGS_bool cond_253281 = operand_252849->mInfo.mHasSetter ;
          if (cond_253281.isBuiltAndTrue ()) {
            GGS_string var_cas_modifierName = ((GGS_string ("set")).operator_concat (operand_252849->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6728)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")) ;
            GGS_L_EXsignature  var_cas_modifierSignature = GGS_L_EXsignature ::constructor_emptyList () ;
            var_cas_modifierSignature.addAssign_operation (operand_252849->mInfo.mAttributType, var_cas_inPassingMode) ;
      ...
      const GGS_bool cond_253542 = (var_cas_mapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_253542.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_257806 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_257806 = NULL ;
    while (((operand_257806 = enumerator_257806.nextObject ()))) {
      macroValidPointer (operand_257806) ;
      GGS_string var_cas_keyClassMethod = ((operand_257806->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6872))) ;
      const GGS_bool cond_258103 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6873)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_258103.isBuiltAndTrue ()) {
        var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_257806->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (6876)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i65_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_259738 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6918)))).operator_not () ;
  if (cond_259738.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_263242 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (6972))) ;
  if (cond_263242.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_262284 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_262284 = NULL ;
      while (((operand_262284 = enumerator_262284.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_262284) ;
        GGS_string var_cas_keyClassMethod = ((operand_262284->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6976))) ;
        var_cas_baseClassName = operand_262284->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6977)) ;
        ...
        const GGS_bool cond_263022 = var_cas_found ;
        if (cond_263022.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryMethodMap  temp_262691 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          if (temp_262691.isBuilt ()) {
            temp_262691 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (6982)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (6982)) ;
          }
    ...
    const GGS_bool cond_263230 = (var_cas_found).operator_not () ;
    if (cond_263230.isBuiltAndTrue ()) {
  ...
  }else if (cond_263242.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_263319 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_263319 = NULL ;
      while (((operand_263319 = enumerator_263319.nextObject ()))) {
        macroValidPointer (operand_263319) ;
        GGS_string var_cas_keyClassMethod = ((operand_263319->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))).operator_concat (GGS_string (":"))).operator_concat (var_cas_methodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (6997))) ;
        const GGS_bool cond_263625 = var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (6998)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_263625.isBuiltAndTrue ()) {
          var_cas_methodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this method is already defined for super class @")).operator_concat (operand_263319->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7001)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_263778 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7006)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_263778 = NULL ;
    while (((operand_263778 = enumerator_263778.nextObject ()))) {
      macroValidPointer (operand_263778) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_methodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7008)), operand_263778->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7009)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7007)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_263778->mAttributeName, operand_263778->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7013)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i66_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_266296 = (var_cas_ioSemanticContext.reader_mCategoryMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7073)))).operator_not () ;
  if (cond_266296.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_269243 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_269243 = NULL ;
    while (((operand_269243 = enumerator_269243.nextObject ()))) {
      macroValidPointer (operand_269243) ;
      GGS_string var_cas_keyClassMethod = ((operand_269243->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7136))) ;
      const GGS_bool cond_269540 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7137)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_269540.isBuiltAndTrue ()) {
        var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_269243->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7140)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i67_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_271659 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7192)))).operator_not () ;
  if (cond_271659.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_276247 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7256))) ;
  if (cond_276247.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_274946 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_274946 = NULL ;
      while (((operand_274946 = enumerator_274946.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_274946) ;
        GGS_string var_cas_keyClassMethod = ((operand_274946->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7260))) ;
        var_cas_baseClassName = operand_274946->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7261)) ;
        ...
        const GGS_bool cond_276027 = var_cas_found ;
        if (cond_276027.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          GGS_AC_galgasType  var_cas_returnedTypePreviousDeclaration ;
          const GGS_EXcategoryReaderMap  temp_275410 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          if (temp_275410.isBuilt ()) {
            temp_275410 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7268)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration, var_cas_returnedTypePreviousDeclaration COMMA_SOURCE_FILE_AT_LINE (7267)) ;
          }
    ...
    const GGS_bool cond_276235 = (var_cas_found).operator_not () ;
    if (cond_276235.isBuiltAndTrue ()) {
  ...
  }else if (cond_276247.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_276324 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_276324 = NULL ;
      while (((operand_276324 = enumerator_276324.nextObject ()))) {
        macroValidPointer (operand_276324) ;
        GGS_string var_cas_keyClassMethod = ((operand_276324->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))).operator_concat (GGS_string (":"))).operator_concat (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7293))) ;
        const GGS_bool cond_276630 = var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7294)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_276630.isBuiltAndTrue ()) {
          var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this reader is already defined for super class @")).operator_concat (operand_276324->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7297)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_276783 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7302)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_276783 = NULL ;
    while (((operand_276783 = enumerator_276783.nextObject ()))) {
      macroValidPointer (operand_276783) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_readerName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7304)), operand_276783->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7305)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7303)) ;
      var_cas_methodLocalVariablesMap.modifier_insertUsedConstInArgument (inLexique, operand_276783->mAttributeName, operand_276783->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7309)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i68_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_279784 = (var_cas_ioSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7379)))).operator_not () ;
  if (cond_279784.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_typeSuperClassesMap::cEnumerator enumerator_282240 (var_cas_ancestorClassesMap, true) ;
    const GGS_typeSuperClassesMap::cElement * operand_282240 = NULL ;
    while (((operand_282240 = enumerator_282240.nextObject ()))) {
      macroValidPointer (operand_282240) ;
      GGS_string var_cas_keyClassMethod = ((operand_282240->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7435))) ;
      const GGS_bool cond_282545 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7436)).reader_hasKey (var_cas_keyClassMethod) ;
      if (cond_282545.isBuiltAndTrue ()) {
        var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_282240->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7439)) ;
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_beginning_5F_by_5F_abstract_i69_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_284250 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7482)))).operator_not () ;
  if (cond_284250.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_287994 = (var_cas_categoryMethodKind).operator_isEqual (GGS_categoryMethodKind::constructor_overridingMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (7539))) ;
  if (cond_287994.isBuiltAndTrue ()) {
    var_cas_baseClassName = GGS_string ("") ;
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_286965 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_286965 = NULL ;
      while (((operand_286965 = enumerator_286965.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_286965) ;
        GGS_string var_cas_keyClassMethod = ((operand_286965->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7543))) ;
        var_cas_baseClassName = operand_286965->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7544)) ;
        ...
        const GGS_bool cond_287770 = var_cas_found ;
        if (cond_287770.isBuiltAndTrue ()) {
          GGS_categoryMethodKind var_cas_localCategoryMethodKind ;
          GGS_L_EXsignature  var_cas_listeDeTypesPrecedenteDeclaration ;
          const GGS_EXcategoryTemplateMap  temp_287378 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          if (temp_287378.isBuilt ()) {
            temp_287378 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_keyClassMethod, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (7550)), var_cas_localCategoryMethodKind, var_cas_listeDeTypesPrecedenteDeclaration COMMA_SOURCE_FILE_AT_LINE (7549)) ;
          }
    ...
    const GGS_bool cond_287982 = (var_cas_found).operator_not () ;
    if (cond_287982.isBuiltAndTrue ()) {
  ...
  }else if (cond_287994.isBuiltAndFalse ()) {
    {
      GGS_typeSuperClassesMap::cEnumerator enumerator_288071 (var_cas_ancestorClassesMap, true) ;
      const GGS_typeSuperClassesMap::cElement * operand_288071 = NULL ;
      while (((operand_288071 = enumerator_288071.nextObject ()))) {
        macroValidPointer (operand_288071) ;
        GGS_string var_cas_keyClassMethod = ((operand_288071->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))).operator_concat (GGS_string (":"))).operator_concat (var_cas_templateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7568))) ;
        const GGS_bool cond_288385 = var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7569)).reader_hasKey (var_cas_keyClassMethod) ;
        if (cond_288385.isBuiltAndTrue ()) {
          var_cas_templateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this template is already defined for super class @")).operator_concat (operand_288071->mKey)).operator_concat (GGS_string (": you should use the 'override' key word")) COMMA_SOURCE_FILE_AT_LINE (7572)) ;
        }
      }
    }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_288538 (var_cas_classType.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (7577)), true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_288538 = NULL ;
    while (((operand_288538 = enumerator_288538.nextObject ()))) {
      macroValidPointer (operand_288538) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_templateName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (7579)), operand_288538->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7580)), GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (7578)) ;
      var_cas_categoryTemplateVariableMap.modifier_insertKey (inLexique, operand_288538->mAttributeName, operand_288538->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (7584)) ;
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i70_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_291352 = (var_cas_ioSemanticContext.reader_mCategoryTemplateMap (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7653)))).operator_not () ;
  if (cond_291352.isBuiltAndTrue ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_292660 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7687))))).operator_not () ;
      if (cond_292660.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_293352 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_293352 = NULL ;
        while (((operand_293352 = enumerator_293352.nextObject ()))) {
          macroValidPointer (operand_293352) ;
          var_cas_extractSignature.addAssign_operation (operand_293352->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7709))) ;
          var_cas_inputSignature.addAssign_operation (operand_293352->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7710))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i71_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_84 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_294799 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7742))))).operator_not () ;
      if (cond_294799.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_inputSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_295491 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_295491 = NULL ;
        while (((operand_295491 = enumerator_295491.nextObject ()))) {
          macroValidPointer (operand_295491) ;
          var_cas_extractSignature.addAssign_operation (operand_295491->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7764))) ;
          var_cas_inputSignature.addAssign_operation (operand_295491->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (7765))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_85 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_297355 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7802))))).operator_not () ;
      if (cond_297355.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_297999 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_297999 = NULL ;
        while (((operand_297999 = enumerator_297999.nextObject ()))) {
          macroValidPointer (operand_297999) ;
          var_cas_extractSignature.addAssign_operation (operand_297999->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7823))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_86 = true ;
        while (syntaxRepeat_86) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            const GGS_bool cond_298690 = var_cas_usedSortedAttributes.reader_hasKey (var_cas_sortAttribute.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7839))) ;
            if (cond_298690.isBuiltAndTrue ()) {
            ...
            }else if (cond_298690.isBuiltAndFalse ()) {
              GGS_AC_galgasType  var_cas_definitionType ;
              GGS_bool automatic_var_298802_0 ;
              GGS_bool automatic_var_298802_1 ;
              if (var_cas_tableAttributs.isBuilt ()) {
                var_cas_tableAttributs (HERE)->method_searchKey (inLexique, var_cas_sortAttribute, var_cas_definitionType, automatic_var_298802_0, automatic_var_298802_1 COMMA_SOURCE_FILE_AT_LINE (7843)) ;
              }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i72_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_85 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
      const GGS_bool cond_300317 = ((var_cas_tableEnAvant.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883)))).operator_or (var_cas_ioComponentSemanticsEntitiesMap.reader_hasKey (var_cas_listTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7883))))).operator_not () ;
      if (cond_300317.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      GGS_L_EXsignature  var_cas_extractSignature = GGS_L_EXsignature ::constructor_emptyList () ;
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_300961 (var_cas_listeTousAttributsSemantiques, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_300961 = NULL ;
        while (((operand_300961 = enumerator_300961.nextObject ()))) {
          macroValidPointer (operand_300961) ;
          var_cas_extractSignature.addAssign_operation (operand_300961->mAttributType, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (7904))) ;
        }
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_90 = true ;
                while (syntaxRepeat_90) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    const GGS_bool cond_303399 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7971))).operator_isEqual (GGS_string ("nogetter")) ;
                    if (cond_303399.isBuiltAndTrue ()) {
                      const GGS_bool cond_303349 = (var_cas_hasGetter).operator_not () ;
                      if (cond_303349.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_303399.isBuiltAndFalse ()) {
                      const GGS_bool cond_303601 = (var_cas_directiveName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7976))).operator_isEqual (GGS_string ("setter")) ;
                      if (cond_303601.isBuiltAndTrue ()) {
                        const GGS_bool cond_303553 = var_cas_hasSetter ;
                        if (cond_303553.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_303601.isBuiltAndFalse ()) {
...
void routine_recursivelyEnumerateDirectoriesEX (C_CompilerEx & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311160 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_311160 = NULL ;
    while (((operand_311160 = enumerator_311160.nextObject ()))) {
      macroValidPointer (operand_311160) ;
      const GGS_bool cond_311667 = var_cas_inExtensionMap.reader_hasKey (operand_311160->mValue.reader_pathExtension ()) ;
      if (cond_311667.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311160->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_311160->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_311160->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (8181)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (8180)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_311904 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_311904 = NULL ;
    while (((operand_311904 = enumerator_311904.nextObject ()))) {
      macroValidPointer (operand_311904) ;
      ...
      ::routine_recursivelyEnumerateDirectoriesEX (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_311904->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_311904->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (8195)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_311904->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_313697 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_313697.isBuiltAndTrue ()) {
    var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8248)) ;
  }else if (cond_313697.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_313977 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
  if (cond_313977.isBuiltAndTrue ()) {
  ...
  }else if (cond_313977.isBuiltAndFalse ()) {
            ...
            while (syntaxRepeat_94) {
              switch (select_semantics_5F_parser_94 (inLexique)) {
                case 2 : {
                  ...
                  const GGS_bool cond_316307 = var_cas_parameterIsUsed ;
                  if (cond_316307.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_316307.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i76_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_319038 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8381)))).operator_not () ;
  if (cond_319038.isBuiltAndTrue ()) {
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_318244 = (var_cas_sourcePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_318244.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = var_cas_sourcePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8385)) ;
    }else if (cond_318244.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_318534 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_318534.isBuiltAndTrue ()) {
    ...
    }else if (cond_318534.isBuiltAndFalse ()) {
      GGS_wrapperFileSortedListEX  var_cas_wrapperFileSortedList ;
      GGS_wrapperDirectorySortedListEX  var_cas_wrapperDirectorySortedList ;
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
  ...
  const GGS_bool cond_320097 = (var_cas_ioSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)).reader_hasKey (var_cas_wrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8442)))).operator_not () ;
  if (cond_320097.isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_98 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_325707 = var_cas_acceptAddAssignOperatorCall ;
              if (cond_325707.isBuiltAndTrue ()) {
              ...
              }else if (cond_325707.isBuiltAndFalse ()) {
      ...
      switch (select_semantics_5F_parser_96 (inLexique)) {
        ...
        case 4 : {
          ...
          switch (select_semantics_5F_parser_98 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2B__3D_) COMMA_HERE) ;
              const GGS_bool cond_329964 = (var_cas_addAssignFormalInputArgumentList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_329964.isBuiltAndTrue ()) {
              ...
              }else if (cond_329964.isBuiltAndFalse ()) {
                var_cas_acceptAddAssignOperatorCall = GGS_bool (true) ;
              }
              { bool syntaxRepeat_99 = true ;
                while (syntaxRepeat_99) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i79_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_331896 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8772))) ;
  if (cond_331896.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
  ...
  }else if (cond_331896.isBuiltAndFalse ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i80_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_332729 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8795))) ;
  if (cond_332729.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_332729.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i81_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_333699 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8820))) ;
  if (cond_333699.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_333699.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_formal_5F_argument_5F_type_i82_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outGalgasTypeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  const GGS_bool cond_334684 = var_cas_inComponentSemanticsEntitiesMap.reader_hasKey (var_cas_outGalgasTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (8846))) ;
  if (cond_334684.isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_entite ;
    if (var_cas_inComponentSemanticsEntitiesMap.isBuilt ()) {
  ...
  }else if (cond_334684.isBuiltAndFalse ()) {
    if (var_cas_tableEnAvant.isBuilt ()) {
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i83_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_336230_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_336230_0) ;
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  var_cas_listeTypeEtNomsArguments ;
  GGS_signatureForGrammarAnalysis  automatic_var_338692_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioComponentSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_tableArgumentsMethode, var_cas_listeTypeEtNomsArguments, var_cas_tableEnAvant, automatic_var_338692_0) ;
  GGS_L_EXsignature  var_cas_returnedTypes = GGS_L_EXsignature ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_338901 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_338901 = NULL ;
    while (((operand_338901 = enumerator_338901.nextObject ()))) {
      macroValidPointer (operand_338901) ;
      const GGS_bool cond_339120 = (operand_338901->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8959))) ;
      if (cond_339120.isBuiltAndTrue ()) {
        operand_338901->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8961)) ;
      }else if (cond_339120.isBuiltAndFalse ()) {
        const GGS_bool cond_339329 = (operand_338901->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (8961))) ;
        if (cond_339329.isBuiltAndTrue ()) {
          operand_338901->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (8963)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_5F_begining_5F_by_5F_extern_i84_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
  {
    GGS_typeListeTypesEtNomsArgMethode::cEnumerator enumerator_341180 (var_cas_listeTypeEtNomsArguments, true) ;
    const GGS_typeListeTypesEtNomsArgMethode::cElement * operand_341180 = NULL ;
    while (((operand_341180 = enumerator_341180.nextObject ()))) {
      macroValidPointer (operand_341180) ;
      const GGS_bool cond_341399 = (operand_341180->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9013))) ;
      if (cond_341399.isBuiltAndTrue ()) {
        operand_341180->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9015)) ;
      }else if (cond_341399.isBuiltAndFalse ()) {
        const GGS_bool cond_341608 = (operand_341180->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (9015))) ;
        if (cond_341608.isBuiltAndTrue ()) {
          operand_341180->mParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a function only input parameters (\?) and constant input parameters (\?\?) can be used.") COMMA_SOURCE_FILE_AT_LINE (9017)) ;
        }
      }
    }
  }
...
void semantics_parser::rule_semantics_5F_parser_semantics_5F_declaration_i85_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semantics_5F_parser_100 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_enumConstantMap::cEnumerator enumerator_343904 (var_cas_constantMap, true) ;
        const GGS_enumConstantMap::cElement * operand_343904 = enumerator_343904.nextObject () ;
        if ((operand_343904 != NULL)) {
          bool _foreach_loop_343904 ;
          do{
            macroValidPointer (operand_343904) ;
            var_cas_s.dotAssign_operation (operand_343904->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9084))) ;
            operand_343904 = enumerator_343904.nextObject () ;
            _foreach_loop_343904 = ((operand_343904 != NULL)) ;
            if (_foreach_loop_343904) {
              var_cas_s.appendCString (", ") ;
            }
          }while (_foreach_loop_343904) ;
        }
      }
    ...
    while (syntaxRepeat_104) {
      switch (select_semantics_5F_parser_104 (inLexique)) {
        case 2 : {
          ...
          {
            GGS_enumConstantMap::cEnumerator enumerator_344724 (var_cas_constantMap, true) ;
            const GGS_enumConstantMap::cElement * operand_344724 = NULL ;
            while (((operand_344724 = enumerator_344724.nextObject ()))) {
              macroValidPointer (operand_344724) ;
              GGS_lstring  var_cas_name = GGS_lstring ::constructor_new (inLexique, operand_344724->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (9116)), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (9116)) ;
              GGS_lstring  var_cas_cstString ;
