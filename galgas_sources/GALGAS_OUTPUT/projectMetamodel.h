...
//--------------------------------- Modifiers
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setMFeatureNameAtIndex (GALGAS_lstring constinArgument0,
                                                                  GALGAS_uint constinArgument1,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) ;

  public : VIRTUAL_IN_DEBUG void modifier_setMFeatureValueAtIndex (GALGAS_lstring constinArgument0,
                                                                   GALGAS_uint constinArgument1,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_qualifiedFeatureList reader_subListWithRange (const GALGAS_uint & constinOperand0,
                                                                                 const GALGAS_uint & constinOperand1,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) const ;
