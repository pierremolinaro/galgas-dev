...
//---------------------------------------------------------------------------*
//                                                                           *
//              Declarations for 'projectComponentAST' struct                *
//                                                                           *
//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_projectComponentAST ;

//---------------------------------------------------------------------------*

class GGS_projectComponentAST : public GGS__root {
//--- Default constructor
  public : GGS_projectComponentAST (void) ;

//--- Virtual destructor
  public : virtual ~GGS_projectComponentAST (void) ;
...
//--- Support for method call handling in GALGAS
  public : inline const GGS_projectComponentAST * operator () (UNUSED_LOCATION_ARGS) const { return this ; }
  public : inline GGS_projectComponentAST * operator () (UNUSED_LOCATION_ARGS) { return this ; }

//--- Comparison
  public : GGS_bool operator_isEqual (const GGS_projectComponentAST & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_projectComponentAST & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_projectComponentAST castFromObject (C_CompilerEx & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;

//--- Galgas 'new' destructor
  public : static GGS_projectComponentAST constructor_new (const GGS_projectSourceList & argument_0,
...
//--- Readers
  public : inline GGS_projectSourceList 
  reader_mProjectSourceList (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
    return mProjectSourceList ;
  }

  public : inline GGS_lstringlist 
  reader_mGenerationFeatureList (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
    return mGenerationFeatureList ;
  }

  public : inline GGS_lstring 
  reader_mProjectName (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
    return mProjectName ;
  }

  public : inline GGS_lstring 
  reader_mTargetName (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
    return mTargetName ;
  }
...
//--- Attributes
  public : GGS_projectSourceList  mProjectSourceList ;
  public : GGS_lstringlist  mGenerationFeatureList ;
  public : GGS_lstring  mProjectName ;
  public : GGS_lstring  mTargetName ;
