...
//--- Current element access
  public : GALGAS_projectSourceList_3A_element current (LOCATION_ARGS) const ;
} ;
...
//--- Current element access
  public : GALGAS_qualifiedFeatureList_3A_element current (LOCATION_ARGS) const ;
} ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                   @projectSourceList_3A_element struct                    *
//                                                                           *
//---------------------------------------------------------------------------*

class GALGAS_projectSourceList_3A_element : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default constructor
  public : GALGAS_projectSourceList_3A_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_projectSourceList_3A_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_projectSourceList_3A_element (const GALGAS_sourceFileKind & in_mSourceKind,
                                                const GALGAS_lstring & in_mFilePath) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_projectSourceList_3A_element extractObject (const GALGAS_object & inObject,
                                                                     C_Compiler * inCompiler,
                                                                     const GALGAS_location & inErrorLocation
                                                                     COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_projectSourceList_3A_element constructor_new (const GALGAS_sourceFileKind & inOperand0,
                                                                       const GALGAS_lstring & inOperand1
                                                                       COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const PMSInt32 inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_projectSourceList_3A_element & inOperand) const ;
...
} ; // End of GALGAS_projectSourceList_3A_element class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_projectSourceList_3A_element ;

//---------------------------------------------------------------------------*
//                                                                           *
//                  @qualifiedFeatureList_3A_element struct                  *
//                                                                           *
//---------------------------------------------------------------------------*

class GALGAS_qualifiedFeatureList_3A_element : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default constructor
  public : GALGAS_qualifiedFeatureList_3A_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_qualifiedFeatureList_3A_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_qualifiedFeatureList_3A_element (const GALGAS_lstring & in_mFeatureName,
                                                   const GALGAS_lstring & in_mFeatureValue) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_qualifiedFeatureList_3A_element extractObject (const GALGAS_object & inObject,
                                                                        C_Compiler * inCompiler,
                                                                        const GALGAS_location & inErrorLocation
                                                                        COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_qualifiedFeatureList_3A_element constructor_new (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_lstring & inOperand1
                                                                          COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const PMSInt32 inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_qualifiedFeatureList_3A_element & inOperand) const ;
...
} ; // End of GALGAS_qualifiedFeatureList_3A_element class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_qualifiedFeatureList_3A_element ;
