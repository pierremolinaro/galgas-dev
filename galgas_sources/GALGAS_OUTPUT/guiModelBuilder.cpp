    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_guiModelBuilder_0 (inLexique)) {
        ...
        case 3 : {
          ...
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("when source file extension is '.gGui', the 'import__' construct is obsolete and has no effect: you can delete it") COMMA_SOURCE_FILE_AT_LINE (52)) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
          } break ;
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_import) COMMA_HERE) ;
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("when source file extension is '.gGui', the 'import' construct is obsolete and has no effect: you can delete it") COMMA_SOURCE_FILE_AT_LINE (57)) ;
  ...
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
      switch (select_repeat_guiModelBuilder_2 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("when source file extension is '.gGui', this construct outside a 'with lexique' is obsolete and has no effect: you can delete it") COMMA_SOURCE_FILE_AT_LINE (80)) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          { bool syntaxRepeat_4 = true ;
            while (syntaxRepeat_4) {
                ...
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                var_cas_mValue = GGS_lstring ::constructor_new (inLexique, (var_cas_mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94))).operator_concat (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94))), var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("when source file extension is '.gGui', the 'label' construct outside a 'with lexique' is obsolete and has no effect: you can delete it") COMMA_SOURCE_FILE_AT_LINE (101)) ;
                ...
                case 3 : {
                  ...
                  { bool syntaxRepeat_7 = true ;
                    while (syntaxRepeat_7) {
                        ...
                        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                        var_cas_value = GGS_lstring ::constructor_new (inLexique, (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133))).operator_concat (var_cas_v.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133))), var_cas_v.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_HERE) ;
                      switch (select_repeat_guiModelBuilder_7 (inLexique)) {
                        case 2 : {
                          } break ;
                        default :
