        ...
        case 2 : {
          ...
          { bool syntaxRepeat_1 = true ;
            while (syntaxRepeat_1) {
                ...
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                var_cas_mValue = GGS_lstring ::constructor_new (inLexique, (var_cas_mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52))).operator_concat (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52))), var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_HERE) ;
                    ...
                    case 3 : {
                      ...
                      { bool syntaxRepeat_5 = true ;
                        while (syntaxRepeat_5) {
                            ...
                            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                            var_cas_value = GGS_lstring ::constructor_new (inLexique, (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90))).operator_concat (var_cas_v.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90))), var_cas_v.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) COMMA_HERE) ;
