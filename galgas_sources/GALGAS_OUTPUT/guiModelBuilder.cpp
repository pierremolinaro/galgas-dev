                ...
                case 3 : {
                  ...
                  { bool syntaxRepeat_7 = true ;
                    while (syntaxRepeat_7) {
                        ...
                        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
                        var_cas_value = GGS_lstring ::constructor_new (inLexique, (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128))).operator_concat (var_cas_v.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128))), var_cas_v.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) COMMA_HERE) ;
