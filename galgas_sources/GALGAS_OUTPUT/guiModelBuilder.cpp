...
void guiModelBuilder::rule_guiModelBuilder_gui_5F_component_5F_start_5F_symbol_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_guiSimpleAttributeList  var_cas_simpleGlobalAttributes = GGS_guiSimpleAttributeList ::constructor_emptyList () ;
  GGS_withLexiqueList  var_cas_withLexiqueList = GGS_withLexiqueList ::constructor_emptyList () ;
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_guiModelBuilder_0 (inLexique)) {
        case 2 : {
          GGS_lstring  var_cas_mKey ;
          inLexique.assignFromAttribute_tokenString (var_cas_mKey) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_HERE) ;
          GGS_lstring  var_cas_mValue = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          switch (select_guiModelBuilder_2 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
              GGS_guiLabelList  var_cas_labels = GGS_guiLabelList ::constructor_emptyList () ;
              GGS_guiSimpleAttributeList  var_cas_simpleAttributes = GGS_guiSimpleAttributeList ::constructor_emptyList () ;
              GGS_guiCompoundAttributeList  var_cas_compoundAttributes = GGS_guiCompoundAttributeList ::constructor_emptyList () ;
                ...
                while (syntaxRepeat_3) {
                  switch (select_guiModelBuilder_3 (inLexique)) {
                    case 2 : {
                      ...
                      { bool syntaxRepeat_4 = true ;
                        while (syntaxRepeat_4) {
                          ...
                          switch (select_guiModelBuilder_4 (inLexique)) {
                            case 2 : {
                    ...
                    case 3 : {
                      ...
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_HERE) ;
                      GGS_lstring  var_cas_value = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
                      { bool syntaxRepeat_5 = true ;
                        while (syntaxRepeat_5) {
                          ...
                          switch (select_guiModelBuilder_5 (inLexique)) {
                            case 2 : {
                              } break ;
                            default :
