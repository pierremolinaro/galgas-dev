...
class GGS_parseDoInstructionList ;
class GGS_parseDoInstruction ;
class cPtr_parseDoInstruction ;
class GGS_blockInstructionList ;
...
//--- Readers
  public : GGS_syntaxInstructionsList  reader_mParseDoBranchList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
//--- operator ()
  #ifndef DO_NOT_GENERATE_CHECKINGS
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      list '@parseDoInstructionList'                       *
//                                                                           *
//---------------------------------------------------------------------------*

class GGS_parseDoInstructionList : public AC_galgas_list {
  public : typedef cPtr_parseDoInstruction element_type ;
//--- Constructor 'emptyList'
  public : static GGS_parseDoInstructionList constructor_emptyList (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_parseDoInstructionList constructor_listWithValue (C_Compiler & _inLexique,
                                const GGS_syntaxInstructionsList & argument_0
                                COMMA_LOCATION_ARGS) ;
//--- Get first object
  public : inline element_type * firstObject (void) const {
...
//--- Operator () used for method call
  public : inline const GGS_parseDoInstructionList * operator () (UNUSED_LOCATION_ARGS) const { return this ;}
...
//--- Handling '.' GALGAS operator
  public : GGS_parseDoInstructionList _operator_concat (const GGS_parseDoInstructionList & inOperand) const ;
  public : void modifier_prependValue (C_Compiler & _inLexique,
                                const GGS_syntaxInstructionsList & argument_0
                                COMMA_LOCATION_ARGS) ;
//--- Internal Methods
...
//---------------------------------------------------------------------------*
//                                                                           *
//                       list '@blockInstructionList'                        *
//                                                                           *
//---------------------------------------------------------------------------*

class GGS_blockInstructionList : public AC_galgas_list {
  public : typedef cPtr_blockInstruction element_type ;
//--- Constructor 'emptyList'
  public : static GGS_blockInstructionList constructor_emptyList (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_blockInstructionList constructor_listWithValue (C_Compiler & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_actualParameters & argument_2,
                                const GGS_syntaxInstructions & argument_3,
...
//--- Operator () used for method call
  public : inline const GGS_blockInstructionList * operator () (UNUSED_LOCATION_ARGS) const { return this ;}
...
//--- Handling '.' GALGAS operator
  public : GGS_blockInstructionList _operator_concat (const GGS_blockInstructionList & inOperand) const ;
  public : void modifier_prependValue (C_Compiler & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_actualParameters & argument_2,
...
//---------------------------------------------------------------------------*
//                                                                           *
//                Element of list '@parseDoInstructionList'                  *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_parseDoInstruction : public cPtr_syntaxInstruction {
//--- Attributes
  public : GGS_syntaxInstructionsList  mParseDoBranchList ;
//--- Constructor
  public : cPtr_parseDoInstruction (const GGS_syntaxInstructionsList & 
                                COMMA_LOCATION_ARGS) ;
...
//--- Friend class declarations
  friend class GGS_parseDoInstructionList ;
} ;

//---------------------------------------------------------------------------*
//                                                                           *
//                 Element of list '@blockInstructionList'                   *
//                                                                           *
//---------------------------------------------------------------------------*
...
//--- Friend class declarations
  friend class GGS_blockInstructionList ;
} ;
