...
GALGAS_string function_checkMethodImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inMethodName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_33053_0 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_33056_0 ; // Joker input parameter
    GALGAS_location joker_33059_0 ; // Joker input parameter
    GALGAS_bool joker_33062_0 ; // Joker input parameter
    GALGAS_string joker_33094_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 833)).method_searchKey (constinArgument_inMethodName, joker_33053_0, joker_33056_0, joker_33059_0, joker_33062_0, var_qualifier, joker_33094_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 833)) ;
...
GALGAS_string function_checkModifierImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inModifierName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodQualifier var_qualifier ;
    GALGAS_methodKind joker_37650_3 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_37650_2 ; // Joker input parameter
    GALGAS_bool joker_37650_1 ; // Joker input parameter
    GALGAS_string joker_37665_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 965)).method_searchKey (constinArgument_inModifierName, joker_37650_3, joker_37650_2, joker_37650_1, var_qualifier, joker_37665_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 965)) ;
    if (var_qualifier.isValid ()) {
      switch (var_qualifier.enumValue ()) {
      case GALGAS_methodQualifier::kNotBuilt:
        break ;
...
void routine_checkExpressionIsBoolean (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      const cMapElement_readerMap * objectArray_57805 = (const cMapElement_readerMap *) var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1493)).readAccessForWithInstruction (GALGAS_string ("bool")) ;
      if (NULL != objectArray_57805) {
          macroValidSharedObject (objectArray_57805, cMapElement_readerMap) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, objectArray_57805->mAttribute_mReturnedType.objectCompare (var_boolType)).boolEnum () ;
        if (kBoolTrue == test_4) {
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, objectArray_57805->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1496)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_5) {
            ...
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_57805->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              inCompiler->emitSemanticError (constinArgument_inErrorLocation, objectArray_57805->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1499)) ;
              outArgument_outExpression.drop () ; // Release error dropped variable
            }else if (kBoolFalse == test_6) {
              outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_boolType, constinArgument_inErrorLocation, objectArray_57805->mAttribute_mKind, constinArgument_inExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1506)), GALGAS_string ("bool"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1508)), objectArray_57805->mAttribute_mHasCompilerArgument  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1501)) ;
            }
          }
        }
      }else{
        ...
        if (kBoolTrue == test_7) {
          ...
          cEnumerator_readerMap enumerator_59007 (var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1520)), kEnumeration_up) ;
          while (enumerator_59007.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - ").operator_concat (enumerator_59007.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1521))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1521))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1521)) ;
            cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_59079 (enumerator_59007.current_mArgumentTypeList (HERE), kEnumeration_up) ;
            while (enumerator_59079.hasCurrentObject ()) {
              var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_59079.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1523))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1523))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1523)) ;
              enumerator_59079.gotoNextObject () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_59007.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1525))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1525))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1525)) ;
            enumerator_59007.gotoNextObject () ;
          }
...
static void categoryMethod_methodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_location joker_31455_0 ; // Joker input parameter
  GALGAS_methodQualifier joker_31479_0 ; // Joker input parameter
  var_receiverExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 780)).reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 780)).method_searchKey (object->mAttribute_mMethodName, var_kind, var_routineSignature, joker_31455_0, var_hasCompilerArgument, joker_31479_0, var_errorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 780)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 798)).isValid ()) {
      uint32_t variant_32034 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 798)).uintValue () ;
      bool loop_32034 = true ;
      while (loop_32034) {
        loop_32034 = var_searching.isValid () ;
        if (loop_32034) {
          loop_32034 = var_searching.boolValue () ;
        }
        if (loop_32034 && (0 == variant_32034)) {
          loop_32034 = false ;
...
static void categoryMethod_modifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_34046 (object->mAttribute_mReceiverStructAttributes, kEnumeration_up) ;
  while (enumerator_34046.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_34046.current_mValue (HERE), var_receiverType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 859)) ;
    enumerator_34046.gotoNextObject () ;
  }
  GALGAS_formalParameterSignature var_routineSignature ;
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_string var_modifierErrorMessage ;
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_34437_0 ; // Joker input parameter
  var_receiverType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 866)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_34437_0, var_modifierErrorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 866)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 885)).isValid ()) {
      uint32_t variant_35037 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 885)).uintValue () ;
      bool loop_35037 = true ;
      while (loop_35037) {
        loop_35037 = var_searching.isValid () ;
        if (loop_35037) {
          loop_35037 = var_searching.boolValue () ;
        }
        if (loop_35037 && (0 == variant_35037)) {
          loop_35037 = false ;
...
static void categoryMethod_selfModifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_36675_0 ; // Joker input parameter
  GALGAS_string joker_36678_0 ; // Joker input parameter
  var_selfTypeProxy.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 931)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_36675_0, joker_36678_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 931)) ;
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  {
...
static void categoryMethod_concatInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_38630 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_38630.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_38630.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 991)) ;
    enumerator_38630.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
...
static void categoryMethod_plusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_41999 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_41999.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_41999.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1081)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_semanticExpressionListAST enumerator_42998 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_43026 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_42998.hasCurrentObject () && enumerator_43026.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_42998.current_mExpression (HERE).ptr (), enumerator_43026.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1100)) ;
        {
        routine_checkAssignmentTypes (enumerator_43026.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1106)), enumerator_42998.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1106)) ;
        }
        var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1107)) ;
        enumerator_42998.gotoNextObject () ;
        enumerator_43026.gotoNextObject () ;
      }
...
static void categoryMethod_plusEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_44276 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_44276.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_44276.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1135)) ;
...
static void categoryMethod_selfPlusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticExpressionListAST enumerator_46901 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_46929 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_46901.hasCurrentObject () && enumerator_46929.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_46901.current_mExpression (HERE).ptr (), enumerator_46929.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1196)) ;
        {
        routine_checkAssignmentTypes (enumerator_46929.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1202)), enumerator_46901.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1202)) ;
        }
        var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1203)) ;
        enumerator_46901.gotoNextObject () ;
        enumerator_46929.gotoNextObject () ;
      }
...
static void categoryMethod_incrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_49621_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_49621_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1269)) ;
  }
  cEnumerator_lstringlist enumerator_49656 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_49656.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_49656.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1272)) ;
...
static void categoryMethod_decrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_52008_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_52008_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1330)) ;
  }
  cEnumerator_lstringlist enumerator_52043 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_52043.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_52043.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1333)) ;
    enumerator_52043.gotoNextObject () ;
  }
...
static void categoryMethod_logInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_logListAST enumerator_55178 (object->mAttribute_mLogList, kEnumeration_up) ;
  while (enumerator_55178.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_55178.current_mLogExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1420)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1419)) ;
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_logInstructionForGeneration::constructor_new (enumerator_55178.current_mLogMessage (HERE), var_expression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1426))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1426)) ;
...
static void categoryMethod_dropInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_56015 (object->mAttribute_mDropList, kEnumeration_up) ;
  while (enumerator_56015.hasCurrentObject ()) {
    GALGAS_string var_variableCppName ;
    GALGAS_unifiedTypeMapProxy var_t ;
    {
    GALGAS_string joker_56141_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForDropAccess (enumerator_56015.current_mValue (HERE), var_t, var_variableCppName, joker_56141_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1444)) ;
    }
...
static void categoryMethod_enumeratedCollectionImplicitVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_62796 (var_enumerationDescriptorList, kEnumeration_up) ;
  while (enumerator_62796.hasCurrentObject ()) {
    ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_62796.current_mEnumeratedType (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_62796.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1633)), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1633)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1634)).operator_concat (enumerator_62796.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1634))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1634)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1634))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1631)) ;
    enumerator_62796.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumeratedCollectionCstListInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_enumerationDescriptorList enumerator_64259 (var_currentTypedAttributeList, kEnumeration_up) ;
      while (enumerator_64259.hasCurrentObject ()) {
        {
        ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_64259.current_mEnumerationName (HERE), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1665)), enumerator_64259.current_mEnumeratedType (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1667)).operator_concat (enumerator_64259.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1667))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1667)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1667)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1668)).operator_concat (enumerator_64259.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1668))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1668)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1668)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1664)) ;
        }
        enumerator_64259.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_5) {
          ...
          cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_65593 (object->mAttribute_mElementList, kEnumeration_up) ;
          cEnumerator_enumerationDescriptorList enumerator_65620 (var_enumerationDescriptorList, kEnumeration_up) ;
          while (enumerator_65593.hasCurrentObject () && enumerator_65620.hasCurrentObject ()) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_65593.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1689)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_65593.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_65593.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1691)) ;
                const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_65620.current_mEnumeratedType (HERE))).boolEnum () ;
                if (kBoolTrue == test_10) {
                  GALGAS_location location_11 (enumerator_65593.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_11, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693)).operator_concat (enumerator_65620.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693)) ;
                }
              }
              ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_65620.current_mEnumeratedType (HERE), enumerator_65593.current_mConstantName (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1696)).operator_concat (enumerator_65620.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1696))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1696)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1696))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1696)) ;
            }
            enumerator_65593.gotoNextObject () ;
            enumerator_65620.gotoNextObject () ;
          }
        }
      }
    }
...
static void categoryMethod_forInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_69746.hasCurrentObject ()) {
    ...
    enumerator_69746.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_localInitializedVariableList enumerator_70309 (var_localConstantListForDoBranch, kEnumeration_up) ;
  while (enumerator_70309.hasCurrentObject ()) {
    {
    ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_70309.current_mName (HERE), enumerator_70309.current_mType (HERE), enumerator_70309.current_mCppName (HERE), enumerator_70309.current_mCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1807)) ;
    }
...
static void categoryMethod_foreachInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_foreachInstructionEnumeratedObjectListAST enumerator_74084 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_74084.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_74084.current_mEnumeratedExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1922)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1921)) ;
    GALGAS_string var_enumerationOrder = enumerator_74084.current_mEnumerationOrder (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1928)) ;
    GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (enumerator_74084.current_mEndOfEnumerationExpression (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1929)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1929))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1929)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringlist enumerator_75139 (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1940)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1940)), kEnumeration_up) ;
        bool bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1940)).isValidAndTrue () ;
        if (enumerator_75139.hasCurrentObject () && bool_2) {
          while (enumerator_75139.hasCurrentObject () && bool_2) {
            var_found = GALGAS_bool (kIsEqual, var_enumerationOrder.objectCompare (enumerator_75139.current_mValue (HERE))) ;
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  \\").operator_concat (enumerator_75139.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)) ;
            enumerator_75139.gotoNextObject () ;
            if (enumerator_75139.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_74084.current_mEnumerationOrder (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_5) {
        ...
        cEnumerator_enumerationDescriptorList enumerator_75642 (var_currentTypedAttributeList, kEnumeration_up) ;
        while (enumerator_75642.hasCurrentObject ()) {
          {
          ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_74084.current_mPrefix (HERE).mAttribute_string.operator_concat (enumerator_75642.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)), enumerator_74084.current_mEndOfEnumerationExpression (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)), enumerator_75642.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1955)).operator_concat (enumerator_75642.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1955))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1955)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1955)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956)).operator_concat (enumerator_75642.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)) ;
          }
          enumerator_75642.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = enumerator_74084.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1959)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_74084.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1959)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1959)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1959)).boolEnum () ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_9) {
            ...
            cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_77012 (enumerator_74084.current_mElementList (HERE), kEnumeration_up) ;
            cEnumerator_enumerationDescriptorList enumerator_77039 (var_enumerationDescriptorList, kEnumeration_up) ;
            while (enumerator_77012.hasCurrentObject () && enumerator_77039.hasCurrentObject ()) {
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_77012.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1977)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_77012.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_77012.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1979)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_77039.current_mEnumeratedType (HERE))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    GALGAS_location location_15 (enumerator_77012.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_15, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981)).operator_concat (enumerator_77039.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1981)) ;
                  }
                }
                {
                ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_77012.current_mConstantName (HERE), enumerator_77039.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1987)).operator_concat (enumerator_77039.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1987))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1987)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1987)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1988)).operator_concat (enumerator_77039.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1988))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1988)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1988)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1984)) ;
                }
              }
              enumerator_77012.gotoNextObject () ;
              enumerator_77039.gotoNextObject () ;
            }
          }
        }
      }
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_castInstructionBranchListAST enumerator_82997 (object->mAttribute_mCastInstructionBranchList, kEnumeration_up) ;
  while (enumerator_82997.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_82997.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2144)) ;
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2148)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2148)).isValid ()) {
      uint32_t variant_83285 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2148)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2148)).uintValue () ;
      bool loop_83285 = true ;
      while (loop_83285) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_82997.current_mConstantVarName (HERE).mAttribute_string.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2161)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_localConstantName = GALGAS_string ("cast_").operator_concat (enumerator_82997.current_mConstantVarName (HERE).reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162)).operator_concat (enumerator_82997.current_mConstantVarName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2162)) ;
      var_localConstantList.addAssign_operation (var_type, enumerator_82997.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2163)) ;
    }else if (kBoolFalse == test_2) {
      var_localConstantName = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2177)), enumerator_82997.current_mInstructionList (HERE), enumerator_82997.current_mEndOfInstructions (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2174)) ;
    }
    var_castBranchList.addAssign_operation (enumerator_82997.current_mTypeComparisonKind (HERE), var_type, var_localConstantName, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2183)) ;
    enumerator_82997.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  {
  GALGAS_string joker_87204_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_87204_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2253)) ;
  }
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_90766_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_90766_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2322)) ;
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_94241 (var_receiverType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2420)), kEnumeration_up) ;
    bool bool_1 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2420)).isValidAndTrue () ;
    if (enumerator_94241.hasCurrentObject () && bool_1) {
      while (enumerator_94241.hasCurrentObject () && bool_1) {
        var_found = GALGAS_bool (kIsEqual, enumerator_94241.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_94241.gotoNextObject () ;
        if (enumerator_94241.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_95393 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2444)), kEnumeration_up) ;
  while (enumerator_95393.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_95393.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_95393.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2447))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2447)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2447)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2449)).operator_concat (enumerator_95393.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2449))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2449))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2445)) ;
    enumerator_95393.gotoNextObject () ;
  }
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_98239_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_98239_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2516)) ;
  }
  cEnumerator_lstringlist enumerator_98267 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_98267.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_98267.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2524)) ;
    enumerator_98267.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_4) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_98799 (var_targetType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2533)), kEnumeration_up) ;
    bool bool_5 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2533)).isValidAndTrue () ;
    if (enumerator_98799.hasCurrentObject () && bool_5) {
      while (enumerator_98799.hasCurrentObject () && bool_5) {
        var_found = GALGAS_bool (kIsEqual, enumerator_98799.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_98799.gotoNextObject () ;
        if (enumerator_98799.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_99353 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2544)), kEnumeration_up) ;
  while (enumerator_99353.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_99353.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_99353.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2547))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2547)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2547)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548)).operator_concat (enumerator_99353.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)) ;
    enumerator_99353.gotoNextObject () ;
  }
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_102214 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_102214.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_102249 (enumerator_102214.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_102249.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_102249.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2622)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2622)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_102249.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2623)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2623)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_102249.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_102249.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2625))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2625)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2625))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2624)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_102249.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_102249.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_102249.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631)).operator_concat (GALGAS_string ("' is not a constant of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2631))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630)) ;
      }
      enumerator_102249.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2638)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2639)), enumerator_102214.current_mInstructions (HERE), enumerator_102214.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_102214.current_mSwitchConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2645)) ;
    enumerator_102214.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_103454 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_103454.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_103454.current_key (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2653))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2653)) ;
      enumerator_103454.gotoNextObject () ;
    }
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_semanticExpressionListAST enumerator_104304 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_104304.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_104304.current_mExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2680)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2679)) ;
    ...
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_104304.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2690))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2690)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2690))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2689)) ;
    }
    enumerator_104304.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_matchInstructionBranchListAST enumerator_105204 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_105204.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2701)).objectCompare (enumerator_105204.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2701)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_105438 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_105455 (enumerator_105204.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_105438.hasCurrentObject () && enumerator_105455.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_105438.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2703)) ;
        ...
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_105455.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2706)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            ...
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2709)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2709)).isValid ()) {
              uint32_t variant_105849 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2709)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2709)).uintValue () ;
              bool loop_105849 = true ;
              while (loop_105849) {
                loop_105849 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).isValid () ;
                if (loop_105849) {
                  loop_105849 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2710)).boolValue () ;
                }
                if (loop_105849 && (0 == variant_105849)) {
                  loop_105849 = false ;
            ...
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_105455.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2718)).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2718)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_105455.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2719)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_105438.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723)).operator_concat (GALGAS_string ("' class is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2722)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726)), enumerator_105455.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726)) ;
        }else if (kBoolFalse == test_2) {
          ...
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_105455.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_105438.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2730)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2730))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2730)).operator_concat (GALGAS_string ("' enumeration type is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2730))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2729)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2732)).reader_hasKey (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2732)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2732)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2732)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734)).operator_concat (enumerator_105438.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2733)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739)), enumerator_105438.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2740)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2740))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2737)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_105455.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_105438.gotoNextObject () ;
        enumerator_105455.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_105204.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2748)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2748))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2748)).operator_concat (GALGAS_string (" elements, but it acually contains ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2748)).operator_concat (enumerator_105204.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2749)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2749))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2748))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2747)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2757)), enumerator_105204.current_mMatchBranchInstructionList (HERE), enumerator_105204.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2754)) ;
    }
    ...
    enumerator_105204.gotoNextObject () ;
  }
