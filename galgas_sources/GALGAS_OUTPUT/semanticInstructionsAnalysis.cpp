...
category_method__foreachInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
  ...
  if (operand_39449 != NULL) {
    ...
    GGS_foreachInstructionEnumeratedObjectListForGeneration  var_cas_enumerationList = GGS_foreachInstructionEnumeratedObjectListForGeneration ::constructor_emptyList () ;
    {
      ...
      while (((operand_39916 = enumerator_39916.nextObject ()))) {
        ...
        if (cond_40646.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_41174 = ((operand_39916->mElementList.reader_length ()).operator_isEqual (GGS_uint (0U))).operator_and ((operand_39916->mEndsWithEllipsis).operator_not ()) ;
          if (cond_41174.isBuiltAndTrue ()) {
            const GGS_enumerationDescriptorList  var_cas_currentTypedAttributeList = var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1054)).reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (1054)) ;
            {
              ...
              while (((operand_40869 = enumerator_40869.nextObject ()))) {
                ...
                var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_39916->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1057))).operator_concat (operand_40869->mEnumerationName), operand_39916->mEndOfEnumerationExpression COMMA_SOURCE_FILE_AT_LINE (1057)), operand_40869->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".current_"))).operator_concat (operand_40869->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1056)) ;
              }
            }
          }else if (cond_41174.isBuiltAndFalse ()) {
            const GGS_bool cond_41616 = ((operand_39916->mEndsWithEllipsis).operator_not ()).operator_and ((operand_39916->mElementList.reader_length ()).operator_isNotEqual (var_cas_enumerationDescriptorList.reader_length ())) ;
            if (cond_41616.isBuiltAndTrue ()) {
            ...
            }else if (cond_41616.isBuiltAndFalse ()) {
              const GGS_bool cond_42060 = (operand_39916->mEndsWithEllipsis).operator_and ((operand_39916->mElementList.reader_length ()).operator_strictSup (var_cas_enumerationDescriptorList.reader_length ())) ;
              if (cond_42060.isBuiltAndTrue ()) {
              ...
              }else if (cond_42060.isBuiltAndFalse ()) {
                {
                  GGS_foreachInstructionEnumeratedObjectElementListAST::cEnumerator enumerator_42087 (operand_39916->mElementList, true) ;
                  const GGS_foreachInstructionEnumeratedObjectElementListAST::cElement * operand_42087 = NULL ;
                  GGS_enumerationDescriptorList::cEnumerator enumerator_42114 (var_cas_enumerationDescriptorList, true) ;
                  const GGS_enumerationDescriptorList::cElement * operand_42114 = NULL ;
                  while (((operand_42087 = enumerator_42087.nextObject ()))
                      && ((operand_42114 = enumerator_42114.nextObject ()))) {
                    macroValidPointer (operand_42087) ;
                    macroValidPointer (operand_42114) ;
                    const GGS_bool cond_42689 = (operand_42087->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1080))).operator_isNotEqual (GGS_string ("")) ;
                    if (cond_42689.isBuiltAndTrue ()) {
                      const GGS_unifiedTypeMapProxy  var_cas_foundType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42087->mTypeName COMMA_SOURCE_FILE_AT_LINE (1081)) ;
                      const GGS_bool cond_42501 = (var_cas_foundType).operator_isNotEqual (operand_42114->mEnumeratedType) ;
                      if (cond_42501.isBuiltAndTrue ()) {
                        operand_42087->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("incorrect '@")).operator_concat (var_cas_foundType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1083)))).operator_concat (GGS_string ("' type: '@"))).operator_concat (operand_42114->mEnumeratedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1083)))).operator_concat (GGS_string ("' type required here")) COMMA_SOURCE_FILE_AT_LINE (1084)) ;
                      }
                      var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, operand_42087->mConstantName, operand_42114->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".current_"))).operator_concat (operand_42114->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1085)) ;
                    }
                  }
                }
              }
    ...
    const GGS_bool cond_43879 = (operand_39449->mIndexVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1117))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_43879.isBuiltAndTrue ()) {
...
category_method__loopInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_loopInstructionAST * operand_45619,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45619 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_variantExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_45619->mVariantExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45619->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variantExpression COMMA_SOURCE_FILE_AT_LINE (1190)) ;
      }
    }
    const GGS_bool cond_46331 = (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1197))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
    if (cond_46331.isBuiltAndTrue ()) {
      operand_45619->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1199)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1199)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1199)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
    }
    GGS_semanticExpressionForGeneration  var_cas_loopExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_45619->mLoopExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45619->mLoopExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_loopExpression COMMA_SOURCE_FILE_AT_LINE (1203)) ;
      }
    }
    const GGS_bool cond_46837 = (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1210))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
    if (cond_46837.isBuiltAndTrue ()) {
      operand_45619->mEndOfLoopExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the loop expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1213)) ;
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_45619->mFirstInstructions,  operand_45619->mEndOfFirstInstructions,  var_cas_ioVariableMap,  var_cas_first_instructionList COMMA_SOURCE_FILE_AT_LINE (1218)) ;
    GGS_semanticInstructionListForGeneration  var_cas_second_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_45619->mSecondInstructions,  operand_45619->mEndOfSecondInstructions,  var_cas_ioVariableMap,  var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1230)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_45619->mEndOfLoopInstruction COMMA_SOURCE_FILE_AT_LINE (1241)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_loopInstructionForGeneration ::constructor_new (inLexique, operand_45619->mInstructionLocation, var_cas_variantExpression, var_cas_first_instructionList, var_cas_loopExpression, var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1243))) ;
  }
}
...
category_method__structuredCastInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_structuredCastInstructionAST * operand_48116,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48116 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_castExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_48116->mCastExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48116->mCastExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_castExpression COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      }
    }
    ...
    {
      GGS_castInstructionBranchListAST::cEnumerator enumerator_48731 (operand_48116->mCastInstructionBranchList, true) ;
      const GGS_castInstructionBranchListAST::cElement * operand_48731 = NULL ;
      while (((operand_48731 = enumerator_48731.nextObject ()))) {
        macroValidPointer (operand_48731) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_48731->mTypeName COMMA_SOURCE_FILE_AT_LINE (1274)) ;
        ...
        GGS_uint _variant_49176 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
        GGS_bool _condition_49176 (_variant_49176.isBuilt (), true) ;
        while (_condition_49176.isBuiltAndTrue ()) {
          _condition_49176 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1279)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1279))).operator_not ()) ;
          if (_condition_49176.isBuiltAndTrue ()) {
            if (_variant_49176.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1282)) ;
              _condition_49176 = GGS_bool (false) ;
            }else{
              _variant_49176.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_49803 = (operand_48731->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_49803.isBuiltAndTrue ()) {
          var_cas_localConstantName = (((GGS_string ("cast_")).operator_concat (operand_48731->mConstantVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1292)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1292)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1292)))).operator_concat (GGS_string ("_"))).operator_concat (operand_48731->mConstantVarName) ;
          var_cas_localConstantList.addAssign_operation (var_cas_type, operand_48731->mConstantVarName, GGS_bool (false), var_cas_localConstantName) ;
        }else if (cond_49803.isBuiltAndFalse ()) {
          var_cas_localConstantName = GGS_string ("") ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48731->mInstructionList,  operand_48731->mEndOfInstructions,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1304)) ;
        var_cas_castBranchList.addAssign_operation (operand_48731->mUseKindOfClass, var_cas_type, var_cas_localConstantName, var_cas_instructionList) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48116->mElseInstructionList,  operand_48116->mEndOfCastInstruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1318)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_48116->mEndOfCastInstruction COMMA_SOURCE_FILE_AT_LINE (1329)) ;
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_grammarInstructionAST * operand_51083,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51083 != NULL) {
    GGS_grammarLabelMap  var_cas_grammarLabelMap ;
    if (var_cas_inSemanticContext.mGrammarMap.isBuilt ()) {
      var_cas_inSemanticContext.mGrammarMap (HERE)->method_searchKey (inLexique, operand_51083->mGrammarComponentName, var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (1348)) ;
    }
    GGS_formalParameterSignature  var_cas_labelSignature ;
    if (var_cas_grammarLabelMap.isBuilt ()) {
      var_cas_grammarLabelMap (HERE)->method_searchKey (inLexique, operand_51083->mLabelName, var_cas_labelSignature COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_51083->mLabelName,  ((GGS_string ("label of the ")).operator_concat (operand_51083->mGrammarComponentName)).operator_concat (GGS_string (" grammar")),  var_cas_labelSignature,  operand_51083->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    GGS_semanticExpressionForGeneration  var_cas_sourceExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_51083->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_51083->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_sourceExpression COMMA_SOURCE_FILE_AT_LINE (1372)) ;
      }
    }
    const GGS_bool cond_52542 = operand_51083->mSourceExpressionIsFile ;
    if (cond_52542.isBuiltAndTrue ()) {
      const GGS_bool cond_52529 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1380))).operator_isNotEqual (var_cas_inPredefinedTypes.mLStringType) ;
      if (cond_52529.isBuiltAndTrue ()) {
        operand_51083->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source file path and its type should be '@lstring', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1384)) ;
      }
    }else if (cond_52542.isBuiltAndFalse ()) {
      const GGS_bool cond_52781 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1385))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
      if (cond_52781.isBuiltAndTrue ()) {
        operand_51083->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source string and its type should be '@string', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1387)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1387)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1389)) ;
      }
    }
    const GGS_bool cond_53109 = operand_51083->mSourceExpressionIsFile ;
    if (cond_53109.isBuiltAndTrue ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceFileForGeneration ::constructor_new (inLexique, operand_51083->mInstructionLocation, operand_51083->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1394)), operand_51083->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1395)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1392))) ;
    }else if (cond_53109.isBuiltAndFalse ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceExpressionForGeneration ::constructor_new (inLexique, operand_51083->mInstructionLocation, operand_51083->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)), operand_51083->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1403)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1400))) ;
    }
  }
}
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readWriteAccessWithInstructionAST * operand_53553,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53553 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_53553->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_53553->mKeyExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1420)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_53553->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1427)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1427))) ;
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_receiverVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_53553->mReceiverName, var_cas_targetType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (1431)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_54320 (operand_53553->mFieldList, true) ;
      const GGS_lstringlist::cElement * operand_54320 = NULL ;
      while (((operand_54320 = enumerator_54320.nextObject ()))) {
        macroValidPointer (operand_54320) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_54320->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (1434)) ;
        }
      }
    }
    ...
    elementOf_GGS_withAccessorMap * operand_54646 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_53553->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1439))) ;
    if (NULL != operand_54646) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_54646->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_54959 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_54959.isBuiltAndTrue ()) {
        operand_53553->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1444)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1447)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_54959.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_55013 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_55013 = NULL ;
          while (((operand_55013 = enumerator_55013.nextObject ()))) {
            macroValidPointer (operand_55013) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_55013->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_55013->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1450))) ;
          }
        }
        operand_53553->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1453)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_53553->mAccessName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1458)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    ...
    const GGS_bool cond_55880 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_55880.isBuiltAndTrue ()) {
      operand_53553->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_53553->mAccessName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1463)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1464)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1465)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1466)) ;
    }else if (cond_55880.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_55916 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_55916 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_55934 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_55934 = NULL ;
        while (((operand_55916 = enumerator_55916.nextObject ()))
            && ((operand_55934 = enumerator_55934.nextObject ()))) {
          macroValidPointer (operand_55916) ;
          macroValidPointer (operand_55934) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_55934->mType,  operand_55916->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1468)),  operand_53553->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1468)) COMMA_SOURCE_FILE_AT_LINE (1468)) ;
        }
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_56230 (var_cas_targetType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1475)), true) ;
      const GGS_typedAttributeList::cElement * operand_56230 = NULL ;
      while (((operand_56230 = enumerator_56230.nextObject ()))) {
        macroValidPointer (operand_56230) ;
        var_cas_localInitializedVariableList.addAssign_operation (operand_56230->mAttributeTypeIndex, GGS_lstring ::constructor_new (inLexique, (operand_53553->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1478))).operator_concat (operand_56230->mAttributeName), operand_53553->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1478)) COMMA_SOURCE_FILE_AT_LINE (1478)), ((var_cas_objectArrayCppName).operator_concat (GGS_string ("->mAttribute_"))).operator_concat (operand_56230->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  var_cas_localInitializedVariableList,  operand_53553->m_do_Instructions,  operand_53553->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1483)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_53553->m_else_Instructions,  operand_53553->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1495)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_53553->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1505)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, var_cas_targetType, operand_53553->mFieldList, operand_53553->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1511)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1507))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_57700,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57700 != NULL) {
    operand_57700->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @readAccessWithInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1530)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_58158,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58158 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_58158->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58158->mSwitchExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1542)) ;
      }
    }
    const GGS_bool cond_58903 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1549))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1549))) ;
    if (cond_58903.isBuiltAndTrue ()) {
      operand_58158->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1551)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1551)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1552)) ;
    }
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_59252 (operand_58158->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_59252 = NULL ;
      while (((operand_59252 = enumerator_59252.nextObject ()))) {
        macroValidPointer (operand_59252) ;
        {
          GGS_lstringlist::cEnumerator enumerator_59287 (operand_59252->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_59287 = NULL ;
          while (((operand_59287 = enumerator_59287.nextObject ()))) {
            macroValidPointer (operand_59287) ;
            const GGS_bool cond_59642 = var_cas_enumConstantStringSet.reader_hasKey (operand_59287->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1561))) ;
            if (cond_59642.isBuiltAndTrue ()) {
              const GGS_bool cond_59562 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_59287->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562))) ;
              if (cond_59562.isBuiltAndTrue ()) {
                operand_59287->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_59287->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1566)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_59287->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1567))) ;
            }else if (cond_59642.isBuiltAndFalse ()) {
              operand_59287->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_59287->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1570)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1570)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1572)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_59252->mInstructions,  operand_59252->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1575)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_59252->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_58158->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1587)) ;
    ...
    const GGS_bool cond_60720 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_60720.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_60526 (var_cas_forgottenConstants, true) ;
        while (enumerator_60526.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_60526._key (HERE)) ;
          enumerator_60526.next () ;
        }
      }
      operand_58158->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1598)) ;
    }
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_61043,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61043 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_61328 (operand_61043->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_61328 = NULL ;
      while (((operand_61328 = enumerator_61328.nextObject ()))) {
        macroValidPointer (operand_61328) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_61328->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_61328->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1618)) ;
          }
        }
        ...
        const GGS_bool cond_62025 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1627))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1627)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1627))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1627)))) ;
        if (cond_62025.isBuiltAndTrue ()) {
          operand_61328->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1629)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1631)) ;
        }
      }
    }
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_62240 (operand_61043->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_62240 = NULL ;
      while (((operand_62240 = enumerator_62240.nextObject ()))) {
        macroValidPointer (operand_62240) ;
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        GGS_matchListForGeneration  var_cas_matchListForGeneration = GGS_matchListForGeneration ::constructor_emptyList () ;
        const GGS_bool cond_64748 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_62240->mMatchEntryList.reader_length ()) ;
        if (cond_64748.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_62474 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_62474 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_62491 (operand_62240->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_62491 = NULL ;
            while (((operand_62474 = enumerator_62474.nextObject ()))
                && ((operand_62491 = enumerator_62491.nextObject ()))) {
              macroValidPointer (operand_62474) ;
              macroValidPointer (operand_62491) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_62474->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1642)) ;
              const GGS_bool cond_63855 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1643))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1643))) ;
              if (cond_63855.isBuiltAndTrue ()) {
                const GGS_bool cond_63536 = operand_62491->mIsType ;
                if (cond_63536.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_62491->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1645)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_63082 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1648)) ;
                  GGS_bool _condition_63082 (_variant_63082.isBuilt (), true) ;
                  while (_condition_63082.isBuiltAndTrue ()) {
                    _condition_63082 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1649)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1649))).operator_not ()) ;
                    if (_condition_63082.isBuiltAndTrue ()) {
                      if (_variant_63082.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1652)) ;
                        _condition_63082 = GGS_bool (false) ;
                      }else{
                        _variant_63082.decrement_operation (inLexique COMMA_HERE) ;
                  ...
                  const GGS_bool cond_63352 = (var_cas_found).operator_not () ;
                  if (cond_63352.isBuiltAndTrue ()) {
                    operand_62491->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_62491->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1657)) ;
                  }else if (cond_63352.isBuiltAndFalse ()) {
                    const GGS_bool cond_63516 = (operand_62491->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_63516.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_62491->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_63536.isBuiltAndFalse ()) {
                  operand_62491->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_62474->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1664)) ;
                }
                var_cas_matchListForGeneration.addAssign_operation (GGS_bool (true), operand_62491->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1665)), operand_62491->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1665))) ;
              }else if (cond_63855.isBuiltAndFalse ()) {
                const GGS_bool cond_64631 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1666))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1666))) ;
                if (cond_64631.isBuiltAndTrue ()) {
                  const GGS_bool cond_64132 = operand_62491->mIsType ;
                  if (cond_64132.isBuiltAndTrue ()) {
                    operand_62491->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_62474->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1671)) ;
                  }else if (cond_64132.isBuiltAndFalse ()) {
                    const GGS_bool cond_64450 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)).reader_hasKey (operand_62491->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)))).operator_not () ;
                    if (cond_64450.isBuiltAndTrue ()) {
                      operand_62491->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_62491->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_62474->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1673)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1673)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1675)) ;
                    }
                  }
                  var_cas_matchListForGeneration.addAssign_operation (GGS_bool (false), operand_62491->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1678)), operand_62474->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1679)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1679))) ;
                }else if (cond_64631.isBuiltAndFalse ()) {
                  operand_62491->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (1683)) ;
                }
              }
            }
          }
        }else if (cond_64748.isBuiltAndFalse ()) {
          operand_62240->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1687)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_62240->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1688))) COMMA_SOURCE_FILE_AT_LINE (1690)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_62240->mMatchBranchInstructionList,  operand_62240->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1693)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_61043->mElseInstructionList,  operand_61043->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1708)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_61043->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1719)) ;
