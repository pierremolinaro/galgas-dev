...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  {
  GALGAS_string joker_75578_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_75578_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1963)) ;
  }
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_79141_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_79141_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2032)) ;
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_82666_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_82666_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2130)) ;
  }
  cEnumerator_lstringlist enumerator_82691 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_82691.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_82691.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE_AT_LINE (2133)) ;
  ...
  const cMapElement_withAccessorMap * objectArray_82970 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (2138))) ;
  if (NULL != objectArray_82970) {
      macroValidSharedObject (objectArray_82970, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_82970->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2139)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_83353 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_83353.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_83353.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2149)) COMMA_SOURCE_FILE_AT_LINE (2149)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2149)).operator_concat (enumerator_83353.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2149)) COMMA_SOURCE_FILE_AT_LINE (2149)) COMMA_SOURCE_FILE_AT_LINE (2149)) ;
        enumerator_83353.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_84259 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_84277 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_84259.hasCurrentObject () && enumerator_84277.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_84277.current_mType (HERE), enumerator_84259.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2167)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (2167)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2167)) ;
      }
      enumerator_84259.gotoNextObject () ;
      enumerator_84277.gotoNextObject () ;
    }
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_84610 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2174)), kEnumeration_up) ;
  while (enumerator_84610.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_84610.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2177)).operator_concat (enumerator_84610.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2177)) COMMA_SOURCE_FILE_AT_LINE (2177)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (2177)) COMMA_SOURCE_FILE_AT_LINE (2177)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2178)).operator_concat (enumerator_84610.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2178)) COMMA_SOURCE_FILE_AT_LINE (2178)) COMMA_SOURCE_FILE_AT_LINE (2175)) ;
    enumerator_84610.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_86902 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2244))) ;
  if (NULL != objectArray_86902) {
      macroValidSharedObject (objectArray_86902, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_86902->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2245)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_87299 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_87299.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_87299.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2255)) COMMA_SOURCE_FILE_AT_LINE (2255)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2255)).operator_concat (enumerator_87299.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2255)) COMMA_SOURCE_FILE_AT_LINE (2255)) COMMA_SOURCE_FILE_AT_LINE (2255)) ;
        enumerator_87299.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
      GALGAS_string temp_2 ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_88233 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_88251 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_88233.hasCurrentObject () && enumerator_88251.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_88251.current_mType (HERE), enumerator_88233.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2273)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2273)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2273)) ;
      }
      enumerator_88233.gotoNextObject () ;
      enumerator_88251.gotoNextObject () ;
    }
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_88570 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2280)), kEnumeration_up) ;
  while (enumerator_88570.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_88570.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2283)).operator_concat (enumerator_88570.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2283)) COMMA_SOURCE_FILE_AT_LINE (2283)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2283)) COMMA_SOURCE_FILE_AT_LINE (2283)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2285)).operator_concat (enumerator_88570.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2285)) COMMA_SOURCE_FILE_AT_LINE (2285)) COMMA_SOURCE_FILE_AT_LINE (2281)) ;
    enumerator_88570.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_91003 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_91003.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_91038 (enumerator_91003.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_91038.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_91038.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_91038.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2350)) COMMA_SOURCE_FILE_AT_LINE (2350)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_91038.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_91038.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2352)) COMMA_SOURCE_FILE_AT_LINE (2352)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction") COMMA_SOURCE_FILE_AT_LINE (2352)) COMMA_SOURCE_FILE_AT_LINE (2351)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_91038.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2355)) COMMA_SOURCE_FILE_AT_LINE (2355)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_91038.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_91038.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2358)) COMMA_SOURCE_FILE_AT_LINE (2358)).operator_concat (GALGAS_string ("' is not a constant of '@") COMMA_SOURCE_FILE_AT_LINE (2358)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2358)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2358)) COMMA_SOURCE_FILE_AT_LINE (2358)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (2358)) COMMA_SOURCE_FILE_AT_LINE (2357)) ;
      }
      enumerator_91038.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2365)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2366)), enumerator_91003.current_mInstructions (HERE), enumerator_91003.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2363)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_91003.current_mSwitchConstantList (HERE), var_instructionList COMMA_SOURCE_FILE_AT_LINE (2372)) ;
    enumerator_91003.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_92243 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_92243.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_92243.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (2380)) COMMA_SOURCE_FILE_AT_LINE (2380)) ;
      enumerator_92243.gotoNextObject () ;
    }
