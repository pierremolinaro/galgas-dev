...
void routine_analyzeRoutineArguments (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_formalParameterSignature enumerator_34309 (constinArgument_inRoutineSignature, kEnumeration_up) ;
    cEnumerator_actualParameterListAST enumerator_34332 (constinArgument_inActualParameterList, kEnumeration_up) ;
    while (enumerator_34309.hasCurrentObject () && enumerator_34332.hasCurrentObject ()) {
      callCategoryMethod_checkAgainstFormalArgument ((const cPtr_actualParameterAST *) enumerator_34332.current_mActualParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_34309.current_mFormalSelector (HERE), enumerator_34309.current_mFormalArgumentType (HERE), enumerator_34309.current_mFormalArgumentPassingMode (HERE), ioArgument_ioVariableMap, outArgument_outActualParameterListForGeneration, var_exclusiveVariableSet, ioArgument_ioLocalVariableDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 808)) ;
...
GALGAS_string function_checkMethodImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inMethodName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_40486_0 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_40489_0 ; // Joker input parameter
    GALGAS_location joker_40492_0 ; // Joker input parameter
    GALGAS_bool joker_40495_0 ; // Joker input parameter
    GALGAS_string joker_40527_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 987)).method_searchKey (constinArgument_inMethodName, joker_40486_0, joker_40489_0, joker_40492_0, joker_40495_0, var_qualifier, joker_40527_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 987)) ;
...
GALGAS_string function_checkModifierImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inModifierName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodQualifier var_qualifier ;
    GALGAS_methodKind joker_45626_3 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_45626_2 ; // Joker input parameter
    GALGAS_bool joker_45626_1 ; // Joker input parameter
    GALGAS_string joker_45641_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1133)).method_searchKey (constinArgument_inModifierName, joker_45626_3, joker_45626_2, joker_45626_1, var_qualifier, joker_45641_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1133)) ;
    if (var_qualifier.isValid ()) {
      switch (var_qualifier.enumValue ()) {
      case GALGAS_methodQualifier::kNotBuilt:
        break ;
...
void routine_checkExpressionIsBoolean (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_expressionType = constinArgument_inExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1636)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      const cMapElement_readerMap * objectArray_66335 = (const cMapElement_readerMap *) var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1665)).readAccessForWithInstruction (GALGAS_string ("bool")) ;
      if (NULL != objectArray_66335) {
          macroValidSharedObject (objectArray_66335, cMapElement_readerMap) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, objectArray_66335->mAttribute_mReturnedType.objectCompare (var_boolType)).boolEnum () ;
        if (kBoolTrue == test_4) {
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, objectArray_66335->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1668)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_5) {
            ...
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_66335->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              inCompiler->emitSemanticError (constinArgument_inErrorLocation, objectArray_66335->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1671)) ;
              outArgument_outExpression.drop () ; // Release error dropped variable
            }else if (kBoolFalse == test_6) {
              outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_boolType, constinArgument_inErrorLocation, objectArray_66335->mAttribute_mKind, constinArgument_inExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1678)), GALGAS_string ("bool"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1680)), objectArray_66335->mAttribute_mHasCompilerArgument  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1673)) ;
            }
          }
        }
      }else{
        ...
        if (kBoolTrue == test_7) {
          ...
          cEnumerator_readerMap enumerator_67537 (var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1692)), kEnumeration_up) ;
          while (enumerator_67537.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - ").operator_concat (enumerator_67537.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693)) ;
            cEnumerator_functionSignature enumerator_67609 (enumerator_67537.current_mArgumentTypeList (HERE), kEnumeration_up) ;
            while (enumerator_67609.hasCurrentObject ()) {
              GALGAS_string temp_8 ;
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_67609.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                temp_8 = enumerator_67609.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)) ;
              }else if (kBoolFalse == test_9) {
                temp_8 = GALGAS_string::makeEmptyString () ;
              }
              var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_8, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)).operator_concat (enumerator_67609.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)) ;
              enumerator_67609.gotoNextObject () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_67537.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1697))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1697))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1697)) ;
...
static void categoryMethod_errorInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_18414.hasCurrentObject ()) {
    ...
    {
    GALGAS_unifiedTypeMap_2D_proxy joker_18494_0 ; // Joker input parameter
    GALGAS_string joker_18509_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_18414.current_mValue (HERE), joker_18494_0, var_varCppName, joker_18509_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 440)) ;
    }
...
static void categoryMethod_outputInputActualParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  {
  GALGAS_string joker_23776_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mOutputInputActualParameterName, var_parameterType, var_variableCppName, joker_23776_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 569)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_23887 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_23887.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_23887.current_mValue (HERE), var_parameterType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 573)) ;
...
static void categoryMethod_inputActualExistingVariableParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_26164_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mInputActualParameterName, var_parameterType, var_targetVariableCppName, joker_26164_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 619)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType)).boolEnum () ;
  if (kBoolTrue == test_5) {
...
static void categoryMethod_inputActualNewVariableParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  if (kBoolTrue == test_5) {
    GALGAS_unifiedTypeMap_2D_proxy var_parameterType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mInputActualTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 670)) ;
...
static void categoryMethod_inputActualNewConstantParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, object->mAttribute_mInputActualTypeName.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_unifiedTypeMap_2D_proxy var_parameterType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mInputActualTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 726)) ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_location location_7 (object->mAttribute_mInputActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_routineCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_36028 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_36028.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_36028.current_mType (HERE), enumerator_36028.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 856))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 856)) ;
...
static void categoryMethod_typeMethodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 875)) ;
  GALGAS_formalParameterSignature var_routineSignature ;
  GALGAS_bool var_hasCompilerArgument ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_37455 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_37455.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_37455.current_mType (HERE), enumerator_37455.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 894))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 894)) ;
...
static void categoryMethod_methodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_location joker_38569_0 ; // Joker input parameter
  GALGAS_methodQualifier joker_38593_0 ; // Joker input parameter
  var_receiverExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 926)).reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 926)).method_searchKey (object->mAttribute_mMethodName, var_kind, var_routineSignature, joker_38569_0, var_hasCompilerArgument, joker_38593_0, var_errorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 926)) ;
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_baseType = var_receiverExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 943)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 946)).isValid ()) {
      uint32_t variant_39273 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 946)).uintValue () ;
      bool loop_39273 = true ;
      while (loop_39273) {
        loop_39273 = var_searching.isValid () ;
        if (loop_39273) {
          loop_39273 = var_searching.boolValue () ;
        }
        if (loop_39273 && (0 == variant_39273)) {
          loop_39273 = false ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_39698 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_39698.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_39698.current_mType (HERE), enumerator_39698.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 960))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 960)) ;
    enumerator_39698.gotoNextObject () ;
  }
...
static void categoryMethod_modifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_41480 (object->mAttribute_mReceiverStructAttributes, kEnumeration_up) ;
  while (enumerator_41480.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_41480.current_mValue (HERE), var_receiverType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1013)) ;
  ...
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_41871_0 ; // Joker input parameter
  var_receiverType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1020)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_41871_0, var_modifierErrorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1020)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1040)).isValid ()) {
      uint32_t variant_42554 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1040)).uintValue () ;
      bool loop_42554 = true ;
      while (loop_42554) {
        loop_42554 = var_searching.isValid () ;
        if (loop_42554) {
          loop_42554 = var_searching.boolValue () ;
        }
        if (loop_42554 && (0 == variant_42554)) {
          loop_42554 = false ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_42975 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_42975.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_42975.current_mType (HERE), enumerator_42975.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1054))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1054)) ;
    enumerator_42975.gotoNextObject () ;
  }
...
static void categoryMethod_selfModifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_44380_0 ; // Joker input parameter
  GALGAS_string joker_44383_0 ; // Joker input parameter
  var_selfTypeProxy.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1092)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_44380_0, joker_44383_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1092)) ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_44866 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_44866.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_44866.current_mType (HERE), enumerator_44866.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1107))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1107)) ;
    enumerator_44866.gotoNextObject () ;
  }
...
static void categoryMethod_concatInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_46607 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_46607.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_46607.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1159)) ;
    enumerator_46607.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
...
static void categoryMethod_plusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_49990 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_49990.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_49990.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1249)) ;
    enumerator_49990.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_actualOutputExpressionList enumerator_50989 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_functionSignature enumerator_51017 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_50989.hasCurrentObject () && enumerator_51017.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_50989.current_mExpression (HERE).ptr (), enumerator_51017.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1267)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_51017.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_50989.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_string temp_3 ;
          const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51017.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_4) {
            temp_3 = GALGAS_string (":") ;
          }else if (kBoolFalse == test_4) {
            temp_3 = GALGAS_string::makeEmptyString () ;
          }
          GALGAS_location location_5 (enumerator_50989.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the selector should be '!").operator_concat (enumerator_51017.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274)).operator_concat (temp_3.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274)) ;
        }
        {
        routine_checkAssignmentTypes (enumerator_51017.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1276)), enumerator_50989.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1276)) ;
        }
        ...
        enumerator_51017.gotoNextObject () ;
      }
...
static void categoryMethod_plusEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_52513 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_52513.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_52513.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1305)) ;
...
static void categoryMethod_selfPlusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_actualOutputExpressionList enumerator_55145 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_functionSignature enumerator_55173 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_55145.hasCurrentObject () && enumerator_55173.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_55145.current_mExpression (HERE).ptr (), enumerator_55173.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1365)) ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_55173.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_55145.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_string temp_4 ;
          const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_55173.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_5) {
            temp_4 = enumerator_55173.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1372)) ;
          }else if (kBoolFalse == test_5) {
            temp_4 = GALGAS_string::makeEmptyString () ;
          }
          GALGAS_location location_6 (enumerator_55145.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        {
        routine_checkAssignmentTypes (enumerator_55173.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1374)), enumerator_55145.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1374)) ;
        }
...
static void categoryMethod_incrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_58126_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_58126_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1441)) ;
  }
  cEnumerator_lstringlist enumerator_58161 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_58161.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_58161.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1444)) ;
    enumerator_58161.gotoNextObject () ;
  }
...
static void categoryMethod_decrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_60515_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_60515_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1502)) ;
  }
  cEnumerator_lstringlist enumerator_60550 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_60550.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_60550.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1505)) ;
    enumerator_60550.gotoNextObject () ;
  }
...
static void categoryMethod_logInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_logListAST enumerator_63699 (object->mAttribute_mLogList, kEnumeration_up) ;
  while (enumerator_63699.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_63699.current_mLogExpression (HERE).ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1592)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1591)) ;
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_logInstructionForGeneration::constructor_new (enumerator_63699.current_mLogMessage (HERE), var_expression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1598))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1598)) ;
    enumerator_63699.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_dropInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_64537 (object->mAttribute_mDropList, kEnumeration_up) ;
  while (enumerator_64537.hasCurrentObject ()) {
    GALGAS_string var_variableCppName ;
    GALGAS_unifiedTypeMap_2D_proxy var_t ;
    {
    GALGAS_string joker_64664_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForDropAccess (enumerator_64537.current_mValue (HERE), var_t, var_variableCppName, joker_64664_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1616)) ;
    }
    ...
    enumerator_64537.gotoNextObject () ;
  }
...
static void categoryMethod_enumeratedCollectionImplicitVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_71441 (var_enumerationDescriptorList, kEnumeration_up) ;
  while (enumerator_71441.hasCurrentObject ()) {
    ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_71441.current_mEnumeratedType (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_71441.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1805)), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1805)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806)).operator_concat (enumerator_71441.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1803)) ;
    enumerator_71441.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_enumeratedCollectionCstListInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_enumerationDescriptorList enumerator_72923 (var_currentTypedAttributeList, kEnumeration_up) ;
      while (enumerator_72923.hasCurrentObject ()) {
        {
        ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_72923.current_mEnumerationName (HERE), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1837)), enumerator_72923.current_mEnumeratedType (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839)).operator_concat (enumerator_72923.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840)).operator_concat (enumerator_72923.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1836)) ;
        }
        enumerator_72923.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_5) {
          ...
          cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_74269 (object->mAttribute_mElementList, kEnumeration_up) ;
          cEnumerator_enumerationDescriptorList enumerator_74296 (var_enumerationDescriptorList, kEnumeration_up) ;
          while (enumerator_74269.hasCurrentObject () && enumerator_74296.hasCurrentObject ()) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_74269.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1861)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_74269.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                GALGAS_unifiedTypeMap_2D_proxy var_foundType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_74269.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1863)) ;
                const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_74296.current_mEnumeratedType (HERE))).boolEnum () ;
                if (kBoolTrue == test_10) {
                  GALGAS_location location_11 (enumerator_74269.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_11, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)).operator_concat (enumerator_74296.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)) ;
                }
              }
              ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_74296.current_mEnumeratedType (HERE), enumerator_74269.current_mConstantName (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868)).operator_concat (enumerator_74296.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868)) ;
            }
            enumerator_74269.gotoNextObject () ;
            enumerator_74296.gotoNextObject () ;
          }
        }
      }
    }
...
static void categoryMethod_enumeratedCollectionVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_enumeratedElementType = outArgument_outEnumerationExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1892)).reader_mTypeForEnumeratedElement (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1892)) ;
  ...
  if (kBoolTrue == test_1) {
    GALGAS_unifiedTypeMap_2D_proxy var_explicitType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumerationTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1900)) ;
...
static void categoryMethod_forInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_78437.hasCurrentObject ()) {
    ...
    enumerator_78437.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_localInitializedVariableList enumerator_79000 (var_localConstantListForDoBranch, kEnumeration_up) ;
  while (enumerator_79000.hasCurrentObject ()) {
    {
    ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_79000.current_mName (HERE), enumerator_79000.current_mType (HERE), enumerator_79000.current_mCppName (HERE), enumerator_79000.current_mCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1979)) ;
    }
    enumerator_79000.gotoNextObject () ;
  }
...
static void categoryMethod_foreachInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_foreachInstructionEnumeratedObjectListAST enumerator_82776 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_82776.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_82776.current_mEnumeratedExpression (HERE).ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2094)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2093)) ;
    GALGAS_string var_enumerationOrder = enumerator_82776.current_mEnumerationOrder (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2100)) ;
    GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (enumerator_82776.current_mEndOfEnumerationExpression (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2101)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2101))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2101)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringlist enumerator_83856 (var_enumerationExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2112)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2112)), kEnumeration_up) ;
        bool bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2112)).isValidAndTrue () ;
        if (enumerator_83856.hasCurrentObject () && bool_2) {
          while (enumerator_83856.hasCurrentObject () && bool_2) {
            var_found = GALGAS_bool (kIsEqual, var_enumerationOrder.objectCompare (enumerator_83856.current_mValue (HERE))) ;
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  \\").operator_concat (enumerator_83856.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2114))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2114)) ;
            enumerator_83856.gotoNextObject () ;
            if (enumerator_83856.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_82776.current_mEnumerationOrder (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_5) {
        ...
        cEnumerator_enumerationDescriptorList enumerator_84365 (var_currentTypedAttributeList, kEnumeration_up) ;
        while (enumerator_84365.hasCurrentObject ()) {
          {
          ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_82776.current_mPrefix (HERE).mAttribute_string.operator_concat (enumerator_84365.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2125)), enumerator_82776.current_mEndOfEnumerationExpression (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2125)), enumerator_84365.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)).operator_concat (enumerator_84365.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128)).operator_concat (enumerator_84365.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2124)) ;
          }
          enumerator_84365.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = enumerator_82776.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_82776.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).boolEnum () ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_9) {
            ...
            inCompiler->emitSemanticError (enumerator_82776.current_mEndOfElementList (HERE), GALGAS_string ("the '@").operator_concat (var_enumerationExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).operator_concat (GALGAS_string ("' type requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).operator_concat (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).operator_concat (GALGAS_string (" argument")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142)).operator_concat (temp_10  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142)).operator_concat (GALGAS_string (" or less for enumeration: this list provides ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2143)).operator_concat (enumerator_82776.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2144))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2140)) ;
          }else if (kBoolFalse == test_9) {
            cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_85747 (enumerator_82776.current_mElementList (HERE), kEnumeration_up) ;
            cEnumerator_enumerationDescriptorList enumerator_85774 (var_enumerationDescriptorList, kEnumeration_up) ;
            while (enumerator_85747.hasCurrentObject () && enumerator_85774.hasCurrentObject ()) {
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_85747.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2149)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_85747.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  GALGAS_unifiedTypeMap_2D_proxy var_foundType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_85747.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2151)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_85774.current_mEnumeratedType (HERE))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    GALGAS_location location_15 (enumerator_85747.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_15, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)).operator_concat (enumerator_85774.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)) ;
                  }
                }
                {
                ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_85747.current_mConstantName (HERE), enumerator_85774.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159)).operator_concat (enumerator_85774.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)).operator_concat (enumerator_85774.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2156)) ;
                }
              }
              enumerator_85747.gotoNextObject () ;
              enumerator_85774.gotoNextObject () ;
            }
          }
        }
      }
    ...
    enumerator_82776.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_uncheckedWhileExpression ;
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_castInstructionBranchListAST enumerator_91761 (object->mAttribute_mCastInstructionBranchList, kEnumeration_up) ;
  while (enumerator_91761.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_91761.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2316)) ;
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).isValid ()) {
      uint32_t variant_92057 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).uintValue () ;
      bool loop_92057 = true ;
      while (loop_92057) {
        loop_92057 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).isValid () ;
        if (loop_92057) {
          loop_92057 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).boolValue () ;
        }
        if (loop_92057 && (0 == variant_92057)) {
          loop_92057 = false ;
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_91761.current_mConstantVarName (HERE).mAttribute_string.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2333)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_localConstantName = GALGAS_string ("cast_").operator_concat (enumerator_91761.current_mConstantVarName (HERE).reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).operator_concat (enumerator_91761.current_mConstantVarName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)) ;
      var_localConstantList.addAssign_operation (var_type, enumerator_91761.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2335)) ;
    }else if (kBoolFalse == test_2) {
      var_localConstantName = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2349)), enumerator_91761.current_mInstructionList (HERE), enumerator_91761.current_mEndOfInstructions (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2346)) ;
    }
    var_castBranchList.addAssign_operation (enumerator_91761.current_mTypeComparisonKind (HERE), var_type, var_localConstantName, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2355)) ;
    enumerator_91761.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  {
  GALGAS_string joker_95989_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_95989_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2425)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2449)) ;
  {
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2474)) ;
  {
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_99553_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_99553_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2494)) ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_101570 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_101570.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_101570.current_mType (HERE), enumerator_101570.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548)) ;
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_receiverType = var_receiverExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2595)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_103330 (var_receiverType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2599)), kEnumeration_up) ;
    bool bool_1 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2599)).isValidAndTrue () ;
    if (enumerator_103330.hasCurrentObject () && bool_1) {
      while (enumerator_103330.hasCurrentObject () && bool_1) {
        var_found = GALGAS_bool (kIsEqual, enumerator_103330.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_103330.gotoNextObject () ;
        if (enumerator_103330.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_104483 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2623)), kEnumeration_up) ;
  while (enumerator_104483.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_104483.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_104483.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2626))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2626)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2626)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628)).operator_concat (enumerator_104483.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2624)) ;
    enumerator_104483.gotoNextObject () ;
  }
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_107356_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_107356_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2695)) ;
  }
  cEnumerator_lstringlist enumerator_107384 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_107384.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_107384.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2703)) ;
    enumerator_107384.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_4) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_107916 (var_targetType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2712)), kEnumeration_up) ;
    bool bool_5 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2712)).isValidAndTrue () ;
    if (enumerator_107916.hasCurrentObject () && bool_5) {
      while (enumerator_107916.hasCurrentObject () && bool_5) {
        var_found = GALGAS_bool (kIsEqual, enumerator_107916.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_107916.gotoNextObject () ;
        if (enumerator_107916.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_108470 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723)), kEnumeration_up) ;
  while (enumerator_108470.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_108470.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_108470.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727)).operator_concat (enumerator_108470.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2724)) ;
    enumerator_108470.gotoNextObject () ;
  }
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_111339 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_111339.hasCurrentObject ()) {
    ...
    cEnumerator_lstringlist enumerator_111499 (enumerator_111339.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_111499.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantMap.reader_hasKey (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2803)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2803)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_111499.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2806)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2805)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809)) ;
        GALGAS_unifiedTypeMapProxyList var_associatedTypeList ;
        GALGAS_uint joker_111882_0 ; // Joker input parameter
        var_enumConstantMap.method_searchKey (enumerator_111499.current_mValue (HERE), joker_111882_0, var_associatedTypeList, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2810)) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, enumerator_111339.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_location location_5 (enumerator_111499.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the associated values of '").operator_concat (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813)).operator_concat (GALGAS_string ("' constant should be extracted")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2812)) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_111339.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_location location_7 (enumerator_111499.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2817))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2817)).operator_concat (GALGAS_string ("' constant has no associated value")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2817))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2816)) ;
          }else if (kBoolFalse == test_6) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2819)).objectCompare (enumerator_111339.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2819)))).boolEnum () ;
            if (kBoolTrue == test_8) {
              ...
              GALGAS_location location_11 (enumerator_111499.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_11, GALGAS_string ("the '").operator_concat (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).operator_concat (GALGAS_string ("' constant requires ").add_operation (var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).add_operation (GALGAS_string ("  associated value"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).add_operation (temp_9, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820)) ;
            }else if (kBoolFalse == test_8) {
              cEnumerator_unifiedTypeMapProxyList enumerator_112705 (var_associatedTypeList, kEnumeration_up) ;
              cEnumerator__32_lstringlist enumerator_112740 (enumerator_111339.current_mAssociatedValuesExtraction (HERE), kEnumeration_up) ;
              while (enumerator_112705.hasCurrentObject () && enumerator_112740.hasCurrentObject ()) {
                const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_112740.current_mValue_30_ (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_112705.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2827)).objectCompare (enumerator_112740.current_mValue_30_ (HERE).mAttribute_string)).boolEnum () ;
                  if (kBoolTrue == test_13) {
                    GALGAS_location location_14 (enumerator_112740.current_mValue_30_ (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_14, GALGAS_string ("the required type is '@").operator_concat (enumerator_112705.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828)) ;
                  }
                }
                const enumGalgasBool test_15 = var_firstConstant.operator_and (GALGAS_bool (kIsNotEqual, enumerator_112740.current_mValue_31_ (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2831)).boolEnum () ;
                if (kBoolTrue == test_15) {
                  GALGAS_string var_cppName = GALGAS_string ("extractedValue_").add_operation (enumerator_112740.current_mValue_31_ (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2832)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2832)) ;
                  var_extractedAssociatedValuesForGeneration.addAssign_operation (enumerator_112705.current_mType (HERE), var_cppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2833)) ;
                  {
                  ioArgument_ioVariableMap.modifier_insertLocalConstant (enumerator_112740.current_mValue_31_ (HERE), enumerator_112705.current_mType (HERE), var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2834)) ;
                  }
                }
                enumerator_112705.gotoNextObject () ;
                enumerator_112740.gotoNextObject () ;
              }
            }
          }
        }
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_16 (enumerator_111499.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_16, GALGAS_string ("'").operator_concat (enumerator_111499.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).operator_concat (GALGAS_string ("' is not a constant of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).operator_concat (var_switchExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2839)) ;
      }
      var_firstConstant = GALGAS_bool (false) ;
      enumerator_111499.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2847)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2848)), enumerator_111339.current_mInstructions (HERE), enumerator_111339.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2845)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_111339.current_mSwitchConstantList (HERE), var_extractedAssociatedValuesForGeneration, enumerator_111339.current_mEndOfBranch (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2854)), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2854)) ;
    enumerator_111339.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_114272 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_114272.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_114272.current_key (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2862))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2862)) ;
      enumerator_114272.gotoNextObject () ;
    }
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_semanticExpressionListAST enumerator_115158 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_115158.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_115158.current_mExpression (HERE).ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2890)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2889)) ;
    ...
    GALGAS_unifiedTypeMap_2D_proxy var_type = var_matchedExpression.reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)) ;
    ...
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_115158.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2900))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2900)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2900))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2899)) ;
    }
    enumerator_115158.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_matchInstructionBranchListAST enumerator_116065 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_116065.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911)).objectCompare (enumerator_116065.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_116299 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_116316 (enumerator_116065.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_116299.hasCurrentObject () && enumerator_116316.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_type = enumerator_116299.current_mExpression (HERE).reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2913)) ;
        ...
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_116316.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMap_2D_proxy var_namedType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2916)) ;
            GALGAS_unifiedTypeMap_2D_proxy var_t = var_type ;
            ...
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).isValid ()) {
              uint32_t variant_116718 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).uintValue () ;
              bool loop_116718 = true ;
              while (loop_116718) {
                loop_116718 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).isValid () ;
                if (loop_116718) {
                  loop_116718 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).boolValue () ;
                }
                if (loop_116718 && (0 == variant_116718)) {
                  loop_116718 = false ;
            ...
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2925)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_116316.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2928)).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2928)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_116316.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2929)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_116299.current_mExpression (HERE).reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933)).operator_concat (GALGAS_string ("' class is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2932)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)), enumerator_116316.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)) ;
        }else if (kBoolFalse == test_2) {
          ...
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_116316.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_116299.current_mExpression (HERE).reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940)).operator_concat (GALGAS_string ("' enumeration type is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2939)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)).reader_hasKey (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).operator_concat (enumerator_116299.current_mExpression (HERE).reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2943)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2949)), enumerator_116299.current_mExpression (HERE).reader_mResultType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2950)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2950))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2947)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_116316.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_116299.gotoNextObject () ;
        enumerator_116316.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_116065.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)).operator_concat (GALGAS_string (" elements, but it acually contains ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)).operator_concat (enumerator_116065.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2959)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2959))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2957)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2967)), enumerator_116065.current_mMatchBranchInstructionList (HERE), enumerator_116065.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2964)) ;
    }
    ...
    enumerator_116065.gotoNextObject () ;
  }
