  ...
  if (operand_49353 != NULL) {
    ...
    GGS_castInstructionBranchListForGeneration  var_cas_castBranchList = GGS_castInstructionBranchListForGeneration ::constructor_emptyList () ;
    {
      ...
      while (((operand_50018 = enumerator_50018.nextObject ()))) {
        ...
        GGS_uint _variant_50487 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1302)) ;
        GGS_bool _condition_50487 (_variant_50487.isBuilt (), true) ;
        while (_condition_50487.isBuiltAndTrue ()) {
          _condition_50487 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1303))).operator_not ()) ;
          if (_condition_50487.isBuiltAndTrue ()) {
            if (_variant_50487.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1306)) ;
              _condition_50487 = GGS_bool (false) ;
            }else{
              _variant_50487.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_50683 = (var_cas_found).operator_not () ;
        ...
        const GGS_bool cond_51114 = (operand_50018->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_51114.isBuiltAndTrue ()) {
        ...
        }else if (cond_51114.isBuiltAndFalse ()) {
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_grammarInstructionAST * operand_52394,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52394 != NULL) {
    GGS_grammarLabelMap  var_cas_grammarLabelMap ;
    if (var_cas_inSemanticContext.mGrammarMap.isBuilt ()) {
      var_cas_inSemanticContext.mGrammarMap (HERE)->method_searchKey (inLexique, operand_52394->mGrammarComponentName, var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (1373)) ;
    }
    GGS_formalParameterSignature  var_cas_labelSignature ;
    if (var_cas_grammarLabelMap.isBuilt ()) {
      var_cas_grammarLabelMap (HERE)->method_searchKey (inLexique, operand_52394->mLabelName, var_cas_labelSignature COMMA_SOURCE_FILE_AT_LINE (1379)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_52394->mLabelName,  ((GGS_string ("label of the ")).operator_concat (operand_52394->mGrammarComponentName)).operator_concat (GGS_string (" grammar")),  var_cas_labelSignature,  operand_52394->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1385)) ;
    GGS_semanticExpressionForGeneration  var_cas_sourceExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_52394->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_52394->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_sourceExpression COMMA_SOURCE_FILE_AT_LINE (1397)) ;
      }
    }
    const GGS_bool cond_53903 = operand_52394->mSourceExpressionIsFile ;
    if (cond_53903.isBuiltAndTrue ()) {
      const GGS_bool cond_53890 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1405))).operator_isNotEqual (var_cas_inPredefinedTypes.mLStringType) ;
      if (cond_53890.isBuiltAndTrue ()) {
        operand_52394->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source file path and its type should be '@lstring', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1407)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1407)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1409)) ;
      }
    }else if (cond_53903.isBuiltAndFalse ()) {
      const GGS_bool cond_54142 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1410))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
      if (cond_54142.isBuiltAndTrue ()) {
        operand_52394->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source string and its type should be '@string', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1412)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1412)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1414)) ;
      }
    }
    const GGS_bool cond_54470 = operand_52394->mSourceExpressionIsFile ;
    if (cond_54470.isBuiltAndTrue ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceFileForGeneration ::constructor_new (inLexique, operand_52394->mInstructionLocation, operand_52394->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1419)), operand_52394->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1420)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1417))) ;
    }else if (cond_54470.isBuiltAndFalse ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceExpressionForGeneration ::constructor_new (inLexique, operand_52394->mInstructionLocation, operand_52394->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1427)), operand_52394->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1428)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1425))) ;
    }
  }
}
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readWriteAccessWithInstructionAST * operand_54914,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54914 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_54914->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_54914->mKeyExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1446)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_54914->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1453)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1453))) ;
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_receiverVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_54914->mReceiverName, var_cas_targetType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (1457)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_55731 (operand_54914->mFieldList, true) ;
      const GGS_lstringlist::cElement * operand_55731 = NULL ;
      while (((operand_55731 = enumerator_55731.nextObject ()))) {
        macroValidPointer (operand_55731) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_55731->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (1460)) ;
        }
      }
    }
    ...
    elementOf_GGS_withAccessorMap * operand_56057 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_54914->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1465))) ;
    if (NULL != operand_56057) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_56057->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_56370 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_56370.isBuiltAndTrue ()) {
        operand_54914->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1470)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1473)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_56370.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_56424 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_56424 = NULL ;
          while (((operand_56424 = enumerator_56424.nextObject ()))) {
            macroValidPointer (operand_56424) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_56424->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_56424->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1476))) ;
          }
        }
        operand_54914->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1479)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_54914->mAccessName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1484)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    ...
    const GGS_bool cond_57291 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_57291.isBuiltAndTrue ()) {
      operand_54914->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_54914->mAccessName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1489)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1490)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1491)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1492)) ;
    }else if (cond_57291.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_57327 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_57327 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_57345 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_57345 = NULL ;
        while (((operand_57327 = enumerator_57327.nextObject ()))
            && ((operand_57345 = enumerator_57345.nextObject ()))) {
          macroValidPointer (operand_57327) ;
          macroValidPointer (operand_57345) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_57345->mType,  operand_57327->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1494)),  operand_54914->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1494)) COMMA_SOURCE_FILE_AT_LINE (1494)) ;
        }
      }
    }
    ...
    GGS_localInitializedVariableList  var_cas_localInitializedVariableList = GGS_localInitializedVariableList ::constructor_emptyList () ;
    {
      ...
      GGS_typedAttributeList::cEnumerator enumerator_57641 (var_cas_targetType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1501)), true) ;
      const GGS_typedAttributeList::cElement * operand_57641 = NULL ;
      while (((operand_57641 = enumerator_57641.nextObject ()))) {
        macroValidPointer (operand_57641) ;
        var_cas_localInitializedVariableList.addAssign_operation (operand_57641->mAttributeTypeIndex, GGS_lstring ::constructor_new (inLexique, (operand_54914->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1504))).operator_concat (operand_57641->mAttributeName), operand_54914->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1504)) COMMA_SOURCE_FILE_AT_LINE (1504)), ((((((((GGS_string ("* ((GALGASap_")).operator_concat (operand_57641->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1505)))).operator_concat (GGS_string (" *) "))).operator_concat (var_cas_objectArrayCppName)).operator_concat (GGS_string ("->pointerAtIndex ("))).operator_concat (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1505)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1505)))).operator_concat (GGS_string (" /* "))).operator_concat (operand_57641->mAttributeName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string (" */ COMMA_HERE))"))) ;
        var_cas_IDX.mValue ++ ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  var_cas_localInitializedVariableList,  operand_54914->m_do_Instructions,  operand_54914->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1509)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_54914->m_else_Instructions,  operand_54914->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1521)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_54914->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1531)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, var_cas_targetType, operand_54914->mFieldList, operand_54914->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1537)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1533))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_59249,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59249 != NULL) {
    operand_59249->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @readAccessWithInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1557)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_59757,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59757 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_59757->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_59757->mSwitchExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1570)) ;
      }
    }
    const GGS_bool cond_60552 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1577)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1577))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1577))) ;
    if (cond_60552.isBuiltAndTrue ()) {
      operand_59757->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1579)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1579)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1580)) ;
    }
    GGS_stringset  var_cas_enumConstantStringSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_60646 (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)).reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)), true) ;
      const GGS_lstringlist::cElement * operand_60646 = NULL ;
      while (((operand_60646 = enumerator_60646.nextObject ()))) {
        macroValidPointer (operand_60646) ;
        var_cas_enumConstantStringSet.addAssign_operation (operand_60646->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1584))) ;
      }
    }
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_60981 (operand_59757->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_60981 = NULL ;
      while (((operand_60981 = enumerator_60981.nextObject ()))) {
        macroValidPointer (operand_60981) ;
        {
          GGS_lstringlist::cEnumerator enumerator_61016 (operand_60981->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_61016 = NULL ;
          while (((operand_61016 = enumerator_61016.nextObject ()))) {
            macroValidPointer (operand_61016) ;
            const GGS_bool cond_61371 = var_cas_enumConstantStringSet.reader_hasKey (operand_61016->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1592))) ;
            if (cond_61371.isBuiltAndTrue ()) {
              const GGS_bool cond_61291 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_61016->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1593))) ;
              if (cond_61291.isBuiltAndTrue ()) {
                operand_61016->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_61016->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1597)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_61016->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1598))) ;
            }else if (cond_61371.isBuiltAndFalse ()) {
              operand_61016->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_61016->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1601)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1601)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1603)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_60981->mInstructions,  operand_60981->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1606)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_60981->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_59757->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1618)) ;
    ...
    const GGS_bool cond_62449 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_62449.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_62255 (var_cas_forgottenConstants, true) ;
        while (enumerator_62255.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_62255._key (HERE)) ;
          enumerator_62255.next () ;
        }
      }
      operand_59757->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1629)) ;
    }
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_62772,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62772 != NULL) {
    operand_62772->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @matchInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1649)) ;
  }
}
