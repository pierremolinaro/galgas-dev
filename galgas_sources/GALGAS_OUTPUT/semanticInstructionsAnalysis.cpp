...
//                    november 11th, 2010, at 22h51'21"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
  ...
  if (operand_60997 != NULL) {
    ...
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, operand_60997->mInstructionLocation, var_cas_receiverVariableCppName, var_cas_targetType, operand_60997->mFieldList, operand_60997->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1666))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_65066,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65066 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_receiverExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_65066->mReceiverExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_65066->mReceiverExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_receiverExpression COMMA_SOURCE_FILE_AT_LINE (1688)) ;
      }
    }
    ...
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_65066->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_65066->mKeyExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1696)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_65066->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1702))) ;
    ...
    GGS_unifiedTypeMapProxyList  var_cas_argumentTypeList ;
    elementOf_GGS_withAccessorMap * operand_66006 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_65066->mSearchMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1706))) ;
    if (NULL != operand_66006) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_66006->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_66333 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_66333.isBuiltAndTrue ()) {
        operand_65066->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_receiverType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1711)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1714)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_66333.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_66387 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_66387 = NULL ;
          while (((operand_66387 = enumerator_66387.nextObject ()))) {
            macroValidPointer (operand_66387) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_66387->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_66387->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1717))) ;
          }
        }
        operand_65066->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_receiverType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1720)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_65066->mSearchMethodName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1725)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    const GGS_semanticExpressionListForGeneration  var_cas_effectiveExpressionList = GGS_semanticExpressionListForGeneration ::constructor_listWithValue (var_cas_keyExpression) ;
    const GGS_bool cond_67282 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_67282.isBuiltAndTrue ()) {
      operand_65066->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_65066->mSearchMethodName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_receiverType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1730)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1731)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1732)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1733)) ;
    }else if (cond_67282.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_67318 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_67318 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_67336 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_67336 = NULL ;
        while (((operand_67318 = enumerator_67318.nextObject ()))
            && ((operand_67336 = enumerator_67336.nextObject ()))) {
          macroValidPointer (operand_67318) ;
          macroValidPointer (operand_67336) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_67336->mType,  operand_67318->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1735)),  operand_65066->mSearchMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1735)) COMMA_SOURCE_FILE_AT_LINE (1735)) ;
        }
      }
    }
    ...
    GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_67615 (var_cas_receiverType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1742)), true) ;
      const GGS_typedAttributeList::cElement * operand_67615 = NULL ;
      while (((operand_67615 = enumerator_67615.nextObject ()))) {
        macroValidPointer (operand_67615) ;
        var_cas_localConstantList.addAssign_operation (operand_67615->mAttributeTypeProxy, GGS_lstring ::constructor_new (inLexique, (operand_65066->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1745))).operator_concat (operand_67615->mAttributeName), operand_65066->mSearchMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1745)) COMMA_SOURCE_FILE_AT_LINE (1745)), GGS_bool (true), ((var_cas_objectArrayCppName).operator_concat (GGS_string ("->mAttribute_"))).operator_concat (operand_67615->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_65066->mDoBranchInstructions,  operand_65066->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1751)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_65066->mElseBranchInstructions,  operand_65066->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1762)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_65066->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1771)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readOnlyWithInstructionForGeneration ::constructor_new (inLexique, operand_65066->mInstructionLocation, var_cas_receiverExpression, operand_65066->mSearchMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1776)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1773))) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_switchInstructionAST * operand_69068,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69068 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_69068->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_69068->mSwitchExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1793)) ;
      }
    }
    const GGS_bool cond_69751 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1799)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1799))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1799))) ;
    if (cond_69751.isBuiltAndTrue ()) {
      operand_69068->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1801)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1801)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1802)) ;
    }
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_70099 (operand_69068->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_70099 = NULL ;
      while (((operand_70099 = enumerator_70099.nextObject ()))) {
        macroValidPointer (operand_70099) ;
        {
          GGS_lstringlist::cEnumerator enumerator_70134 (operand_70099->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_70134 = NULL ;
          while (((operand_70134 = enumerator_70134.nextObject ()))) {
            macroValidPointer (operand_70134) ;
            const GGS_bool cond_70489 = var_cas_enumConstantStringSet.reader_hasKey (operand_70134->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1811))) ;
            if (cond_70489.isBuiltAndTrue ()) {
              const GGS_bool cond_70409 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_70134->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1812))) ;
              if (cond_70409.isBuiltAndTrue ()) {
                operand_70134->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_70134->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1816)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_70134->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1817))) ;
            }else if (cond_70489.isBuiltAndFalse ()) {
              operand_70134->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_70134->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1822)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_70099->mInstructions,  operand_70099->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1825)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_70099->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_69068->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1836)) ;
    ...
    const GGS_bool cond_71544 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_71544.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_71350 (var_cas_forgottenConstants, true) ;
        while (enumerator_71350.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_71350._key (HERE)) ;
          enumerator_71350.next () ;
        }
      }
      operand_69068->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1847)) ;
    }
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_matchInstructionAST * operand_71867,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_71867 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_72113 (operand_71867->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_72113 = NULL ;
      while (((operand_72113 = enumerator_72113.nextObject ()))) {
        macroValidPointer (operand_72113) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_72113->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_72113->mExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1866)) ;
          }
        }
        ...
        const GGS_bool cond_72785 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1874))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1874))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))) ;
        if (cond_72785.isBuiltAndTrue ()) {
          operand_72113->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1876)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1878)) ;
        }
      }
    }
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_72999 (operand_71867->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_72999 = NULL ;
      while (((operand_72999 = enumerator_72999.nextObject ()))) {
        macroValidPointer (operand_72999) ;
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        GGS_matchListForGeneration  var_cas_matchListForGeneration = GGS_matchListForGeneration ::constructor_emptyList () ;
        const GGS_bool cond_75543 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_72999->mMatchEntryList.reader_length ()) ;
        if (cond_75543.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_73233 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_73233 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_73250 (operand_72999->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_73250 = NULL ;
            while (((operand_73233 = enumerator_73233.nextObject ()))
                && ((operand_73250 = enumerator_73250.nextObject ()))) {
              macroValidPointer (operand_73233) ;
              macroValidPointer (operand_73250) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_73233->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1889)) ;
              const GGS_bool cond_74650 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1890))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1890))) ;
              if (cond_74650.isBuiltAndTrue ()) {
                const GGS_bool cond_74331 = operand_73250->mIsType ;
                if (cond_74331.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, operand_73250->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1892)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_73877 = var_cas_inAnalysisContext.mSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1895)) ;
                  GGS_bool _condition_73877 (_variant_73877.isBuilt (), true) ;
                  while (_condition_73877.isBuiltAndTrue ()) {
                    _condition_73877 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1896)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1896))).operator_not ()) ;
                    if (_condition_73877.isBuiltAndTrue ()) {
                      if (_variant_73877.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1899)) ;
                        _condition_73877 = GGS_bool (false) ;
                      }else{
                        _variant_73877.decrement_operation (inLexique COMMA_HERE) ;
                  ...
                  const GGS_bool cond_74147 = (var_cas_found).operator_not () ;
                  if (cond_74147.isBuiltAndTrue ()) {
                    operand_73250->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_73250->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1902)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1904)) ;
                  }else if (cond_74147.isBuiltAndFalse ()) {
                    const GGS_bool cond_74311 = (operand_73250->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1904)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_74311.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_73250->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_74331.isBuiltAndFalse ()) {
                  operand_73250->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_73233->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1909)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1909)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1911)) ;
                }
                var_cas_matchListForGeneration.addAssign_operation (GGS_bool (true), operand_73250->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1912)), operand_73250->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1912))) ;
              }else if (cond_74650.isBuiltAndFalse ()) {
                const GGS_bool cond_75426 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1913))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1913))) ;
                if (cond_75426.isBuiltAndTrue ()) {
                  const GGS_bool cond_74927 = operand_73250->mIsType ;
                  if (cond_74927.isBuiltAndTrue ()) {
                    operand_73250->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_73233->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1916)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1916)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1918)) ;
                  }else if (cond_74927.isBuiltAndFalse ()) {
                    const GGS_bool cond_75245 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1918)).reader_hasKey (operand_73250->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1918)))).operator_not () ;
                    if (cond_75245.isBuiltAndTrue ()) {
                      operand_73250->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_73250->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_73233->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1920)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1920)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1922)) ;
                    }
                  }
                  var_cas_matchListForGeneration.addAssign_operation (GGS_bool (false), operand_73250->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1925)), operand_73233->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1926)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1926))) ;
                }else if (cond_75426.isBuiltAndFalse ()) {
                  operand_73250->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (1930)) ;
                }
              }
            }
          }
        }else if (cond_75543.isBuiltAndFalse ()) {
          operand_72999->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1934)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_72999->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1935))) COMMA_SOURCE_FILE_AT_LINE (1937)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_72999->mMatchBranchInstructionList,  operand_72999->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1940)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_71867->mElseInstructionList,  operand_71867->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1954)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_71867->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1964)) ;
