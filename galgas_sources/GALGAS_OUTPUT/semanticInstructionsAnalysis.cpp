...
//                                         september 25th, 2014, at 16h26'15"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_110892.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_110927 (enumerator_110892.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_110927.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantMap.reader_hasKey (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2801)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2801)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2802)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2802)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_110927.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2803)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2807))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2807)) ;
        GALGAS_unifiedTypeMapProxyList var_associatedTypeList ;
        GALGAS_uint joker_111310_0 ; // Joker input parameter
        var_enumConstantMap.method_searchKey (enumerator_110927.current_mValue (HERE), joker_111310_0, var_associatedTypeList, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2808)) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, enumerator_110892.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_location location_5 (enumerator_110927.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the associated values of '").operator_concat (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).operator_concat (GALGAS_string ("' constant should be extracted")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2810)) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_110892.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813)).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_location location_7 (enumerator_110927.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).operator_concat (GALGAS_string ("' constant has no associated value")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2814)) ;
          }
        }
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_8 (enumerator_110927.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_8, GALGAS_string ("'").operator_concat (enumerator_110927.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820)).operator_concat (GALGAS_string ("' is not a constant of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2819)) ;
      }
      enumerator_110927.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2826)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2827)), enumerator_110892.current_mInstructions (HERE), enumerator_110892.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2824)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_110892.current_mSwitchConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2833)) ;
    enumerator_110892.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_switch_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2835)) ;
  }
  GALGAS_stringset var_forgottenConstants = var_enumConstantMap.reader_keySet (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2837)).substract_operation (var_constantsNamedInSwitchInstruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2837)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, var_forgottenConstants.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2838)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_112640 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_112640.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_112640.current_key (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2841))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2841)) ;
      enumerator_112640.gotoNextObject () ;
    }
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_switchInstructionForGeneration::constructor_new (var_switchExpression, var_switchBranchesForGeneration  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2848))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2848)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionListForGeneration var_expressionList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2863)) ;
  cEnumerator_semanticExpressionListAST enumerator_113490 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_113490.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_113490.current_mExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2868)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2867)) ;
    var_expressionList.addAssign_operation (var_matchedExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2873)) ;
    GALGAS_unifiedTypeMapProxy var_type = var_matchedExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2875)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2876)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2876)))).operator_and (GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2876)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2876)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2876)).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_113490.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2878))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2878)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2878))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2877)) ;
    }
    enumerator_113490.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2883)) ;
  }
  GALGAS_matchInstructionBranchListForGeneration var_matchInstructionBranchList = GALGAS_matchInstructionBranchListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2884)) ;
  cEnumerator_matchInstructionBranchListAST enumerator_114390 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_114390.hasCurrentObject ()) {
    GALGAS_localConstantList var_localConstantList = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2887)) ;
    GALGAS_matchListForGeneration var_matchListForGeneration = GALGAS_matchListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2888)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2889)).objectCompare (enumerator_114390.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2889)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_114624 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_114641 (enumerator_114390.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_114624.hasCurrentObject () && enumerator_114641.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_114624.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2891)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2892)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2892)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_114641.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2894)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_namedType)) ;
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)).isValid ()) {
              uint32_t variant_115035 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)).uintValue () ;
              bool loop_115035 = true ;
              while (loop_115035) {
                loop_115035 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).isValid () ;
                if (loop_115035) {
                  loop_115035 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2898)).boolValue () ;
                }
                if (loop_115035 && (0 == variant_115035)) {
                  loop_115035 = false ;
                  inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)) ;
                }
                if (loop_115035) {
                  variant_115035 -- ;
                  var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2899)) ;
                  var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_namedType)) ;
                }
              }
            }
            const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2902)).boolEnum () ;
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2904))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2904)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2904)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2904))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2904)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2904))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2903)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_114641.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2906)).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2906)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_114641.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2907)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_114624.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911)).operator_concat (GALGAS_string ("' class is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2910)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2914)), enumerator_114641.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2914))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2914)) ;
        }else if (kBoolFalse == test_2) {
          const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2915)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2915)))).boolEnum () ;
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_114641.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_114624.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2918)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2918))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2918)).operator_concat (GALGAS_string ("' enumeration type is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2918))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2917)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).reader_hasKey (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922)).operator_concat (enumerator_114624.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2922))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2921)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2927)), enumerator_114624.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2928)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2928))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2925)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_114641.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_13, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2931)) ;
          }
        }
        enumerator_114624.gotoNextObject () ;
        enumerator_114641.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_114390.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)).operator_concat (GALGAS_string (" elements, but it acually contains ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)).operator_concat (enumerator_114390.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2937)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2937))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2935)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2945)), enumerator_114390.current_mMatchBranchInstructionList (HERE), enumerator_114390.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)) ;
    }
    var_matchInstructionBranchList.addAssign_operation (var_matchListForGeneration, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2952)) ;
    enumerator_114390.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_elseInstructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2959)), object->mAttribute_mElseInstructionList, object->mAttribute_mEndOf_5F_match_5F_instruction, ioArgument_ioVariableMap, var_elseInstructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2956)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_match_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2966)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_matchInstructionForGeneration::constructor_new (var_expressionList, var_matchInstructionBranchList, var_elseInstructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2968))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2968)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
