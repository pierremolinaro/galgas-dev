...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_74031_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE_AT_LINE (1924)) ;
  GALGAS_formalParameterSignature var_labelSignature ;
  var_grammarLabelMap.method_searchKey (object->mAttribute_mLabelName, var_labelSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (1931)) ;
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  {
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mLabelName, GALGAS_string ("label of the ").operator_concat (object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (1940)) COMMA_SOURCE_FILE_AT_LINE (1940)).operator_concat (GALGAS_string (" grammar") COMMA_SOURCE_FILE_AT_LINE (1940)), var_labelSignature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_actualParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1937)) ;
  }
  GALGAS_semanticExpressionForGeneration var_sourceExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mSourceExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_sourceExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1947)) ;
  const enumGalgasBool test_0 = object->mAttribute_mSourceExpressionIsFile.boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1954)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLStringType)).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mEndOfSourceExpression, GALGAS_string ("this expression is the source file path and its type should be '@lstring', but it is '@").operator_concat (var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1956)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)) COMMA_SOURCE_FILE_AT_LINE (1956)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1956)) COMMA_SOURCE_FILE_AT_LINE (1955)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1959)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (object->mAttribute_mEndOfSourceExpression, GALGAS_string ("this expression is the source string and its type should be '@string', but it is '@").operator_concat (var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1961)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1961)) COMMA_SOURCE_FILE_AT_LINE (1961)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1961)) COMMA_SOURCE_FILE_AT_LINE (1960)) ;
    }
  }
  const enumGalgasBool test_3 = object->mAttribute_mSourceExpressionIsFile.boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_grammarInstructionWithSourceFileForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (1968)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (1969)), var_sourceExpression, var_actualParameterListForGeneration, var_hasTranslateFeature COMMA_SOURCE_FILE_AT_LINE (1966)) COMMA_SOURCE_FILE_AT_LINE (1966)) ;
  }else if (kBoolFalse == test_3) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_grammarInstructionWithSourceExpressionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (1977)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (1978)), var_sourceExpression, var_actualParameterListForGeneration, var_hasTranslateFeature COMMA_SOURCE_FILE_AT_LINE (1975)) COMMA_SOURCE_FILE_AT_LINE (1975)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_76867_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_76867_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2005)) ;
  }
  cEnumerator_lstringlist enumerator_76892 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_76892.hasCurrentObject ()) {
    GALGAS_attributeMap var_attributeMap = var_targetType.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2007)) ;
    var_attributeMap.method_searchKey (enumerator_76892.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE_AT_LINE (2008)) ;
    enumerator_76892.gotoNextObject () ;
  }
  ...
  const cMapElement_withAccessorMap * objectArray_77171 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (2013))) ;
  if (NULL != objectArray_77171) {
      macroValidSharedObject (objectArray_77171, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_77171->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2014)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_77554 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_77554.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_77554.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2024)) COMMA_SOURCE_FILE_AT_LINE (2024)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2024)).operator_concat (enumerator_77554.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2024)) COMMA_SOURCE_FILE_AT_LINE (2024)) COMMA_SOURCE_FILE_AT_LINE (2024)) ;
        enumerator_77554.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_78460 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_78478 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_78460.hasCurrentObject () && enumerator_78478.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_78478.current_mType (HERE), enumerator_78460.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2042)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (2042)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2042)) ;
      }
      enumerator_78460.gotoNextObject () ;
      enumerator_78478.gotoNextObject () ;
    }
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_78811 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2049)), kEnumeration_up) ;
  while (enumerator_78811.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_78811.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2052)).operator_concat (enumerator_78811.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2052)) COMMA_SOURCE_FILE_AT_LINE (2052)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (2052)) COMMA_SOURCE_FILE_AT_LINE (2052)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2053)).operator_concat (enumerator_78811.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2053)) COMMA_SOURCE_FILE_AT_LINE (2053)) COMMA_SOURCE_FILE_AT_LINE (2050)) ;
    enumerator_78811.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_81103 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2119))) ;
  if (NULL != objectArray_81103) {
      macroValidSharedObject (objectArray_81103, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_81103->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2120)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_81500 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_81500.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_81500.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2130)) COMMA_SOURCE_FILE_AT_LINE (2130)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2130)).operator_concat (enumerator_81500.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2130)) COMMA_SOURCE_FILE_AT_LINE (2130)) COMMA_SOURCE_FILE_AT_LINE (2130)) ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_82434 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_82452 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_82434.hasCurrentObject () && enumerator_82452.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_82452.current_mType (HERE), enumerator_82434.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2148)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2148)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2148)) ;
      }
      enumerator_82434.gotoNextObject () ;
      enumerator_82452.gotoNextObject () ;
    }
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_82771 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2155)), kEnumeration_up) ;
  while (enumerator_82771.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_82771.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2158)).operator_concat (enumerator_82771.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2158)) COMMA_SOURCE_FILE_AT_LINE (2158)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2158)) COMMA_SOURCE_FILE_AT_LINE (2158)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2160)).operator_concat (enumerator_82771.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2160)) COMMA_SOURCE_FILE_AT_LINE (2160)) COMMA_SOURCE_FILE_AT_LINE (2156)) ;
    enumerator_82771.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_85204 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_85204.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_85239 (enumerator_85204.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_85239.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_85239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2224)) COMMA_SOURCE_FILE_AT_LINE (2224)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_85239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2225)) COMMA_SOURCE_FILE_AT_LINE (2225)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_85239.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_85239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2227)) COMMA_SOURCE_FILE_AT_LINE (2227)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction") COMMA_SOURCE_FILE_AT_LINE (2227)) COMMA_SOURCE_FILE_AT_LINE (2226)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_85239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2230)) COMMA_SOURCE_FILE_AT_LINE (2230)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_85239.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_85239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2233)).operator_concat (GALGAS_string ("' is not a constant of '@") COMMA_SOURCE_FILE_AT_LINE (2233)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2233)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2233)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2232)) ;
      }
      enumerator_85239.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2240)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2241)), enumerator_85204.current_mInstructions (HERE), enumerator_85204.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2238)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_85204.current_mSwitchConstantList (HERE), var_instructionList COMMA_SOURCE_FILE_AT_LINE (2247)) ;
    enumerator_85204.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_86444 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_86444.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_86444.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (2255)) COMMA_SOURCE_FILE_AT_LINE (2255)) ;
      enumerator_86444.gotoNextObject () ;
    }
