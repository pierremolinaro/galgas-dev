  ...
  if (operand_36360 != NULL) {
    {
      ...
      while (((operand_36563 = enumerator_36563.nextObject ()))) {
        ...
        var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_logInstructionForGeneration ::constructor_new (inLexique, operand_36563->mLogMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (945)), var_cas_expression COMMA_SOURCE_FILE_AT_LINE (944))) ;
      }
    }
  }
}
...
category_method__dropInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_dropInstructionAST * operand_37122,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
  ...
  if (operand_37122 != NULL) {
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_37384 (operand_37122->mDropList, true) ;
      const GGS_lstringlist::cElement * operand_37384 = NULL ;
      while (((operand_37384 = enumerator_37384.nextObject ()))) {
        macroValidPointer (operand_37384) ;
        GGS_string var_cas_variableCppName ;
        GGS_unifiedTypeMapProxy  automatic_var_37487_0 ;
        var_cas_ioVariableMap.modifier_searchForDropAccess (inLexique, operand_37384->mValue, automatic_var_37487_0, var_cas_variableCppName COMMA_SOURCE_FILE_AT_LINE (962)) ;
...
category_method__ifInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_ifInstructionAST * operand_37854,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37854 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_if_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_37854->m_if_expression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_37854->m_if_expression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_if_expression COMMA_SOURCE_FILE_AT_LINE (982)) ;
      }
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_37854->m_then_instructionList,  operand_37854->mEndOf_then_branch,  var_cas_ioVariableMap,  var_cas_then_instructionList COMMA_SOURCE_FILE_AT_LINE (991)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_37854->m_else_instructionList,  operand_37854->mEndOf_if_instruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1003)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_37854->mEndOf_if_instruction COMMA_SOURCE_FILE_AT_LINE (1013)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_ifInstructionForGeneration ::constructor_new (inLexique, operand_37854->mEndOf_then_branch, var_cas_if_expression, var_cas_then_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1015))) ;
  }
}
...
category_method__foreachInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_foreachInstructionAST * operand_39400,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
  ...
  if (operand_39400 != NULL) {
    ...
    {
      GGS_foreachInstructionEnumeratedObjectListAST::cEnumerator enumerator_39867 (operand_39400->mEnumeratedObjectList, true) ;
      const GGS_foreachInstructionEnumeratedObjectListAST::cElement * operand_39867 = NULL ;
      while (((operand_39867 = enumerator_39867.nextObject ()))) {
        macroValidPointer (operand_39867) ;
        GGS_semanticExpressionForGeneration  var_cas_enumerationExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_39867->mEnumeratedExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_39867->mEnumeratedExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_enumerationExpression COMMA_SOURCE_FILE_AT_LINE (1039)) ;
          }
        }
        const GGS_string var_cas_enumeratorCppName = (GGS_string ("enumerator_")).operator_concat (operand_39867->mEndOfEnumerationExpression.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1046)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1046))) ;
        ...
        const GGS_bool cond_40597 = (var_cas_enumerationDescriptorList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
        if (cond_40597.isBuiltAndTrue ()) {
          operand_39867->mEndOfEnumerationExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("an '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)))).operator_concat (GGS_string ("' object cannot be enumerated")) COMMA_SOURCE_FILE_AT_LINE (1051)) ;
        }else if (cond_40597.isBuiltAndFalse ()) {
          const GGS_bool cond_41119 = ((operand_39867->mElementList.reader_length ()).operator_isEqual (GGS_uint (0U))).operator_and ((operand_39867->mEndsWithEllipsis).operator_not ()) ;
          if (cond_41119.isBuiltAndTrue ()) {
            ...
            {
              GGS_enumerationDescriptorList::cEnumerator enumerator_40820 (var_cas_currentTypedAttributeList, true) ;
              const GGS_enumerationDescriptorList::cElement * operand_40820 = NULL ;
              while (((operand_40820 = enumerator_40820.nextObject ()))) {
                macroValidPointer (operand_40820) ;
                var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_39867->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1055))).operator_concat (operand_40820->mEnumerationName), operand_39867->mEndOfEnumerationExpression COMMA_SOURCE_FILE_AT_LINE (1055)), operand_40820->mEnumeratedType, ((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_40820->mEnumerationName.reader_identifierRepresentation ()) COMMA_SOURCE_FILE_AT_LINE (1054)) ;
              }
            }
          }else if (cond_41119.isBuiltAndFalse ()) {
            const GGS_bool cond_41561 = ((operand_39867->mEndsWithEllipsis).operator_not ()).operator_and ((operand_39867->mElementList.reader_length ()).operator_isNotEqual (var_cas_enumerationDescriptorList.reader_length ())) ;
            if (cond_41561.isBuiltAndTrue ()) {
              operand_39867->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1062)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1062)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1063)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" for enumeration: this list provides "))).operator_concat (operand_39867->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1066))) COMMA_SOURCE_FILE_AT_LINE (1068)) ;
            }else if (cond_41561.isBuiltAndFalse ()) {
              const GGS_bool cond_42005 = (operand_39867->mEndsWithEllipsis).operator_and ((operand_39867->mElementList.reader_length ()).operator_strictSup (var_cas_enumerationDescriptorList.reader_length ())) ;
              if (cond_42005.isBuiltAndTrue ()) {
                operand_39867->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" or less for enumeration: this list provides "))).operator_concat (operand_39867->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074))) COMMA_SOURCE_FILE_AT_LINE (1076)) ;
              }else if (cond_42005.isBuiltAndFalse ()) {
                {
                  GGS_foreachInstructionEnumeratedObjectElementListAST::cEnumerator enumerator_42032 (operand_39867->mElementList, true) ;
                  const GGS_foreachInstructionEnumeratedObjectElementListAST::cElement * operand_42032 = NULL ;
                  GGS_enumerationDescriptorList::cEnumerator enumerator_42059 (var_cas_enumerationDescriptorList, true) ;
                  const GGS_enumerationDescriptorList::cElement * operand_42059 = NULL ;
                  while (((operand_42032 = enumerator_42032.nextObject ()))
                      && ((operand_42059 = enumerator_42059.nextObject ()))) {
                    macroValidPointer (operand_42032) ;
                    macroValidPointer (operand_42059) ;
                    const GGS_bool cond_42629 = (operand_42032->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1078))).operator_isNotEqual (GGS_string ("")) ;
                    if (cond_42629.isBuiltAndTrue ()) {
                      const GGS_unifiedTypeMapProxy  var_cas_foundType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42032->mTypeName COMMA_SOURCE_FILE_AT_LINE (1079)) ;
                      const GGS_bool cond_42446 = (var_cas_foundType).operator_isNotEqual (operand_42059->mEnumeratedType) ;
                      if (cond_42446.isBuiltAndTrue ()) {
                        operand_42032->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("incorrect '@")).operator_concat (var_cas_foundType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)))).operator_concat (GGS_string ("' type: '@"))).operator_concat (operand_42059->mEnumeratedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)))).operator_concat (GGS_string ("' type required here")) COMMA_SOURCE_FILE_AT_LINE (1082)) ;
                      }
                      var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, operand_42032->mConstantName, operand_42059->mEnumeratedType, ((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_42059->mEnumerationName.reader_identifierRepresentation ()) COMMA_SOURCE_FILE_AT_LINE (1083)) ;
                    }
                  }
                }
              }
        ...
        var_cas_enumerationList.addAssign_operation (operand_39867->mIsAscending, var_cas_enumerationExpression, var_cas_enumeratorCppName) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_whileExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_39400->mWhileExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_39400->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_whileExpression COMMA_SOURCE_FILE_AT_LINE (1092)) ;
      }
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39400->mBeforeInstructionList,  operand_39400->mEndOf_before_branch,  var_cas_ioVariableMap,  var_cas_before_instructionList COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    ...
    const GGS_bool cond_43819 = (operand_39400->mIndexVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1115))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_43819.isBuiltAndTrue ()) {
      var_cas_indexCppName = (GGS_string ("index_")).operator_concat (operand_39400->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1116)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1116))) ;
      var_cas_indexDeclaration.addAssign_operation (var_cas_inPredefinedTypes.mUIntType, operand_39400->mIndexVariableName, GGS_bool (false), var_cas_indexCppName) ;
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_indexDeclaration,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39400->mDoInstructionList,  operand_39400->mEndOf_do_branch,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    GGS_semanticInstructionListForGeneration  var_cas_between_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39400->mBetweenInstructionList,  operand_39400->mEndOf_between_branch,  var_cas_ioVariableMap,  var_cas_between_instructionList COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    GGS_semanticInstructionListForGeneration  var_cas_after_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39400->mAfterInstructionList,  operand_39400->mEndOf_after_branch,  var_cas_ioVariableMap,  var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1150)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_39400->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1161)) ;
    var_cas_ioVariableMap.modifier_endBranch (inLexique, operand_39400->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1163)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_39400->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1164)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_foreachInstructionForGeneration ::constructor_new (inLexique, operand_39400->mInstructionLocation, var_cas_enumerationList, var_cas_indexCppName, var_cas_whileExpression, var_cas_before_instructionList, var_cas_between_instructionList, var_cas_do_instructionList, var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1166))) ;
  }
}
...
category_method__loopInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_loopInstructionAST * operand_45559,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45559 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_variantExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_45559->mVariantExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45559->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variantExpression COMMA_SOURCE_FILE_AT_LINE (1188)) ;
      }
    }
    const GGS_bool cond_46271 = (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1195))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
    if (cond_46271.isBuiltAndTrue ()) {
      operand_45559->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    }
    GGS_semanticExpressionForGeneration  var_cas_loopExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_45559->mLoopExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45559->mLoopExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_loopExpression COMMA_SOURCE_FILE_AT_LINE (1201)) ;
      }
    }
    const GGS_bool cond_46777 = (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1208))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
    if (cond_46777.isBuiltAndTrue ()) {
      operand_45559->mEndOfLoopExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the loop expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_45559->mFirstInstructions,  operand_45559->mEndOfFirstInstructions,  var_cas_ioVariableMap,  var_cas_first_instructionList COMMA_SOURCE_FILE_AT_LINE (1216)) ;
    GGS_semanticInstructionListForGeneration  var_cas_second_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_45559->mSecondInstructions,  operand_45559->mEndOfSecondInstructions,  var_cas_ioVariableMap,  var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1228)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_45559->mEndOfLoopInstruction COMMA_SOURCE_FILE_AT_LINE (1239)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_loopInstructionForGeneration ::constructor_new (inLexique, operand_45559->mInstructionLocation, var_cas_variantExpression, var_cas_first_instructionList, var_cas_loopExpression, var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1241))) ;
  }
}
...
category_method__structuredCastInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_structuredCastInstructionAST * operand_48056,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48056 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_castExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_48056->mCastExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48056->mCastExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_castExpression COMMA_SOURCE_FILE_AT_LINE (1260)) ;
      }
    }
    ...
    {
      GGS_castInstructionBranchListAST::cEnumerator enumerator_48671 (operand_48056->mCastInstructionBranchList, true) ;
      const GGS_castInstructionBranchListAST::cElement * operand_48671 = NULL ;
      while (((operand_48671 = enumerator_48671.nextObject ()))) {
        macroValidPointer (operand_48671) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_48671->mTypeName COMMA_SOURCE_FILE_AT_LINE (1272)) ;
        ...
        GGS_uint _variant_49116 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1276)) ;
        GGS_bool _condition_49116 (_variant_49116.isBuilt (), true) ;
        while (_condition_49116.isBuiltAndTrue ()) {
          _condition_49116 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))).operator_not ()) ;
          if (_condition_49116.isBuiltAndTrue ()) {
            if (_variant_49116.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1280)) ;
              _condition_49116 = GGS_bool (false) ;
            }else{
              _variant_49116.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_49743 = (operand_48671->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_49743.isBuiltAndTrue ()) {
          var_cas_localConstantName = (((GGS_string ("cast_")).operator_concat (operand_48671->mConstantVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)))).operator_concat (GGS_string ("_"))).operator_concat (operand_48671->mConstantVarName) ;
          var_cas_localConstantList.addAssign_operation (var_cas_type, operand_48671->mConstantVarName, GGS_bool (false), var_cas_localConstantName) ;
        }else if (cond_49743.isBuiltAndFalse ()) {
          var_cas_localConstantName = GGS_string ("") ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48671->mInstructionList,  operand_48671->mEndOfInstructions,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1302)) ;
        var_cas_castBranchList.addAssign_operation (operand_48671->mUseKindOfClass, var_cas_type, var_cas_localConstantName, var_cas_instructionList) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48056->mElseInstructionList,  operand_48056->mEndOfCastInstruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1316)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_48056->mEndOfCastInstruction COMMA_SOURCE_FILE_AT_LINE (1327)) ;
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_grammarInstructionAST * operand_51023,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51023 != NULL) {
    GGS_grammarLabelMap  var_cas_grammarLabelMap ;
    if (var_cas_inSemanticContext.mGrammarMap.isBuilt ()) {
      var_cas_inSemanticContext.mGrammarMap (HERE)->method_searchKey (inLexique, operand_51023->mGrammarComponentName, var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    }
    GGS_formalParameterSignature  var_cas_labelSignature ;
    if (var_cas_grammarLabelMap.isBuilt ()) {
      var_cas_grammarLabelMap (HERE)->method_searchKey (inLexique, operand_51023->mLabelName, var_cas_labelSignature COMMA_SOURCE_FILE_AT_LINE (1352)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_51023->mLabelName,  ((GGS_string ("label of the ")).operator_concat (operand_51023->mGrammarComponentName)).operator_concat (GGS_string (" grammar")),  var_cas_labelSignature,  operand_51023->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1358)) ;
    GGS_semanticExpressionForGeneration  var_cas_sourceExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_51023->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_51023->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_sourceExpression COMMA_SOURCE_FILE_AT_LINE (1370)) ;
      }
    }
    const GGS_bool cond_52482 = operand_51023->mSourceExpressionIsFile ;
    if (cond_52482.isBuiltAndTrue ()) {
      const GGS_bool cond_52469 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1378))).operator_isNotEqual (var_cas_inPredefinedTypes.mLStringType) ;
      if (cond_52469.isBuiltAndTrue ()) {
        operand_51023->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source file path and its type should be '@lstring', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1382)) ;
      }
    }else if (cond_52482.isBuiltAndFalse ()) {
      const GGS_bool cond_52721 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1383))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
      if (cond_52721.isBuiltAndTrue ()) {
        operand_51023->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source string and its type should be '@string', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1387)) ;
      }
    }
    const GGS_bool cond_53049 = operand_51023->mSourceExpressionIsFile ;
    if (cond_53049.isBuiltAndTrue ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceFileForGeneration ::constructor_new (inLexique, operand_51023->mInstructionLocation, operand_51023->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1392)), operand_51023->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1393)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1390))) ;
    }else if (cond_53049.isBuiltAndFalse ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceExpressionForGeneration ::constructor_new (inLexique, operand_51023->mInstructionLocation, operand_51023->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1400)), operand_51023->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1401)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1398))) ;
    }
  }
}
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readWriteAccessWithInstructionAST * operand_53493,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53493 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_53493->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_53493->mKeyExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_53493->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1425)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1425))) ;
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_receiverVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_53493->mReceiverName, var_cas_targetType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (1429)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_54260 (operand_53493->mFieldList, true) ;
      const GGS_lstringlist::cElement * operand_54260 = NULL ;
      while (((operand_54260 = enumerator_54260.nextObject ()))) {
        macroValidPointer (operand_54260) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_54260->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (1432)) ;
        }
      }
    }
    ...
    elementOf_GGS_withAccessorMap * operand_54586 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_53493->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1437))) ;
    if (NULL != operand_54586) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_54586->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_54899 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_54899.isBuiltAndTrue ()) {
        operand_53493->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1445)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_54899.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_54953 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_54953 = NULL ;
          while (((operand_54953 = enumerator_54953.nextObject ()))) {
            macroValidPointer (operand_54953) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_54953->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_54953->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1448))) ;
          }
        }
        operand_53493->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1451)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_53493->mAccessName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1456)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    ...
    const GGS_bool cond_55820 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_55820.isBuiltAndTrue ()) {
      operand_53493->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_53493->mAccessName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1461)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1463)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1464)) ;
    }else if (cond_55820.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_55856 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_55856 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_55874 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_55874 = NULL ;
        while (((operand_55856 = enumerator_55856.nextObject ()))
            && ((operand_55874 = enumerator_55874.nextObject ()))) {
          macroValidPointer (operand_55856) ;
          macroValidPointer (operand_55874) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_55874->mType,  operand_55856->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1466)),  operand_53493->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1466)) COMMA_SOURCE_FILE_AT_LINE (1466)) ;
        }
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_56170 (var_cas_targetType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1473)), true) ;
      const GGS_typedAttributeList::cElement * operand_56170 = NULL ;
      while (((operand_56170 = enumerator_56170.nextObject ()))) {
        macroValidPointer (operand_56170) ;
        var_cas_localInitializedVariableList.addAssign_operation (operand_56170->mAttributeTypeIndex, GGS_lstring ::constructor_new (inLexique, (operand_53493->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476))).operator_concat (operand_56170->mAttributeName), operand_53493->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)) COMMA_SOURCE_FILE_AT_LINE (1476)), ((var_cas_objectArrayCppName).operator_concat (GGS_string ("->mAttribute_"))).operator_concat (operand_56170->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  var_cas_localInitializedVariableList,  operand_53493->m_do_Instructions,  operand_53493->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1481)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_53493->m_else_Instructions,  operand_53493->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1493)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_53493->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1503)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, var_cas_targetType, operand_53493->mFieldList, operand_53493->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1505))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_57640,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57640 != NULL) {
    operand_57640->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @readAccessWithInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1528)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_58098,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58098 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_58098->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58098->mSwitchExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1540)) ;
      }
    }
    const GGS_bool cond_58843 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1547))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1547))) ;
    if (cond_58843.isBuiltAndTrue ()) {
      operand_58098->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1550)) ;
    }
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_59192 (operand_58098->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_59192 = NULL ;
      while (((operand_59192 = enumerator_59192.nextObject ()))) {
        macroValidPointer (operand_59192) ;
        {
          GGS_lstringlist::cEnumerator enumerator_59227 (operand_59192->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_59227 = NULL ;
          while (((operand_59227 = enumerator_59227.nextObject ()))) {
            macroValidPointer (operand_59227) ;
            const GGS_bool cond_59582 = var_cas_enumConstantStringSet.reader_hasKey (operand_59227->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1559))) ;
            if (cond_59582.isBuiltAndTrue ()) {
              const GGS_bool cond_59502 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_59227->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1560))) ;
              if (cond_59502.isBuiltAndTrue ()) {
                operand_59227->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_59227->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1564)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_59227->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565))) ;
            }else if (cond_59582.isBuiltAndFalse ()) {
              operand_59227->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_59227->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1570)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_59192->mInstructions,  operand_59192->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1573)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_59192->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_58098->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1585)) ;
    ...
    const GGS_bool cond_60660 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_60660.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_60466 (var_cas_forgottenConstants, true) ;
        while (enumerator_60466.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_60466._key (HERE)) ;
          enumerator_60466.next () ;
        }
      }
      operand_58098->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1596)) ;
    }
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_60983,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60983 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_61268 (operand_60983->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_61268 = NULL ;
      while (((operand_61268 = enumerator_61268.nextObject ()))) {
        macroValidPointer (operand_61268) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_61268->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_61268->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1616)) ;
          }
        }
        ...
        const GGS_bool cond_61965 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1625))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1625))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))) ;
        if (cond_61965.isBuiltAndTrue ()) {
          operand_61268->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1627)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1629)) ;
        }
      }
    }
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_62180 (operand_60983->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_62180 = NULL ;
      while (((operand_62180 = enumerator_62180.nextObject ()))) {
        macroValidPointer (operand_62180) ;
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        GGS_matchListForGeneration  var_cas_matchListForGeneration = GGS_matchListForGeneration ::constructor_emptyList () ;
        const GGS_bool cond_64688 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_62180->mMatchEntryList.reader_length ()) ;
        if (cond_64688.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_62414 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_62414 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_62431 (operand_62180->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_62431 = NULL ;
            while (((operand_62414 = enumerator_62414.nextObject ()))
                && ((operand_62431 = enumerator_62431.nextObject ()))) {
              macroValidPointer (operand_62414) ;
              macroValidPointer (operand_62431) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_62414->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)) ;
              const GGS_bool cond_63795 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1641))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1641))) ;
              if (cond_63795.isBuiltAndTrue ()) {
                const GGS_bool cond_63476 = operand_62431->mIsType ;
                if (cond_63476.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_62431->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1643)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_63022 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1646)) ;
                  GGS_bool _condition_63022 (_variant_63022.isBuilt (), true) ;
                  while (_condition_63022.isBuiltAndTrue ()) {
                    _condition_63022 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1647))).operator_not ()) ;
                    if (_condition_63022.isBuiltAndTrue ()) {
                      if (_variant_63022.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1650)) ;
                        _condition_63022 = GGS_bool (false) ;
                      }else{
                        _variant_63022.decrement_operation (inLexique COMMA_HERE) ;
                  ...
                  const GGS_bool cond_63292 = (var_cas_found).operator_not () ;
                  if (cond_63292.isBuiltAndTrue ()) {
                    operand_62431->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_62431->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1653)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1655)) ;
                  }else if (cond_63292.isBuiltAndFalse ()) {
                    const GGS_bool cond_63456 = (operand_62431->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_63456.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_62431->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_63476.isBuiltAndFalse ()) {
                  operand_62431->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_62414->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1662)) ;
                }
                var_cas_matchListForGeneration.addAssign_operation (GGS_bool (true), operand_62431->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), operand_62431->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663))) ;
              }else if (cond_63795.isBuiltAndFalse ()) {
                const GGS_bool cond_64571 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))) ;
                if (cond_64571.isBuiltAndTrue ()) {
                  const GGS_bool cond_64072 = operand_62431->mIsType ;
                  if (cond_64072.isBuiltAndTrue ()) {
                    operand_62431->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_62414->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1669)) ;
                  }else if (cond_64072.isBuiltAndFalse ()) {
                    const GGS_bool cond_64390 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)).reader_hasKey (operand_62431->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)))).operator_not () ;
                    if (cond_64390.isBuiltAndTrue ()) {
                      operand_62431->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_62431->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_62414->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1673)) ;
                    }
                  }
                  var_cas_matchListForGeneration.addAssign_operation (GGS_bool (false), operand_62431->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_62414->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1677)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1677))) ;
                }else if (cond_64571.isBuiltAndFalse ()) {
                  operand_62431->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (1681)) ;
                }
              }
            }
          }
        }else if (cond_64688.isBuiltAndFalse ()) {
          operand_62180->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1685)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_62180->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1686))) COMMA_SOURCE_FILE_AT_LINE (1688)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_62180->mMatchBranchInstructionList,  operand_62180->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1691)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_60983->mElseInstructionList,  operand_60983->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1706)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_60983->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1717)) ;
