...
void routine_checkExpressionIsBoolean (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      const cMapElement_readerMap * objectArray_57433 = (const cMapElement_readerMap *) var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1484)).readAccessForWithInstruction_hasKey (GALGAS_string ("bool")) ;
      if (NULL != objectArray_57433) {
          macroValidSharedObject (objectArray_57433, cMapElement_readerMap) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, objectArray_57433->mAttribute_mReturnedType.objectCompare (var_boolType)).boolEnum () ;
        if (kBoolTrue == test_4) {
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, objectArray_57433->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1487)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_5) {
            ...
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_57433->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              inCompiler->emitSemanticError (constinArgument_inErrorLocation, objectArray_57433->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1490)) ;
              outArgument_outExpression.drop () ; // Release error dropped variable
            }else if (kBoolFalse == test_6) {
              outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_boolType, constinArgument_inErrorLocation, objectArray_57433->mAttribute_mKind, constinArgument_inExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1497)), GALGAS_string ("bool"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1499)), objectArray_57433->mAttribute_mHasCompilerArgument  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1492)) ;
            }
          }
        }
      }else{
        ...
        if (kBoolTrue == test_7) {
          ...
          cEnumerator_readerMap enumerator_58635 (var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1511)), kEnumeration_up) ;
          while (enumerator_58635.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - ").operator_concat (enumerator_58635.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1512))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1512))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1512)) ;
            cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_58707 (enumerator_58635.current_mArgumentTypeList (HERE), kEnumeration_up) ;
            while (enumerator_58707.hasCurrentObject ()) {
              var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_58707.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1514))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1514))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1514)) ;
              enumerator_58707.gotoNextObject () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_58635.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1516))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1516))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1516)) ;
            enumerator_58635.gotoNextObject () ;
          }
...
static void categoryMethod_selfPlusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticExpressionListAST enumerator_46536 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_46564 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_46536.hasCurrentObject () && enumerator_46564.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_46536.current_mExpression (HERE).ptr (), enumerator_46564.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1187)) ;
        {
        routine_checkAssignmentTypes (enumerator_46564.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1193)), enumerator_46536.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1193)) ;
        }
        ...
        enumerator_46564.gotoNextObject () ;
      }
...
static void categoryMethod_incrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_49255_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_49255_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1260)) ;
  }
  cEnumerator_lstringlist enumerator_49290 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_49290.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_49290.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1263)) ;
...
static void categoryMethod_decrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_51642_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_51642_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1321)) ;
  }
  cEnumerator_lstringlist enumerator_51677 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_51677.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_51677.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1324)) ;
...
static void categoryMethod_logInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_logListAST enumerator_54812 (object->mAttribute_mLogList, kEnumeration_up) ;
  while (enumerator_54812.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_54812.current_mLogExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1411)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1410)) ;
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_logInstructionForGeneration::constructor_new (enumerator_54812.current_mLogMessage (HERE), var_expression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1417))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1417)) ;
...
static void categoryMethod_dropInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_55649 (object->mAttribute_mDropList, kEnumeration_up) ;
  while (enumerator_55649.hasCurrentObject ()) {
    GALGAS_string var_variableCppName ;
    GALGAS_unifiedTypeMapProxy var_t ;
    {
    GALGAS_string joker_55775_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForDropAccess (enumerator_55649.current_mValue (HERE), var_t, var_variableCppName, joker_55775_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1435)) ;
    }
    ...
    enumerator_55649.gotoNextObject () ;
  }
...
static void categoryMethod_enumeratedCollectionImplicitVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_62424 (var_enumerationDescriptorList, kEnumeration_up) ;
  while (enumerator_62424.hasCurrentObject ()) {
    ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_62424.current_mEnumeratedType (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_62424.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1624)), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1624)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1625)).operator_concat (enumerator_62424.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1625))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1625)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1625))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1622)) ;
...
static void categoryMethod_enumeratedCollectionCstListInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_enumerationDescriptorList enumerator_63887 (var_currentTypedAttributeList, kEnumeration_up) ;
      while (enumerator_63887.hasCurrentObject ()) {
        {
        ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_63887.current_mEnumerationName (HERE), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1656)), enumerator_63887.current_mEnumeratedType (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1658)).operator_concat (enumerator_63887.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1658))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1658)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1658)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1659)).operator_concat (enumerator_63887.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1659))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1659)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1659)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1655)) ;
        }
        enumerator_63887.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_5) {
          ...
          cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_65221 (object->mAttribute_mElementList, kEnumeration_up) ;
          cEnumerator_enumerationDescriptorList enumerator_65248 (var_enumerationDescriptorList, kEnumeration_up) ;
          while (enumerator_65221.hasCurrentObject () && enumerator_65248.hasCurrentObject ()) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_65221.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1680)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_65221.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_65221.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1682)) ;
                const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_65248.current_mEnumeratedType (HERE))).boolEnum () ;
                if (kBoolTrue == test_10) {
                  GALGAS_location location_11 (enumerator_65221.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_11, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684)).operator_concat (enumerator_65248.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1684)) ;
                }
              }
              ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_65248.current_mEnumeratedType (HERE), enumerator_65221.current_mConstantName (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1687)).operator_concat (enumerator_65248.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1687))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1687)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1687))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1687)) ;
            }
            enumerator_65221.gotoNextObject () ;
            enumerator_65248.gotoNextObject () ;
          }
        }
      }
    }
...
static void categoryMethod_forInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_forInstructionEnumeratedObjectListAST enumerator_68977 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  ...
  cEnumerator_localInitializedVariableList enumerator_69540 (var_localConstantListForDoBranch, kEnumeration_up) ;
  while (enumerator_69540.hasCurrentObject ()) {
    {
    ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_69540.current_mName (HERE), enumerator_69540.current_mType (HERE), enumerator_69540.current_mCppName (HERE), enumerator_69540.current_mCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1790)) ;
    }
    enumerator_69540.gotoNextObject () ;
  }
...
static void categoryMethod_foreachInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_foreachInstructionEnumeratedObjectListAST enumerator_73315 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_73315.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_73315.current_mEnumeratedExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1905)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1904)) ;
    GALGAS_string var_enumerationOrder = enumerator_73315.current_mEnumerationOrder (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1911)) ;
    GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (enumerator_73315.current_mEndOfEnumerationExpression (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1912)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1912))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1912)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringlist enumerator_74370 (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)), kEnumeration_up) ;
        bool bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)).isValidAndTrue () ;
        if (enumerator_74370.hasCurrentObject () && bool_2) {
          while (enumerator_74370.hasCurrentObject () && bool_2) {
            var_found = GALGAS_bool (kIsEqual, var_enumerationOrder.objectCompare (enumerator_74370.current_mValue (HERE))) ;
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  \\").operator_concat (enumerator_74370.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1925))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1925)) ;
            enumerator_74370.gotoNextObject () ;
            if (enumerator_74370.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_73315.current_mEnumerationOrder (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_73315.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1932)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (enumerator_73315.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1932)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1932)).boolEnum () ;
      if (kBoolTrue == test_5) {
        ...
        cEnumerator_enumerationDescriptorList enumerator_74873 (var_currentTypedAttributeList, kEnumeration_up) ;
        while (enumerator_74873.hasCurrentObject ()) {
          {
          ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_73315.current_mPrefix (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1936)).operator_concat (enumerator_74873.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1936)), enumerator_73315.current_mEndOfEnumerationExpression (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1936)), enumerator_74873.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938)).operator_concat (enumerator_74873.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939)).operator_concat (enumerator_74873.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1935)) ;
          }
          enumerator_74873.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = enumerator_73315.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_73315.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)).boolEnum () ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_9) {
            ...
            inCompiler->emitSemanticError (enumerator_73315.current_mEndOfElementList (HERE), GALGAS_string ("the '@").operator_concat (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).operator_concat (GALGAS_string ("' type requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).operator_concat (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).operator_concat (GALGAS_string (" argument")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)).operator_concat (temp_10  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)).operator_concat (GALGAS_string (" or less for enumeration: this list provides ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1954)).operator_concat (enumerator_73315.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1955))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1951)) ;
          }else if (kBoolFalse == test_9) {
            cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_76244 (enumerator_73315.current_mElementList (HERE), kEnumeration_up) ;
            cEnumerator_enumerationDescriptorList enumerator_76271 (var_enumerationDescriptorList, kEnumeration_up) ;
            while (enumerator_76244.hasCurrentObject () && enumerator_76271.hasCurrentObject ()) {
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_76244.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1960)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_76244.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_76244.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1962)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_76271.current_mEnumeratedType (HERE))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    GALGAS_location location_15 (enumerator_76244.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_15, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)).operator_concat (enumerator_76271.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)) ;
                  }
                }
                {
                ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_76244.current_mConstantName (HERE), enumerator_76271.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970)).operator_concat (enumerator_76271.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971)).operator_concat (enumerator_76271.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1967)) ;
                }
              }
              enumerator_76244.gotoNextObject () ;
              enumerator_76271.gotoNextObject () ;
            }
          }
        }
      }
    ...
    enumerator_73315.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_uncheckedWhileExpression ;
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_castInstructionBranchListAST enumerator_82229 (object->mAttribute_mCastInstructionBranchList, kEnumeration_up) ;
  while (enumerator_82229.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_82229.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)) ;
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).isValid ()) {
      uint32_t variant_82517 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).uintValue () ;
      bool loop_82517 = true ;
      while (loop_82517) {
        loop_82517 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).isValid () ;
        if (loop_82517) {
          loop_82517 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).boolValue () ;
        }
        if (loop_82517 && (0 == variant_82517)) {
          loop_82517 = false ;
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_82229.current_mConstantVarName (HERE).mAttribute_string.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2144)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_localConstantName = GALGAS_string ("cast_").operator_concat (enumerator_82229.current_mConstantVarName (HERE).reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).operator_concat (enumerator_82229.current_mConstantVarName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)) ;
      var_localConstantList.addAssign_operation (var_type, enumerator_82229.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2146)) ;
    }else if (kBoolFalse == test_2) {
      var_localConstantName = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)), enumerator_82229.current_mInstructionList (HERE), enumerator_82229.current_mEndOfInstructions (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2157)) ;
    }
    var_castBranchList.addAssign_operation (enumerator_82229.current_mTypeComparisonKind (HERE), var_type, var_localConstantName, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2166)) ;
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  {
  GALGAS_string joker_86436_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_86436_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2236)) ;
  }
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_89998_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_89998_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2305)) ;
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_93589_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_93589_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2405)) ;
  }
  cEnumerator_lstringlist enumerator_93614 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_93614.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_93614.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2408)) ;
    enumerator_93614.gotoNextObject () ;
  }
  ...
  const cMapElement_withAccessorMap * objectArray_93893 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mAccessName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2413))) ;
  if (NULL != objectArray_93893) {
      macroValidSharedObject (objectArray_93893, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_93893->mAttribute_mArgumentType  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2414)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_94276 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_94276.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_94276.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424)).operator_concat (GALGAS_string (" \?@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424)).operator_concat (enumerator_94276.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424)) ;
        enumerator_94276.gotoNextObject () ;
      }
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_95182 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_95200 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_95182.hasCurrentObject () && enumerator_95200.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_95200.current_mType (HERE), enumerator_95182.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2442)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2442)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2442)) ;
      }
      enumerator_95182.gotoNextObject () ;
      enumerator_95200.gotoNextObject () ;
    }
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_95533 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2449)), kEnumeration_up) ;
  while (enumerator_95533.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_95533.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452)).operator_concat (enumerator_95533.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2453)).operator_concat (enumerator_95533.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2453))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2453))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2450)) ;
    enumerator_95533.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_97891 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2521))) ;
  if (NULL != objectArray_97891) {
      macroValidSharedObject (objectArray_97891, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_97891->mAttribute_mArgumentType  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2522)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_98288 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_98288.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_98288.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532)).operator_concat (GALGAS_string (" \?@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532)).operator_concat (enumerator_98288.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532)) ;
        enumerator_98288.gotoNextObject () ;
      }
      GALGAS_string temp_2 ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_99222 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_99240 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_99222.hasCurrentObject () && enumerator_99240.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_99240.current_mType (HERE), enumerator_99222.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2550)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2550)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2550)) ;
      }
      enumerator_99222.gotoNextObject () ;
      enumerator_99240.gotoNextObject () ;
    }
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_99559 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2557)), kEnumeration_up) ;
  while (enumerator_99559.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_99559.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560)).operator_concat (enumerator_99559.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2562)).operator_concat (enumerator_99559.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2562))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2562))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2558)) ;
    enumerator_99559.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_102025 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_102025.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_102060 (enumerator_102025.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_102060.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_102060.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2627)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2627)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_102060.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_102060.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_102060.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2629)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_102060.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2633))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2633)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_102060.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_102060.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).operator_concat (GALGAS_string ("' is not a constant of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2635)) ;
      }
      enumerator_102060.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2643)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2644)), enumerator_102025.current_mInstructions (HERE), enumerator_102025.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2641)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_102025.current_mSwitchConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2650)) ;
    enumerator_102025.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_103265 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_103265.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_103265.current_key (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2658))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2658)) ;
      enumerator_103265.gotoNextObject () ;
    }
