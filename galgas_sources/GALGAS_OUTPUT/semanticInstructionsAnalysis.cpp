...
category_method__methodCallInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
  ...
  if (operand_26221 != NULL) {
    ...
    GGS_formalParameterSignature  var_cas_routineSignature ;
    GGS_bool var_cas_hasCompilerArgument ;
    GGS_location  automatic_var_26867_0 ;
    GGS_readerQualifier automatic_var_26867_1 ;
    const GGS_instanceMethodMap  temp_26808 = var_cas_receiverExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (674)).reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (674)) ;
    if (temp_26808.isBuilt ()) {
      temp_26808 (HERE)->method_searchKey (inLexique, operand_26221->mMethodName, var_cas_routineSignature, automatic_var_26867_0, var_cas_hasCompilerArgument, automatic_var_26867_1 COMMA_SOURCE_FILE_AT_LINE (674)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ...
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_methodCallInstructionForGeneration ::constructor_new (inLexique, operand_26221->mInstructionLocation, var_cas_receiverExpression, operand_26221->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (691)), var_cas_actualParameterListForGeneration, var_cas_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (688))) ;
  }
}
...
category_method__modifierCallInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_modifierCallInstructionAST * operand_27636,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27636 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_receiverType ;
    GGS_string var_cas_receiverVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_27636->mReceiverName, var_cas_receiverType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (708)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_28058 (operand_27636->mReceiverStructAttributes, true) ;
      const GGS_lstringlist::cElement * operand_28058 = NULL ;
      while (((operand_28058 = enumerator_28058.nextObject ()))) {
        macroValidPointer (operand_28058) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_receiverType.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (710)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_28058->mValue, var_cas_receiverType COMMA_SOURCE_FILE_AT_LINE (711)) ;
        }
      }
    }
    GGS_formalParameterSignature  var_cas_routineSignature ;
    GGS_bool var_cas_hasCompilerArgument ;
    GGS_readerQualifier automatic_var_28405_0 ;
    const GGS_modifierMap  temp_28347 = var_cas_receiverType.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (716)) ;
    if (temp_28347.isBuilt ()) {
      temp_28347 (HERE)->method_searchKey (inLexique, operand_27636->mModifierName, var_cas_routineSignature, var_cas_hasCompilerArgument, automatic_var_28405_0 COMMA_SOURCE_FILE_AT_LINE (716)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_27636->mModifierName,  ((GGS_string ("'")).operator_concat (operand_27636->mModifierName)).operator_concat (GGS_string ("' modifier header")),  var_cas_routineSignature,  operand_27636->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (719)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_modifierCallInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, operand_27636->mReceiverStructAttributes, var_cas_receiverType, operand_27636->mModifierName, var_cas_actualParameterListForGeneration, var_cas_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (730))) ;
  }
}
...
category_method__appendInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_appendInstructionAST * operand_29188,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29188 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_29188->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_29188->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (750)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_29188->mTargetVariableName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (759)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_29817 (operand_29188->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_29817 = NULL ;
      while (((operand_29817 = enumerator_29817.nextObject ()))) {
        macroValidPointer (operand_29817) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_targetType.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (761)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_29817->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (762)) ;
        }
      }
    }
    const GGS_bool cond_30244 = ((var_cas_targetType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (765))).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (765)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_30244.isBuiltAndTrue ()) {
      operand_29188->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (767)))).operator_concat (GGS_string ("' type, but this type does not support the '.=' operator")) COMMA_SOURCE_FILE_AT_LINE (769)) ;
    }
    ::routine_checkAssignmentTypes (inLexique,  var_cas_targetType,  var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (771)),  operand_29188->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (771)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_appendInstructionForGeneration ::constructor_new (inLexique, operand_29188->mInstructionLocation, var_cas_targetType, var_cas_targetVariableCppName, operand_29188->mStructAttributeList, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (773))) ;
  }
}
...
category_method__addInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_addInstructionAST * operand_30741,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30741 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_30741->mReceiverName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (793)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_31155 (operand_30741->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_31155 = NULL ;
      while (((operand_31155 = enumerator_31155.nextObject ()))) {
        macroValidPointer (operand_31155) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_targetType.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (795)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_31155->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (796)) ;
        }
      }
    }
    const GGS_unifiedTypeMapProxyList  var_cas_addAssignOperatorArguments = var_cas_targetType.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (799)) ;
    const GGS_bool cond_31742 = (var_cas_addAssignOperatorArguments.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_31742.isBuiltAndTrue ()) {
      operand_30741->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (802)))).operator_concat (GGS_string ("' type, but this type does not support the '+=' operator")) COMMA_SOURCE_FILE_AT_LINE (805)) ;
    }else if (cond_31742.isBuiltAndFalse ()) {
      const GGS_bool cond_32090 = (operand_30741->mExpressions.reader_length ()).operator_isNotEqual (var_cas_addAssignOperatorArguments.reader_length ()) ;
      if (cond_32090.isBuiltAndTrue ()) {
        operand_30741->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("calling the '+=' operator on an '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (807)))).operator_concat (GGS_string ("' object requires "))).operator_concat (var_cas_addAssignOperatorArguments.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (808)))).operator_concat (GGS_string (" parameter(s), while this invocation has "))).operator_concat (operand_30741->mExpressions.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (809)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (811)) ;
      }else if (cond_32090.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticExpressionListAST::cEnumerator enumerator_32193 (operand_30741->mExpressions, true) ;
          const GGS_semanticExpressionListAST::cElement * operand_32193 = NULL ;
          GGS_unifiedTypeMapProxyList::cEnumerator enumerator_32221 (var_cas_addAssignOperatorArguments, true) ;
          const GGS_unifiedTypeMapProxyList::cElement * operand_32221 = NULL ;
          while (((operand_32193 = enumerator_32193.nextObject ()))
              && ((operand_32221 = enumerator_32221.nextObject ()))) {
            macroValidPointer (operand_32193) ;
            macroValidPointer (operand_32221) ;
            GGS_semanticExpressionForGeneration  var_cas_exp ;
            { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_32193->mExpression.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_32193->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_exp COMMA_SOURCE_FILE_AT_LINE (815)) ;
              }
            }
            ::routine_checkAssignmentTypes (inLexique,  operand_32221->mType,  var_cas_exp.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (821)),  operand_32193->mEndOfExpressionLocation COMMA_SOURCE_FILE_AT_LINE (821)) ;
            var_cas_effectiveParameterList.addAssign_operation (var_cas_exp) ;
          }
        }
        var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_addAssignInstructionForGeneration ::constructor_new (inLexique, var_cas_targetVariableCppName, var_cas_targetType, operand_30741->mInstructionLocation, operand_30741->mStructAttributeList, var_cas_effectiveParameterList COMMA_SOURCE_FILE_AT_LINE (825))) ;
      }
    }
  }
}
...
category_method__incrementInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_incrementInstructionAST * operand_32967,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32967 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_32967->mReceiverName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (846)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_33390 (operand_32967->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_33390 = NULL ;
      while (((operand_33390 = enumerator_33390.nextObject ()))) {
        macroValidPointer (operand_33390) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_targetType.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (848)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_33390->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (849)) ;
        }
      }
    }
    const GGS_bool cond_33806 = ((var_cas_targetType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (852))).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (852)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_33806.isBuiltAndTrue ()) {
      operand_32967->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (854)))).operator_concat (GGS_string ("' type, but this type does not support the '++' operator")) COMMA_SOURCE_FILE_AT_LINE (856)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_incrementInstructionForGeneration ::constructor_new (inLexique, operand_32967->mInstructionLocation, var_cas_targetVariableCppName, var_cas_targetType, operand_32967->mStructAttributeList COMMA_SOURCE_FILE_AT_LINE (858))) ;
  }
}
...
category_method__decrementInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_decrementInstructionAST * operand_34176,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34176 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_34176->mReceiverName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (877)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_34599 (operand_34176->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_34599 = NULL ;
      while (((operand_34599 = enumerator_34599.nextObject ()))) {
        macroValidPointer (operand_34599) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_targetType.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (879)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_34599->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (880)) ;
        }
      }
    }
    const GGS_bool cond_35015 = ((var_cas_targetType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (883))).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (883)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_35015.isBuiltAndTrue ()) {
      operand_34176->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (885)))).operator_concat (GGS_string ("' type, but this type does not support the '--' operator")) COMMA_SOURCE_FILE_AT_LINE (887)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_decrementInstructionForGeneration ::constructor_new (inLexique, operand_34176->mInstructionLocation, var_cas_targetVariableCppName, var_cas_targetType, operand_34176->mStructAttributeList COMMA_SOURCE_FILE_AT_LINE (889))) ;
  }
}
...
category_method__messageInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_messageInstructionAST * operand_35383,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_35383 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_35383->mExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_35383->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (907)) ;
      }
    }
    const GGS_bool cond_36051 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (914))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
    if (cond_36051.isBuiltAndTrue ()) {
      operand_35383->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the expression has the '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (916)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (916)))).operator_concat (GGS_string ("' type, but the 'message' instruction requires an '@string' expression")) COMMA_SOURCE_FILE_AT_LINE (918)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_messageInstructionForGeneration ::constructor_new (inLexique, var_cas_expression, operand_35383->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (920))) ;
  }
}
...
category_method__logInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_logInstructionAST * operand_36360,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
  ...
  if (operand_36360 != NULL) {
    {
      GGS_logListAST::cEnumerator enumerator_36563 (operand_36360->mLogList, true) ;
      const GGS_logListAST::cElement * operand_36563 = NULL ;
      while (((operand_36563 = enumerator_36563.nextObject ()))) {
        macroValidPointer (operand_36563) ;
        GGS_semanticExpressionForGeneration  var_cas_expression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_36563->mLogExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_36563->mLogExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (937)) ;
          }
        }
        var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_logInstructionForGeneration ::constructor_new (inLexique, operand_36563->mLogMessage, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (944))) ;
      }
    }
  }
}
...
category_method__dropInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_dropInstructionAST * operand_37113,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37113 != NULL) {
    GGS_stringlist  var_cas_cppNameDropList = GGS_stringlist ::constructor_emptyList () ;
    {
      GGS_lstringlist::cEnumerator enumerator_37375 (operand_37113->mDropList, true) ;
      const GGS_lstringlist::cElement * operand_37375 = NULL ;
      while (((operand_37375 = enumerator_37375.nextObject ()))) {
        macroValidPointer (operand_37375) ;
        GGS_string var_cas_variableCppName ;
        GGS_unifiedTypeMapProxy  automatic_var_37478_0 ;
        var_cas_ioVariableMap.modifier_searchForDropAccess (inLexique, operand_37375->mValue, automatic_var_37478_0, var_cas_variableCppName COMMA_SOURCE_FILE_AT_LINE (962)) ;
        var_cas_cppNameDropList.addAssign_operation (var_cas_variableCppName) ;
      }
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_dropInstructionForGeneration ::constructor_new (inLexique, var_cas_cppNameDropList, GGS_string ("drop instruction") COMMA_SOURCE_FILE_AT_LINE (966))) ;
  }
}
...
category_method__ifInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_ifInstructionAST * operand_37845,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37845 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_if_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_37845->m_if_expression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_37845->m_if_expression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_if_expression COMMA_SOURCE_FILE_AT_LINE (982)) ;
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (988)) ;
    GGS_semanticInstructionListForGeneration  var_cas_then_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_37845->m_then_instructionList,  operand_37845->mEndOf_then_branch,  var_cas_ioVariableMap,  var_cas_then_instructionList COMMA_SOURCE_FILE_AT_LINE (991)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_37845->m_else_instructionList,  operand_37845->mEndOf_if_instruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1003)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_37845->mEndOf_if_instruction COMMA_SOURCE_FILE_AT_LINE (1013)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_ifInstructionForGeneration ::constructor_new (inLexique, operand_37845->mEndOf_then_branch, var_cas_if_expression, var_cas_then_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1015))) ;
  }
}
...
category_method__foreachInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_foreachInstructionAST * operand_39391,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39391 != NULL) {
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1032)) ;
    var_cas_ioVariableMap.modifier_beginBranch (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)) ;
    ...
    {
      GGS_foreachInstructionEnumeratedObjectListAST::cEnumerator enumerator_39858 (operand_39391->mEnumeratedObjectList, true) ;
      const GGS_foreachInstructionEnumeratedObjectListAST::cElement * operand_39858 = NULL ;
      while (((operand_39858 = enumerator_39858.nextObject ()))) {
        macroValidPointer (operand_39858) ;
        GGS_semanticExpressionForGeneration  var_cas_enumerationExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_39858->mEnumeratedExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_39858->mEnumeratedExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_enumerationExpression COMMA_SOURCE_FILE_AT_LINE (1039)) ;
          }
        }
        const GGS_string var_cas_enumeratorCppName = (GGS_string ("enumerator_")).operator_concat (operand_39858->mEndOfEnumerationExpression.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1046)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1046))) ;
        const GGS_enumerationDescriptorList  var_cas_enumerationDescriptorList = var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1047)).reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (1047)) ;
        const GGS_bool cond_40588 = (var_cas_enumerationDescriptorList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
        if (cond_40588.isBuiltAndTrue ()) {
          operand_39858->mEndOfEnumerationExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("an '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)))).operator_concat (GGS_string ("' object cannot be enumerated")) COMMA_SOURCE_FILE_AT_LINE (1051)) ;
        }else if (cond_40588.isBuiltAndFalse ()) {
          const GGS_bool cond_41110 = ((operand_39858->mElementList.reader_length ()).operator_isEqual (GGS_uint (0U))).operator_and ((operand_39858->mEndsWithEllipsis).operator_not ()) ;
          if (cond_41110.isBuiltAndTrue ()) {
            const GGS_enumerationDescriptorList  var_cas_currentTypedAttributeList = var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1052)).reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (1052)) ;
            {
              GGS_enumerationDescriptorList::cEnumerator enumerator_40811 (var_cas_currentTypedAttributeList, true) ;
              const GGS_enumerationDescriptorList::cElement * operand_40811 = NULL ;
              while (((operand_40811 = enumerator_40811.nextObject ()))) {
                macroValidPointer (operand_40811) ;
                var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_39858->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1055))).operator_concat (operand_40811->mEnumerationName), operand_39858->mEndOfEnumerationExpression COMMA_SOURCE_FILE_AT_LINE (1055)), operand_40811->mEnumeratedType, ((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_40811->mEnumerationName.reader_identifierRepresentation ()) COMMA_SOURCE_FILE_AT_LINE (1054)) ;
              }
            }
          }else if (cond_41110.isBuiltAndFalse ()) {
            const GGS_bool cond_41552 = ((operand_39858->mEndsWithEllipsis).operator_not ()).operator_and ((operand_39858->mElementList.reader_length ()).operator_isNotEqual (var_cas_enumerationDescriptorList.reader_length ())) ;
            if (cond_41552.isBuiltAndTrue ()) {
              operand_39858->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1062)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1062)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1063)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" for enumeration: this list provides "))).operator_concat (operand_39858->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1066))) COMMA_SOURCE_FILE_AT_LINE (1068)) ;
            }else if (cond_41552.isBuiltAndFalse ()) {
              const GGS_bool cond_41996 = (operand_39858->mEndsWithEllipsis).operator_and ((operand_39858->mElementList.reader_length ()).operator_strictSup (var_cas_enumerationDescriptorList.reader_length ())) ;
              if (cond_41996.isBuiltAndTrue ()) {
                operand_39858->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" or less for enumeration: this list provides "))).operator_concat (operand_39858->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074))) COMMA_SOURCE_FILE_AT_LINE (1076)) ;
              }else if (cond_41996.isBuiltAndFalse ()) {
                {
                  GGS_foreachInstructionEnumeratedObjectElementListAST::cEnumerator enumerator_42023 (operand_39858->mElementList, true) ;
                  const GGS_foreachInstructionEnumeratedObjectElementListAST::cElement * operand_42023 = NULL ;
                  GGS_enumerationDescriptorList::cEnumerator enumerator_42050 (var_cas_enumerationDescriptorList, true) ;
                  const GGS_enumerationDescriptorList::cElement * operand_42050 = NULL ;
                  while (((operand_42023 = enumerator_42023.nextObject ()))
                      && ((operand_42050 = enumerator_42050.nextObject ()))) {
                    macroValidPointer (operand_42023) ;
                    macroValidPointer (operand_42050) ;
                    const GGS_bool cond_42620 = (operand_42023->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1078))).operator_isNotEqual (GGS_string ("")) ;
                    if (cond_42620.isBuiltAndTrue ()) {
                      const GGS_unifiedTypeMapProxy  var_cas_foundType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42023->mTypeName COMMA_SOURCE_FILE_AT_LINE (1079)) ;
                      const GGS_bool cond_42437 = (var_cas_foundType).operator_isNotEqual (operand_42050->mEnumeratedType) ;
                      if (cond_42437.isBuiltAndTrue ()) {
                        operand_42023->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("incorrect '@")).operator_concat (var_cas_foundType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)))).operator_concat (GGS_string ("' type: '@"))).operator_concat (operand_42050->mEnumeratedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)))).operator_concat (GGS_string ("' type required here")) COMMA_SOURCE_FILE_AT_LINE (1082)) ;
                      }
                      var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, operand_42023->mConstantName, operand_42050->mEnumeratedType, ((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_42050->mEnumerationName.reader_identifierRepresentation ()) COMMA_SOURCE_FILE_AT_LINE (1083)) ;
                    }
                  }
                }
              }
        ...
        var_cas_enumerationList.addAssign_operation (operand_39858->mIsAscending, var_cas_enumerationExpression, var_cas_enumeratorCppName) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_whileExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_39391->mWhileExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_39391->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_whileExpression COMMA_SOURCE_FILE_AT_LINE (1092)) ;
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1099)) ;
    GGS_semanticInstructionListForGeneration  var_cas_before_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39391->mBeforeInstructionList,  operand_39391->mEndOf_before_branch,  var_cas_ioVariableMap,  var_cas_before_instructionList COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    ...
    const GGS_bool cond_43810 = (operand_39391->mIndexVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1115))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_43810.isBuiltAndTrue ()) {
      var_cas_indexCppName = (GGS_string ("index_")).operator_concat (operand_39391->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1116)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1116))) ;
      var_cas_indexDeclaration.addAssign_operation (var_cas_inPredefinedTypes.mUIntType, operand_39391->mIndexVariableName, GGS_bool (false), var_cas_indexCppName) ;
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_indexDeclaration,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39391->mDoInstructionList,  operand_39391->mEndOf_do_branch,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    GGS_semanticInstructionListForGeneration  var_cas_between_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39391->mBetweenInstructionList,  operand_39391->mEndOf_between_branch,  var_cas_ioVariableMap,  var_cas_between_instructionList COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    GGS_semanticInstructionListForGeneration  var_cas_after_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_39391->mAfterInstructionList,  operand_39391->mEndOf_after_branch,  var_cas_ioVariableMap,  var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1150)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_39391->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1161)) ;
    var_cas_ioVariableMap.modifier_endBranch (inLexique, operand_39391->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1163)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_39391->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1164)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_foreachInstructionForGeneration ::constructor_new (inLexique, operand_39391->mInstructionLocation, var_cas_enumerationList, var_cas_indexCppName, var_cas_whileExpression, var_cas_before_instructionList, var_cas_between_instructionList, var_cas_do_instructionList, var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1166))) ;
  }
}
...
category_method__loopInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_loopInstructionAST * operand_45550,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
  ...
  if (operand_45550 != NULL) {
    ...
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_45550->mVariantExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45550->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variantExpression COMMA_SOURCE_FILE_AT_LINE (1188)) ;
      }
    }
    const GGS_bool cond_46262 = (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1195))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
    if (cond_46262.isBuiltAndTrue ()) {
      operand_45550->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    }
    GGS_semanticExpressionForGeneration  var_cas_loopExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_45550->mLoopExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45550->mLoopExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_loopExpression COMMA_SOURCE_FILE_AT_LINE (1201)) ;
      }
    }
    const GGS_bool cond_46768 = (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1208))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
    if (cond_46768.isBuiltAndTrue ()) {
      operand_45550->mEndOfLoopExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the loop expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    }
    var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1213)) ;
    GGS_semanticInstructionListForGeneration  var_cas_first_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_45550->mFirstInstructions,  operand_45550->mEndOfFirstInstructions,  var_cas_ioVariableMap,  var_cas_first_instructionList COMMA_SOURCE_FILE_AT_LINE (1216)) ;
    GGS_semanticInstructionListForGeneration  var_cas_second_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_45550->mSecondInstructions,  operand_45550->mEndOfSecondInstructions,  var_cas_ioVariableMap,  var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1228)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_45550->mEndOfLoopInstruction COMMA_SOURCE_FILE_AT_LINE (1239)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_loopInstructionForGeneration ::constructor_new (inLexique, operand_45550->mInstructionLocation, var_cas_variantExpression, var_cas_first_instructionList, var_cas_loopExpression, var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1241))) ;
  }
}
...
category_method__structuredCastInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_structuredCastInstructionAST * operand_48047,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48047 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_castExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_48047->mCastExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48047->mCastExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_castExpression COMMA_SOURCE_FILE_AT_LINE (1260)) ;
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1267)) ;
    ...
    {
      GGS_castInstructionBranchListAST::cEnumerator enumerator_48662 (operand_48047->mCastInstructionBranchList, true) ;
      const GGS_castInstructionBranchListAST::cElement * operand_48662 = NULL ;
      while (((operand_48662 = enumerator_48662.nextObject ()))) {
        macroValidPointer (operand_48662) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_48662->mTypeName COMMA_SOURCE_FILE_AT_LINE (1272)) ;
        GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
        GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1275))) ;
        GGS_uint _variant_49107 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1276)) ;
        GGS_bool _condition_49107 (_variant_49107.isBuilt (), true) ;
        while (_condition_49107.isBuiltAndTrue ()) {
          _condition_49107 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))).operator_not ()) ;
          if (_condition_49107.isBuiltAndTrue ()) {
            if (_variant_49107.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1280)) ;
              _condition_49107 = GGS_bool (false) ;
            }else{
              _variant_49107.decrement_operation (inLexique COMMA_HERE) ;
              var_cas_t = var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1278)) ;
              var_cas_found = (var_cas_t).operator_isEqual (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1279))) ;
            }
          }
        }
        const GGS_bool cond_49303 = (var_cas_found).operator_not () ;
        if (cond_49303.isBuiltAndTrue ()) {
          operand_48662->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_48662->mTypeName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1283)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1283)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        }
        ...
        const GGS_bool cond_49734 = (operand_48662->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_49734.isBuiltAndTrue ()) {
          var_cas_localConstantName = (((GGS_string ("cast_")).operator_concat (operand_48662->mConstantVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)))).operator_concat (GGS_string ("_"))).operator_concat (operand_48662->mConstantVarName) ;
          var_cas_localConstantList.addAssign_operation (var_cas_type, operand_48662->mConstantVarName, GGS_bool (false), var_cas_localConstantName) ;
        }else if (cond_49734.isBuiltAndFalse ()) {
          var_cas_localConstantName = GGS_string ("") ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48662->mInstructionList,  operand_48662->mEndOfInstructions,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1302)) ;
        var_cas_castBranchList.addAssign_operation (operand_48662->mUseKindOfClass, var_cas_type, var_cas_localConstantName, var_cas_instructionList) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48047->mElseInstructionList,  operand_48047->mEndOfCastInstruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1316)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_48047->mEndOfCastInstruction COMMA_SOURCE_FILE_AT_LINE (1327)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_structuredCastInstructionForGeneration ::constructor_new (inLexique, var_cas_castExpression, var_cas_castBranchList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1329))) ;
  }
}
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_grammarInstructionAST * operand_51014,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51014 != NULL) {
    GGS_grammarLabelMap  var_cas_grammarLabelMap ;
    if (var_cas_inSemanticContext.mGrammarMap.isBuilt ()) {
      var_cas_inSemanticContext.mGrammarMap (HERE)->method_searchKey (inLexique, operand_51014->mGrammarComponentName, var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    }
    GGS_formalParameterSignature  var_cas_labelSignature ;
    if (var_cas_grammarLabelMap.isBuilt ()) {
      var_cas_grammarLabelMap (HERE)->method_searchKey (inLexique, operand_51014->mLabelName, var_cas_labelSignature COMMA_SOURCE_FILE_AT_LINE (1352)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_51014->mLabelName,  ((GGS_string ("label of the ")).operator_concat (operand_51014->mGrammarComponentName)).operator_concat (GGS_string (" grammar")),  var_cas_labelSignature,  operand_51014->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1358)) ;
    GGS_semanticExpressionForGeneration  var_cas_sourceExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_51014->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_51014->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_sourceExpression COMMA_SOURCE_FILE_AT_LINE (1370)) ;
      }
    }
    const GGS_bool cond_52473 = operand_51014->mSourceExpressionIsFile ;
    if (cond_52473.isBuiltAndTrue ()) {
      const GGS_bool cond_52460 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1378))).operator_isNotEqual (var_cas_inPredefinedTypes.mLStringType) ;
      if (cond_52460.isBuiltAndTrue ()) {
        operand_51014->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source file path and its type should be '@lstring', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1382)) ;
      }
    }else if (cond_52473.isBuiltAndFalse ()) {
      const GGS_bool cond_52712 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1383))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
      if (cond_52712.isBuiltAndTrue ()) {
        operand_51014->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source string and its type should be '@string', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1387)) ;
      }
    }
    const GGS_bool cond_53040 = operand_51014->mSourceExpressionIsFile ;
    if (cond_53040.isBuiltAndTrue ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceFileForGeneration ::constructor_new (inLexique, operand_51014->mInstructionLocation, operand_51014->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1392)), operand_51014->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1393)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1390))) ;
    }else if (cond_53040.isBuiltAndFalse ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceExpressionForGeneration ::constructor_new (inLexique, operand_51014->mInstructionLocation, operand_51014->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1400)), operand_51014->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1401)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1398))) ;
    }
  }
}
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readWriteAccessWithInstructionAST * operand_53484,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53484 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_53484->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_53484->mKeyExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_53484->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1425)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1425))) ;
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_receiverVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_53484->mReceiverName, var_cas_targetType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (1429)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_54251 (operand_53484->mFieldList, true) ;
      const GGS_lstringlist::cElement * operand_54251 = NULL ;
      while (((operand_54251 = enumerator_54251.nextObject ()))) {
        macroValidPointer (operand_54251) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_targetType.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1431)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_54251->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (1432)) ;
        }
      }
    }
    const GGS_withAccessorMap  var_cas_withAccessorMap = var_cas_targetType.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1435)) ;
    GGS_unifiedTypeMapProxyList  var_cas_argumentTypeList ;
    elementOf_GGS_withAccessorMap * operand_54577 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_53484->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1437))) ;
    if (NULL != operand_54577) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_54577->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_54890 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_54890.isBuiltAndTrue ()) {
        operand_53484->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1445)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_54890.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_54944 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_54944 = NULL ;
          while (((operand_54944 = enumerator_54944.nextObject ()))) {
            macroValidPointer (operand_54944) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_54944->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_54944->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1448))) ;
          }
        }
        operand_53484->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1451)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_53484->mAccessName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1456)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    ...
    const GGS_bool cond_55811 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_55811.isBuiltAndTrue ()) {
      operand_53484->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_53484->mAccessName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1461)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1463)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1464)) ;
    }else if (cond_55811.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_55847 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_55847 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_55865 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_55865 = NULL ;
        while (((operand_55847 = enumerator_55847.nextObject ()))
            && ((operand_55865 = enumerator_55865.nextObject ()))) {
          macroValidPointer (operand_55847) ;
          macroValidPointer (operand_55865) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_55865->mType,  operand_55847->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1466)),  operand_53484->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1466)) COMMA_SOURCE_FILE_AT_LINE (1466)) ;
        }
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1470)) ;
    GGS_localInitializedVariableList  var_cas_localInitializedVariableList = GGS_localInitializedVariableList ::constructor_emptyList () ;
    {
      ...
      GGS_typedAttributeList::cEnumerator enumerator_56161 (var_cas_targetType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1473)), true) ;
      const GGS_typedAttributeList::cElement * operand_56161 = NULL ;
      while (((operand_56161 = enumerator_56161.nextObject ()))) {
        macroValidPointer (operand_56161) ;
        var_cas_localInitializedVariableList.addAssign_operation (operand_56161->mAttributeTypeIndex, GGS_lstring ::constructor_new (inLexique, (operand_53484->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476))).operator_concat (operand_56161->mAttributeName), operand_53484->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)) COMMA_SOURCE_FILE_AT_LINE (1476)), ((((((((GGS_string ("* ((GALGASap_")).operator_concat (operand_56161->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1477)))).operator_concat (GGS_string (" *) "))).operator_concat (var_cas_objectArrayCppName)).operator_concat (GGS_string ("->pointerAtIndex ("))).operator_concat (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1477)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1477)))).operator_concat (GGS_string (" /* "))).operator_concat (operand_56161->mAttributeName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string (" */ COMMA_HERE))"))) ;
        var_cas_IDX.mValue ++ ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  var_cas_localInitializedVariableList,  operand_53484->m_do_Instructions,  operand_53484->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1481)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_53484->m_else_Instructions,  operand_53484->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1493)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_53484->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1503)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, var_cas_targetType, operand_53484->mFieldList, operand_53484->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1505))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_57769,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57769 != NULL) {
    operand_57769->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @readAccessWithInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1528)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_58227,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58227 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_58227->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58227->mSwitchExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1540)) ;
      }
    }
    const GGS_bool cond_58972 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1547))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1547))) ;
    if (cond_58972.isBuiltAndTrue ()) {
      operand_58227->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1550)) ;
    }
    const GGS_stringset  var_cas_enumConstantStringSet = var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1552)).reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1552)) ;
    GGS_stringset  var_cas_constantsNamedInSwitchInstruction = GGS_stringset ::constructor_emptySet () ;
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)) ;
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_59321 (operand_58227->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_59321 = NULL ;
      while (((operand_59321 = enumerator_59321.nextObject ()))) {
        macroValidPointer (operand_59321) ;
        {
          GGS_lstringlist::cEnumerator enumerator_59356 (operand_59321->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_59356 = NULL ;
          while (((operand_59356 = enumerator_59356.nextObject ()))) {
            macroValidPointer (operand_59356) ;
            const GGS_bool cond_59711 = var_cas_enumConstantStringSet.reader_hasKey (operand_59356->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1559))) ;
            if (cond_59711.isBuiltAndTrue ()) {
              const GGS_bool cond_59631 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_59356->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1560))) ;
              if (cond_59631.isBuiltAndTrue ()) {
                operand_59356->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_59356->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1564)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_59356->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565))) ;
            }else if (cond_59711.isBuiltAndFalse ()) {
              operand_59356->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_59356->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1570)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_59321->mInstructions,  operand_59321->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1573)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_59321->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_58227->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1585)) ;
    const GGS_stringset  var_cas_forgottenConstants = var_cas_enumConstantStringSet.substract_operation (inLexique, var_cas_constantsNamedInSwitchInstruction COMMA_SOURCE_FILE_AT_LINE (1587)) ;
    const GGS_bool cond_60789 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_60789.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_60595 (var_cas_forgottenConstants, true) ;
        while (enumerator_60595.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_60595._key (HERE)) ;
          enumerator_60595.next () ;
        }
      }
      operand_58227->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1596)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_switchInstructionForGeneration ::constructor_new (inLexique, var_cas_switchExpression, var_cas_switchBranchesForGeneration COMMA_SOURCE_FILE_AT_LINE (1598))) ;
  }
}
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_61112,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61112 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_61397 (operand_61112->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_61397 = NULL ;
      while (((operand_61397 = enumerator_61397.nextObject ()))) {
        macroValidPointer (operand_61397) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_61397->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_61397->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1616)) ;
          }
        }
        var_cas_expressionList.addAssign_operation (var_cas_matchedExpression) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = var_cas_matchedExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1624)) ;
        const GGS_bool cond_62094 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1625))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1625))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))) ;
        if (cond_62094.isBuiltAndTrue ()) {
          operand_61397->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1627)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1629)) ;
        }
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1632)) ;
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_62309 (operand_61112->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_62309 = NULL ;
      while (((operand_62309 = enumerator_62309.nextObject ()))) {
        macroValidPointer (operand_62309) ;
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        GGS_matchListForGeneration  var_cas_matchListForGeneration = GGS_matchListForGeneration ::constructor_emptyList () ;
        const GGS_bool cond_64817 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_62309->mMatchEntryList.reader_length ()) ;
        if (cond_64817.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_62543 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_62543 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_62560 (operand_62309->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_62560 = NULL ;
            while (((operand_62543 = enumerator_62543.nextObject ()))
                && ((operand_62560 = enumerator_62560.nextObject ()))) {
              macroValidPointer (operand_62543) ;
              macroValidPointer (operand_62560) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_62543->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)) ;
              const GGS_bool cond_63924 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1641))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1641))) ;
              if (cond_63924.isBuiltAndTrue ()) {
                const GGS_bool cond_63605 = operand_62560->mIsType ;
                if (cond_63605.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_62560->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1643)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_63151 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1646)) ;
                  GGS_bool _condition_63151 (_variant_63151.isBuilt (), true) ;
                  while (_condition_63151.isBuiltAndTrue ()) {
                    _condition_63151 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1647))).operator_not ()) ;
                    if (_condition_63151.isBuiltAndTrue ()) {
                      if (_variant_63151.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1650)) ;
                        _condition_63151 = GGS_bool (false) ;
                      }else{
                        _variant_63151.decrement_operation (inLexique COMMA_HERE) ;
                        var_cas_t = var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1648)) ;
                        var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                      }
                    }
                  }
                  const GGS_bool cond_63421 = (var_cas_found).operator_not () ;
                  if (cond_63421.isBuiltAndTrue ()) {
                    operand_62560->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_62560->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1653)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1655)) ;
                  }else if (cond_63421.isBuiltAndFalse ()) {
                    const GGS_bool cond_63585 = (operand_62560->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_63585.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_62560->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_63605.isBuiltAndFalse ()) {
                  operand_62560->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_62543->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1662)) ;
                }
                var_cas_matchListForGeneration.addAssign_operation (GGS_bool (true), operand_62560->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), operand_62560->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663))) ;
              }else if (cond_63924.isBuiltAndFalse ()) {
                const GGS_bool cond_64700 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))) ;
                if (cond_64700.isBuiltAndTrue ()) {
                  const GGS_bool cond_64201 = operand_62560->mIsType ;
                  if (cond_64201.isBuiltAndTrue ()) {
                    operand_62560->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_62543->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1669)) ;
                  }else if (cond_64201.isBuiltAndFalse ()) {
                    const GGS_bool cond_64519 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)).reader_hasKey (operand_62560->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)))).operator_not () ;
                    if (cond_64519.isBuiltAndTrue ()) {
                      operand_62560->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_62560->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_62543->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1673)) ;
                    }
                  }
                  var_cas_matchListForGeneration.addAssign_operation (GGS_bool (false), operand_62560->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_62543->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1677)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1677))) ;
                }else if (cond_64700.isBuiltAndFalse ()) {
                  operand_62560->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (1681)) ;
                }
              }
            }
          }
        }else if (cond_64817.isBuiltAndFalse ()) {
          operand_62309->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1685)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_62309->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1686))) COMMA_SOURCE_FILE_AT_LINE (1688)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_62309->mMatchBranchInstructionList,  operand_62309->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1691)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_61112->mElseInstructionList,  operand_61112->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1706)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_61112->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1717)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_matchInstructionForGeneration ::constructor_new (inLexique, var_cas_expressionList, var_cas_matchInstructionBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1719))) ;
  }
}
