...
category_method__foreachInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
  ...
  if (operand_44014 != NULL) {
    ...
    {
      GGS_foreachInstructionEnumeratedObjectListAST::cEnumerator enumerator_44430 (operand_44014->mEnumeratedObjectList, true) ;
      const GGS_foreachInstructionEnumeratedObjectListAST::cElement * operand_44430 = NULL ;
      while (((operand_44430 = enumerator_44430.nextObject ()))) {
        macroValidPointer (operand_44430) ;
        GGS_semanticExpressionForGeneration  var_cas_enumerationExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_44430->mEnumeratedExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_44430->mEnumeratedExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_enumerationExpression, var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1124)) ;
          }
        }
        const GGS_string var_cas_enumeratorCppName = (GGS_string ("enumerator_")).operator_concat (operand_44430->mEndOfEnumerationExpression.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1132))) ;
        const GGS_enumerationDescriptorList  var_cas_enumerationDescriptorList = var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1133)).reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (1133)) ;
        const GGS_bool cond_45191 = (var_cas_enumerationDescriptorList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
        if (cond_45191.isBuiltAndTrue ()) {
          operand_44430->mEndOfEnumerationExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("an '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)))).operator_concat (GGS_string ("' object cannot be enumerated")) COMMA_SOURCE_FILE_AT_LINE (1137)) ;
        }else if (cond_45191.isBuiltAndFalse ()) {
          const GGS_bool cond_45313 = ((operand_44430->mElementList.reader_length ()).operator_isEqual (GGS_uint (0U))).operator_and ((operand_44430->mEndsWithEllipsis).operator_not ()) ;
          if (cond_45313.isBuiltAndTrue ()) {
            operand_44430->mEndOfEnumerationExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("TO DO !") COMMA_SOURCE_FILE_AT_LINE (1139)) ;
          }else if (cond_45313.isBuiltAndFalse ()) {
            const GGS_bool cond_45755 = ((operand_44430->mEndsWithEllipsis).operator_not ()).operator_and ((operand_44430->mElementList.reader_length ()).operator_isNotEqual (var_cas_enumerationDescriptorList.reader_length ())) ;
            if (cond_45755.isBuiltAndTrue ()) {
              operand_44430->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1142)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" for enumeration: this list provides "))).operator_concat (operand_44430->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1145))) COMMA_SOURCE_FILE_AT_LINE (1147)) ;
            }else if (cond_45755.isBuiltAndFalse ()) {
              const GGS_bool cond_46199 = (operand_44430->mEndsWithEllipsis).operator_and ((operand_44430->mElementList.reader_length ()).operator_strictSup (var_cas_enumerationDescriptorList.reader_length ())) ;
              if (cond_46199.isBuiltAndTrue ()) {
                operand_44430->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1149)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1149)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" or less for enumeration: this list provides "))).operator_concat (operand_44430->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1153))) COMMA_SOURCE_FILE_AT_LINE (1155)) ;
              }else if (cond_46199.isBuiltAndFalse ()) {
                {
                  GGS_foreachInstructionEnumeratedObjectElementListAST::cEnumerator enumerator_46226 (operand_44430->mElementList, true) ;
                  const GGS_foreachInstructionEnumeratedObjectElementListAST::cElement * operand_46226 = NULL ;
                  GGS_enumerationDescriptorList::cEnumerator enumerator_46253 (var_cas_enumerationDescriptorList, true) ;
                  const GGS_enumerationDescriptorList::cElement * operand_46253 = NULL ;
                  while (((operand_46226 = enumerator_46226.nextObject ()))
                      && ((operand_46253 = enumerator_46253.nextObject ()))) {
                    macroValidPointer (operand_46226) ;
                    macroValidPointer (operand_46253) ;
                    const GGS_bool cond_46830 = (operand_46226->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1157))).operator_isNotEqual (GGS_string ("")) ;
                    if (cond_46830.isBuiltAndTrue ()) {
                      const GGS_unifiedTypeMapProxy  var_cas_foundType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_46226->mTypeName COMMA_SOURCE_FILE_AT_LINE (1158)) ;
                      const GGS_bool cond_46640 = (var_cas_foundType).operator_isNotEqual (operand_46253->mEnumeratedType) ;
                      if (cond_46640.isBuiltAndTrue ()) {
                        operand_46226->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("incorrect '@")).operator_concat (var_cas_foundType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1160)))).operator_concat (GGS_string ("' type: '@"))).operator_concat (operand_46253->mEnumeratedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1160)))).operator_concat (GGS_string ("' type required here")) COMMA_SOURCE_FILE_AT_LINE (1161)) ;
                      }
                      var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, operand_46226->mConstantName, operand_46253->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_46253->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1162)) ;
                    }
                  }
                }
              }
        ...
        var_cas_enumerationList.addAssign_operation (operand_44430->mIsAscending, var_cas_enumerationExpression, var_cas_enumeratorCppName) ;
      }
    }
    ...
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_44014->mWhileExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_44014->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_whileExpression, var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1171)) ;
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)) ;
    ...
    const GGS_bool cond_48031 = (operand_44014->mIndexVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1195))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_48031.isBuiltAndTrue ()) {
      var_cas_indexCppName = (GGS_string ("index_")).operator_concat (operand_44014->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1196))) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_indexDeclaration,  operand_44014->mDoInstructionList,  operand_44014->mEndOf_do_branch,  var_cas_ioVariableMap,  var_cas_do_instructionList,  var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    ...
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_44014->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1241)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_foreachInstructionForGeneration ::constructor_new (inLexique, var_cas_enumerationList, var_cas_indexCppName, var_cas_whileExpression, var_cas_before_instructionList, var_cas_between_instructionList, var_cas_do_instructionList, var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1243))) ;
  }
}
...
category_method__loopInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_loopInstructionAST * operand_49521,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                ...
                                GGS_bool & var_cas_ioUsesCompilerArgument
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49521 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_variantExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_49521->mVariantExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_49521->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variantExpression, var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1266)) ;
      }
    }
    const GGS_bool cond_50345 = (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1274))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
    if (cond_50345.isBuiltAndTrue ()) {
      operand_49521->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1276)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1276)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1276)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1277)) ;
    }
    GGS_semanticExpressionForGeneration  var_cas_loopExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_49521->mLoopExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_49521->mLoopExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_loopExpression, var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1280)) ;
      }
    }
    const GGS_bool cond_50880 = (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1288))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
    if (cond_50880.isBuiltAndTrue ()) {
      operand_49521->mEndOfLoopExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the loop expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1291)) ;
    }
    var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1293)) ;
    GGS_semanticInstructionListForGeneration  var_cas_first_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  operand_49521->mFirstInstructions,  operand_49521->mEndOfFirstInstructions,  var_cas_ioVariableMap,  var_cas_first_instructionList,  var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1296)) ;
    GGS_semanticInstructionListForGeneration  var_cas_second_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  operand_49521->mSecondInstructions,  operand_49521->mEndOfSecondInstructions,  var_cas_ioVariableMap,  var_cas_second_instructionList,  var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1308)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_49521->mEndOfLoopInstruction COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_loopInstructionForGeneration ::constructor_new (inLexique, var_cas_variantExpression, var_cas_first_instructionList, var_cas_loopExpression, var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1321))) ;
  }
}
...
category_method__structuredCastInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_structuredCastInstructionAST * operand_52097,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                ...
                                GGS_bool & var_cas_ioUsesCompilerArgument
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52097 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_castExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_52097->mCastExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_52097->mCastExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_castExpression, var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1341)) ;
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1349)) ;
    ...
    {
      GGS_castInstructionBranchListAST::cEnumerator enumerator_52824 (operand_52097->mCastInstructionBranchList, true) ;
      const GGS_castInstructionBranchListAST::cElement * operand_52824 = NULL ;
      while (((operand_52824 = enumerator_52824.nextObject ()))) {
        macroValidPointer (operand_52824) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_52824->mTypeName COMMA_SOURCE_FILE_AT_LINE (1354)) ;
        GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
        GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1357))) ;
        GGS_uint _variant_53293 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1358)) ;
        GGS_bool _condition_53293 (_variant_53293.isBuilt (), true) ;
        while (_condition_53293.isBuiltAndTrue ()) {
          _condition_53293 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1359))).operator_not ()) ;
          if (_condition_53293.isBuiltAndTrue ()) {
            if (_variant_53293.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1362)) ;
              _condition_53293 = GGS_bool (false) ;
            }else{
              _variant_53293.decrement_operation (inLexique COMMA_HERE) ;
              var_cas_t = var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)) ;
              var_cas_found = (var_cas_t).operator_isEqual (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1361))) ;
            }
          }
        }
        const GGS_bool cond_53489 = (var_cas_found).operator_not () ;
        if (cond_53489.isBuiltAndTrue ()) {
          operand_52824->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_52824->mTypeName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1365)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1365)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1367)) ;
        }
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        const GGS_bool cond_53840 = (operand_52824->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_53840.isBuiltAndTrue ()) {
          var_cas_localConstantList.addAssign_operation (var_cas_type, operand_52824->mConstantVarName, GGS_bool (false), (((GGS_string ("cast_")).operator_concat (operand_52824->mConstantVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)))).operator_concat (GGS_string ("_"))).operator_concat (operand_52824->mConstantVarName)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  operand_52824->mInstructionList,  operand_52824->mEndOfInstructions,  var_cas_ioVariableMap,  var_cas_instructionList,  var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1380)) ;
        var_cas_castBranchList.addAssign_operation (operand_52824->mUseKindOfClass, var_cas_type, var_cas_instructionList) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  operand_52097->mElseInstructionList,  operand_52097->mEndOfCastInstruction,  var_cas_ioVariableMap,  var_cas_else_instructionList,  var_cas_ioUsesCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1394)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_52097->mEndOfCastInstruction COMMA_SOURCE_FILE_AT_LINE (1405)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_structuredCastInstructionForGeneration ::constructor_new (inLexique, var_cas_castExpression, var_cas_castBranchList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1407))) ;
  }
}
...
category_method__withInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_withInstructionAST * operand_55008,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
  ...
  if (operand_55008 != NULL) {
    operand_55008->mTargetObjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @withInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1427)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_55546,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                ...
                                GGS_bool & /* var_cas_ioUsesCompilerArgument */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55546 != NULL) {
    operand_55546->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @switchInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1442)) ;
  }
}
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_56088,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                ...
                                GGS_bool & /* var_cas_ioUsesCompilerArgument */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56088 != NULL) {
    operand_56088->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @matchInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1457)) ;
  }
}
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_grammarInstructionAST * operand_56631,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                ...
                                GGS_bool & /* var_cas_ioUsesCompilerArgument */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56631 != NULL) {
    operand_56631->mGrammarComponentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction: @grammarInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1472)) ;
  }
}
