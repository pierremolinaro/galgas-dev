...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_74050_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_74050_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1925)) ;
  GALGAS_formalParameterSignature var_labelSignature ;
  var_grammarLabelMap.method_searchKey (object->mAttribute_mLabelName, var_labelSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (1932)) ;
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  {
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mLabelName, GALGAS_string ("label of the ").operator_concat (object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (1941)) COMMA_SOURCE_FILE_AT_LINE (1941)).operator_concat (GALGAS_string (" grammar") COMMA_SOURCE_FILE_AT_LINE (1941)), var_labelSignature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_actualParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1938)) ;
  }
  GALGAS_semanticExpressionForGeneration var_sourceExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mSourceExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_sourceExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1949)) ;
  const enumGalgasBool test_0 = object->mAttribute_mSourceExpressionIsFile.boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1956)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLStringType)).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mEndOfSourceExpression, GALGAS_string ("this expression is the source file path and its type should be '@lstring', but it is '@").operator_concat (var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1958)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1958)) COMMA_SOURCE_FILE_AT_LINE (1958)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1958)) COMMA_SOURCE_FILE_AT_LINE (1957)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1961)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (object->mAttribute_mEndOfSourceExpression, GALGAS_string ("this expression is the source string and its type should be '@string', but it is '@").operator_concat (var_sourceExpression.reader_mType (SOURCE_FILE_AT_LINE (1963)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1963)) COMMA_SOURCE_FILE_AT_LINE (1963)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1963)) COMMA_SOURCE_FILE_AT_LINE (1962)) ;
    }
  }
  const enumGalgasBool test_3 = object->mAttribute_mSourceExpressionIsFile.boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_grammarInstructionWithSourceFileForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (1970)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (1971)), var_sourceExpression, var_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1968)) COMMA_SOURCE_FILE_AT_LINE (1968)) ;
  }else if (kBoolFalse == test_3) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_grammarInstructionWithSourceExpressionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (1978)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (1979)), var_sourceExpression, var_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1976)) COMMA_SOURCE_FILE_AT_LINE (1976)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mKeyExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_keyExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1995)) ;
  GALGAS_string var_objectArrayCppName = GALGAS_string ("objectArray_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (2001)).reader_string (SOURCE_FILE_AT_LINE (2001)) COMMA_SOURCE_FILE_AT_LINE (2001)) ;
  GALGAS_unifiedTypeMapProxy var_targetType ;
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_76838_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_76838_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2005)) ;
  }
  cEnumerator_lstringlist enumerator_76863 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_76863.hasCurrentObject ()) {
    GALGAS_attributeMap var_attributeMap = var_targetType.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2007)) ;
    var_attributeMap.method_searchKey (enumerator_76863.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE_AT_LINE (2008)) ;
    enumerator_76863.gotoNextObject () ;
  }
  GALGAS_withAccessorMap var_withAccessorMap = var_targetType.reader_mWithAccessorMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2011)) ;
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_77142 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (2013))) ;
  if (NULL != objectArray_77142) {
      macroValidSharedObject (objectArray_77142, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_77142->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2014)) ;
  }else{
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_withAccessorMap.reader_count (SOURCE_FILE_AT_LINE (2016)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mAccessName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_targetType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2018)) COMMA_SOURCE_FILE_AT_LINE (2018)).operator_concat (GALGAS_string ("' type cannot be used in a 'with' instruction") COMMA_SOURCE_FILE_AT_LINE (2018)) COMMA_SOURCE_FILE_AT_LINE (2017)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_77525 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_77525.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_77525.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2024)) COMMA_SOURCE_FILE_AT_LINE (2024)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2024)).operator_concat (enumerator_77525.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2024)) COMMA_SOURCE_FILE_AT_LINE (2024)) COMMA_SOURCE_FILE_AT_LINE (2024)) ;
        enumerator_77525.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
      GALGAS_string temp_2 ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_withAccessorMap.reader_count (SOURCE_FILE_AT_LINE (2028)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_3) {
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_targetType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2027)) COMMA_SOURCE_FILE_AT_LINE (2027)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (2027)).operator_concat (object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (2027)) COMMA_SOURCE_FILE_AT_LINE (2027)).operator_concat (GALGAS_string ("' accessor for the 'with' instruction; available ") COMMA_SOURCE_FILE_AT_LINE (2027)).operator_concat (temp_2 COMMA_SOURCE_FILE_AT_LINE (2027)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (2028)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (2029)) COMMA_SOURCE_FILE_AT_LINE (2026)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }
  }
  ...
  if (kBoolTrue == test_5) {
    ...
    inCompiler->emitSemanticError (location_6, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (2037)) COMMA_SOURCE_FILE_AT_LINE (2037)).operator_concat (GALGAS_string ("' accessor of '@") COMMA_SOURCE_FILE_AT_LINE (2037)).operator_concat (var_targetType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2037)) COMMA_SOURCE_FILE_AT_LINE (2037)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (2037)).operator_concat (var_argumentTypeList.reader_length (SOURCE_FILE_AT_LINE (2038)).reader_string (SOURCE_FILE_AT_LINE (2038)) COMMA_SOURCE_FILE_AT_LINE (2037)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (2038)).operator_concat (var_effectiveExpressionList.reader_length (SOURCE_FILE_AT_LINE (2039)).reader_string (SOURCE_FILE_AT_LINE (2039)) COMMA_SOURCE_FILE_AT_LINE (2038)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (2039)) COMMA_SOURCE_FILE_AT_LINE (2037)) ;
  }else if (kBoolFalse == test_5) {
    cEnumerator_semanticExpressionListForGeneration enumerator_78431 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_78449 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_78431.hasCurrentObject () && enumerator_78449.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_78449.current_mType (HERE), enumerator_78431.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2042)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (2042)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2042)) ;
      }
      enumerator_78431.gotoNextObject () ;
      enumerator_78449.gotoNextObject () ;
    }
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (2046)) ;
  }
  GALGAS_localInitializedVariableList var_localInitializedVariableList = GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2048)) ;
  cEnumerator_typedAttributeList enumerator_78782 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2049)), kEnumeration_up) ;
  while (enumerator_78782.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_78782.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2052)).operator_concat (enumerator_78782.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2052)) COMMA_SOURCE_FILE_AT_LINE (2052)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (2052)) COMMA_SOURCE_FILE_AT_LINE (2052)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2053)).operator_concat (enumerator_78782.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2053)) COMMA_SOURCE_FILE_AT_LINE (2053)) COMMA_SOURCE_FILE_AT_LINE (2050)) ;
    enumerator_78782.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2059)), var_localInitializedVariableList, object->mAttribute_m_5F_do_5F_Instructions, object->mAttribute_mEndOf_5F_do_5F_instructions, ioArgument_ioVariableMap, var_do_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2057)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2070)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2071)), object->mAttribute_m_5F_else_5F_Instructions, object->mAttribute_mEndOf_5F_else_5F_instructions, ioArgument_ioVariableMap, var_else_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2068)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_else_5F_instructions, inCompiler COMMA_SOURCE_FILE_AT_LINE (2077)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readWriteWithInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_receiverVariableCppName, var_targetType, object->mAttribute_mFieldList, object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (2084)), var_objectArrayCppName, var_keyExpression, var_do_5F_instructionList, var_else_5F_instructionList COMMA_SOURCE_FILE_AT_LINE (2079)) COMMA_SOURCE_FILE_AT_LINE (2079)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_receiverExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_receiverExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (2101)) ;
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mType (SOURCE_FILE_AT_LINE (2106)) ;
  GALGAS_semanticExpressionForGeneration var_keyExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mKeyExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_keyExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (2109)) ;
  GALGAS_string var_objectArrayCppName = GALGAS_string ("objectArray_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (2115)).reader_string (SOURCE_FILE_AT_LINE (2115)) COMMA_SOURCE_FILE_AT_LINE (2115)) ;
  GALGAS_withAccessorMap var_withAccessorMap = var_receiverType.reader_mWithAccessorMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2117)) ;
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_81074 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2119))) ;
  if (NULL != objectArray_81074) {
      macroValidSharedObject (objectArray_81074, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_81074->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2120)) ;
  }else{
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_withAccessorMap.reader_count (SOURCE_FILE_AT_LINE (2122)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mSearchMethodName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2124)) COMMA_SOURCE_FILE_AT_LINE (2124)).operator_concat (GALGAS_string ("' type cannot be used in a 'with' instruction") COMMA_SOURCE_FILE_AT_LINE (2124)) COMMA_SOURCE_FILE_AT_LINE (2123)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_81471 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_81471.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_81471.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2130)) COMMA_SOURCE_FILE_AT_LINE (2130)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2130)).operator_concat (enumerator_81471.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2130)) COMMA_SOURCE_FILE_AT_LINE (2130)) COMMA_SOURCE_FILE_AT_LINE (2130)) ;
        enumerator_81471.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
      GALGAS_string temp_2 ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_withAccessorMap.reader_count (SOURCE_FILE_AT_LINE (2134)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        temp_2 = GALGAS_string ("accessors are") ;
      }else if (kBoolFalse == test_3) {
        temp_2 = GALGAS_string ("accessor is") ;
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2133)) COMMA_SOURCE_FILE_AT_LINE (2133)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (2133)).operator_concat (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2133)) COMMA_SOURCE_FILE_AT_LINE (2133)).operator_concat (GALGAS_string ("' accessor for the 'with' instruction; available ") COMMA_SOURCE_FILE_AT_LINE (2133)).operator_concat (temp_2 COMMA_SOURCE_FILE_AT_LINE (2133)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (2134)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (2135)) COMMA_SOURCE_FILE_AT_LINE (2132)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }
  }
  GALGAS_semanticExpressionListForGeneration var_effectiveExpressionList = GALGAS_semanticExpressionListForGeneration::constructor_listWithValue (var_keyExpression COMMA_SOURCE_FILE_AT_LINE (2141)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_effectiveExpressionList.reader_length (SOURCE_FILE_AT_LINE (2142)).objectCompare (var_argumentTypeList.reader_length (SOURCE_FILE_AT_LINE (2142)))).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_location location_6 (object->mAttribute_mSearchMethodName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2143)) COMMA_SOURCE_FILE_AT_LINE (2143)).operator_concat (GALGAS_string ("' accessor of '@") COMMA_SOURCE_FILE_AT_LINE (2143)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2143)) COMMA_SOURCE_FILE_AT_LINE (2143)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (2143)).operator_concat (var_argumentTypeList.reader_length (SOURCE_FILE_AT_LINE (2144)).reader_string (SOURCE_FILE_AT_LINE (2144)) COMMA_SOURCE_FILE_AT_LINE (2143)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (2144)).operator_concat (var_effectiveExpressionList.reader_length (SOURCE_FILE_AT_LINE (2145)).reader_string (SOURCE_FILE_AT_LINE (2145)) COMMA_SOURCE_FILE_AT_LINE (2144)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (2145)) COMMA_SOURCE_FILE_AT_LINE (2143)) ;
  }else if (kBoolFalse == test_5) {
    cEnumerator_semanticExpressionListForGeneration enumerator_82405 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_82423 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_82405.hasCurrentObject () && enumerator_82423.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_82423.current_mType (HERE), enumerator_82405.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2148)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2148)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2148)) ;
      }
      enumerator_82405.gotoNextObject () ;
      enumerator_82423.gotoNextObject () ;
    }
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (2152)) ;
  }
  GALGAS_localConstantList var_localConstantList = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2154)) ;
  cEnumerator_typedAttributeList enumerator_82742 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2155)), kEnumeration_up) ;
  while (enumerator_82742.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_82742.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2158)).operator_concat (enumerator_82742.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2158)) COMMA_SOURCE_FILE_AT_LINE (2158)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2158)) COMMA_SOURCE_FILE_AT_LINE (2158)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2160)).operator_concat (enumerator_82742.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2160)) COMMA_SOURCE_FILE_AT_LINE (2160)) COMMA_SOURCE_FILE_AT_LINE (2156)) ;
    enumerator_82742.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2167)), object->mAttribute_mDoBranchInstructions, object->mAttribute_mEndOf_5F_do_5F_instructions, ioArgument_ioVariableMap, var_do_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2164)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2177)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2178)), object->mAttribute_mElseBranchInstructions, object->mAttribute_mEndOf_5F_else_5F_instructions, ioArgument_ioVariableMap, var_else_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2175)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_else_5F_instructions, inCompiler COMMA_SOURCE_FILE_AT_LINE (2184)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readOnlyWithInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_receiverExpression, object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2189)), var_objectArrayCppName, var_keyExpression, var_do_5F_instructionList, var_else_5F_instructionList COMMA_SOURCE_FILE_AT_LINE (2186)) COMMA_SOURCE_FILE_AT_LINE (2186)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mSwitchExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_switchExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (2206)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2212)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2212)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (2212)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfSwitchExpression, GALGAS_string ("the switch expression type should be an instance of an enumeration type (the '@").operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2214)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2214)) COMMA_SOURCE_FILE_AT_LINE (2214)).operator_concat (GALGAS_string ("' type is not an enumeration type)") COMMA_SOURCE_FILE_AT_LINE (2214)) COMMA_SOURCE_FILE_AT_LINE (2213)) ;
  }
  GALGAS_stringset var_enumConstantStringSet = var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2217)).reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE_AT_LINE (2217)) ;
  GALGAS_stringset var_constantsNamedInSwitchInstruction = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2218)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (2220)) ;
  }
  GALGAS_switchBranchesForGeneration var_switchBranchesForGeneration = GALGAS_switchBranchesForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (2221)) ;
  cEnumerator_switchBranchesAST enumerator_85175 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_85175.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_85210 (enumerator_85175.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_85210.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_85210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2224)) COMMA_SOURCE_FILE_AT_LINE (2224)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_85210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2225)) COMMA_SOURCE_FILE_AT_LINE (2225)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_85210.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_85210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2227)) COMMA_SOURCE_FILE_AT_LINE (2227)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction") COMMA_SOURCE_FILE_AT_LINE (2227)) COMMA_SOURCE_FILE_AT_LINE (2226)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_85210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2230)) COMMA_SOURCE_FILE_AT_LINE (2230)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_85210.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_85210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2233)).operator_concat (GALGAS_string ("' is not a constant of '@") COMMA_SOURCE_FILE_AT_LINE (2233)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2233)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2233)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2232)) ;
      }
      enumerator_85210.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2240)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2241)), enumerator_85175.current_mInstructions (HERE), enumerator_85175.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2238)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_85175.current_mSwitchConstantList (HERE), var_instructionList COMMA_SOURCE_FILE_AT_LINE (2247)) ;
    enumerator_85175.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_switch_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (2249)) ;
  }
  GALGAS_stringset var_forgottenConstants = var_enumConstantStringSet.substract_operation (var_constantsNamedInSwitchInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (2251)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_forgottenConstants.reader_count (SOURCE_FILE_AT_LINE (2252)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_86415 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_86415.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_86415.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (2255)) COMMA_SOURCE_FILE_AT_LINE (2255)) ;
      enumerator_86415.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (object->mAttribute_mEndOf_5F_switch_5F_instruction, GALGAS_string ("the switch instruction should name all enumeration constants; missing constants are:").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (2258)) COMMA_SOURCE_FILE_AT_LINE (2257)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_switchInstructionForGeneration::constructor_new (var_switchExpression, var_switchBranchesForGeneration COMMA_SOURCE_FILE_AT_LINE (2262)) COMMA_SOURCE_FILE_AT_LINE (2262)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionListForGeneration var_expressionList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (2275)) ;
  cEnumerator_semanticExpressionListAST enumerator_87178 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_87178.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_87178.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (2279)) ;
    var_expressionList.addAssign_operation (var_matchedExpression COMMA_SOURCE_FILE_AT_LINE (2284)) ;
    GALGAS_unifiedTypeMapProxy var_type = var_matchedExpression.reader_mType (SOURCE_FILE_AT_LINE (2286)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2287)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2287)))).operator_and (GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2287)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (2287)))) COMMA_SOURCE_FILE_AT_LINE (2287)).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_87178.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2289)) COMMA_SOURCE_FILE_AT_LINE (2289)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class") COMMA_SOURCE_FILE_AT_LINE (2289)) COMMA_SOURCE_FILE_AT_LINE (2288)) ;
    }
    enumerator_87178.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (2294)) ;
  }
  GALGAS_matchInstructionBranchListForGeneration var_matchInstructionBranchList = GALGAS_matchInstructionBranchListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (2295)) ;
  cEnumerator_matchInstructionBranchListAST enumerator_88043 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_88043.hasCurrentObject ()) {
    GALGAS_localConstantList var_localConstantList = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2298)) ;
    GALGAS_matchListForGeneration var_matchListForGeneration = GALGAS_matchListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (2299)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE_AT_LINE (2300)).objectCompare (enumerator_88043.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE_AT_LINE (2300)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_88277 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_88294 (enumerator_88043.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_88277.hasCurrentObject () && enumerator_88294.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_88277.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2302)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2303)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2303)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_88294.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2305)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_namedType)) ;
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2308)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2308)).isValid ()) {
              uint32_t variant_88688 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2308)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2308)).uintValue () ;
              bool loop_88688 = true ;
              while (loop_88688) {
                loop_88688 = var_found.operator_not (SOURCE_FILE_AT_LINE (2309)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2309)).reader_isNull (SOURCE_FILE_AT_LINE (2309)).operator_not (SOURCE_FILE_AT_LINE (2309)) COMMA_SOURCE_FILE_AT_LINE (2309)).isValid () ;
                if (loop_88688) {
                  loop_88688 = var_found.operator_not (SOURCE_FILE_AT_LINE (2309)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2309)).reader_isNull (SOURCE_FILE_AT_LINE (2309)).operator_not (SOURCE_FILE_AT_LINE (2309)) COMMA_SOURCE_FILE_AT_LINE (2309)).boolValue () ;
                }
                if (loop_88688 && (0 == variant_88688)) {
                  loop_88688 = false ;
                  inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2308)) ;
                }
                if (loop_88688) {
                  variant_88688 -- ;
                  var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2310)) ;
                  var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_namedType)) ;
                }
              }
            }
            const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (2313)).boolEnum () ;
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2315)) COMMA_SOURCE_FILE_AT_LINE (2315)).operator_concat (GALGAS_string ("' is not a descendant of the '@") COMMA_SOURCE_FILE_AT_LINE (2315)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2315)) COMMA_SOURCE_FILE_AT_LINE (2315)).operator_concat (GALGAS_string ("' type of the cast expression") COMMA_SOURCE_FILE_AT_LINE (2315)) COMMA_SOURCE_FILE_AT_LINE (2314)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_88294.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2317)).reader_length (SOURCE_FILE_AT_LINE (2317)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_88294.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name") COMMA_SOURCE_FILE_AT_LINE (2318)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_88277.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2322)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2322)) COMMA_SOURCE_FILE_AT_LINE (2322)).operator_concat (GALGAS_string ("' class is expected here") COMMA_SOURCE_FILE_AT_LINE (2322)) COMMA_SOURCE_FILE_AT_LINE (2321)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2325)), enumerator_88294.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2325)) COMMA_SOURCE_FILE_AT_LINE (2325)) ;
        }else if (kBoolFalse == test_2) {
          const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2326)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (2326)))).boolEnum () ;
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_88294.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_88277.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2329)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2329)) COMMA_SOURCE_FILE_AT_LINE (2329)).operator_concat (GALGAS_string ("' enumeration type is expected here") COMMA_SOURCE_FILE_AT_LINE (2329)) COMMA_SOURCE_FILE_AT_LINE (2328)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE_AT_LINE (2331)).reader_hasKey (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2331)) COMMA_SOURCE_FILE_AT_LINE (2331)).operator_not (SOURCE_FILE_AT_LINE (2331)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2333)) COMMA_SOURCE_FILE_AT_LINE (2333)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@") COMMA_SOURCE_FILE_AT_LINE (2333)).operator_concat (enumerator_88277.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2333)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2333)) COMMA_SOURCE_FILE_AT_LINE (2333)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (2333)) COMMA_SOURCE_FILE_AT_LINE (2332)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2338)), enumerator_88277.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2339)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2339)) COMMA_SOURCE_FILE_AT_LINE (2336)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_88294.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_13, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (2342)) ;
          }
        }
        enumerator_88277.gotoNextObject () ;
        enumerator_88294.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_88043.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE_AT_LINE (2347)).reader_string (SOURCE_FILE_AT_LINE (2347)) COMMA_SOURCE_FILE_AT_LINE (2347)).operator_concat (GALGAS_string (" elements, but it acually contains ") COMMA_SOURCE_FILE_AT_LINE (2347)).operator_concat (enumerator_88043.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE_AT_LINE (2348)).reader_string (SOURCE_FILE_AT_LINE (2348)) COMMA_SOURCE_FILE_AT_LINE (2347)) COMMA_SOURCE_FILE_AT_LINE (2346)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2356)), enumerator_88043.current_mMatchBranchInstructionList (HERE), enumerator_88043.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2353)) ;
    }
    var_matchInstructionBranchList.addAssign_operation (var_matchListForGeneration, var_instructionList COMMA_SOURCE_FILE_AT_LINE (2363)) ;
    enumerator_88043.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_elseInstructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2369)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2370)), object->mAttribute_mElseInstructionList, object->mAttribute_mEndOf_5F_match_5F_instruction, ioArgument_ioVariableMap, var_elseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2367)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_match_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (2377)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_matchInstructionForGeneration::constructor_new (var_expressionList, var_matchInstructionBranchList, var_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (2379)) COMMA_SOURCE_FILE_AT_LINE (2379)) ;
}
//-----------------------------------------------------------------------------*
