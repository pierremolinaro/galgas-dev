...
static void categoryMethod_forInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1727)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1728)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1730)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_before_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1734)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1735)), object->mAttribute_mBeforeInstructionList, object->mAttribute_mEndOf_5F_before_5F_branch, ioArgument_ioVariableMap, var_before_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1732)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_before_5F_branch, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1741)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1743)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_between_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1747)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1748)), object->mAttribute_mBetweenInstructionList, object->mAttribute_mEndOf_5F_between_5F_branch, ioArgument_ioVariableMap, var_between_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1745)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_between_5F_branch, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1754)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1756)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_after_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1759)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1760)), object->mAttribute_mAfterInstructionList, object->mAttribute_mEndOf_5F_after_5F_branch, ioArgument_ioVariableMap, var_after_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1757)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_after_5F_branch, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1766)) ;
  }
  GALGAS_localInitializedVariableList var_localConstantListForDoBranch = GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1768)) ;
  GALGAS_foreachInstructionEnumeratedObjectListForGeneration var_enumerationList = GALGAS_foreachInstructionEnumeratedObjectListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1769)) ;
  cEnumerator_forInstructionEnumeratedObjectListAST enumerator_68979 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_68979.hasCurrentObject ()) {
    GALGAS_string var_enumeratorCppName ;
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeEnumeration ((const cPtr_abstractEnumeratedCollectionAST *) enumerator_68979.current_mEnumeratedCollection (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_localConstantListForDoBranch, var_enumeratorCppName, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1771)) ;
    GALGAS_string temp_0 ;
    const enumGalgasBool test_1 = enumerator_68979.current_mAscending (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
      temp_0 = GALGAS_string ("up") ;
    }else if (kBoolFalse == test_1) {
      temp_0 = GALGAS_string ("down") ;
    }
    var_enumerationList.addAssign_operation (temp_0, var_enumerationExpression, var_enumeratorCppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1779)) ;
    enumerator_68979.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1786)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1787)) ;
  }
  cEnumerator_localInitializedVariableList enumerator_69542 (var_localConstantListForDoBranch, kEnumeration_up) ;
  while (enumerator_69542.hasCurrentObject ()) {
    {
    ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_69542.current_mName (HERE), enumerator_69542.current_mType (HERE), enumerator_69542.current_mCppName (HERE), enumerator_69542.current_mCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1790)) ;
    }
    enumerator_69542.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_uncheckedWhileExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1794)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_uncheckedWhileExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1793)) ;
  GALGAS_semanticExpressionForGeneration var_whileExpression ;
  {
  routine_checkExpressionIsBoolean (constinArgument_inAnalysisContext, object->mAttribute_mEndOf_5F_while_5F_expression, var_uncheckedWhileExpression, var_whileExpression, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1799)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (object->mAttribute_mEndOf_5F_while_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_while_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1807)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1809)) ;
  }
  GALGAS_string var_indexCppName = GALGAS_string::makeEmptyString () ;
  GALGAS_localConstantList var_indexDeclaration = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1811)) ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexVariableName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1812)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_indexCppName = GALGAS_string ("index_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1813)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1813))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1813)) ;
    var_indexDeclaration.addAssign_operation (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType, object->mAttribute_mIndexVariableName, GALGAS_bool (false), var_indexCppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1814)) ;
  }
  ...
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_foreach_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1833)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (object->mAttribute_mEndOf_5F_foreach_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1835)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_foreach_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1836)) ;
  }
...
static void categoryMethod_foreachInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1858)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1859)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1861)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_before_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1866)), object->mAttribute_mBeforeInstructionList, object->mAttribute_mEndOf_5F_before_5F_branch, ioArgument_ioVariableMap, var_before_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1863)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_before_5F_branch, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1872)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1874)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_between_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1878)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1879)), object->mAttribute_mBetweenInstructionList, object->mAttribute_mEndOf_5F_between_5F_branch, ioArgument_ioVariableMap, var_between_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1876)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_between_5F_branch, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1885)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1887)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_after_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1891)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1892)), object->mAttribute_mAfterInstructionList, object->mAttribute_mEndOf_5F_after_5F_branch, ioArgument_ioVariableMap, var_after_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1889)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_after_5F_branch, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1898)) ;
  }
  GALGAS_foreachInstructionEnumeratedObjectListForGeneration var_enumerationList = GALGAS_foreachInstructionEnumeratedObjectListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1900)) ;
  cEnumerator_foreachInstructionEnumeratedObjectListAST enumerator_73317 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_73317.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_73317.current_mEnumeratedExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1905)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1904)) ;
    GALGAS_string var_enumerationOrder = enumerator_73317.current_mEnumerationOrder (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1911)) ;
    GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (enumerator_73317.current_mEndOfEnumerationExpression (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1912)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1912))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1912)) ;
    GALGAS_enumerationDescriptorList var_enumerationDescriptorList = var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1913)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1913)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1914)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_73317.current_mEndOfEnumerationExpression (HERE), GALGAS_string ("an '@").operator_concat (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1915)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1915))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1915)).operator_concat (GALGAS_string ("' object cannot be enumerated")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1915))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1915)) ;
    }else if (kBoolFalse == test_0) {
      ...
      if (kBoolTrue == test_1) {
        var_enumerationOrder = var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1919)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1919)).reader_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1919)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_bool var_found = GALGAS_bool (false) ;
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringlist enumerator_74372 (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)), kEnumeration_up) ;
        bool bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)).isValidAndTrue () ;
        if (enumerator_74372.hasCurrentObject () && bool_2) {
          while (enumerator_74372.hasCurrentObject () && bool_2) {
            var_found = GALGAS_bool (kIsEqual, var_enumerationOrder.objectCompare (enumerator_74372.current_mValue (HERE))) ;
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  \\").operator_concat (enumerator_74372.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1925))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1925)) ;
            enumerator_74372.gotoNextObject () ;
            if (enumerator_74372.hasCurrentObject ()) {
              bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1923)).isValidAndTrue () ;
            }
          }
        }
        const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1927)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_73317.current_mEnumerationOrder (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_4, GALGAS_string ("unknown enumeration specifier; available ones are :").operator_concat (var_s  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1928))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1928)) ;
        }
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_73317.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1932)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (enumerator_73317.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1932)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1932)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_enumerationDescriptorList var_currentTypedAttributeList = var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1933)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1933)) ;
        cEnumerator_enumerationDescriptorList enumerator_74875 (var_currentTypedAttributeList, kEnumeration_up) ;
        while (enumerator_74875.hasCurrentObject ()) {
          {
          ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_73317.current_mPrefix (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1936)).operator_concat (enumerator_74875.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1936)), enumerator_73317.current_mEndOfEnumerationExpression (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1936)), enumerator_74875.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938)).operator_concat (enumerator_74875.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1938)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939)).operator_concat (enumerator_74875.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1939)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1935)) ;
          }
          enumerator_74875.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = enumerator_73317.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_73317.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1942)).boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_string temp_7 ;
          const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1946)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
          if (kBoolTrue == test_8) {
            temp_7 = GALGAS_string ("s") ;
          }else if (kBoolFalse == test_8) {
            temp_7 = GALGAS_string::makeEmptyString () ;
          }
          inCompiler->emitSemanticError (enumerator_73317.current_mEndOfElementList (HERE), GALGAS_string ("the '@").operator_concat (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1944)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1944)).operator_concat (GALGAS_string ("' type requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1944)).operator_concat (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1945)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1945))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1944)).operator_concat (GALGAS_string (" argument")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1945)).operator_concat (temp_7  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1945)).operator_concat (GALGAS_string (" for enumeration: this list provides ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1946)).operator_concat (enumerator_73317.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1948)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1948))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1947))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1943)) ;
        }else if (kBoolFalse == test_6) {
          const enumGalgasBool test_9 = enumerator_73317.current_mEndsWithEllipsis (HERE).operator_and (GALGAS_bool (kIsStrictSup, enumerator_73317.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1950)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1950)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1950)).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_string temp_10 ;
            const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1954)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
            if (kBoolTrue == test_11) {
              temp_10 = GALGAS_string ("s") ;
            }else if (kBoolFalse == test_11) {
              temp_10 = GALGAS_string::makeEmptyString () ;
            }
            inCompiler->emitSemanticError (enumerator_73317.current_mEndOfElementList (HERE), GALGAS_string ("the '@").operator_concat (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).operator_concat (GALGAS_string ("' type requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).operator_concat (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1952)).operator_concat (GALGAS_string (" argument")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)).operator_concat (temp_10  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1953)).operator_concat (GALGAS_string (" or less for enumeration: this list provides ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1954)).operator_concat (enumerator_73317.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1956))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1955))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1951)) ;
          }else if (kBoolFalse == test_9) {
            cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_76246 (enumerator_73317.current_mElementList (HERE), kEnumeration_up) ;
            cEnumerator_enumerationDescriptorList enumerator_76273 (var_enumerationDescriptorList, kEnumeration_up) ;
            while (enumerator_76246.hasCurrentObject () && enumerator_76273.hasCurrentObject ()) {
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_76246.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1960)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_76246.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_76246.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1962)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_76273.current_mEnumeratedType (HERE))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    GALGAS_location location_15 (enumerator_76246.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_15, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)).operator_concat (enumerator_76273.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1964)) ;
                  }
                }
                {
                ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_76246.current_mConstantName (HERE), enumerator_76273.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970)).operator_concat (enumerator_76273.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1970)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971)).operator_concat (enumerator_76273.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1971)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1967)) ;
                }
              }
              enumerator_76246.gotoNextObject () ;
              enumerator_76273.gotoNextObject () ;
            }
          }
        }
      }
    }
    var_enumerationList.addAssign_operation (var_enumerationOrder, var_enumerationExpression, var_enumeratorCppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1978)) ;
    enumerator_73317.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_uncheckedWhileExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1983)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_uncheckedWhileExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1982)) ;
  GALGAS_semanticExpressionForGeneration var_whileExpression ;
  {
  routine_checkExpressionIsBoolean (constinArgument_inAnalysisContext, object->mAttribute_mEndOf_5F_while_5F_expression, var_uncheckedWhileExpression, var_whileExpression, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1989)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1996)) ;
  }
  GALGAS_string var_indexCppName = GALGAS_string::makeEmptyString () ;
  GALGAS_localConstantList var_indexDeclaration = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1998)) ;
  const enumGalgasBool test_16 = GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexVariableName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1999)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_16) {
    var_indexCppName = GALGAS_string ("index_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2000)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2000))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2000)) ;
    var_indexDeclaration.addAssign_operation (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType, object->mAttribute_mIndexVariableName, GALGAS_bool (false), var_indexCppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2001)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_indexDeclaration, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2013)), object->mAttribute_mDoInstructionList, object->mAttribute_mEndOf_5F_do_5F_branch, ioArgument_ioVariableMap, var_do_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2010)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_foreach_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2020)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (object->mAttribute_mEndOf_5F_foreach_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2022)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_foreach_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2023)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_foreachInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_enumerationList, var_indexCppName, var_whileExpression, var_before_5F_instructionList, var_between_5F_instructionList, var_do_5F_instructionList, var_after_5F_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2025))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2025)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_loopInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2047)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variantExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2046)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variantExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2053)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type should be '@").operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055)).operator_concat (GALGAS_string ("', but it has '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055)).operator_concat (var_variantExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2055))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2054)) ;
  }
  GALGAS_semanticExpressionForGeneration var_loopExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLoopExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2060)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_loopExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2059)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_loopExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2066)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfLoopExpression, GALGAS_string ("the loop expression type should be '@").operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068)).operator_concat (GALGAS_string ("', but it has '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068)).operator_concat (var_loopExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2068))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2067)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2071)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_first_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2076)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2077)), object->mAttribute_mFirstInstructions, object->mAttribute_mEndOfFirstInstructions, ioArgument_ioVariableMap, var_first_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2074)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_second_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2087)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2088)), object->mAttribute_mSecondInstructions, object->mAttribute_mEndOfSecondInstructions, ioArgument_ioVariableMap, var_second_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2085)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfLoopInstruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2095)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_loopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variantExpression, var_first_5F_instructionList, var_loopExpression, var_second_5F_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2097))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2097)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mCastExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2116)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_castExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2115)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2122)) ;
  }
  GALGAS_castInstructionBranchListForGeneration var_castBranchList = GALGAS_castInstructionBranchListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2124)) ;
  cEnumerator_castInstructionBranchListAST enumerator_82231 (object->mAttribute_mCastInstructionBranchList, kEnumeration_up) ;
  while (enumerator_82231.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_82231.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)) ;
    GALGAS_unifiedTypeMapProxy var_t = var_type ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_castExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2130)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).isValid ()) {
      uint32_t variant_82519 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).uintValue () ;
      bool loop_82519 = true ;
      while (loop_82519) {
        loop_82519 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).isValid () ;
        if (loop_82519) {
          loop_82519 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2132)).boolValue () ;
        }
        if (loop_82519 && (0 == variant_82519)) {
          loop_82519 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)) ;
        }
        if (loop_82519) {
          variant_82519 -- ;
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2133)) ;
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_castExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2134)))) ;
        }
      }
    }
    const enumGalgasBool test_0 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2136)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_82231.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (enumerator_82231.current_mTypeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138)).operator_concat (var_castExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2138))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2137)) ;
    }
    GALGAS_string var_localConstantName ;
    GALGAS_localConstantList var_localConstantList = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2143)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_82231.current_mConstantVarName (HERE).mAttribute_string.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2144)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_localConstantName = GALGAS_string ("cast_").operator_concat (enumerator_82231.current_mConstantVarName (HERE).reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).operator_concat (enumerator_82231.current_mConstantVarName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)) ;
      var_localConstantList.addAssign_operation (var_type, enumerator_82231.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2146)) ;
    }else if (kBoolFalse == test_2) {
      var_localConstantName = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)), enumerator_82231.current_mInstructionList (HERE), enumerator_82231.current_mEndOfInstructions (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2157)) ;
    }
    var_castBranchList.addAssign_operation (enumerator_82231.current_mTypeComparisonKind (HERE), var_type, var_localConstantName, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2166)) ;
    enumerator_82231.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2172)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2173)), object->mAttribute_mElseInstructionList, object->mAttribute_mEndOfCastInstruction, ioArgument_ioVariableMap, var_else_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2170)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfCastInstruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2180)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_structuredCastInstructionForGeneration::constructor_new (var_castExpression, var_castBranchList, var_else_5F_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2182))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2182)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationDropResult_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2219)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2220)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2233)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2234)) ;
  }
  GALGAS_unifiedTypeMapProxy var_type ;
  GALGAS_string var_cppName ;
  {
  GALGAS_string joker_86438_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_86438_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2236)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2256)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2257)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2259))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2259)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2260)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2261)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2265))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2265)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2265)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2265))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2265)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2265)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2266))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2266)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2266))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2264)) ;
  }
  ioArgument_ioAssignementList.addAssign_operation (GALGAS_string ("GALGAS_string ").operator_concat (var_cppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2269)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2269)).operator_concat (constinArgument_inSyntaxDirectedTranslationResultVarName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2269)).operator_concat (GALGAS_string (") ;")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2269))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2269)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2281)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2282)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2284))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2284)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2285)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2286)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2290))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2290)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2290)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2290))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2290)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2290)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2291))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2291)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2291))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2289)) ;
  }
  ioArgument_ioAssignementList.addAssign_operation (GALGAS_string ("const GALGAS_string ").operator_concat (var_cppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2294)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2294)).operator_concat (constinArgument_inSyntaxDirectedTranslationResultVarName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2294)).operator_concat (GALGAS_string (") ;")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2294))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2294)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_90000_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_90000_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2305)) ;
  GALGAS_formalParameterSignature var_labelSignature ;
  var_grammarLabelMap.method_searchKey (object->mAttribute_mLabelName, var_labelSignature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2312)) ;
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  {
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mLabelName, GALGAS_string ("label of the ").operator_concat (object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)).operator_concat (GALGAS_string (" grammar")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2321)), var_labelSignature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_actualParameterListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2318)) ;
  }
  GALGAS_semanticExpressionForGeneration var_sourceExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mSourceExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2329)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_sourceExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2328)) ;
  const enumGalgasBool test_0 = object->mAttribute_mSourceExpressionIsFile.boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2336)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLStringType)).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mEndOfSourceExpression, GALGAS_string ("this expression is the source file path and its type should be '@lstring', but it is '@").operator_concat (var_sourceExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2338)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2338))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2338)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2338))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2337)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2341)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (object->mAttribute_mEndOfSourceExpression, GALGAS_string ("this expression is the source string and its type should be '@string', but it is '@").operator_concat (var_sourceExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2343)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2343))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2343)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2343))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2342)) ;
    }
  }
  GALGAS_string var_syntaxDirectedTranslationResultVarName = GALGAS_string ("syntaxDirectedTranslationResult_").operator_concat (object->mAttribute_mGrammarComponentName.mAttribute_location.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2347)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2347))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2347)) ;
  GALGAS_stringlist var_assignementList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2348)) ;
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_93591_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_93591_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2405)) ;
  }
  cEnumerator_lstringlist enumerator_93616 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_93616.hasCurrentObject ()) {
    GALGAS_attributeMap var_attributeMap = var_targetType.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2407)) ;
    var_attributeMap.method_searchKey (enumerator_93616.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2408)) ;
    enumerator_93616.gotoNextObject () ;
  }
  GALGAS_withAccessorMap var_withAccessorMap = var_targetType.reader_mWithAccessorMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2411)) ;
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_93895 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mAccessName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2413))) ;
  if (NULL != objectArray_93895) {
      macroValidSharedObject (objectArray_93895, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_93895->mAttribute_mArgumentType  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2414)) ;
  }else{
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_withAccessorMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2416)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mAccessName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_targetType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2418))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2418)).operator_concat (GALGAS_string ("' type cannot be used in a 'with' instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2418))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2417)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_94278 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_94278.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_94278.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424)).operator_concat (GALGAS_string (" \?@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424)).operator_concat (enumerator_94278.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2424)) ;
        enumerator_94278.gotoNextObject () ;
      }
      GALGAS_string temp_2 ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_withAccessorMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2428)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_3) {
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_targetType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427)).operator_concat (GALGAS_string ("' type does not define the '")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427)).operator_concat (object->mAttribute_mAccessName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427)).operator_concat (GALGAS_string ("' accessor for the 'with' instruction; available ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427)).operator_concat (temp_2  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2427)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2428)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2429))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2426)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }
  }
  GALGAS_semanticExpressionListForGeneration var_effectiveExpressionList = GALGAS_semanticExpressionListForGeneration::constructor_listWithValue (var_keyExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2435)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_effectiveExpressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2436)).objectCompare (var_argumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2436)))).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_location location_6 (object->mAttribute_mAccessName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mAccessName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437)).operator_concat (GALGAS_string ("' accessor of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437)).operator_concat (var_targetType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437)).operator_concat (var_argumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2438)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2438))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2438)).operator_concat (var_effectiveExpressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2439)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2439))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2438)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2439))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2437)) ;
  }else if (kBoolFalse == test_5) {
    cEnumerator_semanticExpressionListForGeneration enumerator_95184 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_95202 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_95184.hasCurrentObject () && enumerator_95202.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_95202.current_mType (HERE), enumerator_95184.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2442)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2442)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2442)) ;
      }
  ...
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2446)) ;
  }
  GALGAS_localInitializedVariableList var_localInitializedVariableList = GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2448)) ;
  cEnumerator_typedAttributeList enumerator_95535 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2449)), kEnumeration_up) ;
  while (enumerator_95535.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_95535.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452)).operator_concat (enumerator_95535.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2452)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2453)).operator_concat (enumerator_95535.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2453))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2453))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2450)) ;
    enumerator_95535.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2459)), var_localInitializedVariableList, object->mAttribute_m_5F_do_5F_Instructions, object->mAttribute_mEndOf_5F_do_5F_instructions, ioArgument_ioVariableMap, var_do_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2457)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2470)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2471)), object->mAttribute_m_5F_else_5F_Instructions, object->mAttribute_mEndOf_5F_else_5F_instructions, ioArgument_ioVariableMap, var_else_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2468)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_else_5F_instructions, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2477)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readWriteWithInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_receiverVariableCppName, var_targetType, object->mAttribute_mFieldList, object->mAttribute_mAccessName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2484)), var_objectArrayCppName, var_keyExpression, var_do_5F_instructionList, var_else_5F_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2479))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2479)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_receiverExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2502)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_receiverExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2501)) ;
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2507)) ;
  GALGAS_semanticExpressionForGeneration var_keyExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mKeyExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2511)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_keyExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2510)) ;
  GALGAS_string var_objectArrayCppName = GALGAS_string ("objectArray_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2517)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2517))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2517)) ;
  GALGAS_withAccessorMap var_withAccessorMap = var_receiverType.reader_mWithAccessorMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2519)) ;
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_97893 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2521))) ;
  if (NULL != objectArray_97893) {
      macroValidSharedObject (objectArray_97893, cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_97893->mAttribute_mArgumentType  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2522)) ;
  }else{
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_withAccessorMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2524)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mSearchMethodName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2526))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2526)).operator_concat (GALGAS_string ("' type cannot be used in a 'with' instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2526))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2525)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_98290 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_98290.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_98290.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532)).operator_concat (GALGAS_string (" \?@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532)).operator_concat (enumerator_98290.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2532)) ;
        enumerator_98290.gotoNextObject () ;
      }
      GALGAS_string temp_2 ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_withAccessorMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2536)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        temp_2 = GALGAS_string ("accessors are") ;
      }else if (kBoolFalse == test_3) {
        temp_2 = GALGAS_string ("accessor is") ;
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535)).operator_concat (GALGAS_string ("' type does not define the '")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535)).operator_concat (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535)).operator_concat (GALGAS_string ("' accessor for the 'with' instruction; available ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535)).operator_concat (temp_2  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2535)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2536)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2537))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2534)) ;
      var_argumentTypeList.drop () ; // Release error dropped variable
    }
  }
  GALGAS_semanticExpressionListForGeneration var_effectiveExpressionList = GALGAS_semanticExpressionListForGeneration::constructor_listWithValue (var_keyExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2543)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_effectiveExpressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2544)).objectCompare (var_argumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2544)))).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_location location_6 (object->mAttribute_mSearchMethodName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)).operator_concat (GALGAS_string ("' accessor of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)).operator_concat (var_argumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2546)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2546))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2546)).operator_concat (var_effectiveExpressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2547)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2547))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2546)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2547))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2545)) ;
  }else if (kBoolFalse == test_5) {
    cEnumerator_semanticExpressionListForGeneration enumerator_99224 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_99242 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_99224.hasCurrentObject () && enumerator_99242.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_99242.current_mType (HERE), enumerator_99224.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2550)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2550)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2550)) ;
      }
      enumerator_99224.gotoNextObject () ;
      enumerator_99242.gotoNextObject () ;
    }
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2554)) ;
  }
  GALGAS_localConstantList var_localConstantList = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2556)) ;
  cEnumerator_typedAttributeList enumerator_99561 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2557)), kEnumeration_up) ;
  while (enumerator_99561.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_99561.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560)).operator_concat (enumerator_99561.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2560)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2562)).operator_concat (enumerator_99561.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2562))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2562))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2558)) ;
    enumerator_99561.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2569)), object->mAttribute_mDoBranchInstructions, object->mAttribute_mEndOf_5F_do_5F_instructions, ioArgument_ioVariableMap, var_do_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2566)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2579)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2580)), object->mAttribute_mElseBranchInstructions, object->mAttribute_mEndOf_5F_else_5F_instructions, ioArgument_ioVariableMap, var_else_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2577)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_else_5F_instructions, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2586)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readOnlyWithInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_receiverExpression, object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2591)), var_objectArrayCppName, var_keyExpression, var_do_5F_instructionList, var_else_5F_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2588))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2588)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mSwitchExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2609)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_switchExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2608)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2615)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2615)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2615)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfSwitchExpression, GALGAS_string ("the switch expression type should be an instance of an enumeration type (the '@").operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2617)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2617))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2617)).operator_concat (GALGAS_string ("' type is not an enumeration type)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2617))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2616)) ;
  }
  GALGAS_stringset var_enumConstantStringSet = var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2620)).reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2620)) ;
  GALGAS_stringset var_constantsNamedInSwitchInstruction = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2621)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2623)) ;
  }
  GALGAS_switchBranchesForGeneration var_switchBranchesForGeneration = GALGAS_switchBranchesForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2624)) ;
  cEnumerator_switchBranchesAST enumerator_102027 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_102027.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_102062 (enumerator_102027.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_102062.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_102062.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2627)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2627)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_102062.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2628)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_102062.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_102062.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2630))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2629)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_102062.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2633))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2633)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_102062.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_102062.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).operator_concat (GALGAS_string ("' is not a constant of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2636))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2635)) ;
      }
      enumerator_102062.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2643)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2644)), enumerator_102027.current_mInstructions (HERE), enumerator_102027.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2641)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_102027.current_mSwitchConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2650)) ;
    enumerator_102027.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_switch_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2652)) ;
  }
  GALGAS_stringset var_forgottenConstants = var_enumConstantStringSet.substract_operation (var_constantsNamedInSwitchInstruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2654)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_forgottenConstants.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2655)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_103267 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_103267.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_103267.current_key (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2658))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2658)) ;
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_switchInstructionForGeneration::constructor_new (var_switchExpression, var_switchBranchesForGeneration  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2665))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2665)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionListForGeneration var_expressionList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2680)) ;
  cEnumerator_semanticExpressionListAST enumerator_104117 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_104117.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_104117.current_mExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2685)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2684)) ;
    var_expressionList.addAssign_operation (var_matchedExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2690)) ;
    GALGAS_unifiedTypeMapProxy var_type = var_matchedExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2692)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2693)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2693)))).operator_and (GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2693)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2693)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2693)).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_104117.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2695))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2695)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2695))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2694)) ;
    }
    enumerator_104117.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2700)) ;
  }
  GALGAS_matchInstructionBranchListForGeneration var_matchInstructionBranchList = GALGAS_matchInstructionBranchListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2701)) ;
  cEnumerator_matchInstructionBranchListAST enumerator_105017 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_105017.hasCurrentObject ()) {
    GALGAS_localConstantList var_localConstantList = GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2704)) ;
    GALGAS_matchListForGeneration var_matchListForGeneration = GALGAS_matchListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2705)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2706)).objectCompare (enumerator_105017.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2706)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_105251 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_105268 (enumerator_105017.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_105251.hasCurrentObject () && enumerator_105268.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_105251.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2708)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2709)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2709)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_105268.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2711)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_namedType)) ;
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2714)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2714)).isValid ()) {
              uint32_t variant_105662 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2714)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2714)).uintValue () ;
              bool loop_105662 = true ;
              while (loop_105662) {
                loop_105662 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).isValid () ;
                if (loop_105662) {
                  loop_105662 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2715)).boolValue () ;
                }
                if (loop_105662 && (0 == variant_105662)) {
                  loop_105662 = false ;
                  inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2714)) ;
                }
                if (loop_105662) {
                  variant_105662 -- ;
                  var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2716)) ;
                  var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_namedType)) ;
                }
              }
            }
            const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2719)).boolEnum () ;
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2721))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2721)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2721)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2721))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2721)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2721))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2720)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_105268.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723)).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_105268.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2724)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_105251.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2728)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2728))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2728)).operator_concat (GALGAS_string ("' class is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2728))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2731)), enumerator_105268.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2731))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2731)) ;
        }else if (kBoolFalse == test_2) {
          const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2732)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2732)))).boolEnum () ;
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_105268.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_105251.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2735)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2735))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2735)).operator_concat (GALGAS_string ("' enumeration type is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2735))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2734)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2737)).reader_hasKey (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2737)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2737)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2737)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739)).operator_concat (enumerator_105251.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2739))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2738)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2744)), enumerator_105251.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2745)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2745))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2742)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_105268.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_13, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2748)) ;
          }
        }
        enumerator_105251.gotoNextObject () ;
        enumerator_105268.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_105017.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2753)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2753))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2753)).operator_concat (GALGAS_string (" elements, but it acually contains ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2753)).operator_concat (enumerator_105017.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2754)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2754))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2753))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2752)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2762)), enumerator_105017.current_mMatchBranchInstructionList (HERE), enumerator_105017.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2759)) ;
    }
    var_matchInstructionBranchList.addAssign_operation (var_matchListForGeneration, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2769)) ;
    enumerator_105017.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_elseInstructionList ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2775)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2776)), object->mAttribute_mElseInstructionList, object->mAttribute_mEndOf_5F_match_5F_instruction, ioArgument_ioVariableMap, var_elseInstructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2773)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_match_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2783)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_matchInstructionForGeneration::constructor_new (var_expressionList, var_matchInstructionBranchList, var_elseInstructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2785))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2785)) ;
}
//-----------------------------------------------------------------------------*
