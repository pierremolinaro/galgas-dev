...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
  ...
  if (operand_59733 != NULL) {
    ...
    const GGS_stringset  var_cas_enumConstantStringSet = var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1582)).reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1582)) ;
    GGS_stringset  var_cas_constantsNamedInSwitchInstruction = GGS_stringset ::constructor_emptySet () ;
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1585)) ;
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_60877 (operand_59733->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_60877 = NULL ;
      while (((operand_60877 = enumerator_60877.nextObject ()))) {
        macroValidPointer (operand_60877) ;
        {
          GGS_lstringlist::cEnumerator enumerator_60912 (operand_60877->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_60912 = NULL ;
          while (((operand_60912 = enumerator_60912.nextObject ()))) {
            macroValidPointer (operand_60912) ;
            const GGS_bool cond_61267 = var_cas_enumConstantStringSet.reader_hasKey (operand_60912->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1589))) ;
            if (cond_61267.isBuiltAndTrue ()) {
              const GGS_bool cond_61187 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_60912->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1590))) ;
              if (cond_61187.isBuiltAndTrue ()) {
                operand_60912->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_60912->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1594)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_60912->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1595))) ;
            }else if (cond_61267.isBuiltAndFalse ()) {
              operand_60912->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_60912->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1600)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_60877->mInstructions,  operand_60877->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1603)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_60877->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_59733->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1615)) ;
    const GGS_stringset  var_cas_forgottenConstants = var_cas_enumConstantStringSet.substract_operation (inLexique, var_cas_constantsNamedInSwitchInstruction COMMA_SOURCE_FILE_AT_LINE (1617)) ;
    const GGS_bool cond_62345 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_62345.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_62151 (var_cas_forgottenConstants, true) ;
        while (enumerator_62151.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_62151._key (HERE)) ;
          enumerator_62151.next () ;
        }
      }
      operand_59733->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1626)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_switchInstructionForGeneration ::constructor_new (inLexique, var_cas_switchExpression, var_cas_switchBranchesForGeneration COMMA_SOURCE_FILE_AT_LINE (1628))) ;
  }
}
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_62668,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_62668 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_63003 (operand_62668->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_63003 = NULL ;
      while (((operand_63003 = enumerator_63003.nextObject ()))) {
        macroValidPointer (operand_63003) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_63003->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_63003->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1647)) ;
          }
        }
        var_cas_expressionList.addAssign_operation (var_cas_matchedExpression) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = var_cas_matchedExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)) ;
        const GGS_bool cond_63700 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1656))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1656))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)))) ;
        if (cond_63700.isBuiltAndTrue ()) {
          operand_63003->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1658)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1660)) ;
        }
      }
    }
    var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)) ;
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_63915 (operand_62668->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_63915 = NULL ;
      while (((operand_63915 = enumerator_63915.nextObject ()))) {
        macroValidPointer (operand_63915) ;
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        GGS_matchListForGeneration  var_cas_matchListForGeneration = GGS_matchListForGeneration ::constructor_emptyList () ;
        const GGS_bool cond_66199 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_63915->mMatchEntryList.reader_length ()) ;
        if (cond_66199.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_64149 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_64149 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_64166 (operand_63915->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_64166 = NULL ;
            while (((operand_64149 = enumerator_64149.nextObject ()))
                && ((operand_64166 = enumerator_64166.nextObject ()))) {
              macroValidPointer (operand_64149) ;
              macroValidPointer (operand_64166) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_64149->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)) ;
              const GGS_bool cond_65412 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1672))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1672))) ;
              if (cond_65412.isBuiltAndTrue ()) {
                const GGS_bool cond_65211 = operand_64166->mIsType ;
                if (cond_65211.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_64166->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1674)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_64757 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1677)) ;
                  GGS_bool _condition_64757 (_variant_64757.isBuilt (), true) ;
                  while (_condition_64757.isBuiltAndTrue ()) {
                    _condition_64757 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1678)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1678))).operator_not ()) ;
                    if (_condition_64757.isBuiltAndTrue ()) {
                      if (_variant_64757.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1681)) ;
                        _condition_64757 = GGS_bool (false) ;
                      }else{
                        _variant_64757.decrement_operation (inLexique COMMA_HERE) ;
                        var_cas_t = var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1679)) ;
                        var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                      }
                    }
                  }
                  const GGS_bool cond_65027 = (var_cas_found).operator_not () ;
                  if (cond_65027.isBuiltAndTrue ()) {
                    operand_64166->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_64166->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1684)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1686)) ;
                  }else if (cond_65027.isBuiltAndFalse ()) {
                    const GGS_bool cond_65191 = (operand_64166->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1686)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_65191.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_64166->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_65211.isBuiltAndFalse ()) {
                  operand_64166->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_64149->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1691)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1691)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1693)) ;
                }
              }else if (cond_65412.isBuiltAndFalse ()) {
                const GGS_bool cond_66025 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1694))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1694))) ;
                if (cond_66025.isBuiltAndTrue ()) {
                  const GGS_bool cond_65689 = operand_64166->mIsType ;
                  if (cond_65689.isBuiltAndTrue ()) {
                    operand_64166->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_64149->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1699)) ;
                  }else if (cond_65689.isBuiltAndFalse ()) {
                    const GGS_bool cond_66007 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_hasKey (operand_64166->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)))).operator_not () ;
                    if (cond_66007.isBuiltAndTrue ()) {
                      operand_64166->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_64166->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_64149->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1703)) ;
                    }
                  }
                }
              }
              var_cas_matchListForGeneration.addAssign_operation (operand_64166->mIsType, operand_64166->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1707)), operand_64166->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1707))) ;
            }
          }
        }else if (cond_66199.isBuiltAndFalse ()) {
          operand_63915->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1711)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_63915->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1712))) COMMA_SOURCE_FILE_AT_LINE (1714)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_63915->mMatchBranchInstructionList,  operand_63915->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1717)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_62668->mElseInstructionList,  operand_62668->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1732)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_62668->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1743)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_matchInstructionForGeneration ::constructor_new (inLexique, var_cas_expressionList, var_cas_matchInstructionBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1745))) ;
  }
}
