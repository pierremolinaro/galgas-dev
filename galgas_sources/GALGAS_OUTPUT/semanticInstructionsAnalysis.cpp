...
void routine_analyzeRoutineArguments (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_25002 = (var_cas_inRoutineSignature.reader_length ()).operator_isNotEqual (var_cas_inActualParameterList.reader_length ()) ;
  if (cond_25002.isBuiltAndTrue ()) {
    ...
    {
      GGS_formalParameterSignature::cEnumerator enumerator_25310 (var_cas_inRoutineSignature, true) ;
      const GGS_formalParameterSignature::cElement * operand_25310 = NULL ;
      GGS_actualParameterListAST::cEnumerator enumerator_25333 (var_cas_inActualParameterList, true) ;
      const GGS_actualParameterListAST::cElement * operand_25333 = NULL ;
      while (((operand_25310 = enumerator_25310.nextObject ()))
          && ((operand_25333 = enumerator_25333.nextObject ()))) {
        macroValidPointer (operand_25310) ;
        macroValidPointer (operand_25333) ;
        { typeCategoryMethod__actualParameterAST__checkAgainstFormalArgument method = findCategoryMethod__actualParameterAST__checkAgainstFormalArgument (operand_25333->mActualParameter.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_25333->mActualParameter (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, operand_25310->mFormalArgumentType, operand_25310->mFormalArgumentPassingMode, var_cas_ioVariableMap, var_cas_outActualParameterListForGeneration, var_cas_outTemporaryInputVariableForRoutineInvocationForGeneration, var_cas_exclusiveVariableSet COMMA_SOURCE_FILE_AT_LINE (602)) ;
          }
        }
      }
    }
...
category_method__routineCallInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_routineCallInstructionAST * operand_25879,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25879 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature ;
    if (var_cas_inSemanticContext.mRoutineMap.isBuilt ()) {
      var_cas_inSemanticContext.mRoutineMap (HERE)->method_searchKey (inLexique, operand_25879->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (627)) ;
    }
    ...
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_25879->mRoutineName,  ((GGS_string ("'")).operator_concat (operand_25879->mRoutineName)).operator_concat (GGS_string ("' routine header")),  var_cas_routineSignature,  operand_25879->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration,  var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (631)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_routineCallInstructionForGeneration ::constructor_new (inLexique, operand_25879->mRoutineName, var_cas_actualParameterListForGeneration, var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (643))) ;
  }
}
...
category_method__typeMethodCallInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_typeMethodCallInstructionAST * operand_27186,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_27186 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_27186->mTypeName COMMA_SOURCE_FILE_AT_LINE (660)) ;
    GGS_formalParameterSignature  var_cas_routineSignature ;
    GGS_bool var_cas_hasCompilerArgument ;
    const GGS_classMethodMap  temp_27696 = var_cas_type.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (664)) ;
    if (temp_27696.isBuilt ()) {
      temp_27696 (HERE)->method_searchKey (inLexique, operand_27186->mMethodName, var_cas_routineSignature, var_cas_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (664)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    GGS_temporaryInputVariableForRoutineInvocationForGeneration  var_cas_temporaryInputVariableForRoutineInvocationForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_27186->mMethodName,  ((GGS_string ("'")).operator_concat (operand_27186->mMethodName)).operator_concat (GGS_string ("' class method header")),  var_cas_routineSignature,  operand_27186->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration,  var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (668)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_typeMethodInstructionForGeneration ::constructor_new (inLexique, operand_27186->mTypeName, operand_27186->mMethodName, var_cas_actualParameterListForGeneration, var_cas_hasCompilerArgument, var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (680))) ;
  }
}
...
category_method__methodCallInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_methodCallInstructionAST * operand_28708,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_28708 != NULL) {
    ...
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28708->mReceiverExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_28708->mReceiverExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_receiverExpression COMMA_SOURCE_FILE_AT_LINE (700)) ;
      }
    }
    GGS_formalParameterSignature  var_cas_routineSignature ;
    GGS_bool var_cas_hasCompilerArgument ;
    GGS_location  automatic_var_29404_0 ;
    GGS_readerQualifier automatic_var_29404_1 ;
    const GGS_instanceMethodMap  temp_29345 = var_cas_receiverExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (709)).reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (709)) ;
    if (temp_29345.isBuilt ()) {
      temp_29345 (HERE)->method_searchKey (inLexique, operand_28708->mMethodName, var_cas_routineSignature, automatic_var_29404_0, var_cas_hasCompilerArgument, automatic_var_29404_1 COMMA_SOURCE_FILE_AT_LINE (709)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    GGS_temporaryInputVariableForRoutineInvocationForGeneration  var_cas_temporaryInputVariableForRoutineInvocationForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_28708->mMethodName,  ((GGS_string ("'")).operator_concat (operand_28708->mMethodName)).operator_concat (GGS_string ("' instance method header")),  var_cas_routineSignature,  operand_28708->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration,  var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (713)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_methodCallInstructionForGeneration ::constructor_new (inLexique, operand_28708->mInstructionLocation, var_cas_receiverExpression, operand_28708->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), var_cas_actualParameterListForGeneration, var_cas_hasCompilerArgument, var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (725))) ;
  }
}
...
category_method__modifierCallInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_modifierCallInstructionAST * operand_30412,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_30412 != NULL) {
    ...
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_30412->mReceiverName, var_cas_receiverType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (747)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_30884 (operand_30412->mReceiverStructAttributes, true) ;
      const GGS_lstringlist::cElement * operand_30884 = NULL ;
      while (((operand_30884 = enumerator_30884.nextObject ()))) {
        macroValidPointer (operand_30884) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_30884->mValue, var_cas_receiverType COMMA_SOURCE_FILE_AT_LINE (750)) ;
        }
      }
    }
    GGS_formalParameterSignature  var_cas_routineSignature ;
    GGS_bool var_cas_hasCompilerArgument ;
    GGS_readerQualifier automatic_var_31231_0 ;
    const GGS_modifierMap  temp_31173 = var_cas_receiverType.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (755)) ;
    if (temp_31173.isBuilt ()) {
      temp_31173 (HERE)->method_searchKey (inLexique, operand_30412->mModifierName, var_cas_routineSignature, var_cas_hasCompilerArgument, automatic_var_31231_0 COMMA_SOURCE_FILE_AT_LINE (755)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    GGS_temporaryInputVariableForRoutineInvocationForGeneration  var_cas_temporaryInputVariableForRoutineInvocationForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_30412->mModifierName,  ((GGS_string ("'")).operator_concat (operand_30412->mModifierName)).operator_concat (GGS_string ("' modifier header")),  var_cas_routineSignature,  operand_30412->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration,  var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (759)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_modifierCallInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, operand_30412->mReceiverStructAttributes, operand_30412->mModifierName, var_cas_actualParameterListForGeneration, var_cas_hasCompilerArgument, var_cas_temporaryInputVariableForRoutineInvocationForGeneration COMMA_SOURCE_FILE_AT_LINE (771))) ;
  }
}
...
category_method__appendInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_appendInstructionAST * operand_32235,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_32235 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_32235->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_32235->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (792)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_32235->mTargetVariableName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (801)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_32914 (operand_32235->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_32914 = NULL ;
      while (((operand_32914 = enumerator_32914.nextObject ()))) {
        macroValidPointer (operand_32914) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_32914->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (804)) ;
        }
      }
    }
    const GGS_bool cond_33341 = ((var_cas_targetType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (807))).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (807)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_33341.isBuiltAndTrue ()) {
      operand_32235->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (809)))).operator_concat (GGS_string ("' type, but this type does not support the '.=' operator")) COMMA_SOURCE_FILE_AT_LINE (811)) ;
    }
    ::routine_checkAssignmentTypes (inLexique,  var_cas_targetType,  var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (813)),  operand_32235->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (813)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_appendInstructionForGeneration ::constructor_new (inLexique, operand_32235->mInstructionLocation, var_cas_targetVariableCppName, operand_32235->mStructAttributeList, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (815))) ;
  }
}
...
category_method__addInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_addInstructionAST * operand_33822,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_33822 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_33822->mReceiverName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (835)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_34286 (operand_33822->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_34286 = NULL ;
      while (((operand_34286 = enumerator_34286.nextObject ()))) {
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_34286->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (838)) ;
        }
      }
    }
    ...
    const GGS_bool cond_34873 = (var_cas_addAssignOperatorArguments.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_34873.isBuiltAndTrue ()) {
      operand_33822->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (844)))).operator_concat (GGS_string ("' type, but this type does not support the '+=' operator")) COMMA_SOURCE_FILE_AT_LINE (847)) ;
    }else if (cond_34873.isBuiltAndFalse ()) {
      const GGS_bool cond_35221 = (operand_33822->mExpressions.reader_length ()).operator_isNotEqual (var_cas_addAssignOperatorArguments.reader_length ()) ;
      if (cond_35221.isBuiltAndTrue ()) {
        operand_33822->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("calling the '+=' operator on an '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (849)))).operator_concat (GGS_string ("' object requires "))).operator_concat (var_cas_addAssignOperatorArguments.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (850)))).operator_concat (GGS_string (" parameter(s), while this invocation has "))).operator_concat (operand_33822->mExpressions.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (851)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (853)) ;
      }else if (cond_35221.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticExpressionListAST::cEnumerator enumerator_35324 (operand_33822->mExpressions, true) ;
          const GGS_semanticExpressionListAST::cElement * operand_35324 = NULL ;
          GGS_unifiedTypeMapProxyList::cEnumerator enumerator_35352 (var_cas_addAssignOperatorArguments, true) ;
          const GGS_unifiedTypeMapProxyList::cElement * operand_35352 = NULL ;
          while (((operand_35324 = enumerator_35324.nextObject ()))
              && ((operand_35352 = enumerator_35352.nextObject ()))) {
            macroValidPointer (operand_35324) ;
            macroValidPointer (operand_35352) ;
            GGS_semanticExpressionForGeneration  var_cas_exp ;
            { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_35324->mExpression.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_35324->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_exp COMMA_SOURCE_FILE_AT_LINE (857)) ;
              }
            }
            ::routine_checkAssignmentTypes (inLexique,  operand_35352->mType,  var_cas_exp.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (863)),  operand_35324->mEndOfExpressionLocation COMMA_SOURCE_FILE_AT_LINE (863)) ;
            var_cas_effectiveParameterList.addAssign_operation (var_cas_exp) ;
          }
        }
        var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_addAssignInstructionForGeneration ::constructor_new (inLexique, var_cas_targetVariableCppName, operand_33822->mStructAttributeList, var_cas_effectiveParameterList COMMA_SOURCE_FILE_AT_LINE (867))) ;
      }
    }
  }
}
...
category_method__incrementInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_incrementInstructionAST * operand_36052,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_36052 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_36052->mReceiverName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (887)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_36525 (operand_36052->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_36525 = NULL ;
      while (((operand_36525 = enumerator_36525.nextObject ()))) {
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_36525->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (890)) ;
        }
      }
    }
    const GGS_bool cond_36941 = ((var_cas_targetType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (893))).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (893)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_36941.isBuiltAndTrue ()) {
      operand_36052->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (895)))).operator_concat (GGS_string ("' type, but this type does not support the '++' operator")) COMMA_SOURCE_FILE_AT_LINE (897)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_incrementInstructionForGeneration ::constructor_new (inLexique, var_cas_targetVariableCppName, operand_36052->mStructAttributeList COMMA_SOURCE_FILE_AT_LINE (899))) ;
  }
}
...
category_method__decrementInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_decrementInstructionAST * operand_37269,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37269 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_targetVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_37269->mReceiverName, var_cas_targetType, var_cas_targetVariableCppName COMMA_SOURCE_FILE_AT_LINE (917)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_37742 (operand_37269->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_37742 = NULL ;
      while (((operand_37742 = enumerator_37742.nextObject ()))) {
        macroValidPointer (operand_37742) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_37742->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (920)) ;
        }
      }
    }
    const GGS_bool cond_38158 = ((var_cas_targetType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (923))).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (923)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_38158.isBuiltAndTrue ()) {
      operand_37269->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the target object has the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (925)))).operator_concat (GGS_string ("' type, but this type does not support the '++' operator")) COMMA_SOURCE_FILE_AT_LINE (927)) ;
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_decrementInstructionForGeneration ::constructor_new (inLexique, var_cas_targetVariableCppName, operand_37269->mStructAttributeList COMMA_SOURCE_FILE_AT_LINE (929))) ;
  }
}
...
category_method__messageInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_messageInstructionAST * operand_38484,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38484 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_38484->mExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_38484->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (946)) ;
      }
    }
    const GGS_bool cond_39202 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (953))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
    if (cond_39202.isBuiltAndTrue ()) {
      operand_38484->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the expression has the '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (955)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (955)))).operator_concat (GGS_string ("' type, but the 'message' instruction requires an '@string' expression")) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    }
...
category_method__logInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_logInstructionAST * operand_39485,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39485 != NULL) {
    {
      GGS_logListAST::cEnumerator enumerator_39738 (operand_39485->mLogList, true) ;
      const GGS_logListAST::cElement * operand_39738 = NULL ;
      while (((operand_39738 = enumerator_39738.nextObject ()))) {
        macroValidPointer (operand_39738) ;
        GGS_semanticExpressionForGeneration  var_cas_expression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_39738->mLogExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_39738->mLogExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (976)) ;
          }
        }
        var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_logInstructionForGeneration ::constructor_new (inLexique, operand_39738->mLogMessage, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (983))) ;
      }
    }
  }
}
...
category_method__dropInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_dropInstructionAST * operand_40288,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40288 != NULL) {
    GGS_stringlist  var_cas_cppNameDropList = GGS_stringlist ::constructor_emptyList () ;
    {
      GGS_lstringlist::cEnumerator enumerator_40600 (operand_40288->mDropList, true) ;
      const GGS_lstringlist::cElement * operand_40600 = NULL ;
      while (((operand_40600 = enumerator_40600.nextObject ()))) {
        macroValidPointer (operand_40600) ;
        GGS_string var_cas_variableCppName ;
        GGS_unifiedTypeMapProxy  automatic_var_40703_0 ;
        var_cas_ioVariableMap.modifier_searchForDropAccess (inLexique, operand_40600->mValue, automatic_var_40703_0, var_cas_variableCppName COMMA_SOURCE_FILE_AT_LINE (1002)) ;
...
category_method__ifInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_ifInstructionAST * operand_41070,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41070 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_if_expression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_41070->m_if_expression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_41070->m_if_expression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_if_expression COMMA_SOURCE_FILE_AT_LINE (1023)) ;
      }
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_41070->m_then_instructionList,  operand_41070->mEndOf_then_branch,  var_cas_ioVariableMap,  var_cas_then_instructionList COMMA_SOURCE_FILE_AT_LINE (1032)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_41070->m_else_instructionList,  operand_41070->mEndOf_if_instruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1044)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_41070->mEndOf_if_instruction COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_ifInstructionForGeneration ::constructor_new (inLexique, operand_41070->mEndOf_then_branch, var_cas_if_expression, var_cas_then_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1056))) ;
  }
}
...
category_method__foreachInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_foreachInstructionAST * operand_42666,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
  ...
  if (operand_42666 != NULL) {
    ...
    {
      GGS_foreachInstructionEnumeratedObjectListAST::cEnumerator enumerator_43183 (operand_42666->mEnumeratedObjectList, true) ;
      const GGS_foreachInstructionEnumeratedObjectListAST::cElement * operand_43183 = NULL ;
      while (((operand_43183 = enumerator_43183.nextObject ()))) {
        macroValidPointer (operand_43183) ;
        GGS_semanticExpressionForGeneration  var_cas_enumerationExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_43183->mEnumeratedExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_43183->mEnumeratedExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_enumerationExpression COMMA_SOURCE_FILE_AT_LINE (1081)) ;
          }
        }
        const GGS_string var_cas_enumeratorCppName = (GGS_string ("enumerator_")).operator_concat (operand_43183->mEndOfEnumerationExpression.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1088)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1088))) ;
        ...
        const GGS_bool cond_43913 = (var_cas_enumerationDescriptorList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
        if (cond_43913.isBuiltAndTrue ()) {
          operand_43183->mEndOfEnumerationExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("an '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1091)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1091)))).operator_concat (GGS_string ("' object cannot be enumerated")) COMMA_SOURCE_FILE_AT_LINE (1093)) ;
        }else if (cond_43913.isBuiltAndFalse ()) {
          const GGS_bool cond_44442 = ((operand_43183->mElementList.reader_length ()).operator_isEqual (GGS_uint (0U))).operator_and ((operand_43183->mEndsWithEllipsis).operator_not ()) ;
          if (cond_44442.isBuiltAndTrue ()) {
            ...
            {
              GGS_enumerationDescriptorList::cEnumerator enumerator_44136 (var_cas_currentTypedAttributeList, true) ;
              const GGS_enumerationDescriptorList::cElement * operand_44136 = NULL ;
              while (((operand_44136 = enumerator_44136.nextObject ()))) {
                macroValidPointer (operand_44136) ;
                var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_43183->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1097))).operator_concat (operand_44136->mEnumerationName), operand_43183->mEndOfEnumerationExpression COMMA_SOURCE_FILE_AT_LINE (1097)), operand_44136->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_44136->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1096)) ;
              }
            }
          }else if (cond_44442.isBuiltAndFalse ()) {
            const GGS_bool cond_44884 = ((operand_43183->mEndsWithEllipsis).operator_not ()).operator_and ((operand_43183->mElementList.reader_length ()).operator_isNotEqual (var_cas_enumerationDescriptorList.reader_length ())) ;
            if (cond_44884.isBuiltAndTrue ()) {
              operand_43183->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1104)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1104)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1105)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" for enumeration: this list provides "))).operator_concat (operand_43183->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1108))) COMMA_SOURCE_FILE_AT_LINE (1110)) ;
            }else if (cond_44884.isBuiltAndFalse ()) {
              const GGS_bool cond_45328 = (operand_43183->mEndsWithEllipsis).operator_and ((operand_43183->mElementList.reader_length ()).operator_strictSup (var_cas_enumerationDescriptorList.reader_length ())) ;
              if (cond_45328.isBuiltAndTrue ()) {
                operand_43183->mEndOfElementList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_enumerationExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1112)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1112)))).operator_concat (GGS_string ("' type requires "))).operator_concat (var_cas_enumerationDescriptorList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1113)))).operator_concat (GGS_string (" argument"))).operator_concat ((((var_cas_enumerationDescriptorList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" or less for enumeration: this list provides "))).operator_concat (operand_43183->mElementList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1116))) COMMA_SOURCE_FILE_AT_LINE (1118)) ;
              }else if (cond_45328.isBuiltAndFalse ()) {
                {
                  GGS_foreachInstructionEnumeratedObjectElementListAST::cEnumerator enumerator_45355 (operand_43183->mElementList, true) ;
                  const GGS_foreachInstructionEnumeratedObjectElementListAST::cElement * operand_45355 = NULL ;
                  GGS_enumerationDescriptorList::cEnumerator enumerator_45382 (var_cas_enumerationDescriptorList, true) ;
                  const GGS_enumerationDescriptorList::cElement * operand_45382 = NULL ;
                  while (((operand_45355 = enumerator_45355.nextObject ()))
                      && ((operand_45382 = enumerator_45382.nextObject ()))) {
                    macroValidPointer (operand_45355) ;
                    macroValidPointer (operand_45382) ;
                    const GGS_bool cond_45959 = (operand_45355->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1120))).operator_isNotEqual (GGS_string ("")) ;
                    if (cond_45959.isBuiltAndTrue ()) {
                      const GGS_unifiedTypeMapProxy  var_cas_foundType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_45355->mTypeName COMMA_SOURCE_FILE_AT_LINE (1121)) ;
                      const GGS_bool cond_45769 = (var_cas_foundType).operator_isNotEqual (operand_45382->mEnumeratedType) ;
                      if (cond_45769.isBuiltAndTrue ()) {
                        operand_45355->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("incorrect '@")).operator_concat (var_cas_foundType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)))).operator_concat (GGS_string ("' type: '@"))).operator_concat (operand_45382->mEnumeratedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)))).operator_concat (GGS_string ("' type required here")) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
                      }
                      var_cas_ioVariableMap.modifier_insertUsedLocalConstant (inLexique, operand_45355->mConstantName, operand_45382->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".attribute_"))).operator_concat (operand_45382->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1125)) ;
                    }
                  }
                }
              }
        ...
        var_cas_enumerationList.addAssign_operation (operand_43183->mIsAscending, var_cas_enumerationExpression, var_cas_enumeratorCppName) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_whileExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_42666->mWhileExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_42666->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_whileExpression COMMA_SOURCE_FILE_AT_LINE (1134)) ;
      }
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_42666->mBeforeInstructionList,  operand_42666->mEndOf_before_branch,  var_cas_ioVariableMap,  var_cas_before_instructionList COMMA_SOURCE_FILE_AT_LINE (1144)) ;
    ...
    const GGS_bool cond_47149 = (operand_42666->mIndexVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1157))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_47149.isBuiltAndTrue ()) {
      var_cas_indexCppName = (GGS_string ("index_")).operator_concat (operand_42666->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1158)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1158))) ;
      var_cas_indexDeclaration.addAssign_operation (var_cas_inPredefinedTypes.mUIntType, operand_42666->mIndexVariableName, GGS_bool (false), var_cas_indexCppName) ;
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_indexDeclaration,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_42666->mDoInstructionList,  operand_42666->mEndOf_do_branch,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    GGS_semanticInstructionListForGeneration  var_cas_between_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_42666->mBetweenInstructionList,  operand_42666->mEndOf_between_branch,  var_cas_ioVariableMap,  var_cas_between_instructionList COMMA_SOURCE_FILE_AT_LINE (1180)) ;
    GGS_semanticInstructionListForGeneration  var_cas_after_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_42666->mAfterInstructionList,  operand_42666->mEndOf_after_branch,  var_cas_ioVariableMap,  var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1192)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_42666->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1203)) ;
    var_cas_ioVariableMap.modifier_endBranch (inLexique, operand_42666->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1205)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_42666->mEndOf_foreach_instruction COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_foreachInstructionForGeneration ::constructor_new (inLexique, operand_42666->mInstructionLocation, var_cas_enumerationList, var_cas_indexCppName, var_cas_whileExpression, var_cas_before_instructionList, var_cas_between_instructionList, var_cas_do_instructionList, var_cas_after_instructionList COMMA_SOURCE_FILE_AT_LINE (1208))) ;
  }
}
...
category_method__loopInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_loopInstructionAST * operand_48889,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48889 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_variantExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_48889->mVariantExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48889->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variantExpression COMMA_SOURCE_FILE_AT_LINE (1231)) ;
      }
    }
    const GGS_bool cond_49651 = (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1238))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
    if (cond_49651.isBuiltAndTrue ()) {
      operand_48889->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
    }
    GGS_semanticExpressionForGeneration  var_cas_loopExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_48889->mLoopExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48889->mLoopExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_loopExpression COMMA_SOURCE_FILE_AT_LINE (1244)) ;
      }
    }
    const GGS_bool cond_50157 = (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1251))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
    if (cond_50157.isBuiltAndTrue ()) {
      operand_48889->mEndOfLoopExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the loop expression type should be '@")).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1253)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1253)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1253)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1254)) ;
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48889->mFirstInstructions,  operand_48889->mEndOfFirstInstructions,  var_cas_ioVariableMap,  var_cas_first_instructionList COMMA_SOURCE_FILE_AT_LINE (1259)) ;
    GGS_semanticInstructionListForGeneration  var_cas_second_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_48889->mSecondInstructions,  operand_48889->mEndOfSecondInstructions,  var_cas_ioVariableMap,  var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1271)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_48889->mEndOfLoopInstruction COMMA_SOURCE_FILE_AT_LINE (1282)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_loopInstructionForGeneration ::constructor_new (inLexique, operand_48889->mInstructionLocation, var_cas_variantExpression, var_cas_first_instructionList, var_cas_loopExpression, var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1284))) ;
  }
}
...
category_method__structuredCastInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_structuredCastInstructionAST * operand_51436,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51436 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_castExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_51436->mCastExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_51436->mCastExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_castExpression COMMA_SOURCE_FILE_AT_LINE (1304)) ;
      }
    }
    ...
    {
      GGS_castInstructionBranchListAST::cEnumerator enumerator_52101 (operand_51436->mCastInstructionBranchList, true) ;
      const GGS_castInstructionBranchListAST::cElement * operand_52101 = NULL ;
      while (((operand_52101 = enumerator_52101.nextObject ()))) {
        macroValidPointer (operand_52101) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_52101->mTypeName COMMA_SOURCE_FILE_AT_LINE (1316)) ;
        ...
        GGS_uint _variant_52570 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1320)) ;
        GGS_bool _condition_52570 (_variant_52570.isBuilt (), true) ;
        while (_condition_52570.isBuiltAndTrue ()) {
          _condition_52570 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1321))).operator_not ()) ;
          if (_condition_52570.isBuiltAndTrue ()) {
            if (_variant_52570.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1324)) ;
              _condition_52570 = GGS_bool (false) ;
            }else{
              _variant_52570.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_52766 = (var_cas_found).operator_not () ;
        if (cond_52766.isBuiltAndTrue ()) {
          operand_52101->mTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_52101->mTypeName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_castExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1327)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1327)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1329)) ;
        }
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        const GGS_bool cond_53117 = (operand_52101->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_53117.isBuiltAndTrue ()) {
          var_cas_localConstantList.addAssign_operation (var_cas_type, operand_52101->mConstantVarName, GGS_bool (false), (((GGS_string ("cast_")).operator_concat (operand_52101->mConstantVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1337)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1337)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1337)))).operator_concat (GGS_string ("_"))).operator_concat (operand_52101->mConstantVarName)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_52101->mInstructionList,  operand_52101->mEndOfInstructions,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1342)) ;
        var_cas_castBranchList.addAssign_operation (operand_52101->mUseKindOfClass, var_cas_type, var_cas_instructionList) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_51436->mElseInstructionList,  operand_51436->mEndOfCastInstruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1356)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_51436->mEndOfCastInstruction COMMA_SOURCE_FILE_AT_LINE (1367)) ;
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_grammarInstructionAST * operand_54324,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54324 != NULL) {
    GGS_grammarLabelMap  var_cas_grammarLabelMap ;
    if (var_cas_inSemanticContext.mGrammarMap.isBuilt ()) {
      var_cas_inSemanticContext.mGrammarMap (HERE)->method_searchKey (inLexique, operand_54324->mGrammarComponentName, var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (1387)) ;
    }
    GGS_formalParameterSignature  var_cas_labelSignature ;
    if (var_cas_grammarLabelMap.isBuilt ()) {
      var_cas_grammarLabelMap (HERE)->method_searchKey (inLexique, operand_54324->mLabelName, var_cas_labelSignature COMMA_SOURCE_FILE_AT_LINE (1393)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    GGS_temporaryInputVariableForRoutineInvocationForGeneration  var_cas_temporaryInputVariableList ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_54324->mLabelName,  ((GGS_string ("label of the ")).operator_concat (operand_54324->mGrammarComponentName)).operator_concat (GGS_string (" grammar")),  var_cas_labelSignature,  operand_54324->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration,  var_cas_temporaryInputVariableList COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    GGS_semanticExpressionForGeneration  var_cas_sourceExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_54324->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_54324->mSourceExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_sourceExpression COMMA_SOURCE_FILE_AT_LINE (1413)) ;
      }
    }
    const GGS_bool cond_55949 = operand_54324->mSourceExpressionIsFile ;
    if (cond_55949.isBuiltAndTrue ()) {
      const GGS_bool cond_55936 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1421))).operator_isNotEqual (var_cas_inPredefinedTypes.mLStringType) ;
      if (cond_55936.isBuiltAndTrue ()) {
        operand_54324->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is a file reference and its type should be '@lstring', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1423)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1423)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1425)) ;
      }
    }else if (cond_55949.isBuiltAndFalse ()) {
      const GGS_bool cond_56188 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1426))).operator_isNotEqual (var_cas_inPredefinedTypes.mStringType) ;
      if (cond_56188.isBuiltAndTrue ()) {
        operand_54324->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source string and its type should be '@string', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1428)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1428)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1430)) ;
      }
    }
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionForGeneration ::constructor_new (inLexique, operand_54324->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1433)), operand_54324->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1434)), var_cas_sourceExpression, operand_54324->mSourceExpressionIsFile, var_cas_actualParameterListForGeneration, var_cas_temporaryInputVariableList COMMA_SOURCE_FILE_AT_LINE (1432))) ;
  }
}
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readWriteAccessWithInstructionAST * operand_56653,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56653 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_56653->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_56653->mKeyExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1453)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_receiverVariableCppName ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_56653->mReceiverName, var_cas_targetType, var_cas_receiverVariableCppName COMMA_SOURCE_FILE_AT_LINE (1462)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_57340 (operand_56653->mFieldList, true) ;
      const GGS_lstringlist::cElement * operand_57340 = NULL ;
      while (((operand_57340 = enumerator_57340.nextObject ()))) {
        macroValidPointer (operand_57340) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_57340->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (1465)) ;
        }
      }
    }
    ...
    elementOf_GGS_withAccessorMap * operand_57666 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_56653->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1470))) ;
    if (NULL != operand_57666) {
      var_cas_argumentTypeList = operand_57666->mInfo.mArgumentTypeList ;
    }else{
      const GGS_bool cond_57941 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_57941.isBuiltAndTrue ()) {
        operand_56653->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1475)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1478)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_57941.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_57995 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_57995 = NULL ;
          while (((operand_57995 = enumerator_57995.nextObject ()))) {
            macroValidPointer (operand_57995) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_57995->mKey) ;
            {
              GGS_unifiedTypeMapProxyList::cEnumerator enumerator_58063 (operand_57995->mInfo.mArgumentTypeList, true) ;
              const GGS_unifiedTypeMapProxyList::cElement * operand_58063 = NULL ;
              while (((operand_58063 = enumerator_58063.nextObject ()))) {
                macroValidPointer (operand_58063) ;
                var_cas_s.appendCString (" \?@") ;
                var_cas_s.dotAssign_operation (operand_58063->mType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1483))) ;
              }
            }
          }
        }
        operand_56653->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1487)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_56653->mAccessName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1492)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    ...
    const GGS_bool cond_58929 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_58929.isBuiltAndTrue ()) {
      operand_56653->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_56653->mAccessName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1497)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1498)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1499)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1500)) ;
    }else if (cond_58929.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_58965 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_58965 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_58983 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_58983 = NULL ;
        while (((operand_58965 = enumerator_58965.nextObject ()))
            && ((operand_58983 = enumerator_58983.nextObject ()))) {
          macroValidPointer (operand_58965) ;
          macroValidPointer (operand_58983) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_58983->mType,  operand_58965->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1502)),  operand_56653->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1502)) COMMA_SOURCE_FILE_AT_LINE (1502)) ;
        }
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_59279 (var_cas_targetType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), true) ;
      const GGS_typedAttributeList::cElement * operand_59279 = NULL ;
      while (((operand_59279 = enumerator_59279.nextObject ()))) {
        macroValidPointer (operand_59279) ;
        var_cas_localInitializedVariableList.addAssign_operation (operand_59279->mAttributeTypeIndex, GGS_lstring ::constructor_new (inLexique, (operand_56653->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1512))).operator_concat (operand_59279->mAttributeName), operand_56653->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1512)) COMMA_SOURCE_FILE_AT_LINE (1512)), (GGS_string ("with_rw_access_for_")).operator_concat (operand_59279->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  var_cas_localInitializedVariableList,  operand_56653->m_do_Instructions,  operand_56653->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1517)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_56653->m_else_Instructions,  operand_56653->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1529)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_56653->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1539)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, operand_56653->mFieldList, operand_56653->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1544)), var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1541))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_60694,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60694 != NULL) {
    operand_60694->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @readAccessWithInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_61202,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61202 != NULL) {
    operand_61202->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @switchInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1577)) ;
  }
}
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_61704,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61704 != NULL) {
    operand_61704->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @matchInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1591)) ;
  }
}
