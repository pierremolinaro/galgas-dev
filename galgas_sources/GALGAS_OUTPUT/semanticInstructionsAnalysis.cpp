...
static GALGAS_object functionWithGenericHeader_checkMethodImplementationInSuperClasses (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand0 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (0 COMMA_HERE),
                                                                 inCompiler,
                                                                 inErrorLocation,
                                                                 GALGAS_string ("operand 0 is not an @lstring")
                                                                 COMMA_THERE) ;
  const GALGAS_unifiedTypeMapProxy operand1 = GALGAS_unifiedTypeMapProxy::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE),
                                                                                         inCompiler,
                                                                                         inErrorLocation,
                                                                                         GALGAS_string ("operand 1 is not an @unifiedTypeMapProxy")
                                                                                         COMMA_THERE) ;
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_69344.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_2) {
      ...
      var_localConstantList.addAssign_operation (var_type, enumerator_69344.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName COMMA_SOURCE_FILE_AT_LINE (1810)) ;
    }else if (kBoolFalse == test_2) {
    ...
    var_castBranchList.addAssign_operation (enumerator_69344.current_mStrictTypeEquality (HERE), var_type, var_localConstantName, var_instructionList COMMA_SOURCE_FILE_AT_LINE (1830)) ;
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_72016_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_72016_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1862)) ;
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_74812_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_74812_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1942)) ;
  }
  cEnumerator_lstringlist enumerator_74839 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_74839.hasCurrentObject ()) {
    GALGAS_attributeMap var_attributeMap = var_targetType.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1944)) ;
    var_attributeMap.method_searchKey (enumerator_74839.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1945)) ;
    enumerator_74839.gotoNextObject () ;
  }
  ...
  const cMapElement_withAccessorMap * objectArray_75162 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mAccessName.reader_string (SOURCE_FILE_AT_LINE (1950))) ;
  if (NULL != objectArray_75162) {
      macroValidSharedObject (objectArray_75162, const cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_75162->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (1951)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_75532 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_75532.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_75532.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (1961)) COMMA_SOURCE_FILE_AT_LINE (1961)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (1961)).operator_concat (enumerator_75532.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1961)) COMMA_SOURCE_FILE_AT_LINE (1961)) COMMA_SOURCE_FILE_AT_LINE (1961)) ;
        enumerator_75532.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_76433 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_76453 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_76433.hasCurrentObject () && enumerator_76453.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_76453.current_mType (HERE), enumerator_76433.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (1979)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (1979)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1979)) ;
      }
      enumerator_76433.gotoNextObject () ;
  ...
  cEnumerator_typedAttributeList enumerator_76786 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1986)), kEnumeration_up) ;
  while (enumerator_76786.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_76786.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (1989)).operator_concat (enumerator_76786.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1989)) COMMA_SOURCE_FILE_AT_LINE (1989)), object->mAttribute_mAccessName.reader_location (SOURCE_FILE_AT_LINE (1989)) COMMA_SOURCE_FILE_AT_LINE (1989)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1990)).operator_concat (enumerator_76786.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1990)) COMMA_SOURCE_FILE_AT_LINE (1990)) COMMA_SOURCE_FILE_AT_LINE (1987)) ;
    enumerator_76786.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxyList var_argumentTypeList ;
  const cMapElement_withAccessorMap * objectArray_79137 = (const cMapElement_withAccessorMap *) var_withAccessorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mSearchMethodName.reader_string (SOURCE_FILE_AT_LINE (2056))) ;
  if (NULL != objectArray_79137) {
      macroValidSharedObject (objectArray_79137, const cMapElement_withAccessorMap) ;
    var_argumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (objectArray_79137->mAttribute_mArgumentType COMMA_SOURCE_FILE_AT_LINE (2057)) ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_withAccessorMap enumerator_79521 (var_withAccessorMap, kEnumeration_up) ;
      while (enumerator_79521.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_79521.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (2067)) COMMA_SOURCE_FILE_AT_LINE (2067)).operator_concat (GALGAS_string (" \?@") COMMA_SOURCE_FILE_AT_LINE (2067)).operator_concat (enumerator_79521.current_mArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2067)) COMMA_SOURCE_FILE_AT_LINE (2067)) COMMA_SOURCE_FILE_AT_LINE (2067)) ;
        enumerator_79521.gotoNextObject () ;
      }
      //--- @ifExpressionForGeneration
      GALGAS_string temp_2 ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_semanticExpressionListForGeneration enumerator_80450 (var_effectiveExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_80470 (var_argumentTypeList, kEnumeration_up) ;
    while (enumerator_80450.hasCurrentObject () && enumerator_80470.hasCurrentObject ()) {
      {
      routine_checkAssignmentTypes (enumerator_80470.current_mType (HERE), enumerator_80450.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2085)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2085)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2085)) ;
      }
      enumerator_80450.gotoNextObject () ;
  ...
  cEnumerator_typedAttributeList enumerator_80789 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2092)), kEnumeration_up) ;
  while (enumerator_80789.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_80789.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.reader_string (SOURCE_FILE_AT_LINE (2095)).operator_concat (enumerator_80789.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2095)) COMMA_SOURCE_FILE_AT_LINE (2095)), object->mAttribute_mSearchMethodName.reader_location (SOURCE_FILE_AT_LINE (2095)) COMMA_SOURCE_FILE_AT_LINE (2095)), GALGAS_bool (true), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_") COMMA_SOURCE_FILE_AT_LINE (2097)).operator_concat (enumerator_80789.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2097)) COMMA_SOURCE_FILE_AT_LINE (2097)) COMMA_SOURCE_FILE_AT_LINE (2093)) ;
    enumerator_80789.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList ;
  {
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_83233 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_83233.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_83268 (enumerator_83233.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_83268.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_83268.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2161)) COMMA_SOURCE_FILE_AT_LINE (2161)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_83268.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_83268.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_83268.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2164)) COMMA_SOURCE_FILE_AT_LINE (2164)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction") COMMA_SOURCE_FILE_AT_LINE (2164)) COMMA_SOURCE_FILE_AT_LINE (2163)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_83268.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2167)) COMMA_SOURCE_FILE_AT_LINE (2167)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_83268.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").operator_concat (enumerator_83268.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2170)) COMMA_SOURCE_FILE_AT_LINE (2170)).operator_concat (GALGAS_string ("' is not a constant of '@") COMMA_SOURCE_FILE_AT_LINE (2170)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (2170)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2170)) COMMA_SOURCE_FILE_AT_LINE (2170)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (2170)) COMMA_SOURCE_FILE_AT_LINE (2169)) ;
      }
      enumerator_83268.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (2177)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2178)), enumerator_83233.current_mInstructions (HERE), enumerator_83233.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2175)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_83233.current_mSwitchConstantList (HERE), var_instructionList COMMA_SOURCE_FILE_AT_LINE (2184)) ;
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_84484 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_84484.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_84484.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (2192)) COMMA_SOURCE_FILE_AT_LINE (2192)) ;
      enumerator_84484.gotoNextObject () ;
    }
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_semanticExpressionListAST enumerator_85247 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_85247.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85247.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (2216)) ;
    ...
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_85247.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2226)) COMMA_SOURCE_FILE_AT_LINE (2226)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class") COMMA_SOURCE_FILE_AT_LINE (2226)) COMMA_SOURCE_FILE_AT_LINE (2225)) ;
    }
  ...
  cEnumerator_matchInstructionBranchListAST enumerator_86133 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_86133.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE_AT_LINE (2237)).objectCompare (enumerator_86133.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE_AT_LINE (2237)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_86365 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_86384 (enumerator_86133.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_86365.hasCurrentObject () && enumerator_86384.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_86365.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2239)) ;
        ...
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_86384.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2242)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            ...
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2245)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2245)).isValid ()) {
              PMUInt32 variant_86795 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2245)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2245)).uintValue () ;
              bool loop_86795 = true ;
              while (loop_86795) {
                loop_86795 = var_found.operator_not (SOURCE_FILE_AT_LINE (2246)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2246)).reader_isNull (SOURCE_FILE_AT_LINE (2246)).operator_not (SOURCE_FILE_AT_LINE (2246)) COMMA_SOURCE_FILE_AT_LINE (2246)).isValid () ;
                if (loop_86795) {
                  loop_86795 = var_found.operator_not (SOURCE_FILE_AT_LINE (2246)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2246)).reader_isNull (SOURCE_FILE_AT_LINE (2246)).operator_not (SOURCE_FILE_AT_LINE (2246)) COMMA_SOURCE_FILE_AT_LINE (2246)).boolValue () ;
                }
                if (loop_86795 && (0 == variant_86795)) {
                  loop_86795 = false ;
            ...
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2252)) COMMA_SOURCE_FILE_AT_LINE (2252)).operator_concat (GALGAS_string ("' is not a descendant of the '@") COMMA_SOURCE_FILE_AT_LINE (2252)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2252)) COMMA_SOURCE_FILE_AT_LINE (2252)).operator_concat (GALGAS_string ("' type of the cast expression") COMMA_SOURCE_FILE_AT_LINE (2252)) COMMA_SOURCE_FILE_AT_LINE (2251)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_86384.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2254)).reader_length (SOURCE_FILE_AT_LINE (2254)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_86384.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name") COMMA_SOURCE_FILE_AT_LINE (2255)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_86365.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2259)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2259)) COMMA_SOURCE_FILE_AT_LINE (2259)).operator_concat (GALGAS_string ("' class is expected here") COMMA_SOURCE_FILE_AT_LINE (2259)) COMMA_SOURCE_FILE_AT_LINE (2258)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2262)), enumerator_86384.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2262)) COMMA_SOURCE_FILE_AT_LINE (2262)) ;
        }else if (kBoolFalse == test_2) {
          ...
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_86384.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_86365.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2266)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2266)) COMMA_SOURCE_FILE_AT_LINE (2266)).operator_concat (GALGAS_string ("' enumeration type is expected here") COMMA_SOURCE_FILE_AT_LINE (2266)) COMMA_SOURCE_FILE_AT_LINE (2265)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE_AT_LINE (2268)).reader_hasKey (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2268)) COMMA_SOURCE_FILE_AT_LINE (2268)).operator_not (SOURCE_FILE_AT_LINE (2268)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2270)) COMMA_SOURCE_FILE_AT_LINE (2270)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@") COMMA_SOURCE_FILE_AT_LINE (2270)).operator_concat (enumerator_86365.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2270)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)) COMMA_SOURCE_FILE_AT_LINE (2270)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (2270)) COMMA_SOURCE_FILE_AT_LINE (2269)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2275)), enumerator_86365.current_mExpression (HERE).reader_mType (SOURCE_FILE_AT_LINE (2276)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2276)) COMMA_SOURCE_FILE_AT_LINE (2273)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_86384.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_13, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (2279)) ;
          }
        }
        enumerator_86365.gotoNextObject () ;
        enumerator_86384.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_86133.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE_AT_LINE (2284)).reader_string (SOURCE_FILE_AT_LINE (2284)) COMMA_SOURCE_FILE_AT_LINE (2284)).operator_concat (GALGAS_string (" elements, but it acually contains ") COMMA_SOURCE_FILE_AT_LINE (2284)).operator_concat (enumerator_86133.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE_AT_LINE (2285)).reader_string (SOURCE_FILE_AT_LINE (2285)) COMMA_SOURCE_FILE_AT_LINE (2285)) COMMA_SOURCE_FILE_AT_LINE (2283)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE_AT_LINE (2293)), enumerator_86133.current_mMatchBranchInstructionList (HERE), enumerator_86133.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2290)) ;
    }
    ...
    enumerator_86133.gotoNextObject () ;
  }
