...
//                                         september 25th, 2014, at 18h57'27"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_analyzeRoutineArguments (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_formalParameterSignature enumerator_34190 (constinArgument_inRoutineSignature, kEnumeration_up) ;
    cEnumerator_actualParameterListAST enumerator_34213 (constinArgument_inActualParameterList, kEnumeration_up) ;
    while (enumerator_34190.hasCurrentObject () && enumerator_34213.hasCurrentObject ()) {
      callCategoryMethod_checkAgainstFormalArgument ((const cPtr_actualParameterAST *) enumerator_34213.current_mActualParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_34190.current_mFormalSelector (HERE), enumerator_34190.current_mFormalArgumentType (HERE), enumerator_34190.current_mFormalArgumentPassingMode (HERE), ioArgument_ioVariableMap, outArgument_outActualParameterListForGeneration, var_exclusiveVariableSet, ioArgument_ioLocalVariableDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 808)) ;
      enumerator_34190.gotoNextObject () ;
...
GALGAS_string function_checkMethodImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inMethodName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_40346_0 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_40349_0 ; // Joker input parameter
    GALGAS_location joker_40352_0 ; // Joker input parameter
    GALGAS_bool joker_40355_0 ; // Joker input parameter
    GALGAS_string joker_40387_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 987)).method_searchKey (constinArgument_inMethodName, joker_40346_0, joker_40349_0, joker_40352_0, joker_40355_0, var_qualifier, joker_40387_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 987)) ;
...
GALGAS_string function_checkModifierImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inModifierName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodQualifier var_qualifier ;
    GALGAS_methodKind joker_45483_3 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_45483_2 ; // Joker input parameter
    GALGAS_bool joker_45483_1 ; // Joker input parameter
    GALGAS_string joker_45498_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1133)).method_searchKey (constinArgument_inModifierName, joker_45483_3, joker_45483_2, joker_45483_1, var_qualifier, joker_45498_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1133)) ;
    if (var_qualifier.isValid ()) {
      switch (var_qualifier.enumValue ()) {
      case GALGAS_methodQualifier::kNotBuilt:
        break ;
...
void routine_checkExpressionIsBoolean (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  GALGAS_unifiedTypeMapProxy var_expressionType = constinArgument_inExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1636)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      const cMapElement_readerMap * objectArray_66124 = (const cMapElement_readerMap *) var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1665)).readAccessForWithInstruction (GALGAS_string ("bool")) ;
      if (NULL != objectArray_66124) {
          macroValidSharedObject (objectArray_66124, cMapElement_readerMap) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, objectArray_66124->mAttribute_mReturnedType.objectCompare (var_boolType)).boolEnum () ;
        if (kBoolTrue == test_4) {
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, objectArray_66124->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1668)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_5) {
            ...
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_66124->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              inCompiler->emitSemanticError (constinArgument_inErrorLocation, objectArray_66124->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1671)) ;
              outArgument_outExpression.drop () ; // Release error dropped variable
            }else if (kBoolFalse == test_6) {
              outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_boolType, constinArgument_inErrorLocation, objectArray_66124->mAttribute_mKind, constinArgument_inExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1678)), GALGAS_string ("bool"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1680)), objectArray_66124->mAttribute_mHasCompilerArgument  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1673)) ;
            }
          }
        }
      }else{
        ...
        if (kBoolTrue == test_7) {
          ...
          cEnumerator_readerMap enumerator_67326 (var_expressionType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1692)), kEnumeration_up) ;
          while (enumerator_67326.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - ").operator_concat (enumerator_67326.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1693)) ;
            cEnumerator_functionSignature enumerator_67398 (enumerator_67326.current_mArgumentTypeList (HERE), kEnumeration_up) ;
            while (enumerator_67398.hasCurrentObject ()) {
              GALGAS_string temp_8 ;
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_67398.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                temp_8 = enumerator_67398.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)) ;
              }else if (kBoolFalse == test_9) {
                temp_8 = GALGAS_string::makeEmptyString () ;
              }
              var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_8, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)).operator_concat (enumerator_67398.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1695)) ;
              enumerator_67398.gotoNextObject () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_67326.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1697))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1697))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1697)) ;
            enumerator_67326.gotoNextObject () ;
          }
...
static void categoryMethod_outputActualParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    routine_checkAssignmentTypes (constinArgument_inFormalArgumentType, var_expression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 538)), object->mAttribute_mEndOfExpressionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 538)) ;
    }
...
static void categoryMethod_outputInputActualParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  {
  GALGAS_string joker_23663_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mOutputInputActualParameterName, var_parameterType, var_variableCppName, joker_23663_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 569)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_23774 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_23774.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_23774.current_mValue (HERE), var_parameterType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 573)) ;
...
static void categoryMethod_inputActualExistingVariableParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_26050_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mInputActualParameterName, var_parameterType, var_targetVariableCppName, joker_26050_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 619)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType)).boolEnum () ;
  if (kBoolTrue == test_5) {
...
static void categoryMethod_routineCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_35909 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_35909.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_35909.current_mType (HERE), enumerator_35909.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 856))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 856)) ;
...
static void categoryMethod_typeMethodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_37335 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_37335.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_37335.current_mType (HERE), enumerator_37335.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 894))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 894)) ;
    enumerator_37335.gotoNextObject () ;
  }
...
static void categoryMethod_methodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_location joker_38442_0 ; // Joker input parameter
  GALGAS_methodQualifier joker_38466_0 ; // Joker input parameter
  var_receiverExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 926)).reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 926)).method_searchKey (object->mAttribute_mMethodName, var_kind, var_routineSignature, joker_38442_0, var_hasCompilerArgument, joker_38466_0, var_errorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 926)) ;
  ...
  GALGAS_unifiedTypeMapProxy var_baseType = var_receiverExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 943)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 946)).isValid ()) {
      uint32_t variant_39140 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 946)).uintValue () ;
      bool loop_39140 = true ;
      while (loop_39140) {
        loop_39140 = var_searching.isValid () ;
        if (loop_39140) {
          loop_39140 = var_searching.boolValue () ;
        }
        if (loop_39140 && (0 == variant_39140)) {
          loop_39140 = false ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_39565 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_39565.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_39565.current_mType (HERE), enumerator_39565.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 960))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 960)) ;
...
static void categoryMethod_modifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_41339 (object->mAttribute_mReceiverStructAttributes, kEnumeration_up) ;
  while (enumerator_41339.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_41339.current_mValue (HERE), var_receiverType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1013)) ;
    enumerator_41339.gotoNextObject () ;
  }
  GALGAS_formalParameterSignature var_routineSignature ;
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_string var_modifierErrorMessage ;
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_41730_0 ; // Joker input parameter
  var_receiverType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1020)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_41730_0, var_modifierErrorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1020)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1040)).isValid ()) {
      uint32_t variant_42413 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1040)).uintValue () ;
      bool loop_42413 = true ;
      while (loop_42413) {
        loop_42413 = var_searching.isValid () ;
        if (loop_42413) {
          loop_42413 = var_searching.boolValue () ;
        }
        if (loop_42413 && (0 == variant_42413)) {
          loop_42413 = false ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_42834 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_42834.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_42834.current_mType (HERE), enumerator_42834.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1054))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1054)) ;
    enumerator_42834.gotoNextObject () ;
  }
...
static void categoryMethod_selfModifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_44238_0 ; // Joker input parameter
  GALGAS_string joker_44241_0 ; // Joker input parameter
  var_selfTypeProxy.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1092)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_44238_0, joker_44241_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1092)) ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_44724 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_44724.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_44724.current_mType (HERE), enumerator_44724.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1107))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1107)) ;
    enumerator_44724.gotoNextObject () ;
  }
...
static void categoryMethod_concatInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_46463 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_46463.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_46463.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1159)) ;
    enumerator_46463.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
  ...
  {
  routine_checkAssignmentTypes (var_targetType, var_expression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1176)), object->mAttribute_mInstructionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1176)) ;
  }
...
static void categoryMethod_selfConcatInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  {
  routine_checkAssignmentTypes (var_selfTypeProxy, var_expression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1219)), object->mAttribute_mInstructionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1219)) ;
  }
...
static void categoryMethod_plusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_49832 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_49832.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_49832.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1249)) ;
    enumerator_49832.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_actualOutputExpressionList enumerator_50831 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_functionSignature enumerator_50859 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_50831.hasCurrentObject () && enumerator_50859.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_50831.current_mExpression (HERE).ptr (), enumerator_50859.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1267)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_50859.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_50831.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_string temp_3 ;
          const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_50859.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_4) {
            temp_3 = GALGAS_string (":") ;
          }else if (kBoolFalse == test_4) {
            temp_3 = GALGAS_string::makeEmptyString () ;
          }
          GALGAS_location location_5 (enumerator_50831.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the selector should be '!").operator_concat (enumerator_50859.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274)).operator_concat (temp_3.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1274)) ;
        }
        {
        routine_checkAssignmentTypes (enumerator_50859.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1276)), enumerator_50831.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1276)) ;
        }
        var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1277)) ;
        enumerator_50831.gotoNextObject () ;
...
static void categoryMethod_plusEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_52348 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_52348.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_52348.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1305)) ;
  ...
  {
  routine_checkAssignmentTypes (var_targetType, var_expression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1321)), object->mAttribute_mInstructionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1321)) ;
  }
...
static void categoryMethod_selfPlusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_actualOutputExpressionList enumerator_54973 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_functionSignature enumerator_55001 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_54973.hasCurrentObject () && enumerator_55001.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_54973.current_mExpression (HERE).ptr (), enumerator_55001.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1365)) ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_55001.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_54973.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_string temp_4 ;
          const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_55001.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_5) {
            temp_4 = enumerator_55001.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1372)) ;
          }else if (kBoolFalse == test_5) {
            temp_4 = GALGAS_string::makeEmptyString () ;
          }
          GALGAS_location location_6 (enumerator_54973.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        {
        routine_checkAssignmentTypes (enumerator_55001.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1374)), enumerator_54973.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1374)) ;
        }
        var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1375)) ;
        enumerator_54973.gotoNextObject () ;
        enumerator_55001.gotoNextObject () ;
      }
...
static void categoryMethod_selfPlusEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  {
  routine_checkAssignmentTypes (var_selfTypeProxy, var_expression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1419)), object->mAttribute_mInstructionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1419)) ;
  }
...
static void categoryMethod_incrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_57940_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_57940_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1441)) ;
  }
  cEnumerator_lstringlist enumerator_57975 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_57975.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_57975.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1444)) ;
    enumerator_57975.gotoNextObject () ;
  }
...
static void categoryMethod_decrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_60327_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_60327_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1502)) ;
  }
  cEnumerator_lstringlist enumerator_60362 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_60362.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_60362.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1505)) ;
    enumerator_60362.gotoNextObject () ;
  }
...
static void categoryMethod_messageInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1569)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_logInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_logListAST enumerator_63497 (object->mAttribute_mLogList, kEnumeration_up) ;
  while (enumerator_63497.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_63497.current_mLogExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1592)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1591)) ;
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_logInstructionForGeneration::constructor_new (enumerator_63497.current_mLogMessage (HERE), var_expression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1598))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1598)) ;
...
static void categoryMethod_dropInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_64334 (object->mAttribute_mDropList, kEnumeration_up) ;
  while (enumerator_64334.hasCurrentObject ()) {
    GALGAS_string var_variableCppName ;
    GALGAS_unifiedTypeMapProxy var_t ;
    {
    GALGAS_string joker_64460_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForDropAccess (enumerator_64334.current_mValue (HERE), var_t, var_variableCppName, joker_64460_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1616)) ;
    }
    ...
    enumerator_64334.gotoNextObject () ;
  }
...
static void categoryMethod_enumeratedCollectionImplicitVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  GALGAS_enumerationDescriptorList var_enumerationDescriptorList = outArgument_outEnumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1797)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1797)) ;
  ...
  cEnumerator_enumerationDescriptorList enumerator_71216 (var_enumerationDescriptorList, kEnumeration_up) ;
  while (enumerator_71216.hasCurrentObject ()) {
    ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_71216.current_mEnumeratedType (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_71216.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1805)), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1805)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806)).operator_concat (enumerator_71216.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1803)) ;
...
static void categoryMethod_enumeratedCollectionCstListInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  GALGAS_enumerationDescriptorList var_enumerationDescriptorList = outArgument_outEnumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1828)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1828)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_enumerationDescriptorList var_currentTypedAttributeList = outArgument_outEnumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1834)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1834)) ;
      cEnumerator_enumerationDescriptorList enumerator_72679 (var_currentTypedAttributeList, kEnumeration_up) ;
      while (enumerator_72679.hasCurrentObject ()) {
        {
        ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_72679.current_mEnumerationName (HERE), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1837)), enumerator_72679.current_mEnumeratedType (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839)).operator_concat (enumerator_72679.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1839)), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840)).operator_concat (enumerator_72679.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1840)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1836)) ;
        }
        enumerator_72679.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_5) {
          ...
          cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_74013 (object->mAttribute_mElementList, kEnumeration_up) ;
          cEnumerator_enumerationDescriptorList enumerator_74040 (var_enumerationDescriptorList, kEnumeration_up) ;
          while (enumerator_74013.hasCurrentObject () && enumerator_74040.hasCurrentObject ()) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_74013.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1861)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_74013.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_74013.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1863)) ;
                const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_74040.current_mEnumeratedType (HERE))).boolEnum () ;
                if (kBoolTrue == test_10) {
                  GALGAS_location location_11 (enumerator_74013.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_11, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)).operator_concat (enumerator_74040.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1865)) ;
                }
              }
              ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_74040.current_mEnumeratedType (HERE), enumerator_74013.current_mConstantName (HERE), outArgument_outEnumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868)).operator_concat (enumerator_74040.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1868)) ;
            }
            enumerator_74013.gotoNextObject () ;
            enumerator_74040.gotoNextObject () ;
          }
        }
      }
    }
...
static void categoryMethod_enumeratedCollectionVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_enumeratedElementType = outArgument_outEnumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1892)).reader_mTypeForEnumeratedElement (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1892)) ;
...
static void categoryMethod_forInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_forInstructionEnumeratedObjectListAST enumerator_78166 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_78166.hasCurrentObject ()) {
    GALGAS_string var_enumeratorCppName ;
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeEnumeration ((const cPtr_abstractEnumeratedCollectionAST *) enumerator_78166.current_mEnumeratedCollection (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_localConstantListForDoBranch, var_enumeratorCppName, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1960)) ;
    GALGAS_string temp_0 ;
    const enumGalgasBool test_1 = enumerator_78166.current_mAscending (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
    ...
    enumerator_78166.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_localInitializedVariableList enumerator_78729 (var_localConstantListForDoBranch, kEnumeration_up) ;
  while (enumerator_78729.hasCurrentObject ()) {
    {
    ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_78729.current_mName (HERE), enumerator_78729.current_mType (HERE), enumerator_78729.current_mCppName (HERE), enumerator_78729.current_mCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 1979)) ;
    }
    enumerator_78729.gotoNextObject () ;
  }
...
static void categoryMethod_foreachInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_foreachInstructionEnumeratedObjectListAST enumerator_82504 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_82504.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_82504.current_mEnumeratedExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2094)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2093)) ;
    GALGAS_string var_enumerationOrder = enumerator_82504.current_mEnumerationOrder (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2100)) ;
    GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (enumerator_82504.current_mEndOfEnumerationExpression (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2101)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2101))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2101)) ;
    GALGAS_enumerationDescriptorList var_enumerationDescriptorList = var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2102)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2102)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringlist enumerator_83559 (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2112)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2112)), kEnumeration_up) ;
        bool bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2112)).isValidAndTrue () ;
        if (enumerator_83559.hasCurrentObject () && bool_2) {
          while (enumerator_83559.hasCurrentObject () && bool_2) {
            var_found = GALGAS_bool (kIsEqual, var_enumerationOrder.objectCompare (enumerator_83559.current_mValue (HERE))) ;
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  \\").operator_concat (enumerator_83559.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2114))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2114)) ;
            enumerator_83559.gotoNextObject () ;
            if (enumerator_83559.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_82504.current_mEnumerationOrder (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_82504.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2121)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (enumerator_82504.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2121)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2121)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_enumerationDescriptorList var_currentTypedAttributeList = var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2122)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2122)) ;
        cEnumerator_enumerationDescriptorList enumerator_84062 (var_currentTypedAttributeList, kEnumeration_up) ;
        while (enumerator_84062.hasCurrentObject ()) {
          {
          ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_82504.current_mPrefix (HERE).mAttribute_string.operator_concat (enumerator_84062.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2125)), enumerator_82504.current_mEndOfEnumerationExpression (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2125)), enumerator_84062.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)).operator_concat (enumerator_84062.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2127)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128)).operator_concat (enumerator_84062.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2128)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2124)) ;
          }
          enumerator_84062.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = enumerator_82504.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_82504.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2131)).boolEnum () ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_9) {
            ...
            inCompiler->emitSemanticError (enumerator_82504.current_mEndOfElementList (HERE), GALGAS_string ("the '@").operator_concat (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).operator_concat (GALGAS_string ("' type requires ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).operator_concat (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2141)).operator_concat (GALGAS_string (" argument")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142)).operator_concat (temp_10  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2142)).operator_concat (GALGAS_string (" or less for enumeration: this list provides ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2143)).operator_concat (enumerator_82504.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2145))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2144))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2140)) ;
          }else if (kBoolFalse == test_9) {
            cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_85432 (enumerator_82504.current_mElementList (HERE), kEnumeration_up) ;
            cEnumerator_enumerationDescriptorList enumerator_85459 (var_enumerationDescriptorList, kEnumeration_up) ;
            while (enumerator_85432.hasCurrentObject () && enumerator_85459.hasCurrentObject ()) {
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_85432.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2149)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_85432.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_85432.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2151)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_85459.current_mEnumeratedType (HERE))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    GALGAS_location location_15 (enumerator_85432.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_15, GALGAS_string ("incorrect '@").operator_concat (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)).operator_concat (GALGAS_string ("' type: '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)).operator_concat (enumerator_85459.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)).operator_concat (GALGAS_string ("' type required here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2153)) ;
                  }
                }
                {
                ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_85432.current_mConstantName (HERE), enumerator_85459.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159)).operator_concat (enumerator_85459.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2159)), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)).operator_concat (enumerator_85459.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2160)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2156)) ;
                }
              }
              enumerator_85432.gotoNextObject () ;
              enumerator_85459.gotoNextObject () ;
            }
          }
        }
      }
    ...
    enumerator_82504.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_uncheckedWhileExpression ;
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_castInstructionBranchListAST enumerator_91417 (object->mAttribute_mCastInstructionBranchList, kEnumeration_up) ;
  while (enumerator_91417.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_91417.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2316)) ;
    GALGAS_unifiedTypeMapProxy var_t = var_type ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_castExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2319)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).isValid ()) {
      uint32_t variant_91705 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2320)).uintValue () ;
      bool loop_91705 = true ;
      while (loop_91705) {
        ...
        if (loop_91705) {
          ...
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_castExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2323)))) ;
        }
      }
    }
    const enumGalgasBool test_0 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2325)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_91417.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (enumerator_91417.current_mTypeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327)).operator_concat (var_castExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2327))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2326)) ;
    }
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_91417.current_mConstantVarName (HERE).mAttribute_string.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2333)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_localConstantName = GALGAS_string ("cast_").operator_concat (enumerator_91417.current_mConstantVarName (HERE).reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)).operator_concat (enumerator_91417.current_mConstantVarName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2334)) ;
      var_localConstantList.addAssign_operation (var_type, enumerator_91417.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2335)) ;
    }else if (kBoolFalse == test_2) {
      var_localConstantName = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2349)), enumerator_91417.current_mInstructionList (HERE), enumerator_91417.current_mEndOfInstructions (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2346)) ;
    }
    var_castBranchList.addAssign_operation (enumerator_91417.current_mTypeComparisonKind (HERE), var_type, var_localConstantName, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2355)) ;
    enumerator_91417.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  {
  GALGAS_string joker_95624_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_95624_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2425)) ;
  }
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_99186_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_99186_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2494)) ;
  ...
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2526)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLStringType)).boolEnum () ;
    if (kBoolTrue == test_1) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_sourceExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2531)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
    if (kBoolTrue == test_2) {
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_101178 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_101178.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_101178.current_mType (HERE), enumerator_101178.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2548)) ;
    enumerator_101178.gotoNextObject () ;
  }
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2595)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_102931 (var_receiverType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2599)), kEnumeration_up) ;
    bool bool_1 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2599)).isValidAndTrue () ;
    if (enumerator_102931.hasCurrentObject () && bool_1) {
      while (enumerator_102931.hasCurrentObject () && bool_1) {
        var_found = GALGAS_bool (kIsEqual, enumerator_102931.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_102931.gotoNextObject () ;
        if (enumerator_102931.hasCurrentObject ()) {
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_keyExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2686)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2686)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
    if (kBoolTrue == test_1) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_keyExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2689)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2689)).objectCompare (GALGAS_string ("lstring"))).boolEnum () ;
    if (kBoolTrue == test_2) {
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_106929_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_106929_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2695)) ;
  }
  cEnumerator_lstringlist enumerator_106957 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_106957.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_106957.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2703)) ;
    enumerator_106957.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_4) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_107489 (var_targetType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2712)), kEnumeration_up) ;
    bool bool_5 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2712)).isValidAndTrue () ;
    if (enumerator_107489.hasCurrentObject () && bool_5) {
      while (enumerator_107489.hasCurrentObject () && bool_5) {
        var_found = GALGAS_bool (kIsEqual, enumerator_107489.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_107489.gotoNextObject () ;
        if (enumerator_107489.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_108043 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2723)), kEnumeration_up) ;
  while (enumerator_108043.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_108043.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.operator_concat (enumerator_108043.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2726)), var_objectArrayCppName.operator_concat (GALGAS_string ("->mAttribute_")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727)).operator_concat (enumerator_108043.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2727))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2724)) ;
    enumerator_108043.gotoNextObject () ;
  }
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_constantIndexMap var_enumConstantMap = var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2794)).reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2794)) ;
  ...
  cEnumerator_switchBranchesAST enumerator_110892 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_110892.hasCurrentObject ()) {
    ...
    cEnumerator_lstringlist enumerator_111052 (enumerator_110892.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_111052.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantMap.reader_hasKey (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2803)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2803)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2804)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_111052.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2806)).operator_concat (GALGAS_string ("' constant is already named in this switch instruction")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2806))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2805)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2809)) ;
        GALGAS_unifiedTypeMapProxyList var_associatedTypeList ;
        GALGAS_uint joker_111435_0 ; // Joker input parameter
        var_enumConstantMap.method_searchKey (enumerator_111052.current_mValue (HERE), joker_111435_0, var_associatedTypeList, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2810)) ;
        const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, enumerator_110892.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2811)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_location location_5 (enumerator_111052.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the associated values of '").operator_concat (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813)).operator_concat (GALGAS_string ("' constant should be extracted")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2813))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2812)) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_110892.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2815)).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_location location_7 (enumerator_111052.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2817))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2817)).operator_concat (GALGAS_string ("' constant has no associated value")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2817))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2816)) ;
          }else if (kBoolFalse == test_6) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2819)).objectCompare (enumerator_110892.current_mAssociatedValuesExtraction (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2819)))).boolEnum () ;
            if (kBoolTrue == test_8) {
              ...
              GALGAS_location location_11 (enumerator_111052.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_11, GALGAS_string ("the '").operator_concat (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).operator_concat (GALGAS_string ("' constant requires ").add_operation (var_associatedTypeList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).add_operation (GALGAS_string ("  associated value"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821)).add_operation (temp_9, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2821))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2820)) ;
            }else if (kBoolFalse == test_8) {
              cEnumerator_unifiedTypeMapProxyList enumerator_112258 (var_associatedTypeList, kEnumeration_up) ;
              cEnumerator__32_lstringlist enumerator_112293 (enumerator_110892.current_mAssociatedValuesExtraction (HERE), kEnumeration_up) ;
              while (enumerator_112258.hasCurrentObject () && enumerator_112293.hasCurrentObject ()) {
                const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_112293.current_mValue_30_ (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_112258.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2827)).objectCompare (enumerator_112293.current_mValue_30_ (HERE).mAttribute_string)).boolEnum () ;
                  if (kBoolTrue == test_13) {
                    GALGAS_location location_14 (enumerator_112293.current_mValue_30_ (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_14, GALGAS_string ("the required type is '@").operator_concat (enumerator_112258.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2828)) ;
                  }
                }
                const enumGalgasBool test_15 = var_firstConstant.operator_and (GALGAS_bool (kIsNotEqual, enumerator_112293.current_mValue_31_ (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2831)).boolEnum () ;
                if (kBoolTrue == test_15) {
                  GALGAS_string var_cppName = GALGAS_string ("extractedValue_").add_operation (enumerator_112293.current_mValue_31_ (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2832)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2832)) ;
                  var_extractedAssociatedValuesForGeneration.addAssign_operation (enumerator_112258.current_mType (HERE), var_cppName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2833)) ;
                  {
                  ioArgument_ioVariableMap.modifier_insertLocalConstant (enumerator_112293.current_mValue_31_ (HERE), enumerator_112258.current_mType (HERE), var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2834)) ;
                  }
                }
                enumerator_112258.gotoNextObject () ;
                enumerator_112293.gotoNextObject () ;
              }
            }
          }
        }
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_16 (enumerator_111052.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_16, GALGAS_string ("'").operator_concat (enumerator_111052.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).operator_concat (GALGAS_string ("' is not a constant of '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2839)) ;
      }
      var_firstConstant = GALGAS_bool (false) ;
      enumerator_111052.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2847)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2848)), enumerator_110892.current_mInstructions (HERE), enumerator_110892.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2845)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_110892.current_mSwitchConstantList (HERE), var_extractedAssociatedValuesForGeneration, enumerator_110892.current_mEndOfBranch (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2854)), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2854)) ;
    enumerator_110892.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_113819 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_113819.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").operator_concat (enumerator_113819.current_key (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2862))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2862)) ;
      enumerator_113819.gotoNextObject () ;
    }
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_semanticExpressionListAST enumerator_114699 (object->mAttribute_mMatchedExpressionList, kEnumeration_up) ;
  while (enumerator_114699.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_matchedExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_114699.current_mExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2890)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_matchedExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2889)) ;
    ...
    GALGAS_unifiedTypeMapProxy var_type = var_matchedExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2897)) ;
    ...
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_114699.current_mEndOfExpressionLocation (HERE), GALGAS_string ("this expression is an instance of '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2900))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2900)).operator_concat (GALGAS_string ("' type, but this type is neither an enumeration, neither a class")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2900))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2899)) ;
    }
    enumerator_114699.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_matchInstructionBranchListAST enumerator_115599 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_115599.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911)).objectCompare (enumerator_115599.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2911)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_115833 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_115850 (enumerator_115599.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_115833.hasCurrentObject () && enumerator_115850.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_115833.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2913)) ;
        ...
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_115850.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2916)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            ...
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).isValid ()) {
              uint32_t variant_116244 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2919)).uintValue () ;
              bool loop_116244 = true ;
              while (loop_116244) {
                loop_116244 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).isValid () ;
                if (loop_116244) {
                  loop_116244 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2920)).boolValue () ;
                }
                if (loop_116244 && (0 == variant_116244)) {
                  loop_116244 = false ;
            ...
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").operator_concat (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2926))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2925)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_115850.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2928)).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2928)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_115850.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2929)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").operator_concat (enumerator_115833.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933)).operator_concat (GALGAS_string ("' class is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2933))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2932)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)), enumerator_115850.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2936)) ;
        }else if (kBoolFalse == test_2) {
          ...
          if (kBoolTrue == test_8) {
            const enumGalgasBool test_9 = enumerator_115850.current_mIsType (HERE).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_location location_10 (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_10, GALGAS_string ("a constant of the '@").operator_concat (enumerator_115833.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940)).operator_concat (GALGAS_string ("' enumeration type is expected here")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2940))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2939)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = var_type.reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)).reader_hasKey (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2942)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).operator_concat (GALGAS_string ("' symbol is not a constant of the '@")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).operator_concat (enumerator_115833.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2944))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2943)) ;
              }
            }
            var_matchListForGeneration.addAssign_operation (GALGAS_bool (false), enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2949)), enumerator_115833.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2950)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2950))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2947)) ;
          }else if (kBoolFalse == test_8) {
            GALGAS_location location_13 (enumerator_115850.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_115833.gotoNextObject () ;
        enumerator_115850.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_115599.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").operator_concat (var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)).operator_concat (GALGAS_string (" elements, but it acually contains ")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958)).operator_concat (enumerator_115599.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2959)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2959))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2958))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2957)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2967)), enumerator_115599.current_mMatchBranchInstructionList (HERE), enumerator_115599.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.gSemantics", 2964)) ;
    }
    ...
    enumerator_115599.gotoNextObject () ;
  }
