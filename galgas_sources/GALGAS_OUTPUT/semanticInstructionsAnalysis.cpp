  ...
  if (operand_53484 != NULL) {
    ...
    GGS_localInitializedVariableList  var_cas_localInitializedVariableList = GGS_localInitializedVariableList ::constructor_emptyList () ;
    {
      ...
      while (((operand_56161 = enumerator_56161.nextObject ()))) {
        ...
        var_cas_localInitializedVariableList.addAssign_operation (operand_56161->mAttributeTypeIndex, GGS_lstring ::constructor_new (inLexique, (operand_53484->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476))).operator_concat (operand_56161->mAttributeName), operand_53484->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)) COMMA_SOURCE_FILE_AT_LINE (1476)), ((var_cas_objectArrayCppName).operator_concat (GGS_string ("->mAttribute_"))).operator_concat (operand_56161->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_57631,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57631 != NULL) {
    operand_57631->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unhandled instruction @readAccessWithInstructionAST") COMMA_SOURCE_FILE_AT_LINE (1528)) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_switchInstructionAST * operand_58089,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58089 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_58089->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58089->mSwitchExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1540)) ;
      }
    }
    const GGS_bool cond_58834 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1547))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1547))) ;
    if (cond_58834.isBuiltAndTrue ()) {
      operand_58089->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1550)) ;
    }
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_59183 (operand_58089->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_59183 = NULL ;
      while (((operand_59183 = enumerator_59183.nextObject ()))) {
        macroValidPointer (operand_59183) ;
        {
          GGS_lstringlist::cEnumerator enumerator_59218 (operand_59183->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_59218 = NULL ;
          while (((operand_59218 = enumerator_59218.nextObject ()))) {
            macroValidPointer (operand_59218) ;
            const GGS_bool cond_59573 = var_cas_enumConstantStringSet.reader_hasKey (operand_59218->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1559))) ;
            if (cond_59573.isBuiltAndTrue ()) {
              const GGS_bool cond_59493 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_59218->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1560))) ;
              if (cond_59493.isBuiltAndTrue ()) {
                operand_59218->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_59218->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1564)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_59218->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565))) ;
            }else if (cond_59573.isBuiltAndFalse ()) {
              operand_59218->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_59218->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1570)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_59183->mInstructions,  operand_59183->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1573)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_59183->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_58089->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1585)) ;
    ...
    const GGS_bool cond_60651 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_60651.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_60457 (var_cas_forgottenConstants, true) ;
        while (enumerator_60457.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_60457._key (HERE)) ;
          enumerator_60457.next () ;
        }
      }
      operand_58089->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1596)) ;
    }
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_Compiler & inLexique,
                                const cPtr_matchInstructionAST * operand_60974,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60974 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_61259 (operand_60974->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_61259 = NULL ;
      while (((operand_61259 = enumerator_61259.nextObject ()))) {
        macroValidPointer (operand_61259) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_61259->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_61259->mExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1616)) ;
          }
        }
        ...
        const GGS_bool cond_61956 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1625))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1625))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))) ;
        if (cond_61956.isBuiltAndTrue ()) {
          operand_61259->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1627)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1629)) ;
        }
      }
    }
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_62171 (operand_60974->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_62171 = NULL ;
      while (((operand_62171 = enumerator_62171.nextObject ()))) {
        macroValidPointer (operand_62171) ;
        GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
        GGS_matchListForGeneration  var_cas_matchListForGeneration = GGS_matchListForGeneration ::constructor_emptyList () ;
        const GGS_bool cond_64679 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_62171->mMatchEntryList.reader_length ()) ;
        if (cond_64679.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_62405 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_62405 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_62422 (operand_62171->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_62422 = NULL ;
            while (((operand_62405 = enumerator_62405.nextObject ()))
                && ((operand_62422 = enumerator_62422.nextObject ()))) {
              macroValidPointer (operand_62405) ;
              macroValidPointer (operand_62422) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_62405->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)) ;
              const GGS_bool cond_63786 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1641))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1641))) ;
              if (cond_63786.isBuiltAndTrue ()) {
                const GGS_bool cond_63467 = operand_62422->mIsType ;
                if (cond_63467.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_62422->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1643)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_63013 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1646)) ;
                  GGS_bool _condition_63013 (_variant_63013.isBuilt (), true) ;
                  while (_condition_63013.isBuiltAndTrue ()) {
                    _condition_63013 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1647))).operator_not ()) ;
                    if (_condition_63013.isBuiltAndTrue ()) {
                      if (_variant_63013.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1650)) ;
                        _condition_63013 = GGS_bool (false) ;
                      }else{
                        _variant_63013.decrement_operation (inLexique COMMA_HERE) ;
                  ...
                  const GGS_bool cond_63283 = (var_cas_found).operator_not () ;
                  if (cond_63283.isBuiltAndTrue ()) {
                    operand_62422->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_62422->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1653)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1655)) ;
                  }else if (cond_63283.isBuiltAndFalse ()) {
                    const GGS_bool cond_63447 = (operand_62422->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_63447.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_62422->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_63467.isBuiltAndFalse ()) {
                  operand_62422->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_62405->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1662)) ;
                }
                var_cas_matchListForGeneration.addAssign_operation (GGS_bool (true), operand_62422->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), operand_62422->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663))) ;
              }else if (cond_63786.isBuiltAndFalse ()) {
                const GGS_bool cond_64562 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))) ;
                if (cond_64562.isBuiltAndTrue ()) {
                  const GGS_bool cond_64063 = operand_62422->mIsType ;
                  if (cond_64063.isBuiltAndTrue ()) {
                    operand_62422->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_62405->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1669)) ;
                  }else if (cond_64063.isBuiltAndFalse ()) {
                    const GGS_bool cond_64381 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)).reader_hasKey (operand_62422->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)))).operator_not () ;
                    if (cond_64381.isBuiltAndTrue ()) {
                      operand_62422->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_62422->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_62405->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1673)) ;
                    }
                  }
                  var_cas_matchListForGeneration.addAssign_operation (GGS_bool (false), operand_62422->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_62405->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1677)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1677))) ;
                }else if (cond_64562.isBuiltAndFalse ()) {
                  operand_62422->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (1681)) ;
                }
              }
            }
          }
        }else if (cond_64679.isBuiltAndFalse ()) {
          operand_62171->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1685)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_62171->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1686))) COMMA_SOURCE_FILE_AT_LINE (1688)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_62171->mMatchBranchInstructionList,  operand_62171->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1691)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_60974->mElseInstructionList,  operand_60974->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1706)) ;
    var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_60974->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1717)) ;
