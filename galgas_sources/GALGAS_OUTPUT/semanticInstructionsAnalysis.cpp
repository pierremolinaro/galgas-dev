...
static void categoryMethod_plusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_semanticExpressionListAST enumerator_49560 (object->mAttribute_mExpressions, kEnumeration_up) ;
...
static void categoryMethod_selfPlusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticExpressionListAST enumerator_53463 (object->mAttribute_mExpressions, kEnumeration_up) ;
