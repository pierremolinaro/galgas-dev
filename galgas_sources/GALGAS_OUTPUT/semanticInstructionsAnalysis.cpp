...
//                    november 11th, 2010, at 20h34'47"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__foreachInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
  ...
  if (operand_46935 != NULL) {
    ...
    const GGS_bool cond_51527 = (operand_46935->mIndexVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1295))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_51527.isBuiltAndTrue ()) {
...
category_method__loopInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_loopInstructionAST * operand_53204,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53204 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_variantExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_53204->mVariantExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_53204->mVariantExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_variantExpression COMMA_SOURCE_FILE_AT_LINE (1364)) ;
      }
    }
    const GGS_bool cond_53890 = (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1370))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mUIntType) ;
    if (cond_53890.isBuiltAndTrue ()) {
      operand_53204->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type should be '@")).operator_concat (var_cas_inAnalysisContext.mPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_variantExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1373)) ;
    }
    GGS_semanticExpressionForGeneration  var_cas_loopExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_53204->mLoopExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_53204->mLoopExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_loopExpression COMMA_SOURCE_FILE_AT_LINE (1376)) ;
      }
    }
    const GGS_bool cond_54409 = (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1382))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mBoolType) ;
    if (cond_54409.isBuiltAndTrue ()) {
      operand_53204->mEndOfLoopExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the loop expression type should be '@")).operator_concat (var_cas_inAnalysisContext.mPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)))).operator_concat (GGS_string ("', but it has '@"))).operator_concat (var_cas_loopExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (1385)) ;
    }
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_53204->mFirstInstructions,  operand_53204->mEndOfFirstInstructions,  var_cas_ioVariableMap,  var_cas_first_instructionList COMMA_SOURCE_FILE_AT_LINE (1390)) ;
    GGS_semanticInstructionListForGeneration  var_cas_second_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_53204->mSecondInstructions,  operand_53204->mEndOfSecondInstructions,  var_cas_ioVariableMap,  var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1401)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_53204->mEndOfLoopInstruction COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_loopInstructionForGeneration ::constructor_new (inLexique, operand_53204->mInstructionLocation, var_cas_variantExpression, var_cas_first_instructionList, var_cas_loopExpression, var_cas_second_instructionList COMMA_SOURCE_FILE_AT_LINE (1413))) ;
  }
}
...
category_method__structuredCastInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_structuredCastInstructionAST * operand_55643,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55643 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_castExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_55643->mCastExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_55643->mCastExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_castExpression COMMA_SOURCE_FILE_AT_LINE (1431)) ;
      }
    }
    ...
    {
      GGS_castInstructionBranchListAST::cEnumerator enumerator_56195 (operand_55643->mCastInstructionBranchList, true) ;
      const GGS_castInstructionBranchListAST::cElement * operand_56195 = NULL ;
      while (((operand_56195 = enumerator_56195.nextObject ()))) {
        macroValidPointer (operand_56195) ;
        const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, operand_56195->mTypeName COMMA_SOURCE_FILE_AT_LINE (1442)) ;
        ...
        GGS_uint _variant_56676 = var_cas_inAnalysisContext.mSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1446)) ;
        GGS_bool _condition_56676 (_variant_56676.isBuilt (), true) ;
        while (_condition_56676.isBuiltAndTrue ()) {
          _condition_56676 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1447)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1447))).operator_not ()) ;
          if (_condition_56676.isBuiltAndTrue ()) {
            if (_variant_56676.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1450)) ;
              _condition_56676 = GGS_bool (false) ;
            }else{
              _variant_56676.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_57324 = (operand_56195->mConstantVarName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_57324.isBuiltAndTrue ()) {
          var_cas_localConstantName = (((GGS_string ("cast_")).operator_concat (operand_56195->mConstantVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1460)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1460)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1460)))).operator_concat (GGS_string ("_"))).operator_concat (operand_56195->mConstantVarName) ;
          var_cas_localConstantList.addAssign_operation (var_cas_type, operand_56195->mConstantVarName, operand_56195->mConstantVarNameIsUnused, var_cas_localConstantName) ;
        }else if (cond_57324.isBuiltAndFalse ()) {
          var_cas_localConstantName = GGS_string ("") ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_56195->mInstructionList,  operand_56195->mEndOfInstructions,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1472)) ;
        var_cas_castBranchList.addAssign_operation (operand_56195->mUseKindOfClass, var_cas_type, var_cas_localConstantName, var_cas_instructionList) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_55643->mElseInstructionList,  operand_55643->mEndOfCastInstruction,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1485)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_55643->mEndOfCastInstruction COMMA_SOURCE_FILE_AT_LINE (1495)) ;
...
category_method__grammarInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_grammarInstructionAST * operand_58558,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58558 != NULL) {
    GGS_grammarLabelMap  var_cas_grammarLabelMap ;
    if (var_cas_inAnalysisContext.mSemanticContext.mGrammarMap.isBuilt ()) {
      var_cas_inAnalysisContext.mSemanticContext.mGrammarMap (HERE)->method_searchKey (inLexique, operand_58558->mGrammarComponentName, var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (1513)) ;
    }
    GGS_formalParameterSignature  var_cas_labelSignature ;
    if (var_cas_grammarLabelMap.isBuilt ()) {
      var_cas_grammarLabelMap (HERE)->method_searchKey (inLexique, operand_58558->mLabelName, var_cas_labelSignature COMMA_SOURCE_FILE_AT_LINE (1519)) ;
    }
    GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
    ::routine_analyzeRoutineArguments (inLexique,  var_cas_inAnalysisContext,  operand_58558->mLabelName,  ((GGS_string ("label of the ")).operator_concat (operand_58558->mGrammarComponentName)).operator_concat (GGS_string (" grammar")),  var_cas_labelSignature,  operand_58558->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1525)) ;
    GGS_semanticExpressionForGeneration  var_cas_sourceExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_58558->mSourceExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58558->mSourceExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_sourceExpression COMMA_SOURCE_FILE_AT_LINE (1536)) ;
      }
    }
    const GGS_bool cond_59968 = operand_58558->mSourceExpressionIsFile ;
    if (cond_59968.isBuiltAndTrue ()) {
      const GGS_bool cond_59955 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1543))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mLStringType) ;
      if (cond_59955.isBuiltAndTrue ()) {
        operand_58558->mEndOfSourceExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is the source file path and its type should be '@lstring', but it is '@")).operator_concat (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1545)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1545)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1547)) ;
      }
    }else if (cond_59968.isBuiltAndFalse ()) {
      const GGS_bool cond_60225 = (var_cas_sourceExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1548))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mStringType) ;
    ...
    const GGS_bool cond_60553 = operand_58558->mSourceExpressionIsFile ;
    if (cond_60553.isBuiltAndTrue ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceFileForGeneration ::constructor_new (inLexique, operand_58558->mInstructionLocation, operand_58558->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1557)), operand_58558->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1558)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1555))) ;
    }else if (cond_60553.isBuiltAndFalse ()) {
      var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_grammarInstructionWithSourceExpressionForGeneration ::constructor_new (inLexique, operand_58558->mInstructionLocation, operand_58558->mGrammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565)), operand_58558->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1566)), var_cas_sourceExpression, var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1563))) ;
    }
  }
}
...
category_method__readWriteAccessWithInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_readWriteAccessWithInstructionAST * operand_60997,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60997 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_60997->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_60997->mKeyExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1582)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_60997->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1588)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1588))) ;
    GGS_unifiedTypeMapProxy  var_cas_targetType ;
    GGS_string var_cas_receiverVariableCppName ;
    GGS_string automatic_var_61682_0 ;
    var_cas_ioVariableMap.modifier_searchForReadWriteAccess (inLexique, operand_60997->mReceiverName, var_cas_targetType, var_cas_receiverVariableCppName, automatic_var_61682_0 COMMA_SOURCE_FILE_AT_LINE (1592)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_61705 (operand_60997->mFieldList, true) ;
      const GGS_lstringlist::cElement * operand_61705 = NULL ;
      while (((operand_61705 = enumerator_61705.nextObject ()))) {
        macroValidPointer (operand_61705) ;
        ...
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_61705->mValue, var_cas_targetType COMMA_SOURCE_FILE_AT_LINE (1595)) ;
        }
      }
    }
    ...
    elementOf_GGS_withAccessorMap * operand_62031 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_60997->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1600))) ;
    if (NULL != operand_62031) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_62031->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_62344 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_62344.isBuiltAndTrue ()) {
        operand_60997->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1608)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_62344.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_62398 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_62398 = NULL ;
          while (((operand_62398 = enumerator_62398.nextObject ()))) {
            macroValidPointer (operand_62398) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_62398->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_62398->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1611))) ;
          }
        }
        operand_60997->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_60997->mAccessName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1619)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    ...
    const GGS_bool cond_63265 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_63265.isBuiltAndTrue ()) {
      operand_60997->mAccessName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_60997->mAccessName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_targetType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1624)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1626)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1627)) ;
    }else if (cond_63265.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_63301 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_63301 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_63319 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_63319 = NULL ;
        while (((operand_63301 = enumerator_63301.nextObject ()))
            && ((operand_63319 = enumerator_63319.nextObject ()))) {
          macroValidPointer (operand_63301) ;
          macroValidPointer (operand_63319) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_63319->mType,  operand_63301->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1629)),  operand_60997->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1629)) COMMA_SOURCE_FILE_AT_LINE (1629)) ;
        }
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_63614 (var_cas_targetType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1636)), true) ;
      const GGS_typedAttributeList::cElement * operand_63614 = NULL ;
      while (((operand_63614 = enumerator_63614.nextObject ()))) {
        macroValidPointer (operand_63614) ;
        var_cas_localInitializedVariableList.addAssign_operation (operand_63614->mAttributeTypeProxy, GGS_lstring ::constructor_new (inLexique, (operand_60997->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1639))).operator_concat (operand_63614->mAttributeName), operand_60997->mAccessName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1639)) COMMA_SOURCE_FILE_AT_LINE (1639)), ((var_cas_objectArrayCppName).operator_concat (GGS_string ("->mAttribute_"))).operator_concat (operand_63614->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  var_cas_localInitializedVariableList,  operand_60997->m_do_Instructions,  operand_60997->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1644)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_60997->m_else_Instructions,  operand_60997->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1655)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_60997->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1664)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readWriteWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverVariableCppName, var_cas_targetType, operand_60997->mFieldList, operand_60997->mAccessName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1670)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1666))) ;
  }
}
...
category_method__readAccessWithInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_readAccessWithInstructionAST * operand_65040,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65040 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_receiverExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_65040->mReceiverExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_65040->mReceiverExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_receiverExpression COMMA_SOURCE_FILE_AT_LINE (1687)) ;
      }
    }
    ...
    GGS_semanticExpressionForGeneration  var_cas_keyExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_65040->mKeyExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_65040->mKeyExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_keyExpression COMMA_SOURCE_FILE_AT_LINE (1695)) ;
      }
    }
    const GGS_string var_cas_objectArrayCppName = (GGS_string ("objectArray_")).operator_concat (operand_65040->mInstructionLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1701))) ;
    ...
    GGS_unifiedTypeMapProxyList  var_cas_argumentTypeList ;
    elementOf_GGS_withAccessorMap * operand_65980 = (elementOf_GGS_withAccessorMap *) var_cas_withAccessorMap.searchForReadWithInstruction (operand_65040->mSearchMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1705))) ;
    if (NULL != operand_65980) {
      var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_listWithValue (operand_65980->mInfo.mArgumentType) ;
    }else{
      const GGS_bool cond_66307 = (var_cas_withAccessorMap.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_66307.isBuiltAndTrue ()) {
        operand_65040->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_receiverType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1710)))).operator_concat (GGS_string ("' type cannot be used in a 'with' instruction")) COMMA_SOURCE_FILE_AT_LINE (1713)) ;
        var_cas_argumentTypeList.drop () ;
      }else if (cond_66307.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_withAccessorMap::cEnumerator enumerator_66361 (var_cas_withAccessorMap, true) ;
          const GGS_withAccessorMap::cElement * operand_66361 = NULL ;
          while (((operand_66361 = enumerator_66361.nextObject ()))) {
            macroValidPointer (operand_66361) ;
            var_cas_s.appendCString ("\n"
              "  - ") ;
            var_cas_s.dotAssign_operation (operand_66361->mKey) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_66361->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1716))) ;
          }
        }
        operand_65040->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((GGS_string ("the '@")).operator_concat (var_cas_receiverType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1719)))).operator_concat (GGS_string ("' type does not define the '"))).operator_concat (operand_65040->mSearchMethodName)).operator_concat (GGS_string ("' accessor for the 'with' instruction; available "))).operator_concat ((((var_cas_withAccessorMap.reader_count ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("accessors are")) : (GGS_string ("accessor is"))))).operator_concat (GGS_string (":"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1724)) ;
        var_cas_argumentTypeList.drop () ;
      }
    }
    const GGS_semanticExpressionListForGeneration  var_cas_effectiveExpressionList = GGS_semanticExpressionListForGeneration ::constructor_listWithValue (var_cas_keyExpression) ;
    const GGS_bool cond_67256 = (var_cas_effectiveExpressionList.reader_length ()).operator_isNotEqual (var_cas_argumentTypeList.reader_length ()) ;
    if (cond_67256.isBuiltAndTrue ()) {
      operand_65040->mSearchMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_65040->mSearchMethodName)).operator_concat (GGS_string ("' accessor of '@"))).operator_concat (var_cas_receiverType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1729)))).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_argumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1730)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (var_cas_effectiveExpressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1731)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (1732)) ;
    }else if (cond_67256.isBuiltAndFalse ()) {
      {
        GGS_semanticExpressionListForGeneration::cEnumerator enumerator_67292 (var_cas_effectiveExpressionList, true) ;
        const GGS_semanticExpressionListForGeneration::cElement * operand_67292 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_67310 (var_cas_argumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_67310 = NULL ;
        while (((operand_67292 = enumerator_67292.nextObject ()))
            && ((operand_67310 = enumerator_67310.nextObject ()))) {
          macroValidPointer (operand_67292) ;
          macroValidPointer (operand_67310) ;
          ::routine_checkAssignmentTypes (inLexique,  operand_67310->mType,  operand_67292->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1734)),  operand_65040->mSearchMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1734)) ;
        }
      }
    }
    var_cas_ioVariableMap.modifier_openOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1738)) ;
    GGS_localConstantList  var_cas_localConstantList = GGS_localConstantList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_67589 (var_cas_receiverType.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1741)), true) ;
      const GGS_typedAttributeList::cElement * operand_67589 = NULL ;
      while (((operand_67589 = enumerator_67589.nextObject ()))) {
        macroValidPointer (operand_67589) ;
        var_cas_localConstantList.addAssign_operation (operand_67589->mAttributeTypeProxy, GGS_lstring ::constructor_new (inLexique, (operand_65040->mPrefix.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1744))).operator_concat (operand_67589->mAttributeName), operand_65040->mSearchMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1744)) COMMA_SOURCE_FILE_AT_LINE (1744)), GGS_bool (true), ((var_cas_objectArrayCppName).operator_concat (GGS_string ("->mAttribute_"))).operator_concat (operand_67589->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
      }
    }
    GGS_semanticInstructionListForGeneration  var_cas_do_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_65040->mDoBranchInstructions,  operand_65040->mEndOf_do_instructions,  var_cas_ioVariableMap,  var_cas_do_instructionList COMMA_SOURCE_FILE_AT_LINE (1750)) ;
    GGS_semanticInstructionListForGeneration  var_cas_else_instructionList ;
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_65040->mElseBranchInstructions,  operand_65040->mEndOf_else_instructions,  var_cas_ioVariableMap,  var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1761)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_65040->mEndOf_else_instructions COMMA_SOURCE_FILE_AT_LINE (1770)) ;
    var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_readOnlyWithInstructionForGeneration ::constructor_new (inLexique, var_cas_receiverExpression, operand_65040->mSearchMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1774)), var_cas_objectArrayCppName, var_cas_keyExpression, var_cas_do_instructionList, var_cas_else_instructionList COMMA_SOURCE_FILE_AT_LINE (1772))) ;
  }
}
...
category_method__switchInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_switchInstructionAST * operand_69016,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69016 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_69016->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_69016->mSwitchExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1791)) ;
      }
    }
    const GGS_bool cond_69699 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1797)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1797))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1797))) ;
    if (cond_69699.isBuiltAndTrue ()) {
      operand_69016->mEndOfSwitchExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the switch expression type should be an instance of an enumeration type (the '@")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1799)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1799)))).operator_concat (GGS_string ("' type is not an enumeration type)")) COMMA_SOURCE_FILE_AT_LINE (1800)) ;
    }
    ...
    var_cas_ioVariableMap.modifier_openOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1805)) ;
    ...
    {
      GGS_switchBranchesAST::cEnumerator enumerator_70047 (operand_69016->mBranches, true) ;
      const GGS_switchBranchesAST::cElement * operand_70047 = NULL ;
      while (((operand_70047 = enumerator_70047.nextObject ()))) {
        macroValidPointer (operand_70047) ;
        {
          GGS_lstringlist::cEnumerator enumerator_70082 (operand_70047->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_70082 = NULL ;
          while (((operand_70082 = enumerator_70082.nextObject ()))) {
            macroValidPointer (operand_70082) ;
            const GGS_bool cond_70437 = var_cas_enumConstantStringSet.reader_hasKey (operand_70082->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1809))) ;
            if (cond_70437.isBuiltAndTrue ()) {
              const GGS_bool cond_70357 = var_cas_constantsNamedInSwitchInstruction.reader_hasKey (operand_70082->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1810))) ;
              if (cond_70357.isBuiltAndTrue ()) {
                operand_70082->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_70082->mValue)).operator_concat (GGS_string ("' constant is already named in this switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1814)) ;
              }
              var_cas_constantsNamedInSwitchInstruction.addAssign_operation (operand_70082->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1815))) ;
            }else if (cond_70437.isBuiltAndFalse ()) {
              operand_70082->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("'")).operator_concat (operand_70082->mValue)).operator_concat (GGS_string ("' is not a constant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1820)) ;
            }
          }
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_70047->mInstructions,  operand_70047->mEndOfBranch,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1823)) ;
        var_cas_switchBranchesForGeneration.addAssign_operation (operand_70047->mSwitchConstantList, var_cas_instructionList) ;
      }
    }
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_69016->mEndOf_switch_instruction COMMA_SOURCE_FILE_AT_LINE (1834)) ;
    ...
    const GGS_bool cond_71492 = (var_cas_forgottenConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_71492.isBuiltAndTrue ()) {
      GGS_string var_cas_s = GGS_string ("") ;
      {
        GGS_stringset::cEnumerator enumerator_71298 (var_cas_forgottenConstants, true) ;
        while (enumerator_71298.hasCurrentObject ()) {
          var_cas_s.appendCString ("\n"
            "  - ") ;
          var_cas_s.dotAssign_operation (enumerator_71298._key (HERE)) ;
          enumerator_71298.next () ;
        }
      }
      operand_69016->mEndOf_switch_instruction.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("the switch instruction should name all enumeration constants; missing constants are:")).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (1845)) ;
    }
...
category_method__matchInstructionAST__analyzeSemanticInstruction (C_CompilerEx & inLexique,
                                const cPtr_matchInstructionAST * operand_71815,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration,
                                GGS_variableMap  & var_cas_ioVariableMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_71815 != NULL) {
    ...
    {
      GGS_semanticExpressionListAST::cEnumerator enumerator_72061 (operand_71815->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListAST::cElement * operand_72061 = NULL ;
      while (((operand_72061 = enumerator_72061.nextObject ()))) {
        macroValidPointer (operand_72061) ;
        GGS_semanticExpressionForGeneration  var_cas_matchedExpression ;
        { typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_72061->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_72061->mExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_matchedExpression COMMA_SOURCE_FILE_AT_LINE (1864)) ;
          }
        }
        ...
        const GGS_bool cond_72733 = ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1872))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1872)))).operator_and ((var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1872))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1872)))) ;
        if (cond_72733.isBuiltAndTrue ()) {
          operand_72061->mEndOfExpressionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this expression is an instance of '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))).operator_concat (GGS_string ("' type, but this type is neither an enumeration, neither a class")) COMMA_SOURCE_FILE_AT_LINE (1876)) ;
        }
      }
    }
    var_cas_ioVariableMap.modifier_openOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1879)) ;
    ...
    {
      GGS_matchInstructionBranchListAST::cEnumerator enumerator_72947 (operand_71815->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListAST::cElement * operand_72947 = NULL ;
      while (((operand_72947 = enumerator_72947.nextObject ()))) {
        ...
        const GGS_bool cond_75491 = (var_cas_expressionList.reader_length ()).operator_isEqual (operand_72947->mMatchEntryList.reader_length ()) ;
        if (cond_75491.isBuiltAndTrue ()) {
          {
            GGS_semanticExpressionListForGeneration::cEnumerator enumerator_73181 (var_cas_expressionList, true) ;
            const GGS_semanticExpressionListForGeneration::cElement * operand_73181 = NULL ;
            GGS_matchEntryListAST::cEnumerator enumerator_73198 (operand_72947->mMatchEntryList, true) ;
            const GGS_matchEntryListAST::cElement * operand_73198 = NULL ;
            while (((operand_73181 = enumerator_73181.nextObject ()))
                && ((operand_73198 = enumerator_73198.nextObject ()))) {
              macroValidPointer (operand_73181) ;
              macroValidPointer (operand_73198) ;
              const GGS_unifiedTypeMapProxy  var_cas_type = operand_73181->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1887)) ;
              const GGS_bool cond_74598 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1888))).operator_isEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1888))) ;
              if (cond_74598.isBuiltAndTrue ()) {
                const GGS_bool cond_74279 = operand_73198->mIsType ;
                if (cond_74279.isBuiltAndTrue ()) {
                  const GGS_unifiedTypeMapProxy  var_cas_namedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, operand_73198->mTypeNameOrEnumerationConstantName COMMA_SOURCE_FILE_AT_LINE (1890)) ;
                  GGS_unifiedTypeMapProxy  var_cas_t = var_cas_type ;
                  GGS_bool var_cas_found = (var_cas_t).operator_isEqual (var_cas_namedType) ;
                  GGS_uint _variant_73825 = var_cas_inAnalysisContext.mSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1893)) ;
                  GGS_bool _condition_73825 (_variant_73825.isBuilt (), true) ;
                  while (_condition_73825.isBuiltAndTrue ()) {
                    _condition_73825 = ((var_cas_found).operator_not ()).operator_and ((var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1894)).reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1894))).operator_not ()) ;
                    if (_condition_73825.isBuiltAndTrue ()) {
                      if (_variant_73825.uintValue () == 0) {
                        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1897)) ;
                        _condition_73825 = GGS_bool (false) ;
                      }else{
                        _variant_73825.decrement_operation (inLexique COMMA_HERE) ;
                  ...
                  const GGS_bool cond_74095 = (var_cas_found).operator_not () ;
                  if (cond_74095.isBuiltAndTrue ()) {
                    operand_73198->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_73198->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' is not a descendant of the '@"))).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1900)))).operator_concat (GGS_string ("' type of the cast expression")) COMMA_SOURCE_FILE_AT_LINE (1902)) ;
                  }else if (cond_74095.isBuiltAndFalse ()) {
                    const GGS_bool cond_74259 = (operand_73198->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1902)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                    if (cond_74259.isBuiltAndTrue ()) {
                      var_cas_localConstantList.addAssign_operation (var_cas_t, operand_73198->mLocalConstantName, GGS_bool (false), GGS_string ("match_instruction_constant_name")) ;
                    }
                  }
                }else if (cond_74279.isBuiltAndFalse ()) {
                  operand_73198->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a type that inherits from '@")).operator_concat (operand_73181->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1907)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1907)))).operator_concat (GGS_string ("' class is expected here")) COMMA_SOURCE_FILE_AT_LINE (1909)) ;
                }
                var_cas_matchListForGeneration.addAssign_operation (GGS_bool (true), operand_73198->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1910)), operand_73198->mLocalConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1910))) ;
              }else if (cond_74598.isBuiltAndFalse ()) {
                const GGS_bool cond_75374 = (var_cas_type.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1911))).operator_isEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1911))) ;
                if (cond_75374.isBuiltAndTrue ()) {
                  const GGS_bool cond_74875 = operand_73198->mIsType ;
                  if (cond_74875.isBuiltAndTrue ()) {
                    operand_73198->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a constant of the '@")).operator_concat (operand_73181->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1914)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1914)))).operator_concat (GGS_string ("' enumeration type is expected here")) COMMA_SOURCE_FILE_AT_LINE (1916)) ;
                  }else if (cond_74875.isBuiltAndFalse ()) {
                    const GGS_bool cond_75193 = (var_cas_type.reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1916)).reader_hasKey (operand_73198->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1916)))).operator_not () ;
                    if (cond_75193.isBuiltAndTrue ()) {
                      operand_73198->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_73198->mTypeNameOrEnumerationConstantName)).operator_concat (GGS_string ("' symbol is not a constant of the '@"))).operator_concat (operand_73181->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1918)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1918)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1920)) ;
                    }
                  }
                  var_cas_matchListForGeneration.addAssign_operation (GGS_bool (false), operand_73198->mTypeNameOrEnumerationConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1923)), operand_73181->mExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1924)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1924))) ;
                }else if (cond_75374.isBuiltAndFalse ()) {
                  operand_73198->mTypeNameOrEnumerationConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (1928)) ;
                }
              }
            }
          }
        }else if (cond_75491.isBuiltAndFalse ()) {
          operand_72947->mEndOfMatchEntryList.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this match list should contain ")).operator_concat (var_cas_expressionList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1932)))).operator_concat (GGS_string (" elements, but it acually contains "))).operator_concat (operand_72947->mMatchEntryList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1933))) COMMA_SOURCE_FILE_AT_LINE (1935)) ;
        }
        GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
        ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_localConstantList,  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_72947->mMatchBranchInstructionList,  operand_72947->mEndOf_instructionList,  var_cas_ioVariableMap,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1938)) ;
    ...
    ::routine_analyzeSemanticInstructionList (inLexique,  var_cas_inAnalysisContext,  GGS_localConstantList ::constructor_emptyList (),  GGS_localInitializedVariableList ::constructor_emptyList (),  operand_71815->mElseInstructionList,  operand_71815->mEndOf_match_instruction,  var_cas_ioVariableMap,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1952)) ;
    var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_71815->mEndOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1962)) ;
