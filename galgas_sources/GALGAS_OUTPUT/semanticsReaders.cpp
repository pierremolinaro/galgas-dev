...
void routine_enterBaseReaderWithoutArgumentWithConversion (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (35)), var_cas_ioUnifiedTypeMap, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (35)) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (37)), GGS_unifiedTypeMapIndexList ::constructor_emptyList (), var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (41)), var_cas_inConversionString COMMA_SOURCE_FILE_AT_LINE (36)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterInheritedReaderWithoutArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapIndex  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (75)), var_cas_ioUnifiedTypeMap, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (75)) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (77)), GGS_unifiedTypeMapIndexList ::constructor_emptyList (), var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (81)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (76)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterBaseReaderWithArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapIndex  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (97)), var_cas_ioUnifiedTypeMap, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (97)) ;
  ...
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (100)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (100)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (103)), var_cas_argList, var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (107)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (102)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterBaseReaderWith2Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapIndex  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (124)), var_cas_ioUnifiedTypeMap, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (124)) ;
  GGS_unifiedTypeMapIndexList  var_cas_argList = GGS_unifiedTypeMapIndexList ::constructor_emptyList () ;
  GGS_unifiedTypeMapIndex  var_cas_t ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (127)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (127)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument2TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (129)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (129)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (132)), var_cas_argList, var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (136)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (131)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterBaseReaderWith3Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapIndex  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (154)), var_cas_ioUnifiedTypeMap, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (154)) ;
  GGS_unifiedTypeMapIndexList  var_cas_argList = GGS_unifiedTypeMapIndexList ::constructor_emptyList () ;
  GGS_unifiedTypeMapIndex  var_cas_t ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (157)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (157)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument2TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (159)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (159)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument3TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (161)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (161)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (164)), var_cas_argList, var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (168)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (163)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__stringsetPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_stringsetPredefinedTypeAST * operand_20237,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__binarysetPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_binarysetPredefinedTypeAST * operand_20785,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20785 != NULL) {
...
category_method__typePredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_typePredefinedTypeAST * operand_24619,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24619 != NULL) {
...
category_method__objectPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_objectPredefinedTypeAST * operand_25158,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__dataPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_dataPredefinedTypeAST * operand_25513,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25513 != NULL) {
...
category_method__functionPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_functionPredefinedTypeAST * operand_25868,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
