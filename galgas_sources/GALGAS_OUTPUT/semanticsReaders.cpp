...
void routine_enterBaseReaderWithoutArgumentWithConversion (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (35)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (35)) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (37)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (41)), var_cas_inConversionString COMMA_SOURCE_FILE_AT_LINE (36)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterInheritedReaderWithoutArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (75)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (75)) ;
  var_cas_ioReaderMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inReaderName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (77)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_inHasLexiqueAndLocationArguments, var_cas_returnedTypeIndex, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (81)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (76)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterBaseReaderWithArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (97)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (97)) ;
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (100)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (100)) ;
...
void routine_enterBaseReaderWith2Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (124)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (124)) ;
  GGS_unifiedTypeMapProxyList  var_cas_argList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
  GGS_unifiedTypeMapProxy  var_cas_t ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (127)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (127)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument2TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (129)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (129)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
...
void routine_enterBaseReaderWith3Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (154)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (154)) ;
  GGS_unifiedTypeMapProxyList  var_cas_argList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
  GGS_unifiedTypeMapProxy  var_cas_t ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (157)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (157)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument2TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (159)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (159)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument3TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (161)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (161)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
