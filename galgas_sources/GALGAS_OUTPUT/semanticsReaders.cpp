...
category_method__dataPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_dataPredefinedTypeAST * operand_25182,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25182 != NULL) {
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioUnifiedTypeMap,  var_cas_outMap COMMA_SOURCE_FILE_AT_LINE (452)) ;
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("length"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (453)) ;
  }
}
...
category_method__functionPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_functionPredefinedTypeAST * operand_25537,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25537 != NULL) {
    ...
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("name"),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (463)) ;
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("resultType"),  GGS_string ("type"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (464)) ;
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("formalParameterTypeList"),  GGS_string ("typelist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (465)) ;
  }
}
