...
void routine_readerMapFor_lstring (C_Compiler & inLexique,
  ...
  {
    GGS_readerMap::cEnumerator enumerator_20241 (var_cas_commonReaders, true) ;
    const GGS_readerMap::cElement * operand_20241 = NULL ;
    while (((operand_20241 = enumerator_20241.nextObject ()))) {
      macroValidPointer (operand_20241) ;
      var_cas_outMap.modifier_insertOrReplace (inLexique, operand_20241->mKey, operand_20241->mInfo.mArgumentTypeList, operand_20241->mInfo.mHasLexiqueArgument, operand_20241->mInfo.mReturnedType, operand_20241->mInfo.mQualifier, GGS_string ("string") COMMA_SOURCE_FILE_AT_LINE (391)) ;
    }
  }
