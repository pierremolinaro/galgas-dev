...
void routine_enterBaseReaderWithoutArgumentWithConversion (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inReturnedTypeName, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (35)) ;
...
void routine_enterBaseReaderWithArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inReturnedTypeName, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (97)) ;
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inArgument1TypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (100)) ;
...
void routine_enterBaseReaderWith2Arguments (C_Compiler & inLexique,
  ...
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inArgument2TypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (129)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
...
void routine_enterBaseReaderWith3Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inReturnedTypeName, var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (154)) ;
  GGS_unifiedTypeMapProxyList  var_cas_argList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
  GGS_unifiedTypeMapProxy  var_cas_t ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inArgument1TypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (157)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inArgument2TypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (159)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inArgument3TypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (161)) ;
  var_cas_argList.addAssign_operation (var_cas_t) ;
...
category_method__locationPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_locationPredefinedTypeAST * operand_7023,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7023 != NULL) {
...
category_method__stringPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_stringPredefinedTypeAST * operand_12417,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12417 != NULL) {
...
category_method__charPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_charPredefinedTypeAST * operand_12748,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12748 != NULL) {
...
category_method__boolPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_boolPredefinedTypeAST * operand_14899,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__uintPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_uintPredefinedTypeAST * operand_15697,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15697 != NULL) {
...
category_method__sintPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_sintPredefinedTypeAST * operand_16883,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__uint64PredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_uint64PredefinedTypeAST * operand_17592,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17592 != NULL) {
...
category_method__sint64PredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_sint64PredefinedTypeAST * operand_18585,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__doublePredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_doublePredefinedTypeAST * operand_19289,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19289 != NULL) {
...
category_method__stringsetPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_stringsetPredefinedTypeAST * operand_19995,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19995 != NULL) {
...
category_method__binarysetPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_binarysetPredefinedTypeAST * operand_20543,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__typePredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_typePredefinedTypeAST * operand_24377,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24377 != NULL) {
...
category_method__objectPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_objectPredefinedTypeAST * operand_24916,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__dataPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_dataPredefinedTypeAST * operand_25271,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__functionPredefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_functionPredefinedTypeAST * operand_25626,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_readerMap  & var_cas_outMap
                                COMMA_UNUSED_LOCATION_ARGS) {
