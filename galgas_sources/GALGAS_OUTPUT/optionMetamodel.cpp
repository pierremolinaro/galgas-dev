...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_optionDefaultValueEnum ("optionDefaultValueEnum", false, NULL) ;

//---------------------------------------------------------------------------*

bool GGS_optionDefaultValueEnum::
isBuilt (void) const {
...
GGS_bool GGS_optionDefaultValueEnum::
operator_isEqual (const GGS_optionDefaultValueEnum inOperand) const {
...
GGS_bool GGS_optionDefaultValueEnum::
operator_isNotEqual (const GGS_optionDefaultValueEnum inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (),
                   mValue != inOperand.mValue) ;
}
...
GGS_bool GGS_optionDefaultValueEnum::
operator_infOrEqual (const GGS_optionDefaultValueEnum inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (),
                   mValue <= inOperand.mValue) ;
}
...
GGS_bool GGS_optionDefaultValueEnum::
operator_supOrEqual (const GGS_optionDefaultValueEnum inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (),
                   mValue >= inOperand.mValue) ;
}
...
GGS_bool GGS_optionDefaultValueEnum::
operator_strictInf (const GGS_optionDefaultValueEnum inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (),
                   mValue < inOperand.mValue) ;
}
...
GGS_bool GGS_optionDefaultValueEnum::
operator_strictSup (const GGS_optionDefaultValueEnum inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (),
                   mValue > inOperand.mValue) ;
}
...
GGS_string GGS_optionDefaultValueEnum::
reader_description (const PMSInt32 /* inIndentation */) const {
  C_String s ;
  s << "<enum @optionDefaultValueEnum" ;
  switch (mValue) {
...
GGS_object GGS_optionDefaultValueEnum::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_optionDefaultValueEnum * p = NULL ;
    macroMyNew (p, GGS_optionDefaultValueEnum (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_optionDefaultValueEnum GGS_optionDefaultValueEnum::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_optionDefaultValueEnum result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_optionDefaultValueEnum * p = dynamic_cast <const GGS_optionDefaultValueEnum *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_optionDefaultValueEnum, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_optionDefaultValueEnum::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_optionDefaultValueEnum ;
}
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_optionDefaultValueEnum p_6 = p->mOptionDefaultValueKind ;
...
reader_description (const PMSInt32 inIndentation) const {
  return performDescription ("@commandLineOptionList", inIndentation) ;
}
...
GGS_optionDefaultValueEnum GGS_commandLineOptionList::
...
/* const */ GGS_lstring  & GGS_commandLineOptionList::cEnumerator::_mOptionDefaultValue (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
/* const */ GGS_optionDefaultValueEnum & GGS_commandLineOptionList::cEnumerator::_mOptionDefaultValueKind (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_object GGS_commandLineOptionList::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_commandLineOptionList * p = NULL ;
    macroMyNew (p, GGS_commandLineOptionList (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_commandLineOptionList GGS_commandLineOptionList::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_commandLineOptionList * p = dynamic_cast <const GGS_commandLineOptionList *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_commandLineOptionList, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_optionComponentRoot) ;
...
GGS_optionComponentRoot (const cPtr__AC_galgas_class * inPointer) {
...
castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      result = GGS_optionComponentRoot (inPointer) ;
    }else{
...
GGS_object GGS_optionComponentRoot::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_optionComponentRoot * p = NULL ;
    macroMyNew (p, GGS_optionComponentRoot (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_optionComponentRoot GGS_optionComponentRoot::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_optionComponentRoot * p = dynamic_cast <const GGS_optionComponentRoot *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_optionComponentRoot, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
