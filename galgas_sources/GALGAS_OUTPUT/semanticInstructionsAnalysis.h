...
//                    november 11th, 2010, at 12h16'32"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
class GGS_localInitializedVariableList ;
...
class elementOf_GGS_localInitializedVariableList ;

//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_localInitializedVariableList ;

//---------------------------------------------------------------------------*

class GGS_localInitializedVariableList : public AC_GGS_list {
  public : typedef elementOf_GGS_localInitializedVariableList cElement ;

//--- Constructor 'emptyList'
  public : static GGS_localInitializedVariableList constructor_emptyList (void) ;
  public : static GGS_localInitializedVariableList constructor_listWithValue (const GGS_unifiedTypeMapProxy & argument_0,
                                const GGS_lstring & argument_1,
...
//--- Modifier 'popFirst'
  public : void modifier_popFirst (C_CompilerEx & inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void dotAssign_operation (const GGS_localInitializedVariableList inOperand) ;
...
//--------------------------------- List Enumerator
  public : class cEnumerator : public cAbstractListEnumerator {
  //--- Constructor
    public : inline cEnumerator (const GGS_localInitializedVariableList & inList,
                                 const bool inAscending) :
    cAbstractListEnumerator (inList, inAscending) {
    }
  //--- Iterator method
...
void routine_analyzeRoutineArguments (C_CompilerEx &,
                                ...
                                GGS_variableMap  &,
                                GGS_actualParameterListForGeneration  & COMMA_LOCATION_ARGS) ;
...
extern const C_galgas_function_descriptorEX kFunction_descriptor_checkMethodImplementationInSuperClasses ;
...
extern const C_galgas_function_descriptorEX kFunction_descriptor_checkModifierImplementationInSuperClasses ;
...
class elementOf_GGS_localInitializedVariableList : public AC_GGS_list::cListElement {
//--- Attributes
  public : GGS_unifiedTypeMapProxy  mType ;
  public : GGS_lstring  mName ;
  public : GGS_string mCppName ;
//--- Constructor
  public : elementOf_GGS_localInitializedVariableList (const GGS_unifiedTypeMapProxy & ,
                                const GGS_lstring & ,
                                const GGS_string& 
                                COMMA_LOCATION_ARGS) ;

//--- Access to next
  public : inline elementOf_GGS_localInitializedVariableList * nextObject (void) const { return (elementOf_GGS_localInitializedVariableList *) internalNextItem () ; }

//--- Access to previous
  public : inline elementOf_GGS_localInitializedVariableList * previousObject (void) const { return (elementOf_GGS_localInitializedVariableList *) internalPreviousItem () ; }
...
//--- Friend class declaration
  friend class GGS_localInitializedVariableList ;
} ;
