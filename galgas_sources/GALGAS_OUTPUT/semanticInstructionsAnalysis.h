...
//--- Current element access
  public : GALGAS_localConstantList_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--- Current element access
  ...
  public : GALGAS_string current_mCppName (LOCATION_ARGS) const ;
//--- Current element access
  public : GALGAS_localInitializedVariableList_2E_element current (LOCATION_ARGS) const ;
} ;
...
typedef void (*categoryMethodSignature_abstractEnumeratedCollectionAST_analyzeEnumeration) (const cPtr_abstractEnumeratedCollectionAST * inObject,
                                                                                            ...
                                                                                            GALGAS_localInitializedVariableList & ioArgument2,
                                                                                            GALGAS_string & outArgument3,
                                                                                            GALGAS_semanticExpressionForGeneration & outArgument4,
                                                                                            C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) ;
...
typedef void (*categoryMethodSignature_abstractGrammarInstructionSyntaxDirectedTranslationResult_analyzeGrammarInstructionSDT) (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
                                                                                                                                ...
                                                                                                                                GALGAS_variableMap & ioArgument4,
                                                                                                                                C_Compiler * inCompiler
                                                                                                                                COMMA_LOCATION_ARGS) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_localConstantList_2E_element constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                       const GALGAS_lstring & inOperand1,
                                                                       const GALGAS_bool & inOperand2,
                                                                       const GALGAS_string & inOperand3
                                                                       COMMA_LOCATION_ARGS) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_localInitializedVariableList_2E_element constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                  const GALGAS_lstring & inOperand1,
                                                                                  const GALGAS_string & inOperand2
                                                                                  COMMA_LOCATION_ARGS) ;
