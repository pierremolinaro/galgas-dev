...
result << "                            GALGAS_" ;
result << operand_4154->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * inList,\n" ;
GGS_attributeList::cEnumerator enumerator_4494 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4494 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4494 = enumerator_4494.nextObject ()))) {
macroValidPointer (operand_4494) ;
result << "                           GALGAS_" ;
result << operand_4494->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
result << " * & outOperand" ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_attributeList::cEnumerator enumerator_5750 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5750 = NULL ;
while (((operand_5750 = enumerator_5750.nextObject ()))) {
macroValidPointer (operand_5750) ;
result << "    public : const GALGAS_" ;
result << operand_5750->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " * attribute_" ;
result << operand_5750->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " (void) const ;\n" ;
}
result << "  } ;\n"
  "} ;\n"
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_6252 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_6252 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6252 = enumerator_6252.nextObject ()))) {
macroValidPointer (operand_6252) ;
result << ",\n"
  "                          const GALGAS_" ;
result << operand_6252->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (138)) ;
result << " * inOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult,\n" ;
GGS_attributeList::cEnumerator enumerator_6488 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_6488 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6488 = enumerator_6488.nextObject ()))) {
macroValidPointer (operand_6488) ;
result << "                        GALGAS_" ;
result << operand_6488->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult,\n" ;
GGS_attributeList::cEnumerator enumerator_6810 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_6810 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6810 = enumerator_6810.nextObject ()))) {
macroValidPointer (operand_6810) ;
result << "                       GALGAS_" ;
result << operand_6810->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_7135 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7135 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7135 = enumerator_7135.nextObject ()))) {
macroValidPointer (operand_7135) ;
result << ",\n"
  "                          const GALGAS_" ;
result << operand_7135->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " * inOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * inList,\n" ;
GGS_attributeList::cEnumerator enumerator_7416 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7416 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7416 = enumerator_7416.nextObject ()))) {
macroValidPointer (operand_7416) ;
result << "                   GALGAS_" ;
result << operand_7416->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * inList,\n" ;
GGS_attributeList::cEnumerator enumerator_7720 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7720 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7720 = enumerator_7720.nextObject ()))) {
macroValidPointer (operand_7720) ;
result << "                  GALGAS_" ;
result << operand_7720->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
result << " * & outOperand" ;
...
result << "                  C_Compiler * inCompiler\n"
  "                  COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
GGS_attributeList::cEnumerator enumerator_7965 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7965 = NULL ;
while (((operand_7965 = enumerator_7965.nextObject ()))) {
macroValidPointer (operand_7965) ;
result << "\n"
  "void modifier_set" ;
result << operand_7965->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_stringByCapitalizingFirstCharacter () ;
result << "AtIndex (GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * & ioList,\n"
  "                                         const GALGAS_" ;
result << operand_7965->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
result << " * inAttributeValue,\n"
  "                                         const GALGAS_uint * inIndex,\n"
  "                                         C_Compiler * inCompiler\n"
  "                                         COMMA_LOCATION_ARGS) ;\n" ;
}
GGS_attributeList::cEnumerator enumerator_8451 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_8451 = NULL ;
while (((operand_8451 = enumerator_8451.nextObject ()))) {
macroValidPointer (operand_8451) ;
result << "\n"
  "GALGAS_" ;
result << operand_8451->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
result << " * reader_" ;
result << operand_8451->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
result << "AtIndex (const GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inList,\n"
  "                                               const GALGAS_uint * inIndex,\n"
