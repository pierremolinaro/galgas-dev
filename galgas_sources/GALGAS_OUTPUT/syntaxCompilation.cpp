...
//                    september 24th, 2010, at 15h21'53"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_11293 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11293.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200)), var_cas_implementationIncludeList) ;
    {
      ...
      while (((operand_9162 = enumerator_9162.nextObject ()))) {
        ...
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9162->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9162->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (204)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9162->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9162->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (205)))) ;
      }
    }
    ...
    {
      GGS_ruleDeclarationList::cEnumerator enumerator_9535 (var_cas_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (209)), true) ;
      const GGS_ruleDeclarationList::cElement * operand_9535 = NULL ;
      while (((operand_9535 = enumerator_9535.nextObject ()))) {
        macroValidPointer (operand_9535) ;
        {
          GGS_ruleLabelImplementationList::cEnumerator enumerator_9629 (operand_9535->mLabelImplementationList, true) ;
          const GGS_ruleLabelImplementationList::cElement * operand_9629 = NULL ;
          while (((operand_9629 = enumerator_9629.nextObject ()))) {
            macroValidPointer (operand_9629) ;
            const GGS_string var_cas_ruleName = (((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9535->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9535->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)))).operator_concat (GGS_string ("_"))).operator_concat (operand_9629->mLabelName.ggs_string ().reader_identifierRepresentation ()) ;
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9629->mSignatureForGeneration, operand_9629->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (215))) ;
          }
        }
        const GGS_bool cond_11046 = operand_9535->mHasParseLabel ;
        if (cond_11046.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10424_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10424_1 ;
          GGS_formalParameterSignature  automatic_var_10424_2 ;
          GGS_location  automatic_var_10424_3 ;
          if (operand_9535->mLabelImplementationList.isBuilt ()) {
            operand_9535->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10424_0, automatic_var_10424_1, automatic_var_10424_2, automatic_var_10424_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (227)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9535->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9535->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)))).operator_concat (GGS_string ("_parse")) ;
