...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8565 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (170))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8565.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)), var_cas_lexiqueName, var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (175))) ;
    {
      ...
      while (((operand_8267 = enumerator_8267.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8267->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8267->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (178)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (180)) ;
  }
  const GGS_bool cond_10974 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (191))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10974.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), var_cas_implementationIncludeList) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8865 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8865 = NULL ;
      while (((operand_8865 = enumerator_8865.nextObject ()))) {
        macroValidPointer (operand_8865) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_8865->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8865->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (197)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_8865->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8865->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (198)))) ;
      }
    }
    const GGS_string var_cas_lexiqueCppName = (GGS_string ("C_Lexique_")).operator_concat (var_cas_syntaxComponentRoot.reader_mImportedLexiqueFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (201)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ().reader_identifierRepresentation ()) ;
    {
      GGS_ruleDeclarationList::cEnumerator enumerator_9238 (var_cas_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
      const GGS_ruleDeclarationList::cElement * operand_9238 = NULL ;
      while (((operand_9238 = enumerator_9238.nextObject ()))) {
        macroValidPointer (operand_9238) ;
        {
          GGS_ruleLabelImplementationList::cEnumerator enumerator_9332 (operand_9238->mLabelImplementationList, true) ;
          const GGS_ruleLabelImplementationList::cElement * operand_9332 = NULL ;
          while (((operand_9332 = enumerator_9332.nextObject ()))) {
            macroValidPointer (operand_9332) ;
            const GGS_string var_cas_ruleName = (((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9238->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9238->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)))).operator_concat (GGS_string ("_"))).operator_concat (operand_9332->mLabelName.ggs_string ().reader_identifierRepresentation ()) ;
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9332->mSignatureForGeneration, operand_9332->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (208))) ;
          }
        }
        const GGS_bool cond_10727 = operand_9238->mHasParseLabel ;
        if (cond_10727.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10112_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10112_1 ;
          GGS_formalParameterSignature  automatic_var_10112_2 ;
          GGS_location  automatic_var_10112_3 ;
          if (operand_9238->mLabelImplementationList.isBuilt ()) {
            operand_9238->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10112_0, automatic_var_10112_1, automatic_var_10112_2, automatic_var_10112_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (220)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9238->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9238->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)))).operator_concat (GGS_string ("_parse")) ;
          var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, GGS_formalParameterListForGeneration ::constructor_emptyList (), function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (228)), GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (225))) ;
        }
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (238))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
