...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2263 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (37)).reader_hasKey (inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (37)) ;
  if (cond_2263.isBuiltAndTrue ()) {
  ...
  }else if (cond_2263.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_2793 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (45))).operator_isNotEqual (var_cas_basename) ;
  if (cond_2793.isBuiltAndTrue ()) {
