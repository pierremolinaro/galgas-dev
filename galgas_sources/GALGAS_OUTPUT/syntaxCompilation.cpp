...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  ::routine_buildTerminalMap (inLexique,  var_cas_lexiqueComponentRoot,  var_cas_terminalMap COMMA_SOURCE_FILE_AT_LINE (142)) ;
  ...
  const GGS_string var_cas_lexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (146)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  ::routine_semanticAnalysisOfSyntaxComponent (inLexique,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (148)),  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (149)),  var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (150)),  var_cas_lexiqueName.reader_identifierRepresentation (),  var_cas_semanticContext,  var_cas_predefinedTypes,  var_cas_terminalMap,  var_cas_syntaxDeclarationForGeneration COMMA_SOURCE_FILE_AT_LINE (147)) ;
  GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
  ::routine_performSemanticAnalysis (inLexique,  var_cas_syntaxComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (160)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (160)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (159)) ;
  var_cas_decoratedDeclarationListForGeneration.addAssign_operation (var_cas_syntaxDeclarationForGeneration) ;
  const GGS_bool cond_8444 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (166))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8444.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)), var_cas_lexiqueName, var_cas_syntaxComponentRoot.reader_mImportedComponentFileNameList (inLexique COMMA_SOURCE_FILE_AT_LINE (170)), var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (171))) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8146 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8146 = NULL ;
      while (((operand_8146 = enumerator_8146.nextObject ()))) {
        macroValidPointer (operand_8146) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8146->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8146->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (174)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (176)) ;
  }
  const GGS_bool cond_9111 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (187))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9111.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189))) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8711 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8711 = NULL ;
      while (((operand_8711 = enumerator_8711.nextObject ()))) {
        macroValidPointer (operand_8711) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_8711->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8711->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (192)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_8711->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8711->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (193)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
