...
void routine_generateSyntaxComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  GALGAS_string var_headerOfCppFile = GALGAS_string (filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementationGalgas_33_ (inCompiler, var_cppInclusionSet COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 528))) ;
  ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("syntax-").operator_concat (var_componentName  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 531)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 531))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 531)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("syntax-").operator_concat (var_componentName  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 532)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 532))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 532)) ;
  {
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("syntax-").operator_concat (var_componentName  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 535)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 535)), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_headerOfCppFile.add_operation (var_implementationString, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 538)), GALGAS_string ("\n"
    "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 533)) ;
  }
}
