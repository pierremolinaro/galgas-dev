...
void routine_compileSyntaxComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_semanticDeclarationSortedListForGeneration enumerator_8634 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
      while (enumerator_8634.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_8634.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189)) ;
        enumerator_8634.gotoNextObject () ;
      }
      cEnumerator_semanticDeclarationSortedListForGeneration enumerator_8769 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
      while (enumerator_8769.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_8769.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
      ...
      if (kBoolTrue == test_4) {
        ...
        cEnumerator_semanticDeclarationSortedListForGeneration enumerator_9437 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
        while (enumerator_9437.hasCurrentObject ()) {
          var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_9437.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
          var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_9437.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)) ;
          enumerator_9437.gotoNextObject () ;
        }
        GALGAS_string var_lexiqueCppName = GALGAS_string ("C_Lexique_").operator_concat (constinArgument_inSyntaxComponentRoot.reader_mImportedLexiqueFilePath (SOURCE_FILE_AT_LINE (214)).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (214)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (214)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)) ;
        cEnumerator_ruleDeclarationList enumerator_9888 (var_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (SOURCE_FILE_AT_LINE (215)), kEnumeration_up) ;
        while (enumerator_9888.hasCurrentObject ()) {
          cEnumerator_ruleLabelImplementationList enumerator_9982 (enumerator_9888.current_mLabelImplementationList (HERE), kEnumeration_up) ;
          while (enumerator_9982.hasCurrentObject ()) {
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (218)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (enumerator_9888.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (enumerator_9888.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (enumerator_9982.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
              "\n") COMMA_SOURCE_FILE_AT_LINE (222)) ;
            var_implementationString.dotAssign_operation (function_generateProcedure (var_ruleName, enumerator_9982.current_mSignatureForGeneration (HERE), enumerator_9982.current_mInstructionListForGeneration (HERE), GALGAS_bool (false), var_lexiqueCppName, GALGAS_bool (false), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) COMMA_SOURCE_FILE_AT_LINE (223)) ;
            enumerator_9982.gotoNextObject () ;
          }
          GALGAS_semanticInstructionListForGeneration var_instructionList ;
          GALGAS_lstring joker_10937_0 ; // Joker input parameter
          GALGAS_formalParameterListForGeneration joker_10940_0 ; // Joker input parameter
          GALGAS_formalParameterSignature joker_10943_0 ; // Joker input parameter
          GALGAS_location joker_10946_0 ; // Joker input parameter
          enumerator_9888.current_mLabelImplementationList (HERE).method_first (joker_10937_0, joker_10940_0, joker_10943_0, joker_10946_0, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) ;
          GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (236)) COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (enumerator_9888.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (238)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (enumerator_9888.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string ("_parse") COMMA_SOURCE_FILE_AT_LINE (239)) ;
          var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
          ...
          if (kBoolTrue == test_5) {
            GALGAS_semanticInstructionListForGeneration var_instructionList ;
            GALGAS_lstring joker_11913_0 ; // Joker input parameter
            GALGAS_formalParameterListForGeneration joker_11916_0 ; // Joker input parameter
            GALGAS_formalParameterSignature joker_11919_0 ; // Joker input parameter
            GALGAS_location joker_11922_0 ; // Joker input parameter
            enumerator_9888.current_mLabelImplementationList (HERE).method_first (joker_11913_0, joker_11916_0, joker_11919_0, joker_11922_0, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)) ;
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (255)) COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (enumerator_9888.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (enumerator_9888.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (GALGAS_string ("_indexing") COMMA_SOURCE_FILE_AT_LINE (257)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_13722_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (295)).method_searchKey (var_basenameKey, joker_13722_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
