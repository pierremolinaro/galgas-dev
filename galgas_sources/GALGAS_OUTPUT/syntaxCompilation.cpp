...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_10784 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (191))).operator_isEqual (GGS_uint (0U)) ;
      ...
      while (((operand_9238 = enumerator_9238.nextObject ()))) {
        macroValidPointer (operand_9238) ;
        {
          ...
          while (((operand_9332 = enumerator_9332.nextObject ()))) {
            ...
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9332->mSignatureForGeneration, operand_9332->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName COMMA_SOURCE_FILE_AT_LINE (208))) ;
          }
        }
        const GGS_bool cond_10537 = operand_9238->mHasParseLabel ;
        if (cond_10537.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10017_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10017_1 ;
          GGS_formalParameterSignature  automatic_var_10017_2 ;
          GGS_location  automatic_var_10017_3 ;
          if (operand_9238->mLabelImplementationList.isBuilt ()) {
            operand_9238->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10017_0, automatic_var_10017_1, automatic_var_10017_2, automatic_var_10017_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (218)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9238->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9238->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)))).operator_concat (GGS_string ("_parse")) ;
          var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, GGS_formalParameterListForGeneration ::constructor_emptyList (), function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (226)), GGS_bool (false), var_cas_lexiqueCppName COMMA_SOURCE_FILE_AT_LINE (223))) ;
        }
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (234))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
