...
void routine_generateSyntaxComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_implementationIncludeList.addAssign_operation (GALGAS_string ("all-declarations")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 353)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        cEnumerator_optionComponentMapForSemanticAnalysis enumerator_16776 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
        while (enumerator_16776.hasCurrentObject ()) {
          const enumGalgasBool test_3 = enumerator_16776.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("syntaxCompilation.gSemantics", 374)).boolEnum () ;
          if (kBoolTrue == test_3) {
            var_implementationIncludeList.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_16776.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 375))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 375)) ;
          }
          enumerator_16776.gotoNextObject () ;
        }
        GALGAS_string var_lexiqueCppName = GALGAS_string ("C_Lexique_").operator_concat (constinArgument_inSyntaxStructForGeneration.mAttribute_mSyntaxComponentRoot.mAttribute_mImportedLexiqueFilePath.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 378))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 378)) ;
        GALGAS_string var_implementationString = GALGAS_string (filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementationGalgas_33_ (inCompiler, var_componentName, var_implementationIncludeList COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 379))) ;
        var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_syntaxDeclarationForGeneration *) constinArgument_inSyntaxStructForGeneration.mAttribute_mSyntaxGeneration.ptr (), inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 383))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 383)) ;
        var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_syntaxDeclarationForGeneration *) constinArgument_inSyntaxStructForGeneration.mAttribute_mSyntaxGeneration.ptr (), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 384))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 384)) ;
        cEnumerator_ruleDeclarationList enumerator_17582 (constinArgument_inSyntaxStructForGeneration.mAttribute_mSyntaxGeneration.reader_mRuleDeclarationList (SOURCE_FILE ("syntaxCompilation.gSemantics", 385)), kEnumeration_up) ;
        while (enumerator_17582.hasCurrentObject ()) {
          cEnumerator_ruleLabelImplementationList enumerator_17676 (enumerator_17582.current_mLabelImplementationList (HERE), kEnumeration_up) ;
          while (enumerator_17676.hasCurrentObject ()) {
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 388))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 388)).operator_concat (GALGAS_string ("::rule_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 388)).operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 389))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 389)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 389)).operator_concat (enumerator_17582.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 390))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 389)).operator_concat (GALGAS_string ("_i")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 390)).operator_concat (enumerator_17582.current_mRuleIndex (HERE).reader_string (SOURCE_FILE ("syntaxCompilation.gSemantics", 391))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 391)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 391)).operator_concat (enumerator_17676.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 391))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 391)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
              "\n")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 393)) ;
            var_implementationString.dotAssign_operation (function_generateProcedure (var_ruleName, GALGAS_bool (false), enumerator_17676.current_mSignatureForGeneration (HERE), enumerator_17676.current_mInstructionListForGeneration (HERE), GALGAS_bool (false), var_lexiqueCppName, GALGAS_bool (false), GALGAS_bool (false), constinArgument_inSyntaxStructForGeneration.mAttribute_mSyntaxComponentRoot.mAttribute_mHasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 394))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 394)) ;
            enumerator_17676.gotoNextObject () ;
          }
          GALGAS_semanticInstructionListForGeneration var_instructionList ;
          GALGAS_lstring joker_18759_0 ; // Joker input parameter
          GALGAS_formalParameterListForGeneration joker_18762_0 ; // Joker input parameter
          GALGAS_formalParameterSignature joker_18765_0 ; // Joker input parameter
          GALGAS_location joker_18768_0 ; // Joker input parameter
          enumerator_17582.current_mLabelImplementationList (HERE).method_first (joker_18759_0, joker_18762_0, joker_18765_0, joker_18768_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 408)) ;
          GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 409))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 409)).operator_concat (GALGAS_string ("::rule_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 409)).operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 410))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 410)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 410)).operator_concat (enumerator_17582.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 411))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 410)).operator_concat (GALGAS_string ("_i")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 411)).operator_concat (enumerator_17582.current_mRuleIndex (HERE).reader_string (SOURCE_FILE ("syntaxCompilation.gSemantics", 412))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 412)).operator_concat (GALGAS_string ("_parse")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 412)) ;
          var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
            "\n")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 413)) ;
          var_implementationString.dotAssign_operation (function_generateProcedure (var_ruleName, GALGAS_bool (false), GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("syntaxCompilation.gSemantics", 417)), function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 418)), GALGAS_bool (false), var_lexiqueCppName, GALGAS_bool (false), GALGAS_bool (true), constinArgument_inSyntaxStructForGeneration.mAttribute_mSyntaxComponentRoot.mAttribute_mHasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 414))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 414)) ;
          const enumGalgasBool test_4 = constinArgument_inSyntaxStructForGeneration.mAttribute_mHasIndexing.boolEnum () ;
          if (kBoolTrue == test_4) {
            GALGAS_semanticInstructionListForGeneration var_instructionList ;
            GALGAS_lstring joker_19869_0 ; // Joker input parameter
            GALGAS_formalParameterListForGeneration joker_19872_0 ; // Joker input parameter
            GALGAS_formalParameterSignature joker_19875_0 ; // Joker input parameter
            GALGAS_location joker_19878_0 ; // Joker input parameter
            enumerator_17582.current_mLabelImplementationList (HERE).method_first (joker_19869_0, joker_19872_0, joker_19875_0, joker_19878_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 428)) ;
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 429))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 429)).operator_concat (GALGAS_string ("::rule_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 429)).operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 430))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 430)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 430)).operator_concat (enumerator_17582.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 431))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 430)).operator_concat (GALGAS_string ("_i")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 431)).operator_concat (enumerator_17582.current_mRuleIndex (HERE).reader_string (SOURCE_FILE ("syntaxCompilation.gSemantics", 432))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 432)).operator_concat (GALGAS_string ("_indexing")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 432)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
              "\n")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 433)) ;
            var_implementationString.dotAssign_operation (function_generateProcedure (var_ruleName, GALGAS_bool (false), GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("syntaxCompilation.gSemantics", 437)), function_syntaxSignatureOfInstructionList (GALGAS_string ("indexing"), var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 438)), GALGAS_bool (false), var_lexiqueCppName, GALGAS_bool (false), GALGAS_bool (false), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 434))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 434)) ;
          }
          enumerator_17582.gotoNextObject () ;
        }
        ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("syntax-").operator_concat (var_componentName  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 447)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 447))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 447)) ;
        ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("syntax-").operator_concat (var_componentName  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 448)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 448))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 448)) ;
        {
        GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("syntax-").operator_concat (var_componentName  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 451)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 451)), GALGAS_string ("//"), GALGAS_string ("\n"
          "\n"), var_implementationString, GALGAS_string ("\n"
          "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 449)) ;
        }
      }
    }
  }
