...
void routine_generateSyntaxComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        cEnumerator_optionComponentMapForSemanticAnalysis enumerator_16770 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
        while (enumerator_16770.hasCurrentObject ()) {
          const enumGalgasBool test_3 = enumerator_16770.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("syntaxCompilation.gSemantics", 374)).boolEnum () ;
          if (kBoolTrue == test_3) {
            var_implementationIncludeList.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_16770.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 375))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 375)) ;
          }
        ...
        while (enumerator_17576.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_4) {
            GALGAS_semanticInstructionListForGeneration var_instructionList ;
            GALGAS_lstring joker_19863_0 ; // Joker input parameter
            GALGAS_formalParameterListForGeneration joker_19866_0 ; // Joker input parameter
            GALGAS_formalParameterSignature joker_19869_0 ; // Joker input parameter
            GALGAS_location joker_19872_0 ; // Joker input parameter
            enumerator_17576.current_mLabelImplementationList (HERE).method_first (joker_19863_0, joker_19866_0, joker_19869_0, joker_19872_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 428)) ;
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 429))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 429)).operator_concat (GALGAS_string ("::rule_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 429)).operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 430))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 430)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 430)).operator_concat (enumerator_17576.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 431))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 430)).operator_concat (GALGAS_string ("_i")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 431)).operator_concat (enumerator_17576.current_mRuleIndex (HERE).reader_string (SOURCE_FILE ("syntaxCompilation.gSemantics", 432))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 432)).operator_concat (GALGAS_string ("_indexing")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 432)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
          ...
          enumerator_17576.gotoNextObject () ;
        }
