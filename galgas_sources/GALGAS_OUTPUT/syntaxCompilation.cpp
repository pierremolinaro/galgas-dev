...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_11118 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11118.isBuiltAndTrue ()) {
      ...
      while (((operand_9466 = enumerator_9466.nextObject ()))) {
        macroValidPointer (operand_9466) ;
        {
          ...
          while (((operand_9560 = enumerator_9560.nextObject ()))) {
            ...
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9560->mSignatureForGeneration, operand_9560->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (212))) ;
          }
        }
        const GGS_bool cond_10871 = operand_9466->mHasParseLabel ;
        if (cond_10871.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10298_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10298_1 ;
          GGS_formalParameterSignature  automatic_var_10298_2 ;
          GGS_location  automatic_var_10298_3 ;
          if (operand_9466->mLabelImplementationList.isBuilt ()) {
            operand_9466->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10298_0, automatic_var_10298_1, automatic_var_10298_2, automatic_var_10298_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (223)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9466->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9466->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (227)))).operator_concat (GGS_string ("_parse")) ;
          var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, GGS_formalParameterListForGeneration ::constructor_emptyList (), function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (231)), GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (228))) ;
        }
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (240))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
