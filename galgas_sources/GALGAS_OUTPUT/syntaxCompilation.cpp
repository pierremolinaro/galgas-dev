...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_12940_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE ("syntaxCompilation.gSemantics", 277)).method_searchKey (var_basenameKey, joker_12940_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 277)) ;
...
void routine_compileSyntaxComponentGalgas_33_ (const GALGAS_galgas_33_SyntaxComponentListAST_2D_element constinArgument_inSyntaxComponentRoot,
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    GALGAS_syntaxDeclarationForGeneration joker_19886_0 ; // Joker input parameter
    routine_semanticAnalysisOfSyntaxComponent (constinArgument_inSyntaxComponentRoot.mAttribute_mNonterminalDeclarationList, constinArgument_inSyntaxComponentRoot.mAttribute_mRuleList, var_componentName, var_lexiqueName, constinArgument_inSemanticContext, var_predefinedTypes, var_terminalMap, var_indexNameSet, var_hasIndexing, constinArgument_inSyntaxComponentRoot.mAttribute_mHasTranslateFeature, joker_19886_0, inCompiler  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 424)) ;
    }
    {
