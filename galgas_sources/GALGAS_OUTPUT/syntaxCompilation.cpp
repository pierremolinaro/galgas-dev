    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_4) {
        ...
        while (enumerator_7736.hasCurrentObject ()) {
          ...
          GALGAS_string var_code ;
          callCategoryMethod_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_7736.current_mDeclaration (HERE).ptr (), var_unusedInclusionSet, var_code, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 174)) ;
...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_12912_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE ("syntaxCompilation.gSemantics", 277)).method_searchKey (var_basenameKey, joker_12912_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 277)) ;
  }else if (kBoolFalse == test_0) {
    var_syntaxComponentRoot.drop () ;
    C_String syntaxDirectedTranslationResult_12973 ;
    cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_12973, constinArgument_inSourceFile, var_syntaxComponentRoot  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 279)) ;
    {
...
void routine_groupSyntaxComponentsGalgas_33_ (const GALGAS_galgas_33_SyntaxComponentListAST constinArgument_inAllSyntaxComponents,
  ...
  cEnumerator_galgas_33_SyntaxComponentListAST enumerator_13982 (constinArgument_inAllSyntaxComponents, kEnumeration_up) ;
  while (enumerator_13982.hasCurrentObject ()) {
    var_syntaxComponentNames.addAssign_operation (enumerator_13982.current (HERE).mAttribute_mSyntaxComponentName.mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 304)) ;
  ...
  cEnumerator_stringset enumerator_14186 (var_syntaxComponentNames, kEnumeration_up) ;
  while (enumerator_14186.hasCurrentObject ()) {
    ...
    cEnumerator_galgas_33_SyntaxComponentListAST enumerator_14494 (constinArgument_inAllSyntaxComponents, kEnumeration_up) ;
    while (enumerator_14494.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_14494.current (HERE).mAttribute_mSyntaxComponentName.mAttribute_string.objectCompare (enumerator_14186.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_componentName = enumerator_14494.current (HERE).mAttribute_mSyntaxComponentName ;
        ...
        if (kBoolTrue == test_1) {
          var_importedLexiqueName = enumerator_14494.current (HERE).mAttribute_mImportedLexiqueFilePath ;
        }else if (kBoolFalse == test_1) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_14494.current (HERE).mAttribute_mImportedLexiqueFilePath.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (GALGAS_bool (kIsNotEqual, var_importedLexiqueName.mAttribute_string.objectCompare (enumerator_14494.current (HERE).mAttribute_mImportedLexiqueFilePath.mAttribute_string)) COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 318)).boolEnum () ;
          if (kBoolTrue == test_2) {
            GALGAS_location location_3 (enumerator_14494.current (HERE).mAttribute_mImportedLexiqueFilePath.reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_nonterminalDeclarationList.dotAssign_operation (enumerator_14494.current (HERE).mAttribute_mNonterminalDeclarationList  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 322)) ;
        var_ruleList.dotAssign_operation (enumerator_14494.current (HERE).mAttribute_mRuleList  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 323)) ;
        const enumGalgasBool test_5 = enumerator_14494.current (HERE).mAttribute_mHasTranslateFeature.boolEnum () ;
        if (kBoolTrue == test_5) {
...
void routine_compileSyntaxComponentGalgas_33_ (const GALGAS_galgas_33_SyntaxComponentListAST_2D_element constinArgument_inSyntaxComponentRoot,
  ...
  cEnumerator_indexingListAST enumerator_19109 (var_indexingListAST, kEnumeration_up) ;
  while (enumerator_19109.hasCurrentObject ()) {
    var_indexNameSet.addAssign_operation (enumerator_19109.current_mIndexName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 417)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    GALGAS_syntaxDeclarationForGeneration joker_19858_0 ; // Joker input parameter
    routine_semanticAnalysisOfSyntaxComponent (constinArgument_inSyntaxComponentRoot.mAttribute_mNonterminalDeclarationList, constinArgument_inSyntaxComponentRoot.mAttribute_mRuleList, var_componentName, var_lexiqueName, constinArgument_inSemanticContext, var_predefinedTypes, var_terminalMap, var_indexNameSet, var_hasIndexing, constinArgument_inSyntaxComponentRoot.mAttribute_mHasTranslateFeature, joker_19858_0, inCompiler  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 424)) ;
    }
    {
