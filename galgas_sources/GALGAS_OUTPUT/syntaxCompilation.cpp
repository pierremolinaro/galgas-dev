    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_4) {
        ...
        while (enumerator_8531.hasCurrentObject ()) {
          ...
          GALGAS_lstring joker_9774_0 ; // Joker input parameter
          GALGAS_formalParameterListForGeneration joker_9777_0 ; // Joker input parameter
          GALGAS_formalParameterSignature joker_9780_0 ; // Joker input parameter
          GALGAS_location joker_9783_0 ; // Joker input parameter
          enumerator_8531.current_mLabelImplementationList (HERE).method_first (joker_9774_0, joker_9777_0, joker_9780_0, joker_9783_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 207)) ;
          ...
          if (kBoolTrue == test_5) {
            GALGAS_semanticInstructionListForGeneration var_instructionList ;
            GALGAS_lstring joker_10916_0 ; // Joker input parameter
            GALGAS_formalParameterListForGeneration joker_10919_0 ; // Joker input parameter
            GALGAS_formalParameterSignature joker_10922_0 ; // Joker input parameter
            GALGAS_location joker_10925_0 ; // Joker input parameter
            enumerator_8531.current_mLabelImplementationList (HERE).method_first (joker_10916_0, joker_10919_0, joker_10922_0, joker_10925_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 229)) ;
...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_12935_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE ("syntaxCompilation.gSemantics", 276)).method_searchKey (var_basenameKey, joker_12935_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 276)) ;
  }else if (kBoolFalse == test_0) {
    var_syntaxComponentRoot.drop () ;
    C_String syntaxDirectedTranslationResult_12996 ;
    cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_12996, constinArgument_inSourceFile, var_syntaxComponentRoot  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 278)) ;
    {
...
void routine_compileAllSyntaxComponentsGalgas_33_ (const GALGAS_galgas_33_SyntaxComponentListAST constinArgument_inAllSyntaxComponents,
  ...
  cEnumerator_galgas_33_SyntaxComponentListAST enumerator_14111 (constinArgument_inAllSyntaxComponents, kEnumeration_up) ;
  while (enumerator_14111.hasCurrentObject ()) {
    var_syntaxComponentNames.addAssign_operation (enumerator_14111.current (HERE).mAttribute_mSyntaxComponentName.mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 305)) ;
  ...
  cEnumerator_stringset enumerator_14315 (var_syntaxComponentNames, kEnumeration_up) ;
  while (enumerator_14315.hasCurrentObject ()) {
    ...
    cEnumerator_galgas_33_SyntaxComponentListAST enumerator_14623 (constinArgument_inAllSyntaxComponents, kEnumeration_up) ;
    while (enumerator_14623.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_14623.current (HERE).mAttribute_mSyntaxComponentName.mAttribute_string.objectCompare (enumerator_14315.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_componentName = enumerator_14623.current (HERE).mAttribute_mSyntaxComponentName ;
        ...
        if (kBoolTrue == test_1) {
          var_importedLexiqueName = enumerator_14623.current (HERE).mAttribute_mImportedLexiqueFilePath ;
        }else if (kBoolFalse == test_1) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_14623.current (HERE).mAttribute_mImportedLexiqueFilePath.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (GALGAS_bool (kIsNotEqual, var_importedLexiqueName.mAttribute_string.objectCompare (enumerator_14623.current (HERE).mAttribute_mImportedLexiqueFilePath.mAttribute_string)) COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 319)).boolEnum () ;
          if (kBoolTrue == test_2) {
            GALGAS_location location_3 (enumerator_14623.current (HERE).mAttribute_mImportedLexiqueFilePath.reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_nonterminalDeclarationList.dotAssign_operation (enumerator_14623.current (HERE).mAttribute_mNonterminalDeclarationList  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 323)) ;
        var_ruleList.dotAssign_operation (enumerator_14623.current (HERE).mAttribute_mRuleList  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 324)) ;
        const enumGalgasBool test_5 = enumerator_14623.current (HERE).mAttribute_mHasTranslateFeature.boolEnum () ;
        if (kBoolTrue == test_5) {
  ...
  cEnumerator_galgas_33_SyntaxComponentListAST enumerator_15869 (var_allGroupedSyntaxComponents, kEnumeration_up) ;
  while (enumerator_15869.hasCurrentObject ()) {
    {
    routine_compileSyntaxComponentGalgas_33_ (enumerator_15869.current (HERE), constinArgument_inSemanticContext, ioArgument_ioParsedSyntaxComponentMap, ioArgument_ioSyntaxListForGeneration, inCompiler  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 342)) ;
    }
...
void routine_compileSyntaxComponentGalgas_33_ (const GALGAS_galgas_33_SyntaxComponentListAST_2D_element constinArgument_inSyntaxComponentRoot,
  ...
  cEnumerator_indexingListAST enumerator_16885 (var_indexingListAST, kEnumeration_up) ;
  while (enumerator_16885.hasCurrentObject ()) {
    var_indexNameSet.addAssign_operation (enumerator_16885.current_mIndexName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 370)) ;
...
void routine_generateSyntaxComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  while (enumerator_20433.hasCurrentObject ()) {
    ...
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    GALGAS_lstring joker_21557_0 ; // Joker input parameter
    GALGAS_formalParameterListForGeneration joker_21560_0 ; // Joker input parameter
    GALGAS_formalParameterSignature joker_21563_0 ; // Joker input parameter
    GALGAS_location joker_21566_0 ; // Joker input parameter
    enumerator_20433.current_mLabelImplementationList (HERE).method_first (joker_21557_0, joker_21560_0, joker_21563_0, joker_21566_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 472)) ;
    GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 473))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 473)).operator_concat (GALGAS_string ("::rule_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 473)).operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 474))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 474)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 474)).operator_concat (enumerator_20433.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 475))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 474)).operator_concat (GALGAS_string ("_i")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 475)).operator_concat (enumerator_20433.current_mRuleIndex (HERE).reader_string (SOURCE_FILE ("syntaxCompilation.gSemantics", 476))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 476)).operator_concat (GALGAS_string ("_parse")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 476)) ;
    var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------------------------------------------------*\n"
    ...
    if (kBoolTrue == test_1) {
      GALGAS_semanticInstructionListForGeneration var_instructionList ;
      GALGAS_lstring joker_22628_0 ; // Joker input parameter
      GALGAS_formalParameterListForGeneration joker_22631_0 ; // Joker input parameter
      GALGAS_formalParameterSignature joker_22634_0 ; // Joker input parameter
      GALGAS_location joker_22637_0 ; // Joker input parameter
      enumerator_20433.current_mLabelImplementationList (HERE).method_first (joker_22628_0, joker_22631_0, joker_22634_0, joker_22637_0, var_instructionList, inCompiler COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 494)) ;
      GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 495))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 495)).operator_concat (GALGAS_string ("::rule_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 495)).operator_concat (var_componentName.reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 496))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 496)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 496)).operator_concat (enumerator_20433.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("syntaxCompilation.gSemantics", 497))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 496)).operator_concat (GALGAS_string ("_i")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 497)).operator_concat (enumerator_20433.current_mRuleIndex (HERE).reader_string (SOURCE_FILE ("syntaxCompilation.gSemantics", 498))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 498)).operator_concat (GALGAS_string ("_indexing")  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 498)) ;
      var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------------------------------------------------*\n"
  ...
  cEnumerator_grammarMap enumerator_23774 (constinArgument_inSemanticContext.mAttribute_mGrammarMap, kEnumeration_up) ;
  while (enumerator_23774.hasCurrentObject ()) {
    var_cppInclusionSet.addAssign_operation (GALGAS_string ("grammar-").operator_concat (enumerator_23774.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 520))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 520)) ;
    enumerator_23774.gotoNextObject () ;
  }
  cEnumerator_optionComponentMapForSemanticAnalysis enumerator_23911 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
  while (enumerator_23911.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_23911.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("syntaxCompilation.gSemantics", 523)).boolEnum () ;
    if (kBoolTrue == test_3) {
      var_cppInclusionSet.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_23911.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 524))  COMMA_SOURCE_FILE ("syntaxCompilation.gSemantics", 524)) ;
    }
