...
//                    september 24th, 2010, at 15h47'26"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8718 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8718.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)), var_cas_lexiqueName, var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (179))) ;
    {
      ...
      while (((operand_8420 = enumerator_8420.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8420->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8420->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (182)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (184)) ;
  }
  const GGS_bool cond_11149 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (195))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11149.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)), var_cas_implementationIncludeList) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9018 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_9018 = NULL ;
      while (((operand_9018 = enumerator_9018.nextObject ()))) {
        macroValidPointer (operand_9018) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9018->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9018->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (201)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9018->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9018->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (202)))) ;
      }
    }
    ...
    {
      GGS_ruleDeclarationList::cEnumerator enumerator_9391 (var_cas_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), true) ;
      const GGS_ruleDeclarationList::cElement * operand_9391 = NULL ;
      while (((operand_9391 = enumerator_9391.nextObject ()))) {
        macroValidPointer (operand_9391) ;
        {
          GGS_ruleLabelImplementationList::cEnumerator enumerator_9485 (operand_9391->mLabelImplementationList, true) ;
          const GGS_ruleLabelImplementationList::cElement * operand_9485 = NULL ;
          while (((operand_9485 = enumerator_9485.nextObject ()))) {
            macroValidPointer (operand_9485) ;
            const GGS_string var_cas_ruleName = (((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9391->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9391->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211)))).operator_concat (GGS_string ("_"))).operator_concat (operand_9485->mLabelName.ggs_string ().reader_identifierRepresentation ()) ;
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9485->mSignatureForGeneration, operand_9485->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (212))) ;
          }
        }
        const GGS_bool cond_10902 = operand_9391->mHasParseLabel ;
        if (cond_10902.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10280_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10280_1 ;
          GGS_formalParameterSignature  automatic_var_10280_2 ;
          GGS_location  automatic_var_10280_3 ;
          if (operand_9391->mLabelImplementationList.isBuilt ()) {
            operand_9391->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10280_0, automatic_var_10280_1, automatic_var_10280_2, automatic_var_10280_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (224)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9391->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9391->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (228)))).operator_concat (GGS_string ("_parse")) ;
