...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    {
      cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (302)) ;
    }
    {
