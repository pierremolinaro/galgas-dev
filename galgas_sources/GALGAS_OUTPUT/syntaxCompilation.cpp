...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8848 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8848.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_syntaxFileGenerationTemplate_syntaxFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)), var_cas_lexiqueName, var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (179))) ;
    {
      ...
      while (((operand_8420 = enumerator_8420.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_8420->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8420->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (182)))) ;
      }
    }
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8549 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8549 = NULL ;
      while (((operand_8549 = enumerator_8549.nextObject ()))) {
        macroValidPointer (operand_8549) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_8549->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8549->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (185)))) ;
      }
    }
  ...
  const GGS_bool cond_11279 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11279.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9148 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_9148 = NULL ;
      while (((operand_9148 = enumerator_9148.nextObject ()))) {
        macroValidPointer (operand_9148) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9148->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9148->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (204)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9148->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9148->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (205)))) ;
      }
    }
    const GGS_string var_cas_lexiqueCppName = (GGS_string ("C_Lexique_")).operator_concat (var_cas_syntaxComponentRoot.reader_mImportedLexiqueFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ().reader_identifierRepresentation ()) ;
    {
      GGS_ruleDeclarationList::cEnumerator enumerator_9521 (var_cas_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (209)), true) ;
      const GGS_ruleDeclarationList::cElement * operand_9521 = NULL ;
      while (((operand_9521 = enumerator_9521.nextObject ()))) {
        macroValidPointer (operand_9521) ;
        {
          GGS_ruleLabelImplementationList::cEnumerator enumerator_9615 (operand_9521->mLabelImplementationList, true) ;
          const GGS_ruleLabelImplementationList::cElement * operand_9615 = NULL ;
          while (((operand_9615 = enumerator_9615.nextObject ()))) {
            macroValidPointer (operand_9615) ;
            const GGS_string var_cas_ruleName = (((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9521->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9521->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)))).operator_concat (GGS_string ("_"))).operator_concat (operand_9615->mLabelName.ggs_string ().reader_identifierRepresentation ()) ;
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9615->mSignatureForGeneration, operand_9615->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (215))) ;
          }
        }
        const GGS_bool cond_11032 = operand_9521->mHasParseLabel ;
        if (cond_11032.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10410_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10410_1 ;
          GGS_formalParameterSignature  automatic_var_10410_2 ;
          GGS_location  automatic_var_10410_3 ;
          if (operand_9521->mLabelImplementationList.isBuilt ()) {
            operand_9521->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10410_0, automatic_var_10410_1, automatic_var_10410_2, automatic_var_10410_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (227)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9521->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9521->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)))).operator_concat (GGS_string ("_parse")) ;
          var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, GGS_formalParameterListForGeneration ::constructor_emptyList (), function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (235)), GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (232))) ;
        }
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
