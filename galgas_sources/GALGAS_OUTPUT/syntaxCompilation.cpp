...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_10096 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (191))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10096.isBuiltAndTrue ()) {
    ...
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
