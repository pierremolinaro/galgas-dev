...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_11224 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11224.isBuiltAndTrue ()) {
      ...
      while (((operand_9466 = enumerator_9466.nextObject ()))) {
        macroValidPointer (operand_9466) ;
        {
          ...
          while (((operand_9560 = enumerator_9560.nextObject ()))) {
            ...
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9560->mSignatureForGeneration, operand_9560->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (212))) ;
          }
        }
        const GGS_bool cond_10977 = operand_9466->mHasParseLabel ;
        if (cond_10977.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10355_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10355_1 ;
          GGS_formalParameterSignature  automatic_var_10355_2 ;
          GGS_location  automatic_var_10355_3 ;
          if (operand_9466->mLabelImplementationList.isBuilt ()) {
            operand_9466->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10355_0, automatic_var_10355_1, automatic_var_10355_2, automatic_var_10355_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (224)) ;
          }
