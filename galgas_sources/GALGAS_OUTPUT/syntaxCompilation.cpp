...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8885 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (175))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8885.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_8457 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_8457 = NULL ;
      while (((operand_8457 = enumerator_8457.nextObject ()))) {
        macroValidPointer (operand_8457) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_8457->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8457->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (183)))) ;
      }
    }
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_8586 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_8586 = NULL ;
      while (((operand_8586 = enumerator_8586.nextObject ()))) {
        macroValidPointer (operand_8586) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_8586->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8586->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (186)))) ;
      }
    }
  ...
  const GGS_bool cond_11316 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (199))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11316.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_9185 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_9185 = NULL ;
      while (((operand_9185 = enumerator_9185.nextObject ()))) {
        macroValidPointer (operand_9185) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9185->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9185->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (205)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9185->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9185->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (206)))) ;
      }
    }
    ...
    {
      GGS_ruleDeclarationList::cEnumerator enumerator_9558 (var_cas_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (210)), true) ;
      const GGS_ruleDeclarationList::cElement * operand_9558 = NULL ;
      while (((operand_9558 = enumerator_9558.nextObject ()))) {
        macroValidPointer (operand_9558) ;
        {
          GGS_ruleLabelImplementationList::cEnumerator enumerator_9652 (operand_9558->mLabelImplementationList, true) ;
          const GGS_ruleLabelImplementationList::cElement * operand_9652 = NULL ;
          while (((operand_9652 = enumerator_9652.nextObject ()))) {
            macroValidPointer (operand_9652) ;
            const GGS_string var_cas_ruleName = (((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9558->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9558->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215)))).operator_concat (GGS_string ("_"))).operator_concat (operand_9652->mLabelName.ggs_string ().reader_identifierRepresentation ()) ;
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9652->mSignatureForGeneration, operand_9652->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (216))) ;
          }
        }
        const GGS_bool cond_11069 = operand_9558->mHasParseLabel ;
        if (cond_11069.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10447_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10447_1 ;
          GGS_formalParameterSignature  automatic_var_10447_2 ;
          GGS_location  automatic_var_10447_3 ;
          if (operand_9558->mLabelImplementationList.isBuilt ()) {
            operand_9558->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10447_0, automatic_var_10447_1, automatic_var_10447_2, automatic_var_10447_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (228)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9558->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9558->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (232)))).operator_concat (GGS_string ("_parse")) ;
