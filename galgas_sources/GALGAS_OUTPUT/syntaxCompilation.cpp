...
void routine_compileSyntaxComponent (C_Compiler & inLexique,
  ...
  ::routine_performSemanticAnalysis (inLexique,  var_cas_syntaxComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (168)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (168)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (167)) ;
  var_cas_decoratedDeclarationListForGeneration.addAssign_operation (var_cas_syntaxDeclarationForGeneration) ;
  const GGS_bool cond_8910 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8910.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8468 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8468 = NULL ;
      while (((operand_8468 = enumerator_8468.nextObject ()))) {
        macroValidPointer (operand_8468) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_8468->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8468->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (182)))) ;
      }
    }
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8612 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8612 = NULL ;
      while (((operand_8612 = enumerator_8612.nextObject ()))) {
        macroValidPointer (operand_8612) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8612->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8612->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (185)))) ;
      }
    }
  ...
  const GGS_bool cond_11425 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11425.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9210 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_9210 = NULL ;
      while (((operand_9210 = enumerator_9210.nextObject ()))) {
        macroValidPointer (operand_9210) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_9210->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9210->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (204)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9210->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9210->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (205)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9210->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9210->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (206)))) ;
      }
    }
    ...
    {
      GGS_ruleDeclarationList::cEnumerator enumerator_9667 (var_cas_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (210)), true) ;
      const GGS_ruleDeclarationList::cElement * operand_9667 = NULL ;
      while (((operand_9667 = enumerator_9667.nextObject ()))) {
        macroValidPointer (operand_9667) ;
        {
          GGS_ruleLabelImplementationList::cEnumerator enumerator_9761 (operand_9667->mLabelImplementationList, true) ;
          const GGS_ruleLabelImplementationList::cElement * operand_9761 = NULL ;
          while (((operand_9761 = enumerator_9761.nextObject ()))) {
            macroValidPointer (operand_9761) ;
            const GGS_string var_cas_ruleName = (((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9667->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9667->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215)))).operator_concat (GGS_string ("_"))).operator_concat (operand_9761->mLabelName.ggs_string ().reader_identifierRepresentation ()) ;
            var_cas_implementationString.dotAssign_operation (function_generateProcedure (inLexique, var_cas_ruleName, operand_9761->mSignatureForGeneration, operand_9761->mInstructionListForGeneration, GGS_bool (false), var_cas_lexiqueCppName, GGS_bool (false), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (216))) ;
          }
        }
        const GGS_bool cond_11178 = operand_9667->mHasParseLabel ;
        if (cond_11178.isBuiltAndTrue ()) {
          GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
          GGS_lstring  automatic_var_10556_0 ;
          GGS_formalParameterListForGeneration  automatic_var_10556_1 ;
          GGS_formalParameterSignature  automatic_var_10556_2 ;
          GGS_location  automatic_var_10556_3 ;
          if (operand_9667->mLabelImplementationList.isBuilt ()) {
            operand_9667->mLabelImplementationList (HERE)->method_first (inLexique, automatic_var_10556_0, automatic_var_10556_1, automatic_var_10556_2, automatic_var_10556_3, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (228)) ;
          }
          const GGS_string var_cas_ruleName = ((((((((GGS_string ("cParser_")).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("::rule_"))).operator_concat (var_cas_componentName.ggs_string ().reader_identifierRepresentation ())).operator_concat (GGS_string ("_"))).operator_concat (operand_9667->mNonterminalName.reader_identifierRepresentation ())).operator_concat (GGS_string ("_i"))).operator_concat (operand_9667->mRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (232)))).operator_concat (GGS_string ("_parse")) ;
