...
void routine_compileSyntaxComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_semanticDeclarationSortedListForGeneration enumerator_8681 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
      while (enumerator_8681.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_8681.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
        enumerator_8681.gotoNextObject () ;
      }
      cEnumerator_semanticDeclarationSortedListForGeneration enumerator_8816 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
      while (enumerator_8816.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_8816.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)) ;
      ...
      if (kBoolTrue == test_4) {
        ...
        cEnumerator_semanticDeclarationSortedListForGeneration enumerator_9484 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
        while (enumerator_9484.hasCurrentObject ()) {
          var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_9484.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)) ;
          var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_9484.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
        ...
        cEnumerator_ruleDeclarationList enumerator_9935 (var_syntaxDeclarationForGeneration.reader_mRuleDeclarationList (SOURCE_FILE_AT_LINE (216)), kEnumeration_up) ;
        while (enumerator_9935.hasCurrentObject ()) {
          cEnumerator_ruleLabelImplementationList enumerator_10029 (enumerator_9935.current_mLabelImplementationList (HERE), kEnumeration_up) ;
          while (enumerator_10029.hasCurrentObject ()) {
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (enumerator_9935.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (enumerator_9935.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (enumerator_10029.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
              "\n") COMMA_SOURCE_FILE_AT_LINE (224)) ;
            var_implementationString.dotAssign_operation (function_generateProcedure (var_ruleName, enumerator_10029.current_mSignatureForGeneration (HERE), enumerator_10029.current_mInstructionListForGeneration (HERE), GALGAS_bool (false), var_lexiqueCppName, GALGAS_bool (false), GALGAS_bool (false), constinArgument_inSyntaxComponentRoot.mAttribute_mHasTranslateFeature, inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) COMMA_SOURCE_FILE_AT_LINE (225)) ;
            enumerator_10029.gotoNextObject () ;
          }
          GALGAS_semanticInstructionListForGeneration var_instructionList ;
          GALGAS_lstring joker_11063_0 ; // Joker input parameter
          GALGAS_formalParameterListForGeneration joker_11066_0 ; // Joker input parameter
          GALGAS_formalParameterSignature joker_11069_0 ; // Joker input parameter
          GALGAS_location joker_11072_0 ; // Joker input parameter
          enumerator_9935.current_mLabelImplementationList (HERE).method_first (joker_11063_0, joker_11066_0, joker_11069_0, joker_11072_0, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (238)) ;
          GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (240)) COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (enumerator_9935.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (241)) COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (enumerator_9935.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("_parse") COMMA_SOURCE_FILE_AT_LINE (242)) ;
          var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
          ...
          if (kBoolTrue == test_5) {
            GALGAS_semanticInstructionListForGeneration var_instructionList ;
            GALGAS_lstring joker_12096_0 ; // Joker input parameter
            GALGAS_formalParameterListForGeneration joker_12099_0 ; // Joker input parameter
            GALGAS_formalParameterSignature joker_12102_0 ; // Joker input parameter
            GALGAS_location joker_12105_0 ; // Joker input parameter
            enumerator_9935.current_mLabelImplementationList (HERE).method_first (joker_12096_0, joker_12099_0, joker_12102_0, joker_12105_0, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (257)) ;
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (enumerator_9935.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (enumerator_9935.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (261)) COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (GALGAS_string ("_indexing") COMMA_SOURCE_FILE_AT_LINE (261)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_13980_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (300)).method_searchKey (var_basenameKey, joker_13980_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) ;
  }else if (kBoolFalse == test_0) {
    C_String syntaxDirectedTranslationResult_14041 ;
    cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_14041, constinArgument_inSourceFile, var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (302)) ;
    {
