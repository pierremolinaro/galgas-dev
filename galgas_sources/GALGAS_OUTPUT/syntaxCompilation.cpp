...
void routine_compileSyntaxComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (181)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (204)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        ...
        while (enumerator_9888.hasCurrentObject ()) {
          ...
          while (enumerator_9982.hasCurrentObject ()) {
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (218)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (218)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (enumerator_9888.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (enumerator_9888.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (enumerator_9982.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
          ...
          GALGAS_lstring joker_10939_0 ; // Joker input parameter
          GALGAS_formalParameterListForGeneration joker_10942_0 ; // Joker input parameter
          GALGAS_formalParameterSignature joker_10945_0 ; // Joker input parameter
          GALGAS_location joker_10948_0 ; // Joker input parameter
          enumerator_9888.current_mLabelImplementationList (HERE).method_first (joker_10939_0, joker_10942_0, joker_10945_0, joker_10948_0, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) ;
          ...
          if (kBoolTrue == test_5) {
            GALGAS_semanticInstructionListForGeneration var_instructionList ;
            GALGAS_lstring joker_11915_0 ; // Joker input parameter
            GALGAS_formalParameterListForGeneration joker_11918_0 ; // Joker input parameter
            GALGAS_formalParameterSignature joker_11921_0 ; // Joker input parameter
            GALGAS_location joker_11924_0 ; // Joker input parameter
            enumerator_9888.current_mLabelImplementationList (HERE).method_first (joker_11915_0, joker_11918_0, joker_11921_0, joker_11924_0, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)) ;
            GALGAS_string var_ruleName = GALGAS_string ("cParser_").operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("::rule_") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (var_componentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (255)) COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (enumerator_9888.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (GALGAS_string ("_i") COMMA_SOURCE_FILE_AT_LINE (256)).operator_concat (enumerator_9888.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (GALGAS_string ("_indexing") COMMA_SOURCE_FILE_AT_LINE (257)) ;
            var_implementationString.dotAssign_operation (GALGAS_string ("//---------------------------------------------------------------------------*\n"
...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_13719_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (295)).method_searchKey (var_basenameKey, joker_13719_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
