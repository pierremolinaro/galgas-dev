...
_treewalking_routine_optionComponentRoot (C_Compiler & _inLexique,
  ...
  var_cas_generatedUserZone3.modifier_setCapacity (_inLexique, GGS_uint (true, 5000U) SOURCE_FILE_AT_LINE (42)) ;
  ...
  var_cas_generatedUserZone3._dotAssign_operation (var_cas_inBoolOptionMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (103))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (103)).reader_string (_inLexique SOURCE_FILE_AT_LINE (103))) ;
  var_cas_generatedUserZone3.writeCstringConstant ("] ;\n"
    "  private : uint32 mUintOptionValues [") ;
  var_cas_generatedUserZone3._dotAssign_operation (var_cas_inUIntOptionMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (104))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (104)).reader_string (_inLexique SOURCE_FILE_AT_LINE (104))) ;
  var_cas_generatedUserZone3.writeCstringConstant ("] ;\n"
    "  private : C_String mStringOptionValues [") ;
  var_cas_generatedUserZone3._dotAssign_operation (var_cas_inStringOptionMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (105))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (105)).reader_string (_inLexique SOURCE_FILE_AT_LINE (105))) ;
  var_cas_generatedUserZone3.writeCstringConstant ("] ;\n"
