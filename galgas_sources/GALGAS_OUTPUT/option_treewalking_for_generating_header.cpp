...
_treewalking_routine_optionComponentRoot (C_Compiler & _inLexique,
  ...
  var_cas_generatedUserZone2._dotAssign_operation (_inLexique, var_cas_inOptionComponentName COMMA_SOURCE_FILE_AT_LINE (33)) ;
  var_cas_generatedUserZone2.writeCstringConstant ("_0_DEFINED\n"
    "#define ") ;
  var_cas_generatedUserZone2._dotAssign_operation (_inLexique, var_cas_inOptionComponentName COMMA_SOURCE_FILE_AT_LINE (33)) ;
  var_cas_generatedUserZone2.writeCstringConstant ("_0_DEFINED\n"
    "#include \"command_line_interface/AC_CLI_Options.h\"\n\n") ;
  var_cas_generatedUserZone2._dotAssign_operation (_inLexique, GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (33)) ;
  ...
  var_cas_generatedUserZone3._dotAssign_operation (_inLexique, GGS_string::constructor_CppTitleComment (_inLexique, GGS_string (true, "Command Line Options definitions class") COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (41)) ;
  var_cas_generatedUserZone3.writeCstringConstant ("class ") ;
  var_cas_generatedUserZone3._dotAssign_operation (_inLexique, var_cas_inOptionComponentName COMMA_SOURCE_FILE_AT_LINE (41)) ;
  ...
  var_cas_generatedUserZone3._dotAssign_operation (_inLexique, var_cas_inBoolOptionMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (103))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (103)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
  var_cas_generatedUserZone3.writeCstringConstant ("] ;\n"
    "  private : uint32 mUintOptionValues [") ;
  var_cas_generatedUserZone3._dotAssign_operation (_inLexique, var_cas_inUIntOptionMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (104))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (104)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
  var_cas_generatedUserZone3.writeCstringConstant ("] ;\n"
    "  private : C_String mStringOptionValues [") ;
  var_cas_generatedUserZone3._dotAssign_operation (_inLexique, var_cas_inStringOptionMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (105))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (105)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
  var_cas_generatedUserZone3.writeCstringConstant ("] ;\n"
    "  private : TC_UniqueArray <C_String> mStringValue ;\n"
    "} ;\n\n") ;
  var_cas_generatedUserZone3._dotAssign_operation (_inLexique, GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (41)) ;
  var_cas_generatedUserZone3.writeCstringConstant ("#endif\n") ;
  GGS_string::class_method_generateFile (_inLexique, var_cas_inStartDirectory, (var_cas_inOptionComponentName)._operator_concat (_inLexique, GGS_string (true, ".h") COMMA_SOURCE_FILE_AT_LINE (116)), GGS_string (true, "//"), GGS_string (true, "\n\n"), var_cas_generatedUserZone2, GGS_string (true, "\n\n"), var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (114)) ;
}
