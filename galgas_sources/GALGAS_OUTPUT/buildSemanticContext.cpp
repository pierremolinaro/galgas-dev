  ...
  if (operand_40479 != NULL) {
    ...
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    {
      ...
      while (((operand_41344 = enumerator_41344.nextObject ()))) {
        ...
        var_cas_readerMap.modifier_insertKey (inLexique, operand_41344->mAttributeName, GGS_unifiedTypeMapIndexList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (1125)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
...
category_method__listDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_42326,
                                GGS_semanticContext & var_cas_ioSemanticContext,
                                const GGS_collectedTypeMap   /* var_cas_inCollectedTypeMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_42326 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_42518 (operand_42326->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_42518 = NULL ;
      while (((operand_42518 = enumerator_42518.nextObject ()))) {
        macroValidPointer (operand_42518) ;
        GGS_unifiedTypeMapIndex  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_42518->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1163)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_42518->mAttributeName) ;
      }
    }
    ::routine_addTypeList (inLexique,  var_cas_typedAttributeList,  operand_42326->mListTypeName,  var_cas_ioSemanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (1166)) ;
  }
}
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_42996,
                                GGS_semanticContext & var_cas_ioSemanticContext,
                                const GGS_collectedTypeMap   /* var_cas_inCollectedTypeMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_42996 != NULL) {
    GGS_unifiedTypeMapIndex  var_cas_uintType ;
    ...
    const GGS_bool cond_43398 = (operand_42996->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1183))).operator_isEqual (GGS_string ("")) ;
    if (cond_43398.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapIndex ::constructor_null (inLexique COMMA_HERE) ;
    }else if (cond_43398.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_42996->mSuperClassName, var_cas_ioSemanticContext.mTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1186)) ;
    }
    GGS_unifiedTypeMapIndex  var_cas_classIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_42996->mClassTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1190)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    const GGS_bool cond_44266 = (operand_42996->mIsAbstract).operator_not () ;
    if (cond_44266.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapIndexList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapIndexList ::constructor_emptyList () ;
      {
        GGS_attributeInCollectionListAST::cEnumerator enumerator_43873 (operand_42996->mAttributeList, true) ;
        const GGS_attributeInCollectionListAST::cElement * operand_43873 = NULL ;
        while (((operand_43873 = enumerator_43873.nextObject ()))) {
          macroValidPointer (operand_43873) ;
          GGS_unifiedTypeMapIndex  var_cas_attributeTypeIndex ;
          GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_43873->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1197)) ;
          var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        }
      }
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_44944,
                                GGS_semanticContext & var_cas_ioSemanticContext,
                                const GGS_collectedTypeMap   /* var_cas_inCollectedTypeMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_44944 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_45179 (operand_44944->mFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_45179 = NULL ;
      while (((operand_45179 = enumerator_45179.nextObject ()))) {
        macroValidPointer (operand_45179) ;
        GGS_unifiedTypeMapIndex  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_45179->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1238)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_45179->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_44944->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1242)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_45703,
                                GGS_semanticContext & var_cas_ioSemanticContext,
                                const GGS_collectedTypeMap   /* var_cas_inCollectedTypeMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45703 != NULL) {
    GGS_unifiedTypeMapIndexList  var_cas_functionSignature = GGS_unifiedTypeMapIndexList ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_45939 (operand_45703->mFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_45939 = NULL ;
      while (((operand_45939 = enumerator_45939.nextObject ()))) {
        macroValidPointer (operand_45939) ;
        GGS_unifiedTypeMapIndex  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_45939->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1255)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapIndex  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_45703->mResultTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1260)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_45703->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1262)) ;
  }
}
...
category_method__lazyFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_lazyFunctionDeclarationAST * operand_46619,
                                GGS_semanticContext & var_cas_ioSemanticContext,
                                const GGS_collectedTypeMap   /* var_cas_inCollectedTypeMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46619 != NULL) {
    GGS_unifiedTypeMapIndex  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_46619->mResultTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1273)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_46619->mFunctionName, GGS_unifiedTypeMapIndexList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1275)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_47169,
                                GGS_semanticContext & var_cas_ioSemanticContext,
                                const GGS_collectedTypeMap   var_cas_inCollectedTypeMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47169 != NULL) {
    GGS_semanticDeclarationAST  var_cas_ast ;
    const GGS_collectedTypeMap  temp_47361 = var_cas_inCollectedTypeMap ;
    if (temp_47361.isBuilt ()) {
      temp_47361 (HERE)->method_searchKey (inLexique, operand_47169->mAssociatedListTypeName, var_cas_ast COMMA_SOURCE_FILE_AT_LINE (1286)) ;
    }
    GGS_attributeInCollectionListAST  var_cas_listAttributeList ;
    { const GGS_semanticDeclarationAST _var_47692 = var_cas_ast ; // CAST instruction
      if (_var_47692.getPtr () != NULL) {
        macroValidPointer (_var_47692.getPtr ()) ;
        if (typeid (cPtr_listDeclarationAST) == typeid (* (_var_47692.getPtr ()))) {
          const GGS_listDeclarationAST var_cas_listAST (_var_47692.getPtr ()) ;
          var_cas_listAttributeList = var_cas_listAST.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)) ;
        }else{
          operand_47169->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_47169->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1293)) ;
    ...
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_47169->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1302)) ;
    GGS_unifiedTypeMapIndex  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_47169->mListmapTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1305)) ;
    GGS_unifiedTypeMapIndex  var_cas_stringTypeIndex ;
    ...
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_47169->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapIndex ::constructor_null (inLexique COMMA_HERE), GGS_typeKindEnum::constructor_mapIndexType (inLexique COMMA_HERE), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_HERE), var_cas_enumeratorDescriptor COMMA_SOURCE_FILE_AT_LINE (1316)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_50136 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_50136 = NULL ;
    while (((operand_50136 = enumerator_50136.nextObject ()))) {
      macroValidPointer (operand_50136) ;
      const GGS_semanticDeclarationAST  temp_50177 = operand_50136->mSemanticDeclaration ;
      if (temp_50177.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (temp_50177.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_50177 (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1354)) ;
        }
      }
    }
  }
  const GGS_bool cond_50430 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_50430.isBuiltAndTrue ()) {
    {
      GGS_semanticDeclarationListAST::cEnumerator enumerator_50323 (var_cas_inSemanticDeclarationList, true) ;
      const GGS_semanticDeclarationListAST::cElement * operand_50323 = NULL ;
      while (((operand_50323 = enumerator_50323.nextObject ()))) {
        macroValidPointer (operand_50323) ;
        const GGS_semanticDeclarationAST  temp_50364 = operand_50323->mSemanticDeclaration ;
        if (temp_50364.isBuilt ()) {
          typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (temp_50364.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_50364 (HERE), var_cas_outSemanticContext, var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1359)) ;
          }
        }
      }
    }
  }
  const GGS_bool cond_51166 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_51166.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_50863 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
    if (cond_50863.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
      {
        GGS_stringlist::cEnumerator enumerator_50739 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_50739 = NULL ;
        while (((operand_50739 = enumerator_50739.nextObject ()))) {
          macroValidPointer (operand_50739) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_50739->mValue) ;
        }
      }
    ...
    }else if (cond_50863.isBuiltAndFalse ()) {
      const GGS_bool cond_51155 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
      if (cond_51155.isBuiltAndTrue ()) {
        ...
        {
          GGS_stringlist::cEnumerator enumerator_51033 (var_cas_undefinedClasses, true) ;
          const GGS_stringlist::cElement * operand_51033 = NULL ;
          while (((operand_51033 = enumerator_51033.nextObject ()))) {
            macroValidPointer (operand_51033) ;
            var_cas_errorMessage.appendCString ("\n"
              "-  @") ;
            var_cas_errorMessage.dotAssign_operation (operand_51033->mValue) ;
          }
        }
  ...
  const GGS_bool cond_51541 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_51541.isBuiltAndTrue ()) {
    {
      GGS_unifiedTypeMap::cEnumerator enumerator_51405 (var_cas_outSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)), true) ;
      const GGS_unifiedTypeMap::cElement * operand_51405 = NULL ;
      while (((operand_51405 = enumerator_51405.nextObject ()))) {
        macroValidPointer (operand_51405) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
