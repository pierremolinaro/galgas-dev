...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << mInfo.mReturnedEntityTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mAllPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
