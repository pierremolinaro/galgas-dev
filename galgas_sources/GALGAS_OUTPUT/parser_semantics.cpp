...
GGS_typeListeBranchesInstructions::cElement * GGS_typeListeBranchesInstructions::
...
GGS_L_parse_rewind_signature_list::cElement * GGS_L_parse_rewind_signature_list::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
void GGS_typeAltProductionsMap::
modifier_setAListeDeTypesEffectifsForKey (C_Compiler & inLexique,                        const GGS_typeListeTypesEtNomsArgMethode & inValue,
...
void GGS_typeAltProductionsMap::
modifier_setMAllInstructionsListForKey (C_Compiler & inLexique,                        const GGS_typeInstructionList & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeAltProductionsMap::
modifier_setMSyntaxSignatureForKey (C_Compiler & inLexique,                        const GGS_L_ruleSyntaxSignature & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeAltProductionsMap::
modifier_setMEndOfInstructionListLocationForKey (C_Compiler & inLexique,                        const GGS_location & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
