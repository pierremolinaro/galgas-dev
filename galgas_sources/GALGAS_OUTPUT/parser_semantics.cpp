...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "parser_semantics.ggs", line
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeParserInstruction & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
...
GGS_bool GGS_typeParserInstruction::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeParserInstruction & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    equal = mNonterminalName._operator_isEqual (_inLexique, _p->mNonterminalName THERE).boolValue ()
         && mParametersExpressionList._operator_isEqual (_inLexique, _p->mParametersExpressionList THERE).boolValue ()
         && mAltName._operator_isEqual (_inLexique, _p->mAltName THERE).boolValue ()
         && mReturnedEntityVarName._operator_isEqual (_inLexique, _p->mReturnedEntityVarName THERE).boolValue ()
         && mReturnedEntityName._operator_isEqual (_inLexique, _p->mReturnedEntityName THERE).boolValue ()
         && mReturnedEntityShouldInsertedInList._operator_isEqual (_inLexique, _p->mReturnedEntityShouldInsertedInList THERE).boolValue () ;
  }
  return equal ;
}
...
GGS_bool GGS_typeInstructionAppelNonTerminal::
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeInstructionAppelNonTerminal & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_typeInstructionAppelNonTerminal::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeInstructionAppelNonTerminal & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = aNomTerminal._operator_isEqual (_inLexique, _p->aNomTerminal THERE).boolValue ()
         && aListeTypeEffectifs._operator_isEqual (_inLexique, _p->aListeTypeEffectifs THERE).boolValue ()
         && mLexiqueClassName._operator_isEqual (_inLexique, _p->mLexiqueClassName THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeInstructionVerifSyntaxique & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_typeInstructionVerifSyntaxique::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeInstructionVerifSyntaxique & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mInstructionList._operator_isEqual (_inLexique, _p->mInstructionList THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeListeBranchesInstructions & inOperand
                   COMMA_LOCATION_ARGS) const {
...
GGS_bool GGS_typeListeBranchesInstructions::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeListeBranchesInstructions & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
...
_operator_concat (C_Compiler & _inLexique, const GGS_typeListeBranchesInstructions & inOperand COMMA_LOCATION_ARGS) const {
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = mIFbranchesList._operator_isEqual (_inLexique, _p->mIFbranchesList THERE).boolValue ()
         && aPositionDebut._operator_isEqual (_inLexique, _p->aPositionDebut THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_C_select_instruction & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_C_select_instruction::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_C_select_instruction & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = aListesBranchesRepeter._operator_isEqual (_inLexique, _p->aListesBranchesRepeter THERE).boolValue ()
         && aPositionDebut._operator_isEqual (_inLexique, _p->aPositionDebut THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_C_repeat_instruction & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_C_repeat_instruction::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_C_repeat_instruction & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mSignature._operator_isEqual (_inLexique, _p->mSignature THERE).boolValue ()
         && mErrorLocation._operator_isEqual (_inLexique, _p->mErrorLocation THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_L_parse_rewind_signature_list & inOperand
                   COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), isEqualToList (_inLexique, inOperand THERE)) ;
}
...
GGS_bool GGS_L_parse_rewind_signature_list::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_L_parse_rewind_signature_list & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
...
_operator_concat (C_Compiler & _inLexique, const GGS_L_parse_rewind_signature_list & inOperand COMMA_LOCATION_ARGS) const {
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_inLexique, _p->mInstructionLocation THERE).boolValue ()
         && mBranchList._operator_isEqual (_inLexique, _p->mBranchList THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_C_parse_rewind_instruction & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_C_parse_rewind_instruction::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_C_parse_rewind_instruction & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = mIFbranchesList._operator_isEqual (_inLexique, _p->mIFbranchesList THERE).boolValue ()
         && mElseInstructionsList._operator_isEqual (_inLexique, _p->mElseInstructionsList THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_C_parse_when_else_instruction & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_C_parse_when_else_instruction::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_C_parse_when_else_instruction & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = aNomNonTerminal._operator_isEqual (_inLexique, _p->aNomNonTerminal THERE).boolValue ()
         && mNonterminalSymbolParametersMap._operator_isEqual (_inLexique, _p->mNonterminalSymbolParametersMap THERE).boolValue ()
         && mLexiqueClassName._operator_isEqual (_inLexique, _p->mLexiqueClassName THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeNonterminalToGenerate & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_typeNonterminalToGenerate::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeNonterminalToGenerate & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
...
isEqualToMapElement (C_Compiler & _inLexique, const AC_galgas_map_element * inOperand COMMA_LOCATION_ARGS) const {
  const elementOf_GGS_typeAltProductionsMap * _p = dynamic_cast <const elementOf_GGS_typeAltProductionsMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.aListeDeTypesEffectifs._operator_isEqual (_inLexique, _p->mInfo.aListeDeTypesEffectifs THERE)).boolValue ()
           && (mInfo.mAllInstructionsList._operator_isEqual (_inLexique, _p->mInfo.mAllInstructionsList THERE)).boolValue ()
           && (mInfo.mSyntaxSignature._operator_isEqual (_inLexique, _p->mInfo.mSyntaxSignature THERE)).boolValue ()
           && (mInfo.mEndOfInstructionListLocation._operator_isEqual (_inLexique, _p->mInfo.mEndOfInstructionListLocation THERE)).boolValue ()
           && (mInfo.mReturnedEntityTypeName._operator_isEqual (_inLexique, _p->mInfo.mReturnedEntityTypeName THERE)).boolValue ()
           && (mInfo.mMDAResultVariableName._operator_isEqual (_inLexique, _p->mInfo.mMDAResultVariableName THERE)).boolValue ()
           && (mInfo.mAllPropertiesMap._operator_isEqual (_inLexique, _p->mInfo.mAllPropertiesMap THERE)).boolValue () ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeAltProductionsMap & inOperand
                   COMMA_LOCATION_ARGS) const {
...
GGS_bool GGS_typeAltProductionsMap::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeAltProductionsMap & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToMap (_inLexique, inOperand THERE)) ;
}
...
_insertElement (C_Compiler & inLexique,
  ...
  sint32 elementID = - 1 ;
  if (_isBuilt (THERE)
   && inParameter0._isBuilt (THERE)
   && inParameter1._isBuilt (THERE)
   && inParameter2._isBuilt (THERE)
   && inParameter3._isBuilt (THERE)
   && inParameter4._isBuilt (THERE)
   && inParameter5._isBuilt (THERE)
   && inParameter6._isBuilt (THERE)
   && inKey._isBuilt (THERE)) {
    insulateMap () ;
    e_typeAltProductionsMap info  ;
...
_searchElement (C_Compiler & inLexique,
  ...
  if (_isBuilt (THERE) && inKey._isBuilt (THERE)) {
...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = aNomProduction._operator_isEqual (_inLexique, _p->aNomProduction THERE).boolValue ()
         && mAltProductionMap._operator_isEqual (_inLexique, _p->mAltProductionMap THERE).boolValue ()
         && mProductionTagName._operator_isEqual (_inLexique, _p->mProductionTagName THERE).boolValue ()
         && mLexiqueClassName._operator_isEqual (_inLexique, _p->mLexiqueClassName THERE).boolValue ()
         && mHasParseLabel._operator_isEqual (_inLexique, _p->mHasParseLabel THERE).boolValue () ;
  }
  return equal ;
}
...
GGS_bool GGS_typeProductionAengendrer::
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_typeProductionAengendrer & inOperand
                   COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_typeProductionAengendrer::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_typeProductionAengendrer & inOperand COMMA_LOCATION_ARGS) const {
  const bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
