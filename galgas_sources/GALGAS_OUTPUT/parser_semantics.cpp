...
elementOf_GGG_typeListeBranchesInstructions::
elementOf_GGG_typeListeBranchesInstructions (const GGG_typeInstructionsList  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeListeBranchesInstructions *) NULL ;
  mInstructionsList = argument_0 ;
  retain (mInstructionsList COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeListeBranchesInstructions::
~elementOf_GGG_typeListeBranchesInstructions (void) {
  macroRelease (mInstructionsList, this) ;
}
...
elementOf_GGG_L_parse_rewind_signature_list::
elementOf_GGG_L_parse_rewind_signature_list (const GGG_L_ruleSyntaxSignature  *argument_0,
                                const GGG_location  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_L_parse_rewind_signature_list *) NULL ;
  mSignature = argument_0 ;
  retain (mSignature COMMA_HERE) ;
  mErrorLocation = argument_1 ;
  retain (mErrorLocation COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_L_parse_rewind_signature_list::
~elementOf_GGG_L_parse_rewind_signature_list (void) {
  macroRelease (mSignature, this) ;
  macroRelease (mErrorLocation, this) ;
}
...
AC_galgas_map_elementEx * GGS_typeAltProductionsMap::
...
void GGS_typeAltProductionsMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
