...
//                    september 9th, 2007, at 17h43'13"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
mConditionalExpression (argument_2),
mInstructionsList (argument_3) {
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mEndOfInstructionLocation._operator_isEqual (_p->mEndOfInstructionLocation).boolValue ()
         ...
         && mConditionalExpression._operator_isEqual (_p->mConditionalExpression).boolValue ()
         && mInstructionsList._operator_isEqual (_p->mInstructionsList).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@C_parse_loop_instruction:"
           ...
           << mConditionalExpression.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mInstructionsList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_typeExpression  GGS_C_parse_loop_instruction::
reader_mConditionalExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_C_parse_loop_instruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_C_parse_loop_instruction *) mPointer)->mConditionalExpression ;
  }
  return result ;
}
...
reader_mInstructionsList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_typeInstructionList   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_C_parse_loop_instruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_C_parse_loop_instruction *) mPointer)->mInstructionsList ;
  }
  return result ;
}
