...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/Developpements/mes_prgms/galgas/galgas_sources/parser_semantics.ggs" ;
...
mNonterminalName.reader_description () ;
mParametersExpressionList.reader_description () ;
mAltName.reader_description () ;
mReturnedEntityVarName.reader_description () ;
mReturnedEntityShouldInsertedInList.reader_description () ;
}
...
aNomTerminal.reader_description () ;
aListeTypeEffectifs.reader_description () ;
}
...
aPositionDebut.reader_description () ;
}
...
aListesBranchesRepeter.reader_description () ;
aPositionDebut.reader_description () ;
}
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mSignature.reader_description () ;
...
mBranchList.reader_description () ;
}
...
aNomNonTerminal.reader_description () ;
mNonterminalSymbolParametersMap.reader_description () ;
}
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << "->" ;
  ioString << mInfo.aListeDeTypesEffectifs.reader_description () ;
  ioString << mInfo.mAllInstructionsList.reader_description () ;
  ioString << mInfo.mSyntaxSignature.reader_description () ;
  ioString << mInfo.mEndOfInstructionListLocation.reader_description () ;
...
aNomProduction.reader_description () ;
mAltProductionMap.reader_description () ;
mProductionTagName.reader_description () ;
mHasParseLabel.reader_description () ;
}
