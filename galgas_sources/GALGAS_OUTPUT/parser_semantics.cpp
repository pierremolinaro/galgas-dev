...
cPtr_typeInstructionAppelNonTerminal::cPtr_typeInstructionAppelNonTerminal (const GGS_lstring & argument_0,
                                ...
                                const GGS_string& argument_4 COMMA_LOCATION_ARGS)
...
mEntityTypeNameForMultipleReference (argument_4) {
}

//---------------------------------------------------------------------------*

void cPtr_typeInstructionAppelNonTerminal::appendForDescription (C_String & ioString) const {
  ioString << "->@typeInstructionAppelNonTerminal:" ;
mNonterminalName.reader_description ().string () ;
mParametersExpressionList.reader_description ().string () ;
mAltName.reader_description ().string () ;
mReturnedEntityVarName.reader_description ().string () ;
mEntityTypeNameForMultipleReference.reader_description ().string () ;
}
...
void cPtr_typeInstructionVerifSyntaxique::appendForDescription (C_String & ioString) const {
  ioString << "->@typeInstructionVerifSyntaxique:" ;
aNomTerminal.reader_description ().string () ;
aListeTypeEffectifs.reader_description ().string () ;
}
...
elementOf_GGS_typeListeBranchesInstructions (const GGS_typeInstructionsList & argument_0) {
...
GGS_string GGS_typeListeBranchesInstructions::reader_description (void) const {
  C_String s ;
...
void cPtr_C_select_instruction::appendForDescription (C_String & ioString) const {
  ioString << "->@C_select_instruction:" ;
mIFbranchesList.reader_description ().string () ;
aPositionDebut.reader_description ().string () ;
}
...
void cPtr_C_repeat_instruction::appendForDescription (C_String & ioString) const {
  ioString << "->@C_repeat_instruction:" ;
aListesBranchesRepeter.reader_description ().string () ;
aPositionDebut.reader_description ().string () ;
}
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mSignature.reader_description ().string () ;
  ioString << mErrorLocation.reader_description ().string () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_parse_rewind_signature_list::reader_description (void) const {
  C_String s ;
...
void cPtr_C_parse_rewind_instruction::appendForDescription (C_String & ioString) const {
  ioString << "->@C_parse_rewind_instruction:" ;
mInstructionLocation.reader_description ().string () ;
mBranchList.reader_description ().string () ;
}
...
void cPtr_C_parse_when_else_instruction::appendForDescription (C_String & ioString) const {
...
void cPtr_typeNonterminalToGenerate::appendForDescription (C_String & ioString) const {
  ioString << "->@typeNonterminalToGenerate:" ;
aNomNonTerminal.reader_description ().string () ;
mNonterminalSymbolParametersMap.reader_description ().string () ;
}
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << "->" ;
  ioString << mInfo.aListeDeTypesEffectifs.reader_description ().string () ;
  ioString << mInfo.mAllInstructionsList.reader_description ().string () ;
  ioString << mInfo.mSyntaxSignature.reader_description ().string () ;
  ioString << mInfo.mEndOfInstructionListLocation.reader_description ().string () ;
...
void GGS_typeAltProductionsMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_typeListeTypesEtNomsArgMethode & inParameter0,
                                const GGS_typeInstructionsList & inParameter1,
                                const GGS_L_ruleSyntaxSignature & inParameter2,
...
GGS_string GGS_typeAltProductionsMap::reader_description (void) const {
  C_String s ;
...
void cPtr_typeProductionAengendrer::appendForDescription (C_String & ioString) const {
  ioString << "->@typeProductionAengendrer:" ;
aNomProduction.reader_description ().string () ;
mAltProductionMap.reader_description ().string () ;
mProductionTagName.reader_description ().string () ;
mHasParseLabel.reader_description ().string () ;
}
