...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      message1_ (0 COMMA_HERE) << cPtr_typeParserInstruction::_static_message () ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionAppelNonTerminal::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionVerifSyntaxique::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_C_select_instruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_C_repeat_instruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_C_parse_rewind_instruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_C_parse_when_else_instruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeNonterminalToGenerate::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeProductionAengendrer::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
