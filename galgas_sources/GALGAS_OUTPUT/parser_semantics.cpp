...
GGS_typeListeBranchesInstructions::GGS_typeListeBranchesInstructions (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_parse_rewind_signature_list::GGS_L_parse_rewind_signature_list (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
