...
void routine_buildLexicalRoutineMap (C_CompilerEx & inLexique,
                                GGS_lexicalRoutineMap  & var_cas_outLexicalRoutineMap
...
void routine_buildLexicalFunctionMap (C_CompilerEx & inLexique,
                                GGS_lexicalFunctionMap  & var_cas_outLexicalFunctionMap
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_printPredefinedLexicalActions (C_CompilerEx & inLexique
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
  ...
  var_cas_s.appendCString ("**************** Prefined lexical routines  ****************\n") ;
  {
    ...
    while (((operand_25083 = enumerator_25083.nextObject ()))) {
      ...
      var_cas_s.dotAssign_operation (operand_25083->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (476))) ;
      {
        GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_25157 (operand_25083->mInfo.mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalRoutineFormalArgumentList::cElement * operand_25157 = NULL ;
        while (((operand_25157 = enumerator_25157.nextObject ()))) {
          macroValidPointer (operand_25157) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_25157->mLexicalFormalArgumentMode.reader_lexicalFormalModeName (inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
          var_cas_s.appendCString ("@") ;
          var_cas_s.dotAssign_operation (operand_25157->mLexicalFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_25157->mArgumentNameForComment) ;
        }
      }
      {
        GGS_stringlist::cEnumerator enumerator_25367 (operand_25083->mInfo.mErrorMessageList, true) ;
        const GGS_stringlist::cElement * operand_25367 = enumerator_25367.nextObject () ;
        if ((operand_25367 != NULL)) {
          var_cas_s.appendCString (" error") ;
          bool _foreach_loop_25367 ;
          do{
            macroValidPointer (operand_25367) ;
            var_cas_s.appendCString (" ") ;
            var_cas_s.dotAssign_operation (operand_25367->mValue) ;
            operand_25367 = enumerator_25367.nextObject () ;
            _foreach_loop_25367 = ((operand_25367 != NULL)) ;
            if (_foreach_loop_25367) {
              var_cas_s.appendCString (",") ;
            }
          }while (_foreach_loop_25367) ;
        }
      }
      var_cas_s.appendCString (" ;\n") ;
      const GGS_bool cond_25640 = (operand_25083->mInfo.mReplacementRoutineName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_25640.isBuiltAndTrue ()) {
  ...
  {
    GGS_lexicalFunctionMap::cEnumerator enumerator_26006 (var_cas_lexicalFunctionMap, true) ;
    const GGS_lexicalFunctionMap::cElement * operand_26006 = NULL ;
    while (((operand_26006 = enumerator_26006.nextObject ()))) {
      macroValidPointer (operand_26006) ;
      var_cas_s.dotAssign_operation (operand_26006->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (497))) ;
      {
        GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_26063 (operand_26006->mInfo.mLexicalTypeList, true) ;
        const GGS_lexicalFunctionFormalArgumentList::cElement * operand_26063 = NULL ;
        while (((operand_26063 = enumerator_26063.nextObject ()))) {
          macroValidPointer (operand_26063) ;
          var_cas_s.appendCString (" \?@") ;
          var_cas_s.dotAssign_operation (operand_26063->mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (499))) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_26063->mArgumentNameForComment) ;
        }
      }
      var_cas_s.appendCString (" -> @") ;
      var_cas_s.dotAssign_operation (operand_26006->mInfo.mReturnedLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (501))) ;
      var_cas_s.appendCString (" ;\n") ;
      const GGS_bool cond_26408 = (operand_26006->mInfo.mReplacementFunctionName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_26408.isBuiltAndTrue ()) {
        var_cas_s.appendCString ("Note: the '") ;
        var_cas_s.dotAssign_operation (operand_26006->mKey) ;
        var_cas_s.appendCString ("' function is obsolete: use '") ;
        var_cas_s.dotAssign_operation (operand_26006->mInfo.mReplacementFunctionName) ;
