...
void routine_buildLexicalRoutineMap (C_Compiler & inLexique,
  ...
  var_cas_mLexicalRoutineFormalArgumentList = GGS_lexicalRoutineFormalArgumentList ::constructor_emptyList () ;
  var_cas_mErrorMessageList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_mLexicalRoutineFormalArgumentList._addAssign_operation (GGS_lexicalArgumentMode::constructor_lexicalInputMode (inLexique COMMA_HERE), GGS_lexicalTypeEnum::constructor_lexicalType_sint (inLexique COMMA_HERE), GGS_string ("inUnsignedNumber")) ;
  ...
  var_cas_mLexicalRoutineFormalArgumentList = GGS_lexicalRoutineFormalArgumentList ::constructor_emptyList () ;
  var_cas_mErrorMessageList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_mLexicalRoutineFormalArgumentList._addAssign_operation (GGS_lexicalArgumentMode::constructor_lexicalInputMode (inLexique COMMA_HERE), GGS_lexicalTypeEnum::constructor_lexicalType_sint64 (inLexique COMMA_HERE), GGS_string ("inUnsignedNumber")) ;
...
void routine_printPredefinedLexicalActions (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  {
    GGS_lexicalRoutineMap::cEnumerator enumerator_24039 (var_cas_lexicalRoutineMap, true) ;
    const GGS_lexicalRoutineMap::cElement * operand_24039 = NULL ;
    while (((operand_24039 = enumerator_24039.nextObject ()))) {
      macroValidPointer (operand_24039) ;
      var_cas_s.dotAssign_operation (operand_24039->mKey.ggs_string ()) ;
      {
        GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_24103 (operand_24039->mInfo.mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalRoutineFormalArgumentList::cElement * operand_24103 = NULL ;
        while (((operand_24103 = enumerator_24103.nextObject ()))) {
          macroValidPointer (operand_24103) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_24103->mLexicalArgumentMode.reader_lexicalFormalModeName (inLexique COMMA_SOURCE_FILE_AT_LINE (446))) ;
          var_cas_s.dotAssign_operation (operand_24103->mLexicalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (446))) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_24103->mArgumentNameForComment) ;
        }
      }
      {
        GGS_stringlist::cEnumerator enumerator_24283 (operand_24039->mInfo.mErrorMessageList, true) ;
        const GGS_stringlist::cElement * operand_24283 = enumerator_24283.nextObject () ;
        if ((operand_24283 != NULL)) {
          var_cas_s.appendCString (" error") ;
          bool _foreach_loop_24283 ;
          do{
            macroValidPointer (operand_24283) ;
            var_cas_s.appendCString (" ") ;
            var_cas_s.dotAssign_operation (operand_24283->mValue) ;
            operand_24283 = enumerator_24283.nextObject () ;
            _foreach_loop_24283 = ((operand_24283 != NULL)) ;
            if (_foreach_loop_24283) {
              var_cas_s.appendCString (",") ;
            }
          }while (_foreach_loop_24283) ;
        }
      }
      var_cas_s.appendCString (" ;\n") ;
      if (((operand_24039->mInfo.mReplacementRoutineName).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_s.appendCString ("Note: the '") ;
        var_cas_s.dotAssign_operation (operand_24039->mKey) ;
        var_cas_s.appendCString ("' routine is obsolete: use '") ;
        var_cas_s.dotAssign_operation (operand_24039->mInfo.mReplacementRoutineName) ;
  ...
  {
    GGS_lexicalFunctionMap::cEnumerator enumerator_24921 (var_cas_lexicalFunctionMap, true) ;
    const GGS_lexicalFunctionMap::cElement * operand_24921 = NULL ;
    while (((operand_24921 = enumerator_24921.nextObject ()))) {
      macroValidPointer (operand_24921) ;
      var_cas_s.dotAssign_operation (operand_24921->mKey.ggs_string ()) ;
      {
        GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_24968 (operand_24921->mInfo.mLexicalTypeList, true) ;
        const GGS_lexicalFunctionFormalArgumentList::cElement * operand_24968 = NULL ;
        while (((operand_24968 = enumerator_24968.nextObject ()))) {
          macroValidPointer (operand_24968) ;
          var_cas_s.appendCString (" \?") ;
          var_cas_s.dotAssign_operation (operand_24968->mLexicalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (467))) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_24968->mArgumentNameForComment) ;
        }
      }
      var_cas_s.appendCString (" -> ") ;
      var_cas_s.dotAssign_operation (operand_24921->mInfo.mReturnedLexicalType.reader_lexicalTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (469))) ;
      var_cas_s.appendCString (" ;\n"
        "\n") ;
      var_cas_s.appendCString (" ;\n") ;
      if (((operand_24921->mInfo.mReplacementFunctionName).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_s.appendCString ("Note: the '") ;
        var_cas_s.dotAssign_operation (operand_24921->mKey) ;
        var_cas_s.appendCString ("' function is obsolete: use '") ;
        var_cas_s.dotAssign_operation (operand_24921->mInfo.mReplacementFunctionName) ;
  ...
  var_cas_s.appendCString ("************************************************************\n") ;
  inLexique.printMessage (var_cas_s COMMA_SOURCE_FILE_AT_LINE (478)) ;
  #ifdef DEBUG_TRACE_ENABLED
