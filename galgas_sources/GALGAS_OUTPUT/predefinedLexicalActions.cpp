...
void routine_printPredefinedLexicalActions (C_Compiler & inLexique
  ...
  var_cas_s.appendCString ("**************** Prefined lexical routines  ****************\n") ;
  {
    ...
    while (((operand_25083 = enumerator_25083.nextObject ()))) {
      ...
      {
        GGS_lexicalRoutineFormalArgumentList::cEnumerator enumerator_25148 (operand_25083->mInfo.mLexicalRoutineFormalArgumentList, true) ;
        const GGS_lexicalRoutineFormalArgumentList::cElement * operand_25148 = NULL ;
        while (((operand_25148 = enumerator_25148.nextObject ()))) {
          macroValidPointer (operand_25148) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_25148->mLexicalFormalArgumentMode.reader_lexicalFormalModeName (inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
          var_cas_s.appendCString ("@") ;
          var_cas_s.dotAssign_operation (operand_25148->mLexicalFormalArgumentType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_25148->mArgumentNameForComment) ;
        }
      }
      {
        GGS_stringlist::cEnumerator enumerator_25358 (operand_25083->mInfo.mErrorMessageList, true) ;
        const GGS_stringlist::cElement * operand_25358 = enumerator_25358.nextObject () ;
        if ((operand_25358 != NULL)) {
          var_cas_s.appendCString (" error") ;
          bool _foreach_loop_25358 ;
          do{
            macroValidPointer (operand_25358) ;
            var_cas_s.appendCString (" ") ;
            var_cas_s.dotAssign_operation (operand_25358->mValue) ;
            operand_25358 = enumerator_25358.nextObject () ;
            _foreach_loop_25358 = ((operand_25358 != NULL)) ;
            if (_foreach_loop_25358) {
              var_cas_s.appendCString (",") ;
            }
          }while (_foreach_loop_25358) ;
        }
      }
      var_cas_s.appendCString (" ;\n") ;
      const GGS_bool cond_25631 = (operand_25083->mInfo.mReplacementRoutineName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_25631.isBuiltAndTrue ()) {
  ...
  {
    GGS_lexicalFunctionMap::cEnumerator enumerator_25997 (var_cas_lexicalFunctionMap, true) ;
    const GGS_lexicalFunctionMap::cElement * operand_25997 = NULL ;
    while (((operand_25997 = enumerator_25997.nextObject ()))) {
      macroValidPointer (operand_25997) ;
      var_cas_s.dotAssign_operation (operand_25997->mKey.ggs_string ()) ;
      {
        GGS_lexicalFunctionFormalArgumentList::cEnumerator enumerator_26045 (operand_25997->mInfo.mLexicalTypeList, true) ;
        const GGS_lexicalFunctionFormalArgumentList::cElement * operand_26045 = NULL ;
        while (((operand_26045 = enumerator_26045.nextObject ()))) {
          macroValidPointer (operand_26045) ;
          var_cas_s.appendCString (" \?@") ;
          var_cas_s.dotAssign_operation (operand_26045->mLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (499))) ;
          var_cas_s.appendCString (" ") ;
          var_cas_s.dotAssign_operation (operand_26045->mArgumentNameForComment) ;
        }
      }
      var_cas_s.appendCString (" -> @") ;
      var_cas_s.dotAssign_operation (operand_25997->mInfo.mReturnedLexicalType.reader_lexicalTypeBaseName (inLexique COMMA_SOURCE_FILE_AT_LINE (501))) ;
      var_cas_s.appendCString (" ;\n") ;
      const GGS_bool cond_26390 = (operand_25997->mInfo.mReplacementFunctionName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_26390.isBuiltAndTrue ()) {
        var_cas_s.appendCString ("Note: the '") ;
        var_cas_s.dotAssign_operation (operand_25997->mKey) ;
        var_cas_s.appendCString ("' function is obsolete: use '") ;
        var_cas_s.dotAssign_operation (operand_25997->mInfo.mReplacementFunctionName) ;
