...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "galgas_LR1_prgm.ggs" ;
...
grammar_galgas_LR1_prgm::
grammar_galgas_LR1_prgm (const C_galgas_io_parameters & inIOparameters COMMA_LOCATION_ARGS) :
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          grammar_galgas_LR1_prgm * compiler = NULL ;
          macroMyNew (compiler, grammar_galgas_LR1_prgm (IOparameters COMMA_HERE)) ;
          compiler->_prologue () ;
          compiler->doCompilation (sourceFilesArray (i COMMA_HERE), verboseOptionOn, r) ;
          compiler->_epilogue () ;
          macroMyDelete (compiler, grammar_galgas_LR1_prgm) ;
        }else{
