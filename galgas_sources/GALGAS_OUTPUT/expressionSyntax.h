...
//--- Rule declarations
  ...
  protected : void rule_expressionSyntax_collection_5F_value_5F_element_i30_ (GALGAS_abstractCollectionValueElement & outArgument0,
                                                                              C_String & ioSyntaxDirectedTranslationResult,
                                                                              C_Lexique_galgas_5F_scanner * inLexique) ;

  protected : void rule_expressionSyntax_collection_5F_value_5F_element_i30_parse (C_String & ioSyntaxDirectedTranslationResult,
                                                                                   C_Lexique_galgas_5F_scanner * inLexique) ;

  protected : void rule_expressionSyntax_collection_5F_value_5F_element_i30_indexing (C_Lexique_galgas_5F_scanner * inLexique) ;

  protected : void rule_expressionSyntax_collection_5F_value_5F_element_i31_ (GALGAS_abstractCollectionValueElement & outArgument0,
                                                                              C_String & ioSyntaxDirectedTranslationResult,
                                                                              C_Lexique_galgas_5F_scanner * inLexique) ;

  protected : void rule_expressionSyntax_collection_5F_value_5F_element_i31_parse (C_String & ioSyntaxDirectedTranslationResult,
                                                                                   C_Lexique_galgas_5F_scanner * inLexique) ;

  protected : void rule_expressionSyntax_collection_5F_value_5F_element_i31_indexing (C_Lexique_galgas_5F_scanner * inLexique) ;
...
//--- Select methods
  ...
  protected : virtual int32_t select_expressionSyntax_17 (C_Lexique_galgas_5F_scanner *) = 0 ;
