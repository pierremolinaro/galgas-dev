    ...
    while (syntaxRepeat) {
      switch (select_repeat_domain_parser_0 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
          if (((var_cas_attributeTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (86)))._operator_isNotEqual (_inLexique, GGS_string (true, "string") SOURCE_FILE_AT_LINE (86))).isBuiltAndTrue ()) {
          ...
          if ((var_cas_propertyNameSet.reader_hasKey (_inLexique, var_cas_attributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91))).isBuiltAndTrue ()) {
            var_cas_attributeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the domain has already a property named '"))._operator_concat (_inLexique, var_cas_attributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)))._operator_concat (_inLexique, GGS_string (true, "'") COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (93)) ;
          }else{
            ...
            var_cas_addModifierName = GGS_lstring::constructor_new (_inLexique, (GGS_string (true, "addTo"))._operator_concat (_inLexique, var_cas_attributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)), var_cas_attributeName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (96)) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          if ((var_cas_propertyNameSet.reader_hasKey (_inLexique, var_cas_relationTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118))).isBuiltAndTrue ()) {
            var_cas_relationTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the domain has already a property named '"))._operator_concat (_inLexique, var_cas_relationTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) COMMA_SOURCE_FILE_AT_LINE (119)))._operator_concat (_inLexique, GGS_string (true, "'") COMMA_SOURCE_FILE_AT_LINE (119)) COMMA_SOURCE_FILE_AT_LINE (120)) ;
          }else{
            ...
            GGS_lstring  var_cas_addModifierName ;
            var_cas_addModifierName = GGS_lstring::constructor_new (_inLexique, (GGS_string (true, "addTo"))._operator_concat (_inLexique, var_cas_relationTypeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)), var_cas_relationTypeName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (122)) COMMA_HERE) ;
