...
pr_domain_declaration_domain_parser_65_6_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_domain_parser_0 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
          if (((var_cas_attributeTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (86))) != (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            var_cas_attributeTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@string' is supported here") SOURCE_FILE_AT_LINE (88)) ;
          }
          ...
          if ((var_cas_propertyNameSet.reader_hasKey (_inLexique, var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (91)) SOURCE_FILE_AT_LINE (91))).isBuiltAndTrue ()) {
            var_cas_attributeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the domain has already a property named '")) + (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (92))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (93)) ;
          }else{
            var_cas_propertyNameSet._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (94))) ;
            var_cas_attributeMap.modifier_insertKey (_inLexique, var_cas_attributeName SOURCE_FILE_AT_LINE (95)) ;
            GGS_lstring  var_cas_addModifierName ;
            var_cas_addModifierName = GGS_lstring::constructor_new (_inLexique, ((GGS_string (true, "addTo")) + (var_cas_attributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (_inLexique SOURCE_FILE_AT_LINE (96)))), var_cas_attributeName.reader_location (_inLexique SOURCE_FILE_AT_LINE (96)) COMMA_HERE) ;
            var_cas_domainModifierMap.modifier_insertKey (_inLexique, var_cas_addModifierName, var_cas_domainModifierAttributeList SOURCE_FILE_AT_LINE (97)) ;
          }
        ...
        case 3 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                if (var_cas_attributeMap._isBuilt ()) {
                  var_cas_attributeMap (HERE)->method_searchKey (_inLexique, var_cas_attributeName SOURCE_FILE_AT_LINE (109)) ;
                }
                var_cas_domains._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (110))) ;
          ...
          if ((var_cas_propertyNameSet.reader_hasKey (_inLexique, var_cas_relationTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (118)) SOURCE_FILE_AT_LINE (118))).isBuiltAndTrue ()) {
            var_cas_relationTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the domain has already a property named '")) + (var_cas_relationTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (119))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (120)) ;
          }else{
            var_cas_propertyNameSet._addAssign_operation (var_cas_relationTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (121))) ;
            GGS_lstring  var_cas_addModifierName ;
            var_cas_addModifierName = GGS_lstring::constructor_new (_inLexique, ((GGS_string (true, "addTo")) + (var_cas_relationTypeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (_inLexique SOURCE_FILE_AT_LINE (122)))), var_cas_relationTypeName.reader_location (_inLexique SOURCE_FILE_AT_LINE (122)) COMMA_HERE) ;
            var_cas_domainModifierMap.modifier_insertKey (_inLexique, var_cas_addModifierName, var_cas_relationModifierAttributeList SOURCE_FILE_AT_LINE (123)) ;
            var_cas_relationMap.modifier_insertKey (_inLexique, var_cas_relationTypeName, var_cas_domains SOURCE_FILE_AT_LINE (124)) ;
          }
  ...
  var_cas_ioComponentSemanticsEntitiesMap.modifier_insertKey (_inLexique, var_cas_domainTypeName, var_cas_theEntity SOURCE_FILE_AT_LINE (131)) ;
