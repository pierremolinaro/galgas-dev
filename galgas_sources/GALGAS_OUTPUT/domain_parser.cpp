...
pr_domain_declaration_domain_parser_66_25_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        if ((var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86))).isBuiltAndTrue ()) {
          var_cas_attributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the domain has already a property named '")).operator_concat (var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (87)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
        }else{
          var_cas_propertyNameSet.addAssign_operation (var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89))) ;
          var_cas_attributeMap.modifier_insertKey (inLexique, var_cas_attributeName COMMA_SOURCE_FILE_AT_LINE (90)) ;
          GGS_lstring  var_cas_addModifierName = GGS_lstring ::constructor_new (inLexique, (GGS_string ("addTo")).operator_concat (var_cas_attributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (91))), var_cas_attributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_HERE) ;
          var_cas_domainModifierMap.modifier_insertKey (inLexique, var_cas_addModifierName, var_cas_domainModifierAttributeList COMMA_SOURCE_FILE_AT_LINE (92)) ;
        }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_2 = true ;
            while (syntaxRepeat_2) {
                ...
                inLexique.assignFromAttribute_tokenString (var_cas_attributeName) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                const GGS_domainAttributeMap  temp_4988 = var_cas_attributeMap ;
                if (temp_4988.isBuilt ()) {
                  temp_4988 (HERE)->method_searchKey (inLexique, var_cas_attributeName COMMA_SOURCE_FILE_AT_LINE (109)) ;
                }
