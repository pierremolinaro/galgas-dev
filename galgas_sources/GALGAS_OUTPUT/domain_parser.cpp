        ...
        case 3 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                _inLexique._assignFromAttribute_tokenString (var_cas_attributeName) ;
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                GGS_L_EXsignature  automatic_var_0 ;
                if (var_cas_domainModifierMap._isBuilt ()) {
                  var_cas_domainModifierMap (HERE)->method_searchKey (_inLexique, var_cas_attributeName, automatic_var_0 SOURCE_FILE_AT_LINE (107)) ;
                }
