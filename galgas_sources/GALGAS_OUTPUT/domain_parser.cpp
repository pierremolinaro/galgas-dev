...
pr_domain_declaration_domain_parser_92_25_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        const GGS_bool cond_4808 = var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
        if (cond_4808.isBuiltAndTrue ()) {
        ...
        }else if (cond_4808.isBuiltAndFalse ()) {
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_2 = true ;
            while (syntaxRepeat_2) {
                ...
                inLexique.assignFromAttribute_tokenString (var_cas_attributeName) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                const GGS_domainAttributeMap  temp_5491 = var_cas_attributeMap ;
                if (temp_5491.isBuilt ()) {
                  temp_5491 (HERE)->method_searchKey (inLexique, var_cas_attributeName COMMA_SOURCE_FILE_AT_LINE (135)) ;
                }
                var_cas_domains.addAssign_operation (var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136))) ;
                var_cas_relationModifierAttributeList.addAssign_operation (GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE), GGS_EXformalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
          ...
          const GGS_bool cond_5911 = var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_relationTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)) ;
          ...
          }else if (cond_5911.isBuiltAndFalse ()) {
