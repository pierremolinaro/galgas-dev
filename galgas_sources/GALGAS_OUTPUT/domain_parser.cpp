        ...
        case 3 : {
          ...
          { bool syntaxRepeat_1 = true ;
            while (syntaxRepeat_1) {
                ...
                _inLexique._assignFromAttribute_tokenString (var_cas_attributeName) ;
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                const GGS_domainAttributeMap  _temp_5218 = var_cas_attributeMap ;
                if (_temp_5218._isBuilt ()) {
                  _temp_5218 (HERE)->method_searchKey (_inLexique, var_cas_attributeName COMMA_SOURCE_FILE_AT_LINE (111)) ;
                }
