        ...
        case 2 : {
          ...
          { bool syntaxRepeat_2 = true ;
            while (syntaxRepeat_2) {
              ...
              switch (select_repeat_domain_parser_2 (inLexique)) {
                case 2 : {
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                  } break ;
                default :
...
pr_semantic_instruction_domain_parser_208_27_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
      ...
      switch (select_repeat_domain_parser_3 (inLexique)) {
        case 2 : {
          } break ;
        default :
...
pr_domain_instruction_domain_parser_229_25_ (galgas_scanner & inLexique) {
  ...
  { bool syntaxRepeat_4 = true ;
    while (syntaxRepeat_4) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      switch (select_repeat_domain_parser_4 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
          } break ;
        default :
...
pr_domain_expression_domain_parser_253_24_ (galgas_scanner & inLexique) {
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
      switch (select_repeat_domain_parser_6 (inLexique)) {
        case 2 : {
...
pr_domain_term_domain_parser_265_18_ (galgas_scanner & inLexique) {
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
      switch (select_repeat_domain_parser_7 (inLexique)) {
        case 2 : {
...
pr_domain_factor_domain_parser_285_20_ (galgas_scanner & inLexique) {
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        ...
        inLexique.assignFromAttribute_tokenString (var_cas_domainName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      switch (select_repeat_domain_parser_8 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
          } break ;
        default :
