...
pr_domain_declaration_domain_parser_92_25_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        if ((var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112))).isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat_1) {
      switch (select_repeat_domain_parser_1 (inLexique)) {
        case 2 : {
          ...
          if ((var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_relationTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144))).isBuiltAndTrue ()) {
