...
void domain_parser::
domain_parser::
pr_domain_declaration_domain_parser_65_5_ (galgas_scanner & _inLexique,
...
void domain_parser::
pr_domain_declaration_domain_parser_65_5_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_domain) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void domain_parser::
domain_parser::
pr_semantics_declaration_domain_parser_144_5_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioComponentSemanticsEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void domain_parser::
domain_parser::
pr_semantics_declaration_domain_parser_144_5_importSemantics (galgas_scanner & _inLexique,
...
void domain_parser::
pr_semantics_declaration_domain_parser_144_5_parse (galgas_scanner & _inLexique) {
