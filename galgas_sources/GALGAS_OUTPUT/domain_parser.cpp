...
//                    november 13th, 2009, at 21h29'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_domain_declaration_domain_parser_92_25_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        const GGS_bool cond_4806 = var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_attributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
    ...
    while (syntaxRepeat_1) {
      switch (select_domain_parser_1 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_5907 = var_cas_propertyNameSet.reader_hasKey (inLexique, var_cas_relationTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)) ;
          if (cond_5907.isBuiltAndTrue ()) {
            ...
            GGS_lstring  var_cas_addModifierName = GGS_lstring ::constructor_new (inLexique, (GGS_string ("addTo")).operator_concat (var_cas_relationTypeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (149))), var_cas_relationTypeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) COMMA_HERE) ;
            ...
            var_cas_addModifierName = GGS_lstring ::constructor_new (inLexique, (GGS_string ("reset")).operator_concat (var_cas_relationTypeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (inLexique COMMA_SOURCE_FILE_AT_LINE (151))), var_cas_relationTypeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) COMMA_HERE) ;
