...
void domain_parser::rule_domain_5F_parser_domain_5F_declaration_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_domainModifierAttributeList.addAssign_operation (GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_2 = true ;
            while (syntaxRepeat_2) {
                ...
                var_cas_relationModifierAttributeList.addAssign_operation (GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE), GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
