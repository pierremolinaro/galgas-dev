...
uint32 cPtr_outExpressionList::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
_addAssign_operation (const GGS_literalBooleanExpression & inElement) {
  if (_isBuilt () && inElement._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (((cPtr_literalBooleanExpression *) inElement.getPtr ())->mValue) ;
  }
}
...
uint32 cPtr_constructorExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_orExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_xorExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_andExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_equalExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_notEqualExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_lowerOrEqualExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_greaterOrEqualExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_strictGreaterExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_strictLowerExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_leftShiftExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_rightShiftExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_addExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_subExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_multiplicationExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_divisionExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_moduloExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_unaryMinusExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_notExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_negateExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
cPtr_trueExpression::
cPtr_trueExpression (const GGS_location & argument_0
                                COMMA_LOCATION_ARGS) :
cPtr_semanticExpression (THERE),
mOperatorLocation (argument_0) {
}
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_trueExpression * _p = dynamic_cast <const cPtr_trueExpression *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mOperatorLocation._operator_isEqual (_p->mOperatorLocation).boolValue () ;
  }
  return equal ;
...
uint32 cPtr_trueExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}

//---------------------------------------------------------------------------*

uint32 cPtr_trueExpression::_metamodelClassID (void) const {
  return 35 ;
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_trueExpression (mOperatorLocation COMMA_HERE)) ;
  return _p ;
}
...
_addAssign_operation (const GGS_trueExpression & inElement) {
  if (_isBuilt () && inElement._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (((cPtr_trueExpression *) inElement.getPtr ())->mOperatorLocation) ;
  }
}
...
constructor_new (C_Compiler & /* inLexique */,
  ...
  macroMyNew (result.mPointer, cPtr_trueExpression (argument_0 COMMA_THERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GGS_location  GGS_trueExpression::
reader_mOperatorLocation (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_location   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_trueExpression *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_trueExpression *) mPointer)->mOperatorLocation ;
  }
  return result ;
}
...
cPtr_falseExpression (const GGS_location & argument_0
                                COMMA_LOCATION_ARGS) :
cPtr_semanticExpression (THERE),
mOperatorLocation (argument_0) {
}
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_falseExpression * _p = dynamic_cast <const cPtr_falseExpression *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mOperatorLocation._operator_isEqual (_p->mOperatorLocation).boolValue () ;
  }
  return equal ;
...
uint32 cPtr_falseExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}

//---------------------------------------------------------------------------*

uint32 cPtr_falseExpression::_metamodelClassID (void) const {
  return 36 ;
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_falseExpression (mOperatorLocation COMMA_HERE)) ;
  return _p ;
}
...
_addAssign_operation (const GGS_falseExpression & inElement) {
  if (_isBuilt () && inElement._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (((cPtr_falseExpression *) inElement.getPtr ())->mOperatorLocation) ;
  }
}
...
constructor_new (C_Compiler & /* inLexique */,
  ...
  macroMyNew (result.mPointer, cPtr_falseExpression (argument_0 COMMA_THERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GGS_location  GGS_falseExpression::
reader_mOperatorLocation (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_location   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_falseExpression *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_falseExpression *) mPointer)->mOperatorLocation ;
  }
  return result ;
}
...
uint32 cPtr_varInExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_selfInExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_descriptionInExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_castInExpression::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
