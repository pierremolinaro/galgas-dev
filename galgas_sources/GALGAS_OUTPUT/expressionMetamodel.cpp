...
const C_galgas_type_descriptor kTypeDescriptor_GGS_descriptionInExpression ("descriptionInExpression", true, & kTypeDescriptor_GGS_semanticExpression) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__descriptionInExpression ("descriptionInExpression", gClassInfoFor__semanticExpression, & kTypeDescriptor_GGS_descriptionInExpression) ;

//---------------------------------------------------------------------------*

GGS_object GGS_descriptionInExpression::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_descriptionInExpression * p = NULL ;
    macroMyNew (p, GGS_descriptionInExpression (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_descriptionInExpression GGS_descriptionInExpression::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_descriptionInExpression result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_descriptionInExpression * p = dynamic_cast <const GGS_descriptionInExpression *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_descriptionInExpression, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptor * GGS_descriptionInExpression::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_descriptionInExpression ;
}
