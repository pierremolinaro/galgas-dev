...
static C_MetamodelManager gMetamodelManager ("expressionMetamodel", 42) ;
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @filewrapperInExpression" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
sint32 cPtr_filewrapperInExpression::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelComponentIndex (inLevel - 1) ;
  }
...
const char * cPtr_filewrapperInExpression::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelComponentName (inLevel - 1) ;
  }
...
sint32 cPtr_filewrapperInExpression::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 40 ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelClassID (inLevel - 1) ;
  }
...
const char * cPtr_filewrapperInExpression::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "filewrapperInExpression" ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelClassName (inLevel - 1) ;
  }
  return result ;
...
/*cPtr_filewrapperInExpression * cPtr_filewrapperInExpression::
_cloneObject (void) const {
  cPtr_filewrapperInExpression * _p = NULL ;
  macroMyNew (_p, cPtr_filewrapperInExpression (mFilewrapperName, mFilewrapperPath COMMA_HERE)) ;
  return _p ;
} */

//---------------------------------------------------------------------------*
//                                                                           *
//                  List '@_list_filewrapperInExpression'                    *
//                                                                           *
//---------------------------------------------------------------------------*

/* void GGS__list_filewrapperInExpression::
_internalAppendValues (const GGS_lstring & argument_0,
                    const GGS_lstring & argument_1) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0,
...
void GGS__list_filewrapperInExpression::
_addAssign_operation (const GGS_filewrapperInExpression & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
GGS__list_filewrapperInExpression GGS__list_filewrapperInExpression::
_operator_concat (const GGS__list_filewrapperInExpression & inOperand) const {
  GGS__list_filewrapperInExpression result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
    }else{
...
GGS_string GGS__list_filewrapperInExpression::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@_list_filewrapperInExpression", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

/* void GGS__list_filewrapperInExpression::
_addModel (const GGS_filewrapperInExpression & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_filewrapperInExpression::constructor_new (_inLexique,
       _p->mFilewrapperName,
       _p->mFilewrapperPath) ;
  }else{
    outElement._drop_operation () ;
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_filewrapperInExpression * GGS_filewrapperInExpression::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @filewrapperTemplateInExpression" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mFilewrapperName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mActualOutputParameterList.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_filewrapperTemplateInExpression::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelComponentIndex (inLevel - 1) ;
  }
...
const char * cPtr_filewrapperTemplateInExpression::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelComponentName (inLevel - 1) ;
  }
...
sint32 cPtr_filewrapperTemplateInExpression::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 41 ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelClassID (inLevel - 1) ;
  }
...
const char * cPtr_filewrapperTemplateInExpression::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "filewrapperTemplateInExpression" ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelClassName (inLevel - 1) ;
  }
  return result ;
...
/*cPtr_filewrapperTemplateInExpression * cPtr_filewrapperTemplateInExpression::
_cloneObject (void) const {
  cPtr_filewrapperTemplateInExpression * _p = NULL ;
  macroMyNew (_p, cPtr_filewrapperTemplateInExpression (mFilewrapperName, mFilewrapperTemplateName, mActualOutputParameterList COMMA_HERE)) ;
  return _p ;
} */

//---------------------------------------------------------------------------*
//                                                                           *
//              List '@_list_filewrapperTemplateInExpression'                *
//                                                                           *
//---------------------------------------------------------------------------*

/* void GGS__list_filewrapperTemplateInExpression::
_internalAppendValues (const GGS_lstring & argument_0,
                    const GGS_lstring & argument_1,
                    const GGS_outExpressionList & argument_2) {
  cElement * nouvelElement = (cElement *) NULL ;
...
void GGS__list_filewrapperTemplateInExpression::
_addAssign_operation (const GGS_filewrapperTemplateInExpression & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
GGS__list_filewrapperTemplateInExpression GGS__list_filewrapperTemplateInExpression::
_operator_concat (const GGS__list_filewrapperTemplateInExpression & inOperand) const {
  GGS__list_filewrapperTemplateInExpression result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
    }else{
...
GGS_string GGS__list_filewrapperTemplateInExpression::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@_list_filewrapperTemplateInExpression", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

/* void GGS__list_filewrapperTemplateInExpression::
_addModel (const GGS_filewrapperTemplateInExpression & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_filewrapperTemplateInExpression::constructor_new (_inLexique,
       _p->mFilewrapperName,
       _p->mFilewrapperTemplateName,
       _p->mActualOutputParameterList) ;
  }else{
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_filewrapperTemplateInExpression * GGS_filewrapperTemplateInExpression::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
