...
void GGS_literalStringExpressionList::
_addAssign_operation (const GGS_stringlist & argument_0) {
  if (_isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (argument_0) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mReceiverExpression ;
    _out_1 = _p->mUseKindOfClass ;
    _out_2 = _p->mTypeName ;
    _out_3 = _p->mErrorLocationExpression ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
