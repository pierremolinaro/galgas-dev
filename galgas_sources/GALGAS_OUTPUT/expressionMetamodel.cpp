...
sint32 cPtr_literalBooleanExpression::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelComponentIndex (inLevel - 1) ;
  }
...
const char * cPtr_literalBooleanExpression::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelComponentName (inLevel - 1) ;
  }
...
sint32 cPtr_literalBooleanExpression::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 3 ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelClassID (inLevel - 1) ;
  }
...
const char * cPtr_literalBooleanExpression::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "literalBooleanExpression" ;
  if (inLevel > 0) {
    result = cPtr_semanticExpression::_metamodelClassName (inLevel - 1) ;
  }
  return result ;
