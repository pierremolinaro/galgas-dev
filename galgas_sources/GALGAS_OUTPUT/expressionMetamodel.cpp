...
static C_MetamodelManager gMetamodelManager ("expressionMetamodel") ;
...
sint32 cPtr_semanticExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_semanticExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_semanticExpression::_superClassMetamodelComponentIndex (void) const {
  return -1 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_semanticExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_semanticExpression::_metamodelClassID (void) const {
  return 0 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_semanticExpression::_metamodelClassIDForClass (void) {
  return 0 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_semanticExpression::_metamodelClassName (void) const {
...
sint32 cPtr_outExpressionList::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_outExpressionList::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_outExpressionList::_superClassMetamodelComponentIndex (void) const {
  return -1 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_outExpressionList::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_outExpressionList::_metamodelClassID (void) const {
  return 1 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_outExpressionList::_metamodelClassIDForClass (void) {
  return 1 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_outExpressionList::_metamodelClassName (void) const {
...
sint32 cPtr_variableExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_variableExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_variableExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_variableExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_variableExpression::_metamodelClassID (void) const {
  return 2 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_variableExpression::_metamodelClassIDForClass (void) {
  return 2 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_variableExpression::_metamodelClassName (void) const {
...
cPtr_literalBooleanExpression (const GGS_location & argument_0,
...
sint32 cPtr_literalBooleanExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalBooleanExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalBooleanExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalBooleanExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalBooleanExpression::_metamodelClassID (void) const {
  return 3 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalBooleanExpression::_metamodelClassIDForClass (void) {
  return 3 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalBooleanExpression::_metamodelClassName (void) const {
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_literalBooleanExpression (mOperatorLocation, mValue COMMA_HERE)) ;
  return _p ;
}
...
void GGS_literalBooleanExpressionList::
_addAssign_operation (const GGS_literalBooleanExpression & inElement) {
  if (_isBuilt () && inElement._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (((cPtr_literalBooleanExpression *) inElement.getPtr ())->mOperatorLocation,
                                ((cPtr_literalBooleanExpression *) inElement.getPtr ())->mValue) ;
  }
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_literalBooleanExpression::constructor_new (_inLexique,
...
constructor_new (C_Compiler & /* inLexique */,
  ...
  macroMyNew (result.mPointer, cPtr_literalBooleanExpression (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_location  GGS_literalBooleanExpression::
reader_mOperatorLocation (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_literalBooleanExpression *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_literalBooleanExpression *) mPointer)->mOperatorLocation ;
  }
  return result ;
}
...
sint32 cPtr_literalCharExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalCharExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalCharExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalCharExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalCharExpression::_metamodelClassID (void) const {
  return 4 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalCharExpression::_metamodelClassIDForClass (void) {
  return 4 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalCharExpression::_metamodelClassName (void) const {
...
_addAssign_operation (const GGS_literalCharExpression & inElement) {
  if (_isBuilt () && inElement._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (((cPtr_literalCharExpression *) inElement.getPtr ())->mValue) ;
  }
}
...
sint32 cPtr_literalStringExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalStringExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalStringExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalStringExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalStringExpression::_metamodelClassID (void) const {
  return 5 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalStringExpression::_metamodelClassIDForClass (void) {
  return 5 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalStringExpression::_metamodelClassName (void) const {
...
sint32 cPtr_literalDoubleExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalDoubleExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalDoubleExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalDoubleExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalDoubleExpression::_metamodelClassID (void) const {
  return 6 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalDoubleExpression::_metamodelClassIDForClass (void) {
  return 6 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalDoubleExpression::_metamodelClassName (void) const {
...
sint32 cPtr_literalUIntExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUIntExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUIntExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalUIntExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUIntExpression::_metamodelClassID (void) const {
  return 7 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUIntExpression::_metamodelClassIDForClass (void) {
  return 7 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalUIntExpression::_metamodelClassName (void) const {
...
sint32 cPtr_literalUInt64Expression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUInt64Expression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUInt64Expression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalUInt64Expression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUInt64Expression::_metamodelClassID (void) const {
  return 8 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalUInt64Expression::_metamodelClassIDForClass (void) {
  return 8 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalUInt64Expression::_metamodelClassName (void) const {
...
sint32 cPtr_literalSIntExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSIntExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSIntExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalSIntExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSIntExpression::_metamodelClassID (void) const {
  return 9 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSIntExpression::_metamodelClassIDForClass (void) {
  return 9 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalSIntExpression::_metamodelClassName (void) const {
...
sint32 cPtr_literalSInt64Expression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSInt64Expression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSInt64Expression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalSInt64Expression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSInt64Expression::_metamodelClassID (void) const {
  return 10 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_literalSInt64Expression::_metamodelClassIDForClass (void) {
  return 10 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_literalSInt64Expression::_metamodelClassName (void) const {
...
sint32 cPtr_hereExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_hereExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_hereExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_hereExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_hereExpression::_metamodelClassID (void) const {
  return 11 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_hereExpression::_metamodelClassIDForClass (void) {
  return 11 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_hereExpression::_metamodelClassName (void) const {
...
sint32 cPtr_constructorExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_constructorExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_constructorExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_constructorExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_constructorExpression::_metamodelClassID (void) const {
  return 12 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_constructorExpression::_metamodelClassIDForClass (void) {
  return 12 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_constructorExpression::_metamodelClassName (void) const {
...
sint32 cPtr_readerCallExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_readerCallExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_readerCallExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_readerCallExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_readerCallExpression::_metamodelClassID (void) const {
  return 13 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_readerCallExpression::_metamodelClassIDForClass (void) {
  return 13 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_readerCallExpression::_metamodelClassName (void) const {
...
sint32 cPtr_optionExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_optionExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_optionExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_optionExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_optionExpression::_metamodelClassID (void) const {
  return 14 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_optionExpression::_metamodelClassIDForClass (void) {
  return 14 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_optionExpression::_metamodelClassName (void) const {
...
sint32 cPtr_concatExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_concatExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_concatExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_concatExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_concatExpression::_metamodelClassID (void) const {
  return 15 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_concatExpression::_metamodelClassIDForClass (void) {
  return 15 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_concatExpression::_metamodelClassName (void) const {
...
sint32 cPtr_orExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_orExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_orExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_orExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_orExpression::_metamodelClassID (void) const {
  return 16 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_orExpression::_metamodelClassIDForClass (void) {
  return 16 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_orExpression::_metamodelClassName (void) const {
  return "orExpression" ;
}
...
sint32 cPtr_xorExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_xorExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_xorExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_xorExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_xorExpression::_metamodelClassID (void) const {
  return 17 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_xorExpression::_metamodelClassIDForClass (void) {
  return 17 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_xorExpression::_metamodelClassName (void) const {
...
sint32 cPtr_andExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_andExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_andExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_andExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_andExpression::_metamodelClassID (void) const {
  return 18 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_andExpression::_metamodelClassIDForClass (void) {
  return 18 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_andExpression::_metamodelClassName (void) const {
...
sint32 cPtr_equalExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_equalExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_equalExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_equalExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_equalExpression::_metamodelClassID (void) const {
  return 19 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_equalExpression::_metamodelClassIDForClass (void) {
  return 19 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_equalExpression::_metamodelClassName (void) const {
...
sint32 cPtr_notEqualExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notEqualExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notEqualExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_notEqualExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notEqualExpression::_metamodelClassID (void) const {
  return 20 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notEqualExpression::_metamodelClassIDForClass (void) {
  return 20 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_notEqualExpression::_metamodelClassName (void) const {
...
sint32 cPtr_lowerOrEqualExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_lowerOrEqualExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_lowerOrEqualExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_lowerOrEqualExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_lowerOrEqualExpression::_metamodelClassID (void) const {
  return 21 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_lowerOrEqualExpression::_metamodelClassIDForClass (void) {
  return 21 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_lowerOrEqualExpression::_metamodelClassName (void) const {
...
sint32 cPtr_greaterOrEqualExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_greaterOrEqualExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_greaterOrEqualExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_greaterOrEqualExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_greaterOrEqualExpression::_metamodelClassID (void) const {
  return 22 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_greaterOrEqualExpression::_metamodelClassIDForClass (void) {
  return 22 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_greaterOrEqualExpression::_metamodelClassName (void) const {
...
sint32 cPtr_strictGreaterExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictGreaterExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictGreaterExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_strictGreaterExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictGreaterExpression::_metamodelClassID (void) const {
  return 23 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictGreaterExpression::_metamodelClassIDForClass (void) {
  return 23 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_strictGreaterExpression::_metamodelClassName (void) const {
...
sint32 cPtr_strictLowerExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictLowerExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictLowerExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_strictLowerExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictLowerExpression::_metamodelClassID (void) const {
  return 24 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_strictLowerExpression::_metamodelClassIDForClass (void) {
  return 24 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_strictLowerExpression::_metamodelClassName (void) const {
...
sint32 cPtr_leftShiftExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_leftShiftExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_leftShiftExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_leftShiftExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_leftShiftExpression::_metamodelClassID (void) const {
  return 25 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_leftShiftExpression::_metamodelClassIDForClass (void) {
  return 25 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_leftShiftExpression::_metamodelClassName (void) const {
...
sint32 cPtr_rightShiftExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_rightShiftExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_rightShiftExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_rightShiftExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_rightShiftExpression::_metamodelClassID (void) const {
  return 26 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_rightShiftExpression::_metamodelClassIDForClass (void) {
  return 26 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_rightShiftExpression::_metamodelClassName (void) const {
...
sint32 cPtr_addExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_addExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_addExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_addExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_addExpression::_metamodelClassID (void) const {
  return 27 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_addExpression::_metamodelClassIDForClass (void) {
  return 27 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_addExpression::_metamodelClassName (void) const {
...
sint32 cPtr_subExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_subExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_subExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_subExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_subExpression::_metamodelClassID (void) const {
  return 28 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_subExpression::_metamodelClassIDForClass (void) {
  return 28 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_subExpression::_metamodelClassName (void) const {
...
sint32 cPtr_multiplicationExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_multiplicationExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_multiplicationExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_multiplicationExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_multiplicationExpression::_metamodelClassID (void) const {
  return 29 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_multiplicationExpression::_metamodelClassIDForClass (void) {
  return 29 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_multiplicationExpression::_metamodelClassName (void) const {
...
sint32 cPtr_divisionExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_divisionExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_divisionExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_divisionExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_divisionExpression::_metamodelClassID (void) const {
  return 30 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_divisionExpression::_metamodelClassIDForClass (void) {
  return 30 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_divisionExpression::_metamodelClassName (void) const {
...
sint32 cPtr_moduloExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_moduloExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_moduloExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_moduloExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_moduloExpression::_metamodelClassID (void) const {
  return 31 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_moduloExpression::_metamodelClassIDForClass (void) {
  return 31 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_moduloExpression::_metamodelClassName (void) const {
...
sint32 cPtr_unaryMinusExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_unaryMinusExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_unaryMinusExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_unaryMinusExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_unaryMinusExpression::_metamodelClassID (void) const {
  return 32 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_unaryMinusExpression::_metamodelClassIDForClass (void) {
  return 32 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_unaryMinusExpression::_metamodelClassName (void) const {
...
sint32 cPtr_notExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_notExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notExpression::_metamodelClassID (void) const {
  return 33 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_notExpression::_metamodelClassIDForClass (void) {
  return 33 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_notExpression::_metamodelClassName (void) const {
...
sint32 cPtr_negateExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_negateExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_negateExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_negateExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_negateExpression::_metamodelClassID (void) const {
  return 34 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_negateExpression::_metamodelClassIDForClass (void) {
  return 34 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_negateExpression::_metamodelClassName (void) const {
...
sint32 cPtr_varInExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_varInExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_varInExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_varInExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_varInExpression::_metamodelClassID (void) const {
  return 35 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_varInExpression::_metamodelClassIDForClass (void) {
  return 35 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_varInExpression::_metamodelClassName (void) const {
...
sint32 cPtr_selfInExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_selfInExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_selfInExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_selfInExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_selfInExpression::_metamodelClassID (void) const {
  return 36 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_selfInExpression::_metamodelClassIDForClass (void) {
  return 36 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_selfInExpression::_metamodelClassName (void) const {
...
sint32 cPtr_descriptionInExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_descriptionInExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_descriptionInExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_descriptionInExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_descriptionInExpression::_metamodelClassID (void) const {
  return 37 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_descriptionInExpression::_metamodelClassIDForClass (void) {
  return 37 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_descriptionInExpression::_metamodelClassName (void) const {
...
sint32 cPtr_castInExpression::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_castInExpression::_metamodelComponentIndexForClass (void) {
  return gMetamodelManager.mMetamodelComponentIndex ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_castInExpression::_superClassMetamodelComponentIndex (void) const {
  return cPtr_semanticExpression::_metamodelComponentIndex () ;
}

//---------------------------------------------------------------------------*

const char * cPtr_castInExpression::_metamodelComponentName (void) const {
  return gMetamodelManager.mMetamodelComponentName ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_castInExpression::_metamodelClassID (void) const {
  return 38 ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_castInExpression::_metamodelClassIDForClass (void) {
  return 38 ;
}

//---------------------------------------------------------------------------*

const char * cPtr_castInExpression::_metamodelClassName (void) const {
