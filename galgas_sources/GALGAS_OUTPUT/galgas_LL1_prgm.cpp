...
galgas_LL1_prgm_prologue (C_Compiler & _inLexique,
  ...
  ::routine_projectCreation (_inLexique,  var_cas_creationProjectName COMMA_SOURCE_FILE_AT_LINE (32)) ;
}
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (40)) ;
          }
          ...
          var_cas_semanticContext = GGS_EXsemanticContext::constructor_new (_inLexique, GGS_M_filewrappers ::constructor_emptyMap (_inLexique COMMA_HERE), GGS_stringset ::constructor_emptySet (_inLexique COMMA_HERE), GGS_EXcategoryMethodMap ::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
