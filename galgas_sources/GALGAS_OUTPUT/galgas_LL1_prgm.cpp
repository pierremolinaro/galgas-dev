...
galgas_LL1_prgm_prologue (C_Compiler & inLexique,
  ...
  var_cas_creationProjectName = GGS_string (true, inLexique.stringOptionValueFromKeys ("galgas_cli_options", "create_project" COMMA_SOURCE_FILE_AT_LINE (35))) ;
  ::routine_projectCreation (inLexique,  var_cas_creationProjectName COMMA_SOURCE_FILE_AT_LINE (36)) ;
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("galgas_cli_options", "printPredefinedLexicalActions" COMMA_SOURCE_FILE_AT_LINE (37)))).isBuiltAndTrue ()) {
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("gOption") == 0) {
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (49)) ;
            if (verboseOptionOn) {
