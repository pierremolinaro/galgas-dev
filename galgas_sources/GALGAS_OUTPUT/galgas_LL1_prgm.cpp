...
//                    september 20th, 2009, at 18h47'42"                     *
//                                                                           *
//---------------------------------------------------------------------------*
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("gOption") == 0) {
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (55)) ;
            if (verboseOptionOn) {
            ...
            if (var_cas_inSourceFile.isBuilt ()) {
              ::routine_fixFileGenerationStartDirectory (inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (63)) ;
            }
