...
galgas_LL1_prgm_prologue (C_Compiler & inLexique,
  ...
  var_cas_creationProjectName = GGS_string (true, inLexique.stringOptionValueFromKeys ("galgas_cli_options", "create_project" COMMA_SOURCE_FILE_AT_LINE (33))) ;
  ::routine_projectCreation (inLexique,  var_cas_creationProjectName COMMA_SOURCE_FILE_AT_LINE (34)) ;
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("galgas_cli_options", "printPredefinedLexicalActions" COMMA_SOURCE_FILE_AT_LINE (35)))).isBuiltAndTrue ()) {
    ::routine_printPredefinedLexicalActions (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
  }
}
        ...
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            if (var_cas_inSourceFile.isBuilt ()) {
              ::routine_fixFileGenerationStartDirectory (inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (45)) ;
            }
