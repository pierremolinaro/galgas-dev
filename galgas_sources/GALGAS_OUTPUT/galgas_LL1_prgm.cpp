...
galgas_LL1_prgm_prologue (C_Compiler & inLexique,
  ...
  ::routine_projectCreation (inLexique,  var_cas_creationProjectName COMMA_SOURCE_FILE_AT_LINE (36)) ;
  if ((gOption_galgas_5F_cli_5F_options_printPredefinedLexicalActions.value ()).isBuiltAndTrue ()) {
    ::routine_printPredefinedLexicalActions (inLexique COMMA_SOURCE_FILE_AT_LINE (38)) ;
  }
}
...
//--- Fix parameters for BDD package
  ...
  //--- Input/output parameters
    const char * extensions [] = {"gOption", "ggs", NULL} ;
    const char * helpMessages [] = {"a GALGAS option source file", "a '.ggs' GALGAS source file", NULL} ;
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("gOption") == 0) {
            ...
            var_cas_outputDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
            var_cas_outputDirectory.appendCString ("/GALGAS_OUTPUT") ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct ;
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileOptionComponent (inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (54)) ;
            if (verboseOptionOn) {
            ...
            if (var_cas_inSourceFile.isBuilt ()) {
              ::routine_fixFileGenerationStartDirectory (inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (62)) ;
            }
