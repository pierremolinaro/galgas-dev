...
class C_options_for_galgas_LL1_prgm : public C_cli_options_group {
//--- Constructor
...
//--- Input/output parameters
  ...
  IOparameters.mCompilerVersion = "version 0.14.0 (LL(1) grammar)" ;
