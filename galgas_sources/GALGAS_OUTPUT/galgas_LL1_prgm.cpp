...
//                    february 28th, 2007, at 15h18'42"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
grammar_galgas_LL1_prgm (C_galgas_io * inParametersPtr
                  COMMA_LOCATION_ARGS) :
_mScannerPtr (NULL) {
  macroMyNew (_mScannerPtr, galgas_scanner (inParametersPtr COMMA_THERE)) ;
}
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          macroMyNew (compiler, grammar_galgas_LL1_prgm (galgasIOptr COMMA_HERE)) ;
          compiler->_prologue () ;
...
void grammar_galgas_LL1_prgm::_beforeParsing (void) {
  ...
  if (! ok) {
    ...
    errorMessage << "cannot create directory '" << _mScannerPtr->ioParametersPtr ()->mFileGenerationStartDir << "'" ;
    _mScannerPtr->ioParametersPtr ()->printFileErrorMessage (_mScannerPtr->sourceFileName (), errorMessage.cString () COMMA_HERE) ;
  }
}
...
void grammar_galgas_LL1_prgm::_afterParsing (const bool inVerboseOptionOn) {
  if (_mScannerPtr->ioParametersPtr ()->boolOptionValueFromKeys ("galgas_cli_options", "warningsAsError" COMMA_HERE) &&
