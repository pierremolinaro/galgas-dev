      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (42)) ;
          }
...
galgas_LL1_prgm_prologue (C_Compiler & _inLexique,
  ...
  var_cas_creationProjectName = GGS_string (true, _inLexique.stringOptionValueFromKeys ("galgas_cli_options", "create_project" COMMA_SOURCE_FILE_AT_LINE (33))) ;
  GGS_string var_cas_libpmPath ;
  var_cas_libpmPath = GGS_string (true, _inLexique.stringOptionValueFromKeys ("galgas_cli_options", "libpm" COMMA_SOURCE_FILE_AT_LINE (34))) ;
  ::routine_projectCreation (_inLexique,  var_cas_creationProjectName,  var_cas_libpmPath COMMA_SOURCE_FILE_AT_LINE (34)) ;
}
