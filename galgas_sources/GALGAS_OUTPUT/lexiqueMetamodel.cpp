...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_abstractLexicalRoutineActualArgument _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_abstractLexicalRoutineActualArgument (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
cPtr__AC_galgas_class * cPtr_lexicalRoutineInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_lexicalRoutineInstruction (mActionName, mActualArgumentList, mErrorMessageList COMMA_HERE)) ;
  return result ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_lexicalRoutineInstruction _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_lexicalRoutineInstruction (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
reader_mActionName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_lexicalRoutineInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_lexicalRoutineInstruction *) mPointer)->mActionName ;
  }
  return result ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_lexicalRoutineOrFunctionFormalInputArgument _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_lexicalRoutineOrFunctionFormalInputArgument (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
