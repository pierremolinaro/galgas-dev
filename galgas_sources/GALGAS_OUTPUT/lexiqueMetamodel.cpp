...
GGS_templateDelimitorList::GGS_templateDelimitorList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_templateReplacementList::GGS_templateReplacementList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalImplicitRuleList::GGS_lexicalImplicitRuleList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalErrorMessageDeclarationList::GGS_lexicalErrorMessageDeclarationList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalAttributeList::GGS_lexicalAttributeList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalStyleList::GGS_lexicalStyleList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_terminalDeclarationList::GGS_terminalDeclarationList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalListEntryList::GGS_lexicalListEntryList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalListDeclarationList::GGS_lexicalListDeclarationList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalExplicitRuleList::GGS_lexicalExplicitRuleList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalSendSearchList::GGS_lexicalSendSearchList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalWhileBranchList::GGS_lexicalWhileBranchList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalInstructionList::GGS_lexicalInstructionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalSelectBranchList::GGS_lexicalSelectBranchList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_lexicalActualArgumentList::GGS_lexicalActualArgumentList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
