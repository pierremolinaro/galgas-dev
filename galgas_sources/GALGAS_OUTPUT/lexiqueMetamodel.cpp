...
static C_MetamodelManager gMetamodelManager ("lexiqueMetamodel", 39) ;
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mIsTemplate.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mTemplateDelimitorList.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mTemplateReplacementList.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_lexiqueComponentRoot (mLexiqueComponentName, mIsTemplate, mTemplateDelimitorList, mTemplateReplacementList, mLexicalAttributeList, mLexicalStyleList, mTerminalDeclarationList, mLexicalErrorMessageDeclarationList, mLexicalListDeclarationList, mLexicalImplicitRuleList, mLexicalExplicitRuleList COMMA_HERE)) ;
  return _p ;
} */
...
void GGS__list_lexiqueComponentRoot::
_addAssign_operation (const GGS_lexiqueComponentRoot & inObject) {
   _insulateList () ;
  ...
  if (_shared ()) {
    ...
    while (_p != NULL) {
      ...
      _internalAppendValues (_p->mLexiqueComponentName,
                                _p->mIsTemplate,
                                _p->mTemplateDelimitorList,
                                _p->mTemplateReplacementList,
...
GGS__list_templateDelimitor  GGS_lexiqueComponentRoot::
reader_mTemplateDelimitorList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS__list_templateDelimitor   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_lexiqueComponentRoot *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
...
GGS__list_templateReplacement  GGS_lexiqueComponentRoot::
reader_mTemplateReplacementList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS__list_templateReplacement   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_lexiqueComponentRoot *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
...
cPtr_templateDelimitor::
cPtr_templateDelimitor (const GGS_lstring & argument_0,
...
bool cPtr_templateDelimitor::
isEqualToObject (const cPtr_entity * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_templateDelimitor * _p = dynamic_cast <const cPtr_templateDelimitor *> (inOperand) ;
    macroValidPointer (_p) ;
...
void cPtr_templateDelimitor::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @templateDelimitor" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
sint32 cPtr_templateDelimitor::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_templateDelimitor::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = NULL ;
  }
...
sint32 cPtr_templateDelimitor::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 1 ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_templateDelimitor::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "templateDelimitor" ;
  if (inLevel > 0) {
    result = NULL ;
  }
  return result ;
...
/*cPtr_templateDelimitor * cPtr_templateDelimitor::
_cloneObject (void) const {
  cPtr_templateDelimitor * _p = NULL ;
  macroMyNew (_p, cPtr_templateDelimitor (mStartString, mEndString COMMA_HERE)) ;
  return _p ;
} */

//---------------------------------------------------------------------------*
//                                                                           *
//                     List '@_list_templateDelimitor'                       *
//                                                                           *
//---------------------------------------------------------------------------*

/* void GGS__list_templateDelimitor::
_internalAppendValues (const GGS_lstring & argument_0,
                    const GGS_lstring & argument_1) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0,
...
void GGS__list_templateDelimitor::
_addAssign_operation (const GGS_templateDelimitor & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
GGS__list_templateDelimitor GGS__list_templateDelimitor::
_operator_concat (const GGS__list_templateDelimitor & inOperand) const {
  GGS__list_templateDelimitor result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
...
GGS_string GGS__list_templateDelimitor::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@_list_templateDelimitor", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

/* void GGS__list_templateDelimitor::
_addModel (const GGS_templateDelimitor & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_templateDelimitor::constructor_new (_inLexique,
       _p->mStartString,
       _p->mEndString) ;
  }else{
    outElement._drop_operation () ;
...
GGS_templateDelimitor GGS_templateDelimitor::
constructor_new (C_Compiler & /* inLexique */,
                 const GGS_lstring & argument_0,
                 const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_templateDelimitor result ;
  macroMyNew (result.mPointer, cPtr_templateDelimitor (argument_0,
...
GGS_lstring  GGS_templateDelimitor::
reader_mStartString (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_templateDelimitor *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_templateDelimitor *) mPointer)->mStartString ;
  }
  return result ;
}
...
GGS_lstring  GGS_templateDelimitor::
reader_mEndString (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_templateDelimitor *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_templateDelimitor *) mPointer)->mEndString ;
  }
  return result ;
}
...
const char * GGS_templateDelimitor::actualTypeName (void) const {
 return "templateDelimitor" ;
}

//---------------------------------------------------------------------------*

#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_templateDelimitor * GGS_templateDelimitor::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
...
cPtr_templateReplacement::
cPtr_templateReplacement (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) :
cPtr_entity (THERE),
...
bool cPtr_templateReplacement::
isEqualToObject (const cPtr_entity * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_templateReplacement * _p = dynamic_cast <const cPtr_templateReplacement *> (inOperand) ;
    macroValidPointer (_p) ;
...
void cPtr_templateReplacement::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @templateReplacement" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
sint32 cPtr_templateReplacement::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_templateReplacement::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = NULL ;
  }
...
sint32 cPtr_templateReplacement::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 2 ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_templateReplacement::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "templateReplacement" ;
  if (inLevel > 0) {
    result = NULL ;
  }
  return result ;
...
/*cPtr_templateReplacement * cPtr_templateReplacement::
_cloneObject (void) const {
  cPtr_templateReplacement * _p = NULL ;
  macroMyNew (_p, cPtr_templateReplacement (mMatchString, mReplacementString COMMA_HERE)) ;
  return _p ;
} */

//---------------------------------------------------------------------------*
//                                                                           *
//                    List '@_list_templateReplacement'                      *
//                                                                           *
//---------------------------------------------------------------------------*

/* void GGS__list_templateReplacement::
_internalAppendValues (const GGS_lstring & argument_0,
                    const GGS_lstring & argument_1) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0,
...
void GGS__list_templateReplacement::
_addAssign_operation (const GGS_templateReplacement & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
GGS__list_templateReplacement GGS__list_templateReplacement::
_operator_concat (const GGS__list_templateReplacement & inOperand) const {
  GGS__list_templateReplacement result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
...
GGS_string GGS__list_templateReplacement::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@_list_templateReplacement", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

/* void GGS__list_templateReplacement::
_addModel (const GGS_templateReplacement & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_templateReplacement::constructor_new (_inLexique,
       _p->mMatchString,
       _p->mReplacementString) ;
  }else{
    outElement._drop_operation () ;
...
GGS_templateReplacement GGS_templateReplacement::
constructor_new (C_Compiler & /* inLexique */,
                 const GGS_lstring & argument_0,
                 const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_templateReplacement result ;
  macroMyNew (result.mPointer, cPtr_templateReplacement (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_templateReplacement::
reader_mMatchString (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_templateReplacement *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_templateReplacement *) mPointer)->mMatchString ;
  }
  return result ;
}
...
GGS_lstring  GGS_templateReplacement::
reader_mReplacementString (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_templateReplacement *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_templateReplacement *) mPointer)->mReplacementString ;
  }
  return result ;
}
...
const char * GGS_templateReplacement::actualTypeName (void) const {
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_templateReplacement * GGS_templateReplacement::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
...
void GGS__list_lexicalImplicitRule::
_addAssign_operation (const GGS_lexicalImplicitRule & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalErrorMessageDeclaration::
_addAssign_operation (const GGS_lexicalErrorMessageDeclaration & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalAttribute::
_addAssign_operation (const GGS_lexicalAttribute & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalStyle::
_addAssign_operation (const GGS_lexicalStyle & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_terminalDeclaration::
_addAssign_operation (const GGS_terminalDeclaration & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalListDeclaration::
_addAssign_operation (const GGS_lexicalListDeclaration & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalListEntry::
_addAssign_operation (const GGS_lexicalListEntry & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalExplicitRule::
_addAssign_operation (const GGS_lexicalExplicitRule & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalExpression::
_addAssign_operation (const GGS_lexicalExpression & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalOrExpression::
_addAssign_operation (const GGS_lexicalOrExpression & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalCharacterMatch::
_addAssign_operation (const GGS_lexicalCharacterMatch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalCharacterIntervalMatch::
_addAssign_operation (const GGS_lexicalCharacterIntervalMatch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalStringMatch::
_addAssign_operation (const GGS_lexicalStringMatch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalStringNotMatch::
_addAssign_operation (const GGS_lexicalStringNotMatch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalInstruction::
_addAssign_operation (const GGS_lexicalInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalStructuredSendInstruction::
_addAssign_operation (const GGS_lexicalStructuredSendInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalSimpleSendInstruction::
_addAssign_operation (const GGS_lexicalSimpleSendInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalSendDefaultAction::
_addAssign_operation (const GGS_lexicalSendDefaultAction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalSendTerminalByDefault::
_addAssign_operation (const GGS_lexicalSendTerminalByDefault & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalErrorByDefault::
_addAssign_operation (const GGS_lexicalErrorByDefault & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalSendSearch::
_addAssign_operation (const GGS_lexicalSendSearch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalRepeatInstruction::
_addAssign_operation (const GGS_lexicalRepeatInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalWhileBranch::
_addAssign_operation (const GGS_lexicalWhileBranch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalSelectInstruction::
_addAssign_operation (const GGS_lexicalSelectInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalSelectBranch::
_addAssign_operation (const GGS_lexicalSelectBranch & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalActionInstruction::
_addAssign_operation (const GGS_lexicalActionInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalActualArgument::
_addAssign_operation (const GGS_lexicalActualArgument & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalAttributeArgument::
_addAssign_operation (const GGS_lexicalAttributeArgument & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalCharacterArgument::
_addAssign_operation (const GGS_lexicalCharacterArgument & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalCurrentCharacterArgument::
_addAssign_operation (const GGS_lexicalCurrentCharacterArgument & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalFunctionArgument::
_addAssign_operation (const GGS_lexicalFunctionArgument & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalDropInstruction::
_addAssign_operation (const GGS_lexicalDropInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalErrorInstruction::
_addAssign_operation (const GGS_lexicalErrorInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalTagInstruction::
_addAssign_operation (const GGS_lexicalTagInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalRewindInstruction::
_addAssign_operation (const GGS_lexicalRewindInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_lexicalLogInstruction::
_addAssign_operation (const GGS_lexicalLogInstruction & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
