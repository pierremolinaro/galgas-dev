...
cPtr__AC_galgas_class * cPtr_lexiqueComponentRoot::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_lexiqueComponentRoot (mLexiqueComponentName, mIsTemplate, mTemplateDelimitorList, mTemplateReplacementList, mLexicalAttributeList, mLexicalStyleList, mTerminalDeclarationList, mLexicalMessageDeclarationList, mLexicalListDeclarationList, mLexicalImplicitRuleList, mLexicalExplicitRuleList COMMA_HERE)) ;
  return result ;
}
