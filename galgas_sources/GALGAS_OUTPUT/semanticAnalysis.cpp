...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_16743,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                GGS_semanticDeclarationListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16743 != NULL) {
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_17022 (operand_16743->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_17022 = NULL ;
      while (((operand_17022 = enumerator_17022.nextObject ()))) {
        macroValidPointer (operand_17022) ;
        var_cas_typedAttributeList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_17022->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (386)), operand_17022->mAttributeName) ;
        var_cas_attributeIndexMap.modifier_insertKey (inLexique, operand_17022->mAttributeName, var_cas_attributeIndexMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (389)) ;
      }
    }
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    const GGS_bool cond_17464 = (operand_16743->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393))).operator_isEqual (GGS_string ("")) ;
    if (cond_17464.isBuiltAndTrue ()) {
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (394)) ;
    }else if (cond_17464.isBuiltAndFalse ()) {
      GGS_bool automatic_var_17561_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_17561_1 ;
      GGS_typeKindEnum automatic_var_17561_2 ;
      GGS_typedAttributeList  automatic_var_17561_3 ;
      GGS_typedAttributeList  automatic_var_17561_4 ;
      GGS_constructorMap  automatic_var_17561_5 ;
      GGS_readerMap  automatic_var_17561_6 ;
      GGS_modifierMap  automatic_var_17561_7 ;
      GGS_classMethodMap  automatic_var_17561_8 ;
      GGS_enumerationDescriptorList  automatic_var_17561_9 ;
      GGS_uint  automatic_var_17561_10 ;
      GGS_unifiedTypeMapProxyList  automatic_var_17561_11 ;
      GGS_unifiedTypeMapProxyList  automatic_var_17561_12 ;
      GGS_nativeAttributeList  automatic_var_17561_13 ;
      GGS_lstringlist  automatic_var_17561_14 ;
      GGS_typedAttributeList  automatic_var_17561_15 ;
      const GGS_unifiedTypeMap  temp_17507 = var_cas_inSemanticContext.mTypeMap ;
      if (temp_17507.isBuilt ()) {
        temp_17507 (HERE)->method_searchKey (inLexique, operand_16743->mSuperClassName, automatic_var_17561_0, automatic_var_17561_1, automatic_var_17561_2, automatic_var_17561_3, automatic_var_17561_4, automatic_var_17561_5, automatic_var_17561_6, automatic_var_17561_7, var_cas_inheritedInstanceMethodMap, automatic_var_17561_8, automatic_var_17561_9, automatic_var_17561_10, automatic_var_17561_11, automatic_var_17561_12, automatic_var_17561_13, automatic_var_17561_14, automatic_var_17561_15 COMMA_SOURCE_FILE_AT_LINE (396)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    const GGS_bool cond_17800 = (operand_16743->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (400))).operator_isEqual (GGS_string ("")) ;
    ...
    }else if (cond_17800.isBuiltAndFalse ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_16743->mSuperClassName COMMA_SOURCE_FILE_AT_LINE (403)) ;
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_18048 (operand_16743->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_18048 = NULL ;
      while (((operand_18048 = enumerator_18048.nextObject ()))) {
        macroValidPointer (operand_18048) ;
        const GGS_bool cond_18234 = (operand_16743->mIsAbstract).operator_not () ;
        if (cond_18234.isBuiltAndTrue ()) {
          operand_18048->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a concrete class cannot declare an abstract method") COMMA_SOURCE_FILE_AT_LINE (411)) ;
        }
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_18379 (operand_18048->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_18379 = NULL ;
          while (((operand_18379 = enumerator_18379.nextObject ()))) {
            macroValidPointer (operand_18379) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_18379->mFormalParameterPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_18379->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (417)), operand_18379->mFormalParameterName, operand_18379->mIsUnused) ;
          }
        }
        const GGS_bool cond_19098 = operand_18048->mIsOverriding ;
        if (cond_19098.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_18910_0 ;
          const GGS_instanceMethodMap  temp_18843 = var_cas_inheritedInstanceMethodMap ;
          if (temp_18843.isBuilt ()) {
            temp_18843 (HERE)->method_searchInheritedKey (inLexique, operand_18048->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_18910_0 COMMA_SOURCE_FILE_AT_LINE (426)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_18048->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (429)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (427)) ;
        }else if (cond_19098.isBuiltAndFalse ()) {
          const GGS_bool cond_19281 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_18048->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (433))) ;
          if (cond_19281.isBuiltAndTrue ()) {
            operand_18048->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (435)) ;
          }
        }
        var_cas_abstractMethodList.addAssign_operation (operand_18048->mIsOverriding, operand_18048->mMethodName, var_cas_formalParameterListForGeneration) ;
      }
    }
    GGS_methodDefinitionListForGeneration  var_cas_methodList = GGS_methodDefinitionListForGeneration ::constructor_emptyList () ;
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_19497 (operand_16743->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_19497 = NULL ;
      while (((operand_19497 = enumerator_19497.nextObject ()))) {
        macroValidPointer (operand_19497) ;
        GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_19640 (operand_19497->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_19640 = NULL ;
          while (((operand_19640 = enumerator_19640.nextObject ()))) {
            macroValidPointer (operand_19640) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_19640->mFormalParameterPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_19640->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (446)), operand_19640->mFormalParameterName, operand_19640->mIsUnused) ;
          }
        }
        const GGS_bool cond_20359 = operand_19497->mIsOverriding ;
        if (cond_20359.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_20171_0 ;
          const GGS_instanceMethodMap  temp_20104 = var_cas_inheritedInstanceMethodMap ;
          if (temp_20104.isBuilt ()) {
            temp_20104 (HERE)->method_searchInheritedKey (inLexique, operand_19497->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_20171_0 COMMA_SOURCE_FILE_AT_LINE (455)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_19497->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (458)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (456)) ;
        }else if (cond_20359.isBuiltAndFalse ()) {
          const GGS_bool cond_20542 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_19497->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (462))) ;
          if (cond_20542.isBuiltAndTrue ()) {
            operand_19497->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (464)) ;
          }
        }
        var_cas_methodList.addAssign_operation (operand_19497->mIsOverriding, operand_19497->mMethodName, var_cas_formalParameterListForGeneration, GGS_semanticInstructionListForGeneration ::constructor_emptyList ()) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_16743->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (474)), operand_16743->mIsAbstract, operand_16743->mClassTypeName, var_cas_superClassIndex, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList COMMA_SOURCE_FILE_AT_LINE (473))) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_21756 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_21756 = NULL ;
    while (((operand_21756 = enumerator_21756.nextObject ()))) {
      macroValidPointer (operand_21756) ;
      const GGS_semanticDeclarationAST  temp_21809 = operand_21756->mSemanticDeclaration ;
      if (temp_21809.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_21809.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_21809 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (498)) ;
        }
      }
    }
  }
