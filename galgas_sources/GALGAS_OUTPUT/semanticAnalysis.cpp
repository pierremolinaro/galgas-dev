...
GALGAS_predefinedTypes function_buildPredefinedTypes (const GALGAS_semanticContext & constinArgument_inSemanticContext,
  ...
  result_outPredefinedTypes = GALGAS_predefinedTypes::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("location"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2943)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2943)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("bool"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2944)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2944)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("char"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2945)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2945)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("string"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2946)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2946)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("uint"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2947)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2947)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("sint"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2948)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2948)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("uint64"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2949)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2949)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("sint64"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2950)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2950)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("double"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2951)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2951)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lbool"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2952)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2952)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lchar"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2953)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2953)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lstring"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2954)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2954)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("luint"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2955)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2955)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lsint"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2956)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2956)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("luint64"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2957)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2957)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lsint64"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2958)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2958)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("ldouble"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2959)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2959))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2942)) ;
//---
...
void routine_performSemanticAnalysis (const GALGAS_string constinArgument_inProductDirectory,
  ...
  cEnumerator_lstringlist enumerator_120412 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2976)), kEnumeration_up) ;
  while (enumerator_120412.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_120412.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_120412.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2977))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2977)).operator_concat (GALGAS_string ("' type is undefined")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2977))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2977)) ;
    enumerator_120412.gotoNextObject () ;
  }
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = constinArgument_inDeclarationList ;
  cEnumerator_semanticDeclarationListAST enumerator_120666 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_120666.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_120666.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2982)) ;
    enumerator_120666.gotoNextObject () ;
  }
  outArgument_outDecoratedDeclarationListForGeneration = GALGAS_semanticDeclarationSortedListForGeneration::constructor_emptySortedList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2985)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("semanticAnalysis.gSemantics", 2986)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_predefinedTypes var_predefinedTypes = function_buildPredefinedTypes (constinArgument_inSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2987)) ;
    cEnumerator_semanticDeclarationListAST enumerator_121036 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_121036.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_121036.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inProductDirectory, constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2989)) ;
      enumerator_121036.gotoNextObject () ;
    }
  }
}
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_125448 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3110))) ;
  if (NULL != objectArray_125448) {
      macroValidSharedObject (objectArray_125448, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_125448->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 3111)) ;
    GALGAS_stringset var_reDeclarationLabelSet = constinArgument_inNonterminalLabelMap.reader_keySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 3112)) ;
    GALGAS_stringset var_missingLabelSet = var_firstDeclarationLabelSet.substract_operation (var_reDeclarationLabelSet, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3113)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_missingLabelSet.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 3114)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_125848 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_125848.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_125848.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3117))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3117)) ;
        enumerator_125848.gotoNextObject () ;
      }
      GALGAS_location location_1 (constinArgument_inNonTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3120))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3120)).operator_concat (GALGAS_string ("' nonterminal is redeclared without the following label(s):")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3120)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3120))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3119)) ;
    }
    GALGAS_stringset var_newLabelSet = var_reDeclarationLabelSet.substract_operation (var_firstDeclarationLabelSet, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3123)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_newLabelSet.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 3124)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_126228 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_126228.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_126228.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3127))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3127)) ;
        enumerator_126228.gotoNextObject () ;
      }
      GALGAS_location location_3 (constinArgument_inNonTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3130))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3130)).operator_concat (GALGAS_string ("' nonterminal is redeclared with the new label(s):")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3130)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3130))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3129)) ;
    }
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_missingLabelSet.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 3133)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 3133)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3133)).boolEnum () ;
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_126522 (objectArray_125448->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_126545 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_126522.hasCurrentObject () && enumerator_126545.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_newSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3135)) ;
        cEnumerator_formalParameterSignature enumerator_126647 (enumerator_126545.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_126647.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_126647.current_mFormalSelector (HERE), enumerator_126647.current_mFormalArgumentType (HERE), enumerator_126647.current_mFormalArgumentPassingMode (HERE), enumerator_126647.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3137)) ;
          enumerator_126647.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_126522.current_mSignatureForGeneration (HERE), enumerator_126522.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_126545.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3139)) ;
        }
        enumerator_126522.gotoNextObject () ;
        enumerator_126545.gotoNextObject () ;
      }
    }
  }else{
    {
    ioArgument_ioNonterminalDeclarationMap.modifier_insertKey (constinArgument_inNonTerminalName, constinArgument_inNonterminalLabelMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3148)) ;
    }
  }
}
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  outArgument_outNonterminalDeclarationMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 3159)) ;
  cEnumerator_nonterminalDeclarationListAST enumerator_127524 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_127524.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 3162)) ;
    cEnumerator_nonTerminalLabelListAST enumerator_127605 (enumerator_127524.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_127605.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3164)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3165)) ;
      cEnumerator_formalParameterListAST enumerator_127775 (enumerator_127605.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_127775.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_127775.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3167)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_127775.current_mFormalSelector (HERE), enumerator_127775.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_127775.current_mFormalArgumentName (HERE), enumerator_127775.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3168))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3168)) ;
        var_signature.addAssign_operation (enumerator_127775.current_mFormalSelector (HERE), var_t, enumerator_127775.current_mFormalArgumentPassingMode (HERE), enumerator_127775.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3169)) ;
        enumerator_127775.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_127605.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_127605.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3171)) ;
      }
      enumerator_127605.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_127524.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3173)) ;
    }
    enumerator_127524.gotoNextObject () ;
  }
}
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3757)) ;
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3759)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_152592 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_152592.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_152592.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3762)) ;
    enumerator_152592.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3776)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 4367)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4368)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4375)) ;
  cEnumerator_formalParameterListForGeneration enumerator_175006 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_175006.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_175006.current_mFormalSelector (HERE), enumerator_175006.current_mFormalArgumentType (HERE), enumerator_175006.current_mFormalArgumentPassingMode (HERE), enumerator_175006.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4377)) ;
    enumerator_175006.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4380)) ;
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4381)) ;
  cEnumerator_syntaxInstructionList enumerator_175361 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_175361.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_175361.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4383)) ;
    enumerator_175361.gotoNextObject () ;
  }
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4397)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 4420)) ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4421)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_176890 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_176890.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 4428)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_176974 (enumerator_176890.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_176974.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4430)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4431)) ;
      cEnumerator_formalParameterListAST enumerator_177141 (enumerator_176974.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_177141.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_177141.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4433)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_177141.current_mFormalSelector (HERE), enumerator_177141.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_177141.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_177141.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4434))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4434))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4434)) ;
        var_signature.addAssign_operation (enumerator_177141.current_mFormalSelector (HERE), var_type, enumerator_177141.current_mFormalArgumentPassingMode (HERE), enumerator_177141.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4435)) ;
        enumerator_177141.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_176974.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_176974.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4437)) ;
      }
      enumerator_176974.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_176890.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4439)) ;
    }
    enumerator_176890.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4445)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4447))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4442)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4451)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_178124 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_178124.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4454)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_178308_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_178124.current_mNonterminalName (HERE), joker_178308_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4456)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_178335 (enumerator_178124.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_178335.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_178335.current_mFormalArguments (HERE), enumerator_178335.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 4468)), var_nonterminalMap, constinArgument_inComponentName, enumerator_178335.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4462)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_178335.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_178335.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4478)) ;
      enumerator_178335.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_179333_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_178124.current_mNonterminalName (HERE), joker_179333_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4487)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_178124.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4489)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4488)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4493)) ;
    enumerator_178124.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4496)) ;
}
...
static void categoryMethod_galgas_33_GrammarComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  var_implementationFileHeader.addAssign_operation (GALGAS_string ("grammar-").operator_concat (object->mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2541))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2541))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2541)) ;
  var_implementationFileHeader.addAssign_operation (GALGAS_string ("lexique-").operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2542))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2542))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2542)) ;
...
static void categoryMethod_grammarForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  cEnumerator_lstringlist enumerator_104137 (object->mAttribute_mSyntaxComponents, kEnumeration_up) ;
  while (enumerator_104137.hasCurrentObject ()) {
    ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("syntax-").add_operation (enumerator_104137.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2608)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2608))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2608)) ;
    enumerator_104137.gotoNextObject () ;
  }
  outArgument_outHeader = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_HeaderGalgas_33_ (inCompiler, object->mAttribute_mLexiqueName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 2611)), object->mAttribute_mNonTerminalMapForGrammarAnalysis, object->mAttribute_mNonTerminalToAddList, object->mAttribute_mHasIndexing, object->mAttribute_mStartSymbolName, object->mAttribute_mHasTranslateFeature, object->mAttribute_mGrammarName, object->mAttribute_mSyntaxComponents COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2610))) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarForGeneration_appendSpecificImplementation (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  const cPtr_grammarForGeneration * object = (const cPtr_grammarForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_grammarForGeneration) ;
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("grammar-").add_operation (object->mAttribute_mGrammarName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2628))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2628)) ;
...
static void categoryMethod_grammarForGeneration_appendSpecificFiles (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  const cPtr_grammarForGeneration * object = (const cPtr_grammarForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_grammarForGeneration) ;
  GALGAS_string var_HTMLFilePath = constinArgument_inProductDirectory.operator_concat (GALGAS_string ("/../helpers/")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2638)).operator_concat (object->mAttribute_mGrammarName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2638)).operator_concat (GALGAS_string (".html")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2638)) ;
  const enumGalgasBool test_0 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_bool joker_105261_0 ; // Joker input parameter
    object->mAttribute_mHTLMHelperContents.method_writeToFileWhenDifferentContents (var_HTMLFilePath, joker_105261_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2640)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_HTMLFilePath, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2642)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lexicalTypeMap var_lexicalTypeMap = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2655)) ;
  GALGAS_lexicalRoutineMap var_lexicalRoutineMap ;
  {
  routine_buildLexicalRoutineMap (var_lexicalRoutineMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2658)) ;
  }
  cEnumerator_externRoutineListAST enumerator_106082 (object->mAttribute_mExternRoutineList, kEnumeration_up) ;
  while (enumerator_106082.hasCurrentObject ()) {
    GALGAS_lexicalRoutineFormalArgumentList var_lexicalRoutineFormalArgumentList = GALGAS_lexicalRoutineFormalArgumentList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2661)) ;
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_106216 (enumerator_106082.current_mLexicalRoutineFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_106216.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_106216.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2664)) ;
      var_lexicalRoutineFormalArgumentList.addAssign_operation (enumerator_106216.current_mPassingMode (HERE), var_lexicalFormalArgumentType, enumerator_106216.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2665))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2665)) ;
      enumerator_106216.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap.modifier_insertKey (enumerator_106082.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList, enumerator_106082.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2667)) ;
    }
    enumerator_106082.gotoNextObject () ;
  }
  GALGAS_lexicalFunctionMap var_lexicalFunctionMap ;
  {
  routine_buildLexicalFunctionMap (var_lexicalFunctionMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2671)) ;
  }
  cEnumerator_externFunctionListAST enumerator_106861 (object->mAttribute_mExternFunctionList, kEnumeration_up) ;
  while (enumerator_106861.hasCurrentObject ()) {
    GALGAS_lexicalFunctionFormalArgumentList var_lexicalFunctionFormalArgumentList = GALGAS_lexicalFunctionFormalArgumentList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2674)) ;
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_106998 (enumerator_106861.current_mLexicalFunctionFormalArgumentList (HERE), kEnumeration_up) ;
    while (enumerator_106998.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType ;
      var_lexicalTypeMap.method_searchKey (enumerator_106998.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2677)) ;
      var_lexicalFunctionFormalArgumentList.addAssign_operation (var_lexicalFormalArgumentType, enumerator_106998.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2678))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2678)) ;
      enumerator_106998.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType ;
    var_lexicalTypeMap.method_searchKey (enumerator_106861.current_mReturnedTypeName (HERE), var_returnedArgumentType, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2681)) ;
    {
    var_lexicalFunctionMap.modifier_insertKey (enumerator_106861.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList, var_returnedArgumentType, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2682)) ;
    }
    enumerator_106861.gotoNextObject () ;
  }
  GALGAS_stringset temp_0 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 2697)) ;
  temp_0.addAssign_operation (GALGAS_string ("unicodeToLower")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2686)) ;
  temp_0.addAssign_operation (GALGAS_string ("unicodeToUpper")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2687)) ;
  temp_0.addAssign_operation (GALGAS_string ("unicodeToUpper")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2688)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeLetter")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2689)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeMark")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2690)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeNumber")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2691)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeDecimalDigit")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2692)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeASCIIHexDigit")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2693)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeSeparator")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2694)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeCommand")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2695)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodePunctuation")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2696)) ;
  temp_0.addAssign_operation (GALGAS_string ("isUnicodeSymbol")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2697)) ;
  GALGAS_stringset var_externUnicodeTestFunctions = temp_0 ;
  GALGAS_lexiqueAnalysisContext var_lexiqueAnalysisContext = GALGAS_lexiqueAnalysisContext::constructor_new (object->mAttribute_mLexiqueComponentName.mAttribute_string, var_lexicalRoutineMap, var_lexicalFunctionMap, GALGAS_lexicalMessageMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2704)), GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2705)), GALGAS_terminalList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2706)), GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2707)), GALGAS_lexicalExplicitTokenListMapMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2708)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 2709)), GALGAS_templateDelimitorList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2710)), GALGAS_styleMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2711)), var_externUnicodeTestFunctions COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2700)) ;
  GALGAS_uint var_styleIndex = GALGAS_uint ((uint32_t) 1U) ;
  cEnumerator_lexicalStyleListAST enumerator_108520 (object->mAttribute_mLexicalStyleList, kEnumeration_up) ;
  while (enumerator_108520.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mStyleMap.modifier_insertKey (enumerator_108520.current_mName (HERE), enumerator_108520.current_mComment (HERE), var_styleIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2717)) ;
    }
    var_styleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2718)) ;
    enumerator_108520.gotoNextObject () ;
  }
  {
  routine_buildLexicalAttributeMap (var_lexicalTypeMap, object->mAttribute_mLexicalAttributeList, var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2721)) ;
  }
  cEnumerator_terminalDeclarationListAST enumerator_108932 (object->mAttribute_mTerminalDeclarationList, kEnumeration_up) ;
  while (enumerator_108932.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, enumerator_108932.current_mStyle (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2729)).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 2729)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_lstring joker_109074_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2730)).method_searchKey (enumerator_108932.current_mStyle (HERE), joker_109074_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2730)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2732)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_109199 (enumerator_108932.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_109199.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_109199.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2735)) ;
      var_argumentTypeList.addAssign_operation (enumerator_109199.current_mFormalSelector (HERE), enumerator_109199.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2736)) ;
      enumerator_109199.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_108932.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2738)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_109643 (enumerator_108932.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_109643.hasCurrentObject ()) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_109643.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2742)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = var_atomicSelection.boolEnum () ;
        if (kBoolTrue == test_3) {
          var_atomicSelection = GALGAS_bool (false) ;
        }else if (kBoolFalse == test_3) {
          GALGAS_location location_4 (enumerator_109643.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_4, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2746)) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_109643.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2748)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_location location_6 (enumerator_109643.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2749)) ;
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = var_isEndOfTemplateMark.boolEnum () ;
          if (kBoolTrue == test_7) {
            GALGAS_location location_8 (enumerator_109643.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_8, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2751)) ;
          }else if (kBoolFalse == test_7) {
            var_isEndOfTemplateMark = GALGAS_bool (true) ;
          }
        }
      }
      enumerator_109643.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_108932.current_mName (HERE), var_argumentTypeList, enumerator_108932.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2759)), var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2756)) ;
    enumerator_108932.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_110475 (object->mAttribute_mLexicalListDeclarationList, kEnumeration_up) ;
  while (enumerator_110475.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, enumerator_110475.current_mStyle (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2767)).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 2767)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_lstring joker_110617_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2768)).method_searchKey (enumerator_110475.current_mStyle (HERE), joker_110617_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2768)) ;
    }
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2770)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_110742 (enumerator_110475.current_mSentAttributeList (HERE), kEnumeration_up) ;
    while (enumerator_110742.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexiqueAnalysisContext.mAttribute_mLexicalAttributeMap.method_searchKey (enumerator_110742.current_mAttributeName (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2773)) ;
      var_argumentTypeList.addAssign_operation (enumerator_110742.current_mFormalSelector (HERE), enumerator_110742.current_mAttributeName (HERE).mAttribute_string, var_attributeLexicalType  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2774)) ;
      enumerator_110742.gotoNextObject () ;
    }
    GALGAS_lexicalExplicitTokenListMap var_lexicalTokenListMap = GALGAS_lexicalExplicitTokenListMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2776)) ;
    GALGAS_tokenSortedlist var_tokenSortedlist = GALGAS_tokenSortedlist::constructor_emptySortedList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2777)) ;
    cEnumerator_lexicalListEntryListAST enumerator_111149 (enumerator_110475.current_mEntryList (HERE), kEnumeration_up) ;
    while (enumerator_111149.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage = enumerator_110475.current_mSyntaxErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2779)).reader_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_111149.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2779)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2779)) ;
      GALGAS_bool var_isEndOfTemplateMark = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_111395 (enumerator_111149.current_mFeatureList (HERE), kEnumeration_up) ;
      while (enumerator_111395.hasCurrentObject ()) {
        const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_111395.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2783)).objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_10) {
          const enumGalgasBool test_11 = var_atomicSelection.boolEnum () ;
          if (kBoolTrue == test_11) {
            var_atomicSelection = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_11) {
            GALGAS_location location_12 (enumerator_111395.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_12, GALGAS_string ("the 'nonAtomicSelection' feature is already set")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2787)) ;
          }
        }else if (kBoolFalse == test_10) {
          const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_111395.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2789)).objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_13) {
            GALGAS_location location_14 (enumerator_111395.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_14, GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' features are allowed here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2790)) ;
          }else if (kBoolFalse == test_13) {
            const enumGalgasBool test_15 = var_isEndOfTemplateMark.boolEnum () ;
            if (kBoolTrue == test_15) {
              GALGAS_location location_16 (enumerator_111395.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_16, GALGAS_string ("the 'templateEndMark' feature is already set")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2792)) ;
            }else if (kBoolFalse == test_15) {
              var_isEndOfTemplateMark = GALGAS_bool (true) ;
            }
          }
        }
        enumerator_111395.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext.mAttribute_mTerminalList.addAssign_operation (enumerator_111149.current_mTerminalSpelling (HERE), var_argumentTypeList, var_syntaxErrorMessage, var_isEndOfTemplateMark, var_atomicSelection, var_terminalStyleIndex  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2797)) ;
      {
      var_lexiqueAnalysisContext.mAttribute_mTerminalMap.modifier_insertKey (enumerator_111149.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2805)) ;
      }
      {
      var_lexicalTokenListMap.modifier_insertKey (enumerator_111149.current_mEntrySpelling (HERE), enumerator_111149.current_mTerminalSpelling (HERE), enumerator_111149.current_mFeatureList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2806)) ;
      }
      var_tokenSortedlist.addAssign_operation (enumerator_111149.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2807)).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 2807)), enumerator_111149.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2807)), enumerator_111149.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2807))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2807)) ;
      var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_111149.current_mEntrySpelling (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2808))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2808)) ;
      enumerator_111149.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalTokenListMap.modifier_insertKey (enumerator_110475.current_mName (HERE), var_lexicalTokenListMap, var_tokenSortedlist, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2810)) ;
    }
    enumerator_110475.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageDeclarationListAST enumerator_112856 (object->mAttribute_mLexicalMessageDeclarationList, kEnumeration_up) ;
  while (enumerator_112856.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext.mAttribute_mLexicalMessageMap.modifier_insertKey (enumerator_112856.current_mMessageName (HERE), enumerator_112856.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2814)) ;
    }
    enumerator_112856.gotoNextObject () ;
  }
  cEnumerator_lexicalRuleListAST enumerator_113054 (object->mAttribute_mLexicalRuleList, kEnumeration_up) ;
  while (enumerator_113054.hasCurrentObject ()) {
    callCategoryMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_113054.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2818)) ;
    enumerator_113054.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_113256 (var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2821)), kEnumeration_up) ;
  while (enumerator_113256.hasCurrentObject ()) {
    const enumGalgasBool test_17 = enumerator_113256.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2822)).boolEnum () ;
    if (kBoolTrue == test_17) {
      GALGAS_location location_18 (enumerator_113256.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_18, GALGAS_string ("unused message")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2823)) ;
    }
    enumerator_113256.gotoNextObject () ;
  }
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_113451 (object->mAttribute_mTemplateDelimitorList, kEnumeration_up) ;
  while (enumerator_113451.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_113451.current_mStartString (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2828))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2828)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_113451.current_mEndString (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2829))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2829)) ;
    GALGAS_bool var_preservesStartDelimiter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_113679 (enumerator_113451.current_mOptionList (HERE), kEnumeration_up) ;
    while (enumerator_113679.hasCurrentObject ()) {
      const enumGalgasBool test_19 = GALGAS_bool (kIsNotEqual, enumerator_113679.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2832)).objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
      if (kBoolTrue == test_19) {
        GALGAS_location location_20 (enumerator_113679.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_20, GALGAS_string ("only the 'preserved' feature is allowed here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2833)) ;
      }else if (kBoolFalse == test_19) {
        const enumGalgasBool test_21 = var_preservesStartDelimiter.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_113679.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("the 'preserved' feature is already set")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2835)) ;
        }else if (kBoolFalse == test_21) {
          var_preservesStartDelimiter = GALGAS_bool (true) ;
        }
      }
      enumerator_113679.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext.mAttribute_mTemplateDelimitorList.addAssign_operation (enumerator_113451.current_mStartString (HERE), enumerator_113451.current_mEndString (HERE), var_preservesStartDelimiter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2840)) ;
    enumerator_113451.gotoNextObject () ;
  }
  const enumGalgasBool test_23 = object->mAttribute_mIndexingDirectory.mAttribute_location.reader_isNowhere (SOURCE_FILE ("semanticAnalysis.gSemantics", 2843)).boolEnum () ;
  if (kBoolTrue == test_23) {
    cEnumerator_indexingListAST enumerator_114243 (object->mAttribute_mIndexingListAST, kEnumeration_up) ;
    while (enumerator_114243.hasCurrentObject ()) {
      GALGAS_location location_24 (enumerator_114243.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_24, GALGAS_string ("indexing declaration requires one 'indexing in \"path\";' declaration")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2845)) ;
      enumerator_114243.gotoNextObject () ;
    }
  }
  GALGAS_stringset var_indexNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 2848)) ;
  cEnumerator_indexingListAST enumerator_114440 (object->mAttribute_mIndexingListAST, kEnumeration_up) ;
  while (enumerator_114440.hasCurrentObject ()) {
    const enumGalgasBool test_25 = var_indexNameSet.reader_hasKey (enumerator_114440.current_mIndexName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2850)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2850)).boolEnum () ;
    if (kBoolTrue == test_25) {
      GALGAS_location location_26 (enumerator_114440.current_mIndexName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("the '").operator_concat (enumerator_114440.current_mIndexName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2851))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2851)).operator_concat (GALGAS_string ("' index is already declared")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2851))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2851)) ;
    }
    var_indexNameSet.addAssign_operation (enumerator_114440.current_mIndexName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2853))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2853)) ;
    enumerator_114440.gotoNextObject () ;
  }
  cEnumerator_templateReplacementListAST enumerator_114748 (object->mAttribute_mTemplateReplacementList, kEnumeration_up) ;
  while (enumerator_114748.hasCurrentObject ()) {
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_114748.current_mMatchString (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2857))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2857)) ;
    var_lexiqueAnalysisContext.mAttribute_mUnicodeStringToGenerate.addAssign_operation (enumerator_114748.current_mReplacementString (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2858))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2858)) ;
    enumerator_114748.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("semanticAnalysis.gSemantics", 2862)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_27) {
    GALGAS_string var_lexiqueClassName = object->mAttribute_mLexiqueComponentName.mAttribute_string ;
    GALGAS_string var_headerContents = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 2866)), var_lexiqueAnalysisContext, object->mAttribute_mTemplateDelimitorList COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2865))) ;
    var_headerContents.dotAssign_operation (GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 2871)), object->mAttribute_mLexicalListDeclarationList, var_lexiqueAnalysisContext, object->mAttribute_mIndexingListAST COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2870)))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2870)) ;
    GALGAS_string var_cppContents = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (inCompiler, var_lexiqueClassName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 2878)), var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2879)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2880)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2881)), var_lexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2882)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("semanticAnalysis.gSemantics", 2883)), object->mAttribute_mLexicalRuleList, var_lexiqueAnalysisContext, object->mAttribute_mIndexingDirectory.mAttribute_string, object->mAttribute_mTemplateDelimitorList, var_lexiqueClassName, object->mAttribute_mTemplateReplacementList COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2877))) ;
    GALGAS_string var_cocoaHeader = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2892))) ;
    var_cocoaHeader.dotAssign_operation (GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_33_ (inCompiler, var_lexiqueClassName, var_lexiqueAnalysisContext COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2896)))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2896)) ;
    GALGAS_string var_cocoaImplementation = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2902)).add_operation (GALGAS_string ("-cocoa"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2902)), var_lexiqueClassName, var_lexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2904)), var_lexiqueAnalysisContext.reader_mLexicalMessageMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2905)), var_lexiqueAnalysisContext.reader_mTerminalList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2906)), var_lexiqueAnalysisContext.reader_mUnicodeStringToGenerate (SOURCE_FILE ("semanticAnalysis.gSemantics", 2907)), object->mAttribute_mLexicalRuleList, var_lexiqueAnalysisContext, object->mAttribute_mTemplateReplacementList, object->mAttribute_mIndexingDirectory.mAttribute_string, object->mAttribute_mIndexingListAST, object->mAttribute_mLexicalStyleList, object->mAttribute_mTemplateDelimitorList COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2901))) ;
    ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string::makeEmptyString (), GALGAS_lexiqueDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("lexique-").add_operation (var_lexiqueClassName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2921)), var_lexiqueClassName, var_headerContents, var_cppContents, var_cocoaHeader, var_cocoaImplementation  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2919)), GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2917)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_semanticInstructionAST_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) temp_0.ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionListForGeneration, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3210)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inNonterminalMap.method_searchKey (object->mAttribute_mNonterminalName, var_labelMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3232)) ;
  GALGAS_formalParameterSignature var_signature ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mLabelName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3234)).objectCompare (GALGAS_string ("parse"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3235)) ;
  }else if (kBoolFalse == test_0) {
    GALGAS_formalParameterListForGeneration joker_130745_0 ; // Joker input parameter
    GALGAS_location joker_130759_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_130745_0, var_signature, joker_130759_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3237)) ;
  }
  GALGAS_unifiedTypeMapProxyAndLocalVariableList var_localVariableDeclarationList = GALGAS_unifiedTypeMapProxyAndLocalVariableList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3240)) ;
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  {
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mNonterminalName, GALGAS_string ("'<").operator_concat (object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3244))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3244)).operator_concat (GALGAS_string (">' nonterminal declaration")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3244)), var_signature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_localVariableDeclarationList, var_actualParameterListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3241)) ;
  }
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3252)) ;
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_131451 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_131451.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_131451.current_mType (HERE), enumerator_131451.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3259))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3259)) ;
    enumerator_131451.gotoNextObject () ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_nonterminalInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3266)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3267)), var_actualParameterListForGeneration, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3264))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3264)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_stringlist var_parameterCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3283)) ;
  GALGAS_stringlist var_jokerParametersToReleaseList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3284)) ;
  GALGAS_stringlist var_inputVariableList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3285)) ;
  cEnumerator_actualParameterListForGeneration enumerator_132411 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  while (enumerator_132411.hasCurrentObject ()) {
    GALGAS_string var_parameterCppName ;
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_132411.current_mActualParameter (HERE).ptr (), ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3287)) ;
    var_parameterCppNameList.addAssign_operation (var_parameterCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3296)) ;
    enumerator_132411.gotoNextObject () ;
  }
  GALGAS_string var_sdtResultVarName = GALGAS_string ("syntaxDirectedTranslationResult_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3299)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3299))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3299)) ;
  const enumGalgasBool test_0 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("C_String ").operator_concat (var_sdtResultVarName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3301)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3301))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3301)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("nt_").operator_concat (object->mAttribute_mNonterminalName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3303))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3303)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3303)).operator_concat (object->mAttribute_mLabelName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3303))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3303)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3303))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3303)) ;
  cEnumerator_stringlist enumerator_133160 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_133160.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_133160.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3305))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3305)) ;
    enumerator_133160.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioGeneratedCode.dotAssign_operation (var_sdtResultVarName.operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3308))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3308)) ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3310)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3310)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3311)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3311))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3311)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, var_sdtResultVarName, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3312)) ;
  cEnumerator_stringlist enumerator_133717 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_133717.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_133717.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3320))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3320)) ;
    enumerator_133717.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_135195_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_135195_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3358)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3371))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3371)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3371)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3371))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3371)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3371)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3372))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3372)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3372))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3370)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (GALGAS_string::makeEmptyString (), var_cppName, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3375)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3404)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3407))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3407)).operator_concat (GALGAS_string ("' formal argument has the '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3407)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3407))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3407)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3407)).operator_concat (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3408))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3408)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3408))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3406)) ;
    }
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3413))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3413)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_expectedType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3414)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3416)), var_cppName, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3415)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredConstant_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualParameterTypeName.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3444)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3447))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3447)).operator_concat (GALGAS_string ("' formal argument has the '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3447)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3447))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3447)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3447)).operator_concat (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3448))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3448)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3448))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3446)) ;
    }
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3453))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3453)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_expectedType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3454)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3457)), var_cppName, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3456)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationDropResult_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3487)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3488)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3499)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3500)) ;
  }
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_141762_0 ; // Joker input parameter
  GALGAS_string joker_141765_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_141762_0, joker_141765_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3502)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3506))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3506)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3506)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3506))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3506)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3506)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3507))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3507)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3507))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3505)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3519)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3520)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3522))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3522)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3523)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3524)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3528))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3528)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3528)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3528))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3528)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3528)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3529))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3529)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3529))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3527)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3541)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3542)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3544))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3544)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3545)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3546)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3550))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3550)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3550)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3550))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3550)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3550)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3551))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3551)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3551))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3549)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultNone_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * /* inObject */,
  ...
  const enumGalgasBool test_0 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3574)).operator_concat (GALGAS_string (" << ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3574)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3574)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3574))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3574)) ;
    {
    ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3575)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3575)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInVar * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInVar *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInVar) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3597))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3597)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (var_cppName.operator_concat (GALGAS_string (" = GALGAS_string (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3598)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3598)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3598))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3598)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3609))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3609)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_string ").operator_concat (var_cppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3610)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3610)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3610)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3610))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3610)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3621))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3621)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const GALGAS_string ").operator_concat (var_cppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inTerminalMap.method_searchKey (object->mAttribute_mTerminalName, var_sentAttributeList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3639)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 3641)).objectCompare (var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 3641)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 3644)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    GALGAS_string temp_3 ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 3647)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
    if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("naming the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3643))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3643)).operator_concat (GALGAS_string ("$' terminal requires ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3643)).operator_concat (var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 3643)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3643))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3643)).operator_concat (GALGAS_string (" input parameter")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3643)).operator_concat (temp_1  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3644)).operator_concat (GALGAS_string (", but this instruction names ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3644)).operator_concat (object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 3646)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3646))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3645)).operator_concat (GALGAS_string (" input parameter")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3646)).operator_concat (temp_3  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3646))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3642)) ;
  }
  GALGAS_terminalCheckAssignementList var_terminalCheckAssignementList = GALGAS_terminalCheckAssignementList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3651)) ;
  cEnumerator_actualInputParameterListAST enumerator_148381 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_148400 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_148381.hasCurrentObject () && enumerator_148400.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_148381.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_148400.current_mLexicalType (HERE), enumerator_148400.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3653)) ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_148400.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_148381.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string temp_7 ;
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_148400.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_8) {
        temp_7 = GALGAS_string (":") ;
      }else if (kBoolFalse == test_8) {
        temp_7 = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_location location_9 (enumerator_148381.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the actual selector should be '\?").operator_concat (enumerator_148400.current_mLexicalFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3661))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)).operator_concat (temp_7.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)) ;
      GALGAS_location location_10 (enumerator_148400.current_mLexicalFormalSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_10, GALGAS_string ("the formal selector is declared here")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3662)) ;
    }
    enumerator_148381.gotoNextObject () ;
    enumerator_148400.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_148959 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_148959.hasCurrentObject ()) {
    const enumGalgasBool test_11 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_148959.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3667)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3667)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3667)).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_149068 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_149068.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_149068.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3670))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3670)) ;
        enumerator_149068.gotoNextObject () ;
      }
      GALGAS_location location_12 (enumerator_148959.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_148959.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3672))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3672)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3672)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3672))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3672)) ;
    }
    enumerator_148959.gotoNextObject () ;
  }
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3676)) ;
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3681)) ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_terminalCheckInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTerminalName, constinArgument_inLexiqueName, var_terminalCheckAssignementList, object->mAttribute_mIndexingKeyList, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3687))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3687)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_150401 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_150401.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_150401.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_150401.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3710))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3710)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3710))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3710)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_150401.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3713)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3713))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3713)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3713)).operator_concat (enumerator_150401.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3714))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3713)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3714))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3713)) ;
    enumerator_150401.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_150802 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_150802.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)).operator_concat (GALGAS_string ("::kIndexing_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)).operator_concat (enumerator_150802.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3719))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)) ;
    enumerator_150802.gotoNextObject () ;
  }
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->preceedingSeparatorString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3722)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->tokenString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3728)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3735)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3735)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3736)).operator_concat (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3736)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3736)).operator_concat (GALGAS_string ("::kToken_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3737)).operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3737))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3737)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3737)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mInstructionLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3738))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3738)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3738))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3736)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3794)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3796)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mRepeatedInstructionList, object->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_repeated_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3799)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3814)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_154225 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_154225.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_154225.current_mSyntaxInstructionList (HERE), enumerator_154225.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3817)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_154225.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3831)) ;
    enumerator_154225.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_repeat_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3834)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOf_5F_repeat_5F_instruction, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3836))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3836)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_repeatFlagCppName = GALGAS_string ("repeatFlag_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3856))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3856)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3856)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3857)).operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3857))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3857)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3858)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3858))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3858)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_m_5F_repeated_5F_instructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3859)) ;
  }
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3867)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3868))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3868))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)).operator_concat (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_156206 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_156162 ((uint32_t) 0) ;
  while (enumerator_156206.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_156162.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3870)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3870))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3870)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3870))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3870)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_156206.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3871)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3879)) ;
    enumerator_156206.gotoNextObject () ;
    index_156162.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3869)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3881)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3882)).operator_concat (GALGAS_string (" = false ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3882))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3882)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3883)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3884)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3885)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3886)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_choiceIndex = ioArgument_ioSelectMethodCount ;
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3904)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3906)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3908)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_157601 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_157601.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_157601.current_mSyntaxInstructionList (HERE), enumerator_157601.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3911)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_157601.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3925)) ;
    enumerator_157601.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_select_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3928)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_selectInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3929))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3929)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3947)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3947)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3948))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3948))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948)).operator_concat (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3948)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_159073 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_159029 ((uint32_t) 0) ;
  while (enumerator_159073.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_159029.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3950)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3950))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3950)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3950))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3950)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_159073.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3951)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3959)) ;
    enumerator_159073.gotoNextObject () ;
    index_159029.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3949)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3961)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3962)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3963)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3981)) ;
  GALGAS_uint var_referenceSelectMethodCount = ioArgument_ioSelectMethodCount ;
  cEnumerator_listOfSyntaxInstructionList enumerator_160268 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_160268.hasCurrentObject ()) {
    ioArgument_ioSelectMethodCount = var_referenceSelectMethodCount ;
    GALGAS_semanticInstructionListForGeneration var_instructionList = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3985)) ;
    cEnumerator_syntaxInstructionList enumerator_160434 (enumerator_160268.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_160434.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_160434.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3987)) ;
      enumerator_160434.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_160268.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4000)) ;
    enumerator_160268.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_161138_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_161138_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4005)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4006)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_161323 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_161323.hasCurrentObject () && bool_0) {
    while (enumerator_161323.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_161323.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4011)), enumerator_161323.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4009)) ;
      enumerator_161323.gotoNextObject () ;
      if (enumerator_161323.hasCurrentObject ()) {
        bool_0 = var_ok.isValidAndTrue () ;
      }
    }
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseRewindInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4016))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4016)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4032)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4032)) ;
  }
  GALGAS_string var_parsingContextVar = GALGAS_string ("parsingContext_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4033))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4033)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4033)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext ").operator_concat (var_parsingContextVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4034)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4034)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4034))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4034)).operator_concat (GALGAS_string ("->parsingContext () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4034))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4034)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_162502 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_162502.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_162502.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4037)) ;
    }
    if (enumerator_162502.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)).operator_concat (GALGAS_string ("->setParsingContext (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)).operator_concat (var_parsingContextVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)).operator_concat (GALGAS_string (") ; // rewind\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)) ;
    }
    enumerator_162502.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//-------- END OF @parseRewindInstructionForGeneration\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4048)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4068)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variant_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4067)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4073)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4075)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4075))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4075)).operator_concat (GALGAS_string ("', but it should be '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4075)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4076))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4076)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4076))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4074)) ;
  }
  GALGAS_semanticExpressionForGeneration var_while_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4082)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4081)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4087)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfWhileExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4089)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4089))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4089)).operator_concat (GALGAS_string ("', but it should be '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4089)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4090))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4090)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4090))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4088)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4095)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mDoInstructionList, object->mAttribute_mEndOfInstructionList, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4098)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4113)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseLoopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variant_5F_expression, var_while_5F_expression, var_instructionList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4115))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4115)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4132)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4132)) ;
  }
  GALGAS_string var_variantVarCppName ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mVariantExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_variantVarCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4136)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_variantVarCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4138)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4138))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4138)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4139)) ;
  }
  GALGAS_string var_variantVar = GALGAS_string ("variant_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4140))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4140)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4140)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("uint32_t ").operator_concat (var_variantVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4141)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4141)).operator_concat (var_variantVarCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4141)).operator_concat (GALGAS_string (".uintValue () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4141))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4141)) ;
  GALGAS_string var_loopVar = GALGAS_string ("loop_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4143))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4143)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4143)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_loopVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4144)).operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4144))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4144)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_loopVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4145)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4145))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4145)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4146)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (var_loopVar.operator_concat (GALGAS_string (" = false ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4147))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4147)) ;
  GALGAS_string var_whileVarCppName ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVarCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4149)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_whileVarCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4150)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4150))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4150)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4151)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (var_loopVar.operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4152))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4152)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (var_variantVar.operator_concat (GALGAS_string (" -- ; // Decrement variant\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4153))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4153)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext parsingContext = ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4154))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4154)).operator_concat (GALGAS_string ("->parsingContext () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4154))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4154)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4155)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4163)).operator_concat (GALGAS_string ("->setParsingContext (parsingContext) ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4163))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4163)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4164)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4165)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4166)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4167)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4168)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4169)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//--- 'parse'\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4171)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4174)), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4172)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4180)).operator_concat (GALGAS_string ("->resetTemplateString () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4180))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4180)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//-------- END OF @parseLoopInstructionForGeneration\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4181)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4201)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4200)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4207)) ;
  }
...
static void categoryMethod_parseWhenInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhenExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4271)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4272)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4272))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4272)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4273)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4281)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mElseInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4282)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4290)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 4307)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' instruction is only allowed when syntax componant has 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4308)) ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4312)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4311)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4318)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' expresion should be an @string expression")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4319)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_syntaxSendInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_expression  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4322))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4322)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_sourceVar ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4337)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4339)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4339)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4340)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4340)).operator_concat (GALGAS_string ("  ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4340)).operator_concat (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4341))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4341)).operator_concat (GALGAS_string (" << ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4341)).operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4341)).operator_concat (GALGAS_string (".stringValue () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4341)).operator_concat (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4341))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4340)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
