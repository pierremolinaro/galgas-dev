...
category_method__structDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_3478,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                GGS_semanticDeclarationListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3478 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_3680 (operand_3478->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_3680 = NULL ;
      while (((operand_3680 = enumerator_3680.nextObject ()))) {
        macroValidPointer (operand_3680) ;
        var_cas_typedAttributeList.addAssign_operation (GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (77)), operand_3680->mAttributeTypeName COMMA_HERE), operand_3680->mAttributeName) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_structTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (82)), operand_3478->mStructTypeName COMMA_HERE), var_cas_typedAttributeList COMMA_HERE)) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_4706 (var_cas_inSemanticContext.reader_mOrderedSemanticDeclarationListAST (inLexique COMMA_SOURCE_FILE_AT_LINE (99)), true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_4706 = NULL ;
    while (((operand_4706 = enumerator_4706.nextObject ()))) {
      macroValidPointer (operand_4706) ;
      const GGS_semanticDeclarationAST  temp_4812 = operand_4706->mSemanticDeclaration ;
      if (temp_4812.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_4812.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_4812 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (100)) ;
        }
      }
    }
  }
