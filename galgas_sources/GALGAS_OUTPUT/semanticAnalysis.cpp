...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
  ...
  if (operand_17584 != NULL) {
    ...
    const GGS_bool cond_17932 = (operand_17584->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (402))).operator_isEqual (GGS_string ("")) ;
    if (cond_17932.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (403)) COMMA_SOURCE_FILE_AT_LINE (403)) ;
    }else if (cond_17932.isBuiltAndFalse ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_17584->mSuperClassName COMMA_SOURCE_FILE_AT_LINE (405)) ;
    }
    GGS_typedAttributeList  var_cas_allAttributeList = var_cas_superClassIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (408)) ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    GGS_attributeIndexMap  var_cas_attributeIndexMap = GGS_attributeIndexMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (410)) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_18295 (operand_17584->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_18295 = NULL ;
      while (((operand_18295 = enumerator_18295.nextObject ()))) {
        macroValidPointer (operand_18295) ;
        var_cas_typedAttributeList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_18295->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (413)), operand_18295->mAttributeName) ;
        var_cas_allAttributeList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_18295->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (417)), operand_18295->mAttributeName) ;
        var_cas_attributeIndexMap.modifier_insertKey (inLexique, operand_18295->mAttributeName, var_cas_attributeIndexMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (420)) ;
      }
    }
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    const GGS_bool cond_18878 = (operand_17584->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (424))).operator_isEqual (GGS_string ("")) ;
    if (cond_18878.isBuiltAndTrue ()) {
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (425)) ;
    }else if (cond_18878.isBuiltAndFalse ()) {
      GGS_bool automatic_var_18976_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_18976_1 ;
      GGS_typeKindEnum automatic_var_18976_2 ;
      GGS_typedAttributeList  automatic_var_18976_3 ;
      GGS_typedAttributeList  automatic_var_18976_4 ;
      GGS_constructorMap  automatic_var_18976_5 ;
      GGS_readerMap  automatic_var_18976_6 ;
      GGS_modifierMap  automatic_var_18976_7 ;
      GGS_classMethodMap  automatic_var_18976_8 ;
      GGS_enumerationDescriptorList  automatic_var_18976_9 ;
      GGS_uint  automatic_var_18976_10 ;
      GGS_unifiedTypeMapProxyList  automatic_var_18976_11 ;
      GGS_unifiedTypeMapProxyList  automatic_var_18976_12 ;
      GGS_nativeAttributeList  automatic_var_18976_13 ;
      GGS_lstringlist  automatic_var_18976_14 ;
      GGS_typedAttributeList  automatic_var_18976_15 ;
      GGS_mapMethodListAST  automatic_var_18976_16 ;
      GGS_mapMethodListAST  automatic_var_18976_17 ;
      const GGS_unifiedTypeMap  temp_18921 = var_cas_inSemanticContext.mTypeMap ;
      if (temp_18921.isBuilt ()) {
        temp_18921 (HERE)->method_searchKey (inLexique, operand_17584->mSuperClassName, automatic_var_18976_0, automatic_var_18976_1, automatic_var_18976_2, automatic_var_18976_3, automatic_var_18976_4, automatic_var_18976_5, automatic_var_18976_6, automatic_var_18976_7, var_cas_inheritedInstanceMethodMap, automatic_var_18976_8, automatic_var_18976_9, automatic_var_18976_10, automatic_var_18976_11, automatic_var_18976_12, automatic_var_18976_13, automatic_var_18976_14, automatic_var_18976_15, automatic_var_18976_16, automatic_var_18976_17 COMMA_SOURCE_FILE_AT_LINE (427)) ;
      }
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_19122 (operand_17584->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_19122 = NULL ;
      while (((operand_19122 = enumerator_19122.nextObject ()))) {
        macroValidPointer (operand_19122) ;
        const GGS_bool cond_19308 = (operand_17584->mIsAbstract).operator_not () ;
        if (cond_19308.isBuiltAndTrue ()) {
          operand_19122->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a concrete class cannot declare an abstract method") COMMA_SOURCE_FILE_AT_LINE (435)) ;
        }
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_19453 (operand_19122->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_19453 = NULL ;
          while (((operand_19453 = enumerator_19453.nextObject ()))) {
            macroValidPointer (operand_19453) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_19453->mFormalParameterPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_19453->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (441)), operand_19453->mFormalParameterName, operand_19453->mIsUnused) ;
          }
        }
        const GGS_bool cond_20172 = operand_19122->mIsOverriding ;
        if (cond_20172.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_19984_0 ;
          const GGS_instanceMethodMap  temp_19917 = var_cas_inheritedInstanceMethodMap ;
          if (temp_19917.isBuilt ()) {
            temp_19917 (HERE)->method_searchInheritedKey (inLexique, operand_19122->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_19984_0 COMMA_SOURCE_FILE_AT_LINE (450)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_19122->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (453)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (451)) ;
        }else if (cond_20172.isBuiltAndFalse ()) {
          const GGS_bool cond_20355 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_19122->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (457))) ;
          if (cond_20355.isBuiltAndTrue ()) {
            operand_19122->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (459)) ;
          }
        }
        var_cas_abstractMethodList.addAssign_operation (operand_19122->mIsOverriding, operand_19122->mMethodName, var_cas_formalParameterListForGeneration) ;
      }
    }
    GGS_methodDefinitionListForGeneration  var_cas_methodList = GGS_methodDefinitionListForGeneration ::constructor_emptyList () ;
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_20571 (operand_17584->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_20571 = NULL ;
      while (((operand_20571 = enumerator_20571.nextObject ()))) {
        macroValidPointer (operand_20571) ;
        GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_20714 (operand_20571->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_20714 = NULL ;
          while (((operand_20714 = enumerator_20714.nextObject ()))) {
            macroValidPointer (operand_20714) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_20714->mFormalParameterPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_20714->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (470)), operand_20714->mFormalParameterName, operand_20714->mIsUnused) ;
          }
        }
        const GGS_bool cond_21433 = operand_20571->mIsOverriding ;
        if (cond_21433.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_21245_0 ;
          const GGS_instanceMethodMap  temp_21178 = var_cas_inheritedInstanceMethodMap ;
          if (temp_21178.isBuilt ()) {
            temp_21178 (HERE)->method_searchInheritedKey (inLexique, operand_20571->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_21245_0 COMMA_SOURCE_FILE_AT_LINE (479)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_20571->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (482)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (480)) ;
        }else if (cond_21433.isBuiltAndFalse ()) {
          const GGS_bool cond_21616 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_20571->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (486))) ;
          if (cond_21616.isBuiltAndTrue ()) {
            operand_20571->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (488)) ;
          }
        }
        var_cas_methodList.addAssign_operation (operand_20571->mIsOverriding, operand_20571->mMethodName, var_cas_formalParameterListForGeneration, GGS_semanticInstructionListForGeneration ::constructor_emptyList ()) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_17584->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (498)), operand_17584->mIsAbstract, operand_17584->mClassTypeName, var_cas_superClassIndex, var_cas_allAttributeList, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList COMMA_SOURCE_FILE_AT_LINE (497))) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_22852 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_22852 = NULL ;
    while (((operand_22852 = enumerator_22852.nextObject ()))) {
      macroValidPointer (operand_22852) ;
      const GGS_semanticDeclarationAST  temp_22905 = operand_22852->mSemanticDeclaration ;
      if (temp_22905.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_22905.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_22905 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (523)) ;
        }
      }
    }
  }
