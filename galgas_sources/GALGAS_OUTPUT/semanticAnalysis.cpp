...
category_method__predefinedTypeAST__performSemanticAnalysis (C_Compiler & inLexique,
  ...
  if (operand_2300 != NULL) {
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_primitiveTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapIndex ::constructor_null (inLexique COMMA_HERE) COMMA_HERE)) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_3219 (var_cas_inSemanticContext.reader_mOrderedSemanticDeclarationListAST (inLexique COMMA_SOURCE_FILE_AT_LINE (59)), true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_3219 = NULL ;
    while (((operand_3219 = enumerator_3219.nextObject ()))) {
      macroValidPointer (operand_3219) ;
      const GGS_semanticDeclarationAST  temp_3325 = operand_3219->mSemanticDeclaration ;
      if (temp_3325.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_3325.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_3325 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (60)) ;
        }
      }
    }
  }
