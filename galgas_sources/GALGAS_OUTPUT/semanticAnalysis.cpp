...
void routine_buildLocalVariableMapAndSignature (const GALGAS_semanticContext constinArgument_inSemanticContext,
  ...
  cEnumerator_formalParameterListAST enumerator_38030 (constinArgument_inRoutineSignatureAST, kEnumeration_up) ;
  while (enumerator_38030.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_38030.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (960)) ;
    GALGAS_string var_formalArgumentCppName ;
    if (enumerator_38030.current_mFormalArgumentPassingMode (HERE).isValid ()) {
      switch (enumerator_38030.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
      case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
        break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
        var_formalArgumentCppName = GALGAS_string ("inArgument_").operator_concat (enumerator_38030.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (964)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (964)) COMMA_SOURCE_FILE_AT_LINE (964)) ;
        const enumGalgasBool test_0 = enumerator_38030.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
          }
        }else if (kBoolFalse == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgument (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (968)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
        var_formalArgumentCppName = GALGAS_string ("outArgument_").operator_concat (enumerator_38030.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (971)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (971)) COMMA_SOURCE_FILE_AT_LINE (971)) ;
        {
        ioArgument_ioVariableMap.modifier_insertOutputFormalArgument (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
        var_formalArgumentCppName = GALGAS_string ("ioArgument_").operator_concat (enumerator_38030.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (974)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)) ;
        const enumGalgasBool test_1 = enumerator_38030.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (976)) ;
          }
        }else if (kBoolFalse == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgument (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
        var_formalArgumentCppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_38030.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (981)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (981)) COMMA_SOURCE_FILE_AT_LINE (981)) ;
        const enumGalgasBool test_2 = enumerator_38030.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
          }
        }else if (kBoolFalse == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgument (enumerator_38030.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (985)) ;
          }
        }
        } break ;
      }
    }
    outArgument_outRoutineSignature.addAssign_operation (enumerator_38030.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_38030.current_mFormalArgumentName (HERE), var_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (988)) ;
...
void routine_analyzeRoutineBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_localConstantList enumerator_40718 (constinArgument_inLocalConstantList, kEnumeration_up) ;
  while (enumerator_40718.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_40718.current_mNoWarningIfUnused (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      var_variableMap.modifier_insertUsedLocalConstant (enumerator_40718.current_mName (HERE), enumerator_40718.current_mType (HERE), enumerator_40718.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      }
    }else if (kBoolFalse == test_0) {
      {
      var_variableMap.modifier_insertLocalConstant (enumerator_40718.current_mName (HERE), enumerator_40718.current_mType (HERE), enumerator_40718.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1012)) ;
      }
    }
    enumerator_40718.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_41092 (constinArgument_inNonMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_41092.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_41092.current_mAttributeName (HERE), enumerator_41092.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1020)).operator_concat (enumerator_41092.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1020)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1020)) COMMA_SOURCE_FILE_AT_LINE (1020)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1017)) ;
    }
    enumerator_41092.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_41440 (constinArgument_inMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_41440.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertMutableAttribute (enumerator_41440.current_mAttributeName (HERE), enumerator_41440.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1029)).operator_concat (enumerator_41440.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1029)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1029)) COMMA_SOURCE_FILE_AT_LINE (1029)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    }
  ...
  cEnumerator_semanticInstructionListAST enumerator_42043 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_42043.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_42043.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
...
void routine_analyzeFunctionBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_typedAttributeList enumerator_49484 (constinArgument_inTypedAttributeList, kEnumeration_up) ;
  while (enumerator_49484.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_49484.current_mAttributeName (HERE), enumerator_49484.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (enumerator_49484.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1264)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) ;
    }
  ...
  cEnumerator_formalInputParameterListAST enumerator_49898 (constinArgument_inFunctionSignature, kEnumeration_up) ;
  while (enumerator_49898.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_49898.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1271)) ;
    const enumGalgasBool test_0 = enumerator_49898.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_cppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_49898.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1273)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1273)) COMMA_SOURCE_FILE_AT_LINE (1273)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (var_parameterType, var_cppName, enumerator_49898.current_mFormalArgumentName (HERE), enumerator_49898.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1274)) ;
      const enumGalgasBool test_1 = enumerator_49898.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        var_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_49898.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        }
      }else if (kBoolFalse == test_1) {
        {
        var_variableMap.modifier_insertConstantInputFormalArgument (enumerator_49898.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1283)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_cppName = GALGAS_string ("inArgument_").operator_concat (enumerator_49898.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1286)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (var_parameterType, var_cppName, enumerator_49898.current_mFormalArgumentName (HERE), enumerator_49898.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1287)) ;
      const enumGalgasBool test_2 = enumerator_49898.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        var_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_49898.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1294)) ;
        }
      }else if (kBoolFalse == test_2) {
        {
        var_variableMap.modifier_insertInputFormalArgument (enumerator_49898.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1296)) ;
        }
      }
    }
    enumerator_49898.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticInstructionListAST enumerator_51681 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_51681.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_51681.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1307)) ;
...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  cEnumerator_lstringlist enumerator_88745 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (2246)), kEnumeration_up) ;
  while (enumerator_88745.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_88745.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_88745.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)).operator_concat (GALGAS_string ("' type is undefined") COMMA_SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)) ;
    enumerator_88745.gotoNextObject () ;
  }
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = constinArgument_inDeclarationList ;
  cEnumerator_semanticDeclarationListAST enumerator_88999 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_88999.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_88999.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2252)) ;
    enumerator_88999.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_semanticDeclarationListAST enumerator_89369 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_89369.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_89369.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (2259)) ;
      enumerator_89369.gotoNextObject () ;
    }
  }
}
...
static void categoryMethod_uniqueMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (652)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (652)).isValid ()) {
    ...
    while (loop_25781) {
      ...
      if (loop_25781) {
        ...
        cEnumerator_mapStateList enumerator_25877 (object->mAttribute_mMapStateList, kEnumeration_up) ;
        while (enumerator_25877.hasCurrentObject ()) {
          const enumGalgasBool test_15 = var_accessibleStates.reader_hasKey (enumerator_25877.current_mStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (655)) COMMA_SOURCE_FILE_AT_LINE (655)).boolEnum () ;
          if (kBoolTrue == test_15) {
            cEnumerator_mapStateTransitionList enumerator_25973 (enumerator_25877.current_mTransitionList (HERE), kEnumeration_up) ;
            while (enumerator_25973.hasCurrentObject ()) {
              const enumGalgasBool test_16 = var_accessibleStates.reader_hasKey (enumerator_25973.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)).operator_not (SOURCE_FILE_AT_LINE (657)).boolEnum () ;
              if (kBoolTrue == test_16) {
                var_accessibleStates.addAssign_operation (enumerator_25973.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (658)) ;
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_26407 (var_uselessStates, kEnumeration_up) ;
    while (enumerator_26407.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_26407.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (669)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)) ;
      if (enumerator_26407.hasNextObject ()) {
  ...
  cEnumerator_mapAutomatonStateMap enumerator_26771 (var_mapAutomatonStateMap, kEnumeration_up) ;
  while (enumerator_26771.hasCurrentObject ()) {
    GALGAS_stringset var_reachableStates = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (679)) ;
    var_reachableStates.addAssign_operation (enumerator_26771.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
    GALGAS_bool var_progress = GALGAS_bool (true) ;
    if (var_mapAutomatonStateMap.reader_count (SOURCE_FILE_AT_LINE (682)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (682)).isValid ()) {
      PMUInt32 variant_26895 = var_mapAutomatonStateMap.reader_count (SOURCE_FILE_AT_LINE (682)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (682)).uintValue () ;
      bool loop_26895 = true ;
      while (loop_26895) {
        loop_26895 = var_progress.isValid () ;
        if (loop_26895) {
          loop_26895 = var_progress.boolValue () ;
        }
        if (loop_26895 && (0 == variant_26895)) {
          loop_26895 = false ;
        ...
        if (loop_26895) {
          variant_26895 -- ;
          var_progress = GALGAS_bool (false) ;
          cEnumerator_mapStateList enumerator_27001 (object->mAttribute_mMapStateList, kEnumeration_up) ;
          while (enumerator_27001.hasCurrentObject ()) {
            const enumGalgasBool test_18 = var_reachableStates.reader_hasKey (enumerator_27001.current_mStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)).boolEnum () ;
            if (kBoolTrue == test_18) {
              cEnumerator_mapStateTransitionList enumerator_27100 (enumerator_27001.current_mTransitionList (HERE), kEnumeration_up) ;
              while (enumerator_27100.hasCurrentObject ()) {
                const enumGalgasBool test_19 = var_reachableStates.reader_hasKey (enumerator_27100.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)).operator_not (SOURCE_FILE_AT_LINE (687)).boolEnum () ;
                if (kBoolTrue == test_19) {
                  var_reachableStates.addAssign_operation (enumerator_27100.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)) ;
                  var_accessibilityGraph.addAssign_operation (enumerator_26771.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (689)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (689)).operator_concat (enumerator_27100.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (689)) COMMA_SOURCE_FILE_AT_LINE (689)) COMMA_SOURCE_FILE_AT_LINE (689)) ;
                  var_progress = GALGAS_bool (true) ;
                }
                enumerator_27100.gotoNextObject () ;
              }
            }
            enumerator_27001.gotoNextObject () ;
          }
        }
      }
    }
    cEnumerator_stringset enumerator_27486 (var_reachableStates, kEnumeration_up) ;
    while (enumerator_27486.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_26771.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (697)).objectCompare (enumerator_27486.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_20) {
        var_neededAssociations.addAssign_operation (enumerator_26771.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (698)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (698)).operator_concat (enumerator_27486.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (698)) COMMA_SOURCE_FILE_AT_LINE (698)) ;
      }
      enumerator_27486.gotoNextObject () ;
    }
    enumerator_26771.gotoNextObject () ;
  }
  GALGAS_mapOverrideList var_mapOverrideList = GALGAS_mapOverrideList::constructor_emptyList (SOURCE_FILE_AT_LINE (703)) ;
  cEnumerator_mapOverrideBlockListAST enumerator_27721 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
  while (enumerator_27721.hasCurrentObject ()) {
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_27969 (enumerator_27721.current_mMapOverrideBlockDescriptor_31_AST (HERE), kEnumeration_up) ;
    while (enumerator_27969.hasCurrentObject ()) {
      GALGAS_uint var_startStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_27969.current_mLeftState (HERE), var_startStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
      GALGAS_uint var_currentStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_27969.current_mRightState (HERE), var_currentStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
      GALGAS_string var_association = enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (713)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (713)).operator_concat (enumerator_27969.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
      ...
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_27969.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_23) {
        GALGAS_location location_24 (enumerator_27969.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_27969.current_mResultingState (HERE), var_finalStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
      const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (724)).objectCompare (enumerator_27969.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (724)))).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_neededCombinaisons.addAssign_operation (enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (enumerator_27969.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) ;
        var_neededCombinaisons.addAssign_operation (enumerator_27969.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (726)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (726)).operator_concat (enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)) ;
        const enumGalgasBool test_26 = var_accessibilityGraph.reader_hasKey (enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (727)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (727)).operator_concat (enumerator_27969.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)).operator_not (SOURCE_FILE_AT_LINE (727)).boolEnum () ;
        if (kBoolTrue == test_26) {
          GALGAS_location location_27 (enumerator_27969.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_27969.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (GALGAS_string ("' state is not reachable from '") COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (GALGAS_string ("' state") COMMA_SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (728)) ;
        }
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_27969.current_mTransitionMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (733)) ;
      }
      var_branchBehaviourSortedListForMapOverride_31_.addAssign_operation (var_startStateNameIndex, enumerator_27969.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (736)), var_currentStateNameIndex, enumerator_27969.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (738)), var_finalStateNameIndex, enumerator_27969.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (740)), enumerator_27969.current_mMessageKind (HERE), enumerator_27969.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (734)) ;
      enumerator_27969.gotoNextObject () ;
    }
    ...
    if (kBoolTrue == test_28) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_29825 (var_forgottenAssociations, kEnumeration_up) ;
      while (enumerator_29825.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_29825.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (749)) COMMA_SOURCE_FILE_AT_LINE (749)) ;
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_30189 (enumerator_27721.current_mMapOverrideBlockDescriptor_32_AST (HERE), kEnumeration_up) ;
    while (enumerator_30189.hasCurrentObject ()) {
      GALGAS_uint var_leftStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_30189.current_mLeftState (HERE), var_leftStateIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (757)) ;
      GALGAS_uint var_rightStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_30189.current_mRightState (HERE), var_rightStateIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (759)) ;
      GALGAS_string var_combinaison = enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (760)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (760)).operator_concat (enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (760)) COMMA_SOURCE_FILE_AT_LINE (760)) ;
      ...
      if (kBoolTrue == test_29) {
        GALGAS_location location_30 (enumerator_30189.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_30, GALGAS_string ("the '").operator_concat (enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (GALGAS_string ("' combinaison is useless") COMMA_SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (762)) ;
      }
      ...
      if (kBoolTrue == test_31) {
        GALGAS_location location_32 (enumerator_30189.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_32, GALGAS_string ("the '").operator_concat (enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string ("' combinaison is already defined") COMMA_SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (766)) ;
      }
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_30189.current_mResultingState (HERE), var_resultingStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (771)) ;
      const enumGalgasBool test_33 = GALGAS_bool (kIsNotEqual, enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (772)).objectCompare (enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (772)))).operator_and (GALGAS_bool (kIsNotEqual, enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (773)).objectCompare (enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (773)))) COMMA_SOURCE_FILE_AT_LINE (773)).operator_and (var_accessibilityGraph.reader_hasKey (enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (774)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).operator_not (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).boolEnum () ;
      if (kBoolTrue == test_33) {
        GALGAS_location location_34 (enumerator_30189.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_34, GALGAS_string ("the '").operator_concat (enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (GALGAS_string ("' state cannot be reached from the '") COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (GALGAS_string ("' state") COMMA_SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (775)) ;
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_30189.current_mTransitionMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (778)) ;
      }
      const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_30189.current_mMessageKind (HERE).objectCompare (GALGAS_mapAutomatonMessageKind::constructor_noMessage (SOURCE_FILE_AT_LINE (779)))).boolEnum () ;
      if (kBoolTrue == test_35) {
        var_definedCombinaisons.addAssign_operation (enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (780)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (780)).operator_concat (enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)) ;
        var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_rightStateIndex, enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (783)), var_leftStateIndex, enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (785)), var_resultingStateNameIndex, enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (787)), enumerator_30189.current_mMessageKind (HERE), enumerator_30189.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (789)) COMMA_SOURCE_FILE_AT_LINE (781)) ;
      }
      var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_leftStateIndex, enumerator_30189.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (794)), var_rightStateIndex, enumerator_30189.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (796)), var_resultingStateNameIndex, enumerator_30189.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (798)), enumerator_30189.current_mMessageKind (HERE), enumerator_30189.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (792)) ;
    ...
    if (kBoolTrue == test_36) {
      ...
      if (kBoolTrue == test_37) {
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_32510 (var_forgottenCombinaisons, kEnumeration_up) ;
        while (enumerator_32510.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_32510.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)) ;
    ...
    var_mapOverrideList.addAssign_operation (enumerator_27721.current_mOverrideBlockName (HERE).reader_string (SOURCE_FILE_AT_LINE (814)), var_branchBehaviourSortedListForMapOverride_31_, var_branchBehaviourSortedListForMapOverride_32_ COMMA_SOURCE_FILE_AT_LINE (813)) ;
    enumerator_27721.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_33021 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_33021.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_33021.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (823)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_33021.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (826)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_33021.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) ;
    }
    enumerator_33021.gotoNextObject () ;
  }
  GALGAS_insertMethodMap var_insertMethodMap = GALGAS_insertMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (835)) ;
  cEnumerator_insertMethodListAST enumerator_33443 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_33443.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_33443.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (837)) ;
    }
    cEnumerator_stringlist enumerator_33636 (enumerator_33443.current_mErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (839)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (839)), kEnumeration_up) ;
    while (enumerator_33636.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_33636.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (840)) ;
      {
      GALGAS_string joker_33750_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_33750_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (841)) ;
      }
      cEnumerator_stringlist enumerator_33784 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_33784.hasCurrentObject ()) {
        const enumGalgasBool test_38 = GALGAS_bool (kIsStrictSup, enumerator_33784.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (843)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_38) {
          GALGAS_char var_c = enumerator_33784.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (844)) ;
          ...
          if (kBoolTrue == test_39) {
            GALGAS_location location_40 (enumerator_33443.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_33636.gotoNextObject () ;
    }
    cEnumerator_stringlist enumerator_34263 (enumerator_33443.current_mShadowErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (852)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (852)), kEnumeration_up) ;
    while (enumerator_34263.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_34263.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (853)) ;
      {
      GALGAS_string joker_34377_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_34377_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) ;
      }
      cEnumerator_stringlist enumerator_34411 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_34411.hasCurrentObject ()) {
        const enumGalgasBool test_41 = GALGAS_bool (kIsStrictSup, enumerator_34411.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (856)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_41) {
          GALGAS_char var_c = enumerator_34411.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (857)) ;
          ...
          if (kBoolTrue == test_42) {
            GALGAS_location location_43 (enumerator_33443.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_34263.gotoNextObject () ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_34859 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_34859.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_34859.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
      }
    }else if (kBoolFalse == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_34859.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      }
    }
    cEnumerator_stringlist enumerator_35173 (enumerator_34859.current_mErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (874)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (874)), kEnumeration_up) ;
    while (enumerator_35173.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_35173.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (875)) ;
      {
      GALGAS_string joker_35287_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_35287_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (876)) ;
      }
      cEnumerator_stringlist enumerator_35321 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_35321.hasCurrentObject ()) {
        const enumGalgasBool test_45 = GALGAS_bool (kIsStrictSup, enumerator_35321.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (878)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_45) {
          GALGAS_char var_c = enumerator_35321.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
          const enumGalgasBool test_46 = GALGAS_bool (kIsNotEqual, var_c.objectCompare (GALGAS_char (TO_UNICODE (75)))).boolEnum () ;
          if (kBoolTrue == test_46) {
            GALGAS_location location_47 (enumerator_34859.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_35173.gotoNextObject () ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_35848 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_35848.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_35848.current_mSearchMethodName (HERE), constinArgument_inPredefinedTypes.mAttribute_mLStringType, inCompiler COMMA_SOURCE_FILE_AT_LINE (891)) ;
    }
    enumerator_35848.gotoNextObject () ;
  }
...
static void categoryMethod_mapProxyDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_36924_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_36924_4 ; // Joker input parameter
  GALGAS_typeKindEnum joker_36924_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_36924_2 ; // Joker input parameter
  GALGAS_attributeMap joker_36924_1 ; // Joker input parameter
  GALGAS_constructorMap joker_36960_11 ; // Joker input parameter
  GALGAS_readerMap joker_36960_10 ; // Joker input parameter
  GALGAS_modifierMap joker_36960_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_36960_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_36960_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_36960_6 ; // Joker input parameter
  GALGAS_stringlist joker_36960_5 ; // Joker input parameter
  GALGAS_uint joker_36960_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_36960_3 ; // Joker input parameter
  GALGAS_stringset joker_36960_2 ; // Joker input parameter
  GALGAS_lstringlist joker_36960_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_36990_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_36990_4 ; // Joker input parameter
  GALGAS_bool joker_36990_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_36990_2 ; // Joker input parameter
  GALGAS_string joker_36990_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_36924_5, joker_36924_4, joker_36924_3, joker_36924_2, joker_36924_1, var_listTypeAttributeList, joker_36960_11, joker_36960_10, joker_36960_9, joker_36960_8, joker_36960_7, joker_36960_6, joker_36960_5, joker_36960_4, joker_36960_3, joker_36960_2, joker_36960_1, var_searchMethodList, joker_36990_5, joker_36990_4, joker_36990_3, joker_36990_2, joker_36990_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (924)) ;
...
static void categoryMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_42711 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_42711.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_42711.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)), enumerator_42711.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1064)), enumerator_42711.current_mFormalArgumentName (HERE), enumerator_42711.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
    enumerator_42711.gotoNextObject () ;
  }
...
static void categoryMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_43624 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_43624.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_43624.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_43624.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1090)), enumerator_43624.current_mFormalArgumentName (HERE), enumerator_43624.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1088)) ;
    enumerator_43624.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      cEnumerator_lstringlist enumerator_46153 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_46153.hasCurrentObject ()) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_46153.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1164)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = var_generatedInSeparateFileFeature.boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (enumerator_46153.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_5 (enumerator_46153.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_lstringlist enumerator_46814 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_46814.hasCurrentObject ()) {
        GALGAS_location location_7 (enumerator_46814.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_46814.gotoNextObject () ;
      }
    }
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_47097 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_47097.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_47097.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_47282 (enumerator_47097.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_47282.hasCurrentObject ()) {
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_47282.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1191)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        const enumGalgasBool test_9 = var_hasSetter.boolEnum () ;
        if (kBoolTrue == test_9) {
          GALGAS_location location_10 (enumerator_47282.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_47282.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_hasGetter.operator_not (SOURCE_FILE_AT_LINE (1197)).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_47282.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_14 (enumerator_47282.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_47282.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_t, enumerator_47097.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1205)) ;
    var_allAttributeList.addAssign_operation (var_t, enumerator_47097.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_47097.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) ;
    }
    enumerator_47097.gotoNextObject () ;
  }
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1222)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)).isValid ()) {
    PMUInt32 variant_48198 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1222)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)).uintValue () ;
    bool loop_48198 = true ;
    while (loop_48198) {
      loop_48198 = var_t.reader_isNull (SOURCE_FILE_AT_LINE (1223)).operator_not (SOURCE_FILE_AT_LINE (1223)).isValid () ;
      if (loop_48198) {
        loop_48198 = var_t.reader_isNull (SOURCE_FILE_AT_LINE (1223)).operator_not (SOURCE_FILE_AT_LINE (1223)).boolValue () ;
      }
      if (loop_48198 && (0 == variant_48198)) {
        loop_48198 = false ;
...
static void categoryMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_formalInputParameterListForGeneration joker_54179_0 ; // Joker input parameter
  routine_analyzeFunctionBody (var_analysisContext, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1383)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1384)), GALGAS_string::makeEmptyString (), object->mAttribute_mFunctionInstructionList, object->mAttribute_mResultVariableName, object->mAttribute_mResultTypeName, object->mAttribute_mEndOfFunctionInstructionList, joker_54179_0, var_returnType, var_resultVariableCppName, var_semanticInstructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1381)) ;
  }
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring joker_55322_0 ; // Joker input parameter
  GALGAS_lstringlist joker_55329_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_55381_0 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_55322_0, joker_55329_0, var_wrapperFileMap, var_wrapperDirectoryMap, joker_55381_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1421)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_filewrapperTemplateListAST enumerator_56041 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
    while (enumerator_56041.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_56041.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE_AT_LINE (1442)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1442)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_56041.current_mFilewrapperTemplatePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_string var_absoluteTemplatePath = var_absoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1445)).operator_concat (enumerator_56041.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE_AT_LINE (1445)) COMMA_SOURCE_FILE_AT_LINE (1445)) ;
      GALGAS_templateInstructionListAST var_resultingInstructionList ;
      {
      cGrammar_templateGrammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absoluteTemplatePath, enumerator_56041.current_mFilewrapperTemplatePath (HERE).reader_location (SOURCE_FILE_AT_LINE (1448)) COMMA_SOURCE_FILE_AT_LINE (1448)), var_resultingInstructionList COMMA_SOURCE_FILE_AT_LINE (1448)) ;
      }
      ...
      cEnumerator_formalTemplateInputParameterListAST enumerator_56854 (enumerator_56041.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
      while (enumerator_56854.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_56854.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1453)) ;
        GALGAS_string var_cppVarName = GALGAS_string ("in_").operator_concat (enumerator_56854.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1454)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1454)) COMMA_SOURCE_FILE_AT_LINE (1454)) ;
        {
        var_templateVariableMap.modifier_insertKey (enumerator_56854.current_mFormalArgumentName (HERE), var_type, var_cppVarName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1455)) ;
        }
        var_filewrapperTemplateFormalInputParameters.addAssign_operation (var_type, var_cppVarName, enumerator_56854.current_mFormalArgumentName (HERE), GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1456)) ;
        enumerator_56854.gotoNextObject () ;
      }
      ...
      var_filewrapperTemplateListForGeneration.addAssign_operation (enumerator_56041.current_mFilewrapperTemplateName (HERE).reader_string (SOURCE_FILE_AT_LINE (1468)), var_filewrapperTemplateFormalInputParameters, var_templateInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1467)) ;
      enumerator_56041.gotoNextObject () ;
    }
...
static void categoryMethod_abstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_59287 (object->mAttribute_mAbstractCategoryMethodFormalParameterList, kEnumeration_up) ;
  while (enumerator_59287.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_59287.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_59287.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1507)), enumerator_59287.current_mFormalArgumentName (HERE), enumerator_59287.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1509)) COMMA_SOURCE_FILE_AT_LINE (1505)) ;
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1599)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1599)).isValid ()) {
    PMUInt32 variant_62689 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1599)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1599)).uintValue () ;
    bool loop_62689 = true ;
    while (loop_62689) {
      loop_62689 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1600)).operator_not (SOURCE_FILE_AT_LINE (1600)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1600)).isValid () ;
      if (loop_62689) {
        loop_62689 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1600)).operator_not (SOURCE_FILE_AT_LINE (1600)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1600)).boolValue () ;
      }
      if (loop_62689 && (0 == variant_62689)) {
        loop_62689 = false ;
      ...
      if (loop_62689) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_62995_0 ; // Joker input parameter
          GALGAS_bool joker_63048_0 ; // Joker input parameter
          GALGAS_string joker_63062_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1603)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_62995_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_63048_0, var_qualifier, joker_63062_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1603)) ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1678)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)).isValid ()) {
    PMUInt32 variant_65852 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1678)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)).uintValue () ;
    bool loop_65852 = true ;
    while (loop_65852) {
      loop_65852 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1679)).operator_not (SOURCE_FILE_AT_LINE (1679)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1679)).isValid () ;
      if (loop_65852) {
        loop_65852 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1679)).operator_not (SOURCE_FILE_AT_LINE (1679)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1679)).boolValue () ;
      }
      if (loop_65852 && (0 == variant_65852)) {
        loop_65852 = false ;
      ...
      if (loop_65852) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_66158_0 ; // Joker input parameter
          GALGAS_bool joker_66211_0 ; // Joker input parameter
          GALGAS_string joker_66225_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_66158_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_66211_0, var_qualifier, joker_66225_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_68148 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_68148.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_68148.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_68148.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1732)), enumerator_68148.current_mFormalArgumentName (HERE), enumerator_68148.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1730)) ;
    enumerator_68148.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1824)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).isValid ()) {
    PMUInt32 variant_71553 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1824)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).uintValue () ;
    bool loop_71553 = true ;
    while (loop_71553) {
      loop_71553 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1825)).operator_not (SOURCE_FILE_AT_LINE (1825)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1825)).isValid () ;
      if (loop_71553) {
        loop_71553 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1825)).operator_not (SOURCE_FILE_AT_LINE (1825)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1825)).boolValue () ;
      }
      if (loop_71553 && (0 == variant_71553)) {
        loop_71553 = false ;
      ...
      if (loop_71553) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_71851_0 ; // Joker input parameter
          GALGAS_bool joker_71874_0 ; // Joker input parameter
          GALGAS_string joker_71888_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_71851_0, var_inheritedSignature, joker_71874_0, var_qualifier, joker_71888_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1903)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)).isValid ()) {
    PMUInt32 variant_74685 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1903)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)).uintValue () ;
    bool loop_74685 = true ;
    while (loop_74685) {
      loop_74685 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1904)).operator_not (SOURCE_FILE_AT_LINE (1904)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1904)).isValid () ;
      if (loop_74685) {
        loop_74685 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1904)).operator_not (SOURCE_FILE_AT_LINE (1904)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1904)).boolValue () ;
      }
      if (loop_74685 && (0 == variant_74685)) {
        loop_74685 = false ;
      ...
      if (loop_74685) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_74983_0 ; // Joker input parameter
          GALGAS_bool joker_75006_0 ; // Joker input parameter
          GALGAS_string joker_75020_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1907)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_74983_0, var_inheritedSignature, joker_75006_0, var_qualifier, joker_75020_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1907)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_76947 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_76947.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_76947.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)), enumerator_76947.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1957)), enumerator_76947.current_mFormalArgumentName (HERE), enumerator_76947.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1955)) ;
    enumerator_76947.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2059)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)).isValid ()) {
    PMUInt32 variant_80655 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2059)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)).uintValue () ;
    bool loop_80655 = true ;
    while (loop_80655) {
      loop_80655 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2060)).operator_not (SOURCE_FILE_AT_LINE (2060)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2060)).isValid () ;
      if (loop_80655) {
        loop_80655 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2060)).operator_not (SOURCE_FILE_AT_LINE (2060)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2060)).boolValue () ;
      }
      if (loop_80655 && (0 == variant_80655)) {
        loop_80655 = false ;
      ...
      if (loop_80655) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_80961_0 ; // Joker input parameter
          GALGAS_bool joker_81038_0 ; // Joker input parameter
          GALGAS_string joker_81097_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2063)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_80961_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_81038_0, var_inheritedReturnType, var_qualifier, joker_81097_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2063)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2158)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)).isValid ()) {
    PMUInt32 variant_84329 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2158)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)).uintValue () ;
    bool loop_84329 = true ;
    while (loop_84329) {
      loop_84329 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2159)).operator_not (SOURCE_FILE_AT_LINE (2159)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2159)).isValid () ;
      if (loop_84329) {
        loop_84329 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2159)).operator_not (SOURCE_FILE_AT_LINE (2159)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2159)).boolValue () ;
      }
      if (loop_84329 && (0 == variant_84329)) {
        loop_84329 = false ;
      ...
      if (loop_84329) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_84631_0 ; // Joker input parameter
          GALGAS_bool joker_84708_0 ; // Joker input parameter
          GALGAS_string joker_84767_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_84631_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_84708_0, var_inheritedReturnType, var_qualifier, joker_84767_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_formalInputParameterListAST enumerator_85291 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_85291.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_85291.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2186)), enumerator_85291.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (2187)), enumerator_85291.current_mFormalArgumentName (HERE), enumerator_85291.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (2185)) ;
      enumerator_85291.gotoNextObject () ;
    }
    {
