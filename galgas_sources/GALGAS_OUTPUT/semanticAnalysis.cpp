...
void routine_check_5F_K_5F_escapeCharacters (GALGAS_lstring inArgument_inString,
  ...
  while (enumerator_20007.hasCurrentObject ()) {
    ...
    {
    GALGAS_string joker_20119_0 ; // Joker input parameter
    var_explodedArray.modifier_popFirst (joker_20119_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 481)) ;
    }
...
void routine_check_5F_K_5F_L_5F_escapeCharacters (GALGAS_lstring inArgument_inString,
  ...
  while (enumerator_20696.hasCurrentObject ()) {
    ...
    {
    GALGAS_string joker_20808_0 ; // Joker input parameter
    var_explodedArray.modifier_popFirst (joker_20808_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 501)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3714)) ;
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3716)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_151353 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_151353.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_151353.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)) ;
    enumerator_151353.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3733)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 4324)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4325)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4332)) ;
  cEnumerator_formalParameterListForGeneration enumerator_173771 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_173771.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_173771.current_mFormalSelector (HERE), enumerator_173771.current_mFormalArgumentType (HERE), enumerator_173771.current_mFormalArgumentPassingMode (HERE), enumerator_173771.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4334)) ;
    enumerator_173771.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4337)) ;
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4338)) ;
  cEnumerator_syntaxInstructionList enumerator_174126 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_174126.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_174126.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4340)) ;
    enumerator_174126.gotoNextObject () ;
  }
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4354)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 4377)) ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4378)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_175655 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_175655.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 4385)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_175739 (enumerator_175655.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_175739.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4387)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4388)) ;
      cEnumerator_formalParameterListAST enumerator_175906 (enumerator_175739.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_175906.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_175906.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4390)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_175906.current_mFormalSelector (HERE), enumerator_175906.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_175906.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_175906.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4391))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4391))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4391)) ;
        var_signature.addAssign_operation (enumerator_175906.current_mFormalSelector (HERE), var_type, enumerator_175906.current_mFormalArgumentPassingMode (HERE), enumerator_175906.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4392)) ;
        enumerator_175906.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_175739.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_175739.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4394)) ;
      }
      enumerator_175739.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_175655.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4396)) ;
    }
    enumerator_175655.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4402)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4404))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4399)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4408)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_176892 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_176892.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 4411)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_177076_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176892.current_mNonterminalName (HERE), joker_177076_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4413)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_177103 (enumerator_176892.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_177103.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_177103.current_mFormalArguments (HERE), enumerator_177103.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 4425)), var_nonterminalMap, constinArgument_inComponentName, enumerator_177103.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4419)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_177103.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_177103.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4435)) ;
      enumerator_177103.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_178101_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176892.current_mNonterminalName (HERE), joker_178101_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4444)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_176892.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4446)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4445)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4450)) ;
    enumerator_176892.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4453)) ;
}
...
static void categoryMethod_listmapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_18411_0 ; // Joker input parameter
  ...
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_18370_3, joker_18370_2, joker_18370_1, var_typeKindEnum, joker_18411_0, var_listTypeAttributeList, joker_18466_20, joker_18466_19, joker_18466_18, joker_18466_17, joker_18466_16, joker_18466_15, joker_18466_14, joker_18466_13, joker_18466_12, joker_18466_11, joker_18466_10, joker_18466_9, joker_18466_8, joker_18466_7, joker_18466_6, joker_18466_5, joker_18466_4, joker_18466_3, joker_18466_2, joker_18466_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 432)) ;
...
static void categoryMethod_uniqueMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_26886.hasCurrentObject ()) {
    ...
    while (enumerator_26917.hasCurrentObject ()) {
      GALGAS_uint joker_26978_0 ; // Joker input parameter
      var_mapAutomatonStateMap.method_searchKey (enumerator_26917.current_mTargetStateName (HERE), joker_26978_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 654)) ;
  ...
  while (enumerator_36483.hasCurrentObject ()) {
    ...
    while (enumerator_36676.hasCurrentObject ()) {
      ...
      {
      GALGAS_string joker_36792_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_36792_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 892)) ;
      }
    ...
    while (enumerator_37303.hasCurrentObject ()) {
      ...
      {
      GALGAS_string joker_37419_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_37419_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 905)) ;
      }
  ...
  while (enumerator_37899.hasCurrentObject ()) {
    ...
    while (enumerator_38213.hasCurrentObject ()) {
      ...
      {
      GALGAS_string joker_38329_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_38329_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 927)) ;
      }
...
static void categoryMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_formalInputParameterListForGeneration joker_58180_0 ; // Joker input parameter
  routine_analyzeFunctionBody (var_analysisContext, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 1459)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 1460)), GALGAS_string::makeEmptyString (), object->mAttribute_mFunctionInstructionList, object->mAttribute_mResultVariableName, object->mAttribute_mResultTypeName, object->mAttribute_mEndOfFunctionInstructionList, joker_58180_0, var_returnType, var_resultVariableCppName, var_semanticInstructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1457)) ;
  }
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring joker_59390_0 ; // Joker input parameter
  GALGAS_lstringlist joker_59397_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_59488_2 ; // Joker input parameter
  GALGAS_bool joker_59488_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_59390_0, joker_59397_0, var_wrapperFileMap, var_wrapperDirectoryMap, joker_59488_2, joker_59488_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1499)) ;
    ...
    while (loop_68893) {
      ...
      if (loop_68893) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_69202_0 ; // Joker input parameter
          GALGAS_bool joker_69255_0 ; // Joker input parameter
          GALGAS_string joker_69269_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_69202_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_69255_0, var_qualifier, joker_69269_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1814)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1814)).isValid ()) {
    ...
    while (loop_72466) {
      ...
      if (loop_72466) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_72775_0 ; // Joker input parameter
          GALGAS_bool joker_72828_0 ; // Joker input parameter
          GALGAS_string joker_72842_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1818)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_72775_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_72828_0, var_qualifier, joker_72842_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1818)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1970)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1970)).isValid ()) {
    ...
    while (loop_78636) {
      ...
      if (loop_78636) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_78937_0 ; // Joker input parameter
          GALGAS_bool joker_78960_0 ; // Joker input parameter
          GALGAS_string joker_78974_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1974)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_78937_0, var_inheritedSignature, joker_78960_0, var_qualifier, joker_78974_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1974)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2053)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2053)).isValid ()) {
    ...
    while (loop_81996) {
      ...
      if (loop_81996) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_82297_0 ; // Joker input parameter
          GALGAS_bool joker_82320_0 ; // Joker input parameter
          GALGAS_string joker_82334_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2057)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_82297_0, var_inheritedSignature, joker_82320_0, var_qualifier, joker_82334_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2057)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2222)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2222)).isValid ()) {
    ...
    while (loop_88668) {
      ...
      if (loop_88668) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_88942_0 ; // Joker input parameter
          GALGAS_bool joker_89019_0 ; // Joker input parameter
          GALGAS_string joker_89096_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2225)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_88942_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_89019_0, var_inheritedReturnType, var_qualifier, joker_89096_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2225)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2323)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2323)).isValid ()) {
    ...
    while (loop_92611) {
      ...
      if (loop_92611) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_92916_0 ; // Joker input parameter
          GALGAS_bool joker_92993_0 ; // Joker input parameter
          GALGAS_string joker_93052_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2327)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_92916_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_92993_0, var_inheritedReturnType, var_qualifier, joker_93052_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2327)) ;
...
static void categoryMethod_galgas_33_GrammarComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_terminalMap joker_98982_0 ; // Joker input parameter
  GALGAS_indexingListAST joker_99018_0 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (var_lexiqueComponentName, joker_98982_0, joker_99018_0, var_inIndexingDirectory, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2486)) ;
  ...
  while (enumerator_100239.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_100347_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_100239.current_mValue (HERE), var_nonterminalIndex, joker_100347_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2514)) ;
    {
...
static void categoryMethod_lexiqueComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_107584.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_lstring joker_107726_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2685)).method_searchKey (enumerator_107584.current_mStyle (HERE), joker_107726_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2685)) ;
    }
  ...
  while (enumerator_109127.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      GALGAS_lstring joker_109269_0 ; // Joker input parameter
      var_lexiqueAnalysisContext.reader_mStyleMap (SOURCE_FILE ("semanticAnalysis.gSemantics", 2723)).method_searchKey (enumerator_109127.current_mStyle (HERE), joker_109269_0, var_terminalStyleIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2723)) ;
    }
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_129415_0 ; // Joker input parameter
    GALGAS_location joker_129429_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_129415_0, var_signature, joker_129429_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3192)) ;
  }
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_130121 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_130121.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_130121.current_mType (HERE), enumerator_130121.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3214))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3214)) ;
    enumerator_130121.gotoNextObject () ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_stringlist enumerator_131830 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_131830.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_131830.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3260))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3260)) ;
    enumerator_131830.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_132387 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_132387.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_132387.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3275))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3275)) ;
    enumerator_132387.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_133866_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_133866_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3313)) ;
  }
...
static void categoryMethod_inputParameterDeclaredVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3359)) ;
...
static void categoryMethod_inputParameterDeclaredConstant_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualParameterTypeName.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3399)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type ;
  {
  GALGAS_string joker_140439_0 ; // Joker input parameter
  GALGAS_string joker_140442_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_140439_0, joker_140442_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3457)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3478)) ;
  {
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3500)) ;
  {
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_147060 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_147079 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_147060.hasCurrentObject () && enumerator_147079.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_147060.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_147079.current_mLexicalType (HERE), enumerator_147079.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3608)) ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_147079.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_147060.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string temp_7 ;
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_147079.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_8) {
        temp_7 = GALGAS_string (":") ;
      }else if (kBoolFalse == test_8) {
        temp_7 = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_location location_9 (enumerator_147060.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the actual selector should be '\?").operator_concat (enumerator_147079.current_mLexicalFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3616))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3616)).operator_concat (temp_7.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3616))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3616))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3616)) ;
      GALGAS_location location_10 (enumerator_147079.current_mLexicalFormalSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_147060.gotoNextObject () ;
    enumerator_147079.gotoNextObject () ;
  }
  cEnumerator__32_lstringlist enumerator_147638 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_147638.hasCurrentObject ()) {
    const enumGalgasBool test_11 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_147638.current_mValue_30_ (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_147748 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_147748.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_147748.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3625))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3625)) ;
        enumerator_147748.gotoNextObject () ;
      }
      GALGAS_location location_12 (enumerator_147638.current_mValue_30_ (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_147638.current_mValue_30_ (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627)) ;
    }
    enumerator_147638.gotoNextObject () ;
  }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_149083 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_149083.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_149083.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_149083.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3665))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3665)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3665))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3665)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_149083.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (enumerator_149083.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)) ;
    enumerator_149083.gotoNextObject () ;
  }
  cEnumerator__32_lstringlist enumerator_149484 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_149484.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3674)).add_operation (GALGAS_string ("->enterIndexing (C_Lexique_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3674)).add_operation (object->mAttribute_mLexiqueIdentifier, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)).operator_concat (GALGAS_string ("::kIndexing_").add_operation (enumerator_149484.current_mValue_30_ (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)).add_operation (enumerator_149484.current_mValue_31_ (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3676)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3676)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3676))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3674)) ;
    enumerator_149484.gotoNextObject () ;
  }
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->preceedingSeparatorString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3679)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->tokenString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3685)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3692)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3692)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3693)).operator_concat (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3693)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3693)).operator_concat (GALGAS_string ("::kToken_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3694)).operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3694))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3694)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3694)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mInstructionLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3695))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3695)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3695))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3693)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3751)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3753)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mRepeatedInstructionList, object->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_repeated_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3756)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3771)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_152986 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_152986.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_152986.current_mSyntaxInstructionList (HERE), enumerator_152986.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3774)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_152986.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3788)) ;
    enumerator_152986.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_repeat_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3791)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOf_5F_repeat_5F_instruction, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3793))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3793)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_repeatFlagCppName = GALGAS_string ("repeatFlag_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3813))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3813)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3813)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3814)).operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3814))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3814)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3815)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3815))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3815)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_m_5F_repeated_5F_instructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3816)) ;
  }
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3824)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3825))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3825))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825)).operator_concat (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3825)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_154967 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_154923 ((uint32_t) 0) ;
  while (enumerator_154967.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_154923.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3827))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_154967.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3828)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3836)) ;
    enumerator_154967.gotoNextObject () ;
    index_154923.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3826)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3838)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3839)).operator_concat (GALGAS_string (" = false ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3839))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3839)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3840)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3841)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3842)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3843)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_choiceIndex = ioArgument_ioSelectMethodCount ;
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3861)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3863)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3865)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_156362 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_156362.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_156362.current_mSyntaxInstructionList (HERE), enumerator_156362.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_156362.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3882)) ;
    enumerator_156362.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_select_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3885)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_selectInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3886))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3886)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3904)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3904)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3905))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3905))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905)).operator_concat (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3905)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_157834 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_157790 ((uint32_t) 0) ;
  while (enumerator_157834.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_157790.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3907))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_157834.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3908)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3916)) ;
    enumerator_157834.gotoNextObject () ;
    index_157790.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3906)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3918)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3919)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3920)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3938)) ;
  GALGAS_uint var_referenceSelectMethodCount = ioArgument_ioSelectMethodCount ;
  cEnumerator_listOfSyntaxInstructionList enumerator_159029 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_159029.hasCurrentObject ()) {
    ioArgument_ioSelectMethodCount = var_referenceSelectMethodCount ;
    GALGAS_semanticInstructionListForGeneration var_instructionList = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 3942)) ;
    cEnumerator_syntaxInstructionList enumerator_159195 (enumerator_159029.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_159195.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_159195.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3944)) ;
      enumerator_159195.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_159029.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3957)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_159899_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_159899_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3962)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3963)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_160084 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_160084.hasCurrentObject () && bool_0) {
    while (enumerator_160084.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_160084.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3968)), enumerator_160084.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3966)) ;
      enumerator_160084.gotoNextObject () ;
      if (enumerator_160084.hasCurrentObject ()) {
        bool_0 = var_ok.isValidAndTrue () ;
      }
    }
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseRewindInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3973))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3973)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3989)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3989)) ;
  }
  GALGAS_string var_parsingContextVar = GALGAS_string ("parsingContext_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3990))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3990)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3990)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext ").operator_concat (var_parsingContextVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3991)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3991)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3991))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3991)).operator_concat (GALGAS_string ("->parsingContext () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3991))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3991)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_161263 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_161263.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_161263.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3994)) ;
    }
    if (enumerator_161263.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4003)).operator_concat (GALGAS_string ("->setParsingContext (")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4003)).operator_concat (var_parsingContextVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4003)).operator_concat (GALGAS_string (") ; // rewind\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4003))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4003)) ;
    }
    enumerator_161263.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//-------- END OF @parseRewindInstructionForGeneration\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4005)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4025)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variant_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4024)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4030)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4032)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4032))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4032)).operator_concat (GALGAS_string ("', but it should be '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4032)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4033))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4033)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4033))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4031)) ;
  }
  GALGAS_semanticExpressionForGeneration var_while_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4039)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4038)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4044)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfWhileExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)).operator_concat (GALGAS_string ("', but it should be '@")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4046)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4047))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4047)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4047))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4045)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4052)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mDoInstructionList, object->mAttribute_mEndOfInstructionList, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4055)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4070)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseLoopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variant_5F_expression, var_while_5F_expression, var_instructionList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4072))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4072)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4089)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4089)) ;
  }
  GALGAS_string var_variantVarCppName ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mVariantExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_variantVarCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4093)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_variantVarCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4095)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4095))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4095)) ;
  {
  ...
  GALGAS_string var_variantVar = GALGAS_string ("variant_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4097))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4097)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4097)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("uint32_t ").operator_concat (var_variantVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4098)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4098)).operator_concat (var_variantVarCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4098)).operator_concat (GALGAS_string (".uintValue () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4098))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4098)) ;
  GALGAS_string var_loopVar = GALGAS_string ("loop_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4100))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4100)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4100)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_loopVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4101)).operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4101))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4101)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_loopVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4102)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4102))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4102)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4103)) ;
  }
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVarCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4106)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_whileVarCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4107)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4107))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4107)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4108)) ;
  }
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (var_variantVar.operator_concat (GALGAS_string (" -- ; // Decrement variant\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4110))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4110)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext parsingContext = ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4111))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4111)).operator_concat (GALGAS_string ("->parsingContext () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4111))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4111)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4112)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4120)).operator_concat (GALGAS_string ("->setParsingContext (parsingContext) ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4120))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4120)) ;
  {
  ...
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4125)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4126)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//--- 'parse'\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4128)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4131)), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4129)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4137)).operator_concat (GALGAS_string ("->resetTemplateString () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4137))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4137)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//-------- END OF @parseLoopInstructionForGeneration\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4138)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4158)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4157)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4164)) ;
  }
...
static void categoryMethod_parseWhenInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhenExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4228)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4229)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4229))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4229)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4230)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4238)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mElseInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4239)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4247)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 4264)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' instruction is only allowed when syntax componant has 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4265)) ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4269)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4268)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysis.gSemantics", 4275)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' expresion should be an @string expression")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4276)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_syntaxSendInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_expression  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4279))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4279)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_sourceVar ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4294)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4296)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4296)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4297)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4297)).operator_concat (GALGAS_string ("  ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4297)).operator_concat (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4298))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4298)).operator_concat (GALGAS_string (" << ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4298)).operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4298)).operator_concat (GALGAS_string (".stringValue () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4298)).operator_concat (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4298))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4297)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
