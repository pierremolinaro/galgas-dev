...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  cEnumerator_lstringlist enumerator_93735 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2333)), kEnumeration_up) ;
  while (enumerator_93735.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_93735.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_93735.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2334)).operator_concat (GALGAS_string ("' type is undefined")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2334)) ;
    enumerator_93735.gotoNextObject () ;
  }
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = constinArgument_inDeclarationList ;
  cEnumerator_semanticDeclarationListAST enumerator_93989 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_93989.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_93989.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2339)) ;
    enumerator_93989.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_semanticDeclarationListAST enumerator_94359 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_94359.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_94359.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2346)) ;
      enumerator_94359.gotoNextObject () ;
    }
  }
}
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_58641.hasCurrentObject ()) {
      ...
      cEnumerator_formalTemplateInputParameterListAST enumerator_59449 (enumerator_58641.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
      while (enumerator_59449.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_59449.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1500)) ;
        GALGAS_string var_cppVarName = GALGAS_string ("in_").operator_concat (enumerator_59449.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1501)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1501))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1501)) ;
        {
        var_templateVariableMap.modifier_insertKey (enumerator_59449.current_mFormalArgumentName (HERE), var_type, var_cppVarName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1502)) ;
        }
        var_filewrapperTemplateFormalInputParameters.addAssign_operation (enumerator_59449.current_mFormalTemplateSelector (HERE), var_type, var_cppVarName, enumerator_59449.current_mFormalArgumentName (HERE), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1503)) ;
        enumerator_59449.gotoNextObject () ;
      }
...
static void categoryMethod_abstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_62038 (object->mAttribute_mAbstractCategoryMethodFormalParameterList, kEnumeration_up) ;
  while (enumerator_62038.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_62038.current_mFormalSelector (HERE), enumerator_62038.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_62038.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1558)), enumerator_62038.current_mFormalArgumentName (HERE), enumerator_62038.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1560))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1555)) ;
    enumerator_62038.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).isValid ()) {
    uint32_t variant_65965 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).uintValue () ;
    bool loop_65965 = true ;
    while (loop_65965) {
      loop_65965 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).isValid () ;
      if (loop_65965) {
        loop_65965 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).boolValue () ;
      }
      if (loop_65965 && (0 == variant_65965)) {
        loop_65965 = false ;
      ...
      if (loop_65965) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_66274_0 ; // Joker input parameter
          GALGAS_bool joker_66327_0 ; // Joker input parameter
          GALGAS_string joker_66341_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1663)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_66274_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_66327_0, var_qualifier, joker_66341_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1663)) ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).isValid ()) {
    uint32_t variant_69496 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).uintValue () ;
    bool loop_69496 = true ;
    while (loop_69496) {
      loop_69496 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).isValid () ;
      if (loop_69496) {
        loop_69496 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).boolValue () ;
      }
      if (loop_69496 && (0 == variant_69496)) {
        loop_69496 = false ;
      ...
      if (loop_69496) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_69805_0 ; // Joker input parameter
          GALGAS_bool joker_69858_0 ; // Joker input parameter
          GALGAS_string joker_69872_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1748)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_69805_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_69858_0, var_qualifier, joker_69872_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1748)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_71793 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_71793.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_71793.current_mFormalSelector (HERE), enumerator_71793.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_71793.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1799)), enumerator_71793.current_mFormalArgumentName (HERE), enumerator_71793.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1801))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1796)) ;
    enumerator_71793.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).isValid ()) {
    uint32_t variant_75544 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).uintValue () ;
    bool loop_75544 = true ;
    while (loop_75544) {
      loop_75544 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).isValid () ;
      if (loop_75544) {
        loop_75544 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).boolValue () ;
      }
      if (loop_75544 && (0 == variant_75544)) {
        loop_75544 = false ;
      ...
      if (loop_75544) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_75845_0 ; // Joker input parameter
          GALGAS_bool joker_75868_0 ; // Joker input parameter
          GALGAS_string joker_75882_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1901)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_75845_0, var_inheritedSignature, joker_75868_0, var_qualifier, joker_75882_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1901)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).isValid ()) {
    uint32_t variant_78863 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).uintValue () ;
    bool loop_78863 = true ;
    while (loop_78863) {
      loop_78863 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).isValid () ;
      if (loop_78863) {
        loop_78863 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).boolValue () ;
      }
      if (loop_78863 && (0 == variant_78863)) {
        loop_78863 = false ;
      ...
      if (loop_78863) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_79164_0 ; // Joker input parameter
          GALGAS_bool joker_79187_0 ; // Joker input parameter
          GALGAS_string joker_79201_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1983)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_79164_0, var_inheritedSignature, joker_79187_0, var_qualifier, joker_79201_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1983)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_81126 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_81126.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_81126.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_81126.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2033)), enumerator_81126.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2034)), enumerator_81126.current_mFormalArgumentName (HERE), enumerator_81126.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2031)) ;
    enumerator_81126.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).isValid ()) {
    uint32_t variant_85409 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).uintValue () ;
    bool loop_85409 = true ;
    while (loop_85409) {
      loop_85409 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).isValid () ;
      if (loop_85409) {
        loop_85409 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).boolValue () ;
      }
      if (loop_85409 && (0 == variant_85409)) {
        loop_85409 = false ;
      ...
      if (loop_85409) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_85683_0 ; // Joker input parameter
          GALGAS_bool joker_85760_0 ; // Joker input parameter
          GALGAS_string joker_85837_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2148)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_85683_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_85760_0, var_inheritedReturnType, var_qualifier, joker_85837_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2148)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).isValid ()) {
    uint32_t variant_89306 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).uintValue () ;
    bool loop_89306 = true ;
    while (loop_89306) {
      loop_89306 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).isValid () ;
      if (loop_89306) {
        loop_89306 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).boolValue () ;
      }
      if (loop_89306 && (0 == variant_89306)) {
        loop_89306 = false ;
      ...
      if (loop_89306) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_89611_0 ; // Joker input parameter
          GALGAS_bool joker_89688_0 ; // Joker input parameter
          GALGAS_string joker_89747_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2249)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_89611_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_89688_0, var_inheritedReturnType, var_qualifier, joker_89747_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2249)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_formalInputParameterListAST enumerator_90269 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_90269.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (enumerator_90269.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_90269.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2274)), enumerator_90269.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2275)), enumerator_90269.current_mFormalArgumentName (HERE), enumerator_90269.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2272)) ;
      enumerator_90269.gotoNextObject () ;
    }
    {
