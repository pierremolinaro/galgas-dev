...
void routine_buildLocalVariableMapAndSignature (const GALGAS_semanticContext constinArgument_inSemanticContext,
  ...
  cEnumerator_formalParameterListAST enumerator_39101 (constinArgument_inRoutineSignatureAST, kEnumeration_up) ;
  while (enumerator_39101.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_39101.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 980)) ;
    GALGAS_string var_formalArgumentCppName ;
    if (enumerator_39101.current_mFormalArgumentPassingMode (HERE).isValid ()) {
      switch (enumerator_39101.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
      case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
        break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
        var_formalArgumentCppName = GALGAS_string ("inArgument_").operator_concat (enumerator_39101.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 984)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 984))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 984)) ;
        const enumGalgasBool test_0 = enumerator_39101.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 986)) ;
          }
        }else if (kBoolFalse == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgument (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 988)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
        var_formalArgumentCppName = GALGAS_string ("outArgument_").operator_concat (enumerator_39101.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 991)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 991))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 991)) ;
        {
        ioArgument_ioVariableMap.modifier_insertOutputFormalArgument (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 992)) ;
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
        var_formalArgumentCppName = GALGAS_string ("ioArgument_").operator_concat (enumerator_39101.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 994)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 994))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 994)) ;
        const enumGalgasBool test_1 = enumerator_39101.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 996)) ;
          }
        }else if (kBoolFalse == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgument (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 998)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
        var_formalArgumentCppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_39101.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1001)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1001))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1001)) ;
        const enumGalgasBool test_2 = enumerator_39101.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1003)) ;
          }
        }else if (kBoolFalse == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgument (enumerator_39101.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1005)) ;
          }
        }
        } break ;
      }
    }
    outArgument_outRoutineSignature.addAssign_operation (enumerator_39101.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_39101.current_mFormalArgumentName (HERE), var_formalArgumentCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1008)) ;
    enumerator_39101.gotoNextObject () ;
  }
}
...
void routine_analyzeRoutineBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_localConstantList enumerator_41792 (constinArgument_inLocalConstantList, kEnumeration_up) ;
  while (enumerator_41792.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_41792.current_mNoWarningIfUnused (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      var_variableMap.modifier_insertUsedLocalConstant (enumerator_41792.current_mName (HERE), enumerator_41792.current_mType (HERE), enumerator_41792.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1030)) ;
      }
    }else if (kBoolFalse == test_0) {
      {
      var_variableMap.modifier_insertLocalConstant (enumerator_41792.current_mName (HERE), enumerator_41792.current_mType (HERE), enumerator_41792.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1032)) ;
      }
    }
    enumerator_41792.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_42166 (constinArgument_inNonMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_42166.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_42166.current_mAttributeName (HERE), enumerator_42166.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1040)).operator_concat (enumerator_42166.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1040)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1040))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1040)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1037)) ;
    }
    enumerator_42166.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_42514 (constinArgument_inMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_42514.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertMutableAttribute (enumerator_42514.current_mAttributeName (HERE), enumerator_42514.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1049)).operator_concat (enumerator_42514.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1049)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1049))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1049)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1046)) ;
    }
    enumerator_42514.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_semanticInstructionListAST enumerator_43117 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_43117.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_43117.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1063)) ;
    enumerator_43117.gotoNextObject () ;
  }
...
void routine_analyzeFunctionBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_typedAttributeList enumerator_50859 (constinArgument_inTypedAttributeList, kEnumeration_up) ;
  while (enumerator_50859.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_50859.current_mAttributeName (HERE), enumerator_50859.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1294)).operator_concat (enumerator_50859.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1294)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1294))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1294)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1291)) ;
    }
    enumerator_50859.gotoNextObject () ;
  }
  ...
  cEnumerator_formalInputParameterListAST enumerator_51273 (constinArgument_inFunctionSignature, kEnumeration_up) ;
  while (enumerator_51273.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_51273.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1301)) ;
    const enumGalgasBool test_0 = enumerator_51273.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_cppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_51273.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1303)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1303))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1303)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (var_parameterType, var_cppName, enumerator_51273.current_mFormalArgumentName (HERE), enumerator_51273.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1304)) ;
      const enumGalgasBool test_1 = enumerator_51273.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        var_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_51273.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1311)) ;
        }
      }else if (kBoolFalse == test_1) {
        {
        var_variableMap.modifier_insertConstantInputFormalArgument (enumerator_51273.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1313)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_cppName = GALGAS_string ("inArgument_").operator_concat (enumerator_51273.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1316)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1316))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1316)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (var_parameterType, var_cppName, enumerator_51273.current_mFormalArgumentName (HERE), enumerator_51273.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1317)) ;
      const enumGalgasBool test_2 = enumerator_51273.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        var_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_51273.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1324)) ;
        }
      }else if (kBoolFalse == test_2) {
        {
        var_variableMap.modifier_insertInputFormalArgument (enumerator_51273.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1326)) ;
        }
      }
    }
  ...
  cEnumerator_semanticInstructionListAST enumerator_53059 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_53059.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_53059.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1337)) ;
    enumerator_53059.gotoNextObject () ;
  }
...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  cEnumerator_lstringlist enumerator_92215 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2318)), kEnumeration_up) ;
  while (enumerator_92215.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_92215.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_92215.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2319))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2319)).operator_concat (GALGAS_string ("' type is undefined")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2319))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2319)) ;
    enumerator_92215.gotoNextObject () ;
  }
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = constinArgument_inDeclarationList ;
  cEnumerator_semanticDeclarationListAST enumerator_92469 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_92469.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_92469.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2324)) ;
    enumerator_92469.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_semanticDeclarationListAST enumerator_92839 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_92839.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_92839.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2331)) ;
      enumerator_92839.gotoNextObject () ;
    }
  }
}
...
static void categoryMethod_listmapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_attributeMap joker_16748_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_16748_21 ; // Joker input parameter
  GALGAS_constructorMap joker_16748_20 ; // Joker input parameter
  GALGAS_readerMap joker_16748_19 ; // Joker input parameter
  GALGAS_modifierMap joker_16748_18 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_16748_17 ; // Joker input parameter
  GALGAS_classMethodMap joker_16748_16 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_16748_15 ; // Joker input parameter
  GALGAS_stringlist joker_16748_14 ; // Joker input parameter
  GALGAS_uint joker_16748_13 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_16748_12 ; // Joker input parameter
  GALGAS_stringset joker_16748_11 ; // Joker input parameter
  GALGAS_lstringlist joker_16748_10 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_16748_9 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_16748_8 ; // Joker input parameter
  GALGAS_withAccessorMap joker_16748_7 ; // Joker input parameter
  GALGAS_bool joker_16748_6 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_16748_5 ; // Joker input parameter
  GALGAS_string joker_16748_4 ; // Joker input parameter
  GALGAS_string joker_16748_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_16748_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_16748_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_16659_3, joker_16659_2, joker_16659_1, var_typeKindEnum, var_listTypeAttributeList, joker_16748_22, joker_16748_21, joker_16748_20, joker_16748_19, joker_16748_18, joker_16748_17, joker_16748_16, joker_16748_15, joker_16748_14, joker_16748_13, joker_16748_12, joker_16748_11, joker_16748_10, joker_16748_9, joker_16748_8, joker_16748_7, joker_16748_6, joker_16748_5, joker_16748_4, joker_16748_3, joker_16748_2, joker_16748_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 404)) ;
...
static void categoryMethod_mapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_mapTypeForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 565)), object->mAttribute_mMapTypeName, var_typedAttributeList, object->mAttribute_mInsertMethodList, object->mAttribute_mSearchMethodList, object->mAttribute_mRemoveMethodList, var_hasInsertOrReplaceModifier, var_withAccessorMap  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 564)), GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 562)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_insertMethodListAST enumerator_23320 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_23320.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_23320.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 589)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_23320.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_23320.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 590))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 590)).operator_concat (GALGAS_string ("' insert method should name an automaton state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 590))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 590)) ;
      }else if (kBoolFalse == test_1) {
        var_initialStateSet.addAssign_operation (enumerator_23320.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 592))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 592)) ;
      }
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_23320.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 594)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_23320.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_23320.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 595))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 595)).operator_concat (GALGAS_string ("' insert method should not name an automaton state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 595))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 595)) ;
      }
    }
    enumerator_23320.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_23923 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_23923.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_23923.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 602)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_23923.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_23923.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 603))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 603)).operator_concat (GALGAS_string ("' search method should name an automaton action")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 603))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 603)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_mapAutomatonActionMap.reader_hasKey (enumerator_23923.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 604)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 604)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 604)).boolEnum () ;
        if (kBoolTrue == test_8) {
          {
          var_mapAutomatonActionMap.modifier_insertKey (enumerator_23923.current_mActionName (HERE), var_mapAutomatonActionMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 606)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 606)) ;
          }
        }
      }
    }else if (kBoolFalse == test_5) {
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_23923.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 610)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_23923.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the '").operator_concat (enumerator_23923.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 611))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 611)).operator_concat (GALGAS_string ("' search method should not name an automaton action")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 611))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 611)) ;
      }
    }
  ...
  cEnumerator_mapStateList enumerator_24736 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_24736.hasCurrentObject ()) {
    {
    var_mapAutomatonStateMap.modifier_insertKey (enumerator_24736.current_mStateName (HERE), var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 617)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 617)) ;
    }
  ...
  while (enumerator_24862.hasCurrentObject ()) {
    cEnumerator_mapStateTransitionList enumerator_24893 (enumerator_24862.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_24893.hasCurrentObject ()) {
      GALGAS_uint joker_24954_0 ; // Joker input parameter
      var_mapAutomatonStateMap.method_searchKey (enumerator_24893.current_mTargetStateName (HERE), joker_24954_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 621)) ;
  ...
  cEnumerator_mapStateList enumerator_25188 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_25188.hasCurrentObject ()) {
    ...
    cEnumerator_mapStateTransitionList enumerator_25353 (enumerator_25188.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_25353.hasCurrentObject ()) {
      GALGAS_uint var_actionIndex ;
      var_mapAutomatonActionMap.method_searchKey (enumerator_25353.current_mActionName (HERE), var_actionIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 632)) ;
      const enumGalgasBool test_11 = var_actionsForCurrentState.reader_hasKey (enumerator_25353.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 633)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 633)).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_location location_12 (enumerator_25353.current_mActionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_25353.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 634))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 634)).operator_concat (GALGAS_string ("' action is already used for this state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 634))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 634)) ;
      }
      var_actionsForCurrentState.addAssign_operation (enumerator_25353.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 636))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 636)) ;
      GALGAS_uint var_targetStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_25353.current_mTargetStateName (HERE), var_targetStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 638)) ;
      var_mapStateTransitionSortedList.addAssign_operation (var_actionIndex, enumerator_25353.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 641)), var_targetStateIndex, enumerator_25353.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 643)), enumerator_25353.current_mTransitionMessageKind (HERE), enumerator_25353.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 645))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 639)) ;
      enumerator_25353.gotoNextObject () ;
    }
    GALGAS_uint var_stateIndex ;
    var_mapAutomatonStateMap.method_searchKey (enumerator_25188.current_mStateName (HERE), var_stateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 649)) ;
    var_mapStateSortedList.addAssign_operation (var_stateIndex, enumerator_25188.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 652)), enumerator_25188.current_mStateMessageKind (HERE), enumerator_25188.current_mStateMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 654)), var_mapStateTransitionSortedList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 650)) ;
    ...
    if (kBoolTrue == test_13) {
      ...
      cEnumerator_stringset enumerator_26455 (var_missingActions, kEnumeration_up) ;
      while (enumerator_26455.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_26455.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 661)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 661))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 661)) ;
        if (enumerator_26455.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 662)) ;
        }
        enumerator_26455.gotoNextObject () ;
      }
      GALGAS_location location_14 (enumerator_25188.current_mStateName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_25188.gotoNextObject () ;
  }
  ...
  if (object->mAttribute_mMapStateList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 670)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 670)).isValid ()) {
    uint32_t variant_26793 = object->mAttribute_mMapStateList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 670)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 670)).uintValue () ;
    bool loop_26793 = true ;
    while (loop_26793) {
      loop_26793 = var_progress.isValid () ;
      if (loop_26793) {
        loop_26793 = var_progress.boolValue () ;
      }
      if (loop_26793 && (0 == variant_26793)) {
        loop_26793 = false ;
      ...
      if (loop_26793) {
        ...
        cEnumerator_mapStateList enumerator_26890 (object->mAttribute_mMapStateList, kEnumeration_up) ;
        while (enumerator_26890.hasCurrentObject ()) {
          const enumGalgasBool test_15 = var_accessibleStates.reader_hasKey (enumerator_26890.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 673)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 673)).boolEnum () ;
          if (kBoolTrue == test_15) {
            cEnumerator_mapStateTransitionList enumerator_26986 (enumerator_26890.current_mTransitionList (HERE), kEnumeration_up) ;
            while (enumerator_26986.hasCurrentObject ()) {
              const enumGalgasBool test_16 = var_accessibleStates.reader_hasKey (enumerator_26986.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 675)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 675)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 675)).boolEnum () ;
              if (kBoolTrue == test_16) {
                var_accessibleStates.addAssign_operation (enumerator_26986.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 676))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 676)) ;
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_27414 (var_uselessStates, kEnumeration_up) ;
    while (enumerator_27414.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_27414.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 687)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 687))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 687)) ;
      if (enumerator_27414.hasNextObject ()) {
  ...
  cEnumerator_mapAutomatonStateMap enumerator_27784 (var_mapAutomatonStateMap, kEnumeration_up) ;
  while (enumerator_27784.hasCurrentObject ()) {
    GALGAS_stringset var_reachableStates = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 697)) ;
    var_reachableStates.addAssign_operation (enumerator_27784.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 698))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 698)) ;
    GALGAS_bool var_progress = GALGAS_bool (true) ;
    if (var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 700)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 700)).isValid ()) {
      uint32_t variant_27909 = var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 700)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 700)).uintValue () ;
      bool loop_27909 = true ;
      while (loop_27909) {
        loop_27909 = var_progress.isValid () ;
        if (loop_27909) {
          loop_27909 = var_progress.boolValue () ;
        }
        if (loop_27909 && (0 == variant_27909)) {
          loop_27909 = false ;
        ...
        if (loop_27909) {
          variant_27909 -- ;
          var_progress = GALGAS_bool (false) ;
          cEnumerator_mapStateList enumerator_28016 (object->mAttribute_mMapStateList, kEnumeration_up) ;
          while (enumerator_28016.hasCurrentObject ()) {
            const enumGalgasBool test_18 = var_reachableStates.reader_hasKey (enumerator_28016.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 703)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 703)).boolEnum () ;
            if (kBoolTrue == test_18) {
              cEnumerator_mapStateTransitionList enumerator_28115 (enumerator_28016.current_mTransitionList (HERE), kEnumeration_up) ;
              while (enumerator_28115.hasCurrentObject ()) {
                const enumGalgasBool test_19 = var_reachableStates.reader_hasKey (enumerator_28115.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 705)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 705)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 705)).boolEnum () ;
                if (kBoolTrue == test_19) {
                  var_reachableStates.addAssign_operation (enumerator_28115.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 706))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 706)) ;
                  var_accessibilityGraph.addAssign_operation (enumerator_27784.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 707)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 707)).operator_concat (enumerator_28115.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 707))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 707))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 707)) ;
                  var_progress = GALGAS_bool (true) ;
                }
    ...
    cEnumerator_stringset enumerator_28501 (var_reachableStates, kEnumeration_up) ;
    while (enumerator_28501.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_27784.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 715)).objectCompare (enumerator_28501.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_20) {
        var_neededAssociations.addAssign_operation (enumerator_27784.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 716)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 716)).operator_concat (enumerator_28501.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 716))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 716)) ;
      }
      enumerator_28501.gotoNextObject () ;
    }
    enumerator_27784.gotoNextObject () ;
  }
  ...
  cEnumerator_mapOverrideBlockListAST enumerator_28736 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
  while (enumerator_28736.hasCurrentObject ()) {
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_28984 (enumerator_28736.current_mMapOverrideBlockDescriptor_31_AST (HERE), kEnumeration_up) ;
    while (enumerator_28984.hasCurrentObject ()) {
      GALGAS_uint var_startStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_28984.current_mLeftState (HERE), var_startStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 728)) ;
      GALGAS_uint var_currentStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_28984.current_mRightState (HERE), var_currentStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 730)) ;
      GALGAS_string var_association = enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 731)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 731)).operator_concat (enumerator_28984.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 731))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 731)) ;
      ...
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_28984.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_23) {
        GALGAS_location location_24 (enumerator_28984.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_28984.current_mResultingState (HERE), var_finalStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 741)) ;
      const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 742)).objectCompare (enumerator_28984.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 742)))).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_neededCombinaisons.addAssign_operation (enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 743)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 743)).operator_concat (enumerator_28984.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 743)) ;
        var_neededCombinaisons.addAssign_operation (enumerator_28984.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 744)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 744)).operator_concat (enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 744))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 744))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 744)) ;
        const enumGalgasBool test_26 = var_accessibilityGraph.reader_hasKey (enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 745)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 745)).operator_concat (enumerator_28984.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 745)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 745)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 745)).boolEnum () ;
        if (kBoolTrue == test_26) {
          GALGAS_location location_27 (enumerator_28984.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_28984.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 747))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 747)).operator_concat (GALGAS_string ("' state is not reachable from '")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 747)).operator_concat (enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 747))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 747)).operator_concat (GALGAS_string ("' state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 747))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 746)) ;
        }
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_28984.current_mTransitionMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 751)) ;
      }
      var_branchBehaviourSortedListForMapOverride_31_.addAssign_operation (var_startStateNameIndex, enumerator_28984.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 754)), var_currentStateNameIndex, enumerator_28984.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 756)), var_finalStateNameIndex, enumerator_28984.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 758)), enumerator_28984.current_mMessageKind (HERE), enumerator_28984.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 760))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 752)) ;
      enumerator_28984.gotoNextObject () ;
    }
    ...
    if (kBoolTrue == test_28) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_30840 (var_forgottenAssociations, kEnumeration_up) ;
      while (enumerator_30840.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_30840.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 767))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 767)) ;
        enumerator_30840.gotoNextObject () ;
      }
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_31204 (enumerator_28736.current_mMapOverrideBlockDescriptor_32_AST (HERE), kEnumeration_up) ;
    while (enumerator_31204.hasCurrentObject ()) {
      GALGAS_uint var_leftStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_31204.current_mLeftState (HERE), var_leftStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 775)) ;
      GALGAS_uint var_rightStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_31204.current_mRightState (HERE), var_rightStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 777)) ;
      GALGAS_string var_combinaison = enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 778)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 778)).operator_concat (enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 778))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 778)) ;
      ...
      if (kBoolTrue == test_29) {
        GALGAS_location location_30 (enumerator_31204.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_30, GALGAS_string ("the '").operator_concat (enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 781))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 781)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 781)).operator_concat (enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 781))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 781)).operator_concat (GALGAS_string ("' combinaison is useless")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 781))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 780)) ;
      }
      ...
      if (kBoolTrue == test_31) {
        GALGAS_location location_32 (enumerator_31204.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_32, GALGAS_string ("the '").operator_concat (enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 785))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 785)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 785)).operator_concat (enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 785))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 785)).operator_concat (GALGAS_string ("' combinaison is already defined")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 785))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 784)) ;
      }
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_31204.current_mResultingState (HERE), var_resultingStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 789)) ;
      const enumGalgasBool test_33 = GALGAS_bool (kIsNotEqual, enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 790)).objectCompare (enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 790)))).operator_and (GALGAS_bool (kIsNotEqual, enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 791)).objectCompare (enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 791)))) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 790)).operator_and (var_accessibilityGraph.reader_hasKey (enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 792)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792)).operator_concat (enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 792))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 792)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 791)).boolEnum () ;
      if (kBoolTrue == test_33) {
        GALGAS_location location_34 (enumerator_31204.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_34, GALGAS_string ("the '").operator_concat (enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 794))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 794)).operator_concat (GALGAS_string ("' state cannot be reached from the '")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 794)).operator_concat (enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 794))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 794)).operator_concat (GALGAS_string ("' state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 794))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 793)) ;
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_31204.current_mTransitionMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 796)) ;
      }
      const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_31204.current_mMessageKind (HERE).objectCompare (GALGAS_mapAutomatonMessageKind::constructor_noMessage (SOURCE_FILE ("semanticAnalysis.gSemantics", 797)))).boolEnum () ;
      if (kBoolTrue == test_35) {
        var_definedCombinaisons.addAssign_operation (enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 798)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 798)).operator_concat (enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 798))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 798))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 798)) ;
        var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_rightStateIndex, enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 801)), var_leftStateIndex, enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 803)), var_resultingStateNameIndex, enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 805)), enumerator_31204.current_mMessageKind (HERE), enumerator_31204.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 807))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 799)) ;
      }
      var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_leftStateIndex, enumerator_31204.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 812)), var_rightStateIndex, enumerator_31204.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 814)), var_resultingStateNameIndex, enumerator_31204.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 816)), enumerator_31204.current_mMessageKind (HERE), enumerator_31204.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 818))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 810)) ;
      enumerator_31204.gotoNextObject () ;
    }
    ...
    if (kBoolTrue == test_36) {
      ...
      if (kBoolTrue == test_37) {
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_33525 (var_forgottenCombinaisons, kEnumeration_up) ;
        while (enumerator_33525.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_33525.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 826))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 826)) ;
    ...
    var_mapOverrideList.addAssign_operation (enumerator_28736.current_mOverrideBlockName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 832)), var_branchBehaviourSortedListForMapOverride_31_, var_branchBehaviourSortedListForMapOverride_32_  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 831)) ;
    enumerator_28736.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_34036 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_34036.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_34036.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 841)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_34036.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 844)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_34036.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 850)) ;
    }
    enumerator_34036.gotoNextObject () ;
  }
  ...
  cEnumerator_insertMethodListAST enumerator_34458 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_34458.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_34458.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 855)) ;
    }
    cEnumerator_stringlist enumerator_34651 (enumerator_34458.current_mErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 857)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 857)), kEnumeration_up) ;
    while (enumerator_34651.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_34651.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 858)) ;
      {
      GALGAS_string joker_34767_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_34767_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 859)) ;
      }
      cEnumerator_stringlist enumerator_34799 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_34799.hasCurrentObject ()) {
        const enumGalgasBool test_38 = GALGAS_bool (kIsStrictSup, enumerator_34799.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 861)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_38) {
          GALGAS_char var_c = enumerator_34799.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 862)) ;
          ...
          if (kBoolTrue == test_39) {
            GALGAS_location location_40 (enumerator_34458.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_34799.gotoNextObject () ;
      }
      enumerator_34651.gotoNextObject () ;
    }
    cEnumerator_stringlist enumerator_35278 (enumerator_34458.current_mShadowErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 870)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 870)), kEnumeration_up) ;
    while (enumerator_35278.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_35278.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 871)) ;
      {
      GALGAS_string joker_35394_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_35394_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 872)) ;
      }
      cEnumerator_stringlist enumerator_35426 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_35426.hasCurrentObject ()) {
        const enumGalgasBool test_41 = GALGAS_bool (kIsStrictSup, enumerator_35426.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 874)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_41) {
          GALGAS_char var_c = enumerator_35426.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 875)) ;
          ...
          if (kBoolTrue == test_42) {
            GALGAS_location location_43 (enumerator_34458.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_35278.gotoNextObject () ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_35874 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_35874.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_35874.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 887)) ;
      }
    }else if (kBoolFalse == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_35874.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 889)) ;
      }
    }
    cEnumerator_stringlist enumerator_36188 (enumerator_35874.current_mErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 892)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 892)), kEnumeration_up) ;
    while (enumerator_36188.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_36188.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 893)) ;
      {
      GALGAS_string joker_36304_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_36304_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 894)) ;
      }
      cEnumerator_stringlist enumerator_36336 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_36336.hasCurrentObject ()) {
        const enumGalgasBool test_45 = GALGAS_bool (kIsStrictSup, enumerator_36336.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 896)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_45) {
          GALGAS_char var_c = enumerator_36336.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 897)) ;
          const enumGalgasBool test_46 = GALGAS_bool (kIsNotEqual, var_c.objectCompare (GALGAS_char (TO_UNICODE (75)))).boolEnum () ;
          if (kBoolTrue == test_46) {
            GALGAS_location location_47 (enumerator_35874.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_35874.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_36863 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_36863.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_36863.current_mSearchMethodName (HERE), constinArgument_inPredefinedTypes.mAttribute_mLStringType, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 909)) ;
    }
...
static void categoryMethod_mapProxyDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_37975_6 ; // Joker input parameter
  GALGAS_bool joker_37975_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_37975_4 ; // Joker input parameter
  GALGAS_typeKindEnum joker_37975_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_37975_2 ; // Joker input parameter
  GALGAS_attributeMap joker_37975_1 ; // Joker input parameter
  GALGAS_constructorMap joker_38010_11 ; // Joker input parameter
  GALGAS_readerMap joker_38010_10 ; // Joker input parameter
  GALGAS_modifierMap joker_38010_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_38010_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_38010_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_38010_6 ; // Joker input parameter
  GALGAS_stringlist joker_38010_5 ; // Joker input parameter
  GALGAS_uint joker_38010_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_38010_3 ; // Joker input parameter
  GALGAS_stringset joker_38010_2 ; // Joker input parameter
  GALGAS_lstringlist joker_38010_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_38041_8 ; // Joker input parameter
  GALGAS_withAccessorMap joker_38041_7 ; // Joker input parameter
  GALGAS_bool joker_38041_6 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_38041_5 ; // Joker input parameter
  GALGAS_string joker_38041_4 ; // Joker input parameter
  GALGAS_string joker_38041_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_38041_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_38041_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_37975_6, joker_37975_5, joker_37975_4, joker_37975_3, joker_37975_2, joker_37975_1, var_listTypeAttributeList, joker_38010_11, joker_38010_10, joker_38010_9, joker_38010_8, joker_38010_7, joker_38010_6, joker_38010_5, joker_38010_4, joker_38010_3, joker_38010_2, joker_38010_1, var_searchMethodList, joker_38041_8, joker_38041_7, joker_38041_6, joker_38041_5, joker_38041_4, joker_38041_3, joker_38041_2, joker_38041_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 943)) ;
...
static void categoryMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_43785 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_43785.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_43785.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1083)), enumerator_43785.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1084)), enumerator_43785.current_mFormalArgumentName (HERE), enumerator_43785.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1082)) ;
    enumerator_43785.gotoNextObject () ;
  }
...
static void categoryMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_44788 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_44788.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_44788.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_44788.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1113)), enumerator_44788.current_mFormalArgumentName (HERE), enumerator_44788.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1115))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1111)) ;
    enumerator_44788.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      cEnumerator_lstringlist enumerator_47496 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_47496.hasCurrentObject ()) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_47496.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1193)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = var_generatedInSeparateFileFeature.boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (enumerator_47496.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_5 (enumerator_47496.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_lstringlist enumerator_48157 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_48157.hasCurrentObject ()) {
        GALGAS_location location_7 (enumerator_48157.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_48157.gotoNextObject () ;
      }
    }
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_48440 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_48440.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_48440.current_mAttributeTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1216)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_48628 (enumerator_48440.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_48628.hasCurrentObject ()) {
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_48628.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1220)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        const enumGalgasBool test_9 = var_hasSetter.boolEnum () ;
        if (kBoolTrue == test_9) {
          GALGAS_location location_10 (enumerator_48628.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_48628.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1225)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_hasGetter.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1226)).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_48628.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_14 (enumerator_48628.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_48628.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_t, enumerator_48440.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1234)) ;
    var_allAttributeList.addAssign_operation (var_t, enumerator_48440.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1240)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_48440.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1246)) ;
    }
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1251)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1251)).isValid ()) {
    uint32_t variant_49545 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1251)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1251)).uintValue () ;
    bool loop_49545 = true ;
    while (loop_49545) {
      loop_49545 = var_t.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1252)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1252)).isValid () ;
      if (loop_49545) {
        loop_49545 = var_t.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1252)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1252)).boolValue () ;
      }
      if (loop_49545 && (0 == variant_49545)) {
        loop_49545 = false ;
...
static void categoryMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_formalInputParameterListForGeneration joker_55658_0 ; // Joker input parameter
  routine_analyzeFunctionBody (var_analysisContext, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 1416)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 1417)), GALGAS_string::makeEmptyString (), object->mAttribute_mFunctionInstructionList, object->mAttribute_mResultVariableName, object->mAttribute_mResultTypeName, object->mAttribute_mEndOfFunctionInstructionList, joker_55658_0, var_returnType, var_resultVariableCppName, var_semanticInstructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1414)) ;
  }
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring joker_56892_0 ; // Joker input parameter
  GALGAS_lstringlist joker_56899_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_56951_0 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_56892_0, joker_56899_0, var_wrapperFileMap, var_wrapperDirectoryMap, joker_56951_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1457)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_filewrapperTemplateListAST enumerator_57587 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
    while (enumerator_57587.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_57587.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1478)).reader_firstCharacterOrNul (SOURCE_FILE ("semanticAnalysis.gSemantics", 1478)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_57587.current_mFilewrapperTemplatePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      cEnumerator_formalTemplateInputParameterListAST enumerator_58400 (enumerator_57587.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
      while (enumerator_58400.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_58400.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1489)) ;
        GALGAS_string var_cppVarName = GALGAS_string ("in_").operator_concat (enumerator_58400.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1490)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1490))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1490)) ;
        {
        var_templateVariableMap.modifier_insertKey (enumerator_58400.current_mFormalArgumentName (HERE), var_type, var_cppVarName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1491)) ;
        }
        var_filewrapperTemplateFormalInputParameters.addAssign_operation (var_type, var_cppVarName, enumerator_58400.current_mFormalArgumentName (HERE), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1492)) ;
        enumerator_58400.gotoNextObject () ;
      }
...
static void categoryMethod_abstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_60945 (object->mAttribute_mAbstractCategoryMethodFormalParameterList, kEnumeration_up) ;
  while (enumerator_60945.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_60945.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_60945.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1546)), enumerator_60945.current_mFormalArgumentName (HERE), enumerator_60945.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1548))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1544)) ;
    enumerator_60945.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1646)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1646)).isValid ()) {
    uint32_t variant_64758 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1646)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1646)).uintValue () ;
    bool loop_64758 = true ;
    while (loop_64758) {
      loop_64758 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1647)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1647)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1647)).isValid () ;
      if (loop_64758) {
        loop_64758 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1647)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1647)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1647)).boolValue () ;
      }
      if (loop_64758 && (0 == variant_64758)) {
        loop_64758 = false ;
      ...
      if (loop_64758) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_65067_0 ; // Joker input parameter
          GALGAS_bool joker_65120_0 ; // Joker input parameter
          GALGAS_string joker_65134_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1650)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_65067_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_65120_0, var_qualifier, joker_65134_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1650)) ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1731)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1731)).isValid ()) {
    uint32_t variant_68243 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1731)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1731)).uintValue () ;
    bool loop_68243 = true ;
    while (loop_68243) {
      loop_68243 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).isValid () ;
      if (loop_68243) {
        loop_68243 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1732)).boolValue () ;
      }
      if (loop_68243 && (0 == variant_68243)) {
        loop_68243 = false ;
      ...
      if (loop_68243) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_68552_0 ; // Joker input parameter
          GALGAS_bool joker_68605_0 ; // Joker input parameter
          GALGAS_string joker_68619_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1735)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_68552_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_68605_0, var_qualifier, joker_68619_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1735)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_70540 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_70540.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_70540.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_70540.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1785)), enumerator_70540.current_mFormalArgumentName (HERE), enumerator_70540.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1787))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1783)) ;
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1883)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1883)).isValid ()) {
    uint32_t variant_74202 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1883)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1883)).uintValue () ;
    bool loop_74202 = true ;
    while (loop_74202) {
      loop_74202 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1884)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1884)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1884)).isValid () ;
      if (loop_74202) {
        loop_74202 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1884)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1884)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1884)).boolValue () ;
      }
      if (loop_74202 && (0 == variant_74202)) {
        loop_74202 = false ;
      ...
      if (loop_74202) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_74503_0 ; // Joker input parameter
          GALGAS_bool joker_74526_0 ; // Joker input parameter
          GALGAS_string joker_74540_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1887)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_74503_0, var_inheritedSignature, joker_74526_0, var_qualifier, joker_74540_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1887)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1965)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1965)).isValid ()) {
    uint32_t variant_77480 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1965)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1965)).uintValue () ;
    bool loop_77480 = true ;
    while (loop_77480) {
      loop_77480 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1966)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1966)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1966)).isValid () ;
      if (loop_77480) {
        loop_77480 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1966)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1966)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1966)).boolValue () ;
      }
      if (loop_77480 && (0 == variant_77480)) {
        loop_77480 = false ;
      ...
      if (loop_77480) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_77781_0 ; // Joker input parameter
          GALGAS_bool joker_77804_0 ; // Joker input parameter
          GALGAS_string joker_77818_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1969)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_77781_0, var_inheritedSignature, joker_77804_0, var_qualifier, joker_77818_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1969)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_79743 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_79743.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_79743.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2018)), enumerator_79743.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2019)), enumerator_79743.current_mFormalArgumentName (HERE), enumerator_79743.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2017)) ;
    enumerator_79743.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2130)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2130)).isValid ()) {
    uint32_t variant_83896 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2130)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2130)).uintValue () ;
    bool loop_83896 = true ;
    while (loop_83896) {
      loop_83896 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2131)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2131)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2131)).isValid () ;
      if (loop_83896) {
        loop_83896 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2131)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2131)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2131)).boolValue () ;
      }
      if (loop_83896 && (0 == variant_83896)) {
        loop_83896 = false ;
      ...
      if (loop_83896) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_84170_0 ; // Joker input parameter
          GALGAS_bool joker_84247_0 ; // Joker input parameter
          GALGAS_string joker_84324_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2133)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_84170_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_84247_0, var_inheritedReturnType, var_qualifier, joker_84324_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2133)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2231)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2231)).isValid ()) {
    uint32_t variant_87811 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2231)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2231)).uintValue () ;
    bool loop_87811 = true ;
    while (loop_87811) {
      loop_87811 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2232)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2232)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2232)).isValid () ;
      if (loop_87811) {
        loop_87811 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2232)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2232)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2232)).boolValue () ;
      }
      if (loop_87811 && (0 == variant_87811)) {
        loop_87811 = false ;
      ...
      if (loop_87811) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_88116_0 ; // Joker input parameter
          GALGAS_bool joker_88193_0 ; // Joker input parameter
          GALGAS_string joker_88252_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2235)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_88116_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_88193_0, var_inheritedReturnType, var_qualifier, joker_88252_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2235)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_formalInputParameterListAST enumerator_88774 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_88774.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_88774.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2259)), enumerator_88774.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2260)), enumerator_88774.current_mFormalArgumentName (HERE), enumerator_88774.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2258)) ;
