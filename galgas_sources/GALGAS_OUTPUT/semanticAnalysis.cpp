...
category_method__abstractCategoryMethodAST__performSemanticAnalysis (C_CompilerEx & inLexique,
  ...
  if (operand_44176 != NULL) {
    ...
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_abstractCategoryMethodForGeneration ::constructor_new (inLexique, operand_44176->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1107)), operand_44176->mAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1108)), var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1106)), GGS_string ("~")) ;
  }
}
...
category_method__categoryMethodAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodAST * operand_45730,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45730 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_45730->mTypeName COMMA_SOURCE_FILE_AT_LINE (1123)) ;
    const GGS_bool cond_46240 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1125))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1125))) ;
    if (cond_46240.isBuiltAndTrue ()) {
      operand_45730->mCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1127)) ;
    }
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ...
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_45730->mCategoryMethodFormalParameterList,  GGS_localConstantList ::constructor_emptyList (),  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)),  GGS_string ("object->"),  operand_45730->mCategoryMethodInstructionList,  operand_45730->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1137)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_categoryMethodForGeneration ::constructor_new (inLexique, operand_45730->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)), operand_45730->mCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1151)), var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1153)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1149)), GGS_string ("~")) ;
  }
}
...
category_method__overridingCategoryMethodAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_overridingCategoryMethodAST * operand_47375,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47375 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_47375->mTypeName COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    const GGS_bool cond_47895 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1170))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1170))) ;
    if (cond_47895.isBuiltAndTrue ()) {
      operand_47375->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1171)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    }
    ...
    GGS_uint _variant_48689 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1178)) ;
    GGS_bool _condition_48689 (_variant_48689.isBuilt (), true) ;
    while (_condition_48689.isBuiltAndTrue ()) {
      _condition_48689 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1179))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_48689.isBuiltAndTrue ()) {
        if (_variant_48689.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1188)) ;
          _condition_48689 = GGS_bool (false) ;
        }else{
          _variant_48689.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_48636 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1180)).reader_hasKey (operand_47375->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1180))) ;
          if (cond_48636.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_48510_0 ;
            GGS_bool automatic_var_48510_1 ;
            const GGS_instanceMethodMap  temp_48411 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1182)) ;
            if (temp_48411.isBuilt ()) {
              temp_48411 (HERE)->method_searchKey (inLexique, operand_47375->mOverridingCategoryMethodName, automatic_var_48510_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_48510_1, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1182)) ;
            }
            const GGS_bool cond_48623 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1183))) ;
            if (cond_48623.isBuiltAndTrue ()) {
    ...
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_selfType, GGS_string ("object")) ;
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_47375->mOverridingCategoryMethodFormalParameterList,  GGS_localConstantList ::constructor_emptyList (),  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1202)),  GGS_string ("object->"),  operand_47375->mOverridingCategoryMethodInstructionList,  operand_47375->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    const GGS_bool cond_49591 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_49591.isBuiltAndTrue ()) {
      ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_47375->mOverridingCategoryMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1213)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_overridingCategoryMethodForGeneration ::constructor_new (inLexique, operand_47375->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1220)), var_cas_baseTypeName, operand_47375->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1222)), var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1224)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1219)), GGS_string ("~")) ;
  }
}
...
category_method__overridingAbstractCategoryMethodAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_overridingAbstractCategoryMethodAST * operand_50135,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & /* var_cas_ioSemanticDeclarationListForGeneration */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50135 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_50135->mTypeName COMMA_SOURCE_FILE_AT_LINE (1239)) ;
    const GGS_bool cond_50676 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1241))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1241))) ;
    if (cond_50676.isBuiltAndTrue ()) {
      operand_50135->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1242)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1243)) ;
    }else if (cond_50676.isBuiltAndFalse ()) {
      const GGS_bool cond_50850 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1243)) ;
      if (cond_50850.isBuiltAndTrue ()) {
    ...
    GGS_formalParameterSignature  var_cas_inheritedSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_51644 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1251)) ;
    GGS_bool _condition_51644 (_variant_51644.isBuilt (), true) ;
    while (_condition_51644.isBuiltAndTrue ()) {
      _condition_51644 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1252))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_51644.isBuiltAndTrue ()) {
        if (_variant_51644.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1261)) ;
          _condition_51644 = GGS_bool (false) ;
        }else{
          _variant_51644.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_51591 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1253)).reader_hasKey (operand_50135->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1253))) ;
          if (cond_51591.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_51465_0 ;
            GGS_bool automatic_var_51465_1 ;
            const GGS_instanceMethodMap  temp_51366 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1255)) ;
            if (temp_51366.isBuilt ()) {
              temp_51366 (HERE)->method_searchKey (inLexique, operand_50135->mOverridingCategoryMethodName, automatic_var_51465_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_51465_1, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1255)) ;
            }
            const GGS_bool cond_51578 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1256))) ;
            if (cond_51578.isBuiltAndTrue ()) {
    ...
    ::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  operand_50135->mOverridingCategoryMethodFormalParameterList,  var_cas_variableMap,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1265)) ;
    const GGS_bool cond_52203 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_52203.isBuiltAndTrue ()) {
      ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_50135->mOverridingCategoryMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1275)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1273)) ;
    }
  }
}
...
category_method__abstractCategoryReaderAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderAST * operand_52368,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52368 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_52368->mTypeName COMMA_SOURCE_FILE_AT_LINE (1290)) ;
    const GGS_bool cond_52905 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1292))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1292))) ;
    if (cond_52905.isBuiltAndTrue ()) {
    ...
    }else if (cond_52905.isBuiltAndFalse ()) {
      const GGS_bool cond_53077 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)) ;
      if (cond_53077.isBuiltAndTrue ()) {
    ...
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_53258 (operand_52368->mAbstractCategoryReaderFormalInputParameterList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_53258 = NULL ;
      while (((operand_53258 = enumerator_53258.nextObject ()))) {
        macroValidPointer (operand_53258) ;
        var_cas_formalParameterListForGeneration.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_53258->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1301)), operand_53258->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1302)), operand_53258->mFormalArgumentName, operand_53258->mIsUnused) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_abstractCategoryReaderForGeneration ::constructor_new (inLexique, operand_52368->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1309)), operand_52368->mAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1310)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_52368->mAbstractCategoryReaderReturnedTypeName COMMA_SOURCE_FILE_AT_LINE (1311)), var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1308)), GGS_string ("~")) ;
  }
}
...
category_method__categoryReaderAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderAST * operand_54024,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54024 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_54024->mTypeName COMMA_SOURCE_FILE_AT_LINE (1328)) ;
    const GGS_bool cond_54535 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1330))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1330))) ;
    if (cond_54535.isBuiltAndTrue ()) {
      operand_54024->mCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1332)) ;
    }
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_selfType, GGS_string ("object")) ;
    GGS_unifiedTypeMapProxy  var_cas_returnType ;
    ...
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  operand_54024->mCategoryReaderFormalInputParameterList,  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)),  GGS_string ("object->"),  operand_54024->mCategoryReaderInstructionList,  operand_54024->mCategoryReaderReturnedVariableName,  operand_54024->mCategoryReaderReturnedTypeName,  operand_54024->mEndOfReaderLocation,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  var_cas_returnVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1344)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_categoryReaderForGeneration ::constructor_new (inLexique, operand_54024->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)), operand_54024->mCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1361)), var_cas_returnType, var_cas_returnVariableCppName, var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1365)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1359)), GGS_string ("~")) ;
  }
}
...
category_method__overridingCategoryReaderAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_overridingCategoryReaderAST * operand_55867,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55867 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_55867->mTypeName COMMA_SOURCE_FILE_AT_LINE (1380)) ;
    const GGS_bool cond_56387 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1382))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1382))) ;
    if (cond_56387.isBuiltAndTrue ()) {
      operand_55867->mOverridingCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1383)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1384)) ;
    }
    GGS_string var_cas_baseTypeName = GGS_string ("") ;
    ...
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_57237 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1391)) ;
    GGS_bool _condition_57237 (_variant_57237.isBuilt (), true) ;
    while (_condition_57237.isBuiltAndTrue ()) {
      _condition_57237 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1392))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_57237.isBuiltAndTrue ()) {
        if (_variant_57237.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1401)) ;
          _condition_57237 = GGS_bool (false) ;
        }else{
          _variant_57237.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_57184 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1393)).reader_hasKey (operand_55867->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1393))) ;
          if (cond_57184.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_57058_0 ;
            GGS_bool automatic_var_57058_1 ;
            const GGS_readerMap  temp_56938 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1395)) ;
            if (temp_56938.isBuilt ()) {
              temp_56938 (HERE)->method_searchKey (inLexique, operand_55867->mOverridingCategoryReaderName, automatic_var_57058_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_57058_1, var_cas_inheritedReturnType, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1395)) ;
            }
            const GGS_bool cond_57171 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1396))) ;
            if (cond_57171.isBuiltAndTrue ()) {
    ...
    GGS_formalInputParameterListForGeneration  var_cas_formalParameterListForGeneration ;
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  operand_55867->mOverridingCategoryReaderFormalInputParameterList,  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)),  GGS_string ("object->"),  operand_55867->mOverridingCategoryReaderInstructionList,  operand_55867->mOverridingCategoryReaderReturnedVariableName,  operand_55867->mOverridingCategoryReaderReturnedTypeName,  operand_55867->mEndOfReaderLocation,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  var_cas_returnVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    const GGS_bool cond_58358 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_58358.isBuiltAndTrue ()) {
      ::routine_checkReaderSignatures (inLexique,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  operand_55867->mOverridingCategoryReaderName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)),  var_cas_inheritedSignature,  var_cas_inheritedReturnType,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1429)) ;
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_overrideCategoryReaderForGeneration ::constructor_new (inLexique, operand_55867->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1440)), var_cas_baseTypeName, operand_55867->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)), var_cas_returnType, var_cas_returnVariableCppName, var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1446)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1439)), GGS_string ("~")) ;
  }
}
...
category_method__overridingAbstractCategoryReaderAST__performSemanticAnalysis (C_CompilerEx & inLexique,
                                const cPtr_overridingAbstractCategoryReaderAST * operand_58943,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & /* var_cas_ioSemanticDeclarationListForGeneration */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58943 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_58943->mTypeName COMMA_SOURCE_FILE_AT_LINE (1461)) ;
    const GGS_unifiedTypeMapProxy  var_cas_returnType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_58943->mAbstractCategoryReaderReturnedTypeName COMMA_SOURCE_FILE_AT_LINE (1463)) ;
    const GGS_bool cond_59647 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1465))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1465))) ;
    if (cond_59647.isBuiltAndTrue ()) {
      operand_58943->mAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1466)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1467)) ;
    }else if (cond_59647.isBuiltAndFalse ()) {
      const GGS_bool cond_59819 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1467)) ;
      if (cond_59819.isBuiltAndTrue ()) {
        operand_58943->mAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare an abstract category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1468)))).operator_concat (GGS_string ("' is not an abstract class")) COMMA_SOURCE_FILE_AT_LINE (1469)) ;
      }
    }
    GGS_string var_cas_baseTypeName = GGS_string ("") ;
    ...
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_60665 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1476)) ;
    GGS_bool _condition_60665 (_variant_60665.isBuilt (), true) ;
    while (_condition_60665.isBuiltAndTrue ()) {
      _condition_60665 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1477))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_60665.isBuiltAndTrue ()) {
        if (_variant_60665.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1486)) ;
          _condition_60665 = GGS_bool (false) ;
        }else{
          _variant_60665.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_60612 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1478)).reader_hasKey (operand_58943->mAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1478))) ;
          if (cond_60612.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_60486_0 ;
            GGS_bool automatic_var_60486_1 ;
            const GGS_readerMap  temp_60368 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1480)) ;
            if (temp_60368.isBuilt ()) {
              temp_60368 (HERE)->method_searchKey (inLexique, operand_58943->mAbstractCategoryReaderName, automatic_var_60486_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_60486_1, var_cas_inheritedReturnType, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1480)) ;
            }
            const GGS_bool cond_60599 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1481))) ;
            if (cond_60599.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_61356 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_61356.isBuiltAndTrue ()) {
      GGS_formalInputParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalInputParameterListForGeneration ::constructor_emptyList () ;
      {
        GGS_formalInputParameterListAST::cEnumerator enumerator_60872 (operand_58943->mAbstractCategoryReaderFormalInputParameterList, true) ;
        const GGS_formalInputParameterListAST::cElement * operand_60872 = NULL ;
        while (((operand_60872 = enumerator_60872.nextObject ()))) {
          macroValidPointer (operand_60872) ;
          var_cas_formalParameterListForGeneration.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_60872->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1492)), operand_60872->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1493)), operand_60872->mFormalArgumentName, operand_60872->mIsUnused) ;
        }
      }
      ::routine_checkReaderSignatures (inLexique,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  operand_58943->mAbstractCategoryReaderName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1501)),  var_cas_inheritedSignature,  var_cas_inheritedReturnType,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1498)) ;
    }
  }
}
...
void routine_performSemanticAnalysis (C_CompilerEx & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_64450 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_64450 = NULL ;
    while (((operand_64450 = enumerator_64450.nextObject ()))) {
      macroValidPointer (operand_64450) ;
      { typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (operand_64450->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_64450->mSemanticDeclaration (HERE), var_cas_inSemanticContext, var_cas_predefinedTypes, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (1554)) ;
        }
      }
    }
  }
