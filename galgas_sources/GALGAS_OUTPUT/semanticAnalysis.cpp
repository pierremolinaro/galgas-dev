  ...
  if (operand_14185 != NULL) {
    ...
    GGS_insertMethodMap  var_cas_insertMethodMap = GGS_insertMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (344)) ;
    {
      ...
      while (((operand_14832 = enumerator_14832.nextObject ()))) {
        ...
        {
          GGS_stringlist::cEnumerator enumerator_14962 (operand_14832->mErrorMessage.ggs_string ().reader_componentsSeparatedByString (GGS_string ("%%")), true) ;
          ...
          while (((operand_14962 = enumerator_14962.nextObject ()))) {
            ...
            GGS_string automatic_var_15128_0 ;
            var_cas_explodedArray.modifier_popFirst (inLexique, automatic_var_15128_0 COMMA_SOURCE_FILE_AT_LINE (350)) ;
            {
              GGS_stringlist::cEnumerator enumerator_15158 (var_cas_explodedArray, true) ;
              const GGS_stringlist::cElement * operand_15158 = NULL ;
              while (((operand_15158 = enumerator_15158.nextObject ()))) {
                macroValidPointer (operand_15158) ;
                const GGS_bool cond_15446 = (operand_15158->mValue.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_15446.isBuiltAndTrue ()) {
                  const GGS_char var_cas_c = operand_15158->mValue.reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (353)) ;
                  const GGS_bool cond_15429 = ((var_cas_c).operator_isNotEqual (GGS_char (TO_UNICODE ('K')))).operator_and ((var_cas_c).operator_isNotEqual (GGS_char (TO_UNICODE ('L')))) ;
                  if (cond_15429.isBuiltAndTrue ()) {
        ...
        {
          GGS_stringlist::cEnumerator enumerator_15574 (operand_14832->mShadowErrorMessage.ggs_string ().reader_componentsSeparatedByString (GGS_string ("%%")), true) ;
          const GGS_stringlist::cElement * operand_15574 = NULL ;
          while (((operand_15574 = enumerator_15574.nextObject ()))) {
            macroValidPointer (operand_15574) ;
            GGS_stringlist  var_cas_explodedArray = operand_15574->mValue.reader_componentsSeparatedByString (GGS_string ("%")) ;
            GGS_string automatic_var_15746_0 ;
            var_cas_explodedArray.modifier_popFirst (inLexique, automatic_var_15746_0 COMMA_SOURCE_FILE_AT_LINE (363)) ;
            {
              GGS_stringlist::cEnumerator enumerator_15776 (var_cas_explodedArray, true) ;
              const GGS_stringlist::cElement * operand_15776 = NULL ;
              while (((operand_15776 = enumerator_15776.nextObject ()))) {
                macroValidPointer (operand_15776) ;
                const GGS_bool cond_16063 = (operand_15776->mValue.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_16063.isBuiltAndTrue ()) {
                  const GGS_char var_cas_c = operand_15776->mValue.reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (366)) ;
                  const GGS_bool cond_16046 = ((var_cas_c).operator_isNotEqual (GGS_char (TO_UNICODE ('K')))).operator_and ((var_cas_c).operator_isNotEqual (GGS_char (TO_UNICODE ('L')))) ;
                  if (cond_16046.isBuiltAndTrue ()) {
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_16224 (operand_14185->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_16224 = NULL ;
      while (((operand_16224 = enumerator_16224.nextObject ()))) {
        macroValidPointer (operand_16224) ;
        var_cas_searchMethodMap.modifier_insertKey (inLexique, operand_16224->mMethodName COMMA_SOURCE_FILE_AT_LINE (377)) ;
        {
          GGS_stringlist::cEnumerator enumerator_16350 (operand_16224->mErrorMessage.ggs_string ().reader_componentsSeparatedByString (GGS_string ("%%")), true) ;
          const GGS_stringlist::cElement * operand_16350 = NULL ;
          while (((operand_16350 = enumerator_16350.nextObject ()))) {
            macroValidPointer (operand_16350) ;
            GGS_stringlist  var_cas_explodedArray = operand_16350->mValue.reader_componentsSeparatedByString (GGS_string ("%")) ;
            GGS_string automatic_var_16516_0 ;
            var_cas_explodedArray.modifier_popFirst (inLexique, automatic_var_16516_0 COMMA_SOURCE_FILE_AT_LINE (381)) ;
            {
              GGS_stringlist::cEnumerator enumerator_16546 (var_cas_explodedArray, true) ;
              const GGS_stringlist::cElement * operand_16546 = NULL ;
              while (((operand_16546 = enumerator_16546.nextObject ()))) {
                macroValidPointer (operand_16546) ;
                const GGS_bool cond_16812 = (operand_16546->mValue.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_16812.isBuiltAndTrue ()) {
                  const GGS_char var_cas_c = operand_16546->mValue.reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (384)) ;
                  const GGS_bool cond_16795 = (var_cas_c).operator_isNotEqual (GGS_char (TO_UNICODE ('K'))) ;
                  if (cond_16795.isBuiltAndTrue ()) {
                    operand_16224->mErrorMessage.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only '%K' and '%%' escape sequences are allowed in a search error message") COMMA_SOURCE_FILE_AT_LINE (387)) ;
                  }
                }
              }
            }
    ...
    {
      GGS_mapRemoveMethodListAST::cEnumerator enumerator_16925 (operand_14185->mRemoveMethodList, true) ;
      const GGS_mapRemoveMethodListAST::cElement * operand_16925 = NULL ;
      while (((operand_16925 = enumerator_16925.nextObject ()))) {
        macroValidPointer (operand_16925) ;
        var_cas_insertMethodMap.modifier_insertKey (inLexique, operand_16925->mMethodName COMMA_SOURCE_FILE_AT_LINE (394)) ;
        {
          GGS_stringlist::cEnumerator enumerator_17051 (operand_16925->mErrorMessage.ggs_string ().reader_componentsSeparatedByString (GGS_string ("%%")), true) ;
          const GGS_stringlist::cElement * operand_17051 = NULL ;
          while (((operand_17051 = enumerator_17051.nextObject ()))) {
            macroValidPointer (operand_17051) ;
            GGS_stringlist  var_cas_explodedArray = operand_17051->mValue.reader_componentsSeparatedByString (GGS_string ("%")) ;
            GGS_string automatic_var_17217_0 ;
            var_cas_explodedArray.modifier_popFirst (inLexique, automatic_var_17217_0 COMMA_SOURCE_FILE_AT_LINE (398)) ;
            {
              GGS_stringlist::cEnumerator enumerator_17247 (var_cas_explodedArray, true) ;
              const GGS_stringlist::cElement * operand_17247 = NULL ;
              while (((operand_17247 = enumerator_17247.nextObject ()))) {
                macroValidPointer (operand_17247) ;
                const GGS_bool cond_17513 = (operand_17247->mValue.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
                if (cond_17513.isBuiltAndTrue ()) {
                  const GGS_char var_cas_c = operand_17247->mValue.reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (401)) ;
                  const GGS_bool cond_17496 = (var_cas_c).operator_isNotEqual (GGS_char (TO_UNICODE ('K'))) ;
                  if (cond_17496.isBuiltAndTrue ()) {
                    operand_16925->mErrorMessage.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only '%K' and '%%' escape sequences are allowed in a remove error message") COMMA_SOURCE_FILE_AT_LINE (404)) ;
                  }
                }
              }
            }
    ...
    }
    {
      ...
      GGS_insertOrReplaceDeclarationListAST::cEnumerator enumerator_17685 (operand_14185->mInsertOrReplaceDeclarationListAST, true) ;
      const GGS_insertOrReplaceDeclarationListAST::cElement * operand_17685 = NULL ;
      while (((operand_17685 = enumerator_17685.nextObject ()))) {
        macroValidPointer (operand_17685) ;
        const GGS_bool cond_17832 = (var_cas_IDX).operator_strictSup (GGS_uint (0U)) ;
        if (cond_17832.isBuiltAndTrue ()) {
          operand_17685->mInsertOrReplaceDeclarationLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("the 'insertOrReplace' modifier is already declared") COMMA_SOURCE_FILE_AT_LINE (412)) ;
        }
        var_cas_IDX.mValue ++ ;
      }
    }
    ...
    const GGS_bool cond_18347 = (var_cas_hasInsertOrReplaceModifier).operator_and (var_cas_insertMethodMap.reader_hasKey (GGS_string ("insertOrReplace"))) ;
    if (cond_18347.isBuiltAndTrue ()) {
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_18554 (operand_14185->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_18554 = NULL ;
      while (((operand_18554 = enumerator_18554.nextObject ()))) {
        macroValidPointer (operand_18554) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_18554->mMethodName, var_cas_inPredefinedTypes.mLStringType COMMA_SOURCE_FILE_AT_LINE (425)) ;
      }
    }
...
category_method__mapProxyDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_19187,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19187 != NULL) {
    GGS_typedAttributeList  var_cas_listTypeAttributeList ;
    GGS_mapSearchMethodListAST  var_cas_searchMethodList ;
    GGS_bool automatic_var_19614_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_19614_1 ;
    GGS_typeKindEnum automatic_var_19614_2 ;
    GGS_typedAttributeList  automatic_var_19614_3 ;
    GGS_attributeMap  automatic_var_19614_4 ;
    GGS_constructorMap  automatic_var_19614_5 ;
    GGS_readerMap  automatic_var_19614_6 ;
    GGS_modifierMap  automatic_var_19614_7 ;
    GGS_instanceMethodMap  automatic_var_19614_8 ;
    GGS_classMethodMap  automatic_var_19614_9 ;
    GGS_enumerationDescriptorList  automatic_var_19614_10 ;
    GGS_uint  automatic_var_19614_11 ;
    GGS_unifiedTypeMapProxyList  automatic_var_19614_12 ;
    GGS_nativeAttributeList  automatic_var_19614_13 ;
    GGS_stringset  automatic_var_19614_14 ;
    GGS_lstringlist  automatic_var_19614_15 ;
    GGS_typedAttributeList  automatic_var_19614_16 ;
    GGS_mapSearchMethodListAST  automatic_var_19614_17 ;
    GGS_withAccessorMap  automatic_var_19614_18 ;
    if (var_cas_inSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_inSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_19187->mAssociatedMapTypeName, automatic_var_19614_0, automatic_var_19614_1, automatic_var_19614_2, automatic_var_19614_3, automatic_var_19614_4, var_cas_listTypeAttributeList, automatic_var_19614_5, automatic_var_19614_6, automatic_var_19614_7, automatic_var_19614_8, automatic_var_19614_9, automatic_var_19614_10, automatic_var_19614_11, automatic_var_19614_12, automatic_var_19614_13, automatic_var_19614_14, automatic_var_19614_15, automatic_var_19614_16, var_cas_searchMethodList, automatic_var_19614_17, automatic_var_19614_18 COMMA_SOURCE_FILE_AT_LINE (455)) ;
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_mapProxyTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_19187->mMapProxyTypeName COMMA_SOURCE_FILE_AT_LINE (458)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_19187->mAssociatedMapTypeName COMMA_SOURCE_FILE_AT_LINE (459)), var_cas_listTypeAttributeList, var_cas_searchMethodList COMMA_SOURCE_FILE_AT_LINE (457)), GGS_string ("")) ;
  }
}
...
void routine_buildLocalVariableMapAndSignature (C_Compiler & inLexique,
  ...
  {
    GGS_formalParameterListAST::cEnumerator enumerator_20631 (var_cas_inRoutineSignatureAST, true) ;
    const GGS_formalParameterListAST::cElement * operand_20631 = NULL ;
    while (((operand_20631 = enumerator_20631.nextObject ()))) {
      macroValidPointer (operand_20631) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_20631->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (483)) ;
      GGS_string var_cas_formalArgumentCppName ;
      switch (operand_20631->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentIn:
        {
        var_cas_formalArgumentCppName = (GGS_string ("inArgument_")).operator_concat (operand_20631->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        const GGS_bool cond_21108 = operand_20631->mIsUnused ;
        if (cond_21108.isBuiltAndTrue ()) {
          var_cas_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (489)) ;
        }else if (cond_21108.isBuiltAndFalse ()) {
          var_cas_ioVariableMap.modifier_insertInputFormalArgument (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (491)) ;
        }
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_formalArgumentCppName = (GGS_string ("outArgument_")).operator_concat (operand_20631->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_ioVariableMap.modifier_insertOutputFormalArgument (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (495)) ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
        {
        var_cas_formalArgumentCppName = (GGS_string ("ioArgument_")).operator_concat (operand_20631->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        const GGS_bool cond_21801 = operand_20631->mIsUnused ;
        if (cond_21801.isBuiltAndTrue ()) {
          var_cas_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (499)) ;
        }else if (cond_21801.isBuiltAndFalse ()) {
          var_cas_ioVariableMap.modifier_insertInputOutputFormalArgument (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (501)) ;
        }
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
        {
        var_cas_formalArgumentCppName = (GGS_string ("constinArgument_")).operator_concat (operand_20631->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        const GGS_bool cond_22266 = operand_20631->mIsUnused ;
        if (cond_22266.isBuiltAndTrue ()) {
          var_cas_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (506)) ;
        }else if (cond_22266.isBuiltAndFalse ()) {
          var_cas_ioVariableMap.modifier_insertConstantInputFormalArgument (inLexique, operand_20631->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (508)) ;
        }
        }
        break ;
      ...
      var_cas_outRoutineSignature.addAssign_operation (operand_20631->mFormalArgumentPassingMode, var_cas_type, operand_20631->mFormalArgumentName, var_cas_formalArgumentCppName) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_analyzeRoutineBody (C_Compiler & inLexique,
  ...
  {
    GGS_localConstantList::cEnumerator enumerator_23221 (var_cas_inLocalConstantList, true) ;
    const GGS_localConstantList::cElement * operand_23221 = NULL ;
    while (((operand_23221 = enumerator_23221.nextObject ()))) {
      macroValidPointer (operand_23221) ;
      const GGS_bool cond_23353 = operand_23221->mNoWarningIfUnused ;
      if (cond_23353.isBuiltAndTrue ()) {
        var_cas_variableMap.modifier_insertUsedLocalConstant (inLexique, operand_23221->mName, operand_23221->mType, operand_23221->mCppName, function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (532)) COMMA_SOURCE_FILE_AT_LINE (532)) ;
      }else if (cond_23353.isBuiltAndFalse ()) {
        var_cas_variableMap.modifier_insertLocalConstant (inLexique, operand_23221->mName, operand_23221->mType, operand_23221->mCppName, function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (534)) ;
      }
    }
  }
  {
    GGS_typedAttributeList::cEnumerator enumerator_23529 (var_cas_inTypedAttributeList, true) ;
    const GGS_typedAttributeList::cElement * operand_23529 = NULL ;
    while (((operand_23529 = enumerator_23529.nextObject ()))) {
      macroValidPointer (operand_23529) ;
      var_cas_variableMap.modifier_insertNonMutableAttribute (inLexique, operand_23529->mAttributeName, operand_23529->mAttributeTypeIndex, ((var_cas_inAttributeVariableNamePrefix).operator_concat (GGS_string ("mAttribute_"))).operator_concat (operand_23529->mAttributeName.ggs_string ().reader_identifierRepresentation ()), function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (543)) COMMA_SOURCE_FILE_AT_LINE (539)) ;
    }
  }
  ...
  {
    GGS_semanticInstructionListAST::cEnumerator enumerator_24104 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListAST::cElement * operand_24104 = NULL ;
    while (((operand_24104 = enumerator_24104.nextObject ()))) {
      macroValidPointer (operand_24104) ;
      { typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (operand_24104->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_24104->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_outSemanticInstructionListForGeneration, var_cas_variableMap COMMA_SOURCE_FILE_AT_LINE (556)) ;
        }
      }
    }
  }
...
category_method__externFunctionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_24501,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24501 != NULL) {
    ...
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_24779 (operand_24501->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_24779 = NULL ;
      while (((operand_24779 = enumerator_24779.nextObject ()))) {
        macroValidPointer (operand_24779) ;
        var_cas_formalArgumentList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_24779->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (576)), operand_24779->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (577)), operand_24779->mFormalArgumentName, operand_24779->mIsUnused) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_functionPrototypeDeclarationForGeneration ::constructor_new (inLexique, operand_24501->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), var_cas_formalArgumentList, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_24501->mResultTypeName COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_SOURCE_FILE_AT_LINE (582)), GGS_string ("")) ;
  }
}
...
category_method__externRoutineDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_25409,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25409 != NULL) {
    ...
    {
      GGS_formalParameterListAST::cEnumerator enumerator_25682 (operand_25409->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_25682 = NULL ;
      while (((operand_25682 = enumerator_25682.nextObject ()))) {
        macroValidPointer (operand_25682) ;
        var_cas_formalArgumentList.addAssign_operation (operand_25682->mFormalArgumentPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_25682->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (602)), operand_25682->mFormalArgumentName, operand_25682->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (604))) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_routinePrototypeDeclarationForGeneration ::constructor_new (inLexique, operand_25409->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (608)), var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (607)), GGS_string ("")) ;
  }
}
...
category_method__routineDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_routineDeclarationAST * operand_26237,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26237 != NULL) {
    GGS_formalParameterListForGeneration  var_cas_formalArgumentList = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    ...
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_26237->mFormalArgumentList,  GGS_localConstantList ::constructor_emptyList (),  GGS_typedAttributeList ::constructor_emptyList (),  GGS_string (""),  operand_26237->mRoutineInstructionList,  operand_26237->mEndOfRoutineInstructionList,  var_cas_instructionList,  var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (631)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_routineImplementationForGeneration ::constructor_new (inLexique, operand_26237->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (644)), var_cas_formalArgumentList, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (643)), GGS_string ("")) ;
  }
}
...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_27283,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27283 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_27283->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (660)) ;
    ...
    const GGS_bool cond_27965 = (operand_27283->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (665))).operator_isEqual (GGS_string ("")) ;
    if (cond_27965.isBuiltAndTrue ()) {
    ...
    }else if (cond_27965.isBuiltAndFalse ()) {
      var_cas_superClassProxy = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_27283->mSuperClassName COMMA_SOURCE_FILE_AT_LINE (670)) ;
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_28372 (operand_27283->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_28372 = NULL ;
      while (((operand_28372 = enumerator_28372.nextObject ()))) {
        macroValidPointer (operand_28372) ;
        GGS_unifiedTypeMapProxy  var_cas_t = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_28372->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (678)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_t, operand_28372->mAttributeName) ;
        var_cas_allAttributeList.addAssign_operation (var_cas_t, operand_28372->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_28372->mAttributeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (687)) ;
      }
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_28788 (operand_27283->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_28788 = NULL ;
      while (((operand_28788 = enumerator_28788.nextObject ()))) {
        macroValidPointer (operand_28788) ;
        var_cas_classMethodMap.modifier_insertKey (inLexique, operand_28788->mMethodName COMMA_SOURCE_FILE_AT_LINE (692)) ;
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_28876 (operand_27283->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_28876 = NULL ;
      while (((operand_28876 = enumerator_28876.nextObject ()))) {
        macroValidPointer (operand_28876) ;
        var_cas_classMethodMap.modifier_insertKey (inLexique, operand_28876->mMethodName COMMA_SOURCE_FILE_AT_LINE (695)) ;
      }
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_29075 (operand_27283->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_29075 = NULL ;
      while (((operand_29075 = enumerator_29075.nextObject ()))) {
        macroValidPointer (operand_29075) ;
        const GGS_bool cond_29261 = (operand_27283->mIsAbstract).operator_not () ;
        if (cond_29261.isBuiltAndTrue ()) {
          operand_29075->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a concrete class cannot declare an abstract method") COMMA_SOURCE_FILE_AT_LINE (703)) ;
        }
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_29406 (operand_29075->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_29406 = NULL ;
          while (((operand_29406 = enumerator_29406.nextObject ()))) {
            macroValidPointer (operand_29406) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_29406->mFormalArgumentPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_29406->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (709)), operand_29406->mFormalArgumentName, operand_29406->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (711))) ;
          }
        }
        const GGS_bool cond_30145 = operand_29075->mIsOverriding ;
        if (cond_30145.isBuiltAndTrue ()) {
          ...
          GGS_bool automatic_var_29957_0 ;
          GGS_bool automatic_var_29957_1 ;
          GGS_methodQualifier automatic_var_29957_2 ;
          if (var_cas_inheritedInstanceMethodMap.isBuilt ()) {
            var_cas_inheritedInstanceMethodMap (HERE)->method_searchInheritedKey (inLexique, operand_29075->mMethodName, automatic_var_29957_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_29957_1, automatic_var_29957_2 COMMA_SOURCE_FILE_AT_LINE (718)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_29075->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (721)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (719)) ;
        }else if (cond_30145.isBuiltAndFalse ()) {
          const GGS_bool cond_30328 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_29075->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (725))) ;
          if (cond_30328.isBuiltAndTrue ()) {
            operand_29075->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (727)) ;
          }
        }
        var_cas_abstractMethodList.addAssign_operation (operand_29075->mIsOverriding, operand_29075->mMethodName, var_cas_formalParameterListForGeneration) ;
      }
    }
    ...
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_30706 (operand_27283->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_30706 = NULL ;
      while (((operand_30706 = enumerator_30706.nextObject ()))) {
        ...
        ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_30706->mSignature,  GGS_localConstantList ::constructor_emptyList (),  var_cas_allAttributeList,  GGS_string (""),  operand_30706->mInstructionList,  operand_30706->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (743)) ;
        const GGS_bool cond_31845 = operand_30706->mIsOverriding ;
        if (cond_31845.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool var_cas_inheritedIsCategory ;
          GGS_bool automatic_var_31493_0 ;
          GGS_methodQualifier automatic_var_31493_1 ;
          if (var_cas_inheritedInstanceMethodMap.isBuilt ()) {
            var_cas_inheritedInstanceMethodMap (HERE)->method_searchInheritedKey (inLexique, operand_30706->mMethodName, var_cas_inheritedIsCategory, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_31493_0, automatic_var_31493_1 COMMA_SOURCE_FILE_AT_LINE (759)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_30706->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (762)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (760)) ;
          const GGS_bool cond_31830 = var_cas_inheritedIsCategory ;
          if (cond_31830.isBuiltAndTrue ()) {
            operand_30706->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method is declared in class, but overriden method is declared as multi-method") COMMA_SOURCE_FILE_AT_LINE (768)) ;
          }
        }else if (cond_31845.isBuiltAndFalse ()) {
          const GGS_bool cond_32034 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_30706->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (769))) ;
          if (cond_32034.isBuiltAndTrue ()) {
            operand_30706->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method should be declared as overridding, as it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (771)) ;
          }
        }
        var_cas_definedMethodSet.addAssign_operation (operand_30706->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (773))) ;
        var_cas_methodList.addAssign_operation (operand_30706->mIsOverriding, operand_30706->mMethodName, var_cas_formalParameterListForGeneration, var_cas_semanticInstructionListForGeneration) ;
      }
    }
    const GGS_bool cond_32779 = (operand_27283->mIsAbstract).operator_not () ;
    if (cond_32779.isBuiltAndTrue ()) {
      {
        GGS_instanceMethodMap::cEnumerator enumerator_32377 (var_cas_inheritedInstanceMethodMap, true) ;
        const GGS_instanceMethodMap::cElement * operand_32377 = NULL ;
        while (((operand_32377 = enumerator_32377.nextObject ()))) {
          macroValidPointer (operand_32377) ;
          const GGS_bool cond_32750 = ((operand_32377->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (784)))).operator_or ((operand_32377->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (784)))) ;
          if (cond_32750.isBuiltAndTrue ()) {
            const GGS_bool cond_32731 = (var_cas_definedMethodSet.reader_hasKey (operand_32377->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (785)))).operator_not () ;
            if (cond_32731.isBuiltAndTrue ()) {
              operand_32377->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_27283->mClassTypeName)).operator_concat (GGS_string ("' class is declared concrete, but the '"))).operator_concat (operand_32377->mKey)).operator_concat (GGS_string ("' method declared in a super class is not implemented")) COMMA_SOURCE_FILE_AT_LINE (787)) ;
            }
          }
        }
      }
    ...
    GGS_uint _variant_33093 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (794)) ;
    GGS_bool _condition_33093 (_variant_33093.isBuilt (), true) ;
    while (_condition_33093.isBuiltAndTrue ()) {
      _condition_33093 = (var_cas_t.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (795))).operator_not () ;
      if (_condition_33093.isBuiltAndTrue ()) {
        if (_variant_33093.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (798)) ;
          _condition_33093 = GGS_bool (false) ;
        }else{
          _variant_33093.decrement_operation (inLexique COMMA_HERE) ;
    ...
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_27283->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (801)), operand_27283->mIsAbstract, operand_27283->mClassTypeName, var_cas_superClassProxy, var_cas_allAttributeList, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList, var_cas_selfType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (800)), var_cas_sortString) ;
  }
}
...
void routine_analyzeFunctionBody (C_Compiler & inLexique,
  ...
  {
    GGS_typedAttributeList::cEnumerator enumerator_34247 (var_cas_inTypedAttributeList, true) ;
    const GGS_typedAttributeList::cElement * operand_34247 = NULL ;
    while (((operand_34247 = enumerator_34247.nextObject ()))) {
      macroValidPointer (operand_34247) ;
      var_cas_variableMap.modifier_insertNonMutableAttribute (inLexique, operand_34247->mAttributeName, operand_34247->mAttributeTypeIndex, ((var_cas_inAttributeVariableNamePrefix).operator_concat (GGS_string ("mAttribute_"))).operator_concat (operand_34247->mAttributeName.ggs_string ().reader_identifierRepresentation ()), function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (834)) ;
    }
  }
  var_cas_outSignatureForGeneration = GGS_formalInputParameterListForGeneration ::constructor_emptyList () ;
  {
    GGS_formalInputParameterListAST::cEnumerator enumerator_34630 (var_cas_inFunctionSignature, true) ;
    const GGS_formalInputParameterListAST::cElement * operand_34630 = NULL ;
    while (((operand_34630 = enumerator_34630.nextObject ()))) {
      macroValidPointer (operand_34630) ;
      const GGS_unifiedTypeMapProxy  var_cas_parameterType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, operand_34630->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (844)) ;
      const GGS_bool cond_35323 = operand_34630->mIsConstant ;
      if (cond_35323.isBuiltAndTrue ()) {
        const GGS_string var_cas_cppName = (GGS_string ("constinArgument_")).operator_concat (operand_34630->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_outSignatureForGeneration.addAssign_operation (var_cas_parameterType, var_cas_cppName, operand_34630->mFormalArgumentName, operand_34630->mIsUnused) ;
        const GGS_bool cond_35185 = operand_34630->mIsUnused ;
        if (cond_35185.isBuiltAndTrue ()) {
          var_cas_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (inLexique, operand_34630->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (854)) ;
        }else if (cond_35185.isBuiltAndFalse ()) {
          var_cas_variableMap.modifier_insertConstantInputFormalArgument (inLexique, operand_34630->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (856)) ;
        }
      }else if (cond_35323.isBuiltAndFalse ()) {
        const GGS_string var_cas_cppName = (GGS_string ("inArgument_")).operator_concat (operand_34630->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_outSignatureForGeneration.addAssign_operation (var_cas_parameterType, var_cas_cppName, operand_34630->mFormalArgumentName, operand_34630->mIsUnused) ;
        const GGS_bool cond_35707 = operand_34630->mIsUnused ;
        if (cond_35707.isBuiltAndTrue ()) {
          var_cas_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (inLexique, operand_34630->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (867)) ;
        }else if (cond_35707.isBuiltAndFalse ()) {
          var_cas_variableMap.modifier_insertInputFormalArgument (inLexique, operand_34630->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (869)) ;
        }
      }
    }
  }
  ...
  var_cas_outSemanticInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
  {
    GGS_semanticInstructionListAST::cEnumerator enumerator_36387 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListAST::cElement * operand_36387 = NULL ;
    while (((operand_36387 = enumerator_36387.nextObject ()))) {
      macroValidPointer (operand_36387) ;
      { typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (operand_36387->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_36387->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_outSemanticInstructionListForGeneration, var_cas_variableMap COMMA_SOURCE_FILE_AT_LINE (880)) ;
        }
      }
    }
  }
...
category_method__functionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_functionDeclarationAST * operand_36780,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36780 != NULL) {
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ...
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  operand_36780->mFormalArgumentList,  GGS_typedAttributeList ::constructor_emptyList (),  GGS_string (""),  operand_36780->mFunctionInstructionList,  operand_36780->mResultVariableName,  operand_36780->mResultTypeName,  operand_36780->mEndOfFunctionInstructionList,  var_cas_formalInputParameterList,  var_cas_returnType,  var_cas_resultVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (908)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_functionImplementationForGeneration ::constructor_new (inLexique, operand_36780->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (924)), var_cas_formalInputParameterList, var_cas_returnType, var_cas_resultVariableCppName, var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (923)), GGS_string ("")) ;
  }
}
...
category_method__onceFunctionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_38085,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38085 != NULL) {
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    GGS_unifiedTypeMapProxy  var_cas_returnType ;
    GGS_string var_cas_resultVariableCppName ;
    ...
    GGS_formalInputParameterListForGeneration  automatic_var_38910_0 ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  GGS_formalInputParameterListAST ::constructor_emptyList (),  GGS_typedAttributeList ::constructor_emptyList (),  GGS_string (""),  operand_38085->mFunctionInstructionList,  operand_38085->mResultVariableName,  operand_38085->mResultTypeName,  operand_38085->mEndOfFunctionInstructionList,  automatic_var_38910_0,  var_cas_returnType,  var_cas_resultVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (951)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_onceFunctionDeclarationForGeneration ::constructor_new (inLexique, operand_38085->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (967)), var_cas_returnType, var_cas_resultVariableCppName, var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (966)), GGS_string ("")) ;
  }
}
...
category_method__filewrapperDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_39602,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39602 != NULL) {
    GGS_wrapperFileMap  var_cas_wrapperFileMap ;
    GGS_wrapperDirectoryMap  var_cas_wrapperDirectoryMap ;
    GGS_lstring  automatic_var_40019_0 ;
    GGS_lstringlist  automatic_var_40019_1 ;
    GGS_filewrapperTemplateMap  automatic_var_40019_2 ;
    if (var_cas_inSemanticContext.mFilewrapperMap.isBuilt ()) {
      var_cas_inSemanticContext.mFilewrapperMap (HERE)->method_searchKey (inLexique, operand_39602->mFilewrapperName, automatic_var_40019_0, automatic_var_40019_1, var_cas_wrapperFileMap, var_cas_wrapperDirectoryMap, automatic_var_40019_2 COMMA_SOURCE_FILE_AT_LINE (990)) ;
    }
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_40194 = (operand_39602->mFilewrapperPath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_40194.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = operand_39602->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)) ;
    }else if (cond_40194.isBuiltAndFalse ()) {
      var_cas_absoluteSourcePath = ((var_cas_inSemanticContext.reader_mSourceFileAbsolutePath (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_39602->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1003))) ;
    }
    const GGS_bool cond_40495 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_40495.isBuiltAndTrue ()) {
      operand_39602->mFilewrapperPath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (var_cas_absoluteSourcePath)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (1007)) ;
    }else if (cond_40495.isBuiltAndFalse ()) {
      ...
      {
        GGS_filewrapperTemplateListAST::cEnumerator enumerator_40663 (operand_39602->mFilewrapperTemplateList, true) ;
        const GGS_filewrapperTemplateListAST::cElement * operand_40663 = NULL ;
        while (((operand_40663 = enumerator_40663.nextObject ()))) {
          macroValidPointer (operand_40663) ;
          const GGS_bool cond_40891 = (operand_40663->mFilewrapperTemplatePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_40891.isBuiltAndTrue ()) {
            operand_40663->mFilewrapperTemplatePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the path should not begin with a '/'; it is relative to filewrapper path '")).operator_concat (var_cas_absoluteSourcePath)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1013)) ;
          }
          const GGS_string var_cas_absoluteTemplatePath = ((var_cas_absoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_40663->mFilewrapperTemplatePath) ;
          ...
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            C_Grammar_templateGrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_absoluteTemplatePath, operand_40663->mFilewrapperTemplatePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1017)) COMMA_SOURCE_FILE_AT_LINE (1017)),
          ...
          {
            GGS_formalTemplateInputParameterListAST::cEnumerator enumerator_41467 (operand_40663->mFilewrapperTemplateFormalInputParameters, true) ;
            const GGS_formalTemplateInputParameterListAST::cElement * operand_41467 = NULL ;
            while (((operand_41467 = enumerator_41467.nextObject ()))) {
              macroValidPointer (operand_41467) ;
              GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_41467->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1022)) ;
              const GGS_string var_cas_cppVarName = (GGS_string ("in_")).operator_concat (operand_41467->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
              var_cas_templateVariableMap.modifier_insertKey (inLexique, operand_41467->mFormalArgumentName, var_cas_type, var_cas_cppVarName COMMA_SOURCE_FILE_AT_LINE (1024)) ;
              var_cas_filewrapperTemplateFormalInputParameters.addAssign_operation (var_cas_type, var_cas_cppVarName, operand_41467->mFormalArgumentName, GGS_bool (true)) ;
            }
          }
          ...
          var_cas_filewrapperTemplateListForGeneration.addAssign_operation (operand_40663->mFilewrapperTemplateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1037)), var_cas_filewrapperTemplateFormalInputParameters, var_cas_templateInstructionListForGeneration) ;
        }
      }
      var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_filewrapperDeclarationForGeneration ::constructor_new (inLexique, operand_39602->mFilewrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1044)), operand_39602->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1045)), var_cas_wrapperFileMap, var_cas_wrapperDirectoryMap, var_cas_filewrapperTemplateListForGeneration COMMA_SOURCE_FILE_AT_LINE (1043)), GGS_string ("")) ;
    }
  }
}
...
category_method__abstractCategoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodAST * operand_43001,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43001 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43001->mTypeName COMMA_SOURCE_FILE_AT_LINE (1063)) ;
    const GGS_bool cond_43538 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1065))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1065))) ;
    if (cond_43538.isBuiltAndTrue ()) {
      operand_43001->mAbstractCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    }else if (cond_43538.isBuiltAndFalse ()) {
      const GGS_bool cond_43710 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1067)) ;
      if (cond_43710.isBuiltAndTrue ()) {
        operand_43001->mAbstractCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare an abstract category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1068)))).operator_concat (GGS_string ("' is not an abstract class")) COMMA_SOURCE_FILE_AT_LINE (1069)) ;
      }
    }
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_43881 (operand_43001->mAbstractCategoryMethodFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_43881 = NULL ;
      while (((operand_43881 = enumerator_43881.nextObject ()))) {
        macroValidPointer (operand_43881) ;
        var_cas_formalParameterListForGeneration.addAssign_operation (operand_43881->mFormalArgumentPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43881->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1075)), operand_43881->mFormalArgumentName, operand_43881->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1077))) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_abstractCategoryMethodForGeneration ::constructor_new (inLexique, operand_43001->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1082)), operand_43001->mAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1083)), var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1081)), var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1086))) ;
  }
}
...
category_method__categoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_categoryMethodAST * operand_44511,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_44511 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_44511->mTypeName COMMA_SOURCE_FILE_AT_LINE (1098)) ;
    const GGS_bool cond_45021 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))) ;
    if (cond_45021.isBuiltAndTrue ()) {
      operand_44511->mCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1101)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    }
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ...
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_44511->mCategoryMethodFormalParameterList,  GGS_localConstantList ::constructor_emptyList (),  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1116)),  GGS_string ("object->"),  operand_44511->mCategoryMethodInstructionList,  operand_44511->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1112)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_categoryMethodForGeneration ::constructor_new (inLexique, operand_44511->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1125)), operand_44511->mCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)), var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1128)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1124)), var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1131))) ;
  }
}
...
category_method__overridingCategoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodAST * operand_46112,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46112 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_46112->mTypeName COMMA_SOURCE_FILE_AT_LINE (1143)) ;
    const GGS_bool cond_46632 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1145))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1145))) ;
    if (cond_46632.isBuiltAndTrue ()) {
      operand_46112->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1146)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1147)) ;
    }
    ...
    GGS_uint _variant_47426 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1153)) ;
    GGS_bool _condition_47426 (_variant_47426.isBuilt (), true) ;
    while (_condition_47426.isBuiltAndTrue ()) {
      _condition_47426 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1154))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_47426.isBuiltAndTrue ()) {
        if (_variant_47426.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1163)) ;
          _condition_47426 = GGS_bool (false) ;
        }else{
          _variant_47426.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_47373 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1155)).reader_hasKey (operand_46112->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1155))) ;
          if (cond_47373.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_47247_0 ;
            GGS_bool automatic_var_47247_1 ;
            const GGS_instanceMethodMap  temp_47148 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1157)) ;
            if (temp_47148.isBuilt ()) {
              temp_47148 (HERE)->method_searchKey (inLexique, operand_46112->mOverridingCategoryMethodName, automatic_var_47247_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_47247_1, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1157)) ;
            }
            const GGS_bool cond_47360 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1158))) ;
            if (cond_47360.isBuiltAndTrue ()) {
    ...
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_selfType, GGS_string ("object")) ;
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_46112->mOverridingCategoryMethodFormalParameterList,  GGS_localConstantList ::constructor_emptyList (),  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1177)),  GGS_string ("object->"),  operand_46112->mOverridingCategoryMethodInstructionList,  operand_46112->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1173)) ;
    const GGS_bool cond_48328 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_48328.isBuiltAndTrue ()) {
      ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_46112->mOverridingCategoryMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1188)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1186)) ;
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_overridingCategoryMethodForGeneration ::constructor_new (inLexique, operand_46112->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1195)), var_cas_baseTypeName, operand_46112->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)), var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1199)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1194)), GGS_string ("{override}")) ;
  }
}
...
category_method__overridingAbstractCategoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_overridingAbstractCategoryMethodAST * operand_48826,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & /* var_cas_ioSemanticDeclarationListForGeneration */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48826 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_48826->mTypeName COMMA_SOURCE_FILE_AT_LINE (1214)) ;
    const GGS_bool cond_49367 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1216))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1216))) ;
    if (cond_49367.isBuiltAndTrue ()) {
      operand_48826->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1217)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1218)) ;
    }else if (cond_49367.isBuiltAndFalse ()) {
      const GGS_bool cond_49541 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1218)) ;
      if (cond_49541.isBuiltAndTrue ()) {
    ...
    GGS_formalParameterSignature  var_cas_inheritedSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_50335 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1226)) ;
    GGS_bool _condition_50335 (_variant_50335.isBuilt (), true) ;
    while (_condition_50335.isBuiltAndTrue ()) {
      _condition_50335 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1227))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_50335.isBuiltAndTrue ()) {
        if (_variant_50335.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1236)) ;
          _condition_50335 = GGS_bool (false) ;
        }else{
          _variant_50335.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_50282 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1228)).reader_hasKey (operand_48826->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1228))) ;
          if (cond_50282.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_50156_0 ;
            GGS_bool automatic_var_50156_1 ;
            const GGS_instanceMethodMap  temp_50057 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1230)) ;
            if (temp_50057.isBuilt ()) {
              temp_50057 (HERE)->method_searchKey (inLexique, operand_48826->mOverridingCategoryMethodName, automatic_var_50156_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_50156_1, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1230)) ;
            }
            const GGS_bool cond_50269 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1231))) ;
            if (cond_50269.isBuiltAndTrue ()) {
    ...
    ::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  operand_48826->mOverridingCategoryMethodFormalParameterList,  var_cas_variableMap,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1240)) ;
    const GGS_bool cond_50894 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_50894.isBuiltAndTrue ()) {
      ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_48826->mOverridingCategoryMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1250)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1248)) ;
    }
  }
}
...
category_method__abstractCategoryReaderAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_abstractCategoryReaderAST * operand_51059,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51059 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_51059->mTypeName COMMA_SOURCE_FILE_AT_LINE (1265)) ;
    const GGS_bool cond_51596 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1267))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1267))) ;
    if (cond_51596.isBuiltAndTrue ()) {
      operand_51059->mAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1269)) ;
    }else if (cond_51596.isBuiltAndFalse ()) {
      const GGS_bool cond_51768 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1269)) ;
      if (cond_51768.isBuiltAndTrue ()) {
    ...
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_51949 (operand_51059->mAbstractCategoryReaderFormalInputParameterList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_51949 = NULL ;
      while (((operand_51949 = enumerator_51949.nextObject ()))) {
        macroValidPointer (operand_51949) ;
        var_cas_formalParameterListForGeneration.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_51949->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1276)), operand_51949->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)), operand_51949->mFormalArgumentName, operand_51949->mIsUnused) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_abstractCategoryReaderForGeneration ::constructor_new (inLexique, operand_51059->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1284)), operand_51059->mAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_51059->mAbstractCategoryReaderReturnedTypeName COMMA_SOURCE_FILE_AT_LINE (1286)), var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1283)), var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1289))) ;
  }
}
...
category_method__categoryReaderAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_categoryReaderAST * operand_52671,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52671 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_52671->mTypeName COMMA_SOURCE_FILE_AT_LINE (1303)) ;
    const GGS_bool cond_53182 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1305))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1305))) ;
    if (cond_53182.isBuiltAndTrue ()) {
      operand_52671->mCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1307)) ;
    }
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_selfType, GGS_string ("object")) ;
    GGS_unifiedTypeMapProxy  var_cas_returnType ;
    ...
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  operand_52671->mCategoryReaderFormalInputParameterList,  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1322)),  GGS_string ("object->"),  operand_52671->mCategoryReaderInstructionList,  operand_52671->mCategoryReaderReturnedVariableName,  operand_52671->mCategoryReaderReturnedTypeName,  operand_52671->mEndOfReaderLocation,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  var_cas_returnVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_categoryReaderForGeneration ::constructor_new (inLexique, operand_52671->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)), operand_52671->mCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1336)), var_cas_returnType, var_cas_returnVariableCppName, var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1334)), var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1343))) ;
  }
}
...
category_method__overridingCategoryReaderAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_overridingCategoryReaderAST * operand_54470,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54470 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_54470->mTypeName COMMA_SOURCE_FILE_AT_LINE (1355)) ;
    const GGS_bool cond_54990 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1357))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1357))) ;
    if (cond_54990.isBuiltAndTrue ()) {
      operand_54470->mOverridingCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1358)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1359)) ;
    }
    GGS_string var_cas_baseTypeName = GGS_string ("") ;
    ...
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_55840 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1366)) ;
    GGS_bool _condition_55840 (_variant_55840.isBuilt (), true) ;
    while (_condition_55840.isBuiltAndTrue ()) {
      _condition_55840 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1367))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_55840.isBuiltAndTrue ()) {
        if (_variant_55840.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1376)) ;
          _condition_55840 = GGS_bool (false) ;
        }else{
          _variant_55840.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_55787 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1368)).reader_hasKey (operand_54470->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1368))) ;
          if (cond_55787.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_55661_0 ;
            GGS_bool automatic_var_55661_1 ;
            const GGS_readerMap  temp_55541 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)) ;
            if (temp_55541.isBuilt ()) {
              temp_55541 (HERE)->method_searchKey (inLexique, operand_54470->mOverridingCategoryReaderName, automatic_var_55661_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_55661_1, var_cas_inheritedReturnType, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1370)) ;
            }
            const GGS_bool cond_55774 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1371))) ;
            if (cond_55774.isBuiltAndTrue ()) {
    ...
    GGS_formalInputParameterListForGeneration  var_cas_formalParameterListForGeneration ;
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  operand_54470->mOverridingCategoryReaderFormalInputParameterList,  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1391)),  GGS_string ("object->"),  operand_54470->mOverridingCategoryReaderInstructionList,  operand_54470->mOverridingCategoryReaderReturnedVariableName,  operand_54470->mOverridingCategoryReaderReturnedTypeName,  operand_54470->mEndOfReaderLocation,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  var_cas_returnVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1388)) ;
    const GGS_bool cond_56961 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_56961.isBuiltAndTrue ()) {
      ::routine_checkReaderSignatures (inLexique,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  operand_54470->mOverridingCategoryReaderName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1407)),  var_cas_inheritedSignature,  var_cas_inheritedReturnType,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1404)) ;
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_overrideCategoryReaderForGeneration ::constructor_new (inLexique, operand_54470->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1415)), var_cas_baseTypeName, operand_54470->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1417)), var_cas_returnType, var_cas_returnVariableCppName, var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1421)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1414)), GGS_string ("{override}")) ;
  }
}
...
category_method__overridingAbstractCategoryReaderAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_overridingAbstractCategoryReaderAST * operand_57500,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & /* var_cas_ioSemanticDeclarationListForGeneration */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57500 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_57500->mTypeName COMMA_SOURCE_FILE_AT_LINE (1436)) ;
    const GGS_unifiedTypeMapProxy  var_cas_returnType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_57500->mAbstractCategoryReaderReturnedTypeName COMMA_SOURCE_FILE_AT_LINE (1438)) ;
    const GGS_bool cond_58204 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1440))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1440))) ;
    if (cond_58204.isBuiltAndTrue ()) {
      operand_57500->mAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1441)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1442)) ;
    }else if (cond_58204.isBuiltAndFalse ()) {
      const GGS_bool cond_58376 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)) ;
      if (cond_58376.isBuiltAndTrue ()) {
        operand_57500->mAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare an abstract category reader: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1443)))).operator_concat (GGS_string ("' is not an abstract class")) COMMA_SOURCE_FILE_AT_LINE (1444)) ;
      }
    }
    GGS_string var_cas_baseTypeName = GGS_string ("") ;
    ...
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_59222 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1451)) ;
    GGS_bool _condition_59222 (_variant_59222.isBuilt (), true) ;
    while (_condition_59222.isBuiltAndTrue ()) {
      _condition_59222 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1452))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_59222.isBuiltAndTrue ()) {
        if (_variant_59222.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1461)) ;
          _condition_59222 = GGS_bool (false) ;
        }else{
          _variant_59222.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_59169 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1453)).reader_hasKey (operand_57500->mAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1453))) ;
          if (cond_59169.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_59043_0 ;
            GGS_bool automatic_var_59043_1 ;
            const GGS_readerMap  temp_58925 = var_cas_superType.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1455)) ;
            if (temp_58925.isBuilt ()) {
              temp_58925 (HERE)->method_searchKey (inLexique, operand_57500->mAbstractCategoryReaderName, automatic_var_59043_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_59043_1, var_cas_inheritedReturnType, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1455)) ;
            }
            const GGS_bool cond_59156 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1456))) ;
            if (cond_59156.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_59913 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_59913.isBuiltAndTrue ()) {
      GGS_formalInputParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalInputParameterListForGeneration ::constructor_emptyList () ;
      {
        GGS_formalInputParameterListAST::cEnumerator enumerator_59429 (operand_57500->mAbstractCategoryReaderFormalInputParameterList, true) ;
        const GGS_formalInputParameterListAST::cElement * operand_59429 = NULL ;
        while (((operand_59429 = enumerator_59429.nextObject ()))) {
          macroValidPointer (operand_59429) ;
          var_cas_formalParameterListForGeneration.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_59429->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1467)), operand_59429->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1468)), operand_59429->mFormalArgumentName, operand_59429->mIsUnused) ;
        }
      }
      ::routine_checkReaderSignatures (inLexique,  var_cas_formalParameterListForGeneration,  var_cas_returnType,  operand_57500->mAbstractCategoryReaderName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)),  var_cas_inheritedSignature,  var_cas_inheritedReturnType,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1473)) ;
    }
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_63007 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_63007 = NULL ;
    while (((operand_63007 = enumerator_63007.nextObject ()))) {
      macroValidPointer (operand_63007) ;
      { typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (operand_63007->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_63007->mSemanticDeclaration (HERE), var_cas_inSemanticContext, var_cas_predefinedTypes, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (1529)) ;
        }
      }
    }
  }
