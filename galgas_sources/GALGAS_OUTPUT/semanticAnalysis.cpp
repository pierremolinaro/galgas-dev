...
GALGAS_predefinedTypes function_buildPredefinedTypes (const GALGAS_semanticContext & constinArgument_inSemanticContext,
  ...
  result_outPredefinedTypes = GALGAS_predefinedTypes::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("location"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2258)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2258)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("bool"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2259)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2259)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("char"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2260)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2260)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("string"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2261)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2261)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("uint"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2262)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2262)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("sint"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2263)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2263)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("uint64"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2264)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2264)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("sint64"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2265)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2265)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("double"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2266)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2266)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lbool"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2267)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2267)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lchar"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2268)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2268)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lstring"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2269)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2269)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("luint"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2270)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lsint"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2271)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2271)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("luint64"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2272)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2272)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lsint64"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2273)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2273)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("ldouble"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2274)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2274)) COMMA_SOURCE_FILE_AT_LINE (2257)) ;
//---
...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  cEnumerator_lstringlist enumerator_90683 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (2290)), kEnumeration_up) ;
  while (enumerator_90683.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_90683.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_90683.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2291)) COMMA_SOURCE_FILE_AT_LINE (2291)).operator_concat (GALGAS_string ("' type is undefined") COMMA_SOURCE_FILE_AT_LINE (2291)) COMMA_SOURCE_FILE_AT_LINE (2291)) ;
    enumerator_90683.gotoNextObject () ;
  }
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = constinArgument_inDeclarationList ;
  cEnumerator_semanticDeclarationListAST enumerator_90937 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_90937.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_90937.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2296)) ;
    enumerator_90937.gotoNextObject () ;
  }
  outArgument_outDecoratedDeclarationListForGeneration = GALGAS_semanticDeclarationSortedListForGeneration::constructor_emptySortedList (SOURCE_FILE_AT_LINE (2299)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (2300)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_predefinedTypes var_predefinedTypes = function_buildPredefinedTypes (constinArgument_inSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2301)) ;
    cEnumerator_semanticDeclarationListAST enumerator_91307 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_91307.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_91307.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (2303)) ;
      enumerator_91307.gotoNextObject () ;
    }
  }
}
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1652)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1652)))).operator_or (GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1652)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (1652)))) COMMA_SOURCE_FILE_AT_LINE (1652)).boolEnum () ;
  if (kBoolTrue == test_7) {
    temp_6 = var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1653)) ;
  }else if (kBoolFalse == test_7) {
    temp_6 = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1654)) ;
  }
  ...
  if (kBoolTrue == test_8) {
    {
    routine_checkMethodSignatures (var_formalParameterListForGeneration, object->mAttribute_mOverridingCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (1667)), var_inheritedSignature, var_inheritedDeclarationLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (1665)) ;
    }
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_overridingCategoryMethodForGeneration::constructor_new (GALGAS_string ("method-").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1676)) COMMA_SOURCE_FILE_AT_LINE (1676)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (1676)).operator_concat (object->mAttribute_mOverridingCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (1676)) COMMA_SOURCE_FILE_AT_LINE (1676)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1677)), var_baseTypeName, object->mAttribute_mOverridingCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (1679)), var_formalParameterListForGeneration, var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1681)), var_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1675)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (1673)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1698)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1698)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mOverridingCategoryMethodName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category method: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1699)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1699)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_selfType.reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (1700)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("cannot declare an abstract category method: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_SOURCE_FILE_AT_LINE (1701)).operator_concat (GALGAS_string ("' is not an abstract class") COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_SOURCE_FILE_AT_LINE (1701)) ;
    }
  }
  GALGAS_string var_baseTypeName = GALGAS_string::makeEmptyString () ;
  GALGAS_unifiedTypeMapProxy var_superType = var_selfType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1705)) ;
  GALGAS_formalParameterSignature var_inheritedSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1706)) ;
  GALGAS_location var_inheritedDeclarationLocation = inCompiler->here () ;
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1708)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1708)).isValid ()) {
    uint32_t variant_66908 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1708)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1708)).uintValue () ;
    bool loop_66908 = true ;
    while (loop_66908) {
      loop_66908 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1709)).operator_not (SOURCE_FILE_AT_LINE (1709)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1709)).isValid () ;
      if (loop_66908) {
        loop_66908 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1709)).operator_not (SOURCE_FILE_AT_LINE (1709)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1709)).boolValue () ;
      }
      if (loop_66908 && (0 == variant_66908)) {
        loop_66908 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1708)) ;
      }
      if (loop_66908) {
        variant_66908 -- ;
        const enumGalgasBool test_4 = var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1710)).reader_hasKey (object->mAttribute_mOverridingCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (1710)) COMMA_SOURCE_FILE_AT_LINE (1710)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_67217_0 ; // Joker input parameter
          GALGAS_bool joker_67270_0 ; // Joker input parameter
          GALGAS_string joker_67284_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1712)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_67217_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_67270_0, var_qualifier, joker_67284_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1712)) ;
          const enumGalgasBool test_5 = GALGAS_bool (kIsInfOrEqual, var_qualifier.objectCompare (GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1713)))).boolEnum () ;
          if (kBoolTrue == test_5) {
            var_baseTypeName = var_superType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1714)) ;
          }
        }
        var_superType = var_superType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1717)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_6) {
    ...
    inCompiler->emitSemanticError (location_7, GALGAS_string ("this reader is not declared by a super class") COMMA_SOURCE_FILE_AT_LINE (1720)) ;
  }
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1752)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1752)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category modifier: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1753)) COMMA_SOURCE_FILE_AT_LINE (1753)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (1753)) COMMA_SOURCE_FILE_AT_LINE (1753)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_selfType.reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (1754)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("cannot declare an abstract category modifier: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1755)) COMMA_SOURCE_FILE_AT_LINE (1755)).operator_concat (GALGAS_string ("' is not an abstract class") COMMA_SOURCE_FILE_AT_LINE (1755)) COMMA_SOURCE_FILE_AT_LINE (1755)) ;
    }
  }
  ...
  cEnumerator_formalParameterListAST enumerator_69205 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_69205.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_69205.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_69205.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1762)), enumerator_69205.current_mFormalArgumentName (HERE), enumerator_69205.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1764)) COMMA_SOURCE_FILE_AT_LINE (1760)) ;
    enumerator_69205.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_abstractCategoryModifierForGeneration::constructor_new (GALGAS_string ("setter-").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1771)) COMMA_SOURCE_FILE_AT_LINE (1771)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (1771)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1771)) COMMA_SOURCE_FILE_AT_LINE (1771)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1772)), object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1773)), var_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1770)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (1768)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_string var_selfObjectAccessor ;
  GALGAS_bool var_implementedAsFunction ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1793)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1793)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_selfObjectName = GALGAS_string ("object") ;
    var_selfObjectAccessor = GALGAS_string ("object->") ;
    var_implementedAsFunction = GALGAS_bool (false) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration ;
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, var_selfType, var_selfObjectName, var_selfType COMMA_SOURCE_FILE_AT_LINE (1805)) ;
  {
  routine_analyzeRoutineBody (var_analysisContext, object->mAttribute_mCategoryModifierFormalParameterList, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (1815)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1816)), var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1817)), var_selfObjectAccessor, object->mAttribute_mCategoryModifierInstructionList, object->mAttribute_mEndOfModifierLocation, var_semanticInstructionListForGeneration, var_formalParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1812)) ;
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_categoryModifierForGeneration::constructor_new (GALGAS_string ("setter-").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) COMMA_SOURCE_FILE_AT_LINE (1828)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (1828)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1828)) COMMA_SOURCE_FILE_AT_LINE (1828)), var_selfType, object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1830)), var_implementedAsFunction, var_formalParameterListForGeneration, var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1833)), var_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1827)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (1825)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_selfType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1848)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1850)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1850)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category modifier: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1851)) COMMA_SOURCE_FILE_AT_LINE (1851)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (1851)) COMMA_SOURCE_FILE_AT_LINE (1851)) ;
  }
  GALGAS_string var_baseTypeName = GALGAS_string::makeEmptyString () ;
  GALGAS_unifiedTypeMapProxy var_superType = var_selfType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1855)) ;
  GALGAS_formalParameterSignature var_inheritedSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1856)) ;
  GALGAS_location var_inheritedDeclarationLocation = inCompiler->here () ;
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1858)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1858)).isValid ()) {
    uint32_t variant_72787 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1858)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1858)).uintValue () ;
    bool loop_72787 = true ;
    while (loop_72787) {
      loop_72787 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1859)).operator_not (SOURCE_FILE_AT_LINE (1859)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1859)).isValid () ;
      if (loop_72787) {
        loop_72787 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1859)).operator_not (SOURCE_FILE_AT_LINE (1859)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1859)).boolValue () ;
      }
      if (loop_72787 && (0 == variant_72787)) {
        loop_72787 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1858)) ;
      }
      if (loop_72787) {
        variant_72787 -- ;
        const enumGalgasBool test_2 = var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1860)).reader_hasKey (object->mAttribute_mOverridingCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1860)) COMMA_SOURCE_FILE_AT_LINE (1860)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_73088_0 ; // Joker input parameter
          GALGAS_bool joker_73111_0 ; // Joker input parameter
          GALGAS_string joker_73125_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1862)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_73088_0, var_inheritedSignature, joker_73111_0, var_qualifier, joker_73125_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1862)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsInfOrEqual, var_qualifier.objectCompare (GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1863)))).boolEnum () ;
          if (kBoolTrue == test_3) {
            var_baseTypeName = var_superType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1864)) ;
          }
        }
        var_superType = var_superType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1867)) ;
      }
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("this modifier is not declared by a super class") COMMA_SOURCE_FILE_AT_LINE (1870)) ;
  }
  GALGAS_formalParameterListForGeneration var_formalParameterListForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1873)) ;
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration ;
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, var_selfType, GALGAS_string ("object"), var_selfType COMMA_SOURCE_FILE_AT_LINE (1875)) ;
  {
  routine_analyzeRoutineBody (var_analysisContext, object->mAttribute_mOverridingCategoryModifierFormalParameterList, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (1885)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1886)), var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1887)), GALGAS_string ("object->"), object->mAttribute_mOverridingCategoryModifierInstructionList, object->mAttribute_mEndOfModifierLocation, var_semanticInstructionListForGeneration, var_formalParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1882)) ;
  }
  ...
  if (kBoolTrue == test_6) {
    {
    routine_checkMethodSignatures (var_formalParameterListForGeneration, object->mAttribute_mOverridingCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (1898)), var_inheritedSignature, var_inheritedDeclarationLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (1896)) ;
    }
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_overridingCategoryModifierForGeneration::constructor_new (GALGAS_string ("setter-").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1907)) COMMA_SOURCE_FILE_AT_LINE (1907)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (1907)).operator_concat (object->mAttribute_mOverridingCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1907)) COMMA_SOURCE_FILE_AT_LINE (1907)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1908)), var_baseTypeName, object->mAttribute_mOverridingCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1910)), var_formalParameterListForGeneration, var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (1912)), var_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1906)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (1904)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_selfType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1927)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1929)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1929)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mOverridingCategoryModifierName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category modifier: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1930)) COMMA_SOURCE_FILE_AT_LINE (1930)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (1930)) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_selfType.reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (1931)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("cannot declare an abstract category modifier: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1932)) COMMA_SOURCE_FILE_AT_LINE (1932)).operator_concat (GALGAS_string ("' is not an abstract class") COMMA_SOURCE_FILE_AT_LINE (1932)) COMMA_SOURCE_FILE_AT_LINE (1932)) ;
    }
  }
  GALGAS_string var_baseTypeName = GALGAS_string::makeEmptyString () ;
  GALGAS_unifiedTypeMapProxy var_superType = var_selfType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1936)) ;
  GALGAS_formalParameterSignature var_inheritedSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1937)) ;
  GALGAS_location var_inheritedDeclarationLocation = inCompiler->here () ;
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1939)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1939)).isValid ()) {
    uint32_t variant_76017 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1939)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1939)).uintValue () ;
    bool loop_76017 = true ;
    while (loop_76017) {
      loop_76017 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1940)).operator_not (SOURCE_FILE_AT_LINE (1940)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1940)).isValid () ;
      if (loop_76017) {
        loop_76017 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1940)).operator_not (SOURCE_FILE_AT_LINE (1940)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1940)).boolValue () ;
      }
      if (loop_76017 && (0 == variant_76017)) {
        loop_76017 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1939)) ;
      }
      if (loop_76017) {
        variant_76017 -- ;
        const enumGalgasBool test_4 = var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1941)).reader_hasKey (object->mAttribute_mOverridingCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (1941)) COMMA_SOURCE_FILE_AT_LINE (1941)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_76318_0 ; // Joker input parameter
          GALGAS_bool joker_76341_0 ; // Joker input parameter
          GALGAS_string joker_76355_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1943)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_76318_0, var_inheritedSignature, joker_76341_0, var_qualifier, joker_76355_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1943)) ;
          const enumGalgasBool test_5 = GALGAS_bool (kIsInfOrEqual, var_qualifier.objectCompare (GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1944)))).boolEnum () ;
          if (kBoolTrue == test_5) {
  ...
  if (kBoolTrue == test_6) {
    ...
    inCompiler->emitSemanticError (location_7, GALGAS_string ("this modifier is not declared by a super class") COMMA_SOURCE_FILE_AT_LINE (1951)) ;
  }
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1954)) ;
  GALGAS_formalParameterListForGeneration var_formalParameterListForGeneration ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inSemanticContext, object->mAttribute_mOverridingCategoryModifierFormalParameterList, var_variableMap, var_formalParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)) ;
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_8) {
    {
    routine_checkMethodSignatures (var_formalParameterListForGeneration, object->mAttribute_mOverridingCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (1966)), var_inheritedSignature, var_inheritedDeclarationLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (1964)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_selfType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1981)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1983)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1983)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category reader: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1984)) COMMA_SOURCE_FILE_AT_LINE (1984)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (1984)) COMMA_SOURCE_FILE_AT_LINE (1984)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_selfType.reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (1985)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("cannot declare an abstract category reader: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1986)) COMMA_SOURCE_FILE_AT_LINE (1986)).operator_concat (GALGAS_string ("' is not an abstract class") COMMA_SOURCE_FILE_AT_LINE (1986)) COMMA_SOURCE_FILE_AT_LINE (1986)) ;
    }
  }
  GALGAS_formalInputParameterListForGeneration var_formalParameterListForGeneration = GALGAS_formalInputParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1989)) ;
  cEnumerator_formalInputParameterListAST enumerator_78280 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_78280.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_78280.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1992)), enumerator_78280.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1993)), enumerator_78280.current_mFormalArgumentName (HERE), enumerator_78280.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1991)) ;
    enumerator_78280.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_abstractCategoryReaderForGeneration::constructor_new (GALGAS_string ("getter-").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2002)) COMMA_SOURCE_FILE_AT_LINE (2002)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (2002)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2002)) COMMA_SOURCE_FILE_AT_LINE (2002)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2003)), object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2004)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2005)), var_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (2001)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (1999)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_selfType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2022)) ;
  GALGAS_string var_selfObjectName ;
  GALGAS_string var_selfObjectAccessor ;
  GALGAS_bool var_implementedAsFunction ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2027)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2027)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_selfObjectName = GALGAS_string ("object") ;
    var_selfObjectAccessor = GALGAS_string ("object->") ;
    var_implementedAsFunction = GALGAS_bool (false) ;
  ...
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, var_selfType, var_selfObjectName, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2042)) COMMA_SOURCE_FILE_AT_LINE (2037)) ;
  GALGAS_unifiedTypeMapProxy var_returnType ;
  ...
  //--- @ifExpressionForGeneration
  GALGAS_typedAttributeList temp_1 ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2052)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2052)))).operator_or (GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2052)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2052)))) COMMA_SOURCE_FILE_AT_LINE (2052)).boolEnum () ;
  if (kBoolTrue == test_2) {
    temp_1 = var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2053)) ;
  }else if (kBoolFalse == test_2) {
    temp_1 = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2054)) ;
  }
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_categoryReaderForGeneration::constructor_new (GALGAS_string ("getter-").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2070)) COMMA_SOURCE_FILE_AT_LINE (2070)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (2070)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2070)) COMMA_SOURCE_FILE_AT_LINE (2070)), var_selfType, object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2072)), var_implementedAsFunction, var_returnType, var_returnVariableCppName, var_formalParameterListForGeneration, var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2077)), var_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (2069)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (2067)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_selfType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2092)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2094)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2094)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category reader: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2095)) COMMA_SOURCE_FILE_AT_LINE (2095)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (2095)) COMMA_SOURCE_FILE_AT_LINE (2095)) ;
  }
  GALGAS_string var_baseTypeName = GALGAS_string::makeEmptyString () ;
  GALGAS_unifiedTypeMapProxy var_superType = var_selfType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2099)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_inheritedSignature = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2100)) ;
  GALGAS_unifiedTypeMapProxy var_inheritedReturnType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2101)) ;
  GALGAS_location var_inheritedDeclarationLocation = inCompiler->here () ;
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2103)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2103)).isValid ()) {
    uint32_t variant_82402 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2103)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2103)).uintValue () ;
    bool loop_82402 = true ;
    while (loop_82402) {
      loop_82402 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2104)).operator_not (SOURCE_FILE_AT_LINE (2104)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2104)).isValid () ;
      if (loop_82402) {
        loop_82402 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2104)).operator_not (SOURCE_FILE_AT_LINE (2104)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2104)).boolValue () ;
      }
      if (loop_82402 && (0 == variant_82402)) {
        loop_82402 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2103)) ;
      }
      if (loop_82402) {
        variant_82402 -- ;
        const enumGalgasBool test_2 = var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2105)).reader_hasKey (object->mAttribute_mOverridingCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2105)) COMMA_SOURCE_FILE_AT_LINE (2105)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_82676_0 ; // Joker input parameter
          GALGAS_bool joker_82753_0 ; // Joker input parameter
          GALGAS_string joker_82830_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2106)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_82676_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_82753_0, var_inheritedReturnType, var_qualifier, joker_82830_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2106)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsInfOrEqual, var_qualifier.objectCompare (GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2116)))).boolEnum () ;
          if (kBoolTrue == test_3) {
            var_baseTypeName = var_superType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2117)) ;
          }
        }
        var_superType = var_superType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2120)) ;
      }
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("this reader is not declared by a super class") COMMA_SOURCE_FILE_AT_LINE (2123)) ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, var_selfType, GALGAS_string ("object"), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2131)) COMMA_SOURCE_FILE_AT_LINE (2126)) ;
  GALGAS_formalInputParameterListForGeneration var_formalParameterListForGeneration ;
  GALGAS_unifiedTypeMapProxy var_returnType ;
  GALGAS_string var_returnVariableCppName ;
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration ;
  ...
  //--- @ifExpressionForGeneration
  GALGAS_typedAttributeList temp_6 ;
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2137)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2137)))).operator_or (GALGAS_bool (kIsEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2137)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2137)))) COMMA_SOURCE_FILE_AT_LINE (2137)).boolEnum () ;
  if (kBoolTrue == test_7) {
    temp_6 = var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2138)) ;
  }else if (kBoolFalse == test_7) {
    temp_6 = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2139)) ;
  }
  routine_analyzeFunctionBody (var_analysisContext, object->mAttribute_mOverridingCategoryReaderFormalInputParameterList, temp_6, GALGAS_string ("object->"), object->mAttribute_mOverridingCategoryReaderInstructionList, object->mAttribute_mOverridingCategoryReaderReturnedVariableName, object->mAttribute_mOverridingCategoryReaderReturnedTypeName, object->mAttribute_mEndOfReaderLocation, var_formalParameterListForGeneration, var_returnType, var_returnVariableCppName, var_semanticInstructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (2133)) ;
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_8) {
    {
    routine_checkReaderSignatures (var_formalParameterListForGeneration, var_returnType, object->mAttribute_mOverridingCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2156)), var_inheritedSignature, var_inheritedReturnType, var_inheritedDeclarationLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (2153)) ;
    }
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (object->mAttribute_mIsPredefined, GALGAS_overrideCategoryReaderForGeneration::constructor_new (GALGAS_string ("getter-").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2166)) COMMA_SOURCE_FILE_AT_LINE (2166)).operator_concat (GALGAS_string ("-") COMMA_SOURCE_FILE_AT_LINE (2166)).operator_concat (object->mAttribute_mOverridingCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2166)) COMMA_SOURCE_FILE_AT_LINE (2166)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2167)), var_baseTypeName, object->mAttribute_mOverridingCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2169)), var_returnType, var_returnVariableCppName, var_formalParameterListForGeneration, var_selfType.reader_mAllTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (2173)), var_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (2165)), GALGAS_string ("~") COMMA_SOURCE_FILE_AT_LINE (2163)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_selfType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)) ;
  GALGAS_unifiedTypeMapProxy var_returnType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2190)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selfType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (2192)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2192)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mAbstractCategoryReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("cannot declare a category reader: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2193)) COMMA_SOURCE_FILE_AT_LINE (2193)).operator_concat (GALGAS_string ("' is not a class") COMMA_SOURCE_FILE_AT_LINE (2193)) COMMA_SOURCE_FILE_AT_LINE (2193)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_selfType.reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2194)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mAbstractCategoryReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("cannot declare an abstract category reader: '@").operator_concat (var_selfType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2195)) COMMA_SOURCE_FILE_AT_LINE (2195)).operator_concat (GALGAS_string ("' is not an abstract class") COMMA_SOURCE_FILE_AT_LINE (2195)) COMMA_SOURCE_FILE_AT_LINE (2195)) ;
    }
  }
  GALGAS_string var_baseTypeName = GALGAS_string::makeEmptyString () ;
  GALGAS_unifiedTypeMapProxy var_superType = var_selfType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2199)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_inheritedSignature = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2200)) ;
  GALGAS_unifiedTypeMapProxy var_inheritedReturnType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2201)) ;
  GALGAS_location var_inheritedDeclarationLocation = inCompiler->here () ;
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2203)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2203)).isValid ()) {
    uint32_t variant_86279 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2203)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2203)).uintValue () ;
    bool loop_86279 = true ;
    while (loop_86279) {
      loop_86279 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2204)).operator_not (SOURCE_FILE_AT_LINE (2204)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2204)).isValid () ;
      if (loop_86279) {
        loop_86279 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2204)).operator_not (SOURCE_FILE_AT_LINE (2204)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2204)).boolValue () ;
      }
      if (loop_86279 && (0 == variant_86279)) {
        loop_86279 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2203)) ;
      }
      if (loop_86279) {
        variant_86279 -- ;
        const enumGalgasBool test_4 = var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2205)).reader_hasKey (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2205)) COMMA_SOURCE_FILE_AT_LINE (2205)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_86584_0 ; // Joker input parameter
          GALGAS_bool joker_86661_0 ; // Joker input parameter
          GALGAS_string joker_86720_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2207)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_86584_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_86661_0, var_inheritedReturnType, var_qualifier, joker_86720_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2207)) ;
          const enumGalgasBool test_5 = GALGAS_bool (kIsInfOrEqual, var_qualifier.objectCompare (GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2217)))).boolEnum () ;
          if (kBoolTrue == test_5) {
            var_baseTypeName = var_superType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2218)) ;
          }
        }
        var_superType = var_superType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (2221)) ;
      }
    }
  }
  const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_6) {
    ...
    inCompiler->emitSemanticError (location_7, GALGAS_string ("this reader is not declared by a super class") COMMA_SOURCE_FILE_AT_LINE (2224)) ;
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_formalInputParameterListForGeneration var_formalParameterListForGeneration = GALGAS_formalInputParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (2228)) ;
    cEnumerator_formalInputParameterListAST enumerator_87242 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_87242.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_87242.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2231)), enumerator_87242.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (2232)), enumerator_87242.current_mFormalArgumentName (HERE), enumerator_87242.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (2230)) ;
      enumerator_87242.gotoNextObject () ;
    }
    {
    routine_checkReaderSignatures (var_formalParameterListForGeneration, var_returnType, object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2240)), var_inheritedSignature, var_inheritedReturnType, var_inheritedDeclarationLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (2237)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
