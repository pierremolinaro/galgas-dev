...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_5468 (var_cas_inSemanticContext.reader_mOrderedSemanticDeclarationListAST (inLexique COMMA_SOURCE_FILE_AT_LINE (122)), true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_5468 = NULL ;
    while (((operand_5468 = enumerator_5468.nextObject ()))) {
      macroValidPointer (operand_5468) ;
      const GGS_semanticDeclarationAST  temp_5574 = operand_5468->mSemanticDeclaration ;
      if (temp_5574.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_5574.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_5574 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (123)) ;
        }
      }
    }
  }
