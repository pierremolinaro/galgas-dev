...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  while (enumerator_176892.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_177076 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176892.current_mNonterminalName (HERE), joker_177076, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4413)) ;
    ...
    GALGAS_nonterminalLabelMap joker_178101 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176892.current_mNonterminalName (HERE), joker_178101, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4444)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_133866 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_133866, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3313)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type ;
  {
  GALGAS_string joker_140439 ; // Joker input parameter
  GALGAS_string joker_140442 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_140439, joker_140442, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3457)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_159899 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_159899, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3962)) ;
  }
