...
//                    september 22th, 2010, at 16h39'47"                     *
//                                                                           *
//---------------------------------------------------------------------------*
  ...
  if (operand_25057 != NULL) {
    ...
    GGS_abstractMethodDefinitionListForGeneration  var_cas_abstractMethodList = GGS_abstractMethodDefinitionListForGeneration ::constructor_emptyList () ;
    {
      ...
      while (((operand_26769 = enumerator_26769.nextObject ()))) {
        ...
        const GGS_bool cond_27839 = operand_26769->mIsOverriding ;
        if (cond_27839.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_27651_0 ;
          GGS_bool automatic_var_27651_1 ;
          GGS_methodQualifier automatic_var_27651_2 ;
          if (var_cas_inheritedInstanceMethodMap.isBuilt ()) {
            var_cas_inheritedInstanceMethodMap (HERE)->method_searchInheritedKey (inLexique, operand_26769->mMethodName, automatic_var_27651_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_27651_1, automatic_var_27651_2 COMMA_SOURCE_FILE_AT_LINE (649)) ;
          }
        ...
        }else if (cond_27839.isBuiltAndFalse ()) {
          const GGS_bool cond_28022 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_26769->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (656))) ;
          if (cond_28022.isBuiltAndTrue ()) {
    ...
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_28276 (operand_25057->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_28276 = NULL ;
      while (((operand_28276 = enumerator_28276.nextObject ()))) {
        macroValidPointer (operand_28276) ;
        GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
        GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
        ::routine_analyzeRoutineBody (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_28276->mSignature,  GGS_localConstantList ::constructor_listWithValue (var_cas_selfType, GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (672)), GGS_bool (true), GGS_string ("(self)")),  var_cas_allAttributeList,  operand_28276->mInstructionList,  operand_28276->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (668)) ;
        const GGS_bool cond_29492 = operand_28276->mIsOverriding ;
        if (cond_29492.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool var_cas_inheritedIsCategory ;
          GGS_bool automatic_var_29140_0 ;
          GGS_methodQualifier automatic_var_29140_1 ;
          if (var_cas_inheritedInstanceMethodMap.isBuilt ()) {
            var_cas_inheritedInstanceMethodMap (HERE)->method_searchInheritedKey (inLexique, operand_28276->mMethodName, var_cas_inheritedIsCategory, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_29140_0, automatic_var_29140_1 COMMA_SOURCE_FILE_AT_LINE (684)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_28276->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (687)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (685)) ;
          const GGS_bool cond_29477 = var_cas_inheritedIsCategory ;
          if (cond_29477.isBuiltAndTrue ()) {
            operand_28276->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method is declared in class, but overriden method is declared as multi-method") COMMA_SOURCE_FILE_AT_LINE (693)) ;
          }
        }else if (cond_29492.isBuiltAndFalse ()) {
          const GGS_bool cond_29681 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_28276->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (694))) ;
          if (cond_29681.isBuiltAndTrue ()) {
            operand_28276->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method should be declared as overridding, as it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (696)) ;
          }
        }
        var_cas_definedMethodSet.addAssign_operation (operand_28276->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (698))) ;
        var_cas_methodList.addAssign_operation (operand_28276->mIsOverriding, operand_28276->mMethodName, var_cas_formalParameterListForGeneration, var_cas_semanticInstructionListForGeneration) ;
      }
    }
    const GGS_bool cond_30426 = (operand_25057->mIsAbstract).operator_not () ;
    if (cond_30426.isBuiltAndTrue ()) {
      {
        GGS_instanceMethodMap::cEnumerator enumerator_30024 (var_cas_inheritedInstanceMethodMap, true) ;
        const GGS_instanceMethodMap::cElement * operand_30024 = NULL ;
        while (((operand_30024 = enumerator_30024.nextObject ()))) {
          macroValidPointer (operand_30024) ;
          const GGS_bool cond_30397 = ((operand_30024->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (709)))).operator_or ((operand_30024->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (709)))) ;
          if (cond_30397.isBuiltAndTrue ()) {
            const GGS_bool cond_30378 = (var_cas_definedMethodSet.reader_hasKey (operand_30024->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (710)))).operator_not () ;
            if (cond_30378.isBuiltAndTrue ()) {
              operand_30024->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_25057->mClassTypeName)).operator_concat (GGS_string ("' class is declared concrete, but the '"))).operator_concat (operand_30024->mKey)).operator_concat (GGS_string ("' method declared in a super class is not implemented")) COMMA_SOURCE_FILE_AT_LINE (712)) ;
            }
          }
        }
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_25057->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (718)), operand_25057->mIsAbstract, operand_25057->mClassTypeName, var_cas_superClassProxy, var_cas_allAttributeList, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList COMMA_SOURCE_FILE_AT_LINE (717))) ;
  }
}
...
void routine_analyzeFunctionBody (C_Compiler & inLexique,
  ...
  {
    GGS_formalInputParameterListAST::cEnumerator enumerator_31560 (var_cas_inFunctionSignature, true) ;
    const GGS_formalInputParameterListAST::cElement * operand_31560 = NULL ;
    while (((operand_31560 = enumerator_31560.nextObject ()))) {
      macroValidPointer (operand_31560) ;
      const GGS_unifiedTypeMapProxy  var_cas_parameterType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_31560->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (748)) ;
      const GGS_bool cond_32188 = operand_31560->mIsConstant ;
      if (cond_32188.isBuiltAndTrue ()) {
        const GGS_string var_cas_cppName = (GGS_string ("constinArgument_")).operator_concat (operand_31560->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_outSignatureForGeneration.addAssign_operation (var_cas_parameterType, var_cas_cppName, operand_31560->mIsUnused) ;
        const GGS_bool cond_32059 = operand_31560->mIsUnused ;
        if (cond_32059.isBuiltAndTrue ()) {
          var_cas_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (inLexique, operand_31560->mFormalArgumentName, var_cas_parameterType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (757)) ;
        }else if (cond_32059.isBuiltAndFalse ()) {
          var_cas_variableMap.modifier_insertConstantInputFormalArgument (inLexique, operand_31560->mFormalArgumentName, var_cas_parameterType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (759)) ;
        }
      }else if (cond_32188.isBuiltAndFalse ()) {
        const GGS_string var_cas_cppName = (GGS_string ("inArgument_")).operator_concat (operand_31560->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_outSignatureForGeneration.addAssign_operation (var_cas_parameterType, var_cas_cppName, operand_31560->mIsUnused) ;
        const GGS_bool cond_32534 = operand_31560->mIsUnused ;
        if (cond_32534.isBuiltAndTrue ()) {
          var_cas_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (inLexique, operand_31560->mFormalArgumentName, var_cas_parameterType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (769)) ;
        }else if (cond_32534.isBuiltAndFalse ()) {
          var_cas_variableMap.modifier_insertInputFormalArgument (inLexique, operand_31560->mFormalArgumentName, var_cas_parameterType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (771)) ;
        }
      }
    }
  }
  ...
  var_cas_outSemanticInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
  {
    GGS_semanticInstructionListAST::cEnumerator enumerator_33161 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListAST::cElement * operand_33161 = NULL ;
    while (((operand_33161 = enumerator_33161.nextObject ()))) {
      macroValidPointer (operand_33161) ;
      { typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (operand_33161->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_33161->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_outSemanticInstructionListForGeneration, var_cas_variableMap COMMA_SOURCE_FILE_AT_LINE (782)) ;
        }
      }
    }
  }
  if (var_cas_variableMap.isBuilt ()) {
    var_cas_variableMap (HERE)->method_checkAutomatonStates (inLexique, var_cas_inEndOfFunctionLocation COMMA_SOURCE_FILE_AT_LINE (790)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__functionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_functionDeclarationAST * operand_33579,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_33579 != NULL) {
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ...
    ::routine_analyzeFunctionBody (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_33579->mFormalArgumentList,  operand_33579->mFunctionInstructionList,  operand_33579->mResultVariableName,  operand_33579->mResultTypeName,  operand_33579->mEndOfFunctionInstructionList,  var_cas_formalInputParameterList,  var_cas_returnType,  var_cas_resultVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (805)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_functionImplementationForGeneration ::constructor_new (inLexique, operand_33579->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), var_cas_formalInputParameterList, var_cas_returnType, var_cas_resultVariableCppName, var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (819))) ;
  }
}
...
category_method__onceFunctionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_34711,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34711 != NULL) {
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    GGS_unifiedTypeMapProxy  var_cas_returnType ;
    GGS_string var_cas_resultVariableCppName ;
    GGS_formalInputParameterListForGeneration  automatic_var_35371_0 ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  GGS_formalInputParameterListAST ::constructor_emptyList (),  operand_34711->mFunctionInstructionList,  operand_34711->mResultVariableName,  operand_34711->mResultTypeName,  operand_34711->mEndOfFunctionInstructionList,  automatic_var_35371_0,  var_cas_returnType,  var_cas_resultVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (839)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_onceFunctionDeclarationForGeneration ::constructor_new (inLexique, operand_34711->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (854)), var_cas_returnType, var_cas_resultVariableCppName, var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (853))) ;
  }
}
...
GGS_predefinedTypes function_buildPredefinedTypes (C_Compiler & inLexique,
  ...
  var_cas_outPredefinedTypes = GGS_predefinedTypes::constructor_new (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("bool"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (874)) COMMA_SOURCE_FILE_AT_LINE (874)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (875)) COMMA_SOURCE_FILE_AT_LINE (875)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (876)) COMMA_SOURCE_FILE_AT_LINE (876)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("double"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (880)) COMMA_SOURCE_FILE_AT_LINE (880)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lbool"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (881)) COMMA_SOURCE_FILE_AT_LINE (881)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (882)) COMMA_SOURCE_FILE_AT_LINE (882)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (883)) COMMA_SOURCE_FILE_AT_LINE (883)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (884)) COMMA_SOURCE_FILE_AT_LINE (884)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (885)) COMMA_SOURCE_FILE_AT_LINE (885)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (886)) COMMA_SOURCE_FILE_AT_LINE (886)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (887)) COMMA_SOURCE_FILE_AT_LINE (887)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("ldouble"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (888)) COMMA_SOURCE_FILE_AT_LINE (888))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  #endif
  const GGS_predefinedTypes var_cas_predefinedTypes = function_buildPredefinedTypes (inLexique, var_cas_inSemanticContext COMMA_SOURCE_FILE_AT_LINE (903)) ;
  var_cas_outDecoratedDeclarationListForGeneration = GGS_semanticDeclarationListForGeneration ::constructor_emptyList () ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_38654 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_38654 = NULL ;
    while (((operand_38654 = enumerator_38654.nextObject ()))) {
      macroValidPointer (operand_38654) ;
      { typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (operand_38654->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_38654->mSemanticDeclaration (HERE), var_cas_inSemanticContext, var_cas_predefinedTypes, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (906)) ;
        }
      }
    }
  }
