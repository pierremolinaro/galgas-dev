...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1678)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)).isValid ()) {
    PMUInt32 variant_65870 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1678)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)).uintValue () ;
    bool loop_65870 = true ;
    while (loop_65870) {
      loop_65870 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1679)).operator_not (SOURCE_FILE_AT_LINE (1679)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1679)).isValid () ;
      if (loop_65870) {
        loop_65870 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1679)).operator_not (SOURCE_FILE_AT_LINE (1679)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1679)).boolValue () ;
      }
      if (loop_65870 && (0 == variant_65870)) {
        loop_65870 = false ;
      ...
      if (loop_65870) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_66176_0 ; // Joker input parameter
          GALGAS_bool joker_66229_0 ; // Joker input parameter
          GALGAS_string joker_66243_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_66176_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_66229_0, var_qualifier, joker_66243_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_68166 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_68166.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_68166.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_68166.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1732)), enumerator_68166.current_mFormalArgumentName (HERE), enumerator_68166.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1730)) ;
    enumerator_68166.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1824)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).isValid ()) {
    PMUInt32 variant_71571 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1824)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).uintValue () ;
    bool loop_71571 = true ;
    while (loop_71571) {
      loop_71571 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1825)).operator_not (SOURCE_FILE_AT_LINE (1825)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1825)).isValid () ;
      if (loop_71571) {
        loop_71571 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1825)).operator_not (SOURCE_FILE_AT_LINE (1825)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1825)).boolValue () ;
      }
      if (loop_71571 && (0 == variant_71571)) {
        loop_71571 = false ;
      ...
      if (loop_71571) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_71869_0 ; // Joker input parameter
          GALGAS_bool joker_71892_0 ; // Joker input parameter
          GALGAS_string joker_71906_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_71869_0, var_inheritedSignature, joker_71892_0, var_qualifier, joker_71906_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1903)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)).isValid ()) {
    PMUInt32 variant_74703 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1903)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)).uintValue () ;
    bool loop_74703 = true ;
    while (loop_74703) {
      loop_74703 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1904)).operator_not (SOURCE_FILE_AT_LINE (1904)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1904)).isValid () ;
      if (loop_74703) {
        loop_74703 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1904)).operator_not (SOURCE_FILE_AT_LINE (1904)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1904)).boolValue () ;
      }
      if (loop_74703 && (0 == variant_74703)) {
        loop_74703 = false ;
      ...
      if (loop_74703) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_75001_0 ; // Joker input parameter
          GALGAS_bool joker_75024_0 ; // Joker input parameter
          GALGAS_string joker_75038_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1907)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_75001_0, var_inheritedSignature, joker_75024_0, var_qualifier, joker_75038_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1907)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_76965 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_76965.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_76965.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)), enumerator_76965.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1957)), enumerator_76965.current_mFormalArgumentName (HERE), enumerator_76965.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1955)) ;
    enumerator_76965.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2059)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)).isValid ()) {
    PMUInt32 variant_80673 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2059)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)).uintValue () ;
    bool loop_80673 = true ;
    while (loop_80673) {
      loop_80673 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2060)).operator_not (SOURCE_FILE_AT_LINE (2060)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2060)).isValid () ;
      if (loop_80673) {
        loop_80673 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2060)).operator_not (SOURCE_FILE_AT_LINE (2060)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2060)).boolValue () ;
      }
      if (loop_80673 && (0 == variant_80673)) {
        loop_80673 = false ;
      ...
      if (loop_80673) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_80979_0 ; // Joker input parameter
          GALGAS_bool joker_81056_0 ; // Joker input parameter
          GALGAS_string joker_81115_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2063)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_80979_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_81056_0, var_inheritedReturnType, var_qualifier, joker_81115_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2063)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2158)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)).isValid ()) {
    PMUInt32 variant_84347 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2158)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)).uintValue () ;
    bool loop_84347 = true ;
    while (loop_84347) {
      loop_84347 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2159)).operator_not (SOURCE_FILE_AT_LINE (2159)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2159)).isValid () ;
      if (loop_84347) {
        loop_84347 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2159)).operator_not (SOURCE_FILE_AT_LINE (2159)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2159)).boolValue () ;
      }
      if (loop_84347 && (0 == variant_84347)) {
        loop_84347 = false ;
