...
//                                         september 24th, 2014, at 18h51'12"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_check_5F_K_5F_escapeCharacters (GALGAS_lstring inArgument_inString,
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_18985 (inArgument_inString.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 459)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 459)), kEnumeration_up) ;
  while (enumerator_18985.hasCurrentObject ()) {
    GALGAS_stringlist var_explodedArray = enumerator_18985.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 460)) ;
    {
    GALGAS_string joker_19097_0 ; // Joker input parameter
    var_explodedArray.modifier_popFirst (joker_19097_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 461)) ;
    }
    cEnumerator_stringlist enumerator_19127 (var_explodedArray, kEnumeration_up) ;
    while (enumerator_19127.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_19127.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 463)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_char var_c = enumerator_19127.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 464)) ;
      ...
      enumerator_19127.gotoNextObject () ;
    }
    enumerator_18985.gotoNextObject () ;
  }
}
...
void routine_check_5F_K_5F_L_5F_escapeCharacters (GALGAS_lstring inArgument_inString,
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_19674 (inArgument_inString.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 479)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 479)), kEnumeration_up) ;
  while (enumerator_19674.hasCurrentObject ()) {
    GALGAS_stringlist var_explodedArray = enumerator_19674.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 480)) ;
    {
    GALGAS_string joker_19786_0 ; // Joker input parameter
    var_explodedArray.modifier_popFirst (joker_19786_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 481)) ;
    }
    cEnumerator_stringlist enumerator_19816 (var_explodedArray, kEnumeration_up) ;
    while (enumerator_19816.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_19816.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 483)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_char var_c = enumerator_19816.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 484)) ;
      ...
      enumerator_19816.gotoNextObject () ;
    }
...
void routine_buildLocalVariableMapAndSignature (const GALGAS_semanticContext constinArgument_inSemanticContext,
  ...
  cEnumerator_formalParameterListAST enumerator_40018 (constinArgument_inRoutineSignatureAST, kEnumeration_up) ;
  while (enumerator_40018.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_40018.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 989)) ;
    GALGAS_string var_formalArgumentCppName ;
    if (enumerator_40018.current_mFormalArgumentPassingMode (HERE).isValid ()) {
      switch (enumerator_40018.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
      case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
        break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
        var_formalArgumentCppName = GALGAS_string ("inArgument_").operator_concat (enumerator_40018.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 993)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 993))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 993)) ;
        const enumGalgasBool test_0 = enumerator_40018.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 995)) ;
          }
        }else if (kBoolFalse == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgument (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 997)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
        var_formalArgumentCppName = GALGAS_string ("outArgument_").operator_concat (enumerator_40018.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1000)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1000))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1000)) ;
        {
        ioArgument_ioVariableMap.modifier_insertOutputFormalArgument (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1001)) ;
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
        var_formalArgumentCppName = GALGAS_string ("ioArgument_").operator_concat (enumerator_40018.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1003)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1003))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1003)) ;
        const enumGalgasBool test_1 = enumerator_40018.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1005)) ;
          }
        }else if (kBoolFalse == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgument (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1007)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
        var_formalArgumentCppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_40018.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1010)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1010)) ;
        const enumGalgasBool test_2 = enumerator_40018.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1012)) ;
          }
        }else if (kBoolFalse == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgument (enumerator_40018.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1014)) ;
          }
        }
        } break ;
      }
    }
    outArgument_outRoutineSignature.addAssign_operation (enumerator_40018.current_mFormalSelector (HERE), enumerator_40018.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_40018.current_mFormalArgumentName (HERE), var_formalArgumentCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1017)) ;
    enumerator_40018.gotoNextObject () ;
  }
}
...
void routine_analyzeRoutineBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_localConstantList enumerator_42726 (constinArgument_inLocalConstantList, kEnumeration_up) ;
  while (enumerator_42726.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_42726.current_mNoWarningIfUnused (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      var_variableMap.modifier_insertUsedLocalConstant (enumerator_42726.current_mName (HERE), enumerator_42726.current_mType (HERE), enumerator_42726.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1039)) ;
      }
    }else if (kBoolFalse == test_0) {
      {
      var_variableMap.modifier_insertLocalConstant (enumerator_42726.current_mName (HERE), enumerator_42726.current_mType (HERE), enumerator_42726.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1041)) ;
      }
    }
    enumerator_42726.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_43100 (constinArgument_inNonMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_43100.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_43100.current_mAttributeName (HERE), enumerator_43100.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1049)).operator_concat (enumerator_43100.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1049)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1049))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1049)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1046)) ;
    }
    enumerator_43100.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_43448 (constinArgument_inMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_43448.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertMutableAttribute (enumerator_43448.current_mAttributeName (HERE), enumerator_43448.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1058)).operator_concat (enumerator_43448.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1058)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1058))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1058)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1055)) ;
    }
  ...
  cEnumerator_semanticInstructionListAST enumerator_44051 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_44051.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_44051.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1072)) ;
    enumerator_44051.gotoNextObject () ;
  }
...
void routine_analyzeFunctionBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_typedAttributeList enumerator_51886 (constinArgument_inTypedAttributeList, kEnumeration_up) ;
  while (enumerator_51886.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_51886.current_mAttributeName (HERE), enumerator_51886.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1305)).operator_concat (enumerator_51886.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1305)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1305))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1305)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1302)) ;
    }
    enumerator_51886.gotoNextObject () ;
  }
  ...
  cEnumerator_formalInputParameterListAST enumerator_52300 (constinArgument_inFunctionSignature, kEnumeration_up) ;
  while (enumerator_52300.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_52300.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1312)) ;
    const enumGalgasBool test_0 = enumerator_52300.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_cppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_52300.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1314)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1314))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1314)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (enumerator_52300.current_mFormalSelector (HERE), var_parameterType, var_cppName, enumerator_52300.current_mFormalArgumentName (HERE), enumerator_52300.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1315)) ;
      const enumGalgasBool test_1 = enumerator_52300.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        var_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_52300.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1323)) ;
        }
      }else if (kBoolFalse == test_1) {
        {
        var_variableMap.modifier_insertConstantInputFormalArgument (enumerator_52300.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1325)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_cppName = GALGAS_string ("inArgument_").operator_concat (enumerator_52300.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1328)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1328))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1328)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (enumerator_52300.current_mFormalSelector (HERE), var_parameterType, var_cppName, enumerator_52300.current_mFormalArgumentName (HERE), enumerator_52300.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1329)) ;
      const enumGalgasBool test_2 = enumerator_52300.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        var_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_52300.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1337)) ;
        }
      }else if (kBoolFalse == test_2) {
        {
        var_variableMap.modifier_insertInputFormalArgument (enumerator_52300.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1339)) ;
        }
      }
    }
    enumerator_52300.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticInstructionListAST enumerator_54136 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_54136.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_54136.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1350)) ;
    enumerator_54136.gotoNextObject () ;
  }
...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  cEnumerator_lstringlist enumerator_93749 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 2333)), kEnumeration_up) ;
  while (enumerator_93749.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_93749.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_93749.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2334)).operator_concat (GALGAS_string ("' type is undefined")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2334))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2334)) ;
    enumerator_93749.gotoNextObject () ;
  }
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = constinArgument_inDeclarationList ;
  cEnumerator_semanticDeclarationListAST enumerator_94003 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_94003.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_94003.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2339)) ;
    enumerator_94003.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_semanticDeclarationListAST enumerator_94373 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_94373.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_94373.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2346)) ;
      enumerator_94373.gotoNextObject () ;
    }
  }
}
...
static void categoryMethod_enumDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_enumConstantList enumerator_15801 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_15801.hasCurrentObject ()) {
    var_constantList.addAssign_operation (enumerator_15801.current_mConstantName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 369)) ;
    {
    var_constantMap.modifier_insertKey (enumerator_15801.current_mConstantName (HERE), var_constantMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 370)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 370)) ;
    }
    enumerator_15801.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("enum ").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 374))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 374)), GALGAS_enumTypeForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 376)), object->mAttribute_mConstantList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 375)), GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 373)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_17351_3 ; // Joker input parameter
  GALGAS_bool joker_17351_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_17351_1 ; // Joker input parameter
  GALGAS_bool joker_17392_0 ; // Joker input parameter
  GALGAS_attributeMap joker_17447_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_17447_19 ; // Joker input parameter
  GALGAS_constructorMap joker_17447_18 ; // Joker input parameter
  GALGAS_readerMap joker_17447_17 ; // Joker input parameter
  GALGAS_modifierMap joker_17447_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_17447_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_17447_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_17447_13 ; // Joker input parameter
  GALGAS_stringlist joker_17447_12 ; // Joker input parameter
  GALGAS_uint joker_17447_11 ; // Joker input parameter
  GALGAS_functionSignature joker_17447_10 ; // Joker input parameter
  GALGAS_stringset joker_17447_9 ; // Joker input parameter
  GALGAS_enumConstantList joker_17447_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_17447_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_17447_6 ; // Joker input parameter
  GALGAS_bool joker_17447_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_17447_4 ; // Joker input parameter
  GALGAS_string joker_17447_3 ; // Joker input parameter
  GALGAS_string joker_17447_2 ; // Joker input parameter
  GALGAS_headerKind joker_17447_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_17351_3, joker_17351_2, joker_17351_1, var_typeKindEnum, joker_17392_0, var_listTypeAttributeList, joker_17447_20, joker_17447_19, joker_17447_18, joker_17447_17, joker_17447_16, joker_17447_15, joker_17447_14, joker_17447_13, joker_17447_12, joker_17447_11, joker_17447_10, joker_17447_9, joker_17447_8, joker_17447_7, joker_17447_6, joker_17447_5, joker_17447_4, joker_17447_3, joker_17447_2, joker_17447_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 412)) ;
...
static void categoryMethod_mapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_20858 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_20858.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_20858.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 513)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_20858.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 516)) ;
    const enumGalgasBool test_0 = function_forbiddenKeysForMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 522)).reader_hasKey (enumerator_20858.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 522)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_m = GALGAS_string ("an attribute cannot be named:") ;
      cEnumerator_stringset enumerator_21268 (function_forbiddenKeysForMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 524)), kEnumeration_up) ;
      while (enumerator_21268.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" ").operator_concat (enumerator_21268.current (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 525))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 525)) ;
        enumerator_21268.gotoNextObject () ;
      }
      var_m.dotAssign_operation (GALGAS_string ("; theses names are reserved")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 527)) ;
      GALGAS_location location_1 (enumerator_20858.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, var_m  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 528)) ;
    }
    {
    var_attributeMap.modifier_insertKey (enumerator_20858.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 530)) ;
    }
  ...
  cEnumerator_insertMethodListAST enumerator_21569 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_21569.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_21569.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 535)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_21569.current_mErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 536)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_21569.current_mShadowErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 537)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_21847 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_21847.hasCurrentObject ()) {
    {
    var_searchMethodMap.modifier_insertKey (enumerator_21847.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 542)) ;
    }
    {
    routine_check_5F_K_5F_escapeCharacters (enumerator_21847.current_mErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 543)) ;
    }
    enumerator_21847.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_22021 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_22021.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_22021.current_mMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 547)) ;
    }
    {
    routine_check_5F_K_5F_escapeCharacters (enumerator_22021.current_mErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 548)) ;
    }
    enumerator_22021.gotoNextObject () ;
  }
  cEnumerator_insertOrReplaceDeclarationListAST enumerator_22248 (object->mAttribute_mInsertOrReplaceDeclarationListAST, kEnumeration_up) ;
  GALGAS_uint index_22213 ((uint32_t) 0) ;
  while (enumerator_22248.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, index_22213.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticWarning (enumerator_22248.current_mInsertOrReplaceDeclarationLocation (HERE), GALGAS_string ("the 'insertOrReplace' modifier is already declared")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 553)) ;
    }
    enumerator_22248.gotoNextObject () ;
    index_22213.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 551)) ;
  }
...
static void categoryMethod_uniqueMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_insertMethodListAST enumerator_24243 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_24243.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_24243.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 600)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_24243.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_24243.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 601))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 601)).operator_concat (GALGAS_string ("' insert method should name an automaton state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 601))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 601)) ;
      }else if (kBoolFalse == test_1) {
        var_initialStateSet.addAssign_operation (enumerator_24243.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 603))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 603)) ;
      }
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_24243.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 605)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_24243.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_24243.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 606))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 606)).operator_concat (GALGAS_string ("' insert method should not name an automaton state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 606))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 606)) ;
      }
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_24846 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_24846.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_24846.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 613)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_24846.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_24846.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 614))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 614)).operator_concat (GALGAS_string ("' search method should name an automaton action")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 614))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 614)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_mapAutomatonActionMap.reader_hasKey (enumerator_24846.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 615)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 615)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 615)).boolEnum () ;
        if (kBoolTrue == test_8) {
          {
          var_mapAutomatonActionMap.modifier_insertKey (enumerator_24846.current_mActionName (HERE), var_mapAutomatonActionMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 617)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 617)) ;
          }
        }
      }
    }else if (kBoolFalse == test_5) {
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_24846.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 621)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_24846.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the '").operator_concat (enumerator_24846.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 622))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 622)).operator_concat (GALGAS_string ("' search method should not name an automaton action")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 622))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 622)) ;
      }
    }
  ...
  cEnumerator_mapStateList enumerator_25659 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_25659.hasCurrentObject ()) {
    {
    var_mapAutomatonStateMap.modifier_insertKey (enumerator_25659.current_mStateName (HERE), var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 628)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 628)) ;
    }
    enumerator_25659.gotoNextObject () ;
  }
  cEnumerator_mapStateList enumerator_25785 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_25785.hasCurrentObject ()) {
    cEnumerator_mapStateTransitionList enumerator_25816 (enumerator_25785.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_25816.hasCurrentObject ()) {
      GALGAS_uint joker_25877_0 ; // Joker input parameter
      var_mapAutomatonStateMap.method_searchKey (enumerator_25816.current_mTargetStateName (HERE), joker_25877_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 632)) ;
      enumerator_25816.gotoNextObject () ;
    }
    enumerator_25785.gotoNextObject () ;
  }
  ...
  cEnumerator_mapStateList enumerator_26111 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_26111.hasCurrentObject ()) {
    ...
    cEnumerator_mapStateTransitionList enumerator_26276 (enumerator_26111.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_26276.hasCurrentObject ()) {
      GALGAS_uint var_actionIndex ;
      var_mapAutomatonActionMap.method_searchKey (enumerator_26276.current_mActionName (HERE), var_actionIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 643)) ;
      const enumGalgasBool test_11 = var_actionsForCurrentState.reader_hasKey (enumerator_26276.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 644)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 644)).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_location location_12 (enumerator_26276.current_mActionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_26276.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 645))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 645)).operator_concat (GALGAS_string ("' action is already used for this state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 645))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 645)) ;
      }
      var_actionsForCurrentState.addAssign_operation (enumerator_26276.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 647))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 647)) ;
      GALGAS_uint var_targetStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_26276.current_mTargetStateName (HERE), var_targetStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 649)) ;
      var_mapStateTransitionSortedList.addAssign_operation (var_actionIndex, enumerator_26276.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 652)), var_targetStateIndex, enumerator_26276.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 654)), enumerator_26276.current_mTransitionMessageKind (HERE), enumerator_26276.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 656))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 650)) ;
      enumerator_26276.gotoNextObject () ;
    }
    GALGAS_uint var_stateIndex ;
    var_mapAutomatonStateMap.method_searchKey (enumerator_26111.current_mStateName (HERE), var_stateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 660)) ;
    var_mapStateSortedList.addAssign_operation (var_stateIndex, enumerator_26111.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 663)), enumerator_26111.current_mStateMessageKind (HERE), enumerator_26111.current_mStateMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 665)), var_mapStateTransitionSortedList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 661)) ;
    ...
    if (kBoolTrue == test_13) {
      ...
      cEnumerator_stringset enumerator_27378 (var_missingActions, kEnumeration_up) ;
      while (enumerator_27378.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_27378.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 672)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 672))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 672)) ;
        if (enumerator_27378.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 673)) ;
        }
        enumerator_27378.gotoNextObject () ;
      }
      GALGAS_location location_14 (enumerator_26111.current_mStateName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_26111.gotoNextObject () ;
  }
  ...
  if (object->mAttribute_mMapStateList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 681)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 681)).isValid ()) {
    uint32_t variant_27716 = object->mAttribute_mMapStateList.reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 681)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 681)).uintValue () ;
    bool loop_27716 = true ;
    while (loop_27716) {
      loop_27716 = var_progress.isValid () ;
      if (loop_27716) {
        loop_27716 = var_progress.boolValue () ;
      }
      if (loop_27716 && (0 == variant_27716)) {
        loop_27716 = false ;
      ...
      if (loop_27716) {
        ...
        cEnumerator_mapStateList enumerator_27813 (object->mAttribute_mMapStateList, kEnumeration_up) ;
        while (enumerator_27813.hasCurrentObject ()) {
          const enumGalgasBool test_15 = var_accessibleStates.reader_hasKey (enumerator_27813.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 684)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 684)).boolEnum () ;
          if (kBoolTrue == test_15) {
            cEnumerator_mapStateTransitionList enumerator_27909 (enumerator_27813.current_mTransitionList (HERE), kEnumeration_up) ;
            while (enumerator_27909.hasCurrentObject ()) {
              const enumGalgasBool test_16 = var_accessibleStates.reader_hasKey (enumerator_27909.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 686)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 686)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 686)).boolEnum () ;
              if (kBoolTrue == test_16) {
                var_accessibleStates.addAssign_operation (enumerator_27909.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 687))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 687)) ;
                var_progress = GALGAS_bool (true) ;
              }
              enumerator_27909.gotoNextObject () ;
            }
          }
          enumerator_27813.gotoNextObject () ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_28337 (var_uselessStates, kEnumeration_up) ;
    while (enumerator_28337.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_28337.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 698)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 698))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 698)) ;
      if (enumerator_28337.hasNextObject ()) {
  ...
  cEnumerator_mapAutomatonStateMap enumerator_28707 (var_mapAutomatonStateMap, kEnumeration_up) ;
  while (enumerator_28707.hasCurrentObject ()) {
    ...
    var_reachableStates.addAssign_operation (enumerator_28707.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 709))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 709)) ;
    GALGAS_bool var_progress = GALGAS_bool (true) ;
    if (var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 711)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 711)).isValid ()) {
      uint32_t variant_28832 = var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 711)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 711)).uintValue () ;
      bool loop_28832 = true ;
      while (loop_28832) {
        loop_28832 = var_progress.isValid () ;
        if (loop_28832) {
          loop_28832 = var_progress.boolValue () ;
        }
        if (loop_28832 && (0 == variant_28832)) {
          loop_28832 = false ;
        ...
        if (loop_28832) {
          variant_28832 -- ;
          var_progress = GALGAS_bool (false) ;
          cEnumerator_mapStateList enumerator_28939 (object->mAttribute_mMapStateList, kEnumeration_up) ;
          while (enumerator_28939.hasCurrentObject ()) {
            const enumGalgasBool test_18 = var_reachableStates.reader_hasKey (enumerator_28939.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 714)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 714)).boolEnum () ;
            if (kBoolTrue == test_18) {
              cEnumerator_mapStateTransitionList enumerator_29038 (enumerator_28939.current_mTransitionList (HERE), kEnumeration_up) ;
              while (enumerator_29038.hasCurrentObject ()) {
                const enumGalgasBool test_19 = var_reachableStates.reader_hasKey (enumerator_29038.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 716)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 716)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 716)).boolEnum () ;
                if (kBoolTrue == test_19) {
                  var_reachableStates.addAssign_operation (enumerator_29038.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 717))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 717)) ;
                  var_accessibilityGraph.addAssign_operation (enumerator_28707.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 718)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 718)).operator_concat (enumerator_29038.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 718))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 718))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 718)) ;
                  var_progress = GALGAS_bool (true) ;
                }
                enumerator_29038.gotoNextObject () ;
              }
            }
            enumerator_28939.gotoNextObject () ;
          }
        }
      }
    }
    cEnumerator_stringset enumerator_29424 (var_reachableStates, kEnumeration_up) ;
    while (enumerator_29424.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_28707.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 726)).objectCompare (enumerator_29424.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_20) {
        var_neededAssociations.addAssign_operation (enumerator_28707.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 727)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 727)).operator_concat (enumerator_29424.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 727))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 727)) ;
      }
  ...
  cEnumerator_mapOverrideBlockListAST enumerator_29659 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
  while (enumerator_29659.hasCurrentObject ()) {
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_29907 (enumerator_29659.current_mMapOverrideBlockDescriptor_31_AST (HERE), kEnumeration_up) ;
    while (enumerator_29907.hasCurrentObject ()) {
      GALGAS_uint var_startStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_29907.current_mLeftState (HERE), var_startStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 739)) ;
      GALGAS_uint var_currentStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_29907.current_mRightState (HERE), var_currentStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 741)) ;
      GALGAS_string var_association = enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 742)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 742)).operator_concat (enumerator_29907.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 742))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 742)) ;
      ...
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_29907.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_23) {
        GALGAS_location location_24 (enumerator_29907.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_29907.current_mResultingState (HERE), var_finalStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 752)) ;
      const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 753)).objectCompare (enumerator_29907.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 753)))).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_neededCombinaisons.addAssign_operation (enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 754)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 754)).operator_concat (enumerator_29907.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 754))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 754))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 754)) ;
        var_neededCombinaisons.addAssign_operation (enumerator_29907.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 755)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 755)).operator_concat (enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 755))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 755))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 755)) ;
        const enumGalgasBool test_26 = var_accessibilityGraph.reader_hasKey (enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 756)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 756)).operator_concat (enumerator_29907.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 756))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 756)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 756)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 756)).boolEnum () ;
        if (kBoolTrue == test_26) {
          GALGAS_location location_27 (enumerator_29907.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_29907.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 758))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 758)).operator_concat (GALGAS_string ("' state is not reachable from '")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 758)).operator_concat (enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 758))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 758)).operator_concat (GALGAS_string ("' state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 758))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 757)) ;
        }
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_29907.current_mTransitionMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 762)) ;
      }
      var_branchBehaviourSortedListForMapOverride_31_.addAssign_operation (var_startStateNameIndex, enumerator_29907.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 765)), var_currentStateNameIndex, enumerator_29907.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 767)), var_finalStateNameIndex, enumerator_29907.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 769)), enumerator_29907.current_mMessageKind (HERE), enumerator_29907.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 771))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 763)) ;
    ...
    if (kBoolTrue == test_28) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_31763 (var_forgottenAssociations, kEnumeration_up) ;
      while (enumerator_31763.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_31763.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 778))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 778)) ;
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_32127 (enumerator_29659.current_mMapOverrideBlockDescriptor_32_AST (HERE), kEnumeration_up) ;
    while (enumerator_32127.hasCurrentObject ()) {
      GALGAS_uint var_leftStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_32127.current_mLeftState (HERE), var_leftStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 786)) ;
      GALGAS_uint var_rightStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_32127.current_mRightState (HERE), var_rightStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 788)) ;
      GALGAS_string var_combinaison = enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 789)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 789)).operator_concat (enumerator_32127.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 789))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 789)) ;
      ...
      if (kBoolTrue == test_29) {
        GALGAS_location location_30 (enumerator_32127.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_30, GALGAS_string ("the '").operator_concat (enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 792))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792)).operator_concat (enumerator_32127.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 792))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792)).operator_concat (GALGAS_string ("' combinaison is useless")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 792))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 791)) ;
      }
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_32127.current_mResultingState (HERE), var_resultingStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 800)) ;
      const enumGalgasBool test_33 = GALGAS_bool (kIsNotEqual, enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 801)).objectCompare (enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 801)))).operator_and (GALGAS_bool (kIsNotEqual, enumerator_32127.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 802)).objectCompare (enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 802)))) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 801)).operator_and (var_accessibilityGraph.reader_hasKey (enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 803)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 803)).operator_concat (enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 803))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 803)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 803)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 803)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 802)).boolEnum () ;
      if (kBoolTrue == test_33) {
        GALGAS_location location_34 (enumerator_32127.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_34, GALGAS_string ("the '").operator_concat (enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 805))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 805)).operator_concat (GALGAS_string ("' state cannot be reached from the '")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 805)).operator_concat (enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 805))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 805)).operator_concat (GALGAS_string ("' state")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 805))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 804)) ;
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_32127.current_mTransitionMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 807)) ;
      }
      const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_32127.current_mMessageKind (HERE).objectCompare (GALGAS_mapAutomatonMessageKind::constructor_noMessage (SOURCE_FILE ("semanticAnalysis.gSemantics", 808)))).boolEnum () ;
      if (kBoolTrue == test_35) {
        var_definedCombinaisons.addAssign_operation (enumerator_32127.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 809)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 809)).operator_concat (enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 809))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 809))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 809)) ;
        var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_rightStateIndex, enumerator_32127.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 812)), var_leftStateIndex, enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 814)), var_resultingStateNameIndex, enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 816)), enumerator_32127.current_mMessageKind (HERE), enumerator_32127.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 818))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 810)) ;
      }
      var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_leftStateIndex, enumerator_32127.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 823)), var_rightStateIndex, enumerator_32127.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 825)), var_resultingStateNameIndex, enumerator_32127.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 827)), enumerator_32127.current_mMessageKind (HERE), enumerator_32127.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 829))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 821)) ;
    ...
    if (kBoolTrue == test_36) {
      ...
      if (kBoolTrue == test_37) {
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_34448 (var_forgottenCombinaisons, kEnumeration_up) ;
        while (enumerator_34448.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_34448.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 837))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 837)) ;
    ...
    var_mapOverrideList.addAssign_operation (enumerator_29659.current_mOverrideBlockName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 843)), var_branchBehaviourSortedListForMapOverride_31_, var_branchBehaviourSortedListForMapOverride_32_  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 842)) ;
  ...
  cEnumerator_attributeInCollectionListAST enumerator_34959 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_34959.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_34959.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 852)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_34959.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 855)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_34959.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 861)) ;
    }
    enumerator_34959.gotoNextObject () ;
  }
  ...
  cEnumerator_insertMethodListAST enumerator_35381 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_35381.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_35381.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 866)) ;
    }
    cEnumerator_stringlist enumerator_35574 (enumerator_35381.current_mErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 868)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 868)), kEnumeration_up) ;
    while (enumerator_35574.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_35574.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 869)) ;
      {
      GALGAS_string joker_35690_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_35690_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 870)) ;
      }
      cEnumerator_stringlist enumerator_35722 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_35722.hasCurrentObject ()) {
        const enumGalgasBool test_38 = GALGAS_bool (kIsStrictSup, enumerator_35722.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 872)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_38) {
          GALGAS_char var_c = enumerator_35722.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 873)) ;
          ...
          if (kBoolTrue == test_39) {
            GALGAS_location location_40 (enumerator_35381.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_35722.gotoNextObject () ;
      }
      enumerator_35574.gotoNextObject () ;
    }
    cEnumerator_stringlist enumerator_36201 (enumerator_35381.current_mShadowErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 881)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 881)), kEnumeration_up) ;
    while (enumerator_36201.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_36201.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 882)) ;
      {
      GALGAS_string joker_36317_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_36317_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 883)) ;
      }
      cEnumerator_stringlist enumerator_36349 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_36349.hasCurrentObject ()) {
        const enumGalgasBool test_41 = GALGAS_bool (kIsStrictSup, enumerator_36349.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 885)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_41) {
          GALGAS_char var_c = enumerator_36349.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 886)) ;
          ...
          if (kBoolTrue == test_42) {
            GALGAS_location location_43 (enumerator_35381.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_36349.gotoNextObject () ;
      }
      enumerator_36201.gotoNextObject () ;
    }
    enumerator_35381.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_36797 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_36797.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_36797.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 898)) ;
      }
    }else if (kBoolFalse == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_36797.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 900)) ;
      }
    }
    cEnumerator_stringlist enumerator_37111 (enumerator_36797.current_mErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 903)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 903)), kEnumeration_up) ;
    while (enumerator_37111.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_37111.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 904)) ;
      {
      GALGAS_string joker_37227_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_37227_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 905)) ;
      }
      cEnumerator_stringlist enumerator_37259 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_37259.hasCurrentObject ()) {
        const enumGalgasBool test_45 = GALGAS_bool (kIsStrictSup, enumerator_37259.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.gSemantics", 907)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_45) {
          GALGAS_char var_c = enumerator_37259.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 908)) ;
          const enumGalgasBool test_46 = GALGAS_bool (kIsNotEqual, var_c.objectCompare (GALGAS_char (TO_UNICODE (75)))).boolEnum () ;
          if (kBoolTrue == test_46) {
            GALGAS_location location_47 (enumerator_36797.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_37259.gotoNextObject () ;
      }
      enumerator_37111.gotoNextObject () ;
    }
    enumerator_36797.gotoNextObject () ;
  }
...
static void categoryMethod_mapProxyDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_38829_7 ; // Joker input parameter
  GALGAS_bool joker_38829_6 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_38829_5 ; // Joker input parameter
  GALGAS_typeKindEnum joker_38829_4 ; // Joker input parameter
  GALGAS_bool joker_38829_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_38829_2 ; // Joker input parameter
  GALGAS_attributeMap joker_38829_1 ; // Joker input parameter
  GALGAS_constructorMap joker_38885_11 ; // Joker input parameter
  GALGAS_readerMap joker_38885_10 ; // Joker input parameter
  GALGAS_modifierMap joker_38885_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_38885_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_38885_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_38885_6 ; // Joker input parameter
  GALGAS_stringlist joker_38885_5 ; // Joker input parameter
  GALGAS_uint joker_38885_4 ; // Joker input parameter
  GALGAS_functionSignature joker_38885_3 ; // Joker input parameter
  GALGAS_stringset joker_38885_2 ; // Joker input parameter
  GALGAS_enumConstantList joker_38885_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_38941_6 ; // Joker input parameter
  GALGAS_bool joker_38941_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_38941_4 ; // Joker input parameter
  GALGAS_string joker_38941_3 ; // Joker input parameter
  GALGAS_string joker_38941_2 ; // Joker input parameter
  GALGAS_headerKind joker_38941_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_38829_7, joker_38829_6, joker_38829_5, joker_38829_4, joker_38829_3, joker_38829_2, joker_38829_1, var_listTypeAttributeList, joker_38885_11, joker_38885_10, joker_38885_9, joker_38885_8, joker_38885_7, joker_38885_6, joker_38885_5, joker_38885_4, joker_38885_3, joker_38885_2, joker_38885_1, var_searchMethodList, joker_38941_6, joker_38941_5, joker_38941_4, joker_38941_3, joker_38941_2, joker_38941_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 952)) ;
...
static void categoryMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_44719 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_44719.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_44719.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_44719.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1093)), enumerator_44719.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1094)), enumerator_44719.current_mFormalArgumentName (HERE), enumerator_44719.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1091)) ;
    enumerator_44719.gotoNextObject () ;
  }
...
static void categoryMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_45760 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_45760.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_45760.current_mFormalSelector (HERE), enumerator_45760.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_45760.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1124)), enumerator_45760.current_mFormalArgumentName (HERE), enumerator_45760.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1126))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1121)) ;
    enumerator_45760.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      cEnumerator_lstringlist enumerator_48512 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_48512.hasCurrentObject ()) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_48512.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1204)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = var_generatedInSeparateFileFeature.boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (enumerator_48512.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_5 (enumerator_48512.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_48512.gotoNextObject () ;
      }
    }
  }else if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_lstringlist enumerator_49173 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_49173.hasCurrentObject ()) {
        GALGAS_location location_7 (enumerator_49173.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_49173.gotoNextObject () ;
      }
    }
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_49456 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49456.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_49456.current_mAttributeTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1227)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_49644 (enumerator_49456.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_49644.hasCurrentObject ()) {
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_49644.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1231)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        const enumGalgasBool test_9 = var_hasSetter.boolEnum () ;
        if (kBoolTrue == test_9) {
          GALGAS_location location_10 (enumerator_49644.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_49644.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1236)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_hasGetter.operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1237)).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_49644.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_14 (enumerator_49644.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_typedAttributeList.addAssign_operation (var_t, enumerator_49456.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1245)) ;
    var_allAttributeList.addAssign_operation (var_t, enumerator_49456.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1251)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_49456.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1257)) ;
    }
    enumerator_49456.gotoNextObject () ;
  }
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1262)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1262)).isValid ()) {
    uint32_t variant_50561 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1262)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1262)).uintValue () ;
    bool loop_50561 = true ;
    while (loop_50561) {
      loop_50561 = var_t.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1263)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1263)).isValid () ;
      if (loop_50561) {
        loop_50561 = var_t.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1263)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1263)).boolValue () ;
      }
      if (loop_50561 && (0 == variant_50561)) {
        loop_50561 = false ;
...
static void categoryMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_formalInputParameterListForGeneration joker_56748_0 ; // Joker input parameter
  routine_analyzeFunctionBody (var_analysisContext, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 1429)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.gSemantics", 1430)), GALGAS_string::makeEmptyString (), object->mAttribute_mFunctionInstructionList, object->mAttribute_mResultVariableName, object->mAttribute_mResultTypeName, object->mAttribute_mEndOfFunctionInstructionList, joker_56748_0, var_returnType, var_resultVariableCppName, var_semanticInstructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1427)) ;
  }
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring joker_57920_0 ; // Joker input parameter
  GALGAS_lstringlist joker_57927_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_58018_2 ; // Joker input parameter
  GALGAS_bool joker_58018_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_57920_0, joker_57927_0, var_wrapperFileMap, var_wrapperDirectoryMap, joker_58018_2, joker_58018_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1468)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_filewrapperTemplateListAST enumerator_58655 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
    while (enumerator_58655.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_58655.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1489)).reader_firstCharacterOrNul (SOURCE_FILE ("semanticAnalysis.gSemantics", 1489)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_58655.current_mFilewrapperTemplatePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      cEnumerator_formalTemplateInputParameterListAST enumerator_59463 (enumerator_58655.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
      while (enumerator_59463.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_59463.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1500)) ;
        GALGAS_string var_cppVarName = GALGAS_string ("in_").operator_concat (enumerator_59463.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1501)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 1501))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1501)) ;
        {
        var_templateVariableMap.modifier_insertKey (enumerator_59463.current_mFormalArgumentName (HERE), var_type, var_cppVarName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1502)) ;
        }
        var_filewrapperTemplateFormalInputParameters.addAssign_operation (enumerator_59463.current_mFormalTemplateSelector (HERE), var_type, var_cppVarName, enumerator_59463.current_mFormalArgumentName (HERE), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1503)) ;
...
static void categoryMethod_abstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_62052 (object->mAttribute_mAbstractCategoryMethodFormalParameterList, kEnumeration_up) ;
  while (enumerator_62052.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_62052.current_mFormalSelector (HERE), enumerator_62052.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_62052.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1558)), enumerator_62052.current_mFormalArgumentName (HERE), enumerator_62052.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1560))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1555)) ;
    enumerator_62052.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).isValid ()) {
    uint32_t variant_65979 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1659)).uintValue () ;
    bool loop_65979 = true ;
    while (loop_65979) {
      loop_65979 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).isValid () ;
      if (loop_65979) {
        loop_65979 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1660)).boolValue () ;
      }
      if (loop_65979 && (0 == variant_65979)) {
        loop_65979 = false ;
      ...
      if (loop_65979) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_66288_0 ; // Joker input parameter
          GALGAS_bool joker_66341_0 ; // Joker input parameter
          GALGAS_string joker_66355_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1663)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_66288_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_66341_0, var_qualifier, joker_66355_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1663)) ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).isValid ()) {
    uint32_t variant_69510 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1744)).uintValue () ;
    bool loop_69510 = true ;
    while (loop_69510) {
      loop_69510 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).isValid () ;
      if (loop_69510) {
        loop_69510 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1745)).boolValue () ;
      }
      if (loop_69510 && (0 == variant_69510)) {
        loop_69510 = false ;
      ...
      if (loop_69510) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_69819_0 ; // Joker input parameter
          GALGAS_bool joker_69872_0 ; // Joker input parameter
          GALGAS_string joker_69886_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1748)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_69819_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_69872_0, var_qualifier, joker_69886_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1748)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_71807 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_71807.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_71807.current_mFormalSelector (HERE), enumerator_71807.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_71807.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1799)), enumerator_71807.current_mFormalArgumentName (HERE), enumerator_71807.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 1801))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1796)) ;
    enumerator_71807.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).isValid ()) {
    uint32_t variant_75558 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1897)).uintValue () ;
    bool loop_75558 = true ;
    while (loop_75558) {
      loop_75558 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).isValid () ;
      if (loop_75558) {
        loop_75558 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1898)).boolValue () ;
      }
      if (loop_75558 && (0 == variant_75558)) {
        loop_75558 = false ;
      ...
      if (loop_75558) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_75859_0 ; // Joker input parameter
          GALGAS_bool joker_75882_0 ; // Joker input parameter
          GALGAS_string joker_75896_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1901)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_75859_0, var_inheritedSignature, joker_75882_0, var_qualifier, joker_75896_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1901)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).isValid ()) {
    uint32_t variant_78877 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1979)).uintValue () ;
    bool loop_78877 = true ;
    while (loop_78877) {
      loop_78877 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).isValid () ;
      if (loop_78877) {
        loop_78877 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1980)).boolValue () ;
      }
      if (loop_78877 && (0 == variant_78877)) {
        loop_78877 = false ;
      ...
      if (loop_78877) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_79178_0 ; // Joker input parameter
          GALGAS_bool joker_79201_0 ; // Joker input parameter
          GALGAS_string joker_79215_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1983)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_79178_0, var_inheritedSignature, joker_79201_0, var_qualifier, joker_79215_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 1983)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_81140 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_81140.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_81140.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_81140.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2033)), enumerator_81140.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2034)), enumerator_81140.current_mFormalArgumentName (HERE), enumerator_81140.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2031)) ;
    enumerator_81140.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).isValid ()) {
    uint32_t variant_85423 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2145)).uintValue () ;
    bool loop_85423 = true ;
    while (loop_85423) {
      loop_85423 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).isValid () ;
      if (loop_85423) {
        loop_85423 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2146)).boolValue () ;
      }
      if (loop_85423 && (0 == variant_85423)) {
        loop_85423 = false ;
      ...
      if (loop_85423) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_85697_0 ; // Joker input parameter
          GALGAS_bool joker_85774_0 ; // Joker input parameter
          GALGAS_string joker_85851_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2148)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_85697_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_85774_0, var_inheritedReturnType, var_qualifier, joker_85851_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2148)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).isValid ()) {
    uint32_t variant_89320 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2245)).uintValue () ;
    bool loop_89320 = true ;
    while (loop_89320) {
      loop_89320 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).isValid () ;
      if (loop_89320) {
        loop_89320 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2246)).boolValue () ;
      }
      if (loop_89320 && (0 == variant_89320)) {
        loop_89320 = false ;
      ...
      if (loop_89320) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_89625_0 ; // Joker input parameter
          GALGAS_bool joker_89702_0 ; // Joker input parameter
          GALGAS_string joker_89761_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2249)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_89625_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_89702_0, var_inheritedReturnType, var_qualifier, joker_89761_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2249)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_formalInputParameterListAST enumerator_90283 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_90283.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (enumerator_90283.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_90283.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2274)), enumerator_90283.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 2275)), enumerator_90283.current_mFormalArgumentName (HERE), enumerator_90283.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 2272)) ;
      enumerator_90283.gotoNextObject () ;
    }
    {
