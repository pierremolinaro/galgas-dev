...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_151225 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_151225.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_151225.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3719)) ;
    enumerator_151225.gotoNextObject () ;
  }
  {
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_173639 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_173639.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_173639.current_mFormalSelector (HERE), enumerator_173639.current_mFormalArgumentType (HERE), enumerator_173639.current_mFormalArgumentPassingMode (HERE), enumerator_173639.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4334)) ;
    enumerator_173639.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxInstructionList enumerator_173994 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_173994.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_173994.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4340)) ;
    enumerator_173994.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_175523 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_175523.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_175607 (enumerator_175523.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_175607.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_175774 (enumerator_175607.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_175774.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_175774.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4390)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_175774.current_mFormalSelector (HERE), enumerator_175774.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_175774.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_175774.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4391))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4391))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4391)) ;
        var_signature.addAssign_operation (enumerator_175774.current_mFormalSelector (HERE), var_type, enumerator_175774.current_mFormalArgumentPassingMode (HERE), enumerator_175774.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4392)) ;
        enumerator_175774.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_175607.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_175607.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4394)) ;
      }
      enumerator_175607.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_175523.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4396)) ;
    }
    enumerator_175523.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4402)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4404))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4399)) ;
  ...
  cEnumerator_syntaxRuleListAST enumerator_176757 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_176757.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_176941_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176757.current_mNonterminalName (HERE), joker_176941_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4413)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_176968 (enumerator_176757.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_176968.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_176968.current_mFormalArguments (HERE), enumerator_176968.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 4425)), var_nonterminalMap, constinArgument_inComponentName, enumerator_176968.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4419)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_176968.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_176968.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4435)) ;
      enumerator_176968.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_177966_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176757.current_mNonterminalName (HERE), joker_177966_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4444)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_176757.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4446)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4445)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4450)) ;
    enumerator_176757.gotoNextObject () ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator__32_lstringlist enumerator_147510 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_147510.hasCurrentObject ()) {
    const enumGalgasBool test_11 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_147510.current_mValue_30_ (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3622)).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_147620 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_147620.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_147620.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3625))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3625)) ;
        enumerator_147620.gotoNextObject () ;
      }
      GALGAS_location location_12 (enumerator_147510.current_mValue_30_ (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_147510.current_mValue_30_ (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3627)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_148955 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_148955.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_148955.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_148955.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3665))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3665)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3665))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3665)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_148955.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (enumerator_148955.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)) ;
    enumerator_148955.gotoNextObject () ;
  }
  cEnumerator__32_lstringlist enumerator_149356 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_149356.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3674)).add_operation (GALGAS_string ("->enterIndexing (C_Lexique_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3674)).add_operation (object->mAttribute_mLexiqueIdentifier, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)).operator_concat (GALGAS_string ("::kIndexing_").add_operation (enumerator_149356.current_mValue_30_ (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675)).add_operation (enumerator_149356.current_mValue_31_ (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3676)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3676)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3676))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3675))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3674)) ;
    enumerator_149356.gotoNextObject () ;
  }
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_152858 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_152858.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_152858.current_mSyntaxInstructionList (HERE), enumerator_152858.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3774)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_152858.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3788)) ;
    enumerator_152858.gotoNextObject () ;
  }
  {
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_154839 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_154795 ((uint32_t) 0) ;
  while (enumerator_154839.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_154795.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3827))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3827)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_154839.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3828)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3836)) ;
    enumerator_154839.gotoNextObject () ;
    index_154795.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3826)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_156234 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_156234.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_156234.current_mSyntaxInstructionList (HERE), enumerator_156234.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3868)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_156234.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3882)) ;
    enumerator_156234.gotoNextObject () ;
  }
  {
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_157706 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_157662 ((uint32_t) 0) ;
  while (enumerator_157706.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_157662.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3907))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3907)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_157706.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3908)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3916)) ;
    enumerator_157706.gotoNextObject () ;
    index_157662.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3906)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_158901 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_158901.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_159067 (enumerator_158901.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_159067.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_159067.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3944)) ;
      enumerator_159067.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_158901.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3957)) ;
    enumerator_158901.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_159771_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_159771_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3962)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_159956 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_159956.hasCurrentObject () && bool_0) {
    while (enumerator_159956.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_159956.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3968)), enumerator_159956.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3966)) ;
      enumerator_159956.gotoNextObject () ;
      if (enumerator_159956.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_161135 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_161135.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_161135.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3994)) ;
    }
    if (enumerator_161135.hasNextObject ()) {
    ...
    enumerator_161135.gotoNextObject () ;
  }
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4039)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4038)) ;
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4158)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4157)) ;
  {
...
static void categoryMethod_syntaxSendInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysis.gSemantics", 4269)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4268)) ;
