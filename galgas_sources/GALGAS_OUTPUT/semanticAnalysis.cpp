...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_124117 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3065))) ;
  if (NULL != objectArray_124117) {
      macroValidSharedObject (objectArray_124117, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_124117->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE ("semanticAnalysis.gSemantics", 3066)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_stringset enumerator_124517 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_124517.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_124517.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3072))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3072)) ;
        enumerator_124517.gotoNextObject () ;
      }
    ...
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_124897 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_124897.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_124897.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3082))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3082)) ;
        enumerator_124897.gotoNextObject () ;
      }
    ...
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_125191 (objectArray_124117->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_125214 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_125191.hasCurrentObject () && enumerator_125214.hasCurrentObject ()) {
        ...
        cEnumerator_formalParameterSignature enumerator_125316 (enumerator_125214.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_125316.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_125316.current_mFormalSelector (HERE), enumerator_125316.current_mFormalArgumentType (HERE), enumerator_125316.current_mFormalArgumentPassingMode (HERE), enumerator_125316.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3092)) ;
          enumerator_125316.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_125191.current_mSignatureForGeneration (HERE), enumerator_125191.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_125214.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3094)) ;
        }
        enumerator_125191.gotoNextObject () ;
        enumerator_125214.gotoNextObject () ;
      }
    }
  }else{
    {
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_126193 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_126193.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_126274 (enumerator_126193.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_126274.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_126444 (enumerator_126274.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_126444.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_t = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_126444.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3122)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_126444.current_mFormalSelector (HERE), enumerator_126444.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_126444.current_mFormalArgumentName (HERE), enumerator_126444.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3123))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3123)) ;
        var_signature.addAssign_operation (enumerator_126444.current_mFormalSelector (HERE), var_t, enumerator_126444.current_mFormalArgumentPassingMode (HERE), enumerator_126444.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3124)) ;
        enumerator_126444.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_126274.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_126274.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3126)) ;
      }
      enumerator_126274.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_126193.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3128)) ;
    }
    enumerator_126193.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_173503 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_173503.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_173503.current_mFormalSelector (HERE), enumerator_173503.current_mFormalArgumentType (HERE), enumerator_173503.current_mFormalArgumentPassingMode (HERE), enumerator_173503.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4327)) ;
    enumerator_173503.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxInstructionList enumerator_173858 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_173858.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_173858.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4333)) ;
    enumerator_173858.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_175387 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_175387.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_175471 (enumerator_175387.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_175471.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_175638 (enumerator_175471.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_175638.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_175638.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4383)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_175638.current_mFormalSelector (HERE), enumerator_175638.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_175638.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_175638.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4384))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4384))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4384)) ;
        var_signature.addAssign_operation (enumerator_175638.current_mFormalSelector (HERE), var_type, enumerator_175638.current_mFormalArgumentPassingMode (HERE), enumerator_175638.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4385)) ;
        enumerator_175638.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_175471.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_175471.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4387)) ;
      }
      enumerator_175471.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_175387.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4389)) ;
    }
    enumerator_175387.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxRuleListAST enumerator_176624 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_176624.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_176808 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176624.current_mNonterminalName (HERE), joker_176808, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4406)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_176835 (enumerator_176624.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_176835.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_176835.current_mFormalArguments (HERE), enumerator_176835.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 4418)), var_nonterminalMap, constinArgument_inComponentName, enumerator_176835.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4412)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_176835.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_176835.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4428)) ;
      enumerator_176835.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_177833 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_176624.current_mNonterminalName (HERE), joker_177833, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4437)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_176624.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 4439)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4438)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 4443)) ;
    enumerator_176624.gotoNextObject () ;
  }
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_129415 ; // Joker input parameter
    GALGAS_location joker_129429 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_129415, var_signature, joker_129429, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3192)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_actualParameterListForGeneration enumerator_130813 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  while (enumerator_130813.hasCurrentObject ()) {
    GALGAS_string var_parameterCppName ;
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_130813.current_mActualParameter (HERE).ptr (), ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3235)) ;
    var_parameterCppNameList.addAssign_operation (var_parameterCppName  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3244)) ;
    enumerator_130813.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_131562 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_131562.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_131562.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3253))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3253)) ;
    enumerator_131562.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_132119 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_132119.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_132119.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3268))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3268)) ;
    enumerator_132119.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_133598 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_133598, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3306)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_type ;
  {
  GALGAS_string joker_140171 ; // Joker input parameter
  GALGAS_string joker_140174 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_140171, joker_140174, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3450)) ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_146792 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_146811 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_146792.hasCurrentObject () && enumerator_146811.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_146792.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_146811.current_mLexicalType (HERE), enumerator_146811.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3601)) ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_146811.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_146792.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string temp_7 ;
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_146811.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_8) {
        temp_7 = GALGAS_string (":") ;
      }else if (kBoolFalse == test_8) {
        temp_7 = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_location location_9 (enumerator_146792.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the actual selector should be '\?").operator_concat (enumerator_146811.current_mLexicalFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3609))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3609)).operator_concat (temp_7.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3609))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3609))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3609)) ;
      GALGAS_location location_10 (enumerator_146811.current_mLexicalFormalSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_146792.gotoNextObject () ;
    enumerator_146811.gotoNextObject () ;
  }
  cEnumerator__32_lstringlist enumerator_147370 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_147370.hasCurrentObject ()) {
    const enumGalgasBool test_11 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_147370.current_mValue_30_ (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3615)) COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3615)).operator_not (SOURCE_FILE ("semanticAnalysis.gSemantics", 3615)).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_147480 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_147480.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_147480.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3618))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3618)) ;
        enumerator_147480.gotoNextObject () ;
      }
      GALGAS_location location_12 (enumerator_147370.current_mValue_30_ (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_147370.current_mValue_30_ (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3620))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3620)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3620)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3620))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3620)) ;
    }
    enumerator_147370.gotoNextObject () ;
  }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_148815 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_148815.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_148815.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_148815.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3658))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3658)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3658))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3658)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_148815.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)).operator_concat (enumerator_148815.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3662))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3662))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3661)) ;
    enumerator_148815.gotoNextObject () ;
  }
  cEnumerator__32_lstringlist enumerator_149216 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_149216.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3667)).add_operation (GALGAS_string ("->enterIndexing (C_Lexique_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3667)).add_operation (object->mAttribute_mLexiqueIdentifier, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).operator_concat (GALGAS_string ("::kIndexing_").add_operation (enumerator_149216.current_mValue_30_ (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668)).add_operation (enumerator_149216.current_mValue_31_ (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("semanticAnalysis.gSemantics", 3669)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3669)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3668))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3667)) ;
    enumerator_149216.gotoNextObject () ;
  }
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_152718 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_152718.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_152718.current_mSyntaxInstructionList (HERE), enumerator_152718.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3767)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_152718.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3781)) ;
    enumerator_152718.gotoNextObject () ;
  }
  {
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_154699 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_154655 ((uint32_t) 0) ;
  while (enumerator_154699.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_154655.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3820)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3820))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3820)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3820))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3820)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_154699.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3821)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3829)) ;
    enumerator_154699.gotoNextObject () ;
    index_154655.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3819)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_156094 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_156094.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_156094.current_mSyntaxInstructionList (HERE), enumerator_156094.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3861)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_156094.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3875)) ;
    enumerator_156094.gotoNextObject () ;
  }
  {
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_157566 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_157522 ((uint32_t) 0) ;
  while (enumerator_157566.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_157522.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3900)).reader_string (SOURCE_FILE ("semanticAnalysis.gSemantics", 3900))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3900)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3900))  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3900)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_157566.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3901)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3909)) ;
    enumerator_157566.gotoNextObject () ;
    index_157522.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3899)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_158761 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_158761.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_158927 (enumerator_158761.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_158927.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_158927.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3937)) ;
      enumerator_158927.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_158761.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3950)) ;
    enumerator_158761.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_159631 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_159631, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3955)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_159816 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_159816.hasCurrentObject () && bool_0) {
    while (enumerator_159816.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_159816.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3961)), enumerator_159816.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3959)) ;
      enumerator_159816.gotoNextObject () ;
      if (enumerator_159816.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_160995 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_160995.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_160995.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.gSemantics", 3987)) ;
    }
    if (enumerator_160995.hasNextObject ()) {
    ...
    enumerator_160995.gotoNextObject () ;
  }
