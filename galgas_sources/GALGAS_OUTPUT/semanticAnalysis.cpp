...
void routine_check_5F_K_5F_escapeCharacters (GALGAS_lstring inArgument_inString,
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_17268 (inArgument_inString.reader_string (SOURCE_FILE_AT_LINE (432)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (432)), kEnumeration_up) ;
  while (enumerator_17268.hasCurrentObject ()) {
    GALGAS_stringlist var_explodedArray = enumerator_17268.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (433)) ;
    {
    GALGAS_string joker_17378_0 ; // Joker input parameter
    var_explodedArray.modifier_popFirst (joker_17378_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
    }
    cEnumerator_stringlist enumerator_17410 (var_explodedArray, kEnumeration_up) ;
    while (enumerator_17410.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_17410.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (436)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_char var_c = enumerator_17410.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) ;
...
void routine_check_5F_K_5F_L_5F_escapeCharacters (GALGAS_lstring inArgument_inString,
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_17963 (inArgument_inString.reader_string (SOURCE_FILE_AT_LINE (452)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (452)), kEnumeration_up) ;
  while (enumerator_17963.hasCurrentObject ()) {
    GALGAS_stringlist var_explodedArray = enumerator_17963.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (453)) ;
    {
    GALGAS_string joker_18073_0 ; // Joker input parameter
    var_explodedArray.modifier_popFirst (joker_18073_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
    }
    cEnumerator_stringlist enumerator_18105 (var_explodedArray, kEnumeration_up) ;
    while (enumerator_18105.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_18105.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (456)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_char var_c = enumerator_18105.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
...
void routine_buildLocalVariableMapAndSignature (const GALGAS_semanticContext constinArgument_inSemanticContext,
  ...
  cEnumerator_formalParameterListAST enumerator_38046 (constinArgument_inRoutineSignatureAST, kEnumeration_up) ;
  while (enumerator_38046.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_38046.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (960)) ;
    GALGAS_string var_formalArgumentCppName ;
    if (enumerator_38046.current_mFormalArgumentPassingMode (HERE).isValid ()) {
      switch (enumerator_38046.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
      case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
        break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
        var_formalArgumentCppName = GALGAS_string ("inArgument_").operator_concat (enumerator_38046.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (964)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (964)) COMMA_SOURCE_FILE_AT_LINE (964)) ;
        const enumGalgasBool test_0 = enumerator_38046.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
          }
        }else if (kBoolFalse == test_0) {
          {
          ioArgument_ioVariableMap.modifier_insertInputFormalArgument (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (968)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
        var_formalArgumentCppName = GALGAS_string ("outArgument_").operator_concat (enumerator_38046.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (971)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (971)) COMMA_SOURCE_FILE_AT_LINE (971)) ;
        {
        ioArgument_ioVariableMap.modifier_insertOutputFormalArgument (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
        var_formalArgumentCppName = GALGAS_string ("ioArgument_").operator_concat (enumerator_38046.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (974)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)) ;
        const enumGalgasBool test_1 = enumerator_38046.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (976)) ;
          }
        }else if (kBoolFalse == test_1) {
          {
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgument (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
          }
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
        var_formalArgumentCppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_38046.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (981)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (981)) COMMA_SOURCE_FILE_AT_LINE (981)) ;
        const enumGalgasBool test_2 = enumerator_38046.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
          }
        }else if (kBoolFalse == test_2) {
          {
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgument (enumerator_38046.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (985)) ;
          }
        }
        } break ;
      }
    }
    outArgument_outRoutineSignature.addAssign_operation (enumerator_38046.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_38046.current_mFormalArgumentName (HERE), var_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (988)) ;
    enumerator_38046.gotoNextObject () ;
  }
}
...
void routine_analyzeRoutineBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_localConstantList enumerator_40734 (constinArgument_inLocalConstantList, kEnumeration_up) ;
  while (enumerator_40734.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_40734.current_mNoWarningIfUnused (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      var_variableMap.modifier_insertUsedLocalConstant (enumerator_40734.current_mName (HERE), enumerator_40734.current_mType (HERE), enumerator_40734.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      }
    }else if (kBoolFalse == test_0) {
      {
      var_variableMap.modifier_insertLocalConstant (enumerator_40734.current_mName (HERE), enumerator_40734.current_mType (HERE), enumerator_40734.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1012)) ;
      }
    }
    enumerator_40734.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_41108 (constinArgument_inNonMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_41108.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_41108.current_mAttributeName (HERE), enumerator_41108.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1020)).operator_concat (enumerator_41108.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1020)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1020)) COMMA_SOURCE_FILE_AT_LINE (1020)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1017)) ;
    }
    enumerator_41108.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_41456 (constinArgument_inMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_41456.hasCurrentObject ()) {
    {
    var_variableMap.modifier_insertMutableAttribute (enumerator_41456.current_mAttributeName (HERE), enumerator_41456.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1029)).operator_concat (enumerator_41456.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1029)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1029)) COMMA_SOURCE_FILE_AT_LINE (1029)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    }
  ...
  cEnumerator_semanticInstructionListAST enumerator_42059 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_42059.hasCurrentObject ()) {
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_42059.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
    enumerator_42059.gotoNextObject () ;
  }
...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  cEnumerator_lstringlist enumerator_88799 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (2246)), kEnumeration_up) ;
  while (enumerator_88799.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_88799.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_88799.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)).operator_concat (GALGAS_string ("' type is undefined") COMMA_SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)) ;
  ...
  cEnumerator_semanticDeclarationListAST enumerator_89053 (constinArgument_inDeclarationList, kEnumeration_up) ;
  while (enumerator_89053.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_89053.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2252)) ;
    enumerator_89053.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_semanticDeclarationListAST enumerator_89423 (var_semanticDeclarationList, kEnumeration_up) ;
    while (enumerator_89423.hasCurrentObject ()) {
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_89423.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (2259)) ;
...
static void categoryMethod_structDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_10962 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_10962.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_10962.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (256)) ;
    cEnumerator_lstringlist enumerator_11080 (enumerator_10962.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_11080.hasCurrentObject ()) {
      GALGAS_location location_0 (enumerator_11080.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_typedAttributeList.addAssign_operation (var_t, enumerator_10962.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (262)) ;
    const enumGalgasBool test_1 = function_forbiddenKeysForStruct (inCompiler COMMA_SOURCE_FILE_AT_LINE (268)).reader_hasKey (enumerator_10962.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (268)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_string var_m = GALGAS_string ("an attribute cannot be named:") ;
      cEnumerator_stringset enumerator_11489 (function_forbiddenKeysForStruct (inCompiler COMMA_SOURCE_FILE_AT_LINE (270)), kEnumeration_up) ;
      while (enumerator_11489.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" ").operator_concat (enumerator_11489.current (HERE) COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)) ;
      ...
      GALGAS_location location_2 (enumerator_10962.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, var_m COMMA_SOURCE_FILE_AT_LINE (274)) ;
    }
    {
    var_attributeMap.modifier_insertKey (enumerator_10962.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (276)) ;
    }
...
static void categoryMethod_graphDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_graphInsertModifierList enumerator_12819 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_12819.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_reservedModifierNames.reader_hasKey (enumerator_12819.current_mInsertModifierName (HERE).reader_string (SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_12819.current_mInsertModifierName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_12819.current_mInsertModifierName (HERE).reader_string (SOURCE_FILE_AT_LINE (305)) COMMA_SOURCE_FILE_AT_LINE (305)).operator_concat (GALGAS_string ("' modifier name is reserved for a graph type") COMMA_SOURCE_FILE_AT_LINE (305)) COMMA_SOURCE_FILE_AT_LINE (305)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_12819.current_mInsertErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (307)) ;
    }
...
static void categoryMethod_enumDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_14662 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_14662.hasCurrentObject ()) {
    var_constantList.addAssign_operation (enumerator_14662.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
    {
    var_constantMap.modifier_insertKey (enumerator_14662.current_mValue (HERE), var_constantMap.reader_count (SOURCE_FILE_AT_LINE (360)), inCompiler COMMA_SOURCE_FILE_AT_LINE (360)) ;
    }
...
static void categoryMethod_listmapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_16115_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_16115_1 ; // Joker input parameter
  GALGAS_attributeMap joker_16157_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_16157_18 ; // Joker input parameter
  GALGAS_constructorMap joker_16157_17 ; // Joker input parameter
  GALGAS_readerMap joker_16157_16 ; // Joker input parameter
  GALGAS_modifierMap joker_16157_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_16157_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_16157_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_16157_12 ; // Joker input parameter
  GALGAS_stringlist joker_16157_11 ; // Joker input parameter
  GALGAS_uint joker_16157_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_16157_9 ; // Joker input parameter
  GALGAS_stringset joker_16157_8 ; // Joker input parameter
  GALGAS_lstringlist joker_16157_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_16157_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_16157_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_16157_4 ; // Joker input parameter
  GALGAS_bool joker_16157_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_16157_2 ; // Joker input parameter
  GALGAS_string joker_16157_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_16115_2, joker_16115_1, var_typeKindEnum, var_listTypeAttributeList, joker_16157_19, joker_16157_18, joker_16157_17, joker_16157_16, joker_16157_15, joker_16157_14, joker_16157_13, joker_16157_12, joker_16157_11, joker_16157_10, joker_16157_9, joker_16157_8, joker_16157_7, joker_16157_6, joker_16157_5, joker_16157_4, joker_16157_3, joker_16157_2, joker_16157_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
...
static void categoryMethod_mapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_19146 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_19146.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_19146.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (486)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_19146.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (489)) ;
    const enumGalgasBool test_0 = function_forbiddenKeysForMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (495)).reader_hasKey (enumerator_19146.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (495)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_m = GALGAS_string ("an attribute cannot be named:") ;
      cEnumerator_stringset enumerator_19556 (function_forbiddenKeysForMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (497)), kEnumeration_up) ;
      while (enumerator_19556.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" ").operator_concat (enumerator_19556.current (HERE) COMMA_SOURCE_FILE_AT_LINE (498)) COMMA_SOURCE_FILE_AT_LINE (498)) ;
      ...
      GALGAS_location location_1 (enumerator_19146.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, var_m COMMA_SOURCE_FILE_AT_LINE (501)) ;
    }
    {
    var_attributeMap.modifier_insertKey (enumerator_19146.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
    }
    enumerator_19146.gotoNextObject () ;
  }
  GALGAS_insertMethodMap var_insertMethodMap = GALGAS_insertMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (506)) ;
  cEnumerator_insertMethodListAST enumerator_19857 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_19857.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_19857.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_19857.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (509)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_19857.current_mShadowErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (510)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_20135 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_20135.hasCurrentObject ()) {
    {
    var_searchMethodMap.modifier_insertKey (enumerator_20135.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (515)) ;
    }
    {
    routine_check_5F_K_5F_escapeCharacters (enumerator_20135.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
    }
    enumerator_20135.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_20309 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_20309.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_20309.current_mMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (520)) ;
    }
    {
    routine_check_5F_K_5F_escapeCharacters (enumerator_20309.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (521)) ;
    }
    enumerator_20309.gotoNextObject () ;
  }
  cEnumerator_insertOrReplaceDeclarationListAST enumerator_20539 (object->mAttribute_mInsertOrReplaceDeclarationListAST, kEnumeration_up) ;
  GALGAS_uint index_20533 ((PMUInt32) 0) ;
  while (enumerator_20539.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, index_20533.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticWarning (enumerator_20539.current_mInsertOrReplaceDeclarationLocation (HERE), GALGAS_string ("the 'insertOrReplace' modifier is already declared") COMMA_SOURCE_FILE_AT_LINE (526)) ;
    }
    enumerator_20539.gotoNextObject () ;
    index_20533.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_21405 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_21405.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_21405.current_mSearchMethodName (HERE), constinArgument_inPredefinedTypes.mAttribute_mLStringType, inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
    }
    enumerator_21405.gotoNextObject () ;
  }
...
static void categoryMethod_uniqueMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_insertMethodListAST enumerator_22321 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_22321.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_22321.current_mInitialStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (571)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_22321.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_22321.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)).operator_concat (GALGAS_string ("' insert method should name an automaton state") COMMA_SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)) ;
      }else if (kBoolFalse == test_1) {
        var_initialStateSet.addAssign_operation (enumerator_22321.current_mInitialStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)) ;
      }
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_22321.current_mInitialStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (576)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_22321.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_22321.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (577)) COMMA_SOURCE_FILE_AT_LINE (577)).operator_concat (GALGAS_string ("' insert method should not name an automaton state") COMMA_SOURCE_FILE_AT_LINE (577)) COMMA_SOURCE_FILE_AT_LINE (577)) ;
      }
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_22924 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_22924.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_22924.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (584)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_22924.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_22924.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (585)) COMMA_SOURCE_FILE_AT_LINE (585)).operator_concat (GALGAS_string ("' search method should name an automaton action") COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_SOURCE_FILE_AT_LINE (585)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_mapAutomatonActionMap.reader_hasKey (enumerator_22924.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)).operator_not (SOURCE_FILE_AT_LINE (586)).boolEnum () ;
        if (kBoolTrue == test_8) {
          {
          var_mapAutomatonActionMap.modifier_insertKey (enumerator_22924.current_mActionName (HERE), var_mapAutomatonActionMap.reader_count (SOURCE_FILE_AT_LINE (588)), inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
          }
        }
      }
    }else if (kBoolFalse == test_5) {
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_22924.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (592)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_22924.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the '").operator_concat (enumerator_22924.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (593)) COMMA_SOURCE_FILE_AT_LINE (593)).operator_concat (GALGAS_string ("' search method should not name an automaton action") COMMA_SOURCE_FILE_AT_LINE (593)) COMMA_SOURCE_FILE_AT_LINE (593)) ;
      }
    }
    enumerator_22924.gotoNextObject () ;
  }
  ...
  cEnumerator_mapStateList enumerator_23737 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_23737.hasCurrentObject ()) {
    {
    var_mapAutomatonStateMap.modifier_insertKey (enumerator_23737.current_mStateName (HERE), var_mapAutomatonStateMap.reader_count (SOURCE_FILE_AT_LINE (599)), inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
    }
    enumerator_23737.gotoNextObject () ;
  }
  cEnumerator_mapStateList enumerator_23863 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_23863.hasCurrentObject ()) {
    cEnumerator_mapStateTransitionList enumerator_23894 (enumerator_23863.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_23894.hasCurrentObject ()) {
      GALGAS_uint joker_23953_0 ; // Joker input parameter
      var_mapAutomatonStateMap.method_searchKey (enumerator_23894.current_mTargetStateName (HERE), joker_23953_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (603)) ;
  ...
  cEnumerator_mapStateList enumerator_24189 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_24189.hasCurrentObject ()) {
    ...
    cEnumerator_mapStateTransitionList enumerator_24354 (enumerator_24189.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_24354.hasCurrentObject ()) {
      GALGAS_uint var_actionIndex ;
      var_mapAutomatonActionMap.method_searchKey (enumerator_24354.current_mActionName (HERE), var_actionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (614)) ;
      const enumGalgasBool test_11 = var_actionsForCurrentState.reader_hasKey (enumerator_24354.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_location location_12 (enumerator_24354.current_mActionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_24354.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (616)) COMMA_SOURCE_FILE_AT_LINE (616)).operator_concat (GALGAS_string ("' action is already used for this state") COMMA_SOURCE_FILE_AT_LINE (616)) COMMA_SOURCE_FILE_AT_LINE (616)) ;
      }
      var_actionsForCurrentState.addAssign_operation (enumerator_24354.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (618)) COMMA_SOURCE_FILE_AT_LINE (618)) ;
      GALGAS_uint var_targetStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_24354.current_mTargetStateName (HERE), var_targetStateIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
      var_mapStateTransitionSortedList.addAssign_operation (var_actionIndex, enumerator_24354.current_mActionName (HERE).reader_string (SOURCE_FILE_AT_LINE (623)), var_targetStateIndex, enumerator_24354.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (625)), enumerator_24354.current_mTransitionMessageKind (HERE), enumerator_24354.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (621)) ;
      enumerator_24354.gotoNextObject () ;
    }
    GALGAS_uint var_stateIndex ;
    var_mapAutomatonStateMap.method_searchKey (enumerator_24189.current_mStateName (HERE), var_stateIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (631)) ;
    var_mapStateSortedList.addAssign_operation (var_stateIndex, enumerator_24189.current_mStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (634)), enumerator_24189.current_mStateMessageKind (HERE), enumerator_24189.current_mStateMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (636)), var_mapStateTransitionSortedList COMMA_SOURCE_FILE_AT_LINE (632)) ;
    ...
    if (kBoolTrue == test_13) {
      ...
      cEnumerator_stringset enumerator_25464 (var_missingActions, kEnumeration_up) ;
      while (enumerator_25464.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_25464.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (643)) COMMA_SOURCE_FILE_AT_LINE (643)) ;
        if (enumerator_25464.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (644)) ;
        }
        enumerator_25464.gotoNextObject () ;
      }
      GALGAS_location location_14 (enumerator_24189.current_mStateName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_24189.gotoNextObject () ;
  }
  ...
  if (object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (652)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (652)).isValid ()) {
    PMUInt32 variant_25793 = object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (652)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (652)).uintValue () ;
    bool loop_25793 = true ;
    while (loop_25793) {
      loop_25793 = var_progress.isValid () ;
      if (loop_25793) {
        loop_25793 = var_progress.boolValue () ;
      }
      if (loop_25793 && (0 == variant_25793)) {
        loop_25793 = false ;
      ...
      if (loop_25793) {
        ...
        cEnumerator_mapStateList enumerator_25891 (object->mAttribute_mMapStateList, kEnumeration_up) ;
        while (enumerator_25891.hasCurrentObject ()) {
          const enumGalgasBool test_15 = var_accessibleStates.reader_hasKey (enumerator_25891.current_mStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (655)) COMMA_SOURCE_FILE_AT_LINE (655)).boolEnum () ;
          if (kBoolTrue == test_15) {
            cEnumerator_mapStateTransitionList enumerator_25987 (enumerator_25891.current_mTransitionList (HERE), kEnumeration_up) ;
            while (enumerator_25987.hasCurrentObject ()) {
              const enumGalgasBool test_16 = var_accessibleStates.reader_hasKey (enumerator_25987.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)).operator_not (SOURCE_FILE_AT_LINE (657)).boolEnum () ;
              if (kBoolTrue == test_16) {
                var_accessibleStates.addAssign_operation (enumerator_25987.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (658)) ;
                var_progress = GALGAS_bool (true) ;
              }
              enumerator_25987.gotoNextObject () ;
            }
          }
          enumerator_25891.gotoNextObject () ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_26421 (var_uselessStates, kEnumeration_up) ;
    while (enumerator_26421.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_26421.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (669)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)) ;
      if (enumerator_26421.hasNextObject ()) {
  ...
  cEnumerator_mapAutomatonStateMap enumerator_26785 (var_mapAutomatonStateMap, kEnumeration_up) ;
  while (enumerator_26785.hasCurrentObject ()) {
    GALGAS_stringset var_reachableStates = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (679)) ;
    var_reachableStates.addAssign_operation (enumerator_26785.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
    GALGAS_bool var_progress = GALGAS_bool (true) ;
    if (var_mapAutomatonStateMap.reader_count (SOURCE_FILE_AT_LINE (682)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (682)).isValid ()) {
      PMUInt32 variant_26909 = var_mapAutomatonStateMap.reader_count (SOURCE_FILE_AT_LINE (682)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (682)).uintValue () ;
      ...
      while (loop_26909) {
        ...
        if (loop_26909) {
          variant_26909 -- ;
          var_progress = GALGAS_bool (false) ;
          cEnumerator_mapStateList enumerator_27017 (object->mAttribute_mMapStateList, kEnumeration_up) ;
          while (enumerator_27017.hasCurrentObject ()) {
            const enumGalgasBool test_18 = var_reachableStates.reader_hasKey (enumerator_27017.current_mStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)).boolEnum () ;
            if (kBoolTrue == test_18) {
              cEnumerator_mapStateTransitionList enumerator_27116 (enumerator_27017.current_mTransitionList (HERE), kEnumeration_up) ;
              while (enumerator_27116.hasCurrentObject ()) {
                const enumGalgasBool test_19 = var_reachableStates.reader_hasKey (enumerator_27116.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)).operator_not (SOURCE_FILE_AT_LINE (687)).boolEnum () ;
                if (kBoolTrue == test_19) {
                  var_reachableStates.addAssign_operation (enumerator_27116.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)) ;
                  var_accessibilityGraph.addAssign_operation (enumerator_26785.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (689)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (689)).operator_concat (enumerator_27116.current_mTargetStateName (HERE).reader_string (SOURCE_FILE_AT_LINE (689)) COMMA_SOURCE_FILE_AT_LINE (689)) COMMA_SOURCE_FILE_AT_LINE (689)) ;
                  var_progress = GALGAS_bool (true) ;
                }
                enumerator_27116.gotoNextObject () ;
              }
            }
            enumerator_27017.gotoNextObject () ;
          }
        }
      }
    }
    cEnumerator_stringset enumerator_27502 (var_reachableStates, kEnumeration_up) ;
    while (enumerator_27502.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_26785.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (697)).objectCompare (enumerator_27502.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_20) {
        var_neededAssociations.addAssign_operation (enumerator_26785.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (698)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (698)).operator_concat (enumerator_27502.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (698)) COMMA_SOURCE_FILE_AT_LINE (698)) ;
      }
      enumerator_27502.gotoNextObject () ;
    }
    enumerator_26785.gotoNextObject () ;
  }
  GALGAS_mapOverrideList var_mapOverrideList = GALGAS_mapOverrideList::constructor_emptyList (SOURCE_FILE_AT_LINE (703)) ;
  cEnumerator_mapOverrideBlockListAST enumerator_27737 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
  while (enumerator_27737.hasCurrentObject ()) {
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_27985 (enumerator_27737.current_mMapOverrideBlockDescriptor_31_AST (HERE), kEnumeration_up) ;
    while (enumerator_27985.hasCurrentObject ()) {
      GALGAS_uint var_startStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_27985.current_mLeftState (HERE), var_startStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
      GALGAS_uint var_currentStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_27985.current_mRightState (HERE), var_currentStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
      GALGAS_string var_association = enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (713)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (713)).operator_concat (enumerator_27985.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
      ...
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_27985.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_23) {
        GALGAS_location location_24 (enumerator_27985.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_27985.current_mResultingState (HERE), var_finalStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
      const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (724)).objectCompare (enumerator_27985.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (724)))).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_neededCombinaisons.addAssign_operation (enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (enumerator_27985.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) ;
        var_neededCombinaisons.addAssign_operation (enumerator_27985.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (726)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (726)).operator_concat (enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)) ;
        const enumGalgasBool test_26 = var_accessibilityGraph.reader_hasKey (enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (727)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (727)).operator_concat (enumerator_27985.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)).operator_not (SOURCE_FILE_AT_LINE (727)).boolEnum () ;
        if (kBoolTrue == test_26) {
          GALGAS_location location_27 (enumerator_27985.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_27985.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (GALGAS_string ("' state is not reachable from '") COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (GALGAS_string ("' state") COMMA_SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (728)) ;
        }
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_27985.current_mTransitionMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (733)) ;
      }
      var_branchBehaviourSortedListForMapOverride_31_.addAssign_operation (var_startStateNameIndex, enumerator_27985.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (736)), var_currentStateNameIndex, enumerator_27985.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (738)), var_finalStateNameIndex, enumerator_27985.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (740)), enumerator_27985.current_mMessageKind (HERE), enumerator_27985.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (734)) ;
      enumerator_27985.gotoNextObject () ;
    }
    ...
    if (kBoolTrue == test_28) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_29841 (var_forgottenAssociations, kEnumeration_up) ;
      while (enumerator_29841.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_29841.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (749)) COMMA_SOURCE_FILE_AT_LINE (749)) ;
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_30205 (enumerator_27737.current_mMapOverrideBlockDescriptor_32_AST (HERE), kEnumeration_up) ;
    while (enumerator_30205.hasCurrentObject ()) {
      GALGAS_uint var_leftStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_30205.current_mLeftState (HERE), var_leftStateIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (757)) ;
      GALGAS_uint var_rightStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_30205.current_mRightState (HERE), var_rightStateIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (759)) ;
      GALGAS_string var_combinaison = enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (760)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (760)).operator_concat (enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (760)) COMMA_SOURCE_FILE_AT_LINE (760)) ;
      ...
      if (kBoolTrue == test_29) {
        GALGAS_location location_30 (enumerator_30205.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_30, GALGAS_string ("the '").operator_concat (enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (GALGAS_string ("' combinaison is useless") COMMA_SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (762)) ;
      }
      ...
      if (kBoolTrue == test_31) {
        GALGAS_location location_32 (enumerator_30205.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_32, GALGAS_string ("the '").operator_concat (enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string ("' combinaison is already defined") COMMA_SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (766)) ;
      }
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_30205.current_mResultingState (HERE), var_resultingStateNameIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (771)) ;
      const enumGalgasBool test_33 = GALGAS_bool (kIsNotEqual, enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (772)).objectCompare (enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (772)))).operator_and (GALGAS_bool (kIsNotEqual, enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (773)).objectCompare (enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (773)))) COMMA_SOURCE_FILE_AT_LINE (773)).operator_and (var_accessibilityGraph.reader_hasKey (enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (774)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).operator_not (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).boolEnum () ;
      if (kBoolTrue == test_33) {
        GALGAS_location location_34 (enumerator_30205.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_34, GALGAS_string ("the '").operator_concat (enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (GALGAS_string ("' state cannot be reached from the '") COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (GALGAS_string ("' state") COMMA_SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (775)) ;
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_30205.current_mTransitionMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (778)) ;
      }
      const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_30205.current_mMessageKind (HERE).objectCompare (GALGAS_mapAutomatonMessageKind::constructor_noMessage (SOURCE_FILE_AT_LINE (779)))).boolEnum () ;
      if (kBoolTrue == test_35) {
        var_definedCombinaisons.addAssign_operation (enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (780)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (780)).operator_concat (enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)) ;
        var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_rightStateIndex, enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (783)), var_leftStateIndex, enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (785)), var_resultingStateNameIndex, enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (787)), enumerator_30205.current_mMessageKind (HERE), enumerator_30205.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (789)) COMMA_SOURCE_FILE_AT_LINE (781)) ;
      }
      var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_leftStateIndex, enumerator_30205.current_mLeftState (HERE).reader_string (SOURCE_FILE_AT_LINE (794)), var_rightStateIndex, enumerator_30205.current_mRightState (HERE).reader_string (SOURCE_FILE_AT_LINE (796)), var_resultingStateNameIndex, enumerator_30205.current_mResultingState (HERE).reader_string (SOURCE_FILE_AT_LINE (798)), enumerator_30205.current_mMessageKind (HERE), enumerator_30205.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (792)) ;
      enumerator_30205.gotoNextObject () ;
    }
    ...
    if (kBoolTrue == test_36) {
      ...
      if (kBoolTrue == test_37) {
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_32526 (var_forgottenCombinaisons, kEnumeration_up) ;
        while (enumerator_32526.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_32526.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)) ;
          enumerator_32526.gotoNextObject () ;
        }
    ...
    var_mapOverrideList.addAssign_operation (enumerator_27737.current_mOverrideBlockName (HERE).reader_string (SOURCE_FILE_AT_LINE (814)), var_branchBehaviourSortedListForMapOverride_31_, var_branchBehaviourSortedListForMapOverride_32_ COMMA_SOURCE_FILE_AT_LINE (813)) ;
    enumerator_27737.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_33037 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_33037.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_33037.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (823)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_33037.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (826)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_33037.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) ;
    }
    enumerator_33037.gotoNextObject () ;
  }
  GALGAS_insertMethodMap var_insertMethodMap = GALGAS_insertMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (835)) ;
  cEnumerator_insertMethodListAST enumerator_33459 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_33459.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_33459.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (837)) ;
    }
    cEnumerator_stringlist enumerator_33652 (enumerator_33459.current_mErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (839)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (839)), kEnumeration_up) ;
    while (enumerator_33652.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_33652.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (840)) ;
      {
      GALGAS_string joker_33766_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_33766_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (841)) ;
      }
      cEnumerator_stringlist enumerator_33800 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_33800.hasCurrentObject ()) {
        const enumGalgasBool test_38 = GALGAS_bool (kIsStrictSup, enumerator_33800.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (843)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_38) {
          GALGAS_char var_c = enumerator_33800.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (844)) ;
          ...
          if (kBoolTrue == test_39) {
            GALGAS_location location_40 (enumerator_33459.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_33652.gotoNextObject () ;
    }
    cEnumerator_stringlist enumerator_34279 (enumerator_33459.current_mShadowErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (852)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (852)), kEnumeration_up) ;
    while (enumerator_34279.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_34279.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (853)) ;
      {
      GALGAS_string joker_34393_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_34393_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) ;
      }
      cEnumerator_stringlist enumerator_34427 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_34427.hasCurrentObject ()) {
        const enumGalgasBool test_41 = GALGAS_bool (kIsStrictSup, enumerator_34427.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (856)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_41) {
          GALGAS_char var_c = enumerator_34427.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (857)) ;
          ...
          if (kBoolTrue == test_42) {
            GALGAS_location location_43 (enumerator_33459.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_33459.gotoNextObject () ;
  }
  GALGAS_searchMethodMap var_searchMethodMap = GALGAS_searchMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (866)) ;
  cEnumerator_mapSearchMethodListAST enumerator_34875 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_34875.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_34875.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
      }
    }else if (kBoolFalse == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_34875.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      }
    }
    cEnumerator_stringlist enumerator_35189 (enumerator_34875.current_mErrorMessage (HERE).reader_string (SOURCE_FILE_AT_LINE (874)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE_AT_LINE (874)), kEnumeration_up) ;
    while (enumerator_35189.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_35189.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE_AT_LINE (875)) ;
      {
      GALGAS_string joker_35303_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_35303_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (876)) ;
      }
      cEnumerator_stringlist enumerator_35337 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_35337.hasCurrentObject ()) {
        const enumGalgasBool test_45 = GALGAS_bool (kIsStrictSup, enumerator_35337.current_mValue (HERE).reader_length (SOURCE_FILE_AT_LINE (878)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_45) {
          GALGAS_char var_c = enumerator_35337.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
          const enumGalgasBool test_46 = GALGAS_bool (kIsNotEqual, var_c.objectCompare (GALGAS_char (TO_UNICODE (75)))).boolEnum () ;
          if (kBoolTrue == test_46) {
            GALGAS_location location_47 (enumerator_34875.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_35337.gotoNextObject () ;
      }
      enumerator_35189.gotoNextObject () ;
    }
    enumerator_34875.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_35864 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_35864.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_35864.current_mSearchMethodName (HERE), constinArgument_inPredefinedTypes.mAttribute_mLStringType, inCompiler COMMA_SOURCE_FILE_AT_LINE (891)) ;
    }
...
static void categoryMethod_mapProxyDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_36940_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_36940_4 ; // Joker input parameter
  GALGAS_typeKindEnum joker_36940_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_36940_2 ; // Joker input parameter
  GALGAS_attributeMap joker_36940_1 ; // Joker input parameter
  GALGAS_constructorMap joker_36976_11 ; // Joker input parameter
  GALGAS_readerMap joker_36976_10 ; // Joker input parameter
  GALGAS_modifierMap joker_36976_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_36976_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_36976_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_36976_6 ; // Joker input parameter
  GALGAS_stringlist joker_36976_5 ; // Joker input parameter
  GALGAS_uint joker_36976_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_36976_3 ; // Joker input parameter
  GALGAS_stringset joker_36976_2 ; // Joker input parameter
  GALGAS_lstringlist joker_36976_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_37006_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_37006_4 ; // Joker input parameter
  GALGAS_bool joker_37006_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_37006_2 ; // Joker input parameter
  GALGAS_string joker_37006_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_36940_5, joker_36940_4, joker_36940_3, joker_36940_2, joker_36940_1, var_listTypeAttributeList, joker_36976_11, joker_36976_10, joker_36976_9, joker_36976_8, joker_36976_7, joker_36976_6, joker_36976_5, joker_36976_4, joker_36976_3, joker_36976_2, joker_36976_1, var_searchMethodList, joker_37006_5, joker_37006_4, joker_37006_3, joker_37006_2, joker_37006_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (924)) ;
...
static void categoryMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_42727 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_42727.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_42727.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)), enumerator_42727.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1064)), enumerator_42727.current_mFormalArgumentName (HERE), enumerator_42727.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
...
static void categoryMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_43640 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_43640.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_43640.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_43640.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1090)), enumerator_43640.current_mFormalArgumentName (HERE), enumerator_43640.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1088)) ;
...
static void categoryMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      cEnumerator_lstringlist enumerator_46169 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_46169.hasCurrentObject ()) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_46169.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1164)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = var_generatedInSeparateFileFeature.boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (enumerator_46169.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_5 (enumerator_46169.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_46169.gotoNextObject () ;
      }
    }
  }else if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_lstringlist enumerator_46830 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_46830.hasCurrentObject ()) {
        GALGAS_location location_7 (enumerator_46830.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_attributeInCollectionListAST enumerator_47113 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_47113.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_47113.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_47298 (enumerator_47113.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_47298.hasCurrentObject ()) {
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_47298.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1191)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        const enumGalgasBool test_9 = var_hasSetter.boolEnum () ;
        if (kBoolTrue == test_9) {
          GALGAS_location location_10 (enumerator_47298.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_47298.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_hasGetter.operator_not (SOURCE_FILE_AT_LINE (1197)).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_47298.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_14 (enumerator_47298.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_typedAttributeList.addAssign_operation (var_t, enumerator_47113.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1205)) ;
    var_allAttributeList.addAssign_operation (var_t, enumerator_47113.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_47113.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) ;
    }
    enumerator_47113.gotoNextObject () ;
  }
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1222)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)).isValid ()) {
    PMUInt32 variant_48214 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1222)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)).uintValue () ;
    bool loop_48214 = true ;
    while (loop_48214) {
      loop_48214 = var_t.reader_isNull (SOURCE_FILE_AT_LINE (1223)).operator_not (SOURCE_FILE_AT_LINE (1223)).isValid () ;
      if (loop_48214) {
        loop_48214 = var_t.reader_isNull (SOURCE_FILE_AT_LINE (1223)).operator_not (SOURCE_FILE_AT_LINE (1223)).boolValue () ;
      }
      if (loop_48214 && (0 == variant_48214)) {
        loop_48214 = false ;
    ...
    while (loop_62707) {
      ...
      if (loop_62707) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_63015_0 ; // Joker input parameter
          GALGAS_bool joker_63068_0 ; // Joker input parameter
          GALGAS_string joker_63082_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1603)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_63015_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_63068_0, var_qualifier, joker_63082_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1603)) ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1678)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)).isValid ()) {
    PMUInt32 variant_65872 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1678)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)).uintValue () ;
    bool loop_65872 = true ;
    while (loop_65872) {
      loop_65872 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1679)).operator_not (SOURCE_FILE_AT_LINE (1679)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1679)).isValid () ;
      if (loop_65872) {
        loop_65872 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1679)).operator_not (SOURCE_FILE_AT_LINE (1679)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1679)).boolValue () ;
      }
      if (loop_65872 && (0 == variant_65872)) {
        loop_65872 = false ;
      ...
      if (loop_65872) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_66180_0 ; // Joker input parameter
          GALGAS_bool joker_66233_0 ; // Joker input parameter
          GALGAS_string joker_66247_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_66180_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_66233_0, var_qualifier, joker_66247_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_68170 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_68170.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_68170.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_68170.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1732)), enumerator_68170.current_mFormalArgumentName (HERE), enumerator_68170.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1730)) ;
    enumerator_68170.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1824)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).isValid ()) {
    PMUInt32 variant_71575 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1824)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).uintValue () ;
    bool loop_71575 = true ;
    while (loop_71575) {
      loop_71575 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1825)).operator_not (SOURCE_FILE_AT_LINE (1825)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1825)).isValid () ;
      if (loop_71575) {
        loop_71575 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1825)).operator_not (SOURCE_FILE_AT_LINE (1825)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1825)).boolValue () ;
      }
      if (loop_71575 && (0 == variant_71575)) {
        loop_71575 = false ;
      ...
      if (loop_71575) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_71875_0 ; // Joker input parameter
          GALGAS_bool joker_71898_0 ; // Joker input parameter
          GALGAS_string joker_71912_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_71875_0, var_inheritedSignature, joker_71898_0, var_qualifier, joker_71912_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1903)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)).isValid ()) {
    PMUInt32 variant_74709 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1903)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)).uintValue () ;
    bool loop_74709 = true ;
    while (loop_74709) {
      loop_74709 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1904)).operator_not (SOURCE_FILE_AT_LINE (1904)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1904)).isValid () ;
      if (loop_74709) {
        loop_74709 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1904)).operator_not (SOURCE_FILE_AT_LINE (1904)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1904)).boolValue () ;
      }
      if (loop_74709 && (0 == variant_74709)) {
        loop_74709 = false ;
      ...
      if (loop_74709) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_75009_0 ; // Joker input parameter
          GALGAS_bool joker_75032_0 ; // Joker input parameter
          GALGAS_string joker_75046_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1907)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_75009_0, var_inheritedSignature, joker_75032_0, var_qualifier, joker_75046_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1907)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_76973 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_76973.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_76973.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)), enumerator_76973.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1957)), enumerator_76973.current_mFormalArgumentName (HERE), enumerator_76973.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1955)) ;
    enumerator_76973.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxyAndParameterList var_inheritedSignature = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2056)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2059)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)).isValid ()) {
    PMUInt32 variant_80693 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2059)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)).uintValue () ;
    bool loop_80693 = true ;
    while (loop_80693) {
      loop_80693 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2060)).operator_not (SOURCE_FILE_AT_LINE (2060)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2060)).isValid () ;
      if (loop_80693) {
        loop_80693 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2060)).operator_not (SOURCE_FILE_AT_LINE (2060)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2060)).boolValue () ;
      }
      if (loop_80693 && (0 == variant_80693)) {
        loop_80693 = false ;
      ...
      if (loop_80693) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_81001_0 ; // Joker input parameter
          GALGAS_bool joker_81078_0 ; // Joker input parameter
          GALGAS_string joker_81137_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2063)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_81001_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_81078_0, var_inheritedReturnType, var_qualifier, joker_81137_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2063)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxyAndParameterList var_inheritedSignature = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2155)) ;
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2158)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)).isValid ()) {
    PMUInt32 variant_84381 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2158)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)).uintValue () ;
    bool loop_84381 = true ;
    while (loop_84381) {
      loop_84381 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2159)).operator_not (SOURCE_FILE_AT_LINE (2159)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2159)).isValid () ;
      if (loop_84381) {
        loop_84381 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2159)).operator_not (SOURCE_FILE_AT_LINE (2159)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2159)).boolValue () ;
      }
      if (loop_84381 && (0 == variant_84381)) {
        loop_84381 = false ;
      ...
      if (loop_84381) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_84685_0 ; // Joker input parameter
          GALGAS_bool joker_84762_0 ; // Joker input parameter
          GALGAS_string joker_84821_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_84685_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_84762_0, var_inheritedReturnType, var_qualifier, joker_84821_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_formalInputParameterListAST enumerator_85345 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_85345.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_85345.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2186)), enumerator_85345.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (2187)), enumerator_85345.current_mFormalArgumentName (HERE), enumerator_85345.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (2185)) ;
      enumerator_85345.gotoNextObject () ;
    }
    {
