...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_5182 (var_cas_inSemanticContext.reader_mOrderedSemanticDeclarationListAST (inLexique COMMA_SOURCE_FILE_AT_LINE (111)), true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_5182 = NULL ;
    while (((operand_5182 = enumerator_5182.nextObject ()))) {
      macroValidPointer (operand_5182) ;
      const GGS_semanticDeclarationAST  temp_5288 = operand_5182->mSemanticDeclaration ;
      if (temp_5288.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_5288.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_5288 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (112)) ;
        }
      }
    }
  }
