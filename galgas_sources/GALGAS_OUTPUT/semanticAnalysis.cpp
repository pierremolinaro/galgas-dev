...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_11475,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                GGS_semanticDeclarationListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11475 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_11702 (operand_11475->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_11702 = NULL ;
      while (((operand_11702 = enumerator_11702.nextObject ()))) {
        macroValidPointer (operand_11702) ;
        var_cas_typedAttributeList.addAssign_operation (GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_11702->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (263)), operand_11702->mAttributeName) ;
      }
    }
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    const GGS_bool cond_12063 = (operand_11475->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269))).operator_isEqual (GGS_string ("")) ;
    if (cond_12063.isBuiltAndTrue ()) {
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
    }else if (cond_12063.isBuiltAndFalse ()) {
      GGS_bool automatic_var_12160_0 ;
      GGS_unifiedTypeMapIndex  automatic_var_12160_1 ;
      GGS_typeKindEnum automatic_var_12160_2 ;
      GGS_typedAttributeList  automatic_var_12160_3 ;
      GGS_typedAttributeList  automatic_var_12160_4 ;
      GGS_constructorMap  automatic_var_12160_5 ;
      GGS_readerMap  automatic_var_12160_6 ;
      GGS_modifierMap  automatic_var_12160_7 ;
      GGS_classMethodMap  automatic_var_12160_8 ;
      GGS_enumerationDescriptorList  automatic_var_12160_9 ;
      GGS_uint  automatic_var_12160_10 ;
      GGS_unifiedTypeMapIndexList  automatic_var_12160_11 ;
      GGS_unifiedTypeMapIndexList  automatic_var_12160_12 ;
      GGS_nativeAttributeList  automatic_var_12160_13 ;
      GGS_lstringlist  automatic_var_12160_14 ;
      GGS_typedAttributeList  automatic_var_12160_15 ;
      const GGS_unifiedTypeMap  temp_12106 = var_cas_inSemanticContext.mTypeMap ;
      if (temp_12106.isBuilt ()) {
        temp_12106 (HERE)->method_searchKey (inLexique, operand_11475->mSuperClassName, automatic_var_12160_0, automatic_var_12160_1, automatic_var_12160_2, automatic_var_12160_3, automatic_var_12160_4, automatic_var_12160_5, automatic_var_12160_6, automatic_var_12160_7, var_cas_inheritedInstanceMethodMap, automatic_var_12160_8, automatic_var_12160_9, automatic_var_12160_10, automatic_var_12160_11, automatic_var_12160_12, automatic_var_12160_13, automatic_var_12160_14, automatic_var_12160_15 COMMA_SOURCE_FILE_AT_LINE (272)) ;
      }
    }
    GGS_unifiedTypeMapIndex  var_cas_superClassIndex ;
    const GGS_bool cond_12399 = (operand_11475->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (276))).operator_isEqual (GGS_string ("")) ;
    if (cond_12399.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) ;
    }else if (cond_12399.isBuiltAndFalse ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_11475->mSuperClassName COMMA_SOURCE_FILE_AT_LINE (279)) ;
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_12647 (operand_11475->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_12647 = NULL ;
      while (((operand_12647 = enumerator_12647.nextObject ()))) {
        macroValidPointer (operand_12647) ;
        const GGS_bool cond_12833 = (operand_11475->mIsAbstract).operator_not () ;
        if (cond_12833.isBuiltAndTrue ()) {
          operand_12647->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a concrete class cannot declare an abstract method") COMMA_SOURCE_FILE_AT_LINE (287)) ;
        }
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_12978 (operand_12647->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_12978 = NULL ;
          while (((operand_12978 = enumerator_12978.nextObject ()))) {
            macroValidPointer (operand_12978) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_12978->mFormalParameterPassingMode, GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_12978->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (293)), operand_12978->mFormalParameterName, operand_12978->mIsUnused) ;
          }
        }
        const GGS_bool cond_13697 = operand_12647->mIsOverriding ;
        if (cond_13697.isBuiltAndTrue ()) {
          ...
          GGS_bool automatic_var_13509_0 ;
          const GGS_instanceMethodMap  temp_13442 = var_cas_inheritedInstanceMethodMap ;
          if (temp_13442.isBuilt ()) {
            temp_13442 (HERE)->method_searchInheritedKey (inLexique, operand_12647->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_13509_0 COMMA_SOURCE_FILE_AT_LINE (302)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_12647->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (305)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (303)) ;
        }else if (cond_13697.isBuiltAndFalse ()) {
          const GGS_bool cond_13880 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_12647->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (309))) ;
          if (cond_13880.isBuiltAndTrue ()) {
            operand_12647->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (311)) ;
          }
        }
        var_cas_abstractMethodList.addAssign_operation (operand_12647->mIsOverriding, operand_12647->mMethodName, var_cas_formalParameterListForGeneration) ;
      }
    }
    GGS_methodDefinitionListForGeneration  var_cas_methodList = GGS_methodDefinitionListForGeneration ::constructor_emptyList () ;
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_14096 (operand_11475->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_14096 = NULL ;
      while (((operand_14096 = enumerator_14096.nextObject ()))) {
        macroValidPointer (operand_14096) ;
        GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_14239 (operand_14096->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_14239 = NULL ;
          while (((operand_14239 = enumerator_14239.nextObject ()))) {
            macroValidPointer (operand_14239) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_14239->mFormalParameterPassingMode, GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_14239->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (322)), operand_14239->mFormalParameterName, operand_14239->mIsUnused) ;
          }
        }
        const GGS_bool cond_14958 = operand_14096->mIsOverriding ;
        if (cond_14958.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_14770_0 ;
          const GGS_instanceMethodMap  temp_14703 = var_cas_inheritedInstanceMethodMap ;
          if (temp_14703.isBuilt ()) {
            temp_14703 (HERE)->method_searchInheritedKey (inLexique, operand_14096->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_14770_0 COMMA_SOURCE_FILE_AT_LINE (331)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_14096->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (334)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (332)) ;
        }else if (cond_14958.isBuiltAndFalse ()) {
          const GGS_bool cond_15141 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_14096->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (338))) ;
          if (cond_15141.isBuiltAndTrue ()) {
            operand_14096->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (340)) ;
          }
        }
        var_cas_methodList.addAssign_operation (operand_14096->mIsOverriding, operand_14096->mMethodName, var_cas_formalParameterListForGeneration, GGS_semanticInstructionListForGeneration ::constructor_emptyList ()) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classDeclarationForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_11475->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (350)), operand_11475->mIsAbstract, operand_11475->mClassTypeName, var_cas_superClassIndex, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList COMMA_SOURCE_FILE_AT_LINE (349))) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_16362 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_16362 = NULL ;
    while (((operand_16362 = enumerator_16362.nextObject ()))) {
      macroValidPointer (operand_16362) ;
      const GGS_semanticDeclarationAST  temp_16415 = operand_16362->mSemanticDeclaration ;
      if (temp_16415.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_16415.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_16415 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (374)) ;
        }
      }
    }
  }
