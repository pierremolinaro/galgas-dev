...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_17858,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                GGS_semanticDeclarationListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17858 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_superClassProxy ;
    const GGS_bool cond_18206 = (operand_17858->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (408))).operator_isEqual (GGS_string ("")) ;
    if (cond_18206.isBuiltAndTrue ()) {
      ...
      var_cas_superClassProxy = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_17858->mSuperClassName COMMA_SOURCE_FILE_AT_LINE (411)) ;
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_18569 (operand_17858->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_18569 = NULL ;
      while (((operand_18569 = enumerator_18569.nextObject ()))) {
        macroValidPointer (operand_18569) ;
        var_cas_typedAttributeList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_18569->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (419)), operand_18569->mAttributeName) ;
        var_cas_allAttributeList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_18569->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (423)), operand_18569->mAttributeName) ;
        var_cas_attributeIndexMap.modifier_insertKey (inLexique, operand_18569->mAttributeName, var_cas_attributeIndexMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (426)) ;
      }
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_19084 (operand_17858->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_19084 = NULL ;
      while (((operand_19084 = enumerator_19084.nextObject ()))) {
        macroValidPointer (operand_19084) ;
        var_cas_classMethodMap.modifier_insertKey (inLexique, operand_19084->mMethodName COMMA_SOURCE_FILE_AT_LINE (431)) ;
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_19172 (operand_17858->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_19172 = NULL ;
      while (((operand_19172 = enumerator_19172.nextObject ()))) {
        macroValidPointer (operand_19172) ;
        var_cas_classMethodMap.modifier_insertKey (inLexique, operand_19172->mMethodName COMMA_SOURCE_FILE_AT_LINE (434)) ;
      }
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_19496 (operand_17858->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_19496 = NULL ;
      while (((operand_19496 = enumerator_19496.nextObject ()))) {
        macroValidPointer (operand_19496) ;
        const GGS_bool cond_19682 = (operand_17858->mIsAbstract).operator_not () ;
        if (cond_19682.isBuiltAndTrue ()) {
          operand_19496->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a concrete class cannot declare an abstract method") COMMA_SOURCE_FILE_AT_LINE (444)) ;
        }
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_19827 (operand_19496->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_19827 = NULL ;
          while (((operand_19827 = enumerator_19827.nextObject ()))) {
            macroValidPointer (operand_19827) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_19827->mFormalParameterPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_19827->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (450)), operand_19827->mFormalParameterName, operand_19827->mIsUnused) ;
          }
        }
        const GGS_bool cond_20547 = operand_19496->mIsOverriding ;
        if (cond_20547.isBuiltAndTrue ()) {
          ...
          GGS_bool automatic_var_20359_0 ;
          GGS_readerQualifier automatic_var_20359_1 ;
          const GGS_instanceMethodMap  temp_20291 = var_cas_inheritedInstanceMethodMap ;
          if (temp_20291.isBuilt ()) {
            temp_20291 (HERE)->method_searchInheritedKey (inLexique, operand_19496->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_20359_0, automatic_var_20359_1 COMMA_SOURCE_FILE_AT_LINE (459)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_19496->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (462)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (460)) ;
        }else if (cond_20547.isBuiltAndFalse ()) {
          const GGS_bool cond_20730 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_19496->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (466))) ;
          if (cond_20730.isBuiltAndTrue ()) {
            operand_19496->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (468)) ;
          }
        }
        var_cas_abstractMethodList.addAssign_operation (operand_19496->mIsOverriding, operand_19496->mMethodName, var_cas_formalParameterListForGeneration) ;
      }
    }
    ...
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_20984 (operand_17858->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_20984 = NULL ;
      while (((operand_20984 = enumerator_20984.nextObject ()))) {
        macroValidPointer (operand_20984) ;
        GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_21127 (operand_20984->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_21127 = NULL ;
          while (((operand_21127 = enumerator_21127.nextObject ()))) {
            macroValidPointer (operand_21127) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_21127->mFormalParameterPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_21127->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (480)), operand_21127->mFormalParameterName, operand_21127->mIsUnused) ;
          }
        }
        const GGS_bool cond_21847 = operand_20984->mIsOverriding ;
        if (cond_21847.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_21659_0 ;
          GGS_readerQualifier automatic_var_21659_1 ;
          const GGS_instanceMethodMap  temp_21591 = var_cas_inheritedInstanceMethodMap ;
          if (temp_21591.isBuilt ()) {
            temp_21591 (HERE)->method_searchInheritedKey (inLexique, operand_20984->mMethodName, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_21659_0, automatic_var_21659_1 COMMA_SOURCE_FILE_AT_LINE (489)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_20984->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (492)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (490)) ;
        }else if (cond_21847.isBuiltAndFalse ()) {
          const GGS_bool cond_22036 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_20984->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (496))) ;
          if (cond_22036.isBuiltAndTrue ()) {
            operand_20984->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method should be declared as overridding, as it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (498)) ;
          }
        }
        var_cas_definedMethodSet.addAssign_operation (operand_20984->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (499))) ;
        var_cas_methodList.addAssign_operation (operand_20984->mIsOverriding, operand_20984->mMethodName, var_cas_formalParameterListForGeneration, GGS_semanticInstructionListForGeneration ::constructor_emptyList ()) ;
      }
    }
    {
      GGS_instanceMethodMap::cEnumerator enumerator_22357 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_22357 = NULL ;
      while (((operand_22357 = enumerator_22357.nextObject ()))) {
        macroValidPointer (operand_22357) ;
        const GGS_bool cond_22717 = ((operand_22357->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (509)))).operator_or ((operand_22357->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (509)))) ;
        if (cond_22717.isBuiltAndTrue ()) {
          const GGS_bool cond_22700 = (var_cas_definedMethodSet.reader_hasKey (operand_22357->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (510)))).operator_not () ;
          if (cond_22700.isBuiltAndTrue ()) {
            operand_22357->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_17858->mClassTypeName)).operator_concat (GGS_string ("' class is declared concrete, but the '"))).operator_concat (operand_22357->mKey)).operator_concat (GGS_string ("' method declared in a super class is not implemented")) COMMA_SOURCE_FILE_AT_LINE (512)) ;
          }
        }
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_17858->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (517)), operand_17858->mIsAbstract, operand_17858->mClassTypeName, var_cas_superClassProxy, var_cas_allAttributeList, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList COMMA_SOURCE_FILE_AT_LINE (516))) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_23792 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_23792 = NULL ;
    while (((operand_23792 = enumerator_23792.nextObject ()))) {
      macroValidPointer (operand_23792) ;
      const GGS_semanticDeclarationAST  temp_23845 = operand_23792->mSemanticDeclaration ;
      if (temp_23845.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_23845.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_23845 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (542)) ;
        }
      }
    }
  }
