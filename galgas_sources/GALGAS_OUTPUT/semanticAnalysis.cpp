...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_3290 (var_cas_inSemanticContext.reader_mOrderedSemanticDeclarationListAST (inLexique COMMA_SOURCE_FILE_AT_LINE (59)), true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_3290 = NULL ;
    while (((operand_3290 = enumerator_3290.nextObject ()))) {
      macroValidPointer (operand_3290) ;
      const GGS_semanticDeclarationAST  temp_3396 = operand_3290->mSemanticDeclaration ;
      if (temp_3396.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_3396.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_3396 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (60)) ;
        }
      }
    }
  }
