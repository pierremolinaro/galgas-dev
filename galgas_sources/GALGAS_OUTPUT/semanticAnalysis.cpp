  ...
  var_cas_outRoutineSignature = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  {
    ...
    while (((operand_18512 = enumerator_18512.nextObject ()))) {
      ...
      case GGS_formalArgumentPassingModeAST::enum_argumentIn:
        ...
        const GGS_bool cond_18989 = operand_18512->mIsUnused ;
        if (cond_18989.isBuiltAndTrue ()) {
          var_cas_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (446)) ;
        }else if (cond_18989.isBuiltAndFalse ()) {
          var_cas_ioVariableMap.modifier_insertInputFormalArgument (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (448)) ;
        }
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        ...
        var_cas_ioVariableMap.modifier_insertOutputFormalArgument (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (452)) ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
        ...
        const GGS_bool cond_19682 = operand_18512->mIsUnused ;
        if (cond_19682.isBuiltAndTrue ()) {
          var_cas_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (456)) ;
        }else if (cond_19682.isBuiltAndFalse ()) {
          var_cas_ioVariableMap.modifier_insertInputOutputFormalArgument (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (458)) ;
        }
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
        ...
        const GGS_bool cond_20147 = operand_18512->mIsUnused ;
        if (cond_20147.isBuiltAndTrue ()) {
          var_cas_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (463)) ;
        }else if (cond_20147.isBuiltAndFalse ()) {
          var_cas_ioVariableMap.modifier_insertConstantInputFormalArgument (inLexique, operand_18512->mFormalArgumentName, var_cas_type, var_cas_formalArgumentCppName, var_cas_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (465)) ;
        }
        }
        break ;
...
void routine_analyzeRoutineBody (C_Compiler & inLexique,
  ...
  #endif
  GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (485)) ;
  {
    GGS_localConstantList::cEnumerator enumerator_21102 (var_cas_inLocalConstantList, true) ;
    const GGS_localConstantList::cElement * operand_21102 = NULL ;
    while (((operand_21102 = enumerator_21102.nextObject ()))) {
      macroValidPointer (operand_21102) ;
      const GGS_bool cond_21234 = operand_21102->mNoWarningIfUnused ;
      if (cond_21234.isBuiltAndTrue ()) {
        var_cas_variableMap.modifier_insertUsedLocalConstant (inLexique, operand_21102->mName, operand_21102->mType, operand_21102->mCppName, function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) COMMA_SOURCE_FILE_AT_LINE (489)) ;
      }else if (cond_21234.isBuiltAndFalse ()) {
        var_cas_variableMap.modifier_insertLocalConstant (inLexique, operand_21102->mName, operand_21102->mType, operand_21102->mCppName, function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (491)) COMMA_SOURCE_FILE_AT_LINE (491)) ;
      }
    }
  }
  {
    GGS_typedAttributeList::cEnumerator enumerator_21410 (var_cas_inTypedAttributeList, true) ;
    const GGS_typedAttributeList::cElement * operand_21410 = NULL ;
    while (((operand_21410 = enumerator_21410.nextObject ()))) {
      macroValidPointer (operand_21410) ;
      var_cas_variableMap.modifier_insertNonMutableAttribute (inLexique, operand_21410->mAttributeName, operand_21410->mAttributeTypeIndex, ((var_cas_inAttributeVariableNamePrefix).operator_concat (GGS_string ("mAttribute_"))).operator_concat (operand_21410->mAttributeName.ggs_string ().reader_identifierRepresentation ()), function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (500)) COMMA_SOURCE_FILE_AT_LINE (496)) ;
    }
  }
  ::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inAnalysisContext.mSemanticContext,  var_cas_inRoutineSignatureAST,  var_cas_variableMap,  var_cas_outRoutineSignature COMMA_SOURCE_FILE_AT_LINE (504)) ;
  var_cas_outSemanticInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
  {
    GGS_semanticInstructionListAST::cEnumerator enumerator_21985 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListAST::cElement * operand_21985 = NULL ;
    while (((operand_21985 = enumerator_21985.nextObject ()))) {
      macroValidPointer (operand_21985) ;
      { typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (operand_21985->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_21985->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_outSemanticInstructionListForGeneration, var_cas_variableMap COMMA_SOURCE_FILE_AT_LINE (513)) ;
        }
      }
    }
  }
  if (var_cas_variableMap.isBuilt ()) {
    var_cas_variableMap (HERE)->method_checkAutomatonStates (inLexique, var_cas_inEndOfMethodLocation COMMA_SOURCE_FILE_AT_LINE (520)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__externFunctionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_22382,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22382 != NULL) {
    ...
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_22660 (operand_22382->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_22660 = NULL ;
      while (((operand_22660 = enumerator_22660.nextObject ()))) {
        macroValidPointer (operand_22660) ;
        var_cas_formalArgumentList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_22660->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (533)), operand_22660->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (534)), operand_22660->mIsUnused) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_functionPrototypeDeclarationForGeneration ::constructor_new (inLexique, operand_22382->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (539)), var_cas_formalArgumentList, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_22382->mResultTypeName COMMA_SOURCE_FILE_AT_LINE (541)) COMMA_SOURCE_FILE_AT_LINE (538)), GGS_string ("")) ;
  }
}
...
category_method__externRoutineDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_23263,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23263 != NULL) {
    ...
    {
      GGS_formalParameterListAST::cEnumerator enumerator_23536 (operand_23263->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_23536 = NULL ;
      while (((operand_23536 = enumerator_23536.nextObject ()))) {
        macroValidPointer (operand_23536) ;
        var_cas_formalArgumentList.addAssign_operation (operand_23536->mFormalArgumentPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_23536->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (558)), operand_23536->mFormalArgumentName, operand_23536->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_routinePrototypeDeclarationForGeneration ::constructor_new (inLexique, operand_23263->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)), var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (563)), GGS_string ("")) ;
  }
}
...
category_method__routineDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_routineDeclarationAST * operand_24091,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24091 != NULL) {
    GGS_formalParameterListForGeneration  var_cas_formalArgumentList = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (584)), GGS_string ("")) ;
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_24091->mFormalArgumentList,  GGS_localConstantList ::constructor_emptyList (),  GGS_typedAttributeList ::constructor_emptyList (),  GGS_string (""),  operand_24091->mRoutineInstructionList,  operand_24091->mEndOfRoutineInstructionList,  var_cas_instructionList,  var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (587)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_routineImplementationForGeneration ::constructor_new (inLexique, operand_24091->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (600)), var_cas_formalArgumentList, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (599)), GGS_string ("")) ;
  }
}
...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_25137,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25137 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_25137->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (616)) ;
    ...
    const GGS_bool cond_25819 = (operand_25137->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (621))).operator_isEqual (GGS_string ("")) ;
    if (cond_25819.isBuiltAndTrue ()) {
      var_cas_superClassProxy = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (622)) ;
      var_cas_allAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (624)) ;
    }else if (cond_25819.isBuiltAndFalse ()) {
      var_cas_superClassProxy = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_25137->mSuperClassName COMMA_SOURCE_FILE_AT_LINE (626)) ;
      var_cas_allAttributeList = var_cas_superClassProxy.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (627)) ;
      var_cas_inheritedInstanceMethodMap = var_cas_superClassProxy.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (628)) ;
    }
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    GGS_attributeIndexMap  var_cas_attributeMap = GGS_attributeIndexMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (632)) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_26226 (operand_25137->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_26226 = NULL ;
      while (((operand_26226 = enumerator_26226.nextObject ()))) {
        macroValidPointer (operand_26226) ;
        GGS_unifiedTypeMapProxy  var_cas_t = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_26226->mAttributeTypeName COMMA_SOURCE_FILE_AT_LINE (634)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_t, operand_26226->mAttributeName) ;
        var_cas_allAttributeList.addAssign_operation (var_cas_t, operand_26226->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_26226->mAttributeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (643)) ;
      }
    }
    GGS_declaredMethodMap  var_cas_classMethodMap = GGS_declaredMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (646)) ;
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_26642 (operand_25137->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_26642 = NULL ;
      while (((operand_26642 = enumerator_26642.nextObject ()))) {
        macroValidPointer (operand_26642) ;
        var_cas_classMethodMap.modifier_insertKey (inLexique, operand_26642->mMethodName COMMA_SOURCE_FILE_AT_LINE (648)) ;
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_26730 (operand_25137->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_26730 = NULL ;
      while (((operand_26730 = enumerator_26730.nextObject ()))) {
        macroValidPointer (operand_26730) ;
        var_cas_classMethodMap.modifier_insertKey (inLexique, operand_26730->mMethodName COMMA_SOURCE_FILE_AT_LINE (651)) ;
      }
    }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_26929 (operand_25137->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_26929 = NULL ;
      while (((operand_26929 = enumerator_26929.nextObject ()))) {
        macroValidPointer (operand_26929) ;
        const GGS_bool cond_27115 = (operand_25137->mIsAbstract).operator_not () ;
        if (cond_27115.isBuiltAndTrue ()) {
          operand_26929->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a concrete class cannot declare an abstract method") COMMA_SOURCE_FILE_AT_LINE (659)) ;
        }
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_27260 (operand_26929->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_27260 = NULL ;
          while (((operand_27260 = enumerator_27260.nextObject ()))) {
            macroValidPointer (operand_27260) ;
            var_cas_formalParameterListForGeneration.addAssign_operation (operand_27260->mFormalArgumentPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_27260->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (665)), operand_27260->mFormalArgumentName, operand_27260->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (667))) ;
          }
        }
        const GGS_bool cond_27999 = operand_26929->mIsOverriding ;
        if (cond_27999.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool automatic_var_27811_0 ;
          GGS_bool automatic_var_27811_1 ;
          GGS_methodQualifier automatic_var_27811_2 ;
          if (var_cas_inheritedInstanceMethodMap.isBuilt ()) {
            var_cas_inheritedInstanceMethodMap (HERE)->method_searchInheritedKey (inLexique, operand_26929->mMethodName, automatic_var_27811_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_27811_1, automatic_var_27811_2 COMMA_SOURCE_FILE_AT_LINE (674)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_26929->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (677)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (675)) ;
        }else if (cond_27999.isBuiltAndFalse ()) {
          const GGS_bool cond_28182 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_26929->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (681))) ;
          if (cond_28182.isBuiltAndTrue ()) {
            operand_26929->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method cannot be declared as abstract, it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (683)) ;
          }
        }
        var_cas_abstractMethodList.addAssign_operation (operand_26929->mIsOverriding, operand_26929->mMethodName, var_cas_formalParameterListForGeneration) ;
      }
    }
    ...
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_28560 (operand_25137->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_28560 = NULL ;
      while (((operand_28560 = enumerator_28560.nextObject ()))) {
        macroValidPointer (operand_28560) ;
        GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
        GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
        ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_28560->mSignature,  GGS_localConstantList ::constructor_emptyList (),  var_cas_allAttributeList,  GGS_string (""),  operand_28560->mInstructionList,  operand_28560->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (699)) ;
        const GGS_bool cond_29699 = operand_28560->mIsOverriding ;
        if (cond_29699.isBuiltAndTrue ()) {
          GGS_formalParameterSignature  var_cas_inheritedSignature ;
          GGS_location  var_cas_inheritedDeclarationLocation ;
          GGS_bool var_cas_inheritedIsCategory ;
          GGS_bool automatic_var_29347_0 ;
          GGS_methodQualifier automatic_var_29347_1 ;
          if (var_cas_inheritedInstanceMethodMap.isBuilt ()) {
            var_cas_inheritedInstanceMethodMap (HERE)->method_searchInheritedKey (inLexique, operand_28560->mMethodName, var_cas_inheritedIsCategory, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_29347_0, automatic_var_29347_1 COMMA_SOURCE_FILE_AT_LINE (715)) ;
          }
          ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_28560->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (718)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (716)) ;
          const GGS_bool cond_29684 = var_cas_inheritedIsCategory ;
          if (cond_29684.isBuiltAndTrue ()) {
            operand_28560->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method is declared in class, but overriden method is declared as multi-method") COMMA_SOURCE_FILE_AT_LINE (724)) ;
          }
        }else if (cond_29699.isBuiltAndFalse ()) {
          const GGS_bool cond_29888 = var_cas_inheritedInstanceMethodMap.reader_hasKey (operand_28560->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (725))) ;
          if (cond_29888.isBuiltAndTrue ()) {
            operand_28560->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this method should be declared as overridding, as it is already declared in super class") COMMA_SOURCE_FILE_AT_LINE (727)) ;
          }
        }
        var_cas_definedMethodSet.addAssign_operation (operand_28560->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (729))) ;
        var_cas_methodList.addAssign_operation (operand_28560->mIsOverriding, operand_28560->mMethodName, var_cas_formalParameterListForGeneration, var_cas_semanticInstructionListForGeneration) ;
      }
    }
    const GGS_bool cond_30633 = (operand_25137->mIsAbstract).operator_not () ;
    if (cond_30633.isBuiltAndTrue ()) {
      {
        GGS_instanceMethodMap::cEnumerator enumerator_30231 (var_cas_inheritedInstanceMethodMap, true) ;
        const GGS_instanceMethodMap::cElement * operand_30231 = NULL ;
        while (((operand_30231 = enumerator_30231.nextObject ()))) {
          macroValidPointer (operand_30231) ;
          const GGS_bool cond_30604 = ((operand_30231->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (740)))).operator_or ((operand_30231->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (740)))) ;
          if (cond_30604.isBuiltAndTrue ()) {
            const GGS_bool cond_30585 = (var_cas_definedMethodSet.reader_hasKey (operand_30231->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (741)))).operator_not () ;
            if (cond_30585.isBuiltAndTrue ()) {
              operand_30231->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_25137->mClassTypeName)).operator_concat (GGS_string ("' class is declared concrete, but the '"))).operator_concat (operand_30231->mKey)).operator_concat (GGS_string ("' method declared in a super class is not implemented")) COMMA_SOURCE_FILE_AT_LINE (743)) ;
            }
          }
        }
      }
    }
    GGS_string var_cas_sortString = var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (748)) ;
    GGS_unifiedTypeMapProxy  var_cas_t = var_cas_selfType.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (749)) ;
    GGS_uint _variant_30947 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (750)) ;
    GGS_bool _condition_30947 (_variant_30947.isBuilt (), true) ;
    while (_condition_30947.isBuiltAndTrue ()) {
      _condition_30947 = (var_cas_t.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (751))).operator_not () ;
      if (_condition_30947.isBuiltAndTrue ()) {
        if (_variant_30947.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (754)) ;
          _condition_30947 = GGS_bool (false) ;
        }else{
          _variant_30947.decrement_operation (inLexique COMMA_HERE) ;
          var_cas_sortString = ((var_cas_t.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (752))).operator_concat (GGS_string ("."))).operator_concat (var_cas_sortString) ;
          var_cas_t = var_cas_t.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (753)) ;
        }
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_25137->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (757)), operand_25137->mIsAbstract, operand_25137->mClassTypeName, var_cas_superClassProxy, var_cas_allAttributeList, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList, var_cas_selfType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (756)), var_cas_sortString) ;
  }
}
...
void routine_analyzeFunctionBody (C_Compiler & inLexique,
  ...
  #endif
  GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (785)) ;
  var_cas_outSignatureForGeneration = GGS_formalInputParameterListForGeneration ::constructor_emptyList () ;
  {
    GGS_formalInputParameterListAST::cEnumerator enumerator_32095 (var_cas_inFunctionSignature, true) ;
    const GGS_formalInputParameterListAST::cElement * operand_32095 = NULL ;
    while (((operand_32095 = enumerator_32095.nextObject ()))) {
      macroValidPointer (operand_32095) ;
      const GGS_unifiedTypeMapProxy  var_cas_parameterType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, operand_32095->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (789)) ;
      const GGS_bool cond_32759 = operand_32095->mIsConstant ;
      if (cond_32759.isBuiltAndTrue ()) {
        const GGS_string var_cas_cppName = (GGS_string ("constinArgument_")).operator_concat (operand_32095->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_outSignatureForGeneration.addAssign_operation (var_cas_parameterType, var_cas_cppName, operand_32095->mIsUnused) ;
        const GGS_bool cond_32621 = operand_32095->mIsUnused ;
        if (cond_32621.isBuiltAndTrue ()) {
          var_cas_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (inLexique, operand_32095->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (798)) ;
        }else if (cond_32621.isBuiltAndFalse ()) {
          var_cas_variableMap.modifier_insertConstantInputFormalArgument (inLexique, operand_32095->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (800)) ;
        }
      }else if (cond_32759.isBuiltAndFalse ()) {
        const GGS_string var_cas_cppName = (GGS_string ("inArgument_")).operator_concat (operand_32095->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
        var_cas_outSignatureForGeneration.addAssign_operation (var_cas_parameterType, var_cas_cppName, operand_32095->mIsUnused) ;
        const GGS_bool cond_33114 = operand_32095->mIsUnused ;
        if (cond_33114.isBuiltAndTrue ()) {
          var_cas_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (inLexique, operand_32095->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (810)) ;
        }else if (cond_33114.isBuiltAndFalse ()) {
          var_cas_variableMap.modifier_insertInputFormalArgument (inLexique, operand_32095->mFormalArgumentName, var_cas_parameterType, var_cas_cppName, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (812)) ;
        }
      }
    }
  }
  var_cas_outReturnedType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, var_cas_inResultTypeName COMMA_SOURCE_FILE_AT_LINE (817)) ;
  ...
  var_cas_variableMap.modifier_insertOutputFormalArgument (inLexique, var_cas_inReturnVariableName, var_cas_outReturnedType, var_cas_outResultVariableCppName, var_cas_outResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (819)) ;
  var_cas_outSemanticInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
  {
    GGS_semanticInstructionListAST::cEnumerator enumerator_33794 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListAST::cElement * operand_33794 = NULL ;
    while (((operand_33794 = enumerator_33794.nextObject ()))) {
      macroValidPointer (operand_33794) ;
      { typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (operand_33794->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_33794->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_outSemanticInstructionListForGeneration, var_cas_variableMap COMMA_SOURCE_FILE_AT_LINE (823)) ;
        }
      }
    }
  }
  if (var_cas_variableMap.isBuilt ()) {
    var_cas_variableMap (HERE)->method_checkAutomatonStates (inLexique, var_cas_inEndOfFunctionLocation COMMA_SOURCE_FILE_AT_LINE (830)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__functionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_functionDeclarationAST * operand_34187,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34187 != NULL) {
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ...
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (848)), GGS_string ("")) ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  operand_34187->mFormalArgumentList,  operand_34187->mFunctionInstructionList,  operand_34187->mResultVariableName,  operand_34187->mResultTypeName,  operand_34187->mEndOfFunctionInstructionList,  var_cas_formalInputParameterList,  var_cas_returnType,  var_cas_resultVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (851)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_functionImplementationForGeneration ::constructor_new (inLexique, operand_34187->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (865)), var_cas_formalInputParameterList, var_cas_returnType, var_cas_resultVariableCppName, var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (864)), GGS_string ("")) ;
  }
}
...
category_method__onceFunctionDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_35447,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_35447 != NULL) {
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    GGS_unifiedTypeMapProxy  var_cas_returnType ;
    GGS_string var_cas_resultVariableCppName ;
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (889)), GGS_string ("")) ;
    GGS_formalInputParameterListForGeneration  automatic_var_36227_0 ;
    ::routine_analyzeFunctionBody (inLexique,  var_cas_analysisContext,  GGS_formalInputParameterListAST ::constructor_emptyList (),  operand_35447->mFunctionInstructionList,  operand_35447->mResultVariableName,  operand_35447->mResultTypeName,  operand_35447->mEndOfFunctionInstructionList,  automatic_var_36227_0,  var_cas_returnType,  var_cas_resultVariableCppName,  var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (892)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_onceFunctionDeclarationForGeneration ::constructor_new (inLexique, operand_35447->mFunctionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (906)), var_cas_returnType, var_cas_resultVariableCppName, var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (905)), GGS_string ("")) ;
  }
}
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  var_cas_ioWrapperDirectoryIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (941)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_37833 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_37833 = NULL ;
    while (((operand_37833 = enumerator_37833.nextObject ()))) {
      macroValidPointer (operand_37833) ;
      const GGS_bool cond_38340 = var_cas_inExtensionMap.reader_hasKey (operand_37833->mValue.reader_pathExtension ()) ;
      if (cond_38340.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_37833->mValue) ;
        var_cas_outWrapperFileSortedList.addAssign_operation (operand_37833->mValue, var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex) ;
        var_cas_ioRegularFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (var_cas_inPathInWrapper).operator_concat (operand_37833->mValue), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (956)), var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (955)) ;
        var_cas_ioWrapperFileIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (960)) ;
      }
    }
  }
  ...
  {
    GGS_stringlist::cEnumerator enumerator_38575 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_38575 = NULL ;
    while (((operand_38575 = enumerator_38575.nextObject ()))) {
      macroValidPointer (operand_38575) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_38575->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_38575->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileSortedList,  var_cas_internalWrapperDirectorySortedList,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex,  var_cas_ioRegularFileMap COMMA_SOURCE_FILE_AT_LINE (970)) ;
      var_cas_outWrapperDirectorySortedList.addAssign_operation (operand_38575->mValue, var_cas_internalWrapperFileSortedList, var_cas_internalWrapperDirectorySortedList, var_cas_theDirectoryIndex) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__filewrapperDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_39409,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39409 != NULL) {
    GGS_wrapperExtensionMap  var_cas_extensionMap = GGS_wrapperExtensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (997)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_39693 (operand_39409->mFilewrapperExtensionList, true) ;
      const GGS_lstringlist::cElement * operand_39693 = NULL ;
      while (((operand_39693 = enumerator_39693.nextObject ()))) {
        macroValidPointer (operand_39693) ;
        var_cas_extensionMap.modifier_insertKey (inLexique, operand_39693->mValue COMMA_SOURCE_FILE_AT_LINE (999)) ;
      }
    }
    GGS_filewrapperRegularFileMap  var_cas_regularFileMap = GGS_filewrapperRegularFileMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1002)) ;
    GGS_string var_cas_absoluteSourcePath ;
    const GGS_bool cond_39983 = (operand_39409->mFilewrapperPath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_39983.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = operand_39409->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1005)) ;
    }else if (cond_39983.isBuiltAndFalse ()) {
      var_cas_absoluteSourcePath = ((var_cas_inSemanticContext.reader_mSourceFileAbsolutePath (inLexique COMMA_SOURCE_FILE_AT_LINE (1007)).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_39409->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1007))) ;
    }
    const GGS_bool cond_40284 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_40284.isBuiltAndTrue ()) {
      operand_39409->mFilewrapperPath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (var_cas_absoluteSourcePath)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
    }else if (cond_40284.isBuiltAndFalse ()) {
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  var_cas_absoluteSourcePath,  GGS_string ("/"),  var_cas_extensionMap,  var_cas_wrapperFileSortedList,  var_cas_wrapperDirectorySortedList,  var_cas_wrapperFileIndex,  var_cas_wrapperDirectoryIndex,  var_cas_regularFileMap COMMA_SOURCE_FILE_AT_LINE (1017)) ;
      {
        GGS_filewrapperTemplateListAST::cEnumerator enumerator_40799 (operand_39409->mFilewrapperTemplateList, true) ;
        const GGS_filewrapperTemplateListAST::cElement * operand_40799 = NULL ;
        while (((operand_40799 = enumerator_40799.nextObject ()))) {
          macroValidPointer (operand_40799) ;
          GGS_string var_cas_absoluteTemplatePath ;
          const GGS_bool cond_40986 = (operand_40799->mFilewrapperTemplatePath.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_40986.isBuiltAndTrue ()) {
            var_cas_absoluteTemplatePath = operand_40799->mFilewrapperTemplatePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1031)) ;
          }else if (cond_40986.isBuiltAndFalse ()) {
            var_cas_absoluteTemplatePath = ((var_cas_inSemanticContext.reader_mSourceFileAbsolutePath (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_40799->mFilewrapperTemplatePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1033))) ;
          }
          const GGS_bool cond_41318 = (var_cas_absoluteTemplatePath.reader_fileExists ()).operator_not () ;
          if (cond_41318.isBuiltAndTrue ()) {
            operand_40799->mFilewrapperTemplatePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (var_cas_absoluteTemplatePath)).operator_concat (GGS_string ("' file does not exist")) COMMA_SOURCE_FILE_AT_LINE (1037)) ;
          }
        }
      }
      var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_filewrapperDeclarationForGeneration ::constructor_new (inLexique, operand_39409->mFilewrapperName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1041)), operand_39409->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)), var_cas_extensionMap, var_cas_wrapperFileSortedList, var_cas_wrapperDirectorySortedList COMMA_SOURCE_FILE_AT_LINE (1040)), GGS_string ("")) ;
    }
  }
}
...
category_method__abstractCategoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodAST * operand_41814,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41814 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_41814->mTypeName COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    const GGS_bool cond_42351 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1062))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1062))) ;
    if (cond_42351.isBuiltAndTrue ()) {
      operand_41814->mAbstractCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1063)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1064)) ;
    }else if (cond_42351.isBuiltAndFalse ()) {
      const GGS_bool cond_42523 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1064)) ;
      if (cond_42523.isBuiltAndTrue ()) {
        operand_41814->mAbstractCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare an abstract category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1065)))).operator_concat (GGS_string ("' is not an abstract class")) COMMA_SOURCE_FILE_AT_LINE (1066)) ;
      }
    }
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_42694 (operand_41814->mAbstractCategoryMethodFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_42694 = NULL ;
      while (((operand_42694 = enumerator_42694.nextObject ()))) {
        macroValidPointer (operand_42694) ;
        var_cas_formalParameterListForGeneration.addAssign_operation (operand_42694->mFormalArgumentPassingMode, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42694->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1072)), operand_42694->mFormalArgumentName, operand_42694->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074))) ;
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_abstractCategoryMethodForGeneration ::constructor_new (inLexique, operand_41814->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1079)), operand_41814->mAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1080)), var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1078)), var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1083))) ;
  }
}
...
category_method__categoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_categoryMethodAST * operand_43324,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43324 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43324->mTypeName COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    const GGS_bool cond_43834 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1097))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1097))) ;
    if (cond_43834.isBuiltAndTrue ()) {
      operand_43324->mCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1098)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1099)) ;
    }
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    ...
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_43324->mCategoryMethodFormalParameterList,  GGS_localConstantList ::constructor_emptyList (),  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1113)),  GGS_string ("object->"),  operand_43324->mCategoryMethodInstructionList,  operand_43324->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1109)) ;
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_categoryMethodForGeneration ::constructor_new (inLexique, operand_43324->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1122)), operand_43324->mCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)), var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1125)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1121)), var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1128))) ;
  }
}
...
category_method__overridingCategoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodAST * operand_44925,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                GGS_semanticDeclarationSortedListForGeneration  & var_cas_ioSemanticDeclarationListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_44925 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_44925->mTypeName COMMA_SOURCE_FILE_AT_LINE (1140)) ;
    const GGS_bool cond_45445 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1142))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1142))) ;
    if (cond_45445.isBuiltAndTrue ()) {
      operand_44925->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1144)) ;
    }
    GGS_string var_cas_baseTypeName = GGS_string ("") ;
    GGS_unifiedTypeMapProxy  var_cas_superType = var_cas_selfType.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1147)) ;
    ...
    GGS_uint _variant_46239 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1150)) ;
    GGS_bool _condition_46239 (_variant_46239.isBuilt (), true) ;
    while (_condition_46239.isBuiltAndTrue ()) {
      _condition_46239 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1151))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_46239.isBuiltAndTrue ()) {
        if (_variant_46239.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1160)) ;
          _condition_46239 = GGS_bool (false) ;
        }else{
          _variant_46239.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_46186 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1152)).reader_hasKey (operand_44925->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1152))) ;
          if (cond_46186.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_46060_0 ;
            GGS_bool automatic_var_46060_1 ;
            const GGS_instanceMethodMap  temp_45961 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1154)) ;
            if (temp_45961.isBuilt ()) {
              temp_45961 (HERE)->method_searchKey (inLexique, operand_44925->mOverridingCategoryMethodName, automatic_var_46060_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_46060_1, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1154)) ;
            }
            const GGS_bool cond_46173 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1155))) ;
            if (cond_46173.isBuiltAndTrue ()) {
              var_cas_baseTypeName = var_cas_superType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1156)) ;
            }
          }
          var_cas_superType = var_cas_superType.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1159)) ;
        }
      }
    }
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
    GGS_semanticInstructionListForGeneration  var_cas_semanticInstructionListForGeneration ;
    const GGS_analysisContext var_cas_analysisContext = GGS_analysisContext::constructor_new (var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_selfType, GGS_string ("object")) ;
    ::routine_analyzeRoutineBody (inLexique,  var_cas_analysisContext,  operand_44925->mOverridingCategoryMethodFormalParameterList,  GGS_localConstantList ::constructor_emptyList (),  var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)),  GGS_string ("object->"),  operand_44925->mOverridingCategoryMethodInstructionList,  operand_44925->mEndOfMethodLocation,  var_cas_semanticInstructionListForGeneration,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1170)) ;
    const GGS_bool cond_47141 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_47141.isBuiltAndTrue ()) {
      ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_44925->mOverridingCategoryMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1183)) ;
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_overridingCategoryMethodForGeneration ::constructor_new (inLexique, operand_44925->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1192)), var_cas_baseTypeName, operand_44925->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1194)), var_cas_formalParameterListForGeneration, var_cas_selfType.reader_mAllTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)), var_cas_semanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1191)), GGS_string ("{override}")) ;
  }
}
...
category_method__overridingAbstractCategoryMethodAST__performSemanticAnalysis (C_Compiler & inLexique,
                                const cPtr_overridingAbstractCategoryMethodAST * operand_47639,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticDeclarationSortedListForGeneration  & /* var_cas_ioSemanticDeclarationListForGeneration */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47639 != NULL) {
    const GGS_unifiedTypeMapProxy  var_cas_selfType = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_47639->mTypeName COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    const GGS_bool cond_48180 = (var_cas_selfType.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1213))).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1213))) ;
    if (cond_48180.isBuiltAndTrue ()) {
      operand_47639->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare a category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1214)))).operator_concat (GGS_string ("' is not a class")) COMMA_SOURCE_FILE_AT_LINE (1215)) ;
    }else if (cond_48180.isBuiltAndFalse ()) {
      const GGS_bool cond_48354 = var_cas_selfType.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (1215)) ;
      if (cond_48354.isBuiltAndTrue ()) {
        operand_47639->mOverridingCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot declare an abstract category method: '@")).operator_concat (var_cas_selfType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1216)))).operator_concat (GGS_string ("' is not an abstract class")) COMMA_SOURCE_FILE_AT_LINE (1217)) ;
      }
    }
    GGS_string var_cas_baseTypeName = GGS_string ("") ;
    GGS_unifiedTypeMapProxy  var_cas_superType = var_cas_selfType.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1220)) ;
    GGS_formalParameterSignature  var_cas_inheritedSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_location  var_cas_inheritedDeclarationLocation = GGS_location (inLexique) ;
    GGS_uint _variant_49148 = var_cas_inSemanticContext.mTypeMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
    GGS_bool _condition_49148 (_variant_49148.isBuilt (), true) ;
    while (_condition_49148.isBuiltAndTrue ()) {
      _condition_49148 = ((var_cas_superType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1224))).operator_not ()).operator_and ((var_cas_baseTypeName).operator_isEqual (GGS_string (""))) ;
      if (_condition_49148.isBuiltAndTrue ()) {
        if (_variant_49148.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1233)) ;
          _condition_49148 = GGS_bool (false) ;
        }else{
          _variant_49148.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_49095 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1225)).reader_hasKey (operand_47639->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1225))) ;
          if (cond_49095.isBuiltAndTrue ()) {
            GGS_methodQualifier var_cas_qualifier ;
            GGS_bool automatic_var_48969_0 ;
            GGS_bool automatic_var_48969_1 ;
            const GGS_instanceMethodMap  temp_48870 = var_cas_superType.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1227)) ;
            if (temp_48870.isBuilt ()) {
              temp_48870 (HERE)->method_searchKey (inLexique, operand_47639->mOverridingCategoryMethodName, automatic_var_48969_0, var_cas_inheritedSignature, var_cas_inheritedDeclarationLocation, automatic_var_48969_1, var_cas_qualifier COMMA_SOURCE_FILE_AT_LINE (1227)) ;
            }
            const GGS_bool cond_49082 = (var_cas_qualifier).operator_infOrEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1228))) ;
            if (cond_49082.isBuiltAndTrue ()) {
              var_cas_baseTypeName = var_cas_superType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1229)) ;
            }
          }
          var_cas_superType = var_cas_superType.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1232)) ;
        }
      }
    }
    GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)) ;
    GGS_formalParameterListForGeneration  var_cas_formalParameterListForGeneration ;
    ::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  operand_47639->mOverridingCategoryMethodFormalParameterList,  var_cas_variableMap,  var_cas_formalParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (1237)) ;
    const GGS_bool cond_49707 = (var_cas_baseTypeName).operator_isNotEqual (GGS_string ("")) ;
    if (cond_49707.isBuiltAndTrue ()) {
      ::routine_checkMethodSignatures (inLexique,  var_cas_formalParameterListForGeneration,  operand_47639->mOverridingCategoryMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)),  var_cas_inheritedSignature,  var_cas_inheritedDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (1245)) ;
    }
  }
}
...
GGS_predefinedTypes function_buildPredefinedTypes (C_Compiler & inLexique,
  ...
  var_cas_outPredefinedTypes = GGS_predefinedTypes::constructor_new (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1298)) COMMA_SOURCE_FILE_AT_LINE (1298)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("bool"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1299)) COMMA_SOURCE_FILE_AT_LINE (1299)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1301)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1302)) COMMA_SOURCE_FILE_AT_LINE (1302)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1304)) COMMA_SOURCE_FILE_AT_LINE (1304)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1305)) COMMA_SOURCE_FILE_AT_LINE (1305)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("double"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1306)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lbool"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1307)) COMMA_SOURCE_FILE_AT_LINE (1307)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1308)) COMMA_SOURCE_FILE_AT_LINE (1308)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1309)) COMMA_SOURCE_FILE_AT_LINE (1309)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1310)) COMMA_SOURCE_FILE_AT_LINE (1310)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1311)) COMMA_SOURCE_FILE_AT_LINE (1311)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1312)) COMMA_SOURCE_FILE_AT_LINE (1312)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint64"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1313)) COMMA_SOURCE_FILE_AT_LINE (1313)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("ldouble"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1314)) COMMA_SOURCE_FILE_AT_LINE (1314))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  #endif
  const GGS_predefinedTypes var_cas_predefinedTypes = function_buildPredefinedTypes (inLexique, var_cas_inSemanticContext COMMA_SOURCE_FILE_AT_LINE (1329)) ;
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_54247 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_54247 = NULL ;
    while (((operand_54247 = enumerator_54247.nextObject ()))) {
      macroValidPointer (operand_54247) ;
      { typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (operand_54247->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_54247->mSemanticDeclaration (HERE), var_cas_inSemanticContext, var_cas_predefinedTypes, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (1332)) ;
        }
      }
    }
  }
