...
category_method__classDeclarationAST__performSemanticAnalysis (C_Compiler & inLexique,
  ...
  if (operand_17873 != NULL) {
      ...
      while (((operand_20999 = enumerator_20999.nextObject ()))) {
        ...
        GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (500)) ;
        {
          ...
          while (((operand_22169 = enumerator_22169.nextObject ()))) {
            ...
            const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_22169->mFormalParameterTypeName COMMA_SOURCE_FILE_AT_LINE (502)) ;
            switch (operand_22169->mFormalParameterPassingMode.enumValue ()) {
            case GGS_formalArgumentPassingModeAST::enum_argumentIn:
              {
              const GGS_bool cond_22493 = operand_22169->mIsUnused ;
              if (cond_22493.isBuiltAndTrue ()) {
                var_cas_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (506)) ;
              }else if (cond_22493.isBuiltAndFalse ()) {
                var_cas_variableMap.modifier_insertInputFormalArgument (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (508)) ;
              }
              }
              break ;
            case GGS_formalArgumentPassingModeAST::enum_argumentOut:
              {
              var_cas_variableMap.modifier_insertOutputFormalArgument (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (511)) ;
              }
              break ;
            case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
              {
              const GGS_bool cond_22904 = operand_22169->mIsUnused ;
              if (cond_22904.isBuiltAndTrue ()) {
                var_cas_variableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (514)) ;
              }else if (cond_22904.isBuiltAndFalse ()) {
                var_cas_variableMap.modifier_insertInputOutputFormalArgument (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (516)) ;
              }
              }
              break ;
            case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
              {
              const GGS_bool cond_23210 = operand_22169->mIsUnused ;
              if (cond_23210.isBuiltAndTrue ()) {
                var_cas_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (520)) ;
              }else if (cond_23210.isBuiltAndFalse ()) {
                var_cas_variableMap.modifier_insertConstantInputFormalArgument (inLexique, operand_22169->mFormalParameterName, var_cas_type, GGS_string ("prefixe_") COMMA_SOURCE_FILE_AT_LINE (522)) ;
              }
              }
              break ;
        ...
        {
          GGS_semanticInstructionListAST::cEnumerator enumerator_23521 (operand_20999->mInstructionList, true) ;
          const GGS_semanticInstructionListAST::cElement * operand_23521 = NULL ;
          while (((operand_23521 = enumerator_23521.nextObject ()))) {
            macroValidPointer (operand_23521) ;
            const GGS_semanticInstructionAST  temp_23571 = operand_23521->mInstruction ;
            if (temp_23571.isBuilt ()) {
              typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (temp_23571.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_23571 (HERE), var_cas_inSemanticContext, var_cas_semanticInstructionListForGeneration, var_cas_variableMap COMMA_SOURCE_FILE_AT_LINE (529)) ;
              }
            }
          }
        }
        var_cas_definedMethodSet.addAssign_operation (operand_20999->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (536))) ;
    ...
    const GGS_bool cond_24432 = (operand_17873->mIsAbstract).operator_not () ;
    if (cond_24432.isBuiltAndTrue ()) {
      {
        GGS_instanceMethodMap::cEnumerator enumerator_24033 (var_cas_inheritedInstanceMethodMap, true) ;
        const GGS_instanceMethodMap::cElement * operand_24033 = NULL ;
        while (((operand_24033 = enumerator_24033.nextObject ()))) {
          macroValidPointer (operand_24033) ;
          const GGS_bool cond_24403 = ((operand_24033->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (547)))).operator_or ((operand_24033->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (547)))) ;
          if (cond_24403.isBuiltAndTrue ()) {
            const GGS_bool cond_24384 = (var_cas_definedMethodSet.reader_hasKey (operand_24033->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (548)))).operator_not () ;
            if (cond_24384.isBuiltAndTrue ()) {
              operand_24033->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '@")).operator_concat (operand_17873->mClassTypeName)).operator_concat (GGS_string ("' class is declared concrete, but the '"))).operator_concat (operand_24033->mKey)).operator_concat (GGS_string ("' method declared in a super class is not implemented")) COMMA_SOURCE_FILE_AT_LINE (550)) ;
            }
          }
        }
      }
    }
    var_cas_ioSemanticDeclarationListForGeneration.addAssign_operation (GGS_classTypeForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_17873->mClassTypeName COMMA_SOURCE_FILE_AT_LINE (556)), operand_17873->mIsAbstract, operand_17873->mClassTypeName, var_cas_superClassProxy, var_cas_allAttributeList, var_cas_typedAttributeList, var_cas_abstractMethodList, var_cas_methodList COMMA_SOURCE_FILE_AT_LINE (555))) ;
  }
}
...
void routine_performSemanticAnalysis (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_25491 (var_cas_inDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_25491 = NULL ;
    while (((operand_25491 = enumerator_25491.nextObject ()))) {
      macroValidPointer (operand_25491) ;
      const GGS_semanticDeclarationAST  temp_25544 = operand_25491->mSemanticDeclaration ;
      if (temp_25544.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__performSemanticAnalysis method = findCategoryMethod__semanticDeclarationAST__performSemanticAnalysis (temp_25544.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_25544 (HERE), var_cas_inSemanticContext, var_cas_outDecoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (581)) ;
        }
      }
    }
  }
