...
void routine_buildLocalVariableMapAndSignature (const GALGAS_semanticContext constinArgument_inSemanticContext,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_38050 (constinArgument_inRoutineSignatureAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_38050.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_38050.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (960)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_formalArgumentCppName ;
    //------- @switchInstructionForGeneration
    if (enumerator_38050.current_mFormalArgumentPassingMode (HERE).isValid ()) {
      switch (enumerator_38050.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
      case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
        break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
        //-------- @assignmentInstructionForGeneration
        var_formalArgumentCppName = GALGAS_string ("inArgument_").operator_concat (enumerator_38050.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (964)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (964)) COMMA_SOURCE_FILE_AT_LINE (964)) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = enumerator_38050.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_0) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioVariableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
          } //-------- END @typeMethodInstructionForGeneration
        }else if (kBoolFalse == test_0) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioVariableMap.modifier_insertInputFormalArgument (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (968)) ;
          } //-------- END @typeMethodInstructionForGeneration
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
        //-------- @assignmentInstructionForGeneration
        var_formalArgumentCppName = GALGAS_string ("outArgument_").operator_concat (enumerator_38050.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (971)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (971)) COMMA_SOURCE_FILE_AT_LINE (971)) ;
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioVariableMap.modifier_insertOutputFormalArgument (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
        } //-------- END @typeMethodInstructionForGeneration
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
        //-------- @assignmentInstructionForGeneration
        var_formalArgumentCppName = GALGAS_string ("ioArgument_").operator_concat (enumerator_38050.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (974)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = enumerator_38050.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_1) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgumentDeclaredAsUnused (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (976)) ;
          } //-------- END @typeMethodInstructionForGeneration
        }else if (kBoolFalse == test_1) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioVariableMap.modifier_insertInputOutputFormalArgument (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
          } //-------- END @typeMethodInstructionForGeneration
        }
        } break ;
      case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
        //-------- @assignmentInstructionForGeneration
        var_formalArgumentCppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_38050.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (981)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (981)) COMMA_SOURCE_FILE_AT_LINE (981)) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = enumerator_38050.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_2) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
          } //-------- END @typeMethodInstructionForGeneration
        }else if (kBoolFalse == test_2) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioVariableMap.modifier_insertConstantInputFormalArgument (enumerator_38050.current_mFormalArgumentName (HERE), var_type, var_formalArgumentCppName, var_formalArgumentCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (985)) ;
          } //-------- END @typeMethodInstructionForGeneration
        }
        } break ;
      }
    ...
    //-------- @plusEqualnstructionForGeneration
    outArgument_outRoutineSignature.addAssign_operation (enumerator_38050.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_38050.current_mFormalArgumentName (HERE), var_formalArgumentCppName COMMA_SOURCE_FILE_AT_LINE (988)) ;
...
void routine_analyzeRoutineBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_localConstantList enumerator_40738 (constinArgument_inLocalConstantList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40738.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = enumerator_40738.current_mNoWarningIfUnused (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_variableMap.modifier_insertUsedLocalConstant (enumerator_40738.current_mName (HERE), enumerator_40738.current_mType (HERE), enumerator_40738.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_variableMap.modifier_insertLocalConstant (enumerator_40738.current_mName (HERE), enumerator_40738.current_mType (HERE), enumerator_40738.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1012)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_40738.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_41112 (constinArgument_inNonMutableTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41112.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_41112.current_mAttributeName (HERE), enumerator_41112.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1020)).operator_concat (enumerator_41112.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1020)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1020)) COMMA_SOURCE_FILE_AT_LINE (1020)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1017)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_41112.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_41460 (constinArgument_inMutableTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41460.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_variableMap.modifier_insertMutableAttribute (enumerator_41460.current_mAttributeName (HERE), enumerator_41460.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1029)).operator_concat (enumerator_41460.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1029)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1029)) COMMA_SOURCE_FILE_AT_LINE (1029)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_41460.gotoNextObject () ;
  }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticInstructionListAST enumerator_42063 (constinArgument_inInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42063.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_42063.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_42063.gotoNextObject () ;
  }
  //-------- @methodCallInstructionForGeneration
...
void routine_analyzeFunctionBody (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_49504 (constinArgument_inTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49504.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_variableMap.modifier_insertNonMutableAttribute (enumerator_49504.current_mAttributeName (HERE), enumerator_49504.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.operator_concat (GALGAS_string ("mAttribute_") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (enumerator_49504.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1264)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_49504.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_49918 (constinArgument_inFunctionSignature, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49918.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_49918.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1271)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = enumerator_49918.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_cppName = GALGAS_string ("constinArgument_").operator_concat (enumerator_49918.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1273)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1273)) COMMA_SOURCE_FILE_AT_LINE (1273)) ;
      //-------- @plusEqualnstructionForGeneration
      outArgument_outSignatureForGeneration.addAssign_operation (var_parameterType, var_cppName, enumerator_49918.current_mFormalArgumentName (HERE), enumerator_49918.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1274)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = enumerator_49918.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        { //-------- @modifierCallInstructionForGeneration
        var_variableMap.modifier_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_49918.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }else if (kBoolFalse == test_1) {
        { //-------- @modifierCallInstructionForGeneration
        var_variableMap.modifier_insertConstantInputFormalArgument (enumerator_49918.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1283)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
    }else if (kBoolFalse == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_cppName = GALGAS_string ("inArgument_").operator_concat (enumerator_49918.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1286)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
      //-------- @plusEqualnstructionForGeneration
      outArgument_outSignatureForGeneration.addAssign_operation (var_parameterType, var_cppName, enumerator_49918.current_mFormalArgumentName (HERE), enumerator_49918.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1287)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = enumerator_49918.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_2) {
        { //-------- @modifierCallInstructionForGeneration
        var_variableMap.modifier_insertInputFormalArgumentDeclaredAsUnused (enumerator_49918.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1294)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }else if (kBoolFalse == test_2) {
        { //-------- @modifierCallInstructionForGeneration
        var_variableMap.modifier_insertInputFormalArgument (enumerator_49918.current_mFormalArgumentName (HERE), var_parameterType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1296)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
    }
    enumerator_49918.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticInstructionListAST enumerator_51701 (constinArgument_inInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51701.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_51701.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1307)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_51701.gotoNextObject () ;
  }
  //-------- @methodCallInstructionForGeneration
...
void routine_performSemanticAnalysis (const GALGAS_semanticDeclarationListAST constinArgument_inDeclarationList,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_88139 (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_unsolvedProxyKeyList (SOURCE_FILE_AT_LINE (2231)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_88139.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - @").operator_concat (enumerator_88139.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)) ;
      enumerator_88139.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_88406 (constinArgument_inDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_88406.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_88406.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2239)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_88406.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationListAST enumerator_88776 (var_semanticDeclarationList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_88776.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_semanticAnalysis ((const cPtr_semanticDeclarationAST *) enumerator_88776.current_mSemanticDeclaration (HERE).ptr (), constinArgument_inSemanticContext, var_predefinedTypes, outArgument_outDecoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (2246)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_88776.gotoNextObject () ;
    }
  }
}
...
static void categoryMethod_mapProxyDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_36944_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_36944_4 ; // Joker input parameter
  GALGAS_typeKindEnum joker_36944_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_36944_2 ; // Joker input parameter
  GALGAS_attributeMap joker_36944_1 ; // Joker input parameter
  GALGAS_constructorMap joker_36980_11 ; // Joker input parameter
  GALGAS_readerMap joker_36980_10 ; // Joker input parameter
  GALGAS_modifierMap joker_36980_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_36980_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_36980_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_36980_6 ; // Joker input parameter
  GALGAS_stringlist joker_36980_5 ; // Joker input parameter
  GALGAS_uint joker_36980_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_36980_3 ; // Joker input parameter
  GALGAS_stringset joker_36980_2 ; // Joker input parameter
  GALGAS_lstringlist joker_36980_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_37010_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_37010_4 ; // Joker input parameter
  GALGAS_bool joker_37010_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_37010_2 ; // Joker input parameter
  GALGAS_string joker_37010_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_36944_5, joker_36944_4, joker_36944_3, joker_36944_2, joker_36944_1, var_listTypeAttributeList, joker_36980_11, joker_36980_10, joker_36980_9, joker_36980_8, joker_36980_7, joker_36980_6, joker_36980_5, joker_36980_4, joker_36980_3, joker_36980_2, joker_36980_1, var_searchMethodList, joker_37010_5, joker_37010_4, joker_37010_3, joker_37010_2, joker_37010_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (924)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_42731 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42731.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalArgumentList.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_42731.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)), enumerator_42731.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1064)), enumerator_42731.current_mFormalArgumentName (HERE), enumerator_42731.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
...
static void categoryMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_43644 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43644.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalArgumentList.addAssign_operation (enumerator_43644.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_43644.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1090)), enumerator_43644.current_mFormalArgumentName (HERE), enumerator_43644.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1088)) ;
...
static void categoryMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_46173 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_46173.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_46173.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1164)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          //-------- @ifInstructionForGeneration
          ...
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_46173.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_6) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_46834 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_46834.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_7 (enumerator_46834.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_47117 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_47117.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_47117.current_mAttributeTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_47302 (enumerator_47117.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_47302.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_47302.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1191)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_9 = var_hasSetter.boolEnum () ;
        if (kBoolTrue == test_9) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_10 (enumerator_47302.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_47302.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_12 = var_hasGetter.operator_not (SOURCE_FILE_AT_LINE (1197)).boolEnum () ;
          if (kBoolTrue == test_12) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_13 (enumerator_47302.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          //-------- @errorInstructionForGeneration
          GALGAS_location location_14 (enumerator_47302.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_47302.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_t, enumerator_47117.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1205)) ;
    //-------- @plusEqualnstructionForGeneration
    var_allAttributeList.addAssign_operation (var_t, enumerator_47117.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_47117.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_47117.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1222)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)).isValid ()) {
    PMUInt32 variant_48218 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1222)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)).uintValue () ;
    bool loop_48218 = true ;
    while (loop_48218) {
      loop_48218 = var_t.reader_isNull (SOURCE_FILE_AT_LINE (1223)).operator_not (SOURCE_FILE_AT_LINE (1223)).isValid () ;
      if (loop_48218) {
        loop_48218 = var_t.reader_isNull (SOURCE_FILE_AT_LINE (1223)).operator_not (SOURCE_FILE_AT_LINE (1223)).boolValue () ;
      }
      if (loop_48218 && (0 == variant_48218)) {
        loop_48218 = false ;
...
static void categoryMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @routineCallInstructionForGeneration
  GALGAS_formalInputParameterListForGeneration joker_54199_0 ; // Joker input parameter
  routine_analyzeFunctionBody (var_analysisContext, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1383)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1384)), GALGAS_string::makeEmptyString (), object->mAttribute_mFunctionInstructionList, object->mAttribute_mResultVariableName, object->mAttribute_mResultTypeName, object->mAttribute_mEndOfFunctionInstructionList, joker_54199_0, var_returnType, var_resultVariableCppName, var_semanticInstructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1381)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_55342_0 ; // Joker input parameter
  GALGAS_lstringlist joker_55349_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_55401_0 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_55342_0, joker_55349_0, var_wrapperFileMap, var_wrapperDirectoryMap, joker_55401_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1421)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_filewrapperTemplateListAST enumerator_56061 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_56061.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_56061.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE_AT_LINE (1442)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1442)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_4 (enumerator_56061.current_mFilewrapperTemplatePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_absoluteTemplatePath = var_absoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1445)).operator_concat (enumerator_56061.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE_AT_LINE (1445)) COMMA_SOURCE_FILE_AT_LINE (1445)) ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_templateInstructionListAST var_resultingInstructionList ;
      { //-------- @grammarInstructionWithSourceFileForGeneration
      cGrammar_templateGrammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absoluteTemplatePath, enumerator_56061.current_mFilewrapperTemplatePath (HERE).reader_location (SOURCE_FILE_AT_LINE (1448)) COMMA_SOURCE_FILE_AT_LINE (1448)), var_resultingInstructionList COMMA_SOURCE_FILE_AT_LINE (1448)) ;
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalTemplateInputParameterListAST enumerator_56874 (enumerator_56061.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_56874.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_56874.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1453)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_cppVarName = GALGAS_string ("in_").operator_concat (enumerator_56874.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1454)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1454)) COMMA_SOURCE_FILE_AT_LINE (1454)) ;
        { //-------- @modifierCallInstructionForGeneration
        var_templateVariableMap.modifier_insertKey (enumerator_56874.current_mFormalArgumentName (HERE), var_type, var_cppVarName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1455)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_filewrapperTemplateFormalInputParameters.addAssign_operation (var_type, var_cppVarName, enumerator_56874.current_mFormalArgumentName (HERE), GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1456)) ;
      ...
      //-------- @plusEqualnstructionForGeneration
      var_filewrapperTemplateListForGeneration.addAssign_operation (enumerator_56061.current_mFilewrapperTemplateName (HERE).reader_string (SOURCE_FILE_AT_LINE (1468)), var_filewrapperTemplateFormalInputParameters, var_templateInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1467)) ;
      enumerator_56061.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_abstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_59307 (object->mAttribute_mAbstractCategoryMethodFormalParameterList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59307.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalParameterListForGeneration.addAssign_operation (enumerator_59307.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_59307.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1507)), enumerator_59307.current_mFormalArgumentName (HERE), enumerator_59307.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1509)) COMMA_SOURCE_FILE_AT_LINE (1505)) ;
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1599)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1599)).isValid ()) {
    PMUInt32 variant_62709 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1599)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1599)).uintValue () ;
    bool loop_62709 = true ;
    while (loop_62709) {
      loop_62709 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1600)).operator_not (SOURCE_FILE_AT_LINE (1600)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1600)).isValid () ;
      if (loop_62709) {
        loop_62709 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1600)).operator_not (SOURCE_FILE_AT_LINE (1600)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1600)).boolValue () ;
      }
      if (loop_62709 && (0 == variant_62709)) {
        loop_62709 = false ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1675)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1675)).isValid ()) {
    PMUInt32 variant_65743 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1675)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1675)).uintValue () ;
    bool loop_65743 = true ;
    while (loop_65743) {
      loop_65743 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1676)).operator_not (SOURCE_FILE_AT_LINE (1676)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1676)).isValid () ;
      if (loop_65743) {
        loop_65743 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1676)).operator_not (SOURCE_FILE_AT_LINE (1676)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1676)).boolValue () ;
      }
      if (loop_65743 && (0 == variant_65743)) {
        loop_65743 = false ;
      ...
      if (loop_65743) {
        ...
        if (kBoolTrue == test_4) {
          ...
          GALGAS_methodQualifier var_qualifier ;
          //-------- @methodCallInstructionForGeneration
          GALGAS_methodKind joker_66049_0 ; // Joker input parameter
          GALGAS_bool joker_66102_0 ; // Joker input parameter
          GALGAS_string joker_66116_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1679)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_66049_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_66102_0, var_qualifier, joker_66116_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1679)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @ifInstructionForGeneration
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_67910 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67910.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalParameterListForGeneration.addAssign_operation (enumerator_67910.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_67910.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)), enumerator_67910.current_mFormalArgumentName (HERE), enumerator_67910.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1728)) COMMA_SOURCE_FILE_AT_LINE (1724)) ;
    enumerator_67910.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1818)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)).isValid ()) {
    PMUInt32 variant_71315 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1818)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)).uintValue () ;
    bool loop_71315 = true ;
    while (loop_71315) {
      loop_71315 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1819)).operator_not (SOURCE_FILE_AT_LINE (1819)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1819)).isValid () ;
      if (loop_71315) {
        loop_71315 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1819)).operator_not (SOURCE_FILE_AT_LINE (1819)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1819)).boolValue () ;
      }
      if (loop_71315 && (0 == variant_71315)) {
        loop_71315 = false ;
      ...
      if (loop_71315) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodQualifier var_qualifier ;
          //-------- @methodCallInstructionForGeneration
          GALGAS_methodKind joker_71613_0 ; // Joker input parameter
          GALGAS_bool joker_71636_0 ; // Joker input parameter
          GALGAS_string joker_71650_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1822)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_71613_0, var_inheritedSignature, joker_71636_0, var_qualifier, joker_71650_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1822)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @ifInstructionForGeneration
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1894)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1894)).isValid ()) {
    PMUInt32 variant_74314 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1894)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1894)).uintValue () ;
    bool loop_74314 = true ;
    while (loop_74314) {
      loop_74314 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1895)).operator_not (SOURCE_FILE_AT_LINE (1895)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1895)).isValid () ;
      if (loop_74314) {
        loop_74314 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (1895)).operator_not (SOURCE_FILE_AT_LINE (1895)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (1895)).boolValue () ;
      }
      if (loop_74314 && (0 == variant_74314)) {
        loop_74314 = false ;
      ...
      if (loop_74314) {
        ...
        if (kBoolTrue == test_4) {
          ...
          GALGAS_methodQualifier var_qualifier ;
          //-------- @methodCallInstructionForGeneration
          GALGAS_methodKind joker_74612_0 ; // Joker input parameter
          GALGAS_bool joker_74635_0 ; // Joker input parameter
          GALGAS_string joker_74649_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_74612_0, var_inheritedSignature, joker_74635_0, var_qualifier, joker_74649_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @ifInstructionForGeneration
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_76443 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_76443.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_76443.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1944)), enumerator_76443.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1945)), enumerator_76443.current_mFormalArgumentName (HERE), enumerator_76443.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (1943)) ;
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2047)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2047)).isValid ()) {
    PMUInt32 variant_80151 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2047)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2047)).uintValue () ;
    bool loop_80151 = true ;
    while (loop_80151) {
      loop_80151 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2048)).operator_not (SOURCE_FILE_AT_LINE (2048)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2048)).isValid () ;
      if (loop_80151) {
        loop_80151 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2048)).operator_not (SOURCE_FILE_AT_LINE (2048)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2048)).boolValue () ;
      }
      if (loop_80151 && (0 == variant_80151)) {
        loop_80151 = false ;
      ...
      if (loop_80151) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodQualifier var_qualifier ;
          //-------- @methodCallInstructionForGeneration
          GALGAS_methodKind joker_80457_0 ; // Joker input parameter
          GALGAS_bool joker_80534_0 ; // Joker input parameter
          GALGAS_string joker_80593_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2051)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_80457_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_80534_0, var_inheritedReturnType, var_qualifier, joker_80593_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2051)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @ifInstructionForGeneration
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2143)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2143)).isValid ()) {
    PMUInt32 variant_83696 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (2143)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2143)).uintValue () ;
    bool loop_83696 = true ;
    while (loop_83696) {
      loop_83696 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2144)).operator_not (SOURCE_FILE_AT_LINE (2144)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2144)).isValid () ;
      if (loop_83696) {
        loop_83696 = var_superType.reader_isNull (SOURCE_FILE_AT_LINE (2144)).operator_not (SOURCE_FILE_AT_LINE (2144)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE_AT_LINE (2144)).boolValue () ;
      }
      if (loop_83696 && (0 == variant_83696)) {
        loop_83696 = false ;
      ...
      if (loop_83696) {
        ...
        if (kBoolTrue == test_4) {
          ...
          GALGAS_methodQualifier var_qualifier ;
          //-------- @methodCallInstructionForGeneration
          GALGAS_methodKind joker_83998_0 ; // Joker input parameter
          GALGAS_bool joker_84075_0 ; // Joker input parameter
          GALGAS_string joker_84134_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (2147)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_83998_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_84075_0, var_inheritedReturnType, var_qualifier, joker_84134_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2147)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_6) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalInputParameterListAST enumerator_84531 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_84531.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_formalParameterListForGeneration.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_84531.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2168)), enumerator_84531.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (2169)), enumerator_84531.current_mFormalArgumentName (HERE), enumerator_84531.current_mIsConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (2167)) ;
      enumerator_84531.gotoNextObject () ;
    }
    { //-------- @routineCallInstructionForGeneration
