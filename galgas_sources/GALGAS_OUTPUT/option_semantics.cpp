//---------------------------------------------------------------------------*
//                                                                           *
//                       File 'option_semantics.cpp'                         *
//         Generated by version GALGAS_BETA_VERSION (LL(1) grammar)          *
//                      march 20th, 2007, at 17h31'12"                       *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "option_semantics.ggs", line
...
isEqualToMapElement (C_Compiler & _inLexique, const AC_galgas_map_element * inOperand COMMA_LOCATION_ARGS) const {
  ...
  return (mInfo.mOptionChar._operator_isEqual (_inLexique, _p->mInfo.mOptionChar THERE)).boolValue ()
           && (mInfo.mOptionString._operator_isEqual (_inLexique, _p->mInfo.mOptionString THERE)).boolValue ()
           && (mInfo.mComment._operator_isEqual (_inLexique, _p->mInfo.mComment THERE)).boolValue () ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_commandLineOptionMap & inOperand
                   COMMA_LOCATION_ARGS) const {
...
GGS_bool GGS_commandLineOptionMap::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_commandLineOptionMap & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToMap (_inLexique, inOperand THERE)) ;
}
