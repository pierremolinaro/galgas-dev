...
#ifndef typeGalgasUndefinedClassType_DEFINED
#define typeGalgasUndefinedClassType_DEFINED
...
//--- END OF USER ZONE 2
  ...
  public : cPtr_typeGalgasUndefinedClassType (const GGS_lstring &  COMMA_LOCATION_ARGS) ;
...
class GGG_typeGalgasUndefinedClassType : public GGG_AC_galgasType {
  private : typedef GGG_AC_galgasType inherited ;
  public : GGG_typeGalgasUndefinedClassType (const GGS_lstring &  COMMA_LOCATION_ARGS) ;
} ;
