...
typedef void (*categoryMethodSignature_semanticDeclarationForGeneration_addCppTypeForPredeclarationInHeaderFile) (const class cPtr_semanticDeclarationForGeneration * inObject,
...
void callCategoryMethod_addCppTypeForPredeclarationInHeaderFile (const class cPtr_semanticDeclarationForGeneration * inObject,
