...
GALGAS_string filewrapperTemplate_semanticFileGenerationTemplate_semanticFileHeader (class C_Compiler * inCompiler,
                                                                                     ...
                                                                                     const class GALGAS_stringlist & in_TYPE_5F_PREDECLARATION_5F_LIST
                                                                                     COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  public : VIRTUAL_IN_DEBUG GALGAS_galgas_33_GrammarComponentListAST_2E_element reader_mGrammarComponentASTAtIndex (const class GALGAS_uint & constinOperand0,
                                                                                                                    C_Compiler * inCompiler
                                                                                                                    COMMA_LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG GALGAS_grammarComponentASTList reader_subListFromIndex (const class GALGAS_uint & constinOperand0,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG GALGAS_grammarComponentASTList reader_subListWithRange (const class GALGAS_range & constinOperand0,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_semanticImportDependenceGraph reader_subgraphFromNodes (const class GALGAS_lstringlist & constinOperand0,
...
typedef void (*categoryMethodSignature_semanticDeclarationForGeneration_addCppTypeForPredeclarationInHeaderFile) (const cPtr_semanticDeclarationForGeneration * inObject,
                                                                                                                  class GALGAS_stringlist & ioArgument0,
                                                                                                                  class C_Compiler * inCompiler
                                                                                                                  COMMA_LOCATION_ARGS) ;
