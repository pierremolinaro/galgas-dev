...
void routine_compileBeforeClause (const GALGAS_analysisContext constinArgument0,
                                  const GALGAS_prologueEpilogueList constinArgument1,
...
void routine_compileProgramRules (const GALGAS_analysisContext constinArgument0,
                                  const GALGAS_programRuleList constinArgument1,
                                  GALGAS_semanticDeclarationSortedListForGeneration & ioArgument2,
...
void routine_compileProgramComponentGalgas_33_ (const GALGAS_string constinArgument0,
                                                const GALGAS_prologueEpilogueList constinArgument1,
                                                const GALGAS_programRuleList constinArgument2,
                                                const GALGAS_prologueEpilogueList constinArgument3,
