...
_treewalking_routine_semanticsComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_stringset _var_2129 = _currentObject->mImportedSemanticsComponentSet ;
  const GGS_stringset::element_type * operand_2129 = _var_2129.firstObject () ;
  while ((operand_2129 != NULL)) {
    ...
    operand_2129 = operand_2129->nextObject () ;
  }
