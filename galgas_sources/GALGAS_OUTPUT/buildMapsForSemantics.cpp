...
static const uint32 _kSize_semanticsMetamodel = 10 ;
...
_treewalking_routine_semanticsComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_stringset _var_2148 = _currentObject->mImportedSemanticsComponentSet ;
  const GGS_stringset::element_type * operand_2148 = _var_2148.firstObject () ;
  while ((operand_2148 != NULL)) {
    macroValidPointer (operand_2148) ;
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_2148->mKey COMMA_SOURCE_FILE_AT_LINE (39)))._operator_not ()).isBuiltAndTrue ()) {
      if (((operand_2148->mKey)._operator_isNotEqual (_currentObject->mSemanticsComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (40)))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_sourceFilePath ;
        var_cas_sourceFilePath = GGS_lstring::constructor_new (_inLexique, (((var_cas_inSourceFileDirectory)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_2148->mKey))._operator_concat (GGS_string (true, ".gSemantics")), var_cas_inErrorLocation COMMA_HERE) ;
        ...
        { galgas_scanner * scanner_ = NULL ;
          ...
          if (sourceFileName.fileExists ()) {
            ...
            if (scanner_->sourceText () != NULL) {
              ...
              var_cas_sourceFilePath.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (47)) ;
            }
      ...
      var_cas_ioImportedComponentSet._addAssign_operation (operand_2148->mKey) ;
    }
    operand_2148 = operand_2148->nextObject () ;
  }
  if ((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, _currentObject->mSemanticsComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60))).isBuiltAndTrue ()) {
    _currentObject->mSemanticsComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this component is involved in a circularity in 'extends' definitions") COMMA_SOURCE_FILE_AT_LINE (62)) ;
  }else{
    ...
    { GGS_semanticDeclarationList::element_type * _ptr = _currentObject->mSemanticDeclarationList.firstObject () ;
      while (_ptr != NULL) {
        ...
        (* _f) (_inLexique, _ptr, var_cas_ioTypeMap, var_cas_ioRoutineMap) ;
...
_treewalking_routine_routineDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioRoutineMap.modifier_insertKey (_inLexique, _currentObject->mRoutineName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (87)) ;
}
...
_treewalking_routine_externRoutineDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioRoutineMap.modifier_insertKey (_inLexique, _currentObject->mActionName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (102)) ;
}
...
_treewalking_routine_classDeclaration (C_Compiler & _inLexique,
  ...
  if (((_currentObject->mSuperClassName.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_superClassIndex = GGS_typeMapIndex::constructor_null (_inLexique COMMA_HERE) ;
  }else{
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mSuperClassName, var_cas_ioTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  ...
  macroValidPointer (_currentObject) ;
  { GGS_abstractMethodDefinitionList::element_type * _ptr = _currentObject->mAbstractMethodList.firstObject () ;
    while (_ptr != NULL) {
  ...
  macroValidPointer (_currentObject) ;
  { GGS_methodDefinitionList::element_type * _ptr = _currentObject->mMethodList.firstObject () ;
    while (_ptr != NULL) {
  ...
  macroValidPointer (_currentObject) ;
  { GGS_overridenMethodDefinitionList::element_type * _ptr = _currentObject->mOverridenMethodList.firstObject () ;
    while (_ptr != NULL) {
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (138)) ;
}
...
_treewalking_routine_formalParameter (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mFormalParameterTypeName, var_cas_ioTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (149)) ;
...
_treewalking_routine_formalParameters (C_Compiler & _inLexique,
  ...
  macroValidPointer (_currentObject) ;
  { GGS_formalParameterList::element_type * _ptr = _currentObject->mFormalParameterList.firstObject () ;
    while (_ptr != NULL) {
...
_treewalking_routine_enumDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mEnumTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (212)) ;
}
...
_treewalking_routine_mapDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (233)) ;
}
...
_treewalking_routine_listDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (254)) ;
}
...
_treewalking_routine_attributeInCollection (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mAttributeTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (264)) ;
...
_treewalking_routine_mapindexDeclaration (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeMapIndex  var_cas_index ;
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mMapTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (279)) ;
  GGS_ACGalgasType  var_cas_t ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapIndexName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (287)) ;
}
