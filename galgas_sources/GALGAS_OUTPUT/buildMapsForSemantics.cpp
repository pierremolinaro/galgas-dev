...
_treewalking_routine_semanticsComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  GGS_stringset::cEnumerator enumerator_2129 (_currentObject->mImportedSemanticsComponentSet, true) ;
  const GGS_stringset::cElement * operand_2129 = NULL ;
  while (((operand_2129 = (GGS_stringset::cElement *) enumerator_2129.nextObject ()))) {
    macroValidPointer (operand_2129) ;
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_2129->mKey COMMA_SOURCE_FILE_AT_LINE (39)))._operator_not ()).isBuiltAndTrue ()) {
      if (((operand_2129->mKey)._operator_isNotEqual (_currentObject->mSemanticsComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (40)))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_sourceFilePath ;
        var_cas_sourceFilePath = GGS_lstring::constructor_new (_inLexique, (((var_cas_inSourceFileDirectory)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_2129->mKey))._operator_concat (GGS_string (true, ".gSemantics")), var_cas_inErrorLocation COMMA_HERE) ;
      ...
      var_cas_ioImportedComponentSet._addAssign_operation (operand_2129->mKey) ;
    }
  }
  enumerator_2129.reset () ;
  if ((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, _currentObject->mSemanticsComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62))).isBuiltAndTrue ()) {
    _currentObject->mSemanticsComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this component is involved in a circularity in 'extends' definitions") COMMA_SOURCE_FILE_AT_LINE (64)) ;
    ...
    { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mSemanticDeclarationList.firstObject () ;
      while (_ptr != NULL) {
        _treewalking_routine_semanticDeclaration_type * _f = (_treewalking_routine_semanticDeclaration_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
        MF_Assert (dynamic_cast <cPtr_semanticDeclaration *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
        (* _f) (_inLexique, (cPtr_semanticDeclaration *) _ptr->ptr (), var_cas_ioTypeMap, var_cas_ioRoutineMap, var_cas_outTypeList) ;
...
_treewalking_routine_classDeclaration (C_Compiler & _inLexique,
  ...
  macroValidPointer (_currentObject) ;
  { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mAttributeList.firstObject () ;
    while (_ptr != NULL) {
      _treewalking_routine_attributeInCollection_type * _f = (_treewalking_routine_attributeInCollection_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
      MF_Assert (dynamic_cast <cPtr_attributeInCollection *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
      (* _f) (_inLexique, (cPtr_attributeInCollection *) _ptr->ptr (), var_cas_attributeList, var_cas_ioTypeMap) ;
      _ptr = _ptr->internalNextItem () ;
    }
  }
  ...
  macroValidPointer (_currentObject) ;
  { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mAbstractMethodList.firstObject () ;
    while (_ptr != NULL) {
      _treewalking_routine_abstractMethodDefinition_type * _f = (_treewalking_routine_abstractMethodDefinition_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
      MF_Assert (dynamic_cast <cPtr_abstractMethodDefinition *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
      (* _f) (_inLexique, (cPtr_abstractMethodDefinition *) _ptr->ptr (), var_cas_classMethodList, var_cas_ioTypeMap) ;
      _ptr = _ptr->internalNextItem () ;
    }
  }
  macroValidPointer (_currentObject) ;
  { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mMethodList.firstObject () ;
    while (_ptr != NULL) {
      _treewalking_routine_methodDefinition_type * _f = (_treewalking_routine_methodDefinition_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
      MF_Assert (dynamic_cast <cPtr_methodDefinition *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
      (* _f) (_inLexique, (cPtr_methodDefinition *) _ptr->ptr (), var_cas_classMethodList, var_cas_ioTypeMap) ;
      _ptr = _ptr->internalNextItem () ;
    }
  }
  macroValidPointer (_currentObject) ;
  { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mOverridenMethodList.firstObject () ;
    while (_ptr != NULL) {
      _treewalking_routine_overridenMethodDefinition_type * _f = (_treewalking_routine_overridenMethodDefinition_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
      MF_Assert (dynamic_cast <cPtr_overridenMethodDefinition *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
      (* _f) (_inLexique, (cPtr_overridenMethodDefinition *) _ptr->ptr (), var_cas_classMethodList, var_cas_ioTypeMap) ;
      _ptr = _ptr->internalNextItem () ;
    }
  }
...
_treewalking_routine_formalParameters (C_Compiler & _inLexique,
  ...
  macroValidPointer (_currentObject) ;
  { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mFormalParameterList.firstObject () ;
    while (_ptr != NULL) {
      _treewalking_routine_formalParameter_type * _f = (_treewalking_routine_formalParameter_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
      MF_Assert (dynamic_cast <cPtr_formalParameter *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
      (* _f) (_inLexique, (cPtr_formalParameter *) _ptr->ptr (), var_cas_outMethodSignature, var_cas_ioTypeMap) ;
      _ptr = _ptr->internalNextItem () ;
    }
  }
}
...
_treewalking_routine_sortedListDeclaration (C_Compiler & _inLexique,
  ...
  macroValidPointer (_currentObject) ;
  { AC_galgas_entity_list::cEntityListElement * _ptr = _currentObject->mSortDescriptorList.firstObject () ;
    while (_ptr != NULL) {
      _treewalking_routine_sortedListSortDescriptor_type * _f = (_treewalking_routine_sortedListSortDescriptor_type *) _gDispatcherTree.entry (_ptr->ptr () COMMA_HERE) ;
      MF_Assert (dynamic_cast <cPtr_sortedListSortDescriptor *> (_ptr->ptr ()) != NULL, "Treewalking dispatch error", 0, 0) ;
      (* _f) (_inLexique, (cPtr_sortedListSortDescriptor *) _ptr->ptr (), var_cas_sortDescriptorList) ;
      _ptr = _ptr->internalNextItem () ;
    }
  }
  GGS_ACGalgasType  var_cas_t ;
