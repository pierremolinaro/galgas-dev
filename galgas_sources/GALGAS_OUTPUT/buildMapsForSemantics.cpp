...
_treewalking_routine_semanticsComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_stringset _var_2003 = _currentObject->mImportedSemanticsComponentSet ;
  const GGS_stringset::element_type * operand_2003 = _var_2003.firstObject () ;
  while ((operand_2003 != NULL)) {
    macroValidPointer (operand_2003) ;
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_2003->mKey COMMA_SOURCE_FILE_AT_LINE (37)))._operator_not ()).isBuiltAndTrue ()) {
      if (((operand_2003->mKey)._operator_isNotEqual (_currentObject->mSemanticsComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (38)))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_sourceFilePath ;
        var_cas_sourceFilePath = GGS_lstring::constructor_new (_inLexique, (((var_cas_inSourceFileDirectory)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_2003->mKey))._operator_concat (GGS_string (true, ".gSemantics")), var_cas_inErrorLocation COMMA_HERE) ;
        ...
        { galgas_scanner * scanner_ = NULL ;
          ...
          if (sourceFileName.fileExists ()) {
            ...
            if (scanner_->sourceText () != NULL) {
              ...
              var_cas_sourceFilePath.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (45)) ;
            }
      ...
      var_cas_ioImportedComponentSet._addAssign_operation (operand_2003->mKey) ;
    }
    operand_2003 = operand_2003->nextObject () ;
  }
  if ((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, _currentObject->mSemanticsComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (58)) COMMA_SOURCE_FILE_AT_LINE (58))).isBuiltAndTrue ()) {
    _currentObject->mSemanticsComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this component is involved in a circularity in 'extends' definitions") COMMA_SOURCE_FILE_AT_LINE (60)) ;
  }else{
...
_treewalking_routine_routineDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioRoutineMap.modifier_insertKey (_inLexique, _currentObject->mRoutineName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (85)) ;
}
...
_treewalking_routine_externRoutineDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioRoutineMap.modifier_insertKey (_inLexique, _currentObject->mActionName, var_cas_methodSignature COMMA_SOURCE_FILE_AT_LINE (100)) ;
}
...
_treewalking_routine_classDeclaration (C_Compiler & _inLexique,
  ...
  if (((_currentObject->mSuperClassName.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (115)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_superClassIndex = GGS_typeMapIndex::constructor_null (_inLexique COMMA_HERE) ;
  }else{
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mSuperClassName, var_cas_ioTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (136)) ;
}
...
_treewalking_routine_formalParameter (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mFormalParameterTypeName, var_cas_ioTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (147)) ;
...
_treewalking_routine_enumDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mEnumTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (210)) ;
}
...
_treewalking_routine_mapDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (231)) ;
}
...
_treewalking_routine_listDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (252)) ;
}
...
_treewalking_routine_attributeInCollection (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mAttributeTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (262)) ;
...
_treewalking_routine_mapindexDeclaration (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeMapIndex  var_cas_index ;
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mMapTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (277)) ;
  GGS_ACGalgasType  var_cas_t ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapIndexName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (285)) ;
}
