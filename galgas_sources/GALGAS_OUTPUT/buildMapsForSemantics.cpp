...
_treewalking_routine_semanticsComponentRoot (C_Compiler & _inLexique,
  ...
  GGS_stringset::element_type * operand_1974 = _var_1974.firstObject () ;
  while ((operand_1974 != NULL)) {
    ...
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_1974->mKey COMMA_SOURCE_FILE_AT_LINE (36)))._operator_not ()).isBuiltAndTrue ()) {
      _inLexique.printMessage (((GGS_string (true, "*** "))._operator_concat (operand_1974->mKey))._operator_concat (GGS_string (true, " ***\n")) COMMA_SOURCE_FILE_AT_LINE (37)) ;
      ...
      { galgas_scanner * scanner_ = NULL ;
        ...
        if (sourceFileName.fileExists ()) {
          ...
          try{
            ...
            var_cas_sourceFilePath.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (45)) ;
          }
          macroDetachPointer (scanner_, galgas_scanner) ;
        }else{
          C_String message ;
          message << "The '" << sourceFileName << "' file does not exist" ;
          var_cas_sourceFilePath.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (45)) ;
        }
      }
...
_treewalking_routine_classDeclaration (C_Compiler & _inLexique,
  ...
  if (((_currentObject->mSuperClassName.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_superClassIndex = GGS_typeMapIndex::constructor_null (_inLexique COMMA_HERE) ;
  }else{
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mSuperClassName, var_cas_ioTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (87)) ;
}
...
_treewalking_routine_enumDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mEnumTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (102)) ;
}
...
_treewalking_routine_mapDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (120)) ;
}
...
_treewalking_routine_listDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (138)) ;
}
...
_treewalking_routine_attributeInCollection (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mAttributeTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (148)) ;
...
_treewalking_routine_mapindexDeclaration (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeMapIndex  var_cas_index ;
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mMapTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (162)) ;
  GGS_ACGalgasType  var_cas_t ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapIndexName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (170)) ;
}
