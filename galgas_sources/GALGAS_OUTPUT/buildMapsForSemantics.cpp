...
static const uint32 _kSize_semanticsMetamodel = 5 ;
...
_treewalking_routine_semanticsComponentRoot (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_stringset _var_1902 = _currentObject->mImportedSemanticsComponentSet ;
  GGS_stringset::element_type * operand_1902 = _var_1902.firstObject () ;
  while ((operand_1902 != NULL)) {
    macroValidPointer (operand_1902) ;
    if (((var_cas_ioImportedComponentSet.reader_hasKey (_inLexique, operand_1902->mKey COMMA_SOURCE_FILE_AT_LINE (34)))._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioImportedComponentSet._addAssign_operation (operand_1902->mKey) ;
      GGS_string var_cas_sourceFilePath ;
      var_cas_sourceFilePath = (((var_cas_inSourceFileDirectory)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_1902->mKey))._operator_concat (GGS_string (true, ".gSemantics")) ;
      GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
      GGS_location  var_cas_endOfSourceFile ;
    }
    operand_1902 = operand_1902->nextObject () ;
  }
...
_treewalking_routine_classDeclaration (C_Compiler & _inLexique,
  ...
  if (((_currentObject->mSuperClassName.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_superClassIndex = GGS_typeMapIndex::constructor_null (_inLexique COMMA_HERE) ;
  }else{
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mSuperClassName, var_cas_ioTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (65)) ;
  }
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (77)) ;
}
...
_treewalking_routine_listDeclaration (C_Compiler & _inLexique,
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (95)) ;
}
...
_treewalking_routine_attributeInCollection (C_Compiler & _inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mAttributeTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (105)) ;
...
_treewalking_routine_mapindexDeclaration (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeMapIndex  var_cas_index ;
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, _currentObject->mMapTypeName, var_cas_ioTypeMap, var_cas_index COMMA_SOURCE_FILE_AT_LINE (119)) ;
  GGS_ACGalgasType  var_cas_t ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (_inLexique, _currentObject->mMapIndexName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (127)) ;
}
...
_walk_throught_buildMapsForSemantics (C_Compiler & _inLexique,
  ...
  if (_rootObject._isBuilt ()) {
    ...
    (* _f) (_inLexique, _rootObject.getPtr (), var_cas_inSourceFileDirectory, var_cas_ioImportedComponentSet, var_cas_ioTypeMap) ;
  }else{
  }
}
