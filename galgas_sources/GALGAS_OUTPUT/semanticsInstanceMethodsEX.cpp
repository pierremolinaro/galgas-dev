//---------------------------------------------------------------------------*
//                                                                           *
//                  File 'semanticsInstanceMethodsEX.cpp'                    *
//                 Generated by version GALGAS_BETA_VERSION                  *
//                      march 10th, 2010, at 17h19'29"                       *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "semanticsInstanceMethodsEX.gSemantics", line
...
category_reader__ACGalgasType__instanceMethodMap (C_Compiler & inLexique,
                                const cPtr_ACGalgasType * operand_1681
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMapEXX  var_cas_outModifierMap ;
  if (operand_1681 != NULL) {
...
static GGS_modifierMapEXX  gCachedResultForOnceFunction_instanceMethodMapFor_data ;
static bool gCacheFlagForOnceFunction_instanceMethodMapFor_data = false ;

//---------------------------------------------------------------------------*

GGS_modifierMapEXX  function_instanceMethodMapFor_data (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
...
static GGS_object functionForGenericCall_instanceMethodMapFor_data (C_Compiler & inLexique,
                           ...
                           COMMA_LOCATION_ARGS) {
  const GGS_modifierMapEXX  result = function_instanceMethodMapFor_data (inLexique
                            COMMA_THERE) ;
...
category_reader__dataGalgasType__instanceMethodMap (C_Compiler & inLexique,
                                const cPtr_dataGalgasType * operand_2193
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMapEXX  var_cas_outModifierMap ;
  if (operand_2193 != NULL) {
...
static GGS_modifierMapEXX  gCachedResultForOnceFunction_instanceMethodMapFor_string ;
static bool gCacheFlagForOnceFunction_instanceMethodMapFor_string = false ;

//---------------------------------------------------------------------------*

GGS_modifierMapEXX  function_instanceMethodMapFor_string (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_modifierMapEXX  var_cas_outModifierMap ;
    ...
    var_cas_argList.addAssign_operation (GGS_boolGalgasType ::constructor_new (inLexique COMMA_HERE), GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)) ;
...
static GGS_object functionForGenericCall_instanceMethodMapFor_string (C_Compiler & inLexique,
                           ...
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_modifierMapEXX  result = function_instanceMethodMapFor_string (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
category_reader__stringGalgasType__instanceMethodMap (C_Compiler & inLexique,
                                const cPtr_stringGalgasType * operand_3317
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMapEXX  var_cas_outModifierMap ;
  if (operand_3317 != NULL) {
...
static void prologueRoutineFor_semanticsInstanceMethodsEX (void) {
...
static void epilogueRoutineFor_semanticsInstanceMethodsEX (void) {
...
C_PrologueEpilogue prologueEpilogueObjectFor_semanticsInstanceMethodsEX (prologueRoutineFor_semanticsInstanceMethodsEX, epilogueRoutineFor_semanticsInstanceMethodsEX) ;
