...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "option_treewalking_for_building_map.ggs", line
...
_treewalking_routine_commandLineOption (C_Compiler & _inLexique,
  ...
  #endif
  if ((var_cas_ioOptionNameSet.reader_hasKey (_inLexique, _currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (50)) COMMA_SOURCE_FILE_AT_LINE (50))).isBuiltAndTrue ()) {
    _currentObject->mOptionInternalName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (_inLexique, _currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (51)) COMMA_SOURCE_FILE_AT_LINE (51)))._operator_concat (_inLexique, GGS_string (true, "' command line option has been already declared") COMMA_SOURCE_FILE_AT_LINE (51)) COMMA_SOURCE_FILE_AT_LINE (52)) ;
  }else if (((_currentObject->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52)))._operator_isEqual (_inLexique, GGS_string (true, "bool") SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
    var_cas_ioBoolOptionMap.modifier_insertKey (_inLexique, _currentObject->mOptionInternalName, _currentObject->mOptionInvocationLetter, _currentObject->mOptionInvocationString, _currentObject->mOptionComment COMMA_SOURCE_FILE_AT_LINE (53)) ;
  }else if (((_currentObject->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (59)))._operator_isEqual (_inLexique, GGS_string (true, "uint") SOURCE_FILE_AT_LINE (59))).isBuiltAndTrue ()) {
    var_cas_ioUIntOptionMap.modifier_insertKey (_inLexique, _currentObject->mOptionInternalName, _currentObject->mOptionInvocationLetter, _currentObject->mOptionInvocationString, _currentObject->mOptionComment COMMA_SOURCE_FILE_AT_LINE (60)) ;
  }else if (((_currentObject->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (66)))._operator_isEqual (_inLexique, GGS_string (true, "string") SOURCE_FILE_AT_LINE (66))).isBuiltAndTrue ()) {
    var_cas_ioStringOptionMap.modifier_insertKey (_inLexique, _currentObject->mOptionInternalName, _currentObject->mOptionInvocationLetter, _currentObject->mOptionInvocationString, _currentObject->mOptionComment COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }else{
  ...
  var_cas_ioOptionNameSet._addAssign_operation (_currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (76))) ;
}
