...
_treewalking_routine_commandLineOption (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioOptionNameSet.reader_hasKey (_inLexique, _currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (50)) COMMA_SOURCE_FILE_AT_LINE (50))).isBuiltAndTrue ()) {
    _currentObject->mOptionInternalName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (_currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (51))))) + (GGS_string (true, "' command line option has been already declared"))) COMMA_SOURCE_FILE_AT_LINE (52)) ;
  }else if (((_currentObject->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
  ...
  }else if (((_currentObject->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (59))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
  ...
  }else if (((_currentObject->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (66))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
