//---------------------------------------------------------------------------*
//                                                                           *
//                     File 'include_typeGalgas_bool.h'                      *
...
#ifndef typeGalgas_bool_DEFINED
#define typeGalgas_bool_DEFINED
...
//--- END OF USER ZONE 2
  ...
  public : cPtr_typeGalgas_bool (LOCATION_ARGS) ;
...
class GGG_typeGalgas_bool : public GGG_AC_galgasType {
  private : typedef GGG_AC_galgasType inherited ;
  public : GGG_typeGalgas_bool (LOCATION_ARGS) ;
} ;
