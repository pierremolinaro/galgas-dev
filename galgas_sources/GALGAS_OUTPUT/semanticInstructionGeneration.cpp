...
//                    november 14th, 2010, at 16h27'57"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__sendInstructionForGeneration__generateInstruction (C_CompilerEx &,
                                const cPtr_sendInstructionForGeneration * operand_57447,
                                const GGS_bool  /* var_cas_inGenerateCheckValid */,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57447 != NULL) {
...
category_method__logInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_logInstructionForGeneration * operand_57841,
                                const GGS_bool  /* var_cas_inGenerateCheckValid */,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57841 != NULL) {
    var_cas_ioGeneratedCode.appendCString ("//-------- @logInstructionForGeneration\n") ;
    GGS_string var_cas_logVar ;
    { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_57841->mLogExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_57841->mLogExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_logVar COMMA_SOURCE_FILE_AT_LINE (1328)) ;
      }
    }
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_logVar) ;
    var_cas_ioGeneratedCode.appendCString (".log (") ;
    var_cas_ioGeneratedCode.dotAssign_operation (operand_57841->mLogMessage.reader_utf8Representation ()) ;
    var_cas_ioGeneratedCode.appendCString (") ;\n") ;
  }
}
...
category_method__switchInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_switchInstructionForGeneration * operand_58441,
                                const GGS_bool  var_cas_inGenerateCheckValid,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58441 != NULL) {
    var_cas_ioGeneratedCode.appendCString ("//------- @switchInstructionForGeneration\n") ;
    GGS_string var_cas_switchVar ;
    { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_58441->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58441->mSwitchExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_switchVar COMMA_SOURCE_FILE_AT_LINE (1343)) ;
      }
    }
    var_cas_ioGeneratedCode.appendCString ("if (") ;
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_switchVar) ;
    var_cas_ioGeneratedCode.appendCString (".isValid ()) {\n") ;
    var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (operand_58441->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1347))) ;
    var_cas_ioGeneratedCode.appendCString ("::kNotBuilt:\n") ;
    var_cas_ioGeneratedCode.appendCString ("  break ;\n") ;
    {
      GGS_switchBranchesForGeneration::cEnumerator enumerator_59164 (operand_58441->mBranches, true) ;
      const GGS_switchBranchesForGeneration::cElement * operand_59164 = NULL ;
      while (((operand_59164 = enumerator_59164.nextObject ()))) {
        macroValidPointer (operand_59164) ;
        {
          GGS_lstringlist::cEnumerator enumerator_59199 (operand_59164->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_59199 = NULL ;
          while (((operand_59199 = enumerator_59199.nextObject ()))) {
            macroValidPointer (operand_59199) ;
            var_cas_ioGeneratedCode.appendCString ("case GALGAS_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_58441->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1351))) ;
            var_cas_ioGeneratedCode.appendCString ("::kEnum_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_59199->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)).reader_identifierRepresentation ()) ;
            var_cas_ioGeneratedCode.appendCString (": ") ;
          }
        }
        var_cas_ioGeneratedCode.appendCString ("{\n") ;
        ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_59164->mInstructions,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1354)) ;
        var_cas_ioGeneratedCode.appendCString ("  } break ;\n") ;
      }
    }
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
    var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1364)) ;
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__matchInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_matchInstructionForGeneration * operand_59905,
                                const GGS_bool  var_cas_inGenerateCheckValid,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59905 != NULL) {
    ...
    {
      GGS_semanticExpressionListForGeneration::cEnumerator enumerator_60185 (operand_59905->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListForGeneration::cElement * operand_60185 = NULL ;
      while (((operand_60185 = enumerator_60185.nextObject ()))) {
        macroValidPointer (operand_60185) ;
        GGS_string var_cas_var ;
        { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_60185->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_60185->mExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_var COMMA_SOURCE_FILE_AT_LINE (1380)) ;
          }
        }
    ...
    var_cas_ioGeneratedCode.appendCString ("if (") ;
    {
      GGS_stringlist::cEnumerator enumerator_60420 (var_cas_receiverList, true) ;
      const GGS_stringlist::cElement * operand_60420 = enumerator_60420.nextObject () ;
      if ((operand_60420 != NULL)) {
        bool _foreach_loop_60420 ;
        do{
          macroValidPointer (operand_60420) ;
          var_cas_ioGeneratedCode.dotAssign_operation (operand_60420->mValue) ;
          var_cas_ioGeneratedCode.appendCString (".isValid ()") ;
          operand_60420 = enumerator_60420.nextObject () ;
          _foreach_loop_60420 = ((operand_60420 != NULL)) ;
          if (_foreach_loop_60420) {
            var_cas_ioGeneratedCode.appendCString (" && ") ;
          }
        }while (_foreach_loop_60420) ;
      }
    }
    var_cas_ioGeneratedCode.appendCString (") {\n") ;
    var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1389)) ;
    {
      GGS_matchInstructionBranchListForGeneration::cEnumerator enumerator_60638 (operand_59905->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListForGeneration::cElement * operand_60638 = enumerator_60638.nextObject () ;
      if ((operand_60638 != NULL)) {
        bool _foreach_loop_60638 ;
        do{
          macroValidPointer (operand_60638) ;
          var_cas_ioGeneratedCode.appendCString ("if (") ;
          {
            GGS_matchListForGeneration::cEnumerator enumerator_60709 (operand_60638->mMatchListForGeneration, true) ;
            GGS_stringlist::cEnumerator enumerator_60723 (var_cas_receiverList, true) ;
            const GGS_matchListForGeneration::cElement * operand_60709 = enumerator_60709.nextObject () ;
            const GGS_stringlist::cElement * operand_60723 = enumerator_60723.nextObject () ;
            if ((operand_60709 != NULL) && (operand_60723 != NULL)) {
              bool _foreach_loop_60709 ;
              do{
                macroValidPointer (operand_60709) ;
                macroValidPointer (operand_60723) ;
                const GGS_bool cond_60946 = operand_60709->mIsType ;
                if (cond_60946.isBuiltAndTrue ()) {
                  var_cas_ioGeneratedCode.appendCString ("(NULL != dynamic_cast <const cPtr_") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60709->mTypeNameOrEnumerationConstantName.reader_identifierRepresentation ()) ;
                  var_cas_ioGeneratedCode.appendCString (" *> (") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60723->mValue) ;
                  var_cas_ioGeneratedCode.appendCString (".ptr ()))") ;
                }else if (cond_60946.isBuiltAndFalse ()) {
                  var_cas_ioGeneratedCode.appendCString ("(") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60723->mValue) ;
                  var_cas_ioGeneratedCode.appendCString (".enumValue () == GALGAS_") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60709->mLocalConstantName.reader_identifierRepresentation ()) ;
                  var_cas_ioGeneratedCode.appendCString ("::kEnum_") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60709->mTypeNameOrEnumerationConstantName.reader_identifierRepresentation ()) ;
                  var_cas_ioGeneratedCode.appendCString (")") ;
                }
                operand_60709 = enumerator_60709.nextObject () ;
                operand_60723 = enumerator_60723.nextObject () ;
                _foreach_loop_60709 = ((operand_60709 != NULL)
                  && (operand_60723 != NULL)) ;
                if (_foreach_loop_60709) {
                  var_cas_ioGeneratedCode.appendCString (" && ") ;
                }
              }while (_foreach_loop_60709) ;
            }
          }
          var_cas_ioGeneratedCode.appendCString (") {\n") ;
          ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_60638->mMatchBranchInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1404)) ;
          operand_60638 = enumerator_60638.nextObject () ;
          _foreach_loop_60638 = ((operand_60638 != NULL)) ;
          if (_foreach_loop_60638) {
            var_cas_ioGeneratedCode.appendCString ("}else ") ;
          }
        }while (_foreach_loop_60638) ;
      }
    }
    var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
    ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_59905->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
    var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
