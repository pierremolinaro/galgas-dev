...
//                    november 14th, 2010, at 19h10'17"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__foreachInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
  ...
  if (operand_50732 != NULL) {
    ...
    const GGS_bool cond_55377 = ((operand_50732->mBeforeInstructionList.reader_length ().add_operation (inLexique, operand_50732->mAfterInstructionList.reader_length () COMMA_SOURCE_FILE_AT_LINE (1167))).operator_strictSup (GGS_uint (0U))).operator_or ((var_cas_whileExpressionIsAllwaysTrue).operator_not ()) ;
    if (cond_55377.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_52318 = var_cas_whileExpressionIsAllwaysTrue ;
      if (cond_52318.isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.appendCString ("const bool ") ;
        var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
        var_cas_ioGeneratedCode.appendCString (" = true ;\n") ;
      }else if (cond_52318.isBuiltAndFalse ()) {
      ...
      var_cas_ioGeneratedCode.appendCString ("if (") ;
      {
        GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_52650 (operand_50732->mEnumeratedObjectList, true) ;
        const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_52650 = NULL ;
        while (((operand_52650 = enumerator_52650.nextObject ()))) {
          macroValidPointer (operand_52650) ;
          var_cas_ioGeneratedCode.dotAssign_operation (operand_52650->mEnumeratorCppName) ;
      ...
      {
        GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_53093 (operand_50732->mEnumeratedObjectList, true) ;
        const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_53093 = NULL ;
        while (((operand_53093 = enumerator_53093.nextObject ()))) {
          macroValidPointer (operand_53093) ;
          var_cas_ioGeneratedCode.dotAssign_operation (operand_53093->mEnumeratorCppName) ;
          var_cas_ioGeneratedCode.appendCString (".hasCurrentObject () && ") ;
        }
      }
      var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
      ...
      {
        GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_53510 (operand_50732->mEnumeratedObjectList, true) ;
        const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_53510 = NULL ;
        while (((operand_53510 = enumerator_53510.nextObject ()))) {
          macroValidPointer (operand_53510) ;
          var_cas_ioGeneratedCode.appendCString ("  ") ;
          var_cas_ioGeneratedCode.dotAssign_operation (operand_53510->mEnumeratorCppName) ;
          var_cas_ioGeneratedCode.appendCString (".gotoNextObject () ;\n") ;
        }
      }
      const GGS_bool cond_53737 = (operand_50732->mIndexVariableCppName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_53737.isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.appendCString ("  ") ;
        var_cas_ioGeneratedCode.dotAssign_operation (operand_50732->mIndexVariableCppName) ;
        var_cas_ioGeneratedCode.appendCString (".increment () ;\n") ;
      }
      const GGS_bool cond_54360 = (var_cas_whileExpressionIsAllwaysTrue).operator_not () ;
      if (cond_54360.isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.appendCString ("  if (") ;
        {
          GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_53893 (operand_50732->mEnumeratedObjectList, true) ;
          const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_53893 = enumerator_53893.nextObject () ;
          if ((operand_53893 != NULL)) {
            bool _foreach_loop_53893 ;
            do{
              macroValidPointer (operand_53893) ;
              var_cas_ioGeneratedCode.dotAssign_operation (operand_53893->mEnumeratorCppName) ;
              var_cas_ioGeneratedCode.appendCString (".hasCurrentObject ()") ;
              operand_53893 = enumerator_53893.nextObject () ;
              _foreach_loop_53893 = ((operand_53893 != NULL)) ;
              if (_foreach_loop_53893) {
                var_cas_ioGeneratedCode.appendCString (" && ") ;
              }
            }while (_foreach_loop_53893) ;
          }
        }
        var_cas_ioGeneratedCode.appendCString (") {\n") ;
        GGS_string var_cas_whileVar ;
        { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_50732->mWhileExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_50732->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVar COMMA_SOURCE_FILE_AT_LINE (1223)) ;
          }
        }
        var_cas_ioGeneratedCode.appendCString ("    ") ;
        var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
      ...
      const GGS_bool cond_55006 = (operand_50732->mBetweenInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_55006.isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1229)) ;
        var_cas_ioGeneratedCode.appendCString ("if (") ;
        {
          GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_54568 (operand_50732->mEnumeratedObjectList, true) ;
          const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_54568 = NULL ;
          while (((operand_54568 = enumerator_54568.nextObject ()))) {
            macroValidPointer (operand_54568) ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_54568->mEnumeratorCppName) ;
            var_cas_ioGeneratedCode.appendCString (".hasCurrentObject () && ") ;
          }
        }
        var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
        var_cas_ioGeneratedCode.appendCString (") {\n") ;
        ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_50732->mBetweenInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1235)) ;
        var_cas_ioGeneratedCode.appendCString ("}\n") ;
        var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1243)) ;
      }
      var_cas_ioGeneratedCode.appendCString ("}\n") ;
      var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1248)) ;
      ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_50732->mAfterInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1249)) ;
      var_cas_ioGeneratedCode.appendCString ("}\n") ;
    }else if (cond_55377.isBuiltAndFalse ()) {
      var_cas_ioGeneratedCode.appendCString ("//--- simple foreach instruction\n") ;
      const GGS_bool cond_55648 = (operand_50732->mIndexVariableCppName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_55648.isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.appendCString ("GALGAS_uint ") ;
        var_cas_ioGeneratedCode.dotAssign_operation (operand_50732->mIndexVariableCppName) ;
        var_cas_ioGeneratedCode.appendCString (" ((PMUInt32) 0) ;\n") ;
      }
      var_cas_ioGeneratedCode.appendCString ("while (") ;
      {
        GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_55722 (operand_50732->mEnumeratedObjectList, true) ;
        const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_55722 = enumerator_55722.nextObject () ;
        if ((operand_55722 != NULL)) {
          bool _foreach_loop_55722 ;
          do{
            macroValidPointer (operand_55722) ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_55722->mEnumeratorCppName) ;
            var_cas_ioGeneratedCode.appendCString (".hasCurrentObject ()") ;
            operand_55722 = enumerator_55722.nextObject () ;
            _foreach_loop_55722 = ((operand_55722 != NULL)) ;
            if (_foreach_loop_55722) {
              var_cas_ioGeneratedCode.appendCString (" && ") ;
            }
          }while (_foreach_loop_55722) ;
        }
      }
      var_cas_ioGeneratedCode.appendCString (") {\n") ;
      ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_50732->mDoInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1269)) ;
      const GGS_bool cond_56763 = (operand_50732->mBetweenInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_56763.isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
        var_cas_ioGeneratedCode.appendCString ("if (") ;
        {
          GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_56305 (operand_50732->mEnumeratedObjectList, true) ;
          const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_56305 = enumerator_56305.nextObject () ;
          if ((operand_56305 != NULL)) {
            bool _foreach_loop_56305 ;
            do{
              macroValidPointer (operand_56305) ;
              var_cas_ioGeneratedCode.dotAssign_operation (operand_56305->mEnumeratorCppName) ;
              var_cas_ioGeneratedCode.appendCString (".hasNextObject ()") ;
              operand_56305 = enumerator_56305.nextObject () ;
              _foreach_loop_56305 = ((operand_56305 != NULL)) ;
              if (_foreach_loop_56305) {
                var_cas_ioGeneratedCode.appendCString (" && ") ;
              }
            }while (_foreach_loop_56305) ;
          }
        }
        var_cas_ioGeneratedCode.appendCString (") {\n") ;
        ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_50732->mBetweenInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        var_cas_ioGeneratedCode.appendCString ("}\n") ;
        var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1293)) ;
      }
      {
        GGS_foreachInstructionEnumeratedObjectListForGeneration::cEnumerator enumerator_56836 (operand_50732->mEnumeratedObjectList, true) ;
        const GGS_foreachInstructionEnumeratedObjectListForGeneration::cElement * operand_56836 = NULL ;
        while (((operand_56836 = enumerator_56836.nextObject ()))) {
          macroValidPointer (operand_56836) ;
          var_cas_ioGeneratedCode.appendCString ("  ") ;
          var_cas_ioGeneratedCode.dotAssign_operation (operand_56836->mEnumeratorCppName) ;
          var_cas_ioGeneratedCode.appendCString (".gotoNextObject () ;\n") ;
        }
      }
      const GGS_bool cond_57241 = (operand_50732->mIndexVariableCppName).operator_isNotEqual (GGS_string ("")) ;
      if (cond_57241.isBuiltAndTrue ()) {
        var_cas_ioUnusedVariableCppNameSet.modifier_removeKey (inLexique, function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)) ;
        var_cas_ioGeneratedCode.appendCString ("  ") ;
        var_cas_ioGeneratedCode.dotAssign_operation (operand_50732->mIndexVariableCppName) ;
        var_cas_ioGeneratedCode.appendCString (".increment_operation (") ;
        var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1301))) ;
        var_cas_ioGeneratedCode.appendCString (" COMMA_SOURCE_FILE_AT_LINE (") ;
        var_cas_ioGeneratedCode.dotAssign_operation (operand_50732->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1301))) ;
        var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
      }
      var_cas_ioGeneratedCode.appendCString ("}\n") ;
    }
...
category_method__logInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_logInstructionForGeneration * operand_57446,
                                const GGS_bool  /* var_cas_inGenerateCheckValid */,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57446 != NULL) {
    var_cas_ioGeneratedCode.appendCString ("//-------- @logInstructionForGeneration\n") ;
    GGS_string var_cas_logVar ;
    { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_57446->mLogExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_57446->mLogExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_logVar COMMA_SOURCE_FILE_AT_LINE (1317)) ;
      }
    }
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_logVar) ;
    var_cas_ioGeneratedCode.appendCString (".log (") ;
    var_cas_ioGeneratedCode.dotAssign_operation (operand_57446->mLogMessage.reader_utf8Representation ()) ;
    var_cas_ioGeneratedCode.appendCString (") ;\n") ;
  }
}
...
category_method__switchInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_switchInstructionForGeneration * operand_58046,
                                const GGS_bool  var_cas_inGenerateCheckValid,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58046 != NULL) {
    var_cas_ioGeneratedCode.appendCString ("//------- @switchInstructionForGeneration\n") ;
    GGS_string var_cas_switchVar ;
    { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_58046->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_58046->mSwitchExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_switchVar COMMA_SOURCE_FILE_AT_LINE (1332)) ;
      }
    }
    var_cas_ioGeneratedCode.appendCString ("if (") ;
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_switchVar) ;
    var_cas_ioGeneratedCode.appendCString (".isValid ()) {\n") ;
    var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1334)) ;
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (operand_58046->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1336)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1336))) ;
    var_cas_ioGeneratedCode.appendCString ("::kNotBuilt:\n") ;
    var_cas_ioGeneratedCode.appendCString ("  break ;\n") ;
    {
      GGS_switchBranchesForGeneration::cEnumerator enumerator_58769 (operand_58046->mBranches, true) ;
      const GGS_switchBranchesForGeneration::cElement * operand_58769 = NULL ;
      while (((operand_58769 = enumerator_58769.nextObject ()))) {
        macroValidPointer (operand_58769) ;
        {
          GGS_lstringlist::cEnumerator enumerator_58804 (operand_58769->mSwitchConstantList, true) ;
          const GGS_lstringlist::cElement * operand_58804 = NULL ;
          while (((operand_58804 = enumerator_58804.nextObject ()))) {
            macroValidPointer (operand_58804) ;
            var_cas_ioGeneratedCode.appendCString ("case GALGAS_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_58046->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1340))) ;
            var_cas_ioGeneratedCode.appendCString ("::kEnum_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_58804->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)).reader_identifierRepresentation ()) ;
            var_cas_ioGeneratedCode.appendCString (": ") ;
          }
        }
        var_cas_ioGeneratedCode.appendCString ("{\n") ;
        ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_58769->mInstructions,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1343)) ;
        var_cas_ioGeneratedCode.appendCString ("  } break ;\n") ;
      }
    }
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
    var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__matchInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_matchInstructionForGeneration * operand_59510,
                                const GGS_bool  var_cas_inGenerateCheckValid,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59510 != NULL) {
    ...
    {
      GGS_semanticExpressionListForGeneration::cEnumerator enumerator_59790 (operand_59510->mMatchedExpressionList, true) ;
      const GGS_semanticExpressionListForGeneration::cElement * operand_59790 = NULL ;
      while (((operand_59790 = enumerator_59790.nextObject ()))) {
        macroValidPointer (operand_59790) ;
        GGS_string var_cas_var ;
        { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_59790->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_59790->mExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_var COMMA_SOURCE_FILE_AT_LINE (1369)) ;
          }
        }
    ...
    var_cas_ioGeneratedCode.appendCString ("if (") ;
    {
      GGS_stringlist::cEnumerator enumerator_60025 (var_cas_receiverList, true) ;
      const GGS_stringlist::cElement * operand_60025 = enumerator_60025.nextObject () ;
      if ((operand_60025 != NULL)) {
        bool _foreach_loop_60025 ;
        do{
          macroValidPointer (operand_60025) ;
          var_cas_ioGeneratedCode.dotAssign_operation (operand_60025->mValue) ;
          var_cas_ioGeneratedCode.appendCString (".isValid ()") ;
          operand_60025 = enumerator_60025.nextObject () ;
          _foreach_loop_60025 = ((operand_60025 != NULL)) ;
          if (_foreach_loop_60025) {
            var_cas_ioGeneratedCode.appendCString (" && ") ;
          }
        }while (_foreach_loop_60025) ;
      }
    }
    var_cas_ioGeneratedCode.appendCString (") {\n") ;
    var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1378)) ;
    {
      GGS_matchInstructionBranchListForGeneration::cEnumerator enumerator_60243 (operand_59510->mMatchInstructionBranchList, true) ;
      const GGS_matchInstructionBranchListForGeneration::cElement * operand_60243 = enumerator_60243.nextObject () ;
      if ((operand_60243 != NULL)) {
        bool _foreach_loop_60243 ;
        do{
          macroValidPointer (operand_60243) ;
          var_cas_ioGeneratedCode.appendCString ("if (") ;
          {
            GGS_matchListForGeneration::cEnumerator enumerator_60314 (operand_60243->mMatchListForGeneration, true) ;
            GGS_stringlist::cEnumerator enumerator_60328 (var_cas_receiverList, true) ;
            const GGS_matchListForGeneration::cElement * operand_60314 = enumerator_60314.nextObject () ;
            const GGS_stringlist::cElement * operand_60328 = enumerator_60328.nextObject () ;
            if ((operand_60314 != NULL) && (operand_60328 != NULL)) {
              bool _foreach_loop_60314 ;
              do{
                macroValidPointer (operand_60314) ;
                macroValidPointer (operand_60328) ;
                const GGS_bool cond_60551 = operand_60314->mIsType ;
                if (cond_60551.isBuiltAndTrue ()) {
                  var_cas_ioGeneratedCode.appendCString ("(NULL != dynamic_cast <const cPtr_") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60314->mTypeNameOrEnumerationConstantName.reader_identifierRepresentation ()) ;
                  var_cas_ioGeneratedCode.appendCString (" *> (") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60328->mValue) ;
                  var_cas_ioGeneratedCode.appendCString (".ptr ()))") ;
                }else if (cond_60551.isBuiltAndFalse ()) {
                  var_cas_ioGeneratedCode.appendCString ("(") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60328->mValue) ;
                  var_cas_ioGeneratedCode.appendCString (".enumValue () == GALGAS_") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60314->mLocalConstantName.reader_identifierRepresentation ()) ;
                  var_cas_ioGeneratedCode.appendCString ("::kEnum_") ;
                  var_cas_ioGeneratedCode.dotAssign_operation (operand_60314->mTypeNameOrEnumerationConstantName.reader_identifierRepresentation ()) ;
                  var_cas_ioGeneratedCode.appendCString (")") ;
                }
                operand_60314 = enumerator_60314.nextObject () ;
                operand_60328 = enumerator_60328.nextObject () ;
                _foreach_loop_60314 = ((operand_60314 != NULL)
                  && (operand_60328 != NULL)) ;
                if (_foreach_loop_60314) {
                  var_cas_ioGeneratedCode.appendCString (" && ") ;
                }
              }while (_foreach_loop_60314) ;
            }
          }
          var_cas_ioGeneratedCode.appendCString (") {\n") ;
          ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_60243->mMatchBranchInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1393)) ;
          operand_60243 = enumerator_60243.nextObject () ;
          _foreach_loop_60243 = ((operand_60243 != NULL)) ;
          if (_foreach_loop_60243) {
            var_cas_ioGeneratedCode.appendCString ("}else ") ;
          }
        }while (_foreach_loop_60243) ;
      }
    }
    var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
    ::routine_generateInstructionList (inLexique,  var_cas_inGenerateCheckValid,  operand_59510->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1403)) ;
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
    var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
