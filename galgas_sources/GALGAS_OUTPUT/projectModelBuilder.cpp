        ...
        case 2 : {
          ...
          switch (select_projectModelBuilder_1 (inLexique)) {
            case 1 : {
              ...
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
              } break ;
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_gui) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_guiSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
              } break ;
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_lexique) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (56)) ;
              } break ;
            case 4 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_option) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_optionSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (59)) ;
              } break ;
            case 5 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_semantics) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_semanticsSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
              } break ;
            case 6 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_syntax) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_syntaxSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
              } break ;
            case 7 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_grammar) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_grammarSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
              } break ;
            case 8 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_program) COMMA_HERE) ;
              var_cas_sourceFileKind = GGS_sourceFileKind::constructor_programSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
              } break ;
            default :
              break ;
          }
