...
void routine_compileMetamodelComponentLL1 (C_Compiler & _inLexique,
  ...
  GGS_typeMap::cEnumerator enumerator_6647 (var_cas_typeMap, true) ;
  const GGS_typeMap::cElement * operand_6647 = NULL ;
  while (((operand_6647 = (GGS_typeMap::cElement *) enumerator_6647.nextObject ()))) {
    macroValidPointer (operand_6647) ;
    const GGS_ACGalgasType  _temp_6709 = operand_6647->mInfo.mType ;
    if (_temp_6709._isBuilt ()) {
      _temp_6709 (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
    }
  }
  enumerator_6647.reset () ;
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    GGS_typeList::cEnumerator enumerator_6928 (var_cas_typeList, true) ;
    const GGS_typeList::cElement * operand_6928 = NULL ;
    while (((operand_6928 = (GGS_typeList::cElement *) enumerator_6928.nextObject ()))) {
      macroValidPointer (operand_6928) ;
      const GGS_ACGalgasType  _temp_6974 = operand_6928->mType ;
      if (_temp_6974._isBuilt ()) {
        _temp_6974 (HERE)->method_enterInSortedList (_inLexique, var_cas_sortedTypeList, var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }
    }
    enumerator_6928.reset () ;
  }
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_generatedUserZone2.writeString ("#include \"galgas/predefined_types.h\"\n"
      "") ;
    GGS_stringset::cEnumerator enumerator_7484 (var_cas_importedComponentSet, true) ;
    const GGS_stringset::cElement * operand_7484 = NULL ;
    while (((operand_7484 = (GGS_stringset::cElement *) enumerator_7484.nextObject ()))) {
      macroValidPointer (operand_7484) ;
      var_cas_generatedUserZone2.writeString ("#include \"") ;
      var_cas_generatedUserZone2._dotAssign_operation (operand_7484->mKey) ;
      var_cas_generatedUserZone2.writeString (".h\"\n"
        "") ;
    }
    enumerator_7484.reset () ;
    ...
    GGS_sortedTypeList::cEnumerator enumerator_7973 (var_cas_sortedTypeList, true) ;
    const GGS_sortedTypeList::cElement * operand_7973 = NULL ;
    while (((operand_7973 = (GGS_sortedTypeList::cElement *) enumerator_7973.nextObject ()))) {
      macroValidPointer (operand_7973) ;
      const GGS_ACGalgasType  _temp_8045 = operand_7973->mType ;
      if (_temp_8045._isBuilt ()) {
        _temp_8045 (HERE)->method_generatePredeclarationInHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (173)) ;
      }
    }
    enumerator_7973.reset () ;
    var_cas_generatedUserZone3.writeString ("\n"
      "") ;
    GGS_sortedTypeList::cEnumerator enumerator_8163 (var_cas_sortedTypeList, true) ;
    const GGS_sortedTypeList::cElement * operand_8163 = NULL ;
    while (((operand_8163 = (GGS_sortedTypeList::cElement *) enumerator_8163.nextObject ()))) {
      macroValidPointer (operand_8163) ;
      const GGS_ACGalgasType  _temp_8235 = operand_8163->mType ;
    ...
    while (((operand_8320 = (GGS_sortedTypeList::cElement *) enumerator_8320.nextObject ()))) {
      ...
      const GGS_ACGalgasType  _temp_8392 = operand_8320->mType ;
      if (_temp_8392._isBuilt ()) {
        _temp_8392 (HERE)->method_generateDeclaration_2_inHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (180)) ;
      }
    }
    enumerator_8320.reset () ;
    var_cas_generatedUserZone3._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    "}\n"
      "\n"
      "") ;
    GGS_sortedTypeList::cEnumerator enumerator_10307 (var_cas_sortedTypeList, true) ;
    const GGS_sortedTypeList::cElement * operand_10307 = NULL ;
    while (((operand_10307 = (GGS_sortedTypeList::cElement *) enumerator_10307.nextObject ()))) {
      macroValidPointer (operand_10307) ;
      const GGS_ACGalgasType  _temp_10379 = operand_10307->mType ;
      if (_temp_10379._isBuilt ()) {
        _temp_10379 (HERE)->method_generateImplementation (_inLexique, var_cas_generatedCode3 COMMA_SOURCE_FILE_AT_LINE (230)) ;
      }
    }
    enumerator_10307.reset () ;
    var_cas_generatedCode3._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
...
void routine_compileSemanticsComponentLL1 (C_Compiler & _inLexique,
  ...
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (286)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_stringlist::cEnumerator enumerator_12362 (var_cas_typeMap.reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
    const GGS_stringlist::cElement * operand_12362 = NULL ;
    while (((operand_12362 = (GGS_stringlist::cElement *) enumerator_12362.nextObject ()))) {
      macroValidPointer (operand_12362) ;
      var_cas_m.writeString ("\n"
        "  - @") ;
      var_cas_m._dotAssign_operation (operand_12362->mValue) ;
    }
    enumerator_12362.reset () ;
  ...
  GGS_typeMap::cEnumerator enumerator_12560 (var_cas_typeMap, true) ;
  const GGS_typeMap::cElement * operand_12560 = NULL ;
  while (((operand_12560 = (GGS_typeMap::cElement *) enumerator_12560.nextObject ()))) {
    macroValidPointer (operand_12560) ;
    const GGS_ACGalgasType  _temp_12622 = operand_12560->mInfo.mType ;
    if (_temp_12622._isBuilt ()) {
      _temp_12622 (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
    }
  }
  enumerator_12560.reset () ;
  #ifdef DEBUG_TRACE_ENABLED
