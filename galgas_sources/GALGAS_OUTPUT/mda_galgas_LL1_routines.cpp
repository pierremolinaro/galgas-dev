...
void routine_compileMetamodelComponentLL1 (C_Compiler & _inLexique,
  ...
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (126)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_stringlist _var_6449 = var_cas_typeMap.reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
    const GGS_stringlist::element_type * operand_6449 = _var_6449.firstObject () ;
    while ((operand_6449 != NULL)) {
      macroValidPointer (operand_6449) ;
      var_cas_m.writeString ("\n  - @") ;
      var_cas_m._dotAssign_operation (operand_6449->mValue) ;
      operand_6449 = operand_6449->nextObject () ;
    }
  ...
  const GGS_typeMap _var_6647 = var_cas_typeMap ;
  const GGS_typeMap::element_type * operand_6647 = _var_6647.firstObject () ;
  while ((operand_6647 != NULL)) {
    ...
    operand_6647 = operand_6647->nextObject () ;
  }
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    const GGS_typeList _var_6928 = var_cas_typeList ;
    const GGS_typeList::element_type * operand_6928 = _var_6928.firstObject () ;
    while ((operand_6928 != NULL)) {
      ...
      operand_6928 = operand_6928->nextObject () ;
    }
  }
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_stringset _var_7484 = var_cas_importedComponentSet ;
    const GGS_stringset::element_type * operand_7484 = _var_7484.firstObject () ;
    while ((operand_7484 != NULL)) {
      ...
      operand_7484 = operand_7484->nextObject () ;
    }
    ...
    const GGS_sortedTypeList _var_7973 = var_cas_sortedTypeList ;
    const GGS_sortedTypeList::element_type * operand_7973 = _var_7973.firstObject () ;
    while ((operand_7973 != NULL)) {
      ...
      operand_7973 = operand_7973->nextObject () ;
    }
    var_cas_generatedUserZone3.writeString ("\n") ;
    const GGS_sortedTypeList _var_8163 = var_cas_sortedTypeList ;
    const GGS_sortedTypeList::element_type * operand_8163 = _var_8163.firstObject () ;
    ...
    const GGS_sortedTypeList _var_8320 = var_cas_sortedTypeList ;
    const GGS_sortedTypeList::element_type * operand_8320 = _var_8320.firstObject () ;
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    "}\n\n") ;
    const GGS_sortedTypeList _var_10307 = var_cas_sortedTypeList ;
    const GGS_sortedTypeList::element_type * operand_10307 = _var_10307.firstObject () ;
    while ((operand_10307 != NULL)) {
      ...
      operand_10307 = operand_10307->nextObject () ;
    }
    var_cas_generatedCode3._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
...
void routine_compileSemanticsComponentLL1 (C_Compiler & _inLexique,
  ...
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (286)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_stringlist _var_12362 = var_cas_typeMap.reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)) ;
    const GGS_stringlist::element_type * operand_12362 = _var_12362.firstObject () ;
  ...
  const GGS_typeMap _var_12560 = var_cas_typeMap ;
  const GGS_typeMap::element_type * operand_12560 = _var_12560.firstObject () ;
  while ((operand_12560 != NULL)) {
    ...
    operand_12560 = operand_12560->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
