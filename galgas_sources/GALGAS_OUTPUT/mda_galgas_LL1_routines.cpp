  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (73)) ;
      }
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (107)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (117)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
...
void routine_compileSemanticsComponentLL1 (C_Compiler & _inLexique,
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (134)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  _walk_throught_buildMapsForSemantics (_inLexique, var_cas_semanticsComponentRoot, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (141)), var_cas_endOfSourceFile, var_cas_importedComponentSet, var_cas_typeMap, var_cas_routineMap) ;
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (148)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_m ;
    var_cas_m = (var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (149)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (149)))._operator_concat (GGS_string (true, " type")) ;
    if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (150)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      var_cas_m = GGS_string (true, "1 type is not defined:") ;
    }else{
      var_cas_m = (var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (153)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (153)))._operator_concat (GGS_string (true, " types are not defined:")) ;
    }
    const GGS_stringlist _var_7045 = var_cas_typeMap.reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ;
    const GGS_stringlist::element_type * operand_7045 = _var_7045.firstObject () ;
    while ((operand_7045 != NULL)) {
      macroValidPointer (operand_7045) ;
      var_cas_m.writeString ("\n  - @") ;
      var_cas_m._dotAssign_operation (operand_7045->mValue) ;
      operand_7045 = operand_7045->nextObject () ;
    }
    var_cas_endOfSourceFile.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (159)) ;
  }
  const GGS_typeMap _var_7249 = var_cas_typeMap ;
  const GGS_typeMap::element_type * operand_7249 = _var_7249.firstObject () ;
  while ((operand_7249 != NULL)) {
    macroValidPointer (operand_7249) ;
    if (operand_7249->mInfo.mType._isBuilt ()) {
      operand_7249->mInfo.mType (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)) COMMA_SOURCE_FILE_AT_LINE (162)) ;
    }
    operand_7249 = operand_7249->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (173)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (183)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (193)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (203)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
