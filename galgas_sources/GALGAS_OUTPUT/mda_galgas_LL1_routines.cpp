...
void routine_compileMetamodelComponentLL1 (C_Compiler & _inLexique,
  ...
  while (((operand_6647 = (GGS_typeMap::cElement *) enumerator_6647.nextObject ()))) {
    ...
    if (operand_6647->mInfo.mType._isBuilt ()) {
      operand_6647->mInfo.mType (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
    }
  }
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    while (((operand_6928 = (GGS_typeList::cElement *) enumerator_6928.nextObject ()))) {
      ...
      if (operand_6928->mType._isBuilt ()) {
        operand_6928->mType (HERE)->method_enterInSortedList (_inLexique, var_cas_sortedTypeList, var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }
    }
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    while (((operand_7973 = (GGS_sortedTypeList::cElement *) enumerator_7973.nextObject ()))) {
      ...
      if (operand_7973->mType._isBuilt ()) {
        operand_7973->mType (HERE)->method_generatePredeclarationInHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (173)) ;
      }
    }
    ...
    while (((operand_8163 = (GGS_sortedTypeList::cElement *) enumerator_8163.nextObject ()))) {
      ...
      if (operand_8163->mType._isBuilt ()) {
        operand_8163->mType (HERE)->method_generateDeclaration_1_inHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (177)) ;
      }
    }
    ...
    while (((operand_8320 = (GGS_sortedTypeList::cElement *) enumerator_8320.nextObject ()))) {
      ...
      if (operand_8320->mType._isBuilt ()) {
        operand_8320->mType (HERE)->method_generateDeclaration_2_inHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (180)) ;
      }
    }
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    while (((operand_10307 = (GGS_sortedTypeList::cElement *) enumerator_10307.nextObject ()))) {
      ...
      if (operand_10307->mType._isBuilt ()) {
        operand_10307->mType (HERE)->method_generateImplementation (_inLexique, var_cas_generatedCode3 COMMA_SOURCE_FILE_AT_LINE (230)) ;
      }
    }
...
void routine_compileSemanticsComponentLL1 (C_Compiler & _inLexique,
  ...
  while (((operand_12560 = (GGS_typeMap::cElement *) enumerator_12560.nextObject ()))) {
    ...
    if (operand_12560->mInfo.mType._isBuilt ()) {
      operand_12560->mInfo.mType (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
    }
  }
