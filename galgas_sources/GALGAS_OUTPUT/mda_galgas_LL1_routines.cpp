...
void routine_compileMetamodelComponent (C_Compiler & _inLexique,
  ...
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (126)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_6443 (var_cas_typeMap.reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)), true) ;
      const GGS_stringlist::cElement * operand_6443 = NULL ;
      while (((operand_6443 = (GGS_stringlist::cElement *) enumerator_6443.nextObject ()))) {
        macroValidPointer (operand_6443) ;
        var_cas_m.writeString ("\n"
          "  - @") ;
        var_cas_m._dotAssign_operation (operand_6443->mValue) ;
      }
    }
  ...
  {
    GGS_typeMap::cEnumerator enumerator_6642 (var_cas_typeMap, true) ;
    const GGS_typeMap::cElement * operand_6642 = NULL ;
    while (((operand_6642 = (GGS_typeMap::cElement *) enumerator_6642.nextObject ()))) {
      macroValidPointer (operand_6642) ;
      const GGS_ACGalgasType  _temp_6705 = operand_6642->mInfo.mType ;
      if (_temp_6705._isBuilt ()) {
        _temp_6705 (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
      }
    }
  }
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeList::cEnumerator enumerator_6924 (var_cas_typeList, true) ;
      const GGS_typeList::cElement * operand_6924 = NULL ;
      while (((operand_6924 = (GGS_typeList::cElement *) enumerator_6924.nextObject ()))) {
        macroValidPointer (operand_6924) ;
        const GGS_ACGalgasType  _temp_6971 = operand_6924->mType ;
        if (_temp_6971._isBuilt ()) {
          _temp_6971 (HERE)->method_enterInSortedList (_inLexique, var_cas_sortedTypeList, var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }
      }
    }
  }
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringset::cEnumerator enumerator_7481 (var_cas_importedComponentSet, true) ;
      const GGS_stringset::cElement * operand_7481 = NULL ;
      while (((operand_7481 = (GGS_stringset::cElement *) enumerator_7481.nextObject ()))) {
        macroValidPointer (operand_7481) ;
        var_cas_generatedUserZone2.writeString ("#include \"") ;
        var_cas_generatedUserZone2._dotAssign_operation (operand_7481->mKey) ;
    ...
    {
      GGS_sortedTypeList::cEnumerator enumerator_7971 (var_cas_sortedTypeList, true) ;
      const GGS_sortedTypeList::cElement * operand_7971 = NULL ;
      while (((operand_7971 = (GGS_sortedTypeList::cElement *) enumerator_7971.nextObject ()))) {
        macroValidPointer (operand_7971) ;
        const GGS_ACGalgasType  _temp_8044 = operand_7971->mType ;
        if (_temp_8044._isBuilt ()) {
          _temp_8044 (HERE)->method_generatePredeclarationInHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (173)) ;
        }
      }
    }
    var_cas_generatedUserZone3.writeString ("\n") ;
    {
      GGS_sortedTypeList::cEnumerator enumerator_8162 (var_cas_sortedTypeList, true) ;
      const GGS_sortedTypeList::cElement * operand_8162 = NULL ;
      while (((operand_8162 = (GGS_sortedTypeList::cElement *) enumerator_8162.nextObject ()))) {
        macroValidPointer (operand_8162) ;
        const GGS_ACGalgasType  _temp_8235 = operand_8162->mType ;
        if (_temp_8235._isBuilt ()) {
          _temp_8235 (HERE)->method_generateDeclaration_1_inHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (177)) ;
        }
      }
    }
    {
      GGS_sortedTypeList::cEnumerator enumerator_8320 (var_cas_sortedTypeList, true) ;
      const GGS_sortedTypeList::cElement * operand_8320 = NULL ;
      while (((operand_8320 = (GGS_sortedTypeList::cElement *) enumerator_8320.nextObject ()))) {
        macroValidPointer (operand_8320) ;
        const GGS_ACGalgasType  _temp_8393 = operand_8320->mType ;
        if (_temp_8393._isBuilt ()) {
          _temp_8393 (HERE)->method_generateDeclaration_2_inHeader (_inLexique, var_cas_generatedUserZone3 COMMA_SOURCE_FILE_AT_LINE (180)) ;
        }
      }
    }
    var_cas_generatedUserZone3._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
  ...
  if (((GGS_uint::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    "}\n"
      "\n") ;
    {
      GGS_sortedTypeList::cEnumerator enumerator_10308 (var_cas_sortedTypeList, true) ;
      const GGS_sortedTypeList::cElement * operand_10308 = NULL ;
      while (((operand_10308 = (GGS_sortedTypeList::cElement *) enumerator_10308.nextObject ()))) {
        macroValidPointer (operand_10308) ;
        const GGS_ACGalgasType  _temp_10381 = operand_10308->mType ;
        if (_temp_10381._isBuilt ()) {
          _temp_10381 (HERE)->method_generateImplementation (_inLexique, var_cas_generatedCode3 COMMA_SOURCE_FILE_AT_LINE (230)) ;
        }
      }
    }
    var_cas_generatedCode3._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  GGS_typeMap  var_cas_typeMap ;
  ::routine_constructBuiltinTypeMap (_inLexique,  var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (274)) ;
  GGS_stringset  var_cas_importedComponentSet ;
  var_cas_importedComponentSet = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
  GGS_routineMap  var_cas_routineMap ;
  var_cas_routineMap = GGS_routineMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_typeList  var_cas_typeList ;
  _walk_throught_buildMapsForSemantics (_inLexique, var_cas_semanticsComponentRoot, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (280)), var_cas_endOfSourceFile, var_cas_importedComponentSet, var_cas_typeMap, var_cas_routineMap, var_cas_typeList) ;
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (288)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_m ;
    var_cas_m = (var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)))._operator_concat (GGS_string (true, " type")) ;
    if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (290)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      var_cas_m = GGS_string (true, "1 type is not defined:") ;
    }else{
      var_cas_m = (var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)))._operator_concat (GGS_string (true, " types are not defined:")) ;
    }
    {
      GGS_stringlist::cEnumerator enumerator_12401 (var_cas_typeMap.reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (295)), true) ;
      const GGS_stringlist::cElement * operand_12401 = NULL ;
      while (((operand_12401 = (GGS_stringlist::cElement *) enumerator_12401.nextObject ()))) {
        macroValidPointer (operand_12401) ;
        var_cas_m.writeString ("\n"
          "  - @") ;
        var_cas_m._dotAssign_operation (operand_12401->mValue) ;
      }
    }
    var_cas_endOfSourceFile.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (298)) ;
  }
  {
    GGS_typeMap::cEnumerator enumerator_12600 (var_cas_typeMap, true) ;
    const GGS_typeMap::cElement * operand_12600 = NULL ;
    while (((operand_12600 = (GGS_typeMap::cElement *) enumerator_12600.nextObject ()))) {
      macroValidPointer (operand_12600) ;
      const GGS_ACGalgasType  _temp_12663 = operand_12600->mInfo.mType ;
      if (_temp_12663._isBuilt ()) {
        _temp_12663 (HERE)->method_checkNoCircularity (_inLexique, var_cas_typeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
