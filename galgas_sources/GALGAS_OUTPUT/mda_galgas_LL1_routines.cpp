...
void routine_compileSemanticsComponentLL1 (C_Compiler & _inLexique,
  ...
  if (((var_cas_typeMap.reader_unsolvedIndexCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (146)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_stringlist::element_type * operand_6990 = _var_6990.firstObject () ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (167)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (177)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (187)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (197)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
  ...
  { galgas_scanner * scanner_ = NULL ;
    ...
    if (sourceFileName.fileExists ()) {
      ...
      if (scanner_->sourceText () != NULL) {
        ...
        C_String message ;
        message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
        var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (207)) ;
      }
      macroDetachPointer (scanner_, galgas_scanner) ;
    }else{
      C_String message ;
