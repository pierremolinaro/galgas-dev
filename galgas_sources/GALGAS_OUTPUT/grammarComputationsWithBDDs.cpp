...
reader_nonterminalsWithTwoElementProductionStringValueList (C_Compiler & inLexique
  ...
  if (isBuilt ()) {
    const PMUInt32 variable01Count = mBDDVariableCountForDomain_V + mBDDVariableCountForDomain_V ;
    ...
    while (enumerator_4008.hasCurrentObject ()) {
      {
        ...
        while (((operand_4030 = enumerator_4030.nextObject ()))) {
          ...
          if (((operand_4030->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
    ...
    while (enumerator_4931.hasCurrentObject ()) {
      ...
      }
      {
        ...
        while (((operand_5062 = enumerator_5062.nextObject ()))) {
          ...
          if (((operand_5062->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (112))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          }else if (((operand_5062->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (114))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
          ...
          }else if (((operand_5062->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (117))).operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
            ...
            GGS_uint  var_cas_currentLeftNonTerminal = var_cas_nonterminalIndex ;
            {
              ...
              while (((operand_5907 = enumerator_5907.nextObject ()))) {
                ...
                if (((var_cas_idx).operator_strictInf (operand_5062->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (128)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (128)))).isBuiltAndTrue ()) {
                ...
                }else if (((var_cas_idx).operator_isEqual (operand_5062->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (137)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (137)))).isBuiltAndTrue ()) {
