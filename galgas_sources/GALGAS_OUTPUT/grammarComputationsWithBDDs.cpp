...
void routine_newGrammarAnalyzer (C_Compiler & inLexique,
  ...
  {
    GGS_vocabularyMap::cEnumerator enumerator_2794 (var_cas_inTerminalMap, true) ;
    const GGS_vocabularyMap::cElement * operand_2794 = NULL ;
    while (((operand_2794 = enumerator_2794.nextObject ()))) {
      macroValidPointer (operand_2794) ;
      var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("$")).operator_concat (operand_2794->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (67)))).operator_concat (GGS_string ("$"))) ;
    }
  }
  {
    GGS_vocabularyMap::cEnumerator enumerator_2929 (var_cas_inNonterminalMap, true) ;
    const GGS_vocabularyMap::cElement * operand_2929 = NULL ;
    while (((operand_2929 = enumerator_2929.nextObject ()))) {
      macroValidPointer (operand_2929) ;
      var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (operand_2929->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71)))).operator_concat (GGS_string (">"))) ;
    }
  }
  GGS_uint  var_cas_additionalNonTerminalSymbolsForPureBDDrules = GGS_uint (0U) ;
  {
    GGS_productionListMap::cEnumerator enumerator_3136 (var_cas_inProductionListMap, true) ;
    while (enumerator_3136.hasCurrentObject ()) {
      {
        GGS_derivationList::cEnumerator enumerator_3158 (enumerator_3136._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_3158 = NULL ;
        while (((operand_3158 = enumerator_3158.nextObject ()))) {
          macroValidPointer (operand_3158) ;
          if (((operand_3158->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (77))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
            var_cas_additionalNonTerminalSymbolsForPureBDDrules = var_cas_additionalNonTerminalSymbolsForPureBDDrules.add_operation (inLexique, operand_3158->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (78)) ;
          }
        }
      }
      enumerator_3136.next () ;
    }
  }
  GGS_uint  var_cas_ntIndex = GGS_uint (0U) ;
  GGS_uint _variant_3609 = var_cas_additionalNonTerminalSymbolsForPureBDDrules ;
  GGS_bool _condition_3609 (_variant_3609.isBuilt (), true) ;
  while (_condition_3609.isBuiltAndTrue ()) {
    _condition_3609 = (var_cas_ntIndex).operator_strictInf (var_cas_additionalNonTerminalSymbolsForPureBDDrules) ;
    if (_condition_3609.isBuiltAndTrue ()) {
      if (_variant_3609.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (87)) ;
        _condition_3609 = GGS_bool (false) ;
      }else{
        _variant_3609.decrement_operation (inLexique COMMA_HERE) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (var_cas_ntIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (85)))).operator_concat (GGS_string (">"))) ;
        var_cas_ntIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
      }
    }
  }
  ...
  GGS_uint  var_cas_addedNonTerminalIndex = var_cas_inTerminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (93)).add_operation (inLexique, var_cas_inNonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  {
    GGS_productionListMap::cEnumerator enumerator_4059 (var_cas_inProductionListMap, true) ;
    while (enumerator_4059.hasCurrentObject ()) {
      GGS_uint  var_cas_nonterminalIndex ;
      const GGS_vocabularyMap  temp_4123 = var_cas_inNonterminalMap ;
      if (temp_4123.isBuilt ()) {
        temp_4123 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_4059._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (96)) ;
      }
      {
        GGS_derivationList::cEnumerator enumerator_4190 (enumerator_4059._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_4190 = NULL ;
        while (((operand_4190 = enumerator_4190.nextObject ()))) {
          macroValidPointer (operand_4190) ;
          if (((operand_4190->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (98))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_grammarComputations.modifier_addToNonterminalsWithEmptyProduction (inLexique, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (99)) ;
          }else if (((operand_4190->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (100))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
            const GGS_uint  var_cas_derivation0 = operand_4190->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (101)) ;
            var_cas_grammarComputations.modifier_addToNonterminalsWithOneElementProduction (inLexique, var_cas_nonterminalIndex, var_cas_derivation0 COMMA_SOURCE_FILE_AT_LINE (102)) ;
          }else if (((operand_4190->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (103))).operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
            const GGS_uint  var_cas_derivation0 = operand_4190->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (104)) ;
            const GGS_uint  var_cas_derivation1 = operand_4190->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (105)) ;
            var_cas_grammarComputations.modifier_addToNonterminalsWithTwoElementProduction (inLexique, var_cas_nonterminalIndex, var_cas_derivation0, var_cas_derivation1 COMMA_SOURCE_FILE_AT_LINE (106)) ;
          }else{
            GGS_uint  var_cas_currentLeftNonTerminal = var_cas_nonterminalIndex ;
            {
                GGS_uint var_cas_idx (true, 0) ;
              GGS_uintlist::cEnumerator enumerator_5035 (operand_4190->mDerivation, true) ;
              const GGS_uintlist::cElement * operand_5035 = NULL ;
              while (((operand_5035 = enumerator_5035.nextObject ()))) {
                macroValidPointer (operand_5035) ;
                if (((var_cas_idx).operator_strictInf (operand_4190->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (114)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (114)))).isBuiltAndTrue ()) {
                  const GGS_uint  var_cas_derivation = operand_4190->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (115)) ;
                  var_cas_grammarComputations.modifier_addToNonterminalsWithTwoElementProduction (inLexique, var_cas_nonterminalIndex, var_cas_derivation, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (116)) ;
                  var_cas_currentLeftNonTerminal = var_cas_addedNonTerminalIndex ;
                  var_cas_addedNonTerminalIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
                }else if (((var_cas_idx).operator_isEqual (operand_4190->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (123)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (123)))).isBuiltAndTrue ()) {
                  const GGS_uint  var_cas_derivation0 = operand_4190->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (124)) ;
                  const GGS_uint  var_cas_derivation1 = operand_4190->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)) ;
                  var_cas_grammarComputations.modifier_addToNonterminalsWithTwoElementProduction (inLexique, var_cas_nonterminalIndex, var_cas_derivation0, var_cas_derivation1 COMMA_SOURCE_FILE_AT_LINE (126)) ;
                }
                var_cas_idx.mValue ++ ;
              }
            }
