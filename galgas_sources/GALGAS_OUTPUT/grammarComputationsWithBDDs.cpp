...
GGS_relationStringList GGS_grammarDomain::
reader_nonterminalsWithOneElementProductionRelationStringValueList (C_Compiler & inLexique
                                    COMMA_LOCATION_ARGS) const {
  ...
  if (isBuilt ()) {
    ...
    if (valuesArray.count () > 0) {
      const PMUInt64 rightOperandMask = (1ULL << mBDDVariableCountForDomain_V) - 1ULL ;
      const PMUInt64 leftOperandMask = rightOperandMask << mBDDVariableCountForDomain_V ;
      ...
      subList.addAssign_operation (mDomain_V.reader_mValueAtIndex (inLexique, (PMUInt32) (v0 & rightOperandMask) COMMA_THERE)) ;
      for (PMSInt32 i=1 ; i<valuesArray.count () ; i++) {
        const PMUInt64 v = valuesArray (i COMMA_HERE) ;
        if ((v & leftOperandMask) != currentLeftOperand) {
          result.addAssign_operation (mDomain_V.reader_mValueAtIndex (inLexique, GGS_uint64 (true, currentLeftOperand >> mBDDVariableCountForDomain_V).reader_uint (inLexique COMMA_THERE) COMMA_THERE),
                                      subList) ;
          subList = GGS_stringlist::constructor_emptyList () ;
          currentLeftOperand = v & leftOperandMask ;
        }
        subList.addAssign_operation (mDomain_V.reader_mValueAtIndex (inLexique, GGS_uint64 (true, v & rightOperandMask).reader_uint (inLexique COMMA_THERE) COMMA_THERE)) ;
      }
      result.addAssign_operation (mDomain_V.reader_mValueAtIndex (inLexique, GGS_uint64 (true, currentLeftOperand >> mBDDVariableCountForDomain_V).reader_uint (inLexique COMMA_THERE) COMMA_THERE),
                                  subList) ;
      subList = GGS_stringlist::constructor_emptyList () ;
...
template_filewrapper_grammarComputationTemplates_html (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      ...
      "\n"
      "<p>" ;
    result << var_cas_NON_TERMINAL_WITH_ONE_ELEMENT_PRODUCTION_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (38)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (38)) ;
    result << " non terminal " ;
    if ((var_cas_NON_TERMINAL_WITH_ONE_ELEMENT_PRODUCTION_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (38))).operator_strictSup (GGS_uint (1U)).boolValue ()) {
      result << "symbols have" ;
    }else {
      result << "symbol has" ;
    }
    result << " a one element production:</p>\n"
      "<table class=\"result\">\n" ;
    GGS_relationStringList::cEnumerator enumerator_2180 (var_cas_NON_TERMINAL_WITH_ONE_ELEMENT_PRODUCTION_LIST, true) ;
    const GGS_relationStringList::cElement * operand_2180 = NULL ;
    while (((operand_2180 = enumerator_2180.nextObject ()))) {
      macroValidPointer (operand_2180) ;
      GGS_stringlist::cEnumerator enumerator_2206 (operand_2180->mRightList, true) ;
      const GGS_stringlist::cElement * operand_2206 = NULL ;
      while (((operand_2206 = enumerator_2206.nextObject ()))) {
        macroValidPointer (operand_2206) ;
        result << "<tr class=\"result_line\"><td class=\"result_line\"><code>" ;
        result << operand_2206->mValue.reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (43)) ;
        result << " ::= " ;
        result << operand_2180->mLeftOperand.reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (43)) ;
        result << "</code></td></tr>" ;
      }
    }
    result << "\n"
      ...
      "\n"
      "<p>" ;
    result << var_cas_NON_TERMINAL_WITH_TWO_ELEMENT_PRODUCTION_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (50)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
    result << " non terminal " ;
    if ((var_cas_NON_TERMINAL_WITH_TWO_ELEMENT_PRODUCTION_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).operator_strictSup (GGS_uint (1U)).boolValue ()) {
      result << "symbols have" ;
    }else {
      result << "symbol has" ;
    }
    result << " a two element production:</p>\n"
      "<table class=\"result\">\n" ;
    GGS_relationStringList::cEnumerator enumerator_2708 (var_cas_NON_TERMINAL_WITH_TWO_ELEMENT_PRODUCTION_LIST, true) ;
    const GGS_relationStringList::cElement * operand_2708 = NULL ;
    while (((operand_2708 = enumerator_2708.nextObject ()))) {
      macroValidPointer (operand_2708) ;
      GGS_stringlist::cEnumerator enumerator_2734 (operand_2708->mRightList, true) ;
      const GGS_stringlist::cElement * operand_2734 = NULL ;
      while (((operand_2734 = enumerator_2734.nextObject ()))) {
        macroValidPointer (operand_2734) ;
        result << "<tr class=\"result_line\"><td class=\"result_line\"><code>" ;
        result << operand_2708->mLeftOperand.reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
        result << " ::= " ;
        result << operand_2734->mValue.reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
        result << "</code></td></tr>" ;
      }
    }
    result << "\n"
...
void routine_newGrammarAnalyzer (C_Compiler & inLexique,
  ...
  {
    GGS_productionListMap::cEnumerator enumerator_4022 (var_cas_inProductionListMap, true) ;
    while (enumerator_4022.hasCurrentObject ()) {
      {
        GGS_derivationList::cEnumerator enumerator_4044 (enumerator_4022._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_4044 = NULL ;
        while (((operand_4044 = enumerator_4044.nextObject ()))) {
          macroValidPointer (operand_4044) ;
          if (((operand_4044->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
            var_cas_additionalNonTerminalSymbolsForPureBDDrules = var_cas_additionalNonTerminalSymbolsForPureBDDrules.add_operation (inLexique, operand_4044->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (92)) ;
          }
        }
      }
      enumerator_4022.next () ;
    }
  }
  GGS_uint  var_cas_ntIndex = GGS_uint (0U) ;
  GGS_uint _variant_4495 = var_cas_additionalNonTerminalSymbolsForPureBDDrules ;
  GGS_bool _condition_4495 (_variant_4495.isBuilt (), true) ;
  while (_condition_4495.isBuiltAndTrue ()) {
    _condition_4495 = (var_cas_ntIndex).operator_strictInf (var_cas_additionalNonTerminalSymbolsForPureBDDrules) ;
    if (_condition_4495.isBuiltAndTrue ()) {
      if (_variant_4495.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (101)) ;
        _condition_4495 = GGS_bool (false) ;
      }else{
        _variant_4495.decrement_operation (inLexique COMMA_HERE) ;
  ...
  {
    GGS_productionListMap::cEnumerator enumerator_4945 (var_cas_inProductionListMap, true) ;
    while (enumerator_4945.hasCurrentObject ()) {
      GGS_uint  var_cas_nonterminalIndex ;
      const GGS_vocabularyMap  temp_5009 = var_cas_inNonterminalMap ;
      if (temp_5009.isBuilt ()) {
        temp_5009 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_4945._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (110)) ;
      }
      {
        GGS_derivationList::cEnumerator enumerator_5076 (enumerator_4945._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_5076 = NULL ;
        while (((operand_5076 = enumerator_5076.nextObject ()))) {
          macroValidPointer (operand_5076) ;
          if (((operand_5076->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (112))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          }else if (((operand_5076->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (114))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
            const GGS_uint  var_cas_derivation0 = operand_5076->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (115)) ;
          ...
          }else if (((operand_5076->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (117))).operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
            const GGS_uint  var_cas_derivation0 = operand_5076->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (118)) ;
            const GGS_uint  var_cas_derivation1 = operand_5076->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (119)) ;
            ...
            {
                GGS_uint var_cas_idx (true, 0) ;
              GGS_uintlist::cEnumerator enumerator_5921 (operand_5076->mDerivation, true) ;
              const GGS_uintlist::cElement * operand_5921 = NULL ;
              while (((operand_5921 = enumerator_5921.nextObject ()))) {
                macroValidPointer (operand_5921) ;
                if (((var_cas_idx).operator_strictInf (operand_5076->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (128)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (128)))).isBuiltAndTrue ()) {
                  const GGS_uint  var_cas_derivation = operand_5076->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (129)) ;
                  var_cas_grammarComputations.modifier_addToNonterminalsWithTwoElementProduction (inLexique, var_cas_nonterminalIndex, var_cas_derivation, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (130)) ;
                ...
                }else if (((var_cas_idx).operator_isEqual (operand_5076->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (137)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (137)))).isBuiltAndTrue ()) {
                  const GGS_uint  var_cas_derivation0 = operand_5076->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (138)) ;
                  const GGS_uint  var_cas_derivation1 = operand_5076->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (139)) ;
                  var_cas_grammarComputations.modifier_addToNonterminalsWithTwoElementProduction (inLexique, var_cas_nonterminalIndex, var_cas_derivation0, var_cas_derivation1 COMMA_SOURCE_FILE_AT_LINE (140)) ;
                }
                var_cas_idx.mValue ++ ;
              }
            }
