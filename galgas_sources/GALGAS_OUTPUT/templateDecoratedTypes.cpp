...
class cCollectionElement_templateInstructionIfBranchListForGeneration : public cCollectionElement {
  public : GALGAS_templateInstructionIfBranchListForGeneration_2E_element mObject ;
...
GALGAS_templateInstructionIfBranchListForGeneration_2E_element cEnumerator_templateInstructionIfBranchListForGeneration::current (LOCATION_ARGS) const {
...
class cCollectionElement_templateInstructionSwitchBranchListForGeneration : public cCollectionElement {
  public : GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element mObject ;
...
GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element cEnumerator_templateInstructionSwitchBranchListForGeneration::current (LOCATION_ARGS) const {
...
GALGAS_templateInstructionIfBranchListForGeneration_2E_element::GALGAS_templateInstructionIfBranchListForGeneration_2E_element (void) :
...
GALGAS_templateInstructionIfBranchListForGeneration_2E_element::GALGAS_templateInstructionIfBranchListForGeneration_2E_element (const GALGAS_semanticExpressionForGeneration & inOperand0,
                                                                                                                                const GALGAS_templateInstructionListForGeneration & inOperand1) :
...
GALGAS_templateInstructionIfBranchListForGeneration_2E_element GALGAS_templateInstructionIfBranchListForGeneration_2E_element::constructor_new (const GALGAS_semanticExpressionForGeneration & inOperand0,
                                                                                                                                                const GALGAS_templateInstructionListForGeneration & inOperand1 
                                                                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_templateInstructionIfBranchListForGeneration_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_templateInstructionIfBranchListForGeneration_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_templateInstructionIfBranchListForGeneration_2E_element::objectCompare (const GALGAS_templateInstructionIfBranchListForGeneration_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_templateInstructionIfBranchListForGeneration_2E_element::isValid (void) const {
  return mAttribute_mExpression.isValid () && mAttribute_mInstructionList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_templateInstructionIfBranchListForGeneration_2E_element::drop (void) {
...
GALGAS_semanticExpressionForGeneration GALGAS_templateInstructionIfBranchListForGeneration_2E_element::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mExpression ;
}

//---------------------------------------------------------------------------*

GALGAS_templateInstructionListForGeneration GALGAS_templateInstructionIfBranchListForGeneration_2E_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_templateInstructionIfBranchListForGeneration_2E_element ("templateInstructionIfBranchListForGeneration.element",
                                                                                NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_templateInstructionIfBranchListForGeneration_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_templateInstructionIfBranchListForGeneration_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_templateInstructionIfBranchListForGeneration_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_templateInstructionIfBranchListForGeneration_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_templateInstructionIfBranchListForGeneration_2E_element GALGAS_templateInstructionIfBranchListForGeneration_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                                                                              C_Compiler * inCompiler,
                                                                                                                                              const GALGAS_location & inErrorLocation
                                                                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_templateInstructionIfBranchListForGeneration_2E_element result ;
  const GALGAS_templateInstructionIfBranchListForGeneration_2E_element * p = (const GALGAS_templateInstructionIfBranchListForGeneration_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_templateInstructionIfBranchListForGeneration_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element (const GALGAS_lstringlist & inOperand0,
                                                                                                                                        const GALGAS_templateInstructionListForGeneration & inOperand1) :
...
GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element (GALGAS_lstringlist::constructor_emptyList (HERE),
                                                                             GALGAS_templateInstructionListForGeneration::constructor_emptyList (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::constructor_new (const GALGAS_lstringlist & inOperand0,
                                                                                                                                                        const GALGAS_templateInstructionListForGeneration & inOperand1 
                                                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::objectCompare (const GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
GALGAS_lstringlist GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::reader_mConstantList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mConstantList ;
}

//---------------------------------------------------------------------------*

GALGAS_templateInstructionListForGeneration GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element ("templateInstructionSwitchBranchListForGeneration.element",
                                                                                    NULL) ;
...
GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_templateInstructionSwitchBranchListForGeneration_2E_element *> (p)) {
      result = *p ;
    }else{
