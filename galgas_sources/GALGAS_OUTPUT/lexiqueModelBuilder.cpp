...
pr_lexique_component_start_symbol_lexiqueModelBuilder_66_37_ (galgas_scanner & inLexique,
  ...
  GGS_lexicalMessageDeclarationList  var_cas_lexicalMessageDeclarationList ;
  var_cas_lexicalMessageDeclarationList = GGS_lexicalMessageDeclarationList ::constructor_emptyList () ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_lexique) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_outLexiqueComponentRoot = GGS_lexiqueComponentRoot ::constructor_new (inLexique, var_cas_lexiqueComponentName, var_cas_isTemplate, var_cas_templateDelimitorList, var_cas_templateReplacementList, var_cas_lexicalAttributeList, var_cas_lexicalStyleList, var_cas_terminalDeclarationList, var_cas_lexicalMessageDeclarationList, var_cas_lexicalListDeclarationList, var_cas_lexicalImplicitRuleList, var_cas_lexicalExplicitRuleList COMMA_HERE) ;
}
...
void lexiqueModelBuilder::
pr_lexical_message_declaration_lexiqueModelBuilder_178_34_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioLexicalMessageDeclarationList._addAssign_operation (var_cas_messageName, var_cas_messageValue) ;
}
