...
static const char * gNonTerminalNames [9] = {
...
, END
// State S60 (index = 276)
, galgas_scanner::galgas_scanner_1__3B_, SHIFT (64)
, END
// State S61 (index = 279)
, galgas_scanner::galgas_scanner_1_literal_5F_string, SHIFT (65)
, END
// State S62 (index = 282)
, galgas_scanner::galgas_scanner_1_terminal, SHIFT (66)
, END
// State S63 (index = 285)
...
, galgas_scanner::galgas_scanner_1_literal_5F_string, SHIFT (68)
, END
// State S66 (index = 300)
, galgas_scanner::galgas_scanner_1__3B_, SHIFT (70)
, END
// State S67 (index = 303)
...
static const uint32 gActionTableIndex [75] = {
  0  // S0
, 3  // S1
, 6  // S2
, 9  // S3
...
static const sint16 gSuccessorTable58 [3] = {3, 63, -1} ;

static const sint16 gSuccessorTable64 [3] = {6, 67, -1} ;

static const sint16 gSuccessorTable65 [3] = {7, 69, -1} ;

static const sint16 gSuccessorTable68 [3] = {7, 71, -1} ;

static const sint16 gSuccessorTable70 [3] = {6, 73, -1} ;

static const sint16 gSuccessorTable72 [3] = {6, 74, -1} ;

static const sint16 * gSuccessorTable [75] = {
...
static const sint16 gProductionsTable [25 * 2] = {
0, 9,
  1, 0,
  1, 4,
  1, 7,
