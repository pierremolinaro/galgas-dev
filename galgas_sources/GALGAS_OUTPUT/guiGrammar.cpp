...
static const char * gNonTerminalNames_guiGrammar [10] = {
...
static const int16_t gActionTable_guiGrammar [] = {
// State S0 (index = 0)
...
static const uint32_t gActionTableIndex_guiGrammar [60] = {
  0  // S0
, 3  // S1
, 6  // S2
, 9  // S3
...
static const int16_t gSuccessorTable_guiGrammar_0 [3] = {0, 2, -1} ;

static const int16_t gSuccessorTable_guiGrammar_5 [3] = {1, 8, -1} ;

static const int16_t gSuccessorTable_guiGrammar_7 [3] = {3, 12, -1} ;

static const int16_t gSuccessorTable_guiGrammar_12 [3] = {1, 17, -1} ;

static const int16_t gSuccessorTable_guiGrammar_14 [3] = {2, 20, -1} ;

static const int16_t gSuccessorTable_guiGrammar_19 [3] = {2, 24, -1} ;

static const int16_t gSuccessorTable_guiGrammar_22 [3] = {4, 28, -1} ;

static const int16_t gSuccessorTable_guiGrammar_25 [3] = {1, 29, -1} ;

static const int16_t gSuccessorTable_guiGrammar_27 [3] = {5, 33, -1} ;

static const int16_t gSuccessorTable_guiGrammar_37 [3] = {7, 42, -1} ;

static const int16_t gSuccessorTable_guiGrammar_38 [3] = {8, 44, -1} ;

static const int16_t gSuccessorTable_guiGrammar_39 [3] = {4, 45, -1} ;

static const int16_t gSuccessorTable_guiGrammar_42 [3] = {6, 48, -1} ;

static const int16_t gSuccessorTable_guiGrammar_43 [3] = {8, 49, -1} ;

static const int16_t gSuccessorTable_guiGrammar_50 [3] = {4, 54, -1} ;

static const int16_t gSuccessorTable_guiGrammar_52 [3] = {7, 56, -1} ;

static const int16_t gSuccessorTable_guiGrammar_53 [3] = {4, 57, -1} ;

static const int16_t gSuccessorTable_guiGrammar_56 [3] = {6, 59, -1} ;

static const int16_t * gSuccessorTable_guiGrammar [60] = {
gSuccessorTable_guiGrammar_0, NULL, NULL, NULL, 
  NULL, gSuccessorTable_guiGrammar_5, NULL, gSuccessorTable_guiGrammar_7, 
  NULL, NULL, NULL, NULL, 
  gSuccessorTable_guiGrammar_12, NULL, gSuccessorTable_guiGrammar_14, NULL, 
  NULL, NULL, NULL, gSuccessorTable_guiGrammar_19, 
  NULL, NULL, gSuccessorTable_guiGrammar_22, NULL, 
  NULL, gSuccessorTable_guiGrammar_25, NULL, gSuccessorTable_guiGrammar_27, 
  NULL, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, 
  NULL, gSuccessorTable_guiGrammar_37, gSuccessorTable_guiGrammar_38, gSuccessorTable_guiGrammar_39, 
  NULL, NULL, gSuccessorTable_guiGrammar_42, gSuccessorTable_guiGrammar_43, 
  NULL, NULL, NULL, NULL, 
  NULL, NULL, gSuccessorTable_guiGrammar_50, NULL, 
  gSuccessorTable_guiGrammar_52, gSuccessorTable_guiGrammar_53, NULL, NULL, 
  gSuccessorTable_guiGrammar_56, NULL, NULL, NULL} ;
...
static const int16_t gProductionsTable_guiGrammar [22 * 2] = {
  0, 8,
  1, 0,
  1, 6,
  1, 3,
...
void cGrammar_guiGrammar::performIndexing (C_Compiler * inCompiler,
  ...
  if (scanner->sourceText () != NULL) {
    const bool ok = scanner->performBottomUpParsing (gActionTable_guiGrammar, gNonTerminalNames_guiGrammar,
