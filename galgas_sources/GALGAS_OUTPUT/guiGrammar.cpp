...
static const char * gNonTerminalNames [8] = {
  ...
  "<select_repeat_guiModelBuilder_1>",// Index 2
...
, END
// State S15 (index = 57)
, galgas_scanner::galgas_scanner_1__7B_, SHIFT (21)
, END
// State S16 (index = 60)
, galgas_scanner::galgas_scanner_1__3B_, SHIFT (22)
, END
// State S17 (index = 63)
...
, galgas_scanner::galgas_scanner_1_literal_5F_string, SHIFT (31)
, END
// State S27 (index = 109)
...
, END
// State S31 (index = 121)
, galgas_scanner::galgas_scanner_1__3A_, SHIFT (35)
, END
// State S32 (index = 124)
...
, END
// State S34 (index = 136)
, galgas_scanner::galgas_scanner_1__3B_, SHIFT (38)
, END
// State S35 (index = 139)
, galgas_scanner::galgas_scanner_1_literal_5F_string, SHIFT (39)
, END
// State S36 (index = 142)
...
, galgas_scanner::galgas_scanner_1_literal_5F_string, SHIFT (43)
, END
// State S40 (index = 160)
, galgas_scanner::galgas_scanner_1__2C_, SHIFT (36)
, galgas_scanner::galgas_scanner_1__3B_, REDUCE (12)
...
static const uint32 gActionTableIndex [50] = {
  0  // S0
, 3  // S1
, 6  // S2
, 9  // S3
...
static const sint16 gSuccessorTable7 [3] = {3, 12, -1} ;

static const sint16 gSuccessorTable12 [3] = {1, 17, -1} ;

static const sint16 gSuccessorTable14 [3] = {2, 20, -1} ;

static const sint16 gSuccessorTable19 [3] = {2, 24, -1} ;

static const sint16 gSuccessorTable21 [3] = {4, 28, -1} ;

static const sint16 gSuccessorTable25 [3] = {1, 29, -1} ;

static const sint16 gSuccessorTable32 [3] = {5, 37, -1} ;

static const sint16 gSuccessorTable38 [3] = {4, 42, -1} ;

static const sint16 gSuccessorTable39 [3] = {6, 44, -1} ;

static const sint16 gSuccessorTable40 [3] = {5, 45, -1} ;

static const sint16 gSuccessorTable41 [3] = {4, 46, -1} ;

static const sint16 gSuccessorTable43 [3] = {6, 47, -1} ;

static const sint16 gSuccessorTable48 [3] = {4, 49, -1} ;

static const sint16 * gSuccessorTable [50] = {
...
static const sint16 gProductionsTable [17 * 2] = {
0, 8,
  1, 0,
  1, 6,
  1, 3,
...
//---------------------------------------------------------------------------*
//                                                                           *
//      'select_repeat_guiModelBuilder_1' non terminal implementation        *
//                                                                           *
//---------------------------------------------------------------------------*


sint16 guiGrammar::select_repeat_guiModelBuilder_1 (galgas_scanner & inLexique) {
...
sint16 guiGrammar::select_guiModelBuilder_2 (galgas_scanner & inLexique) {
// Productions numbers : 6 7
  return (sint16) (inLexique.nextProductionIndex () - 5) ;
}
...
// Productions numbers : 8 9 10 11
  return (sint16) (inLexique.nextProductionIndex () - 7) ;
}
...
// Productions numbers : 12 13
  return (sint16) (inLexique.nextProductionIndex () - 11) ;
}
