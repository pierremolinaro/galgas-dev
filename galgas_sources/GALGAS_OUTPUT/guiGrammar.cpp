...
//                    december 10th, 2011, at 18h19'51"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void cGrammar_guiGrammar::nt_gui_5F_component_5F_start_5F_symbol_parse (C_Lexique_galgas_5F_scanner * inLexique) {
  switch (inLexique->nextProductionIndex ()) {
  case 0 :
      rule_guiSyntax_gui_5F_component_5F_start_5F_symbol_i0_parse(inLexique) ;
    break ;
  default :
...
void cGrammar_guiGrammar::nt_gui_5F_component_5F_start_5F_symbol_ (GALGAS_guiComponentAST &  parameter_1,
  ...
  switch (inLexique->nextProductionIndex ()) {
  case 0 :
      rule_guiSyntax_gui_5F_component_5F_start_5F_symbol_i0_(parameter_1, inLexique) ;
    break ;
  default :
    inLexique->internalBottomUpParserError (HERE) ;
  }
      ...
      // if (scanner->needsCompiling ()) {
        if (scanner->sourceText () != NULL) {
          ...
          if (ok && ! executionModeIsSyntaxAnalysisOnly ()) {
            cGrammar_guiGrammar grammar ;
            grammar.nt_gui_5F_component_5F_start_5F_symbol_ (parameter_1, scanner) ;
          }
        }else{
          C_String message ;
...
void cGrammar_guiGrammar::_performSourceStringParsing_ (C_Compiler * inCompiler,
  ...
  if (scanner->sourceText () != NULL) {
    ...
    const bool ok = scanner->performBottomUpParsing (gActionTable, gNonTerminalNames,
                                                     ...
                                                     gProductionsTable) ;
    if (ok && ! executionModeIsSyntaxAnalysisOnly ()) {
      cGrammar_guiGrammar _grammar ;
      _grammar.nt_gui_5F_component_5F_start_5F_symbol_ (parameter_1, scanner) ;
    }
  }
  macroDetachSharedObject (scanner) ;
}
