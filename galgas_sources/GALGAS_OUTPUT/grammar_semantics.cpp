...
elementOf_GGG_typeListeAttributsAxiome::
elementOf_GGG_typeListeAttributsAxiome (const GGG_lstring  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeListeAttributsAxiome *) NULL ;
  aAttributAxiome = argument_0 ;
  retain (aAttributAxiome COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeListeAttributsAxiome::
~elementOf_GGG_typeListeAttributsAxiome (void) {
  macroRelease (aAttributAxiome, this) ;
}
...
elementOf_GGG_typeListeChaines::
elementOf_GGG_typeListeChaines (const GGG_lstring  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeListeChaines *) NULL ;
  attributChaine = argument_0 ;
  retain (attributChaine COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeListeChaines::
~elementOf_GGG_typeListeChaines (void) {
  macroRelease (attributChaine, this) ;
}
...
#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  GGS_typeListeChaines
::GGS_typeListeChaines (UNUSED_LOCATION_ARGS) {
    mFirstItem = (element_type *) NULL ;
    mLastItem = (element_type *) NULL ;
    mListLength = 0 ;
    mCountReference = (sint32 *) NULL ;
...
elementOf_GGG_L_grammarDescriptorForProgram::
elementOf_GGG_L_grammarDescriptorForProgram (const GGG_string *argument_0,
                                const GGG_lstring  *argument_1,
                                const GGG_L_signature  *argument_2,
                                const GGG_typeListeAttributsAxiome  *argument_3,
                                const GGG_lstring  *argument_4 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_L_grammarDescriptorForProgram *) NULL ;
  mGrammarPostfix = argument_0 ;
  retain (mGrammarPostfix COMMA_HERE) ;
  mGrammarName = argument_1 ;
  retain (mGrammarName COMMA_HERE) ;
  mStartSymbolSignature = argument_2 ;
  retain (mStartSymbolSignature COMMA_HERE) ;
  mStartSymbolAttributesList = argument_3 ;
  retain (mStartSymbolAttributesList COMMA_HERE) ;
  mLexiqueClassName = argument_4 ;
  retain (mLexiqueClassName COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_L_grammarDescriptorForProgram::
~elementOf_GGG_L_grammarDescriptorForProgram (void) {
  macroRelease (mGrammarPostfix, this) ;
  macroRelease (mGrammarName, this) ;
  macroRelease (mStartSymbolSignature, this) ;
  macroRelease (mStartSymbolAttributesList, this) ;
  macroRelease (mLexiqueClassName, this) ;
}
