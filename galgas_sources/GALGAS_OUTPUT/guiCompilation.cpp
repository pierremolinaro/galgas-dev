...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_4706 (constinArgument_inGuiComponentRoot.reader_mImportedOptionList (SOURCE_FILE_AT_LINE (121)), true) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_guiSimpleAttributeListAST enumerator_5357 (constinArgument_inGuiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE_AT_LINE (137)), true) ;
  //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_withLexiqueListAST enumerator_5939 (constinArgument_inGuiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (153)), true) ;
  //--- simple foreach instruction
  while (enumerator_5939.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalDeclarationListAST enumerator_6693 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (171)), true) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalListDeclarationListAST enumerator_6822 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (174)), true) ;
    //--- simple foreach instruction
    while (enumerator_6822.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lexicalListEntryListAST enumerator_6850 (enumerator_6822.current_mEntryList (HERE), true) ;
      //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiLabelListAST enumerator_6990 (enumerator_5939.current_mLabels (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_6990.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_7021 (enumerator_6990.current_mTerminalList (HERE), true) ;
      //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiCompoundAttributeListAST enumerator_7432 (enumerator_5939.current_mCompoundAttributes (HERE), true) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiSimpleAttributeListAST enumerator_7914 (enumerator_5939.current_mSimpleAttributes (HERE), true) ;
    //--- simple foreach instruction
