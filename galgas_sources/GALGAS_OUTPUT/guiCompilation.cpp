...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_componentName = var_cas_guiComponentRoot.reader_mGUIName (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) ;
  ...
  const GGS_bool cond_4633 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (109))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4633.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_5043 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (126)), true) ;
    const GGS_lstringlist::cElement * operand_5043 = NULL ;
    while (((operand_5043 = enumerator_5043.nextObject ()))) {
      macroValidPointer (operand_5043) ;
      const GGS_bool cond_5239 = (operand_5043->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5239.isBuiltAndTrue ()) {
        operand_5043->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (129)) ;
      }else if (cond_5239.isBuiltAndFalse ()) {
        GGS_optionComponentAST  automatic_var_5472_0 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_5043->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_5043->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_HERE),  var_cas_ioParsedComponentStruct,  automatic_var_5472_0 COMMA_SOURCE_FILE_AT_LINE (130)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_5043->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5647 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (142)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5647 = NULL ;
    while (((operand_5647 = enumerator_5647.nextObject ()))) {
      macroValidPointer (operand_5647) ;
      const GGS_bool cond_5921 = (operand_5647->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5921.isBuiltAndTrue ()) {
        operand_5647->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5647->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
      }else if (cond_5921.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5647->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6118 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6118.isBuiltAndTrue ()) {
          operand_5647->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (150)) ;
        }else if (cond_6118.isBuiltAndFalse ()) {
          var_cas_context.mNibAndClassList.addAssign_operation (var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (152)), var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (153))) ;
        }
      }
    }
  }
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6323 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (159)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6323 = NULL ;
    while (((operand_6323 = enumerator_6323.nextObject ()))) {
      macroValidPointer (operand_6323) ;
      GGS_lexiqueComponentAST  var_cas_lexiqueComponentRoot ;
      const GGS_bool cond_6618 = (operand_6323->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6618.isBuiltAndTrue ()) {
        operand_6323->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (164)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6618.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6323->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6323->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_HERE) ;
        ::routine_parseLexiqueComponent (inLexique,  var_cas_lexiqueFullPathName,  var_cas_ioParsedComponentStruct,  var_cas_lexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (169)) ;
      }
      GGS_stringset  var_cas_terminalSymbolSet = GGS_stringset ::constructor_emptySet () ;
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_7039 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (177)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_7039 = NULL ;
        while (((operand_7039 = enumerator_7039.nextObject ()))) {
          macroValidPointer (operand_7039) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_7039->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7165 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (180)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7165 = NULL ;
        while (((operand_7165 = enumerator_7165.nextObject ()))) {
          macroValidPointer (operand_7165) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7242 (operand_7165->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7242 = NULL ;
            while (((operand_7242 = enumerator_7242.nextObject ()))) {
              macroValidPointer (operand_7242) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7242->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7382 (operand_6323->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7382 = NULL ;
        while (((operand_7382 = enumerator_7382.nextObject ()))) {
          macroValidPointer (operand_7382) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7413 (operand_7382->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7413 = NULL ;
            while (((operand_7413 = enumerator_7413.nextObject ()))) {
              macroValidPointer (operand_7413) ;
              const GGS_bool cond_7675 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7413->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (188)))).operator_not () ;
              if (cond_7675.isBuiltAndTrue ()) {
                operand_7413->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7413->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6323->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (195)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7824 (operand_6323->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7824 = NULL ;
        while (((operand_7824 = enumerator_7824.nextObject ()))) {
          macroValidPointer (operand_7824) ;
          const GGS_bool cond_7965 = (operand_7824->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7965.isBuiltAndTrue ()) {
            operand_7824->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (203)) ;
          }else if (cond_7965.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7824->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (204)), operand_7824->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (204))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8306 (operand_6323->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8306 = NULL ;
        while (((operand_8306 = enumerator_8306.nextObject ()))) {
          macroValidPointer (operand_8306) ;
          const GGS_bool cond_8533 = (operand_8306->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8533.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8306->mValue, operand_6323->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (215)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8533.isBuiltAndFalse ()) {
            const GGS_bool cond_8772 = (operand_8306->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8772.isBuiltAndTrue ()) {
              const GGS_bool cond_8679 = var_cas_hasTabViewTitle ;
              if (cond_8679.isBuiltAndTrue ()) {
                operand_8306->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8306->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (220)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8306->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
            }else if (cond_8772.isBuiltAndFalse ()) {
              const GGS_bool cond_9017 = (operand_8306->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_9017.isBuiltAndTrue ()) {
                const GGS_bool cond_8925 = var_cas_hasBlockComment ;
                if (cond_8925.isBuiltAndTrue ()) {
                  operand_8306->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8306->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (226)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8306->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (228)) ;
              }else if (cond_9017.isBuiltAndFalse ()) {
                operand_8306->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8306->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (231)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9362 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9362.isBuiltAndTrue ()) {
        operand_6323->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (236)) ;
      }
      const GGS_bool cond_9518 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9518.isBuiltAndTrue ()) {
        operand_6323->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (240)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6323->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6323->mLabels) ;
    }
  }
  const GGS_bool cond_10063 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10063.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254))).operator_concat (GGS_string (".m")), GGS_string ("//"), GGS_string ("\n"
