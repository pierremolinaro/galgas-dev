...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5527 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (143)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5527 = NULL ;
    while (((operand_5527 = enumerator_5527.nextObject ()))) {
      macroValidPointer (operand_5527) ;
      const GGS_bool cond_5801 = (operand_5527->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5801.isBuiltAndTrue ()) {
        operand_5527->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5527->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }else if (cond_5801.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5527->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_5998 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_5998.isBuiltAndTrue ()) {
          operand_5527->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (151)) ;
        }else if (cond_5998.isBuiltAndFalse ()) {
  ...
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6204 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (160)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6204 = NULL ;
    while (((operand_6204 = enumerator_6204.nextObject ()))) {
      ...
      const GGS_bool cond_6498 = (operand_6204->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6498.isBuiltAndTrue ()) {
        operand_6204->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (165)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6498.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6204->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6204->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
      ...
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_6919 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (178)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_6919 = NULL ;
        while (((operand_6919 = enumerator_6919.nextObject ()))) {
          macroValidPointer (operand_6919) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_6919->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7045 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7045 = NULL ;
        while (((operand_7045 = enumerator_7045.nextObject ()))) {
          macroValidPointer (operand_7045) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7122 (operand_7045->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7122 = NULL ;
            while (((operand_7122 = enumerator_7122.nextObject ()))) {
              macroValidPointer (operand_7122) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7122->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7262 (operand_6204->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7262 = NULL ;
        while (((operand_7262 = enumerator_7262.nextObject ()))) {
          macroValidPointer (operand_7262) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7293 (operand_7262->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7293 = NULL ;
            while (((operand_7293 = enumerator_7293.nextObject ()))) {
              macroValidPointer (operand_7293) ;
              const GGS_bool cond_7555 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7293->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)))).operator_not () ;
              if (cond_7555.isBuiltAndTrue ()) {
                operand_7293->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7293->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6204->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (196)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7704 (operand_6204->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7704 = NULL ;
        while (((operand_7704 = enumerator_7704.nextObject ()))) {
          macroValidPointer (operand_7704) ;
          const GGS_bool cond_7845 = (operand_7704->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7845.isBuiltAndTrue ()) {
            operand_7704->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (204)) ;
          }else if (cond_7845.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7704->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), operand_7704->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8186 (operand_6204->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8186 = NULL ;
        while (((operand_8186 = enumerator_8186.nextObject ()))) {
          macroValidPointer (operand_8186) ;
          const GGS_bool cond_8414 = (operand_8186->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8414.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8186->mValue, operand_6204->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (216)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8414.isBuiltAndFalse ()) {
            const GGS_bool cond_8653 = (operand_8186->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8653.isBuiltAndTrue ()) {
              const GGS_bool cond_8560 = var_cas_hasTabViewTitle ;
              if (cond_8560.isBuiltAndTrue ()) {
                operand_8186->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8186->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (221)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8186->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
            }else if (cond_8653.isBuiltAndFalse ()) {
              const GGS_bool cond_8898 = (operand_8186->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_8898.isBuiltAndTrue ()) {
                const GGS_bool cond_8806 = var_cas_hasBlockComment ;
                if (cond_8806.isBuiltAndTrue ()) {
                  operand_8186->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8186->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (227)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8186->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
              }else if (cond_8898.isBuiltAndFalse ()) {
                operand_8186->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8186->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (232)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9243 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9243.isBuiltAndTrue ()) {
        operand_6204->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (237)) ;
      }
      const GGS_bool cond_9399 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9399.isBuiltAndTrue ()) {
        operand_6204->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (241)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6204->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6204->mLabels) ;
    }
  }
  const GGS_bool cond_9945 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (252))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9945.isBuiltAndTrue ()) {
