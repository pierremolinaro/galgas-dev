    ...
    while (enumerator_2152.hasCurrentObject ()) {
      ...
      if (enumerator_2152.current_mLabels (HERE).isValid ()) {
        ...
        while (enumerator_2747.hasCurrentObject ()) {
          ...
          result << " [" ;
          result << GALGAS_uint ((PMUInt32) 2U).multiply_operation (enumerator_2747.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n"
            "  " ;
      ...
      result << " [" ;
      result << enumerator_2152.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (75)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << "] = {\n" ;
      ...
      result << enumerator_2152.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (115)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
      result << "] = {\n" ;
      ...
      result << enumerator_2152.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (125)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
      result << "] = {\n" ;
