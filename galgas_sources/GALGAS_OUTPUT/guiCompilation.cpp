...
GGS_guiCommandLineOptionList GGS_guiCommandLineOptionList::castFromObject (C_CompilerEx & inLexique,
...
void GGS_extensionMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
...
GGS_extensionMap GGS_extensionMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_extensionMap result ;
...
GGS_extensionMap GGS_extensionMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_string& inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_extensionMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
GGS_nibAndClassList GGS_nibAndClassList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_nibAndClassList result ;
...
GGS_textMacroList GGS_textMacroList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_textMacroList result ;
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_guiLabelListAST  p_4 = p->mLabels ;
          internalAppendValues (p_0, p_1, p_2, p_3, p_4 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
GGS_guiLabelListAST  GGS_importedLexiqueList::
...
/* const */ GGS_guiLabelListAST  & GGS_importedLexiqueList::cEnumerator::_mLabels (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_importedLexiqueList GGS_importedLexiqueList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_importedLexiqueList result ;
...
GGS_guiAnalysisContext GGS_guiAnalysisContext::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_guiAnalysisContext result ;
...
static const cRegularFileWrapperEx * gWrapperAllFiles_guiGenerationTemplates_0 [1] = {
  NULL
} ;
...
static const cDirectoryWrapperEx * gWrapperAllDirectories_guiGenerationTemplates_0 [1] = {
  NULL
} ;
...
const cDirectoryWrapperEx gWrapperDirectory_0_guiGenerationTemplates (
  "",
  0,
...
template_filewrapper_guiGenerationTemplates_gui_implementation (C_CompilerEx & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_importedLexiqueList::cEnumerator enumerator_482 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (11)), true) ;
    const GGS_importedLexiqueList::cElement * operand_482 = NULL ;
    while (((operand_482 = enumerator_482.nextObject ()))) {
      macroValidPointer (operand_482) ;
      result << "#import \"" ;
      result << operand_482->mLexiqueClassName ;
      result << "-cocoa.m\"\n" ;
    }
    GGS_nibAndClassList::cEnumerator enumerator_581 (var_cas_GUI_CONTEXT.reader_mNibAndClassList (inLexique COMMA_SOURCE_FILE_AT_LINE (14)), true) ;
    const GGS_nibAndClassList::cElement * operand_581 = NULL ;
    while (((operand_581 = enumerator_581.nextObject ()))) {
      macroValidPointer (operand_581) ;
      result << "#import \"" ;
      result << operand_581->mClassName ;
      result << ".h\"\n" ;
    }
    result << "\n"
    ...
    GGS_nibAndClassList::cEnumerator enumerator_1311 (var_cas_GUI_CONTEXT.reader_mNibAndClassList (inLexique COMMA_SOURCE_FILE_AT_LINE (33)), true) ;
    const GGS_nibAndClassList::cElement * operand_1311 = NULL ;
    while (((operand_1311 = enumerator_1311.nextObject ()))) {
      macroValidPointer (operand_1311) ;
      result << "    [NSArray arrayWithObjects:@\"" ;
      result << operand_1311->mNibName ;
      result << "\", [" ;
      result << operand_1311->mClassName ;
      result << " class], nil],\n" ;
    }
    result << "    nil\n"
      "  ] ;\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringlist::cEnumerator enumerator_1988 (var_cas_GUI_CONTEXT.reader_mImportedOptionComponentList (inLexique COMMA_SOURCE_FILE_AT_LINE (50)), true) ;
    const GGS_stringlist::cElement * operand_1988 = NULL ;
    while (((operand_1988 = enumerator_1988.nextObject ()))) {
      macroValidPointer (operand_1988) ;
      result << "#import \"" ;
      result << operand_1988->mValue ;
      result << "-cocoa.m\"\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    GGS_stringlist::cEnumerator enumerator_2341 (var_cas_GUI_CONTEXT.reader_mImportedOptionComponentList (inLexique COMMA_SOURCE_FILE_AT_LINE (60)), true) ;
    const GGS_stringlist::cElement * operand_2341 = NULL ;
    while (((operand_2341 = enumerator_2341.nextObject ()))) {
      macroValidPointer (operand_2341) ;
      result << "  enterOptionsFor_" ;
      result << operand_2341->mValue.reader_identifierRepresentation () ;
      result << " (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;\n" ;
    }
    result << "}\n"
      "\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_2523 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (65)), true) ;
    const GGS_importedLexiqueList::cElement * operand_2523 = NULL ;
    while (((operand_2523 = enumerator_2523.nextObject ()))) {
      macroValidPointer (operand_2523) ;
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << operand_2523->mLexiqueClassName ;
      result << "\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        ...
        "//---------------------------------------------------------------------------*\n"
        "\n" ;
      GGS_guiLabelListAST::cEnumerator enumerator_3108 (operand_2523->mLabels, true) ;
      const GGS_guiLabelListAST::cElement * operand_3108 = NULL ;
      while (((operand_3108 = enumerator_3108.nextObject ()))) {
        macroValidPointer (operand_3108) ;
        result << "static const UInt16 gPopUpData_" ;
        result << operand_2523->mLexiqueClassName.reader_identifierRepresentation () ;
        result << "_" ;
        result << operand_3108->mLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
        result << " [" ;
        result << operand_3108->mTerminalList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
        result << "] = {\n" ;
        GGS_lstringlist::cEnumerator enumerator_3309 (operand_3108->mTerminalList, true) ;
        const GGS_lstringlist::cElement * operand_3309 = NULL ;
        while (((operand_3309 = enumerator_3309.nextObject ()))) {
          macroValidPointer (operand_3309) ;
          result << "  " ;
          result << operand_2523->mLexiqueClassName ;
          result << "_1_" ;
          result << operand_3309->mValue.ggs_string ().reader_identifierRepresentation () ;
          result << ",\n" ;
        }
        result << "  0\n"
          "} ;\n"
      ...
      result << operand_2523->mLexiqueClassName.reader_identifierRepresentation () ;
      result << " [" ;
      result << operand_2523->mLabels.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (81)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
      result << "] = {\n" ;
      GGS_guiLabelListAST::cEnumerator enumerator_3593 (operand_2523->mLabels, true) ;
      const GGS_guiLabelListAST::cElement * operand_3593 = NULL ;
      while (((operand_3593 = enumerator_3593.nextObject ()))) {
        macroValidPointer (operand_3593) ;
        result << "  gPopUpData_" ;
        result << operand_2523->mLexiqueClassName.reader_identifierRepresentation () ;
        result << "_" ;
        result << operand_3593->mLocation.reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (83)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << ",\n" ;
      }
      result << "  NULL\n"
        "} ;\n"
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << operand_2523->mBlockComment.reader_utf8Representation () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << " ;\n"
        ...
        "- (UInt32) textMacroCount {\n"
        "  return " ;
      result << operand_2523->mTextMacroList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (113)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << operand_2523->mTitle.reader_utf8Representation () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << operand_2523->mTextMacroList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (121)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121)) ;
      result << "] = {\n" ;
      GGS_textMacroList::cEnumerator enumerator_5772 (operand_2523->mTextMacroList, true) ;
      const GGS_textMacroList::cElement * operand_5772 = NULL ;
      while (((operand_5772 = enumerator_5772.nextObject ()))) {
        macroValidPointer (operand_5772) ;
        result << "    @" ;
        result << operand_5772->mKey.reader_utf8Representation () ;
        result << ",\n" ;
      }
      result << "    NULL\n"
        "  } ;\n"
      ...
      result << operand_2523->mTextMacroList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (131)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
      result << "] = {\n" ;
      GGS_textMacroList::cEnumerator enumerator_6185 (operand_2523->mTextMacroList, true) ;
      const GGS_textMacroList::cElement * operand_6185 = NULL ;
      while (((operand_6185 = enumerator_6185.nextObject ()))) {
        macroValidPointer (operand_6185) ;
        result << "    @" ;
        result << operand_6185->mContents.reader_utf8Representation () ;
        result << ",\n" ;
      }
      result << "    NULL\n"
        "  } ;\n"
    ...
    GGS_extensionMap::cEnumerator enumerator_6670 (var_cas_GUI_CONTEXT.reader_mExtensionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (148)), true) ;
    const GGS_extensionMap::cElement * operand_6670 = NULL ;
    if (enumerator_6670.hasCurrentObject ()) {
      result << "  if" ;
      while (((operand_6670 = enumerator_6670.nextObject ()))) {
        macroValidPointer (operand_6670) ;
        result << " ([inExtension isEqualToString:@" ;
        result << operand_6670->mKey.ggs_string ().reader_utf8Representation () ;
        result << "]) {\n"
          "    result = [[[OC_Tokenizer_" ;
        result << operand_6670->mInfo.mLexiqueName ;
        result << " alloc] init] autorelease] ;\n" ;
        if (enumerator_6670.hasNextObject ()) {
          result << "  }else if" ;
        }
      }
      result << "  }\n" ;
    ...
    result << "  return result ;\n"
      ...
      "  return [NSArray arrayWithObjects:\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_7095 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (162)), true) ;
    const GGS_importedLexiqueList::cElement * operand_7095 = NULL ;
    while (((operand_7095 = enumerator_7095.nextObject ()))) {
      macroValidPointer (operand_7095) ;
      result << "    [[[OC_Tokenizer_" ;
      result << operand_7095->mLexiqueClassName ;
      result << " alloc] init] autorelease],\n" ;
    }
    result << "    nil\n"
      "  ] ;\n"
...
void routine_compileGuiComponent (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_guiComponentAST var_cas_guiComponentRoot ;
  ...
  GGS_lstring  var_cas_componentName = var_cas_guiComponentRoot.reader_mGUIName (inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
  GGS_string var_cas_basename = var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  const GGS_bool cond_4552 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4552.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (113)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  GGS_guiAnalysisContext var_cas_context = GGS_guiAnalysisContext::constructor_new (GGS_stringlist ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_nibAndClassList ::constructor_emptyList (), GGS_extensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (124)), GGS_importedLexiqueList ::constructor_emptyList ()) ;
  {
    GGS_lstringlist::cEnumerator enumerator_4962 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (128)), true) ;
    const GGS_lstringlist::cElement * operand_4962 = NULL ;
    while (((operand_4962 = enumerator_4962.nextObject ()))) {
      macroValidPointer (operand_4962) ;
      const GGS_bool cond_5167 = (operand_4962->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)).reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5167.isBuiltAndTrue ()) {
        operand_4962->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (131)) ;
      }else if (cond_5167.isBuiltAndFalse ()) {
        GGS_lstring  automatic_var_5419_0 ;
        GGS_commandLineOptionMap  automatic_var_5419_1 ;
        GGS_commandLineOptionMap  automatic_var_5419_2 ;
        GGS_commandLineOptionMap  automatic_var_5419_3 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_4962->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)).reader_absolutePathFromPath (var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)).reader_stringByDeletingLastPathComponent ()), operand_4962->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (133)),  var_cas_ioParsedComponentStruct,  automatic_var_5419_0,  automatic_var_5419_1,  automatic_var_5419_2,  automatic_var_5419_3 COMMA_SOURCE_FILE_AT_LINE (132)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_4962->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)).reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5604 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (144)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5604 = NULL ;
    while (((operand_5604 = enumerator_5604.nextObject ()))) {
      macroValidPointer (operand_5604) ;
      const GGS_bool cond_5878 = (operand_5604->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5878.isBuiltAndTrue ()) {
        operand_5604->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5604->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }else if (cond_5878.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5604->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (149)).reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6084 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6084.isBuiltAndTrue ()) {
          operand_5604->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (152)) ;
        }else if (cond_6084.isBuiltAndFalse ()) {
          var_cas_context.mNibAndClassList.addAssign_operation (var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (154)), var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (155))) ;
        }
      }
    }
  }
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6290 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (161)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6290 = NULL ;
    while (((operand_6290 = enumerator_6290.nextObject ()))) {
      macroValidPointer (operand_6290) ;
      GGS_lexiqueComponentAST  var_cas_lexiqueComponentRoot ;
      const GGS_bool cond_6593 = (operand_6290->mLexiqueFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6593.isBuiltAndTrue ()) {
        operand_6290->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (166)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6593.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6290->mLexiqueFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)).reader_absolutePathFromPath (var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)).reader_stringByDeletingLastPathComponent ()), operand_6290->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (167)) ;
        ::routine_parseLexiqueComponent (inLexique,  var_cas_lexiqueFullPathName,  var_cas_ioParsedComponentStruct,  var_cas_lexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (171)) ;
      }
      GGS_stringset  var_cas_terminalSymbolSet = GGS_stringset ::constructor_emptySet () ;
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_7032 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (179)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_7032 = NULL ;
        while (((operand_7032 = enumerator_7032.nextObject ()))) {
          macroValidPointer (operand_7032) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_7032->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7158 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (182)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7158 = NULL ;
        while (((operand_7158 = enumerator_7158.nextObject ()))) {
          macroValidPointer (operand_7158) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7235 (operand_7158->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7235 = NULL ;
            while (((operand_7235 = enumerator_7235.nextObject ()))) {
              macroValidPointer (operand_7235) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7235->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7375 (operand_6290->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7375 = NULL ;
        while (((operand_7375 = enumerator_7375.nextObject ()))) {
          macroValidPointer (operand_7375) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7406 (operand_7375->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7406 = NULL ;
            while (((operand_7406 = enumerator_7406.nextObject ()))) {
              macroValidPointer (operand_7406) ;
              const GGS_bool cond_7668 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7406->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (190)))).operator_not () ;
              if (cond_7668.isBuiltAndTrue ()) {
                operand_7406->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7406->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6290->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (197)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7817 (operand_6290->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7817 = NULL ;
        while (((operand_7817 = enumerator_7817.nextObject ()))) {
          macroValidPointer (operand_7817) ;
          const GGS_bool cond_7958 = (operand_7817->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7958.isBuiltAndTrue ()) {
            operand_7817->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (205)) ;
          }else if (cond_7958.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7817->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), operand_7817->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8299 (operand_6290->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8299 = NULL ;
        while (((operand_8299 = enumerator_8299.nextObject ()))) {
          macroValidPointer (operand_8299) ;
          const GGS_bool cond_8536 = (operand_8299->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8536.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8299->mValue, operand_6290->mLexiqueFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (217)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (217)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8536.isBuiltAndFalse ()) {
            const GGS_bool cond_8775 = (operand_8299->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8775.isBuiltAndTrue ()) {
              const GGS_bool cond_8682 = var_cas_hasTabViewTitle ;
              if (cond_8682.isBuiltAndTrue ()) {
                operand_8299->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8299->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (222)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8299->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
            }else if (cond_8775.isBuiltAndFalse ()) {
              const GGS_bool cond_9020 = (operand_8299->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_9020.isBuiltAndTrue ()) {
                const GGS_bool cond_8928 = var_cas_hasBlockComment ;
                if (cond_8928.isBuiltAndTrue ()) {
                  operand_8299->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8299->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (228)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8299->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
              }else if (cond_9020.isBuiltAndFalse ()) {
                operand_8299->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8299->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (233)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9365 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9365.isBuiltAndTrue ()) {
        operand_6290->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (238)) ;
      }
      const GGS_bool cond_9521 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9521.isBuiltAndTrue ()) {
        operand_6290->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (242)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6290->mLexiqueFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)).reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6290->mLabels) ;
    }
  }
  const GGS_bool cond_10076 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (253))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10076.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (256))).operator_concat (GGS_string (".m")), GGS_string ("//"), GGS_string ("\n"
