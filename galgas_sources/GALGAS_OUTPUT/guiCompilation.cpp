...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 26)).isValid ()) {
    cEnumerator_stringlist enumerator_1209 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 26)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 43)).isValid ()) {
    cEnumerator_stringlist enumerator_2126 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 43)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 53)).isValid ()) {
    cEnumerator_stringlist enumerator_2556 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 53)), kEnumeration_up) ;
    while (enumerator_2556.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_2556.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 54)).stringValue () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2732 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 58)), kEnumeration_up) ;
    while (enumerator_2732.hasCurrentObject ()) {
      ...
      if (enumerator_2732.current_mLabels (HERE).isValid ()) {
        ...
        while (enumerator_3571.hasCurrentObject ()) {
          ...
          result << enumerator_2732.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)).stringValue () ;
          result << "_" ;
          result << enumerator_3571.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_3571.current_mTerminalList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)).add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_3571.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 68)).stringValue () ;
          ...
          if (enumerator_3571.current_mTerminalList (HERE).isValid ()) {
            ...
            while (enumerator_3869.hasCurrentObject ()) {
              ...
              result << enumerator_2732.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3869.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 70)).stringValue () ;
              result << ", " ;
              result << enumerator_3869.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 70)).stringValue () ;
              result << ",\n" ;
      ...
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2732.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 75)).stringValue () ;
      result << " [" ;
      result << enumerator_2732.current_mLabels (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 75)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 75)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 75)).stringValue () ;
      result << "] = {\n" ;
      ...
      if (enumerator_2732.current_mLabels (HERE).isValid ()) {
        ...
        while (enumerator_4169.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2732.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 77)).stringValue () ;
          result << "_" ;
          result << enumerator_4169.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 77)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 77)).stringValue () ;
          result << ",\n" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2732.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2732.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2732.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 107)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2732.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2732.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 115)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 115)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 115)).stringValue () ;
      result << "] = {\n" ;
      ...
      if (enumerator_2732.current_mTextMacroList (HERE).isValid ()) {
        ...
        while (enumerator_6812.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_6812.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 117)).stringValue () ;
          result << ",\n" ;
      ...
      result << enumerator_2732.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 125)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.galgasTemplate", 125)).reader_string (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 125)).stringValue () ;
      result << "] = {\n" ;
      ...
      if (enumerator_2732.current_mTextMacroList (HERE).isValid ()) {
        ...
        while (enumerator_7261.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_7261.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 127)).stringValue () ;
          result << ",\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 142)).isValid ()) {
    cEnumerator_extensionMap enumerator_7828 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 142)), kEnumeration_up) ;
    ...
    while (enumerator_7828.hasCurrentObject ()) {
      ...
      result << enumerator_7828.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 144)).stringValue () ;
      result << "]) {\n"
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_8254 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.galgasTemplate", 156)), kEnumeration_up) ;
...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_4622 (constinArgument_inGuiComponentRoot.reader_mImportedOptionList (SOURCE_FILE ("guiCompilation.gSemantics", 117)), kEnumeration_up) ;
  while (enumerator_4622.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_4622.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 118)).reader_pathExtension (SOURCE_FILE ("guiCompilation.gSemantics", 118)).objectCompare (GALGAS_string ("gOption"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_4622.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      GALGAS_lstring joker_5032_4 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5032_3 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5032_2 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5032_1 ; // Joker input parameter
      routine_parseOptionComponent (GALGAS_lstring::constructor_new (enumerator_4622.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 123)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 123)).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("guiCompilation.gSemantics", 123)) COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 123)), enumerator_4622.current_mValue (HERE).reader_location (SOURCE_FILE ("guiCompilation.gSemantics", 124))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 122)), ioArgument_ioParsedComponentStruct, joker_5032_4, joker_5032_3, joker_5032_2, joker_5032_1, inCompiler  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 121)) ;
      }
      var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_4622.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 129)).reader_lastPathComponent (SOURCE_FILE ("guiCompilation.gSemantics", 129)).reader_stringByDeletingPathExtension (SOURCE_FILE ("guiCompilation.gSemantics", 129))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 129)) ;
    }
    enumerator_4622.gotoNextObject () ;
  }
  cEnumerator_guiSimpleAttributeListAST enumerator_5273 (constinArgument_inGuiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE ("guiCompilation.gSemantics", 133)), kEnumeration_up) ;
  while (enumerator_5273.hasCurrentObject ()) {
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_5273.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 134)).objectCompare (GALGAS_string ("nibAndMainClass"))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5273.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_5, GALGAS_string ("the '").operator_concat (enumerator_5273.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 135))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 135)).operator_concat (GALGAS_string ("' key is invalid and has no effect")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 135))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 135)) ;
    }else if (kBoolFalse == test_4) {
      cEnumerator_stringlist enumerator_5471 (enumerator_5273.current_mValue (HERE).mAttribute_string.reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 137)), kEnumeration_up) ;
      while (enumerator_5471.hasCurrentObject ()) {
        var_context.mAttribute_mNibAndClassList.addAssign_operation (enumerator_5471.current_mValue (HERE)  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 138)) ;
        enumerator_5471.gotoNextObject () ;
      }
    }
    enumerator_5273.gotoNextObject () ;
  }
  cEnumerator_withLexiqueListAST enumerator_5657 (constinArgument_inGuiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE ("guiCompilation.gSemantics", 143)), kEnumeration_up) ;
  while (enumerator_5657.hasCurrentObject ()) {
    GALGAS_galgas_33_LexiqueComponentListAST_2D_element var_lexiqueComponentRoot ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_5657.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 146)).reader_pathExtension (SOURCE_FILE ("guiCompilation.gSemantics", 146)).objectCompare (GALGAS_string ("gLexique"))).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_location location_7 (enumerator_5657.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_lstring var_lexiqueFullPathName = GALGAS_lstring::constructor_new (enumerator_5657.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 150)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 150)).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("guiCompilation.gSemantics", 150)) COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 150)), enumerator_5657.current_mLexiqueFileName (HERE).reader_location (SOURCE_FILE ("guiCompilation.gSemantics", 151)) COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 149)) ;
      {
    ...
    cEnumerator_terminalDeclarationListAST enumerator_6430 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE ("guiCompilation.gSemantics", 161)), kEnumeration_up) ;
    while (enumerator_6430.hasCurrentObject ()) {
      var_terminalSymbolSet.addAssign_operation (enumerator_6430.current_mName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 162))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 162)) ;
      enumerator_6430.gotoNextObject () ;
    }
    cEnumerator_lexicalListDeclarationListAST enumerator_6559 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE ("guiCompilation.gSemantics", 164)), kEnumeration_up) ;
    while (enumerator_6559.hasCurrentObject ()) {
      cEnumerator_lexicalListEntryListAST enumerator_6587 (enumerator_6559.current_mEntryList (HERE), kEnumeration_up) ;
      while (enumerator_6587.hasCurrentObject ()) {
        var_terminalSymbolSet.addAssign_operation (enumerator_6587.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 166))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 166)) ;
        enumerator_6587.gotoNextObject () ;
      }
      enumerator_6559.gotoNextObject () ;
    }
    cEnumerator_guiLabelListAST enumerator_6727 (enumerator_5657.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_6727.hasCurrentObject ()) {
      cEnumerator_terminalLabelListAST enumerator_6758 (enumerator_6727.current_mTerminalList (HERE), kEnumeration_up) ;
      while (enumerator_6758.hasCurrentObject ()) {
        const enumGalgasBool test_8 = var_terminalSymbolSet.reader_hasKey (enumerator_6758.current_mTerminal (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 172)) COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 172)).operator_not (SOURCE_FILE ("guiCompilation.gSemantics", 172)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_6758.current_mTerminal (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("the '$").operator_concat (enumerator_6758.current_mTerminal (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 173))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 173)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 174)).operator_concat (enumerator_5657.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 175))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 175)).operator_concat (GALGAS_string ("' lexique")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 176))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 173)) ;
        }
    ...
    cEnumerator_guiCompoundAttributeListAST enumerator_7178 (enumerator_5657.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7178.hasCurrentObject ()) {
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_7178.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 185)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_10) {
        GALGAS_location location_11 (enumerator_7178.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_textMacroList.addAssign_operation (enumerator_7178.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 188)), enumerator_7178.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 188))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 188)) ;
      }
    ...
    cEnumerator_guiSimpleAttributeListAST enumerator_7660 (enumerator_5657.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7660.hasCurrentObject ()) {
      const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_7660.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 198)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_12) {
        {
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7660.current_mValue (HERE), enumerator_5657.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 199)).reader_lastPathComponent (SOURCE_FILE ("guiCompilation.gSemantics", 199)).reader_stringByDeletingPathExtension (SOURCE_FILE ("guiCompilation.gSemantics", 199)), inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 199)) ;
        }
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_12) {
        const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_7660.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 201)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_13) {
          const enumGalgasBool test_14 = var_hasTabViewTitle.boolEnum () ;
          if (kBoolTrue == test_14) {
            GALGAS_location location_15 (enumerator_7660.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_15, GALGAS_string ("the '").operator_concat (enumerator_7660.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 203))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 203)).operator_concat (GALGAS_string ("' key should be defined once")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 203))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 203)) ;
          }
          var_hasTabViewTitle = GALGAS_bool (true) ;
          var_tabViewTitle = enumerator_7660.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 206)) ;
        }else if (kBoolFalse == test_13) {
          const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_7660.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 207)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_16) {
            const enumGalgasBool test_17 = var_hasBlockComment.boolEnum () ;
            if (kBoolTrue == test_17) {
              GALGAS_location location_18 (enumerator_7660.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_18, GALGAS_string ("the '").operator_concat (enumerator_7660.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 209))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 209)).operator_concat (GALGAS_string ("' key should be defined once")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 209))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 209)) ;
            }
            var_hasBlockComment = GALGAS_bool (true) ;
            var_blockComment = enumerator_7660.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 212)) ;
          }else if (kBoolFalse == test_16) {
            GALGAS_location location_19 (enumerator_7660.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_19, GALGAS_string ("the '").operator_concat (enumerator_7660.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 214))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 214)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 214))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 214)) ;
          }
        }
      }
    ...
    if (kBoolTrue == test_20) {
      GALGAS_location location_21 (enumerator_5657.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_22) {
      GALGAS_location location_23 (enumerator_5657.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_5657.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 227)).reader_lastPathComponent (SOURCE_FILE ("guiCompilation.gSemantics", 227)).reader_stringByDeletingPathExtension (SOURCE_FILE ("guiCompilation.gSemantics", 227)), var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_5657.current_mLabels (HERE)  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 226)) ;
...
void routine_compileGuiComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  C_String syntaxDirectedTranslationResult_9889 ;
  cGrammar_guiGrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_9889, constinArgument_inSourceFile, var_guiComponentRoot  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 257)) ;
  {
...
void routine_compileAllGuiComponentFromASTGalgas_33_ (const GALGAS_galgas_33_GUIComponentListAST constinArgument_inGuiComponentListAST,
  ...
  cEnumerator_galgas_33_GUIComponentListAST enumerator_10899 (constinArgument_inGuiComponentListAST, kEnumeration_up) ;
  while (enumerator_10899.hasCurrentObject ()) {
    {
    routine_compileGuiComponentGalgas_33_ (enumerator_10899.current (HERE), constinArgument_inSemanticContext, outArgument_outOptionComponentMapForGeneration, inCompiler  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 285)) ;
    }
...
void routine_compileGuiComponentGalgas_33_ (const GALGAS_galgas_33_GUIComponentListAST_2D_element constinArgument_inGUIComponentAST,
  ...
  cEnumerator_lstringlist enumerator_11936 (constinArgument_inGUIComponentAST.mAttribute_mImportedOptionList, kEnumeration_up) ;
  while (enumerator_11936.hasCurrentObject ()) {
    GALGAS_bool joker_12034_4 ; // Joker input parameter
    GALGAS_commandLineOptionMap joker_12034_3 ; // Joker input parameter
    GALGAS_commandLineOptionMap joker_12034_2 ; // Joker input parameter
    GALGAS_commandLineOptionMap joker_12034_1 ; // Joker input parameter
    constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis.method_searchKey (enumerator_11936.current_mValue (HERE), joker_12034_4, joker_12034_3, joker_12034_2, joker_12034_1, inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 315)) ;
    var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_11936.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 334)) ;
    enumerator_11936.gotoNextObject () ;
  }
  cEnumerator_guiSimpleAttributeListAST enumerator_12813 (constinArgument_inGUIComponentAST.mAttribute_mGlobalSimpleAttributeList, kEnumeration_up) ;
  while (enumerator_12813.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_12813.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 339)).objectCompare (GALGAS_string ("nibAndMainClass"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_12813.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_3, GALGAS_string ("the '").operator_concat (enumerator_12813.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 340))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 340)).operator_concat (GALGAS_string ("' key is invalid and has no effect")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 340))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 340)) ;
    }else if (kBoolFalse == test_2) {
      cEnumerator_stringlist enumerator_13011 (enumerator_12813.current_mValue (HERE).mAttribute_string.reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 342)), kEnumeration_up) ;
      while (enumerator_13011.hasCurrentObject ()) {
        var_context.mAttribute_mNibAndClassList.addAssign_operation (enumerator_13011.current_mValue (HERE)  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 343)) ;
        enumerator_13011.gotoNextObject () ;
      }
    }
    enumerator_12813.gotoNextObject () ;
  }
  cEnumerator_withLexiqueListAST enumerator_13195 (constinArgument_inGUIComponentAST.mAttribute_mWithLexiqueList, kEnumeration_up) ;
  while (enumerator_13195.hasCurrentObject ()) {
    GALGAS_terminalMap var_terminalMap ;
    GALGAS_indexingListAST joker_13357_2 ; // Joker input parameter
    GALGAS_lstring joker_13357_1 ; // Joker input parameter
    constinArgument_inSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (enumerator_13195.current_mLexiqueFileName (HERE), var_terminalMap, joker_13357_2, joker_13357_1, inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 350)) ;
    GALGAS_stringset var_terminalSymbolSet = var_terminalMap.reader_keySet (SOURCE_FILE ("guiCompilation.gSemantics", 370)) ;
    cEnumerator_guiLabelListAST enumerator_14443 (enumerator_13195.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_14443.hasCurrentObject ()) {
      cEnumerator_terminalLabelListAST enumerator_14474 (enumerator_14443.current_mTerminalList (HERE), kEnumeration_up) ;
      while (enumerator_14474.hasCurrentObject ()) {
        const enumGalgasBool test_4 = var_terminalSymbolSet.reader_hasKey (enumerator_14474.current_mTerminal (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 382)) COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 382)).operator_not (SOURCE_FILE ("guiCompilation.gSemantics", 382)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_location location_5 (enumerator_14474.current_mTerminal (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '$").operator_concat (enumerator_14474.current_mTerminal (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 383))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 383)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 384)).operator_concat (enumerator_13195.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 385))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 385)).operator_concat (GALGAS_string ("' lexique")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 386))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 383)) ;
        }
    ...
    cEnumerator_guiCompoundAttributeListAST enumerator_14894 (enumerator_13195.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    while (enumerator_14894.hasCurrentObject ()) {
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_14894.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 395)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_14894.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_textMacroList.addAssign_operation (enumerator_14894.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 398)), enumerator_14894.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 398))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 398)) ;
      }
    ...
    GALGAS_string var_tabViewTitle = GALGAS_string::makeEmptyString () ;
    GALGAS_string var_blockComment = GALGAS_string::makeEmptyString () ;
    cEnumerator_guiSimpleAttributeListAST enumerator_15376 (enumerator_13195.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    while (enumerator_15376.hasCurrentObject ()) {
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_15376.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 408)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        {
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_15376.current_mValue (HERE), enumerator_13195.current_mLexiqueFileName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 409)) ;
        }
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_8) {
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_15376.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 411)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          const enumGalgasBool test_10 = var_hasTabViewTitle.boolEnum () ;
          if (kBoolTrue == test_10) {
            GALGAS_location location_11 (enumerator_15376.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_11, GALGAS_string ("the '").operator_concat (enumerator_15376.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 413))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 413)).operator_concat (GALGAS_string ("' key should be defined once")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 413))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 413)) ;
          }
          var_hasTabViewTitle = GALGAS_bool (true) ;
          var_tabViewTitle = enumerator_15376.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 416)) ;
        }else if (kBoolFalse == test_9) {
          const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_15376.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 417)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            const enumGalgasBool test_13 = var_hasBlockComment.boolEnum () ;
            if (kBoolTrue == test_13) {
              GALGAS_location location_14 (enumerator_15376.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_14, GALGAS_string ("the '").operator_concat (enumerator_15376.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 419))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 419)).operator_concat (GALGAS_string ("' key should be defined once")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 419))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 419)) ;
            }
            var_hasBlockComment = GALGAS_bool (true) ;
            var_blockComment = enumerator_15376.current_mValue (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 422)) ;
          }else if (kBoolFalse == test_12) {
            GALGAS_location location_15 (enumerator_15376.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_15, GALGAS_string ("the '").operator_concat (enumerator_15376.current_mKey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 424))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 424)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 424))  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 424)) ;
          }
        }
      }
    ...
    if (kBoolTrue == test_16) {
      GALGAS_location location_17 (enumerator_13195.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_13195.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_13195.current_mLexiqueFileName (HERE).mAttribute_string, var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_13195.current_mLabels (HERE)  COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 436)) ;
    enumerator_13195.gotoNextObject () ;
  }
  {
...
void routine_generateAllGuiComponentsGalgas_33_ (const GALGAS_optionComponentMapForGeneration constinArgument_inOptionComponentMapForGeneration,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_optionComponentMapForGeneration enumerator_17203 (constinArgument_inOptionComponentMapForGeneration, kEnumeration_up) ;
  while (enumerator_17203.hasCurrentObject ()) {
    GALGAS_string var_fileName = GALGAS_string ("gui-").add_operation (enumerator_17203.current_lkey (HERE).reader_string (SOURCE_FILE ("guiCompilation.gSemantics", 460)), inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 460)).add_operation (GALGAS_string (".m"), inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 460)) ;
    ...
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_fileName, GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (inCompiler, GALGAS_bool (true), enumerator_17203.current_mGuiComponentContext (HERE) COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 468))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("guiCompilation.gSemantics", 463)) ;
    }
    enumerator_17203.gotoNextObject () ;
  }
}
