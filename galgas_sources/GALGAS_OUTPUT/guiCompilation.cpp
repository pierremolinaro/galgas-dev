...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (155)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6721 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (155)), kEnumeration_up) ;
    while (enumerator_6721.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_6721.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
