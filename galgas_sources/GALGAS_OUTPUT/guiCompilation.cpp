...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
    ...
    while (enumerator_2244.hasCurrentObject ()) {
      ...
      if (enumerator_2244.current_mLabels (HERE).isValid ()) {
        ...
        while (enumerator_2754.hasCurrentObject ()) {
          ...
          result << " [" ;
          result << GALGAS_uint ((PMUInt32) 2U).multiply_operation (enumerator_2754.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_2754.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
          result << ", // Leading character count to strip\n" ;
          GALGAS_uint index_3025_ (0) ;
          if (enumerator_2754.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_terminalLabelListAST enumerator_3025 (enumerator_2754.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_3025.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2244.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3025.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ", " ;
              result << enumerator_3025.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ",\n" ;
              index_3025_.increment () ;
      ...
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << " [" ;
      result << enumerator_2244.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (75)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_3346_ (0) ;
      if (enumerator_2244.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3346 (enumerator_2244.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3346.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << "_" ;
          result << enumerator_3346.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (77)).reader_string (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << ",\n" ;
          index_3346_.increment () ;
          enumerator_3346.gotoNextObject () ;
        }
      }
      result << "  NULL\n"
        "} ;\n"
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2244.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2244.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (107)).reader_string (SOURCE_FILE_AT_LINE (107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2244.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2244.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (115)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5525_ (0) ;
      if (enumerator_2244.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5525 (enumerator_2244.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5525.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5525.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << ",\n" ;
          index_5525_.increment () ;
      ...
      result << enumerator_2244.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (125)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5938_ (0) ;
      if (enumerator_2244.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5938 (enumerator_2244.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5938.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5938.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
          result << ",\n" ;
          index_5938_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)).isValid ()) {
    cEnumerator_extensionMap enumerator_6458 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_6458 = enumerator_6458.hasCurrentObject () ;
    if (nonEmpty_enumerator_6458) {
      result << "  if" ;
    }
    while (enumerator_6458.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_6458.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (144)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_6458.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
  ...
  result << "  return result ;\n"
    ...
    "  return [NSArray arrayWithObjects:\n" ;
  GALGAS_uint index_6836_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6836 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)), kEnumeration_up) ;
    while (enumerator_6836.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_6836.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
      index_6836_.increment () ;
...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  while (enumerator_5583.hasCurrentObject ()) {
    ...
    while (enumerator_6634.hasCurrentObject ()) {
      cEnumerator_terminalLabelListAST enumerator_6665 (enumerator_6634.current_mTerminalList (HERE), kEnumeration_up) ;
      while (enumerator_6665.hasCurrentObject ()) {
        const enumGalgasBool test_8 = var_terminalSymbolSet.reader_hasKey (enumerator_6665.current_mTerminal (HERE).reader_string (SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_not (SOURCE_FILE_AT_LINE (170)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_6665.current_mTerminal (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("the '$").operator_concat (enumerator_6665.current_mTerminal (HERE).reader_string (SOURCE_FILE_AT_LINE (172)) COMMA_SOURCE_FILE_AT_LINE (172)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (175)) COMMA_SOURCE_FILE_AT_LINE (171)) ;
        }
    ...
    cEnumerator_guiCompoundAttributeListAST enumerator_7085 (enumerator_5583.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7085.hasCurrentObject ()) {
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_7085.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (183)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_10) {
        GALGAS_location location_11 (enumerator_7085.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_textMacroList.addAssign_operation (enumerator_7085.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (186)), enumerator_7085.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }
    ...
    cEnumerator_guiSimpleAttributeListAST enumerator_7567 (enumerator_5583.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7567.hasCurrentObject ()) {
      const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_7567.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (196)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_12) {
        {
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7567.current_mValue (HERE), enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (197)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (197)), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
        }
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_12) {
        const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_7567.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (199)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_13) {
          const enumGalgasBool test_14 = var_hasTabViewTitle.boolEnum () ;
          if (kBoolTrue == test_14) {
            GALGAS_location location_15 (enumerator_7567.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_15, GALGAS_string ("the '").operator_concat (enumerator_7567.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
          }
          var_hasTabViewTitle = GALGAS_bool (true) ;
          var_tabViewTitle = enumerator_7567.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (204)) ;
        }else if (kBoolFalse == test_13) {
          const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_7567.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_16) {
            const enumGalgasBool test_17 = var_hasBlockComment.boolEnum () ;
            if (kBoolTrue == test_17) {
              GALGAS_location location_18 (enumerator_7567.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_18, GALGAS_string ("the '").operator_concat (enumerator_7567.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
            }
            var_hasBlockComment = GALGAS_bool (true) ;
            var_blockComment = enumerator_7567.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (210)) ;
          }else if (kBoolFalse == test_16) {
            GALGAS_location location_19 (enumerator_7567.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_19, GALGAS_string ("the '").operator_concat (enumerator_7567.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')") COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
          }
        }
      }
