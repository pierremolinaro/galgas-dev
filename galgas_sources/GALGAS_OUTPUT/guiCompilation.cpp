...
//                    september 22th, 2012, at 15h27'18"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (7)).isValid ()) {
    cEnumerator_stringlist enumerator_213 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (7)), kEnumeration_up) ;
    while (enumerator_213.hasCurrentObject ()) {
      result << "#import \"" ;
      result << enumerator_213.current_mValue (HERE).stringValue () ;
      result << ".h\"\n" ;
  ...
  GALGAS_uint index_962_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)).isValid ()) {
    cEnumerator_stringlist enumerator_962 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)), kEnumeration_up) ;
    while (enumerator_962.hasCurrentObject ()) {
      result << "    [NSArray arrayWithObjects:@\"" ;
      result << enumerator_962.current_mValue (HERE).stringValue () ;
      result << "\", [" ;
      result << enumerator_962.current_mValue (HERE).stringValue () ;
      result << " class], nil],\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)).isValid ()) {
    cEnumerator_stringlist enumerator_1610 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)), kEnumeration_up) ;
    while (enumerator_1610.hasCurrentObject ()) {
      result << "#import \"" ;
      result << enumerator_1610.current_mValue (HERE).stringValue () ;
      result << "-cocoa.m\"\n" ;
  ...
  GALGAS_uint index_1972_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)).isValid ()) {
    cEnumerator_stringlist enumerator_1972 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)), kEnumeration_up) ;
    while (enumerator_1972.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_1972.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << " (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;\n" ;
      index_1972_.increment () ;
      enumerator_1972.gotoNextObject () ;
    }
  }
  result << "}\n"
    "\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2244 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)), kEnumeration_up) ;
    while (enumerator_2244.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << enumerator_2244.current_mLexiqueClassName (HERE).stringValue () ;
      result << "\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        ...
        "//---------------------------------------------------------------------------*\n"
        "\n" ;
      GALGAS_uint index_2754_ (0) ;
      if (enumerator_2244.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_2754 (enumerator_2244.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_2754.hasCurrentObject ()) {
          result << "static const UInt16 gPopUpData_" ;
          result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "_" ;
          result << enumerator_2754.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << " [" ;
          result << enumerator_2754.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n" ;
          GALGAS_uint index_2930_ (0) ;
          if (enumerator_2754.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_lstringlist enumerator_2930 (enumerator_2754.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_2930.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2244.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_2930.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (69)).stringValue () ;
              result << ",\n" ;
              index_2930_.increment () ;
              enumerator_2930.gotoNextObject () ;
            }
          }
          result << "  0\n"
            "} ;\n"
            "\n" ;
          index_2754_.increment () ;
          enumerator_2754.gotoNextObject () ;
        }
      }
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (74)).stringValue () ;
      result << " [" ;
      result << enumerator_2244.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (74)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (SOURCE_FILE_AT_LINE (74)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_3221_ (0) ;
      if (enumerator_2244.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3221 (enumerator_2244.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3221.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (76)).stringValue () ;
          result << "_" ;
          result << enumerator_3221.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (76)).reader_string (SOURCE_FILE_AT_LINE (76)).stringValue () ;
          result << ",\n" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2244.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (98)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2244.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (102)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2244.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (106)).reader_string (SOURCE_FILE_AT_LINE (106)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2244.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (110)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2244.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (114)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (114)).reader_string (SOURCE_FILE_AT_LINE (114)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5400_ (0) ;
      if (enumerator_2244.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5400 (enumerator_2244.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5400.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5400.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (116)).stringValue () ;
          result << ",\n" ;
          index_5400_.increment () ;
      ...
      result << enumerator_2244.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (124)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).reader_string (SOURCE_FILE_AT_LINE (124)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5813_ (0) ;
      if (enumerator_2244.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5813 (enumerator_2244.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5813.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5813.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (126)).stringValue () ;
          result << ",\n" ;
          index_5813_.increment () ;
          enumerator_5813.gotoNextObject () ;
        }
      }
      result << "    NULL\n"
        "  } ;\n"
  ...
  GALGAS_uint index_6333_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (141)).isValid ()) {
    cEnumerator_extensionMap enumerator_6333 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (141)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_6333 = enumerator_6333.hasCurrentObject () ;
    if (nonEmpty_enumerator_6333) {
      result << "  if" ;
    }
    while (enumerator_6333.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_6333.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (143)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_6333.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
      if (enumerator_6333.hasNextObject ()) {
        result << "  }else if" ;
      }
      index_6333_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (155)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6711 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (155)), kEnumeration_up) ;
    while (enumerator_6711.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_6711.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_lstring var_componentName = constinArgument_inGuiComponentRoot.reader_mGUIName (SOURCE_FILE_AT_LINE (96)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_basename = constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (97)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (97)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (97)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_componentName.reader_string (SOURCE_FILE_AT_LINE (98)).objectCompare (var_basename)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_componentName.reader_string (SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)).operator_concat (GALGAS_string ("') against the source file base name ('") COMMA_SOURCE_FILE_AT_LINE (101)).operator_concat (var_basename COMMA_SOURCE_FILE_AT_LINE (101)).operator_concat (GALGAS_string ("'): they should be identical") COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_guiAnalysisContext var_context = GALGAS_guiAnalysisContext::constructor_new (GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (106)), GALGAS_guiCommandLineOptionList::constructor_emptyList (SOURCE_FILE_AT_LINE (107)), GALGAS_guiCommandLineOptionList::constructor_emptyList (SOURCE_FILE_AT_LINE (108)), GALGAS_guiCommandLineOptionList::constructor_emptyList (SOURCE_FILE_AT_LINE (109)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (110)), GALGAS_extensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (111)), GALGAS_importedLexiqueList::constructor_emptyList (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_4548 (constinArgument_inGuiComponentRoot.reader_mImportedOptionList (SOURCE_FILE_AT_LINE (115)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_4548.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_4548.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (116)).reader_pathExtension (SOURCE_FILE_AT_LINE (116)).objectCompare (GALGAS_string ("gOption"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_4548.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (117)) ;
    }else if (kBoolFalse == test_2) {
      { //-------- @routineCallInstructionForGeneration
      GALGAS_lstring joker_4956_4 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_4956_3 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_4956_2 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_4956_1 ; // Joker input parameter
      routine_parseOptionComponent (GALGAS_lstring::constructor_new (enumerator_4548.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (121)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (121)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)), enumerator_4548.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (120)), ioArgument_ioParsedComponentStruct, joker_4956_4, joker_4956_3, joker_4956_2, joker_4956_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_4548.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (127)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (127)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
    }
    enumerator_4548.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_guiSimpleAttributeListAST enumerator_5199 (constinArgument_inGuiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE_AT_LINE (131)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5199.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_5199.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).objectCompare (GALGAS_string ("nibAndMainClass"))).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @warningInstructionForGeneration
      GALGAS_location location_5 (enumerator_5199.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_5, GALGAS_string ("the '").operator_concat (enumerator_5199.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string ("' key is invalid and has no effect") COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)) ;
    }else if (kBoolFalse == test_4) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_5397 (enumerator_5199.current_mValue (HERE).mAttribute_string.reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (135)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_5397.hasCurrentObject ()) {
        //-------- @plusEqualnstructionForGeneration
        var_context.mAttribute_mNibAndClassList.addAssign_operation (enumerator_5397.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (136)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_withLexiqueListAST enumerator_5583 (constinArgument_inGuiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (141)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5583.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_lexiqueComponentAST var_lexiqueComponentRoot ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (144)).reader_pathExtension (SOURCE_FILE_AT_LINE (144)).objectCompare (GALGAS_string ("gLexique"))).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_7 (enumerator_5583.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (145)) ;
      var_lexiqueComponentRoot.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_6) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_lexiqueFullPathName = GALGAS_lstring::constructor_new (enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (148)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (148)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)), enumerator_5583.current_mLexiqueFileName (HERE).reader_location (SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      { //-------- @routineCallInstructionForGeneration
      routine_parseLexiqueComponent (var_lexiqueFullPathName, ioArgument_ioParsedComponentStruct, var_lexiqueComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) ;
      } //-------- @routineCallInstructionForGeneration
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_terminalSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (158)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalDeclarationListAST enumerator_6337 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (159)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6337.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_terminalSymbolSet.addAssign_operation (enumerator_6337.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
      enumerator_6337.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalListDeclarationListAST enumerator_6466 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (162)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6466.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lexicalListEntryListAST enumerator_6494 (enumerator_6466.current_mEntryList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6494.hasCurrentObject ()) {
        //-------- @plusEqualnstructionForGeneration
        var_terminalSymbolSet.addAssign_operation (enumerator_6494.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)) ;
        enumerator_6494.gotoNextObject () ;
      }
      enumerator_6466.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiLabelListAST enumerator_6634 (enumerator_5583.current_mLabels (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6634.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_6665 (enumerator_6634.current_mTerminalList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6665.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_8 = var_terminalSymbolSet.reader_hasKey (enumerator_6665.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_not (SOURCE_FILE_AT_LINE (170)).boolEnum () ;
        if (kBoolTrue == test_8) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_9 (enumerator_6665.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("the '$").operator_concat (enumerator_6665.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (172)) COMMA_SOURCE_FILE_AT_LINE (172)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (175)) COMMA_SOURCE_FILE_AT_LINE (171)) ;
        }
    ...
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_textMacroList var_textMacroList = GALGAS_textMacroList::constructor_emptyList (SOURCE_FILE_AT_LINE (181)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiCompoundAttributeListAST enumerator_7076 (enumerator_5583.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7076.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_7076.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (183)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_10) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_11 (enumerator_7076.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, GALGAS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (184)) ;
      }else if (kBoolFalse == test_10) {
        //-------- @plusEqualnstructionForGeneration
        var_textMacroList.addAssign_operation (enumerator_7076.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (186)), enumerator_7076.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiSimpleAttributeListAST enumerator_7558 (enumerator_5583.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7558.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_7558.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (196)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_12) {
        { //-------- @modifierCallInstructionForGeneration
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7558.current_mValue (HERE), enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (197)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (197)), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_12) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_7558.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (199)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_13) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_14 = var_hasTabViewTitle.boolEnum () ;
          if (kBoolTrue == test_14) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_15 (enumerator_7558.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_15, GALGAS_string ("the '").operator_concat (enumerator_7558.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
          }
          //-------- @assignmentInstructionForGeneration
          var_hasTabViewTitle = GALGAS_bool (true) ;
          //-------- @assignmentInstructionForGeneration
          var_tabViewTitle = enumerator_7558.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (204)) ;
        }else if (kBoolFalse == test_13) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_7558.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_16) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_17 = var_hasBlockComment.boolEnum () ;
            if (kBoolTrue == test_17) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_18 (enumerator_7558.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_18, GALGAS_string ("the '").operator_concat (enumerator_7558.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
            }
            //-------- @assignmentInstructionForGeneration
            var_hasBlockComment = GALGAS_bool (true) ;
            //-------- @assignmentInstructionForGeneration
            var_blockComment = enumerator_7558.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (210)) ;
          }else if (kBoolFalse == test_16) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_19 (enumerator_7558.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_19, GALGAS_string ("the '").operator_concat (enumerator_7558.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')") COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
          }
        }
      }
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_20 = var_hasAssociatedExtension.operator_not (SOURCE_FILE_AT_LINE (216)).boolEnum () ;
    if (kBoolTrue == test_20) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_21 (enumerator_5583.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_21, GALGAS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (217)) ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_22 = var_hasTabViewTitle.operator_not (SOURCE_FILE_AT_LINE (220)).boolEnum () ;
    if (kBoolTrue == test_22) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_23 (enumerator_5583.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_23, GALGAS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (221)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_5583.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (225)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (225)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (225)), var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_5583.current_mLabels (HERE) COMMA_SOURCE_FILE_AT_LINE (224)) ;
    enumerator_5583.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (233)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_24) {
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_componentName.reader_string (SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string (".m") COMMA_SOURCE_FILE_AT_LINE (236)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (inCompiler, var_context COMMA_SOURCE_FILE_AT_LINE (239))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
...
void routine_compileGuiComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_guiGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_guiComponentRoot COMMA_SOURCE_FILE_AT_LINE (256)) ;
  } //-------- END @grammarInstructionWithSourceFileForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_compileGuiComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectory, var_guiComponentRoot, ioArgument_ioParsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (258)) ;
  } //-------- @routineCallInstructionForGeneration
}
