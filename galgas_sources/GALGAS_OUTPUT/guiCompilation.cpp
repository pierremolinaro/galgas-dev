...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)).isValid ()) {
    cEnumerator_stringlist enumerator_924 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)), kEnumeration_up) ;
    while (enumerator_924.hasCurrentObject ()) {
      result << "    [NSArray arrayWithObjects:@\"" ;
      result << enumerator_924.current_mValue (HERE).stringValue () ;
      result << "\", [" ;
      result << enumerator_924.current_mValue (HERE).stringValue () ;
      result << " class], nil],\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)).isValid ()) {
    cEnumerator_stringlist enumerator_1595 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)), kEnumeration_up) ;
  ...
  GALGAS_uint index_1948_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)).isValid ()) {
    cEnumerator_stringlist enumerator_1948 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)), kEnumeration_up) ;
    while (enumerator_1948.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_1948.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << " (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;\n" ;
      index_1948_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2130 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)), kEnumeration_up) ;
    while (enumerator_2130.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << enumerator_2130.current_mLexiqueClassName (HERE).stringValue () ;
      result << "\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        "//                                                                           *\n"
        ...
        "//---------------------------------------------------------------------------*\n"
        "\n" ;
      GALGAS_uint index_2715_ (0) ;
      if (enumerator_2130.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_2715 (enumerator_2130.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_2715.hasCurrentObject ()) {
          result << "static const UInt16 gPopUpData_" ;
          result << enumerator_2130.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "_" ;
          result << enumerator_2715.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((PMUInt32) 2U).multiply_operation (enumerator_2715.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_2715.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
          result << ", // Leading character count to strip\n" ;
          GALGAS_uint index_3011_ (0) ;
          if (enumerator_2715.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_terminalLabelListAST enumerator_3011 (enumerator_2715.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_3011.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2130.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3011.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ", " ;
              result << enumerator_3011.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ",\n" ;
          ...
          result << "  0\n"
            "} ;\n"
            "\n" ;
          index_2715_.increment () ;
          enumerator_2715.gotoNextObject () ;
        }
      }
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2130.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << " [" ;
      result << enumerator_2130.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (75)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_3325_ (0) ;
      if (enumerator_2130.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3325 (enumerator_2130.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3325.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2130.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << "_" ;
          result << enumerator_3325.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (77)).reader_string (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << ",\n" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2130.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2130.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2130.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (107)).reader_string (SOURCE_FILE_AT_LINE (107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2130.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2130.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (115)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5512_ (0) ;
      if (enumerator_2130.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5512 (enumerator_2130.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5512.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5512.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << ",\n" ;
          index_5512_.increment () ;
      ...
      result << enumerator_2130.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (125)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5925_ (0) ;
      if (enumerator_2130.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5925 (enumerator_2130.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5925.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5925.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
          result << ",\n" ;
          index_5925_.increment () ;
  ...
  GALGAS_uint index_6422_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)).isValid ()) {
    cEnumerator_extensionMap enumerator_6422 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_6422 = enumerator_6422.hasCurrentObject () ;
    if (nonEmpty_enumerator_6422) {
      result << "  if" ;
    }
    while (enumerator_6422.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_6422.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (144)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_6422.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
      if (enumerator_6422.hasNextObject ()) {
        result << "  }else if" ;
      }
      index_6422_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6812 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)), kEnumeration_up) ;
    while (enumerator_6812.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_6812.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
