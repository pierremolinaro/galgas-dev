...
class cCollectionElement_nibAndClassList : public cCollectionElement {
  public : GALGAS_nibAndClassList_2E_element mObject ;
...
GALGAS_nibAndClassList_2E_element cEnumerator_nibAndClassList::current (LOCATION_ARGS) const {
...
GALGAS_nibAndClassList_2E_element::GALGAS_nibAndClassList_2E_element (void) :
mAttribute_mNibName (),
...
GALGAS_nibAndClassList_2E_element::GALGAS_nibAndClassList_2E_element (const GALGAS_string & inOperand0,
                                                                      const GALGAS_string & inOperand1) :
...
GALGAS_nibAndClassList_2E_element GALGAS_nibAndClassList_2E_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                      const GALGAS_string & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nibAndClassList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_nibAndClassList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nibAndClassList_2E_element::objectCompare (const GALGAS_nibAndClassList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_nibAndClassList_2E_element::isValid (void) const {
  return mAttribute_mNibName.isValid () && mAttribute_mClassName.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_nibAndClassList_2E_element::drop (void) {
...
void GALGAS_nibAndClassList_2E_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_string GALGAS_nibAndClassList_2E_element::reader_mNibName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNibName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_nibAndClassList_2E_element::reader_mClassName (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nibAndClassList_2E_element ("nibAndClassList.element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_nibAndClassList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_nibAndClassList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_nibAndClassList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_nibAndClassList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_nibAndClassList_2E_element GALGAS_nibAndClassList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_nibAndClassList_2E_element result ;
  const GALGAS_nibAndClassList_2E_element * p = (const GALGAS_nibAndClassList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nibAndClassList_2E_element *> (p)) {
      result = *p ;
    }else{
