...
//                    november 23th, 2010, at 13h30'33"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileGuiComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  while (enumerator_4750.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, enumerator_4750.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (123)).reader_pathExtension (SOURCE_FILE_AT_LINE (123)).objectCompare (GALGAS_string ("gOption"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_4750.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  while (enumerator_5399.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, enumerator_5399.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).objectCompare (GALGAS_string ("nibAndMainClass"))).isValidAndTrue ()) {
      //-------- @warningInstructionForGeneration
      GALGAS_location location_2 (enumerator_5399.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_2, GALGAS_string ("the '").operator_concat (enumerator_5399.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).operator_concat (GALGAS_string ("' key is invalid and has no effect") COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
    }else{
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      if (GALGAS_bool (kIsNotEqual, var_x.reader_length (SOURCE_FILE_AT_LINE (144)).objectCompare (GALGAS_uint ((PMUInt32) 2U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_5399.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  while (enumerator_6075.hasCurrentObject ()) {
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (158)).reader_pathExtension (SOURCE_FILE_AT_LINE (158)).objectCompare (GALGAS_string ("gLexique"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_6075.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    while (enumerator_7126.hasCurrentObject ()) {
      ...
      while (enumerator_7157.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        if (var_terminalSymbolSet.reader_hasKey (enumerator_7157.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)).operator_not (SOURCE_FILE_AT_LINE (184)).isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_7157.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '$").operator_concat (enumerator_7157.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }
    ...
    while (enumerator_7568.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsNotEqual, enumerator_7568.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).objectCompare (GALGAS_string ("textMacro"))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_6 (enumerator_7568.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    while (enumerator_8050.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (210)).objectCompare (GALGAS_string ("fileExtension"))).isValidAndTrue ()) {
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (213)).objectCompare (GALGAS_string ("title"))).isValidAndTrue ()) {
          //-------- @ifInstructionForGeneration
          if (var_hasTabViewTitle.isValidAndTrue ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_7 (enumerator_8050.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)) ;
          }
          //-------- @assignmentInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsEqual, enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (219)).objectCompare (GALGAS_string ("blockComment"))).isValidAndTrue ()) {
            //-------- @ifInstructionForGeneration
            if (var_hasBlockComment.isValidAndTrue ()) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_8 (enumerator_8050.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_8, GALGAS_string ("the '").operator_concat (enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
            }
            //-------- @assignmentInstructionForGeneration
    ...
    if (var_hasAssociatedExtension.operator_not (SOURCE_FILE_AT_LINE (230)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_10 (enumerator_6075.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (var_hasTabViewTitle.operator_not (SOURCE_FILE_AT_LINE (234)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_6075.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
