...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (4)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_99 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (4)), kEnumeration_up) ;
  ...
  GALGAS_uint index_198_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (7)).isValid ()) {
    cEnumerator_stringlist enumerator_198 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (7)), kEnumeration_up) ;
    while (enumerator_198.hasCurrentObject ()) {
      result << "#import \"" ;
      result << enumerator_198.current_mValue (HERE).stringValue () ;
      result << ".h\"\n" ;
      index_198_.increment () ;
      enumerator_198.gotoNextObject () ;
    }
  }
  result << "\n"
  ...
  GALGAS_uint index_936_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)).isValid ()) {
    cEnumerator_stringlist enumerator_936 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)).isValid ()) {
    cEnumerator_stringlist enumerator_1619 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)), kEnumeration_up) ;
    while (enumerator_1619.hasCurrentObject ()) {
      result << "#import \"" ;
      result << enumerator_1619.current_mValue (HERE).stringValue () ;
      result << "-cocoa.m\"\n" ;
  ...
  GALGAS_uint index_1974_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)).isValid ()) {
    cEnumerator_stringlist enumerator_1974 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)), kEnumeration_up) ;
    while (enumerator_1974.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_1974.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << " (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;\n" ;
      index_1974_.increment () ;
      enumerator_1974.gotoNextObject () ;
    }
  }
  result << "}\n"
    "\n" ;
  GALGAS_uint index_2156_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2156 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)), kEnumeration_up) ;
    while (enumerator_2156.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << enumerator_2156.current_mLexiqueClassName (HERE).stringValue () ;
      result << "\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        "//                                                                             *\n"
        ...
        "//-----------------------------------------------------------------------------*\n"
        "\n" ;
      GALGAS_uint index_2751_ (0) ;
      if (enumerator_2156.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_2751 (enumerator_2156.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_2751.hasCurrentObject ()) {
          result << "static const UInt16 gPopUpData_" ;
          result << enumerator_2156.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "_" ;
          result << enumerator_2751.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_2751.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_2751.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
          result << ", // Leading character count to strip\n" ;
          GALGAS_uint index_3047_ (0) ;
          if (enumerator_2751.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_terminalLabelListAST enumerator_3047 (enumerator_2751.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_3047.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2156.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3047.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ", " ;
              result << enumerator_3047.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ",\n" ;
          ...
          result << "  0\n"
            "} ;\n"
            "\n" ;
          index_2751_.increment () ;
          enumerator_2751.gotoNextObject () ;
        }
      }
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2156.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << " [" ;
      result << enumerator_2156.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (75)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_3361_ (0) ;
      if (enumerator_2156.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3361 (enumerator_2156.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3361.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2156.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << "_" ;
          result << enumerator_3361.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (77)).reader_string (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << ",\n" ;
          index_3361_.increment () ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2156.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2156.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2156.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (107)).reader_string (SOURCE_FILE_AT_LINE (107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2156.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2156.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (115)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5570_ (0) ;
      if (enumerator_2156.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5570 (enumerator_2156.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5570.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5570.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << ",\n" ;
          index_5570_.increment () ;
      ...
      result << enumerator_2156.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (125)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5985_ (0) ;
      if (enumerator_2156.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5985 (enumerator_2156.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5985.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5985.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
          result << ",\n" ;
  ...
  GALGAS_uint index_6486_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)).isValid ()) {
    cEnumerator_extensionMap enumerator_6486 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_6486 = enumerator_6486.hasCurrentObject () ;
    if (nonEmpty_enumerator_6486) {
      result << "  if" ;
    }
    while (enumerator_6486.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_6486.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (144)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_6486.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
      if (enumerator_6486.hasNextObject ()) {
        result << "  }else if" ;
      }
      index_6486_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6878 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)), kEnumeration_up) ;
    while (enumerator_6878.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_6878.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_componentName.reader_string (SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)).operator_concat (GALGAS_string ("') against the source file base name ('") COMMA_SOURCE_FILE_AT_LINE (100)).operator_concat (var_basename COMMA_SOURCE_FILE_AT_LINE (101)).operator_concat (GALGAS_string ("'): they should be identical") COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_4545 (constinArgument_inGuiComponentRoot.reader_mImportedOptionList (SOURCE_FILE_AT_LINE (115)), kEnumeration_up) ;
  while (enumerator_4545.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_4545.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (116)).reader_pathExtension (SOURCE_FILE_AT_LINE (116)).objectCompare (GALGAS_string ("gOption"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_4545.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      GALGAS_lstring joker_4955_4 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_4955_3 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_4955_2 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_4955_1 ; // Joker input parameter
      routine_parseOptionComponent (GALGAS_lstring::constructor_new (enumerator_4545.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (121)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (121)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)), enumerator_4545.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (120)), ioArgument_ioParsedComponentStruct, joker_4955_4, joker_4955_3, joker_4955_2, joker_4955_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
      }
      var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_4545.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (127)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (127)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
    }
    enumerator_4545.gotoNextObject () ;
  }
  cEnumerator_guiSimpleAttributeListAST enumerator_5196 (constinArgument_inGuiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE_AT_LINE (131)), kEnumeration_up) ;
  while (enumerator_5196.hasCurrentObject ()) {
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_5196.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).objectCompare (GALGAS_string ("nibAndMainClass"))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5196.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_5, GALGAS_string ("the '").operator_concat (enumerator_5196.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string ("' key is invalid and has no effect") COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)) ;
    }else if (kBoolFalse == test_4) {
      cEnumerator_stringlist enumerator_5394 (enumerator_5196.current_mValue (HERE).mAttribute_string.reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (135)), kEnumeration_up) ;
      while (enumerator_5394.hasCurrentObject ()) {
        var_context.mAttribute_mNibAndClassList.addAssign_operation (enumerator_5394.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (136)) ;
        enumerator_5394.gotoNextObject () ;
      }
    }
    enumerator_5196.gotoNextObject () ;
  }
  cEnumerator_withLexiqueListAST enumerator_5580 (constinArgument_inGuiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (141)), kEnumeration_up) ;
  while (enumerator_5580.hasCurrentObject ()) {
    GALGAS_lexiqueComponentAST var_lexiqueComponentRoot ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_5580.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (144)).reader_pathExtension (SOURCE_FILE_AT_LINE (144)).objectCompare (GALGAS_string ("gLexique"))).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_location location_7 (enumerator_5580.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_lstring var_lexiqueFullPathName = GALGAS_lstring::constructor_new (enumerator_5580.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (148)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (148)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)), enumerator_5580.current_mLexiqueFileName (HERE).reader_location (SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      {
    ...
    cEnumerator_terminalDeclarationListAST enumerator_6334 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (159)), kEnumeration_up) ;
    while (enumerator_6334.hasCurrentObject ()) {
      var_terminalSymbolSet.addAssign_operation (enumerator_6334.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
      enumerator_6334.gotoNextObject () ;
    }
    cEnumerator_lexicalListDeclarationListAST enumerator_6463 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (162)), kEnumeration_up) ;
    while (enumerator_6463.hasCurrentObject ()) {
      cEnumerator_lexicalListEntryListAST enumerator_6491 (enumerator_6463.current_mEntryList (HERE), kEnumeration_up) ;
      while (enumerator_6491.hasCurrentObject ()) {
        var_terminalSymbolSet.addAssign_operation (enumerator_6491.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)) ;
        enumerator_6491.gotoNextObject () ;
      }
      enumerator_6463.gotoNextObject () ;
    }
    cEnumerator_guiLabelListAST enumerator_6631 (enumerator_5580.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_6631.hasCurrentObject ()) {
      cEnumerator_terminalLabelListAST enumerator_6662 (enumerator_6631.current_mTerminalList (HERE), kEnumeration_up) ;
      while (enumerator_6662.hasCurrentObject ()) {
        const enumGalgasBool test_8 = var_terminalSymbolSet.reader_hasKey (enumerator_6662.current_mTerminal (HERE).reader_string (SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_not (SOURCE_FILE_AT_LINE (170)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_6662.current_mTerminal (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("the '$").operator_concat (enumerator_6662.current_mTerminal (HERE).reader_string (SOURCE_FILE_AT_LINE (171)) COMMA_SOURCE_FILE_AT_LINE (171)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (172)).operator_concat (enumerator_5580.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (171)) ;
        }
    ...
    cEnumerator_guiCompoundAttributeListAST enumerator_7082 (enumerator_5580.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7082.hasCurrentObject ()) {
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_7082.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (183)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_10) {
        GALGAS_location location_11 (enumerator_7082.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_textMacroList.addAssign_operation (enumerator_7082.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (186)), enumerator_7082.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }
    ...
    cEnumerator_guiSimpleAttributeListAST enumerator_7564 (enumerator_5580.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7564.hasCurrentObject ()) {
      const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_7564.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (196)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_12) {
        {
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7564.current_mValue (HERE), enumerator_5580.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (197)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (197)), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
        }
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_12) {
        const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_7564.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (199)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_13) {
          const enumGalgasBool test_14 = var_hasTabViewTitle.boolEnum () ;
          if (kBoolTrue == test_14) {
            GALGAS_location location_15 (enumerator_7564.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_15, GALGAS_string ("the '").operator_concat (enumerator_7564.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
          }
          var_hasTabViewTitle = GALGAS_bool (true) ;
          var_tabViewTitle = enumerator_7564.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (204)) ;
        }else if (kBoolFalse == test_13) {
          const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_7564.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_16) {
            const enumGalgasBool test_17 = var_hasBlockComment.boolEnum () ;
            if (kBoolTrue == test_17) {
              GALGAS_location location_18 (enumerator_7564.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_18, GALGAS_string ("the '").operator_concat (enumerator_7564.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
            }
            var_hasBlockComment = GALGAS_bool (true) ;
            var_blockComment = enumerator_7564.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (210)) ;
          }else if (kBoolFalse == test_16) {
            GALGAS_location location_19 (enumerator_7564.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_19, GALGAS_string ("the '").operator_concat (enumerator_7564.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')") COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
          }
        }
      }
    ...
    if (kBoolTrue == test_20) {
      GALGAS_location location_21 (enumerator_5580.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_22) {
      GALGAS_location location_23 (enumerator_5580.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_5580.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (225)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (225)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (225)), var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_5580.current_mLabels (HERE) COMMA_SOURCE_FILE_AT_LINE (224)) ;
    enumerator_5580.gotoNextObject () ;
  }
  const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (233)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
