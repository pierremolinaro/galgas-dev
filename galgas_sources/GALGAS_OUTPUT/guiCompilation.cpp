  ...
  if (isBuilt) {
    ...
    while (((operand_2390 = enumerator_2390.nextObject ()))) {
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << operand_2390->mBlockComment.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (104)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << operand_2390->mLexiqueClassName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (UInt32) textMacroCount {\n"
        "  return " ;
      result << operand_2390->mTextMacroList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (112)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << operand_2390->mTextMacroList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (116)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (116)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
      result << "] = {\n" ;
      GGS_textMacroList::cEnumerator enumerator_5426 (operand_2390->mTextMacroList, true) ;
      const GGS_textMacroList::cElement * operand_5426 = NULL ;
      while (((operand_5426 = enumerator_5426.nextObject ()))) {
        macroValidPointer (operand_5426) ;
        result << "    @" ;
        result << operand_5426->mKey.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (118)) ;
        result << ",\n" ;
      }
      result << "    NULL\n"
        "  } ;\n"
      ...
      result << operand_2390->mTextMacroList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (126)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (126)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      result << "] = {\n" ;
      GGS_textMacroList::cEnumerator enumerator_5841 (operand_2390->mTextMacroList, true) ;
      const GGS_textMacroList::cElement * operand_5841 = NULL ;
      while (((operand_5841 = enumerator_5841.nextObject ()))) {
        macroValidPointer (operand_5841) ;
        result << "    @" ;
        result << operand_5841->mContents.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
        result << ",\n" ;
      }
      result << "    NULL\n"
        "  } ;\n"
    ...
    GGS_extensionMap::cEnumerator enumerator_6371 (var_cas_GUI_CONTEXT.reader_mExtensionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (143)), true) ;
    const GGS_extensionMap::cElement * operand_6371 = NULL ;
    if (enumerator_6371.hasCurrentObject ()) {
      result << "  if" ;
      while (((operand_6371 = enumerator_6371.nextObject ()))) {
        macroValidPointer (operand_6371) ;
        result << " ([inExtension isEqualToString:@" ;
        result << operand_6371->mKey.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
        result << "]) {\n"
          "    result = [[[OC_Tokenizer_" ;
        result << operand_6371->mInfo.mLexiqueName ;
    ...
    result << "  return result ;\n"
      ...
      "  return [NSArray arrayWithObjects:\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_6795 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (157)), true) ;
    const GGS_importedLexiqueList::cElement * operand_6795 = NULL ;
    while (((operand_6795 = enumerator_6795.nextObject ()))) {
      macroValidPointer (operand_6795) ;
      result << "    [[[OC_Tokenizer_" ;
      result << operand_6795->mLexiqueClassName ;
      result << " alloc] init] autorelease],\n" ;
    }
    result << "    nil\n"
      "  ] ;\n"
...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (255))).operator_concat (GGS_string ("-2.m")), GGS_string ("//"), GGS_string ("\n"
