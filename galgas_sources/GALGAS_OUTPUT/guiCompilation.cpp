...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4706 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4706.isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_5116 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (127)), true) ;
    const GGS_lstringlist::cElement * operand_5116 = NULL ;
    while (((operand_5116 = enumerator_5116.nextObject ()))) {
      macroValidPointer (operand_5116) ;
      const GGS_bool cond_5312 = (operand_5116->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5312.isBuiltAndTrue ()) {
        operand_5116->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (130)) ;
      }else if (cond_5312.isBuiltAndFalse ()) {
        GGS_optionComponentRoot  automatic_var_5545_0 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_5116->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_5116->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_HERE),  var_cas_ioParsedComponentStruct,  automatic_var_5545_0 COMMA_SOURCE_FILE_AT_LINE (131)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_5116->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5720 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (143)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5720 = NULL ;
    while (((operand_5720 = enumerator_5720.nextObject ()))) {
      macroValidPointer (operand_5720) ;
      const GGS_bool cond_5994 = (operand_5720->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5994.isBuiltAndTrue ()) {
        operand_5720->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5720->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }else if (cond_5994.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5720->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6191 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6191.isBuiltAndTrue ()) {
          operand_5720->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (151)) ;
        }else if (cond_6191.isBuiltAndFalse ()) {
  ...
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6396 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (160)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6396 = NULL ;
    while (((operand_6396 = enumerator_6396.nextObject ()))) {
      macroValidPointer (operand_6396) ;
      GGS_lexiqueComponentAST  var_cas_lexiqueComponentRoot ;
      const GGS_bool cond_6691 = (operand_6396->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6691.isBuiltAndTrue ()) {
        operand_6396->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (165)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6691.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6396->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6396->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_HERE) ;
      ...
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_7112 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (178)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_7112 = NULL ;
        while (((operand_7112 = enumerator_7112.nextObject ()))) {
          macroValidPointer (operand_7112) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_7112->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7238 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7238 = NULL ;
        while (((operand_7238 = enumerator_7238.nextObject ()))) {
          macroValidPointer (operand_7238) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7315 (operand_7238->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7315 = NULL ;
            while (((operand_7315 = enumerator_7315.nextObject ()))) {
              macroValidPointer (operand_7315) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7315->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7455 (operand_6396->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7455 = NULL ;
        while (((operand_7455 = enumerator_7455.nextObject ()))) {
          macroValidPointer (operand_7455) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7486 (operand_7455->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7486 = NULL ;
            while (((operand_7486 = enumerator_7486.nextObject ()))) {
              macroValidPointer (operand_7486) ;
              const GGS_bool cond_7748 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7486->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)))).operator_not () ;
              if (cond_7748.isBuiltAndTrue ()) {
                operand_7486->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7486->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6396->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (196)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7897 (operand_6396->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7897 = NULL ;
        while (((operand_7897 = enumerator_7897.nextObject ()))) {
          macroValidPointer (operand_7897) ;
          const GGS_bool cond_8038 = (operand_7897->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_8038.isBuiltAndTrue ()) {
            operand_7897->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (204)) ;
          }else if (cond_8038.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7897->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), operand_7897->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8379 (operand_6396->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8379 = NULL ;
        while (((operand_8379 = enumerator_8379.nextObject ()))) {
          macroValidPointer (operand_8379) ;
          const GGS_bool cond_8606 = (operand_8379->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8606.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8379->mValue, operand_6396->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (216)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8606.isBuiltAndFalse ()) {
            const GGS_bool cond_8845 = (operand_8379->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8845.isBuiltAndTrue ()) {
              const GGS_bool cond_8752 = var_cas_hasTabViewTitle ;
              if (cond_8752.isBuiltAndTrue ()) {
                operand_8379->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8379->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (221)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8379->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
            }else if (cond_8845.isBuiltAndFalse ()) {
              const GGS_bool cond_9090 = (operand_8379->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_9090.isBuiltAndTrue ()) {
                const GGS_bool cond_8998 = var_cas_hasBlockComment ;
                if (cond_8998.isBuiltAndTrue ()) {
                  operand_8379->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8379->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (227)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8379->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
              }else if (cond_9090.isBuiltAndFalse ()) {
                operand_8379->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8379->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (232)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9435 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9435.isBuiltAndTrue ()) {
        operand_6396->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (237)) ;
      }
      const GGS_bool cond_9591 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9591.isBuiltAndTrue ()) {
        operand_6396->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (241)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6396->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6396->mLabels) ;
    }
  }
  const GGS_bool cond_10136 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10136.isBuiltAndTrue ()) {
