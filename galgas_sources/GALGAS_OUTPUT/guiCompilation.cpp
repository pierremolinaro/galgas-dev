...
template_filewrapper_guiGenerationTemplates_gui_implementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_2212 = enumerator_2212.nextObject ()))) {
      ...
      result << operand_2212->mValue.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (61)) ;
    ...
    while (((operand_2394 = enumerator_2394.nextObject ()))) {
      ...
      while (((operand_2979 = enumerator_2979.nextObject ()))) {
        ...
        result << operand_2394->mLexiqueClassName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
        result << "_" ;
        ...
        result << " [" ;
        result << operand_2979->mTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (74)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
        result << "] = {\n" ;
        ...
        while (((operand_3180 = enumerator_3180.nextObject ()))) {
          ...
          result << operand_2394->mLexiqueClassName ;
          result << "_1_" ;
          result << operand_3180->mValue.ggs_string ().reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
          result << ",\n" ;
        }
        result << "  0\n"
          "} ;\n"
      ...
      result << "static const UInt16 * gPopUpData_" ;
      result << operand_2394->mLexiqueClassName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
      result << " [" ;
      result << operand_2394->mLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (81)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (81)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
      result << "] = {\n" ;
      ...
      while (((operand_3464 = enumerator_3464.nextObject ()))) {
        ...
        result << "  gPopUpData_" ;
        result << operand_2394->mLexiqueClassName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
        result << "_" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << operand_2394->mBlockComment.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (105)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << operand_2394->mLexiqueClassName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (UInt32) textMacroCount {\n"
        "  return " ;
      result << operand_2394->mTextMacroList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (113)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (113)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << operand_2394->mTitle.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (117)) ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------*\n"
      ...
      result << operand_2394->mTextMacroList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (121)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121)) ;
      result << "] = {\n" ;
      ...
      while (((operand_5643 = enumerator_5643.nextObject ()))) {
        ...
        result << "    @" ;
        result << operand_5643->mKey.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (123)) ;
        result << ",\n" ;
      }
      result << "    NULL\n"
        "  } ;\n"
      ...
      result << operand_2394->mTextMacroList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (131)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (131)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
      result << "] = {\n" ;
      ...
      while (((operand_6056 = enumerator_6056.nextObject ()))) {
        ...
        result << "    @" ;
        result << operand_6056->mContents.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
        result << ",\n" ;
      }
      result << "    NULL\n"
        "  } ;\n"
    ...
    if (enumerator_6541.hasCurrentObject ()) {
      ...
      while (((operand_6541 = enumerator_6541.nextObject ()))) {
        ...
        result << operand_6541->mKey.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) ;
        result << "]) {\n"
...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (109)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
  ...
  GGS_guiAnalysisContext var_cas_context = GGS_guiAnalysisContext::constructor_new (GGS_stringlist ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_nibAndClassList ::constructor_emptyList (), GGS_extensionMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_importedLexiqueList ::constructor_emptyList ()) ;
  {
    ...
    while (((operand_5108 = enumerator_5108.nextObject ()))) {
      ...
      const GGS_bool cond_5304 = (operand_5108->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (128))).operator_isNotEqual (GGS_string ("gOption")) ;
  ...
  }
  {
    ...
    while (((operand_5712 = enumerator_5712.nextObject ()))) {
      ...
      if (cond_5986.isBuiltAndTrue ()) {
        ...
        GGS_stringlist  var_cas_x = operand_5712->mValue.ggs_string ().reader_componentsSeparatedByString (inLexique, GGS_string (".") COMMA_SOURCE_FILE_AT_LINE (148)) ;
        const GGS_bool cond_6183 = (var_cas_x.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (149))).operator_isNotEqual (GGS_uint (2U)) ;
  ...
  }
  {
    ...
    while (((operand_6388 = enumerator_6388.nextObject ()))) {
      ...
      const GGS_bool cond_6684 = (operand_6388->mLexiqueFileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_isNotEqual (GGS_string ("gLexique")) ;
        ...
        while (((operand_7448 = enumerator_7448.nextObject ()))) {
          macroValidPointer (operand_7448) ;
          {
            ...
            while (((operand_7479 = enumerator_7479.nextObject ()))) {
              ...
              const GGS_bool cond_7741 = (var_cas_terminalSymbolSet.reader_hasKey (inLexique, operand_7479->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189))).operator_not () ;
