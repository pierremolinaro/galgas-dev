...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (11)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_497 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (11)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (14)).isValid ()) {
    cEnumerator_nibAndClassList enumerator_596 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (14)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (33)).isValid ()) {
    cEnumerator_nibAndClassList enumerator_1349 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (33)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (50)).isValid ()) {
    cEnumerator_stringlist enumerator_2003 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (50)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (60)).isValid ()) {
    cEnumerator_stringlist enumerator_2365 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (60)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (65)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2637 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (65)), kEnumeration_up) ;
    while (enumerator_2637.hasCurrentObject ()) {
      ...
      if (enumerator_2637.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3147 (enumerator_2637.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3147.hasCurrentObject ()) {
          ...
          result << "_" ;
          result << enumerator_3147.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (SOURCE_FILE_AT_LINE (74)).stringValue () ;
          result << " [" ;
          ...
          if (enumerator_3147.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_lstringlist enumerator_3323 (enumerator_3147.current_mTerminalList (HERE), kEnumeration_up) ;
      ...
      if (enumerator_2637.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3614 (enumerator_2637.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3614.hasCurrentObject ()) {
          ...
          result << "_" ;
          result << enumerator_3614.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (83)).reader_string (SOURCE_FILE_AT_LINE (83)).stringValue () ;
          result << ",\n" ;
      ...
      if (enumerator_2637.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5785 (enumerator_2637.current_mTextMacroList (HERE), kEnumeration_up) ;
      ...
      if (enumerator_2637.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_6198 (enumerator_2637.current_mTextMacroList (HERE), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (148)).isValid ()) {
    cEnumerator_extensionMap enumerator_6718 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (148)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (162)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_7121 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (162)), kEnumeration_up) ;
...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_lstring var_componentName = constinArgument_inGuiComponentRoot.reader_mGUIName (SOURCE_FILE_AT_LINE (102)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_basename = constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (103)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (103)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (103)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_componentName.reader_string (SOURCE_FILE_AT_LINE (104)).objectCompare (var_basename)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_componentName.reader_string (SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106)).operator_concat (GALGAS_string ("') against the source file base name ('") COMMA_SOURCE_FILE_AT_LINE (107)).operator_concat (var_basename COMMA_SOURCE_FILE_AT_LINE (107)).operator_concat (GALGAS_string ("'): they should be identical") COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_guiAnalysisContext var_context = GALGAS_guiAnalysisContext::constructor_new (GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (112)), GALGAS_guiCommandLineOptionList::constructor_emptyList (SOURCE_FILE_AT_LINE (113)), GALGAS_guiCommandLineOptionList::constructor_emptyList (SOURCE_FILE_AT_LINE (114)), GALGAS_guiCommandLineOptionList::constructor_emptyList (SOURCE_FILE_AT_LINE (115)), GALGAS_nibAndClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (116)), GALGAS_extensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (117)), GALGAS_importedLexiqueList::constructor_emptyList (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_4706 (constinArgument_inGuiComponentRoot.reader_mImportedOptionList (SOURCE_FILE_AT_LINE (121)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_4706.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_4706.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (122)).reader_pathExtension (SOURCE_FILE_AT_LINE (122)).objectCompare (GALGAS_string ("gOption"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_4706.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (123)) ;
    }else if (kBoolFalse == test_2) {
      { //-------- @routineCallInstructionForGeneration
      GALGAS_lstring joker_5114_4 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5114_3 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5114_2 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5114_1 ; // Joker input parameter
      routine_parseOptionComponent (GALGAS_lstring::constructor_new (enumerator_4706.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (127)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (127)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)), enumerator_4706.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (128)) COMMA_SOURCE_FILE_AT_LINE (126)), ioArgument_ioParsedComponentStruct, joker_5114_4, joker_5114_3, joker_5114_2, joker_5114_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_4706.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (133)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (133)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)) ;
    }
    enumerator_4706.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_guiSimpleAttributeListAST enumerator_5357 (constinArgument_inGuiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE_AT_LINE (137)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5357.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_5357.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).objectCompare (GALGAS_string ("nibAndMainClass"))).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @warningInstructionForGeneration
      GALGAS_location location_5 (enumerator_5357.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_5, GALGAS_string ("the '").operator_concat (enumerator_5357.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (139)).operator_concat (GALGAS_string ("' key is invalid and has no effect") COMMA_SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (139)) ;
    }else if (kBoolFalse == test_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_stringlist var_x = enumerator_5357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (141)).reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (141)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_x.reader_length (SOURCE_FILE_AT_LINE (142)).objectCompare (GALGAS_uint ((PMUInt32) 2U))).boolEnum () ;
      if (kBoolTrue == test_6) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_7 (enumerator_5357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (143)) ;
      }else if (kBoolFalse == test_6) {
        //-------- @addAssignInstructionForGeneration
        var_context.mAttribute_mNibAndClassList.addAssign_operation (var_x.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (146)), var_x.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }
    }
    enumerator_5357.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_withLexiqueListAST enumerator_5939 (constinArgument_inGuiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (153)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5939.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_lexiqueComponentAST var_lexiqueComponentRoot ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_5939.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (156)).reader_pathExtension (SOURCE_FILE_AT_LINE (156)).objectCompare (GALGAS_string ("gLexique"))).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_9 (enumerator_5939.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (157)) ;
      var_lexiqueComponentRoot.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_8) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_lexiqueFullPathName = GALGAS_lstring::constructor_new (enumerator_5939.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (160)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)), enumerator_5939.current_mLexiqueFileName (HERE).reader_location (SOURCE_FILE_AT_LINE (161)) COMMA_SOURCE_FILE_AT_LINE (159)) ;
      { //-------- @routineCallInstructionForGeneration
      routine_parseLexiqueComponent (var_lexiqueFullPathName, ioArgument_ioParsedComponentStruct, var_lexiqueComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
      } //-------- @routineCallInstructionForGeneration
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_terminalSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (170)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalDeclarationListAST enumerator_6693 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (171)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6693.hasCurrentObject ()) {
      //-------- @addAssignInstructionForGeneration
      var_terminalSymbolSet.addAssign_operation (enumerator_6693.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (172)) COMMA_SOURCE_FILE_AT_LINE (172)) ;
      enumerator_6693.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalListDeclarationListAST enumerator_6822 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (174)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6822.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lexicalListEntryListAST enumerator_6850 (enumerator_6822.current_mEntryList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6850.hasCurrentObject ()) {
        //-------- @addAssignInstructionForGeneration
        var_terminalSymbolSet.addAssign_operation (enumerator_6850.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)) ;
        enumerator_6850.gotoNextObject () ;
      }
      enumerator_6822.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiLabelListAST enumerator_6990 (enumerator_5939.current_mLabels (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6990.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_7021 (enumerator_6990.current_mTerminalList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7021.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_10 = var_terminalSymbolSet.reader_hasKey (enumerator_7021.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_not (SOURCE_FILE_AT_LINE (182)).boolEnum () ;
        if (kBoolTrue == test_10) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_11 (enumerator_7021.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_11, GALGAS_string ("the '$").operator_concat (enumerator_7021.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_5939.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (183)) ;
        }
    ...
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_textMacroList var_textMacroList = GALGAS_textMacroList::constructor_emptyList (SOURCE_FILE_AT_LINE (193)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiCompoundAttributeListAST enumerator_7432 (enumerator_5939.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7432.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_7432.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (195)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_12) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_13 (enumerator_7432.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_13, GALGAS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (196)) ;
      }else if (kBoolFalse == test_12) {
        //-------- @addAssignInstructionForGeneration
        var_textMacroList.addAssign_operation (enumerator_7432.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (198)), enumerator_7432.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)) ;
      }
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiSimpleAttributeListAST enumerator_7914 (enumerator_5939.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7914.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (208)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_14) {
        { //-------- @modifierCallInstructionForGeneration
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7914.current_mValue (HERE), enumerator_5939.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (209)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (209)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (209)), inCompiler COMMA_SOURCE_FILE_AT_LINE (209)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_14) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (211)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_15) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_16 = var_hasTabViewTitle.boolEnum () ;
          if (kBoolTrue == test_16) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_17 (enumerator_7914.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_17, GALGAS_string ("the '").operator_concat (enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
          }
          //-------- @assignmentInstructionForGeneration
          var_hasTabViewTitle = GALGAS_bool (true) ;
          //-------- @assignmentInstructionForGeneration
          var_tabViewTitle = enumerator_7914.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (216)) ;
        }else if (kBoolFalse == test_15) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (217)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_18) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_19 = var_hasBlockComment.boolEnum () ;
            if (kBoolTrue == test_19) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_20 (enumerator_7914.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_20, GALGAS_string ("the '").operator_concat (enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)) ;
            }
            //-------- @assignmentInstructionForGeneration
            var_hasBlockComment = GALGAS_bool (true) ;
            //-------- @assignmentInstructionForGeneration
            var_blockComment = enumerator_7914.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (222)) ;
          }else if (kBoolFalse == test_18) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_21 (enumerator_7914.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_21, GALGAS_string ("the '").operator_concat (enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')") COMMA_SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (224)) ;
          }
        }
      }
      enumerator_7914.gotoNextObject () ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_22 = var_hasAssociatedExtension.operator_not (SOURCE_FILE_AT_LINE (228)).boolEnum () ;
    if (kBoolTrue == test_22) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_23 (enumerator_5939.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_23, GALGAS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (229)) ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_24 = var_hasTabViewTitle.operator_not (SOURCE_FILE_AT_LINE (232)).boolEnum () ;
    if (kBoolTrue == test_24) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_25 (enumerator_5939.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (233)) ;
    }
    //-------- @addAssignInstructionForGeneration
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_5939.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (237)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (237)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (237)), var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_5939.current_mLabels (HERE) COMMA_SOURCE_FILE_AT_LINE (236)) ;
    enumerator_5939.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_26) {
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_componentName.reader_string (SOURCE_FILE_AT_LINE (248)).operator_concat (GALGAS_string (".m") COMMA_SOURCE_FILE_AT_LINE (248)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), GALGAS_string (filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (inCompiler, var_context COMMA_SOURCE_FILE_AT_LINE (251))), GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE_AT_LINE (246)) ;
    } //-------- @routineCallInstructionForGeneration
  }
}
...
void routine_compileGuiComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_guiGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_guiComponentRoot COMMA_SOURCE_FILE_AT_LINE (268)) ;
  } //-------- END @grammarInstructionWithSourceFileForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_compileGuiComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectory, var_guiComponentRoot, ioArgument_ioParsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (270)) ;
  } //-------- @routineCallInstructionForGeneration
}
