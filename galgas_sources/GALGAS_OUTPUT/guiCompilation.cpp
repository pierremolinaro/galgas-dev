...
bool GGS_guiAnalysisContext::isBuilt (void) const {
  return mNibAndClassList.isBuilt ()
...
operator_isEqual (const GGS_guiAnalysisContext & inOperand) const {
  return mNibAndClassList.operator_isEqual (inOperand.mNibAndClassList)
...
operator_isNotEqual (const GGS_guiAnalysisContext & inOperand) const {
  return mNibAndClassList.operator_isNotEqual (inOperand.mNibAndClassList)
...
constructor_new (const GGS_nibAndClassList & argument_0,
                 const GGS_extensionMap & argument_1,
                 const GGS_importedLexiqueList & argument_2) {
  GGS_guiAnalysisContext result ;
  result.mNibAndClassList = argument_0 ;
  result.mExtensionMap = argument_1 ;
  result.mWithLexiqueList = argument_2 ;
  return result ;
}
  ...
  if (isBuilt) {
    ...
    if (enumerator_12943.hasCurrentObject ()) {
      ...
      while (((operand_12943 = enumerator_12943.nextObject ()))) {
        ...
        result << operand_12943->mKey.ggs_string ().reader_CStringConstantRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
        result << "]) {\n"
    ...
    result << "  return result ;\n"
      ...
      "  return [NSArray arrayWithObjects:\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_13364 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), true) ;
    const GGS_importedLexiqueList::cElement * operand_13364 = NULL ;
    while (((operand_13364 = enumerator_13364.nextObject ()))) {
      macroValidPointer (operand_13364) ;
      result << "    [[[OC_Tokenizer_" ;
      result << operand_13364->mLexiqueClassName ;
...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  var_cas_componentName = var_cas_guiComponentRoot.reader_mGUIName (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (94)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (95))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (97)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  GGS_guiAnalysisContext var_cas_context ;
  var_cas_context = GGS_guiAnalysisContext::constructor_new (GGS_nibAndClassList ::constructor_emptyList (), GGS_extensionMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_importedLexiqueList ::constructor_emptyList ()) ;
  {
    GGS_guiSimpleAttributeList::cEnumerator enumerator_4428 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (108)), true) ;
    const GGS_guiSimpleAttributeList::cElement * operand_4428 = NULL ;
    while (((operand_4428 = enumerator_4428.nextObject ()))) {
      macroValidPointer (operand_4428) ;
      if (((operand_4428->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (109))).operator_isNotEqual (GGS_string ("nibAndMainClass"))).isBuiltAndTrue ()) {
        operand_4428->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_4428->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (110)) ;
      }else{
        GGS_stringlist  var_cas_x ;
        var_cas_x = operand_4428->mValue.ggs_string ().reader_componentsSeparatedByString (inLexique, GGS_string (".") COMMA_SOURCE_FILE_AT_LINE (113)) ;
        if (((var_cas_x.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (114))).operator_isNotEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
          operand_4428->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (116)) ;
        }else{
          var_cas_context.mNibAndClassList._addAssign_operation (var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (118)), var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (119))) ;
        }
      }
    }
  }
  {
    GGS_withLexiqueList::cEnumerator enumerator_5104 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (125)), true) ;
    const GGS_withLexiqueList::cElement * operand_5104 = NULL ;
    while (((operand_5104 = enumerator_5104.nextObject ()))) {
      macroValidPointer (operand_5104) ;
      GGS_lexiqueComponentRoot  var_cas_lexiqueComponentRoot ;
      if (((operand_5104->mLexiqueFileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (128))).operator_isNotEqual (GGS_string ("gLexique"))).isBuiltAndTrue ()) {
        operand_5104->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (130)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else{
        GGS_lstring  var_cas_lexiqueFullPathName ;
        var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_5104->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)), operand_5104->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_HERE) ;
        ::routine_parseLexiqueComponent (inLexique,  var_cas_lexiqueFullPathName,  var_cas_ioParsedComponentStruct,  var_cas_lexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (135)) ;
      }
      GGS_textMacroList  var_cas_textMacroList ;
      var_cas_textMacroList = GGS_textMacroList ::constructor_emptyList () ;
      {
        GGS_guiCompoundAttributeList::cEnumerator enumerator_5834 (operand_5104->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeList::cElement * operand_5834 = NULL ;
        while (((operand_5834 = enumerator_5834.nextObject ()))) {
          macroValidPointer (operand_5834) ;
          if (((operand_5834->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144))).operator_isNotEqual (GGS_string ("textMacro"))).isBuiltAndTrue ()) {
            operand_5834->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (146)) ;
          }else{
            var_cas_textMacroList._addAssign_operation (operand_5834->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (147)), operand_5834->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (147))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeList::cEnumerator enumerator_6316 (operand_5104->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeList::cElement * operand_6316 = NULL ;
        while (((operand_6316 = enumerator_6316.nextObject ()))) {
          macroValidPointer (operand_6316) ;
          if (((operand_6316->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (157))).operator_isEqual (GGS_string ("fileExtension"))).isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_6316->mValue, operand_5104->mLexiqueFileName.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (158)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (((operand_6316->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160))).operator_isEqual (GGS_string ("title"))).isBuiltAndTrue ()) {
            if ((var_cas_hasTabViewTitle).isBuiltAndTrue ()) {
              operand_6316->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_6316->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (163)) ;
            }
            var_cas_hasTabViewTitle = GGS_bool (true) ;
            var_cas_tabViewTitle = operand_6316->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
          }else if (((operand_6316->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166))).operator_isEqual (GGS_string ("blockComment"))).isBuiltAndTrue ()) {
            if ((var_cas_hasBlockComment).isBuiltAndTrue ()) {
              operand_6316->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_6316->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (169)) ;
            }
            var_cas_hasBlockComment = GGS_bool (true) ;
            var_cas_blockComment = operand_6316->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (171)) ;
          }else{
            operand_6316->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_6316->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (174)) ;
          }
        }
      }
      if (((var_cas_hasAssociatedExtension).operator_not ()).isBuiltAndTrue ()) {
        operand_5104->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (179)) ;
      }
      if (((var_cas_hasTabViewTitle).operator_not ()).isBuiltAndTrue ()) {
        operand_5104->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (183)) ;
      }
      var_cas_context.mWithLexiqueList._addAssign_operation (operand_5104->mLexiqueFileName.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (186)), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196))).operator_concat (GGS_string ("-2.mm")), GGS_string ("//"), GGS_string ("\n"
