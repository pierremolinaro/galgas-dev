...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_4539 (constinArgument_inGuiComponentRoot.reader_mImportedOptionList (SOURCE_FILE_AT_LINE (115)), kEnumeration_up) ;
  while (enumerator_4539.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_4539.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (116)).reader_pathExtension (SOURCE_FILE_AT_LINE (116)).objectCompare (GALGAS_string ("gOption"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      routine_parseOptionComponent (GALGAS_lstring::constructor_new (enumerator_4539.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (121)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (121)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)), enumerator_4539.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (120)), ioArgument_ioParsedComponentStruct, joker_4949_4, joker_4949_3, joker_4949_2, joker_4949_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
      }
      var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_4539.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (127)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (127)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
    }
    enumerator_4539.gotoNextObject () ;
  }
  cEnumerator_guiSimpleAttributeListAST enumerator_5190 (constinArgument_inGuiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE_AT_LINE (131)), kEnumeration_up) ;
  while (enumerator_5190.hasCurrentObject ()) {
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_5190.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (132)).objectCompare (GALGAS_string ("nibAndMainClass"))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5190.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_5, GALGAS_string ("the '").operator_concat (enumerator_5190.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string ("' key is invalid and has no effect") COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)) ;
    }else if (kBoolFalse == test_4) {
      cEnumerator_stringlist enumerator_5388 (enumerator_5190.current_mValue (HERE).mAttribute_string.reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (135)), kEnumeration_up) ;
      while (enumerator_5388.hasCurrentObject ()) {
        var_context.mAttribute_mNibAndClassList.addAssign_operation (enumerator_5388.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (136)) ;
        enumerator_5388.gotoNextObject () ;
      }
    }
    enumerator_5190.gotoNextObject () ;
  }
  cEnumerator_withLexiqueListAST enumerator_5574 (constinArgument_inGuiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (141)), kEnumeration_up) ;
  while (enumerator_5574.hasCurrentObject ()) {
    GALGAS_lexiqueComponentAST var_lexiqueComponentRoot ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_5574.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (144)).reader_pathExtension (SOURCE_FILE_AT_LINE (144)).objectCompare (GALGAS_string ("gLexique"))).boolEnum () ;
    if (kBoolTrue == test_6) {
      ...
      GALGAS_lstring var_lexiqueFullPathName = GALGAS_lstring::constructor_new (enumerator_5574.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (148)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (148)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)), enumerator_5574.current_mLexiqueFileName (HERE).reader_location (SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      {
    ...
    cEnumerator_terminalDeclarationListAST enumerator_6328 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (159)), kEnumeration_up) ;
    while (enumerator_6328.hasCurrentObject ()) {
      var_terminalSymbolSet.addAssign_operation (enumerator_6328.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
      enumerator_6328.gotoNextObject () ;
    }
    cEnumerator_lexicalListDeclarationListAST enumerator_6457 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (162)), kEnumeration_up) ;
    while (enumerator_6457.hasCurrentObject ()) {
      cEnumerator_lexicalListEntryListAST enumerator_6485 (enumerator_6457.current_mEntryList (HERE), kEnumeration_up) ;
      while (enumerator_6485.hasCurrentObject ()) {
        var_terminalSymbolSet.addAssign_operation (enumerator_6485.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)) ;
        enumerator_6485.gotoNextObject () ;
      }
      enumerator_6457.gotoNextObject () ;
    }
    cEnumerator_guiLabelListAST enumerator_6625 (enumerator_5574.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_6625.hasCurrentObject ()) {
      cEnumerator_terminalLabelListAST enumerator_6656 (enumerator_6625.current_mTerminalList (HERE), kEnumeration_up) ;
      while (enumerator_6656.hasCurrentObject ()) {
        const enumGalgasBool test_8 = var_terminalSymbolSet.reader_hasKey (enumerator_6656.current_mTerminal (HERE).reader_string (SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_not (SOURCE_FILE_AT_LINE (170)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_6656.current_mTerminal (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("the '$").operator_concat (enumerator_6656.current_mTerminal (HERE).reader_string (SOURCE_FILE_AT_LINE (171)) COMMA_SOURCE_FILE_AT_LINE (171)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (172)).operator_concat (enumerator_5574.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (171)) ;
        }
    ...
    cEnumerator_guiCompoundAttributeListAST enumerator_7076 (enumerator_5574.current_mCompoundAttributes (HERE), kEnumeration_up) ;
    ...
    cEnumerator_guiSimpleAttributeListAST enumerator_7558 (enumerator_5574.current_mSimpleAttributes (HERE), kEnumeration_up) ;
    while (enumerator_7558.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_12) {
        {
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7558.current_mValue (HERE), enumerator_5574.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (197)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (197)), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
        }
    ...
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_5574.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (225)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (225)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (225)), var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_5574.current_mLabels (HERE) COMMA_SOURCE_FILE_AT_LINE (224)) ;
...
void routine_compileGuiComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_guiGrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_9811, constinArgument_inSourceFile, var_guiComponentRoot COMMA_SOURCE_FILE_AT_LINE (256)) ;
  {
