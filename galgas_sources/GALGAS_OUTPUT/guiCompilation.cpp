...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4626 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4626.isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_5036 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (129)), true) ;
    const GGS_lstringlist::cElement * operand_5036 = NULL ;
    while (((operand_5036 = enumerator_5036.nextObject ()))) {
      macroValidPointer (operand_5036) ;
      const GGS_bool cond_5232 = (operand_5036->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5232.isBuiltAndTrue ()) {
        operand_5036->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (132)) ;
      }else if (cond_5232.isBuiltAndFalse ()) {
        GGS_optionComponentAST  automatic_var_5465_0 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_5036->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_5036->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_HERE),  var_cas_ioParsedComponentStruct,  automatic_var_5465_0 COMMA_SOURCE_FILE_AT_LINE (133)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_5036->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5640 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (145)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5640 = NULL ;
    while (((operand_5640 = enumerator_5640.nextObject ()))) {
      macroValidPointer (operand_5640) ;
      const GGS_bool cond_5914 = (operand_5640->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (146))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5914.isBuiltAndTrue ()) {
        operand_5640->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5640->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      }else if (cond_5914.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5640->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6111 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6111.isBuiltAndTrue ()) {
          operand_5640->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (153)) ;
        }else if (cond_6111.isBuiltAndFalse ()) {
  ...
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6316 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (162)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6316 = NULL ;
    while (((operand_6316 = enumerator_6316.nextObject ()))) {
      ...
      const GGS_bool cond_6611 = (operand_6316->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6611.isBuiltAndTrue ()) {
        operand_6316->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (167)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6611.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6316->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6316->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_HERE) ;
      ...
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_7032 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (180)), true) ;
        ...
        while (((operand_7032 = enumerator_7032.nextObject ()))) {
          ...
          var_cas_terminalSymbolSet.addAssign_operation (operand_7032->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7158 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (183)), true) ;
        ...
        while (((operand_7158 = enumerator_7158.nextObject ()))) {
          macroValidPointer (operand_7158) ;
          {
            ...
            while (((operand_7235 = enumerator_7235.nextObject ()))) {
              ...
              var_cas_terminalSymbolSet.addAssign_operation (operand_7235->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7375 (operand_6316->mLabels, true) ;
        ...
        while (((operand_7375 = enumerator_7375.nextObject ()))) {
          macroValidPointer (operand_7375) ;
          {
            ...
            while (((operand_7406 = enumerator_7406.nextObject ()))) {
              ...
              const GGS_bool cond_7668 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7406->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)))).operator_not () ;
              if (cond_7668.isBuiltAndTrue ()) {
                operand_7406->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7406->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6316->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7817 (operand_6316->mCompoundAttributes, true) ;
        ...
        while (((operand_7817 = enumerator_7817.nextObject ()))) {
          ...
          const GGS_bool cond_7958 = (operand_7817->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (204))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7958.isBuiltAndTrue ()) {
            operand_7817->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (206)) ;
          }else if (cond_7958.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7817->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)), operand_7817->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8299 (operand_6316->mSimpleAttributes, true) ;
        ...
        while (((operand_8299 = enumerator_8299.nextObject ()))) {
          ...
          const GGS_bool cond_8526 = (operand_8299->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8526.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8299->mValue, operand_6316->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (218)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8526.isBuiltAndFalse ()) {
            const GGS_bool cond_8765 = (operand_8299->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8765.isBuiltAndTrue ()) {
              const GGS_bool cond_8672 = var_cas_hasTabViewTitle ;
              if (cond_8672.isBuiltAndTrue ()) {
                operand_8299->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8299->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (223)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8299->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
            }else if (cond_8765.isBuiltAndFalse ()) {
              const GGS_bool cond_9010 = (operand_8299->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (226))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_9010.isBuiltAndTrue ()) {
                const GGS_bool cond_8918 = var_cas_hasBlockComment ;
                if (cond_8918.isBuiltAndTrue ()) {
                  operand_8299->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8299->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (229)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8299->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
              }else if (cond_9010.isBuiltAndFalse ()) {
                operand_8299->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8299->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (234)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9355 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9355.isBuiltAndTrue ()) {
        operand_6316->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (239)) ;
      }
      const GGS_bool cond_9511 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9511.isBuiltAndTrue ()) {
        operand_6316->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (243)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6316->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6316->mLabels) ;
    }
  }
  const GGS_bool cond_10056 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10056.isBuiltAndTrue ()) {
