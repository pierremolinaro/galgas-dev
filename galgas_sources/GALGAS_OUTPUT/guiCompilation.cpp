...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (7)).isValid ()) {
    cEnumerator_stringlist enumerator_190 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (7)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)).isValid ()) {
    cEnumerator_stringlist enumerator_920 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)), kEnumeration_up) ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)).isValid ()) {
    cEnumerator_stringlist enumerator_1942 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)), kEnumeration_up) ;
    while (enumerator_1942.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_1942.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2116 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)), kEnumeration_up) ;
    while (enumerator_2116.hasCurrentObject ()) {
      ...
      if (enumerator_2116.current_mLabels (HERE).isValid ()) {
        ...
        while (enumerator_2711.hasCurrentObject ()) {
          ...
          result << enumerator_2116.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "_" ;
          result << enumerator_2711.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_2711.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_2711.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
          ...
          if (enumerator_2711.current_mTerminalList (HERE).isValid ()) {
            ...
            while (enumerator_3007.hasCurrentObject ()) {
              ...
              result << enumerator_2116.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3007.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ", " ;
              result << enumerator_3007.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ",\n" ;
      ...
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2116.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << " [" ;
      result << enumerator_2116.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (75)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << "] = {\n" ;
      ...
      if (enumerator_2116.current_mLabels (HERE).isValid ()) {
        ...
        while (enumerator_3305.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2116.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << "_" ;
          result << enumerator_3305.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (77)).reader_string (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << ",\n" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2116.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2116.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2116.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (107)).reader_string (SOURCE_FILE_AT_LINE (107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2116.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2116.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (115)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
      result << "] = {\n" ;
      ...
      if (enumerator_2116.current_mTextMacroList (HERE).isValid ()) {
        ...
        while (enumerator_5506.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5506.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << ",\n" ;
      ...
      result << enumerator_2116.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (125)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
      result << "] = {\n" ;
      ...
      if (enumerator_2116.current_mTextMacroList (HERE).isValid ()) {
        ...
        while (enumerator_5913.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5913.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
          result << ",\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)).isValid ()) {
    cEnumerator_extensionMap enumerator_6398 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)), kEnumeration_up) ;
    ...
    while (enumerator_6398.hasCurrentObject ()) {
      ...
      result << enumerator_6398.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (144)).stringValue () ;
      result << "]) {\n"
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6782 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)), kEnumeration_up) ;
...
void routine_compileGuiComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  C_String syntaxDirectedTranslationResult_9817 ;
  cGrammar_guiGrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_9817, constinArgument_inSourceFile, var_guiComponentRoot COMMA_SOURCE_FILE_AT_LINE (256)) ;
  {
