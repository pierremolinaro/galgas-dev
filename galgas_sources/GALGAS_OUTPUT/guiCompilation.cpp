...
bool GGS_guiAnalysisContext::isBuilt (void) const {
  return mBoolOptionList.isBuilt ()
...
operator_isEqual (const GGS_guiAnalysisContext & inOperand) const {
  return mBoolOptionList.operator_isEqual (inOperand.mBoolOptionList)
...
operator_isNotEqual (const GGS_guiAnalysisContext & inOperand) const {
  return mBoolOptionList.operator_isNotEqual (inOperand.mBoolOptionList)
...
constructor_new (const GGS_guiCommandLineOptionList & argument_0,
                 const GGS_guiCommandLineOptionList & argument_1,
                 const GGS_guiCommandLineOptionList & argument_2,
                 const GGS_nibAndClassList & argument_3,
                 const GGS_extensionMap & argument_4,
                 const GGS_importedLexiqueList & argument_5) {
  GGS_guiAnalysisContext result ;
  result.mBoolOptionList = argument_0 ;
  result.mUIntOptionList = argument_1 ;
  result.mStringOptionList = argument_2 ;
  result.mNibAndClassList = argument_3 ;
  result.mExtensionMap = argument_4 ;
  result.mWithLexiqueList = argument_5 ;
  return result ;
}
...
template_filewrapper_guiGenerationTemplates_gui_implementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_extensionMap::cEnumerator enumerator_12943 (var_cas_GUI_CONTEXT.reader_mExtensionMap (inLexique COMMA_SOURCE_FILE_AT_LINE (532)), true) ;
    const GGS_extensionMap::cElement * operand_12943 = NULL ;
    if (enumerator_12943.hasCurrentObject ()) {
      result << "  if" ;
      while (((operand_12943 = enumerator_12943.nextObject ()))) {
        macroValidPointer (operand_12943) ;
        result << " ([inExtension isEqualToString:@" ;
        result << operand_12943->mKey.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
        result << "]) {\n"
          "    result = [[OC_Tokenizer_" ;
        result << operand_12943->mInfo.mLexiqueName ;
        result << " alloc] init] ;\n" ;
    ...
    result << "  return result ;\n"
      ...
      "  return [NSArray arrayWithObjects:\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_13353 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), true) ;
    const GGS_importedLexiqueList::cElement * operand_13353 = NULL ;
    while (((operand_13353 = enumerator_13353.nextObject ()))) {
      macroValidPointer (operand_13353) ;
      result << "    [[[OC_Tokenizer_" ;
      result << operand_13353->mLexiqueClassName ;
...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  var_cas_componentName = var_cas_guiComponentRoot.reader_mGUIName (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (113)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (113)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (114))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  GGS_guiAnalysisContext var_cas_context ;
  var_cas_context = GGS_guiAnalysisContext::constructor_new (GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_nibAndClassList ::constructor_emptyList (), GGS_extensionMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_importedLexiqueList ::constructor_emptyList ()) ;
  {
    GGS_guiSimpleAttributeList::cEnumerator enumerator_5220 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (134)), true) ;
    const GGS_guiSimpleAttributeList::cElement * operand_5220 = NULL ;
    while (((operand_5220 = enumerator_5220.nextObject ()))) {
      macroValidPointer (operand_5220) ;
      if (((operand_5220->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (135))).operator_isNotEqual (GGS_string ("nibAndMainClass"))).isBuiltAndTrue ()) {
        operand_5220->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5220->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (136)) ;
      }else{
        GGS_stringlist  var_cas_x ;
        var_cas_x = operand_5220->mValue.ggs_string ().reader_componentsSeparatedByString (inLexique, GGS_string (".") COMMA_SOURCE_FILE_AT_LINE (139)) ;
        if (((var_cas_x.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (140))).operator_isNotEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
          operand_5220->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (142)) ;
        }else{
          var_cas_context.mNibAndClassList._addAssign_operation (var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (144)), var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (145))) ;
        }
      }
    }
  }
  {
    GGS_withLexiqueList::cEnumerator enumerator_5896 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (151)), true) ;
    const GGS_withLexiqueList::cElement * operand_5896 = NULL ;
    while (((operand_5896 = enumerator_5896.nextObject ()))) {
      macroValidPointer (operand_5896) ;
      GGS_lexiqueComponentRoot  var_cas_lexiqueComponentRoot ;
      if (((operand_5896->mLexiqueFileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (154))).operator_isNotEqual (GGS_string ("gLexique"))).isBuiltAndTrue ()) {
        operand_5896->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (156)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else{
        GGS_lstring  var_cas_lexiqueFullPathName ;
        var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_5896->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)), operand_5896->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_HERE) ;
        ::routine_parseLexiqueComponent (inLexique,  var_cas_lexiqueFullPathName,  var_cas_ioParsedComponentStruct,  var_cas_lexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (161)) ;
      }
      GGS_textMacroList  var_cas_textMacroList ;
      var_cas_textMacroList = GGS_textMacroList ::constructor_emptyList () ;
      {
        GGS_guiCompoundAttributeList::cEnumerator enumerator_6626 (operand_5896->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeList::cElement * operand_6626 = NULL ;
        while (((operand_6626 = enumerator_6626.nextObject ()))) {
          macroValidPointer (operand_6626) ;
          if (((operand_6626->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170))).operator_isNotEqual (GGS_string ("textMacro"))).isBuiltAndTrue ()) {
            operand_6626->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (172)) ;
          }else{
            var_cas_textMacroList._addAssign_operation (operand_6626->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (173)), operand_6626->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (173))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeList::cEnumerator enumerator_7108 (operand_5896->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeList::cElement * operand_7108 = NULL ;
        while (((operand_7108 = enumerator_7108.nextObject ()))) {
          macroValidPointer (operand_7108) ;
          if (((operand_7108->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183))).operator_isEqual (GGS_string ("fileExtension"))).isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_7108->mValue, operand_5896->mLexiqueFileName.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (184)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (((operand_7108->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_isEqual (GGS_string ("title"))).isBuiltAndTrue ()) {
            if ((var_cas_hasTabViewTitle).isBuiltAndTrue ()) {
              operand_7108->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_7108->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (189)) ;
            }
            var_cas_hasTabViewTitle = GGS_bool (true) ;
            var_cas_tabViewTitle = operand_7108->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
          }else if (((operand_7108->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192))).operator_isEqual (GGS_string ("blockComment"))).isBuiltAndTrue ()) {
            if ((var_cas_hasBlockComment).isBuiltAndTrue ()) {
              operand_7108->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_7108->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (195)) ;
            }
            var_cas_hasBlockComment = GGS_bool (true) ;
            var_cas_blockComment = operand_7108->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
          }else{
            operand_7108->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_7108->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (200)) ;
          }
        }
      }
      if (((var_cas_hasAssociatedExtension).operator_not ()).isBuiltAndTrue ()) {
        operand_5896->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (205)) ;
      }
      if (((var_cas_hasTabViewTitle).operator_not ()).isBuiltAndTrue ()) {
        operand_5896->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (209)) ;
      }
      var_cas_context.mWithLexiqueList._addAssign_operation (operand_5896->mLexiqueFileName.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (212)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (212)), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_concat (GGS_string ("-2.mm")), GGS_string ("//"), GGS_string ("\n"
