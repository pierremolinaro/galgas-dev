...
template_filewrapper_guiGenerationTemplates_gui_implementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "  return result ;\n"
      ...
      "  return [NSArray arrayWithObjects:\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_7094 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (162)), true) ;
    const GGS_importedLexiqueList::cElement * operand_7094 = NULL ;
    while (((operand_7094 = enumerator_7094.nextObject ()))) {
      macroValidPointer (operand_7094) ;
      result << "    [[[OC_Tokenizer_" ;
      result << operand_7094->mLexiqueClassName ;
      result << " alloc] init] autorelease],\n" ;
    }
    result << "    nil\n"
      "  ] ;\n"
