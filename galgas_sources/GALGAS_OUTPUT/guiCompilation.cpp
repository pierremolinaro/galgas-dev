  ...
  if (isBuilt) {
    ...
    while (((operand_2394 = enumerator_2394.nextObject ()))) {
      ...
      result << "\n"
        ...
        "//---------------------------------------------------------------------------*\n"
        "\n" ;
      GGS_guiLabelListAST::cEnumerator enumerator_2979 (operand_2394->mLabels, true) ;
      const GGS_guiLabelListAST::cElement * operand_2979 = NULL ;
      ...
      result << "] = {\n" ;
      GGS_guiLabelListAST::cEnumerator enumerator_3464 (operand_2394->mLabels, true) ;
      const GGS_guiLabelListAST::cElement * operand_3464 = NULL ;
...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_componentName = var_cas_guiComponentRoot.reader_mGUIName (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  ...
  const GGS_bool cond_4630 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4630.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (114)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_5040 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (129)), true) ;
    const GGS_lstringlist::cElement * operand_5040 = NULL ;
    while (((operand_5040 = enumerator_5040.nextObject ()))) {
      macroValidPointer (operand_5040) ;
      const GGS_bool cond_5236 = (operand_5040->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5236.isBuiltAndTrue ()) {
        operand_5040->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (132)) ;
      }else if (cond_5236.isBuiltAndFalse ()) {
        GGS_optionComponentAST  automatic_var_5469_0 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_5040->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_5040->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_HERE),  var_cas_ioParsedComponentStruct,  automatic_var_5469_0 COMMA_SOURCE_FILE_AT_LINE (133)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_5040->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5644 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (145)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5644 = NULL ;
    while (((operand_5644 = enumerator_5644.nextObject ()))) {
      macroValidPointer (operand_5644) ;
      const GGS_bool cond_5918 = (operand_5644->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (146))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5918.isBuiltAndTrue ()) {
        operand_5644->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5644->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      }else if (cond_5918.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5644->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6115 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6115.isBuiltAndTrue ()) {
          operand_5644->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (153)) ;
        }else if (cond_6115.isBuiltAndFalse ()) {
          var_cas_context.mNibAndClassList.addAssign_operation (var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (155)), var_cas_x.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (156))) ;
        }
      }
    }
  }
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6320 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (162)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6320 = NULL ;
    while (((operand_6320 = enumerator_6320.nextObject ()))) {
      ...
      const GGS_bool cond_6615 = (operand_6320->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6615.isBuiltAndTrue ()) {
        operand_6320->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (167)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6615.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6320->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6320->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_HERE) ;
        ::routine_parseLexiqueComponent (inLexique,  var_cas_lexiqueFullPathName,  var_cas_ioParsedComponentStruct,  var_cas_lexiqueComponentRoot COMMA_SOURCE_FILE_AT_LINE (172)) ;
      }
      GGS_stringset  var_cas_terminalSymbolSet = GGS_stringset ::constructor_emptySet () ;
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_7036 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (180)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_7036 = NULL ;
        while (((operand_7036 = enumerator_7036.nextObject ()))) {
          macroValidPointer (operand_7036) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_7036->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7162 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (183)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7162 = NULL ;
        while (((operand_7162 = enumerator_7162.nextObject ()))) {
          macroValidPointer (operand_7162) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7239 (operand_7162->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7239 = NULL ;
            while (((operand_7239 = enumerator_7239.nextObject ()))) {
              macroValidPointer (operand_7239) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7239->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7379 (operand_6320->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7379 = NULL ;
        while (((operand_7379 = enumerator_7379.nextObject ()))) {
          macroValidPointer (operand_7379) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7410 (operand_7379->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7410 = NULL ;
            while (((operand_7410 = enumerator_7410.nextObject ()))) {
              macroValidPointer (operand_7410) ;
              const GGS_bool cond_7672 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7410->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)))).operator_not () ;
              if (cond_7672.isBuiltAndTrue ()) {
                operand_7410->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7410->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6320->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7821 (operand_6320->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7821 = NULL ;
        while (((operand_7821 = enumerator_7821.nextObject ()))) {
          macroValidPointer (operand_7821) ;
          const GGS_bool cond_7962 = (operand_7821->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (204))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7962.isBuiltAndTrue ()) {
            operand_7821->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (206)) ;
          }else if (cond_7962.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7821->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)), operand_7821->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8303 (operand_6320->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8303 = NULL ;
        while (((operand_8303 = enumerator_8303.nextObject ()))) {
          macroValidPointer (operand_8303) ;
          const GGS_bool cond_8530 = (operand_8303->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8530.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8303->mValue, operand_6320->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (218)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8530.isBuiltAndFalse ()) {
            const GGS_bool cond_8769 = (operand_8303->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8769.isBuiltAndTrue ()) {
              const GGS_bool cond_8676 = var_cas_hasTabViewTitle ;
              if (cond_8676.isBuiltAndTrue ()) {
                operand_8303->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8303->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (223)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8303->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
            }else if (cond_8769.isBuiltAndFalse ()) {
              const GGS_bool cond_9014 = (operand_8303->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (226))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_9014.isBuiltAndTrue ()) {
                const GGS_bool cond_8922 = var_cas_hasBlockComment ;
                if (cond_8922.isBuiltAndTrue ()) {
                  operand_8303->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8303->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (229)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8303->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
              }else if (cond_9014.isBuiltAndFalse ()) {
                operand_8303->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8303->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (234)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9359 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9359.isBuiltAndTrue ()) {
        operand_6320->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (239)) ;
      }
      const GGS_bool cond_9515 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9515.isBuiltAndTrue ()) {
        operand_6320->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (243)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6320->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6320->mLabels) ;
    }
  }
  const GGS_bool cond_10060 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10060.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257))).operator_concat (GGS_string (".m")), GGS_string ("//"), GGS_string ("\n"
