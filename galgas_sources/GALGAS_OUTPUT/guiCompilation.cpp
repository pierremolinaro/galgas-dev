...
//                    november 26th, 2010, at 18h34'27"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileGuiComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_componentName.reader_string (SOURCE_FILE_AT_LINE (105)).objectCompare (var_basename))) ;
  ...
  cEnumerator_lstringlist enumerator_4750 (var_guiComponentRoot.reader_mImportedOptionList (SOURCE_FILE_AT_LINE (122)), true) ;
  //--- simple foreach instruction
  while (enumerator_4750.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsNotEqual, enumerator_4750.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (123)).reader_pathExtension (SOURCE_FILE_AT_LINE (123)).objectCompare (GALGAS_string ("gOption")))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_4750.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_lstring joker_5158_4 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5158_3 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5158_2 ; // Joker input parameter
      GALGAS_commandLineOptionMap joker_5158_1 ; // Joker input parameter
      routine_parseOptionComponent (GALGAS_lstring::constructor_new (enumerator_4750.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (128)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (128)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (128)) COMMA_SOURCE_FILE_AT_LINE (128)), enumerator_4750.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (129)) COMMA_SOURCE_FILE_AT_LINE (127)), ioArgument_ioParsedComponentStruct, joker_5158_4, joker_5158_3, joker_5158_2, joker_5158_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_context.mAttribute_mImportedOptionComponentList.addAssign_operation (enumerator_4750.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (134)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (134)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)) ;
    }
    enumerator_4750.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_guiSimpleAttributeListAST enumerator_5399 (var_guiComponentRoot.reader_mGlobalSimpleAttributeList (SOURCE_FILE_AT_LINE (138)), true) ;
  //--- simple foreach instruction
  while (enumerator_5399.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_4 (GALGAS_bool (kIsNotEqual, enumerator_5399.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).objectCompare (GALGAS_string ("nibAndMainClass")))) ;
    if (test_4.isValidAndTrue ()) {
      //-------- @warningInstructionForGeneration
      GALGAS_location location_5 (enumerator_5399.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_5, GALGAS_string ("the '").operator_concat (enumerator_5399.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).operator_concat (GALGAS_string ("' key is invalid and has no effect") COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
    }else if (test_4.isValid ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_stringlist var_x = enumerator_5399.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (143)).reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (143)) ;
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_6 (GALGAS_bool (kIsNotEqual, var_x.reader_length (SOURCE_FILE_AT_LINE (144)).objectCompare (GALGAS_uint ((PMUInt32) 2U)))) ;
      if (test_6.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_7 (enumerator_5399.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (145)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_withLexiqueListAST enumerator_6075 (var_guiComponentRoot.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (155)), true) ;
  //--- simple foreach instruction
  while (enumerator_6075.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_lexiqueComponentAST var_lexiqueComponentRoot ;
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_8 (GALGAS_bool (kIsNotEqual, enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (158)).reader_pathExtension (SOURCE_FILE_AT_LINE (158)).objectCompare (GALGAS_string ("gLexique")))) ;
    if (test_8.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_9 (enumerator_6075.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (159)) ;
      var_lexiqueComponentRoot.drop () ; // Release error dropped variable
    }else if (test_8.isValid ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_lexiqueFullPathName = GALGAS_lstring::constructor_new (enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (162)).reader_absolutePathFromPath (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (162)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (162)) COMMA_SOURCE_FILE_AT_LINE (162)), enumerator_6075.current_mLexiqueFileName (HERE).reader_location (SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (161)) ;
      { //-------- @routineCallInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalDeclarationListAST enumerator_6829 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (173)), true) ;
    //--- simple foreach instruction
    while (enumerator_6829.hasCurrentObject ()) {
      //-------- @addAssignInstructionForGeneration
      var_terminalSymbolSet.addAssign_operation (enumerator_6829.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
      enumerator_6829.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalListDeclarationListAST enumerator_6958 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (176)), true) ;
    //--- simple foreach instruction
    while (enumerator_6958.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lexicalListEntryListAST enumerator_6986 (enumerator_6958.current_mEntryList (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_6986.hasCurrentObject ()) {
        //-------- @addAssignInstructionForGeneration
        var_terminalSymbolSet.addAssign_operation (enumerator_6986.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)) ;
        enumerator_6986.gotoNextObject () ;
      }
      enumerator_6958.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiLabelListAST enumerator_7126 (enumerator_6075.current_mLabels (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_7126.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_7157 (enumerator_7126.current_mTerminalList (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_7157.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_10 (var_terminalSymbolSet.reader_hasKey (enumerator_7157.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)).operator_not (SOURCE_FILE_AT_LINE (184))) ;
        if (test_10.isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_11 (enumerator_7157.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_11, GALGAS_string ("the '$").operator_concat (enumerator_7157.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)).operator_concat (GALGAS_string ("$' terminal symbol is not declared by the '") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)).operator_concat (GALGAS_string ("' lexique") COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiCompoundAttributeListAST enumerator_7568 (enumerator_6075.current_mCompoundAttributes (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_7568.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_12 (GALGAS_bool (kIsNotEqual, enumerator_7568.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).objectCompare (GALGAS_string ("textMacro")))) ;
      if (test_12.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_13 (enumerator_7568.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_13, GALGAS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (198)) ;
      }else if (test_12.isValid ()) {
        //-------- @addAssignInstructionForGeneration
        var_textMacroList.addAssign_operation (enumerator_7568.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (200)), enumerator_7568.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (200)) COMMA_SOURCE_FILE_AT_LINE (200)) ;
      }
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_guiSimpleAttributeListAST enumerator_8050 (enumerator_6075.current_mSimpleAttributes (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_8050.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_14 (GALGAS_bool (kIsEqual, enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (210)).objectCompare (GALGAS_string ("fileExtension")))) ;
      if (test_14.isValidAndTrue ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_8050.current_mValue (HERE), enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (211)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (211)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (211)), inCompiler COMMA_SOURCE_FILE_AT_LINE (211)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (test_14.isValid ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_15 (GALGAS_bool (kIsEqual, enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (213)).objectCompare (GALGAS_string ("title")))) ;
        if (test_15.isValidAndTrue ()) {
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_16 (var_hasTabViewTitle) ;
          if (test_16.isValidAndTrue ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_17 (enumerator_8050.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_17, GALGAS_string ("the '").operator_concat (enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)) ;
          }
          //-------- @assignmentInstructionForGeneration
          var_hasTabViewTitle = GALGAS_bool (true) ;
          //-------- @assignmentInstructionForGeneration
          var_tabViewTitle = enumerator_8050.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (218)) ;
        }else if (test_15.isValid ()) {
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_18 (GALGAS_bool (kIsEqual, enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (219)).objectCompare (GALGAS_string ("blockComment")))) ;
          if (test_18.isValidAndTrue ()) {
            //-------- @ifInstructionForGeneration
            const GALGAS_bool test_19 (var_hasBlockComment) ;
            if (test_19.isValidAndTrue ()) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_20 (enumerator_8050.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_20, GALGAS_string ("the '").operator_concat (enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
            }
            //-------- @assignmentInstructionForGeneration
            var_hasBlockComment = GALGAS_bool (true) ;
            //-------- @assignmentInstructionForGeneration
            var_blockComment = enumerator_8050.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (224)) ;
          }else if (test_18.isValid ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_21 (enumerator_8050.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_21, GALGAS_string ("the '").operator_concat (enumerator_8050.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (226)) COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')") COMMA_SOURCE_FILE_AT_LINE (226)) COMMA_SOURCE_FILE_AT_LINE (226)) ;
          }
        }
      }
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_22 (var_hasAssociatedExtension.operator_not (SOURCE_FILE_AT_LINE (230))) ;
    if (test_22.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_23 (enumerator_6075.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_23, GALGAS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (231)) ;
    }
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_24 (var_hasTabViewTitle.operator_not (SOURCE_FILE_AT_LINE (234))) ;
    if (test_24.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_25 (enumerator_6075.current_mLexiqueFileName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (235)) ;
    }
    //-------- @addAssignInstructionForGeneration
    var_context.mAttribute_mWithLexiqueList.addAssign_operation (enumerator_6075.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (239)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (239)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (239)), var_blockComment, var_tabViewTitle, var_textMacroList, enumerator_6075.current_mLabels (HERE) COMMA_SOURCE_FILE_AT_LINE (238)) ;
    enumerator_6075.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_26 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (247)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
