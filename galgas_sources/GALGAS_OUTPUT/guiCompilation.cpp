...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.gTemplate", 7)).isValid ()) {
    cEnumerator_stringlist enumerator_233 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.gTemplate", 7)), kEnumeration_up) ;
  ...
  GALGAS_uint index_1203_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.gTemplate", 26)).isValid ()) {
    cEnumerator_stringlist enumerator_1203 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.gTemplate", 26)), kEnumeration_up) ;
    while (enumerator_1203.hasCurrentObject ()) {
      result << "    [NSArray arrayWithObjects:@\"" ;
      result << enumerator_1203.current_mValue (HERE).stringValue () ;
      result << "\", [" ;
      result << enumerator_1203.current_mValue (HERE).stringValue () ;
      result << " class], nil],\n" ;
      index_1203_.increment () ;
      enumerator_1203.gotoNextObject () ;
    }
  }
  result << "    nil\n"
    "  ] ;\n"
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 43)).isValid ()) {
    cEnumerator_stringlist enumerator_2118 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 43)), kEnumeration_up) ;
    while (enumerator_2118.hasCurrentObject ()) {
      ...
      result << enumerator_2118.current_mValue (HERE).stringValue () ;
      result << "-cocoa.m\"\n" ;
  ...
  GALGAS_uint index_2546_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 53)).isValid ()) {
    cEnumerator_stringlist enumerator_2546 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 53)), kEnumeration_up) ;
    while (enumerator_2546.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_2546.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 54)).stringValue () ;
      result << " (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;\n" ;
      index_2546_.increment () ;
      enumerator_2546.gotoNextObject () ;
    }
  }
  result << "}\n"
    "\n" ;
  GALGAS_uint index_2720_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2720 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 58)), kEnumeration_up) ;
    while (enumerator_2720.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << enumerator_2720.current_mLexiqueClassName (HERE).stringValue () ;
      result << "\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "//                                                                                                                     *\n"
        ...
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n" ;
      GALGAS_uint index_3557_ (0) ;
      if (enumerator_2720.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3557 (enumerator_2720.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3557.hasCurrentObject ()) {
          result << "static const UInt16 gPopUpData_" ;
          result << enumerator_2720.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).stringValue () ;
          result << "_" ;
          result << enumerator_3557.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_3557.current_mTerminalList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_3557.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 68)).stringValue () ;
          result << ", // Leading character count to strip\n" ;
          GALGAS_uint index_3853_ (0) ;
          if (enumerator_3557.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_terminalLabelListAST enumerator_3853 (enumerator_3557.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_3853.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2720.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3853.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 70)).stringValue () ;
              result << ", " ;
              result << enumerator_3853.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 70)).stringValue () ;
              result << ",\n" ;
          ...
          result << "  0\n"
            "} ;\n"
            "\n" ;
          index_3557_.increment () ;
          enumerator_3557.gotoNextObject () ;
        }
      }
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2720.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).stringValue () ;
      result << " [" ;
      result << enumerator_2720.current_mLabels (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_4151_ (0) ;
      if (enumerator_2720.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_4151 (enumerator_2720.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_4151.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2720.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 77)).stringValue () ;
          result << "_" ;
          result << enumerator_4151.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 77)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 77)).stringValue () ;
          result << ",\n" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2720.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2720.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2720.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 107)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2720.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2720.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 115)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 115)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 115)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_6792_ (0) ;
      if (enumerator_2720.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_6792 (enumerator_2720.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_6792.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_6792.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 117)).stringValue () ;
          result << ",\n" ;
          index_6792_.increment () ;
          enumerator_6792.gotoNextObject () ;
        }
      }
      result << "    NULL\n"
        "  } ;\n"
      ...
      result << enumerator_2720.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 125)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 125)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 125)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_7239_ (0) ;
      if (enumerator_2720.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_7239 (enumerator_2720.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_7239.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_7239.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 127)).stringValue () ;
          result << ",\n" ;
          index_7239_.increment () ;
      ...
      result << "    NULL\n"
        ...
        "@end\n"
        "\n" ;
      index_2720_.increment () ;
      enumerator_2720.gotoNextObject () ;
    }
  }
  result << "\n"
    "\n"
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE ("gui-implementation.m.gTemplate", 142)).isValid ()) {
    cEnumerator_extensionMap enumerator_7804 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE ("gui-implementation.m.gTemplate", 142)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_7804 = enumerator_7804.hasCurrentObject () ;
    if (nonEmpty_enumerator_7804) {
      result << "  if" ;
    }
    while (enumerator_7804.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_7804.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 144)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_7804.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
      if (enumerator_7804.hasNextObject ()) {
        result << "  }else if" ;
      }
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_8228 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 156)), kEnumeration_up) ;
    while (enumerator_8228.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_8228.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
