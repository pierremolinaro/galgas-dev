...
template_filewrapper_guiGenerationTemplates_gui_implementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "  return result ;\n"
      ...
      "  return [NSArray arrayWithObjects:\n" ;
    GGS_importedLexiqueList::cEnumerator enumerator_6781 (var_cas_GUI_CONTEXT.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (157)), true) ;
    const GGS_importedLexiqueList::cElement * operand_6781 = NULL ;
    while (((operand_6781 = enumerator_6781.nextObject ()))) {
      macroValidPointer (operand_6781) ;
      result << "    [[[OC_Tokenizer_" ;
      result << operand_6781->mLexiqueClassName ;
