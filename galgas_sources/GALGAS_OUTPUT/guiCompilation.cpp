...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  while (enumerator_5574.hasCurrentObject ()) {
    ...
    cEnumerator_terminalDeclarationListAST enumerator_6347 (var_lexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE_AT_LINE (159)), kEnumeration_up) ;
    while (enumerator_6347.hasCurrentObject ()) {
      var_terminalSymbolSet.addAssign_operation (enumerator_6347.current_mName (HERE).reader_string (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
      enumerator_6347.gotoNextObject () ;
    }
    cEnumerator_lexicalListDeclarationListAST enumerator_6476 (var_lexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE_AT_LINE (162)), kEnumeration_up) ;
    while (enumerator_6476.hasCurrentObject ()) {
      ...
      while (enumerator_6504.hasCurrentObject ()) {
        var_terminalSymbolSet.addAssign_operation (enumerator_6504.current_mTerminalSpelling (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)) ;
    ...
    while (enumerator_7095.hasCurrentObject ()) {
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_7095.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (183)).objectCompare (GALGAS_string ("textMacro"))).boolEnum () ;
      if (kBoolTrue == test_10) {
        ...
        var_textMacroList.addAssign_operation (enumerator_7095.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (186)), enumerator_7095.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }
    ...
    while (enumerator_7577.hasCurrentObject ()) {
      const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_7577.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (196)).objectCompare (GALGAS_string ("fileExtension"))).boolEnum () ;
      if (kBoolTrue == test_12) {
        {
        var_context.mAttribute_mExtensionMap.modifier_insertKey (enumerator_7577.current_mValue (HERE), enumerator_5574.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (197)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (197)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (197)), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
        }
        var_hasAssociatedExtension = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_12) {
        const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_7577.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (199)).objectCompare (GALGAS_string ("title"))).boolEnum () ;
        if (kBoolTrue == test_13) {
          ...
          if (kBoolTrue == test_14) {
            ...
            inCompiler->emitSemanticError (location_15, GALGAS_string ("the '").operator_concat (enumerator_7577.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
          }
          var_hasTabViewTitle = GALGAS_bool (true) ;
          var_tabViewTitle = enumerator_7577.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (204)) ;
        }else if (kBoolFalse == test_13) {
          const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_7577.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_string ("blockComment"))).boolEnum () ;
          if (kBoolTrue == test_16) {
            ...
            if (kBoolTrue == test_17) {
              ...
              inCompiler->emitSemanticError (location_18, GALGAS_string ("the '").operator_concat (enumerator_7577.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string ("' key should be defined once") COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
            }
            var_hasBlockComment = GALGAS_bool (true) ;
            var_blockComment = enumerator_7577.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (210)) ;
          }else if (kBoolFalse == test_16) {
            GALGAS_location location_19 (enumerator_7577.current_mKey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_19, GALGAS_string ("the '").operator_concat (enumerator_7577.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')") COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
          }
        }
      }
...
void routine_compileGuiComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_guiGrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_9830, constinArgument_inSourceFile, var_guiComponentRoot COMMA_SOURCE_FILE_AT_LINE (256)) ;
  {
