...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)).isValid ()) {
    cEnumerator_stringlist enumerator_934 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE_AT_LINE (26)), kEnumeration_up) ;
    while (enumerator_934.hasCurrentObject ()) {
      result << "    [NSArray arrayWithObjects:@\"" ;
      result << enumerator_934.current_mValue (HERE).stringValue () ;
      result << "\", [" ;
      result << enumerator_934.current_mValue (HERE).stringValue () ;
      result << " class], nil],\n" ;
  ...
  result << "    nil\n"
    ...
    "//-----------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_1615_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)).isValid ()) {
    cEnumerator_stringlist enumerator_1615 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (43)), kEnumeration_up) ;
    while (enumerator_1615.hasCurrentObject ()) {
      result << "#import \"" ;
      result << enumerator_1615.current_mValue (HERE).stringValue () ;
      result << "-cocoa.m\"\n" ;
      index_1615_.increment () ;
  ...
  GALGAS_uint index_1970_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)).isValid ()) {
    cEnumerator_stringlist enumerator_1970 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE_AT_LINE (53)), kEnumeration_up) ;
    while (enumerator_1970.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_1970.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << " (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray) ;\n" ;
      index_1970_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2152 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (58)), kEnumeration_up) ;
    while (enumerator_2152.hasCurrentObject ()) {
      result << "//-----------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << enumerator_2152.current_mLexiqueClassName (HERE).stringValue () ;
      result << "\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        "//                                                                             *\n"
      ...
      if (enumerator_2152.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_2747 (enumerator_2152.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_2747.hasCurrentObject ()) {
          result << "static const UInt16 gPopUpData_" ;
          result << enumerator_2152.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "_" ;
          result << enumerator_2747.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_2747.current_mTerminalList (HERE).reader_length (SOURCE_FILE_AT_LINE (67)), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (SOURCE_FILE_AT_LINE (67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_2747.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
          result << ", // Leading character count to strip\n" ;
          GALGAS_uint index_3043_ (0) ;
          if (enumerator_2747.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_terminalLabelListAST enumerator_3043 (enumerator_2747.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_3043.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2152.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3043.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ", " ;
              result << enumerator_3043.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
              result << ",\n" ;
      ...
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2152.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << " [" ;
      result << enumerator_2152.current_mLabels (HERE).reader_length (SOURCE_FILE_AT_LINE (75)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_3357_ (0) ;
      if (enumerator_2152.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3357 (enumerator_2152.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3357.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2152.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << "_" ;
          result << enumerator_3357.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (77)).reader_string (SOURCE_FILE_AT_LINE (77)).stringValue () ;
          result << ",\n" ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2152.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2152.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2152.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (107)).reader_string (SOURCE_FILE_AT_LINE (107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2152.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//-----------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2152.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (115)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5564_ (0) ;
      if (enumerator_2152.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5564 (enumerator_2152.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5564.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5564.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << ",\n" ;
          index_5564_.increment () ;
      ...
      result << enumerator_2152.current_mTextMacroList (HERE).reader_length (SOURCE_FILE_AT_LINE (125)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (SOURCE_FILE_AT_LINE (125)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_5979_ (0) ;
      if (enumerator_2152.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_5979 (enumerator_2152.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_5979.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_5979.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (127)).stringValue () ;
          result << ",\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)).isValid ()) {
    cEnumerator_extensionMap enumerator_6480 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE_AT_LINE (142)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_6480 = enumerator_6480.hasCurrentObject () ;
    if (nonEmpty_enumerator_6480) {
      result << "  if" ;
    }
    while (enumerator_6480.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_6480.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (144)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_6480.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
  ...
  result << "  return result ;\n"
    ...
    "  return [NSArray arrayWithObjects:\n" ;
  GALGAS_uint index_6872_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_6872 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE_AT_LINE (156)), kEnumeration_up) ;
    while (enumerator_6872.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_6872.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
      index_6872_.increment () ;
