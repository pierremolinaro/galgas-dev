...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4553 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4553.isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_4963 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (128)), true) ;
    const GGS_lstringlist::cElement * operand_4963 = NULL ;
    while (((operand_4963 = enumerator_4963.nextObject ()))) {
      macroValidPointer (operand_4963) ;
      const GGS_bool cond_5159 = (operand_4963->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5159.isBuiltAndTrue ()) {
        operand_4963->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (131)) ;
      }else if (cond_5159.isBuiltAndFalse ()) {
        GGS_optionComponentAST  automatic_var_5392_0 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_4963->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_4963->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_HERE),  var_cas_ioParsedComponentStruct,  automatic_var_5392_0 COMMA_SOURCE_FILE_AT_LINE (132)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_4963->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5568 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (144)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5568 = NULL ;
    while (((operand_5568 = enumerator_5568.nextObject ()))) {
      macroValidPointer (operand_5568) ;
      const GGS_bool cond_5842 = (operand_5568->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5842.isBuiltAndTrue ()) {
        operand_5568->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5568->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }else if (cond_5842.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5568->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6039 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6039.isBuiltAndTrue ()) {
          operand_5568->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (152)) ;
        }else if (cond_6039.isBuiltAndFalse ()) {
  ...
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6245 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (161)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6245 = NULL ;
    while (((operand_6245 = enumerator_6245.nextObject ()))) {
      macroValidPointer (operand_6245) ;
      GGS_lexiqueComponentAST  var_cas_lexiqueComponentRoot ;
      const GGS_bool cond_6539 = (operand_6245->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6539.isBuiltAndTrue ()) {
        operand_6245->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (166)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6539.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6245->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6245->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_HERE) ;
      ...
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_6960 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (179)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_6960 = NULL ;
        while (((operand_6960 = enumerator_6960.nextObject ()))) {
          macroValidPointer (operand_6960) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_6960->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7086 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (182)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7086 = NULL ;
        while (((operand_7086 = enumerator_7086.nextObject ()))) {
          macroValidPointer (operand_7086) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7163 (operand_7086->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7163 = NULL ;
            while (((operand_7163 = enumerator_7163.nextObject ()))) {
              macroValidPointer (operand_7163) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7163->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7303 (operand_6245->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7303 = NULL ;
        while (((operand_7303 = enumerator_7303.nextObject ()))) {
          macroValidPointer (operand_7303) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7334 (operand_7303->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7334 = NULL ;
            while (((operand_7334 = enumerator_7334.nextObject ()))) {
              macroValidPointer (operand_7334) ;
              const GGS_bool cond_7596 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7334->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (190)))).operator_not () ;
              if (cond_7596.isBuiltAndTrue ()) {
                operand_7334->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7334->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6245->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (197)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7745 (operand_6245->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7745 = NULL ;
        while (((operand_7745 = enumerator_7745.nextObject ()))) {
          macroValidPointer (operand_7745) ;
          const GGS_bool cond_7886 = (operand_7745->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7886.isBuiltAndTrue ()) {
            operand_7745->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (205)) ;
          }else if (cond_7886.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7745->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), operand_7745->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8227 (operand_6245->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8227 = NULL ;
        while (((operand_8227 = enumerator_8227.nextObject ()))) {
          macroValidPointer (operand_8227) ;
          const GGS_bool cond_8455 = (operand_8227->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8455.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8227->mValue, operand_6245->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (217)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8455.isBuiltAndFalse ()) {
            const GGS_bool cond_8694 = (operand_8227->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8694.isBuiltAndTrue ()) {
              const GGS_bool cond_8601 = var_cas_hasTabViewTitle ;
              if (cond_8601.isBuiltAndTrue ()) {
                operand_8227->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8227->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (222)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8227->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
            }else if (cond_8694.isBuiltAndFalse ()) {
              const GGS_bool cond_8939 = (operand_8227->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_8939.isBuiltAndTrue ()) {
                const GGS_bool cond_8847 = var_cas_hasBlockComment ;
                if (cond_8847.isBuiltAndTrue ()) {
                  operand_8227->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8227->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (228)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8227->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
              }else if (cond_8939.isBuiltAndFalse ()) {
                operand_8227->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8227->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (233)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9284 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9284.isBuiltAndTrue ()) {
        operand_6245->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (238)) ;
      }
      const GGS_bool cond_9440 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9440.isBuiltAndTrue ()) {
        operand_6245->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (242)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6245->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6245->mLabels) ;
    }
  }
  const GGS_bool cond_9986 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9986.isBuiltAndTrue ()) {
