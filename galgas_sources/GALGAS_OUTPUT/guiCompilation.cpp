...
//                    november 30th, 2010, at 11h52'46"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileGuiComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_componentName.reader_string (SOURCE_FILE_AT_LINE (104)).objectCompare (var_basename))) ;
  ...
  while (enumerator_4706.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsNotEqual, enumerator_4706.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (122)).reader_pathExtension (SOURCE_FILE_AT_LINE (122)).objectCompare (GALGAS_string ("gOption")))) ;
  ...
  while (enumerator_5357.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_4 (GALGAS_bool (kIsNotEqual, enumerator_5357.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (138)).objectCompare (GALGAS_string ("nibAndMainClass")))) ;
    if (test_4.isValidAndTrue ()) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_6 (GALGAS_bool (kIsNotEqual, var_x.reader_length (SOURCE_FILE_AT_LINE (142)).objectCompare (GALGAS_uint ((PMUInt32) 2U)))) ;
  ...
  while (enumerator_5939.hasCurrentObject ()) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_8 (GALGAS_bool (kIsNotEqual, enumerator_5939.current_mLexiqueFileName (HERE).reader_string (SOURCE_FILE_AT_LINE (156)).reader_pathExtension (SOURCE_FILE_AT_LINE (156)).objectCompare (GALGAS_string ("gLexique")))) ;
    ...
    while (enumerator_6990.hasCurrentObject ()) {
      ...
      while (enumerator_7021.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_10 (var_terminalSymbolSet.reader_hasKey (enumerator_7021.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_not (SOURCE_FILE_AT_LINE (182))) ;
    ...
    while (enumerator_7432.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_12 (GALGAS_bool (kIsNotEqual, enumerator_7432.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (195)).objectCompare (GALGAS_string ("textMacro")))) ;
    ...
    while (enumerator_7914.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_14 (GALGAS_bool (kIsEqual, enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (208)).objectCompare (GALGAS_string ("fileExtension")))) ;
      if (test_14.isValidAndTrue ()) {
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_15 (GALGAS_bool (kIsEqual, enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (211)).objectCompare (GALGAS_string ("title")))) ;
        if (test_15.isValidAndTrue ()) {
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_16 (var_hasTabViewTitle) ;
          ...
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_18 (GALGAS_bool (kIsEqual, enumerator_7914.current_mKey (HERE).reader_string (SOURCE_FILE_AT_LINE (217)).objectCompare (GALGAS_string ("blockComment")))) ;
          if (test_18.isValidAndTrue ()) {
            //-------- @ifInstructionForGeneration
            const GALGAS_bool test_19 (var_hasBlockComment) ;
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_22 (var_hasAssociatedExtension.operator_not (SOURCE_FILE_AT_LINE (228))) ;
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_24 (var_hasTabViewTitle.operator_not (SOURCE_FILE_AT_LINE (232))) ;
    if (test_24.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_26 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
