...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4512 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110))).operator_isNotEqual (var_cas_basename) ;
  ...
  GGS_guiAnalysisContext var_cas_context = GGS_guiAnalysisContext::constructor_new (GGS_stringlist ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_guiCommandLineOptionList ::constructor_emptyList (), GGS_nibAndClassList ::constructor_emptyList (), GGS_extensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (123)), GGS_importedLexiqueList ::constructor_emptyList ()) ;
  {
    GGS_lstringlist::cEnumerator enumerator_4922 (var_cas_guiComponentRoot.reader_mImportedOptionList (inLexique COMMA_SOURCE_FILE_AT_LINE (127)), true) ;
    const GGS_lstringlist::cElement * operand_4922 = NULL ;
    while (((operand_4922 = enumerator_4922.nextObject ()))) {
      macroValidPointer (operand_4922) ;
      const GGS_bool cond_5118 = (operand_4922->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gOption")) ;
      if (cond_5118.isBuiltAndTrue ()) {
        operand_4922->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only an option component (path extension '.gOption') can be imported here") COMMA_SOURCE_FILE_AT_LINE (130)) ;
      }else if (cond_5118.isBuiltAndFalse ()) {
        GGS_lstring  automatic_var_5352_0 ;
        GGS_commandLineOptionMap  automatic_var_5352_1 ;
        GGS_commandLineOptionMap  automatic_var_5352_2 ;
        GGS_commandLineOptionMap  automatic_var_5352_3 ;
        ::routine_parseOptionComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, operand_4922->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_4922->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (132)),  var_cas_ioParsedComponentStruct,  automatic_var_5352_0,  automatic_var_5352_1,  automatic_var_5352_2,  automatic_var_5352_3 COMMA_SOURCE_FILE_AT_LINE (131)) ;
        var_cas_context.mImportedOptionComponentList.addAssign_operation (operand_4922->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension ()) ;
      }
    }
  }
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5528 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (143)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5528 = NULL ;
    while (((operand_5528 = enumerator_5528.nextObject ()))) {
      macroValidPointer (operand_5528) ;
      const GGS_bool cond_5802 = (operand_5528->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5802.isBuiltAndTrue ()) {
        operand_5528->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5528->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }else if (cond_5802.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5528->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_5999 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_5999.isBuiltAndTrue ()) {
          operand_5528->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (151)) ;
        }else if (cond_5999.isBuiltAndFalse ()) {
  ...
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6205 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (160)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6205 = NULL ;
    while (((operand_6205 = enumerator_6205.nextObject ()))) {
      ...
      const GGS_bool cond_6499 = (operand_6205->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6499.isBuiltAndTrue ()) {
        operand_6205->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (165)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6499.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6205->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6205->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
      ...
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_6920 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (178)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_6920 = NULL ;
        while (((operand_6920 = enumerator_6920.nextObject ()))) {
          macroValidPointer (operand_6920) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_6920->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7046 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7046 = NULL ;
        while (((operand_7046 = enumerator_7046.nextObject ()))) {
          macroValidPointer (operand_7046) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7123 (operand_7046->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7123 = NULL ;
            while (((operand_7123 = enumerator_7123.nextObject ()))) {
              macroValidPointer (operand_7123) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7123->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7263 (operand_6205->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7263 = NULL ;
        while (((operand_7263 = enumerator_7263.nextObject ()))) {
          macroValidPointer (operand_7263) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7294 (operand_7263->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7294 = NULL ;
            while (((operand_7294 = enumerator_7294.nextObject ()))) {
              macroValidPointer (operand_7294) ;
              const GGS_bool cond_7556 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7294->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)))).operator_not () ;
              if (cond_7556.isBuiltAndTrue ()) {
                operand_7294->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7294->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6205->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (196)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7705 (operand_6205->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7705 = NULL ;
        while (((operand_7705 = enumerator_7705.nextObject ()))) {
          macroValidPointer (operand_7705) ;
          const GGS_bool cond_7846 = (operand_7705->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7846.isBuiltAndTrue ()) {
            operand_7705->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (204)) ;
          }else if (cond_7846.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7705->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), operand_7705->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8187 (operand_6205->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8187 = NULL ;
        while (((operand_8187 = enumerator_8187.nextObject ()))) {
          macroValidPointer (operand_8187) ;
          const GGS_bool cond_8415 = (operand_8187->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8415.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8187->mValue, operand_6205->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (216)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8415.isBuiltAndFalse ()) {
            const GGS_bool cond_8654 = (operand_8187->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8654.isBuiltAndTrue ()) {
              const GGS_bool cond_8561 = var_cas_hasTabViewTitle ;
              if (cond_8561.isBuiltAndTrue ()) {
                operand_8187->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8187->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (221)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8187->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
            }else if (cond_8654.isBuiltAndFalse ()) {
              const GGS_bool cond_8899 = (operand_8187->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_8899.isBuiltAndTrue ()) {
                const GGS_bool cond_8807 = var_cas_hasBlockComment ;
                if (cond_8807.isBuiltAndTrue ()) {
                  operand_8187->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8187->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (227)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8187->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
              }else if (cond_8899.isBuiltAndFalse ()) {
                operand_8187->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8187->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (232)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9244 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9244.isBuiltAndTrue ()) {
        operand_6205->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (237)) ;
      }
      const GGS_bool cond_9400 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9400.isBuiltAndTrue ()) {
        operand_6205->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (241)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6205->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6205->mLabels) ;
    }
  }
  const GGS_bool cond_9946 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (252))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9946.isBuiltAndTrue ()) {
