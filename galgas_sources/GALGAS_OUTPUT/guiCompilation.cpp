...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.gTemplate", 26)).isValid ()) {
    cEnumerator_stringlist enumerator_1160 (in_GUI_5F_CONTEXT.reader_mNibAndClassList (SOURCE_FILE ("gui-implementation.m.gTemplate", 26)), kEnumeration_up) ;
    while (enumerator_1160.hasCurrentObject ()) {
      result << "    [NSArray arrayWithObjects:@\"" ;
      result << enumerator_1160.current_mValue (HERE).stringValue () ;
      result << "\", [" ;
      result << enumerator_1160.current_mValue (HERE).stringValue () ;
      result << " class], nil],\n" ;
  ...
  result << "    nil\n"
    ...
    "//---------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_2075_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 43)).isValid ()) {
    cEnumerator_stringlist enumerator_2075 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 43)), kEnumeration_up) ;
    while (enumerator_2075.hasCurrentObject ()) {
      result << "#import \"" ;
      result << enumerator_2075.current_mValue (HERE).stringValue () ;
      result << "-cocoa.m\"\n" ;
      index_2075_.increment () ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 53)).isValid ()) {
    cEnumerator_stringlist enumerator_2462 (in_GUI_5F_CONTEXT.reader_mImportedOptionComponentList (SOURCE_FILE ("gui-implementation.m.gTemplate", 53)), kEnumeration_up) ;
    while (enumerator_2462.hasCurrentObject ()) {
      result << "  enterOptionsFor_" ;
      result << enumerator_2462.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 54)).stringValue () ;
  ...
  result << "}\n"
    "\n" ;
  GALGAS_uint index_2636_ (0) ;
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 58)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_2636 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 58)), kEnumeration_up) ;
    while (enumerator_2636.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "#pragma mark Lexique " ;
      result << enumerator_2636.current_mLexiqueClassName (HERE).stringValue () ;
      result << "\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "//                                                                                                                     *\n"
      ...
      if (enumerator_2636.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_3473 (enumerator_2636.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_3473.hasCurrentObject ()) {
          result << "static const UInt16 gPopUpData_" ;
          result << enumerator_2636.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).stringValue () ;
          result << "_" ;
          result << enumerator_3473.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).stringValue () ;
          result << " [" ;
          result << GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_3473.current_mTerminalList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 67)).stringValue () ;
          result << "] = {\n"
            "  " ;
          result << enumerator_3473.current_mLeadingCharacterStrippedCount (HERE).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 68)).stringValue () ;
          result << ", // Leading character count to strip\n" ;
          GALGAS_uint index_3769_ (0) ;
          if (enumerator_3473.current_mTerminalList (HERE).isValid ()) {
            cEnumerator_terminalLabelListAST enumerator_3769 (enumerator_3473.current_mTerminalList (HERE), kEnumeration_up) ;
            while (enumerator_3769.hasCurrentObject ()) {
              result << "  " ;
              result << enumerator_2636.current_mLexiqueClassName (HERE).stringValue () ;
              result << "_1_" ;
              result << enumerator_3769.current_mTerminal (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 70)).stringValue () ;
              result << ", " ;
              result << enumerator_3769.current_mDisplayFlags (HERE).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 70)).stringValue () ;
              result << ",\n" ;
      ...
      result << "static const UInt16 * gPopUpData_" ;
      result << enumerator_2636.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).stringValue () ;
      result << " [" ;
      result << enumerator_2636.current_mLabels (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 75)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_4067_ (0) ;
      if (enumerator_2636.current_mLabels (HERE).isValid ()) {
        cEnumerator_guiLabelListAST enumerator_4067 (enumerator_2636.current_mLabels (HERE), kEnumeration_up) ;
        while (enumerator_4067.hasCurrentObject ()) {
          result << "  gPopUpData_" ;
          result << enumerator_2636.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 77)).stringValue () ;
          result << "_" ;
          result << enumerator_4067.current_mLocation (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 77)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 77)).stringValue () ;
          result << ",\n" ;
          index_4067_.increment () ;
      ...
      result << "\n"
        ...
        "- (NSString *) blockComment {\n"
        "  return @" ;
      result << enumerator_2636.current_mBlockComment (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 99)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (const UInt16 * *) popupListData {\n"
        "  return gPopUpData_" ;
      result << enumerator_2636.current_mLexiqueClassName (HERE).reader_identifierRepresentation (SOURCE_FILE ("gui-implementation.m.gTemplate", 103)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (NSUInteger) textMacroCount {\n"
        "  return " ;
      result << enumerator_2636.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 107)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 107)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        ...
        "- (NSString *) tabItemTitle {\n"
        "  return @" ;
      result << enumerator_2636.current_mTitle (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 111)).stringValue () ;
      result << " ;\n"
        "}\n"
        "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
      ...
      result << enumerator_2636.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 115)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 115)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 115)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_6708_ (0) ;
      if (enumerator_2636.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_6708 (enumerator_2636.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_6708.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_6708.current_mKey (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 117)).stringValue () ;
          result << ",\n" ;
          index_6708_.increment () ;
      ...
      result << enumerator_2636.current_mTextMacroList (HERE).reader_length (SOURCE_FILE ("gui-implementation.m.gTemplate", 125)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gui-implementation.m.gTemplate", 125)).reader_string (SOURCE_FILE ("gui-implementation.m.gTemplate", 125)).stringValue () ;
      result << "] = {\n" ;
      GALGAS_uint index_7155_ (0) ;
      if (enumerator_2636.current_mTextMacroList (HERE).isValid ()) {
        cEnumerator_textMacroList enumerator_7155 (enumerator_2636.current_mTextMacroList (HERE), kEnumeration_up) ;
        while (enumerator_7155.hasCurrentObject ()) {
          result << "    @" ;
          result << enumerator_7155.current_mContents (HERE).reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 127)).stringValue () ;
          result << ",\n" ;
  ...
  if (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE ("gui-implementation.m.gTemplate", 142)).isValid ()) {
    cEnumerator_extensionMap enumerator_7720 (in_GUI_5F_CONTEXT.reader_mExtensionMap (SOURCE_FILE ("gui-implementation.m.gTemplate", 142)), kEnumeration_up) ;
    const bool nonEmpty_enumerator_7720 = enumerator_7720.hasCurrentObject () ;
    if (nonEmpty_enumerator_7720) {
      result << "  if" ;
    }
    while (enumerator_7720.hasCurrentObject ()) {
      result << " ([inExtension isEqualToString:@" ;
      result << enumerator_7720.current_lkey (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE ("gui-implementation.m.gTemplate", 144)).stringValue () ;
      result << "]) {\n"
        "    result = [OC_Tokenizer_" ;
      result << enumerator_7720.current_mLexiqueName (HERE).stringValue () ;
      result << " new] ;\n" ;
      if (enumerator_7720.hasNextObject ()) {
        result << "  }else if" ;
      }
  ...
  if (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 156)).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_8144 (in_GUI_5F_CONTEXT.reader_mWithLexiqueList (SOURCE_FILE ("gui-implementation.m.gTemplate", 156)), kEnumeration_up) ;
    while (enumerator_8144.hasCurrentObject ()) {
      result << "    [OC_Tokenizer_" ;
      result << enumerator_8144.current_mLexiqueClassName (HERE).stringValue () ;
      result << " new],\n" ;
