...
void routine_compileGuiComponent (C_Compiler & inLexique,
  ...
  {
    GGS_guiSimpleAttributeListAST::cEnumerator enumerator_5567 (var_cas_guiComponentRoot.reader_mGlobalSimpleAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (144)), true) ;
    const GGS_guiSimpleAttributeListAST::cElement * operand_5567 = NULL ;
    while (((operand_5567 = enumerator_5567.nextObject ()))) {
      macroValidPointer (operand_5567) ;
      const GGS_bool cond_5841 = (operand_5567->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145))).operator_isNotEqual (GGS_string ("nibAndMainClass")) ;
      if (cond_5841.isBuiltAndTrue ()) {
        operand_5567->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '")).operator_concat (operand_5567->mKey)).operator_concat (GGS_string ("' key is invalid and has no effect")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }else if (cond_5841.isBuiltAndFalse ()) {
        GGS_stringlist  var_cas_x = operand_5567->mValue.ggs_string ().reader_componentsSeparatedByString (GGS_string (".")) ;
        const GGS_bool cond_6038 = (var_cas_x.reader_length ()).operator_isNotEqual (GGS_uint (2U)) ;
        if (cond_6038.isBuiltAndTrue ()) {
          operand_5567->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the string string should conform to \"nib_name.nib_main_class\"") COMMA_SOURCE_FILE_AT_LINE (152)) ;
        }else if (cond_6038.isBuiltAndFalse ()) {
  ...
  {
    GGS_withLexiqueListAST::cEnumerator enumerator_6243 (var_cas_guiComponentRoot.reader_mWithLexiqueList (inLexique COMMA_SOURCE_FILE_AT_LINE (161)), true) ;
    const GGS_withLexiqueListAST::cElement * operand_6243 = NULL ;
    while (((operand_6243 = enumerator_6243.nextObject ()))) {
      macroValidPointer (operand_6243) ;
      GGS_lexiqueComponentAST  var_cas_lexiqueComponentRoot ;
      const GGS_bool cond_6538 = (operand_6243->mLexiqueFileName.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gLexique")) ;
      if (cond_6538.isBuiltAndTrue ()) {
        operand_6243->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the file extension for a lexique component should be 'gLexique'") COMMA_SOURCE_FILE_AT_LINE (166)) ;
        var_cas_lexiqueComponentRoot.drop () ;
      }else if (cond_6538.isBuiltAndFalse ()) {
        GGS_lstring  var_cas_lexiqueFullPathName = GGS_lstring ::constructor_new (inLexique, operand_6243->mLexiqueFileName.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()), operand_6243->mLexiqueFileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_HERE) ;
      ...
      {
        GGS_terminalDeclarationListAST::cEnumerator enumerator_6959 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (179)), true) ;
        const GGS_terminalDeclarationListAST::cElement * operand_6959 = NULL ;
        while (((operand_6959 = enumerator_6959.nextObject ()))) {
          macroValidPointer (operand_6959) ;
          var_cas_terminalSymbolSet.addAssign_operation (operand_6959->mName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180))) ;
        }
      }
      {
        GGS_lexicalListDeclarationListAST::cEnumerator enumerator_7085 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (182)), true) ;
        const GGS_lexicalListDeclarationListAST::cElement * operand_7085 = NULL ;
        while (((operand_7085 = enumerator_7085.nextObject ()))) {
          macroValidPointer (operand_7085) ;
          {
            GGS_lexicalListEntryListAST::cEnumerator enumerator_7162 (operand_7085->mEntryList, true) ;
            const GGS_lexicalListEntryListAST::cElement * operand_7162 = NULL ;
            while (((operand_7162 = enumerator_7162.nextObject ()))) {
              macroValidPointer (operand_7162) ;
              var_cas_terminalSymbolSet.addAssign_operation (operand_7162->mTerminalSpelling.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184))) ;
            }
          }
        }
      }
      {
        GGS_guiLabelListAST::cEnumerator enumerator_7302 (operand_6243->mLabels, true) ;
        const GGS_guiLabelListAST::cElement * operand_7302 = NULL ;
        while (((operand_7302 = enumerator_7302.nextObject ()))) {
          macroValidPointer (operand_7302) ;
          {
            GGS_lstringlist::cEnumerator enumerator_7333 (operand_7302->mTerminalList, true) ;
            const GGS_lstringlist::cElement * operand_7333 = NULL ;
            while (((operand_7333 = enumerator_7333.nextObject ()))) {
              macroValidPointer (operand_7333) ;
              const GGS_bool cond_7595 = (var_cas_terminalSymbolSet.reader_hasKey (operand_7333->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (190)))).operator_not () ;
              if (cond_7595.isBuiltAndTrue ()) {
                operand_7333->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '$")).operator_concat (operand_7333->mValue)).operator_concat (GGS_string ("$' terminal symbol is not declared by the '"))).operator_concat (operand_6243->mLexiqueFileName)).operator_concat (GGS_string ("' lexique")) COMMA_SOURCE_FILE_AT_LINE (197)) ;
              }
            }
          }
        }
      ...
      {
        GGS_guiCompoundAttributeListAST::cEnumerator enumerator_7744 (operand_6243->mCompoundAttributes, true) ;
        const GGS_guiCompoundAttributeListAST::cElement * operand_7744 = NULL ;
        while (((operand_7744 = enumerator_7744.nextObject ()))) {
          macroValidPointer (operand_7744) ;
          const GGS_bool cond_7885 = (operand_7744->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isNotEqual (GGS_string ("textMacro")) ;
          if (cond_7885.isBuiltAndTrue ()) {
            operand_7744->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("for a compound attribute, only the 'textMacro' key is valid") COMMA_SOURCE_FILE_AT_LINE (205)) ;
          }else if (cond_7885.isBuiltAndFalse ()) {
            var_cas_textMacroList.addAssign_operation (operand_7744->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), operand_7744->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
          }
        }
      }
      ...
      {
        GGS_guiSimpleAttributeListAST::cEnumerator enumerator_8226 (operand_6243->mSimpleAttributes, true) ;
        const GGS_guiSimpleAttributeListAST::cElement * operand_8226 = NULL ;
        while (((operand_8226 = enumerator_8226.nextObject ()))) {
          macroValidPointer (operand_8226) ;
          const GGS_bool cond_8453 = (operand_8226->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isEqual (GGS_string ("fileExtension")) ;
          if (cond_8453.isBuiltAndTrue ()) {
            var_cas_context.mExtensionMap.modifier_insertKey (inLexique, operand_8226->mValue, operand_6243->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () COMMA_SOURCE_FILE_AT_LINE (217)) ;
            var_cas_hasAssociatedExtension = GGS_bool (true) ;
          }else if (cond_8453.isBuiltAndFalse ()) {
            const GGS_bool cond_8692 = (operand_8226->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).operator_isEqual (GGS_string ("title")) ;
            if (cond_8692.isBuiltAndTrue ()) {
              const GGS_bool cond_8599 = var_cas_hasTabViewTitle ;
              if (cond_8599.isBuiltAndTrue ()) {
                operand_8226->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8226->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (222)) ;
              }
              var_cas_hasTabViewTitle = GGS_bool (true) ;
              var_cas_tabViewTitle = operand_8226->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
            }else if (cond_8692.isBuiltAndFalse ()) {
              const GGS_bool cond_8937 = (operand_8226->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).operator_isEqual (GGS_string ("blockComment")) ;
              if (cond_8937.isBuiltAndTrue ()) {
                const GGS_bool cond_8845 = var_cas_hasBlockComment ;
                if (cond_8845.isBuiltAndTrue ()) {
                  operand_8226->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8226->mKey)).operator_concat (GGS_string ("' key should be defined once")) COMMA_SOURCE_FILE_AT_LINE (228)) ;
                }
                var_cas_hasBlockComment = GGS_bool (true) ;
                var_cas_blockComment = operand_8226->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
              }else if (cond_8937.isBuiltAndFalse ()) {
                operand_8226->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_8226->mKey)).operator_concat (GGS_string ("' key is not valid (valid keys: 'blockComment,', 'fileExtension', 'title')")) COMMA_SOURCE_FILE_AT_LINE (233)) ;
              }
            }
          }
        }
      }
      const GGS_bool cond_9282 = (var_cas_hasAssociatedExtension).operator_not () ;
      if (cond_9282.isBuiltAndTrue ()) {
        operand_6243->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more file extensions should be associated with a lexique (fileExtension : \"...\")") COMMA_SOURCE_FILE_AT_LINE (238)) ;
      }
      const GGS_bool cond_9438 = (var_cas_hasTabViewTitle).operator_not () ;
      if (cond_9438.isBuiltAndTrue ()) {
        operand_6243->mLexiqueFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'title' key should be defined once (it is not defined)") COMMA_SOURCE_FILE_AT_LINE (242)) ;
      }
      var_cas_context.mWithLexiqueList.addAssign_operation (operand_6243->mLexiqueFileName.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_blockComment, var_cas_tabViewTitle, var_cas_textMacroList, operand_6243->mLabels) ;
    }
  }
  const GGS_bool cond_9983 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9983.isBuiltAndTrue ()) {
