...
//--- Introspection
  ...
  public : static GGS_programComponentAST castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Readers
  ...
  reader_mProgramComponentName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  reader_mEndOfPrologue (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  public : inline GGS_location 
  reader_mEndOfEpilogue (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
