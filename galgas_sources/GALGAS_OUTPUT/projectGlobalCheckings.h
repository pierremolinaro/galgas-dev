...
//                    september 23th, 2010, at 15h21'28"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
class GGS_multiMethodMapForGlobalCheckings ;
class GGS_multiReaderMapForGlobalCheckings ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 Map '@multiMethodMapForGlobalCheckings'                   *
//                                                                           *
//---------------------------------------------------------------------------*

class elementOf_GGS_multiMethodMapForGlobalCheckings ;

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_multiMethodMapForGlobalCheckings ;

//---------------------------------------------------------------------------*

class GGS_multiMethodMapForGlobalCheckings : public AC_GGS_map {
//--- Element Class
  public : typedef elementOf_GGS_multiMethodMapForGlobalCheckings cElement ;
...
//--- Comparison methods
  public : GGS_bool operator_isEqual (const GGS_multiMethodMapForGlobalCheckings & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_multiMethodMapForGlobalCheckings & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_multiMethodMapForGlobalCheckings castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Get object pointer (for method call)
  public : inline GGS_multiMethodMapForGlobalCheckings * operator () (UNUSED_LOCATION_ARGS) { return this ; }
  public : inline const GGS_multiMethodMapForGlobalCheckings * operator () (UNUSED_LOCATION_ARGS) const { return this ; }

//--- 'emptyMap' constructor
  public : static GGS_multiMethodMapForGlobalCheckings constructor_emptyMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;

//--- 'mapWithKeyAndValue' constructor
  public : static GGS_multiMethodMapForGlobalCheckings constructor_mapWithKeyAndValue (C_Compiler & inLexique,
...
//--- Internal method for searching for an element
  ...
  public : static GGS_multiMethodMapForGlobalCheckings constructor_mapWithMapToOverride (C_Compiler & inLexique,
                                            const GGS_multiMethodMapForGlobalCheckings & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_multiMethodMapForGlobalCheckings reader_overriddenMap (C_Compiler & inLexique
                                            COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Map Enumerator
  ...
  //--- Constructors
    public : inline cEnumerator (const GGS_multiMethodMapForGlobalCheckings & inMap,
                                 const bool inAscending) :
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 Map '@multiReaderMapForGlobalCheckings'                   *
//                                                                           *
//---------------------------------------------------------------------------*

class elementOf_GGS_multiReaderMapForGlobalCheckings ;

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_multiReaderMapForGlobalCheckings ;

//---------------------------------------------------------------------------*

class GGS_multiReaderMapForGlobalCheckings : public AC_GGS_map {
//--- Element Class
  public : typedef elementOf_GGS_multiReaderMapForGlobalCheckings cElement ;
...
//--- Comparison methods
  public : GGS_bool operator_isEqual (const GGS_multiReaderMapForGlobalCheckings & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_multiReaderMapForGlobalCheckings & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_multiReaderMapForGlobalCheckings castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Get object pointer (for method call)
  public : inline GGS_multiReaderMapForGlobalCheckings * operator () (UNUSED_LOCATION_ARGS) { return this ; }
  public : inline const GGS_multiReaderMapForGlobalCheckings * operator () (UNUSED_LOCATION_ARGS) const { return this ; }

//--- 'emptyMap' constructor
  public : static GGS_multiReaderMapForGlobalCheckings constructor_emptyMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;

//--- 'mapWithKeyAndValue' constructor
  public : static GGS_multiReaderMapForGlobalCheckings constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey
...
//--- Internal method for searching for an element
  protected : void searchElement (C_Compiler & inLexique,
                                  ...
                                  COMMA_LOCATION_ARGS) const ;
  public : virtual GGS_string reader_description (const PMSInt32 inIndentation = 0) const ;
  public : static GGS_multiReaderMapForGlobalCheckings constructor_mapWithMapToOverride (C_Compiler & inLexique,
                                            const GGS_multiReaderMapForGlobalCheckings & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_multiReaderMapForGlobalCheckings reader_overriddenMap (C_Compiler & inLexique
                                            COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Map Enumerator
  public : class cEnumerator : public cAbstractMapEnumerator {
  //--- Constructors
    public : inline cEnumerator (const GGS_multiReaderMapForGlobalCheckings & inMap,
                                 const bool inAscending) :
    cAbstractMapEnumerator (inMap, inAscending) {
    }
    public : inline cEnumerator (const GGS_multiReaderMapForGlobalCheckings & inMap) :
...
//---------------------------------------------------------------------------*
//                                                                           *
//            Element of map '@multiMethodMapForGlobalCheckings'             *
//                                                                           *
//---------------------------------------------------------------------------*

class e_multiMethodMapForGlobalCheckings {

} ;

//---------------------------------------------------------------------------*

class elementOf_GGS_multiMethodMapForGlobalCheckings : public AC_galgas_map_element {
//--- Constructor
  public : elementOf_GGS_multiMethodMapForGlobalCheckings (const GGS_lstring & inKey,
                                     const PMSInt32 inIndex,
                                     const e_multiMethodMapForGlobalCheckings & inInfo,
                                     const PMUInt32 inInitialState = 0) ;
//--- Get pointers
  public : inline elementOf_GGS_multiMethodMapForGlobalCheckings * nextObject (void) const { return (elementOf_GGS_multiMethodMapForGlobalCheckings *) mNextItem ; }
  public : inline elementOf_GGS_multiMethodMapForGlobalCheckings * infObject (void) const { return (elementOf_GGS_multiMethodMapForGlobalCheckings *) mInfPtr ; }
  public : inline elementOf_GGS_multiMethodMapForGlobalCheckings * supObject (void) const { return (elementOf_GGS_multiMethodMapForGlobalCheckings *) mSupPtr ; }
//--- Comparison
  protected : virtual bool isEqualToMapElement (const AC_galgas_map_element * inOperand) const ;
//--- Data member
  public : e_multiMethodMapForGlobalCheckings mInfo ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//            Element of map '@multiReaderMapForGlobalCheckings'             *
//                                                                           *
//---------------------------------------------------------------------------*

class e_multiReaderMapForGlobalCheckings {

} ;

//---------------------------------------------------------------------------*

class elementOf_GGS_multiReaderMapForGlobalCheckings : public AC_galgas_map_element {
//--- Constructor
  public : elementOf_GGS_multiReaderMapForGlobalCheckings (const GGS_lstring & inKey,
                                     const PMSInt32 inIndex,
                                     const e_multiReaderMapForGlobalCheckings & inInfo,
                                     const PMUInt32 inInitialState = 0) ;
//--- Get pointers
  public : inline elementOf_GGS_multiReaderMapForGlobalCheckings * nextObject (void) const { return (elementOf_GGS_multiReaderMapForGlobalCheckings *) mNextItem ; }
  public : inline elementOf_GGS_multiReaderMapForGlobalCheckings * infObject (void) const { return (elementOf_GGS_multiReaderMapForGlobalCheckings *) mInfPtr ; }
  public : inline elementOf_GGS_multiReaderMapForGlobalCheckings * supObject (void) const { return (elementOf_GGS_multiReaderMapForGlobalCheckings *) mSupPtr ; }
//--- Comparison
  protected : virtual bool isEqualToMapElement (const AC_galgas_map_element * inOperand) const ;
//--- Data member
  public : e_multiReaderMapForGlobalCheckings mInfo ;
//--- Method for 'description' reader
  public : void appendForMapDescription (const PMSInt32 inElementIndex,
                                         C_String & ioString,
                                         const PMSInt32 inIndentation) const ;
