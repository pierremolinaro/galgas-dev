...
GGS_typeConditionChaine::
GGS_typeConditionChaine (const GGS_typeConditionChaine & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeConditionCaractere::
GGS_typeConditionCaractere (const GGS_typeConditionCaractere & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeConditionIntervalle::
GGS_typeConditionIntervalle (const GGS_typeConditionIntervalle & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeArgumentAttribut::
GGS_typeArgumentAttribut (const GGS_typeArgumentAttribut & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeArgumentCaractere::
GGS_typeArgumentCaractere (const GGS_typeArgumentCaractere & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeArgumentCaractereCourant::
GGS_typeArgumentCaractereCourant (const GGS_typeArgumentCaractereCourant & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeArgumentEntier::
GGS_typeArgumentEntier (const GGS_typeArgumentEntier & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeArgumentRoutine::
GGS_typeArgumentRoutine (const GGS_typeArgumentRoutine & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeEmissionTerminalParDefaut::
GGS_typeEmissionTerminalParDefaut (const GGS_typeEmissionTerminalParDefaut & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeEmissionErreurParDefaut::
GGS_typeEmissionErreurParDefaut (const GGS_typeEmissionErreurParDefaut & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeInstructionActionExterne::
GGS_typeInstructionActionExterne (const GGS_typeInstructionActionExterne & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeInstructionRepetitionLexicale::
GGS_typeInstructionRepetitionLexicale (const GGS_typeInstructionRepetitionLexicale & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeInstructionSiLexical::
GGS_typeInstructionSiLexical (const GGS_typeInstructionSiLexical & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeInstructionEmettreSimple::
GGS_typeInstructionEmettreSimple (const GGS_typeInstructionEmettreSimple & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeInstructionEmettre::
GGS_typeInstructionEmettre (const GGS_typeInstructionEmettre & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeInstructionErreurLexicale::
GGS_typeInstructionErreurLexicale (const GGS_typeInstructionErreurLexicale & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
