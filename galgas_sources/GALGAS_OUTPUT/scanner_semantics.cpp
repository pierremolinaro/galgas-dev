...
_operator_isEqual (const GGS_typeConditionLexicale & inOperand) const {
...
GGS_bool GGS_typeConditionLexicale::
_operator_isNotEqual (const GGS_typeConditionLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeConditionChaine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeConditionChaine::
_operator_isNotEqual (const GGS_typeConditionChaine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_typeConditionNonChaine (void) {
  mPointer = NULL ;
}
...
GGS_typeConditionNonChaine::
GGS_typeConditionNonChaine (const GGS_typeConditionNonChaine & inOperand)
:GGS_typeConditionLexicale () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_typeConditionNonChaine::
~GGS_typeConditionNonChaine (void) {
  macroDetachPointer (mPointer, cPtr_typeConditionNonChaine) ;
}

//---------------------------------------------------------------------------*

void GGS_typeConditionNonChaine::
operator = (const GGS_typeConditionNonChaine & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
GGS_bool GGS_typeConditionNonChaine::
_operator_isEqual (const GGS_typeConditionNonChaine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeConditionNonChaine::
_operator_isNotEqual (const GGS_typeConditionNonChaine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_string GGS_typeConditionNonChaine::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  C_String s ;
  s << "<class @typeConditionNonChaine" ;
  if (_isBuilt ()) {
    mPointer->appendForDescription (_inLexique, s, inIndentation + 1 COMMA_THERE) ;
  }else{
    s << "not built" ;
...
_operator_isEqual (const GGS_typeConditionCaractere & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeConditionCaractere::
_operator_isNotEqual (const GGS_typeConditionCaractere & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeConditionIntervalle & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeConditionIntervalle::
_operator_isNotEqual (const GGS_typeConditionIntervalle & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeListeConditionsLexicales & inOperand) const {
...
GGS_bool GGS_typeListeConditionsLexicales::
_operator_isNotEqual (const GGS_typeListeConditionsLexicales & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeInstructionLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionLexicale::
_operator_isNotEqual (const GGS_typeInstructionLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_tListeInstructionsLexicales & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_tListeInstructionsLexicales::
_operator_isNotEqual (const GGS_tListeInstructionsLexicales & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeListeTestsEtInstructions & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeListeTestsEtInstructions::
_operator_isNotEqual (const GGS_typeListeTestsEtInstructions & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeArgumentRoutineExterne & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeArgumentRoutineExterne::
_operator_isNotEqual (const GGS_typeArgumentRoutineExterne & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeListeArgumentsRoutExterne & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeListeArgumentsRoutExterne::
_operator_isNotEqual (const GGS_typeListeArgumentsRoutExterne & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeArgumentAttribut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeArgumentAttribut::
_operator_isNotEqual (const GGS_typeArgumentAttribut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeArgumentCaractere & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeArgumentCaractere::
_operator_isNotEqual (const GGS_typeArgumentCaractere & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeArgumentCaractereCourant & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeArgumentCaractereCourant::
_operator_isNotEqual (const GGS_typeArgumentCaractereCourant & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeArgumentEntier & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeArgumentEntier::
_operator_isNotEqual (const GGS_typeArgumentEntier & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeArgumentRoutine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeArgumentRoutine::
_operator_isNotEqual (const GGS_typeArgumentRoutine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeListeMessagesErreur & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeListeMessagesErreur::
_operator_isNotEqual (const GGS_typeListeMessagesErreur & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeEmissionParDefaut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeEmissionParDefaut::
_operator_isNotEqual (const GGS_typeEmissionParDefaut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeEmissionTerminalParDefaut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeEmissionTerminalParDefaut::
_operator_isNotEqual (const GGS_typeEmissionTerminalParDefaut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeEmissionErreurParDefaut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeEmissionErreurParDefaut::
_operator_isNotEqual (const GGS_typeEmissionErreurParDefaut & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeListeRecherche & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_typeListeRecherche::
_operator_isNotEqual (const GGS_typeListeRecherche & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_typeInstructionActionExterne & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionActionExterne::
_operator_isNotEqual (const GGS_typeInstructionActionExterne & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeInstructionRepetitionLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionRepetitionLexicale::
_operator_isNotEqual (const GGS_typeInstructionRepetitionLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeInstructionSiLexical & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionSiLexical::
_operator_isNotEqual (const GGS_typeInstructionSiLexical & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeInstructionEmettreSimple & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionEmettreSimple::
_operator_isNotEqual (const GGS_typeInstructionEmettreSimple & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeLexicalDropInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeLexicalDropInstruction::
_operator_isNotEqual (const GGS_typeLexicalDropInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_typeLexicalLogInstruction (void) {
  mPointer = NULL ;
}
...
GGS_typeLexicalLogInstruction::
GGS_typeLexicalLogInstruction (const GGS_typeLexicalLogInstruction & inOperand)
:GGS_typeInstructionLexicale () {
  macroAssignPointer (mPointer, inOperand.mPointer) ;
}
...
GGS_typeLexicalLogInstruction::
~GGS_typeLexicalLogInstruction (void) {
  macroDetachPointer (mPointer, cPtr_typeLexicalLogInstruction) ;
}

//---------------------------------------------------------------------------*

void GGS_typeLexicalLogInstruction::
operator = (const GGS_typeLexicalLogInstruction & inSource) {
  macroAssignPointer (mPointer, inSource.mPointer) ;
}
...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_typeLexicalLogInstruction (THERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GGS_bool GGS_typeLexicalLogInstruction::
_operator_isEqual (const GGS_typeLexicalLogInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeLexicalLogInstruction::
_operator_isNotEqual (const GGS_typeLexicalLogInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_string GGS_typeLexicalLogInstruction::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  C_String s ;
  s << "<class @typeLexicalLogInstruction" ;
  if (_isBuilt ()) {
    mPointer->appendForDescription (_inLexique, s, inIndentation + 1 COMMA_THERE) ;
  }else{
    s << "not built" ;
...
_operator_isEqual (const GGS_typeLexicalTagInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeLexicalTagInstruction::
_operator_isNotEqual (const GGS_typeLexicalTagInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeLexicalRewindAndSendInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeLexicalRewindAndSendInstruction::
_operator_isNotEqual (const GGS_typeLexicalRewindAndSendInstruction & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeInstructionEmettre & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionEmettre::
_operator_isNotEqual (const GGS_typeInstructionEmettre & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeInstructionErreurLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeInstructionErreurLexicale::
_operator_isNotEqual (const GGS_typeInstructionErreurLexicale & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
