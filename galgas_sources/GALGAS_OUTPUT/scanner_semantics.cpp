...
void GGS_typeLexicalAttributesMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_AC_galgasType   & outParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the lexical attribute '",
...
void GGS_typeLexicalAttributesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_AC_galgasType & inParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the lexical attribute '",
...
void GGS_lexicalTypeMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_AC_galgasType   & outParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"there is no type named '%'",
...
void GGS_lexicalTypeMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_AC_galgasType & inParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"--- internal error ---",
...
void GGS_typeTableMessagesErreurs::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the error message '",
...
void GGS_M_styles::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_typeTableDefinitionTerminaux::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_string  & outParameter0,
                                GGS_typeListeAttributsSemantiques   & outParameter1,
                                GGS_luint   & outParameter2,
...
void GGS_typeTableDefinitionTerminaux::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_string& inParameter0,
                                const GGS_typeListeAttributsSemantiques & inParameter1,
                                const GGS_luint & inParameter2,
...
void GGS_typeTableMotsReserves::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the word '",
...
void GGS_typeTableMotsReserves::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the word '",
...
void GGS_typeTableTablesDeMotsReserves::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_typeTableMotsReserves   & outParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the mord map '",
...
void GGS_typeTableTablesDeMotsReserves::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_typeTableMotsReserves & inParameter0,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the word map '",
