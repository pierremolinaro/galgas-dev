...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mPreservesStartDelimiter.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mEndString.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_templateDelimiterMap * _p = dynamic_cast <const elementOf_GGS_templateDelimiterMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.mPreservesStartDelimiter._operator_isEqual (_p->mInfo.mPreservesStartDelimiter)).boolValue ()
           && (mInfo.mEndString._operator_isEqual (_p->mInfo.mEndString)).boolValue () ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mReplacedString.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_templateReplacementMap * _p = dynamic_cast <const elementOf_GGS_templateReplacementMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.mReplacedString._operator_isEqual (_p->mInfo.mReplacedString)).boolValue () ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    const elementOf_GGS_styleList * _p = dynamic_cast <const elementOf_GGS_styleList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mStyleName._operator_isEqual (_p->mStyleName).boolValue ()
         && mTitle._operator_isEqual (_p->mTitle).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mStyleName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mTitle.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mStyleName,
                                _p->mTitle
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
...
internalSubListWithRange (GGS_styleList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mStyleName, _p->mTitle) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@styleList", inIndentation COMMA_THERE) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mIsEndOfTemplateMark.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mErrorMessage._operator_isEqual (_p->mInfo.mErrorMessage)).boolValue ()
           ...
           && (mInfo.mIsEndOfTemplateMark._operator_isEqual (_p->mInfo.mIsEndOfTemplateMark)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = mStrings._operator_isEqual (_p->mStrings).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@typeConditionNonChaine:"
           << mStrings.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
cPtr_typeInstructionExitLoop::
cPtr_typeInstructionExitLoop (LOCATION_ARGS)
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_typeInstructionExitLoop * GGS_typeInstructionExitLoop::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeInstructionExitLoop *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
...
appendForDescription (C_Compiler & /* _inLexique */,
                      ...
                      const sint32 /* inIndentation */
                      COMMA_UNUSED_LOCATION_ARGS) const {
  ioString << "->@typeInstructionExitLoop:" ;
}
...
const char * cPtr_typeInstructionExitLoop::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_typeInstructionExitLoop (& typeid (cPtr_typeInstructionExitLoop), & typeid (cPtr_typeInstructionLexicale), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_typeInstructionExitLoop::galgasRTTI (void) const {
  return & gClassInfoFor__typeInstructionExitLoop ;
}
...
GGS_typeInstructionExitLoop::
GGS_typeInstructionExitLoop (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_typeInstructionExitLoop::
GGS_typeInstructionExitLoop (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_typeInstructionExitLoop GGS_typeInstructionExitLoop::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_typeInstructionExitLoop _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_typeInstructionExitLoop *> (inPointer) != NULL)
      : (typeid (cPtr_typeInstructionExitLoop) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_typeInstructionExitLoop (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_typeInstructionExitLoop),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
static cPtr_typeInstructionExitLoop * gSingleton_typeInstructionExitLoop = NULL ;

//---------------------------------------------------------------------------*

static void cleanUp_typeInstructionExitLoop (void) {
  macroDetachPointer (gSingleton_typeInstructionExitLoop, cPtr_typeInstructionExitLoop) ;
}
...
constructor_new (C_Compiler & /* inLexique */
                                COMMA_LOCATION_ARGS) {
  GGS_typeInstructionExitLoop result ;
  if (NULL == gSingleton_typeInstructionExitLoop) {
    macroMyNew (gSingleton_typeInstructionExitLoop, cPtr_typeInstructionExitLoop (THERE)) ;
    registerReleaseRoutine (cleanUp_typeInstructionExitLoop) ;
  }
  macroAssignPointer (result.mPointer, gSingleton_typeInstructionExitLoop) ;
  return result ;
}

//---------------------------------------------------------------------------*

const char * GGS_typeInstructionExitLoop::actualTypeName (void) const {
  return "typeInstructionExitLoop" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionExitLoop ("typeInstructionExitLoop", gClassInfoFor__typeInstructionLexicale) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//       Implementation of routine "appendToLexicalInstructionList34         *
//                                                                           *
//---------------------------------------------------------------------------*
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mTerminalSymbol.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
