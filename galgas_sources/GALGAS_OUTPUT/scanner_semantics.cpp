...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mEndString._operator_isEqual (_p->mInfo.mEndString)).boolValue () ;
}
...
_searchElement (C_Compiler & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mEndString ;
    if (outIndex != NULL) {
...
void GGS_templateDelimiterMap::
modifier_setMEndStringForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
...
void GGS_templateReplacementMap::
modifier_setMReplacedStringForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeLexicalAttributesMap::
modifier_setAttributTypeForKey (C_Compiler & inLexique,                        const GGS_AC_galgasType & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_lexicalTypeMap::
modifier_setMAttributTypeForKey (C_Compiler & inLexique,                        const GGS_AC_galgasType & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeTableMessagesErreurs::
modifier_setMErrorMessageForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_M_styles::
modifier_setMTitleForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMTitleForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mTitle = inValue ;
    }
  }
}
...
const GGS_lstring  * GGS_M_styles::cEnumerator::_mTitle (LOCATION_ARGS) const {
  return & (((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mTitle) ;
}
...
void GGS_typeTableDefinitionTerminaux::
modifier_setMErrorMessageForKey (C_Compiler & inLexique,                        const GGS_string& inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeTableDefinitionTerminaux::
modifier_setAttributListeDesAttributsForKey (C_Compiler & inLexique,                        const GGS_typeListeAttributsSemantiques & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeTableDefinitionTerminaux::
modifier_setMStyleIndexForKey (C_Compiler & inLexique,                        const GGS_luint & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeTableMotsReserves::
modifier_setAttributNomTerminalForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_typeTableTablesDeMotsReserves::
modifier_setAttributSimpleTableForKey (C_Compiler & inLexique,                        const GGS_typeTableMotsReserves & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
GGS_typeListeConditionsLexicales::cElement * GGS_typeListeConditionsLexicales::
...
GGS_tListeInstructionsLexicales::cElement * GGS_tListeInstructionsLexicales::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
GGS_typeListeTestsEtInstructions::cElement * GGS_typeListeTestsEtInstructions::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
GGS_typeListeArgumentsRoutExterne::cElement * GGS_typeListeArgumentsRoutExterne::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
GGS_typeListeMessagesErreur::cElement * GGS_typeListeMessagesErreur::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
GGS_typeListeRecherche::cElement * GGS_typeListeRecherche::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
void GGS_tokensInListMap::
modifier_setMTerminalSymbolForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
