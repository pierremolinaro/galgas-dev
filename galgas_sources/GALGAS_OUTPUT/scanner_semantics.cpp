...
GGS_typeListeConditionsLexicales::GGS_typeListeConditionsLexicales (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_tListeInstructionsLexicales::GGS_tListeInstructionsLexicales (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_typeListeTestsEtInstructions::GGS_typeListeTestsEtInstructions (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_typeListeArgumentsRoutExterne::GGS_typeListeArgumentsRoutExterne (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_typeListeMessagesErreur::GGS_typeListeMessagesErreur (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_typeListeRecherche::GGS_typeListeRecherche (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
