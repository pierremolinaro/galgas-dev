...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mPreservesStartDelimiter.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mEndString.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mPreservesStartDelimiter._operator_isEqual (ptr->mInfo.mPreservesStartDelimiter)).boolValue ()
           && (mInfo.mEndString._operator_isEqual (ptr->mInfo.mEndString)).boolValue () ;
}
...
_operator_isEqual (const GGS_templateDelimiterMap & inOperand) const {
...
GGS_bool GGS_templateDelimiterMap::
_operator_isNotEqual (const GGS_templateDelimiterMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), ! isEqualToMap (inOperand)) ;
}
...
void GGS_templateDelimiterMap::
modifier_setMPreservesStartDelimiterForKey (C_Compiler & inLexique,
  ...
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      ...
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMPreservesStartDelimiterForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mPreservesStartDelimiter = inValue ;
    }
  }
}
...
void GGS_templateDelimiterMap::
modifier_setMEndStringForKey (C_Compiler & inLexique,
  ...
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMEndStringForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mEndString = inValue ;
    }
  }
}
...
method_searchKey (C_Compiler & inLexique,
  ...
  _searchElement (inLexique,
                  "the template start string '%K' is not declared",
                  inKey,
                  outParameter0,
                  outParameter1,
                  NULL
...
modifier_insertKey (C_Compiler & inLexique,
  ...
  _insertElement (inLexique,
                 "the template start string '%K' is already declared in %L",
                 inKey,
                 inParameter0,
                 inParameter1,
                 NULL
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mReplacedString.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mReplacementFunction.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mReplacedString._operator_isEqual (ptr->mInfo.mReplacedString)).boolValue ()
           && (mInfo.mReplacementFunction._operator_isEqual (ptr->mInfo.mReplacementFunction)).boolValue () ;
}
...
_operator_isEqual (const GGS_templateReplacementMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), isEqualToMap (inOperand)) ;
}
...
GGS_bool GGS_templateReplacementMap::
_operator_isNotEqual (const GGS_templateReplacementMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), ! isEqualToMap (inOperand)) ;
}
...
void GGS_templateReplacementMap::
modifier_setMReplacedStringForKey (C_Compiler & inLexique,
                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMReplacedStringForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mReplacedString = inValue ;
    }
  }
}
...
void GGS_templateReplacementMap::
modifier_setMReplacementFunctionForKey (C_Compiler & inLexique,
                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMReplacementFunctionForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mReplacementFunction = inValue ;
    }
  }
}
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_lstring   & outParameter1 COMMA_LOCATION_ARGS) const {
  _searchElement (inLexique,
                  "the template replacement string '%K' is not declared",
                  inKey,
                  outParameter0,
                  outParameter1,
                  NULL
...
modifier_insertKey (C_Compiler & inLexique,
                                ...
                                const GGS_lstring & inParameter1 COMMA_LOCATION_ARGS) {
  _insertElement (inLexique,
                 "the template replacement string '%K' is already declared in %L",
                 inKey,
                 inParameter0,
                 inParameter1,
                 NULL
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.attributType.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.attributType._operator_isEqual (ptr->mInfo.attributType)).boolValue () ;
}
...
void GGS_typeLexicalAttributesMap::
modifier_setAttributTypeForKey (C_Compiler & inLexique,
  ...
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setAttributTypeForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.attributType = inValue ;
    }
  }
}
...
modifier_insertKey (C_Compiler & inLexique,
  ...
  if (shadowExists) {
    emitMapSemanticErrorMessage (inLexique, inKey, "the '%K' tag declaration shadows the tag declared in %L" COMMA_THERE) ;
  }else{
    _insertElement (inLexique,
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mAttributType._operator_isEqual (ptr->mInfo.mAttributType)).boolValue () ;
}
...
_operator_isEqual (const GGS_EXLexicalTypeMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), isEqualToMap (inOperand)) ;
}
...
GGS_bool GGS_EXLexicalTypeMap::
_operator_isNotEqual (const GGS_EXLexicalTypeMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), ! isEqualToMap (inOperand)) ;
}
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mErrorMessage.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mErrorMessage._operator_isEqual (ptr->mInfo.mErrorMessage)).boolValue () ;
}
...
void GGS_typeTableMessagesErreurs::
modifier_setMErrorMessageForKey (C_Compiler & inLexique,
                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMErrorMessageForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mErrorMessage = inValue ;
    }
  }
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mStyleName._operator_isEqual (ptr->mStyleName).boolValue ()
         && mTitle._operator_isEqual (ptr->mTitle).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mStyleName.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
_operator_concat (const GGS_styleList & inOperand) const {
...
void GGS_styleList::
_dotAssign_operation (const GGS_styleList inOperand) {
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mStyleName,
                                ptr->mTitle
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@styleList", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_string & GGS_styleList::cEnumerator::_mStyleName (LOCATION_ARGS) const {
  ...
  return ((cElement *) mCurrentEnumeratedObject)->mStyleName ;
}
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.attributListeDesAttributs.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mStyleIndex.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mIsEndOfTemplateMark.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mErrorMessage._operator_isEqual (ptr->mInfo.mErrorMessage)).boolValue ()
           && (mInfo.attributListeDesAttributs._operator_isEqual (ptr->mInfo.attributListeDesAttributs)).boolValue ()
           && (mInfo.mStyleIndex._operator_isEqual (ptr->mInfo.mStyleIndex)).boolValue ()
           && (mInfo.mIsEndOfTemplateMark._operator_isEqual (ptr->mInfo.mIsEndOfTemplateMark)).boolValue () ;
}
...
void GGS_typeTableDefinitionTerminaux::
modifier_setAttributListeDesAttributsForKey (C_Compiler & inLexique,
  ...
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setAttributListeDesAttributsForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.attributListeDesAttributs = inValue ;
    }
  }
}
...
void GGS_typeTableDefinitionTerminaux::
modifier_setMStyleIndexForKey (C_Compiler & inLexique,
  ...
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMStyleIndexForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mStyleIndex = inValue ;
    }
  }
}
...
void GGS_typeTableDefinitionTerminaux::
modifier_setMIsEndOfTemplateMarkForKey (C_Compiler & inLexique,
                        const GGS_bool& inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMIsEndOfTemplateMarkForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mIsEndOfTemplateMark = inValue ;
    }
  }
}
...
/* const */ GGS_luint  & GGS_typeTableDefinitionTerminaux::cEnumerator::_mStyleIndex (LOCATION_ARGS) const {
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.attributNomTerminal.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.attributNomTerminal._operator_isEqual (ptr->mInfo.attributNomTerminal)).boolValue () ;
}
...
void GGS_typeTableMotsReserves::
modifier_setAttributNomTerminalForKey (C_Compiler & inLexique,
                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setAttributNomTerminalForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.attributNomTerminal = inValue ;
    }
  }
}
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.attributSimpleTable.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.attributSimpleTable._operator_isEqual (ptr->mInfo.attributSimpleTable)).boolValue () ;
}
...
void GGS_typeTableTablesDeMotsReserves::
modifier_setAttributSimpleTableForKey (C_Compiler & inLexique,
  ...
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setAttributSimpleTableForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.attributSimpleTable = inValue ;
    }
  }
}
...
AC_galgasClassRunTimeInformation * cPtr_typeConditionLexicale::galgasRTTI (void) const {
...
AC_galgasClassRunTimeInformation * GGS_typeConditionLexicale::_galgasObjectRunTimeInfo (void) const {
...
C_galgasRootClassRunTimeInformation gClassInfoFor__typeConditionLexicale ("typeConditionLexicale") ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mUnicodeCharSetName._operator_isEqual (ptr->mUnicodeCharSetName).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeUnicodeCharSet:"
           << mUnicodeCharSetName.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeUnicodeCharSet::galgasRTTI (void) const {
...
GGS_typeUnicodeCharSet (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_typeUnicodeCharSet _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_typeUnicodeCharSet (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__typeUnicodeCharSet ("typeUnicodeCharSet", gClassInfoFor__typeConditionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributChaine._operator_isEqual (ptr->attributChaine).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeConditionChaine:"
           << attributChaine.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeConditionChaine::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeConditionChaine ("typeConditionChaine", gClassInfoFor__typeConditionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mStrings._operator_isEqual (ptr->mStrings).boolValue ()
         && mEndOfFileErrorMessageIndex._operator_isEqual (ptr->mEndOfFileErrorMessageIndex).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeConditionNonChaine:"
           << mStrings.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mEndOfFileErrorMessageIndex.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeConditionNonChaine::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeConditionNonChaine ("typeConditionNonChaine", gClassInfoFor__typeConditionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributCaractere._operator_isEqual (ptr->attributCaractere).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeConditionCaractere:"
           << attributCaractere.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeConditionCaractere::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeConditionCaractere ("typeConditionCaractere", gClassInfoFor__typeConditionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributBorneInf._operator_isEqual (ptr->attributBorneInf).boolValue ()
         && attributBorneSup._operator_isEqual (ptr->attributBorneSup).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeConditionIntervalle:"
           << attributBorneInf.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributBorneSup.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeConditionIntervalle::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeConditionIntervalle ("typeConditionIntervalle", gClassInfoFor__typeConditionLexicale) ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributCondition._operator_isEqual (ptr->attributCondition).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributCondition.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
void GGS_typeListeConditionsLexicales::
_dotAssign_operation (const GGS_typeListeConditionsLexicales inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->attributCondition
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
  }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@typeListeConditionsLexicales", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_typeConditionLexicale  & GGS_typeListeConditionsLexicales::cEnumerator::_attributCondition (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributCondition ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionLexicale::galgasRTTI (void) const {
...
AC_galgasClassRunTimeInformation * GGS_typeInstructionLexicale::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
C_galgasRootClassRunTimeInformation gClassInfoFor__typeInstructionLexicale ("typeInstructionLexicale") ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributInstruction._operator_isEqual (ptr->attributInstruction).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributInstruction.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
void GGS_tListeInstructionsLexicales::
_dotAssign_operation (const GGS_tListeInstructionsLexicales inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->attributInstruction
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
  }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@tListeInstructionsLexicales", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_typeInstructionLexicale  & GGS_tListeInstructionsLexicales::cEnumerator::_attributInstruction (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributInstruction ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributListeConditions._operator_isEqual (ptr->attributListeConditions).boolValue ()
         && attributListeInstructions._operator_isEqual (ptr->attributListeInstructions).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributListeConditions.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributListeInstructions.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
void GGS_typeListeTestsEtInstructions::
_dotAssign_operation (const GGS_typeListeTestsEtInstructions inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->attributListeConditions,
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@typeListeTestsEtInstructions", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_typeListeConditionsLexicales  & GGS_typeListeTestsEtInstructions::cEnumerator::_attributListeConditions (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributListeConditions ;
}
...
/* const */ GGS_tListeInstructionsLexicales  & GGS_typeListeTestsEtInstructions::cEnumerator::_attributListeInstructions (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributListeInstructions ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeArgumentRoutineExterne::galgasRTTI (void) const {
...
AC_galgasClassRunTimeInformation * GGS_typeArgumentRoutineExterne::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
C_galgasRootClassRunTimeInformation gClassInfoFor__typeArgumentRoutineExterne ("typeArgumentRoutineExterne") ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributArgument._operator_isEqual (ptr->attributArgument).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributArgument.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
void GGS_typeListeArgumentsRoutExterne::
_dotAssign_operation (const GGS_typeListeArgumentsRoutExterne inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->attributArgument
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
  }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@typeListeArgumentsRoutExterne", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_typeArgumentRoutineExterne  & GGS_typeListeArgumentsRoutExterne::cEnumerator::_attributArgument (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributArgument ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributNom._operator_isEqual (ptr->attributNom).boolValue ()
         && attributTypeAttribut._operator_isEqual (ptr->attributTypeAttribut).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeArgumentAttribut:"
           << attributNom.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributTypeAttribut.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeArgumentAttribut::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeArgumentAttribut ("typeArgumentAttribut", gClassInfoFor__typeArgumentRoutineExterne) ;
...
AC_galgasClassRunTimeInformation * cPtr_typeArgumentCaractere::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeArgumentCaractere ("typeArgumentCaractere", gClassInfoFor__typeArgumentRoutineExterne) ;
...
AC_galgasClassRunTimeInformation * cPtr_typeArgumentCaractereCourant::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeArgumentCaractereCourant ("typeArgumentCaractereCourant", gClassInfoFor__typeArgumentRoutineExterne) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributValeur._operator_isEqual (ptr->attributValeur).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeArgumentEntier:"
           << attributValeur.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeArgumentEntier::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeArgumentEntier ("typeArgumentEntier", gClassInfoFor__typeArgumentRoutineExterne) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributNomRoutine._operator_isEqual (ptr->attributNomRoutine).boolValue ()
         && attributListeArguments._operator_isEqual (ptr->attributListeArguments).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeArgumentRoutine:"
           << attributNomRoutine.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributListeArguments.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeArgumentRoutine::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeArgumentRoutine ("typeArgumentRoutine", gClassInfoFor__typeArgumentRoutineExterne) ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mErrorMessageIndex._operator_isEqual (ptr->mErrorMessageIndex).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mErrorMessageIndex.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
void GGS_typeListeMessagesErreur::
_dotAssign_operation (const GGS_typeListeMessagesErreur inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mErrorMessageIndex
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
  }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@typeListeMessagesErreur", inIndentation COMMA_THERE) ;
}
...
GGS_luint  GGS_typeListeMessagesErreur::
...
/* const */ GGS_luint  & GGS_typeListeMessagesErreur::cEnumerator::_mErrorMessageIndex (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mErrorMessageIndex ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeEmissionParDefaut::galgasRTTI (void) const {
...
AC_galgasClassRunTimeInformation * GGS_typeEmissionParDefaut::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
C_galgasRootClassRunTimeInformation gClassInfoFor__typeEmissionParDefaut ("typeEmissionParDefaut") ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributNomTerminal._operator_isEqual (ptr->attributNomTerminal).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeEmissionTerminalParDefaut:"
           << attributNomTerminal.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeEmissionTerminalParDefaut::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeEmissionTerminalParDefaut ("typeEmissionTerminalParDefaut", gClassInfoFor__typeEmissionParDefaut) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeEmissionErreurParDefaut:"
           << mErrorMessageIndex.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeEmissionErreurParDefaut::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeEmissionErreurParDefaut ("typeEmissionErreurParDefaut", gClassInfoFor__typeEmissionParDefaut) ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributNomAttribut._operator_isEqual (ptr->attributNomAttribut).boolValue ()
         && attributNomTable._operator_isEqual (ptr->attributNomTable).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributNomAttribut.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << attributNomTable.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
void GGS_typeListeRecherche::
_dotAssign_operation (const GGS_typeListeRecherche inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->attributNomAttribut,
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@typeListeRecherche", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_lstring  & GGS_typeListeRecherche::cEnumerator::_attributNomAttribut (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributNomAttribut ;
}
...
/* const */ GGS_lstring  & GGS_typeListeRecherche::cEnumerator::_attributNomTable (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->attributNomTable ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributNomRoutineExterne._operator_isEqual (ptr->attributNomRoutineExterne).boolValue ()
         && attributListeArguments._operator_isEqual (ptr->attributListeArguments).boolValue ()
         && attributListeMessageErreur._operator_isEqual (ptr->attributListeMessageErreur).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeInstructionActionExterne:"
           << attributNomRoutineExterne.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributListeArguments.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributListeMessageErreur.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionActionExterne::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionActionExterne ("typeInstructionActionExterne", gClassInfoFor__typeInstructionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributListeInstructionsDebut._operator_isEqual (ptr->attributListeInstructionsDebut).boolValue ()
         && attributListeBranches._operator_isEqual (ptr->attributListeBranches).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeInstructionRepetitionLexicale:"
           << attributListeInstructionsDebut.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributListeBranches.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionRepetitionLexicale::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionRepetitionLexicale ("typeInstructionRepetitionLexicale", gClassInfoFor__typeInstructionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributListeBranches._operator_isEqual (ptr->attributListeBranches).boolValue ()
         && attributBrancheSinon._operator_isEqual (ptr->attributBrancheSinon).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeInstructionSiLexical:"
           << attributListeBranches.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributBrancheSinon.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionSiLexical::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionSiLexical ("typeInstructionSiLexical", gClassInfoFor__typeInstructionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mTerminal._operator_isEqual (ptr->mTerminal).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeInstructionEmettreSimple:"
           << mTerminal.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionEmettreSimple::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionEmettreSimple ("typeInstructionEmettreSimple", gClassInfoFor__typeInstructionLexicale) ;
...
AC_galgasClassRunTimeInformation * cPtr_typeLexicalDropInstruction::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeLexicalDropInstruction ("typeLexicalDropInstruction", gClassInfoFor__typeInstructionLexicale) ;
...
AC_galgasClassRunTimeInformation * cPtr_typeLexicalLogInstruction::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeLexicalLogInstruction ("typeLexicalLogInstruction", gClassInfoFor__typeInstructionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLexicalTagName._operator_isEqual (ptr->mLexicalTagName).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeLexicalTagInstruction:"
           << mLexicalTagName.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeLexicalTagInstruction::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeLexicalTagInstruction ("typeLexicalTagInstruction", gClassInfoFor__typeInstructionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLexicalTagName._operator_isEqual (ptr->mLexicalTagName).boolValue ()
         && mTerminal._operator_isEqual (ptr->mTerminal).boolValue () ;
  }
  return equal ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeLexicalRewindAndSendInstruction::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeLexicalRewindAndSendInstruction ("typeLexicalRewindAndSendInstruction", gClassInfoFor__typeInstructionLexicale) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = attributListeRecherches._operator_isEqual (ptr->attributListeRecherches).boolValue ()
         && attributEmissionParDefaut._operator_isEqual (ptr->attributEmissionParDefaut).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@typeInstructionEmettre:"
           << attributListeRecherches.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << attributEmissionParDefaut.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionEmettre::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionEmettre ("typeInstructionEmettre", gClassInfoFor__typeInstructionLexicale) ;
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionErreurLexicale::galgasRTTI (void) const {
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionErreurLexicale ("typeInstructionErreurLexicale", gClassInfoFor__typeInstructionLexicale) ;
...
cPtr_typeInstructionLexicalWarning (const GGS_luint & argument_0
                                COMMA_LOCATION_ARGS)
:cPtr_typeInstructionLexicale (THERE),
mErrorMessageIndex (argument_0) {
}
...
AC_galgasClassRunTimeInformation * cPtr_typeInstructionLexicalWarning::galgasRTTI (void) const {
...
GGS_typeInstructionLexicalWarning (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_typeInstructionLexicalWarning _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_typeInstructionLexicalWarning (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
GGS_luint  GGS_typeInstructionLexicalWarning::
reader_mErrorMessageIndex (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_luint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__typeInstructionLexicalWarning ("typeInstructionLexicalWarning", gClassInfoFor__typeInstructionLexicale) ;
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mTerminalSymbol.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mTerminalSymbol._operator_isEqual (ptr->mInfo.mTerminalSymbol)).boolValue () ;
}
...
void GGS_tokensInListMap::
modifier_setMTerminalSymbolForKey (C_Compiler & inLexique,
                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (isBuilt () && inValue.isBuilt () && inKey.isBuilt ()) {
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMTerminalSymbolForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mTerminalSymbol = inValue ;
    }
  }
}
