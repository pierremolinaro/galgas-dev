...
void GGS_typeLexicalAttributesMap::methode_insertKey (C_Lexique & lexique_var_,
  ...
  insertElement (lexique_var_,
                 "the lexical attribute '%K' is already declared",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
void GGS_typeTableMessagesErreurs::methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the error message '%K' is already declared",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
void GGS_M_styles::methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the '%K' style is already declared",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
void GGS_typeTableMotsReserves::methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the word '%K' is already declared",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
void GGS_typeTableTablesDeMotsReserves::methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_typeTableMotsReserves & inParameter0) {
  insertElement (lexique_var_,
                 "the word map '%K' is already declared",
                 inKey,
                 inParameter0,
                 NULL) ;
}
