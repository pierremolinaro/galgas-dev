...
//                    november 15th, 2006, at 15h48'34"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
isEqualToObject (const C_GGS_Object * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (_p) ;
    equal = (attributTerminal == _p->attributTerminal).boolValue () ;
  }
  return equal ;
}
...
reader_attributTerminal (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_typeInstructionEmettreSimple *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_typeInstructionEmettreSimple *) mPointer)->attributTerminal ;
  }
  return result ;
}
