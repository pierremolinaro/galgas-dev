...
GGS_string GGS_typeListeConditionsLexicales::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_tListeInstructionsLexicales::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeTestsEtInstructions::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeArgumentsRoutExterne::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeMessagesErreur::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeRecherche::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
