...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      message1_ (0 COMMA_HERE) << cPtr_typeConditionLexicale::_static_message () ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeConditionChaine::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeConditionNonChaine::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeConditionCaractere::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeConditionIntervalle::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionLexicale::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeArgumentRoutineExterne::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeArgumentAttribut::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeArgumentCaractere::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeArgumentCaractereCourant::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeArgumentEntier::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeArgumentRoutine::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeEmissionParDefaut::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeEmissionTerminalParDefaut::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeEmissionErreurParDefaut::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionActionExterne::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionRepetitionLexicale::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionSiLexical::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionEmettreSimple::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeLexicalDropInstruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeLexicalLogInstruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeLexicalTagInstruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeLexicalRewindAndSendInstruction::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionEmettre::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      ...
      TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
      message1_ (0 COMMA_HERE) << cPtr_typeInstructionErreurLexicale::_static_message () ;
      inErrorLocation.signalExtractError (inLexique,
                                          message1_,
                                          inPointer->_message ()
                                          COMMA_THERE) ;
