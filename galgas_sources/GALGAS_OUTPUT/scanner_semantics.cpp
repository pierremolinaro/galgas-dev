...
AC_galgas_map_elementEx * GGS_typeLexicalAttributesMap::
...
void GGS_typeLexicalAttributesMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
...
AC_galgas_map_elementEx * GGS_lexicalTypeMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_lexicalTypeMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeTableMessagesErreurs::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableMessagesErreurs::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_styles::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_styles::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeTableDefinitionTerminaux::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableDefinitionTerminaux::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeTableMotsReserves::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableMotsReserves::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeTableTablesDeMotsReserves::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableTablesDeMotsReserves::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* elementOf_GGG_typeListeConditionsLexicales::
elementOf_GGG_typeListeConditionsLexicales (const GGG_typeConditionLexicale  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListeConditionsLexicales *) NULL ;
  attributCondition = argument_0 ;
  retain (attributCondition COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListeConditionsLexicales::
~elementOf_GGG_typeListeConditionsLexicales (void) {
  macroRelease (attributCondition, this) ;
}*/
...
/* elementOf_GGG_tListeInstructionsLexicales::
elementOf_GGG_tListeInstructionsLexicales (const GGG_typeInstructionLexicale  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_tListeInstructionsLexicales *) NULL ;
  attributInstruction = argument_0 ;
  retain (attributInstruction COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_tListeInstructionsLexicales::
~elementOf_GGG_tListeInstructionsLexicales (void) {
  macroRelease (attributInstruction, this) ;
}*/
...
/* elementOf_GGG_typeListeTestsEtInstructions::
elementOf_GGG_typeListeTestsEtInstructions (const GGG_typeListeConditionsLexicales  *argument_0,
                                const GGG_tListeInstructionsLexicales  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListeTestsEtInstructions *) NULL ;
  attributListeConditions = argument_0 ;
  retain (attributListeConditions COMMA_HERE) ;
  attributListeInstructions = argument_1 ;
  retain (attributListeInstructions COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListeTestsEtInstructions::
~elementOf_GGG_typeListeTestsEtInstructions (void) {
  macroRelease (attributListeConditions, this) ;
  macroRelease (attributListeInstructions, this) ;
}*/
...
/* elementOf_GGG_typeListeArgumentsRoutExterne::
elementOf_GGG_typeListeArgumentsRoutExterne (const GGG_typeArgumentRoutineExterne  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListeArgumentsRoutExterne *) NULL ;
  attributArgument = argument_0 ;
  retain (attributArgument COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListeArgumentsRoutExterne::
~elementOf_GGG_typeListeArgumentsRoutExterne (void) {
  macroRelease (attributArgument, this) ;
}*/
...
/* elementOf_GGG_typeListeMessagesErreur::
elementOf_GGG_typeListeMessagesErreur (const GGG_luint  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListeMessagesErreur *) NULL ;
  mErrorMessageIndex = argument_0 ;
  retain (mErrorMessageIndex COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListeMessagesErreur::
~elementOf_GGG_typeListeMessagesErreur (void) {
  macroRelease (mErrorMessageIndex, this) ;
}*/
...
/* elementOf_GGG_typeListeRecherche::
elementOf_GGG_typeListeRecherche (const GGG_lstring  *argument_0,
                                const GGG_lstring  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListeRecherche *) NULL ;
  attributNomAttribut = argument_0 ;
  retain (attributNomAttribut COMMA_HERE) ;
  attributNomTable = argument_1 ;
  retain (attributNomTable COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListeRecherche::
~elementOf_GGG_typeListeRecherche (void) {
  macroRelease (attributNomAttribut, this) ;
  macroRelease (attributNomTable, this) ;
}*/
