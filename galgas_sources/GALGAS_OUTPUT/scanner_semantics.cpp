...
constructor_new (C_Lexique & /* inLexique */,
                 const GGS_lstring & argument_0 COMMA_LOCATION_ARGS) {
  cPtr_typeLexicalDropInstruction * _ptr = (cPtr_typeLexicalDropInstruction *) NULL ;
  macroMyNew (_ptr, cPtr_typeLexicalDropInstruction (argument_0 COMMA_THERE)) ;
...
constructor_new (C_Lexique & /* inLexique */,
                 const GGS_lstring & argument_0 COMMA_LOCATION_ARGS) {
  cPtr_typeLexicalTagInstruction * _ptr = (cPtr_typeLexicalTagInstruction *) NULL ;
  macroMyNew (_ptr, cPtr_typeLexicalTagInstruction (argument_0 COMMA_THERE)) ;
...
constructor_new (C_Lexique & /* inLexique */,
                 const GGS_lstring & argument_0,
                 const GGS_lstring & argument_1 COMMA_LOCATION_ARGS) {
  cPtr_typeLexicalRewindAndSendInstruction * _ptr = (cPtr_typeLexicalRewindAndSendInstruction *) NULL ;
  macroMyNew (_ptr, cPtr_typeLexicalRewindAndSendInstruction (argument_0,
                                argument_1 COMMA_THERE)) ;
