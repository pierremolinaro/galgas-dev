...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributChaine.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributCaractere.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributBorneInf.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributBorneSup.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
void GGS_typeListeConditionsLexicales::
_internalPrependItem (const GGS_typeConditionLexicale & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->attributCondition ;
  }else{
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->attributCondition ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_tListeInstructionsLexicales::
_internalPrependItem (const GGS_typeInstructionLexicale & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->attributInstruction ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->attributInstruction ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_typeListeTestsEtInstructions::
_internalPrependItem (const GGS_typeListeConditionsLexicales & argument_0,
                    const GGS_tListeInstructionsLexicales & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->attributListeConditions ;
    _out_1 = _mRoot->mFirstItem->attributListeInstructions ;
  }else{
    _out_0._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->attributListeConditions ;
    _out_1 = _mRoot->mLastItem->attributListeInstructions ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_typeListeArgumentsRoutExterne::
_internalPrependItem (const GGS_typeArgumentRoutineExterne & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->attributArgument ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->attributArgument ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributNom.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributTypeAttribut.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributValeur.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributNomRoutine.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributListeArguments.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mErrorMessageIndex ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mErrorMessageIndex ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributNomTerminal.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mErrorMessageIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->attributNomAttribut ;
    _out_1 = _mRoot->mFirstItem->attributNomTable ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->attributNomAttribut ;
    _out_1 = _mRoot->mLastItem->attributNomTable ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributNomRoutineExterne.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributListeArguments.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributListeMessageErreur.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributListeInstructionsDebut.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributListeBranches.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributBrancheSinon.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributTerminal.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributListeRecherches.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << attributEmissionParDefaut.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
