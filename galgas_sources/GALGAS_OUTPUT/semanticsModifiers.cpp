...
void routine_enterModifierWithOutputArgument (C_Compiler & inLexique,
  ...
  var_cas_ioModifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inModifierName, GGS_location (inLexique) COMMA_HERE), var_cas_argList, var_cas_inHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (57)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterModifierWith2InputArguments (C_Compiler & inLexique,
  ...
  var_cas_argList.addAssign_operation (var_cas_argumentTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
  var_cas_ioModifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inModifierName, GGS_location (inLexique) COMMA_HERE), var_cas_argList, var_cas_inHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (80)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enterModifierWithoutArgument (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioModifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inModifierName, GGS_location (inLexique) COMMA_HERE), GGS_formalParameterSignature ::constructor_emptyList (), var_cas_inHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (94)) ;
  #ifdef DEBUG_TRACE_ENABLED
