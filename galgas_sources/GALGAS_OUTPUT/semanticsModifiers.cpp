...
category_reader__dataGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_dataGalgasType * operand_18983
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
...
category_reader__functionGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_functionGalgasType * operand_19399
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
...
category_reader__classGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_classGalgasType * operand_19618
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_19618 != NULL) {
    const GGS_bool cond_19741 = operand_19618->mSuperClassIndex.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
    if (cond_19741.isBuiltAndTrue ()) {
      var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    }else if (cond_19741.isBuiltAndFalse ()) {
      GGS_ACGalgasType  var_cas_superClassType ;
      GGS_lstring  automatic_var_19828_0 ;
      const GGS_typeMapIndex  temp_19808 = operand_19618->mSuperClassIndex ;
      if (temp_19808.isBuilt ()) {
        temp_19808 (HERE)->method_searchKey (inLexique, automatic_var_19828_0, var_cas_superClassType COMMA_SOURCE_FILE_AT_LINE (545)) ;
      }
    ...
    {
      GGS_attributeList::cEnumerator enumerator_19919 (operand_19618->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_19919 = NULL ;
      while (((operand_19919 = enumerator_19919.nextObject ()))) {
        macroValidPointer (operand_19919) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_19986_0 ;
        const GGS_typeMapIndex  temp_19979 = operand_19919->mAttributeTypeIndex ;
        if (temp_19979.isBuilt ()) {
          temp_19979 (HERE)->method_searchKey (inLexique, automatic_var_19986_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (550)) ;
        }
        ...
        var_cas_outModifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_19919->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), operand_19919->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_HERE), var_cas_accessorSignature, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (555)) ;
      }
    }
  }
  return var_cas_outModifierMap ;
...
category_reader__listGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_listGalgasType * operand_20604
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_20604 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ...
    {
      GGS_attributeList::cEnumerator enumerator_20823 (operand_20604->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_20823 = NULL ;
      while (((operand_20823 = enumerator_20823.nextObject ()))) {
        macroValidPointer (operand_20823) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_20890_0 ;
        const GGS_typeMapIndex  temp_20883 = operand_20823->mAttributeTypeIndex ;
        if (temp_20883.isBuilt ()) {
          temp_20883 (HERE)->method_searchKey (inLexique, automatic_var_20890_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (571)) ;
        }
    ...
    {
      GGS_attributeList::cEnumerator enumerator_21399 (operand_20604->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_21399 = NULL ;
      while (((operand_21399 = enumerator_21399.nextObject ()))) {
        macroValidPointer (operand_21399) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_21466_0 ;
        const GGS_typeMapIndex  temp_21459 = operand_21399->mAttributeTypeIndex ;
        if (temp_21459.isBuilt ()) {
          temp_21459 (HERE)->method_searchKey (inLexique, automatic_var_21466_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (592)) ;
        }
        ...
        var_cas_outModifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_21399->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (597)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_21399->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (597)) COMMA_HERE), var_cas_signature, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (596)) ;
      }
    }
  }
  return var_cas_outModifierMap ;
...
category_reader__listmapGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_listmapGalgasType * operand_22230
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_22230 != NULL) {
...
category_reader__structGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_structGalgasType * operand_22449
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
...
category_reader__sortedlistGalgasType__modifierMap (C_Compiler & inLexique,
                                const cPtr_sortedlistGalgasType * operand_22670
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_22670 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_formalParameterSignature  var_cas_extractSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_22832 (operand_22670->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_22832 = NULL ;
      while (((operand_22832 = enumerator_22832.nextObject ()))) {
        macroValidPointer (operand_22832) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_22899_0 ;
        const GGS_typeMapIndex  temp_22892 = operand_22832->mAttributeTypeIndex ;
        if (temp_22892.isBuilt ()) {
          temp_22892 (HERE)->method_searchKey (inLexique, automatic_var_22899_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (629)) ;
        }
        var_cas_extractSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
      }
    }
...
category_reader__mapType__modifierMap (C_Compiler & inLexique,
                                const cPtr_mapType * operand_23336
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_23336 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ...
    {
      GGS_attributeList::cEnumerator enumerator_23751 (operand_23336->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_23751 = NULL ;
      while (((operand_23751 = enumerator_23751.nextObject ()))) {
        macroValidPointer (operand_23751) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_23818_0 ;
        const GGS_typeMapIndex  temp_23811 = operand_23751->mAttributeTypeIndex ;
        if (temp_23811.isBuilt ()) {
          temp_23811 (HERE)->method_searchKey (inLexique, automatic_var_23818_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (654)) ;
        }
        ...
        var_cas_accessorSignature.addAssign_operation (GGS_lstringGalgasType ::constructor_new (inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
        var_cas_accessorSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
        var_cas_outModifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_23751->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_23751->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (662)) COMMA_HERE), var_cas_accessorSignature, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (661)) ;
      }
    }
    {
      GGS_mapMethodMap::cEnumerator enumerator_24511 (operand_23336->mInsertMethodMap, true) ;
      const GGS_mapMethodMap::cElement * operand_24511 = NULL ;
      while (((operand_24511 = enumerator_24511.nextObject ()))) {
        macroValidPointer (operand_24511) ;
        var_cas_outModifierMap.modifier_insertKey (inLexique, operand_24511->mKey, var_cas_insertSignature, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (669)) ;
      }
    }
    {
      GGS_mapMethodMap::cEnumerator enumerator_24663 (operand_23336->mRemoveMethodMap, true) ;
      const GGS_mapMethodMap::cElement * operand_24663 = NULL ;
      while (((operand_24663 = enumerator_24663.nextObject ()))) {
        macroValidPointer (operand_24663) ;
        var_cas_outModifierMap.modifier_insertKey (inLexique, operand_24663->mKey, var_cas_removeSignature, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (677)) ;
      }
    }
  }
  return var_cas_outModifierMap ;
...
category_reader__mapindexType__modifierMap (C_Compiler & inLexique,
                                const cPtr_mapindexType * operand_24903
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
...
category_reader__enumType__modifierMap (C_Compiler & inLexique,
                                const cPtr_enumType * operand_25112
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_25112 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  }
  return var_cas_outModifierMap ;
}
