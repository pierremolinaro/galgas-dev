...
void routine_enterModifierWithOutputArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_argumentTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inInputArgumentTypeName, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (54)) ;
  GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
...
void routine_enterModifierWith2InputArguments (C_Compiler & inLexique,
  ...
  GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
  GGS_unifiedTypeMapProxy  var_cas_argumentTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inInputArgument1TypeName, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (76)) ;
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inInputArgument2TypeName, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (78)) ;
...
category_method__stringPredefinedTypeAST__getModifierMap (C_Compiler & inLexique,
                                const cPtr_stringPredefinedTypeAST * operand_4402,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
...
category_method__dataPredefinedTypeAST__getModifierMap (C_Compiler & inLexique,
                                const cPtr_dataPredefinedTypeAST * operand_5089,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_modifierMap  & var_cas_outModifierMap
                                COMMA_UNUSED_LOCATION_ARGS) {
