...
#ifndef typeOrOperation_DEFINED
#define typeOrOperation_DEFINED
...
/* class GGG_typeOrOperation : public GGG_typeExpression {
  private : typedef GGG_typeExpression inherited ;
  public : GGG_typeOrOperation (const GGS_typeExpression & ,
                                const GGS_typeExpression &  COMMA_LOCATION_ARGS) ;
} ; */
