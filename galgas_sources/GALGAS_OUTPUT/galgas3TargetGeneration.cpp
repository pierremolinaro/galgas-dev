...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 214)) ;
  GALGAS_bool joker_10332_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 216))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 217)).operator_concat (GALGAS_string ("/build/headers/project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 217)), joker_10332_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 216)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_10442 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_10442) {
      macroValidSharedObject (objectArray_10442, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_10442->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_10442->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 224)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_10442->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 229)).operator_concat (GALGAS_string ("/build/libpm")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 229)), inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 229)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_13117 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13117.hasCurrentObject ()) {
    const enumGalgasBool test_3 = var_availableGenerationFeatures.reader_hasKey (enumerator_13117.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)).boolEnum () ;
    if (kBoolTrue == test_3) {
      const enumGalgasBool test_4 = var_generationFeatures.reader_hasKey (enumerator_13117.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("duplicate '").operator_concat (enumerator_13117.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)) ;
      }
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        const enumGalgasBool test_7 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_location location_8 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("duplicate '").operator_concat (enumerator_13117.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_10) {
            GALGAS_location location_11 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_11, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 296)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_9) {
          const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            ...
            if (kBoolTrue == test_13) {
              GALGAS_location location_14 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_14, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 302)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_12) {
            const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_15) {
              ...
              if (kBoolTrue == test_16) {
                GALGAS_location location_17 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_17, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 309)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_15) {
              const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_18) {
                ...
                if (kBoolTrue == test_19) {
                  GALGAS_location location_20 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_20, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 316)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_18) {
                const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_21) {
                  ...
                  if (kBoolTrue == test_22) {
                    GALGAS_location location_23 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_23, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 323)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_21) {
                  const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, enumerator_13117.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_24) {
                    ...
                    if (kBoolTrue == test_25) {
                      GALGAS_location location_26 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_26, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 330)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_24) {
                    var_generationFeatures.addAssign_operation (enumerator_13117.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_15608 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_15608.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_15608.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)) ;
        enumerator_15608.gotoNextObject () ;
      }
      GALGAS_location location_27 (enumerator_13117.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("unknown '").operator_concat (enumerator_13117.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)) ;
    }
  ...
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 350)).boolEnum () ;
  ...
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 353)).boolEnum () ;
  ...
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-i386-linux-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 356)).boolEnum () ;
  ...
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86_64-linux-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 359)).boolEnum () ;
  ...
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-mingw-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 362)).boolEnum () ;
  ...
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msy-on-win32") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 365)).boolEnum () ;
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, constinArgument_inHandCodedSourceDirectorySet, constinArgument_inHandCodedSourceFileList, constinArgument_inToolProductFileList, var_libpmPath, temp_35 COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 369))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 376)).operator_concat (GALGAS_string ("/build/lists/file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 376)) ;
  GALGAS_bool joker_17467_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17467_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 377)) ;
  ...
  if (kBoolTrue == test_37) {
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_17679 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_17679) {
        macroValidSharedObject (objectArray_17679, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_17679->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_18162_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)), joker_18162_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)) ;
    const enumGalgasBool test_38 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)).boolEnum () ;
    ...
    GALGAS_bool joker_18663_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_18663_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)) ;
    ...
    const enumGalgasBool test_39 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 405)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 405)).boolEnum () ;
    if (kBoolTrue == test_39) {
      GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_18972 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_18972) {
        macroValidSharedObject (objectArray_18972, cMapElement_projectQualifiedFeatureMap) ;
      ...
      GALGAS_bool joker_19359_0 ; // Joker input parameter
      ...
      GALGAS_bool joker_22707_0 ; // Joker input parameter
