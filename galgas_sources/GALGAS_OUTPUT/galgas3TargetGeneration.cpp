...
void routine_updateGalgas_33_Targets (const GALGAS_string constinArgument_inProjectSourceFilePath,
  ...
  if (kBoolTrue == test_36) {
    ...
    GALGAS_stringlist var_generatedByGalgasFileRefList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 559)) ;
    cEnumerator_stringlist enumerator_28347 (constinArgument_inToolCppFileList, kEnumeration_up) ;
    while (enumerator_28347.hasCurrentObject ()) {
      GALGAS_string var_cppFileRef ;
      {
      categoryModifier_addCppFile (var_xcodeProject, enumerator_28347.current_mValue (HERE), var_cppFileRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 561)) ;
      }
      var_generatedByGalgasFileRefList.addAssign_operation (var_cppFileRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 562)) ;
      GALGAS_string var_buildRef ;
      {
      categoryModifier_addBuildFile (var_xcodeProject, var_cppFileRef, enumerator_28347.current_mValue (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 563)) ;
      }
      var_buildFileRefListForTool.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 564)) ;
      enumerator_28347.gotoNextObject () ;
    }
    cEnumerator_stringlist enumerator_28672 (constinArgument_inToolHeaderFileList, kEnumeration_up) ;
    while (enumerator_28672.hasCurrentObject ()) {
      GALGAS_string var_headerFileRef ;
      {
      categoryModifier_addHeaderFile (var_xcodeProject, enumerator_28672.current_mValue (HERE), var_headerFileRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 567)) ;
      }
      var_generatedByGalgasFileRefList.addAssign_operation (var_headerFileRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 568)) ;
      enumerator_28672.gotoNextObject () ;
    }
    GALGAS_string var_galgasGroupRef ;
    {
    categoryModifier_addGroup (var_xcodeProject, GALGAS_string ("Generated by GALGAS"), GALGAS_string ("../build/output"), var_generatedByGalgasFileRefList, var_galgasGroupRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 571)) ;
    }
    {
    categoryModifier_placeGroupAsMainGroup (var_xcodeProject, var_galgasGroupRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 572)) ;
    }
    GALGAS_stringlist var_libpmReferenceGroupList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 574)) ;
    GALGAS_string var_cacheFileRef ;
    {
    categoryModifier_addHeaderFile (var_xcodeProject, GALGAS_string ("TC_prime_cache2.h"), var_cacheFileRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 576)) ;
    }
    GALGAS_string var_cacheGroupRef ;
    {
    GALGAS_stringlist temp_40 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 577)) ;
    temp_40.addAssign_operation (var_cacheFileRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 577)) ;
    categoryModifier_addGroup (var_xcodeProject, GALGAS_string ("Cache"), GALGAS_string ("cache"), temp_40, var_cacheGroupRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 577)) ;
    }
    var_libpmReferenceGroupList.addAssign_operation (var_cacheGroupRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 578)) ;
    GALGAS_string var_libpmGroupRef ;
    {
    categoryModifier_addGroup (var_xcodeProject, GALGAS_string ("libpm"), GALGAS_string ("../build/libpm"), var_libpmReferenceGroupList, var_libpmGroupRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 579)) ;
    }
    {
    categoryModifier_placeGroupAsMainGroup (var_xcodeProject, var_libpmGroupRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 580)) ;
    }
    {
    GALGAS_stringlist temp_41 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 588)) ;
    temp_41.addAssign_operation (GALGAS_string ("GCC_OPTIMIZATION_LEVEL = 2")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 587)) ;
    temp_41.addAssign_operation (GALGAS_string ("GCC_PREPROCESSOR_DEFINITIONS = (\"LIBPM_MULTI_THREADING=0\", DO_NOT_GENERATE_CHECKINGS)")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 588)) ;
    GALGAS_string joker_30064_0 ; // Joker input parameter
    categoryModifier_addMachOTarget (var_xcodeProject, constinArgument_inTargetName.add_operation (GALGAS_string (" tool"), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 583)), constinArgument_inTargetName, var_buildFileRefListForTool, temp_41, joker_30064_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 582)) ;
    }
    categoryMethod_generateAtPath (var_xcodeProject, var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 593)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 593)).operator_concat (GALGAS_string ("_NEW.xcodeproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 593)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 593)) ;
  }
}
