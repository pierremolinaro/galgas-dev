...
void routine_generateGalgas_33_MsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
                                                        ...
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-msys-on-win32")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 124)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 125)) ;
  GALGAS_bool joker_4766_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 126)), joker_4766_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 126)) ;
  GALGAS_bool joker_4911_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)), joker_4911_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)) ;
  GALGAS_bool joker_5060_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)), joker_5060_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)) ;
  GALGAS_bool joker_5216_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)), joker_5216_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)) ;
}
...
void routine_generateGalgas_33_MakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                     ...
                                                     C_Compiler * inCompiler
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 151)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 152)) ;
  GALGAS_bool joker_6440_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_2_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 153)), joker_6440_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 153)) ;
  GALGAS_bool joker_6596_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_3_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 154)), joker_6596_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 154)) ;
  ...
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 156))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 156)), joker_6905_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 156)) ;
}
...
void routine_generateGalgas_33_MakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 165)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 166)) ;
  GALGAS_bool joker_7341_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 167)), joker_7341_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 167)) ;
  GALGAS_bool joker_7499_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 168)), joker_7499_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 168)) ;
  GALGAS_bool joker_7653_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 169)), joker_7653_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 169)) ;
  GALGAS_bool joker_7800_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170)), joker_7800_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170)) ;
}
...
void routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 179)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 180)) ;
...
void routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 192)) ;
...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectName = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_lastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 212)).reader_stringByDeletingPathExtension (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 212)) ;
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 213)) ;
  GALGAS_bool joker_10365_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 215))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 216)).operator_concat (GALGAS_string ("/build/output/project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 216)), joker_10365_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 215)) ;
  ...
  if (NULL != objectArray_10475) {
    ...
    if (kBoolTrue == test_0) {
      ...
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 223)) ;
    ...
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 228)).operator_concat (GALGAS_string ("/build/libpm")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 228)), inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 228)) ;
    }
    var_libpmPath = GALGAS_string ("../build/libpm") ;
  }
  GALGAS_stringset var_externSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 237)) ;
  GALGAS_stringset var_guiSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 238)) ;
  GALGAS_stringset var_scannerSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 239)) ;
  GALGAS_stringset var_optionSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 240)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 241)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 242)) ;
  GALGAS_stringset var_grammarSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 243)) ;
  GALGAS_stringset var_programSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 244)) ;
  GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 246)) ;
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 247)) ;
  GALGAS_stringset var_scannerSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 248)) ;
  GALGAS_stringset var_optionSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 249)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 250)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 251)) ;
  GALGAS_stringset var_grammarSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 252)) ;
  GALGAS_stringset var_programSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 253)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 255)) ;
  GALGAS_stringlist var_handCodedSourceList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 256)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    inCompiler->printMessage (GALGAS_string ("*** Updating targets\n")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 259)) ;
  }
  ...
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-i386-linux-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86-64-linux-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 265)) ;
  ...
  while (enumerator_13198.hasCurrentObject ()) {
    const enumGalgasBool test_3 = var_availableGenerationFeatures.reader_hasKey (enumerator_13198.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 281)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 281)).boolEnum () ;
    if (kBoolTrue == test_3) {
      const enumGalgasBool test_4 = var_generationFeatures.reader_hasKey (enumerator_13198.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 282)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 282)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (enumerator_13198.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("duplicate '").operator_concat (enumerator_13198.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)) ;
      }
      ...
      if (kBoolTrue == test_6) {
        ...
        if (kBoolTrue == test_7) {
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("duplicate '").operator_concat (enumerator_13198.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 288))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 288)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 288))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 288)) ;
        }
        ...
        if (kBoolTrue == test_9) {
          ...
          if (kBoolTrue == test_10) {
            ...
            inCompiler->emitSemanticError (location_11, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 294)) ;
          }
          ...
          if (kBoolTrue == test_12) {
            ...
            if (kBoolTrue == test_13) {
              ...
              inCompiler->emitSemanticError (location_14, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 300)) ;
            }
            ...
            if (kBoolTrue == test_15) {
              ...
              if (kBoolTrue == test_16) {
                ...
                inCompiler->emitSemanticError (location_17, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 307)) ;
              }
              ...
              if (kBoolTrue == test_18) {
                ...
                if (kBoolTrue == test_19) {
                  ...
                  inCompiler->emitSemanticError (location_20, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 314)) ;
                }
                ...
                if (kBoolTrue == test_21) {
                  ...
                  if (kBoolTrue == test_22) {
                    ...
                    inCompiler->emitSemanticError (location_23, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 321)) ;
                  }
                  ...
                  if (kBoolTrue == test_24) {
                    ...
                    if (kBoolTrue == test_25) {
                      ...
                      inCompiler->emitSemanticError (location_26, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 328)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_24) {
                    var_generationFeatures.addAssign_operation (enumerator_13198.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 333))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 333)) ;
                  }
                }
              }
            }
      ...
      while (enumerator_15597.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_15597.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338)) ;
      ...
      inCompiler->emitSemanticError (location_27, GALGAS_string ("unknown '").operator_concat (enumerator_13198.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)) ;
    }
  ...
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 348)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, var_projectName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 349)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 351)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, var_projectName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 352)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 354)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 355)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 357)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 358)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 360)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 361)) ;
    }
  }
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 363)).boolEnum () ;
  if (kBoolTrue == test_34) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, var_projectName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 364)) ;
    }
  }
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, constinArgument_inHandCodedSourceDirectorySet, var_handCodedSourceList, constinArgument_inToolProductFileList, var_libpmPath, temp_35 COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 367))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 374)).operator_concat (GALGAS_string ("/build/output/file_list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 374)) ;
  GALGAS_bool joker_17454_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17454_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 375)) ;
  ...
  if (kBoolTrue == test_37) {
    ...
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 381)) ;
    GALGAS_bool joker_17863_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_17863_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 382)) ;
    ...
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, var_projectName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 390))) ;
    GALGAS_bool joker_18412_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)), joker_18412_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)) ;
    const enumGalgasBool test_38 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).boolEnum () ;
    ...
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, var_projectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_18912_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404)) ;
    ...
    const enumGalgasBool test_39 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)).boolEnum () ;
    if (kBoolTrue == test_39) {
      GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407)) ;
    }
