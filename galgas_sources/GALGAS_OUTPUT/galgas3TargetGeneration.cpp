...
void routine_generateGalgas_33_MsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
                                                        ...
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-msys32-on-windows")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 131)) ;
  GALGAS_bool joker_5387_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 132)), joker_5387_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 132)) ;
  GALGAS_bool joker_5532_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_16_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 133)), joker_5532_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 133)) ;
  GALGAS_bool joker_5681_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 134)), joker_5681_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 134)) ;
  GALGAS_bool joker_5841_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_msys_33__32__5F_on_5F_windows_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 135))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 135)), joker_5841_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 135)) ;
}
...
void routine_generateGalgas_33_MinGWOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-win32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 144)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 145)) ;
  GALGAS_bool joker_6290_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 146)), joker_6290_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 146)) ;
  GALGAS_bool joker_6461_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 147)), joker_6461_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 147)) ;
  GALGAS_bool joker_6634_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_clean_5F_win_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 148))).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 149)), joker_6634_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 148)) ;
  GALGAS_bool joker_6795_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_win_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 152))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 152)), joker_6795_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 152)) ;
}
...
void routine_generateGalgas_33_MakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                     ...
                                                     C_Compiler * inCompiler
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 161)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 162)) ;
  GALGAS_bool joker_7227_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_0_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 163)), joker_7227_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 163)) ;
  GALGAS_bool joker_7389_0 ; // Joker input parameter
  ...
  GALGAS_bool joker_7545_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_clean_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 165))).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 165)), joker_7545_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 165)) ;
  GALGAS_bool joker_7695_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_1_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 166)), joker_7695_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 166)) ;
  GALGAS_bool joker_7844_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 167))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 167)), joker_7844_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 167)) ;
}
...
void routine_generateGalgas_33_MakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 176)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 177)) ;
  GALGAS_bool joker_8270_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_6_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 178)), joker_8270_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 178)) ;
  GALGAS_bool joker_8430_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 179)), joker_8430_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 179)) ;
  GALGAS_bool joker_8578_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 180)), joker_8578_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 180)) ;
  GALGAS_bool joker_8732_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_clean_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 181))).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 181)), joker_8732_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 181)) ;
  GALGAS_bool joker_8879_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 182))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 182)), joker_8879_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 182)) ;
}
...
void routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 191)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 192)) ;
  GALGAS_bool joker_9340_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 193)), joker_9340_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 193)) ;
  GALGAS_bool joker_9511_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_clean_5F_x_38__36__5F_linux_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 194))).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 194)), joker_9511_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 194)) ;
  GALGAS_bool joker_9687_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 195)), joker_9687_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 195)) ;
  GALGAS_bool joker_9851_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 196))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 196)), joker_9851_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 196)) ;
}
...
void routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 205)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 206)) ;
  GALGAS_bool joker_10312_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_13_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 207)), joker_10312_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 207)) ;
  GALGAS_bool joker_10483_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_clean_5F_x_38__36__5F_linux_36__34__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 208))).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 208)), joker_10483_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 208)) ;
  GALGAS_bool joker_10659_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_14_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 209)), joker_10659_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 209)) ;
  GALGAS_bool joker_10823_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_36__34__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 210))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 210)), joker_10823_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 210)) ;
}
...
void routine_updateGalgas_33_Targets (const GALGAS_string constinArgument_inProjectSourceFilePath,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 232)) ;
  GALGAS_bool joker_11909_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 234))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 235)).operator_concat (GALGAS_string ("/build/output/project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 235)), joker_11909_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 234)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 238)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_12066 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_12066) {
      macroValidSharedObject (objectArray_12066, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_12066->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_12066->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 243)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_12066->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 248)).operator_concat (GALGAS_string ("/build/libpm")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 248)), inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 248)) ;
    }
    var_libpmPath = GALGAS_string ("../build/libpm") ;
  }
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_setWithStringList (constinArgument_inAppProductFileList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 254)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 256)) ;
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 258)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 259)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 260)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 261)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 262)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-win32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 263)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys32-on-windows")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 265)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 266)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 267)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 268)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 269)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 270)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 271)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 272)) ;
  ...
  cEnumerator_lstringlist enumerator_13659 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13659.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_availableGenerationFeatures.reader_hasKey (enumerator_13659.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 278)).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = var_generationFeatures.reader_hasKey (enumerator_13659.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 279)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("duplicate '").operator_concat (enumerator_13659.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 280))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 280)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 280))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 280)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("duplicate '").operator_concat (enumerator_13659.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 291)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_11) {
            ...
            if (kBoolTrue == test_12) {
              GALGAS_location location_13 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_13, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 297)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_11) {
            const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              ...
              if (kBoolTrue == test_15) {
                GALGAS_location location_16 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_16, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 304)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_14) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                ...
                if (kBoolTrue == test_18) {
                  GALGAS_location location_19 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_19, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 311)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_17) {
                const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_20) {
                  ...
                  if (kBoolTrue == test_21) {
                    GALGAS_location location_22 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_22, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 318)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_20) {
                  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_13659.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_23) {
                    ...
                    if (kBoolTrue == test_24) {
                      GALGAS_location location_25 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 325)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_23) {
                    var_generationFeatures.addAssign_operation (enumerator_13659.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 330)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_16055 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_16055.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_16055.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)) ;
        enumerator_16055.gotoNextObject () ;
      }
      GALGAS_location location_26 (enumerator_13659.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("unknown '").operator_concat (enumerator_13659.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 337))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 337)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 337)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 337))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 337)) ;
    }
    enumerator_13659.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341)).boolEnum () ;
  if (kBoolTrue == test_27) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)) ;
  }
  const enumGalgasBool test_28 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 345)).boolEnum () ;
  if (kBoolTrue == test_28) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)) ;
    }
  }
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 348)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 349)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 351)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 352)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux64-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 354)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 355)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-win32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 357)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 358)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msys32-on-windows") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 360)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 361)) ;
    }
  }
  ...
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 372)).operator_concat (GALGAS_string ("/build/output/file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 372)) ;
  GALGAS_bool joker_17955_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17955_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 373)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 374)) ;
  const enumGalgasBool test_36 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_36) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 377)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 378)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_18211 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_18211) {
        macroValidSharedObject (objectArray_18211, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_18211->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_18694_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 392)), joker_18694_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 392)) ;
    const enumGalgasBool test_37 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 394)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 394)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 394)).boolEnum () ;
    if (kBoolTrue == test_37) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)) ;
    GALGAS_bool joker_19195_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_19195_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 401)) ;
    const enumGalgasBool test_38 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 402)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 402)).boolEnum () ;
    if (kBoolTrue == test_38) {
      GALGAS_string (gWrapperFileContent_19_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_19504 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_19504) {
        macroValidSharedObject (objectArray_19504, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 408)) ;
      GALGAS_bool joker_19891_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 409))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 409)), joker_19891_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 409)) ;
      GALGAS_bool joker_20198_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_19504->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 410))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 415)), joker_20198_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 410)) ;
      GALGAS_bool joker_20403_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 418))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 418)), joker_20403_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 418)) ;
      GALGAS_bool joker_20564_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)), joker_20564_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)) ;
      GALGAS_bool joker_20733_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)), joker_20733_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)) ;
      GALGAS_bool joker_20894_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 421))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 421)), joker_20894_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 421)) ;
      GALGAS_bool joker_21063_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422)), joker_21063_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422)) ;
      GALGAS_bool joker_21240_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423)), joker_21240_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_21310 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_21310) {
          macroValidSharedObject (objectArray_21310, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_21310->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 431)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 432)) ;
      GALGAS_bool joker_21786_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 433))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 433)), joker_21786_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 433)) ;
      GALGAS_bool joker_21943_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 434))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 434)), joker_21943_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 434)) ;
      GALGAS_bool joker_22108_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435)), joker_22108_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435)) ;
      GALGAS_bool joker_22373_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 436))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 441)), joker_22373_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 436)) ;
      GALGAS_bool joker_22624_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 444))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 448)), joker_22624_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 444)) ;
      GALGAS_bool joker_22861_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 451))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 455)), joker_22861_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 451)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 459)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 460)) ;
      GALGAS_bool joker_23239_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461)), joker_23239_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461)) ;
      GALGAS_bool joker_23425_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462)), joker_23425_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462)) ;
      GALGAS_bool joker_23615_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463)), joker_23615_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463)) ;
      GALGAS_bool joker_23791_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464)), joker_23791_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464)) ;
      GALGAS_bool joker_24045_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 469)), joker_24045_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465)) ;
      GALGAS_bool joker_24308_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 471))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 476)), joker_24308_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 471)) ;
      GALGAS_bool joker_24464_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 478))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 478)), joker_24464_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 478)) ;
      GALGAS_bool joker_24619_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479)), joker_24619_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 482)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 484)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 485)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 486)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 488)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 488)).operator_concat (GALGAS_string (".xcodeproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 488)) ;
    ...
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list-for-xcode-project.txt")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 490)) ;
    GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_setWithStringList (constinArgument_inHandCodedSourceAppFileList  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 492)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 494)) ;
    {
    routine_generateXcodeProject (GALGAS_stringset::constructor_setWithStringList (constinArgument_inHandCodedSourceToolFileList  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 497)), GALGAS_stringset::constructor_setWithStringList (constinArgument_inToolProductFileList  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 498)), GALGAS_string ("../build/output"), var_externSourceSet_5F_app, var_guiSourceSet_5F_app, constinArgument_inTargetName, constinArgument_inHandCodedLinkAppFileList, var_xcodeProjectPath, var_resourceFiles, var_intermediateFilePath, var_SDK, var_libpmPath, GALGAS_string ("../build/user-headers"), var_multiThreadingEnabled, var_usesARC, constinArgument_inProjectQualifiedFeatureMap, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 496)) ;
    }
  }
}
