...
const char * gWrapperFileContent_3_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_1 [5] = {
...
const char * gWrapperFileContent_4_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
//--- File 'makefile-unix/clean.py'

const char * gWrapperFileContent_5_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_2 [5] = {
...
//--- File 'makefile-win32-on-macosx/clean.py'
...
//--- File 'makefile-x86linux32-on-macosx/clean.py'
...
//--- File 'makefile-x86linux64-on-macosx/clean.py'

const char * gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
const char * gWrapperFileContent_16_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
const char * gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
...
const char * gWrapperFileContent_18_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
...
const char * gWrapperFileContent_19_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
...
const char * gWrapperFileContent_20_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables clean\n" ;

const cRegularFileWrapper gWrapperFile_20_targetGalgas_33_GenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
  gWrapperFileContent_20_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_macosx/install.command'

const char * gWrapperFileContent_21_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables install -j `sysctl -n hw.ncpu`\n" ;

const cRegularFileWrapper gWrapperFile_21_targetGalgas_33_GenerationFileWrapper (
  "install.command",
  "command",
  true, // Text file
  97, // Text length
  gWrapperFileContent_21_targetGalgas_33_GenerationFileWrapper
) ;

//--- All files of 'makefile_macosx' directory

static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_7 [4] = {
  & gWrapperFile_19_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_20_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_21_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
const char * gWrapperFileContent_22_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && make --warn-undefined-variables all -j `sysctl -n hw.ncpu`\n" ;

const cRegularFileWrapper gWrapperFile_22_targetGalgas_33_GenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  88, // Text length
  gWrapperFileContent_22_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_mingw_on_macosx/clean.command'

const char * gWrapperFileContent_23_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables clean\n" ;

const cRegularFileWrapper gWrapperFile_23_targetGalgas_33_GenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
  gWrapperFileContent_23_targetGalgas_33_GenerationFileWrapper
) ;

//--- All files of 'makefile_mingw_on_macosx' directory

static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_8 [3] = {
  & gWrapperFile_22_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_23_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
const char * gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_24_targetGalgas_33_GenerationFileWrapper (
  "build.bat",
  "bat",
  true, // Text file
  87, // Text length
  gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_msys_on_win32/clean.bat'

const char * gWrapperFileContent_25_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make clean --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_25_targetGalgas_33_GenerationFileWrapper (
  "clean.bat",
  "bat",
  true, // Text file
  93, // Text length
  gWrapperFileContent_25_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_msys_on_win32/install.bat'

const char * gWrapperFileContent_26_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make install --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_26_targetGalgas_33_GenerationFileWrapper (
  "install.bat",
  "bat",
  true, // Text file
  95, // Text length
  gWrapperFileContent_26_targetGalgas_33_GenerationFileWrapper
) ;

//--- All files of 'makefile_msys_on_win32' directory

static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_9 [4] = {
  & gWrapperFile_24_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_25_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_26_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
const char * gWrapperFileContent_27_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && make --warn-undefined-variables all\n" ;

const cRegularFileWrapper gWrapperFile_27_targetGalgas_33_GenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  65, // Text length
  gWrapperFileContent_27_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_unix/clean.command'

const char * gWrapperFileContent_28_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables clean\n" ;

const cRegularFileWrapper gWrapperFile_28_targetGalgas_33_GenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
  gWrapperFileContent_28_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_unix/install.command'

const char * gWrapperFileContent_29_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables install\n" ;

const cRegularFileWrapper gWrapperFile_29_targetGalgas_33_GenerationFileWrapper (
  "install.command",
  "command",
  true, // Text file
  74, // Text length
  gWrapperFileContent_29_targetGalgas_33_GenerationFileWrapper
) ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_10 [4] = {
  & gWrapperFile_27_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_28_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_29_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
const char * gWrapperFileContent_30_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && make --warn-undefined-variables all -j `sysctl -n hw.ncpu`\n" ;

const cRegularFileWrapper gWrapperFile_30_targetGalgas_33_GenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  88, // Text length
  gWrapperFileContent_30_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'makefile_x86_64_linux_on_macosx/clean.command'

const char * gWrapperFileContent_31_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables clean\n" ;

const cRegularFileWrapper gWrapperFile_31_targetGalgas_33_GenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
  gWrapperFileContent_31_targetGalgas_33_GenerationFileWrapper
) ;

//--- All files of 'makefile_x86_64_linux_on_macosx' directory

static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_11 [3] = {
  & gWrapperFile_30_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_31_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
const char * gWrapperFileContent_32_targetGalgas_33_GenerationFileWrapper = "{\\rtf1\\ansi\\ansicpg1252\\cocoartf1138\\cocoasubrtf510\n"
...
const cRegularFileWrapper gWrapperFile_32_targetGalgas_33_GenerationFileWrapper (
  "adding-icons-to-your-application.rtf",
  "rtf",
  true, // Text file
  1274, // Text length
  gWrapperFileContent_32_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'project_xcode/build.command'

const char * gWrapperFileContent_33_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && xcodebuild -alltargets -configuration Default\n" ;

const cRegularFileWrapper gWrapperFile_33_targetGalgas_33_GenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  75, // Text length
  gWrapperFileContent_33_targetGalgas_33_GenerationFileWrapper
) ;

//--- File 'English.lproj/Credits.rtf'

const char * gWrapperFileContent_34_targetGalgas_33_GenerationFileWrapper = "{\\rtf1\\mac\\ansicpg10000\\cocoartf824\\cocoasubrtf380\n"
...
const cRegularFileWrapper gWrapperFile_34_targetGalgas_33_GenerationFileWrapper (
  "Credits.rtf",
  "rtf",
  true, // Text file
  310, // Text length
  gWrapperFileContent_34_targetGalgas_33_GenerationFileWrapper
) ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_13 [2] = {
  & gWrapperFile_34_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_12 [3] = {
  & gWrapperFile_32_targetGalgas_33_GenerationFileWrapper,
  & gWrapperFile_33_targetGalgas_33_GenerationFileWrapper,
  NULL
} ;
...
GALGAS_string filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_662 (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET, kEnumeration_up) ;
    while (enumerator_662.hasCurrentObject ()) {
      result << "SOURCES_DIR += " ;
      result << enumerator_662.current_key (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_MAKEFILE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1227 (in_MAKEFILE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1227.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1227.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1382 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1382.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1382.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  result << "\n"
    ...
    "\n"
    "USER_LINK_OPTIONS :=\n" ;
  GALGAS_uint index_5511_ (0) ;
  if (in_TOOL_5F_LINK_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_5511 (in_TOOL_5F_LINK_5F_LIST, kEnumeration_up) ;
    while (enumerator_5511.hasCurrentObject ()) {
      result << "USER_LINK_OPTIONS += " ;
      result << enumerator_5511.current_mValue (HERE).stringValue () ;
      result << "\n" ;
      index_5511_.increment () ;
...
void routine_generateGalgas_33_MsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
                                                        ...
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-msys-on-win32")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 125)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 126)) ;
  GALGAS_bool joker_4834_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)), joker_4834_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)) ;
  GALGAS_bool joker_4979_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_25_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)), joker_4979_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)) ;
  GALGAS_bool joker_5128_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_26_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)), joker_5128_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)) ;
  GALGAS_bool joker_5284_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)), joker_5284_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)) ;
}
...
void routine_generateGalgas_33_MinGWOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-win32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 139)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 140)) ;
  GALGAS_bool joker_5733_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 141)), joker_5733_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 141)) ;
  GALGAS_bool joker_5904_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 142)), joker_5904_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 142)) ;
  GALGAS_bool joker_6059_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 143)), joker_6059_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 143)) ;
  GALGAS_bool joker_6217_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_win_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 144))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 144)), joker_6217_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 144)) ;
}
...
void routine_generateGalgas_33_MakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                     ...
                                                     C_Compiler * inCompiler
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 153)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 154)) ;
  GALGAS_bool joker_6649_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_0_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 155)), joker_6649_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 155)) ;
  GALGAS_bool joker_6811_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_3_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 156)), joker_6811_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 156)) ;
  GALGAS_bool joker_6957_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_1_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 157)), joker_6957_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 157)) ;
  GALGAS_bool joker_7107_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_2_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 158)), joker_7107_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 158)) ;
  GALGAS_bool joker_7256_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 159))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 159)), joker_7256_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 159)) ;
}
...
void routine_generateGalgas_33_MakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 168)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 169)) ;
  GALGAS_bool joker_7682_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_4_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170)), joker_7682_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170)) ;
  GALGAS_bool joker_7842_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 171)), joker_7842_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 171)) ;
  GALGAS_bool joker_7990_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_6_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 172)), joker_7990_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 172)) ;
  GALGAS_bool joker_8134_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_5_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 173)), joker_8134_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 173)) ;
  GALGAS_bool joker_8281_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 174))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 174)), joker_8281_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 174)) ;
}
...
void routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 183)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 184)) ;
  GALGAS_bool joker_8742_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 185)), joker_8742_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 185)) ;
  GALGAS_bool joker_8902_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 186)), joker_8902_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 186)) ;
  GALGAS_bool joker_9078_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_13_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 187)), joker_9078_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 187)) ;
  GALGAS_bool joker_9242_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 188))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 188)), joker_9242_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 188)) ;
}
...
void routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 197)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 198)) ;
  GALGAS_bool joker_9703_0 ; // Joker input parameter
  ...
  GALGAS_string (gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 200)), joker_9863_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 200)) ;
  GALGAS_bool joker_10039_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_16_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201)), joker_10039_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201)) ;
  GALGAS_bool joker_10203_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_36__34__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 202))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 202)), joker_10203_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 202)) ;
}
...
void routine_updateGalgas_33_Targets (const GALGAS_string constinArgument_inProjectSourceFilePath,
                                      ...
                                      const GALGAS_stringlist constinArgument_inHandCodedSourceFileList,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 222)) ;
  GALGAS_bool joker_11204_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 224))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 225)).operator_concat (GALGAS_string ("/build/output/project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 225)), joker_11204_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 224)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 228)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_11361 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_11361) {
      macroValidSharedObject (objectArray_11361, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_11361->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_11361->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 233)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_11361->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 238)).operator_concat (GALGAS_string ("/build/libpm")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 238)), inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 238)) ;
    }
    var_libpmPath = GALGAS_string ("../build/libpm") ;
  }
  GALGAS_stringset var_externSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 243)) ;
  GALGAS_stringset var_guiSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 244)) ;
  GALGAS_stringset var_scannerSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 245)) ;
  GALGAS_stringset var_optionSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 246)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 247)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 248)) ;
  GALGAS_stringset var_grammarSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 249)) ;
  GALGAS_stringset var_programSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 250)) ;
  GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 252)) ;
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 253)) ;
  GALGAS_stringset var_scannerSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 254)) ;
  GALGAS_stringset var_optionSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 255)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 256)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 257)) ;
  GALGAS_stringset var_grammarSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 258)) ;
  GALGAS_stringset var_programSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 259)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 261)) ;
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 263)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 265)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 266)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 267)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-win32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 268)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys-on-win32")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 269)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 270)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 271)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 272)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 273)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 274)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 275)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 276)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 277)) ;
  ...
  cEnumerator_lstringlist enumerator_13633 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13633.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_availableGenerationFeatures.reader_hasKey (enumerator_13633.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = var_generationFeatures.reader_hasKey (enumerator_13633.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("duplicate '").operator_concat (enumerator_13633.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("duplicate '").operator_concat (enumerator_13633.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 296)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_11) {
            ...
            if (kBoolTrue == test_12) {
              GALGAS_location location_13 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_13, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 302)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_11) {
            const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              ...
              if (kBoolTrue == test_15) {
                GALGAS_location location_16 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_16, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 309)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_14) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                ...
                if (kBoolTrue == test_18) {
                  GALGAS_location location_19 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_19, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 316)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_17) {
                const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_20) {
                  ...
                  if (kBoolTrue == test_21) {
                    GALGAS_location location_22 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_22, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 323)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_20) {
                  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_13633.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_23) {
                    ...
                    if (kBoolTrue == test_24) {
                      GALGAS_location location_25 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 330)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_23) {
                    var_generationFeatures.addAssign_operation (enumerator_13633.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_16029 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_16029.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_16029.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)) ;
        enumerator_16029.gotoNextObject () ;
      }
      GALGAS_location location_26 (enumerator_13633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("unknown '").operator_concat (enumerator_13633.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)) ;
    }
    enumerator_13633.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)).boolEnum () ;
  if (kBoolTrue == test_27) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 347)) ;
  }
  const enumGalgasBool test_28 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 350)).boolEnum () ;
  if (kBoolTrue == test_28) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 351)) ;
    }
  }
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 353)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 354)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 356)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 357)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux64-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 359)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 360)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-win32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 362)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 363)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msy-on-win32") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 365)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 366)) ;
    }
  }
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, constinArgument_inHandCodedSourceDirectorySet, constinArgument_inHandCodedSourceFileList, constinArgument_inToolProductFileList, constinArgument_inHandCodedLinkToolFileList, var_libpmPath, temp_34 COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 369))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 377)).operator_concat (GALGAS_string ("/build/output/file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 377)) ;
  GALGAS_bool joker_17920_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17920_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 378)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 379)) ;
  const enumGalgasBool test_36 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_36) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 382)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 383)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_18176 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_18176) {
        macroValidSharedObject (objectArray_18176, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_18176->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_18659_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)), joker_18659_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)) ;
    const enumGalgasBool test_37 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)).boolEnum () ;
    if (kBoolTrue == test_37) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404)) ;
    GALGAS_bool joker_19160_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 405))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_19160_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 405)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)) ;
    const enumGalgasBool test_38 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407)).boolEnum () ;
    if (kBoolTrue == test_38) {
      GALGAS_string (gWrapperFileContent_34_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 408)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_19469 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_19469) {
        macroValidSharedObject (objectArray_19469, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 412)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 413)) ;
      GALGAS_bool joker_19856_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 414))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 414)), joker_19856_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 414)) ;
      GALGAS_bool joker_20163_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_19469->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 415))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)), joker_20163_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 415)) ;
      GALGAS_bool joker_20368_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423)), joker_20368_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423)) ;
      GALGAS_bool joker_20529_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424)), joker_20529_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424)) ;
      GALGAS_bool joker_20698_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 425))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 425)), joker_20698_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 425)) ;
      GALGAS_bool joker_20859_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 426))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 426)), joker_20859_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 426)) ;
      GALGAS_bool joker_21028_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 427))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 427)), joker_21028_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 427)) ;
      GALGAS_bool joker_21205_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 428))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 428)), joker_21205_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 428)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_21275 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_21275) {
          macroValidSharedObject (objectArray_21275, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_21275->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 436)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 437)) ;
      GALGAS_bool joker_21751_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438)), joker_21751_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438)) ;
      GALGAS_bool joker_21908_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 439))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 439)), joker_21908_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 439)) ;
      GALGAS_bool joker_22073_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 440))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 440)), joker_22073_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 440)) ;
      GALGAS_bool joker_22338_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 441))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 446)), joker_22338_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 441)) ;
      GALGAS_bool joker_22589_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 449))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 453)), joker_22589_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 449)) ;
      GALGAS_bool joker_22826_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 456))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 460)), joker_22826_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 456)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465)) ;
      GALGAS_bool joker_23204_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466)), joker_23204_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466)) ;
      GALGAS_bool joker_23390_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 467))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 467)), joker_23390_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 467)) ;
      GALGAS_bool joker_23580_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468)), joker_23580_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468)) ;
      GALGAS_bool joker_23756_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 469))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 469)), joker_23756_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 469)) ;
      GALGAS_bool joker_24010_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 470))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 474)), joker_24010_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 470)) ;
      GALGAS_bool joker_24273_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 476))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 481)), joker_24273_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 476)) ;
      GALGAS_bool joker_24429_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)), joker_24429_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)) ;
      GALGAS_bool joker_24584_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 484))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 484)), joker_24584_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 484)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 487)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 488)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 489)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 490)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 491)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 493)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 493)).operator_concat (GALGAS_string (".xcodeproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 493)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 494)).operator_concat (GALGAS_string ("/build/output/file-list-for-xcode-project.txt")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 494)) ;
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list-for-xcode-project.txt")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 495)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 497)) ;
    {
