...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 256)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 257)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 258)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-i386-linux-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 259)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86-64-linux-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 260)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-mingw-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 261)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys-on-win32")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 262)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 263)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 265)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 266)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 267)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 268)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 269)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 270)) ;
  ...
  cEnumerator_lstringlist enumerator_12792 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_12792.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_availableGenerationFeatures.reader_hasKey (enumerator_12792.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 276)).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = var_generationFeatures.reader_hasKey (enumerator_12792.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 277)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("duplicate '").operator_concat (enumerator_12792.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 278))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 278)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 278))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 278)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("duplicate '").operator_concat (enumerator_12792.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 289)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_11) {
            ...
            if (kBoolTrue == test_12) {
              GALGAS_location location_13 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_13, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 295)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_11) {
            const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              ...
              if (kBoolTrue == test_15) {
                GALGAS_location location_16 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_16, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 302)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_14) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                ...
                if (kBoolTrue == test_18) {
                  GALGAS_location location_19 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_19, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 309)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_17) {
                const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_20) {
                  ...
                  if (kBoolTrue == test_21) {
                    GALGAS_location location_22 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_22, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 316)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_20) {
                  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_12792.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_23) {
                    ...
                    if (kBoolTrue == test_24) {
                      GALGAS_location location_25 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 323)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_23) {
                    var_generationFeatures.addAssign_operation (enumerator_12792.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 328)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_15188 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_15188.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_15188.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 333)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 333))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 333)) ;
        enumerator_15188.gotoNextObject () ;
      }
      GALGAS_location location_26 (enumerator_12792.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("unknown '").operator_concat (enumerator_12792.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)) ;
    }
    enumerator_12792.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 339)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 339)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 339)).boolEnum () ;
  if (kBoolTrue == test_27) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)) ;
  }
  const enumGalgasBool test_28 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 343)).boolEnum () ;
  if (kBoolTrue == test_28) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 344)) ;
    }
  }
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 347)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-i386-linux-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 349)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 350)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86_64-linux-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 352)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 353)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-mingw-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 355)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 356)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msy-on-win32") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 358)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 359)) ;
    }
  }
  ...
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 370)).operator_concat (GALGAS_string ("/build/lists/file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 370)) ;
  GALGAS_bool joker_17080_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17080_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 371)) ;
  const enumGalgasBool test_36 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_36) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 374)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 375)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_17292 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_17292) {
        macroValidSharedObject (objectArray_17292, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_17292->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_17775_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 389)), joker_17775_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 389)) ;
    const enumGalgasBool test_37 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 391)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 391)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 391)).boolEnum () ;
    if (kBoolTrue == test_37) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 392))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 392)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 392)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)) ;
    GALGAS_bool joker_18276_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_18276_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)) ;
    const enumGalgasBool test_38 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)).boolEnum () ;
    if (kBoolTrue == test_38) {
      GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_18585 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_18585) {
        macroValidSharedObject (objectArray_18585, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 405)) ;
      GALGAS_bool joker_18972_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)), joker_18972_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)) ;
      GALGAS_bool joker_19279_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_18585->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 412)), joker_19279_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407)) ;
      GALGAS_bool joker_19484_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 415))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 415)), joker_19484_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 415)) ;
      GALGAS_bool joker_19645_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 416))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 416)), joker_19645_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 416)) ;
      GALGAS_bool joker_19814_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 417))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 417)), joker_19814_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 417)) ;
      GALGAS_bool joker_19975_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 418))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 418)), joker_19975_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 418)) ;
      GALGAS_bool joker_20144_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)), joker_20144_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)) ;
      GALGAS_bool joker_20321_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)), joker_20321_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_20391 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_20391) {
          macroValidSharedObject (objectArray_20391, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_20391->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 428)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 429)) ;
      GALGAS_bool joker_20867_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 430))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 430)), joker_20867_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 430)) ;
      GALGAS_bool joker_21024_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 431))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 431)), joker_21024_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 431)) ;
      GALGAS_bool joker_21189_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 432))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 432)), joker_21189_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 432)) ;
      GALGAS_bool joker_21454_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 433))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438)), joker_21454_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 433)) ;
      GALGAS_bool joker_21705_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 441))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 445)), joker_21705_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 441)) ;
      GALGAS_bool joker_21942_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 448))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 452)), joker_21942_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 448)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 456)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 457)) ;
      GALGAS_bool joker_22320_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 458))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 458)), joker_22320_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 458)) ;
      GALGAS_bool joker_22506_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 459))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 459)), joker_22506_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 459)) ;
      GALGAS_bool joker_22696_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 460))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 460)), joker_22696_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 460)) ;
      GALGAS_bool joker_22872_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461)), joker_22872_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461)) ;
      GALGAS_bool joker_23126_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466)), joker_23126_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462)) ;
      GALGAS_bool joker_23389_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 473)), joker_23389_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468)) ;
      GALGAS_bool joker_23545_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 475))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 475)), joker_23545_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 475)) ;
      GALGAS_bool joker_23700_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 476))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 476)), joker_23700_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 476)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 480)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 481)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 482)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 485)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 485)).operator_concat (GALGAS_string (".xcodeproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 485)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 486)).operator_concat (GALGAS_string ("/build/lists/file-list-for-xcode-project.txt")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 486)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 488)) ;
    {
