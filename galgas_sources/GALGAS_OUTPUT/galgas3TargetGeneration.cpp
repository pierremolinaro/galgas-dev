...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  cEnumerator_lstringlist enumerator_16811 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16811.hasCurrentObject ()) {
    const enumGalgasBool test_3 = var_availableGenerationFeatures.reader_hasKey (enumerator_16811.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).boolEnum () ;
    if (kBoolTrue == test_3) {
      const enumGalgasBool test_4 = var_generationFeatures.reader_hasKey (enumerator_16811.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("duplicate '").operator_concat (enumerator_16811.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
      }
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        const enumGalgasBool test_7 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_location location_8 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("duplicate '").operator_concat (enumerator_16811.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_10) {
            GALGAS_location location_11 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_11, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (369)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_9) {
          const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            ...
            if (kBoolTrue == test_13) {
              GALGAS_location location_14 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_14, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (375)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_12) {
            const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_15) {
              ...
              if (kBoolTrue == test_16) {
                GALGAS_location location_17 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_17, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (382)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_15) {
              const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_18) {
                ...
                if (kBoolTrue == test_19) {
                  GALGAS_location location_20 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_20, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (389)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_18) {
                const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_21) {
                  ...
                  if (kBoolTrue == test_22) {
                    GALGAS_location location_23 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_23, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (396)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_21) {
                  const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, enumerator_16811.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_24) {
                    ...
                    if (kBoolTrue == test_25) {
                      GALGAS_location location_26 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_26, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (403)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_24) {
                    var_generationFeatures.addAssign_operation (enumerator_16811.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_19210 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_19210.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_19210.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)) ;
        enumerator_19210.gotoNextObject () ;
      }
      GALGAS_location location_27 (enumerator_16811.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("unknown '").operator_concat (enumerator_16811.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)) ;
    }
  ...
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (423)).boolEnum () ;
  ...
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (426)).boolEnum () ;
  ...
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (429)).boolEnum () ;
  ...
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (432)).boolEnum () ;
  ...
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (435)).boolEnum () ;
  ...
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (438)).boolEnum () ;
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, constinArgument_inToolProductFileList, var_libpmPath, temp_35 COMMA_SOURCE_FILE_AT_LINE (442))) ;
  ...
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_21065_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (450)) ;
  ...
  if (kBoolTrue == test_37) {
    ...
    GALGAS_bool joker_21474_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_21474_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_21541 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_21541) {
        macroValidSharedObject (objectArray_21541, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_21541->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_22023_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (471)), joker_22023_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
    const enumGalgasBool test_38 = var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (473)).reader_fileExists (SOURCE_FILE_AT_LINE (473)).operator_not (SOURCE_FILE_AT_LINE (473)).boolEnum () ;
    ...
    GALGAS_bool joker_22523_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (479))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22523_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (479)) ;
    ...
    const enumGalgasBool test_39 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE_AT_LINE (481)).operator_not (SOURCE_FILE_AT_LINE (481)).boolEnum () ;
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_22832 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_22832) {
        macroValidSharedObject (objectArray_22832, cMapElement_projectQualifiedFeatureMap) ;
      ...
      GALGAS_bool joker_23219_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (488))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (488)), joker_23219_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (488)) ;
      GALGAS_bool joker_23525_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, var_projectName, objectArray_22832->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (489))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (494)), joker_23525_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
      GALGAS_bool joker_23729_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (497))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (497)), joker_23729_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (497)) ;
      GALGAS_bool joker_23890_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (498))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (498)), joker_23890_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
      GALGAS_bool joker_24059_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (499))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (499)), joker_24059_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
      GALGAS_bool joker_24220_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (500))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (500)), joker_24220_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      GALGAS_bool joker_24389_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (501))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (501)), joker_24389_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      GALGAS_bool joker_24566_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (502))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24566_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_24636 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_24636) {
          macroValidSharedObject (objectArray_24636, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_24636->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
      ...
      GALGAS_bool joker_26562_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (540))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (540)), joker_26562_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (540)) ;
      GALGAS_bool joker_26748_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (541))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (541)), joker_26748_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (541)) ;
      GALGAS_bool joker_26937_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (542))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (542)), joker_26937_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (542)) ;
      GALGAS_bool joker_27113_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (543))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (543)), joker_27113_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
      GALGAS_bool joker_27366_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (548)), joker_27366_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
      GALGAS_bool joker_27628_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, var_projectName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (550))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (555)), joker_27628_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (550)) ;
      GALGAS_bool joker_27784_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (557))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (557)), joker_27784_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (557)) ;
      GALGAS_bool joker_27939_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (558))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (558)), joker_27939_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
    }
