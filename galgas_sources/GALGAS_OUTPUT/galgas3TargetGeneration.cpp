...
const char * gWrapperFileContent_6_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_3 [5] = {
...
const char * gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
const char * gWrapperFileContent_18_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
const char * gWrapperFileContent_19_targetGalgas_33_GenerationFileWrapper = "#! /usr/bin/env python\n"
  "# -*- coding: UTF-8 -*-\n"
  "\n"
  "#------------------------------------------------------------------------------*\n"
  "# https://docs.python.org/2/library/subprocess.html#module-subprocess\n"
...
const char * gWrapperFileContent_23_targetGalgas_33_GenerationFileWrapper = "{\\rtf1\\ansi\\ansicpg1252\\cocoartf1138\\cocoasubrtf510\n"
...
const char * gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper = "{\\rtf1\\mac\\ansicpg10000\\cocoartf824\\cocoasubrtf380\n"
...
void routine_generateGalgas_33_MsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
                                                        ...
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-msys32-on-windows")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 125)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 126)) ;
  GALGAS_bool joker_4845_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_20_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)), joker_4845_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)) ;
  GALGAS_bool joker_4990_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_21_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)), joker_4990_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)) ;
  GALGAS_bool joker_5139_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_22_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)), joker_5139_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)) ;
  GALGAS_bool joker_5299_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_msys_33__32__5F_on_5F_windows_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)), joker_5299_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)) ;
}
...
void routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_9718_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 199)), joker_9718_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 199)) ;
  GALGAS_bool joker_9878_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_18_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 200)), joker_9878_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 200)) ;
  GALGAS_bool joker_10054_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_19_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201)), joker_10054_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201)) ;
  GALGAS_bool joker_10218_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_36__34__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 202))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 202)), joker_10218_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 202)) ;
}
...
void routine_updateGalgas_33_Targets (const GALGAS_string constinArgument_inProjectSourceFilePath,
  ...
  GALGAS_bool joker_11219_0 ; // Joker input parameter
  ...
  const cMapElement_projectQualifiedFeatureMap * objectArray_11376 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_11376) {
      macroValidSharedObject (objectArray_11376, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_11376->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_11376->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_libpmPath = objectArray_11376->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
  ...
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys32-on-windows")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 269)) ;
  ...
  cEnumerator_lstringlist enumerator_13652 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13652.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_availableGenerationFeatures.reader_hasKey (enumerator_13652.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = var_generationFeatures.reader_hasKey (enumerator_13652.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("duplicate '").operator_concat (enumerator_13652.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 285)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("duplicate '").operator_concat (enumerator_13652.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 290)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_11) {
            ...
            if (kBoolTrue == test_12) {
              GALGAS_location location_13 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              ...
              if (kBoolTrue == test_15) {
                GALGAS_location location_16 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              ...
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                ...
                if (kBoolTrue == test_18) {
                  GALGAS_location location_19 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                ...
                const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_20) {
                  ...
                  if (kBoolTrue == test_21) {
                    GALGAS_location location_22 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  ...
                  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_13652.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_23) {
                    ...
                    if (kBoolTrue == test_24) {
                      GALGAS_location location_25 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    ...
                    var_generationFeatures.addAssign_operation (enumerator_13652.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 335)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_16048 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_16048.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_16048.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 340)) ;
        enumerator_16048.gotoNextObject () ;
      }
      GALGAS_location location_26 (enumerator_13652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("unknown '").operator_concat (enumerator_13652.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)) ;
    }
  ...
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msys32-on-windows") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 365)).boolEnum () ;
  ...
  GALGAS_bool joker_17944_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17944_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 378)) ;
  ...
  if (kBoolTrue == test_36) {
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_18200 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_18200) {
        macroValidSharedObject (objectArray_18200, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_18200->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_18683_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)), joker_18683_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 397)) ;
    ...
    if (kBoolTrue == test_38) {
      GALGAS_string (gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 408)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_19493 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_19493) {
        macroValidSharedObject (objectArray_19493, cMapElement_projectQualifiedFeatureMap) ;
