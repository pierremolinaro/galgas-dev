...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectName = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (211)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (211)) ;
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (212)) ;
  GALGAS_bool joker_10320_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE_AT_LINE (214))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (215)).operator_concat (GALGAS_string ("/build/output/project_header.h") COMMA_SOURCE_FILE_AT_LINE (215)), joker_10320_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (214)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_10430 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_10430) {
      macroValidSharedObject (objectArray_10430, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_10430->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_10430->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty") COMMA_SOURCE_FILE_AT_LINE (222)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_10430->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (227)).operator_concat (GALGAS_string ("/build/libpm") COMMA_SOURCE_FILE_AT_LINE (227)), inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
    }
    var_libpmPath = GALGAS_string ("../build/libpm") ;
  }
  GALGAS_stringset var_externSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (236)) ;
  GALGAS_stringset var_guiSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (237)) ;
  GALGAS_stringset var_scannerSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (238)) ;
  GALGAS_stringset var_optionSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (239)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (240)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (241)) ;
  GALGAS_stringset var_grammarSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (242)) ;
  GALGAS_stringset var_programSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (243)) ;
  GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (245)) ;
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (246)) ;
  GALGAS_stringset var_scannerSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (247)) ;
  GALGAS_stringset var_optionSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (248)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (249)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (250)) ;
  GALGAS_stringset var_grammarSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (251)) ;
  GALGAS_stringset var_programSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (252)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (254)) ;
  GALGAS_stringlist var_handCodedSourceList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (256)) ;
  GALGAS_stringset var_handCodedSourceDirectorySet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (257)) ;
  ...
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (262)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE_AT_LINE (263)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE_AT_LINE (264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-i386-linux-on-macosx") COMMA_SOURCE_FILE_AT_LINE (265)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86-64-linux-on-macosx") COMMA_SOURCE_FILE_AT_LINE (266)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-mingw-on-macosx") COMMA_SOURCE_FILE_AT_LINE (267)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys-on-win32") COMMA_SOURCE_FILE_AT_LINE (268)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard") COMMA_SOURCE_FILE_AT_LINE (269)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion") COMMA_SOURCE_FILE_AT_LINE (270)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion") COMMA_SOURCE_FILE_AT_LINE (271)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks") COMMA_SOURCE_FILE_AT_LINE (272)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite") COMMA_SOURCE_FILE_AT_LINE (273)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS") COMMA_SOURCE_FILE_AT_LINE (274)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading") COMMA_SOURCE_FILE_AT_LINE (275)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (276)) ;
  ...
  cEnumerator_lstringlist enumerator_13265 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13265.hasCurrentObject ()) {
    const enumGalgasBool test_3 = var_availableGenerationFeatures.reader_hasKey (enumerator_13265.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (282)) COMMA_SOURCE_FILE_AT_LINE (282)).boolEnum () ;
    if (kBoolTrue == test_3) {
      const enumGalgasBool test_4 = var_generationFeatures.reader_hasKey (enumerator_13265.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("duplicate '").operator_concat (enumerator_13265.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (284)) COMMA_SOURCE_FILE_AT_LINE (284)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_SOURCE_FILE_AT_LINE (284)) ;
      }
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        const enumGalgasBool test_7 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_location location_8 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("duplicate '").operator_concat (enumerator_13265.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (289)) COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (289)) COMMA_SOURCE_FILE_AT_LINE (289)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_10) {
            GALGAS_location location_11 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_11, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (295)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_9) {
          const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            ...
            if (kBoolTrue == test_13) {
              GALGAS_location location_14 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_14, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (301)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_12) {
            const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_15) {
              ...
              if (kBoolTrue == test_16) {
                GALGAS_location location_17 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_17, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (308)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_15) {
              const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_18) {
                ...
                if (kBoolTrue == test_19) {
                  GALGAS_location location_20 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_20, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (315)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_18) {
                const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_21) {
                  ...
                  if (kBoolTrue == test_22) {
                    GALGAS_location location_23 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_23, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (322)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_21) {
                  const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, enumerator_13265.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_24) {
                    ...
                    if (kBoolTrue == test_25) {
                      GALGAS_location location_26 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_26, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (329)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_24) {
                    var_generationFeatures.addAssign_operation (enumerator_13265.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (334)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_15664 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_15664.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_15664.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (339)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)) ;
        enumerator_15664.gotoNextObject () ;
      }
      GALGAS_location location_27 (enumerator_13265.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("unknown '").operator_concat (enumerator_13265.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (341)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)) ;
    }
    enumerator_13265.gotoNextObject () ;
  }
  const enumGalgasBool test_28 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE_AT_LINE (345)).operator_not (SOURCE_FILE_AT_LINE (345)) COMMA_SOURCE_FILE_AT_LINE (345)).boolEnum () ;
  if (kBoolTrue == test_28) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'") COMMA_SOURCE_FILE_AT_LINE (346)) ;
  }
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (349)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (350)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (352)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (353)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (355)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (358)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (361)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (362)) ;
    }
  }
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (364)).boolEnum () ;
  if (kBoolTrue == test_34) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (365)) ;
    }
  }
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, constinArgument_inToolProductFileList, var_libpmPath, temp_35 COMMA_SOURCE_FILE_AT_LINE (368))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (375)).operator_concat (GALGAS_string ("/build/output/file_list.mak") COMMA_SOURCE_FILE_AT_LINE (375)) ;
  GALGAS_bool joker_17519_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17519_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
  const enumGalgasBool test_37 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_37) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project") COMMA_SOURCE_FILE_AT_LINE (379)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf") COMMA_SOURCE_FILE_AT_LINE (382)) ;
    GALGAS_bool joker_17928_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_17928_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_17995 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_17995) {
        macroValidSharedObject (objectArray_17995, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_17995->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
      var_applicationBundleBase = GALGAS_string ("fr.irccyn") ;
    }
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, var_projectName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE_AT_LINE (391))) ;
    GALGAS_bool joker_18477_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (397)), joker_18477_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (397)) ;
    const enumGalgasBool test_38 = var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (399)).reader_fileExists (SOURCE_FILE_AT_LINE (399)).operator_not (SOURCE_FILE_AT_LINE (399)).boolEnum () ;
    if (kBoolTrue == test_38) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE_AT_LINE (400))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (400)), inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
    }
    ...
    GALGAS_bool joker_18977_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (405))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_18977_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) ;
    ...
    const enumGalgasBool test_39 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE_AT_LINE (407)).operator_not (SOURCE_FILE_AT_LINE (407)).boolEnum () ;
    if (kBoolTrue == test_39) {
      GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_19286 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_19286) {
        macroValidSharedObject (objectArray_19286, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application") COMMA_SOURCE_FILE_AT_LINE (412)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (413)) ;
      GALGAS_bool joker_19673_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (414))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (414)), joker_19673_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (414)) ;
      GALGAS_bool joker_19979_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, var_projectName, objectArray_19286->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (415))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (420)), joker_19979_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (415)) ;
      GALGAS_bool joker_20183_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (423))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (423)), joker_20183_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (423)) ;
      GALGAS_bool joker_20344_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (424))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (424)), joker_20344_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (424)) ;
      GALGAS_bool joker_20513_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (425))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (425)), joker_20513_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
      GALGAS_bool joker_20674_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (426))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (426)), joker_20674_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (426)) ;
      GALGAS_bool joker_20843_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (427))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (427)), joker_20843_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (427)) ;
      GALGAS_bool joker_21020_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (428))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (428)), joker_21020_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (428)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_21090 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_21090) {
          macroValidSharedObject (objectArray_21090, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_21090->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool") COMMA_SOURCE_FILE_AT_LINE (436)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) ;
      GALGAS_bool joker_21566_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE_AT_LINE (438))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h") COMMA_SOURCE_FILE_AT_LINE (438)), joker_21566_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (438)) ;
      GALGAS_bool joker_21723_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (439))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h") COMMA_SOURCE_FILE_AT_LINE (439)), joker_21723_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) ;
      GALGAS_bool joker_21888_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (440))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m") COMMA_SOURCE_FILE_AT_LINE (440)), joker_21888_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
      GALGAS_bool joker_22152_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, var_projectName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (441))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist") COMMA_SOURCE_FILE_AT_LINE (446)), joker_22152_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) ;
      GALGAS_bool joker_22402_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (449))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist") COMMA_SOURCE_FILE_AT_LINE (453)), joker_22402_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
      GALGAS_bool joker_22638_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (456))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m") COMMA_SOURCE_FILE_AT_LINE (460)), joker_22638_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (456)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application") COMMA_SOURCE_FILE_AT_LINE (464)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (465)) ;
      GALGAS_bool joker_23016_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (466))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (466)), joker_23016_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
      GALGAS_bool joker_23202_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (467))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (467)), joker_23202_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
      GALGAS_bool joker_23391_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (468))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (468)), joker_23391_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (468)) ;
      GALGAS_bool joker_23567_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (469))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (469)), joker_23567_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (469)) ;
      GALGAS_bool joker_23820_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (470))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (474)), joker_23820_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (470)) ;
      GALGAS_bool joker_24082_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, var_projectName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (476))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (481)), joker_24082_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (476)) ;
      GALGAS_bool joker_24238_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (483))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (483)), joker_24238_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (483)) ;
      GALGAS_bool joker_24393_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (484))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (484)), joker_24393_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources") COMMA_SOURCE_FILE_AT_LINE (487)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (488)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (489)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns") COMMA_SOURCE_FILE_AT_LINE (490)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE_AT_LINE (491)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (GALGAS_string (".xcodeproj") COMMA_SOURCE_FILE_AT_LINE (493)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (494)).operator_concat (GALGAS_string ("/build/output/file_list_for_xcode_project.txt") COMMA_SOURCE_FILE_AT_LINE (494)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (496)) ;
    {
