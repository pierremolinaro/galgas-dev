...
GALGAS_string filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_625 (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET, kEnumeration_up) ;
    while (enumerator_625.hasCurrentObject ()) {
      result << "SOURCES_DIR += " ;
      result << enumerator_625.current_key (HERE).stringValue () ;
      result << "\n" ;
  ...
  result << "\n"
    ...
    "\n"
    "#--- Hand-coded files ---------------------\n" ;
  GALGAS_uint index_1244_ (0) ;
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1244 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1244.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1244.current_mValue (HERE).stringValue () ;
      result << "\n" ;
      index_1244_.increment () ;
      enumerator_1244.gotoNextObject () ;
    }
  }
  result << "\n"
    "#--- Files generated by GALGAS ------------\n" ;
  GALGAS_uint index_1353_ (0) ;
  if (in_MAKEFILE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1353 (in_MAKEFILE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1353.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1353.current_mValue (HERE).stringValue () ;
      result << "\n" ;
      index_1353_.increment () ;
