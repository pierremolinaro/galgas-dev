...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86_64-linux-on-macosx") COMMA_SOURCE_FILE_AT_LINE (266)) ;
