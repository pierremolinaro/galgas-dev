...
GALGAS_string filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_MAKEFILE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1222 (in_MAKEFILE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1222.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1222.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  result << "\n"
    "#--- Hand-coded files ---------------------------------------------------------*\n" ;
  GALGAS_uint index_1377_ (0) ;
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1377 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1377.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1377.current_mValue (HERE).stringValue () ;
      result << "\n" ;
      index_1377_.increment () ;
  ...
  if (in_TOOL_5F_LINK_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_5506 (in_TOOL_5F_LINK_5F_LIST, kEnumeration_up) ;
    while (enumerator_5506.hasCurrentObject ()) {
      result << "USER_LINK_OPTIONS += " ;
      result << enumerator_5506.current_mValue (HERE).stringValue () ;
      result << "\n" ;
