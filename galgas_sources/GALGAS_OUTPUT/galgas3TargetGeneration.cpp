...
void routine_updateGalgas_33_Targets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE_AT_LINE (214))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (215)).operator_concat (GALGAS_string ("/build/output/project_header.h") COMMA_SOURCE_FILE_AT_LINE (215)), joker_10313_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (214)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_10367 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_10367) {
      macroValidSharedObject (objectArray_10367, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_10367->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_10367->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_libpmPath = objectArray_10367->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    ...
    GALGAS_string var_libpmAbsolutePath = var_libpmPath.reader_absolutePathFromPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229)) ;
    const enumGalgasBool test_2 = var_libpmAbsolutePath.reader_directoryExists (SOURCE_FILE_AT_LINE (230)).operator_not (SOURCE_FILE_AT_LINE (230)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (constinArgument_inEndOfProjectSourceFile, GALGAS_string ("the '").operator_concat (var_libpmAbsolutePath COMMA_SOURCE_FILE_AT_LINE (231)).operator_concat (GALGAS_string ("'  LIBPM directory does not exists") COMMA_SOURCE_FILE_AT_LINE (231)) COMMA_SOURCE_FILE_AT_LINE (231)) ;
    }
  }
  ...
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (336)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (337)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (338)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (339)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (340)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (341)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (342)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard") COMMA_SOURCE_FILE_AT_LINE (343)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion") COMMA_SOURCE_FILE_AT_LINE (344)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion") COMMA_SOURCE_FILE_AT_LINE (345)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks") COMMA_SOURCE_FILE_AT_LINE (346)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite") COMMA_SOURCE_FILE_AT_LINE (347)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS") COMMA_SOURCE_FILE_AT_LINE (348)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading") COMMA_SOURCE_FILE_AT_LINE (349)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (350)) ;
  ...
  cEnumerator_lstringlist enumerator_16744 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16744.hasCurrentObject ()) {
    const enumGalgasBool test_4 = var_availableGenerationFeatures.reader_hasKey (enumerator_16744.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = var_generationFeatures.reader_hasKey (enumerator_16744.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_location location_6 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_6, GALGAS_string ("duplicate '").operator_concat (enumerator_16744.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
      }
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        const enumGalgasBool test_8 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("duplicate '").operator_concat (enumerator_16744.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_10) {
          const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_11) {
            GALGAS_location location_12 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_12, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (369)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_10) {
          const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_13) {
            const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_14) {
              GALGAS_location location_15 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_15, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (375)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_13) {
            const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_16) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_17) {
                GALGAS_location location_18 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_18, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (382)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_16) {
              const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_19) {
                ...
                if (kBoolTrue == test_20) {
                  GALGAS_location location_21 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_21, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (389)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_19) {
                const enumGalgasBool test_22 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_22) {
                  ...
                  if (kBoolTrue == test_23) {
                    GALGAS_location location_24 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_24, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (396)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_22) {
                  const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, enumerator_16744.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_25) {
                    ...
                    if (kBoolTrue == test_26) {
                      GALGAS_location location_27 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_27, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (403)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_25) {
                    var_generationFeatures.addAssign_operation (enumerator_16744.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_19143 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_19143.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_19143.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)) ;
        enumerator_19143.gotoNextObject () ;
      }
      GALGAS_location location_28 (enumerator_16744.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_28, GALGAS_string ("unknown '").operator_concat (enumerator_16744.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)) ;
    }
    enumerator_16744.gotoNextObject () ;
  }
  const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE_AT_LINE (419)).operator_not (SOURCE_FILE_AT_LINE (419)) COMMA_SOURCE_FILE_AT_LINE (419)).boolEnum () ;
  if (kBoolTrue == test_29) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'") COMMA_SOURCE_FILE_AT_LINE (420)) ;
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (423)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (424)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (426)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (427)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (429)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (432)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) ;
    }
  }
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (435)).boolEnum () ;
  if (kBoolTrue == test_34) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
    }
  }
  const enumGalgasBool test_35 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (438)).boolEnum () ;
  if (kBoolTrue == test_35) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, var_projectName, inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) ;
    }
  }
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, constinArgument_inToolProductFileList, var_libpmPath, temp_36 COMMA_SOURCE_FILE_AT_LINE (442))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (449)).operator_concat (GALGAS_string ("/build/output/file_list.mak") COMMA_SOURCE_FILE_AT_LINE (449)) ;
  GALGAS_bool joker_20998_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20998_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (450)) ;
  const enumGalgasBool test_38 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_38) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project") COMMA_SOURCE_FILE_AT_LINE (453)) ;
    ...
    GALGAS_bool joker_21407_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_21407_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_21474 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_21474) {
        macroValidSharedObject (objectArray_21474, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_21474->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
      var_applicationBundleBase = GALGAS_string ("fr.irccyn") ;
    }
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, var_projectName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE_AT_LINE (465))) ;
    GALGAS_bool joker_21956_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (471)), joker_21956_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
    const enumGalgasBool test_39 = var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (473)).reader_fileExists (SOURCE_FILE_AT_LINE (473)).operator_not (SOURCE_FILE_AT_LINE (473)).boolEnum () ;
    if (kBoolTrue == test_39) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE_AT_LINE (474))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (474)), inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) ;
    }
    ...
    GALGAS_bool joker_22456_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (479))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22456_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (479)) ;
    ...
    const enumGalgasBool test_40 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE_AT_LINE (481)).operator_not (SOURCE_FILE_AT_LINE (481)).boolEnum () ;
    if (kBoolTrue == test_40) {
      GALGAS_string (gWrapperFileContent_17_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_22765 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_22765) {
        macroValidSharedObject (objectArray_22765, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application") COMMA_SOURCE_FILE_AT_LINE (486)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
      GALGAS_bool joker_23152_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (488))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (488)), joker_23152_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (488)) ;
      GALGAS_bool joker_23458_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, var_projectName, objectArray_22765->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (489))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (494)), joker_23458_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
      GALGAS_bool joker_23662_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (497))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (497)), joker_23662_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (497)) ;
      GALGAS_bool joker_23823_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (498))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (498)), joker_23823_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
      GALGAS_bool joker_23992_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (499))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (499)), joker_23992_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
      GALGAS_bool joker_24153_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (500))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (500)), joker_24153_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      GALGAS_bool joker_24322_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (501))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (501)), joker_24322_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      GALGAS_bool joker_24499_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (502))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24499_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_24569 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_24569) {
          macroValidSharedObject (objectArray_24569, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_24569->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool") COMMA_SOURCE_FILE_AT_LINE (510)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (511)) ;
      GALGAS_bool joker_25045_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE_AT_LINE (512))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h") COMMA_SOURCE_FILE_AT_LINE (512)), joker_25045_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (512)) ;
      GALGAS_bool joker_25202_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (513))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h") COMMA_SOURCE_FILE_AT_LINE (513)), joker_25202_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (513)) ;
      GALGAS_bool joker_25367_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (514))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m") COMMA_SOURCE_FILE_AT_LINE (514)), joker_25367_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (514)) ;
      GALGAS_bool joker_25631_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, var_projectName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (515))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist") COMMA_SOURCE_FILE_AT_LINE (520)), joker_25631_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (515)) ;
      GALGAS_bool joker_25881_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (523))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist") COMMA_SOURCE_FILE_AT_LINE (527)), joker_25881_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (523)) ;
      GALGAS_bool joker_26117_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (530))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m") COMMA_SOURCE_FILE_AT_LINE (534)), joker_26117_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (530)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application") COMMA_SOURCE_FILE_AT_LINE (538)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
      GALGAS_bool joker_26495_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (540))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (540)), joker_26495_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (540)) ;
      GALGAS_bool joker_26681_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (541))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (541)), joker_26681_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (541)) ;
      GALGAS_bool joker_26870_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (542))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (542)), joker_26870_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (542)) ;
      GALGAS_bool joker_27046_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (543))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (543)), joker_27046_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
      GALGAS_bool joker_27299_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, var_projectName COMMA_SOURCE_FILE_AT_LINE (544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (548)), joker_27299_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
      GALGAS_bool joker_27561_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, var_projectName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (550))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (555)), joker_27561_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (550)) ;
      GALGAS_bool joker_27717_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (557))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (557)), joker_27717_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (557)) ;
      GALGAS_bool joker_27872_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (558))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (558)), joker_27872_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources") COMMA_SOURCE_FILE_AT_LINE (561)) ;
    ...
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (567)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (567)).operator_concat (GALGAS_string (".xcodeproj") COMMA_SOURCE_FILE_AT_LINE (567)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (568)).operator_concat (GALGAS_string ("/build/output/file_list_for_xcode_project.txt") COMMA_SOURCE_FILE_AT_LINE (568)) ;
