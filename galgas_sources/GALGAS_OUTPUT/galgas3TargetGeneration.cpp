...
void routine_updateGalgas_33_Targets (const GALGAS_string constinArgument_inProjectSourceFilePath,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 233)) ;
  GALGAS_bool joker_12019_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 235))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 236)).operator_concat (GALGAS_string ("/build/output/project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 236)), joker_12019_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 235)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 239)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_12176 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_12176) {
      macroValidSharedObject (objectArray_12176, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_12176->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_12176->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 244)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_12176->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 249)).operator_concat (GALGAS_string ("/build/libpm")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 249)), inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 249)) ;
    }
    var_libpmPath = GALGAS_string ("../build/libpm") ;
  }
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_setWithStringList (constinArgument_inAppProductFileList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 255)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 257)) ;
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 259)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 260)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 261)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 262)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 263)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-win32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys32-on-windows")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 265)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 266)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 267)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 268)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 269)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 270)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 271)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 272)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 273)) ;
  ...
  cEnumerator_lstringlist enumerator_13769 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13769.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_availableGenerationFeatures.reader_hasKey (enumerator_13769.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 279)).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = var_generationFeatures.reader_hasKey (enumerator_13769.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 280)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("duplicate '").operator_concat (enumerator_13769.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 281))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 281)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 281))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 281)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("duplicate '").operator_concat (enumerator_13769.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 286))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 286)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 286))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 286)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 292)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_11) {
            ...
            if (kBoolTrue == test_12) {
              GALGAS_location location_13 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_13, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 298)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_11) {
            const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              ...
              if (kBoolTrue == test_15) {
                GALGAS_location location_16 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_16, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 305)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_14) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                ...
                if (kBoolTrue == test_18) {
                  GALGAS_location location_19 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_19, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 312)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_17) {
                const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_20) {
                  ...
                  if (kBoolTrue == test_21) {
                    GALGAS_location location_22 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_22, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 319)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_20) {
                  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_23) {
                    ...
                    if (kBoolTrue == test_24) {
                      GALGAS_location location_25 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 326)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_23) {
                    var_generationFeatures.addAssign_operation (enumerator_13769.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 331)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_16165 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_16165.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_16165.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 336)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 336))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 336)) ;
        enumerator_16165.gotoNextObject () ;
      }
      GALGAS_location location_26 (enumerator_13769.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("unknown '").operator_concat (enumerator_13769.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 338)) ;
    }
    enumerator_13769.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 342)).boolEnum () ;
  if (kBoolTrue == test_27) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 343)) ;
  }
  const enumGalgasBool test_28 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)).boolEnum () ;
  if (kBoolTrue == test_28) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 347)) ;
    }
  }
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 349)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 350)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 352)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 353)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux64-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 355)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 356)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-win32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 358)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 359)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msys32-on-windows") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 361)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 362)) ;
    }
  }
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, constinArgument_inHandCodedSourceDirectorySet, constinArgument_inHandCodedSourceToolFileList, constinArgument_inToolProductFileList, constinArgument_inHandCodedLinkToolFileList, var_libpmPath, temp_34 COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 365))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 373)).operator_concat (GALGAS_string ("/build/output/file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 373)) ;
  GALGAS_bool joker_18065_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_18065_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 374)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 375)) ;
  const enumGalgasBool test_36 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_36) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 378)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 379)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_18321 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_18321) {
        macroValidSharedObject (objectArray_18321, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_18321->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_18804_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 393)), joker_18804_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 393)) ;
    const enumGalgasBool test_37 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 395)).boolEnum () ;
    if (kBoolTrue == test_37) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 400)) ;
    GALGAS_bool joker_19305_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 401))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_19305_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 401)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 402)) ;
    const enumGalgasBool test_38 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)).boolEnum () ;
    if (kBoolTrue == test_38) {
      GALGAS_string (gWrapperFileContent_19_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_19614 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_19614) {
        macroValidSharedObject (objectArray_19614, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 408)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 409)) ;
      GALGAS_bool joker_20001_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 410))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 410)), joker_20001_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 410)) ;
      GALGAS_bool joker_20308_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_19614->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 411))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 416)), joker_20308_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 411)) ;
      GALGAS_bool joker_20513_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)), joker_20513_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)) ;
      GALGAS_bool joker_20674_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)), joker_20674_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 420)) ;
      GALGAS_bool joker_20843_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 421))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 421)), joker_20843_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 421)) ;
      GALGAS_bool joker_21004_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422)), joker_21004_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422)) ;
      GALGAS_bool joker_21173_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423)), joker_21173_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 423)) ;
      GALGAS_bool joker_21350_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424)), joker_21350_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_21420 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_21420) {
          macroValidSharedObject (objectArray_21420, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_21420->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 432)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 433)) ;
      GALGAS_bool joker_21896_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 434))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 434)), joker_21896_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 434)) ;
      GALGAS_bool joker_22053_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435)), joker_22053_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435)) ;
      GALGAS_bool joker_22218_0 ; // Joker input parameter
      ...
      GALGAS_bool joker_22483_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 437))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 442)), joker_22483_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 437)) ;
      GALGAS_bool joker_22734_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 445))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 449)), joker_22734_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 445)) ;
      GALGAS_bool joker_22971_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 452))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 456)), joker_22971_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 452)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 460)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 461)) ;
      GALGAS_bool joker_23349_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462)), joker_23349_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 462)) ;
      GALGAS_bool joker_23535_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463)), joker_23535_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463)) ;
      GALGAS_bool joker_23725_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464)), joker_23725_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464)) ;
      GALGAS_bool joker_23901_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465)), joker_23901_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465)) ;
      GALGAS_bool joker_24155_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 470)), joker_24155_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466)) ;
      GALGAS_bool joker_24418_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 472))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 477)), joker_24418_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 472)) ;
      GALGAS_bool joker_24574_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479)), joker_24574_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 479)) ;
      GALGAS_bool joker_24729_0 ; // Joker input parameter
    ...
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 484)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 485)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 486)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 487)) ;
    ...
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list-for-xcode-project.txt")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 491)) ;
    GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_setWithStringList (constinArgument_inHandCodedSourceAppFileList  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 493)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 495)) ;
    {
    routine_generateXcodeProject (GALGAS_stringset::constructor_setWithStringList (constinArgument_inHandCodedSourceToolFileList  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 498)), GALGAS_stringset::constructor_setWithStringList (constinArgument_inToolProductFileList  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 499)), GALGAS_string ("../build/output"), var_externSourceSet_5F_app, var_guiSourceSet_5F_app, constinArgument_inTargetName, constinArgument_inHandCodedLinkAppFileList, var_xcodeProjectPath, var_resourceFiles, var_intermediateFilePath, var_SDK, var_libpmPath, GALGAS_string ("../build/user-headers"), var_multiThreadingEnabled, var_usesARC, constinArgument_inProjectQualifiedFeatureMap, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 497)) ;
    }
    GALGAS_XcodeProjectDescriptor var_xcodeProject = GALGAS_XcodeProjectDescriptor::constructor_default (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 516)) ;
    GALGAS_stringlist var_buildFileRefListForTool = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 517)) ;
    GALGAS_stringlist var_generatedByGalgasFileRefList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 518)) ;
    cEnumerator_stringlist enumerator_26449 (constinArgument_inToolProductFileList, kEnumeration_up) ;
    while (enumerator_26449.hasCurrentObject ()) {
      const enumGalgasBool test_39 = GALGAS_bool (kIsEqual, enumerator_26449.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 520)).objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
      if (kBoolTrue == test_39) {
        GALGAS_string var_cppFileRef ;
        {
        categoryModifier_addCppFile (var_xcodeProject, enumerator_26449.current_mValue (HERE), var_cppFileRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 521)) ;
        }
        var_generatedByGalgasFileRefList.addAssign_operation (var_cppFileRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 522)) ;
        GALGAS_string var_buildRef ;
        {
        categoryModifier_addBuildFile (var_xcodeProject, var_cppFileRef, enumerator_26449.current_mValue (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 523)) ;
        }
        var_buildFileRefListForTool.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 524)) ;
      }else if (kBoolFalse == test_39) {
        const enumGalgasBool test_40 = GALGAS_bool (kIsEqual, enumerator_26449.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 525)).objectCompare (GALGAS_string ("h"))).boolEnum () ;
        if (kBoolTrue == test_40) {
          GALGAS_string var_headerFileRef ;
          {
          categoryModifier_addHeaderFile (var_xcodeProject, enumerator_26449.current_mValue (HERE), var_headerFileRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 526)) ;
          }
          var_generatedByGalgasFileRefList.addAssign_operation (var_headerFileRef  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 527)) ;
        }
      }
      enumerator_26449.gotoNextObject () ;
    }
    GALGAS_string var_groupeRef ;
    {
    categoryModifier_addGroup (var_xcodeProject, GALGAS_string ("Generated by GALGAS"), GALGAS_string ("../build/output"), var_generatedByGalgasFileRefList, var_groupeRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 531)) ;
    }
    GALGAS_string var_machOTargetRef ;
    {
    categoryModifier_addMachOTarget (var_xcodeProject, constinArgument_inTargetName, var_buildFileRefListForTool, var_machOTargetRef, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 532)) ;
    }
    categoryMethod_generateAtPath (var_xcodeProject, var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 533)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 533)).operator_concat (GALGAS_string ("_NEW.xcodeproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 533)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 533)) ;
  }
}
