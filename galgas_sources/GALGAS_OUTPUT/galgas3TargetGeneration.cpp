...
const char * gWrapperFileContent_15_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_6 [4] = {
...
const char * gWrapperFileContent_20_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
...
const char * gWrapperFileContent_21_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
...
const char * gWrapperFileContent_22_targetGalgas_33_GenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_8 [4] = {
...
const char * gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables clean\n" ;
...
const char * gWrapperFileContent_25_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
...
const char * gWrapperFileContent_26_targetGalgas_33_GenerationFileWrapper = "#!/bin/sh\n"
  "cd `dirname $0` && make --warn-undefined-variables all -j `sysctl -n hw.ncpu`\n" ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGalgas_33_GenerationFileWrapper_10 [3] = {
...
const char * gWrapperFileContent_28_targetGalgas_33_GenerationFileWrapper = "{\\rtf1\\ansi\\ansicpg1252\\cocoartf1138\\cocoasubrtf510\n"
...
const char * gWrapperFileContent_30_targetGalgas_33_GenerationFileWrapper = "{\\rtf1\\mac\\ansicpg10000\\cocoartf824\\cocoasubrtf380\n"
...
static const cDirectoryWrapper * gWrapperAllDirectories_targetGalgas_33_GenerationFileWrapper_11 [2] = {
...
static const cDirectoryWrapper * gWrapperAllDirectories_targetGalgas_33_GenerationFileWrapper_0 [12] = {
...
void routine_generateGalgas_33_MsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_4824_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_20_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)), joker_4824_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 127)) ;
  GALGAS_bool joker_4969_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_21_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)), joker_4969_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 128)) ;
  GALGAS_bool joker_5118_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_22_targetGalgas_33_GenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)), joker_5118_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 129)) ;
  GALGAS_bool joker_5274_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)), joker_5274_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 130)) ;
}
...
void routine_generateGalgas_33_MakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_23_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170)), joker_7682_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 170)) ;
  GALGAS_bool joker_7840_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_25_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 171)), joker_7840_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 171)) ;
  GALGAS_bool joker_7994_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_24_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 172)), joker_7994_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 172)) ;
  GALGAS_bool joker_8141_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 173))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 173)), joker_8141_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 173)) ;
}
...
void routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 182)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 183)) ;
  GALGAS_bool joker_8602_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 184)), joker_8602_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 184)) ;
  GALGAS_bool joker_8762_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 185)), joker_8762_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 185)) ;
  GALGAS_bool joker_8938_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 186)), joker_8938_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 186)) ;
  GALGAS_bool joker_9102_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_33__32__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 187))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 187)), joker_9102_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 187)) ;
}
...
void routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 196)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 197)) ;
  GALGAS_bool joker_9563_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 198)), joker_9563_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 198)) ;
  GALGAS_bool joker_9723_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 199)), joker_9723_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 199)) ;
  GALGAS_bool joker_9899_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGalgas_33_GenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/verbose-build.py")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 200)), joker_9899_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 200)) ;
  GALGAS_bool joker_10063_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_x_38__36__5F_linux_36__34__5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201)), joker_10063_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 201)) ;
}
...
void routine_updateGalgas_33_Targets (const GALGAS_string constinArgument_inProjectSourceFilePath,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 221)) ;
  GALGAS_bool joker_11064_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 223))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 224)).operator_concat (GALGAS_string ("/build/output/project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 224)), joker_11064_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 223)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("project_header.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 227)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_11221 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_11221) {
      macroValidSharedObject (objectArray_11221, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_11221->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_11221->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 232)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_11221->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 237)).operator_concat (GALGAS_string ("/build/libpm")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 237)), inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 237)) ;
    }
    var_libpmPath = GALGAS_string ("../build/libpm") ;
  }
  GALGAS_stringset var_externSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 242)) ;
  GALGAS_stringset var_guiSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 243)) ;
  GALGAS_stringset var_scannerSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 244)) ;
  GALGAS_stringset var_optionSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 245)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 246)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 247)) ;
  GALGAS_stringset var_grammarSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 248)) ;
  GALGAS_stringset var_programSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 249)) ;
  GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 251)) ;
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 252)) ;
  GALGAS_stringset var_scannerSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 253)) ;
  GALGAS_stringset var_optionSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 254)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 255)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 256)) ;
  GALGAS_stringset var_grammarSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 257)) ;
  GALGAS_stringset var_programSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 258)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 260)) ;
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 262)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 263)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-unix")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 264)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 265)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-x86linux64-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 266)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-win32-on-macosx")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 267)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile-msys-on-win32")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 268)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 269)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 270)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 271)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 272)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 273)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 274)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 275)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 276)) ;
  ...
  cEnumerator_lstringlist enumerator_13493 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_13493.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_availableGenerationFeatures.reader_hasKey (enumerator_13493.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 282)).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = var_generationFeatures.reader_hasKey (enumerator_13493.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 283)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("duplicate '").operator_concat (enumerator_13493.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 284)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("duplicate '").operator_concat (enumerator_13493.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 289))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 289)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 289))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 289)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_location location_10 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 295)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_11) {
            ...
            if (kBoolTrue == test_12) {
              GALGAS_location location_13 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_13, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 301)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_11) {
            const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              ...
              if (kBoolTrue == test_15) {
                GALGAS_location location_16 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_16, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 308)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_14) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                ...
                if (kBoolTrue == test_18) {
                  GALGAS_location location_19 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_19, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 315)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_17) {
                const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_20) {
                  ...
                  if (kBoolTrue == test_21) {
                    GALGAS_location location_22 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_22, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 322)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_20) {
                  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_13493.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_23) {
                    ...
                    if (kBoolTrue == test_24) {
                      GALGAS_location location_25 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 329)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_23) {
                    var_generationFeatures.addAssign_operation (enumerator_13493.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 334)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_15889 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_15889.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_15889.current_key (HERE)  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 339)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 339))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 339)) ;
        enumerator_15889.gotoNextObject () ;
      }
      GALGAS_location location_26 (enumerator_13493.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("unknown '").operator_concat (enumerator_13493.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341)).operator_concat (var_s  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341))  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 341)) ;
    }
    enumerator_13493.gotoNextObject () ;
  }
  const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 345)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 345)) COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 345)).boolEnum () ;
  if (kBoolTrue == test_27) {
    inCompiler->emitSemanticWarning (inCompiler->here (), GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 346)) ;
  }
  const enumGalgasBool test_28 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 349)).boolEnum () ;
  if (kBoolTrue == test_28) {
    {
    routine_generateGalgas_33_MakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 350)) ;
    }
  }
  const enumGalgasBool test_29 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-unix") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 352)).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_generateGalgas_33_MakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 353)) ;
    }
  }
  const enumGalgasBool test_30 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 355)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_generateGalgas_33_Linux_33__32_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 356)) ;
    }
  }
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-x86linux64-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 358)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_generateGalgas_33_Linux_36__34_OnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 359)) ;
    }
  }
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-win32-on-macosx") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 361)).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_generateGalgas_33_MinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 362)) ;
    }
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile-msy-on-win32") COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 364)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateGalgas_33_MsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 365)) ;
    }
  }
  ...
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 376)).operator_concat (GALGAS_string ("/build/output/file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 376)) ;
  GALGAS_bool joker_17780_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_17780_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 377)) ;
  ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list.mak")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 378)) ;
  const enumGalgasBool test_36 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_36) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 381)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 382)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_18036 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_18036) {
        macroValidSharedObject (objectArray_18036, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_18036->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_18519_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)), joker_18519_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 396)) ;
    const enumGalgasBool test_37 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 398)).boolEnum () ;
    if (kBoolTrue == test_37) {
      GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)), inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 399)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 402)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 402)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 403)) ;
    GALGAS_bool joker_19020_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_19020_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 404)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 405)) ;
    const enumGalgasBool test_38 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)).operator_not (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 406)).boolEnum () ;
    if (kBoolTrue == test_38) {
      GALGAS_string (gWrapperFileContent_30_targetGalgas_33_GenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 407)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_19329 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_19329) {
        macroValidSharedObject (objectArray_19329, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 411)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 412)) ;
      GALGAS_bool joker_19716_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 413))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 413)), joker_19716_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 413)) ;
      GALGAS_bool joker_20023_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_19329->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 414))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 419)), joker_20023_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 414)) ;
      GALGAS_bool joker_20228_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422)), joker_20228_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 422)) ;
      GALGAS_bool joker_20389_0 ; // Joker input parameter
      ...
      GALGAS_bool joker_20558_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424)), joker_20558_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 424)) ;
      GALGAS_bool joker_20719_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 425))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 425)), joker_20719_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 425)) ;
      GALGAS_bool joker_20888_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 426))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 426)), joker_20888_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 426)) ;
      GALGAS_bool joker_21065_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationGalgas_33_UpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 427))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 427)), joker_21065_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 427)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_21135 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_21135) {
          macroValidSharedObject (objectArray_21135, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_21135->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 435)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 436)) ;
      GALGAS_bool joker_21611_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 437))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 437)), joker_21611_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 437)) ;
      GALGAS_bool joker_21768_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438)), joker_21768_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 438)) ;
      GALGAS_bool joker_21933_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 439))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 439)), joker_21933_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 439)) ;
      GALGAS_bool joker_22198_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 440))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 445)), joker_22198_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 440)) ;
      GALGAS_bool joker_22449_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 448))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 452)), joker_22449_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 448)) ;
      GALGAS_bool joker_22686_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 455))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 459)), joker_22686_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 455)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 463)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 464)) ;
      GALGAS_bool joker_23064_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465)), joker_23064_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 465)) ;
      GALGAS_bool joker_23250_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466)), joker_23250_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 466)) ;
      GALGAS_bool joker_23440_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 467))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 467)), joker_23440_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 467)) ;
      GALGAS_bool joker_23616_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468)), joker_23616_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 468)) ;
      GALGAS_bool joker_23870_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 469))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 473)), joker_23870_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 469)) ;
      GALGAS_bool joker_24133_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 475))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 480)), joker_24133_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 475)) ;
      GALGAS_bool joker_24289_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 482))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 482)), joker_24289_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 482)) ;
      GALGAS_bool joker_24444_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterGalgas_33_ApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)), joker_24444_0, inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 483)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/xcode-project/userResources")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 486)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 487)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 488)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 489)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 490)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 492)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 492)).operator_concat (GALGAS_string (".xcodeproj")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 492)) ;
    ...
    ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("file-list-for-xcode-project.txt")  COMMA_SOURCE_FILE ("galgas3TargetGeneration.gSemantics", 494)) ;
