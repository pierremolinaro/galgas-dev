...
GALGAS_string filewrapperTemplate_targetGalgas_33_GenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1421 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1421.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1421.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  result << "\n"
    ...
    "\n"
    "USER_LINK_OPTIONS :=\n" ;
  GALGAS_uint index_5578_ (0) ;
  if (in_TOOL_5F_LINK_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_5578 (in_TOOL_5F_LINK_5F_LIST, kEnumeration_up) ;
    while (enumerator_5578.hasCurrentObject ()) {
      result << "USER_LINK_OPTIONS += " ;
      result << enumerator_5578.current_mValue (HERE).stringValue () ;
      result << "\n" ;
