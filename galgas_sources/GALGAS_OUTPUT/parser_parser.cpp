...
pr_galgas_component_parser_parser_271_24_ (galgas_scanner & _inLexique,
  ...
  while ((operand_13417 != NULL)) {
    ...
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (operand_13417->mKey.reader_value ())))).isBuiltAndTrue ()) {
        operand_13417->mKey.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_13417->mKey.reader_value ()))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (358)) ;
    }
...
pr_rule_declaration_or_implementation_parser_parser_894_42_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_formalReturnedEntity.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
      var_cas_inEffectiveReturnedEntity.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal declaration does not name any returned entity") SOURCE_FILE_AT_LINE (942)) ;
    ...
    if (((! (var_cas_superEntityStringSet.reader_hasKey (var_cas_formalReturnedEntity.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_inEffectiveReturnedEntity.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_formalReturnedEntity.reader_value ()))) + (GGS_string (true, "' entity or one of its inherited entities is expected here"))) SOURCE_FILE_AT_LINE (951)) ;
    }
  }
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_33938 != NULL)) {
      ...
      if ((var_cas_ioEntitiesMap.reader_hasKey (operand_33938->mInfo.mTypeName.reader_value ())).isBuiltAndTrue ()) {
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (operand_33938->mKey.reader_value (), var_cas_inEffectiveReturnedEntity.reader_location () COMMA_HERE) ;
  ...
  var_cas_altProductionsMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_inEffectiveReturnedEntity.reader_value (), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1006)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_7 (_inLexique)) {
        case 2 : {
          ...
          var_cas_altProductionsMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_value (), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1065)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  while ((operand_38455 != NULL)) {
    ...
    if (((((operand_38455->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! (var_cas_altProductionsMap.reader_hasKey (operand_38455->mKey.reader_value ())))))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38455->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1082)) ;
    }
...
pr_syntax_instruction_parser_parser_1223_26_ (galgas_scanner & _inLexique,
  ...
  if ((((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel) && ((var_cas_altName.reader_value ()) != (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
    if (((! (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") SOURCE_FILE_AT_LINE (1255)) ;
    }
  }
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
      var_cas_returnedEntityVariableName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal symbol is declared with no returned entity") SOURCE_FILE_AT_LINE (1283)) ;
      ...
      var_cas_returnedEntityVariableName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the non terminal symbol is declared to return an instance of '@")) + (var_cas_returnedEntityFromSignature.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (1285)) ;
  }else if (((((var_cas_returnedEntityFromSignature.reader_value ()) != (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
