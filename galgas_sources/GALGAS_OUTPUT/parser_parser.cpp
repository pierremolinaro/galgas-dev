...
//                    february 18th, 2007, at 18h11'26"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_galgas_component_parser_parser_249_6_ (galgas_scanner & _inLexique,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_12759 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_12759 != NULL)) {
    macroValidPointer (operand_12759) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_12759->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (337)) SOURCE_FILE_AT_LINE (337))))).isBuiltAndTrue ()) {
      operand_12759->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_12759->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (338))))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (340)) ;
    }
    operand_12759 = operand_12759->nextObject () ;
  }
...
pr_syntax_declaration_parser_parser_831_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (920))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_32541 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_32541 != NULL)) {
      macroValidPointer (operand_32541) ;
      if (operand_32541->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelAttributeProperty * operand_32625 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_32541->mInfo.mProperty.getPtr ()) ;
        if (operand_32625 != NULL) {
          macroValidPointer (operand_32625) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32541->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (932)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (932)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_32625->mAttributeType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (934)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_32625->mAttributeType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_metamodelSingleReferenceProperty * operand_33125 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_32541->mInfo.mProperty.getPtr ()) ;
          if (operand_33125 != NULL) {
            macroValidPointer (operand_33125) ; 
            GGS_AC_galgasType  var_cas_definitionType ;
            var_cas_definitionType = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_33125->mReferenceEntityName COMMA_HERE) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32541->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (939)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (939)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            ...
            cPtr_metamodelMultipleReferenceProperty * operand_33751 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_32541->mInfo.mProperty.getPtr ()) ;
            if (operand_33751 != NULL) {
              macroValidPointer (operand_33751) ; 
              GGS_AC_galgasType  var_cas_definitionType ;
              var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_33751->mReferenceEntityName COMMA_HERE) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32541->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (946)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (946)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
      ...
      operand_32541 = operand_32541->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_37082 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_37082 != NULL)) {
    macroValidPointer (operand_37082) ;
    if (((((operand_37082->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1044))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_37082->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1044)) SOURCE_FILE_AT_LINE (1044))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_37082->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1045))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1046)) ;
    }
    operand_37082 = operand_37082->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1204_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1262))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1262))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_46481 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1282)) ;
      GGS_bool _condition_46481 (_variant_46481._isBuilt (), true) ;
      while (_condition_46481.isBuiltAndTrue ()) {
        _condition_46481 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1283))) > (GGS_uint (true, 0U)))) ;
        if (_condition_46481.isBuiltAndTrue ()) {
          if (_variant_46481.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1288)) ;
            _condition_46481 = GGS_bool (true, false) ;
          }else{
            _variant_46481._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1545_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57186 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57186 != NULL)) {
        macroValidPointer (operand_57186) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57186->mInstruction) ;
        operand_57186 = operand_57186->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60210 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60210 != NULL)) {
        macroValidPointer (operand_60210) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60210->mInstruction) ;
        operand_60210 = operand_60210->nextObject () ;
      }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_19 (_inLexique)) {
        ...
        case 3 : {
          nt_semantic_instruction_ (_inLexique, var_cas_tableEnAvant, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionList, var_cas_propertyMap, var_cas_constraintPropertyDefinitionSet, var_cas_callInstructionSharedPropertySignatureMap) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
