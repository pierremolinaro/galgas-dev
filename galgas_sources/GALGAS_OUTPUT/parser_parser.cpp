...
void parser_parser::rule_parser_5F_parser_galgas_5F_component_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_11149 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax")) ;
  ...
  {
    GGS_typeTableNomRoutinesDeclarees::cEnumerator enumerator_14061 (var_cas_tableNomRoutinesDeclarees, true) ;
    const GGS_typeTableNomRoutinesDeclarees::cElement * operand_14061 = NULL ;
    while (((operand_14061 = enumerator_14061.nextObject ()))) {
      macroValidPointer (operand_14061) ;
      const GGS_bool cond_14259 = (var_cas_tableRoutinesAimplementer.reader_hasKey (operand_14061->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (372)))).operator_not () ;
      if (cond_14259.isBuiltAndTrue ()) {
        operand_14061->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the routine '")).operator_concat (operand_14061->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (373)))).operator_concat (GGS_string ("' is not implemented within the component")) COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }
    }
  }
...
void parser_parser::rule_parser_5F_parser_galgas_5F_component_i0_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_M_terminalSymbolsMapForUse  automatic_var_15207_0 ;
  nt_get_5F_lexique_5F_infos_ (inLexique, automatic_var_15207_0, var_cas_lexiqueMapForUse, var_cas_lexiqueName) ;
...
void parser_parser::rule_parser_5F_parser_get_5F_lexique_5F_infos_i1_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_lexiqueComponents  temp_20104 = var_cas_lexiqueComponentsMap ;
  if (temp_20104.isBuilt ()) {
    temp_20104 (HERE)->method_searchKey (inLexique, var_cas_outLexiqueName, var_cas_tableTerminaux COMMA_SOURCE_FILE_AT_LINE (608)) ;
  }
  const GGS_bool cond_20289 = (var_cas_ioLexiqueMapForUse.reader_hasKey (var_cas_outLexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (610)))).operator_not () ;
  if (cond_20289.isBuiltAndTrue ()) {
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_typeTableBlocsDeTable  temp_21969 = var_cas_tableMethodesBloc ;
  if (temp_21969.isBuilt ()) {
    temp_21969 (HERE)->method_searchKey (inLexique, var_cas_nomMethodeBloc, var_cas_signatureDebut, var_cas_signatureFin COMMA_SOURCE_FILE_AT_LINE (662)) ;
  }
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  GGS_AC_galgasType  automatic_var_23557_0 ;
  GGS_typeCplusPlusName  automatic_var_23557_1 ;
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (inLexique, var_cas_nomTable, automatic_var_23557_0, automatic_var_23557_1 COMMA_SOURCE_FILE_AT_LINE (714)) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i3_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  automatic_var_25648_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioEntitiesMap, var_cas_listeDeTypesFormels0, var_cas_tableArgumentsMethode0, automatic_var_25648_0, var_cas_tableEnAvant, var_cas_signatureForGrammar) ;
      ...
      switch (select_parser_5F_parser_3 (inLexique)) {
        case 2 : {
          ...
          switch (select_parser_5F_parser_4 (inLexique)) {
            case 1 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("parse"), GGS_location (inLexique) COMMA_HERE), GGS_signatureForGrammarAnalysis ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (841)) ;
              } break ;
            case 2 : {
              inLexique.assignFromAttribute_tokenString (var_cas_altName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_nonTerminalSymbolForSyntax  temp_30016 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_30016.isBuilt ()) {
    temp_30016 (HERE)->method_searchKey (inLexique, var_cas_ruleName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (894)) ;
  }
  ...
  const GGS_M_nonterminalSymbolAlts  temp_30910 = var_cas_nonterminalSymbolAltMap ;
  if (temp_30910.isBuilt ()) {
    temp_30910 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (915)) ;
  }
    ...
    while (syntaxRepeat_6) {
      switch (select_parser_5F_parser_6 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_nonterminalSymbolAlts  temp_32397 = var_cas_nonterminalSymbolAltMap ;
          if (temp_32397.isBuilt ()) {
            temp_32397 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (966)) ;
          }
  ...
  {
    GGS_M_nonterminalSymbolAlts::cEnumerator enumerator_33494 (var_cas_nonterminalSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAlts::cElement * operand_33494 = NULL ;
    while (((operand_33494 = enumerator_33494.nextObject ()))) {
      macroValidPointer (operand_33494) ;
      const GGS_bool cond_33679 = ((operand_33494->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1003))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (operand_33494->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)))).operator_not ()) ;
      if (cond_33679.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_33494->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1004)))).operator_concat (GGS_string ("' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1005)) ;
      }
    }
  }
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_terminalSymbolsMapForUse  temp_37777 = var_cas_tableTerminaux ;
  if (temp_37777.isBuilt ()) {
    temp_37777 (HERE)->method_searchKey (inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (1126)) ;
  }
  ...
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_i = GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i6_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_instruction = GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1153)), var_cas_terminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonTerminalSymbolForSyntax  temp_40155 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_40155.isBuilt ()) {
    temp_40155 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1191)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  const GGS_M_nonterminalSymbolAlts  temp_40279 = var_cas_nonterminalSymbolAltMap ;
  if (temp_40279.isBuilt ()) {
    temp_40279 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureMethode COMMA_SOURCE_FILE_AT_LINE (1193)) ;
  }
  const GGS_bool cond_40641 = (var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1195))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_40641.isBuiltAndTrue ()) {
    const GGS_bool cond_40630 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_40630.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_40935 = (var_cas_inIsInvokedWithinParseLoopInstruction).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1200))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_40935.isBuiltAndTrue ()) {
    const GGS_bool cond_40924 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_40924.isBuiltAndTrue ()) {
  ...
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_i = GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1225)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature.addAssign_operation (var_cas_i) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i7_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_actual_5F_parameters_5F_list_parse (inLexique) ;
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_instruction = GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1244)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_parser_5F_parser_10 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_syntaxInstructionListForGrammarAnalysis::cEnumerator enumerator_53599 (var_cas_firstBranchSyntaxSignature, true) ;
        const GGS_syntaxInstructionListForGrammarAnalysis::cElement * operand_53599 = NULL ;
        while (((operand_53599 = enumerator_53599.nextObject ()))) {
          macroValidPointer (operand_53599) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_53599->mInstruction) ;
        }
      }
    ...
    case 3 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_syntaxInstructionListForGrammarAnalysis::cEnumerator enumerator_57079 (var_cas_syntaxSignature, true) ;
        const GGS_syntaxInstructionListForGrammarAnalysis::cElement * operand_57079 = NULL ;
        while (((operand_57079 = enumerator_57079.nextObject ()))) {
          macroValidPointer (operand_57079) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_57079->mInstruction) ;
        }
      }
