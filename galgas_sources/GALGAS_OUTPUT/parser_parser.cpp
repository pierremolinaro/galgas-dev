...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/Developpements/mes_prgms/galgas/galgas_sources/parser_parser.ggs" ;
...
pr_rule_declaration_or_implementation_parser_parser_879_42_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_33142 != NULL)) {
      ...
      if (((((! ((operand_33142->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_mapProperty (HERE))))) && (var_cas_ioEntitiesMap.reader_hasKey (operand_33142->mInfo.mTypeName.reader_value ())))).isBuiltAndTrue ()) {
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_37720 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_37720 != NULL)) {
    macroValidPointer (operand_37720) ;
    if (((((operand_37720->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! (var_cas_altProductionsMap.reader_hasKey (operand_37720->mKey.reader_value ())))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_37720->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1067)) ;
    }
    operand_37720 = operand_37720->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1208_26_ (galgas_scanner & lexique_var_,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_45740 ;
      var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_45740 SOURCE_FILE_AT_LINE (1275)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46003 ;
      var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46003 SOURCE_FILE_AT_LINE (1280)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1509_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_55415 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_55415 != NULL)) {
        macroValidPointer (operand_55415) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_55415->mInstruction) ;
        operand_55415 = operand_55415->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_58322 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_58322 != NULL)) {
        macroValidPointer (operand_58322) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_58322->mInstruction) ;
        operand_58322 = operand_58322->nextObject () ;
      }
