...
pr_galgas_component_parser_parser_262_6_ (galgas_scanner & _inLexique,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_13551 = _var_13551.firstObject () ;
...
pr_syntax_declaration_parser_parser_869_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (960)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_34419 = _var_34419.firstObject () ;
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_39120 = _var_39120.firstObject () ;
...
pr_syntax_instruction_parser_parser_1634_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_60548 = _var_60548.firstObject () ;
    ...
    case 2 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_63784 = _var_63784.firstObject () ;
