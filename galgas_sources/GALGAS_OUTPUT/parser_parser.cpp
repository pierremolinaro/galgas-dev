...
pr_rule_declaration_or_implementation_parser_parser_892_42_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (956))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_34019 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_34019 != NULL)) {
      macroValidPointer (operand_34019) ;
      if (operand_34019->mInfo.mProperty._isBuilt ()) {
        if (dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_34019->mInfo.mProperty.getPtr ()) != NULL) {
          cPtr_metamodelAttributeProperty * operand_34103 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_34019->mInfo.mProperty.getPtr ()) ;
          macroValidPointer (operand_34103) ; 
          GGS_AC_semanticsEntity  var_cas_entite ;
          if (var_cas_ioEntitiesMap._isBuilt ()) {
            var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_34103->mAttributeTypeName, var_cas_entite SOURCE_FILE_AT_LINE (966)) ;
          }
          ...
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34019->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (969)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (969)) COMMA_HERE) ;
        ...
        }else if (dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_34019->mInfo.mProperty.getPtr ()) != NULL) {
          cPtr_metamodelSingleReferenceProperty * operand_34885 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_34019->mInfo.mProperty.getPtr ()) ;
          macroValidPointer (operand_34885) ; 
          GGS_AC_semanticsEntity  var_cas_entite ;
          if (var_cas_ioEntitiesMap._isBuilt ()) {
            var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_34885->mReferenceEntityName, var_cas_entite SOURCE_FILE_AT_LINE (976)) ;
          }
          GGS_AC_galgasType  var_cas_definitionType ;
          { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
            if (ptrExtraire_ == NULL) {
          ...
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34019->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (979)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (979)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          ...
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else if (dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_34019->mInfo.mProperty.getPtr ()) != NULL) {
          cPtr_metamodelMultipleReferenceProperty * operand_35674 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_34019->mInfo.mProperty.getPtr ()) ;
          macroValidPointer (operand_35674) ; 
          GGS_AC_semanticsEntity  var_cas_entite ;
          if (var_cas_ioEntitiesMap._isBuilt ()) {
            var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_35674->mReferenceEntityName, var_cas_entite SOURCE_FILE_AT_LINE (986)) ;
          }
          GGS_AC_galgasType  var_cas_definitionType ;
          var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_35674->mReferenceEntityName COMMA_HERE) ;
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34019->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (988)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (988)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_ioVariablesMap.method_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (990)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{ // Else part
      ...
      operand_34019 = operand_34019->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_39203 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_39203 != NULL)) {
    macroValidPointer (operand_39203) ;
    if (((((operand_39203->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1087))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_39203->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1087)) SOURCE_FILE_AT_LINE (1087))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_39203->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1088))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1089)) ;
    }
    operand_39203 = operand_39203->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1229_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1288))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1288))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_47220 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_47220 SOURCE_FILE_AT_LINE (1296)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_47476 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_47476 SOURCE_FILE_AT_LINE (1301)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1552_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57788 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57788 != NULL)) {
        macroValidPointer (operand_57788) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57788->mInstruction) ;
        operand_57788 = operand_57788->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60718 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60718 != NULL)) {
        macroValidPointer (operand_60718) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60718->mInstruction) ;
        operand_60718 = operand_60718->nextObject () ;
      }
