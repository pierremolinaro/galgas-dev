...
pr_rule_declaration_or_implementation_parser_parser_746_42_ (galgas_scanner & lexique_var_,
  ...
  var_cas_parametersMapForGrammar.methode_insertKey (lexique_var_, var_cas_emptyId, var_cas_inSignatureForGrammar, var_cas_inReturnedEntity, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_4 (lexique_var_)) {
            case 1 : {
              ...
              var_cas_parametersMapForGrammar.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signatureForGrammarComponent, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE), GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_altName ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              var_cas_parametersMapForGrammar.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signatureForGrammarComponent, var_cas_returnedEntity, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
              } break ;
            default :
              break ;
          }
...
pr_rule_declaration_or_implementation_parser_parser_746_42_importSyntax (galgas_scanner & lexique_var_,
  ...
  var_cas_nonterminalSymbolParametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_inDefaultSignature, var_cas_inReturnedEntity, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_3 (lexique_var_)) {
        case 2 : {
          ...
          switch (select_parser_parser_4 (lexique_var_)) {
            case 1 : {
              ...
              var_cas_nonterminalSymbolParametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signature, var_cas_noReturnedEntity, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
              } break ;
            case 2 : {
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_altName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
              ...
              var_cas_nonterminalSymbolParametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signature, var_cas_returnedEntity, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
              } break ;
            default :
              break ;
          }
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_885_42_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_33458 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33458 != NULL)) {
      macroValidPointer (operand_33458) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, operand_33458->mInfo.mTypeName, var_cas_entite) ;
      ...
      var_cas_nomVariable = GGS_lstring::constructor_new (operand_33458->mKey.reader_value (), var_cas_inEffectiveReturnedEntity.reader_location () COMMA_HERE) ;
      ...
      if (((operand_33458->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (operand_33458->mInfo.mTypeName COMMA_HERE) ;
      ...
      operand_33458 = operand_33458->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (lexique_var_), var_cas_inEffectiveReturnedEntity.reader_value (), var_cas_allPropertiesMap) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_7 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_altProductionsMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (lexique_var_), var_cas_returnedEntity.reader_value (), var_cas_allPropertiesMap) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_37305 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_37305 != NULL)) {
    macroValidPointer (operand_37305) ;
    if (((((operand_37305->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_37305->mKey.reader_value ()))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_37305->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
    operand_37305 = operand_37305->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_885_42_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar,
                                const GGS_lstring  &var_cas_inNonterminalSymbolName,
                                const GGS_L_signature  &/* var_cas_inDefaultSignature */,
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_885_42_parse (galgas_scanner & lexique_var_) {
  switch (select_parser_parser_6 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1124_32_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1124_32_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  nt_syntax_instructions_list_no_verif_importSyntax (lexique_var_, var_cas_ioInstructionsList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1124_32_parse (galgas_scanner & lexique_var_) {
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1159_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1159_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  var_cas_terminalSymbolName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1159_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  nt_input_parameters_list_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1206_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_45325 ;
      var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_45325) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_45588 ;
      var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_45588) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1206_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1206_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
  switch (select_parser_parser_9 (lexique_var_)) {
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1334_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1334_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1334_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1408_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1408_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1408_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1507_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_55000 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_55000 != NULL)) {
        macroValidPointer (operand_55000) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_55000->mInstruction) ;
        operand_55000 = operand_55000->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_57907 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_57907 != NULL)) {
        macroValidPointer (operand_57907) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_57907->mInstruction) ;
        operand_57907 = operand_57907->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1507_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1507_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_do) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1665_41_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1665_41_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1665_41_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
        case 2 : {
