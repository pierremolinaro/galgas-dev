...
pr_syntax_instruction_parser_parser_581_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomTable, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (656)) ;
  ...
  switch (select_parser_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9 SOURCE_FILE_AT_LINE (722)) ;
      }
      } break ;
    default :
      break ;
...
pr_rule_declaration_or_implementation_parser_parser_773_42_importSyntax (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_parser_parser_4 (_inLexique)) {
            case 1 : {
              ...
              var_cas_nonterminalSymbolParametersMap.method_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "parse"), GGS_location (_inLexique) COMMA_HERE), var_cas_signature, var_cas_noReturnedEntity SOURCE_FILE_AT_LINE (876)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_altName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_nonterminalSymbolParametersMap.method_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (892)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.method_insertKey (_inLexique, var_cas_inNonterminalSymbolName, var_cas_nonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (898)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_906_42_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  &var_cas_inOptionsComponentsMapForUse,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt ()) {
    var_cas_ioNonTerminalSymbolMapForSyntax (HERE)->method_searchKey (_inLexique, var_cas_inRuleName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (926)) ;
  }
  ...
  var_cas_hasParseLabel = var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") SOURCE_FILE_AT_LINE (931)) ;
  ...
  switch (select_parser_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_productionTagName = var_cas_tagName.reader_string (_inLexique SOURCE_FILE_AT_LINE (941)) ;
      } break ;
    default :
      break ;
  }
  ...
  if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
    var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype, var_cas_formalReturnedEntity SOURCE_FILE_AT_LINE (949)) ;
  }
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signaturePremiereBrancheFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_firstBranchErrorLocation SOURCE_FILE_AT_LINE (954)) ;
  if (((((var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (958))) == (GGS_string (true, ""))) & ((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (958))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    var_cas_inEffectiveReturnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal declaration does not name any returned entity") SOURCE_FILE_AT_LINE (960)) ;
  }else if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (960))) != (var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (960)))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_inEffectiveReturnedEntity, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, var_cas_superEntityStringSet, automatic_var_15, automatic_var_16 SOURCE_FILE_AT_LINE (962)) ;
    }
    if (((! (var_cas_superEntityStringSet.reader_hasKey (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (963)) SOURCE_FILE_AT_LINE (963))))).isBuiltAndTrue ()) {
      var_cas_inEffectiveReturnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (965))))) + (GGS_string (true, "' entity or one of its inherited entities is expected here"))) SOURCE_FILE_AT_LINE (966)) ;
    }
  }
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (971))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_stringset  automatic_var_21 ;
    GGS_entityPropertyMap  automatic_var_22 ;
    GGS_entityPropertyMap  automatic_var_23 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_inEffectiveReturnedEntity, var_cas_allPropertiesMap, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22, automatic_var_23 SOURCE_FILE_AT_LINE (972)) ;
    }
    GGS_entityPropertyMap::element_type * operand_34077 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_34077 != NULL)) {
      macroValidPointer (operand_34077) ;
      if (operand_34077->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelAttributeProperty * operand_34161 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_34077->mInfo.mProperty.getPtr ()) ;
        if (operand_34161 != NULL) {
          macroValidPointer (operand_34161) ; 
          GGS_AC_semanticsEntity  var_cas_entite ;
          if (var_cas_ioEntitiesMap._isBuilt ()) {
            var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_34161->mAttributeTypeName, var_cas_entite SOURCE_FILE_AT_LINE (977)) ;
          }
          ...
          { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
            if (ptrExtraire_ == NULL) {
              ...
              if (var_cas_entite.getPtr () != NULL) {
                ...
                var_cas_inEffectiveReturnedEntity.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (979)) ;
              }
            }else{
              macroValidPointer (ptrExtraire_) ;
          ...
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34077->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (980)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (980)) COMMA_HERE) ;
          ...
          var_cas_ioVariablesMap.method_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (982)) ;
          GGS_typeInstruction  var_cas_instruction ;
          ...
          cPtr_metamodelSingleReferenceProperty * operand_34943 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_34077->mInfo.mProperty.getPtr ()) ;
          if (operand_34943 != NULL) {
            macroValidPointer (operand_34943) ; 
            GGS_AC_galgasType  var_cas_definitionType ;
            var_cas_definitionType = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_34943->mReferenceEntityName COMMA_HERE) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34077->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (987)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (987)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_ioVariablesMap.method_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (989)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{
            cPtr_metamodelMultipleReferenceProperty * operand_35573 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_34077->mInfo.mProperty.getPtr ()) ;
            if (operand_35573 != NULL) {
              macroValidPointer (operand_35573) ; 
              GGS_AC_galgasType  var_cas_definitionType ;
              var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_35573->mReferenceEntityName COMMA_HERE) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34077->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (994)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (994)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
              var_cas_ioVariablesMap.method_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (996)) ;
              GGS_typeInstruction  var_cas_instruction ;
              var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
              var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
            }else{ // Else part
      ...
      operand_34077 = operand_34077->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.method_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (1024)), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1019)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_8 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_24, automatic_var_25, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31 SOURCE_FILE_AT_LINE (1047)) ;
              }
              } break ;
            default :
              break ;
          ...
          ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation SOURCE_FILE_AT_LINE (1055)) ;
          ...
          var_cas_altProductionsMap.method_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_branchInstructionList, var_cas_branchSyntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (1079)), GGS_entityPropertyMap::constructor_emptyMap (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (1074)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  if (var_cas_altProductionsMap._isBuilt ()) {
    ::routine_checkLabelSignatures (_inLexique,  var_cas_altProductionsMap SOURCE_FILE_AT_LINE (1087)) ;
  }
  GGS_M_nonterminalSymbolAlts::element_type * operand_38818 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38818 != NULL)) {
    macroValidPointer (operand_38818) ;
    if (((((operand_38818->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1090))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38818->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1090)) SOURCE_FILE_AT_LINE (1090))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38818->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1091))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1092)) ;
    }
    operand_38818 = operand_38818->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_906_42_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolsForGrammar  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar,
                                const GGS_lstring  &var_cas_inNonterminalSymbolName,
                                const GGS_L_signature  &/* var_cas_inDefaultSignature */,
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_906_42_parse (galgas_scanner & _inLexique) {
  switch (select_parser_parser_6 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1150_32_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                ...
                                GGS_L_ruleSyntaxSignature  &var_cas_ioSyntaxSignature,
                                const GGS_entityToImplementMap  &var_cas_inAllMetamodelClassMap) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique SOURCE_FILE_AT_LINE (1162)) ;
  nt_syntax_instructions_list_no_verif_ (_inLexique, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionList, var_cas_tableTerminaux, var_cas_ioSyntaxSignature, var_cas_inAllMetamodelClassMap) ;
  GGS_location  var_cas_positionErreur ;
  var_cas_positionErreur = GGS_location (_inLexique) ;
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, var_cas_positionErreur SOURCE_FILE_AT_LINE (1162)) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1150_32_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  nt_syntax_instructions_list_no_verif_importSyntax (_inLexique, var_cas_ioInstructionList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1150_32_parse (galgas_scanner & _inLexique) {
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1187_26_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  if (var_cas_tableTerminaux._isBuilt ()) {
    var_cas_tableTerminaux (HERE)->method_searchKey (_inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels SOURCE_FILE_AT_LINE (1202)) ;
  }
  ...
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_terminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1215)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1187_26_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  var_cas_terminalSymbolName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
  ...
  GGS_uint  var_cas_terminalSymbolIndex ;
  var_cas_terminalSymbolIndex = GGS_uint (true, 0U) ;
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_terminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1226)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1187_26_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  nt_input_parameters_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1235_26_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt ()) {
    var_cas_ioNonTerminalSymbolMapForSyntax (HERE)->method_searchKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (1261)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
    var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature SOURCE_FILE_AT_LINE (1264)) ;
  }
  if ((((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel) & ((var_cas_altName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1266))) != (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
    if (((! (var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") SOURCE_FILE_AT_LINE (1267))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") SOURCE_FILE_AT_LINE (1269)) ;
    }
  }
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1295))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1295))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal symbol is declared with no returned entity") SOURCE_FILE_AT_LINE (1297)) ;
    ...
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the non terminal symbol is declared to return an instance of '@")) + (var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1298))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (1299)) ;
  }else if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1299))) != (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1299))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_32 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_32 SOURCE_FILE_AT_LINE (1303)) ;
      ...
      { cPtr_typeGalgas_multipleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_multipleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            ...
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1305)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
        }
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_33 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_33 SOURCE_FILE_AT_LINE (1308)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
            ...
            message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleEntity::static_string_message_messageGalgasType () ;
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1309)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
        }
  ...
  var_cas_ioInstructionList._addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i ;
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1323)), var_cas_nonterminalSymbolName, GGS_uint (true, 0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature._addAssign_operation (var_cas_i) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1235_26_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1345)), var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolIndex COMMA_HERE) ;
  var_cas_ioInstructionList._addAssign_operation (var_cas_i) ;
  switch (select_parser_parser_10 (_inLexique)) {
    case 1 : {
      } break ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1235_26_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
  switch (select_parser_parser_9 (_inLexique)) {
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1364_26_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1380)) ;
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1381)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1381)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_or) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1401)) ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1401)) ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1380)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1364_26_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1364_26_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_or) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1463_26_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (1479)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, var_cas_positionErreurPremiereBranche SOURCE_FILE_AT_LINE (1482)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (1501)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1501)) ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (1479)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1463_26_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1463_26_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1564_26_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57861 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57861 != NULL)) {
        macroValidPointer (operand_57861) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57861->mInstruction) ;
        operand_57861 = operand_57861->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1630)) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1633)) ;
            ...
            var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1633)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1666)) ;
      GGS_location  var_cas_branchStartLocation ;
      var_cas_branchStartLocation = GGS_location (_inLexique) ;
      ...
      var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1666)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1630)) ;
  ...
  if (var_cas_parse_rewind_signature_list._isBuilt ()) {
    ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list SOURCE_FILE_AT_LINE (1696)) ;
  }
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1564_26_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1564_26_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_do) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1727_41_ (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1727_41_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (_inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1727_41_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (_inLexique)) {
        case 2 : {
