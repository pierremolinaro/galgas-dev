...
pr_galgas_component_parser_parser_262_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_componentName._isBuilt () &&
    ...
    ::routine_generateSemanticsComponent (_inLexique,  var_cas_componentName,  var_cas_inclusionsForHeaderFile,  var_cas_defLexique,  var_cas_listeEntitesAengendrer,  var_cas_inclusionsForImplementationFile SOURCE_FILE_AT_LINE (367)) ;
  }
  ...
  switch (select_parser_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9 SOURCE_FILE_AT_LINE (730)) ;
      }
...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_7 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15, automatic_var_16 SOURCE_FILE_AT_LINE (902)) ;
      }
  ...
  if (((((var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (943))) == (GGS_string (true, ""))) & ((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (943))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques  automatic_var_21 ;
    GGS_string automatic_var_22 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, var_cas_superEntityMap, automatic_var_21, automatic_var_22 SOURCE_FILE_AT_LINE (947)) ;
    }
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (956))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_string automatic_var_29 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29 SOURCE_FILE_AT_LINE (957)) ;
    }
    ...
    GGS_string automatic_var_35 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_allPropertiesMap, automatic_var_30, automatic_var_31, automatic_var_32, automatic_var_33, automatic_var_34, automatic_var_35 SOURCE_FILE_AT_LINE (964)) ;
    }
    GGS_entityPropertyMap::element_type * operand_33889 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33889 != NULL)) {
      macroValidPointer (operand_33889) ;
      if (operand_33889->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_33977 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_33889->mInfo.mPropertyType.getPtr ()) ;
        if (operand_33977 != NULL) {
          macroValidPointer (operand_33977) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33889->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (968)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (968)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_33889->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (970)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33889->mInfo.mPropertyType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_34505 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_33889->mInfo.mPropertyType.getPtr ()) ;
          if (operand_34505 != NULL) {
            macroValidPointer (operand_34505) ; 
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33889->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (974)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (974)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_33889->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (976)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, ((operand_34505->mEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (978))) + (GGS_string (true, "List"))), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_33889->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{ // Else part
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33889->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (989)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (989)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_33889->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (991)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33889->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_33889 = operand_33889->nextObject () ;
    }
  }
        ...
        case 2 : {
          ...
          switch (select_parser_parser_11 (_inLexique)) {
            ...
            case 2 : {
              ...
              GGS_lstring  automatic_var_39 ;
              GGS_typeSuperClassesMap  automatic_var_40 ;
              GGS_typeListeAttributsSemantiques  automatic_var_41 ;
              GGS_string automatic_var_42 ;
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_36, automatic_var_37, automatic_var_38, automatic_var_39, automatic_var_40, automatic_var_41, automatic_var_42 SOURCE_FILE_AT_LINE (1043)) ;
              }
              } break ;
            default :
              break ;
  ...
  if (var_cas_altProductionsMap._isBuilt ()) {
    ::routine_checkLabelSignatures (_inLexique,  var_cas_altProductionsMap SOURCE_FILE_AT_LINE (1086)) ;
  }
  GGS_M_nonterminalSymbolAlts::element_type * operand_38484 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38484 != NULL)) {
    macroValidPointer (operand_38484) ;
    if (((((operand_38484->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1089))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38484->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1089)) SOURCE_FILE_AT_LINE (1089))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38484->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1090))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1091)) ;
    }
    operand_38484 = operand_38484->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1260_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1321))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1321))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_43 ;
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_43 SOURCE_FILE_AT_LINE (1329)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_44 ;
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_44 SOURCE_FILE_AT_LINE (1333)) ;
      { cPtr_typeGalgas_singleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          var_cas_variableEntityName._drop_operation () ;
          if (var_cas_type.getPtr () != NULL) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_48312 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1340)) ;
      GGS_bool _condition_48312 (_variant_48312._isBuilt (), true) ;
      while (_condition_48312.isBuiltAndTrue ()) {
        _condition_48312 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1341))) > (GGS_uint (true, 0U)))) ;
        if (_condition_48312.isBuiltAndTrue ()) {
          if (_variant_48312.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1346)) ;
            _condition_48312 = GGS_bool (true, false) ;
          }else{
            _variant_48312._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            GGS_typeSuperClassesMap  automatic_var_48 ;
            GGS_typeListeAttributsSemantiques  automatic_var_49 ;
            GGS_string automatic_var_50 ;
            if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
              var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_45, automatic_var_46, automatic_var_47, var_cas_superEntity, automatic_var_48, automatic_var_49, automatic_var_50 SOURCE_FILE_AT_LINE (1343)) ;
            }
...
pr_syntax_instruction_parser_parser_1616_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_59618 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_59618 != NULL)) {
        macroValidPointer (operand_59618) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59618->mInstruction) ;
        operand_59618 = operand_59618->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_62843 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_62843 != NULL)) {
        macroValidPointer (operand_62843) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_62843->mInstruction) ;
        operand_62843 = operand_62843->nextObject () ;
      }
  ...
  if (var_cas_parse_rewind_signature_list._isBuilt ()) {
    ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list SOURCE_FILE_AT_LINE (1758)) ;
  }
}
