...
pr_syntax_instruction_parser_parser_1224_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i ;
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1311)), var_cas_nonterminalSymbolName, GGS_uint (true, 0UL) COMMA_HERE) ;
  var_cas_ioSyntaxSignature.addAssign_operation (var_cas_i) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
