...
pr_galgas_component_parser_parser_262_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_13565 != NULL)) {
    ...
    if (((var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_13565->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (354))).isBuiltAndTrue ()) {
      operand_13565->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the routine '"))._operator_concat (_inLexique, operand_13565->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)))._operator_concat (_inLexique, GGS_string (true, "' is not implemented within the component") COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
    }
...
pr_get_lexique_infos_parser_parser_534_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_lexiqueComponentsMap._isBuilt (HERE)) {
  ...
  if (((var_cas_ioLexiqueMapForUse.reader_hasKey (_inLexique, var_cas_outLexiqueName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (560)) COMMA_SOURCE_FILE_AT_LINE (560)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (560))).isBuiltAndTrue ()) {
...
pr_syntax_instruction_parser_parser_583_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_tableMethodesBloc._isBuilt (HERE)) {
...
pr_syntax_declaration_parser_parser_693_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt (HERE)) {
...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt (HERE)) {
  ...
  if (var_cas_nonterminalSymbolAltMap._isBuilt (HERE)) {
  ...
  if ((((var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (943)))._operator_isEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (943)))._operator_and (_inLexique, (var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (943)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (943)) COMMA_SOURCE_FILE_AT_LINE (943))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (945)))._operator_isNotEqual (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (945)) SOURCE_FILE_AT_LINE (945))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_superEntityMap.reader_hasKey (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (948)) COMMA_SOURCE_FILE_AT_LINE (948)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (948))).isBuiltAndTrue ()) {
      var_cas_returnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (950)))._operator_concat (_inLexique, GGS_string (true, "' entity or one of its inherited entities is expected here") COMMA_SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (951)) ;
    }
  }
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (956))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt (HERE)) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (957)) ;
    }
    ...
    var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_mdaResultVariableName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (964)), var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (964)) COMMA_HERE) ;
    var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_mdaResultVariableName, var_cas_definitionType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (965)) ;
  ...
  }else if (((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (967)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (967))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt (HERE)) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_allPropertiesMap, automatic_var_34, automatic_var_35, automatic_var_36, automatic_var_37, automatic_var_38, automatic_var_39, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (968)) ;
    }
    GGS_entityPropertyMap::element_type * operand_33901 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33901 != NULL)) {
      macroValidPointer (operand_33901) ;
      if (operand_33901->mInfo.mPropertyType._isBuilt (SOURCE_FILE_AT_LINE (969))) {
        cPtr_typeGalgas_singleReferenceEntity * operand_33989 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_33901->mInfo.mPropertyType.getPtr ()) ;
        if (operand_33989 != NULL) {
          macroValidPointer (operand_33989) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33901->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (972)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (972)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (973)), var_cas_nomVariable.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (973)) COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_33901->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (974)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33901->mInfo.mPropertyType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_34551 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_33901->mInfo.mPropertyType.getPtr ()) ;
          if (operand_34551 != NULL) {
            macroValidPointer (operand_34551) ; 
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33901->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (979)), var_cas_nomVariable.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (979)) COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_33901->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (980)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, (operand_34551->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (982)))._operator_concat (_inLexique, GGS_string (true, "List") COMMA_SOURCE_FILE_AT_LINE (982)), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_33901->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{ // Else part
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33901->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (994)), var_cas_nomVariable.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (994)) COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_33901->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (995)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33901->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_33901 = operand_33901->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1023)), var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1024)), var_cas_allPropertiesMap COMMA_SOURCE_FILE_AT_LINE (1017)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_11 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt (HERE)) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_41, automatic_var_42, automatic_var_43, automatic_var_44, automatic_var_45, automatic_var_46, automatic_var_47, automatic_var_48 COMMA_SOURCE_FILE_AT_LINE (1047)) ;
              }
              } break ;
            default :
              break ;
          ...
          if (var_cas_nonterminalSymbolAltMap._isBuilt (HERE)) {
            var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_returnedEntityFromPrototype COMMA_SOURCE_FILE_AT_LINE (1053)) ;
          }
          ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation COMMA_SOURCE_FILE_AT_LINE (1054)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if (var_cas_altProductionsMap._isBuilt (HERE)) {
    ::routine_checkLabelSignatures (_inLexique,  var_cas_altProductionsMap COMMA_SOURCE_FILE_AT_LINE (1089)) ;
  }
  ...
  while ((operand_38591 != NULL)) {
    ...
    if ((((operand_38591->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)))._operator_isNotEqual (_inLexique, GGS_string (true, "parse") SOURCE_FILE_AT_LINE (1093)))._operator_and (_inLexique, (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38591->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)) COMMA_SOURCE_FILE_AT_LINE (1093)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)) COMMA_SOURCE_FILE_AT_LINE (1093))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (_inLexique, operand_38591->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1094)) COMMA_SOURCE_FILE_AT_LINE (1094)))._operator_concat (_inLexique, GGS_string (true, "' label is not implemented within the rule") COMMA_SOURCE_FILE_AT_LINE (1094)) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    }
...
pr_syntax_instructions_list_parser_parser_1169_6_ (galgas_scanner & _inLexique,
                                ...
                                const GGS_entityToImplementMap  &var_cas_inAllMetamodelClassMap,
                                const GGS_M_treewalkingComponents  &var_cas_inTreewalkingComponentMap) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique COMMA_SOURCE_FILE_AT_LINE (1183)) ;
  nt_syntax_instructions_list_no_verif_ (_inLexique, var_cas_inLexiqueClassName, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionList, var_cas_tableTerminaux, var_cas_ioSyntaxSignature, var_cas_inAllMetamodelClassMap, var_cas_inTreewalkingComponentMap) ;
  GGS_location  var_cas_positionErreur ;
  var_cas_positionErreur = GGS_location (_inLexique) ;
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, var_cas_positionErreur COMMA_SOURCE_FILE_AT_LINE (1183)) ;
}
...
pr_syntax_instruction_parser_parser_1210_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_tableTerminaux._isBuilt (HERE)) {
    var_cas_tableTerminaux (HERE)->method_searchKey (_inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (1227)) ;
  }
  ...
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_terminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1244)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1264_6_ (galgas_scanner & _inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt (HERE)) {
    var_cas_ioNonTerminalSymbolMapForSyntax (HERE)->method_searchKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1290)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  if (var_cas_nonterminalSymbolAltMap._isBuilt (HERE)) {
    var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature COMMA_SOURCE_FILE_AT_LINE (1293)) ;
  }
  if (((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel)._operator_and (_inLexique, (var_cas_altName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1295)))._operator_isNotEqual (_inLexique, GGS_string (true, "parse") SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295))).isBuiltAndTrue ()) {
    if (((var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") COMMA_SOURCE_FILE_AT_LINE (1296)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (1296))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") COMMA_SOURCE_FILE_AT_LINE (1298)) ;
    }
  }
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1325)))._operator_isEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (1325)))._operator_and (_inLexique, (var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1325)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (1325)) COMMA_SOURCE_FILE_AT_LINE (1325))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal symbol is declared with no returned entity") COMMA_SOURCE_FILE_AT_LINE (1327)) ;
  }else if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1327)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (1327)))._operator_and (_inLexique, (var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1327)))._operator_isEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (1327)) COMMA_SOURCE_FILE_AT_LINE (1327))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the non terminal symbol is declared to return an instance of '@"))._operator_concat (_inLexique, var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1328)) COMMA_SOURCE_FILE_AT_LINE (1328)))._operator_concat (_inLexique, GGS_string (true, "' entity") COMMA_SOURCE_FILE_AT_LINE (1328)) COMMA_SOURCE_FILE_AT_LINE (1329)) ;
  }else if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1329)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (1329)))._operator_and (_inLexique, (var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1329)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (1329)) COMMA_SOURCE_FILE_AT_LINE (1329))).isBuiltAndTrue ()) {
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_49 ;
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_49 COMMA_SOURCE_FILE_AT_LINE (1333)) ;
      { cPtr_typeGalgas_multipleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_type.getPtr () != NULL) {
            ...
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (_inLexique, message1_, message2_ COMMA_SOURCE_FILE_AT_LINE (1334)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_50 COMMA_SOURCE_FILE_AT_LINE (1337)) ;
      { cPtr_typeGalgas_singleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          var_cas_variableEntityName._drop_operation () ;
          if (var_cas_type.getPtr () != NULL) {
            ...
            message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleReferenceEntity::static_string_message_messageGalgasType () ;
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (_inLexique, message1_, message2_ COMMA_SOURCE_FILE_AT_LINE (1338)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
          var_cas_variableEntityName = ptrExtraire_->mEntityTypeName ;
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1341)))._operator_isEqual (_inLexique, var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1341)) SOURCE_FILE_AT_LINE (1341)) ;
    if (((var_cas_ok)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (1342))).isBuiltAndTrue ()) {
      GGS_lstring  var_cas_testedClass ;
      var_cas_testedClass = var_cas_returnedEntityFromSignature ;
      GGS_uint _variant_48419 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1344)) ;
      GGS_bool _condition_48419 (_variant_48419._isBuilt (SOURCE_FILE_AT_LINE (1350)), true) ;
      while (_condition_48419.isBuiltAndTrue ()) {
        _condition_48419 = ((var_cas_ok)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (1345)))._operator_and (_inLexique, (var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1345)))._operator_strictSup (_inLexique, GGS_uint (true, 0U) SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
        if (_condition_48419.isBuiltAndTrue ()) {
          if (_variant_48419.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1350)) ;
            _condition_48419 = GGS_bool (true, false) ;
          }else{
            _variant_48419._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if (var_cas_inAllMetamodelClassMap._isBuilt (HERE)) {
              var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_51, automatic_var_52, automatic_var_53, var_cas_superEntity, automatic_var_54, automatic_var_55, automatic_var_56, automatic_var_57 COMMA_SOURCE_FILE_AT_LINE (1347)) ;
            }
            var_cas_testedClass = var_cas_superEntity ;
            var_cas_ok = (var_cas_testedClass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1349)))._operator_isEqual (_inLexique, var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1349)) SOURCE_FILE_AT_LINE (1349)) ;
          }
        }
      }
    }
    if (((var_cas_ok)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (1352))).isBuiltAndTrue ()) {
      var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '%"))._operator_concat (_inLexique, var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1353)) COMMA_SOURCE_FILE_AT_LINE (1353)))._operator_concat (_inLexique, GGS_string (true, "' and is not a super class of '%") COMMA_SOURCE_FILE_AT_LINE (1354)))._operator_concat (_inLexique, var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1354)) COMMA_SOURCE_FILE_AT_LINE (1354)))._operator_concat (_inLexique, GGS_string (true, "'") COMMA_SOURCE_FILE_AT_LINE (1354)) COMMA_SOURCE_FILE_AT_LINE (1355)) ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
  ...
  var_cas_ioInstructionList._addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i ;
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1369)), var_cas_nonterminalSymbolName, GGS_uint (true, 0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature._addAssign_operation (var_cas_i) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
pr_syntax_instruction_parser_parser_1264_6_importSyntax (galgas_scanner & _inLexique,
  ...
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1389)), var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolIndex COMMA_HERE) ;
  var_cas_ioInstructionList._addAssign_operation (var_cas_i) ;
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      } break ;
...
pr_syntax_instruction_parser_parser_1408_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1426)) ;
  var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1427)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1427)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1449)) ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1449)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1426)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_syntax_instruction_parser_parser_1513_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique COMMA_SOURCE_FILE_AT_LINE (1531)) ;
  ...
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1534)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, var_cas_positionErreurPremiereBranche COMMA_SOURCE_FILE_AT_LINE (1534)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_repeatPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1555)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1555)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique COMMA_SOURCE_FILE_AT_LINE (1531)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_typeInstruction  var_cas_instruction ;
...
pr_syntax_instruction_parser_parser_1620_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_59725 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_59725 != NULL)) {
        macroValidPointer (operand_59725) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59725->mInstruction) ;
        operand_59725 = operand_59725->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_ioVariablesMap.prologue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1692)) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) ;
            ...
            var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1695)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1730)) ;
      GGS_location  var_cas_branchStartLocation ;
      var_cas_branchStartLocation = GGS_location (_inLexique) ;
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_62950 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_62950 != NULL)) {
        macroValidPointer (operand_62950) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_62950->mInstruction) ;
        operand_62950 = operand_62950->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1730)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1692)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioInstructionList._addAssign_operation (var_cas_instruction) ;
  if (var_cas_parse_rewind_signature_list._isBuilt (HERE)) {
    ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (1761)) ;
  }
}
