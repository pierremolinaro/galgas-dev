...
pr_syntax_declaration_parser_parser_1323_25_ (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_3 (inLexique)) {
    case 1 : {
      ...
      GGS_L_EXsignature  var_cas_listeDeTypesFormels = GGS_L_EXsignature ::constructor_emptyList () ;
...
pr_syntax_declaration_parser_parser_1323_25_importSyntax (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_3 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
      GGS_uint  var_cas_i = GGS_uint (1U) ;
      GGS_uint _variant_52012 = var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1453)) ;
      GGS_bool _condition_52012 (_variant_52012.isBuilt (), true) ;
      while (_condition_52012.isBuiltAndTrue ()) {
        ...
        _condition_52012 = (var_cas_i).operator_infOrEqual (var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1461))) ;
        if (_condition_52012.isBuiltAndTrue ()) {
          if (_variant_52012.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1462)) ;
            _condition_52012 = GGS_bool (false) ;
          }else{
            _variant_52012.decrement_operation (inLexique COMMA_HERE) ;
          }
        }
      }
          ...
          switch (select_repeat_parser_parser_4 (inLexique)) {
            case 2 : {
              ...
              switch (select_parser_parser_5 (inLexique)) {
                case 1 : {
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
                  GGS_L_signature  var_cas_signature = GGS_L_signature ::constructor_emptyList () ;
...
pr_syntax_declaration_parser_parser_1512_25_ (galgas_scanner & inLexique,
  ...
  const GGS_M_nonTerminalSymbolForSyntax  temp_54924 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_54924.isBuilt ()) {
    temp_54924 (HERE)->method_searchKey (inLexique, var_cas_ruleName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1542)) ;
  }
  GGS_typeAltProductionsMap  var_cas_altProductionsMap = GGS_typeAltProductionsMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_lstring  var_cas_altName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
  GGS_bool var_cas_hasParseLabel = var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1547)) ;
  ...
  const GGS_M_nonterminalSymbolAlts  temp_55818 = var_cas_nonterminalSymbolAltMap ;
  if (temp_55818.isBuilt ()) {
    temp_55818 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  }
    ...
    while (syntaxRepeat_7) {
      switch (select_repeat_parser_parser_7 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_nonterminalSymbolAlts  temp_57271 = var_cas_nonterminalSymbolAltMap ;
          if (temp_57271.isBuilt ()) {
            temp_57271 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (1614)) ;
          }
  ...
  {
    GGS_M_nonterminalSymbolAlts::cEnumerator enumerator_58350 (var_cas_nonterminalSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAlts::cElement * operand_58350 = NULL ;
    while (((operand_58350 = enumerator_58350.nextObject ()))) {
      macroValidPointer (operand_58350) ;
      if ((((operand_58350->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1651))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (inLexique, operand_58350->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1651)) COMMA_SOURCE_FILE_AT_LINE (1651))).operator_not ())).isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_58350->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1652)))).operator_concat (GGS_string ("' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1653)) ;
      }
    }
  }
...
pr_syntax_instruction_parser_parser_1752_25_ (galgas_scanner & inLexique,
  ...
  const GGS_M_terminalSymbolsMapForUse  temp_62388 = var_cas_tableTerminaux ;
  if (temp_62388.isBuilt ()) {
    temp_62388 (HERE)->method_searchKey (inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (1768)) ;
  }
  ...
  GGS_AC_instruction_ForGrammar  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1785)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1752_25_importSyntax (galgas_scanner & inLexique,
  ...
  GGS_AC_instruction_ForGrammar  var_cas_instruction = GGS_T_terminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1795)), var_cas_terminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
pr_syntax_instruction_parser_parser_1807_25_ (galgas_scanner & inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonTerminalSymbolForSyntax  temp_64702 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_64702.isBuilt ()) {
    temp_64702 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1833)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  const GGS_M_nonterminalSymbolAlts  temp_64826 = var_cas_nonterminalSymbolAltMap ;
  if (temp_64826.isBuilt ()) {
    temp_64826 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureMethode COMMA_SOURCE_FILE_AT_LINE (1835)) ;
  }
  ...
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1867)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature.addAssign_operation (var_cas_i) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
pr_syntax_instruction_parser_parser_1807_25_importSyntax (galgas_scanner & inLexique,
  ...
  nt_actual_parameters_list_parse (inLexique) ;
  GGS_AC_instruction_ForGrammar  var_cas_instruction = GGS_T_nonterminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1886)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
pr_syntax_instruction_parser_parser_2109_25_ (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_11 (inLexique)) {
    case 1 : {
      ...
      GGS_typeGalgas_uint  var_cas_ui = GGS_typeGalgas_uint::castFrom (inLexique, var_cas_variantResultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2138)) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
      ...
      GGS_typeGalgas_bool  var_cas_b = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_resultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2151)) ;
    ...
    case 2 : {
      ...
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_78110 (var_cas_firstBranchSyntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_78110 = NULL ;
        while (((operand_78110 = enumerator_78110.nextObject ()))) {
          macroValidPointer (operand_78110) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_78110->mInstruction) ;
        }
      }
    ...
    case 3 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_81530 (var_cas_syntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_81530 = NULL ;
        while (((operand_81530 = enumerator_81530.nextObject ()))) {
          macroValidPointer (operand_81530) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_81530->mInstruction) ;
        }
      }
