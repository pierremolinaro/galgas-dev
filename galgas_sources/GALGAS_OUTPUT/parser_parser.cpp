...
pr_rule_declaration_or_implementation_parser_parser_767_42_ (galgas_scanner & lexique_var_,
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_30656 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_30656 != NULL)) {
    macroValidPointer (operand_30656) ;
    if (((((operand_30656->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_30656->mKey.reader_value ()))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_30656->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
    operand_30656 = operand_30656->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1246_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_parser_parser_9 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_46033 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_46033 != NULL)) {
        macroValidPointer (operand_46033) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_46033->mInstruction) ;
        operand_46033 = operand_46033->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_48808 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_48808 != NULL)) {
        macroValidPointer (operand_48808) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_48808->mInstruction) ;
        operand_48808 = operand_48808->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
