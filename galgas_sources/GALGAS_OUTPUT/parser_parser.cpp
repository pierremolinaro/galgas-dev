...
pr_syntax_instruction_parser_parser_581_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomTable, var_cas_typeEntite, var_cas_nomCppVariableTable SOURCE_FILE_AT_LINE (599)) ;
  ...
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_nomTable, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (656)) ;
...
pr_rule_declaration_or_implementation_parser_parser_773_42_ (galgas_scanner & _inLexique,
  ...
  var_cas_parametersMap.modifier_insertKey (_inLexique, var_cas_emptyId, var_cas_listeDeTypes, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (794)) ;
  var_cas_parametersMapForGrammar.modifier_insertKey (_inLexique, var_cas_emptyId, var_cas_inSignatureForGrammar, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (796)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_4 (_inLexique)) {
            case 1 : {
              ...
              var_cas_parametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeDeTypesFormels, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (808)) ;
              var_cas_parametersMapForGrammar.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signatureForGrammarComponent, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (810)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_altName ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              var_cas_parametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeDeTypesFormels, var_cas_returnedEntity SOURCE_FILE_AT_LINE (841)) ;
              var_cas_parametersMapForGrammar.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signatureForGrammarComponent, var_cas_returnedEntity SOURCE_FILE_AT_LINE (843)) ;
              } break ;
            default :
              break ;
          }
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioNonTerminalSymbolsMapForGrammar.modifier_insertKey (_inLexique, var_cas_inRuleName, var_cas_parametersMapForGrammar SOURCE_FILE_AT_LINE (850)) ;
  var_cas_ioNonTerminalSymbolMapForSyntax.modifier_insertKey (_inLexique, var_cas_inRuleName, var_cas_parametersMap SOURCE_FILE_AT_LINE (851)) ;
...
pr_rule_declaration_or_implementation_parser_parser_773_42_importSyntax (galgas_scanner & _inLexique,
  ...
  var_cas_nonterminalSymbolParametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_inDefaultSignature, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (864)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_3 (_inLexique)) {
        case 2 : {
          ...
          switch (select_parser_parser_4 (_inLexique)) {
            case 1 : {
              ...
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "parse"), GGS_location (_inLexique) COMMA_HERE), var_cas_signature, var_cas_noReturnedEntity SOURCE_FILE_AT_LINE (876)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_altName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (892)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (_inLexique, var_cas_inNonterminalSymbolName, var_cas_nonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (898)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
pr_rule_declaration_or_implementation_parser_parser_906_42_ (galgas_scanner & _inLexique,
    ...
    while ((operand_34077 != NULL)) {
      ...
      if (operand_34077->mInfo.mProperty._isBuilt ()) {
        ...
        if (operand_34161 != NULL) {
          ...
          var_cas_ioVariablesMap.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (982)) ;
          GGS_typeInstruction  var_cas_instruction ;
          ...
          if (operand_34943 != NULL) {
            ...
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_ioVariablesMap.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (989)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{
            ...
            if (operand_35573 != NULL) {
              ...
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
              var_cas_ioVariablesMap.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (996)) ;
              GGS_typeInstruction  var_cas_instruction ;
              var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
              var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
            }else{ // Else part
  ...
  var_cas_altProductionsMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (1024)), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1019)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
pr_syntax_instruction_parser_parser_1235_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1295))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1295))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      ...
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_32 SOURCE_FILE_AT_LINE (1303)) ;
      ...
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_33 SOURCE_FILE_AT_LINE (1308)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
