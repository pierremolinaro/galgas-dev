...
pr_galgas_component_parser_parser_249_6_ (galgas_scanner & _inLexique,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_12777 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_12777 != NULL)) {
    macroValidPointer (operand_12777) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_12777->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (337)) SOURCE_FILE_AT_LINE (337))))).isBuiltAndTrue ()) {
      operand_12777->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_12777->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (338))))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (340)) ;
    }
    operand_12777 = operand_12777->nextObject () ;
  }
...
pr_syntax_declaration_parser_parser_831_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (920))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_32565 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_32565 != NULL)) {
      macroValidPointer (operand_32565) ;
      if (operand_32565->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelAttributeProperty * operand_32649 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_32565->mInfo.mProperty.getPtr ()) ;
        if (operand_32649 != NULL) {
          macroValidPointer (operand_32649) ; 
          GGS_AC_semanticsEntity  var_cas_entite ;
          if (var_cas_ioEntitiesMap._isBuilt ()) {
            var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_32649->mAttributeTypeName, var_cas_entite SOURCE_FILE_AT_LINE (933)) ;
          }
          GGS_AC_galgasType  var_cas_definitionType ;
          ...
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32565->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (936)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (936)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          ...
          cPtr_metamodelSingleReferenceProperty * operand_33416 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_32565->mInfo.mProperty.getPtr ()) ;
          if (operand_33416 != NULL) {
            macroValidPointer (operand_33416) ; 
            GGS_AC_galgasType  var_cas_definitionType ;
            var_cas_definitionType = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_33416->mReferenceEntityName COMMA_HERE) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32565->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (943)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (943)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            ...
            cPtr_metamodelMultipleReferenceProperty * operand_34042 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_32565->mInfo.mProperty.getPtr ()) ;
            if (operand_34042 != NULL) {
              macroValidPointer (operand_34042) ; 
              GGS_AC_galgasType  var_cas_definitionType ;
              var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_34042->mReferenceEntityName COMMA_HERE) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32565->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (950)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (950)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
      ...
      operand_32565 = operand_32565->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_37376 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_37376 != NULL)) {
    macroValidPointer (operand_37376) ;
    if (((((operand_37376->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1048))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_37376->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1048)) SOURCE_FILE_AT_LINE (1048))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_37376->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1049))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1050)) ;
    }
    operand_37376 = operand_37376->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1208_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1266))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1266))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_46777 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1286)) ;
      GGS_bool _condition_46777 (_variant_46777._isBuilt (), true) ;
      while (_condition_46777.isBuiltAndTrue ()) {
        _condition_46777 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1287))) > (GGS_uint (true, 0U)))) ;
        if (_condition_46777.isBuiltAndTrue ()) {
          if (_variant_46777.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1292)) ;
            _condition_46777 = GGS_bool (true, false) ;
          }else{
            _variant_46777._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1549_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57487 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57487 != NULL)) {
        macroValidPointer (operand_57487) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57487->mInstruction) ;
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60515 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60515 != NULL)) {
        macroValidPointer (operand_60515) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60515->mInstruction) ;
        operand_60515 = operand_60515->nextObject () ;
      }
