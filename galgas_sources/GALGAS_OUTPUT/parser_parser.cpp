...
pr_galgas_component_parser_parser_271_24_ (galgas_scanner & _inLexique,
  ...
  var_cas_defLexique = var_cas_lexiqueName.reader_string (_inLexique SOURCE_FILE_AT_LINE (296)) ;
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_13438 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_13438 != NULL)) {
    macroValidPointer (operand_13438) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_13438->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (356)) SOURCE_FILE_AT_LINE (356))))).isBuiltAndTrue ()) {
      operand_13438->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_13438->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (357))))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (359)) ;
    }
    operand_13438 = operand_13438->nextObject () ;
  }
...
pr_syntax_instruction_parser_parser_569_26_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  GGS_AC_galgasType  var_cas_22081 ;
  GGS_typeCplusPlusName  var_cas_22084 ;
  var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_nomTable, var_cas_22081, var_cas_22084 SOURCE_FILE_AT_LINE (642)) ;
...
pr_rule_declaration_or_implementation_parser_parser_894_42_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_productionTagName = var_cas_tagName.reader_string (_inLexique SOURCE_FILE_AT_LINE (928)) ;
      } break ;
    default :
      break ;
  }
  ...
  if (((((var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (941))) == (GGS_string (true, ""))) & ((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (941))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (943))) != (var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (943)))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_e ;
    if (var_cas_ioEntitiesMap._isBuilt ()) {
    ...
    if (((! (var_cas_superEntityStringSet.reader_hasKey (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (950)) SOURCE_FILE_AT_LINE (950))))).isBuiltAndTrue ()) {
      ...
      var_cas_inEffectiveReturnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (952))))) + (GGS_string (true, "' entity or one of its inherited entities is expected here"))) SOURCE_FILE_AT_LINE (953)) ;
    }
  }
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (958))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_e ;
    if (var_cas_ioEntitiesMap._isBuilt ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_34108 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_34108 != NULL)) {
      macroValidPointer (operand_34108) ;
      if ((var_cas_ioEntitiesMap.reader_hasKey (_inLexique, operand_34108->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (965)) SOURCE_FILE_AT_LINE (965))).isBuiltAndTrue ()) {
        GGS_AC_semanticsEntity  var_cas_entite ;
        if (var_cas_ioEntitiesMap._isBuilt ()) {
          var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_34108->mInfo.mTypeName, var_cas_entite SOURCE_FILE_AT_LINE (968)) ;
        }
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34108->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (972)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (972)) COMMA_HERE) ;
        ...
        if (((operand_34108->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_34108->mInfo.mTypeName COMMA_HERE) ;
        ...
        }else if (((operand_34108->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          ...
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else if (((operand_34108->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      ...
      operand_34108 = operand_34108->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38577 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38577 != NULL)) {
    macroValidPointer (operand_38577) ;
    if (((((operand_38577->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1080))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38577->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1080)) SOURCE_FILE_AT_LINE (1080))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38577->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1081))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1082)) ;
    }
    operand_38577 = operand_38577->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1222_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1281))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1281))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46600 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46600 SOURCE_FILE_AT_LINE (1289)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46863 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46863 SOURCE_FILE_AT_LINE (1294)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1545_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57175 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57175 != NULL)) {
        macroValidPointer (operand_57175) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57175->mInstruction) ;
        operand_57175 = operand_57175->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60107 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60107 != NULL)) {
        macroValidPointer (operand_60107) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60107->mInstruction) ;
        operand_60107 = operand_60107->nextObject () ;
      }
