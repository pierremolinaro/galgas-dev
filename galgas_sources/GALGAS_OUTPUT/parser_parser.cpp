...
pr_syntax_declaration_parser_parser_869_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (960)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_34435 != NULL)) {
      ...
      { const GGS_AC_galgasType _var_36440 = operand_34435->mInfo.mPropertyType ; // CAST instruction
        if (_var_36440.getPtr () != NULL) {
          macroValidPointer (_var_36440.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_36440.getPtr ()) != NULL) {
          ...
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_36440.getPtr ()) != NULL) {
            const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_36440.getPtr ()) ;
            GGS_lstring  var_cas_nomVariable ;
  ...
  const GGS_M_nonterminalSymbolAlts _var_39136 = var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonterminalSymbolAlts::element_type * operand_39136 = _var_39136.firstObject () ;
  while ((operand_39136 != NULL)) {
    macroValidPointer (operand_39136) ;
    if ((((operand_39136->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1104)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_39136->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_39136->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1105))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    }
    operand_39136 = operand_39136->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1275_6_ (galgas_scanner & _inLexique,
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_49285 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1358)) ;
      GGS_bool _condition_49285 (_variant_49285._isBuilt (), true) ;
      while (_condition_49285.isBuiltAndTrue ()) {
        _condition_49285 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1359)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_49285.isBuiltAndTrue ()) {
          if (_variant_49285.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1364)) ;
            _condition_49285 = GGS_bool (true, false) ;
          }else{
            _variant_49285._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1634_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      const GGS_L_ruleSyntaxSignature _var_60564 = var_cas_firstBranchSyntaxSignature ;
      const GGS_L_ruleSyntaxSignature::element_type * operand_60564 = _var_60564.firstObject () ;
      while ((operand_60564 != NULL)) {
        macroValidPointer (operand_60564) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60564->mInstruction) ;
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      const GGS_L_ruleSyntaxSignature _var_63800 = var_cas_syntaxSignature ;
      const GGS_L_ruleSyntaxSignature::element_type * operand_63800 = _var_63800.firstObject () ;
      while ((operand_63800 != NULL)) {
        macroValidPointer (operand_63800) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_63800->mInstruction) ;
        operand_63800 = operand_63800->nextObject () ;
      }
