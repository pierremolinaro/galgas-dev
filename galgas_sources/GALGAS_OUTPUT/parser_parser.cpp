...
pr_galgas_component_parser_parser_254_24_ (galgas_scanner & lexique_var_,
  ...
  while ((operand_12606 != NULL)) {
    ...
    if (((! var_cas_tableRoutinesAimplementer.reader_hasKey (operand_12606->mKey))).isBuiltAndTrue ()) {
  ...
  insertKey_M_syntaxComponents (lexique_var_,
                                  ...
                                  var_cas_nonTerminalSymbolsMap,
                                  var_cas_productionRulesListForGrammar,
                                  var_cas_lexiqueName,
                                  var_cas_classNamesSet,
                                  NULL) ;
...
pr_get_lexique_infos_parser_parser_467_25_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  searchKey_M_lexiqueComponents (lexique_var_,
                                  var_cas_lexiqueComponentsMap,
                                  var_cas_outLexiqueName,
...
void parser_parser::
pr_syntax_instruction_parser_parser_514_26_ (galgas_scanner & lexique_var_,
  ...
  searchKey_typeTableBlocsDeTable (lexique_var_,
                                  var_cas_tableMethodesBloc,
                                  var_cas_nomMethodeBloc,
...
void parser_parser::
pr_syntax_instruction_parser_parser_514_26_importSyntax (galgas_scanner & lexique_var_,
...
void parser_parser::
pr_syntax_instruction_parser_parser_514_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
pr_rule_declaration_or_implementation_parser_parser_682_42_ (galgas_scanner & lexique_var_,
  ...
  insertKey_M_nonterminalSymbolAlts (lexique_var_,
                                  var_cas_parametersMap,
                                  var_cas_emptyId,
                                  var_cas_listeDeTypes,
                                  NULL) ;
  insertKey_M_nonterminalSymbolAltsForGrammar (lexique_var_,
                                  var_cas_parametersMapForGrammar,
                                  var_cas_emptyId,
                                  var_cas_inSignatureForGrammar,
                                  NULL) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
          ...
          switch (select_parser_parser_3 (lexique_var_)) {
            case 1 : {
              ...
              insertKey_M_nonterminalSymbolAlts (lexique_var_,
                                              var_cas_parametersMap,
                                              var_cas_altName,
                                              var_cas_listeDeTypesFormels,
                                              NULL) ;
              insertKey_M_nonterminalSymbolAltsForGrammar (lexique_var_,
                                              var_cas_parametersMapForGrammar,
                                              var_cas_altName,
                                              var_cas_signatureForGrammarComponent,
                                              NULL) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_altName ;
  ...
  insertKey_M_nonTerminalSymbolsForGrammar (lexique_var_,
                                  var_cas_ioNonTerminalSymbolsMap,
                                  var_cas_inRuleName,
                                  var_cas_parametersMapForGrammar,
                                  NULL) ;
...
pr_rule_declaration_or_implementation_parser_parser_682_42_importSyntax (galgas_scanner & lexique_var_,
  ...
  insertKey_M_nonTerminalSymbolsForGrammar (lexique_var_,
                                  var_cas_ioNonTerminalSymbolsMap,
                                  var_cas_inNonterminalSymbolName,
                                  var_cas_nonterminalSymbolParametersMap,
                                  NULL) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
pr_rule_declaration_or_implementation_parser_parser_767_42_ (galgas_scanner & lexique_var_,
  ...
  var_cas_hasParseLabel = var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_lstring::constructor_new (GGS_string (true, "parse"), GGS_location (lexique_var_))) ;
  ...
  searchKey_M_nonterminalSymbolAlts (lexique_var_,
                                  var_cas_nonterminalSymbolAltMap,
                                  var_cas_altName,
                                  & var_cas_signatureFournieParPrototype,
                                  NULL) ;
  ...
  insertKey_typeAltProductionsMap (lexique_var_,
                                  var_cas_altProductionsMap,
                                  var_cas_altName,
                                  var_cas_listeTypeEtNomsArguments,
                                  var_cas_listeInstructions,
                                  var_cas_syntaxSignature,
                                  var_cas_endOfInstructionList,
                                  NULL) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_30672 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_30672 != NULL)) {
    macroValidPointer (operand_30672) ;
    if (((((operand_30672->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_30672->mKey))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_30672->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
    operand_30672 = operand_30672->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_953_26_ (galgas_scanner & lexique_var_,
  ...
  searchKey_M_terminalSymbolsMapForUse (lexique_var_,
                                  var_cas_tableTerminaux,
                                  var_cas_terminalSymbolName,
                                  & var_cas_listeDesAttributsFormels,
                                  NULL) ;
...
pr_syntax_instruction_parser_parser_999_26_ (galgas_scanner & lexique_var_,
  ...
  if ((((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel) && ((var_cas_altName.reader_value ()) != (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
    if (((! var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_lstring::constructor_new (GGS_string (true, "parse"), GGS_location (lexique_var_))))).isBuiltAndTrue ()) {
...
pr_syntax_instruction_parser_parser_1246_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_parser_parser_9 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_46063 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_46063 != NULL)) {
        macroValidPointer (operand_46063) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_46063->mInstruction) ;
        operand_46063 = operand_46063->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_48838 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_48838 != NULL)) {
        macroValidPointer (operand_48838) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_48838->mInstruction) ;
        operand_48838 = operand_48838->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
