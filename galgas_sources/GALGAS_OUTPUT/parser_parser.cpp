...
void parser_parser::
parser_parser::
pr_galgas_component_parser_parser_266_24_ (galgas_scanner & lexique_var_,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_13167 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_13167 != NULL)) {
    macroValidPointer (operand_13167) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (operand_13167->mKey.reader_value ())))).isBuiltAndTrue ()) {
        operand_13167->mKey.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the routine '")) + (operand_13167->mKey.reader_value ()))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (353)) ;
    }
    operand_13167 = operand_13167->nextObject () ;
  }
  var_cas_ioSyntaxComponentsMap.methode_insertKey (lexique_var_, var_cas_componentName, var_cas_nonTerminalSymbolsMapForGrammar, var_cas_productionRulesListForGrammar, var_cas_lexiqueName SOURCE_FILE_AT_LINE (358)) ;
  if (var_cas_componentName.isBuilt () &&
    ...
    ::routine_generateSemanticsComponent (lexique_var_,  var_cas_componentName,  var_cas_inclusionsForHeaderFile,  var_cas_defLexique,  var_cas_listeEntitesAengendrer,  var_cas_inclusionsForImplementationFile SOURCE_FILE_AT_LINE (365)) ;
  }
...
void parser_parser::
parser_parser::
pr_galgas_component_parser_parser_266_24_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  ...
  var_cas_ioSyntaxComponentsMap.methode_insertKey (lexique_var_, var_cas_syntaxComponentName, var_cas_nonTerminalSymbolsMapForGrammar, var_cas_productionRulesListForGrammar, var_cas_lexiqueName SOURCE_FILE_AT_LINE (433)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_galgas_component_parser_parser_266_24_importSemantics (galgas_scanner & lexique_var_,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
...
void parser_parser::
parser_parser::
pr_galgas_component_parser_parser_266_24_importLexique (galgas_scanner & lexique_var_,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
...
void parser_parser::
parser_parser::
pr_galgas_component_parser_parser_266_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
...
void parser_parser::
parser_parser::
pr_galgas_component_parser_parser_266_24_importOptions (galgas_scanner & lexique_var_,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
...
void parser_parser::
parser_parser::
pr_get_lexique_infos_parser_parser_519_25_ (galgas_scanner & lexique_var_,
                                GGS_M_terminalSymbolsMapForUse  &var_cas_tableTerminaux,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_lexiqueComponentsMap.methode_searchKey (lexique_var_, var_cas_outLexiqueName, var_cas_tableTerminaux SOURCE_FILE_AT_LINE (544)) ;
}
...
void parser_parser::
parser_parser::
pr_get_lexique_infos_parser_parser_519_25_getLexiqueName (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_outLexiqueName) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_import) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_lexique) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_get_lexique_infos_parser_parser_519_25_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_import) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_lexique) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_parser_parser_1 (lexique_var_)) {
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_564_26_ (galgas_scanner & lexique_var_,
  ...
  var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_nomTable, var_cas_typeEntite, var_cas_nomCppVariableTable SOURCE_FILE_AT_LINE (581)) ;
  ...
  { cPtr_typeGalgasMapType * ptrExtraire_ = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_typeEntite.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      ...
      if (var_cas_typeEntite.getPtr () != NULL) {
        ...
        var_cas_nomTable.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (583)) ;
      }
    }else{
  ...
  var_cas_tableMethodesBloc.methode_searchKey (lexique_var_, var_cas_nomMethodeBloc, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (590)) ;
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  GGS_AC_galgasType  var_cas_21793 ;
  GGS_typeCplusPlusName  var_cas_21796 ;
  var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_nomTable, var_cas_21793, var_cas_21796 SOURCE_FILE_AT_LINE (637)) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_564_26_importSyntax (galgas_scanner & lexique_var_,
...
void parser_parser::
pr_syntax_instruction_parser_parser_564_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_668_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  switch (select_parser_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_returnedEntity, var_cas_e SOURCE_FILE_AT_LINE (703)) ;
      ...
      { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_e.getPtr () != NULL) {
            ...
            var_cas_returnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (705)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            ...
            var_cas_returnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (706)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
        }
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_668_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &var_cas_ioNonTerminalSymbolsMap,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_rule) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_668_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_rule) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_756_42_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  var_cas_parametersMap.methode_insertKey (lexique_var_, var_cas_emptyId, var_cas_listeDeTypes, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (776)) ;
  var_cas_parametersMapForGrammar.methode_insertKey (lexique_var_, var_cas_emptyId, var_cas_inSignatureForGrammar, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (778)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_4 (lexique_var_)) {
            case 1 : {
              ...
              var_cas_parametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_listeDeTypesFormels, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (790)) ;
              var_cas_parametersMapForGrammar.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signatureForGrammarComponent, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (792)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_altName ;
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              switch (select_parser_parser_5 (lexique_var_)) {
                ...
                case 2 : {
                  ...
                  var_cas_returnedEntity.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
                  GGS_AC_semanticsEntity  var_cas_e ;
                  var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_returnedEntity, var_cas_e SOURCE_FILE_AT_LINE (818)) ;
                  GGS_AC_galgasType  var_cas_type ;
                  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
                    if (ptrExtraire_ == NULL) {
                      var_cas_type.drop_operation () ;
                      if (var_cas_e.getPtr () != NULL) {
                        ...
                        message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
                        message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
                        var_cas_returnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (820)) ;
                      }
                    }else{
                      macroValidPointer (ptrExtraire_) ;
                      var_cas_type = ptrExtraire_->aDefType ;
                  ...
                  { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
                    if (ptrExtraire_ == NULL) {
                      if (var_cas_type.getPtr () != NULL) {
                        ...
                        message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleEntity::static_string_message_messageGalgasType () ;
                        message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
                        var_cas_returnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (821)) ;
                      }
                    }else{
                      macroValidPointer (ptrExtraire_) ;
                    }
              ...
              var_cas_parametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_listeDeTypesFormels, var_cas_returnedEntity SOURCE_FILE_AT_LINE (823)) ;
              var_cas_parametersMapForGrammar.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signatureForGrammarComponent, var_cas_returnedEntity SOURCE_FILE_AT_LINE (825)) ;
              } break ;
            default :
              break ;
          }
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioNonTerminalSymbolsMapForGrammar.methode_insertKey (lexique_var_, var_cas_inRuleName, var_cas_parametersMapForGrammar SOURCE_FILE_AT_LINE (832)) ;
  var_cas_ioNonTerminalSymbolMapForSyntax.methode_insertKey (lexique_var_, var_cas_inRuleName, var_cas_parametersMap SOURCE_FILE_AT_LINE (833)) ;
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_756_42_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &var_cas_ioNonTerminalSymbolsMap,
                                GGS_L_productionRules_ForGrammarComponent  &/* var_cas_ioProductionRulesListForGrammar */,
  ...
  var_cas_nonterminalSymbolParametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_inDefaultSignature, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (846)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_3 (lexique_var_)) {
        case 2 : {
          ...
          switch (select_parser_parser_4 (lexique_var_)) {
            case 1 : {
              ...
              var_cas_nonterminalSymbolParametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signature, var_cas_noReturnedEntity SOURCE_FILE_AT_LINE (859)) ;
              } break ;
            case 2 : {
              lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_altName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
              ...
              var_cas_nonterminalSymbolParametersMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (875)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.methode_insertKey (lexique_var_, var_cas_inNonterminalSymbolName, var_cas_nonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (881)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_756_42_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_3 (lexique_var_)) {
        case 2 : {
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_889_42_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  var_cas_ioNonTerminalSymbolMapForSyntax.methode_searchKey (lexique_var_, var_cas_inRuleName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (908)) ;
  ...
  var_cas_nonterminalSymbolAltMap.methode_searchKey (lexique_var_, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_formalReturnedEntity SOURCE_FILE_AT_LINE (930)) ;
  ::routine_verifierCompatibiliteSignatures (lexique_var_,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation SOURCE_FILE_AT_LINE (932)) ;
  if (((((var_cas_formalReturnedEntity.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
      var_cas_inEffectiveReturnedEntity.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the non terminal declaration does not name any returned entity") SOURCE_FILE_AT_LINE (937)) ;
  }else if (((var_cas_inEffectiveReturnedEntity.reader_value ()) != (var_cas_formalReturnedEntity.reader_value ())).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_inEffectiveReturnedEntity, var_cas_e SOURCE_FILE_AT_LINE (940)) ;
    GGS_AC_galgasType  var_cas_type ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type.drop_operation () ;
        if (var_cas_e.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
          var_cas_inEffectiveReturnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (942)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type = ptrExtraire_->aDefType ;
    ...
    { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        ...
        if (var_cas_type.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleEntity::static_string_message_messageGalgasType () ;
          message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
          var_cas_inEffectiveReturnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (944)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
    ...
    if (((! (var_cas_superEntityStringSet.reader_hasKey (var_cas_formalReturnedEntity.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_inEffectiveReturnedEntity.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '@")) + (var_cas_formalReturnedEntity.reader_value ()))) + (GGS_string (true, "' entity or one of its inherited entities is expected here"))) SOURCE_FILE_AT_LINE (946)) ;
    }
  }
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_inEffectiveReturnedEntity, var_cas_e SOURCE_FILE_AT_LINE (954)) ;
    GGS_AC_galgasType  var_cas_type ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type.drop_operation () ;
        if (var_cas_e.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
          message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
          var_cas_inEffectiveReturnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (956)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
        var_cas_type = ptrExtraire_->aDefType ;
    ...
    { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        ...
        if (var_cas_type.getPtr () != NULL) {
          ...
          message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleEntity::static_string_message_messageGalgasType () ;
          message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
          var_cas_inEffectiveReturnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (957)) ;
        }
      }else{
        macroValidPointer (ptrExtraire_) ;
    ...
    GGS_entityPropertyMap::element_type * operand_33698 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33698 != NULL)) {
      macroValidPointer (operand_33698) ;
      if ((var_cas_ioEntitiesMap.reader_hasKey (operand_33698->mInfo.mTypeName.reader_value ())).isBuiltAndTrue ()) {
        GGS_AC_semanticsEntity  var_cas_entite ;
        var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, operand_33698->mInfo.mTypeName, var_cas_entite SOURCE_FILE_AT_LINE (962)) ;
        ...
        { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entite.getPtr ()) ;
          if (ptrExtraire_ == NULL) {
            ...
            if (var_cas_entite.getPtr () != NULL) {
              ...
              var_cas_inEffectiveReturnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (964)) ;
            }
          }else{
            macroValidPointer (ptrExtraire_) ;
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (operand_33698->mKey.reader_value (), var_cas_inEffectiveReturnedEntity.reader_location () COMMA_HERE) ;
        ...
        if (((operand_33698->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
          var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (operand_33698->mInfo.mTypeName COMMA_HERE) ;
          var_cas_ioVariablesMap.methode_insertInArgument (lexique_var_, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (972)) ;
          GGS_typeInstruction  var_cas_instruction ;
        ...
        }else if (((operand_33698->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
          var_cas_ioVariablesMap.methode_insertLocalVariable (lexique_var_, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (976)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }else if (((operand_33698->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE))).isBuiltAndTrue ()) {
          var_cas_ioVariablesMap.methode_insertLocalVariable (lexique_var_, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (980)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }
      }
      operand_33698 = operand_33698->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (lexique_var_), var_cas_inEffectiveReturnedEntity.reader_value (), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1001)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_8 (lexique_var_)) {
            ...
            case 2 : {
              ...
              var_cas_returnedEntity.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
              GGS_AC_semanticsEntity  var_cas_e ;
              var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_returnedEntity, var_cas_e SOURCE_FILE_AT_LINE (1031)) ;
              GGS_AC_galgasType  var_cas_type ;
              { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
                if (ptrExtraire_ == NULL) {
                  var_cas_type.drop_operation () ;
                  if (var_cas_e.getPtr () != NULL) {
                    ...
                    message1_ (0 COMMA_HERE) << cPtr_typeEntiteType::static_string_message_messageTypeEntite () ;
                    message2_ << var_cas_e (HERE)->message_messageTypeEntite () ;
                    var_cas_returnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (1033)) ;
                  }
                }else{
                  macroValidPointer (ptrExtraire_) ;
                  var_cas_type = ptrExtraire_->aDefType ;
              ...
              { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
                if (ptrExtraire_ == NULL) {
                  ...
                  if (var_cas_type.getPtr () != NULL) {
                    ...
                    message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleEntity::static_string_message_messageGalgasType () ;
                    message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
                    var_cas_returnedEntity.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (1034)) ;
                  }
                }else{
                  macroValidPointer (ptrExtraire_) ;
                  var_cas_allPropertiesMap = ptrExtraire_->mAllPropertiesMap ;
          ...
          var_cas_nonterminalSymbolAltMap.methode_searchKey (lexique_var_, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_returnedEntityFromPrototype SOURCE_FILE_AT_LINE (1040)) ;
          ::routine_verifierCompatibiliteSignatures (lexique_var_,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation SOURCE_FILE_AT_LINE (1042)) ;
          GGS_typeInstructionsList  var_cas_listeInstructions ;
          var_cas_listeInstructions = GGS_typeInstructionsList::constructor_empty (HERE) ;
          GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature ;
          var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature::constructor_empty (HERE) ;
          ...
          var_cas_altProductionsMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (lexique_var_), var_cas_returnedEntity.reader_value (), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1060)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  if (var_cas_altProductionsMap.isBuilt ()) {
    ::routine_checkLabelSignatures (lexique_var_,  var_cas_altProductionsMap SOURCE_FILE_AT_LINE (1073)) ;
  }
  GGS_M_nonterminalSymbolAlts::element_type * operand_38216 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38216 != NULL)) {
    macroValidPointer (operand_38216) ;
    if (((((operand_38216->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! (var_cas_altProductionsMap.reader_hasKey (operand_38216->mKey.reader_value ())))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_38216->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1077)) ;
    }
    operand_38216 = operand_38216->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
parser_parser::
pr_rule_declaration_or_implementation_parser_parser_889_42_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar,
                                const GGS_lstring  &var_cas_inNonterminalSymbolName,
                                const GGS_L_signature  &/* var_cas_inDefaultSignature */,
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_889_42_parse (galgas_scanner & lexique_var_) {
  switch (select_parser_parser_6 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1136_32_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
                                ...
                                GGS_M_terminalSymbolsMapForUse  &var_cas_tableTerminaux,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioSyntaxSignature) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (lexique_var_ SOURCE_FILE_AT_LINE (1147)) ;
  nt_syntax_instructions_list_no_verif_ (lexique_var_, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionsList, var_cas_tableTerminaux, var_cas_ioSyntaxSignature) ;
  GGS_location  var_cas_positionErreur ;
  var_cas_positionErreur = GGS_location (lexique_var_) ;
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (lexique_var_, var_cas_positionErreur SOURCE_FILE_AT_LINE (1147)) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1136_32_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  nt_syntax_instructions_list_no_verif_importSyntax (lexique_var_, var_cas_ioInstructionsList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1136_32_parse (galgas_scanner & lexique_var_) {
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1171_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  var_cas_tableTerminaux.methode_searchKey (lexique_var_, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels SOURCE_FILE_AT_LINE (1185)) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1171_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  var_cas_terminalSymbolName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1171_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  nt_input_parameters_list_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1218_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  var_cas_ioNonTerminalSymbolMapForSyntax.methode_searchKey (lexique_var_, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (1243)) ;
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  var_cas_nonterminalSymbolAltMap.methode_searchKey (lexique_var_, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature SOURCE_FILE_AT_LINE (1246)) ;
  if ((((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel) && ((var_cas_altName.reader_value ()) != (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
    if (((! (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") SOURCE_FILE_AT_LINE (1250)) ;
    }
  }
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
      var_cas_returnedEntityVariableName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the non terminal symbol is declared with no returned entity") SOURCE_FILE_AT_LINE (1278)) ;
      ...
      var_cas_returnedEntityVariableName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the non terminal symbol is declared to return an instance of '@")) + (var_cas_returnedEntityFromSignature.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (1280)) ;
  }else if (((((var_cas_returnedEntityFromSignature.reader_value ()) != (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46236 ;
      var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46236 SOURCE_FILE_AT_LINE (1285)) ;
      ...
      { cPtr_typeGalgas_multipleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_multipleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_type.getPtr () != NULL) {
            ...
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (1287)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46499 ;
      var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46499 SOURCE_FILE_AT_LINE (1290)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
            ...
            message1_ (0 COMMA_HERE) << cPtr_typeGalgas_singleEntity::static_string_message_messageGalgasType () ;
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (1291)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
        }
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1218_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1218_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
  switch (select_parser_parser_9 (lexique_var_)) {
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1346_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (1361)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (1363)) ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (1363)) ;
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (1361)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1346_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1346_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1420_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (lexique_var_ SOURCE_FILE_AT_LINE (1435)) ;
  ...
  var_cas_ioVariablesMap.prologue_repeatPart (lexique_var_ SOURCE_FILE_AT_LINE (1438)) ;
  GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature ;
  var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature::constructor_empty (HERE) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (lexique_var_, var_cas_positionErreurPremiereBranche SOURCE_FILE_AT_LINE (1438)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_repeatPart (lexique_var_ SOURCE_FILE_AT_LINE (1457)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (1457)) ;
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (lexique_var_ SOURCE_FILE_AT_LINE (1435)) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1420_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1420_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1519_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_55911 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_55911 != NULL)) {
        macroValidPointer (operand_55911) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_55911->mInstruction) ;
        operand_55911 = operand_55911->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_ioVariablesMap.prologue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (1582)) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (1585)) ;
            ...
            var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (1585)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (lexique_var_ SOURCE_FILE_AT_LINE (1617)) ;
      GGS_location  var_cas_branchStartLocation ;
      var_cas_branchStartLocation = GGS_location (lexique_var_) ;
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_58818 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_58818 != NULL)) {
        macroValidPointer (operand_58818) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_58818->mInstruction) ;
        operand_58818 = operand_58818->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_) SOURCE_FILE_AT_LINE (1617)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_ SOURCE_FILE_AT_LINE (1582)) ;
  ...
  if (var_cas_parse_rewind_signature_list.isBuilt ()) {
    ::routine_checkParseRewindSignatures (lexique_var_,  var_cas_parse_rewind_signature_list SOURCE_FILE_AT_LINE (1646)) ;
  }
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1519_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1519_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_do) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1677_41_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1677_41_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1677_41_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
        case 2 : {
