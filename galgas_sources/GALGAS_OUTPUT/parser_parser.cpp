...
pr_galgas_component_parser_parser_262_6_ (galgas_scanner & _inLexique,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_13577 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_13577 != NULL)) {
    macroValidPointer (operand_13577) ;
    if (((var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_13577->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)))._operator_not ()).isBuiltAndTrue ()) {
      operand_13577->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the routine '"))._operator_concat (operand_13577->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (true, "' is not implemented within the component")) COMMA_SOURCE_FILE_AT_LINE (357)) ;
    }
    operand_13577 = operand_13577->nextObject () ;
  }
...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_34110 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_34110 != NULL)) {
      macroValidPointer (operand_34110) ;
      if (operand_34110->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_34198 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_34110->mInfo.mPropertyType.getPtr ()) ;
        if (operand_34198 != NULL) {
          macroValidPointer (operand_34198) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34110->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (979)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (979)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          ...
          var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_34110->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (981)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_34110->mInfo.mPropertyType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_34763 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_34110->mInfo.mPropertyType.getPtr ()) ;
          if (operand_34763 != NULL) {
            macroValidPointer (operand_34763) ; 
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34110->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (985)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (985)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_34110->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (987)) ;
            ...
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_34110->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{ // Else part
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34110->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1000)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1000)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_34110->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (1002)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_34110->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_34110 = operand_34110->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38803 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38803 != NULL)) {
    macroValidPointer (operand_38803) ;
    if ((((operand_38803->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1100)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38803->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1100)) COMMA_SOURCE_FILE_AT_LINE (1100)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_38803->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1101))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    }
    operand_38803 = operand_38803->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1627_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_59941 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_59941 != NULL)) {
        macroValidPointer (operand_59941) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59941->mInstruction) ;
        operand_59941 = operand_59941->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_63166 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_63166 != NULL)) {
        macroValidPointer (operand_63166) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_63166->mInstruction) ;
        operand_63166 = operand_63166->nextObject () ;
      }
