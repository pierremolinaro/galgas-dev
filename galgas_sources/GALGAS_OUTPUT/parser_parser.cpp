...
//                    february 22th, 2007, at 11h18'47"                      *
//                                                                           *
//---------------------------------------------------------------------------*
  ...
  switch (select_parser_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6 SOURCE_FILE_AT_LINE (697)) ;
      }
...
pr_syntax_declaration_parser_parser_832_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_7 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11 SOURCE_FILE_AT_LINE (867)) ;
      }
  ...
  if (((((var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (908))) == (GGS_string (true, ""))) & ((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (908))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15, var_cas_superEntityStringSet SOURCE_FILE_AT_LINE (912)) ;
    }
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (921))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 SOURCE_FILE_AT_LINE (922)) ;
    }
    ...
    GGS_stringset  automatic_var_24 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_allPropertiesMap, automatic_var_21, automatic_var_22, automatic_var_23, automatic_var_24 SOURCE_FILE_AT_LINE (929)) ;
    }
    GGS_entityPropertyMap::element_type * operand_32481 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_32481 != NULL)) {
      macroValidPointer (operand_32481) ;
      if (operand_32481->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelAttributeProperty * operand_32565 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_32481->mInfo.mProperty.getPtr ()) ;
        if (operand_32565 != NULL) {
          macroValidPointer (operand_32565) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32481->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (933)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (933)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_32565->mAttributeType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (935)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_32565->mAttributeType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_metamodelSingleReferenceProperty * operand_33065 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_32481->mInfo.mProperty.getPtr ()) ;
          if (operand_33065 != NULL) {
            macroValidPointer (operand_33065) ; 
            GGS_AC_galgasType  var_cas_definitionType ;
            var_cas_definitionType = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_33065->mReferenceEntityName COMMA_HERE) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32481->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (940)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (940)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            ...
            cPtr_metamodelMultipleReferenceProperty * operand_33691 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_32481->mInfo.mProperty.getPtr ()) ;
            if (operand_33691 != NULL) {
              macroValidPointer (operand_33691) ; 
              GGS_AC_galgasType  var_cas_definitionType ;
              var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_33691->mReferenceEntityName COMMA_HERE) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32481->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (947)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (947)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
      ...
      operand_32481 = operand_32481->nextObject () ;
    }
  }
        ...
        case 2 : {
          ...
          switch (select_parser_parser_11 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_25, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29 SOURCE_FILE_AT_LINE (1001)) ;
              }
              } break ;
            default :
              break ;
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_37013 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_37013 != NULL)) {
    macroValidPointer (operand_37013) ;
    if (((((operand_37013->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1045))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_37013->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1045)) SOURCE_FILE_AT_LINE (1045))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_37013->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1046))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1047)) ;
    }
    operand_37013 = operand_37013->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1205_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1264))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1264))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      ...
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_30 SOURCE_FILE_AT_LINE (1272)) ;
      ...
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_31 SOURCE_FILE_AT_LINE (1276)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          var_cas_variableEntityName._drop_operation () ;
          if (var_cas_type.getPtr () != NULL) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_46425 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1283)) ;
      GGS_bool _condition_46425 (_variant_46425._isBuilt (), true) ;
      while (_condition_46425.isBuiltAndTrue ()) {
        _condition_46425 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1284))) > (GGS_uint (true, 0U)))) ;
        if (_condition_46425.isBuiltAndTrue ()) {
          if (_variant_46425.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1289)) ;
            _condition_46425 = GGS_bool (true, false) ;
          }else{
            _variant_46425._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
              var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_32, automatic_var_33, automatic_var_34, var_cas_superEntity, automatic_var_35 SOURCE_FILE_AT_LINE (1286)) ;
            }
...
pr_syntax_instruction_parser_parser_1547_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57154 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57154 != NULL)) {
        macroValidPointer (operand_57154) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57154->mInstruction) ;
        operand_57154 = operand_57154->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60178 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60178 != NULL)) {
        macroValidPointer (operand_60178) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60178->mInstruction) ;
        operand_60178 = operand_60178->nextObject () ;
      }
