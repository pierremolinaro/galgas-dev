...
pr_galgas_component_parser_parser_258_23_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_11124 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (274))).operator_isNotEqual (var_cas_basename) ;
  ...
  }
  {
    ...
    while (((operand_13644 = enumerator_13644.nextObject ()))) {
      ...
      const GGS_bool cond_13842 = (var_cas_tableRoutinesAimplementer.reader_hasKey (inLexique, operand_13644->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366))).operator_not () ;
...
pr_get_lexique_infos_parser_parser_576_24_ (galgas_scanner & inLexique,
  ...
  const GGS_M_lexiqueComponents  temp_19625 = var_cas_lexiqueComponentsMap ;
  if (temp_19625.isBuilt ()) {
    temp_19625 (HERE)->method_searchKey (inLexique, var_cas_outLexiqueName, var_cas_tableTerminaux COMMA_SOURCE_FILE_AT_LINE (600)) ;
  }
  const GGS_bool cond_19810 = (var_cas_ioLexiqueMapForUse.reader_hasKey (inLexique, var_cas_outLexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602))).operator_not () ;
  if (cond_19810.isBuiltAndTrue ()) {
...
pr_syntax_instruction_parser_parser_625_25_ (galgas_scanner & inLexique,
  ...
  const GGS_typeTableBlocsDeTable  temp_21472 = var_cas_tableMethodesBloc ;
  if (temp_21472.isBuilt ()) {
    temp_21472 (HERE)->method_searchKey (inLexique, var_cas_nomMethodeBloc, var_cas_signatureDebut, var_cas_signatureFin COMMA_SOURCE_FILE_AT_LINE (654)) ;
  }
...
void routine_implicitDeclarationImportSyntax (C_Compiler & inLexique,
  ...
  GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature ::constructor_emptyList () ;
  GGS_AC_instruction_ForGrammar  var_cas_instruction = GGS_T_nonterminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_actualPrefixName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (949)), var_cas_actualPrefixName, GGS_uint (0U) COMMA_HERE) ;
...
pr_syntax_declaration_parser_parser_1008_25_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_36880 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1043))).operator_isEqual (GGS_string ("multiple prefix")) ;
  if (cond_36880.isBuiltAndTrue ()) {
    ...
    var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
  }else if (cond_36880.isBuiltAndFalse ()) {
    const GGS_bool cond_37484 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1058))).operator_isEqual (GGS_string ("simple prefix")) ;
    if (cond_37484.isBuiltAndTrue ()) {
      ...
      var_cas_instruction = GGS_typeInstructionAppelNonTerminal ::constructor_new (inLexique, var_cas_calledRuleName, GGS_typeExpressionList ::constructor_emptyList (), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
      var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
    }else if (cond_37484.isBuiltAndFalse ()) {
      const GGS_bool cond_38119 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1073))).operator_isEqual (GGS_string ("infix")) ;
      if (cond_38119.isBuiltAndTrue ()) {
        ...
        var_cas_instruction = GGS_typeInstructionAppelNonTerminal ::constructor_new (inLexique, var_cas_calledRuleName, GGS_typeExpressionList ::constructor_emptyList (), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
        var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
      }else if (cond_38119.isBuiltAndFalse ()) {
        const GGS_bool cond_38716 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1088))).operator_isEqual (GGS_string ("right infix")) ;
        if (cond_38716.isBuiltAndTrue ()) {
          ...
          var_cas_instruction = GGS_typeInstructionAppelNonTerminal ::constructor_new (inLexique, var_cas_calledRuleName, GGS_typeExpressionList ::constructor_emptyList (), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }else if (cond_38716.isBuiltAndFalse ()) {
          const GGS_bool cond_39616 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1103))).operator_isEqual (GGS_string ("left infix")) ;
          if (cond_39616.isBuiltAndTrue ()) {
            ...
            var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
          }else if (cond_39616.isBuiltAndFalse ()) {
            const GGS_bool cond_39892 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1125))).operator_isEqual (GGS_string ("simple postfix")) ;
            if (cond_39892.isBuiltAndTrue ()) {
            ...
            }else if (cond_39892.isBuiltAndFalse ()) {
              const GGS_bool cond_40384 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1130))).operator_isEqual (GGS_string ("multiple postfix")) ;
              if (cond_40384.isBuiltAndTrue ()) {
                ...
                var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
              }else if (cond_40384.isBuiltAndFalse ()) {
...
pr_syntax_declaration_parser_parser_1008_25_importSyntax (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature ::constructor_emptyList () ;
  GGS_AC_instruction_ForGrammar  var_cas_instruction = GGS_T_terminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)), var_cas_terminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_syntaxSignature.addAssign_operation (var_cas_instruction) ;
  GGS_lstring  var_cas_leftNonTerminalName ;
  const GGS_bool cond_42857 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1203))).operator_isEqual (GGS_string ("multiple prefix")) ;
  if (cond_42857.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_43457 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1218))).operator_isEqual (GGS_string ("simple prefix")) ;
    if (cond_43457.isBuiltAndTrue ()) {
      ...
      var_cas_syntaxSignature.addAssign_operation (var_cas_instruction) ;
    }else if (cond_43457.isBuiltAndFalse ()) {
      const GGS_bool cond_44048 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1233))).operator_isEqual (GGS_string ("infix")) ;
      if (cond_44048.isBuiltAndTrue ()) {
        ...
        var_cas_syntaxSignature.addAssign_operation (var_cas_instruction) ;
      }else if (cond_44048.isBuiltAndFalse ()) {
        const GGS_bool cond_44641 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1248))).operator_isEqual (GGS_string ("right infix")) ;
        if (cond_44641.isBuiltAndTrue ()) {
          ...
          var_cas_syntaxSignature.addAssign_operation (var_cas_instruction) ;
        }else if (cond_44641.isBuiltAndFalse ()) {
          const GGS_bool cond_45453 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1263))).operator_isEqual (GGS_string ("left infix")) ;
          if (cond_45453.isBuiltAndTrue ()) {
            ...
            const GGS_bool cond_45688 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1284))).operator_isEqual (GGS_string ("simple postfix")) ;
            if (cond_45688.isBuiltAndTrue ()) {
            ...
            }else if (cond_45688.isBuiltAndFalse ()) {
              const GGS_bool cond_46140 = (var_cas_operatorAttributes.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1289))).operator_isEqual (GGS_string ("multiple postfix")) ;
              if (cond_46140.isBuiltAndTrue ()) {
                ...
                var_cas_syntaxSignature.addAssign_operation (var_cas_instruction) ;
              }else if (cond_46140.isBuiltAndFalse ()) {
                var_cas_operatorAttributes.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Valid operator attributes are:\n"
                  "  - \"multiple prefix\" ;\n"
                  "  - \"simple prefix\" ;\n"
                  "  - \"multiple postfix\" ;\n"
...
pr_syntax_declaration_parser_parser_1323_25_ (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_3 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
      const GGS_bool cond_47842 = (var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1344))).operator_isEqual (GGS_uint (0U)) ;
      ...
      GGS_uint _variant_48194 = var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1348)) ;
      GGS_bool _condition_48194 (_variant_48194.isBuilt (), true) ;
      while (_condition_48194.isBuiltAndTrue ()) {
        ...
        _condition_48194 = (var_cas_i).operator_infOrEqual (var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1359))) ;
        if (_condition_48194.isBuiltAndTrue ()) {
          if (_variant_48194.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1360)) ;
            _condition_48194 = GGS_bool (false) ;
          }else{
            _variant_48194.decrement_operation (inLexique COMMA_HERE) ;
          }
        }
      }
    ...
    case 2 : {
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_ruleName, var_cas_parametersMapForGrammar COMMA_SOURCE_FILE_AT_LINE (1433)) ;
...
pr_syntax_declaration_parser_parser_1323_25_importSyntax (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_3 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
      GGS_uint  var_cas_i = GGS_uint (1U) ;
      GGS_uint _variant_51832 = var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1450)) ;
      GGS_bool _condition_51832 (_variant_51832.isBuilt (), true) ;
      while (_condition_51832.isBuiltAndTrue ()) {
        ...
        _condition_51832 = (var_cas_i).operator_infOrEqual (var_cas_levelCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1458))) ;
        if (_condition_51832.isBuiltAndTrue ()) {
          if (_variant_51832.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1459)) ;
            _condition_51832 = GGS_bool (false) ;
          }else{
            _variant_51832.decrement_operation (inLexique COMMA_HERE) ;
          }
        }
      }
      ...
      var_cas_nonterminalSymbolParametersMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_L_signature ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1462)) ;
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualRuleName, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (1470)) ;
      } break ;
    case 2 : {
      GGS_M_nonterminalSymbolAltsForGrammar  var_cas_nonterminalSymbolParametersMap = GGS_M_nonterminalSymbolAltsForGrammar ::constructor_emptyMap (inLexique COMMA_HERE) ;
          ...
          switch (select_repeat_parser_parser_4 (inLexique)) {
            case 2 : {
              ...
              switch (select_parser_parser_5 (inLexique)) {
                case 1 : {
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
                  var_cas_nonterminalSymbolParametersMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("parse"), GGS_location (inLexique) COMMA_HERE), GGS_L_signature ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1485)) ;
                  } break ;
                case 2 : {
                  inLexique.assignFromAttribute_tokenString (var_cas_altName) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (1499)) ;
      } break ;
    default :
      break ;
  }
...
pr_syntax_declaration_parser_parser_1508_25_ (galgas_scanner & inLexique,
  ...
  const GGS_M_nonTerminalSymbolForSyntax  temp_54717 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_54717.isBuilt ()) {
    temp_54717 (HERE)->method_searchKey (inLexique, var_cas_ruleName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1538)) ;
  }
  GGS_typeAltProductionsMap  var_cas_altProductionsMap = GGS_typeAltProductionsMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_lstring  var_cas_altName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
  ...
  const GGS_M_nonterminalSymbolAlts  temp_55611 = var_cas_nonterminalSymbolAltMap ;
  if (temp_55611.isBuilt ()) {
    temp_55611 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (1559)) ;
  }
    ...
    while (syntaxRepeat_7) {
      switch (select_repeat_parser_parser_7 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_nonterminalSymbolAlts  temp_57064 = var_cas_nonterminalSymbolAltMap ;
          if (temp_57064.isBuilt ()) {
            temp_57064 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (1610)) ;
          }
  ...
  {
    GGS_M_nonterminalSymbolAlts::cEnumerator enumerator_58143 (var_cas_nonterminalSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAlts::cElement * operand_58143 = NULL ;
    while (((operand_58143 = enumerator_58143.nextObject ()))) {
      macroValidPointer (operand_58143) ;
      const GGS_bool cond_58328 = ((operand_58143->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1647))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (inLexique, operand_58143->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_SOURCE_FILE_AT_LINE (1647))).operator_not ()) ;
      if (cond_58328.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_58143->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1648)))).operator_concat (GGS_string ("' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1649)) ;
      }
    }
  }
...
pr_syntax_instruction_parser_parser_1748_25_ (galgas_scanner & inLexique,
  ...
  const GGS_M_terminalSymbolsMapForUse  temp_62181 = var_cas_tableTerminaux ;
  if (temp_62181.isBuilt ()) {
    temp_62181 (HERE)->method_searchKey (inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (1764)) ;
  }
  ...
  GGS_AC_instruction_ForGrammar  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1781)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1748_25_importSyntax (galgas_scanner & inLexique,
  ...
  GGS_AC_instruction_ForGrammar  var_cas_instruction = GGS_T_terminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)), var_cas_terminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
pr_syntax_instruction_parser_parser_1803_25_ (galgas_scanner & inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonTerminalSymbolForSyntax  temp_64495 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_64495.isBuilt ()) {
    temp_64495 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1829)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  const GGS_M_nonterminalSymbolAlts  temp_64619 = var_cas_nonterminalSymbolAltMap ;
  if (temp_64619.isBuilt ()) {
    temp_64619 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureMethode COMMA_SOURCE_FILE_AT_LINE (1831)) ;
  }
  const GGS_bool cond_64981 = (var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1833))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_64981.isBuiltAndTrue ()) {
    const GGS_bool cond_64970 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1834))).operator_not () ;
    if (cond_64970.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_65275 = (var_cas_inIsInvokedWithinParseLoopInstruction).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1838))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_65275.isBuiltAndTrue ()) {
    const GGS_bool cond_65264 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1839))).operator_not () ;
    if (cond_65264.isBuiltAndTrue ()) {
  ...
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1863)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature.addAssign_operation (var_cas_i) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
pr_syntax_instruction_parser_parser_1803_25_importSyntax (galgas_scanner & inLexique,
  ...
  nt_actual_parameters_list_parse (inLexique) ;
  GGS_AC_instruction_ForGrammar  var_cas_instruction = GGS_T_nonterminalInstruction_forGrammarComponent ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1882)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
void parser_parser::
pr_syntax_instruction_parser_parser_1999_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (2017)) ;
  ...
  var_cas_ioVariablesMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (2020)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2020)) ;
  ...
  { bool syntaxRepeat_10 = true ;
    while (syntaxRepeat_10) {
        var_cas_ioVariablesMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (2040)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2040)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (2017)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1999_25_importSyntax (galgas_scanner & inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut = GGS_location (inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1999_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat_10 = true ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_2105_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  switch (select_parser_parser_11 (inLexique)) {
    case 1 : {
      ...
      GGS_typeGalgas_uint  var_cas_ui = GGS_typeGalgas_uint::castFrom (inLexique, var_cas_variantResultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2134)) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
      ...
      GGS_typeGalgas_bool  var_cas_b = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_resultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2147)) ;
      ...
      GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature ::constructor_emptyList () ;
      var_cas_ioVariablesMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (2152)) ;
      var_cas_ioVariablesMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (2153)) ;
      ...
      var_cas_ioVariablesMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2153)) ;
      var_cas_ioVariablesMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (2152)) ;
    ...
    case 2 : {
      ...
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_77903 (var_cas_firstBranchSyntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_77903 = NULL ;
        while (((operand_77903 = enumerator_77903.nextObject ()))) {
          macroValidPointer (operand_77903) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_77903->mInstruction) ;
        }
      }
      ...
      if (var_cas_parse_rewind_signature_list.isBuilt ()) {
        ::routine_checkParseRewindSignatures (inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (2230)) ;
      }
      } break ;
    case 3 : {
      GGS_L_parse_rewind_signature_list  var_cas_parse_rewind_signature_list = GGS_L_parse_rewind_signature_list ::constructor_emptyList () ;
      GGS_L_expression_instructionsList_list  var_cas_branchList = GGS_L_expression_instructionsList_list ::constructor_emptyList () ;
      var_cas_ioVariablesMap.prologue_testBloc (inLexique COMMA_SOURCE_FILE_AT_LINE (2235)) ;
      { bool syntaxRepeat_13 = true ;
        while (syntaxRepeat_13) {
            var_cas_ioVariablesMap.prologue_testPart (inLexique COMMA_SOURCE_FILE_AT_LINE (2238)) ;
            ...
            var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2238)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (inLexique COMMA_SOURCE_FILE_AT_LINE (2274)) ;
      GGS_location  var_cas_branchStartLocation = GGS_location (inLexique) ;
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_81329 (var_cas_syntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_81329 = NULL ;
        while (((operand_81329 = enumerator_81329.nextObject ()))) {
          macroValidPointer (operand_81329) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_81329->mInstruction) ;
        }
      }
      var_cas_ioVariablesMap.epilogue_testPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2274)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (inLexique COMMA_SOURCE_FILE_AT_LINE (2235)) ;
      ...
      if (var_cas_parse_rewind_signature_list.isBuilt ()) {
        ::routine_checkParseRewindSignatures (inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (2300)) ;
      }
      } break ;
    default :
      break ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_2105_25_importSyntax (galgas_scanner & inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_11 (inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_2105_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_11 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_loop) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2344_40_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2344_40_importSyntax (galgas_scanner & inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_repeat_parser_parser_14 (inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2344_40_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_repeat_parser_parser_14 (inLexique)) {
        case 2 : {
