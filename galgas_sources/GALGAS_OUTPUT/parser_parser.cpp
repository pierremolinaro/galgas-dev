...
pr_rule_declaration_or_implementation_parser_parser_894_42_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (957))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_34004 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_34004 != NULL)) {
      macroValidPointer (operand_34004) ;
      if ((var_cas_ioEntitiesMap.reader_hasKey (_inLexique, operand_34004->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (964)) SOURCE_FILE_AT_LINE (964))).isBuiltAndTrue ()) {
        GGS_AC_semanticsEntity  var_cas_entite ;
        if (var_cas_ioEntitiesMap.isBuilt ()) {
          var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_34004->mInfo.mTypeName, var_cas_entite SOURCE_FILE_AT_LINE (967)) ;
        }
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34004->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (973)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (973)) COMMA_HERE) ;
        ...
        if (((operand_34004->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_34004->mInfo.mTypeName COMMA_HERE) ;
          var_cas_ioVariablesMap.method_insertInArgument (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (977)) ;
          GGS_typeInstruction  var_cas_instruction ;
        ...
        }else if (((operand_34004->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          var_cas_ioVariablesMap.method_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (981)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }else if (((operand_34004->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          var_cas_ioVariablesMap.method_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (985)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }
      }
      operand_34004 = operand_34004->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38533 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38533 != NULL)) {
    macroValidPointer (operand_38533) ;
    if (((((operand_38533->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1081))) != (GGS_string (true, "parse"))) && ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38533->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1081)) SOURCE_FILE_AT_LINE (1081))))))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38533->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1082))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1082)) ;
    }
    operand_38533 = operand_38533->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1223_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value (_inLexique SOURCE_FILE_AT_LINE (1282))) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1282))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46538 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46538 SOURCE_FILE_AT_LINE (1290)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46801 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46801 SOURCE_FILE_AT_LINE (1295)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1546_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57113 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57113 != NULL)) {
        macroValidPointer (operand_57113) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_57113->mInstruction) ;
        operand_57113 = operand_57113->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60045 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60045 != NULL)) {
        macroValidPointer (operand_60045) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_60045->mInstruction) ;
        operand_60045 = operand_60045->nextObject () ;
      }
