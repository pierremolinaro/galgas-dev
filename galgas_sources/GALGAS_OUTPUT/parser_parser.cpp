  ...
  switch (select_parser_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8 SOURCE_FILE_AT_LINE (730)) ;
      }
...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_7 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_typeSuperClassesMap  automatic_var_13 ;
      GGS_typeListeAttributsSemantiques  automatic_var_14 ;
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14 SOURCE_FILE_AT_LINE (902)) ;
      }
  ...
  if (((((var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (943))) == (GGS_string (true, ""))) & ((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (943))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques  automatic_var_19 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, automatic_var_19 SOURCE_FILE_AT_LINE (947)) ;
    }
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (956))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_typeSuperClassesMap  automatic_var_24 ;
    GGS_typeListeAttributsSemantiques  automatic_var_25 ;
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_20, automatic_var_21, automatic_var_22, automatic_var_23, automatic_var_24, automatic_var_25 SOURCE_FILE_AT_LINE (957)) ;
    }
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_allPropertiesMap, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30 SOURCE_FILE_AT_LINE (964)) ;
    }
    GGS_entityPropertyMap::element_type * operand_33888 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33888 != NULL)) {
      macroValidPointer (operand_33888) ;
      if (operand_33888->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_33976 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_33888->mInfo.mPropertyType.getPtr ()) ;
        if (operand_33976 != NULL) {
          macroValidPointer (operand_33976) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33888->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (968)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (968)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_33888->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (970)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33888->mInfo.mPropertyType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_34504 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_33888->mInfo.mPropertyType.getPtr ()) ;
          if (operand_34504 != NULL) {
            macroValidPointer (operand_34504) ; 
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33888->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (974)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (974)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_33888->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (976)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, ((operand_34504->mEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (978))) + (GGS_string (true, "List"))), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_33888->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{ // Else part
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33888->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (989)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (989)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_33888->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (991)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33888->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_33888 = operand_33888->nextObject () ;
    }
  }
        ...
        case 2 : {
          ...
          switch (select_parser_parser_11 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_31, automatic_var_32, automatic_var_33, automatic_var_34, automatic_var_35, automatic_var_36 SOURCE_FILE_AT_LINE (1043)) ;
              }
              } break ;
            default :
              break ;
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38483 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38483 != NULL)) {
    macroValidPointer (operand_38483) ;
    if (((((operand_38483->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1089))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38483->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1089)) SOURCE_FILE_AT_LINE (1089))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38483->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1090))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1091)) ;
    }
    operand_38483 = operand_38483->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1260_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1321))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1321))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      ...
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_37 SOURCE_FILE_AT_LINE (1329)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_38 ;
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_38 SOURCE_FILE_AT_LINE (1333)) ;
      { cPtr_typeGalgas_singleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          var_cas_variableEntityName._drop_operation () ;
          if (var_cas_type.getPtr () != NULL) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_48311 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1340)) ;
      GGS_bool _condition_48311 (_variant_48311._isBuilt (), true) ;
      while (_condition_48311.isBuiltAndTrue ()) {
        _condition_48311 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1341))) > (GGS_uint (true, 0U)))) ;
        if (_condition_48311.isBuiltAndTrue ()) {
          if (_variant_48311.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1346)) ;
            _condition_48311 = GGS_bool (true, false) ;
          }else{
            _variant_48311._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            GGS_typeSuperClassesMap  automatic_var_42 ;
            GGS_typeListeAttributsSemantiques  automatic_var_43 ;
            if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
              var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_39, automatic_var_40, automatic_var_41, var_cas_superEntity, automatic_var_42, automatic_var_43 SOURCE_FILE_AT_LINE (1343)) ;
            }
...
pr_syntax_instruction_parser_parser_1616_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_59617 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_59617 != NULL)) {
        macroValidPointer (operand_59617) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59617->mInstruction) ;
        operand_59617 = operand_59617->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_62842 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_62842 != NULL)) {
        macroValidPointer (operand_62842) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_62842->mInstruction) ;
        operand_62842 = operand_62842->nextObject () ;
      }
