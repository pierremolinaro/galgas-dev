...
pr_rule_declaration_or_implementation_parser_parser_894_42_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (958))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_34097 != NULL)) {
      ...
      if ((var_cas_ioEntitiesMap.reader_hasKey (_inLexique, operand_34097->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (965)) SOURCE_FILE_AT_LINE (965))).isBuiltAndTrue ()) {
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34097->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (972)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (972)) COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_7 (_inLexique)) {
        case 2 : {
          ...
          var_cas_altProductionsMap.method_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (1069)), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1064)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  while ((operand_38562 != NULL)) {
    macroValidPointer (operand_38562) ;
    if (((((operand_38562->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1080))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38562->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1080)) SOURCE_FILE_AT_LINE (1080))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38562->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1081))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1082)) ;
    }
    operand_38562 = operand_38562->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1222_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value (_inLexique SOURCE_FILE_AT_LINE (1281))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1281))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
  ...
  }else if (((((var_cas_returnedEntityFromSignature.reader_value (_inLexique SOURCE_FILE_AT_LINE (1283))) != (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1283))) == (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the non terminal symbol is declared to return an instance of '@")) + (var_cas_returnedEntityFromSignature.reader_value (_inLexique SOURCE_FILE_AT_LINE (1284))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (1285)) ;
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46574 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46574 SOURCE_FILE_AT_LINE (1289)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46837 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46837 SOURCE_FILE_AT_LINE (1294)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
