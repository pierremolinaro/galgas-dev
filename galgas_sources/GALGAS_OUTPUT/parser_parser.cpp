...
pr_rule_declaration_or_implementation_parser_parser_752_42_ (galgas_scanner & lexique_var_,
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_29142 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_29142 != NULL)) {
    macroValidPointer (operand_29142) ;
    if (((((operand_29142->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_29142->mKey.reader_value ()))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_29142->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
...
pr_syntax_instruction_parser_parser_1231_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_parser_parser_9 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_44491 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_44491 != NULL)) {
        macroValidPointer (operand_44491) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_44491->mInstruction) ;
        operand_44491 = operand_44491->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_47266 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_47266 != NULL)) {
        macroValidPointer (operand_47266) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_47266->mInstruction) ;
        operand_47266 = operand_47266->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
