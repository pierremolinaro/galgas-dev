...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_34093 != NULL)) {
      ...
      if (operand_34093->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_34198 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_34093->mInfo.mPropertyType.getPtr ()) ;
        if (operand_34198 != NULL) {
          ...
          cPtr_typeGalgas_multipleReferenceEntity * operand_34763 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_34093->mInfo.mPropertyType.getPtr ()) ;
          if (operand_34763 != NULL) {
            macroValidPointer (operand_34763) ; 
            GGS_lstring  var_cas_nomVariable ;
            ...
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, (operand_34763->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)))._operator_concat (GGS_string (true, "List")), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
  ...
  const GGS_M_nonterminalSymbolAlts _var_38779 = var_cas_nonterminalSymbolAltMap ;
  GGS_M_nonterminalSymbolAlts::element_type * operand_38779 = _var_38779.firstObject () ;
  while ((operand_38779 != NULL)) {
    macroValidPointer (operand_38779) ;
    if ((((operand_38779->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1100)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38779->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1100)) COMMA_SOURCE_FILE_AT_LINE (1100)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_38779->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1101))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    }
    operand_38779 = operand_38779->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1271_6_ (galgas_scanner & _inLexique,
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1332)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1332)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_48635 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1351)) ;
      GGS_bool _condition_48635 (_variant_48635._isBuilt (), true) ;
      while (_condition_48635.isBuiltAndTrue ()) {
        _condition_48635 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1352)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_48635.isBuiltAndTrue ()) {
          if (_variant_48635.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1357)) ;
            _condition_48635 = GGS_bool (true, false) ;
          }else{
            _variant_48635._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1627_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      const GGS_L_ruleSyntaxSignature _var_59914 = var_cas_firstBranchSyntaxSignature ;
      GGS_L_ruleSyntaxSignature::element_type * operand_59914 = _var_59914.firstObject () ;
      while ((operand_59914 != NULL)) {
        macroValidPointer (operand_59914) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59914->mInstruction) ;
        operand_59914 = operand_59914->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      const GGS_L_ruleSyntaxSignature _var_63150 = var_cas_syntaxSignature ;
      GGS_L_ruleSyntaxSignature::element_type * operand_63150 = _var_63150.firstObject () ;
      while ((operand_63150 != NULL)) {
        macroValidPointer (operand_63150) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_63150->mInstruction) ;
        operand_63150 = operand_63150->nextObject () ;
      }
