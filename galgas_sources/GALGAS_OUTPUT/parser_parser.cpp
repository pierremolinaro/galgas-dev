...
void parser_parser::
pr_galgas_component_parser_parser_260_24_ (galgas_scanner & lexique_var_,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_12715 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_12715 != NULL)) {
    macroValidPointer (operand_12715) ;
    if (((! var_cas_tableRoutinesAimplementer.reader_hasKey (operand_12715->mKey.reader_value ()))).isBuiltAndTrue ()) {
        operand_12715->mKey.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the routine '")) + (operand_12715->mKey.reader_value ()))) + (GGS_string (true, "' is not implemented within the component")))) ;
    }
    operand_12715 = operand_12715->nextObject () ;
  }
...
void parser_parser::
pr_galgas_component_parser_parser_260_24_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
...
void parser_parser::
pr_galgas_component_parser_parser_260_24_importSemantics (galgas_scanner & lexique_var_,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_galgas_component_parser_parser_260_24_importLexique (galgas_scanner & lexique_var_,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
...
void parser_parser::
pr_galgas_component_parser_parser_260_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
...
void parser_parser::
pr_galgas_component_parser_parser_260_24_importOptions (galgas_scanner & lexique_var_,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
...
void parser_parser::
pr_get_lexique_infos_parser_parser_474_25_ (galgas_scanner & lexique_var_,
                                GGS_M_terminalSymbolsMapForUse  &var_cas_tableTerminaux,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse,
...
void parser_parser::
pr_get_lexique_infos_parser_parser_474_25_getLexiqueName (galgas_scanner & lexique_var_,
                                GGS_lstring  &var_cas_outLexiqueName) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_import) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_lexique) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_get_lexique_infos_parser_parser_474_25_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_import) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_lexique) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  switch (select_parser_parser_1 (lexique_var_)) {
...
void parser_parser::
pr_syntax_instruction_parser_parser_519_26_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  GGS_AC_galgasType  var_cas_19989 ;
  GGS_typeCplusPlusName  var_cas_19992 ;
  var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_nomTable, var_cas_19989, var_cas_19992) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_519_26_importSyntax (galgas_scanner & lexique_var_,
...
void parser_parser::
pr_syntax_instruction_parser_parser_519_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_block) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_623_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
...
void parser_parser::
pr_syntax_declaration_parser_parser_623_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &var_cas_ioNonTerminalSymbolsMap,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_rule) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_623_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_rule) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_711_42_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_711_42_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &var_cas_ioNonTerminalSymbolsMap,
                                GGS_L_productionRules_ForGrammarComponent  &/* var_cas_ioProductionRulesListForGrammar */,
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_711_42_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_3 (lexique_var_)) {
        case 2 : {
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_820_42_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeTableEnAvant  &var_cas_tableEnAvant,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_31735 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_31735 != NULL)) {
      macroValidPointer (operand_31735) ;
      GGS_AC_semanticsEntity  var_cas_entite ;
      var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, operand_31735->mInfo.mTypeName, var_cas_entite) ;
      ...
      var_cas_nomVariable = GGS_lstring::constructor_new (operand_31735->mKey.reader_value (), var_cas_inEffectiveReturnedEntity.reader_location () COMMA_HERE) ;
      ...
      if (((operand_31735->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (operand_31735->mInfo.mTypeName COMMA_HERE) ;
      ...
      operand_31735 = operand_31735->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_35458 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_35458 != NULL)) {
    macroValidPointer (operand_35458) ;
    if (((((operand_35458->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_35458->mKey.reader_value ()))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_35458->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
    operand_35458 = operand_35458->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_820_42_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolsForGrammar  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar,
                                const GGS_lstring  &var_cas_inNonterminalSymbolName,
                                const GGS_L_signature  &/* var_cas_inDefaultSignature */,
...
void parser_parser::
pr_rule_declaration_or_implementation_parser_parser_820_42_parse (galgas_scanner & lexique_var_) {
  switch (select_parser_parser_6 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1037_32_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1037_32_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  nt_syntax_instructions_list_no_verif_importSyntax (lexique_var_, var_cas_ioInstructionsList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1037_32_parse (galgas_scanner & lexique_var_) {
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
}
...
void parser_parser::
pr_syntax_instruction_parser_parser_1072_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
...
void parser_parser::
pr_syntax_instruction_parser_parser_1072_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  var_cas_terminalSymbolName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1072_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  nt_input_parameters_list_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
pr_syntax_instruction_parser_parser_1119_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_writeAccess).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_43503 ;
      var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_43503) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_43735 ;
      var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_43735) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1119_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1119_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
  switch (select_parser_parser_9 (lexique_var_)) {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1237_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
pr_syntax_instruction_parser_parser_1237_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1237_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1311_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
pr_syntax_instruction_parser_parser_1311_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1311_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
...
pr_syntax_instruction_parser_parser_1410_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_53134 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_53134 != NULL)) {
        macroValidPointer (operand_53134) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_53134->mInstruction) ;
        operand_53134 = operand_53134->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_56041 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_56041 != NULL)) {
        macroValidPointer (operand_56041) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_56041->mInstruction) ;
        operand_56041 = operand_56041->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1568_41_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1568_41_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1568_41_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
        case 2 : {
