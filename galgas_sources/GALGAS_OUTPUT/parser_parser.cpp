...
pr_syntax_declaration_parser_parser_830_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (920))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_32227 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_32227 != NULL)) {
      macroValidPointer (operand_32227) ;
      if (operand_32227->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_32315 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_32227->mInfo.mPropertyType.getPtr ()) ;
        if (operand_32315 != NULL) {
          macroValidPointer (operand_32315) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32227->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (932)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (932)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_32227->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (934)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_32227->mInfo.mPropertyType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_32843 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_32227->mInfo.mPropertyType.getPtr ()) ;
          if (operand_32843 != NULL) {
            macroValidPointer (operand_32843) ; 
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32227->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (938)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (938)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_32227->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (940)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, ((GGS_string (true, "listOf")) + (operand_32843->mEntityTypeName.ggs_string ().reader_stringByCapitalizingFirstCharacter (_inLexique SOURCE_FILE_AT_LINE (942)))), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_32227->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{ // Else part
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32227->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (953)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (953)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_32227->mInfo.mPropertyType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (955)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_32227->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_32227 = operand_32227->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (982)), var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (983)), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (976)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_11 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_30, automatic_var_31, automatic_var_32, automatic_var_33, automatic_var_34, automatic_var_35 SOURCE_FILE_AT_LINE (1006)) ;
              }
              } break ;
            default :
              break ;
          ...
          if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
            var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_returnedEntityFromPrototype SOURCE_FILE_AT_LINE (1012)) ;
          }
          ::routine_verifierCompatibiliteSignatures (_inLexique, var_cas_signatureFournieParPrototype, var_cas_listeDeTypesFormels, var_cas_errorLocation SOURCE_FILE_AT_LINE (1013)) ;
          ...
          var_cas_altProductionsMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_branchInstructionList, var_cas_branchSyntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (1039)), var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1040)), GGS_entityPropertyMap::constructor_emptyMap (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (1033)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  if (var_cas_altProductionsMap._isBuilt ()) {
    ::routine_checkLabelSignatures (_inLexique,  var_cas_altProductionsMap SOURCE_FILE_AT_LINE (1048)) ;
  }
  GGS_M_nonterminalSymbolAlts::element_type * operand_36789 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_36789 != NULL)) {
    macroValidPointer (operand_36789) ;
    if (((((operand_36789->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1051))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_36789->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1051)) SOURCE_FILE_AT_LINE (1051))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_36789->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1052))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1053)) ;
    }
    operand_36789 = operand_36789->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1127_6_ (galgas_scanner & _inLexique,
                                const GGS_string &var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                ...
                                GGS_L_ruleSyntaxSignature  &var_cas_ioSyntaxSignature,
                                const GGS_entityToImplementMap  &var_cas_inAllMetamodelClassMap) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique SOURCE_FILE_AT_LINE (1140)) ;
  nt_syntax_instructions_list_no_verif_ (_inLexique, var_cas_inLexiqueClassName, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionList, var_cas_tableTerminaux, var_cas_ioSyntaxSignature, var_cas_inAllMetamodelClassMap) ;
  GGS_location  var_cas_positionErreur ;
  var_cas_positionErreur = GGS_location (_inLexique) ;
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, var_cas_positionErreur SOURCE_FILE_AT_LINE (1140)) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1127_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  nt_syntax_instructions_list_no_verif_importSyntax (_inLexique, var_cas_ioInstructionList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1127_6_parse (galgas_scanner & _inLexique) {
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
}
...
pr_syntax_instruction_parser_parser_1166_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_tableTerminaux._isBuilt ()) {
    var_cas_tableTerminaux (HERE)->method_searchKey (_inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels SOURCE_FILE_AT_LINE (1182)) ;
  }
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1219_6_ (galgas_scanner & _inLexique,
                                const GGS_string &/* var_cas_inLexiqueClassName */,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt ()) {
    var_cas_ioNonTerminalSymbolMapForSyntax (HERE)->method_searchKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (1244)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
    var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature SOURCE_FILE_AT_LINE (1247)) ;
  }
  if ((((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel) & ((var_cas_altName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1249))) != (GGS_string (true, "parse"))))).isBuiltAndTrue ()) {
    if (((! (var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") SOURCE_FILE_AT_LINE (1250))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") SOURCE_FILE_AT_LINE (1252)) ;
    }
  }
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1279))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1279))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal symbol is declared with no returned entity") SOURCE_FILE_AT_LINE (1281)) ;
  }else if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1281))) != (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1281))) == (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the non terminal symbol is declared to return an instance of '@")) + (var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1282))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (1283)) ;
  }else if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1283))) != (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1283))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_36 ;
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_36 SOURCE_FILE_AT_LINE (1287)) ;
      { cPtr_typeGalgas_multipleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_type.getPtr () != NULL) {
            ...
            message2_ << var_cas_type (HERE)->message_messageGalgasType () ;
            var_cas_returnedEntityVariableName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1288)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_37 SOURCE_FILE_AT_LINE (1291)) ;
      { cPtr_typeGalgas_singleReferenceEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          var_cas_variableEntityName._drop_operation () ;
          if (var_cas_type.getPtr () != NULL) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = (var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1295))) == (var_cas_variableEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1295))) ;
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      GGS_lstring  var_cas_testedClass ;
      var_cas_testedClass = var_cas_returnedEntityFromSignature ;
      GGS_uint _variant_46405 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1298)) ;
      GGS_bool _condition_46405 (_variant_46405._isBuilt (), true) ;
      while (_condition_46405.isBuiltAndTrue ()) {
        _condition_46405 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1299))) > (GGS_uint (true, 0U)))) ;
        if (_condition_46405.isBuiltAndTrue ()) {
          if (_variant_46405.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1304)) ;
            _condition_46405 = GGS_bool (true, false) ;
          }else{
            _variant_46405._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
              var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_38, automatic_var_39, automatic_var_40, var_cas_superEntity, automatic_var_41, automatic_var_42 SOURCE_FILE_AT_LINE (1301)) ;
            }
            var_cas_testedClass = var_cas_superEntity ;
            var_cas_ok = (var_cas_testedClass.reader_string (_inLexique SOURCE_FILE_AT_LINE (1303))) == (var_cas_variableEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1303))) ;
          }
        }
      }
    }
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "the type of this variable is '%")) + (var_cas_variableEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1307))))) + (GGS_string (true, "' and is not a super class of '%")))) + (var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1308))))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (1309)) ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1219_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_nonterminalSymbolName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_nonterminalSymbolName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1219_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  switch (select_parser_parser_12 (_inLexique)) {
    case 1 : {
      } break ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1362_6_ (galgas_scanner & _inLexique,
                                const GGS_string &var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1379)) ;
  var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1380)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1380)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1379)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1362_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1362_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1464_6_ (galgas_scanner & _inLexique,
                                const GGS_string &var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (1481)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, var_cas_positionErreurPremiereBranche SOURCE_FILE_AT_LINE (1484)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_repeatPart (_inLexique SOURCE_FILE_AT_LINE (1504)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1504)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique SOURCE_FILE_AT_LINE (1481)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1464_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1464_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1568_6_ (galgas_scanner & _inLexique,
                                const GGS_string &var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57369 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57369 != NULL)) {
        macroValidPointer (operand_57369) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57369->mInstruction) ;
        operand_57369 = operand_57369->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_ioVariablesMap.prologue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1637)) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1640)) ;
            ...
            var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1640)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (_inLexique SOURCE_FILE_AT_LINE (1674)) ;
      GGS_location  var_cas_branchStartLocation ;
      var_cas_branchStartLocation = GGS_location (_inLexique) ;
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60483 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60483 != NULL)) {
        macroValidPointer (operand_60483) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60483->mInstruction) ;
        operand_60483 = operand_60483->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) SOURCE_FILE_AT_LINE (1674)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (_inLexique SOURCE_FILE_AT_LINE (1637)) ;
  ...
  if (var_cas_parse_rewind_signature_list._isBuilt ()) {
    ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list SOURCE_FILE_AT_LINE (1705)) ;
  }
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1568_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1568_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1736_6_ (galgas_scanner & _inLexique,
                                const GGS_string &var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1736_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_19 (_inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1736_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_19 (_inLexique)) {
        case 2 : {
