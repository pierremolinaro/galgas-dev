...
pr_galgas_component_parser_parser_271_24_ (galgas_scanner & _inLexique,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_13417 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_13417 != NULL)) {
    macroValidPointer (operand_13417) ;
    if (((! (var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_13417->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (356)) SOURCE_FILE_AT_LINE (356))))).isBuiltAndTrue ()) {
        operand_13417->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine '")) + (operand_13417->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (357))))) + (GGS_string (true, "' is not implemented within the component"))) SOURCE_FILE_AT_LINE (358)) ;
    }
    operand_13417 = operand_13417->nextObject () ;
  }
  var_cas_ioSyntaxComponentsMap.methode_insertKey (_inLexique, var_cas_componentName, var_cas_nonTerminalSymbolsMapForGrammar, var_cas_productionRulesListForGrammar, var_cas_lexiqueName SOURCE_FILE_AT_LINE (363)) ;
...
pr_galgas_component_parser_parser_271_24_importSyntax (galgas_scanner & _inLexique,
  ...
  var_cas_ioSyntaxComponentsMap.methode_insertKey (_inLexique, var_cas_syntaxComponentName, var_cas_nonTerminalSymbolsMapForGrammar, var_cas_productionRulesListForGrammar, var_cas_lexiqueName SOURCE_FILE_AT_LINE (438)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_end) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_syntax) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
pr_get_lexique_infos_parser_parser_524_25_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_lexiqueComponentsMap.methode_searchKey (_inLexique, var_cas_outLexiqueName, var_cas_tableTerminaux SOURCE_FILE_AT_LINE (549)) ;
}
...
pr_syntax_instruction_parser_parser_569_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.methode_searchForReadWriteAccess (_inLexique, var_cas_nomTable, var_cas_typeEntite, var_cas_nomCppVariableTable SOURCE_FILE_AT_LINE (586)) ;
  ...
  var_cas_tableMethodesBloc.methode_searchKey (_inLexique, var_cas_nomMethodeBloc, var_cas_signatureDebut, var_cas_signatureFin SOURCE_FILE_AT_LINE (595)) ;
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  GGS_AC_galgasType  var_cas_22037 ;
  GGS_typeCplusPlusName  var_cas_22040 ;
  var_cas_ioVariablesMap.methode_searchForReadWriteAccess (_inLexique, var_cas_nomTable, var_cas_22037, var_cas_22040 SOURCE_FILE_AT_LINE (642)) ;
...
pr_syntax_declaration_parser_parser_673_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_2 (_inLexique)) {
    case 1 : {
      var_cas_returnedEntity = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_ioEntitiesMap.methode_searchKey (_inLexique, var_cas_returnedEntity, var_cas_e SOURCE_FILE_AT_LINE (708)) ;
...
pr_rule_declaration_or_implementation_parser_parser_761_42_ (galgas_scanner & _inLexique,
  ...
  var_cas_emptyId = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_parametersMap.methode_insertKey (_inLexique, var_cas_emptyId, var_cas_listeDeTypes, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (781)) ;
  var_cas_parametersMapForGrammar.methode_insertKey (_inLexique, var_cas_emptyId, var_cas_inSignatureForGrammar, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (783)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_4 (_inLexique)) {
            case 1 : {
              ...
              var_cas_altName = GGS_lstring::constructor_new (GGS_string (true, "parse"), GGS_location (_inLexique) COMMA_HERE) ;
              var_cas_parametersMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_listeDeTypesFormels, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (795)) ;
              var_cas_parametersMapForGrammar.methode_insertKey (_inLexique, var_cas_altName, var_cas_signatureForGrammarComponent, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (797)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_altName ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              ...
              switch (select_parser_parser_5 (_inLexique)) {
                ...
                case 2 : {
                  ...
                  var_cas_returnedEntity.defineAttribute (_inLexique.tokenString, _inLexique) ;
                  GGS_AC_semanticsEntity  var_cas_e ;
                  var_cas_ioEntitiesMap.methode_searchKey (_inLexique, var_cas_returnedEntity, var_cas_e SOURCE_FILE_AT_LINE (823)) ;
                  GGS_AC_galgasType  var_cas_type ;
                  { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
                    if (ptrExtraire_ == NULL) {
                      var_cas_type.drop_operation () ;
              ...
              var_cas_parametersMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_listeDeTypesFormels, var_cas_returnedEntity SOURCE_FILE_AT_LINE (828)) ;
              var_cas_parametersMapForGrammar.methode_insertKey (_inLexique, var_cas_altName, var_cas_signatureForGrammarComponent, var_cas_returnedEntity SOURCE_FILE_AT_LINE (830)) ;
              } break ;
            default :
              break ;
          }
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioNonTerminalSymbolsMapForGrammar.methode_insertKey (_inLexique, var_cas_inRuleName, var_cas_parametersMapForGrammar SOURCE_FILE_AT_LINE (837)) ;
  var_cas_ioNonTerminalSymbolMapForSyntax.methode_insertKey (_inLexique, var_cas_inRuleName, var_cas_parametersMap SOURCE_FILE_AT_LINE (838)) ;
...
pr_rule_declaration_or_implementation_parser_parser_761_42_importSyntax (galgas_scanner & _inLexique,
  ...
  var_cas_nonterminalSymbolParametersMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_inDefaultSignature, var_cas_inReturnedEntity SOURCE_FILE_AT_LINE (851)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_3 (_inLexique)) {
        case 2 : {
          ...
          switch (select_parser_parser_4 (_inLexique)) {
            case 1 : {
              ...
              var_cas_noReturnedEntity = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
              var_cas_nonterminalSymbolParametersMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_noReturnedEntity SOURCE_FILE_AT_LINE (864)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_altName.defineAttribute (_inLexique.tokenString, _inLexique) ;
              ...
              var_cas_nonterminalSymbolParametersMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntity SOURCE_FILE_AT_LINE (880)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.methode_insertKey (_inLexique, var_cas_inNonterminalSymbolName, var_cas_nonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (886)) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
pr_rule_declaration_or_implementation_parser_parser_894_42_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioNonTerminalSymbolMapForSyntax.methode_searchKey (_inLexique, var_cas_inRuleName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (913)) ;
  ...
  var_cas_nonterminalSymbolAltMap.methode_searchKey (_inLexique, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_formalReturnedEntity SOURCE_FILE_AT_LINE (935)) ;
  ...
  if (((((var_cas_formalReturnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (941))) == (GGS_string (true, ""))) && ((var_cas_inEffectiveReturnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (941))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_ioEntitiesMap.methode_searchKey (_inLexique, var_cas_inEffectiveReturnedEntity, var_cas_e SOURCE_FILE_AT_LINE (945)) ;
    GGS_AC_galgasType  var_cas_type ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type.drop_operation () ;
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (957))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_ioEntitiesMap.methode_searchKey (_inLexique, var_cas_inEffectiveReturnedEntity, var_cas_e SOURCE_FILE_AT_LINE (959)) ;
    GGS_AC_galgasType  var_cas_type ;
    { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
      if (ptrExtraire_ == NULL) {
        var_cas_type.drop_operation () ;
    ...
    GGS_entityPropertyMap::element_type * operand_33938 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33938 != NULL)) {
      macroValidPointer (operand_33938) ;
      if ((var_cas_ioEntitiesMap.reader_hasKey (_inLexique, operand_33938->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (964)) SOURCE_FILE_AT_LINE (964))).isBuiltAndTrue ()) {
        GGS_AC_semanticsEntity  var_cas_entite ;
        var_cas_ioEntitiesMap.methode_searchKey (_inLexique, operand_33938->mInfo.mTypeName, var_cas_entite SOURCE_FILE_AT_LINE (967)) ;
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (operand_33938->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (973)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (973)) COMMA_HERE) ;
        ...
        if (((operand_33938->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
          var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (operand_33938->mInfo.mTypeName COMMA_HERE) ;
          var_cas_ioVariablesMap.methode_insertInArgument (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (977)) ;
          GGS_typeInstruction  var_cas_instruction ;
        ...
        }else if (((operand_33938->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
          var_cas_ioVariablesMap.methode_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (981)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }else if (((operand_33938->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE))).isBuiltAndTrue ()) {
          var_cas_ioVariablesMap.methode_insertLocalVariable (_inLexique, var_cas_nomVariable, var_cas_definitionType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (985)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (var_cas_nomCppVariable, var_cas_definitionType COMMA_HERE) ;
          var_cas_listeInstructions.addAssign_operation (var_cas_instruction) ;
        }
      }
      operand_33938 = operand_33938->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_inEffectiveReturnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (1011)), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1006)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_8 (_inLexique)) {
            ...
            case 2 : {
              ...
              var_cas_returnedEntity.defineAttribute (_inLexique.tokenString, _inLexique) ;
              GGS_AC_semanticsEntity  var_cas_e ;
              var_cas_ioEntitiesMap.methode_searchKey (_inLexique, var_cas_returnedEntity, var_cas_e SOURCE_FILE_AT_LINE (1036)) ;
              GGS_AC_galgasType  var_cas_type ;
              { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
                if (ptrExtraire_ == NULL) {
                  var_cas_type.drop_operation () ;
          ...
          var_cas_nonterminalSymbolAltMap.methode_searchKey (_inLexique, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_returnedEntityFromPrototype SOURCE_FILE_AT_LINE (1045)) ;
          ...
          var_cas_altProductionsMap.methode_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (1070)), var_cas_allPropertiesMap SOURCE_FILE_AT_LINE (1065)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38455 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38455 != NULL)) {
    macroValidPointer (operand_38455) ;
    if (((((operand_38455->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1081))) != (GGS_string (true, "parse"))) && ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38455->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1081)) SOURCE_FILE_AT_LINE (1081))))))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38455->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1082))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1082)) ;
    }
    operand_38455 = operand_38455->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1176_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_tableTerminaux.methode_searchKey (_inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels SOURCE_FILE_AT_LINE (1190)) ;
  ...
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (var_cas_terminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1203)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1176_26_importSyntax (galgas_scanner & _inLexique,
  ...
  GGS_uint  var_cas_terminalSymbolIndex ;
  var_cas_terminalSymbolIndex = GGS_uint (true, 0UL) ;
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (var_cas_terminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1214)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1223_26_ (galgas_scanner & _inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  var_cas_ioNonTerminalSymbolMapForSyntax.methode_searchKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap SOURCE_FILE_AT_LINE (1248)) ;
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  var_cas_nonterminalSymbolAltMap.methode_searchKey (_inLexique, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature SOURCE_FILE_AT_LINE (1251)) ;
  ...
  switch (select_parser_parser_10 (_inLexique)) {
    case 1 : {
      var_cas_returnedEntityVariableName = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2D_3E) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value (_inLexique SOURCE_FILE_AT_LINE (1282))) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1282))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46462 ;
      var_cas_ioVariablesMap.methode_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46462 SOURCE_FILE_AT_LINE (1290)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46725 ;
      var_cas_ioVariablesMap.methode_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46725 SOURCE_FILE_AT_LINE (1295)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
  ...
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i ;
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (var_cas_nonterminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1310)), var_cas_nonterminalSymbolName, GGS_uint (true, 0UL) COMMA_HERE) ;
  var_cas_ioSyntaxSignature.addAssign_operation (var_cas_i) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
pr_syntax_instruction_parser_parser_1223_26_importSyntax (galgas_scanner & _inLexique,
  ...
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (var_cas_nonterminalSymbolName.reader_location (_inLexique SOURCE_FILE_AT_LINE (1332)), var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolIndex COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_i) ;
  switch (select_parser_parser_10 (_inLexique)) {
    case 1 : {
      } break ;
...
pr_syntax_instruction_parser_parser_1351_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_listeInstructionsBrancheChoix = GGS_typeInstructionList::constructor_empty (HERE) ;
  GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature ;
  var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature::constructor_empty (HERE) ;
...
pr_syntax_instruction_parser_parser_1351_26_importSyntax (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_syntaxSignature2 = GGS_L_ruleSyntaxSignature::constructor_empty (HERE) ;
...
pr_syntax_instruction_parser_parser_1447_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_listeInstructionsPremiereBranche = GGS_typeInstructionList::constructor_empty (HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_listeInstructionsBrancheRepeter = GGS_typeInstructionList::constructor_empty (HERE) ;
        GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature ;
        var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature::constructor_empty (HERE) ;
...
pr_syntax_instruction_parser_parser_1546_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      var_cas_firstBranchInstructionsList = GGS_typeInstructionList::constructor_empty (HERE) ;
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_56941 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_56941 != NULL)) {
        macroValidPointer (operand_56941) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_56941->mInstruction) ;
        operand_56941 = operand_56941->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
      ...
      var_cas_instruction = GGS_C_parse_rewind_instruction::constructor_new (GGS_location (_inLexique), var_cas_branchList COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_elseInstructionsList = GGS_typeInstructionList::constructor_empty (HERE) ;
      GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature ;
      var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature::constructor_empty (HERE) ;
      nt_syntax_instructions_list_no_verif_ (_inLexique, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_elseInstructionsList, var_cas_tableTerminaux, var_cas_syntaxSignature) ;
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_59845 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_59845 != NULL)) {
        macroValidPointer (operand_59845) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_59845->mInstruction) ;
        operand_59845 = operand_59845->nextObject () ;
      }
