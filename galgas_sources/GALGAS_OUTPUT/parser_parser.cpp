...
pr_galgas_component_parser_parser_258_23_ (galgas_scanner & inLexique,
  ...
  GGS_string var_cas_basename = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (273)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (273)) ;
  ...
  }
  {
    ...
    while (((operand_13805 = enumerator_13805.nextObject ()))) {
      ...
      const GGS_bool cond_14003 = (var_cas_tableRoutinesAimplementer.reader_hasKey (inLexique, operand_13805->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366))).operator_not () ;
...
pr_get_lexique_infos_parser_parser_576_24_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_19978 = (var_cas_ioLexiqueMapForUse.reader_hasKey (inLexique, var_cas_outLexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602))).operator_not () ;
...
void routine_implicitDeclaration (C_Compiler & inLexique,
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualRuleName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), var_cas_parametersMapForGrammarNoArgument COMMA_SOURCE_FILE_AT_LINE (762)) ;
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualPrefixName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (768)), var_cas_parametersMapForGrammarNoArgument COMMA_SOURCE_FILE_AT_LINE (768)) ;
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualInfixName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (774)), var_cas_parametersMapForGrammarOneArgument COMMA_SOURCE_FILE_AT_LINE (774)) ;
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualPostfixName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (780)), var_cas_parametersMapForGrammarOneArgument COMMA_SOURCE_FILE_AT_LINE (780)) ;
...
void routine_implicitDeclarationImportSyntax (C_Compiler & inLexique,
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualRuleName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (936)), var_cas_nonterminalSymbolParametersMapNoParameter COMMA_SOURCE_FILE_AT_LINE (936)) ;
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualPrefixName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (939)), var_cas_nonterminalSymbolParametersMapNoParameter COMMA_SOURCE_FILE_AT_LINE (939)) ;
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualInfixName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (942)), var_cas_nonterminalSymbolParametersMapNoParameter COMMA_SOURCE_FILE_AT_LINE (942)) ;
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualPostfixName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (945)), var_cas_nonterminalSymbolParametersMapNoParameter COMMA_SOURCE_FILE_AT_LINE (945)) ;
  GGS_syntaxInstructionListForGrammarAnalysis  var_cas_syntaxSignature = GGS_syntaxInstructionListForGrammarAnalysis ::constructor_emptyList () ;
...
pr_syntax_declaration_parser_parser_1323_25_ (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_3 (inLexique)) {
    case 1 : {
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualRuleName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)), var_cas_parametersMapForGrammar COMMA_SOURCE_FILE_AT_LINE (1375)) ;
    ...
    case 2 : {
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_ruleName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1433)), var_cas_parametersMapForGrammar COMMA_SOURCE_FILE_AT_LINE (1433)) ;
...
pr_syntax_declaration_parser_parser_1323_25_importSyntax (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_3 (inLexique)) {
    case 1 : {
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_actualRuleName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1470)), var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (1470)) ;
      } break ;
    case 2 : {
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_nonterminalSymbolParametersMap = GGS_nonterminalSymbolLabelMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_HERE) ;
      ...
      var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_nonterminalSymbolName, var_cas_ioNonTerminalSymbolsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1499)), var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (1499)) ;
      } break ;
    default :
      break ;
  }
...
void parser_parser::
pr_syntax_declaration_parser_parser_1508_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  GGS_typeAltProductionsMap  var_cas_altProductionsMap = GGS_typeAltProductionsMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_lstring  var_cas_altName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
  GGS_bool var_cas_hasParseLabel = var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1543)) ;
  ...
  }
  {
    ...
    while (((operand_59258 = enumerator_59258.nextObject ()))) {
      ...
      const GGS_bool cond_59443 = ((operand_59258->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1647))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (inLexique, operand_59258->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_SOURCE_FILE_AT_LINE (1647))).operator_not ()) ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_1508_25_importSyntax (galgas_scanner & inLexique,
                                GGS_nonTerminalSymbolMapForGrammarAnalysis  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_productionRuleListForGrammarAnalysis  &var_cas_ioProductionRulesListForGrammar) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_1508_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5F_terminal_5F_symbol) COMMA_HERE) ;
  nt_formal_arguments_list_parse (inLexique) ;
  switch (select_parser_parser_6 (inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1707_31_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1707_31_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  nt_syntax_instructions_list_no_verif_importSyntax (inLexique, var_cas_ioInstructionList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1707_31_parse (galgas_scanner & inLexique) {
  nt_syntax_instructions_list_no_verif_parse (inLexique) ;
}
...
void parser_parser::
pr_syntax_instruction_parser_parser_1748_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
...
void parser_parser::
pr_syntax_instruction_parser_parser_1748_25_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  inLexique.assignFromAttribute_tokenString (var_cas_terminalSymbolName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1748_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
  nt_input_parameters_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
}
...
void parser_parser::
pr_syntax_instruction_parser_parser_1803_25_ (galgas_scanner & inLexique,
                                const GGS_string /* var_cas_inLexiqueClassName */,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  if (cond_66255.isBuiltAndTrue ()) {
    const GGS_bool cond_66244 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1834))).operator_not () ;
  ...
  if (cond_66549.isBuiltAndTrue ()) {
    const GGS_bool cond_66538 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1839))).operator_not () ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1803_25_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_nonterminalSymbolName ;
  inLexique.assignFromAttribute_tokenString (var_cas_nonterminalSymbolName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5F_terminal_5F_symbol) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1803_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5F_terminal_5F_symbol) COMMA_HERE) ;
  switch (select_parser_parser_8 (inLexique)) {
    case 1 : {
      } break ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1894_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  { bool syntaxRepeat_9 = true ;
    while (syntaxRepeat_9) {
      ...
      switch (select_parser_parser_9 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
          } break ;
        default :
...
void parser_parser::
pr_syntax_instruction_parser_parser_1894_25_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut = GGS_location (inLexique) ;
  GGS_branchListForGrammarAnalysis  var_cas_selectList = GGS_branchListForGrammarAnalysis ::constructor_emptyList () ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1894_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
  { bool syntaxRepeat_9 = true ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1993_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
pr_syntax_instruction_parser_parser_1993_25_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut = GGS_location (inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1993_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat_10 = true ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_2093_25_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_12 = true ;
        while (syntaxRepeat_12) {
          ...
          switch (select_parser_parser_12 (inLexique)) {
            case 2 : {
              } break ;
            default :
    ...
    case 3 : {
      ...
      { bool syntaxRepeat_13 = true ;
        while (syntaxRepeat_13) {
          ...
          switch (select_parser_parser_13 (inLexique)) {
            case 2 : {
              } break ;
            default :
...
void parser_parser::
pr_syntax_instruction_parser_parser_2093_25_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_11 (inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_2093_25_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_11 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_loop) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2332_40_ (galgas_scanner & inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_parser_parser_14 (inLexique)) {
        case 2 : {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2332_40_importSyntax (galgas_scanner & inLexique,
                                GGS_syntaxInstructionListForGrammarAnalysis  &var_cas_ioInstructionList) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_parser_parser_14 (inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2332_40_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_parser_parser_14 (inLexique)) {
        case 2 : {
