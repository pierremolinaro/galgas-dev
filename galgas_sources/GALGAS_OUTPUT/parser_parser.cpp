...
pr_rule_declaration_or_implementation_parser_parser_892_42_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (956))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_34020 != NULL)) {
      ...
      if ((var_cas_ioEntitiesMap.reader_hasKey (_inLexique, operand_34020->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (963)) SOURCE_FILE_AT_LINE (963))).isBuiltAndTrue ()) {
        GGS_AC_semanticsEntity  var_cas_entite ;
        if (var_cas_ioEntitiesMap._isBuilt ()) {
          var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, operand_34020->mInfo.mTypeName, var_cas_entite SOURCE_FILE_AT_LINE (966)) ;
        }
        ...
        var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34020->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (970)), var_cas_inEffectiveReturnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (970)) COMMA_HERE) ;
        ...
        switch (operand_34020->mInfo.mKind.enumValue ()) {
        ...
        case GGS_metamodelPropertyKind::enum_multipleReferenceProperty:
          {
          var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_34020->mInfo.mTypeName COMMA_HERE) ;
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38429 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38429 != NULL)) {
    macroValidPointer (operand_38429) ;
    if (((((operand_38429->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1080))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38429->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1080)) SOURCE_FILE_AT_LINE (1080))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_38429->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1081))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1082)) ;
    }
    operand_38429 = operand_38429->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1222_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1281))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1281))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46446 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46446 SOURCE_FILE_AT_LINE (1289)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46709 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46709 SOURCE_FILE_AT_LINE (1294)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1545_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57021 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57021 != NULL)) {
        macroValidPointer (operand_57021) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57021->mInstruction) ;
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_59951 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_59951 != NULL)) {
        macroValidPointer (operand_59951) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59951->mInstruction) ;
        operand_59951 = operand_59951->nextObject () ;
      }
