...
pr_galgas_component_parser_parser_262_6_ (galgas_scanner & _inLexique,
  ...
  const GGS_typeTableNomRoutinesDeclarees _var_13551 = var_cas_tableNomRoutinesDeclarees ;
  const GGS_typeTableNomRoutinesDeclarees::element_type * operand_13551 = _var_13551.firstObject () ;
  while ((operand_13551 != NULL)) {
    macroValidPointer (operand_13551) ;
    if (((var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_13551->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)))._operator_not ()).isBuiltAndTrue ()) {
      operand_13551->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the routine '"))._operator_concat (operand_13551->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (true, "' is not implemented within the component")) COMMA_SOURCE_FILE_AT_LINE (357)) ;
    }
    operand_13551 = operand_13551->nextObject () ;
  }
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_694_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
  ...
  switch (select_parser_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (731)) ;
      }
  ...
  var_cas_parametersMap.modifier_insertKey (_inLexique, var_cas_emptyId, var_cas_listeDeTypesFormels, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (741)) ;
  var_cas_parametersMapForGrammar.modifier_insertKey (_inLexique, var_cas_emptyId, var_cas_signatureForGrammar, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (742)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_5 (_inLexique)) {
            case 1 : {
              ...
              var_cas_parametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeDeTypesFormels, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (755)) ;
              var_cas_parametersMapForGrammar.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signatureForGrammarComponent, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (756)) ;
              } break ;
            case 2 : {
              GGS_lstring  var_cas_altName ;
              ...
              switch (select_parser_parser_6 (_inLexique)) {
                ...
                case 2 : {
                  ...
                  if (var_cas_ioEntitiesMap._isBuilt ()) {
                    var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_e COMMA_SOURCE_FILE_AT_LINE (783)) ;
                  }
                  GGS_AC_galgasType  var_cas_type ;
                  var_cas_type = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_e.getPtr (), true, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (785)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (785)) ;
                  GGS_typeGalgas_singleReferenceEntity  var_cas_sre ;
                  var_cas_sre = GGS_typeGalgas_singleReferenceEntity::_castFrom (_inLexique, var_cas_type.getPtr (), true, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (788)) ;
                  } break ;
                default :
                  break ;
              }
              var_cas_parametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeDeTypesFormels, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (791)) ;
              var_cas_parametersMapForGrammar.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signatureForGrammarComponent, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (792)) ;
              } break ;
            default :
              break ;
          }
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (_inLexique, var_cas_ruleName, var_cas_parametersMapForGrammar COMMA_SOURCE_FILE_AT_LINE (800)) ;
  var_cas_ioNonTerminalSymbolMapForSyntax.modifier_insertKey (_inLexique, var_cas_ruleName, var_cas_parametersMap COMMA_SOURCE_FILE_AT_LINE (801)) ;
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_694_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolsForGrammar  &var_cas_ioNonTerminalSymbolsMap,
                                GGS_L_productionRules_ForGrammarComponent  &/* var_cas_ioProductionRulesListForGrammar */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_nonterminal) COMMA_HERE) ;
  ...
  var_cas_nonterminalSymbolParametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (826)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_4 (_inLexique)) {
        case 2 : {
          ...
          switch (select_parser_parser_5 (_inLexique)) {
            case 1 : {
              ...
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "parse"), GGS_location (_inLexique) COMMA_HERE), var_cas_signature, var_cas_noReturnedEntity COMMA_SOURCE_FILE_AT_LINE (838)) ;
              } break ;
            case 2 : {
              _inLexique._assignFromAttribute_tokenString (var_cas_altName) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              ...
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (854)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (861)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
void parser_parser::
pr_syntax_declaration_parser_parser_694_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_nonterminal) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_869_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  switch (select_parser_parser_7 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
        var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (906)) ;
      }
  ...
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt ()) {
    var_cas_ioNonTerminalSymbolMapForSyntax (HERE)->method_searchKey (_inLexique, var_cas_ruleName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (915)) ;
  }
  ...
  var_cas_hasParseLabel = var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") COMMA_SOURCE_FILE_AT_LINE (920)) ;
  ...
  switch (select_parser_parser_9 (_inLexique)) {
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
      var_cas_productionTagName = var_cas_tagName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (930)) ;
      } break ;
    default :
      break ;
  }
  ...
  if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
    var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype, var_cas_formalReturnedEntity COMMA_SOURCE_FILE_AT_LINE (937)) ;
  }
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signaturePremiereBrancheFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_firstBranchErrorLocation COMMA_SOURCE_FILE_AT_LINE (942)) ;
  if ((((var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (947)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (947)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    var_cas_returnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal declaration does not name any returned entity") COMMA_SOURCE_FILE_AT_LINE (949)) ;
  }else if (((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (949)))._operator_isNotEqual (var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (949)))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22, var_cas_superEntityMap, automatic_var_23, automatic_var_24, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (951)) ;
    }
    if (((var_cas_superEntityMap.reader_hasKey (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (952)) COMMA_SOURCE_FILE_AT_LINE (952)))._operator_not ()).isBuiltAndTrue ()) {
      var_cas_returnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (954))))._operator_concat (GGS_string (true, "' entity or one of its inherited entities is expected here")) COMMA_SOURCE_FILE_AT_LINE (955)) ;
    }
  }
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (960)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29, var_cas_superEntityMap, var_cas_propertyList, automatic_var_30, automatic_var_31 COMMA_SOURCE_FILE_AT_LINE (963)) ;
    }
    GGS_AC_galgasType  var_cas_definitionType ;
    var_cas_definitionType = GGS_typeGalgas_singleReferenceEntity::constructor_new (_inLexique, var_cas_returnedEntity, var_cas_propertyList, var_cas_superEntityMap.reader_allKeys (_inLexique COMMA_SOURCE_FILE_AT_LINE (973)) COMMA_HERE) ;
    GGS_typeCplusPlusName  var_cas_nomCppVariable ;
    var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_mdaResultVariableName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (975)), var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (975)) COMMA_HERE) ;
    var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_mdaResultVariableName, var_cas_definitionType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (976)) ;
  ...
  }else if (((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_allPropertiesMap, automatic_var_32, automatic_var_33, automatic_var_34, automatic_var_35, automatic_var_36, automatic_var_37, automatic_var_38 COMMA_SOURCE_FILE_AT_LINE (979)) ;
    }
    const GGS_entityPropertyMap _var_34419 = var_cas_allPropertiesMap ;
    const GGS_entityPropertyMap::element_type * operand_34419 = _var_34419.firstObject () ;
    while ((operand_34419 != NULL)) {
      macroValidPointer (operand_34419) ;
      { const GGS_AC_galgasType _var_36424 = operand_34419->mInfo.mPropertyType ; // CAST instruction
        if (_var_36424.getPtr () != NULL) {
          macroValidPointer (_var_36424.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_36424.getPtr ()) != NULL) {
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34419->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (983)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (983)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (984)), var_cas_nomVariable.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (984)) COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_34419->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (985)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_34419->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_36424.getPtr ()) != NULL) {
            const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_36424.getPtr ()) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34419->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)), var_cas_nomVariable.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)) COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_34419->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (991)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, (var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)))._operator_concat (GGS_string (true, "List")), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_34419->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34419->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1005)), var_cas_nomVariable.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1005)) COMMA_HERE) ;
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_34419->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (1006)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_34419->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_34419 = operand_34419->nextObject () ;
    }
  }
  ...
  var_cas_altProductionsMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1034)), var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1035)), var_cas_allPropertiesMap COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_parser_parser_11 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_39, automatic_var_40, automatic_var_41, automatic_var_42, automatic_var_43, automatic_var_44, automatic_var_45, automatic_var_46 COMMA_SOURCE_FILE_AT_LINE (1058)) ;
              }
              } break ;
            default :
              break ;
          ...
          if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
            var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_returnedEntityFromPrototype COMMA_SOURCE_FILE_AT_LINE (1064)) ;
          }
          ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation COMMA_SOURCE_FILE_AT_LINE (1065)) ;
          ...
          var_cas_altProductionsMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_branchInstructionList, var_cas_branchSyntaxSignature, GGS_location (_inLexique), var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1092)), var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)), GGS_entityPropertyMap::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1086)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
  ...
  if (var_cas_altProductionsMap._isBuilt ()) {
    ::routine_checkLabelSignatures (_inLexique,  var_cas_altProductionsMap COMMA_SOURCE_FILE_AT_LINE (1100)) ;
  }
  const GGS_M_nonterminalSymbolAlts _var_39120 = var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonterminalSymbolAlts::element_type * operand_39120 = _var_39120.firstObject () ;
  while ((operand_39120 != NULL)) {
    macroValidPointer (operand_39120) ;
    if ((((operand_39120->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1104)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_39120->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_39120->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1105))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    }
    operand_39120 = operand_39120->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_869_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolsForGrammar  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_869_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  switch (select_parser_parser_7 (_inLexique)) {
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1180_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                ...
                                const GGS_entityToImplementMap  var_cas_inAllMetamodelClassMap,
                                const GGS_M_treewalkingComponents  var_cas_inTreewalkingComponentMap) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (_inLexique COMMA_SOURCE_FILE_AT_LINE (1194)) ;
  nt_syntax_instructions_list_no_verif_ (_inLexique, var_cas_inLexiqueClassName, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionList, var_cas_tableTerminaux, var_cas_ioSyntaxSignature, var_cas_inAllMetamodelClassMap, var_cas_inTreewalkingComponentMap) ;
  GGS_location  var_cas_positionErreur ;
  var_cas_positionErreur = GGS_location (_inLexique) ;
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (_inLexique, var_cas_positionErreur COMMA_SOURCE_FILE_AT_LINE (1194)) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1180_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  nt_syntax_instructions_list_no_verif_importSyntax (_inLexique, var_cas_ioInstructionList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1180_6_parse (galgas_scanner & _inLexique) {
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1221_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
  ...
  if (var_cas_tableTerminaux._isBuilt ()) {
    var_cas_tableTerminaux (HERE)->method_searchKey (_inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (1238)) ;
  }
  ...
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_terminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1255)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1221_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_terminalSymbolName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
  ...
  GGS_uint  var_cas_terminalSymbolIndex ;
  var_cas_terminalSymbolIndex = GGS_uint (true, 0U) ;
  var_cas_i = GGS_T_terminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_terminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1266)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1221_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_terminal) COMMA_HERE) ;
  nt_input_parameters_list_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1275_6_ (galgas_scanner & _inLexique,
                                const GGS_string /* var_cas_inLexiqueClassName */,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  if (var_cas_ioNonTerminalSymbolMapForSyntax._isBuilt ()) {
    var_cas_ioNonTerminalSymbolMapForSyntax (HERE)->method_searchKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1301)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  if (var_cas_nonterminalSymbolAltMap._isBuilt ()) {
    var_cas_nonterminalSymbolAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature COMMA_SOURCE_FILE_AT_LINE (1304)) ;
  }
  if (((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel)._operator_and ((var_cas_altName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1306)))._operator_isNotEqual (GGS_string (true, "parse")))).isBuiltAndTrue ()) {
    if (((var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") COMMA_SOURCE_FILE_AT_LINE (1307)))._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") COMMA_SOURCE_FILE_AT_LINE (1309)) ;
    }
  }
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal symbol is declared with no returned entity") COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }else if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1338)))._operator_isNotEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1338)))._operator_isEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the non terminal symbol is declared to return an instance of '@"))._operator_concat (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1339))))._operator_concat (GGS_string (true, "' entity")) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
  }else if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1340)))._operator_isNotEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1340)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_47 ;
      var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_47 COMMA_SOURCE_FILE_AT_LINE (1344)) ;
      var_cas_variableEntityName = GGS_typeGalgas_multipleReferenceEntity::_castFrom (_inLexique, var_cas_type.getPtr (), true, var_cas_returnedEntityVariableName COMMA_SOURCE_FILE_AT_LINE (1345)).reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1345)) ;
    }else{
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  automatic_var_48 ;
      var_cas_ioVariablesMap.modifier_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_48 COMMA_SOURCE_FILE_AT_LINE (1349)) ;
      var_cas_variableEntityName = GGS_typeGalgas_singleReferenceEntity::_castFrom (_inLexique, var_cas_type.getPtr (), true, var_cas_returnedEntityVariableName COMMA_SOURCE_FILE_AT_LINE (1351)).reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1351)) ;
    }
    GGS_bool var_cas_ok ;
    var_cas_ok = (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1355)))._operator_isEqual (var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1355))) ;
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_49269 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1358)) ;
      GGS_bool _condition_49269 (_variant_49269._isBuilt (), true) ;
      while (_condition_49269.isBuiltAndTrue ()) {
        _condition_49269 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1359)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_49269.isBuiltAndTrue ()) {
          if (_variant_49269.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1364)) ;
            _condition_49269 = GGS_bool (true, false) ;
          }else{
            _variant_49269._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
              var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_49, automatic_var_50, automatic_var_51, var_cas_superEntity, automatic_var_52, automatic_var_53, automatic_var_54, automatic_var_55 COMMA_SOURCE_FILE_AT_LINE (1361)) ;
            }
            var_cas_testedClass = var_cas_superEntity ;
            var_cas_ok = (var_cas_testedClass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1363)))._operator_isEqual (var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1363))) ;
          }
        }
      }
    }
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '%"))._operator_concat (var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1367))))._operator_concat (GGS_string (true, "' and is not a super class of '%")))._operator_concat (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1368))))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (1369)) ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
  ...
  var_cas_ioInstructionList._addAssign_operation (var_cas_instruction) ;
  GGS_AC_instruction_ForGrammar  var_cas_i ;
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1383)), var_cas_nonterminalSymbolName, GGS_uint (true, 0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature._addAssign_operation (var_cas_i) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1275_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_nonterminalSymbolName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_nonterminalSymbolName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  ...
  var_cas_i = GGS_T_nonterminalInstruction_forGrammarComponent::constructor_new (_inLexique, var_cas_nonterminalSymbolName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1403)), var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolIndex COMMA_HERE) ;
  var_cas_ioInstructionList._addAssign_operation (var_cas_i) ;
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      } break ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1275_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  switch (select_parser_parser_12 (_inLexique)) {
    case 1 : {
      } break ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1422_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1440)) ;
  var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1441)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1441)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1463)) ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1463)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1440)) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1422_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1422_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1527_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique COMMA_SOURCE_FILE_AT_LINE (1545)) ;
  ...
  var_cas_ioVariablesMap.prologue_repeatPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1548)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, var_cas_positionErreurPremiereBranche COMMA_SOURCE_FILE_AT_LINE (1548)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_ioVariablesMap.prologue_repeatPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1569)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1569)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique COMMA_SOURCE_FILE_AT_LINE (1545)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_typeInstruction  var_cas_instruction ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1527_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1527_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1634_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      const GGS_L_ruleSyntaxSignature _var_60548 = var_cas_firstBranchSyntaxSignature ;
      const GGS_L_ruleSyntaxSignature::element_type * operand_60548 = _var_60548.firstObject () ;
      while ((operand_60548 != NULL)) {
        macroValidPointer (operand_60548) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60548->mInstruction) ;
        operand_60548 = operand_60548->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_ioVariablesMap.prologue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1706)) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1709)) ;
            ...
            var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1709)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1744)) ;
      GGS_location  var_cas_branchStartLocation ;
      var_cas_branchStartLocation = GGS_location (_inLexique) ;
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      const GGS_L_ruleSyntaxSignature _var_63784 = var_cas_syntaxSignature ;
      const GGS_L_ruleSyntaxSignature::element_type * operand_63784 = _var_63784.firstObject () ;
      while ((operand_63784 != NULL)) {
        macroValidPointer (operand_63784) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_63784->mInstruction) ;
        operand_63784 = operand_63784->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1744)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (_inLexique COMMA_SOURCE_FILE_AT_LINE (1706)) ;
  ...
  if (var_cas_parse_rewind_signature_list._isBuilt ()) {
    ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (1775)) ;
  }
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1634_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1634_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1807_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1807_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_19 (_inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1807_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_19 (_inLexique)) {
        case 2 : {
