...
void parser_parser::rule_parser_5F_parser_galgas_5F_component_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  }
  {
    ...
    while (((operand_14061 = enumerator_14061.nextObject ()))) {
      ...
      const GGS_bool cond_14262 = (var_cas_tableRoutinesAimplementer.reader_hasKey (operand_14061->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (372)))).operator_not () ;
      if (cond_14262.isBuiltAndTrue ()) {
...
void parser_parser::rule_parser_5F_parser_galgas_5F_component_i0_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_M_terminalSymbolsMapForUse  automatic_var_15210_0 ;
  nt_get_5F_lexique_5F_infos_ (inLexique, automatic_var_15210_0, var_cas_lexiqueMapForUse, var_cas_lexiqueName) ;
...
void parser_parser::rule_parser_5F_parser_get_5F_lexique_5F_infos_i1_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_20292 = (var_cas_ioLexiqueMapForUse.reader_hasKey (var_cas_outLexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (610)))).operator_not () ;
  if (cond_20292.isBuiltAndTrue ()) {
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  GGS_AC_galgasType  automatic_var_23560_0 ;
  GGS_typeCplusPlusName  automatic_var_23560_1 ;
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (inLexique, var_cas_nomTable, automatic_var_23560_0, automatic_var_23560_1 COMMA_SOURCE_FILE_AT_LINE (714)) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i3_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  automatic_var_25651_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioEntitiesMap, var_cas_listeDeTypesFormels0, var_cas_tableArgumentsMethode0, automatic_var_25651_0, var_cas_tableEnAvant, var_cas_signatureForGrammar) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  {
    GGS_M_nonterminalSymbolAlts::cEnumerator enumerator_33497 (var_cas_nonterminalSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAlts::cElement * operand_33497 = NULL ;
    while (((operand_33497 = enumerator_33497.nextObject ()))) {
      macroValidPointer (operand_33497) ;
      const GGS_bool cond_33676 = ((operand_33497->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1003))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (operand_33497->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)))).operator_not ()) ;
      if (cond_33676.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_33497->mKey)).operator_concat (GGS_string ("' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1005)) ;
      }
    }
  }
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_40638 = (var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1195))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_40638.isBuiltAndTrue ()) {
    const GGS_bool cond_40627 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_40627.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_40932 = (var_cas_inIsInvokedWithinParseLoopInstruction).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1200))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_40932.isBuiltAndTrue ()) {
    const GGS_bool cond_40921 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_40921.isBuiltAndTrue ()) {
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_parser_5F_parser_10 (inLexique)) {
    ...
    case 2 : {
      ...
      {
        GGS_syntaxInstructionListForGrammarAnalysis::cEnumerator enumerator_53596 (var_cas_firstBranchSyntaxSignature, true) ;
        const GGS_syntaxInstructionListForGrammarAnalysis::cElement * operand_53596 = NULL ;
        while (((operand_53596 = enumerator_53596.nextObject ()))) {
          macroValidPointer (operand_53596) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_53596->mInstruction) ;
        }
      }
    ...
    case 3 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_syntaxInstructionListForGrammarAnalysis::cEnumerator enumerator_57076 (var_cas_syntaxSignature, true) ;
        const GGS_syntaxInstructionListForGrammarAnalysis::cElement * operand_57076 = NULL ;
        while (((operand_57076 = enumerator_57076.nextObject ()))) {
          macroValidPointer (operand_57076) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_57076->mInstruction) ;
        }
      }
