...
pr_syntax_declaration_parser_parser_869_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (960)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    const GGS_entityPropertyMap _var_34435 = var_cas_allPropertiesMap ;
    const GGS_entityPropertyMap::element_type * operand_34435 = _var_34435.firstObject () ;
    while ((operand_34435 != NULL)) {
      macroValidPointer (operand_34435) ;
      { const GGS_AC_galgasType _var_36443 = operand_34435->mInfo.mPropertyType ; // CAST instruction
        if (_var_36443.getPtr () != NULL) {
          macroValidPointer (_var_36443.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_36443.getPtr ()) != NULL) {
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34435->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (983)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (983)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_34435->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (985)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_34435->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_36443.getPtr ()) != NULL) {
            const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_36443.getPtr ()) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34435->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_34435->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (991)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, (GGS_string (true, "_list_"))._operator_concat (var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (993))), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_34435->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_34435->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_34435->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (1006)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_34435->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_34435 = operand_34435->nextObject () ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAlts _var_39139 = var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonterminalSymbolAlts::element_type * operand_39139 = _var_39139.firstObject () ;
  while ((operand_39139 != NULL)) {
    macroValidPointer (operand_39139) ;
    if ((((operand_39139->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1104)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_39139->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_39139->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1105))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    }
    operand_39139 = operand_39139->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1275_6_ (galgas_scanner & _inLexique,
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_49288 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1358)) ;
      GGS_bool _condition_49288 (_variant_49288._isBuilt (), true) ;
      while (_condition_49288.isBuiltAndTrue ()) {
        _condition_49288 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1359)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_49288.isBuiltAndTrue ()) {
          if (_variant_49288.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1364)) ;
            _condition_49288 = GGS_bool (true, false) ;
          }else{
            _variant_49288._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1634_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      const GGS_L_ruleSyntaxSignature _var_60567 = var_cas_firstBranchSyntaxSignature ;
      const GGS_L_ruleSyntaxSignature::element_type * operand_60567 = _var_60567.firstObject () ;
      while ((operand_60567 != NULL)) {
        macroValidPointer (operand_60567) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60567->mInstruction) ;
        operand_60567 = operand_60567->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      const GGS_L_ruleSyntaxSignature _var_63803 = var_cas_syntaxSignature ;
      const GGS_L_ruleSyntaxSignature::element_type * operand_63803 = _var_63803.firstObject () ;
      while ((operand_63803 != NULL)) {
        macroValidPointer (operand_63803) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_63803->mInstruction) ;
        operand_63803 = operand_63803->nextObject () ;
      }
