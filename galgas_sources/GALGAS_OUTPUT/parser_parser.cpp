...
pr_syntax_declaration_parser_parser_830_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (920))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_32198 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_32198 != NULL)) {
      macroValidPointer (operand_32198) ;
      if (operand_32198->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelAttributeProperty * operand_32282 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_32198->mInfo.mProperty.getPtr ()) ;
        if (operand_32282 != NULL) {
          macroValidPointer (operand_32282) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32198->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (932)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (932)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_32282->mAttributeType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (934)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_32282->mAttributeType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_metamodelSingleReferenceProperty * operand_32782 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_32198->mInfo.mProperty.getPtr ()) ;
          if (operand_32782 != NULL) {
            macroValidPointer (operand_32782) ; 
            GGS_AC_galgasType  var_cas_definitionType ;
            var_cas_definitionType = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_32782->mReferenceEntityName COMMA_HERE) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32198->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (939)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (939)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            ...
            cPtr_metamodelMultipleReferenceProperty * operand_33408 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_32198->mInfo.mProperty.getPtr ()) ;
            if (operand_33408 != NULL) {
              macroValidPointer (operand_33408) ; 
              GGS_AC_galgasType  var_cas_definitionType ;
              var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_33408->mReferenceEntityName COMMA_HERE) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32198->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (946)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (946)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
      ...
      operand_32198 = operand_32198->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_37063 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_37063 != NULL)) {
    macroValidPointer (operand_37063) ;
    if (((((operand_37063->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1055))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_37063->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1055)) SOURCE_FILE_AT_LINE (1055))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_37063->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1056))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1057)) ;
    }
    operand_37063 = operand_37063->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1223_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1283))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1283))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_46657 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1302)) ;
      GGS_bool _condition_46657 (_variant_46657._isBuilt (), true) ;
      while (_condition_46657.isBuiltAndTrue ()) {
        _condition_46657 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1303))) > (GGS_uint (true, 0U)))) ;
        if (_condition_46657.isBuiltAndTrue ()) {
          if (_variant_46657.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1308)) ;
            _condition_46657 = GGS_bool (true, false) ;
          }else{
            _variant_46657._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1572_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57621 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57621 != NULL)) {
        macroValidPointer (operand_57621) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57621->mInstruction) ;
        operand_57621 = operand_57621->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60735 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60735 != NULL)) {
        macroValidPointer (operand_60735) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60735->mInstruction) ;
        operand_60735 = operand_60735->nextObject () ;
      }
