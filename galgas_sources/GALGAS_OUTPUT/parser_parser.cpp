...
void parser_parser::rule_parser_5F_parser_galgas_5F_component_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_11334 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (276))).operator_isNotEqual (var_cas_basename) ;
  if (cond_11334.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS 1.7.5 and later checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (278)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (280)) ;
  }
  ...
  GGS_string var_cas_defLexique = var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (298)) ;
  ...
  {
    GGS_typeTableNomRoutinesDeclarees::cEnumerator enumerator_13916 (var_cas_tableNomRoutinesDeclarees, true) ;
    const GGS_typeTableNomRoutinesDeclarees::cElement * operand_13916 = NULL ;
    while (((operand_13916 = enumerator_13916.nextObject ()))) {
      macroValidPointer (operand_13916) ;
      const GGS_bool cond_14114 = (var_cas_tableRoutinesAimplementer.reader_hasKey (operand_13916->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (370)))).operator_not () ;
      if (cond_14114.isBuiltAndTrue ()) {
        operand_13916->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the routine '")).operator_concat (operand_13916->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (371)))).operator_concat (GGS_string ("' is not implemented within the component")) COMMA_SOURCE_FILE_AT_LINE (373)) ;
      }
    }
  }
  var_cas_ioSyntaxComponentsMap.modifier_insertKey (inLexique, var_cas_componentName, var_cas_nonTerminalSymbolsMapForGrammar, var_cas_productionRulesListForGrammar, var_cas_lexiqueName COMMA_SOURCE_FILE_AT_LINE (376)) ;
  if (var_cas_componentName.isBuilt () &&
    ...
    ::routine_generateSemanticsComponent (inLexique,  var_cas_componentName,  var_cas_inclusionsForHeaderFile,  var_cas_defLexique,  var_cas_listeEntitesAengendrer,  var_cas_inclusionsForImplementationFile COMMA_SOURCE_FILE_AT_LINE (383)) ;
  }
...
void parser_parser::rule_parser_5F_parser_galgas_5F_component_i0_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_M_terminalSymbolsMapForUse  automatic_var_15062_0 ;
  nt_get_5F_lexique_5F_infos_ (inLexique, automatic_var_15062_0, var_cas_lexiqueMapForUse, var_cas_lexiqueName) ;
  ...
  var_cas_ioSyntaxComponentsMap.modifier_insertKey (inLexique, var_cas_syntaxComponentName, var_cas_nonTerminalSymbolsMapForGrammar, var_cas_productionRulesListForGrammar, var_cas_lexiqueName COMMA_SOURCE_FILE_AT_LINE (465)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_syntax) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_get_5F_lexique_5F_infos_i1_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_lexiqueComponents  temp_19959 = var_cas_lexiqueComponentsMap ;
  if (temp_19959.isBuilt ()) {
    temp_19959 (HERE)->method_searchKey (inLexique, var_cas_outLexiqueName, var_cas_tableTerminaux COMMA_SOURCE_FILE_AT_LINE (606)) ;
  }
  const GGS_bool cond_20144 = (var_cas_ioLexiqueMapForUse.reader_hasKey (var_cas_outLexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (608)))).operator_not () ;
  if (cond_20144.isBuiltAndTrue ()) {
    var_cas_ioLexiqueMapForUse.modifier_insertKey (inLexique, var_cas_outLexiqueName, var_cas_tableTerminaux COMMA_SOURCE_FILE_AT_LINE (609)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (inLexique, var_cas_nomTable, var_cas_typeEntite, var_cas_nomCppVariableTable COMMA_SOURCE_FILE_AT_LINE (651)) ;
  GGS_typeTableBlocsDeTable  var_cas_tableMethodesBloc = GGS_typeGalgasMapType::castFrom (inLexique, var_cas_typeEntite.getPtr (), true, var_cas_nomTable COMMA_SOURCE_FILE_AT_LINE (653)).reader_aTableMethodesSurcharger (inLexique COMMA_SOURCE_FILE_AT_LINE (653)) ;
  ...
  const GGS_typeTableBlocsDeTable  temp_21824 = var_cas_tableMethodesBloc ;
  if (temp_21824.isBuilt ()) {
    temp_21824 (HERE)->method_searchKey (inLexique, var_cas_nomMethodeBloc, var_cas_signatureDebut, var_cas_signatureFin COMMA_SOURCE_FILE_AT_LINE (660)) ;
  }
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  GGS_AC_galgasType  automatic_var_23412_0 ;
  GGS_typeCplusPlusName  automatic_var_23412_1 ;
  var_cas_ioVariablesMap.modifier_searchForReadWriteAccess (inLexique, var_cas_nomTable, automatic_var_23412_0, automatic_var_23412_1 COMMA_SOURCE_FILE_AT_LINE (712)) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i3_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeListeTypesEtNomsArgMethode  automatic_var_25503_0 ;
  nt_formal_5F_arguments_5F_list_ (inLexique, var_cas_ioEntitiesMap, var_cas_listeDeTypesFormels0, var_cas_tableArgumentsMethode0, automatic_var_25503_0, var_cas_tableEnAvant, var_cas_signatureForGrammar) ;
  GGS_lstring  var_cas_emptyId = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
  var_cas_parametersMap.modifier_insertKey (inLexique, var_cas_emptyId, var_cas_listeDeTypesFormels0 COMMA_SOURCE_FILE_AT_LINE (774)) ;
  var_cas_parametersMapForGrammar.modifier_insertKey (inLexique, var_cas_emptyId, var_cas_signatureForGrammar COMMA_SOURCE_FILE_AT_LINE (775)) ;
        ...
        case 2 : {
          ...
          switch (select_parser_5F_parser_4 (inLexique)) {
            case 1 : {
              ...
              var_cas_parametersMap.modifier_insertKey (inLexique, var_cas_altName, GGS_L_EXsignature ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (786)) ;
              var_cas_parametersMapForGrammar.modifier_insertKey (inLexique, var_cas_altName, var_cas_signatureForGrammarComponent COMMA_SOURCE_FILE_AT_LINE (787)) ;
              } break ;
            case 2 : {
              ...
              var_cas_parametersMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_listeDeTypesFormels COMMA_SOURCE_FILE_AT_LINE (806)) ;
              var_cas_parametersMapForGrammar.modifier_insertKey (inLexique, var_cas_altName, var_cas_signatureForGrammarComponent COMMA_SOURCE_FILE_AT_LINE (807)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_ruleName, var_cas_ioNonTerminalSymbolsMap.reader_count (), var_cas_parametersMapForGrammar COMMA_SOURCE_FILE_AT_LINE (813)) ;
  var_cas_ioNonTerminalSymbolMapForSyntax.modifier_insertKey (inLexique, var_cas_ruleName, var_cas_parametersMap COMMA_SOURCE_FILE_AT_LINE (814)) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i3_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_nonterminalSymbolParametersMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_signature0 COMMA_SOURCE_FILE_AT_LINE (830)) ;
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
      switch (select_parser_5F_parser_3 (inLexique)) {
        case 2 : {
          ...
          switch (select_parser_5F_parser_4 (inLexique)) {
            case 1 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("parse"), GGS_location (inLexique) COMMA_HERE), GGS_signatureForGrammarAnalysis ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (839)) ;
              } break ;
            case 2 : {
              inLexique.assignFromAttribute_tokenString (var_cas_altName) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
              ...
              var_cas_nonterminalSymbolParametersMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_signature COMMA_SOURCE_FILE_AT_LINE (847)) ;
              } break ;
            default :
              break ;
          }
  ...
  var_cas_ioNonTerminalSymbolsMap.modifier_insertKey (inLexique, var_cas_nonterminalSymbolName, var_cas_ioNonTerminalSymbolsMap.reader_count (), var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (853)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_nonTerminalSymbolForSyntax  temp_29871 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_29871.isBuilt ()) {
    temp_29871 (HERE)->method_searchKey (inLexique, var_cas_ruleName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (892)) ;
  }
  ...
  switch (select_parser_5F_parser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
      var_cas_productionTagName = var_cas_tagName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (907)) ;
      } break ;
    default :
      break ;
  }
  ...
  const GGS_M_nonterminalSymbolAlts  temp_30765 = var_cas_nonterminalSymbolAltMap ;
  if (temp_30765.isBuilt ()) {
    temp_30765 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (913)) ;
  }
  ::routine_verifierCompatibiliteSignatures (inLexique,  var_cas_signaturePremiereBrancheFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_firstBranchErrorLocation COMMA_SOURCE_FILE_AT_LINE (917)) ;
  ...
  var_cas_altProductionsMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_listeInstructions, var_cas_syntaxSignature, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (940)) ;
    ...
    while (syntaxRepeat_6) {
      switch (select_parser_5F_parser_6 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_nonterminalSymbolAlts  temp_32252 = var_cas_nonterminalSymbolAltMap ;
          if (temp_32252.isBuilt ()) {
            temp_32252 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureFournieParPrototype COMMA_SOURCE_FILE_AT_LINE (964)) ;
          }
          ::routine_verifierCompatibiliteSignatures (inLexique,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation COMMA_SOURCE_FILE_AT_LINE (965)) ;
          ...
          var_cas_altProductionsMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_listeTypeEtNomsArguments, var_cas_branchInstructionList, var_cas_branchSyntaxSignature, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (986)) ;
          } break ;
        default :
  ...
  if (var_cas_altProductionsMap.isBuilt ()) {
    ::routine_checkLabelSignatures (inLexique,  var_cas_altProductionsMap COMMA_SOURCE_FILE_AT_LINE (998)) ;
  }
  {
    GGS_M_nonterminalSymbolAlts::cEnumerator enumerator_33349 (var_cas_nonterminalSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAlts::cElement * operand_33349 = NULL ;
    while (((operand_33349 = enumerator_33349.nextObject ()))) {
      macroValidPointer (operand_33349) ;
      const GGS_bool cond_33534 = ((operand_33349->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1001))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (operand_33349->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)))).operator_not ()) ;
      if (cond_33534.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_33349->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1002)))).operator_concat (GGS_string ("' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1003)) ;
      }
    }
  }
  GGS_typeEntityToGenerate  var_cas_ea = GGS_typeProductionAengendrer ::constructor_new (inLexique, var_cas_ruleName, var_cas_altProductionsMap, var_cas_productionTagName, var_cas_inLexiqueClassName, var_cas_hasParseLabel, var_cas_ioProductionIndex COMMA_HERE) ;
  var_cas_listeEntitesAengendrer.addAssign_operation (var_cas_ea) ;
  ...
  var_cas_ioProductionIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1023)) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_declaration_i4_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_ioProductionIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1057)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_rule) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instructions_5F_list_i5_ (C_Lexique_galgas_5F_scanner & inLexique,
                                ...
                                const GGS_bool var_cas_inIsInvokedWithinParseLoopInstruction,
                                const GGS_EXsemanticContext var_cas_inSemanticContext) {
  var_cas_ioVariablesMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)) ;
  nt_syntax_5F_instructions_5F_list_5F_no_5F_verif_ (inLexique, var_cas_inLexiqueClassName, var_cas_ioNonTerminalSymbolMapForSyntax, var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel, var_cas_ioEntitiesMap, var_cas_listeEntitesAengendrer, var_cas_inOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_ioInstructionList, var_cas_tableTerminaux, var_cas_ioSyntaxSignature, var_cas_inIsInvokedWithinParseLoopInstruction, var_cas_inSemanticContext) ;
  GGS_location  var_cas_positionErreur = GGS_location (inLexique) ;
  var_cas_ioVariablesMap.epilogue_verifyVariableUsing (inLexique, var_cas_positionErreur COMMA_SOURCE_FILE_AT_LINE (1081)) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_terminalSymbolsMapForUse  temp_37632 = var_cas_tableTerminaux ;
  if (temp_37632.isBuilt ()) {
    temp_37632 (HERE)->method_searchKey (inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (1124)) ;
  }
  ...
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_i = GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)), var_cas_terminalSymbolName, var_cas_terminalSymbolIndex COMMA_HERE) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i6_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_instruction = GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_terminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1151)), var_cas_terminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonTerminalSymbolForSyntax  temp_40010 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (temp_40010.isBuilt ()) {
    temp_40010 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1189)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  const GGS_M_nonterminalSymbolAlts  temp_40134 = var_cas_nonterminalSymbolAltMap ;
  if (temp_40134.isBuilt ()) {
    temp_40134 (HERE)->method_searchKey (inLexique, var_cas_altName, var_cas_signatureMethode COMMA_SOURCE_FILE_AT_LINE (1191)) ;
  }
  const GGS_bool cond_40496 = (var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1193))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_40496.isBuiltAndTrue ()) {
    const GGS_bool cond_40485 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_40485.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") COMMA_SOURCE_FILE_AT_LINE (1196)) ;
    }
  }
  const GGS_bool cond_40790 = (var_cas_inIsInvokedWithinParseLoopInstruction).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1198))).operator_isNotEqual (GGS_string ("parse"))) ;
  if (cond_40790.isBuiltAndTrue ()) {
    const GGS_bool cond_40779 = (var_cas_nonterminalSymbolAltMap.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_40779.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("As this nonterminal is invoked within a 'parse loop ...' instruction, it must be declared with 'parse' label") COMMA_SOURCE_FILE_AT_LINE (1201)) ;
    }
  }
  ...
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_i = GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1223)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioSyntaxSignature.addAssign_operation (var_cas_i) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i7_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_actual_5F_parameters_5F_list_parse (inLexique) ;
  GGS_abstractSyntaxInstructionForGrammarAnalysis  var_cas_instruction = GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, var_cas_nonterminalSymbolName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1242)), var_cas_nonterminalSymbolName, GGS_uint (0U) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_instruction) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
}
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_ioVariablesMap.prologue_testBloc (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)) ;
  var_cas_ioVariablesMap.prologue_testPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1273)) ;
  ...
  var_cas_ioVariablesMap.epilogue_testPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1273)) ;
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        var_cas_ioVariablesMap.prologue_testPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1295)) ;
        ...
        var_cas_ioVariablesMap.epilogue_testPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_testBloc (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_ioVariablesMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1371)) ;
  ...
  var_cas_ioVariablesMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1374)) ;
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1374)) ;
  ...
  { bool syntaxRepeat_9 = true ;
    while (syntaxRepeat_9) {
        var_cas_ioVariablesMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1394)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1394)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_repeat) COMMA_HERE) ;
  var_cas_ioVariablesMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1371)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
...
void parser_parser::rule_parser_5F_parser_syntax_5F_instruction_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_parser_5F_parser_10 (inLexique)) {
    case 1 : {
      ...
      GGS_typeGalgas_uint  var_cas_ui = GGS_typeGalgas_uint::castFrom (inLexique, var_cas_variantResultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1482)) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_while) COMMA_HERE) ;
      ...
      GGS_typeGalgas_bool  var_cas_b = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_resultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1495)) ;
      ...
      GGS_syntaxInstructionListForGrammarAnalysis  var_cas_syntaxSignature = GGS_syntaxInstructionListForGrammarAnalysis ::constructor_emptyList () ;
      var_cas_ioVariablesMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1500)) ;
      var_cas_ioVariablesMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1501)) ;
      ...
      var_cas_ioVariablesMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1501)) ;
      var_cas_ioVariablesMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (1500)) ;
    ...
    case 2 : {
      ...
      {
        GGS_syntaxInstructionListForGrammarAnalysis::cEnumerator enumerator_53454 (var_cas_firstBranchSyntaxSignature, true) ;
        const GGS_syntaxInstructionListForGrammarAnalysis::cElement * operand_53454 = NULL ;
        while (((operand_53454 = enumerator_53454.nextObject ()))) {
          macroValidPointer (operand_53454) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_53454->mInstruction) ;
        }
      }
      ...
      if (var_cas_parse_rewind_signature_list.isBuilt ()) {
        ::routine_checkParseRewindSignatures (inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (1578)) ;
      }
      } break ;
    case 3 : {
      GGS_L_parse_rewind_signature_list  var_cas_parse_rewind_signature_list = GGS_L_parse_rewind_signature_list ::constructor_emptyList () ;
      GGS_L_expression_instructionsList_list  var_cas_branchList = GGS_L_expression_instructionsList_list ::constructor_emptyList () ;
      var_cas_ioVariablesMap.prologue_testBloc (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)) ;
      { bool syntaxRepeat_12 = true ;
        while (syntaxRepeat_12) {
            var_cas_ioVariablesMap.prologue_testPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1586)) ;
            ...
            var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1586)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (inLexique COMMA_SOURCE_FILE_AT_LINE (1622)) ;
      GGS_location  var_cas_branchStartLocation = GGS_location (inLexique) ;
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_syntaxInstructionListForGrammarAnalysis::cEnumerator enumerator_56934 (var_cas_syntaxSignature, true) ;
        const GGS_syntaxInstructionListForGrammarAnalysis::cElement * operand_56934 = NULL ;
        while (((operand_56934 = enumerator_56934.nextObject ()))) {
          macroValidPointer (operand_56934) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_56934->mInstruction) ;
        }
      }
      var_cas_ioVariablesMap.epilogue_testPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1622)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)) ;
      ...
      if (var_cas_parse_rewind_signature_list.isBuilt ()) {
        ::routine_checkParseRewindSignatures (inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (1648)) ;
      }
      } break ;
    default :
      break ;
