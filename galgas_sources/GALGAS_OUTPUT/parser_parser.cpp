...
pr_syntax_declaration_parser_parser_1089_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_operatorAttributes.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1161)))._operator_isEqual (GGS_string (true, "multiple prefix"))).isBuiltAndTrue ()) {
    ...
    var_cas_operatorAttributes.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Valid operator attributes are:\n"
      ...
      "  - \"left infix\" ;\n"
      "  - \"right infix\" ;\n"
      "  - \"infix\".") COMMA_SOURCE_FILE_AT_LINE (1448)) ;
...
pr_syntax_declaration_parser_parser_1089_6_importSyntax (galgas_scanner & _inLexique,
  ...
  if (((var_cas_operatorAttributes.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1510)))._operator_isEqual (GGS_string (true, "multiple prefix"))).isBuiltAndTrue ()) {
    ...
    var_cas_operatorAttributes.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Valid operator attributes are:\n"
      ...
      "  - \"left infix\" ;\n"
      "  - \"right infix\" ;\n"
      "  - \"infix\".") COMMA_SOURCE_FILE_AT_LINE (1618)) ;
    var_cas_leftNonTerminalName._drop_operation () ;
  }
  var_cas_ioProductionRulesListForGrammar._addAssign_operation (var_cas_leftNonTerminalName, GGS_uint (true, 0U), var_cas_syntaxSignature) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_1630_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
  ...
  switch (select_parser_parser_3 (_inLexique)) {
    case 1 : {
      ...
      if (((var_cas_levelCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1652)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_levelCount.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the level count should be > 0") COMMA_SOURCE_FILE_AT_LINE (1654)) ;
      }
      ...
      while (_condition_59783.isBuiltAndTrue ()) {
        ::routine_implicitDeclaration (_inLexique,  var_cas_ruleName,  var_cas_i,  var_cas_returnedEntity,  var_cas_inLexiqueClassName,  var_cas_ioNonTerminalSymbolMapForSyntax,  var_cas_ioNonTerminalSymbolsMap,  var_cas_listeEntitesAengendrer,  var_cas_ioProductionRulesListForGrammar COMMA_SOURCE_FILE_AT_LINE (1665)) ;
        ...
        if (_condition_59783.isBuiltAndTrue ()) {
          if (_variant_59783.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1677)) ;
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_1630_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolsForGrammar  &var_cas_ioNonTerminalSymbolsMap,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_nonterminal) COMMA_HERE) ;
  ...
  switch (select_parser_parser_3 (_inLexique)) {
    case 1 : {
      ...
      while (_condition_65002.isBuiltAndTrue ()) {
        ::routine_implicitDeclarationImportSyntax (_inLexique,  var_cas_nonterminalSymbolName,  var_cas_i,  var_cas_returnedEntity,  var_cas_ioNonTerminalSymbolsMap,  var_cas_ioProductionRulesListForGrammar COMMA_SOURCE_FILE_AT_LINE (1810)) ;
        ...
        if (_condition_65002.isBuiltAndTrue ()) {
          if (_variant_65002.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1819)) ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_1630_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_nonterminal) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  switch (select_parser_parser_3 (_inLexique)) {
    case 1 : {
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_1892_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signaturePremiereBrancheFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_firstBranchErrorLocation COMMA_SOURCE_FILE_AT_LINE (1965)) ;
  if ((((var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1970)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1970)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    var_cas_returnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal declaration does not name any returned entity") COMMA_SOURCE_FILE_AT_LINE (1972)) ;
    ...
    if (((var_cas_superEntityMap.reader_hasKey (_inLexique, var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1975)) COMMA_SOURCE_FILE_AT_LINE (1975)))._operator_not ()).isBuiltAndTrue ()) {
      var_cas_returnedEntity.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1977))))._operator_concat (GGS_string (true, "' entity or one of its inherited entities is expected here")) COMMA_SOURCE_FILE_AT_LINE (1978)) ;
    }
  }
  GGS_typeInstructionList  var_cas_listeInstructions ;
  var_cas_listeInstructions = GGS_typeInstructionList::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_13 (_inLexique)) {
        case 2 : {
          ...
          ::routine_verifierCompatibiliteSignatures (_inLexique,  var_cas_signatureFournieParPrototype,  var_cas_listeDeTypesFormels,  var_cas_errorLocation COMMA_SOURCE_FILE_AT_LINE (2088)) ;
  ...
  if (var_cas_altProductionsMap._isBuilt ()) {
    ::routine_checkLabelSignatures (_inLexique,  var_cas_altProductionsMap COMMA_SOURCE_FILE_AT_LINE (2123)) ;
  }
  ...
  while ((operand_76660 != NULL)) {
    ...
    if ((((operand_76660->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2127)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_76660->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2127)) COMMA_SOURCE_FILE_AT_LINE (2127)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_76660->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2128))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (2129)) ;
    }
...
void parser_parser::
parser_parser::
pr_syntax_declaration_parser_parser_1892_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_nonTerminalSymbolsForGrammar  &/* var_cas_ioNonTerminalSymbolsMap */,
                                GGS_L_productionRules_ForGrammarComponent  &var_cas_ioProductionRulesListForGrammar) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
...
void parser_parser::
pr_syntax_declaration_parser_parser_1892_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  nt_formal_arguments_list_parse (_inLexique) ;
  switch (select_parser_parser_10 (_inLexique)) {
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_2203_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_2203_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  nt_syntax_instructions_list_no_verif_importSyntax (_inLexique, var_cas_ioInstructionList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_2203_6_parse (galgas_scanner & _inLexique) {
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2300_6_ (galgas_scanner & _inLexique,
                                const GGS_string /* var_cas_inLexiqueClassName */,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  if (((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel)._operator_and ((var_cas_altName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2331)))._operator_isNotEqual (GGS_string (true, "parse")))).isBuiltAndTrue ()) {
    if (((var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") COMMA_SOURCE_FILE_AT_LINE (2332)))._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "As current rule has 'parse' label, every invoked non terminal symbol must be declared with 'parse' label") COMMA_SOURCE_FILE_AT_LINE (2334)) ;
    }
  }
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2361)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2361)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the non terminal symbol is declared with no returned entity") COMMA_SOURCE_FILE_AT_LINE (2363)) ;
      ...
      while (_condition_86669.isBuiltAndTrue ()) {
        ...
        if (_condition_86669.isBuiltAndTrue ()) {
          if (_variant_86669.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2388)) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2300_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  GGS_lstring  var_cas_nonterminalSymbolName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_nonterminalSymbolName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_2300_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_non_5Fterminal_5Fsymbol) COMMA_HERE) ;
  switch (select_parser_parser_15 (_inLexique)) {
    case 1 : {
      } break ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2446_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2446_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_2446_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_or) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2551_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2551_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (_inLexique) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_2551_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_repeat) COMMA_HERE) ;
  nt_syntax_instructions_list_no_verif_parse (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2658_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  if (var_cas_parse_rewind_signature_list._isBuilt ()) {
    ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (2799)) ;
  }
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2658_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_19 (_inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_2658_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_19 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2831_6_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2831_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_22 (_inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2831_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_22 (_inLexique)) {
        case 2 : {
