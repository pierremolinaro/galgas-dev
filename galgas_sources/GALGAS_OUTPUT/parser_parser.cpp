...
pr_galgas_component_parser_parser_254_24_ (galgas_scanner & lexique_var_,
  ...
  GGS_typeTableNomRoutinesDeclarees::element_type * operand_12606 = var_cas_tableNomRoutinesDeclarees.firstObject () ;
  while ((operand_12606 != NULL)) {
    macroValidPointer (operand_12606) ;
    if (((! var_cas_tableRoutinesAimplementer.reader_hasKey (operand_12606->mKey.reader_value ()))).isBuiltAndTrue ()) {
        operand_12606->mKey.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the routine '")) + (operand_12606->mKey.reader_value ()))) + (GGS_string (true, "' is not implemented within the component")))) ;
    }
    operand_12606 = operand_12606->nextObject () ;
  }
...
pr_syntax_instruction_parser_parser_512_26_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  GGS_AC_galgasType  var_cas_20076 ;
  GGS_typeCplusPlusName  var_cas_20079 ;
  if (var_cas_ioVariablesMap.isBuilt ()) {
    var_cas_ioVariablesMap ()->methode_searchForReadWriteAccess (lexique_var_, var_cas_nomTable, var_cas_20076, var_cas_20079) ;
  }
...
pr_rule_declaration_or_implementation_parser_parser_765_42_ (galgas_scanner & lexique_var_,
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_30558 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_30558 != NULL)) {
    macroValidPointer (operand_30558) ;
    if (((((operand_30558->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_30558->mKey.reader_value ()))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_30558->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
    operand_30558 = operand_30558->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1244_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_parser_parser_9 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_45923 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_45923 != NULL)) {
        macroValidPointer (operand_45923) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_45923->mInstruction) ;
        operand_45923 = operand_45923->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_48698 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_48698 != NULL)) {
        macroValidPointer (operand_48698) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_48698->mInstruction) ;
        operand_48698 = operand_48698->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
