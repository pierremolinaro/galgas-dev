    ...
    case 1 : {
      ...
      switch (select_parser_parser_4 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_entityToImplementMap  _temp_60941 = var_cas_inAllMetamodelClassMap ;
          if (_temp_60941._isBuilt ()) {
            _temp_60941 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15, automatic_var_16, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1702)) ;
          }
          } break ;
        default :
          break ;
      ...
      GGS_uint _variant_61354 = var_cas_levelCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1705)) ;
      GGS_bool _condition_61354 (_variant_61354._isBuilt (), true) ;
      while (_condition_61354.isBuiltAndTrue ()) {
        ...
        _condition_61354 = (var_cas_i)._operator_infOrEqual (var_cas_levelCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1717))) ;
        if (_condition_61354.isBuiltAndTrue ()) {
          if (_variant_61354.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1717)) ;
            _condition_61354 = GGS_bool (true, false) ;
          }else{
            _variant_61354._decrement_operation (_inLexique COMMA_HERE) ;
          }
        }
      }
      GGS_L_signature  var_cas_signatureForGrammar ;
    ...
    case 2 : {
      ...
      switch (select_parser_parser_5 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_entityToImplementMap  _temp_63185 = var_cas_inAllMetamodelClassMap ;
          if (_temp_63185._isBuilt ()) {
            _temp_63185 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22, automatic_var_23, automatic_var_24, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (1762)) ;
          }
                ...
                case 2 : {
                  ...
                  switch (select_parser_parser_9 (_inLexique)) {
                    ...
                    case 2 : {
                      ...
                      const GGS_M_semanticsEntitiesForUse  _temp_64884 = var_cas_ioEntitiesMap ;
                      if (_temp_64884._isBuilt ()) {
                        _temp_64884 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1812)) ;
                      }
...
pr_syntax_declaration_parser_parser_1670_4_importSyntax (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_3 (_inLexique)) {
    case 1 : {
      ...
      GGS_uint  var_cas_i ;
      var_cas_i = GGS_uint (true, 1U) ;
      GGS_uint _variant_66573 = var_cas_levelCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1850)) ;
      GGS_bool _condition_66573 (_variant_66573._isBuilt (), true) ;
      while (_condition_66573.isBuiltAndTrue ()) {
        ...
        _condition_66573 = (var_cas_i)._operator_infOrEqual (var_cas_levelCount.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1859))) ;
        if (_condition_66573.isBuiltAndTrue ()) {
          if (_variant_66573.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1859)) ;
            _condition_66573 = GGS_bool (true, false) ;
          }else{
            _variant_66573._decrement_operation (_inLexique COMMA_HERE) ;
          }
        }
      }
...
pr_syntax_declaration_parser_parser_1933_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_10 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_entityToImplementMap  _temp_70300 = var_cas_inAllMetamodelClassMap ;
      if (_temp_70300._isBuilt ()) {
        _temp_70300 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (1971)) ;
      }
  ...
  const GGS_M_nonTerminalSymbolForSyntax  _temp_70631 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (_temp_70631._isBuilt ()) {
    _temp_70631 (HERE)->method_searchKey (_inLexique, var_cas_ruleName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (1980)) ;
  }
  GGS_typeAltProductionsMap  var_cas_altProductionsMap ;
  var_cas_altProductionsMap = GGS_typeAltProductionsMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_lstring  var_cas_altName ;
  ...
  const GGS_M_nonterminalSymbolAlts  _temp_71559 = var_cas_nonterminalSymbolAltMap ;
  if (_temp_71559._isBuilt ()) {
    _temp_71559 (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signaturePremiereBrancheFournieParPrototype, var_cas_formalReturnedEntity COMMA_SOURCE_FILE_AT_LINE (2002)) ;
  }
  ...
  if ((((var_cas_formalReturnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2012)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2012)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    const GGS_entityToImplementMap  _temp_72120 = var_cas_inAllMetamodelClassMap ;
    if (_temp_72120._isBuilt ()) {
      _temp_72120 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_34, automatic_var_35, automatic_var_36, automatic_var_37, var_cas_superEntityMap, automatic_var_38, automatic_var_39, automatic_var_40 COMMA_SOURCE_FILE_AT_LINE (2016)) ;
    }
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2025)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    const GGS_entityToImplementMap  _temp_72816 = var_cas_inAllMetamodelClassMap ;
    if (_temp_72816._isBuilt ()) {
      _temp_72816 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_41, automatic_var_42, automatic_var_43, automatic_var_44, var_cas_superEntityMap, var_cas_propertyList, automatic_var_45, automatic_var_46 COMMA_SOURCE_FILE_AT_LINE (2028)) ;
    }
    ...
    const GGS_entityToImplementMap  _temp_73503 = var_cas_inAllMetamodelClassMap ;
    if (_temp_73503._isBuilt ()) {
      _temp_73503 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, var_cas_allPropertiesMap, automatic_var_47, automatic_var_48, automatic_var_49, automatic_var_50, automatic_var_51, automatic_var_52, automatic_var_53 COMMA_SOURCE_FILE_AT_LINE (2044)) ;
    }
    {
      GGS_entityPropertyMap::cEnumerator enumerator_73566 (var_cas_allPropertiesMap, true) ;
      const GGS_entityPropertyMap::cElement * operand_73566 = NULL ;
      while (((operand_73566 = (GGS_entityPropertyMap::cElement *) enumerator_73566.nextObject ()))) {
        macroValidPointer (operand_73566) ;
        { const GGS_AC_galgasType _var_75491 = operand_73566->mInfo.mPropertyType ; // CAST instruction
          if (_var_75491.getPtr () != NULL) {
            macroValidPointer (_var_75491.getPtr ()) ;
            if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_75491.getPtr ()) != NULL) {
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_73566->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2048)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2048)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              ...
              var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_73566->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (2050)) ;
              GGS_typeInstruction  var_cas_instruction ;
              var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_73566->mInfo.mPropertyType COMMA_HERE) ;
              var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
            }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_75491.getPtr ()) != NULL) {
              const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_75491.getPtr ()) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_73566->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2054)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2054)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              ...
              var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_73566->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (2056)) ;
              ...
              GGS_typeInstruction  var_cas_instruction ;
              var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_73566->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
              var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
            }else{
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_73566->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2069)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2069)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              ...
              var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_73566->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (2071)) ;
              GGS_typeInstruction  var_cas_instruction ;
              var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_73566->mInfo.mPropertyType COMMA_HERE) ;
              var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
            }
        ...
        case 2 : {
          ...
          switch (select_parser_parser_14 (_inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_entityToImplementMap  _temp_76855 = var_cas_inAllMetamodelClassMap ;
              if (_temp_76855._isBuilt ()) {
                _temp_76855 (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_54, automatic_var_55, automatic_var_56, automatic_var_57, automatic_var_58, automatic_var_59, automatic_var_60, automatic_var_61 COMMA_SOURCE_FILE_AT_LINE (2125)) ;
              }
              } break ;
            default :
              break ;
          ...
          const GGS_M_nonterminalSymbolAlts  _temp_77075 = var_cas_nonterminalSymbolAltMap ;
          if (_temp_77075._isBuilt ()) {
            _temp_77075 (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureFournieParPrototype, var_cas_returnedEntityFromPrototype COMMA_SOURCE_FILE_AT_LINE (2131)) ;
          }
  ...
  {
    GGS_M_nonterminalSymbolAlts::cEnumerator enumerator_78339 (var_cas_nonterminalSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAlts::cElement * operand_78339 = NULL ;
    while (((operand_78339 = (GGS_M_nonterminalSymbolAlts::cElement *) enumerator_78339.nextObject ()))) {
      macroValidPointer (operand_78339) ;
      if ((((operand_78339->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2173)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_78339->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2173)) COMMA_SOURCE_FILE_AT_LINE (2173)))._operator_not ())).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_78339->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2174))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (2174)) ;
      }
    }
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_2294_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_M_terminalSymbolsMapForUse  _temp_83115 = var_cas_tableTerminaux ;
  if (_temp_83115._isBuilt ()) {
    _temp_83115 (HERE)->method_searchKey (_inLexique, var_cas_terminalSymbolName, var_cas_listeDesAttributsFormels COMMA_SOURCE_FILE_AT_LINE (2313)) ;
  }
...
pr_syntax_instruction_parser_parser_2352_4_ (galgas_scanner & _inLexique,
  ...
  GGS_M_nonterminalSymbolAlts  var_cas_nonterminalSymbolAltMap ;
  const GGS_M_nonTerminalSymbolForSyntax  _temp_85559 = var_cas_ioNonTerminalSymbolMapForSyntax ;
  if (_temp_85559._isBuilt ()) {
    _temp_85559 (HERE)->method_searchKey (_inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (2380)) ;
  }
  GGS_L_EXsignature  var_cas_signatureMethode ;
  GGS_lstring  var_cas_returnedEntityFromSignature ;
  const GGS_M_nonterminalSymbolAlts  _temp_85724 = var_cas_nonterminalSymbolAltMap ;
  if (_temp_85724._isBuilt ()) {
    _temp_85724 (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_signatureMethode, var_cas_returnedEntityFromSignature COMMA_SOURCE_FILE_AT_LINE (2383)) ;
  }
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2421)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2421)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_89011 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (2442)) ;
      GGS_bool _condition_89011 (_variant_89011._isBuilt (), true) ;
      while (_condition_89011.isBuiltAndTrue ()) {
        _condition_89011 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2443)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_89011.isBuiltAndTrue ()) {
          if (_variant_89011.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2447)) ;
            _condition_89011 = GGS_bool (true, false) ;
          }else{
            _variant_89011._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            const GGS_entityToImplementMap  _temp_88859 = var_cas_inAllMetamodelClassMap ;
            if (_temp_88859._isBuilt ()) {
              _temp_88859 (HERE)->method_searchKey (_inLexique, var_cas_testedClass, automatic_var_64, automatic_var_65, automatic_var_66, var_cas_superEntity, automatic_var_67, automatic_var_68, automatic_var_69, automatic_var_70 COMMA_SOURCE_FILE_AT_LINE (2445)) ;
            }
...
pr_syntax_instruction_parser_parser_2617_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2640)) ;
  ...
  { bool syntaxRepeat_18 = true ;
    while (syntaxRepeat_18) {
        var_cas_ioVariablesMap.prologue_repeatPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (2662)) ;
        ...
        var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2662)) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2729_4_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
  ...
  switch (select_parser_parser_19 (_inLexique)) {
    case 1 : {
      ...
      var_cas_ui = GGS_typeGalgas_uint::_castFrom (_inLexique, var_cas_variantResultType.getPtr (), true, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2760)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_while) COMMA_HERE) ;
      ...
      var_cas_b = GGS_typeGalgas_bool::_castFrom (_inLexique, var_cas_resultType.getPtr (), true, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2773)) ;
      ...
      GGS_L_ruleSyntaxSignature  var_cas_syntaxSignature ;
      var_cas_syntaxSignature = GGS_L_ruleSyntaxSignature::constructor_emptyList (_inLexique COMMA_HERE) ;
      var_cas_ioVariablesMap.prologue_repeatBlock (_inLexique COMMA_SOURCE_FILE_AT_LINE (2778)) ;
      var_cas_ioVariablesMap.prologue_repeatPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (2779)) ;
      ...
      var_cas_ioVariablesMap.epilogue_repeatPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2779)) ;
      var_cas_ioVariablesMap.epilogue_repeatBlock (_inLexique COMMA_SOURCE_FILE_AT_LINE (2778)) ;
    ...
    case 2 : {
      ...
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_102483 (var_cas_firstBranchSyntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_102483 = NULL ;
        while (((operand_102483 = (GGS_L_ruleSyntaxSignature::cElement *) enumerator_102483.nextObject ()))) {
          macroValidPointer (operand_102483) ;
          var_cas_ioSyntaxSignature._addAssign_operation (operand_102483->mInstruction) ;
        }
      }
      ...
      if (var_cas_parse_rewind_signature_list._isBuilt ()) {
        ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (2860)) ;
      }
      } break ;
    case 3 : {
      GGS_L_parse_rewind_signature_list  var_cas_parse_rewind_signature_list ;
      ...
      { bool syntaxRepeat_21 = true ;
        while (syntaxRepeat_21) {
            var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (2870)) ;
            ...
            var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
            var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2870)) ;
      ...
      var_cas_ioVariablesMap.prologue_testPart (_inLexique COMMA_SOURCE_FILE_AT_LINE (2908)) ;
      GGS_location  var_cas_branchStartLocation ;
      var_cas_branchStartLocation = GGS_location (_inLexique) ;
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_106181 (var_cas_syntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_106181 = NULL ;
        while (((operand_106181 = (GGS_L_ruleSyntaxSignature::cElement *) enumerator_106181.nextObject ()))) {
          macroValidPointer (operand_106181) ;
          var_cas_ioSyntaxSignature._addAssign_operation (operand_106181->mInstruction) ;
        }
      }
      var_cas_ioVariablesMap.epilogue_testPart (_inLexique, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (2908)) ;
      ...
      if (var_cas_parse_rewind_signature_list._isBuilt ()) {
        ::routine_checkParseRewindSignatures (_inLexique,  var_cas_parse_rewind_signature_list COMMA_SOURCE_FILE_AT_LINE (2934)) ;
      }
      } break ;
    default :
      break ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_2729_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_19 (_inLexique)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_2729_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  switch (select_parser_parser_19 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_loop) COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2980_4_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inLexiqueClassName,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2980_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionList) {
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
      switch (select_repeat_parser_parser_22 (_inLexique)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_2980_4_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
      switch (select_repeat_parser_parser_22 (_inLexique)) {
        case 2 : {
