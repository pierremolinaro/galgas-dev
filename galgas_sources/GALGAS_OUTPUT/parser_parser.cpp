...
pr_syntax_declaration_parser_parser_832_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (921))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_32461 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_32461 != NULL)) {
      macroValidPointer (operand_32461) ;
      if (operand_32461->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelAttributeProperty * operand_32545 = dynamic_cast <cPtr_metamodelAttributeProperty *> (operand_32461->mInfo.mProperty.getPtr ()) ;
        if (operand_32545 != NULL) {
          macroValidPointer (operand_32545) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32461->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (933)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (933)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
          var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_32545->mAttributeType, var_cas_nomCppVariable SOURCE_FILE_AT_LINE (935)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_32545->mAttributeType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_metamodelSingleReferenceProperty * operand_33045 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_32461->mInfo.mProperty.getPtr ()) ;
          if (operand_33045 != NULL) {
            macroValidPointer (operand_33045) ; 
            GGS_AC_galgasType  var_cas_definitionType ;
            var_cas_definitionType = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_33045->mReferenceEntityName COMMA_HERE) ;
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32461->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (940)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (940)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
            ...
            cPtr_metamodelMultipleReferenceProperty * operand_33671 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_32461->mInfo.mProperty.getPtr ()) ;
            if (operand_33671 != NULL) {
              macroValidPointer (operand_33671) ; 
              GGS_AC_galgasType  var_cas_definitionType ;
              var_cas_definitionType = GGS_typeGalgas_multipleEntity::constructor_new (_inLexique, operand_33671->mReferenceEntityName COMMA_HERE) ;
              GGS_lstring  var_cas_nomVariable ;
              var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_32461->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (947)), var_cas_returnedEntity.reader_location (_inLexique SOURCE_FILE_AT_LINE (947)) COMMA_HERE) ;
              GGS_typeCplusPlusName  var_cas_nomCppVariable ;
              var_cas_nomCppVariable = GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_nomVariable COMMA_HERE) ;
      ...
      operand_32461 = operand_32461->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_36993 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_36993 != NULL)) {
    macroValidPointer (operand_36993) ;
    if (((((operand_36993->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1045))) != (GGS_string (true, "parse"))) & ((! (var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_36993->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1045)) SOURCE_FILE_AT_LINE (1045))))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_36993->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1046))))) + (GGS_string (true, "' label is not implemented within the rule"))) SOURCE_FILE_AT_LINE (1047)) ;
    }
    operand_36993 = operand_36993->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1205_6_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1264))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1264))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if (((! (var_cas_ok))).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_46401 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1283)) ;
      GGS_bool _condition_46401 (_variant_46401._isBuilt (), true) ;
      while (_condition_46401.isBuiltAndTrue ()) {
        _condition_46401 = (((! (var_cas_ok))) & ((var_cas_testedClass.ggs_string ().reader_length (_inLexique SOURCE_FILE_AT_LINE (1284))) > (GGS_uint (true, 0U)))) ;
        if (_condition_46401.isBuiltAndTrue ()) {
          if (_variant_46401.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (1289)) ;
            _condition_46401 = GGS_bool (true, false) ;
          }else{
            _variant_46401._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1547_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57130 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57130 != NULL)) {
        macroValidPointer (operand_57130) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_57130->mInstruction) ;
        operand_57130 = operand_57130->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_60154 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_60154 != NULL)) {
        macroValidPointer (operand_60154) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_60154->mInstruction) ;
        operand_60154 = operand_60154->nextObject () ;
      }
