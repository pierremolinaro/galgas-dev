...
pr_galgas_component_parser_parser_262_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_13565 != NULL)) {
    ...
    if (((var_cas_tableRoutinesAimplementer.reader_hasKey (_inLexique, operand_13565->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)))._operator_not ()).isBuiltAndTrue ()) {
      operand_13565->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the routine '"))._operator_concat (operand_13565->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (true, "' is not implemented within the component")) COMMA_SOURCE_FILE_AT_LINE (357)) ;
    }
...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (967)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    while ((operand_33901 != NULL)) {
      ...
      if (operand_33901->mInfo.mPropertyType._isBuilt ()) {
        ...
        if (operand_33989 != NULL) {
          ...
          if (operand_34551 != NULL) {
            ...
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, (operand_34551->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (982)))._operator_concat (GGS_string (true, "List")), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
  ...
  while ((operand_38591 != NULL)) {
    ...
    if ((((operand_38591->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38591->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)) COMMA_SOURCE_FILE_AT_LINE (1093)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_38591->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1094))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    }
...
pr_syntax_instruction_parser_parser_1264_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel)._operator_and ((var_cas_altName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1295)))._operator_isNotEqual (GGS_string (true, "parse")))).isBuiltAndTrue ()) {
    if (((var_cas_nonterminalSymbolAltMap.reader_hasKey (_inLexique, GGS_string (true, "parse") COMMA_SOURCE_FILE_AT_LINE (1296)))._operator_not ()).isBuiltAndTrue ()) {
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1325)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1325)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
  ...
  }else if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1327)))._operator_isNotEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1327)))._operator_isEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the non terminal symbol is declared to return an instance of '@"))._operator_concat (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1328))))._operator_concat (GGS_string (true, "' entity")) COMMA_SOURCE_FILE_AT_LINE (1329)) ;
  }else if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1329)))._operator_isNotEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1329)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1341)))._operator_isEqual (var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1341))) ;
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_bool _condition_48419 (_variant_48419._isBuilt (), true) ;
      while (_condition_48419.isBuiltAndTrue ()) {
        _condition_48419 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1345)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_48419.isBuiltAndTrue ()) {
          if (_variant_48419.uintValue () == 0) {
            ...
            var_cas_ok = (var_cas_testedClass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1349)))._operator_isEqual (var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1349))) ;
          }
        }
      }
    }
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_returnedEntityVariableName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the type of this variable is '%"))._operator_concat (var_cas_variableEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1353))))._operator_concat (GGS_string (true, "' and is not a super class of '%")))._operator_concat (var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1354))))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (1355)) ;
    }
  }
  GGS_typeInstruction  var_cas_instruction ;
