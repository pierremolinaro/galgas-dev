...
pr_rule_declaration_or_implementation_parser_parser_907_42_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_formalReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (955))) == (GGS_string (true, ""))) & ((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (955))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_inEffectiveReturnedEntity, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, var_cas_superEntityStringSet, automatic_var_15, automatic_var_16 SOURCE_FILE_AT_LINE (959)) ;
    }
  ...
  if (((var_cas_inEffectiveReturnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (968))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
      var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_inEffectiveReturnedEntity, var_cas_allPropertiesMap, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22, automatic_var_23 SOURCE_FILE_AT_LINE (969)) ;
    }
        ...
        case 2 : {
          ...
          switch (select_parser_parser_8 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (var_cas_inAllMetamodelClassMap._isBuilt ()) {
                var_cas_inAllMetamodelClassMap (HERE)->method_searchKey (_inLexique, var_cas_returnedEntity, automatic_var_24, automatic_var_25, automatic_var_26, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31 SOURCE_FILE_AT_LINE (1045)) ;
              }
              } break ;
            default :
              break ;
...
pr_syntax_instruction_parser_parser_1233_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_string (_inLexique SOURCE_FILE_AT_LINE (1293))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1293))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      ...
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_32 SOURCE_FILE_AT_LINE (1301)) ;
      ...
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, automatic_var_33 SOURCE_FILE_AT_LINE (1306)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1, "" COMMA_HERE) ;
