...
pr_syntax_declaration_parser_parser_1508_25_ (galgas_scanner & inLexique,
  ...
  }
  {
    ...
    while (((operand_58143 = enumerator_58143.nextObject ()))) {
      ...
      if ((((operand_58143->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1647))).operator_isNotEqual (GGS_string ("parse"))).operator_and ((var_cas_altProductionsMap.reader_hasKey (inLexique, operand_58143->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_SOURCE_FILE_AT_LINE (1647))).operator_not ())).isBuiltAndTrue ()) {
...
pr_syntax_instruction_parser_parser_1803_25_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1833))).operator_isNotEqual (GGS_string ("parse")))).isBuiltAndTrue ()) {
    if (((var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1834))).operator_not ()).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inIsInvokedWithinParseLoopInstruction).operator_and ((var_cas_altName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1838))).operator_isNotEqual (GGS_string ("parse")))).isBuiltAndTrue ()) {
    if (((var_cas_nonterminalSymbolAltMap.reader_hasKey (inLexique, GGS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (1839))).operator_not ()).isBuiltAndTrue ()) {
...
pr_syntax_instruction_parser_parser_2105_25_ (galgas_scanner & inLexique,
  ...
  switch (select_parser_parser_11 (inLexique)) {
    ...
    case 3 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      {
        GGS_L_ruleSyntaxSignature::cEnumerator enumerator_81323 (var_cas_syntaxSignature, true) ;
        const GGS_L_ruleSyntaxSignature::cElement * operand_81323 = NULL ;
        while (((operand_81323 = enumerator_81323.nextObject ()))) {
          macroValidPointer (operand_81323) ;
          var_cas_ioSyntaxSignature.addAssign_operation (operand_81323->mInstruction) ;
        }
      }
