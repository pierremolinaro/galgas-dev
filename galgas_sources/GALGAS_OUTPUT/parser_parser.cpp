...
pr_rule_declaration_or_implementation_parser_parser_879_42_ (galgas_scanner & lexique_var_,
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_36989 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_36989 != NULL)) {
    macroValidPointer (operand_36989) ;
    if (((((operand_36989->mKey.reader_value ()) != (GGS_string (true, "parse"))) && ((! var_cas_altProductionsMap.reader_hasKey (operand_36989->mKey.reader_value ()))))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (operand_36989->mKey.reader_value ()))) + (GGS_string (true, "' label is not implemented within the rule")))) ;
    }
    operand_36989 = operand_36989->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1118_32_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_parser_parser_1118_32_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  nt_syntax_instructions_list_no_verif_importSyntax (lexique_var_, var_cas_ioInstructionsList) ;
}
...
void parser_parser::
pr_syntax_instructions_list_parser_parser_1118_32_parse (galgas_scanner & lexique_var_) {
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1153_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &/* var_cas_ioNonTerminalSymbolMapForSyntax */,
                                GGS_bool /* var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel */,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1153_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  GGS_lstring  var_cas_terminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  var_cas_terminalSymbolName.defineAttribute (lexique_var_.tokenString, lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1153_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_terminal) ;
  nt_input_parameters_list_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
}
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1200_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &/* var_cas_listeEntitesAengendrer */,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value ()) == (GGS_string (true, ""))) && ((var_cas_returnedEntityVariableName.reader_value ()) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_45009 ;
      var_cas_ioVariablesMap.methode_searchForReadWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_45009) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_45272 ;
      var_cas_ioVariablesMap.methode_searchForWriteAccess (lexique_var_, var_cas_returnedEntityVariableName, var_cas_type, var_cas_45272) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1200_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  GGS_lstring  var_cas_nonterminalSymbolName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1200_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3C) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__3E) ;
  switch (select_parser_parser_9 (lexique_var_)) {
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1328_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1328_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1328_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_select) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1402_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1402_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  GGS_location  var_cas_positionDebut ;
  var_cas_positionDebut = GGS_location (lexique_var_) ;
...
void parser_parser::
pr_syntax_instruction_parser_parser_1402_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_repeat) ;
  nt_syntax_instructions_list_no_verif_parse (lexique_var_) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_while) ;
  { bool syntaxRepeat = true ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1501_26_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
  ...
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_54684 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_54684 != NULL)) {
        macroValidPointer (operand_54684) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_54684->mInstruction) ;
        operand_54684 = operand_54684->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list.addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_57591 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_57591 != NULL)) {
        macroValidPointer (operand_57591) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_57591->mInstruction) ;
        operand_57591 = operand_57591->nextObject () ;
      }
      var_cas_ioVariablesMap.epilogue_testPart (lexique_var_, GGS_location (lexique_var_)) ;
      var_cas_ioVariablesMap.epilogue_testBloc (lexique_var_) ;
...
void parser_parser::
parser_parser::
pr_syntax_instruction_parser_parser_1501_26_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
...
void parser_parser::
pr_syntax_instruction_parser_parser_1501_26_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_parse) ;
  switch (select_parser_parser_13 (lexique_var_)) {
    case 1 : {
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_do) ;
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1659_41_ (galgas_scanner & lexique_var_,
                                GGS_M_nonTerminalSymbolForSyntax  &var_cas_ioNonTerminalSymbolMapForSyntax,
                                GGS_bool var_cas_inCheckNonTerminalsAreDeclaredWithParseLabel,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_typeEntitiesToGenerateList  &var_cas_listeEntitesAengendrer,
...
void parser_parser::
parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1659_41_importSyntax (galgas_scanner & lexique_var_,
                                GGS_L_ruleSyntaxSignature  &var_cas_ioInstructionsList) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
...
void parser_parser::
pr_syntax_instructions_list_no_verif_parser_parser_1659_41_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_parser_parser_16 (lexique_var_)) {
        case 2 : {
