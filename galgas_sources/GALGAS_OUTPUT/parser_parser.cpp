...
pr_syntax_declaration_parser_parser_865_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_mdaResultVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap::element_type * operand_33906 = var_cas_allPropertiesMap.firstObject () ;
    while ((operand_33906 != NULL)) {
      macroValidPointer (operand_33906) ;
      if (operand_33906->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_33994 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_33906->mInfo.mPropertyType.getPtr ()) ;
        if (operand_33994 != NULL) {
          macroValidPointer (operand_33994) ; 
          GGS_lstring  var_cas_nomVariable ;
          var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33906->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (972)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (972)) COMMA_HERE) ;
          GGS_typeCplusPlusName  var_cas_nomCppVariable ;
          ...
          var_cas_tableArgumentsMethode.modifier_insertSingleEntityLocalVariable (_inLexique, var_cas_nomVariable, operand_33906->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (974)) ;
          GGS_typeInstruction  var_cas_instruction ;
          var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33906->mInfo.mPropertyType COMMA_HERE) ;
          var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_34556 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_33906->mInfo.mPropertyType.getPtr ()) ;
          if (operand_34556 != NULL) {
            macroValidPointer (operand_34556) ; 
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33906->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertListOfEntitiesLocalVariable (_inLexique, var_cas_nomVariable, operand_33906->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (980)) ;
            GGS_typeExpression  var_cas_sourceExpression ;
            var_cas_sourceExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, (operand_34556->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (982)))._operator_concat (GGS_string (true, "List")), GGS_string (true, "emptyList"), GGS_typeExpressionList::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_C_declarationInstructionWithAssignment::constructor_new (_inLexique, operand_33906->mInfo.mPropertyType, var_cas_nomCppVariable, var_cas_sourceExpression COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }else{ // Else part
            GGS_lstring  var_cas_nomVariable ;
            var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, operand_33906->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)), var_cas_returnedEntity.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)) COMMA_HERE) ;
            GGS_typeCplusPlusName  var_cas_nomCppVariable ;
            ...
            var_cas_tableArgumentsMethode.modifier_insertEntityAttributeLocalVariable (_inLexique, var_cas_nomVariable, operand_33906->mInfo.mPropertyType, var_cas_nomCppVariable COMMA_SOURCE_FILE_AT_LINE (995)) ;
            GGS_typeInstruction  var_cas_instruction ;
            var_cas_instruction = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_nomCppVariable, operand_33906->mInfo.mPropertyType COMMA_HERE) ;
            var_cas_listeInstructions._addAssign_operation (var_cas_instruction) ;
          }
      ...
      operand_33906 = operand_33906->nextObject () ;
    }
  }
  ...
  GGS_M_nonterminalSymbolAlts::element_type * operand_38596 = var_cas_nonterminalSymbolAltMap.firstObject () ;
  while ((operand_38596 != NULL)) {
    macroValidPointer (operand_38596) ;
    if ((((operand_38596->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)))._operator_isNotEqual (GGS_string (true, "parse")))._operator_and ((var_cas_altProductionsMap.reader_hasKey (_inLexique, operand_38596->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1093)) COMMA_SOURCE_FILE_AT_LINE (1093)))._operator_not ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_38596->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1094))))._operator_concat (GGS_string (true, "' label is not implemented within the rule")) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    }
    operand_38596 = operand_38596->nextObject () ;
  }
  GGS_typeEntityToGenerate  var_cas_ea ;
...
pr_syntax_instruction_parser_parser_1264_6_ (galgas_scanner & _inLexique,
  ...
  if ((((var_cas_returnedEntityFromSignature.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1325)))._operator_isEqual (GGS_string (true, "")))._operator_and ((var_cas_returnedEntityVariableName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1325)))._operator_isNotEqual (GGS_string (true, "")))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      ...
      GGS_uint _variant_48424 = var_cas_inAllMetamodelClassMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1344)) ;
      GGS_bool _condition_48424 (_variant_48424._isBuilt (), true) ;
      while (_condition_48424.isBuiltAndTrue ()) {
        _condition_48424 = ((var_cas_ok)._operator_not ())._operator_and ((var_cas_testedClass.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1345)))._operator_strictSup (GGS_uint (true, 0U))) ;
        if (_condition_48424.isBuiltAndTrue ()) {
          if (_variant_48424.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1350)) ;
            _condition_48424 = GGS_bool (true, false) ;
          }else{
            _variant_48424._decrement_operation (_inLexique COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1620_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_16 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_59730 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_59730 != NULL)) {
        macroValidPointer (operand_59730) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_59730->mInstruction) ;
        operand_59730 = operand_59730->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      var_cas_parse_rewind_signature_list._addAssign_operation (var_cas_syntaxSignature, var_cas_branchStartLocation) ;
      GGS_L_ruleSyntaxSignature::element_type * operand_62955 = var_cas_syntaxSignature.firstObject () ;
      while ((operand_62955 != NULL)) {
        macroValidPointer (operand_62955) ;
        var_cas_ioSyntaxSignature._addAssign_operation (operand_62955->mInstruction) ;
        operand_62955 = operand_62955->nextObject () ;
      }
