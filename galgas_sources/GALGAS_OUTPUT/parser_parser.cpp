...
pr_syntax_instruction_parser_parser_1224_26_ (galgas_scanner & _inLexique,
  ...
  if (((((var_cas_returnedEntityFromSignature.reader_value (_inLexique SOURCE_FILE_AT_LINE (1283))) == (GGS_string (true, ""))) & ((var_cas_returnedEntityVariableName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1283))) != (GGS_string (true, ""))))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_isMultipleEntity).isBuiltAndTrue ()) {
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46675 ;
      var_cas_ioVariablesMap.method_searchForReadWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46675 SOURCE_FILE_AT_LINE (1291)) ;
      ...
      GGS_AC_galgasType  var_cas_type ;
      GGS_typeCplusPlusName  var_cas_46938 ;
      var_cas_ioVariablesMap.method_searchForWriteAccess (_inLexique, var_cas_returnedEntityVariableName, var_cas_type, var_cas_46938 SOURCE_FILE_AT_LINE (1296)) ;
      { cPtr_typeGalgas_singleEntity * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_singleEntity *> (var_cas_type.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          if (var_cas_type.getPtr () != NULL) {
            TC_UniqueArray <C_String> message1_ (1 COMMA_HERE) ;
...
pr_syntax_instruction_parser_parser_1547_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_parser_parser_13 (_inLexique)) {
    case 1 : {
      ...
      GGS_L_ruleSyntaxSignature::element_type * operand_57250 = var_cas_firstBranchSyntaxSignature.firstObject () ;
      while ((operand_57250 != NULL)) {
        macroValidPointer (operand_57250) ;
        var_cas_ioSyntaxSignature.addAssign_operation (operand_57250->mInstruction) ;
        operand_57250 = operand_57250->nextObject () ;
      }
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
    ...
    case 2 : {
      ...
      while ((operand_60182 != NULL)) {
        ...
        var_cas_ioSyntaxSignature.addAssign_operation (operand_60182->mInstruction) ;
