  ...
  switch (select_semanticDeclarationsSyntax_13 (inLexique)) {
    ...
    case 2 : {
      ...
      switch (select_semanticDeclarationsSyntax_14 (inLexique)) {
        case 1 : {
          var_cas_mSuperClassName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (408)) ;
          } break ;
        case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_classDeclarationAST ::constructor_new (inLexique, var_cas_mIsAbstract, var_cas_mClassTypeName, var_cas_mSuperClassName, var_cas_classFeatureList, var_cas_mAttributeList, var_cas_mAbstractMethodList, var_cas_mMethodList, var_cas_mLazyAttributeList COMMA_SOURCE_FILE_AT_LINE (457))) ;
      } break ;
    default :
      break ;
  }
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_structDeclarationAST ::constructor_new (inLexique, var_cas_mListTypeName, var_cas_mAttributeList COMMA_SOURCE_FILE_AT_LINE (491))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_listDeclarationAST ::constructor_new (inLexique, var_cas_mListTypeName, var_cas_mAttributeList COMMA_SOURCE_FILE_AT_LINE (515))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i17_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_sortedListDeclarationAST ::constructor_new (inLexique, var_cas_mSortedListTypeName, var_cas_mAttributeList, var_cas_mSortDescriptorList COMMA_SOURCE_FILE_AT_LINE (582))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i19_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_enumDeclarationAST ::constructor_new (inLexique, var_cas_mEnumTypeName, var_cas_mConstantList, var_cas_mEnumMessageList COMMA_SOURCE_FILE_AT_LINE (664))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_filewrapperDeclarationAST ::constructor_new (inLexique, var_cas_mFilewrapperName, var_cas_mFilewrapperPath, var_cas_mFilewrapperExtensionList, var_cas_mFilewrapperTemplateList COMMA_SOURCE_FILE_AT_LINE (714))) ;
}
