...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_categoryMethodAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList, var_cas_endOfMethodLocation COMMA_SOURCE_FILE_AT_LINE (832))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_overridingCategoryMethodAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList, var_cas_endOfMethodLocation COMMA_SOURCE_FILE_AT_LINE (863))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_abstractCategoryReaderAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mReaderName, var_cas_mFormalInputParameterList, var_cas_mReturnedTypeName COMMA_SOURCE_FILE_AT_LINE (891))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_reader) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_categoryReaderAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalInputParameterList, var_cas_mReturnedTypeName, var_cas_mReturnedVariableName, var_cas_mRoutineInstructionList COMMA_SOURCE_FILE_AT_LINE (922))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_reader) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_overridingCategoryReaderAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalInputParameterList, var_cas_mReturnedTypeName, var_cas_mReturnedVariableName, var_cas_mRoutineInstructionList COMMA_SOURCE_FILE_AT_LINE (956))) ;
}
