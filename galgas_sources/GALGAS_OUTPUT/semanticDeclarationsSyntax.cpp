...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_mapindexDeclarationAST ::constructor_new (inLexique, var_cas_mMapIndexName, var_cas_mMapTypeName, var_cas_mSearchMethodName, var_cas_mSearchMethodErrorMessage COMMA_HERE)) ;
}
      ...
      { bool syntaxRepeat_15 = true ;
        while (syntaxRepeat_15) {
          switch (select_semanticDeclarationsSyntax_15 (inLexique)) {
            ...
            case 8 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_message) COMMA_HERE) ;
              const GGS_bool cond_14833 = (var_cas_mClassMessage.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_14833.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the class message is already defined") COMMA_SOURCE_FILE_AT_LINE (465)) ;
              }
              GGS_lstring  var_cas_classMessage ;
              inLexique.assignFromAttribute_tokenString (var_cas_classMessage) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
              const GGS_bool cond_15036 = (var_cas_classMessage.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_15036.isBuiltAndTrue ()) {
                var_cas_classMessage.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the class message string should be not empty") COMMA_SOURCE_FILE_AT_LINE (470)) ;
              }
              var_cas_mClassMessage = var_cas_classMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (471)) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
              } break ;
            default :
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mAbstractCategoryMethodListMap.addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (757)), var_cas_mMethodName, var_cas_mFormalParameterList) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mCategoryMethodListMap.addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (781)), var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mOverridingCategoryMethodListMap.addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (810)), var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mAbstractCategoryReaderListMap.addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (837)), var_cas_mReaderName, var_cas_mFormalInputParameterList, var_cas_mReturnedTypeName) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_reader) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mCategoryReaderListMap.addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (868)), var_cas_mMethodName, var_cas_mFormalInputParameterList, var_cas_mReturnedTypeName, var_cas_mReturnedVariableName, var_cas_mRoutineInstructionList) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_reader) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mOverridingCategoryReaderListMap.addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (902)), var_cas_mMethodName, var_cas_mFormalInputParameterList, var_cas_mReturnedTypeName, var_cas_mReturnedVariableName, var_cas_mRoutineInstructionList) ;
}
