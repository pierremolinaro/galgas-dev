...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticDeclarationsSyntax_10 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7D_) COMMA_HERE) ;
      var_cas_ioSemanticDeclarations.mSemanticDeclarationList.addAssign_operation (GGS_classDeclarationAST ::constructor_new (inLexique, var_cas_mIsAbstract, var_cas_mClassTypeName, var_cas_mSuperClassName, var_cas_classFeatureList, var_cas_mAttributeList, var_cas_mAbstractMethodList, var_cas_mOverridenMethodList, var_cas_mMethodList COMMA_HERE)) ;
      } break ;
    default :
      break ;
  }
