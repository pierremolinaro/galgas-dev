...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_formal_5F_parameter_5F_list_ (inLexique, var_cas_mFormalParameterList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_overridingAbstractCategoryMethodAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList COMMA_SOURCE_FILE_AT_LINE (829))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_categoryMethodAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList, var_cas_endOfMethodLocation COMMA_SOURCE_FILE_AT_LINE (857))) ;
}
...
void semanticDeclarationsSyntax::rule_semanticDeclarationsSyntax_semantic_5F_declaration_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.addAssign_operation (GGS_overridingCategoryMethodAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList, var_cas_endOfMethodLocation COMMA_SOURCE_FILE_AT_LINE (888))) ;
}
