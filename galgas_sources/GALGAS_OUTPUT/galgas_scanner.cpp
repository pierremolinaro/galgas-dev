    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        if (_token.mTokenCode == -1) {
          _token.mTokenCode = galgas_scanner_1_identifier ;
        }
        _enterToken (_token) ;
        ...
        if (testForInputUTF32String (kUnicodeString_SL, 2, true)) {
          ...
          _token.mTokenCode = galgas_scanner_1_signed_5Fliteral_5Finteger64 ;
          _enterToken (_token) ;
          ...
          _token.mTokenCode = galgas_scanner_1_signed_5Fliteral_5Finteger ;
          _enterToken (_token) ;
          ...
          _token.mTokenCode = galgas_scanner_1_unsigned_5Fliteral_5Finteger64 ;
          _enterToken (_token) ;
        }else{
          scanner_action_convertHexStringIntoUInt (_token.tokenString, _token.uint32value, gErrorMessage_0, gErrorMessage_2) ;
          _token.mTokenCode = galgas_scanner_1_unsigned_5Fliteral_5Finteger ;
          _enterToken (_token) ;
        }
        ...
        if (testForInputUTF32Char (TO_UNICODE ('S')) ||
          ...
          _token.mTokenCode = galgas_scanner_1_literal_5Fdouble ;
          _enterToken (_token) ;
        }else{
        ...
        if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
          ...
          if (testForInputUTF32String (kUnicodeString__2E__2E_, 2, true)) {
            _token.mTokenCode = galgas_scanner_1__2E_2E_2E ;
            _enterToken (_token) ;
          }else if (testForInputUTF32String (kUnicodeString__3D_, 1, true)) {
            _token.mTokenCode = galgas_scanner_1__2E_3D ;
            _enterToken (_token) ;
          }else{
            _token.mTokenCode = galgas_scanner_1__2E ;
            _enterToken (_token) ;
          }
        }
      }else if (testForInputUTF32Char (TO_UNICODE ('@'))) {
        ...
        _token.mTokenCode = galgas_scanner_1_type_5Fname ;
        _enterToken (_token) ;
      }else if (testForInputUTF32Char (TO_UNICODE ('\''))) {
        if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
          if (testForInputUTF32Char (TO_UNICODE ('f'))) {
            ...
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                ...
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              scanner_action_enterHexDigitIntoUInt (previousChar (), _token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
              if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                scanner_action_enterHexDigitIntoUInt (previousChar (), _token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  ...
                  if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                      ...
                      testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                    scanner_action_enterHexDigitIntoUInt (previousChar (), _token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
                    scanner_action_convertUnsignedNumberToUnicodeChar (_token.uint32value, _token.charValue, gErrorMessage_9) ;
                  }else{
            ...
            loop_ = true ;
            scanner_action_convertHTMSequenceToUnicodeCharacter (_token.tokenString, _token.charValue, gErrorMessage_11) ;
          }else{
            lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
          }
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\''))) {
          _token.mTokenCode = galgas_scanner_1_literal_5Fchar ;
          _enterToken (_token) ;
        }else{
          lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
        }
        ...
        if (testForInputUTF32Char (TO_UNICODE ('='))) {
          ...
          loop_ = true ;
          if (testForInputUTF32Char (TO_UNICODE ('>'))) {
            _token.mTokenCode = galgas_scanner_1_non_5Fterminal_5Fsymbol ;
            _enterToken (_token) ;
          }else{
            mCurrentLocation = _locationForTag_onlyInfDelimiter ;
            _token.mTokenCode = galgas_scanner_1__3C ;
            _enterToken (_token) ;
          }
        }else{
          _token.mTokenCode = galgas_scanner_1__3C ;
        ...
        do {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            if (testForInputUTF32Char (TO_UNICODE ('f'))) {
              ...
              loop_ = true ;
              scanner_action_convertHTMSequenceToUnicodeCharacter (_token.identifierString, _token.charValue, gErrorMessage_11) ;
        ...
        loop_ = true ;
        if (testForInputUTF32Char (TO_UNICODE ('\"'))) {
          _token.mTokenCode = galgas_scanner_1_literal_5Fstring ;
          _enterToken (_token) ;
        }else{
        ...
        _token.mTokenCode = galgas_scanner_1_ ; // Empty string code
  ...
  while (_token.mTokenCode < 0) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        loop_ = true ;
        _token.mTokenCode = galgas_scanner_1_comment ;
      }else if (testForInputUTF32CharRange (TO_UNICODE (1), TO_UNICODE (' '))) {
      }else if (testForInputUTF32Char (TO_UNICODE ('\0'))) { // End of source text ? 
        _token.mTokenCode = galgas_scanner_1_ ; // Empty string code
      }else{ // Unknown input character
