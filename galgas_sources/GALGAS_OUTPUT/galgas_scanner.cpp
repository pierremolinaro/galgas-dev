...
//--- Syntax error message for terminal '$wrapper$' :
static const char * gSyntaxErrorMessage_wrapper = "the 'wrapper' keyword" ;
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 82 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [82] = {
  ...
  C_lexique_table_entry ("wrapper", 7, galgas_scanner_1_wrapper),
  ...
  C_lexique_table_entry ("treewalking", 11, galgas_scanner_1_treewalking)
} ;
  ...
  if (_p == NULL) {
    ...
    case  galgas_scanner_1_then:
      s << '$'
        ...
        << '$' ;
      break;
    case  galgas_scanner_1_treewalking:
      s << '$'
        << "treewalking"
        << '$' ;
      break;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [137] = {0,
    ...
    1 /* galgas_scanner_1_treewalking */,
