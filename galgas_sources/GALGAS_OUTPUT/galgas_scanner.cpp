      ...
      if (testForInputCharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        do {
          if (testForInputCharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          }else if (testForInputCharRange (TO_UNICODE ('a'), TO_UNICODE ('f'))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          }else if (testForInputCharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
        ...
        if (testForInputString ("LS", 2, true)) {
          ...
          _enterToken (_token) ;
        }else if (testForInputChar (TO_UNICODE ('S')) ||
        ...
        }else if (testForInputCharRange (TO_UNICODE (' '), TO_UNICODE (255))) {
        ...
        if (testForInputCharRange (TO_UNICODE ('!'), TO_UNICODE ('#')) ||
            testForInputCharRange (TO_UNICODE ('%'), TO_UNICODE ('~'))) {
          do {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
            if (testForInputCharRange (TO_UNICODE ('!'), TO_UNICODE ('#')) ||
                testForInputCharRange (TO_UNICODE ('%'), TO_UNICODE ('~'))) {
        ...
        if (testForInputChar (TO_UNICODE ('='))) {
          ...
          _enterToken (_token) ;
        }else if (testForInputCharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
            testForInputCharRange (TO_UNICODE ('A'), TO_UNICODE ('Z'))) {
          do {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
            if (testForInputCharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
