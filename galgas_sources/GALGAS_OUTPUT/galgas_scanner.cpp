...
galgas_scanner::
galgas_scanner (AC_galgas_io * inGalgasInputOutput)
: C_Lexique (inGalgasInputOutput) {
  charValue = '\0' ;
  longValue = 0 ;
  ulongValue = 0 ;
  tokenString.clearString () ;
...
//--- Message 2 (debut_nom_externe_incorrect) :
static const char * gErrorMessage_2 = "incorrect type name beginning" ;
//--- Message 3 (incorrectCharConstant) :
static const char * gErrorMessage_3 = "incorrect literal character" ;
//--- Message 4 (ASCIIcodeTooLargeError) :
static const char * gErrorMessage_4 = "ASCII code > 255" ;
//--- Message 5 (incorrect_terminal_start) :
static const char * gErrorMessage_5 = "incorrect terminal start" ;
//--- Message 6 (incorrect_terminal_end) :
static const char * gErrorMessage_6 = "terminal does not end with '$'" ;
//--- Message 7 (incorrectStringEnd) :
static const char * gErrorMessage_7 = "string does not end with '\"'" ;
//--- Message 8 (incorrectEndOfComment) :
static const char * gErrorMessage_8 = "incorrect end of comment" ;
...
//--- Syntax error message for terminal '$laststate$' :
static const char * gSyntaxErrorMessage_laststate = "the 'laststate' keyword" ;
...
//--- Syntax error message for terminal '$key$' :
static const char * gSyntaxErrorMessage_key = "the 'key' keyword" ;
//--- Syntax error message for terminal '$firststate$' :
static const char * gSyntaxErrorMessage_firststate = "the 'firststate' keyword" ;
//--- Syntax error message for terminal '$header$' :
static const char * gSyntaxErrorMessage_header = "the 'header' keyword" ;
...
//--- Syntax error message for terminal '$transition$' :
static const char * gSyntaxErrorMessage_transition = "the 'transition' keyword" ;
...
//--- Syntax error message for terminal '$setof$' :
static const char * gSyntaxErrorMessage_setof = "the 'setof' keyword" ;
//--- Syntax error message for terminal '$start$' :
static const char * gSyntaxErrorMessage_start = "the 'start' keyword" ;
...
//--- Syntax error message for terminal '$cocoa$' :
static const char * gSyntaxErrorMessage_cocoa = "the 'cocoa' keyword" ;
//--- Syntax error message for terminal '$unsigned_literal_integer$' :
static const char * gSyntaxErrorMessage_unsigned_5Fliteral_5Finteger = "a decimal number" ;
//--- Syntax error message for terminal '$signed_literal_integer$' :
static const char * gSyntaxErrorMessage_signed_5Fliteral_5Finteger = "a signed decimal number" ;
...
//--- Syntax error message for terminal '$<>$' :
static const char * gSyntaxErrorMessage__3C_3E = "the '<>' delimitor" ;
//--- Syntax error message for terminal '$::$' :
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [104] = {"end of source",
       ...
       gSyntaxErrorMessage_laststate,
       gSyntaxErrorMessage_or,
       gSyntaxErrorMessage_block,
       gSyntaxErrorMessage_key,
       gSyntaxErrorMessage_firststate,
       gSyntaxErrorMessage_header,
       gSyntaxErrorMessage_false,
       gSyntaxErrorMessage_true,
       gSyntaxErrorMessage_transition,
       gSyntaxErrorMessage_rule,
       gSyntaxErrorMessage_tag,
       gSyntaxErrorMessage_setof,
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 65 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [65] = {
  ...
  C_lexique_table_entry ("key", 3, galgas_scanner_1_key),
  ...
  C_lexique_table_entry ("cocoa", 5, galgas_scanner_1_cocoa),
  ...
  C_lexique_table_entry ("setof", 5, galgas_scanner_1_setof),
  C_lexique_table_entry ("start", 5, galgas_scanner_1_start),
  ...
  C_lexique_table_entry ("header", 6, galgas_scanner_1_header),
  ...
  C_lexique_table_entry ("include", 7, galgas_scanner_1_include),
  ...
  C_lexique_table_entry ("laststate", 9, galgas_scanner_1_laststate),
  C_lexique_table_entry ("semantics", 9, galgas_scanner_1_semantics),
  C_lexique_table_entry ("firststate", 10, galgas_scanner_1_firststate),
  C_lexique_table_entry ("transition", 10, galgas_scanner_1_transition),
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasDelimitorsList = 31 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasDelimitorsList [31] = {
  ...
  C_lexique_table_entry (".", 1, galgas_scanner_1__2E),
  ...
  C_lexique_table_entry ("<>", 2, galgas_scanner_1__3C_3E),
  ...
  C_lexique_table_entry ("...", 3, galgas_scanner_1__2E_2E_2E)
} ;
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        do {
          enterCharacterIntoString (identifierString, toLower (getPreviousChar ()), * this) ;
          enterCharacterIntoString (tokenString, getPreviousChar (), * this) ;
          if (testForInputChar ('a', 'z') ||
              testForInputChar ('A', 'Z') ||
              testForInputChar ('_') ||
        ...
        if (testForInputChar ('S') ||
            testForInputChar ('s')) {
          convertUlongToLong (longValue, ulongValue, gErrorMessage_0, * this) ;
        ...
        if (testForInputChar ('\\')) {
          if (testForInputChar ('f')) {
            enterCharacterIntoCharacter (charValue, '\f', * this) ;
          }else if (testForInputChar ('n')) {
            enterCharacterIntoCharacter (charValue, '\n', * this) ;
          }else if (testForInputChar ('r')) {
            enterCharacterIntoCharacter (charValue, '\r', * this) ;
          }else if (testForInputChar ('t')) {
            enterCharacterIntoCharacter (charValue, '\t', * this) ;
          }else if (testForInputChar ('v')) {
            enterCharacterIntoCharacter (charValue, '\v', * this) ;
          }else if (testForInputChar ('\\')) {
            enterCharacterIntoCharacter (charValue, '\\', * this) ;
          }else if (testForInputChar ('0')) {
            enterCharacterIntoCharacter (charValue, '\0', * this) ;
          }else if (testForInputChar ('\'')) {
            enterCharacterIntoCharacter (charValue, '\'', * this) ;
          }else if (testForInputChar ('0', '9')) {
            do {
              enterHexDigitIntoASCIIcharacter (charValue, getPreviousChar (), gErrorMessage_4, gErrorMessage_1, * this) ;
              if (testForInputChar ('0', '9')) {
              }else{
                loop_ = false ;
              }
          ...
          enterCharacterIntoCharacter (charValue, getPreviousChar (), * this) ;
        }else{
          lexicalError (gErrorMessage_3) ;
        }
        if (testForInputChar ('\'')) {
        ...
        do {
          if (testForInputChar ('\\')) {
            if (testForInputChar ('f')) {
              enterCharacterIntoString (tokenString, '\f', * this) ;
            }else if (testForInputChar ('n')) {
              enterCharacterIntoString (tokenString, '\n', * this) ;
            }else if (testForInputChar ('r')) {
              enterCharacterIntoString (tokenString, '\r', * this) ;
            }else if (testForInputChar ('t')) {
              enterCharacterIntoString (tokenString, '\t', * this) ;
            }else if (testForInputChar ('v')) {
              enterCharacterIntoString (tokenString, '\v', * this) ;
            }else if (testForInputChar ('\\')) {
              enterCharacterIntoString (tokenString, '\\', * this) ;
            }else if (testForInputChar ('0')) {
              enterCharacterIntoString (tokenString, '\0', * this) ;
            }else if (testForInputChar ('\"')) {
              enterCharacterIntoString (tokenString, '\"', * this) ;
            }else if (testForInputChar ('\'')) {
              enterCharacterIntoString (tokenString, '\'', * this) ;
              ...
              loop_ = true ;
              enterCharacterIntoString (tokenString, charValue, * this) ;
            }else{
              lexicalError (gErrorMessage_3) ;
            }
          }else if (testForInputChar (' ') ||
...
const char * galgas_scanner::getStyleName (const sint32 inIndex) {
  const char * kStylesArray [9] = {"Default style", "Keywords :", "Delimiters :", "Terminal symbols :", "Integer constants :", "Character constants :", "String constants :", "Type names (@...) :", NULL} ;
...
getTerminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [104] = {0,
    ...
    1 /* galgas_scanner_1_laststate */,
    1 /* galgas_scanner_1_or */,
    1 /* galgas_scanner_1_block */,
    1 /* galgas_scanner_1_key */,
    1 /* galgas_scanner_1_firststate */,
    1 /* galgas_scanner_1_header */,
    1 /* galgas_scanner_1_false */,
    1 /* galgas_scanner_1_true */,
    1 /* galgas_scanner_1_transition */,
    1 /* galgas_scanner_1_rule */,
    1 /* galgas_scanner_1_tag */,
    1 /* galgas_scanner_1_setof */,
    1 /* galgas_scanner_1_start */,
    1 /* galgas_scanner_1_end */,
    1 /* galgas_scanner_1_not */,
    1 /* galgas_scanner_1_include */,
    ...
    6 /* galgas_scanner_1_literal_5Fstring */
  } ;
