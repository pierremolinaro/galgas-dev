...
static const sint32 ktable_size_galgasKeyWordList = 88 ;
...
static const C_unicode_lexique_table_entry ktable_for_galgasKeyWordList [ktable_size_galgasKeyWordList] = {
  ...
  {kEntry_62_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_feature},
  {kEntry_63_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_foreach},
  {kEntry_64_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_grammar},
  {kEntry_65_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_lexique},
  {kEntry_66_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_listmap},
  {kEntry_67_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_message},
  {kEntry_68_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_program},
  {kEntry_69_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_project},
  {kEntry_70_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_replace},
  {kEntry_71_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_routine},
  {kEntry_72_forTable_galgasKeyWordList, 7, galgas_scanner::galgas_scanner_1_warning},
  {kEntry_73_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_abstract},
  {kEntry_74_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_function},
  {kEntry_75_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_import_5F_5F},
  {kEntry_76_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_mapindex},
  {kEntry_77_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_modifier},
  {kEntry_78_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_operator},
  {kEntry_79_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_override},
  {kEntry_80_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_template},
  {kEntry_81_forTable_galgasKeyWordList, 9, galgas_scanner::galgas_scanner_1_semantics},
  {kEntry_82_forTable_galgasKeyWordList, 10, galgas_scanner::galgas_scanner_1_dependency},
  {kEntry_83_forTable_galgasKeyWordList, 10, galgas_scanner::galgas_scanner_1_sortedlist},
  {kEntry_84_forTable_galgasKeyWordList, 11, galgas_scanner::galgas_scanner_1_constructor},
  {kEntry_85_forTable_galgasKeyWordList, 11, galgas_scanner::galgas_scanner_1_description},
  {kEntry_86_forTable_galgasKeyWordList, 11, galgas_scanner::galgas_scanner_1_filewrapper},
  {kEntry_87_forTable_galgasKeyWordList, 11, galgas_scanner::galgas_scanner_1_nonterminal}
} ;
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        if (testForInputUTF32String (kUnicodeString_SL, 2, true)) {
          ::scanner_action_convertHexStringIntoSInt64 (*this, token.tokenString, token.sint64value, gErrorMessage_0, gErrorMessage_2) ;
          ...
          ::scanner_action_convertHexStringIntoSInt (*this, token.tokenString, token.sint32value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_signed_5Fliteral_5Finteger ;
          enterToken (token) ;
        }else if (testForInputUTF32Char (TO_UNICODE ('L'))) {
          ::scanner_action_convertHexStringIntoUInt64 (*this, token.tokenString, token.uint64value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_unsigned_5Fliteral_5Finteger64 ;
          enterToken (token) ;
        }else{
          ::scanner_action_convertHexStringIntoUInt (*this, token.tokenString, token.uint32value, gErrorMessage_0, gErrorMessage_2) ;
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
          if (testForInputUTF32Char (TO_UNICODE ('f'))) {
            ...
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                ...
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              ::scanner_action_enterHexDigitIntoUInt (*this, previousChar (), token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
              if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                ::scanner_action_enterHexDigitIntoUInt (*this, previousChar (), token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  ...
                  if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                      ...
                      testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                    ::scanner_action_enterHexDigitIntoUInt (*this, previousChar (), token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
                    ::scanner_action_convertUnsignedNumberToUnicodeChar (*this, token.uint32value, token.charValue, gErrorMessage_9) ;
                  }else{
            ...
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                ...
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              do {
                ::scanner_action_enterHexDigitIntoASCIIcharacter (*this, token.charValue, previousChar (), gErrorMessage_5, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                    testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                    testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                }else{
            ...
            loop = true ;
            ::scanner_action_convertHTMSequenceToUnicodeCharacter (*this, token.tokenString, token.charValue, gErrorMessage_11) ;
          }else{
            lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
          }
        ...
        do {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            if (testForInputUTF32Char (TO_UNICODE ('f'))) {
              ...
              loop = true ;
              ::scanner_action_convertHTMSequenceToUnicodeCharacter (*this, token.identifierString, token.charValue, gErrorMessage_11) ;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [143] = {0,
