...
//--- Message 1 (floatNumberConversionError) :
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [113] = {"end of source",
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 71 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [71] = {
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        scanner_action_enterDigitIntoUlong (ulongValue, previousChar (), gErrorMessage_0, gErrorMessage_2) ;
        do {
        ...
        if (testForInputChar ('\\')) {
          if (testForInputChar ('f')) {
            ...
            if (testForInputChar ('0', '9') ||
              ...
              lexicalError (gErrorMessage_4 LINE_AND_SOURCE_FILE) ;
            }
          }else{
            lexicalError (gErrorMessage_4 LINE_AND_SOURCE_FILE) ;
          }
        ...
        if (testForInputChar ('\"')) {
          ...
          lexicalError (gErrorMessage_8 LINE_AND_SOURCE_FILE) ;
        }
      }else if (testForInputChar ('#')) {
        do {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [113] = {0,
