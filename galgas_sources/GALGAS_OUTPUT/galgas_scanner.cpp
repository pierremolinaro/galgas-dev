...
static const C_unicode_lexique_table_entry ktable_for_galgasKeyWordList [ktable_size_galgasKeyWordList] = {
  ...
  {kEntry_76_forTable_galgasKeyWordList, 8, galgas_scanner::galgas_scanner_1_import_5F_5F},
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        if (testForInputUTF32String (kUnicodeString_SL, 2, true)) {
          ...
          token.mTokenCode = galgas_scanner_1_signed_5Fliteral_5Finteger ;
          enterToken (token) ;
          ...
          token.mTokenCode = galgas_scanner_1_unsigned_5Fliteral_5Finteger64 ;
          enterToken (token) ;
        }else{
          ::scanner_routine_convertHexStringIntoUInt (*this, token.tokenString, token.uint32value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_unsigned_5Fliteral_5Finteger ;
          enterToken (token) ;
        }
        ...
        if (testForInputUTF32Char (TO_UNICODE ('S')) ||
          ...
          token.mTokenCode = galgas_scanner_1_literal_5Fdouble ;
          enterToken (token) ;
        }else{
        ...
        if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
          ...
          if (testForInputUTF32String (kUnicodeString__2E__2E_, 2, true)) {
            token.mTokenCode = galgas_scanner_1__2E_2E_2E ;
            enterToken (token) ;
          }else if (testForInputUTF32String (kUnicodeString__3D_, 1, true)) {
            token.mTokenCode = galgas_scanner_1__2E_3D ;
            enterToken (token) ;
          }else{
            token.mTokenCode = galgas_scanner_1__2E ;
            enterToken (token) ;
          }
        }
      }else if (testForInputUTF32Char (TO_UNICODE ('@'))) {
        ...
        token.mTokenCode = galgas_scanner_1_type_5Fname ;
        enterToken (token) ;
      }else if (testForInputUTF32Char (TO_UNICODE ('\''))) {
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\''))) {
          token.mTokenCode = galgas_scanner_1_literal_5Fchar ;
          enterToken (token) ;
        }else{
          lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
        }
        ...
        if (testForInputUTF32Char (TO_UNICODE ('='))) {
          ...
          loop = true ;
          if (testForInputUTF32Char (TO_UNICODE ('>'))) {
            token.mTokenCode = galgas_scanner_1_non_5Fterminal_5Fsymbol ;
            enterToken (token) ;
          }else{
            mCurrentLocation = _locationForTag_onlyInfDelimiter ;
            token.mTokenCode = galgas_scanner_1__3C ;
            enterToken (token) ;
          }
        }else{
          token.mTokenCode = galgas_scanner_1__3C ;
        ...
        loop = true ;
        if (testForInputUTF32Char (TO_UNICODE ('\"'))) {
          token.mTokenCode = galgas_scanner_1_literal_5Fstring ;
          enterToken (token) ;
        }else{
