    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        if (testForInputUTF32String (kUnicodeString_LS, 2, true)) {
          ::scanner_routine_convertHexStringIntoSInt64 (*this, token.tokenString, token.sint64value, gErrorMessage_0, gErrorMessage_2) ;
          ...
          ::scanner_routine_convertHexStringIntoSInt (*this, token.tokenString, token.sint32value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_signed_5F_literal_5F_integer ;
          enterToken (token) ;
        }else if (testForInputUTF32Char (TO_UNICODE ('L'))) {
          ::scanner_routine_convertHexStringIntoUInt64 (*this, token.tokenString, token.uint64value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_unsigned_5F_literal_5F_integer_36__34_ ;
          enterToken (token) ;
        }else{
          ::scanner_routine_convertHexStringIntoUInt (*this, token.tokenString, token.uint32value, gErrorMessage_0, gErrorMessage_2) ;
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
          if (testForInputUTF32Char (TO_UNICODE ('f'))) {
            ...
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                ...
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              ::scanner_routine_enterHexDigitIntoUInt (*this, previousChar (), token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
              if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                ::scanner_routine_enterHexDigitIntoUInt (*this, previousChar (), token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  ...
                  if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                      ...
                      testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                    ::scanner_routine_enterHexDigitIntoUInt (*this, previousChar (), token.uint32value, gErrorMessage_2, gErrorMessage_2) ;
                    ::scanner_routine_convertUnsignedNumberToUnicodeChar (*this, token.uint32value, token.charValue, gErrorMessage_9) ;
                  }else{
            ...
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                ...
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              do {
                ::scanner_routine_enterHexDigitIntoASCIIcharacter (*this, token.charValue, previousChar (), gErrorMessage_5, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                    testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                    testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                }else{
            ...
            loop = true ;
            ::scanner_routine_convertHTMLSequenceToUnicodeCharacter (*this, token.tokenString, token.charValue, gErrorMessage_11) ;
          }else{
            lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
          }
        ...
        do {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            if (testForInputUTF32Char (TO_UNICODE ('f'))) {
              ...
              loop = true ;
              ::scanner_routine_convertHTMLSequenceToUnicodeCharacter (*this, token.identifierString, token.charValue, gErrorMessage_11) ;
