...
//--- Syntax error message for terminal '$reader__$' :
static const char * gSyntaxErrorMessage_reader_5F_5F = "the 'reader__' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [127] = {"end of source",
       ...
       gSyntaxErrorMessage_reader_5F_5F,
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 74 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [74] = {
  ...
  C_lexique_table_entry ("reader__", 8, galgas_scanner_1_reader_5F_5F),
...
getCurrentTokenString (void) const {
  ...
  case  galgas_scanner_1_method:
    s << '$'
      ...
      << '$' ;
    break;
  case  galgas_scanner_1_reader_5F_5F:
    s << '$'
      << "reader__"
      << '$' ;
    break;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [127] = {0,
    ...
    1 /* galgas_scanner_1_reader_5F_5F */,
