...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [136] = {"end of source",
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 81 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [81] = {
...
parseLexicalToken (void) {
  ...
  while (_token._mTokenCode < 0) {
    ...
    _token._mFirstLocation = _mCurrentLocation ;
    mCurrentTokenStartLocation = location () ;
    try{
      if (testForInputChar ('a', 'z') ||
          testForInputChar ('A', 'Z')) {
        _token._mLastLocation = _mCurrentLocation ; // §
        do {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [136] = {0,
