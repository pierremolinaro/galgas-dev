...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [108] = {"end of source",
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasDelimitorsList = 34 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasDelimitorsList [34] = {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [108] = {0,
