...
//--- Message 9
static const utf32 gErrorMessage_9 [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('i'),
  TO_UNICODE ('s'),
...
//--- Message 10
static const utf32 gErrorMessage_10 [] = {
  TO_UNICODE ('I'),
  TO_UNICODE ('n'),
  TO_UNICODE ('v'),
  TO_UNICODE ('a'),
...
//--- Message 11
static const utf32 gErrorMessage_11 [] = {
  TO_UNICODE ('I'),
  TO_UNICODE ('n'),
  TO_UNICODE ('v'),
  TO_UNICODE ('a'),
...
//--- Message 12
static const utf32 gErrorMessage_12 [] = {
  TO_UNICODE ('i'),
  TO_UNICODE ('n'),
  TO_UNICODE ('c'),
  TO_UNICODE ('o'),
...
//--- Message 13
static const utf32 gErrorMessage_13 [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('e'),
  TO_UNICODE ('r'),
  TO_UNICODE ('m'),
...
//--- Message 14
static const utf32 gErrorMessage_14 [] = {
  TO_UNICODE ('s'),
  TO_UNICODE ('t'),
  TO_UNICODE ('r'),
  TO_UNICODE ('i'),
...
//--- Message 15
static const utf32 gErrorMessage_15 [] = {
  TO_UNICODE ('\\'),
  TO_UNICODE (' '),
  TO_UNICODE ('f'),
  TO_UNICODE ('o'),
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        if (testForInputUTF32String (kUnicodeString_LS, 2, true)) {
          ::scanner_routine_convertHexStringIntoSInt64 (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_sint64value, gErrorMessage_0, gErrorMessage_2) ;
          ...
          ::scanner_routine_convertHexStringIntoSInt (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_sint32value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_signed_5F_literal_5F_integer ;
          enterToken (token) ;
        }else if (testForInputUTF32Char (TO_UNICODE ('L'))) {
          ::scanner_routine_convertHexStringIntoUInt64 (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_uint64value, gErrorMessage_0, gErrorMessage_2) ;
          token.mTokenCode = galgas_scanner_1_unsigned_5F_literal_5F_integer_36__34_ ;
          enterToken (token) ;
        }else{
          ::scanner_routine_convertHexStringIntoUInt (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_uint32value, gErrorMessage_0, gErrorMessage_2) ;
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
          if (testForInputUTF32Char (TO_UNICODE ('f'))) {
            ...
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                ...
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              ::scanner_routine_enterHexDigitIntoUInt (*this, previousChar (), token.mLexicalAttribute_uint32value, gErrorMessage_2, gErrorMessage_2) ;
              if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                  testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                ::scanner_routine_enterHexDigitIntoUInt (*this, previousChar (), token.mLexicalAttribute_uint32value, gErrorMessage_2, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                  ...
                  if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                      ...
                      testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                    ::scanner_routine_enterHexDigitIntoUInt (*this, previousChar (), token.mLexicalAttribute_uint32value, gErrorMessage_2, gErrorMessage_2) ;
                    ::scanner_routine_convertUnsignedNumberToUnicodeChar (*this, token.mLexicalAttribute_uint32value, token.mLexicalAttribute_charValue, gErrorMessage_9) ;
                  }else{
            ...
            lexicalWarning (gErrorMessage_6 COMMA_LINE_AND_SOURCE_FILE) ;
            if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
              do {
                ::scanner_routine_enterHexDigitIntoASCIIcharacter (*this, token.mLexicalAttribute_charValue, previousChar (), gErrorMessage_5, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
                    testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('f')) ||
                    testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
                }else{
            ...
            do {
              if (notTestForInputUTF32String (kUnicodeString__3B_, 1, gErrorMessage_10 COMMA_LINE_AND_SOURCE_FILE)) {
                ::scanner_routine_enterCharacterIntoString (*this, token.mLexicalAttribute_tokenString, previousChar ()) ;
              }else{
                loop = false ;
              }
            ...
            loop = true ;
            ::scanner_routine_convertHTMLSequenceToUnicodeCharacter (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_charValue, gErrorMessage_11) ;
          }else{
            lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
          }
        ...
        if (testForInputUTF32CharRange (TO_UNICODE ('!'), TO_UNICODE ('#')) ||
          ...
          lexicalError (gErrorMessage_12 COMMA_LINE_AND_SOURCE_FILE) ;
        }
        if (testForInputUTF32Char (TO_UNICODE ('$'))) {
        }else{
          lexicalError (gErrorMessage_13 COMMA_LINE_AND_SOURCE_FILE) ;
        }
        ...
        do {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            if (testForInputUTF32Char (TO_UNICODE ('f'))) {
              ...
              loop = true ;
              ::scanner_routine_convertHTMLSequenceToUnicodeCharacter (*this, token.mLexicalAttribute_identifierString, token.mLexicalAttribute_charValue, gErrorMessage_11) ;
              ::scanner_routine_enterCharacterIntoString (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_charValue) ;
            }else if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
              lexicalWarning (gErrorMessage_15 COMMA_LINE_AND_SOURCE_FILE) ;
              do {
                ::scanner_routine_enterHexDigitIntoASCIIcharacter (*this, token.mLexicalAttribute_charValue, previousChar (), gErrorMessage_5, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
                }else{
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\"'))) {
          ...
          lexicalError (gErrorMessage_14 COMMA_LINE_AND_SOURCE_FILE) ;
        }
      }else if (testForInputUTF32Char (TO_UNICODE ('#'))) {
        do {
