  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        do {
          enterCharacterIntoString (identifierString, toLower (previousChar ()), * this) ;
          enterCharacterIntoString (tokenString, previousChar (), * this) ;
          if (testForInputChar ('a', 'z') ||
              testForInputChar ('A', 'Z') ||
              testForInputChar ('_') ||
        ...
        if (testForInputChar ('\\')) {
          if (testForInputChar ('f')) {
            ...
            do {
              enterHexDigitIntoASCIIcharacter (charValue, previousChar (), gErrorMessage_4, gErrorMessage_1, * this) ;
              if (testForInputChar ('0', '9')) {
              }else{
                loop_ = false ;
              }
          ...
          enterCharacterIntoCharacter (charValue, previousChar (), * this) ;
        }else{
          lexicalError (gErrorMessage_3) ;
        }
        if (testForInputChar ('\'')) {
