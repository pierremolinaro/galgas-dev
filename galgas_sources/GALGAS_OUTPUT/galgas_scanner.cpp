...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasDelimitorsList = 30 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasDelimitorsList [30] = {
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        }else if (testForInputChar (' ', ((char) 0xFF))) {
