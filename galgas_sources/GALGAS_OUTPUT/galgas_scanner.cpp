...
static const char * gSyntaxErrorMessage_first = "the 'first' keyword" ;
...
//--- Syntax error message for terminal '$oppositeOf$' :
static const char * gSyntaxErrorMessage_oppositeOf = "the 'oppositeOf' keyword" ;
...
static const char * gSyntaxErrorMessage_attribute = "the 'attribute' keyword" ;
//--- Syntax error message for terminal '$ref$' :
static const char * gSyntaxErrorMessage_ref = "the 'ref' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [107] = {"end of source",
       ...
       gSyntaxErrorMessage_oppositeOf,
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasDelimitorsList = 33 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasDelimitorsList [33] = {
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 66 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [66] = {
  ...
  C_lexique_table_entry ("ref", 3, galgas_scanner_1_ref),
  ...
  C_lexique_table_entry ("first", 5, galgas_scanner_1_first),
  ...
  C_lexique_table_entry ("attribute", 9, galgas_scanner_1_attribute),
  ...
  C_lexique_table_entry ("oppositeOf", 10, galgas_scanner_1_oppositeOf),
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        if (testForInputChar ('S') ||
            testForInputChar ('s')) {
          scanner_action_convertUlongToLong (longValue, ulongValue, gErrorMessage_0) ;
        ...
        if (testForInputChar ('\\')) {
          if (testForInputChar ('f')) {
            ...
            if (testForInputChar ('0', '9') ||
                ...
                testForInputChar ('A', 'F')) {
              do {
                scanner_action_enterHexDigitIntoASCIIcharacter (charValue, previousChar (), gErrorMessage_4, gErrorMessage_1) ;
                if (testForInputChar ('0', '9') ||
                    testForInputChar ('a', 'f') ||
                    testForInputChar ('A', 'F')) {
                }else{
