...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [128] = {"end of source",
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasDelimitorsList = 38 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasDelimitorsList [38] = {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        if (testForInputChar ('S') ||
          ...
          _enterToken (galgas_scanner_1_signed_5Fliteral_5Finteger) ;
          ...
          _enterToken (galgas_scanner_1_signed_5Fliteral_5Finteger64) ;
          ...
          _enterToken (galgas_scanner_1_unsigned_5Fliteral_5Finteger64) ;
          ...
          _enterToken (galgas_scanner_1_literal_5Fdouble) ;
        }else{
          ...
          _enterToken (galgas_scanner_1_unsigned_5Fliteral_5Finteger) ;
        }
      }else if (testForInputChar ('.')) {
        if (testForInputChar ('0', '9')) {
          ...
          if (testForInputString ("..", 2)) {
            ...
            _enterToken (galgas_scanner_1__2E_2E_2E) ;
          }else if (testForInputString ("=", 1)) {
            mCurrentTokenCode = galgas_scanner_1__2E_3D ;
            _enterToken (galgas_scanner_1__2E_3D) ;
          }else{
            mCurrentTokenCode = galgas_scanner_1__2E ;
            _enterToken (galgas_scanner_1__2E) ;
          }
        }
      }else if (testForInputChar ('@')) {
        if (testForInputChar ('a', 'z') ||
        ...
        _enterToken (galgas_scanner_1_type_5Fname) ;
      }else if (testForInputChar ('%')) {
        if (testForInputChar ('a', 'z') ||
            testForInputChar ('A', 'Z') ||
            testForInputChar ('_')) {
        ...
        mCurrentTokenCode = galgas_scanner_1_mda_5Ftype_5Fname ;
        _enterToken (galgas_scanner_1_mda_5Ftype_5Fname) ;
      }else if (testForInputChar ('\'')) {
        if (testForInputChar ('\\')) {
          if (testForInputChar ('f')) {
            ...
            if (testForInputChar ('0', '9') ||
                ...
                testForInputChar ('A', 'F')) {
              do {
                scanner_action_enterHexDigitIntoASCIIcharacter (charValue, previousChar (), gErrorMessage_6, gErrorMessage_2) ;
                if (testForInputChar ('0', '9') ||
                    testForInputChar ('a', 'f') ||
                    testForInputChar ('A', 'F')) {
                }else{
        ...
        if (testForInputChar ('\'')) {
          ...
          _enterToken (galgas_scanner_1_literal_5Fchar) ;
        }else{
          lexicalError (gErrorMessage_5 COMMA_LINE_AND_SOURCE_FILE) ;
        }
      }else if (testForInputChar ('$')) {
        ...
        if (testForInputChar ('\"')) {
          ...
          _enterToken (galgas_scanner_1_literal_5Fstring) ;
        }else{
...
const char * galgas_scanner::getStyleName (const sint32 inIndex) {
  const char * kStylesArray [11] = {"Default style", "Keywords:", "Delimiters:", "Terminal Symbols:", "Integer Constants:", "Floating Point Constants:", "Character Constants:", "String Constants:", "Type Names (@...):", "MDA Type Names (%...):", NULL} ;
...
const char * galgas_scanner::getStyleIdentifier (const sint32 inIndex) {
  const char * kStylesArray [11] = {"", "keywordsStyle", "delimitersStyle", "terminalStyle", "integerStyle", "float_csts", "characterStyle", "stringStyle", "typeNameStyle", "mdaTypeNameStyle", NULL} ;
  return (inIndex < 10) ? kStylesArray [inIndex] : NULL ;
} ;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [128] = {0,
    ...
    9 /* galgas_scanner_1_mda_5Ftype_5Fname */,
...
void galgas_scanner::_enterToken (const sint16 inTokenCode) {
  ...
  _p->uint32value = uint32value ;
  _p->sint32value = sint32value ;
  _p->uint64value = uint64value ;
  _p->sint64value = sint64value ;
  _p->charValue = charValue ;
  _p->tokenString = tokenString ;
  _p->floatValue = floatValue ;
  _enterTokenFromPointer (_p) ;
}

//---------------------------------------------------------------------------*

void galgas_scanner::_restoreContextFromToken (void) {
  ...
  uint32value = _p->uint32value ;
  sint32value = _p->sint32value ;
  uint64value = _p->uint64value ;
  sint64value = _p->sint64value ;
  charValue = _p->charValue ;
  tokenString = _p->tokenString ;
  floatValue = _p->floatValue ;
}
...
_assignFromAttribute_identifierString (GGS_lstring & outValue) const {
  outValue = GGS_lstring (* this, identifierString) ;
}
...
_assignFromAttribute_uint32value (GGS_luint & outValue) const {
  outValue = GGS_luint (* this, uint32value) ;
}
...
_assignFromAttribute_sint32value (GGS_lsint & outValue) const {
  outValue = GGS_lsint (* this, sint32value) ;
}
...
_assignFromAttribute_uint64value (GGS_luint64 & outValue) const {
  outValue = GGS_luint64 (* this, uint64value) ;
}
...
_assignFromAttribute_sint64value (GGS_lsint64 & outValue) const {
  outValue = GGS_lsint64 (* this, sint64value) ;
}
...
_assignFromAttribute_charValue (GGS_lchar & outValue) const {
  outValue = GGS_lchar (* this, charValue) ;
}
...
_assignFromAttribute_tokenString (GGS_lstring & outValue) const {
  outValue = GGS_lstring (* this, tokenString) ;
}
...
_assignFromAttribute_floatValue (GGS_ldouble & outValue) const {
  outValue = GGS_ldouble (* this, floatValue) ;
}
