...
//--- Syntax error message for terminal '$abstract__$' :
static const char * gSyntaxErrorMessage_abstract_5F_5F = "the 'abstract__' keyword" ;

//--- Syntax error message for terminal '$class__$' :
static const char * gSyntaxErrorMessage_class_5F_5F = "the 'class__' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [124] = {"end of source",
       ...
       gSyntaxErrorMessage_abstract_5F_5F,
       gSyntaxErrorMessage_class_5F_5F,
...
const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [72] = {
  ...
  C_lexique_table_entry ("class__", 7, galgas_scanner_1_class_5F_5F),
  ...
  C_lexique_table_entry ("abstract__", 10, galgas_scanner_1_abstract_5F_5F),
...
getCurrentTokenString (void) const {
  ...
  case  galgas_scanner_1_mapindex:
    s << '$'
      ...
      << '$' ;
    break;
  case  galgas_scanner_1_abstract_5F_5F:
    s << '$'
      << "abstract__"
      << '$' ;
    break;
  case  galgas_scanner_1_class_5F_5F:
    s << '$'
      << "class__"
      << '$' ;
    break;
...
const char * galgas_scanner::getStyleName (const sint32 inIndex) {
  const char * kStylesArray [10] = {"Default style", "Keywords:", "Delimiters:", "Terminal Symbols:", "Integer Constants:", "Floating Point Constants:", "Character Constants:", "String Constants:", "Type Names (@...):", NULL} ;
...
const char * galgas_scanner::getStyleIdentifier (const sint32 inIndex) {
  const char * kStylesArray [10] = {"", "keywordsStyle", "delimitersStyle", "terminalStyle", "integerStyle", "float_csts", "characterStyle", "stringStyle", "typeNameStyle", NULL} ;
  return (inIndex < 9) ? kStylesArray [inIndex] : NULL ;
} ;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [124] = {0,
    ...
    1 /* galgas_scanner_1_abstract_5F_5F */,
    1 /* galgas_scanner_1_class_5F_5F */,
