...
//                    december 10th, 2006, at 20h54'12"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
const char * galgas_scanner::getStyleName (const sint32 inIndex) {
  const char * kStylesArray [12] = {"Default style", "Keywords:", "Delimiters:", "Terminal Symbols:", "Integer Constants:", "Floating Point Constants:", "Character Constants:", "String Constants:", "Type Names (@...):", "MDA Type Names (%...):", "Comments:", NULL} ;
...
const char * galgas_scanner::getStyleIdentifier (const sint32 inIndex) {
  const char * kStylesArray [12] = {"", "keywordsStyle", "delimitersStyle", "terminalStyle", "integerStyle", "float_csts", "characterStyle", "stringStyle", "typeNameStyle", "mdaTypeNameStyle", "commentStyle", NULL} ;
  return (inIndex < 11) ? kStylesArray [inIndex] : NULL ;
} ;
