...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 68 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [68] = {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        if (testForInputChar ('$')) {
          ...
          lexicalError (gErrorMessage_6 LINE_AND_SOURCE_FILE) ;
        }
        ...
        if (testForInputChar ('\"')) {
          ...
          lexicalError (gErrorMessage_7 LINE_AND_SOURCE_FILE) ;
        }
      }else if (testForInputChar ('#')) {
        do {
