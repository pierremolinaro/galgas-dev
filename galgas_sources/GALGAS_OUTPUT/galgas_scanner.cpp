...
static const char * gSyntaxErrorMessage_until = "the 'until' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [143] = {"end of source",
...
const sint16 galgas_scanner::galgas_scanner_table_size_galgasKeyWordList = 88 ;

const C_lexique_table_entry galgas_scanner::galgas_scanner_table_for_galgasKeyWordList [88] = {
  ...
  C_lexique_table_entry ("lazy", 4, galgas_scanner_1_lazy),
  ...
  C_lexique_table_entry ("until", 5, galgas_scanner_1_until),
  ...
  C_lexique_table_entry ("project", 7, galgas_scanner_1_project),
  ...
  C_lexique_table_entry ("function", 8, galgas_scanner_1_function),
  ...
  C_lexique_table_entry ("dependency", 10, galgas_scanner_1_dependency),
      ...
      if (testForInputChar (UNICODE_NEW ('a'), UNICODE_NEW ('z')) ||
        ...
        do {
          if (testForInputChar (UNICODE_NEW ('0'), UNICODE_NEW ('9'))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          }else if (testForInputChar (UNICODE_NEW ('a'), UNICODE_NEW ('f'))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          }else if (testForInputChar (UNICODE_NEW ('A'), UNICODE_NEW ('F'))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
        ...
        if (testForInputChar (UNICODE_NEW ('\\'))) {
          if (testForInputChar (UNICODE_NEW ('f'))) {
            ...
            if (testForInputChar (UNICODE_NEW ('0'), UNICODE_NEW ('9')) ||
                testForInputChar (UNICODE_NEW ('a'), UNICODE_NEW ('f')) ||
                testForInputChar (UNICODE_NEW ('A'), UNICODE_NEW ('F'))) {
              do {
        ...
        }else if (testForInputChar (UNICODE_NEW (' '), UNICODE_NEW (255))) {
        ...
        if (testForInputChar (UNICODE_NEW ('!'), UNICODE_NEW ('#')) ||
            testForInputChar (UNICODE_NEW ('%'), UNICODE_NEW ('~'))) {
          do {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
            if (testForInputChar (UNICODE_NEW ('!'), UNICODE_NEW ('#')) ||
                testForInputChar (UNICODE_NEW ('%'), UNICODE_NEW ('~'))) {
        ...
        do {
          if (testForInputChar (UNICODE_NEW ('\\'))) {
            if (testForInputChar (UNICODE_NEW ('f'))) {
              ...
              testForInputChar (UNICODE_NEW ('#'), UNICODE_NEW (255))) {
            scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          }else{
            loop_ = false ;
          }
