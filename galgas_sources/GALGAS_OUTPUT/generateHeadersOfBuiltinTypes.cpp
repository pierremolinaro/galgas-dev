...
result << " &) ;\n"
  ...
  "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_3261 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (69))), true) ;
const GGS_readerMap::cElement * operand_3261 = NULL ;
while (((operand_3261 = enumerator_3261.nextObject ()))) {
  macroValidPointer (operand_3261) ;
  if ((operand_3261->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_HERE)).boolValue ()) {
    result << "  protected : virtual GALGAS_" ;
    result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_3261->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_3261->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (71))) ;
    result << " * reader_" ;
    result << operand_3261->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
    result << " (" ;
    const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
    GGS_typeList::cEnumerator enumerator_3473 (operand_3261->mInfo.mArgumentTypeList, true) ;
    const GGS_typeList::cElement * operand_3473 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_3473 = enumerator_3473.nextObject ()))) {
    macroValidPointer (operand_3473) ;
    result << "const GALGAS_" ;
    result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_3473->mType (HERE)->galgasRTTI ()) (inLexique, operand_3473->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (73))) ;
    result << " * inOperand" ;
...
if ((operand_3261->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
  if (operand_3261->mInfo.mHasLexiqueArgument.boolValue ()) {
    result << "C_Compiler * inCompiler\n" ;
    result << var_cas_COL ;
    result << "COMMA_LOCATION_ARGS" ;
  }else {
...
result << ") const" ;
if ((operand_3261->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_HERE)).boolValue ()) {
  result << " = 0" ;
}else {
}
result << " ;\n"
...
GGS_stringlist::cEnumerator enumerator_11675 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (263))), true) ;
const GGS_stringlist::cElement * operand_11675 = NULL ;
while (((operand_11675 = enumerator_11675.nextObject ()))) {
macroValidPointer (operand_11675) ;
result << "  private : const GALGAS_" ;
result << operand_11675->mValue.reader_identifierRepresentation () ;
result << " * m" ;
result << operand_11675->mValue.reader_stringByCapitalizingFirstCharacter () ;
result << "Value ;\n"
...
result << "//--------------------------------- Friends\n" ;
GGS_readerMap::cEnumerator enumerator_12110 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (269))), true) ;
const GGS_readerMap::cElement * operand_12110 = NULL ;
while (((operand_12110 = enumerator_12110.nextObject ()))) {
macroValidPointer (operand_12110) ;
if ((operand_12110->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "  friend GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_12110->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_12110->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (271))) ;
result << " * readerCall_" ;
result << operand_12110->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_12352 (operand_12110->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_12352 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12352 = enumerator_12352.nextObject ()))) {
macroValidPointer (operand_12352) ;
result << ",\n" ;
result << var_cas_COL ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_12352->mType (HERE)->galgasRTTI ()) (inLexique, operand_12352->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (274))) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (274)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_12110->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << "} ;\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_readerMap::cEnumerator enumerator_12783 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (288))), true) ;
const GGS_readerMap::cElement * operand_12783 = NULL ;
while (((operand_12783 = enumerator_12783.nextObject ()))) {
macroValidPointer (operand_12783) ;
if ((operand_12783->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "inline GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_12783->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_12783->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (290))) ;
result << " * readerCall_" ;
result << operand_12783->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (290)) ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_13023 (operand_12783->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_13023 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13023 = enumerator_13023.nextObject ()))) {
macroValidPointer (operand_13023) ;
result << ",\n" ;
result << var_cas_COL ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_13023->mType (HERE)->galgasRTTI ()) (inLexique, operand_13023->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (293))) ;
result << " * inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (293)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_12783->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << ") {\n"
  "  GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_12783->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_12783->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (301))) ;
result << " * result = NULL ;\n"
  "  if (inObject != NULL) {\n"
  "    result = inObject->reader_" ;
result << operand_12783->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (303)) ;
result << " (" ;
GGS_typeList::cEnumerator enumerator_13526 (operand_12783->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_13526 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13526 = enumerator_13526.nextObject ()))) {
macroValidPointer (operand_13526) ;
result << "inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (305)) ;
if (enumerator_13526.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_12783->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_12783->mInfo.mHasLexiqueArgument.boolValue ()) {
...
category_method__ACGalgasType__appendGeneratedHeader (C_Compiler &,
                                const cPtr_ACGalgasType * operand_9823,
                                GGS_string & /* var_cas_ioHeader */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9823 != NULL) {
  }
}
...
category_method__primitiveGalgasType__appendGeneratedHeader (C_Compiler & inLexique,
                                const cPtr_primitiveGalgasType * operand_10003,
                                GGS_string & var_cas_ioHeader
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10003 != NULL) {
GGS_ACGalgasType  var_cas_t = operand_10003 ;
var_cas_ioHeader.dotAssign_operation (template_filewrapper_builtinTypeGenerationTemplate_primitiveTypeHeader (inLexique, (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (235))), var_cas_t)) ;
  }
}
...
category_method__ACGalgasType__appendGeneratedImplementation (C_Compiler &,
                                const cPtr_ACGalgasType * operand_11056,
                                GGS_string & /* var_cas_ioImplementation */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11056 != NULL) {
  }
}
...
category_method__primitiveGalgasType__appendGeneratedImplementation (C_Compiler &,
                                const cPtr_primitiveGalgasType * operand_11252,
                                GGS_string & /* var_cas_ioImplementation */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11252 != NULL) {
  }
}
...
category_method__listGalgasType__appendGeneratedImplementation (C_Compiler & inLexique,
                                const cPtr_listGalgasType * operand_11443,
                                GGS_string & var_cas_ioImplementation
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11443 != NULL) {
GGS_ACGalgasType  var_cas_t = operand_11443 ;
GGS_listGalgasType  var_cas_tt = operand_11443 ;
var_cas_ioImplementation.dotAssign_operation (template_filewrapper_builtinTypeGenerationTemplate_listTypeImplementation (inLexique, (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (271))), var_cas_tt.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))) ;
  }
}
...
void routine_generateHeadersOfBuiltinTypes (C_Compiler & inLexique,
  ...
  #endif
const GGS_bool cond_13367 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
if (cond_13367.isBuiltAndTrue ()) {
const GGS_bool cond_12347 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
if (cond_12347.isBuiltAndTrue ()) {
...
}else if (cond_12347.isBuiltAndFalse ()) {
GGS_string var_cas_generatedCode = template_filewrapper_builtinTypeGenerationTemplate_predefinedTypesHeader (inLexique, function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (289))) ;
{
GGS_typeMap::cEnumerator enumerator_12561 (function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), true) ;
const GGS_typeMap::cElement * operand_12561 = NULL ;
while (((operand_12561 = enumerator_12561.nextObject ()))) {
  macroValidPointer (operand_12561) ;
const GGS_ACGalgasType  temp_12604 = operand_12561->mInfo.mType ;
if (temp_12604.isBuilt ()) {
  typeCategoryMethod__ACGalgasType__appendGeneratedHeader method = findCategoryMethod__ACGalgasType__appendGeneratedHeader (temp_12604.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, temp_12604 (HERE), var_cas_generatedCode COMMA_SOURCE_FILE_AT_LINE (292)) ;
  }
}
}
}
...
{
GGS_typeMap::cEnumerator enumerator_13046 (function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (306)), true) ;
const GGS_typeMap::cElement * operand_13046 = NULL ;
while (((operand_13046 = enumerator_13046.nextObject ()))) {
  macroValidPointer (operand_13046) ;
const GGS_ACGalgasType  temp_13097 = operand_13046->mInfo.mType ;
if (temp_13097.isBuilt ()) {
  typeCategoryMethod__ACGalgasType__appendGeneratedImplementation method = findCategoryMethod__ACGalgasType__appendGeneratedImplementation (temp_13097.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, temp_13097 (HERE), var_cas_generatedCode COMMA_SOURCE_FILE_AT_LINE (307)) ;
  }
}
}
}
GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefinedTypes2.cpp"), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_generatedCode, GGS_string ("\n"
  "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (309)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
