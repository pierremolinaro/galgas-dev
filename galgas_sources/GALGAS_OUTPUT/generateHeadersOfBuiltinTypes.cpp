...
category_reader__objectGalgasType__pointerAttributeCppTypeName (C_Compiler &,
  ...
  if (operand_4562 != NULL) {
    var_cas_outTypeName = GGS_string ("GALGAS__root") ;
  }
  return var_cas_outTypeName ;
}
...
category_reader__typeGalgasType__pointerAttributeCppTypeName (C_Compiler &,
                                const cPtr_typeGalgasType * operand_4774
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outTypeName ;
...
category_reader__ACGalgasType__classAttributeCppTypeName (C_Compiler &,
                                const cPtr_ACGalgasType * operand_5297
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outTypeName ;
  if (operand_5297 != NULL) {
    var_cas_outTypeName = GGS_string ("") ;
  }
  return var_cas_outTypeName ;
}
...
category_reader__stringGalgasType__classAttributeCppTypeName (C_Compiler &,
                                const cPtr_stringGalgasType * operand_5525
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outTypeName ;
  if (operand_5525 != NULL) {
...
category_reader__ACGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_ACGalgasType * operand_6030
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__lstringGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_lstringGalgasType * operand_6254
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_6254 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
category_reader__lcharGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_lcharGalgasType * operand_6536
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_6536 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
category_reader__luintGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_luintGalgasType * operand_6816
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
...
category_reader__lsintGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_lsintGalgasType * operand_7096
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_7096 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
category_reader__luint64GalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_luint64GalgasType * operand_7378
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_7378 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
category_reader__lsint64GalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_lsint64GalgasType * operand_7662
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_7662 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
category_reader__lboolGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_lboolGalgasType * operand_7944
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_7944 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
category_reader__ldoubleGalgasType__embeddedObjectTypeNames (C_Compiler &,
                                const cPtr_ldoubleGalgasType * operand_8226
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist  var_cas_outTypeList ;
  if (operand_8226 != NULL) {
    var_cas_outTypeList = GGS_stringlist ::constructor_emptyList () ;
...
GGS_string function_generateCppReaderArguments (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9145 = (var_cas_inCppTypeNameOfCurrentObject).operator_isNotEqual (GGS_string ("")) ;
  ...
  const GGS_bool cond_9338 = var_cas_inHasLexiqueArgument ;
  if (cond_9338.isBuiltAndTrue ()) {
    const GGS_bool cond_9231 = var_cas_first ;
    if (cond_9231.isBuiltAndTrue ()) {
      var_cas_first = GGS_bool (false) ;
    }else if (cond_9231.isBuiltAndFalse ()) {
  ...
  }
  {
    ...
    GGS_typeList::cEnumerator enumerator_9372 (var_cas_inArgumentTypeList, true) ;
    const GGS_typeList::cElement * operand_9372 = NULL ;
    while (((operand_9372 = enumerator_9372.nextObject ()))) {
      macroValidPointer (operand_9372) ;
      const GGS_bool cond_9436 = var_cas_first ;
      if (cond_9436.isBuiltAndTrue ()) {
        var_cas_first = GGS_bool (false) ;
      }else if (cond_9436.isBuiltAndFalse ()) {
        var_cas_outString.appendCString (",\n") ;
        var_cas_outString.dotAssign_operation (var_cas_inIndentation) ;
      }
      var_cas_outString.appendCString ("const ") ;
      var_cas_outString.dotAssign_operation (function_cppTypeName (inLexique, operand_9372->mType COMMA_SOURCE_FILE_AT_LINE (227))) ;
  ...
  const GGS_bool cond_9652 = var_cas_first ;
  if (cond_9652.isBuiltAndTrue ()) {
    var_cas_outString.appendCString ("LOCATION_ARGS") ;
  }else if (cond_9652.isBuiltAndFalse ()) {
    var_cas_outString.appendCString ("\n") ;
    var_cas_outString.dotAssign_operation (var_cas_inIndentation) ;
...
template_filewrapper_builtinTypeGenerationTemplate_header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_lstringlist::cEnumerator enumerator_425 (var_cas_PREDEFINED_TYPE_LIST, true) ;
    const GGS_lstringlist::cElement * operand_425 = NULL ;
    while (((operand_425 = enumerator_425.nextObject ()))) {
      macroValidPointer (operand_425) ;
      result << "class " ;
      result << function_cppTypeNameForGalgasTypeName (inLexique, operand_425->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) COMMA_SOURCE_FILE_AT_LINE (16)) ;
      result << " ;\n" ;
    }
    ...
    if (((findCategoryReader__ACGalgasType__scalarAttributeCppTypeName (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (35))).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_stringlist::cEnumerator enumerator_2337 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (46))), true) ;
      const GGS_stringlist::cElement * operand_2337 = NULL ;
      while (((operand_2337 = enumerator_2337.nextObject ()))) {
        macroValidPointer (operand_2337) ;
        result << "const " ;
        result << function_cppTypeNameForGalgasTypeName (inLexique, operand_2337->mValue COMMA_SOURCE_FILE_AT_LINE (47)) ;
        result << " * in" ;
        result << operand_2337->mValue.reader_stringByCapitalizingFirstCharacter () ;
        result << "Value" ;
        if (enumerator_2337.hasNextObject ()) {
          result << ",\n" ;
          result << var_cas_COL1 ;
        }
      }
      ...
      GGS_stringlist::cEnumerator enumerator_2646 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (52))), true) ;
      const GGS_stringlist::cElement * operand_2646 = NULL ;
      while (((operand_2646 = enumerator_2646.nextObject ()))) {
        macroValidPointer (operand_2646) ;
        result << "const " ;
        result << function_cppTypeNameForGalgasTypeName (inLexique, operand_2646->mValue COMMA_SOURCE_FILE_AT_LINE (53)) ;
        result << " * in" ;
        result << operand_2646->mValue.reader_stringByCapitalizingFirstCharacter () ;
        result << "Value" ;
        if (enumerator_2646.hasNextObject ()) {
          result << ",\n" ;
          result << var_cas_COL2 ;
        }
      }
    ...
    GGS_constructorMap::cEnumerator enumerator_2958 ((findCategoryReader__ACGalgasType__constructorMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (61))), true) ;
    const GGS_constructorMap::cElement * operand_2958 = NULL ;
    if (enumerator_2958.hasCurrentObject ()) {
      ...
      while (((operand_2958 = enumerator_2958.nextObject ()))) {
        ...
        result << function_cppTypeName (inLexique, operand_2958->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (64)) ;
        result << " * constructor_" ;
        result << operand_2958->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
        result << " (" ;
        const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
        GGS_typeList::cEnumerator enumerator_3146 (operand_2958->mInfo.mArgumentTypeList, true) ;
        const GGS_typeList::cElement * operand_3146 = NULL ;
        { GGS_uint var_cas_IDX (true, 0) ;
      while (((operand_3146 = enumerator_3146.nextObject ()))) {
        macroValidPointer (operand_3146) ;
        result << "const " ;
        result << function_cppTypeName (inLexique, operand_3146->mType COMMA_SOURCE_FILE_AT_LINE (66)) ;
        result << " * inOperand" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (66)) ;
        if (enumerator_3146.hasNextObject ()) {
          result << ",\n" ;
          result << var_cas_COL ;
        }
    ...
    if ((operand_2958->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
      if (operand_2958->mInfo.mHasLexique.boolValue ()) {
...
result << " &) ;\n"
  ...
  "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_4058 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (96))), true) ;
const GGS_readerMap::cElement * operand_4058 = NULL ;
while (((operand_4058 = enumerator_4058.nextObject ()))) {
  macroValidPointer (operand_4058) ;
  if ((operand_4058->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_HERE)).boolValue ()) {
    result << "  protected : virtual " ;
    result << function_cppTypeName (inLexique, operand_4058->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (98)) ;
    result << " * reader_" ;
    result << operand_4058->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
    result << " (" ;
    const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
    GGS_typeList::cEnumerator enumerator_4247 (operand_4058->mInfo.mArgumentTypeList, true) ;
    const GGS_typeList::cElement * operand_4247 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4247 = enumerator_4247.nextObject ()))) {
    macroValidPointer (operand_4247) ;
    result << "const " ;
    result << function_cppTypeName (inLexique, operand_4247->mType COMMA_SOURCE_FILE_AT_LINE (100)) ;
    result << " * inOperand" ;
...
if ((operand_4058->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
  if (operand_4058->mInfo.mHasLexiqueArgument.boolValue ()) {
    result << "C_Compiler * inCompiler\n" ;
    result << var_cas_COL ;
    result << "COMMA_LOCATION_ARGS" ;
  }else {
...
result << ") const" ;
if ((operand_4058->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_HERE)).boolValue ()) {
  result << " = 0" ;
}else {
}
result << " ;\n"
...
result << "  public : virtual PMSInt32 compareForSortedList (const GALGAS__root * inOperand\n"
...
GGS_stringlist::cEnumerator enumerator_12296 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (290))), true) ;
const GGS_stringlist::cElement * operand_12296 = NULL ;
while (((operand_12296 = enumerator_12296.nextObject ()))) {
macroValidPointer (operand_12296) ;
result << "  private : const " ;
result << function_cppTypeNameForGalgasTypeName (inLexique, operand_12296->mValue COMMA_SOURCE_FILE_AT_LINE (291)) ;
result << " * m" ;
result << operand_12296->mValue.reader_stringByCapitalizingFirstCharacter () ;
result << "Value ;\n"
  "  public : inline const " ;
result << function_cppTypeNameForGalgasTypeName (inLexique, operand_12296->mValue COMMA_SOURCE_FILE_AT_LINE (292)) ;
...
result << "//--------------------------------- Friends\n" ;
GGS_readerMap::cEnumerator enumerator_12691 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (296))), true) ;
const GGS_readerMap::cElement * operand_12691 = NULL ;
while (((operand_12691 = enumerator_12691.nextObject ()))) {
macroValidPointer (operand_12691) ;
if ((operand_12691->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "  friend " ;
result << function_cppTypeName (inLexique, operand_12691->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (298)) ;
result << " * readerCall_" ;
result << operand_12691->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (298)) ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const " ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_12903 (operand_12691->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_12903 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_COL ;
result << "const " ;
result << function_cppTypeName (inLexique, operand_12903->mType COMMA_SOURCE_FILE_AT_LINE (301)) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_12691->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << "*\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_readerMap::cEnumerator enumerator_13623 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (319))), true) ;
const GGS_readerMap::cElement * operand_13623 = NULL ;
while (((operand_13623 = enumerator_13623.nextObject ()))) {
macroValidPointer (operand_13623) ;
if ((operand_13623->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "inline " ;
result << function_cppTypeName (inLexique, operand_13623->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (321)) ;
result << " * readerCall_" ;
result << operand_13623->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (321)) ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const " ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_13833 (operand_13623->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_13833 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13833 = enumerator_13833.nextObject ()))) {
macroValidPointer (operand_13833) ;
result << ",\n" ;
result << var_cas_COL ;
result << "const " ;
result << function_cppTypeName (inLexique, operand_13833->mType COMMA_SOURCE_FILE_AT_LINE (324)) ;
result << " * inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (324)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_13623->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << ") {\n"
  "  " ;
result << function_cppTypeName (inLexique, operand_13623->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (332)) ;
result << " * result = NULL ;\n"
  "  if (inObject != NULL) {\n"
  "    result = inObject->reader_" ;
result << operand_13623->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
result << " (" ;
GGS_typeList::cEnumerator enumerator_14290 (operand_13623->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_14290 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_14290.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_13623->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_13623->mInfo.mHasLexiqueArgument.boolValue ()) {
...
const GGS_bool cond_10362 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
if (cond_10362.isBuiltAndTrue ()) {
...
}else if (cond_10362.isBuiltAndFalse ()) {
const GGS_typeMap  var_cas_builtinTypeMap = function_constructPrimitiveTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
{
GGS_typeMap::cEnumerator enumerator_10461 (var_cas_builtinTypeMap, true) ;
const GGS_typeMap::cElement * operand_10461 = NULL ;
while (((operand_10461 = enumerator_10461.nextObject ()))) {
  macroValidPointer (operand_10461) ;
const GGS_string var_cas_typeName = function_cppTypeName (inLexique, operand_10461->mInfo.mType COMMA_SOURCE_FILE_AT_LINE (256)) ;
GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, (var_cas_typeName).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), template_filewrapper_builtinTypeGenerationTemplate_header (inLexique, function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (263)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (263)), var_cas_typeName, operand_10461->mInfo.mType), GGS_string ("\n"
