...
template_filewrapper_builtinTypeGenerationTemplate_header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if (((findCategoryReader__ACGalgasType__scalarAttributeCppTypeName (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (35))).reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      GGS_stringlist::cEnumerator enumerator_2340 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (46))), true) ;
      const GGS_stringlist::cElement * operand_2340 = NULL ;
      while (((operand_2340 = enumerator_2340.nextObject ()))) {
        macroValidPointer (operand_2340) ;
        result << "const " ;
        result << function_cppTypeNameForGalgasTypeName (inLexique, operand_2340->mValue COMMA_SOURCE_FILE_AT_LINE (47)) ;
        result << " * in" ;
        result << operand_2340->mValue.reader_stringByCapitalizingFirstCharacter () ;
        result << "Value" ;
      ...
      GGS_stringlist::cEnumerator enumerator_2649 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (52))), true) ;
      const GGS_stringlist::cElement * operand_2649 = NULL ;
      while (((operand_2649 = enumerator_2649.nextObject ()))) {
        macroValidPointer (operand_2649) ;
        result << "const " ;
        result << function_cppTypeNameForGalgasTypeName (inLexique, operand_2649->mValue COMMA_SOURCE_FILE_AT_LINE (53)) ;
        result << " * in" ;
        result << operand_2649->mValue.reader_stringByCapitalizingFirstCharacter () ;
        result << "Value" ;
        if (enumerator_2649.hasNextObject ()) {
          result << ",\n" ;
          result << var_cas_COL2 ;
        }
      }
    ...
    GGS_constructorMap::cEnumerator enumerator_2961 ((findCategoryReader__ACGalgasType__constructorMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (61))), true) ;
    const GGS_constructorMap::cElement * operand_2961 = NULL ;
    if (enumerator_2961.hasCurrentObject ()) {
      ...
      while (((operand_2961 = enumerator_2961.nextObject ()))) {
        ...
        result << function_cppTypeName (inLexique, operand_2961->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (64)) ;
        result << " * constructor_" ;
        result << operand_2961->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
        result << " (" ;
        const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
        GGS_typeList::cEnumerator enumerator_3149 (operand_2961->mInfo.mArgumentTypeList, true) ;
        const GGS_typeList::cElement * operand_3149 = NULL ;
        { GGS_uint var_cas_IDX (true, 0) ;
      while (((operand_3149 = enumerator_3149.nextObject ()))) {
        macroValidPointer (operand_3149) ;
        result << "const " ;
        result << function_cppTypeName (inLexique, operand_3149->mType COMMA_SOURCE_FILE_AT_LINE (66)) ;
        result << " * inOperand" ;
    ...
    if ((operand_2961->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
      if (operand_2961->mInfo.mHasLexique.boolValue ()) {
...
result << " &) ;\n"
  ...
  "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_4061 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (96))), true) ;
const GGS_readerMap::cElement * operand_4061 = NULL ;
while (((operand_4061 = enumerator_4061.nextObject ()))) {
  macroValidPointer (operand_4061) ;
  if ((operand_4061->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_HERE)).boolValue ()) {
    result << "  protected : virtual " ;
    result << function_cppTypeName (inLexique, operand_4061->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (98)) ;
    result << " * reader_" ;
    result << operand_4061->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
    result << " (" ;
    const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
    GGS_typeList::cEnumerator enumerator_4250 (operand_4061->mInfo.mArgumentTypeList, true) ;
    const GGS_typeList::cElement * operand_4250 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4250 = enumerator_4250.nextObject ()))) {
    macroValidPointer (operand_4250) ;
    result << "const " ;
    result << function_cppTypeName (inLexique, operand_4250->mType COMMA_SOURCE_FILE_AT_LINE (100)) ;
    result << " * inOperand" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
    if (enumerator_4250.hasNextObject ()) {
      result << ",\n" ;
      result << var_cas_COL ;
    }
    var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_4061->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
  if (operand_4061->mInfo.mHasLexiqueArgument.boolValue ()) {
    result << "C_Compiler * inCompiler\n" ;
    result << var_cas_COL ;
    result << "COMMA_LOCATION_ARGS" ;
  }else {
...
result << ") const" ;
if ((operand_4061->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_HERE)).boolValue ()) {
  result << " = 0" ;
}else {
}
result << " ;\n"
...
GGS_stringlist::cEnumerator enumerator_12302 ((findCategoryReader__ACGalgasType__embeddedObjectTypeNames (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (290))), true) ;
const GGS_stringlist::cElement * operand_12302 = NULL ;
while (((operand_12302 = enumerator_12302.nextObject ()))) {
macroValidPointer (operand_12302) ;
result << "  private : const " ;
result << function_cppTypeNameForGalgasTypeName (inLexique, operand_12302->mValue COMMA_SOURCE_FILE_AT_LINE (291)) ;
result << " * m" ;
result << operand_12302->mValue.reader_stringByCapitalizingFirstCharacter () ;
result << "Value ;\n"
  "  public : inline const " ;
result << function_cppTypeNameForGalgasTypeName (inLexique, operand_12302->mValue COMMA_SOURCE_FILE_AT_LINE (292)) ;
...
result << "//--------------------------------- Friends\n" ;
GGS_readerMap::cEnumerator enumerator_12697 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (296))), true) ;
const GGS_readerMap::cElement * operand_12697 = NULL ;
while (((operand_12697 = enumerator_12697.nextObject ()))) {
macroValidPointer (operand_12697) ;
if ((operand_12697->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "  friend " ;
result << function_cppTypeName (inLexique, operand_12697->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (298)) ;
result << " * readerCall_" ;
result << operand_12697->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (298)) ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const " ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_12909 (operand_12697->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_12909 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_COL ;
result << "const " ;
result << function_cppTypeName (inLexique, operand_12909->mType COMMA_SOURCE_FILE_AT_LINE (301)) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_12697->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << "*\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_readerMap::cEnumerator enumerator_13629 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (319))), true) ;
const GGS_readerMap::cElement * operand_13629 = NULL ;
while (((operand_13629 = enumerator_13629.nextObject ()))) {
macroValidPointer (operand_13629) ;
if ((operand_13629->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "inline " ;
result << function_cppTypeName (inLexique, operand_13629->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (321)) ;
result << " * readerCall_" ;
result << operand_13629->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (321)) ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const " ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_13839 (operand_13629->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_13839 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13839 = enumerator_13839.nextObject ()))) {
macroValidPointer (operand_13839) ;
result << ",\n" ;
result << var_cas_COL ;
result << "const " ;
result << function_cppTypeName (inLexique, operand_13839->mType COMMA_SOURCE_FILE_AT_LINE (324)) ;
result << " * inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (324)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_13629->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << ") {\n"
  "  " ;
result << function_cppTypeName (inLexique, operand_13629->mInfo.mReturnedType COMMA_SOURCE_FILE_AT_LINE (332)) ;
result << " * result = NULL ;\n"
  "  if (inObject != NULL) {\n"
  "    result = inObject->reader_" ;
result << operand_13629->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
result << " (" ;
GGS_typeList::cEnumerator enumerator_14296 (operand_13629->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_14296 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14296 = enumerator_14296.nextObject ()))) {
macroValidPointer (operand_14296) ;
result << "inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (336)) ;
if (enumerator_14296.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_13629->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_13629->mInfo.mHasLexiqueArgument.boolValue ()) {
