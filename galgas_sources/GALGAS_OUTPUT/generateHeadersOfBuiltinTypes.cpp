...
void routine_generateHeadersOfBuiltinTypes (C_Compiler & inLexique,
  ...
  #endif
const GGS_bool cond_11418 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
if (cond_11418.isBuiltAndTrue ()) {
...
const GGS_typeMap  var_cas_primitiveTypeMap = function_constructPrimitiveTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) ;
{
GGS_typeMap::cEnumerator enumerator_10494 (var_cas_primitiveTypeMap, true) ;
const GGS_typeMap::cElement * operand_10494 = NULL ;
while (((operand_10494 = enumerator_10494.nextObject ()))) {
  macroValidPointer (operand_10494) ;
const GGS_string var_cas_typeName = function_cppTypeName (inLexique, operand_10494->mInfo.mType COMMA_SOURCE_FILE_AT_LINE (257)) ;
GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, (var_cas_typeName).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), template_filewrapper_builtinTypeGenerationTemplate_header (inLexique, function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (264)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (264)), var_cas_typeName, operand_10494->mInfo.mType), GGS_string ("\n"
  "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (258)) ;
}
}
GGS_string var_cas_generatedCode = GGS_string ("") ;
{
GGS_typeMap::cEnumerator enumerator_11036 (function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (274)), true) ;
const GGS_typeMap::cElement * operand_11036 = NULL ;
while (((operand_11036 = enumerator_11036.nextObject ()))) {
  macroValidPointer (operand_11036) ;
const GGS_bool cond_11163 = (var_cas_primitiveTypeMap.reader_hasKey (operand_11036->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (275)))).operator_not () ;
if (cond_11163.isBuiltAndTrue ()) {
var_cas_generatedCode.dotAssign_operation (operand_11036->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (276))) ;
var_cas_generatedCode.appendCString ("\n") ;
}
}
}
GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefiniedTypes2.h"), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_generatedCode, GGS_string ("\n"
  "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (279)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
