...
GGS_enumerableTypeDescriptionList::cEnumerator enumerator_4165 ((findCategoryReader__ACGalgasType__enumerable (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (116))), true) ;
const GGS_enumerableTypeDescriptionList::cElement * operand_4165 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4165->mType (HERE)->galgasRTTI ()) (inLexique, operand_4165->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (118))) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << "::cEnumerator::attribute_" ;
result << operand_4165->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4165->mType (HERE)->galgasRTTI ()) (inLexique, operand_4165->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (119))) ;
...
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4165->mType (HERE)->galgasRTTI ()) (inLexique, operand_4165->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (120))) ;
result << ") ;\n"
  "  return result ;\n"
  "}\n"
  "\n" ;
