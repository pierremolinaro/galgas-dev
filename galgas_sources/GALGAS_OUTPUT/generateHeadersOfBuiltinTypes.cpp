...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_A) ;
...
void cPtr_A::
method_zzz (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
GGS_A  var_cas_a = GGS_A (this) ;
}
...
AC_galgasClassRunTimeInformationEX * cPtr_A::galgasRTTI (void) const {
  return & gClassInfoFor__A ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_A ("A", true, NULL) ;

//---------------------------------------------------------------------------*

GGS_A::
GGS_A (const cPtr__AC_galgas_class * inPointer) {
...
GGS_A::
GGS_A (cPtr__AC_galgas_class & inObject) {
...
static cPtr_A * gSingleton_A = NULL ;
...
constructor_new (C_Compiler & /* inLexique */
                                COMMA_LOCATION_ARGS) {
  GGS_A result ;
  if (NULL == gSingleton_A) {
    macroMyNew (gSingleton_A, cPtr_A (THERE)) ;
    macroRetainObject (gSingleton_A) ;
  }
  macroAssignObject (result.mPointer, gSingleton_A) ;
  return result ;
}
...
AC_galgasClassRunTimeInformationEX * GGS_A::galgasObjectRunTimeInfo (void) const {
...
C_galgasRootClassRunTimeInformationEX gClassInfoFor__A ("A", & kTypeDescriptor_GGS_A) ;

//---------------------------------------------------------------------------*

GGS_object GGS_A::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_A * p = NULL ;
    macroMyNew (p, GGS_A (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_A GGS_A::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_A result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_A * p = dynamic_cast <const GGS_A *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_A, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_A::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_A ;
}
...
static void epilogueRoutineFor_generateHeadersOfBuiltinTypes (void) {
  ...
  macroReleaseObject (gSingleton_A) ;
}
