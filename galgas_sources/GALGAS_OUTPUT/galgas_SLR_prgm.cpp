          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              if (scanner_->sourceText () != NULL) {
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (37)) ;
              }
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              if (scanner_->sourceText () != NULL) {
                ...
                C_String message ;
                message << "the '" << sourceFileName << "' file exits, but cannot be read" ;
                var_cas_inSourceFile.signalSemanticError (_inLexique, message COMMA_SOURCE_FILE_AT_LINE (60)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
