...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "galgas_SLR_prgm.ggs" ;
...
grammar_galgas_SLR_prgm (const C_galgas_io_parameters & inParameters,
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          macroMyNew (compiler, grammar_galgas_SLR_prgm (IOparameters, C_galgas_io::kTerminalOutputKind COMMA_HERE)) ;
          compiler->_prologue () ;
