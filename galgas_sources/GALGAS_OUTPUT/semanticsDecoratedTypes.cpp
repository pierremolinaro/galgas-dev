...
mHasInsertOrReplaceModifier (argument_4) {
}
...
cPtr__AC_galgas_class * cPtr_mapTypeForGeneration::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_mapTypeForGeneration (mTypeIndex, mMapTypeName, mTypedAttributeList, mInsertMethodList, mHasInsertOrReplaceModifier COMMA_HERE)) ;
  return result ;
}
