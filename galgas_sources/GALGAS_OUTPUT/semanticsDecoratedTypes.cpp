...
cPtr_semanticTypeDeclarationForGeneration::
cPtr_semanticTypeDeclarationForGeneration (const GGS_unifiedTypeMapIndex & argument_0
                                COMMA_LOCATION_ARGS)
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_semanticTypeDeclarationForGeneration * GGS_semanticTypeDeclarationForGeneration::
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_semanticTypeDeclarationForGeneration) ;
...
void cPtr_semanticTypeDeclarationForGeneration::
appendForDescription (C_String & ioString,
                      const PMSInt32 inIndentation) const {
  ioString << "->@semanticTypeDeclarationForGeneration:"
...
const char * cPtr_semanticTypeDeclarationForGeneration::
instanceMessage (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_semanticTypeDeclarationForGeneration (& typeid (cPtr_semanticTypeDeclarationForGeneration), & typeid (cPtr_semanticDeclarationForGeneration), "") ;

//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformationEX * cPtr_semanticTypeDeclarationForGeneration::galgasRTTI (void) const {
  return & gClassInfoFor__semanticTypeDeclarationForGeneration ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration ("semanticTypeDeclarationForGeneration", true, & kTypeDescriptor_GGS_semanticDeclarationForGeneration) ;

//---------------------------------------------------------------------------*

GGS_semanticTypeDeclarationForGeneration::
GGS_semanticTypeDeclarationForGeneration (const cPtr__AC_galgas_class * inPointer) {
  macroAssignObject (mPointer, (cPtr__AC_galgas_class *) inPointer) ;
}
...
GGS_semanticTypeDeclarationForGeneration::
GGS_semanticTypeDeclarationForGeneration (cPtr__AC_galgas_class & inObject) {
  macroAssignObject (mPointer, & inObject) ;
}
...
//--- castFrom class method (implements cast expression)
GGS_semanticTypeDeclarationForGeneration GGS_semanticTypeDeclarationForGeneration::
castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_semanticTypeDeclarationForGeneration result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_semanticTypeDeclarationForGeneration *> (inPointer) != NULL)
      : (typeid (cPtr_semanticTypeDeclarationForGeneration) == typeid (*inPointer)) ;
    if (ok) {
      result = GGS_semanticTypeDeclarationForGeneration (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_semanticTypeDeclarationForGeneration),
                                       inUseKindOfClass,
                                       inPointer->instanceMessage ()
                                       COMMA_THERE) ;
    }
...
GGS_unifiedTypeMapIndex  GGS_semanticTypeDeclarationForGeneration::
reader_mTypeIndex (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_unifiedTypeMapIndex   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_semanticTypeDeclarationForGeneration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_semanticTypeDeclarationForGeneration *) mPointer)->mTypeIndex ;
  }
  return result ;
}
...
const char * GGS_semanticTypeDeclarationForGeneration::actualTypeName (void) const {
  return "semanticTypeDeclarationForGeneration" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformationEX gClassInfoFor__semanticTypeDeclarationForGeneration ("semanticTypeDeclarationForGeneration", gClassInfoFor__semanticDeclarationForGeneration, & kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration) ;

//---------------------------------------------------------------------------*

GGS_object GGS_semanticTypeDeclarationForGeneration::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_semanticTypeDeclarationForGeneration * p = NULL ;
    macroMyNew (p, GGS_semanticTypeDeclarationForGeneration (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_semanticTypeDeclarationForGeneration GGS_semanticTypeDeclarationForGeneration::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_semanticTypeDeclarationForGeneration result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_semanticTypeDeclarationForGeneration * p = dynamic_cast <const GGS_semanticTypeDeclarationForGeneration *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_semanticTypeDeclarationForGeneration::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration ;
}
...
cPtr_primitiveTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0
                                COMMA_LOCATION_ARGS)
:cPtr_semanticTypeDeclarationForGeneration (argument_0 COMMA_THERE) {
}
...
C_galgas_class_inspector _gInspectorFor_primitiveTypeForGeneration (& typeid (cPtr_primitiveTypeForGeneration), & typeid (cPtr_semanticTypeDeclarationForGeneration), "") ;
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_primitiveTypeForGeneration ("primitiveTypeForGeneration", true, & kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration) ;
...
C_galgasClassRunTimeInformationEX gClassInfoFor__primitiveTypeForGeneration ("primitiveTypeForGeneration", gClassInfoFor__semanticTypeDeclarationForGeneration, & kTypeDescriptor_GGS_primitiveTypeForGeneration) ;
...
cPtr_listDeclarationForGeneration (const GGS_unifiedTypeMapIndex & argument_0,
...
C_galgas_class_inspector _gInspectorFor_listDeclarationForGeneration (& typeid (cPtr_listDeclarationForGeneration), & typeid (cPtr_semanticTypeDeclarationForGeneration), "") ;
...
cPtr__AC_galgas_class * cPtr_listDeclarationForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_listDeclarationForGeneration (mTypeIndex, mCurrentTypedAttributeList COMMA_HERE)) ;
  return result ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_listDeclarationForGeneration ("listDeclarationForGeneration", true, & kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration) ;
...
GGS_typedAttributeList  GGS_listDeclarationForGeneration::
reader_mCurrentTypedAttributeList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_listDeclarationForGeneration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_listDeclarationForGeneration *) mPointer)->mCurrentTypedAttributeList ;
  }
  return result ;
}
...
C_galgasClassRunTimeInformationEX gClassInfoFor__listDeclarationForGeneration ("listDeclarationForGeneration", gClassInfoFor__semanticTypeDeclarationForGeneration, & kTypeDescriptor_GGS_listDeclarationForGeneration) ;
...
C_galgas_class_inspector _gInspectorFor_structDeclarationForGeneration (& typeid (cPtr_structDeclarationForGeneration), & typeid (cPtr_semanticTypeDeclarationForGeneration), "") ;
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_structDeclarationForGeneration ("structDeclarationForGeneration", true, & kTypeDescriptor_GGS_semanticTypeDeclarationForGeneration) ;
...
C_galgasClassRunTimeInformationEX gClassInfoFor__structDeclarationForGeneration ("structDeclarationForGeneration", gClassInfoFor__semanticTypeDeclarationForGeneration, & kTypeDescriptor_GGS_structDeclarationForGeneration) ;
