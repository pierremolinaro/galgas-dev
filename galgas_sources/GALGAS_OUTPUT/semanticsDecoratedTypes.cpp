...
cPtr_mapTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0,
...
mHasInsertOrReplaceModifier (argument_5) {
}
...
cPtr__AC_galgas_class * cPtr_mapTypeForGeneration::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_mapTypeForGeneration (mTypeIndex, mMapTypeName, mTypedAttributeList, mInsertMethodList, mSearchMethodList, mHasInsertOrReplaceModifier COMMA_HERE)) ;
  return result ;
}
...
GGS_mapMethodListAST  GGS_mapTypeForGeneration::
...
cPtr_classTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0,
...
cPtr__AC_galgas_class * cPtr_classTypeForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_classTypeForGeneration (mTypeIndex, mIsAbstract, mClassTypeName, mSuperClass, mTypedAttributeList, mAbstractMethodList, mMethodList COMMA_HERE)) ;
  return result ;
}
...
GGS_unifiedTypeMapIndex  GGS_classTypeForGeneration::
...
cPtr_listmapTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0,
                                const GGS_unifiedTypeMapIndex & argument_1,
                                const GGS_typedAttributeList & argument_2
                                COMMA_LOCATION_ARGS)
:cPtr_semanticTypeForGeneration (argument_0 COMMA_THERE),
...
GGS_unifiedTypeMapIndex  GGS_listmapTypeForGeneration::
...
cPtr_sortedListTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0,
                                const GGS_typedAttributeList & argument_1,
...
cPtr_enumTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0,
