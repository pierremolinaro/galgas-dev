...
cPtr_genericListTypeForGeneration::
cPtr_genericListTypeForGeneration (const GGS_unifiedTypeMapIndex & argument_0
                                COMMA_LOCATION_ARGS)
:cPtr_semanticTypeForGeneration (argument_0 COMMA_THERE) {
}
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_genericListTypeForGeneration * GGS_genericListTypeForGeneration::
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_genericListTypeForGeneration) ;
...
bool cPtr_genericListTypeForGeneration::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_genericListTypeForGeneration * ptr = dynamic_cast <const cPtr_genericListTypeForGeneration *> (inOperand) ;
    macroValidPointer (ptr) ;
    equal = mTypeIndex.operator_isEqual (ptr->mTypeIndex).boolValue () ;
  }
  return equal ;
...
void cPtr_genericListTypeForGeneration::
appendForDescription (C_String & ioString,
                      const PMSInt32 inIndentation) const {
  ioString << "->@genericListTypeForGeneration:"
           << mTypeIndex.reader_description (inIndentation + 1) ;
}
...
const char * cPtr_genericListTypeForGeneration::
instanceMessage (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_genericListTypeForGeneration (& typeid (cPtr_genericListTypeForGeneration), & typeid (cPtr_semanticTypeForGeneration), "") ;

//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformationEX * cPtr_genericListTypeForGeneration::galgasRTTI (void) const {
  return & gClassInfoFor__genericListTypeForGeneration ;
}

//---------------------------------------------------------------------------*

cPtr__AC_galgas_class * cPtr_genericListTypeForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_genericListTypeForGeneration (mTypeIndex COMMA_HERE)) ;
  return result ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_genericListTypeForGeneration ("genericListTypeForGeneration", true, & kTypeDescriptor_GGS_semanticTypeForGeneration) ;

//---------------------------------------------------------------------------*

GGS_genericListTypeForGeneration::
GGS_genericListTypeForGeneration (const cPtr__AC_galgas_class * inPointer) {
  macroAssignObject (mPointer, (cPtr__AC_galgas_class *) inPointer) ;
}
...
GGS_genericListTypeForGeneration::
GGS_genericListTypeForGeneration (cPtr__AC_galgas_class & inObject) {
  macroAssignObject (mPointer, & inObject) ;
}
...
//--- castFrom class method (implements cast expression)
GGS_genericListTypeForGeneration GGS_genericListTypeForGeneration::
castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_genericListTypeForGeneration result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_genericListTypeForGeneration *> (inPointer) != NULL)
      : (typeid (cPtr_genericListTypeForGeneration) == typeid (*inPointer)) ;
    if (ok) {
      result = GGS_genericListTypeForGeneration (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_genericListTypeForGeneration),
                                       inUseKindOfClass,
                                       inPointer->instanceMessage ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 const GGS_unifiedTypeMapIndex & argument_0
                                COMMA_LOCATION_ARGS) {
  GGS_genericListTypeForGeneration result ;
  macroMyNew (result.mPointer, cPtr_genericListTypeForGeneration (argument_0 COMMA_THERE)) ;
  macroRetainObject (result.mPointer) ;
  return result ;
}
...
const char * GGS_genericListTypeForGeneration::actualTypeName (void) const {
  return "genericListTypeForGeneration" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformationEX gClassInfoFor__genericListTypeForGeneration ("genericListTypeForGeneration", gClassInfoFor__semanticTypeForGeneration, & kTypeDescriptor_GGS_genericListTypeForGeneration) ;

//---------------------------------------------------------------------------*

GGS_object GGS_genericListTypeForGeneration::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_genericListTypeForGeneration * p = NULL ;
    macroMyNew (p, GGS_genericListTypeForGeneration (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_genericListTypeForGeneration GGS_genericListTypeForGeneration::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_genericListTypeForGeneration result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_genericListTypeForGeneration * p = dynamic_cast <const GGS_genericListTypeForGeneration *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_genericListTypeForGeneration, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_genericListTypeForGeneration::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_genericListTypeForGeneration ;
}
