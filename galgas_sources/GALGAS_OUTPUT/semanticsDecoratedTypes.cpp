...
cPtr_readerCallExpressionForGeneration (const GGS_unifiedTypeMapProxy & argument_0,
                                ...
                                COMMA_LOCATION_ARGS)
:cPtr_semanticExpressionForGeneration (argument_0 COMMA_THERE),
mReceiver (argument_1),
mReaderName (argument_2),
mExpressions (argument_3),
mReturnedType (argument_4),
mImplicitConversionReader (argument_5) {
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mType.operator_isEqual (ptr->mType).boolValue ()
         && mReceiver.operator_isEqual (ptr->mReceiver).boolValue ()
         ...
         && mImplicitConversionReader.operator_isEqual (ptr->mImplicitConversionReader).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_String & ioString,
  ...
  ioString << "->@readerCallExpressionForGeneration:"
           ...
           << mImplicitConversionReader.reader_description (inIndentation + 1) ;
}
...
cPtr__AC_galgas_class * cPtr_readerCallExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_readerCallExpressionForGeneration (mType, mReceiver, mReaderName, mExpressions, mReturnedType, mImplicitConversionReader COMMA_HERE)) ;
  return result ;
}
...
GGS_unifiedTypeMapProxy  GGS_readerCallExpressionForGeneration::
reader_mReturnedType (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_readerCallExpressionForGeneration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_readerCallExpressionForGeneration *) mPointer)->mReturnedType ;
  }
  return result ;
}
...
reader_mImplicitConversionReader (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_readerCallExpressionForGeneration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_readerCallExpressionForGeneration *) mPointer)->mImplicitConversionReader ;
  }
  return result ;
}
...
cPtr_optionValueExpressionForGeneration (const GGS_unifiedTypeMapProxy & argument_0,
                                ...
                                COMMA_LOCATION_ARGS)
:cPtr_semanticExpressionForGeneration (argument_0 COMMA_THERE),
mOptionComponentName (argument_1),
mOptionEntryName (argument_2) {
}
...
cPtr__AC_galgas_class * cPtr_optionValueExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_optionValueExpressionForGeneration (mType, mOptionComponentName, mOptionEntryName COMMA_HERE)) ;
  return result ;
}
...
GGS_lstring  GGS_optionValueExpressionForGeneration::
...
cPtr__AC_galgas_class * cPtr_optionCharExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_optionCharExpressionForGeneration (mType, mOptionComponentName, mOptionEntryName COMMA_HERE)) ;
  return result ;
}
...
GGS_lstring  GGS_optionCharExpressionForGeneration::
reader_mOptionComponentName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
...
cPtr__AC_galgas_class * cPtr_optionStringExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_optionStringExpressionForGeneration (mType, mOptionComponentName, mOptionEntryName COMMA_HERE)) ;
  return result ;
}
...
GGS_lstring  GGS_optionStringExpressionForGeneration::
reader_mOptionComponentName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
...
cPtr__AC_galgas_class * cPtr_optionCommentExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_optionCommentExpressionForGeneration (mType, mOptionComponentName, mOptionEntryName COMMA_HERE)) ;
  return result ;
}
...
GGS_lstring  GGS_optionCommentExpressionForGeneration::
reader_mOptionComponentName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
...
cPtr__AC_galgas_class * cPtr_concatExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_concatExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_orExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_orExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_xorExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_xorExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_andExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_andExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_equalExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_equalExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_notEqualExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_notEqualExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_lowerOrEqualExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_lowerOrEqualExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_greaterOrEqualExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_greaterOrEqualExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_strictGreaterExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_strictGreaterExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_strictLowerExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_strictLowerExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_rightShiftExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_rightShiftExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_leftShiftExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_leftShiftExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_addExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_addExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_subExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_subExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_multiplicationExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_multiplicationExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_divisionExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_divisionExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_moduloExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_moduloExpressionForGeneration (mType, mOperatorLocation, mLeftExpression, mRightExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_unaryMinusExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_unaryMinusExpressionForGeneration (mType, mOperatorLocation, mExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_notExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_notExpressionForGeneration (mType, mOperatorLocation, mExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_complementExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_complementExpressionForGeneration (mType, mOperatorLocation, mExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_location  GGS_complementExpressionForGeneration::
reader_mOperatorLocation (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_location   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_complementExpressionForGeneration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_complementExpressionForGeneration *) mPointer)->mOperatorLocation ;
  }
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_ifExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_ifExpressionForGeneration (mType, mOperatorLocation, mIfExpression, mThenExpression, mElseExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_location  GGS_ifExpressionForGeneration::
reader_mOperatorLocation (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_location   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ifExpressionForGeneration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ifExpressionForGeneration *) mPointer)->mOperatorLocation ;
  }
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_functionCallExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_functionCallExpressionForGeneration (mType, mFunctionName, mExpressions COMMA_HERE)) ;
  return result ;
}
...
cPtr_varInExpressionForGeneration (const GGS_unifiedTypeMapProxy & argument_0,
                                ...
                                COMMA_LOCATION_ARGS)
:cPtr_semanticExpressionForGeneration (argument_0 COMMA_THERE),
mCppVarName (argument_1),
mStructFieldList (argument_2) {
}
...
cPtr__AC_galgas_class * cPtr_varInExpressionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_varInExpressionForGeneration (mType, mCppVarName, mStructFieldList COMMA_HERE)) ;
  return result ;
}
...
internalSubListWithRange (GGS_formalParameterListForGeneration & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mFormalArgumentPassingMode, ptr->mFormalArgumentType, ptr->mFormalArgumentName, ptr->mIsUnused) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
cPtr_syntaxInstructionForGeneration (LOCATION_ARGS)
:cPtr__AC_galgas_class (THERE) {
}
...
:cPtr_syntaxInstructionForGeneration (THERE) {
}
...
cPtr__AC_galgas_class * cPtr_localVariableOrConstantDeclarationWithConstructorCallForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_localVariableOrConstantDeclarationWithConstructorCallForGeneration (mTargetType, mIsConstant, mCppVariableName, mConstructorName, mConstructorArguments COMMA_HERE)) ;
  return result ;
}
...
cPtr_appendInstructionForGeneration (const GGS_string& argument_0,
                                const GGS_lstringlist & argument_1,
                                const GGS_semanticExpressionForGeneration & argument_2
                                COMMA_LOCATION_ARGS)
:cPtr_semanticInstructionForGeneration (THERE),
...
cPtr__AC_galgas_class * cPtr_appendInstructionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_appendInstructionForGeneration (mTargetVariableName, mStructAttributeList, mSourceExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr_errorInstructionForGeneration (const GGS_semanticExpressionForGeneration & argument_0,
                                const GGS_bool& argument_1,
                                const GGS_semanticExpressionForGeneration & argument_2,
...
mUseLocationReader (argument_1),
mErrorExpression (argument_2),
mBuiltVariableCppNameList (argument_3) {
}
...
cPtr__AC_galgas_class * cPtr_errorInstructionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_errorInstructionForGeneration (mReceiverExpression, mUseLocationReader, mErrorExpression, mBuiltVariableCppNameList COMMA_HERE)) ;
  return result ;
}
...
cPtr_warningInstructionForGeneration (const GGS_semanticExpressionForGeneration & argument_0,
                                const GGS_bool& argument_1,
                                const GGS_semanticExpressionForGeneration & argument_2
                                COMMA_LOCATION_ARGS)
:cPtr_semanticInstructionForGeneration (THERE),
...
cPtr__AC_galgas_class * cPtr_warningInstructionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_warningInstructionForGeneration (mReceiverExpression, mUseLocationReader, mWarningExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr_methodCallInstructionForGeneration (const GGS_semanticExpressionForGeneration & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_actualParameterListForGeneration & argument_2,
                                const GGS_bool& argument_3,
                                const GGS_temporaryInputVariableForRoutineInvocationForGeneration & argument_4
...
cPtr__AC_galgas_class * cPtr_methodCallInstructionForGeneration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_methodCallInstructionForGeneration (mReceiverExpression, mMethodName, mActualParameterList, mHasCompilerArgument, mTemporaryInputVariableList COMMA_HERE)) ;
  return result ;
}
