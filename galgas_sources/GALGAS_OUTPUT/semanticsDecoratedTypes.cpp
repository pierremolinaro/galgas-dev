...
cPtr__AC_galgas_class * cPtr_classDeclarationForGeneration::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_classDeclarationForGeneration (mTypeIndex, mIsAbstract, mClassTypeName, mSuperClass, mTypedAttributeList, mAbstractMethodList, mOverridenMethodList, mMethodList COMMA_HERE)) ;
  return result ;
}
