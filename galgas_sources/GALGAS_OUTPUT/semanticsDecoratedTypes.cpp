...
mHasInsertOrReplaceModifier (argument_3) {
}
...
cPtr__AC_galgas_class * cPtr_mapTypeForGeneration::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_mapTypeForGeneration (mTypeIndex, mMapTypeName, mTypedAttributeList, mHasInsertOrReplaceModifier COMMA_HERE)) ;
  return result ;
}
