...
category_method__repeatInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
  ...
  if (operand_4745 != NULL) {
    GGS_string var_cas_addedNonTerminalString ;
    var_cas_addedNonTerminalString = (((GGS_string ("select_repeat_")).operator_concat (var_cas_inSyntaxComponent)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130))) ;
    ...
    var_cas_selectRepeatAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, var_cas_addedNonTerminalString, operand_4745->mRepeatInstructionLocation COMMA_HERE) ;
...
category_method__selectInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
  ...
  if (operand_7488 != NULL) {
    GGS_string var_cas_addedNonTerminalString ;
    var_cas_addedNonTerminalString = (((GGS_string ("select_")).operator_concat (var_cas_inSyntaxComponent)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedRuleIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
    ...
    var_cas_selectAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, var_cas_addedNonTerminalString, operand_7488->mSelectInstructionLocation COMMA_HERE) ;
    var_cas_ioAddedNonTerminalList.addAssign_operation (var_cas_addedNonTerminalString) ;
