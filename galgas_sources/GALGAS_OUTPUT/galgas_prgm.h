...
void routine_projectGeneration (const class GALGAS_string constinArgument0,
                                ...
                                const class GALGAS_lexiqueComponentGenerationList constinArgument3,
                                const class GALGAS_stringlist constinArgument4,
                                const class GALGAS_semanticContext constinArgument5,
                                const class GALGAS_syntaxListForGeneration constinArgument6,
                                const class GALGAS_semanticDeclarationSortedListForGeneration constinArgument7,
                                const class GALGAS_programRuleList constinArgument8,
                                const class GALGAS_galgas_33_ProjectComponentAST constinArgument9,
