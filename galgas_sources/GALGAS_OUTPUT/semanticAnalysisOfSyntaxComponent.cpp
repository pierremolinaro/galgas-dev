...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxAnalyserClassDeclaration (C_Compiler * inCompiler,
    ...
    while (enumerator_2258.hasCurrentObject ()) {
      ...
      if (enumerator_2258.current_mLabelImplementationList (HERE).isValid ()) {
        ...
        while (enumerator_2296.hasCurrentObject ()) {
          ...
          result << "_" ;
          result << enumerator_2258.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (46)).stringValue () ;
          result << "_i" ;
          result << enumerator_2258.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (46)).stringValue () ;
          result << "_" ;
          result << enumerator_2296.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (46)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          ...
          if (enumerator_2296.current_mSignature (HERE).isValid ()) {
            ...
            while (enumerator_2523.hasCurrentObject ()) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_2523.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (48)))).boolEnum () ;
              if (kBoolTrue == test_6) {
                result << "const GALGAS_" ;
                result << enumerator_2523.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (49)).stringValue () ;
                result << " constinArgument" ;
                result << index_2523_IDX.reader_string (SOURCE_FILE_AT_LINE (49)).stringValue () ;
              }else if (kBoolFalse == test_6) {
                const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_2523.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (50)))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  result << "GALGAS_" ;
                  result << enumerator_2523.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (51)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_2523_IDX.reader_string (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                }else if (kBoolFalse == test_7) {
                  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_2523.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (52)))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    result << "GALGAS_" ;
                    result << enumerator_2523.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (53)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_2523_IDX.reader_string (SOURCE_FILE_AT_LINE (53)).stringValue () ;
                  }else if (kBoolFalse == test_8) {
                    result << "GALGAS_" ;
                    result << enumerator_2523.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (55)).stringValue () ;
                    result << " inArgument" ;
                    result << index_2523_IDX.reader_string (SOURCE_FILE_AT_LINE (55)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
      ...
      result << "_" ;
      result << enumerator_2258.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (64)).stringValue () ;
      result << "_i" ;
      result << enumerator_2258.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (64)).stringValue () ;
      result << "_parse (" ;
      columnMarker = result.currentColumn () ;
      ...
      if (kBoolTrue == test_11) {
        ...
        result << "_" ;
        result << enumerator_2258.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
        result << "_i" ;
        result << enumerator_2258.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
  ...
  if (in_SELECT_5F_METHOD_5F_LIST.isValid ()) {
    ...
    while (enumerator_4016.hasCurrentObject ()) {
      ...
      result << "_" ;
      result << enumerator_4016.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (76)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_NAME.stringValue () ;
      result << " *) = 0 ;\n"
        "\n" ;
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_5854 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (143))) ;
  if (NULL != objectArray_5854) {
      macroValidSharedObject (objectArray_5854, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_5854->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE_AT_LINE (144)) ;
    GALGAS_stringset var_reDeclarationLabelSet = constinArgument_inNonterminalLabelMap.reader_keySet (SOURCE_FILE_AT_LINE (145)) ;
    GALGAS_stringset var_missingLabelSet = var_firstDeclarationLabelSet.substract_operation (var_reDeclarationLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (147)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_6254 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_6254.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6254.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)) ;
      ...
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("' nonterminal is redeclared without the following label(s):") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (152)) ;
    }
    GALGAS_stringset var_newLabelSet = var_reDeclarationLabelSet.substract_operation (var_firstDeclarationLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_6634 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_6634.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6634.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (GALGAS_string ("' nonterminal is redeclared with the new label(s):") COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (162)) ;
    }
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE_AT_LINE (166)).boolEnum () ;
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_6928 (objectArray_5854->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_6951 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_6928.hasCurrentObject () && enumerator_6951.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_newSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (168)) ;
        cEnumerator_formalParameterSignature enumerator_7053 (enumerator_6951.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_7053.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_7053.current_mFormalArgumentType (HERE), enumerator_7053.current_mFormalArgumentPassingMode (HERE), enumerator_7053.current_mFormalArgumentName (HERE) COMMA_SOURCE_FILE_AT_LINE (170)) ;
          enumerator_7053.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_6928.current_mSignatureForGeneration (HERE), enumerator_6928.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_6951.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (172)) ;
        }
    ...
    {
    ioArgument_ioNonterminalDeclarationMap.modifier_insertKey (constinArgument_inNonTerminalName, constinArgument_inNonterminalLabelMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
  }
}
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  outArgument_outNonterminalDeclarationMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (192)) ;
  cEnumerator_nonterminalDeclarationListAST enumerator_7913 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_7913.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (195)) ;
    cEnumerator_nonTerminalLabelListAST enumerator_7994 (enumerator_7913.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_7994.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (197)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (198)) ;
      cEnumerator_formalParameterListAST enumerator_8164 (enumerator_7994.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_8164.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_8164.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_8164.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_8164.current_mFormalArgumentName (HERE), enumerator_8164.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
        var_signature.addAssign_operation (var_t, enumerator_8164.current_mFormalArgumentPassingMode (HERE), enumerator_8164.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (202)) ;
        enumerator_8164.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_7994.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_7994.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
      }
      enumerator_7994.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_7913.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (783)) ;
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_32625 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_32625.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_32625.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (788)) ;
    enumerator_32625.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (802)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1389)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1390)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1397)) ;
  cEnumerator_formalParameterListForGeneration enumerator_54862 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_54862.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_54862.current_mFormalArgumentType (HERE), enumerator_54862.current_mFormalArgumentPassingMode (HERE), enumerator_54862.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1399)) ;
    enumerator_54862.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1402)) ;
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1403)) ;
  cEnumerator_syntaxInstructionList enumerator_55200 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_55200.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_55200.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1405)) ;
    enumerator_55200.gotoNextObject () ;
  }
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1419)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1442)) ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1443)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_56729 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_56729.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1450)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_56813 (enumerator_56729.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_56813.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1452)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1453)) ;
      cEnumerator_formalParameterListAST enumerator_56980 (enumerator_56813.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_56980.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_56980.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1455)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_56980.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_56980.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_56980.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1456)) COMMA_SOURCE_FILE_AT_LINE (1456)) COMMA_SOURCE_FILE_AT_LINE (1456)) ;
        var_signature.addAssign_operation (var_type, enumerator_56980.current_mFormalArgumentPassingMode (HERE), enumerator_56980.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1457)) ;
        enumerator_56980.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_56813.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_56813.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1459)) ;
      }
      enumerator_56813.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_56729.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1461)) ;
    }
    enumerator_56729.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1467)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1469)) COMMA_SOURCE_FILE_AT_LINE (1464)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1473)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_57929 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_57929.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1476)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_58113_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_57929.current_mNonterminalName (HERE), joker_58113_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1478)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_58140 (enumerator_57929.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_58140.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_58140.current_mFormalArguments (HERE), enumerator_58140.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_58140.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1484)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_58140.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_58140.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1500)) ;
      enumerator_58140.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_59111_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_57929.current_mNonterminalName (HERE), joker_59111_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1509)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_57929.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1511)), var_newRuleIndex, var_ruleLabelImplementationList COMMA_SOURCE_FILE_AT_LINE (1510)) ;
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1515)) ;
    enumerator_57929.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature COMMA_SOURCE_FILE_AT_LINE (1518)) ;
}
...
static GALGAS_string categoryReader_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  GALGAS_uintlist var_selectMethodList = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (114)) ;
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)).isValid ()) {
    uint32_t variant_4889 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)).uintValue () ;
    bool loop_4889 = true ;
    while (loop_4889) {
      loop_4889 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).isValid () ;
      if (loop_4889) {
        loop_4889 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).boolValue () ;
      }
      if (loop_4889 && (0 == variant_4889)) {
        loop_4889 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (116)) ;
      }
      if (loop_4889) {
        variant_4889 -- ;
        var_selectMethodList.addAssign_operation (var_idx COMMA_SOURCE_FILE_AT_LINE (118)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
      }
    }
  }
...
static void categoryMethod_semanticInstructionAST_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) temp_0.ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionListForGeneration, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (243)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inNonterminalMap.method_searchKey (object->mAttribute_mNonterminalName, var_labelMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) ;
  GALGAS_formalParameterSignature var_signature ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (267)).objectCompare (GALGAS_string ("parse"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (268)) ;
  }else if (kBoolFalse == test_0) {
    GALGAS_formalParameterListForGeneration joker_11100_0 ; // Joker input parameter
    GALGAS_location joker_11114_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_11100_0, var_signature, joker_11114_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (270)) ;
  }
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  {
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mNonterminalName, GALGAS_string ("'<").operator_concat (object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)).operator_concat (GALGAS_string (">' nonterminal declaration") COMMA_SOURCE_FILE_AT_LINE (277)), var_signature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_actualParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) ;
  }
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_nonterminalInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE_AT_LINE (292)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (293)), var_actualParameterListForGeneration, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult COMMA_SOURCE_FILE_AT_LINE (290)) COMMA_SOURCE_FILE_AT_LINE (290)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_stringlist var_parameterCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (309)) ;
  GALGAS_stringlist var_jokerParametersToReleaseList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (310)) ;
  GALGAS_stringlist var_inputVariableList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (311)) ;
  cEnumerator_actualParameterListForGeneration enumerator_12476 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  while (enumerator_12476.hasCurrentObject ()) {
    GALGAS_string var_parameterCppName ;
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_12476.current_mActualParameter (HERE).ptr (), ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (313)) ;
    var_parameterCppNameList.addAssign_operation (var_parameterCppName COMMA_SOURCE_FILE_AT_LINE (321)) ;
    enumerator_12476.gotoNextObject () ;
  }
  GALGAS_string var_sdtResultVarName = GALGAS_string ("syntaxDirectedTranslationResult_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE_AT_LINE (324)).reader_string (SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
  const enumGalgasBool test_0 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("C_String ").operator_concat (var_sdtResultVarName COMMA_SOURCE_FILE_AT_LINE (326)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("nt_").operator_concat (object->mAttribute_mNonterminalName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (328)) COMMA_SOURCE_FILE_AT_LINE (328)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (328)).operator_concat (object->mAttribute_mLabelName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (328)) COMMA_SOURCE_FILE_AT_LINE (328)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (328)) COMMA_SOURCE_FILE_AT_LINE (328)) ;
  cEnumerator_stringlist enumerator_13202 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_13202.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13202.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
  ...
  if (kBoolTrue == test_1) {
    ioArgument_ioGeneratedCode.dotAssign_operation (var_sdtResultVarName.operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (333)) ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (336)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, var_sdtResultVarName, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_stringlist enumerator_13816 (var_inputVariableList, kEnumeration_up) ;
    while (enumerator_13816.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_13816.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (347)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)) ;
  ...
  cEnumerator_stringlist enumerator_14026 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_14026.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14026.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_15504_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_15504_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (391)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (403)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (GALGAS_string::makeEmptyString (), var_cppName, constinArgument_inLexicalAttributeName COMMA_SOURCE_FILE_AT_LINE (408)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (424)) COMMA_SOURCE_FILE_AT_LINE (424)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (426)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType ;
  if (constinArgument_inRequiredLexicalType.isValid ()) {
    switch (constinArgument_inRequiredLexicalType.enumValue ()) {
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (439)) COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (438)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (object->mAttribute_mActualParameterTypeName.reader_string (SOURCE_FILE_AT_LINE (444)), var_cppName, constinArgument_inLexicalAttributeName COMMA_SOURCE_FILE_AT_LINE (443)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredConstant_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (459)) COMMA_SOURCE_FILE_AT_LINE (459)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType ;
  if (constinArgument_inRequiredLexicalType.isValid ()) {
    switch (constinArgument_inRequiredLexicalType.enumValue ()) {
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (474)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (474)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (475)) COMMA_SOURCE_FILE_AT_LINE (475)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (475)) COMMA_SOURCE_FILE_AT_LINE (473)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (object->mAttribute_mActualParameterTypeName.reader_string (SOURCE_FILE_AT_LINE (479)), var_cppName, constinArgument_inLexicalAttributeName COMMA_SOURCE_FILE_AT_LINE (478)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationDropResult_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (509)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature") COMMA_SOURCE_FILE_AT_LINE (510)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (521)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature") COMMA_SOURCE_FILE_AT_LINE (522)) ;
  }
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_21826_0 ; // Joker input parameter
  GALGAS_string joker_21829_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_21826_0, joker_21829_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (528)) COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (529)) COMMA_SOURCE_FILE_AT_LINE (529)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (529)) COMMA_SOURCE_FILE_AT_LINE (527)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (541)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature") COMMA_SOURCE_FILE_AT_LINE (542)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (544)) COMMA_SOURCE_FILE_AT_LINE (544)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (545)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (546)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) COMMA_SOURCE_FILE_AT_LINE (551)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (551)) COMMA_SOURCE_FILE_AT_LINE (549)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (563)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature") COMMA_SOURCE_FILE_AT_LINE (564)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (568)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (572)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (572)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (571)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultNone_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * /* inObject */,
  ...
  const enumGalgasBool test_0 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (596)).operator_concat (GALGAS_string (" << ") COMMA_SOURCE_FILE_AT_LINE (596)).operator_concat (constinArgument_inAccessMethodName COMMA_SOURCE_FILE_AT_LINE (596)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (596)) ;
    {
    ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) COMMA_SOURCE_FILE_AT_LINE (597)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (var_cppName.operator_concat (GALGAS_string (" = GALGAS_string (") COMMA_SOURCE_FILE_AT_LINE (620)).operator_concat (constinArgument_inAccessMethodName COMMA_SOURCE_FILE_AT_LINE (620)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (620)) COMMA_SOURCE_FILE_AT_LINE (620)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (631)) COMMA_SOURCE_FILE_AT_LINE (631)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_string ").operator_concat (var_cppName COMMA_SOURCE_FILE_AT_LINE (632)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (632)).operator_concat (constinArgument_inAccessMethodName COMMA_SOURCE_FILE_AT_LINE (632)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (632)) COMMA_SOURCE_FILE_AT_LINE (632)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (643)) COMMA_SOURCE_FILE_AT_LINE (643)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const GALGAS_string ").operator_concat (var_cppName COMMA_SOURCE_FILE_AT_LINE (644)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (644)).operator_concat (constinArgument_inAccessMethodName COMMA_SOURCE_FILE_AT_LINE (644)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (644)) COMMA_SOURCE_FILE_AT_LINE (644)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inTerminalMap.method_searchKey (object->mAttribute_mTerminalName, var_sentAttributeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (661)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (663)).objectCompare (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (663)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //--- @ifExpressionForGeneration
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (666)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (669)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("naming the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (665)) COMMA_SOURCE_FILE_AT_LINE (665)).operator_concat (GALGAS_string ("$' requires ") COMMA_SOURCE_FILE_AT_LINE (665)).operator_concat (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (665)).reader_string (SOURCE_FILE_AT_LINE (665)) COMMA_SOURCE_FILE_AT_LINE (665)).operator_concat (GALGAS_string ("parameter") COMMA_SOURCE_FILE_AT_LINE (665)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (666)).operator_concat (GALGAS_string (", but this instruction names ") COMMA_SOURCE_FILE_AT_LINE (666)).operator_concat (object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (668)).reader_string (SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string (" parameter") COMMA_SOURCE_FILE_AT_LINE (668)).operator_concat (temp_3 COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (664)) ;
  }
  GALGAS_terminalCheckAssignementList var_terminalCheckAssignementList = GALGAS_terminalCheckAssignementList::constructor_emptyList (SOURCE_FILE_AT_LINE (673)) ;
  cEnumerator_actualInputParameterListAST enumerator_28423 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_28442 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_28423.hasCurrentObject () && enumerator_28442.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_28423.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_28442.current_mLexicalType (HERE), enumerator_28442.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
    enumerator_28423.gotoNextObject () ;
    enumerator_28442.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_28677 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_28677.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_28677.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)).operator_not (SOURCE_FILE_AT_LINE (685)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_28790 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_28790.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_28790.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)) ;
        enumerator_28790.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_28677.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_28677.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (690)) COMMA_SOURCE_FILE_AT_LINE (690)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (690)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (690)) COMMA_SOURCE_FILE_AT_LINE (690)) ;
    }
    enumerator_28677.gotoNextObject () ;
  }
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (694)) ;
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (699)) ;
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_30117 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_30117.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_30117.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_30117.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (728)) COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (728)) COMMA_SOURCE_FILE_AT_LINE (728)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_30117.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (731)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (731)) COMMA_SOURCE_FILE_AT_LINE (731)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (731)).operator_concat (enumerator_30117.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (732)) COMMA_SOURCE_FILE_AT_LINE (731)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (732)) COMMA_SOURCE_FILE_AT_LINE (731)) ;
    enumerator_30117.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_30518 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_30518.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (737)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (737)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (737)).operator_concat (GALGAS_string ("::kIndexing_") COMMA_SOURCE_FILE_AT_LINE (737)).operator_concat (enumerator_30518.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737)) ;
    enumerator_30518.gotoNextObject () ;
  }
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->preceedingSeparatorString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (740)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->tokenString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (746)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (753)) COMMA_SOURCE_FILE_AT_LINE (753)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (GALGAS_string ("::kToken_") COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (GALGAS_string (") COMMA_SOURCE_FILE_AT_LINE (") COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (object->mAttribute_mInstructionLocation.reader_line (inCompiler COMMA_SOURCE_FILE_AT_LINE (756)).reader_string (SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (GALGAS_string (")) ;\n") COMMA_SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (754)) ;
  const enumGalgasBool test_1 = constinArgument_inGenerateCheckValid.boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("#ifndef DO_NOT_GENERATE_CHECKINGS\n") COMMA_SOURCE_FILE_AT_LINE (759)) ;
    cEnumerator_terminalCheckAssignementList enumerator_31697 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    while (enumerator_31697.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_31697.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (820)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (822)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mRepeatedInstructionList, object->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_repeated_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (825)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (840)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_34258 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_34258.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_34258.current_mSyntaxInstructionList (HERE), enumerator_34258.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (843)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_34258.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    enumerator_34258.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_repeat_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (860)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOf_5F_repeat_5F_instruction, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_repeatFlagCppName = GALGAS_string ("repeatFlag_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (882)) COMMA_SOURCE_FILE_AT_LINE (882)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (883)).operator_concat (GALGAS_string (" = true ;\n") COMMA_SOURCE_FILE_AT_LINE (883)) COMMA_SOURCE_FILE_AT_LINE (883)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (884)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (884)) COMMA_SOURCE_FILE_AT_LINE (884)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_m_5F_repeated_5F_instructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (885)) ;
  }
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (893)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_36245 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_36201 ((uint32_t) 0) ;
  while (enumerator_36245.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_36201.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (896)).reader_string (SOURCE_FILE_AT_LINE (896)) COMMA_SOURCE_FILE_AT_LINE (896)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (896)) COMMA_SOURCE_FILE_AT_LINE (896)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_36245.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (897)) ;
    }
    ...
    index_36201.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (895)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n") COMMA_SOURCE_FILE_AT_LINE (907)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (908)).operator_concat (GALGAS_string (" = false ;\n") COMMA_SOURCE_FILE_AT_LINE (908)) COMMA_SOURCE_FILE_AT_LINE (908)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n") COMMA_SOURCE_FILE_AT_LINE (909)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (910)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (911)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_choiceIndex = ioArgument_ioSelectMethodCount ;
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (930)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (932)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (934)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_37645 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_37645.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_37645.current_mSyntaxInstructionList (HERE), enumerator_37645.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (937)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_37645.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (951)) ;
    enumerator_37645.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_select_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (954)) ;
  }
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (973)) COMMA_SOURCE_FILE_AT_LINE (973)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (974)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (974)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)).operator_concat (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_39118 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_39074 ((uint32_t) 0) ;
  while (enumerator_39118.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_39074.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (976)).reader_string (SOURCE_FILE_AT_LINE (976)) COMMA_SOURCE_FILE_AT_LINE (976)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (976)) COMMA_SOURCE_FILE_AT_LINE (976)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_39118.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (977)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (985)) ;
    enumerator_39118.gotoNextObject () ;
    index_39074.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (975)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1007)) ;
  GALGAS_uint var_referenceSelectMethodCount = ioArgument_ioSelectMethodCount ;
  cEnumerator_listOfSyntaxInstructionList enumerator_40318 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_40318.hasCurrentObject ()) {
    ioArgument_ioSelectMethodCount = var_referenceSelectMethodCount ;
    GALGAS_semanticInstructionListForGeneration var_instructionList = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1011)) ;
    cEnumerator_syntaxInstructionList enumerator_40484 (enumerator_40318.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_40484.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_40484.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)) ;
      enumerator_40484.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_40318.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_41188_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_41188_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1031)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1032)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_41373 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_41373.hasCurrentObject () && bool_0) {
    while (enumerator_41373.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_41373.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1037)), enumerator_41373.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1035)) ;
      enumerator_41373.gotoNextObject () ;
      if (enumerator_41373.hasCurrentObject ()) {
        bool_0 = var_ok.isValidAndTrue () ;
      }
    }
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseRewindInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1042)) COMMA_SOURCE_FILE_AT_LINE (1042)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1058)) COMMA_SOURCE_FILE_AT_LINE (1058)) ;
  }
  GALGAS_string var_parsingContextVar = GALGAS_string ("parsingContext_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1059)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext ").operator_concat (var_parsingContextVar COMMA_SOURCE_FILE_AT_LINE (1060)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (1060)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)).operator_concat (GALGAS_string ("->parsingContext () ;\n") COMMA_SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42553 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_42553.hasCurrentObject ()) {
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_42553.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) ;
    }
    if (enumerator_42553.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1072)).operator_concat (GALGAS_string ("->setParsingContext (") COMMA_SOURCE_FILE_AT_LINE (1072)).operator_concat (var_parsingContextVar COMMA_SOURCE_FILE_AT_LINE (1072)).operator_concat (GALGAS_string (") ; // rewind\n") COMMA_SOURCE_FILE_AT_LINE (1072)) COMMA_SOURCE_FILE_AT_LINE (1072)) ;
    }
    enumerator_42553.gotoNextObject () ;
  }
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variant_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1098)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1100)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) COMMA_SOURCE_FILE_AT_LINE (1100)).operator_concat (GALGAS_string ("', but it should be '@") COMMA_SOURCE_FILE_AT_LINE (1100)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1101)) COMMA_SOURCE_FILE_AT_LINE (1101)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (1101)) COMMA_SOURCE_FILE_AT_LINE (1099)) ;
  }
  GALGAS_semanticExpressionForGeneration var_while_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1106)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1111)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfWhileExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1113)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1113)) COMMA_SOURCE_FILE_AT_LINE (1113)).operator_concat (GALGAS_string ("', but it should be '@") COMMA_SOURCE_FILE_AT_LINE (1113)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1114)) COMMA_SOURCE_FILE_AT_LINE (1114)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (1114)) COMMA_SOURCE_FILE_AT_LINE (1112)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (1119)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mDoInstructionList, object->mAttribute_mEndOfInstructionList, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1122)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1137)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseLoopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variant_5F_expression, var_while_5F_expression, var_instructionList COMMA_SOURCE_FILE_AT_LINE (1139)) COMMA_SOURCE_FILE_AT_LINE (1139)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1156)) COMMA_SOURCE_FILE_AT_LINE (1156)) ;
  }
  GALGAS_string var_variantVarCppName ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mVariantExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_variantVarCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1160)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (1162)).operator_concat (GALGAS_string (".isValid ()) {\n") COMMA_SOURCE_FILE_AT_LINE (1162)) COMMA_SOURCE_FILE_AT_LINE (1162)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)) ;
  }
  GALGAS_string var_variantVar = GALGAS_string ("variant_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (1164)) COMMA_SOURCE_FILE_AT_LINE (1164)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1164)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("uint32_t ").operator_concat (var_variantVar COMMA_SOURCE_FILE_AT_LINE (1165)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (1165)).operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (1165)).operator_concat (GALGAS_string (".uintValue () ;\n") COMMA_SOURCE_FILE_AT_LINE (1165)) COMMA_SOURCE_FILE_AT_LINE (1165)) ;
  GALGAS_string var_loopVar = GALGAS_string ("loop_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (1167)) COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_loopVar COMMA_SOURCE_FILE_AT_LINE (1168)).operator_concat (GALGAS_string (" = true ;\n") COMMA_SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1168)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_loopVar COMMA_SOURCE_FILE_AT_LINE (1169)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (1169)) COMMA_SOURCE_FILE_AT_LINE (1169)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1170)) ;
  }
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVarCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1173)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (1174)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n") COMMA_SOURCE_FILE_AT_LINE (1174)) COMMA_SOURCE_FILE_AT_LINE (1174)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1175)) ;
  }
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext parsingContext = ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1178)) COMMA_SOURCE_FILE_AT_LINE (1178)).operator_concat (GALGAS_string ("->parsingContext () ;\n") COMMA_SOURCE_FILE_AT_LINE (1178)) COMMA_SOURCE_FILE_AT_LINE (1178)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("->setParsingContext (parsingContext) ;\n") COMMA_SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1188)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1189)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1190)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1191)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1192)) ;
  }
  ...
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1198)), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1196)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("->resetTemplateString () ;\n") COMMA_SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)) ;
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1224)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (1230)) ;
  }
  ...
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1265)) ;
  }
  GALGAS_bool var_ok = function_compareSyntaxSignature (function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_when_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1268)), function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_else_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1269)), object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) ;
...
static void categoryMethod_parseWhenInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhenExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE_AT_LINE (1294)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n") COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1296)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n") COMMA_SOURCE_FILE_AT_LINE (1304)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mElseInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1305)) ;
  }
...
static void categoryMethod_syntaxSendInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (1330)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' instruction is only allowed when syntax componant has 'translate' feature") COMMA_SOURCE_FILE_AT_LINE (1331)) ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1340)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' expresion should be an @string expression") COMMA_SOURCE_FILE_AT_LINE (1341)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_syntaxSendInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_expression COMMA_SOURCE_FILE_AT_LINE (1344)) COMMA_SOURCE_FILE_AT_LINE (1344)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_sourceVar ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE_AT_LINE (1359)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1361)) COMMA_SOURCE_FILE_AT_LINE (1361)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (GALGAS_string (".isValid ()) {\n") COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (GALGAS_string ("  ") COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (1363)) COMMA_SOURCE_FILE_AT_LINE (1363)).operator_concat (GALGAS_string (" << ") COMMA_SOURCE_FILE_AT_LINE (1363)).operator_concat (var_sourceVar COMMA_SOURCE_FILE_AT_LINE (1363)).operator_concat (GALGAS_string (".stringValue () ;\n") COMMA_SOURCE_FILE_AT_LINE (1363)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1363)) COMMA_SOURCE_FILE_AT_LINE (1362)) ;
}
//-----------------------------------------------------------------------------*
