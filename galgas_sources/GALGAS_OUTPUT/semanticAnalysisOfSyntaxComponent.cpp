...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxAnalyserClassDeclaration (C_Compiler * inCompiler,
  ...
  result << "\n"
    "//--- Rule declarations\n" ;
  GALGAS_uint index_1977_ (0) ;
  if (in_RULE_5F_DECLARATION_5F_LIST.isValid ()) {
    cEnumerator_ruleDeclarationList enumerator_1977 (in_RULE_5F_DECLARATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_1977.hasCurrentObject ()) {
      GALGAS_uint index_2015_ (0) ;
      if (enumerator_1977.current_mLabelImplementationList (HERE).isValid ()) {
        cEnumerator_ruleLabelImplementationList enumerator_2015 (enumerator_1977.current_mLabelImplementationList (HERE), kEnumeration_up) ;
        while (enumerator_2015.hasCurrentObject ()) {
          ...
          result << "_" ;
          result << enumerator_1977.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (39)).stringValue () ;
          result << "_i" ;
          result << enumerator_1977.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (39)).stringValue () ;
          result << "_" ;
          result << enumerator_2015.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (39)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_2242_IDX (0) ;
          if (enumerator_2015.current_mSignature (HERE).isValid ()) {
            cEnumerator_formalParameterSignature enumerator_2242 (enumerator_2015.current_mSignature (HERE), kEnumeration_up) ;
            while (enumerator_2242.hasCurrentObject ()) {
              const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_2242.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (41)))).boolEnum () ;
              if (kBoolTrue == test_4) {
                result << "const GALGAS_" ;
                result << enumerator_2242.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (42)).stringValue () ;
                result << " constinArgument" ;
                result << index_2242_IDX.reader_string (SOURCE_FILE_AT_LINE (42)).stringValue () ;
              }else if (kBoolFalse == test_4) {
                const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_2242.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (43)))).boolEnum () ;
                if (kBoolTrue == test_5) {
                  result << "GALGAS_" ;
                  result << enumerator_2242.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (44)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_2242_IDX.reader_string (SOURCE_FILE_AT_LINE (44)).stringValue () ;
                }else if (kBoolFalse == test_5) {
                  const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_2242.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (45)))).boolEnum () ;
                  if (kBoolTrue == test_6) {
                    result << "GALGAS_" ;
                    result << enumerator_2242.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (46)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_2242_IDX.reader_string (SOURCE_FILE_AT_LINE (46)).stringValue () ;
                  }else if (kBoolFalse == test_6) {
                    result << "GALGAS_" ;
                    result << enumerator_2242.current_mFormalArgumentType (HERE).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (48)).stringValue () ;
                    result << " inArgument" ;
                    result << index_2242_IDX.reader_string (SOURCE_FILE_AT_LINE (48)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
      ...
      result << "_" ;
      result << enumerator_1977.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << "_i" ;
      result << enumerator_1977.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << "_parse (C_Lexique_" ;
      result << in_LEXIQUE_5F_NAME.stringValue () ;
      result << " * inLexique) ;\n"
        "\n" ;
      ...
      if (kBoolTrue == test_7) {
        ...
        result << "_" ;
        result << enumerator_1977.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (56)).stringValue () ;
        result << "_i" ;
        result << enumerator_1977.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (56)).stringValue () ;
        result << "_indexing (C_Lexique_" ;
        result << in_LEXIQUE_5F_NAME.stringValue () ;
        result << " * inLexique) ;\n"
          "\n" ;
  ...
  if (in_SELECT_5F_METHOD_5F_LIST.isValid ()) {
    cEnumerator_uintlist enumerator_3510 (in_SELECT_5F_METHOD_5F_LIST, kEnumeration_up) ;
    while (enumerator_3510.hasCurrentObject ()) {
      ...
      result << "_" ;
      result << enumerator_3510.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_NAME.stringValue () ;
      result << " *) = 0 ;\n"
        "\n" ;
