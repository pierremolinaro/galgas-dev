...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
  ...
  if (NULL != objectArray_5714) {
    ...
    if (kBoolTrue == test_4) {
      ...
      cEnumerator_nonterminalLabelMap enumerator_6794 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_6761.hasCurrentObject () && enumerator_6794.hasCurrentObject ()) {
        ...
        cEnumerator_formalParameterSignature enumerator_6897 (enumerator_6794.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_6897.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_6897.current_mFormalArgumentType (HERE), enumerator_6897.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (164)) ;
          enumerator_6897.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_6761.current_mSignatureForGeneration (HERE), enumerator_6761.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_6794.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)) ;
        }
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_7742 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_7742.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_7823 (enumerator_7742.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_7823.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_7993 (enumerator_7823.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_7993.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_7993.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (194)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_7993.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_7993.current_mFormalArgumentName (HERE), enumerator_7993.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (195)) ;
        var_signature.addAssign_operation (var_t, enumerator_7993.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (196)) ;
        enumerator_7993.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_7823.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_7823.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)) ;
      }
      enumerator_7823.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_7742.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_19189 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_19189.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_19189.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_38333 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_38333.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_38333.current_mFormalArgumentType (HERE), enumerator_38333.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (995)) ;
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_40110 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_40110.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_40194 (enumerator_40110.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_40194.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_40361 (enumerator_40194.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_40361.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_40361.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1049)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_40361.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_40361.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_40361.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1050)) COMMA_SOURCE_FILE_AT_LINE (1050)) COMMA_SOURCE_FILE_AT_LINE (1050)) ;
        var_signature.addAssign_operation (var_type, enumerator_40361.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1051)) ;
        enumerator_40361.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_40194.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_40194.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1053)) ;
      }
      enumerator_40194.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40110.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    }
  ...
  cEnumerator_syntaxRuleListAST enumerator_41469 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_41469.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_41651_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_41469.current_mNonterminalName (HERE), joker_41651_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1076)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_41680 (enumerator_41469.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_41680.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_41680.current_mFormalArguments (HERE), enumerator_41680.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_41680.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1082)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_41680.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_41680.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1097)) ;
      enumerator_41680.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_42618_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_41469.current_mNonterminalName (HERE), joker_42618_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_41469.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1108)), var_newRuleIndex, var_ruleLabelImplementationList COMMA_SOURCE_FILE_AT_LINE (1107)) ;
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1112)) ;
    enumerator_41469.gotoNextObject () ;
  }
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_10863_0 ; // Joker input parameter
    GALGAS_location joker_10877_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_10863_0, var_signature, joker_10877_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_stringlist enumerator_12482 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_12482.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_12482.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (305)) COMMA_SOURCE_FILE_AT_LINE (305)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_stringlist enumerator_12787 (var_inputVariableList, kEnumeration_up) ;
    while (enumerator_12787.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_12787.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313)) ;
  ...
  cEnumerator_stringlist enumerator_12997 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_12997.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_12997.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (319)) COMMA_SOURCE_FILE_AT_LINE (319)) ;
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_14312 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_14333 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_14312.hasCurrentObject () && enumerator_14333.hasCurrentObject ()) {
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_14312.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (351)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_unifiedTypeMapProxy var_type ;
      GALGAS_string var_cppName ;
      const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, enumerator_14312.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (354)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_cppName = GALGAS_string ("var_").operator_concat (enumerator_14312.current_mActualParameterName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)) ;
        var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_14312.current_mActualParameterTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
        {
        ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (enumerator_14312.current_mActualParameterName (HERE), var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (357)) ;
        }
      }else if (kBoolFalse == test_7) {
        {
        GALGAS_string joker_14913_0 ; // Joker input parameter
        ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_14312.current_mActualParameterName (HERE), var_type, var_cppName, joker_14913_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
        }
      }
      GALGAS_unifiedTypeMapProxy var_expectedType ;
      if (enumerator_14333.current_mLexicalType (HERE).isValid ()) {
        switch (enumerator_14333.current_mLexicalType (HERE).enumValue ()) {
      ...
      if (kBoolTrue == test_8) {
        GALGAS_location location_9 (enumerator_14312.current_mActualParameterName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (enumerator_14312.current_mActualParameterName (HERE).reader_string (SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (373)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (374)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (372)) ;
      }
      var_terminalCheckAssignementList.addAssign_operation (enumerator_14312.current_mActualParameterTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (378)), var_cppName, enumerator_14333.current_mLexicalAttributeName (HERE) COMMA_SOURCE_FILE_AT_LINE (377)) ;
    }
    enumerator_14312.gotoNextObject () ;
    enumerator_14333.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_16203 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_16203.hasCurrentObject ()) {
    const enumGalgasBool test_10 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_16203.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (386)) COMMA_SOURCE_FILE_AT_LINE (386)).operator_not (SOURCE_FILE_AT_LINE (386)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_16316 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_16316.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_16316.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (389)) COMMA_SOURCE_FILE_AT_LINE (389)) ;
        enumerator_16316.gotoNextObject () ;
      }
      GALGAS_location location_11 (enumerator_16203.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, GALGAS_string ("the '").operator_concat (enumerator_16203.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (391)) COMMA_SOURCE_FILE_AT_LINE (391)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (391)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (391)) COMMA_SOURCE_FILE_AT_LINE (391)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_17190 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_17190.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_17190.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_17190.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_17190.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (enumerator_17190.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (419)) ;
    enumerator_17190.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_17591 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_17591.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("::kIndexing_") COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (enumerator_17591.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_terminalCheckAssignementList enumerator_18293 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    while (enumerator_18293.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_18293.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (436)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (436)) COMMA_SOURCE_FILE_AT_LINE (436)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_20734 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_20734.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_20734.current_mSyntaxInstructionList (HERE), enumerator_20734.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (514)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_20734.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (527)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_22595 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_22589 ((PMUInt32) 0) ;
  while (enumerator_22595.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_22589.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (564)).reader_string (SOURCE_FILE_AT_LINE (564)) COMMA_SOURCE_FILE_AT_LINE (564)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (564)) COMMA_SOURCE_FILE_AT_LINE (564)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_22595.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (572)) ;
    enumerator_22595.gotoNextObject () ;
    index_22589.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (563)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_23911 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_23911.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_23911.current_mSyntaxInstructionList (HERE), enumerator_23911.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (603)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_23911.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (616)) ;
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_25305 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_25299 ((PMUInt32) 0) ;
  while (enumerator_25305.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_25299.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (640)).reader_string (SOURCE_FILE_AT_LINE (640)) COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (640)) COMMA_SOURCE_FILE_AT_LINE (640)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_25305.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (648)) ;
    enumerator_25305.gotoNextObject () ;
    index_25299.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (639)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_26421 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_26421.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_26587 (enumerator_26421.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_26587.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_26587.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
      enumerator_26587.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_26421.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (687)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_27258_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_27258_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (692)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_27448 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_27448.hasCurrentObject () && bool_0) {
    while (enumerator_27448.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_27448.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (698)), enumerator_27448.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (696)) ;
      enumerator_27448.gotoNextObject () ;
      if (enumerator_27448.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28574 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_28574.hasCurrentObject ()) {
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_28574.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
    }
    if (enumerator_28574.hasNextObject ()) {
