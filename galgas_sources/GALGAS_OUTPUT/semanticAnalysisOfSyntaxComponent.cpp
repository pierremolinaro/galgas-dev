...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_7328 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 192))) ;
  if (NULL != objectArray_7328) {
      macroValidSharedObject (objectArray_7328, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_7328->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 193)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_stringset enumerator_7728 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_7728.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_7728.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 199))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 199)) ;
    ...
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_8108 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_8108.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_8108.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 209))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 209)) ;
    ...
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_8402 (objectArray_7328->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_8425 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_8402.hasCurrentObject () && enumerator_8425.hasCurrentObject ()) {
        ...
        cEnumerator_formalParameterSignature enumerator_8527 (enumerator_8425.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_8527.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_8527.current_mFormalArgumentType (HERE), enumerator_8527.current_mFormalArgumentPassingMode (HERE), enumerator_8527.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 219)) ;
          enumerator_8527.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_8402.current_mSignatureForGeneration (HERE), enumerator_8402.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_8425.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 221)) ;
        }
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_9387 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_9387.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_9468 (enumerator_9387.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_9468.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_9638 (enumerator_9468.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_9638.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_9638.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 249)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_9638.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_9638.current_mFormalArgumentName (HERE), enumerator_9638.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 250))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 250)) ;
        var_signature.addAssign_operation (var_t, enumerator_9638.current_mFormalArgumentPassingMode (HERE), enumerator_9638.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 251)) ;
        enumerator_9638.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_9468.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_9468.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 253)) ;
      }
      enumerator_9468.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_9387.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 255)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_33543 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_33543.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_33543.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 822)) ;
    enumerator_33543.gotoNextObject () ;
  }
  {
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_55795 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_55795.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_55795.current_mFormalArgumentType (HERE), enumerator_55795.current_mFormalArgumentPassingMode (HERE), enumerator_55795.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1433)) ;
  ...
  cEnumerator_syntaxInstructionList enumerator_56133 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_56133.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_56133.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1439)) ;
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_57662 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_57662.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_57746 (enumerator_57662.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_57746.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_57913 (enumerator_57746.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_57913.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_57913.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1489)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_57913.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_57913.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_57913.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490)) ;
        var_signature.addAssign_operation (var_type, enumerator_57913.current_mFormalArgumentPassingMode (HERE), enumerator_57913.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1491)) ;
        enumerator_57913.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_57746.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_57746.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1493)) ;
      }
      enumerator_57746.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_57662.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1495)) ;
    }
    enumerator_57662.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxRuleListAST enumerator_58862 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58862.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_59046_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58862.current_mNonterminalName (HERE), joker_59046_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1512)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59073 (enumerator_58862.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59073.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59073.current_mFormalArguments (HERE), enumerator_59073.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59073.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1518)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59073.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59073.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1534)) ;
      enumerator_59073.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_60044_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58862.current_mNonterminalName (HERE), joker_60044_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1543)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_58862.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1545)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1544)) ;
...
static void categoryMethod_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 165)).isValid ()) {
    uint32_t variant_6363 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 165)).uintValue () ;
    bool loop_6363 = true ;
    while (loop_6363) {
      loop_6363 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).isValid () ;
      if (loop_6363) {
        loop_6363 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).boolValue () ;
      }
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_12574_0 ; // Joker input parameter
    GALGAS_location joker_12588_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_12574_0, var_signature, joker_12588_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 319)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_stringlist enumerator_14698 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_14698.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14698.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 380))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 380)) ;
  ...
  cEnumerator_stringlist enumerator_15255 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_15255.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_15255.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 395))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 395)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_16733_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_16733_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 433)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_23055_0 ; // Joker input parameter
  GALGAS_string joker_23058_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_23055_0, joker_23058_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 566)) ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_29652 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_29671 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_29652.hasCurrentObject () && enumerator_29671.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_29652.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_29671.current_mLexicalType (HERE), enumerator_29671.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)) ;
    enumerator_29652.gotoNextObject () ;
    enumerator_29671.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_29906 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_29906.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_29906.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)).operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_30019 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_30019.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_30019.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 730))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 730)) ;
        enumerator_30019.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_29906.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_29906.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_31352 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_31352.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_31352.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_31352.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_31352.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (enumerator_31352.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 774))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 774))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)) ;
    enumerator_31352.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_31753 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_31753.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (GALGAS_string ("::kIndexing_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (enumerator_31753.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_35176 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_35176.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_35176.current_mSyntaxInstructionList (HERE), enumerator_35176.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 877)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_35176.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 891)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_37157.hasCurrentObject ()) {
    ...
    index_37113.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_38552 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_38552.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_38552.current_mSyntaxInstructionList (HERE), enumerator_38552.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 971)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_38552.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 985)) ;
    enumerator_38552.gotoNextObject () ;
  }
  {
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_40024 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_39980 ((uint32_t) 0) ;
  while (enumerator_40024.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_39980.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_40024.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1011)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1019)) ;
    enumerator_40024.gotoNextObject () ;
    index_39980.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_41219 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_41219.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_41385 (enumerator_41219.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_41385.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_41385.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1047)) ;
      enumerator_41385.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_41219.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1060)) ;
    enumerator_41219.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_42089_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_42089_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1065)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42274 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_42274.hasCurrentObject () && bool_0) {
    while (enumerator_42274.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_42274.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1071)), enumerator_42274.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1069)) ;
      enumerator_42274.gotoNextObject () ;
      if (enumerator_42274.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_43453 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_43453.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_43453.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1097)) ;
    }
    if (enumerator_43453.hasNextObject ()) {
