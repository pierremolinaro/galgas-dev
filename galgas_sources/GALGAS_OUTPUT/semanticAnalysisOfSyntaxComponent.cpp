...
cCollectionElement_ruleLabelImplementationList * GALGAS_ruleLabelImplementationList::makeElement (const GALGAS_lstring & in_mLabelName,
                                                                                                  const GALGAS_formalParameterListForGeneration & in_mSignatureForGeneration,
                                                                                                  const GALGAS_formalParameterSignature & in_mSignature,
                                                                                                  const GALGAS_location & in_mEndOfArgumentLocation,
                                                                                                  const GALGAS_semanticInstructionListForGeneration & in_mInstructionListForGeneration
                                                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_ruleLabelImplementationList * result = NULL ;
  macroMyNew (result, cCollectionElement_ruleLabelImplementationList (in_mLabelName,
...
cCollectionElement_ruleDeclarationList * GALGAS_ruleDeclarationList::makeElement (const GALGAS_string & in_mNonterminalName,
                                                                                  const GALGAS_uint & in_mRuleIndex,
                                                                                  const GALGAS_ruleLabelImplementationList & in_mLabelImplementationList,
                                                                                  const GALGAS_bool & in_mHasParseLabel
                                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_ruleDeclarationList * result = NULL ;
  macroMyNew (result, cCollectionElement_ruleDeclarationList (in_mNonterminalName,
                                                                                  in_mRuleIndex,
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
  ...
  const cMapElement_nonterminalMap * objectArray_5699 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (134))) ;
  if (NULL != objectArray_5699) {
      macroValidSharedObject (objectArray_5699, const cMapElement_nonterminalMap) ;
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, objectArray_5699->mAttribute_mHasParseLabel.objectCompare (constinArgument_inHasParseLabel)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_0 ;
      if (objectArray_5699->mAttribute_mHasParseLabel.isValidAndTrue ()) {
        temp_0 = GALGAS_string ("with") ;
      }else{
        temp_0 = GALGAS_string ("without") ;
      }
      //--- @ifExpressionForGeneration
      ...
      GALGAS_location location_2 (constinArgument_inNonTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (GALGAS_string ("' is redeclared ") COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (temp_0 COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (GALGAS_string (" 'parse' label, but first declaration declares it ") COMMA_SOURCE_FILE_AT_LINE (139)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (140)).operator_concat (GALGAS_string (" 'parse' label") COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (136)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_5699->mAttribute_mLabelMap.reader_allKeys (SOURCE_FILE_AT_LINE (144)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringset var_reDeclarationLabelSet = constinArgument_inNonterminalLabelMap.reader_allKeys (SOURCE_FILE_AT_LINE (145)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (147)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6431 (var_missingLabelSet, true) ;
      //--- simple foreach instruction
      while (enumerator_6431.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6431.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)) ;
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("' nonterminal is redeclared without the following label(s):") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (152)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6811 (var_newLabelSet, true) ;
      //--- simple foreach instruction
      while (enumerator_6811.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6811.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
        enumerator_6811.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (constinArgument_inNonTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (GALGAS_string ("' nonterminal is redeclared with the new label(s):") COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (162)) ;
    }
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (166)).isValidAndTrue ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_nonterminalLabelMap enumerator_7103 (objectArray_5699->mAttribute_mLabelMap, true) ;
      cEnumerator_nonterminalLabelMap enumerator_7136 (constinArgument_inNonterminalLabelMap, true) ;
      //--- simple foreach instruction
      while (enumerator_7103.hasCurrentObject () && enumerator_7136.hasCurrentObject ()) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_formalParameterSignature enumerator_7239 (enumerator_7136.current_mSignature (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_7239.hasCurrentObject ()) {
          //-------- @addAssignInstructionForGeneration
          var_newSignature.addAssign_operation (enumerator_7239.current_mFormalArgumentType (HERE), enumerator_7239.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (170)) ;
          enumerator_7239.gotoNextObject () ;
        }
        { //-------- @routineCallInstructionForGeneration
        routine_checkMethodSignatures (enumerator_7103.current_mSignatureForGeneration (HERE), enumerator_7103.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_7136.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (172)) ;
        } //-------- @routineCallInstructionForGeneration
    ...
    ioArgument_ioNonterminalDeclarationMap.modifier_insertKey (constinArgument_inNonTerminalName, constinArgument_inNonterminalLabelMap, constinArgument_inHasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) ;
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonterminalDeclarationListAST enumerator_8095 (constinArgument_inNonterminalDeclarationList, true) ;
  //--- simple foreach instruction
  while (enumerator_8095.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_nonTerminalLabelListAST enumerator_8176 (enumerator_8095.current_mLabels (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_8176.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_8346 (enumerator_8176.current_mFormalArgumentList (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_8346.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_8346.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
        //-------- @addAssignInstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_8346.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_8346.current_mFormalArgumentName (HERE), enumerator_8346.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
        //-------- @addAssignInstructionForGeneration
        var_signature.addAssign_operation (var_t, enumerator_8346.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (202)) ;
        enumerator_8346.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_8176.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_8176.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_8176.gotoNextObject () ;
    }
    { //-------- @routineCallInstructionForGeneration
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_8095.current_mNonterminalName (HERE), var_nonterminalLabelMap, enumerator_8095.current_mHasParseLabel (HERE), outArgument_outNonterminalDeclarationMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (452)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_19092 (constinArgument_inSyntaxInstructionListAST, true) ;
  //--- simple foreach instruction
  while (enumerator_19092.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_19092.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_19092.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (469)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (982)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (990)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListForGeneration enumerator_38428 (outArgument_outSignatureForGeneration, true) ;
  //--- simple foreach instruction
  while (enumerator_38428.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    outArgument_outSignature.addAssign_operation (enumerator_38428.current_mFormalArgumentType (HERE), enumerator_38428.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (992)) ;
    enumerator_38428.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (995)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (996)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_38737 (constinArgument_inSyntaxInstructionList, true) ;
  //--- simple foreach instruction
  while (enumerator_38737.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_38737.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (998)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_38737.gotoNextObject () ;
  }
  //-------- @methodCallInstructionForGeneration
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1030)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1031)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_40129 (constinArgument_inRuleList, true) ;
  //--- simple foreach instruction
  while (enumerator_40129.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1038)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_40213 (enumerator_40129.current_mLabelList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_40213.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1040)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1041)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_40380 (enumerator_40213.current_mFormalArguments (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_40380.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_40380.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
        //-------- @addAssignInstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_40380.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_40380.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_40380.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1044)) ;
        //-------- @addAssignInstructionForGeneration
        var_signature.addAssign_operation (var_type, enumerator_40380.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1045)) ;
        enumerator_40380.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_40213.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_40213.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1047)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_40213.gotoNextObject () ;
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_nonterminalMap * objectArray_40846 = (const cMapElement_nonterminalMap *) var_nonterminalMap.readAccessForWithInstruction_hasKey (enumerator_40129.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1049))) ;
    if (NULL != objectArray_40846) {
        macroValidSharedObject (objectArray_40846, const cMapElement_nonterminalMap) ;
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40129.current_mNonterminalName (HERE), var_nonterminalLabelMap, objectArray_40846->mAttribute_mHasParseLabel, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1050)) ;
      } //-------- @routineCallInstructionForGeneration
    }else{
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40129.current_mNonterminalName (HERE), var_nonterminalLabelMap, GALGAS_bool (false), var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1052)) ;
      } //-------- @routineCallInstructionForGeneration
    }
    enumerator_40129.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1059)), GALGAS_string ("") COMMA_SOURCE_FILE_AT_LINE (1056)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1064)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_41474 (constinArgument_inRuleList, true) ;
  //--- simple foreach instruction
  while (enumerator_41474.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1067)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_41631 (enumerator_41474.current_mLabelList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_41631.hasCurrentObject ()) {
      ...
      { //-------- @routineCallInstructionForGeneration
      routine_semanticAnalysisOfRuleLabel (enumerator_41631.current_mFormalArguments (HERE), enumerator_41631.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_41631.current_mEndOfInstructionList (HERE), var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1074)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_ruleLabelImplementationList.addAssign_operation (enumerator_41631.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_41631.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1088)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_42571_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_41474.current_mNonterminalName (HERE), joker_42571_0, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1098)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_ruleDeclarationList.addAssign_operation (enumerator_41474.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1100)), var_newRuleIndex, var_ruleLabelImplementationList, var_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1099)) ;
    //-------- @incrementInstructionForGeneration
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)) ;
    enumerator_41474.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (1108)) ;
}
...
GALGAS_syntaxDeclarationForGeneration GALGAS_syntaxDeclarationForGeneration::constructor_new (const GALGAS_string & inAttribute_mComponentName,
  ...
  if (inAttribute_mComponentName.isValid () && inAttribute_mLexiqueName.isValid () && inAttribute_mNonterminalDeclarationMap.isValid () && inAttribute_mRuleDeclarationList.isValid () && inAttribute_mSelectMethodCount.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_syntaxDeclarationForGeneration (inAttribute_mComponentName, inAttribute_mLexiqueName, inAttribute_mNonterminalDeclarationMap, inAttribute_mRuleDeclarationList, inAttribute_mSelectMethodCount COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_syntaxDeclarationForGeneration::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_syntaxDeclarationForGeneration (p->mAttribute_mComponentName, p->mAttribute_mLexiqueName, p->mAttribute_mNonterminalDeclarationMap, p->mAttribute_mRuleDeclarationList, p->mAttribute_mSelectMethodCount COMMA_THERE)) ;
...
static GALGAS_string categoryReader_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_uintlist var_selectMethodList = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (106)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @loopInstructionForGeneration
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)).isValid ()) {
    PMUInt32 variant_4743 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)).uintValue () ;
    bool loop_4743 = true ;
    while (loop_4743) {
      ...
      if (loop_4743 && (0 == variant_4743)) {
        loop_4743 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (108)) ;
      }
      if (loop_4743) {
        variant_4743 -- ;
        //-------- @addAssignInstructionForGeneration
        var_selectMethodList.addAssign_operation (var_idx COMMA_SOURCE_FILE_AT_LINE (110)) ;
        //-------- @incrementInstructionForGeneration
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
      }
    }
  }
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string (filewrapperTemplate_syntaxFileGenerationTemplate_syntaxAnalyserClassDeclaration (inCompiler, object->mAttribute_mComponentName, object->mAttribute_mLexiqueName, object->mAttribute_mNonterminalDeclarationMap, object->mAttribute_mRuleDeclarationList, var_selectMethodList COMMA_SOURCE_FILE_AT_LINE (113))) ;
//---
...
static void categoryMethod_semanticInstructionAST_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) var_t.ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionListForGeneration, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_bool var_hasParseLabel ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inNonterminalMap.method_searchKey (object->mAttribute_mNonterminalName, var_labelMap, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_formalParameterSignature var_signature ;
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (264)).objectCompare (GALGAS_string ("parse"))).isValidAndTrue ()) {
    //-------- @ifInstructionForGeneration
    if (var_hasParseLabel.operator_not (SOURCE_FILE_AT_LINE (265)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mLabelName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '<").operator_concat (object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (267)).operator_concat (GALGAS_string (">' nonterminal does not declare the 'parse' label") COMMA_SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (266)) ;
      var_signature.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
      var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (271)) ;
    }
  }else{
    //-------- @methodCallInstructionForGeneration
    GALGAS_formalParameterListForGeneration joker_11413_0 ; // Joker input parameter
    GALGAS_location joker_11427_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_11413_0, var_signature, joker_11427_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mNonterminalName, GALGAS_string ("'<").operator_concat (object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE_AT_LINE (281)) COMMA_SOURCE_FILE_AT_LINE (281)).operator_concat (GALGAS_string (">' nonterminal declaration") COMMA_SOURCE_FILE_AT_LINE (281)), var_signature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_actualParameterListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (278)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_nonterminalInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE_AT_LINE (290)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (291)), var_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (288)) COMMA_SOURCE_FILE_AT_LINE (288)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualParameterListForGeneration enumerator_12557 (object->mAttribute_mActualParameterList, true) ;
  //--- simple foreach instruction
  while (enumerator_12557.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_parameterCppName ;
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_12557.current_mActualParameter (HERE).ptr (), ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_parameterCppNameList.addAssign_operation (var_parameterCppName COMMA_SOURCE_FILE_AT_LINE (312)) ;
    enumerator_12557.gotoNextObject () ;
  }
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("nt_").operator_concat (object->mAttribute_mNonterminalName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (315)).operator_concat (object->mAttribute_mLabelName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13032 (var_parameterCppNameList, true) ;
  //--- simple foreach instruction
  while (enumerator_13032.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13032.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (317)) COMMA_SOURCE_FILE_AT_LINE (317)) ;
  ...
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (320)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (320)) ;
  //-------- @ifInstructionForGeneration
  if (constinArgument_inGenerateCheckValid.isValidAndTrue ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_13337 (var_inputVariableList, true) ;
    //--- simple foreach instruction
    while (enumerator_13337.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_13337.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (325)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13547 (var_jokerParametersToReleaseList, true) ;
  //--- simple foreach instruction
  while (enumerator_13547.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13547.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inTerminalMap.method_searchKey (object->mAttribute_mTerminalName, var_sentAttributeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (348)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (350)).objectCompare (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (350)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    //--- @ifExpressionForGeneration
    GALGAS_string temp_0 ;
    if (GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (353)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    ...
    //--- @ifExpressionForGeneration
    GALGAS_string temp_1 ;
    if (GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (356)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      temp_1 = GALGAS_string ("s") ;
    }else{
      temp_1 = GALGAS_string ("") ;
    }
    GALGAS_location location_2 (object->mAttribute_mTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("naming the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (GALGAS_string ("$' requires ") COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (352)).reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (GALGAS_string ("parameter") COMMA_SOURCE_FILE_AT_LINE (353)).operator_concat (temp_0 COMMA_SOURCE_FILE_AT_LINE (353)).operator_concat (GALGAS_string (", but this instruction names ") COMMA_SOURCE_FILE_AT_LINE (354)).operator_concat (object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (355)).reader_string (SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)).operator_concat (GALGAS_string (" parameter") COMMA_SOURCE_FILE_AT_LINE (355)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_terminalCheckAssignementList var_terminalCheckAssignementList = GALGAS_terminalCheckAssignementList::constructor_emptyList (SOURCE_FILE_AT_LINE (360)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualInputParameterListAST enumerator_14832 (object->mAttribute_mActualInputParameterList, true) ;
  cEnumerator_lexicalSentValueList enumerator_14853 (var_sentAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_14832.hasCurrentObject () && enumerator_14853.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, enumerator_14832.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (362)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_type ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_cppName ;
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsStrictSup, enumerator_14832.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (365)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        var_cppName = GALGAS_string ("var_").operator_concat (enumerator_14832.current_mActualParameterName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)) ;
        //-------- @assignmentInstructionForGeneration
        var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_14832.current_mActualParameterTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (enumerator_14832.current_mActualParameterName (HERE), var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (368)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }else{
        { //-------- @modifierCallInstructionForGeneration
        GALGAS_string joker_15433_0 ; // Joker input parameter
        ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_14832.current_mActualParameterName (HERE), var_type, var_cppName, joker_15433_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (370)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_expectedType ;
      //------- @switchInstructionForGeneration
      if (enumerator_14853.current_mLexicalType (HERE).isValid ()) {
        switch (enumerator_14853.current_mLexicalType (HERE).enumValue ()) {
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_14832.current_mActualParameterName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_14832.current_mActualParameterName (HERE).reader_string (SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
      }
      //-------- @addAssignInstructionForGeneration
      var_terminalCheckAssignementList.addAssign_operation (enumerator_14832.current_mActualParameterTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (389)), var_cppName, enumerator_14853.current_mLexicalAttributeName (HERE) COMMA_SOURCE_FILE_AT_LINE (388)) ;
    }
    enumerator_14832.gotoNextObject () ;
    enumerator_14853.gotoNextObject () ;
  }
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_terminalCheckInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTerminalName, constinArgument_inLexiqueName, var_terminalCheckAssignementList COMMA_SOURCE_FILE_AT_LINE (396)) COMMA_SOURCE_FILE_AT_LINE (396)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_terminalCheckAssignementList enumerator_17343 (object->mAttribute_mTerminalCheckAssignementList, true) ;
  //--- simple foreach instruction
  while (enumerator_17343.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, enumerator_17343.current_mTypeName (HERE).objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_17343.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)) ;
    }
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_17343.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (enumerator_17343.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (419)) ;
    enumerator_17343.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (424)) COMMA_SOURCE_FILE_AT_LINE (424)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string ("::kToken_") COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string (") COMMA_SOURCE_FILE_AT_LINE (") COMMA_SOURCE_FILE_AT_LINE (427)).operator_concat (object->mAttribute_mInstructionLocation.reader_line (SOURCE_FILE_AT_LINE (427)).reader_string (SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427)).operator_concat (GALGAS_string (")) ;\n") COMMA_SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
  //-------- @ifInstructionForGeneration
  if (constinArgument_inGenerateCheckValid.isValidAndTrue ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("#ifndef DO_NOT_GENERATE_CHECKINGS\n") COMMA_SOURCE_FILE_AT_LINE (430)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalCheckAssignementList enumerator_18226 (object->mAttribute_mTerminalCheckAssignementList, true) ;
    //--- simple foreach instruction
    while (enumerator_18226.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_18226.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (432)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (432)) COMMA_SOURCE_FILE_AT_LINE (432)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @incrementInstructionForGeneration
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (485)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mRepeatedInstructionList, object->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_repeated_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (490)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (503)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_20565 (object->mAttribute_mRepeatBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_20565.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_20565.current_mSyntaxInstructionList (HERE), enumerator_20565.current_mEndOf_5F_instructions (HERE), ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_20565.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (518)) ;
    enumerator_20565.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_repeat_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (521)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOf_5F_repeat_5F_instruction, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (523)) COMMA_SOURCE_FILE_AT_LINE (523)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_repeatFlagCppName = GALGAS_string ("repeatFlag_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (542)) COMMA_SOURCE_FILE_AT_LINE (542)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (542)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (543)).operator_concat (GALGAS_string (" = true ;\n") COMMA_SOURCE_FILE_AT_LINE (543)) COMMA_SOURCE_FILE_AT_LINE (543)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (544)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (544)) COMMA_SOURCE_FILE_AT_LINE (544)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_m_5F_repeated_5F_instructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (545)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (553)) COMMA_SOURCE_FILE_AT_LINE (553)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (553)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE_AT_LINE (553)) COMMA_SOURCE_FILE_AT_LINE (553)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (553)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) COMMA_SOURCE_FILE_AT_LINE (553)).operator_concat (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (553)) COMMA_SOURCE_FILE_AT_LINE (553)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_22404 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  GALGAS_uint index_22398 ((PMUInt32) 0) ;
  while (enumerator_22404.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_22398.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (555)).reader_string (SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_22404.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @appendInstructionForGeneration
    ...
    index_22398.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (554)) ;
  }
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n") COMMA_SOURCE_FILE_AT_LINE (565)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (566)).operator_concat (GALGAS_string (" = false ;\n") COMMA_SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n") COMMA_SOURCE_FILE_AT_LINE (567)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (568)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_choiceIndex = ioArgument_ioSelectMethodCount ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (586)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (590)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_23690 (object->mAttribute_mSelectBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_23690.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_23690.current_mSyntaxInstructionList (HERE), enumerator_23690.current_mEndOf_5F_instructions (HERE), ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (593)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_23690.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (605)) ;
    enumerator_23690.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_select_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (608)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @addAssignInstructionForGeneration
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (627)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (627)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (627)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (627)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (627)).operator_concat (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (627)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_25062 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  GALGAS_uint index_25056 ((PMUInt32) 0) ;
  while (enumerator_25062.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_25056.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (629)).reader_string (SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_25062.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (630)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (637)) ;
    enumerator_25062.gotoNextObject () ;
    index_25056.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
  }
  //-------- @appendInstructionForGeneration
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (657)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_referenceSelectMethodCount = ioArgument_ioSelectMethodCount ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_26148 (object->mAttribute_mParseRewindBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_26148.hasCurrentObject ()) {
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioSelectMethodCount = var_referenceSelectMethodCount ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (661)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxInstructionList enumerator_26314 (enumerator_26148.current_mSyntaxInstructionList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_26314.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_26314.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (663)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_26314.gotoNextObject () ;
    }
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_26148.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (674)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_location joker_26961_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_26961_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (679)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (680)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_27142 (var_tempListOfBranches, true) ;
  //--- complex foreach instruction
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_27142.hasCurrentObject () && bool_0) {
    while (enumerator_27142.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (enumerator_27142.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (685)), enumerator_27142.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
      enumerator_27142.gotoNextObject () ;
      if (enumerator_27142.hasCurrentObject ()) {
        bool_0 = var_ok.isValidAndTrue () ;
      }
    }
  }
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseRewindInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (690)) COMMA_SOURCE_FILE_AT_LINE (690)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (705)) COMMA_SOURCE_FILE_AT_LINE (705)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_parsingContextVar = GALGAS_string ("parsingContext_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (706)) COMMA_SOURCE_FILE_AT_LINE (706)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (706)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext ").operator_concat (var_parsingContextVar COMMA_SOURCE_FILE_AT_LINE (707)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (707)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)).operator_concat (GALGAS_string ("->parsingContext () ;\n") COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28259 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  while (enumerator_28259.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_28259.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
    } //-------- @routineCallInstructionForGeneration
    if (enumerator_28259.hasNextObject ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (718)).operator_concat (GALGAS_string ("->setParsingContext (") COMMA_SOURCE_FILE_AT_LINE (718)).operator_concat (var_parsingContextVar COMMA_SOURCE_FILE_AT_LINE (718)).operator_concat (GALGAS_string (") ; // rewind\n") COMMA_SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (718)) ;
    }
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variant_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (742)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (744)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)).operator_concat (GALGAS_string ("', but it should be '@") COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (743)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_while_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (750)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (755)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mEndOfWhileExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (757)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (757)) COMMA_SOURCE_FILE_AT_LINE (757)).operator_concat (GALGAS_string ("', but it should be '@") COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (756)) ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mDoInstructionList, object->mAttribute_mEndOfInstructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (766)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (779)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseLoopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variant_5F_expression, var_while_5F_expression, var_instructionList COMMA_SOURCE_FILE_AT_LINE (781)) COMMA_SOURCE_FILE_AT_LINE (781)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (797)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mVariantExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_variantVarCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (801)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (GALGAS_string (".isValid ()) {\n") COMMA_SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (803)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (804)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_variantVar = GALGAS_string ("variant_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (805)) COMMA_SOURCE_FILE_AT_LINE (805)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (805)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("PMUInt32 ").operator_concat (var_variantVar COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string (".uintValue () ;\n") COMMA_SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_loopVar = GALGAS_string ("loop_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (808)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_loopVar COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (GALGAS_string (" = true ;\n") COMMA_SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)) ;
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_loopVar COMMA_SOURCE_FILE_AT_LINE (810)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (810)) COMMA_SOURCE_FILE_AT_LINE (810)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVarCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (814)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (815)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n") COMMA_SOURCE_FILE_AT_LINE (815)) COMMA_SOURCE_FILE_AT_LINE (815)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (816)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ...
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext parsingContext = ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (819)) COMMA_SOURCE_FILE_AT_LINE (819)).operator_concat (GALGAS_string ("->parsingContext () ;\n") COMMA_SOURCE_FILE_AT_LINE (819)) COMMA_SOURCE_FILE_AT_LINE (819)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (820)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (GALGAS_string ("->setParsingContext (parsingContext) ;\n") COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
  { //-------- @modifierCallInstructionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (830)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (831)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, function_syntaxSignatureOfInstructionList (object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (838)), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (843)).operator_concat (GALGAS_string ("->resetTemplateString () ;\n") COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
  //-------- @appendInstructionForGeneration
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (861)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (867)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (898)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_ok = function_compareSyntaxSignature (function_syntaxSignatureOfInstructionList (var_when_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (901)), function_syntaxSignatureOfInstructionList (var_else_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (902)), object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (900)) ;
  //-------- @ifInstructionForGeneration
  if (var_ok.isValidAndTrue ()) {
    //-------- @addAssignInstructionForGeneration
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseWhenInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_when_5F_expression, var_when_5F_instructionListForGeneration, var_else_5F_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (907)) COMMA_SOURCE_FILE_AT_LINE (907)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_parseWhenInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhenExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE_AT_LINE (926)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar COMMA_SOURCE_FILE_AT_LINE (927)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n") COMMA_SOURCE_FILE_AT_LINE (927)) COMMA_SOURCE_FILE_AT_LINE (927)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (928)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n") COMMA_SOURCE_FILE_AT_LINE (935)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mElseInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (936)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @appendInstructionForGeneration
