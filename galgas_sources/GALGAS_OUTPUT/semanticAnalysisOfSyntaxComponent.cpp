...
//                    november 11th, 2010, at 20h36'22"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
var_cas_ioVariableMap.modifier_openBranch (inLexique COMMA_SOURCE_FILE_AT_LINE (438)) ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_18537 (var_cas_inSyntaxInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18537 = NULL ;
while (((operand_18537 = enumerator_18537.nextObject ()))) {
  macroValidPointer (operand_18537) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18537->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18537->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (441)) ;
  }
}
}
}
var_cas_ioVariableMap.modifier_closeBranch (inLexique, var_cas_inEndOfBranchLocation COMMA_SOURCE_FILE_AT_LINE (453)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                const cPtr_repeatInstruction * operand_19038,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
var_cas_ioVariableMap.modifier_openOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (471)) ;
GGS_semanticInstructionListForGeneration  var_cas_repeated_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19038->mRepeatedInstructionList,  operand_19038->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (474)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20010 (operand_19038->mRepeatBranchList, true) ;
...
var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_19038->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (505)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, operand_19038->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, operand_19038->mEndOf_repeat_instruction, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (507))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_20959,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20959 != NULL) {
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_20959->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (528)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_20959->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_20959->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_21789 (operand_20959->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_21789 = NULL ;
while (((operand_21789 = enumerator_21789.nextObject ()))) {
  macroValidPointer (operand_21789) ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_21789->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (538)) ;
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                const cPtr_selectInstruction * operand_22460,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_uint  & var_cas_ioSelectMethodCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22460 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (567)) ;
var_cas_ioVariableMap.modifier_openOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (569)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_23050 (operand_22460->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_23050 = NULL ;
while (((operand_23050 = enumerator_23050.nextObject ()))) {
  macroValidPointer (operand_23050) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_23050->mSyntaxInstructionList,  operand_23050->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (574)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_23050->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_22460->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (589)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, operand_22460->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (590))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_23932,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_23932->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_23932->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (607))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (607))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_24388 (operand_23932->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_24388 = NULL ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_24388->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (610)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseRewindInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                const cPtr_parseRewindInstruction * operand_24928,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_uint  & var_cas_ioSelectMethodCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24928 != NULL) {
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
const GGS_uint  var_cas_referenceSelectMethodCount = var_cas_ioSelectMethodCount ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_25449 (operand_24928->mParseRewindBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_25449 = NULL ;
while (((operand_25449 = enumerator_25449.nextObject ()))) {
  macroValidPointer (operand_25449) ;
...
{
  GGS_syntaxInstructionList::cEnumerator enumerator_25615 (operand_25449->mSyntaxInstructionList, true) ;
  const GGS_syntaxInstructionList::cElement * operand_25615 = NULL ;
  while (((operand_25615 = enumerator_25615.nextObject ()))) {
    macroValidPointer (operand_25615) ;
    { typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_25615->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_25615->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_instructionList, var_cas_ioVariableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (642)) ;
      }
    }
  }
}
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_25449->mEndOf_instructions) ;
}
}
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
GGS_location  automatic_var_26266_0 ;
var_cas_tempListOfBranches.modifier_popFirst (inLexique, var_cas_instructionList, automatic_var_26266_0 COMMA_SOURCE_FILE_AT_LINE (658)) ;
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_26440 (var_cas_tempListOfBranches, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_26440 = NULL ;
while (((operand_26440 = enumerator_26440.nextObject ()))
    && (var_cas_ok.isBuiltAndTrue ())) {
  macroValidPointer (operand_26440) ;
var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_referenceSignature, function_syntaxSignatureOfInstructionList (inLexique, operand_26440->mInstructionList COMMA_SOURCE_FILE_AT_LINE (664)), operand_26440->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (662)) ;
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseRewindInstructionForGeneration ::constructor_new (inLexique, operand_24928->mInstructionLocation, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (669))) ;
  }
}
...
category_method__parseRewindInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_parseRewindInstructionForGeneration * operand_26977,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26977 != NULL) {
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_27527 (operand_26977->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_27527 = enumerator_27527.nextObject () ;
if ((operand_27527 != NULL)) {
  bool _foreach_loop_27527 ;
  do{
  macroValidPointer (operand_27527) ;
  ::routine_generateInstructionList (inLexique,  operand_27527->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (688)) ;
  operand_27527 = enumerator_27527.nextObject () ;
  _foreach_loop_27527 = ((operand_27527 != NULL)) ;
  if (_foreach_loop_27527) {
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                const cPtr_parseLoopInstruction * operand_28057,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_uint  & var_cas_ioSelectMethodCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28057 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_variant_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28057->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28057->mVariantExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (714)) ;
  }
}
const GGS_bool cond_28861 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (719))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mUIntType) ;
if (cond_28861.isBuiltAndTrue ()) {
operand_28057->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (721)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (721)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inAnalysisContext.mPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (722)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (724)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28057->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28057->mWhileExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (727)) ;
  }
}
const GGS_bool cond_29361 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (732))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mBoolType) ;
if (cond_29361.isBuiltAndTrue ()) {
operand_28057->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (734)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (734)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inAnalysisContext.mPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (735)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (737)) ;
}
var_cas_ioVariableMap.modifier_openOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (740)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_28057->mDoInstructionList,  operand_28057->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (743)) ;
var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_28057->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (756)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_28057->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (758))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_34067,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34067 != NULL) {
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34067->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34067->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (846)) ;
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34067->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34067->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (859)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (") ;
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_34067->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (865)) ;
...
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_34067->mInstructionList COMMA_SOURCE_FILE_AT_LINE (881)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (880)) ;
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                const cPtr_parseWhenInstruction * operand_36642,
                                const GGS_analysisContext  var_cas_inAnalysisContext,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_uint  & var_cas_ioSelectMethodCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36642 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_36642->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_36642->mWhenExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (904)) ;
  }
}
var_cas_ioVariableMap.modifier_openOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (910)) ;
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_36642->mWhenInstructionList,  operand_36642->mEndOfWhenInstructionList,  var_cas_ioVariableMap,  var_cas_localSelectMethodCount,  var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (914)) ;
GGS_semanticInstructionListForGeneration  var_cas_else_instructionListForGeneration ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_36642->mElseInstructionList,  operand_36642->mEndOfElseInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (928)) ;
var_cas_ioVariableMap.modifier_closeOverride (inLexique, operand_36642->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (941)) ;
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, function_syntaxSignatureOfInstructionList (inLexique, var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (944)), function_syntaxSignatureOfInstructionList (inLexique, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (945)), operand_36642->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (943)) ;
const GGS_bool cond_38608 = var_cas_ok ;
if (cond_38608.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_36642->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (950))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_CompilerEx & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_38777,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38777 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//--------- @parseWhenInstructionForGeneration\n") ;
GGS_string var_cas_sourceVar ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_38777->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_38777->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (968)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_sourceVar) ;
var_cas_ioGeneratedCode.appendCString (".isValidAndTrue ()) {\n") ;
::routine_generateInstructionList (inLexique,  operand_38777->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (970)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_38777->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (977)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                const cPtr_blockInstruction * operand_39671,
                                const GGS_analysisContext  /* var_cas_inAnalysisContext */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                const GGS_nonterminalMap   /* var_cas_inNonterminalMap */,
...
operand_39671->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  }
}
...
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_41344 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_41344 = NULL ;
while (((operand_41344 = enumerator_41344.nextObject ()))) {
  macroValidPointer (operand_41344) ;
var_cas_outSignature.addAssign_operation (operand_41344->mFormalArgumentType, operand_41344->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_41653 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_41653 = NULL ;
while (((operand_41653 = enumerator_41653.nextObject ()))) {
  macroValidPointer (operand_41653) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_41653->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_41653->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  }
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43045 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43045 = NULL ;
while (((operand_43045 = enumerator_43045.nextObject ()))) {
  macroValidPointer (operand_43045) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43129 (operand_43045->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43129 = NULL ;
while (((operand_43129 = enumerator_43129.nextObject ()))) {
  macroValidPointer (operand_43129) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_43296 (operand_43129->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_43296 = NULL ;
    while (((operand_43296 = enumerator_43296.nextObject ()))) {
      macroValidPointer (operand_43296) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43296->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1083)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_43296->mFormalArgumentPassingMode, var_cas_type, operand_43296->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_43296->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_43296->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_43129->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43129->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1087)) ;
}
}
elementOf_GGS_nonterminalMap * operand_43765 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_43045->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1089))) ;
if (NULL != operand_43765) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43045->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_43765->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1090)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43045->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1092)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_44390 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_44390 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_44547 (operand_44390->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_44547 = NULL ;
while (((operand_44547 = enumerator_44547.nextObject ()))) {
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_44547->mFormalArguments,  operand_44547->mSyntaxInstructionList,  var_cas_analysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_44547->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1114)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_44547->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_44547->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_45506_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_44390->mNonterminalName, automatic_var_45506_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1138)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_44390->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1140)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
