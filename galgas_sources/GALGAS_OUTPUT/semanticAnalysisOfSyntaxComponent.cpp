...
{
GGS_terminalCheckAssignementList::cEnumerator enumerator_17327 (operand_17064->mTerminalCheckAssignementList, true) ;
const GGS_terminalCheckAssignementList::cElement * operand_17327 = NULL ;
while (((operand_17327 = enumerator_17327.nextObject ()))) {
  macroValidPointer (operand_17327) ;
const GGS_bool cond_17451 = (operand_17327->mTypeName).operator_isNotEqual (GGS_string ("")) ;
if (cond_17451.isBuiltAndTrue ()) {
  var_cas_ioGeneratedCode.appendCString ("GALGAS_") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17327->mTypeName.reader_identifierRepresentation ()) ;
  var_cas_ioGeneratedCode.appendCString (" * ") ;
}else if (cond_17451.isBuiltAndFalse ()) {
  var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17327->mTargetVarCppName) ;
  var_cas_ioGeneratedCode.appendCString (") ;\n") ;
}
var_cas_ioGeneratedCode.dotAssign_operation (operand_17327->mTargetVarCppName) ;
var_cas_ioGeneratedCode.appendCString (" = ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17327->mSourceLexicalAttributeName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (" () ;\n") ;
}
}
var_cas_ioUnusedVariableCppNameSet.modifier_removeKey (inLexique, function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (428)) COMMA_SOURCE_FILE_AT_LINE (428)) ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (429))) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17064->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (431)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (431))) ;
var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
  }
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_18965 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18965 = NULL ;
while (((operand_18965 = enumerator_18965.nextObject ()))) {
  macroValidPointer (operand_18965) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18965->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18965->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (455)) ;
  }
}
}
}
const GGS_bool cond_19516 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_19516.isBuiltAndTrue ()) {
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_19746,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19746->mRepeatedInstructionList,  operand_19746->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (499)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20831 (operand_19746->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_20831 = NULL ;
while (((operand_20831 = enumerator_20831.nextObject ()))) {
  macroValidPointer (operand_20831) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_20831->mSyntaxInstructionList,  operand_20831->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (516)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_20831->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_19746->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (532)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, operand_19746->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, operand_19746->mEndOf_repeat_instruction, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (534))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_21803,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21803 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @repeatInstructionForGeneration\n") ;
const GGS_string var_cas_repeatFlagCppName = (GGS_string ("repeatFlag_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (552))) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_21803->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (555)) ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (561)) ;
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_21803->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_21803->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (562))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (562))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_22633 (operand_21803->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_22633 = NULL ;
while (((operand_22633 = enumerator_22633.nextObject ()))) {
  macroValidPointer (operand_22633) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (564)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_22633->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (565)) ;
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_23304,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23304 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (596)) ;
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_23984 (operand_23304->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_23984 = NULL ;
while (((operand_23984 = enumerator_23984.nextObject ()))) {
  macroValidPointer (operand_23984) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_23984->mSyntaxInstructionList,  operand_23984->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (603)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_23984->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_23304->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (619)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, operand_23304->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (620))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_24889,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24889 != NULL) {
...
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24889->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24889->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (637))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (637))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_25345 (operand_24889->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_25345 = NULL ;
while (((operand_25345 = enumerator_25345.nextObject ()))) {
  macroValidPointer (operand_25345) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (639)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (639))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_25345->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (640)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_25881,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (668)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_26484 (operand_25881->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_26484 = NULL ;
while (((operand_26484 = enumerator_26484.nextObject ()))) {
  macroValidPointer (operand_26484) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_26484->mSyntaxInstructionList,  operand_26484->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (673)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_26484->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_25881->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (689)) ;
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
GGS_location  automatic_var_27301_0 ;
var_cas_tempListOfBranches.modifier_popFirst (inLexique, var_cas_instructionList, automatic_var_27301_0 COMMA_SOURCE_FILE_AT_LINE (693)) ;
const GGS_semanticInstructionListForGeneration  var_cas_referenceSignature = function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (694)) ;
GGS_bool var_cas_ok = GGS_bool (true) ;
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_27475 (var_cas_tempListOfBranches, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_27475 = NULL ;
while (((operand_27475 = enumerator_27475.nextObject ()))
    && (var_cas_ok.isBuiltAndTrue ())) {
  macroValidPointer (operand_27475) ;
var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_referenceSignature, function_syntaxSignatureOfInstructionList (inLexique, operand_27475->mInstructionList COMMA_SOURCE_FILE_AT_LINE (699)), operand_27475->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (697)) ;
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseDoInstructionForGeneration ::constructor_new (inLexique, operand_25881->mInstructionLocation, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (704))) ;
  }
}
...
category_method__parseDoInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstructionForGeneration * operand_28004,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28004 != NULL) {
...
const GGS_string var_cas_parsingContextVar = (GGS_string ("parsingContext_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (719))) ;
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_28550 (operand_28004->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_28550 = enumerator_28550.nextObject () ;
if ((operand_28550 != NULL)) {
  GGS_uint var_cas_IDX (true, 0) ;
  bool _foreach_loop_28550 ;
  do{
  macroValidPointer (operand_28550) ;
  ::routine_generateInstructionList (inLexique,  operand_28550->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (723)) ;
  var_cas_IDX.mValue ++ ;
  operand_28550 = enumerator_28550.nextObject () ;
  _foreach_loop_28550 = ((operand_28550 != NULL)) ;
  if (_foreach_loop_28550) {
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (730)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
    var_cas_ioGeneratedCode.appendCString ("\n") ;
  }
  }while (_foreach_loop_28550) ;
}
}
  }
}
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_29033,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29033 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_variant_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_29033->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_29033->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (750)) ;
  }
}
const GGS_bool cond_29913 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (756))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_29913.isBuiltAndTrue ()) {
operand_29033->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (758)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (758)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (759)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (761)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_29033->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_29033->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (764)) ;
  }
}
const GGS_bool cond_30400 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (770))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_30400.isBuiltAndTrue ()) {
operand_29033->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (772)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (772)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (773)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (775)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (778)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_29033->mDoInstructionList,  operand_29033->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (781)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_29033->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (795)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_29033->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (797))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_31288,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31288 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @parseLoopInstructionForGeneration\n") ;
GGS_string var_cas_variantVarCppName ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31288->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31288->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (815)) ;
  }
}
const GGS_string var_cas_executeParseVar = (GGS_string ("executeParse_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (817))) ;
var_cas_ioTemporaryVariableIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (817)) ;
var_cas_ioGeneratedCode.appendCString ("bool ") ;
...
const GGS_string var_cas_variantVar = (GGS_string ("variant_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (821))) ;
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31288->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31288->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (826)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (" = (NULL == ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (830)) ;
const GGS_string var_cas_loopVar = (GGS_string ("loop_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (831))) ;
var_cas_ioTemporaryVariableIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (831)) ;
var_cas_ioGeneratedCode.appendCString ("bool ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (834)) ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (" = false ;\n") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_31288->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (841)) ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (848)) ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (849))) ;
var_cas_ioGeneratedCode.appendCString ("->setParsingContext (parsingContext) ;\n") ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31288->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31288->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (850)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (" = (NULL != ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_31288->mInstructionList COMMA_SOURCE_FILE_AT_LINE (864)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (863)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_34979,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34979 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_34979->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34979->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (888)) ;
  }
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_35764 (operand_34979->mWhenInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_35764 = NULL ;
while (((operand_35764 = enumerator_35764.nextObject ()))) {
  macroValidPointer (operand_35764) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_35764->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_35764->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_when_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (898)) ;
  }
}
}
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_36241 (operand_34979->mElseInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_36241 = NULL ;
while (((operand_36241 = enumerator_36241.nextObject ()))) {
  macroValidPointer (operand_36241) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_36241->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_36241->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_else_instructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (914)) ;
  }
}
}
}
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration, operand_34979->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (928)) ;
const GGS_bool cond_37014 = var_cas_ok ;
if (cond_37014.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_34979->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (931))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_37183,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37183 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//--------- @parseWhenInstructionForGeneration\n") ;
GGS_string var_cas_sourceVar ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_37183->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_37183->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (949)) ;
  }
}
const GGS_string var_cas_boolVarCppName = (GGS_string ("parseWhen_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (950))) ;
var_cas_ioTemporaryVariableIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (950)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_37183->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (954)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_37183->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (961)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_38406,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38406 != NULL) {
operand_38406->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (986)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1009)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignatureForGeneration COMMA_SOURCE_FILE_AT_LINE (1010)) ;
var_cas_outSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_40196 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_40196 = NULL ;
while (((operand_40196 = enumerator_40196.nextObject ()))) {
  macroValidPointer (operand_40196) ;
var_cas_outSignature.addAssign_operation (operand_40196->mFormalArgumentType, operand_40196->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_40506 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_40506 = NULL ;
while (((operand_40506 = enumerator_40506.nextObject ()))) {
  macroValidPointer (operand_40506) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_40506->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_40506->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  }
}
}
}
if (var_cas_variableMap.isBuilt ()) {
  var_cas_variableMap (HERE)->method_checkAutomatonStates (inLexique, var_cas_inEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (1040)) ;
}
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_semanticAnalysisOfSyntaxComponent (C_Compiler & inLexique,
  ...
  #endif
GGS_nonterminalMap  var_cas_nonterminalMap = GGS_nonterminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1060)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1061)) ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_41956 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_41956 = NULL ;
while (((operand_41956 = enumerator_41956.nextObject ()))) {
  macroValidPointer (operand_41956) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1068)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_42040 (operand_41956->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_42040 = NULL ;
while (((operand_42040 = enumerator_42040.nextObject ()))) {
  macroValidPointer (operand_42040) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_42207 (operand_42040->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_42207 = NULL ;
    while (((operand_42207 = enumerator_42207.nextObject ()))) {
      macroValidPointer (operand_42207) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42207->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1073)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_42207->mFormalArgumentPassingMode, var_cas_type, operand_42207->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_42207->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_42207->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_42040->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_42040->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1077)) ;
}
}
elementOf_GGS_nonterminalMap * operand_42676 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_41956->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1079))) ;
if (NULL != operand_42676) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41956->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_42676->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1080)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41956->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1082)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43140 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43140 = NULL ;
while (((operand_43140 = enumerator_43140.nextObject ()))) {
  macroValidPointer (operand_43140) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43297 (operand_43140->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43297 = NULL ;
while (((operand_43297 = enumerator_43297.nextObject ()))) {
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_43297->mFormalArguments,  operand_43297->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_43297->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1097)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_43297->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43297->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_44285_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_43140->mNonterminalName, automatic_var_44285_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1122)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_43140->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1124)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
var_cas_newRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1129)) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalMap, var_cas_ruleDeclarationList, var_cas_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  #ifdef DEBUG_TRACE_ENABLED
