...
//                    december 23th, 2013, at 19h57'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileHeader (C_Compiler * /* inCompiler */,
  ...
  if (in_IMPORTED_5F_COMPONENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_431 (in_IMPORTED_5F_COMPONENT_5F_LIST, kEnumeration_up) ;
...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_IMPORTED_5F_COMPONENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_231 (in_IMPORTED_5F_COMPONENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_231.hasCurrentObject ()) {
      result << "#include \"" ;
      result << enumerator_231.current_mValue (HERE).stringValue () ;
      result << ".h\"\n" ;
...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxAnalyserClassDeclaration (C_Compiler * inCompiler,
  ...
  if (in_NONTERMINAL_5F_MAP.isValid ()) {
    cEnumerator_nonterminalMap enumerator_643 (in_NONTERMINAL_5F_MAP, kEnumeration_up) ;
    while (enumerator_643.hasCurrentObject ()) {
      GALGAS_uint index_675_ (0) ;
      if (enumerator_643.current_mLabelMap (HERE).isValid ()) {
        cEnumerator_nonterminalLabelMap enumerator_675 (enumerator_643.current_mLabelMap (HERE), kEnumeration_up) ;
        while (enumerator_675.hasCurrentObject ()) {
          result << "  protected : virtual void nt_" ;
          result << enumerator_643.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (14)).stringValue () ;
          result << "_" ;
          result << enumerator_675.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (14)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_831_IDX (0) ;
          if (enumerator_675.current_mSignature (HERE).isValid ()) {
            cEnumerator_formalParameterSignature enumerator_831 (enumerator_675.current_mSignature (HERE), kEnumeration_up) ;
      ...
      result << "  protected : virtual void nt_" ;
      result << enumerator_643.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (30)).stringValue () ;
      ...
      if (kBoolTrue == test_3) {
        result << "  protected : virtual void nt_" ;
        result << enumerator_643.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (33)).stringValue () ;
  ...
  if (in_RULE_5F_DECLARATION_5F_LIST.isValid ()) {
    cEnumerator_ruleDeclarationList enumerator_1999 (in_RULE_5F_DECLARATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_1999.hasCurrentObject ()) {
      GALGAS_uint index_2037_ (0) ;
      if (enumerator_1999.current_mLabelImplementationList (HERE).isValid ()) {
        cEnumerator_ruleLabelImplementationList enumerator_2037 (enumerator_1999.current_mLabelImplementationList (HERE), kEnumeration_up) ;
        while (enumerator_2037.hasCurrentObject ()) {
          ...
          result << "_" ;
          result << enumerator_1999.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (39)).stringValue () ;
          result << "_i" ;
          result << enumerator_1999.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (39)).stringValue () ;
          result << "_" ;
          result << enumerator_2037.current_mLabelName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (39)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_2264_IDX (0) ;
          if (enumerator_2037.current_mSignature (HERE).isValid ()) {
            cEnumerator_formalParameterSignature enumerator_2264 (enumerator_2037.current_mSignature (HERE), kEnumeration_up) ;
      ...
      result << "_" ;
      result << enumerator_1999.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << "_i" ;
      result << enumerator_1999.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (54)).stringValue () ;
      result << "_parse (C_Lexique_" ;
      result << in_LEXIQUE_5F_NAME.stringValue () ;
      result << " * inLexique) ;\n"
        "\n" ;
      ...
      if (kBoolTrue == test_7) {
        ...
        result << "_" ;
        result << enumerator_1999.current_mNonterminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (56)).stringValue () ;
        result << "_i" ;
        result << enumerator_1999.current_mRuleIndex (HERE).reader_string (SOURCE_FILE_AT_LINE (56)).stringValue () ;
        result << "_indexing (C_Lexique_" ;
        result << in_LEXIQUE_5F_NAME.stringValue () ;
        result << " * inLexique) ;\n"
          "\n" ;
  ...
  if (in_SELECT_5F_METHOD_5F_LIST.isValid ()) {
    cEnumerator_uintlist enumerator_3562 (in_SELECT_5F_METHOD_5F_LIST, kEnumeration_up) ;
    while (enumerator_3562.hasCurrentObject ()) {
      ...
      result << "_" ;
      result << enumerator_3562.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_NAME.stringValue () ;
      result << " *) = 0 ;\n"
        "\n" ;
...
static GALGAS_string categoryReader_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)).isValid ()) {
    PMUInt32 variant_4743 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)).uintValue () ;
    bool loop_4743 = true ;
    while (loop_4743) {
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (344)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
  ...
  while (enumerator_14334.hasCurrentObject () && enumerator_14353.hasCurrentObject ()) {
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_14334.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (350)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_unifiedTypeMapProxy var_type ;
      GALGAS_string var_cppName ;
      const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, enumerator_14334.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (353)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
  }
  ...
  while (enumerator_23307.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_23263.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).reader_string (SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)) ;
    {
  ...
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
  }
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_uint index_25974 ((PMUInt32) 0) ;
  while (enumerator_26018.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_25974.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (650)).reader_string (SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)) ;
    {
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("PMUInt32 ").operator_concat (var_variantVar COMMA_SOURCE_FILE_AT_LINE (831)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (831)).operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (831)).operator_concat (GALGAS_string (".uintValue () ;\n") COMMA_SOURCE_FILE_AT_LINE (831)) COMMA_SOURCE_FILE_AT_LINE (831)) ;
  ...
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) ;
  }
  ...
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (853)) ;
  }
  ...
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (857)) ;
  }
