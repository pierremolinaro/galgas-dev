...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListForGeneration enumerator_39907 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39907.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outSignature.addAssign_operation (enumerator_39907.current_mFormalArgumentType (HERE), enumerator_39907.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1039)) ;
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_41718 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41718.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_41802 (enumerator_41718.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41802.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_41969 (enumerator_41802.current_mFormalArguments (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_41969.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_41969.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1094)) ;
        //-------- @plusEqualnstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_41969.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_41969.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_41969.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1095)) COMMA_SOURCE_FILE_AT_LINE (1095)) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
        //-------- @plusEqualnstructionForGeneration
        var_signature.addAssign_operation (var_type, enumerator_41969.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1096)) ;
        enumerator_41969.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_41802.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_41802.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1098)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_41802.gotoNextObject () ;
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_nonterminalMap * objectArray_42435 = (const cMapElement_nonterminalMap *) var_nonterminalMap.readAccessForWithInstruction_hasKey (enumerator_41718.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1100))) ;
    if (NULL != objectArray_42435) {
        macroValidSharedObject (objectArray_42435, const cMapElement_nonterminalMap) ;
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_41718.current_mNonterminalName (HERE), var_nonterminalLabelMap, objectArray_42435->mAttribute_mHasParseLabel, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1101)) ;
      } //-------- @routineCallInstructionForGeneration
    }else{
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_41718.current_mNonterminalName (HERE), var_nonterminalLabelMap, GALGAS_bool (false), var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1103)) ;
      } //-------- @routineCallInstructionForGeneration
    }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_43096 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43096.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_43315_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_43096.current_mNonterminalName (HERE), joker_43315_0, var_currentRuleHasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1122)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_43370 (enumerator_43096.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43370.hasCurrentObject ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      { //-------- @routineCallInstructionForGeneration
      routine_semanticAnalysisOfRuleLabel (enumerator_43370.current_mFormalArguments (HERE), var_currentRuleHasParseLabel, enumerator_43370.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_43370.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1128)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_ruleLabelImplementationList.addAssign_operation (enumerator_43370.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_43370.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1144)) ;
      enumerator_43370.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_44368_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_43096.current_mNonterminalName (HERE), joker_44368_0, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1154)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_ruleDeclarationList.addAssign_operation (enumerator_43096.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1156)), var_newRuleIndex, var_ruleLabelImplementationList, var_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1155)) ;
    //-------- @incrementInstructionForGeneration
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1161)) ;
    enumerator_43096.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_17252 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17252.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_17252.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_not (SOURCE_FILE_AT_LINE (415)).boolEnum () ;
    if (kBoolTrue == test_10) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_17365 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_17365.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_17365.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)) ;
        enumerator_17365.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_17252.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, GALGAS_string ("the '").operator_concat (enumerator_17252.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_terminalCheckAssignementList enumerator_18239 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18239.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_18239.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_18239.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445)) ;
    }
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_18239.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (448)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) COMMA_SOURCE_FILE_AT_LINE (448)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (448)).operator_concat (enumerator_18239.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (449)) COMMA_SOURCE_FILE_AT_LINE (449)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (450)) COMMA_SOURCE_FILE_AT_LINE (448)) ;
    enumerator_18239.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_18640 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18640.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (GALGAS_string ("::kIndexing_") COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (enumerator_18640.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)) ;
    enumerator_18640.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalCheckAssignementList enumerator_19342 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19342.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_19342.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (465)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (465)) COMMA_SOURCE_FILE_AT_LINE (465)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_21923 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_21923.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inCurrentRuleHasParseLabel, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_21923.current_mSyntaxInstructionList (HERE), enumerator_21923.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (547)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_21923.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (561)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_23818 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_23812 ((PMUInt32) 0) ;
  while (enumerator_23818.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_23812.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (598)).reader_string (SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_23818.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @concatInstructionForGeneration
    ...
    index_23812.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
  }
  //-------- @concatInstructionForGeneration
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_25171 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25171.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inCurrentRuleHasParseLabel, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_25171.current_mSyntaxInstructionList (HERE), enumerator_25171.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (638)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_25171.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (652)) ;
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_26599 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_26593 ((PMUInt32) 0) ;
  while (enumerator_26599.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_26593.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (676)).reader_string (SOURCE_FILE_AT_LINE (676)) COMMA_SOURCE_FILE_AT_LINE (676)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (676)) COMMA_SOURCE_FILE_AT_LINE (676)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_26599.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (677)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (684)) ;
    enumerator_26599.gotoNextObject () ;
    index_26593.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
  }
  //-------- @concatInstructionForGeneration
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_27752 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27752.hasCurrentObject ()) {
    //-------- @assignmentInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxInstructionList enumerator_27918 (enumerator_27752.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27918.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_27918.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inCurrentRuleHasParseLabel, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_27918.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_27752.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (725)) ;
    enumerator_27752.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_location joker_28625_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_28625_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (730)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28815 (var_tempListOfBranches, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_28815.hasCurrentObject () && bool_0) {
    while (enumerator_28815.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_28815.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (736)), enumerator_28815.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (734)) ;
      enumerator_28815.gotoNextObject () ;
      if (enumerator_28815.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_29941 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29941.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_29941.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (761)) ;
    } //-------- @routineCallInstructionForGeneration
    if (enumerator_29941.hasNextObject ()) {
      //-------- @concatInstructionForGeneration
