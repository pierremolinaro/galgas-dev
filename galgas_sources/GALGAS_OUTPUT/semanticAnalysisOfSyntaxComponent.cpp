...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementationGalgas_33_ (C_Compiler * /* inCompiler */,
  ...
  if (in_INCLUSION_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_236 (in_INCLUSION_5F_SET, kEnumeration_up) ;
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_7326 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 192))) ;
  if (NULL != objectArray_7326) {
      macroValidSharedObject (objectArray_7326, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_7326->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 193)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_stringset enumerator_7726 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_7726.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_7726.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 199))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 199)) ;
    ...
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_8106 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_8106.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_8106.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 209))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 209)) ;
    ...
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_8400 (objectArray_7326->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_8423 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_8400.hasCurrentObject () && enumerator_8423.hasCurrentObject ()) {
        ...
        cEnumerator_formalParameterSignature enumerator_8525 (enumerator_8423.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_8525.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_8525.current_mFormalArgumentType (HERE), enumerator_8525.current_mFormalArgumentPassingMode (HERE), enumerator_8525.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 219)) ;
          enumerator_8525.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_8400.current_mSignatureForGeneration (HERE), enumerator_8400.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_8423.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 221)) ;
        }
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_9385 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_9385.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_9466 (enumerator_9385.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_9466.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_9636 (enumerator_9466.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_9636.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_9636.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 249)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_9636.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_9636.current_mFormalArgumentName (HERE), enumerator_9636.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 250))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 250)) ;
        var_signature.addAssign_operation (var_t, enumerator_9636.current_mFormalArgumentPassingMode (HERE), enumerator_9636.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 251)) ;
        enumerator_9636.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_9466.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_9466.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 253)) ;
      }
      enumerator_9466.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_9385.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 255)) ;
    }
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_55793 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_55793.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_55793.current_mFormalArgumentType (HERE), enumerator_55793.current_mFormalArgumentPassingMode (HERE), enumerator_55793.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1433)) ;
    enumerator_55793.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxInstructionList enumerator_56131 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_56131.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_56131.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1439)) ;
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_57660 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_57660.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_57744 (enumerator_57660.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_57744.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_57911 (enumerator_57744.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_57911.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_57911.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1489)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_57911.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_57911.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_57911.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490)) ;
        var_signature.addAssign_operation (var_type, enumerator_57911.current_mFormalArgumentPassingMode (HERE), enumerator_57911.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1491)) ;
        enumerator_57911.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_57744.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_57744.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1493)) ;
      }
      enumerator_57744.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_57660.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1495)) ;
    }
    enumerator_57660.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxRuleListAST enumerator_58860 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58860.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_59044_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58860.current_mNonterminalName (HERE), joker_59044_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1512)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59071 (enumerator_58860.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59071.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59071.current_mFormalArguments (HERE), enumerator_59071.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59071.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1518)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59071.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59071.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1534)) ;
      enumerator_59071.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_60042_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58860.current_mNonterminalName (HERE), joker_60042_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1543)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_58860.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1545)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1544)) ;
...
static void categoryMethod_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 165)).isValid ()) {
    uint32_t variant_6361 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 165)).uintValue () ;
    bool loop_6361 = true ;
    while (loop_6361) {
      loop_6361 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).isValid () ;
      if (loop_6361) {
        loop_6361 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).boolValue () ;
      }
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_12572_0 ; // Joker input parameter
    GALGAS_location joker_12586_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_12572_0, var_signature, joker_12586_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 319)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_actualParameterListForGeneration enumerator_13947 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  while (enumerator_13947.hasCurrentObject ()) {
    GALGAS_string var_parameterCppName ;
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_13947.current_mActualParameter (HERE).ptr (), ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 362)) ;
  ...
  cEnumerator_stringlist enumerator_14696 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_14696.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14696.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 380))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 380)) ;
  ...
  cEnumerator_stringlist enumerator_15253 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_15253.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_15253.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 395))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 395)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_16731_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_16731_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 433)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_23053_0 ; // Joker input parameter
  GALGAS_string joker_23056_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_23053_0, joker_23056_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 566)) ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_29650 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_29669 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_29650.hasCurrentObject () && enumerator_29669.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_29650.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_29669.current_mLexicalType (HERE), enumerator_29669.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)) ;
    enumerator_29650.gotoNextObject () ;
    enumerator_29669.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_29904 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_29904.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_29904.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)).operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_30017 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_30017.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_30017.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 730))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 730)) ;
        enumerator_30017.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_29904.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_29904.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_31350 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_31350.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_31350.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_31350.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 770)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_31350.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (enumerator_31350.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 774))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 774))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 773)) ;
    enumerator_31350.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_31751 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_31751.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (GALGAS_string ("::kIndexing_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (enumerator_31751.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 779)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_35174 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_35174.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_35174.current_mSyntaxInstructionList (HERE), enumerator_35174.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 877)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_35174.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 891)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_37155 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_37111 ((uint32_t) 0) ;
  while (enumerator_37155.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_37111.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_37155.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 931)) ;
    }
    ...
    enumerator_37155.gotoNextObject () ;
    index_37111.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_38550 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_38550.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_38550.current_mSyntaxInstructionList (HERE), enumerator_38550.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 971)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_38550.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 985)) ;
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_40022 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_39978 ((uint32_t) 0) ;
  while (enumerator_40022.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_39978.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_40022.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1011)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1019)) ;
    enumerator_40022.gotoNextObject () ;
    index_39978.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_41217 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_41217.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_41383 (enumerator_41217.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_41383.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_41383.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1047)) ;
      enumerator_41383.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_41217.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1060)) ;
    enumerator_41217.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_42087_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_42087_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1065)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42272 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_42272.hasCurrentObject () && bool_0) {
    while (enumerator_42272.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_42272.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1071)), enumerator_42272.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1069)) ;
      enumerator_42272.gotoNextObject () ;
      if (enumerator_42272.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_43451 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_43451.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_43451.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1097)) ;
    }
    if (enumerator_43451.hasNextObject ()) {
    ...
    enumerator_43451.gotoNextObject () ;
  }
