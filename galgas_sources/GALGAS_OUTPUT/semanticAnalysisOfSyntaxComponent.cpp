...
GALGAS_nonterminalLabelMap_3A_element cEnumerator_nonterminalLabelMap::current (LOCATION_ARGS) const {
  const cMapElement_nonterminalLabelMap * p = (const cMapElement_nonterminalLabelMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_nonterminalLabelMap) ;
  return GALGAS_nonterminalLabelMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSignatureForGeneration, p->mAttribute_mSignature, p->mAttribute_mEndOfArgumentLocation) ;
}
...
GALGAS_nonterminalMap_3A_element cEnumerator_nonterminalMap::current (LOCATION_ARGS) const {
  const cMapElement_nonterminalMap * p = (const cMapElement_nonterminalMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_nonterminalMap) ;
  return GALGAS_nonterminalMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLabelMap) ;
}
...
class cCollectionElement_ruleLabelImplementationList : public cCollectionElement {
  public : GALGAS_ruleLabelImplementationList_3A_element mObject ;
...
GALGAS_ruleLabelImplementationList_3A_element cEnumerator_ruleLabelImplementationList::current (LOCATION_ARGS) const {
...
class cCollectionElement_ruleDeclarationList : public cCollectionElement {
  public : GALGAS_ruleDeclarationList_3A_element mObject ;
...
GALGAS_ruleDeclarationList_3A_element cEnumerator_ruleDeclarationList::current (LOCATION_ARGS) const {
...
GALGAS_nonterminalLabelMap_3A_element::GALGAS_nonterminalLabelMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_nonterminalLabelMap_3A_element::GALGAS_nonterminalLabelMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_formalParameterListForGeneration & inOperand1,
                                                                              const GALGAS_formalParameterSignature & inOperand2,
                                                                              const GALGAS_location & inOperand3) :
...
/* GALGAS_nonterminalLabelMap_3A_element & GALGAS_nonterminalLabelMap_3A_element::operator = (const GALGAS_nonterminalLabelMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSignatureForGeneration = inOperand.mAttribute_mSignatureForGeneration ;
  mAttribute_mSignature = inOperand.mAttribute_mSignature ;
  mAttribute_mEndOfArgumentLocation = inOperand.mAttribute_mEndOfArgumentLocation ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_nonterminalLabelMap_3A_element GALGAS_nonterminalLabelMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                              const GALGAS_formalParameterListForGeneration & inOperand1,
                                                                                              const GALGAS_formalParameterSignature & inOperand2,
                                                                                              const GALGAS_location & inOperand3 
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nonterminalLabelMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_nonterminalLabelMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nonterminalLabelMap_3A_element::objectCompare (const GALGAS_nonterminalLabelMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_nonterminalLabelMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSignatureForGeneration.isValid () && mAttribute_mSignature.isValid () && mAttribute_mEndOfArgumentLocation.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_nonterminalLabelMap_3A_element::drop (void) {
...
void GALGAS_nonterminalLabelMap_3A_element::description (C_String & ioString,
                                                         const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_nonterminalLabelMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterListForGeneration GALGAS_nonterminalLabelMap_3A_element::reader_mSignatureForGeneration (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSignatureForGeneration ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterSignature GALGAS_nonterminalLabelMap_3A_element::reader_mSignature (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSignature ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_nonterminalLabelMap_3A_element::reader_mEndOfArgumentLocation (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nonterminalLabelMap_3A_element ("nonterminalLabelMap:element",
                                                       NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_nonterminalLabelMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_nonterminalLabelMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_nonterminalLabelMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_nonterminalLabelMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_nonterminalLabelMap_3A_element GALGAS_nonterminalLabelMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                            C_Compiler * inCompiler,
                                                                                            const GALGAS_location & inErrorLocation
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_nonterminalLabelMap_3A_element result ;
  const GALGAS_nonterminalLabelMap_3A_element * p = (const GALGAS_nonterminalLabelMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nonterminalLabelMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_nonterminalMap_3A_element::GALGAS_nonterminalMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_nonterminalMap_3A_element::GALGAS_nonterminalMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_nonterminalMap_3A_element & GALGAS_nonterminalMap_3A_element::operator = (const GALGAS_nonterminalMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
...
GALGAS_nonterminalMap_3A_element GALGAS_nonterminalMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_nonterminalLabelMap & inOperand1 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nonterminalMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_nonterminalMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nonterminalMap_3A_element::objectCompare (const GALGAS_nonterminalMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_nonterminalMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLabelMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_nonterminalMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_nonterminalMap_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_nonterminalMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_nonterminalLabelMap GALGAS_nonterminalMap_3A_element::reader_mLabelMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nonterminalMap_3A_element ("nonterminalMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_nonterminalMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_nonterminalMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_nonterminalMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_nonterminalMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_nonterminalMap_3A_element GALGAS_nonterminalMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_nonterminalMap_3A_element result ;
  const GALGAS_nonterminalMap_3A_element * p = (const GALGAS_nonterminalMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nonterminalMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_ruleLabelImplementationList_3A_element::GALGAS_ruleLabelImplementationList_3A_element (void) :
...
GALGAS_ruleLabelImplementationList_3A_element::GALGAS_ruleLabelImplementationList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                              const GALGAS_formalParameterListForGeneration & inOperand1,
                                                                                              const GALGAS_formalParameterSignature & inOperand2,
                                                                                              const GALGAS_location & inOperand3,
                                                                                              const GALGAS_semanticInstructionListForGeneration & inOperand4) :
...
/* GALGAS_ruleLabelImplementationList_3A_element & GALGAS_ruleLabelImplementationList_3A_element::operator = (const GALGAS_ruleLabelImplementationList_3A_element & inOperand) {
  mAttribute_mLabelName = inOperand.mAttribute_mLabelName ;
  mAttribute_mSignatureForGeneration = inOperand.mAttribute_mSignatureForGeneration ;
  mAttribute_mSignature = inOperand.mAttribute_mSignature ;
  mAttribute_mEndOfArgumentLocation = inOperand.mAttribute_mEndOfArgumentLocation ;
  mAttribute_mInstructionListForGeneration = inOperand.mAttribute_mInstructionListForGeneration ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_ruleLabelImplementationList_3A_element GALGAS_ruleLabelImplementationList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                              const GALGAS_formalParameterListForGeneration & inOperand1,
                                                                                                              const GALGAS_formalParameterSignature & inOperand2,
                                                                                                              const GALGAS_location & inOperand3,
                                                                                                              const GALGAS_semanticInstructionListForGeneration & inOperand4 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ruleLabelImplementationList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_ruleLabelImplementationList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_ruleLabelImplementationList_3A_element::objectCompare (const GALGAS_ruleLabelImplementationList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_ruleLabelImplementationList_3A_element::isValid (void) const {
...
void GALGAS_ruleLabelImplementationList_3A_element::drop (void) {
...
void GALGAS_ruleLabelImplementationList_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_ruleLabelImplementationList_3A_element::reader_mLabelName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLabelName ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterListForGeneration GALGAS_ruleLabelImplementationList_3A_element::reader_mSignatureForGeneration (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSignatureForGeneration ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterSignature GALGAS_ruleLabelImplementationList_3A_element::reader_mSignature (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSignature ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_ruleLabelImplementationList_3A_element::reader_mEndOfArgumentLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfArgumentLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_semanticInstructionListForGeneration GALGAS_ruleLabelImplementationList_3A_element::reader_mInstructionListForGeneration (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ruleLabelImplementationList_3A_element ("ruleLabelImplementationList:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ruleLabelImplementationList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ruleLabelImplementationList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ruleLabelImplementationList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ruleLabelImplementationList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_ruleLabelImplementationList_3A_element GALGAS_ruleLabelImplementationList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_ruleLabelImplementationList_3A_element result ;
  const GALGAS_ruleLabelImplementationList_3A_element * p = (const GALGAS_ruleLabelImplementationList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ruleLabelImplementationList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_ruleDeclarationList_3A_element::GALGAS_ruleDeclarationList_3A_element (void) :
...
GALGAS_ruleDeclarationList_3A_element::GALGAS_ruleDeclarationList_3A_element (const GALGAS_string & inOperand0,
                                                                              const GALGAS_uint & inOperand1,
                                                                              const GALGAS_ruleLabelImplementationList & inOperand2) :
...
/* GALGAS_ruleDeclarationList_3A_element & GALGAS_ruleDeclarationList_3A_element::operator = (const GALGAS_ruleDeclarationList_3A_element & inOperand) {
  mAttribute_mNonterminalName = inOperand.mAttribute_mNonterminalName ;
  mAttribute_mRuleIndex = inOperand.mAttribute_mRuleIndex ;
  mAttribute_mLabelImplementationList = inOperand.mAttribute_mLabelImplementationList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_ruleDeclarationList_3A_element GALGAS_ruleDeclarationList_3A_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                              const GALGAS_uint & inOperand1,
                                                                                              const GALGAS_ruleLabelImplementationList & inOperand2 
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ruleDeclarationList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_ruleDeclarationList_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_ruleDeclarationList_3A_element::objectCompare (const GALGAS_ruleDeclarationList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
void GALGAS_ruleDeclarationList_3A_element::description (C_String & ioString,
                                                         const PMSInt32 inIndentation) const {
...
GALGAS_string GALGAS_ruleDeclarationList_3A_element::reader_mNonterminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNonterminalName ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_ruleDeclarationList_3A_element::reader_mRuleIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRuleIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_ruleLabelImplementationList GALGAS_ruleDeclarationList_3A_element::reader_mLabelImplementationList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ruleDeclarationList_3A_element ("ruleDeclarationList:element",
                                                       NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ruleDeclarationList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ruleDeclarationList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ruleDeclarationList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ruleDeclarationList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_ruleDeclarationList_3A_element GALGAS_ruleDeclarationList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                            C_Compiler * inCompiler,
                                                                                            const GALGAS_location & inErrorLocation
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_ruleDeclarationList_3A_element result ;
  const GALGAS_ruleDeclarationList_3A_element * p = (const GALGAS_ruleDeclarationList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ruleDeclarationList_3A_element *> (p)) {
      result = *p ;
    }else{
