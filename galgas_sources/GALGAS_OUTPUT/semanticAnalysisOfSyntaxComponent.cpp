...
template_filewrapper_syntaxFileGenerationTemplate_syntaxFileImplementation (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    ...
    result << ".h\"\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringlist::cEnumerator enumerator_530 (var_cas_IMPORTED_COMPONENT_LIST, true) ;
    const GGS_stringlist::cElement * operand_530 = NULL ;
    while (((operand_530 = enumerator_530.nextObject ()))) {
      macroValidPointer (operand_530) ;
      result << "#include \"" ;
      result << operand_530->mValue ;
      result << ".h\"\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
