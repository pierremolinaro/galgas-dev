...
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_nonterminalInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
  }
}
...
static void
category_method__nonterminalInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_nonterminalInstructionForGeneration * operand_12642,
...
var_cas_ioGeneratedCode.appendCString ("@nonterminalCallInstruction\n") ;
  }
}
...
category_method__terminalCheckInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_12978,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12978 != NULL) {
GGS_lexicalSentValueList  var_cas_sentAttributeList ;
if (var_cas_inTerminalMap.isBuilt ()) {
  var_cas_inTerminalMap (HERE)->method_searchKey (inLexique, operand_12978->mTerminalName, var_cas_sentAttributeList COMMA_SOURCE_FILE_AT_LINE (334)) ;
}
const GGS_bool cond_13943 = (operand_12978->mActualInputParameterList.reader_length ()).operator_isNotEqual (var_cas_sentAttributeList.reader_length ()) ;
if (cond_13943.isBuiltAndTrue ()) {
operand_12978->mTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((((GGS_string ("naming the '$")).operator_concat (operand_12978->mTerminalName)).operator_concat (GGS_string ("$' requires "))).operator_concat (var_cas_sentAttributeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (338)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_sentAttributeList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (", but this instruction names "))).operator_concat (operand_12978->mActualInputParameterList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (341)))).operator_concat (GGS_string (" parameter"))).operator_concat ((((operand_12978->mActualInputParameterList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (344)) ;
}
...
{
GGS_actualInputParameterListAST::cEnumerator enumerator_14064 (operand_12978->mActualInputParameterList, true) ;
const GGS_actualInputParameterListAST::cElement * operand_14064 = NULL ;
GGS_lexicalSentValueList::cEnumerator enumerator_14083 (var_cas_sentAttributeList, true) ;
const GGS_lexicalSentValueList::cElement * operand_14083 = NULL ;
while (((operand_14064 = enumerator_14064.nextObject ()))
    && ((operand_14083 = enumerator_14083.nextObject ()))) {
  macroValidPointer (operand_14064) ;
  macroValidPointer (operand_14083) ;
const GGS_bool cond_15793 = (operand_14064->mActualParameterName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_15793.isBuiltAndTrue ()) {
  GGS_unifiedTypeMapProxy  var_cas_type ;
  GGS_string var_cas_cppName ;
  const GGS_bool cond_14602 = (operand_14064->mActualParameterTypeName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_14602.isBuiltAndTrue ()) {
    var_cas_cppName = (GGS_string ("var_")).operator_concat (operand_14064->mActualParameterName.ggs_string ().reader_identifierRepresentation ()) ;
    var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_14064->mActualParameterTypeName COMMA_SOURCE_FILE_AT_LINE (353)) ;
    var_cas_ioVariableMap.modifier_insertDefinedLocalVariable (inLexique, operand_14064->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (354)) ;
    var_cas_ioLocalVariableCppNameList.addAssign_operation (var_cas_cppName) ;
  }else if (cond_14602.isBuiltAndFalse ()) {
    var_cas_ioVariableMap.modifier_searchForWriteAccess (inLexique, operand_14064->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (357)) ;
  }
  GGS_unifiedTypeMapProxy  var_cas_expectedType ;
  switch (operand_14083->mLexicalType.enumValue ()) {
  ...
  const GGS_bool cond_15643 = (var_cas_expectedType).operator_isNotEqual (var_cas_type) ;
  if (cond_15643.isBuiltAndTrue ()) {
    operand_14064->mActualParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '")).operator_concat (operand_14064->mActualParameterName)).operator_concat (GGS_string ("' parameter has the '@"))).operator_concat (var_cas_type.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (371)))).operator_concat (GGS_string (", bit an '@"))).operator_concat (var_cas_expectedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (372)))).operator_concat (GGS_string ("' parameter is required here")) COMMA_SOURCE_FILE_AT_LINE (374)) ;
  }
  var_cas_terminalCheckAssignementList.addAssign_operation (operand_14064->mActualParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)), var_cas_cppName, operand_14083->mLexicalAttributeName) ;
}
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_terminalCheckInstructionForGeneration ::constructor_new (inLexique, operand_12978->mTerminalName, var_cas_inLexiqueName, operand_12978->mInstructionLocation, var_cas_terminalCheckAssignementList COMMA_SOURCE_FILE_AT_LINE (383))) ;
  }
}
...
category_method__terminalCheckInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstructionForGeneration * operand_16172,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
var_cas_ioUnusedVariableCppNameSet.modifier_removeKey (inLexique, function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (399)) COMMA_SOURCE_FILE_AT_LINE (399)) ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (400))) ;
var_cas_ioGeneratedCode.appendCString ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_16172->mLexiqueIdentifier) ;
var_cas_ioGeneratedCode.appendCString ("::kToken_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_16172->mTerminalName.ggs_string ().reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (") COMMA_SOURCE_FILE_AT_LINE (") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_16172->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (402)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
{
GGS_terminalCheckAssignementList::cEnumerator enumerator_16758 (operand_16172->mTerminalCheckAssignementList, true) ;
const GGS_terminalCheckAssignementList::cElement * operand_16758 = NULL ;
while (((operand_16758 = enumerator_16758.nextObject ()))) {
  macroValidPointer (operand_16758) ;
const GGS_bool cond_16882 = (operand_16758->mTypeName).operator_isNotEqual (GGS_string ("")) ;
if (cond_16882.isBuiltAndTrue ()) {
  var_cas_ioGeneratedCode.appendCString ("GALGAS_") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_16758->mTypeName.reader_identifierRepresentation ()) ;
  var_cas_ioGeneratedCode.appendCString (" * ") ;
}else if (cond_16882.isBuiltAndFalse ()) {
  var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_16758->mTargetVarCppName) ;
  var_cas_ioGeneratedCode.appendCString (") ;\n") ;
}
var_cas_ioGeneratedCode.dotAssign_operation (operand_16758->mTargetVarCppName) ;
var_cas_ioGeneratedCode.appendCString (" = ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_16758->mSourceLexicalAttributeName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (" () ;\n") ;
}
}
  }
...
var_cas_ioVariableMap.modifier_beginBranch (inLexique COMMA_SOURCE_FILE_AT_LINE (432)) ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_18014 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18014 = NULL ;
while (((operand_18014 = enumerator_18014.nextObject ()))) {
  macroValidPointer (operand_18014) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18014->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18014->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (436)) ;
  }
}
}
}
const GGS_bool cond_18565 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_18565.isBuiltAndTrue ()) {
var_cas_outInstructionListForGeneration.addAssign_operation (GGS_dropInstructionForGeneration ::constructor_new (inLexique, var_cas_localVariableCppNameList, GGS_string ("end of scope") COMMA_SOURCE_FILE_AT_LINE (451))) ;
}
var_cas_ioVariableMap.modifier_endBranch (inLexique, var_cas_inEndOfBranchLocation COMMA_SOURCE_FILE_AT_LINE (457)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_18795,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18795 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (475)) ;
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (477)) ;
GGS_semanticInstructionListForGeneration  var_cas_repeated_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_18795->mRepeatedInstructionList,  operand_18795->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (480)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_19880 (operand_18795->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_19880 = NULL ;
while (((operand_19880 = enumerator_19880.nextObject ()))) {
  macroValidPointer (operand_19880) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19880->mSyntaxInstructionList,  operand_19880->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (497)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_18795->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (513)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (515))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_20774,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20774 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @repeatInstructionForGeneration\n") ;
const GGS_string var_cas_repeatFlagCppName = (GGS_string ("repeatFlag_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (531))) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_20774->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (534)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_20774->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_20774->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (541))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (541))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_21604 (operand_20774->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_21604 = NULL ;
while (((operand_21604 = enumerator_21604.nextObject ()))) {
  macroValidPointer (operand_21604) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (543)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (543))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_21604->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (544)) ;
...
var_cas_ioGeneratedCode.appendCString ("  break ;\n") ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (556)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_22275,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22275 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (575)) ;
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (577)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_22955 (operand_22275->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_22955 = NULL ;
while (((operand_22955 = enumerator_22955.nextObject ()))) {
  macroValidPointer (operand_22955) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_22955->mSyntaxInstructionList,  operand_22955->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (582)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_22275->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (598)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (599))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_23813,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23813 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- \n") ;
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_23813->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_23813->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (614))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (614))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_24172 (operand_23813->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_24172 = NULL ;
while (((operand_24172 = enumerator_24172.nextObject ()))) {
  macroValidPointer (operand_24172) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (616)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (616))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_24172->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (617)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_24708,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24708 != NULL) {
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (645)) ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_25208 (operand_24708->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_25208 = NULL ;
while (((operand_25208 = enumerator_25208.nextObject ()))) {
  macroValidPointer (operand_25208) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_25208->mSyntaxInstructionList,  operand_25208->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (649)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_24708->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (664)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseDoInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (666))) ;
  }
}
...
category_method__parseDoInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_parseDoInstructionForGeneration * operand_25939,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25939 != NULL) {
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_26296,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26296 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_variant_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_26296->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_26296->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (696)) ;
  }
}
const GGS_bool cond_27176 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (702))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_27176.isBuiltAndTrue ()) {
operand_26296->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (704)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (704)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (705)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (707)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_26296->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_26296->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (710)) ;
  }
}
const GGS_bool cond_27663 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (716))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_27663.isBuiltAndTrue ()) {
operand_26296->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (718)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (718)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (719)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (721)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (724)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_26296->mDoInstructionList,  operand_26296->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (727)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_26296->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (741)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (743))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_parseLoopInstructionForGeneration * operand_28458,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28458 != NULL) {
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_28817,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28817 != NULL) {
GGS_uint  var_cas_localSelectMethodCount = var_cas_ioSelectMethodCount ;
{
GGS_whenBranchList::cEnumerator enumerator_29278 (operand_28817->mWhenBranchList, true) ;
const GGS_whenBranchList::cElement * operand_29278 = NULL ;
while (((operand_29278 = enumerator_29278.nextObject ()))) {
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_29278->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_29278->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (775)) ;
  }
}
...
{
  GGS_syntaxInstructionList::cEnumerator enumerator_29654 (operand_29278->mParseDoBranchList, true) ;
  const GGS_syntaxInstructionList::cElement * operand_29654 = NULL ;
  while (((operand_29654 = enumerator_29654.nextObject ()))) {
    macroValidPointer (operand_29654) ;
    { typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_29654->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_29654->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (783)) ;
      }
    }
  }
}
...
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (799))) ;
  }
}
...
static void
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_parseWhenInstructionForGeneration * operand_30353,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30353 != NULL) {
var_cas_ioGeneratedCode.appendCString ("@parseWhenInstructionForGeneration generateInstruction\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_30708,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30708 != NULL) {
operand_30708->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (829)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (851)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignatureForGeneration COMMA_SOURCE_FILE_AT_LINE (852)) ;
var_cas_outSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_32461 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_32461 = NULL ;
while (((operand_32461 = enumerator_32461.nextObject ()))) {
  macroValidPointer (operand_32461) ;
var_cas_outSignature.addAssign_operation (operand_32461->mFormalArgumentType, operand_32461->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_32771 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_32771 = NULL ;
while (((operand_32771 = enumerator_32771.nextObject ()))) {
  macroValidPointer (operand_32771) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_32771->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_32771->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (868)) ;
  }
}
}
}
...
void routine_semanticAnalysisOfSyntaxComponent (C_Compiler & inLexique,
  ...
  #endif
GGS_nonterminalMap  var_cas_nonterminalMap = GGS_nonterminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (900)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (901)) ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_34153 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_34153 = NULL ;
while (((operand_34153 = enumerator_34153.nextObject ()))) {
  macroValidPointer (operand_34153) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (908)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_34237 (operand_34153->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_34237 = NULL ;
while (((operand_34237 = enumerator_34237.nextObject ()))) {
  macroValidPointer (operand_34237) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_34404 (operand_34237->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_34404 = NULL ;
    while (((operand_34404 = enumerator_34404.nextObject ()))) {
      macroValidPointer (operand_34404) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_34404->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (913)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_34404->mFormalArgumentPassingMode, var_cas_type, operand_34404->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_34404->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_34404->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_34237->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_34237->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (917)) ;
}
}
elementOf_GGS_nonterminalMap * operand_34873 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_34153->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (919))) ;
if (NULL != operand_34873) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_34153->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_34873->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (920)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_34153->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (922)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_35337 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_35337 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_35494 (operand_35337->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_35494 = NULL ;
while (((operand_35494 = enumerator_35494.nextObject ()))) {
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_35494->mFormalArguments,  operand_35494->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (937)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_35494->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_35494->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_36451_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_35337->mNonterminalName, automatic_var_36451_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (961)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_35337->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (963)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
var_cas_newRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (968)) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalMap, var_cas_ruleDeclarationList, var_cas_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (971)) ;
  #ifdef DEBUG_TRACE_ENABLED
