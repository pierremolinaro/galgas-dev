...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListForGeneration enumerator_39111 (outArgument_outSignatureForGeneration, true) ;
  //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_39420 (constinArgument_inSyntaxInstructionList, true) ;
  //--- simple foreach instruction
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_40888 (constinArgument_inRuleList, true) ;
  //--- simple foreach instruction
  while (enumerator_40888.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_40972 (enumerator_40888.current_mLabelList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_40972.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_41139 (enumerator_40972.current_mFormalArguments (HERE), true) ;
      //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_42233 (constinArgument_inRuleList, true) ;
  //--- simple foreach instruction
  while (enumerator_42233.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_42390 (enumerator_42233.current_mLabelList (HERE), true) ;
    //--- simple foreach instruction
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28226 (var_tempListOfBranches, true) ;
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_29352 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
