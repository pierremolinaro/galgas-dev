...
category_method__semanticInstructionAST__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_semanticInstructionAST * operand_10048,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10048 != NULL) {
GGS_semanticInstructionAST  var_cas_t = operand_10048 ;
{ typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (var_cas_t.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, var_cas_t (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (247)) ;
  }
}
  }
}
...
category_method__nonterminalCallInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_nonterminalCallInstruction * operand_10854,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10854 != NULL) {
GGS_nonterminalLabelMap  var_cas_labelMap ;
GGS_bool var_cas_hasParseLabel ;
if (var_cas_inNonterminalMap.isBuilt ()) {
  var_cas_inNonterminalMap (HERE)->method_searchKey (inLexique, operand_10854->mNonterminalName, var_cas_labelMap, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (272)) ;
}
GGS_formalParameterSignature  var_cas_signature ;
const GGS_bool cond_11740 = (operand_10854->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (274))).operator_isEqual (GGS_string ("parse")) ;
if (cond_11740.isBuiltAndTrue ()) {
const GGS_bool cond_11661 = (var_cas_hasParseLabel).operator_not () ;
if (cond_11661.isBuiltAndTrue ()) {
operand_10854->mLabelName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_10854->mNonterminalName)).operator_concat (GGS_string (">' nonterminal does not declare the 'parse' label")) COMMA_SOURCE_FILE_AT_LINE (280)) ;
var_cas_signature.drop () ;
}else if (cond_11661.isBuiltAndFalse ()) {
var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
}
}else if (cond_11740.isBuiltAndFalse ()) {
GGS_formalParameterListForGeneration  automatic_var_11794_0 ;
GGS_location  automatic_var_11794_1 ;
if (var_cas_labelMap.isBuilt ()) {
  var_cas_labelMap (HERE)->method_searchKey (inLexique, operand_10854->mLabelName, automatic_var_11794_0, var_cas_signature, automatic_var_11794_1 COMMA_SOURCE_FILE_AT_LINE (284)) ;
}
}
GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_10854->mNonterminalName,  ((GGS_string ("'<")).operator_concat (operand_10854->mNonterminalName)).operator_concat (GGS_string (">' nonterminal declaration")),  var_cas_signature,  operand_10854->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (288)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_nonterminalInstructionForGeneration ::constructor_new (inLexique, operand_10854->mInstructionLocation, operand_10854->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (301)), operand_10854->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (302)), var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (299))) ;
  }
}
...
category_method__nonterminalInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_nonterminalInstructionForGeneration * operand_12531,
...
{
GGS_actualParameterListForGeneration::cEnumerator enumerator_12866 (operand_12531->mActualParameterList, true) ;
const GGS_actualParameterListForGeneration::cElement * operand_12866 = NULL ;
while (((operand_12866 = enumerator_12866.nextObject ()))) {
  macroValidPointer (operand_12866) ;
GGS_string var_cas_parameterCppName ;
{ typeCategoryMethod__actualParameterForGeneration__generateActualParameter method = findCategoryMethod__actualParameterForGeneration__generateActualParameter (operand_12866->mActualParameter.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_12866->mActualParameter (HERE), var_cas_ioTemporaryVariableIndex, var_cas_ioGeneratedCode, var_cas_jokerParametersToReleaseList, var_cas_ioUnusedVariableCppNameSet, var_cas_parameterCppName COMMA_SOURCE_FILE_AT_LINE (320)) ;
  }
}
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_12531->mNonterminalName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_12531->mLabelName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
{
GGS_stringlist::cEnumerator enumerator_13321 (var_cas_parameterCppNameList, true) ;
const GGS_stringlist::cElement * operand_13321 = NULL ;
while (((operand_13321 = enumerator_13321.nextObject ()))) {
  macroValidPointer (operand_13321) ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_13321->mValue) ;
var_cas_ioGeneratedCode.appendCString (", ") ;
}
}
...
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (329))) ;
var_cas_ioGeneratedCode.appendCString (") ;\n") ;
{
GGS_stringlist::cEnumerator enumerator_13569 (var_cas_jokerParametersToReleaseList, true) ;
const GGS_stringlist::cElement * operand_13569 = NULL ;
while (((operand_13569 = enumerator_13569.nextObject ()))) {
  macroValidPointer (operand_13569) ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_13569->mValue) ;
...
category_method__terminalCheckInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_13852,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
if (var_cas_inTerminalMap.isBuilt ()) {
  var_cas_inTerminalMap (HERE)->method_searchKey (inLexique, operand_13852->mTerminalName, var_cas_sentAttributeList COMMA_SOURCE_FILE_AT_LINE (351)) ;
}
const GGS_bool cond_14817 = (operand_13852->mActualInputParameterList.reader_length ()).operator_isNotEqual (var_cas_sentAttributeList.reader_length ()) ;
if (cond_14817.isBuiltAndTrue ()) {
operand_13852->mTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((((GGS_string ("naming the '$")).operator_concat (operand_13852->mTerminalName)).operator_concat (GGS_string ("$' requires "))).operator_concat (var_cas_sentAttributeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_sentAttributeList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (", but this instruction names "))).operator_concat (operand_13852->mActualInputParameterList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (358)))).operator_concat (GGS_string (" parameter"))).operator_concat ((((operand_13852->mActualInputParameterList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (361)) ;
}
...
{
GGS_actualInputParameterListAST::cEnumerator enumerator_14938 (operand_13852->mActualInputParameterList, true) ;
const GGS_actualInputParameterListAST::cElement * operand_14938 = NULL ;
GGS_lexicalSentValueList::cEnumerator enumerator_14957 (var_cas_sentAttributeList, true) ;
const GGS_lexicalSentValueList::cElement * operand_14957 = NULL ;
while (((operand_14938 = enumerator_14938.nextObject ()))
    && ((operand_14957 = enumerator_14957.nextObject ()))) {
  macroValidPointer (operand_14938) ;
  macroValidPointer (operand_14957) ;
const GGS_bool cond_16667 = (operand_14938->mActualParameterName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_16667.isBuiltAndTrue ()) {
  GGS_unifiedTypeMapProxy  var_cas_type ;
  GGS_string var_cas_cppName ;
  const GGS_bool cond_15476 = (operand_14938->mActualParameterTypeName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_15476.isBuiltAndTrue ()) {
    var_cas_cppName = (GGS_string ("var_")).operator_concat (operand_14938->mActualParameterName.ggs_string ().reader_identifierRepresentation ()) ;
    var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_14938->mActualParameterTypeName COMMA_SOURCE_FILE_AT_LINE (370)) ;
    var_cas_ioVariableMap.modifier_insertDefinedLocalVariable (inLexique, operand_14938->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (371)) ;
    var_cas_ioLocalVariableCppNameList.addAssign_operation (var_cas_cppName) ;
  }else if (cond_15476.isBuiltAndFalse ()) {
    var_cas_ioVariableMap.modifier_searchForWriteAccess (inLexique, operand_14938->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (374)) ;
  }
  GGS_unifiedTypeMapProxy  var_cas_expectedType ;
  switch (operand_14957->mLexicalType.enumValue ()) {
  ...
  const GGS_bool cond_16517 = (var_cas_expectedType).operator_isNotEqual (var_cas_type) ;
  if (cond_16517.isBuiltAndTrue ()) {
    operand_14938->mActualParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '")).operator_concat (operand_14938->mActualParameterName)).operator_concat (GGS_string ("' parameter has the '@"))).operator_concat (var_cas_type.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (388)))).operator_concat (GGS_string (", bit an '@"))).operator_concat (var_cas_expectedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (389)))).operator_concat (GGS_string ("' parameter is required here")) COMMA_SOURCE_FILE_AT_LINE (391)) ;
  }
  var_cas_terminalCheckAssignementList.addAssign_operation (operand_14938->mActualParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393)), var_cas_cppName, operand_14957->mLexicalAttributeName) ;
}
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_terminalCheckInstructionForGeneration ::constructor_new (inLexique, operand_13852->mInstructionLocation, operand_13852->mTerminalName, var_cas_inLexiqueName, var_cas_terminalCheckAssignementList COMMA_SOURCE_FILE_AT_LINE (400))) ;
  }
}
...
category_method__terminalCheckInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstructionForGeneration * operand_17046,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17046 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @terminalCheckInstructionForGeneration\n") ;
{
GGS_terminalCheckAssignementList::cEnumerator enumerator_17309 (operand_17046->mTerminalCheckAssignementList, true) ;
const GGS_terminalCheckAssignementList::cElement * operand_17309 = NULL ;
while (((operand_17309 = enumerator_17309.nextObject ()))) {
  macroValidPointer (operand_17309) ;
const GGS_bool cond_17433 = (operand_17309->mTypeName).operator_isNotEqual (GGS_string ("")) ;
if (cond_17433.isBuiltAndTrue ()) {
  var_cas_ioGeneratedCode.appendCString ("GALGAS_ap") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17309->mTypeName.reader_identifierRepresentation ()) ;
  var_cas_ioGeneratedCode.appendCString (" ") ;
}
var_cas_ioGeneratedCode.dotAssign_operation (operand_17309->mTargetVarCppName) ;
var_cas_ioGeneratedCode.appendCString (" = ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17309->mSourceLexicalAttributeName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (" () ;\n") ;
}
}
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17046->mLexiqueIdentifier) ;
var_cas_ioGeneratedCode.appendCString ("::kToken_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_17046->mTerminalName.ggs_string ().reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (") COMMA_SOURCE_FILE_AT_LINE (") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_17046->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (430)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (430))) ;
var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
  }
}
...
var_cas_ioVariableMap.modifier_beginBranch (inLexique COMMA_SOURCE_FILE_AT_LINE (450)) ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_18867 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18867 = NULL ;
while (((operand_18867 = enumerator_18867.nextObject ()))) {
  macroValidPointer (operand_18867) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18867->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18867->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (454)) ;
  }
}
}
}
const GGS_bool cond_19418 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_19418.isBuiltAndTrue ()) {
var_cas_outInstructionListForGeneration.addAssign_operation (GGS_dropInstructionForGeneration ::constructor_new (inLexique, var_cas_localVariableCppNameList, GGS_string ("end of scope") COMMA_SOURCE_FILE_AT_LINE (469))) ;
}
var_cas_ioVariableMap.modifier_endBranch (inLexique, var_cas_inEndOfBranchLocation COMMA_SOURCE_FILE_AT_LINE (475)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_19648,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19648 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (495)) ;
GGS_semanticInstructionListForGeneration  var_cas_repeated_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19648->mRepeatedInstructionList,  operand_19648->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (498)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20733 (operand_19648->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_20733 = NULL ;
while (((operand_20733 = enumerator_20733.nextObject ()))) {
  macroValidPointer (operand_20733) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_20733->mSyntaxInstructionList,  operand_20733->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (515)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_20733->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_19648->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (531)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, operand_19648->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, operand_19648->mEndOf_repeat_instruction, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (533))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_21705,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21705 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @repeatInstructionForGeneration\n") ;
const GGS_string var_cas_repeatFlagCppName = (GGS_string ("repeatFlag_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (551))) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_21705->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (554)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_21705->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_21705->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (561))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (561))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_22535 (operand_21705->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_22535 = NULL ;
while (((operand_22535 = enumerator_22535.nextObject ()))) {
  macroValidPointer (operand_22535) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (563)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (563))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_22535->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (564)) ;
...
var_cas_ioGeneratedCode.appendCString ("  break ;\n") ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (576)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_23206,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23206 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (595)) ;
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (597)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_23886 (operand_23206->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_23886 = NULL ;
while (((operand_23886 = enumerator_23886.nextObject ()))) {
  macroValidPointer (operand_23886) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_23886->mSyntaxInstructionList,  operand_23886->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (602)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_23886->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_23206->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (618)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, operand_23206->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (619))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_24791,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24791->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24791->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (636))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (636))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_25247 (operand_24791->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_25247 = NULL ;
while (((operand_25247 = enumerator_25247.nextObject ()))) {
  macroValidPointer (operand_25247) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (638)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (638))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_25247->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (639)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_25783,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25783 != NULL) {
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (667)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_26386 (operand_25783->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_26386 = NULL ;
while (((operand_26386 = enumerator_26386.nextObject ()))) {
  macroValidPointer (operand_26386) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_26386->mSyntaxInstructionList,  operand_26386->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (672)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_26386->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_25783->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (688)) ;
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
GGS_location  automatic_var_27203_0 ;
var_cas_tempListOfBranches.modifier_popFirst (inLexique, var_cas_instructionList, automatic_var_27203_0 COMMA_SOURCE_FILE_AT_LINE (692)) ;
const GGS_semanticInstructionListForGeneration  var_cas_referenceSignature = function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (693)) ;
GGS_bool var_cas_ok = GGS_bool (true) ;
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_27377 (var_cas_tempListOfBranches, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_27377 = NULL ;
while (((operand_27377 = enumerator_27377.nextObject ()))
    && (var_cas_ok.isBuiltAndTrue ())) {
  macroValidPointer (operand_27377) ;
var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_referenceSignature, function_syntaxSignatureOfInstructionList (inLexique, operand_27377->mInstructionList COMMA_SOURCE_FILE_AT_LINE (698)), operand_27377->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (696)) ;
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseDoInstructionForGeneration ::constructor_new (inLexique, operand_25783->mInstructionLocation, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (703))) ;
  }
}
...
static void
category_method__parseDoInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstructionForGeneration * operand_27906,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
const GGS_string var_cas_parsingContextVar = (GGS_string ("parsingContext_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (718))) ;
...
var_cas_ioGeneratedCode.appendCString (" = ") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (719))) ;
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_28452 (operand_27906->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_28452 = enumerator_28452.nextObject () ;
if ((operand_28452 != NULL)) {
  GGS_uint var_cas_IDX (true, 0) ;
  bool _foreach_loop_28452 ;
  do{
  macroValidPointer (operand_28452) ;
  ::routine_generateInstructionList (inLexique,  operand_28452->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (722)) ;
  var_cas_IDX.mValue ++ ;
  operand_28452 = enumerator_28452.nextObject () ;
  _foreach_loop_28452 = ((operand_28452 != NULL)) ;
  if (_foreach_loop_28452) {
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (729)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (729))) ;
    var_cas_ioGeneratedCode.appendCString ("\n") ;
  }
  }while (_foreach_loop_28452) ;
}
}
  }
}
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_28935,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28935->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28935->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (749)) ;
  }
}
const GGS_bool cond_29815 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (755))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_29815.isBuiltAndTrue ()) {
operand_28935->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (757)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (757)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (758)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (760)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28935->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28935->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (763)) ;
  }
}
const GGS_bool cond_30302 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (769))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_30302.isBuiltAndTrue ()) {
operand_28935->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (771)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (771)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (772)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (774)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (777)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_28935->mDoInstructionList,  operand_28935->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (780)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_28935->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (794)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_28935->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (796))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_31190,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31190->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31190->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (814)) ;
  }
}
const GGS_string var_cas_executeParseVar = (GGS_string ("executeParse_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (816))) ;
...
const GGS_string var_cas_variantVar = (GGS_string ("variant_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (820))) ;
var_cas_ioTemporaryVariableIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (820)) ;
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31190->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31190->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (825)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (" = (! ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (829)) ;
const GGS_string var_cas_loopVar = (GGS_string ("loop_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830))) ;
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_31190->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (840)) ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (847)) ;
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31190->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31190->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (849)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (" = ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_31190->mInstructionList COMMA_SOURCE_FILE_AT_LINE (863)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (862)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_34871,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34871 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_34871->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34871->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (887)) ;
  }
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_35656 (operand_34871->mWhenInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_35656 = NULL ;
while (((operand_35656 = enumerator_35656.nextObject ()))) {
  macroValidPointer (operand_35656) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_35656->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_35656->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_when_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (897)) ;
  }
}
}
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_36133 (operand_34871->mElseInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_36133 = NULL ;
while (((operand_36133 = enumerator_36133.nextObject ()))) {
  macroValidPointer (operand_36133) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_36133->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_36133->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_else_instructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (913)) ;
  }
}
}
}
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration, operand_34871->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (927)) ;
const GGS_bool cond_36906 = var_cas_ok ;
if (cond_36906.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_34871->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (930))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_37075,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_37075->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_37075->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (948)) ;
  }
}
const GGS_string var_cas_boolVarCppName = (GGS_string ("parseWhen_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (949))) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_37075->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (953)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_37075->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (960)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_38292,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
...
operand_38292->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (985)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1008)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignatureForGeneration COMMA_SOURCE_FILE_AT_LINE (1009)) ;
var_cas_outSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_40082 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_40082 = NULL ;
while (((operand_40082 = enumerator_40082.nextObject ()))) {
  macroValidPointer (operand_40082) ;
var_cas_outSignature.addAssign_operation (operand_40082->mFormalArgumentType, operand_40082->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_40392 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_40392 = NULL ;
while (((operand_40392 = enumerator_40392.nextObject ()))) {
  macroValidPointer (operand_40392) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_40392->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_40392->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (1025)) ;
  }
}
}
}
if (var_cas_variableMap.isBuilt ()) {
  var_cas_variableMap (HERE)->method_checkAutomatonStates (inLexique, var_cas_inEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (1039)) ;
}
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_semanticAnalysisOfSyntaxComponent (C_Compiler & inLexique,
  ...
  #endif
GGS_nonterminalMap  var_cas_nonterminalMap = GGS_nonterminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1060)) ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_41842 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_41842 = NULL ;
while (((operand_41842 = enumerator_41842.nextObject ()))) {
  macroValidPointer (operand_41842) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1067)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_41926 (operand_41842->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_41926 = NULL ;
while (((operand_41926 = enumerator_41926.nextObject ()))) {
  macroValidPointer (operand_41926) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_42093 (operand_41926->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_42093 = NULL ;
    while (((operand_42093 = enumerator_42093.nextObject ()))) {
      macroValidPointer (operand_42093) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42093->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1072)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_42093->mFormalArgumentPassingMode, var_cas_type, operand_42093->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_42093->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_42093->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_41926->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_41926->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1076)) ;
}
}
elementOf_GGS_nonterminalMap * operand_42562 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_41842->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1078))) ;
if (NULL != operand_42562) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41842->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_42562->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1079)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41842->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1081)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43026 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43026 = NULL ;
while (((operand_43026 = enumerator_43026.nextObject ()))) {
  macroValidPointer (operand_43026) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43183 (operand_43026->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43183 = NULL ;
while (((operand_43183 = enumerator_43183.nextObject ()))) {
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_43183->mFormalArguments,  operand_43183->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_43183->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1096)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_43183->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43183->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_44171_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_43026->mNonterminalName, automatic_var_44171_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1121)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_43026->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
var_cas_newRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1128)) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalMap, var_cas_ruleDeclarationList, var_cas_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (1131)) ;
  #ifdef DEBUG_TRACE_ENABLED
