...
category_method__terminalCheckInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_13870,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
if (var_cas_inTerminalMap.isBuilt ()) {
  var_cas_inTerminalMap (HERE)->method_searchKey (inLexique, operand_13870->mTerminalName, var_cas_sentAttributeList COMMA_SOURCE_FILE_AT_LINE (351)) ;
}
const GGS_bool cond_14835 = (operand_13870->mActualInputParameterList.reader_length ()).operator_isNotEqual (var_cas_sentAttributeList.reader_length ()) ;
if (cond_14835.isBuiltAndTrue ()) {
operand_13870->mTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((((GGS_string ("naming the '$")).operator_concat (operand_13870->mTerminalName)).operator_concat (GGS_string ("$' requires "))).operator_concat (var_cas_sentAttributeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_sentAttributeList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (", but this instruction names "))).operator_concat (operand_13870->mActualInputParameterList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (358)))).operator_concat (GGS_string (" parameter"))).operator_concat ((((operand_13870->mActualInputParameterList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (361)) ;
}
...
{
GGS_actualInputParameterListAST::cEnumerator enumerator_14956 (operand_13870->mActualInputParameterList, true) ;
const GGS_actualInputParameterListAST::cElement * operand_14956 = NULL ;
GGS_lexicalSentValueList::cEnumerator enumerator_14975 (var_cas_sentAttributeList, true) ;
const GGS_lexicalSentValueList::cElement * operand_14975 = NULL ;
while (((operand_14956 = enumerator_14956.nextObject ()))
    && ((operand_14975 = enumerator_14975.nextObject ()))) {
  macroValidPointer (operand_14956) ;
  macroValidPointer (operand_14975) ;
const GGS_bool cond_16685 = (operand_14956->mActualParameterName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_16685.isBuiltAndTrue ()) {
  GGS_unifiedTypeMapProxy  var_cas_type ;
  GGS_string var_cas_cppName ;
  const GGS_bool cond_15494 = (operand_14956->mActualParameterTypeName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_15494.isBuiltAndTrue ()) {
    var_cas_cppName = (GGS_string ("var_")).operator_concat (operand_14956->mActualParameterName.ggs_string ().reader_identifierRepresentation ()) ;
    var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_14956->mActualParameterTypeName COMMA_SOURCE_FILE_AT_LINE (370)) ;
    var_cas_ioVariableMap.modifier_insertDefinedLocalVariable (inLexique, operand_14956->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (371)) ;
    var_cas_ioLocalVariableCppNameList.addAssign_operation (var_cas_cppName) ;
  }else if (cond_15494.isBuiltAndFalse ()) {
    var_cas_ioVariableMap.modifier_searchForWriteAccess (inLexique, operand_14956->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (374)) ;
  }
  GGS_unifiedTypeMapProxy  var_cas_expectedType ;
  switch (operand_14975->mLexicalType.enumValue ()) {
  ...
  const GGS_bool cond_16535 = (var_cas_expectedType).operator_isNotEqual (var_cas_type) ;
  if (cond_16535.isBuiltAndTrue ()) {
    operand_14956->mActualParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '")).operator_concat (operand_14956->mActualParameterName)).operator_concat (GGS_string ("' parameter has the '@"))).operator_concat (var_cas_type.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (388)))).operator_concat (GGS_string (", bit an '@"))).operator_concat (var_cas_expectedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (389)))).operator_concat (GGS_string ("' parameter is required here")) COMMA_SOURCE_FILE_AT_LINE (391)) ;
  }
  var_cas_terminalCheckAssignementList.addAssign_operation (operand_14956->mActualParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393)), var_cas_cppName, operand_14975->mLexicalAttributeName) ;
}
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_terminalCheckInstructionForGeneration ::constructor_new (inLexique, operand_13870->mInstructionLocation, operand_13870->mTerminalName, var_cas_inLexiqueName, var_cas_terminalCheckAssignementList COMMA_SOURCE_FILE_AT_LINE (400))) ;
  }
}
...
category_method__terminalCheckInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstructionForGeneration * operand_17064,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17064 != NULL) {
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17064->mLexiqueIdentifier) ;
var_cas_ioGeneratedCode.appendCString ("::kToken_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_17064->mTerminalName.ggs_string ().reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (") COMMA_SOURCE_FILE_AT_LINE (") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_17064->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (419)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (419))) ;
var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
{
GGS_terminalCheckAssignementList::cEnumerator enumerator_17650 (operand_17064->mTerminalCheckAssignementList, true) ;
const GGS_terminalCheckAssignementList::cElement * operand_17650 = NULL ;
while (((operand_17650 = enumerator_17650.nextObject ()))) {
  macroValidPointer (operand_17650) ;
const GGS_bool cond_17774 = (operand_17650->mTypeName).operator_isNotEqual (GGS_string ("")) ;
if (cond_17774.isBuiltAndTrue ()) {
  var_cas_ioGeneratedCode.appendCString ("GALGAS_") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17650->mTypeName.reader_identifierRepresentation ()) ;
  var_cas_ioGeneratedCode.appendCString (" * ") ;
}else if (cond_17774.isBuiltAndFalse ()) {
  var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17650->mTargetVarCppName) ;
  var_cas_ioGeneratedCode.appendCString (") ;\n") ;
}
var_cas_ioGeneratedCode.dotAssign_operation (operand_17650->mTargetVarCppName) ;
var_cas_ioGeneratedCode.appendCString (" = ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17650->mSourceLexicalAttributeName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (" () ;\n") ;
}
}
  }
...
var_cas_ioVariableMap.modifier_beginBranch (inLexique COMMA_SOURCE_FILE_AT_LINE (449)) ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_18906 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18906 = NULL ;
while (((operand_18906 = enumerator_18906.nextObject ()))) {
  macroValidPointer (operand_18906) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18906->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18906->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (453)) ;
  }
}
}
}
const GGS_bool cond_19457 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_19457.isBuiltAndTrue ()) {
var_cas_outInstructionListForGeneration.addAssign_operation (GGS_dropInstructionForGeneration ::constructor_new (inLexique, var_cas_localVariableCppNameList, GGS_string ("end of scope") COMMA_SOURCE_FILE_AT_LINE (468))) ;
}
var_cas_ioVariableMap.modifier_endBranch (inLexique, var_cas_inEndOfBranchLocation COMMA_SOURCE_FILE_AT_LINE (474)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_19687,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19687 != NULL) {
const GGS_uint  var_cas_choiceIndex = var_cas_ioSelectMethodCount ;
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (492)) ;
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (494)) ;
GGS_semanticInstructionListForGeneration  var_cas_repeated_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19687->mRepeatedInstructionList,  operand_19687->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (497)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20772 (operand_19687->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_20772 = NULL ;
while (((operand_20772 = enumerator_20772.nextObject ()))) {
  macroValidPointer (operand_20772) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_20772->mSyntaxInstructionList,  operand_20772->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (514)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_20772->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_19687->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (530)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, operand_19687->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, operand_19687->mEndOf_repeat_instruction, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (532))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_21744,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21744 != NULL) {
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_21744->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (553)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_21744->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_21744->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_22574 (operand_21744->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_22574 = NULL ;
while (((operand_22574 = enumerator_22574.nextObject ()))) {
  macroValidPointer (operand_22574) ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_22574->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (563)) ;
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_23245,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_23925 (operand_23245->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_23925 = NULL ;
while (((operand_23925 = enumerator_23925.nextObject ()))) {
  macroValidPointer (operand_23925) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_23925->mSyntaxInstructionList,  operand_23925->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (601)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_23925->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_23245->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (617)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, operand_23245->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (618))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_24830,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24830->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24830->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (635))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (635))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_25286 (operand_24830->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_25286 = NULL ;
while (((operand_25286 = enumerator_25286.nextObject ()))) {
  macroValidPointer (operand_25286) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (637)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (637))) ;
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_25286->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (638)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_25822,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25822 != NULL) {
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (666)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_26425 (operand_25822->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_26425 = NULL ;
while (((operand_26425 = enumerator_26425.nextObject ()))) {
  macroValidPointer (operand_26425) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_26425->mSyntaxInstructionList,  operand_26425->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (671)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_26425->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_25822->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (687)) ;
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
GGS_location  automatic_var_27242_0 ;
var_cas_tempListOfBranches.modifier_popFirst (inLexique, var_cas_instructionList, automatic_var_27242_0 COMMA_SOURCE_FILE_AT_LINE (691)) ;
const GGS_semanticInstructionListForGeneration  var_cas_referenceSignature = function_syntaxSignatureOfInstructionList (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (692)) ;
GGS_bool var_cas_ok = GGS_bool (true) ;
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_27416 (var_cas_tempListOfBranches, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_27416 = NULL ;
while (((operand_27416 = enumerator_27416.nextObject ()))
    && (var_cas_ok.isBuiltAndTrue ())) {
  macroValidPointer (operand_27416) ;
var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_referenceSignature, function_syntaxSignatureOfInstructionList (inLexique, operand_27416->mInstructionList COMMA_SOURCE_FILE_AT_LINE (697)), operand_27416->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (695)) ;
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseDoInstructionForGeneration ::constructor_new (inLexique, operand_25822->mInstructionLocation, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (702))) ;
  }
}
...
category_method__parseDoInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstructionForGeneration * operand_27945,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27945 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @parseDoInstructionForGeneration\n") ;
var_cas_ioUnusedVariableCppNameSet.modifier_removeKey (inLexique, function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (716)) COMMA_SOURCE_FILE_AT_LINE (716)) ;
const GGS_string var_cas_parsingContextVar = (GGS_string ("parsingContext_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (717))) ;
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_28491 (operand_27945->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_28491 = enumerator_28491.nextObject () ;
if ((operand_28491 != NULL)) {
  GGS_uint var_cas_IDX (true, 0) ;
  bool _foreach_loop_28491 ;
  do{
  macroValidPointer (operand_28491) ;
  ::routine_generateInstructionList (inLexique,  operand_28491->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (721)) ;
  var_cas_IDX.mValue ++ ;
  operand_28491 = enumerator_28491.nextObject () ;
  _foreach_loop_28491 = ((operand_28491 != NULL)) ;
  if (_foreach_loop_28491) {
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (728)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (728))) ;
    var_cas_ioGeneratedCode.appendCString ("\n") ;
  }
  }while (_foreach_loop_28491) ;
}
}
  }
}
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_28974,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28974 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_variant_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28974->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28974->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (748)) ;
  }
}
const GGS_bool cond_29854 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (754))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_29854.isBuiltAndTrue ()) {
operand_28974->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (756)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (756)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (757)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (759)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28974->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28974->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (762)) ;
  }
}
const GGS_bool cond_30341 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (768))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_30341.isBuiltAndTrue ()) {
operand_28974->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (770)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (770)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (771)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (773)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (776)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_28974->mDoInstructionList,  operand_28974->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (779)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_28974->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (793)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_28974->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (795))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_31229,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31229 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @parseLoopInstructionForGeneration\n") ;
GGS_string var_cas_variantVarCppName ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31229->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31229->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (813)) ;
  }
}
const GGS_string var_cas_executeParseVar = (GGS_string ("executeParse_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (815))) ;
...
const GGS_string var_cas_variantVar = (GGS_string ("variant_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (819))) ;
var_cas_ioTemporaryVariableIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (819)) ;
...
var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_variantVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") ; // Release 'parse loop' variant\n") ;
GGS_string var_cas_whileVarCppName ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31229->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31229->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (824)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (" = (NULL == ") ;
...
var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_whileVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") ; // Release 'parse loop' first evaluation of 'while' expression\n") ;
var_cas_ioGeneratedCode.appendCString ("if (! ") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (828)) ;
const GGS_string var_cas_loopVar = (GGS_string ("loop_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (829))) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (832)) ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (" = false ;\n") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
...
var_cas_ioUnusedVariableCppNameSet.modifier_removeKey (inLexique, function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
var_cas_ioGeneratedCode.appendCString ("  const C_parsingContext parsingContext = ") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (838))) ;
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_31229->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (839)) ;
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31229->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31229->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (848)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (" = (NULL != ") ;
...
var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_whileVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") ; // Release 'parse loop' evaluation of 'while' expression\n") ;
var_cas_ioGeneratedCode.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (851)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_31229->mInstructionList COMMA_SOURCE_FILE_AT_LINE (862)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (861)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_34920,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_34920->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34920->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (886)) ;
  }
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_35705 (operand_34920->mWhenInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_35705 = NULL ;
while (((operand_35705 = enumerator_35705.nextObject ()))) {
  macroValidPointer (operand_35705) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_35705->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_35705->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_when_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (896)) ;
  }
}
}
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_36182 (operand_34920->mElseInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_36182 = NULL ;
while (((operand_36182 = enumerator_36182.nextObject ()))) {
  macroValidPointer (operand_36182) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_36182->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_36182->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_else_instructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (912)) ;
  }
}
}
}
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration, operand_34920->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (926)) ;
const GGS_bool cond_36955 = var_cas_ok ;
if (cond_36955.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_34920->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (929))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_37124,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37124 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//--------- @parseWhenInstructionForGeneration\n") ;
GGS_string var_cas_sourceVar ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_37124->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_37124->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (947)) ;
  }
}
const GGS_string var_cas_boolVarCppName = (GGS_string ("parseWhen_")).operator_concat (var_cas_ioTemporaryVariableIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (948))) ;
var_cas_ioTemporaryVariableIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (948)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_37124->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (952)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_37124->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (959)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_38347,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38347 != NULL) {
operand_38347->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (984)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1007)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignatureForGeneration COMMA_SOURCE_FILE_AT_LINE (1008)) ;
var_cas_outSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_40137 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_40137 = NULL ;
while (((operand_40137 = enumerator_40137.nextObject ()))) {
  macroValidPointer (operand_40137) ;
var_cas_outSignature.addAssign_operation (operand_40137->mFormalArgumentType, operand_40137->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_40447 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_40447 = NULL ;
while (((operand_40447 = enumerator_40447.nextObject ()))) {
  macroValidPointer (operand_40447) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_40447->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_40447->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (1024)) ;
  }
}
}
}
if (var_cas_variableMap.isBuilt ()) {
  var_cas_variableMap (HERE)->method_checkAutomatonStates (inLexique, var_cas_inEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (1038)) ;
}
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_semanticAnalysisOfSyntaxComponent (C_Compiler & inLexique,
  ...
  #endif
GGS_nonterminalMap  var_cas_nonterminalMap = GGS_nonterminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1058)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1059)) ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_41897 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_41897 = NULL ;
while (((operand_41897 = enumerator_41897.nextObject ()))) {
  macroValidPointer (operand_41897) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_41981 (operand_41897->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_41981 = NULL ;
while (((operand_41981 = enumerator_41981.nextObject ()))) {
  macroValidPointer (operand_41981) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_42148 (operand_41981->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_42148 = NULL ;
    while (((operand_42148 = enumerator_42148.nextObject ()))) {
      macroValidPointer (operand_42148) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42148->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1071)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_42148->mFormalArgumentPassingMode, var_cas_type, operand_42148->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_42148->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_42148->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_41981->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_41981->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1075)) ;
}
}
elementOf_GGS_nonterminalMap * operand_42617 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_41897->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1077))) ;
if (NULL != operand_42617) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41897->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_42617->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1078)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41897->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1080)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43081 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43081 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43238 (operand_43081->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43238 = NULL ;
while (((operand_43238 = enumerator_43238.nextObject ()))) {
  macroValidPointer (operand_43238) ;
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_43238->mFormalArguments,  operand_43238->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_43238->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1095)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_43238->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43238->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_44226_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_43081->mNonterminalName, automatic_var_44226_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1120)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_43081->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1122)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
var_cas_newRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1127)) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalMap, var_cas_ruleDeclarationList, var_cas_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (1130)) ;
  #ifdef DEBUG_TRACE_ENABLED
