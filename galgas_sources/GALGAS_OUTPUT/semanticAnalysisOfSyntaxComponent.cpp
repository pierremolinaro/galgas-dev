...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_33839 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_33839.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_33839.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 832)) ;
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_56223 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_56223.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_56223.current_mFormalArgumentType (HERE), enumerator_56223.current_mFormalArgumentPassingMode (HERE), enumerator_56223.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1447)) ;
  ...
  cEnumerator_syntaxInstructionList enumerator_56561 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_56561.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_56561.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1453)) ;
    enumerator_56561.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_58090 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58090.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_58174 (enumerator_58090.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_58174.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_58341 (enumerator_58174.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_58341.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_58341.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1503)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_58341.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_58341.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_58341.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1504))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1504))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1504)) ;
        var_signature.addAssign_operation (var_type, enumerator_58341.current_mFormalArgumentPassingMode (HERE), enumerator_58341.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1505)) ;
        enumerator_58341.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_58174.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_58174.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1507)) ;
      }
      enumerator_58174.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_58090.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1509)) ;
    }
  ...
  cEnumerator_syntaxRuleListAST enumerator_59290 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_59290.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_59474_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_59290.current_mNonterminalName (HERE), joker_59474_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1526)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59501 (enumerator_59290.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59501.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59501.current_mFormalArguments (HERE), enumerator_59501.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59501.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1532)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59501.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59501.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1548)) ;
      enumerator_59501.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_60472_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_59290.current_mNonterminalName (HERE), joker_60472_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1557)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_59290.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1559)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1558)) ;
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 718)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 721)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("naming the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)).operator_concat (GALGAS_string ("$' requires ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)).operator_concat (var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)).operator_concat (GALGAS_string ("parameter")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)).operator_concat (temp_1  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 718)).operator_concat (GALGAS_string (", but this instruction names ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 718)).operator_concat (object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 720)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 720))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 719)).operator_concat (GALGAS_string (" parameter")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 720)).operator_concat (temp_3  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 720))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 716)) ;
  }
  ...
  cEnumerator_actualInputParameterListAST enumerator_29948 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_29967 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_29948.hasCurrentObject () && enumerator_29967.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_29948.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_29967.current_mLexicalType (HERE), enumerator_29967.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)) ;
    enumerator_29948.gotoNextObject () ;
    enumerator_29967.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_30202 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_30202.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_30202.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 737)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 737)).operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 737)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_30315 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_30315.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_30315.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 740))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 740)) ;
        enumerator_30315.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_30202.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_30202.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 742))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 742)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 742)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 742))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 742)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_31648 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_31648.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_31648.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_31648.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 780))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 780)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 780))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 780)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_31648.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 783)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 783))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 783)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 783)).operator_concat (enumerator_31648.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 783)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 783)) ;
    enumerator_31648.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_32049 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_32049.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789)).operator_concat (GALGAS_string ("::kIndexing_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789)).operator_concat (enumerator_32049.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 789)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_35472 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_35472.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_35472.current_mSyntaxInstructionList (HERE), enumerator_35472.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 887)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_35472.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 901)) ;
    enumerator_35472.gotoNextObject () ;
  }
  {
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_37453.hasCurrentObject ()) {
    ...
    index_37409.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 939)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_38848 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_38848.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_38848.current_mSyntaxInstructionList (HERE), enumerator_38848.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 981)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_38848.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 995)) ;
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_41515 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_41515.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_41681 (enumerator_41515.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_41681.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_41681.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1057)) ;
      enumerator_41681.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_41515.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1070)) ;
    enumerator_41515.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_42385_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_42385_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1075)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42570 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_42570.hasCurrentObject () && bool_0) {
    while (enumerator_42570.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_42570.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1081)), enumerator_42570.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1079)) ;
      enumerator_42570.gotoNextObject () ;
      if (enumerator_42570.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_43749 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_43749.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_43749.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1107)) ;
    }
    if (enumerator_43749.hasNextObject ()) {
    ...
    enumerator_43749.gotoNextObject () ;
  }
