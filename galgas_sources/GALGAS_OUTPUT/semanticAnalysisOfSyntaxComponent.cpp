...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_34459,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34459->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34459->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (865)) ;
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34459->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34459->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (878)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (") ;
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_34459->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (884)) ;
...
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_34459->mInstructionList COMMA_SOURCE_FILE_AT_LINE (900)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (899)) ;
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_37034,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_uint  & var_cas_ioSelectMethodCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37034 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_37034->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_37034->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
}
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_37034->mWhenInstructionList,  operand_37034->mEndOfWhenInstructionList,  var_cas_ioVariableMap,  var_cas_localSelectMethodCount,  var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (935)) ;
GGS_semanticInstructionListForGeneration  var_cas_else_instructionListForGeneration ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_37034->mElseInstructionList,  operand_37034->mEndOfElseInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (950)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_37034->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (964)) ;
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, function_syntaxSignatureOfInstructionList (inLexique, var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (967)), function_syntaxSignatureOfInstructionList (inLexique, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (968)), operand_37034->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (966)) ;
const GGS_bool cond_39107 = var_cas_ok ;
if (cond_39107.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_37034->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (973))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_39276,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39276 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//--------- @parseWhenInstructionForGeneration\n") ;
GGS_string var_cas_sourceVar ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_39276->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_39276->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (991)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_sourceVar) ;
var_cas_ioGeneratedCode.appendCString (".isValidAndTrue ()) {\n") ;
::routine_generateInstructionList (inLexique,  operand_39276->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (993)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_39276->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1000)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_40170,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_uint  & /* var_cas_ioSelectMethodCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40170 != NULL) {
operand_40170->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (1024)) ;
  }
}
...
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_41910 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_41910 = NULL ;
while (((operand_41910 = enumerator_41910.nextObject ()))) {
  macroValidPointer (operand_41910) ;
var_cas_outSignature.addAssign_operation (operand_41910->mFormalArgumentType, operand_41910->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_42220 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_42220 = NULL ;
while (((operand_42220 = enumerator_42220.nextObject ()))) {
  macroValidPointer (operand_42220) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_42220->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_42220->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (1064)) ;
  }
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43637 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43637 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43721 (operand_43637->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43721 = NULL ;
while (((operand_43721 = enumerator_43721.nextObject ()))) {
  macroValidPointer (operand_43721) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_43888 (operand_43721->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_43888 = NULL ;
    while (((operand_43888 = enumerator_43888.nextObject ()))) {
      macroValidPointer (operand_43888) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43888->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1110)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_43888->mFormalArgumentPassingMode, var_cas_type, operand_43888->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_43888->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_43888->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_43721->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43721->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1114)) ;
}
}
elementOf_GGS_nonterminalMap * operand_44357 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_43637->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1116))) ;
if (NULL != operand_44357) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43637->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_44357->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1117)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43637->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1119)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_44821 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_44821 = NULL ;
while (((operand_44821 = enumerator_44821.nextObject ()))) {
  macroValidPointer (operand_44821) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_44978 (operand_44821->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_44978 = NULL ;
while (((operand_44978 = enumerator_44978.nextObject ()))) {
  macroValidPointer (operand_44978) ;
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_44978->mFormalArguments,  operand_44978->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_44978->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_44978->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_44978->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_45966_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_44821->mNonterminalName, automatic_var_45966_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1159)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_44821->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1161)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
