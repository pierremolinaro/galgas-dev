...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (562)) ;
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_24138 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_24138.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_24138.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
    enumerator_24138.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1090)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1091)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1098)) ;
  cEnumerator_formalParameterListForGeneration enumerator_43287 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_43287.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_43287.current_mFormalArgumentType (HERE), enumerator_43287.current_mFormalArgumentPassingMode (HERE), enumerator_43287.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1100)) ;
    enumerator_43287.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1103)) ;
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1104)) ;
  cEnumerator_syntaxInstructionList enumerator_43625 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_43625.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_43625.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    enumerator_43625.gotoNextObject () ;
  }
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1119)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1141)) ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1142)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_45093 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_45093.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1149)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_45177 (enumerator_45093.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_45177.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1151)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1152)) ;
      cEnumerator_formalParameterListAST enumerator_45344 (enumerator_45177.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_45344.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_45344.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1154)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_45344.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_45344.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_45344.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1155)) COMMA_SOURCE_FILE_AT_LINE (1155)) COMMA_SOURCE_FILE_AT_LINE (1155)) ;
        var_signature.addAssign_operation (var_type, enumerator_45344.current_mFormalArgumentPassingMode (HERE), enumerator_45344.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1156)) ;
        enumerator_45344.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_45177.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_45177.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1158)) ;
      }
      enumerator_45177.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_45093.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1161)) ;
    }
    enumerator_45093.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1170)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1172)) COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1176)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_46487 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_46487.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1179)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_46671_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_46487.current_mNonterminalName (HERE), joker_46671_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1181)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_46698 (enumerator_46487.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_46698.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_46698.current_mFormalArguments (HERE), enumerator_46698.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_46698.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1187)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_46698.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_46698.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1202)) ;
      enumerator_46698.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_47638_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_46487.current_mNonterminalName (HERE), joker_47638_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_46487.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1213)), var_newRuleIndex, var_ruleLabelImplementationList COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) ;
    enumerator_46487.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (GALGAS_bool (true), constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing COMMA_SOURCE_FILE_AT_LINE (1220)) ;
}
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_14415_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_14415_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (353)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (368)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (GALGAS_string::makeEmptyString (), var_cppName, constinArgument_inLexicalAttributeName COMMA_SOURCE_FILE_AT_LINE (373)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (389)) COMMA_SOURCE_FILE_AT_LINE (389)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (390)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (391)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType ;
  if (constinArgument_inRequiredLexicalType.isValid ()) {
    switch (constinArgument_inRequiredLexicalType.enumValue ()) {
  ...
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (object->mAttribute_mActualParameterTypeName.reader_string (SOURCE_FILE_AT_LINE (409)), var_cppName, constinArgument_inLexicalAttributeName COMMA_SOURCE_FILE_AT_LINE (408)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredConstant_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (426)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType ;
  if (constinArgument_inRequiredLexicalType.isValid ()) {
    switch (constinArgument_inRequiredLexicalType.enumValue ()) {
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inTerminalMap.method_searchKey (object->mAttribute_mTerminalName, var_sentAttributeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (463)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (465)).objectCompare (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (465)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //--- @ifExpressionForGeneration
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (468)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (471)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("naming the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (467)) COMMA_SOURCE_FILE_AT_LINE (467)).operator_concat (GALGAS_string ("$' requires ") COMMA_SOURCE_FILE_AT_LINE (467)).operator_concat (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (467)).reader_string (SOURCE_FILE_AT_LINE (467)) COMMA_SOURCE_FILE_AT_LINE (467)).operator_concat (GALGAS_string ("parameter") COMMA_SOURCE_FILE_AT_LINE (467)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (GALGAS_string (", but this instruction names ") COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (470)).reader_string (SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (469)).operator_concat (GALGAS_string (" parameter") COMMA_SOURCE_FILE_AT_LINE (470)).operator_concat (temp_3 COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (466)) ;
  }
  GALGAS_terminalCheckAssignementList var_terminalCheckAssignementList = GALGAS_terminalCheckAssignementList::constructor_emptyList (SOURCE_FILE_AT_LINE (475)) ;
  cEnumerator_actualInputParameterListAST enumerator_20638 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_20657 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_20638.hasCurrentObject () && enumerator_20657.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_20638.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_20657.current_mLexicalType (HERE), enumerator_20657.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (477)) ;
    enumerator_20638.gotoNextObject () ;
    enumerator_20657.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_20892 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_20892.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_20892.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (487)) COMMA_SOURCE_FILE_AT_LINE (487)).operator_not (SOURCE_FILE_AT_LINE (487)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_21005 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_21005.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_21005.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (490)) COMMA_SOURCE_FILE_AT_LINE (490)) ;
        enumerator_21005.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_20892.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_20892.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (492)) COMMA_SOURCE_FILE_AT_LINE (492)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (492)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (492)) COMMA_SOURCE_FILE_AT_LINE (492)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_21880 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_21880.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_21880.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_21880.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (517)) COMMA_SOURCE_FILE_AT_LINE (517)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (517)) COMMA_SOURCE_FILE_AT_LINE (517)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_21880.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (520)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (520)) COMMA_SOURCE_FILE_AT_LINE (520)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (520)).operator_concat (enumerator_21880.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (520)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (520)) ;
    enumerator_21880.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_22281 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_22281.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (GALGAS_string ("::kIndexing_") COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (enumerator_22281.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)) ;
    enumerator_22281.gotoNextObject () ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (533)) COMMA_SOURCE_FILE_AT_LINE (533)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (GALGAS_string ("::kToken_") COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (GALGAS_string (") COMMA_SOURCE_FILE_AT_LINE (") COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (object->mAttribute_mInstructionLocation.reader_line (inCompiler COMMA_SOURCE_FILE_AT_LINE (536)).reader_string (SOURCE_FILE_AT_LINE (536)) COMMA_SOURCE_FILE_AT_LINE (536)).operator_concat (GALGAS_string (")) ;\n") COMMA_SOURCE_FILE_AT_LINE (536)) COMMA_SOURCE_FILE_AT_LINE (534)) ;
  const enumGalgasBool test_1 = constinArgument_inGenerateCheckValid.boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("#ifndef DO_NOT_GENERATE_CHECKINGS\n") COMMA_SOURCE_FILE_AT_LINE (539)) ;
    cEnumerator_terminalCheckAssignementList enumerator_23242 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    while (enumerator_23242.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_23242.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (541)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (541)) COMMA_SOURCE_FILE_AT_LINE (541)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mRepeatedInstructionList, object->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_repeated_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (616)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_25683 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_25683.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_25683.current_mSyntaxInstructionList (HERE), enumerator_25683.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (619)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_25683.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (632)) ;
    enumerator_25683.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_repeat_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (635)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOf_5F_repeat_5F_instruction, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (637)) COMMA_SOURCE_FILE_AT_LINE (637)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_repeatFlagCppName = GALGAS_string ("repeatFlag_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (656)) COMMA_SOURCE_FILE_AT_LINE (656)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (656)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (657)).operator_concat (GALGAS_string (" = true ;\n") COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (658)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_m_5F_repeated_5F_instructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (659)) ;
  }
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (666)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_27542 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_27498 ((uint32_t) 0) ;
  while (enumerator_27542.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_27498.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (669)).reader_string (SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_27542.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (670)) ;
    }
    ...
    index_27498.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n") COMMA_SOURCE_FILE_AT_LINE (679)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (var_repeatFlagCppName COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (GALGAS_string (" = false ;\n") COMMA_SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n") COMMA_SOURCE_FILE_AT_LINE (681)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (682)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_choiceIndex = ioArgument_ioSelectMethodCount ;
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (701)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (703)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (705)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_28861 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_28861.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_28861.current_mSyntaxInstructionList (HERE), enumerator_28861.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (708)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_28861.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (721)) ;
    enumerator_28861.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_select_5F_instruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (724)) ;
  }
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_30253 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_30209 ((uint32_t) 0) ;
  while (enumerator_30253.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_30209.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (745)).reader_string (SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (745)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_30253.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (746)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (753)) ;
    enumerator_30253.gotoNextObject () ;
    index_30209.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (744)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (774)) ;
  GALGAS_uint var_referenceSelectMethodCount = ioArgument_ioSelectMethodCount ;
  cEnumerator_listOfSyntaxInstructionList enumerator_31372 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_31372.hasCurrentObject ()) {
    ioArgument_ioSelectMethodCount = var_referenceSelectMethodCount ;
    GALGAS_semanticInstructionListForGeneration var_instructionList = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (778)) ;
    cEnumerator_syntaxInstructionList enumerator_31538 (enumerator_31372.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_31538.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_31538.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (780)) ;
      enumerator_31538.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_31372.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (792)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_32211_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_32211_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (797)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (798)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_32396 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_32396.hasCurrentObject () && bool_0) {
    while (enumerator_32396.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_32396.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (803)), enumerator_32396.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (801)) ;
      enumerator_32396.gotoNextObject () ;
      if (enumerator_32396.hasCurrentObject ()) {
        bool_0 = var_ok.isValidAndTrue () ;
      }
    }
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseRewindInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_parsingContextVar = GALGAS_string ("parsingContext_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (824)) COMMA_SOURCE_FILE_AT_LINE (824)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (824)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext ").operator_concat (var_parsingContextVar COMMA_SOURCE_FILE_AT_LINE (825)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (825)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (825)).operator_concat (GALGAS_string ("->parsingContext () ;\n") COMMA_SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (825)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_33524 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_33524.hasCurrentObject ()) {
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_33524.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
    }
    if (enumerator_33524.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string ("->setParsingContext (") COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (var_parsingContextVar COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string (") ; // rewind\n") COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
    }
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variant_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (856)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (861)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (863)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string ("', but it should be '@") COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (862)) ;
  }
  GALGAS_semanticExpressionForGeneration var_while_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (874)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfWhileExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (876)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (876)) COMMA_SOURCE_FILE_AT_LINE (876)).operator_concat (GALGAS_string ("', but it should be '@") COMMA_SOURCE_FILE_AT_LINE (876)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (875)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mDoInstructionList, object->mAttribute_mEndOfInstructionList, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (885)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (899)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseLoopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variant_5F_expression, var_while_5F_expression, var_instructionList COMMA_SOURCE_FILE_AT_LINE (901)) COMMA_SOURCE_FILE_AT_LINE (901)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mVariantExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_variantVarCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string (".isValid ()) {\n") COMMA_SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
  GALGAS_string var_variantVar = GALGAS_string ("variant_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (925)) COMMA_SOURCE_FILE_AT_LINE (925)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (925)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("uint32_t ").operator_concat (var_variantVar COMMA_SOURCE_FILE_AT_LINE (926)).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (926)).operator_concat (var_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (926)).operator_concat (GALGAS_string (".uintValue () ;\n") COMMA_SOURCE_FILE_AT_LINE (926)) COMMA_SOURCE_FILE_AT_LINE (926)) ;
  GALGAS_string var_loopVar = GALGAS_string ("loop_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE_AT_LINE (928)) COMMA_SOURCE_FILE_AT_LINE (928)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (928)) ;
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_loopVar COMMA_SOURCE_FILE_AT_LINE (930)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (930)) COMMA_SOURCE_FILE_AT_LINE (930)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (931)) ;
  }
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVarCppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (935)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n") COMMA_SOURCE_FILE_AT_LINE (935)) COMMA_SOURCE_FILE_AT_LINE (935)) ;
  {
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext parsingContext = ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) COMMA_SOURCE_FILE_AT_LINE (939)).operator_concat (GALGAS_string ("->parsingContext () ;\n") COMMA_SOURCE_FILE_AT_LINE (939)) COMMA_SOURCE_FILE_AT_LINE (939)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (947)).operator_concat (GALGAS_string ("->setParsingContext (parsingContext) ;\n") COMMA_SOURCE_FILE_AT_LINE (947)) COMMA_SOURCE_FILE_AT_LINE (947)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (948)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (949)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (950)) ;
  }
  ...
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (958)), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (956)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (963)).operator_concat (GALGAS_string ("->resetTemplateString () ;\n") COMMA_SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)) ;
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (982)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
  }
  ...
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1021)) ;
  }
  GALGAS_bool var_ok = function_compareSyntaxSignature (function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_when_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1024)), function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_else_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1025)), object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1023)) ;
...
static void categoryMethod_parseWhenInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhenExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE_AT_LINE (1049)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar COMMA_SOURCE_FILE_AT_LINE (1050)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n") COMMA_SOURCE_FILE_AT_LINE (1050)) COMMA_SOURCE_FILE_AT_LINE (1050)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n") COMMA_SOURCE_FILE_AT_LINE (1058)) ;
  {
  routine_generateInstructionList (constinArgument_inGenerateCheckValid, object->mAttribute_mElseInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1059)) ;
  }
