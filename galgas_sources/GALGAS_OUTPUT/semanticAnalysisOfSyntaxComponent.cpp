...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_19906 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_19906.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_19906.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (472)) ;
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_39055 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_39055.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_39055.current_mFormalArgumentType (HERE), enumerator_39055.current_mFormalArgumentPassingMode (HERE), enumerator_39055.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1005)) ;
    enumerator_39055.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxInstructionList enumerator_39393 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_39393.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_39393.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1011)) ;
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_40861 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_40861.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_40945 (enumerator_40861.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_40945.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_41112 (enumerator_40945.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_41112.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_41112.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1059)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_41112.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_41112.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_41112.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) ;
        var_signature.addAssign_operation (var_type, enumerator_41112.current_mFormalArgumentPassingMode (HERE), enumerator_41112.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1061)) ;
        enumerator_41112.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_40945.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_40945.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) ;
      }
      enumerator_40945.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40861.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1066)) ;
    }
  ...
  cEnumerator_syntaxRuleListAST enumerator_42255 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_42255.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_42439_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_42255.current_mNonterminalName (HERE), joker_42439_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1086)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_42466 (enumerator_42255.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_42466.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_42466.current_mFormalArguments (HERE), enumerator_42466.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_42466.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1092)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_42466.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_42466.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1107)) ;
      enumerator_42466.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_43406_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_42255.current_mNonterminalName (HERE), joker_43406_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1116)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_42255.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1118)), var_newRuleIndex, var_ruleLabelImplementationList COMMA_SOURCE_FILE_AT_LINE (1117)) ;
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_10908_0 ; // Joker input parameter
    GALGAS_location joker_10922_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_10908_0, var_signature, joker_10922_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_stringlist enumerator_12526 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_12526.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_12526.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (305)) COMMA_SOURCE_FILE_AT_LINE (305)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_stringlist enumerator_12831 (var_inputVariableList, kEnumeration_up) ;
    while (enumerator_12831.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_12831.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313)) ;
  ...
  cEnumerator_stringlist enumerator_13041 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_13041.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13041.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (319)) COMMA_SOURCE_FILE_AT_LINE (319)) ;
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_14337 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_14356 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_14337.hasCurrentObject () && enumerator_14356.hasCurrentObject ()) {
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_14337.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (350)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_unifiedTypeMapProxy var_type ;
      GALGAS_string var_cppName ;
      const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, enumerator_14337.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (353)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_cppName = GALGAS_string ("var_").operator_concat (enumerator_14337.current_mActualParameterName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
        var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_14337.current_mActualParameterTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
        {
        ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (enumerator_14337.current_mActualParameterName (HERE), var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
        }
      }else if (kBoolFalse == test_7) {
        {
        GALGAS_string joker_14938_0 ; // Joker input parameter
        ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_14337.current_mActualParameterName (HERE), var_type, var_cppName, joker_14938_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (358)) ;
        }
      }
      GALGAS_unifiedTypeMapProxy var_expectedType ;
      if (enumerator_14356.current_mLexicalType (HERE).isValid ()) {
        switch (enumerator_14356.current_mLexicalType (HERE).enumValue ()) {
      ...
      if (kBoolTrue == test_8) {
        GALGAS_location location_9 (enumerator_14337.current_mActualParameterName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (enumerator_14337.current_mActualParameterName (HERE).reader_string (SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
      }
      var_terminalCheckAssignementList.addAssign_operation (enumerator_14337.current_mActualParameterTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (377)), var_cppName, enumerator_14356.current_mLexicalAttributeName (HERE) COMMA_SOURCE_FILE_AT_LINE (376)) ;
    }
    enumerator_14337.gotoNextObject () ;
    enumerator_14356.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_16226 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_16226.hasCurrentObject ()) {
    const enumGalgasBool test_10 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_16226.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (385)).operator_not (SOURCE_FILE_AT_LINE (385)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_16339 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_16339.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_16339.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (388)) COMMA_SOURCE_FILE_AT_LINE (388)) ;
        enumerator_16339.gotoNextObject () ;
      }
      GALGAS_location location_11 (enumerator_16226.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, GALGAS_string ("the '").operator_concat (enumerator_16226.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (390)) COMMA_SOURCE_FILE_AT_LINE (390)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (390)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (390)) COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_17648 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_17648.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_17648.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_17648.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_17648.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (enumerator_17648.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
    enumerator_17648.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_18049 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_18049.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (431)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (431)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (431)).operator_concat (GALGAS_string ("::kIndexing_") COMMA_SOURCE_FILE_AT_LINE (431)).operator_concat (enumerator_18049.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (431)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (431)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_terminalCheckAssignementList enumerator_19010 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    while (enumerator_19010.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_19010.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_21451 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_21451.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_21451.current_mSyntaxInstructionList (HERE), enumerator_21451.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_21451.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (537)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_23310 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_23266 ((uint32_t) 0) ;
  while (enumerator_23310.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_23266.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).reader_string (SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_23310.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (575)) ;
    }
    ...
    index_23266.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_24629 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_24629.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_24629.current_mSyntaxInstructionList (HERE), enumerator_24629.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_24629.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (626)) ;
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_26021 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_25977 ((uint32_t) 0) ;
  while (enumerator_26021.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_25977.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (650)).reader_string (SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_26021.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (651)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (658)) ;
    enumerator_26021.gotoNextObject () ;
    index_25977.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (649)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_27140 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_27140.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_27306 (enumerator_27140.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_27306.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_27306.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) ;
      enumerator_27306.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_27140.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (697)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_27979_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_27979_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28164 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_28164.hasCurrentObject () && bool_0) {
    while (enumerator_28164.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_28164.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (708)), enumerator_28164.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (706)) ;
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_29292 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_29292.hasCurrentObject ()) {
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_29292.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (733)) ;
    }
    if (enumerator_29292.hasNextObject ()) {
