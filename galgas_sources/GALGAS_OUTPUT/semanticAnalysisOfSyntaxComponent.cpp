    ...
    if (kBoolTrue == test_4) {
      ...
      while (enumerator_8162.hasCurrentObject () && enumerator_8185.hasCurrentObject ()) {
        ...
        while (enumerator_8287.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_8287.current_mFormalArgumentType (HERE), enumerator_8287.current_mFormalArgumentPassingMode (HERE), enumerator_8287.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 211)) ;
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_9147 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_9147.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_9228 (enumerator_9147.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_9228.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_9398 (enumerator_9228.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_9398.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_9398.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 241)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_9398.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_9398.current_mFormalArgumentName (HERE), enumerator_9398.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 242))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 242)) ;
        var_signature.addAssign_operation (var_t, enumerator_9398.current_mFormalArgumentPassingMode (HERE), enumerator_9398.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 243)) ;
        enumerator_9398.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_9228.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_9228.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 245)) ;
      }
      enumerator_9228.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_9147.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 247)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_34181 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_34181.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_34181.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 836)) ;
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_56565 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_56565.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_56565.current_mFormalArgumentType (HERE), enumerator_56565.current_mFormalArgumentPassingMode (HERE), enumerator_56565.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1451)) ;
  ...
  cEnumerator_syntaxInstructionList enumerator_56903 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_56903.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_56903.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1457)) ;
    enumerator_56903.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_58432 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58432.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_58516 (enumerator_58432.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_58516.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_58683 (enumerator_58516.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_58683.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_58683.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1507)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_58683.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_58683.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_58683.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1508))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1508))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1508)) ;
        var_signature.addAssign_operation (var_type, enumerator_58683.current_mFormalArgumentPassingMode (HERE), enumerator_58683.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1509)) ;
        enumerator_58683.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_58516.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_58516.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1511)) ;
      }
      enumerator_58516.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_58432.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1513)) ;
    }
    enumerator_58432.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxRuleListAST enumerator_59632 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_59632.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_59816_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_59632.current_mNonterminalName (HERE), joker_59816_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1530)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59843 (enumerator_59632.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59843.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59843.current_mFormalArguments (HERE), enumerator_59843.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59843.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1536)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59843.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59843.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1552)) ;
      enumerator_59843.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_60814_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_59632.current_mNonterminalName (HERE), joker_60814_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1561)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_59632.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1563)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1562)) ;
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_12334_0 ; // Joker input parameter
    GALGAS_location joker_12348_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_12334_0, var_signature, joker_12348_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 311)) ;
  }
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_13040 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_13040.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_13040.current_mType (HERE), enumerator_13040.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 333))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 333)) ;
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_actualParameterListForGeneration enumerator_14000 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  while (enumerator_14000.hasCurrentObject ()) {
    GALGAS_string var_parameterCppName ;
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_14000.current_mActualParameter (HERE).ptr (), ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 361)) ;
  ...
  cEnumerator_stringlist enumerator_14749 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_14749.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14749.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 379))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 379)) ;
  ...
  cEnumerator_stringlist enumerator_15306 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_15306.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_15306.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 394))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 394)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_16784_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_16784_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 432)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_23351_0 ; // Joker input parameter
  GALGAS_string joker_23354_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_23351_0, joker_23354_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 576)) ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_29970 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_29989 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_29970.hasCurrentObject () && enumerator_29989.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_29970.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_29989.current_mLexicalType (HERE), enumerator_29989.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 727)) ;
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_29989.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_29970.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string temp_7 ;
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_29989.current_mLexicalFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_8) {
        temp_7 = GALGAS_string (":") ;
      }else if (kBoolFalse == test_8) {
        temp_7 = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_location location_9 (enumerator_29970.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the actual selector should be '\?").operator_concat (enumerator_29989.current_mLexicalFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 735))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 735)).operator_concat (temp_7.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 735))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 735))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 735)) ;
      GALGAS_location location_10 (enumerator_29989.current_mLexicalFormalSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_29989.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_30548 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_30548.hasCurrentObject ()) {
    const enumGalgasBool test_11 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_30548.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 741)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 741)).operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 741)).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_30657 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_30657.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_30657.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 744))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 744)) ;
        enumerator_30657.gotoNextObject () ;
      }
      GALGAS_location location_12 (enumerator_30548.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_30548.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 746))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 746)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 746)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 746))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 746)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_31990 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_31990.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_31990.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_31990.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_31990.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 787)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 787))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 787)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 787)).operator_concat (enumerator_31990.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 788))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 787)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 788))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 787)) ;
    enumerator_31990.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_32391 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_32391.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793)).operator_concat (GALGAS_string ("::kIndexing_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793)).operator_concat (enumerator_32391.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 793)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_35814 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_35814.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_35814.current_mSyntaxInstructionList (HERE), enumerator_35814.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 891)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_35814.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 905)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_37795 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_37751 ((uint32_t) 0) ;
  while (enumerator_37795.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_37751.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_37795.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 945)) ;
    }
    ...
    index_37751.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 943)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_39190 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_39190.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_39190.current_mSyntaxInstructionList (HERE), enumerator_39190.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 985)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_39190.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 999)) ;
    enumerator_39190.gotoNextObject () ;
  }
  {
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_40662 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_40618 ((uint32_t) 0) ;
  while (enumerator_40662.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_40618.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1024)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1024))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1024)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1024))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1024)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_40662.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1025)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1033)) ;
    enumerator_40662.gotoNextObject () ;
    index_40618.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1023)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_41857 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_41857.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_42023 (enumerator_41857.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_42023.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_42023.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1061)) ;
      enumerator_42023.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_41857.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1074)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_42727_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_42727_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1079)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42912 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_42912.hasCurrentObject () && bool_0) {
    while (enumerator_42912.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_42912.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1085)), enumerator_42912.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1083)) ;
      enumerator_42912.gotoNextObject () ;
      if (enumerator_42912.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_44091 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_44091.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_44091.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1111)) ;
    }
    if (enumerator_44091.hasNextObject ()) {
