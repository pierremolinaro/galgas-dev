...
//                    november 15th, 2010, at 14h47'39"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
  ...
  const cMapElement_nonterminalMap * objectArray_5705 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (134))) ;
  if (NULL != objectArray_5705) {
      macroValidSharedObject (objectArray_5705, const cMapElement_nonterminalMap) ;
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, objectArray_5705->mAttribute_mHasParseLabel.objectCompare (constinArgument_inHasParseLabel)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_0 ;
      if (objectArray_5705->mAttribute_mHasParseLabel.isValidAndTrue ()) {
    ...
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_5705->mAttribute_mLabelMap.reader_allKeys (SOURCE_FILE_AT_LINE (144)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    if (GALGAS_bool (kIsStrictSup, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (147)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      ...
      cEnumerator_stringset enumerator_6437 (var_missingLabelSet, true) ;
      //--- simple foreach instruction
      while (enumerator_6437.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6437.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)) ;
    ...
    if (GALGAS_bool (kIsStrictSup, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      ...
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6817 (var_newLabelSet, true) ;
      //--- simple foreach instruction
      while (enumerator_6817.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6817.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
    ...
    if (GALGAS_bool (kIsEqual, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (166)).isValidAndTrue ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_nonterminalLabelMap enumerator_7109 (objectArray_5705->mAttribute_mLabelMap, true) ;
      cEnumerator_nonterminalLabelMap enumerator_7142 (constinArgument_inNonterminalLabelMap, true) ;
      //--- simple foreach instruction
      while (enumerator_7109.hasCurrentObject () && enumerator_7142.hasCurrentObject ()) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_formalParameterSignature enumerator_7245 (enumerator_7142.current_mSignature (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_7245.hasCurrentObject ()) {
          //-------- @addAssignInstructionForGeneration
          var_newSignature.addAssign_operation (enumerator_7245.current_mFormalArgumentType (HERE), enumerator_7245.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (170)) ;
          enumerator_7245.gotoNextObject () ;
        }
        { //-------- @routineCallInstructionForGeneration
        routine_checkMethodSignatures (enumerator_7109.current_mSignatureForGeneration (HERE), enumerator_7109.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_7142.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (172)) ;
        } //-------- @routineCallInstructionForGeneration
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonterminalDeclarationListAST enumerator_8107 (constinArgument_inNonterminalDeclarationList, true) ;
  //--- simple foreach instruction
  while (enumerator_8107.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_nonTerminalLabelListAST enumerator_8188 (enumerator_8107.current_mLabels (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_8188.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_8358 (enumerator_8188.current_mFormalArgumentList (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_8358.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_8358.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
        //-------- @addAssignInstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_8358.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_8358.current_mFormalArgumentName (HERE), enumerator_8358.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
        //-------- @addAssignInstructionForGeneration
        var_signature.addAssign_operation (var_t, enumerator_8358.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (202)) ;
        enumerator_8358.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_8188.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_8188.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_8188.gotoNextObject () ;
    }
    { //-------- @routineCallInstructionForGeneration
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_8107.current_mNonterminalName (HERE), var_nonterminalLabelMap, enumerator_8107.current_mHasParseLabel (HERE), outArgument_outNonterminalDeclarationMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_19104 (constinArgument_inSyntaxInstructionListAST, true) ;
  //--- simple foreach instruction
  while (enumerator_19104.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_19104.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListForGeneration enumerator_38440 (outArgument_outSignatureForGeneration, true) ;
  //--- simple foreach instruction
  while (enumerator_38440.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    outArgument_outSignature.addAssign_operation (enumerator_38440.current_mFormalArgumentType (HERE), enumerator_38440.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (992)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_38749 (constinArgument_inSyntaxInstructionList, true) ;
  //--- simple foreach instruction
  while (enumerator_38749.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_38749.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (998)) ;
    //-------- END @methodCallInstructionForGeneration
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_40141 (constinArgument_inRuleList, true) ;
  //--- simple foreach instruction
  while (enumerator_40141.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_40225 (enumerator_40141.current_mLabelList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_40225.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_40392 (enumerator_40225.current_mFormalArguments (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_40392.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_40392.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
        //-------- @addAssignInstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_40392.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_40392.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_40392.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1044)) ;
        //-------- @addAssignInstructionForGeneration
        var_signature.addAssign_operation (var_type, enumerator_40392.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1045)) ;
        enumerator_40392.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_40225.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_40225.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1047)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_40225.gotoNextObject () ;
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_nonterminalMap * objectArray_40858 = (const cMapElement_nonterminalMap *) var_nonterminalMap.readAccessForWithInstruction_hasKey (enumerator_40141.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1049))) ;
    if (NULL != objectArray_40858) {
        macroValidSharedObject (objectArray_40858, const cMapElement_nonterminalMap) ;
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40141.current_mNonterminalName (HERE), var_nonterminalLabelMap, objectArray_40858->mAttribute_mHasParseLabel, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1050)) ;
      } //-------- @routineCallInstructionForGeneration
    }else{
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40141.current_mNonterminalName (HERE), var_nonterminalLabelMap, GALGAS_bool (false), var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1052)) ;
      } //-------- @routineCallInstructionForGeneration
    }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_41486 (constinArgument_inRuleList, true) ;
  //--- simple foreach instruction
  while (enumerator_41486.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_41643 (enumerator_41486.current_mLabelList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_41643.hasCurrentObject ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      { //-------- @routineCallInstructionForGeneration
      routine_semanticAnalysisOfRuleLabel (enumerator_41643.current_mFormalArguments (HERE), enumerator_41643.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_41643.current_mEndOfInstructionList (HERE), var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1074)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_ruleLabelImplementationList.addAssign_operation (enumerator_41643.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_41643.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1088)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_42583_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_41486.current_mNonterminalName (HERE), joker_42583_0, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1098)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_ruleDeclarationList.addAssign_operation (enumerator_41486.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1100)), var_newRuleIndex, var_ruleLabelImplementationList, var_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1099)) ;
    //-------- @incrementInstructionForGeneration
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)) ;
    enumerator_41486.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (GALGAS_bool (true), constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (1108)) ;
}
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (GALGAS_bool (kIsEqual, object->mAttribute_mLabelName.reader_string (SOURCE_FILE_AT_LINE (264)).objectCompare (GALGAS_string ("parse"))).isValidAndTrue ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_formalParameterListForGeneration joker_11425_0 ; // Joker input parameter
    GALGAS_location joker_11439_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_11425_0, var_signature, joker_11439_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13044 (var_parameterCppNameList, true) ;
  //--- simple foreach instruction
  while (enumerator_13044.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13044.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (317)) COMMA_SOURCE_FILE_AT_LINE (317)) ;
  ...
  if (constinArgument_inGenerateCheckValid.isValidAndTrue ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_13349 (var_inputVariableList, true) ;
    //--- simple foreach instruction
    while (enumerator_13349.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_13349.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (325)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13559 (var_jokerParametersToReleaseList, true) ;
  //--- simple foreach instruction
  while (enumerator_13559.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13559.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualInputParameterListAST enumerator_14844 (object->mAttribute_mActualInputParameterList, true) ;
  cEnumerator_lexicalSentValueList enumerator_14865 (var_sentAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_14844.hasCurrentObject () && enumerator_14865.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, enumerator_14844.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (362)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_type ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_cppName ;
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsStrictSup, enumerator_14844.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (365)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        var_cppName = GALGAS_string ("var_").operator_concat (enumerator_14844.current_mActualParameterName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)) ;
        //-------- @assignmentInstructionForGeneration
        var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_14844.current_mActualParameterTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (enumerator_14844.current_mActualParameterName (HERE), var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (368)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }else{
        { //-------- @modifierCallInstructionForGeneration
        GALGAS_string joker_15445_0 ; // Joker input parameter
        ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_14844.current_mActualParameterName (HERE), var_type, var_cppName, joker_15445_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (370)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_expectedType ;
      //------- @switchInstructionForGeneration
      if (enumerator_14865.current_mLexicalType (HERE).isValid ()) {
        switch (enumerator_14865.current_mLexicalType (HERE).enumValue ()) {
      ...
      if (GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_14844.current_mActualParameterName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_14844.current_mActualParameterName (HERE).reader_string (SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
      }
      //-------- @addAssignInstructionForGeneration
      var_terminalCheckAssignementList.addAssign_operation (enumerator_14844.current_mActualParameterTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (389)), var_cppName, enumerator_14865.current_mLexicalAttributeName (HERE) COMMA_SOURCE_FILE_AT_LINE (388)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_terminalCheckAssignementList enumerator_17355 (object->mAttribute_mTerminalCheckAssignementList, true) ;
  //--- simple foreach instruction
  while (enumerator_17355.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, enumerator_17355.current_mTypeName (HERE).objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_17355.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)) ;
    }
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_17355.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (enumerator_17355.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (419)) ;
  ...
  if (constinArgument_inGenerateCheckValid.isValidAndTrue ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalCheckAssignementList enumerator_18238 (object->mAttribute_mTerminalCheckAssignementList, true) ;
    //--- simple foreach instruction
    while (enumerator_18238.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_18238.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (432)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (432)) COMMA_SOURCE_FILE_AT_LINE (432)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_20577 (object->mAttribute_mRepeatBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_20577.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_20577.current_mSyntaxInstructionList (HERE), enumerator_20577.current_mEndOf_5F_instructions (HERE), ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_20577.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (518)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_22416 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  GALGAS_uint index_22410 ((PMUInt32) 0) ;
  while (enumerator_22416.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_22410.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (555)).reader_string (SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_22416.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @appendInstructionForGeneration
    ...
    index_22410.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (554)) ;
  }
  //-------- @appendInstructionForGeneration
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_23702 (object->mAttribute_mSelectBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_23702.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_23702.current_mSyntaxInstructionList (HERE), enumerator_23702.current_mEndOf_5F_instructions (HERE), ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (593)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_23702.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (605)) ;
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_25074 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  GALGAS_uint index_25068 ((PMUInt32) 0) ;
  while (enumerator_25074.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_25068.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (629)).reader_string (SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_25074.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (630)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @appendInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (637)) ;
    enumerator_25074.gotoNextObject () ;
    index_25068.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
  }
  //-------- @appendInstructionForGeneration
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_26160 (object->mAttribute_mParseRewindBranchList, true) ;
  //--- simple foreach instruction
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_location joker_26973_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_26973_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (679)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_27154 (var_tempListOfBranches, true) ;
  //--- complex foreach instruction
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_27154.hasCurrentObject () && bool_0) {
    while (enumerator_27154.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (enumerator_27154.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (685)), enumerator_27154.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
      enumerator_27154.gotoNextObject () ;
      if (enumerator_27154.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28271 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  while (enumerator_28271.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_28271.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
    } //-------- @routineCallInstructionForGeneration
    if (enumerator_28271.hasNextObject ()) {
      //-------- @appendInstructionForGeneration
