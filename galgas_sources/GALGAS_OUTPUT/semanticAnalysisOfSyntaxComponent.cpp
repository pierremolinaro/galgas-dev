...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_5778 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (140))) ;
  if (NULL != objectArray_5778) {
      macroValidSharedObject (objectArray_5778, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_5778->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE_AT_LINE (141)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_stringset enumerator_6178 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_6178.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6178.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
    ...
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_6558 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_6558.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6558.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)) ;
    ...
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_6852 (objectArray_5778->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_6875 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_6852.hasCurrentObject () && enumerator_6875.hasCurrentObject ()) {
        ...
        cEnumerator_formalParameterSignature enumerator_6977 (enumerator_6875.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_6977.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_6977.current_mFormalArgumentType (HERE), enumerator_6977.current_mFormalArgumentPassingMode (HERE), enumerator_6977.current_mFormalArgumentName (HERE) COMMA_SOURCE_FILE_AT_LINE (167)) ;
          enumerator_6977.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_6852.current_mSignatureForGeneration (HERE), enumerator_6852.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_6875.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
        }
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_7843 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_7843.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_7924 (enumerator_7843.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_7924.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_8094 (enumerator_7924.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_8094.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_8094.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_8094.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_8094.current_mFormalArgumentName (HERE), enumerator_8094.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)) ;
        var_signature.addAssign_operation (var_t, enumerator_8094.current_mFormalArgumentPassingMode (HERE), enumerator_8094.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (199)) ;
        enumerator_8094.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_7924.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_7924.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (201)) ;
      }
      enumerator_7924.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_7843.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (203)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_syntaxInstructionList enumerator_32556 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_32556.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_32556.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) ;
    enumerator_32556.gotoNextObject () ;
  }
  {
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_54793 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_54793.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_54793.current_mFormalArgumentType (HERE), enumerator_54793.current_mFormalArgumentPassingMode (HERE), enumerator_54793.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1396)) ;
  ...
  cEnumerator_syntaxInstructionList enumerator_55131 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_55131.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_55131.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1402)) ;
    enumerator_55131.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_56660 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_56660.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_56744 (enumerator_56660.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_56744.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_56911 (enumerator_56744.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_56911.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_56911.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1452)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_56911.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_56911.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_56911.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1453)) COMMA_SOURCE_FILE_AT_LINE (1453)) COMMA_SOURCE_FILE_AT_LINE (1453)) ;
        var_signature.addAssign_operation (var_type, enumerator_56911.current_mFormalArgumentPassingMode (HERE), enumerator_56911.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1454)) ;
        enumerator_56911.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_56744.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_56744.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1456)) ;
      }
      enumerator_56744.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_56660.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1459)) ;
    }
    enumerator_56660.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1468)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1470)) COMMA_SOURCE_FILE_AT_LINE (1465)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1474)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_58054 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58054.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1477)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_58238_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58054.current_mNonterminalName (HERE), joker_58238_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1479)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_58265 (enumerator_58054.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_58265.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_58265.current_mFormalArguments (HERE), enumerator_58265.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_58265.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1485)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_58265.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_58265.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1501)) ;
      enumerator_58265.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_59236_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58054.current_mNonterminalName (HERE), joker_59236_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1510)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_58054.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1512)), var_newRuleIndex, var_ruleLabelImplementationList COMMA_SOURCE_FILE_AT_LINE (1511)) ;
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1516)) ;
    enumerator_58054.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (GALGAS_bool (true), constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature COMMA_SOURCE_FILE_AT_LINE (1519)) ;
}
...
GALGAS_syntaxDeclarationForGeneration GALGAS_syntaxDeclarationForGeneration::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
  ...
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mComponentName.isValid () && inAttribute_mLexiqueName.isValid () && inAttribute_mNonterminalDeclarationMap.isValid () && inAttribute_mRuleDeclarationList.isValid () && inAttribute_mSelectMethodCount.isValid () && inAttribute_mHasIndexing.isValid () && inAttribute_mHasTranslateFeature.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_syntaxDeclarationForGeneration (inAttribute_mIsGlobal, inAttribute_mComponentName, inAttribute_mLexiqueName, inAttribute_mNonterminalDeclarationMap, inAttribute_mRuleDeclarationList, inAttribute_mSelectMethodCount, inAttribute_mHasIndexing, inAttribute_mHasTranslateFeature COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_syntaxDeclarationForGeneration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_syntaxDeclarationForGeneration (p->mAttribute_mIsGlobal, p->mAttribute_mComponentName, p->mAttribute_mLexiqueName, p->mAttribute_mNonterminalDeclarationMap, p->mAttribute_mRuleDeclarationList, p->mAttribute_mSelectMethodCount, p->mAttribute_mHasIndexing, p->mAttribute_mHasTranslateFeature COMMA_THERE)) ;
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_11030_0 ; // Joker input parameter
    GALGAS_location joker_11044_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_11030_0, var_signature, joker_11044_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (267)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_stringlist enumerator_13132 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_13132.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13132.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (327)) COMMA_SOURCE_FILE_AT_LINE (327)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_stringlist enumerator_13746 (var_inputVariableList, kEnumeration_up) ;
    while (enumerator_13746.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_13746.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (344)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_SOURCE_FILE_AT_LINE (344)) ;
  ...
  cEnumerator_stringlist enumerator_13956 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_13956.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13956.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_15434_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_15434_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (388)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_21756_0 ; // Joker input parameter
  GALGAS_string joker_21759_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_21756_0, joker_21759_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (521)) ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_28354 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_28373 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_28354.hasCurrentObject () && enumerator_28373.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_28354.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_28373.current_mLexicalType (HERE), enumerator_28373.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (672)) ;
    enumerator_28354.gotoNextObject () ;
    enumerator_28373.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_28608 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_28608.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_28608.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (682)).operator_not (SOURCE_FILE_AT_LINE (682)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_28721 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_28721.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_28721.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)) ;
        enumerator_28721.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_28608.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_28608.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (687)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)) ;
    }
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_30048 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_30048.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_30048.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_30048.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_30048.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (728)) COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (enumerator_30048.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (728)) ;
    enumerator_30048.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_30449 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_30449.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_") COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (object->mAttribute_mLexiqueIdentifier COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string ("::kIndexing_") COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (enumerator_30449.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_terminalCheckAssignementList enumerator_31628 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    while (enumerator_31628.hasCurrentObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_31628.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)) ;
      enumerator_31628.gotoNextObject () ;
    }
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_34189 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_34189.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_34189.current_mSyntaxInstructionList (HERE), enumerator_34189.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (840)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_34189.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (854)) ;
    enumerator_34189.gotoNextObject () ;
  }
  {
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_36176 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_36132 ((uint32_t) 0) ;
  while (enumerator_36176.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_36132.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (893)).reader_string (SOURCE_FILE_AT_LINE (893)) COMMA_SOURCE_FILE_AT_LINE (893)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (893)) COMMA_SOURCE_FILE_AT_LINE (893)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_36176.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (894)) ;
    }
    ...
    index_36132.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_37576 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_37576.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_37576.current_mSyntaxInstructionList (HERE), enumerator_37576.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_37576.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (948)) ;
    enumerator_37576.gotoNextObject () ;
  }
  {
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_39049 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_39005 ((uint32_t) 0) ;
  while (enumerator_39049.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_39005.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (973)).reader_string (SOURCE_FILE_AT_LINE (973)) COMMA_SOURCE_FILE_AT_LINE (973)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (973)) COMMA_SOURCE_FILE_AT_LINE (973)) ;
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_39049.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (974)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (982)) ;
    enumerator_39049.gotoNextObject () ;
    index_39005.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_40249 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_40249.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_40415 (enumerator_40249.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_40415.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_40415.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      enumerator_40415.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_40249.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (1023)) ;
    enumerator_40249.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_41119_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_41119_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_41304 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_41304.hasCurrentObject () && bool_0) {
    while (enumerator_41304.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_41304.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1034)), enumerator_41304.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1032)) ;
      enumerator_41304.gotoNextObject () ;
      if (enumerator_41304.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42484 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_42484.hasCurrentObject ()) {
    {
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_42484.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    }
    if (enumerator_42484.hasNextObject ()) {
