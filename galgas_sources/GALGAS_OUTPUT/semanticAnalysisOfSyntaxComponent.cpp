...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 819)) ;
  {
  ioArgument_ioVariableMap.modifier_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 821)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_33512 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_33512.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_33512.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 824)) ;
    enumerator_33512.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 838)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1429)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1430)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1437)) ;
  cEnumerator_formalParameterListForGeneration enumerator_55896 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_55896.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_55896.current_mFormalArgumentType (HERE), enumerator_55896.current_mFormalArgumentPassingMode (HERE), enumerator_55896.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1439)) ;
    enumerator_55896.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1442)) ;
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1443)) ;
  cEnumerator_syntaxInstructionList enumerator_56234 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_56234.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_56234.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1445)) ;
    enumerator_56234.gotoNextObject () ;
  }
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1459)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1482)) ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1483)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_57763 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_57763.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_57847 (enumerator_57763.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_57847.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1492)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1493)) ;
      cEnumerator_formalParameterListAST enumerator_58014 (enumerator_57847.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_58014.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_58014.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1495)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_58014.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_58014.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_58014.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1496))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1496))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1496)) ;
        var_signature.addAssign_operation (var_type, enumerator_58014.current_mFormalArgumentPassingMode (HERE), enumerator_58014.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1497)) ;
        enumerator_58014.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_57847.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_57847.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1499)) ;
      }
      enumerator_57847.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_57763.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1501)) ;
    }
    enumerator_57763.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1507)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1509))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1504)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1513)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_58963 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58963.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1516)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_59147_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58963.current_mNonterminalName (HERE), joker_59147_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1518)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59174 (enumerator_58963.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59174.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59174.current_mFormalArguments (HERE), enumerator_59174.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59174.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1524)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59174.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59174.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1540)) ;
      enumerator_59174.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_60145_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58963.current_mNonterminalName (HERE), joker_60145_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1549)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_58963.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1551)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1550)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1555)) ;
    enumerator_58963.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1558)) ;
}
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  {
  routine_analyzeRoutineArguments (constinArgument_inAnalysisContext, object->mAttribute_mNonterminalName, GALGAS_string ("'<").operator_concat (object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 317))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 317)).operator_concat (GALGAS_string (">' nonterminal declaration")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 317)), var_signature, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, var_actualParameterListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 314)) ;
  }
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 324)) ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_nonterminalInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mNonterminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 332)), object->mAttribute_mLabelName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 333)), var_actualParameterListForGeneration, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 330))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 330)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_stringlist var_parameterCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 349)) ;
  GALGAS_stringlist var_jokerParametersToReleaseList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 350)) ;
  GALGAS_stringlist var_inputVariableList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 351)) ;
  cEnumerator_actualParameterListForGeneration enumerator_13673 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  while (enumerator_13673.hasCurrentObject ()) {
    GALGAS_string var_parameterCppName ;
    callCategoryMethod_generateActualParameter ((const cPtr_actualParameterForGeneration *) enumerator_13673.current_mActualParameter (HERE).ptr (), ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioGeneratedCode, var_jokerParametersToReleaseList, var_inputVariableList, ioArgument_ioUnusedVariableCppNameSet, var_parameterCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 353)) ;
    var_parameterCppNameList.addAssign_operation (var_parameterCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 362)) ;
    enumerator_13673.gotoNextObject () ;
  }
  GALGAS_string var_sdtResultVarName = GALGAS_string ("syntaxDirectedTranslationResult_").operator_concat (object->mAttribute_mInstructionLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 365)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 365))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 365)) ;
  const enumGalgasBool test_0 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("C_String ").operator_concat (var_sdtResultVarName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 367)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 367))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 367)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("nt_").operator_concat (object->mAttribute_mNonterminalName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369)).operator_concat (object->mAttribute_mLabelName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 369)) ;
  cEnumerator_stringlist enumerator_14422 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_14422.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14422.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 371))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 371)) ;
  ...
  if (kBoolTrue == test_1) {
    ioArgument_ioGeneratedCode.dotAssign_operation (var_sdtResultVarName.operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 374))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 374)) ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 376)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 376)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 377)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 377))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 377)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, var_sdtResultVarName, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 378)) ;
  cEnumerator_stringlist enumerator_14979 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_14979.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14979.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 386))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 386)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_16457_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_16457_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 424)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 437))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 437)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 437)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 437))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 437)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 437)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 438))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 438)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 438))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 436)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (GALGAS_string::makeEmptyString (), var_cppName, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 441)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 470)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 473))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 473)).operator_concat (GALGAS_string ("' formal argument has the '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 473)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 473))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 473)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 473)).operator_concat (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 474))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 474)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 474))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 472)) ;
    }
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 479))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 479)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_expectedType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 480)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 482)), var_cppName, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 481)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_inputParameterDeclaredConstant_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualParameterTypeName.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 510)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 513))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 513)).operator_concat (GALGAS_string ("' formal argument has the '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 513)).operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 513))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 513)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 513)).operator_concat (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 514))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 514)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 514))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 512)) ;
    }
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 519))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 519)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_expectedType, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 520)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (var_expectedType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 523)), var_cppName, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 522)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationDropResult_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 553)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 554)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 565)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 566)) ;
  }
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_23024_0 ; // Joker input parameter
  GALGAS_string joker_23027_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_23024_0, joker_23027_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 568)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 572))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 572)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 572)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 572))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 572)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 572)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 573))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 573)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 573))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 571)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 585)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 586)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 588))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 588)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 589)) ;
  {
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 590)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 594))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 594)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 594)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 594))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 594)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 594)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 595))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 595)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 595))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 593)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 607)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 608)) ;
  }
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 610))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 610)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mActualParameterTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 611)) ;
  {
  ioArgument_ioVariableMap.modifier_insertLocalConstant (object->mAttribute_mActualParameterName, var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 612)) ;
  }
  GALGAS_unifiedTypeMapProxy var_expectedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_expectedType.objectCompare (var_type)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mActualParameterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (object->mAttribute_mActualParameterName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 616))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 616)).operator_concat (GALGAS_string ("' parameter has the '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 616)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 616))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 616)).operator_concat (GALGAS_string (", bit an '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 616)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 617))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 617)).operator_concat (GALGAS_string ("' parameter is required here")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 617))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 615)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultNone_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * /* inObject */,
  ...
  const enumGalgasBool test_0 = constinArgument_inGenerateSyntaxDirectedTranslationString.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 640)).operator_concat (GALGAS_string (" << ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 640)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 640)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 640))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 640)) ;
    {
    ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 641)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 641)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInVar * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInVar *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInVar) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 663))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 663)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (var_cppName.operator_concat (GALGAS_string (" = GALGAS_string (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 664)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 664)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 664))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 664)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 675))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 675)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_string ").operator_concat (var_cppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 676)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 676)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 676)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 676))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 676)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst * object = (const cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst *) inObject ;
  macroValidSharedObject (object, cPtr_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst) ;
  GALGAS_string var_cppName = GALGAS_string ("var_").operator_concat (object->mAttribute_mActualParameterName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 687))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 687)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const GALGAS_string ").operator_concat (var_cppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 688)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 688)).operator_concat (constinArgument_inAccessMethodName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 688)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 688))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 688)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inTerminalMap.method_searchKey (object->mAttribute_mTerminalName, var_sentAttributeList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 705)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 707)).objectCompare (var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 707)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 710)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 713)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("naming the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709)).operator_concat (GALGAS_string ("$' requires ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709)).operator_concat (var_sentAttributeList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709)).operator_concat (GALGAS_string ("parameter")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 709)).operator_concat (temp_1  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 710)).operator_concat (GALGAS_string (", but this instruction names ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 710)).operator_concat (object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 712)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 712))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 711)).operator_concat (GALGAS_string (" parameter")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 712)).operator_concat (temp_3  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 712))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 708)) ;
  }
  GALGAS_terminalCheckAssignementList var_terminalCheckAssignementList = GALGAS_terminalCheckAssignementList::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 717)) ;
  cEnumerator_actualInputParameterListAST enumerator_29621 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_29640 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_29621.hasCurrentObject () && enumerator_29640.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_29621.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_29640.current_mLexicalType (HERE), enumerator_29640.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 719)) ;
    enumerator_29621.gotoNextObject () ;
    enumerator_29640.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_29875 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_29875.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_29875.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 729)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 729)).operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 729)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_29988 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_29988.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_29988.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 732)) ;
        enumerator_29988.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_29875.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_29875.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 734))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 734)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 734)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 734))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 734)) ;
    }
    enumerator_29875.gotoNextObject () ;
  }
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 738)) ;
  callCategoryMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 743)) ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_terminalCheckInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTerminalName, constinArgument_inLexiqueName, var_terminalCheckAssignementList, object->mAttribute_mIndexingKeyList, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 749))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 749)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_terminalCheckAssignementList enumerator_31321 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  while (enumerator_31321.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_31321.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_31321.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 772))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 772)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 772))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 772)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_31321.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 775)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 775))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 775)).operator_concat (GALGAS_string ("->synthetizedAttribute_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 775)).operator_concat (enumerator_31321.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 776))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 775)).operator_concat (GALGAS_string (" () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 776))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 775)) ;
    enumerator_31321.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_31722 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_31722.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781)).operator_concat (GALGAS_string ("->enterIndexing (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781)).operator_concat (GALGAS_string ("::kIndexing_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781)).operator_concat (enumerator_31722.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 781)) ;
    enumerator_31722.gotoNextObject () ;
  }
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->preceedingSeparatorString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 784)) ;
  callCategoryMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->tokenString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 790)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 797)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 797)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 798)).operator_concat (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 798)).operator_concat (object->mAttribute_mLexiqueIdentifier  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 798)).operator_concat (GALGAS_string ("::kToken_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 799)).operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 799))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 799)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 799)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mInstructionLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 800))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 800)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 800))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 798)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 856)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 858)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mRepeatedInstructionList, object->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_repeated_5F_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 861)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 876)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_35145 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_35145.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_35145.current_mSyntaxInstructionList (HERE), enumerator_35145.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 879)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_35145.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 893)) ;
    enumerator_35145.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_repeat_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 896)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOf_5F_repeat_5F_instruction, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 898))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 898)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_repeatFlagCppName = GALGAS_string ("repeatFlag_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 918))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 918)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 918)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 919)).operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 919))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 919)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 920)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 920))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 920)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_m_5F_repeated_5F_instructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 921)) ;
  }
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)).operator_concat (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_37126 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_37082 ((uint32_t) 0) ;
  while (enumerator_37126.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_37082.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 932)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 932))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 932)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 932))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 932)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_37126.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 933)) ;
    }
    ...
    index_37082.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 931)) ;
  }
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (var_repeatFlagCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944)).operator_concat (GALGAS_string (" = false ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 944)) ;
  ...
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 947)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 948)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_choiceIndex = ioArgument_ioSelectMethodCount ;
  ioArgument_ioSelectMethodCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 966)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 968)) ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 970)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_38521 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_38521.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_38521.current_mSyntaxInstructionList (HERE), enumerator_38521.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 973)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_38521.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 987)) ;
    enumerator_38521.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOf_5F_select_5F_instruction, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 990)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_selectInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, constinArgument_inComponentName, var_choiceIndex, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 991))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 991)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("switch (select_").operator_concat (object->mAttribute_mSyntaxComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (object->mAttribute_mChoiceIndex.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)).operator_concat (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_39993 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_39949 ((uint32_t) 0) ;
  while (enumerator_39993.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_39949.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1012)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1012))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1012)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1012))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1012)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_39993.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1013)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1021)) ;
    enumerator_39993.gotoNextObject () ;
    index_39949.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1011)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("default:\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1023)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1024)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1025)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1043)) ;
  GALGAS_uint var_referenceSelectMethodCount = ioArgument_ioSelectMethodCount ;
  cEnumerator_listOfSyntaxInstructionList enumerator_41188 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_41188.hasCurrentObject ()) {
    ioArgument_ioSelectMethodCount = var_referenceSelectMethodCount ;
    GALGAS_semanticInstructionListForGeneration var_instructionList = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1047)) ;
    cEnumerator_syntaxInstructionList enumerator_41354 (enumerator_41188.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_41354.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_41354.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1049)) ;
      enumerator_41354.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_41188.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1062)) ;
    enumerator_41188.gotoNextObject () ;
  }
  GALGAS_listOfSemanticInstructionListForGeneration var_tempListOfBranches = var_listOfSemanticInstructionListForGeneration ;
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_42058_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_42058_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1067)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1068)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42243 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_42243.hasCurrentObject () && bool_0) {
    while (enumerator_42243.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_42243.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1073)), enumerator_42243.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1071)) ;
      enumerator_42243.gotoNextObject () ;
      if (enumerator_42243.hasCurrentObject ()) {
        bool_0 = var_ok.isValidAndTrue () ;
      }
    }
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseRewindInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_listOfSemanticInstructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1078))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1078)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1094)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1094)) ;
  }
  GALGAS_string var_parsingContextVar = GALGAS_string ("parsingContext_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1095))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1095)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1095)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext ").operator_concat (var_parsingContextVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1096)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1096)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1096))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1096)).operator_concat (GALGAS_string ("->parsingContext () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1096))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1096)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_43422 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_43422.hasCurrentObject ()) {
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_43422.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1099)) ;
    }
    if (enumerator_43422.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1108)).operator_concat (GALGAS_string ("->setParsingContext (")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1108)).operator_concat (var_parsingContextVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1108)).operator_concat (GALGAS_string (") ; // rewind\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1108))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1108)) ;
    }
    enumerator_43422.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//-------- END OF @parseRewindInstructionForGeneration\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1110)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mVariantExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1130)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_variant_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1129)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mType (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1135)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfVariantExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1137)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1137))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1137)).operator_concat (GALGAS_string ("', but it should be '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1137)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1138))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1138)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1138))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1136)) ;
  }
  GALGAS_semanticExpressionForGeneration var_while_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhileExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1144)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_while_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1143)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mType (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1149)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfWhileExpression, GALGAS_string ("the variant expression type is '@").operator_concat (var_variant_5F_expression.reader_mType (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1151)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1151))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1151)).operator_concat (GALGAS_string ("', but it should be '@")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1151)).operator_concat (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1152))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1152)).operator_concat (GALGAS_string ("' type")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1152))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1150)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1157)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, object->mAttribute_mDoInstructionList, object->mAttribute_mEndOfInstructionList, constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1160)) ;
  }
  {
  ioArgument_ioVariableMap.modifier_closeOverride (object->mAttribute_mEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1175)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_parseLoopInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_variant_5F_expression, var_while_5F_expression, var_instructionList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1177))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1177)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1194)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1194)) ;
  }
  GALGAS_string var_variantVarCppName ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mVariantExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_variantVarCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1198)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_variantVarCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1200)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1200))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1200)) ;
  {
  ...
  GALGAS_string var_variantVar = GALGAS_string ("variant_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1202))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1202)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1202)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("uint32_t ").operator_concat (var_variantVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1203)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1203)).operator_concat (var_variantVarCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1203)).operator_concat (GALGAS_string (".uintValue () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1203))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1203)) ;
  GALGAS_string var_loopVar = GALGAS_string ("loop_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1205))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1205)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1205)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("bool ").operator_concat (var_loopVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1206)).operator_concat (GALGAS_string (" = true ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1206))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1206)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("while (").operator_concat (var_loopVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1207)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1207))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1207)) ;
  {
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVarCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1211)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_whileVarCppName  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1212)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1212))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1212)) ;
  {
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const C_parsingContext parsingContext = ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1216))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1216)).operator_concat (GALGAS_string ("->parsingContext () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1216))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1216)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1217)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1225)).operator_concat (GALGAS_string ("->setParsingContext (parsingContext) ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1225))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1225)) ;
  {
  ...
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1228)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1229)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1230)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1231)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("//--- 'parse'\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1233)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1236)), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1234)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1242)).operator_concat (GALGAS_string ("->resetTemplateString () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1242))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1242)) ;
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mWhenExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1263)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_when_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1262)) ;
  {
  ioArgument_ioVariableMap.modifier_openOverrideForRepeatBlock (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1269)) ;
  }
...
static void categoryMethod_parseWhenInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhenExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1333)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1334)).operator_concat (GALGAS_string (".isValidAndTrue ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1334))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1334)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1335)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1343)) ;
  {
  routine_generateInstructionList (ioArgument_ioInclusionSet, object->mAttribute_mElseInstructionList, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1344)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1352)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1369)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' instruction is only allowed when syntax componant has 'translate' feature")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1370)) ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1374)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1373)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1380)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("'send' expresion should be an @string expression")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1381)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_syntaxSendInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, var_expression  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1384))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1384)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_syntaxSendInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_sourceVar ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1399)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1401)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1401)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1402)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1402)).operator_concat (GALGAS_string ("  ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1402)).operator_concat (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1403))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1403)).operator_concat (GALGAS_string (" << ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1403)).operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1403)).operator_concat (GALGAS_string (".stringValue () ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1403)).operator_concat (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1403))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1402)) ;
}
//-----------------------------------------------------------------------------*
