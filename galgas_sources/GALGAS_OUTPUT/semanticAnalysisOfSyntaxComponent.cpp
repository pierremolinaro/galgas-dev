...
category_reader__syntaxDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_syntaxDeclarationForGeneration * operand_4444
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_4444 != NULL) {
var_cas_outHeader = template_filewrapper_syntaxFileGenerationTemplate_syntaxAnalyserClassDeclaration (inLexique, operand_4444->mComponentName, operand_4444->mLexiqueName, operand_4444->mNonterminalDeclarationMap, operand_4444->mRuleDeclarationList) ;
  }
...
void routine_enterNonterminalNonTerminalInMapAndCheck (C_Compiler & inLexique,
  ...
  #endif
elementOf_GGS_nonterminalDeclarationMap * operand_5313 = (elementOf_GGS_nonterminalDeclarationMap *) var_cas_ioNonterminalDeclarationMap.searchForReadWithInstruction (var_cas_inNonTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120))) ;
if (NULL != operand_5313) {
const GGS_bool cond_5701 = (operand_5313->mInfo.mHasParseLabel).operator_isNotEqual (var_cas_inHasParseLabel) ;
if (cond_5701.isBuiltAndTrue ()) {
var_cas_inNonTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '")).operator_concat (var_cas_inNonTerminalName)).operator_concat (GGS_string ("' is redeclared "))).operator_concat (((operand_5313->mInfo.mHasParseLabel).isBuiltAndTrue () ? (GGS_string ("with")) : (GGS_string ("without"))))).operator_concat (GGS_string (" 'parse' label, but first declaration declares it "))).operator_concat (((var_cas_inHasParseLabel).isBuiltAndTrue () ? (GGS_string ("with")) : (GGS_string ("without"))))).operator_concat (GGS_string (" 'parse' label")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
}
const GGS_stringset  var_cas_firstDeclarationLabelSet = operand_5313->mInfo.mLabelMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
const GGS_stringset  var_cas_reDeclarationLabelSet = var_cas_inNonterminalLabelMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
const GGS_stringset  var_cas_missingLabelSet = var_cas_firstDeclarationLabelSet.substract_operation (inLexique, var_cas_reDeclarationLabelSet COMMA_SOURCE_FILE_AT_LINE (132)) ;
const GGS_bool cond_6244 = (var_cas_missingLabelSet.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_6244.isBuiltAndTrue ()) {
GGS_string var_cas_s = GGS_string ("") ;
{
GGS_stringset::cEnumerator enumerator_6042 (var_cas_missingLabelSet, true) ;
while (enumerator_6042.hasCurrentObject ()) {
  var_cas_s.appendCString ("\n"
    "-  ") ;
  var_cas_s.dotAssign_operation (enumerator_6042._key (HERE)) ;
  enumerator_6042.next () ;
}
}
var_cas_inNonTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("the '")).operator_concat (var_cas_inNonTerminalName)).operator_concat (GGS_string ("' nonterminal is redeclared without the following label(s):"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (141)) ;
}
const GGS_stringset  var_cas_newLabelSet = var_cas_reDeclarationLabelSet.substract_operation (inLexique, var_cas_firstDeclarationLabelSet COMMA_SOURCE_FILE_AT_LINE (142)) ;
const GGS_bool cond_6615 = (var_cas_newLabelSet.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_6615.isBuiltAndTrue ()) {
GGS_string var_cas_s = GGS_string ("") ;
{
GGS_stringset::cEnumerator enumerator_6422 (var_cas_newLabelSet, true) ;
while (enumerator_6422.hasCurrentObject ()) {
  var_cas_s.appendCString ("\n"
    "-  ") ;
  var_cas_s.dotAssign_operation (enumerator_6422._key (HERE)) ;
  enumerator_6422.next () ;
}
}
var_cas_inNonTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("the '")).operator_concat (var_cas_inNonTerminalName)).operator_concat (GGS_string ("' nonterminal is redeclared with the new label(s):"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (151)) ;
}
const GGS_bool cond_7138 = ((var_cas_missingLabelSet.reader_count ()).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_newLabelSet.reader_count ()).operator_isEqual (GGS_uint (0U))) ;
if (cond_7138.isBuiltAndTrue ()) {
{
GGS_nonterminalLabelMap::cEnumerator enumerator_6716 (operand_5313->mInfo.mLabelMap, true) ;
const GGS_nonterminalLabelMap::cElement * operand_6716 = NULL ;
GGS_nonterminalLabelMap::cEnumerator enumerator_6739 (var_cas_inNonterminalLabelMap, true) ;
const GGS_nonterminalLabelMap::cElement * operand_6739 = NULL ;
while (((operand_6716 = enumerator_6716.nextObject ()))
    && ((operand_6739 = enumerator_6739.nextObject ()))) {
  macroValidPointer (operand_6716) ;
  macroValidPointer (operand_6739) ;
  GGS_formalParameterSignature  var_cas_newSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_6850 (operand_6739->mInfo.mSignature, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_6850 = NULL ;
    while (((operand_6850 = enumerator_6850.nextObject ()))) {
      macroValidPointer (operand_6850) ;
      var_cas_newSignature.addAssign_operation (operand_6850->mFormalArgumentType, operand_6850->mFormalArgumentPassingMode) ;
    }
  }
  ::routine_checkMethodSignatures (inLexique,  operand_6716->mInfo.mSignature,  operand_6716->mInfo.mEndOfArgumentLocation,  var_cas_newSignature,  operand_6739->mInfo.mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (158)) ;
}
}
}
}else{
var_cas_ioNonterminalDeclarationMap.modifier_insertKey (inLexique, var_cas_inNonTerminalName, var_cas_inNonterminalLabelMap, var_cas_inHasParseLabel COMMA_SOURCE_FILE_AT_LINE (167)) ;
}
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildNonterminalDeclarationsMap (C_Compiler & inLexique,
  ...
  #endif
var_cas_outNonterminalDeclarationMap = GGS_nonterminalDeclarationMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (178)) ;
{
GGS_nonterminalDeclarationListAST::cEnumerator enumerator_7715 (var_cas_inNonterminalDeclarationList, true) ;
const GGS_nonterminalDeclarationListAST::cElement * operand_7715 = NULL ;
while (((operand_7715 = enumerator_7715.nextObject ()))) {
  macroValidPointer (operand_7715) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
{
GGS_nonTerminalLabelListAST::cEnumerator enumerator_7796 (operand_7715->mLabels, true) ;
const GGS_nonTerminalLabelListAST::cElement * operand_7796 = NULL ;
while (((operand_7796 = enumerator_7796.nextObject ()))) {
  ...
  {
    GGS_formalParameterListAST::cEnumerator enumerator_7897 (operand_7796->mFormalArgumentList, true) ;
    const GGS_formalParameterListAST::cElement * operand_7897 = NULL ;
    while (((operand_7897 = enumerator_7897.nextObject ()))) {
      macroValidPointer (operand_7897) ;
      const GGS_unifiedTypeMapProxy  var_cas_t = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_7897->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (185)) ;
      var_cas_signature.addAssign_operation (operand_7897->mFormalArgumentPassingMode, var_cas_t, operand_7897->mFormalArgumentName, operand_7897->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_7796->mLabelName, var_cas_signature, operand_7796->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (188)) ;
}
}
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_7715->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_7715->mHasParseLabel,  var_cas_outNonterminalDeclarationMap COMMA_SOURCE_FILE_AT_LINE (190)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__semanticInstructionAST__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_semanticInstructionAST * operand_9241,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9241 != NULL) {
GGS_semanticInstructionAST  var_cas_t = operand_9241 ;
{ typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (var_cas_t.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, var_cas_t (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (218)) ;
  }
}
  }
}
...
category_method__nonterminalCallInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_nonterminalCallInstruction * operand_9860,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
...
category_method__terminalCheckInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_10326,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10326 != NULL) {
inLexique.printMessage (GGS_string ("@terminalCheckInstruction\n") COMMA_SOURCE_FILE_AT_LINE (248)) ;
  }
}
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_10783,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10783 != NULL) {
inLexique.printMessage (GGS_string ("@repeatInstruction\n") COMMA_SOURCE_FILE_AT_LINE (260)) ;
  }
}
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_11233,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
...
inLexique.printMessage (GGS_string ("@selectInstruction\n") COMMA_SOURCE_FILE_AT_LINE (272)) ;
  }
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_11684,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_12138,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_12594,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_13046,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                GGS_semanticInstructionListForGeneration  & /* var_cas_ioInstructionListForGeneration */,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (336)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignature COMMA_SOURCE_FILE_AT_LINE (337)) ;
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_14385 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_14385 = NULL ;
while (((operand_14385 = enumerator_14385.nextObject ()))) {
  macroValidPointer (operand_14385) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_14385->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_14385->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_instructionListForGeneration, var_cas_variableMap, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (347)) ;
  }
}
}
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//Implementation of routine "buildContextFromRuleHeadersAndNonterminalDeclarations"*
//                                                                           *
//---------------------------------------------------------------------------*

void routine_buildContextFromRuleHeadersAndNonterminalDeclarations (C_Compiler & inLexique,
                                const GGS_nonterminalDeclarationListAST   var_cas_inNonterminalDeclarationList,
                        ...
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_buildContextFromRuleHeadersAndNonterminalDeclarations at %s:%d\n", __FILE__, __LINE__) ;
  #endif
GGS_nonterminalDeclarationMap  var_cas_nonterminalDeclarationMap = GGS_nonterminalDeclarationMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (372)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalDeclarationMap COMMA_SOURCE_FILE_AT_LINE (373)) ;
GGS_ruleIndexMap  var_cas_ruleIndexMap = GGS_ruleIndexMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (379)) ;
GGS_ruleDeclarationList  var_cas_ruleDeclarationList = GGS_ruleDeclarationList ::constructor_emptyList () ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_15693 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_15693 = NULL ;
while (((operand_15693 = enumerator_15693.nextObject ()))) {
  macroValidPointer (operand_15693) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (382)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_15777 (operand_15693->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_15777 = NULL ;
while (((operand_15777 = enumerator_15777.nextObject ()))) {
  macroValidPointer (operand_15777) ;
  GGS_formalParameterListForGeneration  var_cas_signature ;
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_15777->mFormalArguments,  operand_15777->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_signature COMMA_SOURCE_FILE_AT_LINE (385)) ;
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_15777->mLabelName, var_cas_signature, operand_15777->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (392)) ;
}
}
GGS_uint  var_cas_ruleIndex ;
elementOf_GGS_ruleIndexMap * operand_16158 = (elementOf_GGS_ruleIndexMap *) var_cas_ruleIndexMap.searchForReadWriteWithInstruction (operand_15693->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (395))) ;
if (NULL != operand_16158) {
var_cas_ruleIndex = operand_16158->mInfo.mRuleIndex ;
operand_16158->mInfo.mRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (397)) ;
}else{
var_cas_ruleIndexMap.modifier_insertKey (inLexique, operand_15693->mNonterminalName, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (399)) ;
var_cas_ruleIndex = GGS_uint (0U) ;
}
elementOf_GGS_nonterminalDeclarationMap * operand_16387 = (elementOf_GGS_nonterminalDeclarationMap *) var_cas_nonterminalDeclarationMap.searchForReadWithInstruction (operand_15693->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
if (NULL != operand_16387) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_15693->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_16387->mInfo.mHasParseLabel,  var_cas_nonterminalDeclarationMap COMMA_SOURCE_FILE_AT_LINE (403)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_15693->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalDeclarationMap COMMA_SOURCE_FILE_AT_LINE (405)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_15693->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407)), var_cas_ruleIndex, var_cas_nonterminalLabelMap) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalDeclarationMap, var_cas_ruleDeclarationList COMMA_SOURCE_FILE_AT_LINE (410)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_buildContextFromRuleHeadersAndNonterminalDeclarations\n") ;
  #endif
}
