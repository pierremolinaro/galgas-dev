...
const GGS_bool cond_14612 = (operand_13020->mActualParameterName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_14612.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_14599 = (var_cas_expectedType).operator_isNotEqual (var_cas_type) ;
  if (cond_14599.isBuiltAndTrue ()) {
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_15397 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_15397 = NULL ;
while (((operand_15397 = enumerator_15397.nextObject ()))) {
  macroValidPointer (operand_15397) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_15397->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_15397->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inNonterminalMap, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (366)) ;
  }
}
}
}
const GGS_bool cond_15904 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_15904.isBuiltAndTrue ()) {
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_16134,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_16134->mRepeatedInstructionList,  operand_16134->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (405)) ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_16978 (operand_16134->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_16978 = NULL ;
while (((operand_16978 = enumerator_16978.nextObject ()))) {
  macroValidPointer (operand_16978) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_16978->mSyntaxInstructionList,  operand_16978->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (419)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_16134->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (432)) ;
  }
}
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_17550,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_18028 (operand_17550->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_18028 = NULL ;
while (((operand_18028 = enumerator_18028.nextObject ()))) {
  macroValidPointer (operand_18028) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_18028->mSyntaxInstructionList,  operand_18028->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (453)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_17550->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (466)) ;
  }
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_18601,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_19054 (operand_18601->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_19054 = NULL ;
while (((operand_19054 = enumerator_19054.nextObject ()))) {
  macroValidPointer (operand_19054) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_19054->mSyntaxInstructionList,  operand_19054->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (486)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_18601->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (499)) ;
  }
}
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_19628,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19628 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_variant_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_19628->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_19628->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (516)) ;
  }
}
const GGS_bool cond_20461 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (522))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_20461.isBuiltAndTrue ()) {
operand_19628->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (524)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (524)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (525)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (527)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_19628->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_19628->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (530)) ;
  }
}
const GGS_bool cond_20948 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (536))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_20948.isBuiltAndTrue ()) {
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_19628->mDoInstructionList,  operand_19628->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (547)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_19628->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (559)) ;
  }
}
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_21592,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
{
GGS_whenBranchList::cEnumerator enumerator_22006 (operand_21592->mWhenBranchList, true) ;
const GGS_whenBranchList::cElement * operand_22006 = NULL ;
while (((operand_22006 = enumerator_22006.nextObject ()))) {
  macroValidPointer (operand_22006) ;
var_cas_localSelectMethodCount = var_cas_ioSelectMethodCount ;
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_22006->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_22006->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (580)) ;
  }
}
...
{
  GGS_syntaxInstructionList::cEnumerator enumerator_22382 (operand_22006->mParseDoBranchList, true) ;
  const GGS_syntaxInstructionList::cElement * operand_22382 = NULL ;
  while (((operand_22382 = enumerator_22382.nextObject ()))) {
    macroValidPointer (operand_22382) ;
    { typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_22382->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_22382->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inNonterminalMap, var_cas_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (588)) ;
      }
    }
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_22912,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_nonterminalMap   /* var_cas_inNonterminalMap */,
...
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_24422 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_24422 = NULL ;
while (((operand_24422 = enumerator_24422.nextObject ()))) {
  macroValidPointer (operand_24422) ;
var_cas_outSignature.addAssign_operation (operand_24422->mFormalArgumentType, operand_24422->mFormalArgumentPassingMode) ;
}
}
GGS_semanticInstructionListForGeneration  var_cas_instructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_24726 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_24726 = NULL ;
while (((operand_24726 = enumerator_24726.nextObject ()))) {
  macroValidPointer (operand_24726) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_24726->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_24726->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inNonterminalMap, var_cas_instructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (652)) ;
  }
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_26061 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_26061 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_26145 (operand_26061->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_26145 = NULL ;
while (((operand_26145 = enumerator_26145.nextObject ()))) {
  macroValidPointer (operand_26145) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_26312 (operand_26145->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_26312 = NULL ;
    while (((operand_26312 = enumerator_26312.nextObject ()))) {
      macroValidPointer (operand_26312) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_26312->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (695)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_26312->mFormalArgumentPassingMode, var_cas_type, operand_26312->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_26312->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_26312->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_26145->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_26145->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (699)) ;
}
}
elementOf_GGS_nonterminalMap * operand_26781 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_26061->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (701))) ;
if (NULL != operand_26781) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_26061->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_26781->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (702)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_26061->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (704)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_27245 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_27245 = NULL ;
while (((operand_27245 = enumerator_27245.nextObject ()))) {
  macroValidPointer (operand_27245) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_27385 (operand_27245->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_27385 = NULL ;
while (((operand_27385 = enumerator_27385.nextObject ()))) {
  ...
  GGS_formalParameterSignature  var_cas_signature ;
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_27385->mFormalArguments,  operand_27385->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_nonterminalMap,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature COMMA_SOURCE_FILE_AT_LINE (718)) ;
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_27385->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_27385->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (729)) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_28108_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_27245->mNonterminalName, automatic_var_28108_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (733)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_27245->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), var_cas_newRuleIndex, var_cas_nonterminalLabelMap, var_cas_hasParseLabel) ;
