...
if ((operand_27524 != NULL)) {
  ...
  if (_foreach_loop_27524) {
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (695)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (695))) ;
    var_cas_ioGeneratedCode.appendCString ("\n") ;
  }
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28089->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28089->mVariantExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (714)) ;
  }
}
const GGS_bool cond_28893 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (719))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mUIntType) ;
if (cond_28893.isBuiltAndTrue ()) {
operand_28089->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (721)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (721)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inAnalysisContext.mPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (722)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (724)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28089->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28089->mWhileExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (727)) ;
  }
}
const GGS_bool cond_29393 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (732))).operator_isNotEqual (var_cas_inAnalysisContext.mPredefinedTypes.mBoolType) ;
if (cond_29393.isBuiltAndTrue ()) {
operand_28089->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (734)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (734)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inAnalysisContext.mPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (735)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (737)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (740)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_28089->mDoInstructionList,  operand_28089->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (743)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_28089->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (756)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_28089->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (758))) ;
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34098->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34098->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (846)) ;
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34098->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34098->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (859)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (") ;
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_34098->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (865)) ;
...
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_34098->mInstructionList COMMA_SOURCE_FILE_AT_LINE (881)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (880)) ;
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                ...
                                GGS_uint  & var_cas_ioSelectMethodCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36673 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_36673->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_36673->mWhenExpression (HERE), var_cas_inAnalysisContext, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (904)) ;
  }
}
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_36673->mWhenInstructionList,  operand_36673->mEndOfWhenInstructionList,  var_cas_ioVariableMap,  var_cas_localSelectMethodCount,  var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (914)) ;
GGS_semanticInstructionListForGeneration  var_cas_else_instructionListForGeneration ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inAnalysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_36673->mElseInstructionList,  operand_36673->mEndOfElseInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (928)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_36673->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (941)) ;
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, function_syntaxSignatureOfInstructionList (inLexique, var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (944)), function_syntaxSignatureOfInstructionList (inLexique, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (945)), operand_36673->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (943)) ;
const GGS_bool cond_38638 = var_cas_ok ;
if (cond_38638.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_36673->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (950))) ;
}
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_38807->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_38807->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (968)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_sourceVar) ;
var_cas_ioGeneratedCode.appendCString (".isValidAndTrue ()) {\n") ;
::routine_generateInstructionList (inLexique,  operand_38807->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (970)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_38807->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (977)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_CompilerEx & inLexique,
                                ...
                                GGS_uint  & /* var_cas_ioSelectMethodCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39701 != NULL) {
operand_39701->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  }
}
...
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_41374 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_41374 = NULL ;
while (((operand_41374 = enumerator_41374.nextObject ()))) {
  macroValidPointer (operand_41374) ;
var_cas_outSignature.addAssign_operation (operand_41374->mFormalArgumentType, operand_41374->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_41683 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_41683 = NULL ;
while (((operand_41683 = enumerator_41683.nextObject ()))) {
  macroValidPointer (operand_41683) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_41683->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_41683->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  }
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43075 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43075 = NULL ;
while (((operand_43075 = enumerator_43075.nextObject ()))) {
  macroValidPointer (operand_43075) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43159 (operand_43075->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43159 = NULL ;
while (((operand_43159 = enumerator_43159.nextObject ()))) {
  macroValidPointer (operand_43159) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_43326 (operand_43159->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_43326 = NULL ;
    while (((operand_43326 = enumerator_43326.nextObject ()))) {
      macroValidPointer (operand_43326) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43326->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1083)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_43326->mFormalArgumentPassingMode, var_cas_type, operand_43326->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_43326->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_43326->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_43159->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43159->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1087)) ;
}
}
elementOf_GGS_nonterminalMap * operand_43795 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_43075->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1089))) ;
if (NULL != operand_43795) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43075->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_43795->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1090)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43075->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1092)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_44420 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_44420 = NULL ;
while (((operand_44420 = enumerator_44420.nextObject ()))) {
  macroValidPointer (operand_44420) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_44577 (operand_44420->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_44577 = NULL ;
while (((operand_44577 = enumerator_44577.nextObject ()))) {
  macroValidPointer (operand_44577) ;
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_44577->mFormalArguments,  operand_44577->mSyntaxInstructionList,  var_cas_analysisContext,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_44577->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1114)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_44577->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_44577->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_45536_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_44420->mNonterminalName, automatic_var_45536_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1138)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_44420->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1140)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
