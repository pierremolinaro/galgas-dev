...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1085)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1082)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1090)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_42178 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42178.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1093)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_42335 (enumerator_42178.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42335.hasCurrentObject ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      { //-------- @routineCallInstructionForGeneration
      routine_semanticAnalysisOfRuleLabel (enumerator_42335.current_mFormalArguments (HERE), enumerator_42335.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_42335.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_ruleLabelImplementationList.addAssign_operation (enumerator_42335.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_42335.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1115)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_43299_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_42178.current_mNonterminalName (HERE), joker_43299_0, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1125)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_ruleDeclarationList.addAssign_operation (enumerator_42178.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1127)), var_newRuleIndex, var_ruleLabelImplementationList, var_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    //-------- @incrementInstructionForGeneration
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1132)) ;
    enumerator_42178.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (GALGAS_bool (true), constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing COMMA_SOURCE_FILE_AT_LINE (1135)) ;
}
