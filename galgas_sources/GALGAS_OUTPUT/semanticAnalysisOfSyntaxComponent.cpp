...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementationGalgas_33_ (C_Compiler * /* inCompiler */,
  ...
  if (in_INCLUSION_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_146 (in_INCLUSION_5F_SET, kEnumeration_up) ;
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_7283 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 191))) ;
  if (NULL != objectArray_7283) {
      macroValidSharedObject (objectArray_7283, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_7283->mAttribute_mLabelMap.reader_keySet (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 192)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_stringset enumerator_7683 (var_missingLabelSet, kEnumeration_up) ;
      while (enumerator_7683.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_7683.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 198))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 198)) ;
    ...
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_8063 (var_newLabelSet, kEnumeration_up) ;
      while (enumerator_8063.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_8063.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 208))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 208)) ;
    ...
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_8357 (objectArray_7283->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_8380 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_8357.hasCurrentObject () && enumerator_8380.hasCurrentObject ()) {
        ...
        cEnumerator_formalParameterSignature enumerator_8482 (enumerator_8380.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_8482.hasCurrentObject ()) {
          var_newSignature.addAssign_operation (enumerator_8482.current_mFormalArgumentType (HERE), enumerator_8482.current_mFormalArgumentPassingMode (HERE), enumerator_8482.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 218)) ;
          enumerator_8482.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_8357.current_mSignatureForGeneration (HERE), enumerator_8357.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_8380.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 220)) ;
        }
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_9342 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_9342.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_9423 (enumerator_9342.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_9423.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_9593 (enumerator_9423.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_9593.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_9593.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 248)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_9593.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_9593.current_mFormalArgumentName (HERE), enumerator_9593.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 249))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 249)) ;
        var_signature.addAssign_operation (var_t, enumerator_9593.current_mFormalArgumentPassingMode (HERE), enumerator_9593.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 250)) ;
        enumerator_9593.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_9423.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_9423.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 252)) ;
      }
      enumerator_9423.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_9342.current_mNonterminalName (HERE), var_nonterminalLabelMap, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 254)) ;
    }
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_55750 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_55750.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_55750.current_mFormalArgumentType (HERE), enumerator_55750.current_mFormalArgumentPassingMode (HERE), enumerator_55750.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1432)) ;
  ...
  cEnumerator_syntaxInstructionList enumerator_56088 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_56088.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_56088.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1438)) ;
    enumerator_56088.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_57617 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_57617.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_57701 (enumerator_57617.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_57701.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_57868 (enumerator_57701.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_57868.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_57868.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1488)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_57868.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_57868.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_57868.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1489))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1489))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1489)) ;
        var_signature.addAssign_operation (var_type, enumerator_57868.current_mFormalArgumentPassingMode (HERE), enumerator_57868.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1490)) ;
        enumerator_57868.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_57701.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_57701.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1492)) ;
      }
      enumerator_57701.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_57617.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1494)) ;
    }
  ...
  cEnumerator_syntaxRuleListAST enumerator_58817 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58817.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_59001_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58817.current_mNonterminalName (HERE), joker_59001_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1511)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59028 (enumerator_58817.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59028.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59028.current_mFormalArguments (HERE), enumerator_59028.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59028.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1517)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59028.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59028.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1533)) ;
      enumerator_59028.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_59999_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_58817.current_mNonterminalName (HERE), joker_59999_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1542)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_58817.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1544)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1543)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1548)) ;
    enumerator_58817.gotoNextObject () ;
  }
...
static void categoryMethod_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 164)).isValid ()) {
    uint32_t variant_6318 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 164)).uintValue () ;
    bool loop_6318 = true ;
    while (loop_6318) {
      loop_6318 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).isValid () ;
      if (loop_6318) {
        loop_6318 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).boolValue () ;
      }
      if (loop_6318 && (0 == variant_6318)) {
        loop_6318 = false ;
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_formalParameterListForGeneration joker_12529_0 ; // Joker input parameter
    GALGAS_location joker_12543_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_12529_0, var_signature, joker_12543_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 318)) ;
  }
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_stringlist enumerator_14653 (var_parameterCppNameList, kEnumeration_up) ;
  while (enumerator_14653.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_14653.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 379))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 379)) ;
  ...
  cEnumerator_stringlist enumerator_15210 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  while (enumerator_15210.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_15210.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 394))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 394)) ;
...
static void categoryMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  {
  GALGAS_string joker_16688_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_16688_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 432)) ;
  }
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type ;
  {
  GALGAS_string joker_23010_0 ; // Joker input parameter
  GALGAS_string joker_23013_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, joker_23010_0, joker_23013_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 565)) ;
  }
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_actualInputParameterListAST enumerator_29607 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_29626 (var_sentAttributeList, kEnumeration_up) ;
  while (enumerator_29607.hasCurrentObject () && enumerator_29626.hasCurrentObject ()) {
    callCategoryMethod_analyzeInputParameter ((const cPtr_abstractInputParameter *) enumerator_29607.current_mInputParameter (HERE).ptr (), constinArgument_inAnalysisContext, enumerator_29626.current_mLexicalType (HERE), enumerator_29626.current_mLexicalAttributeName (HERE), var_terminalCheckAssignementList, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 716)) ;
    enumerator_29607.gotoNextObject () ;
    enumerator_29626.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_29861 (object->mAttribute_mIndexingKeyList, kEnumeration_up) ;
  while (enumerator_29861.hasCurrentObject ()) {
    const enumGalgasBool test_6 = constinArgument_inIndexNameSet.reader_hasKey (enumerator_29861.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 726)) COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 726)).operator_not (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 726)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_29974 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      while (enumerator_29974.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_29974.current_key (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 729))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 729)) ;
        enumerator_29974.gotoNextObject () ;
      }
      GALGAS_location location_7 (enumerator_29861.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (enumerator_29861.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 731))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 731)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 731)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 731))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 731)) ;
    }
    enumerator_29861.gotoNextObject () ;
  }
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_35131 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_35131.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_35131.current_mSyntaxInstructionList (HERE), enumerator_35131.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 876)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_35131.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 890)) ;
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_37112 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_37068 ((uint32_t) 0) ;
  while (enumerator_37112.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_37068.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 929)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_37112.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 930)) ;
    }
    ...
    index_37068.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 928)) ;
  }
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_38507 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_38507.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_38507.current_mSyntaxInstructionList (HERE), enumerator_38507.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 970)) ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_38507.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 984)) ;
    enumerator_38507.gotoNextObject () ;
  }
  {
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_39979 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  GALGAS_uint index_39935 ((uint32_t) 0) ;
  while (enumerator_39979.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_39935.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)).operator_concat (GALGAS_string (": {\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1009)) ;
    {
    routine_generateInstructionList (ioArgument_ioInclusionSet, enumerator_39979.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1010)) ;
    }
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n")  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1018)) ;
    enumerator_39979.gotoNextObject () ;
    index_39935.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1008)) ;
  }
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_41174 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  while (enumerator_41174.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxInstructionList enumerator_41340 (enumerator_41174.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_41340.hasCurrentObject ()) {
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_41340.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1046)) ;
      enumerator_41340.gotoNextObject () ;
    }
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_41174.current_mEndOf_5F_instructions (HERE)  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1059)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  {
  GALGAS_location joker_42044_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_42044_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1064)) ;
  }
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_42229 (var_tempListOfBranches, kEnumeration_up) ;
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_42229.hasCurrentObject () && bool_0) {
    while (enumerator_42229.hasCurrentObject () && bool_0) {
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_42229.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1070)), enumerator_42229.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1068)) ;
      enumerator_42229.gotoNextObject () ;
      if (enumerator_42229.hasCurrentObject ()) {
