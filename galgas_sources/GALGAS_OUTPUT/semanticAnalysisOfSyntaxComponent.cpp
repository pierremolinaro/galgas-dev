...
var_cas_ioGeneratedCode.dotAssign_operation (operand_12531->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (329)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (329))) ;
var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
{
GGS_stringlist::cEnumerator enumerator_13642 (var_cas_jokerParametersToReleaseList, true) ;
const GGS_stringlist::cElement * operand_13642 = NULL ;
while (((operand_13642 = enumerator_13642.nextObject ()))) {
  macroValidPointer (operand_13642) ;
var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_13642->mValue) ;
...
category_method__terminalCheckInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_13943,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13943 != NULL) {
GGS_lexicalSentValueList  var_cas_sentAttributeList ;
if (var_cas_inTerminalMap.isBuilt ()) {
  var_cas_inTerminalMap (HERE)->method_searchKey (inLexique, operand_13943->mTerminalName, var_cas_sentAttributeList COMMA_SOURCE_FILE_AT_LINE (351)) ;
}
const GGS_bool cond_14908 = (operand_13943->mActualInputParameterList.reader_length ()).operator_isNotEqual (var_cas_sentAttributeList.reader_length ()) ;
if (cond_14908.isBuiltAndTrue ()) {
operand_13943->mTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((((GGS_string ("naming the '$")).operator_concat (operand_13943->mTerminalName)).operator_concat (GGS_string ("$' requires "))).operator_concat (var_cas_sentAttributeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_sentAttributeList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (", but this instruction names "))).operator_concat (operand_13943->mActualInputParameterList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (358)))).operator_concat (GGS_string (" parameter"))).operator_concat ((((operand_13943->mActualInputParameterList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (361)) ;
}
...
{
GGS_actualInputParameterListAST::cEnumerator enumerator_15029 (operand_13943->mActualInputParameterList, true) ;
const GGS_actualInputParameterListAST::cElement * operand_15029 = NULL ;
GGS_lexicalSentValueList::cEnumerator enumerator_15048 (var_cas_sentAttributeList, true) ;
const GGS_lexicalSentValueList::cElement * operand_15048 = NULL ;
while (((operand_15029 = enumerator_15029.nextObject ()))
    && ((operand_15048 = enumerator_15048.nextObject ()))) {
  macroValidPointer (operand_15029) ;
  macroValidPointer (operand_15048) ;
const GGS_bool cond_16758 = (operand_15029->mActualParameterName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_16758.isBuiltAndTrue ()) {
  GGS_unifiedTypeMapProxy  var_cas_type ;
  GGS_string var_cas_cppName ;
  const GGS_bool cond_15567 = (operand_15029->mActualParameterTypeName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_15567.isBuiltAndTrue ()) {
    var_cas_cppName = (GGS_string ("var_")).operator_concat (operand_15029->mActualParameterName.ggs_string ().reader_identifierRepresentation ()) ;
    var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_15029->mActualParameterTypeName COMMA_SOURCE_FILE_AT_LINE (370)) ;
    var_cas_ioVariableMap.modifier_insertDefinedLocalVariable (inLexique, operand_15029->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (371)) ;
    var_cas_ioLocalVariableCppNameList.addAssign_operation (var_cas_cppName) ;
  }else if (cond_15567.isBuiltAndFalse ()) {
    var_cas_ioVariableMap.modifier_searchForWriteAccess (inLexique, operand_15029->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (374)) ;
  }
  GGS_unifiedTypeMapProxy  var_cas_expectedType ;
  switch (operand_15048->mLexicalType.enumValue ()) {
  ...
  const GGS_bool cond_16608 = (var_cas_expectedType).operator_isNotEqual (var_cas_type) ;
  if (cond_16608.isBuiltAndTrue ()) {
    operand_15029->mActualParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '")).operator_concat (operand_15029->mActualParameterName)).operator_concat (GGS_string ("' parameter has the '@"))).operator_concat (var_cas_type.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (388)))).operator_concat (GGS_string (", bit an '@"))).operator_concat (var_cas_expectedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (389)))).operator_concat (GGS_string ("' parameter is required here")) COMMA_SOURCE_FILE_AT_LINE (391)) ;
  }
  var_cas_terminalCheckAssignementList.addAssign_operation (operand_15029->mActualParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393)), var_cas_cppName, operand_15048->mLexicalAttributeName) ;
}
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_terminalCheckInstructionForGeneration ::constructor_new (inLexique, operand_13943->mInstructionLocation, operand_13943->mTerminalName, var_cas_inLexiqueName, var_cas_terminalCheckAssignementList COMMA_SOURCE_FILE_AT_LINE (400))) ;
  }
}
...
category_method__terminalCheckInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstructionForGeneration * operand_17137,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17137 != NULL) {
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17137->mLexiqueIdentifier) ;
var_cas_ioGeneratedCode.appendCString ("::kToken_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_17137->mTerminalName.ggs_string ().reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (") COMMA_SOURCE_FILE_AT_LINE (") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_17137->mInstructionLocation.reader_line (inLexique COMMA_SOURCE_FILE_AT_LINE (419)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (419))) ;
var_cas_ioGeneratedCode.appendCString (")) ;\n") ;
{
GGS_terminalCheckAssignementList::cEnumerator enumerator_17723 (operand_17137->mTerminalCheckAssignementList, true) ;
const GGS_terminalCheckAssignementList::cElement * operand_17723 = NULL ;
while (((operand_17723 = enumerator_17723.nextObject ()))) {
  macroValidPointer (operand_17723) ;
const GGS_bool cond_17847 = (operand_17723->mTypeName).operator_isNotEqual (GGS_string ("")) ;
if (cond_17847.isBuiltAndTrue ()) {
  var_cas_ioGeneratedCode.appendCString ("GALGAS_") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17723->mTypeName.reader_identifierRepresentation ()) ;
  var_cas_ioGeneratedCode.appendCString (" * ") ;
}else if (cond_17847.isBuiltAndFalse ()) {
  var_cas_ioGeneratedCode.appendCString ("macroReleaseObject (") ;
  var_cas_ioGeneratedCode.dotAssign_operation (operand_17723->mTargetVarCppName) ;
  var_cas_ioGeneratedCode.appendCString (") ;\n") ;
}
var_cas_ioGeneratedCode.dotAssign_operation (operand_17723->mTargetVarCppName) ;
var_cas_ioGeneratedCode.appendCString (" = ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_17723->mSourceLexicalAttributeName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString (" () ;\n") ;
}
}
  }
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_18979 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18979 = NULL ;
while (((operand_18979 = enumerator_18979.nextObject ()))) {
  macroValidPointer (operand_18979) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18979->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18979->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (453)) ;
  }
}
}
}
const GGS_bool cond_19530 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_19530.isBuiltAndTrue ()) {
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_19760,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19760->mRepeatedInstructionList,  operand_19760->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (497)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20845 (operand_19760->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_20845 = NULL ;
while (((operand_20845 = enumerator_20845.nextObject ()))) {
  macroValidPointer (operand_20845) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_20845->mSyntaxInstructionList,  operand_20845->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (514)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_20845->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_19760->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (530)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, operand_19760->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, operand_19760->mEndOf_repeat_instruction, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (532))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_21817,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_21817->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (553)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_21817->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_21817->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_22647 (operand_21817->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_22647 = NULL ;
while (((operand_22647 = enumerator_22647.nextObject ()))) {
  macroValidPointer (operand_22647) ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_22647->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (563)) ;
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_23318,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_23998 (operand_23318->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_23998 = NULL ;
while (((operand_23998 = enumerator_23998.nextObject ()))) {
  macroValidPointer (operand_23998) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_23998->mSyntaxInstructionList,  operand_23998->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (601)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_23998->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_23318->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (617)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, operand_23318->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (618))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_24903,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24903 != NULL) {
...
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24903->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24903->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (635))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (635))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_25359 (operand_24903->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_25359 = NULL ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_25359->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (638)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_25895,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25895 != NULL) {
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (666)) ;
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_26498 (operand_25895->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_26498 = NULL ;
while (((operand_26498 = enumerator_26498.nextObject ()))) {
  macroValidPointer (operand_26498) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_26498->mSyntaxInstructionList,  operand_26498->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (671)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_26498->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_25895->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (687)) ;
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
GGS_location  automatic_var_27315_0 ;
var_cas_tempListOfBranches.modifier_popFirst (inLexique, var_cas_instructionList, automatic_var_27315_0 COMMA_SOURCE_FILE_AT_LINE (691)) ;
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_27489 (var_cas_tempListOfBranches, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_27489 = NULL ;
while (((operand_27489 = enumerator_27489.nextObject ()))
    && (var_cas_ok.isBuiltAndTrue ())) {
  macroValidPointer (operand_27489) ;
var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_referenceSignature, function_syntaxSignatureOfInstructionList (inLexique, operand_27489->mInstructionList COMMA_SOURCE_FILE_AT_LINE (697)), operand_27489->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (695)) ;
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseDoInstructionForGeneration ::constructor_new (inLexique, operand_25895->mInstructionLocation, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (702))) ;
  }
}
...
category_method__parseDoInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstructionForGeneration * operand_28018,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28018 != NULL) {
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_28564 (operand_28018->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_28564 = enumerator_28564.nextObject () ;
if ((operand_28564 != NULL)) {
  GGS_uint var_cas_IDX (true, 0) ;
  bool _foreach_loop_28564 ;
  do{
  macroValidPointer (operand_28564) ;
  ::routine_generateInstructionList (inLexique,  operand_28564->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (721)) ;
  var_cas_IDX.mValue ++ ;
  operand_28564 = enumerator_28564.nextObject () ;
  _foreach_loop_28564 = ((operand_28564 != NULL)) ;
  if (_foreach_loop_28564) {
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_29047,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_29047->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_29047->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (748)) ;
  }
}
const GGS_bool cond_29927 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (754))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_29927.isBuiltAndTrue ()) {
operand_29047->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (756)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (756)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (757)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (759)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_29047->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_29047->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (762)) ;
  }
}
const GGS_bool cond_30414 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (768))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_30414.isBuiltAndTrue ()) {
operand_29047->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (770)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (770)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (771)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (773)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (776)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_29047->mDoInstructionList,  operand_29047->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (779)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_29047->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (793)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_29047->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (795))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_31302,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31302 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//-------- @parseLoopInstructionForGeneration\n") ;
GGS_string var_cas_variantVarCppName ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31302->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31302->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (813)) ;
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31302->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31302->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (824)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (" = (NULL == ") ;
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_31302->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (839)) ;
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_31302->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_31302->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (848)) ;
  }
}
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_loopVar) ;
var_cas_ioGeneratedCode.appendCString (" = (NULL != ") ;
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_executeParseVar) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_31302->mInstructionList COMMA_SOURCE_FILE_AT_LINE (862)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (861)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_34993,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34993 != NULL) {
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_34993->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34993->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (886)) ;
  }
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_35778 (operand_34993->mWhenInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_35778 = NULL ;
while (((operand_35778 = enumerator_35778.nextObject ()))) {
  macroValidPointer (operand_35778) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_35778->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_35778->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_when_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (896)) ;
  }
}
}
}
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_36255 (operand_34993->mElseInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_36255 = NULL ;
while (((operand_36255 = enumerator_36255.nextObject ()))) {
  macroValidPointer (operand_36255) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_36255->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_36255->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_else_instructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (912)) ;
  }
}
}
}
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration, operand_34993->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (926)) ;
const GGS_bool cond_37028 = var_cas_ok ;
if (cond_37028.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_34993->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (929))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_37197,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37197 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//--------- @parseWhenInstructionForGeneration\n") ;
GGS_string var_cas_sourceVar ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_37197->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_37197->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (947)) ;
  }
}
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_boolVarCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_37197->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (952)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_37197->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (959)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_38420,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38420 != NULL) {
operand_38420->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (984)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1006)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignatureForGeneration COMMA_SOURCE_FILE_AT_LINE (1007)) ;
var_cas_outSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_40173 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_40173 = NULL ;
while (((operand_40173 = enumerator_40173.nextObject ()))) {
  macroValidPointer (operand_40173) ;
var_cas_outSignature.addAssign_operation (operand_40173->mFormalArgumentType, operand_40173->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_40483 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_40483 = NULL ;
while (((operand_40483 = enumerator_40483.nextObject ()))) {
  macroValidPointer (operand_40483) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_40483->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_40483->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (1023)) ;
  }
}
}
}
...
void routine_semanticAnalysisOfSyntaxComponent (C_Compiler & inLexique,
  ...
  #endif
GGS_nonterminalMap  var_cas_nonterminalMap = GGS_nonterminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1055)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1056)) ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_41865 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_41865 = NULL ;
while (((operand_41865 = enumerator_41865.nextObject ()))) {
  macroValidPointer (operand_41865) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1063)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_41949 (operand_41865->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_41949 = NULL ;
while (((operand_41949 = enumerator_41949.nextObject ()))) {
  macroValidPointer (operand_41949) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_42116 (operand_41949->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_42116 = NULL ;
    while (((operand_42116 = enumerator_42116.nextObject ()))) {
      macroValidPointer (operand_42116) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_42116->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1068)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_42116->mFormalArgumentPassingMode, var_cas_type, operand_42116->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_42116->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_42116->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_41949->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_41949->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1072)) ;
}
}
elementOf_GGS_nonterminalMap * operand_42585 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_41865->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074))) ;
if (NULL != operand_42585) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41865->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_42585->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1075)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_41865->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1077)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43049 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43049 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43206 (operand_43049->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43206 = NULL ;
while (((operand_43206 = enumerator_43206.nextObject ()))) {
  macroValidPointer (operand_43206) ;
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_43206->mFormalArguments,  operand_43206->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1092)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_43206->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43206->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_44163_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_43049->mNonterminalName, automatic_var_44163_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1116)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_43049->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1118)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
var_cas_newRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalMap, var_cas_ruleDeclarationList, var_cas_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (1126)) ;
  #ifdef DEBUG_TRACE_ENABLED
