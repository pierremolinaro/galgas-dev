...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1323)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap, outArgument_outSignatureForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1324)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1331)) ;
  cEnumerator_formalParameterListForGeneration enumerator_52750 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_52750.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_52750.current_mFormalArgumentType (HERE), enumerator_52750.current_mFormalArgumentPassingMode (HERE), enumerator_52750.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1333)) ;
    enumerator_52750.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1336)) ;
  GALGAS_stringlist var_localVariableCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1337)) ;
  cEnumerator_syntaxInstructionList enumerator_53088 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_53088.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_53088.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1339)) ;
    enumerator_53088.gotoNextObject () ;
  }
  var_variableMap.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1353)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1376)) ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1377)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_54617 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_54617.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1384)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_54701 (enumerator_54617.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_54701.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1386)) ;
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1387)) ;
      cEnumerator_formalParameterListAST enumerator_54868 (enumerator_54701.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_54868.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_54868.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1389)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_54868.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_54868.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_54868.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1390)) COMMA_SOURCE_FILE_AT_LINE (1390)) COMMA_SOURCE_FILE_AT_LINE (1390)) ;
        var_signature.addAssign_operation (var_type, enumerator_54868.current_mFormalArgumentPassingMode (HERE), enumerator_54868.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1391)) ;
        enumerator_54868.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_54701.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_54701.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1393)) ;
      }
      enumerator_54701.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_54617.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1396)) ;
    }
    enumerator_54617.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1405)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1407)) COMMA_SOURCE_FILE_AT_LINE (1402)) ;
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1411)) ;
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_56011 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_56011.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1414)) ;
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    GALGAS_nonterminalLabelMap joker_56195_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_56011.current_mNonterminalName (HERE), joker_56195_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1416)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_56222 (enumerator_56011.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_56222.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_56222.current_mFormalArguments (HERE), enumerator_56222.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_56222.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1422)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_56222.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_56222.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1438)) ;
      enumerator_56222.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_57193_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_56011.current_mNonterminalName (HERE), joker_57193_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1447)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_56011.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1449)), var_newRuleIndex, var_ruleLabelImplementationList COMMA_SOURCE_FILE_AT_LINE (1448)) ;
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1453)) ;
    enumerator_56011.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (GALGAS_bool (true), constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature COMMA_SOURCE_FILE_AT_LINE (1456)) ;
}
