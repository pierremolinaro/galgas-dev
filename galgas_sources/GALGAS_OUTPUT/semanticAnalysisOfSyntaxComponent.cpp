...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementation (C_Compiler * /* inCompiler */,
  ...
  result << ".h\"\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_207_ (0) ;
  if (in_IMPORTED_5F_COMPONENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_207 (in_IMPORTED_5F_COMPONENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_207.hasCurrentObject ()) {
      result << "#include \"" ;
      result << enumerator_207.current_mValue (HERE).stringValue () ;
      result << ".h\"\n" ;
      index_207_.increment () ;
      enumerator_207.gotoNextObject () ;
    }
  }
  result << "\n"
    "//---------------------------------------------------------------------------*\n"
...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxAnalyserClassDeclaration (C_Compiler * inCompiler,
  ...
  if (in_NONTERMINAL_5F_MAP.isValid ()) {
    ...
    while (enumerator_653.hasCurrentObject ()) {
      ...
      const enumGalgasBool test_3 = enumerator_653.current_mHasParseLabel (HERE).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "  protected : virtual void nt_" ;
      ...
      const enumGalgasBool test_4 = in_HAS_5F_INDEXING.boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "  protected : virtual void nt_" ;
  ...
  if (in_RULE_5F_DECLARATION_5F_LIST.isValid ()) {
    cEnumerator_ruleDeclarationList enumerator_2062 (in_RULE_5F_DECLARATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_2062.hasCurrentObject ()) {
      ...
      if (enumerator_2062.current_mLabelImplementationList (HERE).isValid ()) {
        cEnumerator_ruleLabelImplementationList enumerator_2122 (enumerator_2062.current_mLabelImplementationList (HERE), kEnumeration_up) ;
        while (enumerator_2122.hasCurrentObject ()) {
          ...
          if (enumerator_2122.current_mSignature (HERE).isValid ()) {
            cEnumerator_formalParameterSignature enumerator_2317 (enumerator_2122.current_mSignature (HERE), kEnumeration_up) ;
            while (enumerator_2317.hasCurrentObject ()) {
              const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_2317.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (43)))).boolEnum () ;
              if (kBoolTrue == test_5) {
                result << "const GALGAS_" ;
                ...
                const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_2317.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (45)))).boolEnum () ;
                if (kBoolTrue == test_6) {
                  result << "GALGAS_" ;
                  ...
                  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_2317.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (47)))).boolEnum () ;
                  if (kBoolTrue == test_7) {
                    result << "GALGAS_" ;
      ...
      const enumGalgasBool test_8 = enumerator_2062.current_mHasParseLabel (HERE).boolEnum () ;
      if (kBoolTrue == test_8) {
        result << "  protected : void rule_" ;
      ...
      const enumGalgasBool test_9 = in_HAS_5F_INDEXING.boolEnum () ;
      if (kBoolTrue == test_9) {
        result << "  protected : void rule_" ;
  ...
  if (in_SELECT_5F_METHOD_5F_LIST.isValid ()) {
    cEnumerator_uintlist enumerator_3703 (in_SELECT_5F_METHOD_5F_LIST, kEnumeration_up) ;
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
  ...
  const cMapElement_nonterminalMap * objectArray_5792 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction_hasKey (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (140))) ;
  if (NULL != objectArray_5792) {
      macroValidSharedObject (objectArray_5792, const cMapElement_nonterminalMap) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_5792->mAttribute_mHasParseLabel.objectCompare (constinArgument_inHasParseLabel)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_1 ;
      const enumGalgasBool test_2 = objectArray_5792->mAttribute_mHasParseLabel.boolEnum () ;
      if (kBoolTrue == test_2) {
      ...
      const enumGalgasBool test_4 = constinArgument_inHasParseLabel.boolEnum () ;
      if (kBoolTrue == test_4) {
        temp_3 = GALGAS_string ("with") ;
      }else if (kBoolFalse == test_4) {
        temp_3 = GALGAS_string ("without") ;
      }
      GALGAS_location location_5 (constinArgument_inNonTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).operator_concat (GALGAS_string ("' is redeclared ") COMMA_SOURCE_FILE_AT_LINE (143)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (GALGAS_string (" 'parse' label, but first declaration declares it ") COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (temp_3 COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (GALGAS_string (" 'parse' label") COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (142)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringset var_firstDeclarationLabelSet = objectArray_5792->mAttribute_mLabelMap.reader_allKeys (SOURCE_FILE_AT_LINE (150)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringset var_reDeclarationLabelSet = constinArgument_inNonterminalLabelMap.reader_allKeys (SOURCE_FILE_AT_LINE (151)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringset var_missingLabelSet = var_firstDeclarationLabelSet.substract_operation (var_reDeclarationLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (153)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6524 (var_missingLabelSet, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6524.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6524.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)) ;
      ...
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("' nonterminal is redeclared without the following label(s):") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (158)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringset var_newLabelSet = var_reDeclarationLabelSet.substract_operation (var_firstDeclarationLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (162)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (163)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6904 (var_newLabelSet, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6904.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (enumerator_6904.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
        enumerator_6904.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_9 (constinArgument_inNonTerminalName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (GALGAS_string ("' nonterminal is redeclared with the new label(s):") COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (168)) ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (172)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (172)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (172)).boolEnum () ;
    if (kBoolTrue == test_10) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_nonterminalLabelMap enumerator_7196 (objectArray_5792->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_7229 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7196.hasCurrentObject () && enumerator_7229.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_formalParameterSignature var_newSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (174)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_formalParameterSignature enumerator_7332 (enumerator_7229.current_mSignature (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_7332.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_newSignature.addAssign_operation (enumerator_7332.current_mFormalArgumentType (HERE), enumerator_7332.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (176)) ;
          enumerator_7332.gotoNextObject () ;
        }
        { //-------- @routineCallInstructionForGeneration
        routine_checkMethodSignatures (enumerator_7196.current_mSignatureForGeneration (HERE), enumerator_7196.current_mEndOfArgumentLocation (HERE), var_newSignature, enumerator_7229.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) ;
        } //-------- @routineCallInstructionForGeneration
    ...
    ioArgument_ioNonterminalDeclarationMap.modifier_insertKey (constinArgument_inNonTerminalName, constinArgument_inNonterminalLabelMap, constinArgument_inHasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (187)) ;
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  outArgument_outNonterminalDeclarationMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (198)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonterminalDeclarationListAST enumerator_8194 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_8194.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (201)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_nonTerminalLabelListAST enumerator_8275 (enumerator_8194.current_mLabels (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8275.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (203)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (204)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_8445 (enumerator_8275.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8445.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_8445.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
        //-------- @plusEqualnstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_8445.current_mFormalArgumentPassingMode (HERE), var_t, enumerator_8445.current_mFormalArgumentName (HERE), enumerator_8445.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
        //-------- @plusEqualnstructionForGeneration
        var_signature.addAssign_operation (var_t, enumerator_8445.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (208)) ;
        enumerator_8445.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_8275.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_8275.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (210)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_8275.gotoNextObject () ;
    }
    { //-------- @routineCallInstructionForGeneration
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_8194.current_mNonterminalName (HERE), var_nonterminalLabelMap, enumerator_8194.current_mHasParseLabel (HERE), outArgument_outNonterminalDeclarationMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_19912 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19912.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_19912.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_19912.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListForGeneration enumerator_39056 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39056.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outSignature.addAssign_operation (enumerator_39056.current_mFormalArgumentType (HERE), enumerator_39056.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
    enumerator_39056.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_nonterminalMap var_nonterminalMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1056)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1057)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_40833 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40833.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1064)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_40917 (enumerator_40833.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40917.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterListForGeneration var_signatureForGeneration = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1066)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterSignature var_signature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1067)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_41084 (enumerator_40917.current_mFormalArguments (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_41084.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_41084.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1069)) ;
        //-------- @plusEqualnstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_41084.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_41084.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_41084.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1070)) COMMA_SOURCE_FILE_AT_LINE (1070)) COMMA_SOURCE_FILE_AT_LINE (1070)) ;
        //-------- @plusEqualnstructionForGeneration
        var_signature.addAssign_operation (var_type, enumerator_41084.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1071)) ;
        enumerator_41084.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_40917.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_40917.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1073)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_40917.gotoNextObject () ;
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_nonterminalMap * objectArray_41550 = (const cMapElement_nonterminalMap *) var_nonterminalMap.readAccessForWithInstruction_hasKey (enumerator_40833.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1075))) ;
    if (NULL != objectArray_41550) {
        macroValidSharedObject (objectArray_41550, const cMapElement_nonterminalMap) ;
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40833.current_mNonterminalName (HERE), var_nonterminalLabelMap, objectArray_41550->mAttribute_mHasParseLabel, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1076)) ;
      } //-------- @routineCallInstructionForGeneration
    }else{
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40833.current_mNonterminalName (HERE), var_nonterminalLabelMap, GALGAS_bool (false), var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1078)) ;
      } //-------- @routineCallInstructionForGeneration
    }
    enumerator_40833.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1085)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1087)) COMMA_SOURCE_FILE_AT_LINE (1082)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_selectMethodCount = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_ruleDeclarationList var_ruleDeclarationList = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1091)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_newRuleIndex = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_42211 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42211.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1094)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_localSelectMethodCount = var_selectMethodCount ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_42368 (enumerator_42211.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42368.hasCurrentObject ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      { //-------- @routineCallInstructionForGeneration
      routine_semanticAnalysisOfRuleLabel (enumerator_42368.current_mFormalArguments (HERE), enumerator_42368.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_42368.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1101)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_ruleLabelImplementationList.addAssign_operation (enumerator_42368.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_42368.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1116)) ;
      enumerator_42368.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_43332_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_42211.current_mNonterminalName (HERE), joker_43332_0, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_ruleDeclarationList.addAssign_operation (enumerator_42211.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1128)), var_newRuleIndex, var_ruleLabelImplementationList, var_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1127)) ;
    //-------- @incrementInstructionForGeneration
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1133)) ;
    enumerator_42211.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (GALGAS_bool (true), constinArgument_inComponentName, constinArgument_inLexiqueName, var_nonterminalMap, var_ruleDeclarationList, var_selectMethodCount, constinArgument_inHasIndexing COMMA_SOURCE_FILE_AT_LINE (1136)) ;
}
...
static GALGAS_string categoryReader_syntaxDeclarationForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  if (object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)).isValid ()) {
    PMUInt32 variant_4812 = object->mAttribute_mSelectMethodCount.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)).uintValue () ;
    bool loop_4812 = true ;
    while (loop_4812) {
      loop_4812 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).isValid () ;
      if (loop_4812) {
        loop_4812 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mSelectMethodCount)).boolValue () ;
      }
      if (loop_4812 && (0 == variant_4812)) {
        loop_4812 = false ;
...
static void categoryMethod_semanticInstructionAST_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) temp_0.ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionListForGeneration, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (247)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_hasParseLabel.operator_not (SOURCE_FILE_AT_LINE (273)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @errorInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_formalParameterListForGeneration joker_11563_0 ; // Joker input parameter
    GALGAS_location joker_11577_0 ; // Joker input parameter
    var_labelMap.method_searchKey (object->mAttribute_mLabelName, joker_11563_0, var_signature, joker_11577_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13182 (var_parameterCppNameList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13182.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13182.current_mValue (HERE).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_13487 (var_inputVariableList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_13487.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_13487.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (333)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (333)) ;
      enumerator_13487.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (335)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13697 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13697.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_13697.current_mValue (HERE).operator_concat (GALGAS_string (".drop () ; // Release temporary input variables (joker in source)\n") COMMA_SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)) ;
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (359)).objectCompare (var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (359)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    //--- @ifExpressionForGeneration
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_sentAttributeList.reader_length (SOURCE_FILE_AT_LINE (362)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    //--- @ifExpressionForGeneration
    GALGAS_string temp_3 ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mActualInputParameterList.reader_length (SOURCE_FILE_AT_LINE (365)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualInputParameterListAST enumerator_15012 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_15033 (var_sentAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15012.hasCurrentObject () && enumerator_15033.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_15012.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (371)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, enumerator_15012.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (374)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @assignmentInstructionForGeneration
        var_cppName = GALGAS_string ("var_").operator_concat (enumerator_15012.current_mActualParameterName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)) ;
        //-------- @assignmentInstructionForGeneration
        var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_15012.current_mActualParameterTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (enumerator_15012.current_mActualParameterName (HERE), var_type, var_cppName, var_cppName, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }else if (kBoolFalse == test_7) {
        { //-------- @modifierCallInstructionForGeneration
        GALGAS_string joker_15613_0 ; // Joker input parameter
        ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_15012.current_mActualParameterName (HERE), var_type, var_cppName, joker_15613_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (379)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_expectedType ;
      //------- @switchInstructionForGeneration
      if (enumerator_15033.current_mLexicalType (HERE).isValid ()) {
        switch (enumerator_15033.current_mLexicalType (HERE).enumValue ()) {
      ...
      if (kBoolTrue == test_8) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_9 (enumerator_15012.current_mActualParameterName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (enumerator_15012.current_mActualParameterName (HERE).reader_string (SOURCE_FILE_AT_LINE (393)) COMMA_SOURCE_FILE_AT_LINE (393)).operator_concat (GALGAS_string ("' parameter has the '@") COMMA_SOURCE_FILE_AT_LINE (393)).operator_concat (var_type.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) COMMA_SOURCE_FILE_AT_LINE (393)).operator_concat (GALGAS_string (", bit an '@") COMMA_SOURCE_FILE_AT_LINE (394)).operator_concat (var_expectedType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE_AT_LINE (394)) COMMA_SOURCE_FILE_AT_LINE (394)).operator_concat (GALGAS_string ("' parameter is required here") COMMA_SOURCE_FILE_AT_LINE (394)) COMMA_SOURCE_FILE_AT_LINE (392)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_terminalCheckAssignementList.addAssign_operation (enumerator_15012.current_mActualParameterTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (398)), var_cppName, enumerator_15033.current_mLexicalAttributeName (HERE) COMMA_SOURCE_FILE_AT_LINE (397)) ;
    }
    enumerator_15012.gotoNextObject () ;
    enumerator_15033.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexingKey.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_10) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_11 = constinArgument_inIndexNameSet.reader_hasKey (object->mAttribute_mIndexingKey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (406)).operator_not (SOURCE_FILE_AT_LINE (406)).boolEnum () ;
    if (kBoolTrue == test_11) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_17028 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_17028.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_17028.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (409)) ;
        enumerator_17028.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_12 (object->mAttribute_mIndexingKey.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (object->mAttribute_mIndexingKey.reader_string (SOURCE_FILE_AT_LINE (411)) COMMA_SOURCE_FILE_AT_LINE (411)).operator_concat (GALGAS_string ("' indexing name is not declared by the lexique; available names are:") COMMA_SOURCE_FILE_AT_LINE (411)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (411)) COMMA_SOURCE_FILE_AT_LINE (411)) ;
    }
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_terminalCheckAssignementList enumerator_17913 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17913.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_17913.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (enumerator_17913.current_mTypeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (436)) COMMA_SOURCE_FILE_AT_LINE (436)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (436)) COMMA_SOURCE_FILE_AT_LINE (436)) ;
    }
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_17913.current_mTargetVarCppName (HERE).operator_concat (GALGAS_string (" = ") COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (GALGAS_string ("->synthetizedAttribute_") COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (enumerator_17913.current_mSourceLexicalAttributeName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string (" () ;\n") COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (439)) ;
    enumerator_17913.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexingKey.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @concatInstructionForGeneration
  ...
  if (kBoolTrue == test_2) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalCheckAssignementList enumerator_19016 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19016.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_19016.current_mTargetVarCppName (HERE) COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (GALGAS_string (".checkIsValid (HERE) ;\n") COMMA_SOURCE_FILE_AT_LINE (456)) COMMA_SOURCE_FILE_AT_LINE (456)) ;
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_21457 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_21457.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_21457.current_mSyntaxInstructionList (HERE), enumerator_21457.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (534)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_21457.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (547)) ;
    enumerator_21457.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_23318 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_23312 ((PMUInt32) 0) ;
  while (enumerator_23318.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_23312.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (584)).reader_string (SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_23318.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (585)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (592)) ;
    enumerator_23318.gotoNextObject () ;
    index_23312.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
  }
  //-------- @concatInstructionForGeneration
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_24634 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24634.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeSyntaxInstructionList (constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, enumerator_24634.current_mSyntaxInstructionList (HERE), enumerator_24634.current_mEndOf_5F_instructions (HERE), constinArgument_inIndexNameSet, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_24634.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (636)) ;
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_26028 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_26022 ((PMUInt32) 0) ;
  while (enumerator_26028.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("case ").operator_concat (index_26022.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (660)).reader_string (SOURCE_FILE_AT_LINE (660)) COMMA_SOURCE_FILE_AT_LINE (660)).operator_concat (GALGAS_string (": {\n") COMMA_SOURCE_FILE_AT_LINE (660)) COMMA_SOURCE_FILE_AT_LINE (660)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_26028.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (661)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @concatInstructionForGeneration
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("} break ;\n") COMMA_SOURCE_FILE_AT_LINE (668)) ;
    enumerator_26028.gotoNextObject () ;
    index_26022.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (659)) ;
  }
  //-------- @concatInstructionForGeneration
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_27144 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27144.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxInstructionList enumerator_27310 (enumerator_27144.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27310.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_27310.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, var_instructionList, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (695)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_27310.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (var_instructionList, enumerator_27144.current_mEndOf_5F_instructions (HERE) COMMA_SOURCE_FILE_AT_LINE (707)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_instructionList ;
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_location joker_27981_0 ; // Joker input parameter
  var_tempListOfBranches.modifier_popFirst (var_instructionList, joker_27981_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_semanticInstructionListForGeneration var_referenceSignature = function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (713)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28171 (var_tempListOfBranches, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_28171.hasCurrentObject () && bool_0) {
    while (enumerator_28171.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_28171.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (718)), enumerator_28171.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (716)) ;
      enumerator_28171.gotoNextObject () ;
      if (enumerator_28171.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_29297 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29297.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_29297.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (743)) ;
    } //-------- @routineCallInstructionForGeneration
    if (enumerator_29297.hasNextObject ()) {
      //-------- @concatInstructionForGeneration
    ...
    enumerator_29297.gotoNextObject () ;
  }
  //-------- @concatInstructionForGeneration
...
static void categoryMethod_parseLoopInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_variant_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (776)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_while_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (789)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_parseWhenInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_ok = function_compareSyntaxSignature (function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_when_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (939)), function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), var_else_5F_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (940)), object->mAttribute_mEndOfElseInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (938)) ;
  //-------- @ifInstructionForGeneration
