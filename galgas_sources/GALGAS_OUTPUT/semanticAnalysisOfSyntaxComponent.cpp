...
category_method__semanticInstructionAST__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_semanticInstructionAST * operand_10123,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10123 != NULL) {
GGS_semanticInstructionAST  var_cas_t = operand_10123 ;
{ typeCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction method = findCategoryMethod__semanticInstructionAST__analyzeSemanticInstruction (var_cas_t.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, var_cas_t (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (245)) ;
  }
}
  }
}
...
category_method__nonterminalCallInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_nonterminalCallInstruction * operand_10861,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
if (var_cas_inNonterminalMap.isBuilt ()) {
  var_cas_inNonterminalMap (HERE)->method_searchKey (inLexique, operand_10861->mNonterminalName, var_cas_labelMap, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (268)) ;
}
GGS_formalParameterSignature  var_cas_signature ;
const GGS_bool cond_11686 = (operand_10861->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (270))).operator_isEqual (GGS_string ("parse")) ;
if (cond_11686.isBuiltAndTrue ()) {
const GGS_bool cond_11607 = (var_cas_hasParseLabel).operator_not () ;
if (cond_11607.isBuiltAndTrue ()) {
operand_10861->mLabelName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_10861->mNonterminalName)).operator_concat (GGS_string (">' nonterminal does not declare the 'parse' label")) COMMA_SOURCE_FILE_AT_LINE (276)) ;
var_cas_signature.drop () ;
}else if (cond_11607.isBuiltAndFalse ()) {
var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
}
}else if (cond_11686.isBuiltAndFalse ()) {
GGS_formalParameterListForGeneration  automatic_var_11740_0 ;
GGS_location  automatic_var_11740_1 ;
if (var_cas_labelMap.isBuilt ()) {
  var_cas_labelMap (HERE)->method_searchKey (inLexique, operand_10861->mLabelName, automatic_var_11740_0, var_cas_signature, automatic_var_11740_1 COMMA_SOURCE_FILE_AT_LINE (280)) ;
}
}
GGS_actualParameterListForGeneration  var_cas_actualParameterListForGeneration ;
::routine_analyzeRoutineArguments (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  operand_10861->mNonterminalName,  ((GGS_string ("'<")).operator_concat (operand_10861->mNonterminalName)).operator_concat (GGS_string (">' nonterminal declaration")),  var_cas_signature,  operand_10861->mActualParameterList,  var_cas_ioVariableMap,  var_cas_actualParameterListForGeneration COMMA_SOURCE_FILE_AT_LINE (284)) ;
  }
}
...
category_method__terminalCheckInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_12262,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   /* var_cas_inNonterminalMap */,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12262 != NULL) {
GGS_lexicalSentValueList  var_cas_sentAttributeList ;
if (var_cas_inTerminalMap.isBuilt ()) {
  var_cas_inTerminalMap (HERE)->method_searchKey (inLexique, operand_12262->mTerminalName, var_cas_sentAttributeList COMMA_SOURCE_FILE_AT_LINE (310)) ;
}
const GGS_bool cond_13166 = (operand_12262->mActualInputParameterList.reader_length ()).operator_isNotEqual (var_cas_sentAttributeList.reader_length ()) ;
if (cond_13166.isBuiltAndTrue ()) {
operand_12262->mTerminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((((((GGS_string ("naming the '$")).operator_concat (operand_12262->mTerminalName)).operator_concat (GGS_string ("$' requires "))).operator_concat (var_cas_sentAttributeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (314)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_sentAttributeList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (", but this instruction names "))).operator_concat (operand_12262->mActualInputParameterList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (317)))).operator_concat (GGS_string (" parameter"))).operator_concat ((((operand_12262->mActualInputParameterList.reader_length ()).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (320)) ;
}
{
GGS_actualInputParameterListAST::cEnumerator enumerator_13212 (operand_12262->mActualInputParameterList, true) ;
const GGS_actualInputParameterListAST::cElement * operand_13212 = NULL ;
GGS_lexicalSentValueList::cEnumerator enumerator_13231 (var_cas_sentAttributeList, true) ;
const GGS_lexicalSentValueList::cElement * operand_13231 = NULL ;
while (((operand_13212 = enumerator_13212.nextObject ()))
    && ((operand_13231 = enumerator_13231.nextObject ()))) {
  macroValidPointer (operand_13212) ;
  macroValidPointer (operand_13231) ;
const GGS_bool cond_14804 = (operand_13212->mActualParameterName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_14804.isBuiltAndTrue ()) {
  GGS_unifiedTypeMapProxy  var_cas_type ;
  GGS_string var_cas_cppName ;
  const GGS_bool cond_13750 = (operand_13212->mActualParameterTypeName.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_13750.isBuiltAndTrue ()) {
    var_cas_cppName = (GGS_string ("var_")).operator_concat (operand_13212->mActualParameterName.ggs_string ().reader_identifierRepresentation ()) ;
    var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_13212->mActualParameterTypeName COMMA_SOURCE_FILE_AT_LINE (328)) ;
    var_cas_ioVariableMap.modifier_insertDefinedLocalVariable (inLexique, operand_13212->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (329)) ;
    var_cas_ioLocalVariableCppNameList.addAssign_operation (var_cas_cppName) ;
  }else if (cond_13750.isBuiltAndFalse ()) {
    var_cas_ioVariableMap.modifier_searchForWriteAccess (inLexique, operand_13212->mActualParameterName, var_cas_type, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (332)) ;
  }
  GGS_unifiedTypeMapProxy  var_cas_expectedType ;
  switch (operand_13231->mLexicalType.enumValue ()) {
  ...
  const GGS_bool cond_14791 = (var_cas_expectedType).operator_isNotEqual (var_cas_type) ;
  if (cond_14791.isBuiltAndTrue ()) {
    operand_13212->mActualParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '")).operator_concat (operand_13212->mActualParameterName)).operator_concat (GGS_string ("' parameter has the '@"))).operator_concat (var_cas_type.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (346)))).operator_concat (GGS_string (", bit an '@"))).operator_concat (var_cas_expectedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (347)))).operator_concat (GGS_string ("' parameter is required here")) COMMA_SOURCE_FILE_AT_LINE (349)) ;
  }
}
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_terminalCheckInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (353))) ;
  }
}
...
static void
category_method__terminalCheckInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_terminalCheckInstructionForGeneration * operand_15085,
...
var_cas_ioGeneratedCode.appendCString ("@terminalCheckInstructionForGeneration generateInstruction\n") ;
  }
}
...
var_cas_ioVariableMap.modifier_beginBranch (inLexique COMMA_SOURCE_FILE_AT_LINE (382)) ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_16051 (var_cas_inSemanticInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_16051 = NULL ;
while (((operand_16051 = enumerator_16051.nextObject ()))) {
  macroValidPointer (operand_16051) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_16051->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_16051->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inNonterminalMap, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (386)) ;
  }
}
}
}
const GGS_bool cond_16558 = (var_cas_localVariableCppNameList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
if (cond_16558.isBuiltAndTrue ()) {
var_cas_outInstructionListForGeneration.addAssign_operation (GGS_dropInstructionForGeneration ::constructor_new (inLexique, var_cas_localVariableCppNameList, GGS_string ("end of scope") COMMA_SOURCE_FILE_AT_LINE (399))) ;
}
var_cas_ioVariableMap.modifier_endBranch (inLexique, var_cas_inEndOfBranchLocation COMMA_SOURCE_FILE_AT_LINE (405)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_16788,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (420)) ;
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (422)) ;
GGS_semanticInstructionListForGeneration  var_cas_repeated_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_16788->mRepeatedInstructionList,  operand_16788->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (425)) ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_17625 (operand_16788->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_17625 = NULL ;
while (((operand_17625 = enumerator_17625.nextObject ()))) {
  macroValidPointer (operand_17625) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_17625->mSyntaxInstructionList,  operand_17625->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (439)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_16788->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (452)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (454))) ;
  }
}
...
static void
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_repeatInstructionForGeneration * operand_18290,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18290 != NULL) {
var_cas_ioGeneratedCode.appendCString ("@repeatInstructionForGeneration generateInstruction\n") ;
  }
}
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_18643,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
var_cas_ioSelectMethodCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (480)) ;
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (482)) ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_19114 (operand_18643->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_19114 = NULL ;
while (((operand_19114 = enumerator_19114.nextObject ()))) {
  macroValidPointer (operand_19114) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_19114->mSyntaxInstructionList,  operand_19114->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (486)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_18643->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (499)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (500))) ;
  }
}
...
static void
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_selectInstructionForGeneration * operand_19774,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19774 != NULL) {
var_cas_ioGeneratedCode.appendCString ("@selectInstructionForGeneration generateInstruction\n") ;
  }
}
...
category_method__parseDoInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_20128,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20128 != NULL) {
var_cas_ioVariableMap.modifier_beginOverrideForSelectBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (527)) ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20574 (operand_20128->mParseDoBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_20574 = NULL ;
while (((operand_20574 = enumerator_20574.nextObject ()))) {
  macroValidPointer (operand_20574) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_20574->mSyntaxInstructionList,  operand_20574->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (531)) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_20128->mEndOfParseDoInstruction COMMA_SOURCE_FILE_AT_LINE (544)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseDoInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (546))) ;
  }
}
...
category_method__parseDoInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_parseDoInstructionForGeneration * operand_21261,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21261 != NULL) {
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_21618,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_21618->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_21618->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (574)) ;
  }
}
const GGS_bool cond_22444 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (580))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_22444.isBuiltAndTrue ()) {
operand_21618->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (582)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (583)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (585)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_21618->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_21618->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (588)) ;
  }
}
const GGS_bool cond_22931 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (594))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_22931.isBuiltAndTrue ()) {
operand_21618->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (596)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (596)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (597)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (599)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (602)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inNonterminalMap,  operand_21618->mDoInstructionList,  operand_21618->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (605)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_21618->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (617)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (619))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_parseLoopInstructionForGeneration * operand_23686,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_24045,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_nonterminalMap   var_cas_inNonterminalMap,
                                ...
                                GGS_stringlist  & var_cas_ioLocalVariableCppNameList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24045 != NULL) {
GGS_uint  var_cas_localSelectMethodCount = var_cas_ioSelectMethodCount ;
{
GGS_whenBranchList::cEnumerator enumerator_24452 (operand_24045->mWhenBranchList, true) ;
const GGS_whenBranchList::cElement * operand_24452 = NULL ;
while (((operand_24452 = enumerator_24452.nextObject ()))) {
  macroValidPointer (operand_24452) ;
var_cas_localSelectMethodCount = var_cas_ioSelectMethodCount ;
GGS_semanticExpressionForGeneration  var_cas_when_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_24452->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_24452->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (649)) ;
  }
}
...
{
  GGS_syntaxInstructionList::cEnumerator enumerator_24828 (operand_24452->mParseDoBranchList, true) ;
  const GGS_syntaxInstructionList::cElement * operand_24828 = NULL ;
  while (((operand_24828 = enumerator_24828.nextObject ()))) {
    macroValidPointer (operand_24828) ;
    { typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_24828->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_24828->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inNonterminalMap, var_cas_instructionListForGeneration, var_cas_ioVariableMap, var_cas_localSelectMethodCount, var_cas_ioLocalVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (657)) ;
      }
    }
  }
}
...
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (671))) ;
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler &,
                                const cPtr_parseWhenInstructionForGeneration * operand_25479,
                                GGS_uint  & /* var_cas_ioTemporaryVariableIndex */,
                                GGS_stringset  & /* var_cas_ioUnusedVariableCppNameSet */,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25479 != NULL) {
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_25834,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_nonterminalMap   /* var_cas_inNonterminalMap */,
                                ...
                                GGS_stringlist  & /* var_cas_ioLocalVariableCppNameList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25834 != NULL) {
operand_25834->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (699)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (C_Compiler & inLexique,
  ...
  #endif
GGS_variableMap  var_cas_variableMap = GGS_variableMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (719)) ;
::routine_buildLocalVariableMapAndSignature (inLexique,  var_cas_inSemanticContext,  var_cas_inFormalArguments,  var_cas_variableMap,  var_cas_outSignatureForGeneration COMMA_SOURCE_FILE_AT_LINE (720)) ;
var_cas_outSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_27465 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_27465 = NULL ;
while (((operand_27465 = enumerator_27465.nextObject ()))) {
  macroValidPointer (operand_27465) ;
var_cas_outSignature.addAssign_operation (operand_27465->mFormalArgumentType, operand_27465->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_27775 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_27775 = NULL ;
while (((operand_27775 = enumerator_27775.nextObject ()))) {
  macroValidPointer (operand_27775) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_27775->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_27775->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inNonterminalMap, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount, var_cas_localVariableCppNameList COMMA_SOURCE_FILE_AT_LINE (736)) ;
  }
}
}
}
...
void routine_semanticAnalysisOfSyntaxComponent (C_Compiler & inLexique,
  ...
  #endif
GGS_nonterminalMap  var_cas_nonterminalMap = GGS_nonterminalMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (766)) ;
::routine_buildNonterminalDeclarationsMap (inLexique,  var_cas_inNonterminalDeclarationList,  var_cas_inSemanticContext,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (767)) ;
{
GGS_syntaxRuleListAST::cEnumerator enumerator_29113 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_29113 = NULL ;
while (((operand_29113 = enumerator_29113.nextObject ()))) {
  macroValidPointer (operand_29113) ;
GGS_nonterminalLabelMap  var_cas_nonterminalLabelMap = GGS_nonterminalLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (774)) ;
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_29197 (operand_29113->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_29197 = NULL ;
while (((operand_29197 = enumerator_29197.nextObject ()))) {
  macroValidPointer (operand_29197) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_29364 (operand_29197->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_29364 = NULL ;
    while (((operand_29364 = enumerator_29364.nextObject ()))) {
      macroValidPointer (operand_29364) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_29364->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (779)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_29364->mFormalArgumentPassingMode, var_cas_type, operand_29364->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_29364->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_29364->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_29197->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_29197->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (783)) ;
}
}
elementOf_GGS_nonterminalMap * operand_29833 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_29113->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (785))) ;
if (NULL != operand_29833) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_29113->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_29833->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (786)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_29113->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (788)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_30297 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_30297 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_30454 (operand_30297->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_30454 = NULL ;
while (((operand_30454 = enumerator_30454.nextObject ()))) {
  macroValidPointer (operand_30454) ;
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_30454->mFormalArguments,  operand_30454->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_nonterminalMap,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (803)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_30454->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_30454->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_31363_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_30297->mNonterminalName, automatic_var_31363_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (825)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_30297->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (827)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
var_cas_newRuleIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (832)) ;
}
}
var_cas_outSyntaxDeclarationForGeneration = GGS_syntaxDeclarationForGeneration ::constructor_new (inLexique, var_cas_inComponentName, var_cas_inLexiqueName, var_cas_nonterminalMap, var_cas_ruleDeclarationList, var_cas_selectMethodCount COMMA_SOURCE_FILE_AT_LINE (835)) ;
  #ifdef DEBUG_TRACE_ENABLED
