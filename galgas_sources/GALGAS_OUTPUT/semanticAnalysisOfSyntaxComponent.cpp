...
GALGAS_string filewrapperTemplate_syntaxFileGenerationTemplate_syntaxFileImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_IMPORTED_5F_COMPONENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_590 (in_IMPORTED_5F_COMPONENT_5F_LIST, kEnumeration_up) ;
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
  ...
  if (NULL != objectArray_5790) {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_5790->mAttribute_mHasParseLabel.objectCompare (constinArgument_inHasParseLabel)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_1 ;
      const enumGalgasBool test_2 = objectArray_5790->mAttribute_mHasParseLabel.boolEnum () ;
      if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (142)) COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (GALGAS_string ("' is redeclared ") COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (143)).operator_concat (GALGAS_string (" 'parse' label, but first declaration declares it ") COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (temp_3 COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (GALGAS_string (" 'parse' label") COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (141)) ;
    }
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (152)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6522 (var_missingLabelSet, kEnumeration_up) ;
      ...
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string ("' nonterminal is redeclared without the following label(s):") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (157)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (162)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_6902 (var_newLabelSet, kEnumeration_up) ;
      //--- simple foreach instruction
      ...
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (constinArgument_inNonTerminalName.reader_string (SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_concat (GALGAS_string ("' nonterminal is redeclared with the new label(s):") COMMA_SOURCE_FILE_AT_LINE (168)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (167)) ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, var_missingLabelSet.reader_count (SOURCE_FILE_AT_LINE (171)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet.reader_count (SOURCE_FILE_AT_LINE (171)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (171)).boolEnum () ;
    if (kBoolTrue == test_10) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_nonterminalLabelMap enumerator_7194 (objectArray_5790->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_7227 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7194.hasCurrentObject () && enumerator_7227.hasCurrentObject ()) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_formalParameterSignature enumerator_7330 (enumerator_7227.current_mSignature (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonterminalDeclarationListAST enumerator_8192 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_8192.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_nonTerminalLabelListAST enumerator_8273 (enumerator_8192.current_mLabels (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8273.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_8443 (enumerator_8273.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_19967 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListForGeneration enumerator_39111 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39111.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    outArgument_outSignature.addAssign_operation (enumerator_39111.current_mFormalArgumentType (HERE), enumerator_39111.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_39420 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39420.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_39420.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (1021)) ;
    //-------- END @methodCallInstructionForGeneration
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_40888 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40888.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_40972 (enumerator_40888.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40972.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_41139 (enumerator_40972.current_mFormalArguments (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_41139.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_41139.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1069)) ;
        //-------- @addAssignInstructionForGeneration
        var_signatureForGeneration.addAssign_operation (enumerator_41139.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_41139.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_41139.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1070)) COMMA_SOURCE_FILE_AT_LINE (1070)) COMMA_SOURCE_FILE_AT_LINE (1070)) ;
        //-------- @addAssignInstructionForGeneration
        var_signature.addAssign_operation (var_type, enumerator_41139.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1071)) ;
        enumerator_41139.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_nonterminalLabelMap.modifier_insertKey (enumerator_40972.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_40972.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1073)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_40972.gotoNextObject () ;
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_nonterminalMap * objectArray_41605 = (const cMapElement_nonterminalMap *) var_nonterminalMap.readAccessForWithInstruction_hasKey (enumerator_40888.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1075))) ;
    if (NULL != objectArray_41605) {
        macroValidSharedObject (objectArray_41605, const cMapElement_nonterminalMap) ;
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40888.current_mNonterminalName (HERE), var_nonterminalLabelMap, objectArray_41605->mAttribute_mHasParseLabel, var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1076)) ;
      } //-------- @routineCallInstructionForGeneration
    }else{
      { //-------- @routineCallInstructionForGeneration
      routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_40888.current_mNonterminalName (HERE), var_nonterminalLabelMap, GALGAS_bool (false), var_nonterminalMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1078)) ;
      } //-------- @routineCallInstructionForGeneration
    }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_42233 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42233.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxRuleLabelListAST enumerator_42390 (enumerator_42233.current_mLabelList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42390.hasCurrentObject ()) {
      ...
      { //-------- @routineCallInstructionForGeneration
      routine_semanticAnalysisOfRuleLabel (enumerator_42390.current_mFormalArguments (HERE), enumerator_42390.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_42390.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_ruleLabelImplementationList.addAssign_operation (enumerator_42390.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_42390.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1115)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalLabelMap joker_43354_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_42233.current_mNonterminalName (HERE), joker_43354_0, var_hasParseLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1125)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_ruleDeclarationList.addAssign_operation (enumerator_42233.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (1127)), var_newRuleIndex, var_ruleLabelImplementationList, var_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    //-------- @incrementInstructionForGeneration
    var_newRuleIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1132)) ;
    enumerator_42233.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_nonterminalInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualParameterListForGeneration enumerator_12762 (object->mAttribute_mActualParameterList, kEnumeration_up) ;
  //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13237 (var_parameterCppNameList, kEnumeration_up) ;
  //--- simple foreach instruction
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_13542 (var_inputVariableList, kEnumeration_up) ;
    //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13752 (var_jokerParametersToReleaseList, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_terminalCheckInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualInputParameterListAST enumerator_15067 (object->mAttribute_mActualInputParameterList, kEnumeration_up) ;
  cEnumerator_lexicalSentValueList enumerator_15088 (var_sentAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15067.hasCurrentObject () && enumerator_15088.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_15067.current_mActualParameterName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (371)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, enumerator_15067.current_mActualParameterTypeName (HERE).mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (374)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @assignmentInstructionForGeneration
  ...
  if (kBoolTrue == test_10) {
    ...
    if (kBoolTrue == test_11) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_17083 (constinArgument_inIndexNameSet, kEnumeration_up) ;
      //--- simple foreach instruction
...
static void categoryMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_terminalCheckAssignementList enumerator_17968 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17968.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_17968.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @appendInstructionForGeneration
  ...
  if (kBoolTrue == test_2) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_terminalCheckAssignementList enumerator_19071 (object->mAttribute_mTerminalCheckAssignementList, kEnumeration_up) ;
    //--- simple foreach instruction
...
static void categoryMethod_repeatInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_21512 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_repeatInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_23373 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_selectInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_24689 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_selectInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_26083 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_parseRewindInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_27199 (object->mAttribute_mParseRewindBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27199.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_syntaxInstructionList enumerator_27365 (enumerator_27199.current_mSyntaxInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_28226 (var_tempListOfBranches, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_ok.isValidAndTrue () ;
  if (enumerator_28226.hasCurrentObject () && bool_0) {
    while (enumerator_28226.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_ok = function_compareSyntaxSignature (var_referenceSignature, function_syntaxSignatureOfInstructionList (GALGAS_string ("parse"), enumerator_28226.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (718)), enumerator_28226.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (716)) ;
      enumerator_28226.gotoNextObject () ;
      if (enumerator_28226.hasCurrentObject ()) {
...
static void categoryMethod_parseRewindInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_29352 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29352.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateInstructionList (constinArgument_inGenerateCheckValid, enumerator_29352.current_mInstructionList (HERE), ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (743)) ;
    } //-------- @routineCallInstructionForGeneration
    if (enumerator_29352.hasNextObject ()) {
      //-------- @appendInstructionForGeneration
