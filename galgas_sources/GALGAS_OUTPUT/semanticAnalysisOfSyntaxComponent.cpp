...
//                                         september 27th, 2014, at 13h24'52"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument_inFormalArguments,
  ...
  cEnumerator_formalParameterListForGeneration enumerator_56646 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_56646.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_56646.current_mFormalSelector (HERE), enumerator_56646.current_mFormalArgumentType (HERE), enumerator_56646.current_mFormalArgumentPassingMode (HERE), enumerator_56646.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1451)) ;
  ...
  cEnumerator_syntaxInstructionList enumerator_57001 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_57001.hasCurrentObject ()) {
    callCategoryMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_57001.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1457)) ;
    enumerator_57001.gotoNextObject () ;
  }
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_syntaxRuleListAST enumerator_58530 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_58530.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_58614 (enumerator_58530.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_58614.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_58781 (enumerator_58614.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_58781.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_58781.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1507)) ;
        var_signatureForGeneration.addAssign_operation (enumerator_58781.current_mFormalSelector (HERE), enumerator_58781.current_mFormalArgumentPassingMode (HERE), var_type, enumerator_58781.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").operator_concat (enumerator_58781.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1508))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1508))  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1508)) ;
        var_signature.addAssign_operation (enumerator_58781.current_mFormalSelector (HERE), var_type, enumerator_58781.current_mFormalArgumentPassingMode (HERE), enumerator_58781.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1509)) ;
        enumerator_58781.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap.modifier_insertKey (enumerator_58614.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_58614.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1511)) ;
      }
      enumerator_58614.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_58530.current_mNonterminalName (HERE), var_nonterminalLabelMap, var_nonterminalMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1513)) ;
    }
    enumerator_58530.gotoNextObject () ;
  }
  ...
  cEnumerator_syntaxRuleListAST enumerator_59764 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_59764.hasCurrentObject ()) {
    ...
    GALGAS_nonterminalLabelMap joker_59948_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_59764.current_mNonterminalName (HERE), joker_59948_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1530)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_59975 (enumerator_59764.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_59975.hasCurrentObject ()) {
      ...
      {
      routine_semanticAnalysisOfRuleLabel (enumerator_59975.current_mFormalArguments (HERE), enumerator_59975.current_mSyntaxInstructionList (HERE), var_analysisContext, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName, var_nonterminalMap, constinArgument_inComponentName, enumerator_59975.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount, var_signatureForGeneration, var_signature, var_instructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1536)) ;
      }
      var_ruleLabelImplementationList.addAssign_operation (enumerator_59975.current_mLabelName (HERE), var_signatureForGeneration, var_signature, enumerator_59975.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1552)) ;
      enumerator_59975.gotoNextObject () ;
    }
    var_selectMethodCount = var_localSelectMethodCount ;
    GALGAS_nonterminalLabelMap joker_60946_0 ; // Joker input parameter
    var_nonterminalMap.method_searchKey (enumerator_59764.current_mNonterminalName (HERE), joker_60946_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1561)) ;
    var_ruleDeclarationList.addAssign_operation (enumerator_59764.current_mNonterminalName (HERE).reader_string (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1563)), var_newRuleIndex, var_ruleLabelImplementationList  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1562)) ;
    var_newRuleIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1567)) ;
    enumerator_59764.gotoNextObject () ;
  }
...
static void categoryMethod_syntaxSendInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticAnalysisOfSyntaxComponent.gSemantics", 1392)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_1) {
