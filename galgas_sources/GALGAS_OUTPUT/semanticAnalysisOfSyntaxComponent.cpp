...
const GGS_bool cond_17244 = (operand_17120->mTypeName).operator_isNotEqual (GGS_string ("")) ;
if (cond_17244.isBuiltAndTrue ()) {
...
{
GGS_syntaxInstructionList::cEnumerator enumerator_18621 (var_cas_inSyntaxInstructionListAST, true) ;
const GGS_syntaxInstructionList::cElement * operand_18621 = NULL ;
while (((operand_18621 = enumerator_18621.nextObject ()))) {
  macroValidPointer (operand_18621) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_18621->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_18621->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_ioVariableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (448)) ;
  }
}
}
}
...
category_method__repeatInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_19145,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_19145->mRepeatedInstructionList,  operand_19145->mEndOf_repeated_instructions_branch,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_repeated_instructionList COMMA_SOURCE_FILE_AT_LINE (483)) ;
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20180 (operand_19145->mRepeatBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_20180 = NULL ;
while (((operand_20180 = enumerator_20180.nextObject ()))) {
  macroValidPointer (operand_20180) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_20180->mSyntaxInstructionList,  operand_20180->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (500)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_20180->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_19145->mEndOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (516)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_repeatInstructionForGeneration ::constructor_new (inLexique, operand_19145->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_repeated_instructionList, operand_19145->mEndOf_repeat_instruction, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (518))) ;
  }
}
...
category_method__repeatInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstructionForGeneration * operand_21152,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_repeatFlagCppName) ;
var_cas_ioGeneratedCode.appendCString (") {\n") ;
::routine_generateInstructionList (inLexique,  operand_21152->m_repeated_instructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (539)) ;
...
var_cas_ioGeneratedCode.dotAssign_operation (operand_21152->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_21152->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (546))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (546))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_21982 (operand_21152->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_21982 = NULL ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_21982->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (549)) ;
...
category_method__selectInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_22653,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
GGS_listOfSemanticInstructionListForGeneration  var_cas_listOfSemanticInstructionListForGeneration = GGS_listOfSemanticInstructionListForGeneration ::constructor_emptyList () ;
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_23283 (operand_22653->mSelectBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_23283 = NULL ;
while (((operand_23283 = enumerator_23283.nextObject ()))) {
  macroValidPointer (operand_23283) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_23283->mSyntaxInstructionList,  operand_23283->mEndOf_instructions,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (586)) ;
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_23283->mEndOf_instructions) ;
}
}
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_22653->mEndOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (602)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_selectInstructionForGeneration ::constructor_new (inLexique, operand_22653->mInstructionLocation, var_cas_inComponentName, var_cas_choiceIndex, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (603))) ;
  }
}
...
category_method__selectInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstructionForGeneration * operand_24188,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24188 != NULL) {
...
var_cas_ioGeneratedCode.appendCString ("switch (select_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24188->mSyntaxComponentName.reader_identifierRepresentation ()) ;
var_cas_ioGeneratedCode.appendCString ("_") ;
var_cas_ioGeneratedCode.dotAssign_operation (operand_24188->mChoiceIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (620))) ;
var_cas_ioGeneratedCode.appendCString (" (") ;
var_cas_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (620))) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_24644 (operand_24188->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_24644 = NULL ;
while (((operand_24644 = enumerator_24644.nextObject ()))) {
  macroValidPointer (operand_24644) ;
var_cas_ioGeneratedCode.appendCString ("case ") ;
...
var_cas_ioGeneratedCode.appendCString (": {\n") ;
::routine_generateInstructionList (inLexique,  operand_24644->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (623)) ;
var_cas_ioGeneratedCode.appendCString ("} break ;\n") ;
  var_cas_IDX.mValue ++ ;
}
}
...
category_method__parseRewindInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseRewindInstruction * operand_25184,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
{
GGS_listOfSyntaxInstructionList::cEnumerator enumerator_25744 (operand_25184->mParseRewindBranchList, true) ;
const GGS_listOfSyntaxInstructionList::cElement * operand_25744 = NULL ;
while (((operand_25744 = enumerator_25744.nextObject ()))) {
  macroValidPointer (operand_25744) ;
...
{
  GGS_syntaxInstructionList::cEnumerator enumerator_25910 (operand_25744->mSyntaxInstructionList, true) ;
  const GGS_syntaxInstructionList::cElement * operand_25910 = NULL ;
  while (((operand_25910 = enumerator_25910.nextObject ()))) {
    macroValidPointer (operand_25910) ;
    { typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_25910->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_25910->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_instructionList, var_cas_ioVariableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (656)) ;
      }
    }
  }
}
var_cas_listOfSemanticInstructionListForGeneration.addAssign_operation (var_cas_instructionList, operand_25744->mEndOf_instructions) ;
}
}
...
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
GGS_location  automatic_var_26588_0 ;
var_cas_tempListOfBranches.modifier_popFirst (inLexique, var_cas_instructionList, automatic_var_26588_0 COMMA_SOURCE_FILE_AT_LINE (673)) ;
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_26762 (var_cas_tempListOfBranches, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_26762 = NULL ;
while (((operand_26762 = enumerator_26762.nextObject ()))
    && (var_cas_ok.isBuiltAndTrue ())) {
  macroValidPointer (operand_26762) ;
var_cas_ok = function_compareSyntaxSignature (inLexique, var_cas_referenceSignature, function_syntaxSignatureOfInstructionList (inLexique, operand_26762->mInstructionList COMMA_SOURCE_FILE_AT_LINE (679)), operand_26762->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (677)) ;
}
}
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseRewindInstructionForGeneration ::constructor_new (inLexique, operand_25184->mInstructionLocation, var_cas_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (684))) ;
  }
}
...
category_method__parseRewindInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseRewindInstructionForGeneration * operand_27299,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
{
GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_27849 (operand_27299->mListOfSemanticInstructionListForGeneration, true) ;
const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_27849 = enumerator_27849.nextObject () ;
if ((operand_27849 != NULL)) {
  GGS_uint var_cas_IDX (true, 0) ;
  bool _foreach_loop_27849 ;
  do{
  macroValidPointer (operand_27849) ;
  ::routine_generateInstructionList (inLexique,  operand_27849->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (703)) ;
  var_cas_IDX.mValue ++ ;
  operand_27849 = enumerator_27849.nextObject () ;
  _foreach_loop_27849 = ((operand_27849 != NULL)) ;
  if (_foreach_loop_27849) {
...
category_method__parseLoopInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_28414,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28414->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28414->mVariantExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_variant_expression COMMA_SOURCE_FILE_AT_LINE (730)) ;
  }
}
const GGS_bool cond_29244 = (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (736))).operator_isNotEqual (var_cas_inPredefinedTypes.mUIntType) ;
if (cond_29244.isBuiltAndTrue ()) {
operand_28414->mEndOfVariantExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (738)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (738)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mUIntType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (739)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (741)) ;
}
GGS_semanticExpressionForGeneration  var_cas_while_expression ;
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_28414->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_28414->mWhileExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_while_expression COMMA_SOURCE_FILE_AT_LINE (744)) ;
  }
}
const GGS_bool cond_29731 = (var_cas_while_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (750))).operator_isNotEqual (var_cas_inPredefinedTypes.mBoolType) ;
if (cond_29731.isBuiltAndTrue ()) {
operand_28414->mEndOfWhileExpression.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the variant expression type is '@")).operator_concat (var_cas_variant_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (752)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (752)))).operator_concat (GGS_string ("', but it should be '@"))).operator_concat (var_cas_inPredefinedTypes.mBoolType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (753)))).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (755)) ;
}
var_cas_ioVariableMap.modifier_beginOverrideForRepeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (758)) ;
GGS_semanticInstructionListForGeneration  var_cas_instructionList ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_28414->mDoInstructionList,  operand_28414->mEndOfInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (761)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_28414->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (775)) ;
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseLoopInstructionForGeneration ::constructor_new (inLexique, operand_28414->mInstructionLocation, var_cas_variant_expression, var_cas_while_expression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (777))) ;
  }
}
...
category_method__parseLoopInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstructionForGeneration * operand_34495,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34495->mVariantExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34495->mVariantExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_variantVarCppName COMMA_SOURCE_FILE_AT_LINE (865)) ;
  }
}
...
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_34495->mWhileExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34495->mWhileExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_whileVarCppName COMMA_SOURCE_FILE_AT_LINE (878)) ;
  }
}
...
var_cas_ioGeneratedCode.appendCString ("->parsingContext () ;\n") ;
::routine_generateInstructionList (inLexique,  operand_34495->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (884)) ;
...
::routine_generateInstructionList (inLexique,  function_syntaxSignatureOfInstructionList (inLexique, operand_34495->mInstructionList COMMA_SOURCE_FILE_AT_LINE (900)),  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (899)) ;
...
category_method__parseWhenInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_37081,
                                const GGS_semanticContext  var_cas_inSemanticContext,
                                const GGS_predefinedTypes  var_cas_inPredefinedTypes,
                                const GGS_terminalMap   var_cas_inTerminalMap,
                                const GGS_string  var_cas_inLexiqueName,
...
{ typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (operand_37081->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_37081->mWhenExpression (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_when_expression COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
}
...
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_37081->mWhenInstructionList,  operand_37081->mEndOfWhenInstructionList,  var_cas_ioVariableMap,  var_cas_localSelectMethodCount,  var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (935)) ;
GGS_semanticInstructionListForGeneration  var_cas_else_instructionListForGeneration ;
::routine_analyzeSyntaxInstructionList (inLexique,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_inNonterminalMap,  var_cas_inComponentName,  operand_37081->mElseInstructionList,  operand_37081->mEndOfElseInstructionList,  var_cas_ioVariableMap,  var_cas_ioSelectMethodCount,  var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (950)) ;
var_cas_ioVariableMap.modifier_endOverride (inLexique, operand_37081->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (964)) ;
const GGS_bool var_cas_ok = function_compareSyntaxSignature (inLexique, function_syntaxSignatureOfInstructionList (inLexique, var_cas_when_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (967)), function_syntaxSignatureOfInstructionList (inLexique, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (968)), operand_37081->mEndOfElseInstructionList COMMA_SOURCE_FILE_AT_LINE (966)) ;
const GGS_bool cond_39154 = var_cas_ok ;
if (cond_39154.isBuiltAndTrue ()) {
var_cas_ioInstructionListForGeneration.addAssign_operation (GGS_parseWhenInstructionForGeneration ::constructor_new (inLexique, operand_37081->mInstructionLocation, var_cas_when_expression, var_cas_when_instructionListForGeneration, var_cas_else_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (973))) ;
}
  }
}
...
category_method__parseWhenInstructionForGeneration__generateInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstructionForGeneration * operand_39323,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_string & var_cas_ioGeneratedCode
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39323 != NULL) {
var_cas_ioGeneratedCode.appendCString ("//--------- @parseWhenInstructionForGeneration\n") ;
GGS_string var_cas_sourceVar ;
{ typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_39323->mWhenExpression.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_39323->mWhenExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_sourceVar COMMA_SOURCE_FILE_AT_LINE (991)) ;
  }
}
var_cas_ioGeneratedCode.appendCString ("if (isValidAndTrue (") ;
var_cas_ioGeneratedCode.dotAssign_operation (var_cas_sourceVar) ;
var_cas_ioGeneratedCode.appendCString (")) {\n") ;
::routine_generateInstructionList (inLexique,  operand_39323->mInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (993)) ;
var_cas_ioGeneratedCode.appendCString ("}else{\n") ;
::routine_generateInstructionList (inLexique,  operand_39323->mElseInstructionList,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioGeneratedCode COMMA_SOURCE_FILE_AT_LINE (1000)) ;
var_cas_ioGeneratedCode.appendCString ("}\n") ;
  }
}
...
category_method__blockInstruction__analyzeSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_40216,
                                const GGS_semanticContext  /* var_cas_inSemanticContext */,
                                const GGS_predefinedTypes  /* var_cas_inPredefinedTypes */,
                                const GGS_terminalMap   /* var_cas_inTerminalMap */,
                                const GGS_string  /* var_cas_inLexiqueName */,
                                ...
                                GGS_uint  & /* var_cas_ioSelectMethodCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40216 != NULL) {
operand_40216->mBlockMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'block' instruction is not handled in GALGAS 2\n") COMMA_SOURCE_FILE_AT_LINE (1024)) ;
  }
}
...
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_41956 (var_cas_outSignatureForGeneration, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_41956 = NULL ;
while (((operand_41956 = enumerator_41956.nextObject ()))) {
  macroValidPointer (operand_41956) ;
var_cas_outSignature.addAssign_operation (operand_41956->mFormalArgumentType, operand_41956->mFormalArgumentPassingMode) ;
}
}
var_cas_outInstructionListForGeneration = GGS_semanticInstructionListForGeneration ::constructor_emptyList () ;
GGS_stringlist  var_cas_localVariableCppNameList = GGS_stringlist ::constructor_emptyList () ;
{
GGS_syntaxInstructionList::cEnumerator enumerator_42266 (var_cas_inSyntaxInstructionList, true) ;
const GGS_syntaxInstructionList::cElement * operand_42266 = NULL ;
while (((operand_42266 = enumerator_42266.nextObject ()))) {
  macroValidPointer (operand_42266) ;
{ typeCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction method = findCategoryMethod__syntaxInstructionAST__analyzeSyntaxInstruction (operand_42266->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_42266->mInstruction (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_inTerminalMap, var_cas_inLexiqueName, var_cas_inNonterminalMap, var_cas_inComponentName, var_cas_outInstructionListForGeneration, var_cas_variableMap, var_cas_ioSelectMethodCount COMMA_SOURCE_FILE_AT_LINE (1064)) ;
  }
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_43683 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_43683 = NULL ;
while (((operand_43683 = enumerator_43683.nextObject ()))) {
  macroValidPointer (operand_43683) ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_43767 (operand_43683->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_43767 = NULL ;
while (((operand_43767 = enumerator_43767.nextObject ()))) {
  macroValidPointer (operand_43767) ;
  GGS_formalParameterListForGeneration  var_cas_signatureForGeneration = GGS_formalParameterListForGeneration ::constructor_emptyList () ;
  GGS_formalParameterSignature  var_cas_signature = GGS_formalParameterSignature ::constructor_emptyList () ;
  {
    GGS_formalParameterListAST::cEnumerator enumerator_43934 (operand_43767->mFormalArguments, true) ;
    const GGS_formalParameterListAST::cElement * operand_43934 = NULL ;
    while (((operand_43934 = enumerator_43934.nextObject ()))) {
      macroValidPointer (operand_43934) ;
      const GGS_unifiedTypeMapProxy  var_cas_type = GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inSemanticContext.mTypeMap, operand_43934->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (1110)) ;
      var_cas_signatureForGeneration.addAssign_operation (operand_43934->mFormalArgumentPassingMode, var_cas_type, operand_43934->mFormalArgumentName, (GGS_string ("argument_")).operator_concat (operand_43934->mFormalArgumentName)) ;
      var_cas_signature.addAssign_operation (var_cas_type, operand_43934->mFormalArgumentPassingMode) ;
    }
  }
  var_cas_nonterminalLabelMap.modifier_insertKey (inLexique, operand_43767->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_43767->mEndOfArgumentLocation COMMA_SOURCE_FILE_AT_LINE (1114)) ;
}
}
elementOf_GGS_nonterminalMap * operand_44403 = (elementOf_GGS_nonterminalMap *) var_cas_nonterminalMap.searchForReadWithInstruction (operand_43683->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1116))) ;
if (NULL != operand_44403) {
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43683->mNonterminalName,  var_cas_nonterminalLabelMap,  operand_44403->mInfo.mHasParseLabel,  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1117)) ;
}else{
::routine_enterNonterminalNonTerminalInMapAndCheck (inLexique,  operand_43683->mNonterminalName,  var_cas_nonterminalLabelMap,  GGS_bool (false),  var_cas_nonterminalMap COMMA_SOURCE_FILE_AT_LINE (1119)) ;
}
}
}
...
{
GGS_syntaxRuleListAST::cEnumerator enumerator_44867 (var_cas_inRuleList, true) ;
const GGS_syntaxRuleListAST::cElement * operand_44867 = NULL ;
...
{
GGS_syntaxRuleLabelListAST::cEnumerator enumerator_45024 (operand_44867->mLabelList, true) ;
const GGS_syntaxRuleLabelListAST::cElement * operand_45024 = NULL ;
while (((operand_45024 = enumerator_45024.nextObject ()))) {
  ...
  ::routine_semanticAnalysisOfRuleLabel (inLexique,  operand_45024->mFormalArguments,  operand_45024->mSyntaxInstructionList,  var_cas_inSemanticContext,  var_cas_inPredefinedTypes,  var_cas_inTerminalMap,  var_cas_inLexiqueName,  var_cas_nonterminalMap,  var_cas_inComponentName,  operand_45024->mEndOfInstructionList,  var_cas_localSelectMethodCount,  var_cas_signatureForGeneration,  var_cas_signature,  var_cas_instructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  var_cas_ruleLabelImplementationList.addAssign_operation (operand_45024->mLabelName, var_cas_signatureForGeneration, var_cas_signature, operand_45024->mEndOfArgumentLocation, var_cas_instructionListForGeneration) ;
}
}
var_cas_selectMethodCount = var_cas_localSelectMethodCount ;
GGS_bool var_cas_hasParseLabel ;
GGS_nonterminalLabelMap  automatic_var_46012_0 ;
if (var_cas_nonterminalMap.isBuilt ()) {
  var_cas_nonterminalMap (HERE)->method_searchKey (inLexique, operand_44867->mNonterminalName, automatic_var_46012_0, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (1159)) ;
}
var_cas_ruleDeclarationList.addAssign_operation (operand_44867->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1161)), var_cas_newRuleIndex, var_cas_ruleLabelImplementationList, var_cas_hasParseLabel) ;
