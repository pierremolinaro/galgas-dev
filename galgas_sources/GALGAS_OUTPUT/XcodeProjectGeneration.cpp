...
void routine_build_LIBPM_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_3812 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_3812 = NULL ;
    while (((operand_3812 = enumerator_3812.nextObject ()))) {
      macroValidPointer (operand_3812) ;
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  operand_3812->mValue COMMA_SOURCE_FILE_AT_LINE (104)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_4456 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_4456 = NULL ;
    while (((operand_4456 = enumerator_4456.nextObject ()))) {
      macroValidPointer (operand_4456) ;
      var_cas_fileList._addAssign_operation ((operand_4456->mValue)._operator_concat (GGS_string (true, ".cpp"))) ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17435 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17435.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17435._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_17435.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17977 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17977.hc ()) {
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  enumerator_17977._key (HERE) COMMA_SOURCE_FILE_AT_LINE (590)) ;
      enumerator_17977.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_18066 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_18066.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_18066._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_18066.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18586 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18586.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_18586._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (612)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_18586._key (HERE)) ;
      }
      enumerator_18586.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19275 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19275.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19275._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (634)) ;
      if ((((var_cas_extension)._operator_isNotEqual (GGS_string (true, "cpp")))._operator_and ((var_cas_extension)._operator_isNotEqual (GGS_string (true, "c")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19275._key (HERE)) ;
      }
      enumerator_19275.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19895 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19895.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19895._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (656)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19895._key (HERE)) ;
      }
      enumerator_19895.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & _inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_20635 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_20635.hc ()) {
      if (((enumerator_20635._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (681)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20635._key (HERE)) ;
      }
      enumerator_20635.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_20769 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_20769.hc ()) {
      if (((enumerator_20769._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (686)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20769._key (HERE)) ;
      }
      enumerator_20769.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_21327 (var_cas_inExternFileSet, true) ;
    while (enumerator_21327.hc ()) {
      if (((enumerator_21327._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (707)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_21327._key (HERE)) ;
      }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "md5.cpp")) ;
  {
    GGS_stringset::cEnumerator enumerator_24785 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_24785.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24785._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_24785.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24868 (var_cas_inScannerSourceNameSet, true) ;
    while (enumerator_24868.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24868._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24868.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24951 (var_cas_inOptionSourceNameSet, true) ;
    while (enumerator_24951.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24951._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24951.next () ;
    }
  }
