...
void routine_build_LIBPM_GALGAS_group (C_Compiler & inLexique,
  ...
  ::routine_getGALGAS_source_file_list (inLexique,  var_cas_cpp_and_h_fileList COMMA_SOURCE_FILE_AT_LINE (178)) ;
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_6931 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_6931 = NULL ;
    while (((operand_6931 = enumerator_6931.nextObject ()))) {
      macroValidPointer (operand_6931) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_6931->mValue COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
  }
  var_cas_fileList.addAssign_operation (GGS_string ("PP_GalgasPrefix.pch")) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (185)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_GALGAS_2_group (C_Compiler & inLexique,
  ...
  ::routine_getGALGAS_2_source_file_list (inLexique,  var_cas_fileList COMMA_SOURCE_FILE_AT_LINE (199)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (201)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  ::routine_getGALGAS_source_file_list (inLexique,  var_cas_cpp_and_h_fileList COMMA_SOURCE_FILE_AT_LINE (215)) ;
  GGS_stringlist  var_cas_cppFileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_7946 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_7946 = NULL ;
    while (((operand_7946 = enumerator_7946.nextObject ()))) {
      macroValidPointer (operand_7946) ;
      var_cas_cppFileList.addAssign_operation ((operand_7946->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_cppFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (221)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList ;
  ::routine_getGALGAS_2_source_file_list (inLexique,  var_cas_fileList COMMA_SOURCE_FILE_AT_LINE (235)) ;
  GGS_stringlist  var_cas_cppFileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_8507 (var_cas_fileList, true) ;
    const GGS_stringlist::cElement * operand_8507 = NULL ;
    while (((operand_8507 = enumerator_8507.nextObject ()))) {
      macroValidPointer (operand_8507) ;
      const GGS_bool cond_8593 = (operand_8507->mValue.reader_pathExtension ()).operator_isEqual (GGS_string ("cpp")) ;
      if (cond_8593.isBuiltAndTrue ()) {
        var_cas_cppFileList.addAssign_operation (operand_8507->mValue) ;
      }
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_cppFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (243)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_GALGAS_UTILITIES_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  ::routine_getGALGAS_UTILITIES_source_file_list (inLexique,  var_cas_cpp_and_h_fileList COMMA_SOURCE_FILE_AT_LINE (257)) ;
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_9139 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_9139 = NULL ;
    while (((operand_9139 = enumerator_9139.nextObject ()))) {
      macroValidPointer (operand_9139) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_9139->mValue COMMA_SOURCE_FILE_AT_LINE (260)) ;
    }
  }
  var_cas_fileList.addAssign_operation (GGS_string ("galgas_header.h")) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (264)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  ::routine_getGALGAS_UTILITIES_source_file_list (inLexique,  var_cas_cpp_and_h_fileList COMMA_SOURCE_FILE_AT_LINE (278)) ;
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_9764 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_9764 = NULL ;
    while (((operand_9764 = enumerator_9764.nextObject ()))) {
      macroValidPointer (operand_9764) ;
      var_cas_fileList.addAssign_operation ((operand_9764->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (284)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COCOA_GALGAS_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("NSSplitViewExtensions") COMMA_SOURCE_FILE_AT_LINE (298)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMFontButton") COMMA_SOURCE_FILE_AT_LINE (299)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_Token") COMMA_SOURCE_FILE_AT_LINE (300)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_Lexique") COMMA_SOURCE_FILE_AT_LINE (301)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_BuildWindowController") COMMA_SOURCE_FILE_AT_LINE (302)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_CommandLineOption") COMMA_SOURCE_FILE_AT_LINE (303)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("enterDefaultCommandLineOptions") COMMA_SOURCE_FILE_AT_LINE (304)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_Document") COMMA_SOURCE_FILE_AT_LINE (305)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_PreferencesController") COMMA_SOURCE_FILE_AT_LINE (306)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_RulerViewForCompileMessageView") COMMA_SOURCE_FILE_AT_LINE (307)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_RulerViewForTextView") COMMA_SOURCE_FILE_AT_LINE (308)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_TextView") COMMA_SOURCE_FILE_AT_LINE (309)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_DelegateForSyntaxColoring") COMMA_SOURCE_FILE_AT_LINE (310)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_BuildResultTextView") COMMA_SOURCE_FILE_AT_LINE (311)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_ErrorOrWarningDescriptor") COMMA_SOURCE_FILE_AT_LINE (312)) ;
  ...
  ::routine_enter_xib_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("MainMenu.xib"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (323)) ;
  ::routine_enter_xib_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("OC_GGS_Document.xib"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (329)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (336)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COCOA_DEBUG_group (C_Compiler & inLexique,
  ...
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMArrayControllerDebugCategory") COMMA_SOURCE_FILE_AT_LINE (352)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMArrayDebugCategory") COMMA_SOURCE_FILE_AT_LINE (353)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMDictionaryDebugCategory") COMMA_SOURCE_FILE_AT_LINE (354)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMMutableArrayDebugCategory") COMMA_SOURCE_FILE_AT_LINE (355)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMMutableDictionaryDebugCategory") COMMA_SOURCE_FILE_AT_LINE (356)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMMutableSetDebugCategory") COMMA_SOURCE_FILE_AT_LINE (357)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMMutableStringDebugCategory") COMMA_SOURCE_FILE_AT_LINE (358)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMPointerArrayDebugCategory") COMMA_SOURCE_FILE_AT_LINE (359)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("PMSetDebugCategory") COMMA_SOURCE_FILE_AT_LINE (360)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (362)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_FILES_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_HTML_FileWrite") COMMA_SOURCE_FILE_AT_LINE (392)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_TextFileWrite") COMMA_SOURCE_FILE_AT_LINE (393)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (395)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_CommandLineOption") COMMA_SOURCE_FILE_AT_LINE (426)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_BoolCommandLineOption") COMMA_SOURCE_FILE_AT_LINE (427)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_UIntCommandLineOption") COMMA_SOURCE_FILE_AT_LINE (428)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_StringCommandLineOption") COMMA_SOURCE_FILE_AT_LINE (429)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_builtin_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (430)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("F_Analyze_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (431)) ;
  var_cas_fileList.addAssign_operation (GGS_string ("F_main.cpp")) ;
  var_cas_fileList.addAssign_operation (GGS_string ("mainForLIBPM.h")) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (435)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  var_cas_fileList.addAssign_operation (GGS_string ("F_main.cpp")) ;
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (457)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COLLECTIONS_group (C_Compiler & inLexique,
  ...
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (484)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_PROJECT_RESOURCES_group (C_Compiler & inLexique,
  ...
  ::routine_enter_xib_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("Credits.rtf"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (501)) ;
  ::routine_enter_plist_strings_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("InfoPlist.strings"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (507)) ;
...
void routine_build_LIBPM_STRINGS_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_String") COMMA_SOURCE_FILE_AT_LINE (528)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("unicode_character_cpp") COMMA_SOURCE_FILE_AT_LINE (529)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("unicode_string_routines") COMMA_SOURCE_FILE_AT_LINE (530)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("unicode_character_m") COMMA_SOURCE_FILE_AT_LINE (531)) ;
  var_cas_fileList.addAssign_operation (GGS_string ("cUnicodeData.h")) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (534)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_STRINGS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (552)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_UTILITIES_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_SharedObject") COMMA_SOURCE_FILE_AT_LINE (566)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("md5") COMMA_SOURCE_FILE_AT_LINE (567)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("F_GetPrime") COMMA_SOURCE_FILE_AT_LINE (568)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("F_DisplayException") COMMA_SOURCE_FILE_AT_LINE (569)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("MF_Assert") COMMA_SOURCE_FILE_AT_LINE (570)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("cpp-allocation") COMMA_SOURCE_FILE_AT_LINE (571)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("basic-allocation") COMMA_SOURCE_FILE_AT_LINE (572)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("MF_MemoryControl") COMMA_SOURCE_FILE_AT_LINE (573)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_PrologueEpilogue") COMMA_SOURCE_FILE_AT_LINE (574)) ;
  ...
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (580)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_STREAMS_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_ErrorOut") COMMA_SOURCE_FILE_AT_LINE (618)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("AC_OutputStream") COMMA_SOURCE_FILE_AT_LINE (619)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_ConsoleOut") COMMA_SOURCE_FILE_AT_LINE (620)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (622)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_STREAMS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (640)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_TIME_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_DateTime") COMMA_SOURCE_FILE_AT_LINE (654)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_Timer") COMMA_SOURCE_FILE_AT_LINE (655)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (657)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_TIME_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (674)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22433 (var_cas_inComponentNameSet, true) ;
    while (enumerator_22433.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_22433._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_22433.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22975 (var_cas_inComponentNameSet, true) ;
    while (enumerator_22975.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_22975._key (HERE) COMMA_SOURCE_FILE_AT_LINE (710)) ;
      enumerator_22975.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_23064 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_23064.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_23064._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_23064.next () ;
    }
  }
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (716)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_23583 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_23583.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_23583._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_23763 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_23763.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_23583._key (HERE)) ;
      }
      enumerator_23583.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (738)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_24272 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_24272.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24272._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_24452 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_24452.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24272._key (HERE)) ;
      }
      enumerator_24272.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (760)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_24935 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_24935.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24935._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_25115 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_25115.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24935._key (HERE)) ;
      }
      enumerator_24935.next () ;
    }
  }
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (782)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_25675 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_25675.hasCurrentObject ()) {
      const GGS_bool cond_25757 = (enumerator_25675._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_25757.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_25675._key (HERE)) ;
      }
      enumerator_25675.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_25809 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_25809.hasCurrentObject ()) {
      const GGS_bool cond_25891 = (enumerator_25809._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_25891.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_25809._key (HERE)) ;
      }
      enumerator_25809.next () ;
    }
  }
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileSet.reader_stringList (inLexique COMMA_SOURCE_FILE_AT_LINE (813)),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (811)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_26367 (var_cas_inExternFileSet, true) ;
    while (enumerator_26367.hasCurrentObject ()) {
      const GGS_bool cond_26450 = (enumerator_26367._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_26450.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_26367._key (HERE)) ;
      }
      enumerator_26367.next () ;
    }
  }
  ::routine_enter_files_for_frameworks_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (832)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_RESOURCES_for_resources_build_phase (C_Compiler & inLexique,
  ...
  ::routine_enter_files_for_frameworks_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (862)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_29169 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_29169.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_29169._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_29169.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_29272 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_29272.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_29272._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_29452 = ((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_29452.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_29272._key (HERE)) ;
      }
      enumerator_29272.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (918)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateXcodeProject (C_Compiler & inLexique,
  ...
  ::routine_initXcodeProjectDescription (inLexique,  var_cas_XcodeProjectDescription COMMA_SOURCE_FILE_AT_LINE (950)) ;
  ...
  var_cas_fileSet.modifier_removeKey (inLexique, GGS_string ("AppKit.framework") COMMA_SOURCE_FILE_AT_LINE (955)) ;
  var_cas_fileSet.modifier_removeKey (inLexique, GGS_string ("Cocoa.framework") COMMA_SOURCE_FILE_AT_LINE (956)) ;
  ::routine_build_HAND_CODED_SOURCES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileSet,  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (957)) ;
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Hand Coded Sources"),  GGS_string ("../galgas_sources"),  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (963)) ;
  ...
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Generated by GALGAS"),  GGS_string ("../galgas_sources/GALGAS_OUTPUT"),  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (988)) ;
  ...
  ::routine_build_LIBPM_BDD_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_BDD_group COMMA_SOURCE_FILE_AT_LINE (998)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Binary Decision Diagrams"),  GGS_string ("bdd"),  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1003)) ;
  ...
  ::routine_build_LIBPM_COCOA_DEBUG_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_DEBUG_group COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Cocoa Debug"),  GGS_string ("cocoa_debug"),  var_cas_fileListOf_LIBPM_COCOA_DEBUG_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1016)) ;
  ...
  ::routine_build_LIBPM_COCOA_GALGAS_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (1025)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Cocoa GALGAS"),  GGS_string ("cocoa_galgas"),  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  ...
  ::routine_build_LIBPM_COCOA_UTILITIES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Cocoa Utilities"),  GGS_string ("cocoa_utilities"),  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1042)) ;
  ...
  ::routine_build_LIBPM_COLLECTIONS_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COLLECTIONS_group COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Collections"),  GGS_string ("collections"),  var_cas_fileListOf_LIBPM_COLLECTIONS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1056)) ;
  ...
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group COMMA_SOURCE_FILE_AT_LINE (1065)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Command Line Interface"),  GGS_string ("command_line_interface"),  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1070)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_FILE_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_FILES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_FILE_group COMMA_SOURCE_FILE_AT_LINE (1079)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Files"),  GGS_string ("files"),  var_cas_fileListOf_LIBPM_FILE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1084)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_GALGAS_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_GALGAS_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("GALGAS"),  GGS_string ("galgas"),  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1098)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_GALGAS_2_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_GALGAS_2_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_GALGAS_2_group COMMA_SOURCE_FILE_AT_LINE (1107)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("GALGAS 2"),  GGS_string ("galgas2"),  var_cas_fileListOf_LIBPM_GALGAS_2_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1112)) ;
  ...
  ::routine_build_LIBPM_GALGAS_UTILITIES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_GALGAS_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (1121)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("GALGAS UTILITIES"),  GGS_string ("galgas-utilities"),  var_cas_fileListOf_LIBPM_GALGAS_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1126)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_STREAMS_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_STREAMS_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_STREAMS_group COMMA_SOURCE_FILE_AT_LINE (1135)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Streams"),  GGS_string ("streams"),  var_cas_fileListOf_LIBPM_STREAMS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1140)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_TIME_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_TIME_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TIME_group COMMA_SOURCE_FILE_AT_LINE (1149)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Time"),  GGS_string ("time"),  var_cas_fileListOf_LIBPM_TIME_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1154)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_UTILITIES_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_UTILITIES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (1163)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Utilities"),  GGS_string ("utilities"),  var_cas_fileListOf_LIBPM_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1168)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_STRINGS_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_STRINGS_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_STRINGS_group COMMA_SOURCE_FILE_AT_LINE (1177)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Strings"),  GGS_string ("strings"),  var_cas_fileListOf_LIBPM_STRINGS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1182)) ;
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("LIBPM"),  GGS_string ("../../libpm"),  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1190)) ;
  ...
  ::routine_build_PROJECT_RESOURCES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inIconFiles,  var_cas_fileListOf_PROJECT_RESOURCES_group COMMA_SOURCE_FILE_AT_LINE (1198)) ;
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Project Resources"),  GGS_string (""),  var_cas_fileListOf_PROJECT_RESOURCES_group COMMA_SOURCE_FILE_AT_LINE (1203)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_FRAMEWORKS_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_FRAMEWORKS_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_FRAMEWORKS_group,  var_cas_inExternSourceNameSet_tool,  var_cas_inExternSourceNameSet_app COMMA_SOURCE_FILE_AT_LINE (1211)) ;
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Frameworks"),  GGS_string ("/System/Library/Frameworks"),  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (1218)) ;
  GGS_Xcode_PBXBuildFile_list  var_cas_listForSourceBuildPhaseOfTool = GGS_Xcode_PBXBuildFile_list ::constructor_emptyList () ;
  ::routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1227)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet_tool,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1233)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1239)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1244)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1249)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1254)) ;
  ::routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1259)) ;
  ::routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1264)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1269)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1274)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1279)) ;
  ::routine_build_LIBPM_STRINGS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1284)) ;
  GGS_Xcode_PBXBuildFile_list  var_cas_listForFrameworksBuildPhaseOfTool = GGS_Xcode_PBXBuildFile_list ::constructor_emptyList () ;
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForFrameworksBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1290)) ;
  ...
  ::routine_add_tool_target (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Tool")),  var_cas_toolTargetSettings,  GGS_string ("../../libpm/galgas/PP_GalgasPrefix.pch"),  var_cas_listForSourceBuildPhaseOfTool,  var_cas_listForFrameworksBuildPhaseOfTool,  GGS_stringlist ::constructor_emptyList (),  var_cas_toolTargetKey COMMA_SOURCE_FILE_AT_LINE (1300)) ;
  GGS_Xcode_PBXBuildFile_list  var_cas_listForSourceBuildPhaseOfDebugTool = GGS_Xcode_PBXBuildFile_list ::constructor_emptyList () ;
  ::routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet_tool,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1320)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1331)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1336)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1341)) ;
  ::routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1346)) ;
  ::routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1351)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1356)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1361)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1366)) ;
  ::routine_build_LIBPM_STRINGS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1371)) ;
  ...
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForFrameworksBuildPhaseOfToolDebug COMMA_SOURCE_FILE_AT_LINE (1377)) ;
  ...
  var_cas_fileSet.addAssign_operation (GGS_string ("AppKit.framework")) ;
  var_cas_fileSet.addAssign_operation (GGS_string ("Cocoa.framework")) ;
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileSet,  var_cas_listForFrameworksBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1416)) ;
  ...
  ::routine_build_RESOURCES_for_resources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  var_cas_inIconFiles,  var_cas_listForResourcesBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1423)) ;
  ::routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_app,  var_cas_listForResourcesBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1430)) ;
  ...
  GGS_string automatic_var_46050_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_46050_0 COMMA_SOURCE_FILE_AT_LINE (1443)) ;
  ...
  ::routine_enterProjectDefaultSettings (inLexique,  var_cas_pathes,  var_cas_projectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1462)) ;
  ::routine_generateXCodeFile (inLexique,  var_cas_XcodeProjectDescription,  var_cas_in_xcodeproj_filePath,  var_cas_projectDefaultSettings,  var_cas_inReferenceFilePath COMMA_SOURCE_FILE_AT_LINE (1468)) ;
  #ifdef DEBUG_TRACE_ENABLED
