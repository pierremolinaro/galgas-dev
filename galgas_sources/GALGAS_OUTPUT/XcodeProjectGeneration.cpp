...
//                    september 26th, 2008, at 18h51'22"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
//                                                                           *
//   Implementation of routine "build_LIBPM_GALGAS_sourceFiles_for_tool"     *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_GALGAS_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_GALGAS_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  ...
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_GALGAS_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//    Implementation of routine "build_LIBPM_FILES_sourceFiles_for_tool"     *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_FILES_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_FILES_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ...
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_FILES_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//Implementation of routine "build_LIBPM_COMMAND_LINE_INTERFACE_sourceFiles_for_tool"*
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_COMMAND_LINE_INTERFACE_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_COMMAND_LINE_INTERFACE_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ...
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_COMMAND_LINE_INTERFACE_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
// Implementation of routine "build_LIBPM_COLLECTIONS_sourceFiles_for_tool"  *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_COLLECTIONS_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_COLLECTIONS_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_cpp_fileList ;
  ...
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_COLLECTIONS_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//    Implementation of routine "build_LIBPM_CACHE_sourceFiles_for_tool"     *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_CACHE_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_CACHE_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ...
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_CACHE_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//     Implementation of routine "build_LIBPM_BDD_sourceFiles_for_tool"      *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_BDD_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_BDD_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ...
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_BDD_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//   Implementation of routine "build_LIBPM_UNICODE_sourceFiles_for_tool"    *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_UNICODE_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_UNICODE_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_UnicodeString")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "unicode_character")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "unicode_string_routines")) ;
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_h_fileList._addAssign_operation (GGS_string (true, "cUnicodeData")) ;
  var_cas_h_fileList._addAssign_operation (GGS_string (true, "string_class_template")) ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (642)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_UNICODE_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//  Implementation of routine "build_LIBPM_UTILITIES_sourceFiles_for_tool"   *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_UTILITIES_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_UTILITIES_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "md5")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_Exception")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_String")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "F_GetPrime")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "F_DisplayException")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "MF_Assert")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "MF_MemoryControl")) ;
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_h_fileList._addAssign_operation (GGS_string (true, "M_SourceLocation")) ;
  var_cas_h_fileList._addAssign_operation (GGS_string (true, "TF_inf")) ;
  var_cas_h_fileList._addAssign_operation (GGS_string (true, "TF_sup")) ;
  var_cas_h_fileList._addAssign_operation (GGS_string (true, "TF_Swap")) ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (678)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_UTILITIES_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//   Implementation of routine "build_LIBPM_STREAMS_sourceFiles_for_tool"    *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_STREAMS_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_STREAMS_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "AC_OutputUnicodeStream")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_ErrorOut")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "AC_OutputStream")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_ConsoleOut")) ;
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (707)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_STREAMS_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//    Implementation of routine "build_LIBPM_TIME_sourceFiles_for_tool"      *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_TIME_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_TIME_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_DateTime")) ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "C_Timer")) ;
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (734)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_TIME_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//   Implementation of routine "build_LIBPM_TINYXML_sourceFiles_for_tool"    *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_LIBPM_TINYXML_sourceFiles_for_tool (C_Compiler & _inLexique,
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioFileReferenceMap,
                                GGS_Xcode_PBXFileReference_list  & var_cas_ioReferenceList,
                                GGS_stringlist  & var_cas_ioFileListForGroup,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioAllBuildFileList,
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_LIBPM_TINYXML_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "tinyxml")) ;
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_cpp_fileList._addAssign_operation (GGS_string (true, "tinystr")) ;
  var_cas_cpp_fileList._addAssign_operation (GGS_string (true, "tinyxmlerror")) ;
  var_cas_cpp_fileList._addAssign_operation (GGS_string (true, "tinyxmlparser")) ;
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (763)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_LIBPM_TINYXML_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//Implementation of routine "build_GENERATED_BY_GALGAS_sourceFiles_for_tool" *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_GENERATED_BY_GALGAS_sourceFiles_for_tool (C_Compiler & _inLexique,
                                ...
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_GENERATED_BY_GALGAS_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_28092 (var_cas_inComponentNameSet, true) ;
    while (enumerator_28092.hc ()) {
      var_cas_cpp_and_h_fileList._addAssign_operation (enumerator_28092._key (HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (787))) ;
      enumerator_28092.next () ;
    }
  }
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (792)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_GENERATED_BY_GALGAS_sourceFiles_for_tool\n") ;
  #endif
}

//---------------------------------------------------------------------------*
//                                                                           *
//    Implementation of routine "build_HAND_CODED_sourceFiles_for_tool"      *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_build_HAND_CODED_sourceFiles_for_tool (C_Compiler & _inLexique,
                                ...
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildPhaseList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_build_HAND_CODED_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_cpp_and_h_fileList ;
  var_cas_cpp_and_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  GGS_stringlist  var_cas_cpp_fileList ;
  var_cas_cpp_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_28992 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_28992.hc ()) {
      var_cas_cpp_fileList._addAssign_operation (enumerator_28992._key (HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (817))) ;
      enumerator_28992.next () ;
    }
  }
  GGS_stringlist  var_cas_h_fileList ;
  var_cas_h_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_enter_sourceFiles_for_tool (_inLexique,  var_cas_cpp_and_h_fileList,  var_cas_cpp_fileList,  var_cas_h_fileList,  var_cas_ioFileReferenceMap,  var_cas_ioReferenceList,  var_cas_ioFileListForGroup,  var_cas_ioAllBuildFileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (821)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_build_HAND_CODED_sourceFiles_for_tool\n") ;
  #endif
}
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  ::routine_build_HAND_CODED_sourceFiles_for_tool (_inLexique,  var_cas_inExternSourceNameSet,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_HAND_CODED_SOURCES_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (854)) ;
  ...
  ::routine_build_GENERATED_BY_GALGAS_sourceFiles_for_tool (_inLexique,  var_cas_inComponentNameSet,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_GENERATED_BY_GALGAS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (864)) ;
  GGS_stringlist  var_cas_fileListOf_LIBPM_BDD_group ;
  var_cas_fileListOf_LIBPM_BDD_group = GGS_stringlist ::constructor_emptyList () ;
  ::routine_build_LIBPM_BDD_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (874)) ;
  ...
  ::routine_build_LIBPM_CACHE_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_CACHE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (883)) ;
  ...
  ::routine_build_LIBPM_COLLECTIONS_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_COLLECTIONS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (892)) ;
  ...
  ::routine_build_LIBPM_GALGAS_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (901)) ;
  ...
  ::routine_build_LIBPM_FILES_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_FILE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (910)) ;
  ...
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (919)) ;
  ...
  ::routine_build_LIBPM_STREAMS_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_STREAMS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (928)) ;
  ...
  ::routine_build_LIBPM_TIME_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_TIME_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (937)) ;
  ...
  ::routine_build_LIBPM_TINYXML_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_TINYXML_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (946)) ;
  ...
  ::routine_build_LIBPM_UTILITIES_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_UTILITIES_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (955)) ;
  ...
  ::routine_build_LIBPM_UNICODE_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_UNICODE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (964)) ;
  ...
  var_cas_productGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (973))) ;
  ...
  var_cas_targetList._addAssign_operation (GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (984)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (984)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (984)), var_cas_inProjectName, var_cas_toolTargetBuildConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (986)), GGS_string (true, "$(HOME)/bin"), var_cas_inProjectName, var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)), GGS_string (true, "tool"), GGS_Xcode_PBXSourcesBuildPhase_list ::constructor_listWithValue (var_cas_compileSourcesForToolTargetBuildPhase)) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_generatedByGalgasGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (997))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_handCodedSourcesGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1001))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cachesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1007))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_bddSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1011))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_collectionSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1015))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cocoaGALGASSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1019))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cocoaUtilitiesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1023))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_commandLineInterfaceSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1027))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_filesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1031))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_GALGASSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1035))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_streamsSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1039))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_timeSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1043))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_tinyXMLSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1047))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_unicodeSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1051))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_utilitiesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_libpmGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1059))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_resourcesGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1063))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_frameworksGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1067))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_productsGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1071))) ;
  ...
  var_cas_p = GGS_Xcode_rootObject ::constructor_new (_inLexique, var_cas_inProjectName, GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1120)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (1120)), var_cas_groupList, var_cas_mainGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1122)), var_cas_buildConfigurationList, var_cas_targetList, var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1125)), var_cas_PBXFileReferenceList, var_cas_PBXSourcesBuildPhase_list, var_cas_PBXBuildFile_list COMMA_HERE) ;
  GGS_string var_cas_fileNewContents ;
  const GGS_Xcode_rootObject  _temp_42597 = var_cas_p ;
  if (_temp_42597._isBuilt ()) {
    _temp_42597 (HERE)->method_build (_inLexique, var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  }
  GGS_string var_cas_dir ;
  var_cas_dir = var_cas_in_pbxproj_filePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (1135)) ;
  const GGS_string _temp_42748 = var_cas_dir ;
  if (_temp_42748._isBuilt ()) {
    _temp_42748 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (1136)) ;
  }
  GGS_stringlist  var_cas_pbxuser_files ;
  var_cas_pbxuser_files = var_cas_dir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1137)) ;
  {
    GGS_stringlist::cEnumerator enumerator_42888 (var_cas_pbxuser_files, true) ;
    const GGS_stringlist::cElement * operand_42888 = NULL ;
    while (((operand_42888 = enumerator_42888.nextObject ()))) {
      macroValidPointer (operand_42888) ;
      GGS_string var_cas_fullPath ;
      var_cas_fullPath = ((var_cas_dir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_42888->mValue) ;
      GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1140)) ;
    }
  }
  const GGS_string _temp_43041 = var_cas_fileNewContents ;
  if (_temp_43041._isBuilt ()) {
    _temp_43041 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_in_pbxproj_filePath COMMA_SOURCE_FILE_AT_LINE (1142)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
