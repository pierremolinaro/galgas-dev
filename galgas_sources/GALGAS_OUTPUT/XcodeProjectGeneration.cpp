...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17452 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17452.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17452._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_17452.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17994 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17994.hc ()) {
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  enumerator_17994._key (HERE) COMMA_SOURCE_FILE_AT_LINE (590)) ;
      enumerator_17994.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_18083 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_18083.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_18083._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_18083.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18603 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18603.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_18603._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (612)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_18603._key (HERE)) ;
      }
      enumerator_18603.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19292 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19292.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19292._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (634)) ;
      if ((((var_cas_extension)._operator_isNotEqual (GGS_string (true, "cpp")))._operator_and ((var_cas_extension)._operator_isNotEqual (GGS_string (true, "c")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19292._key (HERE)) ;
      }
      enumerator_19292.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19912 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19912.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19912._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (656)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19912._key (HERE)) ;
      }
      enumerator_19912.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & _inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_20652 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_20652.hc ()) {
      if (((enumerator_20652._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (681)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20652._key (HERE)) ;
      }
      enumerator_20652.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_20786 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_20786.hc ()) {
      if (((enumerator_20786._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (686)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20786._key (HERE)) ;
      }
      enumerator_20786.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_21344 (var_cas_inExternFileSet, true) ;
    while (enumerator_21344.hc ()) {
      if (((enumerator_21344._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (707)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_21344._key (HERE)) ;
      }
      enumerator_21344.next () ;
    }
  }
