...
//                    september 17th, 2008, at 18h47'37"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  var_cas_tinyXMLSubGroupKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (192)) ;
  ...
  var_cas_libpmGroupKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (196)) ;
  ...
  var_cas_mainGroupKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (200)) ;
  ...
  var_cas_projectDefaultConfigurationKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (241)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (241)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (241)) ;
  var_cas_buildConfigurationList._addAssign_operation (var_cas_projectDefaultConfigurationKey, GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (242)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (242)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (242)), var_cas_projectDefaultSettings) ;
  GGS_Xcode_rootObject  var_cas_p ;
  var_cas_p = GGS_Xcode_rootObject ::constructor_new (_inLexique, var_cas_inProjectName, GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (246)), var_cas_groupList, var_cas_mainGroupKey, var_cas_buildConfigurationList, var_cas_targetList, var_cas_projectDefaultConfigurationKey COMMA_HERE) ;
  GGS_string var_cas_fileNewContents ;
  const GGS_Xcode_rootObject  _temp_11633 = var_cas_p ;
  if (_temp_11633._isBuilt ()) {
    _temp_11633 (HERE)->method_build (_inLexique, var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (255)) ;
  }
  const GGS_string _temp_11761 = var_cas_in_pbxproj_filePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
  if (_temp_11761._isBuilt ()) {
    _temp_11761 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
  }
  const GGS_string _temp_11816 = var_cas_fileNewContents ;
  if (_temp_11816._isBuilt ()) {
    _temp_11816 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_in_pbxproj_filePath COMMA_SOURCE_FILE_AT_LINE (259)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
