...
void routine_build_LIBPM_COCOA_GALGAS_group (C_Compiler & inLexique,
  ...
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_BuildResult") COMMA_SOURCE_FILE_AT_LINE (150)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_CommandLineOption") COMMA_SOURCE_FILE_AT_LINE (151)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("enterDefaultCommandLineOptions") COMMA_SOURCE_FILE_AT_LINE (152)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_Document") COMMA_SOURCE_FILE_AT_LINE (153)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_PreferencesController") COMMA_SOURCE_FILE_AT_LINE (154)) ;
  ::routine_append_m_h_files (inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_RulerView") COMMA_SOURCE_FILE_AT_LINE (155)) ;
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_16810 (var_cas_inComponentNameSet, true) ;
    while (enumerator_16810.hasCurrentObject ()) {
      var_cas_fileList._addAssign_operation ((enumerator_16810._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_16810.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17352 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17352.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_17352._key (HERE) COMMA_SOURCE_FILE_AT_LINE (560)) ;
      enumerator_17352.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_17441 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_17441.hasCurrentObject ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17441._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_17441.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17960 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_17960.hasCurrentObject ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_17960._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (582)) ;
      if ((((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_17960._key (HERE)) ;
      }
      enumerator_17960.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18649 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18649.hasCurrentObject ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_18649._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) ;
      if ((((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_18649._key (HERE)) ;
      }
      enumerator_18649.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19312 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19312.hasCurrentObject ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19312._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (626)) ;
      if ((((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19312._key (HERE)) ;
      }
      enumerator_19312.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_20052 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_20052.hasCurrentObject ()) {
      if (((enumerator_20052._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (651))).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20052._key (HERE)) ;
      }
      enumerator_20052.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_20186 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_20186.hasCurrentObject ()) {
      if (((enumerator_20186._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (656))).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20186._key (HERE)) ;
      }
      enumerator_20186.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_20744 (var_cas_inExternFileSet, true) ;
    while (enumerator_20744.hasCurrentObject ()) {
      if (((enumerator_20744._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (677))).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_20744._key (HERE)) ;
      }
      enumerator_20744.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_23033 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_23033.hasCurrentObject ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23033._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_23033.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_23136 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_23136.hasCurrentObject ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_23136._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (752)) ;
      if ((((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_23136._key (HERE)) ;
      }
      enumerator_23136.next () ;
    }
  }
