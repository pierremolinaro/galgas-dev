...
void routine_getGALGAS_source_file_list (C_Compiler &,
  ...
  var_cas_out_cpp_and_h_fileList._addAssign_operation (GGS_string (true, "xml_types")) ;
...
void routine_build_LIBPM_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_3832 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_3832 = NULL ;
    while (((operand_3832 = enumerator_3832.nextObject ()))) {
      macroValidPointer (operand_3832) ;
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  operand_3832->mValue COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_4476 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_4476 = NULL ;
    while (((operand_4476 = enumerator_4476.nextObject ()))) {
      macroValidPointer (operand_4476) ;
      var_cas_fileList._addAssign_operation ((operand_4476->mValue)._operator_concat (GGS_string (true, ".cpp"))) ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17455 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17455.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17455._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_17455.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17997 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17997.hc ()) {
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  enumerator_17997._key (HERE) COMMA_SOURCE_FILE_AT_LINE (591)) ;
      enumerator_17997.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_18086 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_18086.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_18086._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_18086.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18606 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18606.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_18606._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (613)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_18606._key (HERE)) ;
      }
      enumerator_18606.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19295 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19295.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19295._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (635)) ;
      if ((((var_cas_extension)._operator_isNotEqual (GGS_string (true, "cpp")))._operator_and ((var_cas_extension)._operator_isNotEqual (GGS_string (true, "c")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19295._key (HERE)) ;
      }
      enumerator_19295.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19915 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19915.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19915._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (657)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19915._key (HERE)) ;
      }
      enumerator_19915.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & _inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_20655 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_20655.hc ()) {
      if (((enumerator_20655._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (682)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20655._key (HERE)) ;
      }
      enumerator_20655.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_20789 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_20789.hc ()) {
      if (((enumerator_20789._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (687)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20789._key (HERE)) ;
      }
      enumerator_20789.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_21347 (var_cas_inExternFileSet, true) ;
    while (enumerator_21347.hc ()) {
      if (((enumerator_21347._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (708)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_21347._key (HERE)) ;
      }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "md5.cpp")) ;
  {
    GGS_stringset::cEnumerator enumerator_24805 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_24805.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24805._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_24805.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24888 (var_cas_inScannerSourceNameSet, true) ;
    while (enumerator_24888.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24888._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24888.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24971 (var_cas_inOptionSourceNameSet, true) ;
    while (enumerator_24971.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24971._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24971.next () ;
    }
  }
