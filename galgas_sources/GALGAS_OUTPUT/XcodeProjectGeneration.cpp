...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (((operand_4463 = enumerator_4463.nextObject ()))) {
      ...
      var_cas_fileList._addAssign_operation ((operand_4463->mValue)._operator_concat (GGS_string (".cpp"))) ;
    }
  }
...
void routine_build_LIBPM_COCOA_GALGAS_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_m_h_files (_inLexique,  var_cas_fileList,  GGS_string ("NSSplitViewExtensions") COMMA_SOURCE_FILE_AT_LINE (143)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_BuildWindowController") COMMA_SOURCE_FILE_AT_LINE (144)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_Document") COMMA_SOURCE_FILE_AT_LINE (145)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_PreferencesController") COMMA_SOURCE_FILE_AT_LINE (146)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_RulerView") COMMA_SOURCE_FILE_AT_LINE (147)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_TextView") COMMA_SOURCE_FILE_AT_LINE (148)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_DelegateForSyntaxColoring") COMMA_SOURCE_FILE_AT_LINE (149)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("OC_GGS_BuildResultTextView") COMMA_SOURCE_FILE_AT_LINE (150)) ;
  ::routine_append_mm_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_SourceTextForCocoa") COMMA_SOURCE_FILE_AT_LINE (151)) ;
  ...
  ::routine_enter_nib_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("MainMenu.nib"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (159)) ;
  ::routine_enter_nib_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("OC_GGS_Document.nib"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (165)) ;
...
void routine_build_LIBPM_FILES_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_HTML_FileWrite") COMMA_SOURCE_FILE_AT_LINE (202)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_TextFileWrite") COMMA_SOURCE_FILE_AT_LINE (203)) ;
...
void routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_builtin_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (236)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("AC_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (237)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_CLI_OptionGroup") COMMA_SOURCE_FILE_AT_LINE (238)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("F_Analyze_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (239)) ;
...
void routine_build_LIBPM_CACHE_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_PrimeCache2") COMMA_SOURCE_FILE_AT_LINE (304)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_PrimeCache3") COMMA_SOURCE_FILE_AT_LINE (305)) ;
...
void routine_build_PROJECT_RESOURCES_group (C_Compiler & _inLexique,
  ...
  ::routine_enter_nib_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("Credits.rtf"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (345)) ;
  ::routine_enter_nib_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("English.lproj"),  GGS_string ("InfoPlist.strings"),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (351)) ;
...
void routine_build_LIBPM_STRINGS_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_String") COMMA_SOURCE_FILE_AT_LINE (374)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("unicode_character") COMMA_SOURCE_FILE_AT_LINE (375)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("unicode_string_routines") COMMA_SOURCE_FILE_AT_LINE (376)) ;
...
void routine_build_LIBPM_UTILITIES_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("md5") COMMA_SOURCE_FILE_AT_LINE (414)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_Exception") COMMA_SOURCE_FILE_AT_LINE (415)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("F_GetPrime") COMMA_SOURCE_FILE_AT_LINE (416)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("F_DisplayException") COMMA_SOURCE_FILE_AT_LINE (417)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("MF_Assert") COMMA_SOURCE_FILE_AT_LINE (418)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("MF_MemoryControl") COMMA_SOURCE_FILE_AT_LINE (419)) ;
...
void routine_build_LIBPM_STREAMS_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_ErrorOut") COMMA_SOURCE_FILE_AT_LINE (460)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("AC_OutputStream") COMMA_SOURCE_FILE_AT_LINE (461)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_ConsoleOut") COMMA_SOURCE_FILE_AT_LINE (462)) ;
...
void routine_build_LIBPM_TIME_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_DateTime") COMMA_SOURCE_FILE_AT_LINE (496)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string ("C_Timer") COMMA_SOURCE_FILE_AT_LINE (497)) ;
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_16388.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_16388._key (HERE))._operator_concat (GGS_string (".cpp"))) ;
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & _inLexique,
  ...
  }
  {
    ...
    while (enumerator_17019.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17019._key (HERE))._operator_concat (GGS_string (".mm"))) ;
...
void routine_build_FRAMEWORKS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileSet._addAssign_operation (GGS_string ("Cocoa.framework")) ;
  {
    ...
    while (enumerator_19588.hc ()) {
      if (((enumerator_19588._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (643)))._operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    while (enumerator_19722.hc ()) {
      if (((enumerator_19722._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (648)))._operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_20280.hc ()) {
      if (((enumerator_20280._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (669)))._operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string ("md5.cpp")) ;
  {
    ...
    while (enumerator_23742.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23742._key (HERE))._operator_concat (GGS_string (".mm"))) ;
  ...
  }
  {
    ...
    while (enumerator_23825.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23825._key (HERE))._operator_concat (GGS_string (".cpp"))) ;
  ...
  }
  {
    ...
    while (enumerator_23908.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23908._key (HERE))._operator_concat (GGS_string (".cpp"))) ;
