...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17373 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17373.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_17373._key (HERE) COMMA_SOURCE_FILE_AT_LINE (560)) ;
      enumerator_17373.next () ;
    }
  }
  {
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17981 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_17981.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_17981._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (582)) ;
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18670 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18670.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_18670._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) ;
      if ((((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm")))).isBuiltAndTrue ()) {
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19333 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19333.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_19333._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (626)) ;
      if ((((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm")))).isBuiltAndTrue ()) {
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_23157 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_23157.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_23157._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (752)) ;
