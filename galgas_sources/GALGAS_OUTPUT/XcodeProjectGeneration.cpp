...
void routine_build_LIBPM_GALGAS_group (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_4169 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_4169 = NULL ;
    while (((operand_4169 = enumerator_4169.nextObject ()))) {
      macroValidPointer (operand_4169) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_4169->mValue COMMA_SOURCE_FILE_AT_LINE (112)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_4813 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_4813 = NULL ;
    while (((operand_4813 = enumerator_4813.nextObject ()))) {
      macroValidPointer (operand_4813) ;
      var_cas_fileList.addAssign_operation ((operand_4813->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18356 (var_cas_inComponentNameSet, true) ;
    while (enumerator_18356.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_18356._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_18356.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18898 (var_cas_inComponentNameSet, true) ;
    while (enumerator_18898.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_18898._key (HERE) COMMA_SOURCE_FILE_AT_LINE (597)) ;
      enumerator_18898.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_18987 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_18987.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_18987._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_18987.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19506 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19506.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_19506._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_19686 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_19686.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_19506._key (HERE)) ;
      }
      enumerator_19506.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_20195 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_20195.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_20195._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_20375 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_20375.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_20195._key (HERE)) ;
      }
      enumerator_20195.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_20858 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_20858.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_20858._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_21038 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_21038.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_20858._key (HERE)) ;
      }
      enumerator_20858.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_CompilerEx & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_21598 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_21598.hasCurrentObject ()) {
      const GGS_bool cond_21680 = (enumerator_21598._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_21680.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_21598._key (HERE)) ;
      }
      enumerator_21598.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_21732 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_21732.hasCurrentObject ()) {
      const GGS_bool cond_21814 = (enumerator_21732._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_21814.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_21732._key (HERE)) ;
      }
      enumerator_21732.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_CompilerEx & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22290 (var_cas_inExternFileSet, true) ;
    while (enumerator_22290.hasCurrentObject ()) {
      const GGS_bool cond_22373 = (enumerator_22290._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_22373.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_22290._key (HERE)) ;
      }
      enumerator_22290.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_CompilerEx & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_25092 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_25092.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_25092._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_25092.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_25195 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_25195.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_25195._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_25375 = ((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_25375.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_25195._key (HERE)) ;
      }
      enumerator_25195.next () ;
    }
  }
...
void routine_generateXcodeProject (C_CompilerEx & inLexique,
  ...
  GGS_string automatic_var_41115_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_41115_0 COMMA_SOURCE_FILE_AT_LINE (1305)) ;
