...
void routine_build_LIBPM_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_6921 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_6921 = NULL ;
    while (((operand_6921 = enumerator_6921.nextObject ()))) {
      macroValidPointer (operand_6921) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_6921->mValue COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_7936 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_7936 = NULL ;
    while (((operand_7936 = enumerator_7936.nextObject ()))) {
      macroValidPointer (operand_7936) ;
      var_cas_cppFileList.addAssign_operation ((operand_7936->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_cppFileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_8497 (var_cas_fileList, true) ;
    const GGS_stringlist::cElement * operand_8497 = NULL ;
    while (((operand_8497 = enumerator_8497.nextObject ()))) {
      macroValidPointer (operand_8497) ;
      const GGS_bool cond_8583 = (operand_8497->mValue.reader_pathExtension ()).operator_isEqual (GGS_string ("cpp")) ;
      if (cond_8583.isBuiltAndTrue ()) {
        var_cas_cppFileList.addAssign_operation (operand_8497->mValue) ;
      }
    }
  }
...
void routine_build_LIBPM_GALGAS_UTILITIES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_9129 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_9129 = NULL ;
    while (((operand_9129 = enumerator_9129.nextObject ()))) {
      macroValidPointer (operand_9129) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_9129->mValue COMMA_SOURCE_FILE_AT_LINE (260)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_9754 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_9754 = NULL ;
    while (((operand_9754 = enumerator_9754.nextObject ()))) {
      macroValidPointer (operand_9754) ;
      var_cas_fileList.addAssign_operation ((operand_9754->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22423 (var_cas_inComponentNameSet, true) ;
    while (enumerator_22423.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_22423._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_22423.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22965 (var_cas_inComponentNameSet, true) ;
    while (enumerator_22965.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_22965._key (HERE) COMMA_SOURCE_FILE_AT_LINE (710)) ;
      enumerator_22965.next () ;
    }
  }
  {
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_24262 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_24262.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24262._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_24442 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_24442.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24262._key (HERE)) ;
      }
      enumerator_24262.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_24925 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_24925.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24925._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_25105 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_25105.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24925._key (HERE)) ;
      }
      enumerator_24925.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_25665 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_25665.hasCurrentObject ()) {
      const GGS_bool cond_25747 = (enumerator_25665._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_25747.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_25665._key (HERE)) ;
      }
      enumerator_25665.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_25799 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_25799.hasCurrentObject ()) {
      const GGS_bool cond_25881 = (enumerator_25799._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_25881.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_25799._key (HERE)) ;
      }
      enumerator_25799.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_26357 (var_cas_inExternFileSet, true) ;
    while (enumerator_26357.hasCurrentObject ()) {
      const GGS_bool cond_26440 = (enumerator_26357._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_26440.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_26357._key (HERE)) ;
      }
      enumerator_26357.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_29159 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_29159.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_29159._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_29159.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_29262 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_29262.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_29262._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_29442 = ((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_29442.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_29262._key (HERE)) ;
      }
      enumerator_29262.next () ;
    }
  }
...
void routine_generateXcodeProject (C_Compiler & inLexique,
  ...
  GGS_string automatic_var_46040_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_46040_0 COMMA_SOURCE_FILE_AT_LINE (1443)) ;
