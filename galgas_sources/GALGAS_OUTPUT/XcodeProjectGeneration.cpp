...
void routine_build_LIBPM_UTILITIES_group (C_Compiler & inLexique,
  ...
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("F_GetPrime") COMMA_SOURCE_FILE_AT_LINE (561)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("F_DisplayException") COMMA_SOURCE_FILE_AT_LINE (562)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("MF_Assert") COMMA_SOURCE_FILE_AT_LINE (563)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("cpp-allocation") COMMA_SOURCE_FILE_AT_LINE (564)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("basic-allocation") COMMA_SOURCE_FILE_AT_LINE (565)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("MF_MemoryControl") COMMA_SOURCE_FILE_AT_LINE (566)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_PrologueEpilogue") COMMA_SOURCE_FILE_AT_LINE (567)) ;
...
void routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (597)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_STREAMS_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_ErrorOut") COMMA_SOURCE_FILE_AT_LINE (611)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("AC_OutputStream") COMMA_SOURCE_FILE_AT_LINE (612)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_ConsoleOut") COMMA_SOURCE_FILE_AT_LINE (613)) ;
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (615)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_TIME_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_DateTime") COMMA_SOURCE_FILE_AT_LINE (647)) ;
  ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  GGS_string ("C_Timer") COMMA_SOURCE_FILE_AT_LINE (648)) ;
...
void routine_build_LIBPM_TIME_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (667)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_21650 (var_cas_inComponentNameSet, true) ;
    while (enumerator_21650.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_21650._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_21650.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (686)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22192 (var_cas_inComponentNameSet, true) ;
    while (enumerator_22192.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_22192._key (HERE) COMMA_SOURCE_FILE_AT_LINE (703)) ;
      enumerator_22192.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_22281 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_22281.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_22281._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_22281.next () ;
    }
  }
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (709)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22800 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_22800.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_22800._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_22980 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_22980.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_22800._key (HERE)) ;
      }
      enumerator_22800.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_23489 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_23489.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_23489._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_23669 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_23669.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_23489._key (HERE)) ;
      }
      enumerator_23489.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (753)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_24152 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_24152.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24152._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_24332 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_24332.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24152._key (HERE)) ;
      }
      enumerator_24152.next () ;
    }
  }
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (775)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_24892 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_24892.hasCurrentObject ()) {
      const GGS_bool cond_24974 = (enumerator_24892._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_24974.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_24892._key (HERE)) ;
      }
      enumerator_24892.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_25026 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_25026.hasCurrentObject ()) {
      const GGS_bool cond_25108 = (enumerator_25026._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_25108.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_25026._key (HERE)) ;
      }
      enumerator_25026.next () ;
    }
  }
  ::routine_enter_files_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileSet.reader_stringList (inLexique COMMA_SOURCE_FILE_AT_LINE (806)),  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (804)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_25584 (var_cas_inExternFileSet, true) ;
    while (enumerator_25584.hasCurrentObject ()) {
      const GGS_bool cond_25667 = (enumerator_25584._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_25667.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_25584._key (HERE)) ;
      }
      enumerator_25584.next () ;
    }
  }
  ::routine_enter_files_for_frameworks_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (825)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_28386 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_28386.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_28386._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_28386.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_28489 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_28489.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_28489._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_28669 = ((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_28669.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_28489._key (HERE)) ;
      }
      enumerator_28489.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (911)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateXcodeProject (C_Compiler & inLexique,
  ...
  ::routine_initXcodeProjectDescription (inLexique,  var_cas_XcodeProjectDescription COMMA_SOURCE_FILE_AT_LINE (943)) ;
  ...
  ::routine_build_HAND_CODED_SOURCES_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileSet,  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (950)) ;
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Hand Coded Sources"),  GGS_string ("../galgas_sources"),  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (956)) ;
  ...
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Generated by GALGAS"),  GGS_string ("../galgas_sources/GALGAS_OUTPUT"),  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (981)) ;
  ...
  ::routine_build_LIBPM_BDD_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_BDD_group COMMA_SOURCE_FILE_AT_LINE (991)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Binary Decision Diagrams"),  GGS_string ("bdd"),  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (996)) ;
  GGS_XcodeObjectReferenceList  var_cas_fileListOf_LIBPM_CACHE_group = GGS_XcodeObjectReferenceList ::constructor_emptyList () ;
  ::routine_build_LIBPM_CACHE_group (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_CACHE_group COMMA_SOURCE_FILE_AT_LINE (1005)) ;
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Caches"),  GGS_string ("cache"),  var_cas_fileListOf_LIBPM_CACHE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  ...
  ::routine_enter_subgroup (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("GALGAS UTILITIES"),  GGS_string ("galgas-utilities"),  var_cas_fileListOf_LIBPM_GALGAS_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1133)) ;
  ...
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1251)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1256)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1261)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1266)) ;
  ::routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1271)) ;
  ::routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1276)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1281)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1286)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1291)) ;
  ::routine_build_LIBPM_STRINGS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1296)) ;
  GGS_Xcode_PBXBuildFile_list  var_cas_listForFrameworksBuildPhaseOfTool = GGS_Xcode_PBXBuildFile_list ::constructor_emptyList () ;
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForFrameworksBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1302)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet_tool,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1332)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1343)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1348)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1353)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1358)) ;
  ::routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1363)) ;
  ::routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1368)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1373)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1378)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1383)) ;
  ::routine_build_LIBPM_STRINGS_files_for_sources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1388)) ;
  ...
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_tool,  var_cas_listForFrameworksBuildPhaseOfToolDebug COMMA_SOURCE_FILE_AT_LINE (1394)) ;
  ...
  var_cas_fileSet.addAssign_operation (GGS_string ("AppKit.framework")) ;
  var_cas_fileSet.addAssign_operation (GGS_string ("Cocoa.framework")) ;
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileSet,  var_cas_listForFrameworksBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1432)) ;
  ...
  ::routine_build_RESOURCES_for_resources_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  var_cas_inIconFiles,  var_cas_listForResourcesBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1439)) ;
  ::routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet_app,  var_cas_listForResourcesBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1446)) ;
  ...
  GGS_string automatic_var_45790_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_45790_0 COMMA_SOURCE_FILE_AT_LINE (1459)) ;
  ...
  ::routine_enterProjectDefaultSettings (inLexique,  var_cas_pathes,  var_cas_projectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1478)) ;
  ::routine_generateXCodeFile (inLexique,  var_cas_XcodeProjectDescription,  var_cas_in_xcodeproj_filePath,  var_cas_projectDefaultSettings,  var_cas_inReferenceFilePath COMMA_SOURCE_FILE_AT_LINE (1484)) ;
  #ifdef DEBUG_TRACE_ENABLED
