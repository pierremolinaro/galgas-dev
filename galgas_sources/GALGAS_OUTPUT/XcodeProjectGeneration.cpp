...
void routine_build_LIBPM_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_7183 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_7183 = NULL ;
    while (((operand_7183 = enumerator_7183.nextObject ()))) {
      macroValidPointer (operand_7183) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_7183->mValue COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_8198 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_8198 = NULL ;
    while (((operand_8198 = enumerator_8198.nextObject ()))) {
      macroValidPointer (operand_8198) ;
      var_cas_cppFileList.addAssign_operation ((operand_8198->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_2_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_cppFileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_8759 (var_cas_fileList, true) ;
    const GGS_stringlist::cElement * operand_8759 = NULL ;
    while (((operand_8759 = enumerator_8759.nextObject ()))) {
      macroValidPointer (operand_8759) ;
      const GGS_bool cond_8845 = (operand_8759->mValue.reader_pathExtension ()).operator_isEqual (GGS_string ("cpp")) ;
      if (cond_8845.isBuiltAndTrue ()) {
        var_cas_cppFileList.addAssign_operation (operand_8759->mValue) ;
      }
    }
  }
...
void routine_build_LIBPM_GALGAS_UTILITIES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_9391 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_9391 = NULL ;
    while (((operand_9391 = enumerator_9391.nextObject ()))) {
      macroValidPointer (operand_9391) ;
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  operand_9391->mValue COMMA_SOURCE_FILE_AT_LINE (266)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_UTILITIES_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_10016 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_10016 = NULL ;
    while (((operand_10016 = enumerator_10016.nextObject ()))) {
      macroValidPointer (operand_10016) ;
      var_cas_fileList.addAssign_operation ((operand_10016->mValue).operator_concat (GGS_string (".cpp"))) ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22685 (var_cas_inComponentNameSet, true) ;
    while (enumerator_22685.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_22685._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_22685.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_23227 (var_cas_inComponentNameSet, true) ;
    while (enumerator_23227.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_23227._key (HERE) COMMA_SOURCE_FILE_AT_LINE (716)) ;
      enumerator_23227.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_23316 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_23316.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_23316._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_23316.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_23835 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_23835.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_23835._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_24015 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_24015.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_23835._key (HERE)) ;
      }
      enumerator_23835.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_24524 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_24524.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24524._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_24704 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_24704.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24524._key (HERE)) ;
      }
      enumerator_24524.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_25187 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_25187.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_25187._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_25367 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_25367.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_25187._key (HERE)) ;
      }
      enumerator_25187.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_25927 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_25927.hasCurrentObject ()) {
      const GGS_bool cond_26009 = (enumerator_25927._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_26009.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_25927._key (HERE)) ;
      }
      enumerator_25927.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_26061 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_26061.hasCurrentObject ()) {
      const GGS_bool cond_26143 = (enumerator_26061._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_26143.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_26061._key (HERE)) ;
      }
      enumerator_26061.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_26619 (var_cas_inExternFileSet, true) ;
    while (enumerator_26619.hasCurrentObject ()) {
      const GGS_bool cond_26702 = (enumerator_26619._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_26702.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_26619._key (HERE)) ;
      }
      enumerator_26619.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_29421 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_29421.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_29421._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_29421.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_29524 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_29524.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_29524._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_29704 = ((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_29704.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_29524._key (HERE)) ;
      }
      enumerator_29524.next () ;
    }
  }
...
void routine_generateXcodeProject (C_Compiler & inLexique,
  ...
  GGS_string automatic_var_46302_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_46302_0 COMMA_SOURCE_FILE_AT_LINE (1449)) ;
