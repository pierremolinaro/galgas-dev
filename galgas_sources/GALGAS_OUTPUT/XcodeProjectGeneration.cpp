...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  if (((var_cas_inExternSourceNameSet.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (796)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    ::routine_build_HAND_CODED_SOURCES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (798)) ;
    ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Hand Coded Sources"),  GGS_string (true, "../hand_coded_sources"),  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (804)) ;
  }
  ...
  ::routine_build_GENERATED_BY_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet,  var_cas_inGUISourceNameSet,  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (818)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Generated by GALGAS"),  GGS_string (true, "../galgas_sources/GALGAS_OUTPUT"),  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (825)) ;
  ...
  ::routine_build_LIBPM_BDD_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_BDD_group COMMA_SOURCE_FILE_AT_LINE (835)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Binary Decision Diagrams"),  GGS_string (true, "bdd"),  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (840)) ;
  ...
  ::routine_build_LIBPM_CACHE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_CACHE_group COMMA_SOURCE_FILE_AT_LINE (849)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Caches"),  GGS_string (true, "cache"),  var_cas_fileListOf_LIBPM_CACHE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (854)) ;
  ...
  ::routine_build_LIBPM_COCOA_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (863)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Cocoa GALGAS"),  GGS_string (true, "cocoa_galgas"),  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (867)) ;
  ...
  ::routine_build_LIBPM_COCOA_UTILITIES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (876)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Cocoa Utilities"),  GGS_string (true, "cocoa_utilities"),  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (880)) ;
  ...
  ::routine_build_LIBPM_COLLECTIONS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COLLECTIONS_group COMMA_SOURCE_FILE_AT_LINE (889)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Collections"),  GGS_string (true, "collections"),  var_cas_fileListOf_LIBPM_COLLECTIONS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (894)) ;
  ...
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group COMMA_SOURCE_FILE_AT_LINE (903)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Command Line Interface"),  GGS_string (true, "command_line_interface"),  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (908)) ;
  ...
  ::routine_build_LIBPM_FILES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_FILE_group COMMA_SOURCE_FILE_AT_LINE (917)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Files"),  GGS_string (true, "files"),  var_cas_fileListOf_LIBPM_FILE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (922)) ;
  ...
  ::routine_build_LIBPM_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (931)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "GALGAS"),  GGS_string (true, "galgas"),  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (936)) ;
  ...
  ::routine_build_LIBPM_STREAMS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_STREAMS_group COMMA_SOURCE_FILE_AT_LINE (945)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Streams"),  GGS_string (true, "streams"),  var_cas_fileListOf_LIBPM_STREAMS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (950)) ;
  ...
  ::routine_build_LIBPM_TIME_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TIME_group COMMA_SOURCE_FILE_AT_LINE (959)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Time"),  GGS_string (true, "time"),  var_cas_fileListOf_LIBPM_TIME_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (964)) ;
  ...
  ::routine_build_LIBPM_TINYXML_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TINYXML_group COMMA_SOURCE_FILE_AT_LINE (973)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Tiny XML"),  GGS_string (true, "tiny_xml"),  var_cas_fileListOf_LIBPM_TINYXML_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (978)) ;
  ...
  ::routine_build_LIBPM_UTILITIES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (987)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Utilities"),  GGS_string (true, "utilities"),  var_cas_fileListOf_LIBPM_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (992)) ;
  ...
  ::routine_build_LIBPM_UNICODE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UNICODE_group COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Unicode"),  GGS_string (true, "unicode"),  var_cas_fileListOf_LIBPM_UNICODE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1006)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "LIBPM"),  GGS_string (true, "../../libpm"),  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  ...
  ::routine_build_PROJECT_RESOURCES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inIconFiles,  var_cas_fileListOf_PROJECT_RESOURCES_group COMMA_SOURCE_FILE_AT_LINE (1022)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Project Resources"),  GGS_string (true, ""),  var_cas_fileListOf_PROJECT_RESOURCES_group COMMA_SOURCE_FILE_AT_LINE (1027)) ;
  ...
  ::routine_build_FRAMEWORKS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Frameworks"),  GGS_string (true, "/System/Library/Frameworks"),  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (1040)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1049)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1055)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1061)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1066)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1071)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1076)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1081)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1086)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1091)) ;
  ::routine_build_LIBPM_TINYXML_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1096)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1101)) ;
  ::routine_build_LIBPM_UNICODE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1106)) ;
  ...
  ::routine_add_tool_target (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1118)))._operator_concat (GGS_string (true, " Tool")),  var_cas_toolTargetSettings,  GGS_string (true, "../../libpm/galgas/PP_GalgasPrefix.pch"),  var_cas_listForSourceBuildPhaseOfTool,  GGS_stringlist ::constructor_emptyList (),  var_cas_toolTargetKey COMMA_SOURCE_FILE_AT_LINE (1115)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1128)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1140)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1145)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1150)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1155)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1160)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1165)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1170)) ;
  ::routine_build_LIBPM_TINYXML_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1175)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1180)) ;
  ::routine_build_LIBPM_UNICODE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1185)) ;
  ...
  ::routine_add_tool_target (_inLexique,  var_cas_XcodeProjectDescription,  (var_cas_inProjectName)._operator_concat (GGS_string (true, "_debug")),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1198)))._operator_concat (GGS_string (true, " Tool Debug")),  var_cas_debugToolTargetSettings,  GGS_string (true, ""),  var_cas_listForSourceBuildPhaseOfDebugTool,  GGS_stringlist ::constructor_emptyList (),  var_cas_toolDebugTargetKey COMMA_SOURCE_FILE_AT_LINE (1195)) ;
  ...
  ::routine_build_COCOA_APP_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inGUISourceNameSet,  var_cas_inScannerSourceNameSet,  var_cas_inOptionSourceNameSet,  var_cas_listForSourceBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1208)) ;
  ...
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForFrameworksBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1217)) ;
  ...
  ::routine_build_RESOURCES_for_resources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  var_cas_inIconFiles,  var_cas_listForResourcesBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1223)) ;
  ...
  ::routine_add_app_target (_inLexique,  var_cas_XcodeProjectDescription,  (GGS_string (true, "Cocoa"))._operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1239))),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1240)))._operator_concat (GGS_string (true, " Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string (true, "../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string (true, "Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1237)) ;
  GGS_stringset  var_cas_pathSet ;
  var_cas_pathSet = GGS_stringset ::constructor_emptySet () ;
  {
    GGS_stringset::cEnumerator enumerator_37032 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_37032.hc ()) {
      var_cas_pathSet._addAssign_operation ((GGS_string (true, "../hand_coded_sources/"))._operator_concat (enumerator_37032._key (HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (1253)))) ;
      enumerator_37032.next () ;
    }
  }
  GGS_string var_cas_pathString ;
  var_cas_pathString = GGS_string (true, "../galgas_sources/GALGAS_OUTPUT, ../../libpm,") ;
  {
    GGS_stringset::cEnumerator enumerator_37228 (var_cas_pathSet, true) ;
    while (enumerator_37228.hc ()) {
      var_cas_pathString._dotAssign_operation (enumerator_37228._key (HERE)) ;
      var_cas_pathString.writeString (", ") ;
      enumerator_37228.next () ;
    }
  }
  ...
  ::routine_generateXCodeFile (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_in_xcodeproj_filePath,  var_cas_projectDefaultSettings,  var_cas_inProjectName COMMA_SOURCE_FILE_AT_LINE (1299)) ;
  #ifdef DEBUG_TRACE_ENABLED
