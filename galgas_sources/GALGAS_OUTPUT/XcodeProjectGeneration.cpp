...
//                    december 16th, 2009, at 15h38'10"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18105 (var_cas_inComponentNameSet, true) ;
    while (enumerator_18105.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_18105._key (HERE)).operator_concat (GGS_string (".cpp"))) ;
      enumerator_18105.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18647 (var_cas_inComponentNameSet, true) ;
    while (enumerator_18647.hasCurrentObject ()) {
      ::routine_append_cpp_h_files (inLexique,  var_cas_fileList,  enumerator_18647._key (HERE) COMMA_SOURCE_FILE_AT_LINE (593)) ;
      enumerator_18647.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_18736 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_18736.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_18736._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_18736.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19255 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19255.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_19255._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_19435 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_19435.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_19255._key (HERE)) ;
      }
      enumerator_19255.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19944 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19944.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_19944._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_20124 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_20124.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_19944._key (HERE)) ;
      }
      enumerator_19944.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_20607 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_20607.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_20607._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_20787 = ((((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("c")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_20787.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_20607._key (HERE)) ;
      }
      enumerator_20607.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_21347 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_21347.hasCurrentObject ()) {
      const GGS_bool cond_21429 = (enumerator_21347._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_21429.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_21347._key (HERE)) ;
      }
      enumerator_21347.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_21481 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_21481.hasCurrentObject ()) {
      const GGS_bool cond_21563 = (enumerator_21481._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_21563.isBuiltAndTrue ()) {
        var_cas_fileSet.addAssign_operation (enumerator_21481._key (HERE)) ;
      }
      enumerator_21481.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_22039 (var_cas_inExternFileSet, true) ;
    while (enumerator_22039.hasCurrentObject ()) {
      const GGS_bool cond_22122 = (enumerator_22039._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
      if (cond_22122.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_22039._key (HERE)) ;
      }
      enumerator_22039.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_24718 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_24718.hasCurrentObject ()) {
      var_cas_fileList.addAssign_operation ((enumerator_24718._key (HERE)).operator_concat (GGS_string (".m"))) ;
      enumerator_24718.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24821 (var_cas_inExternSourceNameSet_app, true) ;
    while (enumerator_24821.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_24821._key (HERE).reader_pathExtension () ;
      const GGS_bool cond_25001 = ((((var_cas_extension).operator_isEqual (GGS_string ("c"))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("cpp")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("m")))).operator_or ((var_cas_extension).operator_isEqual (GGS_string ("mm"))) ;
      if (cond_25001.isBuiltAndTrue ()) {
        var_cas_fileList.addAssign_operation (enumerator_24821._key (HERE)) ;
      }
      enumerator_24821.next () ;
    }
  }
...
void routine_generateXcodeProject (C_Compiler & inLexique,
  ...
  GGS_string automatic_var_40741_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_40741_0 COMMA_SOURCE_FILE_AT_LINE (1299)) ;
