...
void routine_build_LIBPM_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_3856 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_3856 = NULL ;
    while (((operand_3856 = enumerator_3856.nextObject ()))) {
      macroValidPointer (operand_3856) ;
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  operand_3856->mValue COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
  }
...
void routine_build_LIBPM_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_4500 (var_cas_cpp_and_h_fileList, true) ;
    const GGS_stringlist::cElement * operand_4500 = NULL ;
    while (((operand_4500 = enumerator_4500.nextObject ()))) {
      macroValidPointer (operand_4500) ;
      var_cas_fileList._addAssign_operation ((operand_4500->mValue)._operator_concat (GGS_string (true, ".cpp"))) ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17479 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17479.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17479._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_17479.next () ;
    }
  }
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18021 (var_cas_inComponentNameSet, true) ;
    while (enumerator_18021.hc ()) {
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  enumerator_18021._key (HERE) COMMA_SOURCE_FILE_AT_LINE (591)) ;
      enumerator_18021.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_18110 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_18110.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_18110._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_18110.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18630 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18630.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_18630._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (613)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_18630._key (HERE)) ;
      }
      enumerator_18630.next () ;
    }
  }
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19319 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19319.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19319._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (635)) ;
      if ((((var_cas_extension)._operator_isNotEqual (GGS_string (true, "cpp")))._operator_and ((var_cas_extension)._operator_isNotEqual (GGS_string (true, "c")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19319._key (HERE)) ;
      }
      enumerator_19319.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19939 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19939.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19939._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (657)) ;
      if ((((((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp")))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "c"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))))._operator_or ((var_cas_extension)._operator_isEqual (GGS_string (true, "mm")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19939._key (HERE)) ;
      }
      enumerator_19939.next () ;
    }
  }
...
void routine_build_FRAMEWORKS_group (C_Compiler & _inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_20679 (var_cas_inExternSourceForTool, true) ;
    while (enumerator_20679.hc ()) {
      if (((enumerator_20679._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (682)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20679._key (HERE)) ;
      }
      enumerator_20679.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_20813 (var_cas_inExternSourceForApp, true) ;
    while (enumerator_20813.hc ()) {
      if (((enumerator_20813._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (687)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileSet._addAssign_operation (enumerator_20813._key (HERE)) ;
      }
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_21371 (var_cas_inExternFileSet, true) ;
    while (enumerator_21371.hc ()) {
      if (((enumerator_21371._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (708)))._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_21371._key (HERE)) ;
      }
      enumerator_21371.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "md5.cpp")) ;
  {
    GGS_stringset::cEnumerator enumerator_24829 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_24829.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24829._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_24829.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24912 (var_cas_inScannerSourceNameSet, true) ;
    while (enumerator_24912.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24912._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24912.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24995 (var_cas_inOptionSourceNameSet, true) ;
    while (enumerator_24995.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24995._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24995.next () ;
    }
  }
