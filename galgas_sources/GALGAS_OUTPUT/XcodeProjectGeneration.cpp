...
void routine_generateXcodeProject (C_CompilerEx & inLexique,
  ...
  ::routine_enter_group (inLexique,  var_cas_XcodeProjectDescription,  GGS_string ("Hand Coded Sources"),  GGS_string ("../galgas_sources"),  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (934)) ;
  ...
  const GGS_bool cond_34663 = var_cas_inGenerateCodeGalgas1 ;
  if (cond_34663.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_38443 = var_cas_inGenerateCodeGalgas1 ;
  if (cond_38443.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_41076 = var_cas_inGenerateCodeGalgas1 ;
  if (cond_41076.isBuiltAndTrue ()) {
  ...
  GGS_string automatic_var_44841_0 ;
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_44841_0 COMMA_SOURCE_FILE_AT_LINE (1396)) ;
