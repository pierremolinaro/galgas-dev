...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  var_cas_fileSet.addAssign_operation (GGS_string ("Cocoa.framework")) ;
  {
    ...
    while (enumerator_20019.hasCurrentObject ()) {
      if (((enumerator_20019._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (650))).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    while (enumerator_20153.hasCurrentObject ()) {
      if (((enumerator_20153._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (655))).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_20711.hasCurrentObject ()) {
      if (((enumerator_20711._key (HERE).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (676))).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
