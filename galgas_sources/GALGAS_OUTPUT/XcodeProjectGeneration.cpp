...
//                    september 16th, 2008, at 21h53'22"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
internalSubListWithRange (GGS_Xcode_groupList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mTargetKey) ;
      _p = _p->nextObject () ;
    }
  }
}
...
method_build (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_Xcode_groupList::cEnumerator enumerator_1598 (mGroupList, true) ;
    const GGS_Xcode_groupList::cElement * operand_1598 = NULL ;
    while (((operand_1598 = enumerator_1598.nextObject ()))) {
      macroValidPointer (operand_1598) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_1598->mTargetKey) ;
      var_cas_ioString.writeString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n"
      "\t\t\t);\n"
  ...
  {
    GGS_Xcode_targetList::cEnumerator enumerator_1978 (mTargetList, true) ;
    const GGS_Xcode_targetList::cElement * operand_1978 = NULL ;
    while (((operand_1978 = enumerator_1978.nextObject ()))) {
      macroValidPointer (operand_1978) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_1978->mTargetKey) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_1978->mTargetName) ;
      var_cas_ioString.writeString (" */ {\n"
      "\t\t\tisa = PBXNativeTarget;\n"
      "\t\t\tbuildConfigurationList = ") ;
      var_cas_ioString._dotAssign_operation (operand_1978->mTargetConfigurationKey) ;
      ...
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductInstallPath = \"") ;
      var_cas_ioString._dotAssign_operation (operand_1978->mProductInstallPath) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductName = \"") ;
      var_cas_ioString._dotAssign_operation (operand_1978->mProductName) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductType = \"com.apple.product-type.") ;
      var_cas_ioString._dotAssign_operation (operand_1978->mProductTypeExtension) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t}\n") ;
    }
  }
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_targetList::cEnumerator enumerator_3482 (mTargetList, true) ;
    const GGS_Xcode_targetList::cElement * operand_3482 = NULL ;
    while (((operand_3482 = enumerator_3482.nextObject ()))) {
      macroValidPointer (operand_3482) ;
      var_cas_ioString.writeString ("\t\t\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_3482->mTargetKey) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_3482->mTargetName) ;
      var_cas_ioString.writeString (" */,\n") ;
    }
  }
  var_cas_ioString.writeString ("\t\t\t);\n"
  ...
  {
    GGS_Xcode_buildConfigurationList::cEnumerator enumerator_3797 (mBuildConfigurationList, true) ;
    const GGS_Xcode_buildConfigurationList::cElement * operand_3797 = NULL ;
    while (((operand_3797 = enumerator_3797.nextObject ()))) {
      macroValidPointer (operand_3797) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_3797->mXCBuildConfigurationKey) ;
      var_cas_ioString.writeString (" /* Default */ = {\n"
      "\t\t\tisa = XCBuildConfiguration;\n"
      "\t\t\tbuildSettings = {\n") ;
      {
        GGS_stringlist::cEnumerator enumerator_3985 (operand_3797->mSettings, true) ;
        const GGS_stringlist::cElement * operand_3985 = NULL ;
        while (((operand_3985 = enumerator_3985.nextObject ()))) {
          macroValidPointer (operand_3985) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_3985->mValue) ;
          var_cas_ioString.writeString ("\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t};\n"
  ...
  {
    GGS_Xcode_buildConfigurationList::cEnumerator enumerator_4356 (mBuildConfigurationList, true) ;
    const GGS_Xcode_buildConfigurationList::cElement * operand_4356 = NULL ;
    while (((operand_4356 = enumerator_4356.nextObject ()))) {
      macroValidPointer (operand_4356) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_4356->mTargetKey) ;
      var_cas_ioString.writeString (" /* Build configuration list */ = {\n"
      "\t\t\tisa = XCConfigurationList;\n"
      "\t\t\tbuildConfigurations = (\n"
      "\t\t\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_4356->mXCBuildConfigurationKey) ;
      var_cas_ioString.writeString (" /* Default */,\n"
      "\t\t\t);\n"
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  var_cas_mainGroupKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (152)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (152)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (152)) ;
  var_cas_groupList._addAssign_operation (var_cas_mainGroupKey) ;
  ...
  var_cas_projectDefaultConfigurationKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (193)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (193)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (193)) ;
  var_cas_buildConfigurationList._addAssign_operation (var_cas_projectDefaultConfigurationKey, GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (194)), var_cas_projectDefaultSettings) ;
  GGS_Xcode_rootObject  var_cas_p ;
  var_cas_p = GGS_Xcode_rootObject ::constructor_new (_inLexique, var_cas_inProjectName, GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (198)), var_cas_groupList, var_cas_mainGroupKey, var_cas_buildConfigurationList, var_cas_targetList, var_cas_projectDefaultConfigurationKey COMMA_HERE) ;
  GGS_string var_cas_fileNewContents ;
  const GGS_Xcode_rootObject  _temp_8703 = var_cas_p ;
  if (_temp_8703._isBuilt ()) {
    _temp_8703 (HERE)->method_build (_inLexique, var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (207)) ;
  }
  const GGS_string _temp_8831 = var_cas_in_pbxproj_filePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
  if (_temp_8831._isBuilt ()) {
    _temp_8831 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
  const GGS_string _temp_8886 = var_cas_fileNewContents ;
  if (_temp_8886._isBuilt ()) {
    _temp_8886 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_in_pbxproj_filePath COMMA_SOURCE_FILE_AT_LINE (211)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
