...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19179 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19179.hc ()) {
      GGS_string var_cas_extension ;
      var_cas_extension = enumerator_19179._key (HERE).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (633)) ;
      if ((((var_cas_extension)._operator_isNotEqual (GGS_string (true, "cpp")))._operator_and ((var_cas_extension)._operator_isNotEqual (GGS_string (true, "c")))).isBuiltAndTrue ()) {
        var_cas_fileList._addAssign_operation (enumerator_19179._key (HERE)) ;
      }
      enumerator_19179.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19799 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19799.hc ()) {
      var_cas_fileList._addAssign_operation (enumerator_19799._key (HERE)) ;
      enumerator_19799.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "md5.cpp")) ;
  {
    GGS_stringset::cEnumerator enumerator_24064 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_24064.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24064._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_24064.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24147 (var_cas_inScannerSourceNameSet, true) ;
    while (enumerator_24147.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24147._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24147.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_24230 (var_cas_inOptionSourceNameSet, true) ;
    while (enumerator_24230.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_24230._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_24230.next () ;
    }
  }
  ::routine_enter_file_list_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (802)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  ::routine_enterProjectDefaultSettings (_inLexique,  var_cas_pathes,  var_cas_projectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1294)) ;
  ::routine_generateXCodeFile (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_in_xcodeproj_filePath,  var_cas_projectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1300)) ;
  #ifdef DEBUG_TRACE_ENABLED
