...
void routine_build_HAND_CODED_source_files_for_sources_tool_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_18039.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_18039._key (HERE).reader_pathExtension () ;
...
void routine_build_HAND_CODED_source_files_for_sources_cocoa_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_18728.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_18728._key (HERE).reader_pathExtension () ;
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_19391.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_19391._key (HERE).reader_pathExtension () ;
...
void routine_build_FRAMEWORKS_group (C_Compiler & inLexique,
  ...
  var_cas_fileSet.addAssign_operation (GGS_string ("Cocoa.framework")) ;
  {
    ...
    while (enumerator_20131.hasCurrentObject ()) {
      const GGS_bool cond_20213 = (enumerator_20131._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
  ...
  }
  {
    ...
    while (enumerator_20265.hasCurrentObject ()) {
      const GGS_bool cond_20347 = (enumerator_20265._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (enumerator_20823.hasCurrentObject ()) {
      const GGS_bool cond_20906 = (enumerator_20823._key (HERE).reader_pathExtension ()).operator_isEqual (GGS_string ("framework")) ;
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & inLexique,
  ...
  }
  {
    ...
    while (enumerator_23175.hasCurrentObject ()) {
      GGS_string var_cas_extension = enumerator_23175._key (HERE).reader_pathExtension () ;
...
void routine_generateXcodeProject (C_Compiler & inLexique,
  ...
  ::routine_add_app_target (inLexique,  var_cas_XcodeProjectDescription,  (GGS_string ("Cocoa")).operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter ()).operator_concat (GGS_string (" Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string ("../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string ("Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1246)) ;
