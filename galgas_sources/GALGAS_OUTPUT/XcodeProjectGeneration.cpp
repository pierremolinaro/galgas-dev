...
//                    september 24th, 2008, at 20h33'17"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
method_buildXcodeProject (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString.writeString ("\t\t") ;
  var_cas_ioString._dotAssign_operation ((*this) /* self */.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (41))) ;
...
method_buildXcodeProject (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString.writeString ("\t\t") ;
  var_cas_ioString._dotAssign_operation ((*this) /* self */.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (51))) ;
...
void cPtr_Xcode_PBXBuildFile::computeOnce3359 (C_Compiler & _inLexique) const {
  _mOnce3359isComputed = true ;
  key._drop () ;
  key = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (82)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (82)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (82)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXBuildFile::reader_key (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce3359isComputed) {
    computeOnce3359 (_inLexique) ;
  }
  return key ;
}
...
method_buildXcodeProject (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString.writeString ("\t\t") ;
  var_cas_ioString._dotAssign_operation ((*this) /* self */.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (86))) ;
  var_cas_ioString.writeString (" /* ") ;
  ...
  var_cas_ioString._dotAssign_operation (mSourceFile.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (87))) ;
...
reader_key (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_Xcode_PBXBuildFile *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_Xcode_PBXBuildFile *) mPointer)->reader_key (inLexique COMMA_THERE) ;
  }
  return result ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mBuildFile._operator_isEqual (_p->mBuildFile).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mBuildFile.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_Xcode_PBXBuildFile  p_0 = p->mBuildFile ;
          _internalAppendValues (p_0 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mBuildFile
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
  }
...
internalSubListWithRange (GGS_Xcode_PBXBuildFile_list & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mBuildFile) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_mBuildFileAtIndex (C_Compiler & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  GGS_Xcode_PBXBuildFile  result ;
  if (_isBuilt () && inIndex._isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
      result = object->mBuildFile ;
    }
  }
  return result ;
}
...
void GGS_Xcode_PBXBuildFile_list::
modifier_setMBuildFileAtIndex (C_Compiler & inLexique,
...
/* const */ GGS_Xcode_PBXBuildFile  & GGS_Xcode_PBXBuildFile_list::cEnumerator::_mBuildFile (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mBuildFile ;
}
...
void cPtr_Xcode_PBXSourcesBuildPhase::computeOnce4355 (C_Compiler & _inLexique) const {
  _mOnce4355isComputed = true ;
  key._drop () ;
  key = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (109)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXSourcesBuildPhase::reader_key (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce4355isComputed) {
    computeOnce4355 (_inLexique) ;
  }
  return key ;
}
...
void cPtr_Xcode_PBXGroup::computeOnce5126 (C_Compiler & _inLexique) const {
  _mOnce5126isComputed = true ;
  key._drop () ;
  key = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (131)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (131)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (131)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXGroup::reader_key (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce5126isComputed) {
    computeOnce5126 (_inLexique) ;
  }
  return key ;
}
...
_mOnce5857isComputed (false),
configurationKey (),
_mOnce5957isComputed (false),
key () {
}
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce5857 (C_Compiler & _inLexique) const {
  _mOnce5857isComputed = true ;
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce5957 (C_Compiler & _inLexique) const {
  _mOnce5957isComputed = true ;
  key._drop () ;
  key = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (155)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (155)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (155)) ;
}
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_configurationKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce5857isComputed) {
    computeOnce5857 (_inLexique) ;
  }
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_key (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce5957isComputed) {
    computeOnce5957 (_inLexique) ;
  }
  return key ;
}
...
method_build (C_Compiler & _inLexique,
  ...
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_7999 (mPBXBuildFile_list, true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_7999 = NULL ;
    while (((operand_7999 = enumerator_7999.nextObject ()))) {
      macroValidPointer (operand_7999) ;
      const GGS_Xcode_PBXBuildFile  _temp_8038 = operand_7999->mBuildFile ;
      if (_temp_8038._isBuilt ()) {
        _temp_8038 (HERE)->method_buildXcodeProject (_inLexique, var_cas_ioString COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }
    }
  }
  ...
  {
    GGS_Xcode_PBXFileReference_list::cEnumerator enumerator_8249 (mPBXFileReference_list, true) ;
    const GGS_Xcode_PBXFileReference_list::cElement * operand_8249 = NULL ;
    while (((operand_8249 = enumerator_8249.nextObject ()))) {
      macroValidPointer (operand_8249) ;
      const GGS_Xcode_PBXFileReference_abstract  _temp_8292 = operand_8249->mFileReference ;
      if (_temp_8292._isBuilt ()) {
        _temp_8292 (HERE)->method_buildXcodeProject (_inLexique, var_cas_ioString COMMA_SOURCE_FILE_AT_LINE (218)) ;
      }
    }
  }
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_8477 (mGroupList, true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_8477 = NULL ;
    while (((operand_8477 = enumerator_8477.nextObject ()))) {
      macroValidPointer (operand_8477) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_8477->mGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (224))) ;
      var_cas_ioString.writeString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_stringlist::cEnumerator enumerator_8612 (operand_8477->mGroup.reader_mChildrenGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)), true) ;
        const GGS_stringlist::cElement * operand_8612 = NULL ;
        while (((operand_8612 = enumerator_8612.nextObject ()))) {
          macroValidPointer (operand_8612) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_8612->mValue) ;
          var_cas_ioString.writeString (" ,\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t);\n") ;
      if (((operand_8477->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (231)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_ioString.writeString ("\t\t\tname = \"") ;
        var_cas_ioString._dotAssign_operation (operand_8477->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (232))) ;
        var_cas_ioString.writeString ("\";\n") ;
      }
      if (((operand_8477->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (234)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_ioString.writeString ("\t\t\tpath = \"") ;
        var_cas_ioString._dotAssign_operation (operand_8477->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
        var_cas_ioString.writeString ("\";\n") ;
      }
      var_cas_ioString.writeString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_9250 (mTargetList, true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_9250 = NULL ;
    while (((operand_9250 = enumerator_9250.nextObject ()))) {
      macroValidPointer (operand_9250) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mTargetKey) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mTargetName) ;
      var_cas_ioString.writeString (" */ = {\n"
      "\t\t\tisa = PBXNativeTarget;\n"
      "\t\t\tbuildConfigurationList = ") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mTargetConfigurationKey) ;
      var_cas_ioString.writeString (" /* Build configuration list for PBXNativeTarget \"") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mTargetName) ;
      var_cas_ioString.writeString ("\" */;\n"
      "\t\t\tbuildPhases = (\n") ;
      {
        GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_9586 (operand_9250->mBuildPhaseList, true) ;
        const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_9586 = NULL ;
        while (((operand_9586 = enumerator_9586.nextObject ()))) {
          macroValidPointer (operand_9586) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_9586->mBuildPhase.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (249))) ;
          var_cas_ioString.writeString (" ,\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t);\n"
      ...
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductInstallPath = \"") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mProductInstallPath) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductName = \"") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mProductName) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductReference = ") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mProductReferenceKey) ;
      var_cas_ioString.writeString (" ;\n"
      "\t\t\tproductType = \"com.apple.product-type.") ;
      var_cas_ioString._dotAssign_operation (operand_9250->mProductTypeExtension) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t};\n") ;
    }
  }
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_10844 (mTargetList, true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_10844 = NULL ;
    while (((operand_10844 = enumerator_10844.nextObject ()))) {
      macroValidPointer (operand_10844) ;
      var_cas_ioString.writeString ("\t\t\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_10844->mTargetKey) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_10844->mTargetName) ;
      var_cas_ioString.writeString (" */,\n") ;
    }
  }
  var_cas_ioString.writeString ("\t\t\t);\n"
  ...
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_11165 (mPBXSourcesBuildPhase_list, true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_11165 = NULL ;
    while (((operand_11165 = enumerator_11165.nextObject ()))) {
      macroValidPointer (operand_11165) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_11165->mBuildPhase.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (285))) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_11165->mBuildPhase.reader_mNameForComment (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
      var_cas_ioString.writeString (" */ = {\n"
      "\t\t\tisa = PBXSourcesBuildPhase;\n"
      "\t\t\tbuildActionMask = 2147483647;\n"
      "\t\t\tfiles = (\n") ;
      {
        GGS_stringlist::cEnumerator enumerator_11414 (operand_11165->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (290)), true) ;
        const GGS_stringlist::cElement * operand_11414 = NULL ;
        while (((operand_11414 = enumerator_11414.nextObject ()))) {
          macroValidPointer (operand_11414) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_11414->mValue) ;
          var_cas_ioString.writeString (" ,\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t);\n"
  ...
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_11842 (mBuildConfigurationList, true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_11842 = NULL ;
    while (((operand_11842 = enumerator_11842.nextObject ()))) {
      macroValidPointer (operand_11842) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_11842->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
      var_cas_ioString.writeString (" /* Default */ = {\n"
      "\t\t\tisa = XCBuildConfiguration;\n"
      "\t\t\tbuildSettings = {\n") ;
      {
        GGS_stringlist::cEnumerator enumerator_12029 (operand_11842->mBuildConfig.reader_mSettings (_inLexique COMMA_SOURCE_FILE_AT_LINE (304)), true) ;
        const GGS_stringlist::cElement * operand_12029 = NULL ;
        while (((operand_12029 = enumerator_12029.nextObject ()))) {
          macroValidPointer (operand_12029) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_12029->mValue) ;
          var_cas_ioString.writeString ("\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t};\n"
  ...
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_12423 (mBuildConfigurationList, true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_12423 = NULL ;
    while (((operand_12423 = enumerator_12423.nextObject ()))) {
      macroValidPointer (operand_12423) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_12423->mBuildConfig.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (315))) ;
      var_cas_ioString.writeString (" /* Build configuration list */ = {\n"
      "\t\t\tisa = XCConfigurationList;\n"
      "\t\t\tbuildConfigurations = (\n"
      "\t\t\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_12423->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (318))) ;
      var_cas_ioString.writeString (" /* Default */,\n"
      "\t\t\t);\n"
...
//---------------------------------------------------------------------------*
//                                                                           *
//  Implementation of routine "buildGALGAS_LIBPM_cpp_sourceFiles_for_tool"   *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_buildGALGAS_LIBPM_cpp_sourceFiles_for_tool (C_Compiler & _inLexique,
                                ...
                                GGS_Xcode_PBXBuildFile_list  & var_cas_ioBuildFileList,
                                GGS_stringlist  & var_cas_outKeyListForBuildPhase COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_buildGALGAS_LIBPM_cpp_sourceFiles_for_tool at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "PM_C_Array")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "PM_C_Dictionary")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "PM_C_Object")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_galgas_listmap")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_filewrapper")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_galgas_map")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_galgas_list")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_galgas_sortedlist")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_stringset")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "C_Lexique")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_galgas_mapindex")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_galgas_domain")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "C_galgas_io")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_binaryset")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "predefined_types")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_lsint64")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_luint64")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_sint64")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_uint64")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "C_galgas_CLI_Options")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "C_GGS_Object")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_double")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_sint")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_bool")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_char")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_string")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_uint")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_location")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_ldouble")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_lsint")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_lbool")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_lchar")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_lstring")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "GGS_luint")) ;
  var_cas_outKeyListForBuildPhase = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringlist::cEnumerator enumerator_14591 (var_cas_fileList, true) ;
    const GGS_stringlist::cElement * operand_14591 = NULL ;
    while (((operand_14591 = enumerator_14591.nextObject ()))) {
      macroValidPointer (operand_14591) ;
      GGS_string var_cas_fileName ;
      var_cas_fileName = (operand_14591->mValue)._operator_concat (GGS_string (true, ".cpp")) ;
      ...
      if ((var_cas_ioFileReferenceMap.reader_hasKey (_inLexique, var_cas_fileName COMMA_SOURCE_FILE_AT_LINE (383))).isBuiltAndTrue ()) {
        const GGS_Xcode_PBXFileReference_map  _temp_14824 = var_cas_ioFileReferenceMap ;
        if (_temp_14824._isBuilt ()) {
          _temp_14824 (HERE)->method_searchKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (384)) ;
        }
      }else{
        var_cas_ref = GGS_Xcode_PBXFileReference_cppSourceFile ::constructor_new (_inLexique, var_cas_fileName COMMA_HERE) ;
        var_cas_ioFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (387)) ;
        var_cas_ioReferenceList._addAssign_operation (var_cas_ref) ;
      }
      var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (390))) ;
      ...
      var_cas_ioBuildFileList._addAssign_operation (var_cas_build_file) ;
      var_cas_outKeyListForBuildPhase._addAssign_operation (var_cas_build_file.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (393))) ;
      var_cas_fileName = (operand_14591->mValue)._operator_concat (GGS_string (true, ".h")) ;
      var_cas_key = GGS_lstring ::constructor_new (_inLexique, var_cas_fileName, GGS_location (_inLexique) COMMA_HERE) ;
      if ((var_cas_ioFileReferenceMap.reader_hasKey (_inLexique, var_cas_fileName COMMA_SOURCE_FILE_AT_LINE (397))).isBuiltAndTrue ()) {
        const GGS_Xcode_PBXFileReference_map  _temp_15362 = var_cas_ioFileReferenceMap ;
        if (_temp_15362._isBuilt ()) {
          _temp_15362 (HERE)->method_searchKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (398)) ;
        }
      }else{
      ...
      var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (404))) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_buildGALGAS_LIBPM_cpp_sourceFiles_for_tool\n") ;
  #endif
}
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_keyListForBuildPhase ;
  ::routine_buildGALGAS_LIBPM_cpp_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (429)) ;
  ...
  var_cas_productGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (438))) ;
  ...
  var_cas_targetList._addAssign_operation (GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (449)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (449)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (449)), var_cas_inProjectName, var_cas_toolTargetBuildConfiguration.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (451)), GGS_string (true, "$(HOME)/bin"), var_cas_inProjectName, var_cas_toolFileReference.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (454)), GGS_string (true, "tool"), GGS_Xcode_PBXSourcesBuildPhase_list ::constructor_listWithValue (var_cas_compileSourcesForToolTargetBuildPhase)) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_generatedByGalgasGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (462))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_handCodedSourcesGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (466))) ;
  ...
  var_cas_cachesSubGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, "Caches"), GGS_string (true, "cache"), GGS_stringlist ::constructor_emptyList () COMMA_HERE) ;
  var_cas_groupList._addAssign_operation (var_cas_cachesSubGroup) ;
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cachesSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (472))) ;
  GGS_Xcode_PBXGroup  var_cas_bddSubGroup ;
  var_cas_bddSubGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, "Binary Decision Diagrams"), GGS_string (true, "bdd"), GGS_stringlist ::constructor_emptyList () COMMA_HERE) ;
  var_cas_groupList._addAssign_operation (var_cas_bddSubGroup) ;
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_bddSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (476))) ;
  GGS_Xcode_PBXGroup  var_cas_collectionSubGroup ;
  var_cas_collectionSubGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, "Collections"), GGS_string (true, "collections"), GGS_stringlist ::constructor_emptyList () COMMA_HERE) ;
  var_cas_groupList._addAssign_operation (var_cas_collectionSubGroup) ;
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_collectionSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (480))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cocoaGALGASSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (484))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cocoaUtilitiesSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (488))) ;
  GGS_Xcode_PBXGroup  var_cas_commandLineInterfaceSubGroup ;
  var_cas_commandLineInterfaceSubGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, "Command Line Interface"), GGS_string (true, "command_line_interface"), GGS_stringlist ::constructor_emptyList () COMMA_HERE) ;
  var_cas_groupList._addAssign_operation (var_cas_commandLineInterfaceSubGroup) ;
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_commandLineInterfaceSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (492))) ;
  GGS_Xcode_PBXGroup  var_cas_filesSubGroup ;
  var_cas_filesSubGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, "Files"), GGS_string (true, "files"), GGS_stringlist ::constructor_emptyList () COMMA_HERE) ;
  var_cas_groupList._addAssign_operation (var_cas_filesSubGroup) ;
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_filesSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (496))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_GALGASSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (500))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_streamsSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (504))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_timeSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (508))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_tinyXMLSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (512))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_unicodeSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (516))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_utilitiesSubGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (520))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_libpmGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (524))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_resourcesGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (528))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_frameworksGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (532))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_productsGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (536))) ;
  ...
  var_cas_p = GGS_Xcode_rootObject ::constructor_new (_inLexique, var_cas_inProjectName, GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (585)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (585)), var_cas_groupList, var_cas_mainGroup.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (587)), var_cas_buildConfigurationList, var_cas_targetList, var_cas_defaultProjectConfiguration.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (590)), var_cas_PBXFileReferenceList, var_cas_PBXSourcesBuildPhase_list, var_cas_PBXBuildFile_list COMMA_HERE) ;
  GGS_string var_cas_fileNewContents ;
  const GGS_Xcode_rootObject  _temp_25246 = var_cas_p ;
  if (_temp_25246._isBuilt ()) {
    _temp_25246 (HERE)->method_build (_inLexique, var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (597)) ;
  }
  GGS_string var_cas_dir ;
  var_cas_dir = var_cas_in_pbxproj_filePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (600)) ;
  const GGS_string _temp_25397 = var_cas_dir ;
  if (_temp_25397._isBuilt ()) {
    _temp_25397 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (601)) ;
  }
  GGS_stringlist  var_cas_pbxuser_files ;
  var_cas_pbxuser_files = var_cas_dir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (602)) ;
  {
    GGS_stringlist::cEnumerator enumerator_25537 (var_cas_pbxuser_files, true) ;
    const GGS_stringlist::cElement * operand_25537 = NULL ;
    while (((operand_25537 = enumerator_25537.nextObject ()))) {
      macroValidPointer (operand_25537) ;
      GGS_string var_cas_fullPath ;
      var_cas_fullPath = ((var_cas_dir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_25537->mValue) ;
      GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (605)) ;
    }
  }
  const GGS_string _temp_25690 = var_cas_fileNewContents ;
  if (_temp_25690._isBuilt ()) {
    _temp_25690 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_in_pbxproj_filePath COMMA_SOURCE_FILE_AT_LINE (607)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
