...
//                    september 26th, 2008, at 16h37'34"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  ::routine_build_LIBPM_BDD_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (794)) ;
  ...
  ::routine_build_LIBPM_CACHE_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_CACHE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (803)) ;
  ...
  ::routine_build_LIBPM_COLLECTIONS_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_COLLECTIONS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (812)) ;
  ...
  ::routine_build_LIBPM_GALGAS_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (821)) ;
  ...
  ::routine_build_LIBPM_FILES_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_FILE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (830)) ;
  ...
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (839)) ;
  ...
  ::routine_build_LIBPM_STREAMS_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_STREAMS_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (848)) ;
  ...
  ::routine_build_LIBPM_TIME_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_TIME_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (857)) ;
  ...
  ::routine_build_LIBPM_TINYXML_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_TINYXML_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (866)) ;
  ...
  ::routine_build_LIBPM_UTILITIES_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_UTILITIES_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (875)) ;
  ...
  ::routine_build_LIBPM_UNICODE_sourceFiles_for_tool (_inLexique,  var_cas_PBXFileReference_map,  var_cas_PBXFileReferenceList,  var_cas_fileListOf_LIBPM_UNICODE_group,  var_cas_PBXBuildFile_list,  var_cas_keyListForBuildPhase COMMA_SOURCE_FILE_AT_LINE (884)) ;
  ...
  var_cas_productGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (893))) ;
  ...
  var_cas_targetList._addAssign_operation (GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (904)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (904)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (904)), var_cas_inProjectName, var_cas_toolTargetBuildConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (906)), GGS_string (true, "$(HOME)/bin"), var_cas_inProjectName, var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (909)), GGS_string (true, "tool"), GGS_Xcode_PBXSourcesBuildPhase_list ::constructor_listWithValue (var_cas_compileSourcesForToolTargetBuildPhase)) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_generatedByGalgasGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (917))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_handCodedSourcesGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (921))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cachesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (927))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_bddSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (931))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_collectionSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (935))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cocoaGALGASSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (939))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_cocoaUtilitiesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (943))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_commandLineInterfaceSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (947))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_filesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (951))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_GALGASSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (955))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_streamsSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (959))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_timeSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (963))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_tinyXMLSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (967))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_unicodeSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (971))) ;
  ...
  var_cas_libpmGroupChildrenList._addAssign_operation (var_cas_utilitiesSubGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (975))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_libpmGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (979))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_resourcesGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (983))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_frameworksGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (987))) ;
  ...
  var_cas_mainGroupChildrenList._addAssign_operation (var_cas_productsGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (991))) ;
  ...
  var_cas_p = GGS_Xcode_rootObject ::constructor_new (_inLexique, var_cas_inProjectName, GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1040)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (1040)), var_cas_groupList, var_cas_mainGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1042)), var_cas_buildConfigurationList, var_cas_targetList, var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1045)), var_cas_PBXFileReferenceList, var_cas_PBXSourcesBuildPhase_list, var_cas_PBXBuildFile_list COMMA_HERE) ;
  GGS_string var_cas_fileNewContents ;
  const GGS_Xcode_rootObject  _temp_40168 = var_cas_p ;
  if (_temp_40168._isBuilt ()) {
    _temp_40168 (HERE)->method_build (_inLexique, var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1052)) ;
  }
  GGS_string var_cas_dir ;
  var_cas_dir = var_cas_in_pbxproj_filePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)) ;
  const GGS_string _temp_40319 = var_cas_dir ;
  if (_temp_40319._isBuilt ()) {
    _temp_40319 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (1056)) ;
  }
  GGS_stringlist  var_cas_pbxuser_files ;
  var_cas_pbxuser_files = var_cas_dir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1057)) ;
  {
    GGS_stringlist::cEnumerator enumerator_40459 (var_cas_pbxuser_files, true) ;
    const GGS_stringlist::cElement * operand_40459 = NULL ;
    while (((operand_40459 = enumerator_40459.nextObject ()))) {
      macroValidPointer (operand_40459) ;
      GGS_string var_cas_fullPath ;
      var_cas_fullPath = ((var_cas_dir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_40459->mValue) ;
      GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    }
  }
  const GGS_string _temp_40612 = var_cas_fileNewContents ;
  if (_temp_40612._isBuilt ()) {
    _temp_40612 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_in_pbxproj_filePath COMMA_SOURCE_FILE_AT_LINE (1062)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
