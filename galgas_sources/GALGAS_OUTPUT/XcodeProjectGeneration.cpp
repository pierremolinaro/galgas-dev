...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (202)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COCOA_UTILITIES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "main.m")) ;
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (218)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_FILES_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "C_HTML_FileWrite") COMMA_SOURCE_FILE_AT_LINE (232)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "C_TextFileWrite") COMMA_SOURCE_FILE_AT_LINE (233)) ;
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (235)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_FILES_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "C_TextFileWrite.cpp")) ;
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (252)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "C_builtin_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (266)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "AC_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (267)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "C_CLI_OptionGroup") COMMA_SOURCE_FILE_AT_LINE (268)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "F_Analyze_CLI_Options") COMMA_SOURCE_FILE_AT_LINE (269)) ;
  ...
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (273)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "F_main.cpp")) ;
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (293)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_COLLECTIONS_group (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (320)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_CACHE_group (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_fileList ;
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "C_PrimeCache2") COMMA_SOURCE_FILE_AT_LINE (334)) ;
  ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  GGS_string (true, "C_PrimeCache3") COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ...
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (340)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_CACHE_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (358)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_UNICODE_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (396)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (444)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_STREAMS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "AC_OutputStream.cpp")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "C_ConsoleOut.cpp")) ;
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (482)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_TIME_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (516)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_LIBPM_TINYXML_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "tinyxmlerror.cpp")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "tinyxmlparser.cpp")) ;
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (554)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_17635 (var_cas_inComponentNameSet, true) ;
    while (enumerator_17635.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_17635._key (HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (570)))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_17635.next () ;
    }
  }
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (573)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_GENERATED_BY_GALGAS_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18157 (var_cas_inComponentNameSet, true) ;
    while (enumerator_18157.hc ()) {
      ::routine_append_cpp_h_files (_inLexique,  var_cas_fileList,  enumerator_18157._key (HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)) ;
      enumerator_18157.next () ;
    }
  }
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (592)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_source_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18714 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18714.hc ()) {
      var_cas_fileList._addAssign_operation (enumerator_18714._key (HERE)) ;
      enumerator_18714.next () ;
    }
  }
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (611)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_19200 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_19200.hc ()) {
      var_cas_fileList._addAssign_operation (enumerator_19200._key (HERE)) ;
      enumerator_19200.next () ;
    }
  }
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (630)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_FRAMEWORKS_group (C_Compiler & _inLexique,
  ...
  ::routine_enter_files_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (647)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_FRAMEWORKS_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "AppKit.framework")) ;
  var_cas_fileList._addAssign_operation (GGS_string (true, "Cocoa.framework")) ;
  ::routine_enter_files_for_frameworks_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (664)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  ::routine_initXcodeProjectDescription (_inLexique,  var_cas_XcodeProjectDescription COMMA_SOURCE_FILE_AT_LINE (680)) ;
  ...
  ::routine_build_HAND_CODED_SOURCES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (684)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Hand Coded Sources"),  GGS_string (true, "../hand_coded_sources"),  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (690)) ;
  ...
  ::routine_build_GENERATED_BY_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inComponentNameSet,  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (698)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Generated by GALGAS"),  GGS_string (true, "../galgas_sources/GALGAS_OUTPUT"),  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (704)) ;
  ...
  ::routine_build_LIBPM_BDD_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_BDD_group COMMA_SOURCE_FILE_AT_LINE (714)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Binary Decision Diagrams"),  GGS_string (true, "bdd"),  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (719)) ;
  ...
  ::routine_build_LIBPM_CACHE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_CACHE_group COMMA_SOURCE_FILE_AT_LINE (728)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Caches"),  GGS_string (true, "cache"),  var_cas_fileListOf_LIBPM_CACHE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (733)) ;
  ...
  ::routine_build_LIBPM_COCOA_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (742)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Cocoa GALGAS"),  GGS_string (true, "cocoa_galgas"),  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (746)) ;
  ...
  ::routine_build_LIBPM_COCOA_UTILITIES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (755)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Cocoa Utilities"),  GGS_string (true, "cocoa_utilities"),  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (759)) ;
  ...
  ::routine_build_LIBPM_COLLECTIONS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COLLECTIONS_group COMMA_SOURCE_FILE_AT_LINE (768)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Collections"),  GGS_string (true, "collections"),  var_cas_fileListOf_LIBPM_COLLECTIONS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (773)) ;
  ...
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group COMMA_SOURCE_FILE_AT_LINE (782)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Command Line Interface"),  GGS_string (true, "command_line_interface"),  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (787)) ;
  ...
  ::routine_build_LIBPM_FILES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_FILE_group COMMA_SOURCE_FILE_AT_LINE (796)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Files"),  GGS_string (true, "files"),  var_cas_fileListOf_LIBPM_FILE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (801)) ;
  ...
  ::routine_build_LIBPM_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (810)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "GALGAS"),  GGS_string (true, "galgas"),  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (815)) ;
  ...
  ::routine_build_LIBPM_STREAMS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_STREAMS_group COMMA_SOURCE_FILE_AT_LINE (824)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Streams"),  GGS_string (true, "streams"),  var_cas_fileListOf_LIBPM_STREAMS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (829)) ;
  ...
  ::routine_build_LIBPM_TIME_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TIME_group COMMA_SOURCE_FILE_AT_LINE (838)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Time"),  GGS_string (true, "time"),  var_cas_fileListOf_LIBPM_TIME_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (843)) ;
  ...
  ::routine_build_LIBPM_TINYXML_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TINYXML_group COMMA_SOURCE_FILE_AT_LINE (852)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Tiny XML"),  GGS_string (true, "tiny_xml"),  var_cas_fileListOf_LIBPM_TINYXML_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (857)) ;
  ...
  ::routine_build_LIBPM_UTILITIES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (866)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Utilities"),  GGS_string (true, "utilities"),  var_cas_fileListOf_LIBPM_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (871)) ;
  ...
  ::routine_build_LIBPM_UNICODE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UNICODE_group COMMA_SOURCE_FILE_AT_LINE (880)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Unicode"),  GGS_string (true, "unicode"),  var_cas_fileListOf_LIBPM_UNICODE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (885)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "LIBPM"),  GGS_string (true, "../../libpm"),  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (893)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Resources"),  GGS_string (true, ""),  GGS_stringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (900)) ;
  ...
  ::routine_build_FRAMEWORKS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (908)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Frameworks"),  GGS_string (true, "/System/Library/Frameworks"),  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (913)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (922)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inComponentNameSet,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (928)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (934)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (939)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (944)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (949)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (954)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (959)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (964)) ;
  ::routine_build_LIBPM_TINYXML_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (969)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (974)) ;
  ::routine_build_LIBPM_UNICODE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (979)) ;
  ...
  ::routine_add_tool_target (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)))._operator_concat (GGS_string (true, " Tool")),  var_cas_toolTargetSettings,  GGS_string (true, "../../libpm/galgas/PP_GalgasPrefix.pch"),  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (987)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (998)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inComponentNameSet,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1004)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1025)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1030)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1040)) ;
  ::routine_build_LIBPM_TINYXML_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1045)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1050)) ;
  ::routine_build_LIBPM_UNICODE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1055)) ;
  ...
  ::routine_add_tool_target (_inLexique,  var_cas_XcodeProjectDescription,  (var_cas_inProjectName)._operator_concat (GGS_string (true, "_debug")),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1067)))._operator_concat (GGS_string (true, " Tool Debug")),  var_cas_debugToolTargetSettings,  GGS_string (true, ""),  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1064)) ;
  ...
  ::routine_build_COCOA_APP_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1075)) ;
  GGS_Xcode_PBXBuildFile_list  var_cas_listForFrameworkBuildPhaseOfCocoaApp ;
  var_cas_listForFrameworkBuildPhaseOfCocoaApp = GGS_Xcode_PBXBuildFile_list ::constructor_emptyList () ;
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForFrameworkBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1081)) ;
  ...
  ::routine_add_app_target (_inLexique,  var_cas_XcodeProjectDescription,  ((GGS_string (true, "Cocoa"))._operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1091))))._operator_concat (GGS_string (true, ".app")),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1092)))._operator_concat (GGS_string (true, " Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string (true, "../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworkBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1089)) ;
  ...
  ::routine_generateXCodeFile (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_in_xcodeproj_filePath,  var_cas_projectDefaultSettings,  var_cas_inProjectName COMMA_SOURCE_FILE_AT_LINE (1139)) ;
  #ifdef DEBUG_TRACE_ENABLED
