...
//                    november 25th, 2008, at 16h23'59"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_build_HAND_CODED_source_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18432 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18432.hc ()) {
      var_cas_fileList._addAssign_operation (enumerator_18432._key (HERE)) ;
      enumerator_18432.next () ;
    }
  }
...
void routine_build_HAND_CODED_SOURCES_group (C_Compiler & _inLexique,
  ...
  var_cas_fileList = GGS_stringlist ::constructor_emptyList () ;
  {
    GGS_stringset::cEnumerator enumerator_18932 (var_cas_inExternSourceNameSet, true) ;
    while (enumerator_18932.hc ()) {
      var_cas_fileList._addAssign_operation (enumerator_18932._key (HERE)) ;
      enumerator_18932.next () ;
    }
  }
...
void routine_build_COCOA_APP_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  var_cas_fileList._addAssign_operation (GGS_string (true, "md5.cpp")) ;
  {
    GGS_stringset::cEnumerator enumerator_23197 (var_cas_inGUISourceNameSet, true) ;
    while (enumerator_23197.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23197._key (HERE))._operator_concat (GGS_string (true, ".mm"))) ;
      enumerator_23197.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_23280 (var_cas_inScannerSourceNameSet, true) ;
    while (enumerator_23280.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23280._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_23280.next () ;
    }
  }
  {
    GGS_stringset::cEnumerator enumerator_23363 (var_cas_inOptionSourceNameSet, true) ;
    while (enumerator_23363.hc ()) {
      var_cas_fileList._addAssign_operation ((enumerator_23363._key (HERE))._operator_concat (GGS_string (true, ".cpp"))) ;
      enumerator_23363.next () ;
    }
  }
  ::routine_enter_files_for_sources_build_phase (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_fileList,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (776)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateXcodeProject (C_Compiler & _inLexique,
  ...
  ::routine_initXcodeProjectDescription (_inLexique,  var_cas_XcodeProjectDescription COMMA_SOURCE_FILE_AT_LINE (799)) ;
  if (((var_cas_inExternSourceNameSet.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (802)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    ::routine_build_HAND_CODED_SOURCES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (804)) ;
    ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Hand Coded Sources"),  GGS_string (true, "../hand_coded_sources"),  var_cas_fileListOf_HAND_CODED_SOURCES_group COMMA_SOURCE_FILE_AT_LINE (810)) ;
  }
  ...
  ::routine_build_GENERATED_BY_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet,  var_cas_inGUISourceNameSet,  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (824)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Generated by GALGAS"),  GGS_string (true, "../galgas_sources/GALGAS_OUTPUT"),  var_cas_fileListOf_GENERATED_BY_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (831)) ;
  ...
  ::routine_build_LIBPM_BDD_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_BDD_group COMMA_SOURCE_FILE_AT_LINE (841)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Binary Decision Diagrams"),  GGS_string (true, "bdd"),  var_cas_fileListOf_LIBPM_BDD_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (846)) ;
  ...
  ::routine_build_LIBPM_CACHE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_CACHE_group COMMA_SOURCE_FILE_AT_LINE (855)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Caches"),  GGS_string (true, "cache"),  var_cas_fileListOf_LIBPM_CACHE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (860)) ;
  ...
  ::routine_build_LIBPM_COCOA_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (869)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Cocoa GALGAS"),  GGS_string (true, "cocoa_galgas"),  var_cas_fileListOf_LIBPM_COCOA_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (873)) ;
  ...
  ::routine_build_LIBPM_COCOA_UTILITIES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (882)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Cocoa Utilities"),  GGS_string (true, "cocoa_utilities"),  var_cas_fileListOf_LIBPM_COCOA_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (886)) ;
  ...
  ::routine_build_LIBPM_COLLECTIONS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COLLECTIONS_group COMMA_SOURCE_FILE_AT_LINE (895)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Collections"),  GGS_string (true, "collections"),  var_cas_fileListOf_LIBPM_COLLECTIONS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (900)) ;
  ...
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group COMMA_SOURCE_FILE_AT_LINE (909)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Command Line Interface"),  GGS_string (true, "command_line_interface"),  var_cas_fileListOf_LIBPM_COMMAND_LINE_INTERFACE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (914)) ;
  ...
  ::routine_build_LIBPM_FILES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_FILE_group COMMA_SOURCE_FILE_AT_LINE (923)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Files"),  GGS_string (true, "files"),  var_cas_fileListOf_LIBPM_FILE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (928)) ;
  ...
  ::routine_build_LIBPM_GALGAS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_GALGAS_group COMMA_SOURCE_FILE_AT_LINE (937)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "GALGAS"),  GGS_string (true, "galgas"),  var_cas_fileListOf_LIBPM_GALGAS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (942)) ;
  ...
  ::routine_build_LIBPM_STREAMS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_STREAMS_group COMMA_SOURCE_FILE_AT_LINE (951)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Streams"),  GGS_string (true, "streams"),  var_cas_fileListOf_LIBPM_STREAMS_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (956)) ;
  ...
  ::routine_build_LIBPM_TIME_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TIME_group COMMA_SOURCE_FILE_AT_LINE (965)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Time"),  GGS_string (true, "time"),  var_cas_fileListOf_LIBPM_TIME_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (970)) ;
  ...
  ::routine_build_LIBPM_TINYXML_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_TINYXML_group COMMA_SOURCE_FILE_AT_LINE (979)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Tiny XML"),  GGS_string (true, "tiny_xml"),  var_cas_fileListOf_LIBPM_TINYXML_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (984)) ;
  ...
  ::routine_build_LIBPM_UTILITIES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UTILITIES_group COMMA_SOURCE_FILE_AT_LINE (993)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Utilities"),  GGS_string (true, "utilities"),  var_cas_fileListOf_LIBPM_UTILITIES_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (998)) ;
  ...
  ::routine_build_LIBPM_UNICODE_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_LIBPM_UNICODE_group COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  ::routine_enter_subgroup (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Unicode"),  GGS_string (true, "unicode"),  var_cas_fileListOf_LIBPM_UNICODE_group,  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "LIBPM"),  GGS_string (true, "../../libpm"),  var_cas_libpmGroupChildrenList COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  ...
  ::routine_build_PROJECT_RESOURCES_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inIconFiles,  var_cas_fileListOf_PROJECT_RESOURCES_group COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Project Resources"),  GGS_string (true, ""),  var_cas_fileListOf_PROJECT_RESOURCES_group COMMA_SOURCE_FILE_AT_LINE (1033)) ;
  ...
  ::routine_build_FRAMEWORKS_group (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (1041)) ;
  ::routine_enter_group (_inLexique,  var_cas_XcodeProjectDescription,  GGS_string (true, "Frameworks"),  GGS_string (true, "/System/Library/Frameworks"),  var_cas_fileListOf_FRAMEWORKS_group COMMA_SOURCE_FILE_AT_LINE (1046)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1055)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1061)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1067)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1072)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1077)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1082)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1087)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1092)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1097)) ;
  ::routine_build_LIBPM_TINYXML_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1102)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1107)) ;
  ::routine_build_LIBPM_UNICODE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfTool COMMA_SOURCE_FILE_AT_LINE (1112)) ;
  ...
  ::routine_add_tool_target (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1124)))._operator_concat (GGS_string (true, " Tool")),  var_cas_toolTargetSettings,  GGS_string (true, "../../libpm/galgas/PP_GalgasPrefix.pch"),  var_cas_listForSourceBuildPhaseOfTool,  GGS_stringlist ::constructor_emptyList (),  var_cas_toolTargetKey COMMA_SOURCE_FILE_AT_LINE (1121)) ;
  ...
  ::routine_build_HAND_CODED_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inExternSourceNameSet,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  ::routine_build_GENERATED_BY_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_componentNameSet,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1140)) ;
  ::routine_build_LIBPM_BDD_source_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1146)) ;
  ::routine_build_LIBPM_CACHE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1151)) ;
  ::routine_build_LIBPM_COMMAND_LINE_INTERFACE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1156)) ;
  ::routine_build_LIBPM_FILES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1161)) ;
  ::routine_build_LIBPM_GALGAS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1166)) ;
  ::routine_build_LIBPM_STREAMS_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1171)) ;
  ::routine_build_LIBPM_TIME_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1176)) ;
  ::routine_build_LIBPM_TINYXML_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1181)) ;
  ::routine_build_LIBPM_UTILITIES_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1186)) ;
  ::routine_build_LIBPM_UNICODE_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForSourceBuildPhaseOfDebugTool COMMA_SOURCE_FILE_AT_LINE (1191)) ;
  ...
  ::routine_add_tool_target (_inLexique,  var_cas_XcodeProjectDescription,  (var_cas_inProjectName)._operator_concat (GGS_string (true, "_debug")),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1204)))._operator_concat (GGS_string (true, " Tool Debug")),  var_cas_debugToolTargetSettings,  GGS_string (true, ""),  var_cas_listForSourceBuildPhaseOfDebugTool,  GGS_stringlist ::constructor_emptyList (),  var_cas_toolDebugTargetKey COMMA_SOURCE_FILE_AT_LINE (1201)) ;
  ...
  ::routine_build_COCOA_APP_files_for_sources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inGUISourceNameSet,  var_cas_inScannerSourceNameSet,  var_cas_inOptionSourceNameSet,  var_cas_listForSourceBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1214)) ;
  ...
  ::routine_build_FRAMEWORKS_for_frameworks_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_listForFrameworksBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1223)) ;
  ...
  ::routine_build_RESOURCES_for_resources_build_phase (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_inProjectName,  var_cas_inIconFiles,  var_cas_listForResourcesBuildPhaseOfCocoaApp COMMA_SOURCE_FILE_AT_LINE (1229)) ;
  ...
  ::routine_add_app_target (_inLexique,  var_cas_XcodeProjectDescription,  (GGS_string (true, "Cocoa"))._operator_concat (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1245))),  (var_cas_inProjectName.reader_stringByCapitalizingFirstCharacter (_inLexique COMMA_SOURCE_FILE_AT_LINE (1246)))._operator_concat (GGS_string (true, " Cocoa")),  var_cas_cocoaAppTargetSettings,  GGS_string (true, "../../libpm/cocoa_galgas/PP_CocoaGalgasPrefix.pch"),  GGS_string (true, "Info.plist"),  var_cas_listForSourceBuildPhaseOfCocoaApp,  var_cas_listForFrameworksBuildPhaseOfCocoaApp,  var_cas_listForResourcesBuildPhaseOfCocoaApp,  var_cas_directDependencyList,  automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1243)) ;
  ...
  ::routine_enterProjectDefaultSettings (_inLexique,  var_cas_pathes,  var_cas_projectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1261)) ;
  ::routine_generateXCodeFile (_inLexique,  var_cas_XcodeProjectDescription,  var_cas_in_xcodeproj_filePath,  var_cas_projectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1267)) ;
  #ifdef DEBUG_TRACE_ENABLED
