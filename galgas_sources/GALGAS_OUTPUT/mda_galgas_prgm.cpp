          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (280)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (288)))._operator_concat (GGS_string (true, "/DEPENDENCIES/file_list_for_xcode_project.txt")) ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13610 (var_cas_xcode_tool_files, true) ;
                  const GGS_stringlist::cElement * operand_13610 = NULL ;
                  while (((operand_13610 = enumerator_13610.nextObject ()))) {
                    macroValidPointer (operand_13610) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_13710 = var_cas_sourceFileMap ;
                    if (_temp_13710._isBuilt ()) {
                      _temp_13710 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_13610->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (301)) ;
                    }
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_tool._addAssign_operation (operand_13610->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_14882 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_14882 = NULL ;
                  while (((operand_14882 = enumerator_14882.nextObject ()))) {
                    macroValidPointer (operand_14882) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_14982 = var_cas_sourceFileMap ;
                    if (_temp_14982._isBuilt ()) {
                      _temp_14982 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_14882->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (332)) ;
                    }
                    switch (var_cas_sourceKind.enumValue ()) {
                    case GGS_sourceFileKind::enum_externSourceFile:
                      {
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_app._addAssign_operation (operand_14882->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
