        ...
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (277)) ;
              GGS_stringlist  var_cas_xcodeProjects ;
              var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (_inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (278)) ;
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (280)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (282)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (284)))._operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
