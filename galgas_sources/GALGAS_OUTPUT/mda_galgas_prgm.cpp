      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_6950 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_6950 = NULL ;
              while (((operand_6950 = enumerator_6950.nextObject ()))) {
                macroValidPointer (operand_6950) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_6950->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
                var_cas_sourceFileMap.modifier_insertKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_baseName, operand_6950->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_HERE), operand_6950->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)), operand_6950->mSourceKind COMMA_SOURCE_FILE_AT_LINE (160)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7189 (operand_6950->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7189 = NULL ;
                  while (((operand_7189 = enumerator_7189.nextObject ()))) {
                    macroValidPointer (operand_7189) ;
                    if (((((operand_7189->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((operand_7189->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode_tool"))))._operator_and ((operand_7189->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode_app")))).isBuiltAndTrue ()) {
                      operand_7189->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (164)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7189->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_7711 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7711 = NULL ;
              while (((operand_7711 = enumerator_7711.nextObject ()))) {
                macroValidPointer (operand_7711) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_7711->mFilePath.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7711->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177))), operand_7711->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_HERE) ;
                if (((operand_7711->mSourceKind)._operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7711->mFilePath))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (181)) ;
                }
                switch (operand_7711->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (202)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (214)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (220)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_7711->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10428 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10428 = NULL ;
                  while (((operand_10428 = enumerator_10428.nextObject ()))) {
                    ...
                    const GGS_sourceFileMap  _temp_10528 = var_cas_sourceFileMap ;
                    if (_temp_10528._isBuilt ()) {
                      _temp_10528 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10428->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (245)) ;
                    }
                ...
                {
                  GGS_stringset::cEnumerator enumerator_11295 (var_cas_pathSet, true) ;
                  while (enumerator_11295.hc ()) {
                    var_cas_pathesString._dotAssign_operation (enumerator_11295._key (HERE)) ;
                    enumerator_11295.next () ;
                  }
                }
                ...
                const GGS_string _temp_11658 = var_cas_newFileListContents ;
                if (_temp_11658._isBuilt ()) {
                  _temp_11658 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (268)) ;
                }
              }
            }
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (280)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                const GGS_stringlist  _temp_12803 = var_cas_xcodeProjects ;
                if (_temp_12803._isBuilt ()) {
                  _temp_12803 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (285)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13039 (var_cas_xcode_tool_files, true) ;
                  ...
                  while (((operand_13039 = enumerator_13039.nextObject ()))) {
                    ...
                    var_cas_intermediateString._dotAssign_operation (operand_13039->mValue) ;
                    var_cas_intermediateString.appendCstring ("\n") ;
                  }
                }
                var_cas_intermediateString.appendCstring ("::\n") ;
                {
                  GGS_stringlist::cEnumerator enumerator_13175 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_13175 = NULL ;
                  while (((operand_13175 = enumerator_13175.nextObject ()))) {
                    macroValidPointer (operand_13175) ;
                    var_cas_intermediateString._dotAssign_operation (operand_13175->mValue) ;
                    var_cas_intermediateString.appendCstring ("\n") ;
                  }
                }
                ...
                const GGS_string _temp_13520 = var_cas_intermediateString ;
                if (_temp_13520._isBuilt ()) {
                  _temp_13520 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (299)) ;
                }
                if ((var_cas_written).isBuiltAndTrue ()) {
                  ...
                  {
                    GGS_stringlist::cEnumerator enumerator_14099 (var_cas_xcode_tool_files, true) ;
                    const GGS_stringlist::cElement * operand_14099 = NULL ;
                    while (((operand_14099 = enumerator_14099.nextObject ()))) {
                      macroValidPointer (operand_14099) ;
                      GGS_string var_cas_fullPath ;
                      GGS_sourceFileKind var_cas_sourceKind ;
                      const GGS_sourceFileMap  _temp_14205 = var_cas_sourceFileMap ;
                      if (_temp_14205._isBuilt ()) {
                        _temp_14205 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_14099->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (313)) ;
                      }
                      ...
                      case GGS_sourceFileKind::enum_lexiqueSourceFile:
                        {
                        var_cas_scannerSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_guiSourceFile:
                        {
                        var_cas_guiSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_optionSourceFile:
                        {
                        var_cas_optionSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_syntaxSourceFile:
                        {
                        var_cas_syntaxSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_semanticsSourceFile:
                        {
                        var_cas_semanticsSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_grammarSourceFile:
                        {
                        var_cas_grammarSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_programSourceFile:
                        {
                        var_cas_programSourceSet_tool._addAssign_operation (operand_14099->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::kNotBuilt:
                        break ;
                  ...
                  {
                    GGS_stringlist::cEnumerator enumerator_15433 (var_cas_xcode_app_files, true) ;
                    const GGS_stringlist::cElement * operand_15433 = NULL ;
                    while (((operand_15433 = enumerator_15433.nextObject ()))) {
                      macroValidPointer (operand_15433) ;
                      GGS_string var_cas_fullPath ;
                      GGS_sourceFileKind var_cas_sourceKind ;
                      const GGS_sourceFileMap  _temp_15539 = var_cas_sourceFileMap ;
                      if (_temp_15539._isBuilt ()) {
                        _temp_15539 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_15433->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (344)) ;
                      }
                      switch (var_cas_sourceKind.enumValue ()) {
                      case GGS_sourceFileKind::enum_externSourceFile:
                        {
                      ...
                      case GGS_sourceFileKind::enum_lexiqueSourceFile:
                        {
                        var_cas_scannerSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_guiSourceFile:
                        {
                        var_cas_guiSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_optionSourceFile:
                        {
                        var_cas_optionSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_syntaxSourceFile:
                        {
                        var_cas_syntaxSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_semanticsSourceFile:
                        {
                        var_cas_semanticsSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_grammarSourceFile:
                        {
                        var_cas_grammarSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_programSourceFile:
                        {
                        var_cas_programSourceSet_app._addAssign_operation (operand_15433->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::kNotBuilt:
                        break ;
