...
//                    september 12th, 2009, at 17h19'5"                      *
//                                                                           *
//---------------------------------------------------------------------------*
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct ;
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileLexiqueComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (107)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (107)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct ;
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileGuiComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (151)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (151)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_8055 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8055 = NULL ;
              while (((operand_8055 = enumerator_8055.nextObject ()))) {
                macroValidPointer (operand_8055) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_8055->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_8055->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) COMMA_HERE), operand_8055->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)), operand_8055->mSourceKind COMMA_SOURCE_FILE_AT_LINE (184)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_8294 (operand_8055->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_8294 = NULL ;
                  while (((operand_8294 = enumerator_8294.nextObject ()))) {
                    macroValidPointer (operand_8294) ;
                    if (((((operand_8294->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((operand_8294->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((operand_8294->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_isNotEqual (GGS_string ("xcode_app")))).isBuiltAndTrue ()) {
                      operand_8294->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (188)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_8294->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_8901 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8901 = NULL ;
              while (((operand_8901 = enumerator_8901.nextObject ()))) {
                macroValidPointer (operand_8901) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_8901->mFilePath.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_concat (GGS_string ("/"))).operator_concat (operand_8901->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))), operand_8901->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (204)) COMMA_HERE) ;
                if (((operand_8901->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  inLexique.printMessage (((GGS_string ("----- Compiling '")).operator_concat (operand_8901->mFilePath)).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (207)) ;
                }
                switch (operand_8901->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (216)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (222)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (228)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (234)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (240)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (246)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_8901->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (252)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (263))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_11721 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_11721 = NULL ;
                  while (((operand_11721 = enumerator_11721.nextObject ()))) {
                    ...
                    const GGS_sourceFileMap  temp_11821 = var_cas_sourceFileMap ;
                    if (temp_11821.isBuilt ()) {
                      temp_11821 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11721->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (271)) ;
                    }
                ...
                {
                  GGS_stringset::cEnumerator enumerator_12588 (var_cas_pathSet, true) ;
                  while (enumerator_12588.hasCurrentObject ()) {
                    var_cas_pathesString.dotAssign_operation (enumerator_12588._key (HERE)) ;
                    enumerator_12588.next () ;
                  }
                }
                ...
                const GGS_string temp_12955 = var_cas_newFileListContents ;
                if (temp_12955.isBuilt ()) {
                  temp_12955 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (294)) ;
                }
              }
            }
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (306))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                const GGS_stringlist  temp_14100 = var_cas_xcodeProjects ;
                if (temp_14100.isBuilt ()) {
                  temp_14100 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (311)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_14859 (var_cas_xcode_tool_files, true) ;
                  const GGS_stringlist::cElement * operand_14859 = NULL ;
                  while (((operand_14859 = enumerator_14859.nextObject ()))) {
                    macroValidPointer (operand_14859) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_14959 = var_cas_sourceFileMap ;
                    if (temp_14959.isBuilt ()) {
                      temp_14959 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14859->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (327)) ;
                    }
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_tool._addAssign_operation (operand_14859->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_16131 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_16131 = NULL ;
                  while (((operand_16131 = enumerator_16131.nextObject ()))) {
                    macroValidPointer (operand_16131) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_16231 = var_cas_sourceFileMap ;
                    if (temp_16231.isBuilt ()) {
                      temp_16231 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_16131->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (358)) ;
                    }
                    switch (var_cas_sourceKind.enumValue ()) {
                    case GGS_sourceFileKind::enum_externSourceFile:
                      {
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_app._addAssign_operation (operand_16131->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
