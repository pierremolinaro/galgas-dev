...
mda_galgas_prgm_prologue (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3483 = gOption_galgas_5F_cli_5F_options_printPredefinedLexicalActions.reader_value () ;
  if (cond_3483.isBuiltAndTrue ()) {
    ::routine_printPredefinedLexicalActions (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) ;
  }
  const GGS_bool cond_3685 = (gOption_galgas_5F_cli_5F_options_generateHeadersOfBuiltinTypes.reader_value ()).operator_isNotEqual (GGS_string ("")) ;
  if (cond_3685.isBuiltAndTrue ()) {
    ::routine_generateHeadersOfBuiltinTypes (inLexique,  gOption_galgas_5F_cli_5F_options_generateHeadersOfBuiltinTypes.reader_value () COMMA_SOURCE_FILE_AT_LINE (55)) ;
  }
}
        ...
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            if (var_cas_inSourceFile.isBuilt ()) {
              ::routine_fixFileGenerationStartDirectory (inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (66)) ;
            }
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (100)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (100)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileLexiqueComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (114)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (114)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileSemanticsComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (128)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (128)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileSyntaxComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (142)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (142)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileGrammarComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (158)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (156)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileGuiComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (174)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (174)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_location _here (inLexique) ;
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_string var_cas_outputDirectoryTEMP = function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (195)) ;
            GGS_string var_cas_outputDirectory = function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (196)) ;
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_8989 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8989 = NULL ;
              while (((operand_8989 = enumerator_8989.nextObject ()))) {
                macroValidPointer (operand_8989) ;
                GGS_string var_cas_baseName = operand_8989->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_8989->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_HERE), operand_8989->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)), operand_8989->mSourceKind COMMA_SOURCE_FILE_AT_LINE (207)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_9228 (operand_8989->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_9228 = NULL ;
                  while (((operand_9228 = enumerator_9228.nextObject ()))) {
                    macroValidPointer (operand_9228) ;
                    const GGS_bool cond_9457 = (((operand_9228->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((operand_9228->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((operand_9228->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
                    if (cond_9457.isBuiltAndTrue ()) {
                      operand_9228->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (211)) ;
                    }else if (cond_9457.isBuiltAndFalse ()) {
                      var_cas_targetFileListMap.addAssign_operation (operand_9228->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (212)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_9877 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_9877 = NULL ;
              while (((operand_9877 = enumerator_9877.nextObject ()))) {
                macroValidPointer (operand_9877) ;
                GGS_string var_cas_extension = operand_9877->mFilePath.ggs_string ().reader_pathExtension () ;
                GGS_lstring  var_cas_fullFilePath = GGS_lstring ::constructor_new (inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_9877->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (227))), operand_9877->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (228)) COMMA_HERE) ;
                const GGS_bool cond_10209 = (operand_9877->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                if (cond_10209.isBuiltAndTrue ()) {
                  inLexique.printMessage (((GGS_string ("----- Compiling '")).operator_concat (operand_9877->mFilePath)).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (231)) ;
                }
                switch (operand_9877->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  {
                  const GGS_bool cond_10421 = (var_cas_extension).operator_isEqual (GGS_string ("gGui")) ;
                  if (cond_10421.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10421.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (240)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  {
                  const GGS_bool cond_10680 = (var_cas_extension).operator_isEqual (GGS_string ("gLexique")) ;
                  if (cond_10680.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10680.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (246)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  {
                  const GGS_bool cond_10944 = (var_cas_extension).operator_isEqual (GGS_string ("gOption")) ;
                  ...
                  }else if (cond_10944.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (252)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  {
                  const GGS_bool cond_11220 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
                  if (cond_11220.isBuiltAndTrue ()) {
                    ::routine_compileSemanticsComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (255)) ;
                  }else if (cond_11220.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (258)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  {
                  const GGS_bool cond_11506 = (var_cas_extension).operator_isEqual (GGS_string ("gSyntax")) ;
                  if (cond_11506.isBuiltAndTrue ()) {
                    ::routine_compileSyntaxComponent (inLexique,  var_cas_fullFilePath,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (261)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (261)) ;
                  }else if (cond_11506.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (264)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  {
                  const GGS_bool cond_11884 = (var_cas_extension).operator_isEqual (GGS_string ("gGrammar")) ;
                  if (cond_11884.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_11884.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (275)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  {
                  const GGS_bool cond_12131 = (var_cas_extension).operator_isEqual (GGS_string ("gProgram")) ;
                  if (cond_12131.isBuiltAndTrue ()) {
                  }else if (cond_12131.isBuiltAndFalse ()) {
                    operand_9877->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (281)) ;
                  }
                  }
                  break ;
            ...
            const GGS_bool cond_12458 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            ...
            const GGS_bool cond_14131 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_14131.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_14120 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_14120.isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_12858 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_12858 = NULL ;
                  while (((operand_12858 = enumerator_12858.nextObject ()))) {
                    ...
                    const GGS_sourceFileMap  temp_12958 = var_cas_sourceFileMap ;
                    if (temp_12958.isBuilt ()) {
                      temp_12958 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12858->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (300)) ;
                    }
                    GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent () ;
                    const GGS_bool cond_13511 = (var_cas_sourceKind).operator_isEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                    if (cond_13511.isBuiltAndTrue ()) {
                      const GGS_bool cond_13287 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
                      if (cond_13287.isBuiltAndTrue ()) {
                        var_cas_pathSet.addAssign_operation (((GGS_string ("SOURCES_DIR += ")).operator_concat (var_cas_filePath)).operator_concat (GGS_string ("\n"))) ;
                      }else if (cond_13287.isBuiltAndFalse ()) {
                        const GGS_bool cond_13405 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
                        if (cond_13405.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_13511.isBuiltAndFalse ()) {
                ...
                {
                  GGS_stringset::cEnumerator enumerator_13725 (var_cas_pathSet, true) ;
                  while (enumerator_13725.hasCurrentObject ()) {
                    var_cas_pathesString.dotAssign_operation (enumerator_13725._key (HERE)) ;
                    enumerator_13725.next () ;
                  }
                }
                ...
                GGS_bool automatic_var_14110_0 ;
                const GGS_string temp_14092 = var_cas_newFileListContents ;
                if (temp_14092.isBuilt ()) {
                  temp_14092 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_14110_0 COMMA_SOURCE_FILE_AT_LINE (323)) ;
                }
              }
            }
            ...
            const GGS_bool cond_18873 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_18873.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_14987 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_14987.isBuiltAndTrue ()) {
              ...
              }else if (cond_14987.isBuiltAndFalse ()) {
                const GGS_bool cond_15162 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
                if (cond_15162.isBuiltAndTrue ()) {
                ...
                }else if (cond_15162.isBuiltAndFalse ()) {
                  ...
                  if (cond_18862.isBuiltAndTrue ()) {
                    ...
                    const GGS_stringlist  temp_15237 = var_cas_xcodeProjects ;
                    if (temp_15237.isBuilt ()) {
                      temp_15237 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (340)) ;
                    }
                    ...
                    GGS_stringset  var_cas_programSourceSet_tool = GGS_stringset ::constructor_emptySet () ;
                    {
                      ...
                      while (((operand_15996 = enumerator_15996.nextObject ()))) {
                        ...
                        GGS_string var_cas_fullPath ;
                        GGS_sourceFileKind var_cas_sourceKind ;
                        const GGS_sourceFileMap  temp_16096 = var_cas_sourceFileMap ;
                        if (temp_16096.isBuilt ()) {
                          temp_16096 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15996->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (356)) ;
                        }
                    ...
                    GGS_stringset  var_cas_programSourceSet_app = GGS_stringset ::constructor_emptySet () ;
                    {
                      ...
                      while (((operand_17268 = enumerator_17268.nextObject ()))) {
                        ...
                        GGS_string var_cas_fullPath ;
                        GGS_sourceFileKind var_cas_sourceKind ;
                        const GGS_sourceFileMap  temp_17368 = var_cas_sourceFileMap ;
                        if (temp_17368.isBuilt ()) {
                          temp_17368 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_17268->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (387)) ;
                        }
                        switch (var_cas_sourceKind.enumValue ()) {
                        case GGS_sourceFileKind::enum_externSourceFile:
                          {
