      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
            {
              GGS_lstringlist::cEnumerator enumerator_7028 (var_cas_fileList, true) ;
              const GGS_lstringlist::cElement * operand_7028 = NULL ;
              while (((operand_7028 = enumerator_7028.nextObject ()))) {
                macroValidPointer (operand_7028) ;
                _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7028->mValue))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (173)) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_7028->mValue.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (176)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7028->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (176))), operand_7028->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)) COMMA_HERE) ;
                if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                  ::routine_compileSemanticsComponent (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (180)) ;
                }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
                  ::routine_compileLexiqueComponent (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (182)) ;
                  ...
                  ::routine_compileOptionComponent (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (186)) ;
                  ...
                  ::routine_compileGuiComponent (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (192)) ;
                }else{
                  operand_7028->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled extension") COMMA_SOURCE_FILE_AT_LINE (195)) ;
                }
              }
            }
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              ::routine_performProjectGlobalCheckings (_inLexique,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (200)) ;
            }
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
