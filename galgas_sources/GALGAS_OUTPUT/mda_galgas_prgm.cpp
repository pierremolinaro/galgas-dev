      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            const GGS_location _here (inLexique) ;
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            ::routine_compileLexiqueComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            ::routine_compileSemanticsComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (106)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (106)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            const GGS_location _here (inLexique) ;
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            ::routine_compileGuiComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            var_cas_outputDirectoryTEMP = function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (153)) ;
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_7283 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7283 = NULL ;
              while (((operand_7283 = enumerator_7283.nextObject ()))) {
                macroValidPointer (operand_7283) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_7283->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_7283->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_HERE), operand_7283->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)), operand_7283->mSourceKind COMMA_SOURCE_FILE_AT_LINE (165)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7522 (operand_7283->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7522 = NULL ;
                  while (((operand_7522 = enumerator_7522.nextObject ()))) {
                    macroValidPointer (operand_7522) ;
                    if (((((operand_7522->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((operand_7522->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((operand_7522->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).operator_isNotEqual (GGS_string ("xcode_app")))).isBuiltAndTrue ()) {
                      operand_7522->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (169)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7522->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_8044 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8044 = NULL ;
              while (((operand_8044 = enumerator_8044.nextObject ()))) {
                macroValidPointer (operand_8044) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_8044->mFilePath.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).operator_concat (GGS_string ("/"))).operator_concat (operand_8044->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182))), operand_8044->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) COMMA_HERE) ;
                if (((operand_8044->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  inLexique.printMessage (((GGS_string ("----- Compiling '")).operator_concat (operand_8044->mFilePath)).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (186)) ;
                }
                switch (operand_8044->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGui"))).isBuiltAndTrue ()) {
                    ::routine_compileGuiComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP COMMA_SOURCE_FILE_AT_LINE (192)) ;
                  }else{
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (195)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gLexique"))).isBuiltAndTrue ()) {
                    ::routine_compileLexiqueComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP COMMA_SOURCE_FILE_AT_LINE (198)) ;
                  }else{
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (201)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (207)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSemantics"))).isBuiltAndTrue ()) {
                    ::routine_compileSemanticsComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (210)) ;
                  }else{
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (213)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (219)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (225)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_8044->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (231)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (242))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10792 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10792 = NULL ;
                  while (((operand_10792 = enumerator_10792.nextObject ()))) {
                    ...
                    const GGS_sourceFileMap  _temp_10892 = var_cas_sourceFileMap ;
                    if (_temp_10892.isBuilt ()) {
                      _temp_10892 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_10792->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (250)) ;
                    }
                    ...
                    if (((var_cas_sourceKind).operator_isEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                      if (((var_cas_filePath.reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (253))).operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
                      ...
                      var_cas_externSourceFileList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (258))) ;
                      var_cas_externSourceFileList.appendCString ("\n") ;
                    }else{
                      var_cas_galgasSourceList.appendCString ("SOURCES += ") ;
                      var_cas_galgasSourceList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (260)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (260))) ;
                ...
                const GGS_string _temp_12026 = var_cas_newFileListContents ;
                if (_temp_12026.isBuilt ()) {
                  _temp_12026 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (273)) ;
                }
              }
            }
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (280)).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (280))).operator_concat (GGS_string ("/project_xcode")) ;
              ...
              if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (285))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (287))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
                GGS_string var_cas_name ;
                const GGS_stringlist  _temp_13171 = var_cas_xcodeProjects ;
                if (_temp_13171.isBuilt ()) {
                  _temp_13171 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (290)) ;
                }
                ...
                var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (293))).operator_concat (GGS_string ("/DEPENDENCIES/file_list_for_xcode_project.txt")) ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13930 (var_cas_xcode_tool_files, true) ;
                  const GGS_stringlist::cElement * operand_13930 = NULL ;
                  while (((operand_13930 = enumerator_13930.nextObject ()))) {
                    macroValidPointer (operand_13930) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_14030 = var_cas_sourceFileMap ;
                    if (_temp_14030.isBuilt ()) {
                      _temp_14030 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_13930->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (306)) ;
                    }
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_tool._addAssign_operation (operand_13930->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_15202 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_15202 = NULL ;
                  while (((operand_15202 = enumerator_15202.nextObject ()))) {
                    macroValidPointer (operand_15202) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_15302 = var_cas_sourceFileMap ;
                    if (_temp_15302.isBuilt ()) {
                      _temp_15302 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15202->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (337)) ;
                    }
                    switch (var_cas_sourceKind.enumValue ()) {
                    case GGS_sourceFileKind::enum_externSourceFile:
                      {
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_app._addAssign_operation (operand_15202->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
