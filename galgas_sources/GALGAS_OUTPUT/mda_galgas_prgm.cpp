    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (_inLexique, GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE) COMMA_HERE) ;
          {
            GGS_lstringlist::cEnumerator enumerator_6929 (var_cas_fileList, true) ;
            const GGS_lstringlist::cElement * operand_6929 = NULL ;
            while (((operand_6929 = (GGS_lstringlist::cElement *) enumerator_6929.nextObject ()))) {
              macroValidPointer (operand_6929) ;
              _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_6929->mValue))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (171)) ;
              GGS_string var_cas_extension ;
              var_cas_extension = operand_6929->mValue.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
              GGS_lstring  var_cas_fullFilePath ;
              var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_6929->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174))), operand_6929->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) COMMA_HERE) ;
              if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                ...
                operand_6929->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled extension") COMMA_SOURCE_FILE_AT_LINE (192)) ;
              }
            }
          }
          if (verboseOptionOn) {
