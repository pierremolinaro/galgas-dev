      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileLexiqueComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (101)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (101)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct ;
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileSemanticsComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (113)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (113)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct ;
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileGuiComponent (inLexique,  var_cas_inSourceFile,  function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (143)),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (143)) ;
            if (verboseOptionOn) {
              co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
              switch (_commonLexique->totalErrorCount ()) {
              case 0 :
            ...
            var_cas_outputDirectoryTEMP = function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (164)) ;
            GGS_string var_cas_outputDirectory ;
            var_cas_outputDirectory = function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (165)) ;
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_7736 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7736 = NULL ;
              while (((operand_7736 = enumerator_7736.nextObject ()))) {
                macroValidPointer (operand_7736) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_7736->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (175)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (175)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_7736->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) COMMA_HERE), operand_7736->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)), operand_7736->mSourceKind COMMA_SOURCE_FILE_AT_LINE (176)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7975 (operand_7736->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7975 = NULL ;
                  while (((operand_7975 = enumerator_7975.nextObject ()))) {
                    macroValidPointer (operand_7975) ;
                    if (((((operand_7975->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((operand_7975->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((operand_7975->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_isNotEqual (GGS_string ("xcode_app")))).isBuiltAndTrue ()) {
                      operand_7975->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (180)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7975->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_8540 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8540 = NULL ;
              while (((operand_8540 = enumerator_8540.nextObject ()))) {
                macroValidPointer (operand_8540) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_8540->mFilePath.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_concat (GGS_string ("/"))).operator_concat (operand_8540->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))), operand_8540->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) COMMA_HERE) ;
                if (((operand_8540->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  inLexique.printMessage (((GGS_string ("----- Compiling '")).operator_concat (operand_8540->mFilePath)).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
                }
                switch (operand_8540->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGui"))).isBuiltAndTrue ()) {
                    ::routine_compileGuiComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (204)) ;
                  }else{
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (207)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gLexique"))).isBuiltAndTrue ()) {
                    ::routine_compileLexiqueComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (210)) ;
                  }else{
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (213)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gOption"))).isBuiltAndTrue ()) {
                    ::routine_compileOptionComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (216)) ;
                  }else{
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (219)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSemantics"))).isBuiltAndTrue ()) {
                    ::routine_compileSemanticsComponent (inLexique,  var_cas_fullFilePath,  var_cas_outputDirectoryTEMP,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (222)) ;
                  }else{
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (225)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (231)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (237)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_8540->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (243)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              ::routine_performProjectGlobalCheckings (inLexique,  var_cas_parsedComponentStruct,  var_cas_endOfSourceFile COMMA_SOURCE_FILE_AT_LINE (249)) ;
            }
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              GGS_stringlist  var_cas_makefileFiles ;
              var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (253)) ;
              if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (254))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_11336 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_11336 = NULL ;
                  while (((operand_11336 = enumerator_11336.nextObject ()))) {
                    ...
                    const GGS_sourceFileMap  temp_11436 = var_cas_sourceFileMap ;
                    if (temp_11436.isBuilt ()) {
                      temp_11436 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11336->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (262)) ;
                    }
                    GGS_string var_cas_filePath ;
                    var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
                    if (((var_cas_sourceKind).operator_isEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                      if (((var_cas_filePath.reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
                      ...
                      var_cas_externSourceFileList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (270))) ;
                      var_cas_externSourceFileList.appendCString ("\n") ;
                    }else{
                      var_cas_galgasSourceList.appendCString ("SOURCES += ") ;
                      var_cas_galgasSourceList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (272)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (272))) ;
                ...
                {
                  GGS_stringset::cEnumerator enumerator_12203 (var_cas_pathSet, true) ;
                  while (enumerator_12203.hasCurrentObject ()) {
                    var_cas_pathesString.dotAssign_operation (enumerator_12203._key (HERE)) ;
                    enumerator_12203.next () ;
                  }
                }
                ...
                const GGS_string temp_12570 = var_cas_newFileListContents ;
                if (temp_12570.isBuilt ()) {
                  temp_12570 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (285)) ;
                }
              }
            }
            GGS_stringlist  var_cas_xcode_tool_files ;
            var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (289)) ;
            GGS_stringlist  var_cas_xcode_app_files ;
            var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (290)) ;
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              GGS_string var_cas_XcodeProjectDir ;
              var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (292)).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (292))).operator_concat (GGS_string ("/project_xcode")) ;
              GGS_stringlist  var_cas_iconFiles ;
              var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (294)) ;
              GGS_stringlist  var_cas_xcodeProjects ;
              var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (295)) ;
              if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (297))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (299))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (301))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
                GGS_string var_cas_name ;
                const GGS_stringlist  temp_13715 = var_cas_xcodeProjects ;
                if (temp_13715.isBuilt ()) {
                  temp_13715 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (302)) ;
                }
                ...
                var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (305))).operator_concat (GGS_string ("/DEPENDENCIES/file_list_for_xcode_project.txt")) ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_14474 (var_cas_xcode_tool_files, true) ;
                  const GGS_stringlist::cElement * operand_14474 = NULL ;
                  while (((operand_14474 = enumerator_14474.nextObject ()))) {
                    macroValidPointer (operand_14474) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_14574 = var_cas_sourceFileMap ;
                    if (temp_14574.isBuilt ()) {
                      temp_14574 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14474->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (318)) ;
                    }
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_tool._addAssign_operation (operand_14474->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_15746 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_15746 = NULL ;
                  while (((operand_15746 = enumerator_15746.nextObject ()))) {
                    macroValidPointer (operand_15746) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_15846 = var_cas_sourceFileMap ;
                    if (temp_15846.isBuilt ()) {
                      temp_15846 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15746->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (349)) ;
                    }
                    switch (var_cas_sourceKind.enumValue ()) {
                    case GGS_sourceFileKind::enum_externSourceFile:
                      {
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_app._addAssign_operation (operand_15746->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
