        ...
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            galgas_LL1_grammar::_performSourceFileParsing_ (_inLexique,
                                            (var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)))._operator_concat (GGS_string (true, ".dep")),
                                            NULL,
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_6975 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_6975 = NULL ;
              while (((operand_6975 = enumerator_6975.nextObject ()))) {
                macroValidPointer (operand_6975) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_6975->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
                var_cas_sourceFileMap.modifier_insertKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_baseName, operand_6975->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_HERE), operand_6975->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)), operand_6975->mSourceKind COMMA_SOURCE_FILE_AT_LINE (160)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7214 (operand_6975->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7214 = NULL ;
                  while (((operand_7214 = enumerator_7214.nextObject ()))) {
                    macroValidPointer (operand_7214) ;
                    if ((((operand_7214->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((operand_7214->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode")))).isBuiltAndTrue ()) {
                      operand_7214->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the target name should be \"makefile\" or \"xcode\"") COMMA_SOURCE_FILE_AT_LINE (164)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7214->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_7676 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7676 = NULL ;
              while (((operand_7676 = enumerator_7676.nextObject ()))) {
                macroValidPointer (operand_7676) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_7676->mFilePath.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7676->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177))), operand_7676->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_HERE) ;
                if (((operand_7676->mSourceKind)._operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7676->mFilePath))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (181)) ;
                }
                switch (operand_7676->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (202)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (214)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (220)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_7676->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10393 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10393 = NULL ;
                  while (((operand_10393 = enumerator_10393.nextObject ()))) {
                    macroValidPointer (operand_10393) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_10493 = var_cas_sourceFileMap ;
                    if (_temp_10493._isBuilt ()) {
                      _temp_10493 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10393->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (245)) ;
                    }
                ...
                {
                  GGS_stringset::cEnumerator enumerator_11260 (var_cas_pathSet, true) ;
                  while (enumerator_11260.hc ()) {
                    var_cas_pathesString._dotAssign_operation (enumerator_11260._key (HERE)) ;
                    enumerator_11260.next () ;
                  }
                }
                ...
                const GGS_string _temp_11623 = var_cas_newFileListContents ;
                if (_temp_11623._isBuilt ()) {
                  _temp_11623 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (268)) ;
                }
              }
            }
            GGS_stringlist  var_cas_xcodeFiles ;
            var_cas_xcodeFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string (true, "xcode") COMMA_SOURCE_FILE_AT_LINE (272)) ;
            if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcodeFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (273)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
              GGS_string var_cas_XcodeProjectDir ;
              var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (274)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (274)))._operator_concat (GGS_string (true, "/project_xcode")) ;
              GGS_stringlist  var_cas_iconFiles ;
              var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "icns")) COMMA_SOURCE_FILE_AT_LINE (276)) ;
              GGS_stringlist  var_cas_xcodeProjects ;
              var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (277)) ;
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (279)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (281)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
                GGS_string var_cas_name ;
                const GGS_stringlist  _temp_12708 = var_cas_xcodeProjects ;
                if (_temp_12708._isBuilt ()) {
                  _temp_12708 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (284)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13309 (var_cas_xcodeFiles, true) ;
                  const GGS_stringlist::cElement * operand_13309 = NULL ;
                  while (((operand_13309 = enumerator_13309.nextObject ()))) {
                    macroValidPointer (operand_13309) ;
                    var_cas_intermediateString._dotAssign_operation (operand_13309->mValue) ;
                    var_cas_intermediateString.appendCstring ("\n") ;
                  }
                }
                GGS_string var_cas_intermediateFilePath ;
                var_cas_intermediateFilePath = (var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)))._operator_concat (GGS_string (true, "/file_list_for_xcode_project.txt")) ;
                GGS_bool var_cas_written ;
                const GGS_string _temp_13592 = var_cas_intermediateString ;
                if (_temp_13592._isBuilt ()) {
                  _temp_13592 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (302)) ;
                }
                if ((var_cas_written).isBuiltAndTrue ()) {
                  {
                    GGS_stringlist::cEnumerator enumerator_13738 (var_cas_xcodeFiles, true) ;
                    const GGS_stringlist::cElement * operand_13738 = NULL ;
                    while (((operand_13738 = enumerator_13738.nextObject ()))) {
                      macroValidPointer (operand_13738) ;
                      GGS_string var_cas_fullPath ;
                      GGS_sourceFileKind var_cas_sourceKind ;
                      const GGS_sourceFileMap  _temp_13844 = var_cas_sourceFileMap ;
                      if (_temp_13844._isBuilt ()) {
                        _temp_13844 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_13738->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (308)) ;
                      }
                      ...
                      case GGS_sourceFileKind::enum_lexiqueSourceFile:
                        {
                        var_cas_scannerSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_guiSourceFile:
                        {
                        var_cas_guiSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_optionSourceFile:
                        {
                        var_cas_optionSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_syntaxSourceFile:
                        {
                        var_cas_syntaxSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_semanticsSourceFile:
                        {
                        var_cas_semanticsSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_grammarSourceFile:
                        {
                        var_cas_grammarSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_programSourceFile:
                        {
                        var_cas_programSourceSet._addAssign_operation (operand_13738->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::kNotBuilt:
                        break ;
                  ...
                  ::routine_generateXcodeProject (_inLexique,  var_cas_externSourceSet,  var_cas_guiSourceSet,  var_cas_scannerSourceSet,  var_cas_optionSourceSet,  var_cas_semanticsSourceSet,  var_cas_syntaxSourceSet,  var_cas_grammarSourceSet,  var_cas_programSourceSet,  var_cas_name.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (338)),  var_cas_fullXcodePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)),  var_cas_iconFiles COMMA_SOURCE_FILE_AT_LINE (329)) ;
                }
              }
            }
            if (verboseOptionOn) {
