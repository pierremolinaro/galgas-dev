      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_6984 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_6984 = NULL ;
              while (((operand_6984 = enumerator_6984.nextObject ()))) {
                macroValidPointer (operand_6984) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_6984->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
                var_cas_sourceFileMap.modifier_insertKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_baseName, operand_6984->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_HERE), operand_6984->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)), operand_6984->mSourceKind COMMA_SOURCE_FILE_AT_LINE (160)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7223 (operand_6984->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7223 = NULL ;
                  while (((operand_7223 = enumerator_7223.nextObject ()))) {
                    macroValidPointer (operand_7223) ;
                    if (((((operand_7223->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((operand_7223->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode_tool"))))._operator_and ((operand_7223->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode_app")))).isBuiltAndTrue ()) {
                      operand_7223->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (164)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7223->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_7745 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7745 = NULL ;
              while (((operand_7745 = enumerator_7745.nextObject ()))) {
                macroValidPointer (operand_7745) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_7745->mFilePath.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7745->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177))), operand_7745->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_HERE) ;
                if (((operand_7745->mSourceKind)._operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7745->mFilePath))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (181)) ;
                }
                switch (operand_7745->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (202)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (214)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (220)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_7745->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10462 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10462 = NULL ;
                  while (((operand_10462 = enumerator_10462.nextObject ()))) {
                    ...
                    const GGS_sourceFileMap  _temp_10562 = var_cas_sourceFileMap ;
                    if (_temp_10562.isBuilt ()) {
                      _temp_10562 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10462->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (245)) ;
                    }
                    ...
                    if (((var_cas_sourceKind)._operator_isEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                      if (((var_cas_filePath.reader_firstCharacterOrNul (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)))._operator_isEqual (GGS_char (true, TO_UNICODE ('/')))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringset::cEnumerator enumerator_11329 (var_cas_pathSet, true) ;
                  while (enumerator_11329.hc ()) {
                    var_cas_pathesString._dotAssign_operation (enumerator_11329._key (HERE)) ;
                    enumerator_11329.next () ;
                  }
                }
                ...
                const GGS_string _temp_11692 = var_cas_newFileListContents ;
                if (_temp_11692.isBuilt ()) {
                  _temp_11692 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (268)) ;
                }
              }
            }
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (280)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                const GGS_stringlist  _temp_12837 = var_cas_xcodeProjects ;
                if (_temp_12837.isBuilt ()) {
                  _temp_12837 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (285)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13596 (var_cas_xcode_tool_files, true) ;
                  const GGS_stringlist::cElement * operand_13596 = NULL ;
                  while (((operand_13596 = enumerator_13596.nextObject ()))) {
                    macroValidPointer (operand_13596) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_13696 = var_cas_sourceFileMap ;
                    if (_temp_13696.isBuilt ()) {
                      _temp_13696 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_13596->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (301)) ;
                    }
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_tool._addAssign_operation (operand_13596->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_14868 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_14868 = NULL ;
                  while (((operand_14868 = enumerator_14868.nextObject ()))) {
                    macroValidPointer (operand_14868) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_14968 = var_cas_sourceFileMap ;
                    if (_temp_14968.isBuilt ()) {
                      _temp_14968 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_14868->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (332)) ;
                    }
                    switch (var_cas_sourceKind.enumValue ()) {
                    case GGS_sourceFileKind::enum_externSourceFile:
                      {
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_app._addAssign_operation (operand_14868->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
