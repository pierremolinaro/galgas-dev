      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
              ...
              while (((operand_6950 = enumerator_6950.nextObject ()))) {
                ...
                var_cas_sourceFileMap.modifier_insertKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_baseName, operand_6950->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_HERE), operand_6950->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)), operand_6950->mSourceKind COMMA_SOURCE_FILE_AT_LINE (160)) ;
                {
                  ...
                  while (((operand_7189 = enumerator_7189.nextObject ()))) {
                    ...
                    if ((((operand_7189->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((operand_7189->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode")))).isBuiltAndTrue ()) {
                      operand_7189->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the target name should be \"makefile\" or \"xcode\"") COMMA_SOURCE_FILE_AT_LINE (164)) ;
                    }else{
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_7651 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7651 = NULL ;
              while (((operand_7651 = enumerator_7651.nextObject ()))) {
                macroValidPointer (operand_7651) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_7651->mFilePath.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7651->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177))), operand_7651->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_HERE) ;
                if (((operand_7651->mSourceKind)._operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7651->mFilePath))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (181)) ;
                }
                switch (operand_7651->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (202)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (214)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (220)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_7651->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10368 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10368 = NULL ;
                  while (((operand_10368 = enumerator_10368.nextObject ()))) {
                    macroValidPointer (operand_10368) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_10468 = var_cas_sourceFileMap ;
                    if (_temp_10468._isBuilt ()) {
                      _temp_10468 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10368->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (245)) ;
                    }
                ...
                {
                  GGS_stringset::cEnumerator enumerator_11235 (var_cas_pathSet, true) ;
                  while (enumerator_11235.hc ()) {
                    var_cas_pathesString._dotAssign_operation (enumerator_11235._key (HERE)) ;
                    enumerator_11235.next () ;
                  }
                }
                ...
                const GGS_string _temp_11598 = var_cas_newFileListContents ;
                if (_temp_11598._isBuilt ()) {
                  _temp_11598 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (268)) ;
                }
              }
            }
            ...
            if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcodeFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (273)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (279)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                const GGS_stringlist  _temp_12683 = var_cas_xcodeProjects ;
                if (_temp_12683._isBuilt ()) {
                  _temp_12683 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (284)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13284 (var_cas_xcodeFiles, true) ;
                  ...
                  while (((operand_13284 = enumerator_13284.nextObject ()))) {
                    ...
                    var_cas_intermediateString._dotAssign_operation (operand_13284->mValue) ;
                ...
                const GGS_string _temp_13567 = var_cas_intermediateString ;
                if (_temp_13567._isBuilt ()) {
                  _temp_13567 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (302)) ;
                }
                if ((var_cas_written).isBuiltAndTrue ()) {
                  {
                    GGS_stringlist::cEnumerator enumerator_13713 (var_cas_xcodeFiles, true) ;
                    const GGS_stringlist::cElement * operand_13713 = NULL ;
                    while (((operand_13713 = enumerator_13713.nextObject ()))) {
                      macroValidPointer (operand_13713) ;
                      GGS_string var_cas_fullPath ;
                      GGS_sourceFileKind var_cas_sourceKind ;
                      const GGS_sourceFileMap  _temp_13819 = var_cas_sourceFileMap ;
                      if (_temp_13819._isBuilt ()) {
                        _temp_13819 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_13713->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (308)) ;
                      }
                      ...
                      case GGS_sourceFileKind::enum_lexiqueSourceFile:
                        {
                        var_cas_scannerSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_guiSourceFile:
                        {
                        var_cas_guiSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_optionSourceFile:
                        {
                        var_cas_optionSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_syntaxSourceFile:
                        {
                        var_cas_syntaxSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_semanticsSourceFile:
                        {
                        var_cas_semanticsSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_grammarSourceFile:
                        {
                        var_cas_grammarSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_programSourceFile:
                        {
                        var_cas_programSourceSet._addAssign_operation (operand_13713->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::kNotBuilt:
                        break ;
