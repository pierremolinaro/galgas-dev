      ...
      for (PMSInt32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            const GGS_location _here (inLexique) ;
            const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (inLexique, _source, _here COMMA_HERE)) ;
            GGS_string var_cas_outputDirectoryTEMP = function_outputDirectoryTEMP (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (185)) ;
            GGS_string var_cas_outputDirectory = function_outputDirectory (inLexique, var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (186)) ;
            ...
            GGS_targetFileListMap var_cas_targetFileListMap = GGS_targetFileListMap::constructor_emptyMap () ;
            {
              ...
              while (((operand_8616 = enumerator_8616.nextObject ()))) {
                ...
                GGS_string var_cas_baseName = operand_8616->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_8616->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) COMMA_HERE), operand_8616->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)), operand_8616->mSourceKind COMMA_SOURCE_FILE_AT_LINE (197)) ;
                {
                  ...
                  while (((operand_8855 = enumerator_8855.nextObject ()))) {
                    ...
                    }else if (cond_9084.isBuiltAndFalse ()) {
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              ...
              while (((operand_9504 = enumerator_9504.nextObject ()))) {
                ...
                GGS_string var_cas_extension = operand_9504->mFilePath.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
                ...
                const GGS_bool cond_9836 = (operand_9504->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  {
                  const GGS_bool cond_10048 = (var_cas_extension).operator_isEqual (GGS_string ("gGui")) ;
                ...
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  {
                  const GGS_bool cond_10307 = (var_cas_extension).operator_isEqual (GGS_string ("gLexique")) ;
                  if (cond_10307.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10307.isBuiltAndFalse ()) {
                ...
                case GGS_sourceFileKind::enum_optionSourceFile:
                  {
                  const GGS_bool cond_10571 = (var_cas_extension).operator_isEqual (GGS_string ("gOption")) ;
                  if (cond_10571.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10571.isBuiltAndFalse ()) {
                ...
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  {
                  const GGS_bool cond_10847 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
                  if (cond_10847.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10847.isBuiltAndFalse ()) {
                ...
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  {
                  const GGS_bool cond_11133 = (var_cas_extension).operator_isEqual (GGS_string ("gSyntax")) ;
                  if (cond_11133.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_11133.isBuiltAndFalse ()) {
                ...
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  {
                  const GGS_bool cond_11416 = (var_cas_extension).operator_isEqual (GGS_string ("gGrammar")) ;
                  if (cond_11416.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_11416.isBuiltAndFalse ()) {
                ...
                case GGS_sourceFileKind::enum_programSourceFile:
                  {
                  const GGS_bool cond_11663 = (var_cas_extension).operator_isEqual (GGS_string ("gProgram")) ;
                  if (cond_11663.isBuiltAndTrue ()) {
                  }else if (cond_11663.isBuiltAndFalse ()) {
            ...
            const GGS_bool cond_11990 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_11990.isBuiltAndTrue ()) {
            ...
            const GGS_bool cond_13663 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_13663.isBuiltAndTrue ()) {
              GGS_stringlist  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (276)) ;
              const GGS_bool cond_13652 = (var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (277))).operator_strictSup (GGS_uint (0U)) ;
              if (cond_13652.isBuiltAndTrue ()) {
                ...
                var_cas_pathSet.addAssign_operation (GGS_string ("SOURCES_DIR += ../hand_coded_sources\n")) ;
                {
                  ...
                  while (((operand_12390 = enumerator_12390.nextObject ()))) {
                    ...
                    GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (286)) ;
                    const GGS_bool cond_13043 = (var_cas_sourceKind).operator_isEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                    if (cond_13043.isBuiltAndTrue ()) {
                      const GGS_bool cond_12819 = (var_cas_filePath.reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
                      if (cond_12819.isBuiltAndTrue ()) {
                        var_cas_pathSet.addAssign_operation (((GGS_string ("SOURCES_DIR += ")).operator_concat (var_cas_filePath)).operator_concat (GGS_string ("\n"))) ;
                      }else if (cond_12819.isBuiltAndFalse ()) {
                        const GGS_bool cond_12937 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
                    ...
                    }else if (cond_13043.isBuiltAndFalse ()) {
            ...
            GGS_stringlist  var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (312)) ;
            GGS_stringlist  var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (313)) ;
            const GGS_bool cond_18405 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_18405.isBuiltAndTrue ()) {
              GGS_string var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (315)).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (315))).operator_concat (GGS_string ("/project_xcode")) ;
              GGS_stringlist  var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (317)) ;
              GGS_stringlist  var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (318)) ;
              const GGS_bool cond_14519 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (320))).operator_isEqual (GGS_uint (0U)) ;
              if (cond_14519.isBuiltAndTrue ()) {
              ...
              }else if (cond_14519.isBuiltAndFalse ()) {
                const GGS_bool cond_14694 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (322))).operator_strictSup (GGS_uint (1U)) ;
                if (cond_14694.isBuiltAndTrue ()) {
                ...
                }else if (cond_14694.isBuiltAndFalse ()) {
                  const GGS_bool cond_18394 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (324))).operator_isEqual (GGS_uint (1U)) ;
                  if (cond_18394.isBuiltAndTrue ()) {
                    ...
                    GGS_string var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (328))).operator_concat (GGS_string ("/DEPENDENCIES/file_list_for_xcode_project.txt")) ;
