...
//                    december 14th, 2009, at 18h42'36"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
mda_galgas_prgm_prologue (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3386 = gOption_galgas_5F_cli_5F_options_printPredefinedLexicalActions.reader_value () ;
      ...
      for (PMSInt32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_8690 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8690 = NULL ;
              while (((operand_8690 = enumerator_8690.nextObject ()))) {
                macroValidPointer (operand_8690) ;
                GGS_string var_cas_baseName = operand_8690->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_8690->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) COMMA_HERE), operand_8690->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)), operand_8690->mSourceKind COMMA_SOURCE_FILE_AT_LINE (201)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_8929 (operand_8690->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_8929 = NULL ;
                  while (((operand_8929 = enumerator_8929.nextObject ()))) {
                    macroValidPointer (operand_8929) ;
                    const GGS_bool cond_9158 = (((operand_8929->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((operand_8929->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((operand_8929->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
                    if (cond_9158.isBuiltAndTrue ()) {
                      operand_8929->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (205)) ;
                    }else if (cond_9158.isBuiltAndFalse ()) {
                      var_cas_targetFileListMap.addAssign_operation (operand_8929->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_9578 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_9578 = NULL ;
              while (((operand_9578 = enumerator_9578.nextObject ()))) {
                macroValidPointer (operand_9578) ;
                GGS_string var_cas_extension = operand_9578->mFilePath.ggs_string ().reader_pathExtension () ;
                GGS_lstring  var_cas_fullFilePath = GGS_lstring ::constructor_new (inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_9578->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221))), operand_9578->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) COMMA_HERE) ;
                const GGS_bool cond_9910 = (operand_9578->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                if (cond_9910.isBuiltAndTrue ()) {
                  inLexique.printMessage (((GGS_string ("----- Compiling '")).operator_concat (operand_9578->mFilePath)).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (225)) ;
                }
                switch (operand_9578->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  {
                  const GGS_bool cond_10122 = (var_cas_extension).operator_isEqual (GGS_string ("gGui")) ;
                  if (cond_10122.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10122.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (234)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  {
                  const GGS_bool cond_10381 = (var_cas_extension).operator_isEqual (GGS_string ("gLexique")) ;
                  if (cond_10381.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10381.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (240)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  {
                  const GGS_bool cond_10645 = (var_cas_extension).operator_isEqual (GGS_string ("gOption")) ;
                  if (cond_10645.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10645.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (246)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  {
                  const GGS_bool cond_10921 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
                  if (cond_10921.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_10921.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (252)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  {
                  const GGS_bool cond_11207 = (var_cas_extension).operator_isEqual (GGS_string ("gSyntax")) ;
                  if (cond_11207.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_11207.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (258)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  {
                  const GGS_bool cond_11585 = (var_cas_extension).operator_isEqual (GGS_string ("gGrammar")) ;
                  if (cond_11585.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_11585.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (269)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  {
                  const GGS_bool cond_11832 = (var_cas_extension).operator_isEqual (GGS_string ("gProgram")) ;
                  if (cond_11832.isBuiltAndTrue ()) {
                  }else if (cond_11832.isBuiltAndFalse ()) {
                    operand_9578->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (275)) ;
                  }
                  }
                  break ;
            ...
            const GGS_bool cond_12159 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_12159.isBuiltAndTrue ()) {
            ...
            const GGS_bool cond_13832 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_13832.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_13821 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
              if (cond_13821.isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_12559 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_12559 = NULL ;
                  while (((operand_12559 = enumerator_12559.nextObject ()))) {
                    macroValidPointer (operand_12559) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_12659 = var_cas_sourceFileMap ;
                    if (temp_12659.isBuilt ()) {
                      temp_12659 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12559->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (294)) ;
                    }
                    GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent () ;
                    const GGS_bool cond_13212 = (var_cas_sourceKind).operator_isEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                    if (cond_13212.isBuiltAndTrue ()) {
                      const GGS_bool cond_12988 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
                      if (cond_12988.isBuiltAndTrue ()) {
                        var_cas_pathSet.addAssign_operation (((GGS_string ("SOURCES_DIR += ")).operator_concat (var_cas_filePath)).operator_concat (GGS_string ("\n"))) ;
                      }else if (cond_12988.isBuiltAndFalse ()) {
                        const GGS_bool cond_13106 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
                        if (cond_13106.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_13212.isBuiltAndFalse ()) {
                ...
                {
                  GGS_stringset::cEnumerator enumerator_13426 (var_cas_pathSet, true) ;
                  while (enumerator_13426.hasCurrentObject ()) {
                    var_cas_pathesString.dotAssign_operation (enumerator_13426._key (HERE)) ;
                    enumerator_13426.next () ;
                  }
                }
                ...
                GGS_bool automatic_var_13811_0 ;
                const GGS_string temp_13793 = var_cas_newFileListContents ;
                if (temp_13793.isBuilt ()) {
                  temp_13793 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_13811_0 COMMA_SOURCE_FILE_AT_LINE (317)) ;
                }
              }
            }
            ...
            const GGS_bool cond_18574 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
            if (cond_18574.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_14688 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
              if (cond_14688.isBuiltAndTrue ()) {
                ...
                const GGS_bool cond_14863 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
                if (cond_14863.isBuiltAndTrue ()) {
                ...
                }else if (cond_14863.isBuiltAndFalse ()) {
                  const GGS_bool cond_18563 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
                  if (cond_18563.isBuiltAndTrue ()) {
                    GGS_string var_cas_name ;
                    const GGS_stringlist  temp_14938 = var_cas_xcodeProjects ;
                    if (temp_14938.isBuilt ()) {
                      temp_14938 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (334)) ;
                    }
                    ...
                    {
                      GGS_stringlist::cEnumerator enumerator_15697 (var_cas_xcode_tool_files, true) ;
                      const GGS_stringlist::cElement * operand_15697 = NULL ;
                      while (((operand_15697 = enumerator_15697.nextObject ()))) {
                        macroValidPointer (operand_15697) ;
                        GGS_string var_cas_fullPath ;
                        GGS_sourceFileKind var_cas_sourceKind ;
                        const GGS_sourceFileMap  temp_15797 = var_cas_sourceFileMap ;
                        if (temp_15797.isBuilt ()) {
                          temp_15797 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15697->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (350)) ;
                        }
                        ...
                        case GGS_sourceFileKind::enum_lexiqueSourceFile:
                          {
                          var_cas_scannerSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_guiSourceFile:
                          {
                          var_cas_guiSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_optionSourceFile:
                          {
                          var_cas_optionSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_syntaxSourceFile:
                          {
                          var_cas_syntaxSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_semanticsSourceFile:
                          {
                          var_cas_semanticsSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_grammarSourceFile:
                          {
                          var_cas_grammarSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_programSourceFile:
                          {
                          var_cas_programSourceSet_tool.addAssign_operation (operand_15697->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::kNotBuilt:
                          break ;
                    ...
                    {
                      GGS_stringlist::cEnumerator enumerator_16969 (var_cas_xcode_app_files, true) ;
                      ...
                      while (((operand_16969 = enumerator_16969.nextObject ()))) {
                        ...
                        GGS_string var_cas_fullPath ;
                        GGS_sourceFileKind var_cas_sourceKind ;
                        const GGS_sourceFileMap  temp_17069 = var_cas_sourceFileMap ;
                        if (temp_17069.isBuilt ()) {
                          temp_17069 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_16969->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (381)) ;
                        }
                        switch (var_cas_sourceKind.enumValue ()) {
                        case GGS_sourceFileKind::enum_externSourceFile:
                          {
                        ...
                        case GGS_sourceFileKind::enum_lexiqueSourceFile:
                          {
                          var_cas_scannerSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_guiSourceFile:
                          {
                          var_cas_guiSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_optionSourceFile:
                          {
                          var_cas_optionSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_syntaxSourceFile:
                          {
                          var_cas_syntaxSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_semanticsSourceFile:
                          {
                          var_cas_semanticsSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_grammarSourceFile:
                          {
                          var_cas_grammarSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::enum_programSourceFile:
                          {
                          var_cas_programSourceSet_app.addAssign_operation (operand_16969->mValue) ;
                          }
                          break ;
                        case GGS_sourceFileKind::kNotBuilt:
                          break ;
