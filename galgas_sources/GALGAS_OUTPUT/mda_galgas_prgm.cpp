...
//                    november 28th, 2008, at 17h16'54"                      *
//                                                                           *
//---------------------------------------------------------------------------*
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_6942 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_6942 = NULL ;
              while (((operand_6942 = enumerator_6942.nextObject ()))) {
                macroValidPointer (operand_6942) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_6942->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
                var_cas_sourceFileMap.modifier_insertKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_baseName, operand_6942->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_HERE), operand_6942->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)), operand_6942->mSourceKind COMMA_SOURCE_FILE_AT_LINE (160)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7181 (operand_6942->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7181 = NULL ;
                  while (((operand_7181 = enumerator_7181.nextObject ()))) {
                    macroValidPointer (operand_7181) ;
                    if ((((operand_7181->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((operand_7181->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_isNotEqual (GGS_string (true, "xcode")))).isBuiltAndTrue ()) {
                      operand_7181->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the target name should be \"makefile\" or \"xcode\"") COMMA_SOURCE_FILE_AT_LINE (164)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7181->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_7643 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7643 = NULL ;
              while (((operand_7643 = enumerator_7643.nextObject ()))) {
                macroValidPointer (operand_7643) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_7643->mFilePath.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7643->mFilePath.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177))), operand_7643->mFilePath.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_HERE) ;
                if (((operand_7643->mSourceKind)._operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7643->mFilePath))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (181)) ;
                }
                switch (operand_7643->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (202)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (214)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (220)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_7643->mFilePath.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10360 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10360 = NULL ;
                  while (((operand_10360 = enumerator_10360.nextObject ()))) {
                    macroValidPointer (operand_10360) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  _temp_10460 = var_cas_sourceFileMap ;
                    if (_temp_10460._isBuilt ()) {
                      _temp_10460 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10360->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (245)) ;
                    }
                ...
                {
                  GGS_stringset::cEnumerator enumerator_11227 (var_cas_pathSet, true) ;
                  while (enumerator_11227.hc ()) {
                    var_cas_pathesString._dotAssign_operation (enumerator_11227._key (HERE)) ;
                    enumerator_11227.next () ;
                  }
                }
                ...
                const GGS_string _temp_11590 = var_cas_newFileListContents ;
                if (_temp_11590._isBuilt ()) {
                  _temp_11590 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (268)) ;
                }
              }
            }
            ...
            if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcodeFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (273)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (279)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                const GGS_stringlist  _temp_12675 = var_cas_xcodeProjects ;
                if (_temp_12675._isBuilt ()) {
                  _temp_12675 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (284)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_13276 (var_cas_xcodeFiles, true) ;
                  const GGS_stringlist::cElement * operand_13276 = NULL ;
                  while (((operand_13276 = enumerator_13276.nextObject ()))) {
                    macroValidPointer (operand_13276) ;
                    var_cas_intermediateString._dotAssign_operation (operand_13276->mValue) ;
                ...
                const GGS_string _temp_13559 = var_cas_intermediateString ;
                if (_temp_13559._isBuilt ()) {
                  _temp_13559 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (302)) ;
                }
                if ((var_cas_written).isBuiltAndTrue ()) {
                  {
                    GGS_stringlist::cEnumerator enumerator_13705 (var_cas_xcodeFiles, true) ;
                    ...
                    while (((operand_13705 = enumerator_13705.nextObject ()))) {
                      ...
                      GGS_string var_cas_fullPath ;
                      GGS_sourceFileKind var_cas_sourceKind ;
                      const GGS_sourceFileMap  _temp_13811 = var_cas_sourceFileMap ;
                      if (_temp_13811._isBuilt ()) {
                        _temp_13811 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_13705->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (308)) ;
                      }
                      ...
                      case GGS_sourceFileKind::enum_lexiqueSourceFile:
                        {
                        var_cas_scannerSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_guiSourceFile:
                        {
                        var_cas_guiSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_optionSourceFile:
                        {
                        var_cas_optionSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_syntaxSourceFile:
                        {
                        var_cas_syntaxSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_semanticsSourceFile:
                        {
                        var_cas_semanticsSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_grammarSourceFile:
                        {
                        var_cas_grammarSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::enum_programSourceFile:
                        {
                        var_cas_programSourceSet._addAssign_operation (operand_13705->mValue) ;
                        }
                        break ;
                      case GGS_sourceFileKind::kNotBuilt:
                        break ;
