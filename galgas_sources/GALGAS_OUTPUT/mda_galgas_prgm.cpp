      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("ggs") == 0) {
            ...
            {
              GGS_projectSourceList::cEnumerator enumerator_7353 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_7353 = NULL ;
              while (((operand_7353 = enumerator_7353.nextObject ()))) {
                macroValidPointer (operand_7353) ;
                GGS_string var_cas_baseName ;
                var_cas_baseName = operand_7353->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (166)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
                var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, operand_7353->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_HERE), operand_7353->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167)), operand_7353->mSourceKind COMMA_SOURCE_FILE_AT_LINE (167)) ;
                {
                  GGS_lstringlist::cEnumerator enumerator_7592 (operand_7353->mTargetList, true) ;
                  const GGS_lstringlist::cElement * operand_7592 = NULL ;
                  while (((operand_7592 = enumerator_7592.nextObject ()))) {
                    macroValidPointer (operand_7592) ;
                    if (((((operand_7592->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((operand_7592->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((operand_7592->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169))).operator_isNotEqual (GGS_string ("xcode_app")))).isBuiltAndTrue ()) {
                      operand_7592->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (171)) ;
                    }else{
                      var_cas_targetFileListMap._addAssign_operation (operand_7592->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)), var_cas_baseName) ;
                    }
                  }
                }
              }
            ...
            var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            {
              GGS_projectSourceList::cEnumerator enumerator_8114 (var_cas_projectSourceList, true) ;
              const GGS_projectSourceList::cElement * operand_8114 = NULL ;
              while (((operand_8114 = enumerator_8114.nextObject ()))) {
                macroValidPointer (operand_8114) ;
                GGS_string var_cas_extension ;
                var_cas_extension = operand_8114->mFilePath.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (182)) ;
                GGS_lstring  var_cas_fullFilePath ;
                var_cas_fullFilePath = GGS_lstring ::constructor_new (inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).operator_concat (GGS_string ("/"))).operator_concat (operand_8114->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184))), operand_8114->mFilePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_HERE) ;
                if (((operand_8114->mSourceKind).operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
                  inLexique.printMessage (((GGS_string ("----- Compiling '")).operator_concat (operand_8114->mFilePath)).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (188)) ;
                }
                switch (operand_8114->mSourceKind.enumValue ()) {
                ...
                case GGS_sourceFileKind::enum_guiSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGui"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a gui component should be '.gGui'.") COMMA_SOURCE_FILE_AT_LINE (197)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_lexiqueSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gLexique"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a lexique component should be '.gLexique'.") COMMA_SOURCE_FILE_AT_LINE (203)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_optionSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gOption"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of an option component should be '.gOption'.") COMMA_SOURCE_FILE_AT_LINE (209)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_semanticsSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSemantics"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a semantics component should be '.gSemantics'.") COMMA_SOURCE_FILE_AT_LINE (215)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_syntaxSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a syntax component should be '.gSyntax'.") COMMA_SOURCE_FILE_AT_LINE (221)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_grammarSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gGrammar"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a grammar component should be '.gGrammar'.") COMMA_SOURCE_FILE_AT_LINE (227)) ;
                  }
                  }
                  break ;
                case GGS_sourceFileKind::enum_programSourceFile:
                  ...
                  if (((var_cas_extension).operator_isEqual (GGS_string ("gProgram"))).isBuiltAndTrue ()) {
                    ...
                    operand_8114->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("extension of a program component should be '.gProgram'.") COMMA_SOURCE_FILE_AT_LINE (233)) ;
                  }
                  }
                  break ;
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_10862 (var_cas_makefileFiles, true) ;
                  const GGS_stringlist::cElement * operand_10862 = NULL ;
                  while (((operand_10862 = enumerator_10862.nextObject ()))) {
                    macroValidPointer (operand_10862) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_10962 = var_cas_sourceFileMap ;
                    if (temp_10962.isBuilt ()) {
                      temp_10962 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_10862->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (252)) ;
                    }
                ...
                {
                  GGS_stringset::cEnumerator enumerator_11729 (var_cas_pathSet, true) ;
                  while (enumerator_11729.hasCurrentObject ()) {
                    var_cas_pathesString.dotAssign_operation (enumerator_11729._key (HERE)) ;
                    enumerator_11729.next () ;
                  }
                }
                ...
                const GGS_string temp_12096 = var_cas_newFileListContents ;
                if (temp_12096.isBuilt ()) {
                  temp_12096 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (275)) ;
                }
              }
            }
            ...
            if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (287))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                const GGS_stringlist  temp_13241 = var_cas_xcodeProjects ;
                if (temp_13241.isBuilt ()) {
                  temp_13241 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (292)) ;
                }
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_14000 (var_cas_xcode_tool_files, true) ;
                  const GGS_stringlist::cElement * operand_14000 = NULL ;
                  while (((operand_14000 = enumerator_14000.nextObject ()))) {
                    macroValidPointer (operand_14000) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_14100 = var_cas_sourceFileMap ;
                    if (temp_14100.isBuilt ()) {
                      temp_14100 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14000->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (308)) ;
                    }
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_tool._addAssign_operation (operand_14000->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
                ...
                {
                  GGS_stringlist::cEnumerator enumerator_15272 (var_cas_xcode_app_files, true) ;
                  const GGS_stringlist::cElement * operand_15272 = NULL ;
                  while (((operand_15272 = enumerator_15272.nextObject ()))) {
                    macroValidPointer (operand_15272) ;
                    GGS_string var_cas_fullPath ;
                    GGS_sourceFileKind var_cas_sourceKind ;
                    const GGS_sourceFileMap  temp_15372 = var_cas_sourceFileMap ;
                    if (temp_15372.isBuilt ()) {
                      temp_15372 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15272->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (339)) ;
                    }
                    switch (var_cas_sourceKind.enumValue ()) {
                    case GGS_sourceFileKind::enum_externSourceFile:
                      {
                    ...
                    case GGS_sourceFileKind::enum_lexiqueSourceFile:
                      {
                      var_cas_scannerSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_guiSourceFile:
                      {
                      var_cas_guiSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_optionSourceFile:
                      {
                      var_cas_optionSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_syntaxSourceFile:
                      {
                      var_cas_syntaxSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_semanticsSourceFile:
                      {
                      var_cas_semanticsSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_grammarSourceFile:
                      {
                      var_cas_grammarSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::enum_programSourceFile:
                      {
                      var_cas_programSourceSet_app._addAssign_operation (operand_15272->mValue) ;
                      }
                      break ;
                    case GGS_sourceFileKind::kNotBuilt:
                      break ;
