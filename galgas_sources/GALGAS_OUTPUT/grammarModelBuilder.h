...
class grammarModelBuilder {
  ...
  protected : void pr_grammar_start_symbol_label_grammarModelBuilder_126_33_ (galgas_scanner &,
                                const GGS_lstring  ,
                                GGS_nonTerminalLabelList  &) ;

  protected : virtual PMSInt16 select_repeat_grammarModelBuilder_6 (galgas_scanner &) = 0 ;

  protected : void pr_label_formal_parameter_grammarModelBuilder_146_29_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_formalParameterList  &) ;

  protected : virtual PMSInt16 select_grammarModelBuilder_7 (galgas_scanner &) = 0 ;

  protected : void pr_label_formal_parameter_grammarModelBuilder_167_29_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_formalParameterList  &) ;

  protected : virtual PMSInt16 select_grammarModelBuilder_8 (galgas_scanner &) = 0 ;

  protected : void pr_label_formal_parameter_grammarModelBuilder_188_29_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_formalParameterList  &) ;

  protected : virtual PMSInt16 select_grammarModelBuilder_9 (galgas_scanner &) = 0 ;

  protected : void pr_label_formal_parameter_grammarModelBuilder_209_29_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_formalParameterList  &) ;
