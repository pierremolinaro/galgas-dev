...
void routine_enterInstanceMethodWithInputArgument (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inInputArgumentTypeName, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (49)) ;
...
void routine_enterInstanceMethodWithOutputArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_argumentTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, var_cas_inInputArgumentTypeName, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (70)) ;
  GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
...
category_method__dataPredefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
                                const cPtr_dataPredefinedTypeAST * operand_3626,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_instanceMethodMap  & var_cas_outInstanceMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3626 != NULL) {
...
category_method__stringPredefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
                                const cPtr_stringPredefinedTypeAST * operand_4057,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_instanceMethodMap  & var_cas_outInstanceMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4057 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_string ("string"), var_cas_t COMMA_SOURCE_FILE_AT_LINE (104)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_string ("bool"), var_cas_t COMMA_SOURCE_FILE_AT_LINE (106)) ;
