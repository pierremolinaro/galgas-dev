...
void routine_enterInstanceMethodWithoutArgument (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioInstanceMethodMap.modifier_insertKey (inLexique, var_cas_inInstanceMethodName, GGS_formalParameterSignature ::constructor_emptyList (), var_cas_inInstanceMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (34)), var_cas_inHasCompilerArgument, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) COMMA_SOURCE_FILE_AT_LINE (31)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__stringPredefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
  ...
  if (operand_4135 != NULL) {
    ...
    var_cas_outInstanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("writeToFileWhenDifferentContents"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (112)), var_cas_argList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
}
