...
void routine_enterInstanceMethodWithInputArgument (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inInputArgumentTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (49)), var_cas_ioUnifiedTypeMap, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (49)) ;
...
void routine_enterInstanceMethodWithOutputArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapIndex  var_cas_argumentTypeIndex ;
  GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inInputArgumentTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (70)), var_cas_ioUnifiedTypeMap, var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (70)) ;
  GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
...
category_method__stringPredefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
  ...
  if (operand_4101 != NULL) {
    ...
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (104)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (104)) ;
    ...
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("bool"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (106)), var_cas_ioUnifiedTypeMap, var_cas_t COMMA_SOURCE_FILE_AT_LINE (106)) ;
