...
C_String C_Lexique_galgas_33_Scanner::getMessageForTerminal (const int16_t inTerminalIndex) const {
  static const utf32 * syntaxErrorMessageArray [136] = {kEndOfSourceLexicalErrorMessage,
  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z'))) {
        ...
        const C_LocationInSource locationForTag_onlyInterrogationMark = mCurrentLocation ;
        const utf32 currentCharForTag_onlyInterrogationMark = mCurrentChar ;
        if (testForInputUTF32Char (TO_UNICODE ('!'))) {
          const C_LocationInSource locationForTag_onlyExclamationInterrogationMark = mCurrentLocation ;
          ...
          if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z'))) {
            ...
            if (testForInputUTF32Char (TO_UNICODE (':'))) {
              ...
              mCurrentLocation = locationForTag_onlyExclamationInterrogationMark ;
          ...
          if (testForInputUTF32Char (TO_UNICODE (':'))) {
            ...
            ::scanner_routine_resetString (*this, token.mLexicalAttribute_tokenString) ;
            mCurrentLocation = locationForTag_onlyInterrogationMark ;
        ...
        const C_LocationInSource locationForTag_onlyExclamationMark = mCurrentLocation ;
        const utf32 currentCharForTag_onlyExclamationMark = mCurrentChar ;
        if (testForInputUTF32Char (TO_UNICODE ('\?'))) {
          const C_LocationInSource locationForTag_onlyInterrogationExclamationMark = mCurrentLocation ;
          ...
          if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z'))) {
            ...
            if (testForInputUTF32Char (TO_UNICODE (':'))) {
              ...
              ::scanner_routine_resetString (*this, token.mLexicalAttribute_tokenString) ;
              mCurrentLocation = locationForTag_onlyInterrogationExclamationMark ;
          ...
          if (testForInputUTF32Char (TO_UNICODE (':'))) {
            ...
            ::scanner_routine_resetString (*this, token.mLexicalAttribute_tokenString) ;
            mCurrentLocation = locationForTag_onlyExclamationMark ;
