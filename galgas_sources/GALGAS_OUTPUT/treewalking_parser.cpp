...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203))).isBuiltAndTrue ()) {
    if (var_cas_metamodelComponentMap._isBuilt (HERE)) {
    ...
    while ((operand_7881 != NULL)) {
      ...
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_7881->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (212)) ;
      operand_7881 = operand_7881->nextObject () ;
    }
  }else{
    var_cas_fileName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "this file does not define the '"))._operator_concat (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)))._operator_concat (_inLexique, GGS_string (true, "' metamodel") COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (222)) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_treewalking_parser_0 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_semanticsComponentMap._isBuilt (HERE)) {
          ...
          while ((operand_9129 != NULL)) {
            ...
            if (((var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_9129->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (247))).isBuiltAndTrue ()) {
              var_cas_semanticsEntitiesMap.modifier_insertKey (_inLexique, operand_9129->mKey, operand_9129->mInfo.aDefEntite COMMA_SOURCE_FILE_AT_LINE (248)) ;
            }
  ...
  if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283))).isBuiltAndTrue ()) {
    if (var_cas_treewalkingRoutineHeaderMap._isBuilt (HERE)) {
    ...
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a routine should be defined for the '@"))._operator_concat (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (286)) COMMA_SOURCE_FILE_AT_LINE (286)))._operator_concat (_inLexique, GGS_string (true, "' root class") COMMA_SOURCE_FILE_AT_LINE (286)) COMMA_SOURCE_FILE_AT_LINE (288)) ;
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    ...
    while ((operand_10895 != NULL)) {
      ...
      if (var_cas_metamodelEntityMap._isBuilt (HERE)) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_10895->mKey, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (298)), var_cas_entityID, operand_10895->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)), operand_10895->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_10895->mKey ;
      GGS_uint _variant_11889 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)) ;
      GGS_bool _condition_11889 (_variant_11889._isBuilt (SOURCE_FILE_AT_LINE (318)), true) ;
      while (_condition_11889.isBuiltAndTrue ()) {
        _condition_11889 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (305)) ;
        if (_condition_11889.isBuiltAndTrue ()) {
          if (_variant_11889.uintValue () == 0) {
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (308))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_10895->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_10895->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
            }
    ...
    while ((operand_12051 != NULL)) {
      ...
      var_cas_hasRoutine = var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, operand_12051->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)) ;
      if (((var_cas_hasRoutine)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (324))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_superEntityName ;
        var_cas_superEntityName = operand_12051->mInfo.mSuperEntityName ;
        GGS_uint _variant_12722 = var_cas_treewalkingRoutineHeaderMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
        GGS_bool _condition_12722 (_variant_12722._isBuilt (SOURCE_FILE_AT_LINE (333)), true) ;
        while (_condition_12722.isBuiltAndTrue ()) {
          _condition_12722 = ((var_cas_hasRoutine)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_and (_inLexique, (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)) ;
          if (_condition_12722.isBuiltAndTrue ()) {
            if (_variant_12722.uintValue () == 0) {
              ...
              if (((var_cas_hasRoutine)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (328))).isBuiltAndTrue ()) {
        ...
        if ((var_cas_hasRoutine).isBuiltAndTrue ()) {
          ...
          if (var_cas_metamodelEntityMap._isBuilt (HERE)) {
            var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_12051->mKey, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31, automatic_var_32, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (337)) ;
          }
          var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)), var_cas_entityID, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)), operand_12051->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)), var_cas_metamodelName) ;
        }
      }
      operand_12051 = operand_12051->nextObject () ;
    }
    if (var_cas_treewalkingName._isBuilt (HERE) &&
        var_cas_filesToImportInHeaderSet._isBuilt (HERE) &&
        var_cas_treewalkingRoutineToGenerateList._isBuilt (HERE) &&
        var_cas_routineDispatcherSortedList._isBuilt (HERE) &&
        var_cas_rootRoutineArgumentList._isBuilt (HERE) &&
        var_cas_metamodelRootEntity._isBuilt (HERE)) {
  ...
  if (((var_cas_ioTreewalkingComponentMap.reader_hasKey (_inLexique, var_cas_treewalkingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (359))).isBuiltAndTrue ()) {
...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inMetamodelEntityMap._isBuilt (HERE)) {
  ...
  while ((operand_14976 != NULL)) {
    ...
    if (operand_14976->mInfo.mPropertyType._isBuilt (SOURCE_FILE_AT_LINE (402))) {
      ...
      if (operand_15044 != NULL) {
        ...
        if (operand_15094 != NULL) {
          ...
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_14976->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)), operand_14976->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_14976->mKey, operand_14976->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (408)) ;
        }
      }
    }
