  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    ...
    while ((operand_10895 != NULL)) {
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_10895->mKey, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, var_cas_metamodelName, var_cas_entityID SOURCE_FILE_AT_LINE (296)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique SOURCE_FILE_AT_LINE (298)), var_cas_entityID, operand_10895->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (300)), operand_10895->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (301)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_10895->mKey ;
      GGS_uint _variant_11889 = var_cas_metamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (305)) ;
      GGS_bool _condition_11889 (_variant_11889._isBuilt (), true) ;
      while (_condition_11889.isBuiltAndTrue ()) {
        _condition_11889 = (var_cas_entityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (305))) != (GGS_string (true, "")) ;
        if (_condition_11889.isBuiltAndTrue ()) {
          if (_variant_11889.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (318)) ;
            _condition_11889 = GGS_bool (true, false) ;
          }else{
            _variant_11889._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if (var_cas_metamodelEntityMap._isBuilt ()) {
              var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, automatic_var_12, automatic_var_13, automatic_var_14, var_cas_superEntityName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18 SOURCE_FILE_AT_LINE (307)) ;
            }
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (308)) SOURCE_FILE_AT_LINE (308))).isBuiltAndTrue ()) {
              ...
              if (var_cas_treewalkingRoutineHeaderMap._isBuilt ()) {
                var_cas_treewalkingRoutineHeaderMap (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superRoutineSignature, automatic_var_19 SOURCE_FILE_AT_LINE (310)) ;
              }
    ...
    GGS_entityToImplementMap::element_type * operand_12051 = var_cas_metamodelEntityMap.firstObject () ;
    while ((operand_12051 != NULL)) {
      macroValidPointer (operand_12051) ;
      GGS_bool var_cas_hasRoutine ;
      var_cas_hasRoutine = var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, operand_12051->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (323)) SOURCE_FILE_AT_LINE (323)) ;
      if (((! (var_cas_hasRoutine))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_superEntityName ;
        var_cas_superEntityName = operand_12051->mInfo.mSuperEntityName ;
        GGS_uint _variant_12722 = var_cas_treewalkingRoutineHeaderMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (326)) ;
        GGS_bool _condition_12722 (_variant_12722._isBuilt (), true) ;
        while (_condition_12722.isBuiltAndTrue ()) {
          _condition_12722 = (((! (var_cas_hasRoutine))) & ((var_cas_superEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (326))) != (GGS_string (true, "")))) ;
          if (_condition_12722.isBuiltAndTrue ()) {
            if (_variant_12722.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (333)) ;
              _condition_12722 = GGS_bool (true, false) ;
            }else{
              _variant_12722._decrement_operation (_inLexique COMMA_HERE) ;
              ...
              if (((! (var_cas_hasRoutine))).isBuiltAndTrue ()) {
                ...
                if (var_cas_metamodelEntityMap._isBuilt ()) {
                  var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, automatic_var_20, automatic_var_21, automatic_var_22, var_cas_superSuperEntityName, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26 SOURCE_FILE_AT_LINE (330)) ;
                }
        ...
        if ((var_cas_hasRoutine).isBuiltAndTrue ()) {
          ...
          if (var_cas_metamodelEntityMap._isBuilt ()) {
            var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_12051->mKey, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31, automatic_var_32, var_cas_metamodelName, var_cas_entityID SOURCE_FILE_AT_LINE (337)) ;
          }
          var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique SOURCE_FILE_AT_LINE (339)), var_cas_entityID, var_cas_superEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (341)), operand_12051->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (342)), var_cas_metamodelName) ;
        }
      }
      operand_12051 = operand_12051->nextObject () ;
    }
    if (var_cas_treewalkingName._isBuilt () &&
      ...
      ::routine_generate_treewalking (_inLexique,  var_cas_treewalkingName,  var_cas_filesToImportInHeaderSet,  var_cas_treewalkingRoutineToGenerateList,  var_cas_routineDispatcherSortedList,  var_cas_metamodelEntityMap,  var_cas_rootRoutineArgumentList,  var_cas_metamodelRootEntity SOURCE_FILE_AT_LINE (348)) ;
    }
  }
...
pr_treewalking_routine_treewalking_parser_375_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inMetamodelEntityMap._isBuilt ()) {
    var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_33, automatic_var_34, automatic_var_35, automatic_var_36, automatic_var_37, automatic_var_38, automatic_var_39 SOURCE_FILE_AT_LINE (387)) ;
  }
  ...
  GGS_entityPropertyMap::element_type * operand_15002 = var_cas_allMetamodelPropertyMap.firstObject () ;
  while ((operand_15002 != NULL)) {
    macroValidPointer (operand_15002) ;
    if (operand_15002->mInfo.mPropertyType._isBuilt ()) {
      cPtr_typeGalgas_singleReferenceEntity * operand_15070 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_15002->mInfo.mPropertyType.getPtr ()) ;
      if (operand_15070 != NULL) {
        macroValidPointer (operand_15070) ; 
      }else{
        cPtr_typeGalgas_multipleReferenceEntity * operand_15120 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_15002->mInfo.mPropertyType.getPtr ()) ;
        if (operand_15120 != NULL) {
          macroValidPointer (operand_15120) ; 
        }else{ // Else part
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_15002->mKey COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_15002->mKey, operand_15002->mInfo.mPropertyType, var_cas_cppName SOURCE_FILE_AT_LINE (409)) ;
        }
      }
    }
    operand_15002 = operand_15002->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
