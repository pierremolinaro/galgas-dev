...
treewalking_parser::
pr_galgas_component_treewalking_parser_152_6_ (galgas_scanner & _inLexique,
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_152_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_152_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap) {
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_152_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap) {
  nt_parse_treewalking_document_ (_inLexique, var_cas_ioMetamodelComponentMap, var_cas_ioTreewalkingComponentMap, GGS_bool (true, false)) ;
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_152_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap) {
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_152_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_treewalking_document_parse (_inLexique) ;
}
...
void treewalking_parser::
treewalking_parser::
pr_parse_treewalking_document_treewalking_parser_210_6_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271))).isBuiltAndTrue ()) {
    ...
    while ((operand_10558 != NULL)) {
      ...
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_10558->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (280)) ;
      operand_10558 = operand_10558->nextObject () ;
    }
  }else{
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "imported files do not define the '"))._operator_concat (var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (288))))._operator_concat (GGS_string (true, "' metamodel")) COMMA_SOURCE_FILE_AT_LINE (290)) ;
      ...
      while (_condition_20223.isBuiltAndTrue ()) {
        ...
        if (_condition_20223.isBuiltAndTrue ()) {
          if (_variant_20223.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (518)) ;
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)) COMMA_SOURCE_FILE_AT_LINE (508))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_19201->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_19201->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (514)) COMMA_SOURCE_FILE_AT_LINE (511)) ;
            }
...
void treewalking_parser::
pr_parse_treewalking_document_treewalking_parser_210_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_treewalking) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_539_6_ (galgas_scanner & _inLexique,
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_539_6_firstLocalPhase (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inSemanticsEntitiesMap,
...
void treewalking_parser::
pr_treewalking_routine_treewalking_parser_539_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
