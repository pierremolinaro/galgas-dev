...
pr_parse_treewalking_document_treewalking_parser_205_4_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (270))).isBuiltAndTrue ()) {
    const GGS_M_metamodelsComponents  _temp_10449 = var_cas_metamodelComponentMap ;
    if (_temp_10449._isBuilt ()) {
      _temp_10449 (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_metamodelRootEntity, var_cas_metamodelEntityMap, var_cas_importedMetamodels COMMA_SOURCE_FILE_AT_LINE (271)) ;
    }
    GGS_stringset  var_cas_superMetamodels ;
    var_cas_superMetamodels = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
    GGS_stringset::cEnumerator enumerator_10627 (var_cas_importedMetamodels, true) ;
    const GGS_stringset::cElement * operand_10627 = NULL ;
    while (((operand_10627 = (GGS_stringset::cElement *) enumerator_10627.nextObject ()))) {
      macroValidPointer (operand_10627) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_10627->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (278)) ;
    }
    enumerator_10627.reset () ;
  }else{
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12670 = _inLexique.parsingContext () ;
    ...
    if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307))).isBuiltAndTrue ()) {
      const GGS_treewalkingRoutineHeaderMap  _temp_11792 = var_cas_treewalkingRoutineHeaderMap ;
      if (_temp_11792._isBuilt ()) {
        _temp_11792 (HERE)->method_searchKey (_inLexique, var_cas_metamodelRootEntity, var_cas_rootRoutineSignature, var_cas_rootRoutineArgumentList COMMA_SOURCE_FILE_AT_LINE (308)) ;
      }
    }else{
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12670) ;
    { bool syntaxRepeat_0 = true ;
      while (syntaxRepeat_0) {
        switch (select_repeat_treewalking_parser_0 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    GGS_treewalkingRoutineHeaderMap::cEnumerator enumerator_12902 (var_cas_treewalkingRoutineHeaderMap, true) ;
    const GGS_treewalkingRoutineHeaderMap::cElement * operand_12902 = NULL ;
    while (((operand_12902 = (GGS_treewalkingRoutineHeaderMap::cElement *) enumerator_12902.nextObject ()))) {
      macroValidPointer (operand_12902) ;
      ...
      const GGS_entityToImplementMap  _temp_13062 = var_cas_metamodelEntityMap ;
      if (_temp_13062._isBuilt ()) {
        _temp_13062 (HERE)->method_searchKey (_inLexique, operand_12902->mKey, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (343)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (345)), var_cas_entityID, operand_12902->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (347)), operand_12902->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_12902->mKey ;
      GGS_uint _variant_13924 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (352)) ;
      GGS_bool _condition_13924 (_variant_13924._isBuilt (), true) ;
      while (_condition_13924.isBuiltAndTrue ()) {
        _condition_13924 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (352)))._operator_isNotEqual (GGS_string (true, "")) ;
        if (_condition_13924.isBuiltAndTrue ()) {
          if (_variant_13924.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (364)) ;
            _condition_13924 = GGS_bool (true, false) ;
          }else{
            _variant_13924._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            const GGS_entityToImplementMap  _temp_13444 = var_cas_metamodelEntityMap ;
            if (_temp_13444._isBuilt ()) {
              _temp_13444 (HERE)->method_searchKey (_inLexique, var_cas_entityName, automatic_var_6, automatic_var_7, automatic_var_8, var_cas_superEntityName, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (354)) ;
            }
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355))).isBuiltAndTrue ()) {
              ...
              const GGS_treewalkingRoutineHeaderMap  _temp_13661 = var_cas_treewalkingRoutineHeaderMap ;
              if (_temp_13661._isBuilt ()) {
                _temp_13661 (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superRoutineSignature, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (357)) ;
              }
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_12902->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_12902->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
            }
...
pr_treewalking_routine_treewalking_parser_386_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityToImplementMap  _temp_14966 = var_cas_inMetamodelEntityMap ;
  if (_temp_14966._isBuilt ()) {
    _temp_14966 (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_14, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (399)) ;
  }
  GGS_typeTableEnAvant  var_cas_tableEnAvant ;
  var_cas_tableEnAvant = GGS_typeTableEnAvant::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  GGS_entityPropertyMap::cEnumerator enumerator_15557 (var_cas_allMetamodelPropertyMap, true) ;
  const GGS_entityPropertyMap::cElement * operand_15557 = NULL ;
  while (((operand_15557 = (GGS_entityPropertyMap::cElement *) enumerator_15557.nextObject ()))) {
    macroValidPointer (operand_15557) ;
    { const GGS_AC_galgasType _var_15922 = operand_15557->mInfo.mPropertyType ; // CAST instruction
      if (_var_15922.getPtr () != NULL) {
        macroValidPointer (_var_15922.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_15922.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_15922.getPtr ()) != NULL) {
        }else{
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_15557->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (420)), operand_15557->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (420)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_15557->mKey, operand_15557->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (421)) ;
        }
      }
    }
  }
  enumerator_15557.reset () ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
