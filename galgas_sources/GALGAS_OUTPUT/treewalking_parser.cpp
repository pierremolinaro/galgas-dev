...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  #ifdef DEBUG_TRACE_ENABLED
    _inLexique.enterProduction ("<parse_treewalking_document>", NULL, "") ;
  #endif
  #ifdef DEBUG_TRACE_ENABLED
    { C_String message_ ;
      _inLexique.didParseTerminal ("$treewalking$", message_) ;
    }
  #endif
...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  #ifdef DEBUG_TRACE_ENABLED
    _inLexique.enterProduction ("<treewalking_routine>", NULL, "") ;
  #endif
  #ifdef DEBUG_TRACE_ENABLED
    { C_String message_ ;
  ...
  while ((operand_14988 != NULL)) {
    ...
    if (operand_14988->mInfo.mPropertyType._isBuilt ()) {
      ...
      if (operand_15056 != NULL) {
        ...
        cPtr_typeGalgas_multipleReferenceEntity * operand_15107 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_14988->mInfo.mPropertyType.getPtr ()) ;
...
pr_treewalking_routine_treewalking_parser_374_6_firstLocalPhase (galgas_scanner & _inLexique,
  ...
  #ifdef DEBUG_TRACE_ENABLED
    _inLexique.enterProduction ("<treewalking_routine>", "firstLocalPhase", "") ;
  #endif
  #ifdef DEBUG_TRACE_ENABLED
    { C_String message_ ;
      _inLexique.didParseTerminal ("$rule$", message_) ;
