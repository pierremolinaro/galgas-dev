...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203))).isBuiltAndTrue ()) {
    ...
    GGS_stringset::element_type * operand_7886 = var_cas_importedMetamodels.firstObject () ;
    while ((operand_7886 != NULL)) {
      macroValidPointer (operand_7886) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_7886->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (212)) ;
      operand_7886 = operand_7886->nextObject () ;
    }
  }else{
    ...
    while (syntaxRepeat) {
      switch (select_repeat_treewalking_parser_0 (_inLexique)) {
        case 2 : {
          ...
          GGS_M_semanticsEntitiesForUse::element_type * operand_9134 = var_cas_importedSemanticsEntitiesMap.firstObject () ;
          while ((operand_9134 != NULL)) {
            macroValidPointer (operand_9134) ;
            if (((var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_9134->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)))._operator_not ()).isBuiltAndTrue ()) {
              var_cas_semanticsEntitiesMap.modifier_insertKey (_inLexique, operand_9134->mKey, operand_9134->mInfo.aDefEntite COMMA_SOURCE_FILE_AT_LINE (248)) ;
            }
            operand_9134 = operand_9134->nextObject () ;
          }
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_10146 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_10146) ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
        switch (select_repeat_treewalking_parser_1 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    GGS_treewalkingRoutineHeaderMap::element_type * operand_10900 = var_cas_treewalkingRoutineHeaderMap.firstObject () ;
    while ((operand_10900 != NULL)) {
      macroValidPointer (operand_10900) ;
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_10900->mKey, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (298)), var_cas_entityID, operand_10900->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)), operand_10900->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_10900->mKey ;
      GGS_uint _variant_11894 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)) ;
      GGS_bool _condition_11894 (_variant_11894._isBuilt (), true) ;
      while (_condition_11894.isBuiltAndTrue ()) {
        _condition_11894 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)))._operator_isNotEqual (GGS_string (true, "")) ;
        if (_condition_11894.isBuiltAndTrue ()) {
          if (_variant_11894.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (318)) ;
            _condition_11894 = GGS_bool (true, false) ;
          }else{
            _variant_11894._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (308))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_10900->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_10900->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
            }
            var_cas_entityName = var_cas_superEntityName ;
          }
        }
      }
      operand_10900 = operand_10900->nextObject () ;
    }
    GGS_entityToImplementMap::element_type * operand_12056 = var_cas_metamodelEntityMap.firstObject () ;
    while ((operand_12056 != NULL)) {
      macroValidPointer (operand_12056) ;
      GGS_bool var_cas_hasRoutine ;
      var_cas_hasRoutine = var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, operand_12056->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)) ;
      if (((var_cas_hasRoutine)._operator_not ()).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_superEntityName ;
        var_cas_superEntityName = operand_12056->mInfo.mSuperEntityName ;
        GGS_uint _variant_12727 = var_cas_treewalkingRoutineHeaderMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
        GGS_bool _condition_12727 (_variant_12727._isBuilt (), true) ;
        while (_condition_12727.isBuiltAndTrue ()) {
          _condition_12727 = ((var_cas_hasRoutine)._operator_not ())._operator_and ((var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_isNotEqual (GGS_string (true, ""))) ;
          if (_condition_12727.isBuiltAndTrue ()) {
            if (_variant_12727.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (333)) ;
              _condition_12727 = GGS_bool (true, false) ;
            }else{
              _variant_12727._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        if ((var_cas_hasRoutine).isBuiltAndTrue ()) {
          ...
          if (var_cas_metamodelEntityMap._isBuilt ()) {
            var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_12056->mKey, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31, automatic_var_32, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (337)) ;
          }
          var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)), var_cas_entityID, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)), operand_12056->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)), var_cas_metamodelName) ;
        }
      }
      operand_12056 = operand_12056->nextObject () ;
    }
...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  GGS_entityPropertyMap::element_type * operand_14981 = var_cas_allMetamodelPropertyMap.firstObject () ;
  while ((operand_14981 != NULL)) {
    macroValidPointer (operand_14981) ;
    if (operand_14981->mInfo.mPropertyType._isBuilt ()) {
      cPtr_typeGalgas_singleReferenceEntity * operand_15049 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_14981->mInfo.mPropertyType.getPtr ()) ;
      if (operand_15049 != NULL) {
        macroValidPointer (operand_15049) ; 
      }else{
        cPtr_typeGalgas_multipleReferenceEntity * operand_15099 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_14981->mInfo.mPropertyType.getPtr ()) ;
        if (operand_15099 != NULL) {
          macroValidPointer (operand_15099) ; 
        }else{ // Else part
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_14981->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)), operand_14981->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_14981->mKey, operand_14981->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (408)) ;
        }
      }
    }
    operand_14981 = operand_14981->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
