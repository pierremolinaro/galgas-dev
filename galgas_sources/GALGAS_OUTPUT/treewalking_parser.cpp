...
pr_parse_treewalking_document_treewalking_parser_210_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_stringset _var_9993 = var_cas_includedSemanticsComponents ;
  const GGS_stringset::element_type * operand_9993 = _var_9993.firstObject () ;
  while ((operand_9993 != NULL)) {
    ...
    operand_9993 = operand_9993->nextObject () ;
  }
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271))).isBuiltAndTrue ()) {
    ...
    const GGS_stringset _var_10557 = var_cas_importedMetamodels ;
    const GGS_stringset::element_type * operand_10557 = _var_10557.firstObject () ;
    while ((operand_10557 != NULL)) {
      ...
      operand_10557 = operand_10557->nextObject () ;
    }
  }else{
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    const GGS_treewalkingRoutineHeaderMap _var_19200 = var_cas_treewalkingRoutineHeaderMap ;
    const GGS_treewalkingRoutineHeaderMap::element_type * operand_19200 = _var_19200.firstObject () ;
...
pr_treewalking_routine_treewalking_parser_539_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityPropertyMap _var_21816 = var_cas_allMetamodelPropertyMap ;
  const GGS_entityPropertyMap::element_type * operand_21816 = _var_21816.firstObject () ;
  while ((operand_21816 != NULL)) {
    ...
    operand_21816 = operand_21816->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
