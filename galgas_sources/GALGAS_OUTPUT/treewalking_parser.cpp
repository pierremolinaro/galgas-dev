...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    ...
    if (var_cas_treewalkingName._isBuilt () &&
      ...
      ::routine_generate_treewalking (_inLexique,  var_cas_treewalkingName,  var_cas_filesToImportInHeaderSet,  var_cas_treewalkingRoutineToGenerateList,  var_cas_routineDispatcherSortedList,  var_cas_rootRoutineArgumentList,  var_cas_metamodelRootEntity SOURCE_FILE_AT_LINE (348)) ;
    }
  }
  if (((! (var_cas_ioTreewalkingComponentMap.reader_hasKey (_inLexique, var_cas_treewalkingName.reader_string (_inLexique SOURCE_FILE_AT_LINE (359)) SOURCE_FILE_AT_LINE (359))))).isBuiltAndTrue ()) {
    var_cas_ioTreewalkingComponentMap.modifier_insertKey (_inLexique, var_cas_treewalkingName, var_cas_metamodelRootEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (362)), var_cas_rootRoutineSignature SOURCE_FILE_AT_LINE (360)) ;
  }
...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inMetamodelEntityMap._isBuilt ()) {
    var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_33, automatic_var_34, automatic_var_35, automatic_var_36, automatic_var_37, automatic_var_38, automatic_var_39 SOURCE_FILE_AT_LINE (386)) ;
  }
  ...
  GGS_entityPropertyMap::element_type * operand_14976 = var_cas_allMetamodelPropertyMap.firstObject () ;
  while ((operand_14976 != NULL)) {
    macroValidPointer (operand_14976) ;
    if (operand_14976->mInfo.mPropertyType._isBuilt ()) {
      cPtr_typeGalgas_singleReferenceEntity * operand_15044 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_14976->mInfo.mPropertyType.getPtr ()) ;
      if (operand_15044 != NULL) {
        macroValidPointer (operand_15044) ; 
      }else{
        cPtr_typeGalgas_multipleReferenceEntity * operand_15094 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_14976->mInfo.mPropertyType.getPtr ()) ;
        if (operand_15094 != NULL) {
          macroValidPointer (operand_15094) ; 
        }else{ // Else part
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_14976->mKey COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_14976->mKey, operand_14976->mInfo.mPropertyType, var_cas_cppName SOURCE_FILE_AT_LINE (408)) ;
        }
      }
    }
    operand_14976 = operand_14976->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
pr_treewalking_routine_treewalking_parser_374_6_firstLocalPhase (galgas_scanner & _inLexique,
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_inSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_localVariableMap, var_cas_formalArgumentList, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_ioTreewalkingRoutineHeaderMap.modifier_insertKey (_inLexique, var_cas_metamodelClassName, var_cas_listeDeTypes, var_cas_formalArgumentList SOURCE_FILE_AT_LINE (456)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
