...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    const GGS_treewalkingRoutineHeaderMap _var_10879 = var_cas_treewalkingRoutineHeaderMap ;
    GGS_treewalkingRoutineHeaderMap::element_type * operand_10879 = _var_10879.firstObject () ;
    while ((operand_10879 != NULL)) {
      macroValidPointer (operand_10879) ;
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_10879->mKey, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (298)), var_cas_entityID, operand_10879->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)), operand_10879->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_10879->mKey ;
        ...
        if (_condition_11901.isBuiltAndTrue ()) {
          if (_variant_11901.uintValue () == 0) {
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (308))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_10879->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_10879->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
            }
            var_cas_entityName = var_cas_superEntityName ;
          }
        }
      }
      operand_10879 = operand_10879->nextObject () ;
    }
    const GGS_entityToImplementMap _var_12044 = var_cas_metamodelEntityMap ;
    GGS_entityToImplementMap::element_type * operand_12044 = _var_12044.firstObject () ;
    while ((operand_12044 != NULL)) {
      macroValidPointer (operand_12044) ;
      GGS_bool var_cas_hasRoutine ;
      var_cas_hasRoutine = var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, operand_12044->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)) ;
      if (((var_cas_hasRoutine)._operator_not ()).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_superEntityName ;
        var_cas_superEntityName = operand_12044->mInfo.mSuperEntityName ;
        GGS_uint _variant_12738 = var_cas_treewalkingRoutineHeaderMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (326))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (326)) ;
        GGS_bool _condition_12738 (_variant_12738._isBuilt (), true) ;
        while (_condition_12738.isBuiltAndTrue ()) {
          _condition_12738 = ((var_cas_hasRoutine)._operator_not ())._operator_and ((var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_isNotEqual (GGS_string (true, ""))) ;
          if (_condition_12738.isBuiltAndTrue ()) {
            if (_variant_12738.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (333)) ;
              _condition_12738 = GGS_bool (true, false) ;
            }else{
              _variant_12738._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        if ((var_cas_hasRoutine).isBuiltAndTrue ()) {
          ...
          if (var_cas_metamodelEntityMap._isBuilt ()) {
            var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_12044->mKey, automatic_var_27, automatic_var_28, automatic_var_29, automatic_var_30, automatic_var_31, automatic_var_32, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (337)) ;
          }
          var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)), var_cas_entityID, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)), operand_12044->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)), var_cas_metamodelName) ;
        }
      }
      operand_12044 = operand_12044->nextObject () ;
    }
...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityPropertyMap _var_14968 = var_cas_allMetamodelPropertyMap ;
  GGS_entityPropertyMap::element_type * operand_14968 = _var_14968.firstObject () ;
  while ((operand_14968 != NULL)) {
    macroValidPointer (operand_14968) ;
    { const GGS_AC_galgasType _var_15333 = operand_14968->mInfo.mPropertyType ; // CAST instruction
      if (_var_15333.getPtr () != NULL) {
        macroValidPointer (_var_15333.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_15333.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_15333.getPtr ()) != NULL) {
        }else{
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_14968->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)), operand_14968->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_14968->mKey, operand_14968->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (408)) ;
        }
      }
    }
    operand_14968 = operand_14968->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
