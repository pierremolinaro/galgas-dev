...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_14964 != NULL)) {
    ...
    { const GGS_AC_galgasType _var_15329 = operand_14964->mInfo.mPropertyType ; // CAST instruction
      if (_var_15329.getPtr () != NULL) {
        macroValidPointer (_var_15329.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_15329.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_15329.getPtr ()) != NULL) {
        }else{
