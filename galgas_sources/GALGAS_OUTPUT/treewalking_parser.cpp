...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    const GGS_treewalkingRoutineHeaderMap _var_10885 = var_cas_treewalkingRoutineHeaderMap ;
    GGS_treewalkingRoutineHeaderMap::element_type * operand_10885 = _var_10885.firstObject () ;
    while ((operand_10885 != NULL)) {
      macroValidPointer (operand_10885) ;
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_10885->mKey, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (298)), var_cas_entityID, operand_10885->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (300)), operand_10885->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_10885->mKey ;
      GGS_uint _variant_11907 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)) ;
      GGS_bool _condition_11907 (_variant_11907._isBuilt (), true) ;
      while (_condition_11907.isBuiltAndTrue ()) {
        _condition_11907 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)))._operator_isNotEqual (GGS_string (true, "")) ;
        if (_condition_11907.isBuiltAndTrue ()) {
          if (_variant_11907.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (318)) ;
            _condition_11907 = GGS_bool (true, false) ;
          }else{
            _variant_11907._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (308))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_10885->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_10885->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
            }
            var_cas_entityName = var_cas_superEntityName ;
          }
        }
      }
      operand_10885 = operand_10885->nextObject () ;
    }
    if (var_cas_treewalkingName._isBuilt () &&
      ...
      ::routine_generate_treewalking (_inLexique,  var_cas_treewalkingName,  var_cas_filesToImportInHeaderSet,  var_cas_treewalkingRoutineToGenerateList,  var_cas_routineDispatcherSortedList,  var_cas_rootRoutineArgumentList,  var_cas_metamodelRootEntity COMMA_SOURCE_FILE_AT_LINE (320)) ;
    }
  }
...
pr_treewalking_routine_treewalking_parser_374_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inMetamodelEntityMap._isBuilt ()) {
    var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_20, automatic_var_21, automatic_var_22, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (386)) ;
  }
  ...
  const GGS_entityPropertyMap _var_15001 = var_cas_allMetamodelPropertyMap ;
  GGS_entityPropertyMap::element_type * operand_15001 = _var_15001.firstObject () ;
  while ((operand_15001 != NULL)) {
    macroValidPointer (operand_15001) ;
    { const GGS_AC_galgasType _var_15366 = operand_15001->mInfo.mPropertyType ; // CAST instruction
      if (_var_15366.getPtr () != NULL) {
        macroValidPointer (_var_15366.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_15366.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_15366.getPtr ()) != NULL) {
        }else{
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_15001->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)), operand_15001->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (407)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_15001->mKey, operand_15001->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (408)) ;
        }
      }
    }
    operand_15001 = operand_15001->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
