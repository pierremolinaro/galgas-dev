      ...
      switch (select_repeat_treewalking_parser_0 (_inLexique)) {
        case 2 : {
          ...
          while ((operand_9129 != NULL)) {
            ...
            if (((var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_9129->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)))._operator_not ()).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    ...
    while ((operand_10895 != NULL)) {
      ...
      while (_condition_11889.isBuiltAndTrue ()) {
        _condition_11889 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)))._operator_isNotEqual (GGS_string (true, "")) ;
    ...
    while ((operand_12051 != NULL)) {
      ...
      if (((var_cas_hasRoutine)._operator_not ()).isBuiltAndTrue ()) {
        ...
        while (_condition_12722.isBuiltAndTrue ()) {
          _condition_12722 = ((var_cas_hasRoutine)._operator_not ())._operator_and ((var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_isNotEqual (GGS_string (true, ""))) ;
