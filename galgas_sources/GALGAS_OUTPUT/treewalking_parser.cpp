...
pr_parse_treewalking_document_treewalking_parser_205_4_ (galgas_scanner & _inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_10090 (var_cas_includedSemanticsComponents, true) ;
    const GGS_stringset::cElement * operand_10090 = NULL ;
    while (((operand_10090 = (GGS_stringset::cElement *) enumerator_10090.nextObject ()))) {
      macroValidPointer (operand_10090) ;
      var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_10090->mKey)._operator_concat (GGS_string (true, ".h"))) ;
    }
  }
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271))).isBuiltAndTrue ()) {
    const GGS_M_metamodelsComponents  _temp_10477 = var_cas_metamodelComponentMap ;
    if (_temp_10477._isBuilt ()) {
      _temp_10477 (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_metamodelRootEntity, var_cas_metamodelEntityMap, var_cas_importedMetamodels COMMA_SOURCE_FILE_AT_LINE (272)) ;
    }
    GGS_stringset  var_cas_superMetamodels ;
    var_cas_superMetamodels = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
    {
      GGS_stringset::cEnumerator enumerator_10655 (var_cas_importedMetamodels, true) ;
      const GGS_stringset::cElement * operand_10655 = NULL ;
      while (((operand_10655 = (GGS_stringset::cElement *) enumerator_10655.nextObject ()))) {
        macroValidPointer (operand_10655) ;
        ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_10655->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (279)) ;
      }
    }
  }else{
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12699 = _inLexique.parsingContext () ;
    ...
    if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (308))).isBuiltAndTrue ()) {
      const GGS_treewalkingRoutineHeaderMap  _temp_11821 = var_cas_treewalkingRoutineHeaderMap ;
      if (_temp_11821._isBuilt ()) {
        _temp_11821 (HERE)->method_searchKey (_inLexique, var_cas_metamodelRootEntity, var_cas_rootRoutineSignature, var_cas_rootRoutineArgumentList COMMA_SOURCE_FILE_AT_LINE (309)) ;
      }
    }else{
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a routine should be defined for the '@"))._operator_concat (var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (311))))._operator_concat (GGS_string (true, "' root class")) COMMA_SOURCE_FILE_AT_LINE (312)) ;
      var_cas_rootRoutineSignature._drop_operation () ;
      var_cas_rootRoutineArgumentList._drop_operation () ;
    }
    if (((var_cas_ioTreewalkingComponentMap.reader_hasKey (_inLexique, var_cas_treewalkingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)))._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioTreewalkingComponentMap.modifier_insertKey (_inLexique, var_cas_treewalkingName, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (318)), var_cas_rootRoutineSignature COMMA_SOURCE_FILE_AT_LINE (316)) ;
    }
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12699) ;
    { bool syntaxRepeat_0 = true ;
      while (syntaxRepeat_0) {
        switch (select_repeat_treewalking_parser_0 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    {
      GGS_treewalkingRoutineHeaderMap::cEnumerator enumerator_12931 (var_cas_treewalkingRoutineHeaderMap, true) ;
      const GGS_treewalkingRoutineHeaderMap::cElement * operand_12931 = NULL ;
      while (((operand_12931 = (GGS_treewalkingRoutineHeaderMap::cElement *) enumerator_12931.nextObject ()))) {
        macroValidPointer (operand_12931) ;
        ...
        const GGS_entityToImplementMap  _temp_13092 = var_cas_metamodelEntityMap ;
        if (_temp_13092._isBuilt ()) {
          _temp_13092 (HERE)->method_searchKey (_inLexique, operand_12931->mKey, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (344)) ;
        }
        var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (346)), var_cas_entityID, operand_12931->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)), operand_12931->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (349)), var_cas_metamodelName) ;
        GGS_lstring  var_cas_entityName ;
        var_cas_entityName = operand_12931->mKey ;
        GGS_uint _variant_13954 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (353)) ;
        GGS_bool _condition_13954 (_variant_13954._isBuilt (), true) ;
        while (_condition_13954.isBuiltAndTrue ()) {
          _condition_13954 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (353)))._operator_isNotEqual (GGS_string (true, "")) ;
          if (_condition_13954.isBuiltAndTrue ()) {
            if (_variant_13954.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (365)) ;
              _condition_13954 = GGS_bool (true, false) ;
            }else{
              _variant_13954._decrement_operation (_inLexique COMMA_HERE) ;
              ...
              const GGS_entityToImplementMap  _temp_13474 = var_cas_metamodelEntityMap ;
              if (_temp_13474._isBuilt ()) {
                _temp_13474 (HERE)->method_searchKey (_inLexique, var_cas_entityName, automatic_var_6, automatic_var_7, automatic_var_8, var_cas_superEntityName, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (355)) ;
              }
              if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356))).isBuiltAndTrue ()) {
                GGS_L_EXsignature  var_cas_superRoutineSignature ;
                GGS_typeListeTypesEtNomsArgMethode  automatic_var_13 ;
                const GGS_treewalkingRoutineHeaderMap  _temp_13691 = var_cas_treewalkingRoutineHeaderMap ;
                if (_temp_13691._isBuilt ()) {
                  _temp_13691 (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superRoutineSignature, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (358)) ;
                }
                ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_12931->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_12931->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
              }
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_387_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityToImplementMap  _temp_14996 = var_cas_inMetamodelEntityMap ;
  if (_temp_14996._isBuilt ()) {
    _temp_14996 (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_14, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (400)) ;
  }
  GGS_typeTableEnAvant  var_cas_tableEnAvant ;
  var_cas_tableEnAvant = GGS_typeTableEnAvant::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  {
    GGS_entityPropertyMap::cEnumerator enumerator_15587 (var_cas_allMetamodelPropertyMap, true) ;
    const GGS_entityPropertyMap::cElement * operand_15587 = NULL ;
    while (((operand_15587 = (GGS_entityPropertyMap::cElement *) enumerator_15587.nextObject ()))) {
      macroValidPointer (operand_15587) ;
      { const GGS_AC_galgasType _var_15953 = operand_15587->mInfo.mPropertyType ; // CAST instruction
        if (_var_15953.getPtr () != NULL) {
          macroValidPointer (_var_15953.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_15953.getPtr ()) != NULL) {
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_15953.getPtr ()) != NULL) {
          }else{
            GGS_typeCplusPlusName  var_cas_cppName ;
            var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_15587->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (421)), operand_15587->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (421)) COMMA_HERE) ;
            var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_15587->mKey, operand_15587->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (422)) ;
          }
        }
      }
    }
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_387_4_firstLocalPhase (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inSemanticsEntitiesMap,
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_inSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_localVariableMap, var_cas_formalArgumentList, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_ioTreewalkingRoutineHeaderMap.modifier_insertKey (_inLexique, var_cas_metamodelClassName, var_cas_listeDeTypes, var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (471)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
void treewalking_parser::
pr_treewalking_routine_treewalking_parser_387_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
