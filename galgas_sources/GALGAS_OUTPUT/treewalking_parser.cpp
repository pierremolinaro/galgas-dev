...
pr_parse_treewalking_document_treewalking_parser_170_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203))).isBuiltAndTrue ()) {
    ...
    var_cas_fileName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this file does not define the '")) + (var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220))))) + (GGS_string (true, "' metamodel"))) COMMA_SOURCE_FILE_AT_LINE (222)) ;
      ...
      switch (select_repeat_treewalking_parser_0 (_inLexique)) {
        case 2 : {
          ...
          while ((operand_9129 != NULL)) {
            ...
            if (((! (var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_9129->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247))))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283))).isBuiltAndTrue ()) {
    ...
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a routine should be defined for the '@")) + (var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))))) + (GGS_string (true, "' root class"))) COMMA_SOURCE_FILE_AT_LINE (288)) ;
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    ...
    while ((operand_10895 != NULL)) {
      ...
      while (_condition_11889.isBuiltAndTrue ()) {
        _condition_11889 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))) != (GGS_string (true, "")) ;
    ...
    while ((operand_12051 != NULL)) {
      ...
      if (((! (var_cas_hasRoutine))).isBuiltAndTrue ()) {
        ...
        while (_condition_12722.isBuiltAndTrue ()) {
          _condition_12722 = (((! (var_cas_hasRoutine))) & ((var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (326))) != (GGS_string (true, "")))) ;
  ...
  if (((! (var_cas_ioTreewalkingComponentMap.reader_hasKey (_inLexique, var_cas_treewalkingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359))))).isBuiltAndTrue ()) {
