...
pr_parse_treewalking_document_treewalking_parser_179_6_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212))).isBuiltAndTrue ()) {
    ...
    const GGS_stringset _var_8174 = var_cas_importedMetamodels ;
    const GGS_stringset::element_type * operand_8174 = _var_8174.firstObject () ;
    while ((operand_8174 != NULL)) {
      macroValidPointer (operand_8174) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_8174->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (221)) ;
      operand_8174 = operand_8174->nextObject () ;
    }
  }else{
    ...
    while (syntaxRepeat) {
      switch (select_repeat_treewalking_parser_0 (_inLexique)) {
        case 2 : {
          ...
          const GGS_M_semanticsEntitiesForUse _var_9412 = var_cas_importedSemanticsEntitiesMap ;
          const GGS_M_semanticsEntitiesForUse::element_type * operand_9412 = _var_9412.firstObject () ;
          while ((operand_9412 != NULL)) {
            macroValidPointer (operand_9412) ;
            if (((var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_9412->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)))._operator_not ()).isBuiltAndTrue ()) {
              var_cas_semanticsEntitiesMap.modifier_insertKey (_inLexique, operand_9412->mKey, operand_9412->mInfo.aDefEntite COMMA_SOURCE_FILE_AT_LINE (257)) ;
            }
            operand_9412 = operand_9412->nextObject () ;
          }
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  const GGS_M_metamodelsComponents _var_9669 = var_cas_metamodelComponentMap ;
  const GGS_M_metamodelsComponents::element_type * operand_9669 = _var_9669.firstObject () ;
  while ((operand_9669 != NULL)) {
    macroValidPointer (operand_9669) ;
    const GGS_entityToImplementMap _var_9813 = operand_9669->mInfo.mEntityMap ;
    const GGS_entityToImplementMap::element_type * operand_9813 = _var_9813.firstObject () ;
    while ((operand_9813 != NULL)) {
      macroValidPointer (operand_9813) ;
      if (((var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_9813->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_AC_galgasType  var_cas_t ;
        var_cas_t = GGS_typeGalgas_singleReferenceEntity::constructor_new (_inLexique, operand_9813->mKey, operand_9813->mInfo.mPropertyList, operand_9813->mInfo.mAncestorClassesMap.reader_allKeys (_inLexique COMMA_SOURCE_FILE_AT_LINE (275)) COMMA_HERE) ;
        var_cas_semanticsEntitiesMap.modifier_insertKey (_inLexique, operand_9813->mKey, GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (277)) ;
      }
      operand_9813 = operand_9813->nextObject () ;
    }
    operand_9669 = operand_9669->nextObject () ;
  }
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_treewalking_parser_1 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          const GGS_M_grammarComponents _var_11325 = var_cas_grammarComponentsMap ;
          const GGS_M_grammarComponents::element_type * operand_11325 = _var_11325.firstObject () ;
          while ((operand_11325 != NULL)) {
            macroValidPointer (operand_11325) ;
            var_cas_filesToImportInHeaderSet._addAssign_operation (operand_11325->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))) ;
            if (((var_cas_semanticsEntitiesMap.reader_hasKey (_inLexique, operand_11325->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)))._operator_not ()).isBuiltAndTrue ()) {
              ...
              const GGS_M_nonterminalSymbolAltsForGrammar _var_11798 = operand_11325->mInfo.mNonterminalSymbolParametersMap ;
              const GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_11798 = _var_11798.firstObject () ;
              while ((operand_11798 != NULL)) {
                macroValidPointer (operand_11798) ;
                ...
                const GGS_L_signature _var_11976 = operand_11798->mInfo.mFormalParametersList ;
                const GGS_L_signature::element_type * operand_11976 = _var_11976.firstObject () ;
                while ((operand_11976 != NULL)) {
                  macroValidPointer (operand_11976) ;
                  GGS_AC_semanticsEntity  var_cas_e ;
                  if (var_cas_semanticsEntitiesMap._isBuilt ()) {
                    var_cas_semanticsEntitiesMap (HERE)->method_searchKey (_inLexique, operand_11976->mGalgasTypeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (312)) ;
                  }
                  GGS_AC_galgasType  var_cas_type ;
                  var_cas_type = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_e.getPtr (), true, operand_11976->mGalgasTypeName COMMA_SOURCE_FILE_AT_LINE (313)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (313)) ;
                  var_cas_formalParametersList._addAssign_operation (var_cas_type, operand_11976->mFormalArgumentPassingMode) ;
                  operand_11976 = operand_11976->nextObject () ;
                }
                var_cas_grammarAltMap.modifier_insertKey (_inLexique, operand_11798->mKey, var_cas_formalParametersList, operand_11798->mInfo.mReturnedEntityTypeName COMMA_SOURCE_FILE_AT_LINE (316)) ;
                operand_11798 = operand_11798->nextObject () ;
              }
              GGS_AC_semanticsEntity  var_cas_e ;
              var_cas_e = GGS_C_grammarForSemantics::constructor_new (_inLexique, var_cas_grammarAltMap, operand_11325->mInfo.mLexiqueName COMMA_HERE) ;
              var_cas_semanticsEntitiesMap.modifier_insertKey (_inLexique, operand_11325->mKey, var_cas_e COMMA_SOURCE_FILE_AT_LINE (319)) ;
            }
            operand_11325 = operand_11325->nextObject () ;
          }
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_14239 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_14239) ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
        switch (select_repeat_treewalking_parser_2 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    const GGS_treewalkingRoutineHeaderMap _var_14471 = var_cas_treewalkingRoutineHeaderMap ;
    const GGS_treewalkingRoutineHeaderMap::element_type * operand_14471 = _var_14471.firstObject () ;
    while ((operand_14471 != NULL)) {
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_14471->mKey, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (377)), var_cas_entityID, operand_14471->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (379)), operand_14471->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (380)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_14471->mKey ;
      GGS_uint _variant_15493 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (384)) ;
      GGS_bool _condition_15493 (_variant_15493._isBuilt (), true) ;
      while (_condition_15493.isBuiltAndTrue ()) {
        _condition_15493 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (384)))._operator_isNotEqual (GGS_string (true, "")) ;
        if (_condition_15493.isBuiltAndTrue ()) {
          if (_variant_15493.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (397)) ;
            _condition_15493 = GGS_bool (true, false) ;
          }else{
            _variant_15493._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (387)) COMMA_SOURCE_FILE_AT_LINE (387))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_14471->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_14471->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (393)) COMMA_SOURCE_FILE_AT_LINE (390)) ;
            }
            var_cas_entityName = var_cas_superEntityName ;
          }
        }
      }
      operand_14471 = operand_14471->nextObject () ;
    }
...
pr_treewalking_routine_treewalking_parser_417_6_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityPropertyMap _var_17048 = var_cas_allMetamodelPropertyMap ;
  const GGS_entityPropertyMap::element_type * operand_17048 = _var_17048.firstObject () ;
  while ((operand_17048 != NULL)) {
    macroValidPointer (operand_17048) ;
    { const GGS_AC_galgasType _var_17413 = operand_17048->mInfo.mPropertyType ; // CAST instruction
      if (_var_17413.getPtr () != NULL) {
        macroValidPointer (_var_17413.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_17413.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_17413.getPtr ()) != NULL) {
        }else{
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_17048->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (450)), operand_17048->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (450)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_17048->mKey, operand_17048->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (451)) ;
        }
      }
    }
    operand_17048 = operand_17048->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
