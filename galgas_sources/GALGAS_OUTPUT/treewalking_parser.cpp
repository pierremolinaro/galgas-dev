...
treewalking_parser::
pr_galgas_component_treewalking_parser_160_4_ (galgas_scanner & _inLexique,
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_160_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_160_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
                                GGS_M_filewrappers  &/* var_cas_ioFileWrappers */) {
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_160_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
                                GGS_M_filewrappers  &/* var_cas_ioFileWrappers */) {
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_160_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
...
void treewalking_parser::
treewalking_parser::
pr_galgas_component_treewalking_parser_160_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_treewalking_document_parse (_inLexique) ;
}
...
void treewalking_parser::
treewalking_parser::
pr_parse_treewalking_document_treewalking_parser_222_4_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
  ...
  var_cas_filesToImportInHeaderSet = GGS_stringset::constructor_setWithString (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)) COMMA_HERE) ;
  ...
  GGS_stringset::cEnumerator enumerator_10563 (var_cas_includedSemanticsComponents, true) ;
  const GGS_stringset::cElement * operand_10563 = NULL ;
  while (((operand_10563 = (GGS_stringset::cElement *) enumerator_10563.nextObject ()))) {
    macroValidPointer (operand_10563) ;
    var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_10563->mKey)._operator_concat (GGS_string (true, ".h"))) ;
  }
  enumerator_10563.reset () ;
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)) COMMA_SOURCE_FILE_AT_LINE (285))).isBuiltAndTrue ()) {
    if (var_cas_metamodelComponentMap._isBuilt ()) {
      var_cas_metamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_metamodelRootEntity, var_cas_metamodelEntityMap, var_cas_importedMetamodels COMMA_SOURCE_FILE_AT_LINE (286)) ;
    }
    GGS_stringset  var_cas_superMetamodels ;
    var_cas_superMetamodels = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
    GGS_stringset::cEnumerator enumerator_11127 (var_cas_importedMetamodels, true) ;
    const GGS_stringset::cElement * operand_11127 = NULL ;
    while (((operand_11127 = (GGS_stringset::cElement *) enumerator_11127.nextObject ()))) {
      macroValidPointer (operand_11127) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_11127->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (293)) ;
    }
    enumerator_11127.reset () ;
  }else{
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "imported files do not define the '"))._operator_concat (var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (302))))._operator_concat (GGS_string (true, "' metamodel")) COMMA_SOURCE_FILE_AT_LINE (303)) ;
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_13145 = _inLexique.parsingContext () ;
    ...
    if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)) COMMA_SOURCE_FILE_AT_LINE (322))).isBuiltAndTrue ()) {
      if (var_cas_treewalkingRoutineHeaderMap._isBuilt ()) {
        var_cas_treewalkingRoutineHeaderMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelRootEntity, var_cas_rootRoutineSignature, var_cas_rootRoutineArgumentList COMMA_SOURCE_FILE_AT_LINE (323)) ;
      }
    }else{
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a routine should be defined for the '@"))._operator_concat (var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (325))))._operator_concat (GGS_string (true, "' root class")) COMMA_SOURCE_FILE_AT_LINE (326)) ;
      var_cas_rootRoutineSignature._drop_operation () ;
      var_cas_rootRoutineArgumentList._drop_operation () ;
    }
    if (((var_cas_ioTreewalkingComponentMap.reader_hasKey (_inLexique, var_cas_treewalkingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (329)) COMMA_SOURCE_FILE_AT_LINE (329)))._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioTreewalkingComponentMap.modifier_insertKey (_inLexique, var_cas_treewalkingName, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (332)), var_cas_rootRoutineSignature COMMA_SOURCE_FILE_AT_LINE (330)) ;
    }
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_13145) ;
    { bool syntaxRepeat_0 = true ;
      while (syntaxRepeat_0) {
        switch (select_repeat_treewalking_parser_0 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    GGS_treewalkingRoutineHeaderMap::cEnumerator enumerator_13377 (var_cas_treewalkingRoutineHeaderMap, true) ;
    const GGS_treewalkingRoutineHeaderMap::cElement * operand_13377 = NULL ;
    while (((operand_13377 = (GGS_treewalkingRoutineHeaderMap::cElement *) enumerator_13377.nextObject ()))) {
      macroValidPointer (operand_13377) ;
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_13377->mKey, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (357)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)), var_cas_entityID, operand_13377->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (361)), operand_13377->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (362)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_13377->mKey ;
      GGS_uint _variant_14399 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (366)) ;
      GGS_bool _condition_14399 (_variant_14399._isBuilt (), true) ;
      while (_condition_14399.isBuiltAndTrue ()) {
        _condition_14399 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (366)))._operator_isNotEqual (GGS_string (true, "")) ;
        if (_condition_14399.isBuiltAndTrue ()) {
          if (_variant_14399.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (378)) ;
            _condition_14399 = GGS_bool (true, false) ;
          }else{
            _variant_14399._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if (var_cas_metamodelEntityMap._isBuilt ()) {
              var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_entityName, automatic_var_6, automatic_var_7, automatic_var_8, var_cas_superEntityName, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (368)) ;
            }
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369))).isBuiltAndTrue ()) {
              GGS_L_EXsignature  var_cas_superRoutineSignature ;
              GGS_typeListeTypesEtNomsArgMethode  automatic_var_13 ;
              if (var_cas_treewalkingRoutineHeaderMap._isBuilt ()) {
                var_cas_treewalkingRoutineHeaderMap (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superRoutineSignature, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (371)) ;
              }
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_13377->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_13377->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
            }
...
void treewalking_parser::
pr_parse_treewalking_document_treewalking_parser_222_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_treewalking) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_400_4_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_inMetamodelEntityMap._isBuilt ()) {
    var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_14, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (412)) ;
  }
  GGS_typeTableEnAvant  var_cas_tableEnAvant ;
  var_cas_tableEnAvant = GGS_typeTableEnAvant::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  GGS_entityPropertyMap::cEnumerator enumerator_15993 (var_cas_allMetamodelPropertyMap, true) ;
  const GGS_entityPropertyMap::cElement * operand_15993 = NULL ;
  while (((operand_15993 = (GGS_entityPropertyMap::cElement *) enumerator_15993.nextObject ()))) {
    macroValidPointer (operand_15993) ;
    { const GGS_AC_galgasType _var_16358 = operand_15993->mInfo.mPropertyType ; // CAST instruction
      if (_var_16358.getPtr () != NULL) {
        macroValidPointer (_var_16358.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_16358.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_16358.getPtr ()) != NULL) {
        }else{
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_15993->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)), operand_15993->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_15993->mKey, operand_15993->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (434)) ;
        }
      }
    }
  }
  enumerator_15993.reset () ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_400_4_firstLocalPhase (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inSemanticsEntitiesMap,
  ...
  GGS_L_signature  var_cas_signatureForGrammarComponent ;
  nt_formal_arguments_list_ (_inLexique, var_cas_inSemanticsEntitiesMap, var_cas_listeDeTypes, var_cas_localVariableMap, var_cas_formalArgumentList, var_cas_tableEnAvant, var_cas_signatureForGrammarComponent) ;
  var_cas_ioTreewalkingRoutineHeaderMap.modifier_insertKey (_inLexique, var_cas_metamodelClassName, var_cas_listeDeTypes, var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (482)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
void treewalking_parser::
pr_treewalking_routine_treewalking_parser_400_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
