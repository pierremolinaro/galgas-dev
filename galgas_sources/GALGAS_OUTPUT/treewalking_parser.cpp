...
pr_parse_treewalking_document_treewalking_parser_208_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_semanticContext = GGS_EXsemanticContext::constructor_new (_inLexique, GGS_M_filewrappers ::constructor_emptyMap (_inLexique COMMA_HERE), GGS_stringset ::constructor_emptySet (_inLexique COMMA_HERE) COMMA_HERE) ;
  ...
  {
    GGS_stringset::cEnumerator enumerator_10276 (var_cas_includedSemanticsComponents, true) ;
    const GGS_stringset::cElement * operand_10276 = NULL ;
    while (((operand_10276 = (GGS_stringset::cElement *) enumerator_10276.nextObject ()))) {
      macroValidPointer (operand_10276) ;
      var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_10276->mKey)._operator_concat (GGS_string (true, ".h"))) ;
    }
  }
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274))).isBuiltAndTrue ()) {
    const GGS_M_metamodelsComponents  _temp_10663 = var_cas_metamodelComponentMap ;
    if (_temp_10663._isBuilt ()) {
      _temp_10663 (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_metamodelRootEntity, var_cas_metamodelEntityMap, var_cas_importedMetamodels COMMA_SOURCE_FILE_AT_LINE (275)) ;
    }
    GGS_stringset  var_cas_superMetamodels ;
    var_cas_superMetamodels = GGS_stringset ::constructor_emptySet (_inLexique COMMA_HERE) ;
    {
      GGS_stringset::cEnumerator enumerator_10841 (var_cas_importedMetamodels, true) ;
      const GGS_stringset::cElement * operand_10841 = NULL ;
      while (((operand_10841 = (GGS_stringset::cElement *) enumerator_10841.nextObject ()))) {
        macroValidPointer (operand_10841) ;
        ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring ::constructor_new (_inLexique, operand_10841->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (282)) ;
      }
    }
  }else{
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12885 = _inLexique.parsingContext () ;
    ...
    if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_metamodelRootEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (311)) COMMA_SOURCE_FILE_AT_LINE (311))).isBuiltAndTrue ()) {
      const GGS_treewalkingRoutineHeaderMap  _temp_12007 = var_cas_treewalkingRoutineHeaderMap ;
      if (_temp_12007._isBuilt ()) {
        _temp_12007 (HERE)->method_searchKey (_inLexique, var_cas_metamodelRootEntity, var_cas_rootRoutineSignature, var_cas_rootRoutineArgumentList COMMA_SOURCE_FILE_AT_LINE (312)) ;
      }
    }else{
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12885) ;
    { bool syntaxRepeat_0 = true ;
      while (syntaxRepeat_0) {
        switch (select_repeat_treewalking_parser_0 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    {
      GGS_treewalkingRoutineHeaderMap::cEnumerator enumerator_13117 (var_cas_treewalkingRoutineHeaderMap, true) ;
      const GGS_treewalkingRoutineHeaderMap::cElement * operand_13117 = NULL ;
      while (((operand_13117 = (GGS_treewalkingRoutineHeaderMap::cElement *) enumerator_13117.nextObject ()))) {
        ...
        const GGS_entityToImplementMap  _temp_13278 = var_cas_metamodelEntityMap ;
        if (_temp_13278._isBuilt ()) {
          _temp_13278 (HERE)->method_searchKey (_inLexique, operand_13117->mKey, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (347)) ;
        }
        var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (349)), var_cas_entityID, operand_13117->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (351)), operand_13117->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (352)), var_cas_metamodelName) ;
        GGS_lstring  var_cas_entityName ;
        var_cas_entityName = operand_13117->mKey ;
        GGS_uint _variant_14140 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)) ;
        GGS_bool _condition_14140 (_variant_14140._isBuilt (), true) ;
        while (_condition_14140.isBuiltAndTrue ()) {
          _condition_14140 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)))._operator_isNotEqual (GGS_string (true, "")) ;
          if (_condition_14140.isBuiltAndTrue ()) {
            if (_variant_14140.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (368)) ;
              _condition_14140 = GGS_bool (true, false) ;
            }else{
              _variant_14140._decrement_operation (_inLexique COMMA_HERE) ;
              ...
              const GGS_entityToImplementMap  _temp_13660 = var_cas_metamodelEntityMap ;
              if (_temp_13660._isBuilt ()) {
                _temp_13660 (HERE)->method_searchKey (_inLexique, var_cas_entityName, automatic_var_6, automatic_var_7, automatic_var_8, var_cas_superEntityName, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (358)) ;
              }
              if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359))).isBuiltAndTrue ()) {
                ...
                const GGS_treewalkingRoutineHeaderMap  _temp_13877 = var_cas_treewalkingRoutineHeaderMap ;
                if (_temp_13877._isBuilt ()) {
                  _temp_13877 (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superRoutineSignature, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (361)) ;
                }
                ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_13117->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_13117->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (365)) COMMA_SOURCE_FILE_AT_LINE (361)) ;
              }
...
pr_treewalking_routine_treewalking_parser_390_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_entityToImplementMap  _temp_15184 = var_cas_inMetamodelEntityMap ;
  if (_temp_15184._isBuilt ()) {
    _temp_15184 (HERE)->method_searchKey (_inLexique, var_cas_metamodelClassName, var_cas_allMetamodelPropertyMap, automatic_var_14, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (403)) ;
  }
  GGS_typeTableEnAvant  var_cas_tableEnAvant ;
  var_cas_tableEnAvant = GGS_typeTableEnAvant ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  {
    GGS_entityPropertyMap::cEnumerator enumerator_15775 (var_cas_allMetamodelPropertyMap, true) ;
    const GGS_entityPropertyMap::cElement * operand_15775 = NULL ;
    while (((operand_15775 = (GGS_entityPropertyMap::cElement *) enumerator_15775.nextObject ()))) {
      macroValidPointer (operand_15775) ;
      { const GGS_AC_galgasType _var_16141 = operand_15775->mInfo.mPropertyType ; // CAST instruction
        if (_var_16141.getPtr () != NULL) {
          macroValidPointer (_var_16141.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_16141.getPtr ()) != NULL) {
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_16141.getPtr ()) != NULL) {
          }else{
            GGS_typeCplusPlusName  var_cas_cppName ;
            var_cas_cppName = GGS_typeCurrentObjectName ::constructor_new (_inLexique, operand_15775->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (424)), operand_15775->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (424)) COMMA_HERE) ;
            var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_15775->mKey, operand_15775->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (425)) ;
          }
        }
      }
    }
