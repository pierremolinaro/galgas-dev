...
void treewalking_parser::
treewalking_parser::
pr_parse_treewalking_document_treewalking_parser_210_4_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
  ...
  GGS_stringset::cEnumerator enumerator_9993 (var_cas_includedSemanticsComponents, true) ;
  const GGS_stringset::cElement * operand_9993 = NULL ;
  while (((operand_9993 = (GGS_stringset::cElement *) enumerator_9993.nextObject ()))) {
    macroValidPointer (operand_9993) ;
    var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_9993->mKey)._operator_concat (GGS_string (true, ".h"))) ;
  }
  enumerator_9993.reset () ;
  ...
  if ((var_cas_metamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271))).isBuiltAndTrue ()) {
    ...
    GGS_stringset::cEnumerator enumerator_10557 (var_cas_importedMetamodels, true) ;
    const GGS_stringset::cElement * operand_10557 = NULL ;
    while (((operand_10557 = (GGS_stringset::cElement *) enumerator_10557.nextObject ()))) {
      macroValidPointer (operand_10557) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_metamodelComponentMap,  GGS_lstring::constructor_new (_inLexique, operand_10557->mKey, GGS_location (_inLexique) COMMA_HERE),  var_cas_superMetamodels,  var_cas_metamodelEntityMap COMMA_SOURCE_FILE_AT_LINE (279)) ;
    }
    enumerator_10557.reset () ;
  }else{
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_18968 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_18968) ;
    { bool syntaxRepeat_0 = true ;
      while (syntaxRepeat_0) {
        switch (select_repeat_treewalking_parser_0 (_inLexique)) {
          case 2 : {
  ...
  if ((var_cas_inGenerateTreewalkingCode).isBuiltAndTrue ()) {
    GGS_treewalkingRoutineHeaderMap::cEnumerator enumerator_19200 (var_cas_treewalkingRoutineHeaderMap, true) ;
    const GGS_treewalkingRoutineHeaderMap::cElement * operand_19200 = NULL ;
    while (((operand_19200 = (GGS_treewalkingRoutineHeaderMap::cElement *) enumerator_19200.nextObject ()))) {
      ...
      if (var_cas_metamodelEntityMap._isBuilt ()) {
        var_cas_metamodelEntityMap (HERE)->method_searchKey (_inLexique, operand_19200->mKey, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, var_cas_metamodelName, var_cas_entityID COMMA_SOURCE_FILE_AT_LINE (496)) ;
      }
      var_cas_routineDispatcherSortedList._addAssign_operation (var_cas_entityID.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (498)), var_cas_entityID, operand_19200->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_19200->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)), var_cas_metamodelName) ;
      GGS_lstring  var_cas_entityName ;
      var_cas_entityName = operand_19200->mKey ;
      GGS_uint _variant_20222 = var_cas_metamodelEntityMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (505)) ;
      GGS_bool _condition_20222 (_variant_20222._isBuilt (), true) ;
      while (_condition_20222.isBuiltAndTrue ()) {
        _condition_20222 = (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (505)))._operator_isNotEqual (GGS_string (true, "")) ;
        if (_condition_20222.isBuiltAndTrue ()) {
          if (_variant_20222.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (517)) ;
            _condition_20222 = GGS_bool (true, false) ;
          }else{
            _variant_20222._decrement_operation (_inLexique COMMA_HERE) ;
            ...
            if ((var_cas_treewalkingRoutineHeaderMap.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)) COMMA_SOURCE_FILE_AT_LINE (508))).isBuiltAndTrue ()) {
              ...
              ::routine_verifierCompatibiliteSignatures (_inLexique,  operand_19200->mInfo.mRoutineSignature,  var_cas_superRoutineSignature,  operand_19200->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (514)) COMMA_SOURCE_FILE_AT_LINE (510)) ;
            }
...
void treewalking_parser::
pr_parse_treewalking_document_treewalking_parser_210_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_treewalking) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_539_4_ (galgas_scanner & _inLexique,
  ...
  GGS_entityPropertyMap::cEnumerator enumerator_21816 (var_cas_allMetamodelPropertyMap, true) ;
  const GGS_entityPropertyMap::cElement * operand_21816 = NULL ;
  while (((operand_21816 = (GGS_entityPropertyMap::cElement *) enumerator_21816.nextObject ()))) {
    macroValidPointer (operand_21816) ;
    { const GGS_AC_galgasType _var_22181 = operand_21816->mInfo.mPropertyType ; // CAST instruction
      if (_var_22181.getPtr () != NULL) {
        macroValidPointer (_var_22181.getPtr ()) ;
        if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_22181.getPtr ()) != NULL) {
        }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_22181.getPtr ()) != NULL) {
        }else{
          GGS_typeCplusPlusName  var_cas_cppName ;
          var_cas_cppName = GGS_typeCurrentObjectName::constructor_new (_inLexique, operand_21816->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_21816->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (572)) COMMA_HERE) ;
          var_cas_localVariableMap.modifier_insertUsedConstInArgument (_inLexique, operand_21816->mKey, operand_21816->mInfo.mPropertyType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (573)) ;
        }
      }
    }
  }
  enumerator_21816.reset () ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
...
void treewalking_parser::
treewalking_parser::
pr_treewalking_routine_treewalking_parser_539_4_firstLocalPhase (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inSemanticsEntitiesMap,
...
void treewalking_parser::
pr_treewalking_routine_treewalking_parser_539_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_rule) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
