...
//--------------------------------- Native constructor
  public : GALGAS_semanticDeclarationSortedListForGeneration_2E_element (const GALGAS_string & in_mMessage,
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_semanticDeclarationSortedListForGeneration_2E_element constructor_new (const class GALGAS_string & inOperand0,
                                                                                                const class GALGAS_semanticDeclarationForGeneration & inOperand1,
                                                                                                const class GALGAS_string & inOperand2
                                                                                                COMMA_LOCATION_ARGS) ;
