...
//--------------------------------- GALGAS constructors
  ...
  public : static GALGAS_semanticDeclarationSortedListForGeneration constructor_sortedListWithValue (const class GALGAS_semanticDeclarationForGeneration & inOperand0,
                                                                                                     const class GALGAS_string & inOperand1
                                                                                                     COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Modifiers
  public : VIRTUAL_IN_DEBUG void modifier_popGreatest (class GALGAS_semanticDeclarationForGeneration & outArgument0,
                                                       class GALGAS_string & outArgument1,
                                                       C_Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) ;

  public : VIRTUAL_IN_DEBUG void modifier_popSmallest (class GALGAS_semanticDeclarationForGeneration & outArgument0,
                                                       class GALGAS_string & outArgument1,
                                                       C_Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  public : VIRTUAL_IN_DEBUG void method_greatest (class GALGAS_semanticDeclarationForGeneration & outArgument0,
                                                  class GALGAS_string & outArgument1,
                                                  C_Compiler * inCompiler
                                                  COMMA_LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG void method_smallest (class GALGAS_semanticDeclarationForGeneration & outArgument0,
                                                  class GALGAS_string & outArgument1,
                                                  C_Compiler * inCompiler
                                                  COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_mapTypeForGeneration constructor_new (const class GALGAS_unifiedTypeMapProxy & inOperand0,
                                                               ...
                                                               const class GALGAS_withAccessorMap & inOperand8
                                                               COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_withAccessorMap reader_mWithAccessorMap (LOCATION_ARGS) const ;
...
//--------------------------------- Readers
  public : VIRTUAL_IN_DEBUG class GALGAS_string reader_mAccessName (LOCATION_ARGS) const ;
...
//-----------------------------------------------------------------------------*
//                                                                             *
//Abstract category method '@semanticDeclarationForGeneration addHeaderInclusions'*
//                                                                             *
//-----------------------------------------------------------------------------*

typedef void (*categoryMethodSignature_semanticDeclarationForGeneration_addHeaderInclusions) (const class cPtr_semanticDeclarationForGeneration * inObject,
...
void enterCategoryMethod_addHeaderInclusions (const int32_t inClassIndex,
                                              categoryMethodSignature_semanticDeclarationForGeneration_addHeaderInclusions inMethod) ;

//-----------------------------------------------------------------------------*

void callCategoryMethod_addHeaderInclusions (const class cPtr_semanticDeclarationForGeneration * inObject,
                                             GALGAS_string & io_ioHeaderString,
                                             C_Compiler * inCompiler
                                             COMMA_LOCATION_ARGS) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_semanticDeclarationSortedListForGeneration_2E_element constructor_new (const class GALGAS_semanticDeclarationForGeneration & inOperand0,
                                                                                                const class GALGAS_string & inOperand1
                                                                                                COMMA_LOCATION_ARGS) ;
