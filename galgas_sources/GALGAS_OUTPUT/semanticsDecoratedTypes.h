...
class GALGAS_selfReaderCallExpressionForGeneration ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//               @selfReaderCallExpressionForGeneration class                *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_selfReaderCallExpressionForGeneration ;

//---------------------------------------------------------------------------*

class GALGAS_selfReaderCallExpressionForGeneration : public GALGAS_semanticExpressionForGeneration {
//--- Constructor
  public : GALGAS_selfReaderCallExpressionForGeneration (void) ;

//---
  public : inline const cPtr_selfReaderCallExpressionForGeneration * ptr (void) const { return (const cPtr_selfReaderCallExpressionForGeneration *) mObjectPtr ; }
  public : inline cPtr_selfReaderCallExpressionForGeneration * ptr (void) { return (cPtr_selfReaderCallExpressionForGeneration *) mObjectPtr ; }

//--------------------------------- Constructor from pointer
  public : GALGAS_selfReaderCallExpressionForGeneration (const cPtr_selfReaderCallExpressionForGeneration * inSourcePtr) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_selfReaderCallExpressionForGeneration extractObject (const GALGAS_object & inObject,
                                                                              C_Compiler * inCompiler,
                                                                              const GALGAS_location & inErrorLocation
                                                                              COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_selfReaderCallExpressionForGeneration constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                const GALGAS_location & inOperand1,
                                                                                const GALGAS_string & inOperand2,
...
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_selfReaderCallExpressionForGeneration & inOperand) const ;
...
} ; // End of GALGAS_selfReaderCallExpressionForGeneration class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_selfReaderCallExpressionForGeneration ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_selfMethodCallInstructionForGeneration constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                 const GALGAS_string & inOperand1,
                                                                                 const GALGAS_location & inOperand2,
                                                                                 const GALGAS_string & inOperand3,
                                                                                 const GALGAS_methodKind & inOperand4,
...
//---------------------------------------------------------------------------*
//                                                                           *
//      Pointer class for @selfReaderCallExpressionForGeneration class       *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_selfReaderCallExpressionForGeneration : public cPtr_semanticExpressionForGeneration {
...
//--- Constructor
  public : cPtr_selfReaderCallExpressionForGeneration (const GALGAS_unifiedTypeMapProxy & in_mType,
                                                       const GALGAS_location & in_mLocation,
...
//--- Constructor
  public : cPtr_selfMethodCallInstructionForGeneration (const GALGAS_unifiedTypeMapProxy & in_mReceiverType,
                                                        const GALGAS_string & in_mCurrentObjectCppPointer,
                                                        const GALGAS_location & in_mInstructionLocation,
                                                        const GALGAS_string & in_mMethodName,
                                                        const GALGAS_methodKind & in_mKind,
