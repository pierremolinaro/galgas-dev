...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_matchListForGeneration reader_subListWithRange (const GALGAS_range & constinOperand0,
                                                                                   C_Compiler * inCompiler
                                                                                   COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  public : GALGAS_matchListForGeneration_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_matchInstructionBranchListForGeneration reader_subListWithRange (const GALGAS_range & constinOperand0,
                                                                                                    C_Compiler * inCompiler
                                                                                                    COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  public : GALGAS_matchInstructionBranchListForGeneration_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- Element constructor used by listmap
  public : static void makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                  const GALGAS_bool & in_mStrictTypeEquality,
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_bool reader_mStrictTypeEqualityAtIndex (const GALGAS_uint & constinOperand0,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  public : GALGAS_bool current_mStrictTypeEquality (LOCATION_ARGS) const ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_arrayTypeForGeneration constructor_new (const GALGAS_bool & inOperand0,
                                                                 const GALGAS_unifiedTypeMapProxy & inOperand1,
                                                                 const GALGAS_unifiedTypeMapProxy & inOperand2,
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_externTypeDeclarationForGeneration constructor_new (const GALGAS_bool & inOperand0,
                                                                             const GALGAS_unifiedTypeMapProxy & inOperand1,
                                                                             const GALGAS_string & inOperand2,
                                                                             const GALGAS_string & inOperand3,
                                                                             const GALGAS_string & inOperand4
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_nonterminalInstructionForGeneration constructor_default (LOCATION_ARGS) ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_terminalCheckInstructionForGeneration constructor_default (LOCATION_ARGS) ;
...
//--------------------------------- Native constructor
  public : GALGAS_semanticDeclarationSortedListForGeneration_2E_element (const GALGAS_semanticDeclarationForGeneration & in_mDeclaration,
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_semanticDeclarationSortedListForGeneration_2E_element constructor_new (const GALGAS_semanticDeclarationForGeneration & inOperand0,
                                                                                                const GALGAS_string & inOperand1
                                                                                                COMMA_LOCATION_ARGS) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 @matchListForGeneration_2E_element struct                 *
//                                                                           *
//---------------------------------------------------------------------------*

class GALGAS_matchListForGeneration_2E_element : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_matchListForGeneration_2E_element constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_matchListForGeneration_2E_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_matchListForGeneration_2E_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_matchListForGeneration_2E_element (const GALGAS_bool & in_mIsType,
                                                     const GALGAS_string & in_mTypeNameOrEnumerationConstantName,
                                                     const GALGAS_string & in_mLocalConstantName) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_matchListForGeneration_2E_element extractObject (const GALGAS_object & inObject,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_matchListForGeneration_2E_element constructor_new (const GALGAS_bool & inOperand0,
                                                                            const GALGAS_string & inOperand1,
                                                                            const GALGAS_string & inOperand2
                                                                            COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const PMSInt32 inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_matchListForGeneration_2E_element & inOperand) const ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_string reader_mLocalConstantName (LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG GALGAS_string reader_mTypeNameOrEnumerationConstantName (LOCATION_ARGS) const ;


//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
 
} ; // End of GALGAS_matchListForGeneration_2E_element class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_matchListForGeneration_2E_element ;

//---------------------------------------------------------------------------*
//                                                                           *
//        @matchInstructionBranchListForGeneration_2E_element struct         *
//                                                                           *
//---------------------------------------------------------------------------*

class GALGAS_matchInstructionBranchListForGeneration_2E_element : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_matchInstructionBranchListForGeneration_2E_element constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_matchInstructionBranchListForGeneration_2E_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_matchInstructionBranchListForGeneration_2E_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_matchInstructionBranchListForGeneration_2E_element (const GALGAS_matchListForGeneration & in_mMatchListForGeneration,
                                                                      const GALGAS_semanticInstructionListForGeneration & in_mMatchBranchInstructionList) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_matchInstructionBranchListForGeneration_2E_element extractObject (const GALGAS_object & inObject,
                                                                                           C_Compiler * inCompiler
                                                                                           COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_matchInstructionBranchListForGeneration_2E_element constructor_new (const GALGAS_matchListForGeneration & inOperand0,
                                                                                             const GALGAS_semanticInstructionListForGeneration & inOperand1
                                                                                             COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const PMSInt32 inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_matchInstructionBranchListForGeneration_2E_element & inOperand) const ;
...
//--------------------------------- Readers
  public : VIRTUAL_IN_DEBUG GALGAS_semanticInstructionListForGeneration reader_mMatchBranchInstructionList (LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG GALGAS_matchListForGeneration reader_mMatchListForGeneration (LOCATION_ARGS) const ;


//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
 
} ; // End of GALGAS_matchInstructionBranchListForGeneration_2E_element class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_matchInstructionBranchListForGeneration_2E_element ;
...
//--------------------------------- Public data members
  public : GALGAS_bool mAttribute_mStrictTypeEquality ;
...
//--------------------------------- Native constructor
  public : GALGAS_castInstructionBranchListForGeneration_2E_element (const GALGAS_bool & in_mStrictTypeEquality,
                                                                     const GALGAS_unifiedTypeMapProxy & in_mType,
                                                                     const GALGAS_string & in_mCastedVarCppName,
                                                                     const GALGAS_semanticInstructionListForGeneration & in_mInstructionList) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_castInstructionBranchListForGeneration_2E_element constructor_new (const GALGAS_bool & inOperand0,
                                                                                            const GALGAS_unifiedTypeMapProxy & inOperand1,
                                                                                            const GALGAS_string & inOperand2,
                                                                                            const GALGAS_semanticInstructionListForGeneration & inOperand3
                                                                                            COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_bool reader_mStrictTypeEquality (LOCATION_ARGS) const ;
...
//--- Constructor
  public : cPtr_arrayTypeForGeneration (const GALGAS_bool & in_mIsGlobal,
                                        const GALGAS_unifiedTypeMapProxy & in_mTypeProxy,
...
//--- Constructor
  public : cPtr_externTypeDeclarationForGeneration (const GALGAS_bool & in_mIsGlobal,
                                                    const GALGAS_unifiedTypeMapProxy & in_mTypeProxy,
