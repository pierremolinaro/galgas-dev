...
pr_template_instruction_galgasTemplateParser_100_27_ (galgasTemplateScanner & inLexique,
  ...
  switch (select_galgasTemplateParser_0 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      var_cas_prefix = var_cas_prefixString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (113)) ;
      } break ;
    default :
      break ;
  }
  ...
  const GGS_AC_galgasType  _temp_5103 = var_cas_expressionType ;
  if (_temp_5103.isBuilt ()) {
    _temp_5103 (HERE)->method_getTypeName (inLexique, var_cas_cppExpressionTypeName COMMA_SOURCE_FILE_AT_LINE (136)) ;
  }
  ...
  const GGS_AC_galgasType  _temp_5402 = var_cas_expressionType ;
  if (_temp_5402.isBuilt ()) {
    _temp_5402 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_inComponentSemanticsEntitiesMap, var_cas_instructionLocation, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }
  var_cas_ioTemplateVariableMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
  var_cas_ioTemplateVariableMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) ;
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_5849 (var_cas_formalEnumerationList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_5849 = NULL ;
    while (((operand_5849 = enumerator_5849.nextObject ()))) {
      macroValidPointer (operand_5849) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
        ...
        var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_5849->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
      }
      GGS_lstring  var_cas_implicitVariableName ;
      var_cas_implicitVariableName = GGS_lstring ::constructor_new (inLexique, (var_cas_prefix).operator_concat (operand_5849->mAttributeName), operand_5849->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) COMMA_HERE) ;
      var_cas_ioTemplateVariableMap.modifier_insertUsedConstInArgument (inLexique, var_cas_implicitVariableName, operand_5849->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (162)) ;
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_galgasTemplateParser_2 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (176)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (150)) ;
  var_cas_ioTemplateVariableMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_212_37_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_ioTemplateVariableMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_galgasTemplateParser_5 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (229)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_verifyVariableUsing (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (219)) ;
}
