...
void routine_enterTemplateString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2863 = (var_cas_s.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
...
pr_template_instruction_galgasTemplateParser_65_27_ (C_Lexique_galgasTemplateScanner & inLexique,
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_89_27_ (C_Lexique_galgasTemplateScanner & inLexique,
                                GGS_templateVariableMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inComponentSemanticsEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
  ...
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_columnConstantName, GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (100)) ;
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_110_27_ (C_Lexique_galgasTemplateScanner & inLexique,
                                GGS_templateVariableMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgasTemplateParser_0 (inLexique)) {
        case 2 : {
          nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_blockInstructionList) ;
          ::routine_enterTemplateString (inLexique,  var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (143)) ;
          } break ;
        default :
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_157_27_ (C_Lexique_galgasTemplateScanner & inLexique,
                                GGS_templateVariableMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  switch (select_galgasTemplateParser_2 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
      var_cas_foreachPrefix = var_cas_prefixString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
      } break ;
    default :
      break ;
  }
  GGS_string var_cas_cppExpressionTypeName ;
  const GGS_AC_galgasType  temp_6832 = var_cas_expressionType ;
  if (temp_6832.isBuilt ()) {
    temp_6832 (HERE)->method_getTypeName (inLexique, var_cas_cppExpressionTypeName COMMA_SOURCE_FILE_AT_LINE (195)) ;
  }
  ...
  const GGS_AC_galgasType  temp_7131 = var_cas_expressionType ;
  if (temp_7131.isBuilt ()) {
    temp_7131 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_inComponentSemanticsEntitiesMap, var_cas_instructionLocation, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (201)) ;
  }
  ...
  switch (select_galgasTemplateParser_3 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (213)) ;
      GGS_templateVariableMap  var_cas_templateVariableMap = var_cas_ioTemplateVariableMap ;
      { bool syntaxRepeat_4 = true ;
        while (syntaxRepeat_4) {
          switch (select_galgasTemplateParser_4 (inLexique)) {
            case 2 : {
              nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_beforeInstructionList) ;
              ::routine_enterTemplateString (inLexique,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (224)) ;
              } break ;
            default :
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_8095 (var_cas_formalEnumerationList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_8095 = NULL ;
    while (((operand_8095 = enumerator_8095.nextObject ()))) {
      macroValidPointer (operand_8095) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      const GGS_bool cond_8328 = ((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne) ;
      if (cond_8328.isBuiltAndTrue ()) {
      ...
      }else if (cond_8328.isBuiltAndFalse ()) {
        var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_8095->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (237)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
      }
      GGS_lstring  var_cas_implicitVariableName = GGS_lstring ::constructor_new (inLexique, (var_cas_foreachPrefix).operator_concat (operand_8095->mAttributeName), operand_8095->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) COMMA_HERE) ;
      var_cas_templateVariableMap.modifier_insertKey (inLexique, var_cas_implicitVariableName, operand_8095->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (240)) ;
  ...
  switch (select_galgasTemplateParser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_indexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (250)), var_cas_indexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_HERE) ;
      var_cas_templateVariableMap.modifier_insertKey (inLexique, var_cas_indexIdentifier, GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE), var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (251)) ;
      } break ;
    default :
      break ;
  }
  GGS_templateInstructionList  var_cas_doInstructionList = GGS_templateInstructionList ::constructor_emptyList () ;
  ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (254)) ;
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
      switch (select_galgasTemplateParser_6 (inLexique)) {
        case 2 : {
          nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_doInstructionList) ;
          ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (264)) ;
          } break ;
        default :
  ...
  switch (select_galgasTemplateParser_7 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (271)) ;
      GGS_templateVariableMap  var_cas_templateVariableMap = var_cas_ioTemplateVariableMap ;
      { bool syntaxRepeat_8 = true ;
        while (syntaxRepeat_8) {
          switch (select_galgasTemplateParser_8 (inLexique)) {
            case 2 : {
              nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_betweenInstructionList) ;
      ...
      { bool syntaxRepeat_10 = true ;
        while (syntaxRepeat_10) {
          switch (select_galgasTemplateParser_10 (inLexique)) {
            case 2 : {
              nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_beforeInstructionList) ;
              ::routine_enterTemplateString (inLexique,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (301)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_323_27_ (C_Lexique_galgasTemplateScanner & inLexique,
                                GGS_templateVariableMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        GGS_AC_galgasType  var_cas_expressionType ;
        nt_expression_ (inLexique, var_cas_inComponentSemanticsEntitiesMap, var_cas_inSemanticContext, var_cas_inOptionsComponentsMapForUse, var_cas_ioTemplateVariableMap, var_cas_expression, var_cas_expressionType) ;
        GGS_typeGalgas_bool  var_cas_x = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_expressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (343)) ;
        ...
        ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (346)) ;
        GGS_templateVariableMap  var_cas_templateVariableMap = var_cas_ioTemplateVariableMap ;
        { bool syntaxRepeat_12 = true ;
          while (syntaxRepeat_12) {
            switch (select_galgasTemplateParser_12 (inLexique)) {
              case 2 : {
                nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_instructionList) ;
                ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (357)) ;
                } break ;
              default :
  ...
  switch (select_galgasTemplateParser_13 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (368)) ;
      GGS_templateVariableMap  var_cas_templateVariableMap = var_cas_ioTemplateVariableMap ;
      { bool syntaxRepeat_14 = true ;
        while (syntaxRepeat_14) {
          switch (select_galgasTemplateParser_14 (inLexique)) {
            case 2 : {
              nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_elseInstructionList) ;
              ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (379)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_393_37_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (402)) ;
  { bool syntaxRepeat_15 = true ;
    while (syntaxRepeat_15) {
      switch (select_galgasTemplateParser_15 (inLexique)) {
        case 2 : {
          nt_template_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_outResultingInstructionList) ;
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (412)) ;
          } break ;
        default :
