...
pr_template_instruction_galgasTemplateParser_100_27_ (galgasTemplateScanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_foreach) COMMA_HERE) ;
  var_cas_ioResultingInstructionList._addAssign_operation (GGS_templateInstructionForeach ::constructor_new (inLexique, var_cas_ascending, var_cas_cppExpressionTypeName, var_cas_iteratorNewStyle, var_cas_expression, var_cas_instructionLocation, var_cas_doInstructionList COMMA_HERE)) ;
}
...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_185_37_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_ioTemplateVariableMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (193)) ;
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_galgasTemplateParser_2 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (202)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_verifyVariableUsing (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (192)) ;
}
