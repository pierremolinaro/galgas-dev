...
void routine_enterTemplateString (C_Compiler & _inLexique,
  ...
  if (((var_cas_s.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (42)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
...
pr_template_instruction_galgasTemplateParser_49_4_ (galgasTemplateScanner & _inLexique,
...
void galgasTemplateParser::
galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_65_4_ (galgasTemplateScanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
  ...
  ::routine_enterTemplateString (_inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (71)) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_galgasTemplateParser_0 (_inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (_inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (79)) ;
          } break ;
        default :
