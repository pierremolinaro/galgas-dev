...
pr_template_instruction_galgasTemplateParser_152_27_ (galgasTemplateScanner & inLexique,
  ...
  var_cas_ioTemplateVariableMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
  var_cas_ioTemplateVariableMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (204)) ;
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_7407 (var_cas_formalEnumerationList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_7407 = NULL ;
    while (((operand_7407 = enumerator_7407.nextObject ()))) {
      macroValidPointer (operand_7407) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
        ...
        var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_7407->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
      }
      GGS_lstring  var_cas_implicitVariableName ;
      var_cas_implicitVariableName = GGS_lstring ::constructor_new (inLexique, (var_cas_prefix).operator_concat (operand_7407->mAttributeName), operand_7407->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) COMMA_HERE) ;
      var_cas_ioTemplateVariableMap.modifier_insertUsedConstInArgument (inLexique, var_cas_implicitVariableName, operand_7407->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (216)) ;
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (221)) ;
    ...
    while (syntaxRepeat_3) {
      switch (select_repeat_galgasTemplateParser_3 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (231)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (204)) ;
  var_cas_ioTemplateVariableMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
  ...
  switch (select_galgasTemplateParser_4 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (240)) ;
        ...
        while (syntaxRepeat_5) {
          switch (select_repeat_galgasTemplateParser_5 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (250)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_268_37_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_ioTemplateVariableMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (276)) ;
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (277)) ;
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_galgasTemplateParser_6 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (287)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_verifyVariableUsing (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (276)) ;
}
