  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgasTemplateParser_0 (inLexique)) {
        case 2 : {
          nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_blockInstructionList) ;
      ...
      { bool syntaxRepeat_4 = true ;
        while (syntaxRepeat_4) {
          switch (select_galgasTemplateParser_4 (inLexique)) {
            case 2 : {
              nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_beforeInstructionList) ;
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
      switch (select_galgasTemplateParser_6 (inLexique)) {
        case 2 : {
          nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_doInstructionList) ;
      ...
      { bool syntaxRepeat_8 = true ;
        while (syntaxRepeat_8) {
          switch (select_galgasTemplateParser_8 (inLexique)) {
            case 2 : {
              nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_betweenInstructionList) ;
        ...
        { bool syntaxRepeat_12 = true ;
          while (syntaxRepeat_12) {
            switch (select_galgasTemplateParser_12 (inLexique)) {
              case 2 : {
                nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_instructionList) ;
      ...
      { bool syntaxRepeat_14 = true ;
        while (syntaxRepeat_14) {
          switch (select_galgasTemplateParser_14 (inLexique)) {
            case 2 : {
              nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_elseInstructionList) ;
...
void galgasTemplateParser::rule_galgasTemplateParser_lexique_5F_component_5F_start_5F_symbol_i5_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  { bool syntaxRepeat_15 = true ;
    while (syntaxRepeat_15) {
      switch (select_galgasTemplateParser_15 (inLexique)) {
        case 2 : {
          nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_outResultingInstructionList) ;
