...
pr_template_instruction_galgasTemplateParser_152_27_ (galgasTemplateScanner & inLexique,
  ...
  switch (select_galgasTemplateParser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_indexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (245)), var_cas_indexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) COMMA_HERE) ;
      var_cas_ioTemplateVariableMap.modifier_insertConstInArgument (inLexique, var_cas_indexIdentifier, GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE), var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (246)) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__3A_) COMMA_HERE) ;
      } break ;
    default :
      break ;
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_galgasTemplateParser_6 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (260)) ;
          } break ;
        default :
        ...
        while (syntaxRepeat_8) {
          switch (select_repeat_galgasTemplateParser_8 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (279)) ;
              } break ;
            default :
      ...
      { bool syntaxRepeat_10 = true ;
        while (syntaxRepeat_10) {
          switch (select_repeat_galgasTemplateParser_10 (inLexique)) {
            case 2 : {
              nt_template_instruction_ (inLexique, var_cas_ioTemplateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_beforeInstructionList) ;
              ::routine_enterTemplateString (inLexique,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (297)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_319_27_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        var_cas_x = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_expressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (339)) ;
        ...
        ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (342)) ;
          ...
          while (syntaxRepeat_12) {
            switch (select_repeat_galgasTemplateParser_12 (inLexique)) {
              case 2 : {
                ...
                ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (352)) ;
                } break ;
              default :
  ...
  switch (select_galgasTemplateParser_13 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (363)) ;
        ...
        while (syntaxRepeat_14) {
          switch (select_repeat_galgasTemplateParser_14 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (373)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_387_37_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_ioTemplateVariableMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (395)) ;
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (396)) ;
    ...
    while (syntaxRepeat_15) {
      switch (select_repeat_galgasTemplateParser_15 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (406)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_verifyVariableUsing (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (395)) ;
}
