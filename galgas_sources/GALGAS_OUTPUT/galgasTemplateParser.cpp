...
void routine_enterTemplateString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2813 = (var_cas_s.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (56))).operator_strictSup (GGS_uint (0U)) ;
...
pr_template_instruction_galgasTemplateParser_154_27_ (galgasTemplateScanner & inLexique,
  ...
  GGS_bool var_cas_firstOne = GGS_bool (true) ;
  {
    ...
    while (((operand_7951 = enumerator_7951.nextObject ()))) {
      ...
      const GGS_bool cond_8200 = ((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne) ;
      if (cond_8200.isBuiltAndTrue ()) {
      ...
      }else if (cond_8200.isBuiltAndFalse ()) {
