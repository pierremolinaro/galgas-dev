...
void galgasTemplateParser::rule_galgasTemplateParser_template_5F_instruction_i5_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  const GGS_AC_galgasType  temp_8162 = var_cas_expressionType ;
  if (temp_8162.isBuilt ()) {
    temp_8162 (HERE)->method_getTypeName (inLexique, var_cas_cppExpressionTypeName COMMA_SOURCE_FILE_AT_LINE (232)) ;
  }
  ...
  const GGS_AC_galgasType  temp_8461 = var_cas_expressionType ;
  if (temp_8461.isBuilt ()) {
    temp_8461 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_inComponentSemanticsEntitiesMap, var_cas_instructionLocation, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (238)) ;
  }
