...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_308_37_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_ioTemplateVariableMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (317)) ;
    ...
    while (syntaxRepeat_10) {
      switch (select_repeat_galgasTemplateParser_10 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (327)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_verifyVariableUsing (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (316)) ;
}
