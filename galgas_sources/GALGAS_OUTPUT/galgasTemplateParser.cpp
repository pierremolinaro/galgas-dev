...
void routine_enterTemplateString (C_Compiler & inLexique,
  ...
  if (cond_2921.isBuiltAndTrue ()) {
    var_cas_outResultingInstructionList.addAssign_operation (GGS_templateInstructionString ::constructor_new (inLexique, var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (61)) COMMA_HERE)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void galgasTemplateParser::rule_galgasTemplateParser_template_5F_instruction_i1_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  GGS_typeCplusPlusName  var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_columnConstantName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (103)), var_cas_columnConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_HERE) ;
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_columnConstantName, GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE), var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (104)) ;
...
void galgasTemplateParser::rule_galgasTemplateParser_template_5F_instruction_i2_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionGetColumnLocation ::constructor_new (inLexique COMMA_HERE)) ;
...
void galgasTemplateParser::rule_galgasTemplateParser_template_5F_instruction_i3_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionGotoColumnLocation ::constructor_new (inLexique COMMA_HERE)) ;
  var_cas_ioUsesColumnMarker = GGS_bool (true) ;
}
...
void galgasTemplateParser::rule_galgasTemplateParser_template_5F_instruction_i5_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  GGS_bool var_cas_firstOne = GGS_bool (true) ;
  {
    ...
    while (((operand_9454 = enumerator_9454.nextObject ()))) {
      ...
      const GGS_bool cond_9687 = ((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne) ;
  ...
  switch (select_galgasTemplateParser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
      GGS_typeCplusPlusName  var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_indexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (288)), var_cas_indexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (288)) COMMA_HERE) ;
      var_cas_templateVariableMap.modifier_insertKey (inLexique, var_cas_indexIdentifier, GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE), var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (289)) ;
      } break ;
    default :
      break ;
  }
