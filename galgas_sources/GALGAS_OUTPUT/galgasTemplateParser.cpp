...
pr_template_instruction_galgasTemplateParser_173_27_ (galgasTemplateScanner & inLexique,
  ...
  switch (select_galgasTemplateParser_2 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      var_cas_foreachPrefix = var_cas_prefixString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
      } break ;
    default :
      break ;
  }
  GGS_string var_cas_cppExpressionTypeName ;
  const GGS_AC_galgasType  temp_7577 = var_cas_expressionType ;
  if (temp_7577.isBuilt ()) {
    temp_7577 (HERE)->method_getTypeName (inLexique, var_cas_cppExpressionTypeName COMMA_SOURCE_FILE_AT_LINE (211)) ;
  }
  ...
  const GGS_AC_galgasType  temp_7876 = var_cas_expressionType ;
  if (temp_7876.isBuilt ()) {
    temp_7876 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_inComponentSemanticsEntitiesMap, var_cas_instructionLocation, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (217)) ;
  }
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_8811 (var_cas_formalEnumerationList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_8811 = NULL ;
    while (((operand_8811 = enumerator_8811.nextObject ()))) {
      macroValidPointer (operand_8811) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
        ...
        var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_8811->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
      }
      GGS_lstring  var_cas_implicitVariableName = GGS_lstring ::constructor_new (inLexique, (var_cas_foreachPrefix).operator_concat (operand_8811->mAttributeName), operand_8811->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) COMMA_HERE) ;
      var_cas_ioTemplateVariableMap.modifier_insertUsedConstInArgument (inLexique, var_cas_implicitVariableName, operand_8811->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (256)) ;
