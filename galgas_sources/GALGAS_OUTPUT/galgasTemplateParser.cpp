...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_128_27_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_x = GGS_typeGalgas_uint::castFrom (inLexique, var_cas_resultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__3A_) COMMA_HERE) ;
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (150)) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_galgasTemplateParser_0 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (160)) ;
          } break ;
        default :
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_174_27_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  switch (select_galgasTemplateParser_1 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      var_cas_prefix = var_cas_prefixString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (188)) ;
      } break ;
    default :
      break ;
  }
  ...
  const GGS_AC_galgasType  temp_7470 = var_cas_expressionType ;
  if (temp_7470.isBuilt ()) {
    temp_7470 (HERE)->method_getTypeName (inLexique, var_cas_cppExpressionTypeName COMMA_SOURCE_FILE_AT_LINE (212)) ;
  }
  ...
  const GGS_AC_galgasType  temp_7769 = var_cas_expressionType ;
  if (temp_7769.isBuilt ()) {
    temp_7769 (HERE)->method_acceptForeachInstruction (inLexique, var_cas_inComponentSemanticsEntitiesMap, var_cas_instructionLocation, var_cas_formalEnumerationList, var_cas_localConstantBuildStyleEnum, var_cas_iteratorNewStyle COMMA_SOURCE_FILE_AT_LINE (218)) ;
  }
  ...
  switch (select_galgasTemplateParser_3 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (230)) ;
        ...
        while (syntaxRepeat_4) {
          switch (select_repeat_galgasTemplateParser_4 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (240)) ;
              } break ;
            default :
  ...
  var_cas_ioTemplateVariableMap.prologue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) ;
  var_cas_ioTemplateVariableMap.prologue_repeatPart (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
  ...
  {
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_8704 (var_cas_formalEnumerationList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_8704 = NULL ;
    while (((operand_8704 = enumerator_8704.nextObject ()))) {
      ...
      if ((((var_cas_localConstantBuildStyleEnum).operator_isEqual (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (inLexique COMMA_HERE))).operator_and (var_cas_firstOne)).isBuiltAndTrue ()) {
        ...
        var_cas_cppName = GGS_typeOperandName ::constructor_new (inLexique, var_cas_instructionLocation, operand_8704->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), var_cas_mapStyle, var_cas_iteratorNewStyle COMMA_HERE) ;
      }
      GGS_lstring  var_cas_implicitVariableName ;
      var_cas_implicitVariableName = GGS_lstring ::constructor_new (inLexique, (var_cas_prefix).operator_concat (operand_8704->mAttributeName), operand_8704->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (256)) COMMA_HERE) ;
      var_cas_ioTemplateVariableMap.modifier_insertUsedConstInArgument (inLexique, var_cas_implicitVariableName, operand_8704->mAttributType, var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (257)) ;
  ...
  switch (select_galgasTemplateParser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_indexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (267)), var_cas_indexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) COMMA_HERE) ;
      var_cas_ioTemplateVariableMap.modifier_insertConstInArgument (inLexique, var_cas_indexIdentifier, GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE), var_cas_cppName COMMA_SOURCE_FILE_AT_LINE (268)) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__3A_) COMMA_HERE) ;
      } break ;
    default :
      break ;
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (272)) ;
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_galgasTemplateParser_6 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (282)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_repeatPart (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (245)) ;
  var_cas_ioTemplateVariableMap.epilogue_repeatBlock (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) ;
  ...
  switch (select_galgasTemplateParser_7 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (291)) ;
        ...
        while (syntaxRepeat_8) {
          switch (select_repeat_galgasTemplateParser_8 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (301)) ;
              } break ;
            default :
  ...
  switch (select_galgasTemplateParser_9 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (309)) ;
      { bool syntaxRepeat_10 = true ;
        while (syntaxRepeat_10) {
          switch (select_repeat_galgasTemplateParser_10 (inLexique)) {
            case 2 : {
              nt_template_instruction_ (inLexique, var_cas_ioTemplateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_beforeInstructionList) ;
              ::routine_enterTemplateString (inLexique,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (319)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_template_instruction_galgasTemplateParser_341_27_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        var_cas_x = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_expressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (361)) ;
        ...
        ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (364)) ;
          ...
          while (syntaxRepeat_12) {
            switch (select_repeat_galgasTemplateParser_12 (inLexique)) {
              case 2 : {
                ...
                ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (374)) ;
                } break ;
              default :
  ...
  switch (select_galgasTemplateParser_13 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (385)) ;
        ...
        while (syntaxRepeat_14) {
          switch (select_repeat_galgasTemplateParser_14 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (395)) ;
              } break ;
            default :
...
void galgasTemplateParser::
pr_lexique_component_start_symbol_galgasTemplateParser_409_37_ (galgasTemplateScanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioTemplateVariableMap,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inComponentSemanticsEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
  ...
  var_cas_ioTemplateVariableMap.prologue_verifyVariableUsing (inLexique COMMA_SOURCE_FILE_AT_LINE (417)) ;
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (418)) ;
    ...
    while (syntaxRepeat_15) {
      switch (select_repeat_galgasTemplateParser_15 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (428)) ;
          } break ;
        default :
  ...
  var_cas_ioTemplateVariableMap.epilogue_verifyVariableUsing (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (417)) ;
}
