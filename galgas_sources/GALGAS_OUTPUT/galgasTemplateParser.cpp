...
void galgasTemplateParser::rule_galgasTemplateParser_template_5F_instruction_i7_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  GGS_typeGalgas_enum  var_cas_x = GGS_typeGalgas_enum::castFrom (inLexique, var_cas_switchExpressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (458)) ;
  const GGS_enumConstantMap  var_cas_enumConstantesMap = var_cas_x.reader_mEnumConstantesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (459)) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_16 = true ;
            while (syntaxRepeat_16) {
                ...
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
                GGS_uint  automatic_var_15691_0 ;
                if (var_cas_enumConstantesMap.isBuilt ()) {
                  var_cas_enumConstantesMap (HERE)->method_searchKey (inLexique, var_cas_constantName, automatic_var_15691_0 COMMA_SOURCE_FILE_AT_LINE (469)) ;
                }
                const GGS_bool cond_15856 = var_cas_namedConstantSet.reader_hasKey (var_cas_constantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (470))) ;
                if (cond_15856.isBuiltAndTrue ()) {
                  var_cas_constantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this constant is already named in the switch instruction") COMMA_SOURCE_FILE_AT_LINE (472)) ;
                }
                var_cas_namedConstantSet.addAssign_operation (var_cas_constantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (473))) ;
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__3A_) COMMA_HERE) ;
          GGS_templateInstructionList  var_cas_instructionList = GGS_templateInstructionList ::constructor_emptyList () ;
          ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (480)) ;
          GGS_templateVariableMap  var_cas_templateVariableMap = var_cas_ioTemplateVariableMap ;
          { bool syntaxRepeat_17 = true ;
            while (syntaxRepeat_17) {
              switch (select_galgasTemplateParser_17 (inLexique)) {
                case 2 : {
                  nt_template_5F_instruction_ (inLexique, var_cas_templateVariableMap, var_cas_inSemanticContext, var_cas_inComponentSemanticsEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_instructionList, var_cas_ioUsesColumnMarker) ;
                  ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (492)) ;
                  } break ;
                default :
  ...
  GGS_stringset  var_cas_missingConstants = var_cas_enumConstantesMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (497)).substract_operation (inLexique, var_cas_namedConstantSet COMMA_SOURCE_FILE_AT_LINE (497)) ;
  const GGS_bool cond_16910 = (var_cas_missingConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_16910.isBuiltAndTrue ()) {
    GGS_string var_cas_m = GGS_string ("the following constants are missing:") ;
    {
      GGS_stringset::cEnumerator enumerator_16827 (var_cas_missingConstants, true) ;
      while (enumerator_16827.hasCurrentObject ()) {
        var_cas_m.appendCString ("\n"
          "  - '") ;
        var_cas_m.dotAssign_operation (enumerator_16827._key (HERE)) ;
        var_cas_m.appendCString ("'") ;
        enumerator_16827.next () ;
      }
    }
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (504)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_switch) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionSwitch ::constructor_new (inLexique, var_cas_x.reader_mEnumTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (509)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (509)), var_cas_switchExpression, var_cas_templateInstructionSwitchBranchList COMMA_SOURCE_FILE_AT_LINE (508))) ;
}
...
void galgasTemplateParser::rule_galgasTemplateParser_lexique_5F_component_5F_start_5F_symbol_i8_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (527)) ;
    ...
    while (syntaxRepeat_18) {
      switch (select_galgasTemplateParser_18 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (539)) ;
          } break ;
        default :
