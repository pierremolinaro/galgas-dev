...
pr_template_instruction_galgasTemplateParser_106_27_ (galgasTemplateScanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
  GGS_typeCplusPlusName  var_cas_cppName ;
  var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_columnConstantName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (116)), var_cas_columnConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_HERE) ;
...
pr_template_instruction_galgasTemplateParser_127_27_ (galgasTemplateScanner & inLexique,
  ...
  var_cas_x = GGS_typeGalgas_uint::castFrom (inLexique, var_cas_resultType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__3A_) COMMA_HERE) ;
...
pr_template_instruction_galgasTemplateParser_173_27_ (galgasTemplateScanner & inLexique,
  ...
  var_cas_firstOne = GGS_bool (true) ;
  {
    ...
    while (((operand_8781 = enumerator_8781.nextObject ()))) {
      ...
      var_cas_implicitVariableName = GGS_lstring ::constructor_new (inLexique, (var_cas_prefix).operator_concat (operand_8781->mAttributeName), operand_8781->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) COMMA_HERE) ;
  ...
  switch (select_galgasTemplateParser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      GGS_typeCplusPlusName  var_cas_cppName ;
      var_cas_cppName = GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_indexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (266)), var_cas_indexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) COMMA_HERE) ;
...
pr_template_instruction_galgasTemplateParser_340_27_ (galgasTemplateScanner & inLexique,
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        var_cas_x = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_expressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (360)) ;
