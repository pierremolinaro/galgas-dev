...
static const C_cocoa_lexique_table_entry ktable_for_galgas_5F_scanner_galgasKeyWordList [100] = {
  ...
  {"extension", galgas_scanner_1_extension},
  {"semantics", galgas_scanner_1_semantics},
  {"sharedmap", galgas_scanner_1_sharedmap},
...
- (void) parseLexicalTokenForLexicalColoring {
  ...
  while ((mTokenCode == 0) && (mCurrentChar != '\0')) {
    ...
    if (scanningOk && ([self testForInputFromChar:97 toChar:122] || [self testForInputFromChar:65 toChar:90])) {
      ...
      mTokenCode = galgas_scanner_1__7C__7C_ ;
    }else if (scanningOk && [self testForInputString:@">>" advance:YES]) {
      ...
      mTokenCode = galgas_scanner_1__26__26_ ;
    }else if (scanningOk && [self testForInputString:@"!=" advance:YES]) {
...
- (BOOL) atomicSelectionForToken: (NSUInteger) inTokenIndex {
  static const BOOL kTerminalAtomicSelection [158] = {NO,
    ...
    YES /* galgas_scanner_1_extension */,
    ...
    YES /* galgas_scanner_1_sharedmap */,
