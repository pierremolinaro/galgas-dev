...
static const BOOL kEndOfScriptInTemplateArray_galgas_5F_scanner [151] = {
  NO /* identifier */,
  NO /* literal_double */,
...
static const C_cocoa_lexique_table_entry ktable_for_galgas_5F_scanner_galgasKeyWordList [94] = {
  ...
  {"reverse", galgas_scanner_1_reverse},
...
static NSUInteger search_into_galgas_5F_scanner_galgasKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_galgas_5F_scanner_galgasKeyWordList, 94) ;
}
...
- (void) parseLexicalTokenForLexicalColoring {
  ...
  while ((mTokenCode == 0) && (mCurrentChar != '\0')) {
    ...
    if (scanningOk && ([self testForInputFromChar:97 toChar:122] || [self testForInputFromChar:65 toChar:90])) {
      ...
      mTokenCode = galgas_scanner_1_variant ;
...
- (BOOL) atomicSelectionForToken: (NSUInteger) inTokenIndex {
  static const BOOL kTerminalAtomicSelection [152] = {NO,
    ...
    YES /* galgas_scanner_1_prefixedby */,
