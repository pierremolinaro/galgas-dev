...
static const BOOL kEndOfScriptInTemplateArray_galgas_5F_scanner [144] = {
  NO /* identifier */,
  NO /* literal_double */,
...
static const C_cocoa_lexique_table_entry ktable_for_galgas_5F_scanner_galgasKeyWordList [89] = {
...
static SInt32 search_into_galgas_5F_scanner_galgasKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_galgas_5F_scanner_galgasKeyWordList, 89) ;
}
...
- (UInt32) styleIndexForTerminal: (SInt32) inTerminal {
  static const UInt32 kTerminalSymbolStyles [145] = {0,
