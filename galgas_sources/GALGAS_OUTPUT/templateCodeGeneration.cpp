...
category_method__templateInstructionIfForGeneration__templateCodeGeneration (C_CompilerEx & inLexique,
  ...
  if (operand_8716 != NULL) {
    ...
    {
      GGS_templateInstructionIfBranchListForGeneration::cEnumerator enumerator_9773 (operand_8716->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListForGeneration::cElement * operand_9773 = NULL ;
...
category_method__templateInstructionSwitchForGeneration__templateCodeGeneration (C_CompilerEx & inLexique,
  ...
  if (operand_10039 != NULL) {
    ...
    { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_10039->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_10039->mSwitchExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_switchVarCppName COMMA_SOURCE_FILE_AT_LINE (264)) ;
      }
    }
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (operand_10039->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (267)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (267))) ;
    var_cas_ioGeneratedCode.appendCString ("::kNotBuilt :\n") ;
    var_cas_ioGeneratedCode.appendCString ("break ;\n") ;
    {
      GGS_templateInstructionSwitchBranchListForGeneration::cEnumerator enumerator_10635 (operand_10039->mTemplateInstructionSwitchBranchList, true) ;
      const GGS_templateInstructionSwitchBranchListForGeneration::cElement * operand_10635 = NULL ;
      while (((operand_10635 = enumerator_10635.nextObject ()))) {
        macroValidPointer (operand_10635) ;
        {
          GGS_lstringlist::cEnumerator enumerator_10664 (operand_10635->mConstantList, true) ;
          const GGS_lstringlist::cElement * operand_10664 = NULL ;
          while (((operand_10664 = enumerator_10664.nextObject ()))) {
            macroValidPointer (operand_10664) ;
            var_cas_ioGeneratedCode.appendCString ("case GALGAS_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_10039->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (272)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (272))) ;
            var_cas_ioGeneratedCode.appendCString ("::kEnum_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_10664->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (272)).reader_identifierRepresentation ()) ;
            var_cas_ioGeneratedCode.appendCString (" :\n") ;
          }
        }
        var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (274)) ;
        ::routine_templateCodeGenerationForListInstruction (inLexique,  operand_10635->mInstructionList,  var_cas_ioGeneratedCode,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioUseColumnMarker COMMA_SOURCE_FILE_AT_LINE (275)) ;
