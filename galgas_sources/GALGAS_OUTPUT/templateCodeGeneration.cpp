...
category_method__templateInstructionForeachForGeneration__templateCodeGeneration (C_Compiler & inLexique,
  ...
  if (operand_5535 != NULL) {
    ...
    var_cas_ioGeneratedCode.appendCString (") ;\n") ;
    const GGS_bool cond_6511 = (operand_5535->mBeforeInstructionList.reader_length ().add_operation (inLexique, operand_5535->mAfterInstructionList.reader_length () COMMA_SOURCE_FILE_AT_LINE (148))).operator_strictSup (GGS_uint (0U)) ;
    if (cond_6511.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_6958 = (operand_5535->mBeforeInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_6958.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_7743 = (operand_5535->mBetweenInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    ...
    const GGS_bool cond_7863 = (operand_5535->mIndexCppName.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_7863.isBuiltAndTrue ()) {
      var_cas_ioGeneratedCode.dotAssign_operation (operand_5535->mIndexCppName) ;
    ...
    var_cas_ioGeneratedCode.appendCString ("}\n") ;
    const GGS_bool cond_8464 = (operand_5535->mAfterInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_8464.isBuiltAndTrue ()) {
      var_cas_ioGeneratedCode.appendCString ("if (nonEmpty_") ;
      var_cas_ioGeneratedCode.dotAssign_operation (operand_5535->mEnumeratorCppName) ;
      var_cas_ioGeneratedCode.appendCString (") {\n") ;
...
category_method__templateInstructionIfForGeneration__templateCodeGeneration (C_Compiler & inLexique,
  ...
  if (operand_8716 != NULL) {
    {
      GGS_templateInstructionIfBranchListForGeneration::cEnumerator enumerator_8894 (operand_8716->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListForGeneration::cElement * operand_8894 = NULL ;
      while (((operand_8894 = enumerator_8894.nextObject ()))) {
        macroValidPointer (operand_8894) ;
        GGS_string var_cas_ifVarCppName ;
        { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_8894->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_8894->mExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_ifVarCppName COMMA_SOURCE_FILE_AT_LINE (226)) ;
          }
        }
        var_cas_ioGeneratedCode.appendCString ("if (") ;
        ...
        ::routine_templateCodeGenerationForListInstruction (inLexique,  operand_8894->mInstructionList,  var_cas_ioGeneratedCode,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioUseColumnMarker COMMA_SOURCE_FILE_AT_LINE (229)) ;
    ...
    ::routine_templateCodeGenerationForListInstruction (inLexique,  operand_8716->mElseInstructionList,  var_cas_ioGeneratedCode,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioUseColumnMarker COMMA_SOURCE_FILE_AT_LINE (241)) ;
    {
      GGS_templateInstructionIfBranchListForGeneration::cEnumerator enumerator_9776 (operand_8716->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListForGeneration::cElement * operand_9776 = NULL ;
...
category_method__templateInstructionSwitchForGeneration__templateCodeGeneration (C_Compiler & inLexique,
                                const cPtr_templateInstructionSwitchForGeneration * operand_10042,
                                GGS_string & var_cas_ioGeneratedCode,
                                GGS_uint  & var_cas_ioTemporaryVariableIndex,
                                GGS_stringset  & var_cas_ioUnusedVariableCppNameSet,
                                GGS_bool & var_cas_ioUseColumnMarker
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10042 != NULL) {
    GGS_string var_cas_switchVarCppName ;
    { typeCategoryMethod__semanticExpressionForGeneration__generateExpression method = findCategoryMethod__semanticExpressionForGeneration__generateExpression (operand_10042->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_10042->mSwitchExpression (HERE), var_cas_ioGeneratedCode, var_cas_ioTemporaryVariableIndex, var_cas_ioUnusedVariableCppNameSet, var_cas_switchVarCppName COMMA_SOURCE_FILE_AT_LINE (264)) ;
      }
    }
    ...
    var_cas_ioGeneratedCode.dotAssign_operation (operand_10042->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (267)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (267))) ;
    var_cas_ioGeneratedCode.appendCString ("::kNotBuilt :\n") ;
    var_cas_ioGeneratedCode.appendCString ("break ;\n") ;
    {
      GGS_templateInstructionSwitchBranchListForGeneration::cEnumerator enumerator_10638 (operand_10042->mTemplateInstructionSwitchBranchList, true) ;
      const GGS_templateInstructionSwitchBranchListForGeneration::cElement * operand_10638 = NULL ;
      while (((operand_10638 = enumerator_10638.nextObject ()))) {
        macroValidPointer (operand_10638) ;
        {
          GGS_lstringlist::cEnumerator enumerator_10667 (operand_10638->mConstantList, true) ;
          const GGS_lstringlist::cElement * operand_10667 = NULL ;
          while (((operand_10667 = enumerator_10667.nextObject ()))) {
            macroValidPointer (operand_10667) ;
            var_cas_ioGeneratedCode.appendCString ("case GALGAS_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_10042->mSwitchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (272)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (272))) ;
            var_cas_ioGeneratedCode.appendCString ("::kEnum_") ;
            var_cas_ioGeneratedCode.dotAssign_operation (operand_10667->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (272)).reader_identifierRepresentation ()) ;
            var_cas_ioGeneratedCode.appendCString (" :\n") ;
          }
        }
        var_cas_ioGeneratedCode.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (274)) ;
        ::routine_templateCodeGenerationForListInstruction (inLexique,  operand_10638->mInstructionList,  var_cas_ioGeneratedCode,  var_cas_ioTemporaryVariableIndex,  var_cas_ioUnusedVariableCppNameSet,  var_cas_ioUseColumnMarker COMMA_SOURCE_FILE_AT_LINE (275)) ;
