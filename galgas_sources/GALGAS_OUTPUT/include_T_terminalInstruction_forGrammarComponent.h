...
class GGG_T_terminalInstruction_forGrammarComponent : public GGG_AC_instruction_ForGrammar {
  private : typedef GGG_AC_instruction_ForGrammar inherited ;
  public : GGG_T_terminalInstruction_forGrammarComponent (const GGS_location & ,
                                const GGS_lstring & ,
                                const GGS_uint &  COMMA_LOCATION_ARGS) ;
} ;
