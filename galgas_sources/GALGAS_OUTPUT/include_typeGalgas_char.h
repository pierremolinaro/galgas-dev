...
#ifndef typeGalgas_char_DEFINED
#define typeGalgas_char_DEFINED
...
class GGG_typeGalgas_char : public GGG_AC_galgasType {
  private : typedef GGG_AC_galgasType inherited ;
  public : GGG_typeGalgas_char (LOCATION_ARGS) ;
} ;
