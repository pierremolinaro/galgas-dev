...
GALGAS_parsedLexiqueComponentMap_3A_element cEnumerator_parsedLexiqueComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedLexiqueComponentMap * p = (const cMapElement_parsedLexiqueComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedLexiqueComponentMap) ;
  return GALGAS_parsedLexiqueComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLexiqueComponentAST) ;
}
...
GALGAS_parsedOptionComponentMap_3A_element cEnumerator_parsedOptionComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedOptionComponentMap * p = (const cMapElement_parsedOptionComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedOptionComponentMap) ;
  return GALGAS_parsedOptionComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mBoolOptionMap, p->mAttribute_mUIntOptionMap, p->mAttribute_mStringOptionMap) ;
}
...
GALGAS_parsedSemanticsComponentMap_3A_element cEnumerator_parsedSemanticsComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedSemanticsComponentMap * p = (const cMapElement_parsedSemanticsComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedSemanticsComponentMap) ;
  return GALGAS_parsedSemanticsComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSourceFullFilePath, p->mAttribute_mSemanticComponentRoot) ;
}
...
GALGAS_parsedGrammarComponentMap_3A_element cEnumerator_parsedGrammarComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedGrammarComponentMap * p = (const cMapElement_parsedGrammarComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedGrammarComponentMap) ;
  return GALGAS_parsedGrammarComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSourceFullFilePath, p->mAttribute_mGrammarComponentRoot) ;
}
...
GALGAS_parsedSyntaxComponentMap_3A_element cEnumerator_parsedSyntaxComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedSyntaxComponentMap * p = (const cMapElement_parsedSyntaxComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedSyntaxComponentMap) ;
  return GALGAS_parsedSyntaxComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSourceFullFilePath, p->mAttribute_mSyntaxComponentRoot) ;
}
...
GALGAS_parsedProgramComponentMap_3A_element cEnumerator_parsedProgramComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedProgramComponentMap * p = (const cMapElement_parsedProgramComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedProgramComponentMap) ;
  return GALGAS_parsedProgramComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSourceFullFilePath, p->mAttribute_mProgramComponentAST) ;
}
...
GALGAS_parsedGuiComponentMap_3A_element cEnumerator_parsedGuiComponentMap::current (LOCATION_ARGS) const {
  const cMapElement_parsedGuiComponentMap * p = (const cMapElement_parsedGuiComponentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_parsedGuiComponentMap) ;
  return GALGAS_parsedGuiComponentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSourceFullFilePath, p->mAttribute_mGuiComponentAST) ;
}
...
GALGAS_parsedLexiqueComponentMap_3A_element::GALGAS_parsedLexiqueComponentMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_parsedLexiqueComponentMap_3A_element::GALGAS_parsedLexiqueComponentMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_parsedLexiqueComponentMap_3A_element & GALGAS_parsedLexiqueComponentMap_3A_element::operator = (const GALGAS_parsedLexiqueComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mLexiqueComponentAST = inOperand.mAttribute_mLexiqueComponentAST ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_parsedLexiqueComponentMap_3A_element GALGAS_parsedLexiqueComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                          const GALGAS_lexiqueComponentAST & inOperand1 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedLexiqueComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_parsedLexiqueComponentMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedLexiqueComponentMap_3A_element::objectCompare (const GALGAS_parsedLexiqueComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_parsedLexiqueComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexiqueComponentAST.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedLexiqueComponentMap_3A_element::drop (void) {
...
void GALGAS_parsedLexiqueComponentMap_3A_element::description (C_String & ioString,
                                                               const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedLexiqueComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexiqueComponentAST GALGAS_parsedLexiqueComponentMap_3A_element::reader_mLexiqueComponentAST (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedLexiqueComponentMap_3A_element ("parsedLexiqueComponentMap:element",
                                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedLexiqueComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedLexiqueComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedLexiqueComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedLexiqueComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedLexiqueComponentMap_3A_element GALGAS_parsedLexiqueComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                        C_Compiler * inCompiler,
                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_parsedLexiqueComponentMap_3A_element result ;
  const GALGAS_parsedLexiqueComponentMap_3A_element * p = (const GALGAS_parsedLexiqueComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedLexiqueComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedLexiqueComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_parsedOptionComponentMap_3A_element::GALGAS_parsedOptionComponentMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_parsedOptionComponentMap_3A_element::GALGAS_parsedOptionComponentMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_parsedOptionComponentMap_3A_element & GALGAS_parsedOptionComponentMap_3A_element::operator = (const GALGAS_parsedOptionComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
...
GALGAS_parsedOptionComponentMap_3A_element GALGAS_parsedOptionComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                        const GALGAS_commandLineOptionMap & inOperand1,
                                                                                                        const GALGAS_commandLineOptionMap & inOperand2,
                                                                                                        const GALGAS_commandLineOptionMap & inOperand3 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedOptionComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_parsedOptionComponentMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedOptionComponentMap_3A_element::objectCompare (const GALGAS_parsedOptionComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_parsedOptionComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mBoolOptionMap.isValid () && mAttribute_mUIntOptionMap.isValid () && mAttribute_mStringOptionMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedOptionComponentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_parsedOptionComponentMap_3A_element::description (C_String & ioString,
                                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedOptionComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_commandLineOptionMap GALGAS_parsedOptionComponentMap_3A_element::reader_mBoolOptionMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBoolOptionMap ;
}

//---------------------------------------------------------------------------*

GALGAS_commandLineOptionMap GALGAS_parsedOptionComponentMap_3A_element::reader_mUIntOptionMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mUIntOptionMap ;
}

//---------------------------------------------------------------------------*

GALGAS_commandLineOptionMap GALGAS_parsedOptionComponentMap_3A_element::reader_mStringOptionMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedOptionComponentMap_3A_element ("parsedOptionComponentMap:element",
                                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedOptionComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedOptionComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedOptionComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedOptionComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedOptionComponentMap_3A_element GALGAS_parsedOptionComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler,
                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_parsedOptionComponentMap_3A_element result ;
  const GALGAS_parsedOptionComponentMap_3A_element * p = (const GALGAS_parsedOptionComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedOptionComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedOptionComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_parsedSemanticsComponentMap_3A_element::GALGAS_parsedSemanticsComponentMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_parsedSemanticsComponentMap_3A_element::GALGAS_parsedSemanticsComponentMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_parsedSemanticsComponentMap_3A_element & GALGAS_parsedSemanticsComponentMap_3A_element::operator = (const GALGAS_parsedSemanticsComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSourceFullFilePath = inOperand.mAttribute_mSourceFullFilePath ;
  mAttribute_mSemanticComponentRoot = inOperand.mAttribute_mSemanticComponentRoot ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_parsedSemanticsComponentMap_3A_element GALGAS_parsedSemanticsComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                              const GALGAS_lstring & inOperand1,
                                                                                                              const GALGAS_semanticsComponentAST & inOperand2 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedSemanticsComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_parsedSemanticsComponentMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedSemanticsComponentMap_3A_element::objectCompare (const GALGAS_parsedSemanticsComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_parsedSemanticsComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSourceFullFilePath.isValid () && mAttribute_mSemanticComponentRoot.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedSemanticsComponentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_parsedSemanticsComponentMap_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedSemanticsComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_parsedSemanticsComponentMap_3A_element::reader_mSourceFullFilePath (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFullFilePath ;
}

//---------------------------------------------------------------------------*

GALGAS_semanticsComponentAST GALGAS_parsedSemanticsComponentMap_3A_element::reader_mSemanticComponentRoot (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedSemanticsComponentMap_3A_element ("parsedSemanticsComponentMap:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedSemanticsComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedSemanticsComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedSemanticsComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedSemanticsComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedSemanticsComponentMap_3A_element GALGAS_parsedSemanticsComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_parsedSemanticsComponentMap_3A_element result ;
  const GALGAS_parsedSemanticsComponentMap_3A_element * p = (const GALGAS_parsedSemanticsComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedSemanticsComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedSemanticsComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_parsedGrammarComponentMap_3A_element::GALGAS_parsedGrammarComponentMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mSourceFullFilePath (),
...
GALGAS_parsedGrammarComponentMap_3A_element::GALGAS_parsedGrammarComponentMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_lstring & inOperand1,
...
/* GALGAS_parsedGrammarComponentMap_3A_element & GALGAS_parsedGrammarComponentMap_3A_element::operator = (const GALGAS_parsedGrammarComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSourceFullFilePath = inOperand.mAttribute_mSourceFullFilePath ;
  mAttribute_mGrammarComponentRoot = inOperand.mAttribute_mGrammarComponentRoot ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_parsedGrammarComponentMap_3A_element GALGAS_parsedGrammarComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                          const GALGAS_lstring & inOperand1,
                                                                                                          const GALGAS_grammarComponentAST & inOperand2 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedGrammarComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_parsedGrammarComponentMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedGrammarComponentMap_3A_element::objectCompare (const GALGAS_parsedGrammarComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_parsedGrammarComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSourceFullFilePath.isValid () && mAttribute_mGrammarComponentRoot.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedGrammarComponentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mSourceFullFilePath.drop () ;
...
void GALGAS_parsedGrammarComponentMap_3A_element::description (C_String & ioString,
                                                               const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedGrammarComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_parsedGrammarComponentMap_3A_element::reader_mSourceFullFilePath (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFullFilePath ;
}

//---------------------------------------------------------------------------*

GALGAS_grammarComponentAST GALGAS_parsedGrammarComponentMap_3A_element::reader_mGrammarComponentRoot (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedGrammarComponentMap_3A_element ("parsedGrammarComponentMap:element",
                                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedGrammarComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedGrammarComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedGrammarComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedGrammarComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedGrammarComponentMap_3A_element GALGAS_parsedGrammarComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                        C_Compiler * inCompiler,
                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_parsedGrammarComponentMap_3A_element result ;
  const GALGAS_parsedGrammarComponentMap_3A_element * p = (const GALGAS_parsedGrammarComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedGrammarComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedGrammarComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_parsedSyntaxComponentMap_3A_element::GALGAS_parsedSyntaxComponentMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mSourceFullFilePath (),
...
GALGAS_parsedSyntaxComponentMap_3A_element::GALGAS_parsedSyntaxComponentMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                        const GALGAS_lstring & inOperand1,
...
/* GALGAS_parsedSyntaxComponentMap_3A_element & GALGAS_parsedSyntaxComponentMap_3A_element::operator = (const GALGAS_parsedSyntaxComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSourceFullFilePath = inOperand.mAttribute_mSourceFullFilePath ;
  mAttribute_mSyntaxComponentRoot = inOperand.mAttribute_mSyntaxComponentRoot ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_parsedSyntaxComponentMap_3A_element GALGAS_parsedSyntaxComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                        const GALGAS_lstring & inOperand1,
                                                                                                        const GALGAS_syntaxComponentAST & inOperand2 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedSyntaxComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_parsedSyntaxComponentMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedSyntaxComponentMap_3A_element::objectCompare (const GALGAS_parsedSyntaxComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_parsedSyntaxComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSourceFullFilePath.isValid () && mAttribute_mSyntaxComponentRoot.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedSyntaxComponentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mSourceFullFilePath.drop () ;
...
void GALGAS_parsedSyntaxComponentMap_3A_element::description (C_String & ioString,
                                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedSyntaxComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_parsedSyntaxComponentMap_3A_element::reader_mSourceFullFilePath (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFullFilePath ;
}

//---------------------------------------------------------------------------*

GALGAS_syntaxComponentAST GALGAS_parsedSyntaxComponentMap_3A_element::reader_mSyntaxComponentRoot (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedSyntaxComponentMap_3A_element ("parsedSyntaxComponentMap:element",
                                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedSyntaxComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedSyntaxComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedSyntaxComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedSyntaxComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedSyntaxComponentMap_3A_element GALGAS_parsedSyntaxComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler,
                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_parsedSyntaxComponentMap_3A_element result ;
  const GALGAS_parsedSyntaxComponentMap_3A_element * p = (const GALGAS_parsedSyntaxComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedSyntaxComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedSyntaxComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_parsedProgramComponentMap_3A_element::GALGAS_parsedProgramComponentMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mSourceFullFilePath (),
...
GALGAS_parsedProgramComponentMap_3A_element::GALGAS_parsedProgramComponentMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_lstring & inOperand1,
...
/* GALGAS_parsedProgramComponentMap_3A_element & GALGAS_parsedProgramComponentMap_3A_element::operator = (const GALGAS_parsedProgramComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSourceFullFilePath = inOperand.mAttribute_mSourceFullFilePath ;
  mAttribute_mProgramComponentAST = inOperand.mAttribute_mProgramComponentAST ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_parsedProgramComponentMap_3A_element GALGAS_parsedProgramComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                          const GALGAS_lstring & inOperand1,
                                                                                                          const GALGAS_programComponentAST & inOperand2 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedProgramComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_parsedProgramComponentMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedProgramComponentMap_3A_element::objectCompare (const GALGAS_parsedProgramComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_parsedProgramComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSourceFullFilePath.isValid () && mAttribute_mProgramComponentAST.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedProgramComponentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mSourceFullFilePath.drop () ;
...
void GALGAS_parsedProgramComponentMap_3A_element::description (C_String & ioString,
                                                               const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedProgramComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_parsedProgramComponentMap_3A_element::reader_mSourceFullFilePath (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFullFilePath ;
}

//---------------------------------------------------------------------------*

GALGAS_programComponentAST GALGAS_parsedProgramComponentMap_3A_element::reader_mProgramComponentAST (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedProgramComponentMap_3A_element ("parsedProgramComponentMap:element",
                                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedProgramComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedProgramComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedProgramComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedProgramComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedProgramComponentMap_3A_element GALGAS_parsedProgramComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                        C_Compiler * inCompiler,
                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_parsedProgramComponentMap_3A_element result ;
  const GALGAS_parsedProgramComponentMap_3A_element * p = (const GALGAS_parsedProgramComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedProgramComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedProgramComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_parsedGuiComponentMap_3A_element::GALGAS_parsedGuiComponentMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mSourceFullFilePath (),
...
GALGAS_parsedGuiComponentMap_3A_element::GALGAS_parsedGuiComponentMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_lstring & inOperand1,
...
/* GALGAS_parsedGuiComponentMap_3A_element & GALGAS_parsedGuiComponentMap_3A_element::operator = (const GALGAS_parsedGuiComponentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSourceFullFilePath = inOperand.mAttribute_mSourceFullFilePath ;
  mAttribute_mGuiComponentAST = inOperand.mAttribute_mGuiComponentAST ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_parsedGuiComponentMap_3A_element GALGAS_parsedGuiComponentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_lstring & inOperand1,
                                                                                                  const GALGAS_guiComponentAST & inOperand2 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_parsedGuiComponentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_parsedGuiComponentMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_parsedGuiComponentMap_3A_element::objectCompare (const GALGAS_parsedGuiComponentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_parsedGuiComponentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSourceFullFilePath.isValid () && mAttribute_mGuiComponentAST.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_parsedGuiComponentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mSourceFullFilePath.drop () ;
...
void GALGAS_parsedGuiComponentMap_3A_element::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_parsedGuiComponentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_parsedGuiComponentMap_3A_element::reader_mSourceFullFilePath (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFullFilePath ;
}

//---------------------------------------------------------------------------*

GALGAS_guiComponentAST GALGAS_parsedGuiComponentMap_3A_element::reader_mGuiComponentAST (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_parsedGuiComponentMap_3A_element ("parsedGuiComponentMap:element",
                                                         NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_parsedGuiComponentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_parsedGuiComponentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_parsedGuiComponentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_parsedGuiComponentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_parsedGuiComponentMap_3A_element GALGAS_parsedGuiComponentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_parsedGuiComponentMap_3A_element result ;
  const GALGAS_parsedGuiComponentMap_3A_element * p = (const GALGAS_parsedGuiComponentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_parsedGuiComponentMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "parsedGuiComponentMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
