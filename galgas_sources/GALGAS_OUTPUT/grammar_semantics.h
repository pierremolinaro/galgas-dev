...
class GGG_typeListeAttributsAxiome : public GGS_class {
...
class GGG_typeListeChaines : public GGS_class {
//--- Protected Constructor
...
class GGG_L_grammarDescriptorForProgram : public GGS_class {
//--- Protected Constructor
