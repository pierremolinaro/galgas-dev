//---------------------------------------------------------------------------*
//                                                                           *
//                    File 'include_typeLogicalNegate.h'                     *
...
class cPtr_typeLogicalNegate : public cPtr_typeExpression {
...
//--- Constructor
  public : cPtr_typeLogicalNegate (const GGS_typeExpression &  COMMA_LOCATION_ARGS) ;

//--- Declaring a protected virtual destructor enables the compiler to raise
//    an error if a direct delete is performed; only the static method
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_typeLogicalNegate (void) {}
  #endif
