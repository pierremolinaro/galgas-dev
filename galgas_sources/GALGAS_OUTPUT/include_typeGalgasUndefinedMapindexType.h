//---------------------------------------------------------------------------*
//                                                                           *
//             File 'include_typeGalgasUndefinedMapindexType.h'              *
//         Generated by version GALGAS_BETA_VERSION (LL(1) grammar)          *
//                     february 15th, 2007, at 18h55'4"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
class cPtr_typeGalgasUndefinedMapindexType : public cPtr_AC_galgasType {
...
//--- Constructor
  public : cPtr_typeGalgasUndefinedMapindexType (const GGS_lstring &  COMMA_LOCATION_ARGS) ;

//--- Declaring a protected virtual destructor enables the compiler to raise
//    an error if a direct delete is performed; only the static method
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_typeGalgasUndefinedMapindexType (void) {}
  #endif
