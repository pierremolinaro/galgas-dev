...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_88017_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_88020_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_88023_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_88026_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_88017_0, joker_88020_0, joker_88023_0, joker_88026_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1891)) ;
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1894))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1894)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1894)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1895)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1896)), var_filewrapperPath.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1897))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1893)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_88816_0 ; // Joker input parameter
  GALGAS_lstringlist joker_88819_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_88822_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_88825_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_88816_0, joker_88819_0, joker_88822_0, joker_88825_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1911)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_88988_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_88988_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1914)) ;
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1917)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1917)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919)).operator_concat (GALGAS_string ("' template of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919)).operator_concat (GALGAS_string ("' filewrapper requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1920)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1920))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1920)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1921)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1921))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1920)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1921))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1918)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1924)) ;
    cEnumerator_semanticExpressionListAST enumerator_89575 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_89594 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_89575.hasCurrentObject () && enumerator_89594.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_89575.current_mExpression (HERE).ptr (), enumerator_89594.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1927)) ;
      {
      routine_checkAssignmentTypes (enumerator_89594.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1928)), enumerator_89575.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1928)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1929)) ;
      enumerator_89575.gotoNextObject () ;
      enumerator_89594.gotoNextObject () ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1936)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1937)), var_effectiveParameterList  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1933)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1953)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1954)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1955)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1956)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958)) ;
      {
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1959)) ;
      }
    }
  }
  GALGAS_wrapperFileMap var_filewrapperFileMap ;
  GALGAS_wrapperDirectoryMap var_filewrapperDirectoryMap ;
  GALGAS_lstring joker_91170_0 ; // Joker input parameter
  GALGAS_lstringlist joker_91177_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_91237_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_91170_0, joker_91177_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_91237_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1964)) ;
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1974)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1974)).isValid ()) {
    uint32_t variant_91300 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1974)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1974)).uintValue () ;
    bool loop_91300 = true ;
    while (loop_91300) {
      loop_91300 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1975)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_91300) {
        loop_91300 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1975)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_91300 && (0 == variant_91300)) {
        loop_91300 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1974)) ;
      }
      if (loop_91300) {
        variant_91300 -- ;
        GALGAS_string var_directoryName ;
        {
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1977)) ;
        }
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1978))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1978)) ;
        const enumGalgasBool test_4 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1979)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_91708_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1981)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_91708_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1980)) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987)).operator_concat (GALGAS_string ("' path does not exists for the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1988)) ;
        }
      }
    }
  }
  ...
  const enumGalgasBool test_6 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1993)).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_string joker_92128_0 ; // Joker input parameter
    GALGAS_uint joker_92143_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1994)), joker_92128_0, var_isTextFile, joker_92143_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1994)) ;
  }else if (kBoolFalse == test_6) {
    GALGAS_location location_7 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (var_fileName  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997)).operator_concat (GALGAS_string ("' file does not exist in the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997)).operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997)).operator_concat (GALGAS_string ("' directory of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1996)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    temp_8 = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2005)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2005)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_8, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2007)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2008)), var_fileIndex, var_isTextFile  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2002)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_93247_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_93247_2 ; // Joker input parameter
  GALGAS_lstring joker_93247_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_93247_3, joker_93247_2, joker_93247_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2023)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2029)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2032)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inElementType, constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2059)) ;
  {
  routine_checkAssignmentTypes (constinArgument_inElementType, var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2066)), object->mAttribute_mExpressionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2066)) ;
  }
  ioArgument_ioCollectionValueElementListForGeneration.addAssign_operation (GALGAS_expressionCollectionValueForGeneration::constructor_new (object->mAttribute_mExpressionLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2068))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2068)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionListCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  GALGAS_unifiedTypeMapProxyAndParameterList var_formalParameterTypeList = constinArgument_inElementType.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2079)) ;
  GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_formalParameterTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2081)).objectCompare (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2081)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfExpressionLocation, GALGAS_string ("element of of '@").operator_concat (constinArgument_inElementType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2082))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2082)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2082)).operator_concat (var_formalParameterTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2083)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2082))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2082)).operator_concat (GALGAS_string (" parameter(s), while this list has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2083)).operator_concat (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2084)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2083))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2083)).operator_concat (GALGAS_string (" element(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2084))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2082)) ;
    var_semanticExpressionListForGeneration.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2086)) ;
    cEnumerator_semanticExpressionListAST enumerator_95850 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_95875 (var_formalParameterTypeList, kEnumeration_up) ;
    while (enumerator_95850.hasCurrentObject () && enumerator_95875.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_95850.current_mExpression (HERE).ptr (), enumerator_95875.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2088)) ;
      {
      routine_checkAssignmentTypes (enumerator_95875.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2089)), enumerator_95850.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2089)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2090)) ;
      enumerator_95850.gotoNextObject () ;
      enumerator_95875.gotoNextObject () ;
    }
    ioArgument_ioCollectionValueElementListForGeneration.addAssign_operation (GALGAS_expressionListCollectionForGeneration::constructor_new (object->mAttribute_mEndOfExpressionLocation, var_semanticExpressionListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2092))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2092)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_collectionValueAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_targetType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2142)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetType.objectCompare (GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2145)))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("Cannot infer type")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2146)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = var_targetType.reader_mSupportCollectionValue (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2147)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2147)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2148))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2148)).operator_concat (GALGAS_string (" type does not support collection value")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2148))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2148)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, object->mAttribute_mElementList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2150)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outExpression = GALGAS_defaultConstructorExpressionForGeneration::constructor_new (var_targetType, object->mAttribute_mTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2151)) ;
      }else if (kBoolFalse == test_5) {
        GALGAS_collectionValueElementListForGeneration var_collectionValueElementListForGeneration = GALGAS_collectionValueElementListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2156)) ;
        cEnumerator_collectionValueElementList enumerator_98534 (object->mAttribute_mElementList, kEnumeration_up) ;
        while (enumerator_98534.hasCurrentObject ()) {
          callCategoryMethod_analyze ((const cPtr_abstractCollectionValueElement *) enumerator_98534.current_mElement (HERE).ptr (), constinArgument_inAnalysisContext, var_targetType, ioArgument_ioVariableMap, var_collectionValueElementListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2158)) ;
          enumerator_98534.gotoNextObject () ;
        }
        outArgument_outExpression = GALGAS_expressionCollectionForGeneration::constructor_new (var_targetType, object->mAttribute_mEndOfCollectionValue, var_collectionValueElementListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2165)) ;
      }
    }
  }
}
