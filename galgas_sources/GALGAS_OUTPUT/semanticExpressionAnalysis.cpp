    ...
    if (cond_20600.isBuiltAndTrue ()) {
      ...
      GGS_semanticExpressionListForGeneration  var_cas_constructorEffectiveParameterList = GGS_semanticExpressionListForGeneration ::constructor_emptyList () ;
      {
        ...
        while (((operand_20714 = enumerator_20714.nextObject ()))
          ...
          const GGS_semanticExpressionAST  temp_20842 = operand_20714->mExpression ;
          if (temp_20842.isBuilt ()) {
            typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (temp_20842.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_20842 (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_exp COMMA_SOURCE_FILE_AT_LINE (406)) ;
            }
          }
...
category_method__readerCallExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
  ...
  if (operand_21350 != NULL) {
    ...
    const GGS_semanticExpressionAST  temp_21631 = operand_21350->mReceiver ;
    if (temp_21631.isBuilt ()) {
      typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (temp_21631.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_21631 (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_receiverExpression COMMA_SOURCE_FILE_AT_LINE (424)) ;
      }
    }
    ...
    if (cond_23128.isBuiltAndTrue ()) {
      ...
      GGS_semanticExpressionListForGeneration  var_cas_constructorEffectiveParameterList = GGS_semanticExpressionListForGeneration ::constructor_emptyList () ;
      {
        ...
        while (((operand_23242 = enumerator_23242.nextObject ()))
          ...
          GGS_semanticExpressionForGeneration  var_cas_exp ;
          const GGS_semanticExpressionAST  temp_23365 = operand_23242->mExpression ;
          if (temp_23365.isBuilt ()) {
            typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (temp_23365.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_23365 (HERE), var_cas_inSemanticContext, var_cas_inPredefinedTypes, var_cas_ioVariableMap, var_cas_exp COMMA_SOURCE_FILE_AT_LINE (460)) ;
            }
          }
