...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).isValid ()) {
      PMUInt32 variant_82604 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).uintValue () ;
      bool loop_82604 = true ;
      while (loop_82604) {
        loop_82604 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).isValid () ;
        if (loop_82604) {
          loop_82604 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).boolValue () ;
        }
        if (loop_82604 && (0 == variant_82604)) {
          loop_82604 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84284_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84287_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84290_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84293_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84284_0, joker_84287_0, joker_84290_0, joker_84293_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_85044_0 ; // Joker input parameter
  GALGAS_lstringlist joker_85047_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_85050_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_85053_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_85044_0, joker_85047_0, joker_85050_0, joker_85053_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_85216_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_85216_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85803 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85824 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85803.hasCurrentObject () && enumerator_85824.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85803.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
      {
      routine_checkAssignmentTypes (enumerator_85824.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1854)), enumerator_85803.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1855)) ;
      enumerator_85803.gotoNextObject () ;
      enumerator_85824.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_87352_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87359_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87419_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87352_0, joker_87359_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87419_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).isValid ()) {
    PMUInt32 variant_87483 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).uintValue () ;
    bool loop_87483 = true ;
    while (loop_87483) {
      loop_87483 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_87483) {
        loop_87483 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_87483 && (0 == variant_87483)) {
        loop_87483 = false ;
      ...
      if (loop_87483) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87890_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1906)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87890_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1905)) ;
        }else if (kBoolFalse == test_4) {
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88310_0 ; // Joker input parameter
    GALGAS_uint joker_88325_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1919)), joker_88310_0, var_isTextFile, joker_88325_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1919)) ;
  }else if (kBoolFalse == test_6) {
