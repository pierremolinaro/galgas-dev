...
void routine_analyzeConstructorInvocation (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  const cMapElement_constructorMap * objectArray_35787 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction_hasKey (constinArgument_inConstructorName.reader_string (SOURCE_FILE_AT_LINE (541))) ;
  if (NULL != objectArray_35787) {
      macroValidSharedObject (objectArray_35787, const cMapElement_constructorMap) ;
    var_constructorFormalArgumentTypeList = objectArray_35787->mAttribute_mArgumentTypeList ;
    outArgument_outHasCompilerArgument = objectArray_35787->mAttribute_mHasCompilerArgument ;
    outArgument_outReturnedType = objectArray_35787->mAttribute_mReturnedType ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_constructorMap enumerator_36283 (var_constructorMap, kEnumeration_up) ;
      while (enumerator_36283.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_36283.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) ;
        cEnumerator_unifiedTypeMapProxyList enumerator_36351 (enumerator_36283.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_36351.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_36351.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) ;
          enumerator_36351.gotoNextObject () ;
        }
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_36283.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) COMMA_SOURCE_FILE_AT_LINE (558)) COMMA_SOURCE_FILE_AT_LINE (558)) ;
  ...
  cEnumerator_semanticExpressionListAST enumerator_37443 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
  cEnumerator_unifiedTypeMapProxyList enumerator_37480 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
  while (enumerator_37443.hasCurrentObject () && enumerator_37480.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_exp ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_37443.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
    {
    routine_checkAssignmentTypes (enumerator_37480.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (579)), enumerator_37443.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
    }
    outArgument_outConstructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (580)) ;
    enumerator_37443.gotoNextObject () ;
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_44794_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_44794_4 ; // Joker input parameter
    GALGAS_location joker_44794_3 ; // Joker input parameter
    GALGAS_bool joker_44794_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_44794_1 ; // Joker input parameter
    GALGAS_string joker_44809_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (764)).method_searchKey (constinArgument_inReaderName, joker_44794_5, joker_44794_4, joker_44794_3, joker_44794_2, joker_44794_1, var_qualifier, joker_44809_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).isValid ()) {
      PMUInt32 variant_48790 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).uintValue () ;
      bool loop_48790 = true ;
      while (loop_48790) {
        loop_48790 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).isValid () ;
        if (loop_48790) {
          loop_48790 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).boolValue () ;
        }
        if (loop_48790 && (0 == variant_48790)) {
          loop_48790 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49381_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49449_2 ; // Joker input parameter
        GALGAS_string joker_49449_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (881)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (882)), var_kind, var_argumentTypeList, joker_49381_0, var_hasCompilerArgument, var_returnedType, joker_49449_2, joker_49449_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (881)) ;
...
static void categoryMethod_literalStringExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  cEnumerator_stringlist enumerator_32557 (object->mAttribute_mStringSequence, kEnumeration_up) ;
  while (enumerator_32557.hasCurrentObject ()) {
    var_s.dotAssign_operation (enumerator_32557.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (468)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const cMapElement_readerMap * objectArray_40341 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (657))) ;
  if (NULL != objectArray_40341) {
      macroValidSharedObject (objectArray_40341, const cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_40341->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_40341->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_40341->mAttribute_mReturnedType ;
    var_kind = objectArray_40341->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_40341->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_40341->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (663)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_typedAttributeList enumerator_41009 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (672)), kEnumeration_up) ;
      while (enumerator_41009.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_41009.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (673)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (673)), inCompiler COMMA_SOURCE_FILE_AT_LINE (673)) ;
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (674)) ;
        const cMapElement_readerMap * objectArray_41248 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (675))) ;
        if (NULL != objectArray_41248) {
            macroValidSharedObject (objectArray_41248, const cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (676)) ;
          var_readerFormalArgumentTypeList = objectArray_41248->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_41248->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_41248->mAttribute_mReturnedType ;
          var_kind = objectArray_41248->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_41009.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_41248->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_41248->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (683)) ;
          }
        }
        enumerator_41009.gotoNextObject () ;
      }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_42114 (var_fieldList, kEnumeration_up) ;
          while (enumerator_42114.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_42114.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (696)) ;
            if (enumerator_42114.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (697)) ;
            }
            enumerator_42114.gotoNextObject () ;
          }
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_42802 (var_readerMap, kEnumeration_up) ;
        while (enumerator_42802.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_42802.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
          cEnumerator_unifiedTypeMapProxyList enumerator_42870 (enumerator_42802.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_42870.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42870.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) ;
            enumerator_42870.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42802.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
          enumerator_42802.gotoNextObject () ;
        }
        //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_14) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_43822 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_43854 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_43822.hasCurrentObject () && enumerator_43854.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43822.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (736)) ;
      {
      routine_checkAssignmentTypes (enumerator_43854.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (737)), enumerator_43822.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
      }
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47618 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47618.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47618.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
      enumerator_47618.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47714 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47714.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47714.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      enumerator_47714.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47812 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47812.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47812.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
      enumerator_47812.gotoNextObject () ;
    }
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_78241 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_78257 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_78241.hasCurrentObject () && enumerator_78257.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_78257.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1659)) ;
      {
      routine_checkAssignmentTypes (enumerator_78241.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1660)), enumerator_78257.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1660)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1661)) ;
      enumerator_78241.gotoNextObject () ;
      enumerator_78257.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79857_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79857_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79857_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79857_20 ; // Joker input parameter
  GALGAS_attributeMap joker_79857_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79857_18 ; // Joker input parameter
  GALGAS_constructorMap joker_79857_17 ; // Joker input parameter
  GALGAS_readerMap joker_79857_16 ; // Joker input parameter
  GALGAS_modifierMap joker_79857_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79857_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_79857_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79857_12 ; // Joker input parameter
  GALGAS_stringlist joker_79857_11 ; // Joker input parameter
  GALGAS_uint joker_79857_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_79857_9 ; // Joker input parameter
  GALGAS_stringset joker_79857_8 ; // Joker input parameter
  GALGAS_lstringlist joker_79857_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79857_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79857_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79857_4 ; // Joker input parameter
  GALGAS_bool joker_79857_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79857_2 ; // Joker input parameter
  GALGAS_string joker_79857_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79857_23, joker_79857_22, joker_79857_21, joker_79857_20, joker_79857_19, joker_79857_18, joker_79857_17, joker_79857_16, joker_79857_15, joker_79857_14, joker_79857_13, joker_79857_12, joker_79857_11, joker_79857_10, joker_79857_9, joker_79857_8, joker_79857_7, joker_79857_6, joker_79857_5, joker_79857_4, joker_79857_3, joker_79857_2, joker_79857_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1699)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1725)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).isValid ()) {
      PMUInt32 variant_80976 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1725)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).uintValue () ;
      bool loop_80976 = true ;
      while (loop_80976) {
        loop_80976 = var_found.operator_not (SOURCE_FILE_AT_LINE (1726)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)).reader_isNull (SOURCE_FILE_AT_LINE (1726)).operator_not (SOURCE_FILE_AT_LINE (1726)) COMMA_SOURCE_FILE_AT_LINE (1726)).isValid () ;
        if (loop_80976) {
          loop_80976 = var_found.operator_not (SOURCE_FILE_AT_LINE (1726)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)).reader_isNull (SOURCE_FILE_AT_LINE (1726)).operator_not (SOURCE_FILE_AT_LINE (1726)) COMMA_SOURCE_FILE_AT_LINE (1726)).boolValue () ;
        }
        if (loop_80976 && (0 == variant_80976)) {
          loop_80976 = false ;
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).isValid ()) {
      PMUInt32 variant_82598 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).uintValue () ;
      bool loop_82598 = true ;
      while (loop_82598) {
        loop_82598 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).isValid () ;
        if (loop_82598) {
          loop_82598 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).boolValue () ;
        }
        if (loop_82598 && (0 == variant_82598)) {
          loop_82598 = false ;
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1778)) COMMA_SOURCE_FILE_AT_LINE (1778)).operator_concat (GALGAS_string ("' is not a descendant of the '@") COMMA_SOURCE_FILE_AT_LINE (1778)).operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1779)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1779)) COMMA_SOURCE_FILE_AT_LINE (1779)).operator_concat (GALGAS_string ("' type of the cast expression") COMMA_SOURCE_FILE_AT_LINE (1779)) COMMA_SOURCE_FILE_AT_LINE (1777)) ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1787)), GALGAS_string ("cast expression should be a class instance or an @object instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1789)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1789)) COMMA_SOURCE_FILE_AT_LINE (1789)).operator_concat (GALGAS_string (" instance") COMMA_SOURCE_FILE_AT_LINE (1789)) COMMA_SOURCE_FILE_AT_LINE (1787)) ;
    }
  }
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84276_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84279_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84282_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84285_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84276_0, joker_84279_0, joker_84282_0, joker_84285_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_85036_0 ; // Joker input parameter
  GALGAS_lstringlist joker_85039_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_85042_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_85045_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_85036_0, joker_85039_0, joker_85042_0, joker_85045_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_85208_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_85208_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85795 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85816 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85795.hasCurrentObject () && enumerator_85816.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85795.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
      {
      routine_checkAssignmentTypes (enumerator_85816.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1854)), enumerator_85795.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1855)) ;
      enumerator_85795.gotoNextObject () ;
      enumerator_85816.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1878)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  GALGAS_lstring joker_87344_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87351_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87411_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87344_0, joker_87351_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87411_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).isValid ()) {
    PMUInt32 variant_87475 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).uintValue () ;
    bool loop_87475 = true ;
    while (loop_87475) {
      loop_87475 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_87475) {
        loop_87475 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_87475 && (0 == variant_87475)) {
        loop_87475 = false ;
      ...
      if (loop_87475) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87880_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1906)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87880_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1905)) ;
        }else if (kBoolFalse == test_4) {
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88300_0 ; // Joker input parameter
    GALGAS_uint joker_88315_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1919)), joker_88300_0, var_isTextFile, joker_88315_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1919)) ;
  }else if (kBoolFalse == test_6) {
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1947)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader") COMMA_SOURCE_FILE_AT_LINE (1952)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE_AT_LINE (1956)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1955)) ;
}
//---------------------------------------------------------------------------*
