...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (764)).method_searchKey (constinArgument_inReaderName, joker_44543_5, joker_44543_4, joker_44543_3, joker_44543_2, joker_44543_1, var_qualifier, joker_44558_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).isValid ()) {
      uint32_t variant_48538 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).uintValue () ;
      bool loop_48538 = true ;
      while (loop_48538) {
        loop_48538 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).isValid () ;
        if (loop_48538) {
          loop_48538 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).boolValue () ;
        }
        if (loop_48538 && (0 == variant_48538)) {
          loop_48538 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49117_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49185_2 ; // Joker input parameter
        GALGAS_string joker_49185_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (880)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (881)), var_kind, var_argumentTypeList, joker_49117_0, var_hasCompilerArgument, var_returnedType, joker_49185_2, joker_49185_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (880)) ;
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47365 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47365.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47365.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
      enumerator_47365.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47461 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47461.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47461.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      enumerator_47461.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47559 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47559.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47559.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_77977 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_77991 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_77977.hasCurrentObject () && enumerator_77991.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_77991.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1658)) ;
      {
      routine_checkAssignmentTypes (enumerator_77977.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1659)), enumerator_77991.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1659)) ;
      }
      ...
      enumerator_77991.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79592_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79592_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79592_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79592_20 ; // Joker input parameter
  GALGAS_attributeMap joker_79592_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79592_18 ; // Joker input parameter
  GALGAS_constructorMap joker_79592_17 ; // Joker input parameter
  GALGAS_readerMap joker_79592_16 ; // Joker input parameter
  GALGAS_modifierMap joker_79592_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79592_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_79592_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79592_12 ; // Joker input parameter
  GALGAS_stringlist joker_79592_11 ; // Joker input parameter
  GALGAS_uint joker_79592_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_79592_9 ; // Joker input parameter
  GALGAS_stringset joker_79592_8 ; // Joker input parameter
  GALGAS_lstringlist joker_79592_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79592_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79592_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79592_4 ; // Joker input parameter
  GALGAS_bool joker_79592_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79592_2 ; // Joker input parameter
  GALGAS_string joker_79592_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79592_23, joker_79592_22, joker_79592_21, joker_79592_20, joker_79592_19, joker_79592_18, joker_79592_17, joker_79592_16, joker_79592_15, joker_79592_14, joker_79592_13, joker_79592_12, joker_79592_11, joker_79592_10, joker_79592_9, joker_79592_8, joker_79592_7, joker_79592_6, joker_79592_5, joker_79592_4, joker_79592_3, joker_79592_2, joker_79592_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1698)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).isValid ()) {
      uint32_t variant_80714 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).uintValue () ;
      bool loop_80714 = true ;
      while (loop_80714) {
        loop_80714 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).isValid () ;
        if (loop_80714) {
          loop_80714 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).boolValue () ;
        }
        if (loop_80714 && (0 == variant_80714)) {
          loop_80714 = false ;
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).isValid ()) {
      uint32_t variant_82366 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).uintValue () ;
      bool loop_82366 = true ;
      while (loop_82366) {
        loop_82366 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).isValid () ;
        if (loop_82366) {
          loop_82366 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).boolValue () ;
        }
        if (loop_82366 && (0 == variant_82366)) {
          loop_82366 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84047_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84050_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84053_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84056_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84047_0, joker_84050_0, joker_84053_0, joker_84056_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_84807_0 ; // Joker input parameter
  GALGAS_lstringlist joker_84810_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84813_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84816_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_84807_0, joker_84810_0, joker_84813_0, joker_84816_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_84979_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_84979_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85566 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85585 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85566.hasCurrentObject () && enumerator_85585.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85566.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
      {
      routine_checkAssignmentTypes (enumerator_85585.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1854)), enumerator_85566.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1855)) ;
      enumerator_85566.gotoNextObject () ;
      enumerator_85585.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_87115_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87122_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87182_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87115_0, joker_87122_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87182_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).isValid ()) {
    uint32_t variant_87245 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).uintValue () ;
    bool loop_87245 = true ;
    while (loop_87245) {
      loop_87245 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_87245) {
        loop_87245 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_87245 && (0 == variant_87245)) {
        loop_87245 = false ;
      ...
      if (loop_87245) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87653_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1906)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87653_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1905)) ;
        }else if (kBoolFalse == test_4) {
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88073_0 ; // Joker input parameter
    GALGAS_uint joker_88088_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1919)), joker_88073_0, var_isTextFile, joker_88088_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1919)) ;
  }else if (kBoolFalse == test_6) {
